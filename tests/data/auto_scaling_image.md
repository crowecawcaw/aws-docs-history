...
![A basic architecture diagram of an Auto Scaling group within a VPC.](/images/autoscaling/ec2/userguide/images/asg-basic-arch.png)
...
For more information about the benefits of Amazon EC2 Auto Scaling, see [Auto Scaling benefits for application architecture](auto-scaling-benefits.md "auto-scaling-benefits.md").
...
To begin, complete the [Create
 your first Auto Scaling group](create-your-first-auto-scaling-group.md "create-your-first-auto-scaling-group.md") tutorial to create an Auto Scaling group and see how it
...
* **AWS Management Console** â Provides a web interface
 ...
 groups**.
* **AWS Command Line Interface (AWS CLI)** â Provides commands
 for a broad set of AWS services, and is supported on Windows, macOS, and
 Linux. To get started, see [Prepare to use the AWS CLI](setting-up.md#set-up-cli "setting-up.md#set-up-cli"). For more information, see [autoscaling](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/ "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/autoscaling/") in the *AWS CLI Command Reference*.
* **AWS Tools for Windows PowerShell** â Provides commands for a
 broad set of AWS products for those who script in the PowerShell environment.
 To get started, see the [AWS Tools for PowerShell User Guide](../../../powershell/latest/userguide.md "../../../powershell/latest/userguide.md"). For more information, see the [AWS Tools for PowerShell Cmdlet Reference](../../../powershell/latest/reference/Index.md "../../../powershell/latest/reference/Index.md").
* **AWS SDKs** â Provides
 ...
 errors. For more information, see [AWS SDKs](https://aws.amazon.com/developer/tools/#SDKs "https://aws.amazon.com/developer/tools/#SDKs").
* **Query API** â Provides low-level API
 ...
 handling errors. For more information, see the [Amazon EC2 Auto Scaling API Reference](../APIReference.md "../APIReference.md").
* **AWS CloudFormation** â Supports creating Auto Scaling groups
 using CloudFormation templates. For more information, see [Create Auto Scaling groups with
 AWS CloudFormation](creating-auto-scaling-groups-with-cloudformation.md "creating-auto-scaling-groups-with-cloudformation.md").
...
To connect programmatically to an AWS service, you use an endpoint. For information
 ...
 quotas](../../../general/latest/gr/as.md "../../../general/latest/gr/as.md") in the *AWS General Reference*.
