...
As a managed service, Amazon AppFlow is protected by the AWS global network security
...
You use AWS published API calls to access Amazon AppFlow through the network. Clients must
