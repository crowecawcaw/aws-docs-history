...
![Bucket details section showing S3 bucket dropdown, bucket prefix field, and refresh button.](http://docs.aws.amazon.com/appflow/latest/userguide/images/connection_setup-s3-console.png)
