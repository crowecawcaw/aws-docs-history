...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| **Disabled**         | A *_Disabled_<br>• state for the ingestion means that your ingestion is<br>disabled.                                                                                                                    | You can enable the ingestion by selecting *_Enable_<br>• from the<br>*_Actions_<br>• dropdown of the *_Ingestions_<br>• page. |
