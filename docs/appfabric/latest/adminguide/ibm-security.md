...
establish trust and protect against insider threats to both your [workforce](https://www.ibm.com/products/verify-identity/workforce-iam "https://www.ibm.com/products/verify-identity/workforce-iam") and
[consumers](https://www.ibm.com/products/verify-identity/ciam "https://www.ibm.com/products/verify-identity/ciam").
...
- To access the audit logs, you need to have an [IBM
  Security® Verify SaaS account](https://www.ibm.com/products/verify-identity "https://www.ibm.com/products/verify-identity").
...
Security® Verify API rate limits, see [IBM Terms](https://www.ibm.com/support/customer/csol/terms/?id=i126-7765&lc=en "https://www.ibm.com/support/customer/csol/terms/?id=i126-7765&lc=en"). If the combination of AppFabric and your existing IBM
...
1. For first-time login, use the login URL and credentials that were sent to
   your registered email address.
2. Access the administration console at
   `https://`<hostname>`.verify.ibm.com/ui/admin/`.
   For more information, see [Accessing IBM Security® Verify](https://www.ibm.com/docs/en/security-verify?topic=overview-accessing-security-verify#taskt_login_admin_ui__steps__1 "https://www.ibm.com/docs/en/security-verify?topic=overview-accessing-security-verify#taskt_login_admin_ui__steps__1").
...
5. Keep the **Default** option in the **Client
   Authentication method**.

Don't edit the **Custom scopes** field. 6. Choose **Next**. 7. Don't edit the **IP filter** field. 8. Choose **Next**. 9. Don't edit the **Additional properties** field. 10. Choose **Next**. 11. Specify a **Name** and **Description**.
The description is optional. 12. Choose **Create API client**.
...
2. Access the administration console at
   ...
   more information, see [Accessing IBM Security® Verify](https://www.ibm.com/docs/en/security-verify?topic=overview-accessing-security-verify#taskt_login_admin_ui__steps__1 "https://www.ibm.com/docs/en/security-verify?topic=overview-accessing-security-verify#taskt_login_admin_ui__steps__1").
3. In the administration console, under **Security**
   < **API Access** < **API
