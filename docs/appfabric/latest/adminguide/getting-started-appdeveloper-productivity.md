...
Applications](https://aws.amazon.com/appfabric/supported-applications/ "https://aws.amazon.com/appfabric/supported-applications/").
...
delete the AppClient and create a new one. For more information, see [CreateAppClient](API_CreateAppClient.md "API_CreateAppClient.md").
...
signature examples](../../../IAM/latest/UserGuide/signature-v4-examples.md "../../../IAM/latest/UserGuide/signature-v4-examples.md") in the _IAM User Guide_. You need to
...
requests](../../../IAM/latest/UserGuide/reference_aws-signing.md "../../../IAM/latest/UserGuide/reference_aws-signing.md") in the _IAM User Guide_.
...
- `appName` - The name of the application that will be displayed to
  ...
  details about the consent page, see [Step 2. Provide consent for the app to display insights](getting-started-users-productivity.md#provide-consent "getting-started-users-productivity.md#provide-consent").
...
- `customerManagedKeyIdentifier` (optional) - The ARN of the customer
  ...
  AWS keys](../../../kms/latest/developerguide/concepts.md#key-mgmt "../../../kms/latest/developerguide/concepts.md#key-mgmt") in the _AWS Key Management Service Developer
  Guide_.
...
your application identity. For more information, see [Authorize](API_Authorize.md "API_Authorize.md"). Then you'll exchange this authorization code for an
...
**Request Fields**
    ...
    * `app_client_id` (required) - The AppClient ID for the
     ...
     an AppClient](#create_appclient "#create_appclient"). For example,
     `a1b2c3d4-5678-90ab-cdef-EXAMPLE11111`.
    * `redirect_uri` (required) - The URI to redirect end users
     to after authorization you used in [Step
     1. Create an AppClient](#create_appclient "#create_appclient"). For example,
     `https://localhost:8080`.
...
###### Request Fields
    ...
    * `redirect_uri` (required) - The URI to redirect users to
     ...
     Create an AppClient](#create_appclient "#create_appclient"). This must be the same redirect URI used
...
see [Data processing in AppFabric](productivity-data-processing.md "productivity-data-processing.md").
...
- `ListActionableInsights` — For more information, see the
  [Actionable insights](#productivity-actionable-insights "#productivity-actionable-insights")
  section below.
...
For more information, see [ActionableInsights](API_ActionableInsights.md "API_ActionableInsights.md").
...
For more information, see [MeetingInsights](API_MeetingInsights.md "API_MeetingInsights.md").
...
For more information, see [PutFeedback](API_PutFeedback.md "API_PutFeedback.md").
...
Begin the verification process by sending an email to [appfabric-appverification@amazon.com](mailto:appfabric-appverification@amazon.com "mailto:appfabric-appverification@amazon.com") and requesting that your app be
verified.
...
- Your organization is an AWS partner on the AWS Partner Network with at least an “AWS
  ...
  Tiers](https://aws.amazon.com/partners/services-tiers/ "https://aws.amazon.com/partners/services-tiers/").
...
- Your application should be listed on the AWS Marketplace. For more information, see the
  [AWSMarketplace](https://aws.amazon.com/marketplace "https://aws.amazon.com/marketplace").
