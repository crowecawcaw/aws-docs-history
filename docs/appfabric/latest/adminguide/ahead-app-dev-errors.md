...
![Warning message for an unverified application in AWS AppFabric, requesting data access.](images/fabric-24.png)
...
find the AppClient ID, use the [ListAppClient](manage-appclients.md#list_appclients "manage-appclients.md#list_appclients") API
operation.
...
use the [GetAppClient](manage-appclients.md#get_appclient_details "manage-appclients.md#get_appclient_details") API operation.
...
`refresh_token` received in [Token](getting-started-appdeveloper-productivity.md#authorize_data_access "getting-started-appdeveloper-productivity.md#authorize_data_access") API
call response.
