...
performance of AWS AppFabric and your other AWS solutions. AWS provides the following
monitoring tools to watch AppFabric, report when something is wrong, and take automatic actions
when appropriate:
...
- _Amazon CloudWatch Logs_ enables you to monitor, store, and access your log files
  from Amazon EC2 instances, AWS CloudTrail, and other sources. CloudWatch Logs can monitor information in the log
