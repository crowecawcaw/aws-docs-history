...
- [Request body](#API_ListMeetingInsights_request "#API_ListMeetingInsights_request")
- [Response elements](#API_ListMeetingInsights_response "#API_ListMeetingInsights_response")
...
| Parameter              | Description                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **MeetingInsightList** | Lists the actionable meeting insights. For more<br>information, see [MeetingInsights](API_MeetingInsights.md "API_MeetingInsights.md").                                                                                                                                                                                                                                                                  |
