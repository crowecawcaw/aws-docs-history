...
Before you use IAM to manage access to AppFabric, learn what IAM features are
available to use with AppFabric.

| IAM features you can use with AWS AppFabric                                                                                                              | IAM feature | AppFabric support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------- |
...
To get a high-level view of how AppFabric and other AWS services work with most IAM
...
To see a list of AppFabric actions, see [Actions defined by AWS AppFabric](../../../IAM/latest/UserGuide/list_appfabric.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_appfabric.md#your_service-actions-as-permissions") in the
...
example, to specify all actions that begin with the word `List`, include the
following action.
...
To see a list of AppFabric resource types and their ARNs, see [Resource types defined by AWS AppFabric](../../../IAM/latest/UserGuide/list_appfabric.md#your_service-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_appfabric.md#your_service-resources-for-iam-policies")
in the
_Service Authorization Reference_.To
...
To see a list of AppFabric condition keys, see [Condition keys for AWS AppFabric](../../../IAM/latest/UserGuide/list_appfabric.md#your_service-policy-keys "../../../IAM/latest/UserGuide/list_appfabric.md#your_service-policy-keys") in the
