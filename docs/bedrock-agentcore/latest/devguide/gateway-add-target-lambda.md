...
- Understand the Lambda input format. You can then follow the steps in the [AWS Lambda Developer Guide](../../../lambda/latest/dg.md "../../../lambda/latest/dg.md") for **Building with** the language of your choice.
...
- [Key considerations and limitations](#gateway-building-lambda-limitations "#gateway-building-lambda-limitations")
- [Lambda function tool schema](#gateway-lambda-tool-schema "#gateway-lambda-tool-schema")
- [Lambda function input format](#gateway-building-lambda-input "#gateway-building-lambda-input")
...
- [Tool definition](#gateway-lambda-tool-definition "#gateway-lambda-tool-definition")
- [Top level schema definition for input and output schemas](#gateway-lambda-top-level-schema-definition "#gateway-lambda-top-level-schema-definition")
- [Property schema definition](#gateway-lambda-property-schema-definition "#gateway-lambda-property-schema-definition")
- [Example Lambda tool definitions](#gateway-lambda-example "#gateway-lambda-example")

### Tool definition

When you add a Lambda function as a gateway target, you provide a [ToolDefinition](../../../bedrock-agentcore-control/latest/APIReference/API_ToolDefinition.md "../../../bedrock-agentcore-control/latest/APIReference/API_ToolDefinition.md") when providing the target configuration. The structure of the tool definition is as follows:
...
The `inputSchema` and `outputSchema` fields at the top level of the tool definition both map to an object-type [SchemaDefinition](../../../bedrock-agentcore-control/latest/APIReference/API_SchemaDefinition.md "../../../bedrock-agentcore-control/latest/APIReference/API_SchemaDefinition.md") that contains the following fields:
