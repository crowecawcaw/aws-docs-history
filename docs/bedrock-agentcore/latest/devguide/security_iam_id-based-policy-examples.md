...
By default, users and roles don't have permission to create or modify AgentCore
...
Identity-based policies determine whether someone can create, access, or delete AgentCore resources in your
...
These permissions must allow you to list and view details about the AgentCore resources
...
To ensure that users and roles can still use the AgentCore console, also attach the
AgentCore `ConsoleAccess` or `ReadOnly` AWS managed policy to
