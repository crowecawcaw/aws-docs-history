...
- [Create an event](short-term-create-event.md "short-term-create-event.md")
- [Get an event](short-term-get-event.md "short-term-get-event.md")
- [List events](short-term-list-events.md "short-term-list-events.md")
- [Delete an event](short-term-delete-event.md "short-term-delete-event.md")
