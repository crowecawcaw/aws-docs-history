...
Create an empty AgentCore project. Then register the server that you created in [Create your first AG-UI server](#runtime-agui-create-first-server "#runtime-agui-create-first-server") as a BYO agent with the Cognito configuration from the previous step:
