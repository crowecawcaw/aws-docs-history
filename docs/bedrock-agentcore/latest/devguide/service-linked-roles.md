...
You can view the complete policy at [AWSBedrockAgentCoreIdentityNetworkServiceRolePolicy](../../../aws-managed-policy/latest/reference/AWSBedrockAgentCoreIdentityNetworkServiceRolePolicy.md "../../../aws-managed-policy/latest/reference/AWSBedrockAgentCoreIdentityNetworkServiceRolePolicy.md").
...
Use the IAM console, the AWS CLI, or the IAM API to delete service-linked roles. For more information, see [Deleting a service-linked role](../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role "../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role").
