...
For more details, refer to Slack’s documentation [Sign in with Slack](https://docs.slack.dev/authentication/sign-in-with-slack/ "https://docs.slack.dev/authentication/sign-in-with-slack/").
