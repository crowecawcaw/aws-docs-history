...
- Completed the general [Prerequisites](code-interpreter-getting-started.md#code-interpreter-prerequisites "code-interpreter-getting-started.md#code-interpreter-prerequisites").
