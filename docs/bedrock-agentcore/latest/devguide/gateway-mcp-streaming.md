...
Response streaming is a prerequisite for [elicitation](gateway-mcp-elicitation.md "gateway-mcp-elicitation.md"), [sampling](gateway-mcp-sampling.md "gateway-mcp-sampling.md"), [progress notifications](gateway-mcp-progress.md "gateway-mcp-progress.md"), and [logging messages](gateway-mcp-logging.md "gateway-mcp-logging.md"). These features require an open SSE connection to deliver server-initiated events during tool execution.
...
Enabling response streaming introduces a change to the response interceptor input contract. If you use response interceptors, review your interceptor logic to ensure compatibility with streaming responses. See [Response interceptors with streaming enabled](gateway-interceptors-types.md#gateway-interceptors-types-streaming "gateway-interceptors-types.md#gateway-interceptors-types-streaming") for details.
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `notifications/progress` | Progress updates from the target during tool execution. See [Receive progress notifications](gateway-mcp-progress.md "gateway-mcp-progress.md"). |
| `notifications/message`  | Log messages from the target. See [Receive logging messages](gateway-mcp-logging.md "gateway-mcp-logging.md").                                   |
| `elicitation/create`     | Elicitation requests from the target asking for user input. See [Use elicitation](gateway-mcp-elicitation.md "gateway-mcp-elicitation.md").      |
| `sampling/createMessage` | Sampling requests from the target asking for an LLM completion. See [Use sampling](gateway-mcp-sampling.md "gateway-mcp-sampling.md").           |
