...
data at rest when you:

- Create a gateway.
- Update a gateway's configurations.
  Using a customer managed key gives you more control over the encryption process, including
  the ability to:
...
- Audit key usage through CloudWatch logs and AWS CloudTrail
  For more information, see [AWS Key Management Service Developer Guide](../../../kms/latest/developerguide.md "../../../kms/latest/developerguide.md").
...
- You have access to a KMS key. For information about creating a KMS key, see
  [Create a
  KMS key](../../../kms/latest/developerguide/create-keys.md "../../../kms/latest/developerguide/create-keys.md").
- The KMS key has a key policy attached to it that allows the following
  permissions:
  ...
  For more information about controlling IAM permissions for a KMS key, see [KMS key access and permissions](../../../kms/latest/developerguide/control-access.md "../../../kms/latest/developerguide/control-access.md") in the AWS Key Management Service Developer Guide.
...
1. Follow the **Console** steps at [Create an Amazon Bedrock AgentCore gateway](gateway-create.md "gateway-create.md")
   and expand the
...
when sending either of the following requests through an [AgentCore control plane](../../../cli/latest/reference/bedrock-agentcore-control.md "../../../cli/latest/reference/bedrock-agentcore-control.md") client.:
...
The following example shows an example CLI request to create a gateway with a AWS KMS
key specified using the `kms-key-arn` argument:
...
- [create_gateway](../../../https:/boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore-control/client/create_gateway.md "../../../https:/boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore-control/client/create_gateway.md")
- [update_gateway](../../../https:/boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore-control/client/update_gateway.md "../../../https:/boto3.amazonaws.com/v1/documentation/api/latest/reference/services/bedrock-agentcore-control/client/update_gateway.md")

The following example shows an example Boto3 request to create a gateway with a
AWS KMS key specified using the `kmsKeyArn` argument:
