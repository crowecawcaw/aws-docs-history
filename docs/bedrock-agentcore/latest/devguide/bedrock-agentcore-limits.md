...
| InvokeAgentRuntimeCommandShell API rate, per agent, per account        | 25 TPS                | Yes        | Transactions per second. Additional limits: maximum connection duration 1 hour, maximum frame payload 64 KB, concurrent shell sessions per runtime 10, reconnection buffer 256 KB.                                     |
