...
For complete information on EFS mount targets, see [How Amazon EFS works](../../../efs/latest/ug/how-it-works.md "../../../efs/latest/ug/how-it-works.md").
...
For complete information on S3 Files mounting, see [Mounting S3 file systems](../../../AmazonS3/latest/userguide/s3-files-mounting.md "../../../AmazonS3/latest/userguide/s3-files-mounting.md").
...
For supported Availability Zones by region, see the [Supported Availability Zones](agentcore-vpc.md#agentcore-supported-azs "agentcore-vpc.md#agentcore-supported-azs") in the VPC configuration topic. For security group configuration, see [Example: Connecting to Amazon EFS or Amazon S3 Files](agentcore-vpc.md#agentcore-security-groups-filesystem "agentcore-vpc.md#agentcore-security-groups-filesystem").
...
For more information, see [Troubleshoot BYO storage](runtime-troubleshooting.md#troubleshoot-byo-storage-access-denied "runtime-troubleshooting.md#troubleshoot-byo-storage-access-denied").
```
