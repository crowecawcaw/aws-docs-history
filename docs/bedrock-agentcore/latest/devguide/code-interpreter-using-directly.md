...
- [Step 1: Choose your approach and install dependencies](#code-interpreter-direct-install "#code-interpreter-direct-install")
- [Step 2: Execute code](#code-interpreter-direct-execute "#code-interpreter-direct-execute")
