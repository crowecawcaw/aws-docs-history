...
You can provide `filesystemConfigurations` when you create a browser with [CreateBrowser](../../../bedrock-agentcore-control/latest/APIReference/API_CreateBrowser.md "../../../bedrock-agentcore-control/latest/APIReference/API_CreateBrowser.md") (every session started from that browser inherits the mounts), or when you start a session with [StartBrowserSession](../APIReference/API_StartBrowserSession.md "../APIReference/API_StartBrowserSession.md") (the mounts apply to that session). The parameter and shape are identical in both places.
...
Use [GetBrowser](../../../bedrock-agentcore-control/latest/APIReference/API_GetBrowser.md "../../../bedrock-agentcore-control/latest/APIReference/API_GetBrowser.md") to confirm the `filesystemConfigurations` on a browser, and [GetBrowserSession](../APIReference/API_GetBrowserSession.md "../APIReference/API_GetBrowserSession.md") to confirm the effective configurations on a running session. Configurations set at browser creation and at session start both appear in the session response.
