...
policies to limit the permissions that Amazon Bedrock AgentCore gives another service to the
...
`aws:SourceAccount` global condition context keys in AgentCore to prevent
