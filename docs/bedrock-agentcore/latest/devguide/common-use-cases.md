...
For detailed examples of how these patterns apply to specific industries and agent types, see [Example use cases](identity-use-cases.md "identity-use-cases.md").
