...
- The Lambda function must return a JSON response conforming to the response schema described in [Response schema](#code-based-response-schema "#code-based-response-schema").
