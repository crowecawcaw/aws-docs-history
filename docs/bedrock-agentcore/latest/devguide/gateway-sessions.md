...
Sessions are a prerequisite for [elicitation](gateway-mcp-elicitation.md "gateway-mcp-elicitation.md") and [sampling](gateway-mcp-sampling.md "gateway-mcp-sampling.md"), which require tracking state across multiple requests.
