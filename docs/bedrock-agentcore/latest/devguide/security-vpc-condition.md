...
For more information about using condition keys in IAM policies, see [IAM JSON Policy Elements: Condition](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html) in the IAM User Guide. For more information about Gateway condition keys, see [Use IAM condition keys with Amazon Bedrock AgentCore Gateway](security-gateway-condition-keys.md).
