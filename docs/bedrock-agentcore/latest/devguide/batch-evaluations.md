...
- [Prerequisites](batch-evaluations-prereqs.md "batch-evaluations-prereqs.md")
- [Getting started with batch evaluation](batch-evaluations-getting-started.md "batch-evaluations-getting-started.md")
- [Start batch evaluation](batch-evaluations-start.md "batch-evaluations-start.md")
- [Get batch evaluation results](batch-evaluations-get.md "batch-evaluations-get.md")
- [List batch evaluations](batch-evaluations-list.md "batch-evaluations-list.md")
