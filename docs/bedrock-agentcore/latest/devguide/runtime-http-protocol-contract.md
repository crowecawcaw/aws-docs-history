...
For example code, see [Get started with the Amazon Bedrock AgentCore starter toolkit in Python](runtime-get-started-toolkit.md "runtime-get-started-toolkit.md").
