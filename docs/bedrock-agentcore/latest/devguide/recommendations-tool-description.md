...
| `agentTraces`     | Union | Yes      | Trace source for analysis. See [Trace sources for recommendations](optimization-recommendations.md#recommendations-trace-sources "optimization-recommendations.md#recommendations-trace-sources").                     |
...
When the recommendation reaches `COMPLETED` status (retrieved via [Get a recommendation](recommendations-get.md "recommendations-get.md")), the result contains:
