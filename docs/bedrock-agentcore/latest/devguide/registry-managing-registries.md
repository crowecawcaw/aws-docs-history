...
- [Supported Inbound Authorization types](registry-supported-auth-types.md "registry-supported-auth-types.md")
- [Create and manage registries](registry-create-manage.md "registry-create-manage.md")
