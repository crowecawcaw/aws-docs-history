...
1. Choose the registry you want to search. The page automatically calls `ListDiscoverableRegistryRecords` and displays the approved records in the registry.
