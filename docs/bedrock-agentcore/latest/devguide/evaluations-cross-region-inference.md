...
If your use case requires avoiding [cross region inference](../../../cross-region-inference.md "../../../cross-region-inference.md") , you can create [Custom evaluators](custom-evaluators.md "custom-evaluators.md") that operate without CRIS. Custom evaluators provide the flexibility to:
