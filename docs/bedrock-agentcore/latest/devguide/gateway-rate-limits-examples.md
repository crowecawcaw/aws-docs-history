...
dimensionKeys=["targetName", "qualifiedModelId", "$.context.jwt.sub"],
    ...
    entries=[
        {
            "dimensions": {"targetName": "my-inference-target", "qualifiedModelId": "anthropic.claude-3-sonnet-20240229-v1:0", "$.context.jwt.sub": "_"},
"requests": [
{
"rate": 100,
"period": "minute",
...
{
"dimensions": {"targetName": "_", "qualifiedModelId": "_", "$.context.jwt.sub": "_"},
"requests": [
{
"rate": 30,
"period": "minute",
