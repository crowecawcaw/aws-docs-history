...
For more details, refer to [X’s OAuth 2.0 documentation](https://docs.x.com/fundamentals/authentication/oauth-2-0/overview "https://docs.x.com/fundamentals/authentication/oauth-2-0/overview").
