...
These summary chunks can be retrieved using the [ListMemoryRecords](../APIReference/API_ListMemoryRecords.md "../APIReference/API_ListMemoryRecords.md") operation with namespace filter, or you can also perform semantic search over the summary chunks using the [RetrieveMemoryRecords](../APIReference/API_RetrieveMemoryRecords.md "../APIReference/API_RetrieveMemoryRecords.md") operation to retrieve only the relevant summary chunks for your query.
