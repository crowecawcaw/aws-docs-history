...
![Memory AgentCore Memory](images/memory-overview.png)
AgentCore Memory supports a variety of SDKs and agent frameworks. For examples, see [Amazon Bedrock AgentCore Memory examples](memory-examples.md "memory-examples.md").

###### Topics

- [Memory types](#memory-types-overview "#memory-types-overview")
- [Memory key benefits](#memory-key-benefits "#memory-key-benefits")
- [Common use cases of memory](#memory-common-use-cases "#memory-common-use-cases")
- [How it works](how-it-works.md "how-it-works.md")
- [Get started with AgentCore Memory](memory-get-started.md "memory-get-started.md")
- [Create an AgentCore Memory](memory-create-a-memory-store.md "memory-create-a-memory-store.md")
- [Use short-term memory](using-memory-short-term.md "using-memory-short-term.md")
- [Use long-term memory](long-term-memory-long-term.md "long-term-memory-long-term.md")
- [Amazon Bedrock AgentCore Memory examples](memory-examples.md "memory-examples.md")
...
AgentCore Memory offers [two types](memory-types.md "memory-types.md") of memory that work together to create intelligent, context-aware AI agents:
