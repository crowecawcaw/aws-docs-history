...
see [Amazon Bedrock AgentCore Memory examples](memory-examples.md "memory-examples.md").

## Memory types

AgentCore Memory offers [two types](memory-types.md "memory-types.md") of memory that
