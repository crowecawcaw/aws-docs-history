...
For more details, refer to [Zoom’s integration documentation](https://developers.zoom.us/docs/integrations/create/ "https://developers.zoom.us/docs/integrations/create/").
