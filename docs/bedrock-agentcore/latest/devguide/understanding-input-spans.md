...
- [Spans and events](#spans-and-events "#spans-and-events")
- [Example spans and events](#supported-spans "#supported-spans")
...
- [Span structure](#span-structure "#span-structure")
...
- [Attribute variations](#attribute-variations "#attribute-variations")
- [Supported scopes](#supported-scopes "#supported-scopes")
...
- [Event body schema](#event-body-schema "#event-body-schema")
