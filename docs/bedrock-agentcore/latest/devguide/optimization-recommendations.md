...
- [Configuration input modes](#recommendations-input-modes "#recommendations-input-modes")
- [Agent trace sources](#recommendations-trace-sources "#recommendations-trace-sources")
- [Start a system prompt recommendation](recommendations-system-prompt.md "recommendations-system-prompt.md")
- [Start a tool description recommendation](recommendations-tool-description.md "recommendations-tool-description.md")
