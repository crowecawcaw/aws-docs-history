...
| AgentCore Memory<br>• short-term                                                 | ✅                  | No                               | 🔵                  | Yes                              |
| AgentCore Memory<br>• long-term (semantic, summarization, user-pref, episodic)   | ✅                  | No                               | 🔵                  | Yes                              |
...
| Filesystem<br>• service-managed session storage                                  | ✅                  | No                               | ✅                  | No                               |
| Filesystem<br>• EFS access point                                                 | ✅                  | No                               | ✅                  | No                               |
| Filesystem<br>• S3 Files access point                                            | ✅                  | No                               | ✅                  | No                               |
| Environment variables                                                            | ✅                  | No                               | ✅                  | No                               |
| Direct shell command execution (`InvokeAgentRuntimeCommand` API)                 | ✅                  | No                               | ✅                  | No                               |
| Inbound auth<br>• IAM (SigV4)                                                    | ✅                  | No                               | ✅                  | No                               |
| Inbound auth<br>• OAuth                                                          | ✅                  | No                               | ✅                  | No                               |
...
- [Get started](harness-get-started.md "harness-get-started.md") - create and invoke your first harness
- [Models and instructions](harness-models.md "harness-models.md") - configure agents, models, and providers
- [Tools](harness-tools.md "harness-tools.md") - connect tools to your harness
- [Environment and filesystem](harness-environment.md "harness-environment.md") - bring a custom container image or environment
