...
The [Amazon Bedrock AgentCore Starter Toolkit](https://github.com/aws/bedrock-agentcore-starter-toolkit "https://github.com/aws/bedrock-agentcore-starter-toolkit") is a Command Line Interface (CLI) that
simplifies the infrastructure setup for containerizing and deploying an agent to an
AgentCore Runtime.

###### Topics

- [Get started with the Amazon Bedrock AgentCore starter toolkit in Python](runtime-get-started-toolkit.md "runtime-get-started-toolkit.md")
- [Get started with the Amazon Bedrock AgentCore starter toolkit in TypeScript](runtime-get-started-toolkit-typescript.md "runtime-get-started-toolkit-typescript.md")
