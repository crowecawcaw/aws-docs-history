...
For full details on payments observability setup, prerequisites, IAM permissions, and vended logs, see [Observability with Amazon CloudWatch](payments-observability.md "payments-observability.md") in the payments documentation.
