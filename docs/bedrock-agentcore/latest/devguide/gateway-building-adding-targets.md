...
- A target configuration. The configuration differs depending on the gateway protocol type and your gateway target type. For more information, see [TargetConfiguration](../../../bedrock-agentcore-control/latest/APIReference/API_TargetConfiguration.md "../../../bedrock-agentcore-control/latest/APIReference/API_TargetConfiguration.md") and its daughter pages.
