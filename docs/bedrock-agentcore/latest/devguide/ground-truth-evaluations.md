...
Custom evaluators also support ground truth fields through placeholders in their evaluation instructions. See [Ground truth in custom evaluators](#gt-custom-evaluators "#gt-custom-evaluators") for details.
...
For instructions on downloading session spans, see [Getting started with on-demand evaluation](getting-started-on-demand.md "getting-started-on-demand.md").
...
For details on creating custom evaluators, see [Custom evaluators](custom-evaluators.md "custom-evaluators.md").
