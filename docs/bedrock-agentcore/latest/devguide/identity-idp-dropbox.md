...
For more details, refer to [Dropbox’s OAuth implementation guide](https://developers.dropbox.com/oauth-guide#implementing-oauth "https://developers.dropbox.com/oauth-guide#implementing-oauth").
