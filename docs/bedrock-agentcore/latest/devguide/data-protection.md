...
applies to data protection in Amazon Bedrock AgentCore. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with AgentCore or other AWS services
...
- [Cross-region inference in Amazon Bedrock AgentCore Memory, Policy in Amazon Bedrock AgentCore, and AgentCore Evaluations](cross-region-inference.md "cross-region-inference.md")
