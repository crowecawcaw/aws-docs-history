...
- [Key considerations and limitations](#gateway-target-integrations-considerations "#gateway-target-integrations-considerations")
- [Supported APIs by template](#gateway-target-integrations-supported-apis "#gateway-target-integrations-supported-apis")
...
- Amazon Bedrock AgentCore supports a subset of APIs that the provider supports for interacting with these templates. For a list of APIs supported by AgentCore, see [Supported APIs by template](#gateway-target-integrations-supported-apis "#gateway-target-integrations-supported-apis").
...
The following sections show, for each template, the [outbound authentication](gateway-outbound-auth.md "gateway-outbound-auth.md") types supported, the server URL, and the supported APIs and their paths.
...
- [Agents for Amazon Bedrock Runtime](#gateway-target-integrations-supported-apis-bedrock-agent-runtime "#gateway-target-integrations-supported-apis-bedrock-agent-runtime")
- [Amazon Bedrock Runtime](#gateway-target-integrations-supported-apis-bedrock-runtime "#gateway-target-integrations-supported-apis-bedrock-runtime")
- [Amazon CloudWatch](#gateway-target-integrations-supported-apis-cloudwatch "#gateway-target-integrations-supported-apis-cloudwatch")
...
| POST          | RetrieveAndGenerate | /             | Generate a natural language response based on results retrieved<br>from querying a knowledge base. |
