...
Where `your-domain` is your Auth0 tenant domain (e.g., "dev-example.us.auth0.com"). 6. Configure Inbound Auth with the following values:
...
For more details, refer to [Auth0’s documentation on creating applications](https://auth0.com/docs/get-started/auth0-overview/create-applications "https://auth0.com/docs/get-started/auth0-overview/create-applications").
