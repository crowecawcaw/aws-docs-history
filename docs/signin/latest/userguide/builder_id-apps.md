...
**AWS Builder Center**  
With the [AWS Builder Center website](https://builder.aws.com), you can discover educational content, explore hands-on workshops, share your personal projects, and connect with other builders. You can access AWS Builder Center with your AWS Builder ID.
