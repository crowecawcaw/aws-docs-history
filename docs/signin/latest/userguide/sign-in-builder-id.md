...
+ [Change your AWS Builder ID password](change-password-builder-id.md)
...
1. Navigate to the [AWS Builder ID profile](https://profile.aws.amazon.com/) or the sign-in page of the AWS tool or service that you want to access. For example, to access AWS Builder Center, open the [AWS Builder Center website](https://builder.aws.com).
