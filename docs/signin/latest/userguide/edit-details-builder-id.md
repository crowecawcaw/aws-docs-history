...
1. On the **Security** page, under **Authentication**, choose **Add or Edit recovery email**.

1. On the **Add recovery email** page, enter the email address that you want to use as your recovery email, and then choose **Continue**. AWS Builder ID sends a one-time password (OTP) to that email address.
