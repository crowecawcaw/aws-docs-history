...
When viewing Amazon EC2 instance, EC2 Amazon EC2 Auto Scaling group, and Aurora and RDS database recommendations, you can view the price and
...
2. Choose **EC2 instances**, **EC2 Amazon EC2 Auto Scaling groups**, or **RDS databases** in the navigation pane.
...
- [Viewing EC2 Amazon EC2 Auto Scaling group recommendations](view-asg-recommendations.md "view-asg-recommendations.md")
