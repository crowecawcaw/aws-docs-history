...
Third-party auditors assess the security and compliance of AWS Compute Optimizer as part of
multiple AWS compliance programs. AWS Compute Optimizer is FedRAMP authorized for GovCloud and is in scope for that compliance program.
...
Your compliance responsibility when using Compute Optimizer is determined by the sensitivity
