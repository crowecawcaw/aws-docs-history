# Data protection in AWS Compute Optimizer
...
applies to data protection in AWS Compute Optimizer. As described in this model, AWS is
...
- If you require FIPS 140-2 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form fields such as a **Name** field. This includes when you work with Compute Optimizer or other AWS
