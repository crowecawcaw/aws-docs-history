...
the features that are currently available as recommendation preferences in Compute Optimizer.

- [Rightsizing recommendation preferences](rightsizing-preferences.md "rightsizing-preferences.md")
- [Enhanced infrastructure metrics](enhanced-infrastructure-metrics.md "enhanced-infrastructure-metrics.md")
