...
- At the resource level, you can activate enhanced infrastructure
  ...
  **Instance details** page for an individual EC2 instance provides the
  ...
  instance. For more information, see [Activating enhanced infrastructure metrics at the resource level](activating-eim-resource-level.md "activating-eim-resource-level.md") later in this guide.
...
- For an individual AWS account holder, you can activate
  ...
  For more information, see [Activating enhanced infrastructure metrics at the organization or account level](activating-eim-level.md "activating-eim-level.md") later in this guide.
- The account manager or the delegated administrator of an AWS Organization
  ...
  [Activating enhanced infrastructure metrics at the organization or account level](activating-eim-level.md "activating-eim-level.md") later in this guide.
...
[Confirming the status of enhanced infrastructure metrics](#confirm-eim-status "#confirm-eim-status").
...
consideration, see [Confirming the status of enhanced infrastructure metrics](#confirm-eim-status "#confirm-eim-status").
...
For instructions on how activate or deactivate enhanced infrastructure metrics at the resource level, see [Activating enhanced infrastructure metrics at the resource level](activating-eim-resource-level.md "activating-eim-resource-level.md").

For instructions on how activate or deactivate enhanced infrastructure metrics at the organization or account level, see [Activating enhanced infrastructure metrics at the organization or account level](activating-eim-level.md "activating-eim-level.md").
