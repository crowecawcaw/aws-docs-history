...
Compute Optimizer Automation and your other AWS solutions. AWS provides the following monitoring tools to
watch Compute Optimizer Automation, report when something is wrong, and take automatic actions when
appropriate:
