...
The AWS Compute Optimizer and AWS Cost Optimization Hub services are adding SDK support for the
...
Starting 2026-04-16, the following AWS SDKs will use
...
version released before 2026-04-16.
