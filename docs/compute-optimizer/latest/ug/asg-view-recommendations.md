# Accessing EC2 Amazon EC2 Auto Scaling group recommendations and details

You can use one of the following procedures to access either the **EC2 Amazon EC2 Auto Scaling groups recommendations**
or the **EC2 Amazon EC2 Auto Scaling group details** pages in the AWS Console.

On the **EC2 Amazon EC2 Auto Scaling groups recommendations** page you can view the recommendations for your current EC2 Amazon EC2 Auto Scaling groups. On the
**EC2 Amazon EC2 Auto Scaling group details** page you can view the details of a specific group and its recommendations.

## Procedures

###### To access the EC2 Amazon EC2 Auto Scaling group recommendations page
...
2. Choose **EC2 Amazon EC2 Auto Scaling groups** in the navigation pane.

The recommendations page lists the specifications and finding classifications of your EC2 Amazon EC2 Auto Scaling
groups, along with the specifications of the recommended groups. The current EC2 Amazon EC2 Auto Scaling groups listed
are from the AWS Region that is currently selected, in the selected account. 3. You can perform the following actions on the recommendations page:
    ...
    * Clear the selected filters. To do this, choose **Clear filters** next to the
     filter.
    * Access the **EC2 Amazon EC2 Auto Scaling group details** page for a specific EC2 Amazon EC2 Auto Scaling group. To do this,
     choose the finding classification listed next to the desired group.

###### To access the EC2 Amazon EC2 Auto Scaling group details page

1. Open the Compute Optimizer console at [https://console.aws.amazon.com/compute-optimizer/](https://console.aws.amazon.com/compute-optimizer/ "https://console.aws.amazon.com/compute-optimizer/").
2. Choose **EC2 Amazon EC2 Auto Scaling groups** in the navigation pane.
3. To view the details of a recommendation, select an EC2 Amazon EC2 Auto Scaling group and choose **View details**.
   Or, choose the EC2 Amazon EC2 Auto Scaling group link.

The details page lists up to three optimization recommendations for the EC2 Amazon EC2 Auto Scaling group that
you chose. It lists the specifications of current instances in the EC2 Amazon EC2 Auto Scaling group, the
...
graphs. 4. You can perform the following actions on the details page:
    ...
    * Activate the enhanced infrastructure metrics paid feature to extend the metrics analysis
     look-back period for the Amazon EC2 Auto Scaling group you're viewing up to three months (compared to the 14-day
    ...
    * The utilization metric graphs for your current instance are displayed at the bottom of
     the page. The solid blue line is the utilization of current instances in the Amazon EC2 Auto Scaling
     group.
