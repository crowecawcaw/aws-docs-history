...
| Metric        | Description                                                                                                                                                                                                                                                                                                               |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DBLoad`      | The level of session activity in your database. For more information, see<br>[Database load](../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.ActiveSessions.md "../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.ActiveSessions.md") in the _Amazon Relational Database Service User Guide_. |
...
For more information, see [Amazon CloudWatch metrics for Amazon Aurora](../../../AmazonRDS/latest/AuroraUserGuide/Aurora.AuroraMonitoring.Metrics.md "../../../AmazonRDS/latest/AuroraUserGuide/Aurora.AuroraMonitoring.Metrics.md") in the _Amazon Aurora User Guide_.
...
[Turning Performance Insights on and off for Aurora](../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Enabling.md "../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Enabling.md")
