...
1. Move the SCPs or RCPs under **organization\_policies** under new property **resources**.
...
1. Add a new property **deploy\_method** with the value **scp** or **rcp**. 
...
**Note**  
The **parameter\_file** property is supported in CfCT manifest version *2021-03-15*.