...
| --- | --- | --- | 
| AWS Identity and Access Management | Roles | AWSAFTAdmin<br />AWSAFTExecution<br />AWSAFTService<br />ct-aft-\*<br />aft-\*<br />codebuild\_trigger\_role<br />python-layer-builder-aft-common-\* | 
