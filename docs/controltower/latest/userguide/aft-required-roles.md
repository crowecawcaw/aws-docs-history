...
In general, roles and policies are part of identity and access management (IAM) in AWS.
Refer to the [_AWS IAM User Guide_](../../../IAM/latest/UserGuide/introduction.md "../../../IAM/latest/UserGuide/introduction.md") for more
information.
