...
- To learn more about the capabilities of AWS Control Tower, see [Related
  information](related-information.md "related-information.md").
- From time to time, you may need to update your landing zone to get the latest
  backend updates, the latest controls, and to keep your landing zone up-to-date. For
  more information, see [Configuration update management in AWS Control Tower](configuration-updates.md "configuration-updates.md").
- If you encounter issues while using AWS Control Tower, see [Troubleshooting](troubleshooting.md "troubleshooting.md").

###### Important

If you have not yet enabled MFA for your account's root user, do so now. For
more information about best practices for the root user, see [Best practices to protect your account's root user](../../../accounts/latest/reference/best-practices-root-user.md#bp-root-limit-tasks "../../../accounts/latest/reference/best-practices-root-user.md#bp-root-limit-tasks").
