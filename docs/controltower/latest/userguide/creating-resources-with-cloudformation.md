...
as `AWS::ControlTower::EnabledControl` for controls. CloudFormation provisions and configures those resources for you.

When you use CloudFormation, you can reuse your template to set up your AWS Control Tower resources
...
To view some AWS Control Tower examples for the CLI and the console, see [Enable controls with CloudFormation](enable-controls.md "enable-controls.md").
