# Create AWS Control Tower resources with

AWS CloudFormation

AWS Control Tower is integrated with AWS CloudFormation, a service that helps you to model and set up your
...
as `AWS::ControlTower::EnabledControl` for controls. AWS CloudFormation provisions and configures those resources for you.

When you use AWS CloudFormation, you can reuse your template to set up your AWS Control Tower resources
...
To provision and configure resources for AWS Control Tower and related services, you must understand
[AWS CloudFormation
...
templates for these resource types, see [AWS Control Tower](../../../AWSCloudFormation/latest/UserGuide/AWS_ControlTower.md "../../../AWSCloudFormation/latest/UserGuide/AWS_ControlTower.md") in the
...
To view some AWS Control Tower examples for the CLI and the console, see [Enable controls with AWS CloudFormation](enable-controls.md "enable-controls.md").
