...
Changing your home Region after you have deployed your AWS Control Tower landing zone requires
decommissioning as well as the assistance of AWS Support. This practice is not
recommended.

Learn how to configure and launch your landing zone using the AWS CLI in [Get started with AWS Control Tower using APIs](getting-started-apis.md "getting-started-apis.md").
...
2. In the console, verify that you are working in your desired home Region for
   AWS Control Tower. Then choose **Set up your landing zone**.
