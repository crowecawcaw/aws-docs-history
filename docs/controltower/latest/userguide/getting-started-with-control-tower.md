...
<a name="getting-started-with-control-tower"></a>
...
+ [Setting up your controls dedicated environment](setting-up-controls-dedicated-environment.md)
+ [Get started with AWS Control Tower from the console](getting-started-from-console.md)
+ [Get started with AWS Control Tower using APIs](getting-started-apis.md)
