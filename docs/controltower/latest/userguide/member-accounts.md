...
- [Provision accounts with AWS Control Tower Account Factory for Terraform (AFT)](taf-account-provisioning.md "taf-account-provisioning.md")
- [AWS
...
For information about member account resources that AWS Control Tower allocates, see [Resource Considerations for Account Factory](account-factory-considerations.md "account-factory-considerations.md").
