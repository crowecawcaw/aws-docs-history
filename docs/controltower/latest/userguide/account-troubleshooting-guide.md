...
**Topics**
+ [General issues](#w2aac44c33c47b7)
+ [Issues related to account provisioning/registration](#w2aac44c33c47b9)
+ [Issues related to customizations invocation](#w2aac44c33c47c11)
+ [Issues related to the account customizations workflow](#w2aac44c33c47c13)

## General issues
<a name="w2aac44c33c47b7"></a>
...
+  ** Used incorrect token for HCP Terraform ** 
   ...
   Make sure that you set up the correct token. HCP Terraform only supports team-based tokens, not organization-based tokens. 
