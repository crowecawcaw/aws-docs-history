...
1. On the **Landing zone settings** page,in the **Details** section, choose the **Modify settings** button in the upper right. You are directed to the update landing zone workflow. 

1. Under **Additional governed Regions**, search for the Regions you want to govern (or stop governing).
