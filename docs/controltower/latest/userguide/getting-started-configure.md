...
+ During setup, you can select customized names for the shared accounts that AWS Control Tower creates, called **CloudTrail Administrator** and **Aggregator account** by default.
**Note**  
In Landing Zone versions prior to 4.0, these accounts are named "Log Archive" and "Audit" by default. Customers using earlier versions may still see the original names.
