...
**Topics**
+ [Strongly recommended controls with preventive behavior](strongly-recommended-preventive-controls.md)
+ [Strongly recommended controls with detective behavior](strongly-recommended-detective-controls.md)