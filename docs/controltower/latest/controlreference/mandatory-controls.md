...
**Topics**
+ [Changes in Landing Zone 4.0 controls](#changes-in-landing-zone-40)
+ [Mandatory controls for the Security OU](#mandatory-on-security-ou)
+ [Mandatory controls for all OUs](#mandatory-on-all-ous)
