...
| --- | --- | 
| AWS-GR\_AUDIT\_BUCKET\_ENCRYPTION\_ENABLED | Disallow modification of an Amazon S3 bucket default encryption | 
...
| AWS-GR\_DISALLOW\_VPN\_CONNECTIONS  | Disallow AWS Virtual Private Network (VPN) connections | 
...
| AWS-GR\_RESTRICT\_S3\_CROSS\_REGION\_REPLICATION  | Disallow cross region replication for S3 buckets | 
