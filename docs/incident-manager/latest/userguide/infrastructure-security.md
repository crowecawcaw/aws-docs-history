...
As a managed service, AWS Systems Manager Incident Manager is protected by AWS global network security. For
...
You use AWS published API calls to access Incident Manager through the network. Clients must
