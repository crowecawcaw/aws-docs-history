...
After you define a contact and activate its contact channels, you can add contacts to escalation plans to form a chain of escalation. To learn more about escalation plans, see [Creating an escalation plan for responder engagement in Incident Manager](escalation.md). You can add contacts to a response plan for direct engagement. To learn more about creating response plans, see [Creating and configuring response plans in Incident Manager](response-plans.md).
