...
CodeGuru Profiler provides different visualizations of profiling data to help you identify what code is
...
Use CodeGuru Profiler to help profile your applications in the cloud from a single, centralized
dashboard.

Specifically, you can do the following:

- Troubleshoot latency and CPU utilization issues in your application.
- Learn where you could reduce the infrastructure costs of running your
  application.
...
CodeGuru Profiler currently supports applications written in all Java virtual machine (JVM) languages and runtimes
and Python 3.6 or later. The following table explains which features of CodeGuru Profiler are supported by which
language.
