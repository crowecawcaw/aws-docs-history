...
+ [Internetwork Traffic Privacy](#security-inter-network-privacy)
...
<a name="data-retention"></a>
 ...
 Data received from an agent is aggregated into proﬁles representing ﬁve-minute periods. These are then aggregated into hourly and daily proﬁles. CodeGuru Profiler currently retains ﬁve-minute, hourly, and daily proﬁles for 15 days, 60 days, and three years, respectively. 
