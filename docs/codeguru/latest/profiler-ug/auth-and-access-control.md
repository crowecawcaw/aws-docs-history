...
+ [AWS managed policies for CodeGuru Profiler](security-iam-awsmanpol.md)
...
+ [Using tags to control access to Amazon CodeGuru Profiler resources](auth-and-access-control-using-tags.md)