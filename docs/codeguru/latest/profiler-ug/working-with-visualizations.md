...
<a name="working-with-visualizations"></a>
...
**Topics**
+ [Accessing visualizations](working-with-visualizations-accessing.md)
...
+ [Understanding the summary page](working-with-visualizations-summary-page.md)
+ [Understanding the heap summary](working-with-visualizations-heap-summary.md)
+ [Comparing two time ranges](working-with-visualizations-diff.md)