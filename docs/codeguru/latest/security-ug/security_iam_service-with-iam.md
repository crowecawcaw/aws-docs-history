...
Before you use IAM to manage access to CodeGuru Security, learn what IAM features are
available to use with CodeGuru Security.

| IAM features you can use with Amazon CodeGuru Security                                                                                                   | IAM feature | CodeGuru Security support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------- |
...
To get a high-level view of how CodeGuru Security and other AWS services work with most IAM
features, see [AWS services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_.

## Identity-based

policies for CodeGuru Security
...
policies within CodeGuru Security
...
To see a list of CodeGuru Security actions, see [Actions Defined by Amazon CodeGuru Security](../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions "../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions") in the
...
resources for CodeGuru Security
...
To see a list of CodeGuru Security resource types and their ARNs, see [Resources Defined by Amazon CodeGuru Security](../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-resources-for-iam-policies")
in the _Service Authorization Reference_. To learn with which actions you can
specify the ARN of each resource, see [Actions Defined by Amazon CodeGuru Security](../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions "../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions").
...
condition keys for CodeGuru Security
...
To see a list of CodeGuru Security condition keys, see [Condition Keys for Amazon CodeGuru Security](../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-policy-keys "../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions Defined by Amazon CodeGuru Security](../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions "../../../IAM/latest/UserGuide/list_amazoncodegurusecurity.md#amazoncodegurusecurity-actions-as-permissions").
...
credentials with CodeGuru Security
...
principal permissions for CodeGuru Security
...
Changing the permissions for a service role might break CodeGuru Security functionality.
Edit service roles only when CodeGuru Security provides guidance to do so.

## Service-linked

roles for CodeGuru Security
