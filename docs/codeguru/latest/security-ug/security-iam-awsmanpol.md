...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ------------ |
| [AmazonCodeGuruSecurityScanAccess](#security-iam-awsmanpol-AmazonCodeGuruSecurityScanAccess "#security-iam-awsmanpol-AmazonCodeGuruSecurityScanAccess") –<br>New policy | CodeGuru Security added a new policy that grants permissions to create and view<br>scans and view scan findings. | May 10, 2023 |
