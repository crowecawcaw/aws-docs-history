...
When you sign up for Amazon Web Services (AWS), your AWS account automatically has access to
all AWS services, including Amazon CodeGuru Security. Note that you’re charged only for the services that you
use.
