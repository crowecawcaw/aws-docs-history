...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon CodeGuru Reviewer, see [AWS Services in Scope by Compliance Program](https://aws.amazon.com/compliance/services-in-scope/ "https://aws.amazon.com/compliance/services-in-scope/").
- **Security in the cloud** – Your responsibility is
  ...
  using CodeGuru Reviewer. The following topics show you how to configure CodeGuru Reviewer to meet your security and
