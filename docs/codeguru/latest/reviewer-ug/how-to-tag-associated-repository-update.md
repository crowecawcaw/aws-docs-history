...
- [Add or update tags for a CodeGuru Reviewer associated repository (console)](how-to-tag-associated-repository-update-console.md "how-to-tag-associated-repository-update-console.md")
- [Add or update tags for a CodeGuru Reviewer associated repository (AWS CLI)](how-to-tag-associated-repository-update-cli.md "how-to-tag-associated-repository-update-cli.md")
