...
- [View tags for an
  associated repository (console)](how-to-tag-associated-repository-view-console.md "how-to-tag-associated-repository-view-console.md")
- [View tags for a CodeGuru Reviewer
  associated repository (AWS CLI)](how-to-tag-associated-repository-view-cli.md "how-to-tag-associated-repository-view-cli.md")
