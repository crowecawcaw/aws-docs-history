...
+ **Configure VOD optimization**: Set the **Maximum concurrent ADS requests** setting for VOD streams with multiple ad breaks to reduce server load. For more information, see [Advanced settings](configurations-create.md#configurations-advanced-settings)
