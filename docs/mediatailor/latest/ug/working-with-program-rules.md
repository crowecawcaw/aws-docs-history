...
1. Configure alternate media:
   ...
   + Within the** Alternate media 1** box:
     ...
     + Select either a **VOD** or** Live ** Source Type:
       ...
       + (Optional) a\\Add Ad Breaks. This is done in the same way as when creating programs. For more information, see [Creating a program within a channel schedule using the MediaTailor console](channel-assembly-adding-programs.md).
