...
information about setting up your CDN, see [Using a CDN to optimize MediaTailor ad personalization and content delivery](integrating-cdn.md "integrating-cdn.md").
...
- [Ad transcoding in AWS Elemental MediaTailor](ad-transcoding.md "ad-transcoding.md")
...
- [Working with MediaTailor Monetization Functions](monetization-functions.md "monetization-functions.md")
