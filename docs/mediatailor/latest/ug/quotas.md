...
| PRE_SESSION_INITIALIZATION hook timeout      | 2 seconds                      | The maximum number of seconds that a<br>PRE_SESSION_INITIALIZATION hook execution can take, including all<br>function steps and HTTP calls. If the hook exceeds its timeout,<br>MediaTailor discards all output and proceeds as if no function<br>was executed.                                                                                                                                                                |
| PRE_ADS_REQUEST hook timeout                 | 2 seconds                      | The maximum number of seconds that a PRE_ADS_REQUEST hook<br>execution can take, including all function steps and HTTP calls. If<br>the hook exceeds its timeout, MediaTailor discards all output and<br>proceeds as if no function was executed.                                                                                                                                                                              |
