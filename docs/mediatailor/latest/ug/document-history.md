...
| --- |--- |--- |
| [New analytics dashboard page](analytics-dashboard.md) | Added documentation for the MediaTailor analytics dashboard, a MediaTailor console page that visualizes monetization performance and beacon firing performance across the AWS regions where you run playback configurations. | August 29, 2026 | 
...
| [Automatic server-side authentication with Google's ad platforms](gam-integration.md) | Updated the chapter to reflect that MediaTailor now automatically authenticates server-to-server connections with Google Ad Manager (GAM), Google Campaign Manager (GCM), and Google Display & Video 360 (DV360). No customer action or support ticket is required. Updated the server-side section to describe the URI-based rules MediaTailor applies and removed the manual support ticket procedure. | April 15, 2026 | 
| [Added TPS traffic shaping](tps-traffic-shaping.md) | Updated sections to include information about limiting requests to the ADS based on TPS. | October 2, 2025 | 
| [Added `prefetchScheduleName`](ads-log-format.md) | Added information about `prefetchScheduleName` in the ADS logs. | September 24, 2025 | 
| [Restructured ad skipping troubleshooting guide](troubleshooting-ad-skipping-overview.md) | Restructured troubleshooting guide to focus each section on one specific job to be done. | August 26, 2025 | 
| [Added query parameter handling documentation](manifest-query-parameters.md) | Added section explaining how MediaTailor handles query parameters for origin-specific functionality like time-shifted viewing with MediaPackage. | August 26, 2025 | 
| [SGAI VOD configuration guide](sgai-vod-configuration.md) | Added configuration guidance for server-guided ad insertion with video-on-demand content. | August 7, 2025 | 
| [Integrated parameter troubleshooting guidance](variables.md) | Added comprehensive troubleshooting section covering character restriction errors, length limitation issues, configuration alias problems, parameter processing flow debugging, and security best practices. | August 4, 2025 | 
| [Enhanced parameter formatting documentation](passing-paramters-to-the-ads.md) | Added comprehensive character restrictions, URL-encoding support, and length limitations for manifest query parameters and ADS parameters. | August 1, 2025 | 
| [Enhanced parameter documentation with comprehensive reference](variables.md) | Added comprehensive parameter character restrictions, length limitations, URL-encoding support, configuration aliases documentation, and session initialization methods based on AWS Guide analysis. | August 1, 2025 | 
| [Enhanced manifest query parameters documentation](manifest-query-parameters.md) | Added comprehensive parameter placement behavior, character restrictions, URL-encoding support, and protocol-specific differences based on AWS Guide analysis. | August 1, 2025 | 
| [Enhanced domain variables documentation](variables-domains.md) | Added comprehensive configuration aliases documentation, supported fields, and domain-level parameter rules based on AWS Guide analysis. | August 1, 2025 | 
| [Added event flow troubleshooting guidance](troubleshooting-event-flow.md) | New section providing practical guidance for using MediaTailor event flow analysis to diagnose and resolve ad insertion issues. | July 31, 2025 | 
| [Added ad insertion event flow documentation](mediatailor-event-flow.md) | New section explaining the chronological flow of MediaTailor events during manifest personalization to help users understand the workflow. | July 23, 2025 | 
| [Enhanced client-side tracking workflow documentation](ad-reporting-client-side.md) | Added comprehensive client-side reporting workflow documentation with detailed sequence diagram and step-by-step process explanation. | July 16, 2025 | 
| [CDN integration documentation](integrating-cdn.md) | Added more comprehensive information about setting up a CDN with MediaTailor. | June 30, 2025 | 
| [Added CDN integration for Channel Assembly](channel-assembly.md) | Added documentation for integrating a CDN with Channel Assembly to optimize content delivery. | May 16, 2025 | 
| [HLS playlist types](what-is-terms.md) | Added definitions for HLS multivariant and media playlists. | May 9, 2025 | 
| [DASH manifest types](what-is-terms.md) | Added definitions for DASH manifest components. | May 9, 2025 | 
| [Added HLS playlist type information](manifest-hls-example.md) | Added explanations about multivariant and variant playlists to provide context for the examples. | May 9, 2025 | 
| [Added DASH manifest type information](manifest-dash-example.md) | Added explanations about MPD structure and components to provide context for the examples. | May 9, 2025 | 
| [Added recurring prefetch](prefetching-ads.md) | Updated sections to include information about recurring prefetch schedules. | April 28, 2025 | 
| [Added per-configuration log filtering information](logs-filter.md) | Added information about filtering logs that MediaTailor emits for a configuration. | March 31, 2025 | 
| [Added vended logs information](vended-logs.md) | Added new section about using vended logs for publishing logs that MediaTailor emits.. | February 4, 2025 | 
| [Added preconditioned ads overview](precondition-ads.md) | Added new section that describes how MediaTailor manages ad insertion when you're using preconditioned ads. | January 30, 2025 | 
| [Added ad conditioning](configurations-create.md#configurations-ad-conditioning) | Added the **Streaming media file conditioning** setting. | January 30, 2025 | 
| [SGAI live configuration guide](sgai-live-configuration.md) | Added configuration guidance for server-guided ad insertion with live content. | January 15, 2025 | 
| [Added log types](log-types.md) | Added new section that lists the log types that MediaTailor emits. | January 15, 2025 | 
| [Added log filtering information](logs-filter.md) | Added new section about filtering logs that MediaTailor emits. | January 15, 2025 | 
| [Added supported query parameter formatting](passing-paramters-to-the-ads.md) | Added sections for manifest query parameter and ADS query parameter formatting. | January 2, 2025 | 
| [Integration information for Google Ad Manager](gam-integration.md) | Added a section about integrating MediaTailor with Google Ad Manager from server side and client side. | November 25, 2024 | 
| [Updated variable](ad-behavior-preroll.md) | Changed `breakabilityStartTime` to `availabilityStartTime`. | May 6, 2024 | 
| [Added personalization detail](configurations-create.md#configurations-personalization-details) | Added the `Insertion Mode` personalization detail. | May 6, 2024 | 
| [Program Rules](channel-assembly-programs.md) | Added new content on program rules. | April 25, 2024 | 
| [Updated content on creating channels](channel-assembly-creating-channels.md) | Added information about program rules when creating channels. | April 20, 2024 | 
| [Updated content on adding programs](channel-assembly-programs.md) | Added information about program rules when adding programs. | April 20, 2024 | 
...
| [AlternateMedia and the As Run Log](as-run-log.md) |  Added a note on how AlternateMedia affects the As Run Log. | February 28, 2024 | 
| [Updated manifest settings](channel-assembly-creating-channels.md) | Added information about passthrough tags, depending on the chosen Ad markup type. | November 28, 2023 | 
| [SCTE-35 messages for ad breaks](ca-scte-35-messages.md) | Added information about inserted SCTE-35 tags for `Daterange` versus `Scte35 Enhanced` Ad markup types. | November 28, 2023 | 
| [Key-value pairs for the `Enhanced Scte35` Ad markup type](channel-assembly-adding-programs.md) | Added information about how MediaTailor handles submitted key-value pairs for the `Enhanced Scte35` Ad markup type. | November 28, 2023 | 
| [VOD source ad opportunities](channel-assembly-working-vod-sources.md) | MediaTailor can now automatically detect ad opportunities on VOD sources. | October 6, 2023 | 
| [New Autodetect SigV4 authentication type](channel-assembly-source-locations-access-configuration.md) | MediaTailor now supports the `AUTODETECT_SIGV4` access type. | August 18, 2023 | 
| [Updated client-side tracking content](ad-reporting-client-side.md) | Updated the client-side tracking content to include additional information. | August 12, 2023 | 
| [Setting up MediaTailor and MediaPackage workflows to use live sources](channel-assembly-working-live-sources.md) | Added information on setup, general requirements, and behavior when MediaTailor and AWS Elemental MediaPackage workflows use live sources. | May 24, 2023 | 
| [Manifest query parameters documentation](manifest-query-parameters.md) | Added a section that describes manifest query parameters. | April 26, 2023 | 
| [Overlay ads documentation](overlay-ads.md) | Added a section that describes overlay ads. | April 24, 2023 | 
...
| [Added and corrected channel assembly quotas](quotas.md#channel-assembly-quotas) | Added quotas for logging, channel, live sources, programs, source locations, and channel policies in the MediaTailor channel assembly service. | September 11, 2022 | 
| [New channel assembly alerts table](channel-assembly-alerts.md) | You can now see a table that explains channel assembly alerts. | September 1, 2022 | 
...
| [New absolute transition type](channel-assembly-adding-programs.md) | Added support for absolute transition types, which you can use to set a wall clock start time for your program on linear channels. | September 1, 2021 | 
...
| [Session initialization reporting mode parameter](ad-reporting-client-side.md#session-initialization-reporting-mode) | Added support for the `reportingMode` parameter in session initialization requests. You can now specify whether MediaTailor performs client-side or server-side ad tracking when initializing a session. | July 30, 2020 | 
| [New bumpers topic](bumpers.md) | Added a new bumpers topic | July 27, 2020 | 
| [Ad Suppression is available for DASH](ad-rules.md#ad-suppression) | Ad suppression is now available for DASH. Removed the "HLS-only" restriction from the ad suppression topic. | June 3, 2020 | 
