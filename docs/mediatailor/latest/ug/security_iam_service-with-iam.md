...
To get a high-level view of how MediaTailor and other AWS services work with most
...
The MediaTailor service supports only one type of resource-based policy. It's called a
_channel policy_ because it's attached to a channel.
This policy defines which principals can perform actions on the channel.
...
To see a list of MediaTailor actions, see [Actions defined by AWS Elemental MediaTailor](../../../service-authorization/latest/reference/list_awselementalmediatailor.md#awselementalmediatailor-actions-as-permissions "../../../service-authorization/latest/reference/list_awselementalmediatailor.md#awselementalmediatailor-actions-as-permissions") in the
...
can use a condition key, see [Actions defined by AWS Elemental MediaTailor](../../../service-authorization/latest/reference/list_awselementalmediatailor.md#awselementalmediatailor-actions-as-permissions "../../../service-authorization/latest/reference/list_awselementalmediatailor.md#awselementalmediatailor-actions-as-permissions").

AWS Elemental MediaTailor doesn't provide service-specific condition keys, but it does
support using some global condition keys. To see all AWS global condition keys, see
[AWS Global
Condition Context Keys](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md") in the _AWS Identity and Access Management User
Guide_.
