...
- [Why use AWS CloudFormation](cloudformation-benefits.md "cloudformation-benefits.md")
- [Prepare for
  deployment](prepare-cloudformation-deployment.md "prepare-cloudformation-deployment.md")
- [Deploy the
  template](deploy-cloudformation-template.md "deploy-cloudformation-template.md")
- [Use the deployed
  resources](use-deployed-resources.md "use-deployed-resources.md")
- [Test and validate your
  deployment](test-validate-deployment.md "test-validate-deployment.md")
- [Troubleshoot deployment
  issues](troubleshoot-deployment-issues.md "troubleshoot-deployment-issues.md")
- [Customize the
  template](customize-cloudformation-template.md "customize-cloudformation-template.md")
- [Template
  reference](cloudformation-template-reference.md "cloudformation-template-reference.md")
