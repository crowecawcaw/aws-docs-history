...
- **Security in the cloud** – Your responsibility is
  ...
  using MediaTailor. The following topics show you how to configure MediaTailor to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your MediaTailor resources.

###### Topics

- [Data protection in AWS Elemental MediaTailor](data-protection.md "data-protection.md")
- [Identity and Access Management for AWS Elemental MediaTailor](security-iam.md "security-iam.md")
