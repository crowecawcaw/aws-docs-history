...
- **Failover scenarios:** Implement backup origins
  ...
  implementation, see [Implement multi-Region resilience for MediaTailor with MQAR](media-quality-resiliency.md "media-quality-resiliency.md") and [Plan your CDN integration for AWS Elemental MediaTailor](planning-cdn-integration.md "planning-cdn-integration.md").
...
- **Device-specific optimization:** Optimize
  ...
  comprehensive guidance, see [Set up manifest filtering with MediaTailor, MediaPackage, and CDN](cdn-emp-manifest-filtering.md "cdn-emp-manifest-filtering.md").
- **Load balancing:** Distribute load across
  multiple origins or ad servers using dynamic routing. For implementation
  guidance, see [Implement multi-Region resilience for MediaTailor with MQAR](media-quality-resiliency.md "media-quality-resiliency.md") and [Plan your CDN integration for AWS Elemental MediaTailor](planning-cdn-integration.md "planning-cdn-integration.md").
