...
|   extensions  | Custom extensions of VAST that ad servers use. For more information about extensions, see section 3.18 of the [VAST 4.2 specification](https://iabtechlab.com/standards/vast/).<br />Path: `/avails/ads/extensions`<br />VAST mapping: `VAST/Ad/InLine/Extensions` | Array | [] | 
