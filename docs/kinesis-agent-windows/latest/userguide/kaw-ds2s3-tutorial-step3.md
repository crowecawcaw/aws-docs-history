...
![Screenshot demonstrating how to create a new query window in Athena.](https://docs.aws.amazon.com/kinesis-agent-windows/latest/userguide/images/athena-new-query.png)
...
![Screenshot demonstrating querying log records using Athena.](https://docs.aws.amazon.com/kinesis-agent-windows/latest/userguide/images/athena-first-select.png)
...
![Screenshot demonstrating how to query for specific kinds of records in Athena.](https://docs.aws.amazon.com/kinesis-agent-windows/latest/userguide/images/athena-second-query.png)