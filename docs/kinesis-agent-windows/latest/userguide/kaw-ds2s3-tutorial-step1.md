...
**Topics**
+ [Configure IAM Policies and Roles](#kaw-ds2s3-tutorial-step1.1)
+ [Create the Amazon S3 Bucket](#kaw-ds2s3-tutorial-step1.2)
+ [Create the Firehose Delivery Stream](#kaw-ds2s3-tutorial-step1.3)
+ [Create the Amazon EC2 Instance to Run Kinesis Agent for Windows](#kaw-ds2s3-tutorial-step1.4)
+ [Next Steps](#kaw-ds2s3-tutorial-next)
