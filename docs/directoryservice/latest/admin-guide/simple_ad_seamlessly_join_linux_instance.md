...
computers to the domain. Although members of the _Domain Admins_ or
other groups may have sufficient privileges to join computers to the domain, we do not
recommend this. As a best practice, we recommend you use a service account that has the
