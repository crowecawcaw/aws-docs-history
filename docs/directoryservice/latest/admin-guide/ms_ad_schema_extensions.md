...
<a name="ms_ad_schema_extensions"></a>
...
<a name="ms_ad_schema_when_to_extend"></a>
...
**Topics**
+ [When to extend your AWS Managed Microsoft AD schema](#ms_ad_schema_when_to_extend)
