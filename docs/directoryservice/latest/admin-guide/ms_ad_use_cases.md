...
**Topics**
+ [Use Case 1: Sign in to AWS applications and services with Active Directory credentials](usecase1.md)
+ [Use Case 2: Manage Amazon EC2 instances](usecase2.md)
+ [Use Case 3: Provide directory services to your Active Directory-aware workloads](usecase3.md)
