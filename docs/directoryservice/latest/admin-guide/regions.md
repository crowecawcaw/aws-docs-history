...
For information about using Directory Service in the AWS GovCloud (US-West) Region and
...
For information about using Directory Service in the Beijing and Ningxia Regions, see [Endpoints and ARNs for
