...
**Topics**
+ [Directory Service resources and operations](#CreatingIAMPolicies_DS)
...
+ **Resource** – In a policy, you use an Amazon Resource Name (ARN) to identify the resource to which the policy applies. For Directory Service resources, you always use the wildcard character (\*) in IAM policies. For more information, see [Directory Service resources and operations](#CreatingIAMPolicies_DS). 
