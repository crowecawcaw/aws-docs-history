...
| Connect Customer          | For more information, see the [Connect Customer Administration Guide](../../../connect/latest/adminguide/what-is-amazon-connect.md "../../../connect/latest/adminguide/what-is-amazon-connect.md").                                                                                                                                    |
