...
1. For the confirmation, you should be able to see an event ID 1137 ( Source : Active Directory\_DomainServices), which indicates that the AD has successfully created the new index for the specified attribute.
