...
The AD Connector credentials you provide in AWS Directory Service represent the service account that is
used to access your existing on-premises directory. You can modify the service account
credentials in AWS Directory Service by performing the following steps.

###### Note

If AWS IAM Identity Center is enabled for the directory, AWS Directory Service must transfer the service
