...
**Topics**
+ [Replication and consistency](#replication_consistency)
+ [AWS Directory Service Data attributes](ad_data_attributes.md)
+ [Group type and group scope](ad_group_type_and_scope.md)
