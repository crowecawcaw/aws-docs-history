...
teaches you to use typical Active Directory administration tools to manage your AWS Managed Microsoft AD
environment from your EC2 Windows instance. By the time you complete the tutorial, you will have set
up the network prerequisites and have configured a new AWS Managed Microsoft AD forest.

As shown in the following illustration, the lab you create from this tutorial is the
foundational component for hands-on learning about AWS Managed Microsoft AD. You can later add optional
tutorials for more hands-on experience. This tutorial series is ideal for anyone who is new to
AWS Managed Microsoft AD and wants a test lab for evaluation purposes. This tutorial takes approximately 1
hour to complete.
...
**[Step 2: Create your AWS Managed Microsoft AD Active Directory](microsoftadbasestep2.md "microsoftadbasestep2.md")**

In this step, you set up AWS Managed Microsoft AD in AWS for the first time.

**[Step 3: Deploy an Amazon EC2 instance to manage your AWS Managed Microsoft AD Active Directory](microsoftadbasestep3.md "microsoftadbasestep3.md")**

Here, you walk through the various post-deployment tasks necessary for client
...
the lab is operational, you can continue to add other test lab guide modules.
