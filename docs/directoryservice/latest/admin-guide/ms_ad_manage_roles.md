...
access to manage directories as described in [Identity-based policies (IAM policies)](IAM_Auth_Access_Overview.md#IAM_Auth_Access_ManagingAccess_IdentityBased "IAM_Auth_Access_Overview.md#IAM_Auth_Access_ManagingAccess_IdentityBased"), in order for users in
...
For information about how to grant users access to the AWS Management Console, see [Enabling AWS Management Console access with AWS Managed Microsoft AD credentials](ms_ad_management_console_access.md "ms_ad_management_console_access.md").

###### Topics

- [Creating a new IAM role](create_role.md "create_role.md")
- [Editing the trust relationship for an existing IAM role](edit_trust.md "edit_trust.md")
- [Assigning users or groups to an existing IAM role](assign_role.md "assign_role.md")
