...
Use the following procedure to create a new AWS Managed Microsoft AD user with AWS Directory Service Data in the AWS Management Console, AWS CLI, or AWS Tools for PowerShell.
...
1. After the user is configured, you're taken to the new user's details page. A banner appears stating the user was successfully created.
...
+  Open the AWS CLI, and run the following command with your Directory ID, username, and display name: 
