...
**To seamlessly join an Amazon EC2 Windows
instance**
...
5. In the **Member of** field, select
   **Domain**, enter the fully qualified name of your AWS Managed Microsoft AD Active
...
a backslash (\), and then the username. The username would be **Admin**. For
example, `corp.example.com\admin` or `corp\admin`. 7. After you receive the message welcoming you to the domain, restart the
