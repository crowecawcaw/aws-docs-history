...
**Topics**
+ [Application compatibility for AWS Managed Microsoft AD](ms_ad_app_compatibility.md)
+ [Enabling access to AWS applications and services for your AWS Managed Microsoft AD](ms_ad_enable_apps_services.md)
