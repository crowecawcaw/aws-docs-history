...
tools, see [Ways to join an Amazon EC2 instance to your Simple AD](simple_ad_join_instance.md "simple_ad_join_instance.md").
...
- [Installing the Active Directory Administration Tools for Simple AD](simple_ad_install_ad_tools.md "simple_ad_install_ad_tools.md")
...
- [Resetting a Simple AD user password](simple_ad_manage_users_groups_reset_password.md "simple_ad_manage_users_groups_reset_password.md")
