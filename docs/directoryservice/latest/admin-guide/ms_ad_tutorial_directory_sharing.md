...
prerequisites have been completed, you will share a directory between two AWS accounts.
Then you will learn how to seamlessly join an EC2 instance to a domain in the directory
consumer account.
...
is outside of the AWS organization. For more information about how sharing works, see
[Sharing methods](ms_ad_directory_sharing.md#sharing_methods "ms_ad_directory_sharing.md#sharing_methods").
