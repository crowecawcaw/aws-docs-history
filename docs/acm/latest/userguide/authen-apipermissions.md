...
| [ImportCertificate](../APIReference/API_ImportCertificate.md "../APIReference/API_ImportCertificate.md")                         | `acm:ImportCertificate`         | `arn:aws:acm:`region`:`account`:certificate/*` or `*`         |
...
| [RequestCertificate](../APIReference/API_RequestCertificate.md "../APIReference/API_RequestCertificate.md")                      | `acm:RequestCertificate`        | `arn:aws:acm:`region`:`account`:certificate/*` or `*`         |
