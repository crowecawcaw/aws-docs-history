...
Before you use IAM to manage access to ACM, learn what IAM features are
available to use with ACM.

| IAM features you can use with AWS Certificate Manager                                                                                                                       | IAM feature | ACM support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------- |
...
To get a high-level view of how ACM and other AWS services work with most IAM
...
To view examples of ACM identity-based policies, see [Identity-based policy
examples for AWS Certificate Manager](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
To see a list of ACM actions, see [Actions defined by AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions "../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions") in the
...
To see a list of ACM resource types and their ARNs, see
[Resources defined by AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions "../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions").
...
To see a list of ACM condition keys, see [Condition keys for AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-policy-keys "../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions "../../../service-authorization/latest/reference/list_awscertificatemanager.md#awscertificatemanager-actions-as-permissions").
...
Changing the permissions for a service role might break ACM functionality.
Edit service roles only when ACM provides guidance to do so.
