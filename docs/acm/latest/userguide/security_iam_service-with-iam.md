...
To view examples of ACM identity-based policies, see [Identity-based policy examples for AWS Certificate Manager](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
