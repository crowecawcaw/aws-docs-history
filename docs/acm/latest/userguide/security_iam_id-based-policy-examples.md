...
For details about actions and resource types defined by ACM, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for AWS Certificate Manager](../../../service-authorization/latest/reference/list_awscertificatemanager.md "../../../service-authorization/latest/reference/list_awscertificatemanager.md") in the _Service Authorization Reference_.
...
To ensure that users and roles can still use the ACM console, also attach the
ACM `AWSCertificateManagerReadOnly` AWS managed policy to
...
The following policy allows a user to list all of the ACM certificates in
the user's account.
