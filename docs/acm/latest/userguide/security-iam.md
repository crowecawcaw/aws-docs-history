...
- [ACM API permissions: Actions and resources
  reference](authen-apipermissions.md "authen-apipermissions.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS Certificate Manager identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
