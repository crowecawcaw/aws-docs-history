...
For more information about AWS Cost and Usage Reports, see the [_Cost and Usage Report Guide_](../../../cur/latest/userguide/what-is-cur.md "../../../cur/latest/userguide/what-is-cur.md").
...
For more information about AWS CloudTrail, see the [Logging Billing and Cost Management API calls with AWS CloudTrail](logging-using-cloudtrail.md "logging-using-cloudtrail.md").
