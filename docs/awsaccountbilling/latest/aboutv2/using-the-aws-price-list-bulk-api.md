...
For more information, see [Getting price list files manually](using-the-aws-price-list-bulk-api-fetching-price-list-files-manually.md "using-the-aws-price-list-bulk-api-fetching-price-list-files-manually.md").
...
the [GetPriceListFileUrl](../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md "../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md") API
...
For more information about this API operation, see [ListPriceLists](../../../aws-cost-management/latest/APIReference/API_pricing_ListPriceLists.md "../../../aws-cost-management/latest/APIReference/API_pricing_ListPriceLists.md") and [language-specific AWS SDKs](../../../aws-cost-management/latest/APIReference/API_pricing_ListPriceLists.md#API_pricing_ListPriceLists_SeeAlso "../../../aws-cost-management/latest/APIReference/API_pricing_ListPriceLists.md#API_pricing_ListPriceLists_SeeAlso") in the
_AWS Billing and Cost Management API Reference_.
...
you retrieved from the `ListPriceLists` response in [step 1](#price-bulk-api-step-1-find-available-services "#price-bulk-api-step-1-find-available-services") and [step
2](#price-list-bulk-api-step-2-find-available-price-list-files "#price-list-bulk-api-step-2-find-available-price-list-files")
...
- [GetPriceListFileUrl](../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md "../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md") and [language-specific AWS SDKs](../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md#API_pricing_GetPriceListFileUrl_SeeAlso "../../../aws-cost-management/latest/APIReference/API_pricing_GetPriceListFileUrl.md#API_pricing_GetPriceListFileUrl_SeeAlso") in the
  _AWS Billing and Cost Management API Reference_
- [Reading the price list files](bulk-api-reading-price-list-files.md "bulk-api-reading-price-list-files.md")
