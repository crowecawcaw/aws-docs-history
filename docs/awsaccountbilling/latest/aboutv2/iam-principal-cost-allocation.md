...
1. Open the Billing and AWS Cost Management console at [https://console.aws.amazon.com/costmanagement/](https://console.aws.amazon.com/costmanagement/ "https://console.aws.amazon.com/costmanagement/").
...
Column documentation](../../../cur/latest/userguide/table-dictionary-cur2-tag-columns.md "../../../cur/latest/userguide/table-dictionary-cur2-tag-columns.md").
