...
multiple AWS compliance programs. Billing and Cost Management is not in scope of any AWS compliance programs.
...
Your compliance responsibility when using Billing and Cost Management is determined by the sensitivity
