...
You use AWS published API calls to access AWS Health through the network. Clients
must support Transport Layer Security (TLS) 1.0 or later. We recommend TLS 1.2 or later.
