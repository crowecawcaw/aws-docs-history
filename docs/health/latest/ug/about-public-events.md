...
To view an example public event for Amazon Elastic Compute Cloud, see [Public Health Event - Amazon EC2 operational issue](aws-health-events-eventbridge-schema.md#amazon-ec2-operational-issue "aws-health-events-eventbridge-schema.md#amazon-ec2-operational-issue").
