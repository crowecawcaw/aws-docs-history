...
Any EventBridge rules that you create can only receive notifications for your AWS account. To receive organizational events for other accounts within your AWS Organizations, see [Aggregating AWS Health events using organizational view and delegated administrator access](https://docs.aws.amazon.com/health/latest/ug/aggregating-health-events.html).
...
**Topics**
+ [Creating EventBridge rules for AWS Region coverage](choosing-a-region.md)
+ [Monitoring account-specific and public events for AWS Health](about-public-events.md)
+ [Viewing paginated lists of AWS Health events on EventBridge](pagnation-of-health-events.md)
+ [Aggregating AWS Health events using organizational view and delegated administrator access](aggregating-health-events.md)
+ [Integrating AWS Health event monitoring and notifications with JIRA and ServiceNow](SMC-integration.md)
+ [Configuring an EventBridge rule to send notifications about events in AWS Health](creating-event-bridge-events-rule-for-aws-health.md)
