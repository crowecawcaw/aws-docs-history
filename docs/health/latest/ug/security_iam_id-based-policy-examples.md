...
- [Accessing the AWS Health Dashboard and the AWS Health API](#security_iam_id-based-policy-examples-access-dashboard "#security_iam_id-based-policy-examples-access-dashboard")
