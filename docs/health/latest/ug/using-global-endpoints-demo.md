...
**Topics**
+ [Demo: Retrieving the last seven days of AWS Health event data using Java](#using-the-java-sample-code)
+ [Demo: Retrieving the last seven days of AWS Health event data using Python](#using-the-python-code)
