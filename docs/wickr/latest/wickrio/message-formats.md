...
| Modify private property         | 4014                                                                                       | All of the messages are represented using JSON. The following table describes the possible fields that are contained in the message JSON. ###### Note The edit messages are only seen by the compliance bot installations (Wickr Enterprise) or by the data retention bot (AWS Wickr). |
| Field                           | Description                                                                                |
| ---                             | ---                                                                                        |
