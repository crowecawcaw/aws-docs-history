...
<a name="wickr-io-translation-bot"></a>

## Prerequisites
<a name="translation-prerequisites"></a>
...
<a name="deploy-translation-bot"></a>

Complete the following procedure to deploy a translation bot.

**Step 1: Deploy and configure**

1. Deploy and configure `wickrio-translation-bot` container on your host. For more information, see [wickrio-translation-bot ](https://www.npmjs.com/package/@wickr-sample-integrations/wickrio-translation-bot).

1. Start the docker image on your host

   ```
   docker run -v ~/WickrIO:/opt/WickrIO -v /home/ubuntu/
           credentials/translation/.aws:/home/wickriouser/.aws -ti public.ecr.aws/
...
![The Wickr IO translation bot add command.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-translation-add.png)

1. Over the next several prompts, enter the username and password created in the previous steps.  
![The Wickr IO translation bot credentials prompt.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-translation-credentials.png)

1. You are prompted to select an integration. Type `@wickr-sample-integrations/wickrio-translation-bot`

1. Next, you are prompted for the AWS Region, and for the name of your profile in your credentials file that you set up earlier. If you are unsure of the AWS Region, you can use US East (N. Virginia)(us-east-1). AWS Wickr is available in the following regions: [AWS Wickr Regional availability](https://docs.aws.amazon.com/wickr/latest/adminguide/what-is-wickr.html#regional-availability).  
![The Wickr IO translation bot region selection.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-translation-region.png)
...
![The Wickr IO translation bot search.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-translation-search.png)
...
![The Wickr IO translation bot conversation.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-translationbot.png)