...
<a name="aws-wickr-managed-integrations"></a>
...
+ **Broadcast bot** - This integration allows a user or administrator to quickly send or broadcast messages to any number of users. These messages can prompt recipients for acknowledgement, prompt them to share their location with the sender, and repeat until the recipient confirms receipt. For more information, see [BroadcastBot Integration](https://docs.aws.amazon.com/wickr/latest/wickrio/broadcastbot-integration.html).
+ **Web-Interface bot** - This integration is the oﬃcial Wickr IO Web API tool. Provides an endpoint to send HTTP requests to communicate with the Wickr IO API. This also makes it possible to create Wickr integrations using any programming language. For more information, see [Web Interface Integration](https://docs.aws.amazon.com/wickr/latest/wickrio/webinterface-integration.html)