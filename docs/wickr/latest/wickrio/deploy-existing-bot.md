...
![The Wickr IO demo add command.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-deploy.png)
...
![The Wickr IO sample bot image.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-integration.png)

1. Start the bot by doing the following:

   1. Use the **list** command to view a list of available bots.  
![The Wickr IO list command output.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-list-command.png)
...
![The Wickr IO start command output.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-start-command.png)

1. Interact with the bot:

   1. Using your Wickr user, choose the **New Direct Message** button.  
![The Wickr IO new message button.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-new-message.png)

   1. In the search bar, search for your bot by display name.  
![The Wickr IO search for bot.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-search-bot.png)

   1. Select your bot for a direct message, and send a message.  
![The Wickr IO bot conversation.](https://docs.aws.amazon.com/wickr/latest/wickrio/images/wickrio-bot-conversation.png)