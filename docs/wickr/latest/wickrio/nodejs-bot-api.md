...
**Parameters:**  
+ client\_username(REQUIRED) - The string user name of the Wickr IO client that is going to be used.
**Example:**  
...
For more information, see [Receive Asynchronous Messages](addon-bot-api-usage-examples.md#receive-asynchronous-messages).
