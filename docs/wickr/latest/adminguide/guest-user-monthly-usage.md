...
You can view the number of guest users your network has communicated with during a
billing period.

Complete the following procedure to view your monthly usage for your Wickr
network.
...
The **Guest users** tab displays the guest users monthly
usage.
