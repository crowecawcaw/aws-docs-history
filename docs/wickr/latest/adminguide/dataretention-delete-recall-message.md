...
<a name="dataretention-delete-recall-message"></a>

The **isrecall** field shows whether the message was recalled (visible to all participants) or only deleted locally.
