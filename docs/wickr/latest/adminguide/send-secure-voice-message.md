...
![Push-to-talk icon.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-wickr-push-to-talk-icon.png)

1. Select and hold the **Hold Button Down to Record** button.  
![Record button.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-secure-voice-message.png)
