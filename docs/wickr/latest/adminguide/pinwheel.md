...
![Wickr icon.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-pinwheel-wickr-icon.png)

1. On the pinwheel, choose one of the following icons:
   + **Phone**: Choose to call.  
![Pinwheel call icon.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-pinwheel-call.png)
   + **Message**: Choose to chat.  
![Pinwheel chat icon.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-pinwheel-message.png)
   + **File send**: Choose to send a file.  
![Pinwheel send a file icon.](https://docs.aws.amazon.com/wickr/latest/adminguide/images/atak-pinwheel-send.png)