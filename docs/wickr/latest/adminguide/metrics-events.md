...
- [CloudWatch metrics for your Wickr network](cloudwatch-metrics.md "cloudwatch-metrics.md")
- [Amazon SNS events for your Wickr network](sns-events.md "sns-events.md")
