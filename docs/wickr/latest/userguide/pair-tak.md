...
![Pair the Wickr client.](images/atak_pair_wickr.png)
...
![Pending connected applications in the Wickr client.](images/atak_connected_apps_pending.png) 3. Choose **Approve** to pair.

![Connected apps approval screen.](images/atak_connected_apps_pending_approve.png) 4. Choose **Open Wickr ATAK Plugin** button to go back to the
ATAK application.

![Connected apps success screen.](images/atak_connected_apps_success.png)
