...
**The following file types can be opened directly from the Wickr application**. All other file types must be saved to your hard drive to prevent Wickr from opening potentially harmful files.
+ pdf
+ doc
+ docx
+ html
