...
1. Download and install the Wickr client. For more information, see [Download and install the Wickr client](getting-started.md#accept-invitation-step1).
...
**Note**  
If you are a guest user, you can become a Wickr network user by creating a network. For more information, see [ Getting started with AWS Wickr ](https://docs.aws.amazon.com/wickr/latest/adminguide/getting-started.html) in the *AWS Wickr Administration Guide*.