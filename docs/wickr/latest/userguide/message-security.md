...
![The Security Verification option.](images/wickr-emoji-security-verification.png)
...
![The Verify Contact screen.](images/wickr-emoji-contact-details-verify-contact.png) 5. If the other Wickr user confirms that the QR or verification codes match,
