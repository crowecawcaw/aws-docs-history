...
# Account in the Wickr client
<a name="account"></a>

You can access the account section of the Wickr client, where you can update your avatar, add your phone number, change the password, and choose to show your status.

Complete the following steps to access the account section of the Wickr client. 
...
1. Choose one of the following options:
   ...
   + **Show My Status** — Enable the toggle to display your status to other Wickr users.