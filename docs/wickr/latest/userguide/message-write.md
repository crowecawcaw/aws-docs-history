...
![The New Direct Message option.](images/wickr-emoji-new-direct-message.png) 3. In the **Direct Message** dialog box, search contacts and
directory for the user that you want to
message.

![The Direct Message dialog box.](images/wickr-emoji-direct-message.png) 4. When you find the contact that you want to message, choose their name to open
a new message window. 5. Type your message into the text box and select **Enter** to
send it.

You can also choose the plus icon (
![Plus symbol icon representing an addition or new item action.](images/icon-wickr-message-file-location.png)
) to send a file, share your location, or view quick
responses.

![Send file, share your location, or quick responses icon](images/wickr-emoji-send-file-option.png)
