...
![The data retention prompt in the Wickr client.](https://docs.aws.amazon.com/wickr/latest/userguide/images/wickr-data-retention-prompt.png)
...
![The data retention control message in the Wickr client.](https://docs.aws.amazon.com/wickr/latest/userguide/images/wickr-data-retention-control-prompt.png)
