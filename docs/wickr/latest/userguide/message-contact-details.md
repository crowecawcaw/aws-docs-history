...
# View message contact details in the Wickr client
<a name="message-contact-details"></a>

You can view message contact details and message settings in the Wickr client.
