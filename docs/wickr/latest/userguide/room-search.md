...
# Search for files or messages in the Wickr client
<a name="room-search"></a>

You can search for files or messages in a room, group, or conversation using the Wickr client.
