...
| Ordered list  | Add line items with numbers, starting with 1, followed by a period.<br>1. item 1<br>2. item 2               |
| Bullet list   | Add an asterisk followed by a space.<br>\<br>• item 1<br>\<br>• item 2                                      |
| Headings      | Add number signs in front of a word.<br># Heading                                                           |
| Hyperlink     | Add square brackets with link text, followed by the URL in parentheses.<br>[Amazon](https://www.amazon.com) |
...
4. In the **Appearance** pane that appears, turn off the toggle in the **New User
   Experience Preview** section to disable.
   **On mobile**:
