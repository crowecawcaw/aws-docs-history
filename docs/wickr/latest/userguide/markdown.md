...
| Bullet list | Add an asterisk followed by a space. <br />\* item 1<br />\* item 2 | 
...
1. In the navigation pane, choose the menu icon (![Menu icon](https://docs.aws.amazon.com/wickr/latest/userguide/images/icon-wickr-settings-hamburger.png)), and then choose **Settings**. 

1. Choose **Appearance**.

1. In the **Appearance** pane that appears, turn off the toggle in the **New User Experience Preview** section to disable.
...
1. In the **Appearance** pane that appears, turn off the toggle in the **Rich Text Editor Preview** section to disable.