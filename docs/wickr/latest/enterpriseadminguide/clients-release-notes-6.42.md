...
<a name="clients-release-notes-6.42"></a>

The following release notes include information for clients release 6.42. For information on the release timeline, see [Change log](#clients-release-notes-6.42-change-log).
...
## Change log
<a name="clients-release-notes-6.42-change-log"></a>
...
| --- | --- | --- | 
| Clients update | Updates to address vulnerability scan results and improvements. | September 16, 2024 | 
