...
<a name="infra-release-notes-6.36"></a>

The following release notes include information for infrastructure release 6.36. For information on the release timeline, see [Change log](#infra-release-notes-6.36-change-log).
...
|  |  | 
| --- | --- | 
| Infrastructure | 6.36.1 <br />Replicated Native Scheduler (1940)<br />Replicated KOTS (1486) | 
...
## Change log
<a name="infra-release-notes-6.36-change-log"></a>
...
| Infrastructure update | Updates to address vulnerability scan results and new features | April 25, 2024 | 
