...
<a name="clients-release-notes-6.34"></a>

The following release notes include information for clients release 6.34. For information on the release timeline, see [Change log](#clients-release-notes-6.34-change-log).
...
## Change log
<a name="clients-release-notes-6.34-change-log"></a>
