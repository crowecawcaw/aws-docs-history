...
# Bots 6.24 release
<a name="bots-release-notes-6.24"></a>

The following release notes include information for bots release 6.24. For information on the release timeline, see [Change log](#bots-release-notes-6.24-change-log).
...
## Change log
<a name="bots-release-notes-6.24-change-log"></a>
