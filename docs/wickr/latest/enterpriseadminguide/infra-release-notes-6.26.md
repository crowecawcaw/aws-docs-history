...
<a name="infra-release-notes-6.26"></a>

The following release notes include information for infrastructure release 6.26. For information on the release timeline, see [Change log](#infra-release-notes-6.26-change-log).
...
## Change log
<a name="infra-release-notes-6.26-change-log"></a>
