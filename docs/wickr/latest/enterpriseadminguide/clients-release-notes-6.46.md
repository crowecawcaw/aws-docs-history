...
The following release notes include information for clients release 6.46. For information on
the release timeline, see [Change log](#clients-release-notes-6.46-change-log "#clients-release-notes-6.46-change-log").
...
| --------------- | --------------------------------------------------------------- | ---------------- |
| Clients update  | Updates to address vulnerability scan results and improvements. | October 21, 2024 |
