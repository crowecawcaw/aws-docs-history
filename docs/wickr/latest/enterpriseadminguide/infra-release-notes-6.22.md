...
<a name="infra-release-notes-6.22"></a>

The following release notes include information for infrastructure release 6.22. For information on the release timeline, see [Change log](#infra-release-notes-6.22-change-log).
...
## Change log
<a name="infra-release-notes-6.22-change-log"></a>
