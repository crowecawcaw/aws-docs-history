...
The files and links are only used for the initial connection to Enterprise config files and must be password protected, as the information within is encrypted. This allows the client to establish a connection to the Enterprise service, but a user must still have a valid username and password to complete the Registration or Sign In process.
