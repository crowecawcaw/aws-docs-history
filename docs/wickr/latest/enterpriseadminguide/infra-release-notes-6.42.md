...
<a name="infra-release-notes-6.42"></a>

The following release notes include information for infrastructure release 6.42. For information on the release timeline, see [Change log](#infra-release-notes-6.42-change-log).
...
1. The primary device is an Android.

1. The Wickr app is running in the background.

1. No recent messages have been received by the Wickr app.
...
## Change log
<a name="infra-release-notes-6.42-change-log"></a>
