...
<a name="clients-release-notes-6.28"></a>

The following release notes include information for clients release 6.28. For information on the release timeline, see [Change log](#clients-release-notes-6.28-change-log).
...
## Change log
<a name="clients-release-notes-6.28-change-log"></a>
