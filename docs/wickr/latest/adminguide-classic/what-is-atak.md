...
**Topics**
+ [Enable ATAK in the Wickr Network Dashboard](#atak)
+ [Additional information about ATAK](#additional-information)
+ [Install and pair the Wickr plugin for ATAK](install-and-pair.md)
+ [Unpair the Wickr Plugin for ATAK](unpair.md)
+ [Dial and receive a call in ATAK](dial-and-receive-call.md)
+ [Send a file in ATAK](send-a-file.md)
+ [Send a secure voice message (Push-to-talk) in ATAK](send-secure-voice-message.md)
+ [Pinwheel (Quick Access) for ATAK](pinwheel.md)
+ [Navigation for ATAK](navigation.md)
...
1. Choose **Details** next to desired security group for which you want to enable ATAK.

1. On the **General** tab, choose **Edit**.

1. In the **ATAK Functionality** section:
   ...
   1. Slide the **ATAK** toggle to the right to turn on the functionality.

   1. Choose **Save**.  
![The ATAK Functionality section of the Wickr Network Dashboard.](https://docs.aws.amazon.com/wickr/latest/adminguide-classic/images/atak_functionality_toggle.png)
