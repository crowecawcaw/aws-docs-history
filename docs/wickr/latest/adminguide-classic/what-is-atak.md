...
**Edit**. 6. In the **ATAK Functionality** section:

    1. Enter the package name in the **Packages** text
     ...
     version of the ATAK that your users will install and use:
    	...
    	* `com.atakmap.app.mil` — Enter this value
    	 ...
    	 version of the ATAK application on their Android
    	 devices.
    2. Slide the **ATAK** toggle to the right to turn on
     the functionality.
    3. Choose **Save**.



    ![The ATAK Functionality section of the Wickr Network Dashboard.](images/atak_functionality_toggle.png)ATAK is now enabled for the selected Wickr Network, and the selected
