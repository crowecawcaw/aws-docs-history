...
+ **Security of the cloud** – AWS is responsible for protecting the infrastructure that runs AWS services in the AWS Cloud. AWS also provides you with services that you can use securely. Third-party auditors regularly test and verify the effectiveness of our security as part of the [AWS Compliance Programs](https://aws.amazon.com/compliance/programs/). To learn about the compliance programs that apply to AWS Wickr, see [AWS Services in Scope by Compliance Program](https://aws.amazon.com/compliance/services-in-scope/).
...
**Topics**
+ [Data protection in AWS Wickr](data-protection.md)
+ [Identity and access management for AWS Wickr](security-iam.md)
+ [Compliance validation](compliance-validation.md)
+ [Resilience in AWS Wickr](disaster-recovery-resiliency.md)
+ [Infrastructure Security in AWS Wickr](infrastructure-security.md)
+ [Configuration and vulnerability analysis in AWS Wickr](vulnerability-analysis-and-management.md)
+ [Security best practices for AWS Wickr](security-best-practices.md)