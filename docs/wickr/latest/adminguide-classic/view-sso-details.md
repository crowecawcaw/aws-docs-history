...
You can view the details of your single sign-on configuration for your Wickr
network and the network endpoint.

Complete the following procedure to view the current single sign-on configuration
for your Wickr network, if any.
...
**Network Settings**, and then choose **SSO
Configuration**.

The **Single Sign-on & LDAP Configuration** page
displays your Wickr network endpoint and current SSO configuration.
