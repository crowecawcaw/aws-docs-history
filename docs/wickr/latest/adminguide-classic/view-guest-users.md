...
Complete the following procedure to view the guest user count for your Wickr
network.
...
2. On the **Networks** page, choose the
   **Admin** link, to navigate to the Wickr Admin Console for
   that network.

You're redirected to the Wickr Admin Console for a specific network. The
