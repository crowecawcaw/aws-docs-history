...
![Push-to-talk icon.](images/atak-wickr-push-to-talk-icon.png) 3. Select and hold the **Hold Button Down to Record**
button.

![Record button.](images/atak-secure-voice-message.png) 4. Record your message. 5. After you record your message, release the button to send.
