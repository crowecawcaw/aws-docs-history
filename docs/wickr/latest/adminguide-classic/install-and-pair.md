...
1. In the ATAK application, choose the menu icon (![Menu icon](https://docs.aws.amazon.com/wickr/latest/adminguide-classic/images/atak_hamburger_icon.png)) at the top-right of the screen, and then choose **Plugins**.
...
1. In the ATAK application, choose the menu icon (![Menu icon](https://docs.aws.amazon.com/wickr/latest/adminguide-classic/images/atak_hamburger_icon.png)) at the top-right of the screen, and then choose **Wickr Plugin**.
