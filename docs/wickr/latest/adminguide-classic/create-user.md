...
# Create a user in AWS Wickr network
<a name="create-user"></a>

You can create a user in your Wickr network.

Complete the following procedure to create a user in your Wickr network.
...
1. In the form that appears, enter the user's first name, last name, country code, phone number, and email address. Email address is the only field that is required. Be sure to choose the appropriate security group for the user. Wickr will send an invitation email to the address you specify for the user.
