...
In addition to the AWS global infrastructure, Wickr offers several features to help support your data resiliency and backup needs. For more information, see [Data retention for AWS Wickr](data-retention.md).