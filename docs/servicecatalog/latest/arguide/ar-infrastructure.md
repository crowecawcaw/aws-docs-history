...
As a managed service, AWS Service Catalog AppRegistry is protected by AWS global network security. For
...
You use AWS published API calls to access AppRegistry through the network. Clients must
