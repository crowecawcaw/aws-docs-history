...
**Topics**
+ [Tag-sync task required permissions](#tag-sync-role)
+ [Create a tag-sync task](#create-tag-sync)

## Tag-sync task required permissions
<a name="tag-sync-role"></a>
