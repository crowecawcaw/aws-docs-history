...
<a name="enduser-update-pp-properties"></a>
 ...
 You can change the owner of a provisioned product at any time. You need to know the user's ARN or the role you want to set as the new owner. 
...
1. Select the provisioned product to update, choose the **Actions** tab, and then select **Change owner**. You can also find the **Change owner** option on the detail page of the provisioned product.
