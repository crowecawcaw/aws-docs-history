...
| Launch constraints            | Inherited. If the portfolio creator adds launch constraints to or removes launch constraints from a _shared product_, the change propagates to all imported instances of the product. If the recipient administrator adds an imported product to their _local_ portfolio, that imported launch constraint is not carried over to the shared portfolio.  | In a local portfolio, the administrator can apply launch constraints that affect the _local_ launch of the product. | Add launch constraints to or remove launch constraints from the imported portfolio.              |
