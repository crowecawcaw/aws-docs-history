...
1. Choose **Edit** for either the light mode or dark mode branding preferences. 

1. Upload a **Logo**, enter a **Brand name**, and then select the **Primary color** and **Secondary color**. 

1. Choose **Save**. 

For a list of regions where AWS Service Catalog supports console branding, review [AWS Region support for console branding](branding-supported-regions.md). 