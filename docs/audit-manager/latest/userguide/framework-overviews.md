...
+ [ACSC ISM 02 March 2023](acsc-information-security-manual.md)
+ [AWS Audit Manager Sample Framework](Sample.md)
+ [AWS Control Tower Guardrails](controltower.md)
...
+ [AWS Operational Best Practices](OBP.md)
...
+ [CIS AWS Benchmark v1.3.0](CIS-1-3.md)
...
+ [GDPR 2016](GDPR.md)
+ [Gramm-Leach-Bliley Act](gramm-leach-bliley-act.md)
+ [Title 21 CFR Part 11](GxP.md)
+ [EU GMP Annex 11, v1](GxP-EU-Annex-11.md)
+ [HIPAA Security Rule: Feb 2003](HIPAA.md)
+ [HIPAA Omnibus Final Rule](HIPAA-omnibus-rule.md)
+ [ISO/IEC 27001:2013 Annex A](iso-27001-2013.md)
