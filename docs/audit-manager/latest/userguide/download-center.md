...
- [Browsing the download center](download-center.md#browse-download-center "download-center.md#browse-download-center")
- [Downloading a file](download-center.md#download-a-file "download-center.md#download-a-file")
- [Deleting a file](download-center.md#delete-assessment-report-steps "download-center.md#delete-assessment-report-steps")
- [Additional resources](download-center.md#download-center-additional-resources "download-center.md#download-center-additional-resources")
...
4. Choose the **Exports** tab to view the CSV exports that are available to
   ...
   - This tab shows the evidence finder search results that you exported in the last
     ...
     destination](settings-export-destination.md "settings-export-destination.md") S3 bucket. For instructions on how to find an evidence finder
     CSV export in your S3 destination bucket, see [Viewing your results after you've exported them](exporting-search-results-from-evidence-finder.md#viewing-results-after-export "exporting-search-results-from-evidence-finder.md#viewing-results-after-export").
   ...
   | **Ready**       | The export succeeded and the file is available for you to<br>download.                                                                                                                                                                                 |
   | **Error**       | The export failed. In this case, Audit Manager displays a message that describes<br>the error.<br>For information about how to resolve these errors, see [csv-exports](evidence-finder-issues.md#csv-exports "evidence-finder-issues.md#csv-exports"). |
...
[Downloading an object](../../../AmazonS3/latest/userguide/download-objects.md "../../../AmazonS3/latest/userguide/download-objects.md") in the _Amazon Simple Storage Service (Amazon S3) User
Guide_.
...
[Deleting
Amazon S3 objects](../../../AmazonS3/latest/userguide/DeletingObjects.md "../../../AmazonS3/latest/userguide/DeletingObjects.md") in the _Amazon Simple Storage Service (Amazon S3) User
Guide_.
