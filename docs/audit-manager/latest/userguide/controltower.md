...
as data source mappings in this standard framework, download the [AuditManager_ConfigDataSourceMappings_AWS-Control-Tower-Guardrails.zip](samples/AuditManager_ConfigDataSourceMappings_AWS-Control-Tower-Guardrails.zip.md "samples/AuditManager_ConfigDataSourceMappings_AWS-Control-Tower-Guardrails.zip.md")
file.
