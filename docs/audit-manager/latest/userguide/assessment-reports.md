...
**Contents**
+ [Understanding the assessment report folder structure](#assessment-report-folder-structure)
+ [Navigating an assessment report](#assessment-report-how-to-navigate)
+ [Reviewing the sections of an assessment report](#assessment-report-sections)
  + [Cover page](#assessment-report-cover-page)
  + [Overview page](#assessment-report-overview)
    + [Report summary](#assessment-report-overview-summary)
    + [Assessment summary](#assessment-report-overview-assessment-summary)
  + [Table of contents page](#assessment-report-toc)
  + [Control page](#assessment-report-control)
    + [Control summary](#assessment-report-control-summary)
    + [Collected evidence](#assessment-report-selection)
  + [Evidence summary page](#assessment-report-evidence-summary)
  + [Evidence detail page](#assessment-report-evidence-detail)
+ [Validating an assessment report](#assessment-report-integrity)
+ [Additional resources](#troubleshooting-assessment-reports)

## Understanding the assessment report folder structure
<a name="assessment-report-folder-structure"></a>
...
+ **Assessment folder** (example: `myAssessmentName-a1b2c3d4`) – The root folder. 
  + **Assessment report folder** (example: `reportName-a1b2c3d4e5f6g7`) – A subfolder where you can find the AssessmentReportSummary.pdf, digest.txt, and README.txt files. 
    + **Evidence by control folder** (example: `controlName-a1b2c3d4e5f6g`) – A subfolder that groups evidence files by the related control.
      + **Evidence by data source folder** (example: `CloudTrail`, `Security Hub CSPM`) – A subfolder that groups evidence files by the data source type. 
...
<a name="assessment-report-how-to-navigate"></a>
...
<a name="assessment-report-sections"></a>
...
### Cover page
<a name="assessment-report-cover-page"></a>
...
#### Assessment summary
<a name="assessment-report-overview-assessment-summary"></a>
...
<a name="assessment-report-toc"></a>
...
### Control page
<a name="assessment-report-control"></a>
...
#### Control summary
<a name="assessment-report-control-summary"></a>
...
#### Collected evidence
<a name="assessment-report-selection"></a>
...
+ For automated evidence that's collected from AWS Security Hub CSPM or AWS Config, a **Compliant**, **Non-compliant**, or **Inconclusive** result is reported. 
...
<a name="assessment-report-evidence-summary"></a>
...
<a name="assessment-report-integrity"></a>
...
To validate the integrity of an assessment report, use the [ValidateAssessmentReportIntegrity](https://docs.aws.amazon.com/audit-manager/latest/APIReference/API_ValidateAssessmentReportIntegrity.html) API that's provided by Audit Manager.

## Additional resources
<a name="troubleshooting-assessment-reports"></a>
