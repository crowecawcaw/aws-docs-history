...
| --------------------------------------------------------------------------------------------- | ---------------------------- | ------------------------- | ---------------------- |
| NIST 800-53 Rev 5: Security and Privacy Controls for Information Systems and<br>Organizations | 132                          | 875                       | 20                     |
...
as data source mappings in this standard framework, download the [AuditManager\_ConfigDataSourceMappings\_NIST-800-53-Rev-5.zip](samples/AuditManager_ConfigDataSourceMappings_NIST-800-53-Rev-5.zip.md "samples/AuditManager_ConfigDataSourceMappings_NIST-800-53-Rev-5.zip.md") file.
