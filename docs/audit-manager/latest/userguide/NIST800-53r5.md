...
as data source mappings in this standard framework, download the [AuditManager_ConfigDataSourceMappings_NIST-800-53-Rev-5.zip](samples/AuditManager_ConfigDataSourceMappings_NIST-800-53-Rev-5.zip.md "samples/AuditManager_ConfigDataSourceMappings_NIST-800-53-Rev-5.zip.md") file.
