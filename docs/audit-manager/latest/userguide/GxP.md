...
as data source mappings in this standard framework, download the [AuditManager_ConfigDataSourceMappings_Title-21-CFR-Part-11.zip](samples/AuditManager_ConfigDataSourceMappings_Title-21-CFR-Part-11.zip.md "samples/AuditManager_ConfigDataSourceMappings_Title-21-CFR-Part-11.zip.md") file.
