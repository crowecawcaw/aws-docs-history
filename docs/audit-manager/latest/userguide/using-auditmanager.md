...
+ **AWS CloudFormation**
  ...
  Create Audit Manager resources using AWS CloudFormation, which allows you to define and deploy your auditing infrastructure as code. For more information, see [Creating AWS Audit Manager resources with AWS CloudFormation](creating-resources-with-cloudformation.md).
+ **Third-party integrations**

  Integrate Audit Manager with supported third-party Governance, Risk, and Compliance (GRC) products, enabling you to leverage existing GRC tools and processes. For more information, see [Integrations with third-party GRC products](third-party-integration.md).
