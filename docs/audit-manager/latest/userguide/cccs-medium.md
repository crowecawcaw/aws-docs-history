...
- [What is the CCCS?](#what-is-cccs-medium "#what-is-cccs-medium")
- [Using this framework](#framework-cccs-medium "#framework-cccs-medium")
- [Next steps](#next-steps-cccs-medium "#next-steps-cccs-medium")
