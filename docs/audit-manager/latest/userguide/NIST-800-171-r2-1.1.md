...
as data source mappings in this standard framework, download the [AuditManager\_ConfigDataSourceMappings\_NIST-800-171-Rev-2.zip](samples/AuditManager_ConfigDataSourceMappings_NIST-800-171-Rev-2.zip.md "samples/AuditManager_ConfigDataSourceMappings_NIST-800-171-Rev-2.zip.md") file.
