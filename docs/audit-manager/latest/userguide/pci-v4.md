...
- [What is PCI DSS?](#what-is-PCI-v4 "#what-is-PCI-v4")
- [Using this framework](#framework-PCI-v4 "#framework-PCI-v4")
- [Next steps](#next-steps-PCI-v4 "#next-steps-PCI-v4")
- [Additional resources](#resources-PCI-v4 "#resources-PCI-v4")
...
as data source mappings in this standard framework, download the [AuditManager\_ConfigDataSourceMappings\_PCI-DSS-v4.0.zip](samples/AuditManager_ConfigDataSourceMappings_PCI-DSS-v4.0.zip.md "samples/AuditManager_ConfigDataSourceMappings_PCI-DSS-v4.0.zip.md") file.
