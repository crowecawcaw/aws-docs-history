...
requirements of your task. For more information, see [Amazon ECS task execution IAM role](task_execution_IAM_role.md "task_execution_IAM_role.md").
...
For more information, see [Amazon ECS task definitions for 64-bit ARM workloads](ecs-arm64.md "ecs-arm64.md").
...
parameter. The following table shows the valid combinations of task-level CPU
and memory.
...
| Memory value (in MiB, with approximate equivalent<br>value in GB)                                           | CPU value      | Operating systems supported for Fargate |
| ----------------------------------------------------------------------------------------------------------- | -------------- | --------------------------------------- |
| 512 (0.5 GB), 1024 (1 GB), 2048 (2 GB)                                                                      | 256 (.25 vCPU) | Linux                                   |
| 1024 (1 GB), 2048 (2 GB), 3072 (3 GB), 4096 (4<br>GB)                                                       | 512 (.5 vCPU)  | Linux                                   |
| 2048 (2 GB), 3072 (3 GB), 4096 (4GB), 5120 (5 GB),<br>6144 (6 GB), 7168 (7 GB), 8192 (8 GB)                 | 1024 (1 vCPU)  | Linux, Windows                          |
| Between 4096 (4 GB) and 16384 (16 GB) in increments of<br>1024 (1 GB)                                       | 2048 (2 vCPU)  | Linux, Windows                          |
| Between 8192 (8 GB) and 30720 (30 GB) in increments of<br>1024 (1 GB)                                       | 4096 (4 vCPU)  | Linux, Windows                          |
| Between 16 GB and 60 GB in 4 GB increments<br>NoteThis option requires Linux platform<br>`1.4.0` or later.  | 8192 (8 vCPU)  | Linux                                   |
| Between 32 GB and 120 GB in 8 GB increments<br>NoteThis option requires Linux platform<br>`1.4.0` or later. | 16384 (16vCPU) | Linux                                   |
...
- [Name](#container_definition_name "#container_definition_name")
...
- [Restart policy](#container_definition_restart_policy "#container_definition_restart_policy")
- [Health check](#container_definition_healthcheck "#container_definition_healthcheck")
- [Environment](#container_definition_environment "#container_definition_environment")
- [Network settings](#container_definition_network "#container_definition_network")
- [Storage and logging](#container_definition_storage "#container_definition_storage")
- [Security](#container_definition_security "#container_definition_security")
- [Resource limits](#container_definition_limits "#container_definition_limits")
- [Docker labels](#container_definition_labels "#container_definition_labels")
...
see [Default log driver mode](ecs-account-settings.md#default-log-driver-mode "ecs-account-settings.md#default-log-driver-mode").
...
and container security best practices](security-tasks-containers.md "security-tasks-containers.md").
...
for Windows Containers](windows-gmsa.md "windows-gmsa.md") and [Using gMSAs
for Linux Containers](linux-gmsa.md "linux-gmsa.md").
...
is `65535`. You can set the values of both limits up to `1048576`. For more information, see [Task resource limits](fargate-tasks-services.md#fargate-resource-limits "fargate-tasks-services.md#fargate-resource-limits").
...
- [Linux parameters](#container_definition_linuxparameters "#container_definition_linuxparameters")
- [Container dependency](#container_definition_dependson "#container_definition_dependson")
- [Container timeouts](#container_definition_timeout "#container_definition_timeout")
- [System controls](#container_definition_systemcontrols "#container_definition_systemcontrols")
- [Interactive](#container_definition_interactive "#container_definition_interactive")
- [Pseudo terminal](#container_definition_pseudoterminal "#container_definition_pseudoterminal")
...
container, such as [KernelCapabilities](../APIReference/API_KernelCapabilities.md "../APIReference/API_KernelCapabilities.md").
...
Linux capabilities, see the [capabilities(7)](http://man7.org/linux/man-pages/man7/capabilities.7.html "http://man7.org/linux/man-pages/man7/capabilities.7.html") Linux manual page.
...
more information, see [IPC mode](#task_definition_ipcmode "#task_definition_ipcmode").
...
accelerator](#ContainerDefinition-elastic-inference "#ContainerDefinition-elastic-inference").
...
- Amazon EBS volumes — Provides cost-effective, durable, high-performance block
  ...
  service. Amazon EBS volumes are supported for Linux tasks hosted on Fargate. For more information, see [Use Amazon EBS volumes with Amazon ECS](ebs-volumes.md "ebs-volumes.md").
- Amazon EFS volumes — Provides simple, scalable, and persistent file storage for
  ...
  are supported for tasks that are hosted on Fargate. For more information, see [Use Amazon EFS volumes with Amazon ECS](efs-volumes.md "efs-volumes.md").
- FSx for Windows File Server volumes — Provides fully managed Microsoft Windows file
  ...
  [Use FSx for Windows File Server volumes with Amazon ECS](wfsx-volumes.md "wfsx-volumes.md").
...
A fully qualified domain name hosted by an [AWS Directory Service for Microsoft Active Directory](../../../directoryservice/latest/admin-guide/directory_microsoft_ad.md "../../../directoryservice/latest/admin-guide/directory_microsoft_ad.md") (AWS Managed Microsoft AD) directory or a self-hosted EC2 Active Directory.
...
- [Ephemeral storage](#task_definition_ephemeralStorage "#task_definition_ephemeralStorage")
- [IPC mode](#task_definition_ipcmode "#task_definition_ipcmode")
- [PID mode](#task_definition_pidmode "#task_definition_pidmode")
- [Fault injection](#task_definition_faultInjection "#task_definition_faultInjection")
