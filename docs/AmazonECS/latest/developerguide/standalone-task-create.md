...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The cluster detail page           | 1. On the **Clusters\*<br>• page, select the<br>cluster to create the service in.<br>2. From the **Tasks\*<br>• tab, choose<br>**Run task**.                                                                                        |
| The task definition revision page | 1. On the **Task definitions\*<br>• page,<br>choose the task definition family to display the<br>revisions for that family.<br>2. Select the revision you want to use.<br>3. From the **Deploy\*<br>• menu, choose<br>**Run task**. |
...
9. (Optional) To override the task IAM role, or task execution role that is defined
   ...
   for your tasks, see [Creating the task IAM role](task-iam-roles.md#create_task_iam_policy_and_role "task-iam-roles.md#create_task_iam_policy_and_role"). 2. For **Task execution role**, choose a task execution
