...
- Both methods only support rolling update deployment and blue/green deployment
  types.
- When a service uses early success criteria, the deployment circuit breaker and
  CloudWatch alarm rollback apply until Amazon ECS completes the deployment. After the deployment
  completes, they no longer roll back the service. For more information, see [Complete Amazon ECS rolling deployments early with early success criteria](early-success-criteria.md "early-success-criteria.md").
