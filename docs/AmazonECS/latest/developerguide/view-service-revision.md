...
| -------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Ongoing deployments                                | Under **Ongoing deployments**, do the following:<br>• To view the source service revision, under<br>**Service revisions**, choose the<br>service revision ID for the Source **Revision<br>type**.<br>• To view the target service revision, under<br>**Service revisions**, choose the<br>service revision ID for the Target **Revision<br>type**. |
| Last deployment                                    | Under **Last deployment**, choose<br>the **Target service revision**.                                                                                                                                                                                                                                                                              |
| Completed deployments                              | Under **Service deployments**, do<br>the following:<br>• Under **Target service<br>revision**, choose the ID.                                                                                                                                                                                                                                      |
...
Note the `arn` for the `sourceServiceRevisions`
or the `targetServiceRevisions`.
...
2. Run `describe-service-revisions`. Use the `arn` that was returned from
