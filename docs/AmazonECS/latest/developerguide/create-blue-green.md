...
- The Amazon ECS CodeDeploy IAM role is created. For more information, see [Amazon ECS CodeDeploy IAM Role](codedeploy_IAM_role.md "codedeploy_IAM_role.md").
...
1. Use the [create-load-balancer](../../../cli/latest/reference/elbv2/create-load-balancer.md "../../../cli/latest/reference/elbv2/create-load-balancer.md") command to create an Application Load Balancer. Specify two
   subnets that aren't from the same Availability Zone as well as a security
   group.
...
2. Use the [create-target-group](../../../cli/latest/reference/elbv2/create-target-group.md "../../../cli/latest/reference/elbv2/create-target-group.md") command to create a target group. This target
   group will route traffic to the original task set in your service.
...
The output includes the ARN of the target group, with the following
format:
...
3. Use the [create-listener](../../../cli/latest/reference/elbv2/create-listener.md "../../../cli/latest/reference/elbv2/create-listener.md") command to create a load balancer listener with a
   default rule that forwards requests to the target group.
...
Use the [create-cluster](../../../cli/latest/reference/ecs/create-cluster.md "../../../cli/latest/reference/ecs/create-cluster.md")
command to create a cluster named `tutorial-bluegreen-cluster` to use.
...
Use the [register-task-definition](../../../cli/latest/reference/ecs/register-task-definition.md "../../../cli/latest/reference/ecs/register-task-definition.md") command to register a task definition that is
...
First, create a file named `fargate-task.json` with the following contents.
...
Then register the task definition using the `fargate-task.json` file that
you created.
...
Use the [create-service](../../../cli/latest/reference/ecs/create-service.md "../../../cli/latest/reference/ecs/create-service.md")
command to create a service.

First, create a file named `service-bluegreen.json` with the following
contents.
...
Then create your service using the `service-bluegreen.json` file that you
created.
...
1. Use the [create-application](../../../cli/latest/reference/deploy/create-application.md "../../../cli/latest/reference/deploy/create-application.md") command to create an CodeDeploy application. Specify
...
2. Use the [create-target-group](../../../cli/latest/reference/elbv2/create-target-group.md "../../../cli/latest/reference/elbv2/create-target-group.md") command to create a second Application Load Balancer target group,
   which will be used when creating your CodeDeploy deployment group.
...
The output includes the ARN for the target group, with the following
format:
...
3. Use the [create-deployment-group](../../../cli/latest/reference/deploy/create-deployment-group.md "../../../cli/latest/reference/deploy/create-deployment-group.md") command to create an CodeDeploy deployment
   group.

First, create a file named `tutorial-deployment-group.json` with
the following contents. This example uses the resource that you created. For the
`serviceRoleArn`, specify the ARN of your Amazon ECS CodeDeploy IAM
role. For more information, see [Amazon ECS CodeDeploy IAM Role](codedeploy_IAM_role.md "codedeploy_IAM_role.md").
...
2. Create the CodeDeploy deployment using the following steps.
   ...
   The output includes the deployment ID, with the following
   format:
   ...
   Continue to retrieve the deployment details until the status is
   `Succeeded`, as shown in the following output.
...
1. Use the [delete-deployment-group](../../../cli/latest/reference/deploy/delete-deployment-group.md "../../../cli/latest/reference/deploy/delete-deployment-group.md") command to delete the CodeDeploy deployment
   group.
...
3. Use the [delete-service](../../../cli/latest/reference/ecs/delete-service.md "../../../cli/latest/reference/ecs/delete-service.md") command to delete the Amazon ECS service. Using the
   `--force` flag allows you to delete a service even if it has not
   been scaled down to zero tasks.
...
4. Use the [delete-cluster](../../../cli/latest/reference/ecs/delete-cluster.md "../../../cli/latest/reference/ecs/delete-cluster.md") command to delete the Amazon ECS cluster.
...
5. Use the [s3 rm](../../../cli/latest/reference/s3/rm.md "../../../cli/latest/reference/s3/rm.md") command to delete
   the AppSpec file from the Amazon S3 bucket.

```
`aws s3 rm s3://`tutorial-bluegreen-bucket/appspec.yaml``
```

6. Use the [s3 rb](../../../cli/latest/reference/s3/rb.md "../../../cli/latest/reference/s3/rb.md") command to delete
...
7. Use the [delete-load-balancer](../../../cli/latest/reference/elbv2/delete-load-balancer.md "../../../cli/latest/reference/elbv2/delete-load-balancer.md") command to delete the Application Load Balancer.
...
8. Use the [delete-target-group](../../../cli/latest/reference/elbv2/delete-target-group.md "../../../cli/latest/reference/elbv2/delete-target-group.md") command to delete the two Application Load Balancer target
   groups.
