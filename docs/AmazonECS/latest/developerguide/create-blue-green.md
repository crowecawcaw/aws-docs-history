...
Amazon ECS services using the blue/green deployment type can use an Application Load Balancer, Network Load Balancer, Service Connect, or be headless. For managed traffic shifting, you need a load balancer or Service Connect. This tutorial uses an Application Load Balancer.
