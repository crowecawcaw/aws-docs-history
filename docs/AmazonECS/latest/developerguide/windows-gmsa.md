...
+ [Setting up gMSA for Windows Containers on Amazon ECS](#windows-gmsa-setup)
...
**Topics**
+ [Example CredSpec](#windows-gmsa-example)
+ [Domainless gMSA setup](#windows-gmsa-domainless)
+ [Referencing a Credential Spec File in a Task Definition](#windows-gmsa-credentialspec)
