...
example is a simple task definition that creates a web app. For more information about
...
For example, in services section, you will find information on deployments, such as the
status of the tasks as running or pending. You may also find information on the task
definition, the network configuration and time-stamped events. In the failures section,
you will find information on failures, if any, associated with the call. For
troubleshooting, see [Service Event
Messages](service-event-messages.md "service-event-messages.md"). For more information about the service description, see [Describe Services](../APIReference/API_DescribeServices.md "../APIReference/API_DescribeServices.md").
