...
Depending on your workload, there are certain task definition parameters that need to
be set. Also for EC2, you have to choose specific
instances that are engineered for the workload.

###### Topics

- [Amazon ECS task definitions for GPU workloads](ecs-gpu.md "ecs-gpu.md")
- [Amazon ECS task definitions for video transcoding workloads](ecs-vt1.md "ecs-vt1.md")
- [Amazon ECS task definitions for AWS Neuron machine learning workloads](ecs-inference.md "ecs-inference.md")
- [Amazon ECS task definitions for deep learning instances](ecs-dl1.md "ecs-dl1.md")
- [Amazon ECS task definitions for 64-bit ARM workloads](ecs-arm64.md "ecs-arm64.md")
