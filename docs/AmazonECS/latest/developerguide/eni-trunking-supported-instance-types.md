...
| mac-m4.metal         | 7                               | 12                           |
| mac-m4pro.metal      | 7                               | 12                           | ## Compute optimized          |
| Instance type        | Task limit without ENI trunking | Task limit with ENI trunking |
| ---                  | ---                             | ---                          |
| c5.large             | 2                               | 10                           |
| c5.xlarge            | 3                               | 20                           |
...
| c8i-flex.16xlarge    | 15                              | 120                          | ## Memory optimized           |
| Instance type        | Task limit without ENI trunking | Task limit with ENI trunking |
| ---                  | ---                             | ---                          |
| r5.large             | 2                               | 10                           |
| r5.xlarge            | 3                               | 20                           |
...
| x8g.metal-48xl       | 14                              | 120                          | ## Storage optimized          |
| Instance type        | Task limit without ENI trunking | Task limit with ENI trunking |
| ---                  | ---                             | ---                          |
| i4g.large            | 2                               | 10                           |
| i4g.xlarge           | 3                               | 20                           |
...
| is4gen.2xlarge       | 3                               | 40                           |
| is4gen.4xlarge       | 7                               | 60                           |
| is4gen.8xlarge       | 7                               | 60                           | ## Accelerated computing      |
| Instance type        | Task limit without ENI trunking | Task limit with ENI trunking |
| ---                  | ---                             | ---                          |
| dl1.24xlarge         | 59                              | 120                          |
...
| vt1.3xlarge          | 3                               | 40                           |
| vt1.6xlarge          | 7                               | 60                           |
| vt1.24xlarge         | 14                              | 120                          | ## High performance computing |
| Instance type        | Task limit without ENI trunking | Task limit with ENI trunking |
| ---                  | ---                             | ---                          |
