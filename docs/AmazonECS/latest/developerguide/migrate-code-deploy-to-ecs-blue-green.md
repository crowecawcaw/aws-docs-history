...
following:
    ...
    3. For **Production rule**, choose the production rule
     from your CodeDeploy blue/green deployment.
    4. For **Test rule**, choose the test rule from your
     CodeDeploy blue/green deployment.
    5. For **Target group**, choose the production target
     group from your CodeDeploy blue/green deployment.
    6. For **Alternate target group**, choose the test
