...
| PRE\_PRODUCTION\_TRAFFIC\_SHIFT | Occurs before each production traffic shift step. For canary, this occurs before the canary traffic shift and before the remaining traffic shift. | Yes | 
