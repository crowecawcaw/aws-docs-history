...
For more information about AWS PrivateLink and VPC endpoints, see [VPC endpoints](../../../vpc/latest/privatelink/concepts.md#concepts-vpc-endpoints "../../../vpc/latest/privatelink/concepts.md#concepts-vpc-endpoints") in the _Amazon VPC User Guide_.
...
- Tasks using Fargate don't require the
  ...
  - To allow your tasks to pull private images from Amazon ECR, you must
    ...
    see [Interface VPC
    Endpoints (AWS PrivateLink)](../../../AmazonECR/latest/userguide/vpc-endpoints.md "../../../AmazonECR/latest/userguide/vpc-endpoints.md") in the
...
- VPC endpoints only support Amazon-provided DNS through Amazon Route 53. If you
  ...
  Options Sets](../../../vpc/latest/userguide/VPC_DHCP_Options.md "../../../vpc/latest/userguide/VPC_DHCP_Options.md") in the _Amazon VPC User Guide_.
...
- Tasks using EC2 require that the container
  ...
  later of the Amazon ECS container agent. For more information, see [Amazon ECS Linux container instance management](manage-linux.md "manage-linux.md").
- To allow your tasks to pull sensitive data from Secrets Manager, you must create the
  ...
  Secrets Manager with VPC Endpoints](../../../secretsmanager/latest/userguide/vpc-endpoint-overview.md "../../../secretsmanager/latest/userguide/vpc-endpoint-overview.md") in the
  _AWS Secrets Manager User Guide_.
...
This behavior occurs because the Amazon ECS agent uses the [DiscoverPollEndpoint](../APIReference/API_DiscoverPollEndpoint.md "../APIReference/API_DiscoverPollEndpoint.md") API to
...
To create the VPC endpoint for the Amazon ECS service, use the [Access an AWS service using an interface VPC endpoint](../../../vpc/latest/privatelink/create-interface-endpoint.md#create-interface-endpoint "../../../vpc/latest/privatelink/create-interface-endpoint.md#create-interface-endpoint") procedure in the
