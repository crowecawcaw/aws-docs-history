...
launch time with the AWS CLI [start-task](../../../cli/latest/reference/ecs/start-task.md "../../../cli/latest/reference/ecs/start-task.md") command. You can also use Amazon EFS volumes for
persistent storage. For more information, see [Use Amazon EFS volumes with Amazon ECS](efs-volumes.md "efs-volumes.md").
...
following steps was built with the preceding Dockerfile. 2. Create a task definition that defines your other volumes and mount points
