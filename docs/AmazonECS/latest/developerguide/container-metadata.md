...
+ [Turning on Amazon ECS container metadata](enable-metadata.md)
+ [Amazon ECS container metadata file format](metadata-file-format.md)
...
+ **For Windows instances:**
  + Host path: `C:\ProgramData\Amazon\ECS\data\metadata\{{task_id}}\{{container_name}}\ecs-container-metadata.json`
