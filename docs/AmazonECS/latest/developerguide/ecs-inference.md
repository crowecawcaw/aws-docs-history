...
[Specifying AWS Neuron machine learning in an Amazon ECS task definition](ecs-inference-task-def.md "ecs-inference-task-def.md"). The following table details the chips
