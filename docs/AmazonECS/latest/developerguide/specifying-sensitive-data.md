...
2. They're referenced as `secretOptions` if your logging platform requires
   authentication. For more information, see [logging configuration options](../APIReference/API_LogConfiguration.md#API_LogConfiguration_Contents "../APIReference/API_LogConfiguration.md#API_LogConfiguration_Contents").
3. They're referenced as secrets pulled by images that use the
   ...
   [Private registry
   authentication for tasks](private-auth.md "private-auth.md").
...
- Tasks - Stop the task, and then start it. For more information, see [Stopping an Amazon ECS task](standalone-task-stop.md "standalone-task-stop.md") and [Running an application as an Amazon ECS task](standalone-task-create.md "standalone-task-create.md").
- Service - Update the service and use the force new deployment option. For more information, see [Updating an Amazon ECS service](update-service-console-v2.md "update-service-console-v2.md").
...
encryption behavior for Amazon S3 buckets](../../../AmazonS3/latest/userguide/bucket-encryption.md "../../../AmazonS3/latest/userguide/bucket-encryption.md").
...
container ordering](../APIReference/API_ContainerDependency.md "../APIReference/API_ContainerDependency.md"). When you do this, the application container
...
automatically deleted after the task stops. For an example, see the [task-def.json](https://github.com/aws-samples/aws-secret-sidecar-injector/blob/master/ecs-task-def/task-def.json "https://github.com/aws-samples/aws-secret-sidecar-injector/blob/master/ecs-task-def/task-def.json") project.
