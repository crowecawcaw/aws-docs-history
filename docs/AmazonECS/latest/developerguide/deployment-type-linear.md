...
| PRE\_PRODUCTION\_TRAFFIC\_SHIFT  | Occurs before each production traffic shift increment. Lifecycle<br>hooks configured for this stage are invoked at every traffic shift<br>step.                                              | Yes                    |
