...
Is AWS Cloud Map](../../../cloud-map/latest/dg/Welcome.md "../../../cloud-map/latest/dg/Welcome.md") in the _AWS Cloud Map Developer Guide_.
...
- **Service discovery instance**: Exists
  ...
  - **Instance attributes**: The following
    ...
    - **`AWS_INSTANCE_IPV6`**–
      ...
      discovering instance details, for example, `2001:0db8:85a3:0000:0000:abcd:0001:2345`. Both
...
- Service discovery is supported for tasks on Fargate that
  use platform version 1.1.0 or later. For more information, see [Fargate platform versions for Amazon ECS](platform-fargate.md "platform-fargate.md").
...
- The VPC DNS attributes must be configured for successful DNS resolution. For
  information about how to configure the attributes, see [DNS support in your VPC](../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support "../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support") in the _Amazon VPC User Guide_.
...
- We recommend you use container-level health checks managed by Amazon ECS for your
  ...
  - **HealthCheckCustomConfig**—Amazon ECS
    ...
    your service discovery service. For more information, see [HealthCheckCustomConfig](../../../cloud-map/latest/api/API_HealthCheckCustomConfig.md "../../../cloud-map/latest/api/API_HealthCheckCustomConfig.md") in the
...
queries to the service registry. For more information, see [AWS Cloud Map Pricing](../../../cloud-map/latest/dg/cloud-map-pricing.md "../../../cloud-map/latest/dg/cloud-map-pricing.md") in the
