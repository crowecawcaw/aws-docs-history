...
Amazon ECS Linux containers on AWS Fargate are supported in the following AWS Regions.
The supported Availability Zone IDs are noted when applicable.
...
| AWS GovCloud (US-West)    | us-gov-west-1                                                                | ## Windows containers on AWS Fargate Amazon ECS Windows containers on AWS Fargate are supported in the following AWS Regions. The supported Availability Zone IDs are noted when applicable. |
| Region Name               | Region                                                                       |
| ---                       | ---                                                                          |
| US East (Ohio)            | us-east-2                                                                    |
