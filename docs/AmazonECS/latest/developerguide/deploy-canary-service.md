...
3. Create a rule to route traffic to your new service revision. For more
   ...
   rules](../../../elasticloadbalancing/latest/application/listener-rules.md "../../../elasticloadbalancing/latest/application/listener-rules.md") in the _Elastic Load Balancing Application Load Balancers_.
4. Create a target group for your green service revision. When you use the
   ...
   `ip`. For information about target groups, see [Target groups](../../../elasticloadbalancing/latest/application/load-balancer-target-groups.md "../../../elasticloadbalancing/latest/application/load-balancer-target-groups.md") in the _Elastic Load Balancing
