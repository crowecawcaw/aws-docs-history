...
6.  Under **Deployment configuration**, do the following:
    ...
    4. For **Health check grace period**, enter the amount
       of time (in seconds) that the service scheduler ignores unhealthy ELB, VPC Lattice, and container
...
7.  1. For **Bake time**, enter the number of minutes that
...
1. Create a file named `service-definition.json`
