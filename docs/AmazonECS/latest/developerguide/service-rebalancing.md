...
For more information about task placement strategies and constraints, see [How Amazon ECS places tasks on container instances](task-placement.md "task-placement.md").
