...
For more information, see [versionConsistency](task_definition_parameters.md#ContainerDefinition-versionconsistency "task_definition_parameters.md#ContainerDefinition-versionconsistency").
...
- To establish updated image digests, you can force a new deployment. The
  ...
  [forceNewDeployment](../APIReference/API_UpdateService.md#ECS-UpdateService-request-forceNewDeployment "../APIReference/API_UpdateService.md#ECS-UpdateService-request-forceNewDeployment") in the _Amazon ECS API
  reference_.
