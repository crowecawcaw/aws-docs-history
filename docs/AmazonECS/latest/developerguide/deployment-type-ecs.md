...
You can configure early success criteria to have Amazon ECS complete a rolling deployment when a percentage of tasks that you define are healthy on the target service revision. For more information, see [Complete Amazon ECS rolling deployments early with early success criteria](early-success-criteria.md).
