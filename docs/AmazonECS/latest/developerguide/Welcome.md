...
![Diagram showing the capacity, controller, and provisioning layers.](images/ecs-layers.png)
...
- **AWS Command Line Interface (AWS CLI)** — Provides commands
  ...
  Mac, and Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/").
- **AWS SDKs** — Provides
  ...
  For more information, see [AWS SDKs](https://aws.amazon.com/developer/tools/#SDKs "https://aws.amazon.com/developer/tools/#SDKs").
