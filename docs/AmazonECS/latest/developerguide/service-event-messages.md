...
**Tip**  
You can use the [Amazon ECS MCP server](ecs-mcp-introduction.md) with AI assistants to analyze service events using natural language.
...
1. On the **Events** tab, view the messages.
