...
| serviceLongArnFormat`taskLongArnFormat`<br />`containerInstanceLongArnFormat` | [Amazon Resource Names (ARNs) and IDs](#ecs-resource-ids) | 
...
|  Resource type  |  ARN  | 
| --- | --- | 
|  Container instance  | Current: `arn:aws:ecs:{{region}}:{{aws_account_id}}:container-instance/{{container-instance-id}}`<br />New: `arn:aws:ecs:{{region}}:{{aws_account_id}}:container-instance/{{cluster-name}}/{{container-instance-id}}` | 
|  Amazon ECS service  | Current: `arn:aws:ecs:{{region}}:{{aws_account_id}}:service/{{service-name}}`<br />New: `arn:aws:ecs:{{region}}:{{aws_account_id}}:service/{{cluster-name}}/{{service-name}}` | 
|  Amazon ECS task  | Current: `arn:aws:ecs:{{region}}:{{aws_account_id}}:task/{{task-id}}`<br />New: `arn:aws:ecs:{{region}}:{{aws_account_id}}:task/{{cluster-name}}/{{task-id}}` | 
