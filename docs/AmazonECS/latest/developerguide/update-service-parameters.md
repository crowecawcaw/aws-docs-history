...
To refer to valid transitions, see [Service mutability](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/capacity-launch-type-comparison.html#service-mutability).
