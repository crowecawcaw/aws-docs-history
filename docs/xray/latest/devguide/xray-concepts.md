...
![Segment data for an X-Ray trace](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cw-segment-overview.png)
...
![Subsegments provide more granular information](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cw-timeline-segment.png)
...
![Edge between an instrumented application and DynamoDB.](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cw-servicemap-ddb-edge.png)
...
![An instrumented application calling another instrumented application.](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cw-servicemap-instrumented-edge.png)
...
![Trace map](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-cw-servicemap-simplified.png)
...
![Timeline view of a trace, which collects all segments generated by a single request](https://docs.aws.amazon.com/xray/latest/devguide/images/xray-trace-details-cw.png)


See [AWS X-Ray pricing](https://aws.amazon.com/xray/pricing/) for information about how X-Ray traces are billed. Trace data is retained for 30 days.
...
![Drill down to traces for individual requests](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-filter-httpurlCONTAINS-cw.png)
...
**Metadata** are key-value pairs with values of any type, including objects and lists, but that are not indexed. Use metadata to record data you want to store in the trace but don't need to use for searching traces.
 ...
 You can view annotations and metadata in the segment or subsegment details window, within the [Trace details](xray-console-traces.md#xray-console-traces-view) page in the CloudWatch console.

![Annotations and metadata are viewable in the segment or subsegment details in the CloudWatch console](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cw-subsegment-metadata.png)
