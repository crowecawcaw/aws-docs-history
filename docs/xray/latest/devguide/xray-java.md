...
- [AWS Distro for OpenTelemetry Java](xray-java-opentel-sdk.md "xray-java-opentel-sdk.md") – An AWS distribution that provides a set
...
- [AWS X-Ray SDK for Java](xray-sdk-java.md "xray-sdk-java.md") – A set of libraries for generating and
