...
notifications, the X-Ray SDK for Go tracks the calls downstream in [subsegments](xray-sdk-go-subsegments.md "xray-sdk-go-subsegments.md"). Traced AWS services and resources that
...
To trace AWS SDK clients, wrap the client object with the `xray.AWS()` call as
...
Then, when you use the AWS SDK client, use the `withContext` version of the call
method, and pass it the `context` from the `http.Request` object passed to
the [handler](xray-sdk-go-handler.md "xray-sdk-go-handler.md").
