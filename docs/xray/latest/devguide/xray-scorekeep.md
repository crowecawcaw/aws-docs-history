...
![Service map showing Client connecting to Scorekeep container, which connects to DynamoDB tables and SNS.](images/scorekeep-gettingstarted-servicemap-before-ECS.png)
