...
- [AWS Distro for OpenTelemetry Go](xray-go-opentel-sdk.md "xray-go-opentel-sdk.md") – An AWS distribution that provides a set of
  open source libraries for sending correlated metrics and traces to multiple AWS monitoring solutions including
...
- [AWS X-Ray SDK for Go](xray-sdk-go.md "xray-sdk-go.md") – A set of libraries for generating and
  sending traces to X-Ray via the [X-Ray daemon](xray-daemon.md "xray-daemon.md").
