...
![X-Ray trace map time period](https://docs.aws.amazon.com/xray/latest/devguide/images/xray-console-time-period-15-minutes.png)
...
![X-Ray console trace map page](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-servicemap-before-ECS.png)
...
![Choosing a trace from the trace list](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-tracelist-sns.png)
...
![Choose the error status icon to open the Exceptions page for the Amazon SNS subsegment](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-timeline-sns-ecs.png)

1. The X-Ray SDK automatically captures exceptions thrown by instrumented AWS SDK clients and records the stack trace.  
![Exceptions tab showing captured exceptions and recorded stack trace](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-exception.png)
...
1. The console shows a representation of the service graph that X-Ray generates from the trace data sent by the application. Be sure to adjust the time period of the trace map if needed, to make sure that it will display all traces since you first started the web application.  
![CloudWatch trace map time period](https://docs.aws.amazon.com/xray/latest/devguide/images/cw-console-service-map-time-period-15-minutes.png)
...
![X-Ray console trace map page](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-cw-servicemap-before-ECS.png)
...
![Choosing a trace from the trace list](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-cw-tracelist-sns-ecs.png)
...
![View the Exceptions tab for the Amazon SNS subsegment](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-gettingstarted-cw-timeline-sns-ecs.png)
...
![Update email configuration](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-cf-email-update.png)
