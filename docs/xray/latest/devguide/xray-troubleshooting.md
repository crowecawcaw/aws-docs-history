...
**Topics**
+ [X-Ray trace map and trace details pages](#xray-console-troubleshooting)
...
Use X-Ray groups to break your map into multiple maps. For more information, see [ Using Filter Expressions with Groups](xray-console-filters.md#groups).
