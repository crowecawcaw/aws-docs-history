...
![Trace map showing how scorekeep calls a Lambda function to get random names for new users](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-servicemap-lambda-node.png)
...
![Trace map showing how the scorekeep worker function uses Amazon SQS, Amazon S3, and the scorekeep API.](https://docs.aws.amazon.com/xray/latest/devguide/images/scorekeep-servicemap-lambdaworker-node.png)
