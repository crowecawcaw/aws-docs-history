...
ADOT currently includes auto-instrumentation support for [Java](https://aws-otel.github.io/docs/getting-started/java-sdk/auto-instr) and [Python](https://aws-otel.github.io/docs/getting-started/python-sdk/auto-instr). In addition, ADOT enables auto-instrumentation of AWS Lambda functions and their downstream requests using Java, Node.js, and Python runtimes, via [ADOT Managed Lambda Layers](https://aws-otel.github.io/docs/getting-started/lambda). 
