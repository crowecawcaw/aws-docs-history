...
![AWS Config timeline.](https://docs.aws.amazon.com/xray/latest/devguide/images/ConfigTimeline.png)
...
![X-Ray encryption configuration change entry.](https://docs.aws.amazon.com/xray/latest/devguide/images/ConfigChanges.png)
