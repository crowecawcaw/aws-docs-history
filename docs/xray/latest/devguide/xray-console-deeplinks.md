...
You can use routes and queries to deep link into specific traces, or filtered views of
traces and the trace map.

###### Console pages

- Welcome page – [xray/home#/welcome](https://console.aws.amazon.com/xray/home#/welcome "https://console.aws.amazon.com/xray/home#/welcome")
- Getting started – [xray/home#/getting-started](https://console.aws.amazon.com/xray/home#/getting-started "https://console.aws.amazon.com/xray/home#/getting-started")
- Trace map – [xray/home#/service-map](https://console.aws.amazon.com/xray/home#/service-map "https://console.aws.amazon.com/xray/home#/service-map")
- Traces – [xray/home#/traces](https://console.aws.amazon.com/xray/home#/traces "https://console.aws.amazon.com/xray/home#/traces")
...
For more information about filter expressions, see [Using filter expressions](xray-console-filters.md "xray-console-filters.md").

## Time range

Specify a length of time or start and end time in ISO8601 format. Time ranges are in UTC
and can be up to 6 hours long.
