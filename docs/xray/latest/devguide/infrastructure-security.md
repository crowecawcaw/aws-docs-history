...
As a managed service, AWS X-Ray is protected by AWS global network security. For
...
You use AWS published API calls to access X-Ray through the network. Clients must
