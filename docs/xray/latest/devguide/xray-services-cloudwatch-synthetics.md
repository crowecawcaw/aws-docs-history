...
![Example canary node in x-ray trace map.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-show-canary-active.png)
...
![Example canary node in x-ray trace map with service details.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-servicedetail.png)
...
![Example canary node in x-ray trace details map.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-tracemap.png)
...
![Example canary node in x-ray trace map.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-active-select.png)


![Example canary node root cause.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-rootcause.png)


![Example annotation filter indicating the canary node.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-showannot.png)
...
![Example annotation filter indicating the canary node.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-distribution.png)
...
![Example annotation filter indicating the canary node.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-compare.png)
...
![Example annotation filter indicating the canary node.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-vs-customer.png)
...
![Example nodes for Elastic Beanstalk www.](https://docs.aws.amazon.com/xray/latest/devguide/images/synthetics-canary-active-www.png)
