...
notifications, the X-Ray SDK for Ruby tracks the calls downstream in [subsegments](xray-sdk-ruby-subsegments.md "xray-sdk-ruby-subsegments.md"). Traced AWS services and resources that
...
The X-Ray SDK for Ruby automatically instruments all AWS SDK clients when you [patch the aws-sdk library](xray-sdk-ruby-patching.md "xray-sdk-ruby-patching.md"). You cannot
