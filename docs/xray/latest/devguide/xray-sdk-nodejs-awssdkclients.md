...
If you want to use [TypeScript](https://www.typescriptlang.org/docs/handbook/typescript-in-5-minutes.html) with [ECMAScript modules](https://nodejs.org/api/esm.html) (ESM) to load your JavaScript code, use the following example to import libraries:
