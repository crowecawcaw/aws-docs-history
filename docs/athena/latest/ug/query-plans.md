...
![Choose Explain in the Athena query editor.](https://docs.aws.amazon.com/athena/latest/ug/images/query-plans-1.png)
...
![Sample query distributed plan graph.](https://docs.aws.amazon.com/athena/latest/ug/images/query-plans-2.png)
...
![Choose a stage to see details for the stage.](https://docs.aws.amazon.com/athena/latest/ug/images/query-plans-3.png)
...
![Expanded operator tree for a stage in a distributed query plan.](https://docs.aws.amazon.com/athena/latest/ug/images/query-plans-4.png)
**Important**  
...
![Graph of a logical query plan in Athena.](https://docs.aws.amazon.com/athena/latest/ug/images/query-plans-5.png)
