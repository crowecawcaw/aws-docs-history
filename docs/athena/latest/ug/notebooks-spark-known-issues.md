...
- With the following [DataFrame](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/dataframe.html "https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/dataframe.html") API syntax:
...
Athena for Spark using Apache Hive syntax. For more information, see [CREATE HIVEFORMAT TABLE](https://spark.apache.org/docs/latest/sql-ref-syntax-ddl-create-table-hiveformat.html "https://spark.apache.org/docs/latest/sql-ref-syntax-ddl-create-table-hiveformat.html") in the Apache Spark documentation.
