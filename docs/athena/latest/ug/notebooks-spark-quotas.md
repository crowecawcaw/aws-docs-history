...
| Apache Spark session DPU concurrency | 60      | No         | The maximum number of DPUs you can consume concurrently for an Apache<br>Spark calculation within a session.                                                                                                                                                                                  |
