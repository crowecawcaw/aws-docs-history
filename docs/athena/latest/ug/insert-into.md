...
queries, see [Use Amazon Athena Federated Query](federated-queries.md "federated-queries.md").
...
result in lower query performance](performance-tuning-data-optimization-techniques.md#performance-tuning-avoid-having-too-many-files "performance-tuning-data-optimization-techniques.md#performance-tuning-avoid-having-too-many-files"), and write and read operations such as
...
- Run `INSERT INTO` operations less frequently on larger batches
  of rows.
- For large data ingestion volumes, consider using a service like [Amazon Data Firehose](../../../firehose/latest/dev/what-is-this-service.md "../../../firehose/latest/dev/what-is-this-service.md").
...
For more information about `SELECT` queries, see [SELECT](select.md "select.md").
...
information, see [Work with query results and recent queries](querying.md "querying.md").
