...
policies for workgroups, see [Control access to data catalogs with IAM policies](datacatalogs-iam-policy.md "datacatalogs-iam-policy.md").

- [Example Policy for Full Access to All Data Catalogs](#datacatalog-policy-full-access-to-all-data-catalogs "#datacatalog-policy-full-access-to-all-data-catalogs")
- [Example Policy for Full Access to a Specified Data Catalog](#datacatalog-policy-full-access-to-a-specified-catalog "#datacatalog-policy-full-access-to-a-specified-catalog")
- [Example Policy for Querying a Specified Data Catalog](#datacatalog-policy-querying-a-specified-data-catalog "#datacatalog-policy-querying-a-specified-data-catalog")
- [Example Policy for Management Operations on a Specified Data Catalog](#datacatalog-policy-management-operations-on-a-specified-catalog "#datacatalog-policy-management-operations-on-a-specified-catalog")
