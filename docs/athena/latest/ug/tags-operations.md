...
| --------------------- | ------------------------ | -------------------------------------------------------------------------------- |
| `TagResource`         | `tag-resource`           | Add or overwrite one or more tags on the resource that has the<br>specified ARN. |
| `UntagResource`       | `untag-resource`         | Delete one or more tags from the resource that has the specified<br>ARN.         |
| `ListTagsForResource` | `list‑tags‑for‑resource` | List one or more tags for the resource that has the specified<br>ARN.            |
