...
| ---------------------------- | -------------------------------------------- | -------------- | ------------- | --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | --- | --- | --- |
| CredentialsProvider          | _AWSCredentialsProviderClass (deprecated)_   | Required       | none          | The fully qualified class name of the custom implementation of `AwsCredentialsProvider` | ## Credentials provider arguments A comma-separated list of string arguments for the custom credentials provider constructor. |
