...
- [Identity-based permissions for Lake Formation and Athena](#lf-athena-user-permissions-identity-based "#lf-athena-user-permissions-identity-based")
- [Amazon S3 permissions for Athena query results locations](#lf-athena-user-permissions-query-results-locations "#lf-athena-user-permissions-query-results-locations")
...
- [IAM permissions to write to Amazon S3 locations](#lf-athena-user-permissions-s3-write "#lf-athena-user-permissions-s3-write")
- [Permissions to encrypted data, metadata, and Athena query results](#lf-athena-user-permissions-encrypted "#lf-athena-user-permissions-encrypted")
- [Resource-based permissions for Amazon S3 buckets in external accounts (optional)](#lf-athena-user-permissions-s3-cross-account "#lf-athena-user-permissions-s3-cross-account")
...
available with Athena drivers. For more information, see [Use workgroups to control query access and costs](workgroups-manage-queries-control-costs.md "workgroups-manage-queries-control-costs.md"), [Use IAM policies to control workgroup access](workgroups-iam-policy.md "workgroups-iam-policy.md"), and
...
information, see [Encrypt Athena query results stored in Amazon S3](encrypting-query-results-stored-in-s3.md "encrypting-query-results-stored-in-s3.md").
...
- Encrypting source data – Encryption
  ...
  encrypt and decrypt data. For more information about requirements, see [Supported Amazon S3 encryption options](encryption.md#encryption-options-S3-and-Athena "encryption.md#encryption-options-S3-and-Athena") and [Permissions to encrypted data in Amazon S3](encryption.md#permissions-for-encrypting-and-decrypting-data "encryption.md#permissions-for-encrypting-and-decrypting-data").
- Encrypting metadata – Encrypting
  ...
  Data Catalog](../../../glue/latest/dg/encrypt-glue-data-catalog.md "../../../glue/latest/dg/encrypt-glue-data-catalog.md") in the _AWS Glue Developer Guide_ and [Configure access from Athena to encrypted metadata in the AWS Glue Data Catalog](access-encrypted-data-glue-data-catalog.md "access-encrypted-data-glue-data-catalog.md").
...
For information about accessing catalogs in another account, see [Option A: Configure cross-account Data Catalog access in Athena](lf-athena-limitations-cross-account.md#lf-athena-limitations-cross-account-glue "lf-athena-limitations-cross-account.md#lf-athena-limitations-cross-account-glue").
