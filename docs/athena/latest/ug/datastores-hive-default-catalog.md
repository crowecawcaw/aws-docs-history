...
![A DML query using a default data source.](images/datastores-hive-default-catalog-2.png) 3. When you use multiple data sources in a query, you can omit only the default
...
connection string in a SQL editor like [SQL workbench](https://www.sql-workbench.eu/index.html "https://www.sql-workbench.eu/index.html").

###### Note

To download the latest Athena JDBC drivers, see [Using
Athena with the JDBC driver](connect-with-jdbc.md "connect-with-jdbc.md").
...
![Configuring a JDBC connection URL in SQL Workbench.](images/datastores-hive-default-catalog-jdbc-1.jpg)
