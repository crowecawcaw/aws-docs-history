...
| `<br>"cloudformation:*"<br>`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Allows the creation and management of AWS CloudFormation stacks specified by<br>the resource `MyCFStackPrefix`. These<br>stacks and stacksets are how AWS Serverless Application Repository deploys connectors and<br>UDFs.                                                                                                                                                                                                                                                     |
