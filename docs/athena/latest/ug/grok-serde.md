...
set of [pre-defined patterns](https://github.com/elastic/logstash/blob/v1.4.2/patterns/grok-patterns "https://github.com/elastic/logstash/blob/v1.4.2/patterns/grok-patterns"). You can also create custom patterns.
...
information, see [grok-patterns](https://github.com/elastic/logstash/blob/v1.4.2/patterns/grok-patterns "https://github.com/elastic/logstash/blob/v1.4.2/patterns/grok-patterns") on GitHub.com.
...
The following example [Amazon S3 server access logs](../../../AmazonS3/latest/userguide/LogFormat.md "../../../AmazonS3/latest/userguide/LogFormat.md")
`CREATE TABLE` statement shows the
...
- [Understanding Grok Patterns](https://edgedelta.com/company/blog/what-are-grok-patterns "https://edgedelta.com/company/blog/what-are-grok-patterns") (external website)
- [Built-in patterns](../../../glue/latest/dg/custom-classifier.md#classifier-builtin-patterns "../../../glue/latest/dg/custom-classifier.md#classifier-builtin-patterns") (_AWS Glue User
  Guide_)
