...
- [Use Lake Formation and JDBC or ODBC drivers for federated access to Athena](security-athena-lake-formation-jdbc.md "security-athena-lake-formation-jdbc.md")
