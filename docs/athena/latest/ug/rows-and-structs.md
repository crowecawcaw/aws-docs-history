# Query arrays with complex types and nested
...
arrays, and find keywords using Athena queries.

###### Topics

- [Create a ROW](creating-row.md "creating-row.md")
- [Change field names in arrays using
  CAST](changing-row-arrays-with-cast.md "changing-row-arrays-with-cast.md")
- [Filter arrays using the .
  notation](filtering-with-dot.md "filtering-with-dot.md")
...
- [Find keywords in arrays using
  regexp_like](filtering-with-regexp.md "filtering-with-regexp.md")
