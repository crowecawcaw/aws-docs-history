...
| ---------------- | ------------------------------------------------------------------------------------------ |
| `statement_name` | The name of the statement to be prepared. The name must be unique<br>within the workgroup. |
| `statement`      | A `SELECT`, `CTAS`, or `INSERT INTO`<br>query.                                             |
...
[DEALLOCATE PREPARE](sql-deallocate-prepare.md "sql-deallocate-prepare.md")
