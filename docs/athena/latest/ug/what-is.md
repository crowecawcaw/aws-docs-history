...
Amazon Simple Storage Service (Amazon S3) using standard [SQL](ddl-sql-reference.md "ddl-sql-reference.md"). With a few actions in the AWS Management Console, you
...
For more information, see [Get started](getting-started.md "getting-started.md").
...
- [When should I use Athena?](when-should-i-use-ate.md "when-should-i-use-ate.md")
- [Ways to use Athena](accessing-athena.md "accessing-athena.md")
- [Set up access](setting-up.md "setting-up.md")
- [AWS service integrations](athena-aws-service-integrations.md "athena-aws-service-integrations.md")
