...
| DDL                     | <= 1                      | Not applicable. Reader features can be declared only on tables<br>with a reader version of 2 or greater.                                                                                                                                                                                                                                                                                                                                                                                          |

- For a list of Delta Lake table features, see [Valid feature names in table features](https://github.com/delta-io/delta/blob/master/PROTOCOL.md#valid-feature-names-in-table-features "https://github.com/delta-io/delta/blob/master/PROTOCOL.md#valid-feature-names-in-table-features") on GitHub.com
