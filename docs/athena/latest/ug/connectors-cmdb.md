...
- default_ec2_image_owner – (Optional)
  When set, controls the default Amazon EC2 image owner that filters [Amazon Machine
  Images (AMI)](../../../AWSEC2/latest/UserGuide/AMIs.md "../../../AWSEC2/latest/UserGuide/AMIs.md"). If you do not set this value and your query against
...
- ebs_volumes – Contains details of your
  Amazon EBS volumes.
- ec2_instances – Contains details of your
  EC2 Instances.
- ec2_images – Contains details of your
  EC2 Instance images.
- routing_tables – Contains details of
  your VPC Routing Tables.
- security_groups – Contains details of
...
- emr_clusters – Contains details of your
  EMR Clusters.

- rds – This database contains Amazon RDS
  related resources, including the following.

- rds_instances – Contains details of your
  RDS Instances.
...
connector requires, review the `Policies` section of the [athena-aws-cmdb.yaml](https://github.com/awslabs/aws-athena-query-federation/blob/master/athena-aws-cmdb/athena-aws-cmdb.yaml "https://github.com/awslabs/aws-athena-query-federation/blob/master/athena-aws-cmdb/athena-aws-cmdb.yaml") file. The following list summarizes the required permissions.
...
The Amazon Athena AWS CMDB connector project is licensed under the [Apache-2.0 License](https://www.apache.org/licenses/LICENSE-2.0.html "https://www.apache.org/licenses/LICENSE-2.0.html").

## Additional resources

For additional information about this connector, visit [the corresponding site](https://github.com/awslabs/aws-athena-query-federation/tree/master/athena-aws-cmdb "https://github.com/awslabs/aws-athena-query-federation/tree/master/athena-aws-cmdb") on GitHub.com.
