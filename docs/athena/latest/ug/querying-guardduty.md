...
[Amazon GuardDuty](https://aws.amazon.com/guardduty/ "https://aws.amazon.com/guardduty/") is a security monitoring service
...
generates security [findings](../../../guardduty/latest/ug/guardduty_findings.md "../../../guardduty/latest/ug/guardduty_findings.md") that
...
For more information about Amazon GuardDuty, see the [Amazon GuardDuty User Guide](../../../guardduty/latest/ug.md "../../../guardduty/latest/ug.md").

## Prerequisites

- Enable the GuardDuty feature for exporting findings to Amazon S3. For steps, see [Exporting findings](../../../guardduty/latest/ug/guardduty_exportfindings.md "../../../guardduty/latest/ug/guardduty_exportfindings.md") in the Amazon GuardDuty User Guide.
...
information, see [JSON Data Files](https://github.com/rcongiu/Hive-JSON-Serde#json-data-files "https://github.com/rcongiu/Hive-JSON-Serde#json-data-files") in the OpenX SerDe documentation on GitHub. 3. Run the query in the Athena console to register the `gd_logs` table.
