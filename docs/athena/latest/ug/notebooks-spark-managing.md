...
1. [Terminate](notebooks-spark-getting-started.md#notebooks-spark-getting-started-terminating-a-session "notebooks-spark-getting-started.md#notebooks-spark-getting-started-terminating-a-session") any active sessions for the notebook that you want to rename.
...
1. [Terminate](notebooks-spark-getting-started.md#notebooks-spark-getting-started-terminating-a-session "notebooks-spark-getting-started.md#notebooks-spark-getting-started-terminating-a-session") any active sessions for the notebook that you want to delete.
