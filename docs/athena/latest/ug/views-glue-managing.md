...
| ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ALTER VIEW DIALECT](alter-view-dialect.md "alter-view-dialect.md")                                                                            | Updates a Data Catalog view by either adding an engine dialect or by updating or dropping an existing engine dialect.                                                                                                                                                                                                      |
