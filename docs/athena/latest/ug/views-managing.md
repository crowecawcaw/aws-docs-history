...
| --- | --- | 
| [CREATE VIEW and CREATE PROTECTED MULTI DIALECT VIEW](create-view.md) | Creates a new view from a specified `SELECT` query. For more information, see [Create views](views-console.md#creating-views).<br />The optional `OR REPLACE` clause lets you update the existing view by replacing it. | 
