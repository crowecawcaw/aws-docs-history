...
sources by using ODBC and JDBC drivers, external Hive metastores, and Athena data source
connectors. For more information, see [Connect to data sources](work-with-data-stores.md "work-with-data-stores.md").
