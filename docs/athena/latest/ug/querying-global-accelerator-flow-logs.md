...
endpoints over the AWS global network. For more information about Global Accelerator, see [What is AWS Global Accelerator](../../../global-accelerator/latest/dg/what-is-global-accelerator.md "../../../global-accelerator/latest/dg/what-is-global-accelerator.md").
...
1. Copy and paste the following DDL statement into the Athena console. This query
   specifies _ROW FORMAT DELIMITED_ and omits specifying a [SerDe](serde-reference.md "serde-reference.md"), which
   means that the query uses the [LazySimpleSerDe](lazy-simple-serde.md "lazy-simple-serde.md"). In this
