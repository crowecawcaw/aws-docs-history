...
![Using the %table magic command.](images/notebooks-spark-magics-graphs-1.png)

## %matplot

[Matplotlib](https://matplotlib.org/ "https://matplotlib.org/") is a comprehensive library for
...
![Using the %matplot magic command.](images/notebooks-spark-magics-graphs-2.png)

### Use the matplotlib and seaborn libraries together

[Seaborn](https://seaborn.pydata.org/tutorial/introduction "https://seaborn.pydata.org/tutorial/introduction") is a
library for making statistical graphics in Python. It builds on top of matplotlib
and integrates closely with [pandas](https://pandas.pydata.org/ "https://pandas.pydata.org/")
...
![Using %matplot to render seaborn data.](images/notebooks-spark-magics-graphs-3.png)

## %plotly

[Plotly](https://plotly.com/python/ "https://plotly.com/python/") is an open source graphing
library for Python that you can use to make interactive graphs. You use the
`%ploty` magic command to render ploty data.

The following example uses the [StringIO](https://docs.python.org/3.13/library/io.html#io.StringIO "https://docs.python.org/3.13/library/io.html#io.StringIO"), plotly, and pandas libraries on stock price data to create a graph of
...
![Using the %ploty magic command.](images/notebooks-spark-magics-graphs-4.png)
