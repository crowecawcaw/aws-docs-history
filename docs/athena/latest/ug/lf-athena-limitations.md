...
- [Iceberg DDL support](#lf-athena-limitations-iceberg-ddl-operations "#lf-athena-limitations-iceberg-ddl-operations")
- [Lake Formation fine-grained access control and Athena workgroups](#lf-athena-limitations-fine-grained-access-control "#lf-athena-limitations-fine-grained-access-control")
...
- [The DESCRIBE permission is required on the default database](#lf-athena-limitations-describe-default "#lf-athena-limitations-describe-default")
...
accounts, see [Configure cross-account Data Catalog access](lf-athena-limitations-cross-account.md "lf-athena-limitations-cross-account.md").
