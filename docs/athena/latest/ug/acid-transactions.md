...
The term "ACID transactions" refers to a set of properties ([atomicity](<https://en.wikipedia.org/wiki/Atomicity_(database_systems)> "https://en.wikipedia.org/wiki/Atomicity_(database_systems)"),
[consistency](<https://en.wikipedia.org/wiki/Consistency_(database_systems)> "https://en.wikipedia.org/wiki/Consistency_(database_systems)"), [isolation](<https://en.wikipedia.org/wiki/Isolation_(database_systems)> "https://en.wikipedia.org/wiki/Isolation_(database_systems)"), and
[durability](<https://en.wikipedia.org/wiki/Durability_(database_systems)> "https://en.wikipedia.org/wiki/Durability_(database_systems)")) that ensure data integrity in database transactions. ACID
...
with other services and engines such as [Amazon EMR](../../../emr/latest/ManagementGuide/emr-what-is-emr.md "../../../emr/latest/ManagementGuide/emr-what-is-emr.md") and [Apache Spark](https://spark.apache.org/ "https://spark.apache.org/") that also support shared table
formats.
...
- [Query Linux Foundation Delta Lake tables](delta-lake-tables.md "delta-lake-tables.md")
- [Query Apache Hudi datasets](querying-hudi.md "querying-hudi.md")
- [Query Apache Iceberg tables](querying-iceberg.md "querying-iceberg.md")
