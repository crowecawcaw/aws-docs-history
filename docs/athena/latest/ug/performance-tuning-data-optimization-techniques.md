...
is read. For more information about partitioning, see [Partition your data](partitions.md "partitions.md").
...
have large number of values, and consider using the [injected](partition-projection-dynamic-id-partitioning.md#partition-projection-injection "partition-projection-dynamic-id-partitioning.md#partition-projection-injection") type
instead.
...
AWS Glue](../../../glue/latest/dg/partition-indexes.md "../../../glue/latest/dg/partition-indexes.md") in the _AWS Glue Developer Guide_ and [Improve Amazon Athena query performance using AWS Glue Data Catalog partition indexes](https://aws.amazon.com/blogs/big-data/improve-amazon-athena-query-performance-using-aws-glue-data-catalog-partition-indexes/ "https://aws.amazon.com/blogs/big-data/improve-amazon-athena-query-performance-using-aws-glue-data-catalog-partition-indexes/")
...
or [AWS Glue
crawlers](../../../glue/latest/dg/crawler-running.md "../../../glue/latest/dg/crawler-running.md"). As an alternative, you can use partition projection, which
removes the need to manage partitions altogether. For more information, see [Use partition projection with Amazon Athena](partition-projection.md "partition-projection.md").

## Validate that your queries are compatible with the partitioning scheme

You can check in advance which partitions a query will scan by using the [EXPLAIN](athena-explain-statement.md "athena-explain-statement.md") statement. Prefix your query with the
...
For more information, see [Convert to columnar formats](columnar-storage.md#convert-to-columnar "columnar-storage.md#convert-to-columnar").
...
The [gzip](https://www.gnu.org/software/gzip/ "https://www.gnu.org/software/gzip/") format provides
good compression ratios and has wide range support across other tools and services.
The [zstd](https://facebook.github.io/zstd/ "https://facebook.github.io/zstd/") (Zstandard) format is
...
For more information about using compression in Athena, see [Use compression in Athena](compression-formats.md "compression-formats.md").
...
- Put files in a location on Amazon S3 and use a tool like Glue ETL to combine
  ...
  larger groups](../../../glue/latest/dg/grouping-input-files.md "../../../glue/latest/dg/grouping-input-files.md") in the _AWS Glue Developer Guide_ and
  [How can I configure an AWS Glue ETL job to output larger files?](https://repost.aws/knowledge-center/glue-job-output-large-files "https://repost.aws/knowledge-center/glue-job-output-large-files") in
...
- Reduce the number of partition keys. When you have too many partition
  ...
  partitions to create, see [Pick partition keys that will support your queries](#performance-tuning-pick-partition-keys-that-will-support-your-queries "#performance-tuning-pick-partition-keys-that-will-support-your-queries").
...
Using the [SymlinkTextInputFormat](https://athena.guide/articles/stitching-tables-with-symlinktextinputformat "https://athena.guide/articles/stitching-tables-with-symlinktextinputformat") technique can be a way to
