...
<a name="service_code_examples_cognito-identity-provider_actions"></a>
...
These excerpts call the Amazon Cognito Identity Provider API and are code excerpts from larger programs that must be run in context. You can see actions in context in [Scenarios for Amazon Cognito Identity Provider using AWS SDKs](service_code_examples_cognito-identity-provider_scenarios.md). 
