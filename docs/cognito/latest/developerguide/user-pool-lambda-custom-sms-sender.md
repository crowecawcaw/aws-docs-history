...
| CustomSMSSender\_ResendCode | A user requests a new code to confirm their registration. | 
...
| CustomSMSSender\_Authentication | A user signs in and Amazon Cognito sends an SMS OTP or MFA code. | 
