...
+ [Other application options](getting-started-user-pools-application-other-options.md)
+ [Add more features and security options to your user pool](user-pool-next-steps.md)