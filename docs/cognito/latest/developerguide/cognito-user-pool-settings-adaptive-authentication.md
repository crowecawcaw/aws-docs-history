...
+ [Viewing and exporting user event history](#user-pool-settings-adaptive-authentication-event-user-history)
...
**Topics**
+ [Viewing user event history (AWS Management Console)](#user-pool-settings-adaptive-authentication-event-user-history-console)
+ [Viewing user event history (API/CLI)](#user-pool-settings-adaptive-authentication-event-user-history-api-cli)
+ [Exporting user authentication events](#user-pool-settings-adaptive-authentication-event-user-history-exporting)
