...
**`identity_provider`**  
Optional.  
Add this parameter to bypass managed login and redirect your user to a provider sign-in page. The value of the *identity\_provider* parameter is the name of the identity provider (IdP) as it appears in your user pool.  
...
**`idp_identifier`**  
Optional.  
Add this parameter to redirect to a provider with an alternative name for the *identity\_provider* name. You can enter identifiers for your SAML 2.0 and OIDC IdPs from the **Social and external providers** menu of the Amazon Cognito console.
