...
The following code examples show you how to implement common scenarios in Amazon Cognito Identity
with AWS SDKs. These scenarios show you how to accomplish specific tasks by calling multiple functions
within Amazon Cognito Identity or combined with other AWS services.
