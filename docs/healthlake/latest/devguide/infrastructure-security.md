...
As a managed service, AWS HealthLake is protected by the AWS global network security
...
You use AWS published API calls to access HealthLake through the network. Clients must
