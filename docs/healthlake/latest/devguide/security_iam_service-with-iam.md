...
To view examples of HealthLake identity-based policies, see [Identity-based policy examples for AWS HealthLake](security_iam_id-based-policy-examples.md).
...
To see a list of HealthLake actions, see [Actions defined by AWS HealthLake](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonhealthlake.html#amazonhealthlake-actions-as-permissions) in the *Service Authorization Reference*.
...
To see a list of HealthLake resource types and their ARNs, see [Resources defined by AWS HealthLake](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonhealthlake.html#amazonhealthlake-resources-for-iam-policies) in the *Service Authorization Reference*. To learn the actions with which you can specify the ARN of each resource, see [Actions defined by AWS HealthLake](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonhealthlake.html#amazonhealthlake-actions-as-permissions).
...
To see a list of HealthLake condition keys, see [Condition keys for AWS HealthLake](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonhealthlake.html#amazonhealthlake-policy-keys) in the *Service Authorization Reference*. To learn the actions and resources with which you can use a condition key, see [Actions defined by AWS HealthLake](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonhealthlake.html#amazonhealthlake-actions-as-permissions).
...
For information about service roles and the inline policy required for full access to AWS HealthLake, see [Setting up AWS HealthLake](getting-started-setting-up.md).
