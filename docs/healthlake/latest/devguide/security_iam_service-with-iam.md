...
Before you use IAM to manage access to HealthLake, learn what IAM features are
available to use with HealthLake.

| IAM features you can use with AWS HealthLake                                                                                                             | IAM feature | HealthLake support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------ |
...
To get a high-level view of how HealthLake and other AWS services work with most IAM
...
To see a list of HealthLake actions, see [Actions defined by AWS HealthLake](../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-actions-as-permissions") in the
...
To see a list of HealthLake resource types and their ARNs, see [Resources defined by AWS HealthLake](../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-resources-for-iam-policies")
...
To see a list of HealthLake condition keys, see [Condition keys for AWS HealthLake](../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-policy-keys "../../../service-authorization/latest/reference/list_amazonhealthlake.md#amazonhealthlake-policy-keys") in the
...
For information about service roles and the inline policy required for full access to
AWS HealthLake, see [Setting up AWS HealthLake](getting-started-setting-up.md "getting-started-setting-up.md").
