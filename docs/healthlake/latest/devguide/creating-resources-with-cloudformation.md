...
When you use CloudFormation, you can reuse your template to set up your HealthLake resources consistently
...
AWS HealthLake supports creating data stores with CloudFormation. For more information, including examples
