...
| --------------- | --------- | ------------------------ | --------------------------------------------------------------------------------------------------------------- |
| `coverage`      | Coverage  | **1..\<br>• (Required)** | Coverage resource(s) to establish the member and coverage for documentation                                     |
