...
| CommunicationRequest        | CommunicationRequest.occurrenceDateTime,<br>CommunicationRequest.occurrencePeriod.start                            |
...
| SupplyDelivery              | SupplyDelivery.occurrenceDateTime, SupplyDelivery.occurrencePeriod.start,<br>SupplyDelivery.occurrenceTiming.event |
