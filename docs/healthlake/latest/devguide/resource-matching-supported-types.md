...
Patient and RelatedPerson identifiers| Identifier | Scope |
| --- | --- |
...
Practitioner and PractitionerRole identifiers| Identifier | Scope |
| --- | --- |
...
Organization identifiers| Identifier | Scope |
| --- | --- |
| National Provider Identifier (NPI) | Globally unique |
| Tax ID (EIN) | Globally unique |
...
Location identifiers| Identifier | Scope |
| --- | --- |
| National Provider Identifier (NPI) | Globally unique |
| Global Location Number (GLN) | Globally unique |
| CMS Certification Number (CCN) | Globally unique |
...
Device identifiers| Identifier | Scope |
| --- | --- |
