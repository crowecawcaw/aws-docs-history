...
AWS re:Post Private and your other AWS solutions. AWS provides the following monitoring tools to
watch re:Post Private, report when something is wrong, and take automatic actions when
appropriate:
...
- _AWS CloudTrail_ captures API calls and related events made by or for your AWS account
