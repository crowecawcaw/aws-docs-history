...
To create a channel within your private re:Post in AWS re:Post Private, follow these steps:
...
3. Choose the private re:Post that you want to manage, and then choose the **Channels** tab.
4. Choose **Create channel**.
5. For **Channel name**, enter a name for your channel.
6. For **Channel description**, enter a brief description of your channel.
7. Choose **Create**.
   Your channel is created and displayed under the list of channels.

###### Note

To update the channel name or channel description, choose **Edit channel**.
