...
- [Customize appearance for your private re:Post](#customize-appearance "#customize-appearance")
- [Add custom tags, custom topics, and blocked terminology for your private re:Post](#add-tags-topics-blocked-terminology "#add-tags-topics-blocked-terminology")
- [Choose your topics of interest for selections](#add-selections-topics "#add-selections-topics")
...
2. For **Description**, enter a welcome message to greet your re:Post Private users. When a user signs in to your private re:Post, this message is displayed on the re:Post Private home page.
3. Under **Logo**, choose **Change logo**, and then upload an image. The maximum size for this image is 2 MiB. The supported file types are .jpg, .peg, and .png. This logo appears on the top-left of your private re:Post and has a resolution of 150 X 50.
4. Under **Color scheme**, for **Primary color** and **Button color**, choose the colors. The primary color that you choose is used as the header color for your private re:Post. The button color that you choose is used as the color for the buttons within your private re:Post.
...
2. In the **Create tag?** dialog box, enter the tag. Then, choose **Create**.
...
2. In the **Create new topic** dialog box, do the following:
...
2. In the **Add blocked terminology?** dialog box, enter the text that you want to block your private re:Post users from using. Then, choose **Add**.

The terms that you added are displayed in the list under the **Blocked terminology** section. When users try to use the blocked term in their private re:Post content, they get a warning message that asks them to edit the content and remove the term. 3. Choose **Continue**.
...
You can also use the dropdown list to select topics of your interest. 2. Choose **Launch your private re:Post**.

All selections with the selected topics are added to the home page for your private re:Post.

###### Important

Your private re:Post is launched and ready for use after the console administrator onboards users to it. For more information, see [Invite users and groups to your private re:Post](../caguide/invite-users.md "../caguide/invite-users.md"). The users of your private re:Post use the information in the onboarding email to sign in to your private re:Post after it's launched.
