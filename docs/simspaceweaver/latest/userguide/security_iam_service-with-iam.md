...
Before you use IAM to manage access to SimSpace Weaver, learn what IAM features are
available to use with SimSpace Weaver.

| IAM features you can use with AWS SimSpace Weaver                                                                                                                           | IAM feature | SimSpace Weaver support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------------- |
...
To get a high-level view of how SimSpace Weaver and other AWS services work with most IAM
...
To see a list of SimSpace Weaver actions, see [Actions defined by AWS SimSpace Weaver](../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-actions-as-permissions "../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-actions-as-permissions") in the
...
To see a list of SimSpace Weaver resource types and their ARNs, see
[Resources defined by AWS SimSpace Weaver](../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of SimSpace Weaver condition keys, see [Condition keys for AWS SimSpace Weaver](../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-policy-keys "../../../service-authorization/latest/reference/list_awssimspaceweaver.md#awssimspaceweaver-policy-keys") in the
