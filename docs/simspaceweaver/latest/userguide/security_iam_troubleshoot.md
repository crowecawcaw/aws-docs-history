...
- [I am not authorized to perform an action in SimSpace Weaver](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I'm an administrator and want to allow others to access SimSpace Weaver](#security_iam_troubleshoot-admin-delegate "#security_iam_troubleshoot-admin-delegate")
- [I want to allow people outside of my AWS account to access my SimSpace Weaver resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
