...
**[AdvancedEventSelectors](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
The advanced event selectors to use to select the events for the data store. You can
 ...
 events, see [Log events by using advanced event selectors](../userguide/logging-data-events-with-cloudtrail.md#creating-data-event-selectors-advanced "../userguide/logging-data-events-with-cloudtrail.md#creating-data-event-selectors-advanced") in the CloudTrail User Guide.
...
For more information about how to use advanced event selectors to include AWS Config configuration items in your event data store, see [Create an event data store for AWS Config configuration
 items](../userguide/lake-eds-cli.md#lake-cli-create-eds-config "../userguide/lake-eds-cli.md#lake-cli-create-eds-config") in the CloudTrail User Guide.


For more information about how to use advanced event selectors to include events outside of AWS events in your event data store, see [Create an integration to log events from outside AWS](../userguide/lake-integrations-cli.md#lake-cli-create-integration "../userguide/lake-integrations-cli.md#lake-cli-create-integration") in the CloudTrail User Guide.
...
**[BillingMode](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
For more information about CloudTrail pricing, 
 see [AWS CloudTrail Pricing](http://aws.amazon.com/cloudtrail/pricing/ "http://aws.amazon.com/cloudtrail/pricing/") and 
 [Managing CloudTrail Lake costs](../userguide/cloudtrail-lake-manage-costs.md "../userguide/cloudtrail-lake-manage-costs.md").
...
**[KmsKeyId](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[MultiRegionEnabled](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[Name](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[OrganizationEnabled](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[RetentionPeriod](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[StartIngestion](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[TagsList](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[TerminationProtectionEnabled](#API_CreateEventDataStore_RequestSyntax "#API_CreateEventDataStore_RequestSyntax")**
...
**[AdvancedEventSelectors](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[BillingMode](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[CreatedTimestamp](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[EventDataStoreArn](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[KmsKeyId](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[MultiRegionEnabled](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[Name](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[OrganizationEnabled](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[RetentionPeriod](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[Status](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[TagsList](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[TerminationProtectionEnabled](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
**[UpdatedTimestamp](#API_CreateEventDataStore_ResponseSyntax "#API_CreateEventDataStore_ResponseSyntax")**
...
* [AWS Command Line Interface V2](https://docs.aws.amazon.com/goto/cli2/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/cli2/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for .NET](https://docs.aws.amazon.com/goto/DotNetSDKV3/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/DotNetSDKV3/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForCpp/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for Go v2](https://docs.aws.amazon.com/goto/SdkForGoV2/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForGoV2/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for JavaScript V3](https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for Kotlin](https://docs.aws.amazon.com/goto/SdkForKotlin/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForKotlin/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for PHP V3](https://docs.aws.amazon.com/goto/SdkForPHPV3/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForPHPV3/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for Python](https://docs.aws.amazon.com/goto/boto3/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/boto3/cloudtrail-2013-11-01/CreateEventDataStore")
* [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/CreateEventDataStore "https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/CreateEventDataStore")
