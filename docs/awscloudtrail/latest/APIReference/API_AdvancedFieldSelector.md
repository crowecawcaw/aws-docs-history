...
For network activity events, this is a required field that only uses the
 ...
 source. For a list of services supporting network activity events, see [Logging network activity events](../userguide/logging-network-events-with-cloudtrail.md "../userguide/logging-network-events-with-cloudtrail.md") in the *AWS CloudTrail User Guide*.
...
* **`eventType`** - For event data stores, this is an optional
 ...
 [CloudTrail record contents](../userguide/cloudtrail-event-reference-record-contents.md#ct-event-type "../userguide/cloudtrail-event-reference-record-contents.md#ct-event-type") in the *AWS CloudTrail user
 guide*.
...
For a list of available resource types for data events, see [Data events](../userguide/logging-data-events-with-cloudtrail.md#logging-data-events "../userguide/logging-data-events-with-cloudtrail.md#logging-data-events") in the *AWS CloudTrail User Guide*.
...
* **`userIdentity.arn`** - For event data stores, this is an
 ...
 see [CloudTrail userIdentity element](../userguide/cloudtrail-event-reference-user-identity.md "../userguide/cloudtrail-event-reference-user-identity.md") in the *AWS CloudTrail User Guide*.
...
* [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/cloudtrail-2013-11-01/AdvancedFieldSelector "https://docs.aws.amazon.com/goto/SdkForCpp/cloudtrail-2013-11-01/AdvancedFieldSelector")
* [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/AdvancedFieldSelector "https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/AdvancedFieldSelector")
* [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/AdvancedFieldSelector "https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/AdvancedFieldSelector")
