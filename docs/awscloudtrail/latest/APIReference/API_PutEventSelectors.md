...
If you want your trail to log Insights events, be sure the event selector or advanced event selector enables 
 logging of the Insights event types you want configured for your trail. For more information about logging Insights events, see [Working with CloudTrail Insights](../userguide/logging-insights-events-with-cloudtrail.md "../userguide/logging-insights-events-with-cloudtrail.md") in the *CloudTrail User Guide*.
...
You can add advanced event selectors, and conditions for your advanced event selectors,
 ...
 [Logging management events](../userguide/logging-management-events-with-cloudtrail.md "../userguide/logging-management-events-with-cloudtrail.md"), [Logging
 data events](../userguide/logging-data-events-with-cloudtrail.md "../userguide/logging-data-events-with-cloudtrail.md"), [Logging
 network activity events](../userguide/logging-network-events-with-cloudtrail.md "../userguide/logging-network-events-with-cloudtrail.md"), and [Quotas in AWS CloudTrail](../userguide/WhatIsCloudTrail-Limits.md "../userguide/WhatIsCloudTrail-Limits.md") in the *AWS CloudTrail User
 Guide*.
...
**[AdvancedEventSelectors](#API_PutEventSelectors_RequestSyntax "#API_PutEventSelectors_RequestSyntax")**
...
You can add advanced event
 ...
 selectors, see [Logging data events](../userguide/logging-data-events-with-cloudtrail.md "../userguide/logging-data-events-with-cloudtrail.md") and 
 [Logging network activity events](../userguide/logging-network-events-with-cloudtrail.md "../userguide/logging-network-events-with-cloudtrail.md")
...
**[EventSelectors](#API_PutEventSelectors_RequestSyntax "#API_PutEventSelectors_RequestSyntax")**
...
Type: Array of [EventSelector](API_EventSelector.md "API_EventSelector.md") objects
...
**[TrailName](#API_PutEventSelectors_RequestSyntax "#API_PutEventSelectors_RequestSyntax")**
...
**[AdvancedEventSelectors](#API_PutEventSelectors_ResponseSyntax "#API_PutEventSelectors_ResponseSyntax")**
...
**[EventSelectors](#API_PutEventSelectors_ResponseSyntax "#API_PutEventSelectors_ResponseSyntax")**
...
**[TrailARN](#API_PutEventSelectors_ResponseSyntax "#API_PutEventSelectors_ResponseSyntax")**
...
* [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudtrail-2013-11-01/PutEventSelectors")
* [AWS SDK for JavaScript V3](https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/cloudtrail-2013-11-01/PutEventSelectors")
* [AWS SDK for Kotlin](https://docs.aws.amazon.com/goto/SdkForKotlin/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/SdkForKotlin/cloudtrail-2013-11-01/PutEventSelectors")
* [AWS SDK for PHP V3](https://docs.aws.amazon.com/goto/SdkForPHPV3/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/SdkForPHPV3/cloudtrail-2013-11-01/PutEventSelectors")
* [AWS SDK for Python](https://docs.aws.amazon.com/goto/boto3/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/boto3/cloudtrail-2013-11-01/PutEventSelectors")
* [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/PutEventSelectors "https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudtrail-2013-11-01/PutEventSelectors")
