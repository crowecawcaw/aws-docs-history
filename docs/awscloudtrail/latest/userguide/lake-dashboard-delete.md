...
You can't delete an event data store if [termination protection](lake-dashboard-termination-protection.md "lake-dashboard-termination-protection.md") is
 enabled.
...
5. From **Actions**, choose **Delete**.
6. Choose **Delete** to confirm you want to delete the dashboard.
