...
You can lookup the last 90 days of Insights events programmatically by running the AWS CLI
 [lookup-events](https://docs.aws.amazon.com/cli/latest/reference/cloudtrail/lookup-events.html "https://docs.aws.amazon.com/cli/latest/reference/cloudtrail/lookup-events.html") command, or the [LookupEvents](../APIReference/API_LookupEvents.md "../APIReference/API_LookupEvents.md") API operation.
