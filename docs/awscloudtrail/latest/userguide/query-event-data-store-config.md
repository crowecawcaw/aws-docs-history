...
Setup](../../../systems-manager/latest/userguide/quick-setup-config.md "../../../systems-manager/latest/userguide/quick-setup-config.md"), a capability of AWS Systems Manager, to quickly create a configuration
...
see [Managing the
Configuration Recorder](../../../config/latest/developerguide/stop-start-recorder.md "../../../config/latest/developerguide/stop-start-recorder.md") in the _AWS Config Developer
Guide_.
...
- Set up an Amazon S3 bucket to receive a configuration snapshot on request and
  ...
  the Delivery Channel](../../../config/latest/developerguide/manage-delivery-channel.md "../../../config/latest/developerguide/manage-delivery-channel.md") and [Delivering
  Configuration Snapshot to an Amazon S3 Bucket](../../../config/latest/developerguide/deliver-snapshot-cli.md "../../../config/latest/developerguide/deliver-snapshot-cli.md") in the
...
User Guide_. 11. Choose **Next**. 12. On the **Choose events** page, choose **AWS events**, and then choose
**Configuration items**. 13. CloudTrail stores the event data store resource in the Region in which you
...
enabled. 14. To have your event data store collect configuration items from all
...
organization. 15. Choose **Next** to review your choices. 16. On the **Review and create** page, review your choices.
Choose **Edit** to make changes to a section. When you're
ready to create the event data store, choose **Create event data
store**. 17. The new event data store is visible in the **Event data
