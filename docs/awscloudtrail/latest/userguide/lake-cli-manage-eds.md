...
------
 ...
 Replace {{123456789012}} with your account ID, {{arn:aws:cloudtrail:us-east-1:123456789012:eventdatastore/event\_data\_store\_ID}} with the ARN of the event data store for which CloudTrail will run queries, and {{arn:aws:cloudtrail:us-east-1:123456789012:eventdatastore/EXAMPLE-f852-4e8f-8bd1-bcf6cEXAMPLE}} with the ARN of the dashboard.
