...
(for example, a CloudTrail delegated administrator account is registered or removed). 7. Edit any additional settings specific to your event data store's **Event type**.
...
For more information about these settings, see [Create an integration with a CloudTrail partner with the console](query-event-data-store-integration-partner.md "query-event-data-store-integration-partner.md"). 8. To add, change, or remove tags, choose **Edit** in
