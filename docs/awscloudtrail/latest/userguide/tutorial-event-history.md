...
![The CloudTrail Event history page highlighting the Read-only filter](images/cloudtrail-event-history.png)
...
![The CloudTrail Event history page filtered on a specific event source](images/event-history-event-source.png)
...
5. To compare events, select up to five events by filling their check boxes in the
 ...
 table.
6. You can save event history by downloading it as a file in CSV or JSON format. Downloading
