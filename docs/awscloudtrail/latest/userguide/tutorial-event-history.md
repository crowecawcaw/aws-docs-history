...
![The CloudTrail Event history page highlighting the Read-only filter](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/cloudtrail-event-history.png)
...
![The CloudTrail Event history page filtered on the ConsoleLogin event.](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/cloudtrail-event-history-filters.png)
...
![The CloudTrail Event history page filtered on a specific event source](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/event-history-event-source.png)
...
![The CloudTrail Event history page showing the download options](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/cloudtrail-event-history-download.png)
