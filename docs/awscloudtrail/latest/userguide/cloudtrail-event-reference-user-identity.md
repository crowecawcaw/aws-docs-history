...
- `AssumedRole` – The request was made with temporary security
  ...
  AWS Security Token Service (AWS STS) [`AssumeRole`](../../../STS/latest/APIReference/API_AssumeRole.md "../../../STS/latest/APIReference/API_AssumeRole.md") API. This can include
  [roles
  for Amazon EC2](../../../AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.md "../../../AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.md") and cross-account API access.
- `Role` – The request was made with a persistent IAM identity that
  ...
  the role. For more information about roles, see [Roles terms and concepts](../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md "../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md") in the
  _IAM User Guide_.
- `FederatedUser` – The request was made with temporary security
  credentials obtained from a call to the AWS STS [`GetFederationToken`](../../../STS/latest/APIReference/API_GetFederationToken.md "../../../STS/latest/APIReference/API_GetFederationToken.md") API. The
...
Credentials](../../../IAM/latest/UserGuide/id_credentials_temp.md "../../../IAM/latest/UserGuide/id_credentials_temp.md") in the
_IAM User Guide_.
...
3. Because you own the IAM role, you receive a log that shows the
   ...
   `AWSAccount`. For an example log entry, see [AWS STS API event in CloudTrail log file](../../../IAM/latest/UserGuide/cloudtrail-integration.md#stscloudtrailexample "../../../IAM/latest/UserGuide/cloudtrail-integration.md#stscloudtrailexample").
...
| --------------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Root` (no alias set) | Not present                   | If you haven't set up an alias for your AWS account, the `userName`<br>field doesn't appear. For more information about account<br>aliases, see [Your AWS account ID and its alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md"). Note that<br>the `userName` field can't contain<br>`Root`, because `Root` is an<br>identity type and not a user name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `Root` (alias set)    | The account alias             | For more information about AWS account aliases, see [Your AWS account ID and its alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `IAMUser`             | The user name of the IAM user |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `AssumedRole`         | Not present                   | For the `AssumedRole` type, you can find the `userName` field<br>in `sessionContext` as part of the [sessionIssuer](#sessionissuer "#sessionissuer")<br>element. For an example entry,<br>see [Examples](#cloudtrail-event-reference-user-identity-examples "#cloudtrail-event-reference-user-identity-examples").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `Role`                | User-defined                  | The `sessionContext` and<br>`sessionIssuer` section contains information<br>about the identity that issued the session for the<br>role.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `FederatedUser`       | Not present                   | The `sessionContext` and `sessionIssuer` section contains<br>information about the identity that issued the session for<br>the federated user.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `Directory`           | Can be present                | For example, the value can be the [account alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md") or email<br>address of the associated [AWS account ID](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `AWSService`          | Not present                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `AWSAccount`          | Not present                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `IdentityCenterUser`  | Not present\*                 | The `onBehalfOf` section contains information about the IAM Identity Center user ID and identity store ARN for which the call was made.<br>To learn more about how you can use these two fields, see<br>[Identifying the user and session in IAM Identity Center user-initiated CloudTrail events](../../../singlesignon/latest/userguide/sso-cloudtrail-use-cases.md#user-session-iam-identity-center "../../../singlesignon/latest/userguide/sso-cloudtrail-use-cases.md#user-session-iam-identity-center")<br>in the IAM Identity Center User Guide.<br>\<br>• IAM Identity Center emits the `userName` field under the `additionalEventData` element in two sign-in CloudTrail events. For more information,<br>see [Username in sign-in CloudTrail events](../../../singlesignon/latest/userguide/username-sign-in-cloudtrail-events.md "../../../singlesignon/latest/userguide/username-sign-in-cloudtrail-events.md") in the IAM Identity Center User Guide. |
| `Unknown`             | Can be present                | For example, the value can be the [account alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md") or email<br>address of the associated [AWS account ID](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
authentication](../../../IAM/latest/UserGuide/id_credentials_mfa.md "../../../IAM/latest/UserGuide/id_credentials_mfa.md"). The following attributes can appear in `sessionContext`:
...
type` and `userName`:
  ...
  | --------------------- | ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | `Root` (no alias set) | Not present                   | If you have not set up an alias for your account, the `userName` field<br>does not appear. For more information about<br>AWS account aliases, see [Your AWS account ID and its alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md"). Note<br>that the `userName` field can't contain<br>`Root`, because `Root` is an<br>identity type, not a user name. |
  | `Root` (alias set)    | The account alias             | For more information about AWS account aliases, see [Your AWS account ID and its<br>alias](../../../IAM/latest/UserGuide/console_account-alias.md "../../../IAM/latest/UserGuide/console_account-alias.md").                                                                                                                                                                                                               |
  | `IAMUser`             | The user name of the IAM user | This also applies when a federated user is using<br>a session issued by `IAMUser`.                                                                                                                                                                                                                                                                                                                                         |
  | `Role`                | The role name                 | A role assumed by an IAM user, AWS service, or web identity federated user in<br>a role session.                                                                                                                                                                                                                                                                                                                           |
...
- `webIdFederationData` – If the request was made with temporary security credentials obtained by [web identity
  federation](../../../IAM/latest/UserGuide/id_roles_providers_oidc.md "../../../IAM/latest/UserGuide/id_roles_providers_oidc.md"), `webIdFederationData` lists information
...
- `sourceIdentity` – See [AWS STS source identity](#STS-API-source-identity "#STS-API-source-identity") in this topic. The
  ...
  assumed roles](../../../IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.md "../../../IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.md") in the
  _IAM User Guide_.
- `ec2RoleDelivery` – The
...
Language (SAML) and web identity federation. When a user makes a call to the [`AssumeRoleWithSAML`](../../../STS/latest/APIReference/API_AssumeRoleWithSAML.md "../../../STS/latest/APIReference/API_AssumeRoleWithSAML.md") and [`AssumeRoleWithWebIdentity`](../../../STS/latest/APIReference/API_AssumeRoleWithWebIdentity.md "../../../STS/latest/APIReference/API_AssumeRoleWithWebIdentity.md") APIs, CloudTrail records the call and
...
`SAMLUser` and `WebIdentityUser` types, see [Logging IAM and AWS STS API calls with AWS CloudTrail](../../../IAM/latest/UserGuide/cloudtrail-integration.md "../../../IAM/latest/UserGuide/cloudtrail-integration.md").
...
- The AWS STS `AssumeRole`, `AssumeRoleWithSAML`, or
  ...
  it uses a role to assume another role, known as [role chaining](../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md#iam-term-role-chaining "../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md#iam-term-role-chaining"). `sourceIdentity` is
...
information, see [Monitor and control actions taken with assumed roles](../../../IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.md "../../../IAM/latest/UserGuide/id_credentials_temp_control-access_monitor.md") in
the _IAM User Guide_. For more information about AWS STS events that
are logged to CloudTrail, see [Logging IAM and AWS STS API calls with AWS CloudTrail](../../../IAM/latest/UserGuide/cloudtrail-integration.md "../../../IAM/latest/UserGuide/cloudtrail-integration.md") in the
_IAM User Guide_.
