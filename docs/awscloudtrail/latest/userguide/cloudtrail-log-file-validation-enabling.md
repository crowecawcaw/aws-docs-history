...
trails. For more information, see [Creating and updating a trail with the console](cloudtrail-create-and-update-a-trail-by-using-the-console.md "cloudtrail-create-and-update-a-trail-by-using-the-console.md").

## AWS CLI

To enable log file integrity validation with the AWS CLI, use the
`--enable-log-file-validation` option with the [create-trail](../../../cli/latest/reference/cloudtrail/create-trail.md "../../../cli/latest/reference/cloudtrail/create-trail.md") or [update-trail](../../../cli/latest/reference/cloudtrail/update-trail.md "../../../cli/latest/reference/cloudtrail/update-trail.md") commands. To
...
For more information, see [CreateTrail](../APIReference/API_CreateTrail.md "../APIReference/API_CreateTrail.md") and [UpdateTrail](../APIReference/API_UpdateTrail.md "../APIReference/API_UpdateTrail.md") in the [AWS CloudTrail API Reference](../APIReference.md "../APIReference.md").
