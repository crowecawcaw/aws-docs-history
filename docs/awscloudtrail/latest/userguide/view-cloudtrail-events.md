...
by viewing the **Event history** page. You can also look up these events by running the [`aws cloudtrail
 lookup-events`](../../../cli/latest/reference/cloudtrail/lookup-events.md "../../../cli/latest/reference/cloudtrail/lookup-events.md") command or by using the [`LookupEvents`](../APIReference/API_LookupEvents.md "../APIReference/API_LookupEvents.md") API.
