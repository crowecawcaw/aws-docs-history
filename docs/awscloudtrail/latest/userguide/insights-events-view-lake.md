...
CloudTrail Lake queries incur costs based upon the amount of data scanned.
 ...
 information about CloudTrail pricing, see [AWS CloudTrail Pricing](https://aws.amazon.com/cloudtrail/pricing/ "https://aws.amazon.com/cloudtrail/pricing/").
...
![Example shows sample queries for Insights events](images/ct-insights-sample-queries.png)
