...
`eventTime` timestamps to queries. 10. Choose the **Visualizer** tab to select the chart type
for the widget. You can choose from these chart types: table, bar chart,
line chart, and pie chart. 11. Choose **Add to dashboard** to add the widget to the
dashboard. 12. Choose **Save** to save the dashboard.
