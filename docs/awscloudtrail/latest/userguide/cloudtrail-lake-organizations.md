...
| --- | --- | --- | 
| Register or remove delegated administrator accounts. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
| Create an organization event data store for AWS CloudTrail events or AWS Config configuration items. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| Enable Insights on an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
| Update an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes1 | 
| Start and stop event ingestion on an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| Enable Lake query federation on an organization event data store.2 | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| Disable Lake query federation on an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| Delete an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| Copy trail events to an event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
| Run queries on organization event data stores. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | 
| View a managed dashboard for an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
| Enable the Highlights dashboard for organization event data stores. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
| Create a widget for a custom dashboard that queries an organization event data store. | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/success_icon.png) Yes | ![](http://docs.aws.amazon.com/awscloudtrail/latest/userguide/images/negative_icon.png) No | 
