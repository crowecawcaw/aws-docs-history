...
The S3 bucket policy must grant CloudTrail access to 
 ...
 events](cloudtrail-copy-trail-to-lake-eds.md#copy-trail-events-permissions-s3 "cloudtrail-copy-trail-to-lake-eds.md#copy-trail-events-permissions-s3").
5. For **Specify a time range of events**, choose the time range for
