...
You can use CloudTrail to log and store user activity data from any source in your
 ...
 in the CloudTrail Lake console, then call the [`PutAuditEvents`](https://docs.aws.amazon.com/awscloudtraildata/latest/APIReference/API_PutAuditEvents.html "https://docs.aws.amazon.com/awscloudtraildata/latest/APIReference/API_PutAuditEvents.html") API to ingest events,
...
8. When you are ready to create the new integration, choose **Add
 ...
 channel ARN in a [`PutAuditEvents`](https://docs.aws.amazon.com/awscloudtraildata/latest/APIReference/API_PutAuditEvents.html "https://docs.aws.amazon.com/awscloudtraildata/latest/APIReference/API_PutAuditEvents.html") request.
...
Use [AWS CloudShell](../../../cloudshell/latest/userguide/welcome.md "../../../cloudshell/latest/userguide/welcome.md") to be sure you are running the
 ...
 **--audit-events** and **--channel-arn**
 ...
 and an [optional
 checksum](#event-data-store-integration-custom-checksum "#event-data-store-integration-custom-checksum") to help validate the integrity of the event after
