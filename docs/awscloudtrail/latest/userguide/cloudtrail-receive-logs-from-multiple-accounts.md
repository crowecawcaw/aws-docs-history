...
For instructions, see [Creating a trail with the console](cloudtrail-create-a-trail-using-the-console-first-time.md#creating-a-trail-in-the-console "cloudtrail-create-a-trail-using-the-console-first-time.md#creating-a-trail-in-the-console").
2. Update the bucket policy on your destination bucket to grant cross-account
 permissions to CloudTrail.


For instructions, see [Setting bucket policy for multiple accounts](cloudtrail-set-bucket-policy-for-multiple-accounts.md "cloudtrail-set-bucket-policy-for-multiple-accounts.md").
