...
events to an existing event data store, see [Copy trail events to an existing event data store with the console](cloudtrail-copy-trail-events-lake.md "cloudtrail-copy-trail-events-lake.md"). For more information about creating a new event data store, see
...
- [Considerations for copying trail events](#cloudtrail-trail-copy-considerations-lake "#cloudtrail-trail-copy-considerations-lake")
- [Required permissions for copying trail events](#copy-trail-events-permissions "#copy-trail-events-permissions")
- [Copy trail events to an existing event data store with the console](cloudtrail-copy-trail-events-lake.md "cloudtrail-copy-trail-events-lake.md")
- [Copy trail events to a new event data store with the console](scenario-lake-import.md "scenario-lake-import.md")
- [View event copy details with the CloudTrail console](copy-trail-details.md "copy-trail-details.md")
...
- [IAM permissions
  for copying trail events](#copy-trail-events-permissions-iam "#copy-trail-events-permissions-iam")
- [Amazon S3 bucket policy for copying trail
  events](#copy-trail-events-permissions-s3 "#copy-trail-events-permissions-s3")
- [KMS key policy for decrypting data
  in the source S3 bucket](#copy-trail-events-permissions-kms "#copy-trail-events-permissions-kms")
