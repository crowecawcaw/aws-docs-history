...
- [Supported Regions for CloudTrail service-linked roles](#slr-regions-create-slr-for-org-trails "#slr-regions-create-slr-for-org-trails")
...
- [Supported Regions for CloudTrail service-linked roles](#slr-regions-create-slr-for-context-management "#slr-regions-create-slr-for-context-management")
