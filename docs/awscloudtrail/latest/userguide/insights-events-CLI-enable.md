...
You will use the `ARN` (or ID suffix of the ARN) from the
 ...
 in step 3.
2. Run the [**aws cloudtrail create-event-data-store**](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/create-event-data-store.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/create-event-data-store.html")
...
You will use the `ARN` (or ID suffix of the ARN) from the
 ...
 step 3.
3. Run the [**put-insight-selectors**](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/put-insight-selectors.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudtrail/put-insight-selectors.html") command to enable
