...
The following example shows how you can use the `aws:SourceArn` and
 ...
 deputy problem: [Amazon S3 bucket policy for CloudTrail Lake query results](s3-bucket-policy-lake-query-results.md "s3-bucket-policy-lake-query-results.md").
