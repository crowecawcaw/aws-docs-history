...
Key](../../../AmazonS3/latest/userguide/bucket-key.md "../../../AmazonS3/latest/userguide/bucket-key.md"), CloudTrail must be allowed permission in the key policy to use the AWS KMS
...
KMS key](../../../kms/latest/developerguide/key-state.md "../../../kms/latest/developerguide/key-state.md") in the _AWS Key Management Service Developer
Guide_.
