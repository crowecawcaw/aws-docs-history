...
Additional
 charges apply for data or Insights events. For more information, see [AWS CloudTrail Pricing](https://aws.amazon.com/cloudtrail/pricing/ "https://aws.amazon.com/cloudtrail/pricing/").
...
Management events can also include non-API events that occur in your account. For
 ...
 event. For more information, see [Non-API events captured by CloudTrail](cloudtrail-non-api-events.md "cloudtrail-non-api-events.md").
...
The CloudTrail **Event history** feature supports only
 ...
 history**. For more information, see [Working with CloudTrail event history](view-cloudtrail-events.md "view-cloudtrail-events.md"). 
...
* [Updating the management event settings for an existing trail](#logging-management-events-with-the-cloudtrail-console-trail "#logging-management-events-with-the-cloudtrail-console-trail")
* [Updating the management event settings for an existing event data store](#logging-management-events-with-the-cloudtrail-console-eds "#logging-management-events-with-the-cloudtrail-console-eds")
...
* [Examples: Logging management events for trails](#log-mgmt-events-trails-examples "#log-mgmt-events-trails-examples")
* [Examples: Logging management events for event data stores](#log-mgmt-events-eds-examples "#log-mgmt-events-eds-examples")
...
* [Examples: Logging management events for trails using advanced event selectors](#log-mgmt-events-trails-examples-adv "#log-mgmt-events-trails-examples-adv")
* [Examples: Logging management events for trails using basic event selectors](#log-mgmt-events-trails-examples-basic "#log-mgmt-events-trails-examples-basic")
...
* **`eventSource`** – 
 ...
 without spaces plus `.amazonaws.com`. For example, you could set `eventSource` `Equals` to 
 `ec2.amazonaws.com` to log only Amazon EC2 management events.
* **`eventType`** – The [eventType](cloudtrail-event-reference-record-contents.md#ct-event-type "cloudtrail-event-reference-record-contents.md#ct-event-type") to include or exclude. For
 example, you can set this field to `NotEquals`
`AwsServiceEvent` to exclude [AWS service events](non-api-aws-service-events.md "non-api-aws-service-events.md"). You
...
* [Example: Exclude AWS KMS management events](#log-mgmt-events-eds-examples-kms "#log-mgmt-events-eds-examples-kms")
* [Example: Exclude Amazon RDS management events](#log-mgmt-events-eds-examples-rds "#log-mgmt-events-eds-examples-rds")
* [Example: Exclude AWS service events and events from AWS Management Console sessions](#log-mgmt-events-eds-examples-service "#log-mgmt-events-eds-examples-service")
* [Example: Exclude management events for a specific IAM identity](#log-mgmt-events-eds-examples-useridentity "#log-mgmt-events-eds-examples-useridentity")
...
Use the [GetEventSelectors](../APIReference/API_GetEventSelectors.md "../APIReference/API_GetEventSelectors.md")
 ...
 configure your trails to log management events with the [PutEventSelectors](../APIReference/API_PutEventSelectors.md "../APIReference/API_PutEventSelectors.md") operation.
...
Run the [GetEventDataStore](../APIReference/API_GetEventDataStore.md "../APIReference/API_GetEventDataStore.md")
 ...
 configure your event data stores to include management events by running the [CreateEventDataStore](../APIReference/API_CreateEventDataStore.md "../APIReference/API_CreateEventDataStore.md") or [UpdateEventDataStore](../APIReference/API_UpdateEventDataStore.md "../APIReference/API_UpdateEventDataStore.md") operations.
