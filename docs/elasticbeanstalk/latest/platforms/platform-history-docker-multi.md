...
<a name="platform-history-docker-multi"></a>
...
This page lists previous versions of AWS Elastic Beanstalk's Multicontainer Docker platform branches and the dates that each version was current. This platform branch was marked as **retired** on July 18, 2022, along with all other platform branches based on Amazon Linux AMI (AL1). Previous platform versions remain accessible to accounts with active or terminated environments using them at the time they were superseded by a new version.

For Multicontainer Docker platform versions that were current earlier than September 25, 2017, see [Docker platform earlier history](platform-history-docker-legacy.md).
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.27.8** <br /> * 64bit Amazon Linux 2018.03 v2.27.8 running Multi-container Docker 20.10.13-ce (Generic) *  | 2018.03.0 | 20.10.13 | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.27.6** <br /> * 64bit Amazon Linux 2018.03 v2.27.6 running Multi-container Docker 20.10.7 (Generic) *  | 2018.03.0 | 20.10.7 | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.27.4** <br /> * 64bit Amazon Linux 2018.03 v2.27.4 running Multi-container Docker 20.10.7 (Generic) *  | 2018.03.0 | 20.10.7 | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.27.2** <br /> * 64bit Amazon Linux 2018.03 v2.27.2 running Multi-container Docker 20.10.7 (Generic) *  | 2018.03.0 | 20.10.7 | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.27.0** <br /> * 64bit Amazon Linux 2018.03 v2.27.0 running Multi-container Docker 20.10.7 (Generic) *  | 2018.03.0 | 20.10.7 | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.26.4** <br /> * 64bit Amazon Linux 2018.03 v2.26.4 running Multi-container Docker 19.03.13-ce (Generic) *  | 2018.03.0 | 19.03.13-ce | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  ** Multicontainer Docker version 2.26.2** <br /> * 64bit Amazon Linux 2018.03 v2.26.2 running Multi-container Docker 19.03.13-ce (Generic) *  | 2018.03.0 | 19.03.13-ce | 1.51.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker Version  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  **Multicontainer Docker 17.12 version 2.10.0** <br /> * 64bit Amazon Linux 2018.03 v2.10.0 running Multi-container Docker 17.12.1-ce (Generic) *  | 2018.03.0 | 17.12.1-ce | 1.17.3 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker Version  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  **Multicontainer Docker 17.12 version 2.9.1** <br /> *64bit Amazon Linux 2017.09 v2.9.1 running Multi-container Docker 17.12.0-ce (Generic)*  | 2017.09.1 | 17.12.0-ce | 1.17.2 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker Version  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  **Multicontainer Docker 17.09 version 2.8.4** <br /> *64bit Amazon Linux 2017.09 v2.8.4 running Multi-container Docker 17.09.1-ce (Generic)*  | 2017.09.1 | 17.09.1-ce | 1.16.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker Version  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  **Multicontainer Docker 17.06 version 2.8.2** <br /> *64bit Amazon Linux 2017.09 v2.8.2 running Multi-container Docker 17.06.2-ce (Generic)*  | 2017.09.1 | 17.06.2-ce | 1.16.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Docker Version  |  ECS Agent  | 
| --- | --- | --- | --- | 
|  **Multicontainer Docker 17.03 version 2.7.5** <br /> *64bit Amazon Linux 2017.03 v2.7.5 running Multi-container Docker 17.03.2-ce (Generic)*  | 2017.03.1 | 17.03.2-ce | 1.14.4 | 