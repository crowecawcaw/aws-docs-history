...
The following Elastic Beanstalk platform versions for Tomcat have been current since March 11, 2026:
...
The following Elastic Beanstalk platform versions for Tomcat were current between February 25, 2026 and February 25, 2026:

| Platform Version and _Solution Stack Name_                                                                              | AMI              | Language             | AWS X-Ray | Application Server | Proxy Server                          |
| ----------------------------------------------------------------------------------------------------------------------- | ---------------- | -------------------- | --------- | ------------------ | ------------------------------------- |
| **Corretto 25 with Tomcat 11 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 11 Corretto 25_ | 2023.10.20260216 | Corretto 25.0.2.10.1 | 3.6.2     | Tomcat 11.0.18     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 21 with Tomcat 11 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 11 Corretto 21_ | 2023.10.20260216 | Corretto 21.0.10.7.1 | 3.6.2     | Tomcat 11.0.18     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 17 with Tomcat 11 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 11 Corretto 17_ | 2023.10.20260216 | Corretto 17.0.18.9.1 | 3.6.2     | Tomcat 11.0.18     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 21 with Tomcat 10 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 10 Corretto 21_ | 2023.10.20260216 | Corretto 21.0.10.7.1 | 3.6.2     | Tomcat 10.1.52     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 17 with Tomcat 10 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 10 Corretto 17_ | 2023.10.20260216 | Corretto 17.0.18.9.1 | 3.6.2     | Tomcat 10.1.52     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 17 with Tomcat 9 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 9 Corretto 17_   | 2023.10.20260216 | Corretto 17.0.18.9.1 | 3.6.2     | Tomcat 9.0.111     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 11 with Tomcat 9 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 9 Corretto 11_   | 2023.10.20260216 | Corretto 11.0.30.7.1 | 3.6.2     | Tomcat 9.0.111     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 8 with Tomcat 9 AL2023 version 5.10.1**<br>_64bit Amazon Linux 2023 v5.10.1 running Tomcat 9 Corretto 8_     | 2023.10.20260216 | Corretto 8.482.08.1  | 3.6.2     | Tomcat 9.0.115     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 11 with Tomcat 9 AL2 version 4.10.5**<br>_64bit Amazon Linux 2 v4.10.5 running Tomcat 9 Corretto 11_         | 2.0.20260216     | Corretto 11.0.30.7.1 | 3.6.2     | Tomcat 9.0.110     | nginx 1.28.2 (default), Apache 2.4.66 |
| **Corretto 8 with Tomcat 9 AL2 version 4.10.5**<br>_64bit Amazon Linux 2 v4.10.5 running Tomcat 9 Corretto 8_           | 2.0.20260216     | Corretto 8.482.08.1  | 3.6.2     | Tomcat 9.0.110     | nginx 1.28.2 (default), Apache 2.4.66 |

## February 12, 2026 – February 24, 2026

The following Elastic Beanstalk platform versions for Tomcat were current between February 12, 2026 and February 24, 2026:
