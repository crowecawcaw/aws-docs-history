...
The following Elastic Beanstalk platform versions for Tomcat have been current since February 12, 2026:

| Platform Version and _Solution Stack Name_                                                                              | AMI              | Language             | AWS X-Ray | Application Server | Proxy Server                          |
| ----------------------------------------------------------------------------------------------------------------------- | ---------------- | -------------------- | --------- | ------------------ | ------------------------------------- |
| **Corretto 8 with Tomcat 9 AL2023 version 5.10.0**<br>_64bit Amazon Linux 2023 v5.10.0 running Tomcat 9 Corretto 8_     | 2023.10.20260202 | Corretto 8.482.08.1  | 3.6.1     | Tomcat None        | nginx 1.28.1 (default), Apache 2.4.66 |
