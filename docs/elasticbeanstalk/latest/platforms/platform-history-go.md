...
The following Elastic Beanstalk platform versions for Go have been current since March 11, 2026:
...
The following Elastic Beanstalk platform versions for Go were current between February 25, 2026 and February 25, 2026:

| Platform Version and _Solution Stack Name_                                     | AMI              | Language   | AWS X-Ray | Proxy Server |
| ------------------------------------------------------------------------------ | ---------------- | ---------- | --------- | ------------ |
| **Go 1 AL2023 version 4.5.5**<br>_64bit Amazon Linux 2023 v4.5.5 running Go 1_ | 2023.10.20260216 | Go 1.24.13 | 3.6.2     | nginx 1.28.2 |
| **Go 1 AL2 version 3.15.1**<br>_64bit Amazon Linux 2 v3.15.1 running Go 1_     | 2.0.20260216     | Go 1.26.0  | 3.6.2     | nginx 1.28.2 |

## February 12, 2026 – February 24, 2026

The following Elastic Beanstalk platform versions for Go were current between February 12, 2026 and February 24, 2026:
