...
# Go platform history
<a name="platform-history-go"></a>

This page lists the current and previous versions of AWS Elastic Beanstalk's Go platform branches and the dates that each version was current. Previous platform versions remain accessible to accounts with active or terminated environments using them at the time they were superseded by a new version.
...
The following Elastic Beanstalk platform versions for Go have been current since September 10, 2026:
...
The following Elastic Beanstalk platform versions for Go were current between August 24, 2026 and September 9, 2026:
...
|  ** Go 1 AL2 version 3.19.3** <br /> * 64bit Amazon Linux 2 v3.19.3 running Go 1 *  | 2.0.20260629 | Go 1.26.4 | 3.6.5 | nginx 1.30.2 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.9.3** <br /> * 64bit Amazon Linux 2023 v4.9.3 running Go 1 *  | 2023.12.20260622 | Go 1.25.11 | 3.6.5 | nginx 1.30.2 | 
|  ** Go 1 AL2 version 3.19.2** <br /> * 64bit Amazon Linux 2 v3.19.2 running Go 1 *  | 2.0.20260622 | Go 1.26.4 | 3.6.5 | nginx 1.30.2 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.4.6** <br /> * 64bit Amazon Linux 2023 v4.4.6 running Go 1 *  | 2023.9.20250929 | Go 1.24.7 | 3.3.15 | nginx 1.28.0 | 
|  ** Go 1 AL2 version 3.13.6** <br /> * 64bit Amazon Linux 2 v3.13.6 running Go 1 *  | 2.0.20250929 | Go 1.25.1 | 3.3.15 | nginx 1.28.0 | 
...
|  ** Go 1 AL2 version 3.13.4** <br /> * 64bit Amazon Linux 2 v3.13.4 running Go 1 *  | 2.0.20250818 | Go 1.25.0 | 3.3.15 | nginx 1.28.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.4.3** <br /> * 64bit Amazon Linux 2023 v4.4.3 running Go 1 *  | 2023.8.20250804 | Go 1.24.5 | 3.3.15 | nginx 1.28.0 | 
|  ** Go 1 AL2 version 3.13.3** <br /> * 64bit Amazon Linux 2 v3.13.3 running Go 1 *  | 2.0.20250804 | Go 1.24.5 | 3.3.15 | nginx 1.28.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.3.2** <br /> * 64bit Amazon Linux 2023 v4.3.2 running Go 1 *  | 2023.7.20250512 | Go 1.24.2 | 3.3.14 | nginx 1.26.3 | 
|  ** Go 1 AL2 version 3.12.2** <br /> * 64bit Amazon Linux 2 v3.12.2 running Go 1 *  | 2.0.20250512 | Go 1.24.3 | 3.3.14 | nginx 1.26.3 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.2.2** <br /> * 64bit Amazon Linux 2023 v4.2.2 running Go 1 *  | 2023.6.20241212 | Go 1.22.7 | 3.3.13 | nginx 1.26.2 | 
|  ** Go 1 AL2 version 3.11.4** <br /> * 64bit Amazon Linux 2 v3.11.4 running Go 1 *  | 2.0.20241113 | Go 1.23.3 | 3.3.13 | nginx 1.22.1 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.2.0** <br /> * 64bit Amazon Linux 2023 v4.2.0 running Go 1 *  | 2023.6.20241031 | Go 1.22.7 | 3.3.13 | nginx 1.26.2 | 
|  ** Go 1 AL2 version 3.11.3** <br /> * 64bit Amazon Linux 2 v3.11.3 running Go 1 *  | 2.0.20241031 | Go 1.23.2 | 3.3.13 | nginx 1.22.1 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2023 version 4.1.4** <br /> * 64bit Amazon Linux 2023 v4.1.4 running Go 1 *  | 2023.5.20240903 | Go 1.22.5 | 3.3.13 | nginx 1.24.0 | 
|  ** Go 1 AL2 version 3.11.1** <br /> * 64bit Amazon Linux 2 v3.11.1 running Go 1 *  | 2.0.20240903 | Go 1.23.1 | 3.3.13 | nginx 1.22.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.7.2** <br /> * 64bit Amazon Linux 2 v3.7.2 running Go 1 *  | 2.0.20230418 | Go 1.20.3 | 3.2.0 | nginx 1.22.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.6.1** <br /> * 64bit Amazon Linux 2 v3.6.1 running Go 1 *  | 2.0.20221004 | Go 1.19.2 | 3.2.0 | nginx 1.22.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.5.5** <br /> * 64bit Amazon Linux 2 v3.5.5 running Go 1 *  | 2.0.20220805 | Go 1.19 | 3.2.0 | nginx 1.20.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.5.3** <br /> * 64bit Amazon Linux 2 v3.5.3 running Go 1 *  | 2.0.20220606 | Go 1.18.3 | 3.2.0 | nginx 1.20.0 | 
|  ** Go 1 version 2.19.3** <br /> * 64bit Amazon Linux 2018.03 v2.19.3 running Go 1.18.3 *  | 2018.03.0 | Go 1.18.3 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.19.2** <br /> * 64bit Amazon Linux 2018.03 v2.19.2 running Go 1.18.2 *  | 2018.03.0 | Go 1.18.2 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.19.1** <br /> * 64bit Amazon Linux 2018.03 v2.19.1 running Go 1.18 *  | 2018.03.0 | Go 1.18 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.19.0** <br /> * 64bit Amazon Linux 2018.03 v2.19.0 running Go 1.18 *  | 2018.03.0 | Go 1.18 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.12** <br /> * 64bit Amazon Linux 2018.03 v2.18.12 running Go 1.17.7 *  | 2018.03.0 | Go 1.17.7 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.11** <br /> * 64bit Amazon Linux 2018.03 v2.18.11 running Go 1.17.6 *  | 2018.03.0 | Go 1.17.6 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.10** <br /> * 64bit Amazon Linux 2018.03 v2.18.10 running Go 1.17.5 *  | 2018.03.0 | Go 1.17.5 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.9** <br /> * 64bit Amazon Linux 2018.03 v2.18.9 running Go 1.17.3 *  | 2018.03.0 | Go 1.17.3 | 3.1.0 | nginx 1.18.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.4.3** <br /> * 64bit Amazon Linux 2 v3.4.3 running Go 1 *  | 2.0.20211103 | Go 1.17.3 | 3.2.0 | nginx 1.20.0 | 
|  ** Go 1 version 2.18.8** <br /> * 64bit Amazon Linux 2018.03 v2.18.8 running Go 1.17.2 *  | 2018.03.0 | Go 1.17.2 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.7** <br /> * 64bit Amazon Linux 2018.03 v2.18.7 running Go 1.17.1 *  | 2018.03.0 | Go 1.17.1 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.6** <br /> * 64bit Amazon Linux 2018.03 v2.18.6 running Go 1.16.6 *  | 2018.03.0 | Go 1.16.6 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.5** <br /> * 64bit Amazon Linux 2018.03 v2.18.5 running Go 1.16.6 *  | 2018.03.0 | Go 1.16.6 | 3.1.0 | nginx 1.18.0 | 
...
|  ** Go 1 version 2.18.4** <br /> * 64bit Amazon Linux 2018.03 v2.18.4 running Go 1.16.5 *  | 2018.03.0 | Go 1.16.5 | 3.1.0 | nginx 1.18.0 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.3.2** <br /> * 64bit Amazon Linux 2 v3.3.2 running Go 1 *  | 2.0.20210617 | Go 1.16.5 | 3.2.0 | nginx 1.20.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.2.1** <br /> * 64bit Amazon Linux 2 v3.2.1 running Go 1 *  | 2.0.20210326 | Go 1.16.2 | 3.2.0 | nginx 1.18.0 | 
|  ** Go 1 version 2.18.1** <br /> * 64bit Amazon Linux 2018.03 v2.18.1 running Go 1.16.2 *  | 2018.03.0 | Go 1.16.2 | 3.1.0 | nginx 1.18.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.2.0** <br /> * 64bit Amazon Linux 2 v3.2.0 running Go 1 *  | 2.0.20210219 | Go 1.16 | 3.2.0 | nginx 1.18.0 | 
|  ** Go 1 version 2.18.0** <br /> * 64bit Amazon Linux 2018.03 v2.18.0 running Go 1.16 *  | 2018.03.0 | Go 1.16 | 3.1.0 | nginx 1.18.0 | 
...
| --- | --- | --- | --- | --- | 
|  ** Go 1 AL2 version 3.1.2** <br /> * 64bit Amazon Linux 2 v3.1.2 running Go 1 *  | 2.0.20200928 | Go 1.15.2 | 3.2.0 | nginx 1.18.0 | 
|  ** Go 1.14 version 2.16.0** <br /> * 64bit Amazon Linux 2018.03 v2.16.0 running Go 1.15.1 *  | 2018.03.0 | Go 1.15.1 | 3.1.0 | nginx 1.16.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** Go 1.14 AL2 version 3.0.1** <br /> * 64bit Amazon Linux 2 v3.0.1 running Go 1.14.2 *  | 2.0.20200430 | Go 1.14.2 | 3.2.0 | nginx 1.16.1 | 
|  ** Go 1.14 version 2.15.3** <br /> * 64bit Amazon Linux 2018.03 v2.15.3 running Go 1.14.2 *  | 2018.03.0 | Go 1.14.2 | 3.1.0 | nginx 1.16.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  **Go 1.11 version 2.10.1** <br /> * 64bit Amazon Linux 2018.03 v2.10.0 running Go 1.11.5 *  | 2018.03.0 | Go 1.11.5 | 3.0.0 | nginx 1.14.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  **Go 1.11 version 2.9.4** <br /> * 64bit Amazon Linux 2018.03 v2.9.4 running Go 1.11.4 *  | 2018.03.0 | Go 1.11.4 | 2.0.0 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.10 version 2.8.0** <br /> * 64bit Amazon Linux 2018.03 v2.8.0 running Go 1.10 *  | 2018.03.0 | Go 1.10 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.9 version 2.7.6** <br /> *64bit Amazon Linux 2017.09 v2.7.6 running Go 1.9*  | 2017.09.1 | Go 1.9.4 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.9 version 2.7.4** <br /> *64bit Amazon Linux 2017.09 v2.7.4 running Go 1.9*  | 2017.09.1 | Go 1.9.1 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.9 version 2.7.2** <br /> *64bit Amazon Linux 2017.09 v2.7.2 running Go 1.9*  | 2017.09.1 | Go 1.9.1 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.9 version 2.7.0** <br /> *64bit Amazon Linux 2017.09 v2.7.0 running Go 1.9*  | 2017.09.0 | Go 1.9.1 | nginx 1.12.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.8 version 2.6.0** <br /> *64bit Amazon Linux 2017.03 v2.6.0 running Go 1.8*  | 2017.03.1 | Go 1.8.3 | nginx 1.10.3 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.8 version 2.5.0** <br /> *64bit Amazon Linux 2017.03 v2.5.0 running Go 1.8*  | 2017.03.1 | Go 1.8.3 | nginx 1.10.3 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.7 version 2.4.1** <br /> *64bit Amazon Linux 2017.03 v2.4.1 running Go 1.7*  | 2017.03.0 | Go 1.7.5 | nginx 1.10.2 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.6 version 2.3.3** <br /> *64bit Amazon Linux 2016.09 v2.3.3 running Go 1.6*  | 2016.09.0 | Go 1.6.3 | nginx 1.10.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.6 version 2.3.1** <br /> *64bit Amazon Linux 2016.09 v2.3.1 running Go 1.6*  | 2016.09.0 | Go 1.6.3 | nginx 1.10.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.5 version 2.2.2** <br /> *64bit Amazon Linux 2016.09 v2.2.2 running Go 1.5*  | 2016.09.0 | Go 1.5.3 | nginx 1.10.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.5 version 2.1.6** <br /> *64bit Amazon Linux 2016.03 v2.1.6 running Go 1.5*  | 2016.03.3 | Go 1.5.3 | nginx 1.8.1 | 
...
|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Proxy Server  | 
| --- | --- | --- | --- | 
|  **Go 1.4 version 2.1.0** <br /> *64bit Amazon Linux 2016.03 v2.1.0 running Go 1.4*  | 2016.03 | Go 1.4.2 | nginx 1.8.1 | 
...
|  Platform Version and *Solution Stack Name*  |  AMI  |  Language  |  Web Server  | 
| --- | --- | --- | --- | 
| **Go 1.4 version 2.0.7**<br />*64bit Amazon Linux 2015.09 v2.0.7 running Go 1.4* | 2015.09 | Go 1.4.2 | nginx 1.8.0 | 
...
|  Platform Version and *Solution Stack Name*  |  AMI  |  Language  |  Web Server  | 
| --- | --- | --- | --- | 
| **Go 1.4 version 2.0.3**<br />*64bit Amazon Linux 2015.03 v2.0.3 running Go 1.4* | 2015.03 | Go 1.4.2 | nginx 1.6.2 | 