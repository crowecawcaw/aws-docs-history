...
| ---------------------------------------------------------------------------- | ------------ | --------- | ------- | -------------- | ------------ | ---------- |
| **Docker AL2 version 4.9.4**<br>_64bit Amazon Linux 2 v4.9.4 running Docker_ | 2.0.20260710 |           | 25.0.16 | 5.3.1          | nginx 1.30.3 | 2026-06-30 |
| **ECS AL2 version 3.10.4**<br>_64bit Amazon Linux 2 v3.10.4 running ECS_     | 2.0.20260710 | 1.105.0   | 25.0.16 |                |              | 2026-06-30 |
...
| -------------------------------------------------------------------------- | ------------ | --------- | --------- | ------------ | ---------- |
| **Go 1 AL2 version 3.19.4**<br>_64bit Amazon Linux 2 v3.19.4 running Go 1_ | 2.0.20260710 | Go 1.26.5 | 3.6.5     | nginx 1.30.3 | 2026-06-30 |
...
| ------------------------------------------------------------------------------------ | ------------ | --------------------- | ---------------------------------------- | --------- | ------------ | ---------- |
| **Corretto 17 version 3.14.4**<br>_64bit Amazon Linux 2 v3.14.4 running Corretto 17_ | 2.0.20260710 | Corretto 17.0.19.10.1 | Ant 1.10.17, Gradle 8.14.5, Maven 3.9.16 | 3.6.5     | nginx 1.30.3 | 2026-06-30 |
| **Corretto 11 version 3.14.4**<br>_64bit Amazon Linux 2 v3.14.4 running Corretto 11_ | 2.0.20260710 | Corretto 11.0.31.11.1 | Ant 1.10.17, Gradle 8.14.5, Maven 3.9.16 | 3.6.5     | nginx 1.30.3 | 2026-06-30 |
| **Corretto 8 version 3.14.4**<br>_64bit Amazon Linux 2 v3.14.4 running Corretto 8_   | 2.0.20260710 | Corretto 8.492.09.1   | Ant 1.10.17, Gradle 8.14.5, Maven 3.9.16 | 3.6.5     | nginx 1.30.3 | 2026-06-30 |
...
| --------------------------------------------------------------------------------------------------------------- | ------------ | --------------------- | --------- | ------------------ | ------------------------------------- | ---------- |
| **Corretto 11 with Tomcat 9 AL2 version 4.14.4**<br>_64bit Amazon Linux 2 v4.14.4 running Tomcat 9 Corretto 11_ | 2.0.20260710 | Corretto 11.0.31.11.1 | 3.6.5     | Tomcat 9.0.118     | nginx 1.30.3 (default), Apache 2.4.68 | 2026-06-30 |
| **Corretto 8 with Tomcat 9 AL2 version 4.14.4**<br>_64bit Amazon Linux 2 v4.14.4 running Tomcat 9 Corretto 8_   | 2.0.20260710 | Corretto 8.492.09.1   | 3.6.5     | Tomcat 9.0.118     | nginx 1.30.3 (default), Apache 2.4.68 | 2026-06-30 |
...
| --------------------------------------------------------------------------------------- | ---------------------------- | ------------ | ---------------- | --------- | ---------- |
| **.NET 9 on AL2023 version 3.11.4**<br>_64bit Amazon Linux 2023 v3.11.4 running .NET 9_ | .NET 9.0.18, supports 9.0.18 | nginx 1.30.3 | 2023.12.20260710 | 3.6.5     | 2027-03-31 |
| **.NET 8 on AL2023 version 3.11.4**<br>_64bit Amazon Linux 2023 v3.11.4 running .NET 8_ | .NET 8.0.29, supports 8.0.29 | nginx 1.30.3 | 2023.12.20260710 | 3.6.5     | 2027-03-31 |
| **.NET Core on AL2 version 2.16.4**<br>_64bit Amazon Linux 2 v2.16.4 running .NET Core_ | .NET 8.0.29, supports 8.0.29 | nginx 1.30.3 | 2.0.20260710     | 3.6.5     | 2026-06-30 |
...
| --------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------ | ---------- |
| **Windows Server 2016 with IIS 10.0 version 2.23.2**      | _64bit Windows Server 2016 v2.23.2 running IIS 10.0_      | .NET 10.0.9, supports 10.0.9, 9.0.17, 8.0.28<br>.NET Framework 4.8, supports 4.x, 2.0 | IIS 10.0     | 2026-09-30 |
| **Windows Server Core 2016 with IIS 10.0 version 2.23.2** | _64bit Windows Server Core 2016 v2.23.2 running IIS 10.0_ | .NET 10.0.9, supports 10.0.9, 9.0.17, 8.0.28<br>.NET Framework 4.8, supports 4.x, 2.0 | IIS 10.0     | 2026-09-30 |
...
| -------------------------------------------------------------------------------------------- | ---------------- | -------------------------------------------- | ------------------------------------- | ------ | --------- | ---------- |
| **Node.js 20 AL2023 version 6.11.4**<br>_64bit Amazon Linux 2023 v6.11.4 running Node.js 20_ | 2023.12.20260710 | 20.20.2 (10.8.2)<br>Default version: 20.20.2 | nginx 1.30.3 (default), Apache 2.4.68 | 2.50.1 | 3.6.5     | 2026-07-31 |
...
| -------------------------------------------------------------------------------------- | ---------------- | ---------- | -------------------------- | ------------------------------------- | ---------- |
| **PHP 8.2 AL2023 version 4.13.4**<br>_64bit Amazon Linux 2023 v4.13.4 running PHP 8.2_ | 2023.12.20260710 | PHP 8.2.31 | Composer 2.10.2, PIE 1.4.8 | nginx 1.30.3 (default), Apache 2.4.68 | 2027-03-31 |
...
| -------------------------------------------------------------------------------------------- | ---------------- | ------------- | --------------------------- | --------- | ------------------------------------- | ---------- |
| **Python 3.9 AL2023 version 4.13.4**<br>_64bit Amazon Linux 2023 v4.13.4 running Python 3.9_ | 2023.12.20260710 | Python 3.9.25 | pip 26.0.1, pipenv 2025.0.4 | 3.6.5     | nginx 1.30.3 (default), Apache 2.4.68 | 2026-07-31 |
...
| ---------------------------------------------------------------------------------------- | ---------------- | ---------- | --------------- | ------------------ | --------- | ------------ | ---------- |
| **Ruby 3.2 AL2023 version 4.14.4**<br>_64bit Amazon Linux 2023 v4.14.4 running Ruby 3.2_ | 2023.12.20260710 | Ruby 3.2.8 | RubyGems 3.4.19 | Puma 8.0.2         | 3.6.5     | nginx 1.30.3 | 2026-07-31 |
