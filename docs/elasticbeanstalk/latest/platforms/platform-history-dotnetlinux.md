...
The following Elastic Beanstalk platform versions for .NET Core on Linux have been current since September 10, 2026:
...
The following Elastic Beanstalk platform versions for .NET Core on Linux were current between August 24, 2026 and September 9, 2026:
...
|  ** .NET 9 on AL2023 version 3.7.3** <br /> * 64bit Amazon Linux 2023 v3.7.3 running .NET 9 *  | .NET 9.0.13, supports 9.0.13 | nginx 1.28.1 | 2023.10.20260202 | 3.6.1 | 
|  ** .NET 8 on AL2023 version 3.7.3** <br /> * 64bit Amazon Linux 2023 v3.7.3 running .NET 8 *  | .NET 8.0.24, supports 8.0.24 | nginx 1.28.1 | 2023.10.20260202 | 3.6.1 | 
...
|  ** .NET 9 on AL2023 version 3.5.6** <br /> * 64bit Amazon Linux 2023 v3.5.6 running .NET 9 *  | .NET 9.0.9, supports 9.0.9 | nginx 1.28.0 | 2023.9.20250929 | 3.3.15 | 
|  ** .NET 8 on AL2023 version 3.5.6** <br /> * 64bit Amazon Linux 2023 v3.5.6 running .NET 8 *  | .NET 8.0.20, supports 8.0.20 | nginx 1.28.0 | 2023.9.20250929 | 3.3.15 | 
|  ** .NET Core on AL2 version 2.11.6** <br /> * 64bit Amazon Linux 2 v2.11.6 running .NET Core *  | .NET 8.0.20, supports 8.0.20 | nginx 1.28.0 | 2.0.20250929 | 3.3.15 | 
...
|  ** .NET Core on AL2 version 2.11.3** <br /> * 64bit Amazon Linux 2 v2.11.4 running .NET Core *  | .NET 8.0.19, supports 8.0.19 | nginx 1.28.0 | 2.0.20250818 | 3.3.15 | 
...
|  ** .NET 8 on AL2023 version 3.4.0** <br /> * 64bit Amazon Linux 2023 v3.4.0 running .NET 8 *  | .NET 8.0.14, supports 8.0.14 | nginx 1.26.3 | 2023.6.20250317 | 3.3.14 | 
|  ** .NET Core on AL2 version 2.9.0** <br /> * 64bit Amazon Linux 2 v2.9.0 running .NET Core *  | .NET 8.0.14, supports 8.0.14, 6.0.36 | nginx 1.26.3 | 2.0.20250321 | 3.3.14 | 
|  ** .NET 6 on AL2023 version 3.4.0** <br /> * 64bit Amazon Linux 2023 v3.4.0 running .NET 6 *  | .NET 6.0.36, supports 6.0.36 | nginx 1.26.3 | 2023.6.20250317 | 3.3.14 | 
...
|  ** .NET 6 on AL2023 version 3.3.1** <br /> * 64bit Amazon Linux 2023 v3.3.1 running .NET 6 *  | .NET 6.0.36, supports 6.0.36 | nginx 1.26.3 | 2023.6.20250218 | 3.3.14 | 
...
|  ** .NET Core on AL2 version 2.8.7** <br /> * 64bit Amazon Linux 2 v2.8.7 running .NET Core *  | .NET 8.0.12, supports 8.0.12, 6.0.36 | nginx 1.22.1 | 2.0.20250123 | 3.3.13 | 
|  ** .NET 6 on AL2023 version 3.3.0** <br /> * 64bit Amazon Linux 2023 v3.3.0 running .NET 6 *  | .NET 6.0.36, supports 6.0.36 | nginx 1.26.2 | 2023.6.20250123 | 3.3.13 | 
...
|  ** .NET 6 on AL2023 version 3.2.2** <br /> * 64bit Amazon Linux 2023 v3.2.2 running .NET 6 *  | .NET 6.0.36, supports 6.0.36 | nginx 1.26.2 | 2023.6.20241212 | 3.3.13 | 
...
|  ** .NET Core on AL2 version 2.8.5** <br /> * 64bit Amazon Linux 2 v2.8.5 running .NET Core *  | .NET 8.0.11, supports 8.0.11, 6.0.36 | nginx 1.22.1 | 2.0.20241113 | 3.3.13 | 
|  ** .NET 6 on AL2023 version 3.2.1** <br /> * 64bit Amazon Linux 2023 v3.2.1 running .NET 6 *  | .NET 6.0.32, supports 6.0.32 | nginx 1.26.2 | 2023.6.20241111 | 3.3.13 | 
...
|  ** .NET Core on AL2 version 2.8.5** <br /> * 64bit Amazon Linux 2 v2.8.5 running .NET Core *  | .NET 8.0.11, supports 8.0.11, 6.0.36 | nginx 1.22.1 | 2.0.20241113 | 3.3.13 | 
|  ** .NET 6 on AL2023 version 3.2.0** <br /> * 64bit Amazon Linux 2023 v3.2.0 running .NET 6 *  | .NET 6.0.32, supports 6.0.32 | nginx 1.26.2 | 2023.6.20241031 | 3.3.13 | 
...
<a name="platform-history-2024-05-17"></a>
...
|  Platform Version and *Solution Stack Name*   |  Framework  |  Proxy Server  |  AMI  |  AWS X-Ray  | 
| --- | --- | --- | --- | --- | 
|  ** .NET Core on AL2 version 2.3.5** <br /> * 64bit Amazon Linux 2 v2.3.5 running .NET Core *  | .NET 6.0.8, supports 6.0.8, 5.0.17, 3.1.28 | nginx 1.20.0 | 2.0.20220805 | 3.2.0 | 
...
|  Platform Version and *Solution Stack Name*   |  Framework  |  Proxy Server  |  AMI  |  AWS X-Ray  | 
| --- | --- | --- | --- | --- | 
|  ** .NET Core on AL2 version 2.2.4** <br /> * 64bit Amazon Linux 2 v2.2.4 running .NET Core *  | .NET 5.0.8, supports 5.0.8, 3.1.17, 2.1.28 | nginx 1.20.0 | 2.0.20210721 | 3.2.0 | 
...
|  Platform Version and *Solution Stack Name*   |  Framework  |  Proxy Server  |  AMI  |  AWS X-Ray  | 
| --- | --- | --- | --- | --- | 
|  ** .NET Core on AL2 version 2.1.4** <br /> * 64bit Amazon Linux 2 v2.1.4 running .NET Core *  | .NET 5.0.4, supports 5.0.4, 3.1.13, 2.1.26 | nginx 1.18.0 | 2.0.20210326 | 3.2.0 | 
