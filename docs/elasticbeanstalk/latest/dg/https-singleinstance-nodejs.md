...
with a public certificate and private key.

If you configured your environment for [enhanced health reporting](health-enhanced.md "health-enhanced.md"), you need to configure nginx to generate access
...
Creates the certificate file on the instance. Replace `certificate file
 contents` with the contents of your certificate.
