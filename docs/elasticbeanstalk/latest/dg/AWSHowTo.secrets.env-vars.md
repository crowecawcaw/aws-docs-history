...
- The secrets environment variables are available to [ebextension](platforms-linux-extend.config-files.md "platforms-linux-extend.config-files.md") container commands and
...
2. Set up the required IAM permissions for your environment’s EC2 instances to fetch the secrets and parameters. For more information, see
   [Required IAM permissions](AWSHowTo.secrets.IAM-permissions.md "AWSHowTo.secrets.IAM-permissions.md").
...
[required IAM permissions](AWSHowTo.secrets.IAM-permissions.md "AWSHowTo.secrets.IAM-permissions.md") to access to it. 10. If you need to add more variables repeat **Step 6** through **Step 9**. 11. To save the changes choose **Apply** at the bottom of the page.
...
- Upgrade your Amazon Linux 2 environment to Amazon Linux 2023. For more information, see [Migration from Amazon Linux 2 to Amazon Linux 2023](using-features.migration-al.generic.from-al2.md "using-features.migration-al.generic.from-al2.md").
...
- Design your application code to retrieve the data directly from Secrets Manager or Systems Manager Parameter Store. For more information, see
  _Retrieving secrets_ in [Using Secrets Manager](AWSHowTo.secrets.Secrets-Manager-and-Parameter-Store.md#AWSHowTo.secrets.Secrets-Manager "AWSHowTo.secrets.Secrets-Manager-and-Parameter-Store.md#AWSHowTo.secrets.Secrets-Manager") or _Retrieving parameters_
