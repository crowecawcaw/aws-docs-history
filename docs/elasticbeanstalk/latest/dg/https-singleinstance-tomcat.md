...
Your certificate vendor may include intermediate certificates that you can install for
...
[Extending and overriding the default Apache configuration — Amazon Linux AMI (AL1)](java-tomcat-proxy.md#java-tomcat-proxy-apache "java-tomcat-proxy.md#java-tomcat-proxy-apache")
for the location):
...
- Add a new entry to the `files` key with the contents of the intermediate
  certificates:
