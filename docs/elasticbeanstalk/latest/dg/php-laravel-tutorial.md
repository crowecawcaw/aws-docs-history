...
Laravel is an open source, model-view-controller (MVC) framework for PHP. This tutorial walks you through the process of generating a Laravel
application, deploying it to an AWS Elastic Beanstalk environment, and configuring it to connect to an Amazon Relational Database Service (Amazon RDS) database instance.

###### Sections

- [Prerequisites](#php-laravel-tutorial-prereqs "#php-laravel-tutorial-prereqs")
- [Launch an Elastic Beanstalk environment](#php-laravel-tutorial-launch "#php-laravel-tutorial-launch")
- [Install Laravel and generate a website](#php-laravel-tutorial-generate "#php-laravel-tutorial-generate")
- [Deploy your application](#php-laravel-tutorial-deploy "#php-laravel-tutorial-deploy")
- [Configure Composer settings](#php-laravel-tutorial-configure "#php-laravel-tutorial-configure")
- [Add a database to your environment](#php-laravel-tutorial-database "#php-laravel-tutorial-database")
- [Cleanup](#php-laravel-tutorial-cleanup "#php-laravel-tutorial-cleanup")
- [Next steps](#php-laravel-tutorial-nextsteps "#php-laravel-tutorial-nextsteps")
...
Laravel 6 requires PHP 7.2 or later. It also requires the PHP extensions listed in the [server requirements](https://laravel.com/docs/6.x/installation#server-requirements "https://laravel.com/docs/6.x/installation#server-requirements") topic in the official Laravel documentation. Follow the instructions to install PHP and Composer.

For Laravel support and maintenance information, see the [support policy](https://laravel.com/docs/master/releases#support-policy "https://laravel.com/docs/master/releases#support-policy")
topic on the official Laravel documentation.
...
If you run into any issues installing Laravel, go to the installation topic in the official documentation: [https://laravel.com/docs/6.x](https://laravel.com/docs/6.x "https://laravel.com/docs/6.x").
...
source bundle named `laravel-default.zip`. It excludes files in the `vendor` folder, which take up a lot of space
...
archive command](applications-sourcebundle.md#using-features.deployment.source.git "applications-sourcebundle.md#using-features.deployment.source.git") to create the source bundle. The default Laravel project includes a `.gitignore` file that tells
...
To serve the Laravel application at the root path, use the Elastic Beanstalk console to configure the _document root_ for the website.
...
![Laravel logo with navigation menu items: Documentation, Laracasts, News, Forge, GitHub.](images/php-laravel-defaultnodb.png)
...
Launch an RDS DB instance in your Elastic Beanstalk environment. You can use MySQL, SQLServer, or PostgreSQL databases with Laravel on Elastic Beanstalk. For this example,
we'll use MySQL.
...
Laravel's database configuration is stored in a file named `database.php` in the `config` folder in your project
...
For more information about Laravel, go to the Laravel official website at [laravel.com](https://laravel.com/ "https://laravel.com/").
