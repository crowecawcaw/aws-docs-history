...
- [Your AWS account](#go-quickstart-aws-account "#go-quickstart-aws-account")
- [Prerequisites](#go-quickstart-prereq "#go-quickstart-prereq")
- [Step 1: Create a Go application](#go-quickstart-create-app "#go-quickstart-create-app")
- [Step 2: Deploy your Go application with the EB CLI](#go-quickstart-deploy "#go-quickstart-deploy")
- [Step 3: Run your application on Elastic Beanstalk](#go-quickstart-run-eb-ap "#go-quickstart-run-eb-ap")
- [Step 4: Clean up](#go-tutorial-cleanup "#go-tutorial-cleanup")
- [AWS resources for your application](#go-quickstart-eb-resources "#go-quickstart-eb-resources")
- [Next steps](#go-quickstart-next-steps "#go-quickstart-next-steps")
- [Deploy with the Elastic Beanstalk console](#go-quickstart-console "#go-quickstart-console")
...
If you already have an AWS account, you can move on to [Prerequisites](#go-quickstart-prereq "#go-quickstart-prereq").
...
This command creates an application named `go-tutorial` and configures your local repository to create environments with the
latest Go platform version. 2. (Optional) Run **eb init** again to configure a default key pair so that you can use SSH to connect to the EC2 instance running
your application.
...
After you deploy a sample application or two and are ready to start developing and running Go applications locally, see [Setting up your Go development environment for Elastic Beanstalk](go-devenv.md "go-devenv.md").
