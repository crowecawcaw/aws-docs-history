...
**Choose AWS Transform MGN when you have the following
requirements:**
...
For more information about AWS Transform MGN, see [What is AWS Transform MGN?](../../../mgn/latest/ug/what-is-application-migration-service.md "../../../mgn/latest/ug/what-is-application-migration-service.md") in the AWS Transform MGN User Guide.
