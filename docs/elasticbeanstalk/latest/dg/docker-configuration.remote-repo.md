...
- [platform hook scripts](platforms-linux-extend.hooks.md "platforms-linux-extend.hooks.md") to execute **docker login** before pulling images
...
For more details, see [environment secrets](AWSHowTo.secrets.env-vars.md "AWSHowTo.secrets.env-vars.md").
...
to configure secrets as environment variables](AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.configure-env-vars.prerequisites "AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.configure-env-vars.prerequisites") for details.
...
###### Notes
    ...
    * For more information about platform hooks, see [Platform hooks](platforms-linux-extend.hooks.md "platforms-linux-extend.hooks.md") in *Extending Elastic Beanstalk Linux
     platforms*.
