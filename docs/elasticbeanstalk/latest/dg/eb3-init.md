...
| `-k` {{keyname}}<br />`--keyname` {{keyname}} | The name of the Amazon EC2 key pair to use with the Secure Shell (SSH) client to securely log in to the Amazon EC2 instances running your Elastic Beanstalk application. |  | 
