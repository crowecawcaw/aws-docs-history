...
| ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| -a `application-name`<br>or<br>--application\_name `application-name`     | The name of the application. If an application with the specified name isn't found, the EB CLI creates an application version for a new<br>application.<br>Only applicable with the `--create` option.<br>Type: String                                                                                |
