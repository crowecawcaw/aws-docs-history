...
information about health checks, see [Health checks](create_deploy_NET.managing.elb.md#create_deploy_NET.managing.elb.healthchecks "create_deploy_NET.managing.elb.md#create_deploy_NET.managing.elb.healthchecks").
...
instances, see [Listing and connecting to server instances](create_deploy_NET.ec2connect.md "create_deploy_NET.ec2connect.md").
