...
up _Auto Scaling groups_ and associate _triggers_ with these groups to automatically scale computing resources based
...
![Elastic Beanstalk Auto Scaling configuration panel](images/aeb-vs-autoscaling.png)
