...
On Amazon Linux 2023, `mod_wsgi` must be installed separately as it's not available in the package repositories. For installation instructions, see [mod\_wsgi](https://pypi.org/project/mod-wsgi/) on PyPI.
