...
Elastic Beanstalk supports multiple [versions](concepts.platforms.md "concepts.platforms.md") for most of the platforms that are listed. By default, the console
...
here. For information about supported platform versions, see [Elastic Beanstalk supported platforms](concepts.platforms.md "concepts.platforms.md"). 6. For **Application code**, you have several choices to proceed.
...
1. (Optional) If you previously created an EC2 key pair, you can select it from the **EC2 key pair** field dropdown. You would use it
   ...
   pair after the environment is created. For more information, see [EC2 key pair](using-features.managing.security.md#using-features.managing.security.keypair "using-features.managing.security.md#using-features.managing.security.keypair").
...
After you have an environment running an application, you can [deploy a new version](using-features.deploy-existing-version.md "using-features.deploy-existing-version.md") of
