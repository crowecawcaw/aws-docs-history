...
information about instance log streaming, see [Using Elastic Beanstalk with Amazon CloudWatch Logs](AWSHowTo.cloudwatchlogs.md "AWSHowTo.cloudwatchlogs.md").
...
###### Example [Health streaming configuration file](samples/aws_eb_cloudwatchlogs-envhealth.zip.md "samples/aws_eb_cloudwatchlogs-envhealth.zip.md")
