...
- _Access control_ – Use tags to manage permissions to requests and resources. For example, a user who can only create and
  manage beta environments should only have access to beta stage resources. For details, see [Using tags to control access to Elastic Beanstalk resources](AWSHowTo.iam.policies.access-tags.md "AWSHowTo.iam.policies.access-tags.md").
...
- [Environments](using-features.tagging.md "using-features.tagging.md")
