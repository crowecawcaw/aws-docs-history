...
testing purposes. For more information, see [Server certificates](configuring-https.certificate.md "configuring-https.certificate.md").
...
- [Server certificates](configuring-https.certificate.md "configuring-https.certificate.md")
