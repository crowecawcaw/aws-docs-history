...
- [Parameters](#ebextensions-otherkeys-parameters "#ebextensions-otherkeys-parameters")
- [Outputs](#ebextensions-otherkeys-outputs "#ebextensions-otherkeys-outputs")
- [Mappings](#ebextensions-otherkeys-mappings "#ebextensions-otherkeys-mappings")
...
###### Example [Loadbalancer-accesslogs-existingbucket.config](https://github.com/awsdocs/elastic-beanstalk-samples/tree/main/configuration-files/aws-provided/resource-configuration/loadbalancer-accesslogs-existingbucket.config "https://github.com/awsdocs/elastic-beanstalk-samples/tree/main/configuration-files/aws-provided/resource-configuration/loadbalancer-accesslogs-existingbucket.config") – Parameters
...
You can use a mapping to store key-value pairs organized by namespace. A mapping can help you organize values that you use throughout your configs, or
