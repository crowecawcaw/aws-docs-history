...
**Topics**
+ [Migrating your Elastic Beanstalk environment to launch templates](environments-cfg-autoscaling-launch-templates.md)
+ [Spot Instance support for your Elastic Beanstalk environment](environments-cfg-autoscaling-spot.md)
+ [Auto Scaling triggers for your Elastic Beanstalk environment](environments-cfg-autoscaling-triggers.md)
+ [Scheduled Auto Scaling actions for your Elastic Beanstalk environments](environments-cfg-autoscaling-scheduledactions.md)
+ [Auto Scaling health check setting for your Elastic Beanstalk environment](environmentconfig-autoscaling-healthchecktype.md)