...
**Topics**
+ [QuickStart: Deploy a Java application to Elastic Beanstalk](java-quickstart.md)
+ [QuickStart: Deploy a Java JSP web application for Tomcat to Elastic Beanstalk](tomcat-quickstart.md)
+ [Setting up your Java development environment](java-development-environment.md)
+ [More Elastic Beanstalk example applications and tutorials for Java](java-getstarted.md)
...
+ [Adding an Amazon RDS DB instance to your Java Elastic Beanstalk environment](java-rds.md)
+ [Java tools and resources](create_deploy_Java.resources.md)