...
| --- | --- | --- | --- | 
| **All at once** |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | 
| **Rolling** |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | 
| **Rolling with an additional batch** |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No | 
...
| **Traffic splitting** |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes (Application Load Balancer) |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No | 
...
| --- | --- | --- | --- | --- | --- | --- | 
| All at once | Downtime | ![Deployment time: 1 of 4 (fastest).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png) |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | Manual redeploy | Existing instances | 
| Rolling | Single batch out of service; any successful batches before failure running new application version | ![Deployment time: 2 of 4 (moderate).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)† |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | Manual redeploy | Existing instances | 
| Rolling with an additional batch | Minimal if first batch fails; otherwise, similar to Rolling | ![Deployment time: 3 of 4 (slower).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)† |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | Manual redeploy | New and existing instances | 
| Immutable | Minimal | ![Deployment time: 4 of 4 (slowest).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png) |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | Terminate new instances | New instances | 
| Traffic splitting | Percentage of client traffic routed to new version temporarily impacted | ![Deployment time: 4 of 4 (slowest).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)†† |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes | Reroute traffic and terminate new instances | New instances | 
| Blue/green | Minimal | ![Deployment time: 4 of 4 (slowest).](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png)![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/clock.png) |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-yes.png) Yes |  ![](http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/images/icon-no.png) No | Swap URL | New instances | 
