...
- **Action** specifies the [API operations](../api/API_Operations.md "../api/API_Operations.md") that you want to
  ...
  such as creating an environment, require additional permissions to perform those actions. For more information, see [Resources and conditions for Elastic Beanstalk actions](AWSHowTo.iam.policies.actions.md "AWSHowTo.iam.policies.actions.md").
...
- **Resource** specifies the resources that you want to control access to. To specify Elastic Beanstalk resources, list the [Amazon Resource Name](AWSHowTo.iam.policies.arn.md "AWSHowTo.iam.policies.arn.md") (ARN) of each resource.
