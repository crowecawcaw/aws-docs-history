...
| --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| Web Server                                          | [nodejs.zip](samples/nodejs.zip.md "samples/nodejs.zip.md")                                                                                     | Single page application.<br>To launch the sample application with the EB CLI, see [QuickStart for Node.js](nodejs-quickstart.md "nodejs-quickstart.md").<br>You can also use the Elastic Beanstalk console to launch the sample application. For<br>detailed steps, see [Create an example<br>application](GettingStarted.md#GettingStarted.CreateApp "GettingStarted.md#GettingStarted.CreateApp") in the \*Getting started<br>• chapter of this<br>guide. |
| Web Server with Amazon RDS                          | [nodejs-example-express-rds.zip](samples/nodejs-example-express-rds.zip.md "samples/nodejs-example-express-rds.zip.md")                         | Hiking log application that uses the Express framework and an Amazon Relational Database Service<br>(RDS).<br>[Tutorial](create_deploy_nodejs_express.md "create_deploy_nodejs_express.md")                                                                                                                                                                                                                                                                 |
| Web Server with Amazon ElastiCache                  | [nodejs-example-express-elasticache.zip](samples/nodejs-example-express-elasticache.zip.md "samples/nodejs-example-express-elasticache.zip.md") | Express web application that uses Amazon ElastiCache for clustering. Clustering enhances<br>your web application's high availability, performance, and security.<br>[Tutorial](nodejs-express-clustering.md "nodejs-express-clustering.md")                                                                                                                                                                                                                 |
| Web Server with DynamoDB, Amazon SNS and Amazon SQS | [nodejs-example-dynamo.zip](samples/nodejs-example-dynamo.zip.md "samples/nodejs-example-dynamo.zip.md")                                        | Express web site that collects user contact information for a new company's<br>marketing campaign. Uses the AWS SDK for JavaScript in Node.js to write entries to a DynamoDB table, and Elastic Beanstalk<br>configuration files to create resources in DynamoDB, Amazon SNS and Amazon SQS.<br>[Tutorial](nodejs-dynamodb-tutorial.md "nodejs-dynamodb-tutorial.md")                                                                                       |
