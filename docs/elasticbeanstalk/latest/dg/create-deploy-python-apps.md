...
Follow the steps in the [QuickStart for Python](python-quickstart.md) for step-by-step instructions to create and deploy a Python *Hello World* web application with the EB CLI.

**Topics**
+ [QuickStart: Deploy a Python application to Elastic Beanstalk](python-quickstart.md)
+ [Setting up your Python development environment for Elastic Beanstalk](python-development-environment.md)
