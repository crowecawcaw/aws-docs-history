...
applies to data protection in AWS Elastic Beanstalk. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Elastic Beanstalk or other AWS services
...
- [Protecting data using encryption](security-data-protection-encryption.md "security-data-protection-encryption.md")
- [Internetwork traffic privacy](security-data-protection-internetwork.md "security-data-protection-internetwork.md")
