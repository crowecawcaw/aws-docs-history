...
server instances using the AWS Management Console, see [Listing and connecting to server instances](using-features.ec2connect.md "using-features.ec2connect.md"). The following section steps you through viewing
