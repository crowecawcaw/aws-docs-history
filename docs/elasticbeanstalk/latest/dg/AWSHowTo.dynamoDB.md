...
with a configuration file and connects to it with the AWS SDK for JavaScript in Node.js. For an example walkthrough using DynamoDB with PHP, see [Example: DynamoDB, CloudWatch, and SNS](customize-environment-resources-dynamodb.md "customize-environment-resources-dynamodb.md"). For an example that uses the AWS SDK for Java,
