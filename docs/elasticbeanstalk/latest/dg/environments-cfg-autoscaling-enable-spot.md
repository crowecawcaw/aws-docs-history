...
option for your environment. Your environment's Amazon EC2 Auto Scaling group then combines Amazon EC2 purchase
...
Before you enable Spot Instances for your environment, become familiar with the Amazon EC2 Auto Scaling,
...
The topics that follow provide details about the Amazon EC2 Auto Scaling and capacity management options
...
configure Amazon EC2 Auto Scaling monitoring and health checks.
