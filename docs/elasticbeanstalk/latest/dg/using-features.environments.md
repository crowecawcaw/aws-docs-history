...
- [Clone an Elastic Beanstalk environment](using-features.managing.clone.md "using-features.managing.clone.md")
- [Terminate an Elastic Beanstalk environment](using-features.terminating.md "using-features.terminating.md")
- [Creating Elastic Beanstalk environments with the AWS CLI](environments-create-awscli.md "environments-create-awscli.md")
