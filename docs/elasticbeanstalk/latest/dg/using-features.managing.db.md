...
require additional security group and connection string configuration. For more information, see [Using Elastic Beanstalk with Amazon RDS](AWSHowTo.RDS.md "AWSHowTo.RDS.md").
...
- _Retain_ — The database instance isn't terminated. It remains available and operational, though decoupled from Elastic Beanstalk.
  You can then configure one or multiple environments to connect to the database as an external Amazon RDS database instance. For more information, see [Using Elastic Beanstalk with Amazon RDS](AWSHowTo.RDS.md "AWSHowTo.RDS.md").
...
see [Master User Account Privileges](../../../AmazonRDS/latest/UserGuide/UsingWithRDS.MasterAccounts.md "../../../AmazonRDS/latest/UserGuide/UsingWithRDS.MasterAccounts.md").
...
[Using Elastic Beanstalk with Amazon RDS](AWSHowTo.RDS.md "AWSHowTo.RDS.md"). If you plan to use the database that you decouple for a production environment, verify the
