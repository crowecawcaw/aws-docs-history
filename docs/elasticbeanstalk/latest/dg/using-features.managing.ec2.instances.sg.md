...
`true`. Use the [AWS CLI](using-features.managing.ec2.aws-cli.md "using-features.managing.ec2.aws-cli.md") or
...
Inbound traffic to an environment with multiple EC2 instances is managed by the [load balancer](using-features.managing.elb.md "using-features.managing.elb.md"), which directs incoming traffic
...
- At least one security group must be assigned to the load balancer using the `SecurityGroups`
  ...
  AWS CLI](using-features.managing.ec2.aws-cli.md "using-features.managing.ec2.aws-cli.md").
