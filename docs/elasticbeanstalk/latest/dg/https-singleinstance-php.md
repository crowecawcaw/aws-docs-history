...
For PHP container types, you use a [configuration file](ebextensions.md "ebextensions.md") to
enable the Apache HTTP Server to use HTTPS.
...
Configures the Apache server. This file loads when the Apache service
starts.
