...
<a name="release-2020-06-03-al2"></a>

This release introduces AWS Elastic Beanstalk Tomcat Amazon Linux 2 platform branches and provides new versions for platforms based on Amazon Linux 2. The release includes security updates. It also includes Go, Node.js, PHP, and Ruby updates, and brings back support for static files.

**Release date:** June 3, 2020

## Changes
<a name="release-2020-06-03-al2.changes"></a>

The following table lists the changes included in this release.

**Notes**  
Be aware that at the time these release notes are published, the new platform versions might not yet be available in all the AWS Regions that Elastic Beanstalk supports. It might take a few hours for the release to complete.
*[June 4, 2020]* We now added an updated Docker version. It was missing when we released this update on June 3, 2020.  
...
<tbody>
  <tr><td><b>Security updates</b></td><td>Applied all security updates published in the <a href="https://alas.aws.amazon.com/alas2.html">Amazon Linux Security Center</a> on or before <b>May 20, 2020</b> to all Amazon Linux 2 platforms.<br />The <b>PHP</b> release includes security fixes. For more information, see <b>Platform-specific updates</b> in this table.</td></tr>
  <tr><td><b>Cross-platform updates</b></td><td>Added back the support for configuring the proxy to serve static files in the released Amazon Linux 2 platforms.</td></tr>
...
<tbody>
  <tr><td><b>Corretto with Tomcat</b></td><td>Introduced Corretto with Tomcat platform branches running on Amazon Linux 2. We support all combinations of Corretto 11 and Corretto 8 with Tomcat 8.5 and Tomcat 7.</td></tr>
  ...
  <tr><td><b>Node.js</b></td><td>Updated the Node.js platform to add support for Node versions <a href="https://nodejs.org/en/blog/release/v12.17.0/">12.17.0</a>, <a href="https://nodejs.org/en/blog/release/v12.16.3/">12.16.3</a>, and <a href="https://nodejs.org/en/blog/release/v10.20.1/">10.20.1</a>.</td></tr>
  <tr><td><b>PHP</b></td><td>Updated PHP 7.4, 7.3, and 7.2 to releases <a href="https://www.php.net/releases/7_4_5.php">7.4.5</a>, <a href="https://www.php.net/releases/7_3_17.php">7.3.17</a>, and <a href="https://www.php.net/releases/7_2_30.php">7.2.30</a>, respectively.<br />These versions include security fixes.</td></tr>
  <tr><td><b>Ruby</b></td><td>Updated some Ruby platform components: RubyGems 3.1.3, Puma 4.3.5.</td></tr>
</tbody>
</table>
</td></tr>
</tbody>
...
<a name="release-2020-06-03-al2.platforms"></a>
...
**Topics**
+ [Single Container Docker](#release-2020-06-04-al2.platforms.docker)
+ [Go](#release-2020-06-03-al2.platforms.go)
+ [Java SE](#release-2020-06-03-al2.platforms.javase)
+ [Tomcat](#release-2020-06-03-al2.platforms.java)
+ [Node.js](#release-2020-06-03-al2.platforms.nodejs)
+ [PHP](#release-2020-06-03-al2.platforms.PHP)
+ [Python](#release-2020-06-03-al2.platforms.python)
+ [Ruby](#release-2020-06-03-al2.platforms.ruby)

### Single Container Docker
<a name="release-2020-06-04-al2.platforms.docker"></a>
...
### Go
<a name="release-2020-06-03-al2.platforms.go"></a>
...
### Java SE
<a name="release-2020-06-03-al2.platforms.javase"></a>
...
### Tomcat
<a name="release-2020-06-03-al2.platforms.java"></a>
...
### Node.js
<a name="release-2020-06-03-al2.platforms.nodejs"></a>
...
### PHP
<a name="release-2020-06-03-al2.platforms.PHP"></a>
...
### Python
<a name="release-2020-06-03-al2.platforms.python"></a>
...
### Ruby
<a name="release-2020-06-03-al2.platforms.ruby"></a>
