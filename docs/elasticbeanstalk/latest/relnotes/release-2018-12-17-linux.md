...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before December 7,<br>2018 to all Linux-based platforms.<br>See also the *_Node.js_<br>• entry in *_Platform-specific updates_<br>• for a platform<br>specific security update. |
...
| -------------------------------------------------------------------------------------- | --------- | ------------- | --------------- | ----------------- | ----------- | --------- | -------------------------------- |
| **Python 3.6 version 2.7.7**<br>_64bit Amazon Linux 2018.03 v2.7.7 running Python 3.6_ | 2018.03.0 | Python 3.6.5  | pip 9.0.3       | setuptools 28.8.0 | meld3 1.0.2 | 2.0.0     | Apache 2.4.34 with mod\_wsgi 3.5 |
| **Python 3.4 version 2.7.7**<br>_64bit Amazon Linux 2018.03 v2.7.7 running Python 3.4_ | 2018.03.0 | Python 3.4.8  | pip 9.0.3       | setuptools 28.8.0 | meld3 1.0.2 | 2.0.0     | Apache 2.4.34 with mod\_wsgi 3.5 |
| **Python 2.7 version 2.7.7**<br>_64bit Amazon Linux 2018.03 v2.7.7 running Python 2.7_ | 2018.03.0 | Python 2.7.14 | pip 9.0.3       | setuptools 28.8.0 | meld3 1.0.2 | 2.0.0     | Apache 2.4.34 with mod\_wsgi 3.5 |
| **Python 2.6 version 2.7.7**<br>_64bit Amazon Linux 2018.03 v2.7.7 running Python 2.6_ | 2018.03.0 | Python 2.6.9  | pip 9.0.3       | setuptools 28.8.0 | meld3 1.0.2 | 2.0.0     | Apache 2.4.34 with mod\_wsgi 3.5 |
