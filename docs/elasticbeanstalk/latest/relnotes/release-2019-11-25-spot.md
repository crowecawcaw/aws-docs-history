...
_Amazon EC2 User Guide_. For more information about Spot support in Elastic Beanstalk, see [Auto Scaling Group for Your Elastic Beanstalk Environment](../dg/using-features.managing.as.md "../dg/using-features.managing.as.md") in the _AWS Elastic Beanstalk Developer Guide_.
