...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before<br>*_March 19, 2021_<br>• to all Amazon Linux 2 platforms.<br>The *_Go_<br>• and *_.NET Core_<br>• releases are security releases.<br>For more information, see *_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                      | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_AMI_<br>•    | Updated the base AMI to version 2.0.20210326.                                                                                                          |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                   | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Docker_<br>• | Updated Docker Compose to version [1.28.6](https://docs.docker.com/compose/release-notes/#1284 "https://docs.docker.com/compose/release-notes/#1284"). | <br> | *_Go_<br>• | Updated Go to release **1.16.2**. For details, see [go1.16](https://golang.org/doc/devel/release.html#go1.16 "https://golang.org/doc/devel/release.html#go1.16") in _The Go Programming Language Release<br>History_.<br>The Go 1.16.1 release (included in this platform update) is a security release. | <br> | *_Tomcat_<br>• | Updated Tomcat 8.5 to [Tomcat<br>8.5.63](<https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.63_(markt)> "https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.63_(markt)"). | <br> | *_.NET Core_<br>• | Updated .NET Core to version [5.0.4](https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.4/5.0.4.md "https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.4/5.0.4.md").<br>This update is a security release. | <br> | *_PHP_<br>• | Added a new platform branch, **PHP 8.0**. For more information, see [PHP 8.0.0 Release Announcement](https://www.php.net/releases/8_0_0.php "https://www.php.net/releases/8_0_0.php"). | <br> | *_Ruby_<br>• | Updated RubyGems to release [3.2.14](https://blog.rubygems.org/2021/03/08/3.2.14-released.html "https://blog.rubygems.org/2021/03/08/3.2.14-released.html").<br>Updated Puma to version [5.2.2](https://github.com/puma/puma/releases/tag/v5.2.2 "https://github.com/puma/puma/releases/tag/v5.2.2"). |     |
...
- [Docker](#release-2021-03-31-al2.platforms.docker "#release-2021-03-31-al2.platforms.docker")
- [Go](#release-2021-03-31-al2.platforms.go "#release-2021-03-31-al2.platforms.go")
- [Java SE](#release-2021-03-31-al2.platforms.javase "#release-2021-03-31-al2.platforms.javase")
- [Tomcat](#release-2021-03-31-al2.platforms.java "#release-2021-03-31-al2.platforms.java")
- [.NET Core on Linux](#release-2021-03-31-al2.platforms.dotnetlinux "#release-2021-03-31-al2.platforms.dotnetlinux")
- [Node.js](#release-2021-03-31-al2.platforms.nodejs "#release-2021-03-31-al2.platforms.nodejs")
- [PHP](#release-2021-03-31-al2.platforms.PHP "#release-2021-03-31-al2.platforms.PHP")
- [Python](#release-2021-03-31-al2.platforms.python "#release-2021-03-31-al2.platforms.python")
- [Ruby](#release-2021-03-31-al2.platforms.ruby "#release-2021-03-31-al2.platforms.ruby")
