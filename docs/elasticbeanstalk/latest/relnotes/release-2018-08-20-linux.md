...
- [Packer Builder](#release-2018-08-20-linux.platforms.packer "#release-2018-08-20-linux.platforms.packer")
- [Single Container Docker](#release-2018-08-20-linux.platforms.docker "#release-2018-08-20-linux.platforms.docker")
- [Multicontainer Docker](#release-2018-08-20-linux.platforms.mcdocker "#release-2018-08-20-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2018-08-20-linux.platforms.dockerpreconfig "#release-2018-08-20-linux.platforms.dockerpreconfig")
- [Go](#release-2018-08-20-linux.platforms.go "#release-2018-08-20-linux.platforms.go")
- [Java SE](#release-2018-08-20-linux.platforms.javase "#release-2018-08-20-linux.platforms.javase")
- [Java with Tomcat](#release-2018-08-20-linux.platforms.java "#release-2018-08-20-linux.platforms.java")
- [Node.js](#release-2018-08-20-linux.platforms.nodejs "#release-2018-08-20-linux.platforms.nodejs")
- [PHP](#release-2018-08-20-linux.platforms.PHP "#release-2018-08-20-linux.platforms.PHP")
- [Python](#release-2018-08-20-linux.platforms.python "#release-2018-08-20-linux.platforms.python")
- [Ruby](#release-2018-08-20-linux.platforms.ruby "#release-2018-08-20-linux.platforms.ruby")

### Packer Builder

| Configuration and _Solution Stack Name_                                                                        | AMI       | Packer Version |
| -------------------------------------------------------------------------------------------------------------- | --------- | -------------- |
| **Elastic Beanstalk Packer Builder version 2.6.1**<br>_64bit Amazon Linux 2018.03 v2.6.1 running Packer 1.0.3_ | 2018.03.0 | 1.0.3          |
...
| ----------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------- | -------------------- | ---------- | ------------ | ------------------ | --------------------------------------------- |
| **Glassfish 5.0 (Docker) version 2.12.2**<br>_64bit Amazon Linux v2.12.2 running GlassFish 5.0 Java 8 (Preconfigured<br>• Docker)_  | 2018.03.0 | Docker 18.03.1-ce | Amazon Linux 2018.03 | Java 8     | nginx 1.12.1 | Glassfish 5.0      | amazon/aws-eb-glassfish:5.0-al-onbuild-2.11.1 |
| **Go 1.4 (Docker) version 2.12.2**<br>_64bit Debian jessie v2.12.2 running Go 1.4 (Preconfigured<br>• Docker)_                      | 2018.03.0 | Docker 18.03.1-ce | Debian Jessie        | Go 1.4.2   | nginx 1.12.1 | none               | golang:1.4.2-onbuild                          |
| **Go 1.3 (Docker) version 2.12.2**<br>_64bit Debian jessie v2.12.2 running Go 1.3 (Preconfigured<br>• Docker)_                      | 2018.03.0 | Docker 18.03.1-ce | Debian Jessie        | Go 1.3.3   | nginx 1.12.1 | none               | golang:1.3.3-onbuild                          |
| **Python 3.4 with uWSGI 2 (Docker) version 2.12.2**<br>_64bit Debian jessie v2.12.2 running Python 3.4 (Preconfigured<br>• Docker)_ | 2018.03.0 | Docker 18.03.1-ce | Debian Jessie        | Python 3.4 | nginx 1.12.1 | uWSGI 2.0.8        | amazon/aws-eb-python:3.4.2-onbuild-3.5.1      |
