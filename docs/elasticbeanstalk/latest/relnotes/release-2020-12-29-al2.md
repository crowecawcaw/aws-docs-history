...
<a name="release-2020-12-29-al2"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux 2. The release includes security updates. It also includes Go, Corretto, .NET Core, Node.js, and Ruby updates.

**Release date:** December 29, 2020

## Changes
<a name="release-2020-12-29-al2.changes"></a>
...
<tbody>
  <tr><td><b>Security updates</b></td><td>Applied all security updates published in the <a href="https://alas.aws.amazon.com/alas2.html">Amazon Linux Security Center</a> on or before <b>December 8, 2020</b> to all Amazon Linux 2 platforms.<br />The <b>Node.js</b> release includes security fixes. For more information, see <b>Platform-specific updates</b> in this table.</td></tr>
...
<tbody>
  <tr><td><b>Go</b></td><td>Updated Go to release 1.15.6. For details, see <a href="https://golang.org/doc/devel/release.html#go1.15">go1.15</a> in <i>The Go Programming Language Release History</i>.</td></tr>
  <tr><td><b>Corretto</b></td><td>Updated Corretto 11 to version 11.0.9.12.1. For change log, see <a href="https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md">Change Log for Amazon Corretto 11</a>.</td></tr>
  <tr><td><b>.NET Core</b></td><td>Updated .NET Core 5.0 to version <a href="https://github.com/dotnet/core/tree/master/release-notes/5.0/5.0.1">5.0.1</a>.</td></tr>
  <tr><td><b>Node.js</b></td><td>Updated the Node.js platform to add support for Node versions <a href="https://nodejs.org/en/blog/release/v12.20.0/">12.20.0</a> and <a href="https://nodejs.org/en/blog/release/v12.19.1/">12.19.1</a>.<br /><b>Node v12.19.1</b> is a security release.</td></tr>
  <tr><td><b>Ruby</b></td><td>Updated RubyGems to release 3.2.0. For details, see <a href="https://blog.rubygems.org/2020/12/10/3.2.0-released.html">3.2.0 Released</a> on the <i>RubyGems blog</i>.<br />Updated Puma to version <a href="https://github.com/puma/puma/releases/tag/v5.1.1">5.1.1</a>.</td></tr>
</tbody>
</table>
</td></tr>
</tbody>
...
<a name="release-2020-12-29-al2.platforms"></a>
...
**Topics**
+ [Docker](#release-2020-12-29-al2.platforms.docker)
+ [Go](#release-2020-12-29-al2.platforms.go)
+ [Java SE](#release-2020-12-29-al2.platforms.javase)
+ [Tomcat](#release-2020-12-29-al2.platforms.java)
+ [.NET Core on Linux](#release-2020-12-29-al2.platforms.dotnetlinux)
+ [Node.js](#release-2020-12-29-al2.platforms.nodejs)
+ [PHP](#release-2020-12-29-al2.platforms.PHP)
+ [Python](#release-2020-12-29-al2.platforms.python)
+ [Ruby](#release-2020-12-29-al2.platforms.ruby)

### Docker
<a name="release-2020-12-29-al2.platforms.docker"></a>
...
### Go
<a name="release-2020-12-29-al2.platforms.go"></a>
...
### Java SE
<a name="release-2020-12-29-al2.platforms.javase"></a>
...
### Tomcat
<a name="release-2020-12-29-al2.platforms.java"></a>
...
### .NET Core on Linux
<a name="release-2020-12-29-al2.platforms.dotnetlinux"></a>
...
### Node.js
<a name="release-2020-12-29-al2.platforms.nodejs"></a>
...
### PHP
<a name="release-2020-12-29-al2.platforms.PHP"></a>
...
### Python
<a name="release-2020-12-29-al2.platforms.python"></a>
...
### Ruby
<a name="release-2020-12-29-al2.platforms.ruby"></a>
