...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | --------------- | ---- | ------- | ------- | ---- | --------------- | ------------------------------------------------------------------------------------ | ---- | ----------- | --------------------------------- | ---- | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------- | ---- | ------------ | ----------------------------------------------------------------------------------------------------------------------- | ---- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2023.html "https://alas.aws.amazon.com/alas2023.html") on or before<br>\*_October 27, 2025_<br>• to all AL2023 platforms.<br>Applied security updates to the Docker and ECS-based platform branches. The security updates address<br>[CVE-2025-31133, CVE-2025-52565, and CVE-2025-52881](https://aws.amazon.com/security/security-bulletins/AWS-2025-024/ "https://aws.amazon.com/security/security-bulletins/AWS-2025-024/"). |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | \*_Component_<br>• | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•    | Updated the base AMI to version 2023.9.20251027.                                     |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | \*_Platform_<br>•  | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_Docker_<br>• | **ECS Docker platform branch**<br>• Updated Amazon ECS Agent to version **1.100.0**. | <br> | \*_Go_<br>• | Updated Go to release **1.24.8**. | <br> | \*_Corretto and Tomcat_<br>• | **Language runtime updates**<br>• Updated Corretto 25 to version [25.0.1.8.1](https://github.com/corretto/corretto-25/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-25/blob/develop/CHANGELOG.md").<br>• Updated Corretto 21 to version [21.0.9.10.1](https://github.com/corretto/corretto-21/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-21/blob/develop/CHANGELOG.md").<br>• Updated Corretto 17 to version [17.0.17.10.1](https://github.com/corretto/corretto-17/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-17/blob/develop/CHANGELOG.md").<br>• Updated Corretto 11 to version [11.0.29.7.1](https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md").<br>• Updated Corretto 8 to version [8.472.08.1](https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md").<br>**Corretto 17, 21, and 25 platform branches**<br>• Updated Gradle to version 9.2.0. | <br> | \*_Node.js_<br>• | Updated Node.js 22 to version [22.21.1](https://nodejs.org/en/blog/release/v22.21.1 "https://nodejs.org/en/blog/release/v22.21.1"). | <br> | \*_PHP_<br>• | Updated PHP 8.4 to version [8.4.14](https://www.php.net/releases/8_4_14.php "https://www.php.net/releases/8_4_14.php"). | <br> | \*_Python_<br>• | • Updated Python 3.11 to version [3.11.14](https://www.python.org/downloads/release/python-31114/ "https://www.python.org/downloads/release/python-31114/").<br>• Updated Python 3.9 to version [3.9.24](https://www.python.org/downloads/release/python-3924/ "https://www.python.org/downloads/release/python-3924/"). |     |
...
- [Docker](#release-2025-11-05-al2023.platforms.docker "#release-2025-11-05-al2023.platforms.docker")
- [Go](#release-2025-11-05-al2023.platforms.go "#release-2025-11-05-al2023.platforms.go")
- [Java SE](#release-2025-11-05-al2023.platforms.javase "#release-2025-11-05-al2023.platforms.javase")
- [Tomcat](#release-2025-11-05-al2023.platforms.java "#release-2025-11-05-al2023.platforms.java")
- [.NET Core on Linux](#release-2025-11-05-al2023.platforms.dotnetlinux "#release-2025-11-05-al2023.platforms.dotnetlinux")
- [Node.js](#release-2025-11-05-al2023.platforms.nodejs "#release-2025-11-05-al2023.platforms.nodejs")
- [PHP](#release-2025-11-05-al2023.platforms.PHP "#release-2025-11-05-al2023.platforms.PHP")
- [Python](#release-2025-11-05-al2023.platforms.python "#release-2025-11-05-al2023.platforms.python")
- [Ruby](#release-2025-11-05-al2023.platforms.ruby "#release-2025-11-05-al2023.platforms.ruby")
