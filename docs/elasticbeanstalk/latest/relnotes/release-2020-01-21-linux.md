...
<a name="release-2020-01-21-linux"></a>

This release provides new Linux-based platform versions for AWS Elastic Beanstalk. The release includes security updates. It also includes Multicontainer Docker, Go, Java SE, Java with Tomcat, and Node.js updates.

**Release date:** January 21, 2020

## Changes
<a name="release-2020-01-21-linux.changes"></a>
...
**Topics**
+ [Packer Builder](#release-2020-01-21-linux.platforms.packer)
+ [Single Container Docker](#release-2020-01-21-linux.platforms.docker)
+ [Multicontainer Docker](#release-2020-01-21-linux.platforms.mcdocker)
+ [Preconfigured Docker](#release-2020-01-21-linux.platforms.dockerpreconfig)
+ [Go](#release-2020-01-21-linux.platforms.go)
+ [Java SE](#release-2020-01-21-linux.platforms.javase)
+ [Java with Tomcat](#release-2020-01-21-linux.platforms.java)
+ [Node.js](#release-2020-01-21-linux.platforms.nodejs)
+ [PHP](#release-2020-01-21-linux.platforms.PHP)
+ [Python](#release-2020-01-21-linux.platforms.python)
+ [Ruby](#release-2020-01-21-linux.platforms.ruby)
...
| --- | --- | --- | --- | --- | 
|  ** PHP 7.3 version 2.9.2** <br /> * 64bit Amazon Linux 2018.03 v2.9.2 running PHP 7.3 *  | 2018.03.0 | PHP 7.3.11 | 1.9.0 | Apache 2.4.41 | 
|  ** PHP 7.2 version 2.9.2** <br /> * 64bit Amazon Linux 2018.03 v2.9.2 running PHP 7.2 *  | 2018.03.0 | PHP 7.2.24 | 1.9.0 | Apache 2.4.41 | 
