...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before *_April 20, 2022_<br>• to released Amazon Linux 2 platforms.<br>Some CVEs were missed from this release’s Ruby update. They were added in the next<br>[Ruby release of May 4, 2020](release-2022-05-04-ruby.md "release-2022-05-04-ruby.md").<br>For more information, see the Ruby platform in this table's **Platform-specific updates**.<br>Some of the platform updates are security releases. For<br>more information, see *_Platform-specific updates_<br>• in this<br>table. |
