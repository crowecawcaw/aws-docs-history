...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before *_September 4, 2020_<br>• to all Amazon Linux AMI platforms.<br>The **Apache**, **Go**, **PHP**, and *_Python_<br>• releases include security fixes. For more information, see *_Cross-platform updates_<br>• and<br>*_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                                                       | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Apache_<br>•                | Updated platforms supporting the Apache HTTP Server 2.4 to version 2.4.46. For details, see [Changes with Apache 2.4.x](https://downloads.apache.org/httpd/CHANGES_2.4 "https://downloads.apache.org/httpd/CHANGES_2.4") on the *Apache Software<br>Foundation<br>• website.<br>The *_Apache 2.4.46_<br>• release includes security fixes. |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                                                    | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Multicontainer Docker_<br>• | Updated the ECS agent to version 1.44.3.                                                                                                                                                                                                                                                                                                   | <br> | *_Go_<br>• | Updated Go to release 1.15.1. For details, see [go1.15](https://golang.org/doc/devel/release.html#go1.15 "https://golang.org/doc/devel/release.html#go1.15") in<br>_The Go Programming Language Release History_.<br>The *_Go 1.15.1_<br>• release includes security fixes. | <br> | *_PHP_<br>• | Updated PHP 7.3 and 7.2 to releases<br>[7.3.21](https://www.php.net/releases/7_3_21.php "https://www.php.net/releases/7_3_21.php") and<br>[7.2.33](https://www.php.net/releases/7_2_33.php "https://www.php.net/releases/7_2_33.php"), respectively.<br>These versions include security fixes. | <br> | *_Python_<br>• | Updated Python 3.6 to [Python<br>3.6.12](https://docs.python.org/3.6/whatsnew/changelog.html#python-3-6-12-final "https://docs.python.org/3.6/whatsnew/changelog.html#python-3-6-12-final").<br>The *_Python 3.6.12_<br>• release includes security fixes. |     |
...
- [Docker](#release-2020-09-10-linux.platforms.docker "#release-2020-09-10-linux.platforms.docker")
- [Multicontainer Docker](#release-2020-09-10-linux.platforms.mcdocker "#release-2020-09-10-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2020-09-10-linux.platforms.dockerpreconfig "#release-2020-09-10-linux.platforms.dockerpreconfig")
- [Go](#release-2020-09-10-linux.platforms.go "#release-2020-09-10-linux.platforms.go")
- [Java SE](#release-2020-09-10-linux.platforms.javase "#release-2020-09-10-linux.platforms.javase")
- [Tomcat](#release-2020-09-10-linux.platforms.java "#release-2020-09-10-linux.platforms.java")
- [Node.js](#release-2020-09-10-linux.platforms.nodejs "#release-2020-09-10-linux.platforms.nodejs")
- [PHP](#release-2020-09-10-linux.platforms.PHP "#release-2020-09-10-linux.platforms.PHP")
- [Python](#release-2020-09-10-linux.platforms.python "#release-2020-09-10-linux.platforms.python")
- [Ruby](#release-2020-09-10-linux.platforms.ruby "#release-2020-09-10-linux.platforms.ruby")
...
| ---------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------- | -------------------- | -------- | ------------ | ------------------ | --------------------------------------------- |
| **Glassfish 5.0 (Docker) version 2.15.4**<br>_64bit Amazon Linux v2.15.4 running GlassFish 5.0 Java 8 (Preconfigured<br>• Docker)_ | 2018.03.0 | Docker 19.03.6-ce | Amazon Linux 2018.03 | Java 8   | nginx 1.16.1 | Glassfish 5.0      | amazon/aws-eb-glassfish:5.0-al-onbuild-2.11.1 |

### Go

| Platform Version and _Solution Stack Name_                                           | AMI          | Language  | AWS X‑Ray | Proxy Server |
| ------------------------------------------------------------------------------------ | ------------ | --------- | --------- | ------------ |
| **Go 1 AL2 version 3.1.2**<br>_64bit Amazon Linux 2 v3.1.2 running Go 1_             | 2.0.20200827 | Go 1.15.1 | 3.2.0     | nginx 1.18.0 |
...
| ----------------------------------------------------------------------------------------------------------------- | ------------ | -------------------- | --------- | ------------------ | ---------------------------------------------------- |
| **Corretto 11 with Tomcat 8.5 AL2 version 4.1.1**<br>_64bit Amazon Linux 2 v4.1.1 running Tomcat 8.5 Corretto 11_ | 2.0.20200827 | Corretto 11.0.8.10.1 | 3.2.0     | Tomcat 8.5.56      | nginx 1.18.0 (default), Apache 2.4.43                |
...
| ---------------------------------------------------------------------------------------- | ------------ | ------------- | ---------------- | ----------------- | ----------- | --------- | ------------------------------------- |
| **Python 3.7 AL2 version 3.1.1**<br>_64bit Amazon Linux 2 v3.1.1 running Python 3.7_     | 2.0.20200827 | Python 3.7.8  | pipenv 2020.8.13 |                   |             | 3.2.0     | nginx 1.18.0 (default), Apache 2.4.43 |
| **Python 3.6 version 2.9.14**<br>_64bit Amazon Linux 2018.03 v2.9.14 running Python 3.6_ | 2018.03.0    | Python 3.6.12 | pip 9.0.3        | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0     | Apache 2.4.46 with mod\_wsgi 3.5      |
