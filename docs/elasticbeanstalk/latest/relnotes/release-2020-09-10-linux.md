...
<a name="release-2020-09-10-linux"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux AMI. The release includes security updates. It also includes Apache, Multicontainer Docker, Go, PHP, and Python updates.

**Release date:** September 10, 2020

## Changes
<a name="release-2020-09-10-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2020-09-10-linux.platforms.docker)
+ [Multicontainer Docker](#release-2020-09-10-linux.platforms.mcdocker)
+ [Preconfigured Docker](#release-2020-09-10-linux.platforms.dockerpreconfig)
+ [Go](#release-2020-09-10-linux.platforms.go)
+ [Java SE](#release-2020-09-10-linux.platforms.javase)
+ [Tomcat](#release-2020-09-10-linux.platforms.java)
+ [Node.js](#release-2020-09-10-linux.platforms.nodejs)
+ [PHP](#release-2020-09-10-linux.platforms.PHP)
+ [Python](#release-2020-09-10-linux.platforms.python)
+ [Ruby](#release-2020-09-10-linux.platforms.ruby)
...
|  ** Java 8 with Tomcat 8.5 version 3.3.10** <br /> * 64bit Amazon Linux 2018.03 v3.3.10 running Tomcat 8.5 Java 8 *  | 2018.03.0 | Java 1.8.0\_252 | 3.1.0 | Tomcat 8.5.57 | Apache 2.4.46 (default), Apache 2.2.34, Nginx 1.16.1 | 
|  ** Java 7 with Tomcat 7 version 3.3.10** <br /> * 64bit Amazon Linux 2018.03 v3.3.10 running Tomcat 7 Java 7 *  | 2018.03.0 | Java 1.7.0\_261 | 3.1.0 | Tomcat 7.0.104 | Apache 2.4.46 (default), Apache 2.2.34, Nginx 1.16.1 | 
...
|  ** PHP 7.3 version 2.9.10** <br /> * 64bit Amazon Linux 2018.03 v2.9.10 running PHP 7.3 *  | 2018.03.0 | PHP 7.3.21 | 1.9.0 | Apache 2.4.46 | 
|  ** PHP 7.2 version 2.9.10** <br /> * 64bit Amazon Linux 2018.03 v2.9.10 running PHP 7.2 *  | 2018.03.0 | PHP 7.2.33 | 1.9.0 | Apache 2.4.46 | 
...
|  ** Python 3.6 version 2.9.14** <br /> * 64bit Amazon Linux 2018.03 v2.9.14 running Python 3.6 *  | 2018.03.0 | Python 3.6.12 | pip 9.0.3 | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0 | Apache 2.4.46 with mod\_wsgi 3.5 | 
