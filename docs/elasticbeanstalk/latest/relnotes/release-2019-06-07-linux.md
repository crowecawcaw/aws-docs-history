...
<a name="release-2019-06-07-linux"></a>

This release provides new Linux-based platform versions for AWS Elastic Beanstalk. The release includes security updates. It also includes Multicontainer Docker, Go, Java with Tomcat, and Node.js updates.

**Release date:** June 7, 2019

## Changes
<a name="release-2019-06-07-linux.changes"></a>

**Note**  
Due to a bug in this platform update, the new instance type **T3a** appears to be available in certain AWS Regions, but when you try to launch it, you'll see the following error.  
...
**Topics**
+ [Packer Builder](#release-2019-06-07-linux.platforms.packer)
+ [Single Container Docker](#release-2019-06-07-linux.platforms.docker)
+ [Multicontainer Docker](#release-2019-06-07-linux.platforms.mcdocker)
+ [Preconfigured Docker](#release-2019-06-07-linux.platforms.dockerpreconfig)
+ [Go](#release-2019-06-07-linux.platforms.go)
+ [Java SE](#release-2019-06-07-linux.platforms.javase)
+ [Java with Tomcat](#release-2019-06-07-linux.platforms.java)
+ [Node.js](#release-2019-06-07-linux.platforms.nodejs)
+ [PHP](#release-2019-06-07-linux.platforms.PHP)
+ [Python](#release-2019-06-07-linux.platforms.python)
+ [Ruby](#release-2019-06-07-linux.platforms.ruby)

### Packer Builder
<a name="release-2019-06-07-linux.platforms.packer"></a>



|  Platform Version and *Solution Stack Name*   |  AMI  |  Packer Version  | 
| --- | --- | --- | 
|  **Elastic Beanstalk Packer Builder version 2.6.10** <br /> * 64bit Amazon Linux 2018.03 v2.6.10 running Packer 1.0.3 *  | 2018.03.0 | 1.0.3 | 

### Single Container Docker
<a name="release-2019-06-07-linux.platforms.docker"></a>
...
<a name="release-2019-06-07-linux.platforms.mcdocker"></a>
...
<a name="release-2019-06-07-linux.platforms.dockerpreconfig"></a>
...
### Go
<a name="release-2019-06-07-linux.platforms.go"></a>
...
### Java SE
<a name="release-2019-06-07-linux.platforms.javase"></a>
...
### Java with Tomcat
<a name="release-2019-06-07-linux.platforms.java"></a>
...
### Node.js
<a name="release-2019-06-07-linux.platforms.nodejs"></a>
...
### PHP
<a name="release-2019-06-07-linux.platforms.PHP"></a>
...
### Python
<a name="release-2019-06-07-linux.platforms.python"></a>
...
### Ruby
<a name="release-2019-06-07-linux.platforms.ruby"></a>
