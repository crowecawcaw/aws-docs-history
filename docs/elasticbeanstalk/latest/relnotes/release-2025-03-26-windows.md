...
| **Framework updates**        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | *_Framework_<br>• | *_Details_<br>• | <br> | --<br>• | --<br>• | <br> | **\*\*New!\*\<br>• — Elastic Beanstalk supports configuration of environment variables to store secret and parameter<br>data.*<br>• | Starting with this release Elastic Beanstalk supports the option to reference AWS Secrets Manager secrets and Systems Manager Parameter Store parameters with<br>environment variables.<br>To learn more about this feature, see [Using<br>Elastic Beanstalk with Secrets Manager and Systems Manager Parameter Store](../dg/AWSHowTo.secrets.md "../dg/AWSHowTo.secrets.md"). | <br> | *_.NET Core_<br>•        | Updated .NET 8 to version 8.0.14.      |      |
