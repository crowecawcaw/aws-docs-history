...
<a name="release-2022-12-06-linux"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux 2. The release includes security updates. It also includes AMI, ECS based Docker, Go, .NET Core, Node.js, PHP, Python, and Ruby updates. 

**Release date:** December 6, 2022

## Changes
<a name="release-2022-12-06-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2022-12-06-linux.platforms.docker)
+ [Go](#release-2022-12-06-linux.platforms.go)
+ [Java SE](#release-2022-12-06-linux.platforms.javase)
+ [Tomcat](#release-2022-12-06-linux.platforms.java)
+ [.NET Core on Linux](#release-2022-12-06-linux.platforms.dotnetlinux)
+ [Node.js](#release-2022-12-06-linux.platforms.nodejs)
+ [PHP](#release-2022-12-06-linux.platforms.PHP)
+ [Python](#release-2022-12-06-linux.platforms.python)
+ [Ruby](#release-2022-12-06-linux.platforms.ruby)

### Docker
<a name="release-2022-12-06-linux.platforms.docker"></a>
...
### Go
<a name="release-2022-12-06-linux.platforms.go"></a>
...
### Java SE
<a name="release-2022-12-06-linux.platforms.javase"></a>
...
### Tomcat
<a name="release-2022-12-06-linux.platforms.java"></a>



|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  AWS X-Ray  |  Application Server  |  Proxy Server  | 
| --- | --- | --- | --- | --- | --- | 
|  ** Corretto 11 with Tomcat 8.5 AL2 version 4.3.2** <br /> * 64bit Amazon Linux 2 v4.3.2 running Tomcat 8.5 Corretto 11 *  | 2.0.20221103 | Corretto 11.0.17.8.1 | 3.2.0 | Tomcat 8.5.79 | nginx 1.22.0 (default), Apache 2.4.54 | 
|  ** Corretto 8 with Tomcat 8.5 AL2 version 4.3.2** <br /> * 64bit Amazon Linux 2 v4.3.2 running Tomcat 8.5 Corretto 8 *  | 2.0.20221103 | Corretto 8.352.08.1 | 3.2.0 | Tomcat 8.5.79 | nginx 1.22.0 (default), Apache 2.4.54 | 

### .NET Core on Linux
<a name="release-2022-12-06-linux.platforms.dotnetlinux"></a>
...
### Node.js
<a name="release-2022-12-06-linux.platforms.nodejs"></a>
...
|  ** Node.js 14 AL2 version 5.6.2** <br /> * 64bit Amazon Linux 2 v5.6.2 running Node.js 14 *  | 2.0.20221103 | 14.21.1 (6.14.17), 14.21.0 (6.14.17), 14.20.1 (6.14.17), 14.20.0 (6.14.17), 14.19.3 (6.14.17), 14.19.2 (6.14.17), 14.19.1 (6.14.16), 14.19.0 (6.14.16), 14.18.3 (6.14.15), 14.18.2 (6.14.15), 14.18.1 (6.14.15), 14.18.0 (6.14.15), 14.17.6 (6.14.15), 14.17.5 (6.14.14), 14.17.4 (6.14.14), 14.17.3 (6.14.13), 14.17.2 (6.14.13), 14.17.1 (6.14.13), 14.17.0 (6.14.13), 14.16.1 (6.14.12), 14.16.0 (6.14.11), 14.15.5 (6.14.11), 14.15.4 (6.14.10), 14.15.3 (6.14.9), 14.15.2 (6.14.9), 14.15.1 (6.14.8), 14.15.0 (6.14.8), 14.14.0 (6.14.8), 14.13.1 (6.14.8), 14.13.0 (6.14.8), 14.12.0 (6.14.8), 14.11.0 (6.14.8), 14.10.1 (6.14.8), 14.10.0 (6.14.8), 14.9.0 (6.14.8), 14.8.0 (6.14.7), 14.7.0 (6.14.7), 14.6.0 (6.14.6), 14.5.0 (6.14.5), 14.4.0 (6.14.5), 14.3.0 (6.14.5), 14.2.0 (6.14.4), 14.1.0 (6.14.4), 14.0.0 (6.14.4)<br /> Default version: 14.21.1 | nginx 1.22.0 (default), Apache 2.4.54 | 2.37.1 | 3.2.0 | 

### PHP
<a name="release-2022-12-06-linux.platforms.PHP"></a>



|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Composer  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** PHP 8.1 AL2 version 3.5.2** <br /> * 64bit Amazon Linux 2 v3.5.2 running PHP 8.1 *  | 2.0.20221103 | PHP 8.1.13 | 2.3.5 | nginx 1.22.0 (default), Apache 2.4.54 | 
|  ** PHP 8.0 AL2 version 3.5.2** <br /> * 64bit Amazon Linux 2 v3.5.2 running PHP 8.0 *  | 2.0.20221103 | PHP 8.0.25 | 2.0.13 | nginx 1.22.0 (default), Apache 2.4.54 | 

### Python
<a name="release-2022-12-06-linux.platforms.python"></a>



|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Package Manager  |  Packager  |  meld3  |  AWS X-Ray  |  Proxy Server  | 
| --- | --- | --- | --- | --- | --- | --- | --- | 
|  ** Python 3.8 AL2 version 3.4.2** <br /> * 64bit Amazon Linux 2 v3.4.2 running Python 3.8 *  | 2.0.20221103 | Python 3.8.15 | pipenv 2021.11.9 |  |  | 3.2.0 | nginx 1.22.0 (default), Apache 2.4.54 | 
|  ** Python 3.7 AL2 version 3.4.2** <br /> * 64bit Amazon Linux 2 v3.4.2 running Python 3.7 *  | 2.0.20221103 | Python 3.7.10 | pipenv 2021.11.9 |  |  | 3.2.0 | nginx 1.22.0 (default), Apache 2.4.54 | 

### Ruby
<a name="release-2022-12-06-linux.platforms.ruby"></a>
