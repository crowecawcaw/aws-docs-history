...
Today Elastic Beanstalk is announcing the retirement of the Node.js 12 and Ruby 2.6 platform branches based on Amazon Linux 2, due to end of support by the owners of their language runtime
components.
