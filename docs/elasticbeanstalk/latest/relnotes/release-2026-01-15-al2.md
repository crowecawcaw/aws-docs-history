...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before<br>*_January 5, 2026_<br>• to all Amazon Linux 2 platforms. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                 | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_AMI_<br>•    | Updated the base AMI to version 2.0.20260109.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | <br> | *_CloudWatch Agent_<br>• | Updated CloudWatch Agent to version [1.300062.1](https://github.com/aws/amazon-cloudwatch-agent/releases "https://github.com/aws/amazon-cloudwatch-agent/releases"). | <br> | *_Apache_<br>•    | Updated platforms supporting the Apache HTTP Server to version [2.4.66](https://downloads.apache.org/httpd/CHANGES_2.4.66 "https://downloads.apache.org/httpd/CHANGES_2.4.66").                   | <br> | *_Additional Changes_<br>• | This release enables extracting specific fields from JSON-formatted Secrets Manager secrets. See [Extracting JSON keys from Secrets Manager secrets](../dg/AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.json "../dg/AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.json") for more information. |     |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                              | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Docker_<br>• | **Docker platform branch**<br>• Updated Docker Engine to version [25.0.14](https://github.com/moby/moby/releases "https://github.com/moby/moby/releases").<br>• Updated Docker Compose to version [5.0.1](https://github.com/docker/compose/releases/ "https://github.com/docker/compose/releases/").<br>**ECS Docker platform branch**<br>• Updated Amazon ECS Agent to version [1.101.1](https://github.com/aws/amazon-ecs-agent/releases "https://github.com/aws/amazon-ecs-agent/releases").<br>• Updated Docker Engine to version [25.0.14](https://github.com/moby/moby/releases "https://github.com/moby/moby/releases"). | <br> | *_Corretto_<br>•         | **Tools Updates**<br>• Updated Maven to version [3.9.12](https://maven.apache.org/docs/history.html "https://maven.apache.org/docs/history.html").                   | <br> | *_.NET Core_<br>• | Updated .NET Core to release [8.0.23](https://github.com/dotnet/core/blob/main/release-notes/8.0/8.0.23/8.0.23.md "https://github.com/dotnet/core/blob/main/release-notes/8.0/8.0.23/8.0.23.md"). | <br> | *_PHP_<br>•                | Updated Composer to version [2.9.3](https://github.com/composer/composer/releases/tag/2.9.3 "https://github.com/composer/composer/releases/tag/2.9.3").                                                                                                                                         |     |
...
- [Docker](#release-2026-01-15-al2.platforms.docker "#release-2026-01-15-al2.platforms.docker")
- [Go](#release-2026-01-15-al2.platforms.go "#release-2026-01-15-al2.platforms.go")
- [Java SE](#release-2026-01-15-al2.platforms.javase "#release-2026-01-15-al2.platforms.javase")
- [Tomcat](#release-2026-01-15-al2.platforms.java "#release-2026-01-15-al2.platforms.java")
- [.NET Core on Linux](#release-2026-01-15-al2.platforms.dotnetlinux "#release-2026-01-15-al2.platforms.dotnetlinux")
- [Node.js](#release-2026-01-15-al2.platforms.nodejs "#release-2026-01-15-al2.platforms.nodejs")
- [PHP](#release-2026-01-15-al2.platforms.PHP "#release-2026-01-15-al2.platforms.PHP")
- [Python](#release-2026-01-15-al2.platforms.python "#release-2026-01-15-al2.platforms.python")
- [Ruby](#release-2026-01-15-al2.platforms.ruby "#release-2026-01-15-al2.platforms.ruby")
