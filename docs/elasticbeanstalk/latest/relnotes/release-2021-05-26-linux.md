# Release: Elastic Beanstalk Amazon Linux AMI platform updates on May 26, 2021
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------- | --------------- | ---- | ------- | ------- | ---- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before **May 19, 2021\*<br>• to all released Amazon Linux AMI platforms.<br>In particular, the release addresses [CVE-2021-30465](https://access.redhat.com/security/cve/CVE-2021-30465 "https://access.redhat.com/security/cve/CVE-2021-30465"), which has a<br>severity rating of **Important Impact**.<br>The **Go*<br>• release is a security release. For more information, see \*\*Platform-specific<br>updates*<br>• in this table. |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | \*_Platform_<br>• | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_Go_<br>• | Updated Go to release **1.16.4**. For details, see [go1.16](https://golang.org/doc/devel/release.html#go1.16 "https://golang.org/doc/devel/release.html#go1.16") in _The Go Programming Language Release<br>History_.<br>The Go 1.16.4 release is a security release. |     |
...
- [Docker](#release-2021-05-26-linux.platforms.docker "#release-2021-05-26-linux.platforms.docker")
- [Multicontainer Docker](#release-2021-05-26-linux.platforms.mcdocker "#release-2021-05-26-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2021-05-26-linux.platforms.dockerpreconfig "#release-2021-05-26-linux.platforms.dockerpreconfig")
- [Go](#release-2021-05-26-linux.platforms.go "#release-2021-05-26-linux.platforms.go")
- [Java SE](#release-2021-05-26-linux.platforms.javase "#release-2021-05-26-linux.platforms.javase")
- [Tomcat](#release-2021-05-26-linux.platforms.java "#release-2021-05-26-linux.platforms.java")
- [Node.js](#release-2021-05-26-linux.platforms.nodejs "#release-2021-05-26-linux.platforms.nodejs")
- [PHP](#release-2021-05-26-linux.platforms.PHP "#release-2021-05-26-linux.platforms.PHP")
- [Python](#release-2021-05-26-linux.platforms.python "#release-2021-05-26-linux.platforms.python")
- [Ruby](#release-2021-05-26-linux.platforms.ruby "#release-2021-05-26-linux.platforms.ruby")
