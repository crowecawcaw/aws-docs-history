...
It also includes nginx, Go, Java SE, Tomcat, and Node.js updates.
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before *_September 29, 2020_<br>• to all Amazon Linux AMI platforms. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                               | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_nginx_<br>• | Updated platforms supporting the nginx server to [version 1.18.0](https://nginx.org/en/CHANGES-1.18 "https://nginx.org/en/CHANGES-1.18").                                                                         |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                            | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Go_<br>•    | Updated Go to release 1.15.2. For details, see [go1.15](https://golang.org/doc/devel/release.html#go1.15 "https://golang.org/doc/devel/release.html#go1.15") in<br>_The Go Programming Language Release History_. | <br> | **Java SE**, *_Tomcat_<br>• | Updated Java 8 to OpenJDK Version 1.8.0\_265.b01. | <br> | *_Node.js_<br>• | Updated the Node.js platform to add support for Node versions<br>[12.18.4](https://nodejs.org/en/blog/release/v12.18.4/ "https://nodejs.org/en/blog/release/v12.18.4/") and<br>[10.22.1](https://nodejs.org/en/blog/release/v10.22.1/ "https://nodejs.org/en/blog/release/v10.22.1/"). |     |
...
- [Docker](#release-2020-10-07-linux.platforms.docker "#release-2020-10-07-linux.platforms.docker")
- [Multicontainer Docker](#release-2020-10-07-linux.platforms.mcdocker "#release-2020-10-07-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2020-10-07-linux.platforms.dockerpreconfig "#release-2020-10-07-linux.platforms.dockerpreconfig")
- [Go](#release-2020-10-07-linux.platforms.go "#release-2020-10-07-linux.platforms.go")
- [Java SE](#release-2020-10-07-linux.platforms.javase "#release-2020-10-07-linux.platforms.javase")
- [Tomcat](#release-2020-10-07-linux.platforms.java "#release-2020-10-07-linux.platforms.java")
- [Node.js](#release-2020-10-07-linux.platforms.nodejs "#release-2020-10-07-linux.platforms.nodejs")
- [PHP](#release-2020-10-07-linux.platforms.PHP "#release-2020-10-07-linux.platforms.PHP")
- [Python](#release-2020-10-07-linux.platforms.python "#release-2020-10-07-linux.platforms.python")
- [Ruby](#release-2020-10-07-linux.platforms.ruby "#release-2020-10-07-linux.platforms.ruby")
...
| ---------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------- | -------------------- | -------- | ------------ | ------------------ | --------------------------------------------- |
| **Glassfish 5.0 (Docker) version 2.16.0**<br>_64bit Amazon Linux v2.16.0 running GlassFish 5.0 Java 8 (Preconfigured<br>• Docker)_ | 2018.03.0 | Docker 19.03.6-ce | Amazon Linux 2018.03 | Java 8   | nginx 1.18.0 | Glassfish 5.0      | amazon/aws-eb-glassfish:5.0-al-onbuild-2.11.1 |
...
| **Python 3.6 version 2.9.15**<br>_64bit Amazon Linux 2018.03 v2.9.15 running Python 3.6_ | 2018.03.0    | Python 3.6.12 | pip 9.0.3        | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0     | Apache 2.4.46 with mod\_wsgi 3.5      |
