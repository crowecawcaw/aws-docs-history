...
| **Framework updates**                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | \*_Framework_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_.NET Core_<br>• | Updated .NET 9 to version 9.0.10.<br>Updated .NET 8 to version 8.0.21 |      |
| **AWS component updates**                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | \*_Component_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•       | Updated the base AMI to version 2025.10.15.                           | <br> | \*_AWS SDK for .NET_<br>• | Updated the SDK to version 3.7.1144.0. | <br> | \*_CloudWatch Agent_<br>• | Updated the CloudWatch Agent to version 1.300060.0b1248. | <br> | \*_SSM Agent_<br>• | Updated the SSM Agent to version 3.3.3270.0. | <br> | \*_AWS X-Ray_<br>• | Updated the X-Ray daemon to version 3.6.1. |     |
| **Additional changes with this<br>release** | • Updated WebDeploy to version 4.0.<br>• This release includes a change that prevents instance hostnames from being reset to the default hostname during reboots when manually updated.                                                                                                                                                                                                                                                                                      |

## New platform versions

###### These platforms are updated:

- [.NET on Windows Server](#release-2025-10-23-windows.platforms.net "#release-2025-10-23-windows.platforms.net")
