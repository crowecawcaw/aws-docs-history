...
| **Additional changes with this release** | \*\*\*\*New!\*\*\*<br>• — The Windows platforms now natively support retrieving bundled instance logs through the Elastic Beanstalk Console and AWS CLI.<br>Platform deployment scripts now check that your [Elastic Beanstalk Amazon S3 bucket](../dg/AWSHowTo.md "../dg/AWSHowTo.md") is owned by the account running the environment before continuing deployment.                                                                                                         |
