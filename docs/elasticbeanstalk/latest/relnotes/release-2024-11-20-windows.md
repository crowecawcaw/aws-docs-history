...
updates framework and AWS components, and introduces native support for retrieving bundled instance logs.
...
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ---------------- | ---- | ------- | ------- | ---- | ------------------ | ---------------------------------------------------------------------- | ---- | ------------------------- | ------------------------------------- | ---- | ------------------------- | ------------------------------------------------------- | ---- | ------------------ | -------------------------------------------- | --- |
| **Windows security updates**             | Applied November 2024 security updates for Windows.<br>This release includes updates from the monthly Microsoft \*Patch Tuesday<br>• Windows release. Windows security updates in<br>this release are current up to the second Tuesday of the month.<br>For more details and a list of security updates, see the Microsoft [Security<br>Update Guide](https://portal.msrc.microsoft.com/en-us/security-guidance "https://portal.msrc.microsoft.com/en-us/security-guidance"). |
| **Framework updates**                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | \*_Framework_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_.NET Core_<br>• | Updated .NET 6 to version 6.0.36.<br>Updated .NET 8 to version 8.0.11. |      |
| **AWS component updates**                |                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | \*_Component_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•       | Updated the base AMI to version 2024.11.13.                            | <br> | \*_AWS SDK for .NET_<br>• | Updated the SDK to version 3.7.925.0. | <br> | \*_CloudWatch Agent_<br>• | Updated the CloudWatch Agent to version 1.300048.1b904. | <br> | \*_SSM Agent_<br>• | Updated the SSM Agent to version 3.3.1230.0. |     |
| **Additional changes with this release** | \*\*\*\*New!\*\*\*<br>• — The Windows platforms now natively support retrieving bundled instance logs through the Elastic Beanstalk Console and AWS CLI.<br>Platform deployment scripts now check that your [Elastic Beanstalk Amazon S3 bucket](../dg/AWSHowTo.S3.md "../dg/AWSHowTo.S3.md") is owned by the account running the environment before continuing deployment.                                                                                                   |
