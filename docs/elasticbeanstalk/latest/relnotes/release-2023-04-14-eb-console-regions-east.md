...
<a name="release-2023-04-14-eb-console-regions-east"></a>

AWS Elastic Beanstalk launches new console design in AWS Regions: Africa (Cape Town), Asia Pacific (Hong Kong), Asia Pacific (Jakarta), Europe (Milan), and Middle East (Bahrain).

**Release date:** April 14, 2023

## Changes
<a name="release-2023-04-14-eb-console-regions-east.changes"></a>
...
To try out our new console experience in the regions where it's available open the [Elastic Beanstalk console](https://console.aws.amazon.com/elasticbeanstalk). In the **Regions** list, select one of the regions listed on this page.
