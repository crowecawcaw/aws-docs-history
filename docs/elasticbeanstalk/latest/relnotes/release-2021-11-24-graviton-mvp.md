...
for your environment](../dg/using-features.managing.ec2.md#using-features.managing.ec2.console "../dg/using-features.managing.ec2.md#using-features.managing.ec2.console") in the _AWS Elastic Beanstalk Developer Guide_.
