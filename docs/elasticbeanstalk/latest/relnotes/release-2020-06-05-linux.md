...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before *_June 3, 2020_<br>• to all Amazon Linux AMI platforms.<br>The *_Apache_<br>• and *_PHP_<br>• releases include security fixes. For more information,<br>see *_Cross-platform updates_<br>• and *_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                                 | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Apache_<br>• | Updated platforms supporting the Apache HTTP Server 2.4 to version 2.4.43. For details, see [Changes with Apache 2.4.x](https://downloads.apache.org/httpd/CHANGES_2.4 "https://downloads.apache.org/httpd/CHANGES_2.4") on the *Apache Software<br>Foundation<br>• website. |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                              | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Go_<br>•     | Updated Go to release 1.14.3. For details, see [go1.14](https://golang.org/doc/devel/release.html#go1.14 "https://golang.org/doc/devel/release.html#go1.14") in<br>_The Go Programming Language Release History_.                                                            | <br> | **Java SE**, *_Tomcat_<br>• | Updated Java 8 to OpenJDK Version 1.8.0.252.b09.<br>Updated Java 7 to OpenJDK Version 1.7.0.261. | <br> | *_PHP_<br>• | Updated PHP 7.3 and 7.2 to releases<br>[7.3.17](https://www.php.net/releases/7_3_17.php "https://www.php.net/releases/7_3_17.php") and<br>[7.2.30](https://www.php.net/releases/7_2_30.php "https://www.php.net/releases/7_2_30.php"), respectively.<br>These versions include security fixes. | <br> | *_Python_<br>• | Updated Python 2.7 to version 2.7.18. For details, see [What’s New in<br>Python 2.7](https://docs.python.org/2.7/whatsnew/2.7.html "https://docs.python.org/2.7/whatsnew/2.7.html"). |     |
...
- [Single Container Docker](#release-2020-06-05-linux.platforms.docker "#release-2020-06-05-linux.platforms.docker")
- [Multicontainer Docker](#release-2020-06-05-linux.platforms.mcdocker "#release-2020-06-05-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2020-06-05-linux.platforms.dockerpreconfig "#release-2020-06-05-linux.platforms.dockerpreconfig")
- [Go](#release-2020-06-05-linux.platforms.go "#release-2020-06-05-linux.platforms.go")
- [Java SE](#release-2020-06-05-linux.platforms.javase "#release-2020-06-05-linux.platforms.javase")
- [Tomcat](#release-2020-06-05-linux.platforms.java "#release-2020-06-05-linux.platforms.java")
- [Node.js](#release-2020-06-05-linux.platforms.nodejs "#release-2020-06-05-linux.platforms.nodejs")
- [PHP](#release-2020-06-05-linux.platforms.PHP "#release-2020-06-05-linux.platforms.PHP")
- [Python](#release-2020-06-05-linux.platforms.python "#release-2020-06-05-linux.platforms.python")
- [Ruby](#release-2020-06-05-linux.platforms.ruby "#release-2020-06-05-linux.platforms.ruby")
...
| ---------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------- | -------------------- | -------- | ------------ | ------------------ | --------------------------------------------- |
| **Glassfish 5.0 (Docker) version 2.15.1**<br>_64bit Amazon Linux v2.15.1 running GlassFish 5.0 Java 8 (Preconfigured<br>• Docker)_ | 2018.03.0 | Docker 19.03.6-ce | Amazon Linux 2018.03 | Java 8   | nginx 1.16.1 | Glassfish 5.0      | amazon/aws-eb-glassfish:5.0-al-onbuild-2.11.1 |
...
| ----------------------------------------------------------------------------------------------------------------- | ------------ | -------------------- | --------- | ------------------ | ---------------------------------------------------- |
| **Corretto 11 with Tomcat 8.5 AL2 version 4.0.0**<br>_64bit Amazon Linux 2 v4.0.0 running Tomcat 8.5 Corretto 11_ | 2.0.20200520 | Corretto 11.0.7.10.1 | 3.2.0     | Tomcat 8.5.51      | nginx 1.16.1                                         |
...
| ---------------------------------------------------------------------------------------- | ------------ | ------------- | ----------------- | ----------------- | ----------- | --------- | -------------------------------- |
| **Python 3.7 AL2 version 3.0.2**<br>_64bit Amazon Linux 2 v3.0.2 running Python 3.7_     | 2.0.20200520 | Python 3.7.6  | pipenv 2018.11.26 |                   |             | 3.2.0     | nginx 1.16.1                     |
| **Python 3.6 version 2.9.11**<br>_64bit Amazon Linux 2018.03 v2.9.11 running Python 3.6_ | 2018.03.0    | Python 3.6.10 | pip 9.0.3         | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0     | Apache 2.4.43 with mod\_wsgi 3.5 |
