...
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                | \*_Component_<br>• | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•    | Updated the base AMI to version 2023.10.20260105.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | <br> | \*_Apache_<br>• | Updated Apache HTTP Server to version [2.4.66](https://downloads.apache.org/httpd/CHANGES_2.4.66 "https://downloads.apache.org/httpd/CHANGES_2.4.66"). | <br> | \*_CloudWatch Agent_<br>• | Updated CloudWatch Agent to version [1.300062.1](https://github.com/aws/amazon-cloudwatch-agent/releases "https://github.com/aws/amazon-cloudwatch-agent/releases"). | <br> | \*_Additional Changes_<br>• | This release enables extracting specific fields from JSON-formatted Secrets Manager secrets. See [Extracting JSON keys from Secrets Manager secrets](../dg/AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.json "../dg/AWSHowTo.secrets.env-vars.md#AWSHowTo.secrets.json") for more information.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |      |
