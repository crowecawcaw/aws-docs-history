...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before<br>*_January 26, 2021_<br>• to all Amazon Linux 2 platforms.<br>Many of the platform updates are security releases.<br>For more information, see *_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                       | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_AMI_<br>•    | Updated the base AMI to version 2.0.20210126.                                                                                                          |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                    | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Docker_<br>• | Updated Docker Compose to version [1.28.2](https://docs.docker.com/compose/release-notes/#1282 "https://docs.docker.com/compose/release-notes/#1282"). | <br> | *_Go_<br>• | Updated Go to release 1.15.7. For details, see [go1.15](https://golang.org/doc/devel/release.html#go1.15 "https://golang.org/doc/devel/release.html#go1.15") in<br>_The Go Programming Language Release History_.<br>The *_Go 1.15.7_<br>• release is a security release. | <br> | **Corretto**, *_Tomcat_<br>• | Updated Corretto 11 to version 11.0.10.9.1. For change log, see [Change Log for Amazon Corretto 11](https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md").<br>Updated Tomcat 8.5 to [Tomcat<br>8.5.60](<https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.60_(markt)> "https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.60_(markt)").<br>The *_Corretto 11_<br>• and *_Tomcat 8.5_<br>• updates are security releases.<br>For Tomcat, see [CVE-2020-17527](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-17527 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-17527"). | <br> | *_.NET Core_<br>• | Updated .NET Core 5.0 to version [5.0.2](https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.2/5.0.2.md#notable-changes "https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.2/5.0.2.md#notable-changes").<br>Updated .NET Core 3.1 to version [3.1.11](https://github.com/dotnet/core/tree/master/release-notes/3.1/3.1.11/3.1.11.md#notable-changes "https://github.com/dotnet/core/tree/master/release-notes/3.1/3.1.11/3.1.11.md#notable-changes").<br>Updated .NET Core 2.1 to version [2.1.24](https://github.com/dotnet/core/tree/master/release-notes/2.1/2.1.24/2.1.24.md#notable-changes "https://github.com/dotnet/core/tree/master/release-notes/2.1/2.1.24/2.1.24.md#notable-changes").<br>All three updates are security releases. | <br> | *_Node.js_<br>• | Updated the Node.js platform to add support for Node versions<br>[12.20.1](https://nodejs.org/en/blog/release/v12.20.0/ "https://nodejs.org/en/blog/release/v12.20.0/"),<br>[10.23.2](https://nodejs.org/en/blog/release/v10.23.2/ "https://nodejs.org/en/blog/release/v10.23.2/"), and<br>[10.23.1](https://nodejs.org/en/blog/release/v10.23.1/ "https://nodejs.org/en/blog/release/v10.23.1/").<br>*_Node v12.19.1_<br>• and *_Node v10.23.1_<br>• area security releases. | <br> | *_Ruby_<br>• | Updated RubyGems to release 3.2.7. For details, see [3.2.7<br>Released](https://blog.rubygems.org/2021/01/27/3.2.7-released.html "https://blog.rubygems.org/2021/01/27/3.2.7-released.html") on the _RubyGems blog_.<br>Updated Puma to version [5.2.0](https://github.com/puma/puma/releases/tag/v5.2.0 "https://github.com/puma/puma/releases/tag/v5.2.0"). |     |
...
- [Docker](#release-2021-01-29-al2.platforms.docker "#release-2021-01-29-al2.platforms.docker")
- [Go](#release-2021-01-29-al2.platforms.go "#release-2021-01-29-al2.platforms.go")
- [Java SE](#release-2021-01-29-al2.platforms.javase "#release-2021-01-29-al2.platforms.javase")
- [Tomcat](#release-2021-01-29-al2.platforms.java "#release-2021-01-29-al2.platforms.java")
- [.NET Core on Linux](#release-2021-01-29-al2.platforms.dotnetlinux "#release-2021-01-29-al2.platforms.dotnetlinux")
- [Node.js](#release-2021-01-29-al2.platforms.nodejs "#release-2021-01-29-al2.platforms.nodejs")
- [PHP](#release-2021-01-29-al2.platforms.PHP "#release-2021-01-29-al2.platforms.PHP")
- [Python](#release-2021-01-29-al2.platforms.python "#release-2021-01-29-al2.platforms.python")
- [Ruby](#release-2021-01-29-al2.platforms.ruby "#release-2021-01-29-al2.platforms.ruby")
...
| ----------------------------------------------------------------------------------------------------------------- | ------------ | -------------------- | --------- | ------------------ | ------------------------------------- |
| **Corretto 11 with Tomcat 8.5 AL2 version 4.1.5**<br>_64bit Amazon Linux 2 v4.1.5 running Tomcat 8.5 Corretto 11_ | 2.0.20210126 | Corretto 11.0.10.9.1 | 3.2.0     | Tomcat 8.5.60      | nginx 1.18.0 (default), Apache 2.4.46 |
...
| ------------------------------------------------------------------------------------- | ------------------------------------------ | ------------ | ------------ | --------- |
| **.NET Core on AL2 version 2.1.2**<br>_64bit Amazon Linux 2 v2.1.2 running .NET Core_ | .NET 5.0.2, supports 5.0.2, 3.1.11, 2.1.24 | nginx 1.18.0 | 2.0.20210126 | 3.2.0     |
...
| ---------------------------------------------------------------------------------------- | ------------ | ------------- | ---------------- | ----------------- | ----------- | --------- | ------------------------------------- |
| **Python 3.7 AL2 version 3.1.5**<br>_64bit Amazon Linux 2 v3.1.5 running Python 3.7_     | 2.0.20210126 | Python 3.7.9  | pipenv 2020.8.13 |                   |             | 3.2.0     | nginx 1.18.0 (default), Apache 2.4.46 |
| **Python 3.6 version 2.9.18**<br>_64bit Amazon Linux 2018.03 v2.9.18 running Python 3.6_ | 2018.03.0    | Python 3.6.12 | pip 9.0.3        | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0     | Apache 2.4.46 with mod\_wsgi 3.5      |
