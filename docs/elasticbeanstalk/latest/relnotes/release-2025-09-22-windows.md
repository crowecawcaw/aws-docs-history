...
| **Framework updates**                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | \*_Framework_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_.NET Core_<br>• | Updated .NET 9 to version 9.0.9.<br>Updated .NET 8 to version 8.0.20. |      |
| **AWS component updates**                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | \*_Component_<br>• | \*_Details_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•       | Updated the base AMI to version 2025.09.10.                           | <br> | \*_AWS SDK for .NET_<br>• | Updated the SDK to version 3.7.1120.0. | <br> | \*_CloudWatch Agent_<br>• | Updated the CloudWatch Agent to version 1.300059.0b1207. | <br> | \*_SSM Agent_<br>• | Updated the SSM Agent to version 3.3.3050.0. | <br> | \*_AWS X-Ray_<br>• | Updated the X-Ray daemon to version 3.6.0. |     |
| **Additional changes with this<br>release** | • PowerShell 2.0 has been removed from Windows Server 2025 platforms in<br>accordance with Microsoft's deprecation of this legacy version. For more<br>information, see Microsoft's [support article](https://support.microsoft.com/en-us/topic/powershell-2-0-removal-from-windows-fe6d1edc-2ed2-4c33-b297-afe82a64200a "https://support.microsoft.com/en-us/topic/powershell-2-0-removal-from-windows-fe6d1edc-2ed2-4c33-b297-afe82a64200a").<br>• In this release, the host rename was moved prior to platform bootstrapping. |

## New platform versions

###### These platforms are updated:

- [.NET on Windows Server](#release-2025-09-22-windows.platforms.net "#release-2025-09-22-windows.platforms.net")
