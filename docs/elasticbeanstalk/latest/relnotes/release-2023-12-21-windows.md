...
| **Component**                | **Details**                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---                          | ---                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **AMI**                      | Updated the base AMI to version 2023.12.13.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **AWS SDK for .NET**         | Updated the SDK to version 3.7.707.0.                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **CloudWatch Agent**         | Updated the CloudWatch Agent to version 1.300032.0b330.                                                                                                                                                                                                                                                                                                                                                                                                      |
| **AWSPowershell**            | Updated AWSPowershell to version 4.1.468.                                                                                                                                                                                                                                                                                                                                                                                                                    |

| ## New platform versions ### .NET on Windows Server #### Configuration basics
| Platform Version | Solution Stack Name | Framework | Proxy Server |
| --- | --- | --- | --- |
| **Windows Server 2019 with IIS 10.0 version 2.13.1** | _64bit Windows Server 2019 v2.13.1 running IIS 10.0_ | .NET 8.0.0, supports 8.0.0, 6.0.25 .NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 |
| **Windows Server Core 2019 with IIS 10.0 version 2.13.1** | _64bit Windows Server Core 2019 v2.13.1 running IIS 10.0_ | .NET 8.0.0, supports 8.0.0, 6.0.25 .NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 |
| **Windows Server 2016 with IIS 10.0 version 2.13.1** | _64bit Windows Server 2016 v2.13.1 running IIS 10.0_ | .NET 8.0.0, supports 8.0.0, 6.0.25 .NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 |
| **Windows Server Core 2016 with IIS 10.0 version 2.13.1** | _64bit Windows Server Core 2016 v2.13.1 running IIS 10.0_ | .NET 8.0.0, supports 8.0.0, 6.0.25 .NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 | #### More details
