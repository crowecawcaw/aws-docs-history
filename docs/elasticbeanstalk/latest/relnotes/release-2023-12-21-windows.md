...
# Release: Elastic Beanstalk Windows Server platform update on December 21, 2023
<a name="release-2023-12-21-windows"></a>
...
## Changes
<a name="release-2023-12-21-windows.changes"></a>
...
<tbody>
  <tr><td><b>AMI</b></td><td>Updated the base AMI to version 2023.12.13.</td></tr>
  <tr><td><b>AWS SDK for .NET</b></td><td>Updated the SDK to version 3.7.707.0.</td></tr>
  <tr><td><b>CloudWatch Agent</b></td><td>Updated the CloudWatch Agent to version 1.300032.0b330.</td></tr>
  <tr><td><b>AWSPowershell</b></td><td>Updated AWSPowershell to version 4.1.468.</td></tr>
</tbody>
</table>
 </td></tr>
</tbody>
...
<a name="release-2023-12-21-windows.platforms"></a>

### .NET on Windows Server
<a name="release-2023-12-21-windows.platforms.net"></a>
...
|  ** Windows Server Core 2019 with IIS 10.0 version 2.13.1**  |  * 64bit Windows Server Core 2019 v2.13.1 running IIS 10.0 *  | .NET 8.0.0, supports 8.0.0, 6.0.25<br />.NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 | 
|  ** Windows Server 2016 with IIS 10.0 version 2.13.1**  |  * 64bit Windows Server 2016 v2.13.1 running IIS 10.0 *  | .NET 8.0.0, supports 8.0.0, 6.0.25<br />.NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 | 
|  ** Windows Server Core 2016 with IIS 10.0 version 2.13.1**  |  * 64bit Windows Server Core 2016 v2.13.1 running IIS 10.0 *  | .NET 8.0.0, supports 8.0.0, 6.0.25<br />.NET Framework 4.8, supports 4.x, 2.0, 1.x | IIS 10.0 | 
