...
| **Additional changes with this release** | [Elastic Beanstalk Amazon S3 bucket](../dg/AWSHowTo.md "../dg/AWSHowTo.md") ownership checks no longer require s3:GetBucketLocation IAM permissions.                                                                                                                                                                                                                                                                                                                          |
