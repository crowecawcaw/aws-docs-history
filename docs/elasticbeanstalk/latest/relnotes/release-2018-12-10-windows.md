...
# Release: AWS Elastic Beanstalk Windows Server platform update on December 10, 2018
<a name="release-2018-12-10-windows"></a>

This release applies Windows November 2018 security updates to the Windows Server platform for Elastic Beanstalk, and updates platform configurations. The release also adds Amazon EC2 instance types in certain AWS Regions.

**Release date:** December 10, 2018

## Changes
<a name="release-2018-12-10-windows.changes"></a>
...
<tbody>
  <tr><td><b>Windows security updates</b></td><td>Applied November 2018 security updates for Windows.<br />See Microsoft's <a href="https://portal.msrc.microsoft.com/en-us/">Security TechCenter</a> and <a href="https://technet.microsoft.com/en-us/library/security/">Security Advisories and Bulletins</a>.</td></tr>
...
<a name="release-2018-12-10-windows.platforms"></a>

### .NET on Windows Server with IIS
<a name="release-2018-12-10-windows.platforms.net"></a>
