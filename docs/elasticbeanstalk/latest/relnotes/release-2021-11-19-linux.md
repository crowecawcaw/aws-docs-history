...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before *_November 12, 2021_<br>• to all released Amazon Linux 2 platforms.<br>The **Go**, **Corretto**, and *_Node.js_<br>• releases<br>are security releases. For more information, see<br>*_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                                           | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_*\*\*New!\*\**<br>`pkg-repo` on-instance CLI_<br>• | This tool provides the capability to unlock and lock yum package repositories on EC2 instances running Amazon Linux 2. For more<br>information, see [pkg-repo](../dg/custom-platforms-scripts.md#custom-platforms-scripts.pkg-repo "../dg/custom-platforms-scripts.md#custom-platforms-scripts.pkg-repo") in the<br>_AWS Elastic Beanstalk Developer Guide_. | <br> | *_Base AMI_<br>•             | Updated the base AMI to version **2.0.20211103**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | <br> | *_Graviton AMIs_<br>• | Added Graviton instance support to the Corretto and .NET Core platforms.<br>Updated Graviton images for platforms that support Graviton instances.<br>For a list of Graviton image IDs for each supported platform branch and region, see [Graviton image IDs for supporting platforms](#release-2021-11-19-linux.graviton "#release-2021-11-19-linux.graviton") on this page.<br>For more information about how to create and configure environments using Graviton instances, see [Amazon EC2 instance<br>types](../dg/using-features.managing.ec2.md#using-features.managing.ec2.instance-types "../dg/using-features.managing.ec2.md#using-features.managing.ec2.instance-types") in the _AWS Elastic Beanstalk Developer Guide_. |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                                        | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Go_<br>•                                           | Updated Go to release **1.17.3**. For details, see [go1.17](https://golang.org/doc/devel/release.html#go1.17 "https://golang.org/doc/devel/release.html#go1.17") in _The Go Programming Language Release<br>History_.<br>The Go 1.17.3 release is a security release.                                                                                        | <br> | **Corretto**, *_Tomcat_<br>• | Updated Corretto 11 to version **11.0.13.8.1**. For more information, see [Change Log for Amazon Corretto 11](https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-11/blob/develop/CHANGELOG.md") in the Corretto 11 repository<br>on GitHub.<br>Updated Corretto 8 to version **8.312.07.1**. For more information, see [Change Log for Amazon Corretto 8](https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md "https://github.com/corretto/corretto-8/blob/develop/CHANGELOG.md") in the Corretto 8 repository on<br>GitHub.<br>Updated Tomcat 8.5 to [Tomcat<br>8.5.69](<https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.72_(schultz)> "https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.72_(schultz)").<br>Both Corretto updates are security releases. | <br> | *_.NET Core_<br>•     | Updated .NET Core to releases [5.0.12](https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.12/5.0.12.md "https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.12/5.0.12.md")<br>and [3.1.21](https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.21/3.1.21.md "https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.21/3.1.21.md").                                                                                                                                                                                                                                                                                                                                                 | <br> | *_Node.js_<br>• | Updated Node.js 14 to add support for Node version<br>[14.17.6](https://nodejs.org/en/blog/release/v14.17.6/ "https://nodejs.org/en/blog/release/v14.17.6/").<br>Updated Node.js 12 to add support for Node version<br>[12.22.7](https://nodejs.org/en/blog/release/v12.22.7/ "https://nodejs.org/en/blog/release/v12.22.7/").<br>The Node.js 14 update is a security release. | <br> | *_Ruby_<br>• | Added a new platform branch, **Ruby 3.0**. For more information, see [Ruby 3.0.0 Released](https://www.ruby-lang.org/en/news/2020/12/25/ruby-3-0-0-released/ "https://www.ruby-lang.org/en/news/2020/12/25/ruby-3-0-0-released/").<br>Updated RubyGems to release [3.2.30](https://blog.rubygems.org/2021/10/26/3.2.30-released.html "https://blog.rubygems.org/2021/10/26/3.2.30-released.html"). |     |

## New platform versions

###### These currently supported platforms are updated:

- [Docker](#release-2021-11-19-linux.platforms.docker "#release-2021-11-19-linux.platforms.docker")
- [Go](#release-2021-11-19-linux.platforms.go "#release-2021-11-19-linux.platforms.go")
- [Java SE](#release-2021-11-19-linux.platforms.javase "#release-2021-11-19-linux.platforms.javase")
- [Tomcat](#release-2021-11-19-linux.platforms.java "#release-2021-11-19-linux.platforms.java")
- [.NET Core on Linux](#release-2021-11-19-linux.platforms.dotnetlinux "#release-2021-11-19-linux.platforms.dotnetlinux")
- [Node.js](#release-2021-11-19-linux.platforms.nodejs "#release-2021-11-19-linux.platforms.nodejs")
- [PHP](#release-2021-11-19-linux.platforms.PHP "#release-2021-11-19-linux.platforms.PHP")
- [Python](#release-2021-11-19-linux.platforms.python "#release-2021-11-19-linux.platforms.python")
- [Ruby](#release-2021-11-19-linux.platforms.ruby "#release-2021-11-19-linux.platforms.ruby")
...
| ----------------------------------------------------------------------------------------------------------------- | ------------ | -------------------- | --------- | ------------------ | ------------------------------------- |
| **Corretto 11 with Tomcat 8.5 AL2 version 4.2.8**<br>_64bit Amazon Linux 2 v4.2.8 running Tomcat 8.5 Corretto 11_ | 2.0.20211103 | Corretto 11.0.13.8.1 | 3.2.0     | Tomcat 8.5.72      | nginx 1.20.0 (default), Apache 2.4.51 |
...
| ------------------------------------------------------------------------------------- | -------------------------------------------- | ------------ | ------------ | --------- |
| **.NET Core on AL2 version 2.2.8**<br>_64bit Amazon Linux 2 v2.2.8 running .NET Core_ | .NET 5.0.12, supports 5.0.12, 3.1.21, 2.1.30 | nginx 1.20.0 | 2.0.20211103 | 3.2.0     |

### Node.js

| Platform Version and _Solution Stack Name_                                           | AMI          | Node.js versions (npm versions)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Proxy Server                          | Git    | AWS X-Ray |
| ------------------------------------------------------------------------------------ | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ------ | --------- |
| **Node.js 14 AL2 version 5.4.8**<br>_64bit Amazon Linux 2 v5.4.8 running Node.js 14_ | 2.0.20211103 | 14.18.1 (6.14.15), 14.18.0 (6.14.15), 14.17.6 (6.14.15), 14.17.5 (6.14.14), 14.17.4 (6.14.14), 14.17.3 (6.14.13), 14.17.2 (6.14.13),<br>14.17.1 (6.14.13), 14.17.0 (6.14.13), 14.16.1 (6.14.12), 14.16.0 (6.14.11), 14.15.5 (6.14.11), 14.15.4 (6.14.10), 14.15.3 (6.14.9), 14.15.2<br>(6.14.9), 14.15.1 (6.14.8), 14.15.0 (6.14.8), 14.14.0 (6.14.8), 14.13.1 (6.14.8), 14.13.0 (6.14.8), 14.12.0 (6.14.8), 14.11.0 (6.14.8),<br>14.10.1 (6.14.8), 14.10.0 (6.14.8), 14.9.0 (6.14.8), 14.8.0 (6.14.7), 14.7.0 (6.14.7), 14.6.0 (6.14.6), 14.5.0 (6.14.5), 14.4.0 (6.14.5),<br>14.3.0 (6.14.5), 14.2.0 (6.14.4), 14.1.0 (6.14.4), 14.0.0 (6.14.4)<br>Default version: 14.18.1                                                                                                                                                                                                                  | nginx 1.20.0 (default), Apache 2.4.51 | 2.32.0 | 3.2.0     |
| **Node.js 12 AL2 version 5.4.8**<br>_64bit Amazon Linux 2 v5.4.8 running Node.js 12_ | 2.0.20211103 | 12.22.7 (6.14.15), 12.22.6 (6.14.15), 12.22.5 (6.14.14), 12.22.4 (6.14.14), 12.22.3 (6.14.13), 12.22.2 (6.14.13), 12.22.1 (6.14.12),<br>12.22.0 (6.14.11), 12.21.0 (6.14.11), 12.20.2 (6.14.11), 12.20.1 (6.14.10), 12.20.0 (6.14.8), 12.19.1 (6.14.8), 12.19.0 (6.14.8), 12.18.4<br>(6.14.6), 12.18.3 (6.14.6), 12.18.2 (6.14.5), 12.18.1 (6.14.5), 12.18.0 (6.14.4), 12.17.0 (6.14.4), 12.16.3 (6.14.4), 12.16.2 (6.14.4),<br>12.16.1 (6.13.4), 12.16.0 (6.13.4), 12.15.0 (6.13.4), 12.14.1 (6.13.4), 12.14.0 (6.13.4), 12.13.1 (6.12.1), 12.13.0 (6.12.0), 12.12.0<br>(6.11.3), 12.11.1 (6.11.3), 12.11.0 (6.11.3), 12.10.0 (6.10.3), 12.9.1 (6.10.2), 12.9.0 (6.10.2), 12.8.1 (6.10.2), 12.8.0 (6.10.2), 12.7.0<br>(6.10.0), 12.6.0 (6.9.0), 12.5.0 (6.9.0), 12.4.0 (6.9.0), 12.3.1 (6.9.0), 12.3.0 (6.9.0), 12.2.0 (6.9.0), 12.1.0 (6.9.0), 12.0.0<br>(6.9.0)<br>Default version: 12.22.7 | nginx 1.20.0 (default), Apache 2.4.51 | 2.32.0 | 3.2.0     |
...
| ------------------------------------------------------------------------------------ | ------------ | ------------- | ---------------- | -------- | ----- | --------- | ------------------------------------- |
| **Python 3.8 AL2 version 3.3.8**<br>_64bit Amazon Linux 2 v3.3.8 running Python 3.8_ | 2.0.20211103 | Python 3.8.5  | pipenv 2020.8.13 |          |       | 3.2.0     | nginx 1.20.0 (default), Apache 2.4.51 |
| **Python 3.7 AL2 version 3.3.8**<br>_64bit Amazon Linux 2 v3.3.8 running Python 3.7_ | 2.0.20211103 | Python 3.7.10 | pipenv 2020.8.13 |          |       | 3.2.0     | nginx 1.20.0 (default), Apache 2.4.51 |
...
The following sections list the Graviton image IDs for each platform branch that supports Graviton instance types. The images are specific to each
supporting AWS Region. For more information about Graviton instances, see [Amazon EC2 instance types](../dg/using-features.managing.ec2.md#using-features.managing.ec2.instance-types "../dg/using-features.managing.ec2.md#using-features.managing.ec2.instance-types") in the
