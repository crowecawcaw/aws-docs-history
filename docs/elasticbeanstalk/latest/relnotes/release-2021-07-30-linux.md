...
<a name="release-2021-07-30-linux"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux 2. The release includes security updates. It also includes a Corretto update.

**Release date:** July 30, 2021

## Changes
<a name="release-2021-07-30-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2021-07-30-linux.platforms.docker)
+ [Go](#release-2021-07-30-linux.platforms.go)
+ [Java SE](#release-2021-07-30-linux.platforms.javase)
+ [Tomcat](#release-2021-07-30-linux.platforms.java)
+ [.NET Core on Linux](#release-2021-07-30-linux.platforms.dotnetlinux)
+ [Node.js](#release-2021-07-30-linux.platforms.nodejs)
+ [PHP](#release-2021-07-30-linux.platforms.PHP)
+ [Python](#release-2021-07-30-linux.platforms.python)
+ [Ruby](#release-2021-07-30-linux.platforms.ruby)

### Docker
<a name="release-2021-07-30-linux.platforms.docker"></a>
...
### Go
<a name="release-2021-07-30-linux.platforms.go"></a>
...
### Java SE
<a name="release-2021-07-30-linux.platforms.javase"></a>
...
### Tomcat
<a name="release-2021-07-30-linux.platforms.java"></a>
...
### .NET Core on Linux
<a name="release-2021-07-30-linux.platforms.dotnetlinux"></a>
...
### Node.js
<a name="release-2021-07-30-linux.platforms.nodejs"></a>
...
### PHP
<a name="release-2021-07-30-linux.platforms.PHP"></a>



|  Platform Version and *Solution Stack Name*   |  AMI  |  Language  |  Composer  |  Proxy Server  | 
| --- | --- | --- | --- | --- | 
|  ** PHP 8.0 AL2 version 3.3.4** <br /> * 64bit Amazon Linux 2 v3.3.4 running PHP 8.0 *  | 2.0.20210721 | PHP 8.0.8 | 2.0.13 | nginx 1.20.0 (default), Apache 2.4.48 | 
|  ** PHP 7.4 AL2 version 3.3.4** <br /> * 64bit Amazon Linux 2 v3.3.4 running PHP 7.4 *  | 2.0.20210721 | PHP 7.4.21 | 1.10.22 | nginx 1.20.0 (default), Apache 2.4.48 | 

### Python
<a name="release-2021-07-30-linux.platforms.python"></a>
...
### Ruby
<a name="release-2021-07-30-linux.platforms.ruby"></a>
