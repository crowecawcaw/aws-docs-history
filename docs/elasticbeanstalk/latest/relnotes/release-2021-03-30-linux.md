# Release: Elastic Beanstalk Amazon Linux AMI platform updates on March 30, 2021
...
It also includes Multicontainer Docker, Go, Java, and Tomcat updates.
...
| ----------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/ "https://alas.aws.amazon.com/") on or before *_March 12, 2021_<br>• to all Amazon Linux AMI platforms.<br>The *_Go_<br>• release is a security release. For more information, see *_Platform-specific<br>updates_<br>• in this table. |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                       | *_Platform_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_Multicontainer Docker_<br>• | Updated the ECS agent to version **1.50.3**. | <br> | *_Go_<br>• | Updated Go to release **1.16.2**. For details, see [go1.16](https://golang.org/doc/devel/release.html#go1.16 "https://golang.org/doc/devel/release.html#go1.16") in _The Go Programming Language Release<br>History_.<br>The Go 1.16.1 release (included in this platform update) is a security release. | <br> | **Java SE**, *_Tomcat_<br>• | Updated Java 8 to OpenJDK Version **1.8.0.282**.<br>Updated Tomcat 8.5 to [Tomcat<br>8.5.63](<https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.63_(markt)> "https://tomcat.apache.org/tomcat-8.5-doc/changelog.html#Tomcat_8.5.63_(markt)"). |     |
...
- [Docker](#release-2021-03-30-linux.platforms.docker "#release-2021-03-30-linux.platforms.docker")
- [Multicontainer Docker](#release-2021-03-30-linux.platforms.mcdocker "#release-2021-03-30-linux.platforms.mcdocker")
- [Preconfigured Docker](#release-2021-03-30-linux.platforms.dockerpreconfig "#release-2021-03-30-linux.platforms.dockerpreconfig")
- [Go](#release-2021-03-30-linux.platforms.go "#release-2021-03-30-linux.platforms.go")
- [Java SE](#release-2021-03-30-linux.platforms.javase "#release-2021-03-30-linux.platforms.javase")
- [Tomcat](#release-2021-03-30-linux.platforms.java "#release-2021-03-30-linux.platforms.java")
- [Node.js](#release-2021-03-30-linux.platforms.nodejs "#release-2021-03-30-linux.platforms.nodejs")
- [PHP](#release-2021-03-30-linux.platforms.PHP "#release-2021-03-30-linux.platforms.PHP")
- [Python](#release-2021-03-30-linux.platforms.python "#release-2021-03-30-linux.platforms.python")
- [Ruby](#release-2021-03-30-linux.platforms.ruby "#release-2021-03-30-linux.platforms.ruby")
...
| **Python 3.6 version 2.9.20**<br>_64bit Amazon Linux 2018.03 v2.9.20 running Python 3.6_ | 2018.03.0    | Python 3.6.12 | pip 9.0.3        | setuptools 28.8.0 | meld3 1.0.2 | 3.1.0     | Apache 2.4.46 with mod\_wsgi 3.5      |
