...
<a name="release-2022-11-04-linux"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux 2. The release includes security updates. It also includes AMI, nginx, ECS based Docker, Go, Corretto, Tomcat, .NET Core, Node.js, PHP, and Ruby updates. 

**Release date:** November 4, 2022

## Changes
<a name="release-2022-11-04-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2022-11-04-linux.platforms.docker)
+ [Go](#release-2022-11-04-linux.platforms.go)
+ [Java SE](#release-2022-11-04-linux.platforms.javase)
+ [Tomcat](#release-2022-11-04-linux.platforms.java)
+ [.NET Core on Linux](#release-2022-11-04-linux.platforms.dotnetlinux)
+ [Node.js](#release-2022-11-04-linux.platforms.nodejs)
+ [PHP](#release-2022-11-04-linux.platforms.PHP)
+ [Python](#release-2022-11-04-linux.platforms.python)
+ [Ruby](#release-2022-11-04-linux.platforms.ruby)

### Docker
<a name="release-2022-11-04-linux.platforms.docker"></a>
...
### Go
<a name="release-2022-11-04-linux.platforms.go"></a>
...
### Java SE
<a name="release-2022-11-04-linux.platforms.javase"></a>
...
### Tomcat
<a name="release-2022-11-04-linux.platforms.java"></a>
...
|  ** Corretto 8 with Tomcat 8.5 AL2 version 4.3.1** <br /> * 64bit Amazon Linux 2 v4.3.1 running Tomcat 8.5 Corretto 8 *  | 2.0.20221004 | Corretto 8.352.08.1 | 3.2.0 | Tomcat 8.5.79 | nginx 1.22.0 (default), Apache 2.4.54 | 

### .NET Core on Linux
<a name="release-2022-11-04-linux.platforms.dotnetlinux"></a>



|  Platform Version and *Solution Stack Name*   |  Framework  |  Proxy Server  |  AMI  |  AWS X-Ray  | 
| --- | --- | --- | --- | --- | 
|  ** .NET Core on AL2 version 2.4.1** <br /> * 64bit Amazon Linux 2 v2.4.1 running .NET Core *  | .NET 6.0.10, supports 6.0.10, 5.0.17, 3.1.30 | nginx 1.22.0 | 2.0.20221004 | 3.2.0 | 

### Node.js
<a name="release-2022-11-04-linux.platforms.nodejs"></a>
...
|  ** Python 3.7 AL2 version 3.4.1** <br /> * 64bit Amazon Linux 2 v3.4.1 running Python 3.7 *  | 2.0.20221004 | Python 3.7.10 | pipenv 2021.11.9 |  |  | 3.2.0 | nginx 1.22.0 (default), Apache 2.4.54 | 

### Ruby
<a name="release-2022-11-04-linux.platforms.ruby"></a>
