...
AWS Elastic Beanstalk launches new console design in AWS Region _Europe (Frankfurt)_.

**Release date:** March 08, 2023

## Changes

Today we’re releasing a new console design in the AWS Region _Europe (Frankfurt) – eu-central-1_. This release introduces some significant design
...
To try out our new console experience in the AWS Region Europe (Frankfurt), open the [Elastic Beanstalk
console](https://console.aws.amazon.com/elasticbeanstalk "https://console.aws.amazon.com/elasticbeanstalk"). In the **Regions** list, select _Europe (Frankfurt) – eu-central-1_.
...
- The new console design is also presently available in the AWS Regions _Asia Pacific (Sydney)_ and beta release in
