...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Windows security updates** | Applied December 2019 security updates for Windows.<br>See Microsoft's [Security TechCenter](https://portal.msrc.microsoft.com/en-us/ "https://portal.msrc.microsoft.com/en-us/") and [Security Advisories and Bulletins](https://technet.microsoft.com/en-us/library/security/ "https://technet.microsoft.com/en-us/library/security/").                                                                                                                                                                                                                   |
| **AWS component updates**    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | *_Component_<br>• | *_Details_<br>• | <br> | --<br>• | --<br>• | <br> | *_AWS SDK for .NET_<br>• | Updated the SDK to version 3.15.903. | <br> | *_AMI_<br>• | Updated the base AMI to version 2019.12.16. | <br> | *_CloudWatch agent_<br>• | Updated the CloudWatch agent to version 1.232905.0. |     |
| **Instance types**           | Starting with today's Windows Server platform update, _we will no longer announce added Amazon EC2 instance types_. Any new<br>platform version will support all instance types available at the time of the platform version's release.<br>For a list of available instance types per AWS Region, see [Amazon EC2 Pricing](https://aws.amazon.com/ec2/pricing/on-demand/ "https://aws.amazon.com/ec2/pricing/on-demand/") and<br>[Amazon EC2 Spot Instances Pricing](https://aws.amazon.com/ec2/spot/pricing/ "https://aws.amazon.com/ec2/spot/pricing/"). |
