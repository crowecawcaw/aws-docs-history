...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ | --------------- | ---- | ------- | ------- | ---- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | -------------- | --------------------------------------------------------------------------------------------------------- | ---- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ---- | --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---- | ------------------------- | --------------------------------------------------- | --- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before<br>\*_May 26, 2026_<br>• to all Amazon Linux 2 platforms. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                               | \*_Component_<br>• | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_AMI_<br>•    | Updated the base AMI to version 2.0.20260526.                                                                                                                                                                                                                                                                                                                              | <br> | \*_nginx_<br>• | Updated nginx to version [1.30.1](https://nginx.org/en/CHANGES-1.30 "https://nginx.org/en/CHANGES-1.30"). | <br> | \*_Apache_<br>• | Updated Apache to version [2.4.67](https://downloads.apache.org/httpd/CHANGES_2.4 "https://downloads.apache.org/httpd/CHANGES_2.4"). | <br> | \*_X-Ray daemon_<br>• | Updated the X-Ray daemon to version [3.6.4](https://github.com/aws/aws-xray-daemon/releases/tag/v3.6.4 "https://github.com/aws/aws-xray-daemon/releases/tag/v3.6.4"). | <br> | \*_CloudWatch Agent_<br>• | Updated the CloudWatch Agent to version 1.300066.2. |     |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                            | \*_Platform_<br>•  | \*_Update_<br>• | <br> | --<br>• | --<br>• | <br> | \*_Docker_<br>• | • Updated ECS Agent to version [1.103.1](https://github.com/aws/amazon-ecs-agent/releases/tag/v1.103.1 "https://github.com/aws/amazon-ecs-agent/releases/tag/v1.103.1") for the ECS Docker platform branch.<br>• Updated Docker Compose to version [5.1.4](https://github.com/docker/compose/releases/tag/v5.1.4 "https://github.com/docker/compose/releases/tag/v5.1.4"). |      |

## New platform versions

###### These platforms are updated:

- [Docker](#release-2026-05-28-al2.platforms.docker "#release-2026-05-28-al2.platforms.docker")
- [Go](#release-2026-05-28-al2.platforms.go "#release-2026-05-28-al2.platforms.go")
- [Java SE](#release-2026-05-28-al2.platforms.javase "#release-2026-05-28-al2.platforms.javase")
- [Tomcat](#release-2026-05-28-al2.platforms.java "#release-2026-05-28-al2.platforms.java")
- [.NET Core on Linux](#release-2026-05-28-al2.platforms.dotnetlinux "#release-2026-05-28-al2.platforms.dotnetlinux")
- [Node.js](#release-2026-05-28-al2.platforms.nodejs "#release-2026-05-28-al2.platforms.nodejs")
- [PHP](#release-2026-05-28-al2.platforms.PHP "#release-2026-05-28-al2.platforms.PHP")
- [Python](#release-2026-05-28-al2.platforms.python "#release-2026-05-28-al2.platforms.python")
- [Ruby](#release-2026-05-28-al2.platforms.ruby "#release-2026-05-28-al2.platforms.ruby")
