...
It also includes AMI, .NET Core, Node.js, and Python updates.
...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Security updates**          | Applied all security updates published in the [Amazon Linux Security Center](https://alas.aws.amazon.com/alas2.html "https://alas.aws.amazon.com/alas2.html") on or before *_June 24, 2021_<br>• to all released Amazon Linux 2 platforms.<br>The **.NET Core**, **Node.js**, and **Python**<br>releases are security releases. For more information, see<br>*_Platform-specific updates_<br>• in this table. |
| **Cross-platform updates**    | Made these cross-platform updates:<br>                                                                                                                                                                                                                                                                                                                                                                        | *_Component_<br>• | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_AMI_<br>•       | Updated the base AMI to version 2.0.20210617.                                                                                                                                                                                                                                                                                                                                                                               |      |
| **Platform-specific updates** | Made these platform-specific updates:<br>                                                                                                                                                                                                                                                                                                                                                                     | *_Platform_<br>•  | *_Update_<br>• | <br> | --<br>• | --<br>• | <br> | *_.NET Core_<br>• | Updated .NET Core to releases<br>[5.0.7](https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.7/5.0.7.md "https://github.com/dotnet/core/blob/master/release-notes/5.0/5.0.7/5.0.7.md") and<br>[3.1.16](https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.16/3.1.16.md "https://github.com/dotnet/core/blob/master/release-notes/3.1/3.1.16/3.1.16.md").<br>Both releases are security releases. | <br> | *_Node.js_<br>• | Updated Node.js 14 to add support for Node version<br>[14.17.1](https://nodejs.org/en/blog/release/v14.17.1/ "https://nodejs.org/en/blog/release/v14.17.1/"). | <br> | *_Python_<br>• | Updated Python 3.7 to [Python<br>3.7.10](https://docs.python.org/3.7/whatsnew/changelog.html#python-3-7-10-final "https://docs.python.org/3.7/whatsnew/changelog.html#python-3-7-10-final").<br>The Python 3.7.10 release is a security release. |     |
...
- [Docker](#release-2021-07-07-al2.platforms.docker "#release-2021-07-07-al2.platforms.docker")
- [Go](#release-2021-07-07-al2.platforms.go "#release-2021-07-07-al2.platforms.go")
- [Java SE](#release-2021-07-07-al2.platforms.javase "#release-2021-07-07-al2.platforms.javase")
- [Tomcat](#release-2021-07-07-al2.platforms.java "#release-2021-07-07-al2.platforms.java")
- [.NET Core on Linux](#release-2021-07-07-al2.platforms.dotnetlinux "#release-2021-07-07-al2.platforms.dotnetlinux")
- [Node.js](#release-2021-07-07-al2.platforms.nodejs "#release-2021-07-07-al2.platforms.nodejs")
- [PHP](#release-2021-07-07-al2.platforms.PHP "#release-2021-07-07-al2.platforms.PHP")
- [Python](#release-2021-07-07-al2.platforms.python "#release-2021-07-07-al2.platforms.python")
- [Ruby](#release-2021-07-07-al2.platforms.ruby "#release-2021-07-07-al2.platforms.ruby")
...
| ------------------------------------------------------------------------------------- | ------------------------------------------ | ------------ | ------------ | --------- |
| **.NET Core on AL2 version 2.2.2**<br>_64bit Amazon Linux 2 v2.2.2 running .NET Core_ | .NET 5.0.7, supports 5.0.7, 3.1.16, 2.1.28 | nginx 1.20.0 | 2.0.20210617 | 3.2.0     |
...
| ---------------------------------------------------------------------------------------- | ------------ | ------------- | ---------------- | ----------------- | ----------- | --------- | ------------------------------------- |
| **Python 3.8 AL2 version 3.3.2**<br>_64bit Amazon Linux 2 v3.3.2 running Python 3.8_     | 2.0.20210617 | Python 3.8.5  | pipenv 2020.8.13 |                   |             | 3.2.0     | nginx 1.20.0 (default), Apache 2.4.46 |
| **Python 3.7 AL2 version 3.3.2**<br>_64bit Amazon Linux 2 v3.3.2 running Python 3.7_     | 2.0.20210617 | Python 3.7.10 | pipenv 2020.8.13 |                   |             | 3.2.0     | nginx 1.20.0 (default), Apache 2.4.46 |
