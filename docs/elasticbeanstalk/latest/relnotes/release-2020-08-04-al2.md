...
Other features are supported but have to be configured differently on Amazon Linux 2 platforms. For a detailed migration guide, see [Migrating your Elastic Beanstalk Linux application to Amazon Linux 2](../dg/using-features.migration-al.md "../dg/using-features.migration-al.md") in the
