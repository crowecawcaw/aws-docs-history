...
<a name="release-2021-10-21-linux"></a>

This release provides new versions for AWS Elastic Beanstalk platforms based on Amazon Linux 2. The release includes security updates. It also includes AMI, Apache httpd, Go, .NET Core, Node.js, and Ruby updates, and updates Graviton image IDs.

**Release date:** October 21, 2021

## Changes
<a name="release-2021-10-21-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2021-10-21-linux.platforms.docker)
+ [Go](#release-2021-10-21-linux.platforms.go)
+ [Java SE](#release-2021-10-21-linux.platforms.javase)
+ [Tomcat](#release-2021-10-21-linux.platforms.java)
+ [.NET Core on Linux](#release-2021-10-21-linux.platforms.dotnetlinux)
+ [Node.js](#release-2021-10-21-linux.platforms.nodejs)
+ [PHP](#release-2021-10-21-linux.platforms.PHP)
+ [Python](#release-2021-10-21-linux.platforms.python)
+ [Ruby](#release-2021-10-21-linux.platforms.ruby)
...
|  ** PHP 7.4 AL2 version 3.3.7** <br /> * 64bit Amazon Linux 2 v3.3.7 running PHP 7.4 *  | 2.0.20211001 | PHP 7.4.21 | 1.10.22 | nginx 1.20.0 (default), Apache 2.4.51 | 
...
<a name="release-2021-10-21-linux.graviton"></a>
