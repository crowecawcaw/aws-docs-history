...
<a name="release-2021-04-21-linux"></a>

This release provides new versions for most AWS Elastic Beanstalk platforms based on Amazon Linux AMI. The release includes security updates. It also includes Multicontainer Docker, Go, Node.js, and Ruby updates, and some platform deprecation announcements.

**Release date:** April 21, 2021

## Changes
<a name="release-2021-04-21-linux.changes"></a>
...
**Topics**
+ [Docker](#release-2021-04-21-linux.platforms.docker)
+ [Multicontainer Docker](#release-2021-04-21-linux.platforms.mcdocker)
+ [Preconfigured Docker](#release-2021-04-21-linux.platforms.dockerpreconfig)
+ [Go](#release-2021-04-21-linux.platforms.go)
+ [Java SE](#release-2021-04-21-linux.platforms.javase)
+ [Tomcat](#release-2021-04-21-linux.platforms.java)
+ [Node.js](#release-2021-04-21-linux.platforms.nodejs)
+ [PHP](#release-2021-04-21-linux.platforms.PHP)
+ [Ruby](#release-2021-04-21-linux.platforms.ruby)
...
|  ** Corretto 8 with Tomcat 8.5 AL2 version 4.1.7** <br /> * 64bit Amazon Linux 2 v4.1.7 running Tomcat 8.5 Corretto 8 *  | 2.0.20210326 | Corretto 8.282.08.1 | 3.2.0 | Tomcat 8.5.63 | nginx 1.18.0 (default), Apache 2.4.46 | 
|  ** Corretto 11 with Tomcat 7 AL2 version 4.1.7** <br /> * 64bit Amazon Linux 2 v4.1.7 running Tomcat 7 Corretto 11 *  | 2.0.20210326 | Corretto 11.0.10.9.1 | 3.2.0 | Tomcat 7.0.76 | nginx 1.18.0 (default), Apache 2.4.46 | 
|  ** Corretto 8 with Tomcat 7 AL2 version 4.1.7** <br /> * 64bit Amazon Linux 2 v4.1.7 running Tomcat 7 Corretto 8 *  | 2.0.20210326 | Corretto 8.282.08.1 | 3.2.0 | Tomcat 7.0.76 | nginx 1.18.0 (default), Apache 2.4.46 | 
...
|  ** PHP 7.4 AL2 version 3.2.0** <br /> * 64bit Amazon Linux 2 v3.2.0 running PHP 7.4 *  | 2.0.20210326 | PHP 7.4.15 | 1.9.3 | nginx 1.18.0 (default), Apache 2.4.46 | 
|  ** PHP 7.3 AL2 version 3.2.0** <br /> * 64bit Amazon Linux 2 v3.2.0 running PHP 7.3 *  | 2.0.20210326 | PHP 7.3.27 | 1.9.3 | nginx 1.18.0 (default), Apache 2.4.46 | 
|  ** PHP 7.2 AL2 version 3.2.0** <br /> * 64bit Amazon Linux 2 v3.2.0 running PHP 7.2 *  | 2.0.20210326 | PHP 7.2.34 | 1.9.3 | nginx 1.18.0 (default), Apache 2.4.46 | 
