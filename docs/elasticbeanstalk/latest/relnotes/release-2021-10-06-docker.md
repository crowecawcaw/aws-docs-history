...
<a name="release-2021-10-06-docker"></a>

This release provides a new version for the AWS Elastic Beanstalk Docker platform based on Amazon Linux 2. The release includes a new Docker version with security updates.

**Release date:** October 6, 2021

## Changes
<a name="release-2021-10-06-docker.changes"></a>

This release updates the Docker platform to AWS Docker version 20.10.7-3, which is equivalent to the Docker organization version [20.10.9](https://docs.docker.com/engine/release-notes/#20109).
...
<a name="release-2021-10-06-docker.platforms"></a>

### Docker
<a name="release-2021-10-06-docker.platforms.docker"></a>
