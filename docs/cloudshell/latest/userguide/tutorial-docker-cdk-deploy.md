...
- Bootstrap your account for use with the AWS CDK. For information about bootstrapping with AWS CDK,
  see [Bootstrapping](../../../cdk/v2/guide/bootstrapping.md "../../../cdk/v2/guide/bootstrapping.md") in the _AWS CDK v2 Developer Guide_.
...
![Image of the command used to install the AWS CDK dependencies.](images/docker-cdk-tutorial%20-%201-setup.png) 4. Create a skeleton AWS CDK project in the folder that you created.
...
![Image of the command to use the AWS CDK CLI to synthesize the project and deploy the resources.](images/docker-cdk-tutorial%20-%203-cdk-deploy-build.png) 10. Invoke the Lambda function to confirm and verify it.
...
Developer Guide](../../../cdk/v2/guide/hello_world.md "../../../cdk/v2/guide/hello_world.md"). If you encounter errors or run into issues when
