...
For a complete list of Amazon S3 actions, see [Actions](../../../AmazonS3/latest/API/API_GetObject.md "../../../AmazonS3/latest/API/API_GetObject.md") in the _Amazon Simple Storage Service API Reference_.
...
console, see [How do I upload files and folders to an S3 bucket?](../../../AmazonS3/latest/userguide/upload-objects.md "../../../AmazonS3/latest/userguide/upload-objects.md") in the
...
to the bucket. 3. Return to the CloudShell command line and enter the following command to
...
Exclude and Include Filters](../../../cli/latest/reference/s3/index.md#use-of-exclude-and-include-filters "../../../cli/latest/reference/s3/index.md#use-of-exclude-and-include-filters") in the _AWS CLI Command Reference_.
...
bucket. 2. Download the contents of the bucket to your local machine. Because the Amazon S3
...
folder or saving it to your local machine. 4. On your local machine, you can now unzip the contents of the downloaded zipped
folder.
