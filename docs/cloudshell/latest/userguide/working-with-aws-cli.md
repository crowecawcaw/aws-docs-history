...
DynamoDB with the AWS CLI](../../../cli/latest/userguide/cli-services-dynamodb.md "../../../cli/latest/userguide/cli-services-dynamodb.md") in the _AWS Command Line Interface User Guide_.
...
with the AWS CLI](../../../cli/latest/userguide/cli-services-ec2.md "../../../cli/latest/userguide/cli-services-ec2.md") in the _AWS Command Line Interface User Guide_.
...
For more information, see [Using
Amazon Glacier with the AWS CLI](../../../cli/latest/userguide/cli-services-glacier.md "../../../cli/latest/userguide/cli-services-glacier.md") in the _AWS Command Line Interface User Guide_.
...
_environment_ refers to a collection of AWS resources running an
application version.
...
command reference](../../../elasticbeanstalk/latest/dg/eb3-cmd-commands.md "../../../elasticbeanstalk/latest/dg/eb3-cmd-commands.md") in the _AWS Elastic Beanstalk Developer Guide_.
...
Command Line Reference](../../../AmazonECS/latest/developerguide/ECS_AWSCLI_Fargate.md "../../../AmazonECS/latest/developerguide/ECS_AWSCLI_Fargate.md") in the _Amazon Elastic Container Service Developer Guide_.
...
reference](../../../serverless-application-model/latest/developerguide/serverless-sam-cli-command-reference.md "../../../serverless-application-model/latest/developerguide/serverless-sam-cli-command-reference.md") in the _AWS Serverless Application Model Developer Guide_.
