...
CloudShell on the Console Toolbar. 5. The **Open in new browser tab**, which provides the option to
access your CloudShell session in a full screen. 6. The **Preferences** option, which you can use to [customize your shell experience](customizing-cshell.md "customizing-cshell.md"). 7. The bottom bar, which provides the following options to:
...
[Environment variables have precedence over AWS CLI credentials files](../../../cli/latest/userguide/cli-configure-quickstart.md#cli-configure-quickstart-precedence "../../../cli/latest/userguide/cli-configure-quickstart.md#cli-configure-quickstart-precedence") that are
...
line option `--region`. For more information, see [Command line options](../../../cli/latest/userguide/cli-configure-options.md "../../../cli/latest/userguide/cli-configure-options.md") in the
...
information about CloudShell and other AWS services. For more information, see [Getting started with the AWS Console Mobile Application](../../../consolemobileapp/latest/userguide/getting-started.md "../../../consolemobileapp/latest/userguide/getting-started.md"). To launch CloudShell in the AWS Console Mobile Application,
...
For more information about accessing CloudShell in Console Mobile Application, see [Access AWS CloudShell](../../../consolemobileapp/latest/userguide/getting-started.md#step-7-access-aws-cloudshell "../../../consolemobileapp/latest/userguide/getting-started.md#step-7-access-aws-cloudshell").
