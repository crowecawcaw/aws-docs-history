...
- **Security in the cloud** – Your responsibility is
  ...
  using Diagnostic Tools. The following topics show you how to configure Diagnostic Tools to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Diagnostic Tools resources.

###### Topics

- [Identity and Access Management for AWS Diagnostic Tools](security-iam.md "security-iam.md")
- [Compliance validation for AWS Diagnostic Tools](Diagnostic-Tools-compliance.md "Diagnostic-Tools-compliance.md")
- [Data protection in AWS Diagnostic Tools](data-protection.md "data-protection.md")
- [Resilience in AWS Diagnostic Tools](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
