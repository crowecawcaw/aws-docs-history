...
To view examples of Diagnostic Tools identity-based policies, see [Identity-based policy examples for AWS Diagnostic Tools](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
