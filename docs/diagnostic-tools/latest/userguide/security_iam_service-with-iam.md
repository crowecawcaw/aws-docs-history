...
To get a high-level view of how Diagnostic Tools and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of Diagnostic Tools identity-based policies, see [Identity-based policy examples for AWS Diagnostic Tools](security_iam_id-based-policy-examples.md).
...
To see a list of Diagnostic Tools actions, see [Actions Defined by Diagnostic Tools ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions) in the *Service Authorization Reference*.
...
To see a list of Diagnostic Tools condition keys, see [Condition Keys for Diagnostic Tools ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-policy-keys) in the *Service Authorization Reference*. To learn with which actions and resources you can use a condition key, see [Actions Defined by Diagnostic Tools ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions).
