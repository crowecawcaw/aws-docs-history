...
For details about actions and resource types defined by Diagnostic Tools, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for Diagnostic Tools](../../../IAM/latest/UserGuide/list_your_service.md "../../../IAM/latest/UserGuide/list_your_service.md") in the _Service Authorization Reference_.
...
To ensure that users and roles can still use the Diagnostic Tools console, also attach the
Diagnostic Tools `ConsoleAccess` or
...
this action on the console or programmatically using the AWS CLI or AWS API.

## Allowing `StartExecution` using a specific `IAM user`

In this example, you want to grant an IAM user in your AWS account access to run
all tools using a specific passrole. This policy includes permissions to complete this
action on the console or programmatically using the AWS CLI or AWS API.
