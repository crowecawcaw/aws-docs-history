...
Before you can create a directory in Amazon Cloud Directory, AWS Directory Service requires
 ...
 additional schemas to a directory. For more information, see [ApplySchema](http://docs.aws.amazon.com/amazoncds/latest/APIReference/API_ApplySchema.html "http://docs.aws.amazon.com/amazoncds/latest/APIReference/API_ApplySchema.html") in the *Amazon Cloud Directory API Reference
 Guide*.
