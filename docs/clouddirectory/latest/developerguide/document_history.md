...
| --- |--- |--- |
| [Amazon Cloud Directory will no longer be open to new customers starting November 7, 2025.](#document_history) | Amazon Cloud Directory will no longer be open to new customers starting November 7, 2025. If you would like to use Amazon Cloud Directory, sign up prior to that date. Existing customers can continue to use the service as normal. For more information, see [Amazon Cloud Directory availability change](https://docs.aws.amazon.com/clouddirectory/latest/developerguide/cloud-directory-availability-change.html). | October 7, 2025 | 
