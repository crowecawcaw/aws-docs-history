...
| tax\_id  | String  | 1024  | N  | Tax identification number  | ## Person The following tables list the facets that are included in the *Person* sample schema.
...
| company\_address (postalCode) | String | 1024 | N | A physical mailing address for the organization | ## Device The following table lists the facet that is included in the *Device* sample schema.
