...
| --- | --- | 
| Cloud Directory Webinar | [Deep Dive on Amazon Cloud Directory](https://www.youtube.com/watch?v=UANm3DC_IxE) | 
| Cloud Directory Sample Java Code | [Amazon Cloud DirectoryGitHub](https://github.com/aws-samples/AmazonCloudDirectory-sample) | 
...
| --- | --- | 
| Cloud Directory Developer Guide | [What is Amazon Cloud Directory](https://docs.aws.amazon.com/clouddirectory/latest/developerguide/what_is_cloud_directory.html) | 
| Cloud Directory API Reference | [Amazon Cloud Directory API Reference](http://docs.aws.amazon.com/clouddirectory/latest/APIReference/welcome.html) | 
| Cloud Directory Limits | [Amazon Cloud Directory Limits](https://docs.aws.amazon.com/clouddirectory/latest/developerguide/limits.html) | 
