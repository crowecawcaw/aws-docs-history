...
# Security in Amazon Cloud Directory
...
Security is a shared responsibility between AWS and you. The [shared
 responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/") describes this as security *of* the cloud and security *in* the cloud:
...
* **Security of the cloud** – AWS is responsible for
 ...
 learn about the compliance programs that apply to Amazon Cloud Directory, see [AWS Services in Scope by
...
This documentation helps you understand how to apply the shared responsibility model when
 using Cloud Directory. The following topics show you how to configure Cloud Directory to meet your
 security and compliance objectives. You also learn how to use other AWS services that help you
 to monitor and secure your Cloud Directory resources. 

###### Topics

* [Identity and Access Management in Amazon Cloud Directory](iam_auth_access.md "iam_auth_access.md")
* [Logging and Monitoring in Amazon Cloud Directory](incident-response.md "incident-response.md")
* [Compliance Validation for Amazon Cloud Directory](cd-compliance.md "cd-compliance.md")
* [Resilience in Amazon Cloud Directory](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
* [Infrastructure Security in Amazon Cloud Directory](infrastructure-security.md "infrastructure-security.md")
