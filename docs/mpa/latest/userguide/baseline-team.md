...
4. On the team page, choose **Baseline approvers**.
5. On the **Baseline approvers** page, select one or more approvers you want to baseline. This will start a Multi-party approval session against the selected approvers.
6. After you have selected the approvers you want to baseline, choose **Baseline approvers**.
...
- AWS CLI: [list-approval-teams](../../../cli/latest/reference/mpa/list-approval-teams.md "../../../cli/latest/reference/mpa/list-approval-teams.md") and [start-approval-team-baseline](../../../cli/latest/reference/mpa/start-approval-team-baseline.md "../../../cli/latest/reference/mpa/start-approval-team-baseline.md")
  ...
  This returns the `Arn` you need for `--arn` (Step 2). 2. Run one of the following commands to start a baseline:
...
- AWS SDKs: [ListApprovalTeams](../APIReference/API_ListApprovalTeams.md "../APIReference/API_ListApprovalTeams.md") and [StartApprovalTeamBaseline](../APIReference/API_StartApprovalTeamBaseline.md "../APIReference/API_StartApprovalTeamBaseline.md")

###### What to do next

After you start a baseline, approvers can accept the baseline by accessing the approver portal. You can monitor the baseline status and last activity information for each approver using the AWS CLI & AWS SDKs with the [get-approval-team](../../../cli/latest/reference/mpa/get-approval-team.md "../../../cli/latest/reference/mpa/get-approval-team.md") command, or by viewing the team details in the Multi-party approval console. For more information, see [View team](admin-view-team.md "admin-view-team.md").
