...
![Requested operations table showing 14 pending operations with expiration times and requestor details.](images/mpa-portal.png)
...
![Email invitation to join AWS Multi-party approval team with expiration date and response button.](images/email-invitation.png)
