...
performance of Multi-party approval and your other AWS solutions. AWS provides the following monitoring
tools to watch Multi-party approval, report when something is wrong, and take automatic actions when
appropriate:
...
- _Amazon CloudWatch_ monitors your AWS resources and the applications you
  run on AWS in real time. You can collect and track metrics, create customized consoles,
...
- [Portal APIs](web-api.md "web-api.md")
