...
As a managed service, Multi-party approval is protected by the AWS global network security
...
You use AWS published API calls to access Multi-party approval through the network. Clients must
