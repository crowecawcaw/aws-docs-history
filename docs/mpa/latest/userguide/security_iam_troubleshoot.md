# Troubleshooting Multi-party approval identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with Multi-party approval and IAM.

###### Topics

- [I am not authorized to
  perform an action in Multi-party approval](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my Multi-party approval resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Multi-party approval
...
have the fictional `mpa:`GetWidget`` permissions.

```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: mpa:GetWidget on resource: my-example-widget
```
...
Multi-party approval. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Multi-party approval resources
...
- To learn whether Multi-party approval supports these features, see [How Multi-party approval works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
