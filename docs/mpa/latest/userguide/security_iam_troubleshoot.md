...
**Topics**
+ [I am not authorized to perform an action in Multi-party approval](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to allow people outside of my AWS account to access my Multi-party approval resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether Multi-party approval supports these features, see [How Multi-party approval works with IAM](security_iam_service-with-iam.md).
