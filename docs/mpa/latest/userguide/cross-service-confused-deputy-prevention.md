...
```
{
  ...
  "Statement": {
    ...
    "Condition": {
      "ArnLike": {
        "aws:SourceArn": "arn:aws:{{ec2}}:*:{{123456789012}}:*"
      },
      "StringEquals": {
