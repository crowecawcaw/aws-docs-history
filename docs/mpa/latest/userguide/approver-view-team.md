...
<a name="approver-view-team"></a>

When you sign in to the Multi-party approval portal, you can view approval teams you belong to.

For more information about a team status, see [Team health](team-health.md).
...
1. On the left navigation, choose **Approval teams** and select a team to view its details.
