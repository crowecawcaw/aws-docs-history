...
- Not applicable: The request does not involve making arguments, drawing inferences, or presenting reasoning. The response does not contain any argumentation or attempts to reach conclusions based on premises.
...
<response>
  ...
  <answer>answer should be one of `Not applicable`, `Not at all`, `Not generally`, `Neutral/Mixed`, `Generally yes`, `Yes`</answer>
</response>
```
