...
## Amazon logo with curved arrow from A to Z forming a smile. Amazon — Nova 2 Sonic
...
| Green circle with white checkmark icon. Speech                                | Green circle with white checkmark icon. Speech                                    | Red circle with white X icon indicating error, cancel, or close action. `Invoke`           |                                                                                                          |
...
**Step 5 - Run your first inference request:** This model uses `InvokeModelWithBidirectionalStream`. See [API reference](bedrock/latest/APIReference/API_runtime_InvokeModelWithBidirectionalStream.md "bedrock/latest/APIReference/API_runtime_InvokeModelWithBidirectionalStream.md") for details.
