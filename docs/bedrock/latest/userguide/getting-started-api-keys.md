...
- **Learn about model inference** – Learn about generating responses with model inference by reading about concepts and the options available in Amazon Bedrock at [Making inference requests](inference.md "inference.md").
