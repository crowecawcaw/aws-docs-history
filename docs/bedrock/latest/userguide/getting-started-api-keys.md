...
- **Explore different models** – Learn about other foundation models available in Amazon Bedrock at [Using models with Bedrock](foundation-models-reference.md "foundation-models-reference.md") and change the `model_id` in your code to try them out.
