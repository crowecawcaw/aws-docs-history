...
## ![Spherical icon with horizontal stripes or segments across its surface.](https://docs.aws.amazon.com/bedrock/latest/userguide/images/models/kimik2.5.png) Moonshot AI — Kimi K2 Thinking
