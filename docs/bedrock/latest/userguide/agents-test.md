...
![Test window request to provide an example output for the action.](https://docs.aws.amazon.com/bedrock/latest/userguide/images/agents/roc-testwindow.png)
