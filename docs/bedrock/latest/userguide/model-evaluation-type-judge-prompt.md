...
+ [Amazon Nova 2 Lite](model-evaluation-type-judge-prompt-nova-2-lite.md)
+ [Amazon Nova Micro](model-evaluation-type-judge-prompt-nova-micro.md)
+ [Amazon Nova Premier](model-evaluation-type-judge-prompt-nova-premier.md)
...
+ [Anthropic Claude Haiku 4.5](model-evaluation-type-judge-prompt-claude-haiku-4-5.md)
+ [Anthropic Claude Opus 4.5](model-evaluation-type-judge-prompt-claude-opus-4-5.md)
+ [OpenAI GPT-5.4](model-evaluation-type-judge-prompt-gpt-5-4.md)
+ [Anthropic Claude Sonnet 4.6](model-evaluation-type-judge-prompt-claude-sonnet-4-6.md)
+ [Anthropic Claude Opus 4.6](model-evaluation-type-judge-prompt-claude-opus-4-6.md)
+ [Anthropic Claude Opus 4.7](model-evaluation-type-judge-prompt-claude-opus-4-7.md)
+ [Anthropic Claude Opus 4.8](model-evaluation-type-judge-prompt-claude-opus-4-8.md)
+ [OpenAI GPT-5.5](model-evaluation-type-judge-prompt-gpt-5-5.md)
+ [Anthropic Claude Sonnet 4.0](model-evaluation-type-judge-prompt-claude-sonnet-4.md)
+ [Anthropic Claude Sonnet 4.5](model-evaluation-type-judge-prompt-claude-sonnet-4-5.md)
