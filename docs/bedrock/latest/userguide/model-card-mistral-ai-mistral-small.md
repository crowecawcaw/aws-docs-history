...
## Pixelated icon showing a stylized person or avatar with orange and yellow coloring. Mistral AI — Mistral Small

## Model Details

Mistral Small is Mistral AI's cost-efficient model optimized for low-latency tasks like classification, translation, and customer support. For more information about model development and performance, see the [model/service card](https://docs.mistral.ai/getting-started/models "https://docs.mistral.ai/getting-started/models").
