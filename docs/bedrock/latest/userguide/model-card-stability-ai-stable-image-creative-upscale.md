...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Creative Upscale

## Model Details

Stable Image Creative Upscale is Stability AI's model that upscales images while adding creative detail and enhancing visual quality. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
