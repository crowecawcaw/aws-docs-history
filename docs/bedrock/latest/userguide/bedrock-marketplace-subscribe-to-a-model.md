...
publicly available model, such as a HuggingFace model, you don't need a subscription.
...
5. Choose the model card to open the **Model Detail**
   page.
6. Choose **View Subscription Options** to open the subscription
   modal.
7. Review the offers and the cost.
8. Review the legal terms and conditions.
9. Choose **Subscribe**.
   The subscription process is usually complete
   within
   10-15 minutes but can vary based on the requirements of the provider.

The costs are for the software costs only. You
will
be billed a separate SageMaker AI infrastructure cost for the instance type
