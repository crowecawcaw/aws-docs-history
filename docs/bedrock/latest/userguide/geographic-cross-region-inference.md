...
+ **Agents** – Specify the ID of the inference profile in the `foundationModel` field in a [CreateAgent](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent_CreateAgent.html) request. For more information, see [Create and configure agent manually](agents-create.md).
