...
All models can use the `InvokeModel` operation. Some models can use the
`Converse` operation.

For Amazon Bedrock marketplace models, use the [ApplyGuardrail](../APIReference/API_runtime_ApplyGuardrail.md "../APIReference/API_runtime_ApplyGuardrail.md") API to use Amazon Bedrock Guardrails.

The following table shows the available models and
whether they can use the `Converse` operation:
