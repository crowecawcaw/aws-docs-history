...
caching: [Implicit Prompt Caching](#prompt-caching-implicit "#prompt-caching-implicit") and
[Explicit Prompt Caching](#prompt-caching-explicit "#prompt-caching-explicit"). Support for each
...
| --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [Implicit Prompt<br>Caching](#prompt-caching-implicit "#prompt-caching-implicit") | Amazon Bedrock and the model automatically attempt to reuse eligible prompt<br>prefixes.         | No cache controls or breakpoints are required in your request.                  |
| [Explicit Prompt<br>Caching](#prompt-caching-explicit "#prompt-caching-explicit") | You identify reusable prompt prefixes by adding model-specific cache<br>controls or breakpoints. | Your request must include the cache controls supported by the model<br>and API. |
...
model-specific cache controls or _cache
checkpoints_. Cache checkpoints are markers that define the
...
[Amazon Bedrock pricing page](https://aws.amazon.com/bedrock/pricing/ "https://aws.amazon.com/bedrock/pricing/").

###### Important

Support for prompt caching doesn't guarantee a cache hit for any request. Check
...
When you [create](prompt-management-create.md "prompt-management-create.md") or [modify](prompt-management-modify.md "prompt-management-modify.md") a prompt, you can
...
[Supported models, Regions, and explicit caching limits](#prompt-caching-models "#prompt-caching-models").
...
availability by Region, see [Regional availability by models](models-region-compatibility.md "models-region-compatibility.md").
...
[Models at a glance](model-cards.md "model-cards.md"), and then choose the model that
...
the preceding section [Supported models, Regions, and explicit caching limits](#prompt-caching-models "#prompt-caching-models").
