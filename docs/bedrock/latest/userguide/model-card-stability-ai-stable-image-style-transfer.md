...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Style Transfer

## Model Details

Stable Image Style Transfer is Stability AI's model that applies the artistic style of a reference image to a target image. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
