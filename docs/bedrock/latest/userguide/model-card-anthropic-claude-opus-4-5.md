...
## Orange rounded square icon with white radial loading spinner design. Anthropic — Claude Opus 4.5

## Model Details

Claude Opus 4.5 is Anthropic's model for coding, agents, and computer use with improvements for spreadsheets and long-running chats. For more information about model development and performance, see the [model/service card](https://www-cdn.anthropic.com/bf10f64990cfda0ba858290be7b8cc6317685f47.pdf "https://www-cdn.anthropic.com/bf10f64990cfda0ba858290be7b8cc6317685f47.pdf").
...
The following tables show which endpoints and APIs are supported for Claude Opus 4.5. For more information, see [APIs supported by Amazon Bedrock](apis.md "apis.md") and [Endpoints supported by Amazon Bedrock](endpoints.md "endpoints.md").
...
| ----------------- | ----------------------------------------- | -------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------ |
| `bedrock-runtime` | `anthropic.claude-opus-4-5-20251101-v1:0` | N/A                        | `us.anthropic.claude-opus-4-5-20251101-v1:0``eu.anthropic.claude-opus-4-5-20251101-v1:0` | `global.anthropic.claude-opus-4-5-20251101-v1:0` |
