...
## ![Orange rounded square icon with white radial loading spinner design.](https://docs.aws.amazon.com/bedrock/latest/userguide/images/models/claude.png) Anthropic — Claude Opus 4.5
...
<a name="model-card-anthropic-claude-opus-4-5-apis-endpoints"></a>

The following tables show which endpoints and APIs are supported for Claude Opus 4.5. For more information, see [APIs supported by Amazon Bedrock](apis.md) and [Endpoints supported by Amazon Bedrock](endpoints.md).
...
| --- | --- | --- | --- | --- | 
| bedrock-runtime | anthropic.claude-opus-4-5-20251101-v1:0 | N/A | `us.anthropic.claude-opus-4-5-20251101-v1:0`<br />`eu.anthropic.claude-opus-4-5-20251101-v1:0` | global.anthropic.claude-opus-4-5-20251101-v1:0 | 
