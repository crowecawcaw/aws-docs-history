...
## Google logo with multicolored G letter icon. Google — Gemma 3 27B PT

## Model Details

Gemma 3 27B PT is Google's 27-billion parameter open model, the largest in the Gemma 3 family, with multimodal capabilities and a 128K context window. For more information about model development and performance, see the [model/service card](https://ai.google.dev/gemma/docs/core/model_card_3 "https://ai.google.dev/gemma/docs/core/model_card_3").
