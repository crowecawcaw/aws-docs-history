...
## Red waveform icon representing audio or voice activity. MiniMax — MiniMax M2.1

## Model Details

MiniMax M2.1 is MiniMax's updated model with improved reasoning, coding, and instruction following over M2. For more information about model development and performance, see the [model/service card](https://www.minimax.io/news/minimax-m21 "https://www.minimax.io/news/minimax-m21").
