...
## Orange rounded square icon with white radial loading or progress indicator symbol. Anthropic — Claude Sonnet 5
...
- **Model EOL date:** N/A
- **End User License Agreements and Terms of Use:** [Third-party model terms](https://aws.amazon.com/legal/bedrock/third-party-models/ "https://aws.amazon.com/legal/bedrock/third-party-models/")
...
For pricing, see the [Amazon Bedrock Pricing](https://aws.amazon.com/bedrock/pricing/ "https://aws.amazon.com/bedrock/pricing/") page.
...
_For example, if the Region is us-east-1 (N. Virginia), the bedrock-runtime endpoint URL is "https://bedrock-runtime.us-east-1.amazonaws.com" and the bedrock-mantle endpoint URL is "https://bedrock-mantle.us-east-1.api.aws/anthropic/v1/messages"._
...
- **Geo Cross-Region** routes across Regions within a geography (such as US, EU, and APAC) while respecting data residency.
- **Global Cross-Region** routes anywhere worldwide when there are no residency constraints.
...
**Step 2 - API key:** Open the [Amazon Bedrock console](https://console.aws.amazon.com/bedrock/home#/api-keys/long-term/create "https://console.aws.amazon.com/bedrock/home#/api-keys/long-term/create") and generate a long-term API key.
