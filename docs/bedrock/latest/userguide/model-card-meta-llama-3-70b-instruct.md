...
## ![Blue infinity symbol or figure-eight icon on white background.](https://docs.aws.amazon.com/bedrock/latest/userguide/images/models/meta.png) Meta — Llama 3 70B Instruct
