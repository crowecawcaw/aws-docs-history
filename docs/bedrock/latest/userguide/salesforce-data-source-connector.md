...
your Amazon Bedrock knowledge base by using either the [AWS Management Console for Amazon Bedrock](https://console.aws.amazon.com/bedrock/home "https://console.aws.amazon.com/bedrock/home") or the
[CreateDataSource](../APIReference/API_agent_CreateDataSource.md "../APIReference/API_agent_CreateDataSource.md")
...
Currently, only Amazon OpenSearch Serverless vector store is available to
use with this data source.
...
- [Supported features](#supported-features-salesforce-connector "#supported-features-salesforce-connector")
- [Prerequisites](#prerequisites-salesforce-connector "#prerequisites-salesforce-connector")
- [Connection configuration](#configuration-salesforce-connector "#configuration-salesforce-connector")
...
To connect to your Salesforce instance, you must provide the necessary configuration
...
An example of a regular expression pattern to exclude or filter out campaigns that
contain "private" in the campaign name: _".\*private.\*"_
...
1. Follow the steps at [Create a knowledge base by connecting to a data source in Amazon Bedrock Knowledge Bases](knowledge-base-create.md "knowledge-base-create.md") and choose **Salesforce** as the data source.
2. Provide a name and optional description for the data source.
3. Provide your Salesforce instance URL. For example,
...
5. Provide the authentication information to connect to your Salesforce instance:
   1. For OAuth 2.0 authentication, go to AWS Secrets Manager to add your secret
      ...
      contain the Salesforce Connected App consumer key (client ID), consumer secret
      (client secret), and the Salesforce instance URL or the URL to request the
      authentication token from. For more information, see Salesforce
...
7. Choose to use filters/regular expressions patterns to include or exclude certain content.
   All standard content is crawled otherwise.
8. Continue to choose an embeddings model and vector store. To see the remaining steps, return to [Create a knowledge base by connecting to a data source in Amazon Bedrock Knowledge Bases](knowledge-base-create.md "knowledge-base-create.md") and continue from the step after connecting your data source.

API
The following is an example of a configuration for connecting
to Salesforce for your Amazon Bedrock knowledge base. You configure your data
