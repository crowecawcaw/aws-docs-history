...
## Blue infinity symbol or figure-eight icon on white background. Meta — Llama 3.1 70B Instruct

## Model Details

Llama 3.1 70B Instruct is Meta's 70-billion parameter model with an extended 128K context window and support for tool use and code generation. For more information about model development and performance, see the [model/service card](https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_1/ "https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_1/").
