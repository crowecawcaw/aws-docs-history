...
All blocked content from the above policies will appear as plain text in [Amazon Bedrock Model Invocation Logs](model-invocation-logging.md "model-invocation-logging.md"), if you have enabled them. You can disable Amazon Bedrock
Invocation Logs if you do not want your blocked content to appear as plain text in the
logs.
