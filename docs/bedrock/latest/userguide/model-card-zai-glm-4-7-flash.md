...
## Icon showing a diagonal stripe pattern in black and white. Z.AI — GLM 4.7 Flash

## Model Details

GLM 4.7 Flash is Z.AI's lightweight model optimized for fast inference and low-latency tasks while maintaining strong general capabilities. For more information about model development and performance, see the [model/service card](https://z.ai/blog/glm-4.7 "https://z.ai/blog/glm-4.7").
