...
| roleArn          | To specify the Amazon Resource Name (ARN) of the service role<br>with permissions to create and manage the job. For more<br>information, see [Create a custom service role for batch inference](batch-iam-sr.md "batch-iam-sr.md").                                                                                                       |
| modelId          | To specify the ID or ARN of the model to use in<br>inference.                                                                                                                                                                                                                                                                             |
| inputDataConfig  | To specify the S3 location containing the input data. Batch inference processes all JSONL and accompanying content files at that S3 location, whether the location is an S3 folder or a single JSONL file. For more<br>information, see [Format and upload your batch inference data](batch-inference-data.md "batch-inference-data.md"). |
