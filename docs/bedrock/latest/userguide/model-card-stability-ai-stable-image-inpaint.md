...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Inpaint

## Model Details

Stable Image Inpaint is Stability AI's model that fills in masked regions of images with contextually appropriate content based on text prompts. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
