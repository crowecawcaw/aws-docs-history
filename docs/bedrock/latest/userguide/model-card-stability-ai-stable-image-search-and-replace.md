...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Search and Replace

## Model Details

Stable Image Search and Replace is Stability AI's model that finds objects in images and replaces them with new content based on text prompts. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
