...
| foundationModel | Specify a [foundation model](foundation-models-reference.md "foundation-models-reference.md") to use for orchestration by the inline agent you create. For example, anthropic claude, meta Llama3.1, etc. |
