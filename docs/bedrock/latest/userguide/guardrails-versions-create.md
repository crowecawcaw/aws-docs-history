...
5. If successful, you will be redirected to the screen with a list of versions with
   your new version added there.

API
To create a version of your guardrail, send a [CreateGuardrailVersion](../APIReference/API_CreateGuardrailVersion.md "../APIReference/API_CreateGuardrailVersion.md") request. Include the guardrail ID and an optional description.
