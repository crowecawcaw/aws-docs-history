...
The following tables show which endpoints and APIs are supported for Claude Opus 4.8. For more information, see [APIs supported by Amazon Bedrock](apis.md "apis.md") and [Endpoints supported by Amazon Bedrock](endpoints.md "endpoints.md").
