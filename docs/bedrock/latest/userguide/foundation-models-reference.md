...
| Use a custom model                                 | [Purchase Provisioned Throughput](prov-throughput.md "prov-throughput.md") for the custom model and use the returned `provisionedModelArn` as the model ID.                                                                                                        |

For example code, see the documentation
for the feature you are using and also [Code examples for Amazon Bedrock using AWS SDKs](service_code_examples.md "service_code_examples.md").

###### Topics

- [Get information about foundation models](models-get-info.md "models-get-info.md")
