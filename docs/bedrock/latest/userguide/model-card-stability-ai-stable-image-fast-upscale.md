...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Fast Upscale

## Model Details

Stable Image Fast Upscale is Stability AI's model that quickly increases image resolution with minimal processing time. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
