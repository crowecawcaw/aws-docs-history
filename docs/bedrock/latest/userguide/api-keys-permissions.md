...
Amazon Bedrock API keys can be used with [two endpoints](https://docs.aws.amazon.com/bedrock/latest/userguide/endpoints.html), each controlled by a separate IAM action. To fully prevent all API key-based access, you must deny both actions.
