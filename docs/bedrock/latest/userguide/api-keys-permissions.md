...
The [iam:CreateServiceSpecificCredential](../../../service-authorization/latest/reference/list_awsidentityandaccessmanagementiam.md#awsidentityandaccessmanagementiam-actions-as-permissions "../../../service-authorization/latest/reference/list_awsidentityandaccessmanagementiam.md#awsidentityandaccessmanagementiam-actions-as-permissions") action controls the generation of a service-specific key (such as a long-term Amazon Bedrock API key). You can scope this action to IAM users as a resource to limit the users for which a key can be generated.
