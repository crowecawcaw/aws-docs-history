...
API
To delete an agent, send a [DeleteAgent](../APIReference/API_agent_DeleteAgent.md "../APIReference/API_agent_DeleteAgent.md") request with an [Agents for Amazon Bedrock build-time endpoint](../../../general/latest/gr/bedrock.md#bra-bt "../../../general/latest/gr/bedrock.md#bra-bt") and specify the `agentId`.
