...
## Pixelated icon showing a stylized person or avatar with orange and yellow coloring. Mistral AI — Ministral 3 8B

## Model Details

Ministral 3 8B is Mistral AI's 8-billion parameter compact model for edge and mobile deployment with efficient inference. For more information about model development and performance, see the [model/service card](https://docs.mistral.ai/getting-started/models "https://docs.mistral.ai/getting-started/models").
