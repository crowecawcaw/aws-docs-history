...
Amazon Bedrock Knowledge Bases supports a variety of documents, including text, images, or multimodal documents that contain tables, charts, diagrams, and other images. _Multimodal_ data refers to a combination of text and visual data. Examples of file types that contain unstructured data are text, markdown, HTML, and PDFs.
