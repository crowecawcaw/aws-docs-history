...
You can configure and customize retrieval, further improving the
relevancy of results. For example, you can apply filters to document metadata
...
Console
Follow the console steps at [Query a knowledge base and retrieve data](kb-test-retrieve.md "kb-test-retrieve.md"). In the **Configurations** pane,
...
Console
Follow the console steps at [Query a knowledge base and retrieve data](kb-test-retrieve.md "kb-test-retrieve.md"). When you open the
...
Console
Follow the console steps at [Query a knowledge base and retrieve data](kb-test-retrieve.md "kb-test-retrieve.md"). In the test window, turn on **Generate
...
Follow the console steps at [Query a knowledge base and retrieve data](kb-test-retrieve.md "kb-test-retrieve.md"). When you open the **Configurations** pane, expand
