...
## Icon showing a diagonal stripe pattern in black and white. Z.AI — GLM 4.7

## Model Details

GLM 4.7 is Z.AI's large language model with strong multilingual capabilities and solid performance on reasoning, coding, and knowledge benchmarks. For more information about model development and performance, see the [model/service card](https://z.ai/blog/glm-4.7 "https://z.ai/blog/glm-4.7").
