...
- **At the start of the request** – The
  following sum is deducted from your quotas. The request is throttled if you
  exceed a quota.
...
Tokens are recorded in the `InputTokenCount` and `OutputTokenCount` runtime metrics (for more metrics, see [Amazon Bedrock runtime metrics](monitoring-runtime-metrics.md#runtime-cloudwatch-metrics "monitoring-runtime-metrics.md#runtime-cloudwatch-metrics").
