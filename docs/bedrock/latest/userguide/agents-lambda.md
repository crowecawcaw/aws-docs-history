...
For your agent to use a Lambda function, you must attach a resource-based policy to the function to provide permissions for the agent. For more information, follow the steps at [Resource-based policy to allow Amazon Bedrock to invoke an action group Lambda function](agents-permissions.md#agents-permissions-lambda "agents-permissions.md#agents-permissions-lambda"). For more information about resource-based policies in Lambda, see [Using resource-based policies for Lambda](../../../lambda/latest/dg/access-control-resource-based.md "../../../lambda/latest/dg/access-control-resource-based.md") in the AWS Lambda Developer Guide.

To learn how to define a function while creating the action group, see [Add an action group to your agent in Amazon Bedrock](agents-action-add.md "agents-action-add.md").

###### Topics

- [Lambda input event from Amazon Bedrock](#agents-lambda-input "#agents-lambda-input")
- [Lambda response event to Amazon Bedrock](#agents-lambda-response "#agents-lambda-response")
- [Action group Lambda function example](#agents-lambda-example "#agents-lambda-example")
...
- `promptSessionAttributes` – Contains [prompt session attributes](agents-session-state.md "agents-session-state.md") and their values. These attributes are stored over a [turn](advanced-prompts.md#advanced-prompts-terminology "advanced-prompts.md#advanced-prompts-terminology") and provide context for the agent.
...
The maximum payload response size matches the maximum size of a synchronous
response from the Lambda function. For more information, see the _invocation payload_
resource [quota](../../../lambda/latest/dg/gettingstarted-limits.md#function-configuration-deployment-and-execution "../../../lambda/latest/dg/gettingstarted-limits.md#function-configuration-deployment-and-execution") in the AWS Lambda Developer Guide.
...
- (Optional) `sessionAttributes` – Contains session attributes and their values. For more information, see [Session and prompt session attributes](agents-session-state.md#session-state-attributes "agents-session-state.md#session-state-attributes").
- (Optional) `promptSessionAttributes` – Contains prompt attributes and their values. For more information, see [Session and prompt session attributes](agents-session-state.md#session-state-attributes "agents-session-state.md#session-state-attributes").
- (Optional) `knowledgeBasesConfiguration` – Contains a list of query configurations for knowledge bases attached to the agent. For more information, see [Knowledge base retrieval configurations](agents-session-state.md#session-state-kb "agents-session-state.md#session-state-kb").
