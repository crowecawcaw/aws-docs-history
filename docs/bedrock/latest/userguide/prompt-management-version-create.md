...
API
To create a version of your prompt, send a [CreatePromptVersion](../APIReference/API_agent_CreatePromptVersion.md "../APIReference/API_agent_CreatePromptVersion.md") request with an [Agents for Amazon Bedrock build-time endpoint](../../../general/latest/gr/bedrock.md#bra-bt "../../../general/latest/gr/bedrock.md#bra-bt") and specify the ARN or ID of the prompt as the `promptIdentifier`.
