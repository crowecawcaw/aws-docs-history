...
IAM principal attribution works with Amazon Bedrock APIs on both the `bedrock-runtime` endpoint ([InvokeModel API](inference-api.md "inference-api.md") / [Converse API](conversation-inference.md "conversation-inference.md") / [Chat Completions API](inference-chat-completions.md "inference-chat-completions.md") / [Responses API](bedrock-mantle.md#bedrock-mantle-responses "bedrock-mantle.md#bedrock-mantle-responses") / [Messages API](model-parameters-anthropic-claude-messages.md "model-parameters-anthropic-claude-messages.md")) and the `bedrock-mantle` endpoint ([Responses API](bedrock-mantle.md "bedrock-mantle.md") / [Chat Completions API](bedrock-mantle.md "bedrock-mantle.md") / [Messages API](model-parameters-anthropic-claude-messages.md "model-parameters-anthropic-claude-messages.md")).
...
If a session tag and a principal tag share the same key, the session tag value overrides the principal tag value for that session. For more information, see [Pass session tags in AWS STS](../../../IAM/latest/UserGuide/id_session-tags.md "../../../IAM/latest/UserGuide/id_session-tags.md").
...
The IAM role's trust policy must allow `sts:TagSession` for session tags to flow through. To learn more, see [Pass session tags in AWS STS](../../../IAM/latest/UserGuide/id_session-tags.md "../../../IAM/latest/UserGuide/id_session-tags.md").
...
3. Filter by type **IAM principal** to find the tags you applied to your principals.
4. Select the tags and choose **Activate**.
...
For more information, see [Creating reports](../../../cur/latest/userguide/cur-create.md "../../../cur/latest/userguide/cur-create.md") in the AWS Cost and Usage Reports User Guide.
...
2. Map those attributes to AWS session tags in your IAM role's trust policy using `sts:TagSession`.
3. The session tags are then available as cost allocation tags in AWS Billing after activation.
...
| ------------------------------ | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------------------------------------------------------- |
| IAM principal attribution      | Identity (user, role, team) | [InvokeModel API](inference-api.md "inference-api.md") / [Converse API](conversation-inference.md "conversation-inference.md") / [Chat Completions API](inference-chat-completions.md "inference-chat-completions.md") / [Responses API](bedrock-mantle.md#bedrock-mantle-responses "bedrock-mantle.md#bedrock-mantle-responses") / [Messages API](model-parameters-anthropic-claude-messages.md "model-parameters-anthropic-claude-messages.md") on `bedrock-runtime`; [Responses API](bedrock-mantle.md "bedrock-mantle.md") / [Chat Completions API](bedrock-mantle.md "bedrock-mantle.md") / [Messages API](model-parameters-anthropic-claude-messages.md "model-parameters-anthropic-claude-messages.md") on `bedrock-mantle` | Green circular icon with a white checkmark symbol inside.               | Green circular icon with a white checkmark symbol inside.               |
