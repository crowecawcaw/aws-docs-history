...
## Blue infinity symbol or figure-eight icon on white background. Meta — Llama 4 Scout 17B Instruct

## Model Details

Llama 4 Scout is Meta's 17-billion active parameter mixture-of-experts model with 16 experts and a 10M token context window for long-document tasks. For more information about model development and performance, see the [model/service card](https://www.llama.com/docs/model-cards-and-prompt-formats/llama4/ "https://www.llama.com/docs/model-cards-and-prompt-formats/llama4/").
