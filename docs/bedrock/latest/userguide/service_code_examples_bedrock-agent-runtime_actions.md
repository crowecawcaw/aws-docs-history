...
The following code examples demonstrate how to perform individual Amazon Bedrock Agents Runtime
...
These excerpts call the Amazon Bedrock Agents Runtime API and
are code excerpts from larger programs that must be run in context.
You can see actions in context in
[Scenarios for Amazon Bedrock Agents Runtime using AWS SDKs](service_code_examples_bedrock-agent-runtime_scenarios.md "service_code_examples_bedrock-agent-runtime_scenarios.md").

The following examples include only the most commonly used actions.
For a complete list, see the
[Amazon Bedrock Agents Runtime API Reference](../APIReference/API_Operations_Agents_for_Amazon_Bedrock_Runtime.md "../APIReference/API_Operations_Agents_for_Amazon_Bedrock_Runtime.md").
