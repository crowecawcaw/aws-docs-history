...
[Scenarios for
Amazon Bedrock Agents Runtime using AWS SDKs](service_code_examples_bedrock-agent-runtime_scenarios.md "service_code_examples_bedrock-agent-runtime_scenarios.md") .
