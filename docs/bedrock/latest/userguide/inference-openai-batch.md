...
You can run a batch inference job using the [OpenAI Create batch API](https://platform.openai.com/docs/api-reference/batch "https://platform.openai.com/docs/api-reference/batch") with Amazon Bedrock OpenAI models.
...
- [Supported models and Regions for the OpenAI batch API](#inference-openai-batch-supported "#inference-openai-batch-supported")
- [Prerequisites to use the OpenAI batch API](#inference-openai-batch-prereq "#inference-openai-batch-prereq")
- [Create an OpenAI batch job](#inference-openai-batch-create "#inference-openai-batch-create")
- [Retrieve an OpenAI batch job](#inference-openai-batch-retrieve "#inference-openai-batch-retrieve")
- [List OpenAI batch jobs](#inference-openai-batch-list "#inference-openai-batch-list")
- [Cancel an OpenAI batch job](#inference-openai-batch-cancel "#inference-openai-batch-cancel")
...
- [Create batch](https://platform.openai.com/docs/api-reference/batch/create "https://platform.openai.com/docs/api-reference/batch/create") – Details both the request and response.
- [The request output object](https://platform.openai.com/docs/api-reference/batch/request-output "https://platform.openai.com/docs/api-reference/batch/request-output") – Details the fields of the generated output from the batch job. Refer to this documentation when interpreting the results in your S3 bucket.
...
- X-Amzn-Bedrock-RoleArn (required) – The Amazon Resource Name (ARN) of the batch inference service role. For more information, see [Create a custom service role for batch inference](batch-iam-sr.md "batch-iam-sr.md")
- X-Amzn-Bedrock-ModelId (required) – The ID of the foundation model to use in inference. For more information, see [Supported foundation models in Amazon Bedrock](models-supported.md "models-supported.md").
- X-Amzn-Bedrock-OutputEncryptionKeyId (optional) – The ID of a KMS key that you want to use to encrypt the output S3 files. For more information, see [Specifying server-side encryption with AWS KMS (SSE-KMS)](../../../AmazonS3/latest/userguide/specifying-kms-encryption.md "../../../AmazonS3/latest/userguide/specifying-kms-encryption.md").
- X-Amzn-Bedrock-Tags (optional) – A dictionary of keys and values that indicate tags to attach to the output. For more information, see [Tagging Amazon Bedrock resources](tagging.md "tagging.md").
...
2. Use the [batches.create()](https://platform.openai.com/docs/api-reference/batch/create "https://platform.openai.com/docs/api-reference/batch/create") method with the client.
...
For details about the OpenAI Retrieve batch API request and response, refer to [Retrieve batch](https://platform.openai.com/docs/api-reference/batch/retrieve "https://platform.openai.com/docs/api-reference/batch/retrieve").
...
2. Use the [batches.retrieve()](https://platform.openai.com/docs/api-reference/batch/create "https://platform.openai.com/docs/api-reference/batch/create") method with the client and specify the ID of the batch for which to retrieve information.
...
For details about the OpenAI List batches API request and response, refer to [List batches](https://platform.openai.com/docs/api-reference/batch/list "https://platform.openai.com/docs/api-reference/batch/list"). The response returns an array of information about your batch jobs.
...
2. Use the [batches.list()](https://platform.openai.com/docs/api-reference/batch/list "https://platform.openai.com/docs/api-reference/batch/list") method with the client. You can include any of the optional parameters.
...
You can include any of the optional query parameters. 2. Specify your AWS credentials or an Amazon Bedrock API key in the `Authorization` header.
...
For details about the OpenAI Cancel batch API request and response, refer to [Cancel batch](https://platform.openai.com/docs/api-reference/batch/cancel "https://platform.openai.com/docs/api-reference/batch/cancel"). The response returns information about the cancelled batch job.
...
2. Use the [batches.cancel()](https://platform.openai.com/docs/api-reference/batch/cancel "https://platform.openai.com/docs/api-reference/batch/cancel") method with the client and specify the ID of the batch for which to retrieve information.
