...
| **Quota**                        | **Default value** |
| -------------------------------- | ----------------- |
| On-demand requests per minute    | 2,000             |
| On-demand tokens per minute      | 4,000,000         |
| Cross-region requests per minute | 4,000             |
| Cross-region tokens per minute   | 8,000,000         |
| Max tokens per day               | 5,760,000,000     |
