...
1. Define or create resources for one or more nodes you plan to add to your flow:
   ...
   - For a Lambda node – Define a AWS Lambda function for the business logic you plan to implement in the flow. For more information, see the [AWS Lambda Developer Guide](../../../lambda/latest/dg.md "../../../lambda/latest/dg.md").
