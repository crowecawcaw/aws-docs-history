...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Control Structure

## Model Details

Stable Image Control Structure is Stability AI's model that generates images guided by structural inputs like depth maps and edge detection. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
