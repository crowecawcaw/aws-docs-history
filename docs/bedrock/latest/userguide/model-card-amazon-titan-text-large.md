...
Titan Text Large is Amazon's general-purpose text generation model for tasks like summarization, text generation, and conversational chat. For more information about model development and performance, see the [model/service card](../../../ai/responsible-ai/titan-text-embeddings/overview.md "../../../ai/responsible-ai/titan-text-embeddings/overview.md").
...
| ----------------- | ------------------------ | ------------------------------------------------ | -------------------- | ----------------------- |
| `bedrock-runtime` | `amazon.titan-tg1-large` | `https://bedrock-runtime.{region}.amazonaws.com` | Not supported        | Not supported           |
