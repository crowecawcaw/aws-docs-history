...
API
To get information about a guardrail version, send a [GetGuardrail](../APIReference/API_GetGuardrail.md "../APIReference/API_GetGuardrail.md") request and include the ID and version of the guardrail. If you don't specify a version, the response returns details for the `DRAFT` version.
