...
| ----------------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `bedrock-mantle`  | `https://bedrock-mantle.{region}.api.aws/anthropic/v1/messages` | Recommended for new applications. Supports API key auth and [Workspaces (Anthropic-compatible)](workspaces.md "workspaces.md"). |
