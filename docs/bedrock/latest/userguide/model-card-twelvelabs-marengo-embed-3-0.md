...
| **Quota**                        | **Default value** |
| -------------------------------- | ----------------- |
| On-demand requests per minute    | 500               |
