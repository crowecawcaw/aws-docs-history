...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Outpaint

## Model Details

Stable Image Outpaint is Stability AI's model that extends images beyond their original boundaries with contextually coherent content. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
