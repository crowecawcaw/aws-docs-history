...
To list your knowledge bases, send a [ListKnowledgeBases](../APIReference/API_agent_ListKnowledgeBases.md "../APIReference/API_agent_ListKnowledgeBases.md") request with a [Agents for Amazon Bedrock build-time endpoint](../../../general/latest/gr/bedrock.md#bra-bt "../../../general/latest/gr/bedrock.md#bra-bt"). You can set the maximum number of results to return in a response. If there are more results than the number you set, the response returns a `nextToken`. Send this value in the `nextToken` field of another [ListKnowledgeBases](../APIReference/API_agent_ListKnowledgeBases.md "../APIReference/API_agent_ListKnowledgeBases.md") request to see the next batch of results.
