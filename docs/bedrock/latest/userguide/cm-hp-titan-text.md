...
| Learning rate warmup steps | learningRateWarmupSteps | The number of iterations over which the learning rate is gradually<br>increased to the specified rate | integer | 0        | 20       | 5        |
...
| Learning rate warmup steps | learningRateWarmupSteps | The number of iterations over which the learning rate is gradually<br>increased to the specified rate | integer | 0       | 250     | 5       |
