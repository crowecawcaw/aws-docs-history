...
Please go to [Models at a glance](model-cards.md "model-cards.md") and choose the model you are interested in to see which service tier that model supports.
