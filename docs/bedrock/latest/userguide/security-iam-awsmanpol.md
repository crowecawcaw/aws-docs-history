...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| [AmazonBedrockLimitedAccess](#security-iam-awsmanpol-AmazonBedrockLimitedAccess "#security-iam-awsmanpol-AmazonBedrockLimitedAccess") –<br>Update to an existing policy       | Amazon Bedrock added the `bedrock:CancelInvoke` action so that a role can cancel a response that the [Responses API](bedrock-mantle.md#bedrock-mantle-responses "bedrock-mantle.md#bedrock-mantle-responses") is still generating. `bedrock:GetInvoke` is already covered by the `bedrock:Get*` action in this policy. `bedrock:DeleteInvoke` is not included, because deleting a stored response destroys data — grant that action explicitly to the roles that need it. | August 13, 2026    |
