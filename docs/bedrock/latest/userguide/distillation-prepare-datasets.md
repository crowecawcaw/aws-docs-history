...
- [Supported modalities for distillation](#distillation-supported-modalities "#distillation-supported-modalities")
- [Optimize your input prompts for
  synthetic data generation](#distillation-data-prep-prompt-optimization "#distillation-data-prep-prompt-optimization")
...
- [Option 2: Use invocation logs for data preparation](distillation-data-prep-option-2.md "distillation-data-prep-option-2.md")
