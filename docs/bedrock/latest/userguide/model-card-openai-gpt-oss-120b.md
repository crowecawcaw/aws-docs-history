...
Use the settings from [Step 4 - Set environment variables](#model-card-openai-gpt-oss-120b-sample-code-environment). Choose the `bedrock-runtime` tab. The Chat tab uses the Chat Completions API.
