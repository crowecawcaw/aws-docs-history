...
## Google logo with multicolored G letter icon. Google — Gemma 3 12B IT

## Model Details

Gemma 3 12B IT is Google's 12-billion parameter open model with instruction tuning, supporting text and image inputs with a 128K context window. For more information about model development and performance, see the [model/service card](https://ai.google.dev/gemma/docs/core/model_card_3 "https://ai.google.dev/gemma/docs/core/model_card_3").
