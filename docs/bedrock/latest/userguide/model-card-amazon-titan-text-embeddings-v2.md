...
## Amazon logo with curved arrow from A to Z forming a smile. Amazon — Titan Text Embeddings V2

## Model Details

Titan Text Embeddings V2 is Amazon's second-generation text embeddings model with configurable output dimensions and improved accuracy for retrieval tasks. For more information about model development and performance, see the [model/service card](ai/responsible-ai/titan-text-embeddings/overview.md "ai/responsible-ai/titan-text-embeddings/overview.md").
...
| `us-gov-east-1` (GovCloud) | Green circle with white checkmark icon. | Red circle with white X icon indicating error, cancel, or close action. | Red circle with white X icon indicating error, cancel, or close action. |
...
| `eu-south-2` (Spain)       | Green circle with white checkmark icon. | Red circle with white X icon indicating error, cancel, or close action. | Red circle with white X icon indicating error, cancel, or close action. |
...
| `ap-northeast-3` (Osaka)   | Green circle with white checkmark icon. | Red circle with white X icon indicating error, cancel, or close action. | Red circle with white X icon indicating error, cancel, or close action. |
...
| `ap-south-2` (Hyderabad)   | Green circle with white checkmark icon. | Red circle with white X icon indicating error, cancel, or close action. | Red circle with white X icon indicating error, cancel, or close action. |
