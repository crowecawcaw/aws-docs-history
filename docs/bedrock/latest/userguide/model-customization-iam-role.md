...
- [Trust relationship](#model-customization-iam-role-trust "#model-customization-iam-role-trust")
- [Permissions to access training and validation files and to write output files in S3](#model-customization-iam-role-s3 "#model-customization-iam-role-s3")
- [(Optional) Permissions to create a Distillation job with a cross-region inference profiles](#customization-iam-sr-ip "#customization-iam-sr-ip")
