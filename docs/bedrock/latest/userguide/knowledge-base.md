...
- Use reranking models to influence the results that are retrieved from your data
  source.
- Include the knowledge base in an [Amazon Bedrock Agents](agents.md "agents.md")
  workflow.
...
1. (Optional) If you connect your knowledge base to an unstructured data source, set
   ...
   store](knowledge-base-setup.md "knowledge-base-setup.md") to index the vector embeddings representation of your data. You
