...
## Three overlapping circles in dark green, coral, and purple colors forming a logo or icon. Cohere — Embed English

## Model Details

Embed English is Cohere's English-language text embedding model for search, classification, and clustering with strong retrieval accuracy. For more information about model development and performance, see the [model/service card](https://docs.cohere.com/docs/cohere-embed "https://docs.cohere.com/docs/cohere-embed").
