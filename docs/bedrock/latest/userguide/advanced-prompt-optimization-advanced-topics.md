...
- [Multi-objective optimization](#advanced-prompt-optimization-multi-objective "#advanced-prompt-optimization-multi-objective")
- [Optimizing multi-turn and staged prompts](#advanced-prompt-optimization-multi-turn "#advanced-prompt-optimization-multi-turn")
...
For composite criteria across many turns or many sub-checks (tool correctness and tone and completeness), see the [Multi-objective optimization](#advanced-prompt-optimization-multi-objective "#advanced-prompt-optimization-multi-objective") section.
