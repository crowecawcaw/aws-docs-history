...
When you delete a Provisioned Throughput, you can no longer invoke the model at the throughput level that you purchased. If you delete a Provisioned Throughput linked to a custom model, the custom model isn't deleted. To learn how to delete a custom model, see [Delete a custom model](model-customization-delete.md).
