...
## Orange rounded square icon with white radial loading spinner design. Anthropic — Claude Opus 4.1
...
The following tables show which endpoints and APIs are supported for Claude Opus 4.1. For more information, see [APIs supported by Amazon Bedrock](apis.md "apis.md") and [Endpoints supported by Amazon Bedrock](endpoints.md "endpoints.md").
