...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Control Sketch

## Model Details

Stable Image Control Sketch is Stability AI's model that generates images guided by sketch inputs for controlled image creation. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
