...
- [Define actions in the action group](action-define.md "action-define.md")
- [Handle fulfillment of the action](action-handle.md "action-handle.md")
- [Add an action group to your agent in Amazon Bedrock](agents-action-add.md "agents-action-add.md")
- [View information about an action group](agents-action-view.md "agents-action-view.md")
- [Modify an action group](agents-action-edit.md "agents-action-edit.md")
- [Delete an action group](agents-action-delete.md "agents-action-delete.md")
