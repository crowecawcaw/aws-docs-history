...
## ![Blue icon showing a stylized whale with containers, representing Docker or container services.](https://docs.aws.amazon.com/bedrock/latest/userguide/images/models/deepseek.png) DeepSeek — DeepSeek-V3.1
