...
- The following actions allow a role to run inference with Amazon Bedrock resources other than foundation models:
  ...
  - `bedrock:GetImportedModel` – Required to run inference with an [imported model](model-customization-import-model.md "model-customization-import-model.md").
