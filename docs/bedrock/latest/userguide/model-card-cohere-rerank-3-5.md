...
## Three overlapping circles in dark green, coral, and purple colors forming a logo or icon. Cohere — Rerank 3.5

## Model Details

Rerank 3.5 is Cohere's relevance scoring model that reorders search results for improved accuracy in RAG pipelines and enterprise search. For more information about model development and performance, see the [model/service card](https://docs.cohere.com/docs/rerank "https://docs.cohere.com/docs/rerank").
