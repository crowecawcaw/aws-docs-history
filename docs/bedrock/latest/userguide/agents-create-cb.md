...
being built that fulfills the purpose. The conversational builder interacts with you to get all the necessary
information to build or update your agent.

###### Important

The conversational builder is available in the Amazon Bedrock console in
US East (N. Virginia), US West (Oregon), Europe (Frankfurt),
Asia Pacific (Sydney), and Europe (Paris) regions.

Conversational builder performs _only_ the following actions based on the interactions:
