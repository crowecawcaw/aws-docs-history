...
Please refer to [models at a glance](model-cards.md "model-cards.md") to see product
IDs for individual models. The following table shows product IDs for models not
