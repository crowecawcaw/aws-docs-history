...
## Pixelated icon showing a stylized person or avatar with orange and yellow coloring. Mistral AI — Mistral Large 3

## Model Details

Mistral Large 3 is Mistral AI's 675-billion parameter model with strong performance on coding, reasoning, and multilingual tasks. For more information about model development and performance, see the [model/service card](https://docs.mistral.ai/getting-started/models "https://docs.mistral.ai/getting-started/models").
