...
- [Inference using Responses API](bedrock-mantle.md "bedrock-mantle.md")
- [Inference using Chat Completions API](inference-chat-completions-mantle.md "inference-chat-completions-mantle.md")
