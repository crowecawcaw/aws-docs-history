...
- For API details, see
  [CreateAgent](../../../AWSJavaScriptSDK/v3/latest/client/bedrock-agent/command/CreateAgentCommand.md "../../../AWSJavaScriptSDK/v3/latest/client/bedrock-agent/command/CreateAgentCommand.md")
