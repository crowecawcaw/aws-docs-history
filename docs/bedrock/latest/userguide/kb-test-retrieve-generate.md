...
| orchestrationConfiguration | To specify configurations for how the model processes the prompt before retrieval and generation.<br>For more information, see [OrchestrationConfiguration](../APIReference/API_agent-runtime_OrchestrationConfiguration.md "../APIReference/API_agent-runtime_OrchestrationConfiguration.md").                                         |
