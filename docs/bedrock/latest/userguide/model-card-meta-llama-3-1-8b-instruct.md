...
## Blue infinity symbol or figure-eight icon on white background. Meta — Llama 3.1 8B Instruct

## Model Details

Llama 3.1 8B Instruct is Meta's compact 8-billion parameter model with a 128K context window, suitable for edge deployment and fine-tuning. For more information about model development and performance, see the [model/service card](https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_1/ "https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_1/").
