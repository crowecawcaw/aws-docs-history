...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Remove Background

## Model Details

Stable Image Remove Background is Stability AI's model that accurately removes backgrounds from images, isolating the foreground subject. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
