...
## Amazon logo with curved arrow from A to Z forming a smile. Amazon — Nova Micro

## Model Details

Nova Micro is Amazon's fastest text-only model, optimized for speed and low cost in tasks like summarization, translation, and classification. For more information about model development and performance, see the [model/service card](../../../ai/responsible-ai/nova-micro-lite-pro/overview.md "../../../ai/responsible-ai/nova-micro-lite-pro/overview.md").
...
| ----------------- | ------------------------ | ------------------------------------------------ | ------------------------------------------------------ | ----------------------- |
| `bedrock-runtime` | `amazon.nova-micro-v1:0` | `https://bedrock-runtime.{region}.amazonaws.com` | `us.amazon.nova-micro-v1:0``eu.amazon.nova-micro-v1:0` | Not supported           |
