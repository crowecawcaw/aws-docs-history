...
## Icon showing a purple letter S with a red dot in the lower right corner. Stability AI — Stable Image Style Guide

## Model Details

Stable Image Style Guide is Stability AI's model that generates images matching a reference style while following text prompt instructions. For more information about model development and performance, see the [model/service card](https://stability.ai/stable-image "https://stability.ai/stable-image").
