...
| ---------------- | ----------------------------------------------------------------------------------- | ------------------------------- | ----------------- |
| InvokeModel      | [Inference profiles](inference-profiles-support.md "inference-profiles-support.md") | Text<br>Image                   | Embedding         |
| StartAsyncInvoke | [Base models](models-supported.md "models-supported.md")                            | Video<br>Audio<br>Image<br>Text | Embedding         |
...
- [TwelveLabs Marengo Embed 2.7 request parameters](#model-parameters-marengo-async-request "#model-parameters-marengo-async-request")
- [TwelveLabs Marengo Embed 2.7 response](#model-parameters-marengo-response "#model-parameters-marengo-response")
- [TwelveLabs Marengo Embed 2.7 code examples](#model-parameters-marengo-examples "#model-parameters-marengo-examples")
...
- [InvokeModel](../APIReference/API_runtime_InvokeModel.md "../APIReference/API_runtime_InvokeModel.md") – In the response body.
- [StartAsyncInvoke](../APIReference/API_runtime_StartAsyncInvoke.md "../APIReference/API_runtime_StartAsyncInvoke.md") – In the S3 bucket defined in the `s3OutputDataConfig`, after the asynchronous invocation job completes.
