...
Before you use IAM to manage access to Lookout for Metrics, learn what IAM features are
available to use with Lookout for Metrics.

| IAM features you can use with Amazon Lookout for Metrics                                                                                                                    | IAM feature | Lookout for Metrics support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------- |
...
To get a high-level view of how Lookout for Metrics and other AWS services work with most IAM
features, see [AWS services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_.

## Identity-based

policies for Lookout for Metrics
...
To view examples of Lookout for Metrics identity-based policies, see [Identity-based policy
examples for Amazon Lookout for Metrics](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within Lookout for Metrics
...
To see a list of Lookout for Metrics actions, see [Actions defined by Amazon Lookout for Metrics](../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#yamazonlookoutformetrics-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#yamazonlookoutformetrics-actions-as-permissions") in the
...
resources for Lookout for Metrics
...
To see a list of Lookout for Metrics resource types and their ARNs, see
[Resources defined by Amazon Lookout for Metrics](../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#amazonlookoutformetrics-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#amazonlookoutformetrics-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon Lookout for Metrics](../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#yamazonlookoutformetrics-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#yamazonlookoutformetrics-actions-as-permissions").
...
condition keys for Lookout for Metrics
...
To see a list of Lookout for Metrics condition keys, see [Condition keys for Amazon Lookout for Metrics](../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#amazonlookoutformetrics-policy-keys "../../../service-authorization/latest/reference/list_amazonlookoutformetrics.md#amazonlookoutformetrics-policy-keys") in the
...
credentials with Lookout for Metrics
...
principal permissions for Lookout for Metrics
...
Changing the permissions for a service role might break Lookout for Metrics functionality.
Edit service roles only when Lookout for Metrics provides guidance to do so.

## Service-linked

roles for Lookout for Metrics
