...
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ----------------- |
| [AmazonLookoutMetricsReadOnlyAccess](#security-iam-awsmanpol-ReadOnlyAccess "#security-iam-awsmanpol-ReadOnlyAccess") – Update policy | Lookout for Metrics updated the read-only policy to include<br>`ListAnomalyGroupRelatedMetrics`.        | November 24, 2021 |
| [AmazonLookoutMetricsReadOnlyAccess](#security-iam-awsmanpol-ReadOnlyAccess "#security-iam-awsmanpol-ReadOnlyAccess")<br>– New policy | Lookout for Metrics added a new policy to allow read-only access for all Lookout for Metrics resources. | May 06, 2021      |
| [AmazonLookoutMetricsFullAccess](#security-iam-awsmanpol-FullAccess "#security-iam-awsmanpol-FullAccess") –<br>New policy             | Lookout for Metrics added a new policy to allow full access to all Lookout for Metrics resources.       | May 06, 2021      |
