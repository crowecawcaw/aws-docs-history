...
# Troubleshooting Amazon Lookout for Metrics identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with Lookout for Metrics and IAM.

###### Topics

- [I am not authorized to
  perform an action in Lookout for Metrics](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my Lookout for Metrics resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Lookout for Metrics
...
have the fictional `lookout for metrics:`GetWidget`` permissions.

```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: lookout for metrics:GetWidget on resource: my-example-widget
```
...
`lookout for metrics:`GetWidget`` action.
...
Lookout for Metrics. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Lookout for Metrics resources
...
- To learn whether Lookout for Metrics supports these features, see [How Amazon Lookout for Metrics works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
