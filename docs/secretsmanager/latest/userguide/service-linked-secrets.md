# AWS Secrets Manager secrets managed by other AWS
...
- `directconnect` – [How AWS Direct Connect
  uses AWS Secrets Manager](integrating_how-services-use-secrets_directconnect.md "integrating_how-services-use-secrets_directconnect.md")
...
- `rds` – [How Amazon RDS uses
  AWS Secrets Manager](integrating_how-services-use-secrets_RDS.md "integrating_how-services-use-secrets_RDS.md")
- `redshift` – [How Amazon Redshift uses
  AWS Secrets Manager](integrating_how-services-use-secrets_RS.md "integrating_how-services-use-secrets_RS.md")
