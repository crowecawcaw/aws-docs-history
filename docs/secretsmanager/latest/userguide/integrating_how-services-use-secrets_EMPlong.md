...
streams to a wide variety of playback devices and content delivery networks (CDNs). For
more information, see [Secrets Manager
access for CDN authorization](../../../mediapackage/latest/ug/setting-up-create-trust-rel-policy-cdn.md "../../../mediapackage/latest/ug/setting-up-create-trust-rel-policy-cdn.md") in the
