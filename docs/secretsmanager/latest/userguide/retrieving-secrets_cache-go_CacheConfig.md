...
Cache configuration options for a [Cache](retrieving-secrets_cache-go_cache.md "retrieving-secrets_cache-go_cache.md"),
such as maximum cache size, default [version stage](whats-in-a-secret.md#term_version "whats-in-a-secret.md#term_version"),
