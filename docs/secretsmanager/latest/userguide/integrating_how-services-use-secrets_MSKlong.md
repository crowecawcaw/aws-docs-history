...
your Amazon MSK clusters using usernames and passwords that are stored and secured using
AWS Secrets Manager. For more information, see [Username and password
authentication with AWS Secrets Manager](../../../msk/latest/developerguide/msk-password.md "../../../msk/latest/developerguide/msk-password.md") in the
