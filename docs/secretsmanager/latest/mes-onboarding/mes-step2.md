...
**Prerequisite**  
You must be a member of the AWS Partner Network. For more information about the benefits of being a member, see [Join the AWS Partner Network](https://aws.amazon.com/partners/).
...
+ The defined rotation strategy for your secret. Your customer can choose from the supported rotation strategies when creating secrets.
  + [Single user rotation](secrets-manager-mes-onboarding.md#single-user)
  + [Alternating users rotation (requires support for multiple active users)](secrets-manager-mes-onboarding.md#alternating-user)
