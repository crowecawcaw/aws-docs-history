...
| --- |--- |--- |
| [Initial release](secrets-manager-mes-onboarding.md) | This is the initial release of the Secrets Manager managed external secrets onboarding guide. | October 18, 2025 | 