...
AWS billing and usage reports often use abbreviations for Region codes. For example, the
`line_item_usage_type` value `APE1-USE1-AWS-In-Bytes` shows the
short codes for the Asia Pacific (Hong Kong) and US East (N. Virginia) Regions.
...
| `MXC1`            | `mx-central-1`   | Mexico (Central)           | ## Africa        |
| Region short code | Code             | Region                     |
| ---               | ---              | ---                        |
| `AFS1`            | `af-south-1`     | Africa (Cape Town)         | ## Asia Pacific  |
| Region short code | Code             | Region                     |
| ---               | ---              | ---                        |
...
| `APS9`            | `ap-southeast-7` | Asia Pacific (Thailand)    | ## Europe        |
| Region short code | Code             | Region                     |
| ---               | ---              | ---                        |
...
| `EUS2`            | `eu-south-2`     | Europe (Spain)             | ## Middle East   |
| Region short code | Code             | Region                     |
| ---               | ---              | ---                        |
| `ILC1`            | `il-central-1`   | Israel (Tel Aviv)          |
| `MEC1`            | `me-central-1`   | Middle East (UAE)          |
| `MES1`            | `me-south-1`     | Middle East (Bahrain)      | ## South America |
| Region short code | Code             | Region                     |
| ---               | ---              | ---                        |
