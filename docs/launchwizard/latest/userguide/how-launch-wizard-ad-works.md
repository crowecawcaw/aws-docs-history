...
<a name="how-launch-wizard-ad-works"></a>
...
**Topics**
+ [Deployment path](#launch-wizard-ad-deployment-options)
+ [Implementation details](#launch-wizard-ad-implementation)
+ [Domain controller launch limits](#launch-wizard-ad-limits)
+ [AWS Regions](#launch-wizard-ad-regions)

## Deployment path
<a name="launch-wizard-ad-deployment-options"></a>
...
<a name="launch-wizard-ad-deployment-options-windows"></a>
...
<a name="launch-wizard-ad-implementation"></a>
...
### VPC
<a name="launch-wizard-ad-implementation-vpc"></a>
...
- ** Private subnets A **
  ...
  - **10.0.0.0/16:** Availability Zone 1 / 10.0.0.0/20
  - **10.0.0.0/16:** Availability Zone 2 / 10.0.16.0/20
  - **10.0.0.0/16:** Availability Zone 3 / 10.0.32.0/20

- ** Public subnets **
  - **10.0.0.0/16:** Availability Zone 1
  - 10.0.128.0/20
...
### Security groups
<a name="launch-wizard-ad-implementation-sg"></a>
...
For a detailed list of port mappings used by CloudFormation, see the [Security best practices ](launch-wizard-ad-best-practices.md#launch-wizard-ad-security) in this guide.
...
<a name="launch-wizard-ad-implementation-rdg"></a>
...
### Active Directory
<a name="launch-wizard-ad-implementation-ad"></a>
...
<a name="launch-wizard-ad-implementation-domain-controllers"></a>
...
<a name="launch-wizard-ad-implementation-dns-dhcp"></a>
...
The VPC also provides an internal DNS server. This DNS provides instances with basic name resolution services for internet access and is crucial for access to AWS service endpoints, such as CloudFormation and Amazon S3 during bootstrapping.
...
<a name="launch-wizard-ad-dns-settings"></a>
...
<a name="launch-wizard-ad-adcs"></a>
...
<a name="launch-wizard-ad-architecture"></a>
...
To view architectural diagrams showing best practices for setting up an AD DS environment, see [Active Directory Domain Services on AWS](https://aws.amazon.com/quickstart/architecture/active-directory-ds/).

## Domain controller launch limits
<a name="launch-wizard-ad-limits"></a>
...
## AWS Regions
<a name="launch-wizard-ad-regions"></a>
