...
<a name="launch-wizard-sap-getting-started"></a>
...
+ [Monitor Launch Wizard for SAP deployments](launch-wizard-sap-monitoring.md)
+ [Deploying SAP Web Dispatcher](launch-wizard-sap-deploy-web-dispatcher.md)
