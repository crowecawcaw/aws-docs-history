...
details related to the deployment on the **Deployments** page of the Launch Wizard
console.

This section describes steps to help you troubleshoot deploying domain controllers with
Launch Wizard for Active Directory.
...
- Application Resources
  ...
  - `LaunchWizard-`STACK_NAME`-`TEMPLATE_NAME``.
    This log includes all of the logs from each PowerShell script run from
    within the instance.
