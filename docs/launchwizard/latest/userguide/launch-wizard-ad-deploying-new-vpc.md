...
<a name="launch-wizard-ad-deploying-new-vpc"></a>
...
**Contents**
+ [Deploy self-managed Active Directory to a new VPC](launch-wizard-ad-deploying-new-vpc-self-managed.md)
+ [Extend an existing Active Directory to a new VPC](launch-wizard-ad-deploying-new-vpc-extend.md)
+ [Deploy AWS Directory Service for Microsoft Active Directory to a new VPC](launch-wizard-ad-deploying-new-vpc-managed-ad.md)