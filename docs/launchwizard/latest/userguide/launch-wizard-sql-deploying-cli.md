# Deploy SQL Server to

a new or existing VPC (AWS CLI)

You can use the AWS Launch Wizard [CreateDeployment](../APIReference/API_CreateDeployment.md "../APIReference/API_CreateDeployment.md") API operation to deploy SQL Server. To create
...
You can create a deployment for your SQL Server application using the
