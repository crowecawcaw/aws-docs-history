...
- `iam` – Allows Launch Wizard EC2 roles and instance profiles to
  ...
  permissions.
- `autoscaling` – Allows Launch Wizard Amazon EC2 Auto Scaling groups, launch
