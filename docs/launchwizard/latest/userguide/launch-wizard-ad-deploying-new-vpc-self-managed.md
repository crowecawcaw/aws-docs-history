...
| Domain admin password<br>(DomainAdminPassword)              | _**Requires input**_ | Password for the previously named account. Must<br>be at least 8 characters containing letters, numbers<br>and symbols.                                                                                                       |
