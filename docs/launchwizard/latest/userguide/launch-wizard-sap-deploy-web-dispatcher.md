...
<a name="launch-wizard-sap-deploy-web-dispatcher"></a>
...
**Topics**
+ [Architectures for SAP Web Dispatcher](#launch-wizard-sap-deploy-web-dispatcher-architectures)
+ [Post-deployment configuration activities](#launch-wizard-sap-deploy-web-dispatcher-post-deployment)

## Architectures for SAP Web Dispatcher
<a name="launch-wizard-sap-deploy-web-dispatcher-architectures"></a>
...
<a name="launch-wizard-sap-deploy-web-dispatcher-post-deployment-activate"></a>
...
<a name="launch-wizard-sap-deploy-web-dispatcher-post-deployment-enable-https"></a>
...
1. Import the certificate that you used in the previous steps into ACM. For more information, see [Importing a certificate](https://docs.aws.amazon.com/acm/latest/userguide/import-certificate-api-cli.html) in the *AWS Certificate Manager User Guide*.
