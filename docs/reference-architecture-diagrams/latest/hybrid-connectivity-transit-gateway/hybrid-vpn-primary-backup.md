...
<a name="hybrid-vpn-primary-backup"></a>

Publication date: **August 17, 2022 ([Diagram history](#hc3-diagram-history))**

You can create a [Site-to-Site VPN](https://docs.aws.amazon.com/vpn/latest/s2svpn/SetUpVPNConnections.html) connection directly to a [Transit Gateway](https://docs.aws.amazon.com/vpc/latest/tgw/what-is-transit-gateway.html). With this, you can take advantage of the benefits of a managed VPN solution, while connecting to several VPCs without having to add a new connection. Having a secondary VPN connection allows you to achieve high availability in the hybrid setup.

## AWS Site-to-Site VPN primary and backup architecture
<a name="hc3-diagram1"></a>

![Architecture diagram showing AWS Site-to-Site VPN primary and backup configuration with AWS Transit Gateway.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/hybrid-connectivity-transit-gateway/images/hybrid-connectivity-transit-gateway-3.png)
...
1. Traffic is forwarded to the AWS Transit Gateway. As per the **spoke VPC route table**, the traffic is routed to the office branch through the primary AWS Site-to-Site VPN attachment. To influence the choice of the primary tunnel you can advertise a shorter Border Gateway Protocol (BGP) AS\_PATH from your preferred customer gateway.

1. The traffic is routed to the destination through the primary Site-to-Site VPN connection over the internet.
...
For more information about how to configure AWS Site-to-Site VPN to prefer one tunnel over the other, see [How do I configure my Site-to-Site VPN connection](https://repost.aws/knowledge-center/vpn-configure-tunnel-preference) on AWS re:Post.

## Further reading
<a name="hc3-further-reading"></a>
...
| [Initial publication](#hc3-diagram-history) | Reference architecture diagram first published. | August 17, 2022 | 
