...
5. The MetaVision Database stores data from medical devices, hospital systems and data
   ...
   On Failover Cluster Instances (FCIs)](../../../prescriptive-guidance/latest/optimize-costs-microsoft-workloads/sql-server-hadr.md "../../../prescriptive-guidance/latest/optimize-costs-microsoft-workloads/sql-server-hadr.md") are configured across Availability Zones to
