...
Publication date: **January 17, 2025 ([Diagram history](#hdnsd-diagram-history "#hdnsd-diagram-history"))**

This architecture shows how to resolve DNS queries bidirectionally between a corporate data center and an [Amazon VPC](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md") using [Amazon Route 53](../../../Route53/latest/DeveloperGuide/Welcome.md "../../../Route53/latest/DeveloperGuide/Welcome.md") Resolver inbound and outbound endpoints in a dual-stack configuration. Connectivity is provided through [AWS Transit Gateway](../../../vpc/latest/tgw/what-is-transit-gateway.md "../../../vpc/latest/tgw/what-is-transit-gateway.md") or AWS Cloud WAN with [AWS Direct Connect](../../../directconnect/latest/UserGuide/Welcome.md "../../../directconnect/latest/UserGuide/Welcome.md") or AWS Site-to-Site VPN.
...
![Architecture diagram showing hybrid DNS resolution between a corporate data center and an AWS VPC using Amazon Route 53 Resolver endpoints in a dual-stack IPv4 and IPv6 configuration.](images/hybrid-dns-route53-2.png)
...
3. The Route 53 Resolver outbound endpoint forwards the query to the on-premises DNS resolver. As per VPC routing and AWS Transit Gateway or AWS Cloud WAN routing configuration, the query is sent to the corporate data center through the hybrid connection, using either AWS Direct Connect or AWS Site-to-Site VPN.
...
6. The forwarded query arrives at the Route 53 Resolver inbound endpoint through the hybrid connection and AWS Transit Gateway or AWS Cloud WAN. The inbound endpoint sends the query to the Route 53 Resolver within the VPC.
