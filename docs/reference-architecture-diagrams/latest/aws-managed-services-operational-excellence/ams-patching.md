...
![Reference architecture diagram showing how AWS Managed Services manages OS patching by using AWS Systems Manager, , and Amazon CloudWatch.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/aws-managed-services-operational-excellence/images/aws-managed-services-operational-excellence-5.png)
