...
1. You or your partners can rely on AMS Helpdesk 24x7 for incidents at OS, infrastructure, and security levels. This frees your workforce for more value-added activities.

1. You and your partners are responsible for ITSM tooling and integration to the AWS ticketing system. With AMS, you can rely on AWS Service Management Connector (for ServiceNow or Jira SD) or use AWS Support APIs to integrate.

1. When you or your partners raise incidents and service requests, they end up in the standard AWS Support console. AMS then provides updates and resolutions.

1. The AMS service account receives events from AMS proactive monitoring and AMS security guardrails. AMS automation raises incidents, triggers remediations, and updates you through the AWS Support portal.

1. AMS acts as a single interface for all AWS related incidents. The AMS Operations team monitors your environments 24x7 (with email, phone, and chat support), backed by dedicated AMS security engineers.

## Deploy the architecture
<a name="ams-helpdesk-deploy"></a>
...
## Further reading
<a name="helpdesk-further-reading"></a>
...
## Diagram history
<a name="helpdesk-diagram-history"></a>

To be notified about updates to this reference architecture diagram, subscribe to the RSS feed.

| Change | Description | Date | 
| --- |--- |--- |
| [Initial publication](#helpdesk-diagram-history) | Reference architecture diagrams first published. | September 20, 2022 | 
