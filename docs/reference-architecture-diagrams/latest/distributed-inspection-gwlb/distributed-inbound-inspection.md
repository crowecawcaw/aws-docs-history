...
Publication date: **July 21, 2022 ([Diagram history](#dinb-diagram-history "#dinb-diagram-history"))**

This architecture uses [Gateway Load Balancer](../../../elasticloadbalancing/latest/gateway/introduction.md "../../../elasticloadbalancing/latest/gateway/introduction.md") to inspect inbound traffic in a distributed fashion. Multiple VPCs share the same backend security appliances in a centralized appliances VPC connected through [AWS PrivateLink](../../../vpc/latest/privatelink/what-is-privatelink.md "../../../vpc/latest/privatelink/what-is-privatelink.md").

## North/South inbound distributed inspection architecture

![Architecture diagram showing distributed inbound inspection with Gateway Load Balancer using shared security appliances across multiple VPCs.](images/distributed-inspection-gwlb-1.png)
