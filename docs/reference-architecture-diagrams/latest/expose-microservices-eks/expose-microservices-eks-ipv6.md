...
<a name="expose-microservices-eks-ipv6"></a>
...
1. Amazon Route 53 resolves incoming requests to the public ELBs in [dual-stack mode](https://kubernetes-sigs.github.io/aws-load-balancer-controller/v2.3/guide/service/annotations/) deployed by the AWS Load Balancer Controller.

1. The ELB forwards traffic to the IPv6 pods using IP mode.
...
1. The private route table forwards traffic to the NAT gateway, and the private IPv4 address of a node is translated to the public IPv4 address of the gateway.
...
| [Initial publication](#diagram-history-3) | Reference architecture diagram first published. | February 22, 2022 | 
