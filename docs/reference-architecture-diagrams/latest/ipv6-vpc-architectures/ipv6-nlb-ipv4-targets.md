...
Publication date: **June 23, 2022 ([Diagram history](#ipv6-6-diagram-history "#ipv6-6-diagram-history"))**

This architecture shows how to enable IPv4 and IPv6 internet connectivity to your application using [NLBs](../../../elasticloadbalancing/latest/userguide/what-is-load-balancing.md "../../../elasticloadbalancing/latest/userguide/what-is-load-balancing.md"). The NLB and target group instances continue using IPv4 for communication while supporting dual stack clients.

## IPv4 Targets for Dual Stack Internet-facing Network Load Balancer architecture

![Architecture diagram showing ipv4 targets for dual stack internet-facing network load balancer.](images/ipv6-vpc-architectures-6.png)
...
3. Your application stack remains unchanged with the dual stack added functionality for your application endpoints with NLB. The NLB and target group instances continue using IPv4 for communication.
