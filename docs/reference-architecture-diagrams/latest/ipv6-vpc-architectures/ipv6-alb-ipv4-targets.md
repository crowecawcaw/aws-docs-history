...
<a name="ipv6-alb-ipv4-targets"></a>

Publication date: **June 23, 2022 ([Diagram history](#ipv6-4-diagram-history))**

This architecture shows how to enable IPv4 and IPv6 internet connectivity to your application using [Application Load Balancers](https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/what-is-load-balancing.html) (ALBs). The ALB and target group instances continue using IPv4 for communication while supporting dual stack clients.

## IPv4 Targets for Dual Stack Internet-facing Application Load Balancer architecture
<a name="ipv6-4-diagram1"></a>

![Architecture diagram showing ipv4 targets for dual stack internet-facing application load balancer.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/ipv6-vpc-architectures/images/ipv6-vpc-architectures-4.png)


The following numbered items describe the key components in this architecture:

1. Configure your [Amazon VPC](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html) ALB subnets for dual stack internet connectivity by adding the default routes for IPv4 and IPv6.

1. Deploy your dual stack internet-facing ALB, and select the dual stack ALB subnets in the Amazon VPC.

1. Your application stack remains unchanged with the dual stack added functionality for the application endpoints with ALB. The ALB and target group instances continue using IPv4 for communication.
...
1. The ALB distributes traffic to the healthy targets in the target groups using IPv4 connections.

## Further reading
<a name="ipv6-4-further-reading"></a>
...
## Diagram history
<a name="ipv6-4-diagram-history"></a>
...
| [Initial publication](#ipv6-4-diagram-history) | Reference architecture diagram first published. | June 23, 2022 | 
