...
Publication date: **June 23, 2022 ([Diagram history](#ipv6-12-diagram-history "#ipv6-12-diagram-history"))**

This architecture shows how to configure IPv4 and IPv6 Amazon VPC peering connectivity. [Amazon Amazon VPC](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md") peering natively supports routing for both IP stacks, and you can create both intra-Region and cross-Region Amazon VPC peering connections.

## Dual Stack Peering Connectivity for the Amazon Amazon VPC architecture

![Architecture diagram showing dual stack peering connectivity for the amazon .](images/ipv6-vpc-architectures-12.png)
...
3. With Amazon VPC peering, IPv4 and IPv6 CIDR blocks of peered VPCs cannot overlap.
