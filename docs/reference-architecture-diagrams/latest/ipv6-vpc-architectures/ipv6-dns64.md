...
Publication date: **June 23, 2022 ([Diagram history](#ipv6-9-diagram-history "#ipv6-9-diagram-history"))**
...
![Architecture diagram showing dns64.](images/ipv6-vpc-architectures-9.png)

The following numbered items describe the key components in this architecture:

1. When you create a [Amazon VPC](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md"), the Amazon Route 53 Resolver that is created by default maps to a DNS server that runs on a reserved IPv4 address for the Amazon VPC network range, plus 2. For the IPv6 stack, the Route 53 Resolver can be reached at the local address fd00:ec2::253.
