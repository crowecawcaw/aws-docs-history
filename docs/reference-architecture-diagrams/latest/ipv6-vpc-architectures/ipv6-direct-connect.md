...
<a name="ipv6-direct-connect"></a>

Publication date: **June 23, 2022 ([Diagram history](#ipv6-15-diagram-history))**
...
1. For all types of VIFs IPv6 BGP peering, Amazon assigns a **/125** CIDR which is not configurable.

1. Private and transit VIFs IPv4 configuration make use of either Amazon-generated private IPv4 addresses, or addresses that you configure. If you specify your own, ensure that you specify private CIDRs for your router interface and the AWS Direct Connect interface only.

1. For public VIFs IPv4 BGP peering, you must specify unique public **/31** IPv4 CIDR that you own, or submit a request to have a CIDR block assigned.

1. You can maintain both IPv6-only and dual stack on-premises environments and use AWS Direct Connect for dedicated and private connectivity to your dual stack or IPv6-only workload footprint in AWS.

## Further reading
<a name="ipv6-15-further-reading"></a>
...
## Diagram history
<a name="ipv6-15-diagram-history"></a>
...
| [Initial publication](#ipv6-15-diagram-history) | Reference architecture diagram first published. | June 23, 2022 | 
