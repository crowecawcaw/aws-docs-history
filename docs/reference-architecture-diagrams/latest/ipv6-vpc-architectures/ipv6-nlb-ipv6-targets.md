...
# IPv6 Targets for Dual Stack Internet-facing Network Load Balancer
<a name="ipv6-nlb-ipv6-targets"></a>

Publication date: **June 23, 2022 ([Diagram history](#ipv6-7-diagram-history))**

This architecture shows how to enable IPv4 and IPv6 internet connectivity to your application using [NLBs](https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/what-is-load-balancing.html) with IPv6 targets. Your application stack can run natively on IPv6, as the NLB supports IPv6 targets. IPv6 target groups only support IP type targets.

## IPv6 Targets for Dual Stack Internet-facing Network Load Balancer architecture
<a name="ipv6-7-diagram1"></a>

![Architecture diagram showing ipv6 targets for dual stack internet-facing network load balancer.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/ipv6-vpc-architectures/images/ipv6-vpc-architectures-7.png)
...
1. Your application stack can run natively on IPv6, as the NLB supports IPv6 targets. IPv6 target groups only support IP type targets.
...
1. The NLB distributes traffic to the healthy targets in the target groups using IPv6 connections.

## Further reading
<a name="ipv6-7-further-reading"></a>
...
## Diagram history
<a name="ipv6-7-diagram-history"></a>
...
| [Initial publication](#ipv6-7-diagram-history) | Reference architecture diagram first published. | June 23, 2022 | 
