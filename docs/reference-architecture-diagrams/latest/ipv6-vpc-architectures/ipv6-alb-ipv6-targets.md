...
<a name="ipv6-alb-ipv6-targets"></a>

Publication date: **June 23, 2022 ([Diagram history](#ipv6-5-diagram-history))**

This architecture shows how to enable IPv4 and IPv6 internet connectivity to your application using ALBs with IPv6 targets. Your application stack can run natively on IPv6, as the [ALB](https://docs.aws.amazon.com/elasticloadbalancing/latest/userguide/what-is-load-balancing.html) supports IPv6 targets. IPv6 target groups only support IP type targets.

## IPv6 Targets for Dual Stack Internet-facing Application Load Balancer architecture
<a name="ipv6-5-diagram1"></a>

![Architecture diagram showing ipv6 targets for dual stack internet-facing application load balancer.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/ipv6-vpc-architectures/images/ipv6-vpc-architectures-5.png)
...
1. Your application stack can run natively on IPv6, as the ALB supports IPv6 targets. IPv6 target groups only support IP type targets.
...
1. The ALB distributes traffic to the healthy targets in the target groups using IPv6 connections.

## Further reading
<a name="ipv6-5-further-reading"></a>
...
## Diagram history
<a name="ipv6-5-diagram-history"></a>
...
| [Initial publication](#ipv6-5-diagram-history) | Reference architecture diagram first published. | June 23, 2022 | 
