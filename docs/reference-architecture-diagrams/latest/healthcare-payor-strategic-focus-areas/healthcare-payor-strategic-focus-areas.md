...
7. Query structured claims data and create data products that can be consumed by care management
   ...
   reconciliation. Create visualization dashboards using [**Amazon Quick Sight**](https://aws.amazon.com/quicksight/ "https://aws.amazon.com/quicksight/"),
...
leveraged to create data products and make them available in a catalog. 5. Create dashboards using **Amazon Quick Sight** (with [**Amazon Q**](https://aws.amazon.com/q/ "https://aws.amazon.com/q/") integration)
