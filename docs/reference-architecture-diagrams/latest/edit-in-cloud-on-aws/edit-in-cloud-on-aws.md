...
<a name="edit-in-cloud-on-aws"></a>

Publication date: **June 12, 2022 ([Diagram history](#diagram-history))**

This architecture helps you build a virtual, video editing environment on AWS to collaborate with your editors and creative professionals. This architecture can also be [deployed on AWS](https://docs.aws.amazon.com/solutions/latest/edit-in-the-cloud-on-aws/welcome.html) using an CloudFormation template that launches, configures, and runs the AWS services required to deploy this solution using AWS best practices for security and availability.
...
| --- |--- |--- |
| [Reference architecture updated](#diagram-history) | Updated for technical accuracy | July 12, 2022 | 
| [Reference architecture updated](#diagram-history) | Updated for technical accuracy | March 12, 2022 | 
| [Initial publication](#diagram-history) | Reference architecture diagram first published. | May 19, 2021 | 
