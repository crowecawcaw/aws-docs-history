...
Publication date: **December 28, 2024 ([Diagram history](#sdwan3-diagram-history "#sdwan3-diagram-history"))**
...
![Architecture diagram showing SD-WAN connectivity using AWS Cloud WAN Tunnel-less Connect attachments with native BGP peering across multiple Regions.](images/sd-wan-solutions-3.png)
