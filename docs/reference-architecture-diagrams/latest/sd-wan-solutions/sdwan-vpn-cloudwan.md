...
1. As per the Core Network policy, traffic arriving to the prod segment destined to the corporate data center should be forwarded to the Site-to-Site VPN attachment in Region B. The traffic is routed between the Core Network and the third-party virtual appliance using the Site-to-Site VPN connection.
...
1. The third-party virtual appliance in the **appliance VPC** forwards the traffic to the Core Network through the Site-to-Site VPN connection.
...
## Further reading
<a name="sdwan5-further-reading"></a>
...
## Diagram history
<a name="sdwan5-diagram-history"></a>
...
| [Initial publication](#sdwan5-diagram-history) | Reference architecture diagram first published. | December 28, 2024 | 
