...
![Reference architecture for Siemens NX on Amazon WorkSpaces Applications with Amazon EBS shared folders.](https://docs.aws.amazon.com/reference-architecture-diagrams/latest/siemens-nx-appstream/images/siemens-nx-architecture-diagram-ra-1.png)
