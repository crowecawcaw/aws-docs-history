...
performance of SageMaker AI and your other AWS solutions. AWS provides the following monitoring
tools to watch SageMaker AI, report when something is wrong, and take automatic actions when
appropriate:
...
- _Amazon CloudWatch Logs_ enables you to monitor, store, and access your log files
  from EC2 instances, AWS CloudTrail, and other sources. CloudWatch Logs can monitor information in the log
...
- _CloudWatch Events_ delivers a near real-time stream of system events that
  describe changes in AWS resources. Create CloudWatch Events rules react to a status change in a SageMaker AI
...
- [Amazon SageMaker AI detailed observability for inference endpoints](monitoring-cloudwatch-detailed-observability.md "monitoring-cloudwatch-detailed-observability.md")
