...
various metrics. This section details the content of a performance report for image
...
- Problem type: The problem type. In our case, _image
  classification_.
...
The following image is an example of a metrics table generates by Autopilot for an image
