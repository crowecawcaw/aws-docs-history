...
When you create a 3D point cloud object tracking labeling job, tasks are sent to
...
learn about the 3D point cloud object tracking output data format, see [3D point cloud object tracking output](sms-data-output.md#sms-output-point-cloud-object-tracking "sms-data-output.md#sms-output-point-cloud-object-tracking").
