...
To adjust the basic profiling configuration (`profiler_config`) or add the profiler rules (`rules`), use the following template for setting up a SageMaker AI training job. In the subsequent pages, you can find more information about how to configure the two parameters.
