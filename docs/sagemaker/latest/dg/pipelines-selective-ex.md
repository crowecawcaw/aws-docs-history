...
For more information about selective execution configuration requirements, see the [ sagemaker.workflow.selective\_execution\_config.SelectiveExecutionConfig ](https://sagemaker.readthedocs.io/en/stable/api/sagemaker_mlops.html#selective-execution-config) documentation.
