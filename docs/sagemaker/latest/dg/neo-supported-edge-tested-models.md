...
| maskrcnn_resnet50_fpn             |        |          |                |                | X        | X         |                 |                 |             |                        | TensorFlow             |
| Models                            | ARM V8 | ARM Mali | Ambarella CV22 | Ambarella CV25 | Nvidia   | Panorama  | TI TDA4VM       | Qualcomm QCS603 | X86_Linux   | X86_Windows            |
| ---                               | ---    | ---      | ---            | ---            | ---      | ---       | ---             | ---             | ---         | ---                    |
...
| rfcn_resnet101                    |        |          |                |                | X        |           |                 |                 |             |                        | TensorFlow.Keras       |
| Models                            | ARM V8 | ARM Mali | Ambarella CV22 | Nvidia         | Panorama | TI TDA4VM | Qualcomm QCS603 | X86_Linux       | X86_Windows |                        | ---                    | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DenseNet121                       | X      | X        |                | X              | X        | X         |                 | X               | X           |                        | DenseNet201            | X   | X   |     | X   | X   | X   |     |     | X   |
| InceptionV3                       | X      | X        |                | X              | X        | X         |                 | X               | X           |                        | MobileNet              | X   | X   |     | X   | X   | X   |     | X   | X   |
| MobileNetv2                       | X      | X        |                | X              | X        | X         |                 | X               | X           |                        | NASNetLarge            |     |     |     | X   | X   |     |     | X   | X   |
| NASNetMobile                      | X      | X        |                | X              | X        | X         |                 | X               | X           |                        | ResNet101              |     |     |     | X   | X   | X   |     |     | X   |
| ResNet101V2                       |        |          |                | X              | X        | X         |                 |                 | X           |                        | ResNet152              |     |     |     | X   | X   |     |     |     | X   |
| ResNet152v2                       |        |          |                | X              | X        |           |                 |                 | X           |                        | ResNet50               | X   | X   |     | X   | X   |     |     | X   | X   |
| ResNet50V2                        | X      | X        |                | X              | X        | X         |                 | X               | X           |                        | VGG16                  |     |     |     | X   | X   |     |     | X   | X   |
| Xception                          | X      | X        |                | X              | X        | X         |                 | X               | X           | TensorFlow-Lite (FP32) |
...
| squeezenet_2018_04_27             | X      |          |                | X              | X        | X         |                 |                 | X           |                        | TensorFlow-Lite (INT8) |
| Models                            | ARM V8 | ARM Mali | Ambarella CV22 | Nvidia         | Panorama | TI TDA4VM | Qualcomm QCS603 | X86_Linux       | X86_Windows | i.MX 8M Plus           |
| ---                               | ---    | ---      | ---            | ---            | ---      | ---       | ---             | ---             | ---         | ---                    |
| inception_v1                      |        |          |                |                |          |           | X               |                 |             | X                      |
| inception_v2                      |        |          |                |                |          |           | X               |                 |             | X                      |
