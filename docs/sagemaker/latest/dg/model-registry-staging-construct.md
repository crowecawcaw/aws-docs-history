...
+ Search based on Model Life Cycle Fields - You can search and filter stage and stage status using the [`Search`](https://docs.aws.amazon.com/sagemaker/latest/APIReference/API_Search.html) API.
