...
![Gif showing how to create a named entity recognition labeling job in the SageMaker AI console.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/sms/gifs/nertool.gif)
