...
| `channel`           | The position of the color channel in the input tensor shape array.<br>**Optional**<br>Valid values: Integer<br>Default value: `1` (for example, MXNet expects input<br>data in the form of (batch\_size, channel, height, width))  |
