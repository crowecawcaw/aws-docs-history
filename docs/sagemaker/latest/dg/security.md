...
- **Security of the cloud** – AWS is responsible for
  ...
  learn about the compliance programs that apply to Amazon SageMaker AI, see [AWS Services in Scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  to monitor and secure your SageMaker AI resources.

###### Topics

- [Data Privacy in Amazon SageMaker AI](data-privacy.md "data-privacy.md")
- [Data Protection in Amazon SageMaker AI](data-protection.md "data-protection.md")
- [AWS Identity and Access Management for Amazon SageMaker AI](security-iam.md "security-iam.md")
