...
You can list all available **JumpStart Model IDs** programmatically with the Amazon SageMaker Python SDK:
...
For the details of a specific model, search for its model ID on the [JumpStart landing page](https://aws.amazon.com/sagemaker/jumpstart/getting-started/) in Studio Classic. These details might include the languages supported by the model, biases it may exhibit, the datasets employed for fine-tuning, and more.
