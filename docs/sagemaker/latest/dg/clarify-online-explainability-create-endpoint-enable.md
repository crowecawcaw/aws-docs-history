...
| 'probability>`0.5`'                                 | '{"predicted_label":1,"probability":0.6}'                              | True                        | For each record, the model container outputs JSON data.<br>Explain a record if its probability is greater than 0.5.                                                                                                                                                        |
