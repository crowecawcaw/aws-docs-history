...
You can only delete an empty model group. Before you delete your model
group, remove its model versions, if any.

To delete a Model Group in the Amazon SageMaker Studio console, complete the following
...
5. From the model groups list, select the check box next to
   the name of the Model Group you want to delete.
6. Choose the vertical ellipsis above the top right corner of
   the model groups list, and choose
   **Delete**.
7. In the **Delete model group** dialog box,
   choose **Yes, delete the model
   group**.
8. Choose **Delete**.
9. Confirm that your deleted model groups no longer appear in
   your list of model groups.
...
5. In the top right corner, choose
   **Remove**.
6. In the confirmation dialog box, enter
   `REMOVE`.
7. Choose **Remove**.
