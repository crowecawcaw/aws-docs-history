...
![Amazon SageMaker Autopilot model insights regression metrics report example.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-regression-metrics.png)
...
![Amazon SageMaker Autopilot model insights multiclass classification metrics report example.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-multiclass-metrics-report.png)
...
![Amazon SageMaker Autopilot area under the receiver operating characteristic curve example.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-receiver-operating-characteristic-curve.png)
...
![Amazon SageMaker Autopilot binary confusion matrix example.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-confusion-matrix-binary.png)
...
![Amazon SageMaker Autopilot gain curve example with percentage and gain value.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-gain-curve.png)
...
![Amazon SageMaker Autopilot lift curve example with percentage and lift value.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-lift-curve.png)
...
![Autopilot example of high recall and low precision system, modelling all samples as positives.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-high-recall-low-precision.PNG)
...
![Autopilot example of high-precision and low-recall system, modeling all samples as negatives.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-high-precision-low-recall.PNG)
...
![Precision-recall curve depicts tradeoff between precision and recall at different thresholds.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-binary-precision-recall.png)
...
![Example with linear line of best fit, differing actual and predicted plot, and model error.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-actual-vs-predicted-plot.png)
...
![Amazon SageMaker Autopilot standardized residual plot example.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-standardized-residual.png)
...
![Standardized residual value close to zero, indicating that the model fits the data well.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/autopilot/autopilot-model-insights-residual-histogram.png)
