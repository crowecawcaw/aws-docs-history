...
To learn more, see [Subscribe an Endpoint to Your Amazon SNS Output Topic](sms-create-sns-input-topic.md#sms-streaming-subscribe-output-topic "sms-create-sns-input-topic.md#sms-streaming-subscribe-output-topic").
