...
- Use case 3: Deploy machine learning models at
  ...
  models at scale in production, use the AWS SDK for Python (Boto3) and AWS CloudFormation along with
