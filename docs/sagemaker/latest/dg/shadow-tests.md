...
more information on production and shadow variants, see [Validation of models in production](model-validation.md "model-validation.md").

See [Create a shadow test](shadow-tests-create.md "shadow-tests-create.md") for instructions on creating a
shadow test.
