...
- The input dataset should ensure all records are under 12 k context length,
  ...
  Rubric Judge is an enhanced LLM-as-a-judge evaluation model built on Nova 2.0 Lite.
...
Reasoning model support enables evaluation with reasoning-capable Nova models that
