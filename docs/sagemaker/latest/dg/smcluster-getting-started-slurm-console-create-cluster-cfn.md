...
- [Configure resources in the console and deploy using CloudFormation](#smcluster-getting-started-slurm-console-create-cluster-deploy-console "#smcluster-getting-started-slurm-console-create-cluster-deploy-console")
- [Configure resources and deploy using CloudFormation](#smcluster-getting-started-slurm-console-create-cluster-deploy-cfn "#smcluster-getting-started-slurm-console-create-cluster-deploy-cfn")
...
You can configure resources and deploy using the CloudFormation templates for
SageMaker HyperPod.
