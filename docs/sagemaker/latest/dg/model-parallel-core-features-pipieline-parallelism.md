...
![Example execution schedule for the interleaved pipeline over 2 GPUs.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/distributed/model-parallel/interleaved-pipeline-execution.png)
...
![Example on a pipeline running the forward pass for each microbatch before starting the backward pass.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/distributed/model-parallel/simple-pipeline-execution.png)
...
![Example of a TensorFlow graph partitioned by the model parallelism library, using automated model splitting.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/distributed/model-parallel/interleaved-pipeline-tf.png)
...
![Example of 2 subgraphs split with B=2 with gradient operations added.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/distributed/model-parallel/interleaved-pipeline-tf.gif)
