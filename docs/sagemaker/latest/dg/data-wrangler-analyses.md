...
Amazon SageMaker Data Wrangler includes built-in analyses that help you generate visualizations and data
...
the best-selling books on Amazon from 2009–2019, colored by genre.

![Example histogram chart in the Data Wrangler console.](images/studio/mohave/histogram.png)
...
histograms of user reviews of best-selling books on Amazon if faceted by year.

![Example histograms in the Data Wrangler console.](images/studio/mohave/review_by_year.png)
...
You can color scatter plots by an additional column. For example, the following
...
![Example scatter plot in the Data Wrangler console.](images/studio/mohave/scatter-plot.png)

Additionally, you can facet scatter plots by features. For example, the following
image shows an example of the same review versus user rating scatter plot, faceted by
year.

![Example faceted scatter plot in the Data Wrangler console.](images/studio/mohave/scatter-plot-facet.png)
...
![Example UI of the quick model feature in the Data Wrangler console.](images/studio/mohave/quick-model.png)
...
For example, the following image shows a target leakage report for a diabetes
...
determined to be safe from target leakage.

![Example target leakage report in the Data Wrangler console.](images/studio/mohave/target-leakage.png)
...
You can use the bias report in Data Wrangler to uncover potential biases in your data. To
generate a bias report, you must specify the target column, or
**Label**, that you want to predict and a
**Facet**, or the column that you want to inspect for
biases.

**Label**: The feature about which you want a model to
...
specify what a _positive outcome_ looks like in your
...
**Facet**: The column that you want to inspect for
...
select **Value** and specify those ages. If you want to look at an age
group, you select **Threshold** and specify the threshold of ages you
want to inspect.

After you select your feature and label, you select the types of bias metrics you want
to calculate.

To learn more, see [Generate reports for bias in
pre-training data](data-bias-reports.md "data-bias-reports.md").
...
![Example on how to add your visualization in the Data Wrangler console.](images/studio/mohave/custom-visualization.png)
