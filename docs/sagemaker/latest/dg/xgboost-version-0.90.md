...
If you are using the SageMaker Python SDK, to upgrade existing XGBoost 0.90 jobs to version 1.5, you must have version 3.x of the SDK installed and change the XGBoost `version` and `framework_version` parameters to 1.5-1. If you are using Boto3, you need to update the Docker image, and a few hyperparameters and learning objectives.

**Topics**
+ [Upgrade SageMaker AI Python SDK Version 1.x to Version 3.x](#upgrade-xgboost-version-0.90-sagemaker-python-sdk)
...
If you are still using Version 1.x of the SageMaker Python SDK, you must to upgrade version 3.x of the SageMaker Python SDK. For information on the latest version of the SageMaker Python SDK, see [Use Version 3.x of the SageMaker Python SDK](https://sagemaker.readthedocs.io/en/stable/). To install the latest version, run:
...
```
 ...
 For the full list of SageMaker Python SDK version 3.x changes, see [Use Version 3.x of the SageMaker Python SDK](https://sagemaker.readthedocs.io/en/stable/). 
