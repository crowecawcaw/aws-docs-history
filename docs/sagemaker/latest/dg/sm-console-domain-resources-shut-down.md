...
1. [View SageMaker AI resources in your domain](sm-console-domain-resources-view.md "sm-console-domain-resources-view.md")
...
3. Once the resources are selected, a shutdown option will become available at the
   ...
   For instructions on how to delete your resources per SageMaker AI feature, see [Where to shut down resources per SageMaker AI features](sm-shut-down-resources-per-feature.md "sm-shut-down-resources-per-feature.md").
