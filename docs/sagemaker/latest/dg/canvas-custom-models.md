...
| Multi-category text prediction | Predicting categories of products, such as clothing, electronics, or household goods, based on product descriptions | Source column: text<br />Target column: binary or categorical | Local upload, Amazon S3 | 
