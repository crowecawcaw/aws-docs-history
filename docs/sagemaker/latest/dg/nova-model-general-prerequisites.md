...
- An AWS account. If you don't have an AWS account, follow [these
  instructions](gs-set-up.md#sign-up-for-aws "gs-set-up.md#sign-up-for-aws") to sign up for one.
- [Installing the
...
- Familiarity of how to [train a model with
  Amazon SageMaker AI](how-it-works-training.md "how-it-works-training.md").
- Familiarity of [Amazon SageMaker HyperPod with
  EKS orchestration](sagemaker-hyperpod-eks.md "sagemaker-hyperpod-eks.md").
- Familiarity of [Amazon SageMaker HyperPod CLI](sagemaker-hyperpod-eks-run-jobs-access-nodes.md "sagemaker-hyperpod-eks-run-jobs-access-nodes.md").
- Familiarity of [Amazon Nova foundational
  models](../../../nova/latest/userguide/customization.md "../../../nova/latest/userguide/customization.md").
