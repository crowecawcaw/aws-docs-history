...
**Topics**
+ [Complete Amazon SageMaker AI prerequisites](gs-set-up.md)
+ [Use quick setup for Amazon SageMaker AI](onboard-quick-start.md)
+ [Use custom setup for Amazon SageMaker AI](onboard-custom.md)
+ [Amazon SageMaker AI domain overview](gs-studio-onboard.md)
