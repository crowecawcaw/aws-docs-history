...
1. You must first onboard to Amazon SageMaker AI domain and create a user profile. For more
...
2. If you are interacting with your Code Editor application using the AWS CLI, you must also
   ...
   2. From your local machine, run `aws configure` and provide your AWS
      credentials. For information about AWS credentials, see [Understanding
      and getting your AWS credentials](../../../general/latest/gr/aws-sec-cred-types.md "../../../general/latest/gr/aws-sec-cred-types.md").

3. (Optional) To get more storage and compute for your application, you can request an
   increase to your AWS quotas. For more information about requesting a quota increase,
   see [Amazon SageMaker AI
