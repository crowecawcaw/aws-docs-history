...
**Topics**
+ [RStudio support in SageMaker AI](#rstudio-for-r)
+ [R kernel in SageMaker AI](#r-sagemaker-kernel-ni)
+ [Example notebooks](#r-sagemaker-example-notebooks)
+ [Get started with R in SageMaker AI](r-sagemaker-get-started.md)
...
**Intermediate Level**
+ [Hyperparameter Optimization for XGBoost in R](https://sagemaker-examples.readthedocs.io/en/latest/r_examples/r_xgboost_hpo_batch_transform/r_xgboost_hpo_batch_transform.html) – This sample notebook extends the previous beginner notebooks that use the abalone dataset and XGBoost. It describes how to do model tuning with [hyperparameter optimization](https://sagemaker.readthedocs.io/en/stable/api/sagemaker_train.html). You will also learn how to use batch transform for batching predictions, as well as how to create a model endpoint to make real-time predictions.
