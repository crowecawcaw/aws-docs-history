...
**Note**  
After you finish preparing your training script, you can run a SageMaker training job using the SageMaker AI ModelTrainer class. For more information, see the previous topic at [Enable SageMaker Training Compiler](training-compiler-enable.md).