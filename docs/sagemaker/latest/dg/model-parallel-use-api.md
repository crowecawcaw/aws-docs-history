...
In all cases, you launch your training job configuring a SageMaker `TensorFlow` or `PyTorch` ModelTrainer to activate the library. To learn more, see the following topics.
