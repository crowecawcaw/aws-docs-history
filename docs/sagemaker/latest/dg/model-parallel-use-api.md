...
3. You can adapt your own Docker container to work with SageMaker AI using the [SageMaker Training
   ...
   For options 2 and 3 in the preceding list, refer to [Extend a Pre-built Docker Container that Contains SageMaker's Distributed Model Parallel Library](model-parallel-sm-sdk.md#model-parallel-customize-container "model-parallel-sm-sdk.md#model-parallel-customize-container") to learn how to install the model
...
- [Step 1: Modify Your Own Training Script Using SageMaker's Distributed Model Parallel Library](model-parallel-customize-training-script.md "model-parallel-customize-training-script.md")
- [Step 2: Launch a Training Job Using the SageMaker Python SDK](model-parallel-sm-sdk.md "model-parallel-sm-sdk.md")
