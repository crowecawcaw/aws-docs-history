...
The [Amazon SageMaker Python SDK](https://sagemaker.readthedocs.io/en/stable "https://sagemaker.readthedocs.io/en/stable") SparkML Serving model and predictor and the Amazon SageMaker AI open-source
