...
You can customize [Amazon Nova models](../../../nova/latest/userguide/what-is-nova.md "../../../nova/latest/userguide/what-is-nova.md"), including the enhanced Nova 2.0 models, through [recipes](nova-model-recipes.md#nova-model-get-recipes "nova-model-recipes.md#nova-model-get-recipes") and train them on SageMaker AI. These recipes
...
- [Limitations of customizing Amazon Nova models](nova-model-limitations.md "nova-model-limitations.md")
