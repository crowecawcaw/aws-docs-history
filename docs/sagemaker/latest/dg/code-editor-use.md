...
connections to AWS services, shut down resources, and more. After creating a Code Editor space, you
can access your Code Editor session directly through the browser.
...
- Access the SageMaker Python SDK
  You can return to Studio to review any assets created in your Code Editor environment such
  as experiments, pipelines, or training jobs.

###### Topics

- [Check the version of Code Editor](code-editor-use-version.md "code-editor-use-version.md")
- [Code Editor application instances and images](code-editor-use-instances.md "code-editor-use-instances.md")
