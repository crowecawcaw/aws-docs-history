...
3. From the dropdown menu, select **Notebook instances** to navigate to
   the **Notebook instances** page.
4. From the list of notebook instances, select your notebook instance name.
5. On the **Notebook instance settings** page, view the
   **Platform Identifier** to see the JupyterLab version of the notebook.
