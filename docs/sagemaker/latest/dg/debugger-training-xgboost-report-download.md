...
![An example of rule output.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-xgboost-report-ls.png)
...
![An example of rule output.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-xgboost-report-open-trust.png)
...
![The Find bucket by name field in the Amazon S3 console.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-report-download-s3console-0.png)
...
![The Find objects by prefix field in the Amazon S3 console.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-report-download-s3console-1.png)
...
![An example to the rule output S3 bucket URI.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-report-download-s3console-2.png)
...
![An example to the rule output S3 bucket URI.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-xgboost-report-s3-download.png)
