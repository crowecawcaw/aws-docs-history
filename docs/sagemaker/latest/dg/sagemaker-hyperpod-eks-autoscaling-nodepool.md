...
| ------------------------------------------------------ | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Instance Types<br>(`node.kubernetes.io/instance-type`) | Controls which SageMaker instance types Karpenter can choose<br>from | Instead of restricting to only ml.c5.xlarge, let Karpenter pick<br>from all available types in your instance groups       | Leave this undefined or use Exists operator to give Karpenter<br>maximum flexibility in choosing cost-effective instance types |
| Availability Zones<br>(`topology.kubernetes.io/zone`)  | Controls which AWS availability zones nodes can be created<br>in     | Specific zone names like us-east-1c. Use when you need pods to run<br>in specific zones for latency or compliance reasons | n/a                                                                                                                            |
