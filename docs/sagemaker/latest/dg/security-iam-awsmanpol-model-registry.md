...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | -------------------------------------------------------------------------------------------------- | -------------- |
| [AmazonSageMakerModelRegistryFullAccess](#security-iam-awsmanpol-model-registry-AmazonSageMakerModelRegistryFullAccess "#security-iam-awsmanpol-model-registry-AmazonSageMakerModelRegistryFullAccess")<br>• Update to an existing policy | 2       | Add `kms:CreateGrant`, `kms:DescribeKey`,<br>`kms:GenerateDataKey`, and `kms:Decrypt` permissions. | June 6, 2024   |
| AmazonSageMakerModelRegistryFullAccess<br>• New policy                                                                                                                                                                                    | 1       | Initial policy                                                                                     | April 12, 2023 |
