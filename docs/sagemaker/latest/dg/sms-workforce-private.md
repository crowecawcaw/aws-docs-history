...
**Note**  
Your private workforce is shared between Ground Truth and Amazon A2I. To create and manage private work teams used by Augmented AI, use the Ground Truth section of the SageMaker AI console. 

**Topics**
+ [Amazon Cognito Workforces](sms-workforce-private-use-cognito.md)
+ [OIDC IdP Workforces](sms-workforce-private-use-oidc.md)
+ [Private workforce management using the Amazon SageMaker API](sms-workforce-management-private-api.md)
+ [Track Worker Performance Metrics](workteam-private-tracking.md)
+ [Create the Amazon SNS topic](sms-workforce-management-private-sns.md)