...
**Topics**
+ [Construct a SageMaker AI XGBoost ModelTrainer with the Debugger XGBoost Report rule](debugger-training-xgboost-report-estimator.md)
+ [Download the Debugger XGBoost training report](debugger-training-xgboost-report-download.md)
+ [Debugger XGBoost training report walkthrough](debugger-training-xgboost-report-walkthrough.md)