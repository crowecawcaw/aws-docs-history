...
- [custom\_model\_runner\_chat\_gpt.ipnyb](https://github.com/aws/fmeval/blob/main/examples/custom_model_runner_chat_gpt.ipynb "https://github.com/aws/fmeval/blob/main/examples/custom_model_runner_chat_gpt.ipynb") – Evaluates a custom
