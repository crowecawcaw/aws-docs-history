...
see [Step 1: Create a Work Team](a2i-get-started-console.md#a2i-get-started-console-step-1 "a2i-get-started-console.md#a2i-get-started-console-step-1").
...
Cognito user pool](../../../cognito/latest/developerguide/cognito-user-identity-pools.md "../../../cognito/latest/developerguide/cognito-user-identity-pools.md"). Make sure that you have added yourself to this
user pool. You can create a private work team using the AWS SDK for Python (Boto3)
`create_workforce` function. For other language-specific
SDKs, refer to the list in [CreateWorkforce](../APIReference/API_CreateWorkforce.md#API_CreateWorkforce_SeeAlso "../APIReference/API_CreateWorkforce.md#API_CreateWorkforce_SeeAlso").
...
AWS SDK for Python (Boto3) `create_workteam` function. For other language-specific
...
in a given AWS Region in your account using the AWS SDK for Python (Boto3) `list_workteams` function. For other language-specific
...
`MaxResults`, `SortBy`, and `NameContains` to
filter your results.

## Create a Human Review Workflow

You can create a human review workflow using the Amazon A2I `CreateFlowDefinition` operation. Before you create your human
review workflow, you need to create a human task UI. You can do this with the
`CreateHumanTaskUi` operation.
...
integration. This template is used in this [notebook](<https://github.com/aws-samples/amazon-a2i-sample-jupyter-notebooks/blob/master/Amazon%20Augmented%20AI%20(A2I)%20and%20Comprehend%20DetectSentiment.ipynb> "https://github.com/aws-samples/amazon-a2i-sample-jupyter-notebooks/blob/master/Amazon%20Augmented%20AI%20(A2I)%20and%20Comprehend%20DetectSentiment.ipynb"), demonstrating a custom integration with
Amazon Comprehend.
...
AWS SDK for Python (Boto3) `create_human_task_ui` function. For other
...
`Mail address`) in the document. If Amazon Textract's
...
thresholds for the `Suggestive` and `Female Swimwear
 Or Underwear` moderation labels.
...
other language-specific SDKs, refer to the list in [CreateFlowDefinition](../APIReference/API_CreateFlowDefinition.md#API_CreateFlowDefinition_SeeAlso "../APIReference/API_CreateFlowDefinition.md#API_CreateFlowDefinition_SeeAlso"). Use the tabs in the following table to see
...
specify `"AWS/Textract/AnalyzeDocument/Forms/V1"` for
`"AwsManagedHumanLoopRequestSource"` in
...
for `"AwsManagedHumanLoopRequestSource"` in
`HumanLoopRequestSource`.
...
- If you use the Amazon Textract built-in integration, you use the [AnalyzeDocument](../../../textract/latest/dg/API_AnalyzeDocument.md "../../../textract/latest/dg/API_AnalyzeDocument.md") operation.
- If you use the Amazon Rekognition built-in integration, you use the [DetectModerationLabels](../../../rekognition/latest/dg/API_DetectModerationLabels.md "../../../rekognition/latest/dg/API_DetectModerationLabels.md") operation.
- If you use a custom integration, you use the [StartHumanLoop](../../../augmented-ai/2019-11-07/APIReference/API_StartHumanLoop.md "../../../augmented-ai/2019-11-07/APIReference/API_StartHumanLoop.md") operation.
...
human review workflow. You can check the `response` element
to determine if a human loop has been created. To see everything
included in this response, see [`HumanLoopActivationOutput`](../../../textract/latest/dg/API_HumanLoopActivationOutput.md "../../../textract/latest/dg/API_HumanLoopActivationOutput.md").
...
human review workflow. You can check the `response` element
to determine if a human loop has been created. To see everything
included in this response, see [`HumanLoopActivationOutput`](../../../rekognition/latest/dg/API_HumanLoopActivationOutput.md "../../../rekognition/latest/dg/API_HumanLoopActivationOutput.md").
...
The keys `initialValue` and `taskObject` must
correspond to the keys used in the liquid elements of the worker task
template. Refer to the custom template in [Create a Human Task UI](#a2i-get-started-api-worker-task-template "#a2i-get-started-api-worker-task-template") to see an
example.

To create `inputContentJson`, do
the following:
