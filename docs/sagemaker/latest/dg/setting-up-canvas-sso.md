...
1. Choose **Edit** and specify the following:
   + SAML 2.0
   + **Default Relay State** – https://{{Region}}.console.aws.amazon.com/sagemaker/home?region={{Region}}\#/studio/canvas/open/{{StudioId}}. You can find the Studio Classic ID in the console: [https://console.aws.amazon.com/sagemaker/](https://console.aws.amazon.com/sagemaker/)
