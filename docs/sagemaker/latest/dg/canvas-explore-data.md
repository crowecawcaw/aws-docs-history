...
You can only use SageMaker Canvas visualizations and analytics for models built on tabular datasets.
...
analytics and create in-application visualizations and
