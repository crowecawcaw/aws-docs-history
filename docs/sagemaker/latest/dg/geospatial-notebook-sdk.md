...
| `config` | Dictionary<br />config = { label: <string> custom label of the added AoI layer, default AoI } | An option to pass layer properties. | 
...
| --- | --- | --- | 
| `Arn` | String | The ARN of the job. | 
| `time_range_filter` | Dictionary<br />time\_range\_filter = {<br />start\_date: <string> date in ISO format<br />end\_date: <string> date in ISO format<br />} | An option to provide the start and end time. Defaults to the raster data collection search start and end date. | 
| `config` | Dictionary<br />config = { label: <string> custom label of the added output layer, default Input } | An option to pass layer properties. | 
