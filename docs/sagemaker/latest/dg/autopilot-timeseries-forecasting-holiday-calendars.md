...
useful in the retail domain, where public holidays can significantly affect demand. The following
...
Autopilot provides native support for the public holiday calendars of the following
countries. Use the **Country Code** when specifying a country
with the API.
