...
![Endpoints list page showing the View in SageMaker Insights button.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/SageMaker Observability/Observability_Enabled_page.png)


**From the Endpoint detail page:** Click **View in SageMaker Insights** to open the dashboard filtered to that endpoint.

![Endpoint detail page showing the View in SageMaker Insights button.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/SageMaker Observability/Endpoint_detail_page.png)
...
![Inference component detail page showing the View in SageMaker Insights button.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/SageMaker Observability/IC_Detaild_page.png)
...
![SageMaker Insights dashboard header with summary bar showing Invocations, Instances, Inference Components, and Avg AZ Skew.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/SageMaker Observability/New_Insights_Dashbaord.png)
