...
![Ranking mechanism, parameter distribution, and associated AllReduce operations of tensor parallelism.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/distributed/model-parallel/tensor-parallel-ranking-mechanism.png)
