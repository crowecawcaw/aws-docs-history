...
If you disable it, you won't be able to collect output tensors and cannot debug your model parameters.
  ...
  For more information about the Debugger-specific parameters, see [SageMaker AI Estimator](https://sagemaker.readthedocs.io/en/stable/api/sagemaker_train.html) in the [Amazon SageMaker Python SDK](https://sagemaker.readthedocs.io/en/stable).
