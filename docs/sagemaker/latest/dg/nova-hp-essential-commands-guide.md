...
Your logs are available in your AWS account that contains the hyperpod cluster under
...
- Once you're in the log group, you can find your specific log using the node instance
  ...
  - `i-00b3d8a1bf25714e4` here represents the hyperpod friendly machine
...
- If you don't see your job scheduled, double check if the output of your
  HyperPod CLI has this section with job names and other metadata. If not,
