...
12. (Optional) To view your feature groups, choose **My
    account**. To view shared feature groups, choose
    **Cross account**.
13. Under the **Feature Group Catalog** tab, choose
    **My account** to view your feature groups.
14. Under the **Feature Group Catalog** tab, choose
    **Cross account** to view feature groups that
    others made discoverable to you. Under **Created by**,
    you can view the resource owner account ID.
...
You can also use python SDK of AWS RAM APIs to create resource share. The API
signature is given below. To use python SDK of AWS RAM API, you need attach AWS RAM
full access managed policy with execution Role.
