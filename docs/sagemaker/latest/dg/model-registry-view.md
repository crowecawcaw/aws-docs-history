...
Model Group you created in [Create a Model Group (Boto3)](model-registry-model-group.md#model-registry-package-group-api "model-registry-model-group.md#model-registry-package-group-api").
