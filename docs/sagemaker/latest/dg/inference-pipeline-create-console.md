...
![The page for creating a model for an Inference Pipeline.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/create-pipeline-model.png)
...
![Creating a pipeline model with containers.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/create-pipeline-model-containers.png)
...
![The summary of container settings for the pipeline model.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/pipeline-MyInferencePipelinesModel-recap.png)