...
For more in-depth examples, see *[Property File](https://sagemaker.readthedocs.io/en/stable/api/sagemaker_mlops.html#property-file)* in the [Amazon SageMaker Python SDK](https://sagemaker.readthedocs.io/en/stable).