...
![Gif showing how to create a text classification labeling job in the SageMaker AI console.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/sms/gifs/single-label-text.gif)
