...
| --- | --- | 
| num\_topics | The number of topics for LDA to find within the data.<br />**Required**<br />Valid values: positive integer | 
| feature\_dim | The size of the vocabulary of the input document corpus.<br />**Required**<br />Valid values: positive integer | 
| mini\_batch\_size | The total number of documents in the input document corpus.<br />**Required**<br />Valid values: positive integer | 
| alpha0 | Initial guess for the concentration parameter: the sum of the elements of the Dirichlet prior. Small values are more likely to generate sparse topic mixtures and large values (greater than 1.0) produce more uniform mixtures. <br />**Optional**<br />Valid values: Positive float<br />Default value: 1.0 | 
