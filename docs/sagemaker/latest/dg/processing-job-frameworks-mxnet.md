...
The following code example shows how you can use the `MXNetProcessor` to run your Processing job using a Docker
...
the `MXNetProcessor` class, see [MXNet Estimator](https://sagemaker.readthedocs.io/en/stable/frameworks/mxnet/sagemaker.mxnet.html#mxnet-estimator "https://sagemaker.readthedocs.io/en/stable/frameworks/mxnet/sagemaker.mxnet.html#mxnet-estimator") in the _Amazon SageMaker Python SDK_.
