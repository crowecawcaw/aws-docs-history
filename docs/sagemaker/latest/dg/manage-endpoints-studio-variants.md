...
![Screenshot of an endpoint's main page showing multiple models deployed.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/inference/studio-goldfinch-multi-model-endpoint.png)
