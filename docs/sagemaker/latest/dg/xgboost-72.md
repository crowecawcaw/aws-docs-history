...
| ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `num_class`              | The number of classes.<br>*_Required_<br>• if<br>`objective` is set to<br>*multi:softmax<br>• or<br>_multi:softprob_.<br>Valid values: integer                                                                                                                                                                                                                                                                                                                                                                               |
...
| `normalize_type`         | Type of normalization algorithm.<br>**Optional**<br>Valid values: Either *tree<br>• or<br>_forest_.<br>Default value: _tree_                                                                                                                                                                                                                                                                                                                                                                                                 |
