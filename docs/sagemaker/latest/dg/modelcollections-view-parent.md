...
To view the Collections which contain a particular Model Group, complete the
...
4. Immediately below the **Registered models**
   ...
   selected already.
5. View the **Collection** column for your Model
   Group, which displays the name of the Collection which contains
   this Model Group. If multiple Collections contain this Model
   Group, choose the **Collection** column entry
   to display a pop-up listing the Collections which contain this
   Model Group.
...
6. View the **Collection** column for your Model
   Group, which displays the name of the Collection which contains
   this Model Group. If multiple Collections contain this Model
   Group, choose the **Collection** column entry
   to display a pop-up listing the Collections which contain this
