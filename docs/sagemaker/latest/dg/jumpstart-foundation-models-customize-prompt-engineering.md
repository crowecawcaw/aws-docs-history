...
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `max_new_tokens`    | The maximum output length of a foundation model<br>response. Valid values: integer, range: Positive<br>integer.                                                                                                                                                                                                                                                     |
| `temperature`       | Controls the randomness in the output. Higher<br>temperature results in an output sequence with<br>low-probability words and lower temperature results in<br>output sequence with high-probability words. If<br>`temperature=0`, the response is made up of<br>only the highest probability words (greedy decoding). Valid<br>values: float, range: Positive float. |
