...
[Preparing data for
fine-tuning Understanding models](../../../nova/latest/userguide/fine-tune-prepare-data-understanding.md "../../../nova/latest/userguide/fine-tune-prepare-data-understanding.md").
...
an SFT job on a HyperPod cluster. This recipe also assumes that you have
