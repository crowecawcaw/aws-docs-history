...
**Topics**
+ [Feature Store Spark installation](#batch-ingestion-spark-connector-installation)
+ [Retrieving the JAR for Feature Store Spark](#retrieve-jar-spark-connector)
+ [Example implementations](#batch-ingestion-spark-connector-example-implementations)
