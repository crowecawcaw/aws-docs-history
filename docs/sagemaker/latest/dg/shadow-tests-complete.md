...
early. After your test has completed, the test’s status in the **Shadow tests** section on the
**Shadow tests** page shows as **Complete**. Then you can review and analyze
...
information about analyzing the metrics dashboard of your test, see [Monitor a shadow test](shadow-tests-view-monitor-edit-dashboard.md "shadow-tests-view-monitor-edit-dashboard.md").

For instructions on how to complete your test before the end of its scheduled completion time, see [Complete a shadow test early](#shadow-tests-complete-early "#shadow-tests-complete-early").

For instructions on promoting your shadow variant to production, see [Promote a shadow variant](#shadow-tests-complete-promote "#shadow-tests-complete-promote").
...
1. Select the test you want to mark complete from the **Shadow tests** section on the
   **Shadow tests** page.
...
4. (Optional) In the **Comment** text box, enter your reason for completing the
   test before its scheduled end time.
5. 1. If you decided to deploy the shadow variant, choose **Complete and proceed to
      deploy**. The **Deploy shadow variant** page appears. For
      instructions on how to fill out this page, see [Promote a shadow variant](#shadow-tests-complete-promote "#shadow-tests-complete-promote").
...
before its scheduled end, follow the instructions in [Complete a shadow test early](#shadow-tests-complete-early "#shadow-tests-complete-early") before continuing with this section.
...
1. If your test has completed, do the following:
   ...
   2. From the **Actions** dropdown list, choose **View**. The
      dashboard appears.
   3. Choose **Deploy shadow variant** in the **Environment**
      section. The **Deploy shadow variant** page appears.
