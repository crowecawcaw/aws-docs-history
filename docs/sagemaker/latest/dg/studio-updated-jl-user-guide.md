...
**Topics**
+ [Create a space](studio-updated-jl-user-guide-create-space.md)
+ [Configure a space](studio-updated-jl-user-guide-configure-space.md)
+ [Customize your environment using a package manager](studio-updated-jl-user-guide-customize-package-manager.md)
+ [Clean up a conda environment](studio-updated-jl-clean-up-conda.md)
+ [Share conda environments between instance types](studio-updated-jl-create-conda-share-environment.md)
+ [Using a coding assistant to expedite your machine learning workflows](studio-updated-jl-coding-assistant.md)
+ [Use Amazon Q to Expedite Your Machine Learning Workflows](studio-updated-jl-user-guide-use-amazon-q.md)