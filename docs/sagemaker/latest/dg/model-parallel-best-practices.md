...
| 60 billion                     | 32 `ml.p4d.24xlarge` | 2                    | 8                  | True                     | Each transformer layer   | True            | `batch_size=56`, `microbatches=4`,<br>`active_microbatches=2` |
...
- To launch a training job faster, use the [SageMaker AI local mode](https://sagemaker.readthedocs.io/en/v2.199.0/overview.html?highlight=local%20mode#local-mode "https://sagemaker.readthedocs.io/en/v2.199.0/overview.html?highlight=local%20mode#local-mode"). This helps you quickly run a training job locally
  ...
  your model by changing the model configurations, such as the hidden width, number of
  transformer layers, and attention heads. Validate if the reduced model runs well
...
To run a SageMaker training job with model parallelism or the [SageMaker distributed training example notebooks](https://sagemaker-examples.readthedocs.io/en/latest/training/distributed_training/index.html "https://sagemaker-examples.readthedocs.io/en/latest/training/distributed_training/index.html"), make sure you have the right
