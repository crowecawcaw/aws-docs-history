...
1. In the upper-left corner of the Code Editor UI, choose the menu button (![Hamburger menu icon with three horizontal lines.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/code-editor/code-editor-menu-icon.png)). Then, choose **Help**. Then, choose **About**.