...
Amazon SageMaker JumpStart onboards and maintains publicly available foundation models for you to access, customize, and integrate into your machine learning lifecycles. Amazon SageMaker JumpStart also includes proprietary foundation models from third-party providers. For a complete list of available models, see [Available foundation models](jumpstart-foundation-models-latest.md).
