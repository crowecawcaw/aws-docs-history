...
Execute the evaluation job using the provided notebook: [Nova model evaluation notebook](nova-model-evaluation.md#nova-model-evaluation-notebook "nova-model-evaluation.md#nova-model-evaluation-notebook") 4. **Monitor progress**
