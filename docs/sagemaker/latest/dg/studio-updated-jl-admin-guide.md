...
**Topics**
+ [Give your users access to spaces](studio-updated-jl-admin-guide-permissions.md)
+ [Change the default storage size for your JupyterLab users](studio-updated-jl-admin-guide-storage-size.md)
+ [Lifecycle configurations with JupyterLab](jl-lcc.md)
+ [Git repos in JupyterLab](studio-updated-jl-admin-guide-git-attach.md)
+ [Custom images](studio-updated-jl-admin-guide-custom-images.md)
+ [Update the SageMaker Distribution Image](studio-updated-jl-update-distribution-image.md)
+ [Delete unused resources](studio-updated-jl-admin-guide-clean-up.md)
