...
more information, see [Create and attach lifecycle configurations in Studio](code-editor-use-lifecycle-configurations-studio-create.md "code-editor-use-lifecycle-configurations-studio-create.md"). 4. Create your Code Editor application with the lifecycle configuration attached:
...
more information about connections and extensions, see [Code Editor Connections and Extensions](code-editor-use-connections-and-extensions.md "code-editor-use-connections-and-extensions.md").
