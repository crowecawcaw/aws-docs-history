...
For large jobs, using the [Hyperband](automatic-model-tuning-how-it-works.md#automatic-tuning-hyperband "automatic-model-tuning-how-it-works.md#automatic-tuning-hyperband") tuning strategy can reduce computation time. Hyperband has an early
...
training jobs using less runtime, use either [random search](automatic-model-tuning-how-it-works.md#automatic-tuning-random-search "automatic-model-tuning-how-it-works.md#automatic-tuning-random-search") or [Bayesian optimization](automatic-model-tuning-how-it-works.md#automatic-tuning-bayesian-optimization.title "automatic-model-tuning-how-it-works.md#automatic-tuning-bayesian-optimization.title").
...
Bayesian optimization cannot massively scale.

Use random search to run a large number of parallel jobs. In random search, subsequent
jobs do not depend on the results from prior jobs and can be run independently. Compared to
other strategies, random search is able to run the largest number of parallel jobs.

Use [grid search](automatic-model-tuning-how-it-works.md#automatic-tuning-grid-search "automatic-model-tuning-how-it-works.md#automatic-tuning-grid-search") to reproduce results of a tuning job, or if simplicity and
...
Although you can simultaneously specify up to 30 hyperparameters, limiting your search
