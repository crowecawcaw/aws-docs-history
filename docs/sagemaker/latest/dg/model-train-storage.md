...
![An example of how SageMaker AI maps paths between the training job container and the storage when you run a training job using the SageMaker Python SDK ModelTrainer class and its train method.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/sagemaker-training-storage.png)
