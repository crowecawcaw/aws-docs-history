...
![The UI controller in the SageMaker Debugger Insights dashboard.](http://docs.aws.amazon.com/sagemaker/latest/dg/images/debugger/debugger-insights-graph-controller.png)
