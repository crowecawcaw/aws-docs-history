...
![Two GPUs running model training steps in parallel, with data feeding each step and checkpoints saved periodically.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/hyperpod/hyperpod-checkpointless-optimization-tracks.png)
