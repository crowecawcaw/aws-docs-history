...
**Topics**
+ [Sharded data parallelism](#model-parallel-intro-sdp-v2)
+ [Expert parallelism](#model-parallel-intro-expert-parallelism-v2)
+ [Tensor parallelism](#model-parallel-intro-tp-v2)
+ [Activation checkpointing and offloading](#model-parallel-intro-activation-offloading-checkpointing-v2)
+ [Choosing the right techniques for your model](#model-parallel-intro-choosing-techniques-v2)
