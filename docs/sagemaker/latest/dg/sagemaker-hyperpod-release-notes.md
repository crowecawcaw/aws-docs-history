...
**Improvements**
+ HyperPod now properly supports passing partition names provided through `provisioning_parameters.json` and creates partitions appropriately based on provided inputs. For more information about `provisioning_parameters.json`, see [Legacy configuration: provisioning\_parameters.json](sagemaker-hyperpod-ref.md#sagemaker-hyperpod-ref-provisioning-forms) and [Customizing SageMaker HyperPod clusters using lifecycle scripts](sagemaker-hyperpod-lifecycle-best-practices-slurm.md).
