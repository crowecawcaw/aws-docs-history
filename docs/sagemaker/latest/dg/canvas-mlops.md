...
After building a model in SageMaker Canvas that you feel confident about, you might want to integrate your model with the
machine learning operations (MLOps) processes in your organization. MLOps includes common tasks such as deploying a
model for use in production or setting up continuous integration and continuous deployment (CI/CD) pipelines.
...
- [Invoke your endpoint](canvas-deploy-model-invoke.md "canvas-deploy-model-invoke.md")
- [Delete a model deployment](canvas-deploy-model-delete.md "canvas-deploy-model-delete.md")
