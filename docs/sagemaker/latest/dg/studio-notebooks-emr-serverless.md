...
**Topics**
+ [Prerequisites](#studio-set-up-emr-serverless-prerequisites)
+ [Set up the permissions to enable listing and launching Amazon EMR applications from SageMaker Studio](studio-emr-serverless-permissions.md)
+ [Create EMR Serverless applications from Studio](create-emr-serverless-application.md)
+ [Connect to an EMR Serverless application from Studio](connect-emr-serverless-application.md)
+ [Stop or delete an EMR Serverless application from the Studio UI](terminate-emr-serverless-application.md)