...
**Tip**  
To learn more about how to specify your VPC configuration to SageMaker AI ModelTrainers, see [Use File Systems as Training Inputs](https://sagemaker.readthedocs.io/en/stable/) in the *SageMaker AI Python SDK documentation*.