...
selection, fine-tuning, model evaluation, and model deployment with options for
Amazon SageMaker AI and Amazon Bedrock, according to Amazon SageMaker AI best practices. You can describe your use
case and preferred workflow in natural language to your coding assistant which,
guided by Amazon SageMaker AI skills, outputs code constructs that handle the invocation and
orchestration of Amazon SageMaker AI APIs and MCP tools.

Amazon SageMaker AI skills are distributed as an open-source agent plugin through the AWS
Agent Plugins GitHub repository, maintained by AWSLabs. By adhering to the standard
