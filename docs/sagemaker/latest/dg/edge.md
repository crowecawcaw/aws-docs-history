...
1. **Read the [Getting Started](edge-manager-getting-started.md "edge-manager-getting-started.md") section** - This
   ...
   your first fleet.
2. **Explore Edge Manager Jupyter notebook examples** - Example notebooks are stored in the [amazon-sagemaker-examples](https://github.com/aws/amazon-sagemaker-examples "https://github.com/aws/amazon-sagemaker-examples") GitHub repository in the [sagemaker\_edge\_manager](https://github.com/aws/amazon-sagemaker-examples/tree/master/sagemaker_edge_manager "https://github.com/aws/amazon-sagemaker-examples/tree/master/sagemaker_edge_manager") folder.
