...
**Note**  
To use model cards with the SageMaker Python SDK, you first need to establish a SageMaker AI Session. For more information, see [Session](https://sagemaker.readthedocs.io/en/stable/api/sagemaker_core.html) in the SageMaker Python SDK API reference.
