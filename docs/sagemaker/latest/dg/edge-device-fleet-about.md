...
The Edge Manager agent is an inference engine for your edge devices. Use the agent to
make predictions with models loaded onto your edge devices. The agent also collects model
metrics and captures data at specific intervals. Sample data is stored in your Amazon S3
bucket.
