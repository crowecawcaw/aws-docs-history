...
If you have followed instructions in [Deploy a Model](neo-deployment-hosting-services.md "neo-deployment-hosting-services.md"), you should have a SageMaker AI endpoint set
