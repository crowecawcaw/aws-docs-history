...
+ To build numeric prediction, 2 category prediction, or 3\+ category prediction models, see [Build a custom numeric or categorical prediction model](#canvas-build-model-numeric-categorical).
