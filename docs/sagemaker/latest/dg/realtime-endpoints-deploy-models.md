...
1. Call `deploy()` to deploy the model to an endpoint.
...
Once you have an endpoint configuration, use the [create\_endpoint](https://docs.aws.amazon.com/boto3/latest/reference/services/sagemaker/client/create_endpoint.html) method to create your endpoint. The endpoint name must be unique within an AWS Region in your AWS account. 
...
Once you have your model and endpoint configuration, use the [create\_endpoint](https://docs.aws.amazon.com/boto3/latest/reference/services/sagemaker/client/create_endpoint.html) method to create your endpoint. The endpoint name must be unique within an AWS Region in your AWS account. 
