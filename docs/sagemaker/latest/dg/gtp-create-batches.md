...
![The intake form to create a batch using Amazon SageMaker Ground Truth Plus.](images/gtp-create-batch.png)
...
3. Enter the **Batch name**, **Batch description**, **S3 location for input datasets**, and
   **S3 location for output datasets**.
4. Choose **Submit**.
