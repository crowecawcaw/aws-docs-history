...
- [Plot the system metrics and framework metrics data](debugger-access-data-profiling-default-plot.md "debugger-access-data-profiling-default-plot.md")
- [Access the profiling data using the pandas data parsing tool](debugger-access-data-profiling-pandas-frame.md "debugger-access-data-profiling-pandas-frame.md")
- [Access the Python profiling stats data](debugger-access-data-python-profiling.md "debugger-access-data-python-profiling.md")
- [Merge timelines of multiple profile trace files](debugger-merge-timeline.md "debugger-merge-timeline.md")
