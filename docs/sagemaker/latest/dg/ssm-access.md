...
+  `sagemaker-endpoint:{{endpoint-name}}_{{variant-name}}_{{ec2-instance-id}}` for containers on single container endpoints 
+  `sagemaker-endpoint:{{endpoint-name}}_{{variant-name}}_{{ec2-instance-id}}_{{container-name}}` for containers on multi-container endpoints 
