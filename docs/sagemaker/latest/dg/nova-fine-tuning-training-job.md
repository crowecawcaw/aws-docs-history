...
Fine-tuning Amazon Nova models with SageMaker training jobs offers a powerful way to customize foundation
models for your specific use cases.

###### Topics

- [Prerequisites](#nova-model-training-jobs-prerequisites "#nova-model-training-jobs-prerequisites")
- [Data preparation](#nova-model-training-prepare-data "#nova-model-training-prepare-data")
- [Full-rank SFT and LoRA PEFT
  configurations](#nova-model-training-jobs-recipe-config "#nova-model-training-jobs-recipe-config")
- [Running customized Nova model on
  SageMaker training jobs](#nova-model-training-jobs-notebook "#nova-model-training-jobs-notebook")
- [Hyperparameter optimization guidance](#nova-model-hyperparameter "#nova-model-hyperparameter")
