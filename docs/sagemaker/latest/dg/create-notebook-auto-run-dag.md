...
retrieve information from prior steps, see [Pass information to and from your notebook step](create-notebook-auto-run-dag-seq.md "create-notebook-auto-run-dag-seq.md").
...
another notebook, see [Invoke another notebook in your notebook job](create-notebook-auto-run-dag-call.md "create-notebook-auto-run-dag-call.md").
