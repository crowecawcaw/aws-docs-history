...
1. Choose the plus icon (**\+**) next to the join or concatenate node that you want to delete.
...
![Screenshot of a data flow in Data Wrangler showing the delete join view.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/studio/canvas/canvas-data-flow-delete-step.png)
