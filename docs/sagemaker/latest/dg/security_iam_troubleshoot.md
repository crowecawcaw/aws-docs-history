...
- [I am not authorized to perform an action in SageMaker AI](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
- [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole "#security_iam_troubleshoot-passrole")
- [I want to allow people outside of my AWS account to access my SageMaker AI resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
- To learn whether SageMaker AI supports these features, see [How Amazon SageMaker AI works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
