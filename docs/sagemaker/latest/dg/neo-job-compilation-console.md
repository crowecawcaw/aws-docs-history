...
![Create a compilation job.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/8-create-compilation-job.png)

1. On the **Create compilation job** page, under **Job name**, enter a name. Then select an **IAM role**.  
![Create compilation job page.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/9-create-compilation-job-config.png)

1. If you don’t have an IAM role, choose **Create a new role**.  
![Create IAM role location.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/10a-create-iam-role.png)

1. On the **Create an IAM role** page, choose **Any S3 bucket**, and choose **Create role**.  
![Create IAM role page.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/10-create-iam-role.png)
...
![Input configuration page.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/neo-create-compilation-job-input-config.png)
...
![Example Input configuration section showing where to choose the Framework version.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/compile_console_pytorch.png)
...
![Example Output Configuration section.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/neo_compilation_console_pytorch_compiler_options.png)
...
![Output configuration page.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/neo-console-output-config.png)
...
![Compilation job status.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/12-run-model-compilation.png)
...
![Compilation job status.](https://docs.aws.amazon.com/sagemaker/latest/dg/images/neo/12a-completed-model-compilation.png)