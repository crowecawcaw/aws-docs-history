...
The output data is the result of your labeling job. The output data file, or _augmented manifest file_, contains label data for each object
you send to the labeling job and metadata about the label assigned to data objects.

When you use image classification (single and multi-label), text classification (single
...
- [Video Frame Input Data](sms-video-frame-input-data-overview.md "sms-video-frame-input-data-overview.md")
- [Labeling job output data](sms-data-output.md "sms-data-output.md")
