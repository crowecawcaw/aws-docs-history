...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.4.0   | inference\_graviton     | CPU             | py311           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.3.0   | inference\_graviton     | CPU             | py311           |
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-training:`<tag>`           | 2.3.0   | training                | CPU, GPU        | py311           |
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.2.1   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.1.0   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.0.1   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.0.0   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/pytorch-inference-graviton:`<tag>` | 1.12.1  | inference\_graviton     | CPU             | py38            |
...
| 737474898029.dkr.ecr.sa-east-1.amazonaws.com/sagemaker-scikit-learn:`<tag>` | 1.0-1   | 1.0.2           | inference\_graviton     |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.16.1  | inference\_graviton     | CPU             | py310           |
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference:`<tag>`             | 2.14.1  | inference               | CPU, GPU        | -               |
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.14.1  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.13.0  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.12.1  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.sa-east-1.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.9.1   | inference\_graviton     | CPU             | py38            |
...
| 737474898029.dkr.ecr.sa-east-1.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.5-1   | 1.5.2           | inference\_graviton     |
...
| 737474898029.dkr.ecr.sa-east-1.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.3-1   | 1.3.3           | inference\_graviton     |
