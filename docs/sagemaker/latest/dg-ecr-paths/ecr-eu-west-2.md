...
- [AutoGluon (algorithm)](#autogluon-eu-west-2 "#autogluon-eu-west-2")
- [BlazingText (algorithm)](#blazingtext-eu-west-2 "#blazingtext-eu-west-2")
- [Chainer (DLC)](#chainer-eu-west-2 "#chainer-eu-west-2")
- [Clarify (algorithm)](#clarify-eu-west-2 "#clarify-eu-west-2")
- [DJL DeepSpeed (algorithm)](#djl-deepspeed-eu-west-2 "#djl-deepspeed-eu-west-2")
- [Data Wrangler (algorithm)](#data-wrangler-eu-west-2 "#data-wrangler-eu-west-2")
- [Debugger (algorithm)](#debugger-eu-west-2 "#debugger-eu-west-2")
- [DeepAR Forecasting (algorithm)](#forecasting-deepar-eu-west-2 "#forecasting-deepar-eu-west-2")
- [Factorization Machines (algorithm)](#factorization-machines-eu-west-2 "#factorization-machines-eu-west-2")
- [Hugging Face (algorithm)](#huggingface-eu-west-2 "#huggingface-eu-west-2")
- [IP Insights (algorithm)](#ipinsights-eu-west-2 "#ipinsights-eu-west-2")
- [Image classification (algorithm)](#image-classification-eu-west-2 "#image-classification-eu-west-2")
- [Inferentia MXNet (DLC)](#inferentia-mxnet-eu-west-2 "#inferentia-mxnet-eu-west-2")
- [Inferentia PyTorch (DLC)](#inferentia-pytorch-eu-west-2 "#inferentia-pytorch-eu-west-2")
- [K-Means (algorithm)](#kmeans-eu-west-2 "#kmeans-eu-west-2")
- [KNN (algorithm)](#knn-eu-west-2 "#knn-eu-west-2")
- [LDA (algorithm)](#lda-eu-west-2 "#lda-eu-west-2")
- [Linear Learner (algorithm)](#linear-learner-eu-west-2 "#linear-learner-eu-west-2")
- [MXNet (DLC)](#mxnet-eu-west-2 "#mxnet-eu-west-2")
- [MXNet Coach (DLC)](#coach-mxnet-eu-west-2 "#coach-mxnet-eu-west-2")
- [Model Monitor (algorithm)](#model-monitor-eu-west-2 "#model-monitor-eu-west-2")
- [NTM (algorithm)](#ntm-eu-west-2 "#ntm-eu-west-2")
- [Neo Image Classification (algorithm)](#image-classification-neo-eu-west-2 "#image-classification-neo-eu-west-2")
- [Neo MXNet (DLC)](#neo-mxnet-eu-west-2 "#neo-mxnet-eu-west-2")
- [Neo PyTorch (DLC)](#neo-pytorch-eu-west-2 "#neo-pytorch-eu-west-2")
- [Neo Tensorflow (DLC)](#neo-tensorflow-eu-west-2 "#neo-tensorflow-eu-west-2")
- [Neo XGBoost (algorithm)](#xgboost-neo-eu-west-2 "#xgboost-neo-eu-west-2")
- [Object Detection (algorithm)](#object-detection-eu-west-2 "#object-detection-eu-west-2")
- [Object2Vec (algorithm)](#object2vec-eu-west-2 "#object2vec-eu-west-2")
- [PCA (algorithm)](#pca-eu-west-2 "#pca-eu-west-2")
- [PyTorch (DLC)](#pytorch-eu-west-2 "#pytorch-eu-west-2")
- [PyTorch Training Compiler (DLC)](#pytorch-training-compiler-eu-west-2 "#pytorch-training-compiler-eu-west-2")
- [Random Cut Forest (algorithm)](#randomcutforest-eu-west-2 "#randomcutforest-eu-west-2")
- [Ray PyTorch (DLC)](#ray-pytorch-eu-west-2 "#ray-pytorch-eu-west-2")
- [Scikit-learn (algorithm)](#sklearn-eu-west-2 "#sklearn-eu-west-2")
- [Semantic Segmentation (algorithm)](#semantic-segmentation-eu-west-2 "#semantic-segmentation-eu-west-2")
- [Seq2Seq (algorithm)](#seq2seq-eu-west-2 "#seq2seq-eu-west-2")
- [Spark (algorithm)](#spark-eu-west-2 "#spark-eu-west-2")
- [SparkML Serving (algorithm)](#sparkml-serving-eu-west-2 "#sparkml-serving-eu-west-2")
- [Tensorflow (DLC)](#tensorflow-eu-west-2 "#tensorflow-eu-west-2")
- [Tensorflow Coach (DLC)](#coach-tensorflow-eu-west-2 "#coach-tensorflow-eu-west-2")
- [Tensorflow Inferentia (DLC)](#inferentia-tensorflow-eu-west-2 "#inferentia-tensorflow-eu-west-2")
- [Tensorflow Ray (DLC)](#ray-tensorflow-eu-west-2 "#ray-tensorflow-eu-west-2")
- [VW (algorithm)](#vw-eu-west-2 "#vw-eu-west-2")
- [XGBoost (algorithm)](#xgboost-eu-west-2 "#xgboost-eu-west-2")
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.4.0   | inference\_graviton     | CPU             | py311           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.3.0   | inference\_graviton     | CPU             | py311           |
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-training:`<tag>`           | 2.3.0   | training                | CPU, GPU        | py311           |
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.2.1   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.1.0   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.0.1   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 2.0.0   | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/pytorch-inference-graviton:`<tag>` | 1.12.1  | inference\_graviton     | CPU             | py38            |
...
| 764974769150.dkr.ecr.eu-west-2.amazonaws.com/sagemaker-scikit-learn:`<tag>` | 1.0-1   | 1.0.2           | inference\_graviton     |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.16.1  | inference\_graviton     | CPU             | py310           |
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference:`<tag>`             | 2.14.1  | inference               | CPU, GPU        | -               |
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.14.1  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.13.0  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.12.1  | inference\_graviton     | CPU             | py310           |
...
| 763104351884.dkr.ecr.eu-west-2.amazonaws.com/tensorflow-inference-graviton:`<tag>`    | 2.9.1   | inference\_graviton     | CPU             | py38            |
...
| 764974769150.dkr.ecr.eu-west-2.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.5-1   | 1.5.2           | inference\_graviton     |
...
| 764974769150.dkr.ecr.eu-west-2.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.3-1   | 1.3.3           | inference\_graviton     |
