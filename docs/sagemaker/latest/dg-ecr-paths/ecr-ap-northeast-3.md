...
| 364406365360.dkr.ecr.ap-northeast-3.amazonaws.com/djl-inference:0.19.0-deepspeed0.7.3-cu113-`<tag>`  | 0.19.0  | inference               |
...
| 913387583493.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-data-wrangler-container:`<tag>` | 1.x     | processing              |
...
| Registry path                                                                        | Version | Job types (image scope) |
| ------------------------------------------------------------------------------------ | ------- | ----------------------- |
| 102471314380.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-spark-processing:`<tag>` | 3.3     | processing              |
| 102471314380.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-spark-processing:`<tag>` | 3.2     | processing              |
| 102471314380.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-spark-processing:`<tag>` | 3.1     | processing              |
| 102471314380.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-spark-processing:`<tag>` | 3.0     | processing              |
| 102471314380.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-spark-processing:`<tag>` | 2.4     | processing              |
...
| Registry path                                                                       | Version | Job types (image scope) |
| ----------------------------------------------------------------------------------- | ------- | ----------------------- |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-sparkml-serving:`<tag>` | 3.3     | inference               |
...
| Registry path                                                               | Version | Package version | Job types (image scope) |
| --------------------------------------------------------------------------- | ------- | --------------- | ----------------------- |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.7-1   | 1.7.4           | inference               |
...
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.0-1   | 1.0.0           | inference               |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 1.0-1   | 1.0.0           | training                |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/xgboost:`<tag>`           | 1       | 0.72            | inference               |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/xgboost:`<tag>`           | 1       | 0.72            | training                |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 0.90-2  | 0.90            | inference               |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 0.90-2  | 0.90            | training                |
| 867004704886.dkr.ecr.ap-northeast-3.amazonaws.com/sagemaker-xgboost:`<tag>` | 0.90-1  | 0.90            | inference               |
