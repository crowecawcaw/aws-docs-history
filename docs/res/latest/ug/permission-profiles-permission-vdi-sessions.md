...
![non-admin users without permissions have the launch new virtual desktop button disabled](https://docs.aws.amazon.com/res/latest/ug/images/res-nonadmin-vdi-disabled.png)
...
![Non-admin pop-out window for session management](https://docs.aws.amazon.com/res/latest/ug/images/res-nonadmin-link-displayed.png)
...
![the sessions management link is hidden from non-admin users without permission to create sessions for others](https://docs.aws.amazon.com/res/latest/ug/images/res-nonadmin-hidden-link.png)
