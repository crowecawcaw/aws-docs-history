...
![Shared desktop sessions](https://docs.aws.amazon.com/res/latest/ug/images/res-shareddesktops.jpg)
...
**Topics**
+ [Share a desktop](desktop-sharing.md)
+ [Access a shared desktop](access-shared-desktop.md)