...
![Actions menu with Schedule option](https://docs.aws.amazon.com/res/latest/ug/images/virtual-desktop-options.png)

1. Choose **Reset**.  
![Schedule dialog with Reset option](https://docs.aws.amazon.com/res/latest/ug/images/reset-schedules.png)
