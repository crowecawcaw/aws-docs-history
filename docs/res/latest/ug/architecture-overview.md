...
| [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/")                                         | Core       | Supports product functionalities such as updating settings within the DynamoDB<br>table, starting Active Directory sync workflows, and updating the prefix list.      |
