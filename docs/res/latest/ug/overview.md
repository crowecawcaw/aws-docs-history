...
This User Guide covers the current release (2025.09) of Research and Engineering Studio on AWS. For previous
...
Administrators can create virtual collaboration spaces called projects for a specific set of users
...
This guide provides an overview of Research and Engineering Studio on AWS, its reference
architecture and components, considerations for planning the deployment, and configuration steps
for deploying RES to the Amazon Web Services (AWS) Cloud.
