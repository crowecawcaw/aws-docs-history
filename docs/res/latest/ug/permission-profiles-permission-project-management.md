...
![Team configurations pop-out window](https://docs.aws.amazon.com/res/latest/ug/images/res-update-project-membership.png)
...
![Admin console projects window under environment management](https://docs.aws.amazon.com/res/latest/ug/images/res-update-project-status.png)
