...
ASG settings can be customized within the Amazon EC2 console at [https://console.aws.amazon.com/ec2/](https://console.aws.amazon.com/ec2/ "https://console.aws.amazon.com/ec2/"). The product
creates four ASGs by default with each name ending with `-asg`. You can
