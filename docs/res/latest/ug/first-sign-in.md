...
After the product stack deploys in your account, you receive an email with your
credentials. Use the URL to sign in to your account and configure the workspace for other
users.

![First sign in email invitation](images/res-firstsignin.png)
After you sign in for the first time, you can configure settings in the web portal
