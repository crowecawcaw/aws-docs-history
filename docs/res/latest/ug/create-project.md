...
The shared home filesystem, EFS, FSx for Lustre, and
...
You can also onboard multiple volumes from a single FSx NetApp ONTAP file system.

![Create a new project with resource configurations](images/res-create-new-project.png) 5. Assign users, groups, or both the appropriate role ("Project Member" or "Project
