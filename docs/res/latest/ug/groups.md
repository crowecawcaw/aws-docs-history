...
1. When a user group is selected, use the **Actions** menu to disable or enable a group. 

1. When a user group is selected, you can expand the **Users** pane at the bottom of the screen to view users in the group. 