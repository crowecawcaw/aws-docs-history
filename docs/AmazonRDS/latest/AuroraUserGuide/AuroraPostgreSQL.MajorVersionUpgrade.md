...
logical replication, see [Replication with Amazon Aurora PostgreSQL](AuroraPostgreSQL.Replication.md "AuroraPostgreSQL.Replication.md").
...
about using logical replication on an Aurora host, see [Setting up logical replication for your Aurora PostgreSQL DB cluster](AuroraPostgreSQL.Replication.Logical.Configure.md "AuroraPostgreSQL.Replication.Logical.Configure.md").
