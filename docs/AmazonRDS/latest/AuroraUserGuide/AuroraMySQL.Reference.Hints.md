...
In Aurora MySQL version 8.4, you can use all the hints that are available in MySQL Community Edition 8.4. For more information about these hints, see [Optimizer Hints](https://dev.mysql.com/doc/refman/8.4/en/optimizer-hints.html) in the *MySQL Reference Manual*.
