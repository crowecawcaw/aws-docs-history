...
- [Overview of auto-pause](#auto-pause-overview "#auto-pause-overview")
- [Prerequisites and Limitations](#auto-pause-prereqs "#auto-pause-prereqs")
- [Turning auto-pause on and off](#auto-pause-enabling-disabling "#auto-pause-enabling-disabling")
- [How auto-pause works](#auto-pause-how-it-works "#auto-pause-how-it-works")
- [Auto-pause and Aurora cluster configurations](#auto-pause-topology "#auto-pause-topology")
- [Monitoring auto-pause](#auto-pause-monitoring "#auto-pause-monitoring")
- [Troubleshooting for auto-pause](#auto-pause-troubleshooting "#auto-pause-troubleshooting")
- [Application design for auto-pause](#auto-pause-applications "#auto-pause-applications")
...
- For the full list of engine versions and AWS Regions where this feature is available, see
  [Supported Regions and Aurora DB engines for Aurora serverless](Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.md "Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.md").
...
information, see [Situations where Aurora serverless doesn't auto-pause](#auto-pause-whynot "#auto-pause-whynot").
...
- [Turning on auto-pause](#auto-pause-enabling "#auto-pause-enabling")
- [Auto-pause timeout interval](#auto-pause-timeout "#auto-pause-timeout")
- [Resuming an instance](#auto-pause-waking "#auto-pause-waking")
- [Turning off auto-pause](#auto-pause-disabling "#auto-pause-disabling")

### Turning on auto-pause for Aurora serverless instances in a cluster

Follow the procedure in
[Setting the Aurora serverless capacity range for a cluster](aurora-serverless-v2-administration.md#aurora-serverless-v2-setting-acus "aurora-serverless-v2-administration.md#aurora-serverless-v2-setting-acus"). For
...
- [How auto-pause works](#auto-pause-pausing "#auto-pause-pausing")
- [How auto-resume works](#auto-pause-resuming "#auto-pause-resuming")
- [CPU billing](#auto-pause-billing "#auto-pause-billing")
...
- [Aurora cluster layouts](#auto-pause-recommended-layouts "#auto-pause-recommended-layouts")
- [Auto-pause for the writer instance](#auto-pause-writer "#auto-pause-writer")
- [Auto-pause for multi-AZ clusters and reader instances](#auto-pause-multi-az "#auto-pause-multi-az")
- [Auto-pause for mixed clusters](#auto-pause-provisioned "#auto-pause-provisioned")
...
[Monitoring Amazon Aurora metrics with Amazon CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md") and the CloudWatch metrics listed in
[Metrics reference for Amazon Aurora](metrics-reference.md "metrics-reference.md"). Be aware that there are some special
...
- You can check whether Aurora serverless instances are pausing more or less frequently than you expect. To
  ...
  see [Prerequisites and Limitations for the Aurora serverless auto-pause feature](#auto-pause-prereqs "#auto-pause-prereqs"),
  [Situations where Aurora serverless doesn't auto-pause](#auto-pause-whynot "#auto-pause-whynot"), and
  [Troubleshooting for Aurora serverless auto-pause](#auto-pause-troubleshooting "#auto-pause-troubleshooting").
- You can also examine a log file that records automatic pause and resume operations for an
  ...
  [Monitoring Aurora serverless pause and resume activity](aurora-serverless-v2-administration.md#autopause-logging-instance-log "aurora-serverless-v2-administration.md#autopause-logging-instance-log").

###### Topics

- [Checking for paused instances](#auto-pause-status "#auto-pause-status")
- [Auto-pause and auto-resume events](#auto-pause-events "#auto-pause-events")
- [Performance Insights and Enhanced Monitoring](#auto-pause-pi-em "#auto-pause-pi-em")
- [Aurora metrics](#auto-pause-metrics "#auto-pause-metrics")
...
- Confirm that the cluster isn't using any of the incompatible features or settings from
  [Prerequisites and Limitations for the Aurora serverless auto-pause feature](#auto-pause-prereqs "#auto-pause-prereqs").
...
[Situations where Aurora serverless doesn't auto-pause](#auto-pause-whynot "#auto-pause-whynot").
