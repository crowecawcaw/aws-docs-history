...
- [ALTER TABLE](#limitless-reference.DDL-limitations.ALTER_TABLE "#limitless-reference.DDL-limitations.ALTER_TABLE")
- [CREATE DATABASE](#limitless-reference.DDL-limitations.CREATE_DATABASE "#limitless-reference.DDL-limitations.CREATE_DATABASE")
- [CREATE INDEX](#limitless-reference.DDL-limitations.CREATE_INDEX "#limitless-reference.DDL-limitations.CREATE_INDEX")
- [CREATE SCHEMA](#limitless-reference.DDL-limitations.CREATE_SCHEMA "#limitless-reference.DDL-limitations.CREATE_SCHEMA")
- [CREATE TABLE](#limitless-reference.DDL-limitations.CREATE_TABLE "#limitless-reference.DDL-limitations.CREATE_TABLE")
- [CREATE TABLE AS](#limitless-reference.DDL-limitations.CREATE_TABLE_AS "#limitless-reference.DDL-limitations.CREATE_TABLE_AS")
- [DROP DATABASE](#limitless-reference.DDL-limitations.DROP_DATABASE "#limitless-reference.DDL-limitations.DROP_DATABASE")
- [SELECT INTO](#limitless-reference.DDL-limitations.SELECT_INTO "#limitless-reference.DDL-limitations.SELECT_INTO")
- [Constraints](#limitless-reference.DDL-limitations.Constraints "#limitless-reference.DDL-limitations.Constraints")
- [Default values](#limitless-reference.DDL-limitations.DefaultValues "#limitless-reference.DDL-limitations.DefaultValues")
- [Extensions](#limitless-reference.DDL-limitations.Extensions "#limitless-reference.DDL-limitations.Extensions")
- [Foreign keys](#limitless-reference.DDL-limitations.FKs "#limitless-reference.DDL-limitations.FKs")
- [Functions](#limitless-reference.DDL-limitations.Functions "#limitless-reference.DDL-limitations.Functions")
- [Sequences](#limitless-reference.DDL-limitations.Sequences "#limitless-reference.DDL-limitations.Sequences")

## ALTER TABLE

The `ALTER TABLE` command is generally supported in Aurora PostgreSQL Limitless Database. For more information, see [ALTER TABLE](https://www.postgresql.org/docs/current/sql-altertable.html "https://www.postgresql.org/docs/current/sql-altertable.html") in the PostgreSQL documentation.
...
For details on what isn't supported, see [Constraints](#limitless-reference.DDL-limitations.Constraints "#limitless-reference.DDL-limitations.Constraints").

**Changing a column's default value**

Default values are supported. For more information, see [Default values](#limitless-reference.DDL-limitations.DefaultValues "#limitless-reference.DDL-limitations.DefaultValues").
...
For more information, see [UNIQUE](#unique-constraint "#unique-constraint"). For general information on creating indexes, see [CREATE INDEX](https://www.postgresql.org/docs/current/sql-createindex.html "https://www.postgresql.org/docs/current/sql-createindex.html") in the PostgreSQL documentation.
...
sharded tables, you must also use the `rds_aurora.limitless_create_table_shard_key` variable. For more information, see [Creating limitless tables by using variables](limitless-creating-config.md "limitless-creating-config.md").
...
For general information, see [CREATE TABLE AS](https://www.postgresql.org/docs/current/sql-createtableas.html "https://www.postgresql.org/docs/current/sql-createtableas.html") in the
...
`SELECT INTO` is functionally similar to [CREATE TABLE AS](#limitless-reference.DDL-limitations.CREATE_TABLE_AS "#limitless-reference.DDL-limitations.CREATE_TABLE_AS"). You must use the `rds_aurora.limitless_create_table_mode`
...
[Creating limitless tables by using variables](limitless-creating-config.md "limitless-creating-config.md").
...
For general information, see [SELECT INTO](https://www.postgresql.org/docs/current/sql-selectinto.html "https://www.postgresql.org/docs/current/sql-selectinto.html") in the PostgreSQL
documentation.
...
For more information, see [Foreign keys](#limitless-reference.DDL-limitations.FKs "#limitless-reference.DDL-limitations.FKs").
...
For more information on creating sharded and reference tables, see [Creating Aurora PostgreSQL Limitless Database tables](limitless-creating.md "limitless-creating.md").
...
For more information, see [Constraints](https://www.postgresql.org/docs/current/ddl-constraints.html "https://www.postgresql.org/docs/current/ddl-constraints.html") in the PostgreSQL
documentation.
...
For more information, see [Default values](https://www.postgresql.org/docs/current/ddl-default.html "https://www.postgresql.org/docs/current/ddl-default.html") in the PostgreSQL
documentation.
...
more information, see [Importing data from Amazon S3 into an Aurora PostgreSQL DB cluster](USER_PostgreSQL.md "USER_PostgreSQL.md") and [Exporting data from an Aurora PostgreSQL DB cluster to Amazon S3](postgresql-s3-export.md "postgresql-s3-export.md").
...
- `pgstattuple` – This extension behaves differently in Aurora PostgreSQL Limitless Database from community PostgreSQL. For more information, see
  [pgstattuple differences in Aurora PostgreSQL Limitless Database](#limitless-reference.DDL-limitations.Extensions.pgstattuple "#limitless-reference.DDL-limitations.Extensions.pgstattuple").
- `pgvector`
...
For more information, see [CREATE EXTENSION](https://www.postgresql.org/docs/current/sql-createextension.html "https://www.postgresql.org/docs/current/sql-createextension.html")
...
For more information, see [ALTER EXTENSION](https://www.postgresql.org/docs/current/sql-alterextension.html "https://www.postgresql.org/docs/current/sql-alterextension.html") in
...
For more information, see [DROP EXTENSION](https://www.postgresql.org/docs/current/sql-dropextension.html "https://www.postgresql.org/docs/current/sql-dropextension.html") in
the PostgreSQL documentation.
...
In Aurora PostgreSQL, the [pgstattuple](https://www.postgresql.org/docs/current/pgstattuple.html "https://www.postgresql.org/docs/current/pgstattuple.html") extension currently
...
- [Foreign key options](#limitless-reference.DDL-limitations.FKs.options "#limitless-reference.DDL-limitations.FKs.options")
- [Examples](#limitless-reference.DDL-limitations.FKs.examples "#limitless-reference.DDL-limitations.FKs.examples")
...
For more information, see [CREATE FUNCTION](https://www.postgresql.org/docs/current/sql-createfunction.html "https://www.postgresql.org/docs/current/sql-createfunction.html") in
the PostgreSQL documentation.
...
For more information, see [ALTER FUNCTION](https://www.postgresql.org/docs/current/sql-alterfunction.html "https://www.postgresql.org/docs/current/sql-alterfunction.html") in
the PostgreSQL documentation.
...
For more information, see [DROP FUNCTION](https://www.postgresql.org/docs/current/sql-dropfunction.html "https://www.postgresql.org/docs/current/sql-dropfunction.html") in the
PostgreSQL documentation.

###### Topics

- [Function distribution](#limitless-function-distribution "#limitless-function-distribution")
- [Function volatility](#limitless-function-volatility "#limitless-function-volatility")
...
and incorrect results. For more information on function volatility, see [Function volatility categories](https://www.postgresql.org/docs/current/xfunc-volatility.html "https://www.postgresql.org/docs/current/xfunc-volatility.html") in the PostgreSQL
documentation.
...
For more information on sequences, see [CREATE SEQUENCE](https://www.postgresql.org/docs/current/sql-createsequence.html "https://www.postgresql.org/docs/current/sql-createsequence.html") in
the PostgreSQL documentation.

###### Topics

- [Requesting a new chunk](#limitless-reference.DDL-limitations.Sequences.request-chunk "#limitless-reference.DDL-limitations.Sequences.request-chunk")
- [Limitations](#limitless-reference.DDL-limitations.Sequences.limitations "#limitless-reference.DDL-limitations.Sequences.limitations")
- [Unsupported options](#limitless-reference.DDL-limitations.Sequences.unsupported "#limitless-reference.DDL-limitations.Sequences.unsupported")
- [Examples](#limitless-reference.DDL-limitations.Sequences.examples "#limitless-reference.DDL-limitations.Sequences.examples")
- [Sequence views](#limitless-reference.DDL-limitations.Sequences.views "#limitless-reference.DDL-limitations.Sequences.views")
- [Troubleshooting sequence issues](#limitless-reference.DDL-limitations.Sequences.troubleshooting "#limitless-reference.DDL-limitations.Sequences.troubleshooting")
...
The `setval` function isn't supported. For more information, see [Sequence Manipulation Functions](https://www.postgresql.org/docs/current/functions-sequence.html "https://www.postgresql.org/docs/current/functions-sequence.html") in the
PostgreSQL documentation.
...
For more information, see [CREATE SEQUENCE](https://www.postgresql.org/docs/current/sql-createsequence.html "https://www.postgresql.org/docs/current/sql-createsequence.html")
in the PostgreSQL documentation.
...
For more information, see [ALTER SEQUENCE](https://www.postgresql.org/docs/current/sql-altersequence.html "https://www.postgresql.org/docs/current/sql-altersequence.html")
in the PostgreSQL documentation.
...
![Wait events caused by sequence issues.](images/limitless_sequence_waits.png)
