...
8. Wait until **Instance state** for your instance is **Running** before continuing. 9. Complete [Create an Amazon Aurora DB cluster](CHAP_Tutorials.WebServerDB.CreateDBCluster.md "CHAP_Tutorials.WebServerDB.CreateDBCluster.md").
