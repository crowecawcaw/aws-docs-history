...
Amazon Aurora in `stderr` (standard error) format, as specified in `log_destination`
...
to do so, see [Parameter groups for Amazon Aurora](USER_WorkingWithParamGroups.md "USER_WorkingWithParamGroups.md").
