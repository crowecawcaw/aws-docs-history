...
+  **db.serverless** – A special DB instance class type used by Aurora serverless. Aurora adjusts the compute, memory, and network resources dynamically as the workload changes. For usage details, see [Using Aurora serverless](aurora-serverless-v2.md). 
