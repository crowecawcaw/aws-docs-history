...
- [Considerations for custom endpoints in Amazon Aurora](Aurora.Endpoints.Custom.Considerations.md "Aurora.Endpoints.Custom.Considerations.md")
...
- [AWS CLI examples for custom endpoints for Amazon Aurora](Aurora.Endpoint.Tutorial.md "Aurora.Endpoint.Tutorial.md")
