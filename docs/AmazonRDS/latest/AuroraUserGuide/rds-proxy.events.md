...
- To learn how to configure Amazon Aurora to send events to EventBridge, see [Creating a rule that triggers on an Amazon Aurora event](rds-cloud-watch-events.md "rds-cloud-watch-events.md").
