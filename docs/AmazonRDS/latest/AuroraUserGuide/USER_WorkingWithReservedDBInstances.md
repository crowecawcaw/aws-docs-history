...
![Applying a reserved DB instance in full to smaller DB instances.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/ri-db-instance-flex-full.png)
...
![Applying a reserved DB instance in part to a larger DB instance.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/ri-db-instance-flex-partial.png)
...
| db.r6g.12xlarge | 5 | 5 \* 1.3 = 6.5 | 1.5 \* db.r6g.12xlarge | One each of db.r6g.12xlarge, r6g.4xlarge, and r6g.2xlarge<br />(0.5 \* db.r6g.12xlarge = 1 \* db.r6g.4xlarge \+ 1 \* db.r6g.2xlarge ) | 
| db.r6i.24xlarge | 15 | 15 \* 1.3 = 19.5 | 4.5 \* db.r6i.24xlarge | 4 \* db.r6i.24xlarge \+ 1 \* db.r6i.12xlarge<br />(0.5 \* db.r6i.24xlarge = 1 \* db.r6i.12xlarge) | 
