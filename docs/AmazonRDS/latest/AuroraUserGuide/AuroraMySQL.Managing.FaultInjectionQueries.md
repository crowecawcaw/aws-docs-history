...
Running fault injection queries requires all of the master user privileges. For more information, see [Master user account privileges](UsingWithRDS.MasterAccounts.md "UsingWithRDS.MasterAccounts.md").
...
- `DISK index` — A
  ...
  For more information, see [Displaying volume status for an Aurora MySQL DB cluster](AuroraMySQL.Managing.VolumeStatus.md "AuroraMySQL.Managing.VolumeStatus.md").
- `NODE index` — A
  ...
  information, see [Displaying volume status for an Aurora MySQL DB cluster](AuroraMySQL.Managing.VolumeStatus.md "AuroraMySQL.Managing.VolumeStatus.md").
- `quantity` — The
