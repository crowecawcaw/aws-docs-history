...
**io/redo\_log\_flush**  
A session is persisting data to Aurora storage. Typically, this wait event is for a write I/O operation in Aurora MySQL. For more information, see [io/redo\_log\_flush](ams-waits.io-redologflush.md).
