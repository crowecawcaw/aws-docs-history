...
operation in Aurora MySQL. For more information, see [io/aurora_redo_log_flush](ams-waits.io-auredologflush.md "ams-waits.io-auredologflush.md").
...
this wait is prominent, see [io/aurora_respond_to_client](ams-waits.respond-to-client.md "ams-waits.respond-to-client.md").
...
Aurora MySQL. For more information, see [io/redo_log_flush](ams-waits.io-redologflush.md "ams-waits.io-redologflush.md").

**io/socket/sql/client_connection**

The `mysqld` program is busy creating threads to handle incoming new client connections.
For more information, see [io/socket/sql/client_connection](ams-waits.client-connection.md "ams-waits.client-connection.md").
...
more information, see [synch/cond/innodb/row_lock_wait](ams-waits.row-lock-wait.md "ams-waits.row-lock-wait.md").

**synch/cond/innodb/row_lock_wait_cond**

Multiple DML statements are accessing the same database rows at the same time. For more information, see [synch/cond/innodb/row_lock_wait_cond](ams-waits.row-lock-wait-cond.md "ams-waits.row-lock-wait-cond.md").
...
the MySQL documentation. To learn how to tune your database when this event is prominent, see [synch/cond/sql/MDL_context::COND_wait_status](ams-waits.cond-wait-status.md "ams-waits.cond-wait-status.md").
...
Multiple DML statements are accessing the same database rows at the same time. For more information, see [synch/mutex/innodb/aurora_lock_thread_slot_futex](ams-waits.waitsynch.md "ams-waits.waitsynch.md").

**synch/mutex/innodb/buf_pool_mutex**

The buffer pool isn't large enough to hold the working data set. Or the workload accesses pages
from a specific table, which leads to contention in the buffer pool. For more information, see [synch/mutex/innodb/buf_pool_mutex](ams-waits.bufpoolmutex.md "ams-waits.bufpoolmutex.md").

**synch/mutex/innodb/fil_system_mutex**

The process is waiting for access to the tablespace memory cache. For more information, see [synch/mutex/innodb/fil_system_mutex](ams-waits.innodb-fil-system-mutex.md "ams-waits.innodb-fil-system-mutex.md").
...
event. For more information, see [synch/mutex/innodb/trx_sys_mutex](ams-waits.trxsysmutex.md "ams-waits.trxsysmutex.md").
