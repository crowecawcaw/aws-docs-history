...
| --- | --- | --- | --- | --- | 
| aurora\_fwd\_writer\_idle\_timeout | Cluster | Unsigned integer | 60 | 1–86,400 | 
| aurora\_fwd\_writer\_max\_connections\_pct | Cluster | Unsigned long integer | 10 | 0–90 | 
| aurora\_replica\_read\_consistency | Cluster or instance | Enum | '' (null) | EVENTUAL, SESSION, GLOBAL | 
...
You can use the `information_schema.aurora_forwarding_processlist` table to identify forwarded transactions and queries. For more information on this table, see [information\_schema.aurora\_forwarding\_processlist](AuroraMySQL.Reference.ISTables.md#AuroraMySQL.Reference.ISTables.aurora_forwarding_processlist).
