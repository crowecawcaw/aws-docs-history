...
- [Using Amazon Aurora for Disaster Recovery with your MySQL databases](#AuroraMySQL.BestPractices.DisasterRecovery "#AuroraMySQL.BestPractices.DisasterRecovery")
...
- [Avoiding slow performance, automatic restart, and failover for Aurora MySQL DB instances](#AuroraMySQL.BestPractices.Avoiding "#AuroraMySQL.BestPractices.Avoiding")
...
classes and their specifications, see [Amazon AuroraDB instance classes](Concepts.DBInstanceClass.md "Concepts.DBInstanceClass.md").
