...
The following message will be reported in the PostgreSQL log file after the connection is terminated, when a transaction is in the idle\_in\_transaction state for longer than the specified time.
...
![In pgadmin, choose AUTOCOMMIT to turn it on.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/apg-insight-pgadmin-autocommit.png)
