...
- [Finding the writer and reader instances for an Aurora cluster](#USER_Reboot.Examples.IsClusterWriter "#USER_Reboot.Examples.IsClusterWriter")
- [Rebooting a single reader instance](#USER_Reboot.Examples.RebootReader "#USER_Reboot.Examples.RebootReader")
- [Rebooting the writer instance](#USER_Reboot.Examples.RebootWriter "#USER_Reboot.Examples.RebootWriter")
- [Rebooting the writer and readers independently](#USER_Reboot.Examples.RebootAsynch "#USER_Reboot.Examples.RebootAsynch")
- [Applying a cluster parameter change to an Aurora MySQL version 2.10 cluster](#USER_Reboot.Examples.ParamChangeNewStyle "#USER_Reboot.Examples.ParamChangeNewStyle")
