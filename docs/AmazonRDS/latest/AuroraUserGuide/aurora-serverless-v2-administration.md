...
- [Setting the Aurora serverless capacity range for a cluster](#aurora-serverless-v2-setting-acus "#aurora-serverless-v2-setting-acus")
- [Checking the capacity range for Aurora serverless](#aurora-serverless-v2-checking-capacity "#aurora-serverless-v2-checking-capacity")
- [Checking the platform version for an existing Aurora serverless cluster](#aurora-serverless-v2-checking-platform-version "#aurora-serverless-v2-checking-platform-version")
- [Adding an Aurora serverless reader](#aurora-serverless-v2-adding-reader "#aurora-serverless-v2-adding-reader")
- [Converting a provisioned writer or reader to Aurora serverless](#aurora-serverless-v2-converting-from-provisioned "#aurora-serverless-v2-converting-from-provisioned")
- [Converting an Aurora serverless writer or reader to provisioned](#aurora-serverless-v2-converting-to-provisioned "#aurora-serverless-v2-converting-to-provisioned")
- [Pausing Aurora serverless DB instances](#pause-when-inactive "#pause-when-inactive")
- [Choosing the promotion tier for an Aurora serverless reader](#aurora-serverless-v2-choosing-promotion-tier "#aurora-serverless-v2-choosing-promotion-tier")
- [Using TLS/SSL with Aurora serverless](#aurora-serverless-v2.tls "#aurora-serverless-v2.tls")
- [Viewing Aurora serverless writers and readers](#aurora-serverless-v2.viewing "#aurora-serverless-v2.viewing")
- [Logging for Aurora serverless](#aurora-serverless-v2.logging "#aurora-serverless-v2.logging")
...
For more information on making sure that your Aurora serverless DB clusters can scale up to 256 ACUs, see [Upgrading your Aurora serverless DB cluster to allow scaling to 256 ACUs](#setting-256-acus "#setting-256-acus").
...
procedures, see
[Creating an Aurora serverless writer DB instance](aurora-serverless-v2.create.md#aurora-serverless-v2-adding-writer "aurora-serverless-v2.create.md#aurora-serverless-v2-adding-writer"),
[Adding an Aurora serverless reader](#aurora-serverless-v2-adding-reader "#aurora-serverless-v2-adding-reader"), and
[Converting a provisioned writer or reader to Aurora serverless](#aurora-serverless-v2-converting-from-provisioned "#aurora-serverless-v2-converting-from-provisioned").
...
![Cluster with multiple Aurora serverless reader DB instances.](images/serverless_v2_screencaps/serverless_v2_capacity_settings_identical_all_instances_in_tree_view.png)
...
5. In the **Capacity range** section, choose the following:
   ...
   ![Modifying the DB cluster capacity.](images/sv2_capacity_settings_256_acus.png)
...
during the next scheduled maintenance window. 8. Choose **Modify cluster** to accept the summary of modifications. You can also choose
...
[ModifyDBCluster](../APIReference/API_ModifyDBCluster.md "../APIReference/API_ModifyDBCluster.md") API operation. Specify the
...
![Cluster details for multiple Aurora serverless DB instances.](images/serverless_v2_screencaps/serverless_v2_capacity_settings_identical_all_instances_in_tree_view.png)
...
[Adding Aurora Replicas to a DB cluster](aurora-replicas-adding.md "aurora-replicas-adding.md"). Choose the **Serverless
...
![Instance configuration user interface for Aurora serverless.](images/serverless_v2_screencaps/serverless_v2_capacity_settings_settable_for_add_reader_modify_instance.png)
...
![Capacity settings for Aurora serverless shown in Add reader interface.](images/serverless_v2_screencaps/serverless_v2_capacity_settings_fixed_for_add_reader_modify_instance.png)
...
requirements in
[Requirements and limitations for Aurora serverless](aurora-serverless-v2.requirements.md "aurora-serverless-v2.requirements.md"). For
...
![Capacity range information panel.](images/serverless_v2_screencaps/serverless_v2_capacity_settings_fixed_for_add_reader_modify_instance.png)
...
[Viewing an Amazon Aurora DB cluster](accessing-monitoring.md#Aurora.Viewing "accessing-monitoring.md#Aurora.Viewing"). A cluster might contain all Aurora serverless
...
- [Viewing Aurora serverless logs in Amazon CloudWatch](#aurora-serverless-v2.logging.monitoring "#aurora-serverless-v2.logging.monitoring")
...
- [Monitoring Aurora serverless pause and resume activity](#autopause-logging-instance-log "#autopause-logging-instance-log")

### Logging with Amazon CloudWatch

After you use the procedure in
[Logging for Aurora serverless](#aurora-serverless-v2.logging "#aurora-serverless-v2.logging") to choose which
...
- **background activity**: A broad category that includes all the reasons why
  ...
  [Resuming an auto-paused Aurora serverless instance](aurora-serverless-v2-auto-pause.md#auto-pause-waking "aurora-serverless-v2-auto-pause.md#auto-pause-waking").
