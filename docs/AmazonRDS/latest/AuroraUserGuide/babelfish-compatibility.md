...
with T-SQL functionality and behavior, as shown in the [Supported functionalities in Babelfish by version](babelfish-compatibility.md "babelfish-compatibility.md") table. For
...
Babelfish for the latest version. To learn more, see [T-SQL differences in Babelfish](babelfish-compatibility.tsql.md "babelfish-compatibility.tsql.md").
...
- [T-SQL differences in Babelfish](babelfish-compatibility.tsql.md "babelfish-compatibility.tsql.md")
