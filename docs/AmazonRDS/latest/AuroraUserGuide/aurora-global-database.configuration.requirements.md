...
+ **Capacity requirements for Aurora serverless** – For a global database with Aurora serverless, the [minimum recommended capacity](aurora-serverless-v2.setting-capacity.md#aurora-serverless-v2.min_capacity_considerations) for the DB cluster in the primary AWS Region is 8 ACUs.
