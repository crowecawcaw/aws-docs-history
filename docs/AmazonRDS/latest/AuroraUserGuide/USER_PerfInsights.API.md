...
Amazon CloudWatch Database Insights monitors your Amazon Aurora cluster so that you can analyze and troubleshoot database performance. One way to view Database Insights data is in the AWS Management Console. Performance Insights also provides a public API so that you can query your own data. You can use the API to do the following:
