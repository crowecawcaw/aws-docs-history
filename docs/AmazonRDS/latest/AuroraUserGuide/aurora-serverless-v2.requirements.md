...
- [Clusters that use Aurora serverless must have a capacity range specified](#aurora-serverless-v2.requirements.capacity-range "#aurora-serverless-v2.requirements.capacity-range")
- [Incompatible scaling configuration](#aurora-serverless-v2.requirements.incompatible-scaling-config "#aurora-serverless-v2.requirements.incompatible-scaling-config")
- [Some provisioned features aren't supported in Aurora serverless](#aurora-serverless-v2.limitations "#aurora-serverless-v2.limitations")
...
[Setting the Aurora serverless capacity range for a cluster](aurora-serverless-v2-administration.md#aurora-serverless-v2-setting-acus "aurora-serverless-v2-administration.md#aurora-serverless-v2-setting-acus"). For a
...
- If reducing the database parameters is not an option, follow
  ...
  above in: [New scaling configuration is incompatible with workload](#aurora-serverless-v2.requirements.incompatible-scaling-config.workload "#aurora-serverless-v2.requirements.incompatible-scaling-config.workload").
