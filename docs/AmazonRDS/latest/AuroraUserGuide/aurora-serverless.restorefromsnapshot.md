...
- **Timeout action** – The action to take when a capacity modification times out
  ...
  [Timeout action for capacity changes](aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action "aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action").
...
- **Timeout action** – The action to take when a
  ...
  **Force scaling the capacity to the specified values...** option.
  ...
  more information, see [Timeout action for capacity changes](aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action "aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action").
