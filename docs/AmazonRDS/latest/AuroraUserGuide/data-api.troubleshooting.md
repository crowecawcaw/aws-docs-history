...
For information about running transactions, see [Calling the Amazon RDS Data API](data-api.calling.md "data-api.calling.md").
...
- The Aurora DB cluster doesn't support Data API.
  ...
  see [Region and version availability for the Amazon RDS Data API](data-api.regions.md "data-api.regions.md").
- Data API isn't enabled for the Aurora DB cluster. To use Data API
  ...
  information about enabling Data API, see [Enabling the Amazon RDS Data API](data-api.enabling.md "data-api.enabling.md").
