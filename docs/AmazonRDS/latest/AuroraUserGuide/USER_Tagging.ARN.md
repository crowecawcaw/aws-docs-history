...
For global cluster resources, the ARN doesn't include an AWS Region:
`arn:aws:rds::`<account
 number>`:global-cluster:`<name>``.
ARNs for global clusters don't appear in the AWS Management Console.
...
| Global cluster                | arn:aws:rds::`<account>`:global-cluster:`<name>`<br>For example:<br>``<br>arn:aws:rds::`123456789012`:global-cluster:`my-aurora-global-cluster-1`<br>``                                          |
