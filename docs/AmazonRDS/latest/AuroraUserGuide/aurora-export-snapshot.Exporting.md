...
chosen S3 bucket, or create a new role.
    ...
    * If you created a role by following the steps in [Providing access to an Amazon S3 bucket using an IAM role](aurora-export-snapshot.Setup.md#aurora-export-snapshot.SetupIAMRole "aurora-export-snapshot.Setup.md#aurora-export-snapshot.SetupIAMRole"), choose that
     role.
