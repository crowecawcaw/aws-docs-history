...
| DB cluster | arn:aws:rds:{{<region>}}:{{<account>}}:cluster:{{<name>}}<br />For example:<pre>arn:aws:rds:{{us-east-2}}:{{123456789012}}:cluster:{{my-aurora-cluster-1}}</pre> | 
...
| Reserved DB instance  | arn:aws:rds:{{<region>}}:{{<account>}}:ri:{{<name>}}<br />For example:<pre>arn:aws:rds:{{us-east-2}}:{{123456789012}}:ri:{{my-reserved-postgresql}}</pre> | 
| DB security group  | arn:aws:rds:{{<region>}}:{{<account>}}:secgrp:{{<name>}}<br />For example:<pre>arn:aws:rds:{{us-east-2}}:{{123456789012}}:secgrp:{{my-public}}</pre> | 
| Automated DB snapshot | arn:aws:rds:{{<region>}}:{{<account>}}:snapshot:rds:{{<name>}}<br />For example:<pre>arn:aws:rds:{{us-east-2}}:{{123456789012}}:snapshot:rds:{{my-mysql-db-2019-07-22-07-23}}</pre> | 
| Automated DB cluster snapshot | arn:aws:rds:{{<region>}}:{{<account>}}:cluster-snapshot:rds:{{<name>}}<br />For example:<pre>arn:aws:rds:{{us-east-2}}:{{123456789012}}:cluster-snapshot:rds:{{my-aurora-cluster-2019-07-22-16-16}}</pre> | 
...
| Global cluster | arn:aws:rds::{{<account>}}:global-cluster:{{<name>}}<br />For example:<pre>arn:aws:rds::{{123456789012}}:global-cluster:{{my-aurora-global-cluster-1}}</pre> | 