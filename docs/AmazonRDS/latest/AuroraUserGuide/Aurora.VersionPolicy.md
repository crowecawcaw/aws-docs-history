...
With Amazon Aurora, you can choose the [supported relational database engine](#Aurora.VersionPolicy.SupportedEngines "#Aurora.VersionPolicy.SupportedEngines") that best fits your application requirements
...
engines. When you create a cluster, you [specify the Amazon Aurora database engine version](#Aurora.VersionPolicy.ChoosingVersion "#Aurora.VersionPolicy.ChoosingVersion") that you want to use. The version that
...
| ------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Amazon Aurora MySQL-Compatible Edition      | [Working with Amazon Aurora MySQL](Aurora.AuroraMySQL.md "Aurora.AuroraMySQL.md")                | [Database engine updates for Amazon Aurora MySQL](AuroraMySQL.Updates.md "AuroraMySQL.Updates.md")                | [Release Notes for Aurora MySQL](../AuroraMySQLReleaseNotes/Welcome.md "../AuroraMySQLReleaseNotes/Welcome.md")                |
| Amazon Aurora PostgreSQL-Compatible Edition | [Working with Amazon Aurora PostgreSQL](Aurora.AuroraPostgreSQL.md "Aurora.AuroraPostgreSQL.md") | [Database engine updates for Amazon Aurora PostgreSQL](AuroraPostgreSQL.Updates.md "AuroraPostgreSQL.Updates.md") | [Release Notes for Aurora PostgreSQL](../AuroraPostgreSQLReleaseNotes/Welcome.md "../AuroraPostgreSQLReleaseNotes/Welcome.md") |
...
To learn how to create Aurora clusters, see [Creating an Amazon Aurora DB cluster](Aurora.CreateInstance.md "Aurora.CreateInstance.md"). To learn how to change the version of an existing
Aurora cluster, see [Modifying an Amazon Aurora DB cluster](Aurora.Modifying.md "Aurora.Modifying.md").

###### Note

Not every Aurora database version is available in every AWS Region. To learn more about
Regions and the available versions in each AWS Region, see [Regions and Availability Zones](Concepts.RegionsAndAvailabilityZones.md "Concepts.RegionsAndAvailabilityZones.md") and [Supported Regions and DB engines for Aurora global databases](Concepts.Aurora_Fea_Regions_DB-eng.Feature.GlobalDatabase.md "Concepts.Aurora_Fea_Regions_DB-eng.Feature.GlobalDatabase.md").
