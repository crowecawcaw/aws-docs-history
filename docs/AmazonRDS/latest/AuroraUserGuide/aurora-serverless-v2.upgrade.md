...
- Migrate from an on-premises database to an Aurora Serverless v2 cluster.
  When your upgraded cluster is running the appropriate engine version as listed in [Requirements and limitations for Aurora Serverless v2](aurora-serverless-v2.requirements.md "aurora-serverless-v2.requirements.md"), you can begin adding Aurora Serverless v2 DB instances to it. The first DB
...
- [Upgrading or switching existing clusters to use Aurora Serverless v2](aurora-serverless-v2.upgrade.md#aurora-serverless-v2.getting-started-general-procedure "aurora-serverless-v2.upgrade.md#aurora-serverless-v2.getting-started-general-procedure")
  - [Upgrade paths for MySQL-compatible clusters to use Aurora Serverless v2](aurora-serverless-v2.upgrade.md#serverless-v2-upgrade-paths-ams "aurora-serverless-v2.upgrade.md#serverless-v2-upgrade-paths-ams")
  - [Upgrade paths for PostgreSQL-compatible clusters to use Aurora Serverless v2](aurora-serverless-v2.upgrade.md#serverless-v2-upgrade-paths-apg "aurora-serverless-v2.upgrade.md#serverless-v2-upgrade-paths-apg")
...
- [Comparison of Aurora Serverless v2 and Aurora Serverless v1](aurora-serverless-v2.upgrade.md#aurora-serverless.comparison "aurora-serverless-v2.upgrade.md#aurora-serverless.comparison")
  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 requirements](aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-requirements "aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-requirements")
  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 scaling and availability](aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-scaling "aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-scaling")
  - [Comparison of Aurora Serverless v2 and Aurora Serverless v1 feature support](aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-features "aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-features")
  - [Adapting Aurora Serverless v1 use cases to Aurora Serverless v2](aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-approaches "aurora-serverless-v2.upgrade.md#aurora-serverless.comparison-approaches")
...
- [Upgrading from an Aurora Serverless v1 cluster to Aurora Serverless v2](aurora-serverless-v2.upgrade.md#aurora-serverless-v2.upgrade-from-serverless-v1-procedure "aurora-serverless-v2.upgrade.md#aurora-serverless-v2.upgrade-from-serverless-v1-procedure")
  - [Aurora MySQL–compatible DB clusters](aurora-serverless-v2.upgrade.md#sv1-to-sv2-ams "aurora-serverless-v2.upgrade.md#sv1-to-sv2-ams")
  - [Aurora PostgreSQL–compatible DB clusters](aurora-serverless-v2.upgrade.md#sv1-to-sv2-apg "aurora-serverless-v2.upgrade.md#sv1-to-sv2-apg")

- [Migrating from an on-premises database to Aurora Serverless v2](aurora-serverless-v2.upgrade.md#aurora-serverless-v2.migrate-from-on-prem "aurora-serverless-v2.upgrade.md#aurora-serverless-v2.migrate-from-on-prem")
...
see [Creating a DB cluster that uses Aurora Serverless v2](aurora-serverless-v2.create.md "aurora-serverless-v2.create.md").
...
1. Check if the provisioned cluster needs to be upgraded to be used with Aurora Serverless v2 DB instances. For the Aurora versions
   that are compatible with Aurora Serverless v2, see [Requirements and limitations for Aurora Serverless v2](aurora-serverless-v2.requirements.md "aurora-serverless-v2.requirements.md").
...
version of the cluster:
    ...
    * If you have a MySQL 5.7–compatible provisioned cluster, follow the upgrade instructions for Aurora MySQL version 3.
     Use the procedures in [How to perform an in-place upgrade](AuroraMySQL.Upgrading.Procedure.md "AuroraMySQL.Upgrading.Procedure.md").
    * If you have a PostgreSQL-compatible provisioned cluster running PostgreSQL version 11 or 12, follow the upgrade
     instructions for Aurora PostgreSQL version 13. Use the procedures in [Performing a major version upgrade](USER_UpgradeDBInstance.PostgreSQL.MajorVersion.md "USER_UpgradeDBInstance.PostgreSQL.MajorVersion.md").

2. Configure any other cluster properties to match the Aurora Serverless v2 requirements from [Requirements and limitations for Aurora Serverless v2](aurora-serverless-v2.requirements.md "aurora-serverless-v2.requirements.md").
...
| Configuration parameters                             | Almost all the same parameters can be modified as in provisioned clusters. For details, see [Working with parameter groups for Aurora Serverless v2](aurora-serverless-v2.setting-capacity.md#aurora-serverless-v2.parameter-groups "aurora-serverless-v2.setting-capacity.md#aurora-serverless-v2.parameter-groups"). | Only a subset of parameters can be modified.                                                                                                                                                                                                   |
...
| Encryption for cluster volume                        | Optional                                                                                                                                                                                                                                                                                                               | Required. The limitations in [Limitations of Amazon Aurora encrypted DB clusters](Overview.Encryption.md#Overview.Encryption.Limitations "Overview.Encryption.md#Overview.Encryption.Limitations") apply to all Aurora Serverless v1 clusters. |
...
1. Convert the Aurora Serverless v1 DB cluster to a provisioned Aurora MySQL version 2 cluster. Follow the procedure in
   ...
   provisioned](aurora-serverless.modifying.md#aurora-serverless.modifying.convert "aurora-serverless.modifying.md#aurora-serverless.modifying.convert").
...
For compatible versions, see [Aurora Serverless v2 with Aurora PostgreSQL](Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.md#Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.apg "Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.md#Concepts.Aurora_Fea_Regions_DB-eng.Feature.ServerlessV2.apg"). 4. Modify the writer DB instance of the green cluster to use the **Serverless v2** (db.serverless)
DB instance class.
...
2. Upgrade the Aurora Serverless v1 cluster to an Aurora PostgreSQL version 13 version that's compatible with
   Aurora Serverless v2, for example, 13.12. Follow the procedure in [Upgrading the major version](aurora-serverless.modifying.md#aurora-serverless.modifying.upgrade "aurora-serverless.modifying.md#aurora-serverless.modifying.upgrade").
