...
- For busier tables, perform a manual vacuum freeze regularly during a maintenance
  ...
  vacuum freeze, see [Performing a manual vacuum freeze](Appendix.PostgreSQL.CommonDBATasks.Autovacuum.VacuumFreeze.md "Appendix.PostgreSQL.CommonDBATasks.Autovacuum.VacuumFreeze.md").
