...
12. Complete the steps in [Associating an IAM role with an Amazon Aurora MySQL DB cluster](AuroraMySQL.Integrating.Authorizing.IAM.AddRoleToDBCluster.md "AuroraMySQL.Integrating.Authorizing.IAM.AddRoleToDBCluster.md").
