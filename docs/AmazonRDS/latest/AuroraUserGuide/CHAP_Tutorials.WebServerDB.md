...
DB cluster](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md"). The web server connects to the Amazon Aurora
...
DB cluster (IPv4 only)](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md"). Make sure that
...
Apache web server to your DB cluster

Next, you add content to your Apache web server that connects to your Amazon Aurora DB cluster.

###### To add content to the Apache web server that connects to your DB
