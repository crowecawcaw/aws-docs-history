...
- [Cross-account cloning with AWS RAM and
  Amazon Aurora](Aurora.Managing.Clone.md "Aurora.Managing.Clone.md")
...
with other AWS accounts. For more information, see [Cross-account cloning with AWS RAM and
Amazon Aurora](Aurora.Managing.Clone.md "Aurora.Managing.Clone.md").
...
procedures in [Cross-account cloning with AWS RAM and
Amazon Aurora](Aurora.Managing.Clone.md "Aurora.Managing.Clone.md").
...
For more information, see [Storage configurations for Amazon Aurora DB
clusters](Aurora.Overview.md#aurora-storage-type "Aurora.Overview.md#aurora-storage-type"). 7. Choose the DB instance size or DB cluster capacity:
