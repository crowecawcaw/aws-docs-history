...
| escape\_hatch\_database\_misc\_options | Controls Babelfish behavior related to the following options on CREATE DATABASE: CONTAINMENT, DB\_CHAINING, TRUSTWORTHY, PERSISTENT\_LOG\_BUFFER. | ignore | 
...
| escape\_hatch\_fulltext | Controls Babelfish behavior related to FULLTEXT features, such a DEFAULT\_FULLTEXT\_LANGUAGE in CREATE/ALTER DATABASE, CREATE FULLTEXT INDEX, or sp\_fulltext\_database. | ignore | 
