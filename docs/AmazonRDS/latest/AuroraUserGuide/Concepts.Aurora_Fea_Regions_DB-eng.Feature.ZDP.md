...
for Aurora MySQL upgrades, see [Using zero-downtime patching](AuroraMySQL.Updates.ZDP.md "AuroraMySQL.Updates.ZDP.md").

For detailed information on the conditions and engine versions where ZDP is available
for Aurora PostgreSQL upgrades, see [Minor release upgrades and zero-downtime patching](USER_UpgradeDBInstance.PostgreSQL.MinorUpgrade.md#USER_UpgradeDBInstance.PostgreSQL.Minor.zdp "USER_UpgradeDBInstance.PostgreSQL.MinorUpgrade.md#USER_UpgradeDBInstance.PostgreSQL.Minor.zdp").
