...
For more information, see [Examining Aurora PostgreSQL query plans in the dba_plans view](AuroraPostgreSQL.Optimize.ViewPlans.md "AuroraPostgreSQL.Optimize.ViewPlans.md").
...
the `dba_plans` view. To learn more, see [Examining Aurora PostgreSQL query plans in the dba_plans view](AuroraPostgreSQL.Optimize.ViewPlans.md "AuroraPostgreSQL.Optimize.ViewPlans.md").
