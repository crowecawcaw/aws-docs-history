...
and slow_query_log in the DB cluster parameter group](aurora-serverless-v1.how-it-works.md#aurora-serverless.parameter-groups "aurora-serverless-v1.how-it-works.md#aurora-serverless.parameter-groups") associated with
...
[Viewing Aurora Serverless v1 logs with Amazon CloudWatch](aurora-serverless-v1.how-it-works.md#aurora-serverless.logging.monitoring "aurora-serverless-v1.how-it-works.md#aurora-serverless.logging.monitoring").
