...
- [Determining DB instance class support in AWS Regions](Concepts.DBInstanceClass.md "Concepts.DBInstanceClass.md")
- [Hardware specifications for DB instance classesfor Aurora](Concepts.DBInstanceClass.md "Concepts.DBInstanceClass.md")
