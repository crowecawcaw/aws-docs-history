...
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------- |
| apg_adaptive_join_crossover_multiplier | This multiplier works with the _row crossover point_ to determine when to switch from a nested loop to a hash join. The row crossover point is where the SQL optimizer estimates that nested loop and hash join operations have equal cost. A higher multiplier value reduces the likelihood of adaptive join switching to a hash join.                   | Controls whether Adaptive Join is enabled <br>• Default value: -1 (disabled) <br>• Valid range: -1 to DBL_MAX <br>• To enable: Set to >= 1                                                                                                                                                                                                 |
