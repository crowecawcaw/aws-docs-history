...
**[Migrating
an RDS for PostgreSQL DB instance using a snapshot](AuroraPostgreSQL.Migrating.RDSPostgreSQL.Import.Console.md "AuroraPostgreSQL.Migrating.RDSPostgreSQL.Import.Console.md")**
...
replica](AuroraPostgreSQL.Migrating.RDSPostgreSQL.Replica.md "AuroraPostgreSQL.Migrating.RDSPostgreSQL.Replica.md")**
...
into Aurora PostgreSQL](USER_PostgreSQL.S3Import.md "USER_PostgreSQL.S3Import.md")**
...
For information about Aurora PostgreSQL versions, see [Engine versions for Amazon Aurora PostgreSQL](AuroraPostgreSQL.Updates.20180305.md "AuroraPostgreSQL.Updates.20180305.md").
