...
For more information, see [Amazon Aurora Auto Scaling with Aurora Replicas](Aurora.Integrating.AutoScaling.md "Aurora.Integrating.AutoScaling.md").
...
isn't already turned on. For more information on GoSH, see [Managing the global status history](../UserGuide/Appendix.MySQL.CommonDBATasks.md#Appendix.MySQL.CommonDBATasks.GoSH "../UserGuide/Appendix.MySQL.CommonDBATasks.md#Appendix.MySQL.CommonDBATasks.GoSH").
