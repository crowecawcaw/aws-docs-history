...
Enterprise version of Active Directory. For more information, see [Multi-Region replication](../../../directoryservice/latest/admin-guide/ms_ad_configure_multi_region_replication.md "../../../directoryservice/latest/admin-guide/ms_ad_configure_multi_region_replication.md") in the
