...
- [To use the TDS port to query for version information](#apg-version-info-tds "#apg-version-info-tds")
- [To use the PostgreSQL port to query for version information](#apg-version-info-psql "#apg-version-info-psql")
