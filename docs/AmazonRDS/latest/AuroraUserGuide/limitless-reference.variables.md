...
as a constant predicate. For more information, see [Setting an active shard key](limitless-query.single-shard.md#limitless-query.single-shard.active "limitless-query.single-shard.md#limitless-query.single-shard.active").
...
What to include in the `EXPLAIN` output. For more information, see [EXPLAIN](limitless-reference.DML-limitations.md#limitless-reference.DML-limitations.EXPLAIN "limitless-reference.DML-limitations.md#limitless-reference.DML-limitations.EXPLAIN").
