...
- [Supported engine versions](#apg-ipc-parallel-context-supported "#apg-ipc-parallel-context-supported")
- [Context](#apg-ipc-parallel-context "#apg-ipc-parallel-context")
- [Likely causes of increased waits](#apg-ipc-parallel-causes "#apg-ipc-parallel-causes")
- [Actions](#apg-ipc-parallel-actions "#apg-ipc-parallel-actions")
