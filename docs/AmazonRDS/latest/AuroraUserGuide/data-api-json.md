...
- [Retrieving query results in JSON format](#data-api-json-querying "#data-api-json-querying")
- [Data Type Mapping](#data-api-json-datatypes "#data-api-json-datatypes")
- [Troubleshooting](#data-api-json-troubleshooting "#data-api-json-troubleshooting")
- [Examples](#data-api-json-examples "#data-api-json-examples")
...
| `DECIMAL`                                              | String by default. Number if the `DecimalReturnType` option is set to<br>`DOUBLE_OR_LONG`. |
| `STRING`                                               | String                                                                                     |
| `BOOLEAN`, `BIT`                                       | Boolean                                                                                    |
