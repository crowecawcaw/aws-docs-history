...
format. For more information, see [Data conversion when exporting to an Amazon S3 bucket](aurora-export-snapshot.Considerations.md#aurora-export-snapshot.data-types "aurora-export-snapshot.Considerations.md#aurora-export-snapshot.data-types").
