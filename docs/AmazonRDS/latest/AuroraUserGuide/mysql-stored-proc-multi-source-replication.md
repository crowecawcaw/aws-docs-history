...
Aurora MySQL
multi-source replica. For more
information, see [Configure multi-source replication for Amazon Aurora MySQL](AuroraMySQL.Replication.MultiSource.md "AuroraMySQL.Replication.MultiSource.md").
...
file is named `mysql-bin-changelog.012345`, then the index is 12345. To determine the current source log file name, run the `SHOW
...
parameter to `1`. For information about modifying parameters, see [Modifying parameters in a DB parameter group in Amazon Aurora](USER_WorkingWithParamGroups.Modifying.md "USER_WorkingWithParamGroups.Modifying.md").
...
modifying parameters, see [Modifying parameters in a DB parameter group in Amazon Aurora](USER_WorkingWithParamGroups.Modifying.md "USER_WorkingWithParamGroups.Modifying.md").
...
To skip errors in GTID-based replication, we recommend that you use the procedure [mysql.rds\_skip\_transaction\_with\_gtid(Aurora MySQL version 2 and 3)](mysql-stored-proc-gtid.md#mysql_rds_skip_transaction_with_gtid "mysql-stored-proc-gtid.md#mysql_rds_skip_transaction_with_gtid") instead.
