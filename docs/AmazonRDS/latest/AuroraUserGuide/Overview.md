...
- [Overview of encryption in Amazon Aurora resources](#Overview.Encryption.Overview "#Overview.Encryption.Overview")
- [Encrypting an Amazon Aurora DB cluster](#Overview.Encryption.Enabling "#Overview.Encryption.Enabling")
- [Determining whether encryption is turned on for a DB cluster](#Overview.Encryption.Determining "#Overview.Encryption.Determining")
- [Availability of Amazon Aurora encryption](#Overview.Encryption.Availability "#Overview.Encryption.Availability")
- [Encryption in transit](#Overview.Encryption.InTransit "#Overview.Encryption.InTransit")
...
[AWS-owned key](../../../kms/latest/developerguide/concepts.md#aws-owned-key "../../../kms/latest/developerguide/concepts.md#aws-owned-key")
...
about key types, see
[customer managed keys and AWS managed keys](../../../kms/latest/developerguide/concepts.md#key-mgmt "../../../kms/latest/developerguide/concepts.md#key-mgmt").
