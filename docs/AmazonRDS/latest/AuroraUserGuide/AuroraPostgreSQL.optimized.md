...
```
postgres=> show temp_tablespaces;`temp_tablespaces
---------------------
...
- Create an Aurora PostgreSQL DB cluster using one of the NVMe-based DB instance classes. For
  more information, see [Creating an Amazon Aurora DB cluster](Aurora.md "Aurora.md").
...
throughput. For more information about these metrics, see [Instance-level metrics for Amazon Aurora](Aurora.AuroraMonitoring.md#Aurora.AuroraMySQL.Monitoring.Metrics.instances "Aurora.AuroraMonitoring.md#Aurora.AuroraMySQL.Monitoring.Metrics.instances").
