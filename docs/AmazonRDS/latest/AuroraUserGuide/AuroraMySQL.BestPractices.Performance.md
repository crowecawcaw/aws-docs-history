...
For details, see [Aurora MySQL hints](AuroraMySQL.Reference.Hints.md "AuroraMySQL.Reference.Hints.md").
...
see [Scaling reads for your MySQL database with Amazon Aurora](AuroraMySQL.Replication.ReadScaling.md "AuroraMySQL.Replication.ReadScaling.md").
...
`UTC`. For more information, see [Modifying parameters in a DB cluster parameter groupin Amazon Aurora](USER_WorkingWithParamGroups.ModifyingCluster.md "USER_WorkingWithParamGroups.ModifyingCluster.md").
