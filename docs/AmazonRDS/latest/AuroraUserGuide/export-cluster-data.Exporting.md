...
or create a new role.
    ...
    * If you created a role by following the steps in [Providing access to an Amazon S3 bucket using an IAM role](export-cluster-data.Setup.md#export-cluster-data.SetupIAMRole "export-cluster-data.Setup.md#export-cluster-data.SetupIAMRole"), choose that role.
