...
You can use the following SQL script on your existing MySQL DB instance to list the tables in your database that are MyISAM tables, compressed tables, or tables with compressed pages.
