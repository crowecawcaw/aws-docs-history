...
formats](https://dev.mysql.com/doc/refman/8.0/en/innodb-row-format.html "https://dev.mysql.com/doc/refman/8.0/en/innodb-row-format.html") and [InnoDB table
...
For the list of supported privileges, see [Role-based privilege model](AuroraMySQL.Compare-80-v3.md#AuroraMySQL.privilege-model "AuroraMySQL.Compare-80-v3.md#AuroraMySQL.privilege-model").
