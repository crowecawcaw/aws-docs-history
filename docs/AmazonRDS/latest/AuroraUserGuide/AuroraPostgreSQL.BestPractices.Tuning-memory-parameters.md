...
and then start a simple replication. For more information, see [Setting up logical replication for your Aurora PostgreSQL DB cluster](AuroraPostgreSQL.Replication.Logical.Configure.md "AuroraPostgreSQL.Replication.Logical.Configure.md"). With replication under
