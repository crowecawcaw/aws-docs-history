...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------- |
| Amazon Aurora MySQL      | See [Best practices with Amazon Aurora MySQL](AuroraMySQL.BestPractices.md "AuroraMySQL.BestPractices.md")                |
| Amazon Aurora PostgreSQL | See [Best practices with Amazon Aurora PostgreSQL](AuroraPostgreSQL.BestPractices.md "AuroraPostgreSQL.BestPractices.md") |
...
- [Basic operational guidelines for Amazon Aurora](#Aurora.BestPractices.OperationalGuidelines "#Aurora.BestPractices.OperationalGuidelines")
...
For more information, see [Connecting to Aurora DB clusters with the AWS drivers](Aurora.Connecting.md#Aurora.Connecting.Drivers "Aurora.Connecting.md#Aurora.Connecting.Drivers").
