...
**Note**  
For common recommendations for Aurora, see [Recommendations from Amazon Aurora](monitoring-recommendations.md).
...
For more information, see [Connecting to Aurora DB clusters with the AWS drivers](Aurora.Connecting.md#Aurora.Connecting.Drivers).
