...
- Network traffic to and from the database is encrypted using Secure Socket Layer (SSL)
  ...
  Amazon Aurora,
  see [Using SSL/TLS to encrypt a connection to a DB cluster](UsingWithRDS.SSL.md "UsingWithRDS.SSL.md").
...
- [Connecting to your DB cluster using IAM authentication](UsingWithRDS.IAMDBAuth.Connecting.md "UsingWithRDS.IAMDBAuth.Connecting.md")
...
[Supported Regions and Aurora DB engines for IAM database authentication](Concepts.Aurora_Fea_Regions_DB-eng.Feature.IAMdbauth.md "Concepts.Aurora_Fea_Regions_DB-eng.Feature.IAMdbauth.md").
