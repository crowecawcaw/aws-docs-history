...
see [Database has long running idle in transaction connection](PostgreSQL.Tuning_proactive_insights.md#proactive-insights.idle-txn "PostgreSQL.Tuning_proactive_insights.md#proactive-insights.idle-txn").
...
- When a table has large unused indexes, it can cause autovacuum to not fit your workload and might block it from running. To avoid this, check for unused indexes and remove them completely. For more information, see
  [Managing autovacuum with large indexes](../UserGuide/Appendix.PostgreSQL.CommonDBATasks.Autovacuum.LargeIndexes.md "../UserGuide/Appendix.PostgreSQL.CommonDBATasks.Autovacuum.LargeIndexes.md").
