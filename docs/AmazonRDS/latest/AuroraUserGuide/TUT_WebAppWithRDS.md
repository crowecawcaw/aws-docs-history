...
1. [Launch an EC2 instance to connect with your DB cluster](CHAP_Tutorials.WebServerDB.LaunchEC2.md "CHAP_Tutorials.WebServerDB.LaunchEC2.md")
2. [Create an Amazon Aurora DB cluster](CHAP_Tutorials.WebServerDB.CreateDBCluster.md "CHAP_Tutorials.WebServerDB.CreateDBCluster.md")
