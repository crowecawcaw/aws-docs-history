...
- [CloudTrail integration with Amazon Aurora](#service-name-info-in-cloudtrail "#service-name-info-in-cloudtrail")
- [Amazon Aurora log file entries](#understanding-service-name-entries "#understanding-service-name-entries")

## CloudTrail integration with Amazon Aurora

All Amazon Aurora actions are
logged by CloudTrail. CloudTrail provides a record of actions taken by a user, role, or an AWS service in Amazon Aurora.

### CloudTrail events

CloudTrail captures API calls for Amazon Aurora as events. An _event_
...
For an ongoing record of events in your AWS account, including events for Amazon Aurora, create a _trail_. A
...
information about `CreateDBInstance` and other Amazon Aurora actions, see the [Amazon RDS API Reference](../APIReference.md "../APIReference.md").
