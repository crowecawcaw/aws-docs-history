...
- An intermediate certificate for
  Amazon Aurora
  that is specific to an AWS Region. (For more information, see [Using SSL/TLS to encrypt a connection to a DB cluster](UsingWithRDS.SSL.md "UsingWithRDS.SSL.md").) At runtime, the class loader
...
- Modify the values of the following variables as needed:
  ...
  AWS Region, see [Using SSL/TLS to encrypt a connection to a DB cluster](UsingWithRDS.SSL.md "UsingWithRDS.SSL.md").
