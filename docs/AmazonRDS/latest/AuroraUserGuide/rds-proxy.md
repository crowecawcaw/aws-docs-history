...
group_ embodies the Aurora DB cluster that the proxy can
...
(IAM). For general information about those security features, see [Security in Amazon Aurora](UsingWithRDS.md "UsingWithRDS.md"). Also, make sure to familiarize
yourself with how
