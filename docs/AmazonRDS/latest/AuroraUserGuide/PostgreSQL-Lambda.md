...
![Example Lambda function shown in the AWS CLI for AWS Lambda.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/lambda_simple_function.png)
