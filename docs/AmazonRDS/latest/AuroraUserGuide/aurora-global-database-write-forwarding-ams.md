...
- [Region and version availability of write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-regions-versions-ams "#aurora-global-database-write-forwarding-regions-versions-ams")
- [Enabling write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-enabling-ams "#aurora-global-database-write-forwarding-enabling-ams")
- [Checking if a secondary cluster has write forwarding enabled in Aurora MySQL](#aurora-global-database-write-forwarding-describing-ams "#aurora-global-database-write-forwarding-describing-ams")
- [Application and SQL compatibility with write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-compatibility-ams "#aurora-global-database-write-forwarding-compatibility-ams")
- [Isolation and consistency for write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-isolation-ams "#aurora-global-database-write-forwarding-isolation-ams")
- [Running multipart statements with write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-multipart-ams "#aurora-global-database-write-forwarding-multipart-ams")
- [Transactions with write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-txns-ams "#aurora-global-database-write-forwarding-txns-ams")
- [Configuration parameters for write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-params-ams "#aurora-global-database-write-forwarding-params-ams")
- [Amazon CloudWatch metrics for write forwarding in Aurora MySQL](#aurora-global-database-write-forwarding-cloudwatch-ams "#aurora-global-database-write-forwarding-cloudwatch-ams")
- [Aurora MySQL status variables for write forwarding](#aurora-global-database-write-forwarding-status-ams "#aurora-global-database-write-forwarding-status-ams")
...
aws rds **create-global-cluster** **--global-cluster-identifier write-forwarding-test** \
  **--engine aurora-mysql** **--engine-version 5.7.mysql\_aurora.2.11.1** \
  --region `us-east-1`
