...
- [Using Full Text Search in Babelfish](babelfish-postgres-fulltextsearch.md "babelfish-postgres-fulltextsearch.md")
- [Babelfish supports Geospatial data types](babelfish-geospatial.md "babelfish-geospatial.md")
- [Understanding partitioning in Babelfish](babelfish-partition.md "babelfish-partition.md")
