...
[Launch an EC2 instance to connect with your DB cluster](CHAP_Tutorials.WebServerDB.LaunchEC2.md "CHAP_Tutorials.WebServerDB.LaunchEC2.md"). The web server connects to the Amazon Aurora
DB cluster that you created in [Create an Amazon Aurora DB cluster](CHAP_Tutorials.WebServerDB.CreateDBCluster.md "CHAP_Tutorials.WebServerDB.CreateDBCluster.md").
...
VPC security group that you created in [Tutorial: Create a VPC for use with a DB cluster (IPv4 only)](CHAP_Tutorials.WebServerDB.CreateVPC.md "CHAP_Tutorials.WebServerDB.CreateVPC.md"). Make sure that
...
For information about connecting to a DB cluster, see [Connecting to an Amazon Aurora DB cluster](Aurora.Connecting.md "Aurora.Connecting.md").
