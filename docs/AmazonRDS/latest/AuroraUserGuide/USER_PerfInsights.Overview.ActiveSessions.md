...
- For a list of the common wait events for Aurora MySQL, see [Aurora MySQL wait events](AuroraMySQL.Reference.Waitevents.md "AuroraMySQL.Reference.Waitevents.md"). To learn how to tune using these wait
  events, see [Tuning Aurora MySQL](AuroraMySQL.Managing.Tuning.md "AuroraMySQL.Managing.Tuning.md").
...
- For a list of common wait events for Aurora PostgreSQL, see [Amazon Aurora PostgreSQL wait events](AuroraPostgreSQL.Reference.Waitevents.md "AuroraPostgreSQL.Reference.Waitevents.md"). To learn how to tune using these
  wait events, see [Tuning with wait events for Aurora PostgreSQL](AuroraPostgreSQL.Tuning.md "AuroraPostgreSQL.Tuning.md").
