...
[Giving Aurora access to Lambda](AuroraMySQL.Integrating.LambdaAccess.md "AuroraMySQL.Integrating.LambdaAccess.md").
...
- [Giving Aurora access to Lambda](AuroraMySQL.Integrating.LambdaAccess.md "AuroraMySQL.Integrating.LambdaAccess.md")
- [Invoking a Lambda function with an Aurora MySQL native function](AuroraMySQL.Integrating.NativeLambda.md "AuroraMySQL.Integrating.NativeLambda.md")
- [Invoking a Lambda function with an Aurora MySQL stored procedure (deprecated)](AuroraMySQL.Integrating.ProcLambda.md "AuroraMySQL.Integrating.ProcLambda.md")
