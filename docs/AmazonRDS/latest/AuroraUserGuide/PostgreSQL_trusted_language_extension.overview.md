...
![Image showing some of the components that make up the TLE development kit.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/apg-pg_tle-installed-view-in-pgAdmin.png)
