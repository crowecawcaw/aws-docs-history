...
| max\_parallel\_workers\_per\_gather | Maximum number of workers per query plan node (for example, per Gather) | 2 for Aurora PostgreSQL 17 and earlier versions. 0 for Aurora PostgreSQL 18 and later versions. | 
