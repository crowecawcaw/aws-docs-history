...
subnets for this scenario, see [Tutorial: Create a VPC for use with a DB cluster (IPv4 only)](CHAP_Tutorials.WebServerDB.CreateVPC.md "CHAP_Tutorials.WebServerDB.CreateVPC.md").

###### Tip

You can set up network connectivity between an Amazon EC2 instance and a DB cluster automatically when you create the DB cluster. For more information, see [Configure automatic network connectivity with an EC2 instance](Aurora.CreateInstance.md#Aurora.CreateInstance.Prerequisites.VPC.Automatic "Aurora.CreateInstance.md#Aurora.CreateInstance.Prerequisites.VPC.Automatic")
.
...
[Creating a DB cluster in a VPC](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC "USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC").
