...
- [Monitoring Aurora machine learning](mysql-ml.md#aurora-ml-monitoring "mysql-ml.md#aurora-ml-monitoring")
...
- For SageMaker AI:
  - The machine learning components that you want to use for inferences must be set up and ready to use. During
    ...
    models and handle the other such tasks. To get started with Amazon SageMaker AI, see [Get Started with Amazon SageMaker AI](../../../sagemaker/latest/dg/gs.md "../../../sagemaker/latest/dg/gs.md"). For more information about inferences
  ...
  - To use SageMaker AI with your own training data, you must set up an Amazon S3 bucket as part of your Aurora MySQL
    ...
    For a summary of this optional setup process, see [Setting up your Aurora MySQL DB cluster to use Amazon S3 for SageMaker AI (Optional)](#aurora-ml-setting-up-access-sagemaker-advanced-s3 "#aurora-ml-setting-up-access-sagemaker-advanced-s3").
...
support by AWS Region](../../../bedrock/latest/userguide/models-regions.md "../../../bedrock/latest/userguide/models-regions.md") in the _Amazon Bedrock User Guide_.
...
- Stored functions that call tables with generated-always columns aren't supported. This applies to any Aurora MySQL
  ...
  Columns](https://dev.mysql.com/doc/refman/5.7/en/create-table-generated-columns.html "https://dev.mysql.com/doc/refman/5.7/en/create-table-generated-columns.html") in the MySQL documentation.
...
The Amazon Bedrock permissions display. 5. Expand **Read**, then select **InvokeModel**. 6. For **Resources**, select **All**.

The **Specify permissions** page should resemble the following figure.

![Amazon Bedrock IAM permission policy for the InvokeModel operation.](images/ams-ml-br-iam-policy.png) 7. Choose **Next**. 8. On the **Review and create** page, enter a name for your policy, for example
`BedrockInvokeModel`. 9. Review your policy, then choose **Create policy**.
...
![Amazon Bedrock IAM role for the InvokeModel operation.](images/ams-ml-br-iam-role.png) 8. Review your role, then choose **Create role**.
...
![IAM role associated with your DB cluster.](images/ams-ml-br-manage-iam-roles.png)
...
information, see [DB cluster parameter groups for Amazon Aurora DB clusters](USER_WorkingWithDBClusterParamGroups.md "USER_WorkingWithDBClusterParamGroups.md").
...
The IAM integration for Amazon Bedrock is complete. Continue setting up your Aurora MySQL DB cluster to work with Amazon Bedrock by [Granting database users access to Aurora machine learning](#aurora-ml-sql-privileges "#aurora-ml-sql-privileges").
...
![Image showing Amazon Comprehend chosen for the Aurora MySQL DB cluster.](images/ams-ml-cmp-iam-role.png) 7. The **Connect cluster to Amazon Comprehend** dialog doesn't require any additional information. However, you might see a
...
message before you continue. You can choose **Cancel** if you prefer not to proceed. 8. Choose **Connect service** to complete the integration process.
...
integration. For more information, see [DB cluster parameter groups for Amazon Aurora DB clusters](USER_WorkingWithDBClusterParamGroups.md "USER_WorkingWithDBClusterParamGroups.md").
...
[SageMaker AI console](https://console.aws.amazon.com/sagemaker/home "https://console.aws.amazon.com/sagemaker/home"). In the navigation pane, open the
**Inference** menu and choose **Endpoints**. In the following image,
you can find an example.

![Image showing SageMaker AI chosen for the Aurora MySQL DB cluster.](images/ams-sm-endpoint-arn.png)
...
AWS Identity and Access Management navigation menu. 10. Find the role from among those listed. Its name uses the following pattern.
...
add the Amazon S3 bucket to your Aurora MySQL DB cluster, as outlined in the [Setting up your Aurora MySQL DB cluster to use Amazon S3 for SageMaker AI (Optional)](#aurora-ml-setting-up-access-sagemaker-advanced-s3 "#aurora-ml-setting-up-access-sagemaker-advanced-s3") that follows.
...
for the Aurora MySQL DB cluster to use. For more information about creating an Amazon S3 bucket, see [Creating a bucket](../../../AmazonS3/latest/userguide/create-bucket-overview.md "../../../AmazonS3/latest/userguide/create-bucket-overview.md") in the
...
Instances](../../../sagemaker/latest/dg/gs-console.md "../../../sagemaker/latest/dg/gs-console.md")in the in the _Amazon SageMaker AI Developer Guide_.
...
- For Aurora MySQL version 3 (MySQL 8.0 compatible), database users must be granted the appropriate _database role_.
  For more informations, see [Using Roles](https://dev.mysql.com/doc/refman/8.0/en/roles.html "https://dev.mysql.com/doc/refman/8.0/en/roles.html") in
...
- For Aurora MySQL version 2 (MySQL 5.7 compatible), database users are granted _privileges_. For more information, see
  ...
  Management](https://dev.mysql.com/doc/refman/5.7/en/access-control.html "https://dev.mysql.com/doc/refman/5.7/en/access-control.html") in the _MySQL 5.7 Reference Manual_.
...
The Amazon Comprehend functions are now available for use. For usage examples, see [Using Amazon Comprehend with your Aurora MySQL DB cluster](#using-amazon-comprehend-for-sentiment-detection "#using-amazon-comprehend-for-sentiment-detection").
...
The SageMaker AI functions are now available for use. For usage examples, see [Using SageMaker AI with your Aurora MySQL DB cluster](#using-amazon-sagemaker-to-run-your-own-ml-models "#using-amazon-sagemaker-to-run-your-own-ml-models").
...
see [Supported models in Amazon Bedrock](../../../bedrock/latest/userguide/models-supported.md "../../../bedrock/latest/userguide/models-supported.md") in the
...
format the request body according to the [Amazon Titan text models](../../../bedrock/latest/userguide/model-parameters-titan-text.md "../../../bedrock/latest/userguide/model-parameters-titan-text.md").
...
For other models that you use, make sure to format the request body appropriately for them. For more information, see [Inference parameters for foundation models](../../../bedrock/latest/userguide/model-parameters.md "../../../bedrock/latest/userguide/model-parameters.md")
...
[Performance considerations for using Aurora machine learning with Aurora MySQL](#aurora-ml-performance "#aurora-ml-performance").

For more information about parameters and return types for the sentiment detection functions in Amazon Comprehend, see
[DetectSentiment](../../../comprehend/latest/dg/API_DetectSentiment.md "../../../comprehend/latest/dg/API_DetectSentiment.md")
...
CREATE FUNCTION Statements](https://dev.mysql.com/doc/refman/8.0/en/create-procedure.html "https://dev.mysql.com/doc/refman/8.0/en/create-procedure.html") in the MySQL 8.0 Reference Manual.
...
- Format `CSV` is a newly introduced format that follows the specification in
  [RFC-4180](https://tools.ietf.org/html/rfc4180 "https://tools.ietf.org/html/rfc4180").
...
For information about monitoring the performance of the SageMaker AI operations called from Aurora machine learning functions, see [Monitor Amazon SageMaker AI](../../../sagemaker/latest/dg/monitoring-overview.md "../../../sagemaker/latest/dg/monitoring-overview.md").
