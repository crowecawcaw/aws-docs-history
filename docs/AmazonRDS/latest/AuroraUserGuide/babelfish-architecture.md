...
![Diagram of single-database migration mode, where schema names are unchanged.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/babelfish_single_db_mode.png)
...
![Diagram of multiple-database migration mode, where schema names change.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/babelfish_multi_db_mode.png)
