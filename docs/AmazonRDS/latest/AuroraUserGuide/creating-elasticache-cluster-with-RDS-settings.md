...
**Topics**
+ [Overview of ElastiCache cache creation with Aurora DB cluster settings](#creating-elasticache-cluster-with-RDS-settings-overview)
+ [Creating an ElastiCache cache with settings from an Aurora DB cluster](#creating-elasticache-cluster-with-RDS-settings-new-DB)
