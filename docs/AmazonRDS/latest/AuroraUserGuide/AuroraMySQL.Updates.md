...
For details about the Aurora MySQL versions that are supported by Amazon Aurora, see the [*Release Notes for Aurora MySQL*](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraMySQLReleaseNotes/Welcome.html).
