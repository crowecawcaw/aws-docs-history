...
| log_disconnections         | –       | Logs the end of each session and its duration. To learn how to use this parameter with<br>`log_connections` to detect connection churn, see<br>[Managing Aurora PostgreSQL connection churn with pooling](AuroraPostgreSQL.BestPractices.connection_pooling.md "AuroraPostgreSQL.BestPractices.connection_pooling.md").                                                                                                                                                                                                                                                                           |
