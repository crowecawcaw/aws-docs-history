...
- [Storage auto-repair](#Aurora.Overview.AutoRepair "#Aurora.Overview.AutoRepair")
- [Survivable page cache](#Aurora.Overview.CacheWarming "#Aurora.Overview.CacheWarming")
- [Recovery from unplanned restarts](#Aurora.Overview.RestartRecovery "#Aurora.Overview.RestartRecovery")
...
information, see [Fast recovery after failover with cluster cache management for Aurora PostgreSQL](AuroraPostgreSQL.cluster-cache-mgmt.md "AuroraPostgreSQL.cluster-cache-mgmt.md").
...
For more information, see [Fault tolerance for an Aurora DB cluster](Concepts.AuroraHighAvailability.md#Aurora.Managing.FaultTolerance "Concepts.AuroraHighAvailability.md#Aurora.Managing.FaultTolerance") and [Optimizations to reduce database restart time](AuroraMySQL.MySQL80.md#ReducedRestartTime "AuroraMySQL.MySQL80.md#ReducedRestartTime").
...
- To reduce computational overhead and improve recovery times with binary logging, you
  ...
  99%. For more information, see [Setting up enhanced binlog for Aurora MySQL](AuroraMySQL.Enhanced.binlog.md "AuroraMySQL.Enhanced.binlog.md").
...
For more information about Aurora binary logging and replication, see [Replication with Amazon Aurora](Aurora.Replication.md "Aurora.Replication.md"). For more information
