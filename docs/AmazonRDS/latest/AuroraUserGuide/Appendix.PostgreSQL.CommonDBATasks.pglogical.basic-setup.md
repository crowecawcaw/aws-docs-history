...
![The shared_preload_libraries parameter with pglogical added.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/apg_rpg_shared_preload_pglogical.png)
