...
- [Supported engine versions](#apg-waits.lwl-buffer-mapping.context.supported "#apg-waits.lwl-buffer-mapping.context.supported")
...
information, see [Shared buffers](AuroraPostgreSQL.Tuning.concepts.md#AuroraPostgreSQL.Tuning.concepts.buffer-pool "AuroraPostgreSQL.Tuning.concepts.md#AuroraPostgreSQL.Tuning.concepts.buffer-pool").
...
- [Reduce the number of buffers that must be allocated quickly](#apg-waits.lwl-buffer-mapping.actions.buffers "#apg-waits.lwl-buffer-mapping.actions.buffers")
