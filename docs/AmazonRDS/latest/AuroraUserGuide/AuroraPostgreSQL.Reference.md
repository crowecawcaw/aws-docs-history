...
- [Aurora PostgreSQL collations for EBCDIC and other mainframe migrations](#AuroraPostgreSQL.Reference.Collations.mainframe.migration "#AuroraPostgreSQL.Reference.Collations.mainframe.migration")
- [Collations supported in Aurora PostgreSQL](PostgreSQL-Collations.md "PostgreSQL-Collations.md")
- [Aurora PostgreSQL functions reference](Appendix.AuroraPostgreSQL.Functions.md "Appendix.AuroraPostgreSQL.Functions.md")
...
- [Amazon Aurora PostgreSQL wait events](AuroraPostgreSQL.Reference.Waitevents.md "AuroraPostgreSQL.Reference.Waitevents.md")
...
Modernization?](../../../m2/latest/userguide/what-is-m2.md "../../../m2/latest/userguide/what-is-m2.md")
...
relevant code page, (cp*nnnn*), so that you can choose the
...
AWS Blu Age](../../../m2/latest/userguide/tutorial-runtime-ba.md "../../../m2/latest/userguide/tutorial-runtime-ba.md") in the _AWS Mainframe Modernization User
Guide_.

For more information about working with AWS Micro Focus, see [Tutorial:
Managed Runtime for Micro Focus](../../../m2/latest/userguide/tutorial-runtime.md "../../../m2/latest/userguide/tutorial-runtime.md") in the _AWS Mainframe
Modernization User Guide_.
