...
more information, see [Client:ClientRead](apg-waits.md "apg-waits.md").

**Client:ClientWrite**

A backend process is waiting to send more data to a PostgreSQL client. For
more information, see [Client:ClientWrite](apg-waits.md "apg-waits.md").
...
information, see [CPU](apg-waits.md "apg-waits.md").
...
information, see [IO:BufFileRead and IO:BufFileWrite](apg-waits.md "apg-waits.md").
...
it, and so read it from storage. For more information, see [IO:DataFileRead](apg-waits.md "apg-waits.md").
...
of a prepared transaction. For more information, see [IO:XactSync](apg-waits.md "apg-waits.md").
...
waiting for the event to become durable. For more information, see [IPC:DamRecordTxAck](apg-waits.md "apg-waits.md").
...
more information, see [Lock:advisory](apg-waits.md "apg-waits.md").
...
extend a relation at a time. For more information, see [Lock:extend](apg-waits.md "apg-waits.md").
...
locked by another transaction. For more information, see [Lock:Relation](apg-waits.md "apg-waits.md").
...
[Lock:transactionid](apg-waits.md "apg-waits.md").
...
information, see [Lock:tuple](apg-waits.md "apg-waits.md").
...
of a shared memory buffer. For more information, see [LWLock:buffer_content (BufferContent)](apg-waits.md "apg-waits.md").

**LWLock:buffer_mapping**

A backend process is waiting to associate a data block with a buffer in
the shared buffer pool. For more information, see [LWLock:buffer_mapping](apg-waits.md "apg-waits.md").
...
information, see [LWLock:BufferIO (IPC:BufferIO)](apg-waits.md "apg-waits.md").
...
parallel query. For more information, see [LWLock:lock_manager](apg-waits.md "apg-waits.md").
...
A process is waiting for I/O on a simple least-recently used (SLRU) buffer
for a multixact member. For more information, see [LWLock:MultiXact](apg-waits.md "apg-waits.md").
...
A process is waiting for I/O on a simple least-recently used (SLRU) buffer
for a multixact offset. For more information, see [LWLock:MultiXact](apg-waits.md "apg-waits.md").
...
sleep timeout to expire. For more information, see [Timeout:PgSleep](apg-waits.md "apg-waits.md").
