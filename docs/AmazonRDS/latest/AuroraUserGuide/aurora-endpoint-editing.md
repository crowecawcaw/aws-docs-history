...
exclusion list. If you need more details about these endpoint properties, see [Membership rules for custom endpoints](Aurora.Endpoints.Custom.Considerations.md#Aurora.Endpoints.Custom.Membership "Aurora.Endpoints.Custom.Considerations.md#Aurora.Endpoints.Custom.Membership").
...
![Editing a custom endpoint.](images/AuroraEditCustomEndpoint.png)
To edit a custom endpoint with the AWS CLI, run the [modify-db-cluster-endpoint](../../../cli/latest/reference/rds/modify-db-cluster-endpoint.md "../../../cli/latest/reference/rds/modify-db-cluster-endpoint.md") command.
...
To edit a custom endpoint with the RDS API, run the [ModifyDBClusterEndpoint.html](../APIReference/API_ModifyDBClusterEndpoint.html.md "../APIReference/API_ModifyDBClusterEndpoint.html.md") operation.
