...
![The Logs and events tab.](images/Monitoring_logsEvents.png) 5. In the **Logs** section, choose a log file, and then choose
**Watch**.

![The log selection.](images/Monitoring_LogsEvents_watch.png)
