...
For more information about turning on Performance Insights, see [Turning Performance Insights on and off for Aurora](USER_PerfInsights.Enabling.md "USER_PerfInsights.Enabling.md"). For information about pricing and data
...
For more information about recommendations, see [Recommendations from Amazon Aurora](monitoring-recommendations.md "monitoring-recommendations.md").
