...
For more
information, see
[Publishing Aurora PostgreSQL logs to Amazon CloudWatch Logs](AuroraPostgreSQL.CloudWatch.md "AuroraPostgreSQL.CloudWatch.md"). After you set up CloudWatch
...
compression utility. For more information, see the [gzip](https://www.gzip.org "https://www.gzip.org") website.
