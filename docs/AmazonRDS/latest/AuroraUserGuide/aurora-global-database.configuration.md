...
- **Capacity requirements for Aurora Serverless v2** – For a global database with
  Aurora Serverless v2, the [minimum recommended capacity](aurora-serverless-v2.md#aurora-serverless-v2.min_capacity_considerations "aurora-serverless-v2.md#aurora-serverless-v2.min_capacity_considerations")
  ...
  preliminary steps for creating any Aurora DB cluster. To learn more, see [Creating an Amazon Aurora DB cluster](Aurora.md "Aurora.md").
