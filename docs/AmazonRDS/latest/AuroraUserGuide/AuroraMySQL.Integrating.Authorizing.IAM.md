...
1. Create an IAM policy that grants permission to the AWS service. For more
   ...
   - [Creating an IAM policy to access AWS KMS resources](AuroraMySQL.Integrating.Authorizing.IAM.KMSCreatePolicy.md "AuroraMySQL.Integrating.Authorizing.IAM.KMSCreatePolicy.md")

2. Create an IAM role and attach the policy that you created. For more
   information, see [Creating an IAM role to allow Amazon Aurora to access AWS services](AuroraMySQL.Integrating.Authorizing.IAM.CreateRole.md "AuroraMySQL.Integrating.Authorizing.IAM.CreateRole.md").
