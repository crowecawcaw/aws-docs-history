...
![The pgAdmin Servers context menu.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/pgAdmin1.png)
...
![The pgAdmin Create - Server dialog box Connection tab with host and port entered.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/pgAdmin2.png)
...
![The pgAdmin dashboard for the connected Aurora PostgreSQL cluster.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/pgAdmin3.png)
