...
automatically when you export the DB cluster. For instructions, see [Creating DB cluster export tasks](export-cluster-data.Exporting.md "export-cluster-data.Exporting.md").
...
For more information about creating an IAM policy for Amazon Aurora, see [Creating and using an IAM policy for IAM database access](UsingWithRDS.IAMDBAuth.IAMPolicy.md "UsingWithRDS.IAMDBAuth.IAMPolicy.md"). See also [Tutorial: Create and attach your
...
You can use S3 buckets across AWS accounts. For more information, see [Using a cross-account Amazon S3 bucket](aurora-export-snapshot.Setup.md#aurora-export-snapshot.Setup.XAcctBucket "aurora-export-snapshot.Setup.md#aurora-export-snapshot.Setup.XAcctBucket").
