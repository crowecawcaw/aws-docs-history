...
**Note**  
For Aurora Serverless DB clusters, you connect to the database endpoint rather than to the DB instance. You can find the database endpoint for an Aurora Serverless DB cluster on the **Connectivity & security** tab of the AWS Management Console. . 
...
**Contents**
+ [Connecting to Aurora DB clusters with the AWS drivers](#Aurora.Connecting.Drivers)
