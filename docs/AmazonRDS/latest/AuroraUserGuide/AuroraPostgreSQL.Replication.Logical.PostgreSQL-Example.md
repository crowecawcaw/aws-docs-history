...
logical replication as detailed in [Setting up logical replication for your Aurora PostgreSQL DB cluster](AuroraPostgreSQL.Replication.Logical.Configure.md "AuroraPostgreSQL.Replication.Logical.Configure.md").
...
2. On the subscriber Aurora PostgreSQL DB
   ...
   created at the publisher. 4. To verify for this example that the initial data is replicated on the
