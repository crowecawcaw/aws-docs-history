...
1. Sign in to the AWS Management Console and open the AWS DMS console at [https://console.aws.amazon.com/dms/v2](https://console.aws.amazon.com/dms/v2). Choose the same AWS Region in which the publisher and subscriber are located.
