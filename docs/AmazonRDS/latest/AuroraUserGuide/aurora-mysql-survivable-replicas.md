...
The read availability feature for primary DB clusters is available in Aurora MySQL version 2.10 and higher, including version 8.4. Read availability for secondary DB clusters is available in Aurora MySQL version 3.06 and higher, including version 8.4.
