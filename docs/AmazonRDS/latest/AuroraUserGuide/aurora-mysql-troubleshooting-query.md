...
**Note**  
Aurora MySQL version 3 uses the community default value of 20 for the [innodb\_stats\_persistent\_sample\_pages](https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_stats_persistent_sample_pages) parameter.
...
| --- | --- | --- | 
| batched\_key\_access | off | off | 
| block\_nested\_loop | on | on | 
| condition\_fanout\_filter | on | on | 
| derived\_condition\_pushdown | – | on | 
| derived\_merge | on | on | 
| duplicateweedout | on | on | 
| engine\_condition\_pushdown | on | on | 
| firstmatch | on | on | 
| hash\_join | off | on | 
| hash\_join\_cost\_based | on | – | 
| hypergraph\_optimizer | – | off | 
| index\_condition\_pushdown | on | on | 
| index\_merge | on | on | 
| index\_merge\_intersection | on | on | 
| index\_merge\_sort\_union | on | on | 
| index\_merge\_union | on | on | 
| loosescan | on | on | 
| materialization | on | on | 
| mrr | on | on | 
| mrr\_cost\_based | on | on | 
| prefer\_ordering\_index | on | on | 
| semijoin | on | on | 
| skip\_scan | – | on | 
| subquery\_materialization\_cost\_based | on | on | 
| subquery\_to\_derived | – | off | 
| use\_index\_extensions | on | on | 
| use\_invisible\_indexes | – | off | 
