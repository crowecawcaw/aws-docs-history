...
For descriptions of the Amazon Aurora events, see [Amazon RDS event categories and event messagesfor Aurora](USER_Events.Messages.md "USER_Events.Messages.md").
