...
The `LWLock:BufferIO` wait event precedes the [IO:DataFileRead](apg-waits.iodatafileread.md "apg-waits.iodatafileread.md") wait event. The `IO:DataFileRead` wait event occurs while data is
