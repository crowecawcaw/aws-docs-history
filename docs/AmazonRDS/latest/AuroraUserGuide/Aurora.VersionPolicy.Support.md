...
For the version numbers of all Aurora LTS versions, see [Aurora MySQL long-term support (LTS) releases](AuroraMySQL.Update.SpecialVersions.md#AuroraMySQL.Updates.LTS "AuroraMySQL.Update.SpecialVersions.md#AuroraMySQL.Updates.LTS") and [Using an Aurora PostgreSQL long-term support (LTS) release](AuroraPostgreSQL.Updates.LTS.md "AuroraPostgreSQL.Updates.LTS.md").
...
RDS Extended Support is only available on certain Aurora versions. For more information, see [Amazon Aurora major versions](Aurora.VersionPolicy.Versioning.md#Aurora.VersionPolicy.MajorVersions "Aurora.VersionPolicy.Versioning.md#Aurora.VersionPolicy.MajorVersions").
