...
When you use Amazon Aurora resources,
...
The page displays the Amazon Aurora dimensions. For descriptions of these dimensions, see [Amazon CloudWatch dimensions for Aurora](dimensions.md "dimensions.md").
