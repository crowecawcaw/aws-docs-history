...
In the [tutorial](AuroraMySQL.Upgrading.Tutorial.md "AuroraMySQL.Upgrading.Tutorial.md"), the upgrade from Aurora MySQL version 2 to version 3 succeeded. But if the
