...
Aurora MySQL supports the following MySQL password policy features. For more information on these policies, see [MySQL Password Management documentation](https://dev.mysql.com/doc/refman/8.4/en/password-management.html "https://dev.mysql.com/doc/refman/8.4/en/password-management.html").
