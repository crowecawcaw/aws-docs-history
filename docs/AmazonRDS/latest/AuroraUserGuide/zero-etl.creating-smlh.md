...
To create a zero-ETL integration with Amazon SageMaker by using the Amazon RDS API, use the [`CreateIntegration`](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateIntegration.html) operation with the following parameters:
