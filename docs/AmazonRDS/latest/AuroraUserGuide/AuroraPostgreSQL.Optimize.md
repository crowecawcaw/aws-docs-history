...
- [Deleting plans](#AuroraPostgreSQL.Optimize.Maintenance.DeletingPlans "#AuroraPostgreSQL.Optimize.Maintenance.DeletingPlans")
- [Validating plans](#AuroraPostgreSQL.Optimize.Maintenance.ValidatingPlans "#AuroraPostgreSQL.Optimize.Maintenance.ValidatingPlans")
...
For more information, see [apg_plan_mgmt.delete_plan](AuroraPostgreSQL.Optimize.md#AuroraPostgreSQL.Optimize.Functions.delete_plan "AuroraPostgreSQL.Optimize.md#AuroraPostgreSQL.Optimize.Functions.delete_plan").
...
delete or disable invalid plans. For more information, see [Validating plans](#AuroraPostgreSQL.Optimize.Maintenance.ValidatingPlans "#AuroraPostgreSQL.Optimize.Maintenance.ValidatingPlans").
...
effect. For more information, see the [apg_plan_mgmt.max_plans](AuroraPostgreSQL.Optimize.md#AuroraPostgreSQL.Optimize.Parameters.max_plans "AuroraPostgreSQL.Optimize.md#AuroraPostgreSQL.Optimize.Parameters.max_plans") parameter.
