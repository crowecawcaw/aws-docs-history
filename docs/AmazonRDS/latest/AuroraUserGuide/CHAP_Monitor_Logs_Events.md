...
When you monitor your Amazon Aurora
...
- Performance
- Security
  [Monitoring metrics in an Amazon Aurora cluster](MonitoringAurora.md "MonitoringAurora.md") explains how to
  monitor your cluster using
...
- _Amazon CloudWatch Logs_ provides a way to monitor, store, and access your
  log files from Amazon Aurora instances, AWS CloudTrail, and other sources.
...
- _Database Activity Streams_ is an Amazon Aurora feature that
  provides a near real-time stream of the activity in your DB cluster. Amazon Aurora pushes activities to an Amazon Kinesis data stream. The Kinesis stream is
