...
- SQL Server catalogs (system views) – The
  ...
  see [Getting information from the Babelfish system catalog](babelfish-query-database.md "babelfish-query-database.md").
...
| ------------------------------------------------------------------------- | ---------- | --------- |
| Create objects in the schema without additional grants by the<br>DBO?     | No         | Yes       |
