...
For more information, see [What RDS Proxy tracks for Aurora MySQL databases](rds-proxy-pinning.md#rds-proxy-pinning.mysql-tracked-vars "rds-proxy-pinning.md#rds-proxy-pinning.mysql-tracked-vars"). Session state tracking is not
