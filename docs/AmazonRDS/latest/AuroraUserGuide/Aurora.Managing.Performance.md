...
To learn what kinds of data are included in the cluster volume, see [Amazon Aurora storage](Aurora.Overview.StorageReliability.md "Aurora.Overview.StorageReliability.md"). For details about the maximum
...
billing, see [How Aurora data storage is billed](Aurora.Overview.StorageReliability.md#aurora-storage-data-billing "Aurora.Overview.StorageReliability.md#aurora-storage-data-billing").
...
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Amazon Aurora MySQL      | See [Scaling Aurora MySQL DB instances](AuroraMySQL.Managing.Performance.md#AuroraMySQL.Managing.Performance.InstanceScaling "AuroraMySQL.Managing.Performance.md#AuroraMySQL.Managing.Performance.InstanceScaling")  |
| Amazon Aurora PostgreSQL | See [Scaling Aurora PostgreSQL DB instances](AuroraPostgreSQL.Managing.md#AuroraPostgreSQL.Managing.Performance.InstanceScaling "AuroraPostgreSQL.Managing.md#AuroraPostgreSQL.Managing.Performance.InstanceScaling") |
...
the optimizer runs. For more information, see [Managing query execution plans for Aurora PostgreSQL](AuroraPostgreSQL.Optimize.md "AuroraPostgreSQL.Optimize.md").
