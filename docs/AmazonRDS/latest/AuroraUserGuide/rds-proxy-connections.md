...
The maximum number of client connections configured in your application-side connection pool does not have to be limited to the **max\_connections** setting for RDS Proxy.
