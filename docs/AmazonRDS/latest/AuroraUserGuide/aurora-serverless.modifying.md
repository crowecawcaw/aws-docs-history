...
- **Autoscaling timeout and action** – This section specifies how long Aurora
  ...
  For more information, see [Timeout action for capacity changes](aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action "aurora-serverless-v1.how-it-works.md#aurora-serverless.how-it-works.timeout-action").
...
costs for using the DB cluster. For more information, see [DB instance class types](Concepts.DBInstanceClass.Types.md "Concepts.DBInstanceClass.Types.md").
