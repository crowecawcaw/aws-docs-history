...
DevOps Guru for RDS collects data about your Aurora databases from Amazon RDS Performance Insights. The most important metric is `DBLoad`. DevOps Guru for RDS consumes these detailed per-query and database counter metrics, analyzes them with machine learning, and publishes insights to the dashboard.
...
When you create an Aurora DB cluster or modify a cluster instance, you can turn on Performance Insights. For more information, see [Enabling and disabling detailed per-query and database counter metrics](USER_PerfInsights.Enabling.md).
...
![Turn on DevOps Guru when you create a DB cluster](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-enable-create.png)
...
![DevOps Guru banner.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-enable-banner.png)
...
![Turn on DevOps Guru in the RDS console.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-turn-on.png)
...
![Banner with a missing permissions error.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-permissions-error.png)
...
![The switch to turn on DevOps Guru for RDS.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-pi-toggle-off.png)
...
![Turn on DevOps Guru in the Amazon RDS console.](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/images/devops-guru-turn-on.png)
