...
- [Supported engine versions](#apg-waits.clientread.context.supported "#apg-waits.clientread.context.supported")
- [Context](#apg-waits.clientread.context "#apg-waits.clientread.context")
- [Likely causes of increased waits](#apg-waits.clientread.causes "#apg-waits.clientread.causes")
- [Actions](#apg-waits.clientread.actions "#apg-waits.clientread.actions")
...
- [Place the clients in the same Availability Zone and VPC subnet as the cluster](#apg-waits.clientread.actions.az-vpc-subnet "#apg-waits.clientread.actions.az-vpc-subnet")
- [Scale your client](#apg-waits.clientread.actions.scale-client "#apg-waits.clientread.actions.scale-client")
- [Use current generation instances](#apg-waits.clientread.actions.db-instance-class "#apg-waits.clientread.actions.db-instance-class")
- [Increase network bandwidth](#apg-waits.clientread.actions.increase-network-bandwidth "#apg-waits.clientread.actions.increase-network-bandwidth")
- [Monitor maximums for network performance](#apg-waits.clientread.actions.monitor-network-performance "#apg-waits.clientread.actions.monitor-network-performance")
- [Monitor for transactions in the "idle in transaction" state](#apg-waits.clientread.actions.check-idle-in-transaction "#apg-waits.clientread.actions.check-idle-in-transaction")
...
For information about DB instance classes, see [Amazon AuroraDB instance classes](Concepts.DBInstanceClass.md "Concepts.DBInstanceClass.md"). To determine the DB instance class that is equivalent to an Amazon EC2
