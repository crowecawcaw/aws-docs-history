...
**MySQL**
+ **When to choose**: Best for for web-based applications, content management systems, and workloads that require simple transactional operations. Its broad compatibility with frameworks and tools makes it an ideal choice for general-purpose use cases.
+ **Key features**: Read replicas, point-in-time recovery, multiple storage engines.
+ **Documentation**: [Amazon RDS for MySQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_MySQL.html)
...
+ **Documentation**: [Amazon RDS for PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_PostgreSQL.html)
...
+ **Documentation**: [Amazon RDS for Oracle](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Oracle.html)
...
+ **Documentation**: [Amazon RDS for Microsoft SQL Server](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_SQLServer.html)
...
+ **Documentation**: [Amazon RDS for MariaDB](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_MariaDB.html)
...
+ **Documentation**: [Amazon RDS for Db2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Db2.html)

## Next steps
<a name="choosing-engine-next-steps"></a>
