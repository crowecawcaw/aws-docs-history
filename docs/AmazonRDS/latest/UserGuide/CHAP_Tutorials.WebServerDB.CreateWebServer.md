...
[Launch an EC2 instance to connect with your DB instance](CHAP_Tutorials.WebServerDB.LaunchEC2.md "CHAP_Tutorials.WebServerDB.LaunchEC2.md"). The web server connects to the Amazon RDS DB
instance that you created in [Create an Amazon RDS DB instance](CHAP_Tutorials.WebServerDB.CreateDBInstance.md "CHAP_Tutorials.WebServerDB.CreateDBInstance.md").
...
VPC security group that you created in [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](CHAP_Tutorials.WebServerDB.CreateVPC.md "CHAP_Tutorials.WebServerDB.CreateVPC.md"). Make sure that
