...
When you use AWS CloudFormation, you can reuse your template to set up your
RDS resources
...
[AWS CloudFormation templates](../../../AWSCloudFormation/latest/UserGuide/template-guide.md "../../../AWSCloudFormation/latest/UserGuide/template-guide.md") are formatted text files in JSON or YAML. These templates describe the
resources that you want to provision in your AWS CloudFormation stacks. If you're unfamiliar with JSON or
...
in AWS CloudFormation. For more information, including examples of JSON and YAML templates for these
resources, see the [RDS resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_RDS.md "../../../AWSCloudFormation/latest/UserGuide/AWS_RDS.md")
