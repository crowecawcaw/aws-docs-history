...
1. (Optional) Choose **Add additional permissions** to add resources to the policy. For example, do the following:
   ...
   1. If you want Amazon RDS to access other buckets, add the ARNs for these buckets. Optionally, you can also grant access to all buckets and objects in Amazon S3.
