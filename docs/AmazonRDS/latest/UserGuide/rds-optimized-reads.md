...
- [Overview of RDS Optimized Reads](#rds-optimized-reads-overview "#rds-optimized-reads-overview")
- [Use cases for RDS Optimized Reads](#rds-optimized-reads-use-cases "#rds-optimized-reads-use-cases")
- [Best practices for RDS Optimized Reads](#rds-optimized-reads-best-practices "#rds-optimized-reads-best-practices")
- [Using RDS Optimized Reads](#rds-optimized-reads-using "#rds-optimized-reads-using")
- [Monitoring DB instances that use RDS Optimized Reads](#rds-optimized-reads-monitoring "#rds-optimized-reads-monitoring")
- [Limitations for RDS Optimized Reads](#rds-optimized-reads-limitations "#rds-optimized-reads-limitations")
...
[Amazon EC2
instance store](../../../AWSEC2/latest/UserGuide/InstanceStorage.md "../../../AWSEC2/latest/UserGuide/InstanceStorage.md") in the _Amazon Elastic Compute Cloud User Guide for
Linux Instances_.
...
about these metrics, see [Amazon CloudWatch instance-level metrics for Amazon RDS](rds-metrics.md#rds-cw-metrics-instance "rds-metrics.md#rds-cw-metrics-instance").
