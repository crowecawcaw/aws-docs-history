...
You can use the following stored procedure to determine whether your SQL Server DB instance is Single-AZ, Multi-AZ with DBM, Multi-AZ with Always On AGs, or Multi-AZ with block level replication:
...
## Return values
<a name="USER_SQLServerMultiAZ.ha_return_values"></a>
