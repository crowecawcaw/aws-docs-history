...
Amazon RDS Custom for SQL Server](custom-troubleshooting-sqlserver.md "custom-troubleshooting-sqlserver.md").

###### Topics

- [Viewing RDS Custom
  events](#custom-troubleshooting.support-perimeter.viewing-events "#custom-troubleshooting.support-perimeter.viewing-events")
- [Subscribing to RDS Custom
  events](#custom-troubleshooting.support-perimeter.subscribing "#custom-troubleshooting.support-perimeter.subscribing")
...
In addition to reviewing [Step 6: Configure your VPC for
RDS Custom for Oracle](custom-setup-orcl.md#custom-setup-orc.vpc-config "custom-setup-orcl.md#custom-setup-orc.vpc-config"), verify that the following are
...
IAM user or role](custom-setup-orcl.md#custom-setup-orcl.iam-user "custom-setup-orcl.md#custom-setup-orcl.iam-user"), or the number of S3 buckets
...
- The caller doesn't have permissions to get files from your S3 bucket that contains the installation media files. These
  permissions are described in [Step 7: Add necessary IAM
  permissions](custom-cev.md#custom-cev.preparing.iam "custom-cev.md#custom-cev.preparing.iam").
- Your IAM policy has an `aws:SourceIp` condition. Make sure to follow the recommendations in [AWS Denies access to
  ...
  caller has the S3 permissions described in [Step 5: Grant required permissions to your
...
information about RDS Custom for SQL Server, see [Fixing unsupported
...
are subject to change. For background on the support perimeter, see [RDS Custom support
