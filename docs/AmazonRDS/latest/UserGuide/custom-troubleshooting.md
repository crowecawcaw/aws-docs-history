...
The procedure for subscribing to events is the same for RDS Custom and Amazon RDS DB instances. For more information, see [Subscribing to Amazon RDS event notification](USER_Events.Subscribing.md "USER_Events.Subscribing.md").
...
- The caller doesn't have permissions to get files from your S3 bucket that contains the installation media files. These
  permissions are described in [Step 7: Add necessary IAM permissions](custom-cev.preparing.md#custom-cev.preparing.iam "custom-cev.preparing.md#custom-cev.preparing.iam").
...
promote it automatically. For more information, see [Promoting an RDS Custom for Oracle replica to a standalone DB instance](custom-rr.promoting.md "custom-rr.promoting.md").
