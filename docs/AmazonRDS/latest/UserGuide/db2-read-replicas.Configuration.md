...
+ The DB instance contains all databases that you want present on the DB instance. After replica creation, you can't create, drop, or native restore a database on the DB instance. Any calls to the [rdsadmin.create\_database](db2-sp-managing-databases.md#db2-sp-create-database), [rdsadmin.drop\_database](db2-sp-managing-databases.md#db2-sp-drop-database), or [rdsadmin.restore\_database](db2-sp-managing-databases.md#db2-sp-restore-database) stored procedures fail.
