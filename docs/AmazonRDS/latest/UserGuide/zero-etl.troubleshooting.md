...
- Your source database must be running a supported DB engine version. For a
  list of supported versions, see [Supported Regions and DB engines for Amazon RDS zero-ETL integrations](Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.md "Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.md").
- You correctly configured DB parameters. If the required parameters are
  ...
  [Step 1: Create a custom DB parameter group](zero-etl.setting-up.md#zero-etl.parameters "zero-etl.setting-up.md#zero-etl.parameters").
...
values. For more information, see [Step 1: Create a custom DB parameter group](zero-etl.setting-up.md#zero-etl.parameters "zero-etl.setting-up.md#zero-etl.parameters").
