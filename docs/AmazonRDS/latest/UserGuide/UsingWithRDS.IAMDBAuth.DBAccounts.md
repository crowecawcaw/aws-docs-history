...
- [Using IAM authentication with MariaDB and MySQL](#UsingWithRDS.IAMDBAuth.DBAccounts.MySQL "#UsingWithRDS.IAMDBAuth.DBAccounts.MySQL")
- [Using IAM authentication with PostgreSQL](#UsingWithRDS.IAMDBAuth.DBAccounts.PostgreSQL "#UsingWithRDS.IAMDBAuth.DBAccounts.PostgreSQL")
...
and that you have enabled IAM database authentication on your DB instance. For more information, see [Region and version availability](UsingWithRDS.IAMDBAuth.md#UsingWithRDS.IAMDBAuth.Availability "UsingWithRDS.IAMDBAuth.md#UsingWithRDS.IAMDBAuth.Availability") and [Enabling and disabling IAM database authentication](UsingWithRDS.IAMDBAuth.Enabling.md "UsingWithRDS.IAMDBAuth.Enabling.md").
