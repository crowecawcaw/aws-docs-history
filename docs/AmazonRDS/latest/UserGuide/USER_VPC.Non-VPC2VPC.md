...
- [Step 1: Create a VPC](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.CreatingVPC "USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.CreatingVPC")
- [Step 2: Create a DB subnet group](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.CreateDBSubnetGroup "USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.CreateDBSubnetGroup")
...
- [Updating the VPC for a DB instance](USER_VPC.VPC2VPC.md "USER_VPC.VPC2VPC.md")
  ...
  you can restore the data if the migration fails. For more information, see [Backing up, restoring, and exporting data](CHAP_CommonTasks.BackupRestore.md "CHAP_CommonTasks.BackupRestore.md").
