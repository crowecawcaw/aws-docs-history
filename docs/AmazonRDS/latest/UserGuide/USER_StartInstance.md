...
You can stop your Amazon RDS DB instance temporarily to save money. After you stop your DB instance, you can restart it to begin using it again. For more information about stopping a DB instance, see [Stopping an Amazon RDS DB instance temporarily](USER_StopInstance.md). 
