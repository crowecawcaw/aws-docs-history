...
For the list of switchover actions, see [Switchover actions](../AuroraUserGuide/blue-green-deployments-switching.md#blue-green-deployments-switching-actions "../AuroraUserGuide/blue-green-deployments-switching.md#blue-green-deployments-switching-actions"). When the switchover happens through RDS Proxy, note the following considerations:
