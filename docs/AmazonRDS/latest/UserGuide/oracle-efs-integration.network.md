...
- [Controlling network access with security groups](#oracle-efs-integration.network.inst-access "#oracle-efs-integration.network.inst-access")
- [Controlling network access with file system policies](#oracle-efs-integration.network.file-system-policy "#oracle-efs-integration.network.file-system-policy")
