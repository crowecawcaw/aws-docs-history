...
+ [Permission policies to create, modify and, delete resources in Amazon RDS](security_iam_id-based-policy-examples-create-and-modify-examples.md)
...
+ [Grant permission to tag Amazon RDS resources during creation](security_iam_id-based-policy-examples-grant-permissions-tags-on-create.md)
