...
- [Settings for RDS Proxy](#rds-proxy-best-practices.configuration-settings "#rds-proxy-best-practices.configuration-settings")
- [Aligning application, proxy, and database configuration](#rds-proxy-best-practices.configuration.alignment "#rds-proxy-best-practices.configuration.alignment")
- [Database configuration](#rds-proxy-best-practices.configuration.alignment.database "#rds-proxy-best-practices.configuration.alignment.database")
- [Application configuration](#rds-proxy-best-practices.configuration.alignment.application "#rds-proxy-best-practices.configuration.alignment.application")
...
For more information, see [MaxConnectionsPercent](rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.maxconnectionspercent "rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.maxconnectionspercent").
...
- If you did not explicitly set the connection limit (such as the `max_connections` parameter) in your
  ...
  [Maximum number of database connections](CHAP_Limits.md#RDS_Limits.MaxConnections "CHAP_Limits.md#RDS_Limits.MaxConnections") in the _Amazon RDS User Guide_,
  [Maximum connections to an Aurora MySQL DB instance](../AuroraUserGuide/AuroraMySQL.Managing.Performance.md#AuroraMySQL.Managing.MaxConnections "../AuroraUserGuide/AuroraMySQL.Managing.Performance.md#AuroraMySQL.Managing.MaxConnections"), and
  [Maximum connections to an Aurora PostgreSQL DB instance](../AuroraUserGuide/AuroraPostgreSQL.Managing.md#AuroraPostgreSQL.Managing.MaxConnections "../AuroraUserGuide/AuroraPostgreSQL.Managing.md#AuroraPostgreSQL.Managing.MaxConnections") in the _Amazon Aurora User Guide_.
- Aurora Serverless v2 database instances determine their connection limit based on
  ...
  [Maximum connections for Aurora Serverless v2](../AuroraUserGuide/aurora-serverless-v2.setting-capacity.md#aurora-serverless-v2.max-connections "../AuroraUserGuide/aurora-serverless-v2.setting-capacity.md#aurora-serverless-v2.max-connections") in the _Amazon Aurora User Guide_.
...
- When using RDS Proxy with Aurora Global Database clusters and Write Forwarding
  ...
  [Aurora MySQL](../AuroraUserGuide/aurora-global-database-write-forwarding-ams.md#aurora-global-database-write-forwarding-params-ams "../AuroraUserGuide/aurora-global-database-write-forwarding-ams.md#aurora-global-database-write-forwarding-params-ams") and
  [Aurora PostgreSQL](../AuroraUserGuide/aurora-global-database-write-forwarding-apg.md#aurora-global-database-write-forwarding-params-apg "../AuroraUserGuide/aurora-global-database-write-forwarding-apg.md#aurora-global-database-write-forwarding-params-apg") in the _Amazon Aurora User Guide_.
...
- If the target serves multiple proxies, the combined value of
  ...
  don't need to use multiple proxies per database for redundancy. For more information, see [Using multiple proxies with one target](rds-proxy-best-practices.usage-scenarios.md#rds-proxy-best-practices.multiple-proxies "rds-proxy-best-practices.usage-scenarios.md#rds-proxy-best-practices.multiple-proxies").
...
For more information, see [MaxIdleConnectionsPercent](rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.maxidleconnectionspercent "rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.maxidleconnectionspercent").
...
- Connections count as idle when they are available for reuse in the proxy's
  ...
  [Avoiding pinning an RDS Proxy](rds-proxy-pinning.md "rds-proxy-pinning.md").
...
For more information, see [IdleClientTimeout](rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.idleclienttimeout "rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.idleclienttimeout").
...
[MaxIdleConnectionsPercent](#rds-proxy-best-practices.configuration.maxidleconnectionspercent "#rds-proxy-best-practices.configuration.maxidleconnectionspercent").
...
For more information, see [ConnectionBorrowTimeout](rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.connectionborrowtimeout "rds-proxy-connections.md#rds-proxy-connection-pooling-tuning.connectionborrowtimeout").
...
- [Creating a proxy](rds-proxy-creating.md "rds-proxy-creating.md") and
  [Modifying a proxy](rds-proxy-modifying-proxy.md "rds-proxy-modifying-proxy.md") for Amazon RDS.
- [Creating a proxy](../AuroraUserGuide/rds-proxy-creating.md "../AuroraUserGuide/rds-proxy-creating.md") and
  [Modifying a proxy](../AuroraUserGuide/rds-proxy-modifying-proxy.md "../AuroraUserGuide/rds-proxy-modifying-proxy.md") for Amazon Aurora.
...
pinning caused by explicit `SET` statements. For more information, see [Considerations for connecting to PostgreSQL](rds-proxy-connecting.md#rds-proxy-connecting-postgresql "rds-proxy-connecting.md#rds-proxy-connecting-postgresql").
...
4. If possible, move session configuration statements to the proxy layer using the
   ...
   [Initialization queries and pinning filters](#rds-proxy-best-practices.configuration.pinning-filters "#rds-proxy-best-practices.configuration.pinning-filters").
