...
- [Step 3: Create an IAM
  role for Amazon RDS to access the Directory Service](#postgresql-kerberos-setting-up.CreateIAMRole "#postgresql-kerberos-setting-up.CreateIAMRole")
- [Step 4: Create and
...
role for Amazon RDS to access the Directory Service
