...
![Console banner showing resources moved from dismissed to active recommendations.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-DismissToActive-Banner.png)

   The following example shows the banner with the failure message.  
![Console banner showing the resource that failed to update.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-DismissToActive-Banner-Failure.png)
