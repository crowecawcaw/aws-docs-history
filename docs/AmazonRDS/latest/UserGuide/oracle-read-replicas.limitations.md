...
- [Version and licensing requirements for RDS for Oracle replicas](#oracle-read-replicas.limitations.versions-and-licenses "#oracle-read-replicas.limitations.versions-and-licenses")
- [Option group limitations for RDS for Oracle replicas](#oracle-read-replicas.limitations.options "#oracle-read-replicas.limitations.options")
...
- [Oracle Data Guard requirements and limitations for RDS for Oracle replicas](#oracle-read-replicas.data-guard.requirements "#oracle-read-replicas.data-guard.requirements")
...
- To avoid blocking connections from the Data Guard broker process, don't enable
  restricted sessions. For more information about restricted sessions, see [Enabling and disabling restricted sessions](Appendix.Oracle.CommonDBATasks.RestrictedSession.md "Appendix.Oracle.CommonDBATasks.RestrictedSession.md").
...
- Block change tracking is supported for read-only replicas, but not for mounted replicas. You can
  ...
  information, see [Enabling and disabling block change tracking](Appendix.Oracle.CommonDBATasks.BlockChangeTracking.md "Appendix.Oracle.CommonDBATasks.BlockChangeTracking.md").
