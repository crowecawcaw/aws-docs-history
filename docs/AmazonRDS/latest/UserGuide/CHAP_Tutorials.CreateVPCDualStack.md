...
![VPC scenario for dual-stack mode.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/con-VPC-sec-grp-dual-stack.png)
...
1. In the AWS Management Console, choose the Region to create your VPC in. This example uses the US East (Ohio) Region.

1. Choose **VPC dashboard**. To begin creating a VPC, choose **Create VPC**.
...
1. In the console, choose the AWS Region where you want to create the DB instance. This example uses the US East (Ohio) Region.
