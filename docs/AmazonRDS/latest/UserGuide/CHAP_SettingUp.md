...
The following list describes the rules for each VPC option:
    ...
    + **Default VPC** – If your AWS account has a
     ...
     instance, do the following:
    	...
    	- Make sure to create a *VPC security group* that authorizes
...
requirements and security group. To do so, follow the instructions in [Creating an Amazon RDS DB instance](USER_CreateDBInstance.md "USER_CreateDBInstance.md"). For
