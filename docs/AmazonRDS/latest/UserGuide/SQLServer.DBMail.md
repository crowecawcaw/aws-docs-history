...
However, you can use SQL Server Agent jobs to attach files. For more information on SQL Server Agent, see [Using SQL Server Agent for Amazon RDS](Appendix.SQLServer.CommonDBATasks.Agent.md "Appendix.SQLServer.CommonDBATasks.Agent.md") and [SQL Server Agent](https://docs.microsoft.com/en-us/sql/ssms/agent/sql-server-agent "https://docs.microsoft.com/en-us/sql/ssms/agent/sql-server-agent") in the Microsoft
documentation.
