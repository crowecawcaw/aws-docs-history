...
[Step 1: Configure your RDS for PostgreSQL DB instance for outbound connections to AWS Lambda](PostgreSQL-Lambda.md#PostgreSQL-Lambda-network "PostgreSQL-Lambda.md#PostgreSQL-Lambda-network"). For more
information, see
[Interface VPC endpoints (AWS PrivateLink)](../../../vpc/latest/privatelink/vpce-interface.md#vpce-private-dns "../../../vpc/latest/privatelink/vpce-interface.md#vpce-private-dns").
