...
![Viewing metrics for running queries.](images/perf_insights_per_sql_sql.png) 6. Choose which statistics to display by choosing the gear icon. For descriptions of the SQL
