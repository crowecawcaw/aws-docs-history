...
by Windows Server 2019 and operates at the 2016 Forest and Domain functional levels. Directory Service creates the domain controllers in different subnets in an
...
move on to next step in [Network configuration port rules](custom-sqlserver-WinAuth.NWConfigPorts.md "custom-sqlserver-WinAuth.NWConfigPorts.md").
...
2. Allow the DB instance's security group to recieve inbound traffic from the directory's security group.
   For more information, see [Network configuration port rules](custom-sqlserver-WinAuth.NWConfigPorts.md "custom-sqlserver-WinAuth.NWConfigPorts.md").
