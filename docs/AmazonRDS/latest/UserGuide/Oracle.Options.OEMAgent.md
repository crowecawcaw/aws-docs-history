...
| **MINIMUM_TLS_VERSION**            | No       | `TLSv1` (default), `TLSv1.2`                                                                                                                                                                             | A value that specifies the minimum TLS version supported by the<br>OEM Agent while the agent listens as a server. Desupported agent<br>versions only support the `TLSv1` setting.<br>To connect 13.5.0.0 (v1-v3) or 24.1.0.0.v1 to a 24.1 OMS host, set<br>this to `TLSv1.2`.                                                                                                            |
| **TLS_CIPHER_SUITE**               | No       | See Option settings for Management Agent.                                                                                                                                                                | A value that specifies the TLS cipher suite used by the OEM Agent<br>while the agent listens as a server.                                                                                                                                                                                                                                                                                |
