...
instance by using the [AWS Management Console](USER_CreateDBInstance.md "USER_CreateDBInstance.md"), the
Amazon RDS API [CreateDBInstance](../APIReference/API_CreateDBInstance.html.md "../APIReference/API_CreateDBInstance.html.md") action, or the AWS CLI [create-db-instance](../../../cli/latest/reference/rds/create-db-instance.md "../../../cli/latest/reference/rds/create-db-instance.md") command.
...
more information, see [Multi-AZ deployments using Microsoft SQL Server Database Mirroring or Always On availability groups](CHAP_SQLServer.md#SQLServer.Concepts.General.Mirroring "CHAP_SQLServer.md#SQLServer.Concepts.General.Mirroring").

When you request a point-in-time restore, you specify the time to restore to. The time is
shown in your local time zone. For more information, see [Restoring a DB instance to a specified time for Amazon RDS](USER_PIT.md "USER_PIT.md").
...
- We strongly recommend that you don't restore a backup file from one time zone
  ...
  effects of the time zone change. For more information, see [Importing and exporting SQL Server databases using native backup and restore](SQLServer.Procedural.Importing.md "SQLServer.Procedural.Importing.md").
...
| GMT Standard Time               | (UTC)                | Dublin, Edinburgh, Lisbon, London                 | This time zone isn't the same as Greenwich Mean Time.<br>This time zone does observe daylight saving time. |
