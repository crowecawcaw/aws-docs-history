...
For a list of scenarios involving Amazon RDS DB instances in a VPC and outside of a VPC, see [Scenarios for accessing a DB instance in a VPC](USER_VPC.Scenarios.md "USER_VPC.Scenarios.md").

###### Topics

- [Working with a DB instance in a VPC](#Overview.RDSVPC.Create "#Overview.RDSVPC.Create")
...
- [Amazon RDS IP addressing](#USER_VPC.IP_addressing "#USER_VPC.IP_addressing")
- [Hiding a DB instance in a VPC from the internet](#USER_VPC.Hiding "#USER_VPC.Hiding")
- [Creating a DB instance in a VPC](#USER_VPC.InstanceInVPC "#USER_VPC.InstanceInVPC")
...
For more information see, [DB instance class types](Concepts.DBInstanceClass.Types.md "Concepts.DBInstanceClass.Types.md"). For information about Nitro instances, see
...
CIDR block associated with it. For more information, see [Amazon RDS IP addressing](#USER_VPC.IP_addressing "#USER_VPC.IP_addressing") and
...
- [Working with dual-stack mode DB instances](#USER_VPC.IP_addressing.dual-stack-working-with "#USER_VPC.IP_addressing.dual-stack-working-with")
- [Modifying IPv4-only DB instances to use dual-stack mode](#USER_VPC.IP_addressing.dual-stack-modifying-ipv4 "#USER_VPC.IP_addressing.dual-stack-modifying-ipv4")
- [Region and version availability](#USER_VPC.IP_addressing.RegionVersionAvailability "#USER_VPC.IP_addressing.RegionVersionAvailability")
- [Limitations for dual-stack network DB instances](#USER_VPC.IP_addressing.dual-stack-limitations "#USER_VPC.IP_addressing.dual-stack-limitations")
...
see [Creating an Amazon RDS DB instance](USER_CreateDBInstance.md "USER_CreateDBInstance.md"). For more information about
...
RDS for MariaDB Single-AZ instances, we recommend that you run the [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md "../../../cli/latest/reference/rds/modify-db-instance.md") command with only the
...
_Amazon VPC User Guide_. 3. Modify the DB instance to
...
If you are using the AWS CLI, run the [describe-db-instances](../../../cli/latest/reference/rds/describe-db-instances.md "../../../cli/latest/reference/rds/describe-db-instances.md") command, and make sure that the
...
and Region availability with dual-stack mode, see [Supported Regions and DB engines for dual-stack mode in Amazon RDS](Concepts.RDS_Fea_Regions_DB-eng.Feature.DualStackMode.md "Concepts.RDS_Fea_Regions_DB-eng.Feature.DualStackMode.md").
...
instances. For an illustration of this scenario, see [A DB instance in a VPC accessed by an Amazon EC2 instance in the same VPC](USER_VPC.Scenarios.md#USER_VPC.Scenario1 "USER_VPC.Scenarios.md#USER_VPC.Scenario1").
...
**Public access** option, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
...
- [Step 2: Create a DB subnet group](#USER_VPC.CreateDBSubnetGroup "#USER_VPC.CreateDBSubnetGroup")
- [Step 3: Create a VPC security group](#USER_VPC.CreateVPCSecurityGroup "#USER_VPC.CreateVPCSecurityGroup")
- [Step 4: Create a DB instance in the VPC](#USER_VPC.CreateDBInstanceInVPC "#USER_VPC.CreateDBInstanceInVPC")
...
For more information, see [Create a VPC with private and public subnets](CHAP_Tutorials.WebServerDB.CreateVPC.md#CHAP_Tutorials.WebServerDB.CreateVPC.VPCAndSubnets "CHAP_Tutorials.WebServerDB.CreateVPC.md#CHAP_Tutorials.WebServerDB.CreateVPC.VPCAndSubnets"), or see
[Create a
...
![Create a DB subnet group.](images/RDSVPC101.png)
...
instructions on how to create a security group for your DB instance, see [Create a VPC security group for a private DB instance](CHAP_Tutorials.WebServerDB.CreateVPC.md#CHAP_Tutorials.WebServerDB.CreateVPC.SecurityGroupDB "CHAP_Tutorials.WebServerDB.CreateVPC.md#CHAP_Tutorials.WebServerDB.CreateVPC.SecurityGroupDB"), or
...
For details on how to create a DB instance, see [Creating an Amazon RDS DB instance](USER_CreateDBInstance.md "USER_CreateDBInstance.md").
