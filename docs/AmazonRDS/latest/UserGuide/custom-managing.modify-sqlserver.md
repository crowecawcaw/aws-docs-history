...
5. Make the following changes as needed:
   ...
   [DB instance class support for RDS Custom for SQL Server](custom-reqs-limits.instancesMS.md "custom-reqs-limits.instancesMS.md") 3. Change the value for **Backup retention
