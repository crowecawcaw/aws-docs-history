...
![The default login identity for Credentials in the Create database page is postgres.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/default-login-identity-apg-rpg.png)
