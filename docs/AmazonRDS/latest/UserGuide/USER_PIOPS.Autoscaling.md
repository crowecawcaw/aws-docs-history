...
+ Autoscaling can't completely prevent storage-full situations for large data loads. This is because further storage modifications can't be made until storage optimization completes on the instance, and are limited to a maximum of four modifications within any 24-hour period.
...
1.  In the Amazon RDS console, choose the AWS Region where you want to create the DB instance. 
