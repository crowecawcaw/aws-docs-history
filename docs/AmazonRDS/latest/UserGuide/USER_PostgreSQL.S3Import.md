...
see [Importing an Amazon S3 file that uses a custom delimiter](USER_PostgreSQL.S3Import.md#USER_PostgreSQL.S3Import.FileFormats.CustomDelimiter "USER_PostgreSQL.S3Import.md#USER_PostgreSQL.S3Import.FileFormats.CustomDelimiter").
...
- `region` – The AWS Region that the file
  ...
  values, see [Regions, Availability Zones, and Local Zones](Concepts.md "Concepts.md").
