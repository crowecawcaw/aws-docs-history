...
**Topics**
+ [Installing the aws\_s3 extension](USER_PostgreSQL.S3Import.InstallExtension.md)
...
+ [Importing data from Amazon S3 to your RDS for PostgreSQL DB instance](USER_PostgreSQL.S3Import.FileFormats.md)
