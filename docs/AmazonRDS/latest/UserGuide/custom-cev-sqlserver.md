...
- [Preparing to create a CEV for RDS Custom for SQL Server](custom-cev-sqlserver.md "custom-cev-sqlserver.md")
- [Creating a CEV for RDS Custom for SQL Server](custom-cev-sqlserver.md "custom-cev-sqlserver.md")
