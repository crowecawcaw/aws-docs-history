...
- [Preparing to create a CEV for RDS Custom for SQL Server](custom-cev-sqlserver.preparing.md "custom-cev-sqlserver.preparing.md")
- [Creating a CEV for RDS Custom for SQL Server](custom-cev-sqlserver.create.md "custom-cev-sqlserver.create.md")
- [Modifying a CEV for RDS Custom for SQL Server](custom-cev-sqlserver-modifying.md "custom-cev-sqlserver-modifying.md")
- [Viewing CEV details for Amazon RDS Custom for SQL Server](custom-viewing-sqlserver.md "custom-viewing-sqlserver.md")
- [Deleting a CEV for RDS Custom for SQL Server](custom-cev-sqlserver-deleting.md "custom-cev-sqlserver-deleting.md")
