...
- You dropped a tempfile from the tablespace on your read replica.
  For more information, see [Dropping tempfiles on a read replica](Appendix.Oracle.CommonDBATasks.dropping-tempfiles-replica.md "Appendix.Oracle.CommonDBATasks.dropping-tempfiles-replica.md").
...
| ------------------- | --------- | ------- | -------- | ------------------------------------------------------------- |
| `p_tablespace_name` | varchar   | —       | Yes      | The name of the temporary tablespace on your read<br>replica. |
