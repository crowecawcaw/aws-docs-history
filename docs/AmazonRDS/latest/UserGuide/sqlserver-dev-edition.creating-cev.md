...
+ Use the [create-custom-db-engine-version](https://docs.aws.amazon.com/cli/latest/reference/rds/create-custom-db-engine-version.html) command with `--engine sqlserver-dev-se`.
...
3. --engine-version {{17.00.4045.5.my-dev-cev}} \
4. --region us-west-2 \
