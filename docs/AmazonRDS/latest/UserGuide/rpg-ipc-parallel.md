...
This query shows the number of active parallel worker processes. A high value may indicate that your `max\_parallel\_workers` is configured with a high value and you might want to consider reducing it.
