...
![VPC scenario with a public web server and a private database.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/con-VPC-sec-grp.png)
...
![Adding a security group to another security group rules.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/con-vpc-add-sg-rule.png)
...
![A DB instance in a VPC accessed by an Amazon EC2 instance in a different VPC.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/RDSVPC2EC2VPC.png)
...
![DB instance in a VPC accessed by a client application through the internet.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/GS-VPC-network.png)
...
![DB instances. in a VPC accessed by a private network.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/site-to-site-vpn-connection.png)
