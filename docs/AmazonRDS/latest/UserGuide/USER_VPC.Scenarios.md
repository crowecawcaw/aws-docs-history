...
subnets for this scenario, see [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](CHAP_Tutorials.WebServerDB.CreateVPC.md "CHAP_Tutorials.WebServerDB.CreateVPC.md").
...
instance, see [Connecting to an Amazon RDS DB instance](CHAP_CommonTasks.Connect.md "CHAP_CommonTasks.Connect.md")
.
...
![DB instance in a VPC accessed by a client application through the internet.](images/GS-VPC-network.png)
...
[Creating a DB instance in a VPC](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC "USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC").
