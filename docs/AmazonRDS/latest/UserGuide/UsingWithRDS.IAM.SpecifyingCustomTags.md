...
For more information about adding tags to an Amazon RDS resource, see [Amazon Resource Names (ARNs) in Amazon RDS](USER_Tagging.ARN.md "USER_Tagging.ARN.md").
...
information about using ARNs with Amazon RDS resources, see [Amazon Resource Names (ARNs) in Amazon RDS](USER_Tagging.ARN.md "USER_Tagging.ARN.md").
