...
file size for older 32-bit file systems. For more information, see [Upgrading the storage file system for a DB instance](USER_PIOPS.UpgradeFileSystem.md "USER_PIOPS.UpgradeFileSystem.md").
...
information, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md") and [Configuring and managing a Multi-AZ deployment for Amazon RDS](Concepts.MultiAZ.md "Concepts.MultiAZ.md").
