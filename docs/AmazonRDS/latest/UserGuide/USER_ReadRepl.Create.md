...
subnet group. For more information, see [Working with a DB instance in a VPC](USER_VPC.WorkingWithRDSInstanceinaVPC.md "USER_VPC.WorkingWithRDSInstanceinaVPC.md").
...
[Upgrading the storage file system for a DB instance](USER_PIOPS.UpgradeFileSystem.md "USER_PIOPS.UpgradeFileSystem.md"). 9. For **Availability**, choose whether to create a standby
...
setting, see [Settings for DB instances](USER_CreateDBInstance.Settings.md "USER_CreateDBInstance.Settings.md"). 11. To create an encrypted read replica, expand **Additional
...
the source DB instance, see [Encrypting Amazon RDS resources](Overview.Encryption.md "Overview.Encryption.md"). 12. Choose **Create read replica**.
