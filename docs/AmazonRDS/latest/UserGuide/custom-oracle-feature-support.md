...
| db.m6id   | `db.m6id.metal`     |                     | db.m6in             | `db.m6in.metal`     |
...
| db.r6id   | `db.r6id.metal`     |                     | db.r6in             | `db.r6in.metal`     |
...
| db.t3     | `db.t3.medium`      | `db.t3.large`       | `db.t3.xlarge`      | `db.t3.2xlarge`     | ## Option group support for RDS Custom for Oracle You can specify an option group when you create or modify an RDS Custom for Oracle DB instance. For more information, see [Working with option groups in RDS Custom for Oracle](custom-oracle-option-groups.md "custom-oracle-option-groups.md"). |
