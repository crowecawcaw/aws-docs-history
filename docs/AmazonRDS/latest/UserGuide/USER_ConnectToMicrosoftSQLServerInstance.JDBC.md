...
see
[Security group considerations](USER_ConnectToMicrosoftSQLServerInstance.Security.md "USER_ConnectToMicrosoftSQLServerInstance.Security.md")
and
[Troubleshooting connections to your SQL Server DB instance](USER_ConnectToMicrosoftSQLServerInstance.Troubleshooting.md "USER_ConnectToMicrosoftSQLServerInstance.Troubleshooting.md"). 9. In the query pane, enter the following SQL query.
