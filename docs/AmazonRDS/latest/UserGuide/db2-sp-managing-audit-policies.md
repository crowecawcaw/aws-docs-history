...
- [rdsadmin.configure\_db\_audit](#db2-sp-configure-db-audit "#db2-sp-configure-db-audit")
- [rdsadmin.disable\_db\_audit](#db2-sp-disable-db-audit "#db2-sp-disable-db-audit")
...
| --------------------------------------------------------------------------------------------------- | ----------------------- |
| `ALL`<br>`AUDIT`<br>`CHECKING`<br>`CONTEXT`<br>`OBJMAINT`<br>`SECMAINT`<br>`SYSADMIN`<br>`VALIDATE` | `BOTH                   | FAILURE                              | SUCCESS      | NONE`           |
| `ERROR`                                                                                             | `AUDIT                  | NORMAL`. The default is<br>`NORMAL`. |
...
want to add. For more information, see [Examples](#db2-sp-configure-db-audit-examples "#db2-sp-configure-db-audit-examples").
...
default). To change that setting to `AUDIT`, follow [Example 6: Specifying the ERROR category](#example-6 "#example-6").
