...
from [Step 5: Prepare the CEV manifest](custom-cev.preparing.md#custom-cev.preparing.manifest "custom-cev.preparing.md#custom-cev.preparing.manifest"). The example sets new
...
- `--database-installation-files-s3-bucket-name` – Specify
  the same bucket name that you specified in [Step 3: Upload your installation files to Amazon S3](custom-cev.preparing.md#custom-cev.preparing.s3 "custom-cev.preparing.md#custom-cev.preparing.s3"). The AWS Region in which you run
...
- `--database-installation-files-s3-prefix` – Specify the
  folder name that you specified in [Step 3: Upload your installation files to Amazon S3](custom-cev.preparing.md#custom-cev.preparing.s3 "custom-cev.preparing.md#custom-cev.preparing.s3").
