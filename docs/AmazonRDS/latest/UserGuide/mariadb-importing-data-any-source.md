...
You can store the flat files anywhere. However, when you load the data in [Step 5](#mariadb-importing-data-any-source-load-data "#mariadb-importing-data-any-source-load-data"), you must invoke
...
more information, see [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md "../../../cli/latest/reference/rds/modify-db-instance.md").
