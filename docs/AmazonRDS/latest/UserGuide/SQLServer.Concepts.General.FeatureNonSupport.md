...
- Link servers with Oracle OLEDB in Amazon RDS for SQL Server. For more information,
  see [Support for Linked Servers with Oracle OLEDB in Amazon RDS for SQL Server](Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.md "Appendix.SQLServer.Options.LinkedServers_Oracle_OLEDB.md").
