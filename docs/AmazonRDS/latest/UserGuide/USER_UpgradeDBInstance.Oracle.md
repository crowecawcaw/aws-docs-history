...
6. Decide when to schedule your DB instance upgrade. To apply the changes
   ...
   option can cause an outage in some cases. For more information, see [Using the schedule modifications setting](USER_ModifyInstance.md "USER_ModifyInstance.md").
