...
- [What RDS Proxy tracks for RDS for SQL Server databases](#rds-proxy-pinning.sql-server-tracked-vars "#rds-proxy-pinning.sql-server-tracked-vars")
- [What RDS Proxy tracks for RDS for MariaDB and RDS for MySQL databases](#rds-proxy-pinning.mysql-tracked-vars "#rds-proxy-pinning.mysql-tracked-vars")
...
- Setting a user or system variable (with some exceptions) pins the session to the
  ...
  filters property. For more information, see [Creating a proxy for Amazon RDS](rds-proxy-creating.md "rds-proxy-creating.md") and [Modifying an RDS Proxy](rds-proxy-modifying-proxy.md "rds-proxy-modifying-proxy.md").
