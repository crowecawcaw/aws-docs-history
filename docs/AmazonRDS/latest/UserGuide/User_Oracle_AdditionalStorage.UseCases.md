...
- After the creation of the directory, follow the steps described in [Importing using Oracle Data Pump](Oracle.Procedural.Importing.DataPump.md "Oracle.Procedural.Importing.DataPump.md") to export and import your data to the new directory.
