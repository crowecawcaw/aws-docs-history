...
For a complete list of dimensions for the Amazon RDS engines, see [DB load sliced by dimensions](USER_PerfInsights.UsingDashboard.md#USER_PerfInsights.UsingDashboard.Components.AvgActiveSessions.dims "USER_PerfInsights.UsingDashboard.md#USER_PerfInsights.UsingDashboard.Components.AvgActiveSessions.dims").
...
- Oracle: [Analyzing Oracle execution plans using the Performance Insights dashboard for Amazon RDS](USER_PerfInsights.UsingDashboard.md "USER_PerfInsights.UsingDashboard.md")
- SQL Server: [Analyzing SQL Server execution plans using the Performance Insights dashboard for Amazon RDS](USER_PerfInsights.UsingDashboard.md "USER_PerfInsights.UsingDashboard.md")
...
query text limit. For more information, see [Accessing more SQL text in the Performance Insights dashboard](USER_PerfInsights.UsingDashboard.md "USER_PerfInsights.UsingDashboard.md").
