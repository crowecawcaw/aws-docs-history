...
For more information, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md"). 4. Reboot the DB instance for the parameter change to take effect.
