...
availability of RDS for Oracle with Kerberos authentication, see [Supported
...
deprecated for RDS for Oracle DB instances. For more information, see [RDS for Oracle DB instance classes](Oracle.Concepts.md "Oracle.Concepts.md").
