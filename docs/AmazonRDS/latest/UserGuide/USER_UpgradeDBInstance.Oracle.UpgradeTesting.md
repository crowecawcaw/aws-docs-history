...
1. Review the Oracle upgrade documentation for the new version of the database engine
   ...
   [Database Upgrade Guide](https://docs.oracle.com/en/database/oracle/oracle-database/19/upgrd/intro.html "https://docs.oracle.com/en/database/oracle/oracle-database/19/upgrd/intro.html")
...
3. If your DB instance uses a custom parameter group,
   ...
   For more information, see
   [Parameter group considerations](USER_UpgradeDBInstance.Oracle.OGPG.md#USER_UpgradeDBInstance.Oracle.OGPG.PG "USER_UpgradeDBInstance.Oracle.OGPG.md#USER_UpgradeDBInstance.Oracle.OGPG.PG").
