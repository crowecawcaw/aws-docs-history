...
1. Review the Oracle upgrade documentation for the new version of the database engine to see if there are compatibility issues that might affect your database or applications. For more information, see [Database Upgrade Guide](https://docs.oracle.com/en/database/oracle/oracle-database/19/upgrd/intro.html) in the Oracle documentation. 
