...
`LOCATOR` option, you can lose data. For more information, see [Backing up, restoring, and exporting data](CHAP_CommonTasks.BackupRestore.md "CHAP_CommonTasks.BackupRestore.md"). 2. Check whether any existing objects reference data types or features of the `LOCATOR` option.
