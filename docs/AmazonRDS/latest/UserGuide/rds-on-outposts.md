...
For information about each setting when creating a DB instance, see [Settings for DB instances](USER_CreateDBInstance.md "USER_CreateDBInstance.md"). 11. Choose **Create database**.
...
instance. For more information about modifying a DB instance, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.md "Overview.DBInstance.md"). 2. Choose the name of the new DB instance on the **Databases** page.
