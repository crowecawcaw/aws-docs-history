...
easily detach and remove it after migration completes, freeing up storage costs. 6. Verify source database configuration
...
- [When to use RMAN active duplication](#RDS-Custom-for-Oracle-end-of-support-option-1-when-to-use "#RDS-Custom-for-Oracle-end-of-support-option-1-when-to-use")
- [RMAN active duplication overview](#RDS-Custom-for-Oracle-end-of-support-option-1-overview "#RDS-Custom-for-Oracle-end-of-support-option-1-overview")
- [Migration workflow for RMAN active duplication](#RDS-Custom-for-Oracle-end-of-support-option-1-migration-workflow "#RDS-Custom-for-Oracle-end-of-support-option-1-migration-workflow")
- [Step 1: Pause Amazon RDS Custom automation](#RDS-Custom-for-Oracle-end-of-support-option-1-step-1 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-1")
- [Step 2: Create password and parameter files](#RDS-Custom-for-Oracle-end-of-support-option-1-step-2 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-2")
- [Step 3: Transfer files to EC2](#RDS-Custom-for-Oracle-end-of-support-option-1-step-3 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-3")
- [Step 4: Edit parameter file on EC2](#RDS-Custom-for-Oracle-end-of-support-option-1-step-4 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-4")
- [Step 5: Configure TNS and listener](#RDS-Custom-for-Oracle-end-of-support-option-1-step-5 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-5")
- [Step 6: Start database in NOMOUNT on EC2](#RDS-Custom-for-Oracle-end-of-support-option-1-step-6 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-6")
- [Step 7: Perform RMAN active duplication](#RDS-Custom-for-Oracle-end-of-support-option-1-step-7 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-7")
- [Step 8: Open PDBs (multitenant only)](#RDS-Custom-for-Oracle-end-of-support-option-1-step-8 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-8")
- [Step 9: Remove RDS Custom objects](#RDS-Custom-for-Oracle-end-of-support-option-1-step-9 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-9")
- [Step 10: Configure automatic startup](#RDS-Custom-for-Oracle-end-of-support-option-1-step-10 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-10")
- [Step 11: Final validation](#RDS-Custom-for-Oracle-end-of-support-option-1-step-11 "#RDS-Custom-for-Oracle-end-of-support-option-1-step-11")
...
Adjust the number to match the version available in your installation. 3. Retry the drop:
...
- Use [AWS Backup](https://aws.amazon.com/backup/ "https://aws.amazon.com/backup/") for EBS volume snapshots
...
| **Migration duration**           | Single duplication operation             | Initial setup + continuous sync                   |
| **Continuous synchronization**   | No                                       | Yes                                               |
...
| **Cutover process**              | Redirect applications to EC2             | Switchover command + redirect applications        |
...
| ---------------------------------- | --------------------------------------- | ----------------------------------------------------------------------------------------- |
| **Database type**                  | Single-instance non-CDB (e.g., `ORCL`)  | CDB (source: `RDSCDB`, target: `ORCL`) with `CDB$ROOT` + `PDB$SEED` + one<br>or more PDBs |
...
| **Parameter file**                 | Standard init parameters                | Must include `enable_pluggable_database`=`TRUE`                                           |
...
| **RDS-specific cleanup**           | Drop users/objects from single database | Drop common users from `CDB$ROOT` (cascades to PDBs); handle C## users                    |
| **TNS/Listener configuration**     | Single service for database             | CDB service + individual PDB services dynamically registered                              |
...
- [Amazon RDS Custom for Oracle User
  Guide](custom.md "custom.md")
- [Oracle Database Documentation](https://docs.oracle.com/en/database/ "https://docs.oracle.com/en/database/")
- [Oracle RMAN Documentation](https://docs.oracle.com/en/database/oracle/oracle-database/19/bradv/ "https://docs.oracle.com/en/database/oracle/oracle-database/19/bradv/")
- [Oracle Data Guard
  Documentation](https://docs.oracle.com/en/database/oracle/oracle-database/19/sbydb/ "https://docs.oracle.com/en/database/oracle/oracle-database/19/sbydb/")
- [AWS Database Migration Service](https://aws.amazon.com/dms/ "https://aws.amazon.com/dms/")
- [AWS Prescriptive Guidance](https://aws.amazon.com/prescriptive-guidance/ "https://aws.amazon.com/prescriptive-guidance/")
