...
1. Turn on logical replication – To create
   ...
   - To turn on logical replication for a newly
     ...
     read replica. For more information, see [Associating a DB parameter group with a DB instance in Amazon RDS](USER_WorkingWithParamGroups.Associating.md "USER_WorkingWithParamGroups.Associating.md").
