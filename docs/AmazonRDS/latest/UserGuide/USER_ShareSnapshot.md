...
- [Sharing public snapshots for Amazon RDS](USER_ShareSnapshot.Public.md "USER_ShareSnapshot.Public.md")
...
5. Choose one of the following options for **DB snapshot visibility**.
   ...
   For more information, see [Sharing public snapshots for Amazon RDS](USER_ShareSnapshot.Public.md "USER_ShareSnapshot.Public.md").
