...
**Note**  
Storage optimization can take several hours. After storage optimization completes on the instance, you can make additional storage modifications. You can perform a maximum of four storage modifications within any 24-hour period.
