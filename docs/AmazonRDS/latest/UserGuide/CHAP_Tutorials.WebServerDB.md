...
[Launch an EC2 instance to connect with your DB instance](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md"). The web server connects to the Amazon RDS DB
...
VPC security group that you created in [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md"). Make sure that
