...
1. Attach to the source database. In the following example, replace {{source\_database\_alias}}, {{user\_id}}, and {{user\_password}} with the alias you that created in the previous step and the user ID and password for the self-managed Db2 database. 
