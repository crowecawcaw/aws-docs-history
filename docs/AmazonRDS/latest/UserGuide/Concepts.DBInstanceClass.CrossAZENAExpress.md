...
Zone ENA Express, see [ENA Express](../../../AWSEC2/latest/UserGuide/ena-express.md "../../../AWSEC2/latest/UserGuide/ena-express.md") in
...
- Stop and start the DB instance. For more information, see [Stopping an Amazon RDS DB instance temporarily](USER_StopInstance.md "USER_StopInstance.md").
...
- Use Scale Compute on an eligible instance class. For more
  information, see [Scale Compute](../gettingstartedguide/scaling-ha.md "../gettingstartedguide/scaling-ha.md").
