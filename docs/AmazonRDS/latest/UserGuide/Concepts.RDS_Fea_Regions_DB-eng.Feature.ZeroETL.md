...
available in Amazon Redshift or Amazon SageMaker after it's written to an Amazon RDS DB instance. For more information, see [Amazon RDS zero-ETL integrations](zero-etl.md "zero-etl.md").

###### Topics

- [Zero-ETL integrations with RDS for MySQL](#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.mysql "#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.mysql")
- [Zero-ETL integrations with RDS for PostgreSQL](#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.PostgreSQL "#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.PostgreSQL")
- [Zero-ETL integrations with RDS for Oracle](#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.Oracle "#Concepts.RDS_Fea_Regions_DB-eng.Feature.ZeroETL.Oracle")
