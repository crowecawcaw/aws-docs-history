...
database, follow the link that corresponds to your DB engine:
    ...
    * [SSL/TLS support for MySQL DB instances on Amazon RDS](MySQL.Concepts.SSLSupport.md "MySQL.Concepts.SSLSupport.md")
    * [Using SSL with an RDS for Oracle DB instance](Oracle.Concepts.SSL.md "Oracle.Concepts.SSL.md")
    * [Using SSL with a PostgreSQL DB instance](PostgreSQL.Concepts.General.SSL.md "PostgreSQL.Concepts.General.SSL.md")
...
- Modify a DB instance or Multi-AZ DB cluster – You can set the CA for a
  DB instance or cluster by modifying it. For instructions, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md")
...
For more information about DB server certificate rotation, see [Automatic server certificate rotation](UsingWithRDS.SSL-certificate-rotation.md#UsingWithRDS.SSL-certificate-rotation-server-cert-rotation "UsingWithRDS.SSL-certificate-rotation.md#UsingWithRDS.SSL-certificate-rotation-server-cert-rotation")
.
