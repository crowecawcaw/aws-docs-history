...
1. Enter **HomogeneousDataMigrationsPolicy** for **Name\***, and choose **Create policy**.
...
------
   ...
   In the preceding example, replace {{your\_region}} with the name of your AWS Region.
