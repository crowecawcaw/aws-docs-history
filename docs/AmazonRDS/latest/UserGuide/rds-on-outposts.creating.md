...
1. In the Amazon RDS console, choose the AWS Region where you want to create the DB subnet group.
...
1. In the Amazon RDS console, choose the AWS Region where the Outpost on which you want to create the DB instance is attached.
