...
information about modifying a DB instance, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md"). 13. In the **Databases** list, choose the name of the new PostgreSQL DB
...
connect to your DB instance, see [Troubleshooting connections to your RDS for PostgreSQL instance](USER_ConnectToPostgreSQLInstance.Troubleshooting.md "USER_ConnectToPostgreSQLInstance.Troubleshooting.md").
...
connections, see [Connecting to a PostgreSQL DB instance over SSL](PostgreSQL.Concepts.General.SSL.md#PostgreSQL.Concepts.General.SSL.Connecting "PostgreSQL.Concepts.General.SSL.md#PostgreSQL.Concepts.General.SSL.Connecting"). 6. Run SQL commands.
