...
import data to a table on a PostgreSQL DB instance
...
For complete details about the `\copy` command, see the [psql](http://www.postgresql.org/docs/current/static/app-psql.html "http://www.postgresql.org/docs/current/static/app-psql.html")
