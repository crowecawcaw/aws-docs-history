...
| orclb | 10.0.159.30 |  <pre>( address=<br />  (protocol=tcp)<br />  (host=10.0.159.30)<br />  (port=1521)<br />)</pre>  | 10.0.159.100:1521 | 
| orclc | 10.0.159.40 |  <pre>( address=<br />  (protocol=tcp)<br />  (host=10.0.159.40)<br />  (port=1521)<br />)</pre>  | 10.0.159.100:1521 | 
