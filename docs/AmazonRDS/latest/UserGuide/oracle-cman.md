...
[Configuring Oracle Connection Manager](https://docs.oracle.com/en/database/oracle/oracle-database/19/netag/configuring-oracle-connection-manager.html#GUID-AF8A511E-9AE6-4F4D-8E58-F28BC53F64E4 "https://docs.oracle.com/en/database/oracle/oracle-database/19/netag/configuring-oracle-connection-manager.html#GUID-AF8A511E-9AE6-4F4D-8E58-F28BC53F64E4") in the Oracle Database documentation.

###### Topics

- [Supported versions and licensing options for CMAN](#oracle-cman.Versions "#oracle-cman.Versions")
- [Requirements and limitations for CMAN](#oracle-cman.requirements "#oracle-cman.requirements")
- [Configuring CMAN](#oracle-cman.configuring-cman "#oracle-cman.configuring-cman")
