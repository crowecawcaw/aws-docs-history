...
![A few active recommendations selected and dismiss button highlighted in the console.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendations_Dismiss.png)
...
![Console banner showing the number of resources successfully updated.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Dismiss-Banner.png)

   The following example shows the banner with the failure message.  
![Console banner showing the resource that failed to update.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Dismiss-Banner-failure.png)
