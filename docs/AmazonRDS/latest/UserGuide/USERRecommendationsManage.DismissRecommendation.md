...
To dismiss a RDS recommendation using the Amazon RDS API, use the [ModifyDBRecommendation](../APIReference/API_ModifyDBRecommendation.md "../APIReference/API_ModifyDBRecommendation.md") operation.
