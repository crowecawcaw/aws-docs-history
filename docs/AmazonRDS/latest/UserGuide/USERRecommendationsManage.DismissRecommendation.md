...
![Console banner showing the number of resources successfully updated.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Dismiss-Banner.png)

   The following example shows the banner with the failure message.  
![Console banner showing the resource that failed to update.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Dismiss-Banner-failure.png)
