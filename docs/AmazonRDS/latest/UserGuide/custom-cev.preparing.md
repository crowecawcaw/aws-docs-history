...
- Oracle Database 12c Release 1 (12.1)
  ...
  [RDS Custom with RDS for Oracle](Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.md#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.ora "Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.md#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.ora").

###### Topics

- [Step 1 (Optional): Download the manifest templates](#custom-cev.preparing.templates "#custom-cev.preparing.templates")
- [Step 2: Download your database installation files and patches from Oracle Software Delivery Cloud](#custom-cev.preparing.download "#custom-cev.preparing.download")
...
- [Step 5: Prepare the CEV manifest](#custom-cev.preparing.manifest "#custom-cev.preparing.manifest")
- [Step 6 (Optional): Validate the CEV manifest](#custom-cev.preparing.validating "#custom-cev.preparing.validating")
- [Step 7: Add necessary IAM permissions](#custom-cev.preparing.iam "#custom-cev.preparing.iam")
...
are or modify them with your own patches. To review the templates, download [custom-oracle-manifest.zip](samples/custom-oracle-manifest.zip.md "samples/custom-oracle-manifest.zip.md") to your
...
- [Step 3a: Verify that your S3 bucket is in the correct AWS Region](#custom-cev.preparing.s3.verify-region "#custom-cev.preparing.s3.verify-region")
- [Step 3b: Make sure that your S3 bucket policy has the correct permissions](#custom-cev.preparing.s3.verify-policy "#custom-cev.preparing.s3.verify-policy")
- [Step 3c: Upload your files using the cp or sync commands](#custom-cev.preparing.s3.upload "#custom-cev.preparing.s3.upload")
- [Step 3d: List the files in your S3 bucket](#custom-cev.preparing.s3.list "#custom-cev.preparing.s3.list")
...
Command Reference_. 7. Create a CEV by following the steps in [Creating a CEV](custom-cev.create.md "custom-cev.create.md").
...
For sample CEV manifests, see the JSON templates that you downloaded in [Step 1 (Optional): Download the manifest templates](#custom-cev.preparing.templates "#custom-cev.preparing.templates"). You can also review the samples in [CEV manifest examples](#custom-cev.preparing.manifest.examples "#custom-cev.preparing.manifest.examples").
...
Make sure that the IAM principal that creates the CEV has the necessary policies described in [Step 5: Grant required permissions to your IAM user or role](custom-setup-orcl.md#custom-setup-orcl.iam-user "custom-setup-orcl.md#custom-setup-orcl.iam-user").
