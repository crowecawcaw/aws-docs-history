...
[Upgrading the storage file system for a DB instance](USER_PIOPS.md "USER_PIOPS.md"). 9. For **Availability**, choose whether to create a standby
...
the source DB instance, see [Encrypting Amazon RDS resources](Overview.md "Overview.md"). 12. Choose **Create read replica**.
