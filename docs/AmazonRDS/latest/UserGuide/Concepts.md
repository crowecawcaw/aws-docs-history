...
For more information, see [Creating a DB instance in a VPC](USER_VPC.md#USER_VPC.InstanceInVPC "USER_VPC.md#USER_VPC.InstanceInVPC"). 4. Create a DB instance that uses the DB subnet group in the Local Zone.
