...
For information about downloading certificates, see [Using SSL/TLS to encrypt a connection to a DB instance or cluster](UsingWithRDS.SSL.md "UsingWithRDS.SSL.md") . For more information about using SSL/TLS with
MySQL, see [Updating applications to connect to MariaDB instances using new SSL/TLS certificates](ssl-certificate-rotation-mariadb.md "ssl-certificate-rotation-mariadb.md").
...
| TLS version | MariaDB 10.11, 11.4, 11.8, and 12.3 | MariaDB 10.6       | MariaDB 10.5       | MariaDB 10.4       |
| ----------- | ----------------------------------- | ------------------ | ------------------ | ------------------ |
