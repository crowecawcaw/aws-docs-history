...
**Examples**  
The code examples use profiles for shared credentials. For information about the specifying credentials, see [Credentials](https://docs.aws.amazon.com/boto3/latest/guide/credentials.html) in the AWS SDK for Python (Boto3) documentation.
