...
- [RDS Proxy with RDS for MariaDB](#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.mdb "#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.mdb")
- [RDS Proxy with RDS for MySQL](#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.my "#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.my")
- [RDS Proxy with RDS for PostgreSQL](#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.pg "#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.pg")
- [RDS Proxy with RDS for SQL Server](#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.sq "#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDS_Proxy.sq")
...
| Region                     | RDS for MariaDB 12.3   | RDS for MariaDB 11.8   | RDS for MariaDB 11.4   | RDS for MariaDB 10.11  | RDS for MariaDB 10.6   | RDS for MariaDB 10.5   |
| -------------------------- | ---------------------- | ---------------------- | ---------------------- | ---------------------- | ---------------------- | ---------------------- |
