...
Before you can create or connect to a DB instance, make sure to complete the tasks in [Setting up your Amazon RDS environment](CHAP_SettingUp.md "CHAP_SettingUp.md").
