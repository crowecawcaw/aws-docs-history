...
For instructions to fix them manually, see [Turn on case sensitivity for your data warehouse](../../../redshift/latest/mgmt/zero-etl-using.setting-up.md#zero-etl-setting-up.case-sensitivity "../../../redshift/latest/mgmt/zero-etl-using.setting-up.md#zero-etl-setting-up.case-sensitivity") and
[Configure authorization for your data warehouse](../../../redshift/latest/mgmt/zero-etl-using.setting-up.md#zero-etl-using.redshift-iam "../../../redshift/latest/mgmt/zero-etl-using.setting-up.md#zero-etl-using.redshift-iam") in the
...
If creation fails, see [I can't create a zero-ETL integration](zero-etl.troubleshooting.md#zero-etl.troubleshooting.creation "zero-etl.troubleshooting.md#zero-etl.troubleshooting.creation") for
...
Amazon Redshift](../../../redshift/latest/mgmt/zero-etl-using.creating-db.md "../../../redshift/latest/mgmt/zero-etl-using.creating-db.md").
