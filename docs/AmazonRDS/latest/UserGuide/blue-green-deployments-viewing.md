...
![Blue-green deployment in the database list.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/blue-green-deployment-view-db-list.png)
...
![Blue-green deployment details.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/blue-green-deployment-view-details.png)
...
![Blue-green deployment configuration details.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/blue-green-deployment-view-config.png)

   The following image shows an example of the **Status** tab:  
![Blue-green deployment status.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/blue-green-deployment-view-status.png)
