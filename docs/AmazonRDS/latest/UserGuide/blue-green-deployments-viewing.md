...
![Blue/green deployment in the database list](images/blue-green-deployment-view-db-list.png)
...
![Blue/green deployment details](images/blue-green-deployment-view-details.png)
...
![Blue/green deployment configuration details](images/blue-green-deployment-view-config.png)

The following image shows an example of the **Status** tab:

![Blue/green deployment status](images/blue-green-deployment-view-status.png)
