...
**Important**  
Removing the APEX option drops the APEX repository, permanently deleting all APEX applications, workspaces, and user accounts stored in the DB instance. Export your applications before removing this option.
