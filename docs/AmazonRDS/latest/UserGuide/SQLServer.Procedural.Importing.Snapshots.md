...
**Note**  
SQL Server Native Client 11.0 (SQLNCLI11) has been fully deprecated by Microsoft and was removed starting with SQL Server Management Studio (SSMS) 19. If you are using SSMS 19 or later, choose **Microsoft OLE DB Driver for SQL Server** instead for both the data source and destination.
