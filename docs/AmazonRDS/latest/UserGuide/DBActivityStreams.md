...
- [Configuring auditing policy for Amazon RDS for Microsoft SQL Server](DBActivityStreams.md "DBActivityStreams.md")
...
[Supported Regions and DB engines for database activity streams in Amazon RDS](Concepts.RDS_Fea_Regions_DB-eng.Feature.md "Concepts.RDS_Fea_Regions_DB-eng.Feature.md").
