...
You set access to database activity streams using IAM policies. For more information about Amazon RDS authentication, see [Identity and access management for Amazon RDS](UsingWithRDS.md "UsingWithRDS.md"). For more information about creating IAM policies, see
