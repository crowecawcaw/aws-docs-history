...
2. Follow the steps in [Creating a DB instance](USER_CreateDBInstance.md#USER_CreateDBInstance.Creating "USER_CreateDBInstance.md#USER_CreateDBInstance.Creating"), up to but not including the step where you choose monitoring settings.
...
![Turn on DevOps Guru when you create a DB instance](images/devops-guru-enable-create.png) 5. Create a tag for your database so that DevOps Guru can monitor it. Do the following:
