...
**Console-to-Code**  
With this tool, you can generate code for actions that you perform in the Amazon RDS console, and use that code in other tools such as AWS CloudFormation. For more information, see [Use Console-to-Code to generate code for your Amazon RDS console actions](Using_C2C.md).