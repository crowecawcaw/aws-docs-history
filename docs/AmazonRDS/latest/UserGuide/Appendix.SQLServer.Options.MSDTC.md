...
+ [Using transactions](#Appendix.SQLServer.Options.MSDTC.Using)
  + [Using distributed transactions](#Appendix.SQLServer.Options.MSDTC.UsingXA)
...
+ Java Database Connectivity (JDBC) XA transactions are supported for SQL Server 2017 version 14.00.3223.3 and higher, SQL Server 2019, SQL Server 2022, and SQL Server 2025.
