...
In this model, if you have an AWS Support account with case support, contact Support for both Amazon RDS and Oracle Database service requests. Your use of the RDS for Oracle LI option is subject to Section 10.3.1 of the [AWS Service Terms](https://aws.amazon.com/service-terms/).
...
In this model, you continue to use your active Oracle support account, and you contact Oracle directly for Oracle Database service requests. If you have an AWS Support account with case support, you can contact Support for Amazon RDS issues.
...
- ** Engine Edition **
  - **Name:** `oracle-ee` / **Description:** Oracle Database Enterprise Edition (EE)
  - **Name:** `oracle-se2` / **Description:** Oracle Database Standard Edition 2 (SE2)

- ** License Pack **
  - **Name:** `data guard` / **Description:** See [Working with read replicas for Amazon RDS for Oracle](oracle-read-replicas.md) (Oracle Active Data Guard)
  - **Name:** `olap` / **Description:** See [Oracle OLAP](Oracle.Options.OLAP.md)
  - **Name:** `ols` / **Description:** See [Oracle Label Security](Oracle.Options.OLS.md)
  - **Name:** `diagnostic pack sqlt` / **Description:** See [Oracle SQLT](Oracle.Options.SQLT.md)
  - **Name:** `tuning pack sqlt` / **Description:** See [Oracle SQLT](Oracle.Options.SQLT.md)
