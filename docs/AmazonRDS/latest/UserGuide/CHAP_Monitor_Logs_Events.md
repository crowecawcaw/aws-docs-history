...
- Performance
- Security
  [Monitoring metrics in an Amazon RDS instance](CHAP_Monitoring.md "CHAP_Monitoring.md") explains how to
...
- _Amazon CloudWatch Logs_ provides a way to monitor, store, and access your
  ...
  For more information, see the [Amazon CloudWatch Logs User Guide](../../../AmazonCloudWatch/latest/logs.md "../../../AmazonCloudWatch/latest/logs.md").
...
- [Viewing logs, events, and streams in the Amazon RDS console](logs-events-streams-console.md "logs-events-streams-console.md")
