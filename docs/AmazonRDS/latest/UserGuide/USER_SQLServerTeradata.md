...
**Topics**
+ [Supported versions and Regions](#USER_SQLServerTeradata.VersionRegionSupport)
+ [Limitations and recommendations](#USER_SQLServerTeradata.LimitsandRecommendations)
+ [Considerations for Multi-AZ deployment](#USER_SQLServerTeradata.MultiAZ)
+ [Activating linked servers with Teradata](USER_SQLServerTeradata.Activate.md)
+ [Creating linked servers with Teradata](USER_SQLServerTeradata.CreateLinkedServers.md)
+ [Deactivating servers linked to Teradata](USER_SQLServerTeradata.Deactivate.md)
