...
domain, authentication requests are forwarded to the directory that you create with AWS Directory Service.
...
- [Setting up Kerberos for Oracle DB instances](oracle-kerberos-setting-up.md "oracle-kerberos-setting-up.md")
- [Managing a DB instance in a domain](oracle-kerberos-managing.md "oracle-kerberos-managing.md")
- [Connecting to Oracle with Kerberos authentication](oracle-kerberos-connecting.md "oracle-kerberos-connecting.md")
