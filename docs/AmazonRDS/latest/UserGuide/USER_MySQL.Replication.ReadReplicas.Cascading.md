...
turn on automatic backups. For more information, see [Creating a read replica](USER_ReadRepl.Create.md "USER_ReadRepl.Create.md").
...
- Your `mysql-main` continues replicating to `read-replica-1`.
  ...
  see [Promoting a read replica to be a standalone DB instance](USER_ReadRepl.Promote.md "USER_ReadRepl.Promote.md").
