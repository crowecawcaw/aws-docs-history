...
- [Requiring SSL/TLS for specific user accounts to a MySQL DB instance on Amazon RDS](mysql-ssl-connections.require-ssl-users.md "mysql-ssl-connections.require-ssl-users.md")
- [Requiring SSL/TLS for all connections to a MySQL DB instance on Amazon RDS](mysql-ssl-connections.require-ssl.md "mysql-ssl-connections.require-ssl.md")
- [Connecting to your MySQL DB instance on Amazon RDS with SSL/TLS from the MySQL command-line client (encrypted)](USER_ConnectToInstanceSSL.CLI.md "USER_ConnectToInstanceSSL.CLI.md")
