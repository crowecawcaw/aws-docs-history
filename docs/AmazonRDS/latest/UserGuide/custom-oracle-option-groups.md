...
its options to a new option group. To learn how to copy an option group, see [Copying an option group](USER_WorkingWithOptionGroups.md#USER_WorkingWithOptionGroups.Copy "USER_WorkingWithOptionGroups.md#USER_WorkingWithOptionGroups.Copy").
...
5. To continue, choose **Create**. To cancel the
   ...
   To create an option group, use the AWS CLI [`create-option-group`](../../../cli/latest/reference/rds/create-option-group.md "../../../cli/latest/reference/rds/create-option-group.md") command with the following
   required parameters.
