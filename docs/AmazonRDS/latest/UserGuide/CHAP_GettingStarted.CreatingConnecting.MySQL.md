...
![EC2 instance and MySQL DB instance.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/getting-started-mysql.png)
...
+ [Create an EC2 instance](#CHAP_GettingStarted.Creating.MySQL.EC2)
+ [Create a MySQL DB instance](#CHAP_GettingStarted.Creating.MySQL)
+ [(Optional) Create VPC, EC2 instance, and MySQL instance using CloudFormation](#CHAP_GettingStarted.CFN.MySQL)
+ [Connect to a MySQL DB instance](#CHAP_GettingStarted.Connecting.MySQL)
+ [Delete the EC2 instance and DB instance](#CHAP_GettingStarted.Deleting.MySQL)
+ [(Optional) Delete the EC2 instance and DB instance created with CloudFormation](#CHAP_GettingStarted.DeletingCFN.MySQL)
+ [(Optional) Connect your DB instance to a Lambda function](#CHAP_GettingStarted.ComputeConnect.MySQL)
...
1. In the Amazon RDS console, choose the AWS Region you used for the EC2 instance previously.
...
![Create database page.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/easy-create-mysql.png)
...
![Easy create default settings.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/easy-create-view-default-mysql.png)
...
![DB instance details.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/MySQL-Launch06.png)
...
1. Find the endpoint (DNS name) and port number for your DB instance. 
   ...
   1. In the Amazon RDS console, choose the AWS Region for the DB instance.
