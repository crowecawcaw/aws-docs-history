...
As discussed in [Read replica configuration with PostgreSQL](USER_PostgreSQL.Replication.ReadReplicas.Configuration.md "USER_PostgreSQL.Replication.ReadReplicas.Configuration.md"),
...
For more information, see [Monitoring and tuning the replication process](USER_PostgreSQL.Replication.ReadReplicas.Monitor.md "USER_PostgreSQL.Replication.ReadReplicas.Monitor.md").
...
action as captured by the PostgreSQL log in [Example: How a read replica recovers from replication interruptions](#USER_PostgreSQL.Replication.example-how-it-works "#USER_PostgreSQL.Replication.example-how-it-works").
