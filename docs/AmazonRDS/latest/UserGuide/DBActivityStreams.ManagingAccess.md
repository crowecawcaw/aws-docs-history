...
can create, start, stop, and modify the activity stream settings for a DB instance. These
...
You set access to database activity streams using IAM policies. For more information about Amazon RDS authentication, see [Identity and access management for Amazon RDS](UsingWithRDS.IAM.md "UsingWithRDS.IAM.md"). For more information about creating IAM policies, see
