...
1. Set a password for the Oracle APEX `admin` user. To do this, use SQL\*Plus to connect to your DB instance as the master user, and then run the following commands.
