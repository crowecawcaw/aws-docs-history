...
- [Guidelines and limitations for RDS Custom for Oracle replication](custom-rr.reqs-limitations.md "custom-rr.reqs-limitations.md")
- [Promoting an RDS Custom for Oracle replica to a standalone DB instance](custom-rr.promoting.md "custom-rr.promoting.md")
- [Configuring a VPN tunnel between RDS Custom for Oracle primary and replica instances](cfo-standby-vpn-tunnel.md "cfo-standby-vpn-tunnel.md")
...
support perimeter, see [RDS Custom support perimeter](custom-concept.md#custom-troubleshooting.support-perimeter "custom-concept.md#custom-troubleshooting.support-perimeter").
