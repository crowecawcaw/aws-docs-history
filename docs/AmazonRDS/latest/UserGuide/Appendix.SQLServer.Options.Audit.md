...
- [Adding SQL Server Audit to the DB instance options](Appendix.SQLServer.Options.Audit.Adding.md "Appendix.SQLServer.Options.Audit.Adding.md")
- [Using SQL Server Audit](Appendix.SQLServer.Options.Audit.CreateAuditsAndSpecifications.md "Appendix.SQLServer.Options.Audit.CreateAuditsAndSpecifications.md")
