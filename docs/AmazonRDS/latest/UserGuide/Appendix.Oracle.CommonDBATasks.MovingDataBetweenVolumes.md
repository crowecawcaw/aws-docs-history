...
- [Moving data files between volumes in RDS for Oracle](#Appendix.Oracle.CommonDBATasks.MovingDatafiles "#Appendix.Oracle.CommonDBATasks.MovingDatafiles")
- [Moving table data and indexes between volumes in RDS for Oracle](#Appendix.Oracle.CommonDBATasks.MovingTableData "#Appendix.Oracle.CommonDBATasks.MovingTableData")
- [Managing LOB storage using additional volumes](#Appendix.Oracle.CommonDBATasks.ManagingLargeLOBStorage "#Appendix.Oracle.CommonDBATasks.ManagingLargeLOBStorage")
...
| `p_location`     | varchar2  | Yes      | The storage volume to which you want to move the data<br>file. |
