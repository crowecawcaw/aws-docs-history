...
the target (subscriber) have the `pglogical` extension set up as detailed in [Setting up the pglogical extension](Appendix.PostgreSQL.CommonDBATasks.pglogical.basic-setup.md "Appendix.PostgreSQL.CommonDBATasks.pglogical.basic-setup.md").
...
`pglogical` extension. For more information, see [Setting up the pglogical extension](Appendix.PostgreSQL.CommonDBATasks.pglogical.basic-setup.md "Appendix.PostgreSQL.CommonDBATasks.pglogical.basic-setup.md").
