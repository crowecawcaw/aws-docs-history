...
KMS key to use for encryption. For more information, see [Encrypting Amazon RDS resources](Overview.md "Overview.md").
...
If creation fails, see [I can't create a zero-ETL integration](zero-etl.md#zero-etl.troubleshooting.creation "zero-etl.md#zero-etl.troubleshooting.creation") for
