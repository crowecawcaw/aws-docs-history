...
command with `--engine sqlserver-dev-ee` for Enterprise Edition capabilities, or
`--engine sqlserver-dev-se` for Standard Edition capabilities (SQL Server 2025 only).
