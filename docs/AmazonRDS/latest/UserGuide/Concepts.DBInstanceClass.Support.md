...
| Instance class    | Db2 | MariaDB                                         | Microsoft SQL Server | MySQL                   | Oracle                             | PostgreSQL                                                                                                     |
| ----------------- | --- | ----------------------------------------------- | -------------------- | ----------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| db.m7i.48xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, Enterprise Edition only | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.24xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, Enterprise Edition only | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.16xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, Enterprise Edition only | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.12xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, Enterprise Edition only | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.8xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, Enterprise Edition only | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.4xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions            | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.2xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions            | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.xlarge     | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions            | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.m7i.large      | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions            | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
...
| Instance class    | Db2 | MariaDB                                         | Microsoft SQL Server | MySQL                   | Oracle                  | PostgreSQL                                                                                                     |
| ----------------- | --- | ----------------------------------------------- | -------------------- | ----------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------- |
| db.r7i.48xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only               | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.24xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only               | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.16xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only               | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.12xlarge   | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only               | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.8xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only               | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.4xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.2xlarge    | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.xlarge     | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
| db.r7i.large      | Yes | MariaDB 11.8, 11.4, 10.11, 10.6, 10.5, and 10.4 | Yes                  | MySQL 8.0.32 and higher | BYOL only, all editions | PostgreSQL version 17.1 and higher, 16.1 and higher, 15.4 and higher, 14.9<br>and higher, and 13.11 and higher |
