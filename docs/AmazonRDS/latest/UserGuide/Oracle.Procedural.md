...
RDS for Oracle DB instances by creating snapshots. Later, you can restore the snapshots. For more information, see [Backing up, restoring, and exporting data](CHAP_CommonTasks.md "CHAP_CommonTasks.md").
...
- [Migrating with Oracle materialized views](Oracle.Procedural.Importing.md "Oracle.Procedural.Importing.md")
