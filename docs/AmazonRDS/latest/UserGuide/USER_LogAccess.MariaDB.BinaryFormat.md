...
period** setting, see [Settings for DB instances](USER_ModifyInstance.Settings.md "USER_ModifyInstance.Settings.md"). 6. Choose **Save changes** to save the updates to the DB
parameter group.
