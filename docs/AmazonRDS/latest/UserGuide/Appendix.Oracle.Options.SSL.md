...
connection encryption. For more information, see [Oracle native network encryption](Appendix.Oracle.Options.NetworkEncryption.md "Appendix.Oracle.Options.NetworkEncryption.md").
...
- [Adding the SSL option](Appendix.Oracle.Options.SSL.OptionGroup.md "Appendix.Oracle.Options.SSL.OptionGroup.md")
- [Configuring SQL\*Plus to use SSL with an RDS for Oracle DB instance](Appendix.Oracle.Options.SSL.ClientConfiguration.md "Appendix.Oracle.Options.SSL.ClientConfiguration.md")
- [Connecting to an RDS for Oracle DB instance using SSL](Appendix.Oracle.Options.SSL.Connecting.md "Appendix.Oracle.Options.SSL.Connecting.md")
- [Setting up an SSL connection over JDBC](Appendix.Oracle.Options.SSL.JDBC.md "Appendix.Oracle.Options.SSL.JDBC.md")
- [Enforcing a DN match with an SSL connection](Appendix.Oracle.Options.SSL.DNMatch.md "Appendix.Oracle.Options.SSL.DNMatch.md")
- [Troubleshooting SSL connections](Appendix.Oracle.Options.SSL.troubleshooting.md "Appendix.Oracle.Options.SSL.troubleshooting.md")
...
SSL cipher suites for each TLS version. For more information, see [Oracle database FIPS 140-2 settings](https://docs.oracle.com/en/database/oracle/oracle-database/19/dbseg/oracle-database-fips-140-settings.html "https://docs.oracle.com/en/database/oracle/oracle-database/19/dbseg/oracle-database-fips-140-settings.html") in the Oracle Database
documentation.
