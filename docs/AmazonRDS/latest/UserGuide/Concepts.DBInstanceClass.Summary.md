...
see [Supported DB engines for DB instance classes](Concepts.DBInstanceClass.Support.md "Concepts.DBInstanceClass.Support.md").
...
RDS for SQL Server supports Optimize CPU starting with 7th generation instance classes (such as db.m7i and db.r7i). The vCPU counts documented below may differ for these instance classes. For accurate vCPU counts, refer to [DB instance classes that support Optimize CPU](SQLServer.Concepts.General.OptimizeCPU.Support.md "SQLServer.Concepts.General.OptimizeCPU.Support.md").
