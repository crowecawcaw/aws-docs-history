...
deployment. Amazon RDS chooses them for you randomly. For more information about Multi-AZ deployments, see [Configuring and managing a Multi-AZ deployment for Amazon RDS](Concepts.MultiAZ.md "Concepts.MultiAZ.md").
...
For more information, see [Creating a DB instance in a VPC](USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC "USER_VPC.WorkingWithRDSInstanceinaVPC.md#USER_VPC.InstanceInVPC"). 4. Create a DB instance that uses the DB subnet group in the Local Zone.
