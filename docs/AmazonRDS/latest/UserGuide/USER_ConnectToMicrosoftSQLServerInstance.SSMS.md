...
If you can't connect to your DB instance, see [Security group considerations](USER_ConnectToMicrosoftSQLServerInstance.Security.md "USER_ConnectToMicrosoftSQLServerInstance.Security.md") and [Troubleshooting connections to your SQL Server DB instance](USER_ConnectToMicrosoftSQLServerInstance.Troubleshooting.md "USER_ConnectToMicrosoftSQLServerInstance.Troubleshooting.md"). 4. Your SQL Server DB instance comes with SQL Server's standard built-in system databases (`master`,
