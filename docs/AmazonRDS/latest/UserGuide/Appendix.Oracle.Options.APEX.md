...
- [Installing and configuring ORDS 21
  and lower](#Appendix.Oracle.Options.APEX.ORDS "#Appendix.Oracle.Options.APEX.ORDS")
- [Installing and configuring ORDS 22
  and higher](#Appendix.Oracle.Options.APEX.ORDS22 "#Appendix.Oracle.Options.APEX.ORDS22")
...
19.1 to 21. To learn how to install ORDS 22 and higher, see [Installing and configuring ORDS 22
and higher](#Appendix.Oracle.Options.APEX.ORDS22 "#Appendix.Oracle.Options.APEX.ORDS22").
...
and configure ORDS 21 and lower for use with Oracle APEX
...
`MyUser`. For more information, see [Granting SELECT
