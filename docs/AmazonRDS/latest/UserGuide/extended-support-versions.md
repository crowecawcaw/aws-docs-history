...
Amazon RDS will release new minor versions with fixes and CVE patches for engines on RDS Extended Support. For more information, see [Amazon RDS Extended Support versions for RDS for MySQL](MySQL.Concepts.VersionMgmt.md#mysql-extended-support-releases) and [Amazon RDS Extended Support updates for RDS for PostgreSQL](https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-extendedsupport.html) in the *Amazon RDS for PostgreSQL Release Notes*.
