...
system of the DB instance. For example, you might want to install Oracle APEX, the Oracle
Enterprise Manager (OEM) agent, or the Guardium S-TAP agent. For
...
1. [Step 1: Configure your DB instance to allow SSH connections](#custom-managing.ssh.port-22 "#custom-managing.ssh.port-22")
2. [Step 2: Retrieve your SSH secret key and EC2 instance ID](#custom-managing.ssh.obtaining-key "#custom-managing.ssh.obtaining-key")
3. [Step 3: Connect to your EC2 instance using the ssh utility](#custom-managing.ssh.connecting "#custom-managing.ssh.connecting")
