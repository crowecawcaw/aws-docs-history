...
By using cross-Region read replicas in Amazon RDS, you can create a Db2, MariaDB, MySQL, Oracle,
...
RDS for Oracle, see [Requirements and considerations for RDS for Oracle replicas](oracle-read-replicas.limitations.md "oracle-read-replicas.limitations.md").
