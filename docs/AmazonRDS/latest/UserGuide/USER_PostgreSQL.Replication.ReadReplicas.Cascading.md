...
see [Creating a read replica](USER_ReadRepl.Create.md "USER_ReadRepl.Create.md").
...
- Your `rpg-db-main` continues replicating to
  `read-replica-1`.
  For more information about promoting read replicas, see [Promoting a read replica to be a standalone DB instance](USER_ReadRepl.Promote.md "USER_ReadRepl.Promote.md").
