...
1. Run a client-side IBM Db2 CLP session. For information about cataloging your RDS for Db2
   DB instance and database, see [Connecting to your Amazon RDS for Db2 DB instance with IBM Db2 CLP](db2-connecting-with-clp-client.md "db2-connecting-with-clp-client.md"). Make a note of the master
