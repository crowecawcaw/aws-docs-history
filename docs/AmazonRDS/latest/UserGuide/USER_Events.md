...
- [Amazon RDS event notification tags and attributes](USER_Events.md "USER_Events.md")
...
- [Adding a source identifier to an Amazon RDS event notification subscription](USER_Events.md "USER_Events.md")
- [Removing a source identifier from an Amazon RDS event notification subscription](USER_Events.md "USER_Events.md")
