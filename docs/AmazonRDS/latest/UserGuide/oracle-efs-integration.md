...
- [Step 1: Create an IAM role for your DB
  instance and attach your policy](#oracle-efs-integration.iam.role "#oracle-efs-integration.iam.role")
- [Step 2: Create a file system policy for
  your Amazon EFS file system](#oracle-efs-integration.iam.policy "#oracle-efs-integration.iam.policy")
...
instance and attach your policy
