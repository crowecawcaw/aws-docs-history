...
- [Overview of the RDS for Oracle instance store](#CHAP_Oracle.advanced-features.instance-store.overview "#CHAP_Oracle.advanced-features.instance-store.overview")
...
- [Configuring an RDS for Oracle instance store](CHAP_Oracle.advanced-features.instance-store.configuring.md "CHAP_Oracle.advanced-features.instance-store.configuring.md")
- [Working with an instance store on an Oracle read replica](CHAP_Oracle.advanced-features.instance-store.replicas.md "CHAP_Oracle.advanced-features.instance-store.replicas.md")
- [Configuring a temporary tablespace group on an instance store and Amazon EBS](CHAP_Oracle.advanced-features.instance-store.temp-ebs.md "CHAP_Oracle.advanced-features.instance-store.temp-ebs.md")
...
The size of the instance store varies by DB instance type. For more information about the instance store, see [Amazon EC2 instance store](../../../AWSEC2/latest/UserGuide/InstanceStorage.md "../../../AWSEC2/latest/UserGuide/InstanceStorage.md") in the _Amazon Elastic
Compute Cloud User Guide for Linux Instances_.
...
For more information, see [Supported RDS for Oracle DB instance classes](Oracle.Concepts.InstanceClasses.md#Oracle.Concepts.InstanceClasses.Supported "Oracle.Concepts.InstanceClasses.md#Oracle.Concepts.InstanceClasses.Supported") and [Bring Your Own License (BYOL) for EE and SE2](Oracle.Concepts.Licensing.md#Oracle.Concepts.Licensing.BYOL "Oracle.Concepts.Licensing.md#Oracle.Concepts.Licensing.BYOL").
...
on the db.m5d and db.r5d instance classes, see [DB instance classes](Concepts.DBInstanceClass.md "Concepts.DBInstanceClass.md").
For more information on the instance classes supported by Amazon RDS for Oracle, see [RDS for Oracle DB instance classes](Oracle.Concepts.InstanceClasses.md "Oracle.Concepts.InstanceClasses.md").
...
- Create an RDS for Oracle DB instance using a supported instance class. For more information, see [Creating an Amazon RDS DB instance](USER_CreateDBInstance.md "USER_CreateDBInstance.md").
- Modify an existing RDS for Oracle DB instance to use a supported instance class. For more information, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
