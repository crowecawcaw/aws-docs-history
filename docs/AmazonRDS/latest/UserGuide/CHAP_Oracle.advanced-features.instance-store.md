...
how to create the temporary tablespace on the instance store, see [Creating a temporary tablespace
on the instance store](Appendix.Oracle.CommonDBATasks.md "Appendix.Oracle.CommonDBATasks.md").
...
information about using the allocated space, see [Creating a temporary tablespace
on the instance store](Appendix.Oracle.CommonDBATasks.md "Appendix.Oracle.CommonDBATasks.md") or [Adding a tempfile to the instance
store on a read replica](Appendix.Oracle.CommonDBATasks.md#Appendix.Oracle.CommonDBATasks.adding-tempfile-replica "Appendix.Oracle.CommonDBATasks.md#Appendix.Oracle.CommonDBATasks.adding-tempfile-replica").
