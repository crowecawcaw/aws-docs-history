...
+ Capture (extract) is supported on RDS for Oracle DB instances that use the traditional non-CDB database architecture. Oracle GoldenGate Remote PDB capture is supported on CDBs running Oracle Database 26ai, Oracle Database 21c, or Oracle Database 19c version 19.0.0.0.ru-2024-04.rur-2024-04.r1 or higher.
