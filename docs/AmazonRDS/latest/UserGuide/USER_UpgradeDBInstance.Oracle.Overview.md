...
- [Support dates for major releases of RDS for Oracle](#oracle-major-support-dates "#oracle-major-support-dates")
- [Support dates for minor versions of RDS for Oracle](#oracle-minor-support-dates "#oracle-minor-support-dates")
...
To change your backup retention period, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
