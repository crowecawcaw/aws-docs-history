...
learn how to set the retention policy, see [Retaining archived redo logs](Appendix.Oracle.CommonDBATasks.RetainRedoLogs.md "Appendix.Oracle.CommonDBATasks.RetainRedoLogs.md"). 2. Wait up to 5 minutes for the archived log retention policy change to
...
information, see similar examples in [Monitoring the status of a file transfer](oracle-s3-integration.using.md#oracle-s3-integration.using.task-status "oracle-s3-integration.using.md#oracle-s3-integration.using.task-status").
