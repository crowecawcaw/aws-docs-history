...
Amazon RDS SQL Server also supports BYOM for Developer Edition, however, there are some feature differences between them. For more details, see [Differences between Developer Edition and BYOM](sqlserver-byom-comparison.md).

## Benefits
<a name="sqlserver-byom.benefits"></a>
...
+ **License usage visibility** Amazon RDS integrates with [AWS License Manager](https://docs.aws.amazon.com/license-manager/latest/userguide/license-manager.html), so you can track SQL Server license consumption across your AWS environment and maintain compliance with your licensing agreements.

## How BYOM works
<a name="sqlserver-byom.how-it-works"></a>
...
Providing valid SQL Server installation media (RTM ISO file)
Maintaining Microsoft licensing compliance through License Mobility
...
<a name="sqlserver-byom.supported-editions"></a>
...
<a name="sqlserver-byom.supported-instances"></a>
...
## Region availability
<a name="sqlserver-byom.regions"></a>
...
## Pricing
<a name="sqlserver-byom.pricing"></a>
...
Amazon RDS integrates with [AWS License Manager](https://docs.aws.amazon.com/license-manager/latest/userguide/license-manager.html) to help you track and manage your SQL Server license usage. When you configure License Manager, Amazon RDS automatically detects BYOM instances and reports vCPU usage. License Manager provides:
...
## Current limitations
<a name="sqlserver-byom.limitations"></a>
