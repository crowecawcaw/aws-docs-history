...
4. Change any of the settings that you want.
   ...
   [Settings for DB instances](USER_ModifyInstance.Settings.md "USER_ModifyInstance.Settings.md").
...
6. (Optional) Choose **Apply immediately** to apply the changes immediately. Choosing this option
   can cause downtime in some cases. For more information, see [Using the schedule modifications setting](USER_ModifyInstance.ApplyImmediately.md "USER_ModifyInstance.ApplyImmediately.md").
