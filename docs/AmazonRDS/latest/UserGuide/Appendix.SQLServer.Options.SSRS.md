...
Starting with SQL Server 2025, Microsoft has consolidated all reporting services
under Power BI Report Server (PBIRS), replacing SSRS. If you upgrade an existing RDS DB
instance with SSRS to SQL Server 2025, SSRS is automatically replaced by PBIRS. For more
information about the upgrade process, see
[Upgrading from SSRS to PBIRS](SSRS.Upgrade.md "SSRS.Upgrade.md"). Like SSRS,
PBIRS provides a report server with a web portal where you can display and manage reports
and KPIs. With PBIRS, you can run Power BI reports (.pbix) and paginated reports (.rdl),
which makes it a superset of SSRS functionality. Everything you can do in SSRS, you can
do in PBIRS, with the addition of interactive Power BI report types.
...
- [Upgrading from SSRS to PBIRS](SSRS.Upgrade.md "SSRS.Upgrade.md")
- [Limitations and recommendations](SSRS.Limitations.md "SSRS.Limitations.md")
- [Turning on SSRS or PBIRS](SSRS.Enabling.md "SSRS.Enabling.md")

  - [Creating an option group for SSRS or PBIRS](SSRS.Enabling.md#SSRS.OptionGroup "SSRS.Enabling.md#SSRS.OptionGroup")
...
- [Report server databases](SSRS.DBs.md "SSRS.DBs.md")
- [SSRS and PBIRS log files](SSRS.Logs.md "SSRS.Logs.md")
- [Accessing the SSRS or PBIRS web portal](SSRS.Access.md "SSRS.Access.md")
  ...
  - [Accessing the web portal](SSRS.Access.md#SSRS.Access.Portal "SSRS.Access.md#SSRS.Access.Portal")
...
- [Using reporting services email to send reports](SSRS.Email.md "SSRS.Email.md")
...
- [Disabling and deleting SSRS or PBIRS databases](SSRS.DisableDelete.md "SSRS.DisableDelete.md")

  - [Turning off SSRS or PBIRS](SSRS.DisableDelete.md#SSRS.Disable "SSRS.DisableDelete.md#SSRS.Disable")
  - [Deleting the SSRS or PBIRS databases](SSRS.DisableDelete.md#SSRS.Drop "SSRS.DisableDelete.md#SSRS.Drop")
