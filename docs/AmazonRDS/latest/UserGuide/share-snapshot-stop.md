...
To remove sharing permission for an AWS account, use the [`ModifyDBSnapshotAttribute`](../APIReference/API_ModifyDBClusterSnapshotAttribute.md "../APIReference/API_ModifyDBClusterSnapshotAttribute.md")
