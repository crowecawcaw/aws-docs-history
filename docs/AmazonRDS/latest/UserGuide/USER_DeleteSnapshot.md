...
![Delete snapshot.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/delete-snapshot.png)

1. Choose **Delete** on the confirmation page.  
![Confirm snapshot deletion.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/delete-snapshot-confirm.png)
