...
By default, the time zone for a MySQL DB instance is UTC. You can set the time zone for your DB instance to the local time zone for your application instead.
...
SQL commands or run the [mysql\_tzinfo\_to\_sql tool](https://dev.mysql.com/doc/refman/8.0/en/mysql-tzinfo-to-sql.html "https://dev.mysql.com/doc/refman/8.0/en/mysql-tzinfo-to-sql.html")
