...
1. Create a JSON file, for example `ssrs-option.json`.
   1. Set the following required parameters:
      ...
      8443. For a list of allowed values, see [Limitations and recommendations](Appendix.SQLServer.Options.SSRS.md#SSRS.Limitations "Appendix.SQLServer.Options.SSRS.md#SSRS.Limitations").
