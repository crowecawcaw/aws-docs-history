...
the prerequisites, follow the steps in [Modifying an RDS Custom for SQL Server Single-AZ deployment to a Multi-AZ deployment](custom-sqlserver-multiaz.modify-saztomaz.md "custom-sqlserver-multiaz.modify-saztomaz.md").
