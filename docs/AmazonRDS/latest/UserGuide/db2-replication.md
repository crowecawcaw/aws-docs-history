...
For information about setting archive log retention hours, see [rdsadmin.set\_archive\_log\_retention](db2-sp-managing-databases.md#db2-sp-set-archive-log-retention).
