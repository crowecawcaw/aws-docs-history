...
For more information, see [Upgrades of the RDS for MySQL DB engine](USER_UpgradeDBInstance.MySQL.md "USER_UpgradeDBInstance.MySQL.md"). 2. (Optional) Reset the GTID parameters and test the behavior of the DB instance
and read replicas:
