...
- [Importing transportable
  tablespace metadata into your DB instance](rdsadmin_transport_util_import_xtts_metadata.md "rdsadmin_transport_util_import_xtts_metadata.md")
- [Listing orphaned files after
  a tablespace import](rdsadmin_transport_util_list_xtts_orphan_files.md "rdsadmin_transport_util_list_xtts_orphan_files.md")
- [Deleting orphaned
