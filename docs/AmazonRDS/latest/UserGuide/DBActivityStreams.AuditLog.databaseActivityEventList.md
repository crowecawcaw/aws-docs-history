...
| `dbProtocol` | string | N/A | This field isn't used for RDS for Oracle and is always null. | 
...
| `logTime` | string | `EVENT_TIMESTAMP` column in `UNIFIED_AUDIT_TRAIL` | Timestamp of the creation of the audit trail entry in the local time zone. A sample value is `2020-11-27 06:56:14.981404`. | 
