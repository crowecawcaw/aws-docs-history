...
For a list of scenarios involving Amazon RDS DB instances in a VPC and outside of a VPC, see [Scenarios for accessing a DB instance in a VPC](USER_VPC.md "USER_VPC.md").
...
- [Hiding a DB instance in a VPC from
...
CIDR block associated with it. For more information, see [Amazon RDS IP
...
When a DB instance can communicate over both the IPv4 and
IPv6 addressing protocols, it's running in dual-stack mode. So, resources can
communicate with the DB instance over IPv4, IPv6, or both. RDS disables
...
- [Modifying
  IPv4-only DB instances to use dual-stack mode](#USER_VPC.IP_addressing.dual-stack-modifying-ipv4 "#USER_VPC.IP_addressing.dual-stack-modifying-ipv4")
- [Region
  and version availability](#USER_VPC.IP_addressing.RegionVersionAvailability "#USER_VPC.IP_addressing.RegionVersionAvailability")
- [Limitations
  for dual-stack network DB instances](#USER_VPC.IP_addressing.dual-stack-limitations "#USER_VPC.IP_addressing.dual-stack-limitations")
...
IPv4-only DB instances to use dual-stack mode
...
###### To modify an IPv4-only DB instance to use
...
and Region availability with dual-stack mode, see [Supported
Regions and DB engines for dual-stack mode in Amazon RDS](Concepts.RDS_Fea_Regions_DB-eng.Feature.md "Concepts.RDS_Fea_Regions_DB-eng.Feature.md").

#### Limitations

for dual-stack network DB instances
...
- DB instances that use dual-stack mode
...
instances. For an illustration of this scenario, see [A DB instance in a VPC
...
**Public access** option, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.md "Overview.DBInstance.md").
...
instructions on how to create a security group for your DB instance, see [Create a VPC
security group for a private DB instance](CHAP_Tutorials.WebServerDB.md#CHAP_Tutorials.WebServerDB.CreateVPC.SecurityGroupDB "CHAP_Tutorials.WebServerDB.md#CHAP_Tutorials.WebServerDB.CreateVPC.SecurityGroupDB"), or
