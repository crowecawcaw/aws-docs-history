...
hook, see [Trusted
Language Extensions hooks](https://github.com/aws/pg_tle/blob/main/docs/04_hooks.md "https://github.com/aws/pg_tle/blob/main/docs/04_hooks.md").
...
- `CREATE ROLE `username` ...PASSWORD`
  ...
  ROLE](https://www.postgresql.org/docs/current/sql-createrole.html "https://www.postgresql.org/docs/current/sql-createrole.html") in the PostgreSQL documentation.
...
- [Function prototype](PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-prototype "PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-prototype")
- [Arguments](PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-arguments "PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-arguments")
- [Configuration](PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-configuration "PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-configuration")
- [Usage notes](PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-usage "PostgreSQL_trusted_language_extension-hooks-reference.md#passcheck_hook-usage")
