...
For more information on using TDE with RDS for SQL Server, see [Support for Transparent Data Encryption in SQL Server](Appendix.SQLServer.Options.TDE.md "Appendix.SQLServer.Options.TDE.md").
