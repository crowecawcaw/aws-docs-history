...
![Switch over a standby instance to make it the primary DB instance.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/read-replica-switchover.png)
