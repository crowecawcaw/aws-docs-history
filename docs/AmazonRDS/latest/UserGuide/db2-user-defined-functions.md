...
The following response example shows that a database called `TESTJP` was successfully created. For more information, see the [rdsadmin.create\_database](db2-sp-managing-databases.md#db2-sp-create-database) stored procedure.
...
The following response example explains why dropping a database failed. For more information, see the [rdsadmin.drop\_database](db2-sp-managing-databases.md#db2-sp-drop-database) stored procedure.
...
The following response example shows the successful restoration of a database. For more information, see the [rdsadmin.restore\_database](db2-sp-managing-databases.md#db2-sp-restore-database) stored procedure.
...
If you don't see your databases in the list, call the [rdsadmin.get\_task\_status](#db2-udf-get-task-status) user-defined function and look for error messages.
