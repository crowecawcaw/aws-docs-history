...
You can migrate data from an existing database into your DB instance using AWS Database Migration Service. For more information, see [Auto migrating databases to Amazon RDS using AWS Database Migration Service](USER_DMS_migration.md).
