...
+ [Setting up Trusted Language Extensions in your RDS for PostgreSQL DB instance](PostgreSQL_trusted_language_extension-setting-up.md)
+ [Overview of Trusted Language Extensions for PostgreSQL](PostgreSQL_trusted_language_extension.overview.md)
+ [Creating TLE extensions for RDS for PostgreSQL](PostgreSQL_trusted_language_extension-creating-TLE-extensions.md)
...
+ [Using Custom Data Types in TLE](PostgreSQL_trusted_language_extension-custom-data-type.md)
