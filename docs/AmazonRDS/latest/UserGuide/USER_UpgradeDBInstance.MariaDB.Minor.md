...
supported MariaDB minor versions, see [SSL/TLS support for MariaDB DB instances on Amazon RDS](MariaDB.Concepts.SSLSupport.md "MariaDB.Concepts.SSLSupport.md").
