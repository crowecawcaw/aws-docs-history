...
- [Upgrades of the MariaDB DB engine](USER_UpgradeDBInstance.MariaDB.md "USER_UpgradeDBInstance.MariaDB.md")
...
- [Upgrading the RDS for Oracle DB engine](USER_UpgradeDBInstance.Oracle.md "USER_UpgradeDBInstance.Oracle.md")
...
see [Using Amazon RDS Blue/Green Deployments for database updates](blue-green-deployments.md "blue-green-deployments.md").
...
6. Decide when to schedule your upgrade:
   ...
   - To apply the changes immediately, choose **Apply
     ...
     outage in some cases. For more information, see [Using the schedule modifications setting](USER_ModifyInstance.ApplyImmediately.md "USER_ModifyInstance.ApplyImmediately.md").
...
- [Automatic minor version upgrades for RDS for MariaDB](USER_UpgradeDBInstance.MariaDB.Minor.md "USER_UpgradeDBInstance.MariaDB.Minor.md")
- [Oracle minor version upgrades](USER_UpgradeDBInstance.Oracle.Minor.md "USER_UpgradeDBInstance.Oracle.Minor.md")
- [Upgrades of the Microsoft SQL Server DB engine](USER_UpgradeDBInstance.SQLServer.md "USER_UpgradeDBInstance.SQLServer.md")
- [Db2 on Amazon RDS versions](Db2.Concepts.VersionMgmt.md "Db2.Concepts.VersionMgmt.md")

###### Topics

- [How automatic minor version upgrades work](#USER_UpgradeDBInstance.Upgrading.scheduled "#USER_UpgradeDBInstance.Upgrading.scheduled")
- [Turning on automatic minor version upgrades](#USER_UpgradeDBInstance.Upgrading.turning-on-automatic "#USER_UpgradeDBInstance.Upgrading.turning-on-automatic")
- [Determining the availability of maintenance updates](#USER_UpgradeDBInstance.Upgrading.availability "#USER_UpgradeDBInstance.Upgrading.availability")
- [Finding automatic minor version upgrade targets](#USER_UpgradeDBInstance.Upgrading.targets "#USER_UpgradeDBInstance.Upgrading.targets")
...
- [Modifying a
  DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md")
- [Creating a read replica](USER_ReadRepl.Create.md "USER_ReadRepl.Create.md")
...
- [Importing a DB instance from
  Amazon S3](MySQL.Procedural.Importing.md "MySQL.Procedural.Importing.md") (for a MySQL backup on Amazon S3)
...
For more information, see [Maintaining a DB instance](USER_UpgradeDBInstance.Maintenance.md "USER_UpgradeDBInstance.Maintenance.md").
...
information about Aurora PostgreSQL versions, see [Engine versions for Amazon Aurora PostgreSQL](../AuroraUserGuide/AuroraPostgreSQL.Updates.20180305.md "../AuroraUserGuide/AuroraPostgreSQL.Updates.20180305.md").
