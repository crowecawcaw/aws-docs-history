...
![Console banner showing the number of resources to apply the recommendation to.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Apply-Banner.png)

   The following example shows the banner with the failure message.   
![Console banner showing the resource that failed to apply the recommendation.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/Recommendation-Apply-Banner-failure.png)
