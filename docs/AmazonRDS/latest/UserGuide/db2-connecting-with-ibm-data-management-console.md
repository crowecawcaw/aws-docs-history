...
1. Create a buffer pool for IBM Db2 Data Management Console. In the following example, replace {{database\_name}} with the name of the repository you created for IBM Db2 Data Management Console to monitor your RDS for Db2 DB instances. 
...
1. Create a user tablespace for IBM Db2 Data Management Console. In the following example, replace {{database\_name}} with the name of the repository you created for IBM Db2 Data Management Console to monitor your RDS for Db2 DB instances. 
...
1. Create a system temporary tablespace for IBM Db2 Data Management Console. In the following example, replace {{database\_name}} with the name of the repository you created for IBM Db2 Data Management Console to monitor your RDS for Db2 DB instances. 
