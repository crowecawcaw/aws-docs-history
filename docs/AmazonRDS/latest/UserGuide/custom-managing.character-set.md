...
- You can only change to a character set supported by RDS for Oracle. For more information, see [Supported DB character sets](Appendix.OracleCharacterSets.md#Appendix.OracleCharacterSets.db-character-set.supported "Appendix.OracleCharacterSets.md#Appendix.OracleCharacterSets.db-character-set.supported").

###### To change the character set of an RDS Custom for Oracle DB instance

1. Pause RDS Custom automation. For more information, see [Pausing and resuming your RDS Custom DB instance](custom-managing.customizing-env.md#custom-managing.pausing "custom-managing.customizing-env.md#custom-managing.pausing").
...
4. Resume RDS Custom automation. For more information, see [Pausing and resuming your RDS Custom DB instance](custom-managing.customizing-env.md#custom-managing.pausing "custom-managing.customizing-env.md#custom-managing.pausing").
