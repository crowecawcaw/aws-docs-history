...
| `p_grantee` | varchar2 | — | Yes | The name of the user or role to grant privileges to. | 
| `p_privilege` | varchar2 | null | Yes | The privilege to grant. Valid values include `SELECT`, `EXECUTE`, and `ALL`. | 
