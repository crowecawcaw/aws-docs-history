...
- [Working with self-managed Active Directory with an Amazon RDS for SQL Server
  DB instance](USER_SQLServer_SelfManagedActiveDirectory.md "USER_SQLServer_SelfManagedActiveDirectory.md")
