...
- [Overview of RDS Optimized Reads](#rds-optimized-reads-mariadb-overview "#rds-optimized-reads-mariadb-overview")
- [Use cases for RDS Optimized Reads](#rds-optimized-reads-mariadb-use-cases "#rds-optimized-reads-mariadb-use-cases")
- [Best practices for RDS Optimized Reads](#rds-optimized-reads-mariadb-best-practices "#rds-optimized-reads-mariadb-best-practices")
- [Using RDS Optimized Reads](#rds-optimized-reads-mariadb-using "#rds-optimized-reads-mariadb-using")
- [Monitoring DB instances that use RDS Optimized Reads](#rds-optimized-reads-mariadb-monitoring "#rds-optimized-reads-mariadb-monitoring")
- [Limitations for RDS Optimized Reads](#rds-optimized-reads-mariadb-limitations "#rds-optimized-reads-mariadb-limitations")
...
- Create an RDS for MariaDB DB instance using one of these DB instance classes. For more information, see [Creating an Amazon RDS DB instance](USER_CreateDBInstance.md "USER_CreateDBInstance.md").
- Modify an existing RDS for MariaDB DB instance to use one of these DB instance classes. For more information, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
