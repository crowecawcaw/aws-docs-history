...
login for executing SSIS packages. For more information, see [Setting up a Windows-authenticated user for SSIS](SSIS.Permissions.md#SSIS.Use.Auth "SSIS.Permissions.md#SSIS.Use.Auth").
