...
- [Deferred DB instance modifications](#USER_UpgradeDBInstance.Maintenance.Overview.Deferred "#USER_UpgradeDBInstance.Maintenance.Overview.Deferred")
...
about modifying a DB instance, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
...
deployment. For more information, see [Using Amazon RDS Blue/Green Deployments for database updates](blue-green-deployments.md "blue-green-deployments.md"). If you upgrade an RDS for SQL Server or
...
information, see [Multi-AZ considerations](USER_UpgradeDBInstance.SQLServer.Considerations.md#USER_UpgradeDBInstance.SQLServer.MAZ "USER_UpgradeDBInstance.SQLServer.Considerations.md#USER_UpgradeDBInstance.SQLServer.MAZ").

For more information about Multi-AZ deployments, see [Configuring and managing a Multi-AZ deployment for Amazon RDS](Concepts.MultiAZ.md "Concepts.MultiAZ.md").
...
maintenance window, see [Adjusting the preferred DB instance maintenance window](#AdjustingTheMaintenanceWindow "#AdjustingTheMaintenanceWindow").
...
- [Adjusting the preferred DB instance maintenance window](#AdjustingTheMaintenanceWindow "#AdjustingTheMaintenanceWindow")
