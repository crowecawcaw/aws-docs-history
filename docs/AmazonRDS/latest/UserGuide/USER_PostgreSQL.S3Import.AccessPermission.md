...
- [Using an IAM role to access an Amazon S3 bucket](#USER_PostgreSQL.S3Import.ARNRole "#USER_PostgreSQL.S3Import.ARNRole")
- [Using security credentials to access an Amazon S3 bucket](#USER_PostgreSQL.S3Import.Credentials "#USER_PostgreSQL.S3Import.Credentials")
- [Troubleshooting access to Amazon S3](#USER_PostgreSQL.S3Import.troubleshooting "#USER_PostgreSQL.S3Import.troubleshooting")
...
For more information on creating an IAM policy for RDS for PostgreSQL, see [Creating and using an IAM policy for IAM database access](UsingWithRDS.IAMDBAuth.IAMPolicy.md "UsingWithRDS.IAMDBAuth.IAMPolicy.md"). See also [Tutorial: Create and
...
[AddRoleToDBInstance](../APIReference/API_AddRoleToDBInstance.md "../APIReference/API_AddRoleToDBInstance.md") operation.
