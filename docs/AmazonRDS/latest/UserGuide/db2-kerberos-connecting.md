...
1. Use the following command to log in to an RDS for Db2 DB instance that is associated with Active Directory. Replace {{database\_name}} with the name of your RDS for Db2 database.
