...
- [Turning on SSAS](SSAS.Enabling.md "SSAS.Enabling.md")
  ...
  - [Allowing inbound access to your VPC security group](SSAS.Enabling.md#SSAS.InboundRule "SSAS.Enabling.md#SSAS.InboundRule")
  - [Enabling Amazon S3 integration](SSAS.Enabling.md#SSAS.EnableS3 "SSAS.Enabling.md#SSAS.EnableS3")
...
- [Using SSAS on Amazon RDS](SSAS.Use.md "SSAS.Use.md")
  ...
  - [Scheduling SSAS database processing using SQL Server Agent](SSAS.Use.md#SSAS.Use.Schedule "SSAS.Use.md#SSAS.Use.Schedule")
  - [Revoking SSAS access from the proxy](SSAS.Use.md#SSAS.Use.Revoke "SSAS.Use.md#SSAS.Use.Revoke")
...
- [Turning off SSAS](SSAS.Disable.md "SSAS.Disable.md")
- [Troubleshooting SSAS issues](SSAS.Trouble.md "SSAS.Trouble.md")
...
For more information, see [Changing the SSAS mode](SSAS.ChangeMode.md "SSAS.ChangeMode.md").

- Multi-AZ instances aren't supported.
- Instances must use self-managed Active Directory or AWS Directory Service for Microsoft Active Directory for SSAS authentication. For more information, see [Working with Active Directory with RDS for SQL Server](User.SQLServer.ActiveDirectoryWindowsAuth.md "User.SQLServer.ActiveDirectoryWindowsAuth.md").
...
- You can't deploy projects directly. We provide an RDS stored procedure to do this. For more information, see [Deploying SSAS projects on Amazon RDS](SSAS.Deploy.md "SSAS.Deploy.md").
