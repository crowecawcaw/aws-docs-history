...
To use Oracle Label Security, you create policies that control access to specific rows in your tables. For more information, see [Creating an Oracle Label Security policy](https://docs.oracle.com/en/database/oracle/oracle-database/19/olsag/getting-started-ols.html) in the Oracle documentation. 
