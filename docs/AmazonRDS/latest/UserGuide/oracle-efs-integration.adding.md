...
different Oracle directories. For more information see [Transferring files between RDS for Oracle and an Amazon EFS file system](oracle-efs-integration.transferring.md "oracle-efs-integration.transferring.md").
...
following ways:
    ...
    * Modify an Oracle DB instance to associate the option group with
     it. For information about modifying an Oracle DB instance, see [Modifying an Amazon RDS DB instance](Overview.DBInstance.Modifying.md "Overview.DBInstance.Modifying.md").
