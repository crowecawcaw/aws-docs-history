...
about upgrading DB instances, see [Upgrading a DB instance engine version](USER_UpgradeDBInstance.Upgrading.md "USER_UpgradeDBInstance.Upgrading.md").
...
your IBM Site ID and IBM Customer ID. For more information, see [IBM IDs for bring your own license (BYOL) for Db2](db2-licensing.md#db2-prereqs-ibm-info "db2-licensing.md#db2-prereqs-ibm-info"). You
...
For more information about backups and restoring backups, see [Working with RDS for Db2 replica backups](db2-read-replicas.backups.md "db2-read-replicas.backups.md").
...
- All stored procedures for creating, dropping, restoring, or rolling forward
  ...
  these stored procedures, see [Stored procedures for databases for RDS for Db2](db2-sp-managing-databases.md "db2-sp-managing-databases.md").
