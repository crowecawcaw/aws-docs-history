...
+ **Supported versions** – All Db2 11.5 and 12.1 versions support replica DB instances. 
...
+ **Valid licensing models and replica modes** – All Db2 editions, Advanced Edition (AE), Community Edition (CE), and Standard Edition (SE), support replicas in read-only or standby mode. Db2 AE and Db2 SE are available under both the Bring Your Own License (BYOL) model and the Db2 license through AWS Marketplace model. CE is available under BYOL only. To obtain your IBM Customer ID and IBM Site ID for CE, see the [IBM website](https://www.ibm.com/account/reg/us-en/signup?formid=urx-54367).
