...
- In most cases, you must configure your VPC to allow connections from OMS to
  ...
  complete the steps in [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md") before continuing.
...
- To connect from your OMS to the Management Agent, if your OMS has a publicly
  ...
  rules, see [Tutorial: Create a VPC for use with a DB instance (IPv4 only)](CHAP_Tutorials.WebServerDB.md "CHAP_Tutorials.WebServerDB.md").
- To connect from your OMS to the Management Agent, if your OMS doesn't have a
  ...
  - If your OMS is hosted on an Amazon Elastic Compute Cloud (Amazon EC2) instance in a private
    ...
    For more information, see [A DB instance in a VPC accessed by an EC2 instance in a different VPC](USER_VPC.md#USER_VPC.Scenario3 "USER_VPC.md#USER_VPC.Scenario3").
  - If your OMS is hosted on-premises, you can set up a VPN connection to
    ...
    [A DB instance in a VPC accessed by a client application through the internet](USER_VPC.md#USER_VPC.Scenario4 "USER_VPC.md#USER_VPC.Scenario4") or [VPN connections](../../../vpc/latest/userguide/vpn-connections.md "../../../vpc/latest/userguide/vpn-connections.md").
...
`rdsadmin.rds_file_util.read_text_file`, see [Reading files in a DB instance directory](Appendix.Oracle.CommonDBATasks.md#Appendix.Oracle.CommonDBATasks.ReadingFiles "Appendix.Oracle.CommonDBATasks.md#Appendix.Oracle.CommonDBATasks.ReadingFiles").
