...
applications. You can also connect the stream to compliance management applications such as IBM's Security Guardium or Imperva's SecureSphere Database Audit and
Protection.
...
An activity stream's name includes the prefix `aws-rds-das-db-`
followed by the resource ID of the database. The following is an example.
...
the database,
choose your DB instance from the list of databases, and then choose
