...
- To authenticate login and permissions for a MySQL DB instance, you can take either
  ...
  - You can also use IAM database authentication. With IAM database authentication,
    ...
    AWS resources and your databases. For more information, see [IAM database authenticationfor MariaDB, MySQL, and PostgreSQL](UsingWithRDS.IAMDBAuth.md "UsingWithRDS.IAMDBAuth.md").
