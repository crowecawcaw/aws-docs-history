...
- [Application scalability](#rds-proxy-best-practices.application-scalability "#rds-proxy-best-practices.application-scalability")
- [High availability](#rds-proxy-best-practices.high-availability "#rds-proxy-best-practices.high-availability")
- [Using multiple proxies with one target](#rds-proxy-best-practices.multiple-proxies "#rds-proxy-best-practices.multiple-proxies")
