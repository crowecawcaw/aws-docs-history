...
For more information on SQL Server Agent job replication, see [Turning on SQL Server Agent job replication](Appendix.SQLServer.CommonDBATasks.Agent.md#SQLServerAgent.Replicate "Appendix.SQLServer.CommonDBATasks.Agent.md#SQLServerAgent.Replicate").
