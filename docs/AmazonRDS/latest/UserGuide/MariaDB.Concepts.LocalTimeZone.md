...
The Internet Assigned Numbers Authority (IANA) publishes new time zones at [https://www.iana.org/time-zones](https://www.iana.org/time-zones "https://www.iana.org/time-zones") several times a year. Every time RDS releases a new minor maintenance release of MariaDB,
...
SQL commands or run the [mysql\_tzinfo\_to\_sql tool](https://mariadb.com/kb/en/mysql_tzinfo_to_sql/ "https://mariadb.com/kb/en/mysql_tzinfo_to_sql/")
