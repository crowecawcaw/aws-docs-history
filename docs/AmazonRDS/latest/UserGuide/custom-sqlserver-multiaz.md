...
prerequisites, see [Prerequisites for a Multi-AZ deployment with RDS Custom for SQL Server](custom-sqlserver-multiaz.prerequisites.md "custom-sqlserver-multiaz.prerequisites.md").
...
![RDS Custom for SQL Server supports Multi-AZ.](images/custom-sqlserver-multiaz-architecture.png)
...
see [Requirements and limitations for Amazon RDS Custom for SQL Server](custom-reqs-limits-MS.md "custom-reqs-limits-MS.md").

###### Topics

- [Region and version availability](#custom-sqlserver-multiaz.regionversion "#custom-sqlserver-multiaz.regionversion")
- [Limitations for a Multi-AZ deployment with RDS Custom for SQL Server](#custom-sqlserver-multiaz.limitations "#custom-sqlserver-multiaz.limitations")
- [Prerequisites for a Multi-AZ deployment with RDS Custom for SQL Server](custom-sqlserver-multiaz.prerequisites.md "custom-sqlserver-multiaz.prerequisites.md")
- [Creating an RDS Custom for SQL Server Multi-AZ deployment](#custom-sqlserver-multiaz.creating "#custom-sqlserver-multiaz.creating")
- [Modifying an RDS Custom for SQL Server Single-AZ deployment to a Multi-AZ deployment](custom-sqlserver-multiaz.modify-saztomaz.md "custom-sqlserver-multiaz.modify-saztomaz.md")
- [Modifying an RDS Custom for SQL Server Multi-AZ deployment to a Single-AZ deployment](custom-sqlserver-multiaz.modify-maztosaz.md "custom-sqlserver-multiaz.modify-maztosaz.md")
- [Failover process for an RDS Custom for SQL Server Multi-AZ deployment](custom-sqlserver-multiaz.failover.md "custom-sqlserver-multiaz.failover.md")
...
is available. For more information on Region availability of Multi-AZ deployments for RDS Custom for SQL Server, see [Supported Regions and DB engines for RDS Custom for SQL Server](Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.md#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.sq "Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.md#Concepts.RDS_Fea_Regions_DB-eng.Feature.RDSCustom.sq").
...
[Creating and connecting to a DB instance for Amazon RDS Custom for SQL Server](custom-creating-sqlserver.md "custom-creating-sqlserver.md").
