...
The **Databases** pane appears. 3. Choose the RDS Custom for SQL Server DB instance that you want to modify. 4. For **Multi-AZ deployment**, choose **No**. 5. On the **Confirmation** page, choose **Apply
...
setting](USER_ModifyInstance.md "USER_ModifyInstance.md"). 6. On the **Confirmation** page, choose **Modify DB Instance**.
To modify a Multi-AZ deployment to a Single-AZ deployment by using the AWS CLI, call the [modify-db-instance](../../../cli/latest/reference/rds/modify-db-instance.md "../../../cli/latest/reference/rds/modify-db-instance.md")
