...
+ [Prerequisites for a Multi-AZ deployment with RDS Custom for SQL Server](custom-sqlserver-multiaz.prerequisites.md)
+ [Creating an RDS Custom for SQL Server Multi-AZ deployment](#custom-sqlserver-multiaz.creating)
+ [Modifying an RDS Custom for SQL Server Single-AZ deployment to a Multi-AZ deployment](custom-sqlserver-multiaz.modify-saztomaz.md)
+ [Modifying an RDS Custom for SQL Server Multi-AZ deployment to a Single-AZ deployment](custom-sqlserver-multiaz.modify-maztosaz.md)
+ [Failover process for an RDS Custom for SQL Server Multi-AZ deployment](custom-sqlserver-multiaz.failover.md)
