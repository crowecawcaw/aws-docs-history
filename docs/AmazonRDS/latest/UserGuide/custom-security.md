...
- [Securing your Amazon S3 bucket against the confused deputy problem](custom-security.confused-deputy.md "custom-security.confused-deputy.md")
- [Rotating RDS Custom for Oracle credentials for compliance programs](custom-security.cred-rotation.md "custom-security.cred-rotation.md")
...
management tasks. For more information, see [AmazonRDSCustomServiceRolePolicy](../../../aws-managed-policy/latest/reference/AmazonRDSCustomServiceRolePolicy.md "../../../aws-managed-policy/latest/reference/AmazonRDSCustomServiceRolePolicy.md").
...
networking setup. For more information, see [Step 4: Configure IAM for RDS Custom for Oracle](custom-setup-orcl.md#custom-setup-orcl.iam-vpc "custom-setup-orcl.md#custom-setup-orcl.iam-vpc").
...
the permissions required for IAM principals who use RDS Custom, see [Step 5: Grant required permissions to your IAM user or role](custom-setup-orcl.md#custom-setup-orcl.iam-user "custom-setup-orcl.md#custom-setup-orcl.iam-user").
...
host-based management tasks such as backups. For more information, see [Create your IAM role and instance profile manually](custom-setup-orcl.md#custom-setup-orcl.iam "custom-setup-orcl.md#custom-setup-orcl.iam").
...
information, see [Configuring Transport Layer Security Authentication](https://docs.oracle.com/en/database/oracle/oracle-database/19/dbseg/configuring-secure-sockets-layer-authentication.html#GUID-6AD89576-526F-4D6B-A539-ADF4B840819F "https://docs.oracle.com/en/database/oracle/oracle-database/19/dbseg/configuring-secure-sockets-layer-authentication.html#GUID-6AD89576-526F-4D6B-A539-ADF4B840819F") in the Oracle Database
documentation.
