...
performing an upgrade, see [Upgrading a DB instance engine version](USER_UpgradeDBInstance.md "USER_UpgradeDBInstance.md").
...
- [RDS version numbers in RDS for MySQL](USER_UpgradeDBInstance.MySQL.rds.md "USER_UpgradeDBInstance.MySQL.rds.md")
