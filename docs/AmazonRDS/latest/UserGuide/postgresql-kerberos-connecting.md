...
4. On the **Connection** tab, enter the following
   ...
   instance. An endpoint looks similar to the
   following:
...
Directory for the user. 2. If the PostgreSQL DB
instance is using a publicly
accessible VPC, put IP address for your DB
instance endpoint in your
