...
For more information, see [Enabling automated backups](USER_WorkingWithAutomatedBackups.Enabling.md "USER_WorkingWithAutomatedBackups.Enabling.md").
...
For more information on parameter groups, see [Parameter groups for Amazon RDS](USER_WorkingWithParamGroups.md "USER_WorkingWithParamGroups.md"). 4. From **Actions**, choose **Edit**. 5. Set the `binlog_format` parameter to the binary logging format of your
...
period** setting, see [Settings for DB instances](USER_ModifyInstance.Settings.md "USER_ModifyInstance.Settings.md"). 6. Choose **Save changes** to save the updates to the DB parameter group.
...
Aurora MySQL, this parameter is static. For more information, see [Configuring Aurora MySQL binary logging](../AuroraUserGuide/USER_LogAccess.MySQL.BinaryFormat.md "../AuroraUserGuide/USER_LogAccess.MySQL.BinaryFormat.md").)
