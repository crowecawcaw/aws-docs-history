...
To get a high-level view of how Amazon RDS and other AWS services work with IAM, see [AWS services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_.
...
To see a list of Amazon RDS condition keys, see [Condition Keys for Amazon RDS](../../../service-authorization/latest/reference/list_amazonrds.md#amazonrds-policy-keys "../../../service-authorization/latest/reference/list_amazonrds.md#amazonrds-policy-keys")
