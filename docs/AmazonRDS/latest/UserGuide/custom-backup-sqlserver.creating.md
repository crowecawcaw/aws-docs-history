...
see [Number of databases eligible for PITR per instance class type](custom-backup.pitr-sqs.md#custom-backup.pitr.sqlserver.eligiblecountperinstance "custom-backup.pitr-sqs.md#custom-backup.pitr.sqlserver.eligiblecountperinstance").
...
You create a snapshot of an RDS Custom DB instance by using the [create-db-snapshot](../../../cli/latest/reference/rds/create-db-snapshot.md "../../../cli/latest/reference/rds/create-db-snapshot.md") AWS CLI command.
