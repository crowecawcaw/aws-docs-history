...
![The Engine options section with the Amazon RDS Optimized Writes filter turned on for Engine Version.](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/images/rds-optimized-writes-version-filter.png)
