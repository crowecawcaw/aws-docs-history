...
- Using unsafe nondeterministic queries such as `SYSDATE()`. For
  ...
  [Skipping the current replication error for RDS for MySQL](Appendix.MySQL.CommonDBATasks.SkipError.md "Appendix.MySQL.CommonDBATasks.SkipError.md"). Otherwise, you can
