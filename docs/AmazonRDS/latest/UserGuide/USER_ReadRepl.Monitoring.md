...
- **error** – An error has
  ...
  information about troubleshooting a replication error, see [Troubleshooting a MySQL read replica problem](USER_ReadRepl.Troubleshooting.md "USER_ReadRepl.Troubleshooting.md").
