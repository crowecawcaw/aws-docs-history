...
- Introduced a new user for binary log (binlog) replication, `rdsrepladmin_priv_checks_user`. For more information, see
  [Privilege
  checks user for binary log replication](../AuroraUserGuide/AuroraMySQL.Compare-80-v3.md#AuroraMySQL.privilege-model.binlog "../AuroraUserGuide/AuroraMySQL.Compare-80-v3.md#AuroraMySQL.privilege-model.binlog") in the _Amazon Aurora User Guide_.
