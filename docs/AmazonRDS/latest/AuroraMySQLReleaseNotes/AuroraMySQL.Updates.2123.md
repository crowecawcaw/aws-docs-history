...
MySQL 5.7.44 (2022-10-11, General Availability)](https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-44.html "https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-44.html").
...
and through [AWS Support](https://aws.amazon.com/support "https://aws.amazon.com/support"). For more information,
see [Maintaining an
Amazon Aurora DB cluster](../AuroraUserGuide/USER_UpgradeDBInstance.Maintenance.md "../AuroraUserGuide/USER_UpgradeDBInstance.Maintenance.md") in the _Amazon Aurora User Guide_.

###### Note

For information on how to upgrade your Aurora MySQL database cluster, see [Upgrading the
minor version or patch level of an Aurora MySQL DB cluster](../AuroraUserGuide/AuroraMySQL.Updates.Patching.md "../AuroraUserGuide/AuroraMySQL.Updates.Patching.md") in the _Amazon Aurora
User Guide_.
...
- [CVE-2023-21912](https://nvd.nist.gov/vuln/detail/CVE-2023-21912 "https://nvd.nist.gov/vuln/detail/CVE-2023-21912")
...
- [CVE-2024-0853](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-0853 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-0853")
...
- [CVE-2024-21009](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21009 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21009")
- [CVE-2024-21013](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21013 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21013")
- [CVE-2024-21047](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21047 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21047")
...
- [CVE-2024-21096](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21096 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21096")
- [CVE-2024-21097](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21097 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2024-21097")
...
- The request timeout for [Aurora machine learning](../AuroraUserGuide/mysql-ml.md "../AuroraUserGuide/mysql-ml.md") operations to Amazon SageMaker AI has been
...
- Fixed an issue where slow `INSERT`, `DELETE`, and
  ...
  Scheduler](https://dev.mysql.com/doc/refman/8.0/en/event-scheduler.html "https://dev.mysql.com/doc/refman/8.0/en/event-scheduler.html") weren't recorded in the slow query log unless preceded by a slow
  `SELECT` query.

## Integration of MySQL Community Edition bug fixes

This release includes all community bug fixes up to and including 5.7.44. For more
information, see [MySQL bugs fixed by Aurora MySQL 2.x database engine updates](AuroraMySQL.Updates.MySQLBugs.md#AuroraMySQL.Updates.MySQLBugs.v2 "AuroraMySQL.Updates.MySQLBugs.md#AuroraMySQL.Updates.MySQLBugs.v2").
...
- Fixed a defect that can cause the server to exit when single-table `UPDATE`
  ...
  statements. ([Bug #29257254](https://dev.mysql.com/doc/relnotes/mysql/8.0/en/news-8-0-17.html "https://dev.mysql.com/doc/relnotes/mysql/8.0/en/news-8-0-17.html"))
