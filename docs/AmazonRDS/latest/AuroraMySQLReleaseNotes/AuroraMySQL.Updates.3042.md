...
version 3](../AuroraUserGuide/Aurora.AuroraMySQL.Compare-v2-v3.md "../AuroraUserGuide/Aurora.AuroraMySQL.Compare-v2-v3.md"). For a comparison of Aurora MySQL version 3 and MySQL 8.0 Community Edition, see [Comparing Aurora MySQL version 3 and MySQL 8.0
Community Edition](../AuroraUserGuide/Aurora.AuroraMySQL.Compare-80-v3.md "../AuroraUserGuide/Aurora.AuroraMySQL.Compare-80-v3.md").
...
for Aurora MySQL version 3](../AuroraUserGuide/AuroraMySQL.mysql80-upgrade-procedure.md#AuroraMySQL.mysql80-planning "../AuroraUserGuide/AuroraMySQL.mysql80-upgrade-procedure.md#AuroraMySQL.mysql80-planning") in the _Amazon Aurora User Guide_. For general information about Aurora MySQL
upgrades, see [Upgrading
Amazon Aurora MySQL DB clusters](../AuroraUserGuide/AuroraMySQL.Updates.Upgrading.md "../AuroraUserGuide/AuroraMySQL.Updates.Upgrading.md") in the _Amazon Aurora User Guide_.
