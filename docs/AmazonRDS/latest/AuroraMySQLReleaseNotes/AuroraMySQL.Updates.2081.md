...
- Global database write forwarding. In an Aurora global database,
  ...
  For more information, see [Using write forwarding in an Amazon Aurora global database](../AuroraUserGuide/aurora-global-database-write-forwarding.md "../AuroraUserGuide/aurora-global-database-write-forwarding.md") in the _Amazon Aurora User Guide_.
