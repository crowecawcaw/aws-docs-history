...
Aurora MySQL 2.08.3 is generally available. Aurora MySQL 2.x versions are compatible with MySQL 5.7
...
You can upgrade an existing Aurora MySQL 1.\* cluster directly to 2.07.3 or higher and then directly upgrade to 2.08.3.
