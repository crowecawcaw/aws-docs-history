...
existing instances. You can apply the patch by choosing a cluster in the [Amazon RDS console](https://console.aws.amazon.com/rds/ "https://console.aws.amazon.com/rds/"), choosing **Cluster
...
- **Advanced Auditing** – Aurora MySQL
  ...
  Advanced Auditing, see [Using Advanced Auditing with an Aurora MySQL DB cluster](../AuroraUserGuide/AuroraMySQL.Auditing.md "../AuroraUserGuide/AuroraMySQL.Auditing.md") in the _Amazon Aurora User Guide_.
