...
- [CVE-2022-32221](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-32221 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-32221")
...
- Fixed an issue where the [SSL server status variables](https://dev.mysql.com/doc/refman/8.0/en/server-status-variables.html#statvar_Ssl_accept_renegotiates "https://dev.mysql.com/doc/refman/8.0/en/server-status-variables.html#statvar_Ssl_accept_renegotiates")) weren't being populated.
