...
- Bug #16311231: Incorrect results were returned if a query contained a subquery in an
  ...
  [XOR](https://dev.mysql.com/doc/refman/5.6/en/logical-operators.html#operator_xor "https://dev.mysql.com/doc/refman/5.6/en/logical-operators.html#operator_xor")
