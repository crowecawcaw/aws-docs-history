...
- Bug #15831300: By default, when promoting integers from a smaller
  ...
  from a [SMALLINT](https://dev.mysql.com/doc/refman/5.6/en/integer-types.html "https://dev.mysql.com/doc/refman/5.6/en/integer-types.html")
  column on the master to a [BIGINT](https://dev.mysql.com/doc/refman/5.6/en/integer-types.html "https://dev.mysql.com/doc/refman/5.6/en/integer-types.html")
