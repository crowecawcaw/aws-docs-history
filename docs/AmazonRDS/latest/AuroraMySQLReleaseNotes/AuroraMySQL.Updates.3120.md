...
- Excluded a community change introduced in MySQL 8.0.44 where failed connection attempts unexpectedly added rows to performance\_schema tables causing excessive memory consumption. Ref community [Bug#119766](https://bugs.mysql.com/bug.php?id=119766 "https://bugs.mysql.com/bug.php?id=119766")
