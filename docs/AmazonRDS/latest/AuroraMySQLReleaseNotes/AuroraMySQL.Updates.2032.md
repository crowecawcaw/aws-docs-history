...
Aurora MySQL 2.03.2 is generally available. Aurora MySQL 2.x versions are compatible with MySQL 5.7
...
to Aurora MySQL 2.03.2 from an Amazon S3 backup. We plan to remove these restrictions in a later Aurora MySQL
2.\* release.
...
- **Aurora Version Selector** – Starting with Aurora MySQL 2.03.2, you can choose from among
  multiple versions of MySQL 5.7-compatible Aurora on the AWS Management Console. For more information, see
  [Checking or specifying Aurora MySQL engine versions through AWS](../AuroraUserGuide/AuroraMySQL.Updates.Versions.md#AuroraMySQL.Updates.EngineVersions "../AuroraUserGuide/AuroraMySQL.Updates.Versions.md#AuroraMySQL.Updates.EngineVersions") in the _Amazon Aurora User Guide_.

**Critical fixes:**

- [CVE-2016-3495](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-3495 "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2016-3495")
...
Aurora MySQL 2.03.2 is wire-compatible with MySQL 5.7 and includes features such as JSON support, spatial indexes,
