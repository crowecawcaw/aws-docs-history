...
- **Improved index build** – The
  ...
  version 1.9 and later. For information, see [Amazon Aurora MySQL lab mode](../AuroraUserGuide/AuroraMySQL.Updates.LabMode.md "../AuroraUserGuide/AuroraMySQL.Updates.LabMode.md") in the _Amazon Aurora User Guide_.
