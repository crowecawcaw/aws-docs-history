...
Aurora MySQL 2.04.4 is generally available. Aurora MySQL 2.x versions are compatible with MySQL 5.7
...
upgrade of Aurora MySQL 1.\* clusters or restore of Aurora MySQL 1.\* clusters from an Amazon S3 backup into Aurora MySQL 2.04.4.
...
2.01.\*, 2.02.\*, 2.03.\*, and 2.04.\* into Aurora MySQL 2.04.4.
...
Aurora MySQL 2.04.4 is wire-compatible with MySQL 5.7 and includes features such as JSON support, spatial indexes,
