...
The AWS CLI is available at [http://aws.amazon.com/cli](http://aws.amazon.com/cli "http://aws.amazon.com/cli"). It runs on Windows, MacOS and Linux. After you download the AWS CLI, follow these steps to install and configure it:
...
2. Follow the instructions for [Installing the AWS CLI](../../../cli/latest/userguide/cli-chap-install.md "../../../cli/latest/userguide/cli-chap-install.md") and
