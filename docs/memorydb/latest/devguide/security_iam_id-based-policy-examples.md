...
By default, users and roles don't have permission to create or modify MemoryDB
...
For details about actions and resource types defined by MemoryDB, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for MemoryDB](../../../IAM/latest/UserGuide/list_awskeymanagementservice.md "../../../IAM/latest/UserGuide/list_awskeymanagementservice.md") in the _Service Authorization Reference_.

###### Topics

- [Policy best practices](#security_iam_service-with-iam-policy-best-practices "#security_iam_service-with-iam-policy-best-practices")
- [Using the MemoryDB console](#security_iam_id-based-policy-examples-console "#security_iam_id-based-policy-examples-console")
...
Identity-based policies determine whether someone can create, access, or delete MemoryDB resources in your
...
To access the MemoryDB console, you must have a minimum set of permissions.
These permissions must allow you to list and view details about the MemoryDB resources
...
To ensure that users and roles can still use the MemoryDB console, also attach the MemoryDB
