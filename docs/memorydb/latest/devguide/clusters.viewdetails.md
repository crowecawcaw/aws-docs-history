...
For more information, see [Metrics for MemoryDB](metrics.memorydb.md "metrics.memorydb.md"). 6. Choose the **Network and security** tab to see details of the subnet group and security groups.
