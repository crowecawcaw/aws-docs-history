...
| <br />`us-gov-east-1` | `usge1-az1, usge1-az2, usge1-az3` | 
| <br />`us-gov-west-1` | `usgw1-az1, usgw1-az2, usgw1-az3` | 
...
+ [Ensuring sufficient IP addresses for scaling operations](subnetgroups.ipcapacity.md)
