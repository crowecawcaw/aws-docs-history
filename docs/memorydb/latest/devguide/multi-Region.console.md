...
![Create a cluster, console view.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/create-multi-region1.png)
...
1. Navigate to the create cluster section from the cluster list or dashboard.   
![Create and configure a cluster, console view.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/create-multi-region2-configure.png)
...
1. Navigate to the create cluster section from the cluster list or dashboard.   
![Restore a cluster, console view.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/restore-multi-region-from-snapshot1.png)
...
![Console view of selecting the source snapshot to restore to Multi-Region cluster.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/restore-multi-region-from-snapshot2-confirm.png)

1. To see your Multi-Region clusters, navigate to the cluster section:  
![Console view of the cluster section for modifying Multi-Region clusters.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/restore-multi-region-from-snapshot3-confirm.png)

1. Now select the target multi regional cluster name.  
![Console view of selecting the multi regional cluster to modify.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/restore-multi-region-from-snapshot4-confirm.png)

1. Now select the target regional cluster name.  
![Console view of selecting theregional cluster to modify.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/restore-multi-region-from-snapshot5-confirm.png)
...
![This is my image.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/modify-multi-region1.png)
...
![Console view of selecting a target Multi-Region cluster to modify.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/modify-multi-region2.png)
...
![Console view of selecting a target Multi-Region cluster to add a regional cluster to.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/modify-multi-region3-add-regional-cluster.png)

1. To add a Region, select the target Region. Then fill in the required information and select **Add AWS Region**.  
![Console view of selecting a target Multi-Region cluster to add a Region to.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/modify-multi-region4-add-region.png)
...
![Console view of selecting an empty Multi-Region cluster to add a new regional cluster to.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/modify-multi-region5-add-regional-cluster-to-empty.png)
...
![Console view of selecting a single cluster to delete.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/delete-multi-region1-select.png)
...
![Consolve view of a confirmation window for deletion.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/delete-multi-region2-snapshot.png)
...
![Console view of selecting to delete all associated clusters with a Multi Region cluster.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/delete-multi-region3-associated-clusters.png)
...
![Console view of deleting an entire multi regional cluster.](https://docs.aws.amazon.com/memorydb/latest/devguide/images/delete-multi-region4-entire-mrc.png)