...
The number of dimensions of your vectors is dependent on the embedding model you choose. For instance, if you choose to use the [AWS Titan](https://aws.amazon.com/bedrock/titan/ "https://aws.amazon.com/bedrock/titan/") embedding model then the number of dimensions would be 1536.
...
![Vector search cluster settings in the AWS console.](images/vector-search-cluster-settings-console.png)
...
![The vector calculator recommended node type, based on the input to the calculator.](images/vector-calc1.png)

![The vector calculator with values entered.](images/vector-calc2.png)
...
The commands `FT.CREATE`, `FT.DROPINDEX`, `FT.ALIASADD`, `FT.ALIASDEL`, and `FT.ALIASUPDATE`
