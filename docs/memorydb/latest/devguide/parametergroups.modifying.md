...
To find the name of the parameter you changed, see [Engine specific parameters](parametergroups.redis.md "parametergroups.redis.md").
...
To find the name and permitted values of the parameter you want to change, see [Engine specific parameters](parametergroups.redis.md "parametergroups.redis.md")
