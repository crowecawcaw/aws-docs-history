...
After a MemoryDB cluster is created, it can be altered (scaled in or out). For more information, see [Scaling](scaling.md "scaling.md") and [Replacing nodes](nodes.nodereplacement.md "nodes.nodereplacement.md").
