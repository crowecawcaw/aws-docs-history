...
To monitor the ratio of items in DRAM compared to SSD, you can use the `CurrItems` metric at [Metrics for MemoryDB](metrics.memorydb.md "metrics.memorydb.md").
...
For more information, see _Metrics for MemoryDB clusters that use data tiering_ at [Metrics for MemoryDB](metrics.memorydb.md "metrics.memorydb.md").
