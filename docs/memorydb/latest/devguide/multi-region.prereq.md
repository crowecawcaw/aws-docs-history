...
+ Transactions are supported in MemoryDB Multi-Region. Transaction atomicity is guaranteed within a single region, but is not guaranteed across regions due to eventual consistency and CRDT-based conflict resolution.
