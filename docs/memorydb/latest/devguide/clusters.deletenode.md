...
1. Identify the names of the nodes that you want to remove. For more information, see [Viewing a cluster's details](clusters.viewdetails.md "clusters.viewdetails.md").
