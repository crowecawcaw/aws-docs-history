...
+  [Inspektor Gadget advise network-policy gadget](https://www.inspektor-gadget.io/docs/latest/gadgets/advise_networkpolicy) Suggests network policies based on an analysis of network traffic
