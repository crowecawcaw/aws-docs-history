...
[https://docs.aws.amazon.com/eks/latest/userguide/windows-support.html](../userguide/windows-support.md "../userguide/windows-support.md")

To better understand how Pod Networking (CNI) works, check the following link: [https://docs.aws.amazon.com/eks/latest/userguide/pod-networking.html](../userguide/pod-networking.md "../userguide/pod-networking.md")

AWS Blog on Deploying Managed Node Group for Windows on EKS:
[https://aws.amazon.com/blogs/containers/deploying-amazon-eks-windows-managed-node-groups/](https://aws.amazon.com/blogs/containers/deploying-amazon-eks-windows-managed-node-groups/ "https://aws.amazon.com/blogs/containers/deploying-amazon-eks-windows-managed-node-groups/")
