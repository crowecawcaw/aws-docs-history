...
![illustration of node with security group connecting to RDS](http://docs.aws.amazon.com/eks/latest/best-practices/images/networking/sgpp_image.png)
...
![illustration of pod and node with different security groups connecting to RDS](http://docs.aws.amazon.com/eks/latest/best-practices/images/networking/sgpp_image-2.png)
...
![illustration of worker subnet with security groups associated with ENIs](http://docs.aws.amazon.com/eks/latest/best-practices/images/networking/sgpp_image-3.png)
