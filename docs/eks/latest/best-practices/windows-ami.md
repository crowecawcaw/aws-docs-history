...
- [containerd](https://containerd.io/ "https://containerd.io/")
  You can programmatically retrieve the Amazon Machine Image (AMI) ID for Amazon EKS optimized AMIs by querying the AWS Systems Manager Parameter Store API. This parameter eliminates the need for you to manually look up Amazon EKS optimized AMI IDs. For more information about the Systems Manager Parameter Store API, see [GetParameter](../../../systems-manager/latest/APIReference/API_GetParameter.md "../../../systems-manager/latest/APIReference/API_GetParameter.md"). Your user account must have the ssm:GetParameter IAM permission to retrieve the Amazon EKS optimized AMI metadata.
...
**NOTE:** Prior to selecting a base image, consult the [Windows Server Version and License](windows-licensing.md "windows-licensing.md") section for important details pertaining to release channel updates.
...
For more information: [AWS Windows AMIs - Configure your AMI for faster launching](../../../AWSEC2/latest/WindowsGuide/windows-ami-version-history.md#win-ami-config-fast-launch "../../../AWSEC2/latest/WindowsGuide/windows-ami-version-history.md#win-ami-config-fast-launch")
...
On Amazon EC2 Image Builder, create a [component](../../../imagebuilder/latest/userguide/manage-components.md "../../../imagebuilder/latest/userguide/manage-components.md") to download the necessary images and attach it to the Image recipe. The following example pulls a specific image from a ECR repository.
...
![permissions policies](images/windows/permissions-policies.png)
