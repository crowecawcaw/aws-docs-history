...
[EKS Auto Mode](../userguide/automode.md "../userguide/automode.md"), which is
...
when this occurs by configuring [disruption controls](../userguide/create-node-pool.md#_disruption "../userguide/create-node-pool.md#_disruption")
...
[Managed
node groups](../userguide/managed-node-groups.md "../userguide/managed-node-groups.md") automate the provisioning and lifecycle management of EC2
...
EKS also
[manages
updating the nodes](../userguide/update-managed-node-group.md "../userguide/update-managed-node-group.md") although you have to initiate the update process.
The process of
[updating
managed node](../userguide/managed-node-update-behavior.md "../userguide/managed-node-update-behavior.md") is explained in the EKS documentation.

If you run self-managed nodes, you can use
[Amazon
EKS-optimized Linux AMI](../userguide/eks-optimized-ami.md "../userguide/eks-optimized-ami.md") to create worker nodes. You are responsible for
...
[upgrade
self-managed nodes](../userguide/update-workers.md "../userguide/update-workers.md"). Consider
[migrating
to new nodes](../userguide/migrate-stack.md "../userguide/migrate-stack.md") when updating worker nodes because the migration process
...
[in-place
upgrade of self-managed nodes](../userguide/update-stack.md "../userguide/update-stack.md").

**Shared Responsibility Model - Fargate**

![Shared Responsibility Model - Fargate](images/reliability/SRM-Fargate.jpeg)

**Shared Responsibility Model - MNG**

![Shared Responsibility Model - MNG](images/reliability/SRM-MNG.jpeg)
