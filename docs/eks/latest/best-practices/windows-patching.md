...
Using [EC2 Image Builder](https://aws.amazon.com/image-builder/ "https://aws.amazon.com/image-builder/") you can automate AMIs build, by creating recipes and adding components.
...
![associated components](images/windows/associated-components.png)
...
![images](images/windows/images.png)
...
The following example shows a [fluentd Windows ltsc](https://github.com/fluent/fluentd-docker-image/blob/master/v1.14/windows-ltsc2019/Dockerfile "https://github.com/fluent/fluentd-docker-image/blob/master/v1.14/windows-ltsc2019/Dockerfile") image pushed to an Amazon ECR repository. The size of the layer stored in ECR is **533.05MB**.

![ecr image](images/windows/ecr-image.png)
...
- Fluentd [compressed final image ECR](../../../AmazonECR/latest/userguide/repository-info.md "../../../AmazonECR/latest/userguide/repository-info.md") = 533.05MB
