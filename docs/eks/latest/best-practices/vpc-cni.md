...
If you are using custom AMI, make sure to set iptables forward policy to ACCEPT under [kubelet.service](https://github.com/awslabs/amazon-eks-ami/blob/main/templates/al2023/runtime/rootfs/etc/systemd/system/kubelet.service "https://github.com/awslabs/amazon-eks-ami/blob/main/templates/al2023/runtime/rootfs/etc/systemd/system/kubelet.service"). Many systems set the iptables forward policy to DROP. You can build custom AMI using [HashiCorp Packer](https://packer.io/intro/why.html "https://packer.io/intro/why.html") and a build specification with resources and configuration scripts from the [Amazon EKS AMI repository on AWS GitHub](https://github.com/awslabs/amazon-eks-ami "https://github.com/awslabs/amazon-eks-ami"). You can update the [kubelet.service](https://github.com/awslabs/amazon-eks-ami/blob/main/templates/al2023/runtime/rootfs/etc/systemd/system/kubelet.service "https://github.com/awslabs/amazon-eks-ami/blob/main/templates/al2023/runtime/rootfs/etc/systemd/system/kubelet.service") and follow the instructions specified [here](https://aws.amazon.com/premiumsupport/knowledge-center/eks-custom-linux-ami/ "https://aws.amazon.com/premiumsupport/knowledge-center/eks-custom-linux-ami/") to create a custom AMI.
