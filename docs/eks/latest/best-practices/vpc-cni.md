...
<a name="_deploy_eks_cluster_with_auto_mode"></a>
...
<a name="_deploy_vpc_cni_managed_add_on"></a>
...
<a name="_migrate_to_managed_add_on"></a>
...
<a name="_backup_cni_settings_before_update"></a>
...
<a name="_understand_security_context"></a>
...
It is advised that you [block access instance metadata](https://docs.aws.amazon.com/eks/latest/best-practices/identity-and-access-management.html#_identities_and_credentials_for_eks_pods_recommendations) to minimize the blast radius of security breach.

### Handle Liveness/Readiness Probe failures
<a name="_handle_livenessreadiness_probe_failures"></a>
...
<a name="_configure_iptables_forward_policy_on_non_eks_optimized_ami_instances"></a>
