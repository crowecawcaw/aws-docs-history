...
those outlined in the [Runtime Security](runtime-security.md "runtime-security.md") section.
...
[Bottlerocket](https://github.com/bottlerocket-os/bottlerocket/ "https://github.com/bottlerocket-os/bottlerocket/"), a
...
Alternately, use the
[EKS
optimized AMI](../userguide/eks-optimized-amis.md "../userguide/eks-optimized-amis.md") for your Kubernetes worker nodes. The EKS optimized AMI
...
Please refer [Amazon
EKS AMI RHEL Build Specification](https://github.com/aws-samples/amazon-eks-ami-rhel "https://github.com/aws-samples/amazon-eks-ami-rhel") for a sample configuration script
...
[CHANGELOG](https://github.com/awslabs/amazon-eks-ami/blob/master/CHANGELOG.md "https://github.com/awslabs/amazon-eks-ami/blob/master/CHANGELOG.md")
and/or [release notes
channel](https://github.com/awslabs/amazon-eks-ami/releases "https://github.com/awslabs/amazon-eks-ami/releases") and automate the rollout of updated worker node images into
your cluster.
...
[managed
node groups](../userguide/managed-node-groups.md "../userguide/managed-node-groups.md") uses the first approach and will display a message in the
...
### Periodically run kube-bench to verify compliance with [CIS benchmarks for Kubernetes](https://www.cisecurity.org/benchmark/kubernetes/ "https://www.cisecurity.org/benchmark/kubernetes/")
...
When running [kube-bench](https://github.com/aquasecurity/kube-bench "https://github.com/aquasecurity/kube-bench")
against an EKS cluster, follow
[these
instructions](https://github.com/aquasecurity/kube-bench/blob/main/docs/running.md#running-cis-benchmark-in-an-eks-cluster "https://github.com/aquasecurity/kube-bench/blob/main/docs/running.md#running-cis-benchmark-in-an-eks-cluster") from Aqua Security. For further information see
[Introducing
The CIS Amazon EKS Benchmark](https://aws.amazon.com/blogs/containers/introducing-cis-amazon-eks-benchmark/ "https://aws.amazon.com/blogs/containers/introducing-cis-amazon-eks-benchmark/").

### Minimize access to worker nodes

Instead of enabling SSH access, use
[SSM
Session Manager](../../../systems-manager/latest/userguide/session-manager.md "../../../systems-manager/latest/userguide/session-manager.md") when you need to remote into a host. Unlike SSH keys
...
[this
example](https://github.com/aws-samples/ssm-agent-daemonset-installer "https://github.com/aws-samples/ssm-agent-daemonset-installer").
...
You can use
[Amazon
Inspector](../../../inspector/latest/user/what-is-inspector.md "../../../inspector/latest/user/what-is-inspector.md") to check for unintended network access to your nodes and for
...
on several
[Amazon
Machine Images (AMIs)](../../../systems-manager/latest/userguide/ami-preinstalled-agent.md "../../../systems-manager/latest/userguide/ami-preinstalled-agent.md") including
[EKS
optimized Amazon Linux AMIs](../userguide/eks-optimized-ami.md "../userguide/eks-optimized-ami.md"). Regardless of SSM agent status, all of
...
[Scanning
Amazon EC2 instances](../../../inspector/latest/user/enable-disable-scanning-ec2.md "../../../inspector/latest/user/enable-disable-scanning-ec2.md").
...
[container-selinux](https://github.com/containers/container-selinux "https://github.com/containers/container-selinux")
