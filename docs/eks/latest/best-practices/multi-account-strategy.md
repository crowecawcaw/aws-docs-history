...
[EKS
Pod Identities](../userguide/pod-identities.md "../userguide/pod-identities.md") is a new way of delivering AWS credentials to your
...
perform
[Role
Chaining](../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md#iam-term-role-chaining "../../../IAM/latest/UserGuide/id_roles_terms-and-concepts.md#iam-term-role-chaining").

Role chaining can be configured in an applications profile with their
aws configuration file using the
[Process
Credentials Provider](../../../sdkref/latest/guide/feature-process-credentials.md "../../../sdkref/latest/guide/feature-process-credentials.md") available in various AWS SDKs.
...
[EKS
specific attributes](../userguide/pod-id-abac.md "../userguide/pod-id-abac.md") as session tags and use attribute based access
