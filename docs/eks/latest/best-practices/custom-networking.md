...
![Architecture diagram showing an EKS worker node with its primary ENI attached to the primary VPC CIDR range 10.0.0.0/16 and secondary ENIs attached to the secondary VPC CIDR range 100.64.0.0/16](https://docs.aws.amazon.com/eks/latest/best-practices/images/networking/cn-image.png)
...
![Architecture diagram showing EKS clusters deployed in non-routable 100.64.0.0/16 secondary CIDR range](https://docs.aws.amazon.com/eks/latest/best-practices/images/networking/cn-image-3.png)
...
![Architecture diagram showing Kubernetes worker nodes deployed on subnets from a secondary VPC CIDR range such as 100.64.0.0/10 without custom networking](https://docs.aws.amazon.com/eks/latest/best-practices/images/networking/cn-image-2.png)
