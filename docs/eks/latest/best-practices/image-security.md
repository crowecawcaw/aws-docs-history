...
an application like [Dive](https://github.com/wagoodman/dive "https://github.com/wagoodman/dive") which can
...
[Docker’s
multi-stage builds documentation](https://docs.docker.com/develop/develop-images/multistage-build/ "https://docs.docker.com/develop/develop-images/multistage-build/").
...
management. [Generating, storing SBOMS in a
central repository and scanning SBOMs for vulnerabilities](https://anchore.com/sbom/ "https://anchore.com/sbom/") helps address
...
- [Amazon Inspector](../../../inspector.md "../../../inspector.md") can be used to
  [create
  and export SBOMs](../../../inspector/latest/user/sbom-export.md "../../../inspector/latest/user/sbom-export.md").
- [Syft from Anchore](https://github.com/anchore/syft "https://github.com/anchore/syft") can also be used
...
[CNCF Software
Supply Chain Best Practices guide](https://project.linuxfoundation.org/hubfs/CNCF_SSCP_v1.pdf "https://project.linuxfoundation.org/hubfs/CNCF_SSCP_v1.pdf").
...
[two
types of scanning - Basic and Enhanced](../../../AmazonECR/latest/userguide/image-scanning.md "../../../AmazonECR/latest/userguide/image-scanning.md"). Basic scanning leverages
[Clair](https://github.com/quay/clair "https://github.com/quay/clair") an open source image scanning
solution for no cost.
[Enhanced
scanning](../../../AmazonECR/latest/userguide/image-scanning-enhanced.md "../../../AmazonECR/latest/userguide/image-scanning-enhanced.md") uses Amazon Inspector to provide automatic continuous scans
for [additional cost](https://aws.amazon.com/inspector/pricing/ "https://aws.amazon.com/inspector/pricing/"). After an
...
- [Palo
  Alto - Prisma Cloud (twistcli)](https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-compute/tools/twistcli_scan_images "https://docs.paloaltonetworks.com/prisma/prisma-cloud/prisma-cloud-admin-compute/tools/twistcli_scan_images")
...
webhook.
[This](https://aws.amazon.com/blogs/containers/building-serverless-admission-webhooks-for-kubernetes-with-aws-sam/ "https://aws.amazon.com/blogs/containers/building-serverless-admission-webhooks-for-kubernetes-with-aws-sam/")
...
- Attestations can be created using
  [AWS
  Signer](../../../signer/latest/developerguide/Welcome.md "../../../signer/latest/developerguide/Welcome.md") or
  [Sigstore
  cosign](https://github.com/sigstore/cosign/blob/main/doc/cosign_attest.md "https://github.com/sigstore/cosign/blob/main/doc/cosign_attest.md").
...
[namespaces](../../../AmazonECR/latest/userguide/Repositories.md#repository-concepts "../../../AmazonECR/latest/userguide/Repositories.md#repository-concepts").
...
[Amazon
ECR interface VPC endpoints](../../../AmazonECR/latest/userguide/vpc-endpoints.md "../../../AmazonECR/latest/userguide/vpc-endpoints.md").
...
See,
[aws:PrincipalOrgID](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-principalorgid "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-principalorgid")
