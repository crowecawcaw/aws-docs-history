...
![Kubernetes components](images/scalability/k8s-components.png)
...
![Keeping up](images/scalability/keeping-up.png)
...
![PLEG duration](images/scalability/PLEG-duration.png)
...
![Flow add-ons](images/scalability/flow-addons.png)
...
![Bottlenecks](images/scalability/bottlenecks.png)
