...
While AWS handles most operational aspects, customers retain responsibility for [cluster version management](../userguide/update-cluster.md "../userguide/update-cluster.md") and can perform controlled upgrades that trigger rolling updates of worker nodes .
...
in the official [AWS Documentation](../userguide/auto-enable-existing.md "../userguide/auto-enable-existing.md")
...
![General Purpose NodePool](images/autoscaling/gp_nodepool.png)
...
![System NodePool](images/autoscaling/system_nodepool.png)
...
NodePools please consult the [Karpenter Documentation](https://karpenter.sh/docs/concepts/nodepools/ "https://karpenter.sh/docs/concepts/nodepools/").
...
be deploying the workload as a Kubernetes [DaemonSet](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/ "https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/").
