...
+  [EKS managed nodegroups](nodegroup-managed.md) 
...
+  [Support Node Repair Configuration for EKS Managed Nodegroups](nodegroup-node-repair-config.md) 
...
+  [Launch Template support for Managed Nodegroups](launch-template-support.md) 
...
+  [Unmanaged nodegroups](nodegroup-unmanaged.md) 
...
+  [Additional Volume Mappings](nodegroup-additional-volume-mappings.md) 
...
+  [Windows Worker Nodes](windows-worker-nodes.md) 
...
+  [Custom AMI support](custom-ami-support.md) 
...
+  [Custom DNS](nodegroup-customize-dns.md) 
