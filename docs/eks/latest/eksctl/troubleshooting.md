...
Then you might need to set [enableDnsHostnames](../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support "../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support"). More details can be found in [this issue](https://github.com/eksctl-io/eksctl/issues/4645 "https://github.com/eksctl-io/eksctl/issues/4645").
