...
For more information, see [Set Cluster Authentication Mode](../userguide/grant-k8s-access.md#set-cam "../userguide/grant-k8s-access.md#set-cam")
...
For more information about the _types_ of access entries, see [Create access entries](../userguide/creating-access-entries.md "../userguide/creating-access-entries.md")
