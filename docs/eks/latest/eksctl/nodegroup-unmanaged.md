...
You should be upgrading nodegroups only after you ran `eksctl upgrade cluster`. (See [Upgrading clusters](cluster-upgrade.md).)
...
<a name="_updating_multiple_nodegroups"></a>
...
<a name="_updating_with_config_file"></a>
...
<a name="_updating_default_add_ons"></a>

You may need to update the networking add-ons installed on your cluster. For more information, see [Default add-on updates](addon-upgrade.md).