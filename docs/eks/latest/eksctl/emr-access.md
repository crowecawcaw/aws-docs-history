...
In order to allow [EMR](https://aws.amazon.com/emr/ "https://aws.amazon.com/emr/") to perform operations on the Kubernetes API, its SLR needs to be granted the required RBAC permissions.
