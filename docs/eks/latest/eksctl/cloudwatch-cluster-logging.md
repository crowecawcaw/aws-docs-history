...
[CloudWatch logging](../userguide/control-plane-logs.md "../userguide/control-plane-logs.md") for EKS control plane is not enabled by default due to data
...
To learn more, see [EKS documentation](../userguide/control-plane-logs.md "../userguide/control-plane-logs.md").
