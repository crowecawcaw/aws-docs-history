...
eksctl supports [EKS Auto Mode](../userguide/automode.md "../userguide/automode.md"), a feature that extends AWS management of Kubernetes clusters beyond the cluster itself,
...
To use private subnets for worker nodes launched by Auto Mode, [update the cluster to use private subnets](cluster-subnets-security-groups.md "cluster-subnets-security-groups.md").
...
- [EKS Auto Mode](../userguide/automode.md "../userguide/automode.md")
