...
- **Create new cluster**: You must create a new cluster and specify that you want to use the `IPv6` family for that cluster. You can’t enable the `IPv6` family for a cluster that you updated from a previous version. For instructions on how to create a new cluster, see [Deploying an Amazon EKS IPv6 cluster and managed Amazon Linux nodes](deploy-ipv6-cluster.md "deploy-ipv6-cluster.md").
