...
NVIDIA’s official implementation of the [Kubernetes device plugin](https://github.com/NVIDIA/k8s-device-plugin) does not support Windows. You can track the progress on adding official Windows support in the [NVIDIA/k8s-device-plugin issue \#419](https://github.com/NVIDIA/k8s-device-plugin/issues/419).
