...
**Standardized data format** — Security Lake converts the collected data into the [Open Cybersecurity Schema Framework (OCSF) format](../../../security-lake/latest/userguide/open-cybersecurity-schema-framework.md "../../../security-lake/latest/userguide/open-cybersecurity-schema-framework.md"), which is a standard open-source schema. This normalization enables easier analysis and integration with other security tools and services.
...
1. Enable Amazon EKS control plane logging for your EKS clusters. Refer to [Enabling and disabling control plane logs](control-plane-logs.md#enabling-control-plane-log-export "control-plane-logs.md#enabling-control-plane-log-export") for detailed instructions.
2. [Add Amazon EKS Audit Logs as a source in Security Lake.](../../../security-lake/latest/userguide/internal-sources.md#add-internal-sources "../../../security-lake/latest/userguide/internal-sources.md#add-internal-sources") Security Lake will then start collecting in-depth information about the activities performed on the Kubernetes resources running in your EKS clusters.
3. [Configure retention and replication settings](../../../security-lake/latest/userguide/lifecycle-management.md "../../../security-lake/latest/userguide/lifecycle-management.md") for your security data in Security Lake based on your requirements.
4. Use the normalized OCSF data stored in Security Lake for incident response, security analytics, and integration with other AWS services or third-party tools. For example, you can [Generate security insights from Amazon Security Lake data using Amazon OpenSearch Ingestion](https://aws.amazon.com/blogs/big-data/generate-security-insights-from-amazon-security-lake-data-using-amazon-opensearch-ingestion "https://aws.amazon.com/blogs/big-data/generate-security-insights-from-amazon-security-lake-data-using-amazon-opensearch-ingestion").
...
For more information about the OCSF mapping for EKS log events, refer to the [https://github.com/ocsf/examples/tree/main/mappings/markdown/](https://github.com/ocsf/examples/tree/main/mappings/markdown/ "https://github.com/ocsf/examples/tree/main/mappings/markdown/")
AWS/v1.1.0/EKS Audit Logs[mapping reference] in the OCSF GitHub repository.
