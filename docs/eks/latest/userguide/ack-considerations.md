...
The AWS resource is deleted when you delete the Kubernetes resource. This maintains consistency between your cluster and AWS, ensuring resources do not accumulate.
...
+ For creating and managing resources, see the [ACK usage guide](https://aws-controllers-k8s.github.io/docs/guides/create-resource).
+ For complete API documentation for all services, see the [ACK API reference](https://aws-controllers-k8s.github.io/docs/api-reference).
+ For comprehensive user documentation, see the [ACK documentation](https://aws-controllers-k8s.github.io/docs/).
