...
1. (Optional) Verify the downloaded binary with the `SHA-256` checksum for your binary.
   ...
   1. Make sure that the generated checksum in the output matches the checksum in the downloaded `kubectl.sha256` file.
...
1. (Optional) Verify the downloaded binary with the `SHA-256` checksum for your binary.
   ...
   1. For the first, you should see `kubectl: OK`, for the second, you can check that the generated checksum in the output matches the checksum in the downloaded `kubectl.sha256` file.
