...
+ Direct access to `argocd-params` and most configuration ConfigMaps (a subset of `argocd-cm` fields is supported. See [Configure Argo CD settings](argocd-configure-settings.md))
