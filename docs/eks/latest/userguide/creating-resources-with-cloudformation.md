...
Amazon EKS supports creating clusters and node groups in AWS CloudFormation. For more information, including examples of JSON and YAML templates for your Amazon EKS resources, see [Amazon EKS resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_EKS.md "../../../AWSCloudFormation/latest/UserGuide/AWS_EKS.md") in the _AWS CloudFormation User Guide_.
