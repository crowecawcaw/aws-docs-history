...
**Topics**
+ [Amazon EKS identity-based policies](#security-iam-service-with-iam-id-based-policies)
+ [Amazon EKS resource-based policies](#security-iam-service-with-iam-resource-based-policies)
+ [Authorization based on Amazon EKS tags](#security-iam-service-with-iam-tags)
+ [Amazon EKS IAM roles](#security-iam-service-with-iam-roles)
