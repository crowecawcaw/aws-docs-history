...
- [Guide to EKS AL2 & AL2-Accelerated AMIs transition features](eks-ami-deprecation-faqs.md "eks-ami-deprecation-faqs.md")
- [Create nodes with optimized Amazon Linux AMIs](eks-optimized-ami.md "eks-optimized-ami.md")
- [Create nodes with optimized Bottlerocket AMIs](eks-optimized-ami-bottlerocket.md "eks-optimized-ami-bottlerocket.md")
- [Create nodes with optimized Ubuntu Linux AMIs](eks-partner-amis.md "eks-partner-amis.md")
- [Create nodes with optimized Windows AMIs](eks-optimized-windows-ami.md "eks-optimized-windows-ami.md")
