...
- For more information, see [Use Capacity Blocks for machine learning workloads](../../../autoscaling/ec2/userguide/launch-template-capacity-blocks.md "../../../autoscaling/ec2/userguide/launch-template-capacity-blocks.md") in the _Amazon EC2 Auto Scaling User Guide_.
