...
These capabilities are enabled by [Amazon CloudWatch Network Flow Monitor](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor.md").
...
To get started, enable Container Network Observability in the EKS console for a new or existing cluster. This will automate the creation of Network Flow Monitor (NFM) dependencies ([Scope](../../../networkflowmonitor/2.0/APIReference/API_CreateScope.md "../../../networkflowmonitor/2.0/APIReference/API_CreateScope.md") and [Monitor](../../../networkflowmonitor/2.0/APIReference/API_CreateMonitor.md "../../../networkflowmonitor/2.0/APIReference/API_CreateMonitor.md") resources). In addition, you will have to install the [Network Flow Monitor Agent add-on](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-agents-kubernetes-eks.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-agents-kubernetes-eks.md"). Alternatively, you can install these dependencies using the `AWS CLI`, [EKS APIs](../APIReference/API_Operations_Amazon_Elastic_Kubernetes_Service.md "../APIReference/API_Operations_Amazon_Elastic_Kubernetes_Service.md") (for the add-on), [NFM APIs](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-API-operations.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-API-operations.md") or Infrastructure as Code (like [Terraform](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/networkflowmonitor_monitor "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/networkflowmonitor_monitor")). Once these dependencies are in place, you can configure your preferred monitoring tool to scrape network performance metrics for pods and worker nodes from the NFM agent. To visualize the network activity and performance of your workloads, you can navigate to the EKS console under the “Network” tab of the cluster’s observability dashboard.

When using Network Flow Monitor in EKS, you can maintain your existing observability workflow and technology stack while leveraging a set of additional features which further enable you to understand and optimize the network layer of your EKS environment. You can learn more about the [Network Flow Monitor pricing here](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor.pricing.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor.pricing.md").
...
![Illustration of workflow with different performance metrics](images/nfm-eks-metrics-types-workflow.png)
...
![Illustration of how NFM works with EKS](images/nfm-eks-workflow.png)
...
![Illustration of service map with ecommerce app in deployment view](images/ecommerce-deployment.png)

_Pod view_

![Illustration of service map with ecommerce app in pod view](images/ecommerce-pod.png)

_Deployment view_

![Illustration of service map with photo-gallery app in deployment view](images/photo-gallery-deployment.png)

_Pod view_

![Illustration of service map with photo-gallery app in pod view](images/photo-gallery-pod.png)

#### Example: Flow table

_AWS service view_

![Illustration of flow table view](images/aws-service-view.png)

_Cluster view_

![Illustration of flow table in cluster view](images/cluster-view.png)

## Considerations and limitations

- Container Network Observability in EKS is only available in regions where [Network Flow Monitor is supported](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-Regions.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-NetworkFlowMonitor-Regions.md").
