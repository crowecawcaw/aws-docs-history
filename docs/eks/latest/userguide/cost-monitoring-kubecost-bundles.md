...
No. *Amazon EKS optimized Kubecost bundle* is only compatible with Amazon EKS clusters.
...
![Kubecost architecture](https://docs.aws.amazon.com/eks/latest/userguide/images/kubecost-architecture.png)
