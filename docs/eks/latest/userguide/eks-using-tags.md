...
- [Tagging your resources for billing](#tag-resources-for-billing "#tag-resources-for-billing")
- [Working with tags using the console](#tag-resources-console "#tag-resources-console")
- [Working with tags using the CLI, API, or eksctl](#tag-resources-api-sdk "#tag-resources-api-sdk")
...
- [Labels and Selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/ "https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/")
- [Annotations](https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/ "https://kubernetes.io/docs/concepts/overview/working-with-objects/annotations/")
...
- If you’re using the Amazon EKS console, you can apply tags to new or existing resources at any time. You can do this by using the **Tags** tab on the relevant resource page. For more information, see [Working with tags using the console](#tag-resources-console "#tag-resources-console").
- If you’re using `eksctl`, you can apply tags to resources when they’re created using the `--tags` option.
- If you’re using the AWS CLI, the Amazon EKS API, or an AWS SDK, you can apply tags to new resources using the `tags` parameter on the relevant API action. You can apply tags to existing resources using the `TagResource` API action. For more information, see [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md").
...
- If multiple AWS services and resources use your tagging schema, limit the types of characters you use. Some services might have restrictions on allowed characters. Generally, allowed characters are letters, numbers, spaces, and the following characters: `+`
  `-`
  `=`
  `.`
  `_`
...
When you apply tags to Amazon EKS clusters, you can use them for cost allocation in your **Cost & Usage Reports**. The metering data in your **Cost & Usage Reports** shows usage across all of your Amazon EKS clusters. For more information, see [AWS cost and usage report](../../../awsaccountbilling/latest/aboutv2/billing-reports-costusage.md "../../../awsaccountbilling/latest/aboutv2/billing-reports-costusage.md") in the _AWS Billing User Guide_.
...
You can also use **Tag Editor** in the AWS Management Console, which provides a unified way to manage your tags. For more information, see [Tagging your AWS resources with Tag Editor](../../../ARG/latest/userguide/tag-editor.md "../../../ARG/latest/userguide/tag-editor.md") in the _AWS Tag Editor User Guide_.

### Adding tags on a resource on creation

You can add tags to Amazon EKS clusters, managed node groups, and Fargate profiles when you create them. For more information, see [Create an Amazon EKS cluster](create-cluster.md "create-cluster.md").
...
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Add or overwrite one or more tags. | [tag-resource](../../../cli/latest/reference/eks/tag-resource.md "../../../cli/latest/reference/eks/tag-resource.md")                               | [Add-EKSResourceTag](../../../powershell/latest/reference/items/Add-EKSResourceTag.md "../../../powershell/latest/reference/items/Add-EKSResourceTag.md")          | [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md")                                 |
| Delete one or more tags.           | [untag-resource](../../../cli/latest/reference/eks/untag-resource.md "../../../cli/latest/reference/eks/untag-resource.md")                         | [Remove-EKSResourceTag](../../../powershell/latest/reference/items/Remove-EKSResourceTag.md "../../../powershell/latest/reference/items/Remove-EKSResourceTag.md") | [UntagResource](../APIReference/API_UntagResource.md "../APIReference/API_UntagResource.md")                           | The following examples show how to tag or untag resources using the AWS CLI. ###### Example 1: Tag an existing cluster The following command tags an existing cluster. `aws eks tag-resource --resource-arn resource_ARN --tags team=devs` ###### Example 2: Untag an existing cluster The following command deletes a tag from an existing cluster. `aws eks untag-resource --resource-arn resource_ARN --tag-keys tag_key` ###### Example 3: List tags for a resource The following command lists the tags that are associated with an existing resource. `aws eks list-tags-for-resource --resource-arn resource_ARN` When you use some resource-creating actions, you can specify tags at the same time that you create the resource. The following actions support specifying a tag when you create a resource. |
| Task                               | AWS CLI                                                                                                                                             | AWS Tools for Windows PowerShell                                                                                                                                   | API action                                                                                                             | eksctl                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ---                                | ---                                                                                                                                                 | ---                                                                                                                                                                | ---                                                                                                                    | ---                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Create a cluster                   | [create-cluster](../../../cli/latest/reference/eks/create-cluster.md "../../../cli/latest/reference/eks/create-cluster.md")                         | [New-EKSCluster](../../../powershell/latest/reference/items/New-EKSCluster.md "../../../powershell/latest/reference/items/New-EKSCluster.md")                      | [CreateCluster](../APIReference/API_CreateCluster.md "../APIReference/API_CreateCluster.md")                           | `create cluster`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Create a managed node group\*      | [create-nodegroup](../../../cli/latest/reference/eks/create-nodegroup.md "../../../cli/latest/reference/eks/create-nodegroup.md")                   | [New-EKSNodegroup](../../../powershell/latest/reference/items/New-EKSNodegroup.md "../../../powershell/latest/reference/items/New-EKSNodegroup.md")                | [CreateNodegroup](../APIReference/API_CreateNodegroup.md "../APIReference/API_CreateNodegroup.md")                     | `create nodegroup`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Create a Fargate profile           | [create-fargate-profile](../../../cli/latest/reference/eks/create-fargate-profile.md "../../../cli/latest/reference/eks/create-fargate-profile.md") | [New-EKSFargateProfile](../../../powershell/latest/reference/items/New-EKSFargateProfile.md "../../../powershell/latest/reference/items/New-EKSFargateProfile.md") | [CreateFargateProfile.html](../APIReference/API_CreateFargateProfile.md "../APIReference/API_CreateFargateProfile.md") | `create fargateprofile`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | <br>• If you want to also tag the Amazon EC2 instances when you create a managed node group, create the managed node group using a launch template. For more information, see [Tagging Amazon EC2 instances](launch-templates.md#launch-template-tagging "launch-templates.md#launch-template-tagging"). If your instances already exist, you can manually tag the instances. For more information, see [Tagging your resources](../../../AWSEC2/latest/UserGuide/Using_Tags.md#tag-resources "../../../AWSEC2/latest/UserGuide/Using_Tags.md#tag-resources") in the Amazon EC2 User Guide. |
