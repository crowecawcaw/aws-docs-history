...
- If you use `eksctl`, install version `0.215.0` or later on your computer. To install or update to it, see [Installation](https://eksctl.io/installation "https://eksctl.io/installation") in the `eksctl` documentation.
