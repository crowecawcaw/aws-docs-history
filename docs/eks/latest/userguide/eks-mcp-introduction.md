...
+  **Centralized access management.** The EKS MCP server integrates with [IAM](https://aws.amazon.com/iam/), providing a centralized, secure way to control access to the server. All requests are signed using [AWS SigV4](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_sigv.html) through a lightweight proxy, enabling seamless integration with your existing AWS credentials and IAM policies.
