...
6. When creating Amazon EKS node groups, select this launch template. For more information, see [Create a managed node group for your cluster](create-managed-node-group.md "create-managed-node-group.md").

## Related information

- [Deploy the FSx for Lustre driver](fsx-csi-create.md "fsx-csi-create.md")
- [Optimize Amazon FSx for Lustre performance on nodes (EFA)](fsx-csi-tuning-efa.md "fsx-csi-tuning-efa.md")
