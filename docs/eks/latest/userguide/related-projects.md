...
For more information, see the [graduated and incubating projects](https://www.cncf.io/projects/ "https://www.cncf.io/projects/") associated with the Cloud Native Computing Foundation (CNCF).
...
For example, AWS is responsible for the [Kubernetes API Server](https://kubernetes.io/docs/concepts/architecture/#kube-apiserver "https://kubernetes.io/docs/concepts/architecture/#kube-apiserver").
The Kubernetes API server is covered by [Amazon EKS Service Level Agreement](https://aws.amazon.com/eks/sla/ "https://aws.amazon.com/eks/sla/").
You can use your [Amazon Web Services Support Plan](https://aws.amazon.com/premiumsupport/plans/ "https://aws.amazon.com/premiumsupport/plans/") to resolve issues with the Kubernetes API server, or get general guidance.
...
For more information, see [add-on Support.](eks-add-ons.md#addon-support "eks-add-ons.md#addon-support")
...
For more information on the types of Amazon EKS Add-ons available and the associated levels of support, see [Scope of Support for Amazon EKS add-ons.](eks-add-ons.md#addon-support "eks-add-ons.md#addon-support")
To view add-ons fully supported by AWS, see [Amazon Web Services add-ons.](workloads-add-ons-available-eks.md "workloads-add-ons-available-eks.md")
...
Available in [EKS Capabilities](kro.md "kro.md").

- [Project URL](https://kro.run/ "https://kro.run/")
- [Project documentation](https://kro.run/docs/ "https://kro.run/docs/")
...
Available in [EKS Capabilities](argocd.md "argocd.md").

- [Project URL](https://argo-cd.readthedocs.io/ "https://argo-cd.readthedocs.io/")
- [Project documentation](https://argo-cd.readthedocs.io/en/stable/ "https://argo-cd.readthedocs.io/en/stable/")
...
For more information about operators, see [OperatorHub.io](https://operatorhub.io/ "https://operatorhub.io/") on GitHub.
...
- Amazon EKS workshop: [https://eksworkshop.com/intermediate/240\_monitoring/](https://eksworkshop.com/intermediate/240_monitoring/ "https://eksworkshop.com/intermediate/240_monitoring/")
