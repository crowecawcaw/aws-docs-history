...
| Applications |  [AWS Distro for OpenTelemetry (ADOT)](https://aws-otel.github.io/docs/introduction)  | ADOT can collect and send correlated metrics, trace data, and metadata to AWS monitoring services or partners. It can be set up through CloudWatch Container Insights. |  [Setup procedure](opentelemetry.md)  | 
