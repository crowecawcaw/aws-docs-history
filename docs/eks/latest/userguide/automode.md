...
You can delegate key infrastructure decisions and use the expertise of AWS for day-to-day operations.
...
For version rollbacks, EKS Auto Mode automatically rolls back worker nodes before the control plane is reverted, honoring your configured disruption controls. For more information, see [Rollback EKS Auto Mode clusters](rollback-automode.md "rollback-automode.md").
