...
![Prometheus metrics](https://docs.aws.amazon.com/eks/latest/userguide/images/prometheus-metric.png)

1. From the top navigation bar, choose **Status**, then **Targets**.  
![Prometheus console](https://docs.aws.amazon.com/eks/latest/userguide/images/prometheus.png)
