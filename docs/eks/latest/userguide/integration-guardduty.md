...
<a name="integration-guardduty"></a>
...
To configure *Runtime Monitoring*, you install the GuardDuty agent to your cluster as an *Amazon EKS add-on*. For more information about the add-on, see [AWS add-ons](workloads-add-ons-available-eks.md).  
