...
When you enable EKS Protection, GuardDuty will be able to access your Amazon EKS audit logs only for continuous threat detection. If GuardDuty identifies a potential threat to your cluster, it generates an associated Kubernetes audit log _finding_ of a specific type. For more information about the types of findings available from Kubernetes audit logs, see [Kubernetes audit logs finding types](../../../guardduty/latest/ug/guardduty_finding-types-kubernetes.md "../../../guardduty/latest/ug/guardduty_finding-types-kubernetes.md") in the Amazon GuardDuty User Guide.

For more information, see [EKS Protection](../../../guardduty/latest/ug/kubernetes-protection.md "../../../guardduty/latest/ug/kubernetes-protection.md") in the Amazon GuardDuty User Guide.
