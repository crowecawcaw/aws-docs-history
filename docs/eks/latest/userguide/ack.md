...
All AWS services listed as Generally Available upstream are supported by the EKS Capability for ACK. For the complete list of AWS services supported, see the [ACK services page](https://aws-controllers-k8s.github.io/docs/services) on the ACK website.
