...
+  [Globally scalable applications based on IPv6](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-ipv6-globally-scalable) 
+  [Asynchronous batch tasks](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-batch-processing) 
+  [High traffic microservices](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-high-traffic) 
+  [Autoscaling with Karpenter on Fargate](https://community.aws/tutorials/navigating-amazon-eks/eks-karpenter-fargate) 
+  [Financial workloads](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-financial-workload) 
+  [Windows Managed Node Groups](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-windows-fargate) 
...
+  [Provide storage solutions with EFS CSI](https://community.aws/tutorials/navigating-amazon-eks/eks-with-efs-add-on/) 
+  [Provide dynamic database storage with EBS CSI](https://community.aws/tutorials/navigating-amazon-eks/eks-dynamic-db-storage-ebs-csi) 
+  [Expose applications on IPv4 clusters using the AWS Load Balancer Controller](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-load-balancer-ipv4) 
+  [Expose applications on IPv6 clusters using the AWS Load Balancer Controller](https://community.aws/tutorials/navigating-amazon-eks/eks-cluster-load-balancer-ipv6) 
...
+  [Manage DNS records for microservices with ExternalDNS](https://community.aws/tutorials/navigating-amazon-eks/automating-dns-records-for-microservices-using-externaldns/) 
+  [Monitor applications with CloudWatch](https://community.aws/tutorials/navigating-amazon-eks/eks-monitor-containerized-applications) 
+  [Manage asynchronous tasks with SQS and EFS storage](https://community.aws/tutorials/navigating-amazon-eks/managing-high-volume-batch-sqs-eks) 
+  [Consume AWS Secrets Manager Secrets from workloads](https://community.aws/tutorials/navigating-amazon-eks/eks-integrate-secrets-manager) 
+  [Set up mTLS with Fargate, NGINX, and ACM PCA](https://community.aws/tutorials/navigating-amazon-eks/eks-fargate-mtls-nginx-controller) 

## Amazon EKS Samples
<a name="eks-samples"></a>

The [Amazon EKS Samples](https://github.com/aws-samples/aws-eks-se-samples) repository stores manifests to use with Amazon EKS. These manifests give you the opportunity to try out different kinds of applications in Amazon EKS or create specific types of Amazon EKS clusters. Samples include manifests to:
+  [Create an AWS Amazon EKS Fargate cluster](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/eksctl/how-to-eks-fargate) 
+  [Create a cluster with an existing IAM role](https://github.com/aws-samples/aws-eks-se-samples/blob/main/examples/eksctl/how-to-existing-iamrole/existing-role.yaml) 
+  [Add an Ubuntu Managed Node Group to a cluster](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/eksctl/how-to-ubuntu-nodegroups) 
+  [Backup and restore Pod storage with volume snapshots](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-backup-restore-ebs-pvc) 
+  [Recover EBS volumes mounted as PVCs with multiple accounts](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-dr-multi-account) 
+  [Enable proxy protocol for NGINX Ingress Controller with Classic Load Balancers](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-enable-proxy-procotcol-clb) 
+  [Configure Logging on Fargate to AWS OpenSearch](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-logging-eks-fargate-opensearch) 
+  [Run Python SDK with a web federated identity provider](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-python-sdk-containers) 
+  [Deploy a sample app on an NFS CSI controller](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-setup-nfs-csi-eks) 
+  [Use volume snapshots for StatefulSets](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-snapshot-restore-resize-sts) 
+  [Deploy pods across nodes on different availability zones](https://github.com/aws-samples/aws-eks-se-samples/tree/main/examples/kubernetes/how-to-topology-awareness-hints) 
...
+  [Deploy a Container Web App on Amazon EKS](https://aws.amazon.com/tutorials/deploy-webapp-eks/) 
+  [Run Kubernetes clusters for less (Amazon EKS and Spot instances)](https://aws.amazon.com/tutorials/amazon-eks-with-spot-instances/) 
+  [How to cost optimize Jenkins jobs on Kubernetes](https://aws.amazon.com/tutorials/cost-optimize-jenkins/) 

## Developers Workshop
<a name="developers-workshop"></a>

If you are a software developer, looking to create or refactor applications to run on Amazon EKS, the [Amazon EKS Developers workshop](https://developers.eksworkshop.com) is a good place to start. The workshop not only helps you build containerized applications, but also helps you deploy those containers to a container registry ([ECR](https://aws.amazon.com/ecr/)) and from there to an Amazon EKS cluster.
