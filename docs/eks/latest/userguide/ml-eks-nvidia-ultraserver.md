...
- P6e-GB200 UltraServers are made available through [EC2 Capacity Blocks for ML](https://aws.amazon.com/ec2/capacityblocks/ "https://aws.amazon.com/ec2/capacityblocks/"). See [Manage compute resources for AI/ML workloads on Amazon EKS](ml-compute-management.md "ml-compute-management.md") for information on how to launch EKS nodes with Capacity Blocks.
