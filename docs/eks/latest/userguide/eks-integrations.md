...
**Topics**
+ [Back up your EKS Clusters with AWS Backup](integration-backup.md)
+ [Create Amazon EKS resources with AWS CloudFormation](creating-resources-with-cloudformation.md)
+ [Connect to Git repositories with AWS CodeConnections](integration-codeconnections.md)
...
+ [Manage application secrets with AWS Secrets Manager](integration-secrets-manager.md)
