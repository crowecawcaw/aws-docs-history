...
- Your Pods can communicate with internet resources if the node that they’re running on either has a [public](../../../AWSEC2/latest/UserGuide/using-instance-addressing.md#concepts-public-addresses "../../../AWSEC2/latest/UserGuide/using-instance-addressing.md#concepts-public-addresses") or [elastic](../../../vpc/latest/userguide/vpc-eips.md "../../../vpc/latest/userguide/vpc-eips.md") IP address and is in a [public subnet](../../../vpc/latest/userguide/configure-subnets.md#subnet-basics "../../../vpc/latest/userguide/configure-subnets.md#subnet-basics") whose [route table](../../../vpc/latest/userguide/VPC_Route_Tables.md "../../../vpc/latest/userguide/VPC_Route_Tables.md") has a route to an [internet gateway](../../../vpc/latest/userguide/VPC_Internet_Gateway.md "../../../vpc/latest/userguide/VPC_Internet_Gateway.md"), or is in a [private subnet](../../../vpc/latest/userguide/configure-subnets.md#subnet-basics "../../../vpc/latest/userguide/configure-subnets.md#subnet-basics") whose route table has a route to a [NAT gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md "../../../vpc/latest/userguide/vpc-nat-gateway.md"). We recommend deploying nodes to private subnets, whenever possible.
...
- You want the Pod’s source IP address to be preserved when traffic leaves the node, with SNAT performed by a [NAT gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md "../../../vpc/latest/userguide/vpc-nat-gateway.md") instead of the node — for example, so network appliances or logs observe the Pod’s IP address. Your nodes must be in a [private subnet](../../../vpc/latest/userguide/configure-subnets.md#subnet-basics "../../../vpc/latest/userguide/configure-subnets.md#subnet-basics") with a route to a NAT gateway, because Pod-sourced traffic can’t route through an internet gateway.
