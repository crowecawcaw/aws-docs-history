...
For additional information on capability IAM roles and Kubernetes permissions, see [Security considerations for EKS Capabilities](capabilities-security.md "capabilities-security.md").
...
EKS Capabilities are integrated with AWS features for streamlined configurations, provide built-in high availability and fault tolerance, and eliminate in-cluster troubleshooting of controller workloads.
...
Cluster resources managed by the capability also have an associated hourly cost with their own pricing. For more information, see [Amazon EKS pricing](https://aws.amazon.com/eks/pricing/ "https://aws.amazon.com/eks/pricing/").
...
- [Comparing EKS Capability for ACK to self-managed ACK](ack-comparison.md "ack-comparison.md")
- [Comparing EKS Capability for Argo CD to self-managed Argo CD](argocd-comparison.md "argocd-comparison.md")
- [Comparing EKS Capability for kro to self-managed kro](kro-comparison.md "kro-comparison.md")
