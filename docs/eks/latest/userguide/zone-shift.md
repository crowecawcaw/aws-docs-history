...
Kubernetes has native features that enable you to make your applications more resilient to events such as the degraded health or impairment of an Availability Zone (AZ). When you run your workloads in an Amazon EKS cluster, you can further improve your application environment’s fault tolerance and application recovery by using [Amazon Application Recovery Controller (ARC) zonal shift](../../../r53recovery/latest/dg/arc-zonal-shift.md "../../../r53recovery/latest/dg/arc-zonal-shift.md") or [zonal autoshift](../../../r53recovery/latest/dg/arc-zonal-autoshift.md "../../../r53recovery/latest/dg/arc-zonal-autoshift.md"). ARC zonal shift is designed to be a temporary measure that enables you to move traffic for a resource away from an impaired AZ until the zonal shift expires or you cancel it. You can extend the zonal shift, if necessary.

You can start a zonal shift for an EKS cluster, or you can allow AWS to shift traffic for you by enabling zonal autoshift. This shift updates the flow of east-to-west network traffic in your cluster to only consider network endpoints for Pods running on worker nodes in healthy AZs. Additionally, any ALB or NLB handling ingress traffic for applications in your EKS cluster will automatically route traffic to targets in the healthy AZs. For those customers seeking the highest availability goals, in the case that an AZ becomes impaired, it can be important to be able to steer all traffic away from the impaired AZ until it recovers. For this, you can also [_enable an ALB or NLB with ARC zonal shift_](../../../r53recovery/latest/dg/arc-zonal-shift.resource-types.md "../../../r53recovery/latest/dg/arc-zonal-shift.resource-types.md").
...
![Illustration of network traffic](images/zs-traffic-flow-before-1.png)

![Illustration of network traffic](images/zs-traffic-flow-before-2.png)
...
![Illustration of network traffic](images/zs-traffic-flow-after-1.png)

![Illustration of network traffic](images/zs-traffic-flow-after-2.png)
...
![Illustration of network](images/zs-ha-after-failure.png)
...
![Illustration of network](images/zs-spread-constraints-2.png)
...
You can also use [NodeLocal DNS](https://kubernetes.io/docs/tasks/administer-cluster/nodelocaldns/ "https://kubernetes.io/docs/tasks/administer-cluster/nodelocaldns/") or the [cluster proportional autoscaler](https://github.com/kubernetes-sigs/cluster-proportional-autoscaler "https://github.com/kubernetes-sigs/cluster-proportional-autoscaler") to scale CoreDNS. For more information, see [Scaling CoreDNS horizontally](https://aws.github.io/aws-eks-best-practices/scalability/docs/cluster-services/#scale-coredns-horizontally "https://aws.github.io/aws-eks-best-practices/scalability/docs/cluster-services/#scale-coredns-horizontally").
...
![Illustration of network](images/zs-pod-affinity-rule.png)
...
Self-managed Karpenter support is available with ARC zonal shift and zonal autoshift in EKS with [Karpenter version 1.12 or greater](https://github.com/aws/karpenter-provider-aws "https://github.com/aws/karpenter-provider-aws").
...
- [How a zonal shift works](../../../r53recovery/latest/dg/arc-zonal-shift.how-it-works.md "../../../r53recovery/latest/dg/arc-zonal-shift.how-it-works.md")
- [Best practices for zonal shifts in ARC](../../../r53recovery/latest/dg/route53-arc-best-practices.zonal-shifts.md#zonalshift.route53-arc-best-practices.zonal-shifts "../../../r53recovery/latest/dg/route53-arc-best-practices.zonal-shifts.md#zonalshift.route53-arc-best-practices.zonal-shifts")
- [Resources and scenarios supported for zonal shift and zonal autoshift](../../../r53recovery/latest/dg/arc-zonal-shift.resource-types.md "../../../r53recovery/latest/dg/arc-zonal-shift.resource-types.md")
- [Operating resilient workloads on Amazon EKS](https://aws.amazon.com/blogs/containers/operating-resilient-workloads-on-amazon-eks "https://aws.amazon.com/blogs/containers/operating-resilient-workloads-on-amazon-eks")
...
- [Scale CoreDNS Pods for high DNS traffic](coredns-autoscaling.md "coredns-autoscaling.md")
