...
7.  On the **Quick create stack** page, enter the following parameters accordingly:
    ...
    - **NodeSecurityGroups**: Select the security group that was created for your Linux node group when you created your [VPC](creating-a-vpc.md "creating-a-vpc.md"). If your Linux nodes have more than one security group attached to them, specify all of them. This for, for example, if the Linux node group was created with `eksctl`.
