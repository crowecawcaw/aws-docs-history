...
Update the Amazon EKS type of the add-on. If you haven’t added the Amazon EKS add-on to your cluster, either [add it](coredns-add-on-create.md "coredns-add-on-create.md") or see [Update the CoreDNS Amazon EKS self-managed add-on](coredns-add-on-self-managed-update.md "coredns-add-on-self-managed-update.md").
