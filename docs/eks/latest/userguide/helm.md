...
3. Make sure the version installed is compatible with your cluster version. Check [Supported Version Skew](https://helm.sh/docs/topics/version_skew/#supported-version-skew "https://helm.sh/docs/topics/version_skew/#supported-version-skew") to learn more. For example, if you are running with `3.17.x`, supported Kubernetes version should be within the range of `1.29.x` to `1.32.x`.
