...
- [AmazonEKSConnectorServiceRolePolicy](../../../aws-managed-policy/latest/reference/AmazonEKSConnectorServiceRolePolicy.md "../../../aws-managed-policy/latest/reference/AmazonEKSConnectorServiceRolePolicy.md")
...
Use the IAM console, the AWS CLI, or the AWS API to delete the AWSServiceRoleForAmazonEKSConnector service-linked role. For more information, see [Deleting a service-linked role](../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role "../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role") in the _IAM User Guide_.
