...
**Note**  
This topic covers data plane egress (nodes and workloads without outbound internet access). To control how egress traffic from the cluster *control plane* reaches your VPC, see [Configuring control plane egress routing](control-plane-egress.md).
