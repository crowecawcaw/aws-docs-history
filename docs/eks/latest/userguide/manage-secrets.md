...
To show secrets from Secrets Manager and parameters from Parameter Store as files mounted in Amazon EKS Pods, you can use the AWS Secrets and Configuration Provider (ASCP) for the [Kubernetes Secrets Store CSI Driver](https://secrets-store-csi-driver.sigs.k8s.io/ "https://secrets-store-csi-driver.sigs.k8s.io/").
...
For more information, see [Using Secrets Manager secrets in Amazon EKS](../../../secretsmanager/latest/userguide/integrating_csi_driver.md "../../../secretsmanager/latest/userguide/integrating_csi_driver.md") in the AWS Secrets Manager User Guide.
