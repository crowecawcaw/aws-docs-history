...
<a name="next-gen-running-service-assessment"></a>
...
**Prerequisites**
+ The service's invoker role must be configured and accessible. For more information, see [Required IAM permissions and roles](next-gen-iam-permissions.md).
+ The service must have a valid discovered topology with a data flow relationship between at least two resources. For more information, see [Minimum topology requirements](next-gen-minimum-topology-requirements.md).
