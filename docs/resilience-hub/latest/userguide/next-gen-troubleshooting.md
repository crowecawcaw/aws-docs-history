...
This section provides solutions for common issues you might encounter when using
the next generation of Resilience Hub.

###### Topics

- [Dependency discovery issues](next-gen-troubleshoot-discovery.md "next-gen-troubleshoot-discovery.md")
- [Failure mode assessment issues](next-gen-troubleshoot-assessments.md "next-gen-troubleshoot-assessments.md")
