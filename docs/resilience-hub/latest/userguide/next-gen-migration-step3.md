...
The failure mode findings include detailed reasoning specific to your architecture,
recommendations with cost and complexity guidance, and policy mapping showing which
