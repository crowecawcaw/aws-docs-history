...
as AWS::ResilienceHub:::ResiliencyPolicy and AWS::ResilienceHub:::App), and CloudFormation provisions and configures those resources for you.

When you use CloudFormation, you can reuse your template to set up your AWS Resilience Hub resources
...
You can use CloudFormation stacks to define AWS Resilience Hub applications. A stack lets you manage related
