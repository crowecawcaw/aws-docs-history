...
The following table maps concepts from AWS Resilience Hub v1 to their equivalents in
the next generation of Resilience Hub.

| AWS Resilience Hub v1 concept | Next generation Resilience Hub concept | Notes                                                                                                               |
| ----------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| Application                   | Service                                | Your v1 "application" becomes a the next generation of Resilience Hub "service" – the primary unit<br>of assessment |
