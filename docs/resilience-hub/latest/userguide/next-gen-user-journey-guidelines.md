...
- A user journey should represent something an end user does (for example, "Check balance,"
  not "Database reads").
- Start with your most critical user journeys and add more over time.
- A service can belong to multiple user journeys – shared platform services often
  do.
