...
# Prerequisites
<a name="next-gen-prerequisites"></a>
...
+ (Optional) An IAM execution role for resilience testing. For details, see [IAM execution roles for resilience testing](next-gen-resilience-testing-iam.md).