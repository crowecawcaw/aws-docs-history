...
Dependency discovery analyzes Route 53 DNS resolver query logs to identify every domain
name that your service's compute resources resolve. This reveals the full set of external
dependencies without requiring any agents, code changes, or instrumentation.
