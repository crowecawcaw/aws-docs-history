...
Dependency discovery covers all DNS queries made through Route 53 resolvers in your VPC,
including both IPv4 and IPv6 queries, and queries from Amazon EC2, Amazon ECS, Amazon EKS, and VPC-connected
Lambda. The following known limitations apply:
