...
| `assertion`<br />Assertion text (AI-generated and user-created). | Enabled | Enabled | 
...
+ `Encrypt` – Encrypt sensitive fields such as findings, recommendations, and assertions generated during assessment workflows.
...
+ **AllowResilienceHubEncryptDecryptForServices** – Allows Next generation Resilience Hub to encrypt and decrypt service-level data (findings, recommendations, assertions, service functions, events, and assessment data) during synchronous API calls. Scoped to your service resources by encryption context.
...
| --- | --- | --- | 
| aws:resiliencehub:service-arn | Service | Findings, recommendations, assertions, service functions, dependencies, events, and assessment data | 
