...
4. Provide the following details:
   ...
   - **Regions** – Select the AWS Regions where your
     service operates. You can select up to 5 Regions.
   - **Resource discovery** – Provide input sources to
     enable discovery of resources used by your service. See [Add input sources to a service](next-gen-add-input-source.md "next-gen-add-input-source.md") for instructions on adding input sources.
   - **Dependency discovery** – (Optional) Enable the
     dependency discovery feature for this service. See [Dependency discovery](next-gen-dependency-discovery.md "next-gen-dependency-discovery.md") for more information on dependency
     discovery.
   - **Data encryption** – (Optional) Choose a customer
     managed AWS KMS key to encrypt service data. For more information, see [Data encryption](next-gen-data-encryption.md "next-gen-data-encryption.md").
   - **Tags** – (Optional) Add tags to your
     service.
