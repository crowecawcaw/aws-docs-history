...
encounter when working with AWS Resilience Hub and IAM.

###### Topics

- [I am not authorized to
  perform an action in AWS Resilience Hub](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS Resilience Hub resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS Resilience Hub
...
have the fictional `resiliencehub:`GetWidget`` permissions.
...
`resiliencehub:`GetWidget`` action.
...
AWS Resilience Hub. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AWS Resilience Hub resources
...
- To learn whether AWS Resilience Hub supports these features, see [How AWS Resilience Hub works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
