...
- **AWS service endpoints** – Amazon S3, Amazon DynamoDB, SQS,
  and other AWS services your application calls.
- **Internal endpoints** – Services within your VPC or
  organization.
- **Third-party endpoints** – External services such as
  LaunchDarkly, Stripe, or Datadog.
- **Cross-region calls** – Dependencies that resolve to
  endpoints in other AWS Regions.
