...
Resilience tests run on AWS Fault Injection Service, so AWS FIS service quotas also apply to your test runs.
These include quotas for the maximum number of active experiments and the maximum action
duration. For more information, see [Quotas and limitations for AWS Fault Injection Service](../../../fis/latest/userguide/fis-quotas.md "../../../fis/latest/userguide/fis-quotas.md").
