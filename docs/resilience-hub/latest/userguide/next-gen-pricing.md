...
Resilience tests are powered by AWS Fault Injection Service (AWS FIS). You are charged $0.10 per action-minute plus $0.10 per action-minute for each additional target account. For detailed pricing information, see [AWS FIS pricing](https://aws.amazon.com/fis/pricing/). Resilience test reports generated by the next generation of Resilience Hub are included at no additional cost.

For detailed pricing information, see [Next generation Resilience Hub pricing](https://aws.amazon.com/resilience-hub/pricing/).