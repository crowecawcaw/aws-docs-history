...
grouping, see [Blocked services for manual grouping](blocked-services-for-manual-grouping.md "blocked-services-for-manual-grouping.md").
...
- [AWS Resilience Hub resource grouping recommendations](grouping-recommendation.md "grouping-recommendation.md")
- [Manually grouping resources into an AppComponent](AppComponent-manual-grouping.md "AppComponent-manual-grouping.md")
