...
other settings, which determine how a test or cutover instance is launched for each source
server on AWS.
...
[Learn more about individual launch settings.](launch-settings.md "launch-settings.md")
