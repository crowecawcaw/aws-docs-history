...
1. Initialize AWS Transform MGN in the target region. Refer to the [list](supported-regions.md "supported-regions.md") of
...
your source servers by installing the MGN vCenter Client. [Learn more about agentless replication.](agentless-mgn.md "agentless-mgn.md") 3. Wait until the initial sync is finished. After installing the agent, you need to wait for
