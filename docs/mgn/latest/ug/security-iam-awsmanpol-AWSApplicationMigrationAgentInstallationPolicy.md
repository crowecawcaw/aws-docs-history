...
To view the policy permission details see [AWSApplicationMigrationAgentInstallationPolicy](../../../aws-managed-policy/latest/reference/AWSApplicationMigrationAgentInstallationPolicy.md "../../../aws-managed-policy/latest/reference/AWSApplicationMigrationAgentInstallationPolicy.md") in the AWS Managed Policy Reference Guide.
