...
servers. You can also perform operation on the application, such as edit, tagging, archive,
as well as bulk operations on the servers associated with the application.

###### Topics

- [Manage applications](applications-list.md "applications-list.md")
- [Access details for an application](application-details.md "application-details.md")
