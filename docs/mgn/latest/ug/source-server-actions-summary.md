...
The following table summarizes the actions available on source servers at each phase of the
migration lifecycle.

Source server actions by migration phase| **Action** | **Migration phase** | **Description** |
| --- | --- | --- |
...
| Finalize test | During migration | Mark the test as complete and advance the server to the ready-for-cutover<br>state. |
