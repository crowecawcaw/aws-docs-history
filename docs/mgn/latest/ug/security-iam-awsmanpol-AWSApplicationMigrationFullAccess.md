...
This policy provides permissions to all public APIs of AWS Transform MGN, as well as permissions to read KMS key, License Manager, Resource Groups, Elastic Load Balancing, IAM, EC2, and Amazon FSx information.
...
launch test and cutover instances and to complete a full migration cycle with MGN.
