...
- [What type of replication server is utilized in the AWS Application Migration Service staging area?](#What-Replication-Server-Type-Staging "#What-Replication-Server-Type-Staging")
...
- [Does AWS Application Migration Service compress data during replication?](#Does-Data-Compress "#Does-Data-Compress")
...
- [How many snapshots does AWS Application Migration Service create?](#How-Many-Snapshots "#How-Many-Snapshots")
- [Does AWS Application Migration Service delete snapshots?](#Does-Delete-Snapshots "#Does-Delete-Snapshots")
...
- [Can AWS Application Migration Service replicate Oracle ASM?](#Can-Replicate-Oracle-ASM "#Can-Replicate-Oracle-ASM")
