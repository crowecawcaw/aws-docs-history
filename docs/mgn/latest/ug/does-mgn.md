...
AWS Application Migration Service does not support OS-based disk encryption features such as BitLocker. These should
be deactivated before using AWS MGN.
