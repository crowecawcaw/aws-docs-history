...
| Asia Pacific (New Zealand) | ap-southeast-6  | **IPv4 -\*<br>• https://aws-application-migration-service-ap-southeast-6.s3.ap-southeast-6.amazonaws.com/latest/linux/aws-replication-installer-init<br>**Dual-stack -\*<br>• https://aws-application-migration-service-ap-southeast-6.s3.dualstack.ap-southeast-6.amazonaws.com/latest/linux/aws-replication-installer-init |
| Canada West (Calgary)      | ca-west-1       | **IPv4 -\*<br>• https://aws-application-migration-service-ca-west-1.s3.ca-west-1.amazonaws.com/latest/linux/aws-replication-installer-init<br>**Dual-stack -\*<br>• https://aws-application-migration-service-ca-west-1.s3.dualstack.ca-west-1.amazonaws.com/latest/linux/aws-replication-installer-init                     |
| Asia Pacific (Taipei)      | ap-east-2       | **IPv4 -\*<br>• https://aws-application-migration-service-ap-east-2.s3.ap-east-2.amazonaws.com/latest/linux/aws-replication-installer-init<br>**Dual-stack -\*<br>• https://aws-application-migration-service-ap-east-2.s3.dualstack.ap-east-2.amazonaws.com/latest/linux/aws-replication-installer-init                     |
| Mexico (Central)           | mx-central-1    | **IPv4 -\*<br>• https://aws-application-migration-service-mx-central-1.s3.mx-central-1.amazonaws.com/latest/linux/aws-replication-installer-init<br>**Dual-stack -\*<br>• https://aws-application-migration-service-mx-central-1.s3.dualstack.mx-central-1.amazonaws.com/latest/linux/aws-replication-installer-init         |
