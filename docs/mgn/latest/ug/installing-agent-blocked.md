...
The AWS Transform MGN AWS Replication Agent installer needs network access to MGN and Amazon S3
endpoints. If your on premises network is not open to MGN and Amazon S3 endpoints, then you can
...
MGN via Site-to-Site VPN/Direct Connect by using the --endpoint installation parameter.
...
connect to MGN via the endpoint over your Site-to-Site VPN/Direct Connect connection.
...
Amazon S3 endpoint for MGN in your staging area subnet. For more information, see [Endpoints for
...
A detailed guide for rehosting servers using MGN over private networks is available
here:

[Migrating on-premises servers to AWS over private networks by using MGN.](../../../prescriptive-guidance/latest/rehost-servers-over-private-networks-mgn/welcome.md "../../../prescriptive-guidance/latest/rehost-servers-over-private-networks-mgn/welcome.md")
