...
You must add your source servers to the AWS Transform MGN console in order to migrate them into
...
servers. Ensure that your servers are supported by AWS Transform MGN by reviewing the [Supported operating systems](Supported-Operating-Systems.md "Supported-Operating-Systems.md")

In addition, AWS Transform MGN allows you to perform [agentless snapshot
replication](agentless-mgn.md "agentless-mgn.md") from your vCenter source environment into AWS. This is achieved by
installing the MGN vCenter Client in your vCenter environment. Agentless snapshot replication
has its own unique credentials, installation, and replication mechanisms. AWS Transform MGN recommends
...
Once your source servers have been added to AWS Transform MGN, you can monitor and interact with them
from the Source servers page. The Source servers page is the default view in the AWS Transform MGN
...
- [Installing the AWS Transform MGN vCenter Client for Agentless Replication on vCenter source environments](agentless-mgn.md "agentless-mgn.md")
