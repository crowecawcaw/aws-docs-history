...
This policy allows AWS Transform MGN to send metadata about the
progress of servers being migrated using MGN to AWS Migration Hub (MGH). MGN automatically
...
To stop MGN from sending this metadata to AWS MGH, detach it from your users or
roles.
