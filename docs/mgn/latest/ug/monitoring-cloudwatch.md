...
AWS Transform MGN includes the following metrics across all Source servers.
...
AWS Transform MGN includes the following metrics by individual source server.
