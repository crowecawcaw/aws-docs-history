...
2. In the server details view, under the **Migration
   dashboard**, agentless servers that are replicated through snapshot shipping
   have an additional **Lifecycle** step – **Not
   started.**
3. Similarly, in the server details view, under the **Migration
   dashboard**, the **Data replication status** box shows the **Replication type** as **Snapshot
   shipping**.
