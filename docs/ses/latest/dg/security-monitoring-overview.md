...
- _Amazon CloudWatch_ monitors your AWS resources and the applications you run
  ...
  you specify. For more information, see [Retrieving Amazon SES event data from CloudWatch](event-publishing-retrieving-cloudwatch.md "event-publishing-retrieving-cloudwatch.md") and [Creating reputation monitoring alarms using CloudWatch](reputationdashboard-cloudwatch-alarm.md "reputationdashboard-cloudwatch-alarm.md").
