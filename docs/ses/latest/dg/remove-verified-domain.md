...
2. In the console, use the Region selector to choose the AWS Region from which you
   want to delete one or more identities.
...
delete. You can delete multiple identities by checking the box next to each identity
that you want to delete. 5. Choose **Delete**.
