...
- By enabling email feedback forwarding. For more information, see [Receiving Amazon SES
...
notifications for Amazon SES](monitor-sending-activity-using-notifications.md "monitor-sending-activity-using-notifications.md") for important
