...
| [IP addresses & reputation isolated from other SES customers](#dedicated-ip-managed-reputation) | No | Yes | Yes | 
| [Capacity increases automatically as traffic increases](#dedicated-ip-sending-patterns) | No | No | Yes | 
...
## Ease of setup
<a name="dedicated-ip-simplicity"></a>
...
<a name="dedicated-ip-managed-reputation"></a>
...
**Note**  
For information about Smart Network Data Services (SNDS) data for your dedicated IPs (standard), see [SNDS metrics for dedicated IPs](snds-metrics-dedicated-ips.md).
...
<a name="dedicated-ip-sending-patterns"></a>
...
<a name="dedicated-ip-sending-volumes"></a>
...
<a name="dedicated-ip-reputation-control"></a>
...
<a name="dedicated-ip-isolate-reputation"></a>
...
<a name="dedicated-ip-known-addresses"></a>
