...
| `Permanent`    | `OnTenantSuppressionList`   | SES has suppressed sending to this address because<br>it is on the [tenant-level suppression list](sending-email-suppression-list-tenant-level.md "sending-email-suppression-list-tenant-level.md"). This does not count<br>toward your bounce rate metric.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| `Permanent`    | `EmailValidationSuppressed` | SES has suppressed sending to this address because<br>the address did not meet the threshold for your [email validation<br>settings](email-validation-auto.md "email-validation-auto.md").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
