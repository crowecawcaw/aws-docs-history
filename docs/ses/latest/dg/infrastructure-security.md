...
As a managed service, Amazon Simple Email Service is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Simple Email Service through the network. Clients must
