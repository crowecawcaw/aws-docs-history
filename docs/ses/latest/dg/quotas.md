...
| --- | --- | --- | 
| Number of emails that can be sent per 24-hour period | If your account is in the sandbox, you can send up to 200 emails per 24-hour period.<br />If your account is out of the sandbox, this number varies based on your specific use case. | [Yes](manage-sending-quotas-request-increase.md) | 
| Number of emails that can be sent per second (sending rate) | If your account is in the sandbox, you can send 1 email per second.<br />If your account is out of the sandbox, this rate varies based on your specific use case. | [Yes](manage-sending-quotas-request-increase.md) | 
