...
| [_Archive action_](../../../sesmailmanager/latest/APIReference/API_ArchiveAction.md "../../../sesmailmanager/latest/APIReference/API_ArchiveAction.md")                                | Archives the email by delivering it to an Amazon SES<br>archive.                                                                                                                                                                                                                                                                                                                                                 |
...
| [_Drop action_](../../../sesmailmanager/latest/APIReference/API_DropAction.md "../../../sesmailmanager/latest/APIReference/API_DropAction.md")                                         | For email with multiple recipients, if this action applies to one<br>or more (but not all) of those recipients, they will be dropped from<br>the email’s recipient list, and continued processing of rules will<br>apply to remaining recipients. If this action applies to all<br>recipient(s), rules processing stops as all recipients are dropped<br>from the recipient list and will not receive the email. |
