...
Depending on which email sending interface you use, you either provide the message tag as a parameter to the [`EmailTags`](https://docs.aws.amazon.com/ses/latest/APIReference-V2/API_SendEmail.html#SES-SendEmail-request-EmailTags) field of the [`SendEmail`](https://docs.aws.amazon.com/ses/latest/APIReference-V2/API_SendEmail.html) API operation or add the message tag to the SES-specific email header [`X-SES-MESSAGE-TAGS`](https://docs.aws.amazon.com/ses/latest/dg/event-publishing-send-email.html#event-publishing-using-ses-headers). For more information about configuration sets, see [Using configuration sets in Amazon SES](using-configuration-sets.md).
