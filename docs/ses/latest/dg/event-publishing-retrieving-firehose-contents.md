...
| `isBotEvent` | The likelihood that the event was generated by an automated system (bot) rather<br>than a human. Possible values: `Likely`, `Unlikely`. |
...
| `isBotEvent` | The likelihood that the event was generated by an automated system (bot)<br>rather than a human. Possible values: `Likely`,<br>`Unlikely`.                                                                                                                                                                                                                                            |
...
| `topicDefaultSubscriptionStatus` | Specifies the default subscription<br>status of the topic in the `topicName` field determining whether<br>new topics added to the event destination will be subscribed or unsubscribed<br>by default. Possible values are *_OptIn_<br>• (subscribed by<br>default) or *_OptOut_<br>• (unsubscribed by default) in the<br>`subscriptionStatus` field. |
