...
<a name="configure-custom-open-click-domain-universal-links"></a>

This section is optional. Complete it only if you have a mobile app and want iOS Universal Links or Android App Links to open your app directly when recipients click tracking links. Complete the subsection for each mobile platform your app supports—iOS, Android, or both. Before you begin, complete Part 1 to set up a custom redirect domain and Part 2 to configure your configuration set to use that domain.
