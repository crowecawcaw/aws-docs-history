...
| Amazon Simple Email Service updated a policy definition    | _Amazon Simple Email Service clarified the previous entry in this table (row below) to be:_ Amazon Simple Email Service added `ses:BatchGetMetricData` to AmazonSESReadOnlyAccess managed policy—this will give access to the SES API BatchGetMetricData | Apr 30, 2024  |
