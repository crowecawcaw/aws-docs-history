...
publishing of tags for all event types. If using feedback notifications directly on
the identity, SES does not publish tags. Read about adding tags when [creating a configuration set](creating-configuration-sets.md "creating-configuration-sets.md") or
...
The following is an example of a `Bounce` event record that Amazon SES
publishes to Firehose.
...
The following is an example of a `Send` event record that Amazon SES
publishes to Firehose.
...
The following is an example of a `Reject` event record that Amazon SES
publishes to Firehose.
...
The following is an example of an `Open` event record that Amazon SES
publishes to Firehose.
...
The following is an example of a `Click` event record that Amazon SES
publishes to Firehose.
...
The following is an example of a `DeliveryDelay` event record that
Amazon SES publishes to Firehose.
