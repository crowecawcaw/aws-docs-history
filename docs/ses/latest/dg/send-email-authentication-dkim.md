...
| ---------------------------------------------------------------- | ----------------------------------------------------------- |
| You cannot enable DKIM signing on<br>the email address identity. | You can disable DKIM signing on the email address identity. |
| You can re-enable DKIM signing on the email address identity.    |

It’s generally never recommended to disable your DKIM signing as it risks tarnishing
your sender reputation, and it increases the risk of having your sent mail go to junk or
spam folders or having your domain spoofed.
