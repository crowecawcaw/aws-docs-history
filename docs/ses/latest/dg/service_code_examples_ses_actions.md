...
<a name="service_code_examples_ses_actions"></a>
...
These excerpts call the Amazon SES API and are code excerpts from larger programs that must be run in context. You can see actions in context in [Scenarios for Amazon SES using AWS SDKs](service_code_examples_ses_scenarios.md). 
