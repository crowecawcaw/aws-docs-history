...
**Meeting bridge information ( ![An icon of the letter i in a circle.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-1.png))**  
...
**Attendees panel (![An icon of two overlapping people in a blue circle.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-2.png))**  
...
**Chat panel (![An icon of a rectangular message balloon.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-3.png))**  
...
**Closed captions (![An icon of a box surrounding the letters CC.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-4.png))**  
...
**Media layout (![An icon showing a stylized app window with three panels.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-5.png))**  
...
**More options (![An icon showing a horizontal ellipsis.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-6.png))**  
...
**Record meeting (![An icon showing a REC button.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-7.png))**  
