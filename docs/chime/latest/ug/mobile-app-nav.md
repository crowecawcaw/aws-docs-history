...
![The navigation bar at the bottom of the Amazon Chime mobile app screen.](https://docs.aws.amazon.com/chime/latest/ug/images/mobile-nav-bar.png)
...
![The Answer control that appears when a meeting calls.](https://docs.aws.amazon.com/chime/latest/ug/images/mobile-widget.png)
...
![The Message from menu that appears when you tap a message.](https://docs.aws.amazon.com/chime/latest/ug/images/mobile-tap-menu.png)
...
**Ellipsis menus**  
When you join a meeting, a vertical ellipsis icon appears in the upper-right corner of the app window. ![Vertical ellipsis icon representing a menu or more options.](https://docs.aws.amazon.com/chime/latest/ug/images/mobile-kebab-menu.png)   
When you chat with someone or enter a chat room, a horizontal ellipsis icon appears in the upper-right corner. ![Horizontal ellipsis icon with three blue dots arranged horizontally.](https://docs.aws.amazon.com/chime/latest/ug/images/mobile-horiz-ellipse.jpg)   
