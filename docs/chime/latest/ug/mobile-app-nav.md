...
![The navigation bar at the bottom of the Amazon Chime mobile app screen.](images/mobile-nav-bar.png)
...
![The Answer control that appears when a meeting calls.](images/mobile-widget.png)
...
![The Message from menu that appears when you tap a message.](images/mobile-tap-menu.png)
...
![Vertical ellipsis icon representing a menu or more options.](images/mobile-kebab-menu.png)
