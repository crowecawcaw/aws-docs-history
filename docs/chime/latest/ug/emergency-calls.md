# Making emergency calls with Amazon Chime
...
- Windows, macOS, and the web app:
  ...
  - In the navigation pane, choose the **Meeting and call actions** icon, located to the right of **MEETINGS AND CALLS**,
    then choose **Dial a phone number**.
  - Choose **Call history** under **MEETINGS AND CALLS**, select a previous outbound number entry from the
    **Incoming**, **Missed**, or **Outgoing** list, choose the **Call log actions** icon, then choose **Call**.
