...
**Topics**
+ [Starting a group chat](#start-group-chat)
+ [Calling everyone in a chat room](#call-group-chat)
+ [Adding and removing group members](#add-remove-members)
+ [Leaving a group chat](#leave-group-chat)
