...
1. From the Amazon Chime app, choose the **Settings** icon (![Gear icon representing settings or configuration options.](https://docs.aws.amazon.com/chime/latest/ug/images/settings.png)) .
