...
When anonymous users try to join an Amazon Chime meeting, they automatically go to the Waiting Room, and the **Waiting Room** section appears in the **Attendees** panel.
