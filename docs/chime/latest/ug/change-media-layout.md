...
1. On the left control bar, choose the **Media layout** icon ![An icon showing a stylized app window with three panels.](https://docs.aws.amazon.com/chime/latest/ug/images/left-control-5.png)).
...
![The Amazon Chime meetings window, repeated to infinity.](https://docs.aws.amazon.com/chime/latest/ug/images/infinity-mirror.png)