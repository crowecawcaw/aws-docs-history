...
**Topics**
+ [Creating chat rooms](create-chat-room.md)
+ [Joining a chat room](join-chat.md)
+ [Sharing chat room URLs (web app only)](share-chat-url.md)
+ [Sending messages in chat rooms](chat-messages.md)
+ [Calling the members of a chat room](im-chat-room.md)
+ [Viewing chat room details.](chat-room-details.md)
+ [Changing a chat room's notification settings](chat-notification-settings.md)
+ [Hiding a chat room from the sidebar](hide-from-sidebar.md)
+ [Deleting chat rooms](delete-chat-room.md)
+ [Leaving a chat room](leave-chat.md)
+ [Sending @ notifications](at-mention.md)