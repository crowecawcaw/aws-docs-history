...
1. Get the webhook URL from the chat room administrator. For more information, see [Adding webhooks to a chat room](https://docs.aws.amazon.com/chime/latest/ug/chat-webhooks.html) in the *Amazon Chime User Guide*.
