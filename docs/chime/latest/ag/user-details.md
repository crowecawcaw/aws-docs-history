...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| **Display name**         | The user's name that appears in Amazon Chime. For Login with Amazon<br>(LWA) users, this is the full name. For Active Directory users, the<br>DISPLAY\_NAME\_ATTRIBUTE is used.             | Major, Mary                                                                                                          |
...
| **Registration**         | The user’s current registration status. The possible values are<br>different between Enterprise accounts, where invitations are not<br>sent, and Team accounts, where invitations are sent. | **Registered**,<br>*_Unregistered_<br>• (for a Team account), or<br>*_Suspended_<br>• (for an Enterprise<br>account) |
| **Permission tier**      | Set to *_Pro_<br>• by default, to allow users to<br>host meetings. It can be changed to<br>**Basic**.                                                                                       | **Pro**, **Basic**                                                                                                   |
...
| **Privacy setting**      | The presence setting that the user selected.                                                                                                                                                | *_Public_<br>• or<br>**Private**                                                                                     |
