...
As a managed service, Amazon Chime is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Chime through the network. Clients must
