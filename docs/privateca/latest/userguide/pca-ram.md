...
![Cross-account issuance with the console](https://docs.aws.amazon.com/privateca/latest/userguide/images/ca_access_2_accounts_console.png)
...
![Cross-account issuance using the APIs](https://docs.aws.amazon.com/privateca/latest/userguide/images/ca_access_2_accounts_api_options.png)
