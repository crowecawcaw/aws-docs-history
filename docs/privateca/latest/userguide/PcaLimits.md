...
To see what quotas can be adjusted, see the [AWS Private CA quotas table](https://docs.aws.amazon.com/general/latest/gr/pca.html#limits_pca) in the *AWS General Reference*.
