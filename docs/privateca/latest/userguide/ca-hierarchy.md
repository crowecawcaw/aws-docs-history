...
**Topics**
+ [Validate end-entity certificates](#end-entity-validation)
+ [Plan the structure of a CA hierarchy](#ca-layers)
+ [Set length constraints on the certification path](#length-constraints)
