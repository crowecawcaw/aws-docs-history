...
- **Security of the cloud** – AWS is
  ...
  programs that apply to AWS Private Certificate Authority, see [AWS services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using AWS Private CA. The following topics show you how to configure AWS Private CA to meet your
  security and compliance objectives. You also learn how to use other AWS services that help
  you to monitor and secure your AWS Private CA resources.
