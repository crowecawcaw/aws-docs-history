...
AWS Private CA and your other AWS solutions. AWS provides the following monitoring tools to
watch AWS Private CA, report when something is wrong, and take automatic actions when
appropriate:
...
- _Amazon EventBridge_ is a serverless event bus service that makes it easy to connect your
  ...
  The following topics describe AWS cloud-monitoring tools available for use with
  AWS Private CA.
