...
<a name="connector-for-scep-setting-up"></a>
...
**Topics**
+ [Step 1: Create an AWS Identity and Access Management policy](#scep-prequisite-iam)
+ [Step 2: Create a private CA](#scep-prequisite-pca)
+ [Step 3: Create a resource share using AWS Resource Access Manager](#scep-prequisite-ram-share-pca)

## Step 1: Create an AWS Identity and Access Management policy
<a name="scep-prequisite-iam"></a>
...
+ **Revocation** – Enable OCSP or CRLs on your private CA to allow for revocation. For more information, see [Plan your AWS Private CA certificate revocation method](revocation-setup.md).
