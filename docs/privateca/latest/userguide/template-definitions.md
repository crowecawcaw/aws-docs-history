...
certificates. The template does not specify a path length ([pathLenConstraint](PcaTerms.md#terms-pathlength "PcaTerms.md#terms-pathlength")) because this could inhibit
...
AWS Private CA can issue, but it can be customized using the API structure. The basic
...
this template, AWS Private CA passes additional extensions from the certificate
