...
As a managed service, AWS Private Certificate Authority is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Private CA through the network. Clients must
