...
+  [AWS Command Line Interface V2](https://docs.aws.amazon.com/goto/cli2/personalize-2018-05-22/CreateFilter) 
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/personalize-2018-05-22/CreateFilter) 
