...
2. Create a Custom dataset group with a new schema and upload your dataset with
   impressions data. Optionally include CREATION\_TIMESTAMP and [Unstructured text metadata](items-datasets.md#text-data "items-datasets.md#text-data") data in your Items dataset so Amazon Personalize can more
...
options. 8. In **Event configuration**, if your Item interactions dataset has EVENT\_TYPE or both EVENT\_TYPE and EVENT\_VALUE columns,
...
Optionally include CREATION\_TIMESTAMP and [Unstructured text metadata](items-datasets.md#text-data "items-datasets.md#text-data") data in your Items dataset so Amazon Personalize can more
