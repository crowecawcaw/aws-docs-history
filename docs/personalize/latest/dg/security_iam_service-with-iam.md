...
Before you use IAM to manage access to Amazon Personalize, learn what IAM features are
available to use with Amazon Personalize.

| IAM features you can use with Amazon Personalize                                                                                                                            | IAM feature | Amazon Personalize support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------------- |
...
To get a high-level view of how Amazon Personalize and other AWS services work with most IAM
...
To see a list of Amazon Personalize actions, see [Actions defined by Amazon Personalize](../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-actions-as-permissions") in the
...
To see a list of Amazon Personalize resource types and their ARNs, see
[Resources defined by Amazon Personalize](../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of Amazon Personalize condition keys, see [Condition keys for Amazon Personalize](../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-policy-keys "../../../service-authorization/latest/reference/list_amazonpersonalize.md#amazonpersonalize-policy-keys") in the
...
For more information about tagging Amazon Personalize
resources, see [Tagging Amazon Personalize resources](tagging-resources.md "tagging-resources.md").
