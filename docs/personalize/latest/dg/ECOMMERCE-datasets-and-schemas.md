...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Item interactions ([default schema](ECOMMERCE-interactions-dataset.md#ECOMMERCE-interactions-schema "ECOMMERCE-interactions-dataset.md#ECOMMERCE-interactions-schema")) | USER_ID (`string`)<br>ITEM_ID (`string`)<br>TIMESTAMP (`long`)<br>EVENT_TYPE (`string` and depending on [use case](domain-use-cases.md "domain-use-cases.md"), `Purchase` and `View` event types) | EVENT_VALUE (`float`, `null`)<br>IMPRESSION (`string`, `null`)<br>RECOMMENDATION_ID (`string`, `null`)<br>EVENT_ATTRIBUTION_SOURCE (`string`, `null`)                                                                                                                                                  |
| Users ([default schema](ECOMMERCE-users-dataset.md#ECOMMERCE-users-dataset-schema "ECOMMERCE-users-dataset.md#ECOMMERCE-users-dataset-schema"))                         | USER_ID (`string`)<br>1 metadata field (categorical `string` or numerical)                                                                                                                        |                                                                                                                                                                                                                                                                                                        |
| Items ([default schema](ECOMMERCE-items-dataset.md#ECOMMERCE-items-dataset-schema "ECOMMERCE-items-dataset.md#ECOMMERCE-items-dataset-schema"))                         | ITEM_ID (`string`)<br>PRICE (`float`)<br>CATEGORY_L1 (categorical `string`)                                                                                                                       | CATEGORY_L2 (categorical `string`, `null`)<br>CATEGORY_L3 (categorical `string`, `null`)<br>PRODUCT_DESCRIPTION (textual `string`, `null`)<br>CREATION_TIMESTAMP (`long`)<br>AGE_GROUP (categorical `string`, `null`)<br>ADULT (categorical `string`, `null`)<br>GENDER (categorical `string`, `null`) |
