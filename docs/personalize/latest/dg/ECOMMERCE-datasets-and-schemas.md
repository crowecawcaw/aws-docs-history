...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Item interactions ([default schema](ECOMMERCE-interactions-dataset.md#ECOMMERCE-interactions-schema "ECOMMERCE-interactions-dataset.md#ECOMMERCE-interactions-schema")) | USER\_ID (`string`)<br>ITEM\_ID (`string`)<br>TIMESTAMP (`long`)<br>EVENT\_TYPE (`string` and depending on [use case](domain-use-cases.md "domain-use-cases.md"), `Purchase` and `View` event types) | EVENT\_VALUE (`float`, `null`)<br>IMPRESSION (`string`, `null`)<br>RECOMMENDATION\_ID (`string`, `null`)<br>EVENT\_ATTRIBUTION\_SOURCE (`string`, `null`)                                                                                                                                                   |
| Users ([default schema](ECOMMERCE-users-dataset.md#ECOMMERCE-users-dataset-schema "ECOMMERCE-users-dataset.md#ECOMMERCE-users-dataset-schema"))                         | USER\_ID (`string`)<br>1 metadata field (categorical `string` or numerical)                                                                                                                          |                                                                                                                                                                                                                                                                                                             |
