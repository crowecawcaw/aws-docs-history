...
Third-party auditors assess the security and compliance of Amazon Personalize as part of
...
Your compliance responsibility when using Amazon Personalize is determined by the sensitivity
...
- [Architecting for HIPAA security and compliance whitepaper](../../../whitepapers/latest/architecting-hipaa-security-and-compliance-on-aws/architecting-hipaa-security-and-compliance-on-aws.md "../../../whitepapers/latest/architecting-hipaa-security-and-compliance-on-aws/architecting-hipaa-security-and-compliance-on-aws.md") –
  Learn how you can use AWS to run sensitive workloads regulated under the U.S. Health Insurance Portability and Accountability Act (HIPAA).
- [AWS
