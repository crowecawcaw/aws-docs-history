...
1. Depending on if your resources are in the same or different accounts, create one or more IAM service roles with
   ...
   - If your OpenSearch Service and Amazon Personalize resources are in separate accounts, you create two IAM service roles. You create
     ...
     campaign. For more information, see [Configuring permissions when resources are in different accounts](configuring-multiple-accounts.md "configuring-multiple-accounts.md").
...
- [Configuring permissions when resources are in the same account](service-role-managed.md "service-role-managed.md")
- [Configuring permissions when resources are in different accounts](configuring-multiple-accounts.md "configuring-multiple-accounts.md")
