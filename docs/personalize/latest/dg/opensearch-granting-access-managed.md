...
1. Grant the user or role that's accessing your OpenSearch Service domain `PassRole` permissions for the IAM service role that you created for OpenSearch Service. For more information, see [Configuring Amazon OpenSearch Service domain security](domain-user-managed.md).

After you set up permissions, you are ready to install the plugin on your domain. For more information, see [Installing the plugin](open-search-install-managed.md).
