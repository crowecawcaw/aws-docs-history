...
<tbody>
  <tr><td colspan="2"><b>Feature transformation hyperparameters</b></td></tr>
  <tr><td><code>Trend discovery frequency</code></td><td>Specify how often Amazon Personalize evaluates your interactions data and identifies trending items. For example, if you specify <code>30 minutes</code> for <code>Trend discovery frequency</code>, every 30 minutes Amazon Personalize identifies items with the greatest rate of increase in interactions over 30-minute intervals. <br />Available frequencies include 30 minutes, 1 hour, 2 hours, 3 hours, and 1 day. Choose a frequency that aligns with the distribution of your interactions data. Missing data over the interval you choose can reduce recommendation accuracy. If you use the CreateSolution API operation and don't specify a value, the default is every 2 hours. For any parameter values that are greater than 2 hours, Amazon Personalize automatically refreshes the trending item recommendations every 2 hours to account for new interactions and new items. <br />Default value: 2 hours<br />Possible values: 30 minutes, 1 hour, 2 hours, 3 hours, and 1 day.<br />Value type: String<br />HPO tunable: No</td></tr>
</tbody>
</table>
