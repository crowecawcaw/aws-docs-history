...
<a name="use-cases-and-recipes"></a>
...
+ With a *Domain dataset group*, you create resources that are pre-configured and optimized for the VIDEO\_ON\_DEMAND or ECOMMERCE domains.
