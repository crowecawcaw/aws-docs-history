...
As a managed service, Amazon Personalize is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Personalize through the network. Clients must
