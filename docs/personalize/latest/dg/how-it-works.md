...
![Depicts the Amazon Personalize workflow, from importing data, to training a model, to getting recommendations.](https://docs.aws.amazon.com/personalize/latest/dg/images/how-it-works.png)
