...
**Topics**
+ [Bulk data format guidelines for all types of data](#general-formatting-guidelines)
+ [Preparing item interaction data for training](interactions-datasets.md)
+ [Preparing item metadata for training](items-datasets.md)
+ [Preparing user metadata for training](users-datasets.md)
+ [Preparing action metadata for training](actions-datasets.md)
+ [Preparing action interaction data for training](action-interactions-datasets.md)
