...
A container for historical and real-time data that you collect from interactions between users and items (called *[events](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#event)*). Interactions data can include event type data and [contextual metadata](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#contextual-metadata).
...
A *[USER\_PERSONALIZATION](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#user-personalization-recipes)* recipe that recommends the items that have the most interactions with unique users.
...
**training mode**  
 ...
 With User-Personalization-v2, User-Personalization, or Next-Best-Action, Amazon Personalize automatically updates the latest solution version trained with FULL training mode. See [Automatic updates](use-case-recipe-features.md#automatic-updates). 

**User-Personalization-v2 recipe**  
 A *[USER\_PERSONALIZATION](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#user-personalization-recipes)* recipe that recommends items a user will interact with based on their preferences. This recipe uses a transformer based architecture to train a model that learns from item interactions data, item metadata, and user metadata. It can train on up to 5 million items and generate more relevant recommendations with lower latency than the previous version. 

**User-Personalization recipe**  
A Hierarchical Recurrent Neural Network (HRNN) based *[USER\_PERSONALIZATION](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#user-personalization-recipes)* recipe that predicts the items that a user will interact with. The user-personalization recipe can use item exploration and impressions data to generate recommendations for new items.
