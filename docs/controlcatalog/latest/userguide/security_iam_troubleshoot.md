# Troubleshooting Control Catalog identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with AWS Control Catalog and IAM.

###### Topics

- [I am not authorized to
  perform an action in Control Catalog](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to give people
  outside of my AWS account access to my Control Catalog resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Control Catalog
...
have the fictional `controlcatalog:`GetWidget`` permissions.
...
`controlcatalog:`GetWidget`` action.
...
AWS Control Catalog. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account access to my Control Catalog resources
...
- To learn whether AWS Control Catalog supports these features, see [How Control Catalog works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
