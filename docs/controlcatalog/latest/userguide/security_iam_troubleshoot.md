...
**Topics**
+ [I am not authorized to perform an action in Control Catalog](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to give people outside of my AWS account access to my Control Catalog resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether AWS Control Catalog supports these features, see [How Control Catalog works with IAM](security_iam_service-with-iam.md).
