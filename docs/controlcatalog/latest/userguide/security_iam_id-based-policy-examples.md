...
For details about actions and resource types defined by AWS Control Catalog, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for AWS Control Catalog](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscontrolcatalog.html) in the *Service Authorization Reference*.

**Topics**
+ [Policy best practices](#security_iam_service-with-iam-policy-best-practices)
+ [Allow users to view their own permissions](#security_iam_id-based-policy-examples-view-own-permissions)
+ [Allow users to view resources from AWS Control Catalog](#security_iam_id-based-policy-examples-view-resources-in-audit-manager)
...
<a name="security_iam_id-based-policy-examples-view-resources-in-audit-manager"></a>
