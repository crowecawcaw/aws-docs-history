...
performance of AWS Control Catalog and your other AWS solutions. AWS provides the following monitoring
tools to watch AWS Control Catalog, report when something is wrong, and take automatic actions when
appropriate:
