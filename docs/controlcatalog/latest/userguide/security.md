...
- **Security in the cloud** – Your responsibility is
  ...
  using Control Catalog;. The following topics show you how to configure Control Catalog; to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Control Catalog; resources.

###### Topics

- [Data protection in Control Catalog](data-protection.md "data-protection.md")
- [Identity and access management for Control Catalog](security-iam.md "security-iam.md")
- [Compliance validation for Control Catalog](compliance-validation.md "compliance-validation.md")
- [Resilience in Control Catalog](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure Security in Control Catalog](infrastructure-security.md "infrastructure-security.md")
