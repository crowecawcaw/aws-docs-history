...
To view examples of AWS Control Catalog identity-based policies, see [Identity-based policy examples for Control Catalog](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
