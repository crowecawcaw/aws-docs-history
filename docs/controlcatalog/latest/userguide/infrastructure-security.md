...
As a managed service, Control Catalog is protected by the AWS global network security
...
You use AWS published API calls to access Control Catalog through the network. Clients must
