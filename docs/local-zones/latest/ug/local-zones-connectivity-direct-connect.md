...
With AWS Direct Connect, you transfer data privately and directly from your data center into and out
...
For more information, see the [AWS Direct Connect User Guide](../../../directconnect/latest/UserGuide/Welcome.md "../../../directconnect/latest/UserGuide/Welcome.md").
...
AWS Direct Connect to communicate back to other parts of your applications in the data center. An example
