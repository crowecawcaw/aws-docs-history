...
**Topics**
+ [Procedure](#modernization-cal-process)
+ [Architecture category and pattern](#step1-pattern)
+ [Architecture size](#step2-size)
+ [Modernized architecture pattern](#step3-architecture)
+ [AWS service configuration](#step4-configuration)
