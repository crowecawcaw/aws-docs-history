...
![Choose Create an estimate](images/create-estimate.png) 3. On the **Add service** page, find the service that you want.
...
![Total upfront and monthly costs](images/upfront-monthly-costs.png) 7. (Optional) Choose **Show calculations** to view the breakeven
