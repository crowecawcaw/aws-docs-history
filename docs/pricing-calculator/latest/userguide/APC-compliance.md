...
Third-party auditors assess the security and compliance of AWS Pricing Calculator as part of
multiple AWS compliance programs. AWS Pricing Calculator is not in scope of any AWS compliance programs.
...
Your compliance responsibility when using AWS Pricing Calculator is determined by the sensitivity
