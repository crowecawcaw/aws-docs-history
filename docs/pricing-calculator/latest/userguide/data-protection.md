...
applies to data protection in AWS Pricing Calculator. As described in this model, AWS is
...
- If you require FIPS 140-2 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form fields such as a **Name** field. This includes when you work with AWS Pricing Calculator or other AWS
