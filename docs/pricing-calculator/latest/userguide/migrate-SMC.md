...
1. Generate an AWS Pricing Calculator migrated estimate link for your records. To do this, choose **Share**.
...
<a name="migrate-SMC-differences"></a>
...
<a name="migrate-SMC-notsupported"></a>
