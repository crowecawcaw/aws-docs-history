...
**Topics**
+ [Procedure](#windows-sql-ec2-estimate)
+ [Licensing and tenancy recommendations](#estimate-workload-tenancy-ec2)
+ [Machine specifications](#estimate-workload-configure-ec2)
+ [Review dedicated hosts](#estimate-dedicatedhost-ec2)
+ [Pricing strategy](#estimate-workload-pricing-ec2)
+ [Cost details](#estimate-workload-cost-ec2)
+ [Bulk upload instructions for Dedicated Hosts](estimate-bulk-upload-ec2.md)
