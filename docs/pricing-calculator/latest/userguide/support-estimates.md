...
<a name="support-estimates"></a>

You can add Support costs to your estimates using the AWS Pricing Calculator. You can either directly choose your preferred support plan, or complete the recommendations that match your usage needs. You can change your Support within the calculator at any time.

## Procedure
<a name="support-estimate"></a>
...
1. (Optional) Choose an **Enhanced technical support** level from the dropdown list that appears.

1. (Optional) Choose a **High severity response** time from the dropdown list that appears..
**Note**  
Some of the Support recommendation options might not be available. This depends on the **Enhanced technical support** level and **High severity response** times you selected.
...
1. If you chose a **Business support plan** or **Enterprise support plan**, choose **Confirm** in the prompt that appears. Then, choose **Add to my estimate**.