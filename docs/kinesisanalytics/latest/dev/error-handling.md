...
| DATA\_ROW     | VARCHAR(49152) | The hex-encoded data in the original<br>row. You can use standard libraries to hex decode this value, or use web resources such as this<br>[Hex to String Converter](http://string-functions.com/hex-string.aspx "http://string-functions.com/hex-string.aspx"). |
