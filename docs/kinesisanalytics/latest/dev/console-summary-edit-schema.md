...
![Diagram showing relationship between streaming input, source schema configuration, and in-application input streams](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-diagram.png)
...
![Screenshot of edit schema page.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-overview.png)
...
![Screenshot of formatted stream sample tab containing stock data, with the edit schema button highlighted.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-1.png)

1. On the **Edit schema** page, edit the source schema.  
![Screenshot of edit schema page.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-0.png)
...
![Screenshot of schema editor showing the x icon next to the column number.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-delete.png)
...
![Screenshot of schema editor showing the modified schema.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-2.png)
...
![Screenshot of schema editor showing the modified schema.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/edit-schema-3.png)
