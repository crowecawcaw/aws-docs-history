...
**Topics**
+ [Stopped applications](#idle-applications)
...
+ For more information about SQL statements, see [Kinesis Data Analytics for SQL examples](examples.md). This section provides a number of SQL examples that you can use. 
