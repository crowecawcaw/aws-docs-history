...
![Console screenshot showing the in-application schema with event time, ticker, and price columns.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/ex_tumbling_event_schema.png)
...
![Console screenshot showing the resulting data in an in-application stream.](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/images/ex_tumbling_event.png)
