...
1. Choose **Data Analytics** in the navigation pane. Create a Kinesis Data Analytics application as described in the [Getting Started with Amazon Kinesis Data Analytics for SQL Applications](getting-started.md) tutorial.
