...
| Access or sample data in the console                                                                                              | `kinesisanalytics:GetApplicationState`                  | `arn:aws:kinesisanalytics: `region`:`accountId`:application/`application-name`` | ## GetApplicationState The console uses an internal method called `GetApplicationState` to sample or access application data. Your service application needs to have permissions for the internal `kinesisanalytics:GetApplicationState` API to sample or access application data through the AWS Management Console. |
