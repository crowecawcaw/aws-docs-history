...
| DOUBLE<br />DOUBLE PRECISION | number | A 64-bit floating point number | 64-bit approx value; -1.79E\+308 to 1.79E\+308. Follows the ISO DOUBLE PRECISION data type, 53 bits are used for the number's mantissa in scientific notation, representing 15 digits of precision and 8 bytes of storage. | 
| INTEGER<br />INT | number |   | 32-bit signed integer. Range is -2147483648 to 2147483647 [ 2\*\*(31) to 2\*\*(31)- 1] | 
...
| TIME | string | A TIME is a time in a day (hour:minute:second). | Its precision is milliseconds; its range is 00:00:00.000 to 23:59:59.999. Since the system clock runs in UTC, the timezone used for values stored in a TIME or TIMESTAMP column is not considered.<br />for values stored in a TIME or TIMESTAMP column. | 
