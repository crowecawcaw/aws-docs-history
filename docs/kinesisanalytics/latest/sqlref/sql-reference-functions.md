...
- [Boolean Functions](sql-reference-boolean-functions.md "sql-reference-boolean-functions.md")
- [Conversion Functions](sql-reference-conversion-functions.md "sql-reference-conversion-functions.md")
- [Date and Time Functions](sql-reference-date-time-functions.md "sql-reference-date-time-functions.md")
- [Null Functions](sql-reference-null-functions.md "sql-reference-null-functions.md")
