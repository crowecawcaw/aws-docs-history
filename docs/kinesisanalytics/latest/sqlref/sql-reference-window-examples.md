...
![Time-based window example showing lastHour windows at different times containing varying row counts.](images/window-examples.png)## Examples of windows containing rows
...
![Table showing ticker data with time windows: lastZeroRows groups by row, lastZeroSeconds by timestamp.](images/window-examples2.png)
...
![Table showing rowtime, ticker, and amount columns with partitioned windows highlighted for rows.](images/window-examples3.png)
