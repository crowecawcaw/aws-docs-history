...
- If you don't use the `OVER` clause, `STDDEV_POP` is calculated as an aggregate function. In this case,
...
- If you use the `OVER` clause, `STDDEV_POP` is calculated as an analytic function. For more information, see
...
![Table showing ROWTIME, TICKER_SYMBOL, and STDDEV_POP_PRICE columns with sample data entries.](images/sql-reference-stddev-pop-1.png)
...
![Table showing ROWTIME, TICKER_SYMBOL, and STDEV_POP_PRICE columns with sample data entries.](images/sql-reference-stddev-pop-2.png)
