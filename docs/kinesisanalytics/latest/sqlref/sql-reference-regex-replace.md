...
![Table showing stock data with columns for rowtime, ticker symbol, sector, change, and price.](https://docs.aws.amazon.com/kinesisanalytics/latest/sqlref/images/sql-reference-regex-replace.png)
