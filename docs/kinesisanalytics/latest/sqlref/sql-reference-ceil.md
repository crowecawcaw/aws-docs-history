...
| CEILING(TIMESTAMP '2004-09-30 13:48:23' TO YEAR)   | TIMESTAMP '2005-01-01 00:00:00.0' | ## Notes <br>• CEIL and CEILING are synonyms for this function provided by the SQL:2008 standard. <br>• CEIL(<datetime value expression> TO <time unit>) is an Amazon Kinesis Data Analytics extension. <br>• For more information, see [FLOOR](sql-reference-floor.md "sql-reference-floor.md"). |
