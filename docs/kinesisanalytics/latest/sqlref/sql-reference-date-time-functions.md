...
- [CURRENT\_DATE](sql-reference-current-date.md "sql-reference-current-date.md")
- [CURRENT\_ROW\_TIMESTAMP](sql-reference-current-row-timestamp.md "sql-reference-current-row-timestamp.md")
- [CURRENT\_TIME](sql-reference-current-time.md "sql-reference-current-time.md")
- [CURRENT\_TIMESTAMP](sql-reference-current-timestamp.md "sql-reference-current-timestamp.md")
...
LOCALTIMESTAMP, LOCALTIME, CURRENT\_DATE, and CURRENT\_TIMESTAMP all produce results which are
set to values at the time the query first executes. Only CURRENT\_ROW\_TIMESTAMP generates a row
...
CURRENT\_ROW\_TIMESTAMP, each output row gets a newly-calculated value of TIME representing when
that row was output.
