...
Before you use IAM to manage access to EventBridge Scheduler, learn what IAM features are
available to use with EventBridge Scheduler.

| IAM features you can use with Amazon EventBridge Scheduler                                                                                                                  | IAM feature | EventBridge Scheduler support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------------------- |
...
To get a high-level view of how EventBridge Scheduler and other AWS services work with most IAM
...
To view examples of EventBridge Scheduler identity-based policies, see [Using identity-based policies in EventBridge Scheduler](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within EventBridge Scheduler
...
To see a list of EventBridge Scheduler actions, see [Actions defined by Amazon EventBridge Scheduler](../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions") in the
...
resources for EventBridge Scheduler
...
To see a list of EventBridge Scheduler resource types and their ARNs, see
[Resources defined by Amazon EventBridge Scheduler](../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon EventBridge Scheduler](../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions").

To view examples of EventBridge Scheduler identity-based policies, see [Using identity-based policies in EventBridge Scheduler](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Policy

condition keys for EventBridge Scheduler
...
To see a list of EventBridge Scheduler condition keys, see [Condition keys for Amazon EventBridge Scheduler](../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-policy-keys "../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Amazon EventBridge Scheduler](../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoneventbridgescheduler.md#amazoneventbridgescheduler-actions-as-permissions").
...
credentials with EventBridge Scheduler
...
principal permissions for EventBridge Scheduler
...
Changing the permissions for a service role might break EventBridge Scheduler functionality.
Edit service roles only when EventBridge Scheduler provides guidance to do so.

## Service-linked

roles for EventBridge Scheduler
