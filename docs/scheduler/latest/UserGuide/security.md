...
- **Security in the cloud** – Your responsibility is
  ...
  using EventBridge Scheduler. The following topics show you how to configure EventBridge Scheduler to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your EventBridge Scheduler resources.

###### Topics

- [Managing access to Amazon EventBridge Scheduler](security-iam.md "security-iam.md")
- [Data protection in Amazon EventBridge Scheduler](data-protection.md "data-protection.md")
- [Compliance validation for Amazon EventBridge Scheduler](compliance-validation.md "compliance-validation.md")
- [Resilience in Amazon EventBridge Scheduler](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure Security in Amazon EventBridge Scheduler](infrastructure-security.md "infrastructure-security.md")
