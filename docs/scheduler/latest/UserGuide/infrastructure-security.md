...
As a managed service, Amazon EventBridge Scheduler is protected by AWS global network security. For
...
You use AWS published API calls to access EventBridge Scheduler through the network. Clients must
