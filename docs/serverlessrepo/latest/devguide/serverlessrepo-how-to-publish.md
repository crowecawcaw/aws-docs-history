...
For more information about sharing your application by using the AWS CLI, see [AWS Serverless Application Repository Application Policy Examples](security_iam_resource-based-policy-examples.md).
...
For more information about changing permissions using the AWS CLI, see [AWS Serverless Application Repository Application Policy Examples](security_iam_resource-based-policy-examples.md).
