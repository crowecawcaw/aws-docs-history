...
+ [AWS Serverless Application Repository Application Policies](#security_iam_service-with-iam-resource-based-policies)
...
To view examples of managing AWS Serverless Application Repository application policies, see [AWS Serverless Application Repository Application Policy Examples](security_iam_resource-based-policy-examples.md).
