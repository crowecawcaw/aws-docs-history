...
As a managed service, AWS Serverless Application Repository is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Serverless Application Repository through the network. Clients must
