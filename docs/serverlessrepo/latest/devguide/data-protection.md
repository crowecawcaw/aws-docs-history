...
applies to data protection in AWS Serverless Application Repository. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with AWS Serverless Application Repository or other AWS services
...
AWS Serverless Application Repository API endpoints only support secure connections over HTTPS. When you manage AWS Serverless Application Repository
resources with the AWS Management Console, AWS SDK, or the AWS Serverless Application Repository API, all communication is encrypted
with Transport Layer Security (TLS).

For a full list of API endpoints, see [AWS Regions and
Endpoints](../../../general/latest/gr/rande.md "../../../general/latest/gr/rande.md") in the _AWS General Reference_.

## Encryption at Rest

The AWS Serverless Application Repository encrypts files that you upload to the AWS Serverless Application Repository, including deployment packages
and layer archives.
