...
- ** `fsxadmin` **
  - **Level of access:** all
  - **To the following commands or command directories:** All command directories available in FSx for ONTAP

- **`fsxadmin-readonly`**
  - **Level of access:** all / **To the following commands or command directories:** `security login password`<br />For managing own user account local password and key information only
  - **Level of access:** none / **To the following commands or command directories:** security
  - **Level of access:** readonly / **To the following commands or command directories:** All other command directories available in FSx for ONTAP
