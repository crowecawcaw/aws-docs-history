...
![Image of a volume's Available files (inodes) graph in the Monitoring tab, as seen in the Amazon FSx console.](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/images/fsx-ontap-available-files.png)
