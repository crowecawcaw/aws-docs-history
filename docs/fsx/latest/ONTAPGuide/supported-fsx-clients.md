...
+ [Using block storage protocols](#using-block-storage)
+ [Accessing data from within the AWS Cloud](#access-environments)
+ [Accessing data from on-premises](#accessing-data-from-on-premises)
+ [Configure routing to access Multi-AZ file systems from outside your VPC](configuring-routing-using-AWSTG.md)
+ [Configure routing to access Multi-AZ file systems from on-premises](configure-routing-maz-on-prem.md)
+ [Mounting volumes on Linux clients](attach-linux-client.md)
+ [Mounting volumes on Microsoft Windows clients](attach-windows-client.md)
+ [Mounting volumes on macOS clients](attach-mac-client.md)
...
+ [Accessing your data via Amazon S3 access points](accessing-data-via-s3-access-points.md)
+ [Accessing data from other AWS services](using-fsx-with-other-AWS-services.md)
