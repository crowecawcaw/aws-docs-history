...
examples for Amazon FSx for NetApp ONTAP
...
For details about actions and resource types defined by Amazon FSx, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md "../../../service-authorization/latest/reference/list_amazonfsx.md") in the _Service Authorization Reference_.
...
To access the Amazon FSx for NetApp ONTAP console, you must have a minimum set of permissions.
...
`AmazonFSxConsoleReadOnlyAccess` AWS managed policy to
...
Amazon FSx managed service policies in [AWS managed policies for Amazon FSx for NetApp ONTAP](security-iam-awsmanpol.md "security-iam-awsmanpol.md") .
