...
1. The **Backup restore** **Update type** provides the following information:
   ...
   + **IN\_PROGRESS** indicates that the volume is available and clients can mount the volume with read-only access to data. The **Progress %** shows the percentage of data that has been downloaded to the volume.
