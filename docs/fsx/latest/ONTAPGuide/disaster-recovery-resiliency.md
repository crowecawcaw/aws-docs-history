...
For more information, see [Protecting your data with volume backups](using-backups.md).

## Snapshots
<a name="resiliency-snapshots"></a>

 Amazon FSx creates snapshot copies of the Amazon FSx for NetApp ONTAP volumes. Snapshot copies offer protection against accidental deletion or modification of files in your volumes by end users. For more information, see [Protecting your data with snapshots](snapshots-ontap.md).
