...
examples for Amazon FSx for NetApp ONTAP](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
For details about creating or managing Amazon FSx service-linked roles, see [Using service-linked roles for
