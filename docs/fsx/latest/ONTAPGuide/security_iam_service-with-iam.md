...
Before you use IAM to manage access to Amazon FSx, learn what IAM features are
available to use with Amazon FSx.

IAM features you can use with Amazon FSx for NetApp ONTAP| IAM feature | Amazon FSx support |
| --- | --- |
...
To get a high-level view of how Amazon FSx and other AWS services work with most IAM
...
To view examples of Amazon FSx identity-based policies, see [Identity-based policy examples for Amazon FSx for NetApp ONTAP](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
To see a list of Amazon FSx actions, see [Actions defined by Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions") in the
...
To see a list of Amazon FSx resource types and their ARNs, see
[Resources defined by Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions").
...
To see a list of Amazon FSx condition keys, see [Condition keys for Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-policy-keys "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Amazon FSx](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions").
...
For more information about tagging Amazon FSx
resources, see [Tagging Amazon FSx resources](tag-resources.md "tag-resources.md").
...
For details about creating or managing Amazon FSx service-linked roles, see [Using service-linked roles for Amazon FSx](using-service-linked-roles.md "using-service-linked-roles.md").
