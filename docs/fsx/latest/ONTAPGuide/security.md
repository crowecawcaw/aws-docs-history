...
- **Security in the cloud** – Your responsibility is
  ...
  using Amazon FSx. The following topics show you how to configure Amazon FSx to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Amazon FSx resources.

###### Topics

- [Data protection in Amazon FSx for NetApp ONTAP](data-protection.md "data-protection.md")
- [Identity and access management for Amazon FSx for NetApp ONTAP](security-iam.md "security-iam.md")
- [AWS managed policies for Amazon FSx for NetApp ONTAP](security-iam-awsmanpol.md "security-iam-awsmanpol.md")
- [File System Access Control with Amazon VPC](limit-access-security-groups.md "limit-access-security-groups.md")
- [Compliance Validation for Amazon FSx for NetApp ONTAP](fsx-ontap-compliance.md "fsx-ontap-compliance.md")
- [Amazon FSx for NetApp ONTAP and interface VPC endpoints (AWS PrivateLink)](fsx-vpc-endpoints.md "fsx-vpc-endpoints.md")
- [Resilience in Amazon FSx for NetApp ONTAP](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure security in Amazon FSx for NetApp ONTAP](infrastructure-security.md "infrastructure-security.md")
- [Use NetApp ONTAP Vscan with FSx for ONTAP](using-vscan.md "using-vscan.md")
