...
| Maximum SSD IOPS | Second-generation file systems: +  200,000 per HA pair (up to 12 pairs) for Single-AZ <br />+  200,000 total for Multi-AZ <br />First-generation file systems:+ 160,000 in US East (Ohio) Region, US East (N. Virginia) Region, US West (Oregon) Region, and Europe (Ireland)<br />+ 80,000 [ in all other AWS Regions where FSx for ONTAP is available](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/) | 
...
| Maximum throughput capacity | Second-generation file systems: +  73,728 MBps1 for Single-AZ <br />+  6,144 MBps for Multi-AZ <br />First-generation file systems: + 4,096 MBps2 in US East (Ohio) Region, US East (N. Virginia) Region, US West (Oregon) Region, and Europe (Ireland)<br />+ 2,048 MBps [ in all other AWS Regions where FSx for ONTAP is available ](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/) | 
| Maximum number of volumes | + Second-generation file systems (1 HA pair): 500<br />+ Second-generation file systems (2 or more HA pairs): 1,000<br />+ First-generation file systems: 500When using S3 access points with your file system:+ Second-generation file systems (1 HA pair): 491<br />+ Second-generation file systems (2 or more HA pairs): 975 for 2 HA pairs (903 for 12 HA pairs)<br />+ First-generation file systems: 491 | 
| Maximum number of snapshots | 1,023 per volume3 | 
| Maximum number of backups | 4,091 per volume4 | 
| Maximum number of SVMs | Second-generation file systems with one HA pair and IPv4-only network type:+  6 (384 MBps of throughput capacity) <br />+  6 (768 MBps of throughput capacity) <br />+  14 (1,536 MBps of throughput capacity) <br />+  14 (3,072 MBps of throughput capacity) <br />+  24 (6,144 MBps of throughput capacity) Second-generation file systems with one HA pair and dual-stack network type:+  6 (384 MBps of throughput capacity) <br />+  6 (768 MBps of throughput capacity) <br />+  11 (1,536 MBps of throughput capacity) <br />+  11 (3,072 MBps of throughput capacity) <br />+  11 (6,144 MBps of throughput capacity) <br />Second-generation file systems with 2–12 HA pairs and either IPv4-only or dual-stack network type:+  11 <br />First-generation file systems with IPv4-only network type:+  6 (128 MBps throughput capacity) <br />+  6 (256 MBps throughput capacity) <br />+  14 (512 MBps throughput capacity) <br />+  14 (1,024 MBps throughput capacity) <br />+  24 (2,048 MBps throughput capacity) <br />+  24 (4,096 MBps throughput capacity) <br />First-generation file systems with dual-stack network type:+  6 (128 MBps throughput capacity) <br />+  6 (256 MBps throughput capacity) <br />+  11 (512 MBps throughput capacity) <br />+  11 (1,024 MBps throughput capacity) <br />+  11 (2,048 MBps throughput capacity) <br />+  11 (4,096 MBps throughput capacity)  | 
