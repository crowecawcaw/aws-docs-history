...
For more information about tagging Amazon FSx resources, see [Tagging Amazon FSx resources](tag-resources.md). For more information about using tags to control access to Amazon FSx resources, see [Using tags to control access to your Amazon FSx resources](#restrict-fsx-access-tags).
