...
For more information about data encryption with Amazon FSx for NetApp ONTAP, see [Encryption of data at rest](encryption-at-rest.md) and [Encrypting data in transit](encryption-in-transit.md).