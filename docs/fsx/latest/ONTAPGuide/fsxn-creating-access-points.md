...
[IAM access point policies](s3-ap-manage-access-fsxn.md#access-points-for-fsxn-policies "s3-ap-manage-access-fsxn.md#access-points-for-fsxn-policies").
...
- [Creating access points restricted to a virtual private cloud](access-points-for-fsxn-vpc.md "access-points-for-fsxn-vpc.md")
