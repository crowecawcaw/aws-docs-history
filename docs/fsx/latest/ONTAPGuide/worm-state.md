...
+ Run the following command. Replace {{litigation1}}, {{slc\_vol1}}, and {{file1}} with your own information. 
...
+ Run the following command. Replace {{litigation1}} and {{slc\_vol1}} with your own information. 
