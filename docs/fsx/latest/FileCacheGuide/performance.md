...
| --- |--- |--- |--- |--- |--- |
| CACHE-1000 | 2600 |  Tens of thousands baseline Hundreds of thousands burst  | 27.3 |  Metadata: sub-ms Data: sub-ms  |  1000  | 
| --- |--- |--- |--- |--- |--- |
...
For more information about monitoring your cache’s performance, see [Monitoring Amazon File Cache](monitoring_overview.md).
