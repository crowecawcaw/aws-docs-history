...
Interfaces for your caches in your VPC.
...
The AmazonFSxServiceRolePolicy permissions policy allows Amazon FSx to complete the following actions on
all applicable AWS resources:
...
You don't need to manually create a service-linked role. When you create a cache
...
the same process to recreate the role in your account. When you create a cache,
...
actively monitored or maintained. However, you must delete all of your file caches before
