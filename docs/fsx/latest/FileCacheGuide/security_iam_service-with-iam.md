...
Before you use IAM to manage access to File Cache, learn what IAM features are
available to use with File Cache.

| IAM features you can use with Amazon File Cache                                                                                                                             | IAM feature | File Cache support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------ |
...
To get a high-level view of how Amazon File Cache and other AWS services work with most
...
To see a list of File Cache actions, see [Actions defined by Amazon File Cache](../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-actions-as-permissions") in the
...
To see a list of File Cache resource types and their ARNs, see
[Resources defined by Amazon File Cache](../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of File Cache condition keys, see [Condition keys for Amazon File Cache](../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-policy-keys "../../../service-authorization/latest/reference/list_amazonfsx.md#your_service-policy-keys") in the
...
Changing the permissions for a service role might break Amazon File Cache
