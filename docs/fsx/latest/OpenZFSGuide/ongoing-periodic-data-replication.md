...
| CopyStrategy              | INCREMENTAL\_COPY                 | The *_CopyStrategy_<br>• parameter for the `CopySnapshotAndUpdateVolume` API operation. For more information, see [CopySnapshotAndUpdateVolume](../APIReference/API_CopySnapshotAndUpdateVolume.md "../APIReference/API_CopySnapshotAndUpdateVolume.md") in the Amazon FSx API. |
