...
When you create an Amazon FSx for OpenZFS file system, you must specify a network type, which
...
- `Dual-stack` allows your file system to communicate using
  ...
  You can change the network type of an existing FSx for OpenZFS file system at any time
...
When creating FSx for OpenZFS file systems set to dual-stack mode, you can specify the IPv6 address
