...
examples for Amazon FSx for OpenZFS
...
To access the Amazon FSx for OpenZFS console, you must have a minimum set of permissions.
...
To ensure that users and roles can still use the Amazon FSx console, also attach the
Amazon FSx
[AmazonFSxConsoleFullAccess](security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonFSxConsoleFullAccess "security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonFSxConsoleFullAccess")
or [AmazonFSxConsoleReadOnlyAccess](security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonFSxConsoleReadOnlyAccess "security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonFSxConsoleReadOnlyAccess") AWS managed policy to
