...
[Using service-linked roles for Amazon FSx for OpenZFS](using-service-linked-roles.md "using-service-linked-roles.md") to learn more.
...
information, see [Using service-linked roles for Amazon FSx for OpenZFS](using-service-linked-roles.md "using-service-linked-roles.md").
