...
As a managed service, Amazon FSx for OpenZFS is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon FSx through the network. Clients must
