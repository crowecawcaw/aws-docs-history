...
For more information about tagging Amazon FSx resources, see [Tag your Amazon FSx for OpenZFS resources](tag-resources.md).
...
For details about creating or managing Amazon FSx service-linked roles, see [Using service-linked roles for Amazon FSx for OpenZFS](using-service-linked-roles.md).