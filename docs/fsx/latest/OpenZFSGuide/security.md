...
**Topics**
+ [Data encryption in Amazon FSx for OpenZFS](data-protection.md)
+ [Managing file system access with with Amazon VPC](limit-access-security-groups.md)
...
+ [Using AWS PrivateLink to configure interface VPC endpoints](fsx-vpc-endpoints.md)
