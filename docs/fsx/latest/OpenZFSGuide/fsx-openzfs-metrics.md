...
| Metric                                | Description                                                                                                                                                                                                                                                                                                                                           |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NetworkThroughputUtilization`        | The network throughput for clients that access the file system, as a percentage of the<br>provisioned limit. For Multi-AZ file systems, this metric includes replication<br>traffic.<br>Unit: Percent<br>Valid statistics: `Average`, `Maximum`                                                                                                       |
