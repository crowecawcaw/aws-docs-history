...
FSx for OpenZFS supports the use of AWS Direct Connect or Site-to-Site VPN to access your file
systems from your on-premises compute instances. Using Direct Connect, you access your file system over a
dedicated network connection from your on-premises environment. Using Site-to-Site VPN, you access your file system
...
compute instances within the VPC. For more information about Direct Connect, see
[What is AWS Direct Connect?](../../../directconnect/latest/UserGuide/Welcome.md "../../../directconnect/latest/UserGuide/Welcome.md")
in the _Direct Connect User Guide_. For more information on setting up Site-to-Site VPN connections,
