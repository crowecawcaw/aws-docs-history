...
interface provides a private IP address that serves as an entry point for traffic to the Amazon FSx API.
...
You can call any of the Amazon FSx API operations from your VPC. For example, you can create an FSx for Lustre
...
For a complete list of Amazon FSx endpoints, see [Amazon FSx endpoints and quotas](../../../general/latest/gr/fsxn.md "../../../general/latest/gr/fsxn.md") in the
