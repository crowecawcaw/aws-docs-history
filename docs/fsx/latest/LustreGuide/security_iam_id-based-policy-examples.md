...
For details about actions and resource types defined by Amazon FSx, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for Amazon FSx for Lustre](../../../service-authorization/latest/reference/list_amazonfsx.md "../../../service-authorization/latest/reference/list_amazonfsx.md") in the _Service Authorization Reference_.
