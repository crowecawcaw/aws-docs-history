...
+ Run AL2023, RHEL 9.5 and newer, or Ubuntu 22\+ with kernel version of 6.8 and newer. For more information, see [Installing the Lustre client](install-lustre-client.md).
...
+ Use an Amazon EC2 P5, P5e, P5en, P6-B200, or P6-B300 client instance.
