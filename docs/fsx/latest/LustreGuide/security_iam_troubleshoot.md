# Troubleshooting Amazon FSx for Lustre identity and
...
- To learn whether Amazon FSx supports these features, see [How Amazon FSx for Lustre works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
