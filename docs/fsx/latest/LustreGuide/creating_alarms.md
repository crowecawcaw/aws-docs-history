...
of time. The action is a notification that's sent to an Amazon SNS topic or Auto Scaling policy.
...
The following procedures describe how to create alarms for Amazon FSx for Lustre using the console,
AWS CLI, and API.
...
3. On the **Summary** page, choose **Monitoring & performance**.
4. Choose **Create CloudWatch alarm**. You are redirected to the CloudWatch
   console.
5. Choose **Select metrics**, and choose **Next**.
6. In the **Metrics** section, choose **FSX**.
7. Choose **File System Metrics**, choose the metric that you want to set the
   alarm for, and then choose **Select metric**.
8. In the **Conditions** section, choose the conditions for the alarm, and
   choose **Next**.
...
_Amazon CloudWatch User Guide_. 9. If you want CloudWatch to send you an email or SNS notification when the alarm state
triggers the action, choose **Whenever this alarm state is**.
...
the email addresses are verified, they do not receive a notification. 10. Fill in the **Name**, **Description**, and
**Whenever** values for the metric, and choose
**Next**. 11. On the **Preview and create** page, review the alarm and choose
**Create Alarm**.
...
4. Enter a **Name** and a **Description**, and
   choose a **Whenever** value for the metric.
