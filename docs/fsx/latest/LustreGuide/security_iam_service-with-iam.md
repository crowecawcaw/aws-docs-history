...
| IAM features you can use with Amazon FSx for Lustre                                                                                                      | IAM feature | Amazon FSx support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------ |
...
To see a list of Amazon FSx actions, see [Actions defined by Amazon FSx for Lustre](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-actions-as-permissions") in the
...
[Resources defined by Amazon FSx for Lustre](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of Amazon FSx condition keys, see [Condition keys for Amazon FSx for Lustre](../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-policy-keys "../../../service-authorization/latest/reference/list_amazonfsx.md#amazonfsx-policy-keys") in the
