...
**Topics**
+ [Key capabilities](#managing-files-fsrm-capabilities)
+ [Getting Started with File Server Resource Manager](enabling-fsrm.md)
+ [Quota Management](fsrm-quota-management.md)
+ [File Groups](fsrm-file-groups.md)
+ [File Screening](fsrm-file-screening.md)
+ [File Classification](fsrm-file-classification.md)
+ [Storage Reports](fsrm-storage-reports.md)
+ [File Management Tasks](fsrm-file-management.md)
+ [FSRM Settings](fsrm-settings.md)
+ [Event Logs](fsrm-event-logs.md)
+ [Common Use Cases](fsrm-common-use-cases.md)