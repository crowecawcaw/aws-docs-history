...
Access the generated reports by mapping the administrative D$ share. For more information, visit [Accessing storage reports](fsrm-storage-reports.md#fsrm-storage-reports-accessing).