...
+ For overview information about Amazon Kendra, see the [Amazon Kendra website](https://aws.amazon.com/kendra/).
...
<a name="kendra-file-performance"></a>
