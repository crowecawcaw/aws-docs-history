...
When you create an FSx for Windows file system, you must specify a network type, which
...
- `Dual-stack` allows your file system to communicate using
  ...
  You can change the network type of an existing FSx for Windows file system at any time
...
2. Navigate to **File systems**, and choose the FSx for Windows file system that you
