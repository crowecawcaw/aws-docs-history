...
| Metric                                | Description                                                                                                                                                                                                                                                                                                                                                                                        |
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NetworkThroughputUtilization`        | The network throughput on the file system as a percentage of the provisioned limit.<br>This metric reflects all network activity on the file system, including client I/O,<br>customer-scheduled tasks such as Data Deduplication, customer-enabled features such as Shadow Copies,<br>and system background activities such as Multi-AZ replication and maintenance operations.<br>Units: Percent |
