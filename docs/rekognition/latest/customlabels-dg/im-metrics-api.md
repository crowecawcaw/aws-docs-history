...
- _Confusion
  Matrix_ for image classification. For more information, see [Viewing the confusion matrix for a model](im-confusion-matrix.md "im-confusion-matrix.md").
...
[Interpreting the evaluation manifest snapshot](im-evaluation-manifest-snapshot-api.md "im-evaluation-manifest-snapshot-api.md")
...
- [Viewing the confusion matrix for a model](im-confusion-matrix.md "im-confusion-matrix.md")
