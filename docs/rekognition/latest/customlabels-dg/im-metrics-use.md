...
The console provides access to true positive, false positive, and false negative values for each image in your test dataset. For more information, see [Accessing evaluation metrics (Console)](im-access-training-results.md).
...
You can get the value of the assumed threshold for a label from the model's training results. For more information, see [Accessing evaluation metrics (Console)](im-access-training-results.md).
