...
When you use CloudFormation, you can reuse your template to set up your Amazon Rekognition Custom Labels projects
...
To provision and configure projects for Amazon Rekognition Custom Labels and related services, you must
...
For reference information about Amazon Rekognition Custom Labels projects, including examples of JSON and YAML templates,
see [Rekognition resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_Rekognition.md "../../../AWSCloudFormation/latest/UserGuide/AWS_Rekognition.md").
