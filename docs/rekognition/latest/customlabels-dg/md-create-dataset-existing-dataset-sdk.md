...
The following procedure shows you how to create a dataset from an existing dataset by using the [CreateDataset](../APIReference/API_CreateDataset.md "../APIReference/API_CreateDataset.md") operation.
...
2. Use the following example code to create a dataset by copying another dataset.
...
Use the following code to create the dataset. Replace the following:
    ...
    * `dataset_type` — with the type of dataset (`TRAIN` or `TEST`) that
     you want to create in the project.
