...
concepts) in images: Amazon Rekognition Custom Labels and [Amazon Rekognition Image label detection](../dg/labels.md "../dg/labels.md"). Use the
...
search for _common_ labels in images and
...
[Detecting labels](../dg/labels.md "../dg/labels.md").
...
Rekognition](../dg/what-is.md "../dg/what-is.md").
...
1. **[Setting up Amazon Rekognition Custom Labels](setting-up.md "setting-up.md")** – In this section, you set your account details.
2. **[Understanding Amazon Rekognition Custom Labels](understanding-custom-labels.md "understanding-custom-labels.md")** – In this section,
   you learn about the workflow for creating a model.
3. **[Getting started with Amazon Rekognition Custom Labels](getting-started.md "getting-started.md")** – In this section,
   you train a model using example projects created by Amazon Rekognition Custom Labels.
4. **[Classifying images](tutorial-classification.md "tutorial-classification.md")** – In this section,
