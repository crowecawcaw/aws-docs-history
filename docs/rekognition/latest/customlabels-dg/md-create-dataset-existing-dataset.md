...
Single dataset
    ...
    1. In the **Training dataset details**
     section, choose **Copy an existing Amazon Rekognition Custom Labels dataset**.
    2. In the **Training dataset details**
     section, in the **Dataset** edit box, type or select the name of the dataset that you want to copy.
