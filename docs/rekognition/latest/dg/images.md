...
- [Text in image detection](text-detection.md "text-detection.md")
  ...
  by non-storage API operations. For more information, see [Understanding non-storage and storage API operations](how-it-works-storage-non-storage.md "how-it-works-storage-non-storage.md").
