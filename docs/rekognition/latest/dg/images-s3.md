...
1. If you haven't already:
   ...
   1. Install and configure the AWS CLI and the AWS SDKs. For more information, see [Step 2: Set up the AWS CLI and AWS SDKs](setup-awscli-sdk.md). Ensure that you have given the user calling the API operations the proper permissions for programmatic access, see [Grant programmatic access](sdk-programmatic-access.md) for instructions on how to do this.
...
For more information about using the `DetectLabels` operation, see [Detecting objects and concepts](labels.md).
