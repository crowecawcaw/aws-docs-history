...
#### [ AWS CLI ]
   ...
   This AWS CLI command displays the JSON output for the `get-celebrity-info` CLI operation. Replace `ID` with one of the celebrity IDs displayed in [Recognizing celebrities in an image](celebrities-procedure-image.md). Replace the value of `profile-name` with the name of your developer profile.
...
#### [ Python ]
   ...
   Replace `id` with one of the celebrity IDs displayed in [Recognizing celebrities in an image](celebrities-procedure-image.md). Replace the value of `profile_name` in the line that creates the Rekognition session with the name of your developer profile.
