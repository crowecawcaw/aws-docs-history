...
As a managed service, Amazon Rekognition is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Rekognition through the network. Clients must
