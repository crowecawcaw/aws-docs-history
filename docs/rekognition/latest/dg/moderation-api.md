...
Custom Moderation adapters can be in one of the following statuses: TRAINING\_IN\_PROGRESS, TRAINING\_COMPLETED, TRAINING\_FAILED, DELETING, DEPRECATED, or EXPIRED. For a full explanation of these adapter statuses, see [Managing adapters](https://docs.aws.amazon.com/rekognition/latest/dg/managing-adapters.html).
