...
performance of Amazon Rekognition and your other AWS solutions. AWS provides the following monitoring
tools to watch Rekognition, report when something is wrong, and take automatic actions when
appropriate:
