...
**Topics**
+ [Creating a project and training an adapter](#using-adapters-tutorial-annotation)
+ [Bulk analysis, prediction verification, and training an adapter](#using-adapters-tuorial-annotation-bulk-analysis)
...
![Rekognition Custom Moderation interface showing no existing fine-tuned adapters and options to create a new project or search.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-1-landing-page.png)
...
![Form to enter project details including a project name, adapter name, and optional adapter description. Options to import training image dataset from a manifest file or S3 bucket.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-2-project-details.png)
...
![Image labeling interface with instructions, adapter details, and empty image panel.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-4-assign-labels-to-images.png)
...
![Interface showing 2 images with options to assign labels for categories like explicit nudity, suggestive content, violence, hate symbols, alcohol, drugs, tobacco, etc.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-5-labels-images-blurred.png)
...
![Bulk Analysis feature overview showing the workflow and listing recent Bulk Analysis jobs for Content Moderation using the base model.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-1-create-bulk-analysis.png)
...
![Bulk Analysis interface with dropdown menus to choose a Rekognition feature, adapter, set a job name and minimum confidence threshold for labels. Some fields are required.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-2-bulk-analysis-job.png)
...
![Bulk Analysis jobs table showing a job named "Evaluation 01" with status "Succeeded", using Content moderation Recognition API and Base model.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-3-bulk-analysis-status.png)
...
![The Bulk Analysis bar chart showing count of images flagged for various labels.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-4-bulk-analysis-complete.png)
...
![A panel prompting you to verify predictions to calculate false positive and negative rates, or train a custom moderation adapter for enhanced accuracy.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-6-start-verification.png)
...
![Three images depicting people holding alcoholic beverages, used to illustrate the "Alcohol" category prediction for image labels.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-7-verify-predictions-1.png)
...
![Image showing three examples of content moderation for alcohol, as well as a menu to apply labels.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-8-verify-predictions-2.png)
...
![Content Moderation verification page showing false positive rates for Explicit Nudity, Suggestive, and Alcohol labels at 50% confidence threshold.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-8.5-predictions-stats.png)
...
![Verify predictions page showing job details including name, creation date, model version, input and output locations. Train an adapter button is present.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-9-train-adapter.png)
...
![Interface for creating a new adapter project with fields to enter project name, adapter name, adapter description, specify test data source, and either autosplit data or import a manifest file.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-10-train-adapter-project.png)
...
![Configuration settings for an adapter, including options for adding tags, data encryption, confidence threshold, and auto-update. The adapter can be trained from this interface.](https://docs.aws.amazon.com/rekognition/latest/dg/images/BA-11-train-adapter.png)
...
![Custom Moderation landing page showing a list of moderation projects with details like status, adapter ID, input data location, base model version, date created, and status messages. Projects can be created, deleted, or resumed.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-7-status-alt.png)
...
![Interface for creating a new content moderation adapter or adding to an existing project, with options to name the adapter and project.](https://docs.aws.amazon.com/rekognition/latest/dg/images/adapters-9-create-new-adapter.png)
