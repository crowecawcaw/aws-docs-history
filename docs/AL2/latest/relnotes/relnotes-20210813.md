...
| systemtap-runtime-4.4-1.amzn2.0.2.x86_64       | ## Kernel updates Rebase kernel tupstream stable 4.14.243 CVEs fixed: <br>• CVE-2021-22543 [KVM: do not allow mapping valid but non-reference-counted pages] Amazon Features and Backports: <br>• In this update, an issue was addressed where an upstream change reverts to memory management. This issue caused significant regressions for some workloads. This issue is referred to as the revert "gup: document and work around "COW can break either way" issue". |
