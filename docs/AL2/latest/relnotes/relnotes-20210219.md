...
| net: ethernet: ti: cpts: Fixes ethtool output when no ptp_clock<br>registered   |
...
| crypto: ecdh<br>• Avoids buffer overflow in ecdh_set_secret()                   |
| x86/mm: Fixes leak of pmd ptlock                                                |
| KVM: x86: Fixes shift out of bounds reported by UBSAN                           |
| net: ip: Always refragment ip defragmented packets                              |
| x86/resctrl: Uses an IPI instead of task_work_add() to update PQR_ASSOC<br>MSR  |
...
| x86/entry/64/compat: Fixes x86/entry/64/compat: Preserve r8-r11 in int<br>$0x80 |
