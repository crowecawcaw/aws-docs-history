...
| net: ethernet: ti: cpts: Fixes ethtool output when no ptp\_clock<br>registered    |
...
| crypto: ecdh<br>• Avoids buffer overflow in ecdh\_set\_secret()                   |
| x86/mm: Fixes leak of pmd ptlock                                                  |
| KVM: x86: Fixes shift out of bounds reported by UBSAN                             |
| net: ip: Always refragment ip defragmented packets                                |
| x86/resctrl: Uses an IPI instead of task\_work\_add() to update PQR\_ASSOC<br>MSR |
