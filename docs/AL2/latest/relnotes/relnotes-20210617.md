...
- bpf: Wrapps aux data inside bpf_sanitize_info container
...
- perf: Makes perf_callchain function static
...
- perf/UAPI: Clearly markes \_\_PERF_SAMPLE_CALLCHAIN_EARLY as internal use
- perf/x86/intel: Doesn't allow precise_ip on BTS events
...
- perf/x86/intel: Adds event constraint for CYCLE_ACTIVITY.STALLS_MEM_ANY
- perf/x86/intel: Fixes rtm_abort_event encoding on Ice Lake
- x86/CPU: Adds more Icelake model numbers
- perf/ring_buffer: Fixes AUX software double buffering
...
- perf/core: Adds PERF_PMU_CAP_NO_EXCLUDE for exclusion incapable PMUs
- perf/x86/regs: Checks reserved bits
- perf/x86: Cleans up PEBS_XMM_REGS
- perf/x86: Removes pmu->pebs_no_xmm_regs
...
- tools x86 uapi asm: Syncs the pt_regs.h copy with the kernel sources
