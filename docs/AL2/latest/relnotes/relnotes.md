...
Cloud-init has been updated to version 18.2 to handle early initialization of the operating system. Cloud-init sets the default locale and instance hostname, and it generates SSH private keys and adds SSH keys into the user’s .ssh/authorized\_keys entry. It also establishes ephemeral mount points and configures the network devices.
...
<a name="major-updates-9-25-2018"></a>
