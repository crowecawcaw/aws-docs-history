...
AWS App Runner now offers improved features to manage the auto scaling resources in your account. With this release you can perform the following
tasks:
...
For more information, see [Managing App Runner automatic scaling](../dg/manage-autoscaling.md "../dg/manage-autoscaling.md") in
