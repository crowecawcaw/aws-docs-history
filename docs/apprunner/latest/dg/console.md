...
The **Connected accounts** page lists App Runner connections to source code repository providers in your account. You can scope the list down by using the filter text box. For more information about connected accounts, see [Managing App Runner connections](manage-connections.md).
...
The **Auto scaling configurations** page lists the auto scaling configurations that you have set up in your account. You can configure a few parameters to adjust auto scaling behavior and save them in different configurations that you can later assign to one or more App Runner services. You can scope the list down by using the filter text box. For more information about auto scaling configurations, see [Manage auto scaling for a service](manage-autoscaling.md#manage-autoscaling.manage).
