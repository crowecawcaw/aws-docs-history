...
with the ID of the operation that performs the deployment. This operation is either a [CreateService](../api/API_CreateService.md "../api/API_CreateService.md") call for the initial application deployment or a [StartDeployment](../api/API_StartDeployment.md "../api/API_StartDeployment.md") call
