...
Configuration files are applicable only to [services that are based on source code](service-source-code.md "service-source-code.md"). You can't use
configuration files with [image-based services](service-source-image.md "service-source-image.md").
...
The App Runner configuration file is a YAML file that's named `apprunner.yaml` in the [source directory](service-source-code.md#service-source-code.source-directory "service-source-code.md#service-source-code.source-directory") of your application’s repository. It provides build and runtime options for your
...
For examples of App Runner configuration files, see [App Runner configuration file examples](config-file-examples.md "config-file-examples.md"). For a complete reference guide, see [App Runner configuration file reference](config-file-ref.md "config-file-ref.md").

###### Topics

- [App Runner configuration file examples](config-file-examples.md "config-file-examples.md")
- [App Runner configuration file reference](config-file-ref.md "config-file-ref.md")
