...
- The IAM roles required by ECS Express Mode:
  `ecsTaskExecutionRole` for [Amazon ECS task execution](../../../AmazonECS/latest/developerguide/task_execution_IAM_role.md "../../../AmazonECS/latest/developerguide/task_execution_IAM_role.md") and
  `ecsInfrastructureRoleForExpressServices` for [ECS
  Express Mode infrastructure provisioning](../../../AmazonECS/latest/developerguide/express-service-getting-started.md#express-service-create-execution-role "../../../AmazonECS/latest/developerguide/express-service-getting-started.md#express-service-create-execution-role")
...
- An SSL/TLS certificate in [AWS Certificate Manager](../../../acm/latest/userguide/acm-overview.md "../../../acm/latest/userguide/acm-overview.md") (ACM) that matches your custom domain. [Request a public ACM certificate](../../../acm/latest/userguide/gs-acm-request-public.md "../../../acm/latest/userguide/gs-acm-request-public.md")
...
- **Container image requirement** — ECS Express Mode deploys a container image.
  ...
  to a registry such as Amazon Elastic Container Registry. Then deploy that image to ECS Express Mode. See [Migrating source-based deployments](#migration-source-based "#migration-source-based") for details on migrating source-based deployments.
...
![Architecture diagram showing migration from App Runner to ECS Express Mode using Route 53 weighted routing for gradual traffic shifting between the two services.](images/migration-image-based.png)
...
For custom domain details, see [Managing custom domain names for an App Runner service](manage-custom-domains.md "manage-custom-domains.md").
...
service using either the [AWS Management Console](../../../AmazonECS/latest/developerguide/express-service-first-run.md "../../../AmazonECS/latest/developerguide/express-service-first-run.md") or the [AWS CLI](../../../AmazonECS/latest/developerguide/express-service-getting-started.md "../../../AmazonECS/latest/developerguide/express-service-getting-started.md").
...
your service](../../../AmazonECS/latest/developerguide/express-custom-domain.md "../../../AmazonECS/latest/developerguide/express-custom-domain.md") in the _Amazon ECS Developer Guide_.

The following image shows an example of configuring the host header condition in the Application Load Balancer
listener rule.

![Console screenshot showing the Application Load Balancer listener rule with host header conditions configured for the ECS Express Mode service endpoint and custom domain.](images/migration-alb-host-header.png)
...
routing](../../../Route53/latest/DeveloperGuide/routing-policy-weighted.md "../../../Route53/latest/DeveloperGuide/routing-policy-weighted.md"). Weighted routing allows you to route traffic for the same hostname to multiple endpoints.
...
Service GitHub Action](https://github.com/aws-actions/amazon-ecs-deploy-express-service "https://github.com/aws-actions/amazon-ecs-deploy-express-service").

The migration workflow has three stages:

1. Build the container image using a [Dockerfile](../../../AmazonECS/latest/developerguide/create-container-image.md "../../../AmazonECS/latest/developerguide/create-container-image.md")
2. Push the image to a container registry such as [Amazon Elastic Container Registry](../../../AmazonECR/latest/userguide/what-is-ecr.md "../../../AmazonECR/latest/userguide/what-is-ecr.md")
3. Deploy the image to ECS Express Mode

The following diagram shows how this workflow works using GitHub Actions:

![Architecture diagram showing migration of a source-based App Runner service to ECS Express Mode using GitHub Actions for building container images, pushing to Amazon Elastic Container Registry, and deploying to ECS Express Mode.](images/migration-source-based.png)
...
- Create an [OpenID
  Connect (OIDC) provider](https://docs.github.com/en/actions/how-tos/secure-your-work/security-harden-deployments/oidc-in-aws "https://docs.github.com/en/actions/how-tos/secure-your-work/security-harden-deployments/oidc-in-aws") to allow GitHub Actions to assume an IAM role
- Create an [IAM
  role with ECS Express Mode](https://github.com/marketplace/actions/amazon-ecs-deploy-express-service-action-for-github-actions#github-actions-role "https://github.com/marketplace/actions/amazon-ecs-deploy-express-service-action-for-github-actions#github-actions-role") and [Amazon Elastic Container Registry permissions](../../../AmazonECR/latest/userguide/ECR_on_ECS.md "../../../AmazonECR/latest/userguide/ECR_on_ECS.md")
...
- [Create
  your first Express Mode service using the AWS CLI](../../../AmazonECS/latest/developerguide/express-getting-started-cli.md "../../../AmazonECS/latest/developerguide/express-getting-started-cli.md")
- [Create
  your first Amazon ECS Express Mode service in the console](../../../AmazonECS/latest/developerguide/express-getting-started-console.md "../../../AmazonECS/latest/developerguide/express-getting-started-console.md")
- [Updating
  resources outside of Express Mode](../../../AmazonECS/latest/developerguide/express-update-resources.md "../../../AmazonECS/latest/developerguide/express-update-resources.md")
- [Managing custom domain names for an App Runner service](manage-custom-domains.md "manage-custom-domains.md")
- [Amazon Route 53
  weighted routing](../../../Route53/latest/DeveloperGuide/routing-policy-weighted.md "../../../Route53/latest/DeveloperGuide/routing-policy-weighted.md")
