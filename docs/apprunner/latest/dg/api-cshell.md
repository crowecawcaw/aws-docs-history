...
- [Obtaining IAM permissions for AWS CloudShell](#api-cshell.permissions "#api-cshell.permissions")
- [Interacting with App Runner using AWS CloudShell](#api-cshell.call-apprunner "#api-cshell.call-apprunner")
- [Verifying your App Runner service using AWS CloudShell](#api-cshell.call-your-service "#api-cshell.call-your-service")
...
App Runner. For more information, see [How App Runner works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
...
When you [create an App Runner service](manage-create.md "manage-create.md"), App Runner creates a default domain for your service's website, and shows it in the
...
For example, after you create an App Runner service as described in [Getting started with App Runner](getting-started.md "getting-started.md"), run the following command in CloudShell:
...
![Browser window showing AWS CloudShell with a command to display the content of an App Runner service page](images/api-cshell-curl.png)
