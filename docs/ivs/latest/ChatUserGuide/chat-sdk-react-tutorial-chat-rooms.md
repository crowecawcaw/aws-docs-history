...
1. [Set Up a Local Authentication/Authorization Server](#chat-react-rooms-auth-server)

1. [Create a Chatterbox Project](#chat-react-rooms-chatterbox)

1. [Connect to a Chat Room](#chat-react-rooms-connect)

1. [Build a Token Provider](#chat-react-rooms-token-provider)

1. [Observe Connection Updates](#chat-react-rooms-connection-state)

1. [Create a Send Button Component](#chat-react-rooms-send-button)

1. [Create a Message Input](#chat-react-rooms-message-input)

1. [Next Steps](#chat-react-rooms-next-steps)

## Prerequisites
<a name="chat-react-rooms-prerequisites"></a>
+ Be familiar with TypeScript or JavaScript and the React Native library. If you're unfamiliar with React Native, learn the basics in [Intro to React Native](https://reactnative.dev/docs/tutorial).
...
See [Create a Chat Token](getting-started-chat-auth.md) in *Getting Started with Amazon IVS Chat*. As shown in the flowchart there, your server-side application is responsible for creating a chat token. This means your app must provide its own means of generating a chat token by requesting one from your server-side application.
...
You can integrate the Chat Client Messaging JS SDK via [Node Package Manager](https://www.npmjs.com/) or [Yarn Package Manager](https://yarnpkg.com/):
...
**Important**: You must use the same AWS region as the one in which you created the room in [Getting Started with Amazon IVS Chat](getting-started-chat-create-room.md). The API is an AWS regional service. For a list of supported regions and Amazon IVS Chat HTTPS service endpoints, see the [Amazon IVS Chat regions](https://docs.aws.amazon.com/general/latest/gr/ivs.html#ivs_region) page.
...
Now that you finished building a message bar for Chatterbox, proceed to Part 2 of this React Native tutorial, [Messages and Events](chat-sdk-react-tutorial-messages-events.md).