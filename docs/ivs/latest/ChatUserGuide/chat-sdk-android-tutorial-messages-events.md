...
1. [Create a UI for Sending Messages](#chat-android-messages-events-create_ui)

   1. [UI Main Layout](#create-ui-main-layout)

   1. [UI Abstracted Text Cell to Display Text Consistently](#create-ui-text-cell)

   1. [UI Left Chat Message](#create-ui-left-chat-message)

   1. [UI Right Chat Message](#create-ui-right-chat-message)

   1. [UI Additional Color Values](#create-ui-color-values)

1. [Apply View Binding](#chat-android-messages-events-view-binding)

1. [Manage Chat-Message Requests](#chat-android-messages-events-requests)

1. [Final Steps](#chat-android-messages-events-final-steps)
...
Be sure you have completed Part 1 of this tutorial, [Chat Rooms](chat-sdk-android-tutorial-chat-rooms.md).
