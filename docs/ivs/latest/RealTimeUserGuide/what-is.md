...
| AWS CLI            | Either: <br>• Appending `--region <aws-region>` to your CLI command. <br>• Putting the region in your local AWS configuration file.                                                                                                                                                                                                                                   | _Remember, regardless of the region in which a stage was created, you can stream to Amazon IVS from anywhere, and viewers can watch from anywhere._ |
