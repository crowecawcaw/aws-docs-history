...
| • `latest_thumbnail`        | object  | Yes         | Enumerated field that describes latest thumbnail output. This<br>is available only when the thumbnail configuration’s<br>`storage` includes<br>`LATEST`.                                                                                                                                                                                                                                                                         |
