...
- Receive events.
- Receive errors.
  **Latest version of Android broadcast SDK:** 1.36.0 ([Release Notes](release-notes.md#oct30-25-broadcast-android-ll "release-notes.md#oct30-25-broadcast-android-ll"))
