...
- Receive events.
- Receive errors.
  **Latest version of Android broadcast SDK:** 1.37.0 ([Release Notes](release-notes.md#dec05-25-broadcast-android-ll "release-notes.md#dec05-25-broadcast-android-ll"))
