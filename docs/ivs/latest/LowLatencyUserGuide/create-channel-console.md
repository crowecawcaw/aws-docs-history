...
![Create a channel using the IVS Console: Specify channel configuration in the Create Channel window.](https://docs.aws.amazon.com/ivs/latest/LowLatencyUserGuide/images/Accept_Default_Configuration.png)

1. If you want to auto-record to Amazon S3, continue with [Set Up to Auto-Record to Amazon S3 (Optional)](#getting-started-create-channel-console-record-s3) below. Otherwise, skip that and proceed directly to [Set Up to Auto-Record to Amazon S3 (Optional)](#getting-started-create-channel-console-record-s3).
...
![Create a channel using the IVS Console: Select Auto-record to Amazon S3.](https://docs.aws.amazon.com/ivs/latest/LowLatencyUserGuide/images/Select_Auto_Record.png)
...
![Create a channel using the IVS Console: Specify storage options for the recording configuration.](https://docs.aws.amazon.com/ivs/latest/LowLatencyUserGuide/images/Click_Create_Recording_Config.png)
...
![Create a channel using the IVS Console: New recording configuration created.](https://docs.aws.amazon.com/ivs/latest/LowLatencyUserGuide/images/Create_Recording_Config.png)
...
![Create a channel using the IVS Console: View channel stream, playback and recording configuration, and stream sessions in the Channel Details window.](https://docs.aws.amazon.com/ivs/latest/LowLatencyUserGuide/images/Final_Channel_Creation.png)
