...
**Latest version of JW Player integration:** 1.49.0 ([Release Notes](release-notes.md#feb19-26-player-web-ll "release-notes.md#feb19-26-player-web-ll"))
...
1. Include the following `script` tag (for the latest version of
   the player integration; in this case, 1.49.0):

```
<script src="https://player.live-video.net/1.49.0/amazon-ivs-jw-provider.min.js"></script>
```
...
Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.49.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.49.0/web/").
