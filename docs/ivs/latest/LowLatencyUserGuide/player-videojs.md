...
**Latest version of Video.js player integration:** 1.48.0
([Release
Notes](release-notes.md#dec18-25-player-web-ll "release-notes.md#dec18-25-player-web-ll"))
...
```
<script src="https://player.live-video.net/1.48.0/amazon-ivs-videojs-tech.min.js"></script>
```
...
For more information on these types, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/").
...
events, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/").
...
```
<script src="https://player.live-video.net/1.48.0/amazon-ivs-quality-plugin.min.js"></script>
```
...
- [Events](#videojs-events "#videojs-events") and [Errors](#videojs-errors "#videojs-errors") in this
  document.
- [Amazon
  IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.48.0/web/") for more information about events,
