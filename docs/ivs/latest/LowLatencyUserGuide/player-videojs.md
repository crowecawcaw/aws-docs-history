...
**Latest version of Video.js player integration:** 1.56.0
([Release
Notes](release-notes.md#sep03-26-player-web-ll "release-notes.md#sep03-26-player-web-ll"))
...
For more information on these types, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/").
...
events, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/").
...
- [Events](#videojs-events "#videojs-events") and [Errors](#videojs-errors "#videojs-errors") in this
  document.
- [Amazon
  IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.56.0/web/") for more information about events,
