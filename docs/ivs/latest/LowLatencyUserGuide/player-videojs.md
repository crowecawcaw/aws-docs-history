...
**Latest version of Video.js player integration:** 1.52.1
([Release
Notes](release-notes.md#may28-26-player-web-ll "release-notes.md#may28-26-player-web-ll"))
...
```
<script src="https://player.live-video.net/1.52.1/amazon-ivs-videojs-tech.min.js"></script>
```
...
For more information on these types, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/ "https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/").
...
events, see the [Amazon IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/ "https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/").
...
```
<script src="https://player.live-video.net/1.52.1/amazon-ivs-quality-plugin.min.js"></script>
```
...
- [Events](#videojs-events "#videojs-events") and [Errors](#videojs-errors "#videojs-errors") in this
  document.
- [Amazon
  IVS Player SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/ "https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/") for more information about events,
