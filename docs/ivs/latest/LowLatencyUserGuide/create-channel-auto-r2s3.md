...
For more information (including how to set up post-processing or VOD playback on your recorded files), see [IVS Auto-Record to Amazon S3 \| Low-Latency Streaming](record-to-s3.md).
