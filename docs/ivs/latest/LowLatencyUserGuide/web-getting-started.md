...
```
<script src="https://player.live-video.net/1.52.1/amazon-ivs-player.min.js"></script>
```
...
SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/ "https://aws.github.io/amazon-ivs-player-docs/1.52.1/web/").
...
```
importScripts('https://player.live-video.net/1.52.1/amazon-ivs-service-worker.min.js');
```
