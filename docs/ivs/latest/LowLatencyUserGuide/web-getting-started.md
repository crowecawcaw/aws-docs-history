...
SDK: Web Reference](https://aws.github.io/amazon-ivs-player-docs/1.53.0/web/ "https://aws.github.io/amazon-ivs-player-docs/1.53.0/web/").
...
```
importScripts('https://player.live-video.net/1.53.0/amazon-ivs-service-worker.min.js');
```
