...
**Topics**
+ [Patching recommendations](#acc-patching-recos)
+ [Create a patch maintenance window in AMS](acc-p-maint-window.md)
+ [Patch with hooks](acc-p-hooks.md)
+ [AMS Accelerate patch baseline](acc-patch-baseline.md)
+ [Creating an IAM role for on-demand patching of AMS Accelerate](acc-p-user-access.md)
+ [Understand patch notifications and patch failures in AMS Accelerate](acc-patch-mon-remediate.md)
