...
+ **AWS Regions:** The AWS Regions where your resources are located. For a list of AWS Regions, see [AWS services by Region](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/).
...
1. Update your configuration to turn on remediation for your selected Trusted Advisor checks, Compute Optimizer recommendations, and Security Hub CSPM recommendations. For instructions on how to select checks, see [Configure Trusted Advisor check remediation in Trusted Remediator](tr-configure-remediations.md).
