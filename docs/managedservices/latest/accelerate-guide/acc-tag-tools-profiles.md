...
+ **AWS::EC2::Instance**:
  + **AvailabilityZone**: The filter matches an EC2 instance in the specified availability zone. This field supports wildcard matching, so **\*a** matches us-east-1a, ap-northeast-1a, and so on.
