# Accelerate tags using AWS CloudFormation
...
To apply tags using AWS CloudFormation, you can apply tags at the stack level (see
...
instance managed by AWS CloudFormation:
...
Scaling group managed by AWS CloudFormation. Note that the Auto Scaling group will propagate its tags to
