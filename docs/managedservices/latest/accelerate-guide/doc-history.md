...
| --- |--- |--- |
| [Updated recommended patch tag names](https://docs.aws.amazon.com/managedservices/latest/accelerate-guide/acc-patching.html) | Changed the recommended patch tag names to remove spaces and added a note that whitespace in a tag key isn't compatible with instances that have IMDS tags enabled. | September 16, 2026 | 
