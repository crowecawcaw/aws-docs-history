...
**Topics**
+ [(Optional) Quick Start template in Accelerate](acc-quick-start.md)
+ [Onboarding Accelerate monitoring](acc-get-feature-monitoring-onboarding.md)
+ [Onboarding EC2 instances to Accelerate](acc-get-feature-ec2-onboarding.md)
+ [Onboarding AWS Backup in Accelerate](acc-get-feature-backup-onboarding.md)
+ [Onboarding patching in Accelerate](acc-get-feature-patching-onboarding.md)
+ [Review non-conformance reports in Accelerate](acc-get-feature-nonconformance.md)