...
| ------------------------------------- | ------------------------------------ | ---------------------------------------------------------------------------------------------------------------- |
| `aws_managedservices_onboarding_role` | AMS personnel during onboarding only | [onboarding\_role\_minimal.zip](samples/onboarding_role_minimal.zip.md "samples/onboarding_role_minimal.zip.md") |
