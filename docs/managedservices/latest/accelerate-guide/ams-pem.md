...
+ Use the PEM ID shared by your CSDM in the RFC/SR subject line in the format `{{PEM-ID}}`.
  ...
  Where applicable, you can use the [Live contact option](https://docs.aws.amazon.com/managedservices/latest/accelerate-guide/creating-a-sr.html).
...
+ SLAs and SLOs for PEM-related work items (Service Request, Incidents) are defined by AMS SLOs.
  ...
  For more information, see [Incident reports, service requests, and billing questions in AMS Accelerate](https://docs.aws.amazon.com/managedservices/latest/accelerate-guide/acc-supp-ex.html).
