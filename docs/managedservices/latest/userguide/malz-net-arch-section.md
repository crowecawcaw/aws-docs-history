...
[AMS multi-account landing zone environment basic components](ams-sd.md#basic-components-malz "ams-sd.md#basic-components-malz").
...
![AWS multi-account structure showing management, shared services, network, security, log archive, and application accounts with organizational units.](images/MALZ-high-level-Nov2022.png)
...
[Developer mode](developer-mode-section.md "developer-mode-section.md") accounts that provide you
