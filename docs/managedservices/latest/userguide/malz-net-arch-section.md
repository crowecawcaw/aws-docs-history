...
![AWS multi-account structure showing management, shared services, network, security, log archive, and application accounts with organizational units.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/MALZ-high-level-Nov2022.png)
