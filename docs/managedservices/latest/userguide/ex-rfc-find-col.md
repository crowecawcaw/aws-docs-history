...
![Filter menu showing options such as Subject, RFC ID, Activity state, and Creation time.](http://docs.aws.amazon.com/managedservices/latest/userguide/images/filterRfcAllOptions3.png)
