...
![Service requests page with filter dropdown, table headers, and Create service request button.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiSrCreateOpenPnC.png)

   If your service request list is empty, the **Clear filter** option resets the filter to **Any status**.  
![Service requests list showing multiple resolved requests with subjects, IDs, and status.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiSRlist2.png)
...
![Create a service request form with fields for Category, Subject, CC Emails, Details, and attachment option.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiServiceRequestCreate.png)
...
1. Enter information for:
   ...
   To add an attachment, choose **Add Attachment**, browse to the attachment you want, and click **Open**. To delete the attachment, click the Delete icon: ![](https://docs.aws.amazon.com/managedservices/latest/userguide/images/icon-delete-attachment.png).
...
![Service Request Detail page showing Type, Subject, Created date, ID, and Resolved status.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiSRdetail.png)
...
![Correspondence interface showing email exchange with star rating options for feedback.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiSRcorrespond.png)
