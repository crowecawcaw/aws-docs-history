...
![AWS Transit Gateway network diagram showing connections to VPCs and Direct Connect.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/malz-cent-edge.png)
