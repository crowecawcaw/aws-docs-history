...
**Topics**
+ [When to use a service request](service-request-when-to-use.md)
+ [How service request management works](service-request-resolution.md)
+ [Testing a service request in AMS](service-request-testing.md)
+ [Creating a service request in AMS](gui-ex-create-service-request.md)
+ [Monitoring and updating service requests in AMS](update-monitor-review-service-requests.md)
+ [Responding to an AMS-generated service requests](respond-to-sent-generated-sr.md)
