...
![Remote Desktop Connection dialog with computer field showing rdpbastion4.A12345678912.amazonaws.com.](http://docs.aws.amazon.com/managedservices/latest/userguide/images/ConnectToCustomerRDPBastionSmall.png)
...
![Windows Security credentials dialog with password field and options for smart card or alternate account.](http://docs.aws.amazon.com/managedservices/latest/userguide/images/ConnectRDPCredentialsDialogSmall.png)
...
![Remote Desktop Connection dialog with Computer field showing 10.0.0.100 and Connect button.](http://docs.aws.amazon.com/managedservices/latest/userguide/images/ConnectToWindowsStackInstanceSmall.png)
