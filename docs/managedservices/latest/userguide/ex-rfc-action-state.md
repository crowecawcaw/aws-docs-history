...
![RFC ActionState changes during the review, approval, and start of a manual change type with deferred scheduling](https://docs.aws.amazon.com/managedservices/latest/userguide/images/actionStateRfc.png)
