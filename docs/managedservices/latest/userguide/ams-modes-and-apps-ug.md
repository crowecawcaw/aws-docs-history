...
![Chart comparing AMS modes by time to operationalize and governance level.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/ams-modes-choosing-dcm.png)
