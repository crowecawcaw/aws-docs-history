...
| Default Maintenance Window Schedule Time Zone | The time zone that the default maintenance window runs<br>are based on, in Internet Assigned Numbers Authority (IANA) format. | For example:<br>• America/Los\_Angeles<br>• etc/UTC |
