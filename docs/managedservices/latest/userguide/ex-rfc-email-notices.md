...
![Add email addresses to receive notifications of RFC state changes.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/emailNoticeOption2.png)
