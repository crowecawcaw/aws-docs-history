...
![The Shared Services Subnet includes an active directory, an internal bastion, a management host, an EPS DSM, an EPS relay, and a controller.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/AMS_VPC_Shared_Services_diagram.png)
