...
![Multi-account AWS architecture with management, shared services, network, security, log archive, production, tools, and AWS accounts.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/high-level-diagram_v1.png)
