...
- _Customer-Requested Configuration_: Any software, services or other configurations that are not identified in:
  ...
  - AMS Advanced:
    [Supported Configurations](ams-sd.md#supported-configs "ams-sd.md#supported-configs") or
    [AMS Advanced; Service Description](ams-sd.md "ams-sd.md").
...
- _Supported patches_: AMS supports
  ...
  OSs, see [Support Configurations](../accelerate-guide/acc-sd.md#supported-configs "../accelerate-guide/acc-sd.md#supported-configs").
  **Security terms**:
