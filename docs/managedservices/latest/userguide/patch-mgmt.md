...
**Topics**
+ [AMS Patch Orchestrator: a tag-based patching model](patch-orchestrator.md)
+ [Using Patch Orchestrator](patch-orchestrator-using.md)
+ [On-demand patching](#patching-on-demand)
+ [AMS standard patching](patch-overview.md)
+ [Patching service commitments](patching-service-commitments.md)
...
For definitions of patching terms, see [AMS key terms](key-terms.md).
...
**Tip**  
AMS recommends that you enable backups for instances that have valuable applications or services. For information about enabling backups, see [Continuity management in AMS Advanced](continuity-mgmt.md).
...
For information about using this change type, see [On Demand Patching \| Run](https://docs.aws.amazon.com/managedservices/latest/ctref/management-patching-on-demand-patching-run.html).
