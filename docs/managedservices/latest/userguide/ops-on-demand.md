...
**Note**  
For definitions of key terms refer to the AWS Managed Services documentation [Key Terms](https://docs.aws.amazon.com/managedservices/latest/userguide/key-terms.html).
