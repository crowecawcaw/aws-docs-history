...
| Recovery point move to cold storage after days | recovery\_point\_move\_to\_cold\_storage\_after\_days | Number of days after completion date when backup snapshot is moved to cold storage | 
