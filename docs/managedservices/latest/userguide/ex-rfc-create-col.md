...
![](https://docs.aws.amazon.com/managedservices/latest/userguide/images/quickCreate1.png)


The following is the first page of the RFC Create process in the AMS console, with **Select by category** active:

![](https://docs.aws.amazon.com/managedservices/latest/userguide/images/guiRfcCreate1-2.png)
