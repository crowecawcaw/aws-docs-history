...
![Shared Services account architecture with three availability zones containing AD, bastions, and security resources.](https://docs.aws.amazon.com/managedservices/latest/userguide/images/malzSharedServicesAccount2.png)
