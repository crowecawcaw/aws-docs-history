...
AWS Managed Services (AMS) collates data from various native AWS services to provide value-added reports on major
AMS offerings.
...
- [On-request reports](on-request-reporting.md "on-request-reporting.md")
