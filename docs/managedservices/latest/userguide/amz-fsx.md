...
You must also share the Managed AD to the application account first. Do this by submitting an RFC with the Management \| Directory Service \| Directory \| Share directory change type (ct-369odosk0pd9w).
