...
AMS Advanced uses the service-linked role (SLR) named **AWSServiceRoleForManagedServices\_Events** – This role trusts one
...
The **AWSServiceRoleForManagedServices\_Events** service-linked role
trusts the following services to assume the role:

- events.managedservices.amazonaws.com

Attached to this role is the **AWSManagedServices\_EventsServiceRolePolicy** AWS managed
policy (see [AWS managed policy:
AWSManagedServices\_EventsServiceRolePolicy](../accelerate-guide/security-iam-awsmanpol.md#EventsServiceRolePolicy "../accelerate-guide/security-iam-awsmanpol.md#EventsServiceRolePolicy")). The service uses the
...
You can download the JSON **AWSManagedServices\_EventsServiceRolePolicy** in this ZIP:
...
AWSServiceRoleForManagedServices\_Events role in your account. To learn
...
AWSServiceRoleForManagedServices\_Events service-linked role. After you
...
AWSServiceRoleForManagedServices\_Events role. When you Offboard from AMS
...
by the AWSServiceRoleForManagedServices\_Events service-linked
role****

**To manually delete the service-linked role using IAM**

Use the IAM console, the AWS CLI, or the AWS API to delete the
AWSServiceRoleForManagedServices\_Events service-linked role.
