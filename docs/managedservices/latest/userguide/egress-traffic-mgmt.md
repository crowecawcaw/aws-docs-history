...
AMS has identified the corresponding AMS HTTP and HTTPS dependencies, and develops and refines these dependencies on an ongoing basis. See [egressMgmt.zip](samples/egressMgmt.zip). Along with the JSON file, the ZIP contains a README.
