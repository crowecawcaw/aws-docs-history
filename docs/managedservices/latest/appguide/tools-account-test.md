...
![Flowchart showing AMS ingestion steps from data center replication through AMI creation.](http://docs.aws.amazon.com/managedservices/latest/appguide/images/Ingestion_Process_v1.png)
