...
![WordPress installation page with fields for site title, username, password, and email.](https://docs.aws.amazon.com/managedservices/latest/appguide/images/wpFirstPage.png)
