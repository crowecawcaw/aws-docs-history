...
**Note**  
AMS is developing a video to help with cost optimization. The first step is providing you with a PDF and an Excel spreadsheet of cost optimization best practices. To access these resources, open the [Quick guide to cost optimization](samples/Resources_Quick_Guide_to_Cost_Optimization.zip) ZIP file.

## Cost optimization framework
<a name="ams-cost-opt-framework"></a>
...
1. Present a cost optimization plan to you

1. Assist in achieving cost optimization in a measurable way

### Identify cost optimization avenues in the managed environment
<a name="ams-cost-opt-id-avenues"></a>
...
<a name="ams-cost-opt-id-achieve"></a>
