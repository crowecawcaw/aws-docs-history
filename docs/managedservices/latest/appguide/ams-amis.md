...
[AMS's supported operating systems](../userguide/supported-configs.md "../userguide/supported-configs.md").
...
[AMS AMI notifications with SNS](../userguide/ams-ami-notifications.md "../userguide/ams-ami-notifications.md").
