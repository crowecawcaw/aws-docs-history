...
- **Supported resources** – Only AMS AWS CloudFormation ingest-supported resources are used.
...
The AWS CloudFormation Linter tool is the best way to validate your CloudFormation template as it provides validation for resource/property names, data types, and
...
To assist with offline validation of CloudFormation templates, AMS has developed a set of pluggable custom validation rules for the AWS CloudFormation Linter
...
1. Install the AWS CloudFormation Linter tool. For installation instructions, see
