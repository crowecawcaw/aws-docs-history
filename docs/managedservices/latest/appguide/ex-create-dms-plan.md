...
+ Migrate data from an on-prem MySQL server to Amazon RDS MySQL: See AWS blog post [ Migrate On-Premises MySQL Data to Amazon RDS (and back)](https://aws.amazon.com/blogs/aws/migrate-mysql-data-to-amazon-rds-and-back/)
+ Migrate data from an Oracle database to Amazon RDS Aurora PostgreSQL database: See AWS blog post [ A quick introduction to migrating from an Oracle database to an Amazon Aurora PostgreSQL database](https://aws.amazon.com/blogs/database/a-quick-introduction-to-migrating-from-an-oracle-database-to-an-amazon-aurora-postgresql-database/)
+ Migrate data from RDS MySQL to S3: See AWS blog post [How to archive data from relational databases to Amazon Glacier using AWS DMS](https://aws.amazon.com/blogs/database/archiving-data-from-relational-databases-to-amazon-glacier-via-aws-dms/)
