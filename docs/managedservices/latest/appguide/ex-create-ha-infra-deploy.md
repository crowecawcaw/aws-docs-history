...
1. Launch an S3 bucket
   ...
   1. Modify the schema as follows, you can delete and replace the contents. Replace {{VPC\_ID}} appropriately. The values in the example have been tested, but may not be right for you.
**Tip**  
