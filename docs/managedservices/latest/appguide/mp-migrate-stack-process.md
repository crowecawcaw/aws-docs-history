...
1. Migration partner, Migrate Individual Workloads:
   ...
   1. The migration partner submits an RFC with the Deployment \| Ingestion \| Stack from migration partner migrated instance \| Create CT (ct-257p9zjk14ija); for details on creating and submitting this RFC, see [Workload Ingest Stack: Creating](ams-workload-ingest.md#ex-workload-ingest-col).
