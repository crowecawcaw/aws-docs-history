...
![Multi-account AWS architecture with management, shared services, network, security, log archive, production, tools, and AWS accounts.](http://docs.aws.amazon.com/managedservices/latest/appguide/images/high-level-diagram_v1.png)
