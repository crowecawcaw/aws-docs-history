...
<a name="well-architected-aog"></a>

At AWS we believe that well-architected systems greatly increase the likelihood of business success. The [AWS Architecture Center](https://aws.amazon.com/architecture/) provides expert guidance on architecting in the AWS Cloud. 
...
[Are You Well-Architected?](https://aws.amazon.com/architecture/well-architected/): Introduces the AWS Well-Architected Framework, based around six pillars:
