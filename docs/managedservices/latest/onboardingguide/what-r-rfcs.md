...
1. In the Validation Stage, AMS reviews the RFC Request for completeness and correctness. AMS also evaluates the request for security in accordance with our [security technical standards](rfc-security.md). AMS validates that the requested change is valid and executable.
...
![The workflow of a customer-submitted RFC.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/requestForChange-v5g.png)
