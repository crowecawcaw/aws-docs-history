...
![Management account overview showing AMS Customer Region and various AWS services and features.](http://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/management-account.png)
