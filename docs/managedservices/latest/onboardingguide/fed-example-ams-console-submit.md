...
<a name="fed-example-ams-console-submit"></a>
...
1. From the same account where you created the service request, create a new RFC using CT-ID ct-1e1xtak34nx76 (Management \| Other \| Other \| Create) with the following information.
