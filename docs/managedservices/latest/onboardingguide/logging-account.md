...
![Log Archive Account diagram showing Aggregated CloudTrail Logs and Aggregated Config Logs icons.](http://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/malzLogAccount.png)
