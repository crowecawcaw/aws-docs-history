...
![SSH tunneling architecture showing remote user connecting through firewall to SSH server, then to RDP client, with AWS subnets containing bastion and application servers.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/SSH_Tunneling_Bastion_Generic.png)
...
![PuTTY Configuration window showing Session category with host name and port fields.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/sshBastionPutty.png)

1. In SSH ->Auth, set the private key file in .ppk format  
![PuTTY Configuration window showing SSH Auth section with private key file path field.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/sshBastionPutty2.png)
...
![PuTTY Configuration window showing SSH port forwarding setup with source port 5000 to destination 10.0.101.51:3389.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/sshBastionPutty3.png)

1. Connect to the bastion host via PuTTY and log in.  
![PuTTY terminal window showing successful SSH connection to the bastion host with login prompt.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/sshBastionConnect.png)

1. Start an RDP session to localhost:5000 to reach the destination server.  
![Remote Desktop Connection dialog with localhost:5000 in the Computer field and Connect button.](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/sshBastionConnect2.png)