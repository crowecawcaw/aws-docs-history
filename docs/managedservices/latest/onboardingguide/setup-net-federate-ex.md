...
This example uses Active Directory Federation Services (AD FS); however, any technology that supports AWS IAM Federation is
supported. For more information on AWS-supported IAM federation, see
...
[Appendix: AD FS claim rule and SAML settings](../userguide/apx-adfs-claim-rule-saml.md "../userguide/apx-adfs-claim-rule-saml.md").
