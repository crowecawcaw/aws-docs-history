...
1. Sign in to the AWS Management Console and open the CloudFormation console at [https://console.aws.amazon.com/cloudformation](https://console.aws.amazon.com/cloudformation/).
    ...
    ![](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/image1.png)

1. Choose **Create Stack**. You see the following page.

   ![](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/image2.png)
...
1. Choose **Upload a template file**, upload the JSON or YAML file of the IAM role, and then choose **Next**. You see the following page.
   ...
   ![](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/image3.png)
...
1. Enter **ams-onboarding-role** into the **Stack name** section and continue scrolling down and selecting next until you reach this page.
   ...
   ![](https://docs.aws.amazon.com/managedservices/latest/onboardingguide/images/image4.png)
