...
1. Submit a request for change (RFC) using the Management \| Managed account \| Direct Change mode \| Enable change type (ct-3rd4781c2nnhp). For an example walkthrough, see [Direct Change mode \| Enable](https://docs.aws.amazon.com/managedservices/latest/ctref/management-managed-direct-change-mode-enable.html).
