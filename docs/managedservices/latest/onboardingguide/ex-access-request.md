...
[Stack Admin Access | Update](../ctref/management-access-stack-admin-access-update.md "../ctref/management-access-stack-admin-access-update.md").
...
[ReadOnly access: requesting](../ctref/ex-access-ro-request-col.md "../ctref/ex-access-ro-request-col.md").
...
1. Output the execution parameters JSON schema for this change type to a file; this
   example names it GrantReadOnlyAccessParams.json:
...
can request up to twelve hours. 2. Output the RFC template to a file in your current folder; this example names it GrantReadOnlyAccessRfc.json:
...
4. Create the RFC, specifying the GrantReadOnlyAccessRfc file and the
   GrantReadOnlyAcessParams file:
...
You can submit an update to your access request before it expires. For details, see
[Stack Read-Only Access | Update](../ctref/management-access-stack-read-only-access-update.md "../ctref/management-access-stack-read-only-access-update.md").

To log into an instance that is part of an EC2 Auto Scaling group (ASG), you request access
to the ASG stack, which gives you access to all associated instances.

For a walkthrough on requesting Admin access, see
[Admin Access: requesting](../ctref/ex-access-admin-request-col.md "../ctref/ex-access-admin-request-col.md").
