...
1. Create and save a JSON file for the RFC parameters; example names it OtherRfc.json.
...
1. Create the RFC, specifying the OtherRfc file and the OtherParams file:
