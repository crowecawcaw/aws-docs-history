...
![IAM Roles console page showing role creation options and a searchable list of roles.](images/iamConsoleRoles.PNG) 2. Click **Create role**.
...
![Create role wizard showing Another AWS account option selected with account ID field.](images/iamConsoleCreateRole.PNG) 3. Click **Next: Permissions**.
...
![Policy list showing AdministratorAccess and AmazonAPIGateway policies with attachment counts.](images/iamConsoleCreateRolePermissionsDetail.PNG) 4. Select the **AdministratorAccess** policy and then click **Next: Review**.
