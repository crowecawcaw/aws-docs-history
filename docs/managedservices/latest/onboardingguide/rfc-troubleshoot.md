...
- Make sure the Username and FQDN you specified in the RFC are correct and exist in the domain. For help finding your FQDN, see
  [Finding your FQDN](../userguide/find-FQDN.md "../userguide/find-FQDN.md").
- Make sure the stack ID you specified for access is an EC2-related stack. Stacks such as
  ...
  [Finding stack IDs](../userguide/find-stack.md "../userguide/find-stack.md")
...
[Access management](../userguide/access-mgmt.md "../userguide/access-mgmt.md").
...
- If you are requesting permissions for a human user (instead of attaching the permissions
  ...
  on doing this, see
  [Temporary AMS Advanced console access](../userguide/access-console-temp.md "../userguide/access-console-temp.md").
...
[RFC Correspondence
and Attachment (Console)](../userguide/ex-rfc-correspondence.md "../userguide/ex-rfc-correspondence.md") and [Creating a
Service Request in AMS](../userguide/gui-ex-create-service-request.md "../userguide/gui-ex-create-service-request.md") for more details.
...
- To ask for information or advice, or for access to an AMS-managed IT service, or to request an additional service from AMS, use the AMS console and submit a
  service request. For details, see [Creating a Service Request](../userguide/gui-ex-create-service-request.md "../userguide/gui-ex-create-service-request.md").
  For general information about AMS service requests, see [Service Request Management](../userguide/mk-service-requests.md "../userguide/mk-service-requests.md").
