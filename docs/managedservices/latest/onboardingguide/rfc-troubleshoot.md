...
and Attachment (Console)](../userguide/ex-rfc-gui.md#ex-rfc-correspondence "../userguide/ex-rfc-gui.md#ex-rfc-correspondence").
...
- If you require assistance with an open RFC or an RFC which is completed but was incorrect, engage AMS through RFC bi-directional correspondence. For more information, see [RFC Correspondence and Attachment (Console)](../userguide/ex-rfc-gui.md#ex-rfc-correspondence "../userguide/ex-rfc-gui.md#ex-rfc-correspondence").
