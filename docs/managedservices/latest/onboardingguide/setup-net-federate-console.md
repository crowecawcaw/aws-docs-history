...
| AWSManagedServicesChangeManagementRole | Allows you to view the AMS infrastructure in the core accounts, file AWS Support tickets, and request some RFCs. | For the full list of the roles available under different accounts see [IAM user role in AMS](defaults-user-role.md "defaults-user-role.md") . |
