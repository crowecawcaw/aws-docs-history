...
**\***Operations On Demand (OOD) has an offering for customers using the Standard CM mode to manage
their changes through dedicated resourcing. For more details, see the [Operations on Demand catalog of offerings](../userguide/ood-catalog.md "../userguide/ood-catalog.md") and talk to your cloud service delivery manager (CSDM).
...
![Comparison of AMS modes showing governance and flexibility against time to operationalize.](images/ams-modes-choosing-dcm.png)
...
the need for operational readiness, select Customer Managed mode. With Customer Managed mode,
it could take you a longer time to operationalize you applications as you bear
the responsibility to establish people, processes, and tools to support operational capabilities such as
Incident Management, Configuration Management, Provisioning Management, Security Management, Patch Management, etc.
