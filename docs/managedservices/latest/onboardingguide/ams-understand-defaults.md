...
For an example of infrastructure costs, see
[Basic components](../userguide/ams-sd.md#basic-components "../userguide/ams-sd.md#basic-components").

Firewall rules are provided in [Set up your Firewall](setup-firewall.md "setup-firewall.md")
