...
[Change management](../userguide/ex-what-is.md "../userguide/ex-what-is.md").
...
through DCM, see
[Creating stacks using Direct Change mode](../userguide/dcm-creating-stacks.md "../userguide/dcm-creating-stacks.md").
