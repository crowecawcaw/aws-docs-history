...
| `CustomerApprovalId: Required`               | The AMS change type system and you,                                                                           | A notification is sent to you, and you must explicitly approve the RFC, either by responding to the notice, or running the [ApproveRfc](../ApiReference-cm/API_ApproveRfc.md "../ApiReference-cm/API_ApproveRfc.md") operation. |
