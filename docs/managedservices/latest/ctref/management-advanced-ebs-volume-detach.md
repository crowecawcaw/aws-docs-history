...
- For Linux instances, volumes can't be detached if managed by Logical Volume Manager (LVM). Only volumes with filesystem
  type "ext3", "ext4" and "xfs" can be detached from Linux instances using this change type.
- To learn more about Amazon EBS volumes, see [Amazon Elastic Block Store](https://aws.amazon.com/ebs/ "https://aws.amazon.com/ebs/").
  To learn more about Amazon EBS volumes, see [Amazon Elastic Block Store](https://aws.amazon.com/ebs/ "https://aws.amazon.com/ebs/").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2d55p1d7z6w3d](schemas.md#ct-2d55p1d7z6w3d-schema-section "schemas.md#ct-2d55p1d7z6w3d-schema-section").
