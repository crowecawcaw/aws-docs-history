...
<a name="management-managed-automated-iam-provisioning-with-read-write-permissions-update-custom-deny-list-managed-automation"></a>
...
**Full classification:** Management \| Managed account \| Automated IAM provisioning with read-write permissions \| Update custom deny list (managed automation)
...
<a name="management-managed-automated-iam-provisioning-with-read-write-permissions-update-custom-deny-list-managed-automation-info"></a>
...
<a name="management-managed-automated-iam-provisioning-with-read-write-permissions-update-custom-deny-list-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2r9xvd3sdsic0](schemas.md#ct-2r9xvd3sdsic0-schema-section).

## Example: Required Parameters
<a name="management-managed-automated-iam-provisioning-with-read-write-permissions-update-custom-deny-list-managed-automation-ex-min"></a>
...
<a name="management-managed-automated-iam-provisioning-with-read-write-permissions-update-custom-deny-list-managed-automation-ex-max"></a>
