...
![GuardDuty IPSet update interface showing description, ID, and version details.](images/guiGuardDutyIpSetUpdateRrCT.png)
How it works:
...
For more information about Amazon GuardDuty and creating IP sets, see [Amazon Guard​Duty](https://aws.amazon.com/guardduty/ "https://aws.amazon.com/guardduty/") and [CreateIPSet](../../../guardduty/latest/APIReference/API_CreateIPSet.md "../../../guardduty/latest/APIReference/API_CreateIPSet.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-07jzw8bzd2on7](schemas.md#ct-07jzw8bzd2on7-schema-section "schemas.md#ct-07jzw8bzd2on7-schema-section").
