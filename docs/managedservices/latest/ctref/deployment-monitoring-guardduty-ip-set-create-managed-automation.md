...
2. Modify and save the CreateGdIpSetParams file. For example, you can replace the contents with something like this:
...
To learn more about Amazon GuardDuty and creating IP sets, see
[Amazon Guard​Duty](https://aws.amazon.com/guardduty/ "https://aws.amazon.com/guardduty/") and
[CreateIPSet](../../../guardduty/latest/APIReference/API_CreateIPSet.md "../../../guardduty/latest/APIReference/API_CreateIPSet.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-08avsj2e9mc7g](schemas.md#ct-08avsj2e9mc7g-schema-section "schemas.md#ct-08avsj2e9mc7g-schema-section").
