...
![Console interface for attaching target instances to ALB and NLB groups without service interruption.](images/guiTarGroupAttachInstanceCT.png)
How it works:
...
[Schema for Change Type ct-3sk74t8igor0s](schemas.md#ct-3sk74t8igor0s-schema-section "schemas.md#ct-3sk74t8igor0s-schema-section").
