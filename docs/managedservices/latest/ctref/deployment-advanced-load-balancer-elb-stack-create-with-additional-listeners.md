...
<a name="deployment-advanced-load-balancer-elb-stack-create-with-additional-listeners"></a>
...
<a name="deployment-advanced-load-balancer-elb-stack-create-with-additional-listeners-info"></a>

### Create ELB load balancer with additional listeners
<a name="ex-elb-create-addl-listeners-col"></a>

#### Creating an Elastic Load Balancer (with additional listeners) with the Console
<a name="elb-create-addl-listeners-con"></a>
...
<a name="elb-create-addl-listeners-cli"></a>
...
1. Output the RFC template to a file in your current folder; this example names it CreateElbAlRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > CreateElbAlRfc.json
   ```

1. Modify and save the CreateElbAlRfc.json file. For example, you can replace the contents with something like this: 
...
1. Create the RFC, specifying the CreateElbAlRfc file and the CreateElbAlParams file:

   ```
   aws amscm create-rfc --cli-input-json file://CreateElbAlRfc.json --execution-parameters file://CreateElbAlParams.json
   ```
...
#### Tips
<a name="ex-elb-create-addl-listeners-tip"></a>
...
<a name="deployment-advanced-load-balancer-elb-stack-create-with-additional-listeners-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0ary07xiajwx4](schemas.md#ct-0ary07xiajwx4-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-load-balancer-elb-stack-create-with-additional-listeners-ex-min"></a>
...
<a name="deployment-advanced-load-balancer-elb-stack-create-with-additional-listeners-ex-max"></a>
