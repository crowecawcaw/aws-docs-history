...
<a name="management-advanced-route-53-resolver-disassociate-resolver-rules-from-vpc"></a>
...
<a name="management-advanced-route-53-resolver-disassociate-resolver-rules-from-vpc-info"></a>
...
![Console page showing disassociate resolver rules from VPC change type with ID, execution mode, and version details.](https://docs.aws.amazon.com/managedservices/latest/ctref/images/guiVpcDisassociateResolverRule.png)
...
<a name="management-advanced-route-53-resolver-disassociate-resolver-rules-from-vpc-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2pfarpvczsstr](schemas.md#ct-2pfarpvczsstr-schema-section).

## Example: Required Parameters
<a name="management-advanced-route-53-resolver-disassociate-resolver-rules-from-vpc-ex-min"></a>
...
<a name="management-advanced-route-53-resolver-disassociate-resolver-rules-from-vpc-ex-max"></a>
