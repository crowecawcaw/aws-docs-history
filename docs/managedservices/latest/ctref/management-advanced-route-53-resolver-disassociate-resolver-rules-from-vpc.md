...
![Console page showing disassociate resolver rules from VPC change type with ID, execution mode, and version details.](http://docs.aws.amazon.com/managedservices/latest/ctref/images/guiVpcDisassociateResolverRule.png)
