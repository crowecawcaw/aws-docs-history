...
![Change type details for starting an Amazon RDS database instance, including ID and version.](images/guiRdsDbStartCT.png)
How it works:
...
For information about RDS, see the
[RDS User Guide](../../../AmazonRDS/latest/UserGuide/Welcome.md "../../../AmazonRDS/latest/UserGuide/Welcome.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-3s3ik03uzw19t](schemas.md#ct-3s3ik03uzw19t-schema-section "schemas.md#ct-3s3ik03uzw19t-schema-section").
