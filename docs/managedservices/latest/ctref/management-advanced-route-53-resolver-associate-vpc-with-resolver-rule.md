...
<a name="management-advanced-route-53-resolver-associate-vpc-with-resolver-rule"></a>
...
<a name="management-advanced-route-53-resolver-associate-vpc-with-resolver-rule-info"></a>
...
<a name="management-advanced-route-53-resolver-associate-vpc-with-resolver-rule-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2pbqoffhclpek](schemas.md#ct-2pbqoffhclpek-schema-section).

## Example: Required Parameters
<a name="management-advanced-route-53-resolver-associate-vpc-with-resolver-rule-ex-min"></a>
...
<a name="management-advanced-route-53-resolver-associate-vpc-with-resolver-rule-ex-max"></a>
