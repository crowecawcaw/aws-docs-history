...
1. Create the RFC, specifying the EnableDevMode Rfc file and the EnableDevModeParams file:
...
For detailed information about the execution input parameters, see [Schema for Change Type ct-1opjmhuddw194](schemas.md#ct-1opjmhuddw194-schema-section).
