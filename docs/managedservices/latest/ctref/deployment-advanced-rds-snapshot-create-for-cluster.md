...
![Create RDS DB cluster Snapshot interface showing ID, execution mode, and description.](images/guiRdsDbClusterSnpshtCreateCT.png)
How it works:
...
[Schema for Change Type ct-2zqwr34epwzx1](schemas.md#ct-2zqwr34epwzx1-schema-section "schemas.md#ct-2zqwr34epwzx1-schema-section").
