...
# VPC \| Add Static Route (Managed Automation)
<a name="deployment-advanced-vpc-add-static-route-managed-automation"></a>

Create a static route on your route table inside a VPC.

**Full classification:** Deployment \| Advanced stack components \| VPC \| Add static route (managed automation)
...
<a name="deployment-advanced-vpc-add-static-route-managed-automation-info"></a>
...
<a name="deployment-advanced-vpc-add-static-route-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-06bwg93ukgg8t](schemas.md#ct-06bwg93ukgg8t-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-vpc-add-static-route-managed-automation-ex-min"></a>
...
<a name="deployment-advanced-vpc-add-static-route-managed-automation-ex-max"></a>
