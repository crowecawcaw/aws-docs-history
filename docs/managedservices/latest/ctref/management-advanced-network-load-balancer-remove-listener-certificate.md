...
<a name="management-advanced-network-load-balancer-remove-listener-certificate"></a>
...
<a name="management-advanced-network-load-balancer-remove-listener-certificate-info"></a>

### Remove NLB listener certificate
<a name="ex-nlb-listener-cert-remove-col"></a>

#### Removing a listener certificate from an NLB with the console
<a name="nlb-remove-listener-cert-con"></a>
...
<a name="nlb-remove-listener-cert-cli"></a>
...
1. Modify and save the RemoveNlbListenerCertParams file. For example:
...
1. Modify and save the RemoveNlbListenerCertRfc.json file. For example:
...
1. Create the RFC, specifying the RemoveNlbListenerCertRfc file and the RemoveNlbListenerCertParams file:
...
#### Tips
<a name="ex-nlb-listener-cert-remove-tip"></a>

 For information about listeners, see [ELB Listeners](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-listeners.html). 

## Execution Input Parameters
<a name="management-advanced-network-load-balancer-remove-listener-certificate-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3929xwf222jri](schemas.md#ct-3929xwf222jri-schema-section).

## Example: Required Parameters
<a name="management-advanced-network-load-balancer-remove-listener-certificate-ex-min"></a>
...
<a name="management-advanced-network-load-balancer-remove-listener-certificate-ex-max"></a>
