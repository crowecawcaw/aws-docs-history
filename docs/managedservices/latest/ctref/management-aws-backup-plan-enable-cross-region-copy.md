...
1. Output the execution parameters JSON schema for this change type to a JSON
   file; this example names it ConfigCrossRegionBackupPlanParams.json:
...
[Schema for Change Type ct-0fqo03yizfnw6](schemas.md#ct-0fqo03yizfnw6-schema-section "schemas.md#ct-0fqo03yizfnw6-schema-section").
