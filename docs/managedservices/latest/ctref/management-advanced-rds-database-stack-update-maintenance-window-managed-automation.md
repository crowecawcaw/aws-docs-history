...
<a name="management-advanced-rds-database-stack-update-maintenance-window-managed-automation"></a>
...
**Full classification:** Management \| Advanced stack components \| RDS database stack \| Update maintenance window (managed automation)
...
<a name="management-advanced-rds-database-stack-update-maintenance-window-managed-automation-info"></a>
...
<a name="management-advanced-rds-database-stack-update-maintenance-window-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-27jjy5wnrfef2](schemas.md#ct-27jjy5wnrfef2-schema-section).

## Example: Required Parameters
<a name="management-advanced-rds-database-stack-update-maintenance-window-managed-automation-ex-min"></a>
...
<a name="management-advanced-rds-database-stack-update-maintenance-window-managed-automation-ex-max"></a>
