...
- The first step to offboarding the AMS multi-account landing zone Application account is to submit the
  [Confirm offboarding](management-managed-application-account-confirm-offboarding.md#ex-man-lz-app-acct-confirm-offb-col "management-managed-application-account-confirm-offboarding.md#ex-man-lz-app-acct-confirm-offb-col") CT (ct-2wlfo2jxj2rkj) from the application account.
...
[Schema for Change Type ct-0vdiy51oyrhhm](schemas.md#ct-0vdiy51oyrhhm-schema-section "schemas.md#ct-0vdiy51oyrhhm-schema-section").
