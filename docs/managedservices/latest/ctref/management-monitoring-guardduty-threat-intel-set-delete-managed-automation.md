...
# GuardDuty Threat Intel Set | Delete (Managed Automation)

Use to delete an Amazon GuardDuty ThreatIntelSet instance which is a list of known malicious IP addresses.

**Full classification:** Management | Monitoring and notification | GuardDuty threat intel set | Delete (managed automation)
...
![Delete GuardDuty ThreatIntelSet interface showing description, ID, and version details.](images/guiGuardDutyThreatIntelSetDeleteRrCT.png)
How it works:
...
For more information about Amazon GuardDuty and Threat Intel sets, see [Amazon Guard​Duty](https://aws.amazon.com/guardduty/ "https://aws.amazon.com/guardduty/").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2qjqju7h67s7w](schemas.md#ct-2qjqju7h67s7w-schema-section "schemas.md#ct-2qjqju7h67s7w-schema-section").
