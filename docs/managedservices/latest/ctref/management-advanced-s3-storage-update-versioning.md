...
<a name="management-advanced-s3-storage-update-versioning"></a>
...
<a name="management-advanced-s3-storage-update-versioning-info"></a>
...
<a name="management-advanced-s3-storage-update-versioning-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2hh93eyzmwbkd](schemas.md#ct-2hh93eyzmwbkd-schema-section).

## Example: Required Parameters
<a name="management-advanced-s3-storage-update-versioning-ex-min"></a>
...
<a name="management-advanced-s3-storage-update-versioning-ex-max"></a>
