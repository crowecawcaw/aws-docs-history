...
<a name="management-advanced-security-group-revoke-ingress-rule"></a>
...
<a name="management-advanced-security-group-revoke-ingress-rule-info"></a>

### Revoke security group ingress rule
<a name="ex-sec-group-ingress-rule-revoke-col"></a>

#### Revoking a Security Group Ingress Rule with the Console
<a name="sec-group-ingress-rule-revoke-con"></a>
...
<a name="sec-group-ingress-rule-revoke-cli"></a>
...
1. Modify and save the RevokeSGIngressParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file named RevokeSGIngressRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > RevokeSGIngressRfc.json
   ```

1. Modify and save the RevokeSGIngressRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the RevokeSGIngressRfc file and the RevokeSGIngressParams file:
...
#### Tips
<a name="ex-sec-group-ingress-rule-revoke-tip"></a>

**Note**  
This change type is now at version 3.0.

## Execution Input Parameters
<a name="management-advanced-security-group-revoke-ingress-rule-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1vjbacfr4ufdv](schemas.md#ct-1vjbacfr4ufdv-schema-section).

## Example: Required Parameters
<a name="management-advanced-security-group-revoke-ingress-rule-ex-min"></a>
...
<a name="management-advanced-security-group-revoke-ingress-rule-ex-max"></a>
