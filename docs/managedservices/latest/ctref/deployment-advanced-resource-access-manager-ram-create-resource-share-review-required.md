# Resource Access Manager (RAM) | Create Resource Share (managed automation)
...
**Full classification:** Deployment | Advanced stack components | Resource Access Manager (RAM) | Create resource share (managed automation)
