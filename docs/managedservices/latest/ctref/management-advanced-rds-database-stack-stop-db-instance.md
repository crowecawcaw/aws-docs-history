...
![AMS Advanced console, create RFC section, change type details box for ct-2r2bffv9u6q4m: RDS Database Stack | Stop DB Instance.](images/guiRdsDbStopCT.png)
How it works:
...
- Seven days after being stopped, the DB instance is automatically re-started.
  Supported engines are: MariaDB, Microsoft SQL Server, MySQL, Oracle, PostgreSQL.
- You can't stop a DB instance that has a read replica, or that is a read replica.
- You can't stop a SQL Server DB instance with Multi-AZ feature enabled.
- This change type doesn't apply to Aurora MySQL and Aurora PostgreSQL. For Aurora clusters, use
  a Management | Advanced stack components | RDS database stack | Stop Aurora cluster (ct-37vqa0oggka3q) change type.

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2r2bffv9u6q4m](schemas.md#ct-2r2bffv9u6q4m-schema-section "schemas.md#ct-2r2bffv9u6q4m-schema-section").
