...
1. Output the execution parameters JSON schema for this change type to a file;
   this example names it DeregisterAmiParams.json:
...
To learn more about deregistering AMIs, see
[Deregister your Linux AMI](../../../AWSEC2/latest/UserGuide/deregister-ami.md "../../../AWSEC2/latest/UserGuide/deregister-ami.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-26vhhlj9jmlpf](schemas.md#ct-26vhhlj9jmlpf-schema-section "schemas.md#ct-26vhhlj9jmlpf-schema-section").
