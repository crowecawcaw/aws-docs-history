...
# EBS Volume \| Modify
<a name="management-advanced-ebs-volume-modify"></a>
...
<a name="management-advanced-ebs-volume-modify-info"></a>
...
<a name="management-advanced-ebs-volume-modify-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1wle0ai4en6km](schemas.md#ct-1wle0ai4en6km-schema-section).

## Example: Required Parameters
<a name="management-advanced-ebs-volume-modify-ex-min"></a>
...
<a name="management-advanced-ebs-volume-modify-ex-max"></a>
