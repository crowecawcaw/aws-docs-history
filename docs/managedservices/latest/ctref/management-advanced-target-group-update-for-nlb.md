...
<a name="management-advanced-target-group-update-for-nlb"></a>
...
<a name="management-advanced-target-group-update-for-nlb-info"></a>

### Update NLB target group
<a name="ex-tar-group-nlb-update-col"></a>

#### Updating a Target Group for a Network Load Balancer with the Console
<a name="tar-group-nlb-update-con"></a>
...
<a name="tar-group-nlb-update-cli"></a>
...
1. Modify and save the UpdateTgNlbParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template to a file in your current folder named UpdateTgNlbRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > UpdateTgNlbRfc.json
   ```

1. Modify and save the UpdateTgNlbRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the UpdateTgNlbRfc file and the UpdateTgNlbParams file:
...
#### Tips
<a name="ex-tar-group-nlb-update-tip"></a>
...
<a name="management-advanced-target-group-update-for-nlb-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1x66wvkjw2zp5](schemas.md#ct-1x66wvkjw2zp5-schema-section).

## Example: Required Parameters
<a name="management-advanced-target-group-update-for-nlb-ex-min"></a>
...
<a name="management-advanced-target-group-update-for-nlb-ex-max"></a>
