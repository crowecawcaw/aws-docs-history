...
![Update target group interface showing description, ID, and version for Network Load Balancer.](images/guiTarGroupNlbUpdateCT.png)
How it works:
...
Issue the create RFC command with execution parameters provided inline (escape quotation marks when providing execution
parameters inline), and then submit the returned RFC ID. For example, you can replace the contents with something like this:
...
[Schema for Change Type ct-1x66wvkjw2zp5](schemas.md#ct-1x66wvkjw2zp5-schema-section "schemas.md#ct-1x66wvkjw2zp5-schema-section").
