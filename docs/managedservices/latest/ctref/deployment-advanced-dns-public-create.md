...
# DNS (Public) \| Create
<a name="deployment-advanced-dns-public-create"></a>
...
<a name="deployment-advanced-dns-public-create-info"></a>

### Create public DNS Route 53
<a name="ex-dns-public-create-stack-col"></a>

#### Creating a public Route 53 hosted zone with the console
<a name="dns-public-create-con"></a>
...
<a name="dns-public-create-cli"></a>
...
1. Output the JSON template to a file in your current folder; this example names it CreateDnsPublicRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > CreateDnsPublicRfc.json
   ```

1. Modify and save the CreateDnsPublicRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the execution parameters file and the CreateDnsPublicRfc file:
...
#### Tips
<a name="ex-dns-public-create-stack-tip"></a>

**Note**  
To create a private Route 53 DNS stack, see [Create private DNS Route 53](https://docs.aws.amazon.com/managedservices/latest/ctref/ex-dns-private-create-stack-col.html). 
...
To update your public DNS stack after it's created, see [Update public DNS Route 53](https://docs.aws.amazon.com/managedservices/latest/ctref/ex-dns-public-update-stack-col.html). 

## Execution Input Parameters
<a name="deployment-advanced-dns-public-create-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0vzsr2nyraedl](schemas.md#ct-0vzsr2nyraedl-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-dns-public-create-ex-min"></a>
...
<a name="deployment-advanced-dns-public-create-ex-max"></a>
