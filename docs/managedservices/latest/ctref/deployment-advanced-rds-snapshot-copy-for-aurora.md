...
![Details of an Amazon RDS DB Cluster snapshot copy operation, including ID and execution mode.](images/guiRdsDbCopyAuroraSnapshotCT.png)
How it works:
...
2. Modify and save the execution parameters in the CopyRdsAuroraSnapshotParams.json file.
...
5. Copy the RFC, specifying the input CopyDBClusterSnapshotRfc.json file and the execution
   parameters file CopyDBClusterSnapshotParams.json:
...
For an overview of backing up and restoring Aurora clusters, see
[Backing up and restoring an Amazon Aurora DB cluster](../../../AmazonRDS/latest/AuroraUserGuide/BackupRestoreAurora.md "../../../AmazonRDS/latest/AuroraUserGuide/BackupRestoreAurora.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-19fdy7np55xiu](schemas.md#ct-19fdy7np55xiu-schema-section "schemas.md#ct-19fdy7np55xiu-schema-section").
