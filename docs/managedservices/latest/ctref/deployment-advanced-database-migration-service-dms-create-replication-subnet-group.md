...
<a name="deployment-advanced-database-migration-service-dms-create-replication-subnet-group"></a>
...
<a name="deployment-advanced-database-migration-service-dms-create-replication-subnet-group-info"></a>

### Create AWS DMS replication subnet group
<a name="ex-dms-rsg-create"></a>

#### Creating a AWS DMS replication subnet group with the console
<a name="dms-rsg-create-con"></a>

![DMS replication subnet group details showing ID, execution mode, version, and classification.](https://docs.aws.amazon.com/managedservices/latest/ctref/images/guiDmsCreateRepSubGroupCT.png)
...
1. Modify and save the execution parameters CreateDmsRsgParams.json file. For example, you can replace the contents with something like this:
...
1. Output the JSON template to a file in your current folder; this example names it CreateDmsRsgRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > CreateDmsRsgRfc.json
   ```

1. Modify and save the CreateDmsRsgRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the execution parameters file and the CreateDmsRsgRfc file:
...
#### Tips
<a name="ex-dms-rsg-create-tip"></a>
+ This CT fails if the `dms-vpc-role` IAM role doesn't exist in the account.
...
<a name="deployment-advanced-database-migration-service-dms-create-replication-subnet-group-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2q5azjd8p1ag5](schemas.md#ct-2q5azjd8p1ag5-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-database-migration-service-dms-create-replication-subnet-group-ex-min"></a>
...
<a name="deployment-advanced-database-migration-service-dms-create-replication-subnet-group-ex-max"></a>
