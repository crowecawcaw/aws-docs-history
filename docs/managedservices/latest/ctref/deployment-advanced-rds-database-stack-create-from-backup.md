...
![Console interface for creating an Amazon RDS instance from a backup, showing description and version details.](images/guiRdsStackCreateFromBackupCT.png)
How it works:
...
[Schema for Change Type ct-0pgvtw5rpcsb6](schemas.md#ct-0pgvtw5rpcsb6-schema-section "schemas.md#ct-0pgvtw5rpcsb6-schema-section").
