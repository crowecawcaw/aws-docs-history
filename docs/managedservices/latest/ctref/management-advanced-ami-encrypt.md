...
![Change type Encrypt AMI details showing ID, version 2.0, and automated execution mode.](images/guiAmiEncryptCT.png)
How it works:
...
To learn more about AWS AMI encryption, see [AMIs with Encrypted Snapshots](../../../AWSEC2/latest/UserGuide/AMIEncryption.md "../../../AWSEC2/latest/UserGuide/AMIEncryption.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-3u9yd8jznb2zd](schemas.md#ct-3u9yd8jznb2zd-schema-section "schemas.md#ct-3u9yd8jznb2zd-schema-section").
