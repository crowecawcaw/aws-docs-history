...
<a name="deployment-standard-high-availability-one-tier-stack-create-with-elb"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-with-elb-info"></a>

### High availability one-tier Stacks: Creating (with ELB)
<a name="ex-HA-1-tier-create-with-elb-col"></a>
...
<a name="ha-1-tier-create-with-elb-cli"></a>
...
1. Output the CreateRfc JSON template to a file in your current folder; example names it CreateOnetierElbStackRfc.json:
...
1. Create the RFC, specifying the CreateOnetierElbStackRfc.json file and the CreateOnetierElbStackParams.json execution parameters file:
...
#### Tips
<a name="ex-HA-1-tier-create-with-elb-tip"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-with-elb-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3w4lxdl3pqxob](schemas.md#ct-3w4lxdl3pqxob-schema-section).

## Example: Required Parameters
<a name="deployment-standard-high-availability-one-tier-stack-create-with-elb-ex-min"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-with-elb-ex-max"></a>
