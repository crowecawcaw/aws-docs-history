...
<a name="deployment-standard-high-availability-one-tier-stack-create"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-info"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-09t6q7j9v5hrn](schemas.md#ct-09t6q7j9v5hrn-schema-section).

## Example: Required Parameters
<a name="deployment-standard-high-availability-one-tier-stack-create-ex-min"></a>
...
<a name="deployment-standard-high-availability-one-tier-stack-create-ex-max"></a>
