...
<a name="management-other-other-update-review-required"></a>
...
<a name="management-other-other-update-review-required-info"></a>

### Update Other Other CTs
<a name="ex-other-other-update-col"></a>

#### Creating an Other Other Update RFC with the Console
<a name="other-other-update-con"></a>
...
<a name="other-other-update-cli"></a>
...
1. Modify and save the OtherUpdateParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template to a file in your current folder; this example names it OtherUpdateRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > OtherUpdateRfc.json
   ```

1. Modify and save the OtherUpdateRfc.json file. For example, you can replace the contents with something like this:.
...
1. Create the RFC, specifying the OtherUpdateRfc file and the OtherUpdateParams file:
...
<a name="management-other-other-update-review-required-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0xdawir96cy7k](schemas.md#ct-0xdawir96cy7k-schema-section).

## Example: Required Parameters
<a name="management-other-other-update-review-required-ex-min"></a>
...
<a name="management-other-other-update-review-required-ex-max"></a>
