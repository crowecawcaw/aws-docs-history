...
![AMS Resource Scheduler configuration panel showing ID, execution mode, and version details.](images/guiResSchedStateEnableCT.png)
How it works:
...
[Schema for Change Type ct-2wrvu4kca9xky](schemas.md#ct-2wrvu4kca9xky-schema-section "schemas.md#ct-2wrvu4kca9xky-schema-section").
