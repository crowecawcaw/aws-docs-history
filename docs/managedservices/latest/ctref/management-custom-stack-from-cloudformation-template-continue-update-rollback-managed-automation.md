...
<a name="management-custom-stack-from-cloudformation-template-continue-update-rollback-managed-automation"></a>
...
<a name="management-custom-stack-from-cloudformation-template-continue-update-rollback-managed-automation-info"></a>
...
<a name="management-custom-stack-from-cloudformation-template-continue-update-rollback-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-32r1igwrwag4i](schemas.md#ct-32r1igwrwag4i-schema-section).

## Example: Required Parameters
<a name="management-custom-stack-from-cloudformation-template-continue-update-rollback-managed-automation-ex-min"></a>
...
<a name="management-custom-stack-from-cloudformation-template-continue-update-rollback-managed-automation-ex-max"></a>
