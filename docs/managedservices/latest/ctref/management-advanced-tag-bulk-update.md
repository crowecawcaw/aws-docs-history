...
1. Output the RFC template to a file in your current folder. This example names it TagBulkUpdateAutoRfc.json. Note
...
- This change type is automated, so it typically runs more quickly than a managed automation change type; however, if your situation is
  unusual, you might want to use the managed automation change type for additional help. See
  [Tag | Bulk Update (managed automation)](management-advanced-tag-bulk-update-review-required.md "management-advanced-tag-bulk-update-review-required.md").
...
[Schema for Change Type ct-3047c34zuvswh](schemas.md#ct-3047c34zuvswh-schema-section "schemas.md#ct-3047c34zuvswh-schema-section").
