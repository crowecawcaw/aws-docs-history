...
# EC2 Instance Stack \| Update DeleteOnTermination (Managed Automation)
<a name="management-advanced-ec2-instance-stack-update-deleteontermination-managed-automation"></a>

Update the EBS volume DeleteOnTermination property of the specified EC2 instance devices.

**Full classification:** Management \| Advanced stack components \| EC2 instance stack \| Update DeleteOnTermination (managed automation)
...
<a name="management-advanced-ec2-instance-stack-update-deleteontermination-managed-automation-info"></a>
...
<a name="management-advanced-ec2-instance-stack-update-deleteontermination-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2aaaqid7asjy6](schemas.md#ct-2aaaqid7asjy6-schema-section).

## Example: Required Parameters
<a name="management-advanced-ec2-instance-stack-update-deleteontermination-managed-automation-ex-min"></a>
...
<a name="management-advanced-ec2-instance-stack-update-deleteontermination-managed-automation-ex-max"></a>
