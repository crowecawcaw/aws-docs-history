...
This change type has moved to v2.0 with the addition of new parameter options for the
KeyStatus parameter. You can now choose to cancel a KMS key deletion operation and enable or disable the key.
...
[Schema for Change Type ct-3ovo7px2vsa6n](schemas.md#ct-3ovo7px2vsa6n-schema-section "schemas.md#ct-3ovo7px2vsa6n-schema-section").
