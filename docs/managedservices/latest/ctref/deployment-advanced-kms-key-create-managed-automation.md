...
This change type is at v3.0. The required **KeyName** parameter has been replaced by an optional
**AliasName** parameter; KMS keys use aliases.
...
[Schema for Change Type ct-2epp05svrlwod](schemas.md#ct-2epp05svrlwod-schema-section "schemas.md#ct-2epp05svrlwod-schema-section").
