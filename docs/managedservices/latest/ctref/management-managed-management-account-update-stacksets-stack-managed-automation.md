...
# Management Account \| Update StackSets Stack (Managed Automation)
...
**Full classification:** Management \| Managed landing zone \| Management account \| Update StackSets stack (managed automation)
...
For detailed information about the execution input parameters, see [Schema for Change Type ct-1v9g9n30woc8h](schemas.md#ct-1v9g9n30woc8h-schema-section).
