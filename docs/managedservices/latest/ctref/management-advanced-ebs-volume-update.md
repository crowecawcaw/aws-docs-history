...
![Update EBS volumes interface showing description, ID, and version for modifying volume properties.](images/guiEbsUpdateCT.png)
How it works:
...
1. Output the execution parameters JSON schema for this change type to a file; this
   example names it UpdateEbsParams.json:
...
2. Modify and save the UpdateEbsParams file, retaining only the parameters that you
   want to change. For example, you can replace the contents with something like this:
...
[Creating a Request for change (RFC)](../userguide/ex-rfc-create-col.md "../userguide/ex-rfc-create-col.md"); for an explanation of common RFC parameters, see
...
[Schema for Change Type ct-2y6q4vco4miyp](schemas.md#ct-2y6q4vco4miyp-schema-section "schemas.md#ct-2y6q4vco4miyp-schema-section").
