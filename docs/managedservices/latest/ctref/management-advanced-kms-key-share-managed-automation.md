...
# KMS Key \| Share (Managed Automation)
...
**Full classification:** Management \| Advanced stack components \| KMS key \| Share (managed automation)
...
For detailed information about the execution input parameters, see [Schema for Change Type ct-05yb337abq3x5](schemas.md#ct-05yb337abq3x5-schema-section).
