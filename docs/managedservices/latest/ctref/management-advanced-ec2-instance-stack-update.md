...
![Change type details for updating EC2 stack, including description, ID, version, and execution mode.](images/guiEc2UpdateCT.png)
How it works:
...
To learn more about Amazon EC2, including size recommendations, see [Amazon Elastic Compute Cloud Documentation](https://aws.amazon.com/documentation/ec2/ "https://aws.amazon.com/documentation/ec2/").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-38s4s4tm4ic4u](schemas.md#ct-38s4s4tm4ic4u-schema-section "schemas.md#ct-38s4s4tm4ic4u-schema-section").
