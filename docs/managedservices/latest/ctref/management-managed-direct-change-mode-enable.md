...
<a name="management-managed-direct-change-mode-enable"></a>
...
<a name="management-managed-direct-change-mode-enable-info"></a>

### Enable Direct Change mode
<a name="ex-man-acct-dir-change-mode-enable-col"></a>

#### Enabling Direct Change mode with the Console
<a name="ex-man-acct-dir-change-mode-enable-con"></a>
...
<a name="ex-man-acct-dir-change-mode-enable-cli"></a>
...
1. Output the execution parameters JSON schema for this change type to a file; this example names it EnableDCMParams.json.
   ...
   ```
   aws amscm get-change-type-version --change-type-id "ct-3rd4781c2nnhp" --query "ChangeTypeVersion.ExecutionInputSchema" --output text > EnableDCMParams.json
   ```

1. Modify and save the EnableDCMParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file named EnableDCMRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > EnableDCMRfc.json
   ```

1. Modify and save the EnableDCMRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the EnableDCMRfc file and the EnableDCMParams file:
...
#### Tips
<a name="ex-man-acct-dir-change-mode-enable-tip"></a>

 For information about Direct Change mode, see [Direct Change Mode](https://docs.aws.amazon.com/managedservices/latest/userguide/direct-change-mode-section.html). 

## Execution Input Parameters
<a name="management-managed-direct-change-mode-enable-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3rd4781c2nnhp](schemas.md#ct-3rd4781c2nnhp-schema-section).

## Example: Required Parameters
<a name="management-managed-direct-change-mode-enable-ex-min"></a>
...
<a name="management-managed-direct-change-mode-enable-ex-max"></a>
