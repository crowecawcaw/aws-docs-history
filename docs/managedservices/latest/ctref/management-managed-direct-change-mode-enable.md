...
![Console interface showing details for enabling Direct Change mode in AWS Management.](images/guiManAcctDirChangeModeEnableCT.png)
How it works:
...
For information about Direct Change mode, see
[Direct Change Mode](../userguide/direct-change-mode-section.md "../userguide/direct-change-mode-section.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-3rd4781c2nnhp](schemas.md#ct-3rd4781c2nnhp-schema-section "schemas.md#ct-3rd4781c2nnhp-schema-section").
