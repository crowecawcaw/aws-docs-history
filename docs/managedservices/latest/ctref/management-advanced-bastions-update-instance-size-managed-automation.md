...
1. Output the execution parameters JSON schema for this change type to a JSON file;
   this example names it UpdateBastionInstSizeParams.json:
...
[Schema for Change Type ct-2x14cv67uym46](schemas.md#ct-2x14cv67uym46-schema-section "schemas.md#ct-2x14cv67uym46-schema-section").
