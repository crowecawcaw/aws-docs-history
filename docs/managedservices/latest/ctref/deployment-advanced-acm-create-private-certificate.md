...
![Create Public ACM Certificate change type showing ID, execution mode as Automated, and version 2.0.](images/guiAcmCreatePrivateCT.png)
How it works:
...
[Schema for Change Type ct-0hu3q3957aghj](schemas.md#ct-0hu3q3957aghj-schema-section "schemas.md#ct-0hu3q3957aghj-schema-section").
