...
1. Output the execution parameters JSON schema for this change type to a
   JSON file; this example names it DeleteRecoveryPointsParams.json:
...
This CT is now at version 2.0. This reflects development to allow you to delete more than one recovery point at a
time.
...
[Schema for Change Type ct-1r1vbr8ahr156](schemas.md#ct-1r1vbr8ahr156-schema-section "schemas.md#ct-1r1vbr8ahr156-schema-section").
