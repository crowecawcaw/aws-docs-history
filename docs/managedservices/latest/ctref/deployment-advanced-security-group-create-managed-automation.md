...
<a name="deployment-advanced-security-group-create-managed-automation"></a>
...
<a name="deployment-advanced-security-group-create-managed-automation-info"></a>
...
<a name="deployment-advanced-security-group-create-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1oxx2g2d7hc90](schemas.md#ct-1oxx2g2d7hc90-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-security-group-create-managed-automation-ex-min"></a>
...
<a name="deployment-advanced-security-group-create-managed-automation-ex-max"></a>
