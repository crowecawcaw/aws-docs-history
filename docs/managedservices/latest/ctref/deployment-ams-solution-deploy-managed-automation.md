...
<a name="deployment-ams-solution-deploy-managed-automation"></a>
...
**Full classification:** Deployment \| AMS patterns \| Solution \| Deploy (managed automation)
...
<a name="deployment-ams-solution-deploy-managed-automation-info"></a>
...
<a name="deployment-ams-solution-deploy-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2jndrh7uit8uf](schemas.md#ct-2jndrh7uit8uf-schema-section).

## Example: Required Parameters
<a name="deployment-ams-solution-deploy-managed-automation-ex-min"></a>
...
<a name="deployment-ams-solution-deploy-managed-automation-ex-max"></a>
