...
1. Modify and save the ConfigCrossAcctCopyBackupPlanParams file.
...
1. Output the RFC template to a file in your current folder; this example names it ConfigCrossAcctCopyBackupPlanRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > ConfigCrossAcctCopyBackupPlanRfc.json
   ```

1. Modify and save the ConfigCrossAcctCopyBackupPlanRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the ConfigCrossAcctCopyBackupPlanRfc file and the ConfigCrossAcctCopyBackupPlanParams file:
...
For detailed information about the execution input parameters, see [Schema for Change Type ct-2yja7ihh30ply](schemas.md#ct-2yja7ihh30ply-schema-section).
