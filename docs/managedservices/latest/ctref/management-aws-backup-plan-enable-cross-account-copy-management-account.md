...
quotes when providing execution parameters inline), and then submit the returned RFC ID. For example, you can replace the contents with something like this:
...
1. Output the execution parameters JSON schema for this change type to a JSON
   file; this example names it ConfigCrossAcctCopyBackupPlanParams.json:
...
[Schema for Change Type ct-2yja7ihh30ply](schemas.md#ct-2yja7ihh30ply-schema-section "schemas.md#ct-2yja7ihh30ply-schema-section").
