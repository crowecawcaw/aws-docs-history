...
<a name="management-advanced-vpc-endpoint-update-policy-managed-automation"></a>
...
**Full classification:** Management \| Advanced stack components \| VPC endpoint \| Update policy (managed automation)
...
<a name="management-advanced-vpc-endpoint-update-policy-managed-automation-info"></a>
...
<a name="management-advanced-vpc-endpoint-update-policy-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-128mp7mbxobd0](schemas.md#ct-128mp7mbxobd0-schema-section).

## Example: Required Parameters
<a name="management-advanced-vpc-endpoint-update-policy-managed-automation-ex-min"></a>
...
<a name="management-advanced-vpc-endpoint-update-policy-managed-automation-ex-max"></a>
