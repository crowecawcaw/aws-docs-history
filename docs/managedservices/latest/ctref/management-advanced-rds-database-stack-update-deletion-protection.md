...
![Change DeletionProtection setting for RDS instance or cluster page showing ID, execution mode, version, classification, and description fields.](images/guiRdsStackUpdateDelProCT.png)
How it works:
...
You receive the ID of the new RFC in the response and can use it to submit and monitor the RFC. Until you submit it, the RFC remains in the editing state and does not start. 6. The execution output indicates the action taken: enabled or disabled.
...
[Schema for Change Type ct-2syhk4sr7cvyw](schemas.md#ct-2syhk4sr7cvyw-schema-section "schemas.md#ct-2syhk4sr7cvyw-schema-section").
