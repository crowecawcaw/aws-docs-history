...
![AMS Advanced console, create RFC section, change type details box for ct-3nba0wtdugnan: Create DNS conditional forwarders.](images/guiDirservCondForwardCreateCT.png)
How it works:
...
[Schema for Change Type ct-3nba0wtdugnan](schemas.md#ct-3nba0wtdugnan-schema-section "schemas.md#ct-3nba0wtdugnan-schema-section").
