...
<a name="deployment-directory-dns-create-conditional-forwarder"></a>
...
<a name="deployment-directory-dns-create-conditional-forwarder-info"></a>

### Create DNS conditional forwarder
<a name="ex-dirserv-cond-forward-create-col"></a>

#### Creating DNS conditional forwarders with the console
<a name="dirserv-cond-forward-create-con"></a>
...
<a name="dirserv-cond-forward-create-cli"></a>
...
1. Output the execution parameters JSON schema for this change type to a file; this example names it CondForwardCreateParams.json:
   ...
   ```
   aws amscm get-change-type-version --change-type-id "ct-3nba0wtdugnan" --query "ChangeTypeVersion.ExecutionInputSchema" --output text > CondForwardCreateParams.json
   ```
...
1. Output the RFC template to a file in your current folder; this example names it CondForwardCreateRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > CondForwardCreateRfc.json
   ```

1. Modify and save the CondForwardCreateRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the CondForwardCreateRfc file and the CondForwardCreateParams file:
...
#### Tips
<a name="ex-dirserv-cond-forward-create-tip"></a>

## Execution Input Parameters
<a name="deployment-directory-dns-create-conditional-forwarder-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3nba0wtdugnan](schemas.md#ct-3nba0wtdugnan-schema-section).

## Example: Required Parameters
<a name="deployment-directory-dns-create-conditional-forwarder-ex-min"></a>
...
<a name="deployment-directory-dns-create-conditional-forwarder-ex-max"></a>
