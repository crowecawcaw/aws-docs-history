...
![Change type details for rebooting an EC2 instance, including ID and version.](images/guiEc2RebootCT.png)
How it works:
...
1. Output the RFC template to a file in your current folder. This example names it RebootEC2Rfc.json. Note
...
For information about EC2, see the
[EC2 Documentation](../../../ec2.md "../../../ec2.md") for your operation system.

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-09qbhy7kvtxqw](schemas.md#ct-09qbhy7kvtxqw-schema-section "schemas.md#ct-09qbhy7kvtxqw-schema-section").
