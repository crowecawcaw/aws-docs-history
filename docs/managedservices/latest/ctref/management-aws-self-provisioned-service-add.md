...
<a name="management-aws-self-provisioned-service-add"></a>
...
<a name="management-aws-self-provisioned-service-add-info"></a>

### Add Self-Service Provisioning service
<a name="ex-aws-service-self-serve-add-auto-col"></a>

#### Adding an AMS self-provisioned AWS service with the console
<a name="self-serve-add-auto-con"></a>
...
<a name="self-serve-add-auto-cli"></a>
...
1. Output the execution parameters for this change type to a JSON file named AddSspsParameters.json.
...
1. Output the RFC template to a file in your current folder; this example names it AddSspsRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > AddSspsRfc.json
   ```

1. Modify and save the AddSspsRfc.json file. For example, you can replace the contents with something like this:
...
#### Tips
<a name="ex-aws-service-self-serve-add-auto-tip"></a>
+ The **ServiceName** field in the console lists the self-provisioned services supported by this CT. Limited to AMS-approved AWS services. For a list, see [ Setting Up Self-serve Services](https://docs.aws.amazon.com/managedservices/latest/userguide/self-service-provisioning.html).
+ For self-provisioned services not supported by this CT, or for deployment with custom parameters, use the manual version: Management \| AWS service \| [ Self-Provisioned Service \| Add (managed automation)](https://docs.aws.amazon.com/managedservices/latest/ctref/management-aws-self-provisioned-service-add-review-required.html) (ct-3qe6io8t6jtny).

## Execution Input Parameters
<a name="management-aws-self-provisioned-service-add-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1w8z66n899dct](schemas.md#ct-1w8z66n899dct-schema-section).

## Example: Required Parameters
<a name="management-aws-self-provisioned-service-add-ex-min"></a>
...
<a name="management-aws-self-provisioned-service-add-ex-max"></a>
