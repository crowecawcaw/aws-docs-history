...
[Stack Read-Only Access | Update](management-access-stack-read-only-access-update.md "management-access-stack-read-only-access-update.md").
...
[Admin Access: requesting](ex-access-admin-request-col.md "ex-access-admin-request-col.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-199h35t7uz6jl](schemas.md#ct-199h35t7uz6jl-schema-section "schemas.md#ct-199h35t7uz6jl-schema-section").
