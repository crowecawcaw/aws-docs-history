...
- To create an SSM patch baseline, see
  [SSM Patch Window | Create](deployment-patching-ssm-patch-window-create.md "deployment-patching-ssm-patch-window-create.md").

To update a custom Maintenance Window, see
[Updating an SSM Patch Window](ex-patch-window-update-col.md "ex-patch-window-update-col.md").
...
[Schema for Change Type ct-0el2j07llrxs7](schemas.md#ct-0el2j07llrxs7-schema-section "schemas.md#ct-0el2j07llrxs7-schema-section").
