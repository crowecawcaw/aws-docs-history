...
1. Output the execution parameters JSON schema for this change type to a file; this example names it
   ClusterPermissionsUpdateParams.json:
...
For additional information, see [DirectoryService section](../../../parallelcluster/latest/ug/DirectoryService-v3.md "../../../parallelcluster/latest/ug/DirectoryService-v3.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-03ytgoevfebjr](schemas.md#ct-03ytgoevfebjr-schema-section "schemas.md#ct-03ytgoevfebjr-schema-section").
