...
<a name="deployment-advanced-database-migration-service-dms-create-target-endpoint-s3"></a>
...
<a name="deployment-advanced-database-migration-service-dms-create-target-endpoint-s3-info"></a>
...
![Change type details showing ID, version 1.0, and automated execution mode for creating DMS target endpoint for S3.](https://docs.aws.amazon.com/managedservices/latest/ctref/images/guiDmsCreateTargetEpS3CT.png)
...
<a name="deployment-advanced-database-migration-service-dms-create-target-endpoint-s3-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-05muqzievnxk5](schemas.md#ct-05muqzievnxk5-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-database-migration-service-dms-create-target-endpoint-s3-ex-min"></a>
...
<a name="deployment-advanced-database-migration-service-dms-create-target-endpoint-s3-ex-max"></a>
