...
<a name="management-managed-dns-migrate-to-route-53-managed-automation"></a>
...
**Full classification:** Management \| Managed account \| DNS \| Migrate to Route 53 (managed automation)
...
<a name="management-managed-dns-migrate-to-route-53-managed-automation-info"></a>
...
<a name="management-managed-dns-migrate-to-route-53-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2tqi3kjcusen4](schemas.md#ct-2tqi3kjcusen4-schema-section).

## Example: Required Parameters
<a name="management-managed-dns-migrate-to-route-53-managed-automation-ex-min"></a>
...
<a name="management-managed-dns-migrate-to-route-53-managed-automation-ex-max"></a>
