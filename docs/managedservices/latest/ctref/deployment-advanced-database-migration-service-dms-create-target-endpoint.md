...
- AMS DMS can use S3 or any Relational Database Service (RDS) with MySQL, MariaDB, Oracle, Postgresql, or Microsoft SQL as a
  target endpoint. For an S3 target endpoint, see [DMS target endpoint for S3: creating](deployment-advanced-database-migration-service-dms-create-target-endpoint-s3.md#ex-dms-te-s3-create-col "deployment-advanced-database-migration-service-dms-create-target-endpoint-s3.md#ex-dms-te-s3-create-col").
...
[Schema for Change Type ct-3gf8dolbo8x9p](schemas.md#ct-3gf8dolbo8x9p-schema-section "schemas.md#ct-3gf8dolbo8x9p-schema-section").
