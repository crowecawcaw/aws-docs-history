...
<a name="management-advanced-identity-and-access-management-iam-delete-entity-or-policy-managed-automation"></a>
...
<a name="management-advanced-identity-and-access-management-iam-delete-entity-or-policy-managed-automation-info"></a>

### Delete IAM entity or policy
<a name="ex-iam-resource-delete-col"></a>
...
<a name="iam-resource-delete-cli"></a>
...
1. Modify and save the DeleteIamResourceParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file; this example names it DeleteIamResourceRfc.json:
...
#### Tips
<a name="ex-iam-resource-delete-tip"></a>
...
<a name="management-advanced-identity-and-access-management-iam-delete-entity-or-policy-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-30j78u6li9aqr](schemas.md#ct-30j78u6li9aqr-schema-section).

## Example: Required Parameters
<a name="management-advanced-identity-and-access-management-iam-delete-entity-or-policy-managed-automation-ex-min"></a>
...
<a name="management-advanced-identity-and-access-management-iam-delete-entity-or-policy-managed-automation-ex-max"></a>
