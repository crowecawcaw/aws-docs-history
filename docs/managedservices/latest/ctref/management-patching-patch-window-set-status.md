...
![Set Patch Window Status page showing description, ID ct-3vfxkiudtovm9, and version 1.0.](images/guiPatchWindowSetStatusCT.png)
How it works:
...
To learn more about doing this, see
...
[Schema for Change Type ct-3vfxkiudtovm9](schemas.md#ct-3vfxkiudtovm9-schema-section "schemas.md#ct-3vfxkiudtovm9-schema-section").
