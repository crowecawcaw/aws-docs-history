...
![Form to update an existing schedule in AMS Resource Scheduler, showing ID and version fields.](images/guiResSchedScheduleUpdateCT.png)
How it works:
...
[Schema for Change Type ct-3u61cd4edns0x](schemas.md#ct-3u61cd4edns0x-schema-section "schemas.md#ct-3u61cd4edns0x-schema-section").
