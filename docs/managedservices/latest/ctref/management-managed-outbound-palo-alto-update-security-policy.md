...
|                             |                  |
| --------------------------- | ---------------- |
| Change type ID              | ct-0mss4i7neuj7f |
| Current version             | 1.0              |
...
![Details of an "Update Security Policy" change type for AMS managed Palo Alto firewall.](images/guiManFwPaUpdateSpCT.png)
How it works:
...
```
aws amscm get-change-type-version --change-type-id "ct-0mss4i7neuj7f" --query "ChangeTypeVersion.ExecutionInputSchema" --output text > UpdateSecurityPolicyParams.json
```
...
```
aws amscm create-rfc --cli-input-json file://UpdateSecurityPolicyRfc.json  --execution-parameters file://UpdateSecurityPolicyParams.json
```
...
[Schema for Change Type ct-0mss4i7neuj7f](schemas.md#ct-0mss4i7neuj7f-schema-section "schemas.md#ct-0mss4i7neuj7f-schema-section").
