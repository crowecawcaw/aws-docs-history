...
![Enable KMS Auto Rotation panel showing description, ID, and version for AWS KMS customer master key.](images/guiKmsKeyEnableAutoRotateCT.png)
How it works:
...
(escape quotes when providing execution parameters inline), and then submit the returned RFC ID. For example, you can replace the contents with something like this:
...
[Schema for Change Type ct-2lt0jeydeumpe](schemas.md#ct-2lt0jeydeumpe-schema-section "schemas.md#ct-2lt0jeydeumpe-schema-section").
