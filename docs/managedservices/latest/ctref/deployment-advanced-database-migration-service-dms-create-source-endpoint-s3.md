...
[DMS source endpoint for MongoDB: Creating](deployment-advanced-database-migration-service-dms-create-source-endpoint-mongodb.md#ex-dms-se-mongo-create-col "deployment-advanced-database-migration-service-dms-create-source-endpoint-mongodb.md#ex-dms-se-mongo-create-col").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2oxl37nphsrjz](schemas.md#ct-2oxl37nphsrjz-schema-section "schemas.md#ct-2oxl37nphsrjz-schema-section").
