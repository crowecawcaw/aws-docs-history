...
<a name="management-advanced-ec2-instance-stack-start"></a>
...
<a name="management-advanced-ec2-instance-stack-start-info"></a>

### Start stack
<a name="ex-ec2-start-col"></a>

#### Starting EC2 instances with the console
<a name="ec2-start-con"></a>
...
1. Modify and save the StartEC2Params file.
...
1. Output the RFC template to a file in your current folder; this example names it StartEC2Rfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > StartEC2Rfc.json
   ```

1. Modify and save the StartEC2Rfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the StartEC2Rfc file and the StartEC2Params file:
...
#### Tips
<a name="ex-ec2-start-tip"></a>

**Note**  
This change type is now at version 2.0. The schema has been changed so you can start up to fifty EC2 instances.

## Execution Input Parameters
<a name="management-advanced-ec2-instance-stack-start-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-03t7kvuwx6rgr](schemas.md#ct-03t7kvuwx6rgr-schema-section).

## Example: Required Parameters
<a name="management-advanced-ec2-instance-stack-start-ex-min"></a>
...
<a name="management-advanced-ec2-instance-stack-start-ex-max"></a>
