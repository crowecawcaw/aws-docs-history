...
1. Output the execution parameters JSON schema for this change type to a
   JSON file; this example names it StartEC2Params.json:
...
[Schema for Change Type ct-03t7kvuwx6rgr](schemas.md#ct-03t7kvuwx6rgr-schema-section "schemas.md#ct-03t7kvuwx6rgr-schema-section").
