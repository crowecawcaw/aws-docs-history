# SNS | Update (Managed Automation)

Modify the properties of an existing Amazon Simple Notification Service (SNS) topic.

**Full classification:** Management | Monitoring and notification | SNS | Update (managed automation)
...
[Schema for Change Type ct-0zzf0fjz76jmb](schemas.md#ct-0zzf0fjz76jmb-schema-section "schemas.md#ct-0zzf0fjz76jmb-schema-section").
