...
![Change type details showing Reboot stack with ID ct-02u0hoaa9grat, version 1.0, automated execution.](http://docs.aws.amazon.com/managedservices/latest/ctref/images/guiStackRebootCT.png)
