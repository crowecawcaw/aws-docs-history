...
<a name="management-advanced-rds-database-stack-start-aurora-cluster"></a>
...
<a name="management-advanced-rds-database-stack-start-aurora-cluster-info"></a>

### Start DB Aurora cluster
<a name="ex-rds-db-start-aurora-cluster-aurora-cluster-col"></a>

#### Starting an RDS DB Aurora cluster with the Console
<a name="rds-db-start-aurora-cluster-con"></a>
...
<a name="rds-db-start-aurora-cluster-cli"></a>
...
1. Output the JSON template to a file in your current folder; this example names it StartRdsDbAuroraClusterRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > StartRdsDbAuroraClusterRfc.json
   ```

1. Modify and save the StartRdsDbAuroraClusterRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the execution parameters file and the StartRdsDbAuroraClusterRfc file:
...
#### Tips
<a name="ex-rds-db-start-aurora-cluster-tip"></a>

For more information see [Amazon Aurora DB clusters](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Aurora.Overview.html).

## Execution Input Parameters
<a name="management-advanced-rds-database-stack-start-aurora-cluster-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-02ocqy2i0jx3t](schemas.md#ct-02ocqy2i0jx3t-schema-section).

## Example: Required Parameters
<a name="management-advanced-rds-database-stack-start-aurora-cluster-ex-min"></a>
...
<a name="management-advanced-rds-database-stack-start-aurora-cluster-ex-max"></a>
