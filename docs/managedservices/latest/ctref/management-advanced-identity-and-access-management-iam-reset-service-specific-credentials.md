...
<a name="management-advanced-identity-and-access-management-iam-reset-service-specific-credentials"></a>
...
<a name="management-advanced-identity-and-access-management-iam-reset-service-specific-credentials-info"></a>

### Reset service specific credentials
<a name="ex-iam-serv-specific-creds-reset-col"></a>
...
<a name="iam-serv-specific-creds-reset-cli"></a>
...
1. Modify and save the ResetServSpecCredsParams file; example creates an IAM Role with policy documents pasted inline.
...
1. Output the RFC template JSON file to a file named ResetServSpecCredsRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > ResetServSpecCredsRfc.json
   ```

1. Modify and save the ResetServSpecCredsRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the ResetServSpecCredsRfc file and the ResetServSpecCredsParams file:
...
#### Tips
<a name="ex-iam-serv-specific-creds-reset-tip"></a>
...
<a name="management-advanced-identity-and-access-management-iam-reset-service-specific-credentials-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-22cbvc1yujhec](schemas.md#ct-22cbvc1yujhec-schema-section).

## Example: Required Parameters
<a name="management-advanced-identity-and-access-management-iam-reset-service-specific-credentials-ex-min"></a>
...
<a name="management-advanced-identity-and-access-management-iam-reset-service-specific-credentials-ex-max"></a>
