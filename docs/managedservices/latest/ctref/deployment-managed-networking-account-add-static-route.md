...
![Interface for adding a static route to Transit Gateway Route Table, showing description and ID.](images/guiManLzNetAcctAddStaticRouteCT.png)
How it works:
...
[Schema for Change Type ct-3r2ckznmt0a59](schemas.md#ct-3r2ckznmt0a59-schema-section "schemas.md#ct-3r2ckznmt0a59-schema-section").
