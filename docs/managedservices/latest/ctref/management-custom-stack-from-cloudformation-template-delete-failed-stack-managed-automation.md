...
<a name="management-custom-stack-from-cloudformation-template-delete-failed-stack-managed-automation"></a>
...
<a name="management-custom-stack-from-cloudformation-template-delete-failed-stack-managed-automation-info"></a>

### Delete failed stack (Managed Automation)
<a name="ex-custom-stack-cfn-template-delete-failed-stack-ma-col"></a>

#### Deleting failed stack (Managed Automation) with the Console
<a name="custom-stack-cfn-template-delete-failed-stack-ma-con"></a>
...
#### Deleting failed stack (Managed Automation) with the CLI
<a name="custom-stack-cfn-template-delete-failed-stack-ma-cli"></a>
...
1. Output the execution parameters JSON schema for this change type to a file; this example names it DeleteFailedStackParams.json:
...
1. Modify and save the DeleteFailedStackParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file; this example names it DeleteFailedStackRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > DeleteFailedStackRfc.json
   ```

1. Modify and save the DeleteFailedStackRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the DeleteFailedStackRfc file and the DeleteFailedStackParams file:
...
#### Tips
<a name="ex-custom-stack-cfn-template-delete-failed-stack-ma-tip"></a>
...
<a name="management-custom-stack-from-cloudformation-template-delete-failed-stack-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0ntpkt9wntdfs](schemas.md#ct-0ntpkt9wntdfs-schema-section).

## Example: Required Parameters
<a name="management-custom-stack-from-cloudformation-template-delete-failed-stack-managed-automation-ex-min"></a>
...
<a name="management-custom-stack-from-cloudformation-template-delete-failed-stack-managed-automation-ex-max"></a>
