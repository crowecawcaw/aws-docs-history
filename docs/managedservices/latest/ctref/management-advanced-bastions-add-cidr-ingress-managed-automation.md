...
<a name="management-advanced-bastions-add-cidr-ingress-managed-automation"></a>
...
<a name="management-advanced-bastions-add-cidr-ingress-managed-automation-info"></a>

### Add CIDR ingress (Managed Automation) ct-36zubwzxp44a4
<a name="ex-bastion-cidr-ingress-add-col"></a>

#### Adding bastion CIDR ingress with the console
<a name="bastion-cidr-ingress-add-con"></a>
...
<a name="bastion-cidr-ingress-add-cli"></a>
...
1. Modify and save the AddBastionCidrIngressParams file.
...
1. Output the RFC template to a file in your current folder; this example names it AddBastionCidrIngressRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > AddBastionCidrIngressRfc.json
   ```

1. Modify and save the AddBastionCidrIngressRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the AddBastionCidrIngressRfc file and the AddBastionCidrIngressParams file:
...
#### Tips
<a name="ex-bastion-cidr-ingress-add-tip"></a>
+ To learn more, see [Authorize inbound traffic for your Linux instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/authorizing-access-to-an-instance.html). 
...
<a name="management-advanced-bastions-add-cidr-ingress-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-36zubwzxp44a4](schemas.md#ct-36zubwzxp44a4-schema-section).

## Example: Required Parameters
<a name="management-advanced-bastions-add-cidr-ingress-managed-automation-ex-min"></a>
...
<a name="management-advanced-bastions-add-cidr-ingress-managed-automation-ex-max"></a>
