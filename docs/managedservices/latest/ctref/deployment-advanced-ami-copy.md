...
1. Output the execution parameters JSON schema for this change type to a file;
   this example names it CopyAmiParams.json:
...
To learn more about copying AMIs, see
[Copying
an AMI](../../../AWSEC2/latest/UserGuide/CopyingAMIs.md "../../../AWSEC2/latest/UserGuide/CopyingAMIs.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-046aizcwg5idf](schemas.md#ct-046aizcwg5idf-schema-section "schemas.md#ct-046aizcwg5idf-schema-section").
