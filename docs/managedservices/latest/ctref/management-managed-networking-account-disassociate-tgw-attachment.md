...
![Console interface showing Disassociate Transit Gateway Attachment change type details.](images/guiManLzNetAcctDisasscTgwAttachCT.png)
How it works:
...
[Schema for Change Type ct-3jo8yccbin4it](schemas.md#ct-3jo8yccbin4it-schema-section "schemas.md#ct-3jo8yccbin4it-schema-section").
