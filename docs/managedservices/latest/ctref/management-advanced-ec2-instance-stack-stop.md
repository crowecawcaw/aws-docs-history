...
![Description of EC2 instance stopping functionality, with ID and version details.](/images/managedservices/latest/ctref/images/guiEc2StopCT.png)
How it works:
...
1. Output the execution parameters JSON schema for this change type to a
   JSON file; this example names it StopEC2Params.json:
...
[Schema for Change Type ct-3mvvt2zkyveqj](schemas.md#ct-3mvvt2zkyveqj-schema-section "schemas.md#ct-3mvvt2zkyveqj-schema-section").
