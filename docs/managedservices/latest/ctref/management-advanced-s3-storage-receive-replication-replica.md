...
![Receive Replication Replica change type showing description, ID ct-00zr0b0ozlcn3, and version 1.0.](images/guiS3ReceiveReplicaCT.png)
How it works:
...
This is a new change type that enables you to receive replication replicas in your Amazon S3 bucket.
 If you want to add replication rules, use the
 [S3 storage: Add replication replica](management-advanced-s3-storage-add-replication-rule.md#ex-s3-add-replication-rule-col "management-advanced-s3-storage-add-replication-rule.md#ex-s3-add-replication-rule-col") change type.

To learn more about Replication, see [Replication](../../../AmazonS3/latest/dev/replication.md "../../../AmazonS3/latest/dev/replication.md").
...
[Schema for Change Type ct-00zr0b0ozlcn3](schemas.md#ct-00zr0b0ozlcn3-schema-section "schemas.md#ct-00zr0b0ozlcn3-schema-section").
