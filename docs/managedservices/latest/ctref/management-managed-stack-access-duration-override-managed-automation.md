...
<a name="management-managed-stack-access-duration-override-managed-automation"></a>
...
**Full classification:** Management \| Managed account \| Stack access duration \| Override (managed automation)
...
<a name="management-managed-stack-access-duration-override-managed-automation-info"></a>
...
<a name="management-managed-stack-access-duration-override-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0jb01cofkhwk1](schemas.md#ct-0jb01cofkhwk1-schema-section).

## Example: Required Parameters
<a name="management-managed-stack-access-duration-override-managed-automation-ex-min"></a>
...
<a name="management-managed-stack-access-duration-override-managed-automation-ex-max"></a>
