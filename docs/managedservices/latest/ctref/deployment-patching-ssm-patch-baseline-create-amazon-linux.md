...
In this example, all critical security updates are approved for installation five days after release. Patches related to vulnerability ID CVE-2017-5754
are approved immediately even if they are not a critical severity. Finally, example-pkg-0.710.10-2.7.abcd.x86\_64 will not be installed, even if it
matches an approval rule.
...
[Schema for Change Type ct-2taqdgegqthjr](schemas.md#ct-2taqdgegqthjr-schema-section "schemas.md#ct-2taqdgegqthjr-schema-section").
