...
<a name="deployment-advanced-ami-create-from-auto-scaling-group"></a>
...
<a name="deployment-advanced-ami-create-from-auto-scaling-group-info"></a>

### Create AMIs from Auto Scaling groups (ASGs)
<a name="ex-ami-create-from-asg-col"></a>

#### Creating an AMI from an ASG with the console
<a name="ami-create-from-asg-con"></a>
...
<a name="ami-create-from-asg-cli"></a>
...
#### Tips
<a name="ex-ami-create-from-asg-tip"></a>
...
<a name="deployment-advanced-ami-create-from-auto-scaling-group-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3e3prksxmdhw8](schemas.md#ct-3e3prksxmdhw8-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-ami-create-from-auto-scaling-group-ex-min"></a>
...
<a name="deployment-advanced-ami-create-from-auto-scaling-group-ex-max"></a>
