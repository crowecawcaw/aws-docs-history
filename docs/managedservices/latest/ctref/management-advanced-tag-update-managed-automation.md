...
# Tag \| Update (Managed Automation)
<a name="management-advanced-tag-update-managed-automation"></a>
...
**Full classification:** Management \| Advanced stack components \| Tag \| Update (managed automation)
...
<a name="management-advanced-tag-update-managed-automation-info"></a>

### Update tags (Managed Automation)
<a name="ex-tag-update-rr-col"></a>

#### Updating tags (Managed Automation) with the Console
<a name="tag-update-rr-con"></a>
...
#### Updating tags (Managed Automation) with the CLI
<a name="tag-update-rr-cli"></a>
...
1. Modify and save the TagUpdateParams.json file. For example, you can replace the contents with something like this:
...
1. Output the RFC template to a file in your current folder; this example names it TagUpdateRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > TagUpdateRfc.json
   ```

1. Modify and save the TagUpdateRfc.json file.
...
<a name="management-advanced-tag-update-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0zko7t3rk2efb](schemas.md#ct-0zko7t3rk2efb-schema-section).

## Example: Required Parameters
<a name="management-advanced-tag-update-managed-automation-ex-min"></a>
...
<a name="management-advanced-tag-update-managed-automation-ex-max"></a>
