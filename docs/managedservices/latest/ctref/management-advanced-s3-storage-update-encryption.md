...
![Change S3 Bucket Encryption Setting page showing ID, execution mode, version, and classification.](http://docs.aws.amazon.com/managedservices/latest/ctref/images/guiS3UpdateEncryptionCT.png)
