...
<a name="deployment-advanced-identity-and-access-management-iam-create-service-linked-role"></a>
...
<a name="deployment-advanced-identity-and-access-management-iam-create-service-linked-role-info"></a>

### Create IAM service-linked role
<a name="ex-iam-service-role-create-col"></a>
...
<a name="iam-service-rrole-create-cli"></a>
...
1. Save a CreateSlrParams.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the CreateSlrRfc file and the CreateSlrParams files:
...
#### Tips
<a name="ex-iam-service-role-create-tip"></a>
...
For more information about service-linked roles, see [Using service-linked roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html).

## Execution Input Parameters
<a name="deployment-advanced-identity-and-access-management-iam-create-service-linked-role-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2eof6j3mlcwhf](schemas.md#ct-2eof6j3mlcwhf-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-identity-and-access-management-iam-create-service-linked-role-ex-min"></a>
...
<a name="deployment-advanced-identity-and-access-management-iam-create-service-linked-role-ex-max"></a>
