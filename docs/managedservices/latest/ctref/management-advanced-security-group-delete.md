...
![Delete Security Groups change type details showing ID, execution mode, version, and description.](images/guiSecGroupDeleteCT.png)
How it works:
...
Only security groups with no dependencies are deleted and security groups with dependencies are not deleted.

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-18r16ldqil6w9](schemas.md#ct-18r16ldqil6w9-schema-section "schemas.md#ct-18r16ldqil6w9-schema-section").
