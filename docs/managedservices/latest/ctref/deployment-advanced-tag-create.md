...
![Create Resource Tags interface showing ID, execution mode, version, classification, and description.](images/guiTagCreateCT.png)
How it works:
...
[Schema for Change Type ct-3cx7we852p3af](schemas.md#ct-3cx7we852p3af-schema-section "schemas.md#ct-3cx7we852p3af-schema-section").
