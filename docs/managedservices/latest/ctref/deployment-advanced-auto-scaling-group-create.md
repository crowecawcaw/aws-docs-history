...
<a name="deployment-advanced-auto-scaling-group-create"></a>
...
<a name="deployment-advanced-auto-scaling-group-create-info"></a>

### Create Auto Scaling groups
<a name="ex-asg-create-col"></a>
...
1. Modify and save the schema as follows. For example, you can replace the contents with something like this:
**Note**  
...
The RFC waits up to six hours for all of the UserData script commands to run before returning a final status of success or failure.

   ```
   {
   "Description":                          "{{Create_WordPress_ASG}}",
   "VpcId":                                "{{VPC_ID}}",
   "StackTemplateId":                      "stm-suw38u00000000000",
   "Name":                                 "{{WP_ASG}}",
...
1. Output the JSON template for CreateRfc to a file in your current folder; example names it CreateAsgRfc.json:
...
1. Create the RFC, specifying the CreateAsgRfc file and the execution parameters file:
...
<a name="deployment-advanced-auto-scaling-group-create-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-2tylseo8rxfsc](schemas.md#ct-2tylseo8rxfsc-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-auto-scaling-group-create-ex-min"></a>

```
{
  "Description": "This is a test description",
  "VpcId": "vpc-1234567890abcdef0",
  "StackTemplateId": "stm-suw38u40000000000",
  "Name": "Test Stack",
  "Tags": [
    {
      "Key": "foo",
...
<a name="deployment-advanced-auto-scaling-group-create-ex-max"></a>
