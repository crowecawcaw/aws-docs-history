...
<a name="deployment-advanced-tag-create-managed-automation"></a>
...
<a name="deployment-advanced-tag-create-managed-automation-info"></a>

### Create tags (Managed Automation)
<a name="ex-tag-create-rr-col"></a>

#### Creating tags (Managed Automation) with the Console
<a name="tag-create-rr-con"></a>
...
#### Creating tags (Managed Automation) with the CLI
<a name="tag-create-rr-cli"></a>
...
1. Modify and save the TagCreateParams.json file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file; this example names it TagCreateRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > TagCreateRfc.json
   ```

1. Modify and save the TagCreateRfc.json file. For example, you can replace the contents with something like this:
...
#### Tips
<a name="ex-tag-create-rr-tip"></a>

## Execution Input Parameters
<a name="deployment-advanced-tag-create-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0176f0n99vcps](schemas.md#ct-0176f0n99vcps-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-tag-create-managed-automation-ex-min"></a>
...
<a name="deployment-advanced-tag-create-managed-automation-ex-max"></a>
