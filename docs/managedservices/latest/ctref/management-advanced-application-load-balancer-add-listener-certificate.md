...
![Application Load Balancer (ALB) listener certificate addition interface with description and version details.](images/guiAlbAddListenerCertCT.png)
How it works:
...
5. Create the RFC, specifying the AddAlbListenerCertRfc file and the AddAlbListenerCertParams
   file:
...
[Schema for Change Type ct-3g6fq83nxg1a7](schemas.md#ct-3g6fq83nxg1a7-schema-section "schemas.md#ct-3g6fq83nxg1a7-schema-section").
