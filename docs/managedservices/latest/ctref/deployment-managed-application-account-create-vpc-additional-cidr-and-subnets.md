...
- To use this CT to create additional public subnets in an already-provisioned VPC,
  the VPC must already have public subnets inside it. If this is not the case, contact AMS to
  deploy those public subnets inside the VPC first.
...
[Schema for Change Type ct-2ha68tpd7nr3y](schemas.md#ct-2ha68tpd7nr3y-schema-section "schemas.md#ct-2ha68tpd7nr3y-schema-section").
