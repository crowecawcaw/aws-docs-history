...
![Change type details for sharing an RDS DB snapshot, including ID and version.](images/guiRdsDbSnpshtShareCT.png)
How it works:
...
[Schema for Change Type ct-2u5rcyv5h34zn](schemas.md#ct-2u5rcyv5h34zn-schema-section "schemas.md#ct-2u5rcyv5h34zn-schema-section").
