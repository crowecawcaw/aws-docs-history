...
![Start Backup Job interface with description, ID, and version details for AWS Backup service.](images/guiAwsBackupJobStartCT.png)
...
1. Output the execution parameters JSON schema for this change type to a JSON file;
   this example names it StartBackupJobParams.json:
...
5. Create the RFC, specifying the StartBackupJobRfc file and the
   StartBackupJobParams file:
...
To learn more about AWS Backup, see [AWS Backup: How It Works](../../../aws-backup/latest/devguide/how-it-works.md "../../../aws-backup/latest/devguide/how-it-works.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2hhud2lx01tq7](schemas.md#ct-2hhud2lx01tq7-schema-section "schemas.md#ct-2hhud2lx01tq7-schema-section").
