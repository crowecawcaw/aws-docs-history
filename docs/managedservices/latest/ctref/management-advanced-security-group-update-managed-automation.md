...
<a name="management-advanced-security-group-update-managed-automation"></a>
...
<a name="management-advanced-security-group-update-managed-automation-info"></a>

### Update security group (Managed Automation)
<a name="ex-sec-group-update-rr-col"></a>

#### Updating an AMS Security Group (Managed Automation) with the Console
...
#### Updating an AMS Security Group (Managed Automation) with the CLI
...
1. Modify and save the UpdateSGParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template JSON file to a file named UpdateSGRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > UpdateSGRfc.json
   ```

1. Modify and save the UpdateSGRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the UpdateSG Rfc file and the UpdateSGParams file:
...
To learn more about AWS security groups, see [Amazon EC2 Security Groups for Linux Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-network-security.html) and/or [Security Groups for Your VPC](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html).
...
<a name="management-advanced-security-group-update-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3memthlcmvc1b](schemas.md#ct-3memthlcmvc1b-schema-section).

## Example: Required Parameters
<a name="management-advanced-security-group-update-managed-automation-ex-min"></a>
...
<a name="management-advanced-security-group-update-managed-automation-ex-max"></a>
