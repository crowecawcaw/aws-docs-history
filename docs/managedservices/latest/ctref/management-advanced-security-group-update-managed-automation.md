...
![Security group update interface showing ID, execution mode, version, and description.](images/guiSecGroupUpdateRrCT.png)
How it works:
...
To learn more about AWS security groups, see
...
[Schema for Change Type ct-3memthlcmvc1b](schemas.md#ct-3memthlcmvc1b-schema-section "schemas.md#ct-3memthlcmvc1b-schema-section").
