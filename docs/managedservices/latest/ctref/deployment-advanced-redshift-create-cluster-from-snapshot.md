...
To learn more about AWS Redshift snapshots, see
[Amazon Redshift snapshots](../../../redshift/latest/mgmt/working-with-snapshots.md "../../../redshift/latest/mgmt/working-with-snapshots.md").

To create an AWS Redshift cluster subnet group, see
[Create cluster subnet group](deployment-advanced-redshift-create-cluster-subnet-group.md#ex-rdshift-subnet-group-create-col "deployment-advanced-redshift-create-cluster-subnet-group.md#ex-rdshift-subnet-group-create-col").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-3jrqmeq7j0wke](schemas.md#ct-3jrqmeq7j0wke-schema-section "schemas.md#ct-3jrqmeq7j0wke-schema-section").
