...
![Properties panel for an Amazon Simple Queue Service instance, showing ID, version, and execution mode.](images/guiSqsUpdateCT.png)
How it works:
...
[Schema for Change Type ct-0hi7z7tyikjf6](schemas.md#ct-0hi7z7tyikjf6-schema-section "schemas.md#ct-0hi7z7tyikjf6-schema-section").
