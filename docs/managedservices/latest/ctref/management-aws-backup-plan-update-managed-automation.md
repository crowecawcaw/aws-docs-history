...
<a name="management-aws-backup-plan-update-managed-automation"></a>
...
<a name="management-aws-backup-plan-update-managed-automation-info"></a>
...
<a name="management-aws-backup-plan-update-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-1ay83wy4vxa3k](schemas.md#ct-1ay83wy4vxa3k-schema-section).

## Example: Required Parameters
<a name="management-aws-backup-plan-update-managed-automation-ex-min"></a>
...
<a name="management-aws-backup-plan-update-managed-automation-ex-max"></a>
