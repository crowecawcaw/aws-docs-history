...
![Disable AMS Resource Scheduler change type details showing ID, execution mode, and version.](images/guiResSchedStateDisableCT.png)
How it works:
...
[Schema for Change Type ct-14v49adibs4db](schemas.md#ct-14v49adibs4db-schema-section "schemas.md#ct-14v49adibs4db-schema-section").
