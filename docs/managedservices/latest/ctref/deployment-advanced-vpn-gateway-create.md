...
![VPNGateway details showing description, ID, and version for creating and associating with a VPC.](images/guiVpnGatewayCreateCT.png)
How it works:
...
[Schema for Change Type ct-0qbikxr9okwvy](schemas.md#ct-0qbikxr9okwvy-schema-section "schemas.md#ct-0qbikxr9okwvy-schema-section").
