...
![Delete Allow List interface showing ID, execution mode, version, and description for AMS managed Palo Alto firewall.](images/guiManFwPaDeleteAlCT.png)
How it works:
...
```
aws amscm create-rfc --change-type-id "ct-2fzh1wckpl7f5" --change-type-version "1.0" --title "`Delete Allow List`" --execution-parameters "{ \"RequestType\": \"DeleteAllowList\", \"Parameters\": { "AllowListName": "`CustomAllowList`" } } "
```
...
[Schema for Change Type ct-2fzh1wckpl7f5](schemas.md#ct-2fzh1wckpl7f5-schema-section "schemas.md#ct-2fzh1wckpl7f5-schema-section").
