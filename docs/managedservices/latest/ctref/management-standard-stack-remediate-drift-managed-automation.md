...
# Stack | Remediate Drift (Managed Automation)
...
**Full classification:** Management | Standard stacks | Stack | Remediate drift (managed automation)
...
![Remediate Stack Drift interface showing ID, execution mode, version, and description details.](images/guiStackRemediateDriftRrCT.png)
How it works:
