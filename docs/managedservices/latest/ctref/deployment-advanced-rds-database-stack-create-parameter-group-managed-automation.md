...
<a name="deployment-advanced-rds-database-stack-create-parameter-group-managed-automation"></a>
...
<a name="deployment-advanced-rds-database-stack-create-parameter-group-managed-automation-info"></a>
...
<a name="deployment-advanced-rds-database-stack-create-parameter-group-managed-automation-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-3da2lxapopb86](schemas.md#ct-3da2lxapopb86-schema-section).

## Example: Required Parameters
<a name="deployment-advanced-rds-database-stack-create-parameter-group-managed-automation-ex-min"></a>
...
<a name="deployment-advanced-rds-database-stack-create-parameter-group-managed-automation-ex-max"></a>
