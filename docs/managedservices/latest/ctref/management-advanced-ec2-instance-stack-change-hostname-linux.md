...
![Change Linux Hostname interface showing ID, execution mode, version, and description.](images/guiEc2HostnameChangeLinuxCT.png)
How it works:
...
This change type is at a new version, 2.0, and is now automated (version 1.0 was execution mode=manual). There are additional parameters, notably
**DocumentName** and **Platform**.

To learn more about doing this, see
[Changing the hostname of your Amazon Linux instance](../../../AWSEC2/latest/UserGuide/set-hostname.md "../../../AWSEC2/latest/UserGuide/set-hostname.md").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-2781aqd6f6svs](schemas.md#ct-2781aqd6f6svs-schema-section "schemas.md#ct-2781aqd6f6svs-schema-section").
