...
![Automation document details showing ID ct-16xg8qguovg2w and version 1.0 only version.](images/guiEbsCreateFromBackupCT.png)
How it works:
...
1. Output the execution parameters JSON schema for this change type to a file; this
   example names it CreateEbsParams.json:
...
To learn more about Amazon EBS, see [Amazon Elastic
Block Store (EBS)](https://aws.amazon.com/ebs/ "https://aws.amazon.com/ebs/").

## Execution Input Parameters

For detailed information about the execution input parameters, see
[Schema for Change Type ct-16xg8qguovg2w](schemas.md#ct-16xg8qguovg2w-schema-section "schemas.md#ct-16xg8qguovg2w-schema-section").
