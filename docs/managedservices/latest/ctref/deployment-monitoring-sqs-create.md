...
![Change type details showing Create SQS with ID ct-1vbv99k07psrq, version 1.0, and automated execution mode.](http://docs.aws.amazon.com/managedservices/latest/ctref/images/guiSqsCreateCT.png)
