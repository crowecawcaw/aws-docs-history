...
![AWS Backup service restore job interface for Storage Gateway volume snapshot restoration.](images/guiStoreGatewayCreateFromBackupCT.png)
How it works:
...
[Schema for Change Type ct-0cupn1txog5tk](schemas.md#ct-0cupn1txog5tk-schema-section "schemas.md#ct-0cupn1txog5tk-schema-section").
