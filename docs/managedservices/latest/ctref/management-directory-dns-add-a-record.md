...
![Interface for adding a new static DNS A record, showing description, ID, and version fields.](images/guiDirservArecordAddCT.png)
How it works:
...
[Schema for Change Type ct-2w3rbmnny1qpo](schemas.md#ct-2w3rbmnny1qpo-schema-section "schemas.md#ct-2w3rbmnny1qpo-schema-section").
