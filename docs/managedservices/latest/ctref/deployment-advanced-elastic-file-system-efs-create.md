...
<a name="deployment-advanced-elastic-file-system-efs-create"></a>
...
<a name="deployment-advanced-elastic-file-system-efs-create-info"></a>

### Create EFS
<a name="ex-efs-create-col"></a>

#### Creating an Elastic File System with the console
<a name="efs-create-con"></a>
...
1. Output the execution parameters JSON schema for this change type to a JSON file; this example names it CreateEfsParams.json:
   ...
   ```
   aws amscm get-change-type-version --change-type-id "ct-2uw99b8hpncnu" --query "ChangeTypeVersion.ExecutionInputSchema" --output text > CreateEfsParams.json
   ```

1. Modify and save the CreateEfsParams file. For example, you can replace the contents with something like this:
...
1. Output the RFC template to a file in your current folder; this example names it CreateEfsRfc.json:

   ```
   aws amscm create-rfc --generate-cli-skeleton > CreateEfsRfc.json
   ```

1. Modify and save the CreateEfsRfc.json file. For example, you can replace the contents with something like this:
...
1. Create the RFC, specifying the CreateEfsRfc file and the CreateEfsParams file:
...
<a name="deployment-advanced-elastic-file-system-efs-create-ex-max"></a>
