...
![SSM patch baseline creation interface for RHEL OS with description, ID, and version fields.](images/guiPatchBaseRhelCT.png)
How it works:
...
[Schema for Change Type ct-3ebotglihggse](schemas.md#ct-3ebotglihggse-schema-section "schemas.md#ct-3ebotglihggse-schema-section").
