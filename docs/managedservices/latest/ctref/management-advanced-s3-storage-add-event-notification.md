...
<a name="management-advanced-s3-storage-add-event-notification"></a>
...
<a name="management-advanced-s3-storage-add-event-notification-info"></a>
...
<a name="management-advanced-s3-storage-add-event-notification-input"></a>

For detailed information about the execution input parameters, see [Schema for Change Type ct-0o4zi9bzg74lp](schemas.md#ct-0o4zi9bzg74lp-schema-section).

## Example: Required Parameters
<a name="management-advanced-s3-storage-add-event-notification-ex-min"></a>
...
<a name="management-advanced-s3-storage-add-event-notification-ex-max"></a>
