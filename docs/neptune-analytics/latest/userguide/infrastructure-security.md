...
As a managed service, Neptune Analytics is protected by the AWS global network security
...
You use AWS published API calls to access Neptune Analytics through the network. Clients must
