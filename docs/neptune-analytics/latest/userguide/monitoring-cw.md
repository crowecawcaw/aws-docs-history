...
1.  In the **All Metrics** pane, choose Neptune , and then choose Neptune Analytics. 
...
1.  Dimensions.member.1 = "GraphIdentifier"=g-d3iivkv6i6 

1.  Namespace = AWS/Neptune 

1.  StartTime = 2024-08-17T00:00:00Z 

1.  EndTime = 2024-08-17T00:00:00Z 

1.  Period = 60 

1.  MetricName = GraphSizeBytes 
...
<a name="monitoring-cw-metrics"></a>
...
| CPUUtilization | System CPU usage by percentage. A continuous period of high(close to 100) CPU Utilization metric is not alone indicative of an issue, but validates a potential need to scale up if other metrics are also exhibiting stress. | 
