...
To view examples of Neptune Analytics identity-based policies, see [Identity-based policy examples for Neptune Analytics](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
