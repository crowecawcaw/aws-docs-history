...
To get a high-level view of how Neptune Analytics and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
For details about creating or managing Neptune Analytics service-linked roles, see [Using service-linked roles (SLRs) in Neptune Analytics](nan-service-linked-roles.md).
