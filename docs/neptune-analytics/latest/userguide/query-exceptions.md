...
| ---------------------------- | ----------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Validation Exception         | 400         | No        | Something is wrong with the required information<br>• Eg. a malformed query.                                                                                                                         |
...
| UnprocessableException       | 422         | No        | Request cannot be processed due to known reasons<br>• Eg. The query timed out.                                                                                                                       |
| ConflictException            | 409         | Yes       | Concurrently running queries attempted to modify resources or data records concurrently and<br>the conflict could not be resolved automatically. Please retry with an exponential back-off strategy. |
