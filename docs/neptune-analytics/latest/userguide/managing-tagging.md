...
1.  Choose the name of the graph that you want to tag. This will show the graph details. 

1.  In the details section, scroll down to the **Tags** section. 

1.  Choose **Manage tags**. The Manage tags window appears. 

1.  Enter a value for Tag key and value. 

1.  To add additional tags, choose the **Add another tag** button and enter values for its Tag key and value. Repeat this step as many times as necessary. 
...
1.  Choose the **Remove** button for the tag you want to delete. 

1.  Choose the **Save** button to save your changes. 
...
+  To add one or more tags to a Neptune Analytics graph resource, use the AWS CLI command `tag-resource`. 
   ...
   To learn more about how to construct the required ARN, see [Working with ARNs in Neptune Analytics graph](managing-ARN.md). 
