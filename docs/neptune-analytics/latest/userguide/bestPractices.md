...
- [openCypher query best practices](best-practices-content.md "best-practices-content.md")
  ...
  - [Place more restrictive nodes on the left side in Variable-Length Path (VLP) expressions](best-practices-content.md#best-practices-content-4 "best-practices-content.md#best-practices-content-4")
  ...
  - [Prefer the properties function over individual property lookup when retrieving all property values](best-practices-content.md#best-practices-content-12 "best-practices-content.md#best-practices-content-12")
