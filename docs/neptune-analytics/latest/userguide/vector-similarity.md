...
- [Vector-similarity search (VSS) algorithms in Neptune Analytics](vss-algorithms.md "vss-algorithms.md")
  ...
  - [The  .vectors.distance.byNode  algorithm](vectors.distance.byNode.md "vectors.distance.byNode.md")
    ...
    - [.vectors.distance.byNode  query examples](vectors.distance.byNode.md#vectors.distance.byNode-query-example "vectors.distance.byNode.md#vectors.distance.byNode-query-example")
  ...
  - [The  .vectors.distance.byEmbedding  algorithm](vectors.distance.byEmbedding.md "vectors.distance.byEmbedding.md")
    ...
    - [.vectors.distance.byEmbedding  query examples](vectors.distance.byEmbedding.md#vectors.distance.byEmbedding-query-example "vectors.distance.byEmbedding.md#vectors.distance.byEmbedding-query-example")
  ...
  - [.vectors.topK.byEmbedding algorithm](vectors.topK.byEmbedding.md "vectors.topK.byEmbedding.md")
    ...
    - [.vectors.topK.byEmbedding  query example](vectors.topK.byEmbedding.md#vectors.topK.byEmbedding-query-example "vectors.topK.byEmbedding.md#vectors.topK.byEmbedding-query-example")
  ...
  - [.vectors.topK.byNode algorithm](vectors.topK.byNode.md "vectors.topK.byNode.md")
    ...
    - [.vectors.topK.byNode  query example](vectors.topK.byNode.md#vectors.topK.byNode-query-example "vectors.topK.byNode.md#vectors.topK.byNode-query-example")
