...
**In the AWS console:**
+  **Cluster ARN** – In the Neptune console, choose **Databases**, and then choose your DB cluster. Find the ARN in the **Configuration** tab under **Resource ARN**. 
+  **Snapshot ARN** – In the Neptune console, choose **Snapshots**, and then choose your snapshot. Find the ARN in the snapshot details summary. 
