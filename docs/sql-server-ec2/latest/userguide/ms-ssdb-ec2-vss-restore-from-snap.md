...
<a name="ms-ssdb-ec2-vss-restore-from-snap"></a>
...
<a name="ms-ssdb-ec2-vss-restore-params"></a>
...
<a name="ms-ssdb-ec2-vss-restore-run"></a>
...
#### [ AWS Management Console ]
   ...
   To review the execution status, navigate to the **Executed Steps** section within the automation execution details. This section displays all of the steps that ran, along with their runtime status. If the automation execution failed, follow the troubleshooting steps outlined in [Troubleshoot restoring your SQL Server database from AWS VSS solution snapshots using the Systems Manager console](#ms-ssdb-ec2-vss-restore-troubleshoot).
...
<a name="ms-ssdb-ec2-vss-restore-troubleshoot"></a>
