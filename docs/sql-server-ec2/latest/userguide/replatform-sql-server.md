...
<a name="replatform-sql-server"></a>
...
+ [Replatforming script prerequisites](replatform-sql-server-setting-up.md)
+ [Run the Windows to Linux replatforming assistant for SQL Server script](replatform-sql-server-script.md)

## Concepts
<a name="replatform-sql-server-concepts"></a>
...
## Related services
<a name="replatform-sql-server-related-services"></a>
...
<a name="replatform-sql-server-how-it-works"></a>
...
## Components
<a name="replatform-sql-server-components"></a>
