...
<a name="connect-sql-server-on-ec2-instance"></a>

You can connect to your Microsoft SQL Server instance using one of the following tools.

**Topics**
+ [SQL Server Management Studio (SSMS)](#connect-sql-server-on-ec2-instance-ssms)
+ [SQL Server Configuration Manager](#connect-sql-server-on-ec2-instance-configuration-manager)

## SQL Server Management Studio (SSMS)
<a name="connect-sql-server-on-ec2-instance-ssms"></a>
...
1. For **Authentication**, choose **Windows Authentication** to log in with the built-in local administrator.

1. (Optional) Allow domain users to log in.
...
<a name="connect-sql-server-on-ec2-instance-configuration-manager"></a>
