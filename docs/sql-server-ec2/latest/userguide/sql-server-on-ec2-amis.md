...
- The [root device](../../../AWSEC2/latest/UserGuide/RootDeviceStorage.md "../../../AWSEC2/latest/UserGuide/RootDeviceStorage.md") type: Amazon EBS-backed (`EBS`)
...
the [AWS Windows AMI
version history](../../../AWSEC2/latest/WindowsGuide/ec2-windows-ami-version-history.md "../../../AWSEC2/latest/WindowsGuide/ec2-windows-ami-version-history.md") in the _Amazon EC2 User Guide_.

## Methods to find a SQL Server license-included AMI

AWS Marketplace
To view a list of SQL Server AMIs available from AWS in AWS Marketplace, see [Windows AMIs](https://aws.amazon.com/marketplace/search/results?searchTerms=sql+server "https://aws.amazon.com/marketplace/search/results?searchTerms=sql+server").
...
2. From the navigation bar, select the Region in which to launch your
...
5. To launch an instance from this AMI, select it and then choose
   **Launch instance**. For more information about
   ...
   wizard](../../../AWSEC2/latest/WindowsGuide/ec2-launch-instance-wizard.md "../../../AWSEC2/latest/WindowsGuide/ec2-launch-instance-wizard.md"). If you're not ready to launch the instance now, take
...
4. Enter `SQL` in the search bar and choose
...
PowerShell](../../../powershell/latest/userguide/pstools-ec2-launch.md "../../../powershell/latest/userguide/pstools-ec2-launch.md") in the _AWS Tools for PowerShell User Guide_.
...
lists the latest Windows AMIs with _SQL_ in their image
name:
...
Windows PowerShell](../../../powershell/latest/userguide/pstools-ec2-get-amis.md "../../../powershell/latest/userguide/pstools-ec2-get-amis.md") in the
...
[Launching an
Instance Using the AWS CLI](../../../cli/latest/userguide/cli-ec2-launch.md#launching-instances "../../../cli/latest/userguide/cli-ec2-launch.md#launching-instances") in the _AWS Command Line Interface User Guide_.

The [describe-images](../../../cli/latest/reference/ec2/describe-images.md "../../../cli/latest/reference/ec2/describe-images.md")
...
AMIs owned by you or Amazon with _SQL_ in the AMI
