...
+ [Compliance validation for Amazon OpenSearch Service](compliance-validation.md)
+ [Resilience in Amazon OpenSearch Service](disaster-recovery-resiliency.md)
+ [JWT authentication and authorization for Amazon OpenSearch Service](JSON-Web-tokens.md)
