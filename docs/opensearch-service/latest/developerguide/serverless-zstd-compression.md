...
For more details, refer to the [OpenSearch Index Codecs documentation](https://opensearch.org/docs/latest/im-plugin/index-codecs/ "https://opensearch.org/docs/latest/im-plugin/index-codecs/").
