...
For more details, refer to the [OpenSearch blog](https://opensearch.org/blog/save-up-to-2x-on-storage-with-derived-source/ "https://opensearch.org/blog/save-up-to-2x-on-storage-with-derived-source/").
