...
In addition to the AWS global infrastructure, OpenSearch Service offers several features to help
support your data resiliency and backup needs:

- [Multi-AZ domains and replica
  shards](managedomains-multiaz.md "managedomains-multiaz.md")
- [Automated and manual
  snapshots](managedomains-snapshots.md "managedomains-snapshots.md")
