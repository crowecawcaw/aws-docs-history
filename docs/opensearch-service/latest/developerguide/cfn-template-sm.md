...
**Note**  
Cross-Region connections to Amazon SageMaker or Amazon Bedrock endpoints are not supported by these CloudFormation templates. The ML connector and the OpenSearch Service domain must reside in the same AWS Region.
