...
If you already have a domain created, open the Amazon OpenSearch Service console, select your domain, choose the **Security configuration** tab, and choose **Edit**. Under **Access policy**, add the above permissions for `OpenSearchIngestion-PipelineRole` to the existing policy JSON.
