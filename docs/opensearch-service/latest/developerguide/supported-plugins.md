...
of legacy Elasticsearch OSS. This table isn't exhaustive; it lists only the plugins
that you're most likely to interact with directly. OpenSearch Service uses additional plugins to enable core service
...
| [Japanese (kuromoji) Analysis](https://opensearch.org/docs/latest/analyzers/supported-analyzers/language-analyzers/ "https://opensearch.org/docs/latest/analyzers/supported-analyzers/language-analyzers/") | 1.0                                 | Included on all domains                |
