...
**Topics**
+ [Amazon OpenSearch Service user interface release history](application-release-history.md)
+ [Getting started with the OpenSearch user interface in Amazon OpenSearch Service](application-getting-started.md)
+ [Agentic AI in Amazon OpenSearch Service](application-ai-assistant.md)
+ [Encrypting OpenSearch UI application metadata with customer managed keys](application-encryption-cmk.md)
