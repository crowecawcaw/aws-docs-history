...
programmatic access, you can use the [AWS CLI](../../../cli/latest/userguide.md "../../../cli/latest/userguide.md"), the [AWS SDKs](http://aws.amazon.com/code "http://aws.amazon.com/code"), or [Terraform](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/opensearch_domain "https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/opensearch_domain").
...
- Numerous configurations of CPU, memory, and storage capacity known as
  _instance types_, including cost-effective Graviton
  instances
- Supports up to 1002 data nodes
- Up to 25 PB of attached storage
- Cost-effective [UltraWarm](ultrawarm.md "ultrawarm.md") and [cold storage](cold-storage.md "cold-storage.md") for read-only data
...
of any EBS storage volumes attached to your instances. [Standard AWS data transfer charges](https://aws.amazon.com/ec2/pricing/ "https://aws.amazon.com/ec2/pricing/") also apply.

However, some notable data transfer exceptions exist. If a domain uses [multiple Availability Zones](managedomains-multiaz.md "managedomains-multiaz.md"), OpenSearch Service does not
...
traffic. Similarly, OpenSearch Service does not bill for data transfer between [UltraWarm](ultrawarm.md "ultrawarm.md")/[cold](cold-storage.md "cold-storage.md") nodes
and Amazon S3.
...
massive scale. For more information, see [Loading streaming data from Amazon Kinesis Data Streams](integrations-kinesis.md "integrations-kinesis.md") and [Loading streaming data from Amazon Data Firehose](integrations-fh.md "integrations-fh.md").

[Amazon S3](../../../s3.md "../../../s3.md")

Amazon Simple Storage Service (Amazon S3) provides storage for the internet. This guide provides
Lambda sample code for integration with Amazon S3. For more information, see [Loading streaming data from Amazon S3](integrations-s3-lambda.md "integrations-s3-lambda.md").
...
your OpenSearch Service domains. For more information, see [Identity and Access Management in Amazon OpenSearch Service](ac.md "ac.md").
...
from DynamoDB, Amazon S3, and Kinesis. For more information, see [Loading streaming data into Amazon OpenSearch Service](integrations.md "integrations.md").
