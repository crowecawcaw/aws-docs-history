...
- [Creating an Amazon Managed Service for Prometheus data source](direct-query-prometheus-creating.md "direct-query-prometheus-creating.md") in the AWS Management Console
- [AWS CLI](../../../cli/latest/reference/opensearch/add-direct-query-data-source.md "../../../cli/latest/reference/opensearch/add-direct-query-data-source.md")
