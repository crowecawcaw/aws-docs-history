...
+ Migrating to OpenSearch optimized (OR1) instances is irreversible. Clusters using OR1 instances cannot be changed back to standard instance types. Plan your migration carefully before proceeding.
