...
- [RDS for MySQL prerequisites](#rds-mysql-prereqs "#rds-mysql-prereqs")
- [Step 1: Configure the pipeline role](#rds-mysql-pipeline-role "#rds-mysql-pipeline-role")
- [Step 2: Create the pipeline](#rds-mysql-pipeline "#rds-mysql-pipeline")
- [Data consistency](#rds-mysql-pipeline-consistency "#rds-mysql-pipeline-consistency")
- [Mapping data types](#rds-mysql-pipeline-mapping "#rds-mysql-pipeline-mapping")
- [Limitations](#rds-mysql-pipeline-limitations "#rds-mysql-pipeline-limitations")
...
1. Create a custom DB parameter group in Amazon RDS to configure binary logging
...
Secrets Manager secret](../../../secretsmanager/latest/userguide/create_secret.md "../../../secretsmanager/latest/userguide/create_secret.md"). 6. If you use the full initial snapshot feature, create an AWS KMS key and
...
7. Select or create an OpenSearch Service domain or OpenSearch Serverless collection. For
...
8. Attach a [resource-based policy](ac.md#ac-types-resource "ac.md#ac-types-resource") to your domain or a [data access policy](serverless-data-access.md "serverless-data-access.md") to your collection. These access policies
...
pipeline specifies an Amazon RDS instance as the source.
...
that the Amazon RDS VPC CIDR is different from the CIDR for OpenSearch Ingestion.
