...
After you navigate to the URL, you automatically log in to Dashboards.

If you already have the OpenSearch Dashboards URL available but aren't on the AWS Management Console,
calling the Dashboards URL from the browser will redirect to the console. After you enter
your AWS credentials, you automatically log in to Dashboards. For information about
