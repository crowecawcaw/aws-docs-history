...
| `actionHandleEventsDropped.count`                 | The number of events that have *_not_<br>• been returned from the<br>`handleEvent` call to the configured<br>action.<br>**Relevant statistics**:<br>Sum<br>**Dimension**:<br>`PipelineName`                                       |
