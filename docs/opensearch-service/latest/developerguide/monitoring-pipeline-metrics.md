...
| actionHandleEventsDropped.count | The number of events that have **not** been returned from the `handleEvent` call to the configured action.<br />**Relevant statistics**: Sum<br />**Dimension**: `PipelineName` | 
