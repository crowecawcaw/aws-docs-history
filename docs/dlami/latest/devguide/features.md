...
Deep Learning AMI with Conda comes preinstalled with model servers for TensorFlow, as well as TensorBoard for model visualizations. For more information, see [TensorFlow Serving](tutorial-tfserving.md).