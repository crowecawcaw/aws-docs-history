...
The latest DLAMI is ready to use with AWS Inferentia and comes with the AWS Neuron API
package. To launch a DLAMI instance, see [Launching and
Configuring a DLAMI.](launch-config.md "launch-config.md") After you have a DLAMI, use the steps here to ensure that
your AWS Inferentia chip and AWS Neuron resources are active.

###### Contents

- [Verify Your Instance](#tutorial-inferentia-launching-verify "#tutorial-inferentia-launching-verify")
- [Identifying AWS Inferentia Devices](#tutorial-inferentia-launching-identify "#tutorial-inferentia-launching-identify")
- [View Resource Usage](#tutorial-inferentia-launching-resource-usage "#tutorial-inferentia-launching-resource-usage")
- [Using Neuron Monitor (neuron-monitor)](#tutorial-inferentia-launching-neuron-monitor "#tutorial-inferentia-launching-neuron-monitor")
- [Upgrading Neuron Software](#tutorial-inferentia-launching-upgrade "#tutorial-inferentia-launching-upgrade")
...
To identify the number of Inferentia devices on your instance,
