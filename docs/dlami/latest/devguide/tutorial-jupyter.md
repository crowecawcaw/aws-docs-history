...
**Important**  
To run the Jupyter notebook tutorials installed on the DLAMI, you will need to [Setting up a Jupyter Notebook server on a DLAMI instance](setup-jupyter.md).
