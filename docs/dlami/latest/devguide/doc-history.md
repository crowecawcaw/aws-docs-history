...
| --- |--- |--- |
| [Using TensorFlow Serving to Train a MNIST Model](tutorial-tfserving.md) | An example for using Tensorflow serving to train MNIST model. | February 14, 2025 | 
| [ARM64 DLAMI](tutorial-arm64.md) |  The AWS Deep Learning AMIs now supports images on Arm64 processor-based GPUs. | November 29, 2021 | 
