...
1. In the address bar of your browser, enter the following URL, or choose this link: [https://localhost:8888](https://localhost:8888 "https://localhost:8888")
...
Choose this, then choose the "proceed to localhost" link. If the connection is
