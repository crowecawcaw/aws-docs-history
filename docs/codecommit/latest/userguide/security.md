...
- **Security in the cloud** – Your responsibility is
  ...
  using CodeCommit. The following topics show you how to configure CodeCommit to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your CodeCommit resources.

###### Topics

- [Data protection in AWS CodeCommit](data-protection.md "data-protection.md")
- [Identity and Access Management for AWS CodeCommit](security-iam.md "security-iam.md")
- [Resilience in AWS CodeCommit](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure security in AWS CodeCommit](infrastructure-security.md "infrastructure-security.md")
