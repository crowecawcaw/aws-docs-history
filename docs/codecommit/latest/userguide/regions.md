...
The following table lists the public fingerprints for Git connection endpoints in
CodeCommit. These server fingerprints are displayed as part of the verification process for
adding an endpoint to your known hosts file.
