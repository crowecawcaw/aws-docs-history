...
![A pull request showing an approval rule whose condititions have not been satisfied and an empty list of approvers.](https://docs.aws.amazon.com/codecommit/latest/userguide/images/codecommit-approval-rule-not-met.png)
