...
<a name="how-to-share-repository"></a>
...
<a name="how-to-share-repo-choose"></a>
...
For more information about HTTPS, SSH, Git, **git-remote-codecommit**, and remote repositories, see [Setting up ](setting-up.md), [Connecting to AWS CodeCommit repositories with rotating credentials](temporary-access.md), or consult your Git documentation. 
...
<a name="how-to-share-repo-create-policy"></a>
...
<a name="how-to-share-repository-IAMgroup"></a>
...
<a name="how-to-share-repository-cli"></a>
