...
repositories), and CloudFormation provisions and configures those resources for
you.

When you use CloudFormation, you can reuse your template to set up your CodeCommit resources
...
CodeCommit supports creating repositories in CloudFormation Unlike creating repositories from the
console or command line, you can use CloudFormation to create repositories and automatically commit
...
When you create a CodeCommit repository using CloudFormation, you have the option to commit code to that
...
AWS CLI. Repositories created with CloudFormation or the AWS CDK with an initial commit
