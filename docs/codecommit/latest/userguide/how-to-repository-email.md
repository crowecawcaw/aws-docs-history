...
![A notification rule configured in an CodeCommit repository](https://docs.aws.amazon.com/codecommit/latest/userguide/images/create-notification-rule-repository.png)
