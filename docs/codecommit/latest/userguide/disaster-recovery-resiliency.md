...
A CodeCommit repository or CodeCommit approval rule template exists in the AWS Region where it was created. For more information, see [Regions and Git connection endpoints for AWS CodeCommit](regions.md "regions.md").
For resiliency in repositories, you can configure your Git client to push to two repositories at once. For more information, see [Push commits to an additional Git repository](how-to-mirror-repo-pushes.md "how-to-mirror-repo-pushes.md").
