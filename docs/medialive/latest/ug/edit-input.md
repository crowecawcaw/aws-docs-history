...
1. In the navigation pane, choose **Inputs**. Choose the name of the input, and then choose **Edit**.
...
1. On the **Inputs** page, make the following changes as appropriate:
   ...
   + In the **Tags** section, you can add or delete tags. To edit the value of an existing tag, delete the tag and add it again. For more information, see [Tagging resources](tagging.md).
