...
| --- | --- | --- | 
| Create, modify, and delete networks, clusters, nodes, and SDI sources. | MediaLive | CreateNetwork`CreateCluster`<br />`CreateNode`<br />`CreateSdiSource`<br />`DeleteNetwork`<br />`DeleteCluster`<br />`DeleteNode`DeleteSdiSource<br />`UpdateNetwork`<br />`UpdateCluster`<br />`UpdateNode`<br />`UpdateSdiSource` | 
