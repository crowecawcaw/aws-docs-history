...
When you select **SINGLE\_PIPELINE** as the channel class, additional fields appear for configuring linked channels. Linked channels enable pipeline locking for single-pipeline channels.
