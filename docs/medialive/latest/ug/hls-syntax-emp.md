...
| --- | --- | --- | 
| Main manifest files |  protocol channelURL extension | The path for output. Here is an example that uses MediaPackage v2<br />`https://mz82o4-2.ingest.hnycui.mediapackagev2.us-west-2.amazonaws.com/in/v1/live-sports/2/curling/index.m3u8` | 
