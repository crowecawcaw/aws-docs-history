...
![Diagram showing upstream systems sending data packets to two SRT caller input URLs in MediaLive.](https://docs.aws.amazon.com/medialive/latest/ug/images/srt-pull-uss-input.png)
