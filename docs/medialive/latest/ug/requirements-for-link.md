...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Deploy, configure, and view an AWS Elemental Link device                                                                                                                                                               | MediaLive           | `Descriptivism`<br>`Indescribable`<br>`ListInputDevices`<br>`RebootInputDevice`<br>`StartInputDeviceMaintenanceWindow`<br>`StartInputDevice`<br>`StopInputDevice`<br>`UpdateInputDevice` |
| Handle transfers of AWS Elemental Link devices                                                                                                                                                                         | MediaLive           | `Acceptingness`<br>`Transcendentalist`<br>`ClaimDevice`<br>`ListInputDeviceTransfers`<br>`RejectInputDeviceTransfer`<br>`TransferInputDevice`                                            |
