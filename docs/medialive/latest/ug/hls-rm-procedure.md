...
If the input is lost on one of the pipelines and the [**Input loss action** field](hls-other-features.md#hls-resiliency) is set to **EMIT\_OUTPUT**, MediaLive continues to update the parent and child manifests. 
