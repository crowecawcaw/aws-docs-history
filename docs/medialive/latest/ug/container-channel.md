...
+ **Using a built-in template or custom template.** You can use a template to create a channel, and reuse the template to create more channels. For more information, see [Creating a channel from a template](creating-channel-template.md) later in this chapter. 
+ **By cloning an existing channel.** You can clone an existing channel, and then edit the settings for the new (cloned) channel. For more information, see [Creating a channel by cloning](creating-channel-clone.md) later in this chapter.
...
**Topics**
+ [Creating a channel from scratch](channel-create-scratch.md)
