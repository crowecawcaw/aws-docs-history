...
this setup in each Region where channels or multiplexes are
running.

Create as many subscriptions and rules combinations as you
need. Follow the steps for [option
1](option-1.md "option-1.md"), with these differences:
...
- When creating the CloudWatch rule, you create an event
  ...
  example, for a channel create this pattern:
...
The resource is the ARN for the channel or multiplex. You can
...
You can choose to include more than one channel or multiplex
in the resources section, as shown in the following
example:
