...
real-time metrics that are kept for 15 months. You use CloudWatch to view the
metrics. Metrics can help you gain a better perspective about how MediaLive
is performing over the short term and long term.

You can set alarms that watch for certain thresholds, and send
notifications or take actions when those thresholds are met. For more
...
- [Components of a metric](eml-metrics-gen-info.md "eml-metrics-gen-info.md")
- [Pricing to view MediaLive metrics](eml-metrics-pricing.md "eml-metrics-pricing.md")
