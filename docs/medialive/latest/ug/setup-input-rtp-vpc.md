...
- [Create the RTP input](#rtp-vpc-push-create "#rtp-vpc-push-create")
- [IAM role and ARN](#rtp-push-role-and-remember-arn "#rtp-push-role-and-remember-arn")
...
8. Complete the **Role ARN** section to choose a role
   for MediaLive to use with this input. For more information, see [IAM role and ARN](#rtp-push-role-and-remember-arn "#rtp-push-role-and-remember-arn").
9. In the **Tags** section, create tags if you want to
...
`rtp://10.99.39.15:5000`. 11. Provide the upstream system with these endpoints:
...
The RTP input has two IP addresses. These addresses are fixed for the lifetime of
...
For a description of this setup that includes a diagram, see [Result of this procedure](setup-rtp-vpc-result.md "setup-rtp-vpc-result.md") in the section about setting up an RTP VPC
source.
...
You must choose a role for MediaLive to assume when it creates an RTP Push input.
