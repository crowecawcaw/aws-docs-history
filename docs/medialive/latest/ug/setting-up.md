# Preliminary steps for setting up to use MediaLive

This topic describes preliminary steps, such as creating an account, that prepare you to use
MediaLive. You aren't charged for these preliminary items. You are charged only for AWS services
that you use.
...
- [Download tools](#setting-up-medialive-tools "#setting-up-medialive-tools")
...
The AWS Management Console includes a console for AWS Elemental MediaLive, but if you want to
