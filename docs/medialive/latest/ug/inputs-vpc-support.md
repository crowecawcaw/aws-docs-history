...
Some MediaLive inputs can be set up in Amazon Virtual Private Cloud (Amazon VPC). For more information, see [Creating an input](create-input.md "create-input.md").
