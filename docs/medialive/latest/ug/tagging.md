...
You can use the AWS Management Console to manage tags. You can also use the AWS Elemental MediaLive console, the AWS CLI, or the MediaLive API to add, edit, or delete the values for these properties. 

### Tagging using the AWS Management Console
<a name="tagging-management-console"></a>

You can manage tags on MediaLive resources by using the MediaLive console, the AWS CLI, or the MediaLive API.

### Tagging using MediaLive
<a name="tagging-medialive-console"></a>

For information about managing tags using the MediaLive console, see the following:
+ [Complete channel and input details](creating-a-channel-step1.md) – for information about including tags when you create a channel
+ [Editing and deleting a channel](editing-deleting-channel.md) – for information about modifying tags in an existing channel
+ [Working with inputs](creating-input.md) – for information about including tags in an input
...
For information about managing tags using the MediaLive API, see the following:
