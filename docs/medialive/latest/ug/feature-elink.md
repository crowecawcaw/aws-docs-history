...
![Flow diagram showing AWS Elemental Link hardware device connecting to Link input device, then to Elemental Link input within MediaLive.](images/link-parts.png)
