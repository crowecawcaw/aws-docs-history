...
+ [Identity and Access Management for AWS Elemental MediaLive](security-iam.md)
+ [AWS managed policies for AWS Elemental MediaLive](security-iam-awsmanpol.md)
+ [Compliance validation for AWS Elemental MediaLive](SERVICE-compliance.md)
