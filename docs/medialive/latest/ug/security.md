# Security in AWS Elemental MediaLive
...
- **Security of the cloud** – AWS is responsible for
  ...
  learn about the compliance programs that apply to AWS Elemental MediaLive, see [AWS Services in Scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  using MediaLive. The following topics show you how to configure MediaLive to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your MediaLive resources.
