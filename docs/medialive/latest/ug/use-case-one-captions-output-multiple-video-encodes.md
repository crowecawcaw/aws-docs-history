...
![Diagram showing input captions flowing to output captions, which connect to three video quality outputs and HLS output.](https://docs.aws.amazon.com/medialive/latest/ug/images/captions_INembed_OUTembed_ABRhls.png)
