...
In MediaLive, you can delete a multiplex, the programs in a multiplex, and the channels in a multiplex. There are specific rules that are based on the state of the item that you want to work with, as described in this section. 

## Deleting a multiplex
<a name="delete-multiplex"></a>

To delete a multiplex In MediaLive, the multiplex must be idle, and all of its programs must be empty (they must not have associated channels.) 
...
In MediaLive, you can delete a program that has no channel. You can delete a program when the multiplex is running or idle. 
