...
| Smart Subtitles | Remove all `SmartSubtitleSourceSettings`<br>caption selectors from input attachments. Remove or<br>update caption descriptions that reference those<br>selectors. Remove the captions-only subtitle<br>outputs.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
