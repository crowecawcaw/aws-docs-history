...
| output-network | my-Outputs-Interface | Eth2                   | Eth2                                        | Eth3   | Eth2   |

| Cluster name   | Network name         | Logical interface name | Corresponding physical interface for Node 1 | Node 2 | Node 3 |
| -------------- | -------------------- | ---------------------- | ------------------------------------------- | ------ | ------ |
| CL-B           | input-network        | my-Inputs-Interface    | Eth1                                        | Eth1   | Eth2   |
| output-network | my-Outputs-Interface | Eth2                   | Eth2                                        | Eth3   |

You will use this information as follows:

- Network name: Assign this name when you [create each network](emla-setup-cl-networks.md "emla-setup-cl-networks.md").
- Cluster name: Assign this name when you [create
  each cluster](emla-setup-cluster.md "emla-setup-cluster.md").
- Logical interface name: Assign this name to complete the **Interface
  mappings** fields when you [create each
  cluster](emla-setup-cluster.md "emla-setup-cluster.md").
- Physical interface: You will enter this information to complete the **Node
  interface mapping** fields when you [create the nodes](emla-setup-cl-nodes-create.md "emla-setup-cl-nodes-create.md").
