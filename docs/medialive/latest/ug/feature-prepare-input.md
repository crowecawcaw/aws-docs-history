...
**Topics**
+ [Rules and limits for input prepare in MediaLive](input-prep-rules.md)
...
+ [Deleting and stopping input prepare actions in the MediaLive schedule](input-prep-delete.md)