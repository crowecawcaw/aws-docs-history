...
- If you have identified AWS Elemental MediaPackage as an origin service, see
  [Delivering to MediaPackage](delivering-to-mediapackage.md "delivering-to-mediapackage.md") for guidance on choosing the correct output
  group configuration.
