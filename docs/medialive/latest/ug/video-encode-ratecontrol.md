...
1. On the **Stream settings** pane, for **Video**, for **Codec settings**, choose **H264** or **H265**.

1. For H.264 and H.265, in the **Rate Control** section, for **Rate control mode**, choose **QVBR** or **CBR** or **VBR**. The default mode is CBR. For information about choosing the best option and about completing the other fields in the **Rate control mode** section, see the sections below.
...
+ Bitrate (H.264 and H.265 only): Enter the same value as you enter in **Max bitrate**. 
