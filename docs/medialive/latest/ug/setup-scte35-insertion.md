...
detailed information, see [Creating an AWS Elemental MediaLive schedule](working-with-schedule.md "working-with-schedule.md").
...
- Manifest decoration
- Passthrough
  For a summary of these options, see [Scope of processing by feature](scope-by-feature.md "scope-by-feature.md") and [Supported features by output type](processing-applicability-by-output-type.md "processing-applicability-by-output-type.md").
