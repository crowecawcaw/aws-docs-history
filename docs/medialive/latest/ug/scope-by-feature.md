...
![Channel diagram showing blanking or blackout applied to two output groups containing outputs.](images/scte35_scope_blanking.png)
**Decoration**
...
![Channel diagram showing manifest decoration applied at output group level with outputs nested inside.](images/scte35_scope_manifest.png)
...
![Channel diagram showing two output groups, each containing two outputs, with passthrough or removal applied at output level.](images/scte35_scope_passthrough.png)
