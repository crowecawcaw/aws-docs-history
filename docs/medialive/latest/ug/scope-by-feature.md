...
![Channel diagram showing blanking or blackout applied to two output groups containing outputs.](https://docs.aws.amazon.com/medialive/latest/ug/images/scte35_scope_blanking.png)
...
![Channel diagram showing manifest decoration applied at output group level with outputs nested inside.](https://docs.aws.amazon.com/medialive/latest/ug/images/scte35_scope_manifest.png)
...
![Channel diagram showing two output groups, each containing two outputs, with passthrough or removal applied at output level.](https://docs.aws.amazon.com/medialive/latest/ug/images/scte35_scope_passthrough.png)
