# Input codecs in MediaLive

This section provides information about the video and audio codecs that each input type
can ingest in AWS Elemental MediaLive
...
- [Video encoding schemes supported in a source](inputs-video-encoding-schemes.md "inputs-video-encoding-schemes.md")
