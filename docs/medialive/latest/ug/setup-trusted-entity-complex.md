...
Read this section if you decided that you should use the [complex option](scenarios-for-medialive-role.md "scenarios-for-medialive-role.md") for setting up the trusted
entity.
...
- Set up all MediaLive users with permissions that let them attach a specific trust policy to
  a channel, when they create or edit the channel. This task is covered in step D.
