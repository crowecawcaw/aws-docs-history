...
1. When you [discussed your requirements](origin-server-rtmp.md "origin-server-rtmp.md") with the
   ...
   - IP address.
   - Port number.
   - Application name. Also called _app
     name_.
   - Stream name. Also called _application
     instance_ or _app instance_ or
     _stream
     key_.
...
| ----------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| protocol, IP address, port,<br>application name | The two **URL**<br>fields in the *_RTMP<br>destination_<br>• section. (Note<br>that these fields are on the<br>*_Output_<br>• page, not<br>the **Output group**<br>page.)For<br>example:`rtmp://203.0.113.17:80/xyz`Specify<br>two destinations when the channel is set<br>up as a [Channel class](channel-class.md "channel-class.md"),<br>or one destination when it is set up as<br>a single-pipeline<br>channel. |
| Stream name                                     | The two *_Stream<br>name_<br>• fields in the<br>**RTMP outputs**<br>section.For<br>example:`ywq7b`                                                                                                                                                                                                                                                                                                                   |
