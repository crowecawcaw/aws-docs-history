...
| The available coding modes (for example, 2.0 and 5.1) for each codec. | Identify the audio coding modes that you prefer for each audio language. Determine which of these coding modes the content provider can provide. For more information, see the [section after this table](#coding).<br /> | 
