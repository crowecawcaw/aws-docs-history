...
1. Choose the Tags tab. Add or delete tags. To edit the value of an existing tag, delete the tag and add it again. For more information, see [Tagging resources](tagging.md). 
