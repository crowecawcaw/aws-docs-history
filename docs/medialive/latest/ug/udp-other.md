...
- **UDP settings** – **Input loss
  action** – For details about a field on the MediaLive console, choose the **Info** link next to the field. For more information, see [Handling loss of video input](feature-input-loss.md "feature-input-loss.md").
  The following fields relate to implementing captions in a
  UDP output:
