...
| HLG or HLG 2020                    | Rec. 2020                               | HLG rec. 2020 (ARIB\_STD-B67/HLG)                       | Not applicable. This color space doesn't include display metadata.                                             |
| Dolby Vision 8.1                   | Rec. 2020                               | SMPTE ST 2084 (PQ)                                      | Proprietary Dolby Vision 8.1 metadata (RPU), on a per-frame basis, and SMPTE<br>ST 2086 on a per-stream basis. |
