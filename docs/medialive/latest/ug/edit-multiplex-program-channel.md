...
In MediaLive, you can edit a multiplex, the programs in a multiplex, and the channels in a multiplex. There are specific rules that are based on the state (running or idle) of the item that you want to work with, as described in this section. 

## Editing a multiplex
<a name="edit-multiplex"></a>

In MediaLive, there are very few restrictions on your ability to edit a multiplex. You can edit a multiplex when these situations apply: 
...
In MediaLive, you can edit a program at any time, including when the multiplex if running or when the associated channel is running. 
