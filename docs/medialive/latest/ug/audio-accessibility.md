...
MediaLive also includes a feature for including accessibility data in captions. For more information, see [Including accessibility data in captions in MediaLive](captions-accessibility.md).

## Supported accessibility data standards
<a name="audio-accessibility-standards"></a>
...
<a name="audio-accessibility-procedure"></a>
...
1. Select the output by its name. The details appear on the right. Go to the **Stream** settings section and choose the **Audio** section.

1. Open the **Additional settings** and set the accessibility data fields.
...
<a name="audio-accessiblity-result"></a>
