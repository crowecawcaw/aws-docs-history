...
| ---------------------------------------------------------------------------- | ---------------------------- | ------------------------- | -------- | ----------- |
| CDI container                                                                | Embedded                     | Burn-in TTML              |
| Teletext                                                                     | TTML                         |
...
| MPEG-TS container (through MediaConnect or through the RTP or SRT protocols) | Embedded or Embedded+SCTE-20 | Burn-inTTML               |
| SCTE-20                                                                      | Burn-inTTML                  |                           | Teletext | Burn-inTTML |
