...
| Date and time | If the **Start type** is **Fixed**, specify the UTC start time for the time\_signal. The time should be at least 15 seconds in the future.<br />Note that the time is the wall clock time, not the timecode in the input. | 
