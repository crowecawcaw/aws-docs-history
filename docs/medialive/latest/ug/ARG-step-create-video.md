...
If you want to include video in the HLS output group, then follow this procedure
for each video encode.

This procedure involves the following fields in the output section of the HLS
output group the Channel page in the console:

- **Output settings** – **HLS
  settings**
- **Output settings** – **HLS
  settings** – **Audio rendition
  sets**
...
3. Complete the **Output settings** section as
   ...
   - For **HLS settings**, choose **Standard
     hls** or **Fmp4**, as
     appropriate.
   - For **Audio rendition sets**, enter the name of
     the audio renditions groups to associate with this video output.
     Don't worry that you haven't created this name yet. To associate the
     video output with more than one group, enter a comma-separated list.
     For example:
