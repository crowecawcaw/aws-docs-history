...
**Topics**
+ [Identify networks](#emla-identify-networks)
+ [Reserve CIDRs](#emla-reserve-cidrs)
+ [Identify routes](#emla-identify-routes)
+ [Identify default route](#emla-identify-default-route)
+ [Summary of data](#emla-deploy-requirements-summary)
