...
**Topics**
+ [Obtain information](setup-hls-http.md)
+ [Create an HLS input](setup-input-hls.md)
+ [Ensure correct setup on the HLS upstream server](setup-uss-hls.md)
+ [Result of this procedure](setup-hls-result.md)