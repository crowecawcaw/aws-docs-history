...
- [Organize encodes in a MediaPackage output group](design-emp-hls-package.md "design-emp-hls-package.md")
- [Coordinate with the MediaPackage operator](origin-server-emp.md "origin-server-emp.md")
- [Create a MediaPackage output group](creating-mediapackage-output-group.md "creating-mediapackage-output-group.md")
