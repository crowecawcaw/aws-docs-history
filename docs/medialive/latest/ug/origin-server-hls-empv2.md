...
Follow this procedure if you [determined](delivering-to-mediapackage.md "delivering-to-mediapackage.md") that you will create an HLS output group, and will send to
