...
![Diagram showing upstream systems sending GET requests to two input URLs with different IP addresses.](/images/medialive/latest/ug/images\rtmp-pull-uss-input.png)
