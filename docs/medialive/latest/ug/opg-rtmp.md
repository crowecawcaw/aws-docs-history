...
- [Organize encodes in an RTMP output group](design-rtmp-package.md "design-rtmp-package.md")
- [Coordinate with the downstream system](origin-server-rtmp.md "origin-server-rtmp.md")
- [Create an RTMP output group](creating-rtmp-output-group.md "creating-rtmp-output-group.md")
