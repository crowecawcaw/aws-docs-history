...
| **Date and time** | If the *_Start type_<br>• is<br>**Fixed**, specify the UTC start time<br>for the ID3 segment tag. The time should be at least 15<br>seconds in the future.<br>Note that the time is the wall clock time, not the<br>timecode in the input.                                                                                                                                                                                                                                                                             |
