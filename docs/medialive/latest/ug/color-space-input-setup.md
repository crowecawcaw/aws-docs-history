...
| *_REC\_601_<br>• or<br>*_REC\_709_<br>• or<br>*_HDR10_<br>• or<br>*_HLG_<br>• or<br>**Dolby Vision 8.1** | **Force**                       | Cleanup. MediaLive marks all the content as using the specified color space.                                                                                                                     |
| *_REC\_601_<br>• or<br>*_REC\_709_<br>• or<br>*_HDR10_<br>• or<br>*_HLG_<br>• or<br>**Dolby Vision 8.1** | **Fallback**                    | Cleanup. MediaLive marks the content as using the specified color space only for<br>portions of the content that are unmarked or marked as unknown or marked with an<br>unsupported color space. |
