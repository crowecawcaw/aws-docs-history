...
| **REC_601** or **REC_709** or **HDR10** or **HLG** or **Dolby Vision 8.1** | **Force**                   | Cleanup. MediaLive marks all the content as using the specified color space.                                                                                                               |
| **REC_601** or **REC_709** or **HDR10** or **HLG** or **Dolby Vision 8.1** | **Fallback**                | Cleanup. MediaLive marks the content as using the specified color space only for portions of the content that are unmarked or marked as unknown or marked with an unsupported color space. |
