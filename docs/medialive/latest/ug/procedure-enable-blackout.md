...
7. For **Network end blackout image**, choose the
   ...
   - **Network end blackout image**: To use a special
     ...
     name and Systems Manager password for accessing the S3 bucket. See [About the feature for creating password parameters](requirements-for-EC2.md#about-EC2Password "requirements-for-EC2.md#about-EC2Password").
