...
reminder of where the fields are located in the MediaLive Console. The information is sorted by
the location of the fields on the **Channel** page, from top to bottom.
...
| **Max Fall**                                                                               |
| Configure the channel to use 3D LUTs files                                                 | **General settings**                   | **Color correction settings**                                                                                            | **Url\*\***Input color<br>space\***\*Output color<br>space** |
