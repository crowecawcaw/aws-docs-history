...
In the list of channels that appears, there are two columns on the right-hand side:
**Maintenance status** and **Maintenance window**,
which shows the upcoming maintenance

## Viewing information on the Personal Health
...
2. In the navigation pane, choose **Your account health**, then choose
   **Other notifications**. Use the filter to find events with a title
   that includes **MediaLive maintenance event**.
