...
| HLS                               | No                                                                         | By default, MediaLive extracts the video asset with the highest<br>bandwidth. You can complete the **Bandwidth**<br>field (in *_Input settings_<br>• –<br>**Network input settings**). MediaLive extracts<br>the highest bandwidth video that is below this limit.                                                                                                                                                             |
