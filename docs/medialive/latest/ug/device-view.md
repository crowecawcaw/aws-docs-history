...
| Device settings  | The current configuration of the device.                                                                | The streaming fields (such as the framerate) show information only if the<br>device is sending content to AWS.You can set some fields. Choose the<br>**Modify\*<br>• then **Configure device\*\*. For<br>information about the dialog, see [Configuring a Link device](device-edit.md "device-edit.md"). |
