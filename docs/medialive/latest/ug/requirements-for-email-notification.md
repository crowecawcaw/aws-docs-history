...
distribution setup. Or you might decide that an administrator must be
responsible for performing the setup at startup for applicable users, and
then again whenever a new user is added.

The following table shows the actions in IAM that relate to access
for setting up email notification.
