...
| The maximum expected bitrate.                                         | Make sure that the bandwidth between the upstream system and MediaLive is sufficient to handle the anticipated maximum bitrate of the source content.If you are setting up standard channels (to implement [pipeline redundancy](plan-redundancy.md "plan-redundancy.md")), make sure that the bandwidth is double the anticipated maximum bitrate because there are two pipelines.                                      |
