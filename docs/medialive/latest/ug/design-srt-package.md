...
![Output group containing one output with embedded video and two audio outputs.](https://docs.aws.amazon.com/medialive/latest/ug/images/output3-nonABR-Ve-2A.png)
