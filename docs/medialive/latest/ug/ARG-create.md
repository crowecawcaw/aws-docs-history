...
**Topics**
+ [Identify the video and audio encodes](ARG-step-create-mapping.md)
+ [Determine Defaults and Selection Rules](ARG-step-defaults.md)
+ [Create the video outputs](ARG-step-create-video.md)
+ [Create the audio outputs](ARG-step-create-audio.md)
