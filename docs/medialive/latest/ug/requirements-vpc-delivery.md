...
When a user sets up for this feature on the MediaLive console, they have
the option to choose subnets, security groups, and EIPs from a dropdown
list. For the dropdown list to be populated with the resources in Amazon VPC, the
user must have the appropriate permissions. For information about this
feature, see [Delivering outputs via your VPC](delivery-out-vpc.md "delivery-out-vpc.md").
