...
1. In the channel that you are creating, in the navigation pane, choose
   **General settings**.
2. Set the ad avail mode, if you have not already done so. See [Getting ready: Set the SCTE 35 source—segments or manifest](scte35-getting-ready-source.md "scte35-getting-ready-source.md"). The mode identifies which of
...
4. In **Avail blanking image**, choose the appropriate
   ...
   - Avail blanking image: To use a special image for blanking. In the
     **URL** field, type the path to a file in an S3
     ...
     password parameter for accessing the S3 bucket. See [About the feature for creating password parameters](requirements-for-EC2.md#about-EC2Password "requirements-for-EC2.md#about-EC2Password").
