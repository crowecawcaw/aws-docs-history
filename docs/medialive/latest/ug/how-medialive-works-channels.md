...
+ One or more *upstream systems* that provide the *source content* (the video and other media) to MediaLive.
...
**Topics**
+ [MediaLive inputs](#input-side-overview)
+ [MediaLive channels](#medialive-channel-overview)
+ [MediaLive pipelines](#what-is-pipeline)
+ [MediaLive schedule](#schedule-overview)
...
For information about designing this workflow and creating a channel, see [Planning a MediaLive workflow](container-planning-workflow.md).
