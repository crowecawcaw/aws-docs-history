...
A MediaConnect Router output group uses the M2TS (MPEG-2 Transport Stream) container.
Each output can contain the following:

- One video encode.
- Zero or more audio encodes.
- Zero or more captions encodes. The captions are embedded captions or sidecar
  captions.
