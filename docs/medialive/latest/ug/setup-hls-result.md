...
![Diagram showing upstream origin servers receiving GET requests for two different sports URLs.](https://docs.aws.amazon.com/medialive/latest/ug/images/hls-pull-uss-input.png)
