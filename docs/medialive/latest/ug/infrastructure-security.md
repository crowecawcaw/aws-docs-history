# Infrastructure security in AWS Elemental MediaLive

As a managed service, AWS Elemental MediaLive is protected by AWS global network security. For
...
You use AWS published API calls to access MediaLive through the network. Clients must
