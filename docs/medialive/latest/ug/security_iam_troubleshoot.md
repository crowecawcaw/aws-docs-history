...
AWS Elemental MediaLive identity and access
...
- [I am not
  authorized to perform an action in MediaLive](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
- [I am not
...
- [I
  ...
  MediaLive resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not

authorized to perform an action in MediaLive
...
- To learn whether MediaLive supports these features, see [How AWS Elemental MediaLive works
