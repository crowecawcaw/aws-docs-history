...
1. Identify the output groups that you need to produce, based on the
   systems that are downstream of MediaLive. See [Identify the output group types for the downstream system](identify-downstream-system.md "identify-downstream-system.md").
2. Identify the requirements for the video and audio encodes that you
   will include in each output group. See [Identify the encode requirements for the output groups](identify-dss-video-audio.md "identify-dss-video-audio.md").
