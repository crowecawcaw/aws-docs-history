...
| Font size                                                        | Match size of source captions, if specified. Otherwise, set to 80% of the<br>available height available for captions. | Left blank.                                  |
| Font family                                                      | Match family of source captions, if specified. Otherwise, set to<br>**monospaceSansSerif**.                           | Left blank.                                  |
