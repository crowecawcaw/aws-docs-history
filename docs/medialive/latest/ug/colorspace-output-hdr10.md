...
| Content in HDR10 |  +  Doesn't touch the color space (the pixel values) in the output. <br />+  Passes through the color space metadata. <br />+  Passes through the brightness metadata and the display metadata.    | 
