...
![Two clusters: CL-A contains nodes Nd-1 through Nd-4 and channel placement groups CPG-W, CPG-X, and CPG-Y with multiple channels; CL-B contains nodes Nd-5 and Nd-6 and CPG-Z with one channel.](http://docs.aws.amazon.com/medialive/latest/ug/images/anywhere_cluster_cnp.png)
