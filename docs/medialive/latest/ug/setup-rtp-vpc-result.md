...
![Two upstream systems pushing RTP input to MediaLive via VPC subnets with IP addresses.](http://docs.aws.amazon.com/medialive/latest/ug/images/rtp-vpc-uss-input.png)
