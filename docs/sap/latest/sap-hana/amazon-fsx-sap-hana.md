...
- ** HDB\_data\_mnt00001 **
  - **Junction path:** HDB\_data\_mnt00001
  - **Directory:** -
  - **Mount point:** /hana/data/HDB/mnt00001

- ** HDB\_log\_mnt00001 **
  - **Junction path:** HDB\_log\_mnt00001
  - **Directory:** -
  - **Mount point:** /hana/log/HDB/mnt00001

- ** HDB\_shared **
  - **Junction path:** HDB\_shared
  - **Directory:** usr-sap / **Mount point:** /usr/sap/HDB
  - **Directory:** shared / **Mount point:** /hana/shared
