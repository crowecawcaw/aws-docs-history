...
You do not need a cluster placement group to obtain minimum required single flow network throughput for SAP HANA scale-out systems after successfully enabling ENA Express. To remove a placement group, see [Working with placement groups](../../../-AWSEC2/latest/UserGuide/placement-groups.md#concepts-placement-groups "../../../-AWSEC2/latest/UserGuide/placement-groups.md#concepts-placement-groups").
