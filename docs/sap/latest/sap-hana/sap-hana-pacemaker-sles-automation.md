...
For reliable cluster operations, thoroughly test your system regardless of setup method. Testing helps identify system anomalies, validate changing requirements, and build operational understanding. See [Testing](sap-hana-pacemaker-sles-testing.md "sap-hana-pacemaker-sles-testing.md") for more details.
