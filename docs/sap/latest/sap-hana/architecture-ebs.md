...
![Configuration for scale-up SAP HANA workloads.](https://docs.aws.amazon.com/sap/latest/sap-hana/images/std-sap-hana-scale-up-diagram.png)
...
![configuration for scale-out SAP HANA workloads.](https://docs.aws.amazon.com/sap/latest/sap-hana/images/std-sap-hana-scale-out-diagram.png)
