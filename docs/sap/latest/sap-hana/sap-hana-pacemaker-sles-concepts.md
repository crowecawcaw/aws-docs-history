...
SUSE supports several fencing agents, including the ones recommended for use with Amazon EC2 Instances (`fence_aws` for SLES 15 SP5 and above, or `external/ec2` for older releases).