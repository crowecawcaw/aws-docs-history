...
|  |  |  |  |  |  |  |  | 
| --- |--- |--- |--- |--- |--- |--- |--- |
|  **Instance type**  |  **Memory (GiB)**  |  **vCPUs / logical processors**\* |  **General Purpose SSD (gp3) storage with LVM**  |  **Configured throughput per volume (MiB/s)**  |  **Configured IOPS per volume**  |  **Total throughput (MiB/s)**  |  **Total IOPS**  | 
...
|  |  |  |  |  |  |  | 
| --- |--- |--- |--- |--- |--- |--- |
|  **Instance type**  |  **Memory (GiB)**  |  **vCPUs / logical processors**\* |  **Provisioned IOPS SSD (io1/io2) storage with LVM**  |  **Total maximum throughput (MiB/s)**  |  **Provisioned IOPS per volume**  |  **Total provisioned IOPS**  | 
...
|  |  |  |  |  |  |  | 
| --- |--- |--- |--- |--- |--- |--- |
|  **Instance type**  |  **Memory (GiB)**  |  **vCPUs / logical processors**\* |  **Root volume**  |  **SAP binaries**  |  **SAP HANA shared**\*\* |  **SAP HANA backup**\*\*\* | 
