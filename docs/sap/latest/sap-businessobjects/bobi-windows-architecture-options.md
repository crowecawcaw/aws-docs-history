...
<a name="bobi-windows-architecture-options"></a>
...
<a name="bobi-windows-cms-and-audit-database-architecture-options"></a>
...
![SAP BOBI with multi-AZ and multi-instance architecture](https://docs.aws.amazon.com/sap/latest/sap-businessobjects/images/bobi-multi-az-instance-arch-win.png)
