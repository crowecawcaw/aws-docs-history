...
# Security & Compliance
<a name="bobi-linux-security-compliance"></a>
...
+  [Network and security features for Linux and Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EC2_Network_and_Security.html) 

## OS Hardening
<a name="bobi-linux-os-hardening"></a>
...
## Encryption
<a name="bobi-linux-encryption"></a>
...
+  [Encrypting Amazon EFS Data at Rest and Data in Transit](https://docs.aws.amazon.com/efs/latest/ug/encryption.html) 
...
<a name="bobi-linux-security-groups-nacls"></a>
...
## API Call Logging
<a name="bobi-linux-api-call-logging"></a>
...
<a name="bobi-linux-notifications-on-access"></a>
