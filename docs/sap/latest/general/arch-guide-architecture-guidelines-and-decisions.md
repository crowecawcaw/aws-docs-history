...
[Amazon Virtual Private Cloud](../../../vpc/latest/userguide.md "../../../vpc/latest/userguide.md") (Amazon VPC) supports [Inter-Region peering](../../../vpc/latest/peering/what-is-vpc-peering.md "../../../vpc/latest/peering/what-is-vpc-peering.md") between two VPCs in different Regions. This can be used to allow network traffic, such as database replication traffic to flow between two [Amazon EC2](https://docs.aws.amazon.comAWSEC2/latest/UserGuide/concepts.html "https://docs.aws.amazon.comAWSEC2/latest/UserGuide/concepts.html") instances in different Regions. Inter-Region peering incurs data transfer costs.
