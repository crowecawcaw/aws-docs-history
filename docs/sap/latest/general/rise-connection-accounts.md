...
![Example connections in a single Region.](https://docs.aws.amazon.com/sap/latest/general/images/connectivity-own.jpg)


The following image shows this option across different AWS Regions.

![Example connections across Regions.](https://docs.aws.amazon.com/sap/latest/general/images/connectivity-own-regions.jpg)
