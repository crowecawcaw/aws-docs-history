...
![Amazon QuickSight.](images/rise-amazon-q-in-quicksight.png)
...
3. Create a QuickSight dataset and topic based on the Athena query.
4. Now using Q in QuickSight, you can interact with the data generated by SAP reports using natural language and get insights of data, to build dashboard and generate stories.
