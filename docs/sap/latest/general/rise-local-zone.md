...
Cost of data transferred between a Local Zone and an Availability Zone within the same AWS Region, "in" to and "out" from Amazon EC2 in the Local Zone varies. For more information see: {https---aws-amazon-com-ec2-pricing-on-demand—​Data-Transfer-within-the-same-AWS-Region}[EC2 - On-Demand Pricing - Data Transfer within the same AWS Region]
