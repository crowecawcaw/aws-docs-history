...
<a name="shared_aws_sdk_for_sap_abap"></a>
...
![Data flow for SAP ABAP SDK.](https://docs.aws.amazon.com/sap/latest/general/images/rise-abap.png)
...
<a name="_compatibility_packs_and_alternatives"></a>
