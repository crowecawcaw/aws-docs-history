...
When connecting your remote network directly to RISE using AWS Site-to-Site VPN, the cost for the AWS VPN Connection and the cost for data transfer out are included in the RISE subscription.
