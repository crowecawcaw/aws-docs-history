...
# mTLS Authentication
<a name="rise-mtls-authentication"></a>
...
1. The client presents its certificate, and the server verifies it to complete mutual authentication.

## Benefits of mTLS Authentication for SAP
<a name="_benefits_of_mtls_authentication_for_sap"></a>
...
<a name="_mtls_client_authentication_with_application_load_balancer"></a>
...
<a name="_mtls_architecture_diagram"></a>
...
<a name="_mtls_passthrough_mode"></a>
...
<a name="_comparison_of_mtls_verify_mode_mtls_passthrough_mode_and_nlb_passthrough"></a>
