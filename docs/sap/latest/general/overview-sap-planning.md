...
# SAP on AWS Planning
<a name="overview-sap-planning"></a>
...
### Choosing a Region
<a name="overview-choose-region"></a>
...
<a name="overview-network-connectivity"></a>

### Amazon VPC
<a name="overview-vpc"></a>
...
<a name="overview-private-network"></a>
...
<a name="overview-direct-internet"></a>
...
### Amazon VPC
<a name="overview-vpc-security"></a>
...
<a name="overview-instance-types"></a>
...
<a name="overview-nw-instances"></a>
...
### SAP HANA
<a name="overview-hana-instances"></a>
...
<a name="overview-b1-instances"></a>
...
| --- | --- | 
|  **SLES**  | On-demand \| [BYOL](https://www.suse.com/promo/cloud/public/aws/)  | 
|  **SLES for SAP**  |  [AWS Marketplace](https://aws.amazon.com/marketplace/search/results?x=0&y=0&searchTerms=SUSE+SAP+Applications) \| [BYOL](https://www.suse.com/promo/cloud/public/aws/sap-hana/)  | 
|  **RHEL**  | On-demand \| [BYOL](https://aws.amazon.com/partners/redhat)  | 
|  **RHEL for SAP with HA and US**  |  [AWS Marketplace](https://aws.amazon.com/marketplace/pp/prodview-puvcki5kgypyy) \| BYOL | 
|  **Windows**  | On-demand \| [BYOL](https://aws.amazon.com/windows/resources/licensing)  | 
|  **Oracle Linux**  |  [BYOL](https://aws.amazon.com/oracle)  | 

## Databases
<a name="overview-db"></a>

### Supported Databases
<a name="overview-db-support"></a>
...
<a name="overview-db-admin"></a>

#### Customer-Managed Database on Amazon EC2
<a name="overview-self-managed"></a>
...
|  **Microsoft SQL Server**  |  [BYOL](https://aws.amazon.com/windows/resources/licensing)\* | 
