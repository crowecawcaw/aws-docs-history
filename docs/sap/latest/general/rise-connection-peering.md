...
![VPC peering connections between multiple accounts in multiple Regions.](https://docs.aws.amazon.com/sap/latest/general/images/connectivity-peering.jpg)
