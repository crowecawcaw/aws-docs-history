...
| **Resilience type** | **Recovery point objective**    | **Recovery time objective**  | **Cost**                   | **Complexity** |
| **SQL AlwaysOn**    | **Amazon S3 replication**       |
...
| Pattern 4           | Near zero\*                     | Low                          | High                       | High           | 3-tier | Cross Region |                                                                                                                                                   | Pattern 5 | Medium | High | Low | Low | N/A | Cross Region |
| Pattern 6           | Low                             | Low                          | Medium                     | Medium         | N/A    | N/A          | _\*To achieve near zero recovery point objective, database replication must be setup in synchronous data commit mode within the same AWS Region._ |
