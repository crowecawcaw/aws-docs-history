...
![Connecting to cloud solutions or SaaS from RISE.](https://docs.aws.amazon.com/sap/latest/general/images/rise-saas1.png)


If your cloud is running on other data centre or with another cloud service provider, then you need internet connectivity.

![Connecting to cloud solutions or SaaS from RISE.](https://docs.aws.amazon.com/sap/latest/general/images/rise-saas2.png)
