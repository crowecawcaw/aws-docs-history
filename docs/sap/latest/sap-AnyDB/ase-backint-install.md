...
| `EnableTagging`        | Enables or disables default object tagging for backups files stored in S3.<br>Tagging helps to identify the AWS Backint version and SAP HANA version used during the backup. | `true`        | `true`, `false`                                                                                   |
