...
# Prerequisites
<a name="ase-backint-preprequisites"></a>

This section provides information on mandatory prerequisites for AWS Backint Agent for SAP ASE.

**Topics**
+ [AWS Identity and Access Management (IAM)](#ase-backint-iam)
+ [Amazon S3 Bucket](#ase-backint-s3-bucket)

## AWS Identity and Access Management (IAM)
<a name="ase-backint-iam"></a>
...
### S3 storage classes
<a name="ase-backint-s3-storage-classes"></a>
...
### Encryption
<a name="ase-backint-encryption"></a>
...
### Object locking
<a name="ase-backint-object-locking"></a>
...
### Object tagging
<a name="ase-backint-object-tagging"></a>
