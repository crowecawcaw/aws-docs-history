...
# Vendor Support
<a name="sap-nw-pacemaker-rhel-references"></a>

The following section details the documentation and deployment guidance from Red Hat.

**Topics**
+ [Deployment Patterns](#deployments-rhel)
+ [Automated Deployment](#automation-nw-rhel)
+ [Pacemaker - simple-mount and classic architecture](#simple-classic-nw-rhel)
...
<a name="simple-classic-nw-rhel"></a>
...
<a name="switching-architecture-rhel"></a>
