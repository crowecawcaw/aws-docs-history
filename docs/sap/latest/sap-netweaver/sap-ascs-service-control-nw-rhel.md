...
You can confirm whether systemd is in place by running the following command. Systemd is in place if SAP Services (e.g., SAPRHX\_00.service, SAPRHX\_10.service) are listed.
