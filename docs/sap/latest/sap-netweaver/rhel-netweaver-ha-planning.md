...
Protecting ASCS with a pacemaker cluster requires packages from Red Hat, including targeted cluster resource agents for SAP and AWS that may not be available in standard repositories.
...
ASCS is a single point of failure in a highly available SAP architecture. We recommend evaluating the impact of design decisions on cost, operation, and reliability. For more information, see [Reliability](../../../wellarchitected/latest/sap-lens/reliability.md "../../../wellarchitected/latest/sap-lens/reliability.md") in SAP Lens - AWS Well-Architected Framework.

## SAP and Red Hat references

In addition to this guide, see the following references for more details.

- [Red Hat documentation – SAP S/4 HANA - Enqueue Replication 2 High Availability Cluster - Setup Guide](https://access.redhat.com/articles/4175371 "https://access.redhat.com/articles/4175371")
- [Red Hat documentation – SAP NetWeaver - Enqueue Replication 1 High Availability Cluster - Setup Guide](https://access.redhat.com/articles/3916511 "https://access.redhat.com/articles/3916511")
- [Red Hat documentation – Red Hat Enterprise Linux for SAP offerings on Amazon Web Services FAQ](https://access.redhat.com/articles/3671571 "https://access.redhat.com/articles/3671571")
- [SAP Note: 1656099 - SAP Applications on AWS: Supsported DB/OS and Amazon EC2 products](https://launchpad.support.sap.com/#/notes/1656099 "https://launchpad.support.sap.com/#/notes/1656099")
