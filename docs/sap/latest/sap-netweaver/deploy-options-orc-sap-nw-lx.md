...
**Note**  
When using native Oracle with SAP and AWS features, the design must be a subset of supported features, as described in [SAP Note 105047](https://me.sap.com/notes/105047) and [SAP Note 2358420](https://me.sap.com/notes/2358420).
...
+  [Using SIOS to Protect your Critical Core on AWS](https://aws.amazon.com/blogs/awsforsap/using-sios-to-protect-your-critical-core-on-aws/) 
+  [High Availability Configuration in AWS Cloud using InfoScale Enterprise](https://www.veritas.com/support/en_US/doc/ka6j000000009eOAAQ) 
