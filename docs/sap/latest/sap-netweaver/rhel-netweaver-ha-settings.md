...
| ENSA Type              | `<ensa_type>`            | `ENSA2/ENSA1`          |
...
| Cluster connector | `cluster_connector` | `sap-cluster-connector` |
...
If you are using a Shared VPC, see [Shared VPC – optional](#rhel-netweaver-ha-shared-vpc "#rhel-netweaver-ha-shared-vpc").
...
| ----------------------------- | -------------------- |
| RHX_sapmnt                    | /sapmnt/RHX          |
| RHX_ASCS00                    | /usr/sap/RHX/ASCS00  |
| RHX_ERS10                     | /usr/sap/RHX/ERS10   |
...
- [Shared VPC cluster resources](#shared-vpc-cluster-resources "#shared-vpc-cluster-resources")
