...
# Parameter Reference
<a name="sap-nw-pacemaker-rhel-parameters"></a>

The cluster setup relies on the following parameters.

**Topics**
+ [Global AWS parameters](#global-aws-parameters-nw-rhel)
+ [Amazon EC2 instance parameters](#ec2-parameters-nw-rhel)
+ [SAP Instance Parameters](#sap-pacemaker-resource-parameters-nw-rhel)
+ [Pacemaker Parameters](#rhel-cluster-parameters)

## Global AWS parameters
<a name="global-aws-parameters-nw-rhel"></a>
...
<a name="ec2-parameters-nw-rhel"></a>
...
<a name="sap-pacemaker-resource-parameters-nw-rhel"></a>
