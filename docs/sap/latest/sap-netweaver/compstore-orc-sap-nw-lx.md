...
Aside from operating system maintenance, you should consider maintenance for your Amazon EC2 instances. It can be driven by using [Automation runbook](https://docs.aws.amazon.com/systems-manager/latest/userguide/automation-documents.html). The following are some examples.
