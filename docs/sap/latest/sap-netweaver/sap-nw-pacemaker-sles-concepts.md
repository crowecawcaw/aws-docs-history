...
- [SAP – ABAP SAP Central Services (ASCS)](#ascs-nw-sles "#ascs-nw-sles")
- [SAP – Enqueue Replication Server (ERS)](#ers-nw-sles "#ers-nw-sles")
- [AWS – Availability Zones](#availability-zones-nw-sles "#availability-zones-nw-sles")
- [AWS – Overlay IP](#overlay-ip-sles "#overlay-ip-sles")
- [AWS – Shared VPC](#shared-vpc "#shared-vpc")
- [Pacemaker - STONITH fencing agent](#stonith-nw-sles "#stonith-nw-sles")
