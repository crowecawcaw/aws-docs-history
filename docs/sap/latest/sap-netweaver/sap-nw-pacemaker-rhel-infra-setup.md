...
<a name="sap-nw-pacemaker-rhel-infra-setup"></a>
...
**Topics**
+ [Create IAM Roles and Policies for Pacemaker](#iam-roles-rhel)
...
### STONITH Policy
<a name="stonith-policy-nw-rhel"></a>
...
<a name="overlay-policy-nw-rhel"></a>
