...
| media       | Amazon Elastic File System (Amazon EFS) Amazon FSx for NetApp ONTAP             | Single Availability Zone or Multi-Availability Zone | ###### Note In a standard installation, `/usr/sap` can also be mounted on Amazon EFS. Directories for interfaces and media are optional. |
