...
- [Test 1: Stop ASCS on the primary node using sapcontrol](#test1 "#test1")
- [Test 2: Stop ERS on the secondary node using sapcontrol](#test2 "#test2")
- [Test 3: Kill the message server process on the primary node](#test3 "#test3")
- [Test 4: Kill the enqueue server process on the primary node](#test4 "#test4")
- [Test 5: Kill the ER process](#test5 "#test5")
- [Test 6: Simulate hardware failure of an individual node, and repeat for other node](#test6 "#test6")
- [Test 7: Simulate a network failure](#test7 "#test7")
- [Test 8: Simulate an NFS failure](#test8 "#test8")
- [Test 9: Accidental shutdown](#test9 "#test9")
