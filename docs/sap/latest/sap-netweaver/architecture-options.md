...
- **High Availability (HA) system**: For your SAP application to be highly available, you need to protect the single point of failures. Database is one single point of failure in SAP applications. There are two methods you can use to protect SQL Server and make it highly available.
      ...
      + Third-party solutions: For example, [SIOS Data Keeper](https://us.sios.com/solutions/sql-server-high-availability/ "https://us.sios.com/solutions/sql-server-high-availability/"), [Veritas InfoScale](https://www.veritas.com/support/en_US/doc/ka6j000000009eOAAQ "https://www.veritas.com/support/en_US/doc/ka6j000000009eOAAQ").
