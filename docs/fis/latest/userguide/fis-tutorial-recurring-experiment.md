...
**Topics**
+ [Prerequisites](#recurring-experiment-prerequisites)
+ [Step 1: Create an IAM role and policy](#recurring-experiment-step1)
+ [Step 2: Create an Amazon EventBridge Scheduler](#recurring-experiment-step2)
+ [Step 3: Verify your experiment](#recurring-experiment-step3)
+ [Step 4: Clean up](#recurring-experiment-step4)
