...
**Topics**
+ [Concepts for safety levers](#concepts-for-safety-levers)
+ [Working with safety levers](#working-with-safety-levers)
...
1. If the safety lever is engaged, you will see an alert banner across the top of the page. If there is no alert banner, the safety lever is disengaged.
...
1. Choose the **Stop all experiments** button.

1. Enter the reason for engaging the safety lever.
...
1. Choose the **Disengage safety lever** button.

1. Enter the reason for disengaging the safety lever.
