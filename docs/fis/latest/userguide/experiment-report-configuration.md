...
![Two graphs showing processed bytes for use1-az4 increasing and use1-az6 decreasing during experiment.](http://docs.aws.amazon.com/fis/latest/userguide/images/packet-loss-az-example.png)
