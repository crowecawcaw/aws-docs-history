...
**Topics**
+ [Prerequisites](#create-fis-role-prereqs)
+ [Option 1: Create an experiment role and attach an AWS managed policy](#fis-role-managed-policy)
+ [Option 2: Create an experiment role and add an inline policy document](#fis-role-inline-policy-document)
