...
+ [Create a Trail for Your AWS Account](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.html)
...
All AWS FIS actions are logged by CloudTrail and are documented in the [AWS Fault Injection Service API Reference](https://docs.aws.amazon.com/fis/latest/APIReference/). For the experiment actions that are carried out on a target resource, view the API reference documentation for the service that owns the resource. For example, for actions that are carried out on an Amazon EC2 instance, see the [Amazon EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/).
