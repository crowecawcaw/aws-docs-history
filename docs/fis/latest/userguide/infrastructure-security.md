...
As a managed service, AWS Fault Injection Service is protected by AWS global network security. For
...
You use AWS published API calls to access AWS FIS through the network. Clients must
