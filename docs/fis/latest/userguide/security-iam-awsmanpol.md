...
| [AWSFaultInjectionSimulatorNetworkAccess](#AWSFaultInjectionSimulatorNetworkAccess "#AWSFaultInjectionSimulatorNetworkAccess") –<br>Update to an existing policy        | Added permissions to allow AWS FIS to run experiments using the *_aws:network:route-table-disrupt-cross-region-connectivity_<br>• and *_aws:network:transit-gateway-disrupt-cross-region-connectivity_<br>• actions.         | January 25, 2024  |
