...
Before you use IAM to manage access to AWS FIS, learn what IAM features are
available to use with AWS FIS.

| IAM features you can use with AWS Fault Injection Service                                                                                                                   | IAM feature | AWS FIS support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------- |
...
To see a list of AWS FIS actions, see [Actions defined by AWS Fault Injection Service](../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions "../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions") in the
...
Some AWS FIS API actions support multiple resources. To specify multiple
...
To see a list of AWS FIS resource types and their ARNs, see
[Resource types defined by AWS Fault Injection Service](../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by AWS Fault Injection Service](../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions "../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions").
...
To see a list of AWS FIS condition keys, see [Condition keys for AWS Fault Injection Service](../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-policy-keys "../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-policy-keys")
in the _Service Authorization Reference_. To learn with which actions and
resources you can use a condition key, see [Actions defined by AWS Fault Injection Service](../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions "../../../service-authorization/latest/reference/list_awsfaultinjectionservice.md#amazonec2-actions-as-permissions").
...
For details about creating or managing AWS FIS service-linked roles, see [Use service-linked roles for AWS Fault Injection Service](using-service-linked-roles.md "using-service-linked-roles.md").
