...
- View your experiments in the AWS FIS console. For more information, see [View your experiments](view-experiment-progress.md "view-experiment-progress.md").
- View Amazon CloudWatch metrics for the target resources in your experiments or view
  AWS FIS usage metrics. For more information, see [Monitor using CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md").
