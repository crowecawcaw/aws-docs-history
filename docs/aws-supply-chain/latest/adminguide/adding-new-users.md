...
Identity Center (IdC), and then they can be added to AWS Supply Chain. For more information about adding users to IdC,
see [Assign user access](../../../singlesignon/latest/userguide/get-started-assign-account-access-user.md "../../../singlesignon/latest/userguide/get-started-assign-account-access-user.md").
