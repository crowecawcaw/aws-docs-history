...
In this section, you can learn to create an AWS Supply Chain instance, grant user
permission roles,
log
into the AWS Supply Chain web application, and create custom user
permission roles. An AWS account can have up to 10 AWS Supply Chain instances in active
or initializing
state.
