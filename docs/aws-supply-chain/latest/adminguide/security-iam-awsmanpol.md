...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ |
| [AWSSupplyChainFederationAdminAccess](#security-iam-awsmanpol-AWSSupplyChainFederationAdminAccess "#security-iam-awsmanpol-AWSSupplyChainFederationAdminAccess") – Updated policy | AWS Supply Chain updated the managed policy to allow federated users access to ListApplicationAssignments, DescribeApplication, DescribeInstance, and GetApplicationAssignmentConfiguration operations in IAM Identity Center. | December 10, 2024  |
