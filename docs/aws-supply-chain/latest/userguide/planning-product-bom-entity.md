...
| Name        | Column                               |
| ----------- | ------------------------------------ |
| product_bom | id, product_id, component_product_id |
...
or EDI, the default values for string and timestamp date type values are: SCN_RESERVED_NO_VALUE_PROVIDED for _string_; and for
