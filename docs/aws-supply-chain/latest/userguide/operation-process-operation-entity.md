...
| Name                 | Column                           |
| -------------------- | -------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| process_operation    | process_operation_id, process_id | The table below lists the column names supported by the _process_operation_ data entity: |
...
| planned_end_dttm     | timestamp                        | No                                                                                       | Planned end date-time of operation.                                 | 1Foreign key **Foreign key (FK)** The table below lists the columns with the associated foreign key. |
