...
| Name                     | Column       |
| ------------------------ | ------------ | -------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| product_hierarchy        | id           | The table below lists the column names supported by the data entity: |
...
| parent_product_group_id1 | string       | No                                                                   | Parent of this product group. If null, it indicates this record is a top level product group. |
...
| source                   | string       | No                                                                   | Source of data.                                                                               | 1Foreign key **Foreign key (FK)** The table below lists the columns with the associated foreign key. |
