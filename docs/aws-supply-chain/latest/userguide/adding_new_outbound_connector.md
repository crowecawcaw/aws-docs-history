...
The **Data Ingestion** page appears. 2. Choose **Add Outbound Source**.

The **Amazon S3 Connection details** page appears. 3. Under **Connection name**, enter a name for your Amazon S3 connection. 4. Under **Outbound Data**, select the outbound dataflow that you want to
export. Purchase order request and Supply forecast data flows are
supported. 5. Choose **Confirm**.
