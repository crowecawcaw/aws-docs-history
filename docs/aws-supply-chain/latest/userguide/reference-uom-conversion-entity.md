...
| Name           | Column                                               |
| -------------- | ---------------------------------------------------- |
| uom_conversion | uom, conversion_uom_id, eff_start_date, eff_end_date |

The table below lists the column names supported by the data entity:

| Column             | Data type | Required | Description                                                      |
| ------------------ | --------- | -------- | ---------------------------------------------------------------- |
| uom                | string    | Yes      | Unit of measure (UOM). For example, weight_uom,<br>currency_uom. |
| company_id2        | string    | No       | Company ID.                                                      |
| uom_code           | string    | No       | Alternate code for UOM.                                          |
| uom_description    | string    | No       | UOM description.                                                 |
| uom_type           | string    | No       | UOM type, for example, currency, weight, volume, or<br>unit.     |
