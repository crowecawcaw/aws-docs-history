...
| ZEINE                 | Purchasing Info ​Record: Purchasing ​Organization Data | ZV_EINE                                                                                             | ZEINE_SRV                   | Table          | Master data        | Full        |
...
| ZINB_​SHIPMENT        | Shipment Header ​and Item (Inbound)                    | ZV_INB_​SHIPMENT​ based with join ​condition: VTTK.MANDT = VTTP.MANDT​ and ​VTTK.TKNUM = VTTP.TKNUM | ZINB_SHIPMENT​_SRV          | Table          | Transa​ctional     | Full        |
