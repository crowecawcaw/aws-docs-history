...
![Viewing prebuilt dashboards](images/Prebuilt_dashboard_view.png) 7. Choose the share icon to share the dashboard with other AWS Supply Chain Analytics users. For more information on permission roles, see [Setting AWS Supply Chain Analytics](setting_analytics.md "setting_analytics.md").
