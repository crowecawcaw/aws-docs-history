...
![Setting AWS Supply Chain Analytics](images/analytics_settings.png) 3. Slide the **Enable data access for Analytics** button to enable AWS Supply Chain Analytics. 4. Under **User and Permissions**, choose **Permission Roles**.

You can edit the permission roles for a current user or add a new permission role to enable Analytics access.

![Setting AWS Supply Chain Analytics permissions](images/analytics_permissions.png) 5. On the **Manage Permission Role** page, under **Analytics**, slide the **Manage** or **View** button to grant read or write access.
