...
| ship_to_site_id   | Site that received the order       | Enter \*NULL<br>• to avoid forecast failure | Country, Region, State, or Zip – as applicable    | External retailer sore ID, or Country, Region, State, or Zip – as applicable               |
