...
If another user has made you their delegate, you can schedule meetings on their
behalf. For more information, see [Scheduling meetings on behalf of someone else](schedule_meeting_delegate.md "schedule_meeting_delegate.md").

###### Topics

- [Creating appointments](#create_appointment "#create_appointment")
- [Creating meeting requests](#create_meeting_request "#create_meeting_request")
- [Editing meetings and appointments](#edit_meeting_appointment "#edit_meeting_appointment")
- [Moving meetings and appointments](#move_meeting_appointment "#move_meeting_appointment")
- [Canceling or declining meeting requests](#cancel_decline_meeting "#cancel_decline_meeting")
- [Printing calendar items](#print_calendar_items "#print_calendar_items")
- [Deleting meetings and appointments](#delete_meeting_appointment "#delete_meeting_appointment")

## Creating appointments

You can create an appointment and set a reminder that automatically reminds you before
the appointment's start date and time.
...
3. Enter the following:
   ...
   - (Optional) For **Location**, specify a
     location.
...
You can also create an appointment by double-clicking in the
calendar.

## Creating meeting requests

You can create a meeting request that includes attendees and resources, and set a
reminder to remind you before the meeting starts.
...
3. To add one or more attendees, type their names in the **To**
   field. Amazon WorkMail suggests names from the address book. You can remove suggestions
   from this list by selecting a name and then pressing
   **Delete**. To add users from the address book or to add them
   to the **Required**, **Optional**, or
   **Resource** fields, choose **To**, and
...
5. In the lower portion of the meeting invitation, you can add information about
...
3. If you are the organizer of a meeting, do one of the following:
   ...
   - To save your changes to the meeting without sending an update to the
     other participants, choose **Save**.

## Moving meetings and appointments

You can move a meeting or appointment by clicking it and dragging it to a different
day or time. You can also edit the meeting or appointment to move it.
...
3. For a meeting, if prompted to send an update to attendees, choose
   **Yes**.
...
3. In the **Send meeting request cancellation** dialog box, do one of the following:
   - To send a message along with your response, choose **Edit the
     ...
     **OK**.
   - To send your response without comments, choose **Send the
     cancellation now**, **OK**.
...
1. In the Amazon WorkMail web application, on the shortcut bar, choose the calendar
   icon.
2. In the calendar, open the appointment, and then choose
   **Print**.
...
You can delete a meeting or appointment that you no longer plan to hold or
attend.
...
1. In the Amazon WorkMail web application, on the shortcut bar, select the calendar
   icon.
2. On the calendar, open the context (right-click) menu for the meeting or
