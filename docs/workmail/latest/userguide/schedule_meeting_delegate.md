...
2. At the bottom of the navigation pane, choose **Open other
   calendars**, **Name**.
3. In the address book, select the owner of the calendar to open and choose
   **OK**.
4. For **Folder type**, choose **Calendar**. To
   show the subfolders of the shared calendar, choose **Show
   subfolders**.Choose **OK**.
...
The next time that you log in to the Amazon WorkMail web application, the opened
folders are still displayed.
...
**Properties**, **Permissions**. 5. To create a meeting request, open the day and time on the calendar when the
meeting should occur. 6. To add one or more attendees, type their names into the
**To** field. Amazon WorkMail suggests names from the address
book. You can remove suggestions from this list by selecting a name and then
pressing **Delete**. To add users from the address book or to
add them to the **Required**, **Optional**, or
**Resource** fields, choose **To**, and
select one or more users from the address book and add them to the
**Required**, **Optional**, or
**Resource** fields as appropriate. 7. Enter values for the following:
