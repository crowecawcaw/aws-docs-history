...
- [Creating contacts](#create_contact "#create_contact")
- [Editing contacts](#edit_contact "#edit_contact")
- [Copying or moving contacts](#copy_move_contact "#copy_move_contact")
- [Printing contacts](#print_contact "#print_contact")
- [Deleting contacts](#delete_contact "#delete_contact")
...
3. In the contents pane, enter the contact's information in the appropriate fields.
...
1. In the Amazon WorkMail web application, on the shortcut bar, choose the contacts
   icon.
2. In the navigation pane, under **My Contacts**, choose
   **Contacts**.
3. In the contents pane, open the contact to edit.
4. Update the contact information as appropriate, and choose
   **Save**.
...
2. In the navigation pane, under **My Contacts**, choose
   **Contacts**.
3. Select the contact, choose **Copy/Move**, select the
   destination folder, and then choose either **Copy** or
   **Move**.
...
1. In the Amazon WorkMail web application, on the shortcut bar, select the contacts
   icon.
2. In the navigation pane, under **My Contacts**, select the
   **Contacts** folder that contains the contact to
   print.
3. In the contents pane, double-click the contact to print. On the menu bar,
   choose **Print**.
...
2. In the navigation pane, under **My Contacts**, choose
   **Contacts**.
3. In the contents pane, open the context (right-click) menu for the contact and
   choose **Delete**.

###### Note

To restore a contact that you deleted by mistake, drag the contact from
the **Deleted Items** folder back to the
**Contacts** folder.
