...
Shortcut keys are globally applicable and not specific to screen reader software. Keyboard shortcuts are disabled by default. To
enable keyboard shortcuts, see [Working with general and email settings](general-settings.md "general-settings.md").
...
- **Ctrl+0-9** - Switch between context such as inbox, calendar,
  etc.
...
- **Ctrl+P** - Print item
- **Ctrl+S** - Save an item, such as a message, contact,
  etc.
