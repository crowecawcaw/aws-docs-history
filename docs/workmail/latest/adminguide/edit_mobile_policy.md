...
1. Update any of the following as necessary:
   ...
   1. **Number of failed attempts allowed**: Specify the number of failed device unlock attempts that are allowed before the user's device is wiped. All data, including personal files will be deleted when the device is wiped.
