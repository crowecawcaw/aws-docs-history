...
+ Enable message tracking in Amazon WorkMail, and then check the logs for delivery problems. For more information about message tracking, see [Enabling email event logging](tracking.md).
