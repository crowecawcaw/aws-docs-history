...
1. Enable the user account that you are migrating to Amazon WorkMail. For more information, see [Enable existing users](https://docs.aws.amazon.com/workmail/latest/adminguide/enable_user.html).
