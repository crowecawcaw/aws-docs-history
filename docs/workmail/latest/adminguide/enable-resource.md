...
organization which contains the resource that you want to enable. 3. In the navigation pane, choose **Resources**. 4. In the list of resources, select the button next to the resource that you want
to enable, and then choose **Enable**.

The **Enable resource** dialog box appears. 5. Choose **Enable**.
