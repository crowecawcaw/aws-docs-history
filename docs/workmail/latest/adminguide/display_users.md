...
window, open the **Select a Region** list
and choose a Region. For more information, see [Region and endpoints](../../../general/latest/gr/rande.md "../../../general/latest/gr/rande.md") in
the _Amazon Web Services General Reference_. 2. In the navigation pane, choose **Organizations** and then choose the name of your organization. 3. In the navigation pane, choose **Users**. 4. Additionally, you can filter users by **Username**, **Display name**, or **Primary email address**.
