...
_Amazon Web Services General Reference_. 2. In the navigation pane, choose **Organizations**, then choose the name of your organization. 3. In the navigation pane, choose **Groups**, and then choose
**Add group**.

The **Add group** page appears. 4. Under **Group name**, enter a name for the group. 5. Under **Email address**, enter the primary email address for
the group. 6. Verify the group's email address, update as required. 7. By default, the group is displayed in the global address list. To hide the group from the global address list, clear the **Show in global address list** check box. 8. Choose **Add group**.
