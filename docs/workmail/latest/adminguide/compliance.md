...
Third-party auditors assess the security and compliance of Amazon WorkMail as part of
multiple AWS compliance programs. These include SOC, ISO, and C5.
...
Your compliance responsibility when using Amazon WorkMail is determined by the sensitivity
