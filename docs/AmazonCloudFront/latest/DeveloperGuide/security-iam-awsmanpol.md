...
To add permissions to users, groups, and roles, it’s easier to use AWS managed policies
 ...
 policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_create-console.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_create-console.html") that provide your users with only the permissions they need. To get started
 ...
 managed policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html#aws-managed-policies "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html#aws-managed-policies") in the *IAM User Guide*.
...
To view the permissions for this policy, see [CloudFrontReadOnlyAccess](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/CloudFrontReadOnlyAccess.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/CloudFrontReadOnlyAccess.html") in the *AWS Managed Policy Reference*.
...
To view the permissions for this policy, see [CloudFrontFullAccess](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/CloudFrontFullAccess.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/CloudFrontFullAccess.html") in the *AWS Managed Policy Reference*.
...
To view the permissions for this policy, see [AWSCloudFrontLogger](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFrontLogger.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFrontLogger.html") in the *AWS Managed Policy Reference*.
...
To view the permissions for this policy, see [AWSLambdaReplicator](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSLambdaReplicator.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSLambdaReplicator.html") in the *AWS Managed Policy Reference*.
...
To view the permissions for this policy, see [AWSCloudFrontVPCOriginServiceRolePolicy](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFrontVPCOriginServiceRolePolicy.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/AWSCloudFrontVPCOriginServiceRolePolicy.html") in the *AWS Managed Policy Reference*.
