...
- [HTTP 403 status code (Permission Denied)](http-403-permission-denied.md "http-403-permission-denied.md")
- [HTTP 404 status code (Not Found)](http-404-not-found.md "http-404-not-found.md")
- [HTTP 412 status code (Precondition Failed)](http-412-precondition-failed.md "http-412-precondition-failed.md")
- [HTTP 500 status code (Internal Server Error)](http-500-internal-server-error.md "http-500-internal-server-error.md")
- [HTTP 502 status code (Bad Gateway)](http-502-bad-gateway.md "http-502-bad-gateway.md")
- [HTTP 503 status code (Service Unavailable)](http-503-service-unavailable.md "http-503-service-unavailable.md")
- [HTTP 504 status code (Gateway Timeout)](http-504-gateway-timeout.md "http-504-gateway-timeout.md")
