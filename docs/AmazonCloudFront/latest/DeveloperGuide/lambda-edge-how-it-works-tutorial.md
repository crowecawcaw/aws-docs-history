...
3. On the **Create function** page, choose **Use
...
CloudFront blueprints are available only in the **US-East-1 (N.
 Virginia)** Region
 (**us-east-1**).
4. Choose the **Modify HTTP response header** blueprint
...
For more information about the CloudFront domain name to use in the file
 URL, see [Customize the URL format for files in CloudFront](LinkFormat.md "LinkFormat.md").
...
Now, you can delete your bucket. For more information, see [Deleting a bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-bucket.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-bucket.html") in the *Amazon Simple Storage
