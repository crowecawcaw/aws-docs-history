...
1. Choose the distribution that you want to use as the *primary distribution*. The primary distribution is one that currently
 serves production traffic.
2. From the primary distribution, create a *staging
 distribution*. A staging distribution starts as a copy of the primary
 distribution.
3. Create a *traffic configuration* inside a
 *continuous deployment policy*, and attach it
 ...
 *promote* the staging distribution's
