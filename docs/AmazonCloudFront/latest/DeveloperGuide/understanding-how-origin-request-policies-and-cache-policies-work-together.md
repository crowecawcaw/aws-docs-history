 ...
 *origin requests*. To use an origin request policy, you
...
| **Cache policy** | | **None** | No values from the viewer request are included in the origin request, except for the defaults that are included in every origin request. For more information, see [Control origin requests with a policy](controlling-origin-requests.md "controlling-origin-requests.md"). | All values from the viewer request are included in the origin request. | Only the values specified in the origin request policy are included in the origin request. | All values from the viewer request ***except*** those specified in the origin request policy are included in the origin request. |
