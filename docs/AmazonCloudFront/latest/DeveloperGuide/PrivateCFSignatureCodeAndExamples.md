...
For example code in Python, see [Generate a signed URL for Amazon CloudFront](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudfront.html#examples "https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloudfront.html#examples") in the *AWS SDK for Python (Boto3) API Reference* and [this
 example code](https://github.com/boto/boto3/blob/develop/boto3/examples/cloudfront.rst "https://github.com/boto/boto3/blob/develop/boto3/examples/cloudfront.rst") in the Boto3 GitHub repository.
