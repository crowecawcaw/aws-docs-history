...
To call the [CloudFront KeyValueStore API](../../../cloudfront/latest/APIReference/API_Operations_Amazon_CloudFront_KeyValueStore.md "../../../cloudfront/latest/APIReference/API_Operations_Amazon_CloudFront_KeyValueStore.md"), use a _Regional_
endpoint in AWS STS to return a _version 2_ session token. If you
use the _global_ endpoint for AWS STS
(`sts.amazonaws.com`), AWS STS will generate a _version
1_ session token, which isn't supported by Signature Version 4A
...
endpoints. For more information, see [AWS STS Regionalized endpoints](../../../sdkref/latest/guide/feature-sts-regionalized-endpoints.md "../../../sdkref/latest/guide/feature-sts-regionalized-endpoints.md") in the
_AWS SDK and Tools Reference Guide_.

For more information about available AWS STS endpoints, see [Regions and endpoints](../../../IAM/latest/UserGuide/id_credentials_temp_enable-regions.md#id_credentials_region-endpoints "../../../IAM/latest/UserGuide/id_credentials_temp_enable-regions.md#id_credentials_region-endpoints") in the
_IAM User Guide_.
...
use the [SetSecurityTokenServicePreferences](../../../IAM/latest/APIReference/API_SetSecurityTokenServicePreferences.md "../../../IAM/latest/APIReference/API_SetSecurityTokenServicePreferences.md") API
