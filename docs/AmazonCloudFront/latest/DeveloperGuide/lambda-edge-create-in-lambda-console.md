...
Now**. 3. In the Region list at the top of the page, choose
**US East (N. Virginia)**. 4. Create a function using your own code or create a function starting with a
...
around the world, and the corresponding distribution is deployed. 7. Choose **Create function**.
