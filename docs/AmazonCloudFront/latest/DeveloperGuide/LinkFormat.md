...
distribution, see [Origin path](DownloadDistValuesOrigin.md#DownloadDistValuesOriginPath "DownloadDistValuesOrigin.md#DownloadDistValuesOriginPath").
...
an alternate domain name](distribution-web-values-specify.md#DownloadDistValuesCNAME "distribution-web-values-specify.md#DownloadDistValuesCNAME") that's easier to work with, like `example.com`.
...
or that are available only from a specified IP address. For more information, see [Serve private content with signed URLs and signed cookies](PrivateContent.md "PrivateContent.md").
