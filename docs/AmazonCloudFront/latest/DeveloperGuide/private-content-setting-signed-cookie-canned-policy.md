...
Defines how the browser (where supported) interacts with the cookie value. With
 ...
 For more information, see [Using HTTP cookies](https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies "https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies").
...
For information about UTC, see *RFC 3339, Date and
 Time on the Internet: Timestamps*, [https://tools.ietf.org/html/rfc3339](https://tools.ietf.org/html/rfc3339 "https://tools.ietf.org/html/rfc3339").
