...
`https://d111111abcdef8.cloudfront.net/images/image.jpg` 2. Save the HTML code in a file that has an .html file name extension. 3. Open your webpage in a browser to ensure that you can see your object.
