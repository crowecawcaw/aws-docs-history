...
costs with Amazon S3 Intelligent-Tiering](../../../AmazonS3/latest/userguide/intelligent-tiering.md "../../../AmazonS3/latest/userguide/intelligent-tiering.md") in the
_Amazon Simple Storage Service User Guide_.

### Use Amazon S3 Object Lambda

When you [create an Object Lambda
Access Point](../../../AmazonS3/latest/userguide/olap-create.md "../../../AmazonS3/latest/userguide/olap-create.md"), Amazon S3 automatically generates a unique alias for your
Object Lambda Access Point. You can [use this alias](../../../AmazonS3/latest/userguide/olap-use.md#ol-access-points-alias "../../../AmazonS3/latest/userguide/olap-use.md#ol-access-points-alias") instead of an Amazon S3 bucket name
...
Object Lambda Access Point](../../../AmazonS3/latest/userguide/olap-use.md#ol-access-points-alias "../../../AmazonS3/latest/userguide/olap-use.md#ol-access-points-alias") in the _Amazon S3 User Guide_.
...
Point](../../../AmazonS3/latest/userguide/creating-access-points.md "../../../AmazonS3/latest/userguide/creating-access-points.md"), Amazon S3 automatically generates a unique alias for you. You can
...
For more information about finding the
`alias`, see [Using a bucket-style alias for your S3 bucket access point](../../../AmazonS3/latest/userguide/access-points-alias.md "../../../AmazonS3/latest/userguide/access-points-alias.md") in the _Amazon S3 User Guide_.
...
For more information about specifying Amazon S3 static website endpoints, see [Website endpoints](../../../AmazonS3/latest/userguide/WebsiteEndpoints.md "../../../AmazonS3/latest/userguide/WebsiteEndpoints.md") in the _Amazon Simple Storage Service User Guide_.
...
distribution, too. 2. Create a test webpage that contains links to publicly readable objects
...
For more information about the format of CloudFront URLs, see [Customize the URL format for files in CloudFront](LinkFormat.md "LinkFormat.md"). 3. If you're using Amazon S3 CNAMEs, your application uses your domain name
...
resource record sets, see [Editing records](../../../Route53/latest/DeveloperGuide/resource-record-sets-editing.md "../../../Route53/latest/DeveloperGuide/resource-record-sets-editing.md"). For information about
alias resource record sets, see [Choosing between alias and non-alias
records](../../../Route53/latest/DeveloperGuide/resource-record-sets-choosing-alias-non-alias.md "../../../Route53/latest/DeveloperGuide/resource-record-sets-choosing-alias-non-alias.md"). Both topics are in the
...
A [Lambda
function URL](../../../lambda/latest/dg/lambda-urls.md "../../../lambda/latest/dg/lambda-urls.md") is a dedicated HTTPS endpoint for a Lambda function. You can
...
- [Lambda
  function URLs](../../../lambda/latest/dg/lambda-urls.md "../../../lambda/latest/dg/lambda-urls.md") – A general overview of the Lambda function URLs
  feature
- [Invoking Lambda function URLs](../../../lambda/latest/dg/urls-invocation.md "../../../lambda/latest/dg/urls-invocation.md") – Includes details about the
  request and response payloads to use for coding your serverless web
  application
- [Security
  and auth model for Lambda function URLs](../../../lambda/latest/dg/urls-auth.md "../../../lambda/latest/dg/urls-auth.md") – Includes details
