...
If you want to use your own domain name in the URLs for your files (for example,
 ...
 following topic instead: [Require HTTPS for communication
...
* [Configure alternate domain names and
 HTTPS](cnames-and-https-procedures.md "cnames-and-https-procedures.md")
...
* [Switch from a custom SSL/TLS
 certificate with dedicated IP addresses to SNI](cnames-and-https-switch-dedicated-to-sni.md "cnames-and-https-switch-dedicated-to-sni.md")
