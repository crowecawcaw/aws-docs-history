...
- To use a certificate provided by AWS Certificate Manager (ACM), see the
  [AWS Certificate Manager User Guide](../../../acm/latest/userguide.md "../../../acm/latest/userguide.md"). Then skip to [Update your CloudFront distribution](#cnames-and-https-updating-cloudfront "#cnames-and-https-updating-cloudfront").
...
ACM, see [Importing Certificates into AWS Certificate Manager](../../../acm/latest/userguide/import-certificate.md "../../../acm/latest/userguide/import-certificate.md") in the
...
For more information about the AWS CLI, see the [AWS Command Line Interface User Guide](../../../cli/latest/userguide/cli-chap-welcome.md "../../../cli/latest/userguide/cli-chap-welcome.md") and
...
the certificate from all distributions and all the distributions are deployed. 5. Choose **Save changes**. 6. Configure CloudFront to require HTTPS between viewers and CloudFront:
