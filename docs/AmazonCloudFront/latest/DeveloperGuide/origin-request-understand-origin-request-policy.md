...
CloudFront provides some predefined origin request policies, known as *managed policies*, for common use cases. You can use these
...
Origin request settings specify the values in viewer requests that are included in
 ...
 information about controlling the cache key, see [Control the cache key with a policy](controlling-the-cache-key.md "controlling-the-cache-key.md").
...
* **All viewer headers and the following CloudFront
 ...
 information about the CloudFront headers, see [Add CloudFront request headers](adding-cloudfront-headers.md "adding-cloudfront-headers.md").
...
* **All viewer headers except** – You
 specify which HTTP headers are ***not*** included in origin
...
* **All cookies except** – You specify
 which cookies in viewer requests are ***not*** included in
...
* **All query strings except** – You
 specify which query strings in viewer requests are ***not***
