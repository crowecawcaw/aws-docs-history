...
1. To verify domain ownership, create a DCV TXT record with an underscore ( \_ ) prefix that points to the CloudFront routing endpoint for your distribution tenant. For more information, see [Point domains to CloudFront](managed-cloudfront-certificates.md#point-domains-to-cloudfront).
