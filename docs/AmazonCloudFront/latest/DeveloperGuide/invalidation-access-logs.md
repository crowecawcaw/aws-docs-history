...
wildcard at the end of the invalidation path. For more information about using the `*` wildcard, see [Invalidation paths](invalidation-specifying-objects.md#invalidation-specifying-objects-paths "invalidation-specifying-objects.md#invalidation-specifying-objects-paths").
...
- `/images/*`
  ...
  requested, enable CloudFront access logging. For more information about access logs, see [Access logs (standard logs)](AccessLogs.md "AccessLogs.md").
