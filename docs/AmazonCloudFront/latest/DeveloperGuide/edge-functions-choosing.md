...
| Supports [Amazon CloudFront KeyValueStore](kvs-with-functions.md "kvs-with-functions.md") | Yes<br>CloudFront KeyValueStore only supports [JavaScript runtime<br>2.0](functions-javascript-runtime-20.md "functions-javascript-runtime-20.md") | No                                                                                                                                                                                                                                                   |
...
| Maximum function memory size                                                              | 2 MB                                                                                                                                               | 128 MB (viewer request and viewer response)<br>10,240 MB (10 GB) (origin request and origin response)<br>For more information, see [Quotas on Lambda@Edge](cloudfront-limits.md#limits-lambda-at-edge "cloudfront-limits.md#limits-lambda-at-edge"). |
| Maximum size of the function code and included libraries                                  | 10 KB                                                                                                                                              | 50 MB (viewer request and viewer response)<br>50 MB (origin request and origin response)                                                                                                                                                             |
