...
* Cache in the CloudFront edge cache, when the response was
 ...
 request event
* Log in CloudFront [Standard logging (access logs)](AccessLogs.md "AccessLogs.md")
...
For sample code, see [Lambda@Edge example functions](lambda-examples.md "lambda-examples.md").
