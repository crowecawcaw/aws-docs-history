...
5. If the origin returns an uncompressed object to CloudFront without the
 ...
 determines whether the object can be compressed. For more information, see [Conditions for compression](#compressed-content-cloudfront-notes "#compressed-content-cloudfront-notes").
