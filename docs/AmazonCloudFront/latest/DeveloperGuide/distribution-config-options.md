...
In a *standard distribution*, the distribution contains all the settings that
...
You can change this by manually creating your own connection group. For more information, see [Create custom connection group (optional)](custom-connection-group.md "custom-connection-group.md").
...
4. You can then customize some distribution tenant settings, such as vanity domains and
 origin paths. For more information, see [Distribution tenant customizations](tenant-customization.md "tenant-customization.md").
 ...
 *different* settings from the multi-tenant distribution. For each
 ...
 *distribution tenant* level. For more information, see [Request certificates for your
...
* [AWS Identity and Access Management (IAM)
 server certificates](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_server-certs.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_server-certs.html")
