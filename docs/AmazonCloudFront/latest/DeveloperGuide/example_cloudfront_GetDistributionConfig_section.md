...
* For API details, see
 [GetDistributionConfig](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/get-distribution-config.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/cloudfront/get-distribution-config.html")
...
* For API details, see
 [GetDistributionConfig](https://docs.aws.amazon.com/powershell/v4/reference "https://docs.aws.amazon.com/powershell/v4/reference")
...
* For API details, see
 [GetDistributionConfig](https://docs.aws.amazon.com/powershell/v5/reference "https://docs.aws.amazon.com/powershell/v5/reference")
...
* For API details, see
 [GetDistributionConfig](https://docs.aws.amazon.com/goto/boto3/cloudfront-2020-05-31/GetDistributionConfig "https://docs.aws.amazon.com/goto/boto3/cloudfront-2020-05-31/GetDistributionConfig")
