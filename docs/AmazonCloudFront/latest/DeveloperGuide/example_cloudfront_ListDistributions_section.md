...
* For API details, see
 [ListDistributions](https://docs.aws.amazon.com/powershell/v4/reference "https://docs.aws.amazon.com/powershell/v4/reference")
...
* For API details, see
 [ListDistributions](https://docs.aws.amazon.com/powershell/v5/reference "https://docs.aws.amazon.com/powershell/v5/reference")
...
* For API details, see
 [ListDistributions](https://docs.aws.amazon.com/goto/boto3/cloudfront-2020-05-31/ListDistributions "https://docs.aws.amazon.com/goto/boto3/cloudfront-2020-05-31/ListDistributions")
