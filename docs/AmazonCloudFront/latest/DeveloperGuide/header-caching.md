...
+ [Select the headers to base caching on](#header-caching-web-selecting)
+ [Configure CloudFront to respect CORS settings](#header-caching-web-cors)
+ [Configure caching based on the device type](#header-caching-web-device)
+ [Configure caching based on the language of the viewer](#header-caching-web-language)
+ [Configure caching based on the location of the viewer](#header-caching-web-location)
+ [Configure caching based on the protocol of the request](#header-caching-web-protocol)
+ [Configure caching for compressed files](#header-caching-web-compressed)
