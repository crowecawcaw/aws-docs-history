...
- ****Security headers:****
  - **Header name:** Referrer-Policy / **Header value:** strict-origin-when-cross-origin / **Override origin?:** No
  - **Header name:** Strict-Transport-Security / **Header value:** max-age=31536000 / **Override origin?:** No
  - **Header name:** X-Content-Type-Options / **Header value:** nosniff / **Override origin?:** Yes
  - **Header name:** X-Frame-Options / **Header value:** SAMEORIGIN / **Override origin?:** No
  - **Header name:** X-XSS-Protection / **Header value:** 1; mode=block / **Override origin?:** No
...
- ****CORS headers:****
  - **Header name:** Access-Control-Allow-Methods / **Header value:** DELETE, GET, HEAD, OPTIONS, PATCH, POST, PUT
  - **Header name:** Access-Control-Allow-Origin / **Header value:** \*
  - **Header name:** Access-Control-Expose-Headers / **Header value:** \*
  - **Override origin?:** No
