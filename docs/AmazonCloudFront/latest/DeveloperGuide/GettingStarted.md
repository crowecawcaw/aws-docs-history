...
The AWS CLI tutorial shows you how to create, update, and delete a standard distribution by using the AWS Command Line Interface (AWS CLI). For more information, see [Get started with a standard distribution (AWS CLI)](get-started-cli-tutorial.md).
