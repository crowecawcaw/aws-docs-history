...
2. We recommend that you use our Hello World sample for this Getting started.
 Download the *hello world* webpage: [hello-world-html.zip](samples/hello-world-html.zip "samples/hello-world-html.zip"). Unzip
...
4. Enter a unique **Bucket name** that conforms to the
 [General purpose buckets naming rules](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html#general-purpose-bucket-names "https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html#general-purpose-bucket-names") in the
...
* [Deleting a
 bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-bucket.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-bucket.html")
