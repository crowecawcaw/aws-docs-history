...
Use [AWS Elemental MediaLive](https://docs.aws.amazon.com/medialive/latest/ug/getting-started.html "https://docs.aws.amazon.com/medialive/latest/ug/getting-started.html") to encode live
 video streams in real time. To encode a large video stream, MediaLive compresses it into
 smaller versions (*encodes*) that can be distributed to
 your viewers.
...
* **Convert your content into required formats, and then
 ...
 [AWS Elemental MediaPackage](https://aws.amazon.com/mediapackage/ "https://aws.amazon.com/mediapackage/") to package the
...
* **Store and serve your content using scalable
 ...
 [AWS Elemental MediaStore](https://docs.aws.amazon.com/mediastore/latest/ug/getting-started.html "https://docs.aws.amazon.com/mediastore/latest/ug/getting-started.html") to serve the
...
You can learn about an AWS solution that automatically deploys services for
 ...
 Streaming Automated Deployment](https://docs.aws.amazon.com/solutions/latest/live-streaming/deployment.html "https://docs.aws.amazon.com/solutions/latest/live-streaming/deployment.html").
...
If you have video stored in an [AWS Elemental MediaStore](https://docs.aws.amazon.com/mediastore/latest/ug/getting-started.html "https://docs.aws.amazon.com/mediastore/latest/ug/getting-started.html") container, you can create a CloudFront distribution to serve the
 content.
...
1. Follow the procedure at [Allowing Amazon CloudFront to access your AWS Elemental MediaStore
 container](https://docs.aws.amazon.com/mediastore/latest/ug/cdns-allowing-cloudfront-to-access-mediastore.html "https://docs.aws.amazon.com/mediastore/latest/ug/cdns-allowing-cloudfront-to-access-mediastore.html"), and then return to these steps to create your
 distribution.
...
For more information, see [Origin domain](DownloadDistValuesOrigin.md#DownloadDistValuesDomainName "DownloadDistValuesOrigin.md#DownloadDistValuesDomainName").
...
For the other distribution settings, set specific values based on
 ...
 see [All distribution settings reference](distribution-web-values-specify.md "distribution-web-values-specify.md").
...
6. Go to the [CloudFront distributions
 page](https://console.aws.amazon.com/cloudfront/v4/home#/distributions "https://console.aws.amazon.com/cloudfront/v4/home#/distributions").
 ...
 **Add item**:
	...
	* If you’re using the time-shifted viewing
	 ...
	 parameters, see [Time-shifted viewing](https://docs.aws.amazon.com/mediapackage/latest/ug/time-shifted.html "https://docs.aws.amazon.com/mediapackage/latest/ug/time-shifted.html")
	...
	* If you’re using the manifest filtering
	 ...
	 information, see [Manifest filtering](https://docs.aws.amazon.com/mediapackage/latest/ug/manifest-filtering.html "https://docs.aws.amazon.com/mediapackage/latest/ug/manifest-filtering.html") in the *AWS Elemental MediaPackage User Guide*.
...
We recommend enabling header-based MediaPackage CDN Authorization between MediaPackage
 endpoints and the CloudFront distribution. For more information, see [Enable CDN authorization in MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/cdn-auth-setup.html#cdn-aut-setup-endpoint "https://docs.aws.amazon.com/mediapackage/latest/ug/cdn-auth-setup.html#cdn-aut-setup-endpoint") in the
...
We recommend enabling header-based MediaPackage CDN Authorization between MediaPackage
 VOD content and the CloudFront distribution. For more information, see [Enable CDN authorization in MediaPackage](https://docs.aws.amazon.com/mediapackage/latest/ug/cdn-auth-setup.html#cdn-aut-setup-endpoint "https://docs.aws.amazon.com/mediapackage/latest/ug/cdn-auth-setup.html#cdn-aut-setup-endpoint") in the
 *AWS Elemental MediaPackage User Guide*.
