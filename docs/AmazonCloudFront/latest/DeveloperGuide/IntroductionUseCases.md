...
CloudFront, see [Customize at the edge with Lambda@Edge](lambda-at-the-edge.md "lambda-at-the-edge.md"). To see
...
- Restrict access to your origin so that it's only available from CloudFront's origin-facing
  ...
  - For a custom origin, you can do the following:
    ...
    - If the custom origin requires custom access control logic,
      ...
      Lambda@Edge](https://aws.amazon.com/blogs/networking-and-content-delivery/serving-private-content-using-amazon-cloudfront-aws-lambdaedge/ "https://aws.amazon.com/blogs/networking-and-content-delivery/serving-private-content-using-amazon-cloudfront-aws-lambdaedge/").
