...
**Topics**
+ [Specify how long CloudFront caches your objects](#cache-hit-ratio-duration)
+ [Use Origin Shield](#cache-hit-ratio-use-origin-shield)
...
+ [Serve media content over HTTP](#cache-hit-ratio-http-streaming)
