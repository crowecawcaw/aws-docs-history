...
**Example**
   + If you specify {{tenant1.example.com}}, the response includes tenant1.example.com and the overlapping wildcard alternate domain name (\*.example.com if it exists).
   + If you specify {{\*.tenant1.example.com}}, the response includes \*.tenant1.example.com and any alternate domain names covered by that wildcard (for example, test.tenant1.example.com, dev.tenant1.example.com, and so on).
...
**Example**
   + If you specify {{www.example.com}}, the response includes www.example.com and the overlapping wildcard alternate domain name (\*.example.com) if it exists.
   + If you specify {{\*.example.com}}, the response includes \*.example.com and any alternate domain names covered by that wildcard (for example, www.example.com, test.example.com, dev.example.com, and so on).
