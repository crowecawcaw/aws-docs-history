...
CloudFront delivers logs for a distribution up to several times an hour. In general, a log
 ...
 date and time of the period in which the requests *occurred*, not the
...
If you enable cookie logging, CloudFront logs the cookies in all requests regardless
 ...
 information about cookies, see [Cache content based on cookies](Cookies.md "Cookies.md").
...
One way to analyze your access logs is to use [Amazon Athena](https://aws.amazon.com/athena/ "https://aws.amazon.com/athena/"). Athena is an interactive query service that can help you analyze
 data for AWS services, including CloudFront. To learn more, see  [Querying Amazon CloudFront Logs](https://docs.aws.amazon.com/athena/latest/ug/cloudfront-logs.html "https://docs.aws.amazon.com/athena/latest/ug/cloudfront-logs.html") in the
