...
`PUT`, and so on). 9. Under **Origin selection criteria**, specify how your
...
information, see [Media quality-aware resiliency](media-quality-score.md "media-quality-score.md"). 10. Choose **Create origin group**.
