...
**Topics**
+ [Increase the proportion of requests that are served directly from the CloudFront caches (cache hit ratio)](cache-hit-ratio.md)
+ [Use Amazon CloudFront Origin Shield](origin-shield.md)
+ [Optimize high availability with CloudFront origin failover](high_availability_origin_failover.md)
