...
Disassociating a web ACL is different from deleting it. Disassociating removes the web ACL
 ...
 [Associating or
 disassociating a web ACL with an AWS resource](https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-associating-aws-resource.html "https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-associating-aws-resource.html") in the *AWS WAF, AWS Firewall Manager, and
...
* If you disabled AWS WAF security protection and you still want to delete the web ACL from
 ...
 ACL](https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-deleting.html "https://docs.aws.amazon.com/waf/latest/developerguide/web-acl-deleting.html"). In the AWS WAF & Shield console, for the **Web ACLs** page,
 you *must* choose the **Global (CloudFront)** list to find the
 web ACLs.
* When you delete a distribution from the CloudFront console, CloudFront will attempt to also delete
 ...
 guaranteed. For more information, see [Delete a distribution](HowToDeleteDistribution.md "HowToDeleteDistribution.md").
