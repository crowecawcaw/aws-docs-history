 ...
 *viewer request* event type. For more information, see [Create the function](functions-tutorial.md#functions-tutorial-create "functions-tutorial.md#functions-tutorial-create"). This makes
...
When you create a function that generates an HTTP response, make sure to choose
 the *viewer request* event type. This means that
...
When you create a function that modifies the HTTP response, make sure to choose
 the *viewer response* event type. This means that
