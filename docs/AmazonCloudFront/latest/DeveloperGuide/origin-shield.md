...
Origin Shield can further reduce the number of [simultaneous requests](RequestAndResponseBehaviorCustomOrigin.md#request-custom-traffic-spikes "RequestAndResponseBehaviorCustomOrigin.md#request-custom-traffic-spikes") that
...
When you enable Origin Shield in the AWS Region [that has the lowest latency to your
 origin](#choose-origin-shield-region "#choose-origin-shield-region"), you can get better network performance. For origins in an
...
You incur additional charges for using Origin Shield. For more information, see [CloudFront pricing](https://aws.amazon.com/cloudfront/pricing/ "https://aws.amazon.com/cloudfront/pricing/").
...
Origin Shield isn't supported with gRPC requests. If a distribution that supports gRPC
 ...
 Shield. For more information, see [Using gRPC with CloudFront distributions](distribution-using-grpc.md "distribution-using-grpc.md").
...
With Amazon CloudFront, you inherently get a reduced load on your origin because requests
 ...
 [global network of edge locations](https://aws.amazon.com/cloudfront/features/#Amazon_CloudFront_Infrastructure "https://aws.amazon.com/cloudfront/features/#Amazon_CloudFront_Infrastructure"), [regional edge caches](HowCloudFrontWorks.md#CloudFrontRegionaledgecaches "HowCloudFrontWorks.md#CloudFrontRegionaledgecaches") serve as a
...
![Without CloudFront Origin Shield, the origin might receive duplicate requests.](images/origin-shield-without.png)
...
![With CloudFront Origin Shield, the origin can receive fewer duplicate requests.](images/origin-shield-with.png)
...
* A common [cache key](controlling-the-cache-key.md "controlling-the-cache-key.md") across
...
If you are interested in using Origin Shield in a multi-CDN architecture, and
 ...
 us](https://aws.amazon.com/contact-us/ "https://aws.amazon.com/contact-us/") or your AWS sales representative for more information.
...
![Graphic that shows how an origin can receive duplicate requests, each coming from a different CDN.](images/origin-shield-without-multi-cdn.png)
