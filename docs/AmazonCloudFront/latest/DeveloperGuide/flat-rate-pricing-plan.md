...
| **Invalidations by cache tag**<br>Assign custom tags to your content and remove all cached<br>content sharing a specific tag, without tracking individual file<br>paths.                                                                                                                                                                                                                                                                          |            | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
...
| **Tiered caching**<br>[Regional edge<br>caches](HowCloudFrontWorks.md#CloudFrontRegionaledgecaches "HowCloudFrontWorks.md#CloudFrontRegionaledgecaches") sit between edge locations and your application to<br>store content longer, reducing load on your application and<br>maintaining fast delivery.                                                                                                                                          | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
...
| **Origin load reduction**<br>Adds an additional caching layer close to your web application<br>using [Origin Shield](origin-shield.md "origin-shield.md"). Origin<br>Shield consolidates requests from all edge locations, reducing<br>load on your application particularly during traffic spikes.                                                                                                                                               |            |            |            | Yes<br>Yes |
...
| **Protections for WordPress, PHP, and SQL<br>databases**<br>Use-case based security rules to protect common applications<br>and operating systems like WordPress, PHP, SQL databases, Linux,<br>and Windows.                                                                                                                                                                                                                                      |            | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
| **AI traffic analytics**<br>Monitor access patterns, request volumes, and popular paths of<br>AI bots interacting with your content. AI bots are classified<br>based on intent to detect activities like potentially<br>unauthorized scraping used for training.                                                                                                                                                                                  |            | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
...
| **CAPTCHA challenge**<br>Require requests matching specific security rules to solve a<br>CAPTCHA puzzle to prove that a human being is sending the<br>request.                                                                                                                                                                                                                                                                                    |            | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
...
| **Mutual TLS (origin)**<br>Restrict unauthorized access to your application (origin)<br>using TLS-based client certificates,<br>ensuring only your authorized CloudFront distributions can establish<br>connections to your application.                                                                                                                                                                                                          |            |            | Yes<br>Yes | Yes<br>Yes |
...
| **Mutual TLS (mTLS)**<br>Restrict access to your application using mTLS authentication,<br>ensuring only trusted clients with valid certificates can<br>connect.                                                                                                                                                                                                                                                                                  |            |            |            | Yes<br>Yes |
| **Edge<br>Compute**                                                                                                                                                                                                                                                                                                                                                                                                                               |            |            |            |            |
| **Serverless edge compute**<br>Run lightweight JavaScript at the edge to modify URLs, HTTP<br>headers, and request/response elements in milliseconds using [CloudFront<br>Functions](cloudfront-functions.md "cloudfront-functions.md"). Lambda@Edge can also be used with all plan<br>tiers, but unlike CloudFront Functions, Lambda@Edge invocations are<br>billed on a pay-as-you-go basis.                                                    | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes | Yes<br>Yes |
