...
Application Monitoring can launch this event.
...
`AvailabilityMonitorTest` notification when you [run a test](vmware-ha.md#vmware-ha-test-failover "vmware-ha.md#vmware-ha-test-failover") of the [Availability and application monitoring](../APIReference/API_StartAvailabilityMonitorTest.md "../APIReference/API_StartAvailabilityMonitorTest.md") system in VMware.
