...
- [Create and activate an
  Amazon S3 File Gateway](../../../filegateway/latest/files3/create-gateway-file.md "../../../filegateway/latest/files3/create-gateway-file.md")
- [Create and activate
  an Amazon FSx File Gateway](../../../filegateway/latest/filefsxw/create-gateway-file.md "../../../filegateway/latest/filefsxw/create-gateway-file.md")
- [Create and activate a
  Tape Gateway](../tgw/create-tape-gateway.md "../tgw/create-tape-gateway.md")
- [Create and
  activate a Volume Gateway](create-volume-gateway-volume.md "create-volume-gateway-volume.md")
