...
In this section, you can find instructions on how to download, deploy, and activate a
Volume Gateway.
...
4. In the **Gateway options** section, for **Gateway
   ...
   - **Cached volumes** - Stores your primary data in
     ...
     faster access.
   - **Stored volumes** - Stores all of your data
     locally while also backing it up asynchronously to Amazon S3. Gateways
     using this volume type cannot be deployed on Amazon EC2.
...
5. In the **Platform options** section, do the
   ...
   1. For **Host platform**, choose the platform on
      ...
      - **VMware ESXi** - Download, deploy, and
        ...
        ESXi.
      - **Microsoft Hyper-V** - Download, deploy,
...
1. Complete the procedure described in [Set up a Volume Gateway](create-volume-gateway.md#set-up-gateway-volume "create-volume-gateway.md#set-up-gateway-volume") if you have not done so already. When
   finished, choose **Next** to open the **Connect to
   AWS** page in the Storage Gateway console.
2. In the **Endpoint options** section, for
   **Service endpoint**, choose the type of endpoint your
   ...
   - **Publicly accessible** - Your gateway
     ...
     to specify whether the connection should comply with Federal
   ...
   - **VPC hosted** - Your gateway communicates with
     AWS through a private connection with your VPC, allowing you to
...
3. In the **Gateway connection options** section, for
   **Connection options**, choose how to identify your
   ...
   - **IP address** - Provide the IP address of your
     ...
     to connect to it from your web browser.
   ...
   - **Activation key** - Provide the activation key
     for your gateway in the corresponding field. You can generate an
     activation key using the gateway's local console. Choose this option
     if your gateway's IP address is unavailable.
...
1.  Complete the procedures described in the following topics if you have not
        ...
        * [Set up a Volume Gateway](create-volume-gateway.md#set-up-gateway-volume "create-volume-gateway.md#set-up-gateway-volume")
        * [Connect your Volume Gateway to AWS](create-volume-gateway.md#connect-to-amazon-volume "create-volume-gateway.md#connect-to-amazon-volume")
...
your gateway is created. 4. Choose **Activate gateway** to proceed.

Now that you have activated your gateway, you need to perform first-time
configuration to allocate local storage disks and configure logging. For
instructions, see [Configure your Volume Gateway](create-volume-gateway.md#configure-gateway-volume "create-volume-gateway.md#configure-gateway-volume").
...
1.  Complete the procedures described in the following topics if you have not
        ...
        * [Connect your Volume Gateway to AWS](create-volume-gateway.md#connect-to-amazon-volume "create-volume-gateway.md#connect-to-amazon-volume")
        * [Review settings and activate your
         Volume Gateway](create-volume-gateway.md#review-and-activate-volume "create-volume-gateway.md#review-and-activate-volume")
...
Amazon CloudWatch alarms to notify you when gateway metrics deviate from defined
limits. You can choose from the following options:

    * **Create Storage Gateway's recommended alarms**
     – Create all recommended CloudWatch alarms automatically when the
     gateway is created. For more information about recommended alarms,
     see [Understanding CloudWatch alarms](Main_monitoring-gateways-common.md#cloudwatch-alarms "Main_monitoring-gateways-common.md#cloudwatch-alarms").
    ...
    * **Create a custom alarm** – Configure a
     new CloudWatch alarm to notify you about your gateway's metrics. Choose
    ...
    * **No alarm** – Don't receive CloudWatch
...
Now that you have created your gateway, you need to create a volume for it to use.
For instructions, see [Creating a
volume](GettingStartedCreateVolumes.md "GettingStartedCreateVolumes.md").
