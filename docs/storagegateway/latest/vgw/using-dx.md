...
3. Create a public virtual interface, and configure your on-premises router
   ...
   HAProxy. For more information, see [Creating a Virtual Interface](../../../directconnect/latest/UserGuide/create-vif.md "../../../directconnect/latest/UserGuide/create-vif.md") in the _Direct Connect User Guide._
