...
code calls to the Storage Gateway API operations. If you create a trail, you can activate
...
All of the Storage Gateway actions are logged and are documented in the [Actions](../APIReference/API_Operations.md "../APIReference/API_Operations.md") topic. For example, calls
