...
![an upload buffer formula based on application and network throughput compression and write duration.](http://docs.aws.amazon.com/storagegateway/latest/vgw/images/WorkingStorageFormula-diagram.png)
