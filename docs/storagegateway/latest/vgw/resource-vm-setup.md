...
**Topics**
+ [Deploy a default Amazon EC2 host for Volume Gateway](ec2-quicklaunch-settings.md) - Learn about how to deploy and activate a Volume Gateway on an Amazon Elastic Compute Cloud (Amazon EC2) instance using the default specifications.
+ [Deploy a customized Amazon EC2 instance for Volume Gateway](ec2-gateway-common.md) - Learn about how to deploy and activate a Volume Gateway on an Amazon Elastic Compute Cloud (Amazon EC2) instance using customized settings.
