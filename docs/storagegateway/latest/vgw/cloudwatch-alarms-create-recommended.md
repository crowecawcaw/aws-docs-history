...
information, see [Configure your Volume Gateway](create-volume-gateway.md#configure-gateway-volume "create-volume-gateway.md#configure-gateway-volume"). If you want to add or update recommended
