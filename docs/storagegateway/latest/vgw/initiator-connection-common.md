...
**Topics**
+ [Connecting to your volumes from a Windows client](ConfiguringiSCSIClient.md)
+ [Connecting your volumes to a Linux client](ConfiguringiSCSIClientInitiatorRedHatClient.md)
+ [Customizing iSCSI Settings](recommendediSCSISettings.md)
+ [Configuring CHAP Authentication for Your iSCSI Targets](ConfiguringiSCSIClientInitiatorCHAP.md)
