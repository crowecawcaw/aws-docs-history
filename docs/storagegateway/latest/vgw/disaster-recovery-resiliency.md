...
- Use AWS Backup to back up your volumes. For more information, see [Backing up your volumes](backing-up-volumes.md "backing-up-volumes.md").
- Clone your volume from a recovery point. For more information, see [Cloning a cached volume from a recovery point](clone-volume.md "clone-volume.md").
