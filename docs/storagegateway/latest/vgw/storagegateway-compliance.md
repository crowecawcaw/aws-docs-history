...
multiple AWS compliance programs. These include SOC, PCI, ISO, FedRAMP, HIPAA, MTSC, C5,
K-ISMS, ENS High, OSPAR, and HITRUST CSF.
...
Your compliance responsibility when using Storage Gateway is determined by the sensitivity
