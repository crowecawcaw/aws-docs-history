...
1. Activate the hardware appliance on the console **Hardware appliance overview** page in the AWS Region of your choice. For more information, see [Activating your Storage Gateway Hardware Appliance](appliance-activation.md).

1. Create a gateway on your hardware appliance. For more information, see [Create and activate a Tape Gateway](create-gateway-vtl.md).
