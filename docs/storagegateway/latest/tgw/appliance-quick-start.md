...
3. Activate the hardware appliance on the console **Hardware appliance
   ...
   information, see [Activating your Storage Gateway Hardware Appliance](appliance-activation.md "appliance-activation.md").
4. Create a gateway on your hardware appliance. For more information, see [Create and activate a Tape Gateway](create-gateway-vtl.md "create-gateway-vtl.md").
