...
To view examples of AWS SGW identity-based policies, see [Identity-based policy examples for Storage Gateway](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
