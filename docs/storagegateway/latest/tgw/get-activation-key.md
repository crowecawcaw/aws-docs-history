...
of your gateway. For more information, see [ActivateGateway](../APIReference/API_ActivateGateway.md "../APIReference/API_ActivateGateway.md") in
...
The Storage Gateway Hardware Appliance, VM image templates, and Amazon EC2 Amazon Machine Images (AMI) come
...
For more information, see [Endpoint types](Requirements.md#endpoint-types "Requirements.md#endpoint-types").
