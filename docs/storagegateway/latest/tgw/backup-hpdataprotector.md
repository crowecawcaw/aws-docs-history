...
**Topics**
+ [Configuring OpenText Data Protector to Work with VTL Devices](#hpdataprotector-configure-software)
+ [Preparing Virtual Tapes for Use with Data Protector](#hpdataprotector-prepare-tapes)
