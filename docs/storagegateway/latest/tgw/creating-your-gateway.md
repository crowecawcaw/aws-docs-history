...
- [Create and activate a
  Tape Gateway](create-tape-gateway.md "create-tape-gateway.md")
- [Create and
  activate a Volume Gateway](../vgw/create-volume-gateway-volume.md "../vgw/create-volume-gateway-volume.md")
