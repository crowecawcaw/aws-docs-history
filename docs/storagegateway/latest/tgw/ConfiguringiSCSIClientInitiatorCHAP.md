...
2. Choose your gateway, and then choose the **VTL Devices** tab
   to display all your VTL devices.
3. Choose the device that you want to configure CHAP for.
4. Provide the requested information in the **Configure CHAP
...
1. Ensure that the iSCSI daemon is running and that you have already connected to
   a target. If you have not completed these two tasks, see [Connecting to a Linux Client](GettingStarted-create-tape-gateway.md#iscsi-vtl-linux "GettingStarted-create-tape-gateway.md#iscsi-vtl-linux").
