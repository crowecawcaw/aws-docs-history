...
3. Create a public virtual interface, and configure your on-premises router
   accordingly. Even with Direct Connect, VPC endpoints must be created with the
   HAProxy. For more information, see [Creating a Virtual Interface](../../../directconnect/latest/UserGuide/create-vif.md "../../../directconnect/latest/UserGuide/create-vif.md") in the _AWS Direct Connect User Guide._
