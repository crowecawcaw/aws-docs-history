...
5. In the **Platform options** section, do the
   ...
   2. For **Confirm set up gateway**,
      select the check box to confirm that you performed the deployment
      steps for the host platform you chose. This step is not applicable
      for the **Hardware appliance** host
      platform.

6. In the **Backup application settings** section, for
   **Backup application**, choose the application you want
   to use to backup your tape data to the virtual tapes associated with your
   Tape Gateway.
7. Choose **Next** to proceed.

Now that your gateway is set up, you need to choose how you want it to connect and
communicate with AWS. For instructions, see [Connect your Tape Gateway to AWS](create-gateway-vtl.md#connect-to-amazon-tape "create-gateway-vtl.md#connect-to-amazon-tape").

## Connect your Tape Gateway to AWS

###### To connect a new Tape Gateway to AWS

1. Complete the procedure described in [Set up a Tape Gateway](create-gateway-vtl.md#set-up-gateway-tape "create-gateway-vtl.md#set-up-gateway-tape") if you have not done so already. When
...
your gateway is activated. 4. Choose **Activate gateway** to proceed.
...
instructions, see [Configure your Tape Gateway](create-gateway-vtl.md#configure-gateway-tape "create-gateway-vtl.md#configure-gateway-tape").
...
Now that you have created your gateway, you need to create virtual tapes for it to
use. For instructions, see [Creating
