...
**Topics**
+ [Connecting your VTL devices to a Windows client](ConfiguringiSCSIClient-vtl.md)
+ [Connecting your VTL devices to a Linux client](ConfiguringiSCSIClientInitiatorRedHatClient.md)
