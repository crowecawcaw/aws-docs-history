...
and activate the gateway. For more information, see [Connect
your Tape Gateway to AWS](create-gateway-vtl.md#connect-to-amazon-tape "create-gateway-vtl.md#connect-to-amazon-tape").
