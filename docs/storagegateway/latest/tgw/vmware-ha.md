...
- On the **Set up gateway** page in the Storage Gateway console, select
  ...
  Tape Gateway](create-gateway-vtl.md "create-gateway-vtl.md").
...
information, see [Getting Tape Gateway Health Logs with CloudWatch Log Groups](GatewayMetrics-vtl-common.md#cw-log-groups-tape "GatewayMetrics-vtl-common.md#cw-log-groups-tape").
