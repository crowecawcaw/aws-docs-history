...
For more information about the metrics that are used to monitor Tape Gateway, see [Understanding gateway metrics](Main_monitoring-gateways-common.md#MonitoringGateways-common "Main_monitoring-gateways-common.md#MonitoringGateways-common") and [Understanding Virtual Tape Metrics](GatewayMetrics-vtl-common.md#monitoring-tape "GatewayMetrics-vtl-common.md#monitoring-tape"). For each alarm, you specify conditions that
...
| **None**              | No alarms are created for the gateway. To create a new alarm, see<br>[Creating a custom CloudWatch alarm for your<br>gateway](cloudwatch-alarms-create-alarm.md "cloudwatch-alarms-create-alarm.md"). |
