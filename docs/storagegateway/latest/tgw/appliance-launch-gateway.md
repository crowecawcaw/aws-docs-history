...
Storage Gateway Hardware Appliance in your deployment.
...
2. Follow the procedures described in [Creating Your
   Gateway](creating-your-gateway.md "creating-your-gateway.md") to set up, connect, and configure the type of Storage Gateway that
   you want to deploy.
