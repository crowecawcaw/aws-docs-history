...
- [Deploy a default Amazon EC2 host for Tape Gateway](ec2-quicklaunch-settings.md "ec2-quicklaunch-settings.md") - Learn about how to deploy and
  activate a Tape Gateway on an Amazon Elastic Compute Cloud (Amazon EC2) instance using the default
  specifications.
- [Deploy a customized Amazon EC2 instance for Tape Gateway](ec2-gateway-common.md "ec2-gateway-common.md") -
