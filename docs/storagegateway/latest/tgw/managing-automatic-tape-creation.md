...
1. For **Pool**, choose **Glacier Pool** or **Deep Archive Pool**. This pool represents the storage class in which your tapes are stored when they are ejected by your backup software. 
   ...
   If you archive tapes in S3 Glacier Flexible Retrieval, you can move them to S3 Glacier Deep Archive later. For more information, see [Moving tapes to S3 Glacier Deep Archive storage class](moving-tapes-vtl.md).
