...
+ Gateway VM local console—see [Logging in to the Tape Gateway local console](LocalConsole-login-common.md).
...
<a name="start-stop-classic"></a><a name="PoweringOffGatewayConsole-common"></a>
