...
**Topics**
+ [Deciding the amount of local disk storage](decide-local-disks-and-sizes.md)
+ [Configuring additional upload buffer or cache storage](ConfiguringLocalDiskStorage.md)