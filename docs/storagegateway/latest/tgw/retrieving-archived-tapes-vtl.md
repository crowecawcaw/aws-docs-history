...
**Note**  
There is a charge for retrieving tapes from archive. For detailed pricing information, see [Storage Gateway Pricing](https://aws.amazon.com/storagegateway/pricing/).
