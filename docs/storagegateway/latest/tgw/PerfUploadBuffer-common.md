...
You monitor the upload buffer in the same way in both the cached-volume and Tape Gateway architectures. For more information, see [How Tape Gateway works](StorageGatewayConcepts.md).
