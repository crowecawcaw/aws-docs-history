...
+ If an outage causes network connectivity issues, you can troubleshoot the issue. For information about how to test network connectivity, see [Testing your gateway connection to the internet](MaintenanceTestGatewayConnectivity-common.md).
+  For tapes setups, when your gateway becomes reachable, your tapes go into BOOTSTRAPPING status. This functionality ensures that your locally stored data continues to be synchronized with AWS. For more information on this status, see [Understanding Tape Status](understand-tapes-status.md).
...
1. Deactivate the malfunctioning gateway.
...
1. Create and activate a new Tape Gateway on an Amazon EC2 host. For more information, see [Deploy a customized Amazon EC2 instance for Tape Gateway](ec2-gateway-common.md).
...
If you plan to continue using your Tape Gateway, see additional information in [Where do I go from here?](GettingStartedWhatsNextStep3-vtl.md)

**To clean up resources you don't need**

1. Delete tapes from both your gateway's virtual tape library (VTL) and archive. For more information, see [Deleting your gateway and removing associated resources](deleting-gateway-common.md).
   ...
   1. Delete any remaining tapes from your gateway's VTL. For instructions, see [Deleting virtual tapes from your Tape Gateway](deleting-tapes-vtl.md).

   1. Delete any tapes you have in the archive. For instructions, see [Deleting virtual tapes from your Tape Gateway](deleting-tapes-vtl.md).
