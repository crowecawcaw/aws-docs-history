...
more information, see [Logging in to
the Tape Gateway local console](LocalConsole-login-common.md "LocalConsole-login-common.md").
...
tasks on the virtual machine local console](manage-on-premises-common.md "manage-on-premises-common.md") .
