...
For information specific to monitoring a Tape Gateway and its associated
resources, see [Monitoring your
Tape Gateway](GatewayMetrics-vtl-common.md "GatewayMetrics-vtl-common.md").
