...
For information specific to monitoring a Tape Gateway and its associated resources, see [Monitoring your Tape Gateway](https://docs.aws.amazon.com/storagegateway/latest/tgw/GatewayMetrics-vtl-common.html).
