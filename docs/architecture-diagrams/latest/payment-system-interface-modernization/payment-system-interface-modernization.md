...
14. Payment interface near real-time transaction data is consumed by other systems in the
    bank DC using an **Amazon Relational Database Service** (Amazon RDS) replica over **AWS Direct Connect**.
...
| ------------------- | ----------------------------------------------- | ------------- | ----------------------------------------------------------------------------------------------------------- |
| Initial publication | Reference architecture diagram first published. | April 6, 2022 | ###### Note To subscribe to RSS updates, you must have an RSS plugin enabled for the browser you are using. |
