...
<tbody>
  <tr><td>NCRYPT_MACHINE_KEY_FLAG</td><td>This flag has no effect.</td></tr>
  <tr><td>NCRYPT_SILENT_FLAG</td><td>This flag has no effect.</td></tr>
  <tr><td>NCRYPT_OVERWRITE_KEY_FLAG</td><td>Specifying this flag overwrites any existing key with the same name in the HSM.<br />Without this flag, the function returns NTE_EXISTS.</td></tr>
</tbody>
</table>
