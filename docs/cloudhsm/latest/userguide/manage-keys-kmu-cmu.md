...
If using the [previous SDK version series](choose-client-sdk.md "choose-client-sdk.md"), you can
 manage keys on the hardware security modules (HSM) in your AWS CloudHSM cluster using the key\_mgmt\_util
 (KMU) command line tool. Before you can manage keys, you must start the AWS CloudHSM client, start
 key\_mgmt\_util, and log in to the HSMs. For more information, see [Getting Started with key\_mgmt\_util](key_mgmt_util-getting-started.md "key_mgmt_util-getting-started.md").
