...
Certificate storage limits the number of stored certificates for each cluster, and the
rate of read and write operations for each HSM. For more information, see
[Certificate storage limits](pkcs11-certificate-storage-limits.md "pkcs11-certificate-storage-limits.md").
...
- [Limits](pkcs11-certificate-storage-limits.md "pkcs11-certificate-storage-limits.md")
