...
###### To change the HSM type ([AWS CLI](../../../cli/latest/userguide.md "../../../cli/latest/userguide.md"))

- At a command prompt, run the **[modify-cluster](../../../cli/latest/reference/cloudhsmv2/modify-cluster.md "../../../cli/latest/reference/cloudhsmv2/modify-cluster.md")** command. Specify the cluster ID and
...
1. Run the [describe-clusters](../../../cli/latest/reference/cloudhsmv2/describe-clusters.md "../../../cli/latest/reference/cloudhsmv2/describe-clusters.md") command.
...
###### To roll back your HSM type ([AWS CLI](../../../cli/latest/userguide.md "../../../cli/latest/userguide.md"))
