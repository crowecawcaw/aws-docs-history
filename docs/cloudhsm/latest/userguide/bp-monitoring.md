...
This section describes multiple mechanisms you can use to monitor your cluster and application. For additional details on monitoring, see [Monitoring AWS CloudHSM](get-logs.md).

## Monitor client logs
<a name="w2aab9c15b5"></a>

Every Client SDK writes logs that you can monitor. For information on client logging, see [Working with AWS CloudHSM client SDK logs](hsm-client-logs.md).
...
See the [AWS CloudHSM Client SDK 5 configure tool](configure-sdk-5.md) for information on how to configure logging options in your application.
...
See [How HSM audit logging works](get-audit-logs-from-cloudwatch.md) for more details. 
...
See [Working with AWS CloudTrail and AWS CloudHSM](get-api-logs-using-cloudtrail.md) for details.
