...
To learn more about CloudTrail, see the [AWS CloudTrail User Guide](../../../awscloudtrail/latest/userguide.md "../../../awscloudtrail/latest/userguide.md"). For a
 full list of AWS CloudHSM API operations, see [Actions](../APIReference/API_Operations.md "../APIReference/API_Operations.md") in the *AWS CloudHSM API Reference*.
...
## Understanding AWS CloudHSM log file
 entries
