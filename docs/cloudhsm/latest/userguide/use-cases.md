...
For details on how to do this, see [AWS CloudHSM key stores](../../../kms/latest/developerguide/keystore-cloudhsm.md "../../../kms/latest/developerguide/keystore-cloudhsm.md") in the _AWS Key Management Service Developer Guide_.
