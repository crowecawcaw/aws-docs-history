...
To create a Windows Server CA with AWS CloudHSM, go to [Create Windows Server CA](#win-ca-setup-sdk3 "#win-ca-setup-sdk3").
...
Then choose **Next**. 17. For **Cryptography**, do the following:
     ...
     **Cavium Key Storage Provider** options from the menu. These are the
     AWS CloudHSM key storage providers. For example, you can choose **RSA#Cavium Key
     Storage Provider**.
