...
**Topics**
+ [Step 1: Set up the prerequisites](#win-ca-prerequisites-sdk3)
+ [Step 2: Create a Windows Server CA with AWS CloudHSM](#win-ca-setup-sdk3)
+ [Step 3: Sign a certificate signing request (CSR) with your Windows Server CA with AWS CloudHSM](#win-ca-sign-csr-sdk3)
