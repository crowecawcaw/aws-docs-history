...
If not, log out and start over. 4. Use **changePswd** to change your own password.
...
Make sure the number of connections CMU lists match the number of HSMs in the cluster.
If not, log out and start over. 4. Use **changePswd** to change the password of another user.
