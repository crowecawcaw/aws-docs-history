...
Ubuntu 20.04 LTS
Install the OpenSSL Dynamic Engine for Ubuntu 20.04 LTS on x86\_64 architecture:
...
3. Set an environment variable with the credentials of a crypto user (CU). For
...
4. Connect your installation of OpenSSL Dynamic Engine to the cluster. For more information, see [Connect to the Cluster](cluster-connect.md "cluster-connect.md").
5. Bootstrap the Client SDK 5. For more information, see [Bootstrap the Client SDK](cluster-connect.md#connect-how-to "cluster-connect.md#connect-how-to").
