...
<a name="cloudhsm-cli-generate-asymmetric-mldsa"></a>

Use the **key generate-asymmetric-pair ml-dsa** command to generate an ML-DSA key pair. To see all available options, use the **help key generate-asymmetric-pair ml-dsa** command.
...
#### Arguments
<a name="cloudhsm-cli-generate-asymmetric-mldsa-args"></a>
