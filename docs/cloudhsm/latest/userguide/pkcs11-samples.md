# Code samples for the PKCS #11 library for AWS CloudHSM Client SDK 5
...
Before running samples, perform the following steps to set up your
environment:

- Install and configure the [PKCS #11 library](pkcs11-library-install.md "pkcs11-library-install.md") for Client SDK 5.
...
- [Generate Ed25519 key pairs](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/generate/ed25519_generate.c "https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/generate/ed25519_generate.c")
- [Generate ML-DSA key pairs](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/generate/mldsa_generate.c "https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/generate/mldsa_generate.c")
...
- [Sign and verify data with ECDSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/ec_sign.c "https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/ec_sign.c")
- [Sign and verify data with EdDSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/sign/eddsa_sign.c "https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/sign/eddsa_sign.c")
- [Sign and verify data with ML-DSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/mldsa_sign.c "https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/mldsa_sign.c")
