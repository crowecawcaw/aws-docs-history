...
The code samples on GitHub show you how to accomplish basic tasks using the PKCS \#11 library for AWS CloudHSM Client SDK 5. 
...
+ [Generate Ed25519 key pairs](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/generate/ed25519_generate.c)
+ [Generate ML-DSA key pairs](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/generate/mldsa_generate.c)
...
+ [Sign and verify data with ECDSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/ec_sign.c)
+ [Sign and verify data with EdDSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/non_fips_examples/sign/eddsa_sign.c)
+ [Sign and verify data with ML-DSA](https://github.com/aws-samples/aws-cloudhsm-pkcs11-examples/blob/master/src/sign/mldsa_sign.c)
