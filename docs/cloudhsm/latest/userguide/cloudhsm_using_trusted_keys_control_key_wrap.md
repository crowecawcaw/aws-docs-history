...
2. Use the [Set the attributes of AWS CloudHSM keys using CMU](cloudhsm_mgmt_util-setAttribute.md "cloudhsm_mgmt_util-setAttribute.md") command with `OBJ_ATTR_TRUSTED` (value `134`) set to true (`1`).
