...
+ For Client SDK 3, the PKCS \#11 library is a Linux only component that matches Linux base support. For more information, see [Linux support for AWS CloudHSM Client SDK 3](sdk3-linux.md).
+ For Client SDK 5, the PKCS \#11 library is a cross-platform component that matches Linux and Windows Client SDK 5 base support. For more information, see [Linux support for AWS CloudHSM Client SDK 5](sdk8-linux.md) and [Windows support for AWS CloudHSM Client SDK 5](sdk8-windows.md).
