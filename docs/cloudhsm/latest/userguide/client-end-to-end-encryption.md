...
<a name="client-end-to-end-encryption"></a>
...
![A TLS connection between the client and the server.](https://docs.aws.amazon.com/cloudhsm/latest/userguide/images/end-to-end-encryption-part-1.png)
...
![A secure, end-to-end encrypted connection between the client and the HSM.](https://docs.aws.amazon.com/cloudhsm/latest/userguide/images/end-to-end-encryption-part-2.png)