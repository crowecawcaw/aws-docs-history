...
**Example 3: **To generate a p256 ED key and save it in a key store file named, "example\_keystore.store" in the working directory. Replace {{<ec key pair label>}} with a unique label.
