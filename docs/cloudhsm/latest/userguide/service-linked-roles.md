 ...
 **AWSServiceRoleForCloudHSM** role, you can use the console, the [create-cluster](https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/create-cluster.html "https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/create-cluster.html") command, or the [CreateCluster](../APIReference/API_CreateCluster.md "../APIReference/API_CreateCluster.md") API operation
 to create a cluster. Then use the console, the [delete-cluster](https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/delete-cluster.html "https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/delete-cluster.html") command, or the [DeleteCluster](../APIReference/API_DeleteCluster.md "../APIReference/API_DeleteCluster.md") API operation
...
AWS CloudHSM does not allow you to edit the **AWSServiceRoleForCloudHSM** 
 ...
 information, see [Editing a Service–Linked Role](https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html#edit-service-linked-role "https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html#edit-service-linked-role") in the
 *IAM User Guide*.
...
You cannot delete a service-linked role as long as a cluster to which it has been
 ...
 information about deleting a cluster, see [Deleting an AWS CloudHSM cluster](delete-cluster.md "delete-cluster.md"). For more information, see [Deleting a Service-Linked Role](https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html#delete-service-linked-role "https://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html#delete-service-linked-role") in the
 *IAM User Guide*.
