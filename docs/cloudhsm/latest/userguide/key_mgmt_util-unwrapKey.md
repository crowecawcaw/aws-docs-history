...
Use the **unWrapKey** command in the AWS CloudHSM key_mgmt_util tool to import a wrapped
...
command in key_mgmt_util, but it can also be used to unwrap keys that were wrapped with other tools.
...
Imported keys work like keys generated by AWS CloudHSM. However, the value of their [OBJ_ATTR_LOCAL attribute](key-attribute-table.md "key-attribute-table.md") is zero, which indicates that
...
**[wrapKey](key_mgmt_util-wrapKey.md "key_mgmt_util-wrapKey.md")** key_mgmt_util command, and
