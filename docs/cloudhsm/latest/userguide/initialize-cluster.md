...
**Topics**
+ [Overview](#initialize-cluster-overview)
+ [Step 1. Get the cluster CSR](#get-csr)
+ [Step 2. Create a private key for your Root CA](#sign-csr-create-key)
+ [Step 3. Sign the CSR](#sign-csr)
+ [Step 4. Initialize the cluster](#initialize)
