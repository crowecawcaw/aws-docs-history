...
To see your cluster's mode and HSM type, use the [describe-clusters](../../../cli/latest/reference/cloudhsmv2/describe-clusters.md "../../../cli/latest/reference/cloudhsmv2/describe-clusters.md") command.
...
| **Algorithms**             | Supports AWS CloudHSM algorithms that are FIPS approved[1](#cluster-mode-note-1 "#cluster-mode-note-1").                   | Supports AWS CloudHSM algorithms that are both FIPS approved and not FIPS approved.                                   |

[1] See [Deprecation notifications](compliance-dep-notif.md#compliance-dep-notif-1 "compliance-dep-notif.md#compliance-dep-notif-1") for details.
