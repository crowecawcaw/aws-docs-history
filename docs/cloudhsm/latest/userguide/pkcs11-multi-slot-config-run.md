...
2. Add these clusters to your PKCS #11 configuration by following the instructions in [Add a cluster with multi-slot functionality for AWS CloudHSM](pkcs11-multi-slot-add-cluster.md "pkcs11-multi-slot-add-cluster.md")
