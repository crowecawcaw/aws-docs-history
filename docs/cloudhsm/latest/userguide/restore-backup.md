...
* To restore a backup, issue the **[restore-backup](https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/restore-backup.html "https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/restore-backup.html")** command, passing the ID of a backup that is in
