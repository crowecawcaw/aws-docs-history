...
AWS CloudHSM collects your HSM audit logs and sends them to [Amazon CloudWatch Logs](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.html") on your behalf. You can use
 ...
 the [AWS CLI](https://docs.aws.amazon.com/cli/latest/reference/logs/index.html "https://docs.aws.amazon.com/cli/latest/reference/logs/index.html") and [CloudWatch Logs
 SDKs](https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/ "https://docs.aws.amazon.com/AmazonCloudWatchLogs/latest/APIReference/").
