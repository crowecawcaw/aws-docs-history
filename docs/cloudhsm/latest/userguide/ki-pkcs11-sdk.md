...
- [Issue: The CKA\_DERIVE attribute was not supported and was not handled](#ki-pkcs11-3 "#ki-pkcs11-3")
- [Issue: The CKA\_SENSITIVE attribute was not supported and was not handled](#ki-pkcs11-4 "#ki-pkcs11-4")
- [Issue: Multipart hashing and signing are not supported](#ki-pkcs11-5 "#ki-pkcs11-5")
- [Issue: C\_GenerateKeyPair does not handle CKA\_MODULUS\_BITS or CKA\_PUBLIC\_EXPONENT in the private template in a manner that is compliant with standards](#ki-pkcs11-6 "#ki-pkcs11-6")
- [Issue: Buffers for the C\_Encrypt and C\_Decrypt API operations cannot exceed 16 KB when using the CKM\_AES\_GCM mechanism](#ki-pkcs11-8 "#ki-pkcs11-8")
