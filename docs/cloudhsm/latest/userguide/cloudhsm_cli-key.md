...
In the CloudHSM CLI, **key** is a parent category for a group of commands that,
when combined with the parent category, create a command specific to keys. Currently, this
category consists of the following commands:
...
- [import pem](cloudhsm_cli-key-import-pem.md "cloudhsm_cli-key-import-pem.md")
- [list](cloudhsm_cli-key-list.md "cloudhsm_cli-key-list.md")
- [replicate](cloudhsm_cli-key-replicate.md "cloudhsm_cli-key-replicate.md")
- [set-attribute](cloudhsm_cli-key-set-attribute.md "cloudhsm_cli-key-set-attribute.md")
- [share](cloudhsm_cli-key-share.md "cloudhsm_cli-key-share.md")
- [unshare](cloudhsm_cli-key-unshare.md "cloudhsm_cli-key-unshare.md")
- [unwrap](cloudhsm_cli-key-unwrap.md "cloudhsm_cli-key-unwrap.md")
- [wrap](cloudhsm_cli-key-wrap.md "cloudhsm_cli-key-wrap.md")
