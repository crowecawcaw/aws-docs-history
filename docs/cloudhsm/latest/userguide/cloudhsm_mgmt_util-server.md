...
Use the **server** command in the AWS CloudHSM cloudhsm\_mgmt\_util to enter *server mode* and interact directly with a particular hardware security module (HSM) instance. 
