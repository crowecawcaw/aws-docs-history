...
+ [Issue: Client SDK 5 memory leak with getKey operations](#ki-jce-9)
...
**Note**  
OpenJDK 11 is no longer supported. Client SDK 5.17.1 is the last release to support OpenJDK 11.
