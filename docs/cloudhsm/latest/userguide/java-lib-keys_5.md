...
| **Triple DES (3DES, DESede)** | Generate a 192-bit Triple DES Key [1](#java-lib-keys_5-note-1 "#java-lib-keys_5-note-1").                                                                                                                     |
| **EC**                        | Generate EC key pairs – NIST curves secp224r1 (P-224), secp256r1 (P-256), secp256k1<br>(Blockchain), secp384r1 (P-384), secp521r1 (P-521), and ed25519[2](#java-lib-keys_5-note-2 "#java-lib-keys_5-note-2"). |
| **GENERIC\_SECRET**           | Generate 1 to 800 bytes generic secrets.                                                                                                                                                                      |
| **HMAC**                      | Hash support for SHA1, SHA224, SHA256, SHA384, SHA512.                                                                                                                                                        |
| **ML-DSA**                    | Generate ML-DSA[3](#java-lib-keys_5-note-3 "#java-lib-keys_5-note-3") key pairs with parameter sets ML-DSA-44, ML-DSA-65, and ML-DSA-87.                                                                      |
