...
The following example demonstrates how to use OpenSSL to create a 2048-bit RSA key. To use this example, replace {{<crypto\_user1.key>}} with the name of the file where you want to store the key.  
