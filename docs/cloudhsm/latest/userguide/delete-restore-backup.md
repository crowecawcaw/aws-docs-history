...
The Delete backups dialog box appears. 6. Choose **Delete**.
...
AWS CLI
Check the status of a backup or find its ID by using the **[describe-backups](../../../cli/latest/reference/cloudhsmv2/describe-backups.md "../../../cli/latest/reference/cloudhsmv2/describe-backups.md")** command from the AWS CLI.

###### To delete a backup (AWS CLI)

- At a command prompt, run the **[delete-backup](../../../cli/latest/reference/cloudhsmv2/delete-backup.md "../../../cli/latest/reference/cloudhsmv2/delete-backup.md")**
