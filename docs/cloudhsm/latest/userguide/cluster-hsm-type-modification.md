...
| **hsm2m.medium** | **hsm1.medium**  | **Conditional**. You can roll back from<br>hsm2m.medium to hsm1.medium within 24 hours of the start of a migration. |

###### Topics

- [Migrating from hsm1.medium to hsm2m.medium](hsm1-to-hsm2-migration.md "hsm1-to-hsm2-migration.md")
