...
| `ENCRYPT`           | `TRUE`        | `TRUE`                 |                         | True indicates you can use the key to encrypt any<br>buffer.                                                                                                                                                                                                                                                                                                                                                   |
...
| `KEY_TYPE`          |               |                        |                         | Used to identify the type of key (AES, DESede, generic secret, EC, or RSA).                                                                                                                                                                                                                                                                                                                                    |
...
| `UNWRAP`            | `TRUE`        |                        | `TRUE`                  | True indicates you can use the key to<br>unwrap (import) another key.                                                                                                                                                                                                                                                                                                                                          |
...
| `WRAP`              | `TRUE`        | `TRUE`                 |                         | True indicates you can use the key to wrap<br>another key. You will generally set this to FALSE for private keys.                                                                                                                                                                                                                                                                                              |
