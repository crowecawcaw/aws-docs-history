# HSM user types for AWS CloudHSM Management Utility
 ...
 credentials of an AWS CloudHSM *HSM user*. The HSM authenticates each HSM user and
 each HSM user has a *type* that determines which operations you can perform
