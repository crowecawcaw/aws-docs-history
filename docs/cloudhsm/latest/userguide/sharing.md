...
- To share a backup, it must be in the _READY_ state.
...
Use the [put-resource-policy](../../../cli/latest/reference/cloudhsmv2/put-resource-policy.md "../../../cli/latest/reference/cloudhsmv2/put-resource-policy.md") command.
...
any principal that has DescribeBackups permission in that account can describe the backup. 3. Run the [put-resource-policy](../../../cli/latest/reference/cloudhsmv2/put-resource-policy.md "../../../cli/latest/reference/cloudhsmv2/put-resource-policy.md") command.
...
The next steps describe how to promote the AWS RAM resource share in order for the backup to be included in the response. 4. Get the AWS RAM resource share ARN.
...
From the response, copy the `<resource-share-arn>` value to use in the next steps. 5. Run the AWS RAM [promote-resource-share-created-from-policy](../../../cli/latest/reference/ram/promote-resource-share-created-from-policy.md "../../../cli/latest/reference/ram/promote-resource-share-created-from-policy.md") command.

```
`$` `aws ram promote-resource-share-created-from-policy --resource-share-arn `<resource-share-arn>``
```

6. To validate that the resource share has been promoted, you can run the AWS RAM [get-resource-shares](../../../cli/latest/reference/ram/get-resource-shares.md "../../../cli/latest/reference/ram/get-resource-shares.md") command.
...
Use the [delete-resource-policy](../../../cli/latest/reference/cloudhsmv2/delete-resource-policy.md "../../../cli/latest/reference/cloudhsmv2/delete-resource-policy.md") command.
...
Use the [describe-backups](../../../cli/latest/reference/cloudhsmv2/describe-backups.md "../../../cli/latest/reference/cloudhsmv2/describe-backups.md") command with the `--shared`
