...
- [Migrate your AWS CloudHSM PKCS #11 library from Client SDK 3 to Client SDK 5](pkcs11-migrate-to-sdk-5.md "pkcs11-migrate-to-sdk-5.md")
- [Migrate your OpenSSL Dynamic Engine from AWS CloudHSM Client SDK 3 to Client SDK 5](openssl-migrate-to-sdk-5.md "openssl-migrate-to-sdk-5.md")
- [Migrate your Key Storage Provider (KSP) from AWS CloudHSM Client SDK 3 to Client SDK 5](ksp-migrate-to-sdk-5.md "ksp-migrate-to-sdk-5.md")
- [Migrate your JCE provider from AWS CloudHSM Client SDK 3 to Client SDK 5](java-lib-migrate_to_sdk5.md "java-lib-migrate_to_sdk5.md")
