...
cluster, you lose the keys _and_ access to anything
encrypted by the keys. To mitigate this risk, we offer _client-side synchronization_. Client side synchronization is a
