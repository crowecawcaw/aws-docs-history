...
The _cloudhsmv2.`<region>`.api.aws_ dual-stack endpoint where AWS CloudHSM APIs are hosted supports IPv6 in addition to IPv4.
...
Customers who use dual addressing with policies containing _aws:sourceIp_ are
impacted by this upgrade. _Dual addressing_
...
Customers using the _cloudhsmv2.{region}.api.aws_ endpoint are
...
[AWS CloudHSM service endpoints](../../../general/latest/gr/cloudhsm.md "../../../general/latest/gr/cloudhsm.md")
which has IPv6 enabled endpoints located at the _api.aws endpoint_.
