...
5. To update a tag, do the following:
   ...
   tag and creates a new one. 2. Type the new tag value. 3. Choose **Save**.

###### To add or update tags (AWS CLI)

1. At a command prompt, issue the [**tag-resource**](../../../cli/latest/reference/cloudhsmv2/tag-resource.md "../../../cli/latest/reference/cloudhsmv2/tag-resource.md") command, specifying the tags and the ID of the
   cluster that you are tagging. If you don't know the cluster ID, issue the **[describe-clusters](../../../cli/latest/reference/cloudhsmv2/describe-clusters.md "../../../cli/latest/reference/cloudhsmv2/describe-clusters.md")**
   command.
