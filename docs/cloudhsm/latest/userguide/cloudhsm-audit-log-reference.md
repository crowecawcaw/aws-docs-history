...
| `CN_CREATE_CO` | [Create a crypto officer (CO)](cloudhsm_mgmt_util-createUser.md "cloudhsm_mgmt_util-createUser.md") |
| `CN_DELETE_USER` | [Delete a user](cloudhsm_mgmt_util-deleteUser.md "cloudhsm_mgmt_util-deleteUser.md") |
| `CN_CHANGE_PSWD` | [Change a user password](cloudhsm_mgmt_util-changePswd.md "cloudhsm_mgmt_util-changePswd.md") |
...
| `CN_SHARE_OBJECT` | [Share or unshare a key](cloudhsm_mgmt_util-shareKey.md "cloudhsm_mgmt_util-shareKey.md") |
