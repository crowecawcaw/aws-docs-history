...
* At a command prompt, issue the **[delete-cluster](https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/delete-cluster.html "https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/delete-cluster.html")** command,
 passing the ID of the cluster that you are deleting. If you don't know the cluster ID, issue
 the **[describe-clusters](https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/describe-clusters.html "https://docs.aws.amazon.com/cli/latest/reference/cloudhsmv2/describe-clusters.html")** command.
