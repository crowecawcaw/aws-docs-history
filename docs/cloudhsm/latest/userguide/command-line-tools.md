...
AWS CLI](../../../cli/latest/reference/cloudhsmv2/index.md "../../../cli/latest/reference/cloudhsmv2/index.md") and [HSM2 PowerShell cmdlets in the AWSPowerShell module](https://aws.amazon.com/powershell/ "https://aws.amazon.com/powershell/")

- These tools get, create, delete, and tag AWS CloudHSM clusters and HSMs:
- To use the commands in [CloudHSMv2 commands in
  CLI](../../../cli/latest/reference/cloudhsmv2/index.md "../../../cli/latest/reference/cloudhsmv2/index.md"), you need to [install](../../../cli/latest/userguide/installing.md "../../../cli/latest/userguide/installing.md") and [configure](../../../cli/latest/userguide/cli-chap-getting-started.md#cli-quick-configuration "../../../cli/latest/userguide/cli-chap-getting-started.md#cli-quick-configuration") AWS CLI.
