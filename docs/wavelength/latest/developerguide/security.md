...
+ **Security of the cloud** – AWS is responsible for protecting the infrastructure that runs AWS services in the AWS Cloud. AWS also provides you with services that you can use securely. Third-party auditors regularly test and verify the effectiveness of our security as part of the [AWS Compliance Programs](https://aws.amazon.com/compliance/programs/). To learn about the compliance programs that apply to AWS Wavelength, see [Compliance validation for AWS Wavelength](compliance-validation.md).
...
+ [Security in Amazon ECS clusters](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/security.html) 
