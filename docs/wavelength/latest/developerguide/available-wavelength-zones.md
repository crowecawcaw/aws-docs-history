...
AWS Wavelength Zones are associated with an AWS Region and designed to run workloads that require low
latency or edge resiliency. Review the locations, carriers, and other details of each available AWS Wavelength Zone.
...
- [Find your AWS Wavelength Zones](wavelength-zones-describe.md "wavelength-zones-describe.md")
  The following tables list the Wavelength Zones by Region. For more information, see [AWS Wavelength Zone locations](https://aws.amazon.com/wavelength/locations/ "https://aws.amazon.com/wavelength/locations/").
