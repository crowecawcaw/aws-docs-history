...
corresponding visemes for the Finnish voice that is supported by Amazon Polly.
...
| ʋ                                        | v\  | voiced labiodental approximant        | [v]aivaَ    | v       |
...
| **Consonants found in<br>loanwords**     |
...
| **Long vowels**                          |
| iː                                       | iː  | long close front unrounded vowel      | s[ii]li     | i       |
| ɛː                                       | E:  | long open mid-front unrounded vowel   | [ee]tu      | E       |
| æː                                       | {:  | long near open-front unrounded vowel  | t[ää]llä    | A       |
| y:                                       | y:  | long close front unrounded vowel      | t[yy]li     | u       |
| øː                                       | 2:  | long close mid-front rounded vowel    | t[öö]lö     | O       |
| u:                                       | u:  | long close back rounded vowel         | t[uu]li     | u       |
| ɔː                                       | O:  | long open mid-back rounded vowel      | r[oo]li     | O       |
| ɑː                                       | A:  | long open back unrounded vowel        | k[aa]su     | A       |
| **Dipthongs**                            |
...
| **Vowels found in English<br>loanwords** |
