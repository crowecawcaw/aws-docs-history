...
- To use any neural speaking style, you must use one of the AWS
  ...
  all Regions. For more information, see [Feature and region compatibility](neural-voices.md#ntts-regions "neural-voices.md#ntts-regions").

Console

###### To apply the Newscaster style

1. Open the Amazon Polly console at [https://console.aws.amazon.com/polly/](https://console.aws.amazon.com/polly/ "https://console.aws.amazon.com/polly/").
2. Make sure that you are using an AWS Region where neural
   voices are supported.
3. On the Text-to-Speech page, for **Engine**,
   choose **Neural**.
...
5. Turn on **SSML**.
6. Add input text to your text-to-speech request using the
...
1. In your API request, include the engine parameter with the
   `neural` value:
...
2. Add input text to your API request using the Newscaster style
   SSML syntax.
...
For more information about SSML, see [Supported SSML tags](supportedtags.md "supportedtags.md").
