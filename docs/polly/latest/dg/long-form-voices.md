...
| --- | ------------------- | ------------- | -------------------------------------- | -------------------------------- |
| 1   | **English (US)**    | en-US         | Danielle<br>Gregory<br>Ruth<br>Patrick | Female<br>Male<br>Female<br>Male |
| 2   | **Spanish (Spain)** | es-ES         | Alba<br>Raúl                           | Female<br>Male                   |
...
**The Amazon Polly Long-form engine supports the following
features:**
...
- As with standard voices, you can choose from various sampling rates to
  ...
  sampling rates for standard, long-form, and neural voices are: 8 kHz, 16
  kHz, 22kHz, or 24 kHz. The default for standard voices is 22 kHz. The
  default for long-form and neural voices is 24 kHz. Amazon Polly supports MP3,
  OGG (Vorbis), and raw PCM audio stream formats.

###### Note

Long-form voices cost is specified on the [Amazon Polly pricing information page](https://aws.amazon.com/polly/pricing/ "https://aws.amazon.com/polly/pricing/").
