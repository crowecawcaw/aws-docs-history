...
AWS CLI, save your text to a file. Then open the file in an audio application of your
choice.

You can use either of the following options:

- AWS SDKs – When using the SDKs, your requests to Amazon Polly are
  automatically signed and authenticated using the credentials you provide. This is
  the recommended choice for building your applications.
...
- [Signing up for AWS](signup.md "signup.md")
- [Setting up the AWS CLI](setup-cli.md "setup-cli.md")
- [Reconfiguring the AWS CLI](reconfigure-cli.md "reconfigure-cli.md")
