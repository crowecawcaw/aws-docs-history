...
To view examples of Amazon Polly identity-based policies, see [Identity-based policy examples for Amazon Polly](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
