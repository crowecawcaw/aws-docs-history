...
Before you use IAM to manage access to Amazon Polly, learn what IAM features are
available to use with Amazon Polly.

| IAM features you can use with Amazon Polly                                                                                                                                  | IAM feature | Amazon Polly support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------- |
...
| [Forward access sessions (FAS) for Amazon Polly](#security_iam_service-with-iam-principal-permissions "#security_iam_service-with-iam-principal-permissions")               | Yes         |
...
To view examples of Amazon Polly identity-based policies, see [Identity-based policy
examples for Amazon Polly](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within Amazon Polly
...
To see a list of Amazon Polly actions, see [Actions defined by Amazon Polly](../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions") in the
...
To see a list of Amazon Polly resource types and their ARNs, see
[Resources defined by Amazon Polly](../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon Polly](../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions").
...
To see a list of Amazon Polly condition keys, see [Condition keys for Amazon Polly](../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-policy-keys "../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Amazon Polly](../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonpolly.md#amazonpolly-actions-as-permissions").
...
forward access sessions (FAS) for Amazon Polly
...
Changing the permissions for a service role might break Amazon Polly functionality.
Edit service roles only when Amazon Polly provides guidance to do so.

## Service-linked

roles for Amazon Polly
...
grant cross-account permissions to another AWS account (for example, account B)
...
3. Account B administrator can then delegate permissions to assume the
   ...
   policy can also be an AWS service principal if you want to grant an AWS
...
The following is an example policy that grants permissions to put and get lexicons as
well as to list those lexicons currently available.
...
In these cases, the `Resource` value is indicated by the ARN. For example:
...
groups, roles, and permissions, see [Identities
