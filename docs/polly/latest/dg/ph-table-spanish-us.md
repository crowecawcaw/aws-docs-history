...
corresponding visemes for the US Spanish voices that are supported by Amazon Polly.

| Phoneme/Viseme Table   | IPA | X-SAMPA                          | Description                                         | Example | Viseme |
| ---------------------- | --- | -------------------------------- | --------------------------------------------------- | ------- | ------ |
| **Consonants**         |
| ɾ                      | 4   | alveolar flap                    | pe**r**o, b**r**avo, amo**r**,<br>ete**r**no        | t       |
...
| j                      | j   | palatal approximant              | hac**i**a, t**i**erra, rad**i**o,<br>v**i**uda      | i       |
...
| w                      | w   | labial-velar approximant         | f**u**ego, f**u**imos, c**u**ota,<br>c**u**adro     | u       |
| x                      | x   | voiceless velar fricative        | **j**amón, **g**eneral, pea**j**e,<br>relo**j**     | k       |
