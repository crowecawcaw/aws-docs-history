...
+ [Registry authentication in Amazon ECR public](public-registry-auth.md)
+ [Required IAM permissions for Amazon ECR public registries](public-registry-settings-iam.md)
+ [Updating registry settings in Amazon ECR public](public-registry-settings.md)

## Public registry concepts
<a name="public-registry-concepts"></a>
