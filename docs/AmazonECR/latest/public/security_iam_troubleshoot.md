# Troubleshooting Amazon ECR Public identity and
...
- [I am not authorized to
  perform an action in Amazon ECR Public](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I'm an administrator and
  want to allow others to access Amazon ECR Public](#security_iam_troubleshoot-admin-delegate "#security_iam_troubleshoot-admin-delegate")
- [I want to allow
  people outside of my AWS account to access my Amazon ECR Public resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Amazon ECR Public
...
want to allow others to access Amazon ECR Public
...
people outside of my AWS account to access my Amazon ECR Public resources
...
- To learn whether Amazon ECR Public supports these features, see [How Amazon ECR Public works with
