...
<a name="public-registry-settings"></a>
...
## Prerequisites
<a name="update-registry-prereqs"></a>

Before you can update your public registry settings in Amazon ECR, you must first have the required IAM permissions. See, [Required IAM permissions for Amazon ECR public registries](public-registry-settings-iam.md) to ensure you have the necessary permissions before continuing with the steps outlined on this page.

## Update your registry settings
<a name="public-registry-settings-console"></a>
