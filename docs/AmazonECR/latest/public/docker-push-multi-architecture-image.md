...
manifest](https://docs.docker.com/engine/reference/commandline/manifest/ "https://docs.docker.com/engine/reference/commandline/manifest/").

###### Important

Your Docker CLI must have experimental features enabled to use this feature. For
more information, see [Experimental features](https://docs.docker.com/engine/reference/commandline/cli/#experimental-features "https://docs.docker.com/engine/reference/commandline/cli/#experimental-features").
