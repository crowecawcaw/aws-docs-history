...
The graph displays your current usage of that AWS resource. 5. To add your service quota to the graph, do the following:
    ...
    2. Choose **Math expression**, **Start with an
     empty expression**. Then in the new row, under
     **Details**, enter
     `SERVICE_QUOTA(m1)`.


    A new line is added to the graph, displaying the service quota for the
