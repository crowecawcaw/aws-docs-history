...
[What is
Amazon ECR Public](../public/what-is-ecr.md "../public/what-is-ecr.md") in the _Amazon ECR Public User Guide_.
...
- Image scanning helps in identifying software vulnerabilities in your container
  ...
  then retrieve the results of the image scan. For more information, see [Scan images for software vulnerabilities in Amazon ECR](image-scanning.md "image-scanning.md").
- Cross-Region and cross-account replication makes it easier for you to have
  ...
  on a per-Region basis. For more information, see [Private registry settings in Amazon ECR](registry-settings.md "registry-settings.md").
