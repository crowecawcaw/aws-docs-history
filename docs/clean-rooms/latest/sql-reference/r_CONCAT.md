...
To concatenate columns that might contain nulls, use the [NVL and COALESCE functions](r_NVL_function.md "r_NVL_function.md"). The following example uses
NVL to return a 0 whenever NULL is encountered.
