...
| Name               | Storage                                                  | Range                                                         |
| ------------------ | -------------------------------------------------------- | ------------------------------------------------------------- |
| DECIMAL or NUMERIC | Variable, up to 128 bits for uncompressed DECIMAL types. | 128-bit signed integers with up to 38 digits of<br>precision. |
...
Don't arbitrarily assign maximum precision to DECIMAL columns unless you are
