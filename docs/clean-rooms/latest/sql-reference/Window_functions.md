...
+ [CUME\_DIST window function](WF_CUME_DIST.md)
+ [DENSE\_RANK window function](WF_DENSE_RANK.md)
+ [FIRST window function](WF_FIRST.md)
+ [FIRST\_VALUE window function](WF_first_value.md)
+ [LAG window function](WF_LAG.md) 
+ [LAST window function](WF-LAST.md)
+ [LAST\_VALUE window function](WF_last_value.md)
+ [LEAD window function](WF_LEAD.md) 

Following are the supported ranking functions: 
+ [DENSE\_RANK window function](WF_DENSE_RANK.md) 
+ [PERCENT\_RANK window function](WF_PERCENT_RANK.md)
+ [RANK window function](WF_RANK.md) 
+ [ROW\_NUMBER window function](WF_ROW_NUMBER.md)
