...
| 16:05           | 4:05 PM exactly                                                                                            | ## Special datetime values The following table shows special values that can be used as datetime literals and as arguments to date functions. They require single quotation marks and are converted to regular timestamp values during query processing.                            |
