...
Regardless of the data type of the expression, the return type of a STDDEV function
is a double precision number.

## Examples

The following example shows how to use STDDEV_POP and VAR_POP functions as window
functions. The query computes the population variance and population standard deviation
for PRICEPAID values in the SALES table.
