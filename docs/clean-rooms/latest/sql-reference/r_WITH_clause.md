...
Defines a temporary table that you can reference in the [FROM clause](r_FROM_clause30.md "r_FROM_clause30.md") and is used only during the execution of the query to
which it belongs.
...
table name that can be referenced in the [FROM clause](r_FROM_clause30.md "r_FROM_clause30.md").

_query_

Any SELECT query that AWS Clean Rooms supports. See [SELECT](r_SELECT_synopsis.md "r_SELECT_synopsis.md").
