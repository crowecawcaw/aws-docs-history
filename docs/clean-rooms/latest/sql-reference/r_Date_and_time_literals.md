...
The following table shows input timestamps that are valid examples of literal time
values that you can load into AWS Clean Rooms tables. All of the valid date literals can be
combined with the following time literals.
...
| 20080215 04:05 PM                               | 4:05 PM exactly; the hour value must be less than<br>12 |
