...
ABS calculates the absolute value of a number, where that number can be a literal or an
...
Number or expression that evaluates to a number. It can be the SMALLINT,
