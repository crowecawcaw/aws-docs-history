...
Datetime data types include DATE, TIME, TIMESTAMP\_LTZ, and TIMESTAMP\_NTZ.

###### Topics

- [DATE](Datetime_types-date.md "Datetime_types-date.md")
- [TIMESTAMP\_LTZ](Datetime_types-timestamp_LTZ.md "Datetime_types-timestamp_LTZ.md")
- [TIMESTAMP\_NTZ](Datetime_types-TIMESTAMP_NTZ.md "Datetime_types-TIMESTAMP_NTZ.md")
