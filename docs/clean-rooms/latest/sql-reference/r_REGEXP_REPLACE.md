...
pattern with the specified string. REGEXP_REPLACE is similar to the [REPLACE function](r_REPLACE.md "r_REPLACE.md"), but lets you search a string for a
regular expression pattern.

r_REGEXP_REPLACE is similar to the [TRANSLATE function](r_TRANSLATE.md "r_TRANSLATE.md") and the [REPLACE function](r_REPLACE.md "r_REPLACE.md"), except that TRANSLATE
makes multiple single-character substitutions and REPLACE substitutes one entire string
with another string, while REGEXP_REPLACE lets you search a string for a regular expression
pattern.
