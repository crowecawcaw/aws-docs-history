...
The ARRAY\_INTERSECT function takes two arrays as arguments and returns a new array that
...
The ARRAY\_INTERSECT function returns an ARRAY of matching type to array1 with no
...
ARRAY\_INTERSECT function identifies the common elements between the two arrays, which
