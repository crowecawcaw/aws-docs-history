...
The ARRAY\_JOIN function takes two arguments: The first argument is the input array that
...
The ARRAY\_JOIN function returns a STRING where the elements of array are separated by
...
In this example, the ARRAY\_JOIN function takes the array `['hello',
...
In this example, the ARRAY\_JOIN function takes the array `['hello', null,
 'world']` and joins the elements using the separator `' '` (a space
