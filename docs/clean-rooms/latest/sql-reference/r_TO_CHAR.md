...
implicitly be coerced to a numeric type. For more information, see [Numeric types](r_Numeric_types201.md "r_Numeric_types201.md"). TO_CHAR
inserts a space to the left of the numeral string.
