...
The HLL\_UNION function combines two HLL sketches into a single, unified sketch. It uses
...
The HLL\_UNION function returns a BINARY buffer containing the HyperLogLog sketch
