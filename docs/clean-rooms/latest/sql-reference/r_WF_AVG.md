...
The AVG window function returns the average (arithmetic mean) of the input expression
...
The following example computes a rolling average of quantities sold by date; order
the results by date ID and sales ID:
