...
The concatentation operator is similar to [CONCAT function](r_CONCAT.md "r_CONCAT.md").
...
To concatenate columns that might contain nulls, use the [NVL and COALESCE functions](r_NVL_function.md "r_NVL_function.md") expression. The following
