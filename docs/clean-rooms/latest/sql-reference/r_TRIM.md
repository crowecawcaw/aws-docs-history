...
mismatch error. See the [CAST function](r_CAST_function.md "r_CAST_function.md") and [CONVERT function](r_CONVERT_function.md "r_CONVERT_function.md") functions
for information about explicit conversions.
