...
- For examples of formatting strings as numbers, see [TO\_NUMBER](TO_NUMBER.md "TO_NUMBER.md").
- For examples of formatting numbers as strings, see [TO\_CHAR](TO_CHAR.md "TO_CHAR.md").
