...
The ARRAY\_REMOVE function takes two arguments: The first argument is the input array
...
The ARRAY\_REMOVE function returns the result type matched the type of the array. If
the element to be removed is `NULL`, the result is `NULL`.

## Examples

In this example, the ARRAY\_REMOVE function takes the array `[1, 2, 3, null,
