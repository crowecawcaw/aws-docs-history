...
Following are rules for working with interval literals that are supported by
AWS Clean Rooms.
...
The following example subtracts 4 months from February 15, 2023 and the result is
October 15, 2022.
