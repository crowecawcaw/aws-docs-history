...
_coercion_, is possible. For more information, see [Implicit conversion types](#implicit-conversion-types-spark "#implicit-conversion-types-spark"). When data types are incompatible,
...
- If you compare DECIMAL values with character strings, AWS Clean Rooms attempts to convert
  ...
  function, such as [CAST function](CAST_function.md "CAST_function.md").
