...
ADD\_MONTHS adds the specified number of months to a date or timestamp value or expression. The [DATE\_ADD](DATE_ADD_function.md) function provides similar functionality. 
