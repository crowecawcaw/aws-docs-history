...
| INTERVAL       | [Datetime types](Datetime_types.md "Datetime_types.md")      | Not applicable           | Time duration in day to time order or year to month order  |
