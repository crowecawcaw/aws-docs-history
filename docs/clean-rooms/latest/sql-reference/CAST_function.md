...
using CAST. See [Type compatibility and conversion](s_Type_conversion.md "s_Type_conversion.md").
...
One of the supported [Data types](s_Supported_data_types.md "s_Supported_data_types.md") , except for
BINARY
and BINARY VARYING data types.
