...
- Sufficient Amazon EC2 quota to run multiple instances for distributed training
  Distributed training leverages the power of many computing nodes working in
  parallel to process large amounts of data and update model parameters efficiently.

For more information about distributed training, see [Distributed training concepts](../../../sagemaker/latest/dg/distributed-training.md#distributed-training-basic-concepts "../../../sagemaker/latest/dg/distributed-training.md#distributed-training-basic-concepts") in the _Amazon SageMaker AI
Developer Guide_.
