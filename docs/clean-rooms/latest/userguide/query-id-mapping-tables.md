...
the query results settings. 9. View the **Results**.

For more information, see [Receiving and using analysis results](receive-query-results.md "receive-query-results.md"). 10. Continue to adjust parameters and run your query again, or choose the
