...
1. Go to the Cryptographic Computing for Clean Rooms AWS GitHub repository: [https://github.com/aws/c3r](https://github.com/aws/c3r)

1. Select and download the files.
   ...
   The latest signed C3R encryption client Java Executable File (that is, the command line interface application) is on the **Releases** page of the GitHub repository.
    ...
    The C3R encryption client package for Apache Spark (`c3r-cli-spark`) is a version of the c3r-cli that must be submitted as a job to a running Apache Spark server. For more information, see [Running C3R on Apache Spark](https://github.com/aws/c3r/blob/main/README.md#running-c3r-on-apache-spark). 