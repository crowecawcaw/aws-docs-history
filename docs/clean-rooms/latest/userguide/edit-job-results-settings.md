...
###### To edit the default values for job results settings
...
5. On the **Edit results settings defaults** page, modify any of the
   following, as needed:
   1. Under **Job results**, modify the **Results destination
      in Amazon S3**.
   2. Under **Service access**, modify the **Existing service
      role name**.

6. Choose **Save changes**.
7. The updated **Job results settings** appear on the collaboration
   detail page.
