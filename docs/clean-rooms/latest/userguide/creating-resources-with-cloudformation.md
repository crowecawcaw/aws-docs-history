...
resources that you want, and CloudFormation provisions and configures those resources for you. Examples
of resources include collaborations, configured tables, configured table associations, and memberships.

When you use CloudFormation, you can reuse your template to set up your AWS Clean Rooms resources
...
AWS Clean Rooms supports creating collaborations, configured tables, configured table associations, and memberships in CloudFormation. For more information, including examples
