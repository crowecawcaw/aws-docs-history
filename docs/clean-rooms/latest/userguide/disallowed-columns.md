...
+ Member B defines a table *pets* with a similar set of columns *age*, *gender*, and *owner\_name*. However, they don't set any constraints on the output columns, meaning that all columns in the table can be projected freely in the query.
