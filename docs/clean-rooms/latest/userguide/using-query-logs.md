...
- To verify that the queries and jobs match the use cases or queries that were agreed
  upon for the collaboration, review the queries and jobs that are run in the
  collaboration.

For more information about how to view recent queries, see [Viewing recent queries](query-data.md#view-queries-console "query-data.md#view-queries-console").
