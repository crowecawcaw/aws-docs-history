...
in AWS Clean Rooms. Configured tables can be associated to one or more collaborations.

For information about how to create a configured table using the AWS SDKs, see the
[_AWS Clean Rooms API Reference_](../apireference/Welcome.md "../apireference/Welcome.md").
