...
- Assign abilities to members, such as the [member who can query](glossary.md#glossary-member-who-can-query "glossary.md#glossary-member-who-can-query") and the [member who can receive
...
- Configure which [member is responsible for
  paying for compute costs in the collaboration](glossary.md#glossary-member-paying-for-query-compute "glossary.md#glossary-member-paying-for-query-compute").
