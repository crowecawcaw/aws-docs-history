...
SQL query output can be used for the seed data for a Clean Rooms ML model. For more information,
see [AWS Clean Rooms ML](machine-learning.md "machine-learning.md").
...
Documentation](../../../sagemaker.md "../../../sagemaker.md").
