...
+ Model authors should follow the [Model authoring guidelines for the training container](custom-model-guidelines.md) and [Model authoring guidelines for the inference container](inference-model-guidelines.md) to ensure model inputs and outputs are configured as expected by AWS Clean Rooms.