...
4. On the configured table detail page, scroll down to either the **Aggregation
   analysis rule**, **List analysis rule**, or the
   **Custom analysis rule** section. (Your choice depends on which type of
   analysis rule you chose for the configured table.)
5. Choose **Delete**.
6. If you’re certain that you want to delete the analysis rule, choose
   **Delete**.
