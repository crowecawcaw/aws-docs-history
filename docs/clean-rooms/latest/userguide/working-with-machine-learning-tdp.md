...
After the training data provider is done creating the ML model, the [seed data provider can create and export the lookalike segment](working-with-machine-learning-sdp.md).

**Topics**
+ [Importing training data](create-ml-model-training-data.md)
+ [Creating a lookalike model](create-ml-model-create-model.md)
+ [Configuring a lookalike model](create-ml-model-configure-model.md)
+ [Associating a configured lookalike model](create-ml-model-associate-model.md)
+ [Updating a configured lookalike model](update-ml-model-configured-model.md)