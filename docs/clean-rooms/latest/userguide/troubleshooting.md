...
You can use the [AWS MCP Server](../../../agent-toolkit/latest/userguide/mcp-server.md "../../../agent-toolkit/latest/userguide/mcp-server.md") with any MCP-compatible client to automatically diagnose and resolve common Clean Rooms issues. The aws-cleanrooms skill can help with the following:
...
To get started, install and configure the AWS MCP server. For setup instructions, see the [AWS MCP Server Setup](../../../agent-toolkit/latest/userguide/getting-started-aws-mcp-server.md "../../../agent-toolkit/latest/userguide/getting-started-aws-mcp-server.md") guide.
