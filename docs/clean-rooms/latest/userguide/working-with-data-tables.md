...
<a name="working-with-data-tables"></a>
...
The data tables that you use for queries in AWS Clean Rooms are commonly the same types of data tables that you use for other applications. For example, the same types of datasets are used with Amazon Athena, Amazon EMR, Amazon Redshift Spectrum, and Amazon Quick. 
...
If your use case involves querying identity data, see [AWS Entity Resolution in AWS Clean Rooms](working-with-entity-resolution.md).

**Topics**
+ [Data formats for AWS Clean Rooms](data-formats.md)
+ [Apache Iceberg tables in AWS Clean Rooms](iceberg-tables.md)
+ [Preparing data tables for queries in AWS Clean Rooms](prepare-data.md)
+ [Preparing encrypted data tables with Cryptographic Computing for Clean Rooms](prepare-encrypted-data.md)
+ [Decrypting data tables with the C3R encryption client](decrypt-data.md)