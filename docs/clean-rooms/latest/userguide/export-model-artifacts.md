...
1. On the **Collaborations** page, choose the collaboration that contains the custom model that you want to export.

1. After the collaboration opens, choose the **ML Models** tab, then choose your model from the **Custom trained model** table

1. On the custom trained model details page, click **Export model output**.

1. For **Export model output**, for **Export model output details**, enter a **Name** and optional **Description**.
