...
- [Step 3: (Optional) View available commands in the C3R encryption client](view-commands.md "view-commands.md")
- [Step 4: Generate an encryption schema for a tabular file](gen-encryption-schema-csv.md "gen-encryption-schema-csv.md")
- [Step 5: Create a shared secret key](create-SSK.md "create-SSK.md")
- [Step 6: Store the shared secret key in an environment variable](store-key.md "store-key.md")
