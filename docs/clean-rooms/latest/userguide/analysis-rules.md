...
| **Built-in privacy enhancing techniques** | • Blind match<br>• Aggregation required<br>• Min aggregation threshold >=<br>• 2 Pre-defined query structure         | • Blind match<br>• Overlap required<br>• Pre-defined query structure<br>• Allowed additional analyses                       | • Differential privacy<br>• Disallowed output columns                                                                                         |
