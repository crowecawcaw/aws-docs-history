...
| ----------------------------------------- | ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| **Control mechanism**                     | Control how data in the table can be used in a query*(For<br>example, allow COUNT and SUM of column hashed_email.)* | Control how data in the table can be used in a query*(For<br>example, allow use of column hashed_email only for joining.)* | Control what queries are allowed to run on the table*(For<br>example, allow only queries defined in analysis templates "Custom query<br>1".)* |
