...
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Supported analyses**                             | Queries that aggregate statistics using COUNT, SUM, and AVG functions along optional<br>dimensions                                                                                                                                                                                                                                                                                                                                            | Queries that output row-level lists of the overlap between multiple tables                                                                                              | Any custom analysis as long as the analysis template or the analysis creator have been<br>reviewed and allowed                                                                                                                                                                                                                       |
...
| **SQL constructs**                                 | • [JOIN statements](analysis-rules-aggregation.md#join-controls "analysis-rules-aggregation.md#join-controls"): INNER JOIN<br>• [Aggregate functions](analysis-rules-aggregation.md#agg-functions "analysis-rules-aggregation.md#agg-functions"): COUNT/COUNT DISTINCT,<br>SUM/SUM DISTINCT, and AVG<br>• [Scalar functions](analysis-rules-aggregation.md#scalar-functions "analysis-rules-aggregation.md#scalar-functions"): Limited subset | • [JOIN statements](analysis-rules-list.md#list-controls-join-controls "analysis-rules-list.md#list-controls-join-controls"): INNER<br>JOIN<br>• Scalar functions: None | • Majority of SQL functions and SQL constructs available with the SELECT command<br>• A restricted SQL surface applies when minimum aggregation thresholds are configured.<br>For more information, see [SQL capabilities for minimum aggregation and comparison controls](custom-sql-capabilities.md "custom-sql-capabilities.md"). |
| **Subqueries and common table expressions (CTEs)** | No                                                                                                                                                                                                                                                                                                                                                                                                                                            | No                                                                                                                                                                      | Yes                                                                                                                                                                                                                                                                                                                                  |
| **Analysis templates**                             | No                                                                                                                                                                                                                                                                                                                                                                                                                                            | No                                                                                                                                                                      | Yes                                                                                                                                                                                                                                                                                                                                  |

### Supported controls

The following tables show a comparison summary of how each analysis rule type protects your
underlying data.
...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Control mechanism**                     | Control how data in the table can be used in a query*(For<br>example, allow COUNT and SUM of column hashed\_email.)* | Control how data in the table can be used in a query*(For<br>example, allow use of column hashed\_email only for joining.)* | Control what queries are allowed to run on the table*(For<br>example, allow only queries defined in analysis templates "Custom query<br>1".)*                                                                                                                                                                                                                                                  |
| **Built-in privacy enhancing techniques** | • Blind match<br>• Aggregation required<br>• Min aggregation threshold >=<br>• 2 Pre-defined query structure         | • Blind match<br>• Overlap required<br>• Pre-defined query structure<br>• Allowed additional analyses                       | • [Minimum aggregation thresholds](custom-min-agg-thresholds.md "custom-min-agg-thresholds.md")<br>• [Comparison controls](custom-comparison-controls.md "custom-comparison-controls.md")<br>• [Disallowed output columns](disallowed-output-columns.md "disallowed-output-columns.md")<br>• [Differential privacy](differential-privacy.md#dp-overview "differential-privacy.md#dp-overview") |
| **Review query before it can be run**     | No                                                                                                                   | No                                                                                                                          | Yes, using analysis templates                                                                                                                                                                                                                                                                                                                                                                  |

For more information about the analysis rules that are available in AWS Clean Rooms, see the
following topics.
