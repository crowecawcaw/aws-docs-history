...
Before you use IAM to manage access to AWS Clean Rooms, learn what IAM features are
available to use with AWS Clean Rooms.

| IAM features you can use with AWS Clean Rooms                                                                                                                               | IAM feature | AWS Clean Rooms support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------------- |
...
| [Policy condition keys (service-specific)](#security_iam_service-with-iam-id-based-policies-conditionkeys "#security_iam_service-with-iam-id-based-policies-conditionkeys") | Partial     |
...
| [Forward<br>access sessions (FAS)](#security_iam_service-with-iam-principal-permissions "#security_iam_service-with-iam-principal-permissions")                             | Yes         |
...
To get a high-level view of how AWS Clean Rooms and other AWS services work with most IAM
...
The AWS Clean Rooms service supports only one type of resource-based policy called a _configured lookalike model managed resource policy_, which is attached
to a configured lookalike model. This policy defines which principals can perform actions on the
configured lookalike model.
...
To see a list of AWS Clean Rooms actions, see [Actions defined
by AWS Clean Rooms](../../../service-authorization/latest/reference/list_awscleanrooms.md "../../../service-authorization/latest/reference/list_awscleanrooms.md") in the _Service Authorization Reference_.
...
To see a list of AWS Clean Rooms resource types and their ARNs, see [Resources defined by AWS Clean Rooms](../../../service-authorization/latest/reference/list_your_service.md#your_service-resources-for-iam-policies "../../../service-authorization/latest/reference/list_your_service.md#your_service-resources-for-iam-policies")
...
To learn how AWS Clean Rooms ML uses policy condition keys, see **[IAM behaviors for AWS Clean Rooms ML](ml-behaviors.md "ml-behaviors.md")**.
