...
| [AWSCleanRoomsMLReadOnlyAccess](#ml-read-only) – New policy<br />[AWSCleanRoomsMLFullAccess](#ml-full-access) – New policy | Added AWSCleanRoomsMLReadOnlyAccess and AWSCleanRoomsMLFullAccess to support AWS Clean Rooms ML. | November 29, 2023 | 
