...
**Topics**
+ [WorkSpaces Secure Browser information in CloudTrail](service-name-info-in-cloudtrail.md)
+ [Understanding WorkSpaces Secure Browser log file entries](understanding-service-name-entries.md)