...
For details about actions and resource types defined by WorkSpaces Secure Browser, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for Amazon WorkSpaces Secure Browser](../../../service-authorization/latest/reference/list_amazonworkspacesweb.md "../../../service-authorization/latest/reference/list_amazonworkspacesweb.md") in the _Service Authorization Reference_.
