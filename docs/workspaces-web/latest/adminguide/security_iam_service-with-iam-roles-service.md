...
Changing the permissions for a service role might break WorkSpaces Secure Browser's functionality.
Edit service roles only when WorkSpaces Secure Browser provides guidance to do so.
