...
**Topics**
+ [Monitoring Amazon WorkSpaces Secure Browser with Amazon CloudWatch](monitoring-cloudwatch.md)
+ [Logging WorkSpaces Secure Browser API calls using AWS CloudTrail](logging-using-cloudtrail.md)
+ [User activity logging in Amazon WorkSpaces Secure Browser](monitoring-logging.md)