...
1. Select the language selector drop-down located on the right side of the black, top panel bar. By default, the selector will show **en**, for English.

1. In the dropdown menu, choose the desired language.

1. In the submenu that appears after choosing a language, choose additional language details.
...
+ Japanese
  + For macOS users: If you're using a US input source, you may experience input issues. To resolve this:
    ...
    1. In the WorkSpaces Secure Browser session, go to **Toolbar** → **Preferences** → **Keyboard** → **Option key setting** and select **Use Option (⌥) as remote Alt key (Mac)** to ensure keyboard shortcuts work properly.
  ...
  + Switching input modes
    + To switch from Hiragana to Katakana, press  Alt/Option K .
    + To switch from Katakana to Hankaku Katakana, press  Alt/Option K .
    + To switch from Hankaku Katakana (Half-width Katakana) back to Hiragana, press  Alt/Option K .
    + To switch from any Japanese mode or Wide Latin to Latin, press  Alt/Option L .
    + To switch from Latin to Wide Latin, press  Alt/Option L .
