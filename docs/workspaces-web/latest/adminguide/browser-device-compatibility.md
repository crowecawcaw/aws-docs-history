...
<a name="browser-device-compatibility"></a>
...
For the most up-to-date details on web browser client support, see [Web browser client](https://docs.aws.amazon.com/dcv/latest/userguide/client-web.html).
