...
If you try to launch dual monitors and see a **Pop-ups blocked** icon at the end of the address bar on the top browser, select the icon and the radio button next to **Always allow pop-ups and redirects**. With pop-ups allowed, select the **Dual monitor** icon on the toolbar to launch a new window, reposition the window on your monitor, and drag a browser tab to the window.
