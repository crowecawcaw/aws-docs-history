...
applies to data protection in Amazon WorkSpaces Secure Browser. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with WorkSpaces Secure Browser or other AWS services
...
- [Data encryption in Amazon WorkSpaces Secure Browser](data-encryption.md "data-encryption.md")
- [Inter-network traffic privacy in Amazon WorkSpaces Secure Browser](inter-network-traffic-privacy.md "inter-network-traffic-privacy.md")
- [User access logging in Amazon WorkSpaces Secure Browser](data-protection-logging.md "data-protection-logging.md")
