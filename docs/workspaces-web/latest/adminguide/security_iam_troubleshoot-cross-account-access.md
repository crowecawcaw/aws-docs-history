...
- To learn whether WorkSpaces Secure Browser supports these features, see [How Amazon WorkSpaces Secure Browser works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
