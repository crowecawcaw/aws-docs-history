...
**Topics**
+ [Browser and device compatibility for Amazon WorkSpaces Secure Browser](browser-device-compatibility.md)
+ [Web portal access for Amazon WorkSpaces Secure Browser](user-access.md)
+ [Session guidance for Amazon WorkSpaces Secure Browser](session-guidance.md)
+ [Troubleshooting user issues in Amazon WorkSpaces Secure Browser](user-troubleshooting.md)
+ [Single sign-on extension for Amazon WorkSpaces Secure Browser](extension.md)