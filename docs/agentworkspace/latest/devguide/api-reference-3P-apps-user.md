...
- [getUserArn()](3P-apps-user-requests-getuserarn.md "3P-apps-user-requests-getuserarn.md")
- [getInstanceId()](3P-apps-user-requests-getinstanceid.md "3P-apps-user-requests-getinstanceid.md")
- [getNetworkType()](3P-apps-user-requests-getnetworktype.md "3P-apps-user-requests-getnetworktype.md")
- [setLanguage()](3P-apps-user-requests-setlanguage.md "3P-apps-user-requests-setlanguage.md")
- [setVisualMode()](3P-apps-user-requests-setvisualmode.md "3P-apps-user-requests-setvisualmode.md")
- [onVisualModeChange()](3P-apps-user-events-visualmodechange-sub.md "3P-apps-user-events-visualmodechange-sub.md")
- [offVisualModeChange()](3P-apps-user-events-visualmodechange-unsub.md "3P-apps-user-events-visualmodechange-unsub.md")
