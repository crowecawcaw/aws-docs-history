...
<a name="building-3P-services-startup-process"></a>
...
1. **Agent workspace loading**: The agent workspace will not fully load and become accessible to the agent until all services have successfully connected.

1. **Service startup**: Once connected, the logic within the onCreate handler will begin to run.

1. **Service runtime**: Once created, services continue running for the remainder of the agent workspace session.
