...
![Applications that have been onboarded will appear in the Agent applications menu.](http://docs.aws.amazon.com/agentworkspace/latest/devguide/images/integrating-with-agent-workspace-how-apps-load.png)
