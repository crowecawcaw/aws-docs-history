# Get the type of contact in Amazon Connect Customer agent workspace

Get the type of the contact in Amazon Connect Customer agent workspace. This indicates
