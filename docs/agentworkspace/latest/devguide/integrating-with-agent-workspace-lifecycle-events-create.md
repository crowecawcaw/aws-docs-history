# The create event in Amazon Connect Customer agent workspace

The create event in the Amazon Connect Customer agent workspace results in the `onCreate` handler passed into the `AmazonConnectApp.init()` to
