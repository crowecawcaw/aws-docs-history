...
For preview contacts, the agent must call [engagePreviewContact()](3P-apps-contact-requests-engagepreviewcontact.md "3P-apps-contact-requests-engagepreviewcontact.md") to proceed to the Connecting state, or [disconnectSelf()](3P-apps-contact-requests-disconnectself.md "3P-apps-contact-requests-disconnectself.md") to
