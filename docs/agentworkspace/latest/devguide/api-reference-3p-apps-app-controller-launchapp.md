...
Launch the application in the workspace for the given application ARN or name. It
...
| options.scope            | ContactScope  | IdleScope                                                                                           | Indicates if the application is launched with idle i.e when there are no contacts or launched during an active contact | **Output - AppInfo** |
| **Parameter**            | **Type**      | **Description**                                                                                     |
| ---                      | ---           | ---                                                                                                 |
| instanceId               | string        | Unique ID of of the application instance                                                            |
