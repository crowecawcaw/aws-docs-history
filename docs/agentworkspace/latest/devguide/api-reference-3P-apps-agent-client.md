...
- [getState() - Deprecated](3P-apps-agent-requests-getstate.md "3P-apps-agent-requests-getstate.md")
...
- [onStateChanged() - Deprecated](3P-apps-agent-events-statechanged-sub.md "3P-apps-agent-events-statechanged-sub.md")
- [offStateChanged() - Deprecated](3P-apps-agent-events-statechanged-unsub.md "3P-apps-agent-events-statechanged-unsub.md")
- [getDefaultOutboundQueue()](3P-apps-agent-requests-getdefaultoutboundqueue.md "3P-apps-agent-requests-getdefaultoutboundqueue.md")
- [getRoutingProfileQueues()](3P-apps-agent-requests-getroutingprofilequeues.md "3P-apps-agent-requests-getroutingprofilequeues.md")
- [getAvailabilityState()](3P-apps-agent-requests-getavailabilitystate.md "3P-apps-agent-requests-getavailabilitystate.md")
- [listSecurityProfilePermissions()](3P-apps-agent-requests-listsecurityprofilepermissions.md "3P-apps-agent-requests-listsecurityprofilepermissions.md")
- [onAvailabilityStateChanged()](3P-apps-agent-events-availabilitystatechanged-sub.md "3P-apps-agent-events-availabilitystatechanged-sub.md")
- [offAvailabilityStateChanged()](3P-apps-agent-events-availabilitystatechanged-unsub.md "3P-apps-agent-events-availabilitystatechanged-unsub.md")
- [onNextAvailabilityStateChanged()](3P-apps-agent-events-nextavailabilitystatechanged-sub.md "3P-apps-agent-events-nextavailabilitystatechanged-sub.md")
- [getNetworkConnectionStatus()](3P-apps-agent-requests-getnetworkconnectionstatus.md "3P-apps-agent-requests-getnetworkconnectionstatus.md")
- [onNetworkConnectionStatusChanged()](3P-apps-agent-events-networkconnectionstatuschanged-sub.md "3P-apps-agent-events-networkconnectionstatuschanged-sub.md")
- [offNetworkConnectionStatusChanged()](3P-apps-agent-events-networkconnectionstatuschanged-unsub.md "3P-apps-agent-events-networkconnectionstatuschanged-unsub.md")
- [offNextAvailabilityStateChanged()](3P-apps-agent-events-nextavailabilitystatechanged-unsub.md "3P-apps-agent-events-nextavailabilitystatechanged-unsub.md")
