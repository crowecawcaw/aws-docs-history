# Get the attributes of a contact in Amazon Connect Customer agent workspace

Returns a map of the attributes associated with the contact in the Amazon Connect Customer agent workspace. Each
