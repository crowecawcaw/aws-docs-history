...
- [Ensuring that apps can only be embedded in the Connect Customer agent workspace](#recommendations-and-best-practices-embedded "#recommendations-and-best-practices-embedded")
...
[WCAG AA 2.1](https://www.w3.org/TR/WCAG21/ "https://www.w3.org/TR/WCAG21/"). The
