# Get the voice enhancement mode in Amazon Connect Customer agent workspace

Gets the voice enhancement mode of the user that's currently logged in to Amazon Connect
