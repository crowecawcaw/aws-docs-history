# Get the voice enhancement mode in Connect Customer Customer agent workspace

Gets the voice enhancement mode of the user that's currently logged in to Connect Customer
