...
| ------------------------ | -------- | ---------------------------------------------- | --------------------------- | ------------------------------------------------------- | ----------------------------- |
| appInstanceId _Required_ | string   | The instance ID of the application             | **Output - AppFocusResult** |
| **Parameter**            | **Type** | **Description**                                |
| ---                      | ---      | ---                                            |
| instanceId               | string   | The AmazonResourceName(ARN) of the application |
| result                   | "queued" | "completed"                                    | "failed"                    | Indicates if the request is queued, completed or failed | **Permissions required:** `*` |
