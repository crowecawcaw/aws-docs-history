# Get the initial ID of the contact in Connect Customer Customer agent workspace

Returns the original (initial) contact id from which this contact was transferred
in the Connect Customer Customer agent workspace, or none if this is not an internal Connect transfer. This is
