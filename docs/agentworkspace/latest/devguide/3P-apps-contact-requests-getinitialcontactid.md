# Get the initial ID of the contact in Amazon Connect Customer agent workspace

Returns the original (initial) contact id from which this contact was transferred
in the Amazon Connect Customer agent workspace, or none if this is not an internal Connect transfer. This is
