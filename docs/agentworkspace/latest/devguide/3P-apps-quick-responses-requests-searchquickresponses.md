...
| operator       | QuickResponsesQueryOperator  | The operator to use for matching attribute field values in the<br>query. Supported values: "CONTAINS" or "CONTAINS\_AND\_PREFIX"                                                                                     |
