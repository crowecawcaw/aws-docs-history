...
agent application with AWS-managed applications from the Connect Customer agent workspace.
...
agent workspace](../../../connect/latest/adminguide/agent-workspace.md "../../../connect/latest/adminguide/agent-workspace.md").
