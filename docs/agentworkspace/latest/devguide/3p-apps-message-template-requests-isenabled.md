...
Message Template feature is enabled in Amazon Connect Agent Workspace
...
- `isEnabled`: A boolean indicating if the feature is
  enabled
- `knowledgeBaseId`: The id of the Message Template Knowledge
  Base (if the feature is enabled)
