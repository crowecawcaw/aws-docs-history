# Working with third-party applications in the Amazon Connect Customer agent workspace

With Amazon Connect Customer agent workspace, you have the option to use first-party
...
the Amazon Connect Customer agent workspace.
