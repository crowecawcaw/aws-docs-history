...
```
840364872350.dkr.ecr.`region-code`.amazonaws.com/aws-appmesh-envoy:v1.34.4.2-prod
```

FIPS-compliant

```
840364872350.dkr.ecr.`region-code`.amazonaws.com/aws-appmesh-envoy:v1.34.4.2-prod-fips
```
...
```
public.ecr.aws/appmesh/aws-appmesh-envoy:v1.34.4.2-prod
```

FIPS-compliant

```
public.ecr.aws/appmesh/aws-appmesh-envoy:v1.34.4.2-prod-fips
```
...
{
	"name": "envoy",
	"image": "`840364872350`.dkr.ecr.`us-west-2`.amazonaws.com/aws-appmesh-envoy:v1.34.4.2-prod",
	"essential": true,
	"environment": [{
