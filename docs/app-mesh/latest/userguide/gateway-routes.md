...
For more information on creating a gateway route with the AWS CLI for
 App Mesh, see the [create-gateway-route](../../../cli/latest/reference/appmesh/create-gateway-route.md "../../../cli/latest/reference/appmesh/create-gateway-route.md") command in the AWS CLI reference.
...
For more information on deleting a gateway route with the AWS CLI for
 App Mesh, see the [delete-gateway-route](../../../cli/latest/reference/appmesh/delete-gateway-route.md "../../../cli/latest/reference/appmesh/delete-gateway-route.md") command in the AWS CLI reference.
```
