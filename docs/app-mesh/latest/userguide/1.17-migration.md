...
of the [SPIRE agent](https://github.com/spiffe/spire/releases/tag/v0.12.0 "https://github.com/spiffe/spire/releases/tag/v0.12.0")
(released December 2020). This is the first version that can support Envoy versions after
`1.16`.

## Regular expression changes

Starting from Envoy `1.17`, App Mesh configures Envoy to use the [RE2](https://github.com/google/re2 "https://github.com/google/re2") regular expression engine by default. This
