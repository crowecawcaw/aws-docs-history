...
- **Security in the cloud** – Your responsibility is
  ...
  using Strategy Recommendations. The following topics show you how to configure Strategy Recommendations to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Strategy Recommendations resources.

###### Topics

- [Data protection in Migration Hub Strategy Recommendations](data-protection.md "data-protection.md")
- [Identity and access management for Migration Hub Strategy Recommendations](security-iam.md "security-iam.md")
- [Compliance validation for Migration Hub Strategy Recommendations](compliance-validation.md "compliance-validation.md")
