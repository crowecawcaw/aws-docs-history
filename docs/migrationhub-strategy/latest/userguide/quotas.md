...
To view a list of the quotas for Migration Hub Strategy Recommendations, see [Strategy Recommendations
service quotas](../../../general/latest/gr/migrationhubstrategy.md#limits_migrationhubstrategy "../../../general/latest/gr/migrationhubstrategy.md#limits_migrationhubstrategy").

You can also view the quotas for Strategy Recommendations, by opening the [Service Quotas console](https://console.aws.amazon.com/servicequotas/home "https://console.aws.amazon.com/servicequotas/home"). In the navigation pane, choose
**AWS services** and select **Migration Hub Strategy Recommendations**.
