...
encounter when working with Strategy Recommendations and IAM.

###### Topics

- [I am not authorized to
  perform an action in Strategy Recommendations](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I'm an administrator and want
  to allow others to access Strategy Recommendations](#security_iam_troubleshoot-admin-delegate "#security_iam_troubleshoot-admin-delegate")
- [I want to allow people
  outside of my AWS account to access my Strategy Recommendations resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Strategy Recommendations
...
have the fictional `migrationhub-strategy:`GetWidget``
permissions.
...
`migrationhub-strategy:`GetWidget`` action.
...
Strategy Recommendations. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
to allow others to access Strategy Recommendations

To allow others to access Strategy Recommendations, you must grant permission to the people or applications that need access. If you are using AWS IAM Identity Center
...
a policy to the entity that grants them the correct permissions in Strategy Recommendations. After the permissions are granted, provide the credentials to the user
...
outside of my AWS account to access my Strategy Recommendations resources
...
- To learn whether Strategy Recommendations supports these features, see [How Migration Hub Strategy Recommendations works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
