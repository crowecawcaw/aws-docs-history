...
(have permissions) to use Strategy Recommendations resources. IAM is an AWS service that you can
...
- [How Migration Hub Strategy Recommendations works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
- [AWS managed policies for Migration Hub Strategy Recommendations](security-iam-awsmanpol.md "security-iam-awsmanpol.md")
- [Identity-based policy examples for Migration Hub Strategy Recommendations](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md")
- [Troubleshooting Migration Hub Strategy Recommendations identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md")
- [Using service-linked roles for Strategy Recommendations](using-service-linked-roles.md "using-service-linked-roles.md")
- [Migration Hub Strategy Recommendations and interface VPC endpoints (AWS PrivateLink)](vpc-interface-endpoints.md "vpc-interface-endpoints.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting Migration Hub Strategy Recommendations identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
- **Service administrator** - determine user access and
  submit permission requests (see [How Migration Hub Strategy Recommendations works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md"))
- **IAM administrator** - write policies to manage
  access (see [Identity-based policy examples for Migration Hub Strategy Recommendations](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md"))
