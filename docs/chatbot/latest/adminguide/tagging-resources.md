...
- [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md"), [UntagResource](../APIReference/API_UntagResource.md "../APIReference/API_UntagResource.md"), and [ListTagsForResource](../APIReference/API_ListTagsForResource.md "../APIReference/API_ListTagsForResource.md") API actions.
- [TagResource](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/tag-resource.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/tag-resource.html"), [UntagResource](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/untag-resource.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/untag-resource.html"), and [ListTagsForResource](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/list-tags-for-resource.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/chatbot/list-tags-for-resource.html") in the _Amazon Q Developer in chat applications CLI Reference_.
- [Using Tag Editor](../../../tag-editor/latest/userguide/tag-editor.md "../../../tag-editor/latest/userguide/tag-editor.md") in the _Resource Groups User Guide._
...
| Prefix restriction                  | Don't use the `aws:` prefix in your tag names or values because it is<br>reserved for AWS use. You can't edit or delete tag names or values with this prefix. Tags<br>with this prefix don't count against the number of tags you can assign to a resource. |
| Character restrictions              | Tags may only contain Unicode letters, digits, white space, or these symbols: `_ .<br>: / = +<br>• @`                                                                                                                                                       |
