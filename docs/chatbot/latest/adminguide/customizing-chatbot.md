...
**Topics**
+ [Custom notifications using Amazon Q Developer in chat applications](custom-notifs.md)
+ [Custom actions using Amazon Q Developer in chat applications](custom-actions.md)
+ [Creating and using command aliases in chat channels](creating-aliases.md)
+ [Invoking Amazon Bedrock Agents from chat channels using Amazon Q Developer in chat applications](connect-bedrock-agents.md)