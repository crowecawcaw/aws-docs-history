...
Amazon Q Developer in chat applications currently supports service endpoints, however there are no adjustable quotas. For more information about Amazon Q Developer in chat applications endpoints and quotas,
see [Amazon Q Developer in chat applications endpoints and quotas](../../../general/latest/gr/chatbot.md "../../../general/latest/gr/chatbot.md").
