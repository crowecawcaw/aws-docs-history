...
- AWS Cost Anomaly Detection
  Most AWS services that you can manage using the [AWS Command Line Interface (CLI)](../../../cli/latest/userguide/cli-chap-welcome.md "../../../cli/latest/userguide/cli-chap-welcome.md") are also supported.
  Subsequently, you can manage your AWS resources from these services using AWS CLI commands directly from your chat channels.
