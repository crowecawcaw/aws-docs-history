...
## Prerequisites
<a name="getting-started-prerequisites-chime"></a>
...
1. For **Configure Amazon Chime webhook**, do the following.
   ...
   1. For **Webhook description**, use the following naming convention to describe the purpose of the webhook: **Chat\_room\_name/Webhook\_name**. This helps you associate Amazon Chime webhooks with their Amazon Q Developer in chat applications configurations.
