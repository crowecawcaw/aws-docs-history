...
![Configure network dialog with fields for IP Address, Subnet mask, Router, and DNS servers.](/images/Monitron/latest/user-guide/images/ethernet-IP-DNS-settings.png)
