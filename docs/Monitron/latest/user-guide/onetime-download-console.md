...
![](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/gdpr-create-bucket.png)
...
![](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/gdpr-create-bucket-2.png)
...
![](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/gdpr-choose-s3-bucket.png)

1. From the **Properties** tab, make a note of the name, ARN, and region of the bucket.  
![](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/gdpr-s3-properties-tab.png)
...
![IAM Dashboard showing resource counts, recent updates, and tools for policy management.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-9.png)

1. Choose **Create policy**.  
![IAM Policies page with options to search, filter, and create a new policy.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-10.png)

1. Select the **JSON** tab.  
![Policy editor interface showing JSON structure for specifying permissions in IAM.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-11.png)
...
------  
![IAM policy editor interface showing JSON code for S3 bucket permissions.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-12.png)
...
1. On the **Review and create** page, do the following:
   ...
   1. Choose **Create policy**.  
![Policy creation interface showing policy details, permissions, and tags sections.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-13.png)

## Step 3: Create the role
<a name="gdpr-console-create-role"></a>

1. Open the [ IAM console](https://console.aws.amazon.com/iam/) and choose **Roles**.  
![IAM Dashboard showing resource counts, recent updates, and available tools.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-14.png)

1. Choose **Create role**.  
![IAM roles interface showing 116 roles and a prominent "Create role" button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-15.png)
...
1. Choose **Next**.  
![AWS account selection interface with trusted entity types and account options.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-16.png)
...
![Add permissions interface showing search for "monitron-policy" with one matching result selected.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-17.png)
...
1. Choose **Create role**.  
![Form for creating a new role with fields for role name, description, trust policy, and permissions.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-18.png)
...
![IAM Roles page showing search results for "monitron-role" with one matching role listed.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-19.png)

1. Select the **Trust relationships** tab.  
![IAM role details page showing Trust relationships tab and Edit trust policy button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/s3-export-20.png)

1. Choose **Edit trust relationship**.  
![](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/gdpr-edit-trust-relationship.png)
