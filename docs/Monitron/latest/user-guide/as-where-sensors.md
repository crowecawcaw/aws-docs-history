...
![Diagram of motor and pump connected by coupling, without sensor locations shown.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/assets-positions.png)


The following example shows where you might mount sensors if your primary concern is the motor rather than the pump.

![Simplified diagram of a motor and pump system with labels indicating their positions.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/mounting_sensor1.png)


Gearboxes and bearings are also examples of common locations where you might want to place sensors.

![Diagram showing a gearbox connected to two pillar bearings via a shaft.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/mounting_sensor3.png)
...
![Gearbox diagram showing transmission path and damage source causing vibration.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/transmission-path.png)
...
![Diagram showing sensor placement near bearing load zone, indicated by pink area and arrow.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/load-zone1.png)
...
![Diagram showing downward force and tension effects on bearings with different load zones highlighted.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/load-zone2.png)


For information about how to mount sensors, see [Mounting a sensor](as-how-sensors.md).