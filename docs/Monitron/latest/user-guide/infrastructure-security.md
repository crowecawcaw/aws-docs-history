...
As a managed service, Amazon Monitron is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Monitron through the network. Clients must
