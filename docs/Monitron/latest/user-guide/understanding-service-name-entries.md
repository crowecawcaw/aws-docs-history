...
**Topics**
+ [Successful DeleteProject action](#collapsible-section-1)
+ [Failed DeleteProject action (authorization error)](#collapsible-section-2)
+ [Failed DeleteProject action (conflict exception error)](#collapsible-section-3)
