...
<a name="troubleshooting-gateway-detection-ethernet"></a>
...
+ View and copy your gateway MAC address and get in touch with your IT admin. See [Retrieving MAC address details](https://docs.aws.amazon.com/Monitron/latest/user-guide/mac-address-ethernet-gateway.html).
