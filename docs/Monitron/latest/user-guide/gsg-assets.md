...
![Assets page with one example asset listed and an "Add asset" button in the top right corner.](images/add-asset-mobile-1.png) 2. Make sure you're on the correct site your project that you want to add
...
![Amazon Monitron interface showing Sites page with one site listed and options to manage sites.](/images/Monitron/latest/user-guide/images/add-asset-2.png)
