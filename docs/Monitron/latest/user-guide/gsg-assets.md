...
![Assets page showing Add asset button highlighted with one example asset listed below.](images/add-asset-mobile-1.png) 2. Make sure you're on the correct site your project that you want to add
...
![Projects page with Add project button highlighted in the upper right corner.](images/add-asset-1.png) 2. From the left navigation menu, choose **Sites**, and
