...
<a name="troubleshooting-Bluetooth-pairing-ethernet"></a>
...
**Topics**
+ [To unpair a gateway from your device](#unpair-gateway-ethernet)

## To unpair a gateway from your device
<a name="unpair-gateway-ethernet"></a>

1. On your iOS device, choose **Settings**.

1. On your **Settings** screen, choose **Bluetooth**.

1. On the **Bluetooth** screen, choose the information icon next to the name of your Amazon Monitron Gateway.

1. On the next screen, choose **Forget This Device**.