...
![Project name 1 displayed in the upper left corner of the navigation bar.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/site-contents.png)
...
![Dialog box indicating site deletion requires removing all assets, sensors, gateways and users first.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/site-delete.png)
...
![Sites management interface showing a list of three site names and options to delete, edit, or add sites.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/webapp_delete-site-name.png)
