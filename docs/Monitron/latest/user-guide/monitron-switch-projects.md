...
![Project A page showing setup steps, project details, and admin users table with five users.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/switch-project-console.png)
...
![Account details dropdown menu expanded showing View projects and Sign out options.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/switch-project-web-app.png)

1. If you want to add a project, choose **Add project** and enter your project link url.  
![Add project dialog with Project link URL field containing a sample URL and Save button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/switch-project-add-web.png)
...
![Project switching dialog with message about single project sign-in and Confirm button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/project-switching-message-web.png)
