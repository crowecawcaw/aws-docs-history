...
| 4   | Flashing orange light (1 fast/ 1 slow)    | The gateway is connected to the Ethernet network and is attempting to connect to the Amazon Monitron backend system.                                                                                           |
