...
![Asset management interface showing list of assets and positions with status indicators.](images/web-app-add-position-1.png) 3. In the dialog box that opens, enter your **Position
