...
![Dashboard showing vibration and temperature data for a pump, with alarm notifications and asset status.](images/web-understand-sensor-measurement.png) 3. Choose **Acknowledge**.
