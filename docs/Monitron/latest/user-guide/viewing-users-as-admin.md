...
![Username dropdown menu showing User 9 search with list of users and their email addresses.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/user-7.png)
...
![Permission dropdown menu showing Admin selected, with Technician, Viewer, and Remove options.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/user-8.png)
...
![Modify user permissions page showing Project name with Admin role and inherited permissions for sites.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/user-9.png)