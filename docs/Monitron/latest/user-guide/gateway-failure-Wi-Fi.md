...
<a name="gateway-failure-Wi-Fi"></a>
...
+ **Make sure the gateway is not already commissioned to any of your projects.** The devide must be deleted from all existing projects before commissioning.

If none of these actions resolves the issue, try the following:
+ View and copy your gateway MAC address and get in touch with your IT admin. See [Retrieving MAC address details](https://docs.aws.amazon.com/Monitron/latest/user-guide/mac-address-wifi-gateway.html).
