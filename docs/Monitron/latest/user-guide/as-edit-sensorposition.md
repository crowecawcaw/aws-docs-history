...
![Dashboard showing asset positions with warning status for Position name 3 and vibration data graph.](images/vibration-web-changing-sensor-position-name-1.png) 2. Choose **Edit position name**. 3. For **Position name**, enter a new name. 4. Choose **Save**.
