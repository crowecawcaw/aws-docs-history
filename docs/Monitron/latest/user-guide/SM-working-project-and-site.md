...
![Project name dropdown menu in the header of an application interface.](images/projectname.png) 2. Choose the project name.

![Dropdown menu showing Project name 1 expanded with three site name options listed.](images/project-to-site.png) 3. Choose the site that you want to view.
...
![Header bar with expandable site name menu and notification bell icon.](images/site-level.png) 2. Choose the site name.

![Dropdown menu showing Project name 1 with three site names listed beneath it.](images/site-to-project.png) 3. Choose the project name.
