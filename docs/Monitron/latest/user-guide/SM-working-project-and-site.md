...
<a name="SM-working-project-and-site"></a>
...
![Project name dropdown menu in the header of an application interface.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/projectname.png)


or

![Header bar with expandable site name menu and notification bell icon.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/site-level.png)
...
**Topics**
+ [Switching from project level to site level](#project-to-site)
+ [Switching from site level to project level](#site-to-project)

## Switching from project level to site level
<a name="project-to-site"></a>
...
![Dropdown menu showing Project name 1 expanded with three site name options listed.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/project-to-site.png)

1. Choose the site that you want to view. 

## Switching from site level to project level
<a name="site-to-project"></a>
...
![Dropdown menu showing Project name 1 with three site names listed beneath it.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/site-to-project.png)
