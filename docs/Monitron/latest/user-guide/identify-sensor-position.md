...
![Scan sensor icon highlighted in the asset list header.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-icon.png)
...
![Sensor scan dialog showing phone near sensor with instruction text below the illustration.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-graphic.png)

1. After you've scanned your sensor successfully, your mobile app will show the sensor's position and details.  
![Sensor scan successful dialog with list of scanned assets including Pump-4, HVAC, and HVAC-2.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-success-message.png)  
![Position monitoring interface showing vibration RMS velocity graph over one week period.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-position-details.png)
...
![Dialog box displaying Scan sensor failed error message with Close button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-unread-sensor.png)
...
![Sensor scan failed dialog with error message and Close button.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-verify-commission.png)
...
![Dialog showing scan sensor failed error with message about missing site permissions.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-no-permissions.png)
...
![Dialog box prompting to change sites when sensor is detected on a different site.](https://docs.aws.amazon.com/Monitron/latest/user-guide/images/android-sensor-scan-change-site.png)
