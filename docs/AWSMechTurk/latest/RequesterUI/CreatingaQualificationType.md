...
<a name="CreatingaQualificationType"></a>
...
1. On the **Qualification Types** page, choose **Create New Qualification Type**.

1. In the **Create New Qualification Type** dialog box, enter a name that describes the qualification type in **Friendly Name**.

1. In **Description** text box, enter a description of the qualification type and then choose **Create**.
