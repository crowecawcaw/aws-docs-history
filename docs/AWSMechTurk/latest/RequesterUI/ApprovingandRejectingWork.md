...
<a name="ApprovingandRejectingWork"></a>
...
**Topics**
+ [Review assignments](ReviewingResultsintheRUI.md)
+ [Review assignments offline](ReviewingResultsOutsideoftheRUI.md)
+ [Approve previously rejected assignments](ReversingRejectedAssignment.md)