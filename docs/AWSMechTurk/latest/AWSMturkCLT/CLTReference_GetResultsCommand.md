...
| `-outputfile [filename]` |  Specifies the file in which the results are saved. For information about this file, see *The output file* in [Files Used by the Command Line Tools](CLTFilesArticle.md). <br />Example: `-outputfile helloworld.results` | Yes | 
...
| `-successfile [filename]` |  Specifies the path and name of the `.success` file that [loadHITs](CLTReference_LoadHITsCommand.md) returns. For information about this file, see *The success file* in [Files Used by the Command Line Tools](CLTFilesArticle.md). <br />Example: `-successfile helloworld.success` | Yes | 
