...
**Topics**
+ [Create a HIT Directly](#mturk-creating-hits-directly)
+ [Create a HIT using a HIT Type](#mturk-creating-hits-using-type)
...
<a name="mturk-creating-hits-using-type"></a>
