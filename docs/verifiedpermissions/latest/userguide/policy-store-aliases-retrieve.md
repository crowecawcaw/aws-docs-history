...
You can retrieve a policy store alias by using the [GetPolicyStoreAlias](../apireference/API_GetPolicyStoreAlias.md "../apireference/API_GetPolicyStoreAlias.md")
operation. The following example retrieves details for a policy store alias with the name `example-policy-store`.
...
You can list policy store aliases by using the [ListPolicyStoreAliases](../apireference/API_ListPolicyStoreAliases.md "../apireference/API_ListPolicyStoreAliases.md")
operation. The following example lists all policy store aliases owned by the 123456789012 AWS account in the us-west-2 Region.
