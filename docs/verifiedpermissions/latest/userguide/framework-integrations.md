...
1. Extract relevant authorization context from requests

1. Determine authorization decisions using Verified Permissions

1. Enforce access control based on authorization results

Verified Permissions currently supports the following frameworks:
+ [Express.js for Node.js applications](integration-express.md)