...
You can create a policy store alias by using the [CreatePolicyStoreAlias](../apireference/API_CreatePolicyStoreAlias.md "../apireference/API_CreatePolicyStoreAlias.md")
operation. The following example creates a policy store alias with the name `example-policy-store`.
