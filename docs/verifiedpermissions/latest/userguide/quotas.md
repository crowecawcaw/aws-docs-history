...
| Policy store aliases per policy store | 10                               | Yes                                                                                                                                                                                                        | The maximum number of policy store aliases that you can associate with a single<br>policy store. |
...
| Namespaces per policy store schema    | 100                              | Yes                                                                                                                                                                                                        | The maximum number of namespaces that you can define in a<br>policy store schema.                |
