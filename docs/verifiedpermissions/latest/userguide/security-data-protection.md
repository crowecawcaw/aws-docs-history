...
For detailed information about using customer managed keys for encryption, see [Encrypting Resources in Amazon Verified Permissions](security-data-protection-cmk.md).