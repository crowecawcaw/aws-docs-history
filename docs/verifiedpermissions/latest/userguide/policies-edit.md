...
**To edit a static policy**  
You can edit a static policy by using the [UpdatePolicy](https://docs.aws.amazon.com/verifiedpermissions/latest/apireference/API_UpdatePolicy.html) operation. The following example edits a simple static policy. 
