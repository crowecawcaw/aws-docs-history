...
+ You have reached the quota of available policy stores in a given Region. For more information, see [Quotas for resources](quotas.md#quotas-resources). 
...
1. Choose **Delete this policy store**.

1. Type `delete` in the text box and choose **Delete**.
**Note**  
