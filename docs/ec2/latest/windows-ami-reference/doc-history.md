...
| ----------------------------------- | -------------------------------------------------------- | ---------------- |
| Archive 2014 release notes          | Yearly archive of release notes more than ten years old. | January 21, 2025 |
| Add support for Windows Server 2025 | Release AMIs for Windows Server 2025.                    | November 4, 2024 |
| Initial release                     | Initial release of the AWS Windows AMI reference.        | April 30, 2024   |
