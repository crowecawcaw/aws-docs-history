...
For more information about API error codes, see [Error Codes](../../../AWSEC2/latest/APIReference/api-error-codes.md "../../../AWSEC2/latest/APIReference/api-error-codes.md").

###### Contents

- [Query API request rate](#api-request-rate "#api-request-rate")
- [Eventual consistency](#api-eventual-consistency "#api-eventual-consistency")
- [Unauthorized operation](#unauthorized-operation "#unauthorized-operation")
...
For more information, see [Request throttling](ec2-api-throttling.md "ec2-api-throttling.md") in the _Amazon EC2 Developer Guide_.
...
For more information, see [Eventual consistency](eventual-consistency.md "eventual-consistency.md")
...
For more information about creating IAM policies for Amazon EC2, see [IAM policies for Amazon EC2](../../../AWSEC2/latest/UserGuide/iam-policies-for-amazon-ec2.md "../../../AWSEC2/latest/UserGuide/iam-policies-for-amazon-ec2.md")
in the _Amazon EC2 User Guide_.

For more information about which ARNs you can use with which Amazon EC2 API actions, see
[Actions, resources, and condition keys for Amazon EC2](../../../service-authorization/latest/reference/list_amazonec2.md "../../../service-authorization/latest/reference/list_amazonec2.md")
