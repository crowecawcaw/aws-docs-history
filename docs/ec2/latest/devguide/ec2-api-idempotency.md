...
- [Idempotency in Amazon EC2](#client-tokens "#client-tokens")
- [RunInstances idempotency](#run-instances-idempotency "#run-instances-idempotency")
- [Examples](#Run_Instance_Idempotency_CLI "#Run_Instance_Idempotency_CLI")
...
token_. The corresponding AWS CLI commands also support idempotency
...
The [RunInstances](../../../AWSEC2/latest/APIReference/API_RunInstances.md "../../../AWSEC2/latest/APIReference/API_RunInstances.md") API action uses both Regional and zonal
idempotency.
...
The following [allocate-hosts](../../../cli/latest/reference/ec2/allocate-hosts.md "../../../cli/latest/reference/ec2/allocate-hosts.md")
...
The following [run-instances](../../../cli/latest/reference/ec2/run-instances.md "../../../cli/latest/reference/ec2/run-instances.md")
...
The following [AllocateHosts](../../../AWSEC2/latest/APIReference/API_AllocateHosts.md "../../../AWSEC2/latest/APIReference/API_AllocateHosts.md")
...
The following [RunInstances](../../../AWSEC2/latest/APIReference/API_RunInstances.md "../../../AWSEC2/latest/APIReference/API_RunInstances.md")
...
| 400-series response codes<br>([client errors](../../../AWSEC2/latest/APIReference/errors-overview.md#CommonErrors "../../../AWSEC2/latest/APIReference/errors-overview.md#CommonErrors"))                                 | Do not retry   | There is a problem with the request, from among the following:<br>• It includes a parameter or parameter combination that is not valid.<br>• It uses an action or resource for which you do not<br>have permissions.<br>• It uses a resource that is in the process of changing<br>states.<br>If the request involves a resource that is in the process of<br>changing states, retrying the request could possibly<br>succeed. |
| 500-series response codes<br>([server errors](../../../AWSEC2/latest/APIReference/errors-overview.md#api-error-codes-table-server "../../../AWSEC2/latest/APIReference/errors-overview.md#api-error-codes-table-server")) | Retry          | The error is caused by an AWS server-side issue and is generally transient.<br>Repeat the request with an appropriate backoff strategy.                                                                                                                                                                                                                                                                                        |
