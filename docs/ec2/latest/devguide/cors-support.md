...
[Signing AWS API requests](../../../IAM/latest/UserGuide/reference_aws-signing.md "../../../IAM/latest/UserGuide/reference_aws-signing.md") in
...
control (CORS)](https://developer.mozilla.org/en-US/docs/Web/HTTP/Access_control_CORS "https://developer.mozilla.org/en-US/docs/Web/HTTP/Access_control_CORS").
