...
- For API details, see
  [DeleteCustomerGateway](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-customer-gateway.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/ec2/delete-customer-gateway.html")
...
- For API details, see
  [DeleteCustomerGateway](../../../powershell/v4/reference.md "../../../powershell/v4/reference.md")
...
- For API details, see
  [DeleteCustomerGateway](../../../powershell/v5/reference.md "../../../powershell/v5/reference.md")
