...
see [Actions](../../../AWSEC2/latest/APIReference/query-apis.md "../../../AWSEC2/latest/APIReference/query-apis.md").

###### Contents

- [Structure of a GET request](#structure-of-a-get-request "#structure-of-a-get-request")
- [Query parameters](#query-parameters "#query-parameters")
- [Query API authentication](#query-authentication "#query-authentication")
- [Query response structures](#api-responses "#api-responses")
- [Pagination](#api-pagination "#api-pagination")
- [Preventing requests over HTTP](#prevent-http-requests "#prevent-http-requests")
...
- **Endpoint**: The URL that serves as the entry point for the web
  service. For more information, see [Amazon EC2 service endpoints](ec2-endpoints.md "ec2-endpoints.md").
...
- **Authorization parameters**: The authorization parameters that
  ...
  see [Signing AWS API requests](../../../IAM/latest/UserGuide/reference_aws-signing.md "../../../IAM/latest/UserGuide/reference_aws-signing.md") in
...
For more information about common parameters for API requests, see [Common query parameters](../../../AWSEC2/latest/APIReference/CommonParameters.md "../../../AWSEC2/latest/APIReference/CommonParameters.md").
...
about Amazon EC2 endpoints, see [Amazon EC2 service endpoints](ec2-endpoints.md "ec2-endpoints.md").

The `Action` parameter indicates the action to perform. For a complete list of
actions, see [Actions](../../../AWSEC2/latest/APIReference/query-apis.md "../../../AWSEC2/latest/APIReference/query-apis.md"). The
...
headers, [common required parameters](../../../AWSEC2/latest/APIReference/CommonParameters.md "../../../AWSEC2/latest/APIReference/CommonParameters.md"), and
...
[AWS security credentials](../../../IAM/latest/UserGuide/security-creds.md "../../../IAM/latest/UserGuide/security-creds.md").
...
Signature Version 4. For more information, see [Signing AWS API requests](../../../IAM/latest/UserGuide/reference_aws-signing.md "../../../IAM/latest/UserGuide/reference_aws-signing.md") in the _IAM User Guide_.
...
For more information, see [Pagination](ec2-api-pagination.md "ec2-api-pagination.md") in the _Amazon EC2 Developer Guide_.
...
instead. You can use the [`aws:SecureTransport`](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-securetransport "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-securetransport") global IAM condition key in
