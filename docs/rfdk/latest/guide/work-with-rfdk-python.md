# Working with the RFDK in Python
...
In addition to the general [RFDK prerequisites](work-with-rfdk.md#work-with-prerequisites "work-with-rfdk.md#work-with-prerequisites"), please see [the Python prerequisites for AWS CDK](../../../cdk/latest/guide/work-with-cdk-python.md#python-prerequisites "../../../cdk/latest/guide/work-with-cdk-python.md#python-prerequisites").
