...
1. From the **Choose type** menu, choose the type of item you're looking for.
...
1. Enter the exact identifier or an identifier with wildcard characters to search for.
