...
As a managed service, Amazon Detective; is protected by AWS global network security. For
...
You use AWS published API calls to access Detective; through the network. Clients must
