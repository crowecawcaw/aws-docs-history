...
| Bar chart | A bar chart shows values based on groupings.<br />Depending on the chart, you might be able to choose a bar to display a timeline of related activity.![Example of a profile panel containing a bar chart.](http://docs.aws.amazon.com/detective/latest/userguide/images/screen_profile_panel_bar_chart.png) | 
