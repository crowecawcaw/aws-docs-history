...
- [Using NDI® outputs in a MediaConnect flow](outputs-using-ndi.md "outputs-using-ndi.md")
- [Adding outputs to a MediaConnect flow](outputs-add.md "outputs-add.md")
- [Viewing the list of outputs for a MediaConnect flow](outputs-view-list.md "outputs-view-list.md")
...
- [Disabling or removing outputs from a MediaConnect flow](outputs-remove.md "outputs-remove.md")
