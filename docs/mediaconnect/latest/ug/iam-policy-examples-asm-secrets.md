...
**Topics**
+ [Allow read access to specific secrets in Secrets Manager](#iam-policy-examples-asm-specific-secrets)
+ [Allow read access to all secrets created in a specific AWS Region in Secrets Manager](#iam-policy-examples-asm-secrets-in-a-region)
+ [Allow read access to all resources in Secrets Manager](#iam-policy-examples-asm-secrets-all)
