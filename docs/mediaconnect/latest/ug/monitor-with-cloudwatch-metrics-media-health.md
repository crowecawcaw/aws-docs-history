...
| Metric                    | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `ConnectionAttempts`      | The number of reconnection attempts. If the MediaConnect flow or<br>source loses its connection, it will attempt to reconnect<br>automatically.<br>Units: Count<br>Supported protocols:<br>• Zixi<br>• SRT listener<br>• SRT caller<br>Supported statistics:<br>• Sum<br>Valid dimension sets:<br>• Flow ARN<br>• Source ARN<br>• Availability Zone<br>• All flows                                                                                                                         |
