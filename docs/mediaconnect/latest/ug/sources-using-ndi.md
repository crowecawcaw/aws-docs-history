...
| Timecode processing                                                                                                                                                     | Timecodes that are embedded in the NDI source will be<br>inserted to the encoded AVC (H.264) video in an SEI message<br>of type pic\_timing, in accordance with section D.1.2 of<br>ISO/IEC 14496-10-2005.                   |
