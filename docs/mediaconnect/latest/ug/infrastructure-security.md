...
As a managed service, AWS Elemental MediaConnect is protected by AWS global network security. For
...
You use AWS published API calls to access MediaConnect through the network. Clients must
