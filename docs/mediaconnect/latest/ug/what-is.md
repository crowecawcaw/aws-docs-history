...
![This illustration shows how AWS Elemental MediaConnect ingests live video into the cloud, routes it dynamically, and distributes it to multiple destinations.](https://docs.aws.amazon.com/mediaconnect/latest/ug/images/mediaconnect-overview.png)
