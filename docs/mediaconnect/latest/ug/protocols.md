...
<a name="protocols-for-transport-stream-flows"></a>
...
+ **Zixi** is a highly available protocol suitable for most applications, especially use cases that involve longer distances. If your encoder doesn't support Zixi, you can use the Zixi Edge Compute (ZEC) software. ZEC operates as both a sender and a receiver. To download this software, see [Zixi Edge Compute (ZEC)](https://portal.zixi.com/self-registration/zec) on the Zixi website. MediaConnect supports two Zixi protocol options:
...
## CDI flows
<a name="protocols-for-cdi-flows"></a>
