...
<a name="getting-started-access-console"></a>
...
<a name="getting-started-create-flow"></a>
...
1. In the **Source** section, for **Source type** select **Standard source**.

1.  For **Name**, enter **AwardsNYCSource**.
...
1. For **Allowlist CIDR**, enter **10.24.34.0/23**.

1. Choose **Create flow**.

## Step 3: Add an output
<a name="getting-started-add-output"></a>
...
1. For **Output type**, select **Standard output**.

1. For **Protocol**, choose **Zixi push**.

1. For **Stream ID**, enter **ZixiAwardsOutput**.

1. For **Destination IP address**, enter **198.51.100.11**.

1. For **Port**, enter **1024**.

1. Choose **Add output**.

## Step 4: Grant an entitlement
<a name="getting-started-add-entitlement"></a>
...
<a name="getting-started-share-with-affiliates"></a>
