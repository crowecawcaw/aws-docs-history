...
<a name="monitor-with-source-stream-monitoring-status"></a>
...
### Programs
<a name="monitor-with-source-stream-monitoring-status-program"></a>
...
### Streams
<a name="monitor-with-source-stream-monitoring-status-streams"></a>
...
<a name="monitor-with-source-stream-monitoring-console"></a>
...
<a name="monitor-with-source-stream-monitoring-cli"></a>
