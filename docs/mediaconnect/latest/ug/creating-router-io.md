...
5. Under **Input type**, choose an option and complete its configuration:
   ...
   4. **Failover** - For failover configuration, follow these steps:
        ...
        For example, if you specify port 2000 for the input,
         ...
         streams.
        4. Under **Source priority configuration**,
   ...
   5. **Merge** - For merge configuration, follow these steps:
        ...
        The recovery window is the size of the buffer (delay) that you want
         ...
         correction.
        2. Under **First source protocol configuration**, define the protocol settings
...
organize this router input. 9. Choose **Create router input**.

1. Open the MediaConnect console at [https://console.aws.amazon.com/mediaconnect/](https://console.aws.amazon.com/mediaconnect/ "https://console.aws.amazon.com/mediaconnect/").
2. In the navigation pane, choose **Router outputs**.
3. Choose **Create router output**.
4. Under **Router output details**, set up your output:
...
5. Under **Output type**, choose one of these options and
