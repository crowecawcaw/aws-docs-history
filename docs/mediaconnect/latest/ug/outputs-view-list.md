...
AWS Elemental MediaConnect added when subscribers create flows based on entitlements that you
granted.
...
The details page for that flow appears. 3. Choose the **Outputs** tab.
...
The return value shows the details of the entire flow, including all the
outputs. The following example shows the return value:
