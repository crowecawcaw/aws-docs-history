...
<a name="security-iam-trusted-entity"></a>
...
<a name="security-iam-trusted-entity-create-policy"></a>
...
<a name="security-iam-trusted-entity-create-role"></a>
...
1. In the confirmation message that appears across the top of your page, choose the name of the role that you just created by selecting **View role**.

1. Choose **Trust relationships** tab, and then choose **Edit trust policy**.
