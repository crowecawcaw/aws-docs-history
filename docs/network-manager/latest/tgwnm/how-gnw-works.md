...
<a name="nm-how-it-works-on-premises"></a>
...
You can work with one of our Partners in the AWS Partner Network (APN) to provision and connect your on-premises networks. For more information, see [AWS Network Manager](https://aws.amazon.com/transit-gateway/network-manager).

## Supported resource types
<a name="nm-supported-resource-type"></a>
