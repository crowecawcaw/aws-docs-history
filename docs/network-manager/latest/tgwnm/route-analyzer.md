...
+ [Perform a route analysis](working-with-route-analyzer.md)
+ [Example: Route analysis for peered transit gateways](example-route-analyzer.md)
+ [Example: Route analysis with a middlebox configuration](example-route-analyzer-middlebox.md)

## Route Analyzer basics
<a name="route-analyzer-basics"></a>
