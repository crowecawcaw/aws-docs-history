...
<a name="example-route-analyzer"></a>
...
![Peered transit gateways](https://docs.aws.amazon.com/network-manager/latest/tgwnm/images/transit-gateway-peering.png)
...
![Route analyzer results](https://docs.aws.amazon.com/network-manager/latest/tgwnm/images/nm-route-analyzer-peering.png)
