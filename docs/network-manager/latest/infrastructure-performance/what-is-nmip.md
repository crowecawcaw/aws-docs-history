...
view performance in CloudWatch. For more information about CloudWatch pricing guidelines, see [Amazon CloudWatch pricing](https://aws.amazon.com/cloudwatch/pricing/ "https://aws.amazon.com/cloudwatch/pricing/").
...
- **Availability zones** — Generate network performance metrics between two
  Availability Zones or within a single Availability Zone.
- **Regions** — Generate network performance metrics to see
...
Regions that support Infrastructure Performance, see [Region availability](how-nmip-works.md#nmip-regions "how-nmip-works.md#nmip-regions").
