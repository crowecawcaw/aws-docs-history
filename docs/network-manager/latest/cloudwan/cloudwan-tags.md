...
- Control access to your AWS resources. For more information on controlling access
  to resources, see [Controlling access to AWS resources using tags](../../../IAM/latest/UserGuide/access_tags.md "../../../IAM/latest/UserGuide/access_tags.md") in the _AWS Identity and Access
...
For tagging support resources in Network Manager, see [Resources tags in AWS Global Networks for Transit Gateways](../tgwnm/gnw-tagging.md "../tgwnm/gnw-tagging.md").
