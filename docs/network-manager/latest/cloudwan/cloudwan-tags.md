...
+ Control access to your AWS resources. For more information on controlling access to resources, see [Controlling access to AWS resources using tags](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html) in the *AWS Identity and Access Management User Guide*.
...
## Supported resources
<a name="cloudwan-tag-supported"></a>
...
For tagging support resources in Network Manager, see [Resources tags in AWS Global Networks for Transit Gateways](https://docs.aws.amazon.com/network-manager/latest/tgwnm/gnw-tagging.html).
