...
- For a Connect, transit gateway route table, VPC, or Site-to-Site VPN
  attachment, see [delete-attachment](../../../cli/latest/reference/networkmanager/delete-attachment.md "../../../cli/latest/reference/networkmanager/delete-attachment.md").
- For a Connect peer attachment, see [delete-transit-gateway-connect-peer](../../../cli/latest/reference/ec2/delete-transit-gateway-connect-peer.md "../../../cli/latest/reference/ec2/delete-transit-gateway-connect-peer.md").
