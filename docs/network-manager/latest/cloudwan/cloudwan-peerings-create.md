...
The core ASN and the transit gateway ASN must be unique. ASNs must be unique for
 peerings to succeed.
9. Choose one of the following **Associate policy table**
 options:
	...
	* **Existing** — Allows you to associate this peering
	 ...
	 tables](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-policy-tables.html "https://docs.aws.amazon.com/vpc/latest/tgw/tgw-policy-tables.html") in the *AWS Transit Gateway
	 Guide*.
