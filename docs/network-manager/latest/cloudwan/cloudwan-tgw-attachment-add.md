...
10. From the **Transit gateway route table** list, choose
 ...
 creating a transit gateway route table, see [Transit gateway route tables](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-route-tables.html "https://docs.aws.amazon.com/vpc/latest/tgw/tgw-route-tables.html")
