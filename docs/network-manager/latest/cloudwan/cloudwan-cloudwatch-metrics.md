...
The **Add to dashboard** option only works if your registered transit gateway is in the US West (Oregon) Region. 8. The Metrics page displays the usage metrics for the specified edge location
