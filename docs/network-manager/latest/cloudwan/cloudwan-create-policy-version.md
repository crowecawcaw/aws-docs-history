...
Use **Network configuration** to configure the Border Gateway
 ...
 Connect](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-connect.html "https://docs.aws.amazon.com/vpc/latest/tgw/tgw-connect.html") documentation. Using the network configuration, you can also
