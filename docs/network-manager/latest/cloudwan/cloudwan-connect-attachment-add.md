...
the steps to create a Connect peer after creating the Connect attachment, see [Create an AWS Cloud WAN Connect peer for a core network](cloudwan-connect-peer-attachment.md "cloudwan-connect-peer-attachment.md").

###### Topics

- [Create a Connect attachment using the console](#cloudwan-connect-attachment-console "#cloudwan-connect-attachment-console")
- [Create a Connect attachment or Connect peer using the command line or API](#cloudwan-connect-attachment-cli "#cloudwan-connect-attachment-cli")
