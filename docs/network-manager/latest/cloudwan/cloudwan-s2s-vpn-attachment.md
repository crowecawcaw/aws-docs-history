...
Attaching a Site-to-Site VPN connection to your core network edge, first requires that you create a
 ...
 Site-to-Site VPN attachment](https://docs.aws.amazon.com/vpn/latest/s2svpn/create-cwan-vpn-attachment.html "https://docs.aws.amazon.com/vpn/latest/s2svpn/create-cwan-vpn-attachment.html") in the *AWS Site-to-Site VPN User Guide*.
