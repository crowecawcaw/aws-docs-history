...
<a name="cloudwan-visualize-networks"></a>
...
<a name="cloudwan-global-network-intro"></a>
...
For the steps to access and use the Cloud WAN global network dashboards, see [Access AWS Cloud WAN global network dashboards](cloudwan-visualize-networks-global.md).

## Cloud WAN core network dashboards
<a name="cloudwan-core-network-intro"></a>
...
For the steps to use the Cloud WAN core network dashboards see [Access Cloud WAN core network dashboards](cloudwan-visualize-networks-core.md).