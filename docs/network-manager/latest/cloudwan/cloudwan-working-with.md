...
<a name="cloudwan-working-with"></a>
...
**Note**  
Modifying a global network or a core network requires that both be set up first. If you haven't yet created either, see [Quick start: Create an AWS Cloud WAN global network and core network](cloudwan-getting-started.md) for the steps to create a global or core network. 
...
+ [Prefix list associations](cloudwan-prefix-lists.md)
