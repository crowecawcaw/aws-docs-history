...
* Only one core network can be associated with a Direct Connect gateway.
 ...
 For more information about Direct Connect, see the [*AWS Direct Connect
 User Guide*](https://docs.aws.amazon.com/directconnect/latest/UserGuide/Welcome.html "https://docs.aws.amazon.com/directconnect/latest/UserGuide/Welcome.html").
...
* The AS\_PATH BGP attribute is retained in these route advertisements to your
 ...
 policies](https://docs.aws.amazon.com/directconnect/latest/UserGuide/routing-and-bgp.html#private-routing-policies "https://docs.aws.amazon.com/directconnect/latest/UserGuide/routing-and-bgp.html#private-routing-policies") in the *AWS Direct Connect User
 Guide*.
