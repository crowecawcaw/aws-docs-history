...
When you attach a VPC to a core network edge in AWS Cloud WAN, you must specify one subnet from
 ...
 [Transit
 Gateway attachment to a VPC](https://docs.aws.amazon.com/vpc/latest/tgw/tgw-vpc-attachments.html "https://docs.aws.amazon.com/vpc/latest/tgw/tgw-vpc-attachments.html") in the *Transit Gateway User
 Guide*. 
...
You cannot select a subnet from a Local Zone while creating a Cloud WAN VPC
 ...
 see the [*AWS Local Zones User Guide*](https://docs.aws.amazon.com/local-zones/latest/ug/what-is-aws-local-zones.html "https://docs.aws.amazon.com/local-zones/latest/ug/what-is-aws-local-zones.html").
...
DNS support in Cloud WAN enables the resolution of public DNS host names to private
 ...
 network policy or by using the [`get-core-network`](https://docs.aws.amazon.com/cli/latest/reference/networkmanager/get-core-network.html "https://docs.aws.amazon.com/cli/latest/reference/networkmanager/get-core-network.html") command. 
