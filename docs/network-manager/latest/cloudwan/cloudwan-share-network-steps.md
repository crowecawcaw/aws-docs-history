...
10. If there are no resources available to share, you'll need to create a new resource
 share: 
	...
	1. Choose **Create resource share**. See [Create a resource share](https://docs.aws.amazon.com/ram/latest/userguide/getting-started-sharing.html#getting-started-sharing-create "https://docs.aws.amazon.com/ram/latest/userguide/getting-started-sharing.html#getting-started-sharing-create")  in the
	 *AWS RAM User Guide*.
