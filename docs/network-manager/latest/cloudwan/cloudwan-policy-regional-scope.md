...
- [version](#regional-cloudwan-version-json "#regional-cloudwan-version-json")
- [core-network-configuration](#regional-cloudwan-network-config-json "#regional-cloudwan-network-config-json")
- [segments](#regional-cloudwan-segments-json "#regional-cloudwan-segments-json")
- [network-function-groups](#regional-cloudwan-network-functions-json "#regional-cloudwan-network-functions-json")
- [segment-actions](#regional-cloudwan-segment-actions-json "#regional-cloudwan-segment-actions-json")
- [attachment-policies](#regional-cloudwan-attachment-policies-json "#regional-cloudwan-attachment-policies-json")
- [attachment-routing-policy-rules](#regional-cloudwan-attachment-routing-policy-rules-json "#regional-cloudwan-attachment-routing-policy-rules-json")
- [routing-policies](#regional-cloudwan-routing-policies-json "#regional-cloudwan-routing-policies-json")
