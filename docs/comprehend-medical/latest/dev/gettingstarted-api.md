...
To run the AWS CLI and Python examples, install the AWS CLI. For more information, see [Step 1: Set up the AWS Command Line Interface (AWS CLI)](gettingstarted-awscli.md).
...
The following example demonstrates using the `DetectEntitiesV2` operation using the AWS CLI to return the medical entities detected in text. To run the example, you must install the AWS CLI. For more information, see [Step 1: Set up the AWS Command Line Interface (AWS CLI)](gettingstarted-awscli.md).
...
The following example uses the `DetectEntitiesV2` operation with Python. To run the sample, install the AWS CLI. For more information, see [Step 1: Set up the AWS Command Line Interface (AWS CLI)](gettingstarted-awscli.md).
