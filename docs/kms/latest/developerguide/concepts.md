...
| Type of KMS key                                               | Can view KMS key metadata | Can manage KMS key | Created in my AWS account | [Automatic rotation](rotate-keys.md "rotate-keys.md") | [Pricing](https://aws.amazon.com/kms/pricing/ "https://aws.amazon.com/kms/pricing/") |
| ------------------------------------------------------------- | ------------------------- | ------------------ | ------------------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------ |
