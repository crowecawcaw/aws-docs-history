...
To better estimate the effect of disconnecting your external key store, identify the KMS keys in the external key store and [determine their past use](monitoring-keys-determining-usage.md).
