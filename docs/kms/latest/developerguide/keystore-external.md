...
To decide whether an external key store is right for your requirements, see [Choosing the right key store](key-store-overview.md#choosing-key-store).
...
**Note**  
The AWS GovCloud (US) Region does not support TLS\_CHACHA20\_POLY1305\_SHA256.
