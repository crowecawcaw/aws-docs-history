...
template that describes all the AWS resources that you want (such as custom data identifiers), and CloudFormation
provisions and configures those resources for you.

When you use CloudFormation, you can reuse your template to set up your Macie resources consistently
...
CloudFormation templates. The templates describe the resources that you want to provision in your CloudFormation
stacks. They are text files in JSON or YAML format. If you're unfamiliar with JSON or YAML,
AWS Infrastructure Composer or CloudFormation Designer can help you get started. For more information, see [Working with
