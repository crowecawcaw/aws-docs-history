...
1. Select **AUTOMATED\_SENSITIVE\_DATA\_DISCOVERY** as the value for the field, and then choose **Apply**. Macie applies the filter criteria and adds the condition to a filter token in the **Filter criteria** box.
