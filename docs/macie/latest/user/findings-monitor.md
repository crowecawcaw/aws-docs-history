...
**Topics**
+ [Configuring publication settings for findings](findings-publish-frequency.md)
+ [Processing findings with Amazon EventBridge](findings-monitor-events-eventbridge.md)
