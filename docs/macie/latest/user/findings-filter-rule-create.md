...
![The Save rule link in the Filter criteria box on the Findings page.](https://docs.aws.amazon.com/macie/latest/user/images/scrn-findings-filter-bar-save-rule.png)
...
Where:
+ {{my\_filter\_rule}} is the custom name for the rule.
+ `criterion` is a map of filter conditions for the rule:
  ...
  + {{PERSONAL\_INFORMATION}} is an enumerated value for the **Sensitive data category** field.
