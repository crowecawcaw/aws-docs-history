...
- [Features of Macie](#macie-features "#macie-features")
- [Accessing Macie](#macie-access "#macie-access")
- [Pricing for Macie](#macie-pricing "#macie-pricing")
- [Related services](#macie-related-services "#macie-related-services")
...
configuring Macie to [perform automated sensitive data discovery](discovery-asdd.md "discovery-asdd.md"), and by [creating and running sensitive data discovery jobs](discovery-jobs.md "discovery-jobs.md"). If Macie
...
identifiers](managed-data-identifiers.md "managed-data-identifiers.md"), can detect a large and growing list of sensitive data types for many
...
You can also use [custom data identifiers](custom-data-identifiers.md "custom-data-identifiers.md").
A custom data identifier is a set of criteria that you define to detect sensitive
data—a regular expression (_regex_) that defines a
...
To fine tune analyses, you can also use [allow lists](allow-lists.md "allow-lists.md").
...
Evaluate and monitor data for security and access
control
...
privacy of a bucket, it creates a [policy finding](findings-types.md#findings-policy-types "findings-types.md#findings-policy-types")
for you.

In addition to findings, a [dashboard](monitoring-s3-dashboard.md "monitoring-s3-dashboard.md") gives
...
bucket. You can [browse the inventory](monitoring-s3-inventory.md "monitoring-s3-inventory.md"), or sort
...
To [review, analyze, and manage findings](findings.md "findings.md"), you can use
...
To support integration with other services and systems, Macie [publishes findings to Amazon EventBridge](findings-monitor-events-eventbridge.md "findings-monitor-events-eventbridge.md") as
...
If your AWS environment has multiple accounts, you can [centrally manage Macie](macie-accounts.md "macie-accounts.md") for accounts in your environment. You can do this in two ways,
...
In addition to the Amazon Macie console, you can interact with Macie by using the [Amazon Macie API](../APIReference/welcome.md "../APIReference/welcome.md").
...
available, see [Amazon Macie endpoints and quotas](../../../general/latest/gr/macie.md "../../../general/latest/gr/macie.md") in the
_AWS General Reference_. For information about managing AWS Regions
for your AWS account, see [Enable or disable AWS Regions in your
account](../../../accounts/latest/reference/manage-acct-regions.md "../../../accounts/latest/reference/manage-acct-regions.md") in the _AWS Account Management Reference Guide_.
...
AWS Tools for PowerShell. For information about installing and using the AWS CLI, see the [AWS Command Line Interface User Guide](../../../cli/latest/userguide/cli-chap-welcome.md "../../../cli/latest/userguide/cli-chap-welcome.md"). For
information about installing and using the Tools for PowerShell, see the [AWS Tools for PowerShell User Guide](../../../powershell/latest/userguide/pstools-welcome.md "../../../powershell/latest/userguide/pstools-welcome.md").
...
information about this API, see the [Amazon Macie API Reference](../APIReference/welcome.md "../APIReference/welcome.md").
...
discover and report sensitive data in the objects. For more information, see [Amazon Macie pricing](https://aws.amazon.com/macie/pricing/ "https://aws.amazon.com/macie/pricing/").
...
estimates](account-mgmt-costs-review.md "account-mgmt-costs-review.md") on the Amazon Macie console and access them with the Amazon Macie API. Depending on
...
trial](account-mgmt-free-trial.md "account-mgmt-free-trial.md").
...
To learn more about GuardDuty, see the [Amazon GuardDuty User Guide](../../../guardduty/latest/ug/what-is-guardduty.md "../../../guardduty/latest/ug/what-is-guardduty.md").
