...
The Internet Content Provider (ICP) recordal status for a CNAME. The ICPRecordalStatus
 is set to APPROVED for all CNAMEs (aliases) in AWS Regions outside of China.
...
* [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/cloudfront-2020-05-31/AliasICPRecordal "https://docs.aws.amazon.com/goto/SdkForCpp/cloudfront-2020-05-31/AliasICPRecordal")
* [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudfront-2020-05-31/AliasICPRecordal "https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudfront-2020-05-31/AliasICPRecordal")
* [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudfront-2020-05-31/AliasICPRecordal "https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudfront-2020-05-31/AliasICPRecordal")
