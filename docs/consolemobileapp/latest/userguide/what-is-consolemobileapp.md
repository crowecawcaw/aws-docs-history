...
You can view ongoing issues and follow through to the relevant CloudWatch alarm or CloudWatch dashboard screen for a detailed view with graphs and configuration options. In addition, you can check on the status of specific AWS services, view detailed resource screens, and perform some actions.
...
![QR code](images/ACMA-Download-QR-Code-Image-Doc-What-is-ACMA-Page-nn.png)
