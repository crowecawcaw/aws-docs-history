...
Before you begin, be sure that you’ve completed the steps in [Setting up for the AWS Console Mobile Application](setting-up.md).
...
If you use AWS Multi-factor Authentication (MFA), we recommend using either a hardware key fob MFA device, a hardware display card MFA device, or a virtual MFA device for the greatest level of account protection. For a list of MFA devices that you can use, see [Multi-factor Authentication](http://aws.amazon.com/iam/details/mfa/).

The Console Mobile Application does not currently support using U2F security keys for MFA. For more information, see [Supported configurations for using U2F security keys](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_mfa_u2f_supported_configurations.html) in the *IAM User Guide*.
...
<a name="step-1-verify-your-permissions"></a>
...
1. (Optional) Save your password using your password manager.

1. View your home screen.
...
1. Sign in using a QR code:
   ...
   1. Open the right sidepanel by choosing **More ways to access AWS**.

   1. Use your mobile device to scan the **Access the console in the mobile app** QR code.
**Note**  
...
1. (Optional) Or sign in using a URL:

   1. In the Console Mobile Application, select **Use a sign in URL**.

   1. Enter your organization’s sign in URL. This directs you to your organization’s federated sign in page.
**Note**  
...
1. Enter your organizational credentials (for example, a user name and password).

1. Choose **Sign in**.

1. If you are asked for a verification code, check your email for it. Then enter or paste the code in the sign-in screen.
**Note**  
If you have a virtual MFA device or a hardware authenticator enabled for MFA, you will be prompted to enter your MFA code or use your hardware authenticator to verify your identity.

1. (Optional) Save your password using your password manager. We recommend doing this step.

1. Select an AWS account and role to assume.
...
<a name="step-3-view-your-home-screen"></a>
...
<a name="view-and-modify-cloudwatch-alarms"></a>
...
<a name="view-cloudwatch-custom-dashboards"></a>
...
1. Select the CloudWatch custom dashboard that you want to view.

1. (Optional) Adjust the date or timespan to change the viewable data.

### View AWS Health details
<a name="view-aws-health-details"></a>
...
<a name="view-cost-management-details"></a>
...
<a name="view-recently-visited-aws-service-details"></a>
...
<a name="optional-step-4-enable-push-notifications"></a>

If you want to receive push notifications about AWS services and resources of interest on your mobile device, enable push notifications. For more information, see [Push notifications](managing-notifications.md).

## (Optional) Step 5: Access Amazon Q
<a name="optional-step-5-access-amazon-q"></a>

If you want to receive in-app answers to your AWS service questions, access Amazon Q. You can access the generative Artificial Intelligence (AI) from the Amazon Q tab at the bottom of your screen if you have the necessary permissions. For more information, see [What is Amazon Q Developer?](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/what-is.html) and [AmazonQFullAccess](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/managed-policy.html#amazonq-policy-fullaccess) in the the *Amazon Q User Guide*.

**Note**  
For Apple users, Amazon Q is supported on iOS 16 and higher.

## Step 6: View information about other AWS services
<a name="step-6-view-information-about-other-aws-services"></a>
...
For a list of supported services, see [Supported AWS Regions and services](supported-services-regions.md).

## Step 7: Access AWS CloudShell
<a name="step-7-access-aws-cloudshell"></a>
...
For more information about CloudShell Region availability, see [AWS Cloudshell endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/cloudshell.html) in the *CloudShell Reference Guide*.
