...
To get a high-level view of how AWS FinOps Agent and other AWS services work with most IAM
...
To view examples of AWS FinOps Agent identity-based policies, see [Identity-based policy examples for AWS FinOps Agent](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
To see a list of AWS FinOps Agent actions, see [Actions Defined by AWS FinOps Agent](../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions "../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions") in the
...
To see a list of AWS FinOps Agent resource types and their ARNs, see
[Resources Defined by AWS FinOps Agent](../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions Defined by AWS FinOps Agent](../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions "../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions") .
...
To see a list of AWS FinOps Agent condition keys, see [Condition Keys for AWS FinOps Agent](../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-policy-keys "../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions Defined by AWS FinOps Agent](../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions "../../../IAM/latest/UserGuide/list_awsfinopsagent.md#awsfinopsagent-actions-as-permissions") .
...
Changing the permissions for a service role might break AWS FinOps Agent functionality.
Edit service roles only when AWS FinOps Agent provides guidance to do so.
