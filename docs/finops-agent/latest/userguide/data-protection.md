...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Context files       | Open the **Context files\*<br>• workspace in the web application. Choose **Delete*<br>• to soft-delete a file, which removes it from the agent's active context. Choose \*\*Restore*<br>• on a soft-deleted file to make it active again. |
...
| Generated artifacts | Open the **Artifacts\*<br>• workspace and choose **Delete\*<br>• on the artifact you want to remove.                                                                                                                                      |
