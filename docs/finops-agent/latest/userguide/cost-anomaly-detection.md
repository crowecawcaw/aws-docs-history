...
Ask the agent to investigate why [AWS Cost Anomaly Detection](../../../cost-management/latest/userguide/manage-ad.md "../../../cost-management/latest/userguide/manage-ad.md") anomalies occurred and perform root-cause analysis. The agent retrieves the anomaly details, analyzes the root causes ranked by cost impact, and presents its findings directly in the conversation.
...
To investigate anomalies automatically whenever AWS Cost Anomaly Detection detects one, without starting a conversation each time, see [Event-triggered cost anomaly investigation](automated-anomaly-response.md "automated-anomaly-response.md").
