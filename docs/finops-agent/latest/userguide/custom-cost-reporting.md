...
For recurring reporting needs, create a scheduled task that generates and delivers reports on a defined cadence. For details on scheduled tasks, see [Task management](task-management.md "task-management.md").
