...
The following limits apply per agent. For all per-agent quotas, see [Quotas](quotas.md "quotas.md").
...
For details on how context files, memory, and reports are stored and secured, see [Data protection](data-protection.md "data-protection.md").
