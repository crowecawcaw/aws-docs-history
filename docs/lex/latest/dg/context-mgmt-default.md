...
- Fixed value – Any value that doesn't match the
  previous
  When you use the [PutIntent](API_PutIntent.md "API_PutIntent.md") operation to add slots to an
...
3. If neither of the first two default values are used, then
   the slot doesn't have a default value and Amazon Lex will elicit
   a value as usual.
