...
- If the message is a clarification prompt configured for the
  ...
  Conversation Context](context-mgmt.md "context-mgmt.md").
...
**[accept](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
**[activeContexts](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
**[botAlias](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**

Alias of the Amazon Lex bot.

Required: Yes

**[botName](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**

Name of the Amazon Lex bot.

Required: Yes

**[contentType](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
**[requestAttributes](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
For more information, see [Setting Request Attributes](context-mgmt.md#context-mgmt-request-attribs "context-mgmt.md#context-mgmt-request-attribs").

**[sessionAttributes](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
For more information, see [Setting Session Attributes](context-mgmt.md#context-mgmt-session-attribs "context-mgmt.md#context-mgmt-session-attribs").

**[userId](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
**[inputStream](#API_runtime_PostContent_RequestSyntax "#API_runtime_PostContent_RequestSyntax")**
...
**[activeContexts](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[alternativeIntents](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[botVersion](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[contentType](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**

Content type as specified in the `Accept` HTTP header in
the request.

**[dialogState](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[encodedInputTranscript](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[encodedMessage](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
returned, see [Supported Message Formats](howitworks-manage-prompts.md#msg-prompts-formats "howitworks-manage-prompts.md#msg-prompts-formats").
...
**[inputTranscript](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**

_This header has been deprecated._
...
**[intentName](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**

Current user intent that Amazon Lex is aware of.

**[message](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[messageFormat](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[nluIntentConfidence](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[sentimentResponse](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[sessionAttributes](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**

Map of key/value pairs representing the session-specific context
information.

**[sessionId](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**

The unique identifier for the session.

**[slots](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[slotToElicit](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
**[audioStream](#API_runtime_PostContent_ResponseSyntax "#API_runtime_PostContent_ResponseSyntax")**
...
In this request, the URI identifies a bot (Traffic), bot version
($LATEST), and end user name (someuser). The `Content-Type`
header identifies the format of the audio in the body. Amazon Lex also
supports other formats. To convert audio from one format to another,
if necessary, you can use SoX open source software. You specify the
format in which you want to get the response by adding the
`Accept` HTTP header.

In the response, the `x-amz-lex-message` header shows
the response that Amazon Lex returned. The client can then send this
response to the user. The same message is sent in audio/MPEG format
through chunked encoding (as requested).
...
- [AWS Command Line Interface V2](../../../goto/cli2/runtime.lex-2016-11-28/PostContent.md "../../../goto/cli2/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for .NET V4](../../../goto/DotNetSDKV4/runtime.lex-2016-11-28/PostContent.md "../../../goto/DotNetSDKV4/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for C++](../../../goto/SdkForCpp/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForCpp/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for Go v2](../../../goto/SdkForGoV2/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForGoV2/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for Java V2](../../../goto/SdkForJavaV2/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForJavaV2/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for JavaScript V3](../../../goto/SdkForJavaScriptV3/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForJavaScriptV3/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for Kotlin](../../../goto/SdkForKotlin/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForKotlin/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for PHP V3](../../../goto/SdkForPHPV3/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForPHPV3/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for Python](../../../goto/boto3/runtime.lex-2016-11-28/PostContent.md "../../../goto/boto3/runtime.lex-2016-11-28/PostContent.md")
- [AWS SDK for Ruby V3](../../../goto/SdkForRubyV3/runtime.lex-2016-11-28/PostContent.md "../../../goto/SdkForRubyV3/runtime.lex-2016-11-28/PostContent.md")
