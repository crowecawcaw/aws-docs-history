...
have predefined permissions. For more information, see [Using Service-Linked Roles for Amazon Lex](using-service-linked-roles.md "using-service-linked-roles.md").

If you've already created an Amazon Lex bot using the console, the service-linked role
was created automatically. Skip to [Step 2: Create a Custom Slot Type (AWS CLI)](gs-create-flower-types.md "gs-create-flower-types.md").
