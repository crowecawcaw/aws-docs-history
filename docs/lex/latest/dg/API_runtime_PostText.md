...
**[botAlias](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**

The alias of the Amazon Lex bot.

Required: Yes

**[botName](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**

The name of the Amazon Lex bot.

Required: Yes

**[userId](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**
...
**[activeContexts](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**
...
**[inputText](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**

The text that the user entered (Amazon Lex interprets this text).

When you are using the AWS CLI, you can't pass a URL in the
`--input-text` parameter. Pass the URL using the
`--cli-input-json` parameter instead.
...
**[requestAttributes](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**
...
**[sessionAttributes](#API_runtime_PostText_RequestSyntax "#API_runtime_PostText_RequestSyntax")**
...
**[activeContexts](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[alternativeIntents](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
Type: Array of [PredictedIntent](API_runtime_PredictedIntent.md "API_runtime_PredictedIntent.md") objects

Array Members: Maximum number of 4 items.

**[botVersion](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[dialogState](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[intentName](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**

The current user intent that Amazon Lex is aware of.

Type: String

**[message](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[messageFormat](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[nluIntentConfidence](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
between 0.0 and 1.0. For more information, see [Confidence Scores](confidence-scores.md "confidence-scores.md").
...
**[responseCard](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
Type: [ResponseCard](API_runtime_ResponseCard.md "API_runtime_ResponseCard.md") object

**[sentimentResponse](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
Type: [SentimentResponse](API_runtime_SentimentResponse.md "API_runtime_SentimentResponse.md") object

**[sessionAttributes](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[sessionId](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**

A unique identifier for the session.

Type: String

**[slots](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
**[slotToElicit](#API_runtime_PostText_ResponseSyntax "#API_runtime_PostText_ResponseSyntax")**
...
- [AWS SDK for JavaScript V3](../../../goto/SdkForJavaScriptV3/runtime.lex-2016-11-28/PostText.md "../../../goto/SdkForJavaScriptV3/runtime.lex-2016-11-28/PostText.md")
- [AWS SDK for Kotlin](../../../goto/SdkForKotlin/runtime.lex-2016-11-28/PostText.md "../../../goto/SdkForKotlin/runtime.lex-2016-11-28/PostText.md")
- [AWS SDK for PHP V3](../../../goto/SdkForPHPV3/runtime.lex-2016-11-28/PostText.md "../../../goto/SdkForPHPV3/runtime.lex-2016-11-28/PostText.md")
- [AWS SDK for Python](../../../goto/boto3/runtime.lex-2016-11-28/PostText.md "../../../goto/boto3/runtime.lex-2016-11-28/PostText.md")
- [AWS SDK for Ruby V3](../../../goto/SdkForRubyV3/runtime.lex-2016-11-28/PostText.md "../../../goto/SdkForRubyV3/runtime.lex-2016-11-28/PostText.md")
