...
1. In the AWS CLI, create an audio file using Amazon Polly. The example is
...
2. To send the audio file to Amazon Lex, run the following command. Amazon Lex
   saves the audio from the response in the specified output file.
...
Amazon Lex responds with a request for the first slot. It saves the audio
response in the specified output file.
...
4. To set the delivery date, create the following audio file and send it
   to Amazon Lex:
...
5. To set the delivery time, create the following audio file and send it
   to Amazon Lex:
...
6. To confirm the delivery, create the following audio file and send it
   to Amazon Lex:
...
After you confirm the delivery, Amazon Lex sends a response that confirms
