...
services. For this tutorial, it provides access to Amazon Lex.
...
that grant access to Amazon Lex.
...
10. In the **Get AWS Credentials** section, find and record the
    **Identity pool ID**.
11. To allow access to Amazon Lex, modify the authenticated and unauthenticated IAM
    roles.
