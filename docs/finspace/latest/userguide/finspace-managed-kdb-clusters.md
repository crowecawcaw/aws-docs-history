...
<a name="finspace-managed-kdb-clusters"></a>
...
** **Topics** **
+ [Running a clusters on scaling groups vs as a dedicated cluster](kdb-clusters-running-clusters-comparison.md)
+ [Cluster types](kdb-cluster-types.md)
+ [Managing kdb clusters](managing-kdb-clusters.md)
+ [Using Managed kdb Insights clusters](using-kdb-clusters.md)