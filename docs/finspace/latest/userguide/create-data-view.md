...
1. Choose **Create Data View**.

1. On the **Create a New View ** page, choose a **View Type**. To know more about the view types, see [Data view concepts](data-view-concepts.md).

1. For **Access Through**, choose one of the following options: 
...
1. Select partitioning for the data view under **Partition Data**.
...
1. Choose **Create Data View** to start the view creation process. 
