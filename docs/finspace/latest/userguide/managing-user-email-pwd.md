...
<a name="managing-user-email-pwd"></a>
...
<a name="creating-the-first-superuser"></a>
...
<a name="creating-accounts-and-inviting-users-to-access-amazon-finspace"></a>
...
## Deactivating a user
<a name="deactivating-an-amazon-finspace-user"></a>
