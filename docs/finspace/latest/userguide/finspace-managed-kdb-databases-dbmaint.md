...
<a name="finspace-managed-kdb-databases-dbmaint"></a>
...
**Topics**
+ [Setting up for database maintenance](dbmaint-writable-database-dataviews.md)
+ [Performing database maintenance](dbmaint-long-running-dbmaint.md)