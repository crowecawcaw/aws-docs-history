...
<a name="finspace-data-connector"></a>
...
** **Topics** **
+ [Tutorial: Creating a connector for Goldman Sachs Financial Cloud for Data](tutorial-creating-connector-gsm.md)
+ [Connector details](connector-summary.md)
+ [Using external datasets in Amazon FinSpace](dc-external-dataset.md)