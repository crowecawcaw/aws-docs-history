...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------- |
| [AWSFinSpaceServiceRolePolicy](#security-iam-awsmanpol-AWSFinSpaceServiceRolePolicy "#security-iam-awsmanpol-AWSFinSpaceServiceRolePolicy") –<br>Updated policy | Updated the `AWSServiceRoleForFinSpace` policy to allow<br>PutMetricData calls to AWS/Usage CloudWatch namespace. | November 17, 2023 |
| [AWSFinSpaceServiceRolePolicy](#security-iam-awsmanpol-AWSFinSpaceServiceRolePolicy "#security-iam-awsmanpol-AWSFinSpaceServiceRolePolicy") –<br>New policy     | FinSpace added a new policy to enable access to AWS service and resources used or managed by Amazon FinSpace.     | June 5, 2023      |
