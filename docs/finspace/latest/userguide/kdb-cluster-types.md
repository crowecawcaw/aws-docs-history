...
### Savedown storage
<a name="kdb-cluster-savedown-storage"></a>
...
### Cache configuration
<a name="kdb-cluster-cache-config"></a>
...
### Auto scaling
<a name="kdb-cluster-hdb-autoscaling"></a>
...
<a name="cluster-type-capabilities"></a>
