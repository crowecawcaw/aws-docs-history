...
1. From the notebook menu bar, choose the plus (\+) icon to create a new cell. In the cell, run the `curl` command in the shell to test connectivity to the host.
...
<a name="vpc-validation-config-internet"></a>
