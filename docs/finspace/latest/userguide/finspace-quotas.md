...
You can contact AWS Support to request a [quota](https://docs.aws.amazon.com/general/latest/gr/aws_service_quotas.html) increase for the service quotas listed in the AWS General Reference.
...
1. For **Increase quota value**, enter the new quota value.
