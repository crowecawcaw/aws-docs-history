...
<a name="managing-user-permissions"></a>
...
<a name="supported-dataset-permissions"></a>
...
<a name="creating-a-user-group-and-adding-a-user-to-the-group"></a>
