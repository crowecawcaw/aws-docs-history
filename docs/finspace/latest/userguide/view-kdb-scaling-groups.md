...
4. On the environment details page, choose **Kdb scaling groups**
   tab.
5. From the list of scaling groups, choose a name to view its details. The Kdb scaling group
   ...
   - **Configuration** tab – Displays the
     availability zone for the scaling group.
   - **Monitoring** tab – Displays the dashboard
     of scaling group metrics. You can view activity logs for your scaling group here.
   - **Clusters** tab – Displays a list of
     clusters running on this scaling group. For information on how to create clusters,
     see [Creating a Managed kdb Insights cluster](create-kdb-clusters.md "create-kdb-clusters.md").
   - **Tags** tab – Displays a list of key-value
     pairs that are associated with the scaling group. If you did not provide tags during volume
