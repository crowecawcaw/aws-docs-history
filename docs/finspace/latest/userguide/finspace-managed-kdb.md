...
** **Topics** **
+ [Permissions required for Managed kdb](permissions-managed-kdb.md)
+ [Managed kdb Insights environments](finspace-managed-kdb-environment.md)
+ [Managed kdb Insights databases](finspace-managed-kdb-db.md)
+ [Managed kdb scaling groups](finspace-managed-kdb-scaling-groups.md)
+ [Managed kdb volumes](finspace-managed-kdb-volumes.md)
+ [Managed kdb Insights clusters](finspace-managed-kdb-clusters.md)
+ [Logging and monitoring](kdb-cluster-logging-monitoring.md)