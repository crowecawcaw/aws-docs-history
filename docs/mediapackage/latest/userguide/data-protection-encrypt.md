...
For information about using DRM with MediaPackage, see [Content encryption and DRM in AWS Elemental MediaPackage](using-encryption.md "using-encryption.md").
