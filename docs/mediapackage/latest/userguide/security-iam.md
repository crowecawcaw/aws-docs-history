...
- [Resource-based policy examples](using-iam-policies.md "using-iam-policies.md")
- [AWS managed policies for AWS Elemental MediaPackage](security-iam-awsmanpol.md "security-iam-awsmanpol.md")
- [Authenticating Requests (AWS Signature Version 4)](sig-v4-authenticating-requests.md "sig-v4-authenticating-requests.md")
