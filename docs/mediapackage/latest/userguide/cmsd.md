...
## Common CMSD keys
<a name="cmsd-common"></a>

The following table describes common CMSD keys that MediaPackage uses. For a full of list of keys, see the Consumer Technology Association's [Common Media Server Data CTA-5006 specification](https://shop.cta.tech/products/web-application-video-ecosystem-common-media-server-data-cta-5006). 
