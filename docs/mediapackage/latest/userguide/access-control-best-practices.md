...
<a name="access-control-best-practices"></a>
...
**Topics**
+ [Creating new resources](#access-control-best-practices-new-resources)
+ [Sharing resources](#access-control-best-practices-groups)
+ [Protecting data](#access-control-best-practices-groups)

## Creating new resources
<a name="access-control-best-practices-new-resources"></a>
...
For more information, see [Identity and Access Management for AWS Elemental MediaPackage](security-iam.md).
...
For more information, see [Resource-based policy examples](using-iam-policies.md).
...
## Sharing resources
<a name="access-control-best-practices-groups"></a>
...
For more information, see [Identity-based policy examples for MediaPackage](security_iam_id-based-policy-examples.md).
