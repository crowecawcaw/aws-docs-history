...
![This illustration shows how content that's stored in MediaPackage is distributed using a CDN.](https://docs.aws.amazon.com/mediapackage/latest/userguide/images/cf_flow.png)
