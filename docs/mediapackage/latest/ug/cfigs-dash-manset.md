...
1. (Optional) For **Manifest name**, enter a short
   ...
   helps to create a unique path to this endpoint. If you don't enter a
   value, the default manifest name is _index_.
2. (Optional) For **Min buffer time**, enter the minimum
...
3. (Optional) For **Profile**, specify a DASH
   profile.

Choose from the following:

    * **None** – the output doesn't use a
     DASH profile
