...
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HLS                     | Extract a portion of a live HLS or DASH endpoint in MediaPackage<br>and save it as a live-to-VOD asset.<br>Additional requirements:<br>• The endpoint must have a defined startover window,<br>which determines the maximum length of the live-to-VOD asset that can be harvested.<br>• Streams can contain either muxed video and audio<br>tracks, or unmuxed tracks.<br>• The input must contain at least one video track.<br>MediaPackage doesn't support inputs that contain no<br>video track. |
...
saving a live-to-VOD asset to an Amazon S3 bucket. The endpoint must serve either clear (unencrypted)
or encrypted DASH or HLS content.
