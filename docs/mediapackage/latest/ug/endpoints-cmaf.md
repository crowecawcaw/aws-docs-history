...
3. Complete the fields as described in the following topics:
   ...
   - [Access control settings fields](endpoints-cmaf-access-control.md "endpoints-cmaf-access-control.md")
   - [Stream selection fields](endpoints-cmaf-include-streams.md "endpoints-cmaf-include-streams.md")
