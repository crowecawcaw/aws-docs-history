...
Preview an endpoint's playback to ensure that AWS Elemental MediaPackage is receiving the content stream
...
2. On the details page for the channel, under **Origin
   endpoints**, select the origin endpoint that you want to preview.
3. To preview playback, do one of the following:
   - Choose **Preview** to play content with the embedded
     player.
   - Choose **QR code** to view and scan the QR code for
