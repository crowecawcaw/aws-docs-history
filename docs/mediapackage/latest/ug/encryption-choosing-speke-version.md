...
| CMAF Apple HLS | Not supported | √<br />Has key rotation<br />Supports only cbcs encryption | √<br />Has key rotation<br />Supports only cbcs encryption | Not supported | 
...
| CMAF Apple HLS | Not supported | √<br />Supports only cbcs encryption | √<br />Supports only cbcs encryption | Not supported | 
...
| Live | 
| CMAF Apple HLS | √<br />Supports cbcs and cenc encryption | √<br />Supports cbcs and cenc encryption | √<br />Supports cbcs encryption | Not supported | 
| DASH | √ | √ | Not supported | √ | 
| VOD | 
| CMAF Apple HLS | √<br />Supports only cbcs encryption | √<br />Supports only cbcs encryption | √<br />Supports only cbcs encryption | Not supported | 
| DASH | √ | √ | Not supported | √ | 