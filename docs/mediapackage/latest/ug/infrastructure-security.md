...
As a managed service, AWS Elemental MediaPackage is protected by AWS global network security. For
...
You use AWS published API calls to access MediaPackage through the network. Clients must
