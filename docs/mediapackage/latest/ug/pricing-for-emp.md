...
MediaPackage. You are charged only for AWS resources that your account uses. Pricing is
...
Content that's cached and served from a content delivery network (CDN)
doesn't incur this per GB charge.
