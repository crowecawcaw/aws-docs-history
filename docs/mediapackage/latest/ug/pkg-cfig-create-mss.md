...
6. Complete the fields as described in the following topics:
   ...
   - [Encryption fields](cfigs-mss-encryption.md "cfigs-mss-encryption.md")
...
7. Choose **Save**.
 ...
 requests, please try again. Resource limit exceeded`**, either you have
   exceeded the API request quota, or you have already reached the maximum number of
   packaging groups allowed on your account. If this is your first group, or if you
   think you mistakenly received this error, use the Service Quotas console to [request quota increases](https://console.aws.amazon.com/servicequotas/home?region=us-east-1#!/services/mediapackage/quotas "https://console.aws.amazon.com/servicequotas/home?region=us-east-1#!/services/mediapackage/quotas"). For more information about quotas in
   MediaPackage, see [Quotas in AWS Elemental MediaPackage](quotas.md "quotas.md").
