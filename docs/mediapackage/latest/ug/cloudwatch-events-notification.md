...
You can use Amazon CloudWatch Events and Amazon Simple Notification Service (Amazon SNS) to notify you of new events. In CloudWatch Events, the rule
...
- [Getting started with Amazon CloudWatch Events](../../../AmazonCloudWatch/latest/events/CWE_GettingStarted.md "../../../AmazonCloudWatch/latest/events/CWE_GettingStarted.md")
...
2. Subscribe to the topic that you just created. Choose what kind of notification you want
   ...
   for the endpoint.
3. Access [CloudWatch Events](https://console.aws.amazon.com/cloudwatch "https://console.aws.amazon.com/cloudwatch") and create a rule that
...
the event. You can use the following values for detail-type:
...
4. Add a target to the rule that you just created. Choose **SNS topic**,
   and then choose the topic that you created in step 1.
5. Configure the details of the rule, and give it a descriptive name. To start using the
