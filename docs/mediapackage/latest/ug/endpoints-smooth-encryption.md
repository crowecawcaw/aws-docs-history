...
To encrypt content, you must have a DRM solution provider and be set up to
use encryption. For information, see [Content encryption and DRM in AWS Elemental MediaPackage](using-encryption.md "using-encryption.md").
