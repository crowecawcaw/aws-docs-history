...
1. To serve content with copyright protection, choose **Encrypt content** and complete the additional fields as follows:
   ...
   1. For **System ID**, enter unique identifiers for your streaming protocol and DRM system. Provide up to one system ID. If you do not know your ID, ask your DRM solution provider.
