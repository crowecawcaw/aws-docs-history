...
MediaPackage has the following resource
ARNs:
...
For example, to specify the `9a6b3953e242400eb805f324d95788e3` channel
...
Some MediaPackage actions, such as those for creating resources, can't be
