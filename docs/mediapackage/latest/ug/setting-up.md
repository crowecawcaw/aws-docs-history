...
Before you start using AWS Elemental MediaPackage (MediaPackage), you must sign up for AWS (if you don’t already have an
AWS account) and create IAM users and roles to allow access to MediaPackage. This
includes creating an IAM role for yourself. If you want to use encryption to protect your
content, you also must store your encryption keys in AWS Secrets Manager, and then give MediaPackage
...
MediaPackage. For background and additional information about identity and access
management for MediaPackage, see [Identity and Access Management for AWS Elemental MediaPackage](security-iam.md "security-iam.md").
