...
2. Navigate to the appropriate page to view metrics:
   ...
   - For metrics on a specific channel and all of its endpoints, go to the channel's details
     page.
   - For metrics on a specific endpoint and its channel, go to the endpoint's details
     page.
...
- [AWS Elemental MediaPackage live content metrics](metrics.md "metrics.md")
- [AWS Elemental MediaPackage VOD content metrics](metrics-vod.md "metrics-vod.md")
