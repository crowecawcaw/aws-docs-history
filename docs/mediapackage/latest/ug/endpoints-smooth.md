...
3. Complete the fields as described in the following topics:
   ...
   - [Access control settings fields](endpoints-smooth-access-control.md "endpoints-smooth-access-control.md")
   - [Stream selection fields](endpoints-smooth-include-streams.md "endpoints-smooth-include-streams.md")

4. Choose **Save**.

If you enabled Amazon CloudFront distribution creation from the AWS Elemental MediaPackage
console and this is your first endpoint on the channel, MediaPackage adds
an origin to the distribution. You can view the CloudFront CDN URL and endpoint
information in the endpoints section of the channel's details page.
