...
- [IAM policy examples for secrets in
  AWS Secrets Manager](iam-policy-examples-asm-secrets.md "iam-policy-examples-asm-secrets.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting MediaPackage identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
