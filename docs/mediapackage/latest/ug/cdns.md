...
![This illustration shows how content that's stored in AWS Elemental MediaPackage is distributed using a CDN.](https://docs.aws.amazon.com/mediapackage/latest/ug/images/cf_flow.png)
