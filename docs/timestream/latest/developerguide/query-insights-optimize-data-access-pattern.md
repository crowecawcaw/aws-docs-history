...
- [Timestream partitioning scheme](#query-insights-optimize-data-access-partitioning-scheme "#query-insights-optimize-data-access-partitioning-scheme")
- [Data organization](#query-insights-optimize-data-access-data-org "#query-insights-optimize-data-access-data-org")
...
![Timestream partitioning scheme](images/QueryInsights/ts-partitioning-scheme.png)
...
![Result provided by the QuerySpatialCoverage metric that shows poor spatial pruning.](images/QueryInsights/QuerySpatialCoverageMetricResult.png)
...
![Result provided by the QueryTemporalCoverage metric that shows poor temporal pruning.](images/QueryInsights/QueryTemporalCoverageMetricResult.png)
