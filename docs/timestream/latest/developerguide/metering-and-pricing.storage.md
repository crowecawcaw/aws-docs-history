...
(see [Calculating the write size of a time series event](metering-and-pricing.writes.md#metering-and-pricing.writes.write-size-one-event "metering-and-pricing.writes.md#metering-and-pricing.writes.write-size-one-event")),
