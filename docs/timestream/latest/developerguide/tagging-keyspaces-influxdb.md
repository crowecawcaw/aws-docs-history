...
You can label Amazon Timestream for InfluxDB resources using _tags_. Tags let you categorize
...
- See AWS bills broken down by tags.
  Tagging is supported by AWS services like Amazon Elastic Compute Cloud (Amazon EC2), Amazon Simple Storage Service (Amazon S3), Timestream for InfluxDB, and
