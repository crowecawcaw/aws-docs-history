...
Ensure that you have met the following prerequisites before using the Timestream for LiveAnalytics
JDBC single sign-on authentication with Okta:

- [Admin permissions in AWS to create the
