...
As a managed service, Amazon Timestream Live Analytics is protected by the AWS global network security
...
You use AWS published API calls to access Timestream Live Analytics through the network. Clients must
