...
- [Querying energy consumption for the last 24 hours](#query-energy-consumption-data "#query-energy-consumption-data")
- [Optimizing the query for temporal range](#optimize-query-temporal-range "#optimize-query-temporal-range")
- [Optimizing the query for spatial coverage](#optimize-query-spatial-coverage "#optimize-query-spatial-coverage")
- [Improved query performance](#improved-query-performance "#improved-query-performance")
