...
- [Preparing a batch load data file](batch-load-preparing-data-file.md "batch-load-preparing-data-file.md")
- [Data model mappings for batch load](batch-load-data-model-mappings.md "batch-load-data-model-mappings.md")
