...
+ **Secure and Cost effective** – `UNLOAD` statement provides the capability to export your data to an S3 bucket in a compressed manner and to encrypt (SSE-KMS or SSE\_S3) your data using customer managed keys, reducing the data storage costs and protecting against unauthorized access.
