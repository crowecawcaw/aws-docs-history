...
![Monitored instances sending metrics to Timestream, with users querying for dashboards and alerts.](https://docs.aws.amazon.com/timestream/latest/developerguide/images/schedquery_common_schema_example.png)
