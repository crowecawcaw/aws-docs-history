...
Find EC2 instances and network interfaces related to a security
group
...
Find EC2 instances, network ACLs, network interfaces and route tables
related to a subnet
...
Find EC2 instances, internet gateways, network ACLs, network interfaces,
route tables, subnets and security groups related to a VPC
