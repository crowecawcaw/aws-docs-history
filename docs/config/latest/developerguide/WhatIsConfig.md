...
- **AWS account**: You need an active AWS account. For more information, see
  [Signing up for AWS](getting-started.md#getting-started-signing-up "getting-started.md#getting-started-signing-up").
- **Amazon S3 Bucket**: You need an S3 bucket to receive data for your configuration snapshots and history.
  For more information, see [Permissions for the Amazon S3 Bucket](s3-bucket-policy.md "s3-bucket-policy.md").
- **Amazon SNS Topic**: You need an Amazon SNS to receive notifications when there are changes to your configuration snapshots and history.
  For more information, see [Permissions for the Amazon SNS Topic](sns-topic-policy.md "sns-topic-policy.md").
- **IAM Role**: You need an IAM role that has the necessary permissions to access AWS Config.
  For more information, see [Permissions for the IAM Role](iamrole-permissions.md "iamrole-permissions.md").
...
that use AWS Config output. For more information, visit the AWS Config detail page at [AWS Config](https://aws.amazon.com/config "https://aws.amazon.com/config").
...
History](view-manage-resource-console.md "view-manage-resource-console.md") and [Managing AWS Resource Configurations and
History](aws-config-landing-page.md "aws-config-landing-page.md").
...
Resources with AWS Config Rules](evaluate-config.md "evaluate-config.md") and [Conformance Packs](conformance-packs.md "conformance-packs.md").

**Remediation**

- Remediate noncompliant resources that are evaluated by AWS Config Rules.

For more information, see [Remediation](remediation.md "remediation.md").
...
Multi-Region Data Aggregation](aggregate-data.md "aggregate-data.md").
...
For more information, see [Querying the Current Configuration State of AWS Resources](querying-AWS-resources.md "querying-AWS-resources.md") .
