...
Checks if Amazon CloudWatch Evidently projects have tags. Optionally, you can specify tag keys. The rule is NON\_COMPLIANT if there are no tags or if the specified tag keys are not present. The rule does not check for tags starting with 'aws:'. 



**Identifier:** EVIDENTLY\_PROJECT\_TAGGED
...
<a name="w2aac20c16c17b7d829c19"></a>
