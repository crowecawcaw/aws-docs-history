...
As a managed service, AWS Config is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Config through the network. Clients must
