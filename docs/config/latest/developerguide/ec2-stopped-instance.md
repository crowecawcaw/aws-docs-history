...
**AWS Region:** All supported AWS regions except Africa (Cape Town), Middle East (UAE), AWS Secret - West, Asia Pacific (Osaka), Asia Pacific (Melbourne), Europe (Milan), Canada West (Calgary) Region
