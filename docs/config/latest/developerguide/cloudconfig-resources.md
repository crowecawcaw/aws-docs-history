...
| Third-party libraries | Developers in the AWS developer community also provide their own libraries, which you can find at the following AWS developer centers:+   [AWS Java Developer Center](https://aws.amazon.com/java/)  <br />+   [AWS JavaScript Developer Center](https://aws.amazon.com/javascript/)  <br />+   [AWS PHP Developer Center](https://aws.amazon.com/php/)  <br />+   [AWS Python Developer Center](https://aws.amazon.com/python/)  <br />+   [AWS Ruby Developer Center](https://aws.amazon.com/ruby/)  <br />+   [AWS Windows and .NET Developer Center](https://aws.amazon.com/net/)   | 