...
**Topics**
+ [Considerations](#dc-considerations)
+ [Terminology](#dc-terminology)
+ [Components of a Configuration Item](config-item-table.md)
+ [Viewing the Delivery Channel](dc-view.md)
+ [Updating the Delivery Channel](update-dc-console.md)
+ [Renaming the Delivery Channel](update-dc-rename.md)
+ [Delivering Configuration Snapshots](deliver-snapshot-cli.md)
+ [Verifying Delivery Status](verify-delivery-status.md)
+ [Viewing Configuration Snapshots](view-configuration-snapshot.md)
+ [Example Configuration Snapshot](example-s3-snapshot.md)
+ [Example Notifications](notifications-for-AWS-Config.md)
...
AWS Config does not support the delivery channel to an Amazon S3 bucket where object lock is enabled with default retention enabled. For more information, see [How S3 Object Lock works](https://docs.aws.amazon.com/AmazonS3/latest/userguide/object-lock-overview.html).
