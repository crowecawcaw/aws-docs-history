...
![The image on the AWS Config Console page provides an overview of the AWS Config service, emphasizing its role in recording and evaluating the configuration chages of AWS resources.](images/welcome.png) 3. Choose **1-click setup** to launch AWS Config based on AWS best practices.
