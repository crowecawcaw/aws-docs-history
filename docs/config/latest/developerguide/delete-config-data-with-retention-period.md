...
<a name="delete-config-data-with-retention-period"></a>
...
| 365 days | December 12, 2017; November 12, 2017, and March 10, 2017 | The retention period shows the current state December 12, 2017 and previous `ConfigurationItems` November 12, 2017 and March 10, 2017. <br />The `ConfigurationItem` for March 10, 2017 is displayed on the timeline because that configuration state represented the current state 365 days ago.  | 
...
<a name="delete-config-data-with-retention-period-console"></a>
