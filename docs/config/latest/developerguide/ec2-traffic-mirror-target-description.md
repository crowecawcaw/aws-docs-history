...
Checks if Amazon EC2 traffic mirror targets have a description. The rule is NON\_COMPLIANT if configuration.Description does not exist.

**Identifier:** EC2\_TRAFFIC\_MIRROR\_TARGET\_DESCRIPTION
