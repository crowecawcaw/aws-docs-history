...
\*For more information on valid values for these inputs, see [MonitoringInterval](../../../AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbinstance.md#cfn-rds-dbinstance-monitoringinterval "../../../AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbinstance.md#cfn-rds-dbinstance-monitoringinterval") and [Engine](../../../AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbinstance.md#cfn-rds-dbinstance-engine "../../../AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbinstance.md#cfn-rds-dbinstance-engine") in the AWS CloudFormation User Guide.
