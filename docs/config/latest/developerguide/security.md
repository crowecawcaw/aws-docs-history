...
- **Security of the cloud** – AWS is
  ...
  programs that apply to AWS Config, see [AWS services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using AWS Config. The following topics show you how to configure AWS Config to meet your security and
  compliance objectives.

###### Topics

- [Data Protection in AWS Config](data-protection.md "data-protection.md")
- [Identity and Access Management for AWS Config](security-iam.md "security-iam.md")
- [Incident Response in AWS Config](incident-response.md "incident-response.md")
