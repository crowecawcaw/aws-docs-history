...
<a name="additional-resources"></a>
 ...
 For more information about AWS Lake Formation, we recommend that you continue to learn more about the concepts introduced in this guide by using the following resources: 

**Topics**
+ [Blogs](#lf-blogs)
+ [Tech talks and webinars](#talks-webinars)
+ [Modern day architecture](#modern-day-architecture)
+ [Data mesh resources](#data-mesh-resources)
+ [Best practices guides](#best-practice-lf)
