...
**Topics**
+ [Lake Formation permissions management workflow](#lf-workflow)
+ [Metadata permissions](metadata-permissions.md)
+ [Storage access management](storage-permissions.md)
+ [Cross-account data sharing in Lake Formation](cross-data-sharing-lf.md)