...
![The enable S3 table integration option on the catalogs page.](https://docs.aws.amazon.com/lake-formation/latest/dg/images/enable-s3-table-integration.png)
...
![The enable S3 integration screen with IAM role.](https://docs.aws.amazon.com/lake-formation/latest/dg/images/enable-s3-table-catalog.png)
...
![The S3 Table Catalog](https://docs.aws.amazon.com/lake-formation/latest/dg/images/s3-table-catalog.png)
