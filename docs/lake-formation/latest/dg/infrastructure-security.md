...
As a managed service, AWS Lake Formation is protected by the AWS global network security
...
You use AWS published API calls to access Lake Formation through the network. Clients must
