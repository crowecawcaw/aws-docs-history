...
performance of AWS Resource Explorer and your other AWS solutions. AWS provides the following
monitoring tools to watch Resource Explorer, report when something is wrong, and take automatic
...
- _AWS CloudTrail_ captures API calls and related events made by or on
  ...
  information, see [Logging AWS Resource Explorer API calls using AWS CloudTrail](monitoring-cloudtrail.md "monitoring-cloudtrail.md") and the [AWS CloudTrail User Guide](../../../awscloudtrail/latest/userguide.md "../../../awscloudtrail/latest/userguide.md").
