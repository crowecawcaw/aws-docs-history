...
**Topics**
+ [Configuring a Resource Explorer view to provide access to resource searches](#configure-views)
+ [Creating Resource Explorer views to use for search](configure-views-create.md)
+ [Granting access to Resource Explorer views for search](configure-views-grant-access.md)
+ [Setting a default view in an AWS Region](configure-views-set-default.md)
+ [Adding tags to views](configure-views-tag.md)
+ [Sharing Resource Explorer views](configure-views-share.md)
+ [Deleting views in Resource Explorer](configure-views-delete.md)