...
By default, users and roles don't have permission to create or modify Verified Access resources. To grant users permission to perform actions on the resources that they need, an IAM administrator can create IAM policies.
...
+ [Policy for creating Verified Access instances](#security_iam_id-based-policy-examples-create-instance)
...
<a name="security_iam_id-based-policy-examples-create-instance"></a>
