...
- **Security in the cloud** – Your responsibility is
  ...
  using Verified Access. The following topics show you how to configure Verified Access to meet your security and
  compliance objectives. You also learn how to use other AWS services that help you to monitor
  and secure your Verified Access resources.

###### Contents

- [Data protection in Verified Access](data-protection.md "data-protection.md")
- [Identity and access management for Verified Access](security-iam.md "security-iam.md")
- [Compliance validation for Verified Access](compliance-validation.md "compliance-validation.md")
- [Resilience in Verified Access](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
