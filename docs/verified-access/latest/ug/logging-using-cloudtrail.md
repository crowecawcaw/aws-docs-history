...
Verified Access logs control plan operations as management events. For a list, see the [Amazon EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/operation-list-verified-access.html).
