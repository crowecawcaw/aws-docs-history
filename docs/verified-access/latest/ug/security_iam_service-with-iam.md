...
To get a high-level view of how Verified Access and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of Verified Access identity-based policies, see [Identity-based policy examples for Verified Access](security_iam_id-based-policy-examples.md).
...
To see a list of Verified Access actions, see [Actions Defined by Amazon EC2](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonec2.html#amazonec2-actions-as-permissions) in the *Service Authorization Reference*.
...
For details about creating or managing Verified Access service-linked roles, see [Use service-linked roles for Verified Access](using-service-linked-roles.md).