...
To view examples of Verified Access identity-based policies, see [Identity-based policy examples for Verified Access](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
