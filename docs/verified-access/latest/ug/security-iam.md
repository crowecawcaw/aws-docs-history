...
+ [How Verified Access works with IAM](security_iam_service-with-iam.md)
+ [Identity-based policy examples for Verified Access](security_iam_id-based-policy-examples.md)
+ [Troubleshooting Verified Access identity and access](security_iam_troubleshoot.md)
+ [Use service-linked roles for Verified Access](using-service-linked-roles.md)
+ [AWS managed policies for Verified Access](security-iam-awsmanpol.md)
