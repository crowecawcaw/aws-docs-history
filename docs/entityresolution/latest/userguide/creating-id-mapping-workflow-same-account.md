...
Before you create an ID mapping workflow on your own AWS account, you must first
complete the [prerequisites](id-mapping-workflow-prerequisite.md "id-mapping-workflow-prerequisite.md").

After you create and run an ID mapping workflow, you can view the output (the ID mapping
table) and use it for analysis.

The following topics guide you through a set of steps to create an ID mapping workflow in
