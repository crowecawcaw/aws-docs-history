...
7. For **Rule parameters**, do the following.
   ...
   **Rule controls** must be compatible between the source and the
   ...
   this results in an error. 2. For **Matching rules**, AWS Entity Resolution automatically adds the rules from
...
11. Choose **Create ID namespace**.
    ...
    target) required for an ID mapping workflow, you're ready to [create an
