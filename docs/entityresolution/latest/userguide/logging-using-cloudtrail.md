...
All AWS Entity Resolution actions are logged by CloudTrail and are documented in the [AWS Entity Resolution API Reference](https://docs.aws.amazon.com/entityresolution/latest/apireference/Welcome.html). 
