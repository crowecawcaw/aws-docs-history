...
To view examples of AWS Entity Resolution identity-based policies, see [Identity-based policy examples for AWS Entity Resolution](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
