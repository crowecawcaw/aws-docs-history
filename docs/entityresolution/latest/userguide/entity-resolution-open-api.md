...
<a name="entity-resolution-open-api"></a>
...
+ [Synchronous processing integration](#entity-resolution-synchronous-processing)

## Batch processing integration
<a name="batch-processing-integration"></a>
...
1. `POST StartJob`: This API lets the provider know to start the job based on the `JobId` provided. This allows the provider to perform any validations needed from `CreateJob` until `StartJob`.
...
1. `GET GetJob`: This API informs AWS Entity Resolution if the job has been completed or any other status.
...
<a name="entity-resolution-synchronous-processing"></a>
