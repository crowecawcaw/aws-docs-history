...
encounter when working with AWS Entity Resolution and IAM.

###### Topics

- [I am not authorized to
  perform an action in AWS Entity Resolution](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS Entity Resolution resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS Entity Resolution
...
have the fictional `entityresolution:`GetWidget``
permissions.
...
`entityresolution:`GetWidget`` action.
...
AWS Entity Resolution. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AWS Entity Resolution resources
...
- To learn whether AWS Entity Resolution supports these features, see [How AWS Entity Resolution works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
