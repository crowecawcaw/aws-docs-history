...
- [Identity-based policy examples for
  AWS Entity Resolution](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md")
- [AWS managed policies for AWS Entity Resolution](security-iam-awsmanpol.md "security-iam-awsmanpol.md")
- [Troubleshooting AWS Entity Resolution identity and
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS Entity Resolution identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
