...
1. In the main navigation pane, choose **Manage security and sign-in**.
...
1. Open your authenticator app. For a list of apps, see [Authenticator applications](#authenticator-applications).
...
1. On the **Security** page, select the MFA device that you want to change and choose **Delete**.
