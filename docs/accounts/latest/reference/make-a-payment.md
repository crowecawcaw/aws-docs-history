...
1. Under **Action**, you'll see **Pay invoice** for any outstanding invoice. If there are no invoices listed, you don't need to do anything.

1. Choose **Pay invoice**.
