...
<a name="request-your-builder-id-data"></a>
...
For more information about exercising your data subject rights, including for personal information provided in relation to other AWS websites, applications, products, services, events, and experiences, see [AWS Privacy](https://aws.amazon.com/privacy).
...
1. Choose **Manage profile**.

   You'll be redirected to your AWS Builder ID profile.

1. Choose **Privacy & data**.

1. Choose to request your Builder ID data or your AWS data.
