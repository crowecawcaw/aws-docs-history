...
<a name="supported-services-sign-up-new"></a>

**Warning**  
We're currently releasing our new experience to a limited number of customers. You might not be able to access this experience yet.

When you use Sign up for AWS (new), you get access to the Free Tier. Free Tier provides access to select AWS services. You can upgrade your account to a Paid Plan to access additional AWS services and features. To learn how to upgrade your account, see [Upgrade your account in AWS Settings](upgrade-account.md).

Not every AWS service is available for Sign up for AWS (new). If a service is not listed in either of the following lists or has an unsupported feature, you must create an account by using [Sign up for AWS (advanced)](getting-started.md) or [Activate advanced AWS features](activate-advanced-features.md).

## AWS services included in the Free Tier of our new AWS experience
<a name="supported-services-free-tier"></a>
...
+ Amazon Polly
+ Amazon Quick
  + Only Amazon Quick Free or Quick Plus are supported. For more information, see [Amazon Quick pricing](https://aws.amazon.com/quick/pricing/).
+ Amazon Rekognition
  + Not supported in Europe (Stockholm).
...
+ AWS User Notifications
  + User-configured notifications and Managed notifications configuration operations are not supported. For more information, see [What is AWS User Notifications?](https://docs.aws.amazon.com/notifications/latest/userguide/what-is-service.html)
+ AWS WAF
...
The following services are available for Sign up for AWS (new) if you have a Paid Plan. For more information, see [Upgrade your account in AWS Settings](upgrade-account.md).
+ Amazon DevOps Guru
...
The following AWS services are not supported for our new AWS experience, unless you [Activate advanced AWS features](activate-advanced-features.md). These AWS services aren't necessary for new developers or small teams. Some of these services are automatically turned on for your account and managed by AWS. For more information, see [Compare features for sign-up options](sign-up-for-aws.md#compare-sign-up-options).
+ Alexa for Business
+ Alexa Top Sites
