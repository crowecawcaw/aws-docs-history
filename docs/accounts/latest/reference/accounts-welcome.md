...
![This image shows how the resources container, security boundary, and policies determine the level of access that users and roles have to shared resources in your account.](https://docs.aws.amazon.com/accounts/latest/reference/images/container-and-security-boundary.png)
