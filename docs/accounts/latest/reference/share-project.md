...
You can invite a team member to access a project. For information on what team
members can do in a project, see [Invite team members to collaborate in AWS Settings](invite-team-members.md "invite-team-members.md").
...
3. For **Members**, choose **Invite new team
   member**.
