...
Additional steps are required to opt out for Amazon Monitron. For more information, see [AWS Service Terms](https://aws.amazon.com/service-terms/). Only the project owner can opt out of data use by AWS AI services.
...
1. For **Overview**, choose **Actions**, and then choose **Opt out of data use by AWS AI services**.

1. Confirm your choice and choose **Opt out**.