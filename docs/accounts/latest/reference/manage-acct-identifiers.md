...
1. Under the **Account details** section, the account number appears next to **AWS account ID**.
...
1. At the top of the page, under **Account details**, the account number appears next to **AWS account ID**.
...
1. Under the **Account details** section, the canonical user ID appears next to **Canonical user ID**. You can use your canonical user ID to configure Amazon S3 access control lists (ACLs). 
...
1. In the Amazon S3 console, choose a bucket name to view details about a bucket.

1. Choose the **Permissions** tab.

1. In the **Access control list** section, under **Bucket owner**, the canonical ID for your AWS account appears.
