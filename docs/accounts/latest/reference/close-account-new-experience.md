...
<a name="close-account-new-experience"></a>
...
<a name="delete-social-login-before"></a>

Before closing your management account, you should consider the following:
+ When you close a project, consider the considerations in [What you need to know before closing your project](close-project.md#close-project-before).
...
+ You can't use the same email address that was registered to your organization at the time of its closure as the primary email of another organization. If you want to use the same email address for a different organization while using Sign up for AWS (new), we recommend updating it before closure. For more information, see [Change your email address in AWS Settings](change-email.md).
...
## Close a project
<a name="delete-social-login-close-projects"></a>

To close your projects, see [Close a project in AWS Settings](close-project.md).

## Close your management account
<a name="delete-social-login-close-org"></a>
...
1. For **Actions**, choose **Close management account**.

1. Confirm your choice and choose **Close management account**.

## Delete your AWS Builder ID
<a name="delete-social-login-delete-builder-id"></a>
...
1. In the main navigation pane, choose **Manage profile**.

1. For **Profile info**, choose **Manage profile**.

   You'll be redirected to your AWS Builder ID profile.

1. In the main navigation pane, choose **Privacy & data**.

1. For **Deleting AWS Builder ID**, choose **Delete your AWS Builder ID**.
