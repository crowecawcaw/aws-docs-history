...
Before you use IAM to manage access to AWS Sustainability, learn what IAM features are
available to use with AWS Sustainability.
...
To get a high-level view of how AWS Sustainability and other AWS services work with most IAM
...
To view examples of AWS Sustainability identity-based policies, see [Identity-based policy examples for AWS Sustainability](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
To see a list of AWS Sustainability actions, see [Actions Defined by AWS Sustainability](../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions "../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions") in the
...
To see a list of AWS Sustainability resource types and their ARNs, see
[Resources Defined by AWS Sustainability](../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions Defined by AWS Sustainability](../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions "../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions") .
...
To see a list of AWS Sustainability condition keys, see [Condition Keys for AWS Sustainability](../../../IAM/latest/UserGuide/list_list_awssustainability.md#awssustainability-policy-keys "../../../IAM/latest/UserGuide/list_list_awssustainability.md#awssustainability-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions Defined by AWS Sustainability](../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions "../../../IAM/latest/UserGuide/list_awssustainability.md#awssustainability-actions-as-permissions") .
...
Changing the permissions for a service role might break AWS Sustainability functionality.
Edit service roles only when AWS Sustainability provides guidance to do so.
