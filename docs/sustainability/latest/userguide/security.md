...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Sustainability. The following topics show you how to configure AWS Sustainability to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS Sustainability resources.

###### Topics

- [Data protection in AWS Sustainability](data-protection.md "data-protection.md")
- [Identity and access management for AWS Sustainability](security-iam.md "security-iam.md")
- [Compliance validation for AWS Sustainability](compliance-validation.md "compliance-validation.md")
- [Resilience in AWS Sustainability](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure Security in AWS Sustainability](infrastructure-security.md "infrastructure-security.md")
