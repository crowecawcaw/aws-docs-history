...
**Topics**
+ [I am not authorized to perform an action in AWS Sustainability](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to allow people outside of my AWS account to access my AWS Sustainability resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether AWS Sustainability supports these features, see [How AWS Sustainability works with IAM](security_iam_service-with-iam.md).
