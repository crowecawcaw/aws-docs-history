...
If you want to keep data calculated using previous versions of the methodology we recommend creating a [Data Export](../../../cur/latest/userguide/what-is-data-exports.md "../../../cur/latest/userguide/what-is-data-exports.md"), which exports your carbon data to Amazon S3.
When a new version is released it has its own prefix and previous versions remain available.
