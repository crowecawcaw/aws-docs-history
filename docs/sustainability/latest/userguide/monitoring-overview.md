...
performance of AWS Sustainability and your other AWS solutions. AWS provides the following monitoring
tools to watch AWS Sustainability, report when something is wrong, and take automatic actions when
appropriate:
