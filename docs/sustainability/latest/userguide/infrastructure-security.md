...
As a managed service, AWS Sustainability is protected by the AWS global network security
...
You use AWS published API calls to access AWS Sustainability through the network. Clients must
