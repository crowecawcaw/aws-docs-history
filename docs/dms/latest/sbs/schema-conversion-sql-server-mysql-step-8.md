...
5. Change the settings to improve the performance of converted code. For more information, see [Specifying SQL Server to MySQL conversion settings](../userguide/schema-conversion-sql-server-mysql.md "../userguide/schema-conversion-sql-server-mysql.md").
