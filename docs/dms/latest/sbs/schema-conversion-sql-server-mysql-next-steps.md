# Migration from SQL Server databases to Amazon RDS for MySQL with DMS schema conversion next steps
...
- Learn more about Amazon RDS for MySQL. For more information, see the [Amazon Relational Database Service User Guide](../../../AmazonRDS/latest/UserGuide/Welcome.md "../../../AmazonRDS/latest/UserGuide/Welcome.md").
