...
4. Change the settings to customize the schema conversion view. For more information, see [Specifying migration project settings](../userguide/migration-projects-settings.md "../userguide/migration-projects-settings.md").
5. Change the settings to improve the performance of converted code. For more information, see [Specifying SQL Server to PostgreSQL conversion settings](../userguide/schema-conversion-sql-server-postgresql.md "../userguide/schema-conversion-sql-server-postgresql.md").
