...
- The custom scripts that include creating the tables to be migrated and SQL queries for confirming the migration, as listed following:
  ...
  These scripts are available at the following link: [`dms-sbs-RDSOracle2Aurora.zip`](samples/dms-sbs-RDSOracle2Aurora.zip.md "samples/dms-sbs-RDSOracle2Aurora.zip.md").
...
- Knowledge of the supported data type conversion options for Oracle and Amazon Aurora MySQL. For information about data types for Oracle as a source, see [Using an Oracle database as a source](../userguide/CHAP_Source.Oracle.md "../userguide/CHAP_Source.Oracle.md"). For information about data types for Amazon Aurora MySQL as a target, see [Using a MySQL-Compatible database as a target](../userguide/CHAP_Target.MySQL.md "../userguide/CHAP_Target.MySQL.md").
