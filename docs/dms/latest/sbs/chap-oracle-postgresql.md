...
- [Can My Oracle Database Migrate?](chap-oracle-postgresql.md "chap-oracle-postgresql.md")
...
- [The 12 Step Migration Process](#chap-oracle-postgresql.migration-process "#chap-oracle-postgresql.migration-process")
  - [Future State Architecture Design](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Database Schema Conversion](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Application Conversion or Remediation](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Script/ETL/Report Conversion](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Integration with Third-Party Applications](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Data Migration Mechanism](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Testing and Bug Fixing](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Performance Tuning](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Setup, DevOps, Integration, Deployment, and Security](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Documentation and Knowledge Transfer](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Project Management and Version Control](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")
  - [Post-Production Support](chap-oracle-postgresql.migration-process.md "chap-oracle-postgresql.migration-process.md")

- [Automation](#chap-oracle-postgresql.automation "#chap-oracle-postgresql.automation")
- [Platform Differences](chap-oracle-postgresql.md "chap-oracle-postgresql.md")
...
![The 12 Step Migration Process](images/12-step-migration-process.png)
...
This document references the freely available AWS Schema Conversion Tool (AWS SCT) for code conversion and the AWS Database Migration Service for data migration. For more information, see [Installing, verifying, and updating Schema Conversion Tool](../../../SchemaConversionTool/latest/userguide/CHAP_Installing.md "../../../SchemaConversionTool/latest/userguide/CHAP_Installing.md") and [Database Migration Service](https://aws.amazon.com/dms/ "https://aws.amazon.com/dms/").
