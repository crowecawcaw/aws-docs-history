...
- [Launch an Amazon EC2 instance for MongoDB migration](chap-mongodb2documentdb.01.md "chap-mongodb2documentdb.01.md")
- [Install and configure MongoDB community edition](chap-mongodb2documentdb.02.md "chap-mongodb2documentdb.02.md")
- [Create an AWS DMS replication instance for MongoDB migration](chap-mongodb2documentdb.03.md "chap-mongodb2documentdb.03.md")
- [Create source and target endpoints for MongoDB migration](chap-mongodb2documentdb.04.md "chap-mongodb2documentdb.04.md")
- [Create and run a MongoDB migration task](chap-mongodb2documentdb.05.md "chap-mongodb2documentdb.05.md")
