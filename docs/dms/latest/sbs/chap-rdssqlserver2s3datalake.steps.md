...
![Load complete](images/sbs-rdssqlserver2s3datalake-load-complete-replication-ongoing.png)
...
![the structure of folders after partitioning.](images/sbs-rdssqlserver2s3datalake-partitioning.png)
