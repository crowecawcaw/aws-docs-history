...
- [Step-by-step an Amazon RDS PostgreSQL database to an Amazon S3 data lake migration walkthrough](postgresql-s3datalake.stepbystep.md "postgresql-s3datalake.stepbystep.md")
...
- An AWS account with AWS Identity and Access Management (IAM) credentials that allows you to launch Amazon RDS
  ...
  credentials, see [Create an IAM user](../userguide/CHAP_GettingStarted.SettingUp.md#CHAP_SettingUp.IAM "../userguide/CHAP_GettingStarted.SettingUp.md#CHAP_SettingUp.IAM").
- An understanding of the Amazon Virtual Private Cloud (Amazon VPC) service and security groups.
  ...
  [Controlling access with security groups](../../../AmazonRDS/latest/UserGuide/Overview.RDSSecurityGroups.md "../../../AmazonRDS/latest/UserGuide/Overview.RDSSecurityGroups.md").
