...
If your Oracle source is an Amazon RDS database, it will be placed in ARCHIVELOG MODE if, and only if, you enable backups. 3. Run the following command to turn on supplemental logging at the database level, which AWS DMS requires:
