...
8. For **Virtual private cloud (VPC)** under **Connectivity**, choose `sc-vpc`. You created this VPC in [Step 1](schema-conversion-oracle-postgresql-step-1.md "schema-conversion-oracle-postgresql-step-1.md").
