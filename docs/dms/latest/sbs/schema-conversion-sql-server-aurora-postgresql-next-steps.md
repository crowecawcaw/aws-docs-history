# Migration from SQL Server databases to Aurora PostgreSQL with DMS schema conversion next steps
...
- Use AWS DMS to migrate your source data. For more information, see the [Database Migration Service User Guide](../userguide/Welcome.md "../userguide/Welcome.md").
...
- Learn more about Aurora PostgreSQL. For more information, see the [Amazon Aurora User Guide](../../../AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.md "../../../AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.md").
