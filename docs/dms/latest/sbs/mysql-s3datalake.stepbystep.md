...
- [Using a MySQL-compatible database as a source for AWS DMS](../userguide/CHAP_Source.MySQL.md "../userguide/CHAP_Source.MySQL.md")
- [Using Amazon S3 as a target](../userguide/CHAP_Target.S3.md "../userguide/CHAP_Target.S3.md")
