...
![Migration process](/images/dms/latest/sbs/images/datarep-conceptual2.png)
...
For information about the KMS key, see [Setting an Encryption Key and Specifying KMS Permissions](../userguide/CHAP_Security.EncryptionKey.md "../userguide/CHAP_Security.EncryptionKey.md"). 5. Click **Next**.
