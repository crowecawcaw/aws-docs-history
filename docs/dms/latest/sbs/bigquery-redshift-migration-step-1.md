...
You can connect to BigQuery with a user account or a service account. A _service account_ is a special kind of account designed to be used by applications or compute workloads, rather than a person.
...
2. Make sure that you have API enabled on your [BigQuery API](https://console.cloud.google.com/apis/library/bigquery.googleapis.com "https://console.cloud.google.com/apis/library/bigquery.googleapis.com") page. If you don’t see **API Enabled**, choose **Enable**.
3. On the [Service accounts](https://console.cloud.google.com/iam-admin/serviceaccounts "https://console.cloud.google.com/iam-admin/serviceaccounts") page, choose your BigQuery project, and then choose **Create service account**.
