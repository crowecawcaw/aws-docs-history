...
5. Change the settings to improve the performance of converted code. For more information, see [Specifying Oracle to MySQL conversion settings](../userguide/schema-conversion-oracle-mysql.md "../userguide/schema-conversion-oracle-mysql.md").
