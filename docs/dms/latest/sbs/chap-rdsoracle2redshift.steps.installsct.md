...
4. Using SQL Workbench/J, configure JDBC drivers for Oracle and Amazon Redshift to set up connectivity, as described following.
   ...
   ![driver management](images/sbs-rdsor2redshift7.png) 4. From the list of drivers, choose **Redshift**. 5. Choose the **Open** icon, then choose the Amazon Redshift JDBC driver that you downloaded in the previous step. Choose **OK**.
