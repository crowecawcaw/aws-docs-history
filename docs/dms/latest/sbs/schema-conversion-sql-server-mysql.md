...
- [Migration overview](#schema-conversion-sql-server-mysql-migration-overview "#schema-conversion-sql-server-mysql-migration-overview")
- [Prerequisites for migrating SQL Server databases to Amazon RDS for MySQL with DMS schema conversion](schema-conversion-sql-server-mysql-prerequisites.md "schema-conversion-sql-server-mysql-prerequisites.md")
- [Step-by-step SQL Server databases to Amazon RDS for MySQL with DMS schema conversion](schema-conversion-sql-server-mysql-step-by-step-migration.md "schema-conversion-sql-server-mysql-step-by-step-migration.md")
- [Migration from SQL Server databases to Amazon RDS for MySQL with DMS schema conversion next steps](schema-conversion-sql-server-mysql-next-steps.md "schema-conversion-sql-server-mysql-next-steps.md")
...
![SQL Server to MySQL migration architecture in DMS Schema Conversion](images/schema-conversion-sql-server-mysql-migration-architecture.png)

Start the walkthrough by [creating the required resources](schema-conversion-sql-server-mysql-step-1.md "schema-conversion-sql-server-mysql-step-1.md").
