...
**Topics**
+ [Migration overview](#schema-conversion-sql-server-mysql-migration-overview)
+ [Prerequisites for migrating SQL Server databases to Amazon RDS for MySQL with DMS schema conversion](schema-conversion-sql-server-mysql-prerequisites.md)
+ [Step-by-step SQL Server databases to Amazon RDS for MySQL with DMS schema conversion](schema-conversion-sql-server-mysql-step-by-step-migration.md)
+ [Migration from SQL Server databases to Amazon RDS for MySQL with DMS schema conversion next steps](schema-conversion-sql-server-mysql-next-steps.md)

## Migration overview
<a name="schema-conversion-sql-server-mysql-migration-overview"></a>
