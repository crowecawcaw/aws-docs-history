...
The [Performance Comparison](chap-manageddatabases.oracle2rds.md "chap-manageddatabases.oracle2rds.md") section to know the performance of these native tools.
...
This example uses Oracle SQL Developer to generate the configuration file. If you prefer, you can use SQL\*Plus to generate the configuration file. For more information, see [Oracle SQL\*Loader](../../../AmazonRDS/latest/UserGuide/Oracle.Procedural.Importing.md "../../../AmazonRDS/latest/UserGuide/Oracle.Procedural.Importing.md") in the _Amazon Relational Database Service User Guide_.
