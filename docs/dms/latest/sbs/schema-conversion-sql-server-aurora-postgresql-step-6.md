...
9. Choose **Create data provider**.
   Use these data providers when you create your migration project in [Step 7](schema-conversion-sql-server-aurora-postgresql-step-7.md "schema-conversion-sql-server-aurora-postgresql-step-7.md").
