...
<a name="chap-oracle-postgresql.migration-process.testing"></a>
...
## Unit Testing
<a name="chap-oracle-postgresql.migration-process.testing.unit"></a>
...
## Functional Testing
<a name="chap-oracle-postgresql.migration-process.testing.functional"></a>
...
## Load Testing
<a name="chap-oracle-postgresql.migration-process.testing.load"></a>
...
<a name="chap-oracle-postgresql.migration-process.testing.standard"></a>
...
## Monitoring
<a name="chap-oracle-postgresql.migration-process.testing.monitoring"></a>
...
## Cutover
<a name="chap-oracle-postgresql.migration-process.testing.cutover"></a>

Cutover procedures are the planned event where everything goes the way you want, but it still needs to be tested.

## Fallback
<a name="chap-oracle-postgresql.migration-process.testing.fallback"></a>
...
<a name="chap-oracle-postgresql.migration-process.testing.rollback"></a>
...
## Migrate Back
<a name="chap-oracle-postgresql.migration-process.testing.migrate-back"></a>
