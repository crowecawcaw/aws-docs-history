...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher"></a>
...
## Example
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-example"></a>
...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-configure"></a>
...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-replication"></a>
...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-verify"></a>
...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-stop"></a>
...
<a name="chap-manageddatabases.postgresql-rds-postgresql-full-load-publisher-drop"></a>
