...
<a name="schema-conversion-oracle-aurora-mysql"></a>
...
**Topics**
+ [Migration overview](#schema-conversion-oracle-aurora-mysql-migration-overview)
+ [Prerequisites for Migrating Oracle databases to Amazon RDS for MySQL with DMS schema conversion](schema-conversion-oracle-aurora-mysql-prerequisites.md)
+ [Step-by-step Oracle database to Amazon RDS for MySQL with DMS schema conversion migration walkthrough](schema-conversion-oracle-aurora-mysql-step-by-step-migration.md)
+ [Migration from Oracle database to Amazon RDS for MySQL with DMS schema conversion next steps](schema-conversion-oracle-aurora-mysql-next-steps.md)

## Migration overview
<a name="schema-conversion-oracle-aurora-mysql-migration-overview"></a>
