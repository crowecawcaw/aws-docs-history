...
- Understand the supported features and limitations of AWS DMS. For information about AWS DMS, see [https://docs.aws.amazon.com/dms/latest/userguide/Welcome.html](../userguide/Welcome.md "../userguide/Welcome.md").
