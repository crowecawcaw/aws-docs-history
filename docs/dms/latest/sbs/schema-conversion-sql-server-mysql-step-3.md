...
8. For **Virtual private cloud (VPC)** under **Connectivity**, choose `sc-vpc`. You created this VPC in [Step 1](schema-conversion-sql-server-mysql-step-1.md "schema-conversion-sql-server-mysql-step-1.md").
