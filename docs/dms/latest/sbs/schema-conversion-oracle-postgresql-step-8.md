...
5. Change the settings to improve the performance of converted code. For more information, see [Specifying Oracle to PostgreSQL conversion settings](../userguide/schema-conversion-oracle-postgresql.md "../userguide/schema-conversion-oracle-postgresql.md").
