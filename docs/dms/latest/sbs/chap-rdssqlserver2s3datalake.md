...
- [Prerequisties for migrating from an Amazon RDS for SQL Server database to an Amazon S3 data lake](chap-rdssqlserver2s3datalake.prerequisites.md "chap-rdssqlserver2s3datalake.prerequisites.md")
- [Step-by-step Amazon RDS for SQL Server database to an Amazon S3 data lake migration walkthrough](chap-rdssqlserver2s3datalake.steps.md "chap-rdssqlserver2s3datalake.steps.md")
...
You can refer to [Migrating a SQL Server Always On Database to Amazon Web Services](chap-manageddatabases.sqlserveralwayson.md "chap-manageddatabases.sqlserveralwayson.md") for details on migrating from a Microsoft SQL Server Always On database instance.
