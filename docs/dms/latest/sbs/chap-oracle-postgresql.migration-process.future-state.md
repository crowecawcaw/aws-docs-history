...
<a name="chap-oracle-postgresql.migration-process.future-state"></a>
...
<a name="chap-oracle-postgresql.migration-process.future-state.current-state"></a>
...
<a name="chap-oracle-postgresql.migration-process.future-state.architecture"></a>
...
<a name="chap-oracle-postgresql.migration-process.future-state.transition"></a>
