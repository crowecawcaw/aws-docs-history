...
- Accomplish the prerequisites required for using an SAP ASE database as a source for AWS DMS. For more information, see [Prerequisites for using an SAP ASE database as a source](../userguide/CHAP_Source.SAP.md#CHAP_Source.SAP.Prerequisites "../userguide/CHAP_Source.SAP.md#CHAP_Source.SAP.Prerequisites").
- Understand the limitations on using SAP ASE as a source and MySQL as a target for AWS DMS. For more information, see [Limitations on using SAP ASE as a source](../userguide/CHAP_Source.SAP.md#CHAP_Source.SAP.Limitations "../userguide/CHAP_Source.SAP.md#CHAP_Source.SAP.Limitations") and [Limitations on using a MySQL-compatible database as a target](../userguide/CHAP_Target.MySQL.md#CHAP_Target.MySQL.Limitations "../userguide/CHAP_Target.MySQL.md#CHAP_Target.MySQL.Limitations").
- Accomplish the prerequisites required for using a MySQL-compatible database as a target for AWS DMS. For more information, see [Using a MySQL-compatible database as a target](../userguide/CHAP_Target.MySQL.md "../userguide/CHAP_Target.MySQL.md").
