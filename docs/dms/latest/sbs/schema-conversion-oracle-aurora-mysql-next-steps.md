# Migration from Oracle database to Amazon RDS for MySQL with DMS schema conversion next steps
...
- Learn more about Aurora MySQL. For more information, see the [Amazon Aurora User Guide](../../../AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.md "../../../AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.md").
