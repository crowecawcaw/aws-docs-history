...
9. For **Virtual private cloud (VPC)** under **Connectivity**, choose `sc-vpc`. You created this VPC in [Step 1](schema-conversion-oracle-aurora-mysql-step-1.md "schema-conversion-oracle-aurora-mysql-step-1.md").
