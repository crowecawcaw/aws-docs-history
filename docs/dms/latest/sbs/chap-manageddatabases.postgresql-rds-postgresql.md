...
![PostgreSQL Databases to Amazon RDS for PostgreSQL hybrid migration approach](images/postgresql-rds-postgresql-migration-approach.png)
...
- [Full load PostgreSQL database migration](chap-manageddatabases.postgresql-rds-postgresql-full-load.md "chap-manageddatabases.postgresql-rds-postgresql-full-load.md")
- [Full load PostgreSQL database migration options performance comparison](chap-manageddatabases.postgresql-rds-postgresql-performance-comparison.md "chap-manageddatabases.postgresql-rds-postgresql-performance-comparison.md")
- [Migrate PostgreSQL database with AWS DMS ongoing replication](chap-manageddatabases.postgresql-rds-postgresql-ongoing-replication.md "chap-manageddatabases.postgresql-rds-postgresql-ongoing-replication.md")
...
For more information about the performance of these tools, see [Performance Comparison](chap-manageddatabases.postgresql-rds-postgresql-performance-comparison.md "chap-manageddatabases.postgresql-rds-postgresql-performance-comparison.md").
