...
5. For **User name** and **Password**, enter the credentials of the database user that you created for your source database in [Step 2](schema-conversion-sql-server-aurora-postgresql-step-2.md "schema-conversion-sql-server-aurora-postgresql-step-2.md").
...
5. For **User name** and **Password**, enter the credentials of the database user that you created for your target database in [Step 3](schema-conversion-sql-server-aurora-postgresql-step-3.md "schema-conversion-sql-server-aurora-postgresql-step-3.md").
...
11. Choose **Store**.
    Use these secrets when you create your migration project in [Step 7](schema-conversion-sql-server-aurora-postgresql-step-7.md "schema-conversion-sql-server-aurora-postgresql-step-7.md").
