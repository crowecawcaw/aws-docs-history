...
- Run AWS SCT and create a migration assessment report. For more information, see [Creating migration assessment reports](../../../SchemaConversionTool/latest/userguide/CHAP_AssessmentReport.md "../../../SchemaConversionTool/latest/userguide/CHAP_AssessmentReport.md").
- Run AWS SCT and automatically convert the database code. For more information, see [Converting database schemas](../../../SchemaConversionTool/latest/userguide/CHAP_Converting.md "../../../SchemaConversionTool/latest/userguide/CHAP_Converting.md").
...
AWS SCT offers both an interactive GUI and a command line interface (CLI) which are useful in different situations. The user interface is good in a more interactive situations where the user needs to explore the schema and perhaps select only part of it for conversion. The CLI is good for automation in situations where DDL code might be coming from a different source such as reports. For more information, see [Script/ETL/Report Conversion](chap-oracle-postgresql.migration-process.script-conversion.md "chap-oracle-postgresql.migration-process.script-conversion.md").
...
For more information, see [AWS Schema Conversion Tool User Guide](../../../SchemaConversionTool/latest/userguide/Schema-Conversion-Tool.pdf.md "../../../SchemaConversionTool/latest/userguide/Schema-Conversion-Tool.pdf.md"), [Oracle Database 19c To Amazon Aurora with PostgreSQL Compatibility (12.4) Migration Playbook](../oracle-to-aurora-postgresql-migration-playbook/chap-oracle-aurora-pg.md "../oracle-to-aurora-postgresql-migration-playbook/chap-oracle-aurora-pg.md"), and [AWS Schema Conversion Tool CLI and Interactive Mode Reference](https://s3.amazonaws.com/publicsctdownload/AWS+SCT+CLI+Reference.pdf "https://s3.amazonaws.com/publicsctdownload/AWS+SCT+CLI+Reference.pdf").
