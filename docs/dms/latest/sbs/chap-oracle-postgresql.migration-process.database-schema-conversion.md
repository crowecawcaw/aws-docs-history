...
<a name="chap-oracle-postgresql.migration-process.database-schema-conversion"></a>
...
## Process
<a name="chap-oracle-postgresql.migration-process.database-schema-conversion.process"></a>
...
## Exceptions
<a name="chap-oracle-postgresql.migration-process.database-schema-conversion.exceptions"></a>
...
<a name="chap-oracle-postgresql.migration-process.database-schema-conversion.interactive"></a>
...
## Schema Drift
<a name="chap-oracle-postgresql.migration-process.database-schema-conversion.schema-drift"></a>
