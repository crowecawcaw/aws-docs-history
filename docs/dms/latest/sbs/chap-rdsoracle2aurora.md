...
<a name="chap-rdsoracle2aurora"></a>
...
**Topics**
+ [Costs](#costs)
+ [Prerequisites for migrating from Amazon RDS for Oracle to Amazon Aurora MySQL](chap-rdsoracle2aurora.prerequisites.md)
+ [Migration architecture for migrating from Amazon RDS for Oracle database to Amazon Aurora MySQL-Compatible Edition](chap-rdsoracle2aurora.architecture.md)
+ [Step-by-step Amazon Relational Database Service to Amazon Aurora MySQL-Compatible Edition migration walkthrough](chap-rdsoracle2aurora.steps.md)
+ [AWS DMS migration from Amazon RDS for Oracle next steps](chap-rdsoracle2aurora.nextsteps.md)
