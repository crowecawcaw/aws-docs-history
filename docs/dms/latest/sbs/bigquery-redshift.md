...
**Topics**
+ [Migration overview](#bigquery-redshift-migration-overview)
+ [Prerequisites for migrating a BigQuery project to Amazon Redshift](bigquery-redshift-prerequisites.md)
+ [Step-by-Step BigQuery project to Amazon Redshift migration walkthrough](bigquery-redshift-step-by-step-migration.md)
+ [Migration from a BigQuery project to Amazon Redshift next steps](bigquery-redshift-next-steps.md)

## Migration overview
<a name="bigquery-redshift-migration-overview"></a>
...
### Migration strategy
<a name="bigquery-redshift-migration-overview-strategy"></a>
...
<a name="bigquery-redshift-migration-overview-security"></a>
...
### Data types mapping
<a name="bigquery-redshift-migration-overview-mapping"></a>
...
### Limitations
<a name="bigquery-redshift-migration-overview-limitations"></a>
