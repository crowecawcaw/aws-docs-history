...
- Understand the supported data type conversion options for Oracle and PostgreSQL. For information about data types for Oracle as a source, see [Using an Oracle database as a source](../userguide/CHAP_Source.Oracle.md "../userguide/CHAP_Source.Oracle.md"). For information about data types for PostgreSQL as a target, see [Using a PostgreSQL Database as a Target](../userguide/CHAP_Target.PostgreSQL.md "../userguide/CHAP_Target.PostgreSQL.md").
