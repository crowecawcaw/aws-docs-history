...
# Migration from Oracle databases to Amazon Aurora PostgreSQL with DMS schema conversion next steps
<a name="schema-conversion-oracle-postgresql-next-steps"></a>
