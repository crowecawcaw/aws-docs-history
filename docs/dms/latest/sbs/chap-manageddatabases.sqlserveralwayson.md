...
For more information on extra connection attributes for SQL Server as source, see [Extra connection attributes when using SQL Server as a source](../userguide/CHAP_Source.md#CHAP_Source.SQLServer.ConnectionAttrib "../userguide/CHAP_Source.md#CHAP_Source.SQLServer.ConnectionAttrib").
