...
![Task Settings section](images/sbs-rdsor2postgresql23.5.png) 3. Leave the Advanced settings at their default values. 4. Choose **Table mappings**, and select the **JSON** tab. Next, select **Enable JSON editing**, and enter the table mappings you saved in the last step in [Step 4: Convert the Oracle Schema to PostgreSQL](chap-rdsoracle2postgresql.steps.convertschema.md "chap-rdsoracle2postgresql.steps.convertschema.md").
