...
# Merge for T-SQL
<a name="chap-sql-server-aurora-pg.tsql.merge"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-pg.tsql.merge.sqlserver"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.tsql.merge.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.merge.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.tsql.merge.pg"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.merge.pg.examples"></a>
