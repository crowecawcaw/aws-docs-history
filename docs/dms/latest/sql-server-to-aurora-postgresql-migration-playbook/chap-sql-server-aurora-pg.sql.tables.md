...
<a name="chap-sql-server-aurora-pg.sql.tables"></a>
...
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.conformity"></a>
...
### T-SQL Extensions
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.extensions"></a>
...
### Table Scope
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.scope"></a>
...
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.existingtable"></a>
...
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.timestamp"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.sql.tables.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.sql.tables.pg"></a>
...
<a name="chap-sql-server-aurora-pg.sql.tables.pg.extensions"></a>
...
### Table Scope
<a name="chap-sql-server-aurora-pg.sql.tables.pg.scope"></a>
...
### Creating a Table Based on an Existing Table or Query
<a name="chap-sql-server-aurora-pg.sql.tables.pg.existingtable"></a>
...
<a name="chap-sql-server-aurora-pg.sql.tables.pg.timestamp"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.sql.tables.pg.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.sql.tables.pg.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-pg.sql.tables.summary"></a>
