...
| -------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Three star feature compatibility | Four star automation level         | [Creating Tables](chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.tables "chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.tables") | Auto generated value column is different. Can’t use physical attribute `ON`. Missing table variable and memory-optimized table. |
...
For more information, see [Data Types](chap-sql-server-aurora-pg.sql.datatypes.md "chap-sql-server-aurora-pg.sql.datatypes.md"), [Column Encryption](chap-sql-server-aurora-pg.security.columnencryption.md "chap-sql-server-aurora-pg.security.columnencryption.md"), and [Databases and Schemas](chap-sql-server-aurora-pg.tsql.schemas.md "chap-sql-server-aurora-pg.tsql.schemas.md").
...
| Index types                 | `CLUSTERED` or `NONCLUSTERED` | See [Indexes](chap-sql-server-aurora-pg.indexes.md "chap-sql-server-aurora-pg.indexes.md"). |
