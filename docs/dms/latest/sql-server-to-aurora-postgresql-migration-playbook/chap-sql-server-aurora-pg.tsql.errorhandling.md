...
<a name="chap-sql-server-aurora-pg.tsql.errorhandling"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver"></a>
...
### TRY…​CATCH Blocks
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.trycatch"></a>
...
### THROW
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.throw"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.examples"></a>
...
### RAISERROR
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.raiseerror"></a>
...
### FORMATMESSAGE
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.formatmessage"></a>
...
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.sqlserver.errorstate"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.pg"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.pg.syntax"></a>
...
### Throw errors
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.pg.throwerrors"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.pg.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-pg.tsql.errorhandling.summary"></a>
