...
| ------------------------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- |
| Four star feature compatibility | Three star automation level        | [Flow Control](chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.flowcontrol "chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.flowcontrol") | PostgreSQL doesn’t support `GOTO` and `WAITFOR TIME`. |
...
- `TRY…​ CATCH` — Error handling. For more information, see [Error Handling](chap-sql-server-aurora-pg.tsql.errorhandling.md "chap-sql-server-aurora-pg.tsql.errorhandling.md").
...
WHILE loops are commonly used with cursors and use the system variable `@@FETCH_STATUS` to determine when to exit. For more information, see [Cursors](chap-sql-server-aurora-pg.tsql.cursors.md "chap-sql-server-aurora-pg.tsql.cursors.md").
...
For more information, see [Control-of-Flow](https://docs.microsoft.com/en-us/sql/t-sql/language-elements/control-of-flow?view=sql-serverver15 "https://docs.microsoft.com/en-us/sql/t-sql/language-elements/control-of-flow?view=sql-serverver15") in the _SQL Server documentation_.
...
| `TRY…​CATCH` | Error handling.                                                                                                           | Error handling. For more information, see [Error Handling](chap-sql-server-aurora-pg.tsql.errorhandling.md "chap-sql-server-aurora-pg.tsql.errorhandling.md").                                                                                                                                         |
...
| `WAITFOR`    | Delay                                                                                                                     | `pg_sleep`. For more information, see [Date/Time Functions and Operators](https://www.postgresql.org/docs/13/static/functions-datetime.html "https://www.postgresql.org/docs/13/static/functions-datetime.html") in the _PostgreSQL documentation_.                                                    |
...
For more information, see [Control Structures](https://www.postgresql.org/docs/13/plpgsql-control-structures.html "https://www.postgresql.org/docs/13/plpgsql-control-structures.html") in the _PostgreSQL documentation_.
