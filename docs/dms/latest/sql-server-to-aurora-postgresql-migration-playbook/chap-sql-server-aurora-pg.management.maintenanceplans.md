...
You can also restore a database instance to a point-in-time. For more information, see [Backup and Restore](chap-sql-server-aurora-pg.hadr.backup.md "chap-sql-server-aurora-pg.hadr.backup.md").
...
For more information, see [SQL Server Managing Statistics and PostgreSQL Table Statistics](chap-sql-server-aurora-pg.tuning.statistics.md "chap-sql-server-aurora-pg.tuning.statistics.md").
