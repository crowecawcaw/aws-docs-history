...
| -------------------------------- | ---------------------------------- | ------------------------- | ------------------------------------------------------------------------------- |
| Three star feature compatibility | Four star automation level         | N/A                       | CONVERT is used only to convert between collations. CAST uses different syntax. |
...
For more information, see [Date and Time styles](https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017#date-and-time-styles "https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017#date-and-time-styles") in the _SQL Server documentation_.

### Conversion Matrix

For a list of available conversion data types, see [Implicit conversions](https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017#implicit-conversions "https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017#implicit-conversions") in the _SQL Server documentation_.
...
For more information, see [CAST and CONVERT (Transact-SQL)](https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017 "https://docs.microsoft.com/en-us/sql/t-sql/functions/cast-and-convert-transact-sql?view=sql-server-2017") in the _SQL Server documentation_.
...
Not all SQL Server data types are supported on Aurora PostgreSQL, besides changing the `CAST` or `CONVERT` commands, you might need to also change the source of the target data type. For more information, see [Data Types](chap-sql-server-aurora-pg.sql.datatypes.md "chap-sql-server-aurora-pg.sql.datatypes.md").
...
For more information, see [CREATE CAST](https://www.postgresql.org/docs/13/sql-createcast.html "https://www.postgresql.org/docs/13/sql-createcast.html"), [Type Conversion](https://www.postgresql.org/docs/13/typeconv.html "https://www.postgresql.org/docs/13/typeconv.html"), and [CREATE CONVERSION](https://www.postgresql.org/docs/13/sql-createconversion.html "https://www.postgresql.org/docs/13/sql-createconversion.html") in the _PostgreSQL documentation_.
