...
# Scripting features
<a name="chap-sql-server-aurora-pg.management.scripting"></a>
...
| --- | --- | --- | --- | 
|  ![No feature compatibility](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-postgresql-migration-playbook/images/pb-compatibility-0.png)  | N/A | N/A | Non-compatible tool sets and scripting languages. Use PostgreSQL `pgAdmin`, Amazon RDS API, AWS Management Console, and AWS CLI. | 

## SQL Server Usage
<a name="chap-sql-server-aurora-pg.management.scripting.sqlserver"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.scripting.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.management.scripting.pg"></a>
...
### PostgreSQL pgAdmin
<a name="chap-sql-server-aurora-pg.management.scripting.pg.pgadmin"></a>
...
### Amazon RDS API
<a name="chap-sql-server-aurora-pg.management.scripting.pg.rdsapi"></a>
...
<a name="chap-sql-server-aurora-pg.management.scripting.pg.managementconsole"></a>
...
<a name="chap-sql-server-aurora-pg.management.scripting.pg.cli"></a>
...
<a name="chap-sql-server-aurora-pg.management.scripting.pg.programmaticapi"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.scripting.pg.examples"></a>
