...
| ------------------------ | ---------------------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| No feature compatibility | N/A                                | N/A                       | Non-compatible tool sets and scripting languages. Use PostgreSQL `pgAdmin`, Amazon RDS API, AWS Management Console, and AWS CLI. |
...
SQL Server Agent supports running PowerShell scripts in job steps. For more information, see [SQL Server Agent](chap-sql-server-aurora-pg.management.scheduledlambda.md "chap-sql-server-aurora-pg.management.scheduledlambda.md").
...
The PostgreSQL `pgAdmin` also supports a Python scripting shell that you can use interactively and programmatically. For more information see: [pgAdmin](https://www.pgadmin.org/ "https://www.pgadmin.org/").
...
You can also connect to individual database instances. For more information, see [High Availability Essentials](chap-sql-server-aurora-pg.hadr.essentials.md "chap-sql-server-aurora-pg.hadr.essentials.md"). 3. In the command shell, enter the following:
...
For more information, see [Command Line Interface Command Reference](../../../cli/latest/reference.md "../../../cli/latest/reference.md") and [Amazon Relational Database Service API Reference](../../../AmazonRDS/latest/APIReference/Welcome.md "../../../AmazonRDS/latest/APIReference/Welcome.md").
