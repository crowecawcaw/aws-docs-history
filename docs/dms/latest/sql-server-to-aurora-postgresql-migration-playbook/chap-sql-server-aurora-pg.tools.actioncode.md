...
For more information, see [Creating Tables](chap-sql-server-aurora-pg.sql.tables.md "chap-sql-server-aurora-pg.sql.tables.md").
...
For more information, see [Data Types](chap-sql-server-aurora-pg.sql.datatypes.md "chap-sql-server-aurora-pg.sql.datatypes.md").
...
![No automation](/images/dms/latest/sql-server-to-aurora-postgresql-migration-playbook/images/pb-automation-0.png)
...
For more information, see [SQL Server Collations and PostgreSQL Encoding](chap-sql-server-aurora-pg.tsql.collations.md "chap-sql-server-aurora-pg.tsql.collations.md").
...
For more information, see [PIVOT and UNPIVOT](chap-sql-server-aurora-pg.tsql.pivot.md "chap-sql-server-aurora-pg.tsql.pivot.md").
...
For more information, see [SQL Server TOP and FETCH and PostgreSQL LIMIT and OFFSET](chap-sql-server-aurora-pg.tsql.topfetch.md "chap-sql-server-aurora-pg.tsql.topfetch.md").
...
![Three star automation level](/images/dms/latest/sql-server-to-aurora-postgresql-migration-playbook/images/pb-automation-3.png)
...
For more information, see [Cursors](chap-sql-server-aurora-pg.tsql.cursors.md "chap-sql-server-aurora-pg.tsql.cursors.md").
...
For more information, see [SQL Server Flow Control and PostgreSQL Control Structures](chap-sql-server-aurora-pg.tsql.flowcontrol.md "chap-sql-server-aurora-pg.tsql.flowcontrol.md").
...
For more information, see [Transactions](chap-sql-server-aurora-pg.tsql.transactions.md "chap-sql-server-aurora-pg.tsql.transactions.md").
...
For more information, see [Triggers](chap-sql-server-aurora-pg.tsql.triggers.md "chap-sql-server-aurora-pg.tsql.triggers.md").
...
For more information, see [MERGE](chap-sql-server-aurora-pg.tsql.merge.md "chap-sql-server-aurora-pg.tsql.merge.md").
...
For more information, see [SQL Server Query Hints and Plan Guides and PostgreSQL DB Query Planning](chap-sql-server-aurora-pg.tuning.queryplanning.md "chap-sql-server-aurora-pg.tuning.queryplanning.md").
...
For more information, see [Full-Text Search](chap-sql-server-aurora-pg.tsql.fulltextsearch.md "chap-sql-server-aurora-pg.tsql.fulltextsearch.md").
...
For more information, see [Indexes](chap-sql-server-aurora-pg.indexes.md "chap-sql-server-aurora-pg.indexes.md").
...
For more information, see [SQL Server Partitioning and PostgreSQL Partitions or Table Inheritance](chap-sql-server-aurora-pg.storage.partitioning.md "chap-sql-server-aurora-pg.storage.partitioning.md").
...
For more information, see [Backup and Restore](chap-sql-server-aurora-pg.hadr.backup.md "chap-sql-server-aurora-pg.hadr.backup.md").
...
For more information and potential workarounds, see [SQL Server Graph and PostgreSQL Apache AGE Extension](chap-sql-server-aurora-pg.tsql.graph.md "chap-sql-server-aurora-pg.tsql.graph.md").
...
For more information, see [SQL Server Agent and PostgreSQL Scheduled Lambda](chap-sql-server-aurora-pg.management.scheduledlambda.md "chap-sql-server-aurora-pg.management.scheduledlambda.md").
...
For more information, see [SQL Server Service Broker Essentials](chap-sql-server-aurora-pg.tsql.servicebroker.md "chap-sql-server-aurora-pg.tsql.servicebroker.md").
...
For more information, see [JSON and XML](chap-sql-server-aurora-pg.tsql.json.md "chap-sql-server-aurora-pg.tsql.json.md").
...
For more information, see [SQL Server Constraints and PostgreSQL Table Constraints](chap-sql-server-aurora-pg.sql.constraints.md "chap-sql-server-aurora-pg.sql.constraints.md").
...
For more information, see [SQL Server Linked Servers and PostgreSQL DBLink and FDWrapper](chap-sql-server-aurora-pg.management.linkedservers.md "chap-sql-server-aurora-pg.management.linkedservers.md").
...
For more information, see [SQL Server Synonyms and PostgreSQL Views, Types, and Functions](chap-sql-server-aurora-pg.tsql.synonyms.md "chap-sql-server-aurora-pg.tsql.synonyms.md").
