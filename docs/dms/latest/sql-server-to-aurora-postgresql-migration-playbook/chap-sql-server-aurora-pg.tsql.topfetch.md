...
# Top fetch for T-SQL
<a name="chap-sql-server-aurora-pg.tsql.topfetch"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-pg.tsql.topfetch.sqlserver"></a>
...
### TOP
<a name="chap-sql-server-aurora-pg.tsql.topfetch.sqlserver.top"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.tsql.topfetch.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.topfetch.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.tsql.topfetch.pg"></a>
...
### Syntax
<a name="chap-sql-server-aurora-pg.tsql.topfetch.pg.syntax"></a>
...
<a name="chap-sql-server-aurora-pg.tsql.topfetch.pg.considerations"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.topfetch.pg.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-pg.tsql.topfetch.summary"></a>
