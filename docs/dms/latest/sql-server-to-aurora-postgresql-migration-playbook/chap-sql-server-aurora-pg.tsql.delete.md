...
| -------------------------------- | ---------------------------------- | ------------------------- | --------------------------------------------------------------------------------- |
| Three star feature compatibility | Three star automation level        | N/A                       | PostgreSQL doesn’t support `DELETE …​ FROM from_list`. Rewrite to use subqueries. |
...
For more information, see [DELETE](https://www.postgresql.org/docs/13/sql-delete.html "https://www.postgresql.org/docs/13/sql-delete.html") and [UPDATE](https://www.postgresql.org/docs/13/sql-update.html "https://www.postgresql.org/docs/13/sql-update.html") in the _PostgreSQL documentation_.
