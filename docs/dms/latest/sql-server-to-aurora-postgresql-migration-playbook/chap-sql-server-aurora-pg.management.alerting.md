...
| ------------------------------ | ---------------------------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| One star feature compatibility | N/A                                | N/A                       | Use [Amazon RDS event notification](../../../AmazonRDS/latest/UserGuide/USER_Events.md "../../../AmazonRDS/latest/UserGuide/USER_Events.md") with [Amazon Simple Notification Service](https://aws.amazon.com/sns/ "https://aws.amazon.com/sns/"). |
...
For more information, see [Alerts](https://docs.microsoft.com/en-us/sql/ssms/agent/alerts?view=sql-server-ver15 "https://docs.microsoft.com/en-us/sql/ssms/agent/alerts?view=sql-server-ver15") in the _SQL Server documentation_.
...
For more information, see [Using Amazon RDS event notification](../../../AmazonRDS/latest/UserGuide/USER_Events.md "../../../AmazonRDS/latest/UserGuide/USER_Events.md") in the _Amazon Relational Database Service User Guide_.
