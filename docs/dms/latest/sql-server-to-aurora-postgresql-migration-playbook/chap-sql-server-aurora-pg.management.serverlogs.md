...
# Viewing server logs
<a name="chap-sql-server-aurora-pg.management.serverlogs"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.serverlogs.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.management.serverlogs.pg"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.serverlogs.pg.examples"></a>
