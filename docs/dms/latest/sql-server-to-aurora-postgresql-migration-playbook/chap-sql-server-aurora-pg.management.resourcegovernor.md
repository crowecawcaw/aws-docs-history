...
<a name="chap-sql-server-aurora-pg.management.resourcegovernor"></a>
...
### Use Cases
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.sqlserver.usecases"></a>
...
### Concepts
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.sqlserver.concepts"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.pg"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.pg.examples"></a>
...
<a name="chap-sql-server-aurora-pg.management.resourcegovernor.pg.dedicated"></a>
