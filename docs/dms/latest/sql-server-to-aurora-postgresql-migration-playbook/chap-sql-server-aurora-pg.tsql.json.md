...
<a name="chap-sql-server-aurora-pg.tsql.json"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver"></a>
...
### XML Data
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.xmldata"></a>
...
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.xmldata.types"></a>
...
#### XML Indexes
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.xmldata.indexes"></a>
...
#### XQuery
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.xmldata.xquery"></a>
...
### JSON Data
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.jsondata"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.json.sqlserver.examples"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.tsql.json.pg"></a>
...
### Examples
<a name="chap-sql-server-aurora-pg.tsql.json.pg.examples"></a>
...
### XML Examples
<a name="chap-sql-server-aurora-pg.tsql.json.pg.xmlexamples"></a>
...
## Summary
<a name="chap-sql-server-aurora-pg.tsql.json.summary"></a>
