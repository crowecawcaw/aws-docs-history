...
| ------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| Four star feature compatibility | Three star automation level        | [XML](chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.xml "chap-sql-server-aurora-pg.tools.actioncode.md#chap-sql-server-aurora-pg.tools.actioncode.xml") | Syntax and option differences, similar functionality. PostgreSQL doesn’t have a `FOR XML` clause. |
...
SQL Server doesn’t support a dedicated JSON data type. However, you can store JSON documents in an `NVARCHAR` column. For more information about BLOBS, see [Data Types](chap-sql-server-aurora-pg.sql.datatypes.md "chap-sql-server-aurora-pg.sql.datatypes.md").
