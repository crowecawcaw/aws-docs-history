...
# Monitoring features
<a name="chap-sql-server-aurora-pg.management.monitoring"></a>
...
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.ostools"></a>
...
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.extendedevents"></a>
...
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.tracingframework"></a>
...
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.ssms"></a>
...
### T-SQL
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.tsql"></a>
...
### Trace Flags
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.traceflags"></a>
...
<a name="chap-sql-server-aurora-pg.management.monitoring.sqlserver.ssqs"></a>
...
## PostgreSQL Usage
<a name="chap-sql-server-aurora-pg.management.monitoring.pg"></a>
...
### Example
<a name="chap-sql-server-aurora-pg.management.monitoring.pg.example"></a>
