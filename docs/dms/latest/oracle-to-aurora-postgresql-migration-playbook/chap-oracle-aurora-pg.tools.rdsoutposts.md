...
<a name="chap-oracle-aurora-pg.tools.rdsoutposts"></a>
...
## How it works
<a name="chap-oracle-aurora-pg.tools.rdsoutposts.howitworks"></a>
...
![How RDS on Outposts works](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-rds-outposts-how-it-works.png)
