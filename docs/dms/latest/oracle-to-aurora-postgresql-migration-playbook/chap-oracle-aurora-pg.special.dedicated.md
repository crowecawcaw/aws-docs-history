...
![Traditional Oracle model](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-traditional-oracle-model.png)
...
![Aurora separate and dedicated database clusters](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-aurora-dedicated-database-clusters.png)
