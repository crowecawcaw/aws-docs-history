...
| ------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| Four star feature compatibility | Four star automation level         | [Data Types](chap-oracle-aurora-pg.tools.md#chap-oracle-aurora-pg.tools.actioncode.datatypes "chap-oracle-aurora-pg.tools.md#chap-oracle-aurora-pg.tools.actioncode.datatypes") | PostgreSQL doesn’t support `BFILE`, `ROWID`, `UROWID`. |
