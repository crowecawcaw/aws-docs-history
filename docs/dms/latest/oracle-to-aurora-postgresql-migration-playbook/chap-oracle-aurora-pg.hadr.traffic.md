...
| ------------------------------ | ---------------------------------- | ------------------------- | ------------------------------------------------- |
| Two star feature compatibility | No automation                      | N/A                       | Some features may be replaced by Amazon RDS Proxy |
...
For more information, see [Amazon RDS Proxy](chap-oracle-aurora-pg.tools.rdsproxy.md "chap-oracle-aurora-pg.tools.rdsproxy.md") and [Using Amazon RDS Proxy](../../../AmazonRDS/latest/UserGuide/rds-proxy.md "../../../AmazonRDS/latest/UserGuide/rds-proxy.md") in the _Amazon RDS user guide_.
