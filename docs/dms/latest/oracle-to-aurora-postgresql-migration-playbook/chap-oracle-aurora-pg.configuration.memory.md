...
| Maximum amount of physical memory available for the instance | sga\_max\_size or memory\_max\_size | Configured by the Amazon RDS/Aurora instance class<br />For example:<pre>db.r3.large: 15.25GB<br />db.r3.xlarge: 30.5GB</pre> | 
