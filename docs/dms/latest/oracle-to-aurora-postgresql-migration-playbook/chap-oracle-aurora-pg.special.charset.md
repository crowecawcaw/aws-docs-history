...
| --------------------------------- | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| View database character set       | `<br>SELECT<br>• FROM NLS_DATABASE_PARAMETERS;<br>`                                | `<br>select datname,<br>pg_encoding_to_char(encoding),<br>datcollate, datctype<br>from pg_database;<br>`                                                                                         |
...
For more information, see [Character Set Support](https://www.postgresql.org/docs/10/multibyte.html "https://www.postgresql.org/docs/10/multibyte.html") in the _PostgreSQL documentation_.
