...
<a name="chap-oracle-aurora-pg.monitoring"></a>
...
<a name="chap-oracle-aurora-pg.monitoring.vsviews"></a>
...
For more information, see [Static Data Dictionary Views](https://docs.oracle.com/en/database/oracle/oracle-database/19/refrn/static-data-dictionary-views-5.html#GUID-22FAAA6B-2181-47AE-8A10-6CF968B52CA4) in the *Oracle documentation*.
...
For more information, see [Data Dictionary and Dynamic Performance Views](https://docs.oracle.com/en/database/oracle/oracle-database/19/cncpt/data-dictionary-and-dynamic-performance-views.html#GUID-BDF5B748-EB43-4B48-938E-89099069C3BB) in the *Oracle documentation*.

### PostgreSQL usage
<a name="chap-oracle-aurora-pg.monitoring.vsviews.pg"></a>
...
<a name="chap-oracle-aurora-pg.monitoring.vsviews.pg.catalog"></a>
...
For more information, see [System Catalogs](https://www.postgresql.org/docs/13/catalogs.html) in the *PostgreSQL documentation*.

#### Statistics collector
<a name="chap-oracle-aurora-pg.monitoring.vsviews.pg.collector"></a>
...
For more information, see [Dynamic Statistics Views](https://www.postgresql.org/docs/13/monitoring-stats.html#MONITORING-STATS-DYNAMIC-VIEWS-TABLE) in the *PostgreSQL documentation*.

#### Information schema tables
<a name="chap-oracle-aurora-pg.monitoring.vsviews.pg.schema"></a>
...
For more information, see [The Information Schema](https://www.postgresql.org/docs/13/information-schema.html) in the *PostgreSQL documentation*.

### Summary
<a name="chap-oracle-aurora-pg.monitoring.vsviews.summary"></a>
...
<a name="chap-oracle-aurora-pg.monitoring.vsviews.rds"></a>
