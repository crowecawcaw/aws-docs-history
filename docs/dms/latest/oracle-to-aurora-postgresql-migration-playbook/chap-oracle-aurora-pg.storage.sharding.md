...
# Oracle sharding
<a name="chap-oracle-aurora-pg.storage.sharding"></a>
...
| --- | --- | --- | --- | 
|  ![No feature compatibility](http://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-compatibility-0.png)  |  ![No automation](http://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-automation-0.png)  | N/A | PostgreSQL doesn’t support sharding. | 

## Oracle usage
<a name="chap-oracle-aurora-pg.storage.chapter.ora"></a>
