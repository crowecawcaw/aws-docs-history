...
| Move Cursor to next row and fetch into multiple scalar data types (emp_id, emp_name, salary was declared in the DECLARE section) | `<br>FETCH c1<br>INTO emp_id, emp_name, salary;<br>`                                                                                                                                         | `<br>FETCH c2<br>INTO emp_id, emp_name, salary;<br>`                                                                                                                                            |
