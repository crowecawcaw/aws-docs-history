...
<a name="chap-oracle-aurora-pg.security.users"></a>
...
| --- | --- | --- | --- | 
|  ![Three star feature compatibility](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-postgresql-migration-playbook/images/pb-compatibility-3.png)  | N/A | N/A | N/A | 

## Oracle usage
<a name="chap-oracle-aurora-pg.security.users.ora"></a>
...
<a name="chap-oracle-aurora-pg.security.users.ora.steps"></a>
...
<a name="chap-oracle-aurora-pg.security.users.ora.common"></a>
...
<a name="chap-oracle-aurora-pg.security.users.ora.mechanisms"></a>
...
<a name="chap-oracle-aurora-pg.security.users.ora.compare"></a>
...
<a name="chap-oracle-aurora-pg.security.users.ora.users"></a>
...
## PostgreSQL usage
<a name="chap-oracle-aurora-pg.security.users.pg"></a>
