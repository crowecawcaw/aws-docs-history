...
| ------------------------------ | ---------------------------------- | ------------------------- | ------------------------------------------ |
| Two star feature compatibility | No automation                      | N/A                       | PostgreSQL doesn’t support unused columns. |
...
For more information, see [ALTER TABLE](https://www.postgresql.org/docs/10/sql-altertable.html "https://www.postgresql.org/docs/10/sql-altertable.html") and [VACUUM](https://www.postgresql.org/docs/13/sql-vacuum.html "https://www.postgresql.org/docs/13/sql-vacuum.html") in the _PostgreSQL documentation_.
