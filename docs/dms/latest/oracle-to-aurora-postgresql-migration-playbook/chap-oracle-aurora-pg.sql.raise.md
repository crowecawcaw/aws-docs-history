...
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Disables message output.                                                      | `<br>DISABLE<br>`                                                                                                                                                                                                                                                 | Configure “client\_min\_message” or “log\_min\_message” for the desired results.                                                                                                                                                                                                                                                         |
| Enables message output.                                                       | `<br>ENABLE<br>`                                                                                                                                                                                                                                                  | Configure “client\_min\_message” or “log\_min\_message” for the desired results.                                                                                                                                                                                                                                                         |
