...
of Babelfish that AWS DMS supports as a target, see [Targets for AWS DMS](CHAP_Introduction.Targets.md "CHAP_Introduction.Targets.md"). Earlier versions of Babelfish on Aurora PostgreSQL
...
as a target](CHAP_Target.PostgreSQL.md#CHAP_Target.PostgreSQL.Babelfish "CHAP_Target.PostgreSQL.md#CHAP_Target.PostgreSQL.Babelfish").

For information about using Babelfish as a database endpoint, see [Babelfish for
Aurora PostgreSQL](../../../AmazonRDS/latest/AuroraUserGuide/Aurora.AuroraPostgreSQL.md "../../../AmazonRDS/latest/AuroraUserGuide/Aurora.AuroraPostgreSQL.md") in the _Amazon Aurora User Guide for Aurora_
...
handle known issues when running the migration task. For more information see, [Transformation rules and actions](CHAP_Tasks.CustomizingTasks.TableMapping.SelectionTransformation.Transformations.md "CHAP_Tasks.CustomizingTasks.TableMapping.SelectionTransformation.Transformations.md"). 3. Identify columns with data types that Babelfish doesn't support. Then,
...
more information see, [Transformation rules and actions](CHAP_Tasks.CustomizingTasks.TableMapping.SelectionTransformation.Transformations.md "CHAP_Tasks.CustomizingTasks.TableMapping.SelectionTransformation.Transformations.md").
...
cluster](../../../AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.setting-capacity.md "../../../AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.setting-capacity.md") in the _Amazon Aurora User Guide_
