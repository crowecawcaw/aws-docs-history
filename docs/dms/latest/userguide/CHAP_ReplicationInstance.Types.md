...
mode, see [Working with unlimited mode for burstable performance instances](#CHAP_ReplicationInstance.Types.UnlimitedMode "#CHAP_ReplicationInstance.Types.UnlimitedMode").
...
- [Deciding what instance class to use](#CHAP_ReplicationInstance.Types.Deciding "#CHAP_ReplicationInstance.Types.Deciding")
- [Working with unlimited mode for burstable performance instances](#CHAP_ReplicationInstance.Types.UnlimitedMode "#CHAP_ReplicationInstance.Types.UnlimitedMode")
