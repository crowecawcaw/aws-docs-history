...
**Topics**
+ [Using a MySQL compatible database as a source for homogeneous data migrations in AWS DMS](dm-data-providers-source-mysql.md)
+ [Using a PostgreSQL database as a source for homogeneous data migrations in AWS DMS](dm-data-providers-source-postgresql.md)
+ [Using a MongoDB compatible database as a source for homogeneous data migrations in AWS DMS](dm-data-providers-source-mongodb.md)