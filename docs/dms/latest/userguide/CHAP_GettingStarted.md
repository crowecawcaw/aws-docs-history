...
1. Set up your AWS account by following the steps in [Set up for AWS Database Migration Service](CHAP_GettingStarted.SettingUp.md "CHAP_GettingStarted.SettingUp.md").
