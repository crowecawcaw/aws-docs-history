...
process. For more information, see [Task settings example](CHAP_Tasks.CustomizingTasks.TaskSettings.md#CHAP_Tasks.CustomizingTasks.TaskSettings.Example "CHAP_Tasks.CustomizingTasks.TaskSettings.md#CHAP_Tasks.CustomizingTasks.TaskSettings.Example") in the [Specifying task settings for AWS Database Migration Service
tasks](CHAP_Tasks.CustomizingTasks.TaskSettings.md "CHAP_Tasks.CustomizingTasks.TaskSettings.md").
...
present in Cron format. For more information, see [Cron expression rules](CHAP_Validating.DataResync.md#CHAP_DataResync.cron "CHAP_Validating.DataResync.md#CHAP_DataResync.cron").
