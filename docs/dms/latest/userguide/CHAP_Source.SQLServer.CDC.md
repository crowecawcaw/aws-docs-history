...
Before setting up ongoing replication, see [Prerequisites for using ongoing replication (CDC) from a SQL Server source](CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Prerequisites "CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Prerequisites").
...
about ECAs, see [Endpoint settings](CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.ConnectionAttrib "CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.ConnectionAttrib").
...
each database type, see [Limitations on using SQL Server as a source for AWS DMS](CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Limitations "CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Limitations").
...
[Listing available transaction log backups](../../../AmazonRDS/latest/UserGuide/USER.SQLServer.AddlFeat.TransactionLogAccess.md#USER.SQLServer.AddlFeat.TransactionLogAccess.Listing "../../../AmazonRDS/latest/UserGuide/USER.SQLServer.AddlFeat.TransactionLogAccess.md#USER.SQLServer.AddlFeat.TransactionLogAccess.Listing") in the _Amazon RDS User Guide_.
...
as detailed in [Set up permissions for ongoing replication from a cloud SQL Server database](CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Permissions.Cloud "CHAP_Source.SQLServer.md#CHAP_Source.SQLServer.Permissions.Cloud")
