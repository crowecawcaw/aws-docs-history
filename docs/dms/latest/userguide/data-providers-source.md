...
You can use a Microsoft SQL Server, Oracle, PostgreSQL, MySQL, IBM DB2 for LUW, IBM DB2 for z/OS
and SAP ASE (Sybase ASE) database as a source data provider in migration projects for DMS Schema Conversion.

Make sure that you configure the network to permit interaction between your source data provider
and DMS Schema Conversion. For more information,
see [Setting up a network for DMS Schema Conversion](instance-profiles-network.md "instance-profiles-network.md").

###### Topics

- [Using a Microsoft SQL Server database as a source in DMS Schema Conversion](data-providers-sql-server.md "data-providers-sql-server.md")
- [Using an Oracle database as a source in DMS Schema Conversion](data-providers-oracle.md "data-providers-oracle.md")
