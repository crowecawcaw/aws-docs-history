...
| --- | --- | --- | 
| ConfigurationChange |  DMS-EVENT-0012  | The replication instance class for this replication instance is being changed.  | 
| ConfigurationChange |  DMS-EVENT-0014  | The replication instance class for this replication instance has changed.  | 
...
| ConfigurationChange |  DMS-EVENT-0024  | The replication instance is transitioning to a Multi-AZ configuration.  | 
| ConfigurationChange |  DMS-EVENT-0025  | The replication instance finished transitioning to a Multi-AZ configuration.  | 
| ConfigurationChange |  DMS-EVENT-0030  | The replication instance is transitioning to a Single-AZ configuration.  | 
| ConfigurationChange |  DMS-EVENT-0029  | The replication instance has finished transitioning to a Single-AZ configuration.  | 
...
The following table shows the possible categories and events for the premigration assessment source type.
...
| State Change | DMS-EVENT-0090 | The premigration assessment encountered an error while provisioning resources. | 
