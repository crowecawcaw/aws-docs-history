...
performance of converted code, and you can customize the schema conversion view with
tree view settings.

For information about the common conversion settings, the tree view settings, and the
settings for each conversion path, see [Specifying schema conversion settings for migration projects](schema-conversion-settings.md "schema-conversion-settings.md").
