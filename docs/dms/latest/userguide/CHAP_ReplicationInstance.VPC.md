...
1. Create an AWS DMS replication instance and assign a VPC
   ...
   [Step 1: Create a replication instance using the AWS DMS console](CHAP_GettingStarted.Replication.md#CHAP_GettingStarted.Replication.ReplicationInstance "CHAP_GettingStarted.Replication.md#CHAP_GettingStarted.Replication.ReplicationInstance") to create
...
Endpoint](CHAP_Advanced.Endpoints.secretsmanager.md "CHAP_Advanced.Endpoints.secretsmanager.md").
