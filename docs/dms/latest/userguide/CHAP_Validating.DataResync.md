...
For more information regarding data resync logging settings, see [Logging task settings](CHAP_Tasks.CustomizingTasks.TaskSettings.Logging.md "CHAP_Tasks.CustomizingTasks.TaskSettings.Logging.md").
