...
* If you already have a user account with required privileges described in [Diagnostic support scripts for MySQL-compatible databases](CHAP_SupportScripts.MySQL.md "CHAP_SupportScripts.MySQL.md"), you
