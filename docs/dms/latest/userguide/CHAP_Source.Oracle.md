...
| `OraclePathPrefix`                    | Set this string attribute to the required value in order to use<br>the Binary Reader to capture change data for an Amazon RDS for Oracle as<br>the source. This value specifies the default Oracle root used to<br>access the redo logs. For more information, see [Configuring a CDC task to use Binary Reader with an RDS for Oracle source for AWS DMS](#CHAP_Source.Oracle.Amazon-Managed.CDC "#CHAP_Source.Oracle.Amazon-Managed.CDC").Default value: none Valid value:<br>/rdsdbdata/db/ORCL_A/<br>Example: `--oracle-settings '{"OraclePathPrefix": "`/rdsdbdata/db/ORCL_A/`"}'`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
