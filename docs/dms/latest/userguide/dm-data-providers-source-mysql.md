...
**Topics**
+ [Using a self-managed MySQL compatible database as a source for homogeneous data migrations](#dm-data-providers-source-mysql-sm)
+ [Using an AWS-managed MySQL compatible database as a source for homogeneous data migrations in AWS DMS](#dm-data-providers-source-mysql-aws)
+ [Limitations for using a MySQL compatible database as a source for homogeneous data migrations](#dm-data-providers-source-mysql-limitations)
