...
![Get started with AWS DMS](https://docs.aws.amazon.com/dms/latest/userguide/images/datarep-intro-rep-instance1.png)
...
Rather than creating and managing a replication instance, you can let AWS DMS provision your replication automatically using AWS DMS Serverless. For more information, see [Working with AWS DMS Serverless](CHAP_Serverless.md).
...
![Get started with AWS DMS](https://docs.aws.amazon.com/dms/latest/userguide/images/datarep-intro-rep-task1.png)
