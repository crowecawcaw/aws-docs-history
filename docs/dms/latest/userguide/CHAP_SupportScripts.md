...
* If you already have a user account with required privileges described in [Diagnostic support scripts for MySQL-compatible databases](CHAP_SupportScripts.md "CHAP_SupportScripts.md"), you
