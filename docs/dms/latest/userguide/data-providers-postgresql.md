...
To use the converted public synonyms, change the database default search path
...
In this example, replace the `<db_name>`
placeholder with the name of your database.
