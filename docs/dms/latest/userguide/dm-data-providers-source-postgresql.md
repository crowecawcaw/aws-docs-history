...
**Topics**
+ [Using a self-managed PostgreSQL database as a source for homogeneous data migrations in AWS DMS](#dm-data-providers-source-postgresql-sm)
+ [Using an AWS-managed PostgreSQL database as a source for homogeneous data migrations in AWS DMS](#dm-data-providers-source-postgresql-aws)
+ [Limitations for using a PostgreSQL compatible database as a source for homogeneous data migrations](#dm-data-providers-source-postgresql-limitations)
...
In the preceding example, replace {{your\_user}} with the name of your database user.
