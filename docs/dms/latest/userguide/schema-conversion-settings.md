...
- [Understanding IBM Db2 for LUW to Amazon RDS for PostgreSQL conversion settings](schema-conversion-db2-luw-postgresql.md "schema-conversion-db2-luw-postgresql.md")
...
- [Understanding IBM Db2 for z/OS to Amazon RDS for PostgreSQL conversion settings](schema-conversion-db2-zos-postgresql.md "schema-conversion-db2-zos-postgresql.md")
