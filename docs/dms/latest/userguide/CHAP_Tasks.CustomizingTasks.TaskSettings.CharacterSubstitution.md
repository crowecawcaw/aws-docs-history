...
`STRING` or `WSTRING` data type. For information about how to use a task configuration file to set task settings, see [Task settings example](CHAP_Tasks.CustomizingTasks.TaskSettings.md#CHAP_Tasks.CustomizingTasks.TaskSettings.Example "CHAP_Tasks.CustomizingTasks.TaskSettings.md#CHAP_Tasks.CustomizingTasks.TaskSettings.Example").
...
[Source data types for Oracle](CHAP_Source.Oracle.md#CHAP_Source.Oracle.DataTypes "CHAP_Source.Oracle.md#CHAP_Source.Oracle.DataTypes")
following.
