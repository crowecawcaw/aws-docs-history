...
For a comprehensive list of valid sources, see [Sources for AWS DMS](CHAP_Introduction.Sources.md).
...
+ [Using Microsoft Azure Database for PostgreSQL flexible server as a source for AWS DMS](CHAP_Source.AzureDBPostgreSQL.md)
+ [Using Microsoft Azure Database for MySQL flexible server as a source for AWS DMS](CHAP_Source.AzureDBMySQL.md)
+ [Using OCI MySQL Heatwave as a source for AWS DMS](CHAP_Source.heatwave.md)
+ [Using Google Cloud for MySQL as a source for AWS DMS](CHAP_Source.GC.md)
+ [Using Google Cloud for PostgreSQL as a source for AWS DMS](CHAP_Source.GCPostgres.md)
