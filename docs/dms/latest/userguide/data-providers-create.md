...
| **Virtual Mode**                     | Select *_Virtual Mode_<br>• to use schema conversion without connecting to a database.<br>For more information, see [Virtual mode for offline source and virtual target](virtual-data-provider.md "virtual-data-provider.md")                                                                                                                                        |
