...
**Topics**
+ [ReplicationInstance event messages](#EventBridge.Messages.ReplicationInstance)
+ [ReplicationTask event messages](#EventBridge.Messages.ReplicationTask)
+ [Replication event messages](#EventBridge.Messages.Replication)
...
| ConfigurationChange | DMS-EVENT-0025 | The replication instance has finished transitioning to a Multi-AZ configuration.  | 
