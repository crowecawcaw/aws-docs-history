...
1. On the **dms-postgresql-parameters** page, choose **Edit**, and set **session\_replication\_role parameter** to **replica**. Note that the **session\_replication\_role ** parameter is not on the first page of parameters. Use the pagination controls or the search field to find the parameter.
