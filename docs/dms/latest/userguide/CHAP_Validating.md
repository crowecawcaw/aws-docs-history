...
+ [Redshift Validation Performance](#CHAP_Validating.Redshift)
+ [Enhanced data validation for AWS Database Migration Service](#CHAP_Validating_Enhanced)
+ [Limitations](#CHAP_Validating.Limitations)
+ [Amazon S3 target data validation](CHAP_Validating_S3.md)
+ [AWS DMS data resync](CHAP_Validating.DataResync.md)
...
| FAILURE\_TYPE | VARCHAR(128) NOT NULL |  Severity of validation error. Can be either `RECORD_DIFF`, `MISSING_SOURCE`, `MISSING_TARGET`, or `TABLE_WARNING`. | 
