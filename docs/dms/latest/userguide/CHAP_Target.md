...
AWS Database Migration Service (AWS DMS) can use many of the most popular databases as a target for data
...
AWS DMS doesn't support migration across AWS Regions for the following target
endpoint types:
