...
1. Ensure the Amazon RDS and the database user has IAM authentication
   ...
   authentication](../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.Enabling.md "../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.Enabling.md") in the _Amazon
...
For more information, see [Creating source and target endpoints](CHAP_Endpoints.Creating.md "CHAP_Endpoints.Creating.md").
...
3. Run the following command to import the certificate and
   ...
   RDS](../../../AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.md#UsingWithRDS.SSL.CertificatesDownload "../../../AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.md#UsingWithRDS.SSL.CertificatesDownload") in the _Amazon Relational
