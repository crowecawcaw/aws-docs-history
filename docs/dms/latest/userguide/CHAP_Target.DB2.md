...
see [Targets for AWS DMS](CHAP_Introduction.Targets.md "CHAP_Introduction.Targets.md").
...
[Limitations when using Db2 LUW as a source for AWS DMS](CHAP_Source.DB2.md#CHAP_Source.DB2.Limitations "CHAP_Source.DB2.md#CHAP_Source.DB2.Limitations").
