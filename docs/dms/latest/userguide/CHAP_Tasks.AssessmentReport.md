...
For more information, see [Limitations on using a
PostgreSQL database as a DMS source](CHAP_Source.md#CHAP_Source.PostgreSQL.Limitations "CHAP_Source.md#CHAP_Source.PostgreSQL.Limitations").
...
For more information, see [Enabling change data capture (CDC)
