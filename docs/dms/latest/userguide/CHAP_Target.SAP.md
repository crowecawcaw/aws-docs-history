...
| Name | Description | 
| --- | --- | 
| `Driver` | Set this attribute if you want to use TLS for versions of ASE 15.7 and higher.<br />Default value: `Adaptive Server Enterprise`<br />Example: `driver=Adaptive Server Enterprise 16.03.06;`<br />Valid values: `Adaptive Server Enterprise 16.03.06` | 
