...
3. On the **Create replication instance** page, specify your
   ...
   class, see [Choosing the right AWS DMS replication instance for your migration](CHAP_ReplicationInstance.Types.md "CHAP_ReplicationInstance.Types.md"). 4. For **Engine version**, accept the default. 5. For **Multi AZ**, choose **Dev or test workload (Single-AZ)**. 6. For **Allocated storage (GiB)**, accept the default of 50 GiB.
