...
For more information, see [Using a PostgreSQL database as an AWS DMS source](CHAP_Source.PostgreSQL.md "CHAP_Source.PostgreSQL.md").
...
- [Enabling change data capture (CDC) using logical replication](CHAP_Source.PostgreSQL.md#CHAP_Source.PostgreSQL.Security "CHAP_Source.PostgreSQL.md#CHAP_Source.PostgreSQL.Security")
- [Using native CDC start points to set up a CDC load of a PostgreSQL source](CHAP_Source.PostgreSQL.md#CHAP_Source.PostgreSQL.v10 "CHAP_Source.PostgreSQL.md#CHAP_Source.PostgreSQL.v10")
