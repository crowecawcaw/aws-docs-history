...
- The LOB mode determines how LOBs are handled:
  ...
  settings](CHAP_Tasks.CustomizingTasks.TaskSettings.ChangeProcessingTuning.md "CHAP_Tasks.CustomizingTasks.TaskSettings.ChangeProcessingTuning.md").
...
restrictions.
For information on the task settings to specify these options, see [Target metadata task settings](CHAP_Tasks.CustomizingTasks.TaskSettings.TargetMetadata.md "CHAP_Tasks.CustomizingTasks.TaskSettings.TargetMetadata.md")
