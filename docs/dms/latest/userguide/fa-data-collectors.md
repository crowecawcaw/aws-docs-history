...
+ [Installing and configuring a data collector in AWS DMS](fa-data-collectors-install.md)
+ [Discovering OS and database servers to monitor in AWS DMS](fa-discovery.md)
+ [Managing monitored objects in AWS DMS](fa-managing-objects.md)
