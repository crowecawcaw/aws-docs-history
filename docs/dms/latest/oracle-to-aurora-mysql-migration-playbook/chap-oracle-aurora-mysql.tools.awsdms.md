...
<a name="chap-oracle-aurora-mysql.tools.awsdms"></a>
...
<a name="chap-oracle-aurora-mysql.tools.awsdms.tasks"></a>
...
## How AWS DMS works
<a name="chap-oracle-aurora-mysql.tools.awsdms.howitworks"></a>
...
![How the database migration service works](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-how-aws-dms-works.png)
