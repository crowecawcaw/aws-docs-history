...
<a name="chap-oracle-aurora-mysql.sql.ctas"></a>
...
| --- | --- | --- | --- | 
|  ![Five star feature compatibility](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-compatibility-5.png)  |  ![Five star automation level](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-automation-5.png)  | N/A | N/A | 

## Oracle usage
<a name="chap-oracle-aurora-mysql.sql.ctas.oracle"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.sql.ctas.oracle.examples"></a>
...
## MySQL usage
<a name="chap-oracle-aurora-mysql.sql.ctas.mysql"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.sql.ctas.mysql.examples"></a>
