...
For an example of sending an email message from Aurora MySQL using AWS Lambda integration, see [Invoking a Lambda Function from an Amazon Aurora MySQL DB Cluster](../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Integrating.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Integrating.md").
