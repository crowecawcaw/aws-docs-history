...
<a name="chap-oracle-aurora-mysql.hadr.replicas"></a>
...
## Oracle usage
<a name="chap-oracle-aurora-mysql.hadr.replicas.oracle"></a>
...
![Active Data Guard architecture](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-active-data-guard.png)
...
## MySQL usage
<a name="chap-oracle-aurora-mysql.hadr.replicas.mysql"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.hadr.replicas.mysql.examples"></a>

The following walkthrough demonstrates how to create a replica reader.

1. Sign in to your AWS console and choose **RDS**.

1. Choose **Instance actions** and choose **Create cross-Region read replica**.
