...
<a name="chap-oracle-aurora-mysql.security.roles"></a>
...
| --- | --- | --- | --- | 
|  ![Three star feature compatibility](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-compatibility-3.png)  | N/A | N/A | There are no roles in MySQL, only privileges. | 

## Oracle usage
<a name="chap-oracle-aurora-mysql.security.roles.oracle"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.security.roles.oracle.examples"></a>
...
For more information, see [Overview of PL/SQL](https://docs.oracle.com/en/database/oracle/oracle-database/19/lnpls/overview.html) in the *Oracle documentation*.

## MySQL usage
<a name="chap-oracle-aurora-mysql.security.roles.mysql"></a>
...
For more information, see [Using Roles](https://dev.mysql.com/doc/refman/8.0/en/roles.html) in the *MySQL documentation*.
...
### Examples
<a name="chap-oracle-aurora-mysql.security.roles.mysql.examples"></a>
