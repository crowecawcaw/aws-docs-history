...
| `to_char(sysdate,'WW')`    | 36                          | Week of the year (1<br>• 53)          |
| `to_char(sysdate,'DAY')`   | SATURDAY                    | Name of the day                       |
| `to_char(sysdate,'DD')`    | 30                          | Day in number format                  |
| `to_char(sysdate,'D')`     | 7                           | Day of the week (1<br>• 7)            |
| `to_char(sysdate,'DDD')`   | 273                         | Day of the year (1<br>• 366)          |
| `to_char(sysdate,'DY')`    | SAT                         | Short form of the day                 |
| `to_char(sysdate,'HH')`    | 9                           | Hour (1<br>• 12)                      |
| `to_char(sysdate,'HH12')`  | 9                           | Hour in 12 hours format               |
| `to_char(sysdate,'HH24')`  | 21                          | Hour in 24 hours format               |
| `to_char(sysdate,'MI')`    | 15                          | Minute (0<br>• 59)                    |
| `to_char(sysdate,'SS')`    | 24                          | Second (0<br>• 59)                    |
| `to_char(sysdate,'SSSSS')` | 79100                       | Seconds after midnight (0<br>• 86399) |
...
For more information, see [Single-Row and Aggregate Functions](chap-oracle-aurora-mysql.sql.aggregate.md "chap-oracle-aurora-mysql.sql.aggregate.md").
