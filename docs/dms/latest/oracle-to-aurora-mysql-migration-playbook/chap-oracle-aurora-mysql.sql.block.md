...
<a name="chap-oracle-aurora-mysql.sql.block"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.sql.block.oracle.examples"></a>
...
## MySQL usage
<a name="chap-oracle-aurora-mysql.sql.block.mysql"></a>
...
For more information, see [Stored Procedures](chap-oracle-aurora-mysql.sql.stored.md) and [Oracle Transaction Model and MySQL Transactions](chap-oracle-aurora-mysql.sql.transactions.md).