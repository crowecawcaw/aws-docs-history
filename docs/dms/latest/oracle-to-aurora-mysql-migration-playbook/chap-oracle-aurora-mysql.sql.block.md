...
For more information, see [Stored Procedures](chap-oracle-aurora-mysql.sql.stored.md "chap-oracle-aurora-mysql.sql.stored.md") and [Oracle Transaction Model and MySQL Transactions](chap-oracle-aurora-mysql.sql.transactions.md "chap-oracle-aurora-mysql.sql.transactions.md").
