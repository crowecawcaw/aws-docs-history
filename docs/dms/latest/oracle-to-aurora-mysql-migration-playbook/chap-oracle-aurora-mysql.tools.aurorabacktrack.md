...
<a name="chap-oracle-aurora-mysql.tools.aurorabacktrack"></a>
...
![How Amazon Aurora Backtrack works](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-amazon-aurora-backtrack.png)
...
![Backtrack DB cluster](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-backtrack-db-cluster.png)
...
## Backtrack window
<a name="chap-oracle-aurora-mysql.tools.aurorabacktrack.window"></a>
...
<a name="chap-oracle-aurora-mysql.tools.aurorabacktrack.limitations"></a>
