...
<a name="chap-oracle-aurora-mysql.tools.auroraserverless"></a>
...
![How Aurora Serverless Works](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-aurora-serverless.png)


## Amazon Aurora Serverless v2
<a name="chap-oracle-aurora-mysql.tools.auroraserverless.v2"></a>
...
## How to provision
<a name="chap-oracle-aurora-mysql.tools.auroraserverless.provision"></a>
...
![Provision Serverless v2](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-aurora-serverless-capacity.png)
