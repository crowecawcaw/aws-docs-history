...
<a name="chap-oracle-aurora-mysql.hadr.rac"></a>
...
## Oracle usage
<a name="chap-oracle-aurora-mysql.hadr.rac.oracle"></a>
...
![Oracle RAC architecture](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-oracle-rac.png)
...
<a name="chap-oracle-aurora-mysql.hadr.rac.oracle.performance"></a>
...
## MySQL usage
<a name="chap-oracle-aurora-mysql.hadr.rac.mysql"></a>
...
![Aurora architecture with four cluster nodes](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-aurora-architecture-four-cluster-nodes.png)
...
<a name="chap-oracle-aurora-mysql.hadr.rac.mysql.ha"></a>
...
![Aurora architecture with cluster endpoints](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-aurora-cluster-endpoints.png)
...
![Oracle RAC and Aurora architecture comparison](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-oracle-rac-amazon-aurora-comparison.png)
