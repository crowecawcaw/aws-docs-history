...
The primary Oracle error log file is the _alert log_. It contains verbose information about database activity including informational messages and errors. Each event includes a timestamp indicating when the event occurred. The alert log filename format is `alert<sid>.log`.
...
![Oracle database alert log file](images/oracle-aurora-mysql-configuration-logs.png)
...
For more information, see [Server Error Message Reference](https://dev.mysql.com/doc/mysql-errors/8.0/en/server-error-reference.html "https://dev.mysql.com/doc/mysql-errors/8.0/en/server-error-reference.html") in the _MySQL documentation_.
...
For more information, see [MySQL Server Logs](https://dev.mysql.com/doc/refman/5.7/en/server-logs.html "https://dev.mysql.com/doc/refman/5.7/en/server-logs.html") in the _MySQL documentation_.
...
![MySQL database error log](images/oracle-aurora-mysql-database-log.png)
