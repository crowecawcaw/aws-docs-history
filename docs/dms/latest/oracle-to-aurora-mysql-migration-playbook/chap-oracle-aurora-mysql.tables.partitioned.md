...
| -------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| Three star feature compatibility | No automation                      | [Indexes](chap-oracle-aurora-mysql.tools.actioncode.md#chap-oracle-aurora-mysql.tools.actioncode.indexes "chap-oracle-aurora-mysql.tools.actioncode.md#chap-oracle-aurora-mysql.tools.actioncode.indexes") | N/A             |
...
For more information, see [Overview of Partitioning in MySQL](https://dev.mysql.com/doc/refman/5.7/en/partitioning-overview.html "https://dev.mysql.com/doc/refman/5.7/en/partitioning-overview.html") in the _MySQL documentation_.
