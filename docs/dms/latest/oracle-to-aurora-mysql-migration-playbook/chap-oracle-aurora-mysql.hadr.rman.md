...
For examples, see [MySQL Snapshots](chap-oracle-aurora-mysql.hadr.flashback.md#chap-oracle-aurora-mysql.hadr.flashback.mysql "chap-oracle-aurora-mysql.hadr.flashback.md#chap-oracle-aurora-mysql.hadr.flashback.mysql").
