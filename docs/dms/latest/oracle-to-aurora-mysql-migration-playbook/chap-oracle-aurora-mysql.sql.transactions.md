...
| ------------------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Four star feature compatibility | Four star automation level         | [Transaction Isolation](chap-oracle-aurora-mysql.tools.actioncode.md#chap-oracle-aurora-mysql.tools.actioncode.transactionisolation "chap-oracle-aurora-mysql.tools.actioncode.md#chap-oracle-aurora-mysql.tools.actioncode.transactionisolation") | In MySQL, the default isolation level is `REPEATABLE READ`. MySQL doesn’t support nested transactions. |
...
To set the transaction isolation level, configure the `tx_isolation` parameter when using Aurora for MySQL. For more information, see [Oracle Instance Parameters and Aurora MySQL Parameter Groups](chap-oracle-aurora-mysql.configuration.parameters.md "chap-oracle-aurora-mysql.configuration.parameters.md").
