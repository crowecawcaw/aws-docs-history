...
For more information, see [Table Constraints](chap-oracle-aurora-mysql.tables.constraints.md "chap-oracle-aurora-mysql.tables.constraints.md").
...
For more information, see [Data Types](chap-oracle-aurora-mysql.tables.common.md "chap-oracle-aurora-mysql.tables.common.md").
...
For workarounds using traditional SQL syntax, see [Common Table Expressions](chap-oracle-aurora-mysql.sql.cte.md "chap-oracle-aurora-mysql.sql.cte.md").
...
For more information, see [Cursors](chap-oracle-aurora-mysql.sql.cursors.md "chap-oracle-aurora-mysql.sql.cursors.md").
...
For more information, see [Transactions](chap-oracle-aurora-mysql.sql.transactions.md "chap-oracle-aurora-mysql.sql.transactions.md").
...
For more information, see [Stored Procedures](chap-oracle-aurora-mysql.sql.stored.md "chap-oracle-aurora-mysql.sql.stored.md").
...
For more information, see [Triggers](chap-oracle-aurora-mysql.tables.triggers.md "chap-oracle-aurora-mysql.tables.triggers.md").
...
For more information, see [Oracle Sequences and Identity Columns and MySQL Sequences and AUTO INCREMENT Columns](chap-oracle-aurora-mysql.sql.identity.md "chap-oracle-aurora-mysql.sql.identity.md").
...
For more information, see [User-Defined Types](chap-oracle-aurora-mysql.tables.udt.md "chap-oracle-aurora-mysql.tables.udt.md").
...
For more information, see [XML](chap-oracle-aurora-mysql.special.xmldb.md "chap-oracle-aurora-mysql.special.xmldb.md").
...
For more information, see [Database Hints](chap-oracle-aurora-mysql.tuning.dbhints.md "chap-oracle-aurora-mysql.tuning.dbhints.md").
...
For more information, see [Indexes](chap-oracle-aurora-mysql.tables.indexes.md "chap-oracle-aurora-mysql.tables.indexes.md").
...
For more information, see [Table Partitioning](chap-oracle-aurora-mysql.storage.partition.md "chap-oracle-aurora-mysql.storage.partition.md").
...
For more information, see [Oracle Materialized Views and MySQL Summary Tables or Views](chap-oracle-aurora-mysql.special.matviews.md "chap-oracle-aurora-mysql.special.matviews.md").
...
For more information, see [Views](chap-oracle-aurora-mysql.special.views.md "chap-oracle-aurora-mysql.special.views.md").
...
For more information, see [Database Mail](chap-oracle-aurora-mysql.sql.mail.md "chap-oracle-aurora-mysql.sql.mail.md").
...
For more information, see [Database Links](chap-oracle-aurora-mysql.special.dblinks.md "chap-oracle-aurora-mysql.special.dblinks.md").
...
For more information, see [Execute Immediate](chap-oracle-aurora-mysql.sql.immediate.md "chap-oracle-aurora-mysql.sql.immediate.md").
