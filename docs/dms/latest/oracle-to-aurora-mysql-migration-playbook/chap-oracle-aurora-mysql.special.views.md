...
<a name="chap-oracle-aurora-mysql.special.views"></a>
...
| --- | --- | --- | --- | 
|  ![Four star feature compatibility](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-compatibility-4.png)  |  ![Four star automation level](https://docs.aws.amazon.com/dms/latest/oracle-to-aurora-mysql-migration-playbook/images/pb-automation-4.png)  |  | N/A | 

## Oracle usage
<a name="chap-oracle-aurora-mysql.special.views.oracle"></a>
...
### Privileges
<a name="chap-oracle-aurora-mysql.special.views.oracle.privileges"></a>
...
<a name="chap-oracle-aurora-mysql.special.views.oracle.create"></a>
...
<a name="chap-oracle-aurora-mysql.special.views.oracle.parameters"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.special.views.oracle.examples"></a>
...
## MySQL usage
<a name="chap-oracle-aurora-mysql.special.views.mysql"></a>
...
### Syntax
<a name="chap-oracle-aurora-mysql.special.views.mysql.syntax"></a>
...
### Examples
<a name="chap-oracle-aurora-mysql.special.views.mysql.examples"></a>
