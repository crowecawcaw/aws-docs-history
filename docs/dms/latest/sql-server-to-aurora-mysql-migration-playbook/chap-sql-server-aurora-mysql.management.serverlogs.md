...
The MySQL Error Log is generated by default. To generate the slow query and general logs, set the corresponding parameters in the database parameter group. For more information, see [Server Options](chap-sql-server-aurora-mysql.configuration.serveroptions.md "chap-sql-server-aurora-mysql.configuration.serveroptions.md").
...
For more information, see [MySQL database log files](../../../AmazonRDS/latest/UserGuide/USER_LogAccess.Concepts.MySQL.md "../../../AmazonRDS/latest/UserGuide/USER_LogAccess.Concepts.MySQL.md") in the _Amazon Relational Database Service User Guide_.
