...
<a name="chap-sql-server-aurora-mysql.sql.groupby"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-mysql.sql.groupby.sqlserver"></a>
...
### Syntax
<a name="chap-sql-server-aurora-mysql.sql.groupby.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.sql.groupby.sqlserver.examples"></a>
...
## MySQL Usage
<a name="chap-sql-server-aurora-mysql.sql.groupby.mysql"></a>
...
### Syntax
<a name="chap-sql-server-aurora-mysql.sql.groupby.mysql.syntax"></a>
...
<a name="chap-sql-server-aurora-mysql.sql.groupby.mysql.considerations"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.sql.groupby.mysql.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-mysql.sql.groupby.summary"></a>
