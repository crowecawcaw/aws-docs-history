...
<a name="chap-sql-server-aurora-mysql.tools.parallelquery"></a>
...
## Features
<a name="chap-sql-server-aurora-mysql.tools.parallelquery.features"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.parallelquery.benefits"></a>
...
## Important Notes
<a name="chap-sql-server-aurora-mysql.tools.parallelquery.notes"></a>
