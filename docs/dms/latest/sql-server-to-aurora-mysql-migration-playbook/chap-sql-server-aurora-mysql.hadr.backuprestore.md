...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore"></a>
...
## SQL Server Usage
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.sqlserver"></a>
...
### Syntax
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.sqlserver.examples"></a>
...
## MySQL Usage
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql"></a>
...
### Restoring Data
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.restoringdata"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.s3backups"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.backtracking"></a>
...
### Database Cloning
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.databasecloning"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.snapshots"></a>
...
### Backup Storage
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.backupstorage"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.retention"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.disabling"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.savingdata"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.migrationconsiderations"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.considerations"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.examples"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.mysql.dataexport"></a>
...
## Summary
<a name="chap-sql-server-aurora-mysql.hadr.backuprestore.summary"></a>
