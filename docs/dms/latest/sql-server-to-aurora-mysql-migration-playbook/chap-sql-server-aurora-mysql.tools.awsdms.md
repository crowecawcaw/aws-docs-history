...
<a name="chap-sql-server-aurora-mysql.tools.awsdms"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.awsdms.tasks"></a>
...
## How AWS DMS Works
<a name="chap-sql-server-aurora-mysql.tools.awsdms.howitworks"></a>
...
![How the database migration service works](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-how-aws-dms-works.png)
