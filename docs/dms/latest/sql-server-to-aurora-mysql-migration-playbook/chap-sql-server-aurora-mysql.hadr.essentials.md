...
<a name="chap-sql-server-aurora-mysql.hadr.essentials"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.essentials.sqlserver.fci"></a>
...
<a name="chap-sql-server-aurora-mysql.hadr.essentials.sqlserver.alwayson"></a>
...
### Database Mirroring
<a name="chap-sql-server-aurora-mysql.hadr.essentials.sqlserver.databasemirroring"></a>
...
### Log Shipping
<a name="chap-sql-server-aurora-mysql.hadr.essentials.sqlserver.logshipping"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.hadr.essentials.sqlserver.examples"></a>
...
## MySQL Usage
<a name="chap-sql-server-aurora-mysql.hadr.essentials.mysql"></a>
...
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.regions"></a>
...
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.dbcluster"></a>
...
### Endpoints
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.endpoints"></a>
...
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.storage"></a>
...
### Storage Auto-Repair
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.autorepair"></a>
...
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.cachewarming"></a>
...
### Crash Recovery
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.crashrecovery"></a>
...
### Delayed Replication
<a name="chap-sql-server-aurora-mysl.hadr.essentials.mysql.delayedreplication"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.hadr.essentials.mysql.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-mysql.hadr.essentials.summary"></a>
