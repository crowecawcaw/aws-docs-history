...
You can also restore a database instance to a point-in-time. For more information, see [Backup and Restore](chap-sql-server-aurora-mysql.hadr.backuprestore.md "chap-sql-server-aurora-mysql.hadr.backuprestore.md").
...
For more information, see [Managing Statistics](chap-sql-server-aurora-mysql.tsql.managingstatistics.md "chap-sql-server-aurora-mysql.tsql.managingstatistics.md").
...
| Back up the database and transaction log files                              | `BACKUP DATABASE` / `BACKUP LOG`          | Automated backups and snapshots                                                          | For more information, see [Backup and Restore](chap-sql-server-aurora-mysql.hadr.backuprestore.md "chap-sql-server-aurora-mysql.hadr.backuprestore.md"). |
