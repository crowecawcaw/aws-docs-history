...
<a name="chap-sql-server-aurora-mysql.tools.rdsproxy"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.rdsproxy.benefits"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.rdsproxy.howitworks"></a>

![How Amazon RDS Proxy Works](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-how-rds-proxy-works.png)
