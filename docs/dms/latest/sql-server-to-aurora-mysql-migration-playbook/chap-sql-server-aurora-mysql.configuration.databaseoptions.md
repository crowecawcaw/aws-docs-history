...
- Set default session options. For more information, see [Session Options](chap-sql-server-aurora-mysql.configuration.sessionoptions.md "chap-sql-server-aurora-mysql.configuration.sessionoptions.md").
...
For migration considerations, see [Server Options](chap-sql-server-aurora-mysql.configuration.serveroptions.md "chap-sql-server-aurora-mysql.configuration.serveroptions.md").
