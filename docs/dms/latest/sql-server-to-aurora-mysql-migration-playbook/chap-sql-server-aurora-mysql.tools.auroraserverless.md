...
<a name="chap-sql-server-aurora-mysql.tools.auroraserverless"></a>
...
![How Aurora Serverless Works](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-aurora-serverless.png)


## Amazon Aurora Serverless v2
<a name="chap-sql-server-aurora-mysql.tools.auroraserverless.v2"></a>
...
## How to Provision
<a name="chap-sql-server-aurora-mysql.tools.auroraserverless.provision"></a>
...
![Provision Serverless v2](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-aurora-serverless-provision.png)
