...
<a name="chap-sql-server-aurora-mysql.tools.rdsoutposts"></a>
...
## How It Works
<a name="chap-sql-server-aurora-mysql.tools.rdsoutposts.howitworks"></a>
...
![How RDS on Outposts works](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-rds-outposts-how-it-works.png)
