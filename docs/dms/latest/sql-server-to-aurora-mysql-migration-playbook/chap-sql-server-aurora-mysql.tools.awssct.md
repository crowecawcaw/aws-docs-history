...
<a name="chap-sql-server-aurora-mysql.tools.awssct"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.awssct.download"></a>
...
## Configure AWS SCT
<a name="chap-sql-server-aurora-mysql.tools.awssct.configure"></a>
...
<a name="chap-sql-server-aurora-mysql.tools.awssct.newproject"></a>
