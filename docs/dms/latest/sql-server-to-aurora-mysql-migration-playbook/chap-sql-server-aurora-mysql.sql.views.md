...
# Views for ANSI SQL
<a name="chap-sql-server-aurora-mysql.sql.views"></a>
...
<a name="chap-sql-server-aurora-mysql.sql.views.sqlserver.modifyingdata"></a>
...
### Special View Types
<a name="chap-sql-server-aurora-mysql.sql.views.sqlserver.special"></a>
...
### Syntax
<a name="chap-sql-server-aurora-mysql.sql.views.sqlserver.syntax"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.sql.views.sqlserver.examples"></a>
...
## MySQL Usage
<a name="chap-sql-server-aurora-mysql.sql.views.mysql"></a>
...
### Syntax
<a name="chap-sql-server-aurora-mysql.sql.views.mysql.syntax"></a>
...
<a name="chap-sql-server-aurora-mysql.sql.views.mysql.considerations"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.sql.views.mysql.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-mysql.sql.views.summary"></a>
