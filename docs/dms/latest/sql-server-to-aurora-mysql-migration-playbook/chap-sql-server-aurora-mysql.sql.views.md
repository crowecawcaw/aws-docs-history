...
Aurora MySQL doesn’t support triggers on views. In SQL Server, `INSTEAD OF` triggers are supported. For more information, see [Triggers](chap-sql-server-aurora-mysql.tsql.triggers.md "chap-sql-server-aurora-mysql.tsql.triggers.md").
...
Unlike SQL Server, a view in Aurora MySQL can invoke functions, which in turn may introduce a change to the database. For more information, see [User-Defined Functions](chap-sql-server-aurora-mysql.tsql.udf.md "chap-sql-server-aurora-mysql.tsql.udf.md").
...
| Triggers on views        | `INSTEAD OF`                    | N/A          | For more information, see [Triggers](chap-sql-server-aurora-mysql.tsql.triggers.md "chap-sql-server-aurora-mysql.tsql.triggers.md").              |
