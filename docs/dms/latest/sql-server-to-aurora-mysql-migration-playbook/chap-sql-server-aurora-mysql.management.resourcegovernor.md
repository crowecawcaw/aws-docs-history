...
- **Classification** is a process that inspects incoming connections and assigns them to a specific Workload Group based on the common attributes. User-defined functions are used to implement Classification. For more information, see [User-Defined Functions](chap-sql-server-aurora-mysql.tsql.udf.md "chap-sql-server-aurora-mysql.tsql.udf.md").
...
For more information, see [Users and Roles](chap-sql-server-aurora-mysql.security.usersroles.md "chap-sql-server-aurora-mysql.security.usersroles.md").
