...
For more information, see [Creating Tables](chap-sql-server-aurora-mysql.sql.creatingtables.md "chap-sql-server-aurora-mysql.sql.creatingtables.md").
...
For more information, see [Constraints](chap-sql-server-aurora-mysql.sql.constraints.md "chap-sql-server-aurora-mysql.sql.constraints.md").
...
For more information, see [Data Types](chap-sql-server-aurora-mysql.sql.datatypes.md "chap-sql-server-aurora-mysql.sql.datatypes.md").
...
For more information, see [Collations](chap-sql-server-aurora-mysql.tsql.collations.md "chap-sql-server-aurora-mysql.tsql.collations.md").
...
For workarounds using traditional SQL syntax, see [Window Functions](chap-sql-server-aurora-mysql.sql.windowfunctions.md "chap-sql-server-aurora-mysql.sql.windowfunctions.md").
...
For workarounds using traditional SQL syntax, see [PIVOT and UNPIVOT](chap-sql-server-aurora-mysql.tsql.pivot.md "chap-sql-server-aurora-mysql.tsql.pivot.md").
...
For more information, see [SQL Server TOP and FETCH and MySQL LIMIT](chap-sql-server-aurora-mysql.tsql.topfetch.md "chap-sql-server-aurora-mysql.tsql.topfetch.md").
...
For workarounds using traditional SQL syntax, see [Common Table Expressions](chap-sql-server-aurora-mysql.sql.cte.md "chap-sql-server-aurora-mysql.sql.cte.md").
...
![Three star automation level](/images/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-automation-3.png)
...
For more information, see [Cursors](chap-sql-server-aurora-mysql.tsql.cursors.md "chap-sql-server-aurora-mysql.tsql.cursors.md").
...
For more information, see [Flow Control](chap-sql-server-aurora-mysql.tsql.flowcontrol.md "chap-sql-server-aurora-mysql.tsql.flowcontrol.md").
...
For more information, see [Transactions](chap-sql-server-aurora-mysql.tsql.transactions.md "chap-sql-server-aurora-mysql.tsql.transactions.md").
...
For more information, see [Stored Procedures](chap-sql-server-aurora-mysql.tsql.storedprocedures.md "chap-sql-server-aurora-mysql.tsql.storedprocedures.md").
...
For more information, see [GROUP BY](chap-sql-server-aurora-mysql.sql.groupby.md "chap-sql-server-aurora-mysql.sql.groupby.md").
...
For more information, see [Identity and Sequences](chap-sql-server-aurora-mysql.tsql.identitysequences.md "chap-sql-server-aurora-mysql.tsql.identitysequences.md").
...
For more information, see [Date and Time Functions](chap-sql-server-aurora-mysql.tsql.datetime.md "chap-sql-server-aurora-mysql.tsql.datetime.md").
...
For more information, see [User-Defined Functions](chap-sql-server-aurora-mysql.tsql.udf.md "chap-sql-server-aurora-mysql.tsql.udf.md").
...
For more information, see [User-Defined Types](chap-sql-server-aurora-mysql.tsql.udt.md "chap-sql-server-aurora-mysql.tsql.udt.md").
...
For more information, see [Synonyms](chap-sql-server-aurora-mysql.tsql.synonyms.md "chap-sql-server-aurora-mysql.tsql.synonyms.md").
...
For more information, see [JSON and XML](chap-sql-server-aurora-mysql.tsql.xml.md "chap-sql-server-aurora-mysql.tsql.xml.md").
...
For more information, see [Table JOIN](chap-sql-server-aurora-mysql.sql.tablejoin.md "chap-sql-server-aurora-mysql.sql.tablejoin.md").
...
For more information and potential workarounds, see [MERGE](chap-sql-server-aurora-mysql.tsql.merge.md "chap-sql-server-aurora-mysql.tsql.merge.md").
...
For more information, see [Query Hints and Plan Guides](chap-sql-server-aurora-mysql.tuning.queryhints.md "chap-sql-server-aurora-mysql.tuning.queryhints.md").
...
For more information, see [Full-Text Search](chap-sql-server-aurora-mysql.tsql.fulltextsearch.md "chap-sql-server-aurora-mysql.tsql.fulltextsearch.md").
...
For more information, see [Storage](chap-sql-server-aurora-mysql.storage.md "chap-sql-server-aurora-mysql.storage.md").
...
For more information, see [Backup and Restore](chap-sql-server-aurora-mysql.hadr.backuprestore.md "chap-sql-server-aurora-mysql.hadr.backuprestore.md").
...
For more information and potential workarounds, see [Database Mail](chap-sql-server-aurora-mysql.management.databasemail.md "chap-sql-server-aurora-mysql.management.databasemail.md").
...
For more information, see [SQL Server Agent and MySQL Agent](chap-sql-server-aurora-mysql.management.agent.md "chap-sql-server-aurora-mysql.management.agent.md").
...
For more information, see [Linked Servers](chap-sql-server-aurora-mysql.management.linkedservers.md "chap-sql-server-aurora-mysql.management.linkedservers.md").
...
For more information, see [Views](chap-sql-server-aurora-mysql.sql.views.md "chap-sql-server-aurora-mysql.sql.views.md").
