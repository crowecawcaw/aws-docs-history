...
SQL Server Agent supports running PowerShell scripts in job steps. For more information, see [SQL Server Agent and MySQL Agent](chap-sql-server-aurora-mysql.management.agent.md "chap-sql-server-aurora-mysql.management.agent.md").
...
You can also connect to individual database instances. For more information, see [High Availability Essentials](chap-sql-server-aurora-mysql.hadr.essentials.md "chap-sql-server-aurora-mysql.hadr.essentials.md"). 3. In the command shell, enter the following:
