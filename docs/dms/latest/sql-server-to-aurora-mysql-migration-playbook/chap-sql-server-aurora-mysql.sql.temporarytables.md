...
<a name="chap-sql-server-aurora-mysql.sql.temporarytables"></a>
...
| --- | --- | --- | --- | 
|  ![Three star feature compatibility](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-compatibility-3.png)  |  ![Three star automation level](https://docs.aws.amazon.com/dms/latest/sql-server-to-aurora-mysql-migration-playbook/images/pb-automation-3.png)  | N/A | N/A | 

## SQL Server Usage
<a name="chap-sql-server-aurora-mysql.sql.temporarytables.sqlserver"></a>
...
## MySQL Usage
<a name="chap-sql-server-aurora-mysql.sql.temporarytables.mysql"></a>
...
### Examples
<a name="chap-sql-server-aurora-mysql.sql.temporarytables.mysql.examples"></a>
...
## Summary
<a name="chap-sql-server-aurora-mysql.sql.temporarytables.summary"></a>
