...
Security for Amazon WorkSpaces Core Bundles is same as Amazon WorkSpaces. For more information on WorkSpaces Core
Bundles security guidelines, please refer to [Security in Amazon WorkSpaces](../../../workspaces/latest/adminguide/security.md "../../../workspaces/latest/adminguide/security.md")
