...
**Topics**
+ [Shared responsibilities with Amazon WorkSpaces Core](#shared-responsibilities)
+ [Amazon WorkSpaces Core responsibilities](#core-responsibilities)
+ [Customer and partner responsibilities](#customer-responsibilities)

## Shared responsibilities with Amazon WorkSpaces Core
<a name="shared-responsibilities"></a>
...
<a name="core-responsibilities"></a>

The following responsibilities belong to Amazon WorkSpaces Core:
+ Infrastructure security. 
+ Encryption at rest (which must be enabled) for Amazon WorkSpaces Core bundles. For more information, see [Encrypted WorkSpaces](https://docs.aws.amazon.com/workspaces/latest/adminguide/encrypt-workspaces.html) in the *Amazon WorkSpaces Administration Guide*.
