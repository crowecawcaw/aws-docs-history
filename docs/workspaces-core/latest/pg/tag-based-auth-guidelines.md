...
| [TerminateWorkSpaces](../../../workspaces/latest/api/API_TerminateWorkspaces.md "../../../workspaces/latest/api/API_TerminateWorkspaces.md") | TagKeys + RequestTag  | JSON `` `{ "Version":"2012-10-17", "Statement": [ { "Effect": "Allow", "Action": [ "workspaces:TerminateWorkspaces" ], "Resource": "*", "Condition": { "StringEquals": { "aws:ResourceTag/PartnerManaged": "true" }, "ForAllValues:StringEquals" : { "aws:TagKeys": "PartnerManaged" } } } ] }` `` | With this policy, you can only terminate a workspace if the workspace has a tag key "PartnerManaged" and value "true".       |
