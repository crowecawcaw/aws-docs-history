...
**Topics**
+ [Adding or removing a notification hub in AWS User Notifications](nhr-add-remove.md)
+ [Enabling or disabling opt-in Regions in AWS User Notifications](nhr-optin-out.md)