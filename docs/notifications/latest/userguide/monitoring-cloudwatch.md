...
You can see a detailed view of User Notifications metrics in the CloudWatch console. You can tailor your view in the CloudWatch console to suit your needs. For more information about CloudWatch, see the [Amazon CloudWatch User Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html).
