...
| Metric                   | Description                                     |
| ------------------------ | ----------------------------------------------- |
| `ServiceEventsThrottled` | The number of throttled events.<br>Units: Count |
...
You can view metrics in the CloudWatch console. The console provides a fine-grained and
customizable display of your resources, as well as the number of running tasks in a
service.

### Viewing User Notifications metrics in the CloudWatch console

You can see a detailed view of User Notifications metrics in the CloudWatch console. You can tailor your
view in the CloudWatch console to suit your needs. For more information about CloudWatch, see the
