...
- ** Managed Notification Configuration **
  ...
  - **API action:** UpdateManagedNotificationChannelAssociation / **Resource ARN format:** `arn:aws:notifications::{{accountId}}:managed-notification-configuration/category/{{category-name}}/sub-category/{{sub-category-name}}` / **Example:** `arn:aws:notifications::123456789012:managed-notification-configuration/category/AWS-BCM/sub-category/Billing-and-Invoices`
  - **API action:** SubscribeSensitiveEvents / **Resource ARN format:** `arn:aws:notifications::{{accountId}}:managed-notification-configuration/category/{{category-name}}/sub-category/{{sub-category-name}}` / **Example:** `arn:aws:notifications::123456789012:managed-notification-configuration/category/AWS-BCM/sub-category/Billing-and-Invoices`
  - **API action:** AccessSensitiveEvents / **Resource ARN format:** `arn:aws:notifications::{{accountId}}:managed-notification-configuration/category/{{category-name}}/sub-category/{{sub-category-name}}` / **Example:** `arn:aws:notifications::123456789012:managed-notification-configuration/category/AWS-BCM/sub-category/Billing-and-Invoices`
