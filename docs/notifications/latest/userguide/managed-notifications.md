...
+ **AWS Billing and Cost Management** – Notifications about your billing, payment, and account activity
...
For AWS Health, you can aggregate managed notifications across accounts within the same organization to reduce the total number of notifications you receive. For more information, see [Aggregating and deduplicating AWS managed notifications in User Notifications](managed-notification-aggregation.md). 
...
+ [Manage AWS Billing and Cost Management notifications in AWS User Notifications](managed-notifications-bcm.md).

**Topics**
+ [Supported services](supported-services.md)
+ [Features](managed-notification-features.md)