...
- [Request syntax](#update-cluster-request "#update-cluster-request")
- [Request body](#update-cluster-request-body "#update-cluster-request-body")
- [Response syntax](#update-cluster-response "#update-cluster-response")
- [Response body](#update-cluster-response-body "#update-cluster-response-body")
- [Example](#update-cluster-example "#update-cluster-example")
...
If set to `true`, only perform request validation without creating any resource.
Use this parameter to validate the cluster configuration and update requirements. The default is `false`.
...
Example valid values: `currentValue`, `requestedValue`,
`message`
...
A list of messages with a validation level lower than `validationFailureLevel`. The list of messages is collected during
