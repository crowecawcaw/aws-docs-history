...
- [Request syntax](#list-images-request "#list-images-request")
- [Request body](#list-images-request-body "#list-images-request-body")
- [Response syntax](#list-images-response "#list-images-response")
- [Response body](#list-images-response-body "#list-images-response-body")
- [Example](#list-images-example "#list-images-example")
