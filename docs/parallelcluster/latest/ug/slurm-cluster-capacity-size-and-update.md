...
and the maximum number of instances the compute resource can scale to ([MaxCount3](Scheduling-v3.md#yaml-Scheduling-SlurmQueues-ComputeResources-MaxCount "Scheduling-v3.md#yaml-Scheduling-SlurmQueues-ComputeResources-MaxCount") ).
...
- When removing a queue from `Scheduling/SlurmQueues`
  all the compute nodes with name
