...
- [Request syntax](#delete-cluster-request "#delete-cluster-request")
- [Request body](#delete-cluster-request-body "#delete-cluster-request-body")
- [Response syntax](#delete-cluster-response "#delete-cluster-response")
- [Response body](#delete-cluster-response-body "#delete-cluster-response-body")
- [Example](#delete-cluster-example "#delete-cluster-example")
