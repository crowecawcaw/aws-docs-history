...
Specifies the name of the log stream. You can use the `list-image-log-streams` command
...
example `2021-01-01T20:00:00Z`). Events with a timestamp equal to or later than this time are
included.
