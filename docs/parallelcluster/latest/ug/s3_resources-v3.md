...
The following example configures read-only access to all objects in {{firstbucket/read\_only/}} and read/write access to all objects in `{{secondbucket/read_and_write/}}`.
