...
† AWS ParallelCluster only supports mounting existing Amazon FSx for NetApp ONTAP, Amazon FSx for OpenZFS, and File Cache systems. It doesn't support the
creation of new FSx for ONTAP, FSx for OpenZFS, and File Cache systems.
