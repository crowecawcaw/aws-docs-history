...
**Topics**
+ [Cluster capacity size and update](#cluster-capacity-size-and-update)
+ [Cluster capacity update](#cluster-capacity-update)
+ [Considerations and limitations](#considerations-limitations)
+ [Impacts on the Jobs](#impacts-on-jobs)
+ [Cluster update process on capacity changes](#cluster-update-process)
+ [Supported cluster and SLURM versions](#cluster-slurm-version-table)
...
+ [Cluster scaling for dynamic nodes](scheduler-node-allocation-v3.md)
...
+ [Cluster capacity size and update](slurm-cluster-capacity-size-and-update.md)