...
- [Request syntax](#build-image-request "#build-image-request")
- [Request body](#build-image-request-body "#build-image-request-body")
- [Response syntax](#build-image-response "#build-image-response")
- [Response body](#build-image-response-body "#build-image-response-body")
- [Example](#build-image-example "#build-image-example")
...
If set to `true`, only perform request validation without creating
any resource. Use this parameter to validate the image configuration. The default
is `false`.
...
If set to `true`, image stack rollback occurs if the image fails
to create. The default is `false`.
