...
1. Log in to the AWS Management Console, and then navigate to the [Amazon CloudWatch](https://console.aws.amazon.com/cloudwatch/) console on the AWS account that the PCUI is on.
