...
- [Request syntax](#list-clusters-request "#list-clusters-request")
- [Request body](#list-clusters-request-body "#list-clusters-request-body")
- [Response syntax](#list-clusters-response "#list-clusters-response")
- [Response body](#list-clusters-response-body "#list-clusters-response-body")
- [Example](#list-clusters-example "#list-clusters-example")
