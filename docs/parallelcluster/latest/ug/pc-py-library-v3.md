...
`s3://`aws-region-id`-aws-parallelcluster/parallelcluster/`3.15.0`/layers/aws-parallelcluster/lambda-layer.zip`.
(Replace `3.15.0` with the AWS ParallelCluster version you want to use in
the following step.)
...
4. Enter the URL to the zip file: s3://`aws-region-id`-aws-parallelcluster/parallelcluster/`3.15.0`/layers/aws-parallelcluster/lambda-layer.zip.
