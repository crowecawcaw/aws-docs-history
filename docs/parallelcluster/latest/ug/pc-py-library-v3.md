...
`s3://`aws-region-id`-aws-parallelcluster/parallelcluster/`3.14.2`/layers/aws-parallelcluster/lambda-layer.zip`.
(Replace `3.14.2` with the AWS ParallelCluster version you want to use in
the following step.)
...
4. Enter the URL to the zip file: s3://`aws-region-id`-aws-parallelcluster/parallelcluster/`3.14.2`/layers/aws-parallelcluster/lambda-layer.zip.
