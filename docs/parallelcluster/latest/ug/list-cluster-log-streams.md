...
- [Request syntax](#list-cluster-log-streams-request "#list-cluster-log-streams-request")
- [Request body](#list-cluster-log-streams-request-body "#list-cluster-log-streams-request-body")
- [Response syntax](#list-cluster-log-streams-response "#list-cluster-log-streams-response")
- [Response body](#list-cluster-log-streams-response-body "#list-cluster-log-streams-response-body")
- [Example](#list-cluster-log-streams-example "#list-cluster-log-streams-example")
...
- private-dns-name: The short form of the private DNS name of the instance (e.g.
  ip-10-0-0-101).
...
The time of the last event of the stream. The lastEventTime value updates on
an eventual consistency basis. It typically updates in less than an hour from
