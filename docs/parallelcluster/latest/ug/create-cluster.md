...
- [Request syntax](#create-cluster-request "#create-cluster-request")
- [Request body](#create-cluster-request-body "#create-cluster-request-body")
- [Response syntax](#create-cluster-response "#create-cluster-response")
- [Response body](#create-cluster-response-body "#create-cluster-response-body")
- [Example](#create-cluster-example "#create-cluster-example")
...
The name must start with an alphabetical character. The name can have up
to 60 characters. If Slurm accounting is enabled, the name can have up to
40 characters.
...
If set to `true`, only perform request validation but do not create
any resource. Use this parameter to validate the cluster configuration. The default
is `false`.
...
If set to `true`, cluster stack rollback occurs if the cluster fails
to create. The default is `true`.
...
The minimum validation level that causes cluster create to fail. The default
is `ERROR`.
