...
- **CI/CD for serverless:** You can build deployment pipelines using SAM templates that automatically generate the CloudFormation
  infrastructure needed for staging and production environments.
- **Migration from console-created resources:** You can convert Lambda functions and API Gateway resources created in the AWS
  Management Console into infrastructure as code using SAM templates.
...
more information, see [AWS SAM CLI](using-sam-cli.md "using-sam-cli.md").
...
information, see [Introduction to using sam sync to sync to AWS Cloud](using-sam-cli-sync.md "using-sam-cli-sync.md").
...
layers. For more information, see [AWS SAM CLI Terraform support](terraform-support.md "terraform-support.md").
