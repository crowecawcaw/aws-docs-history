...
For more information, see [What is Amazon EventBridge Scheduler?](../../../scheduler/latest/UserGuide/what-is-scheduler.md "../../../scheduler/latest/UserGuide/what-is-scheduler.md") in
...
The scheduling expression that determines when and how often the scheduler schedule
event runs.
