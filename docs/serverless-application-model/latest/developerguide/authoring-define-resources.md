...
| [AWS::Serverless::Connector](sam-resource-connector.md "sam-resource-connector.md")          | Configures permissions between two resources. For an introduction to connectors, see [Managing resource permissions with AWS SAM<br>connectors](managing-permissions-connectors.md "managing-permissions-connectors.md").                      |
