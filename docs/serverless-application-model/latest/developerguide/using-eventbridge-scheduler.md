...
- [EventBridge Scheduler support in AWS SAM](#using-eventbridge-scheduler-sam-support "#using-eventbridge-scheduler-sam-support")
- [Creating EventBridge Scheduler events in AWS SAM](#using-eventbridge-scheduler-sam-create "#using-eventbridge-scheduler-sam-create")
