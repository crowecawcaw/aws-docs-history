...
**Topics**
+ [Using CloudWatch Application Insights to monitor your AWS SAM serverless applications](monitor-app-insights.md)
+ [Working with logs in AWS SAM](serverless-sam-cli-logging.md)