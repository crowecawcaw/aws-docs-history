...
The name of the schedule. If you don't specify a name, AWS SAM generates a name in the format `{{StateMachine-Logical-ID}}{{Event-Source-Name}}` and uses that ID for the schedule name.  
*Type*: String  
*Required*: No  
