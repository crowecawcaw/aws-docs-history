...
- [Prerequisites](#building-python-uv-prerequisites "#building-python-uv-prerequisites")
- [Configuring AWS SAM to use with Python Lambda functions and uv](#building-python-uv-configure "#building-python-uv-configure")
- [Examples](#building-python-uv-examples "#building-python-uv-examples")

## Prerequisites

**Python**

To install Python, see [Download Python](https://www.python.org/downloads/ "https://www.python.org/downloads/") in the _Python website_.

**uv**

The AWS SAM CLI requires installation of [uv](https://docs.astral.sh/uv/ "https://docs.astral.sh/uv/"), an extremely fast Python package installer and resolver. For installation instructions, see [Installation](https://docs.astral.sh/uv/getting-started/installation/ "https://docs.astral.sh/uv/getting-started/installation/") in the _uv documentation_.
...
**In this example, we build a sample Hello World application using Python
