...
+ [Step 5: Interact with your function in the AWS Cloud](#serverless-getting-started-hello-world-remote-invoke)
+ [Step 6: Modify and sync your application to the AWS Cloud](#serverless-getting-started-hello-world-sync)
+ [Step 7: (Optional) Test your application locally](#serverless-getting-started-hello-world-test)
+ [Step 8: Delete your application from the AWS Cloud](#serverless-getting-started-hello-world-delete)
...
**Note**  
This step requires AWS credentials configuration. For more information, see [Step 2: Use the AWS CLI to configure AWS credentials](prerequisites.md#prerequisites-configure-credentials) in [AWS SAM prerequisites](prerequisites.md).
