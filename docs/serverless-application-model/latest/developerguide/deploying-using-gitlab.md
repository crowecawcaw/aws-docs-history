...
To configure your [GitLab](https://about.gitlab.com "https://about.gitlab.com") pipeline to automate
the build and deployment of your AWS SAM application, your `gitlab-ci.yml` file
must contain lines that do the following:
