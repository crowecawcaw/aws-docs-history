...
1. [Develop your application](chapter-create-application.md) (this includes initializing your application, defining your resources, and building your application).

1. [Test your application](serverless-test-and-debug.md).

1. [Debug your application](debug-application.md).

1. [Deploy your application and resources](serverless-deploying.md).

1. [Monitor your application](serverless-monitoring.md).

AWS SAM creates your AWS SAM project after you run the **sam init** command and complete its subsequent workflow. You define your serverless application by adding code to your AWS SAM project. While your AWS SAM project consists of a set of files and folders, the most important file in it is your AWS SAM template (named `template.yaml`). In this template, you write your code to express resources, event source mappings, and other properties that define your serverless application.
