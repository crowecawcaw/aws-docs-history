...
- [Applying migration rules in AWS Schema Conversion Tool](CHAP_Converting.MigrationRules.md "CHAP_Converting.MigrationRules.md")
- [Converting schemas using AWS SCT](CHAP_Converting.Convert.md "CHAP_Converting.Convert.md")
- [Manually converting schemas in AWS SCT](CHAP_Converting.Manual.md "CHAP_Converting.Manual.md")
...
- [Comparing schemas in AWS Schema Conversion Tool](CHAP_Converting.SchemaCompare.md "CHAP_Converting.SchemaCompare.md")
- [Viewing related transformed objects in AWS Schema Conversion Tool](CHAP_Converting.RelatedObjects.md "CHAP_Converting.RelatedObjects.md")
...
For information about converting a data warehouse schema, see [Converting data warehouse schemas to Amazon RDS using AWS SCT](CHAP_Converting.DW.md "CHAP_Converting.DW.md").

To convert your database schema to Amazon RDS, you take the following high-level steps:

- [Creating migration rules in AWS SCT](CHAP_Converting.MigrationRules.md "CHAP_Converting.MigrationRules.md") –
...
- [Converting schemas using AWS SCT](CHAP_Converting.Manual.md "CHAP_Converting.Manual.md") –
