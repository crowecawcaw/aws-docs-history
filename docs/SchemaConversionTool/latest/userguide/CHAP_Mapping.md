...
[Applying migration rules](CHAP_Converting.MigrationRules.md "CHAP_Converting.MigrationRules.md").
...
- [Mapping new data types in the AWS Schema Conversion Tool](CHAP_Mapping.New.md "CHAP_Mapping.New.md")
- [Editing data type mappings in the AWS Schema Conversion Tool](CHAP_Mapping.Edit.md "CHAP_Mapping.Edit.md")
- [Mapping to virtual targets in the AWS Schema Conversion Tool](CHAP_Mapping.VirtualTargets.md "CHAP_Mapping.VirtualTargets.md")
- [Limitations of data type mapping in the AWS Schema Conversion Tool](CHAP_Mapping.Limitations.md "CHAP_Mapping.Limitations.md")
