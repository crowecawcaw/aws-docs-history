...
(as shown in [Converting schemas using AWS SCT](CHAP_Converting.Convert.md "CHAP_Converting.Convert.md")), it doesn't immediately apply
...
[Using the AWS Lambda functions from the AWS SCT extension pack](CHAP_ExtensionPack.md#CHAP_ExtensionPack.OLTP "CHAP_ExtensionPack.md#CHAP_ExtensionPack.OLTP").
