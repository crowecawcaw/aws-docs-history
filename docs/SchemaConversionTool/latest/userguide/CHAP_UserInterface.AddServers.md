...
1.  Choose a database platform and specify database connection credentials. For more information on connecting to a source database, see [Connecting to source databases with the AWS Schema Conversion Tool](CHAP_Source.md). 
