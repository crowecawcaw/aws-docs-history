...
1.  Choose **AWS Glue** and complete the following: 
   ...
   + **Amazon S3 bucket folder** – Enter the folder path for the Amazon S3 bucket that you plan to use.
    ...
    You can use a virtual AWS Glue target. In this case, you don't need to specify the connection credentials. For more information, see [Mapping to virtual targets in the AWS Schema Conversion Tool](CHAP_Mapping.VirtualTargets.md). 

1. Create a new mapping rule that includes your source SSIS package and your AWS Glue target. For more information, see [Mapping new data types in the AWS Schema Conversion Tool](CHAP_Mapping.New.md). 
