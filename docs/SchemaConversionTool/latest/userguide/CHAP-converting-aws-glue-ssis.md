...
11. Choose **Apply**.
12. Convert your package. In the source tree view,
    find **Packages**. Open the
    context (right-click) menu for your package, then choose
    **Convert package**.
13. Save the converted script to Amazon S3. In the target tree view,
    find **Package scripts**. Open the context (right-click) menu
    for your converted script, then choose **Save to S3**.
14. Configure your AWS Glue job. In the target tree view,
    find **Package scripts**. Open the context (right-click) menu
