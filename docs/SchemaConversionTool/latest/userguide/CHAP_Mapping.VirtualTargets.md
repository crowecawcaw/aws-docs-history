...
you create a mapping rule. For more information, see [Mapping new data types in the AWS Schema Conversion Tool](CHAP_Mapping.New.md "CHAP_Mapping.New.md"). Make sure that you expand the
...
For more information, see [Saving your converted schema to a file](CHAP_Converting.SaveAndApply.md#CHAP_Converting.Saving "CHAP_Converting.SaveAndApply.md#CHAP_Converting.Saving").
