...
for use with the target database or data warehouse, see details in the following.

###### Topics

- [Connecting Amazon Redshift with the AWS Schema Conversion Tool](CHAP_Source.md "CHAP_Source.md")
- [Connecting Azure Synapse Analytics with AWS Schema Conversion Tool](CHAP_Source.md "CHAP_Source.md")
- [Connecting to Google BigQuery with AWS Schema Conversion Tool](CHAP_Source.md "CHAP_Source.md")
- [Connecting Greenplum Database with AWS Schema Conversion Tool](CHAP_Source.md "CHAP_Source.md")
- [Connecting to Netezza with AWS Schema Conversion Tool](CHAP_Source.md "CHAP_Source.md")
