...
- [Converting SQL code in your applications with AWS SCT](CHAP_Converting.App.Generic.md "CHAP_Converting.App.Generic.md")
- [Converting SQL code in C# applications with AWS Schema Conversion Tool](CHAP_Converting.App.Csharp.md "CHAP_Converting.App.Csharp.md")
- [Converting SQL code in C++ applications with AWS Schema Conversion Tool](CHAP_Converting.App.Cplusplus.md "CHAP_Converting.App.Cplusplus.md")
- [Converting SQL code in Java applications with AWS Schema Conversion Tool](CHAP_Converting.App.Java.md "CHAP_Converting.App.Java.md")
- [Converting SQL code in Pro\*C applications with AWS Schema Conversion Tool](CHAP_Converting.App.ProC.md "CHAP_Converting.App.ProC.md")
...
- **Create an application conversion project**
  ...
  child application conversion projects. For more information, see [Creating generic application conversion projects in AWS SCT](CHAP_Converting.App.Generic.md#CHAP_Converting.App.Project "CHAP_Converting.App.Generic.md#CHAP_Converting.App.Project").
- **Analyze and convert your SQL code** –
  ...
  [Analyzing and converting your SQL code in AWS SCT](CHAP_Converting.App.Generic.md#CHAP_Converting.App.Convert "CHAP_Converting.App.Generic.md#CHAP_Converting.App.Convert").
- **Create an application assessment report**
  ...
  your target database schema. For more information, see [Creating and using the AWS SCT assessment report in AWS SCT](CHAP_Converting.App.Generic.md#CHAP_Converting.App.AssessmentReport "CHAP_Converting.App.Generic.md#CHAP_Converting.App.AssessmentReport").
- **Edit, apply changes to, and save your converted SQL
  ...
  SQL code manually to perform the conversion. For more information, see [Editing and saving your converted SQL code with AWS SCT](CHAP_Converting.App.Generic.md#CHAP_Converting.App.Edit "CHAP_Converting.App.Generic.md#CHAP_Converting.App.Edit").
