...
SQL code converters. For more information, see [SQL code in C# applications](CHAP_Converting.App.Csharp.md "CHAP_Converting.App.Csharp.md"), [SQL code in Java](CHAP_Converting.App.Java.md "CHAP_Converting.App.Java.md"), and [SQL code in Pro\*C](CHAP_Converting.App.ProC.md "CHAP_Converting.App.ProC.md").
