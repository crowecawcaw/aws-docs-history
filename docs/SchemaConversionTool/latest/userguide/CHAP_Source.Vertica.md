...
<tbody>
  ...
  <tr><td><b>Database</b></td><td>Enter the name of the Vertica database.</td></tr>
  ...
  <tr><td><b>Use SSL</b></td><td>Choose this option to use Secure Sockets Layer (SSL) to connect to your database. Provide the following additional information, as applicable, on the <b>SSL</b> tab:<ul><li> <b>Verify server certificate</b>: Choose this option to verify the server certificate by using a trust store.  </li><li> <b>Trust store</b>: A trust store that you set up in the <b>Global settings</b>.  </li><li> <b>Key store</b>: A key store that you set up in the <b>Global settings</b>. </li></ul></td></tr>
