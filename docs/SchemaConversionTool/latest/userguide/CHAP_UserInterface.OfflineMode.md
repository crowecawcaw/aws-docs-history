...
1. Start the AWS Schema Conversion Tool and create a new project. For more information, see [Starting and managing Projects in AWS SCT](CHAP_UserInterface.Project.md "CHAP_UserInterface.Project.md").
2. Add a source database server and connect to your source database. For more information,
   see [Adding servers to project in AWS SCT](CHAP_UserInterface.AddServers.md "CHAP_UserInterface.AddServers.md").
3. Add a target database server or use a virtual target database platform. For more information,
   see [Mapping to virtual targets in the AWS Schema Conversion Tool](CHAP_Mapping.VirtualTargets.md "CHAP_Mapping.VirtualTargets.md").
