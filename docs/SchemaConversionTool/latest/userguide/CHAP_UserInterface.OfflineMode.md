...
1. Start the AWS Schema Conversion Tool and create a new project. For more information, see [Starting and managing Projects in AWS SCT](CHAP_UserInterface.Project.md).

1. Add a source database server and connect to your source database. For more information, see [Adding servers to project in AWS SCT](CHAP_UserInterface.AddServers.md).

1. Add a target database server or use a virtual target database platform. For more information, see [Mapping to virtual targets in the AWS Schema Conversion Tool](CHAP_Mapping.VirtualTargets.md).

1. Create a mapping rule to define the target database platform for your source database. For more information, see [Mapping data types in the AWS Schema Conversion Tool](CHAP_Mapping.md).
