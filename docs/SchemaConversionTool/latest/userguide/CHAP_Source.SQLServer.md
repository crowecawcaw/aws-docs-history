...
- [Converting SQL Server to MySQL](CHAP_Source.SQLServer.ToMySQL.md "CHAP_Source.SQLServer.ToMySQL.md")
- [Migrating from SQL Server to PostgreSQL with AWS Schema Conversion Tool](CHAP_Source.SQLServer.ToPostgreSQL.md "CHAP_Source.SQLServer.ToPostgreSQL.md")
- [Migrating from SQL Server to Amazon RDS for SQL Server with AWS Schema Conversion Tool](CHAP_Source.SQLServer.ToRDSSQLServer.md "CHAP_Source.SQLServer.ToRDSSQLServer.md")
...
[Adding a user to the SQLAgentUser role](../../../AmazonRDS/latest/UserGuide/Appendix.SQLServer.CommonDBATasks.Agent.md#SQLServerAgent.AddUser "../../../AmazonRDS/latest/UserGuide/Appendix.SQLServer.CommonDBATasks.Agent.md#SQLServerAgent.AddUser") in the
