...
Amazon RDS for Oracle DB instance:
    ...
    [Settings for Oracle DB instances](../../../AmazonRDS/latest/UserGuide/USER_ModifyInstance.Oracle.md#USER_ModifyInstance.Oracle.Settings "../../../AmazonRDS/latest/UserGuide/USER_ModifyInstance.Oracle.md#USER_ModifyInstance.Oracle.Settings").
    + If your DB instance is version 11.2.0.4.v10 or higher, you must
     install the XMLDB option. For more information, see


    [Oracle XML DB](../../../AmazonRDS/latest/UserGuide/Appendix.Oracle.Options.XMLDB.md "../../../AmazonRDS/latest/UserGuide/Appendix.Oracle.Options.XMLDB.md").
...
[Amazon RDS documentation](../../../AmazonRDS/latest/UserGuide/Appendix.Oracle.CommonDBATasks.Database.md#Appendix.Oracle.CommonDBATasks.DBLinks "../../../AmazonRDS/latest/UserGuide/Appendix.Oracle.CommonDBATasks.Database.md#Appendix.Oracle.CommonDBATasks.DBLinks").
