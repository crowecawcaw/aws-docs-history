...
## Syntax
<a name="remote-inventory-syntax"></a>
...
<a name="remote-inventory-parameters"></a>Parameters
...
Information about the Java processes, .NET applications, or IIS websites is saved to `inventory.json`file in one of the following locations:
