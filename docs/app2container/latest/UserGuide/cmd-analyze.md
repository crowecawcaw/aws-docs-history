...
<a name="analyze-parameters"></a>Parameters
...
+ **Windows: **`C:\Users\Administrator\AppData\Local\.app2container-config\inventory.json`Options

**--help**  
Displays the command help.

## Output
<a name="analyze-output"></a>
...
√ Created artifacts folder C:\Users\Administrator\AppData\Local\app2container\iis-smarts-51d2dbf8
