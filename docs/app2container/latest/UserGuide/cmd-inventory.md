...
<a name="inventory-parameters"></a>Parameters
...
+ For .NET applications running on Linux, you must specify `dotnet`.Options
...
### Linux examples
<a name="inventory-examples-linux"></a>
...
### Windows examples
<a name="inventory-examples-windows"></a>
