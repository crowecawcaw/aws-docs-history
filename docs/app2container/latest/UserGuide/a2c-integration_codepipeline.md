...
<a name="a2c-integration_codepipeline"></a>
...
**Topics**
+ [Validation](#integrations-codepipeline-workflow-validation)
+ [Output](#integrations-codepipeline-workflow-output)

## Validation
<a name="integrations-codepipeline-workflow-validation"></a>
...
## Output
<a name="integrations-codepipeline-workflow-output"></a>
