...
## Syntax
<a name="remote-configure-syntax"></a>
...
<a name="remote-configure-parameters"></a>Parameters

**--input-json**  
Uses the provided JSON file as input to configure connections to application servers for the worker machine to run remote commands.Options

**--help**  
Displays the command help.

## Input
<a name="remote-inventory-input"></a>
...
<a name="remote-hosts-json-linux"></a>
...
<a name="remote-hosts-json-windows"></a>
...
## Output
<a name="remote-inventory-output"></a>
...
## Examples
<a name="remote-inventory-examples"></a>
