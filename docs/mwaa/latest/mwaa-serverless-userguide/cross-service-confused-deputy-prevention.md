...
policies to limit the permissions that Amazon MWAA Serverless gives another service to the
...
`arn:aws:`airflow-serverless`:*:`123456789012`:*`.
...
`aws:SourceAccount` global condition context keys in Amazon MWAA Serverless to prevent
