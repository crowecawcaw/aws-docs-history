...
<a name="log-apis-with-cloudtrail"></a>
 ...
 To learn more about AWS CloudTrail, including how to configure and enable it, see the [AWS CloudTrail User Guide](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html). 

## Data encryption
<a name="mwaa-info-in-ct"></a>
...
**Topics**
+ [Creating a trail in CloudTrail](#trail-in-cloudtrail)
+ [Accessing events with CloudTrail Event History](#access-events-history)
+ [Accessing events with CloudTrail Event History](#example-create-workflow-trail)

### Creating a trail in CloudTrail
<a name="trail-in-cloudtrail"></a>
...
<a name="access-events-history"></a>
...
1.  Open the [AWS CloudTrail console](https://console.aws.amazon.com/cloudtrail/home). 
