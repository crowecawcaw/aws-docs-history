...
security-sensitive organizations. Security is a shared responsibility between AWS and you. The [shared responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/")
...
To learn about the compliance programs that apply to Amazon MWAA Serverless, refer to
...
using Amazon MWAA Serverless. The following topics show you how to configure Amazon MWAA Serverless to meet your
security and compliance objectives. You also learn how to use other AWS services that help you
to monitor and secure your Amazon MWAA Serverless resources.

###### Topics

- [Data protection in Amazon MWAA Serverless](data-protection.md "data-protection.md")
- [Identity and access management for Amazon MWAA Serverless](security-iam.md "security-iam.md")
