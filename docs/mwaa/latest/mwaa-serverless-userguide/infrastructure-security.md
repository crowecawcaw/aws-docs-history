...
To design your workflows using the best practices for infrastructure security, see [Infrastructure Protectiony](../../../wellarchitected/latest/security-pillar/infrastructure-protection.html).md "../../../wellarchitected/latest/security-pillar/infrastructure-protection.html).md") in Security Pillar AWS Well‐Architected Framework.
