...
**Note**  
If your security requirements do not allow granting `ec2:CreateVpcEndpoint` to end users, you can use customer-managed endpoints instead. For more information, see [Managing your own Amazon VPC endpoints on Amazon MWAA](vpc-endpoint-management.md).
