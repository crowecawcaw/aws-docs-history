...
![This image displays the architecture for an Amazon MWAA environment with a public webserver.](images/mwaa-public-web-server.png)
...
![This image depicts where to find the Public network option on the Amazon MWAA console.](images/mwaa-console-public-network-2026.png)
...
![This image depicts where to find the Both public and private network option on the Amazon MWAA console.](images/mwaa-console-public-private-network-2026.png)
