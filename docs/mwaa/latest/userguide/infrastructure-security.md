...
As a managed service, Amazon Managed Workflows for Apache Airflow is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon MWAA through the network. Clients must
