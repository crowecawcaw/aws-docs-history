...
+ [Accessing Apache Airflow logs](#monitoring-airflow-view)
...
+ Standard CloudWatch Logs charges apply. For more information, refer to [CloudWatch pricing](http://aws.amazon.com/cloudwatch/pricing/).

## Before you begin
<a name="monitoring-airflow-before"></a>
+ You must have a role that can access logs in CloudWatch. For more information, refer to [Accessing an Amazon MWAA environment](access-policies.md).
...
1. Review the list of packages and whether any of these encountered an error during installation. If something went wrong, you might get an error similar to the following:
...
+ Learn how to configure a CloudWatch alarm in [Using Amazon CloudWatch alarms](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/AlarmThatSendsEmail.html).
