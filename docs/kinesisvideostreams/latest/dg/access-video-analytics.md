...
<a name="access-video-analytics"></a>

This section contains information about how to access video analytics using the parser library and Amazon CloudWatch.

**Topics**
+ [Consume metadata embedded in a Kinesis video stream](how-meta-consume.md)
+ [Watch output from cameras using parser library](parser-library.md)
+ [Monitoring Amazon Kinesis Video Streams](monitoring.md)
+ [Streaming metadata limits](#how-meta-limits)
