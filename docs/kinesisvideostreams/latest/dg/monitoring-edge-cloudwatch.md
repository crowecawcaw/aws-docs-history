...
| Stream name                  | PercentageSpaceUsed                                                                                                                                     | This is the percentage used out of the total space allocated in Amazon Kinesis Video Streams Edge Agent configurations for recording media. See [LocalSizeConfig](../APIReference/API_LocalSizeConfig.md "../APIReference/API_LocalSizeConfig.md") for more information.<br>Units: Percentage (scale 0–1). |
...
To have the agent reattempt a fatally-errored job, use [StartEdgeConfigurationUpdate](../APIReference/API_StartEdgeConfigurationUpdate.md "../APIReference/API_StartEdgeConfigurationUpdate.md").
