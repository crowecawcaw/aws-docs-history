...
[GStreamer](https://gstreamer.freedesktop.org/ "https://gstreamer.freedesktop.org/") is a popular media framework used by
...
container, see [Run the GStreamer element in a Docker container](examples-gstreamer-plugin.md#examples-gstreamer-plugin-docker "examples-gstreamer-plugin.md#examples-gstreamer-plugin-docker").
