...
- The video track of each fragment must contain codec private data in the
  ...
  14496-15](https://www.iso.org/standard/55980.html "https://www.iso.org/standard/55980.html")). For information about adapting stream data to a given
  format, see [NAL Adaptation Flags](producer-reference-nal.md "producer-reference-nal.md").
- The audio track (if present) of each fragment must contain codec private data
  in the AAC format ([AAC
  specification ISO/IEC 13818-7](https://www.iso.org/standard/43345.html "https://www.iso.org/standard/43345.html")).
  ...
  [HLS
  specification](https://tools.ietf.org/html/draft-pantos-http-live-streaming-23 "https://tools.ietf.org/html/draft-pantos-http-live-streaming-23").

The following procedure shows how to use HLS with Kinesis Video Streams:

1. Call the `GetDataEndpoint` API to get an endpoint. Then send the
   `GetHLSStreamingSessionURL` requests to this endpoint using the
   [--endpoint-url parameter](../../../cli/latest/reference.md "../../../cli/latest/reference.md").
2. Retrieve the HLS URL using `GetHLSStreamingSessionURL`. Kinesis
   ...
   session's HLS _master playlist_ (the root resource needed for
   streaming with HLS).
...
outside the requested window or alternate bitrates) is made available. 3. Provide the URL (containing the encrypted session token) for the HLS master
...
frames or AAC-encoded audio samples. 4. The media player receives the authenticated URL and requests stream metadata
...
following actions:
    ...
    * **GetMP4MediaFragment:** Retrieves MP4
    ...
    The codec private data (CPD) contained in each fragment contains
     codec-specific initialization information, such as frame rate,
     resolution, and encoding profile, which are necessary for properly
     decoding the fragment. For both TS and MP4, CPD changes are
     supported during a streaming session. Therefore, the fragments in a
     session can have a different information in the CPD without
     interrupting playback. For each streaming session, only 500 CPD
     changes are allowed.


    ###### Important

    Track changes aren't supported. Tracks must remain consistent
     throughout the queried media. Streaming will fail if the fragments
     in the stream change from having only video to having both audio and
     video, or if an AAC audio track is changed to an A-Law audio
     track.


    Data retrieved with this action is billable. For information, see
     [Pricing](https://aws.amazon.com/kinesis/video-streams/pricing/ "https://aws.amazon.com/kinesis/video-streams/pricing/").
    * **GetTSFragment:** Retrieves MPEG TS
    ...
    Data retrieved with this action is billable. For more information, see
     [Kinesis Video Streams pricing](https://aws.amazon.com/kinesis/video-streams/pricing/ "https://aws.amazon.com/kinesis/video-streams/pricing/").
...
See the video playback examples in the documentation guide: [Use the AWS CLI to retrieve an HLS streaming session URL](hls-playback.md#retrieve-hls-url "hls-playback.md#retrieve-hls-url") and [Example: Use HLS in HTML and JavaScript](hls-playback.md#how-hls-ex1 "hls-playback.md#how-hls-ex1").
...
**[ContainerFormat](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[DiscontinuityMode](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
fragments (as is typical if [HLSFragmentSelector](API_reader_HLSFragmentSelector.md "API_reader_HLSFragmentSelector.md") is set to
...
The default is `ALWAYS` when [HLSFragmentSelector](API_reader_HLSFragmentSelector.md "API_reader_HLSFragmentSelector.md") is set
...
**[DisplayFragmentTimestamp](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
The default is `NEVER`. When [HLSFragmentSelector](API_reader_HLSFragmentSelector.md "API_reader_HLSFragmentSelector.md") is
`SERVER_TIMESTAMP`, the timestamps will be the server start timestamps.
Similarly, when [HLSFragmentSelector](API_reader_HLSFragmentSelector.md "API_reader_HLSFragmentSelector.md") is
...
**[Expires](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[HLSFragmentSelector](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
Type: [HLSFragmentSelector](API_reader_HLSFragmentSelector.md "API_reader_HLSFragmentSelector.md") object

Required: No

**[MaxMediaPlaylistFragmentResults](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[PlaybackMode](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[StreamARN](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[StreamName](#API_reader_GetHLSStreamingSessionURL_RequestSyntax "#API_reader_GetHLSStreamingSessionURL_RequestSyntax")**
...
**[HLSStreamingSessionURL](#API_reader_GetHLSStreamingSessionURL_ResponseSyntax "#API_reader_GetHLSStreamingSessionURL_ResponseSyntax")**
...
- [AWS Command Line Interface V2](../../../goto/cli2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/cli2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for .NET V4](../../../goto/DotNetSDKV4/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/DotNetSDKV4/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for C++](../../../goto/SdkForCpp/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForCpp/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for Go v2](../../../goto/SdkForGoV2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForGoV2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for Java V2](../../../goto/SdkForJavaV2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForJavaV2/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for JavaScript V3](../../../goto/SdkForJavaScriptV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForJavaScriptV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for Kotlin](../../../goto/SdkForKotlin/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForKotlin/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for PHP V3](../../../goto/SdkForPHPV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForPHPV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for Python](../../../goto/boto3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/boto3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
- [AWS SDK for Ruby V3](../../../goto/SdkForRubyV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md "../../../goto/SdkForRubyV3/kinesis-video-reader-data-2017-09-30/GetHLSStreamingSessionURL.md")
