...
![Catalog type in the lakehouse architecture](https://docs.aws.amazon.com/sagemaker-lakehouse-architecture/latest/userguide/images/lakehouse/catalog-type.png)
...
![How catalogs, databases, tables/views work in the lakehouse architecture](https://docs.aws.amazon.com/sagemaker-lakehouse-architecture/latest/userguide/images/lakehouse/catalog-database.png)
