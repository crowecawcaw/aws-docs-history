...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------- | -------------------------------------------------------------- |
| Amazon Linux 2023 (AL2023)                                                                                                                                                                                                                                                                                                                       | AL2023              | x86\_64, arm64 (Graviton2 or later processors)                 |
| Amazon Linux 2 (AL2)                                                                                                                                                                                                                                                                                                                             | 2.0                 | x86\_64, arm64 (Amazon Linux 2, A1 instance types)             |
| Amazon Linux 1 (AL1)<br>NoteAmazon Linux 1 (AL1) AMI reached its end-of-life on December 31, 2023 and is<br>not supported for `amazon-efs-utils` packages released in April 2024<br>and later (version 2.0 and later). We recommend that you upgrade applications to<br>Amazon Linux 2023 (AL2023), which includes long-term support until 2028. | 2017.09, 2018.03    | x86\_64                                                        |
| CentOS                                                                                                                                                                                                                                                                                                                                           | 7, 8                | x86\_64                                                        |
