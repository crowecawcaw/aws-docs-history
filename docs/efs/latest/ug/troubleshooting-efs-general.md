...
RHEL 6.9 might be suboptimal for certain workloads due to [Poor performance when opening many files in parallel](#open-close-operations-serialized "#open-close-operations-serialized").
