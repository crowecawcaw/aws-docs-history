...
You can also use AWS IAM to control NFS access with an EFS file system policy and identity-based policies.

###### Topics

- [Using VPC security groups](network-access.md "network-access.md")
- [Working with interface VPC endpoints in Amazon EFS](efs-vpc-endpoints.md "efs-vpc-endpoints.md")
