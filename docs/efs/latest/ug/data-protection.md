...
applies to data protection in Amazon EFS. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Amazon EFS or other AWS services
...
- [Internetwork privacy](internetwork-privacy.md "internetwork-privacy.md")
