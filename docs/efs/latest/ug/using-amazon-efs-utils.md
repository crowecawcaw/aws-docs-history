...
For a complete list of supported distributions that the package has been verified against, see the `amazon-efs-utils` [README](https://github.com/aws/efs-utils/blob/master/README.md) on Github.