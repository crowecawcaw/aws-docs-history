...
- _Regional_ (Recommended) – Regional file systems (recommended) store data redundantly across multiple geographically separated Availability Zones within the same AWS Region.
...
- _One Zone_ – One Zone file systems store data within a single Availability Zone. Storing data in a single Availability Zone provides continuous availability to the data.
...
- _General Purpose_ – The General Purpose performance mode is ideal for
...
- _Elastic_ – The Elastic
  ...
  For more information about EFS performance and throughput modes, see [Amazon EFS performance specifications](performance.md "performance.md").

Amazon EFS provides file-system-access semantics, such as strong data consistency and file
locking. For more information, see [Data consistency in Amazon EFS](features.md#consistency "features.md#consistency").
Amazon EFS also supports controlling access to your file systems through Portable Operating System
Interface (POSIX) permissions. For more information, see [Securing your data in Amazon EFS](security-considerations.md "security-considerations.md").
...
1. For an Amazon EFS product and pricing overview, see [Amazon EFS](https://aws.amazon.com/efs/ "https://aws.amazon.com/efs/").
2. For an Amazon EFS technical overview, see [How Amazon EFS works](how-it-works.md "how-it-works.md").
3. Try the [Getting started](getting-started.md "getting-started.md") exercise.
