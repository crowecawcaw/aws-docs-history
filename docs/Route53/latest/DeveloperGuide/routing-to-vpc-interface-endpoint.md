...
- [Prerequisites](#routing-to-vpc-interface-endpoint-prereqs "#routing-to-vpc-interface-endpoint-prereqs")
- [Configuring Amazon Route 53 to route traffic to an Amazon VPC interface endpoint](#routing-to-vpc-interface-endpoint-config "#routing-to-vpc-interface-endpoint-config")
...
- An Amazon VPC interface endpoint. For more information, see
  [Interface VPC endpoints (AWS PrivateLink)](../../../vpc/latest/userguide/vpce-interface.md "../../../vpc/latest/userguide/vpce-interface.md") in the
