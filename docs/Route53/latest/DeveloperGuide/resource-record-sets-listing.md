...
To show only certain records, enter search terms above the list of records. In automatic mode the search behavior depends on whether the hosted zone has up to 2,000 records or more than 2,000 records:
