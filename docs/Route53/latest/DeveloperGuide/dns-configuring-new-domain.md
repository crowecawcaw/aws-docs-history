...
<a name="dns-configuring-new-domain-r53"></a>
...
<a name="dns-configuring-new-domain-other"></a>
...
+ **Transfer the domain to Route 53:** Make Route 53 your registrar and DNS service. See [Pre-transfer checklist for domain transfers](domain-transfer-checklist.md) for what to do first, and [Transferring registration for a domain to Amazon Route 53](domain-transfer-to-route-53.md) for the transfer steps.
...
<a name="dns-configuring-create-hz-delegate"></a>

Follow these steps to create a public hosted zone and then add the name servers to your registrar:<a name="dns-configuring-create-hosted-zone-for-different-registrar"></a>
...
1. For the **Name**, enter the name of the domain you want to create a hosted zone for, such as `example.com`, add a description if you want, choose **Public hosted zone**, and then choose **Create hosted zone**.

1. After you create the hosted zone, note the four name server (NS) records. Each starts with "ns-".

   At your domain registrar, enter these name servers to point the domain to your Route 53 hosted zone.

### Route DNS traffic
<a name="dns-configuring-route-traffic"></a>
