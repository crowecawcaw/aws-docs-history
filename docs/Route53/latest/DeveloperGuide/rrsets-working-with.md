...
records that you can create in a hosted zone, see [Quotas](DNSLimitations.md "DNSLimitations.md").
...
- [Resource record set permissions](resource-record-sets-permissions.md "resource-record-sets-permissions.md")
