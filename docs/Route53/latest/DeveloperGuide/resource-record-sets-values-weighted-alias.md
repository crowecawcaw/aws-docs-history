...
When you create weighted alias records, you specify the following values. For more information, see [Choosing between alias and non-alias records](resource-record-sets-choosing-alias-non-alias.md "resource-record-sets-choosing-alias-non-alias.md").

###### Topics

- [Routing policy](#rrsets-values-weighted-alias-routing-policy "#rrsets-values-weighted-alias-routing-policy")
- [Record name](#rrsets-values-weighted-alias-name "#rrsets-values-weighted-alias-name")
- [Record type](#rrsets-values-weighted-alias-type "#rrsets-values-weighted-alias-type")
- [Value/Route traffic to](#rrsets-values-weighted-alias-alias-target "#rrsets-values-weighted-alias-alias-target")
- [Weight](#rrsets-values-weighted-alias-weight "#rrsets-values-weighted-alias-weight")
- [Health check](#rrsets-values-weighted-alias-associate-with-health-check "#rrsets-values-weighted-alias-associate-with-health-check")
- [Evaluate target health](#rrsets-values-weighted-alias-evaluate-target-health "#rrsets-values-weighted-alias-evaluate-target-health")
- [Record ID](#rrsets-values-weighted-alias-set-identifier "#rrsets-values-weighted-alias-set-identifier")
...
see [How Amazon Route 53 chooses records when health checking is configured](health-checks-how-route-53-chooses-records.md "health-checks-how-route-53-chooses-records.md").
