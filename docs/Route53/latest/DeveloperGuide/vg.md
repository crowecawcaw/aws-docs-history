...
Also used as a generic TLD, often by organizations involved in video
gaming.
...
- Renewal is possible: Until 44 days after the expiration
  date
- Late renewal with Route 53 is possible: Yes
- Domain is deleted from Route 53: 45 days after
  expiration
- Domain is deleted from the registry: 45 days after
  expiration
- Restoration with the registry is possible: Between 45 days
  and 74 days after expiration
- Domain is made publicly available again: 80 days after
  expiration
