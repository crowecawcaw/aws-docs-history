...
- **Use explicit logical IDs** - Always assign
  ...
  indices. For more information about CloudFormation logical IDs, see [Resources section structure](../../../AWSCloudFormation/latest/UserGuide/resources-section-structure.md "../../../AWSCloudFormation/latest/UserGuide/resources-section-structure.md") in the
  _AWS CloudFormation User Guide_
