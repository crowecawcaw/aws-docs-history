...
groups**. 3. On the navigation bar, choose the Region for the rule group. 4. Select the rule group that you want to associate. 5. Choose **View details**. The rule group page displays. 6. Toward the bottom, you can see a tabbed details area that includes rules
