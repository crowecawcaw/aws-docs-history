...
------
#### [ New console ]<a name="health-checks-monitoring-latency-proc"></a>
...
1. Select the linked ID for the health check for which you want to view metrics. You can view latency data only for health checks that monitor the status of an endpoint and for which the **Latency graphs** option is enabled.
...
1. To view a larger graph and specify different settings, choose the three dots on the upper right of the graph. You can change the following settings:  
**Statistic**  
...
------
#### [ Old console ]<a name="monitoring-latency-procedure"></a>
