...
4. On the **CIDR locations** page, select each location one at a time,
   ...
   **Delete**. You must delete each location
   associated with a CIDR collection before you can delete the
   collection.
5. After the deletion of each CIDR location is complete, on the
   **CIDR locations** page, choose the radio button
   next to the collection you want to delete, and then choose
   **Delete**.
