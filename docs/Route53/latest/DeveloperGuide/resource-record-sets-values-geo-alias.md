...
- [Routing policy](#rrsets-values-geo-alias-routing-policy "#rrsets-values-geo-alias-routing-policy")
- [Record name](#rrsets-values-geo-alias-name "#rrsets-values-geo-alias-name")
- [Record type](#rrsets-values-geo-alias-type "#rrsets-values-geo-alias-type")
- [Value/Route traffic to](#rrsets-values-geo-alias-alias-target "#rrsets-values-geo-alias-alias-target")
- [Location](#rrsets-values-geo-alias-location "#rrsets-values-geo-alias-location")
- [U.S. states](#rrsets-values-geo-alias-sublocation "#rrsets-values-geo-alias-sublocation")
- [Health check](#rrsets-values-geo-alias-associate-with-health-check "#rrsets-values-geo-alias-associate-with-health-check")
- [Evaluate target health](#rrsets-values-geo-alias-evaluate-target-health "#rrsets-values-geo-alias-evaluate-target-health")
- [Record ID](#rrsets-values-geo-alias-set-id "#rrsets-values-geo-alias-set-id")
...
article [ISO 3166-1 alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 "http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2"):
