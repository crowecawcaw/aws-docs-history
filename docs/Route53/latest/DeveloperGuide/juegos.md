...
You can no longer use Route 53 to register new .juegos domains or transfer
.juegos domains to Route 53. We'll continue to support .juegos domains that are
already registered with Route 53.

Used for gaming websites of all kinds. "Juegos" is a Spanish word that means
"games."
...
Not supported. You can no longer transfer .juegos domains to
Route 53.
