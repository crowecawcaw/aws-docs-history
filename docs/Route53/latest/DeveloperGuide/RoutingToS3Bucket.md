...
Amazon Simple Storage Service, see [Use your domain for a static website in an Amazon S3 bucket](getting-started-s3.md "getting-started-s3.md")
for a complete tutorial.

Amazon Simple Storage Service (Amazon S3) provides secure, durable, highly scalable [cloud storage](https://aws.amazon.com/what-is-cloud-storage/ "https://aws.amazon.com/what-is-cloud-storage/"). You can
...
record](resource-record-sets-choosing-alias-non-alias.md "resource-record-sets-choosing-alias-non-alias.md") that points to your bucket. An alias record is a Route 53 extension to
...
with Route 53](../../../AmazonS3/latest/userguide/website-hosting-custom-domain-walkthrough.md "../../../AmazonS3/latest/userguide/website-hosting-custom-domain-walkthrough.md") in the
...
following requirements:
    ...
    * The bucket was created by the current AWS
    ...
    If you created the bucket using a different AWS
     ...
     endpoint** column in the table [Amazon S3 website endpoints](../../../general/latest/gr/s3.md#s3_website_region_endpoints "../../../general/latest/gr/s3.md#s3_website_region_endpoints") in the
...
see [Choosing a routing policy](routing-policy.md "routing-policy.md"). 6. Choose **Create records**.
