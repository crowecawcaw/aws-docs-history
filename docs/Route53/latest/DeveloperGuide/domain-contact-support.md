...
AWS provides a Basic support plan, free of charge, for all AWS customers. The plan includes assistance for the
following issues related to domain registration:

- Transferring domains to or from Amazon Route 53
- Transferring domains between AWS accounts
- Increasing quotas on Route 53 entities, such as the number of domains that you can register
  (See [Quotas](DNSLimitations.md "DNSLimitations.md").)
...
- [Contacting AWS Support when you can sign in to your AWS account](#domain-contact-support-can-sign-in "#domain-contact-support-can-sign-in")
- [Contacting AWS Support when you can't sign in to your AWS account](#domain-contact-support-cannot-sign-in "#domain-contact-support-cannot-sign-in")
...
1. Using the AWS account that the domain is currently registered to, sign in to the
   [AWS Support](https://console.aws.amazon.com/route53/home "https://console.aws.amazon.com/route53/home").

###### Important

You must sign in by using the root account that the domain is currently registered to. This requirement prevents unauthorized users
from hijacking your account. 2. Choose **Account and Billing** 3. Specify the following values:
...
1. Go to the [I'm an AWS customer and I'm
   looking for billing or account support](https://pages.awscloud.com/contact-us-account-support.html "https://pages.awscloud.com/contact-us-account-support.html") page.
2. Fill out the form.
3. Choose **Submit**.
