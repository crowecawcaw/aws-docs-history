...
AWS Regions introduced after March 20, 2019 are deployed as opt-in Regions. In an opt-in Region, your account is not enabled within that Region. Your Route 53 Global Resolver data is not replicated to the Region unless you choose to opt into use of that Region. For more information about opt-in Regions, see [Managing AWS Regions](../../../accounts/latest/reference/manage-acct-regions.md "../../../accounts/latest/reference/manage-acct-regions.md").
