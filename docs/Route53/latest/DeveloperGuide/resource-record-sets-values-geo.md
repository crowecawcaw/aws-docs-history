...
- [Routing policy](#rrsets-values-geo-routing-policy "#rrsets-values-geo-routing-policy")
- [Record name](#rrsets-values-geo-name "#rrsets-values-geo-name")
- [Record type](#rrsets-values-geo-type "#rrsets-values-geo-type")
- [TTL (seconds)](#rrsets-values-geo-ttl "#rrsets-values-geo-ttl")
- [Value/Route traffic to](#rrsets-values-geo-value "#rrsets-values-geo-value")
- [Location](#rrsets-values-geo-location "#rrsets-values-geo-location")
- [U.S. states](#rrsets-values-geo-sublocation "#rrsets-values-geo-sublocation")
- [Health check](#rrsets-values-geo-associate-with-health-check "#rrsets-values-geo-associate-with-health-check")
- [Record ID](#rrsets-values-geo-set-id "#rrsets-values-geo-set-id")
...
alpha-2](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2 "http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2"):
