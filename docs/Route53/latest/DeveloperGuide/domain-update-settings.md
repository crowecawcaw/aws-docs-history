...
1. [Updating contact information and ownership for
...
2. [Enabling or disabling privacy protection for
...
3. [Enabling or disabling automatic
...
4. [Locking a domain to prevent unauthorized transfer to
...
6. [Updating name servers to use another
   registrar](domain-register-other-dns-service.md "domain-register-other-dns-service.md") and [Adding or changing name servers and
