...
As a managed service, Amazon Route 53 is protected by AWS global network security. For
...
You use AWS published API calls to access Route 53 through the network. Clients must
