...
also specifies how you want to locate resources: using AWS Cloud Map [DiscoverInstances](../../../cloud-map/latest/api/API_DiscoverInstances.md "../../../cloud-map/latest/api/API_DiscoverInstances.md") API calls,
...
When your application adds a resource, you can call the AWS Cloud Map [RegisterInstance](../../../cloud-map/latest/api/API_RegisterInstance.md "../../../cloud-map/latest/api/API_RegisterInstance.md") API action in the code, which creates a AWS Cloud Map service instance in a service. The service
instance contains information about how your application can locate the resource, whether
using DNS or using the AWS Cloud Map [DiscoverInstances](../../../cloud-map/latest/api/API_DiscoverInstances.md "../../../cloud-map/latest/api/API_DiscoverInstances.md") API
action.

When your application needs to connect to a resource, it calls [DiscoverInstances](../../../cloud-map/latest/api/API_DiscoverInstances.md "../../../cloud-map/latest/api/API_DiscoverInstances.md") or utilizes
...
- **AWS Cloud Map API** – If you're using a programming
  language that an SDK isn't available for, see the [AWS Cloud Map API Reference](../../../cloud-map/latest/api.md "../../../cloud-map/latest/api.md") for information about API actions and
