...
- [Routing policy](#rrsets-values-latency-routing-policy "#rrsets-values-latency-routing-policy")
- [Record name](#rrsets-values-latency-name "#rrsets-values-latency-name")
- [Record type](#rrsets-values-latency-type "#rrsets-values-latency-type")
- [TTL (seconds)](#rrsets-values-latency-ttl "#rrsets-values-latency-ttl")
- [Value/Route traffic to](#rrsets-values-latency-value "#rrsets-values-latency-value")
- [Region](#rrsets-values-latency-region "#rrsets-values-latency-region")
- [Health check](#rrsets-values-latency-associate-with-health-check "#rrsets-values-latency-associate-with-health-check")
- [Record ID](#rrsets-values-latency-set-id "#rrsets-values-latency-set-id")
...
applies to private hosted zones. Don't change this value.
