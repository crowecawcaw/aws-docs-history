...
Amazon Route 53 lets you configure weighted records. For a given name and type (for example, `www.example.com`, type A),
...
Route 53 DNS servers select a weighted random response to return to DNS resolvers. The value of a weighted record that has
