...
- [Routing policy](#rrsets-values-ipbased-routing-policy "#rrsets-values-ipbased-routing-policy")
- [Record name](#rrsets-values-ibased-name "#rrsets-values-ibased-name")
- [Record type](#rrsets-values-ibased-type "#rrsets-values-ibased-type")
- [TTL (seconds)](#rrsets-values-ibased-ttl "#rrsets-values-ibased-ttl")
- [Value/Route traffic to](#rrsets-values-ibased-value "#rrsets-values-ibased-value")
- [Location](#rrsets-values-ibased-location "#rrsets-values-ibased-location")
- [Health check](#rrsets-values-ibased-associate-with-health-check "#rrsets-values-ibased-associate-with-health-check")
- [Record ID](#rrsets-values-ipbased-set-id "#rrsets-values-ipbased-set-id")
...
(hyphen) and how to specify internationalized domain names, see [DNS domain name format](DomainNameFormat.md "DomainNameFormat.md").
...
on where it appears in the name. For more information, see [Using an asterisk (\*) in the names of hosted zones and records](DomainNameFormat.md#domain-name-format-asterisk "DomainNameFormat.md#domain-name-format-asterisk").
...
For more information about the above values, see [Value/Route traffic to](resource-record-sets-values-shared.md#rrsets-values-common-value "resource-record-sets-values-shared.md#rrsets-values-common-value")
[common values for Value/Route traffic to](resource-record-sets-values-shared.md#rrsets-values-common-value "resource-record-sets-values-shared.md#rrsets-values-common-value").
...
For more information about using IP-based records, see [IP-based routing](routing-policy-ipbased.md "routing-policy-ipbased.md").
...
- You select **Yes** for **Evaluate target
  ...
  **Evaluate Target Health**, both must evaluate to true. For
  more information, see [What happens when you associate a health check with an alias record?](dns-failover-complex-configs.md#dns-failover-complex-configs-hc-alias "dns-failover-complex-configs.md#dns-failover-complex-configs-hc-alias").
