...
<a name="troubleshooting-multiple-invoices"></a>
...
1. Choose **Invoices** to see details for any waived invoices.
...
1.  Choose the **Transactions** tab to view the **Transactions** table for all the completed transactions with AWS. 