...
Used for sexual content. Also used for describing the most popular and exciting
brands, products, information, and websites.

[Return to index](registrar-tld-list.md#index "registrar-tld-list.md#index")

###### Important

You can no longer use Route 53 to register new .sexy domains or transfer .sexy
domains to Route 53. We'll continue to support .sexy domains that are already
...
Not supported. You can no longer transfer .sexy domains to
Route 53.
