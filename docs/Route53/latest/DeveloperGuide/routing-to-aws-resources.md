...
- [Routing traffic to an AWS App Runner service](routing-to-app-runner.md "routing-to-app-runner.md")
- [Routing traffic to an AWS Global Accelerator](routing-to-global-accelerator.md "routing-to-global-accelerator.md")
...
- [Routing traffic to an ELB load balancer](routing-to-elb-load-balancer.md "routing-to-elb-load-balancer.md")
...
- [Creating Amazon Route 53 and Route 53 VPC Resolver resources with AWS CloudFormation](creating-resources-with-cloudformation.md "creating-resources-with-cloudformation.md")
