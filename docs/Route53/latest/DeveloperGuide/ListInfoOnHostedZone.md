...
1.  To filter hosted zones, use the search bar located at the top of the table. 
   ...
   **Up to 2,000 hosted zones**
   + To display the records that have specific values, choose the search bar, choose a property in the dropdown list, and enter a value. You can also enter a value directly in the search bar and press Enter. For example, to display the hosted zones that have a name beginning with **abc**, enter that value in the search bar and press Enter.
