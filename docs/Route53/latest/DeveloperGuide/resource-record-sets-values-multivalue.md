...
- [Routing policy](#rrsets-values-multivalue-routing-policy "#rrsets-values-multivalue-routing-policy")
- [Record name](#rrsets-values-multivalue-name "#rrsets-values-multivalue-name")
- [Record type](#rrsets-values-multivalue-type "#rrsets-values-multivalue-type")
- [TTL (seconds)](#rrsets-values-multivalue-ttl "#rrsets-values-multivalue-ttl")
- [Value/Route traffic to](#rrsets-values-multivalue-value "#rrsets-values-multivalue-value")
- [Health check](#rrsets-values-multivalue-associate-with-health-check "#rrsets-values-multivalue-associate-with-health-check")
- [Record ID](#rrsets-values-multivalue-set-identifier "#rrsets-values-multivalue-set-identifier")
