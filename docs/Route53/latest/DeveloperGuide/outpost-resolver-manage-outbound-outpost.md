...
**Topics**
+ [Viewing and editing outbound endpoints](#resolver-forwarding-outbound-queries-managing-viewing-outpost)
+ [Viewing the status for outbound endpoints](#resolver-forwarding-outbound-queries-managing-viewing-status-outpost)
+ [Deleting outbound endpoints](#resolver-forwarding-outbound-queries-managing-deleting-outpost)
