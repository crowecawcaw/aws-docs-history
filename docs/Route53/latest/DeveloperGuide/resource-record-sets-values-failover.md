...
- [Routing policy](#rrsets-values-failover-routing-policy "#rrsets-values-failover-routing-policy")
- [Record name](#rrsets-values-failover-name "#rrsets-values-failover-name")
- [Record type](#rrsets-values-failover-type "#rrsets-values-failover-type")
