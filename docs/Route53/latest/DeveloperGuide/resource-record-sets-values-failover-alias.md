...
- For information about creating failover records in a private hosted zone, see [Configuring failover in a private hosted zone](dns-failover-private-hosted-zones.md "dns-failover-private-hosted-zones.md").
- For information about alias records, see [Choosing between alias and non-alias records](resource-record-sets-choosing-alias-non-alias.md "resource-record-sets-choosing-alias-non-alias.md").

###### Topics

- [Routing policy](#rrsets-values-failover-alias-routing-policy "#rrsets-values-failover-alias-routing-policy")
- [Record name](#rrsets-values-failover-alias-name "#rrsets-values-failover-alias-name")
- [Record type](#rrsets-values-failover-alias-type "#rrsets-values-failover-alias-type")
- [Value/Route traffic to](#rrsets-values-failover-alias-alias-target "#rrsets-values-failover-alias-alias-target")
- [Failover record type](#rrsets-values-failover-alias-failover-record-type "#rrsets-values-failover-alias-failover-record-type")
- [Health check](#rrsets-values-failover-alias-associate-with-health-check "#rrsets-values-failover-alias-associate-with-health-check")
- [Evaluate target health](#rrsets-values-failover-alias-evaluate-target-health "#rrsets-values-failover-alias-evaluate-target-health")
- [Record ID](#rrsets-values-failover-alias-set-id "#rrsets-values-failover-alias-set-id")
...
values
for alias records for value/route traffic to](resource-record-sets-values-alias-common.md#rrsets-values-alias-common-target "resource-record-sets-values-alias-common.md#rrsets-values-alias-common-target").
