...
Verisign, the registry for .name TLDs, allows you to register both
second-level domains (_name_.name) and third-level
domains
(_firstname_._lastname_.name).
Route 53 supports only second-level domains, both for registering domains
and for transferring existing domains to Route 53.
