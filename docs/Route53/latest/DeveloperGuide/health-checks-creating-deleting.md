...
1. **Values displayed when creating a health check:**
...
1. **Configuring router and firewall rules:**
...
+ [Disabling or enabling health checks](health-checks-disable.md)
+ [Inverting health checks](health-checks-invert.md)
