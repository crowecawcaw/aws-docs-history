...
tags for custom billing reports](../../../awsaccountbilling/latest/aboutv2/allocation.md "../../../awsaccountbilling/latest/aboutv2/allocation.md") in the
...
- To add, edit, or delete the **Name** tag when you add or edit
  health checks in the Route 53 console, see [Creating and updating health checks](health-checks-creating.md "health-checks-creating.md").
- For an overview of tagging Route 53 resources, see [Tagging Amazon Route 53 resources](tagging-resources.md "tagging-resources.md").
...
- [New console](#health-checks-tagging-new "#health-checks-tagging-new")
- [Old console](#health-checks-tagging-old "#health-checks-tagging-old")
...
one and sets the value to **777**. 4. In the bottom pane, choose the **Tags** tab, and then
choose **Add/Edit Tags**. 5. In the **Add/Edit Tags** dialog box, edit the
value. 6. Choose **Save**.
