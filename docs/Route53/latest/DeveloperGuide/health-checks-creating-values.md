...
+ [New console](#health-checks-creating-values-endpoint-new)
+ [Old console](#health-checks-creating-values-endpoint-old)
...
If you delete the Amazon EC2 instance, make sure you also delete the health check associated to the EIP. For more information, see [Best practices for Amazon Route 53 health checks](best-practices-healthchecks.md).   
If you specify a non-AWS endpoint, an additional charge applies. For more information, including a definition of AWS endpoints, see "Health Checks" on the [Route 53 Pricing](https://aws.amazon.com/route53/pricing/) page.
...
Choose the tab for the console you are using.
+ [New console](#health-checks-creating-values-calculated-new)
+ [Old console](#health-checks-creating-values-calculated-old)
...
To invert a health check on the new console, see [Inverting health checks](health-checks-invert.md).   
...
To disable a health check on the new console, see [Disabling or enabling health checks](health-checks-disable.md) .  
...
Choose the tab for the console you are using.
+ [New console](#health-checks-creating-values-cloudwatch-new)
+ [Old console](#health-checks-creating-values-cloudwatch-old)
...
**Note**  
Route 53 is updating the health checks console. During the transition period, you can continue to use the old console.
+ [New console](#health-checks-creating-values-advanced-new)
+ [Old console](#health-checks-creating-values-advanced-old)
...
If you choose **Customize**, choose the **x** for a Region to remove it. Choose the space at the bottom of the list to add a Region back to the list. You must specify at least three Regions.
