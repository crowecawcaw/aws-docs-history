...
your domain, see [Domains that you can register with Amazon Route 53](registrar-tld-list.md "registrar-tld-list.md"). In addition, processing a
...
for the domain. For more information, see [Extending the registration period for a domain](domain-extend.md "domain-extend.md").

For more information about renewal periods, see the Deadlines for renewing and restoring
domains section for your TLD in [Domains that you can register with Amazon Route 53](registrar-tld-list.md "registrar-tld-list.md").
...
see [Restoring an expired or deleted domain](domain-restore-expired.md "domain-restore-expired.md").
...
[Extending the registration period for a domain](domain-extend.md "domain-extend.md") section. If the domain is still listed, it's within the
late-renewal period.
