...
list see [Automatically tracked connections](../../../AWSEC2/latest/UserGuide/security-group-connection-tracking.md#automatic-tracking "../../../AWSEC2/latest/UserGuide/security-group-connection-tracking.md#automatic-tracking") ) are automatically tracked, even
...
For the [Amazon Route 53 APIs](../APIReference/API_Operations_Amazon_Route_53.md "../APIReference/API_Operations_Amazon_Route_53.md") five requests per second per AWS account. If you submit more than five requests per second,
