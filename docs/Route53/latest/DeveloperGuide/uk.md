...
If you're transferring a uk domain to Route 53, you don't need to get
an authorization code. Instead, use the method provided by your
...
When you register a .uk domain, Route 53 automatically sets the
IPS tag for the domain to **GANDI**.
...
The registry for .uk domains doesn't allow you to delete domain
