...
- [Domain registration concepts](#route-53-concepts-domain-registration "#route-53-concepts-domain-registration")
- [Domain Name System (DNS) concepts](#route-53-concepts-domain-name-system-dns "#route-53-concepts-domain-name-system-dns")
- [Control and data plane concepts](#route-53-concepts-control-and-data-plane "#route-53-concepts-control-and-data-plane")
- [Health checking concepts](#route-53-concepts-health-checking "#route-53-concepts-health-checking")

## Domain registration concepts

Here's an overview of the concepts that are related to domain registration.

- [domain name](#route-53-concepts-domain-name "#route-53-concepts-domain-name")
- [domain registrar](#route-53-concepts-domain-registrar "#route-53-concepts-domain-registrar")
- [domain registry](#route-53-concepts-domain-registry "#route-53-concepts-domain-registry")
- [domain reseller](#route-53-concepts-domain-reseller "#route-53-concepts-domain-reseller")
- [top-level domain (TLD)](#route-53-concepts-top-level-domain "#route-53-concepts-top-level-domain")
...
[How domain registration works](welcome-domain-registration.md "welcome-domain-registration.md").
...
find the registrar of your domain, see [Finding your registrar](find-your-registrar.md "find-your-registrar.md").

**domain registry**
A company that owns the right to sell domains that have a specific top-level domain. For example,
[VeriSign](http://www.verisign.com/ "http://www.verisign.com/") is the registry that owns the right to sell domains that have a
...
[.io (British Indian Ocean Territory)](io.md "io.md"), allow or even encourage use as a generic TLD.
...
- [alias record](#route-53-concepts-alias-resource-record-set "#route-53-concepts-alias-resource-record-set")
- [authoritative name server](#route-53-concepts-authoritative-name-server "#route-53-concepts-authoritative-name-server")
- [CIDR block](#route-53-concepts-cidr "#route-53-concepts-cidr")
- [DNS query](#route-53-concepts-dns-query "#route-53-concepts-dns-query")
- [DNS resolver](#route-53-concepts-dns-resolver "#route-53-concepts-dns-resolver")
- [Domain Name System (DNS)](#route-53-concepts-domain-name-system "#route-53-concepts-domain-name-system")
- [hosted zone](#route-53-concepts-hosted-zone "#route-53-concepts-hosted-zone")
- [IP address](#route-53-concepts-ip-address "#route-53-concepts-ip-address")
- [name servers](#route-53-concepts-name-servers "#route-53-concepts-name-servers")
- [private DNS](#route-53-concepts-private-dns "#route-53-concepts-private-dns")
- [recursive name server](#route-53-concepts-recursive-name-server "#route-53-concepts-recursive-name-server")
- [record (DNS record)](#route-53-concepts-resource-record-set "#route-53-concepts-resource-record-set")
- [reusable delegation set](#route-53-concepts-reusable-delegation-set "#route-53-concepts-reusable-delegation-set")
- [routing policy](#route-53-concepts-routing-policy "#route-53-concepts-routing-policy")
- [subdomain](#route-53-concepts-subdomain "#route-53-concepts-subdomain")
- [time to live (TTL)](#route-53-concepts-time-to-live "#route-53-concepts-time-to-live")
...
See also [record (DNS record)](#route-53-concepts-resource-record-set "#route-53-concepts-resource-record-set").
...
servers are either recursive name servers (also known as [DNS resolver](#route-53-concepts-dns-resolver "#route-53-concepts-dns-resolver")) or [authoritative name server](#route-53-concepts-authoritative-name-server "#route-53-concepts-authoritative-name-server").
...
Route 53–specific records, see [Configuring Amazon Route 53 as your DNS service](dns-configuring.md "dns-configuring.md").

**recursive name server**
See [DNS resolver](#route-53-concepts-dns-resolver "#route-53-concepts-dns-resolver").
...
[CreateHostedZone](../APIReference/API_CreateHostedZone.md "../APIReference/API_CreateHostedZone.md") and
...
[AWS SDKs](../../../index.md "../../../index.md"), the [AWS Command Line Interface](../../../cli/latest/reference/route53/index.md "../../../cli/latest/reference/route53/index.md"), and
...
For more information, see [Choosing a routing policy](routing-policy.md "routing-policy.md").
...
stability using Availability Zones paper](https://aws.amazon.com/builders-library/static-stability-using-availability-zones/ "https://aws.amazon.com/builders-library/static-stability-using-availability-zones/") in the Amazon Builders’
Library.
...
- [DNS failover](#route-53-concepts-dns-failover "#route-53-concepts-dns-failover")
- [endpoint](#route-53-concepts-endpoint "#route-53-concepts-endpoint")
- [health check](#route-53-concepts-health-check "#route-53-concepts-health-check")
