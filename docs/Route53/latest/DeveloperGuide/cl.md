...
You can no longer use Route 53 to register new .cl domains or transfer .cl
domains to Route 53. We'll continue to support .cl domains that are already
...
Not supported. You can no longer transfer .cl domains to
Route 53.
