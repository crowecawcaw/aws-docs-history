...
![Conceptual graphic that shows how you configure Route 53 to monitor the health of specified endpoints.](images/how-health-checks-work.png)
...
no action. 3. If the endpoint doesn't respond to a request, Route 53 starts to count the number of consecutive requests
