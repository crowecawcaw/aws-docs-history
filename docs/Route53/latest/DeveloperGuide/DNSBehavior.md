...
[RFC 2671](https://tools.ietf.org/html/rfc2671 "https://tools.ietf.org/html/rfc2671")), and advertises the EDNS0 option to
...
(as defined in [RFC 1035](https://tools.ietf.org/html/rfc1035 "https://tools.ietf.org/html/rfc1035")) for the relevant hosted zone to the
...
DNS record types, see [Supported DNS record types](ResourceRecordTypes.md "ResourceRecordTypes.md").
