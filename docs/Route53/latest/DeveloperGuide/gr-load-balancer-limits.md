...
can request increases for some quotas. Other quotas can't be increased.
...
services**, and then select **Route 53 Global Resolver**.
...
The following table describes quotas in Route 53 Global Resolver that can be increased. To
change quotas, see [Requesting a Quota
...
got a _Resource limit exceeded_ error
...
Global Resolver soft quotas| Resource | Default quota | Adjustable |
| --- | --- | --- |
