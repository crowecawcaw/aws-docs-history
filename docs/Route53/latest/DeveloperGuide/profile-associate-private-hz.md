...
2. On the navigation bar, choose the Region where you created the
   Profile.
3. In the navigation pane, choose **Profiles** and on the
   **Profiles** table, choose the linked name of the
   Profile you want to work with.
4. On the **<Profile name>** page, choose the
   **Private hosted zones** tab, and then
   **Associate**.
5. On the **Associate private hosted zones** page you can
   select up to 10 private hosted zones you have previously created. If you
   want to associate more than 10 private hosted zones, use the APIs. For more
