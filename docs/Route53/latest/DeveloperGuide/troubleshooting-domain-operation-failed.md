...
After you correct the contact information, try the domain operation again. For specific requirements for different top-level domains, see [Domains that you can register with Amazon Route 53](registrar-tld-list.md "registrar-tld-list.md").
