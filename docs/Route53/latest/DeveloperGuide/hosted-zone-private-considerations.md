...
- [Amazon VPC settings](#hosted-zone-private-considerations-vpc-settings "#hosted-zone-private-considerations-vpc-settings")
- [Route 53 health checks](#hosted-zone-private-considerations-health-checks "#hosted-zone-private-considerations-health-checks")
- [Supported routing policies for records in a private hosted zone](#hosted-zone-private-considerations-routing-policies "#hosted-zone-private-considerations-routing-policies")
...
For more information, see [View and update DNS attributes for your VPC](../../../vpc/latest/userguide/vpc-dns-updating.md "../../../vpc/latest/userguide/vpc-dns-updating.md")
...
failover records, see [Configuring failover in a private hosted zone](dns-failover-private-hosted-zones.md "dns-failover-private-hosted-zones.md").
...
- [Simple routing](routing-policy-simple.md "routing-policy-simple.md")
- [Failover routing](routing-policy-failover.md "routing-policy-failover.md")
...
- [Geolocation routing](routing-policy-geo.md "routing-policy-geo.md")
...
For more information, see [Resolver delegation rules tutorial](outbound-delegation-tutorial.md "outbound-delegation-tutorial.md").
...
actions. For more information, see [Actions, resources, and condition keys for Route 53](../../../service-authorization/latest/reference/list_amazonroute53.md "../../../service-authorization/latest/reference/list_amazonroute53.md") in the _Service Authorization Reference_.
