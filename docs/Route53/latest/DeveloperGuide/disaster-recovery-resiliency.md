...
Route 53 divides its functionality into a control and a data plane. Route 53 service, like most
...
provides the service's core functionality. For more information about control and data
planes in Route 53, see [Control and data plane concepts](route-53-concepts.md#route-53-concepts-control-and-data-plane "route-53-concepts.md#route-53-concepts-control-and-data-plane").
...
- When you create a health check that monitors an endpoint, you can optionally specify the Regions that you want
  ...
  and Availability Zones, see [AWS Global
