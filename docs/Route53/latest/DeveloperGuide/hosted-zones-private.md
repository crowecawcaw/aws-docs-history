...
For more information about records, see [Working with records](rrsets-working-with.md "rrsets-working-with.md"). For information
about the Amazon VPC requirements for using private hosted zones, see
[Using private hosted zones](../../../vpc/latest/userguide/vpc-dns.md#vpc-private-hosted-zones "../../../vpc/latest/userguide/vpc-dns.md#vpc-private-hosted-zones") in the
_Amazon VPC User Guide_. 3. When an application submits a DNS query for db.example.com, Route 53 returns the corresponding IP
...
- [Considerations when working with a private hosted zone](hosted-zone-private-considerations.md "hosted-zone-private-considerations.md")
