...
+ During the registration process, you must provide the following information:
  ...
  + The reason why you are allowed to register this domain name (Policy reason):
    ...
    + The domain name meets the allocation rules but is not an acronym or abbreviation of the registrant's company or trading name, organization or association name, or trademark. (Policy reason 2). To view the allocation rules for .com.au, see SCHEDULE C from the [.com.au registry](https://www.auda.org.au/au-domain-names/au-rules-and-policies/domain-name-eligibility-and-allocation-policy-rules-open-2lds-2012-04/).
