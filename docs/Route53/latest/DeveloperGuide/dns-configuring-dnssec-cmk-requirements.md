...
- The customer managed key must be
  ...
  [Viewing the cryptographic configuration of customer managed keys](../../../kms/latest/developerguide/symm-asymm-crypto-config.md "../../../kms/latest/developerguide/symm-asymm-crypto-config.md")
...
- Be aware that separate charges apply for each customer managed key that you have, whether you create the customer managed key
  or Route 53 creates it for you. For more information, see [AWS Key Management Service pricing](https://aws.amazon.com/kms/pricing/ "https://aws.amazon.com/kms/pricing/").
