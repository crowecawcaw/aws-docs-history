...
1. Under **KSK**, enter a name for the KSK that Route 53 creates for you. The name can include numbers, letters, and underscores (\_). It must be unique.

1. Enter the alias for a customer managed key that applies to DNSSEC signing, or enter an alias for a new customer managed key that Route 53 creates for you.
**Note**  
