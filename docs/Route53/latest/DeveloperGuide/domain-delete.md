...
To determine whether you can delete the registration for your domain, see [Domains that you can register with Amazon Route 53](registrar-tld-list.md "registrar-tld-list.md"). If
...
the domain lock, see [DisableDomainTransferLock](../APIReference/API_domains_DisableDomainTransferLock.md "../APIReference/API_domains_DisableDomainTransferLock.md").
...
TLD in [Domains that you can register with Amazon Route 53](registrar-tld-list.md "registrar-tld-list.md").
...
[Viewing the status of a domain registration](domain-view-status.md "domain-view-status.md"). 6. Delete the records in the hosted zone for the deleted domain, and then delete the hosted zone. After you delete the
hosted zone, Route 53 stops billing you the monthly charge for a hosted zone. For more information, see the following documentation:
    ...
    * [Deleting records](resource-record-sets-deleting.md "resource-record-sets-deleting.md")
...
[https://www.nominet.uk/domain-support/](https://www.nominet.uk/domain-support/ "https://www.nominet.uk/domain-support/").
...
1. On the Nominet website, follow the instructions for logging in for the first time. See
   [https://secure.nominet.org.uk/auth/login.html](https://secure.nominet.org.uk/auth/login.html "https://secure.nominet.org.uk/auth/login.html").
