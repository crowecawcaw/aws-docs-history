...
If you need to register and manage a lot of domains, you might prefer to make changes programmatically. For more information, see [Set up Amazon Route 53](setting-up-route-53.md). 
