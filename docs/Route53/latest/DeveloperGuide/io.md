...
Also used as a generic TLD, often by computer-related organizations such as
online services, browser-based games, and startup companies.
...
All information is hidden except state/province and
country.
...
The registry for .io domains also uses the authorization code as a
single-use password for some operations, such as enabling or
disabling privacy protection. If you want to perform more than one
operation that requires a password, you must generate another
authorization code for each operation.
