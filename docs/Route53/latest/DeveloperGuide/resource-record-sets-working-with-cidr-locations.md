...
1. In the navigation pane, choose **IP-based routing**, **CIDR collections** and then, in the **CIDR collections** section, choose a link to a CIDR collection in the **Collection name** list.
