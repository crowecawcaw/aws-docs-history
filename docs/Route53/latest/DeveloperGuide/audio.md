...
You can no longer use Route 53 to register new .audio domains or transfer .audio
domains to Route 53. We'll continue to support .audio domains that are already
registered with Route 53.

Used by the audiovisual industry and anyone interested in broadcasting, sound
equipment, audio production, and audio streaming.
...
Supported for Cyrillic (primarily Russian), French, German, Italian,
Portuguese, and Spanish.

**Authorization code required for transfers**

Not supported. You can no longer transfer .audio domains to
Route 53.
