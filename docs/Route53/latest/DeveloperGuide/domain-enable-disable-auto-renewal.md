...
**Note**  
Make sure you turn off automatic renewal if you intend to cancel your AWS account. Otherwise, you will continue to receive renewal notices from AWS. Your domain will not, however, be renewed, unless you re-activate your account.<a name="domain-enable-disable-auto-renewal-procedure"></a>
