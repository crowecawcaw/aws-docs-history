...
- There are two kinds of keys in DNSSEC: a key-signing key (KSK) and a zone-signing
  key (ZSK). In Route 53 DNSSEC signing, each KSK is based on an [asymmetric customer managed key](../../../kms/latest/developerguide/concepts.md#asymmetric-keys-concept "../../../kms/latest/developerguide/concepts.md#asymmetric-keys-concept") in AWS KMS
