...
The query logs will show the additional DNS Firewall fields for only the queries that
are blocked
...
2. Expand the Route 53 console menu. In the upper left corner of the console, choose
...
This must be the same Region where you created the VPCs that are associated
with DNS Firewall
