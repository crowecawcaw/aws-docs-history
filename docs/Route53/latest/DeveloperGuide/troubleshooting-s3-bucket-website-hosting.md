...
<a name="troubleshooting-s3-bucket-website-hosting"></a>
...
+ The S3 bucket is correctly configured for website hosting. For more information, see [Hosting a static website on Amazon S3](https://docs.aws.amazon.com/AmazonS3/latest/userguide/WebsiteHosting.html) in the *Amazon Simple Storage Service User Guide*.