...
**Domain list**  
The list of domains that the rule inspects for. You can create and manage your own domain list or you can subscribe to a domain list that AWS manages for you. For more information, see [DNS Firewall Foundational Rules](resolver-dns-firewall-domain-lists.md).   
...
For more information, see For more information, see [DNS Firewall Advanced Rules](firewall-advanced.md).   
