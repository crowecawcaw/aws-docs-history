...
- [Task list for configuring DNS failover](dns-failover-how-to.md "dns-failover-how-to.md")
- [How health checks work in simple Amazon Route 53 configurations](dns-failover-simple-configs.md "dns-failover-simple-configs.md")
- [How health checks work in complex Amazon Route 53 configurations](dns-failover-complex-configs.md "dns-failover-complex-configs.md")
- [How Amazon Route 53 chooses records when health checking is configured](health-checks-how-route-53-chooses-records.md "health-checks-how-route-53-chooses-records.md")
- [Active-active and active-passive failover](dns-failover-types.md "dns-failover-types.md")
- [Configuring failover in a private hosted zone](dns-failover-private-hosted-zones.md "dns-failover-private-hosted-zones.md")
- [How Amazon Route 53 averts failover problems](dns-failover-problems.md "dns-failover-problems.md")
