...
3. On the **<Profile name>** page, choose the
   **VPC endpoints** tab, and then
   **Associate**.
4. On the **Associate VPC endpoints** page, in the
   **VPC endpoints** table you can select up to 10
   endpoints you have previously created. If you want to associate more than 10
   endpoints, use the APIs. For more information, see [AssociateResourceToProfile](../APIReference/API_route53profiles_AssociateResourceToProfile.md "../APIReference/API_route53profiles_AssociateResourceToProfile.md").
