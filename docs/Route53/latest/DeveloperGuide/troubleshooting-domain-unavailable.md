...
<a name="troubleshooting-domain-unavailable"></a>

Here are the most common reasons that your domain is not available on the internet.

**Topics**
+ [You registered a new domain, but you didn't choose the link in the confirmation email](#troubleshooting-domain-unavailable-didnt-click-link)
...
<a name="troubleshooting-domain-unavailable-transferred-domain-wrong-name-servers"></a>
...
<a name="troubleshooting-domain-unavailable-transferred-domain-too-soon-after-dns-transfer"></a>
...
<a name="troubleshooting-domain-unavailable-deleted-hosted-zone"></a>
...
<a name="troubleshooting-domain-unavailable-suspended"></a>
