...
- Additionally, with Amazon Application Recovery Controller (ARC), you can set up routing control health checks with DNS
  ...
  Guide](../../../r53recovery/latest/dg/what-is-route-53-recovery.md "../../../r53recovery/latest/dg/what-is-route-53-recovery.md").
  For an overview of the types of health checks, see [Types of Amazon Route 53 health checks](health-checks-types.md "health-checks-types.md"). For information
  about creating health checks, see [Creating and updating health checks](health-checks-creating.md "health-checks-creating.md").
...
see [Monitoring health check status and getting notifications](health-checks-monitor-view-status.md "health-checks-monitor-view-status.md").
