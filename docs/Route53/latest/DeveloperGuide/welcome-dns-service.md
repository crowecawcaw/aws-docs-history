...
- [Overview of how you configure Amazon Route 53 to route internet traffic for your domain](#welcome-dns-service-how-to-configure "#welcome-dns-service-how-to-configure")
- [How Amazon Route 53 routes traffic for your domain](#welcome-dns-service-how-route-53-routes-traffic "#welcome-dns-service-how-route-53-routes-traffic")
...
1. You register the domain name that you want your users to use to access your content. For an overview,
   see [How domain registration works](welcome-domain-registration.md "welcome-domain-registration.md").
...
[time to live (TTL)](route-53-concepts.md#route-53-concepts-time-to-live "route-53-concepts.md#route-53-concepts-time-to-live"). 8. The web browser sends a request for www.example.com to the IP address that it got from the
DNS resolver. This is where your content is, for example, a web server running on an Amazon EC2 instance or an
Amazon S3 bucket that's configured as a website endpoint. 9. The web server or other resource at 192.0.2.44 returns the web page for www.example.com to the
