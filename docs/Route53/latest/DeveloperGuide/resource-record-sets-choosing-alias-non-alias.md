...
- **Another Route 53 record of the same type in the same hosted zone**
  ...
  the alias record (see [Comparison of alias and CNAME records](#resource-record-sets-choosing-alias-non-alias-comparison "#resource-record-sets-choosing-alias-non-alias-comparison")).
