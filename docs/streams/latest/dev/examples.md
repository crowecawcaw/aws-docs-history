...
+ [Tutorial: Analyze real-time stock data using Amazon Managed Service for Apache Flink](tutorial-stock-data.md)
+ [Tutorial: Use AWS Lambda with Amazon Kinesis Data Streams](tutorial-stock-data-lambda.md)
+ [Use the AWS Streaming Data Solution for Amazon Kinesis](examples-streaming-solution.md)