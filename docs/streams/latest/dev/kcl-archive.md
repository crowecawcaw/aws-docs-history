...
The following topics have been archived. To see current Kinesis Client Library documentation,
see [Use Kinesis Client Library](kcl.md "kcl.md").
...
- [KCL 1.x and 2.x information](shared-throughput-kcl-consumers.md "shared-throughput-kcl-consumers.md")
- [Develop custom consumers with shared throughput](shared-throughput-consumers.md "shared-throughput-consumers.md")
- [Migrate consumers from KCL 1.x to KCL 2.x](kcl-migration.md "kcl-migration.md")
