...
**Topics**
+ [KCL 1.x and 2.x information](shared-throughput-kcl-consumers.md)
+ [Develop custom consumers with shared throughput](shared-throughput-consumers.md)
+ [Migrate consumers from KCL 1.x to KCL 2.x](kcl-migration.md)