...
latest functionality. For more information, see [Installing the AWS Command Line
Interface](../../../cli/latest/userguide/installing.md "../../../cli/latest/userguide/installing.md") in the _AWS Command Line Interface User Guide_. To check the
...
2. Add a named profile for the administrator user in the AWS CLI config file. You
   use this profile when executing the AWS CLI commands. For more information about
   named profiles, see [Named
   Profiles](../../../cli/latest/userguide/cli-multiple-profiles.md "../../../cli/latest/userguide/cli-multiple-profiles.md") in the _AWS Command Line Interface User Guide_.
...
For a list of available AWS Regions, see [AWS
