...
**Topics**
+ [Get data from a stream](#kinesis-using-sdk-java-get-data)
+ [Use shard iterators](#kinesis-using-sdk-java-get-data-shard-iterators)
+ [Use GetRecords](#kinesis-using-sdk-java-get-data-getrecords)
+ [Adapt to a reshard](#kinesis-using-sdk-java-get-data-reshard)
