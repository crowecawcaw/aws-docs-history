...
One of the methods of developing a custom consumer application with shared throughput is
to use the Kinesis Client Library (KCL).

Choose from the following topics for the KCL version you are using.

###### Topics

- [Develop KCL 1.x consumers](developing-consumers-with-kcl.md "developing-consumers-with-kcl.md")
- [Develop KCL 2.x Consumers](developing-consumers-with-kcl-v2.md "developing-consumers-with-kcl-v2.md")
