...
- [Differences between shared throughput consumer and enhanced fan-out consumer](#enhanced-consumers-differences "#enhanced-consumers-differences")
...
This table compares shared-throughput consumers to enhanced fan-out consumers| Characteristics | Shared throughput consumers without enhanced fan-out | Enhanced fan-out consumers |
| --- | --- | --- |
