...
For more information about the KCL, see the overview provided in [Developing Consumers Using the Kinesis Client Library 1.x](developing-consumers-with-kcl.md "developing-consumers-with-kcl.md").

Choose from the following topics depending on the option you want to use.

###### Topics

- [Develop a Kinesis Client Library consumer in Java](kcl2-standard-consumer-java-example.md "kcl2-standard-consumer-java-example.md")
- [Develop a Kinesis Client Library consumer in Python](kcl2-standard-consumer-python-example.md "kcl2-standard-consumer-python-example.md")
- [Develop enhanced fan-out consumers with KCL 2.x](building-enhanced-consumers-kcl-retired.md "building-enhanced-consumers-kcl-retired.md")
