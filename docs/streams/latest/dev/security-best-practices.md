...
Data at rest and data in transit can be encrypted in Kinesis Data Streams. For more information, see [Data protection in Amazon Kinesis Data Streams](server-side-encryption.md).
...
For more information, see [Log Amazon Kinesis Data Streams API calls with AWS CloudTrail](logging-using-cloudtrail.md).