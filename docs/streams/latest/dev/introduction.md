...
You can use Amazon Kinesis Data Streams to collect and process large [streams](https://aws.amazon.com/streaming-data/ "https://aws.amazon.com/streaming-data/") of data records in real time. You
can create data-processing applications, known as _Kinesis Data Streams applications_. A
typical Kinesis Data Streams application reads data from a _data stream_ as data
...
AWS services. For information about Kinesis Data Streams features and pricing, see [Amazon Kinesis Data Streams](https://aws.amazon.com/kinesis/streams/ "https://aws.amazon.com/kinesis/streams/").

Kinesis Data Streams is part of the Kinesis streaming data platform, along with [Firehose](../../../firehose/latest/dev.md "../../../firehose/latest/dev.md"), [Kinesis Video Streams](../../../kinesisvideostreams/latest/dg.md "../../../kinesisvideostreams/latest/dg.md"), and [Managed Service for Apache Flink](../../../kinesisanalytics/latest/dev.md "../../../kinesisanalytics/latest/dev.md").

For more information about AWS big data solutions, see [Big Data on AWS](https://aws.amazon.com/big-data/ "https://aws.amazon.com/big-data/"). For more information about
AWS streaming data solutions, see [What is
Streaming Data?](https://aws.amazon.com/streaming-data/ "https://aws.amazon.com/streaming-data/").

###### Topics

- [What can I do with Kinesis Data Streams?](#use-service-for-what "#use-service-for-what")
- [Benefits of using Kinesis Data Streams](#using-the-service "#using-the-service")
...
Connector](../../../emr/latest/ReleaseGuide/emr-kinesis.md "../../../emr/latest/ReleaseGuide/emr-kinesis.md").
