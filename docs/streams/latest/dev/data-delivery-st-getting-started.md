...
This tutorial walks you through creating your first streaming table delivery to send
records from an Amazon Kinesis Data Streams stream to a streaming table on Apache Iceberg, verifying it,
and cleaning up.
...
Create a streaming table delivery with the AWS Management Console or the AWS CLI. For the full
procedure and all configuration options, see
[Create a streaming table delivery](data-delivery-st-create.md "data-delivery-st-create.md").
...
1. Delete the delivery. See [Delete a streaming table delivery](data-delivery-st-delete.md "data-delivery-st-delete.md").
...
3. If you no longer need the destination table bucket or the dead-letter
   queue bucket, delete them in Amazon S3 to stop incurring storage charges.
