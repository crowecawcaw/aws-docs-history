...
writing a basic Amazon Kinesis Data Streams application that performs calculations on the stream. You will
...
resources to stop incurring charges. For more information, see [Clean up resources](tutorial-stock-data-kplkcl2-finish.md "tutorial-stock-data-kplkcl2-finish.md").
...
The examples shown use the US West (Oregon) Region, but they work on any of the [AWS Regions](../../../general/latest/gr/rande.md#ak_region "../../../general/latest/gr/rande.md#ak_region") that support Kinesis Data Streams.

###### Tasks

- [Complete prerequisites](tutorial-stock-data-kplkcl2-begin.md "tutorial-stock-data-kplkcl2-begin.md")
