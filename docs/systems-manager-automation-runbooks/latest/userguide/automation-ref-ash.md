...
AWS Systems Manager Automation provides predefined runbooks for AWS Security Hub CSPM. For more information
...
- [AWSConfigRemediation-EnableSecurityHub](automation-aws-enable-security-hub.md "automation-aws-enable-security-hub.md")
