...
[Run this Automation (console)](https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-EnableCopyTagsToSnapshotOnRDSDBInstance "https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-EnableCopyTagsToSnapshotOnRDSDBInstance")
...
- `aws:assertAwsResourceProperty` - Confirms the
  `CopyTagsToSnapshot` setting is enabled on your DB instance.
