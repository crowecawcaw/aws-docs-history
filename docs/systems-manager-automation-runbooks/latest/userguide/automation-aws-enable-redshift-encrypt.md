...
The `AWSConfigRemediation-EnableRedshiftClusterEncryption` runbook
...
[Run this Automation (console)](https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-EnableRedshiftClusterEncryption "https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-EnableRedshiftClusterEncryption")
...
customer managed key you want to use to encrypt the cluster's data.
...
- `aws:executeAwsApi` - Enables encryption on the Amazon Redshift cluster
