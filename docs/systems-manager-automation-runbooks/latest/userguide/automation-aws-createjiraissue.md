...
Description: (Optional) The username of the person the issue should be
assigned to.
...
Description: (Optional) The due date for the issue in yyyy-mm-dd
format.
...
Description: (Required) The name of the type of issue you want to create
(for example, Task, Sub-task, Bug, etc.).
...
Description: (Required) The name of the user the issue will be created
with.
...
Description: (Required) The key of the project the issue should be created
in.
...
the API key or password for the Jira user.
