...
[Run this Automation (console)](https://console.aws.amazon.com/systems-manager/automation/execute/AWS-CreateServiceNowIncident "https://console.aws.amazon.com/systems-manager/automation/execute/AWS-CreateServiceNowIncident")
...
Valid values: None | Inquiry/Help | Software | Hardware | Network |
Database
...
Description: (Required) The name of the user the incident will be created
with.
...
Description: (Required) The name of an encrypted SSM Parameter containing
the password for the ServiceNow user.
