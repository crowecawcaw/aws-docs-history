...
to collect the Connect Customer contact flow logs for a specific contact ID. By providing your Connect Customer
...
collect the Connect Customer contact flow logs for a specific contact ID stored in the configured CloudWatch
log group and uploads them to a specified Amazon S3 bucket. To help with the security of the logs
gathered from your Connect Customer contact flow, the automation evaluates the Amazon S3 bucket
...
AWS KMS key. For more information about the logs generated by your Connect Customer instance, see [Flow logs
...
![Input parameters form for AWS Systems Manager Automation with fields for roles, IDs, and S3 settings.](images/automation-collect-amazon-connect-contact-flow-log_input_parameters.png) 4. Select Execute. 5. The automation initiates. 6. The document performs the following steps:
    ...
    * **CheckConnectInstanceExistance**
    ...
    Checks if the Connect Customer instance provided in the
    ...
    * **StartQuery**
    ...
    Starts a query log for the provided `ContactId` in the CloudWatch Logs
     log group associated with the Connect Customer instance provided in
    ...
    * **WaitForQueryCompletion**
    ...
    Waits for the CloudWatch Logs query log for the provided `ContactId` to
     ...
     Connect Customer console. For more information see [View running queries or query history](../../../AmazonCloudWatch/latest/logs/CloudWatchLogs-Insights-Query-History.md "../../../AmazonCloudWatch/latest/logs/CloudWatchLogs-Insights-Query-History.md").
