...
1. Navigate to [`AWSSupport-ContainS3Resource`](https://console.aws.amazon.com/systems-manager/documents/AWSSupport-ContainS3Resource/description) in Systems Manager under Documents.
