...
The restore option recreates both the root volume and user volume based on the most recent snapshots. The rebuild option recreates the user volume from the most recent snapshot and recreates the WorkSpace from the image associated with the bundle the WorkSpace was created from. Applications that were installed or system settings that were changed after the WorkSpace was created are lost. For more information about restoring and rebuilding WorkSpaces, see [Restore a WorkSpace](../../../workspaces/latest/adminguide/restore-workspace.md "../../../workspaces/latest/adminguide/restore-workspace.md") and [Rebuild a WorkSpace](../../../workspaces/latest/adminguide/rebuild-workspace.md "../../../workspaces/latest/adminguide/rebuild-workspace.md") in the _Amazon WorkSpaces Administration Guide_.

Before using this runbook, we recommend reviewing the [Troubleshooting Amazon WorkSpaces Issues](../../../workspaces/latest/adminguide/amazon-workspaces-troubleshooting.md "../../../workspaces/latest/adminguide/amazon-workspaces-troubleshooting.md") topic in the Amazon WorkSpaces Administration Guide.
...
[Run this Automation (console)](https://console.aws.amazon.com/systems-manager/automation/execute/AWSSupport-RecoverWorkSpaceWithApproval "https://console.aws.amazon.com/systems-manager/automation/execute/AWSSupport-RecoverWorkSpaceWithApproval")
...
1. Open [AWSSupport-RecoverWorkSpaceWithApproval](https://console.aws.amazon.com/systems-manager/documents/AWSSupport-RecoverWorkSpaceWithApproval/description "https://console.aws.amazon.com/systems-manager/documents/AWSSupport-RecoverWorkSpaceWithApproval/description") in Systems Manager under Documents.
...
- [Run this Automation (console)](https://console.aws.amazon.com/systems-manager/documents/AWSSupport-RecoverWorkSpaceWithApproval/description "https://console.aws.amazon.com/systems-manager/documents/AWSSupport-RecoverWorkSpaceWithApproval/description")
...
- [Running an automation with approvers](../../../systems-manager/latest/userguide/automation-working-executing-approval.md "../../../systems-manager/latest/userguide/automation-working-executing-approval.md")
