...
[Run this Automation (console)](https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-DeleteUnusedSecurityGroup "https://console.aws.amazon.com/systems-manager/automation/execute/AWSConfigRemediation-DeleteUnusedSecurityGroup")
...
- `aws:executeAwsApi` - Returns the security group name using the
  value you provide in the `GroupId` parameter.
- `aws:branch` - Confirms that the group name is not "default".
- `aws:executeAwsApi` - Deletes the security group specified in the
  `GroupId` parameter.
