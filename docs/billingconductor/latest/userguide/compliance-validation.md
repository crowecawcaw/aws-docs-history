...
multiple AWS compliance programs. AWS Billing Conductor is not in scope of any AWS compliance programs.
...
Your compliance responsibility when using AWS Billing Conductor is determined by the sensitivity
