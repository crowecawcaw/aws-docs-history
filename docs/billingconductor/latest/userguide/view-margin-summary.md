...
<a name="view-margin-summary"></a>

## Viewing your billing group margins summary
<a name="understand-margin-analysis-table-view"></a>
...
1. In the navigation pane, under **Analytics**, choose **Margin summary**.

1. For **Report type**, choose **All billing groups** or **Select billing group**.

1. If you chose **Select billing groups**, choose a **Billing period** and one or more billing groups.

1. In the **Month-to-date overview** section, you can view your **Charged amount**, **AWS costs**, and **Margin**.

1. You can view your margin analysis in two ways:
...
<a name="understand-margin-analysis-table"></a>
