...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Billing Conductor. The following topics show you how to configure AWS Billing Conductor to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS Billing Conductor resources.
