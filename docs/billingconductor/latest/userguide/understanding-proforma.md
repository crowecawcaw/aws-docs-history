...
<a name="understanding-proforma"></a>
...
<a name="abc-proforma-def-bestpractices"></a>
...
<a name="abc-proforma-def-bestpractices-diff"></a>
...
+ Non-public discounts (for example, [Solution Provider Program](https://aws.amazon.com/partners/programs/solution-provider/))
...
<a name="abc-proforma-def-bestpractices-configure"></a>
...
You can then [create custom line items](create-cli.md) to add credits or fees to a specific billing group account's pro forma bill.

### Who can see the pro forma billing data and standard AWS bills?
<a name="abc-proforma-def-bestpractices-viewing"></a>
...
For more information, see [Viewing your billing group details](viewing-abc.md) and [Configuring Cost and Usage Reports by billing group](configuring-abc.md).
...
<a name="abc-proforma-def-bestpractices-FT"></a>
...
**Always Free Tier**  
Billing Conductor doesn't remove this Free Tier from the pro forma bill. You can deactivate this Free Tier by applying a tiering pricing rule to your billing group's pricing plan. For more information, see [Pricing rules](create-pricingrule.md)
...
<a name="abc-proforma-def-bestpractices-impact"></a>
