...
For services and features that don't support pro forma costs, AWS accounts will see costs
at billable rates, which match the AWS invoice.
...
in the [Cost Management Console](https://console.aws.amazon.com/cost-management/home#/settings "https://console.aws.amazon.com/cost-management/home#/settings").
...
policy, see [Denying Billing and Cost Explorer access to
services and features that don't support pro forma costs](security_iam_id-based-policy-examples.md#deny-access-proforma-costs "security_iam_id-based-policy-examples.md#deny-access-proforma-costs").
...
- [Migrating access control for AWS Cost Management](../../../cost-management/latest/userguide/migrate-granularaccess-whatis.md "../../../cost-management/latest/userguide/migrate-granularaccess-whatis.md") in the _AWS Cost Management User
  Guide_
- [Migrating access control for AWS Billing](../../../awsaccountbilling/latest/aboutv2/migrate-granularaccess-whatis.md "../../../awsaccountbilling/latest/aboutv2/migrate-granularaccess-whatis.md") and in the
