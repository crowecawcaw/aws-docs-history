...
1. For **Type**, choose **Discount**, **Markup**, or **Tiering**.
**Note**  
**Tiering** is only available for global and service-scoped pricing rules.

1. For **Percentage**, enter the percentage amount.
...
1. For the **Tiering** type, you can check the box under **Tiering configuration** to deactivate Always Free Tier, or leave as activated. Always Free Tier will be activated unless it's explicitly deactivated.
