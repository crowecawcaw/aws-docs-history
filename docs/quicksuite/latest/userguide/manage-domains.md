...
In Amazon Quick Suite Enterprise edition, you can embed Amazon Quick Sight dashboards, visuals, consoles,
...
Quick Suite subscription. This requirement protects your data by preventing unapproved
...
Quick Suite console. Alternatively, add them at runtime with the Quick Suite
API.
...
- [Allow listing domains at runtime with
  the Amazon Quick Suite API](#embedding-run-time "#embedding-run-time")

## Allow listing static domains

You can add static domains to your allow list through the Amazon Quick Suite console. All
...
2. Choose **Manage Amazon Quick Suite**. You must be an Amazon Quick Suite admin to
   access this screen.
...
For more information about embedded dashboards, see [Embedding with the Amazon Quick Suite APIs](../../../quicksight/latest/user/embedded-analytics-api.md "../../../quicksight/latest/user/embedded-analytics-api.md").
