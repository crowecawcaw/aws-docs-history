...
Use this section to learn how to explore AWS data in Amazon Quick Suite using the AWS Management Console.
...
After you have enabled storage class analysis, you can use Amazon Quick Suite to explore your
...
If you don't have an Amazon Quick Suite account, you're prompted to create one
before you can use the dashboard.
When you choose the option to explore in Amazon Quick Suite, your Amazon S3 analytics data is
