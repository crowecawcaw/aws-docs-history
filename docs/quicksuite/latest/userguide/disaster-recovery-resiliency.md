# Resilience in Amazon Quick Suite

Quick Suite is built by AWS and runs on AWS-managed infrastructure. It takes
...
Because Amazon Quick Suite is an AWS-managed application, all patches and updates are applied
by AWS as needed.
