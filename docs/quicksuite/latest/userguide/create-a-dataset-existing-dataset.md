...
dataset in Amazon Quick Suite

After you create a dataset in Amazon Quick Suite, you can create additional datasets using it as a
...
Creating datasets from existing Quick Suite datasets has the following
advantages:
...
- **Reduction of data source management** –
  ...
  Quick Suite data refresh schedules. Building new datasets from existing datasets
...
- **Flexibility to customize data** – By
  ...
  returns data in a database. You have created a Quick Suite dataset by joining 18 other
...
Amazon Quick Suite supports creating up to two additional levels of datasets from a single
dataset.
