...
Amazon Quick Suite provides five integrated API sets for comprehensive business intelligence and analytics:
...
With Quick Suite AI capabilities, your applications can:
...
- Comprehensive APIs and SDKs for programmatic access
  Quick Suite lets you enhance the accuracy and relevance of AI responses by connecting custom knowledge bases and configuring agents with domain-specific expertise. For example, you can create specialized agents for financial analysis, customer support, or technical documentation that understand your organization's specific context and terminology.

The following sections cover the types of analysis that Quick Suite provides and an overview of Amazon Quick Sight, automation, and AI operations. Also covered are the differences between interactive and programmatic operations.

To demo the Quick Suite capabilities, you can see [Getting started with Amazon Quick Suite](getting-started.md "getting-started.md"), which covers getting started with sample data and creating your first analysis.
...
- [Create and use Amazon Quick Suite custom
  agents](#how-quick-works-chat-agents "#how-quick-works-chat-agents")
- [Share data and collaborate with
  Amazon Quick Suite spaces and folders](#how-quick-works-spaces-folders "#how-quick-works-spaces-folders")
- [Governance and administration for
  Amazon Quick Suite](#how-quick-works-governance-admin "#how-quick-works-governance-admin")
...
Amazon Quick Research capabilities in Quick Suite enable you to conduct
...
Quick Suite automations provide intelligent workflow capabilities that combine
...
Custom agents in Quick Suite are AI-powered assistants that you can configure to
...
Amazon Quick Suite spaces and folders

Spaces and folders in Quick Suite provide organizational structures that enable
...
Governance and administration features in Quick Suite provide comprehensive
...
These features ensure that your Quick Suite deployment meets organizational
