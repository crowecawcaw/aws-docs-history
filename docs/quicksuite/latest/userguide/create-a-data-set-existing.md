...
database data source, Amazon Quick Suite saves the connection information. It adds the data source to
...
1. On the Amazon Quick Suite start page, choose **Data**.
...
Amazon Quick Suite creates a connection profile for this data source based only on
