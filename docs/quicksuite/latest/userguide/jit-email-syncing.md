...
In Amazon Quick Suite Enterprise edition, as an administrator you can restrict new users
from using personal email addresses when provisioning through their identity provider
(IdP) directly to Quick Suite. Quick Suite then uses the preconfigured email
...
users are provisioned to your Amazon Quick Suite account through your IdP.

###### Note

Make sure that your users are federating directly to Amazon Quick Suite through their
IdP. Federating to the AWS Management Console through their IdP and then clicking into
Amazon Quick Suite results in an error and they won't be able to access
Amazon Quick Suite.

When you configure email syncing for federated users in Amazon Quick Suite, users who log in
to your Amazon Quick Suite account for the first time have preassigned email addresses. These
...
Amazon Quick Suite supports provisioning through an IdP that supports SAML or OpenID Connect
...
federated users in Amazon Quick Suite.
...
your IdP to Amazon Quick Suite. To do this, add the `sts:TagSession` action to
...
Then turn on email syncing for federated users in Amazon Quick Suite as described in the
following procedure.

###### To turn on email syncing for federated users

1. From any page in Amazon Quick Suite, choose your username at top right, and then
   choose **Manage Amazon Quick Suite**.
...
When email syncing for federated users is on, Amazon Quick Suite uses the email
...
When email syncing for federated users is off, Amazon Quick Suite asks users to
