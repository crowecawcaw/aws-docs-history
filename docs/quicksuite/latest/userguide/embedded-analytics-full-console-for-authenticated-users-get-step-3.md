...
In the following section, you can find out how you can use the [Amazon Quick Sight embedding SDK](https://www.npmjs.com/package/amazon-quicksight-embedding-sdk "https://www.npmjs.com/package/amazon-quicksight-embedding-sdk") (JavaScript) to embed the console
session URL from step 3 in your website or application page. With the SDK, you can
do the following:
...
- Handle error states with messages that are customized to your
  application.
  Call the `GetSessionEmbedUrl` API operation to get the URL that you can
  embed in your app. This URL is valid for 5 minutes, and the resulting session is
...
parameters within the console session and receive callbacks in terms of page load
...
load the embedded console session on your website using JavaScript. To get your
