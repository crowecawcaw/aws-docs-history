...
The `periodToDateMin` function returns the minimum value of the specified
measure or date, or a given time granularity (for instance, a quarter) up to a point in
time, relative to that period.

## Syntax

```
periodToDateMin(*measure,
 dateTime,
 period,
 endDate (optional)*)
```
...
![This is an image of the results from the example calculation.](images/PTDMinResults.png)
