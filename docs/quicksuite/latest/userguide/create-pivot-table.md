...
3. From the **Fields list** pane, choose the fields that you
   want to include. Amazon Quick Suite automatically places these into the field
   wells.
...
When you create a pivot table in Amazon Quick Suite, you can further customize the
...
Quick Suite](format-tables-pivot-tables.md "format-tables-pivot-tables.md").
