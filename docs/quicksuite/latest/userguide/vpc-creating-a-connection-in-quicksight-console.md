...
connection in the Amazon Quick Suite console

To create a secure private connection to the Amazon VPC service from the Amazon Quick Suite
console, use the following procedure.

###### Prerequisites

- Sign in to Amazon Quick Suite as a Amazon Quick Suite admin to set up a VPC connection in
  Amazon Quick Suite. To verify that you're a Amazon Quick Suite administrator, choose your
  profile icon in the upper-right. If your profile menu contains the option
  **Manage Amazon Quick Suite**, then you're a Amazon Quick Suite
...
###### To create a secure private connection to the Amazon VPC service from Quick Suite

Enterprise edition

1. In Amazon Quick Suite, choose your profile icon in the upper-right, then choose
   **Manage Amazon Quick Suite**.

Only Amazon Quick Suite administrators can view the **Manage
Amazon Quick Suite** option. If you don't see this option on your profile
menu, you're not an administrator. In this case, contact your Amazon Quick Suite
...
Amazon EC2 that you want to connect to your Amazon Quick Suite account. This field
...
policy that allows Amazon Quick Suite to configure the VPC connection to your
...
like the one you plan to use in Amazon Quick Suite. Most databases that are hosted by
...
the backend. After Amazon Quick Suite is finished configuring the new connection, the status
