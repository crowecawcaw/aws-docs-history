...
- [Setting up parameters in Amazon Quick Suite](parameters-set-up.md "parameters-set-up.md")
- [Using a control with a parameter in
  Amazon Quick Suite](parameters-controls.md "parameters-controls.md")
- [Creating parameter defaults in
  Amazon Quick Suite](parameters-default-values.md "parameters-default-values.md")
- [Connecting to parameters in
  Amazon Quick Suite](parameters-connections.md "parameters-connections.md")
