...
In analyses, when you add multiple filters to a visual, Quick Suite uses the AND
...
more information about these options, see [Filter types in Amazon Quick Suite](filtering-types.md "filtering-types.md"). 5. (Optional) You can add additional filter conditions to the filter group by
