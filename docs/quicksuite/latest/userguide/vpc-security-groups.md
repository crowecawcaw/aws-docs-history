...
create a new security group for use with Amazon Quick Suite. It also makes it easier for
...
To enable Quick Suite to successfully connect to an instance in your VPC,
configure your security group rules to allow traffic between the Amazon Quick Suite network
...
- From the port that Amazon Quick Suite is connecting to
- From one of the following options:

      + The security group ID that's associated with Amazon Quick Suite network
       interface (recommended)


      or
      + The private IP address of the Amazon Quick Suite network interface
...
The security group attached to the Amazon Quick Suite network interface behaves
...
allow return traffic. In contrast, the Amazon Quick Suite network interface security group
doesn't automatically allow return traffic. Because of this, adding an egress rule
to the Amazon Quick Suite network interface security group doesn't work. To make it work
for the Amazon Quick Suite network interface security group, make sure to add an inbound
...
To restrict Amazon Quick Suite to connect only to certain instances, you can specify the
...
To allow Amazon Quick Suite to connect to any instance in the VPC, you can configure the
Amazon Quick Suite network interface security group. In this case, give it an inbound rule
to allow traffic on 0.0.0.0/0 on all ports (0–65535). The security group used
by the Amazon Quick Suite network interface should be different than the security groups
...
VPC for use with Amazon Quick Suite, make sure to update your DB security group's
inbound rules. Update them to allow inbound traffic from the VPC security group
that you're using for Amazon Quick Suite. For more information, see [Controlling Access with Security Groups](../../../AmazonRDS/latest/UserGuide/Overview.md "../../../AmazonRDS/latest/UserGuide/Overview.md") in the
...
Do not configure the security group on the Amazon Quick Suite network interface with
...
The security group attached to Amazon Quick Suite network interface should have outbound
rules that allow traffic to each of the database instances in your VPC that you want
Amazon Quick Suite to connect to. To restrict Amazon Quick Suite to connect only to certain
