...
Before using actions in Amazon Quick Suite, ensure you have the following:

## License requirements

One of the following Amazon Quick Suite licenses:
...
- Appropriate IAM permissions - IAM roles and policies that allow Amazon Quick Suite to access the required AWS services.
