...
across all visuals in a Quick Suite analysis or dashboard. Colors are assigned on
...
Quick Suite authors can configure up to 50 field based colors per field. Colors
