# Amazon Quick Suite JSON expression language for
...
- Dates
- Undefined values
  Quick Suite authors can use JSON expression language create JSON schemas for
...
Highcharts visuals in Amazon Quick Suite.

###### Topics

- [Arithmetics](jle-arithmetics.md "jle-arithmetics.md")
- [Array operations](jle-arrays.md "jle-arrays.md")
- [Amazon Quick Suite expressions](jle-qs-expressions.md "jle-qs-expressions.md")
