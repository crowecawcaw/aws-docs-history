# Choosing a language in Amazon Quick Suite

You can choose the language that you want to use in the Amazon Quick Suite user interface.
This option is set separately for each individual user. The first time a user signs in,
Amazon Quick Suite detects and selects a suitable language. This choice is based on the user's
