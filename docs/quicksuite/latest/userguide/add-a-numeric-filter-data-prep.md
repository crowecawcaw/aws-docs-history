...
5. Do one of the following:
   ...
   **Maximum value**.
   ...
   then add a filter for it. For more information, see [Parameters in Amazon Quick Suite](parameters-in-quicksight.md "parameters-in-quicksight.md"). The values display
