...
As an Amazon Quick Suite author, you can deploy Quick Suite Microsoft
...
your Quick Suite admin must [configure Amazon Quick Suite access to Microsoft
Teams](teams-extension.md "teams-extension.md").
...
Amazon Quick Suite console. This process establishes the foundation for connecting
...
administrative permissions can add the Amazon Quick Suite App to the
Microsoft Teams admin center for your
organization. 12. Choose **Teams apps** in the left navigation. 13. Choose **Amazon Quick Suite** from the list of available
...
procedure, there is no further action required. 15. Authenticate and choose **Accept** for Amazon Quick Suite
app. 16. Confirm that an app titled Amazon Quick Suite
