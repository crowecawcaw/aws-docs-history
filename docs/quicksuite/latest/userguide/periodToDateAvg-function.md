...
The `periodToDateAvg` function averages the set of numbers in the specified
...
![This is an image of the results from the example calculation.](images/PTDAvgResults.png)
