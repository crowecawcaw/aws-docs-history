...
With Zendesk Suite integration in Amazon Quick Suite, you can perform actions within Zendesk instances, including managing tickets, users, and customer support workflows. This integration supports action execution only and requires Amazon Quick Suite Pro tier or higher.
