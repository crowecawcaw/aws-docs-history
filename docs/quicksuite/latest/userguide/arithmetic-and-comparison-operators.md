...
You can use the following operators in calculated fields. Quick Suite uses the
...
- OR
- NOT
  Amazon Quick Suite supports applying the following mathematical functions to an
  expression.
...
Amazon Quick Suite uses floating point divisions.
