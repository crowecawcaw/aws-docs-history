...
|                                                  |
| ------------------------------------------------ |
| Intended audience:<br>Amazon Quick Suite authors |

As an analysis author in Amazon Quick Suite, you don't need to understand anything about
...
Quick Suite console. You can use it to create one or more datasets. After a
...
Before you begin adding a new data-source connection profile to Amazon Quick Suite,
...
To view your existing connection profiles, open the Quick Suite start page,
...
dataset](creating-data-sets.md "creating-data-sets.md") in Quick Sight that contains data from the connected data
source. You can also [update data source
connection](edit-a-data-source.md "edit-a-data-source.md") information at any time.
