...
Before you create your first analysis, make sure to complete the steps in [Setting up and signing into Amazon Quick Suite](setting-up.md "setting-up.md").
...
1. From the Amazon Quick Suite homepage, from Amazon Quick Sight, choose
