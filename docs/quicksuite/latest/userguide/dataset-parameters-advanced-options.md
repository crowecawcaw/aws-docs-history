...
new Quick Suite analyses](dataset-parameters-analysis.md#dataset-parameters-map-to-analysis "dataset-parameters-analysis.md#dataset-parameters-map-to-analysis"). For more information
