...
Quick Suite admin must [configure Amazon Quick Suite access to Microsoft
Word](word-extension.md "word-extension.md").
...
5. Choose **Accept permissions** in the **Accept
   ...
   Amazon Quick Suite Add-in in their Microsoft Word.
