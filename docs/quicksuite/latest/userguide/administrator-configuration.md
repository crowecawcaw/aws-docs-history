...
1. Open the [Amazon Quick Suite console](https://quicksight.aws.amazon.com/ "https://quicksight.aws.amazon.com/").
...
For more information, see [Apply custom permissions profile to account](create-custom-permisions-profile.md#customizing-permissions-to-the-quicksight-console-apply-account "create-custom-permisions-profile.md#customizing-permissions-to-the-quicksight-console-apply-account").

### Apply a custom permissions profile to an account using the Amazon Quick Suite APIs

For more information, see [Apply custom permissions profile using APIs](create-custom-permisions-profile.md#customizing-permissions-to-the-quicksight-console-apply-account-with-apis "create-custom-permisions-profile.md#customizing-permissions-to-the-quicksight-console-apply-account-with-apis").
