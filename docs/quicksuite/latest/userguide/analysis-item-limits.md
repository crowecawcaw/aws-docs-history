...
| [Custom actions](custom-actions.md "custom-actions.md")                                    | 10 per visual                          |
| [Filter groups](add-a-compound-filter.md "add-a-compound-filter.md")                       | 2000 per analysis                      |
...
| [Image components](image-component.md "image-component.md")                                | 10 per sheet                           |
| [Layer map visuals](layered-maps.md "layered-maps.md")                                     | 5 per sheet                            | \* The per dataset limit applies to calculations that were created in the analysis. Dataset level calculations are not included in this limit. For more information about dataset level calculations, see [Adding calculated fields](adding-a-calculated-field-analysis.md "adding-a-calculated-field-analysis.md"). |
