...
With Google Drive integration in Amazon Quick Suite, you can create knowledge bases from
...
- Amazon Quick Suite Professional subscription or
  higher.
...
integration in Amazon Quick Suite, understand the authentication process and required
permissions:
...
Amazon Quick Suite requests the following Google Drive permissions during authentication:
...
2. Review the permissions that Amazon Quick Suite is requesting:
...
When using Google Drive integrations in Amazon Quick Suite, be aware of the following
limitations:
