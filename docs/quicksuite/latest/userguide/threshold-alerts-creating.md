...
1. Open Quick Suite and navigate to the dashboard that you want.

For more information about viewing dashboards as a dashboard subscriber in
Quick Suite, see [Interacting with Amazon Quick Sight dashboards](exploring-dashboards.md "exploring-dashboards.md"). 2. In the dashboard, select the visual that you want to create an alert for,
