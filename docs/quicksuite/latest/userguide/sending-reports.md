...
- File attachments and sheet previews in Scheduled Report emails. The [download link
  option](email-reports-from-dashboard.md "email-reports-from-dashboard.md") is the default.
...
groups who share your Amazon Quick Suite subscription. To receive email reports, the users or
group members must meet the following conditions:

- They are part of your Quick Suite subscription.
...
Quick Suite authors can run scheduled reports with the **Report
now** button in the Quick Suite console or with the [`StartDashboardSnapshotJobSchedule`](../../../quicksight/latest/APIReference/API_StartDashboardSnapshotJobSchedule.md "../../../quicksight/latest/APIReference/API_StartDashboardSnapshotJobSchedule.md") API.
