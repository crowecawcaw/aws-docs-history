# Using dataset parameters in Amazon Quick Suite

In Amazon Quick Suite, authors can use dataset parameters in direct query to dynamically customize
...
descriptions. For more information on analysis parameters, see [Parameters in Amazon Quick Suite](parameters-in-quicksight.md "parameters-in-quicksight.md"). The
...
- **Custom SQL in direct query** – Dataset owners
  ...
  these parameters are applied to a filter control in a Quick Suite analysis, users can
...
- **Move calculated fields to datasets** –
  Quick Suite authors can copy calculated fields with parameters in an analysis and
...
- [Creating dataset parameters in Amazon Quick Suite](dataset-parameters-SQL.md "dataset-parameters-SQL.md")
...
dataset parameters in Amazon Quick Suite.
