...
Connect Amazon Quick Suite to your BambooHR system to manage employee data, time-off requests, and HR processes. You can create, update, and manage HR content without leaving your Amazon Quick Suite environment. This integration requires Amazon Quick Suite Pro tier or higher.
...
Follow these steps to connect Amazon Quick Suite to your BambooHR system.
...
After you complete the setup, your BambooHR integration appears in the integrations list. You can use it in Amazon Quick Suite workflows, automations, and AI agents to perform HR-related tasks.
...
Check that your BambooHR instance URL is correct and accessible from Amazon Quick Suite.
