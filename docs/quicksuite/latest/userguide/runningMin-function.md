...
The `runningMin` function calculates a running minimum for a measure based
...
The following example calculates a running minimum of `sum(Sales)`,
...
The following example calculates a running minimum of `Billed Amount`,
