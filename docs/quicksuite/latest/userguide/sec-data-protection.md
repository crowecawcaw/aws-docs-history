# Data protection in Amazon Quick Suite
...
applies to data protection in Amazon Quick Suite. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Amazon Quick Suite or other AWS services
...
- [Inter-network traffic privacy in
  Amazon Quick Suite](internetwork-traffic-privacy.md "internetwork-traffic-privacy.md")
