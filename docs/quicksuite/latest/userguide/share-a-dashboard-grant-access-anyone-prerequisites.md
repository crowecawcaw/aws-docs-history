...
For more information on using IAM with Quick Sight, see [Using Quick Suite with
...
_AWS Organizations User Guide_. 3. Turn on public sharing on your Amazon Quick Suite account.

    1. From the Amazon Quick Suite start page, choose your user icon at
