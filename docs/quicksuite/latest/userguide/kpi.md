...
To understand the features supported by the KPI visual type in Amazon Quick Suite, use
the following table.
...
| Changing comparison method              | Yes        | By default, Amazon Quick Suite automatically chooses a method. The<br>settings are auto, difference, percent, and difference as<br>percent. |                                                                                                                         |
