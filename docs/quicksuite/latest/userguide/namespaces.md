...
Amazon Quick Suite Enterprise edition supports multitenancy through namespaces. An
Amazon Quick Suite _namespace_ is a logical container that you
can use to organize clients, subsidiaries, teams, and so on. Namespaces can help you achieve
the following goals:

- You can allow the users of your Amazon Quick Suite subscription to discover shared
...
- Use default namespaces instead of custom namespaces if you need to support the
  following:
  - Integrating your Amazon Quick Suite account with IAM Identity Center. For more information on
    integrating your Amazon Quick Suite account with IAM Identity Center, see [AWS
    security in Amazon Quick Suite](../../../quicksight/latest/user/security.md "../../../quicksight/latest/user/security.md").
...
- You can't transfer users directly from one namespace to another. You can choose to
  do some or all of this work programmatically. For more information, see the [Quick Suite API reference](../../../quicksight/latest/APIReference/Welcome.md "../../../quicksight/latest/APIReference/Welcome.md"). At the bottom of the page of each API
...
- Namespaces are useful for isolating users and permissions, but not for sharing
  ...
  with them.
  If you don't have an existing AWS account or you need to sign up for Amazon Quick Suite, read
  the following guidelines, then follow the applicable instructions in [Signing up for an Amazon Quick Suite
...
- Use the Amazon Quick Suite [CreateNamespace](../../../quicksight/latest/APIReference/API_CreateNamespace.md "../../../quicksight/latest/APIReference/API_CreateNamespace.md") API operation to create one or more namespaces.
- To start adding users, first follow the instructions in [Setting up IdP federation using IAM and Amazon Quick Suite](../../../quicksight/latest/user/external-identity-providers-setting-up-saml.md "../../../quicksight/latest/user/external-identity-providers-setting-up-saml.md").
  ...
  Enterprise edition. The person performing the upgrade must be a Amazon Quick Suite user with
  administrator privileges. For more information, see [Upgrading
  your Amazon Quick Suite subscription](../../../quicksight/latest/user/upgrading-subscription.md "../../../quicksight/latest/user/upgrading-subscription.md").

If you have an Enterprise edition subscription that you've been using for some time, it's
also possible to migrate your users into namespaces. When you sign up for Amazon Quick Suite and
...
Amazon Quick Suite assets and resources, including datasets, data sources, dashboards,
...
To implement namespaces, you use the following Amazon Quick Suite API operations:
...
- Amazon Quick Suite considers these two entities to be different persons:
...
- Amazon Quick Suite considers these two entities to be the same person:
  ...
  restricted. People using Amazon Quick Suite can have a single access level, as follows:

- Reader access, for read-only subscribers of a dashboard
- Author access, for analysts and dashboard designers
- Admin access, for Amazon Quick Suite administrators
...
If a namespace user starts using the Amazon Quick Suite console or API in a new
...
such, it originates in the primary AWS Region where Amazon Quick Suite is set up.
...
using Amazon Quick Suite. 3. To identify the asset and resource permissions that the new namespace users
need, use the Amazon Quick Suite API operations associated with each type of asset
(dashboards, datasets, and so on). For more information, see [QuickSight API operations to control assets](../../../quicksight/latest/APIReference/qs-assets.md "../../../quicksight/latest/APIReference/qs-assets.md") in the [Quick Suite API reference](../../../quicksight/latest/APIReference/Welcome.md "../../../quicksight/latest/APIReference/Welcome.md").
...
API operations to control data resources](../../../quicksight/latest/APIReference/qs-data.md "../../../quicksight/latest/APIReference/qs-data.md") in the [Quick Suite API reference](../../../quicksight/latest/APIReference/Welcome.md "../../../quicksight/latest/APIReference/Welcome.md").
...
AWS Command Line Interface (AWS CLI), see [Controlling command output from the AWS CLI](../../../cli/latest/userguide/cli-usage-output.md#cli-usage-output-filter "../../../cli/latest/userguide/cli-usage-output.md#cli-usage-output-filter") in the [AWS Command Line Interface User Guide](../../../cli/latest/userguide.md "../../../cli/latest/userguide.md"). 4. For Amazon Quick Suite assets and resources, copy the permissions that the source
...
[Quick Suite API reference](../../../quicksight/latest/APIReference/Welcome.md "../../../quicksight/latest/APIReference/Welcome.md"). 5. When you are finished adding users and permissions, it's a good practice to
