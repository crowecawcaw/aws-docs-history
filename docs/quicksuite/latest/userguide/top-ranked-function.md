...
The top ranked computation finds the top ranking dimensions by value. For
example, you can create a computation to find the top three states by sales
revenue.
