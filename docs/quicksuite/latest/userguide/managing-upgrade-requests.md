...
As an administrator, you can view and manage user license upgrade requests through the Amazon Quick Suite admin console. This section describes how to approve, deny, or verify upgrade requests based on your organization's identity management setup.
...
2. Choose **Manage Amazon Quick Suite** from the top right corner.
...
5. Return to the Amazon Quick Suite admin console and choose **Verify**.
