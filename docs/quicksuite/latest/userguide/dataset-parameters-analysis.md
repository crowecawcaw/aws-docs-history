# Using dataset parameters in Quick Suite
...
parameter upon creation.
    ...
    4. In the **Mapped dataset parameters** table, you
     ...
     that you want to remove.For more information on creating analysis parameters, see [Setting up parameters in Amazon Quick Suite](parameters-set-up.md "parameters-set-up.md").
...
After you map a dataset parameter to an analysis parameter in Quick Suite, you can
