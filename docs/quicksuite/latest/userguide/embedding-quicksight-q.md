...
Q&A experience. Amazon Quick Sight integrates with Amazon Q Business to launch a new Generative Q&A experience.
Developers are recommended to use the new Generative Q&A experience. For more information on the embedded
Generative Q&A experience, see [Embedding the Amazon Q in Amazon Quick Sight Generative Q&A experience](../../../quicksight/latest/user/embedding-gen-bi.md "../../../quicksight/latest/user/embedding-gen-bi.md").

Use the following topics to learn about embedding the Amazon Quick Sight Q search bar with
