...
Outlook](outlook-extension.md "outlook-extension.md").
...
Quick Suite console. This process establishes the foundation for
...
**Actions** menu. 11. In the screen asking for permissions to allow your Amazon Quick Suite
...
Amazon Quick Suite Add-in in their Microsoft Outlook.
