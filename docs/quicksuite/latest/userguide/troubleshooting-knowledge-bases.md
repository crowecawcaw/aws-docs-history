...
When you encounter issues with your Quick Suite knowledge base, you can use this troubleshooting guide to identify and resolve common problems. Knowledge base issues typically involve document synchronization, refresh job failures, or access permissions.
...
Quick Suite knowledge bases support specific file formats. Files must meet format, size, and character limit requirements.
