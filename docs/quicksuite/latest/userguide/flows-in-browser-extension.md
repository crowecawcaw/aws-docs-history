...
- Appropriate permissions to execute flows in your Amazon Quick Suite account.
...
1. Open the Amazon Quick Suite browser extension.
...
To view flow capabilities, see the [flows documentation](using-amazon-quick-flows.md "using-amazon-quick-flows.md").
