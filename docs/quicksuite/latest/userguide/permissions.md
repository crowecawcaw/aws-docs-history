...
Permission management in Quick Suite controls what actions users can perform and
which resources they can access within your Amazon Quick Suite environment. This section
...
- [Accessing AWS resources](accessing-data-sources.md "accessing-data-sources.md")
...
- [Creating a custom permissions profile in
  Amazon Quick Suite](create-custom-permisions-profile.md "create-custom-permisions-profile.md")
