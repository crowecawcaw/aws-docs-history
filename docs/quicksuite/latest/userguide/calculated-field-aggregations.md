...
To make sure that your data is accurately displayed, Amazon Quick Suite applies the following
rules:
...
- Scatter plots with custom aggregations need at least one dimension under
  **Group/Color** in the field wells.
  For more information about supported functions and operators, see [Calculated field function and operator reference for Amazon Quick Suite](../../../quicksight/latest/user/calculated-field-reference.md "../../../quicksight/latest/user/calculated-field-reference.md").

The aggregate functions for calculated fields in Quick Suite include the
following.
