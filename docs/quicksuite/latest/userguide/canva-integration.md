...
With Canva integration in Amazon Quick Suite, you can create, edit, and manage designs and visual content through MCP server connectivity. This integration provides action capabilities for design operations and content creation.
