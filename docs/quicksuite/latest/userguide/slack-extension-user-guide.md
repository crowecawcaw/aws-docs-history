...
As a user, you can access Amazon Quick Suite directly within Slack to get
...
Install the Amazon Quick Suite app in your Slack workspace to enable
AI-powered assistance. This one-time setup makes Quick Suite accessible
...
3. Choose **Apps**.
4. Choose **+ Add apps**.
5. Search for **Quick Suite** and choose
   Quick Suite.
...
7. Navigate to **Preferences** >
   **Navigation** > **AI Apps and
   ...
   and select **Quick Suite**.
8. Quick Suite is now available to access anywhere in
...
Once you've added Quick Suite to your Slack workspace,
...
Quick Suite while you work in Slack channels and direct
messages.

###### Access Quick Suite in your Slack side panel at any
...
2. Navigate to **Preferences** >
   **Navigation** > **AI Apps and
   Agents** and select
   **Amazon Quick Suite**.
3. Quick Suite will now be available to access anywhere in
   Slack through an icon in the top right of your
   Slack window.

## Slack extension use cases

With Quick Suite integrated into Slack, you can search
...
1. Open the Quick Suite side panel from the top right of your
   Slack window or start a DM with Quick Suite
   under **Apps**.
...
###### Get Quick Suite's in-context help in Slack
...
2. Mention **@Amazon Quick Suite** and ask questions about the
   uploaded image, such as requesting analysis, descriptions, or
   insights.
3. Quick Suite will analyze the image and provide relevant
...
Slack message history or the Amazon Quick Suite chat instance,
...
knowledge base available in your Amazon Quick Suite chat instance.

###### Note

Users can access conversation history in Slack.
Deleting the conversation in Slack will not delete from
conversation history in Amazon Quick Suite. However, users need to visit the
Amazon Quick Suite chat instance to manage their conversations.
...
may exceed Amazon Quick Suite's 30-day limit.

Users can access conversation history in Slack through the
AI App History tab. Deleting the conversation in Slack will
not delete from conversation history in Amazon Quick Suite. However, users need to
visit the Amazon Quick Suite chat instance to manage their conversations.

### Security

considerations

When you use Amazon Quick Suite in public channels, remember that responses
...
privacy in mind. Amazon Quick Suite maintains strict data privacy by not using
...
your company's Amazon Quick Suite instance.
...
- File upload limitations are the same within Amazon Quick Suite chat. For
  more information, see [Upload files and chat](using-quick-chat.md#file-uploads "using-quick-chat.md#file-uploads").
