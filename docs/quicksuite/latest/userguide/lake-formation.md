...
After Lake Formation is configured, you can use Amazon Quick Suite to access databases and tables by
name or through SQL queries. Amazon Quick Suite provides a full-featured editor where you can
...
- [Enabling connection from
  Amazon Quick Suite](#lake-formation-qs-steps "#lake-formation-qs-steps")

## Enabling connection from Lake Formation

Before you begin using this solution with Quick Suite, make sure that you
can access your data using Athena with Lake Formation. After you verify that the connection is
working through Athena, you need to verify only that Amazon Quick Suite can connect to
...
- Collect the Amazon Resource Names (ARNs) of the Quick Suite users
  and groups that need to access the data in Lake Formation. These users should be
  Amazon Quick Suite authors or administrators.

###### To find Amazon Quick Suite user and group ARNs

    1. Use the AWS CLI to find user ARNs for Amazon Quick Suite authors and
    ...
    To avoid using the AWS CLI, you can construct the ARNs for each user
     manually.
    2. (Optional) Use the AWS CLI to find ARNs for Amazon Quick Suite groups by
    ...
    If you don't have any Amazon Quick Suite groups, add a group by using
     the AWS CLI to run the `create-group` command. There
     currently isn't an option to do this from the Amazon Quick Suite console.
     For more information, see [Creating and managing groups in
     Amazon Quick Suite](../../../quicksight/latest/user/creating-quicksight-groups.md "../../../quicksight/latest/user/creating-quicksight-groups.md").
...
configured in Amazon Quick Suite:
...
Quick Suite, see [Allowing autodiscovery of AWS resources](../../../quicksight/latest/user/autodiscover-aws-data-sources.md "../../../quicksight/latest/user/autodiscover-aws-data-sources.md") and
