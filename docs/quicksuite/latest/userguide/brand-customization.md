# Amazon Quick Suite brand customization

Amazon Quick Suite allows account admins to customize their application's branding and
...
non-administrative Amazon Quick Suite console pages, schedules, alerts, and email reports.
...
- **Global navigation bar** colors are applied to the
  topmost bar in the Amazon Quick Suite UI and include the company logo that is diaplayed in
  the standard and embedded Amazon Quick Suite consoles.
...
- **Automation** colors are applied to the
  **Automation** icon.
  Use the following sections to get started with brand customization in Amazon Quick Suite.

###### Topics

- [Permisisons for Amazon Quick Suite brand
  customization](#brand-customization-permissions "#brand-customization-permissions")
- [Create a custom brand in
  Amazon Quick Suite](#brand-customization-create "#brand-customization-create")
- [Setting a default theme for
  Amazon Quick Suite analyses with the Amazon Quick Suite APIs](customizing-quicksight-default-theme.md "customizing-quicksight-default-theme.md")
...
whose roles are granted to them within Amazon Quick Suite can't create brands. To learn
more about integrating your account with IAM Identity Center, see [Configure your Amazon Quick Suite account with IAM Identity Center](../../../quicksight/latest/user/sec-identity-management-identity-center.md "../../../quicksight/latest/user/sec-identity-management-identity-center.md"). For
information about admin roles and capabilities, see [Understanding Amazon Quick Suite subscriptions and
...
The IAM role that you use to create a brand in Amazon Quick Suite must contain
...
[Create a custom brand](../../../quicksight/latest/user/brand-customization-create.md "../../../quicksight/latest/user/brand-customization-create.md") in the Amazon Quick Suite admin
console.
...
Use the following procedure to create a custom brand in Amazon Quick Suite.
...
a Amazon Quick Suite theme that can be customized.
...
all Amazon Quick Suite user accounts. If you don't want to publish the brand,
choose **SAVE** to save the brand for later.

When you finish creating a brand in Amazon Quick Suite, the new brand appears in the brands
table on the **Customize application** page of the Quick Suite admin
console. The **Status** column of the brands table indicates which
brand is currently published to the Quick Suite account. To make changes to a custom
