...
User-driven license upgrades allow users to seamlessly transition between license tiers as their needs grow. When users encounter a feature that requires a higher tier or reach their usage limits, Amazon Quick Suite provides contextual upgrade prompts to help them continue their work without interruption.
...
Users can request upgrades along the following paths:
...
When users attempt to access features not available in their current tier, Amazon Quick Suite presents contextual upgrade prompts. These prompts explain the benefits of the higher tier and guide users through the upgrade request process.
...
Users receive upgrade prompts when they approach or exceed usage limits for their current license tier. These prompts appear in context, allowing users to upgrade and continue their work without interruption.
...
- [How users upgrade their license](how-users-upgrade-license.md "how-users-upgrade-license.md")
- [Administrator configuration](administrator-configuration.md "administrator-configuration.md")
- [Managing upgrade requests](managing-upgrade-requests.md "managing-upgrade-requests.md")
- [Monitoring upgrades](monitoring-upgrades.md "monitoring-upgrades.md")
- [User-driven license upgrades FAQ](user-driven-upgrades-faqs.md "user-driven-upgrades-faqs.md")
