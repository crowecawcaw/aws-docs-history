...
When you drag a field to either a drop target or field well, Amazon Quick Suite
provides you with information about whether the target element expects a measure
or a dimension. Amazon Quick Suite also provides you with information about whether
