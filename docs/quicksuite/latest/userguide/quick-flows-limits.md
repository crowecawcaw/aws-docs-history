...
The following limits apply to flow creation and management in your Quick Suite instance:
...
Input limits vary depending on whether you're using General knowledge or Quick Suite data as your data source.

### Text input limits

- **General knowledge:** 40,000 characters
- **Quick Suite data:** 15,000 characters
...
- **Quick Suite data:** Up to 20 files
...
- **Quick Suite data:** 665,000 characters
...
- **Maximum input prompt size:**
  ...
  - Quick Suite data: 5,000 characters
