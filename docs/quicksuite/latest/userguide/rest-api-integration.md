...
With REST API Connection integration in Amazon Quick Suite, you can perform actions with custom REST APIs and web services. This integration supports action execution only.
...
Before configuring the integration in Amazon Quick Suite, prepare your REST API endpoint and authentication credentials. REST API Connection integration supports multiple authentication methods. Choose the method that matches your API requirements:
