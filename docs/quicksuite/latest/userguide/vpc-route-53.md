...
Amazon Quick Suite can't directly use Route 53 Resolver to query private DNS servers. However,
...
Developer Guide_. To use inbound endpoints in Amazon Quick Suite, provide the IP
