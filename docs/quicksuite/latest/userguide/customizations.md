...
Using Amazon Quick Suite, you can create a customized experience for people using either the
AWS Management Console or Quick Suite consoles embedded in your application.

Currently, different options for customizing Quick Suite are available
separately in the console and the Quick Suite API. Following, you can find
information about the available options.

The following customization options are currently available:

- You can customize the welcome content Quick Suite provides for new
  users:
  ...
  - You can show or hide default introductory videos. These videos include
    ...
    shown on the Amazon Quick Suite home page.
...
that is selected in the Amazon Quick Suite console.

To check your Region setting, you can use one of the following procedures.

###### To check your AWS Region on the Amazon Quick Suite console
...
- [Amazon Quick Suite brand customization](brand-customization.md "brand-customization.md")
- [Chat agent customization in Amazon Quick Suite](manage-agent.md "manage-agent.md")
