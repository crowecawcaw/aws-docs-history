...
In Amazon Quick Suite Enterprise edition, you can email a report from any sheet in a
...
When you share the dashboard with new Quick Suite user names or groups,
...
Before you begin, make sure that you are using Amazon Quick Suite Enterprise edition and
that you have shared the dashboard with intended recipients.

###### To create or change an email report

1. Open Quick Suite and choose **Dashboards** on the
...
the report title. 12. Enter the email addresses of the Quick Suite group name of the users
