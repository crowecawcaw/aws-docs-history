...
With Atlassian Confluence integration in Amazon Quick Suite, you can perform actions on
...
With Confluence actions, you can create, update, and manage pages, spaces, and other Confluence objects directly through Amazon Quick Suite. These action capabilities allow you to streamline content management tasks without leaving your Amazon Quick Suite environment.
...
- For data access: Amazon Quick Suite Professional subscription or higher.

## Prepare Atlassian app setup and authentication

Before setting up the integration in Amazon Quick Suite, prepare your Atlassian app and authentication credentials. Confluence integration supports different authentication methods depending on your integration type.
...
2. Grant permissions for Amazon Quick Suite to access your Confluence content.
