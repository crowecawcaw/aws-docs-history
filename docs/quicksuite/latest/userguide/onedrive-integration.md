...
- For data access: Amazon Quick Suite Professional subscription –
...
Before setting up the integration in Amazon Quick Suite, prepare your Microsoft App Registration and authentication credentials. OneDrive integration supports different authentication methods depending on your integration type.
...
- **Redirect URL** - OAuth redirect URI, this is the Amazon Quick Suite URL.
...
Amazon Quick Suite supports creating OneDrive knowledge base integrations using
three-legged OAuth (3LO). For this approach, Amazon Quick Suite registers a multi-tenant
...
despite being a multi-tenant application. Amazon Quick Suite can only access data through
...
Amazon Quick Suite, Azure automatically creates a Service Principal (Enterprise
...
2. Grant the requested permissions to allow Amazon Quick Suite to access your OneDrive data.
3. Complete the authentication process.

## Set up OneDrive integration

After preparing your Microsoft App Registration and authentication credentials, use the Integrations tab in the Amazon Quick Suite console to set up OneDrive integration.
...
When using One Drive integrations in Amazon Quick Suite, be aware of the following
limitations:
