...
Amazon Quick Suite](infrastructure-and-network-access.md "infrastructure-and-network-access.md").
...
Quick Suite-specific network interface to Amazon Virtual Private Cloud (Amazon VPC). When configured
