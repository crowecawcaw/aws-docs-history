...
The `periodToDateMedian` function returns the median value of the specified
...
![This is an image of the results from the example calculation.](images/PTDMedianResults.png)
