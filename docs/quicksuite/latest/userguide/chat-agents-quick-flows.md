...
Amazon Quick Flows allows you to utilize your chat agents in Quick Suite to generate outputs for any step. This feature enables your flows to utilize customized agents to explore data, analyze information, and take actions, in the context of a workflow.
