...
[Creating a custom permissions profile in Amazon Quick Suite](create-custom-permisions-profile.md "create-custom-permisions-profile.md").
...
[Using row-level security in Amazon Quick Suite](row-level-security.md "row-level-security.md").
