...
1. On the Quick Suite start page, choose **Data**.
...
7. For private connections:
   ...
   connection in Quick Suite](vpc-creating-a-connection-in-quicksight.md "vpc-creating-a-connection-in-quicksight.md"). SSL is enabled by default to ensure
