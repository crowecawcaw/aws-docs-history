...
Use a histogram chart in Amazon Quick Suite to display the distribution of continuous
numerical values in your data. Amazon Quick Suite uses un-normalized histograms, which use an
...
off to the side of the X-axis. For information about how Amazon Quick Suite handles data that
...
3. On the **Properties** pane, set the following options to
   ...
   - With the following settings, you can explore the best way to
     ...
     Amazon Quick Suite displays up to 100 bins (buckets) by default.
...
4. (Optional) Change other visual settings. For more information, see [Formatting in Amazon Quick Suite](formatting-a-visual.md "formatting-a-visual.md").
