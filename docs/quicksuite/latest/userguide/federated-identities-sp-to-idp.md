...
In this scenario, your user initiates the sign-on process from an Amazon Quick Suite
...
account on Quick Suite. Quick Suite sends an authentication request to the
IdP. After the user is authenticated, Quick Suite opens.

Beginning with the user signing into Quick Suite, authentication flows through
these steps:

1. The user opens Quick Suite. At this point, the user isn't signed in to
   the IdP.
2. The user attempts to sign in to Amazon Quick Suite.
3. Amazon Quick Suite redirects the user's input to the federation service and requests
   authentication.
...
5. Amazon Quick Suite accepts the authentication token from AWS and
   ...
   Amazon Quick Suite application portal. Amazon Quick Suite negotiates authentication with your
   organization's federation service and AWS. Amazon Quick Suite opens, without the user
