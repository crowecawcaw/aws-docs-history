...
Quick Suite accounts are charged if Generative BI is active in the account.
...
1. Ensure there are no Pro users or user groups mapped to Pro roles in the
   ...
   - To update or remove Pro users using APIs:
     - If you use Quick Suite identity (with or without IAM
       federation):
   ...
   - To update or remove Pro users using the Quick Suite
     console:
     ...
     3. If necessary, in the left navigation pane, choose
        **Manage users**.
        - If you use Quick Suite identity (with or without
          IAM federation), update user roles or delete users
          using the steps in [Viewing Amazon Quick Suite account details](managing-user-access-qs-iam.md#view-user-accounts "managing-user-access-qs-iam.md#view-user-accounts") or [Deleting a Amazon Quick Suite user account](managing-user-access-qs-iam.md#delete-a-user-account "managing-user-access-qs-iam.md#delete-a-user-account").
