...
3. Set up redirect URLs to match your Amazon Quick Suite integration configuration.
4. Note the client ID and client secret for use in Amazon Quick Suite integration setup.
