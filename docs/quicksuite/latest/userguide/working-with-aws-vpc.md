...
**If you're a Amazon Quick Suite system administrator**
configuring a VPC connection to Amazon Quick Sight, this section is for you. Amazon Quick Suite
knowledge bases currently don't support VPC integrations.

Quick Suite Enterprise edition is fully integrated with the Amazon VPC service. A
...
By creating a VPC connection in Amazon Quick Suite, you're adding elastic network interfaces
in your VPC. These network interfaces allow Amazon Quick Suite to exchange network traffic
...
apply to network traffic to and from Amazon Quick Suite in the same way that they apply to
traffic between other instances in your VPC.

When you register a VPC connection with Amazon Quick Suite, you can securely connect to data
...
as described in [Logging Amazon Quick Suite information with CloudTrail](../../../quicksight/latest/user/logging-using-cloudtrail.md "../../../quicksight/latest/user/logging-using-cloudtrail.md"). You can even create
a dashboard to help you analyze your CloudTrail logs. By combining Amazon Quick Suite logs with logs
from your other AWS services, you can get a fuller view of how your data is being
used.

You don't need to be an networking expert to connect and use a VPC with Amazon Quick Suite,
because Amazon Quick Suite provides a user interface for adding your network information.
...
- [Setting up a VPC to use with
  Amazon Quick Suite](vpc-setup-for-quicksight.md "vpc-setup-for-quicksight.md")
