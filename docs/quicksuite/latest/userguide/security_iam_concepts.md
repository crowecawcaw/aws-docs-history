...
AWS Identity and Access Management (IAM) is an AWS service that helps an administrator to more securely
control access to AWS resources. Administrators control who can be _authenticated_ (signed in) and _authorized_ (have permissions) to use Amazon Quick Suite resources. IAM is an
AWS service that you can use with no additional charge.

IAM is used with Amazon Quick Suite in several ways, including the following:

- If your company uses IAM for their identity management, people might have
  IAM user names and passwords that they use to sign in to Amazon Quick Suite.
- If you want your Amazon Quick Suite users to be automatically created at first
  sign-in, you can use IAM to create a policy for users who are preauthorized to
  use Amazon Quick Suite.
- If you want to create specialized access for specific groups of Amazon Quick Suite
  users or to specific resources, you can use IAM policies to accomplish
  this.
...
Use the following to help understand the context of the information provided in
this section, and how it applies to your role. How you use AWS Identity and Access Management (IAM) differs
depending on the work that you do in Amazon Quick Suite.

**Service user** – In some cases, you might
use Amazon Quick Suite as an Author or Reader to interact with data, analyses, and
dashboards, spaces, and agents through the Amazon Quick Suite by using the browser
interface. In these cases, this section provides only background information for
you. You don't directly interact with the IAM service, except if you use IAM to
sign into Amazon Quick Suite.

**Amazon Quick Suite administrator** – If
you're in charge of Amazon Quick Suite resources at your company, you probably have
full access to Amazon Quick Suite. It's your job to determine which Amazon Quick Suite
features and resources your team members should access. If you have specialized
requirements that you can't solve by using the Amazon Quick Suite admin panel, then you
can work with your administrator to create permissions policies for your
Amazon Quick Suite users. To learn more about IAM, read this page to understand the
basic concepts of IAM. To learn more about how your company can use IAM with
Amazon Quick Suite, see [Using Amazon Quick Suite with IAM](../../../quicksight/latest/user/security_iam_service-with-iam.md "../../../quicksight/latest/user/security_iam_service-with-iam.md").

**Administrator** – If you're a system
administrator, you might want to learn details about how you can write policies to
manage access to Amazon Quick Suite. To view examples of Amazon Quick Suite identity-based
policies that you can use in IAM, see [IAM identity-based policies for
Amazon Quick Suite](../../../quicksight/latest/user/iam-policy-examples.md#security_iam_id-based-policy-examples "../../../quicksight/latest/user/iam-policy-examples.md#security_iam_id-based-policy-examples").
...
- [AWS account root user](#security_iam_authentication-rootuser "#security_iam_authentication-rootuser")
- [IAM users and
  groups](#security_iam_authentication-iamuser "#security_iam_authentication-iamuser")
- [IAM roles](#security_iam_authentication-iamrole "#security_iam_authentication-iamrole")
