# Compliance validation for Amazon Quick Suite

Third-party auditors assess the security and compliance of Quick Suite as part of
multiple AWS compliance programs. These include FedRamp, HIPAA, PCI DSS, SOC, and ISO
(9001, 27001, 27018, and 27019).
...
For the most current list of AWS services in scope of specific compliance programs, see
...
Your compliance responsibility when using Amazon Quick Suite is determined by the sensitivity of
...
- [Architecting for HIPAA
  security and compliance paper](https://tinyurl.com/AWS-HIPAA-Compliance "https://tinyurl.com/AWS-HIPAA-Compliance") – This paper describes how
