...
Amazon Quick Suite Enterprise edition integrates with your existing directories, using either
...
In Quick Suite Standard edition, you can manage users entirely within
Quick Suite. If you prefer, you can integrate with your existing users, groups, and
roles in IAM.
...
- [IAM federation](iam-federation.md "iam-federation.md") (Standard and Enterprise editions)
...
In the regions listed below, Amazon Quick Suite accounts can only use [IAM Identity Center](../../../quicksight/latest/user/sec-identity-management-identity-center.md "../../../quicksight/latest/user/sec-identity-management-identity-center.md") for identity and access management.
...
Before you integrate your Amazon Quick Suite account with IAM Identity Center, set up IAM Identity Center in your AWS
...
store if you don't want to use a third-party identity provider with Amazon Quick Suite.
Identity methods can't be changed after your account is created.

When you integrate your Amazon Quick Suite account with IAM Identity Center, Amazon Quick Suite account
administrators can create a new Amazon Quick Suite account that automatically has the identity
provider's groups available. This simplifies asset sharing at scale in
Amazon Quick Suite.

Access to some sections of the Amazon Quick Suite administration console is restricted by
IAM permissions. The following table summarizes the admin actions that you can perform
in Amazon Quick Suite based on the access type that you choose.

To learn more how to sign up for an Amazon Quick Suite account with IAM Identity Center, see [Signing up for an
Amazon Quick Suite subscription](../../../quicksight/latest/user/signing-up.md "../../../quicksight/latest/user/signing-up.md").
...
The Amazon Quick Suite mobile app is not supported with Amazon Quick Suite accounts that are
integrated with IAM Identity Center.

### Considerations

The following actions permanently remove the ability for Amazon Quick Suite users to
sign into Amazon Quick Suite. Amazon Quick Suite does not recommend that Amazon Quick Suite users
perform these actions.

- Disabling or deleting the Amazon Quick Suite application in the IAM Identity Center console.
  If you want to delete your Amazon Quick Suite account, see [Closing your Amazon Quick Suite account](../../../quicksight/latest/user/closing-account.md "../../../quicksight/latest/user/closing-account.md").
- Migrating the Amazon Quick Suite account that contains your IAM Identity Center configuration
  to an AWS Organization that does not contain the IAM Identity Center instance that your
  Amazon Quick Suite account is configured to.
- Deleting the IAM Identity Center instance that is configured to your Amazon Quick Suite
  account.
