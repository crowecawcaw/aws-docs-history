...
You can customize tables and pivot tables in Quick Suite to meet your business
...
- [Row and column size
  in tables and pivot tables in Quick Suite](format-tables-pivot-tables-resize-rows-columns.md "format-tables-pivot-tables-resize-rows-columns.md")
