...
- **Amazon EBS volumes** — These are storage
...
- **Amazon EBS snapshots** — These are
...
- [Features of Amazon EBS](#ebs-overview "#ebs-overview")
- [Related services](#related-services "#related-services")
- [Accessing Amazon EBS](#acessing-ebs "#acessing-ebs")
- [Pricing](#ebs-pricing "#ebs-pricing")
...
- **Backup and recovery** — Use Amazon EBS
...
- **Amazon Elastic Compute Cloud** — A service that lets you
  ...
  information, see [What is Amazon EC2?](../../../AWSEC2/latest/UserGuide/concepts.md "../../../AWSEC2/latest/UserGuide/concepts.md")
- **AWS Key Management Service** — A managed service that
  ...
  For more information, see [How Amazon EBS uses AWS KMS](../../../kms/latest/developerguide/services-ebs.md "../../../kms/latest/developerguide/services-ebs.md").
...
- **EBS direct APIs** — A service that enables you
  ...
  information, see [Use EBS direct APIs to access the contents of an EBS snapshot](ebs-accessing-snapshot.md "ebs-accessing-snapshot.md").
- **Recycle Bin** — A data recovery service
...
up for an AWS account, you can access the Amazon EC2 console at [https://console.aws.amazon.com/ec2/](https://console.aws.amazon.com/ec2/ "https://console.aws.amazon.com/ec2/").
...
see the [AWS Command Line Interface User Guide](../../../cli/latest/userguide/cli-chap-welcome.md "../../../cli/latest/userguide/cli-chap-welcome.md") and the [ec2 commands](../../../cli/latest/reference/ec2.md "../../../cli/latest/reference/ec2.md").
...
those resources for you. For more information, see the [AWS CloudFormation User Guide](../../../AWSCloudFormation/latest/UserGuide/Welcome.md "../../../AWSCloudFormation/latest/UserGuide/Welcome.md").
...
For more information see the [Amazon EC2 API Reference](../../../AWSEC2/latest/APIReference/Welcome.md "../../../AWSEC2/latest/APIReference/Welcome.md").
...
For more information, see [Tools to
Build on AWS](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/").
