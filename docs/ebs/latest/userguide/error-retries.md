...
| `ConflictException`                                              | 409           | The specified client token was previously used in a similar request that had different request parameters. For more information, see [Ensure idempotency in StartSnapshot API requests](ebs-direct-api-idempotency.md "ebs-direct-api-idempotency.md"). | StartSnapshot    | No               |
