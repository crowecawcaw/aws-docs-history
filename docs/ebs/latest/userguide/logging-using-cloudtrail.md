...
Amazon Data Lifecycle Manager (Amazon Data Lifecycle Manager) is integrated with AWS CloudTrail, a service that provides a record of actions taken
by a user, role, or an AWS service in Amazon Data Lifecycle Manager. CloudTrail captures all API calls for Amazon Data Lifecycle Manager as events, including calls from
the Amazon Data Lifecycle Manager console and from code calls to the Amazon Data Lifecycle Manager APIs. If you create a trail, you can enable
continuous delivery of CloudTrail events to an Amazon S3 bucket, including events for Amazon Data Lifecycle Manager. If you don't configure a trail,
...
you can determine the request that was made to Amazon Data Lifecycle Manager, the IP address from which the
...
Amazon Data Lifecycle Manager, that activity is recorded in a CloudTrail event along with other AWS service
...
For an ongoing record of events in your AWS account, including events for Amazon Data Lifecycle Manager,
...
All Amazon Data Lifecycle Manager actions are logged by CloudTrail. For example, calls to the
`CreateLifecyclePolicy` and `DeleteLifecyclePolicy` actions generate
entries in the CloudTrail log files. For the complete list of actions, see [Actions](../../../dlm/latest/APIReference/API_Operations.md "../../../dlm/latest/APIReference/API_Operations.md").
