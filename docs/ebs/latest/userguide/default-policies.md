...
**Topics**
+ [Considerations for default policies](#default-policy-considerations)
+ [Create default policy for Amazon EBS snapshots](#default-snapshot-policy)
+ [Create default policy for EBS-backed AMIs](#default-ami-policy)
