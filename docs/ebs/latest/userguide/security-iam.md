...
+ [How Amazon EBS works with IAM](security_iam_service-with-iam.md)
+ [Example IAM policies for Amazon EBS](security_iam_id-based-policy-examples.md)
+ [Troubleshoot Amazon EBS authorization issues](security_iam_troubleshoot.md)
