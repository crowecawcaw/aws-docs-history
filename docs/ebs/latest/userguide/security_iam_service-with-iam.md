...
Before you use IAM to manage access to Amazon EBS, learn what IAM features are
available to use with Amazon EBS.

| IAM features you can use with Amazon Elastic Block Store                                                                                                 | IAM feature | Amazon EBS support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------ |
...
To get a high-level view of how Amazon EBS and other AWS services work with most IAM
...
To see a list of Amazon EBS actions, see [Actions, resources, and condition keys for Amazon EC2](../../../service-authorization/latest/reference/list_amazonec2.md "../../../service-authorization/latest/reference/list_amazonec2.md") and [Actions, resources, and condition keys for Amazon EBS](../../../service-authorization/latest/reference/list_amazonelasticblockstore.md "../../../service-authorization/latest/reference/list_amazonelasticblockstore.md")
in the _Service Authorization Reference_.

Policy actions in Amazon EBS use either the `ec2` or the `ebs`
...
Some Amazon EBS API actions support multiple resources. To specify multiple
resources in a single statement, separate the ARNs with commas. For example,
`DescribeVolumes` accesses vol-01234567890abcdef and vol-09876543210fedcba,
so a principal must have permissions to access both resources.
...
For example, the following condition allows the principal to perform an action
on a volume only if the volume type is `gp2`.
...
To see a list of Amazon EBS condition keys, see [Actions, resources, and condition keys](../../../service-authorization/latest/reference/list_amazonec2.md#amazonec2-policy-keys "../../../service-authorization/latest/reference/list_amazonec2.md#amazonec2-policy-keys") in the _Service Authorization Reference_.
