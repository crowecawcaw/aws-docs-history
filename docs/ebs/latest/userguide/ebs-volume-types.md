...
an EBS volume, use [EBS–optimized instances](../../../AWSEC2/latest/UserGuide/ebs-optimized.md "../../../AWSEC2/latest/UserGuide/ebs-optimized.md").
For more information about getting the most out of your EBS volumes, see [Amazon EBS volume performance](ebs-performance.md "ebs-performance.md").
...
- [Solid state drive (SSD) volumes](#vol-type-ssd "#vol-type-ssd")
- [Hard disk drive (HDD) volumes](#vol-type-hdd "#vol-type-hdd")
- [Previous generation volumes](#vol-type-prev "#vol-type-prev")
...
|                             | [Amazon EBS General Purpose SSD volumes](general-purpose.md "general-purpose.md")                                                                                                               | [Amazon EBS Provisioned IOPS SSD volumes](provisioned-iops.md "provisioned-iops.md")                                                                                                                  |
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- | --------------------- |
| **Volume type**             | `gp3` 6                                                                                                                                                                                         | `gp2`                                                                                                                                                                                                 | `io2` Block Express                                                                                                   | `io1`                 |
| **Durability**              | 99.8%<br>• 99.9% durability (0.1%<br>• 0.2% annual failure rate)                                                                                                                                | 99.999% durability (0.001% annual failure rate)                                                                                                                                                       | 99.8%<br>• 99.9% durability (0.1%<br>• 0.2% annual failure rate)                                                      |
| **Use cases**               | • Transactional workloads<br>• Virtual desktops<br>• Medium-sized, single-instance databases<br>• Low-latency interactive applications<br>• Boot volumes<br>• Development and test environments | Workloads that require:<br>• Consistent sub-millisecond latency with average latency under 500 microseconds 5<br>• Sustained IOPS performance<br>• More than 80,000 IOPS or 2,000 MiB/s of throughput | • Workloads that require sustained IOPS performance or more than<br>16,000 IOPS<br>• I/O-intensive database workloads |
| **Volume size**             | 1 GiB<br>• 64 TiB                                                                                                                                                                               | 1 GiB<br>• 16 TiB                                                                                                                                                                                     | 4 GiB<br>• 64 TiB                                                                                                     | 4 GiB<br>• 16 TiB     |
...
MiB/s, depending on the volume size. For more information, see [gp2 volume performance](general-purpose.md#gp2-performance "general-purpose.md#gp2-performance"). Volumes created before **December 3,
2018** that have not been modified since creation might not reach full performance
unless you [modify the volume](ebs-modify-volume.md "ebs-modify-volume.md").

2 To achieve maximum throughput of 1,000 MiB/s, the volume must
be provisioned with 64,000 IOPS and it must be attached to a [Nitro-based instance](../../../ec2/latest/instancetypes/ec2-nitro-instances.md "../../../ec2/latest/instancetypes/ec2-nitro-instances.md"). Volumes created before **December
6, 2017** that have not been modified since creation might not reach full performance
unless you [modify the volume](ebs-modify-volume.md "ebs-modify-volume.md").

3 [Nitro-based instances](../../../ec2/latest/instancetypes/ec2-nitro-instances.md "../../../ec2/latest/instancetypes/ec2-nitro-instances.md") support volumes provisioned with up to 256,000 IOPS. Other instance
...
- [Amazon EBS General Purpose SSD volumes](general-purpose.md "general-purpose.md")
- [Amazon EBS Provisioned IOPS SSD volumes](provisioned-iops.md "provisioned-iops.md")
...
|                                          | [Throughput Optimized HDD volumes](hdd-vols.md#EBSVolumeTypes_st1 "hdd-vols.md#EBSVolumeTypes_st1") | [Cold HDD volumes](hdd-vols.md#EBSVolumeTypes_sc1 "hdd-vols.md#EBSVolumeTypes_sc1")                                            |
| ---------------------------------------- | --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **Volume type**                          | `st1`                                                                                               | `sc1`                                                                                                                          |
| **Durability**                           | 99.8%<br>• 99.9% durability (0.1%<br>• 0.2% annual failure rate)                                    |
...
| **Volume size**                          | 125 GiB<br>• 16 TiB                                                                                 |
| \*_Max IOPS per volume_<br>• (1 MiB I/O) | 500                                                                                                 | 250                                                                                                                            |
| **Max throughput per volume**            | 500 MiB/s                                                                                           | 250 MiB/s                                                                                                                      |
| **Amazon EBS Multi-attach**              | Not supported                                                                                       |
| **Boot volume**                          | Not supported                                                                                       |

For more information about the Hard disk drives (HDD) volumes, see [Amazon EBS Throughput Optimized HDD and Cold HDD volumes](hdd-vols.md "hdd-vols.md").
