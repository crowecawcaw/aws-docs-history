...
For using AWS Identity and Access Management ([IAM](https://aws.amazon.com/iam/ "https://aws.amazon.com/iam/")) permissions.
...
2. Create a GraphQL API object by running the [`update-graphql-api`](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/update-graphql-api.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appsync/update-graphql-api.html") command.
...
to Lambda functions, see [Resource-based policies](../../../lambda/latest/dg/access-control-resource-based.md#permissions-resource-serviceinvoke "../../../lambda/latest/dg/access-control-resource-based.md#permissions-resource-serviceinvoke") in the AWS Lambda Developer Guide.
...
`arn:aws:appsync:`us-east-1`:`111122223333`:apis/`GraphQLApiId`/types/`TypeName`/fields/`FieldName`  or a short form of
 `TypeName`.`FieldName``.
...
**AWS Lambda**. 3. Choose the AWS Region and Lambda ARN to authorize API calls
against.

###### Note

The appropriate principal policy will be added automatically, allowing
AWS AppSync to call your Lambda function. 4. Optionally, set the response TTL and token validation regular
expression.
...
Management ([IAM](https://aws.amazon.com/iam/ "https://aws.amazon.com/iam/")) access policies with this authorization type.
...
Discovery](https://openid.net/specs/openid-connect-discovery-1_0.html "https://openid.net/specs/openid-connect-discovery-1_0.html") specification. It expects to retrieve an [RFC5785](https://tools.ietf.org/html/rfc5785 "https://tools.ietf.org/html/rfc5785") compliant JSON document at
