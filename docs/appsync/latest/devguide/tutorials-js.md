...
- [Using OpenSearch Service resolvers](tutorial-elasticsearch-resolvers-js.md "tutorial-elasticsearch-resolvers-js.md")
- [Performing DynamoDB transactions](tutorial-dynamodb-transact-js.md "tutorial-dynamodb-transact-js.md")
- [Using DynamoDB batch operations](tutorial-dynamodb-batch-js.md "tutorial-dynamodb-batch-js.md")
- [Using HTTP resolvers](tutorial-http-resolvers-js.md "tutorial-http-resolvers-js.md")
- [Using Aurora PostgreSQL with Data API](aurora-serverless-tutorial-js.md "aurora-serverless-tutorial-js.md")
