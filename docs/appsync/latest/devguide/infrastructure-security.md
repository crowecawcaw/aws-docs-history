...
As a managed service, AWS AppSync is protected by AWS global network security. For
...
You use AWS published API calls to access AWS AppSync through the network. Clients must
