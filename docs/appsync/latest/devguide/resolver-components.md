...
![GraphQL request flow showing sequential processing through request and response functions with data source interactions.](/images/appsync/latest/devguide/images/appsync-js-resolver-logic.png)
