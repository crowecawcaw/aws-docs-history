...
Third-party auditors assess the security and compliance of AWS AppSync as part of
multiple AWS compliance programs. AWS AppSync is compliant with SOC, PCI, HIPAA/HIPAA BAA, IRAP, C5, ENS High, OSPAR,
and HITRUST CSF programs.
