...
![GraphQL API architecture showing schema, resolvers, and data sources connected by arrows.](https://docs.aws.amazon.com/appsync/latest/devguide/images/appsync-architecture-graphql-api.png)
