...
To see a list of AWS AppSync actions, see [Actions defined by AWS AppSync](../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-actions-as-permissions "../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-actions-as-permissions") in the
...
To see a list of AWS AppSync resource types and their ARNs, see [Resources defined by AWS AppSync](../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-resources-for-iam-policies")
...
To see a list of AWS AppSync condition keys, see [Condition keys for AWS AppSync](../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-policy-keys "../../../service-authorization/latest/reference/list_awsappsync.md#awsappsync-policy-keys") in the
...
that work with
IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in
