...
You use AWS published API actions to access Amazon SQS through the network. Clients must
...
You must sign requests using an access key ID and a secret access key associated with an
IAM principal. Alternatively, you can use the [AWS Security Token Service](../../../STS/latest/APIReference/Welcome.md "../../../STS/latest/APIReference/Welcome.md") (AWS STS) to generate
temporary security credentials for signing requests.

You can call these API actions from any network location, but Amazon SQS supports
