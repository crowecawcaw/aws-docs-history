...
- **Manual deletion** – You explicitly delete
  messages using the [`DeleteMessage`](../APIReference/API_DeleteMessage.md "../APIReference/API_DeleteMessage.md") action.
- **Automatic deletion** – Supported in certain
  AWS SDKs, messages are automatically deleted upon successful processing,
  simplifying workflows.

![Time line graph displaying how requests are processed during visibility timeout](images/sqs-visibility-timeout-diagram.png)
...
changing the queue's overall setting. Use the [`ChangeMessageVisibility`](../APIReference/API_ChangeMessageVisibility.md "../APIReference/API_ChangeMessageVisibility.md") action to programmatically extend
...
- **Changing the timeout** – Adjust the
  visibility timeout dynamically using [`ChangeMessageVisibility`](../APIReference/API_ChangeMessageVisibility.md "../APIReference/API_ChangeMessageVisibility.md"). This allows you to extend
