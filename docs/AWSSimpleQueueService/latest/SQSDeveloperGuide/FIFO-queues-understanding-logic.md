...
1. **Producer retries**
   - If a [`SendMessage`](../APIReference/API_SendMessage.md "../APIReference/API_SendMessage.md") action fails, the producer
...
2. **Consumer retries**
   - If a [`ReceiveMessage`](../APIReference/API_ReceiveMessage.md "../APIReference/API_ReceiveMessage.md") action fails, the
