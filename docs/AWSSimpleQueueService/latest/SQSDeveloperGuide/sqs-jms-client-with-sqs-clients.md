...
JMS Client with the Amazon SQS Extended Client Library for Java to send an Amazon SQS message that contains a
reference to a message payload (up to 2 GB) in Amazon S3. For more information, see [Managing large Amazon SQS messages using Java and Amazon S3](sqs-s3-messages.md "sqs-s3-messages.md").

The following Java code example creates the JMS provider for the
