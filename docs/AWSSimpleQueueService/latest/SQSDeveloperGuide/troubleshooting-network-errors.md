...
+ **Check network settings**
  ...
  + Amazon Elastic Compute Cloud (Amazon EC2) instances that connect to the public internet must have [internet connectivity](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Internet_Gateway.html#vpc-igw-internet-access).
...
If you received an unsuccessful output, follow the instructions in [How does DNS work and how do I troubleshoot partial or intermittent DNS failures?](https://repost.aws/knowledge-center/sqs-connection-error) in the *AWS Knowledge Center Guide*.
