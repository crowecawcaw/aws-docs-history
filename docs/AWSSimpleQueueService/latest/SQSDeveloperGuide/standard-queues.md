...
number of API calls per second for actions like [`SendMessage`](../APIReference/API_SendMessage.md "../APIReference/API_SendMessage.md"), [`ReceiveMessage`](../APIReference/API_ReceiveMessage.md "../APIReference/API_ReceiveMessage.md"), and [`DeleteMessage`](../APIReference/API_DeleteMessage.md "../APIReference/API_DeleteMessage.md"). Standard queues ensure at-least-once message
...
- **Batching messages for future processing** –
  ...
  For information on quotas related to standard queues, see [Amazon SQS standard queue quotas](quotas-queues.md "quotas-queues.md").

For best practices of working with standard queues, see [Amazon SQS best practices](sqs-best-practices.md "sqs-best-practices.md").
