...
For code samples that use Maven, the Spring Framework, and the Amazon SQS Java Messaging Library, see [Working Java examples for using JMS with Amazon SQS standard queues](sqs-jms-code-examples.md).  
