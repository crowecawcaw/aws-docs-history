...
+ [Identity and access management in Amazon SQS](security-iam.md)
...
For more information, see [Encryption at rest in Amazon SQS](sqs-server-side-encryption.md) and [Amazon SQS Key management](sqs-key-management.md).
