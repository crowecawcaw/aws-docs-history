...
- To learn whether Amazon SQS supports these features, see [How Amazon Simple Queue Service works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
...
queues. For instructions on how to check your AWS Organizations policies, see [Listing all policies](../../../organizations/latest/userguide/orgs_manage_policies_info-operations.md#list-all-pols-in-org.html "../../../organizations/latest/userguide/orgs_manage_policies_info-operations.md#list-all-pols-in-org.html") in the _AWS Organizations User Guide_.
...
privileged task on an AWS Organizations member account](../../../IAM/latest/UserGuide/id_root-user-privileged-task.md "../../../IAM/latest/UserGuide/id_root-user-privileged-task.md") in the _IAM User
Guide_.
