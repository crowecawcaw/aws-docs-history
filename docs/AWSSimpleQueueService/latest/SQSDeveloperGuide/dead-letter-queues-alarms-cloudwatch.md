...
instructions, see [Creating CloudWatch alarms for Amazon SQS metrics](set-cloudwatch-alarms-for-metrics.md "set-cloudwatch-alarms-for-metrics.md"). When the alarm triggers, indicating
