...
| IAM features you can use with Amazon Simple Queue Service                                                                                                                   | IAM feature | Amazon SQS support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------ |
...
To see a list of Amazon SQS actions, see [Resources Defined by Amazon Simple Queue Service](../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-resources-for-iam-policies") in the
...
[Actions Defined by Amazon Simple Queue Service](../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-actions-as-permissions "../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-actions-as-permissions") in the _Service Authorization Reference_. To learn with
...
To see a list of Amazon SQS condition keys, see [Condition Keys for Amazon Simple Queue Service](../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-policy-keys "../../../IAM/latest/UserGuide/list_amazonsqs.md#amazonsqs-policy-keys") in the
