...
<a name="AWSManagedSettingsAdminAccess"></a>
...
`AWSManagedSettingsAdminAccess` is an [AWS managed policy](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html#aws-managed-policies).

## Using this policy
<a name="AWSManagedSettingsAdminAccess-how-to-use"></a>
...
<a name="AWSManagedSettingsAdminAccess-json"></a>
