...
`AWSIoTManagedIntegrationsFullAccess` is an [AWS managed policy](../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies "../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies").
...
- **Edited time:** March 05, 2025, 19:22 UTC
- **ARN**:
  `arn:aws:iam::aws:policy/AWSIoTManagedIntegrationsFullAccess`
