...
<a name="AWSResilienceHubV2AssessmentExecutionPolicy"></a>
...
`AWSResilienceHubV2AssessmentExecutionPolicy` is an [AWS managed policy](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html#aws-managed-policies).

## Using this policy
<a name="AWSResilienceHubV2AssessmentExecutionPolicy-how-to-use"></a>

You can attach `AWSResilienceHubV2AssessmentExecutionPolicy` to your users, groups, and roles.

## Policy details
<a name="AWSResilienceHubV2AssessmentExecutionPolicy-details"></a>
...
## Policy version
<a name="AWSResilienceHubV2AssessmentExecutionPolicy-version"></a>
...
<a name="AWSResilienceHubV2AssessmentExecutionPolicy-json"></a>
...
## Learn more
<a name="AWSResilienceHubV2AssessmentExecutionPolicy-learn-more"></a>
