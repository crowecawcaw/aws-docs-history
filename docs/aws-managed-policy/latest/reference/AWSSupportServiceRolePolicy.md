...
`AWSSupportServiceRolePolicy` is an [AWS managed policy](../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies "../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies").
...
- **Edited time:** August 19, 2026, 17:37 UTC
- **ARN**:
  `arn:aws:iam::aws:policy/aws-service-role/AWSSupportServiceRolePolicy`

## Policy version

**Policy version:** v59 (default)
