...
managed policies](../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies "../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md#aws-managed-policies") in the IAM User Guide.
...
- **Policy details**
  - **Type** – The type of AWS managed policy
    ...
    - `Service-linked role policy` – Policy that is attached to a
      service-linked role that allows a service to perform actions on your behalf, such as [AmazonRDSPreviewServiceRolePolicy](AmazonRDSPreviewServiceRolePolicy.md "AmazonRDSPreviewServiceRolePolicy.md")
    - `Service role policy` – Policy designed to work with service roles,
      such as [AWSControlTowerServiceRolePolicy](AWSControlTowerServiceRolePolicy.md "AWSControlTowerServiceRolePolicy.md")
