...
You can specify a maximum of 50 IDs, one per line. For more information about how to use Targets, see [Sending Commands to a Fleet](../../../systems-manager/latest/userguide/send-commands-multiple.md "../../../systems-manager/latest/userguide/send-commands-multiple.md").

This parameter is required if _Select Targets by_ is set to _Manually select instances_.

### Tags

A list of tags that targets instances using a Key=Value combination that you specify, one per line. For more information about how to use Targets, see [Sending Commands to a Fleet](../../../systems-manager/latest/userguide/send-commands-multiple.md "../../../systems-manager/latest/userguide/send-commands-multiple.md").
...
For more information about how to use MaxConcurrency, see [Using Concurrency Controls](../../../systems-manager/latest/userguide/send-commands-multiple.md#send-commands-velocity "../../../systems-manager/latest/userguide/send-commands-multiple.md#send-commands-velocity").
...
For more information about how to use MaxErrors, see [Using Error Controls](../../../systems-manager/latest/userguide/send-commands-multiple.md#send-commands-maxerrors "../../../systems-manager/latest/userguide/send-commands-multiple.md#send-commands-maxerrors").
...
The different events for which you can receive notifications. For more information see [Setting Up Events and Notifications](../../../systems-manager/latest/userguide/monitor-commands.md "../../../systems-manager/latest/userguide/monitor-commands.md").

### Notification Type

- _Command_: Receive notification when the status of a command changes.
