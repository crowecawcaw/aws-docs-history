...
<a name="create-s3-bucket-if-it-does-not-exist"></a>
...
For more information see [Storage Classes](https://docs.aws.amazon.com/AmazonS3/latest/userguide/storage-class-intro.html) in the Amazon S3 documentation for more information.
