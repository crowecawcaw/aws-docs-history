...
<a name="archiving-build-artifacts-with-the-aws-s3-upload-task"></a>
...
<a name="add-the-s3-upload-task-to-the-build-definition"></a>
...
<a name="configure-the-task-properties"></a>
+ **AWS Credentials**
