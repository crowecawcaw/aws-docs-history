...
<a name="secretsmanager-create-update"></a>
...
<a name="secret-value-location"></a>
...
<a name="path-to-file-containing-secret-value"></a>
...
<a name="create-secret-if-it-does-not-exist"></a>
...
<a name="output-variable-name-to-contain-the-secret-s-arn"></a>
...
<a name="output-variable-name-to-contain-the-secret-s-version-id"></a>
