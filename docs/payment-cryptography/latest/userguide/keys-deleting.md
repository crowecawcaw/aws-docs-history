...
**Example**  
In this example, a key is requested to be deleted. Besides the basic key information, two relevant fields are that key state has been changed to DELETE\_PENDING and deletePendingTimestamp represents when the key is currently scheduled to delete.   
