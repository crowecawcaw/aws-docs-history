...
CVN14 and CVN15 utilize the [EMV CSK method](use-cases-issuers.generalfunctions.arqc.md "use-cases-issuers.generalfunctions.arqc.md") of key derivation. The exact transaction data varies between these two methods - please see the scheme documentation for details on
