...
The PGK must be a key of algorithm TDES\_2KEY based on the PVV algorithm itself. A PEK can be TDES\_2KEY, TDES\_3KEY or AES\_128. In this case, since the PEK is intended for internal use within your system, AES\_128 would be a good choice. If a PEK is used for interchange with other systems (e.g. card networks, acquirers, ATMs) or are being moved as part of a migration, TDES\_2KEY may be the more appropriate choice for compatibility reasons. 
