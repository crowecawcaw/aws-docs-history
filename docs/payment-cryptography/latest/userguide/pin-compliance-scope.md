...
**Topics**
+ [Shared Responsibility](pin-compliance-scope-sr.md)
+ [High-Level Network Diagrams](pin-compliance-scope-diagram.md)
+ [Key Table](pin-compliance-scope-kt.md)
+ [Document References](pin-compliance-scope-dr.md)