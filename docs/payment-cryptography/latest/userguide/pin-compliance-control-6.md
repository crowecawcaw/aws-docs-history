...
*Requirement 22:* Key compromise procedures for AWS Payment Cryptography were assessed as part of the service’s PCI PIN assessment. You will need to describe key compromise detection and response procedures, including [monitoring and response to notification from AWS](https://aws.amazon.com/security-incident-response/).
