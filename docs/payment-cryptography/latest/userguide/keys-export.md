...
| KP          | Key check value of the [KBPK](terminology.md#terms.kbpk "terminology.md#terms.kbpk") | 2 hex characters represent the KCV method (00 for X9.24 method and 01 for CMAC method). Followed by KCV value<br>which is typically 6 hex characters. For example 010FA329 represents KCV of 0FA329 calculated using 01(CMAC) method.              | Computed according to ANSI X9.24-1-2017 Annex A; the KCV is used for key validation not as an integrity mechanism.                                                                                                                                                                                                                                 |
