...
**Topics**
+ [Shared Responsibility](#compliance.pin.commontopics.sharedresponsibility)
+ [Minimum HSM configuration](#compliance.pin.commontopics.hsmconfig)
+ [Key exchange between customer and APC](#compliance.pin.commontopics.keyconfig)
