...
![The Amazon Kendra console showing the total document count for an index.](https://docs.aws.amazon.com/kendra/latest/dg/images/IndexDocumentCount.png)
...
![The Amazon Kendra console showing the average queries per second for an index.](https://docs.aws.amazon.com/kendra/latest/dg/images/IndexQueriesPerSecond.png)
...
![The Amazon Kendra console showing the sync run history for a data source.](https://docs.aws.amazon.com/kendra/latest/dg/images/SyncRunHistory.png)
...
![The Amazon Kendra console showing the total document count for a data source.](https://docs.aws.amazon.com/kendra/latest/dg/images/DocumentCount.png)
...
![The Amazon Kendra console showing the the number of documents scanned for a data source.](https://docs.aws.amazon.com/kendra/latest/dg/images/DocumentScans.png)
...
![The Amazon Kendra console showing the the average run time for a data source sync.](https://docs.aws.amazon.com/kendra/latest/dg/images/AverageRunTime.png)