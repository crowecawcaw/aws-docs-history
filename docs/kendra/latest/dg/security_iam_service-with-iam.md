...
|  [API\_ListTagsForResource](https://docs.aws.amazon.com/kendra/latest/dg/API_ListTagsForResource.html)  | data source, FAQ, index |   | 
| [TagResource](https://docs.aws.amazon.com/kendra/latest/dg/API_TagResource.html)  | data source, FAQ, index | aws:RequestTag, aws:TagKeys | 
| [UntagResource](https://docs.aws.amazon.com/kendra/latest/dg/API_UntagResource.html)  | data source, FAQ, index | aws:TagKeys | 
