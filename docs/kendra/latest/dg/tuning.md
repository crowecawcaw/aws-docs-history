...
You tune the relevance of a field or attribute at the index level by using either the [console](https://console.aws.amazon.com/kendra/) to set tuning in the index details or the [UpdateIndex](https://docs.aws.amazon.com/kendra/latest/APIReference/API_UpdateIndex.html) API.
...
You tune the relevance of a field or attribute at the query level by using the [Query](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Query.html) API.
