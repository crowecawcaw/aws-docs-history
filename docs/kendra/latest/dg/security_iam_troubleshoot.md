# Troubleshooting Amazon Kendra Identity
...
- [I am not authorized to
  perform an action in Amazon Kendra](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
- [I am not authorized to perform
  iam:PassRole](#security_iam_troubleshoot-passrole "#security_iam_troubleshoot-passrole")
- [I'm an administrator and I
  want to allow others to access Amazon Kendra](#security_iam_troubleshoot-admin-delegate "#security_iam_troubleshoot-admin-delegate")
- [I want to allow people
  outside of my AWS account to access my Amazon Kendra resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Amazon Kendra
...
want to allow others to access Amazon Kendra
...
outside of my AWS account to access my Amazon Kendra resources
