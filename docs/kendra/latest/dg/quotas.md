...
## Quotas
<a name="quota-details"></a>

Service quotas, also referred to as limits, are the maximum number of service resources for your AWS account. For more information, see [Amazon Kendra service quotas](https://docs.aws.amazon.com/general/latest/gr/kendra.html) in the *AWS General Reference*.

**Note**  
Quotas for Amazon Kendra GenAI Enterprise Edition indices aren't currently available in the Service Quotas console.

### Index quotas
<a name="quotas-index"></a>
...
| Amount of text extracted for an index in a single unit (Enterprise). You can add up to 100 extra units for extracting text for the Enterprise Edition, or simply contact [Support](https://aws.amazon.com/contact-us/). | 30 GB | GenAI Enterprise | Yes | 
...
<a name="quotas-kendra-experience"></a>
...
<a name="quotas-query-search-results"></a>
...
| Amount of queries per second for an index in a single unit (Enterprise). You can add up to 100 extra units for queries for the Enterprise Edition, or simply contact [Support](https://aws.amazon.com/contact-us/). | 0.1 | Enterprise | Yes | 
...
| Maximum number of search results per query. Default is 100. To allow more than 100 results, simply contact [Support](https://aws.amazon.com/contact-us/). | 100 | Developer, Enterprise | Yes | 
| Maximum number of search results per page | 100 | Developer, Enterprise | Yes | 
| Maximum number of token words per query text before truncation. Default is 30. To allow more than 30 words, simply contact [Support](https://aws.amazon.com/contact-us/). | 30 | Developer, Enterprise | Yes | 
...
<a name="quotas-query-suggestions"></a>


| Description | Default | Edition | Adjustable | 
| --- | --- | --- | --- | 
| Maximum number of query suggestions returned per [GetQuerySuggestions](https://docs.aws.amazon.com/kendra/latest/APIReference/API_GetQuerySuggestions.html) call | 10 | Developer, Enterprise | Yes | 
| Maximum number of fields/attributes for query suggestions per [GetQuerySuggestions](https://docs.aws.amazon.com/kendra/latest/APIReference/API_GetQuerySuggestions.html) call | 10 | Developer, Enterprise | Yes | 
| Maximum number of additional fields/attributes for query suggestions per [GetQuerySuggestions](https://docs.aws.amazon.com/kendra/latest/APIReference/API_GetQuerySuggestions.html) call | 5 | Developer, Enterprise | Yes | 
...
### Document quotas
<a name="quotas-document"></a>


| Description | Default | Edition | Adjustable | 
| --- | --- | --- | --- | 
| Amount of text extracted for an index in a single unit (Developer). You can't add extra units for extracting text for the Developer Edition. | 3 GB | Developer | No | 
| Amount of text extracted for an index in a single unit (Enterprise). You can add up to 100 extra units for extracting text for the Enterprise Edition, or simply contact [Support](https://aws.amazon.com/contact-us/). | 30 GB | Enterprise | Yes | 
...
<a name="quotas-featured-results"></a>
...
<a name="quotas-rescore-results"></a>
