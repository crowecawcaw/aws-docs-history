...
| `OneMonth`     | `myindex-2016-02`       | ###### Note With the `OneWeek` option, Data Firehose auto-create indexes using the format of <YEAR>-w<WEEK NUMBER> (for example, `2020-w33`), where the week number is calculated using UTC time and according to the following US conventions: <br>• A week starts on Sunday <br>• The first week of the year is the first week that contains a Saturday in this year |
