...
Data at rest and data in transit can be encrypted in Amazon Data Firehose. For more information, see [Data protection in Amazon Data Firehose](encryption.md).
