...
**Topics**
+ [Understand delivery across AWS accounts and regions](across.md)
+ [Understand HTTP endpoint delivery request and response specifications](httpdeliveryrequestresponse.md)
+ [Handle data delivery failures](retry.md)
