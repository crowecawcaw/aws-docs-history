...
1. Choose a source and destination. For more information, see [Tutorial: Create a Firehose stream from console](basic-create.md).

1. Choose the destination settings. For more information, see [Configure destination settings](create-destination.md).

1. Under [**Advanced settings**](create-configure-advanced.md), for **Service access**, choose **Create or update IAM role**.
**Note**  
