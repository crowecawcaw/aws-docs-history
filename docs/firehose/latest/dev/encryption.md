...
When you use a [customer managed key](../../../kms/latest/developerguide/concepts.md#customer-cmk "../../../kms/latest/developerguide/concepts.md#customer-cmk") (CUSTOMER\_MANAGED\_CMK) to enable server-side encryption (SSE) for your Firehose stream,
