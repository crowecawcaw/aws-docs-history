...
Amazon Data Firehose is a fully managed service for delivering real-time [streaming data](http://aws.amazon.com/streaming-data/ "http://aws.amazon.com/streaming-data/") to destinations such as
...
For more information about AWS big data solutions, see [Big Data on AWS](http://aws.amazon.com/big-data/ "http://aws.amazon.com/big-data/"). For more information about
AWS streaming data solutions, see [What is
Streaming Data?](http://aws.amazon.com/streaming-data/ "http://aws.amazon.com/streaming-data/")
...
then sending data to it. For more information, see [Tutorial: Create a Firehose stream from console](basic-create.md "basic-create.md") and [Send data to a Firehose stream](basic-write.md "basic-write.md").
...
data stream, and load it into destinations. For more information, see [Send data to a Firehose stream](basic-write.md "basic-write.md").
...
![A diagram showing the Amazon Data Firehose data flow for Amazon S3.](images/fh-flow-s3.png)
...
![A diagram showing Amazon Data Firehose data flow for Amazon Redshift.](images/fh-flow-rs.png)
...
![A diagram showing Amazon Data Firehose data flow for OpenSearch Service.](images/fh-flow-es.png)
...
![A diagram showing Amazon Data Firehose data flow for Splunk.](images/fh-flow-splunk.png)
