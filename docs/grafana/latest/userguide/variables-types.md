...
| --- | --- | --- | 
|  ${\_\_from}  |  1594671549254  |  Unix millisecond epoch  | 
|  ${\_\_from:date}  |  2020-07-13T20:19:09.254Z  |  No args, defaults to ISO 8601/RFC 3339  | 
|  ${\_\_from:date:iso}  |  2020-07-13T20:19:09.254Z  |  ISO 8601/RFC 3339  | 
|  ${\_\_from:date:seconds}  |  1594671549  |  Unix seconds epoch  | 
|  ${\_\_from:date:YYYY-MM}  |  2020-07  |  Any custom data format. For more information, see [ Display](https://momentjs.com/docs/#/displaying/).  | 
