...
**Topics**
+ [Use AWS data source configuration to add AWS IoT SiteWise as a data source](IoTSiteWise-adding-AWS-config.md)
+ [Manually adding the AWS IoT SiteWise data source](iotsitewise-add-the-data-source.md)
+ [AWS IoT SiteWise settings](#iotsitewise-settings)
+ [Using the AWS IoT SiteWise data source](IoTSiteWise-using.md)
