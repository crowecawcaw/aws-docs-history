...
Annotations support Cron syntax for time regions, providing more precise control
over time-based annotations.

You can annotate visualizations in three ways:

- Directly in the panel, using the [built-in annotations query](#v12-dash-built-in-query "#v12-dash-built-in-query").
...
Grafana HTTP API, refer to [Annotations API](v12-Grafana-API-Annotations.md "v12-Grafana-API-Annotations.md").
...
using the [built-in annotations query](#v12-dash-built-in-query "#v12-dash-built-in-query") that
