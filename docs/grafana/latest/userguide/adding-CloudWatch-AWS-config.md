...
1. On the navigation pane, choose the menu icon and then choose **All workspaces**.
...
1. Select the check box for **Amazon CloudWatch** and then choose **Actions**, **Enable service-managed policy**.

1. Choose the **Data sources** tab again. 

1. Choose **Configure in Grafana** in the **Amazon CloudWatch** row.

1. Sign in to the Grafana workspace console using IAM Identity Center, if necessary.

1. On the navigation bar in the Grafana workspace console, choose the AWS icon and then choose **AWS services**, **CloudWatch**.

1. Select the default Region that you want the CloudWatch data source to query from. 

1. Select the accounts that you want, and then choose **Add data source**.