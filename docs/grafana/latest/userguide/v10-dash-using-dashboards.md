...
| **9. Zoom out time<br>range**              | Use to zoom out the time range. For more information about how<br>to use time range controls, see [Setting dashboard time range](#v10-dash-setting-dashboard-time-range "#v10-dash-setting-dashboard-time-range").                                                                                                                                                                                                                   |
