...
1. Choose the **\+ Add mute timing** button.

1. Fill out the form to create a [time interval](#v10-alerting-manage-muting-interval) to match against for your mute timing.
