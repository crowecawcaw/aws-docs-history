...
Values mappings bypass the unit formatting set in the [Standard options](v10-panels-configure-standard-options.md) of the panel editor, like color or number of decimal places displayed. When value mappings are present in a panel, Grafana displays a summary of them in the **Value mappings** section of the panel editor.
