...
1. Select an evaluation group or choose **\+ New evaluation group**.
...
Add [annotations](v10-alerting-overview-labels.md#v10-alerting-overview-labels-annotations) to provide more context on the alert in your alert notifications.
