...
the background or value color using thresholds or overrides. Stat panels also display
percent change with configurable color mode options, making it easier to see trends at
a glance.
...
Show a calculated value based on all rows.
    ...
    + **Calculation** – Select a reducer
     ...
     calculations](v12-panels-calculation-types.md "v12-panels-calculation-types.md").
