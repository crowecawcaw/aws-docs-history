...
As a first step, define your [contact points](v10-alerting-explore-contacts.md "v10-alerting-explore-contacts.md"), which define where to send your alert notifications. A
...
For more detailed information about customizing notifications, see [Customize notifications](v10-alerting-manage-notifications.md "v10-alerting-manage-notifications.md").
...
For more detailed information about using silences, see [Silencing alert notifications](v10-alerting-silences.md "v10-alerting-silences.md").
