...
formatting, and coloring options, including CSS cell styling, tooltip generation from
table fields, a new Actions cell type for interactive buttons, auto-formatted cell
values in Cell Inspect, and row-level conditional formatting for coloring entire rows
...
Shows values rendered as a sparkline. Requires [time series to table](v12-panels-xform-functions.md#v12-panels-xform-funcs-series "v12-panels-xform-functions.md#v12-panels-xform-funcs-series") data
transform.
...
see [Filter table columns](#v12-panels-table-filter "#v12-panels-table-filter").
...
You can use the table footer to show [calculations](v12-panels-calculation-types.md "v12-panels-calculation-types.md") on fields.
