...
Trend visualizations support all visual styles and options available in the [time series visualization](v12-panels-time-series.md "v12-panels-time-series.md") with the following
exceptions:
