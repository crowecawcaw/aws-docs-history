...
You can use Explore to visualize traces from tracing data sources. The legacy
Tempo Search and Loki Search interfaces have been removed in favor of the
TraceQL-powered search experience.
