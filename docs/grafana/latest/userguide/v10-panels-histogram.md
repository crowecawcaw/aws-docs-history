...
Choose which of the standard calculations to show in the legend. You can have more than one. For more information, see [Calculation types](v10-panels-calculation-types.md).
