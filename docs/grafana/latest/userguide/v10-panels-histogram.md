...
![An image showing an example of a histogram visualization in Grafana.](images/viz/histogram-example.png)
...
thresholds. For more information about the legend, see [Configure a legend](v10-panels-configure-legend.md "v10-panels-configure-legend.md").
...
than one. For more information, see [Calculation types](v10-panels-calculation-types.md "v10-panels-calculation-types.md").
