...
has been selected. For information about available calculations, refer to [Calculation types](v12-panels-calculation-types.md "v12-panels-calculation-types.md").
...
more information about the legend, refer to [Configure a legend](v12-panels-configure-legend.md "v12-panels-configure-legend.md").
...
For more information about the legend, refer to [Configure a legend](v12-panels-configure-legend.md "v12-panels-configure-legend.md").
