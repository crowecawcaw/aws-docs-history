...
+ An Amazon Managed Grafana workspace [created](AMG-create-workspace.md) with the Prometheus instance [configured as a data source](amazon-prometheus-data-source.md).
