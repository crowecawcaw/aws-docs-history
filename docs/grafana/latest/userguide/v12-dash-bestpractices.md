...
Refer to the list of examples in [Variables](v12-dash-variables.md "v12-dash-variables.md"), for ideas.

- Methodical dashboards according to an [observability
  strategy](#v12-dash-common-observability-strategies "#v12-dash-common-observability-strategies").
...
- Expressive charts with meaningful use of color and normalizing axes
  ...
  - Example of meaningful color: Blue means it’s good, red means
    it’s bad. [Thresholds](v12-panels-configure-thresholds.md "v12-panels-configure-thresholds.md") can help with that.
...
- Directed browsing cuts down on guessing.
  ...
  - Browsing is directed with links. For more information, see
    [Managing dashboard links](v12-dash-manage-dashboard-links.md "v12-dash-manage-dashboard-links.md").
...
- Actively reducing sprawl.
  ...
  - Tracking dashboard use. You can
    ...
    insights](v12-dash-assess-dashboard-usage.md "v12-dash-assess-dashboard-usage.md").
...
Refer to [Common
observability strategies](#v12-dash-common-observability-strategies "#v12-dash-common-observability-strategies") and [Dashboard management
maturity levels](#v12-dash-management-maturity-model "#v12-dash-management-maturity-model") for more information.
...
- If you create many related dashboards, think about how to
  ...
  [Best
  practices for managing dashboards](#v12-dash-best-practices-for-managing-dashboards "#v12-dash-best-practices-for-managing-dashboards"), later in this section.
...
- Add documentation to dashboards and panels.
  - To add documentation to a dashboard, add a [Text panel visualization](v12-panels-text.md "v12-panels-text.md") to the
...
- Reuse your dashboards and enforce consistency by using [templates and variables](v12-dash-variables.md "v12-dash-variables.md").
...
There are several [common observability strategies](#v12-dash-common-observability-strategies "#v12-dash-common-observability-strategies"). You should research them and decide
...
maturity model](#v12-dash-management-maturity-model "#v12-dash-management-maturity-model"). Understanding where you are can help you decide
...
- Copying dashboards with no significant changes is not a good idea.
  ...
  - In many cases copies are being made to simply customize the
    ...
    the view with [URL
    parameters](v12-panels-configure-data-links.md#v12-panels-data-link-variables "v12-panels-configure-data-links.md#v12-panels-data-link-variables").
...
- Maintain a dashboard of dashboards or cross-reference dashboards.
  ...
  - Create dashboard links, panel, or data links. Links can go to
    ...
    refer to [Manage
    dashboard links](v12-dash-manage-dashboard-links.md "v12-dash-manage-dashboard-links.md").
  - Add a [Dashboard list
    panel](v12-panels-dashboard-list.md "v12-panels-dashboard-list.md"). You
    can then customize what you see by doing tag or folder
    searches.
  - Add a [Text
    panel](v12-panels-dashboard-list.md "v12-panels-dashboard-list.md") and use markdown to customize the display.
