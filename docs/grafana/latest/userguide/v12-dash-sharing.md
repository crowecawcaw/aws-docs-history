...
export a dashboard. The sharing workflow includes customizable shareable panel
images and a streamlined interface.
...
the import and export sections in [Building dashboards](v12-dash-building-dashboards.md "v12-dash-building-dashboards.md").
