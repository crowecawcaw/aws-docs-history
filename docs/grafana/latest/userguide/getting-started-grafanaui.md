...
1. In the **New Dashboard/Edit Panel** view, choose the **Query** tab. 

1. Configure your query by selecting the data source that you'd like to query. For example, if you have **TestDB** added as a data source, this generates a sample dashboard called the Random Walk dashboard.
...
+ Prometheus (with the [histogram](https://prometheus.io/docs/concepts/metric_types/#histogram) metric type and the *Format as* option set to **Heatmap**)
