...
- [Query management in Explore](v12-explore-manage.md "v12-explore-manage.md")
- [Logs in Explore](v12-explore-logs.md "v12-explore-logs.md")
- [Tracing in Explore](v12-explore-tracing.md "v12-explore-tracing.md")
- [Correlations editor in Explore](v12-explore-correlations.md "v12-explore-correlations.md")
- [Inspector in Explore](v12-explore-inspector.md "v12-explore-inspector.md")
...
For more details about queries, see [Query and transform data](v12-panels-query-xform.md "v12-panels-query-xform.md"). 4. Run the query using the button in the top right corner.
...
[shortened link](#v12-explore-share "#v12-explore-share") if the URL is too long for
your tools.
...
ranges as described in the [Setting dashboard time range](v12-dash-using-dashboards.md#v12-dash-setting-dashboard-time-range "v12-dash-using-dashboards.md#v12-dash-setting-dashboard-time-range") topic.
