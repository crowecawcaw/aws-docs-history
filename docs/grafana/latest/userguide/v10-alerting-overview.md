...
Alerts are sent to the alert receiver where they are routed, grouped, inhibited, silenced and notified. In Grafana Alerting, the default alert receiver is the Alertmanager embedded inside Grafana, and is referred to as the Grafana Alertmanager. However, you can use other Alertmanagers too, and these are referred to as [External Alertmanagers](v10-alerting-setup-alertmanager.md).
...
By default, an alert can only match one notification policy. However, with the `continue` feature alerts can be made to match any number of notification policies at the same time. For more information about notification policies, see [Notification Policies](v10-alerting-explore-notifications-policies-details.md).
...
+ [Fundamentals](#v10-alerting-overview-fundamentals)
+ [Data sources and Grafana alerting](v10-alerting-overview-datasources.md)
+ [Alerting on numeric data](v10-alerting-overview-numeric.md)
+ [Labels and annotations](v10-alerting-overview-labels.md)
+ [About alert rules](v10-alerting-explore-rules.md)
+ [Alertmanager](v10-alerting-explore-alertmanager.md)
+ [Contact points](v10-alerting-explore-contacts.md)
+ [Notifications](v10-alerting-explore-notifications.md)
+ [Alerting high availability](v10-alerting-explore-high-availability.md)