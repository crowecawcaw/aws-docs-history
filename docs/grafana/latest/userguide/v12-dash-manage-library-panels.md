...
1. Select **Library panels**, and then **\+ Create library panel**. This opens the create dialog.
...
1. On the empty dashboard, select **\+ Import library panel**. You will see a list of your library panels.
