...
To assign colors to boolean or string values, use [Configure value mappings](v12-panels-configure-value-mappings.md "v12-panels-configure-value-mappings.md").
...
calculations](v12-panels-calculation-types.md "v12-panels-calculation-types.md") to show in the legend. You can have more than one.
