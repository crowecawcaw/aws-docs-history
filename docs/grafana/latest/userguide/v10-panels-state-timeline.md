...
To assign colors to boolean or string values, use [Configure value mappings](v10-panels-configure-value-mappings.md).
...
Choose which of the [standard calculations](v10-panels-calculation-types.md) to show in the legend. You can have more than one.