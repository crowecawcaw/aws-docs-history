...
2. From the **Options** dropdown, specify a [time range](v12-dash-using-dashboards.md#v12-dash-setting-dashboard-time-range "v12-dash-using-dashboards.md#v12-dash-setting-dashboard-time-range").
...
To add multiple [queries](v12-panels-query-xform.md#v12-panels-query-xform-add "v12-panels-query-xform.md#v12-panels-query-xform-add"),
choose **Add query**.
...
source-managed alert rule**. 4. Add one or more [expressions](v12-panels-query-xform-expressions.md "v12-panels-query-xform-expressions.md").
...
and a preview.
Add [annotations](v12-alerting-overview-labels.md#v12-alerting-overview-labels-annotations "v12-alerting-overview-labels.md#v12-alerting-overview-labels-annotations")
...
expressions to create a multi-dimensional rule. For example:
    ...
    + Add a `Reduce` expression for each query to aggregate
     ...
     for [rules using
     numeric data](v12-alerting-overview-numeric.md "v12-alerting-overview-numeric.md")).
