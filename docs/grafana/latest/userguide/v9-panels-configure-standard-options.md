...
| ---------------------------------- | --------------------------- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **${\_\_field.displayName}**       | Same as syntax              | **Temp {Loc="PBI",<br>Sensor="3"}** | Displays the field name, and labels in **{}**<br>if they are present. If there is only one label key in the response,<br>then for the label portion, Grafana displays the value of the label<br>without the enclosing braces. |
...
| **${\_\_field.labels.\_\_values}** | Same as Syntax              | **PBI, 3**                          | Displays the values of the labels separated by a comma (without<br>label keys).                                                                                                                                               |
...
You can specify a single color, or select a continuous (gradient) color schemes,
