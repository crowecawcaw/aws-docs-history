...
<a name="v9-panels-standard-options-displayname"></a>
 ...
 When multiple stats, fields, or series are shown, this field controls the title in each stat. You can use expressions like **${\_\_field.name}** to use only the series name or the field name in title. 
