...
| `timepicker`    | timepicker metadata, see [timepicker section](#v10-dash-json-panels "#v10-dash-json-panels") for details          |
| `templating`    | templating metadata, see [templating section](#v10-dash-json-panels "#v10-dash-json-panels") for details          |
| `annotations`   | annotations metadata, see [annotations](v10-dash-annotations.md "v10-dash-annotations.md") for how to add them    |
