...
**Topics**
+ [Special data sources](#AMG-data-sources-special)
+ [How Amazon Managed Grafana works with AWS Organizations for AWS data source access](AMG-and-Organizations.md)
+ [Connect to built-in data sources](AMG-data-sources-builtin.md)
+ [Connect to Enterprise data sources](AMG-data-sources-enterprise.md)