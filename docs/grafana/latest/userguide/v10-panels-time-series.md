...
**Topics**
+ [Tooltip options](v10-time-series-panel-tooltip.md)
+ [Legend options](v10-time-series-panel-legend.md)
+ [Graph styles](v10-time-series-graph.md)
+ [Axis options](v10-time-series-axis.md)
+ [Color options](v10-time-series-color.md)