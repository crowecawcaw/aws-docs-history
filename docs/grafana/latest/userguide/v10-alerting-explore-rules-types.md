...
In addition to supporting multiple data sources, you can add [expressions](v10-panels-query-xform-expressions.md) to transform your data and express alert conditions.
...
**Note**  
You can also configure alerts to be delivered using an external Alertmanager, or use both internal and external Alertmanagers. For more information, see [Add an external alertmanager](v10-alerting-setup-alertmanager.md).
