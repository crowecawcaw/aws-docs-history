...
<a name="tempo-linking-trace-id-from-logs"></a>
 ...
 You can link to Tempo trace from logs in Loki or Elastic by configuring an internal link. For more information, see [Derived fields](using-loki-in-AMG.md#loki-derived-fields). 