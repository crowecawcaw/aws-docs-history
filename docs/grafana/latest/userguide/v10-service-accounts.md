...
Service accounts are available in Grafana 9.x and newer, and have
replaced API keys as the primary way to authenticate applications
that interact with Grafana. API keys are deprecated and have been
removed in Amazon Managed Grafana version 12.
