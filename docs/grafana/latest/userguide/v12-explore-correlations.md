...
6. Choose a link to add a new correlation. Links are associated with a
   ...
   see [Correlation configuration](v12-correlations-config.md "v12-correlations-config.md").
7. In the split view that opens, use the right pane to set up the target
   query source of the correlation. For more details, see [Target query](v12-correlations-config.md#v12-correlations-config-target-query "v12-correlations-config.md#v12-correlations-config-target-query").
8. Build a target query using [variables syntax](v12-dash-variable-syntax.md "v12-dash-variable-syntax.md") with variables from the list provided at the top
