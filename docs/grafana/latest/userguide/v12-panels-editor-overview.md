...
- **More** – Access other panel actions.
  ...
  - **Create alert** – Open the alert rule
    ...
    create a [Grafana-managed alert](v12-alerts.md "v12-alerts.md") based on the panel queries.
...
- Visualization preview – The visualization preview section contains
  ...
  - **Table view** – Convert any visualization
    ...
    formatting options available in the [Table](v12-panels-table.md "v12-panels-table.md") visualization.
...
- Data section – The data section contains tabs where you enter
  ...
  - **Query tab** – Select your data source
    and enter queries here. For more information, see [Query and transform data](v12-panels-query-xform.md "v12-panels-query-xform.md"). When you initially
  ...
  - **Transform tab** – Apply data
    transformations. For more information, see [Query and transform data](v12-panels-query-xform.md "v12-panels-query-xform.md").
  - **Alert tab** – Write alert rules. For
    more information, see [Alerts in Grafana version 12](v12-alerts.md "v12-alerts.md").
