...
1. Enter the templates you wish to use in one or more field, such as **Message** or **Subject**. To enter a template, use the form `{{ template "{{template_name}}" . }}`, replacing {{template\_name}} with the name of the template you want to use.
