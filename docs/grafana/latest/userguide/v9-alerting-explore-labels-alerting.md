...
- You can add labels to an [alerting rule](v9-alerting-managerules.md "v9-alerting-managerules.md"). Labels are manually configurable, use
...
`grafana_` it can be overwritten in case of
collision.
...
| Label           | Description                               |
| --------------- | ----------------------------------------- |
| grafana\_folder | Title of the folder containing the alert. |
