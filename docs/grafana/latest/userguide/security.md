...
- **Security of the cloud** – AWS is
  ...
  programs that apply to Amazon Managed Grafana, see [AWS Services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using Amazon Managed Grafana. The following topics show you how to configure Amazon Managed Grafana to meet
  your security and compliance objectives. You also learn how to use other AWS services that
  help you to monitor and secure your Amazon Managed Grafana resources.
