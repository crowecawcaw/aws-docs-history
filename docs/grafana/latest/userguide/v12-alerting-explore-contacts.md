...
For more information about contact points, see [Configure contact points](v12-alerting-configure-contactpoints.md "v12-alerting-configure-contactpoints.md") and [Customize notifications](v12-alerting-manage-notifications.md "v12-alerting-manage-notifications.md").
