...
- You can add labels to an [alerting rule](v12-alerting-configure.md "v12-alerting-configure.md"). Labels are manually configurable, use
...
| Label           | Description                                  |
| --------------- | -------------------------------------------- |
| grafana\_folder | Title of the folder containing the<br>alert. |
