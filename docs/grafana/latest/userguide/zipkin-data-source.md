...
<a name="zipkin-linking-trace-id-from-logs"></a>
 ...
 You can link to Zipkin trace from logs in Loki by configuring a derived field with internal link. For more information, see [Derived fields](using-loki-in-AMG.md#loki-derived-fields). 