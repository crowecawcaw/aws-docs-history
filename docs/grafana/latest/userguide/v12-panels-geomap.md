...
important location-based characteristics of the data. Geomap visualizations support
...
- [Markers layer](#v12-panels-geomap-markers "#v12-panels-geomap-markers") renders a marker at each data point.
- [Heatmap layer](#v12-panels-geomap-heatmap "#v12-panels-geomap-heatmap") visualizes a heatmap of the data.
- [GeoJSON layer](#v12-panels-geomap-geojson "#v12-panels-geomap-geojson") renders static data from a GeoJSON file.
- [Night / Day layer (Alpha)](#v12-panels-geomap-nightday "#v12-panels-geomap-nightday") renders a night or day region.
- [Route layer (preview)](#v12-panels-geomap-route "#v12-panels-geomap-route") render data points as a route.
- [Photos layer (preview)](#v12-panels-geomap-photos "#v12-panels-geomap-photos") renders a photo at each data point.
- [Network layer (preview)](#v12-panels-geomap-network "#v12-panels-geomap-network") visualizes a network graph from the data.
