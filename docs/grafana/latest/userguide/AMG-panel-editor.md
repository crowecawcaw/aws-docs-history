...
+  Choose the **Add panel** icon at the top of the screen, and then choose **Add new panel**. The new panel opens in the panel editor. For more information about how to add a panel, see [Adding a panel](add-a-panel-to-a-dashboard.md). 
...
+  **Time range controls** – For more information, see [Time range controls](dashboard-time-range-controls.md). .
...
+  **Query tab** – Select your data source and enter queries here. For more information, see [Queries](panel-queries.md). 
+  **Transform tab** – Apply data transformations. For more information, see [Transformations](panel-transformations.md). 
+  **Alert tab** – Write alert rules. For more information, see [Grafana alerting](alerts-overview.md). 
...
+  [Panel links](panel-links.md) and [Data links](data-links.md), which help you connect your visualization to other resources 