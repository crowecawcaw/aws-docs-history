...
Select a calculation to reduce each series when Calculate has been selected. For
...
Select which field or fields to display in the visualization. Each field name is
...
- **Name** – The series or field
  name.
- **Percent** – The percentage of the
  whole.
...
- **Single** – The hover tooltip shows
  only a single series, the one that you are hovering over on the
  visualization.
...
- **Hidden** – Do not display the
  tooltip when you interact with the visualization.
...
more information about the legend, refer to [Configure a legend](v9-panels-configure-legend.md "v9-panels-configure-legend.md").

- **List** – Displays the legend as a
  list. This is a default display mode of the legend.
...
For more information about the legend, refer to [Configure a legend](v9-panels-configure-legend.md "v9-panels-configure-legend.md").
