...
By default, the graph uses the standard [Color scheme](v9-panels-configure-standard-options.md#v9-panels-standard-options-color-scheme "v9-panels-configure-standard-options.md#v9-panels-standard-options-color-scheme") option to
assign series colors. You can also use the legend to open the color picker by
clicking the legend series color icon. Setting color this way automatically creates
...
Use this mode to specify a color. You can also click the colored line icon next to
each series in the Legend to open the color picker. This automatically creates a new
override that sets the color scheme to single color and the selected color.
