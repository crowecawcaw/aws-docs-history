...
For more information on notification policies, see [Notifications](v10-alerting-explore-notifications.md).
...
1. To add a top level specific policy, go to the Specific routing section (eitehr to the default policy, or to antoher existing policy in which you would like to add a new nested policy) and choose **\+ New nested policy**.
