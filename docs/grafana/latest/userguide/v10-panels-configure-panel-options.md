...
1. Write a description of the panel and the data you are displaying.
   ...
   You can use [variables you have defined](v10-dash-variables.md) in the **Title** and **Description** field, but not [global variables](v10-dash-variable-add.md#v10-dash-variable-add-global).
