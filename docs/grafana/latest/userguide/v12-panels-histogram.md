...
![An image showing an example of a histogram visualization in Grafana.](/images/grafana/latest/userguide/images/viz/histogram-example.png)
...
Set the mode of the gradient fill. Fill gradient is based on the line color. To
change the color, use the standard color scheme field option. Gradient appearance
is influenced by the **Fill opacity** setting.
...
thresholds. For more information about the legend, see [Configure a legend](v12-panels-configure-legend.md "v12-panels-configure-legend.md").
...
than one. For more information, see [Calculation types](v12-panels-calculation-types.md "v12-panels-calculation-types.md").
