...
By default, the graph uses the standard [Color scheme](v12-panels-configure-standard-options.md#v12-panels-standard-options-color-scheme "v12-panels-configure-standard-options.md#v12-panels-standard-options-color-scheme") option to
