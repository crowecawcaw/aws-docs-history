...
**Note**  
Choosing a button will only trigger an API call when inline editing is disabled. See [Canvas editing](#v10-panels-canvas-editing).
...
Canvases support [data links](v10-panels-configure-data-links.md). You can create a data link for a metric-value element and display it for all elements that use the field name by following these steps.
...
1. Choose the **\+ Add override property** button.

1. Select **Datalinks > Datalinks** from the list.

1. Choose **\+ Add link**, add a title and URL for the data link.
