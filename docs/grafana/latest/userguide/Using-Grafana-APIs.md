...
You can use Grafana HTTP APIs with Amazon Managed Grafana workspaces. The following sections
describe how to use the APIs, and then list which Grafana APIs are supported.

###### Note

Amazon Managed Grafana also provides AWS APIs for creating and managing workspaces. For more
information about the AWS APIs, see the [Amazon Managed Grafana API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
- [Dashboard Permissions API](Grafana-API-DashboardPermissions.md "Grafana-API-DashboardPermissions.md")
...
- [Organization API](Grafana-API-Organization.md "Grafana-API-Organization.md")
- [Playlist API](Grafana-API-Playlist.md "Grafana-API-Playlist.md")
- [Plugin API](Grafana-API-Plugin.md "Grafana-API-Plugin.md")
- [Preferences API](Grafana-API-Preferences.md "Grafana-API-Preferences.md")
- [Snapshot API](Grafana-API-Snapshot.md "Grafana-API-Snapshot.md")
- [Team API](Grafana-API-Team.md "Grafana-API-Team.md")
- [User API](Grafana-API-User.md "Grafana-API-User.md")
