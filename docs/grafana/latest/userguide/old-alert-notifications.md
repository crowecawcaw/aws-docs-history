...
1.  Fill out the fields or select options described in the following sections. 
...
+  **Type** – Select the channel type. For more information, see [List of supported notifiers](#old-list-of-supported-notifiers). 
...
| --- | --- | --- | --- | 
| [Amazon Simple Notification Service](#old-amazon-sns)  |  sns  |  No  |  Yes  | 
|  OpsGenie  |  opsgenie  |  No  |  Yes  | 
|  [PagerDuty](#old-pagerduty)  |  pagerduty  |  No  |  Yes  | 
...
<a name="old-slack"></a>
 ...
 To set up Slack, you must configure an incoming Slack webhook URL. For more information, see [Sending messages using Incoming Webhooks](https://api.slack.com/incoming-webhooks).

For more information about setting up a Slack bot integration, see [Follow Slack’s guide to set up a bot integration](https://api.slack.com/bot-users). Use the token provided, which starts with "xoxb". 
