...
- [Logs](v12-panels-logs.md "v12-panels-logs.md")
- [Table](v12-panels-table.md "v12-panels-table.md")
  You can configure correlations using the **Administration > Plugins and data >
  Correlations** page in Grafana or directly in [Explore](v12-explore-correlations.md "v12-explore-correlations.md"). You can also add correlations to
  external URLs directly from Explore, enabling seamless navigation between data sources
  and external systems.

###### Topics

- [Correlation configuration](v12-correlations-config.md "v12-correlations-config.md")
- [Create a new correlation](v12-correlations-create.md "v12-correlations-create.md")
