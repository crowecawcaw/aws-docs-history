...
the visualization applied. For more information, see [Visualizations options](v12-panels-viz.md "v12-panels-viz.md"). 7. Under **Panel options**, you can enter a title and
...
ways.
    ...
    * [Configure
     value mappings](v12-panels-configure-value-mappings.md "v12-panels-configure-value-mappings.md")
    * [Visualization-specific
     options](v12-panels-viz.md "v12-panels-viz.md")
    * [Override field
     values](v12-panels-configure-overrides.md "v12-panels-configure-overrides.md")
    * [Configure
     thresholds](v12-panels-configure-thresholds.md "v12-panels-configure-thresholds.md")
    * [Configure
