...
## Install plugin
<a name="v10-Grafana-API-Plugin-install"></a>
...
## Uninstall plugin
<a name="v10-Grafana-API-Plugin-uninstall"></a>
...
## Get all plugins
<a name="v10-Grafana-API-Plugin-getall"></a>
...
## Get plugin
<a name="v10-Grafana-API-Plugin-get"></a>
...
## Get plugin versions
<a name="v10-Grafana-API-Plugin-versions"></a>
