...
1. Choose the title of the panel and choose **Edit**.

1. In the panel display options side pane, choose the down arrow option to bring changes to the visualization.

1. Choose **Library panels**, and choose **Create new library panel**. 

1. Enter a name for the library panel, and select the folder to save it in.

1. Choose **Create library panel** and then save the dashboard.
...
1. Choose **Add a panel from the panel library**.

1. Filter the list of library panels to find the panel that you want.

1. Choose that panel and add it to the dashboard. 
...
1. Select a library panel. You will see a list of all the dashboards where the library panel is used.

1. Select the panel that you want to unlink and update.
...
1. Choose the delete icon next to the panel name. 
