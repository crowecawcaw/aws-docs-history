...
**Topics**
+ [About queries](#v10-panels-query-xform-about)
+ [Navigate the query tab](#v10-panels-query-xform-navigate)
+ [Adding a query](#v10-panels-query-xform-add)
+ [Manage queries](#v10-panels-query-xform-manage)
+ [Query options](#v10-panels-query-xform-options)
+ [Write expression queries](v10-panels-query-xform-expressions.md)
+ [Share query results with another panel](v10-panels-query-share.md)
+ [Transform data](v10-panels-xform.md)
+ [Troubleshoot queries](v10-panels-query-troubleshoot.md)
+ [Calculation types](v10-panels-calculation-types.md)
...
+ **Expressions** – Uses the expression builder to create alert expressions. For more information about expressions, see [Write expression queries](v10-panels-query-xform-expressions.md).
...
1. Choose **Query options** to configure the maximum number of data points you need. For more information about query options, see [Query options](#v10-panels-query-xform-options).
