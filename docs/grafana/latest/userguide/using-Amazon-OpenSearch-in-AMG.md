...
| `Url`     | The endpoint of your OpenSearch Service domain. The endpoint<br>takes the following format:<br>https://search-my-domain.us-east-1.es.amazonaws.com. |
...
OpenSearch Service, the following configuration should work.
