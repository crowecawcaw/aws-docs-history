...
- [Creating a Grafana API key to use with Grafana APIs in the workspace (Console)](#v10-API_key_console "#v10-API_key_console")
- [Creating an Amazon Managed Grafana workspace API key using AWS CLI](#v10-API_key_CLI "#v10-API_key_CLI")

###### Important

API keys are deprecated and have been removed in Amazon Managed Grafana version 12.
Use service accounts instead. For more information, see
[Use service accounts to authenticate with the Grafana HTTP APIs](v10-service-accounts.md "v10-service-accounts.md").
...
that are valid for a long time. 10. Choose **Add**. 11. (Optional) You can automate creating API keys with the [Create API Key](v10-Grafana-API-Authentication.md "v10-Grafana-API-Authentication.md") API using
