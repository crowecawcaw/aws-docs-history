...
see [Color scheme](v12-panels-configure-standard-options.md#v12-panels-standard-options-color-scheme "v12-panels-configure-standard-options.md#v12-panels-standard-options-color-scheme").
...
- **Scheme** – A color gradient defined
  ...
  line. For more information, see [Color options](v12-time-series-color.md "v12-time-series-color.md").
...
information about creating an override, see [Configure field overrides](v12-panels-configure-overrides.md "v12-panels-configure-overrides.md").
