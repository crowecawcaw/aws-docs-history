...
For more information about variables, see [Variables](v12-dash-variables.md "v12-dash-variables.md").
...
For more information about the JSON fields, see [JSON fields](v12-dash-dashboard-json-model.md "v12-dash-dashboard-json-model.md").
