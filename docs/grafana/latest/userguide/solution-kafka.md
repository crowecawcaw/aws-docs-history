...
![An image showing an example of a Grafana dashboard folder built using this solution.](http://docs.aws.amazon.com/grafana/latest/userguide/images/kafka-solution-cluster-overview.png)
