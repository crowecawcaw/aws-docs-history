...
- Ensure that the data source you choose are compatible with and supported by
  [Grafana
  alerting](v12-alerting-overview-datasources.md "v12-alerting-overview-datasources.md").
...
3. Configure [notification policies](v12-alerting-explore-notifications-policies-details.md "v12-alerting-explore-notifications-policies-details.md")
...
- [Adding an external Alertmanager](v12-alerting-setup-alertmanager.md "v12-alerting-setup-alertmanager.md")
- [Provisioning Grafana Alerting resources](v12-alerting-setup-provision.md "v12-alerting-setup-provision.md")
