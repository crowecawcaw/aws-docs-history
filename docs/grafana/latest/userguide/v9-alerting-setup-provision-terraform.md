...
1. Copy this code block into a .tf file on your local
   machine. Replace
   `<slack-webhook-url>`
   with your Slack webhook URL (or other contact
...
the example above, a shared template ie embedded using the statement
`{{ template "Alert Instance Template" . }}`
...
can [define your data sources in Terraform](https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/data_source "https://registry.terraform.io/providers/grafana/grafana/latest/docs/resources/data_source") alongside your alert
rules.
