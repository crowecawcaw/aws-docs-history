...
1. Choose the title of the panel that you want to inspect, and then choose **Inspect**. Or pause over the panel title, and then press **i**.
...
1. If your panel contains multiple queries or queries multiple nodes, you have additional options.
...
+  **Transform data** 
  ...
  1. Above the table, choose on **Data display options**.

  1. Choose the **Apply field configuration** toggle button.
...
1. You can expand or collapse portions of the JSON to explore it, or you can choose **Copy to clipboard** and paste the JSON in another application.
