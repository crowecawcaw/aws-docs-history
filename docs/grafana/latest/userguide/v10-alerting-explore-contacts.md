...
For more information about contact points, see [Configure contact points](v10-alerting-configure-contactpoints.md) and [Customize notifications](v10-alerting-manage-notifications.md).