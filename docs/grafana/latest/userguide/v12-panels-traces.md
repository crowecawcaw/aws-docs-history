...
variables, refer to the [Variables documentation](v12-dash-variables.md "v12-dash-variables.md").
...
information on the panel editor, refer to the [Panel editor documentation](v12-panels-editor-overview.md "v12-panels-editor-overview.md").
...
5. Under the **Panel options**, enter a
   **Title** for your trace panel. For more information on
   the panel editor, see [Configure panel options](v12-panels-configure-panel-options.md "v12-panels-configure-panel-options.md").
