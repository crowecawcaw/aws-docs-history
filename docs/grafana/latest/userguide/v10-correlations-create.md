...
You can create a correlation in the Explore correlation editor. For more details, see [Creating a correlation](v10-explore-correlations.md#v10-explore-corr-create-a-correlation).
