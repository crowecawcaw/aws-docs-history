...
+ Alerts. This is the only type of visualization that allows you to set alerts. For more information, see [Grafana alerting](alerts-overview.md).
...
1. Choose **\+** and then select a style to apply to the series. You can add multiple styles to each entry.
