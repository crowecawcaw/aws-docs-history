...
For logs where a **level** label is specified, we use the
value of the label to
determine the log level and update color accordingly. If the log doesn’t have a
level label specified, we try to find out if its content matches any of the
...
level, it will be visualized with **unknown** log level. For
more information, see
[Logs visualization](v9-explore-logs.md#v9-explore-logs-viz "v9-explore-logs.md#v9-explore-logs-viz").
