...
| **schemaVersion** | version of the JSON schema (integer), incremented each time<br>a Grafana update brings changes to said schema                               |
...
- `w`: 1–24 (the width of the dashboard is divided into 24
  columns)
