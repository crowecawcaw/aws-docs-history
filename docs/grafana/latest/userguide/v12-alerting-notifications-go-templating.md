...
be used in other templates. You can see examples of this in [Create notification templates](v12-alerting-create-templates.md "v12-alerting-create-templates.md"), and all data and
functions in the [Template reference](v12-alerting-template-reference.md "v12-alerting-template-reference.md").
...
field of dot, the result of a function, and the value of a [variable](#v12-go-variables "#v12-go-variables"). For example, to print the
