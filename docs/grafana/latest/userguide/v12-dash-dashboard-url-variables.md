...
dashboard links](v12-dash-manage-dashboard-links.md "v12-dash-manage-dashboard-links.md") and [Templates and
variables](v12-dash-variables.md "v12-dash-variables.md").
...
dashboard’s settings. For more information and steps to add variables, see [Manage dashboard links](v12-dash-manage-dashboard-links.md "v12-dash-manage-dashboard-links.md").

**Passing ad hoc filters**

Ad hoc filters apply key or value filters to all metric queries that use a
specified data source. For more information, see [Ad hoc filters](v12-dash-variable-add.md#v12-dash-variable-add-adhoc "v12-dash-variable-add.md#v12-dash-variable-add-adhoc").
