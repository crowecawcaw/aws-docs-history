...
A common panel to get started with, and to learn the basics of using panels, is the [Time series](v10-panels-time-series.md) panel.
...
+ Graphs & charts
  + [Time series](v10-panels-time-series.md) is the default and main Graph visualization.
  + [State timeline](v10-panels-state-timeline.md) for state changes over time.
  + [Status history](v10-panels-status-history.md) for periodic state over time.
  + [Bar chart](v10-panels-bar-chart.md) shows any categorical data.
  + [Histogram](v10-panels-histogram.md) calculates and shows value distribution in a bar chart.
  + [Heatmap](v10-panels-heatmap.md) visualizes data in two dimensions, used typically for the magnitude of a phenomenon.
  + [Pie chart](v10-panels-piechart.md) is typically used where proportionality is important.
  + [Candlestick](v10-panels-candlestick.md) is typically for financial data where the focus is price/data movement.
  + [Gauge](v10-panels-gauge.md) is the traditional rounded visual showing how far a single metric is from a threshold.
  + [Trend](v10-panels-trend.md) for datasets that have a sequential, numeric x that is not time.
  + [XY Chart](v10-panels-xychart.md) provides a way to visualize arbitrary x and y values in a graph.
+ Stats & numbers
  + [Stat](v10-panels-stat.md) for big stats and optional sparkline.
  + [Bar gauge](v10-panels-bar-gauge.md) is a horizontal or vertical bar gauge.
+ Misc
  + [Table](v10-panels-table.md) is the main and only table visualization.
  + [Logs](v10-panels-logs.md) is the main visualization for logs.
  + [Node graph](v10-panels-node-graph.md) for directed graphs or networks.
  + [Traces](v10-panels-traces.md) is the main visualization for traces.
  + [Flame graph](v10-panels-flamegraph.md) is the main visualization for profiling.
  + [Geomap](v10-panels-geomap.md) helps you visualize geospatial data.
  + [Datagrid](v10-panels-datagrid.md) allows you to create and manipulate data, and acts as a data source for other panels.
+ Widgets
  + [Dashboard list](v10-panels-dashboard-list.md) can list dashboards.
  + [Alert list](v10-panels-alert-list.md) can list alerts.
  + [Text](v10-panels-text.md) can show markdown and html.
  + [News](v10-panels-news.md) can show RSS feeds.
