...
You can also use template variables in your data links URLs, see [Variables](v10-dash-variables.md).
...
+ `$__from` – For more information, see [Global variables](v10-dash-variable-add.md#v10-dash-variable-add-global).
+ `$__to` – For more information, see [Global variables](v10-dash-variable-add.md#v10-dash-variable-add-global).
