...
A *workspace* is a logical Grafana server. You can have as many as five workspaces in each AWS Region in your account.
...
1. Choose the IP addressing mode for your workspace:
