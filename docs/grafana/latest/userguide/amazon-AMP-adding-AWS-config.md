...
<a name="amazon-AMP-adding-AWS-config"></a>
...
1. In the left navigation bar in the Grafana workspace console, choose the **Connections** tab, and then choose the **Data sources** sub-tab.

1. Choose **Add new data source**, and then select **Amazon Managed Service for Prometheus**.

1. Configure the fields in the settings page.