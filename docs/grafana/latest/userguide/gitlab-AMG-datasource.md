...
1. Add a new panel to the dashboard and use **$project** as the project ID.
...
1.  Add a new **Group by** transformation: for **Group by**, select **created\_at\_date** and then calculate **(Count)=id** 
...
1.  Add a new **Add field from calculation** transformation: for **Mode**, select **Binary Operation**, for **Operation**, select **closed\_at = created\_at** and for **Alias** choose **resolution\_time**. 

1.  Add a new **Add field from calculation** transformation: for **Mode**, select **Binary Operation**, for **Operation**, select **resolution\_time / 86400000** and for **Alias** choose **resolution\_time**. 
