...
**Note**  
To suppress alert notifications at regular time intervals, for example, during regular maintenance periods, use [Mute timings](v10-alerting-manage-muting.md) rather than silences.
