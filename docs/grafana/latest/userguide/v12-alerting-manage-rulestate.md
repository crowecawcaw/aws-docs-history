...
- [Alert rule state](#v12-alerting-manage-rulestate-state "#v12-alerting-manage-rulestate-state")
- [Alert instance state](#v12-alerting-manage-rulestate-instance "#v12-alerting-manage-rulestate-instance")
- [Alert rule health](#v12-alerting-manage-rulestate-health "#v12-alerting-manage-rulestate-health")
...
or `Error` in the alert rule, as described in the [Configure Grafana managed alert rules](v12-alerting-configure-grafanamanaged.md "v12-alerting-configure-grafanamanaged.md") topic, to generate
