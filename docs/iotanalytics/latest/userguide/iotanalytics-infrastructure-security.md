...
As a managed service, AWS IoT Analytics is protected by AWS global network security. For
...
You use AWS published API calls to access AWS IoT Analytics through the network. Clients must
