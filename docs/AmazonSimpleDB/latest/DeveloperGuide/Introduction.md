...
+ [How Amazon Charges for Amazon SimpleDB](#HowAmazonChargesForSDB)
+ [Viewing Your Bill](#ViewingYourBill)
...
<a name="HowAmazonChargesForSDB"></a>
...
### Machine Utilization
<a name="MachineUtilizationCharges"></a>
...
## Viewing Your Bill
<a name="ViewingYourBill"></a>

You can view the charges for your current billing period at any time by going to the [ AWS Portal](http://aws.amazon.com).

**To view your activity**

1. Log in to your AWS account.

1. Move the pointer over **Your Web Services Account**.

1. Click **Account Activity**.

   A list of services to which you subscribe appears.

1. Locate the Amazon SimpleDB service.
