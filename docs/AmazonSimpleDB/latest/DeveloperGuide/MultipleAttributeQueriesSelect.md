...
| ------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- |
| `select<br>• from mydomain where Rating = '****'`                                     | Retrieves all items that have a "\*\*\*\*" Rating.                                                                                                                                                                                                             | 0802131786, 1579124585 |
| `select<br>• from mydomain where every(Rating) = '****'`                              | Retrieves all items that only have a "\*\*\*\*" Rating. Items are not<br>returned that have a multi-valued Rating attribute that contains any value<br>other than '\*\*\*\*.'                                                                                  | 0802131786             |
| `select<br>• from mydomain where Keyword = 'Book' intersection Keyword = 'Hardcover'` | Retrieves all items that have a "Book" Keyword and a "Hardcover" Keyword.<br>The first predicate produces 0385333498, 0802131786, and 1579124585. The second produces<br>1579124585. The intersection operator returns results that<br>appear in both queries. | 1579124585             |
