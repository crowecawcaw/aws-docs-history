...
|  Attribute name, attribute value, and item name allowed characters | All UTF-8 characters that are valid in XML documents.<br />Control characters and any sequences that are not valid in XML are returned Base64-encoded. For more information, see [Working with XML-Restricted Characters](InvalidCharacters.md). | 
