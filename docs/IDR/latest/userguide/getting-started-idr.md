...
To get started with workload onboarding, see [Onboard workloads to Incident Detection and Response](idr-gs-onboard-workload.md "idr-gs-onboard-workload.md").
...
To get started with alarm ingestion, see [Alarm Ingestion](idr-gs-alarm-ingestion.md "idr-gs-alarm-ingestion.md").
