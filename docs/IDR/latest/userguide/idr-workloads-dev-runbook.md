...
+ **Impact Communication plan**
  ...
  (Choose one depending on whether *One Time Only Contacts* is available or not.)
  ...
  1. Send the engagement notification to the customer based on the following template:
  ...
  1. Set the Case to Pending Customer Action.

  1. REMOVE *One Time Only Contacts* from the case after sending above Impact Communication. (If *One Time Only Contacts* is available.)

  1. Follow **Engagement Escalation** plan as mentioned above.

  1. If the customer does not respond within 30 minutes, disengage and continue to monitor until the alarm recovers.
+ **No Impact Communication plan**
  ...
  1. Send a no engagement notification to the customer based on the below template:
  ...
  1. Put the case in to **Pending Customer Action**.

  1. If the customer does not respond within 30 minutes, resolve the case.
