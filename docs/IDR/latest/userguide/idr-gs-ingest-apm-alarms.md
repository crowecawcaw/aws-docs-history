...
- [Ingest Alarms from APMs with direct EventBridge integration](idr-gs-ingest_alarms_from_apm_to_eventbridge.md "idr-gs-ingest_alarms_from_apm_to_eventbridge.md")
- [Ingest alarms from APMs without direct integration with EventBridge](idr-gs-ingest-apm-webhooks.md "idr-gs-ingest-apm-webhooks.md")
- [Ingest Alarms from APMs with direct Amazon SNS integration](idr-gs-ingest-apm-sns.md "idr-gs-ingest-apm-sns.md")

###### Note

The CloudFormation templates require modifications. These modifications are explained in the preceding topics. For more information on the required payload format for sending APM alerts to AWS Incident Detection and Response see [Payload Requirements For Ingesting APM Alerts with EventBridge](idr-gs-apm-payload-requirements.md "idr-gs-apm-payload-requirements.md").
