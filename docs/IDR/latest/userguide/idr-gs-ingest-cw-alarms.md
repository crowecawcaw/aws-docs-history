...
- Configure alarms with [metric math expressions](suppress-alarms-at-source.md "suppress-alarms-at-source.md") to suppress them during periods of regular maintenance or batch job executions to avoid false positive alarm engagements.
...
- Identify and create alarms for [custom metrics](../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md "../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md") that directly represent the customer experience for your workload.
  For a list of recommended Amazon CloudWatch alarms for common AWS services, see the [Incident Detection and Response Alarm Best Practices on AWS re:Post](https://repost.aws/selections/KP6FA7iQgVSVeSNq1jAcjwxg/incident-detection-and-response-idr "https://repost.aws/selections/KP6FA7iQgVSVeSNq1jAcjwxg/incident-detection-and-response-idr").
