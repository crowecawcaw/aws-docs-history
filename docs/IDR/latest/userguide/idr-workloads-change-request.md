...
![AWS Support Center example.](https://docs.aws.amazon.com/IDR/latest/userguide/images/workload-change-request1.png)
...
1. Enter a **Subject** for this change. For example:
   ...
   AWS Incident Detection and Response - {{workload\_name}} 
...
![Enter contacts in the highlighted Additional contacts - optional section.](https://docs.aws.amazon.com/IDR/latest/userguide/images/workload-change-request2.png)
**Important**  
...
![The Details page showing the Reply button highlighted.](https://docs.aws.amazon.com/IDR/latest/userguide/images/workload-change-request3.png)
...
![The Reply page where you can add additional emails.](https://docs.aws.amazon.com/IDR/latest/userguide/images/workload-change-request4.png)