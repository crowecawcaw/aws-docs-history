...
**Topics**
+ [Create your Amazon VPC and subnet](#create-vpc)
+ [Launch an Amazon EC2 instance in your subnet](#launch-ec2-instance)
+ [Create Amazon VPC interface endpoint](#create-vpc-endpoint)
+ [Test your connection to the interface endpoint](#connect-vpc-endpoint)
