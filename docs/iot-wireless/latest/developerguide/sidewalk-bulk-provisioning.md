...
devices in a factory and want to onboard these devices to AWS IoT. For more information about
manufacturing devices, see [Manufacturing Amazon Sidewalk devices](https://docs.sidewalk.amazon/manufacturing/ "https://docs.sidewalk.amazon/manufacturing/") in the _Amazon Sidewalk
documentation_.
...
import tasks, and view the status of the import task and devices in the
task.
