# Troubleshooting Amazon One identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with Amazon One Enterprise and IAM.

###### Topics

- [I am not authorized to
  perform an action in Amazon One](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
- [I want to allow people
  outside of my AWS account to access my Amazon One resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Amazon One
...
have the fictional `one:`GetWidget`` permissions.
...
`one:`GetWidget`` action.

If you need help, contact your AWS administrator. Your administrator is the person who provided you with your sign-in credentials.

## I want to allow people

outside of my AWS account to access my Amazon One resources
...
- To learn whether Amazon One Enterprise supports these features, see [How Amazon One Enterprise works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
