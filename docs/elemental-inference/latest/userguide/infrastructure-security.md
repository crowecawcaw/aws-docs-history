...
As a managed service, AWS Elemental Inference is protected by AWS global network security. For
...
You use AWS published API calls to access Elemental Inference through the network. Clients must
