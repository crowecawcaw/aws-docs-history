...
The AWS Management Console includes a console for Elemental Inference, but if you want to access the services
...
- The API guides document the operations that the services support and provide
  ...
  - [AWS Elemental Inference API Reference](../APIReference.md "../APIReference.md")

- To call an API without having to handle low-level details like assembling raw
  HTTP requests, you can use an AWS SDK. The AWS SDKs provide functions and
  data types that encapsulate the functionality of AWS services. To download an
  AWS SDK and access installation instructions, see the applicable page:
...
- You can use the AWS Command Line Interface (AWS CLI) to control multiple AWS services from the
  command line. You can also automate your commands using scripts. For more
  information, see [AWS Command Line Interface](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/").
