...
The AWS Management Console includes a console for Elemental Inference, but if you want to access the services programmatically, see the following:
+ The API guides document the operations that the services support and provide links to the related SDK and CLI documentation:
  + [AWS Elemental Inference API Reference](https://docs.aws.amazon.com/elemental-inference/latest/APIReference/)
