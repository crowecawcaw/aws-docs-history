...
- **Security of the cloud** – AWS is responsible for
  ...
  learn about the compliance programs that apply to AWS Elemental Inference, see [AWS Services in Scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  using Elemental Inference. The following topics show you how to configure Elemental Inference to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Elemental Inference resources.

###### Topics

- [Data protection in AWS Elemental Inference](data-retention.md "data-retention.md")
- [Identity and Access Management for AWS Elemental Inference](security-iam.md "security-iam.md")
- [Compliance validation for AWS Elemental Inference](SERVICE-compliance.md "SERVICE-compliance.md")
- [Resilience in AWS Elemental Inference](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure security in AWS Elemental Inference](infrastructure-security.md "infrastructure-security.md")
