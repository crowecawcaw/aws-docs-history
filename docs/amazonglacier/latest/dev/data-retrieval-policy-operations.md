...
- [Get Data Retrieval Policy (GET policy)](api-GetDataRetrievalPolicy.md "api-GetDataRetrievalPolicy.md")
...
- [Set Data Retrieval Policy (PUT policy)](api-SetDataRetrievalPolicy.md "api-SetDataRetrievalPolicy.md")
