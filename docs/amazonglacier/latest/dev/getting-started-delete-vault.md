...
You can delete a vault programmatically or by using the Amazon Glacier console. For information about deleting a vault programmatically, see [Deleting a Vault in Amazon Glacier](deleting-vaults.md).
...
1. Select the option button next to the empty vault that you want to delete. If the vault is not empty, you must delete all archives before deleting the vault. For more information, see [Deleting an Archive in Amazon Glacier](deleting-an-archive.md). 
**Important**  
