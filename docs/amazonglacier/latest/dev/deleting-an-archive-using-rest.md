...
- For information about the Delete Archive API, see [Delete Archive (DELETE archive)](api-archive-delete.md "api-archive-delete.md").
- For information about using the REST API, see [API Reference for Amazon Glacier](amazon-glacier-api.md "amazon-glacier-api.md").
