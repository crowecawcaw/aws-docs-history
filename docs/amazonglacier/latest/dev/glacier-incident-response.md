...
<a name="glacier-incident-response"></a>
...
**AWS CloudTrail Logs**  
CloudTrail provides a record of actions taken by a user, role, or an AWS service in Amazon Glacier. CloudTrail captures all API calls for Amazon Glacier as events, including calls from the Amazon Glacier console and from code calls to the Amazon Glacier APIs. For more information, see [Logging Amazon Glacier API Calls with AWS CloudTrail](audit-logging.md).
