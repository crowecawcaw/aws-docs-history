...
+ [Deleting an Empty Vault by Using the Amazon Glacier Console](deleting-vaults-console.md)
+ [Deleting a Vault in Amazon Glacier Using the AWS Command Line Interface](deleting-vaults-cli.md)