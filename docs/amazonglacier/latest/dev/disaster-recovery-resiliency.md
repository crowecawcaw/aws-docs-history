...
Regions provide multiple, physically separated and isolated Availability Zones that are
...
single data center infrastructures or multi-data center infrastructures. Amazon Glacier
redundantly stores data in multiple devices spanning a minimum of three Availability Zones.
To increase durability, Amazon Glacier synchronously stores your data across multiple AZs before
