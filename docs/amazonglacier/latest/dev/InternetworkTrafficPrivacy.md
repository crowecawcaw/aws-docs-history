...
later support these modes. Additionally, you must sign requests using an access key ID and a
secret access key that are associated with an IAM principal, or you can use the [AWS Security Token Service (AWS STS)](../../../STS/latest/APIReference/Welcome.md "../../../STS/latest/APIReference/Welcome.md") to generate temporary security
...
Although Amazon Glacier does not support VPC endpoints directly, you can take advantage of
Amazon Simple Storage Service (Amazon S3) VPC endpoints if you access Amazon Glacier as a storage tier integrated with Amazon S3.
