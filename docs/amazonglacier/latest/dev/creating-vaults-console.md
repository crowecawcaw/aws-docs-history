...
To create a vault using the Amazon Glacier (Amazon Glacier) console, see [Step 2: Create a Vault in Amazon Glacier](getting-started-create-vault.md "getting-started-create-vault.md") in the _Getting
Started_ tutorial.
