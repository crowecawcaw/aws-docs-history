...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| `operation=add` | A single query string parameter `operation` with a value of<br>`add` to distinguish it from [Remove Tags From Vault (POST tags remove)](api-RemoveTagsFromVault.md "api-RemoveTagsFromVault.md"). | Yes      |
...
_Length constraints:_ Minimum length of 1. Maximum length 10.
...
- [AWS Command Line Interface](../../../cli/latest/reference/glacier/add-tags-to-vault.md "../../../cli/latest/reference/glacier/add-tags-to-vault.md")
