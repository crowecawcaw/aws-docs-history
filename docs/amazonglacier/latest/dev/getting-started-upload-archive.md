...
In this step, you'll upload a sample archive to the vault that you created in the preceding step (see [Step 2: Create a Vault in Amazon Glacier](getting-started-create-vault.md)). Depending on the development platform that you're using, choose one of the links at the end of this section.
