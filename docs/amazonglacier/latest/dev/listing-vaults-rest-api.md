...
To list vaults using the REST API, see [List Vaults (GET vaults)](api-vaults-get.md "api-vaults-get.md").
To describe one vault, see [Describe Vault (GET vault)](api-vault-get.md "api-vault-get.md").
