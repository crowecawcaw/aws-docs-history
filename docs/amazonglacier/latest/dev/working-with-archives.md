...
for Amazon Glacier](../../../cli/latest/reference/glacier/index.md "../../../cli/latest/reference/glacier/index.md"). To install the AWS CLI, go to [AWS Command Line Interface](http://aws.amazon.com/cli/ "http://aws.amazon.com/cli/").
...
For
more information, see [Uploading an Archive in Amazon Glacier](uploading-an-archive.md "uploading-an-archive.md").
