...
To configure vault notifications using the REST API, see [Set Vault Notification Configuration (PUT
notification-configuration)](api-vault-notifications-put.md "api-vault-notifications-put.md").
Additionally, you can also get vault notifications ([Get Vault Notifications (GET
notification-configuration)](api-vault-notifications-get.md "api-vault-notifications-get.md")) and
delete vault notifications ([Delete Vault Notifications (DELETE
