...
1. Initiate a job of the `archive-retrieval` type. For more
   information, see [Initiate Job (POST jobs)](api-initiate-job-post.md "api-initiate-job-post.md").
2. After the job is completed, download the archive data. For more information, see [Get Job Output (GET output)](api-job-output-get.md "api-job-output-get.md").
