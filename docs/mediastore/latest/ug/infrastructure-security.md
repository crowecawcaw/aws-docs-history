...
As a managed service, AWS Elemental MediaStore is protected by AWS global network security. For
...
You use AWS published API calls to access MediaStore through the network. Clients must
