...
examples for AWS Elemental MediaStore

By default, users and roles don't have permission to create or modify MediaStore
...
Identity-based policies determine whether someone can create, access, or delete MediaStore resources in your
...
To access the AWS Elemental MediaStore console, you must have a minimum set of permissions.
These permissions must allow you to list and view details about the MediaStore resources
...
To ensure that users and roles can still use the MediaStore console, also attach the
MediaStore `ConsoleAccess` or `ReadOnly` AWS managed policy to
