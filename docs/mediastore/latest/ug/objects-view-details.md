...
After you upload an object, AWS Elemental MediaStore stores details such as the modification
date, content length, ETag (entity tag), and content type. To learn how an object's
metadata is used, see [MediaStore's interaction with HTTP caches](cdn-mediastore-interaction-with-http-caches.md "cdn-mediastore-interaction-with-http-caches.md").
...
2. On the **Containers** page, choose the name of container that
   has the object that you want to view.
3. If the object that you want to view is in a folder, continue choosing the
