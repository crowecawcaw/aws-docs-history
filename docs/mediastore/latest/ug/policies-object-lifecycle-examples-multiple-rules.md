...
- Move objects that are stored in the `AwardsShow` folder to the
  infrequent access (IA) storage class after 30 days
- Delete objects that have a file extension of `m3u8` and are stored in the `Football` folder after 20
  seconds
