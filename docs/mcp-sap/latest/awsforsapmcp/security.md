...
The AWS for SAP MCP Server runs in virtual private cloud (VPC) mode on Amazon Bedrock AgentCore Runtime. Network access is controlled through VPC security groups and subnets that you configure during deployment. You can manage network access to Amazon Bedrock AgentCore by using [resource-based policies](../../../bedrock-agentcore/latest/devguide/resource-based-policies.md "../../../bedrock-agentcore/latest/devguide/resource-based-policies.md").
