...
| Invalid credentials                                | `ODataAuthError`, HTTP 401 status code.                                                                                                     | For BASIC auth: verify the AWS Secrets Manager secret contains the correct username and password. For M2M/USER_FEDERATION: verify the OAuth provider name and scopes.                                                                                                                                                                                                                                                                                        |
...
| Configuration validation failures                  | Server fails to start, `ValidationError` in logs.                                                                                           | Review environment variables against the validation rules in [Configuration Reference](configuration-reference.md "configuration-reference.md").                                                                                                                                                                                                                                                                                                             |
