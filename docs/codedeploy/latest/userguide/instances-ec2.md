...
Amazon Elastic Compute Cloud. Amazon EC2 provides scalable computing capacity in the AWS Cloud. You can use Amazon EC2 to
launch as many or as few virtual servers as you need for your CodeDeploy deployments.

For more information about Amazon EC2, see [_Amazon EC2 Getting Started Guide_](../../../AWSEC2/latest/UserGuide.md "../../../AWSEC2/latest/UserGuide.md").
