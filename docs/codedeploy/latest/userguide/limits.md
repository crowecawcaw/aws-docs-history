...
| Applications associated per account per region | Each supported Region: 1,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-3F19B6A5)  | The maximum number of applications associated with an AWS account in a single region | 
| Associated alarms per deployment group | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-9F835576)  | The maximum number of alarms associated with a deployment group | 
| Auto Scaling groups in a deployment group | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-6DACB4EE)  | Maximum number of Amazon EC2 Auto Scaling groups in a deployment group | 
| Concurrent deployments per account | Each supported Region: 1,300 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-AB125F0B)  | Maximum number of concurrent deployments associated with an AWS account. Each deployment to a scaled-up Amazon EC2 instance in an Amazon EC2 Auto Scaling group counts as a single concurrent deployment for each application that the EC2 instance is associated with. | 
...
| Deployment groups associated with a single application | Each supported Region: 1,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-D9088B77)  | Maximum number of deployment groups associated with a single application | 
...
| Event notification triggers in a deployment group | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-877B748B)  | Maximum number of event notification triggers in a deployment group | 
...
| Instances count per deployment | us-east-1: 2,000<br />us-east-2: 2,000<br />us-west-2: 2,000<br />eu-central-1: 2,000<br />Each of the other supported Regions: 1,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-6BCCFC85)  | Maximum number of instances in a single deployment | 
...
| Number of instances used by concurrent deployments that are in progress per account | us-east-1: 3,000<br />Each of the other supported Regions: 1,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/codedeploy/quotas/L-464411D9)  | Maximum number of instances that can be used by concurrent deployments that are in progress and associated with one account | 
