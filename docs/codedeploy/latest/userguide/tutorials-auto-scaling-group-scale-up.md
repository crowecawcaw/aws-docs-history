...
2. Choose **Actions**, and then choose
   **Edit**.
3. On the **Details** tab, in the
   **Desired**, **Min**, and
   **Max** boxes, type `2`, and then
   choose **Save**.
4. Choose the **Instances** tab. The new Amazon EC2 instance
   should appear in the list. (If the instance does not appear, you may need to
   choose the **Refresh** button a few times.) Do not proceed
   until the value of **InService** appears in the
