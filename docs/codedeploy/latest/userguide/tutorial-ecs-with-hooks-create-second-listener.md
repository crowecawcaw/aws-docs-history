...
The listener for your test traffic can use either of your target groups. Use the [create-listener](../../../cli/latest/reference/elbv2/create-listener.md "../../../cli/latest/reference/elbv2/create-listener.md") AWS CLI command to
create a second listener with a default rule that forwards test traffic to port 8080. Use the
ARN of your load balancer and the ARN of one of your target groups.
