...
In CodeDeploy, a deployment is the process, and the components involved in the process, of
installing content on one or more instances. This content can consist of code, web and
...
- [Create a deployment](deployments-create.md "deployments-create.md")
- [View deployment details](deployments-view-details.md "deployments-view-details.md")
- [View deployment log data](deployments-view-logs.md "deployments-view-logs.md")
- [Stop a deployment](deployments-stop.md "deployments-stop.md")
- [Redeploy and roll back a deployment](deployments-rollback-and-redeploy.md "deployments-rollback-and-redeploy.md")
- [Deploy an application in a different AWS account](deployments-cross-account.md "deployments-cross-account.md")
- [Validate a deployment package on a local machine](deployments-local.md "deployments-local.md")
