...
multiple on-premises instances

You can get information about on-premises instances by following the instructions in [View CodeDeploy deployment details](deployments-view-details.md "deployments-view-details.md") . You can use
the AWS CLI or the CodeDeploy console to get more information about on-premises instances.
...
2. For more detailed information, call the [batch-get-on-premises-instances](../../../cli/latest/reference/deploy/batch-get-on-premises-instances.md "../../../cli/latest/reference/deploy/batch-get-on-premises-instances.md")
   command, with the names of the on-premises instances (with the
...
Sign in with the same user that you set up in [Getting started with CodeDeploy](getting-started-codedeploy.md "getting-started-codedeploy.md"). 2. In the navigation pane, expand **Deploy**, and choose **On-premises instances**.

Information about the on-premises
