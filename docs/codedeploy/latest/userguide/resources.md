...
## Blogs
<a name="resources-blogs"></a>
+ [AWS DevOps blog](https://aws.amazon.com/blogs/devops/) — Insights for developers, system administrators, and architects.

## AWS software development kits and tools
<a name="resources-sdks"></a>
