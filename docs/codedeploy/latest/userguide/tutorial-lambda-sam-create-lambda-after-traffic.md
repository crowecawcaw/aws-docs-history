...
1. Create a text file and save it as `afterAllowTraffic.js` in
   the `SAM-Tutorial` directory.
2. Copy the following Node.js code into `afterAllowTraffic.js`.
   This function executes during your deployment's `AfterAllowTraffic` hook.
