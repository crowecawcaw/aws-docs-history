...
To install the CodeDeploy agent, choose the Systems Manager Distributor package for the agent
version you want, then follow the steps in [Install or update packages with AWS Systems Manager distributor](../../../systems-manager/latest/userguide/distributor-working-with-packages-deploy.md "../../../systems-manager/latest/userguide/distributor-working-with-packages-deploy.md"). The package differs by
agent version:

- For version 2.0.x and later, choose the `AWSCodeDeployAgentV2`
  package.
- For version 1.8.x and earlier, choose the `AWSCodeDeployAgent`
  package.
