...
The resource names in these steps are the names suggested in this tutorial (for example,
`ecs-demo-codedeploy-app` for the name of your CodeDeploy application). If
you used different names, then be sure to use those during your cleanup.
