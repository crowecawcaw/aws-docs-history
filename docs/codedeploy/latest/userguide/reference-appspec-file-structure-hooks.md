...
| Lifecycle event name                                                                                                                                                                                                                                                                                                                                                                                                  | Amazon EC2 Auto Scaling launch deployment¹ | Amazon EC2 Auto Scaling termination deployment¹ | In-place deployment² | Blue/green deployment: Original instances | Blue/green deployment: Replacement instances | Blue/green deployment rollback: Original instances | Blue/green deployment rollback: Replacement instances |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------------------- | -------------------- | ----------------------------------------- | -------------------------------------------- | -------------------------------------------------- | ----------------------------------------------------- |
| **ApplicationStop**                                                                                                                                                                                                                                                                                                                                                                                                   | ✓                                          | ✓                                               | ✓                    |                                           | ✓                                            |                                                    |                                                       |
| **DownloadBundle**³                                                                                                                                                                                                                                                                                                                                                                                                   | ✓                                          |                                                 | ✓                    |                                           | ✓                                            |                                                    |                                                       |
| **BeforeInstall**                                                                                                                                                                                                                                                                                                                                                                                                     | ✓                                          |                                                 | ✓                    |                                           | ✓                                            |                                                    |                                                       |
...
**Amazon EC2 Auto Scaling launch deployments**

During an Amazon EC2 Auto Scaling launch deployment, CodeDeploy runs event hooks in the following
order.

For more information about Amazon EC2 Auto Scaling launch deployments, see [How Amazon EC2 Auto Scaling works with
...
![The order of event hooks during an Amazon EC2 Auto Scaling launch deployment.](images/lifecycle-event-order-scale-out.png)
...
**Amazon EC2 Auto Scaling termination deployments**

During an Amazon EC2 Auto Scaling termination deployment, CodeDeploy runs event hooks in the following
order.

For more information about Amazon EC2 Auto Scaling termination deployments, see [Enabling
...
![The order of event hooks during an Amazon EC2 Auto Scaling termination deployment.](images/lifecycle-event-order-scale-in.png)
