...
instead of 80 if the value of **DEPLOYMENT\_GROUP\_NAME** is
...
error log from warning to debug if the value of the **DEPLOYMENT\_GROUP\_NAME** environment variable is equal to
