...
see [AWS CloudTrail User Guide](../../../awscloudtrail/latest/userguide.md "../../../awscloudtrail/latest/userguide.md").
...
All of the CodeDeploy actions are logged and documented in the [AWS CodeDeploy Command Line Reference](../../../cli/latest/reference/deploy/index.md "../../../cli/latest/reference/deploy/index.md") and the [AWS CodeDeploy API Reference](../APIReference.md "../APIReference.md"). For example, calls to create deployments, delete applications, and
...
another AWS service. For more information, see the **userIdentity** field
in the [CloudTrail event
