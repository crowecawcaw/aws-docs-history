...
1. Create a text file and save it as `beforeAllowTraffic.js` in
   the `SAM-Tutorial` directory.
2. Copy the following Node.js code into `beforeAllowTraffic.js`.
   This function executes during your deployment's `BeforeAllowTraffic` hook.
