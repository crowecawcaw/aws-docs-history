...
see [AWS Lambda
runtimes](../../../lambda/latest/dg/lambda-runtimes.md "../../../lambda/latest/dg/lambda-runtimes.md").

###### To create your Lambda function

1. Create a text file and save it as `myDateTimeFunction.js` in
...
The Lambda function returns the day, month, and year for yesterday, today, or tomorrow.
Later in this tutorial, you uncomment code that updates the function to return information
about the day or time you specify (for example, the day, month, and year, or the current
hour, minute, and second). The framework created by AWS SAM detects and deploys the updated
...
update, and debug this function in AWS Cloud9, see [AWS Lambda tutorial for
AWS Cloud9](../../../cloud9/latest/user-guide/tutorial-lambda.md "../../../cloud9/latest/user-guide/tutorial-lambda.md").
