...
`CodeDeployDemo-AS-Group` as you did before:
...
Using a web browser, show the SimpleDemoApp revision deployed to that
Amazon EC2 instance, using a URL like the following:
...
On the **Instances** tab, choose the Amazon EC2 instance ID in the
list.
