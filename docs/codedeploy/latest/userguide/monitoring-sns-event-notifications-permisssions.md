...
2. In the IAM console, in the navigation pane, choose
   **Roles**.
3. Choose the name of the service role you use in your AWS CodeDeploy
   operations.
4. On the **Permissions** tab, in the **Inline
   Policies** area, choose **Create Role
   Policy**.

–or–

If the **Create Role Policy** button is not available, expand
the **Inline Policies** area, and then choose **click
here**. 5. On the **Set Permissions** page, choose **Custom
Policy**, and then choose **Select**. 6. On the **Review Policy** page, in the **Policy
Name** field, enter a name to identify this policy, such as
`SNSPublish`. 7. Paste the following into the **Policy Document** field:
