...
**To view your migration spaces**
 ...
 You can view migration spaces of which you are a member, either as an administrator or a contributor.
...
1. In the table that shows your migration spaces, choose the space that you want to delete.

1. Choose **Actions**, and then choose **Delete migration space**.

## Migration journeys
<a name="view-migration-journeys"></a>
...
1. Look for an email with the title *You've been invited to join the {{name-of-the-migration-space}} migration space*.
   ...
   Don't reply to the email. Instead, choose the hyperlinked word **Respond** in the body of the email. Choosing **Respond** takes you to the **Pending actions** page in the Migration Hub Journeys console.

   If you know you've received an invitation but don't see the invitation email, go to the Migration Hub Journeys console, and choose **Pending actions** in the navigation pane.

1. In the **Invitations** section, choose the radio button next to the invitation that you want to accept or reject.
...
1. In the table that shows your migration spaces, choose the space that has the team that you want to delete.

1. Choose **Teams**.

1. Choose the team that you want to delete.

1. Choose **Actions**, and then choose **Delete team**.