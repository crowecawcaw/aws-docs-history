...
When someone sends you an invitation, you receive an email that includes a button that you can use to respond to the invitation. That button takes you to the **Pending actions** page of the Migration Hub Journeys console. On that page, you can accept or reject each invitation.

You don't have to respond through the email. You can go directly to the **Pending actions** page of the Migration Hub Journeys console and view all the invitations you've received.
