...
4. To access the sharing page, do one of the following:
   - Select the custom billing view whose sharing you want to update, choose
     **Actions**, and then choose **Edit external shares** from the dropdown list.
   - Choose the name of the custom billing view whose sharing you want to update and,
     on the view details page, choose the **Sharing** tab. Next to
     **Share outside of your organization**, choose
     **Edit**.

5. Choose which account IDs should have access to the custom billing view.
6. Choose **Share**.
