...
| Deployment model | Amazon RDS | Whether your recommended reserved instance is for RDS Custom. If the value is "Custom", you<br>must to purchase the recommended reserved instances for RDS Custom to see potential savings. |
...
| Tenancy | Amazon EC2 | The tenancy for the recommendation. Valid values are *_shared_<br>• or<br>**dedicated**. |
