...
4. Choose **Actions**, and then choose **Export PDF** from the dropdown list.
5. Wait for PDF preview to load, verify the layout and choose **Export PDF**.
6. The PDF file will be generated and downloaded to your device.
...
7. The PDF file will be generated and downloaded to your device.
...
1. Review the PDF preview before finalizing the export
2. If you notice data is being truncated or excluded, cancel the PDF preview
3. Edit the widget's time range to a shorter period (e.g., change from yearly to quarterly or monthly view)
