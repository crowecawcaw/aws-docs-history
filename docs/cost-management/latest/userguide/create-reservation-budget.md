...
It can take up to 48 hours for Reservations utilization and coverage metrics
to generate, which is longer than the time frame for cost and usage data.
...
4. Under **Budget setup**, choose **Customize
   (advanced)**.
5. Under **Budget types**, choose **Reservation
...
**Utilization of reservations** to track how much of
your reservation you used. Or, choose **Coverage of
reservations** to track how much of your instance usage is
covered by reservations. 9. For **Service**, choose the service that you want the
budget to track. 10. For **Utilization threshold**, enter the utilization
percentage that you want AWS to notify you at. For example, for a
utilization budget where you want to stay above 90% RI utilization, enter
`90`. The budget notiﬁes you when your overall RI
...
budget notiﬁes you when your overall coverage is below 80%. 11. (Optional) Under **Budget scope**, for
...
linked account. 12. Choose **Next**. 13. Under **Notification preferences**, for **Email
