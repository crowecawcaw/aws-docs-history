...
**Topics**
+ [Multi-year data at monthly granularity](ce-multi-year-data.md)
+ [Granular data](ce-granular-data.md)
+ [Understanding your estimated monthly usage summary](ce-estimated-monthly-usage-summary.md)
+ [Configuring multi-year and granular data](ce-configuring-data.md)