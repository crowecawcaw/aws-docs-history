...
As a managed service, AWS Cost Management is protected by the AWS global network security
...
You use AWS published API calls to access Billing and Cost Management through the network. Clients must
