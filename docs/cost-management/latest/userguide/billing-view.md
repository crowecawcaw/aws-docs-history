...
By using billing view, you can create custom billing views from your organization’s management
...
- [Accessing cost management data using billing views](access-data-custom-billing-views.md "access-data-custom-billing-views.md")
