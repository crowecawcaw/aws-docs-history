...
multiple AWS compliance programs. AWS Cost Management is not in scope of any AWS compliance programs.
...
Your compliance responsibility when using AWS Cost Management is determined by the sensitivity
