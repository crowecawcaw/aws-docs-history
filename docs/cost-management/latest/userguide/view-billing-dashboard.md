...
1. Open the AWS Billing and Cost Management console at [https://console.aws.amazon.com/costmanagement](https://console.aws.amazon.com/costmanagement/home "https://console.aws.amazon.com/costmanagement/home").
...
- [Cost summary](#cost-summary-widget "#cost-summary-widget")
- [Cost monitor](#cost-monitor-widget "#cost-monitor-widget")
- [Cost breakdown](#cost-breakdown-widget "#cost-breakdown-widget")
- [Recommended actions](#recommended-actions-widget "#recommended-actions-widget")
- [Savings opportunities](#savings-opportunities-widget "#savings-opportunities-widget")
- [Top trends](#top-trends-widget "#top-trends-widget")
...
For more information about Cost Explorer, see [Forecasting with Cost Explorer](ce-forecast.md "ce-forecast.md").
...
For more information about budgets, see [Managing your costs with AWS Budgets](budgets-managing-costs.md "budgets-managing-costs.md").

For more information about anomaly detection monitors, see [Detecting unusual spend with
AWS Cost Anomaly Detection](manage-ad.md "manage-ad.md").
...
using Cost Explorer](ce-exploring-data.md "ce-exploring-data.md").
...
You will need the new IAM permission `bcm-recommended-actions:ListRecommendedActions` to view all recommended actions. For more information, see [Understanding recommended action types](recommended-action-types.md "recommended-action-types.md").

For a full list of the different recommended action types and the corresponding IAM policy permissions needed in order to see the recommended actions, refer to [Billing and Cost Management recommended actions policies](billing-permissions-ref.md#allows-recommended-actions-access "billing-permissions-ref.md#allows-recommended-actions-access").

For full details on the categorization of recommended actions, see [Understanding recommended action types](recommended-action-types.md "recommended-action-types.md").
...
dimensions important to your organization. For more information, see [Building a cost allocation strategy](../../../whitepapers/latest/tagging-best-practices/building-a-cost-allocation-strategy.md "../../../whitepapers/latest/tagging-best-practices/building-a-cost-allocation-strategy.md") in the
...
- [Using Tag Editor](../../../tag-editor/latest/userguide/tag-editor.md "../../../tag-editor/latest/userguide/tag-editor.md")
...
When you use billing transfer, savings opportunities are calculated based on On-Demand costs (costs without negotiated discounts, AWS Partner Network program discounts, or Reserved Instance and Savings Plans discounts). To learn about cost optimization best practices while billing transfer is active, see [Transfer billing management to external accounts](../../../awsaccountbilling/latest/aboutv2/orgs_transfer_billing.md "../../../awsaccountbilling/latest/aboutv2/orgs_transfer_billing.md").
...
For more information about comparing costs, see [Comparing your costs between time periods](ce-cost-comparison.md "ce-cost-comparison.md").
