...
1. Choose **Actions**, and then choose **Duplicate dashboard** from the dropdown list.

1. In the dialog box that appears, you can modify the name and description for your new dashboard.
