...
If the Porting Assistant for .NET extension is disabled, contact [aws-porting-assistant-support@amazon.com](mailto:aws-porting-assistant-support@amazon.com "mailto:aws-porting-assistant-support@amazon.com").
