...
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| Updated Porting Assistant for .NET required IAM policy. | Updated the IAM policy that you must attach as an inline policy to your IAM user.                                                                                | October 1, 2020 |
| Porting Assistant for .NET initial release              | Initial release of Porting Assistant for .NET: a tool that helps you to port your existing .NET applications running on<br>Windows Server to .NET Core on Linux. | June 30, 2020   |
