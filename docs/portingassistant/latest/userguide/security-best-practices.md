...
Grant only the permissions that are required to perform a specified task. Implementing least privilege access is fundamental in reducing security risk and the impact that could result from errors or malicious intent. 