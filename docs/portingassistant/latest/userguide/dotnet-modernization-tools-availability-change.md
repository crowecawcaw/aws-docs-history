...
<a name="dotnet-modernization-tools-availability-change"></a>
...
+ **On November 7, 2025, how can I get help if I have issues?**
  ...
  Customers experiencing issues can contact [AWS Support](https://aws.amazon.com/support).
