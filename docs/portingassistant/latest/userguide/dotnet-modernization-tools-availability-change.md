...
Existing users can complete their current projects using existing tools, while all new modernization projects can start in AWS Transform. To begin using AWS Transform, see the [Getting Started Guide](../../../transform/latest/userguide/what-is-service.md "../../../transform/latest/userguide/what-is-service.md"). No data migration or special transition tools are needed, as users can organically switch to AWS Transform for any new work.
...
Customers experiencing issues can contact [AWS Support](https://aws.amazon.com/support "https://aws.amazon.com/support").
