...
securely control access to AWS resources. Porting Assistant for .NET is a standalone application that does
not require IAM access control to use resources.
