...
<a name="add-amplify-storage-to-the-app"></a>
...
1. To create the Storage category, enter the following when prompted:
...
1. Open the **main.dart** file and update the **\_configureAmplify()** function as shown in the following code to add the Amplify storage plugin.
...
**Note**  
VSCode will show errors due to the missing the **trip\_controller.g.dart** file. You will fix that in the next step.
...
1. Open the **lib/common/navigation/router/router.dart** file and update it to add the **TripPage** route.
...
1. Open the **lib/common/navigation/router/router.dart** file and update it to add the **EditTripPage** route.
...
1. Run the app in the simulator and try the following:
   + Create a new trip
