...
In this module, you will learn how to authenticate a user with the [Amplify auth category](https://docs.amplify.aws/lib/auth/getting-started/q/platform/flutter/) by using Amazon Cognito, a managed user identity service.

You will also learn how to use the [Amplify Authenticator](https://ui.docs.amplify.aws/flutter/components/authenticator) library to quickly create an authentication flow for the app, allowing users to sign up, sign in, and reset their password with just a few lines of code.
...
<a name="add-amplify-authentication-category-to-the-app"></a>
...
1. Select the **Default configuration **option and then select **Email **as the sign-in method. Then select the** No, I am done** option.
...
<a name="minimum-time-to-complete"></a>
...
1. Open the **main.dart** file and update it with the following code. This contains the logic of configuring Amplify for the Auth category.
