...
| **Get help** | [Troubleshooting Lambda Functions](https://docs.amplify.aws/react/build-a-backend/functions/)  | 
...
<a name="create-a-lambda-function-for-handling-requests"></a>
...
<a name="add-amazon-bedrock-as-a-data-source"></a>
