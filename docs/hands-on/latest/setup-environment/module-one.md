...
| **Get help** | [Troubleshooting AWS account sign-in issues](https://docs.aws.amazon.com/signin/latest/userguide/troubleshooting-sign-in-issues.html)  | 
...
<a name="add-contact-information"></a>
...
1. Accept the AWS Customer Agreement
   ...
   At the end of this form, read through the terms of the [AWS Customer Agreement](https://aws.amazon.com/agreement/) and select the checkbox to accept them.  
...
<a name="confirm-your-identity"></a>
