...
| **Get help**            | [Troubleshooting<br>AWS account sign-in issues](../../../signin/latest/userguide/troubleshooting-sign-in-issues.md "../../../signin/latest/userguide/troubleshooting-sign-in-issues.md") |
...
![Interface element requiring manual review.](images/interface.png) 2. Enter the email verification code
...
![The navigation bar showing create a password create your root user password. the password you...](images/navigation-bar-password-your-root-user-you.png) 4. Choose continue
...
![The navigation interface.](images/navigation-interface.png) 3. Accept the AWS Customer Agreement
...
![Interface element requiring manual review.](images/interface-interface-element.png) 2. Choose Continue
...
![Security verification CAPTCHA with distorted text and options for audio or refresh.](images/security-verification-captcha-distorted.png) 4. Enter the verification code
...
![The selection interface.](images/selection-interface.png) 2. Choose Complete sign up
