...
1. Create the stack
   ...
   This stack assumes that you already have a public VPC set up in your account. If you do not have a public VPC, see [VPC with a single public subnet](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Scenario1.html) to learn how to create a public VPC.    
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface.png)
...
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface-1.png)
...
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface-2.png)
...
![The navigation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-interface.jpeg)
...
![The navigation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-interface-1.jpeg)
...
![The navigation menu interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/image-navigation-menu-interface.png)
...
![The selection interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/image-selection-interface.jpeg)

1. Import data from S3

   In the **Data Import** tab, under I**mport data**, choose **Amazon S3**.   
![Interface element requiring manual review.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/image-aeb-fde-cfadcefb-interface.jpeg)
...
![Interface element requiring manual review.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface.jpeg)
...
![A data analysis interface showing dataset statistics, including 10,692 rows, 8 numeric features, and 5.65% duplicate rows, with high-priority warnings for duplicate rows and target leakage.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/data-analysis-interface-dataset-statistics.jpeg)
...
![A histogram showing the distribution of Brazilian house rent amounts by the number of rooms, with a data table below and analysis settings on the right.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/histogram-distribution-brazilian-house.jpeg)
...
![A data analysis interface showing a bar chart of feature importance, a data table with housing attributes, and a panel for creating a "Quick Model" analysis with highlighted fields for analysis type, name, and label.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/data-analysis-interface-bar-chart-feature.jpeg)
...
![The navigation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-interface-2.jpeg)

1. Add a transformation

   Under the **ALL STEPS** pane, choose **Add step**.   
![AWS SageMaker AI Data Wrangler interface showing data transformation for a CSV file, with histograms and data columns for city, area, rooms, bathrooms, and parking, and an "Add step" button highlighted.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/data-wrangler-interface-transformation.png)
...
![Interface for managing rows with options to drop duplicates, featuring 'Preview' and 'Add' buttons.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface-managing-rows-options-drop.jpeg)
...
![A data management interface showing options to drop columns, with "property tax (R$)" and "fire insurance (R$)" selected for removal.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/data-management-interface-options-drop.jpeg)
...
![Table of data types with a highlighted "floor" row and "Preview" and "Update" buttons visible at the bottom.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/table-data-types-highlighted-floor-row.jpeg)
...
![A data management interface showing options to rename a column from "bathroom" to "bathrooms" with buttons for preview and add.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/data-management-interface-options-rename.jpeg)
...
![The configuration settings interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/configuration-settings-interface.jpeg)
...
![A user interface for adding data transformations, highlighting the "Process numeric" option with settings for scaling values using a standard scaler and specifying input columns "floor" and "area.".](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/user-interface-adding-data-transformations.jpeg)
...
![A software interface showing a list of data transformation options, with "Add Transform" highlighted at the top and "Search and edit" outlined in red at the bottom.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/software-interface-list-data.jpeg)
...
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface.jpeg)
...
![Interface element requiring manual review.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface-1.jpeg)
...
![Dropdown menu with 'Add destination' highlighted and pointing to 'Amazon S3'.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/dropdown-menu-destination-highlighted.jpeg)
...
![Amazon S3 configuration panel showing dataset name "kaggle_brazil_home_rentals_data_processed.csv" and S3 location "s3://sagemaker-us-east-1-645411898653/".](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/configuration-panel-dataset-name-kaggle.jpeg)
...
![A screenshot of the AWS SageMaker AI Data Wrangler interface showing a data flow diagram with multiple nodes for data processing steps and a "Create job" panel on the left.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/screenshot-data-wrangler-interface-flow.jpeg)

1. Configure job

   Then you can decide on the job instance type, instance count, the job’s IAM security role, and the job schedule.   
![AWS SageMaker AI interface showing the 'Create Job' configuration panel and a 'Create new schedule' pop-up with scheduling options highlighted in red.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface-job-configuration-panel-new.jpeg)
...
![The navigation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-interface-3.jpeg)
...
![Interface element requiring manual review.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface-interface-element.jpeg)
...
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface-1.jpeg)
...
![Interface element requiring manual review.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/interface-2.jpeg)
...
![The navigation bar showing in the delete objects dialog box, and verify that you have selected the proper...](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-bar-delete-objects-dialog-box.png)
...
![Amazon SageMaker AI user details page showing two apps, both with "Ready" status and options to delete the apps.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/user-details-page-two-apps-both-ready.png)
...
![The navigation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/navigation-interface.png)
...
![The selection interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/selection-interface.png)

1. Delete the stack

   On the **CFN-SM-IM-Lambda-catalog** stack details page, choose **Delete** to delete the stack along with the resources it created.   
![The resource creation interface.](https://docs.aws.amazon.com/hands-on/latest/machine-learning-tutorial-prepare-data-with-minimal-code/images/resource-creation-interface-3.png)
