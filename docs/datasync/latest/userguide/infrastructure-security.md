...
As a managed service, AWS DataSync is protected by AWS global network security. For
...
You use AWS published API calls to access DataSync through the network. Clients must
