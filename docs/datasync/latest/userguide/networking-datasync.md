...
- [Connecting your storage network to AWS](networking-datasync.md#connecting-options-to-amazon "networking-datasync.md#connecting-options-to-amazon")
...
information, see [Choosing a service endpoint for your AWS DataSync agent](choose-service-endpoint.md "choose-service-endpoint.md").
...
DataSync service can access your S3 bucket or file system. For more information, see [Network requirements for AWS storage services](datasync-network.md#storage-service-network-requirements "datasync-network.md#storage-service-network-requirements").
...
storage systems you’re transferring between. For more information, see [Network requirements for AWS storage services](datasync-network.md#storage-service-network-requirements "datasync-network.md#storage-service-network-requirements").
