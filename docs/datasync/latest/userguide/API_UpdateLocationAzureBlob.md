...
authentication token or set of credentials that DataSync uses to access a specific
transfer location, and a customer-managed AWS Identity and Access Management (IAM) role that
...
- [AWS SDK for .NET V4](../../../goto/DotNetSDKV4/datasync-2018-11-09/UpdateLocationAzureBlob.md "../../../goto/DotNetSDKV4/datasync-2018-11-09/UpdateLocationAzureBlob.md")
