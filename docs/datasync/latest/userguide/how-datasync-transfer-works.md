...
**Note**  
If you configure your task to [transfer all data](configure-metadata.md#task-option-transfer-mode), DataSync doesn't compare your source and destination locations. Your task execution still has a `PREPARING` status, though. During this time, DataSync scans your source location to determine what it's transferring and how to transfer it.
