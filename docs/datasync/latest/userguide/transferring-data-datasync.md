...
With AWS DataSync, you can transfer data to or from storage that's on-premises, in AWS, in
other clouds, and on the edge.
...
between your storage system and DataSync. 5. Create a location for your storage system by using the DataSync console, AWS CLI, or
DataSync API.
...
location](create-s3-location.md#create-s3-location-how-to "create-s3-location.md#create-s3-location-how-to"). 6. Repeat steps 3-5 to create your transfer's other location. 7. [Create and start a DataSync transfer task](create-task-how-to.md "create-task-how-to.md")
...
- [Transferring to or from S3 compatible storage on
  Snowball Edge](s3-compatible-storage-snow.md "s3-compatible-storage-snow.md")
