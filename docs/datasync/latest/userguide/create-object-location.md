...
With AWS DataSync, you can transfer data between your object storage system and the following AWS storage services. Supported storage services depend on your task mode:
