...
To connect to your HDFS cluster, DataSync uses an [agent that you deploy](deploy-agents.md) as close as possible to your HDFS cluster. Use the agent that corresponds to your task mode. The DataSync agent acts as an HDFS client and communicates with the NameNodes and DataNodes in your cluster.
