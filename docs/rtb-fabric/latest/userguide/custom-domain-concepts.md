...
2. **Wildcard match** - If no exact match is found, the resolver iterates over the wildcard hostname entries, checking each wildcard pattern against the SNI hostname.
