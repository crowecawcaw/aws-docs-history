...
AWS RTB Fabric logs all RTB Fabric control plane operations as management events. For a list of the AWS RTB Fabric control plane operations that RTB Fabric logs to CloudTrail, see the [AWS RTB Fabric API Reference](https://docs.aws.amazon.com/RTB Fabric/latest/APIReference/).
