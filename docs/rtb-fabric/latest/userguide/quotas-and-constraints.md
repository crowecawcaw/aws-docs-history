...
For information about end-to-end bid-request latency, QPS capacity limits, and connection pooling characteristics, contact your RTB Fabric account team. For information about health check behavior, see [Health checks for Managed Endpoints](health-checks-for-managed-endpoints.md "health-checks-for-managed-endpoints.md").
