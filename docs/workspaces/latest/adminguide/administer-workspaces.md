...
To perform directory administration tasks, see [Set up Active Directory Administration Tools for WorkSpaces Personal](directory_administration.md "directory_administration.md").
...
- [Customize branding in WorkSpaces Personal](customize-branding.md "customize-branding.md")
