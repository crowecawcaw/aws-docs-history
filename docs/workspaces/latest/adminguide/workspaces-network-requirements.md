...
<tbody>
  <tr><td>Windows or Linux clients</td><td>In the upper-right corner of the client application, select the <b>Network</b> icon <img src="https://docs.aws.amazon.com/workspaces/latest/adminguide/images/network-icon.png" alt="Network icon" />.</td></tr>
