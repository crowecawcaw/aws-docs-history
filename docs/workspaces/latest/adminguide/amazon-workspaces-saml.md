...
![Opening WorkSpaces application redirection page](/images/workspaces/latest/adminguide/images/saml-redir.png) 4. The WorkSpaces client application is now registered and users can continue to sign by clicking
...
![Opening WorkSpaces application redirection page](/images/workspaces/latest/adminguide/images/saml-redir.png) 4. The WorkSpaces client application is now registered and users can continue to sign in through WorkSpaces Web Access.
