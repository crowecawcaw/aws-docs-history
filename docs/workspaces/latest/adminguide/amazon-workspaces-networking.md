...
**Note**  
Nested virtualization is not supported on PCoIP WorkSpaces. If you require nested virtualization to run hypervisors or tools like Docker Desktop, WSL2, or Android emulators inside your WorkSpace, you must use DCV. For information about switching protocols, see [Modify protocols](https://docs.aws.amazon.com/workspaces/latest/adminguide/modify-workspaces.html#modify-protocols). For more information about nested virtualization, see [Nested virtualization for WorkSpaces Personal](https://docs.aws.amazon.com/workspaces/latest/adminguide/nested-virtualization.html).
