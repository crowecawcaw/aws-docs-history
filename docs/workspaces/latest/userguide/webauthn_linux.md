...
+ Amazon WorkSpaces native clients for Windows, Linux and Mac that support WebAuthn.
   ...
   For more information, see [Client version requirements](webauthn_support.md#webauthn-client-versions).
...
1. To enable seamless setup, you can configure the system to preinstall the DCV WebAuthn extension as follows:
