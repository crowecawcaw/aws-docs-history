...
###### Warning
    ...
    * If you close the local browser window that you used to log in to
     CCP, you will lose your CCP audio (though your WorkSpaces client will
     continue running).
    * If you close your WorkSpaces window, your local browser window will
     also close, and your CCP audio will stop.

If you accidentally close your local browser CCP window or if it crashes, you can
restart it. Go to the menu bar, select **Add-in**, and then select the
administrator-given CCP name.

For more information about using Amazon Connect, go to the
[Agent training guide](../../../connect/latest/adminguide/agent-user-guide.md "../../../connect/latest/adminguide/agent-user-guide.md").
