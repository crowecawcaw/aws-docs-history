...
5. To add custom colors to your application, enable the **Customize** toggle and update the following settings:
   ...
   more accessible. 2. In **Header color**, choose the color that is applied to your app's header. You can choose a
   color with the color picker, RGB, HSL, or HEX code. 3. Choose **Default themes** to view and choose from predefined themes, or choose **Randomize** to generate a random
