...
1. In the navigation pane, choose **Connectors** in the **Manage** section.
   You will be taken to a page displaying a list of existing connectors with the following details for each connector:
   ...
   - **Connected to:** The service that the connector is connecting to App Studio.
     A value of **API** represents a connection to a third-party service.
