...
| **Quick Suite Embedding**           | A demo application that enables users to view analytics while working with the underlying data.<br>The app contains two methods for embedding Amazon Quick Suite dashboards in App Studio: an API-based approach<br>for registered and anonymous users (requiring Quick Suite connector), and an iFrame integration for public dashboards.                                                                                         | Quicksight Embedding/0cdc15fc-ca8b-41b7-869e-ed13c9072bc8            |
