...
<a name="troubleshooting-permissions-onboarding"></a>
...
**Solution:** Navigate to the IAM Identity Center console at [https://console.aws.amazon.com/singlesignon/](https://console.aws.amazon.com/singlesignon/) to check if you have an IAM Identity Center instance. Check every supported AWS Region until you locate the instance. You can either use that instance when setting up App Studio, or delete the IAM Identity Center instance and try again with the **Create an account instance for me** option.
...
<a name="troubleshooting-onboarding-not-in-group"></a>
...
**Solution:** Navigate to the IAM Identity Center console at [https://console.aws.amazon.com/singlesignon/](https://console.aws.amazon.com/singlesignon/) to add yourself to a group that was added to App Studio when setting up.

## Not sure what username or password to use when logging into App Studio
<a name="troubleshooting-onboarding-login-credentials"></a>
...
<a name="troubleshooting-onboarding-service-error"></a>
...
<a name="troubleshooting-onboarding-instance-url"></a>
...
<a name="troubleshooting-onboarding-modify-groups-roles"></a>
