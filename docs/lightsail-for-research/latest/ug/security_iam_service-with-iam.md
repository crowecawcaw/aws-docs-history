...
To get a high-level view of how Lightsail for Research and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of Lightsail for Research identity-based policies, see [Identity-based policy examples for Amazon Lightsail for Research](security_iam_id-based-policy-examples.md).
...
To see a list of Lightsail for Research actions, see [Actions Defined by Amazon Lightsail for Research ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions) in the *Service Authorization Reference*.
