...
To view examples of Lightsail for Research identity-based policies, see [Identity-based policy examples for Amazon Lightsail for Research](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
