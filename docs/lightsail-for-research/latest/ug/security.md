...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon Lightsail for Research, see [AWS Services in Scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  using Lightsail for Research. The following topics show you how to configure Lightsail for Research to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Lightsail for Research resources.

###### Topics

- [Data protection in Amazon Lightsail for Research](data-protection.md "data-protection.md")
- [Identity and Access Management for Amazon Lightsail for Research](security-iam.md "security-iam.md")
