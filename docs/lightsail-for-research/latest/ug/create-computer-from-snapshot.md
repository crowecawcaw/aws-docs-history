...
<a name="create-computer-from-snapshot"></a>
...
1. On the **Snapshots** page, locate the name of the computer or disk snapshot you'll use for creating the new computer or disk. Choose the **Snapshots** dropdown menu to view a list of available snapshots for that resource.
