# Troubleshooting Amazon Lightsail for Research identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with Lightsail for Research and IAM.

###### Topics

- [I am not authorized to
  perform an action in Lightsail for Research](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
- [I want to allow people
  outside of my AWS account to access my Lightsail for Research resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Lightsail for Research
...
have the fictional `lightsail:`GetWidget`` permissions.
...
`lightsail:`GetWidget`` action.

If you need help, contact your AWS administrator. Your administrator is the person who provided you with your sign-in credentials.

## I want to allow people

outside of my AWS account to access my Lightsail for Research resources
...
- To learn whether Lightsail for Research supports these features, see [How Amazon Lightsail for Research works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
