...
**Topics**
+ [I am not authorized to perform an action in Lightsail for Research](#security_iam_troubleshoot-no-permissions)
+ [I want to allow people outside of my AWS account to access my Lightsail for Research resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether Lightsail for Research supports these features, see [How Amazon Lightsail for Research works with IAM](security_iam_service-with-iam.md).
