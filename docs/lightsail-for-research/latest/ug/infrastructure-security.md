...
You use AWS published API calls to access Lightsail for Research through the network.
...
- Cipher suites with perfect forward secrecy (PFS) such as DHE (Ephemeral
  ...
  can use the [AWS Security Token Service](../../../STS/latest/APIReference/Welcome.md "../../../STS/latest/APIReference/Welcome.md") (AWS STS) to generate temporary security credentials to sign requests.
