...
- [Step 4: Launch the RStudio application](#rstudio-launch-application "#rstudio-launch-application")
- [Step 5: Read the RStudio documentation](#rstudio-read-documentation "#rstudio-read-documentation")
- [Step 6: (Optional) Monitor usage and costs](#rstudio-monitor-usage "#rstudio-monitor-usage")
- [Step 7: (Optional) Create a cost control rule](#rstudio-create-cost-control-rule "#rstudio-create-cost-control-rule")
- [Step 8: (Optional) Create a snapshot](#rstudio-create-snapshot "#rstudio-create-snapshot")
- [Step 9: (Optional) Stop or delete your virtual computer](#rstudio-stop-delete-computer "#rstudio-stop-delete-computer")
...
[Step 5: Read the RStudio documentation](#rstudio-read-documentation "#rstudio-read-documentation") section of this
tutorial.
...
[Step 6: (Optional) Monitor usage and costs](#rstudio-monitor-usage "#rstudio-monitor-usage") section of this tutorial.
