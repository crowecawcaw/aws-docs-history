...
| Mobile Analytics in the AWS Mobile SDKs.        | Is supported via Amazon Pinpoint in the AWS Mobile SDKs or JavaScript library.<br>Versions of the Mobile Analytics client in the SDKs will continue to report events,<br>but with limited support for issues.<br>See [Migrating to Amazon Pinpoint in the AWS Mobile SDKs or JavaScript<br>Library](migrate-sdk.md "migrate-sdk.md"). |
...
- [Migrating to Amazon Pinpoint in the AWS Mobile SDKs or JavaScript
  Library](migrate-sdk.md "migrate-sdk.md")
