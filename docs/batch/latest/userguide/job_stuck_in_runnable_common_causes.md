...
request a limit increase, see [Amazon EC2 Service Limits](../../../AWSEC2/latest/UserGuide/ec2-resource-limits.md "../../../AWSEC2/latest/UserGuide/ec2-resource-limits.md") in the
...
AMIs. For more information about the Amazon ECS container agent, see [Amazon ECS container
agent](../../../AmazonECS/latest/developerguide/ECS_agent.md "../../../AmazonECS/latest/developerguide/ECS_agent.md") in the _Amazon Elastic Container Service Developer Guide_.

**Long-running user data scripts in a launch
template**
