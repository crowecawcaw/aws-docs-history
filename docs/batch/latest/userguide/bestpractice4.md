...
+ The requirements of your jobs are 32 vCPUs or less, no GPUs, and 244 GiB of memory or less.

For more information, see [When to use Fargate](when-to-use-fargate.md).
