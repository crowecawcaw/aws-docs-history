...
![Diagram showing data layers from operating system to data, with table listing sizes and change frequencies.](https://docs.aws.amazon.com/batch/latest/userguide/images/batch-best-practices-f1.png)