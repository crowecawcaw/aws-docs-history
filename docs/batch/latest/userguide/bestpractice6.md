...
+ **Choose the `SPOT_CAPACITY_OPTIMIZED` allocation strategy** – AWS Batch chooses Amazon EC2 instances from the deepest Amazon EC2 Spot capacity pools. If you’re concerned about interruptions, this is a suitable choice. For more information, see [Instance type allocation strategies for AWS Batch](allocation-strategies.md).
