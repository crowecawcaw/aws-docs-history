...
![Workflow diagram showing administrator setting up roles, data scientist creating service environment and job queue, submitting SageMaker training jobs, and monitoring jobs in both AWS Batch queue and SageMaker AI execution](images/Batch-SageMaker-Diagram-Light-Mode.png)
...
[AWS Command Line Interface User Guide](../../../cli/latest/userguide.md "../../../cli/latest/userguide.md"). You can find the AWS Batch commands in the [AWS CLI Command Reference](../../../cli/latest/reference.md "../../../cli/latest/reference.md").
