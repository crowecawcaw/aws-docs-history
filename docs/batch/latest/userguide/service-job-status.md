...
| `RUNNABLE`   | N/A                         | N/A                           | Job is queued and ready for scheduling. Jobs in this state are started as<br>soon as sufficient resources are available in the service environment. Jobs<br>can remain in this state indefinitely when sufficient resources are<br>unavailable. |
| `SCHEDULED`  | `InProgress`                | `Pending`                     | Service job successfully submitted to SageMaker AI                                                                                                                                                                                              |
| `STARTING`   | `InProgress`                | `Downloading`                 | SageMaker Training job downloading data and images. Training job capacity<br>has been acquired and job initialization begins.                                                                                                                   |
| `RUNNING`    | `InProgress`                | `Training`                    | SageMaker Training job executing algorithm                                                                                                                                                                                                      |
| `RUNNING`    | `InProgress`                | `Uploading`                   | SageMaker Training job uploading output artifacts after training<br>completion                                                                                                                                                                  |
| `SUCCEEDED`  | `Completed`                 | `Completed`                   | SageMaker Training job completed successfully. Output artifacts finished<br>uploading.                                                                                                                                                          |
| `FAILED`     | `Failed`                    | `Failed`                      | SageMaker Training job encountered an unrecoverable error.                                                                                                                                                                                      |
| `FAILED`     | `Stopped`                   | `Stopped`                     | SageMaker Training job was manually stopped using<br>`StopTrainingJob`.                                                                                                                                                                         |
