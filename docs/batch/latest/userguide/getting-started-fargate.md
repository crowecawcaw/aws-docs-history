...
<tbody>
  <tr><td>Pricing is based on requested vCPU, memory, Operating Systems, CPU Architecture, and storage resources for the Task or Pod. </td><td>For more information about pricing, see <a href="https://aws.amazon.com/fargate/pricing/">Fargate Pricing</a>.</td></tr>
</tbody>
</table>
