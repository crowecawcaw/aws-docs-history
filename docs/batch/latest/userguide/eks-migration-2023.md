...
- If you are not using a launch template or launch template overrides then change [Ec2Configuraiton.ImageType](../APIReference/API_Ec2Configuration.md#Batch-Type-Ec2Configuration-imageType "../APIReference/API_Ec2Configuration.md#Batch-Type-Ec2Configuration-imageType") to `EKS_AL2023` or
...
- If you have any `kubelet` extra arguments defined in a launch template or
  launch template override, they need to updated to the new [kubelet extra arguments format](eks-launch-templates.md#kubelet-extra-args.title "eks-launch-templates.md#kubelet-extra-args.title").
...
You can't specify a customised container runtime with `EKS_AL2023`.
