...
**Note**  
To create a *single-node* job definition, see [Create a single-node job definition on Amazon EC2 resources](create-job-definition-EC2.md).
...
1. In the **Task properties** section:
   ...
   1. 
**Important**  
To use **ECS execute command** your compute environment must meet the [compute environment considerations for multi node parallel jobs](mnp-ce.md).
