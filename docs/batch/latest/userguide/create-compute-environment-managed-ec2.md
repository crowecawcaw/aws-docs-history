...
6. In the **Instance configuration** section:
   ...
   **BEST\_FIT\_PROGRESSIVE** is usually the better choice for EC2
   On-Demand compute environments, **SPOT\_CAPACITY\_OPTIMIZED**, and
   **SPOT\_PRICE\_CAPACITY\_OPTIMIZED** for EC2 Spot compute
   ...
   11. (Optional) Expand **Launch templates**
        ...
        2. (Optional) For **Default version**, enter
        ...
        If the version parameter of the launch template is `$Default` or
         ...
         that AMI ID is used in the update. For more information, see [AMI selection during infrastructure updates](infrastructure-updates.md#updating-compute-environments-ami "infrastructure-updates.md#updating-compute-environments-ami").
