...
15. Choose **Next**. 16. For **Target types**, choose
**AWS service**. 17. For **Select a target**, choose a target type. For example, choose
...
target. 21. Choose **Next**. 22. (Optional) For **Tags**, choose **Add new tag** to
...
_Amazon EventBridge User Guide_. 23. Choose **Next**. 24. For **Review and create**, review the configuration
