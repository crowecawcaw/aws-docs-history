...
this rule. 18. Choose **Next**. 19. (Optional) For **Tags**, choose **Add new tag** to
add a resource label for the rule. For more information, see [Amazon
EventBridge tags](../../../eventbridge/latest/userguide/eb-tagging.md "../../../eventbridge/latest/userguide/eb-tagging.md"). 20. Choose **Next**. 21. For **Review and create**, review the configuration
