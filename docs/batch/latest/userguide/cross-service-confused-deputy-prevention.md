...
policies to limit the permissions that AWS Batch gives another service to the
...
you are specifying multiple resources, use the `aws:SourceArn` global context condition key with wildcard
