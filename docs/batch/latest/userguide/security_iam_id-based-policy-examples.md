...
By default, users and roles don't have permission to create or modify AWS Batch
...
For details about actions and resource types defined by AWS Batch, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for AWS Batch](../../../service-authorization/latest/reference/list_awsbatch.md "../../../service-authorization/latest/reference/list_awsbatch.md") in the _Service Authorization Reference_.

###### Topics

- [Policy best practices](#security_iam_service-with-iam-policy-best-practices "#security_iam_service-with-iam-policy-best-practices")
- [Using the AWS Batch console](#security_iam_id-based-policy-examples-console "#security_iam_id-based-policy-examples-console")
...
Identity-based policies determine whether someone can create, access, or delete AWS Batch resources in your
...
To access the AWS Batch console, you must have a minimum set of permissions.
These permissions must allow you to list and view details about the AWS Batch resources
