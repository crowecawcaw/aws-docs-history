...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| \***_[AWSBatchServiceRolePolicyForSageMaker](#security-iam-awsmanpol-sagemaker-service-role-policy "#security-iam-awsmanpol-sagemaker-service-role-policy")_**<br>• policy<br>updated                                                                 | Updated to add `sagemaker:DeleteTrainingJob` permission to allow<br>AWS Batch to delete SageMaker AI training jobs.                                                                                                                                                                                                       | April 16, 2026   |
