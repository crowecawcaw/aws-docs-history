...
1. For **Job definition**, choose an existing job definition for your job. For more information, see [Create a single-node job definition](create-job-definition.md).

1. For **Job queue**, choose an existing job queue. For more information, see [Create a job queue](create-job-queue.md).
