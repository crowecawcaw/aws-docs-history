...
Aurora (MySQL) using the console

The following procedure outlines how to connect Amazon Q Business to
Aurora (MySQL) using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Aurora (MySQL)** data source to your Amazon Q application.
5. Then, on the **Aurora (MySQL)** data source page, enter
...
For more information, see [IAM role](aurora-mysql-connector.md#aurora-mysql-iam "aurora-mysql-connector.md#aurora-mysql-iam"). 12. In **Sync scope**, enter the following information:
    ...
    * **Title column** – Provide the column in your
     database table that contains the document titles.
    * **Body column** – Provide the column in your
     database table that contains the document body text.
