...
Aurora (PostgreSQL) using the console

The following procedure outlines how to connect Amazon Q Business to
Aurora (PostgreSQL) using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Aurora (PostgreSQL)** data source to your Amazon Q application.
5. Then, on the **Aurora (PostgreSQL)** data source page, enter
...
For more information, see [IAM role](aurora-postgresql-connector.md#aurora-postgresql-iam "aurora-postgresql-connector.md#aurora-postgresql-iam"). 12. In **Sync scope**, enter the following information:
