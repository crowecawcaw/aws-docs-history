...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **MySQL** data source to your Amazon Q application.
5. Then, on the **MySQL** data source page, enter
...
For more information, see [IAM role](my-sql-connector.md#my-sql-iam "my-sql-connector.md#my-sql-iam"). 12. In **Sync scope**, enter the following information:
