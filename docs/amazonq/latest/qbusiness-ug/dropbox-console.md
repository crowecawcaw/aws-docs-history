...
5. Then, on the **Dropbox** data source page, enter
...
See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details. 8. In **Authentication** – OAuth 2.0 (offline access) is supported. You must provide App key, App secret, access token, and refresh token. 9. In **Authentication credentials**, for **AWS Secrets Manager
...
For more information, see [IAM role](dropbox-connector.md#dropbox-iam "dropbox-connector.md#dropbox-iam"). 13. In **Sync scope**, enter the following information.
