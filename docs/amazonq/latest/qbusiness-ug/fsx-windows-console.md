...
7. In **Source**, for **Amazon FSx file system
   ID**—Select your file system ID or create a new directory.

Only already created file system IDs are displayed and available to connect. 8. **Authorization** – Amazon Q Business crawls ACL information by default to ensure responses are generated only from
...
See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details. 9. **Authentication** – Enter the following information for your
...
For more information, see [IAM role](fsx-windows-connector.md#fsx-windows-iam "fsx-windows-connector.md#fsx-windows-iam"). 13. In **Sync scope**, enter the following information:
