...
Amazon RDS (Oracle) using the console

The following procedure outlines how to connect Amazon Q Business to
Amazon RDS (Oracle) using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Amazon RDS (Oracle)** data source to your Amazon Q application.
5. Then, on the **Amazon RDS (Oracle)** data source page, enter
...
For more information, see [IAM role](rds-oracle-connector.md#rds-oracle-iam "rds-oracle-connector.md#rds-oracle-iam"). 12. In **Sync scope**, enter the following information:
