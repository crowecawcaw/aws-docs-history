...
Amazon RDS (MySQL) using the console

The following procedure outlines how to connect Amazon Q Business to
Amazon RDS (MySQL) using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Amazon RDS (MySQL)** data source to your Amazon Q application.
...
7. In **Source**, enter the following information:
   ...
   3. **Instance** – Enter the database instance, for
      example `mysql`.
   4. **SSL certificate location** – Choose to enter
      the Amazon S3 path to your SSL certificate file.
...
For more information, see [IAM role](rds-my-sql-connector.md#rds-my-sql-iam "rds-my-sql-connector.md#rds-my-sql-iam"). 12. In **Sync scope**, enter the following information:
