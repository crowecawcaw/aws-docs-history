...
For more information, see [IAM role](github-server-connector.md#github-server-iam "github-server-connector.md#github-server-iam"). 12. In **Sync scope**, enter the following information:
