...
- [Confluence (Cloud) JSON schema](#confluence-cloud-json "#confluence-cloud-json")
- [Confluence (Cloud) JSON schema example](#confluence-cloud-api-json-example "#confluence-cloud-api-json-example")
