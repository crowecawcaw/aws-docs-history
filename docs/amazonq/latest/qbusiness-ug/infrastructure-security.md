...
As a managed service, Amazon Q Business is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Q through the network. Clients must
