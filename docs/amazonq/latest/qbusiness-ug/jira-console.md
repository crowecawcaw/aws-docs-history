...
5. Then, on the **Jira** data source page, enter
...
For more information, see [IAM role](jira-connector.md#jira-iam "jira-connector.md#jira-iam"). 12. In **Sync scope**, enter the following information:
