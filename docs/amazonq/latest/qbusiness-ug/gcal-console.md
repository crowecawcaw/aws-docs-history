...
Google Calendar using the console (Preview)
...
5. Then, on the **Google Calendar** data source page, enter
...
See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details. 8. In **Authentication**, Choose between Google service account
or OAuth 2.0 authentication, based on your use case. 9. AWS Secrets Manager secret – Choose an existing secret or create a Secrets
...
For more information, see [IAM role](gcal-connector.md#gcal-iam "gcal-connector.md#gcal-iam"). 12. In Sync scope, choose from the following options:
...
[Document deletion
safeguard](connector-concepts.md#document-deletion-safeguard "connector-concepts.md#document-deletion-safeguard"). 14. For **Sync mode**, choose how you want to update your index
