...
Confluence (Cloud) connector and suggested resolutions.
...
| CNF-5516   | Error validating credentials due to invalid client id or client<br>secret. | Provide valid client id and client secret.                     |
