...
Oracle Database using the console

The following procedure outlines how to connect Amazon Q to
Oracle Database using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Oracle Database** data source to your Amazon Q application.
5. Then, on the **Oracle Database** data source page, enter
...
For more information, see [IAM role](oracle-database-connector.md#oracle-database-iam "oracle-database-connector.md#oracle-database-iam"). 12. In **Sync scope**, enter the following information:
