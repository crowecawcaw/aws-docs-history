...
2. In **Source**, enter the following information:
   ...
   2. **Port** – Enter the database port, for example,
      `5432`.
   3. **Instance** – Enter the database instance, for example
      `postgres` .
   4. **SSL certificate location** – Choose to enter the Amazon S3 path to your SSL certificate file.

3. **Authorization** – Amazon Q Business crawls ACL information by default to ensure responses are generated only from
...
See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details. 4. In **Authentication** – Enter the following information for
...
5. **Configure VPC and security group –
_optional_** – Choose
...
For more information, see [IAM role](rds-postgresql-connector.md#rds-postgresql-iam "rds-postgresql-connector.md#rds-postgresql-iam"). 7. In **Sync scope**, enter the following information:
...
10. In **Sync mode**, choose how you
...
For more details, see [Sync mode](connector-concepts.md#connector-sync-mode "connector-concepts.md#connector-sync-mode"). 11. In **Sync run schedule**, for
