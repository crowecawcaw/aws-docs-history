...
crawls Microsoft OneDrive ACLs
...
authentication. Google Drive supports nested groups, meaning that one group can be a member of another.
The connector handles complex group structures by flattening group memberships and ensuring that permissions
are applied correctly across all levels.
