...
- [Connecting Amazon Q Business to Microsoft Teams (new connector)
  using APIs](teams-new-api.md "teams-new-api.md")
- [Connecting Amazon Q Business to Microsoft Teams (Original connector)
  using APIs](teams-original-api.md "teams-original-api.md")
