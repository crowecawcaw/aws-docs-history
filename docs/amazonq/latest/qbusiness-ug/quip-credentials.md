...
![Screenshot of the Quip interface showing the account settings menu where users can access developer tools to generate an API token.](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/images/quip-1.png)
...
![Screenshot of the Quip developer token page showing the generated personal access token that needs to be copied for API authentication.](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/images/quip-2.png)
