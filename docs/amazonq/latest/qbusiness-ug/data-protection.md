...
applies to data protection in Amazon Q Business. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Amazon Q or other AWS services
...
- [Data encryption for Q Apps](data-encryption-qapps.md "data-encryption-qapps.md")
- [Key management](key-management.md "key-management.md")
- [Cross-region inference in Amazon Q Business](cross-region-inference.md "cross-region-inference.md")
- [Amazon Q Business Service improvement](service-improvement.md "service-improvement.md")
