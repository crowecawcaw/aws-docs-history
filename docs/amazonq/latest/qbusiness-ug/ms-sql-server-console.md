...
Microsoft SQL Server using the AWS Management Console.
...
4. Then, on the **Add data sources** page, from
   **Data sources**, add the **Microsoft SQL Server** data source to your Amazon Q application.
5. Then, on the **Microsoft SQL Server** data source page, enter
...
For more information, see [IAM role](ms-sql-server-connector.md#ms-sql-server-iam "ms-sql-server-connector.md#ms-sql-server-iam"). 12. In **Sync scope**, enter the following information:
