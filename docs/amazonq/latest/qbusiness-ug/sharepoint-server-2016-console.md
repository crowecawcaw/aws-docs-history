...
SharePoint Server 2016 using the console
...
5.  Then, on the **SharePoint Server 2016** data source page, enter
...
For more information, see [IAM role](sharepoint-server-2016-connector.md#sharepoint-server-2016-iam "sharepoint-server-2016-connector.md#sharepoint-server-2016-iam"). 14. In **Sync scope**, choose from the following options :
