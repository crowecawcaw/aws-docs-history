...
1. From **All applications**, choose **\+ New application** from the top navigation pane.
...
1. Then, in the left navigation pane of your application, choose **Users and groups**, and do the following steps.
   ...
   1. Choose **\+ Add user/group** and select the users or groups you want to assign to your application, and then choose **Select**.
