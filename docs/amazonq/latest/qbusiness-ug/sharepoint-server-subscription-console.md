...
SharePoint Server (Subscription Edition) using the AWS Management Console.
...
5. Then, on the **SharePoint Server (Subscription Edition)** data source page, enter
...
7. In **Source**, enter the following information:
   ...
   2. **Choose SharePoint Version** –
      Choose **SharePoint (Subscription Edition)**.
...
10. For **Authorization** – Amazon Q Business crawls
    ...
    2. **Email ID with Custom Domain** – Access
       ...
       email domain using **Add Email Domain**.See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details.

11. For **Authentication**, choose between **SharePoint
...
12. **Configure VPC and security group –
    _optional_** – Choose
...
For more information, see [IAM role](sharepoint-server-subscription-connector.md#sharepoint-server-subscription-iam "sharepoint-server-subscription-connector.md#sharepoint-server-subscription-iam"). 13. In **Sync scope**, choose from the following options :
...
14. In **Sync mode**, choose how you
...
For more details, see [Sync mode](connector-concepts.md#connector-sync-mode "connector-concepts.md#connector-sync-mode"). 15. In **Sync run schedule**, for
...
Right after setup, Amazon Q Business automatically tests your connection. This test will ensure that your data source connects properly before
you run a sync job.
