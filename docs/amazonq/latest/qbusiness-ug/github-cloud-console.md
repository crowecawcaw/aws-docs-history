...
5. Then, on the **GitHub (Cloud)** data source page, enter
...
7. **Source** – Choose your GitHub (Cloud) source
   details.
...
For more information, see [IAM role](github-cloud-connector.md#github-cloud-iam "github-cloud-connector.md#github-cloud-iam"). 12. In **Sync scope**, enter the following information:
...
For more details, see [Sync mode](connector-concepts.md#connector-sync-mode "connector-concepts.md#connector-sync-mode"). 14. In **Sync run schedule**, for
