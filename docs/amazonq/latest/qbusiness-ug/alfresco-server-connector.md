...
Alfresco is a content management service (CMS) that helps customers store
and manage their content. You can connect Alfresco (Server) instance to Amazon Q Business—using either the AWS Management Console or the [CreateDataSource](../api-reference/API_CreateDataSource.md "../api-reference/API_CreateDataSource.md") API—and create an Amazon Q web experience.
