...
**In Microsoft Yammer, make sure you
have:**

- Created a Microsoft Yammer administrative account with verified admin
  user permissions.
...
- Stored your Microsoft Yammer authentication credentials in an AWS Secrets Manager
