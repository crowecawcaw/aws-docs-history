...
ServiceNow Online using the console
...
For more information, see [IAM role](servicenow-connector.md#servicenow-iam "servicenow-connector.md#servicenow-iam"). 12. **Sync scope** – Set the content that you want to
sync.
