...
Alfresco (Cloud) using the console

The following procedure outlines how to connect Amazon Q Business to
Alfresco (Cloud) using the AWS Management Console.
...
7. **Source** – Choose **Alfresco
   ...
   2. **Alfresco user application URL**
      – Enter your Alfresco user interface URL. You can
      get the repository URL from your Alfresco administrator.
      For example, the user interface URL could be
      *https://example.com*.
...
For more information, see [IAM role](alfresco-cloud-connector.md#alfresco-cloud-iam "alfresco-cloud-connector.md#alfresco-cloud-iam"). 13. In **Sync scope**, enter the following information:
