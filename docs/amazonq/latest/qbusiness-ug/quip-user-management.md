...
When you connect an Quip data source to Amazon Q Business, Amazon Q Business crawls ACL information attached to a document (user and group
information) from your Quip instance. If you choose to activate ACL crawling,
...
- `_user_id`—User IDs exist in Quip on files where there are set
  access permissions. They are mapped from the user emails as the IDs in Quip.
  For more
  information, see:
