...
When you connect an Alfresco (Server) data source to Amazon Q Business, Amazon Q crawls ACL information attached to a document (user and group
information) from your Alfresco (Server) instance. If you choose to activate ACL
