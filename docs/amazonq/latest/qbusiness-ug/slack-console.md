...
7. In **Source**, **Slack workspace team
...
For more information, see [IAM role](slack-connector.md#slack-iam "slack-connector.md#slack-iam"). 12. In **Sync scope**, enter the following information:
