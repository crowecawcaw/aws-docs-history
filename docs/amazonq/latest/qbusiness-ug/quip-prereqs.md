...
- Created Quip authentication credentials that include a personal
  access token. See [Quip documentation on authentication](https://quip.com/dev/admin/documentation/current#section/Authentication "https://quip.com/dev/admin/documentation/current#section/Authentication") for more information.
...
- Stored your Quip authentication credentials in an AWS Secrets Manager
