...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon Q Business, see [AWS Services in Scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  using Amazon Q Business. The following topics show you how to configure Amazon Q Business to meet your security and compliance objectives. You also learn how to use
  other AWS services that help you to monitor and secure your Amazon Q Business resources.
