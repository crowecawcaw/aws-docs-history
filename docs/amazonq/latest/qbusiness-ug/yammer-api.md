...
|  +  `community` <br />+  `user` <br />+  `message` <br />+  `attachment`   | A list of objects that map attributes or field names of Microsoft Yammer objects to Amazon Q index field names. | 
...
|  +  `sinceDate`   | Use to specify the time from when Amazon Q should crawl your Microsoft Yammer content | 
