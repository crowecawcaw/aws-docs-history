...
Oracle Database is a database management system. You can connect your
Oracle Database instance to Amazon Q Business—using either the AWS Management Console,
...
The Amazon Q Oracle Database data source connector supports Oracle Database
18c, 19c, and 21c.
