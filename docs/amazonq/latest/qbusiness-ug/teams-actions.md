# Configuring a Microsoft Teams plugin for
...
- [Prerequisites](#teams-plugin-prereqs "#teams-plugin-prereqs")
- [Service access roles](#teams-plugin-iam "#teams-plugin-iam")
- [Creating a plugin](#teams-plugin-create "#teams-plugin-create")
...
- As an admin, create a new OAuth 2.0 Microsoft Teams app in the
  ...
  actions in Amazon Q. To learn how to do this, see [Register an application](https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app?tabs=certificate#register-an-application "https://learn.microsoft.com/en-us/entra/identity-platform/quickstart-register-app?tabs=certificate#register-an-application") in Microsoft Teams Developer
