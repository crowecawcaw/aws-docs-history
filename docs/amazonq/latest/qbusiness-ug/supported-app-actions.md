...
- [Deleting an application](#delete-app "#delete-app")
- [Getting application environment properties](#describe-app "#describe-app")
- [Listing applications](#list-app "#list-app")
- [Updating an application environment](#update-app "#update-app")
...
[application environment summary](../business-use-dg/supported-app-actions.md "../business-use-dg/supported-app-actions.md") page.
