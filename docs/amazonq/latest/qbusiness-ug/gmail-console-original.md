...
See [Authorization](connector-concepts.md#connector-authorization "connector-concepts.md#connector-authorization") for more details. 8. In **Authentication**, for **AWS Secrets Manager
...
For more information, see [IAM role](gmail-connector.md#gmail-iam "gmail-connector.md#gmail-iam"). 10. In **Sync scope**, choose from the following entity types:
