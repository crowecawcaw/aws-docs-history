...
| `aemUrl`                                                                                                                                                             | The Adobe Experience Manager host<br>URL. For example, if you use AEM On-Premise, you<br>include the hostname and port:<br>*http://hostname:port*.<br>Or, if you use AEM as a Cloud Service, you can use<br>the author URL:<br>*https://author-xxxxxx-xxxxxxx.adobeaemcloud.com*.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
