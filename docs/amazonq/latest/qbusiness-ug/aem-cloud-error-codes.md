...
<a name="aem-cloud-error-codes"></a>
...
| AEM-5104 | Error while parsing https response. Below are the possible reasons for this error. 1. Provided AEM host URL might be wrong, please cross-check the AEM host URL.<br />2. AEM server is down or not reachable. | Provide a valid host URL, or try again later. | 
...
| AEM-5115 | Null/empty crawl type. | crawl Type value should be FULL\_CRAWL/CHANG\_LOG type. | 
...
| AEM-5121 | Provided deploymentype is incorrect. | Deployment type should be either CLOUD or ON\_PREMISE. | 
...
| AEM-5125 | Null/Empty deployment type. | Deployment type should be either CLOUD or ON\_PREMISE. | 
