...
**Important**  
The **@workspace** feature is deprecated. You can still add context by using **@file**, **@folder**, or **@code**.
...
1. Amazon Q prompts you to enable indexing. Choose **Settings** to be redirected to Amazon Q settings in your IDE. 
   ...
   If you aren't prompted, you can go to settings by choosing **Amazon Q** in the IDE status bar. Then, choose **Open Settings** from the Amazon Q task bar that opens.
