...
To get a high-level view of how Amazon Q and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of Amazon Q Developer identity-based policies, see [Identity-based policy examples for Amazon Q Developer](security_iam_id-based-policy-examples.md).
...
To see a list of Amazon Q actions, see [Manage access to Amazon Q Developer with policies](security_iam_manage-access-with-policies.md).
