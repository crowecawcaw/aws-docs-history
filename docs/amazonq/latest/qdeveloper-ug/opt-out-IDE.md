...
To learn more about the telemetry data collected by Amazon Q in the IDE, see the [commonDefinitions.json](https://github.com/aws/aws-toolkit-common/blob/main/telemetry/definitions/commonDefinitions.json "https://github.com/aws/aws-toolkit-common/blob/main/telemetry/definitions/commonDefinitions.json") document in the
...
- [Amazon Q extension for VS Code](https://github.com/aws/aws-toolkit-vscode/blob/master/packages/core/src/shared/telemetry/vscodeTelemetry.json "https://github.com/aws/aws-toolkit-vscode/blob/master/packages/core/src/shared/telemetry/vscodeTelemetry.json")
- [Amazon Q plugin for JetBrains](https://github.com/aws/aws-toolkit-jetbrains/blob/main/plugins/core/jetbrains-community/resources/telemetryOverride.json "https://github.com/aws/aws-toolkit-jetbrains/blob/main/plugins/core/jetbrains-community/resources/telemetryOverride.json")
...
![The settings panel in JetBrains](images/JB-usage.png)
...
For information on content AWS uses, see [Amazon Q Developer service improvement](service-improvement.md "service-improvement.md").
...
![Options for sharing Amazon Q data in VS Code.](images/JB-content.png)
