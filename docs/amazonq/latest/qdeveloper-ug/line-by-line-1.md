...
![A screenshot that shows the first Amazon Q recommendation when prompted for a function that publishes messages to a CloudWatch Logs log group.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-line-by-line-cwlogs-1.png)
...
![A screenshot that shows the next few Amazon Q recommendations that begin to form the implementation the function to publish messages to a CloudWatch Logs log group.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-line-by-line-cwlogs-2.png)
...
![A screenshot that shows the completed implementation of a code block that publishes messages to a CloudWatch Logs log group, based only on Amazon Q recommendations.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-line-by-line-cwlogs-3.png)
