...
![An example of the full function completion feature using C.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/full-function-completion-c-plus.gif)
...
![An example of the full-function generation feature.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/javascript_lambda_FullFunctionGeneration.gif)
...
![A screenshot that shows a Amazon Q recommendation to complete an entire function that reads an object from an Amazon S3 location.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-read-from-s3.png)
...
![A screenshot that shows a Amazon Q recommendation for an entire function implementation of the quicksort algorithm.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-quicksort.png)
...
![A screenshot that shows a Amazon Q recommendation for a function implementation based on context.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-from-context-sort.png)


In the following image, a user has written a comment. Based on this comment, Amazon Q then suggests a function signature.

![A screenshot that shows a Amazon Q recommendation for a binary search function signature based on user code comments.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-comment-binary-search.png)
...
![A screenshot that shows a Amazon Q recommendation for a complete implementation of the binary search algorithm.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-binary-search.png)
...
![An example of a function generated from a comment.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/cw-c9-function-from-comment.gif)
...
![An example of a function generated from a comment inside an existing block of code.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/cw-c9-function-from-comment-within-block.gif)
...
![Code editor showing a public static async Task function signature for ListTables method.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/c-sharp-full-function.gif)
...
![An example of the full function completion feature.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/typescript_vscode_function.gif)
...
![An example of the full function completion feature.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/python_pycharm_fullfunction_unittests.GIF)
...
![alt_text](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/cw-jb-comment-062022.png)
...
![alt_text](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/cw-jb-commentfunctionadvance-062022.png)
...
![generateing a new suggestion based on the content of a comment](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/cw-jb-commentfunction-062022.png)

In this example, Amazon Q recommends a full function after the user types part of the signature. 

![An example of the full function feature.](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/python_sagemakerstudio_fullfunction.gif)
