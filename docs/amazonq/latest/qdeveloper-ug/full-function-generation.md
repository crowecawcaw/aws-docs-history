...
![A screenshot that shows a Amazon Q recommendation to complete an entire function that reads an object from an Amazon S3 location.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-read-from-s3.png)
...
![A screenshot that shows a Amazon Q recommendation for an entire function implementation of the quicksort algorithm.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-quicksort.png)
...
![A screenshot that shows a Amazon Q recommendation for a function implementation based on context.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-from-context-sort.png)


In the following image, a user has written a comment. Based on this comment, Amazon Q then suggests a function signature.

![A screenshot that shows a Amazon Q recommendation for a binary search function signature based on user code comments.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-comment-binary-search.png)
...
![A screenshot that shows a Amazon Q recommendation for a complete implementation of the binary search algorithm.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/whisper-function-binary-search.png)
...
![Code editor showing a public static async Task function signature for ListTables method.](http://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/images/c-sharp-full-function.gif)
