...
- **Security of the cloud** – AWS is responsible for
  ...
  provides you with services that you can use securely. Third-party auditors regularly
  test and verify the effectiveness of our security as part of the [AWS Compliance Programs](http://aws.amazon.com/compliance/programs/ "http://aws.amazon.com/compliance/programs/").
  To learn about the compliance programs that apply to Amazon Q, see [AWS Services in Scope by
...
- [Firewalls, proxies, and data
  perimeters](firewall.md "firewall.md")
