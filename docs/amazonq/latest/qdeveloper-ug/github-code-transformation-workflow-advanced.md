...
The following dynamically code snippet dynamically chooses Java 17 when jobs are running on a pull request created by
the **Amazon Q code transform agent**. When you decide to merge the open pull request to your default branch,
you need to modify your workflow file in the `.github/workflows/` directory to use Java 17 by default.
