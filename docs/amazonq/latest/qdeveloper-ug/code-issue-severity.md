...
issue. Detectors in the [Amazon Q Detector Library](../../../codeguru/detector-library.md "../../../codeguru/detector-library.md") are each assigned a severity using the Common
Vulnerability Scoring System ([CVSS](https://nvd.nist.gov/vuln-metrics/cvss/v3-calculator "https://nvd.nist.gov/vuln-metrics/cvss/v3-calculator")). The
