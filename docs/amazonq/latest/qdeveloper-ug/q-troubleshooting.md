...
+ Ensure Amazon Q is up to date in your [IDE](q-in-IDE-setup.md)
...
**Topics**
+ [Accessing and using Amazon Q Developer logs](troubleshooting-q-logs.md)