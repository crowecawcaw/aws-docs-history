...
![The severity filter menu in IntelliJ IDEA.](images/jb-filter-issues.png) 3. Select or deselect the the severity levels you want to filter for,
...
![The filter icon in the Code Issues tab in Visual Studio Code.](images/filter-issues-vsc.png) 2. The **Filter Issues** menu opens.
...
![The grouping icon in the Code Issues tab in Visual Studio Code.](images/group-issues-vsc.png) 2. The **Group Issues** menu opens. 3. Select **Severity** to group issues in the Code Issues panel based on their
severity. Select **Location** to group issues based on which code file they are
located in.
