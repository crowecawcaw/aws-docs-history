...
You can select and deselect individual files to be used as context when you ask a question. 6. If your project changes, you can have Amazon Q generate new memory bank
