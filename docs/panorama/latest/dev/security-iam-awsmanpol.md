...
| AWSPanoramaFullAccess – Update to an existing policy                 | Added permissions to the user policy to allow users to manage the AWS Panorama [service-linked role](using-service-linked-roles.md "using-service-linked-roles.md"), and to access AWS Panorama resources in other services including IAM, Amazon S3, CloudWatch, and Secrets Manager. | 2021-10-20 |
