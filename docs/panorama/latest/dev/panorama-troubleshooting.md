...
# Troubleshooting
<a name="panorama-troubleshooting"></a>
...
<a name="troubleshooting-appliance"></a>
...
<a name="troubleshooting-application"></a>
...
Each time you deploy a change to an application, you register a *patch version* that represents the package configuration and asset files for each package that it uses. Use the [cleanup patches script](panorama-samples.md#samples-scripts) to deregister unused patch versions.

## Camera streams
<a name="troubleshooting-camera"></a>
