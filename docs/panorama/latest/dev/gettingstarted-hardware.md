...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Processor and GPU             | [Nvidia Jetson AGX<br>Xavier](https://developer.nvidia.com/embedded/jetson-agx-xavier-developer-kit "https://developer.nvidia.com/embedded/jetson-agx-xavier-developer-kit") with 32GB RAM |
...
The AWS Panorama Appliance includes two screws for mounting on a server rack. You can mount two appliances side-by-side on
a 19-inch rack.
