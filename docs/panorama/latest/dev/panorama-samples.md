...
+ [CloudFormation templates](#samples-templates)
...
The `create-stack.sh` script in this directory creates CloudFormation stacks. It takes a variable number of arguments. The first argument is the name of the template, and the remaining arguments are overrides for parameters in the template.
