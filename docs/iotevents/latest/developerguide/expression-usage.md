...
- Pass the expressions to the AWS IoT Events APIs as parameters.
  Expressions support literals, operators, functions, references, and substitution
  templates.
...
For literal values, the expressions must contain single quotes. A Boolean value
...
be in single quotes. A substitution template can also contain a combination of
...
- The evaluated result of the following expression is a string,
...
can also contain a combination of literals, operators, functions, references, and
