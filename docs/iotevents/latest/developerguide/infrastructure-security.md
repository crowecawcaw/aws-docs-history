...
As a managed service, AWS IoT Events is protected by AWS global network security. For
...
You use AWS published API calls to access AWS IoT Events through the network. Clients must
