...
error types and messages for your detector model, see [Detector model analysis and diagnostic information for AWS IoT Events](analyze-diagnostic-information.md "analyze-diagnostic-information.md").
...
- [Detector model analysis and diagnostic information for AWS IoT Events](analyze-diagnostic-information.md "analyze-diagnostic-information.md")
