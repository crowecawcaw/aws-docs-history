...
# Create a Channel
<a name="msk-data-delivery-s3-create"></a>

## Using the AWS Management Console
<a name="msk-data-delivery-s3-create-console"></a>
...
1. Under **Destination type**, select **data delivery to general purpose S3**.
...
## Using the AWS CLI
<a name="msk-data-delivery-s3-create-cli"></a>
