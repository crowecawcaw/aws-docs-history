...
**Topics**
+ [Tag basics for Amazon MSK clusters](msk-tagging-basics.md)
+ [Track Amazon MSK cluster costs using tagging](msk-tagging-billing.md)
+ [Tag restrictions](msk-tagging-restrictions.md)
+ [Tag resources using the Amazon MSK API](msk-tagging-howto.md)