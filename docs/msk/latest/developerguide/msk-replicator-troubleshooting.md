...
1. Verify that the security groups you provided for the Replicator creation in
   ...
   provide for the Replicator creation in the Target cluster section. See [Choose your target cluster](msk-replicator-create-console.md#msk-replicator-create-console-choose-target "msk-replicator-create-console.md#msk-replicator-create-console-choose-target").
