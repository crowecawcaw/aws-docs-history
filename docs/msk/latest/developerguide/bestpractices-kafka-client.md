...
- [Apache Kafka client availability](#bestpractices-kafka-client-client-availability "#bestpractices-kafka-client-client-availability")
- [Apache Kafka client performance](#bestpractices-kafka-client-performance "#bestpractices-kafka-client-performance")
- [Kafka client monitoring](#bestpractices-kafka-client-monitoring "#bestpractices-kafka-client-monitoring")
