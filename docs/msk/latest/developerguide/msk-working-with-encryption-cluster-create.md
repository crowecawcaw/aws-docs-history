...
1. Save the contents of the previous example in a file and give the file any name that you want.
...
The following is an example of a successful response after running this
command.
