...
In this step of [Get Started Using Amazon MSK](getting-started.md "getting-started.md"), you create a client machine. You use this client machine to create a topic that produces and consumes data. For simplicity, you'll create this client machine in the VPC that is associated with the MSK cluster so that the client can easily connect to the cluster.
...
To create a new key pair, do the following:
    ...
    2. For **Key pair name**, enter `MSKKeyPair`.
