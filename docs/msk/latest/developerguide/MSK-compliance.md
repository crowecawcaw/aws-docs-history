...
Third-party auditors assess the security and compliance of Amazon Managed Streaming for Apache Kafka as part of AWS
compliance programs. These include PCI and HIPAA BAA.
...
Your compliance responsibility when using Amazon MSK is determined by the sensitivity
