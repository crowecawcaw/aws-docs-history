...
For more information on configuring an Amazon MSK cluster as a pipe source, see [Amazon Managed Streaming for Apache Kafka cluster as a source](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes-msk.html) in the *Amazon EventBridge User Guide*. For more information about EventBridge Pipes in general, see [EventBridge Pipes](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-pipes.html). 

**To access EventBridge pipes for a given Amazon MSK cluster**

1. Open the [Amazon MSK console](https://console.aws.amazon.com/msk/) and choose **Clusters** .

1. Select a cluster.

1. On the cluster detail page, choose the **Integration** tab.
...
1. Manage the pipes for your Amazon MSK cluster as desired:
