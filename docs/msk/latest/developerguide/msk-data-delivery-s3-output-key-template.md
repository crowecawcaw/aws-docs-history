...
# Output key template
<a name="msk-data-delivery-s3-output-key-template"></a>
...
**Topics**
+ [Variables](msk-data-delivery-s3-template-variables.md)
+ [Partitioning](msk-data-delivery-s3-template-partitioning.md)
+ [Rules](msk-data-delivery-s3-template-rules.md)
+ [Examples](msk-data-delivery-s3-template-examples.md)