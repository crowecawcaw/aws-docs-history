...
- You can also monitor your MSK cluster with Prometheus, an open-source monitoring
  ...
  Prometheus documentation. To learn how to monitor your MSK Provisioned cluster with Prometheus, see [Monitor an MSK Provisioned cluster with Prometheus](open-monitoring.md "open-monitoring.md").
...
- [Monitor an MSK Provisioned cluster with Prometheus](open-monitoring.md "open-monitoring.md")
