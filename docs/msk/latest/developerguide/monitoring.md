...
**Topics**
+ [View Amazon MSK metrics using CloudWatch](cloudwatch-metrics.md)
+ [Amazon MSK metrics for monitoring Standard brokers with CloudWatch](metrics-details.md)
+ [Amazon MSK metrics for monitoring Express brokers with CloudWatch](metrics-details-express.md)
+ [Monitor an MSK Provisioned cluster with Prometheus](open-monitoring.md)
+ [Monitor consumer lags](consumer-lag.md)
+ [Use Amazon MSK storage capacity alerts](cluster-alerts.md)