...
- [Mutual TLS client authentication for Amazon MSK](msk-authentication.md "msk-authentication.md")
- [Sign-in credentials authentication with AWS Secrets Manager](msk-password.md "msk-password.md")
- [Apache Kafka ACLs](msk-acls.md "msk-acls.md")
