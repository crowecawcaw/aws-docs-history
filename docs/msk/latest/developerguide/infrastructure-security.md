...
As a managed service, Amazon Managed Streaming for Apache Kafka is protected by the AWS global network security
...
You use AWS published API calls to access Amazon MSK through the network. Clients must
