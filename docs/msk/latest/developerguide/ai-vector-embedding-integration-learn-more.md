...
<a name="ai-vector-embedding-integration-learn-more"></a>
...
**Topics**
+ [Logging and observability](ai-vector-embedding-integration-logging-observability.md)
+ [Notes before enabling real-time vector embedding blueprints](ai-vector-embedding-integration-notes.md)
+ [Deploy streaming data vectorization blueprint](ai-vector-embedding-integration-deploy.md)