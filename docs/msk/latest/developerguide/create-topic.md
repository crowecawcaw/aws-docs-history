...
8. **(Optional) Verify that the topic was created successfully.**
   ...
   ```If the command is unsuccessful or you run into an error, see [Troubleshoot your Amazon MSK cluster](troubleshooting.md "troubleshooting.md") for troubleshooting information.
   ````
