...
# Update a Channel
<a name="msk-data-delivery-s3-update"></a>
...
<a name="msk-data-delivery-s3-update-console"></a>
...
## Using the AWS CLI
<a name="msk-data-delivery-s3-update-cli"></a>

Use the update field that matches the Channel's destination type — `--s3-destination-update` for an S3 destination.
