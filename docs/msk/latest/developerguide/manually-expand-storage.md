...
2. Choose the MSK cluster for which you want to update broker
   storage.
3. In the **Storage** section, choose
   **Edit**.
4. Specify the storage volume you want. You can only increase the amount of
   storage, you can't decrease it.
...
all clusters. For more information, see [List Amazon MSK clusters](msk-list-clusters.md "msk-list-clusters.md").
...
To update a broker storage using the API, see [UpdateBrokerStorage](../../1.0/apireference/clusters-clusterarn-nodes-storage.md#UpdateBrokerStorage "../../1.0/apireference/clusters-clusterarn-nodes-storage.md#UpdateBrokerStorage").
