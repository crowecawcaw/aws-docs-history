...
<a name="msk-replicator-supported-configs"></a>
...
+ MSK Replicator supports MSK Provisioned and MSK Serverless clusters in any combination, when both the source and target are Amazon MSK clusters.
...
<a name="msk-replicator-serverless-config"></a>
