...
- **Security in the cloud** – Your responsibility is
  ...
  using Security Lake. The following topics show you how to configure Security Lake to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Security Lake resources.

###### Topics

- [Identity and access management for Security Lake](security-iam.md "security-iam.md")
- [Data protection in Amazon Security Lake](data-protection.md "data-protection.md")
- [Compliance validation for Amazon Security Lake](compliance-validation.md "compliance-validation.md")
- [Security best practices for Security Lake](best-practices-overview.md "best-practices-overview.md")
