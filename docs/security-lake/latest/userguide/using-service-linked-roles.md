...
**Topics**
+ [Service-linked role (SLR) permissions for Security Lake](slr-permissions.md)
+ [Service-linked role (SLR) permissions for resource management](AWSServiceRoleForSecurityLakeResourceManagement.md)