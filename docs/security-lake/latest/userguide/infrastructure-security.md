...
As a managed service, Amazon Security Lake is protected by AWS global network security. For
...
You use AWS published API calls to access Security Lake through the network. Clients must
