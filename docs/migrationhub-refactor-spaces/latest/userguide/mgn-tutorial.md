...
| **EnvironmentId**                | When you have an existing environment that you want to use,<br>you enter its ID here and leave the<br>*_EnvironmentName_<br>• field blank. However,<br>in this tutorial, to create a new environment, you enter a value<br>for *_EnvironmentName_<br>• and leave<br>*_EnvironmentId_<br>• blank.                                                                                    |
...
| **NetworkFabricType**            | Choose **TRANSIT\_GATEWAY**. To create an<br>environment without a network bridge, enter<br>`NONE`.                                                                                                                                                                                                                                                                                 |
