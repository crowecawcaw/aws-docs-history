...
To view a list of the quotas for AWS Migration Hub Refactor Spaces, see [Refactor Spaces service quotas](https://docs.aws.amazon.com/general/latest/gr/migrationhub-refactor-spaces#limits-migrationhub-refactor-spaces).

You can also view the quotas for Refactor Spaces by opening the [Service Quotas console](https://console.aws.amazon.com/servicequotas/home). In the navigation pane, choose **AWS services** and select **AWS Migration Hub Refactor Spaces**.
