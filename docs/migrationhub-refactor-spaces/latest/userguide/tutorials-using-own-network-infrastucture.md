...
<a name="tutorials-using-own-network-infrastucture"></a>

When you use a Refactor Spaces environment without a network bridge, you must configure [VPC to VPC connectivity](https://docs.aws.amazon.com/whitepapers/latest/aws-vpc-connectivity-options/amazon-vpc-to-amazon-vpc-connectivity-options.html) between services with private URL endpoints and an application proxy VPC. The following tutorials show two common scenarios: connecting through VPC peering, and through your own transit gateway. 
