...
![Data source configuration page with Yes option selected to use existing Glue tables.](https://docs.aws.amazon.com/glue/latest/dg/images/crawler-s3-event-console1-cat.png)
...
1.  In the **Add table** modal, configure the database and tables: 
   ...
   +  Choose **Confirm**.   
![Add Glue tables dialog showing database selection, table selection, and event-based crawling options.](https://docs.aws.amazon.com/glue/latest/dg/images/crawler-s3-event-console2-cat.png)