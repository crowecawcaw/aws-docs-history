...
| created_at                       | DateTime   |           |                                                                                              |
| updated_at                       | DateTime   | EQUAL_TO  |                                                                                              |
| DML_STATUS                       | String     |           | A user-defined field used to track the created, updated and<br>deleted status of the record. |
...
| instance_id                      | Integer    |           |                                                                                              |
| type                             | String     |           |                                                                                              |
| DML_STATUS                       | String     | EQUAL_TO  | A user-defined field used to track the created, updated and<br>deleted status of the record. |
