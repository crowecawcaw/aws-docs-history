...
should first gather information about names, IDs, and logs that are associated with the failed
action. Having this information available enables Support to help you resolve the problems you're
experiencing.

Along with your _account ID_, gather the following information for each
...
- Connection name
- Connection ID
- JDBC connection string in the form
