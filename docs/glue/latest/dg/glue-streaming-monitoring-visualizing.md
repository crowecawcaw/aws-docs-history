...
![The screenshot shows accessing metrics in the Amazon CloudWatch console when monitoring AWS Glue streaming jobs.](https://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-1.png)
...
![The screenshot shows applying an average to metrics when monitoring streaming jobs.](https://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-2.png)
...
![The screenshot shows adding a windowSize annotation to your graph when monitoring streaming jobs.](https://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-3.png)

1. Once you have your metrics selected, create a dashboard and add it. Here is a sample dashboard.  
![The screenshot shows a sample dashboard for monitoring streaming jobs.](https://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-4.png)