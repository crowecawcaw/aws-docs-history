...
| position         | Double     | N/A                              |                                                                                                                                                                                                                                                             |
| start_end_date   | Date       | BETWEEN                          | Default value for `start_end_date` is between <30 days ago from the current date> AND <yesterday: that is, 1 day ago from the current date><br>Note: expects you to pass a UTC date value.<br>Example: start_end_date between '2022-01-01' AND '2024-09-09' |
...
| searchAppearance | String     | EQUAL_TO, NOT_EQUAL_TO, CONTAINS | See [Search Appearance](https://support.google.com/webmasters/answer/7576553#by_search_appearance "https://support.google.com/webmasters/answer/7576553#by_search_appearance") for a list of valid values.                                                  |
