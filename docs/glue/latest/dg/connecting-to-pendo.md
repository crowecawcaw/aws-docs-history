...
Pendo provides a rich data store for user interaction data. Customers will transfer this
data to AWS so that they may join it with other product data, perform additional analysis
and dash-boarding and set alerts if they choose.

###### Topics

- [AWS Glue support for Pendo](pendo-support.md "pendo-support.md")
