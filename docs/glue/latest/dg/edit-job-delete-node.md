...
![The screenshot shows the Example jobs panel with the Visual ETL job to join multiple sources eample job selected.](https://docs.aws.amazon.com/glue/latest/dg/images/visual-etl-example-jobs-create.png)
...
![The screenshot shows a job diagram generated from the Example job.](https://docs.aws.amazon.com/glue/latest/dg/images/visual-job-example-job-nodes.png)
...
![The screenshot shows a job diagram where the Join nodes and Select Fields have been removed and the node connected to it, the Change Schema node, has moved up to take its place in the job flow.](https://docs.aws.amazon.com/glue/latest/dg/images/visual-job-three-data-sources-rearranged.png)
