...
within AWS Glue Studio notebooks.
...
and their code in the IDE. The service integrates with JupyterLab, Amazon SageMaker AI Studio,
Amazon SageMaker AI notebook instances, and other integrated development environments (IDEs).

For more information, see [Using Amazon Q Developer with AWS Glue Studio](../../../amazonq/latest/qdeveloper-ug/glue-setup.md "../../../amazonq/latest/qdeveloper-ug/glue-setup.md").
