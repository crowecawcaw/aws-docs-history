...
+ [Creating a crawler for an Amazon S3 data store](#connection-S3-VPC-create-crawler)
...
You can now create a crawler that specifies the `Network` connection you've created. For more details on creating a crawler, see [Configuring a crawler](define-crawler.md).
...
You can now create a crawler that specifies the `Network` connection you've created and a Catalog source type. For more details on creating a crawler, see [Configuring a crawler](define-crawler.md).
