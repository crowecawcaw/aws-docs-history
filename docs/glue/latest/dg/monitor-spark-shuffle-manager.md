...
![Spark Map Stage writes to disk, shuffles data to S3, then Spark Reduce Stage reads from S3.](http://docs.aws.amazon.com/glue/latest/dg/images/gs-s3-shuffle-diagram.png)
...
![Job parameters section showing write-shuffle-files key with optional value field and Remove button.](http://docs.aws.amazon.com/glue/latest/dg/images/gs-s3-shuffle.png)
