...
1. To avoid reprocessing data, enable job bookmarks in the new job or existing job. For more information, see [Tracking Processed Data Using Job Bookmarks](monitor-continuations.md "monitor-continuations.md").
...
You can also use AWS Glue workflows to orchestrate multiple jobs to process data from different partitions in parallel. For more information, see [AWS Glue Triggers](about-triggers.md "about-triggers.md") and [AWS Glue Workflows](workflows_overview.md "workflows_overview.md").

For more information on use cases and options, please refer to the blog [Optimizing Spark applications with workload partitioning in AWS Glue](https://aws.amazon.com/blogs/big-data/optimizing-spark-applications-with-workload-partitioning-in-aws-glue/ "https://aws.amazon.com/blogs/big-data/optimizing-spark-applications-with-workload-partitioning-in-aws-glue/").
