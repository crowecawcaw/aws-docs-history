...
- Amazon S3 Table Asset publishing in SageMaker Unified Studio: Currently, publishing Amazon S3 Tables as Assets in SageMaker Unified Studio is
  unavailable; visualizing Amazon S3 Table Data Quality runs is unavailable from SageMaker Unified Studio as a result.

## Related topics

- [DQDL rule type reference](dqdl-rule-types.md "dqdl-rule-types.md")
- [Data Quality Definition Language (DQDL) reference](dqdl.md "dqdl.md")
