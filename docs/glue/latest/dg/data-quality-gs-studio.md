...
1.  **Configure a data quality job** – Define actions based on the data quality results and output options. 

1.  **Save and run a data quality job** – Create and run a job. Saving the job will save the rulesets that you created for the job. 

1.  **Monitor and review the data quality results** – Review the data quality results after the job run is complete. Optionally, schedule the job for a future date. 
