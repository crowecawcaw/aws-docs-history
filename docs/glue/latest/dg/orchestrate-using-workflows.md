...
- [Viewing the EventBridge events that started a workflow](viewing-start-event-info.md "viewing-start-event-info.md")
...
- [Getting and setting workflow run properties in AWS Glue](workflow-run-properties-code.md "workflow-run-properties-code.md")
- [Querying workflows using the AWS Glue API](workflows_api_concepts.md "workflows_api_concepts.md")
- [Blueprint and workflow restrictions in AWS Glue](blueprint_workflow_restrictions.md "blueprint_workflow_restrictions.md")
- [Troubleshooting blueprint errors in AWS Glue](blueprint_workflow_troubleshoot.md "blueprint_workflow_troubleshoot.md")
