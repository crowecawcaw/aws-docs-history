...
After you develop a blueprint, you must upload it to Amazon S3. You must have write
...
2. Add all files to a ZIP archive and upload the ZIP file to Amazon S3. Use an S3 bucket that
   is in the same Region as the Region in which users will register and run the
   blueprint.
...
3. Add a bucket policy that grants read permissions to the AWS desired account. The
