...
| `"s3:GetObject"`                                                                             | `"arn:aws:s3:::crawler-public*",<br>"arn:aws:s3:::aws-glue-*"`                                                  | Allows get of Amazon S3 objects used by examples and tutorials<br>from notebooks.<br>Naming convention: Amazon S3 bucket names begin with<br>**crawler-public\*<br>• and<br>**aws-glue-\*\*. |
