...
- For public Salesforce Marketing Cloud documentation for OAuth 2.0 with client credentials, see [Set Up Your Development Environment for Enhanced Packages](https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/mc-dev-setup-enhanced.html "https://developer.salesforce.com/docs/marketing/marketing-cloud/guide/mc-dev-setup-enhanced.html").
...
2. In AWS Glue Glue Studio, create a connection under **Data Connections** by following the steps below:
   ...
   2. Provide the `Subdomain Endpoint` of the Salesforce Marketing Cloud you want to connect to.
