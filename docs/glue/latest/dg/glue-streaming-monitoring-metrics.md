...
![The screenshot shows monitoring the number of records in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-5numrecords.png)
...
![The screenshot shows monitoring using the number of records and Kinesis PutRecords metrics in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-6putrecords.png)
...
![The screenshot shows monitoring batch processing time in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-7batchprocess.png)
...
![The screenshot shows monitoring lag in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-8lag.png)
...
![The screenshot shows monitoring derived metrics in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-9derived.png)
...
![The screenshot shows monitoring autoscaling in streaming jobs.](http://docs.aws.amazon.com/glue/latest/dg/images/streaming-monitoring-10autoscaling.png)
