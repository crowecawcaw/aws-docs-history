...
| --- | --- | --- | 
| AWSGlueServiceNotebookRole – Minor update to an existing policy. | Add glue:GetSessionEndpoint and glue:GetDashboardUrl to policy. Required for Spark Connect connectivity in AWS Glue Interactive Sessions. | June 1, 2026 | 
