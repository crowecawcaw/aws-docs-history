...
| AWSGlueConsoleFullAccess – Minor update to an existing policy.                                                                                                                                                                                             | Add `cloudformation:ListStacks` to policy. Preserves existing capabilities<br>after changes to AWS CloudFormation authorization requirements.                                                                                                                                                                                                                                                                         | March 28, 2023    |
