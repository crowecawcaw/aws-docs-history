...
1. Open the Resource panel and then choose
   **Derived Column** to add a new transform to your job diagram. The node selected at the time of adding the node
   will be its parent.
...
![The screenshot shows the Transform tab for the Derived Column transform.](images/transforms-dervied-column-transform-tab.png)
