...
**Partition key**. For more information about partition parameters, see ["connectionType": "mongodb" as source](aws-glue-programming-etl-connect-mongodb-home.md#etl-connect-mongodb-as-source "aws-glue-programming-etl-connect-mongodb-home.md#etl-connect-mongodb-as-source"). 5. In **Custom MongoDB properties**, enter parameters and values as needed.
