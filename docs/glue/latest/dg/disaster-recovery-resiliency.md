...
For more information about AWS Glue job resiliency, see [Error: Failover behavior between VPCs in AWS Glue](glue-troubleshooting-errors.md#vpc-failover-behavior-error-10 "glue-troubleshooting-errors.md#vpc-failover-behavior-error-10").
