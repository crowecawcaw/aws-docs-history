...
![Graph showing the ETL Data Movement profile.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-1.png)
...
![The metrics for data shuffle across the executors.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-2.png)
...
![The execution metrics for the active executors.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-3.png)
...
![The metrics for the memory profile after the first two stages.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-4.png)
...
![The ETL data movements showing the issue is fixed.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-5.png)
...
![The data shuffle metrics showing the issue is fixed.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-6.png)
...
![The metrics for the Job Execution widget showing that there are no stragglers in the job.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-7.png)
...
![The memory profile metrics showing active memory consumption across all executors.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-straggler-8.png)
