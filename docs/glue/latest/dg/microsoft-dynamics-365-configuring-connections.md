...
+  For public Microsoft Dynamics 365 CRM documentation on creating a connected app for Authorization Code OAuth flow, see \| Microsoft Learn. [Microsoft App Registration](https://learn.microsoft.com/en-us/power-apps/developer/data-platform/authenticate-oauth#app-registration). 
...
1. In AWS Glue Studio, create a connection under **Data Connections** by following the steps below: 
   ...
   1. Select the **INSTANCE\_URL** of the Microsoft Dynamics 365 CRM instance you want to connect to.
