...
![The screenshot shows the Resource Panel and the search bar populated with the word 'Flatten'. The search result shows the Flatten transform.](https://docs.aws.amazon.com/glue/latest/dg/images/transform-flatten.png)
