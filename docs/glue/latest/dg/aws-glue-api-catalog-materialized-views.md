...
The materialized view API describes the AWS Glue data types
and operations for starting, stopping, and monitoring materialized view refresh
task runs.

## Data types

- [MaterializedViewRefreshTaskRun structure](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun")
...
- `MaterializedViewRefreshTaskRunId` – UTF-8 string, matching the [Custom string pattern #48](aws-glue-api-common.md#regex_48 "aws-glue-api-common.md#regex_48").
...
The number of bytes the refresh task run has scanned to refresh the materialized
view.

## Operations

- [StartMaterializedViewRefreshTaskRun action (Python: start\_materialized\_view\_refresh\_task\_run)](#aws-glue-api-catalog-materialized-views-StartMaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-StartMaterializedViewRefreshTaskRun")
- [StopMaterializedViewRefreshTaskRun action (Python: stop\_materialized\_view\_refresh\_task\_run)](#aws-glue-api-catalog-materialized-views-StopMaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-StopMaterializedViewRefreshTaskRun")
- [GetMaterializedViewRefreshTaskRun action (Python: get\_materialized\_view\_refresh\_task\_run)](#aws-glue-api-catalog-materialized-views-GetMaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-GetMaterializedViewRefreshTaskRun")
- [ListMaterializedViewRefreshTaskRuns action (Python: list\_materialized\_view\_refresh\_task\_runs)](#aws-glue-api-catalog-materialized-views-ListMaterializedViewRefreshTaskRuns "#aws-glue-api-catalog-materialized-views-ListMaterializedViewRefreshTaskRuns")
...
- `CatalogId` – _Required:_ UTF-8 string, not less than 1 or more than 255 bytes long, matching the [Single-line string pattern](aws-glue-api-common.md#aws-glue-api-regex-oneLine "aws-glue-api-common.md#aws-glue-api-regex-oneLine").
...
- `MaterializedViewRefreshTaskRunId` – _Required:_ UTF-8 string, matching the [Custom string pattern #48](aws-glue-api-common.md#regex_48 "aws-glue-api-common.md#regex_48").

The identifier for the particular materialized view refresh task run.

###### Response

- `MaterializedViewRefreshTaskRun` – A [MaterializedViewRefreshTaskRun](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun") object.

A MaterializedViewRefreshTaskRun object representing the details
of the task run.
...
- `MaterializedViewRefreshTaskRuns` – An array of [MaterializedViewRefreshTaskRun](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRun") objects.
...
- [MaterializedViewRefreshTaskRunningException structure](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRunningException "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskRunningException")
- [MaterializedViewRefreshTaskNotRunningException structure](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskNotRunningException "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskNotRunningException")
- [MaterializedViewRefreshTaskStoppingException structure](#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskStoppingException "#aws-glue-api-catalog-materialized-views-MaterializedViewRefreshTaskStoppingException")
