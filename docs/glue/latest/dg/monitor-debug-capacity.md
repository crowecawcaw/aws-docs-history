...
![The job metrics showing active executors and maximum needed executors.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-capacity-1.png)
...
![The job metrics showing ETL data movement.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-capacity-2.png)
...
![Graph showing increasing the total number of allocated DPUs](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-capacity-3.png)
...
![Graph showing the total number of active executors reaching the maximum allocated.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-capacity-4.png)
...
![Graph showing that job performance does not always increase by increasing the number of DPUs.](https://docs.aws.amazon.com/glue/latest/dg/images/monitor-debug-capacity-5.png)
