...
+  For more information, see [documentation on creating a connected app for AUTHORIZATION\_CODE OAuth flow](https://developers.pipedrive.com/docs/api/v1/Oauth). 
