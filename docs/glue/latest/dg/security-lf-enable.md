...
| Metadata tables | Not applicable to this table format | Supported, but certain tables are hidden. See [ considerations and limitations](https://docs.aws.amazon.com/glue/latest/dg/security-lf-enable-considerations.html) for more information. | 
...
| Stored procedures | Not applicable | Supported with the exceptions of register\_table and migrate. See [ considerations and limitations](https://docs.aws.amazon.com/glue/latest/dg/security-lf-enable-considerations.html) for more information. | 