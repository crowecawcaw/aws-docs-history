...
For public Twilio documentation for Basic Authentication flow, see [Basic Authentication \| Twilio](https://www.twilio.com/docs/glossary/what-is-basic-authentication).
...
1. In AWS Glue Glue Studio, create a connection under **Data Connections** by following the steps below:
   ...
   1. Provide the `[Edge\_Location](https://www.twilio.com/docs/global-infrastructure/edge-locations)` of the Twilio instance you want to connect to.
