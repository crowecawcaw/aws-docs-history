...
![The screenshot shows the Data Preview session as complete.](https://docs.aws.amazon.com/glue/latest/dg/images/data-preparation-recipe-data-preview-complete.png)
+  Ensure that the toggle for **Automatically import glue libraries** is enabled.   
![The screenshot shows the option for Automatically import glue libraries toggled on.](https://docs.aws.amazon.com/glue/latest/dg/images/data-preparation-recipe-automatically-import-glue-libraries.png)

   You can do this by choosing the gear icon in the Data Preview pane.   
![The screenshot shows the option for Automatically import glue libraries toggled on.](https://docs.aws.amazon.com/glue/latest/dg/images/data-preview-preferences.png)
...
![The screenshot shows the data frame loading after adding the Data Preparation Recipe.](https://docs.aws.amazon.com/glue/latest/dg/images/data-preparation-preparing-dataframe.png)
...
![The screenshot shows the Transform panel with the fields for Name and Node parents, as well as option to Author Recipe.](https://docs.aws.amazon.com/glue/latest/dg/images/data-preparation-recipe-transform-tab-new.png)
...
![The screenshot shows the Transform panel after choosing Add Step. When you choose a column, the options will change dynamically. You can choose to sort, take an action on the column, and filter values.](https://docs.aws.amazon.com/glue/latest/dg/images/author-recipe-preview-data-transform-panel.png)

1.  In the **Transform** panel, choose to sort, take an action on the column, and filter values. For example, choose **Rename column**.   
![The screenshot shows the Transform panel after choosing Add Step. When you choose a column, the options will change dynamically. You can choose to sort, take an action on the column, and filter values.](https://docs.aws.amazon.com/glue/latest/dg/images/author-recipe-add-step.png)
...
![The screenshot shows the Preview data grid with the toolbar highlighted. You can apply an action by using any of the tools and it will be added to the recipe in the Transform panel on the right.](https://docs.aws.amazon.com/glue/latest/dg/images/author-recipe-preview-data-grid.png)
...
![The screenshot shows the Transform panel with steps added to your recipe. When done, choose Done Authoring Recipe or choose the add icon to add more steps to the recipe.](https://docs.aws.amazon.com/glue/latest/dg/images/author-recipe-done-authoring-recipe.png)
