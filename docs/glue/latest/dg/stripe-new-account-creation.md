...
3. After login with account, verify the account by choosing **Open Gmail**.
4. Verify the account by clicking on the verification link received on email.
5. After clicking on verify email address, it will redirect to another page
6. After clicking on **Activate payments** to activate the account, it will redirect to Activate
...
3. Choose **API keys** under Developers.
4. Choose **Reveal test key** to get the API keys.
