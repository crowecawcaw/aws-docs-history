...
We recommend that you use the [`DynamicFrame.split_fields()`](aws-glue-api-crawler-pyspark-extensions-dynamic-frame.md#aws-glue-api-crawler-pyspark-extensions-dynamic-frame-split_fields) method to split fields in a `DynamicFrame`. To view a code example, see [Example: Use split\_fields to split selected fields into a separate `DynamicFrame`](aws-glue-api-crawler-pyspark-extensions-dynamic-frame.md#pyspark-split_fields-example).
