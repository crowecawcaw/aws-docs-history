...
**Topics**
+ [AWS Glue support for Mixpanel](Mixpanel-support.md)
+ [Policies containing the API operations for creating and using connections](mixpanel-configuring-iam-permissions.md)
+ [Configuring Mixpanel](mixpanel-configuring.md)
+ [Configuring Mixpanel connections](mixpanel-configuring-connections.md)
+ [Reading from Mixpanel entities](mixpanel-reading-from-entities.md)
+ [Mixpanel connection options](mixpanel-connection-options.md)
+ [Creating a Mixpanel account and configuring the client app](mixpanel-create-account.md)
