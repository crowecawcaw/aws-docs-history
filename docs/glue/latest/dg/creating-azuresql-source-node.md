...
**View properties**. 2. Choose a **Azure SQL Source** option:
...
If you chose **Enter custom query**, enter a TransactSQL SELECT query. 4. In **Custom Azure SQL properties**, enter parameters and values as needed.
