...
1. OAuth Auth: Monday supports AUTHORIZATION\_CODE grant type for OAuth2.
   ...
   - For more information, see
     ...
     AUTHORIZATION\_CODE OAuth flow](https://developers.Monday.com/docs/api/v1/Oauth "https://developers.Monday.com/docs/api/v1/Oauth").
...
3. In AWS Secrets Manager, create a secret with the following details. It is required to create a secret for
   ...
   1. For OAuth auth:
      ...
      - For customer managed connected app - Secret should contain the connected app Consumer Secret with
        USER\_MANAGED\_CLIENT\_APPLICATION\_CLIENT\_SECRET as key.
