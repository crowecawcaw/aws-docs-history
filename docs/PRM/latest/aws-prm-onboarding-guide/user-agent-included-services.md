...
<a name="user-agent-included-services"></a>
...
For detailed information including specific API actions and regions supported for each service, download the [User Agent Included Services and API Actions (CSV)](samples/user-agent-included-services.zip).
