...
Amazon DocumentDB doesn't enable compression by default for version 5.0. You can [enable compression](doc-compression.md "doc-compression.md") at collection or cluster level for 5.0 cluster. Use Amazon DocumentDB's compression review utility to analyze compression ratios for your collections.

For Amazon DocumentDB 8.0, [compression is enabled by default](dict-compression.md "dict-compression.md").
...
- Amazon DocumentDB provides multiple [index types](index-types.md "index-types.md")
