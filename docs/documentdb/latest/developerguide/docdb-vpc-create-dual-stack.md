...
![Network type section in the console with Dual-stack mode selected.](/images/documentdb/latest/developerguide/images/nw-type-dual-stack.png) 7. At the bottom of the page, switch on **Show advanced settings**. 8. In the **Network settings** section, set these values:
