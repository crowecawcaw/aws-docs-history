...
| -------------------------------- | -------------------------- | ----------------------- | ---------------------- | ----------------------- | ---- |
| Release status                   | EOL: Mar 2026              | Active                  | Active (LTS available) | Active (GA Nov 2025)    |
| Extended Support available       | Yes (paid, until Mar 2029) | N/A                     | N/A                    | N/A                     |
| LTS release available            | No                         | No                      | Yes (v5.0 LTS)         | No                      |
| Default engine version (API/CLI) | No (must specify 3.6.0)    | No (must specify 4.0.0) | Yes (default)          | No (must specify 8.0.0) |
...
| TLS certificate rotation (no reboot)          | No           | Yes (patch 2.0.10179+) | Yes (patch 3.0.4780+)  | Yes  | Yes             |
...
| Zstandard compression                         | No           | No                     | No                     | Yes  | No              |
| Text Index v1                                 | No           | No                     | Yes                    | No   | No              |
| Text Index v2                                 | No           | No                     | No                     | Yes  | No              |
| FedRAMP (GovCloud)                            | No           | No                     | Yes                    | Yes  | No              |

## Instance types

| Instance type support by version | Instance Type | Global cluster | v3.6 | v4.0 | v5.0 | v8.0 |
| -------------------------------- | ------------- | -------------- | ---- | ---- | ---- | ---- |
| db.r4 (previous generation)      | No            | Yes            | No   | No   | No   |
| db.r5                            | Yes           | Yes            | Yes  | Yes  | Yes  |
| db.r6g (Graviton2)               | Yes           | No             | Yes  | Yes  | Yes  |
| db.r6gd (NVMe-backed Graviton2)  | No            | No             | No   | Yes  | Yes  |
| db.r8g (Graviton4)               | Yes           | No             | No   | Yes  | Yes  |
| db.t3.medium                     | No            | Yes            | Yes  | Yes  | Yes  |
| db.t4g.medium (Graviton2)        | No            | No             | Yes  | Yes  | Yes  |
| serverless                       | No            | No             | No   | Yes  | No   |
