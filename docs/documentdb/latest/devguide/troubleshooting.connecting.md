...
- [Can't connect to an Amazon DocumentDB endpoint](#troubleshooting-connecting "#troubleshooting-connecting")
- [Testing a connection to an Amazon DocumentDB instance](#troubleshooting.testing-connection "#troubleshooting.testing-connection")
- [Connecting to an invalid endpoint](#troubleshooting.invalid-endpoint "#troubleshooting.invalid-endpoint")
