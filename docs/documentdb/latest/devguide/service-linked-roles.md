...
If you no longer need to use a feature or service that requires a service-linked role, delete that role. That way you don’t have an unused entity that isn’t actively monitored or maintained. However, you must delete all of your clusters before you can delete the service-linked role.
