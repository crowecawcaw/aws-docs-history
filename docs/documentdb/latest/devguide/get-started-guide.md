...
![Amazon DocumentDB cluster management interface showing a regional cluster with primary instance details](images/cluster-connect-cloud-shell.png) 2. Choose **Connect to cluster** (which is next to the **Actions** dropdown menu).
