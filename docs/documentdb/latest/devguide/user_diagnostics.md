...
- If the high CPU utilization is a result of your write
  ...
  available to service the workload. For more information, see [Managing Amazon DocumentDB instances](db-instances.md "db-instances.md") and [Instance class specifications](db-instance-classes.md#db-instance-class-specs "db-instance-classes.md#db-instance-class-specs").
