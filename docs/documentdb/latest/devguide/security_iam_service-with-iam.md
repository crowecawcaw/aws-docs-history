...
To see a list of RDS actions, see [Actions defined by Amazon Relational Database Service](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonrds.html#amazonrds-actions-as-permissions) in the *Service Authorization Reference*.  
...
To view condition keys for Amazon DocumentDB elastic clusters, see [Condition keys for Amazon DocumentDB elastic clusters](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazondocumentdbelasticclusters.html#amazondocumentdbelasticclusters-policy-keys) in the *Service Authorization Reference*.
