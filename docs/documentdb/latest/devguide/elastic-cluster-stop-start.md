...
**Topics**
+ [Overview of stopping and starting an elastic cluster](#elastic-cluster-stop-start-overview)
+ [Operations you can perform on a stopped elastic cluster](#elastic-cluster-stopped-operations)
