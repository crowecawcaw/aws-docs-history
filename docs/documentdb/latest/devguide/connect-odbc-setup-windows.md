...
![Windows Control Panel interface showing setup links for ODBC 32-bit and 64-bit data sources.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/odbc-control-panel-1.png)
...
![ODBC Data Source Administrator interface showing Add button.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/odbc-add-dsn-1.png)

1. Choose **Amazon DocumentDB** from the data source driver list:  
![The Create New Data Source interface with the Amazon DocumentDB driver option selected.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/create-data-source-1.png)
...
![The Configure Amazon DocumentDB DSN interface with Connection Settings, TLS, and Test Connection fields. The Save button is on the bottom.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/config-docdb-dsn-1.png)
...
![The Configure Amazon DocumentDB DSN interface with SSH Tunnel fields completed.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/config-docdb-dsn-ssh-1.png)
