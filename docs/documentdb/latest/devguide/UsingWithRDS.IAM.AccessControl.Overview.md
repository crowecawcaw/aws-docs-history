...
Amazon DocumentDB provides a set of operations to work with the Amazon DocumentDB resources. For a list of available operations, see [Actions](https://docs.aws.amazon.com/documentdb/latest/developerguide/api-reference.htmlAPI_Operations.html). 
