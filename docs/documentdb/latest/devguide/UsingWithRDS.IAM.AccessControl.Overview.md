...
For more information about using identity-based policies with Amazon DocumentDB, see [Using identity-based policies (IAM policies) for Amazon DocumentDB](UsingWithRDS.IAM.AccessControl.IdentityBased.md "UsingWithRDS.IAM.AccessControl.IdentityBased.md"). For more information about users, groups, roles, and permissions, see [Identities (Users, Groups, and Roles)](../../../IAM/latest/UserGuide/id.md "../../../IAM/latest/UserGuide/id.md") in the _IAM User Guide_.
...
For a table showing all of the Amazon DocumentDB API actions and the resources that they apply to, see [Amazon DocumentDB API permissions: actions, resources, and conditions reference](UsingWithRDS.IAM.ResourcePermissions.md "UsingWithRDS.IAM.ResourcePermissions.md").
