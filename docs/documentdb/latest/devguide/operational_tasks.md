...
**Topics**
+ [Adding a replica to an Amazon DocumentDB cluster](#operational_tasks-add_replica)
+ [Describing clusters and instances](#operational_tasks-list_clusters_and_instances)
+ [Creating a cluster snapshot](#operational_tasks-creating_snapshot)
+ [Restoring from a snapshot](#operational_tasks-restore_from_snapshot)
+ [Removing an instance from a cluster](#operational_tasks-remove_instance_from_cluster)
+ [Deleting a cluster](#operational_tasks-delete_cluster)
