...
![Bar chart showing database load, with a portion of it highlighted for zooming in.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/performance-insights/pi-zoom-1.png)
...
![Database load bar chart showing zoomed-in portion, with corresponding Top waits table below.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/performance-insights/pi-zoom-2.png)
