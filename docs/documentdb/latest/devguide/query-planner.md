...
- [Prerequisites](#v2-nqp-prerequisites "#v2-nqp-prerequisites")
- [Selecting planner version 2.0 as the default query planner](#v2-second-concept-chapter "#v2-second-concept-chapter")
- [Best practices](#v2-nqp-best-practices "#v2-nqp-best-practices")
- [Limitations](#v2-nqp-limitations "#v2-nqp-limitations")
- [Improvements to Find and Update Operators](#v2-operator-improvements "#v2-operator-improvements")
- [Plan cache filter API](#plan-cache-filter-api "#plan-cache-filter-api")
- [Potential behavior differences between planner version 1.0, 2.0, and MongoDB](#v2-planner-behavior-differences "#v2-planner-behavior-differences")
