...
To learn more about monitoring in Amazon DocumentDB, see [Monitoring and logging in Amazon DocumentDB](monitoring_docdb.md).

**Topics**
+ [Out of Memory: incompatible-parameters status](#w2aac51c27b7)
+ [Amazon CloudWatch metrics for DocumentDB serverless](#w2aac51c27b9)
+ [Monitoring DocumentDB serverless performance with Performance Insights](#w2aac51c27c11)

## Out of Memory: incompatible-parameters status
<a name="w2aac51c27b7"></a>
