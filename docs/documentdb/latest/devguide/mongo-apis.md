...
| Command | 3.6 | 4.0 | 5.0 | 8.0 | Elastic cluster | 
| --- | --- | --- | --- | --- | --- | 
| Change streams | [Yes](change_streams.md) | [Yes](change_streams.md) | [Yes](change_streams.md) | [Yes](change_streams.md) | No | 
...
+ [Trigonometry operators](#mongo-apis-aggregation-pipeline-trigonometry)
+ [Bitwise operators (aggregation)](#mongo-apis-aggregation-pipeline-bitwise)
+ [Timestamp operators](#mongo-apis-aggregation-pipeline-timestamp)
...
| [$top](top-accumulator.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$topN](topN.md) | - | - | - | Yes (8.0.1\+) | No | 
...
| [$pow](pow.md) | No | No | Yes (5.0.1\+) | Yes | No | 
| [$round](round.md) | - | - | No | Yes (8.0.1\+) | No | 
| [$sqrt](sqrt.md) | No | Yes | Yes | Yes | Yes | 
| [$subtract](subtract.md) | Yes | Yes | Yes | Yes | Yes | 
| [$trunc](trunc.md) | No | No | No | Yes (8.0.1\+) | No | 
...
| [$sortArray](sortArray.md) | No | No | No | Yes | No | 
...
| Command | 3.6 | 4.0 | 5.0 | 8.0 | Elastic cluster | 
| --- | --- | --- | --- | --- | --- | 
| [$binarySize](binarySize.md) | - | - | No | Yes (8.0.1\+) | No | 
| [$bsonSize](bsonSize.md) | - | - | No | Yes (8.0.1\+) | No | 
...
| [$dateFromParts](dateFromParts.md) | No | No | Yes (5.0.1\+) | No | No | 
| [$dateFromString](dateFromString.md) | Yes | Yes | Yes | Yes | Yes | 
| [$dateSubtract](dateSubtract.md) | No | No | Yes | Yes | Yes | 
| [$dateToParts](dateToParts.md) | No | No | Yes (5.0.1\+) | No | No | 
...
| [$listSearchIndexes](listSearchIndexes.md) | - | - | - | Yes (8.0.1\+) | No | 
...
| [$isNumber](isNumber.md) | - | - | No | Yes (8.0.1\+) | No | 
...
<a name="mongo-apis-aggregation-pipeline-trigonometry"></a>


| Command | 3.6 | 4.0 | 5.0 | 8.0 | Elastic cluster | 
| --- | --- | --- | --- | --- | --- | 
| [$acos](acos.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$acosh](acosh.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$asin](asin.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$asinh](asinh.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$atan](atan.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$atan2](atan2.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$atanh](atanh.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$cos](cos.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$cosh](cosh.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$degreesToRadians](degreesToRadians.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$radiansToDegrees](radiansToDegrees.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$sin](sin.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$sinh](sinh.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$tan](tan.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$tanh](tanh.md) | - | - | - | Yes (8.0.1\+) | No | 

### Bitwise operators (aggregation)
<a name="mongo-apis-aggregation-pipeline-bitwise"></a>


| Command | 3.6 | 4.0 | 5.0 | 8.0 | Elastic cluster | 
| --- | --- | --- | --- | --- | --- | 
| [$bitAnd](bitAnd.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$bitNot](bitNot.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$bitOr](bitOr.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$bitXor](bitXor.md) | - | - | - | Yes (8.0.1\+) | No | 

### Timestamp operators
<a name="mongo-apis-aggregation-pipeline-timestamp"></a>


| Command | 3.6 | 4.0 | 5.0 | 8.0 | Elastic cluster | 
| --- | --- | --- | --- | --- | --- | 
| [$tsIncrement](tsIncrement.md) | - | - | - | Yes (8.0.1\+) | No | 
| [$tsSecond](tsSecond.md) | - | - | - | Yes (8.0.1\+) | No | 
