...
+ **Change streams** — You can read change streams from a secondary cluster in global clusters, reducing the load on the primary cluster and allowing you to scale read workloads from secondary Regions.

## What are the current limitations of global clusters?
<a name="w2aac31b9b7"></a>
...
**Topics**
+ [What is a global cluster?](#w2aac31b9b3)
+ [How are global clusters useful?](#w2aac31b9b5)
+ [What are the current limitations of global clusters?](#w2aac31b9b7)
