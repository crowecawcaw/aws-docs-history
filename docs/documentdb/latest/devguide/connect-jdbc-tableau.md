...
![The Connect interface on Tableau Desktop shows the More... submenu under the To a Server section. The Amazon DocumentDB option is highlighted in the Installed Connectors submenu.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-choose-docdb.png)
...
![General tab in Amazon DocumentDB connector interface showing hostname, port, database, username, and password fields.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-connect.png)

1. (Optional) More advanced options can be found on the **Advanced** tab.  
![Advanced tab in Amazon DocumentDB connector interface showing additional connection options.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-advanced.png)
...
![Advanced tab in Amazon DocumentDB connector interface with Enable SSH Tunnel selected and additional SSH input fields shown.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-advanced-Enablessh.png)
...
![Advanced tab in Amazon DocumentDB connector interface with SSH Strict Host Key Check option disabled.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-advanced-sshhostkeycheck.png)
...
![General tab in Amazon DocumentDB connector interface showing hostname, port, database, username, and password fields.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/jdbc/tableau-hostname.png)
