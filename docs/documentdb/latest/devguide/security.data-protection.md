...
applies to data protection in Amazon DocumentDB.
...
- [Encrypting data in transit](security.encryption.ssl.md "security.encryption.ssl.md")
- [Key management](security.encryption.ssl.public-key.md "security.encryption.ssl.public-key.md")
