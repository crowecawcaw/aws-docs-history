...
**Topics**
+ [Modifying elastic cluster configurations](#elastic-modify)
+ [Monitoring an elastic cluster](#elastic-monitor)
+ [Deleting an elastic cluster](#elastic-delete)
+ [Managing elastic cluster snapshots](elastic-manage-snapshots.md)
+ [Stopping and starting an Amazon DocumentDB elastic cluster](elastic-cluster-stop-start.md)
+ [Maintaining Amazon DocumentDB elastic clusters](elastic-cluster-maintenance.md)
