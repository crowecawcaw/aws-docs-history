...
1. **Modify the value of the `tls` cluster parameter.**
   ...
   The following code *enables* `tls`, applying the change to each instance when it is rebooted.
