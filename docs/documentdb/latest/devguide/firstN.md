...
<a name="firstN-examples"></a>

The following example shows how to use the `$firstN` accumulator to retrieve the first two quantities for each item during the aggregation.
...
<a name="firstN-expression-examples"></a>
