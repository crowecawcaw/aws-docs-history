...
- [Amazon DocumentDB index creation](#index-creation-build "#index-creation-build")
- [Maintaining Amazon DocumentDB indexes](#maintaining-indexes-build "#maintaining-indexes-build")
...
In the following output example (foreground index build), the status of the index creation is shown.
