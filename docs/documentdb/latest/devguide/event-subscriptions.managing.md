...
![Amazon DocumentDB console navigation pane with Event Subscriptions option highlighted.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/modify-event-subs.png)

1. In the **Event subscriptions** pane, choose the subscription that you want to modify and choose **Edit**.  
![The Event subscriptions pane showing a selected subscription and the Edit button.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/modify-edit.png)
...
![The Modify event subscription form highlighting the Target section.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/modify-target.png)

1. Choose **Modify**. The Amazon DocumentDB console indicates that the subscription is being modified.   
![The end of the Modify event subscription form with the Modify button highlighted.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/modify-button.png)
...
![Amazon DocumentDB console navigation pane with Event Subscriptions option highlighted.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/delete-event-subs.png)

1. In the **Event subscriptions** pane, choose the subscription that you want to delete.   
![The Event subscriptions pane showing a selected subscription.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/delete-select.png)

1. Choose **Delete**.  
![The Event subscriptions pane highlighting the Delete button.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/delete-delete.png)

1. A pop-up window will appear asking you if you want to permanently delete this notification. Choose **Delete**.  
![A dialog box confirming deletion of the event subscription with the Delete button highlighted in the lower-right corner.](https://docs.aws.amazon.com/documentdb/latest/devguide/images/event-subs/delete-delete-2.png)