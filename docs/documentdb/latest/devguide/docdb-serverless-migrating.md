...
**Topics**
+ [Migrating existing DocumentDB clusters to serverless](#w2aac51c19b5)
+ [Migrating from MongoDB to DocumentDB serverless](#w2aac51c19b7)

## Migrating existing DocumentDB clusters to serverless
<a name="w2aac51c19b5"></a>

### Upgrading a cluster’s engine version
<a name="w2aac51c19b5b3"></a>
...
1. Choose **Create**.
   ...
   It takes several minutes to create an instance. You can use the console or the AWS CLI to view the instance's status. For more information, see [Monitoring an Amazon DocumentDB cluster's status](monitoring_docdb-cluster_status.md).
...
<a name="w2aac51c19b7"></a>

You can migrate your MongoDB databases to DocumentDB serverless, just as with provisioned Amazon DocumentDB. For more information, see [Migrating and upgrading Amazon DocumentDB](docdb-migration.md).