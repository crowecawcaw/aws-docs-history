...
policies to limit the permissions that Amazon DocumentDB gives another service to the
...
`aws:SourceAccount` global condition context keys in Amazon DocumentDB to prevent
