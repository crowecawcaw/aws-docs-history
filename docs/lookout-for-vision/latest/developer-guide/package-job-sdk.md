...
the [StartModelPackagingJob](../APIReference/API_StartModelPackagingJob.md "../APIReference/API_StartModelPackagingJob.md") API. The job might take a while to complete.
To find out the current status, call [DescribeModelPackagingJob](../APIReference/API_DescribeModelPackagingJob.md "../APIReference/API_DescribeModelPackagingJob.md")
...
[StartModelPackagingJob](https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javav2/example_code/lookoutvision/src/main/java/com/example/lookoutvision/StartModelPackagingJob.java "https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javav2/example_code/lookoutvision/src/main/java/com/example/lookoutvision/StartModelPackagingJob.java").
...
2. Make sure that you have the correct permissions to start a model
   packaging job. For more information, see [StartModelPackagingJob](../APIReference/API_StartModelPackagingJob.md "../APIReference/API_StartModelPackagingJob.md").
...
Change the following values:
    ...
    * `project_name` to the name of the project that contains the model that
     you want to package.
    ...
    * (Optional) `component_version` to a version for the model component that the packaging job creates. Use the format
     `major.minor.patch`. For example, 1.0.0 represents the first major release for a component.
...
5. Use `DescribeModelPackagingJob` to get the current status of the job.
...
If the value is different, wait a minute and try again. 6. Continue deployment using AWS IoT Greengrass V2. For more information, see [Deploying your components to a device](device-deploy-components.md "device-deploy-components.md").
