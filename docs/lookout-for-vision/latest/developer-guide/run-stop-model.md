...
To stop a running model, you call the `StopModel` operation and pass the
following:

- **Project** – The name of the project that contains the model that
  you want to stop.
...
- [Stopping your model (console)](#stop-model "#stop-model")
- [Stopping your Amazon Lookout for Vision model (SDK)](#stop-model-sdk "#stop-model-sdk")
...
Change the following values:
    ...
    * `project-name` to the name of the project that contains the model
     that you want to stop.
    * `model-version` to the version of the
...
Java V2
This code is taken from the AWS Documentation SDK examples GitHub repository. See the full example
[here](https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javav2/example_code/lookoutvision/src/main/java/com/example/lookoutvision/StopModel.java "https://github.com/awsdocs/aws-doc-sdk-examples/blob/main/javav2/example_code/lookoutvision/src/main/java/com/example/lookoutvision/StopModel.java").
