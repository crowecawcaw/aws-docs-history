...
encounter when working with Lookout for Vision and IAM.

###### Topics

- [I am not authorized to
  perform an action in Lookout for Vision](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my Lookout for Vision resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Lookout for Vision
...
have the fictional `lookoutvision:`GetWidget`` permissions.
...
`lookoutvision:`GetWidget`` action.
...
Lookout for Vision. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Lookout for Vision resources
...
- To learn whether Lookout for Vision supports these features, see [How Amazon Lookout for Vision works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
