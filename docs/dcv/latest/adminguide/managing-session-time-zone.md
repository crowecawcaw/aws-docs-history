...
If only individual users in a session are required to have this feature, you will need to set the centralized parameter for all users first and then adjust individuals’
permissions separately by creating a custom permissions file at [Adding permissions](security-authorization-file-create-permission.md "security-authorization-file-create-permission.md").
