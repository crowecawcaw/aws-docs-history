...
**Topics**
+ [Uninstalling the Amazon DCV Server on Windows](#uninstalling-windows)
+ [Uninstalling the Amazon DCV Server on Linux](#uninstalling-linux)
+ [Uninstalling the Amazon DCV Server on macOS](#uninstalling-macos)
...
1. Select Amazon DCV server and then press **Uninstall**.

1. (Optional) You might also want to remove any log files that were generated by the Amazon DCV server. After the uninstallation is complete, navigate to **C:\\ProgramData\\NICE\\dcv\\** and delete the **log** folder.
...
1. (Optional) You might also want to remove any log files that were generated by the Amazon DCV server. After the uninstallation is complete, navigate to **/var/log** and delete the **dcv** folder.
...
1. Remove the Amazon DCV server packages with the following command:
