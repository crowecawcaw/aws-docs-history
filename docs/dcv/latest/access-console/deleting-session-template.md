...
![Session templates interface showing options to manage and create templates.](images/session-templates-delete.png) 4. Click on the **Delete** button in the window that
appears.
