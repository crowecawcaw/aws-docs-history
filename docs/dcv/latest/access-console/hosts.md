...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Family                  | The host operating system family that the Amazon DCV server is<br>running on, such as Windows or Linux<br>(`Host.OS.Family` in the<br>[DescribeServers API](../sm-dev/DescribeServers.md "../sm-dev/DescribeServers.md") API).                               |
