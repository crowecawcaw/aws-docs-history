...
The Amazon DCV Access Console has three components Handler, Web Client, and Authentication Server. To streamline the setup process, you can install the components on the same host. See Amazon DCV Access Console [Requirements](requirements.md) to ensure your setup meets the requirements for setup on a single host.

## Preparing the components and the Setup Wizard
<a name="preparing-components-single"></a>
