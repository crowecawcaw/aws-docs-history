...
![Sessions page showing three available sessions with Create session button highlighted.](images/console-dashboard-create-button.png) 3. In **Display name**, enter a user friendly name for your
session.
...
![Create session page with display name field, session template selector showing Test 2, Test 2 - copy, and Test options.](images/create-seesion-1.png)
...
![Sessions dashboard showing three available sessions with names, status, and owner columns.](images/create-seesion-2.png)
