...
![Display is the second tab from the left inside the Preferences modal.](images/web-preferences-display.png) 3. (Optional) For information about network performance, choose **Display Streaming
...
![Streaming metrics data example](images/web-streaming-metrics-data.png) 6. (Optional) Close the **Metrics** modal.
