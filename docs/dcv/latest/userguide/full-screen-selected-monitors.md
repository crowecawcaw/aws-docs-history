...
![Diagram showing transformation of rectangles from gray to blue, merging into larger shapes.](images/multi-monitors-yes.png)
_Examples of nonadjacent monitor placement._

![Two blue rectangles separated by a gray rectangle, with a red X to the right.](images/multi-monitors-no.png)
