...
applications that process small documents as they arrive. For example, you can detect custom entities in social
media posts, support tickets, or customer reviews.
...
images, PDF files, and Word documents. For information about the input files, see
