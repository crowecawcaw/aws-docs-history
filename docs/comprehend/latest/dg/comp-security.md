...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon Comprehend, see [AWS Services in Scope by Compliance
...
- **Security in the cloud** – Your responsibility is
  ...
  using Amazon Comprehend. The following topics show you how to configure Amazon Comprehend to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Amazon Comprehend resources.
