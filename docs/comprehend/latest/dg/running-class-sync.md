...
After you train a custom classifier, you can classify documents using real-time analysis.
Real-time analysis takes a single document as input and returns the results synchronously.
Custom classification accepts a variety of document types as inputs for real-time analysis. For details, see
...
- [Real-time analysis for custom classification (console)](custom-sync.md "custom-sync.md")
- [Real-time analysis for custom classification (API)](class-sync-api.md "class-sync-api.md")
- [Outputs for real-time analysis](outputs-class-sync.md "outputs-class-sync.md")
