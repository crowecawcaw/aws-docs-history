...
- [Before you start](#events-before "#events-before")
- [Detect events using the AWS CLI](#events-cli "#events-cli")
- [List events using the AWS CLI](#list-events "#list-events")
- [Describe events using the AWS CLI](#describe-events "#describe-events")
- [Get events detection results](#async-events "#async-events")
  To detect events in a document set, use the [StartEventsDetectionJob](../APIReference/API_StartEventsDetectionJob.md "../APIReference/API_StartEventsDetectionJob.md")
  to start an asynchronous job.
...
The following example demonstrates using the [StartEventsDetectionJob](../APIReference/API_StartEventsDetectionJob.md "../APIReference/API_StartEventsDetectionJob.md")
...
If the request to start the events detection job was successful, you will receive
...
Use the [ListEventsDetectionJobs](../APIReference/API_ListEventsDetectionJobs.md "../APIReference/API_ListEventsDetectionJobs.md")
operation to see a list of the events detection jobs that you have submitted. The list includes information about
...
The following is an example an output file from an analysis job that detected
events in documents. The format of the input is one document per line.
...
For more information about events output file structure and supported event types,
see [Events](how-events.md "how-events.md").
