...
You can use the Amazon Comprehend API to run real-time analysis with a custom model. First, you create an endpoint to run the real-time analysis.
After you create the endpoint, you run the real-time analysis.
...
For more information about the command syntax, see [DetectEntities](../APIReference/API_DetectEntities.md "../APIReference/API_DetectEntities.md") in the _Amazon Comprehend API Reference_.
