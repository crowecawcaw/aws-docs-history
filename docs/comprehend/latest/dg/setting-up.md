...
- [Set up the AWS Command Line Interface (AWS CLI)](#setup-awscli "#setup-awscli")
...
skip this step and go to [Getting started with Amazon Comprehend](getting-started.md "getting-started.md"), and set up the AWS CLI later.
