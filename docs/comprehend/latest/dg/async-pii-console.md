...
For more information about PII entity types, see [Detecting PII entities](how-pii.md "how-pii.md").
...
for the job. For a description of the analysis results, see [Detecting PII entities](how-pii.md "how-pii.md").
