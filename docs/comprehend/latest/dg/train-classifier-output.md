...
+ [Additional outputs for native document models](#train-class-output-native)
...
**Topics**
+ [Confusion matrix for multi-class mode](#m-c-matrix)
+ [Confusion matrix for multi-label mode](#m-l-matrix)
