...
In the following example training data, there are five labels, DOCUMENTARY, DOCUMENTARY, SCIENCE\_FICTION,
DOCUMENTARY, ROMANTIC\_COMEDY. There are three unique classes: DOCUMENTARY, SCIENCE\_FICTION, ROMANTIC\_COMEDY.
...
SCIENCE\_FICTION, and a single instance of the ROMANTIC\_COMEDY class, the test dataset might contain 100 DOCUMENTARY
and 90 SCIENCE\_FICTION instances, but no ROMANTIC\_COMEDY instances, as there is a single example available.
