...
you to reserve a static minimum capacity for your load balancer. Gateway Load Balancers
...
LCUs, with each LCU being equal to 2.2Mbps. You can use the **PeakBytesPerSecond** metric
to see the maximum per-minute throughput traffic on the load balancer, then convert
that throughput to LCUs using a conversion rate of 2.2Mbps equals 1 LCU.
...
more information, see [Load Balancer Capacity Units](quotas-limits.md#lcu-quotas "quotas-limits.md#lcu-quotas").
