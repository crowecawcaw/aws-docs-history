...
defined in RFC 2616, [Message Headers](https://datatracker.ietf.org/doc/html/rfc2616#section-4.2 "https://datatracker.ietf.org/doc/html/rfc2616#section-4.2"). There are also non-standard HTTP headers
available (and automatically added) that are widely used by the applications. Some of
