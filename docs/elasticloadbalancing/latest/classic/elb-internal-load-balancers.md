...
![An internal load balancer routes traffic to your EC2 instances in private subnets.](https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/images/internal_load_balancer.png)
