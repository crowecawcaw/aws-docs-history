...
| destination:port             | The IP address and port of the destination. If the client<br>connects directly to the load balancer, the destination is the<br>listener. If the client connects using a VPC endpoint service,<br>the destination is the VPC endpoint.                                                                                                                                                                                                         |
