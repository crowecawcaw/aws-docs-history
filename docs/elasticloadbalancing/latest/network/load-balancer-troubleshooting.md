...
If you are using QUIC listeners, ensure that your targets generate
Connection IDs that are exactly 17 bytes. The load balancer drops QUIC
packets that carry a Connection ID of any other length.
