...
- [Load balancers](network-load-balancers.md "network-load-balancers.md")
- [Listeners](load-balancer-listeners.md "load-balancer-listeners.md")
- [Target groups](load-balancer-target-groups.md "load-balancer-target-groups.md")
...
registered targets in all enabled Availability Zones. For more information, see [Update the Availability Zones for your Network Load Balancer](availability-zones.md "availability-zones.md").
