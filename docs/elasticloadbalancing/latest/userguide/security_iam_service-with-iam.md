...
- Application Load Balancers, Network Load Balancers, and Gateway Load Balancers —
  [API Reference version 2015-12-01](../APIReference.md "../APIReference.md")
...
- [elasticloadbalancing:ListenerProtocol](#listenerprotocol-condition "#listenerprotocol-condition")
- [elasticloadbalancing:SecurityPolicy](#securitypolicy-condition "#securitypolicy-condition")
- [elasticloadbalancing:Scheme](#scheme-condition "#scheme-condition")
- [elasticloadbalancing:SecurityGroup](#securitygroup-condition "#securitygroup-condition")
- [elasticloadbalancing:Subnet](#subnet-condition "#subnet-condition")
- [elasticloadbalancing:ResourceTag](#resourcetag-condition "#resourcetag-condition")
...
The following example policy requires users to select the HTTPS
protocol for the listeners for their Application Load Balancers and the TLS protocol for
the listeners for their Network Load Balancers.
...
With a Classic Load Balancer, you can specify multiple listeners in a single call. Therefore, your policy must use a
[multi-value
context key](../../../IAM/latest/UserGuide/reference_policies_condition_examples-multi-valued-context-keys.md "../../../IAM/latest/UserGuide/reference_policies_condition_examples-multi-valued-context-keys.md"), as shown in the following example.
...
The following example policy requires users to select one of the
specified security policies for their Application Load Balancers and Network Load Balancers.
...
The following example policy requires users to select the specified
scheme for their load balancers.
...
The following example policy requires users to select one of the specified
security groups for their load balancers.
...
The following example policy requires users to select one of the specified
subnets for their load balancers.
