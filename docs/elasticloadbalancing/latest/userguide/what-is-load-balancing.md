...
- [User Guide for Application Load Balancers](../application.md "../application.md")
...
- **Amazon EC2** — Virtual servers that run your applications
  ...
  instances. For more information, see the [Amazon EC2 User Guide](../../../AWSEC2/latest/UserGuide.md "../../../AWSEC2/latest/UserGuide.md").
...
- **AWS Certificate Manager** — When you create an HTTPS listener, you
  ...
  to terminate connections and decrypt requests from clients.
- **Amazon CloudWatch** — Enables you to monitor your load
  balancer and to take action as needed. For more information, see the
...
- **Amazon ECS** — Enables you to run, stop, and manage Docker
  containers on a cluster of EC2 instances. You can configure your load balancer to
  route traffic to your containers. For more information, see the [Amazon Elastic Container Service Developer Guide](../../../AmazonECS/latest/developerguide.md "../../../AmazonECS/latest/developerguide.md").
- **AWS Global Accelerator** — Improves the availability and performance
  of your application. Use an accelerator to distribute traffic across multiple load
  balancers in one or more AWS Regions. For more information, see the [AWS Global Accelerator Developer Guide](../../../global-accelerator/latest/dg.md "../../../global-accelerator/latest/dg.md").
- **Route 53** — Provides a reliable and cost-effective way
  to route visitors to websites by translating domain names into the numeric IP
  addresses that computers use to connect to each other. For example, it would
  translate `www.example.com` into the numeric IP address
  `192.0.2.1`. AWS assigns URLs to your resources, such as load
  balancers. However, you might want a URL that is easy for users to remember. For
  example, you can map your domain name to a load balancer. For more information,
  see the [Amazon Route 53 Developer Guide](../../../Route53/latest/DeveloperGuide.md "../../../Route53/latest/DeveloperGuide.md").
- **AWS WAF** — You can use AWS WAF with your Application Load Balancer to allow
  ...
  more information, see the [AWS WAF Developer Guide](../../../waf/latest/developerguide.md "../../../waf/latest/developerguide.md").
