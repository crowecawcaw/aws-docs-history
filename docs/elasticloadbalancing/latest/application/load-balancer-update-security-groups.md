...
| `instance security group` | `instance listener` | Allow outbound traffic to instances on the instance listener<br>port |
| `instance security group` | `health check`      | Allow outbound traffic to instances on the health check<br>port      |

The following rules are recommended for an internal load balancer with instances
as targets.
...
The following rules are recommended for an Application Load Balancer with instances as targets that
...
You can update the security groups associated with your load balancer at any
time.
...
5. To associate a security group with your load balancer, select it. To
   remove a security group association, choose the **X** icon
