...
| X-Amzn-TLS-Version                   | Indicates the version of the TLS protocol used for a<br>connection. It helps determining the security level<br>of the communication, troubleshoot connection issues and<br>ensuring compliance.                                                                    |
