...
statement for Elastic Load Balancing health check logs to the policy. If you do so, we recommend
...
that you don't own, Elastic Load Balancing could write the health check logs for your load balancer
to this new bucket.
...
After health check logs are enabled for your load balancer, Elastic Load Balancing validates the S3
...
- The bucket policy does not grant Elastic Load Balancing permission to write health check logs
