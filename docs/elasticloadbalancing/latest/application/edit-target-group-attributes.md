...
- Plan for enough target capacity across all Availability Zones that you expect to
  use, per target group. If you can't plan for enough capacity across all
...
information to provide a continuous experience to clients. To use sticky
...
- Set an expiry on the cookie generated by the application that is before
