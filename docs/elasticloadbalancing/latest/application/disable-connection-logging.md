...
You can disable connection logs for your load balancer at any time. After you
disable connection logs, your connection logs remain in your S3 bucket until you delete
...
4. On the **Attributes** tab, choose
   **Edit**.
5. For **Monitoring**, turn off **Connection
   logs**.
