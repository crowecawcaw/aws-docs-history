...
Each _target group_ routes requests to one or more registered
...
![The components of a basic Application Load Balancer](images/component_architecture.png)

For more information, see the following documentation:

- [Load balancers](application-load-balancers.md "application-load-balancers.md")
...
- Support for [Path conditions](rule-condition-types.md#path-conditions "rule-condition-types.md#path-conditions").
  ...
  URL.
- Support for [Host conditions](rule-condition-types.md#host-conditions "rule-condition-types.md#host-conditions").
...
- Support for routing based on fields in the request, such as [HTTP header conditions](rule-condition-types.md#http-header-conditions "rule-condition-types.md#http-header-conditions")
...
- **AWS Certificate Manager** — When you create an HTTPS listener, you
  ...
  information, see [SSL certificates for your Application Load Balancer](https-listener-certificates.md "https-listener-certificates.md").
- **Amazon CloudWatch** — Enables you to monitor your load
  balancer and take action as needed. For more information, see [CloudWatch metrics for your Application Load Balancer](load-balancer-cloudwatch-metrics.md "load-balancer-cloudwatch-metrics.md").
- **Amazon ECS** — Enables you to run, stop, and manage Docker
  ...
  balancing](../../../AmazonECS/latest/developerguide/service-load-balancing.md "../../../AmazonECS/latest/developerguide/service-load-balancing.md") in the _Amazon Elastic Container Service Developer Guide_.
- **AWS Global Accelerator** — Improves the availability and
  ...
  the [AWS Global Accelerator Developer Guide](../../../global-accelerator/latest/dg.md "../../../global-accelerator/latest/dg.md").
- **Route 53** — Provides a reliable and cost-effective way
  ...
  [Routing traffic to
  an ELB load balancer](../../../Route53/latest/DeveloperGuide/routing-to-elb-load-balancer.md "../../../Route53/latest/DeveloperGuide/routing-to-elb-load-balancer.md") in the _Amazon Route 53 Developer Guide_.
- **AWS WAF** — You can use AWS WAF with your Application Load Balancer to allow
  ...
  more information, see [AWS WAF](load-balancer-integrations.md#load-balancer-waf "load-balancer-integrations.md#load-balancer-waf").
