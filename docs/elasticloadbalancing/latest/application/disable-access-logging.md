...
You can disable access logs for your load balancer at any time. After you
disable access logs, your access logs remain in your S3 bucket until you delete
them. For more information, see [Creating, configuring, and working with S3 buckets](../../../AmazonS3/latest/userguide/creating-buckets-s3.md "../../../AmazonS3/latest/userguide/creating-buckets-s3.md") in the
