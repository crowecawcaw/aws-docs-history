...
Security is a shared responsibility between AWS and you. The [shared responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/") describes
 this as security *of* the cloud and security *in* the
 cloud:
...
* **Security of the cloud** – AWS is responsible for
 ...
 learn about the compliance programs that apply to AWS Cloud Map, see [AWS Services in Scope by
...
The following documentation helps you understand how to apply the shared responsibility model when
 using AWS Cloud Map. The following topics show you how to configure AWS Cloud Map to meet your security and
 compliance objectives. You also learn how to use other AWS services that help you to monitor
 and secure your AWS Cloud Map resources. 

###### Topics

* [Identity and Access Management for AWS Cloud Map](security-iam.md "security-iam.md")
* [Compliance validation for AWS Cloud Map](cloud-map-compliance.md "cloud-map-compliance.md")
* [Resilience in AWS Cloud Map](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
* [Infrastructure security in AWS Cloud Map](infrastructure-security.md "infrastructure-security.md")
