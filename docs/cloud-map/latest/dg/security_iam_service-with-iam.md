...
To get a high-level view of how AWS Cloud Map and other AWS services work with most
...
To see a list of AWS Cloud Map actions, see [Actions defined by AWS Cloud Map](../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-actions-as-permissions "../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-actions-as-permissions") in the
...
To see a list of AWS Cloud Map resource types and their ARNs, see
[Resources defined by AWS Cloud Map](../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of AWS Cloud Map condition keys, see [Condition keys for AWS Cloud Map](../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-policy-keys "../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources
you can use a condition key, see [Actions defined by AWS Cloud Map](../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-actions-as-permissions "../../../service-authorization/latest/reference/list_awscloudmap.md#awscloudmap-actions-as-permissions").

AWS Cloud Map supports the following service-specific condition keys that you can use to
provide fine-grained filtering for your IAM policies.

**`servicediscovery:NamespaceArn`**

A filter that lets you get objects by specifying the Amazon Resource
Name (ARN) for the related namespace.

**`servicediscovery:NamespaceName`**

A filter that lets you get objects by specifying the name of the
related namespace.

**`servicediscovery:ServiceArn`**

A filter that lets you get objects by specifying the Amazon Resource
Name (ARN) for the related service.
...
Changing the permissions for a service role might break AWS Cloud Map
