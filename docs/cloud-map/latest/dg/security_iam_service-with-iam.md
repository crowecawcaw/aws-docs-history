...
To get a high-level view of how AWS Cloud Map and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of AWS Cloud Map identity-based policies, see [Identity-based policy examples for AWS Cloud Map](security_iam_id-based-policy-examples.md).
...
**Note**  
You can use AWS Resource Access Manager (AWS RAM) to securely share a AWS Cloud Map namespace. A resource-based policy is applied to your namespace by the AWS RAM service. For more information, see [Shared AWS Cloud Map namespaces](sharing-namespaces.md).
...
To see a list of AWS Cloud Map actions, see [Actions defined by AWS Cloud Map](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscloudmap.html#awscloudmap-actions-as-permissions) in the *Service Authorization Reference*.
...
To see a list of AWS Cloud Map condition keys, see [Condition keys for AWS Cloud Map](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscloudmap.html#awscloudmap-policy-keys) in the *Service Authorization Reference*. To learn with which actions and resources you can use a condition key, see [Actions defined by AWS Cloud Map](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscloudmap.html#awscloudmap-actions-as-permissions).
