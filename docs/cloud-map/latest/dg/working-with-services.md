...
done using DNS queries or the AWS Cloud Map [`DiscoverInstances`](../api/API_DiscoverInstances.md "../api/API_DiscoverInstances.md") API
...
- Service preferences such as API timeouts and suggested retry policies.
  For more information, see [UpdateServiceAttributes](../api/API_UpdateServiceAttributes.md "../api/API_UpdateServiceAttributes.md") in the _AWS Cloud Map API reference_.
