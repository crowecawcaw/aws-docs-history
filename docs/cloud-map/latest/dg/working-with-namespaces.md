...
- If you create a namespace to allow for instance discovery by DNS queries in a VPC, AWS Cloud Map
  ...
  multiple VPCs. For more information, see [AssociateVPCWithHostedZone](../../../Route53/latest/APIReference/API_AssociateVPCWithHostedZone.md "../../../Route53/latest/APIReference/API_AssociateVPCWithHostedZone.md") in
