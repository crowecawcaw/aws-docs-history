...
As a managed service, AWS Cloud Map is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Cloud Map through the network. Clients must
