...
AWS Cloud Map [DiscoverInstances](../api/API_DiscoverInstances.md "../api/API_DiscoverInstances.md") API action. The resources you can register include, but aren't limited to, the following:
