...
necessary for it to be an actual domain that's being used. 4. (Optional) For **Namespace description**, specify a description for what
you intend to use the namespace for. 5. For **Instance discovery**, select **API calls and public DNS
queries**. 6. Leave the rest of the default values and choose **Create
namespace**.
...
4. In the **Services** section, choose **Create service**
   ...
   routing policy](../../../Route53/latest/DeveloperGuide/routing-policy.md "../../../Route53/latest/DeveloperGuide/routing-policy.md") in the _Route 53 Developer Guide_. 4. Leave the rest of the default values and choose **Create service**
