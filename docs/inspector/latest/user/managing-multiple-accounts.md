...
**Topics**
+ [Understanding the delegated administrator account and member account in Amazon Inspector](admin-member-relationship.md)
+ [Designating a delegated administrator account for Amazon Inspector](designating-admin.md)