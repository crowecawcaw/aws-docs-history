...
For code vulnerability findings Amazon Inspector uses the severity levels defined by the Amazon Q detectors that generated the finding. Each detector is assigned a severity using the CVSS v3 scoring system. ?
