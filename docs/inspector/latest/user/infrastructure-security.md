...
As a managed service, Amazon Inspector is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Inspector through the network. Clients must
