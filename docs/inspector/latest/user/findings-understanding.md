...
**Suppressed**  
 Amazon Inspector categorizes a finding subject to one or more [suppression rules](https://docs.aws.amazon.com/inspector/latest/user/findings-managing-supression-rules.html) as **Suppressed**. 

**Closed**  
 When a finding has been remediated, Amazon Inspector categorizes the finding as **Closed**. 

**Topics**
+ [Amazon Inspector finding types](findings-types.md)
+ [Viewing Amazon Inspector findings](findings-understanding-locating-analyzing.md)
+ [Viewing details for your Amazon Inspector findings](findings-understanding-details.md)
+ [Viewing the Amazon Inspector score and understanding vulnerability intelligence details](findings-understanding-score.md)
+ [Understanding severity levels for your Amazon Inspector findings](findings-understanding-severity.md)