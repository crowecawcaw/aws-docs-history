...
**Topics**
+ [Viewing the dashboard](#displaying-the-dashboard)
+ [Understanding dashboard components and interpreting data](#understanding-dashboard-components)
