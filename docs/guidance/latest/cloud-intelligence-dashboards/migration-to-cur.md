...
<a name="step-1-3-deploy-data-exports"></a>
...
<a name="step-2-3-update-dashboards"></a>
...
<a name="step-2-1-cloudformation-update-if-needed"></a>
...
<a name="step-2-2-command-line-update-mandatory"></a>
...
<a name="step-3-3-decommission-optional"></a>
...
<a name="troubleshooting-and-faq"></a>

### I do not see data on dashboards after migration
<a name="i-do-not-see-data-on-dashboards-after-migration"></a>
...
Please [contact the team](feedback-support.md) if you encounter any issue.