...
<a name="graviton-savings-dashboard"></a>
...
## Usage Overview
<a name="graviton-savings-usage-overview"></a>

### Click here for the detailed usage overview
<a name="collapsible-section-id-graviton-savings-dashboard-1"></a>
...
OpenSearch Graviton eligibility is a bit more straightforward than other AWS Managed Services. The below table describes eligibility for both Amazon ElasticSearch and AmazonOpenSearch:
...
## Feedback Support
<a name="graviton-savings-dashboard-feedback-support"></a>
