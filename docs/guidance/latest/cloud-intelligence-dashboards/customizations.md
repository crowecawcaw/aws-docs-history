...
[cloud-intelligence-dashboards@amazon.com](mailto:cloud-intelligence-dashboards@amazon.com "mailto:cloud-intelligence-dashboards@amazon.com")

## Cloud Intelligence Dashboards Customizations

Now that you have the Cloud Intelligence Dashboards deployed, you can
...
- [Organization (OU) integration](organization-integration.md "organization-integration.md")
- [Removing Discounts](remove-discount.md "remove-discount.md")
- [Publishing as single sign-on (SSO) Application](publishing-as-sso-application.md "publishing-as-sso-application.md")
- [Row Level Security](row-level-security.md "row-level-security.md")
- [SaaS Unit Metrics](saas-unit-metrics.md "saas-unit-metrics.md")
