...
![Allow Save as on CUDOS dashboard](images/qs_allow_save_as.png)
...
![Save icon on CUDOS dashboard](images/qs_save.png)

1. Click on **Save** icon and enter a name for Analysis, for example **CUDOS Analysis** and click on **Save** button

![Save Analysis prompt on CUDOS dashboard](images/cudos_analysis.png)
