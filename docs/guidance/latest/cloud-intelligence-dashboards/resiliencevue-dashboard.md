...
Get more familiar with the Dashboard using the live, interactive demo dashboard following this [link](https://cid.workshops.aws.dev/demo?dashboard=resiliencevue "https://cid.workshops.aws.dev/demo?dashboard=resiliencevue")
