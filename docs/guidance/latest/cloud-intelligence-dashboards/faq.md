...
| Data Collection Schedule     | Daily                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Up to 3 times a day, based on [CUR schedule](../../../cur/latest/userguide/what-is-cur.md "../../../cur/latest/userguide/what-is-cur.md")                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| Supported Aggregation Levels | Cluster:\* Cluster name\* Cluster ARNK8s constructs:\* Namespace\* Controller kind\* Controller name\* Deployment\* DaemonSet\* StatefulSet\* Job\* Pod name\* **Container name **\*Pod label** \*Node label **\*Pod Annotation\*Node:\***\* Node name\* Node instance ID\* **Node capacity type (On-Demand, Spot)** Node OS\* **Node architecture **\*Node’s node group** \*Node image (AMI ID)**\* **Karpenter provisioner name\*Other:\*\* Linked account ID\* Region code\* AZ | Cluster:\* Cluster type\* Cluster name\* Cluster ARNK8s constructs:\* Node name\* Namespace\* Controller kind\* Controller name\* Deployment\* ReplicaSet\* DaemonSet\* StatefulSet\* Job\* ReplicationController\* Pod name\* **Pod UID\*Amazon ECS:** Service\* Task IDAWS Batch:\* Compute environement\* Job definition name\* Job definition revision\* Job queueInstance:\* Instance ID\* **Purchase option (On-Demand, Spot, SP, RI) **\*Instance family\*\* **Instance type family\*\*** Instance type\* OSOther:\* Payer account ID**\***Linked account name\***\* Linked account ID** Region code\* AZ |
| K8s Labels Support           | Yes (requires user input)                                                                                                                                                                                                                                                                                                                                                                                                                                                          | No                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| K8s Node Labels Support      | Yes (requires user input)                                                                                                                                                                                                                                                                                                                                                                                                                                                          | No                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| K8s Annotations Support      | Yes (requires user input)                                                                                                                                                                                                                                                                                                                                                                                                                                                          | No                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | ###### Note This page is updated regularly with new answers. If you have a question you’d like answered here, please [reach out to us](feedback-support.md "feedback-support.md") |
