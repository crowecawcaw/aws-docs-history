...
<a name="kubecost-containers-dashboard"></a>
...
<a name="cids-containers-cost-allocation-dashboards-comparison"></a>
...
Please review the [Containers Cost Allocation dashboards comparison in the FAQs](faq.md#faq-scad-kubecost-dashboard-difference) for more information.
...
## Feedback & Support
<a name="kubecost-containers-dashboard-feedback-support"></a>
