...
You must be using the Data Collection framework version 3.14.4+ to enable the Granular Control capability. See [Update](data-collection-update.md "data-collection-update.md") for instructions on updating your deployment.
...
| ----------------------------------------------------------------------------- | ------------------------------------------------------- | ----------- |
| [Inclusion List](#inclusion-list "#inclusion-list")                           | Collect data only from specific accounts                | All modules |
...
2. Add deny rules for the specific accounts you want to exclude.
