...
# Update
<a name="data-collection-update"></a>

## Update Process
<a name="update-process"></a>

You can check the version of your existing Data Collection in the description of the CloudFormation stack. If it does not contain any version reference, then it is less than v3 and you need to [update from legacy versions](#data-collection-update-from-legacy-versions).
...
<a name="step-1-in-managementpayer-account-deploy-permissions-stack"></a>
...
<a name="step-2-in-data-collection-account-update-data-collection-stack"></a>
...
<a name="data-collection-update-from-legacy-versions"></a>

The Data Collection gets updated to increase performance and add the new data collection modules. If you already have this lab installed via Well Architected Labs site, you have a version 1 or 2. This update procedure will help you update both to the latest v3. You can check the description of Data Collection Stack. If the description of the stack does not contain a version (ex: 3.0.0).

Watch [demo of update process from legacy version to v3](https://www.youtube.com/watch?v=vpRNkwmuOEM) 

### Step 1. [In Management/Payer Account] Deploy permissions stack
<a name="step-1-in-managementpayer-account-deploy-permissions-stack-2"></a>

#### More
<a name="collapsible-section-id-data-collection-update-1"></a>
...
<a name="step-2-data-collection-account-update-data-collection-stack"></a>

#### More
<a name="collapsible-section-id-data-collection-update-2"></a>
...
<a name="step-3-in-data-collection-account-run-data-migration-script"></a>

#### More
<a name="collapsible-section-id-data-collection-update-3"></a>
...
<a name="step-4-in-managementpayer-account-clean-up"></a>

#### More
<a name="collapsible-section-id-data-collection-update-4"></a>
...
#### More
<a name="collapsible-section-id-data-collection-update-5"></a>
