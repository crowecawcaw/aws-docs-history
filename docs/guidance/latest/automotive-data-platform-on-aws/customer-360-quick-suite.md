...
![Quick Suite Dashboard - Executive Summary and Trends](images/quick-suite-dashboard1.jpg)

![Quick Suite Dashboard - Detailed Analytics](images/quick-suite-dashboard-2.jpg)
...
![Quick Suite Automate - Workflow Configuration](images/quick-suite-automate.jpg)
...
3. Configure daily trigger at 6 AM
4. Add Bedrock agent step for analysis
5. Add code block for criticality check
6. Add loop for case creation
7. Add approval task step
8. Add report generation step
...
![Quick Flows - Approval Process Configuration](images/quick-suite-flow.jpg)
...
4. Define trigger from automation
5. Add form inputs for review
6. Configure approval logic
...
![Quick Suite Reports - Metrics Dashboard](images/quick-suite-report.jpg)
