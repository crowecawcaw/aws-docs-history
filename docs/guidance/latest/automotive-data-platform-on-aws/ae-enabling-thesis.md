...
+  **Example 2** — a natural-language query interface for business executives ([Amazon Quick Suite](https://docs.aws.amazon.com/quicksuite/latest/userguide/) / [Quick Desktop](https://docs.aws.amazon.com/quick/latest/userguide/what-is-desktop.html)) that subscribes to ADP data products via Amazon DataZone and answers operational questions without writing a line of SQL. This is a pattern for business users who want self-service access to governed data.
