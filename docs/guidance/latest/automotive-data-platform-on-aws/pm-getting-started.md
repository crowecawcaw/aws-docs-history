...
For customers using the [CMS](../connected-mobility-on-aws/developer-guide.md "../connected-mobility-on-aws/developer-guide.md"), follow these steps to connect the tire prediction model to your CMS telemetry pipeline.
...
- The algorithm choice, per [Choosing an approach](pm-inference-strategy.md "pm-inference-strategy.md") above — RCF is not mandatory; pick based on whether you have labeled failure history
