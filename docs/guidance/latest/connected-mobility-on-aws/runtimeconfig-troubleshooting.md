...
2. Look for empty string values for any of these keys: `commandsApiEndpoint`, `dataProcessingApiEndpoint`, `simulationApiEndpoint`, `vsaApiEndpoint`. If a field is empty and the corresponding stack is deployed, the race condition occurred.
