...
After uninstalling the guidance, you must delete the retained buckets manually. For step-by-step instructions, see the [Uninstall the guidance](uninstall-the-solution.md "uninstall-the-solution.md") chapter.
