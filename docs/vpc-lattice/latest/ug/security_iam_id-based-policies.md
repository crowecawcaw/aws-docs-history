...
By default, users and roles don't have permission to create or modify VPC Lattice resources. To grant users permission to perform actions on the resources that they need, an IAM administrator can create IAM policies.
...
+ [Additional required permissions for full access](#security_iam_id-based-policy-additional-permissions)
+ [Identity-based policy examples for VPC Lattice](#security_iam_id-based-policy-examples)
...
**Topics**
+ [Example policy: Manage VPC associations to a service network](#security_iam_id-based-policy-examples-vpc-to-service-network-association)
+ [Example policy: Create service associations to a service network](#security_iam_id-based-policy-examples-service-to-service-network-association)
+ [Example policy: Add tags to resources](#security_iam_id-based-policy-examples-tag-resources)
+ [Example policy: Create a service-linked role](#security_iam_id-based-policy-examples-service-linked-role)
