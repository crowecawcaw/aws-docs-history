...
To monitor additional actions, use access logs. For more information, see [Access logs](monitoring-access-logs.md).
...
Amazon VPC Lattice logs VPC Lattice control plane operations as management events. For a list of the Amazon VPC Lattice control plane operations that VPC Lattice logs to CloudTrail, see the [Amazon VPC Lattice API Reference](https://docs.aws.amazon.com/vpc-lattice/latest/APIReference/).
...
The following example shows a CloudTrail event for the [CreateService](https://docs.aws.amazon.com/vpc-lattice/latest/APIReference/API_CreateService.html) operation.
...
The following example shows a CloudTrail event for the [DeleteService](https://docs.aws.amazon.com/vpc-lattice/latest/APIReference/API_DeleteService.html) operation.
