...
- [Create and verify a domain](create-and-verify.md "create-and-verify.md")
- [Create a resource
...
- You can verify your custom domain name using the domain name verification
  process in VPC Lattice. For more information For more information, see [Create and verify a domain](create-and-verify.md "create-and-verify.md").
