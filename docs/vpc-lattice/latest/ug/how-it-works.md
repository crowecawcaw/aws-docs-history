...
1. **Associate services with the service network**
...
1. **Create a resource configuration**
...
1. **Associate resource configurations with the service network**
