...
**Topics**
+ [Downloading and installing the Amazon Redshift ODBC driver](odbc-driver-windows-how-to-install.md)
+ [Creating a system DSN entry for an ODBC connection](create-dsn-odbc-windows.md)