...
| 21000      | Class 21 — Cardinality Violation                        | cardinality_violation                                | Data exceptions:                 |
| Error Code | Error Class                                             | Condition Name                                       |
| ---        | ---                                                     | ---                                                  |
...
| 22P05      | Class 01 — Warning                                      | untranslatable_character                             | Integrity constraint violations: |
| Error Code | Error Class                                             | Condition Name                                       |
| ---        | ---                                                     | ---                                                  |
