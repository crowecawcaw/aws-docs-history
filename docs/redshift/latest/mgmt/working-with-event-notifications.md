...
| Pending | REDSHIFT-EVENT-2025 | INFO | <br />Your database for cluster [cluster name] will be updated between [start time] and [end time]. Your cluster will not be accessible. Plan accordingly. | 
...
| Security | REDSHIFT-EVENT-4005 | ERROR | Cluster [cluster name] has invalid AWS KMS key permissions. Your cluster will enter an "INACCESSIBLE\_KMS\_KEY" state and you will no longer be able to access it. | 
