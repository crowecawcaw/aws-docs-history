...
+ If you're using a provisioned cluster, it must have the RG or RA3 node type. An Amazon Redshift Serverless workgroup works for setting up a VPC endpoint too. 
