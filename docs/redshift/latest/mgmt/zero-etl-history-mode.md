...
For information about what to consider when using history mode, see [Considerations when using history mode on the target](zero-etl.reqs-lims.md#zero-etl-considerations-history-mode "zero-etl.reqs-lims.md#zero-etl-considerations-history-mode").
