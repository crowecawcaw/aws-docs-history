...
You can query SYS\_ views in pg\_catalog schema to monitor query runtime in a Multi-AZ deployment. The SYS\_ views display query runtime activities or statistics from primary and secondary clusters. For a list of monitoring views, see [Monitoring views](https://docs.aws.amazon.com/redshift/latest/dg/serverless-monitoring.html).
