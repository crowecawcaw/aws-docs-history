...
For information about viewing the status of a destination database, see [Viewing zero-ETL integrations](zero-etl-using.describing.md "zero-etl-using.describing.md").
...
- For Aurora sources, see [Add
  data to the source DB cluster](../../../AmazonRDS/latest/AuroraUserGuide/zero-etl.querying.md#zero-etl.add-data-rds "../../../AmazonRDS/latest/AuroraUserGuide/zero-etl.querying.md#zero-etl.add-data-rds") in the
  _Amazon Aurora User Guide_.
- For Amazon RDS sources, see [Add data
  to the source DB instance](../../../AmazonRDS/latest/UserGuide/zero-etl.querying.md#zero-etl.add-data-rds "../../../AmazonRDS/latest/UserGuide/zero-etl.querying.md#zero-etl.add-data-rds") in the _Amazon RDS User Guide_.
