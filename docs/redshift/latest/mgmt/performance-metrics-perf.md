...
![An image of the CPU utilization graph in the Amazon Redshift console that shows the percentage of CPU utilization for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-cpu-utilization.png)
...
![An image of the graph in the Amazon Redshift console that shows whether maintenance mode is On or Off.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-maintenance-mode.png)
...
![An image of the graph in the Amazon Redshift console that shows the percentage of disk space used for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-percentage-disk-space-used.png)
...
![An image of the graph in the Amazon Redshift console that shows the read throughput for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-read-throughput.png)
...
![An image of the graph in the Amazon Redshift console that shows the read latency for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-read-latency.png)
...
![An image of the graph in the Amazon Redshift console that shows the write throughput for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-write-throughput.png)
...
![An image of the graph in the Amazon Redshift console that shows the write latency for each node.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-write-latency.png)
...
![Graph in the Amazon Redshift console that shows the number of database connections to a cluster.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-database-connections.png)
...
![An image of the graph in the Amazon Redshift console that shows the total table count for a cluster.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-total-table-count.png)
...
![An image of the graph in the Amazon Redshift console that shows the health status for a cluster.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-health-status.png)
...
![An image of the graph in the Amazon Redshift console that shows the query duration for a cluster.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-query-duration.png)
...
![An image of the graph in the Amazon Redshift console that shows the query throughput for a cluster.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-query-throughput.png)
...
![An image of the graph in the Amazon Redshift console that shows the query duration per WLM queue.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-query-duration-per-wlm-queue.png)
...
![An image of the graph in the Amazon Redshift console that shows the query throughput per WLM queue.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-query-throughput-per-wlm-queue.png)
...
![An image of the graph in the Amazon Redshift console that shows the number of active concurrency scaling clusters.](https://docs.aws.amazon.com/redshift/latest/mgmt/images/cluster-performance-concurrency-scaling-activity.png)