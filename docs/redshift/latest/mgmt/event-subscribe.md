...
created in the US East (N. Virginia) Region. For more information, see [Amazon Redshift provisioned cluster event notifications](working-with-event-notifications.md "working-with-event-notifications.md").
