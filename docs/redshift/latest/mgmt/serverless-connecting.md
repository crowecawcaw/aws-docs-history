...
For more information about configuring Redshift Serverless to use FIPS-compliant connections, see [use\_fips\_ssl](https://docs.aws.amazon.com/redshift/latest/dg/use_fips_ssl) in the *Amazon Redshift Database Developer Guide*.
