...
For a list of Amazon Redshift events by source type and category, see [Amazon Redshift provisioned cluster event notifications](working-with-event-notifications.md)