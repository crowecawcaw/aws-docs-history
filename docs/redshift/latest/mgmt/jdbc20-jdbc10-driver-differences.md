...
| ------------------- | ---------------------------------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ |
| 2.2                 | Redshift                           | 8.0.2                              |
| 1.x                 | PostgreSQL                         | 08.00.0002                         | The following table lists the DatabaseMetadata information returned by the getTypeInfo function for each version of the JDBC driver. |
| JDBC driver version | getTypeInfo result                 |                                    | ---                                                                                                                                  | ---                                  |
| 2.2                 | Consistent with Redshift datatypes |                                    | 1.x                                                                                                                                  | Consistent with PostgreSQL datatypes |
