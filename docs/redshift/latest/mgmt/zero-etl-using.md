...
[Zero-ETL integration event notifications with Amazon EventBridge](integration-event-notifications.md "integration-event-notifications.md"). The simplest way to create a subscription
...
- A destination database is the database that you create from a zero-ETL integration in the target
  ...
  [Monitoring zero-ETL integrations with Amazon Redshift system views](zero-etl-monitoring.md#zero-etl-monitoring-sysviews "zero-etl-monitoring.md#zero-etl-monitoring-sysviews").

For a list of AWS Regions that each source for zero-ETL integrations supports, see [Supported Regions for zero-ETL integrations](zero-etl-using.regions.md "zero-etl-using.regions.md").
...
- [Considerations when using zero-ETL integrations with Amazon Redshift](zero-etl.reqs-lims.md "zero-etl.reqs-lims.md")
- [Getting started with zero-ETL integrations](zero-etl-using.setting-up.md "zero-etl-using.setting-up.md")
- [Creating destination databases in Amazon Redshift](zero-etl-using.creating-db.md "zero-etl-using.creating-db.md")
- [Querying replicated data in Amazon Redshift](zero-etl-using.querying-and-creating-materialized-views.md "zero-etl-using.querying-and-creating-materialized-views.md")
- [Viewing zero-ETL integrations](zero-etl-using.describing.md "zero-etl-using.describing.md")
- [History mode](zero-etl-history-mode.md "zero-etl-history-mode.md")
- [Sharing your data in Amazon Redshift](zero-etl-using.share-data-redshift.md "zero-etl-using.share-data-redshift.md")
- [Monitoring zero-ETL integrations](zero-etl-monitoring.md "zero-etl-monitoring.md")
- [Metrics for zero-ETL integrations](zero-etl-using.metrics.md "zero-etl-using.metrics.md")
- [Modify a zero-ETL integration for DynamoDB](zero-etl-managing.modify-integration-ddb.md "zero-etl-managing.modify-integration-ddb.md")
- [Delete a zero-ETL integration for DynamoDB](zero-etl-managing.delete-integration-ddb.md "zero-etl-managing.delete-integration-ddb.md")
- [Supported Regions for zero-ETL integrations](zero-etl-using.regions.md "zero-etl-using.regions.md")
- [Troubleshooting zero-ETL integrations](zero-etl-using.troubleshooting.md "zero-etl-using.troubleshooting.md")
