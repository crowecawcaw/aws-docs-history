...
Amazon Redshift provides 64-bit ODBC drivers for Linux, Windows, and macOS operating
...
[Amazon Redshift ODBC driver release notes](https://s3.amazonaws.com/redshift-downloads/drivers/odbc/1.6.3.1008/Release+Notes.pdf "https://s3.amazonaws.com/redshift-downloads/drivers/odbc/1.6.3.1008/Release+Notes.pdf").
...
- [Using an Amazon Redshift ODBC driver on macOS](install-odbc-driver-mac.md "install-odbc-driver-mac.md")
