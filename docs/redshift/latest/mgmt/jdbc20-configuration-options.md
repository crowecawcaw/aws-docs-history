...
Following, you can find descriptions for the options that you can specify for version 2.x of the Amazon Redshift JDBC driver. Configuration options are not case sensitive.
...
+ [Idc\_Client\_Display\_Name](#jdbc20-idc_client_display_name)
+ [Idc\_Region](#jdbc20-idc_region)
+ [IdP\_Host](#jdbc20-idp_host-option)
+ [IdP\_Partition](#jdbc20-idp_partition-option)
...
+ [Issuer\_Url](#jdbc20-issuer-url)
+ [Listen\_Port](#jdbc20-listen-port)
...
When connecting using IAM authentication through an IDP, this is the username for the idp\_host server. When using standard authentication, this can be used for the Amazon Redshift database username. 
