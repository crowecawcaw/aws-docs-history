...
You can't use STL, SVCS, SVL, SVV, or STV views with Multi-AZ deployments because they only support system monitoring views (SYS\_\* views). Change your monitoring queries to use system monitoring views (SYS\_\* views).