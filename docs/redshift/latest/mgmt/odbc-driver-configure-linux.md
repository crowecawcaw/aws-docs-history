...
Amazon Redshift ODBC drivers, see [Using an Amazon Redshift ODBC driver on Linux](install-odbc-driver-linux.md "install-odbc-driver-linux.md") for Linux operating systems.
...
Machine" in the [Amazon Redshift ODBC connector installation and configuration guide](https://s3.amazonaws.com/redshift-downloads/drivers/odbc/1.6.3.1006/Amazon+Redshift+ODBC+Connector+Install+Guide.pdf "https://s3.amazonaws.com/redshift-downloads/drivers/odbc/1.6.3.1006/Amazon+Redshift+ODBC+Connector+Install+Guide.pdf").
