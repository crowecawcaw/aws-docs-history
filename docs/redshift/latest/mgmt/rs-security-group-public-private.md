...
1. Choose the **Protocol** and **Port** for the inbound rule, or rules, per your requirements, to allow traffic from clients. For an RG or RA3 cluster, select a port within the ranges 5431-5455 or 8191-8215. When you are finished, save each rule.
