...
<a name="r_datashare_break_glass_session_var"></a>

## Values (default in bold)
<a name="t_datashare_break_glass_session_var-values"></a>
...
## Description
<a name="datashare_break_glass_session_var-description"></a>
...
## Example
<a name="datashare_break_glass_session_var-example"></a>
