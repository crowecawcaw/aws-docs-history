...
The following examples use the sample TICKIT database. For more information on the sample database, go to [Sample database](c_sampledb.md).
...
To successfully run the previous query, use [SUBSTRING](https://docs.aws.amazon.com/redshift/latest/dg/r_SUBSTRING.html).
