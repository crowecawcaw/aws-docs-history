...
| privilege\_scope | text | The scope of the permission specified in privilege\_type. Possible values are as follows: + DATABASE<br />+ SCHEMAS<br />+ TABLES<br />+ FUNCTIONS<br />+ LANGUAGES For information on scoped permissions, go to [Scoped permissions](t_scoped-permissions.md).  | 
