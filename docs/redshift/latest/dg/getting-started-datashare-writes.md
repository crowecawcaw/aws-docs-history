...
**Topics**
+ [Connecting to a database in Amazon Redshift](connect-database-console-writes.md)
+ [Producer actions for new datashares in Amazon Redshift](writes-producer-new.md)
