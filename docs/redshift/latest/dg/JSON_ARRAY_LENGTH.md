...
Instead of using JSON\_ARRAY\_LENGTH, we recommend that you parse your JSON strings using the
[JSON\_PARSE function](JSON_PARSE.md "JSON_PARSE.md") to get a SUPER value. Then,
use the
[GET\_ARRAY\_LENGTH function](get_array_length.md "get_array_length.md") to
get the length of your array.

The JSON\_ARRAY\_LENGTH function returns the number of elements in the outer array of a
JSON string. If the _null\_if\_invalid_ argument is set to
