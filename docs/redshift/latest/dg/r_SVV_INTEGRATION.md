...
SVV\_INTEGRATION is visible only to superusers. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data).
...
| source | character(128) | The source data for the integration. Possible types include MySQL, PostgreSQL, and S3\_EVENT\_NOTIFICATIONS. | 
