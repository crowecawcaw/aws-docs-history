...
- [Sharing read access to data within an AWS account](within-account.md "within-account.md")
- [Working with views in Amazon Redshift data sharing](datashare-views.md "datashare-views.md")
- [Adding data lake tables to a datashare](create-datashare-external-views.md "create-datashare-external-views.md")
...
- [Getting started with AWS Lake Formation-managed datashares](lf-getting-started.md "lf-getting-started.md")
