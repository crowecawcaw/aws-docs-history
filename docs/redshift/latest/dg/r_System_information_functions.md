...
+ [CURRENT\_SESSION\_ARN](r_CURRENT_SESSION_ARN.md)
+ [CURRENT\_USER](r_CURRENT_USER.md)
+ [CURRENT\_USER\_ID](r_CURRENT_USER_ID.md)
+ [DB\_COLLATION](r_DB_COLLATION.md)
+ [DEFAULT\_IAM\_ROLE](r_DEFAULT_IAM_ROLE.md)
+ [GET\_MOUNTED\_ROLE](GET_MOUNTED_ROLE.md)
...
+ [LAST\_USER\_QUERY\_ID](LAST_USER_QUERY_ID.md)
...
+ [PG\_GET\_SESSION\_ROLES](PG_GET_SESSION_ROLES.md)
