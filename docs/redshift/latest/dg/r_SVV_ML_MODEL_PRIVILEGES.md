...
Use SVV\_ML\_MODEL\_PRIVILEGES to view the machine learning model permissions that are
...
| --------------- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| namespace\_name | text      | The name of the namespace where a specified<br>machine learning model exists.                                                                             |
