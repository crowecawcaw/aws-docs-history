...
# Using the SVL\_QUERY\_REPORT view

To analyze query summary information by slice using
[SVL\_QUERY\_REPORT](r_SVL_QUERY_REPORT.md "r_SVL_QUERY_REPORT.md"), do the following:
...
LIMIT clause used to make sure that your query is included. 2. Select rows from SVL\_QUERY\_REPORT for your query. Order the results by
segment, step, elapsed\_time, and rows:
