...
see TABLE PROPERTIES in [CREATE EXTERNAL TABLE](r_CREATE_EXTERNAL_TABLE.md "r_CREATE_EXTERNAL_TABLE.md"). For examples, see [Data handling examples](r_CREATE_EXTERNAL_TABLE_examples.md#r_CREATE_EXTERNAL_TABLE_examples-data-handling "r_CREATE_EXTERNAL_TABLE_examples.md#r_CREATE_EXTERNAL_TABLE_examples-data-handling"). For a list of errors,
see [SVL\_SPECTRUM\_SCAN\_ERROR](r_SVL_SPECTRUM_SCAN_ERROR.md "r_SVL_SPECTRUM_SCAN_ERROR.md").
...
- `surplus_char_handling` to specify input handling for surplus characters in columns containing VARCHAR, CHAR, and string data.
  You can set a configuration option to cancel queries that exceed a maximum number of errors. For more information, see [spectrum\_query\_maxerror](r_spectrum_query_maxerror.md "r_spectrum_query_maxerror.md").
