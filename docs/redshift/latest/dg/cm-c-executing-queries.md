...
To see the list of users that have been granted roles in the cluster, query the SVV\_USER\_GRANTS table. To see the list of roles that have been granted roles in the cluster, query the SVV\_ROLE\_GRANTS table.
