...
+  Query the STV\_DB\_ISOLATION\_LEVEL catalog view to view which isolation level your database is using. For more information, see [STV\_DB\_ISOLATION\_LEVEL](r_STV_DB_ISOLATION_LEVEL.md). 
+  Query the PG\_DATABASE\_INFO view to see how many concurrent transactions are supported for your database. For more information, see [PG\_DATABASE\_INFO](r_PG_DATABASE_INFO.md). 
