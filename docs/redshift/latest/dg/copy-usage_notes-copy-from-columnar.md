...
+ If the file you specify for the COPY operation includes one of the following extensions, Amazon Redshift decompresses the data without the need for adding any parameters: 
  + `.gz`
  + `.snappy`
  + `.bz2`
