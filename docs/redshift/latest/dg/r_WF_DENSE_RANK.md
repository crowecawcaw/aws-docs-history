...
The following examples use the sample table for window functions. For more information, see [Sample table for window function examples](c_Window_functions.md#r_Window_function_example).
