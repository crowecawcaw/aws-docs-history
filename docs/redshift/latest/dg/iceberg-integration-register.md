...
1.  Navigate to the serverless namespace or provisioned cluster that you want to register and select it.

1.  From the namespace or cluster’s details page, select **Register to AWS Glue Data Catalog** from the **Actions** drop-down menu. 

1.  Enter the destination account ID that you want to register the namespace or cluster to and choose **Register**. 

1.  If you’re registering from your account to the same account in AWS Glue, you’ll be taken directly to the AWS Lake Formation console to finish the process. If you’re registering to a different account, a link appears that takes you to Lake Formation. 
