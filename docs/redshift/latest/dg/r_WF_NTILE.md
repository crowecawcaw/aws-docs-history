...
number of ranked groups of as equal size as possible and returns the group that a given
row falls into.
...
tickets on August 26, 2008. The result set is 17 rows, divided almost evenly among
the rankings 1 through 4:
