...
To create a view in the Data Catalog, you must have a [ Spectrum external table](https://docs.aws.amazon.com/redshift/latest/dg/c-spectrum-external-tables.html), an object that’s contained within a [Lake Formation-managed datashare](https://docs.aws.amazon.com/redshift/latest/dg/what_is_datashare.html#lf_datashare_overview), or an [Apache Iceberg table](https://docs.aws.amazon.com/redshift/latest/dg/what_is_datashare.html#lf_datashare_overview).
...
When you use Amazon Redshift to run a query referencing such AWS Glue Data Catalog views, Amazon Redshift automatically masks fields in certain system table and view columns when logging metadata about that query. For more information, see [ Secure logging](https://docs.aws.amazon.com/redshift/latest/mgmt/db-auditing-secure-logging.html) in the *Amazon Redshift Management Guide*.
