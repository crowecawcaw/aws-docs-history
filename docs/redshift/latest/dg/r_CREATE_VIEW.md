...
For more information about valid names, see [Names and identifiers](r_names.md). You can't create tables or views in the system databases template0, template1, padb\_harvest, or sys:internal.
