...
+ [ACCESS\_KEY\_ID, SECRET\_ACCESS\_KEY](copy-parameters-authorization.md#copy-access-key-id-access)
...
+ [IAM\_ROLE](copy-parameters-authorization.md#copy-iam-role-iam)
...
+ [SESSION\_TOKEN](copy-parameters-authorization.md#copy-token)
