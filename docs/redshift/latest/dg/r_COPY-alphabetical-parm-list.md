...
- [ACCESS\_KEY\_ID, SECRET\_ACCESS\_KEY](copy-parameters-authorization.md#copy-access-key-id-access "copy-parameters-authorization.md#copy-access-key-id-access")
...
- [IAM\_ROLE](copy-parameters-authorization.md#copy-iam-role-iam "copy-parameters-authorization.md#copy-iam-role-iam")
...
- [MASTER\_SYMMETRIC\_KEY](copy-parameters-data-source-s3.md#copy-master-symmetric-key "copy-parameters-data-source-s3.md#copy-master-symmetric-key")
...
- [SESSION\_TOKEN](copy-parameters-authorization.md#copy-token "copy-parameters-authorization.md#copy-token")
