...
SVL\_USER\_INFO is visible only to superusers. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data "cm_chap_system-tables.md#c_visibility-of-data").
...
| last\_ddl\_ts  | timestamp | The timestamp for the last data definition<br>language (DDL) create statement run by the user.                                                                                                                                                                                                                                                                                           |
