...
The delimiter string indicating sections of the input _string_.

If _delimiter_ is a literal, enclose it in single quotation marks.
...
A CHAR or VARCHAR string, the same as the _string_ parameter.
...
The following example splits the timestamp field LISTTIME into year, month, and
day components.
