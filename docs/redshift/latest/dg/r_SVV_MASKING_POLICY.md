...
Only superusers and users with the [`sys:secadmin`](https://docs.aws.amazon.com/redshift/latest/dg/r_roles-default.html) role can view SVV\_MASKING\_POLICY. Regular users will see 0 rows.
