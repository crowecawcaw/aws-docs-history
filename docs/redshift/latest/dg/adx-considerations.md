...
+ Both producers and consumers must use the RG or RA3 instance types to use Amazon Redshift datashares. Producers must use the RG or RA3 instance types with the latest Amazon Redshift cluster version.
