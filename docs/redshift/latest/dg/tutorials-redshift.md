...
| [Tutorial: Querying nested data with Amazon Redshift Spectrum](tutorial-query-nested-data.md) |  In this tutorial, you use Redshift Spectrum to query nested data. With Redshift Spectrum, you can query data in Parquet, ORC, JSON, or Ion file formats. | 
