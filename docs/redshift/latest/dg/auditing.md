...
With Amazon Redshift, you can monitor and audit data sharing activities to maintain compliance and security.
...
1. The consumer administrators look at the datashares for which they're granted use and review the contents of each datashare by viewing inbound datashares using [SVV\_DATASHARES](r_SVV_DATASHARES.md). 
