...
queries, query the [SVL\_S3LOG](r_SVL_S3LOG.md "r_SVL_S3LOG.md") system
table.
...
the [SVV\_EXTERNAL\_PARTITIONS](r_SVV_EXTERNAL_PARTITIONS.md "r_SVV_EXTERNAL_PARTITIONS.md") view to find existing partitions. Run `ALTER TABLE … ADD PARTITION` for each missing
partition.
...
the complete error message, including column name and column type, query the [SVL\_S3LOG](r_SVL_S3LOG.md "r_SVL_S3LOG.md") system view.
...
- Values
  You can query [SVV\_EXTERNAL\_PARTITIONS](r_SVV_EXTERNAL_PARTITIONS.md "r_SVV_EXTERNAL_PARTITIONS.md")
