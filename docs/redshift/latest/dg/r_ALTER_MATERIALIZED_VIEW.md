...
To view the distribution style of a relation, query the SVV\_TABLE\_INFO system catalog view. For more information, go to [SVV\_TABLE\_INFO](r_SVV_TABLE_INFO.md). To view the Amazon Redshift Advisor recommendations for relations, query the SVV\_ALTER\_TABLE\_RECOMMENDATIONS system catalog view. For more information, go to [SVV\_ALTER\_TABLE\_RECOMMENDATIONS](r_SVV_ALTER_TABLE_RECOMMENDATIONS.md). To view the actions taken by Amazon Redshift, query the SVL\_AUTO\_WORKER\_ACTION system catalog view. For more information, go to [SVL\_AUTO\_WORKER\_ACTION](r_SVL_AUTO_WORKER_ACTION.md). 
...
To view the sort key of a relation, query the SVV\_TABLE\_INFO system catalog view. For more information, go to [SVV\_TABLE\_INFO](r_SVV_TABLE_INFO.md). To view the Amazon Redshift Advisor recommendations for relations, query the SVV\_ALTER\_TABLE\_RECOMMENDATIONS system catalog view. For more information, go to [SVV\_ALTER\_TABLE\_RECOMMENDATIONS](r_SVV_ALTER_TABLE_RECOMMENDATIONS.md). To view the actions taken by Amazon Redshift, query the SVL\_AUTO\_WORKER\_ACTION system catalog view. For more information, go to [SVL\_AUTO\_WORKER\_ACTION](r_SVL_AUTO_WORKER_ACTION.md). 
