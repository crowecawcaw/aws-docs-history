...
- For examples of formatting strings as numbers, see [TO\_NUMBER](r_TO_NUMBER.md "r_TO_NUMBER.md").
- For examples of formatting numbers as strings, see [TO\_CHAR](r_TO_CHAR.md "r_TO_CHAR.md").
...
| CC            | Century code. For example, the 21st century started on<br>2001-01-01 (supported for TO\_CHAR only). |
...
| RN            | Roman numeral between 1 and 3999 (supported for TO\_CHAR<br>only).                                  |
