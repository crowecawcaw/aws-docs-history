...
The format for the new value. For valid formats, see [Datetime format strings](r_FORMAT_strings.md "r_FORMAT_strings.md") and [Numeric format strings](r_Numeric_formating.md "r_Numeric_formating.md").
...
The following example converts a timestamp to a value with the date and time in a format with the name of the month padded to nine characters,
the name of the day of the week, and the day number of the month.
