...
**Topics**
+ [Set up authentication](#materialized-view-streaming-ingestion-getting-started-MSK-setup-auth)
+ [Setting up your VPC](#materialized-view-streaming-ingestion-getting-started-MSK-Setup-VPC)
+ [Create a Materialized View](#materialized-view-streaming-ingestion-getting-started-MSK-setup-materialized-view)
