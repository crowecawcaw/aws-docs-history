...
- [Load data in sequential blocks](c_best-practices-load-data-in-sequential-blocks.md "c_best-practices-load-data-in-sequential-blocks.md")
- [Use time-series tables](c_best-practices-time-series-tables.md "c_best-practices-time-series-tables.md")
- [Schedule around maintenance windows](c_best-practices-avoid-maintenance.md "c_best-practices-avoid-maintenance.md")
