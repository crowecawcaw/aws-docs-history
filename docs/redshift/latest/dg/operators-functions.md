...
+ ARRAY\_CONCAT. For more information, see [ARRAY\_CONCAT function](r_array_concat.md).
+ ARRAY\_CONTAINS. For more information, see [ARRAY\_CONTAINS function](array_contains.md).
+ ARRAY\_DISTINCT. For more information, see [ARRAY\_DISTINCT function](array_distinct.md).
+ ARRAY\_EXCEPT. For more information, see [ARRAY\_EXCEPT function](array_except.md).
+ ARRAY\_FLATTEN. For more information, see [ARRAY\_FLATTEN function](array_flatten.md).
+ ARRAY\_INTERSECTION. For more information, see [ARRAY\_INTERSECTION function](array_intersection.md).
+ ARRAY\_POSITION. For more information, see [ARRAY\_POSITION function](array_position.md).
+ ARRAY\_POSITIONS. For more information, see [ARRAY\_POSITIONS function](array_positions.md).
+ ARRAY\_SORT. For more information, see [ARRAY\_SORT function](array_sort.md).
+ ARRAY\_UNION. For more information, see [ARRAY\_UNION function](array_union.md).
+ ARRAYS\_OVERLAP. For more information, see [ARRAYS\_OVERLAP function](arrays_overlap.md).
+ GET\_ARRAY\_LENGTH. For more information, see [GET\_ARRAY\_LENGTH function](get_array_length.md).
+ SPLIT\_TO\_ARRAY. For more information, see [SPLIT\_TO\_ARRAY function](split_to_array.md).
...
With SUPER, you can set the collation of a column with [CREATE TABLE](https://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_TABLE_NEW.html), take the default collation set with [CREATE DATABASE](https://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_DATABASE.html), and set the collation of an expression with the [COLLATE function](https://docs.aws.amazon.com/redshift/latest/dg/r_COLLATE.html).
...
+ [GET\_NUMBER\_ATTRIBUTES function](get_number_attributes.md)
+ [LOWER\_ATTRIBUTE\_NAMES function](r_lower_attribute_names.md)
