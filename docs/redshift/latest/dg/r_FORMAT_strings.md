...
| D  | Day of week (1–7; Sunday is 1)  The D datepart behaves differently from the day of week (DOW) datepart used for the datetime functions DATE\_PART and EXTRACT. DOW is based on integers 0–6, where Sunday is 0. For more information, see [Date parts for date or timestamp functions](r_Dateparts_for_datetime_functions.md).   | 
