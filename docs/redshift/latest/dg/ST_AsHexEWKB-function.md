...
ST\_AsHexEWKB returns the extended well-known binary (EWKB) representation of an input geometry or geography using ASCII hexadecimal characters (0–9, A–F).
For 3DZ, 3DM, and 4D geometries or geographies, ST\_AsHexEWKB uses the PostGIS extended WKB value for the geometry or geography type.
