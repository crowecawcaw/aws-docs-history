...
**Topics**
+ [SVV\_ACTIVE\_CURSORS](r_SVV_ACTIVE_CURSORS.md)
...
+ [SVV\_COPY\_JOB\_INTEGRATIONS](SVV_COPY_JOB_INTEGRATIONS.md)
...
+ [SVV\_GEOGRAPHY\_COLUMNS](r_SVV_GEOGRAPHY_COLUMNS.md)
+ [SVV\_GEOMETRY\_COLUMNS](r_SVV_GEOMETRY_COLUMNS.md)
+ [SVV\_IAM\_PRIVILEGES](r_SVV_IAM_PRIVILEGES.md)
+ [SVV\_IDENTITY\_PROVIDERS](r_SVV_IDENTITY_PROVIDERS.md)
+ [SVV\_INTEGRATION](r_SVV_INTEGRATION.md)
+ [SVV\_INTEGRATION\_TABLE\_MAPPING](r_SVV_INTEGRATION_TABLE_MAPPING.md)
+ [SVV\_INTEGRATION\_TABLE\_STATE](r_SVV_INTEGRATION_TABLE_STATE.md)
...
+ [SVV\_ML\_MODEL\_INFO](r_SVV_ML_MODEL_INFO.md)
+ [SVV\_ML\_MODEL\_PRIVILEGES](r_SVV_ML_MODEL_PRIVILEGES.md)
+ [SVV\_MV\_DEPENDENCY](r_SVV_MV_DEPENDENCY.md)
+ [SVV\_MV\_INFO](r_SVV_MV_INFO.md)
...
+ [SVV\_REDSHIFT\_SCHEMA\_QUOTA](r_SVV_REDSHIFT_SCHEMA_QUOTA.md)
...
+ [SVV\_USER\_INFO](r_SVV_USER_INFO.md)
