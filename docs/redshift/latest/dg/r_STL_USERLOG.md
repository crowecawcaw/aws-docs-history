...
- Alter user (alter properties)
  STL\_USERLOG is visible only to superusers. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data "cm_chap_system-tables.md#c_visibility-of-data").

Some or all of the data in this table can also be found in the SYS monitoring view [SYS\_USERLOG](SYS_USERLOG.md "SYS_USERLOG.md"). The data in the SYS monitoring view is formatted to be easier to use and understand.
...
The following example performs four user actions, then queries the STL\_USERLOG
view.
