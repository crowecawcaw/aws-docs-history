...
| preferred\_diskno | integer   | Disk number that the block should be on, unless<br>the disk has failed. Once the disk has been fixed, the block will<br>move back to this disk.                                                                                                                                                                                                                                                                |
