...
UPPER\_ATTRIBUTE\_NAMES supports UTF-8 multibyte characters, up to a maximum of
four bytes per character.

To convert SUPER attribute names to lowercase, use the [LOWER\_ATTRIBUTE\_NAMES function](r_lower_attribute_names.md "r_lower_attribute_names.md").
