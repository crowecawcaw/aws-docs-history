...
SVV\_RLS\_RELATION is visible to all users. Superusers can see all rows; regular users can see only their own data. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data "cm_chap_system-tables.md#c_visibility-of-data").
...
| is\_rls\_on                       | boolean      | The parameter that indicates whether the relation<br>is RLS-protected.                                 |
