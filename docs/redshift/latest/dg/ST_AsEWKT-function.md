...
ST\_AsEWKT returns the extended well-known text (EWKT) representation of an input geometry or geography.
For 3DZ, 3DM, and 4D geometries, ST\_AsEWKT appends Z, M, or ZM to the WKT value for the geometry type.
