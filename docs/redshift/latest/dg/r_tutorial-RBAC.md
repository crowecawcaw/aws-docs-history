...
1. To create the sales\_ro role, use the following example.
...
1. To grant the sales\_ro role usage and select access to objects of the sales schema, use the following example.
...
1. To grant the salesanalyst user the sales\_ro role, use the following example.
...
1. To create the sales\_rw role in the sales schema, use the following example.
...
1. To grant the sales\_rw role usage and select access to objects of the sales schema by assigning the sales\_ro role to it, use the following example. For more information on how roles inherit permissions in Amazon Redshift, see [Role hierarchy](t_role_hierarchy.md).

   ```
   GRANT ROLE sales_ro TO ROLE sales_rw;
   ```

1. To assign the sales\_rw role to the salesengineer user, use the following example.
...
1. To grant UPDATE, INSERT, and DELETE permissions to the sales\_rw role, use the following example.
...
1. To grant truncate table privileges to the sales\_rw role, use the following example.
...
1. To check if the sales\_rw role is a member of the sales\_ro role, use the following example.
...
1. To check if the sales\_ro role is a member of the sales\_rw role, use the following example.
