...
information, see [Load data in sequential blocks](c_best-practices-load-data-in-sequential-blocks.md "c_best-practices-load-data-in-sequential-blocks.md") and [Vacuuming tables](t_Reclaiming_storage_space202.md "t_Reclaiming_storage_space202.md").
