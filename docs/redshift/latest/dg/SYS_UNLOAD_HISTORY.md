...
Use SYS\_UNLOAD\_HISTORY to view details of UNLOAD commands. Each row represents a
UNLOAD command with accumulated statistics for some of the fields. It contains both
running and finished UNLOAD commands.

SYS\_UNLOAD\_HISTORY is visible to all users. Superusers can see all rows; regular users can see only their own data. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data "cm_chap_system-tables.md#c_visibility-of-data").
...
| query\_id              | bigint    | The query identifier of the UNLOAD<br>command.                                                                  |
| transaction\_id        | bigint    | The transaction identifier.                                                                                     |
| session\_id            | integer   | The process identifier of the process running the<br>unload.                                                    |
