...
The date part to which to truncate the timestamp value.
The input _timestamp_ is truncated to the precision of the input _datepart_.
For example, `month` truncates to the first day of the month.
