...
Query STL\_LOADERROR\_DETAIL for additional details, such as the exact data row and
column where a parse error occurred, after you query [STL\_LOAD\_ERRORS](r_STL_LOAD_ERRORS.md "r_STL_LOAD_ERRORS.md") to find out general information about the
error.

The STL\_LOADERROR\_DETAIL view contains all data columns including and prior to the
...
STL\_LOADERROR\_DETAIL only contains queries run on main provisioned clusters. It doesn't contain queries run on concurrency scaling clusters
...
| line\_number | bigint          | Line number in the load file with the error.                                                                                                                                                                |
...
| is\_null     | integer         | Whether or not the parsed value is null.                                                                                                                                                                    |
...
When a query joins STL\_LOAD\_ERRORS and STL\_LOADERROR\_DETAIL, it displays an error
