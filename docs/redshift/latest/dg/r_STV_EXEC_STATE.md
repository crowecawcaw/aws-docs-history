...
| is_delayed_scan | char(1)   | If true (`t`), indicates that delayed scan was used on the step. Default is false (`f`).                                                                                                                                                                                            | ## Sample queries Rather than querying STV_EXEC_STATE directly, Amazon Redshift recommends querying SVL_QUERY_SUMMARY or SVV_QUERY_STATE to obtain the information in STV_EXEC_STATE in a more user-friendly format. See the [SVL_QUERY_SUMMARY](r_SVL_QUERY_SUMMARY.md "r_SVL_QUERY_SUMMARY.md") or [SVV_QUERY_STATE](r_SVV_QUERY_STATE.md "r_SVV_QUERY_STATE.md") table documentation for more details. |
