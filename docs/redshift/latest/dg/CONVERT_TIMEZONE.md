...
Time zone abbreviations represent a fixed offset from UTC. If you specify a time zone using a time zone abbreviation, CONVERT\_TIMEZONE uses the fixed offset from UTC and doesn't adjust for any local seasonal protocol.
