...
**Time zone name** – The full time zone name, such as America/New\_York. Full time zone names can include daylight savings rules. Note that Amazon Redshift uses the [IANA Time Zone Database](https://www.iana.org/time-zones) as the authoritative source of time zone specification.
