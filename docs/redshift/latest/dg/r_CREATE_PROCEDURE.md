...
If a stored procedure was created using the SECURITY DEFINER option, when invoking the CURRENT\_USER function from within the stored procedure, Amazon Redshift returns the user name of the owner of the stored procedure.
