...
Use SVV\_GEOGRAPHY\_COLUMNS to view the list of GEOGRAPHY columns in your data warehouse.
This list of columns includes columns from datashares.

SVV\_GEOGRAPHY\_COLUMNS is visible to all users. Superusers can see all rows; regular users can see only their own data. For more information, see [Visibility of data in system tables and views](cm_chap_system-tables.md#c_visibility-of-data "cm_chap_system-tables.md#c_visibility-of-data").
