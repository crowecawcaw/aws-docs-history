...
**Topics**
+ [Copying data from JSON and Avro](#copy_json-from-JSON)
+ [Copying data from text and CSV](#copy_json-from-text-csv)
+ [Copying data from columnar-format Parquet and ORC](#copy_json-from-parquet-orc)
...
1. Map the root jsonpath "$" to the root of the document as follows:
