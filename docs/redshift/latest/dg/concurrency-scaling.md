...
+ Amazon Redshift supports concurrency scaling for write operations on only Amazon Redshift RG and RA3 nodes. Concurrency scaling for write operations isn't supported on other node types.
