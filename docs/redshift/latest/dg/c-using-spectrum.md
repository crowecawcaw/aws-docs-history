...
- [Amazon Redshift Spectrum query performance](c-spectrum-external-performance.md "c-spectrum-external-performance.md")
...
- [Query troubleshooting in Amazon Redshift Spectrum](c-spectrum-troubleshooting.md "c-spectrum-troubleshooting.md")
- [Tutorial: Querying nested data with Amazon Redshift Spectrum](tutorial-query-nested-data.md "tutorial-query-nested-data.md")
