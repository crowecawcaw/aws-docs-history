...
For information about selecting the last row in the frame, see [LAST\_VALUE window function](r_WF_last_value.md) .
...
The following examples use the VENUE table from the sample TICKIT data. For more information, see [Sample database](c_sampledb.md).
