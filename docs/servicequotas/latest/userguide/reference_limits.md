...
| Active service quota increase requests per resource                                              | 1     | API request rates                        | Quota | Default |
| ---                                                                                              | ---   |
...
| `UntagResource` requests per second sent in one burst                                            | 10    | Quota request template API request rates | Quota | Default |
| ---                                                                                              | ---   |
...
| Additional `PutServiceQuotaIncreaseRequestIntoTemplate` per second sent in one burst             | 1     | Overall API request rate                 | Quota | Default |
| ---                                                                                              | ---   |
