...
Service Quotas and your other AWS solutions. AWS provides the following monitoring tools to
watch Service Quotas, report when something is wrong, and take automatic actions when
appropriate:
