...
applies to data protection in Service Quotas. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Service Quotas or other AWS services
...
Customer requests and all associated data is encrypted in transit using [Transport Later Security (TLS)](https://datatracker.ietf.org/doc/html/rfc5246 "https://datatracker.ietf.org/doc/html/rfc5246") 1.2 or later.
All Service Quotas endpoints support HTTPS for encrypting data in transit.
