...
- [cfn-init](cfn-init.md "cfn-init.md") – Use to retrieve and
  interpret resource metadata, install packages, create files, and start services.
- [cfn-signal](cfn-signal.md "cfn-signal.md") – Use to signal with a
  ...
  ready.
- [cfn-get-metadata](cfn-get-metadata.md "cfn-get-metadata.md") – Use to
  retrieve metadata for a resource or path to a specific key.
- [cfn-hup](cfn-hup.md "cfn-hup.md") – Use to check for updates to
