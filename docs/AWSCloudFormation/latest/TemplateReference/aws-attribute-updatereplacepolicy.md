...
stack resources](../UserGuide/using-cfn-updating-stacks-update-behaviors.md "../UserGuide/using-cfn-updating-stacks-update-behaviors.md") in the _AWS CloudFormation User Guide_.
...
if you update the `Engine` property of an [AWS::RDS::DBInstance](aws-properties-rds-database-instance.md "aws-properties-rds-database-instance.md")
...
resource in the [AWS resource and property types reference](aws-template-resource-type-ref.md "aws-template-resource-type-ref.md").

The `UpdateReplacePolicy` attribute applies to [stack updates you perform
directly](../UserGuide/using-cfn-updating-stacks-direct.md "../UserGuide/using-cfn-updating-stacks-direct.md"), in addition to stack updates performed using [change
sets](../UserGuide/using-cfn-updating-stacks-changesets.md "../UserGuide/using-cfn-updating-stacks-changesets.md").
...
`UpdateReplacePolicy` differs from the [DeletionPolicy](aws-attribute-deletionpolicy.md "aws-attribute-deletionpolicy.md") attribute in that it only applies to resources
