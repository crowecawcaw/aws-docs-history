...
The template developer uses the CloudFormation resource, [AWS::CloudFormation::CustomResource](../TemplateReference/aws-resource-cloudformation-customresource.md "../TemplateReference/aws-resource-cloudformation-customresource.md"), to specify a custom
...
_Required_: Always sent with `Update` and `Delete`
