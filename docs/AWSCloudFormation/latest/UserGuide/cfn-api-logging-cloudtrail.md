...
All CloudFormation actions are logged by CloudTrail and are documented in the [_AWS CloudFormation API Reference_](../APIReference/API_Operations.md "../APIReference/API_Operations.md"). For
