...
You start by defining a [AWS::CloudFormation::WaitConditionHandle](../TemplateReference/aws-resource-cloudformation-waitconditionhandle.md "../TemplateReference/aws-resource-cloudformation-waitconditionhandle.md") resource in
...
Next, you define an [AWS::CloudFormation::WaitCondition](../TemplateReference/aws-resource-cloudformation-waitcondition.md "../TemplateReference/aws-resource-cloudformation-waitcondition.md") resource in the
...
condition. For more information, see [DependsOn attribute](../TemplateReference/aws-attribute-dependson.md "../TemplateReference/aws-attribute-dependson.md").
...
displayed as the physical ID of the wait condition handle resource. 2. (Optional) To detect when the stack enters the wait condition, you can use one
...
You can then view this data using the [describe-stacks](../../../cli/latest/reference/cloudformation/describe-stacks.md "../../../cli/latest/reference/cloudformation/describe-stacks.md") command, or the
