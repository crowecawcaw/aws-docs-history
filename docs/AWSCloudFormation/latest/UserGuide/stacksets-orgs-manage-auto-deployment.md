...
1. Use the [update-stack-set](../../../cli/latest/reference/cloudformation/update-stack-set.md "../../../cli/latest/reference/cloudformation/update-stack-set.md") command with the
...
2. Using the operation ID that was returned as part of the
   **update-stack-set** output, run [describe-stack-set-operation](../../../cli/latest/reference/cloudformation/describe-stack-set-operation.md "../../../cli/latest/reference/cloudformation/describe-stack-set-operation.md") to verify that
