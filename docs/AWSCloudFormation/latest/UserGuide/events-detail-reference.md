...
definitions of these general fields, see [AWS service event metadata](../../../eventbridge/latest/ref/events-structure.md "../../../eventbridge/latest/ref/events-structure.md") in the _AWS Events Reference_.
