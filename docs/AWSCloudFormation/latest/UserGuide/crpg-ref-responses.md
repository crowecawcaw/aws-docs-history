...
presigned URLs, see [Uploading objects with presigned URLs](../../../AmazonS3/latest/userguide/PresignedUrlUploadObject.md "../../../AmazonS3/latest/userguide/PresignedUrlUploadObject.md") in the _Amazon Simple Storage Service User Guide_.
...
_Required_: Required if `Status` is `FAILED`. It's
optional otherwise.
