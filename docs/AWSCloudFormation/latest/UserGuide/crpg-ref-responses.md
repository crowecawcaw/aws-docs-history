...
The following are properties that the custom resource provider includes when it sends
 ...
 presigned URLs, see [Uploading objects with presigned URLs](https://docs.aws.amazon.com/AmazonS3/latest/userguide/PresignedUrlUploadObject.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/PresignedUrlUploadObject.html") in the *Amazon Simple Storage Service User Guide*.
