...
[Intrinsic function reference](../TemplateReference/intrinsic-function-reference.md "../TemplateReference/intrinsic-function-reference.md").
...
section. 4. Change the value of the **InstanceType** text box from
`t1.micro` to `m1.small`. Then, choose
**Next**. 5. On the **Options** screen, choose **Next**. 6. Choose **Next** because the stack doesn't have a stack policy. All
resources can be updated without an overriding policy. 7. On the **Review** screen, verify that all the settings are as you
want them, and then choose **Update**.
...
3. Update the stack, either from the AWS Management Console as explained
   ...
   using the AWS command [update-stack](../../../cli/latest/reference/cloudformation/update-stack.md "../../../cli/latest/reference/cloudformation/update-stack.md").
...
4. Update the stack, either from the AWS Management Console as explained in [Update the application](#update.application "#update.application") or by using
   the AWS command [update-stack](../../../cli/latest/reference/cloudformation/update-stack.md "../../../cli/latest/reference/cloudformation/update-stack.md").
