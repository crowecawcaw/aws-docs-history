...
- AWS Command Line Interface – Provides commands for a broad set of
  ...
  information about the CloudFormation commands, see [cloudformation](../../../cli/latest/reference/cloudformation.md "../../../cli/latest/reference/cloudformation.md") in the
...
- AWS Tools for PowerShell – A set of PowerShell modules that
  ...
  cmdlets for CloudFormation in the [AWS Tools for PowerShell Cmdlet Reference](../../../powershell/latest/reference/Index.md "../../../powershell/latest/reference/Index.md").
