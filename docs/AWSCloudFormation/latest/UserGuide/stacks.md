...
**Express mode** lets you complete stack operations as soon as resource configuration is applied, without waiting for resources to reach a fully stabilized state. Use express mode during iterative development workflows when speed is more important than full resource stabilization. For more information, see [Express mode](cloudformation-express-mode.md).
...
+ [Validate stack deployments](validate-stack-deployments.md)
