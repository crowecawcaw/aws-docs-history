...
auto scaling resources as part of your infrastructure using AWS CloudFormation templates. Templates make it
easy to manage and automate the deployment of auto scaling resources in a repeatable and
consistent manner.

The following example template snippets describe AWS CloudFormation resources or components for Amazon EC2 Auto Scaling
...
- [Configure Amazon EC2 Auto Scaling
  resources](quickref-ec2-auto-scaling.md "quickref-ec2-auto-scaling.md")
- [Configure Application Auto Scaling
  resources](quickref-application-auto-scaling.md "quickref-application-auto-scaling.md")
