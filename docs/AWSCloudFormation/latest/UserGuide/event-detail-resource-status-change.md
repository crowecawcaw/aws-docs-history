...
{
  . . .,
  "[detail-type](#resource-status-change-detail-type "#resource-status-change-detail-type")": "CloudFormation Resource Status Change",
  "[source](#resource-status-change-source "#resource-status-change-source")": "aws.cloudformation",
  . . .,
  "[detail](#resource-status-change-detail "#resource-status-change-detail")": {
    "[stack-id](#resource-status-change-stack-id "#resource-status-change-stack-id")" : "string",
    "[logical-resource-id](#resource-status-change-logical-resource-id "#resource-status-change-logical-resource-id")" : "string",
    "[physical-resource-id](#resource-status-change-physical-resource-id "#resource-status-change-physical-resource-id")": "string",
    "[status-details](#resource-status-change-status-details "#resource-status-change-status-details")": {
        "[status](#resource-status-change-status "#resource-status-change-status")": "string",
        "[status-reason](#resource-status-change-status-reason "#resource-status-change-status-reason")": "string"
    },
     "[resource-type](#resource-status-change-resource-type "#resource-status-change-resource-type")": "string",
     "[client-request-token](#resource-status-change-client-request-token "#resource-status-change-client-request-token")": "string"
  }
}
```
