...
- Run the [execute-change-set](../../../cli/latest/reference/cloudformation/execute-change-set.md "../../../cli/latest/reference/cloudformation/execute-change-set.md") command.
