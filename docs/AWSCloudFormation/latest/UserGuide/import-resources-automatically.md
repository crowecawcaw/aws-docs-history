...
You can now import *named resources* automatically when creating or
 updating CloudFormation stacks. A *named resource* is one with a custom name. For
 more information, see [Name type](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-name.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-properties-name.html") in the
