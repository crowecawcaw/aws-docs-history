...
{
  . . .,
  "[detail-type](#drift-detection-status-change-detail-type "#drift-detection-status-change-detail-type")":"CloudFormation Drift Detection Status Change",
  "[source](#drift-detection-status-change-source "#drift-detection-status-change-source")":"aws.cloudformation",
  . . .,
  "[detail](#drift-detection-status-change-detail "#drift-detection-status-change-detail")":{
    "[stack-id](#drift-detection-status-change-stack-id "#drift-detection-status-change-stack-id")":"string",
    "[stack-drift-detection-id](#drift-detection-status-change-stack-drift-detection-id "#drift-detection-status-change-stack-drift-detection-id")":"string",
    "[status-details](#drift-detection-status-change-status-details "#drift-detection-status-change-status-details")":{
      "[stack-drift-status](#drift-detection-status-change-stack-drift-status "#drift-detection-status-change-stack-drift-status")":"string",
      "[detection-status](#drift-detection-status-change-detection-status "#drift-detection-status-change-detection-status")":"string"
    },
      "[drift-detection-details](#drift-detection-status-change-drift-detection-details "#drift-detection-status-change-drift-detection-details")":{
        "[drifted-stack-resource-count](#drift-detection-status-change-drifted-stack-resource-count "#drift-detection-status-change-drifted-stack-resource-count")":integer
      },
    "[client-request-token](#drift-detection-status-change-client-request-token "#drift-detection-status-change-client-request-token")":"string"
  }
}
```
