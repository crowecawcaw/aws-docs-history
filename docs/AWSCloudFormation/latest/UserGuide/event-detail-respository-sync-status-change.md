...
{
  . . .,
  "[detail-type](#respository-sync-status-change-detail-type "#respository-sync-status-change-detail-type")": "Git Sync Repository Sync Status Change",
  "[source](#respository-sync-status-change-source "#respository-sync-status-change-source")": "aws.codeconnections",
  . . .,
  "[detail](#respository-sync-status-change-detail "#respository-sync-status-change-detail")": {
    "[connectionArn](#respository-sync-status-change-connection-arn "#respository-sync-status-change-connection-arn")" : "string",
    "[providerType](#respository-sync-status-change-provider-type "#respository-sync-status-change-provider-type")" : "string",
    "[repositoryName](#respository-sync-status-change-repository-name "#respository-sync-status-change-repository-name")": "string",
    "[providerType](#respository-sync-status-change-provider-type "#respository-sync-status-change-provider-type")": "string",
    "[repositoryName](#respository-sync-status-change-repository-name "#respository-sync-status-change-repository-name")": "string",
    "[repositoryArn](#respository-sync-status-change-repository-arn "#respository-sync-status-change-repository-arn")": "string",
    "[repositoryLinkId](#respository-sync-status-change-repository-link-id "#respository-sync-status-change-repository-link-id")": "string",
    "[ownerId](#respository-sync-status-change-owner-id "#respository-sync-status-change-owner-id")": "string",
    "[commit](#respository-sync-status-change-commit "#respository-sync-status-change-commit")": "string",
    "[branch](#respository-sync-status-change-branch "#respository-sync-status-change-branch")": "string",
    "[syncType](#respository-sync-status-change-sync-type "#respository-sync-status-change-sync-type")": "string",
    "[status](#respository-sync-status-change-status "#respository-sync-status-change-status")": "string",
    "[previousSync](#respository-sync-status-change-previous-sync "#respository-sync-status-change-previous-sync")": "string"
    }
  }
}
```
