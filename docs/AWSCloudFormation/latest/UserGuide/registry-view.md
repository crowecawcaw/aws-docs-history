...
Use the [list-types](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-types.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-types.html") command.
