...
`myWebServer` or `i-123abcd4`. 6. In the **Changes** section, choose **View
details** in the **Property-level changes** column to
view property value changes made to your resource. 7. The CloudFormation console directs you to the property-level changes page for a
...
`DeadLetterQueue` or
`NestedStack`. 6. In the **Changes** section, choose **View nested change
...
change set. For more information see, [Change sets for nested stacks](change-sets-for-nested-stacks.md "change-sets-for-nested-stacks.md").
...
1. To get the ID of the change set, run the [change-sets](../../../cli/latest/reference/cloudformation/list-change-sets.md "../../../cli/latest/reference/cloudformation/list-change-sets.md") command.
...
2. Run the [describe-change-set](../../../cli/latest/reference/cloudformation/describe-change-set.md "../../../cli/latest/reference/cloudformation/describe-change-set.md") command, specifying the ID of the change
...
For a description of each field, see the [`Change`](../APIReference/API_Change.md "../APIReference/API_Change.md") data type in the
