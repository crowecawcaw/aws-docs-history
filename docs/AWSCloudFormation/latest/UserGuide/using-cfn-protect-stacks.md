...
**Enable**. For more information, see [Configure stack options](cfn-console-create-stack.md#configure-stack-options "cfn-console-create-stack.md#configure-stack-options").
...
to which the nested stack belongs. 4. In the stack details pane, select **Stack actions** and then
**Edit termination protection**.

CloudFormation displays the **Edit termination protection** dialog
box. 5. Choose **Enable** or **Disable**, and then
select **Save**.
...
CloudFormation displays the stack details for the root stack. 5. Choose **Stack actions** and then choose **Edit
Termination Protection**.

CloudFormation displays the **Edit termination protection** dialog
box. 6. Choose **Enable** or **Disable**, and then
select **Save**.
