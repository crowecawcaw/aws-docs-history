...
Before you set up an interface endpoint, first make sure you have met the
 prerequisites in the [Access an AWS service using an interface VPC endpoint](https://docs.aws.amazon.com/vpc/latest/privatelink/create-interface-endpoint.html "https://docs.aws.amazon.com/vpc/latest/privatelink/create-interface-endpoint.html") topic in the
...
* If you have resources within your VPC that must respond to a custom resource
 ...
 resource](template-custom-resources.md "template-custom-resources.md") request or a [wait
 condition](using-cfn-waitcondition.md "using-cfn-waitcondition.md"). If a template includes custom resources or wait conditions
...
For a list of AWS Regions where CloudFormation is currently available, see the
 [AWS CloudFormation endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/cfn.html "https://docs.aws.amazon.com/general/latest/gr/cfn.html") page
...
* VPC endpoints only support Amazon-provided DNS through Route 53. If you want to
 ...
 Amazon VPC](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_DHCP_Options.html "https://docs.aws.amazon.com/vpc/latest/userguide/VPC_DHCP_Options.html") in the Amazon VPC User Guide.
...
For a complete list of CloudFormation endpoints, see [AWS CloudFormation endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/cfn.html "https://docs.aws.amazon.com/general/latest/gr/cfn.html") in the
