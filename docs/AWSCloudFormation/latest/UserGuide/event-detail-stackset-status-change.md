...
{
  . . .,
  "[detail-type](#stackset-status-change-detail-type "#stackset-status-change-detail-type")": "CloudFormation StackSet Status Change",
  "[source](#stackset-status-change-source "#stackset-status-change-source")": "aws.cloudformation",
  . . .,
  "[detail](#stackset-status-change-detail "#stackset-status-change-detail")": {
    "[stack-set-arn](#stackset-status-change-stack-set-arn "#stackset-status-change-stack-set-arn")" : "string",
    "[status-details](#stackset-status-change-status-details "#stackset-status-change-status-details")": {
        "[status](#stackset-status-change-status "#stackset-status-change-status")":"string"
    }
  }
}
```
