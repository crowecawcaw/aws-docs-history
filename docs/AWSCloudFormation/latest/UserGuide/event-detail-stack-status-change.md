...
{
  . . .,
  "[detail-type](#stack-status-change-detail-type "#stack-status-change-detail-type")":"CloudFormation Stack Status Change",
  "[source](#stack-status-change-source "#stack-status-change-source")":"aws.cloudformation",
  . . .,
  "[detail](#stack-status-change-detail "#stack-status-change-detail")":{
    "[stack-id](#stack-status-change-stack-id "#stack-status-change-stack-id")":"string",
    "[status-details](#stack-status-change-status-details "#stack-status-change-status-details")":{
      "[status](#stack-status-change-status "#stack-status-change-status")":"string",
      "[status-reason](#stack-status-change-status-reason "#stack-status-change-status-reason")":"string"
    },
    "[client-request-token](#stack-status-change-client-request-token "#stack-status-change-client-request-token")":"string"
  }
}
```
