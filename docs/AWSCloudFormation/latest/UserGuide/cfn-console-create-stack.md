...
**Express mode**  
Under **Deployment options**, you can select **Express** for the deployment mode. Express mode completes stack operations as soon as resource configuration is applied, without waiting for resources to reach a fully stabilized state. For more information, see [Express mode](cloudformation-express-mode.md).
