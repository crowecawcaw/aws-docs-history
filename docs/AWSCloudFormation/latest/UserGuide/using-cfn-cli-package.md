...
You can use the AWS CLI to upload local artifacts that are referenced by a CloudFormation template
 ...
 can specify local artifacts in your template and use the [package](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html") command to
 upload them quickly. 
 ...
 **package** command supports. For more information about this command and a
 list of the supported resource properties, see the [package](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html") documentation
 in the [AWS CLI Command Reference](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/index.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/index.html").
...
The following [package](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/package.html") command creates and uploads a `.zip` file
...
After you package your template’s artifacts, deploy the processed template using the
 [deploy](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/deploy/ "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/deploy/")
 command.
