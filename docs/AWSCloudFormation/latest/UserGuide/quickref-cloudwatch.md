...
Use these sample template snippets to help describe your Amazon CloudWatch resources in AWS CloudFormation. For
 more information, see the [Amazon CloudWatch resource type reference](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/AWS_CloudWatch.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/AWS_CloudWatch.html").

###### Topics

* [Billing alarm](#cloudwatch-sample-billing-alarm "#cloudwatch-sample-billing-alarm")
...
In the following sample, Amazon CloudWatch sends an email notification when charges to your AWS
 ...
 more information, see [Create a billing alarm to monitor your estimated AWS charges](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/monitor_estimated_charges_with_cloudwatch.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/monitor_estimated_charges_with_cloudwatch.html") in the
...
The following CloudWatch alarm recovers an EC2 instance when it has status check failures for 15
 ...
 terminate, reboot, or recover an EC2 instance](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/UsingAlarmActions.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/UsingAlarmActions.html") in the
 *Amazon CloudWatch User Guide*.
