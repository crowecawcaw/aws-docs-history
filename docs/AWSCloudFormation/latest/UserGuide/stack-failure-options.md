...
7. When you're satisfied with the parameter values, choose
 **Next**.
8. On the **Configure stack options** page, you can set additional
 options for your stack.
9. For **Stack failure options**, select **Preserve successfully
...
*Results*: Resources that failed to update transition the stack status
...
Specify the `--disable-rollback` option or `on-failure DO_NOTHING`
 enumeration during a [create-stack](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-stack.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-stack.html")
 operation.
...
Specify the `--disable-rollback` option
 during an [execute-change-set](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/execute-change-set.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/execute-change-set.html")
 operation.
...
You can use the [rollback-stack](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/rollback-stack.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/rollback-stack.html") command to
