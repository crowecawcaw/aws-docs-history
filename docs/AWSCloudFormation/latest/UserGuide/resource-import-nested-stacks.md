...
1. Add the `AWS::CloudFormation::Stack` resource to the parent stack
   ...
   [DeletionPolicy](../TemplateReference/aws-attribute-deletionpolicy.md "../TemplateReference/aws-attribute-deletionpolicy.md"). In the following example parent stack template,
...
create, update, or delete operation. 8. On the **Review `MyParentStack`** page,
...
time. 9. The **Events** pane of the **Stack details**
...
1. Add the `AWS::CloudFormation::Stack` resource to the parent stack
   template with a `Retain`
   [DeletionPolicy](../TemplateReference/aws-attribute-deletionpolicy.md "../TemplateReference/aws-attribute-deletionpolicy.md"). In the following example parent template,
   `MyNestedStack` is the target of the import.
