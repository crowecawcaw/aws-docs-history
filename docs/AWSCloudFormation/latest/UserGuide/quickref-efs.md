...
The following sample template deploys EC2 instances (in an Auto Scaling group) that are associated
 ...
 instance's Availability Zone. For more information about the DNS name structure, see [Mounting File Systems](https://docs.aws.amazon.com/efs/latest/ug/mounting-fs.html "https://docs.aws.amazon.com/efs/latest/ug/mounting-fs.html") in the
