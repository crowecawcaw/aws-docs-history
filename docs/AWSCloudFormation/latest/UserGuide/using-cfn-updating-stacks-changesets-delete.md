...
- Run the [delete-change-set](../../../cli/latest/reference/cloudformation/delete-change-set.md "../../../cli/latest/reference/cloudformation/delete-change-set.md") command, specifying the ID of the change set
