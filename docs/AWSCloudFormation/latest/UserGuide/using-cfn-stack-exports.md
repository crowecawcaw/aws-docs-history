...
To share information between stacks, you *export* output values from one
 stack and *import* them into another stack. Here's how it works:
...
1. In the first stack's template (for example, the networking stack), you define certain
 ...
 section. For more information, see [CloudFormation template Outputs syntax](outputs-section-structure.md "outputs-section-structure.md").
...
Use the following [list-exports](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-exports.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-exports.html") command. Replace
...
Use the [list-imports](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-imports.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-imports.html") command. Replace
