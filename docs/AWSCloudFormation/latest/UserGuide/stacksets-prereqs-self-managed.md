...
1. Determine which AWS account is the _administrator
   account_.

StackSets are created in this administrator account. A
_target account_ is the account in which you create
individual stacks that belong to a StackSet. 2. Determine how you want to structure permissions for the StackSet.
...
Create an [IAM
service role](../../../IAM/latest/UserGuide/id_roles_create_for-service.md "../../../IAM/latest/UserGuide/id_roles_create_for-service.md") with a custom name and the following
...
Name (ARN). Therefore, you can define conditions for [global keys](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-sourceaccount "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-sourceaccount")
`aws:SourceAccount` and `aws:SourceArn` in the trust
relationships to prevent [confused deputy
problems](../../../IAM/latest/UserGuide/confused-deputy.md "../../../IAM/latest/UserGuide/confused-deputy.md"). The following example shows how you can use the
