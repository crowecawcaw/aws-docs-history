...
| --- | --- | --- |
| Custom resources | The `AWS::CloudFormation::CustomResource` resource type
 ...
 CloudFormation resource types. | [Custom resources](template-custom-resources.md "template-custom-resources.md") |
| Macros | The `AWS::CloudFormation::Macro` resource type defines a
 ...
 updates. | [Template macros](template-macros.md "template-macros.md") |
| Nested stacks | The `AWS::CloudFormation::Stack` resource type allows you
 to create nested stacks within your CloudFormation templates for a more
 modular and reusable stack architectures. | [Nested stacks](using-cfn-nested-stacks.md "using-cfn-nested-stacks.md") |
| StackSet | The `AWS::CloudFormation::StackSet` resource type creates
 or updates a CloudFormation StackSet, which is a container for stacks that
 can be deployed across multiple AWS accounts and Regions. | [Managing stacks with
 StackSets](what-is-cfnstacksets.md "what-is-cfnstacksets.md") |
| Wait condition | The `AWS::CloudFormation::WaitCondition` resource type
 ...
 availability of external resources.  | [Wait conditions](using-cfn-waitcondition.md "using-cfn-waitcondition.md") |
| Wait condition handle | The `AWS::CloudFormation::WaitConditionHandle` resource
 ...
 or update process to proceed. | [Wait conditions](using-cfn-waitcondition.md "using-cfn-waitcondition.md") |
