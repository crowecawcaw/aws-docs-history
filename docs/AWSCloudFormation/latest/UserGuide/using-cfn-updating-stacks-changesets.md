...
* [Change sets for nested stacks](change-sets-for-nested-stacks.md "change-sets-for-nested-stacks.md")
###### Important
...
![Diagram showing four steps to update a stack using CloudFormation change sets.](../../../images/AWSCloudFormation/latest/UserGuide/images/update-stack-changesets-diagram.png)
