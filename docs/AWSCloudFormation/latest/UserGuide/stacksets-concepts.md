...
- Management account – the account that you use to create the organization. For more
  ...
  concepts for AWS Organizations](../../../organizations/latest/userguide/orgs_getting-started_concepts.md "../../../organizations/latest/userguide/orgs_getting-started_concepts.md").
- Delegated administrator – a compatible AWS service can register an AWS
  ...
  that you can use with AWS Organizations](../../../organizations/latest/userguide/orgs_integrate_services_list.md "../../../organizations/latest/userguide/orgs_integrate_services_list.md").
...
and tracking costs using AWS cost allocation tags](../../../awsaccountbilling/latest/aboutv2/cost-alloc-tags.md "../../../awsaccountbilling/latest/aboutv2/cost-alloc-tags.md") in the _AWS Billing and Cost Management User
Guide_. After you specify the key-value pair, choose **+** to
