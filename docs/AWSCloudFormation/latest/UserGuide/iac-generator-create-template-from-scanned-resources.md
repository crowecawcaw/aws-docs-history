...
1. Open the [IaC
 generator page](https://console.aws.amazon.com/cloudformation/home?#iac-generator "https://console.aws.amazon.com/cloudformation/home?#iac-generator") of the CloudFormation console.
...
1. Use the [list-resource-scan-resources](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-resource-scan-resources.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-resource-scan-resources.html") command to list the resources
...
For a description of the fields in the output, see [ScannedResource](../APIReference/API_ScannedResource.md "../APIReference/API_ScannedResource.md") in the
...
```
3. Use the [list-resource-scan-related-resources](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-resource-scan-related-resources.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/list-resource-scan-related-resources.html") command, along with the
...
Be aware that the output may contain duplicated resources in the
 list.
4. Use the [create-generated-template](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-generated-template.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-generated-template.html") command to create a new stack
