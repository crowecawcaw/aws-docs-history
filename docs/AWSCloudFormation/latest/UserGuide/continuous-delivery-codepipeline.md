...
For example, you can create a workflow that automatically builds a test stack when you
 ...
 delivery?](https://aws.amazon.com/devops/continuous-delivery/ "https://aws.amazon.com/devops/continuous-delivery/").
...
Use CodePipeline to build a continuous delivery workflow by building a pipeline for CloudFormation
 ...
 information about CodePipeline, see the [AWS CodePipeline User Guide](https://docs.aws.amazon.com/codepipeline/latest/userguide/ "https://docs.aws.amazon.com/codepipeline/latest/userguide/").
...
* [AWS CloudFormation configuration properties reference](continuous-delivery-codepipeline-action-reference.md "continuous-delivery-codepipeline-action-reference.md")
