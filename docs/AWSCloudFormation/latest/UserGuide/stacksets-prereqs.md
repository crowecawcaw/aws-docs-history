...
You can manage StackSets using *self-managed* or
 *service-managed* permissions. 


* For *self-managed* StackSets, you must create and manage
...
* For *service-managed* StackSets, you don't need to manually
