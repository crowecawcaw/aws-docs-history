...
{
  . . .,
  "[detail-type](#stackset-operation-status-change-detail-type "#stackset-operation-status-change-detail-type")": "CloudFormation StackSet Operation Status Change",
  "[source](#stackset-operation-status-change-source "#stackset-operation-status-change-source")": "aws.cloudformation",
  . . .,
  "[detail](#stackset-operation-status-change-detail "#stackset-operation-status-change-detail")": {
    "[stack-set-arn](#stackset-operation-status-change-stack-set-arn "#stackset-operation-status-change-stack-set-arn")" : "string",
    "[stack-set-operation-id](#stackset-operation-status-change-stack-set-operation-id "#stackset-operation-status-change-stack-set-operation-id")" : "string",
    "[status-details](#stackset-operation-status-change-status-details "#stackset-operation-status-change-status-details")": {
        "[status](#stackset-operation-status-change-status "#stackset-operation-status-change-status")": "string"
      }
    }
  }
}
