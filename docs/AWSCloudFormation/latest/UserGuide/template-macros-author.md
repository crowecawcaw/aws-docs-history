...
1. [Build a Lambda function](https://docs.aws.amazon.com/lambda/latest/dg/getting-started.html "https://docs.aws.amazon.com/lambda/latest/dg/getting-started.html") that will handle the processing of
