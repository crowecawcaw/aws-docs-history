...
In the **Advanced** section, you can specify an output file name, such as
 ...
 artifact](https://docs.aws.amazon.com/codepipeline/latest/userguide/concepts.html#concepts-artifacts "https://docs.aws.amazon.com/codepipeline/latest/userguide/concepts.html#concepts-artifacts") after it performs the specified action. The output artifact contains a JSON file with the
