...
This section provides examples of the change sets that CloudFormation would create for common
 ...
 description of each field in a change set, see the [Change](../APIReference/API_Change.md "../APIReference/API_Change.md") data type in the *AWS CloudFormation API Reference*.
...
If the key name were unchanged, the change to the `InstanceType` property
 ...
 `InstanceType` property of the [AWS::EC2::Instance](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-ec2-instance.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-ec2-instance.html") resource type.
