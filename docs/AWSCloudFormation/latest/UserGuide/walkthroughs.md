...
- [Refer to resource outputs in another CloudFormation stack](walkthrough-crossstackref.md "walkthrough-crossstackref.md") – This walkthrough shows you
...
- [Peer with a VPC in another AWS account](peer-with-vpc-in-another-account.md "peer-with-vpc-in-another-account.md") – This walkthrough
  ...
  network.
- [Perform ECS blue/green deployments through CodeDeploy using CloudFormation](blue-green.md "blue-green.md") – Discover how to
