...
![Diagram showing the sequence of events for resource creation and eventual consistency check in a stack.](../../../images/AWSCloudFormation/latest/UserGuide/images/configuration-complete.png)
