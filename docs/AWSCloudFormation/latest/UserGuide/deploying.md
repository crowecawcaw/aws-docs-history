...
CloudFormation includes a set of helper scripts (`cfn-init`, `cfn-signal`,
 ...
 For more information, see the [CloudFormation helper scripts reference](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-helper-scripts-reference.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-helper-scripts-reference.html") in the
...
1. Open the [EC2 console](https://console.aws.amazon.com/ec2/ "https://console.aws.amazon.com/ec2/") and find your
 instance.
...
* Explore more complex bootstrap scenarios with multiple configuration sets. For more
 information, see [cfn-init](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-init.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-init.html") and
 [AWS::CloudFormation::Init](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-init.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-init.html") in the *AWS CloudFormation Template Reference Guide*.
* Learn about `cfn-signal` for reporting bootstrap completion status. For
 more information, see [cfn-signal](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-signal.html "https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/cfn-signal.html") in
