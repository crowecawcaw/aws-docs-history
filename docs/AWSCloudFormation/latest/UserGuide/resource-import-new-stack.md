...
- For each resource you want to import, include the following:
  ...
  - the unique identifier for the resource, such as the resource name. For more information,
    see [Resource identifiers](import-resources-manually.md#resource-import-identifiers-unique-ids "import-resources-manually.md#resource-import-identifiers-unique-ids").
  - the [DeletionPolicy attribute](../TemplateReference/aws-attribute-deletionpolicy.md "../TemplateReference/aws-attribute-deletionpolicy.md").

###### Topics

- [Example
  template](#resource-import-new-stack-example-template "#resource-import-new-stack-example-template")
- [Create a stack from existing
  resources using the AWS Management Console](#resource-import-new-stack-console "#resource-import-new-stack-console")
- [Create a stack from existing
  resources using the AWS CLI](#resource-import-new-stack-cli "#resource-import-new-stack-cli")
...
![The Create stack from existing resources option in the console.](images/create-stack-with-existing-resources.png) 3. Read the **Import overview** page for a list of things you're required
to provide during this operation. Then, choose **Next**. 4. On the **Specify template** page, provide your template using one of the
...
update, or delete operation. 7. On the **Review `stack-name`** page, confirm
...
configurations.
    ...
    1. [Revert the import operation](resource-import-revert.md#resource-import-revert-console "resource-import-revert.md#resource-import-revert-console") for
...
For more information, see [Resource identifiers](import-resources-manually.md#resource-import-identifiers-unique-ids "import-resources-manually.md#resource-import-identifiers-unique-ids"). 2. Compose a list of the actual resources from your template and their unique identifiers in
...
[Using quotation marks inside strings](../../../cli/latest/userguide/cli-usage-parameters-quoting-strings.md#cli-usage-parameters-quoting-strings-containing "../../../cli/latest/userguide/cli-usage-parameters-quoting-strings.md#cli-usage-parameters-quoting-strings-containing") in the
