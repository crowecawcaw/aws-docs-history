...
that was changed in the update template. For example, updating an [AWS::RDS::DBInstance](../TemplateReference/aws-resource-rds-dbinstance.md "../TemplateReference/aws-resource-rds-dbinstance.md") resource named `MyDB` would result in the following
entries:
...
`AllocatedStorage` for an [AWS::RDS::DBInstance](../TemplateReference/aws-resource-rds-dbinstance.md "../TemplateReference/aws-resource-rds-dbinstance.md") resource, you would see events like these:
