...
- [Get started with StackSets using a sample template](stacksets-getting-started.md "stacksets-getting-started.md")
- [Create CloudFormation StackSets with self-managed permissions](stacksets-getting-started-create-self-managed.md "stacksets-getting-started-create-self-managed.md")
...
- [Enable or disable automatic deployments for StackSets in AWS Organizations](stacksets-orgs-manage-auto-deployment.md "stacksets-orgs-manage-auto-deployment.md")
...
- [Prevent failed StackSets deployments using target account gates](stacksets-account-gating.md "stacksets-account-gating.md")
