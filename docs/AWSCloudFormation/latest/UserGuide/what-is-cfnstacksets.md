...
AWS CloudFormation StackSets extends the capability of stacks by allowing you to create, update, or delete
...
![A StackSet is a collection of resources in a template, that's deployed across multiple accounts and regions.](../../../images/AWSCloudFormation/latest/UserGuide/images/stack_set_conceptual_sv.png)
...
* [Prerequisites for using AWS CloudFormation StackSets](stacksets-prereqs.md "stacksets-prereqs.md")
...
* [Update AWS CloudFormation StackSets](stacksets-update.md "stacksets-update.md")
...
* [Delete stacks from AWS CloudFormation StackSets](stackinstances-delete.md "stackinstances-delete.md")
* [Delete AWS CloudFormation StackSets](stacksets-delete.md "stacksets-delete.md")
* [Prevent failed StackSets deployments using target
 account gates](stacksets-account-gating.md "stacksets-account-gating.md")
* [Choose the Concurrency Mode for AWS CloudFormation StackSets](concurrency-mode.md "concurrency-mode.md")
* [Performing drift detection on CloudFormation StackSets](stacksets-drift.md "stacksets-drift.md")
* [Import stacks into AWS CloudFormation StackSets](stacksets-import.md "stacksets-import.md")
* [Best practices for using AWS CloudFormation StackSets](stacksets-bestpractices.md "stacksets-bestpractices.md")
* [AWS CloudFormation StackSets sample templates](stacksets-sampletemplates.md "stacksets-sampletemplates.md")
* [Troubleshooting AWS CloudFormation StackSets](stacksets-troubleshooting.md "stacksets-troubleshooting.md")
