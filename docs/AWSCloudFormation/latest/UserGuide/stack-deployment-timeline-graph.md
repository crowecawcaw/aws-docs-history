...
![A stack deployment timeline graph for a failed stack deployment.](images/deployment-timeline-graph.PNG)
...
![A stack deployment timeline graph popover showing deployment details for the chosen failed resource.](images/deployment-timeline-graph-root-cause.PNG)
