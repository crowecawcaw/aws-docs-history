...
* [Example stack policy](#stack-policy-intro-example "#stack-policy-intro-example")
* [Defining a stack policy](#stack-policy-reference "#stack-policy-reference")
* [Setting a stack policy](#protect-stack-resources-protecting "#protect-stack-resources-protecting")
* [Updating protected resources](#protect-stack-resources-updating "#protect-stack-resources-updating")
* [Modifying a stack policy](#protect-stack-resources-modifying "#protect-stack-resources-modifying")
* [More example stack policies](#stack-policy-samples "#stack-policy-samples")
...
The `Principal` element is required, but supports only the wild card
 (`*`), which means that the statement applies to all [principals](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#principal "https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#principal").
...
The `Principal` element specifies the entity that the policy applies to.
 ...
 that the policy applies to all [principals](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#principal "https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#principal").
...
* Use the [create-stack](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-stack.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/create-stack.html") command with the `--stack-policy-body`
...
* Use the [set-stack-policy](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/set-stack-policy.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/set-stack-policy.html") command with the
...
To add a policy to an existing stack, you must have permission to the CloudFormation
 [SetStackPolicy](../APIReference/API_SetStackPolicy.md "../APIReference/API_SetStackPolicy.md") action.
...
To update protected resources, you must have permission to use the CloudFormation [SetStackPolicy](../APIReference/API_SetStackPolicy.md "../APIReference/API_SetStackPolicy.md") action. For information about setting CloudFormation
 permissions, see [Control CloudFormation access with AWS Identity and Access Management](control-access-with-iam.md "control-access-with-iam.md").
...
3. If you *haven't* modified the stack template, select **Use
 ...
 section:
	...
	* For a template stored in an Amazon S3 bucket, select **Amazon S3 URL**.
	...
	If you have a template in a versioning-enabled bucket, you can specify a specific
	 ...
	 information, see [Working with objects in a versioning-enabled bucket](https://docs.aws.amazon.com/AmazonS3/latest/userguide/manage-objects-versioned-bucket.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/manage-objects-versioned-bucket.html") in the
...
For more information about using `NoEcho` to mask sensitive information, as
 well as using dynamic parameters to manage secrets, see the [Do not embed credentials in your templates](security-best-practices.md#creds "security-best-practices.md#creds") best practice.
5. Specify an override stack policy.
	...
	4. Choose **Next**.The override policy must specify an `Allow` statement for the protected
...
* Use the [update-stack](https://docs.aws.amazon.com/cli/latest/reference/cloudformation/update-stack.html "https://docs.aws.amazon.com/cli/latest/reference/cloudformation/update-stack.html") command with the
...
To protect additional resources or to remove protection from resources, modify the stack
 ...
 must have permission to use the [SetStackPolicy](../APIReference/API_SetStackPolicy.md "../APIReference/API_SetStackPolicy.md") action.
