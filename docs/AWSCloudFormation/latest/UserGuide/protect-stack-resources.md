 ...
 section:
	...
	* For a template stored in an Amazon S3 bucket, select **Amazon S3 URL**.
	...
	If you have a template in a versioning-enabled bucket, you can specify a specific
	 ...
	 information, see [Working with objects in a versioning-enabled bucket](../../../AmazonS3/latest/userguide/manage-objects-versioned-bucket.md "../../../AmazonS3/latest/userguide/manage-objects-versioned-bucket.md") in the
