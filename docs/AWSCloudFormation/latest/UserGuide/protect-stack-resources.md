...
(`*`), which means that the statement applies to all [principals](../../../glossary/latest/reference/glos-chap.md#principal "../../../glossary/latest/reference/glos-chap.md#principal").
...
that the policy applies to all [principals](../../../glossary/latest/reference/glos-chap.md#principal "../../../glossary/latest/reference/glos-chap.md#principal").
...
well as using dynamic parameters to manage secrets, see the [Do not embed credentials in your templates](security-best-practices.md#creds "security-best-practices.md#creds") best practice. 5. Specify an override stack policy.
