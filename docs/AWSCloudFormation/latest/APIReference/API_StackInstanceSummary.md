...
[Service-managed permissions] The organization root ID or organizational unit (OU) IDs that
 you specified for [DeploymentTargets](API_DeploymentTargets.md "API_DeploymentTargets.md").
...
Type: [StackInstanceComprehensiveStatus](API_StackInstanceComprehensiveStatus.md "API_StackInstanceComprehensiveStatus.md") object
...
* `INOPERABLE`: A `DeleteStackInstances` operation has failed and left
 ...
 due to a failed import, call the [DescribeStackInstance](API_DescribeStackInstance.md "API_DescribeStackInstance.md") API operation, look at
...
* [AWS SDK for C++](https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/StackInstanceSummary "https://docs.aws.amazon.com/goto/SdkForCpp/cloudformation-2010-05-15/StackInstanceSummary")
* [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/StackInstanceSummary "https://docs.aws.amazon.com/goto/SdkForJavaV2/cloudformation-2010-05-15/StackInstanceSummary")
* [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/StackInstanceSummary "https://docs.aws.amazon.com/goto/SdkForRubyV3/cloudformation-2010-05-15/StackInstanceSummary")
