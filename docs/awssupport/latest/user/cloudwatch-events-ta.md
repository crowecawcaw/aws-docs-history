...
You must have an AWS Business Support\+, AWS Enterprise Support, or AWS Unified Operations plan to create a rule for Trusted Advisor checks. For more information, see [Change AWS Support Plans](changing-support-plans.md).
