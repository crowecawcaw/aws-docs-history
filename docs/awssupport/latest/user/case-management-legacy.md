...
| --- | --- | --- | --- | 
| **General guidance** | low | 24 hours | You have a general development question, or you want to request a feature. (\*Developer, AWS Business Support\+, AWS Enterprise Support, or AWS Unified Operations plan) | 
| **System impaired** | normal | 12 hours | Non-critical functions of your application are behaving abnormally, or you have a time-sensitive development question. (\*Developer, AWS Business Support\+, AWS Enterprise Support, or AWS Unified Operations plan) | 
