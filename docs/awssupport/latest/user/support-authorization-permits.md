...
- `allActions`: Permits all support actions for
  the specified resources.
- `actions`: A list of up to 10 specific action
  names. Use `ListActions` to view available
  actions.
...
- `resources`: A list of up to 10 specific
  resource ARNs for which AWS Support can access service
  information.
...
- `allowAfter`: The support permit is not valid before
  this time (ISO 8601 format).
- `allowBefore`: The support permit is not valid after
  this time (ISO 8601 format).
...
2. In the navigation pane, choose
   **Support authorization**.
3. In the **Granted access** section, locate
...
2. In the navigation pane, choose
   **Support authorization**.
3. In the **Granted access** section, view the
...
2. In the navigation pane, choose
   **Support authorization**.
3. In the **Granted access** section, select
...
[Revoking AWS Support authorization access](support-authorization-kms.md#support-authorization-kms-revoke "support-authorization-kms.md#support-authorization-kms-revoke"). Alternatively, you can
