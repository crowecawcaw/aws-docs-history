...
1. (Optional) Choose **Choose file** to add any relevant files to your case, such as error logs or screenshots. You can attach up to 10 files. Each file can be up to 150 MB. For more information about managing attachments, see [Managing attachments](manage-attachments.md).
**Note**  
To attach more than 3 files or files over 5 MB, make sure that you have the correct permissions. For more information, see [Required permissions for large attachments](large-attachments-permissions.md).
