...
## Updated the Amazon EC2 Auto Scaling Group Resources check

Trusted Advisor updated the following check on December 23, 2024.

| Check name                              | Check category  | Check ID     |
| --------------------------------------- | --------------- | ------------ |
| Amazon EC2 Auto Scaling Group Resources | Fault tolerance | `8CNsSllI5v` |
...
For more information, see [Amazon EC2 Auto Scaling Group Resources](fault-tolerance-checks.md#auto-scaling-group-resources "fault-tolerance-checks.md#auto-scaling-group-resources").
