...
1. Complete the following steps to invite the AWS Support App to your channel:
   ...
   1. Choose the **Integrations** tab, and then choose **Add an App**.
...
1. Under **Notifications**, specify how to get notified for cases.
   ...
   + **High-severity cases** – Get notified for only cases that affect a production system or higher. For more information, see [Choosing an initial support case severity level](case-management.md#choosing-severity).
