...
| SaveFeedback                                                 | WRITE                               | Grants permission to save questionnaire feedback.                                                        | ###### Note If you have a custom VPN configuration, then your IAM policies must allow the Support Center Console API endpoint in the [aws.sourceIP conditions](../../../IAM/latest/UserGuide/reference_policies_examples_aws_deny-ip.md "../../../IAM/latest/UserGuide/reference_policies_examples_aws_deny-ip.md"). If the Support Center Console API endpoint isn't allowed, then your ClientIp address won't forward to the API correctly. The following table provides the Support Center Console API endpoints by AWS Region. |
| AWS Region                                                   | Support Center Console API endpoint |                                                                                                          | ---                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | ---              |
| `https://api.us-east-1.prod.support-console.support.aws.dev` | US East (N. Virginia)               |                                                                                                          | `https://api.us-west-2.prod.support-console.support.aws.dev`                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | US West (Oregon) |
