...
- [I'm an administrator and want to allow others to access Support](#security_iam_troubleshoot-admin-delegate "#security_iam_troubleshoot-admin-delegate")
- [I want to allow people outside of my AWS account to access my Support resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
- To learn whether Support supports these features, see [How AWS Support works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
