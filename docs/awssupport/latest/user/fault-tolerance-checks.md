...
| Red    | arn:aws:sts::0123456789012:assumed-role/aws:ec2-instance/i-0123456789example | EC2 Instance Identity Role | GetCallerIdentity | 2025-01-01T08:00.000Z | us-west-1          |

**Additional resources**

- [Manage AWS STS in an AWS Region](../../../IAM/latest/UserGuide/id_credentials_temp_enable-regions.md "../../../IAM/latest/UserGuide/id_credentials_temp_enable-regions.md")
- [AWS STS Regional endpoints](../../../sdkref/latest/guide/feature-sts-regionalized-endpoints.md "../../../sdkref/latest/guide/feature-sts-regionalized-endpoints.md")
...
Checks for high risk issues (HRIs) for your workloads in the reliability
...
- Red: At least one active high risk issue was identified in the
  reliability pillar for AWS Well-Architected.
- Green: No active high risk issues were detected in the reliability
...
For more information, see [What is a Classic Load Balancer?](../../../elasticloadbalancing/latest/classic/introduction.md "../../../elasticloadbalancing/latest/classic/introduction.md").
...
For more information, see [Tutorial: Create a Classic Load Balancer](../../../elasticloadbalancing/latest/classic/elb-getting-started.md "../../../elasticloadbalancing/latest/classic/elb-getting-started.md").
...
Checks for Classic load balancers that do not have connection draining
enabled.

When connection draining is not enabled and you deregister an Amazon EC2
instance from a Classic load balancer, the Classic load balancer stops
routing traffic to that instance and closes the connection. When connection
draining is enabled, the Classic load balancer stops sending new requests to
the deregistered instance but keeps the connection open to serve active
requests.
...
Enable connection draining for the Classic load balancer. For more
information, see [Connection Draining](../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md#conn-drain "../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md#conn-drain") and [Enable or Disable Connection Draining for Your Load
Balancer](../../../ElasticLoadBalancing/latest/DeveloperGuide/config-conn-drain.md "../../../ElasticLoadBalancing/latest/DeveloperGuide/config-conn-drain.md").

**Additional Resources**

[Elastic Load Balancing Concepts](../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md "../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md")
...
- Green: No AZs represents more than 50% of the load balancer
  capacity.
...
[Target groups for your Application Load Balancers](../../../elasticloadbalancing/latest/application/load-balancer-target-groups.md "../../../elasticloadbalancing/latest/application/load-balancer-target-groups.md")

[Register targets with your Application Load Balancer target group](../../../elasticloadbalancing/latest/application/target-group-register-targets.md "../../../elasticloadbalancing/latest/application/target-group-register-targets.md")
...
It’s a best practice to choose a maintenance window for architecture
changes in your Amazon VPC.

**Additional Resources**

- [Availability Zone Independence](../../../whitepapers/latest/advanced-multi-az-resilience-patterns/availability-zone-independence.md "../../../whitepapers/latest/advanced-multi-az-resilience-patterns/availability-zone-independence.md")
- [Configure Routing for Gateway Load Balancer endpoint](../../../vpc/latest/privatelink/gateway-load-balancer-endpoints.md#configure-routing-gateway-load-balancer-endpoint "../../../vpc/latest/privatelink/gateway-load-balancer-endpoints.md#configure-routing-gateway-load-balancer-endpoint")
- [AWS Well-Architected Tool - Use bulkhead architectures to limit scope of
  impact](../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_use_bulkhead.md "../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_use_bulkhead.md")
...
- Yellow: A load balancer is enabled for a single Availability
  Zone.
- Yellow: A load balancer is enabled for an Availability Zone that
  has no active instances.
- Yellow: The Amazon EC2 instances that are registered with a load
  balancer are unevenly distributed across Availability Zones. (The
  difference between the highest and lowest instance counts in
  utilized Availability Zones is more than 1, and the difference is
  more than 20% of the highest count.)

**Recommended Action**

Ensure that your load balancer points to active and healthy instances in
at least two Availability Zones. For more information, see [Add Availability Zone](../../../ElasticLoadBalancing/latest/DeveloperGuide/enable-disable-az.md#US_AddLBAvailabilityZone "../../../ElasticLoadBalancing/latest/DeveloperGuide/enable-disable-az.md#US_AddLBAvailabilityZone").

If your load balancer is configured for an Availability Zone with no
healthy instances, or if there is an imbalance of instances across the
Availability Zones, determine if all the Availability Zones are necessary.
Omit any unnecessary Availability Zones and ensure there is a balanced
distribution of instances across the remaining Availability Zones. For more
information, see [Remove Availability Zone](../../../ElasticLoadBalancing/latest/DeveloperGuide/enable-disable-az.md#US_ShrinkLBApp04 "../../../ElasticLoadBalancing/latest/DeveloperGuide/enable-disable-az.md#US_ShrinkLBApp04").

**Additional Resources**

- [Availability Zones and
  Regions](../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md#AZ-Region "../../../ElasticLoadBalancing/latest/DeveloperGuide/TerminologyandKeyConcepts.md#AZ-Region")
- [Managing Load Balancers](../../../ElasticLoadBalancing/latest/DeveloperGuide/UserScenarios.md "../../../ElasticLoadBalancing/latest/DeveloperGuide/UserScenarios.md")
- [Best
  Practices in Evaluating Elastic Load Balancing](https://aws.amazon.com/articles/1636185810492479 "https://aws.amazon.com/articles/1636185810492479")
...
A NAT Gateway enables resources in your private subnet to securely connect to
services outside the subnet using the NAT Gateway’s IP addresses and drops any
unsolicited inbound traffic. Each NAT Gateway operates within a designated Availability
Zone (AZ) and is built with redundancy in that AZ only. Therefore, your resources in a
particular AZ should use a NAT Gateway in the same AZ so that any potential outage of a
NAT Gateway or its AZ does not impact your resources in another AZ.
...
- Red: Traffic from your subnet in one AZ is being routed
  through a NATGW in a different AZ.
- Green: Traffic from your subnet in one AZ is being routed
  through a NATGW in the same AZ.

**Recommended Action**

Please check the AZ of your subnet and route traffic through a NAT
Gateway in the same AZ.

If there is no NATGW in the AZ, please create one and then route
your subnet traffic through it.

If you have the same route table associated across subnets in different
AZs, keep this route table associated to the subnets that reside in the
same AZ as the NAT Gateway and for subnets in the other AZ, please associate
a separate route table with a route to a NAT Gateway in this other AZ.

We recommend choosing a maintenance window for architecture changes in your
Amazon VPC.

**Additional Resources**

- [How to create a NAT Gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md#nat-gateway-working-with "../../../vpc/latest/userguide/vpc-nat-gateway.md#nat-gateway-working-with")
- [How to configure routes for different NAT
  Gateway use cases](../../../vpc/latest/userguide/nat-gateway-scenarios.md "../../../vpc/latest/userguide/nat-gateway-scenarios.md")
...
Checks if your AWS Network Firewall endpoints are configured as a route destination
from another Availability Zone (AZ).
...
[Data Transfer
within the same AWS Region](https://aws.amazon.com/ec2/pricing/on-demand/ "https://aws.amazon.com/ec2/pricing/on-demand/")

[Understanding data transfer charges](../../../cur/latest/userguide/cur-data-transfers-charges.md "../../../cur/latest/userguide/cur-data-transfers-charges.md")

[Availability Zone Independence](../../../whitepapers/latest/advanced-multi-az-resilience-patterns/availability-zone-independence.md "../../../whitepapers/latest/advanced-multi-az-resilience-patterns/availability-zone-independence.md")

[High Level steps for implementing a firewall](../../../network-firewall/latest/developerguide/firewall-high-level-steps.md "../../../network-firewall/latest/developerguide/firewall-high-level-steps.md")

[Creating a firewall](../../../network-firewall/latest/developerguide/firewall-creating.md "../../../network-firewall/latest/developerguide/firewall-creating.md")
...
Checks if your Network Firewalls are configured to use more than one
Availability Zone (AZ) for firewall endpoints.

An AZ is a distinct location that’s insulated from failures in other
zones. If the Network Firewall endpoint is deployed in only 1 AZ, then it
can be a single point of failure and can impair workloads from other AZs
using the Network Firewall for traffic inspection. It’s a best practice to
configure your Network Firewalls in multiple AZs in the same Region to
mprove your workload availability.
...
Make sure that your Network Firewall is configured with at least two AZs
for production workloads.

**Additional Resources**

[VPC subnet configuration forAWS Network Firewall](../../../network-firewall/latest/developerguide/vpc-config.md#vpc-config-subnets "../../../network-firewall/latest/developerguide/vpc-config.md#vpc-config-subnets")

[Creating a firewall](../../../network-firewall/latest/developerguide/firewall-creating.md "../../../network-firewall/latest/developerguide/firewall-creating.md")

[Availability Zone](../../../elasticloadbalancing/latest/network/network-load-balancers.md#availability-zones "../../../elasticloadbalancing/latest/network/network-load-balancers.md#availability-zones")

[AWS Well-Architected Tool - Deploy the workload to multiple locations](../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_multiaz_region_system.md "../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_multiaz_region_system.md")

[Appliance in a shared services VPC](../../../vpc/latest/tgw/transit-gateway-appliance-scenario.md#transit-gateway-appliance-overview "../../../vpc/latest/tgw/transit-gateway-appliance-scenario.md#transit-gateway-appliance-overview")
...
For more information, see [Cross-zone load balancing](../../../elasticloadbalancing/latest/userguide/how-elastic-load-balancing-works.md#cross-zone-load-balancing "../../../elasticloadbalancing/latest/userguide/how-elastic-load-balancing-works.md#cross-zone-load-balancing").
...
[Cross-zone load balancing (Network Load Balancers)](../../../elasticloadbalancing/latest/network/network-load-balancers.md#cross-zone-load-balancing "../../../elasticloadbalancing/latest/network/network-load-balancers.md#cross-zone-load-balancing")
...
Checks if an internet-facing Network Load Balancer (NLB) is configured with a private subnet. An internet-facing Network Load Balancer (NLB) must be configured in public subnets in order to receive traffic. A public subnet is defined as a subnet that has a direct route to an [internet gateway](../../../vpc/latest/userguide/VPC_Internet_Gateway.md "../../../vpc/latest/userguide/VPC_Internet_Gateway.md"). If the subnet is configured as private, then it’s Availability Zone (AZ) doesn’t receive traffic, which can cause availability issues.
...
Confirm that the subnets configured in an internet-facing load balancer are public. A public subnet is defined as a subnet that has a direct route to an [internet gateway](../../../vpc/latest/userguide/VPC_Internet_Gateway.md "../../../vpc/latest/userguide/VPC_Internet_Gateway.md"). Use one of following options:

- Create a new load balancer and select a different subnet with a direct route to an internet gateway.
- Change the subnet that’s currently attached to the load balancer from private to public. To do this, change its route table and [associate an internet gateway](../../../vpc/latest/userguide/WorkWithRouteTables.md#associate-route-table-gateway "../../../vpc/latest/userguide/WorkWithRouteTables.md#associate-route-table-gateway").

**Additional Resources**

- [Configure a load balancer and a listener](../../../elasticloadbalancing/latest/network/create-network-load-balancer.md#configure-load-balancer "../../../elasticloadbalancing/latest/network/create-network-load-balancer.md#configure-load-balancer")
- [Subnets for your VPC](../../../vpc/latest/userguide/configure-subnets.md "../../../vpc/latest/userguide/configure-subnets.md")
- [Associate a gateway with a route table](../../../vpc/latest/userguide/WorkWithRouteTables.md#associate-route-table-gateway "../../../vpc/latest/userguide/WorkWithRouteTables.md#associate-route-table-gateway")
...
- [Availability Zones](../../../elasticloadbalancing/latest/network/network-load-balancers.md#availability-zones "../../../elasticloadbalancing/latest/network/network-load-balancers.md#availability-zones")
- [AWS Well-Architected - Deploy the workload to multiple locations](../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_multiaz_region_system.md "../../../wellarchitected/latest/reliability-pillar/rel_fault_isolation_multiaz_region_system.md")
...
Checks that an Incident Manager replication set’s configuration uses more than one AWS Region to support regional failover and response.
For incidents created by CloudWatch alarms or EventBridge events, Incident Manager creates an incident in the same AWS Region as the alarm or event rule.
If Incident Manager is temporarily unavailable in that Region, the system attempts to create an incident in another Region in the replication set.
If the replication set includes only one Region, the system fails to create an incident record while Incident Manager is unavailable.
...
For more information, see [Cross-region Incident management](../../../incident-manager/latest/userguide/incident-manager-cross-account-cross-region.md#incident-manager-cross-region.html "../../../incident-manager/latest/userguide/incident-manager-cross-account-cross-region.md#incident-manager-cross-region.html").
...
Checks through network patterns if your egress network traffic is routing
through a single Availability Zone (AZ).

An AZ is a distinct location that is insulated from any impact in other
zones. By spreading your service across multiple AZs, you limit the blast
radius of an AZ failure.
...
- Yellow: Your application may be deployed in only one AZ based on
  observed egress network patterns. If this is true and your application
  expects high availability, we recommend that you provision your application
  resources and implement your network flows to utilize multiple Availability Zones.

**Recommended Action**

If your application requires high availability, consider implementing a multi-AZ architecture
...
- [Private IP address of the endpoint network interface](../../../whitepapers/latest/aws-privatelink/creating-highly-available-endpoint-services.md#private-ip-address-of-the-endpoint-network-interface "../../../whitepapers/latest/aws-privatelink/creating-highly-available-endpoint-services.md#private-ip-address-of-the-endpoint-network-interface")
- [AWS PrivateLink concepts](../../../vpc/latest/privatelink/concepts.md "../../../vpc/latest/privatelink/concepts.md")
- [Regions and Availability Zones](https://aws.amazon.com/about-aws/global-infrastructure/regions_az/ "https://aws.amazon.com/about-aws/global-infrastructure/regions_az/")
...
Checks the number of tunnels that are active for each of your Site-to-Site
VPNs.

A VPN should have two tunnels configured at all times. This provides
redundancy in case of outage or planned maintenance of the devices at the
AWS endpoint. For some hardware, only one tunnel is active at a time. If a
VPN has no active tunnels, charges for the VPN might still apply. For more
information, see [AWS Site-to-Site VPN User Guide](../../../vpn/latest/s2svpn/VPC_VPN.md "../../../vpn/latest/s2svpn/VPC_VPN.md").
...
- Yellow: A VPN has one active tunnel (this is normal for some
  hardware).
- Yellow: A VPN has no active tunnels.

**Recommended Action**

Be sure that two tunnels are configured for your VPN connection, and that
both are active if your hardware supports it. If you no longer need a VPN
connection, you can delete it to avoid charges. For more information, see
[Your
customer gateway device](../../../vpn/latest/s2svpn/your-cgw.md "../../../vpn/latest/s2svpn/your-cgw.md") or [Delete a
Site-to-Site VPN connection](../../../vpn/latest/s2svpn/delete-vpn.md "../../../vpn/latest/s2svpn/delete-vpn.md").

**Additional Resources**

- [AWS Site-to-Site VPN User Guide](../../../vpn/latest/s2svpn/VPC_VPN.md "../../../vpn/latest/s2svpn/VPC_VPN.md")
- [Create a target gateway](../../../vpn/latest/s2svpn/SetUpVPNConnections.md#vpn-create-target-gateway "../../../vpn/latest/s2svpn/SetUpVPNConnections.md#vpn-create-target-gateway")
...
Checks that Amazon MQ for ActiveMQ brokers are configured for high
availability with an active/standby broker in multiple Availability Zones.
...
- Yellow: An Amazon MQ for ActiveMQ broker is configured in a
  single Availability Zone.

Green: An Amazon MQ for ActiveMQ broker is configured in at
...
- [Creating an ActiveMQ broker](../../../amazon-mq/latest/developer-guide/getting-started-activemq.md "../../../amazon-mq/latest/developer-guide/getting-started-activemq.md")
...
Checks that Amazon MQ for RabbitMQ brokers are configured for high availability
with cluster instances in multiple Availability Zones.
...
- Yellow: An Amazon MQ for RabbitMQ broker is configured in a
  single Availability Zone.

Green: An Amazon MQ for RabbitMQ broker is configured in
...
- [Creating a RabbitMQ broker](../../../amazon-mq/latest/developer-guide/getting-started-rabbitmq.md "../../../amazon-mq/latest/developer-guide/getting-started-rabbitmq.md")
