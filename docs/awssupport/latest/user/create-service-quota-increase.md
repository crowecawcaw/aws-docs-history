...
Use the Service Quotas service to request increases directly for your services. For more information,
...
- [Requesting a quota increase](../../../servicequotas/latest/userguide/request-quota-increase.md "../../../servicequotas/latest/userguide/request-quota-increase.md") in the _Service Quotas User Guide_
  At this time, Service Quotas doesn't support service quotas for all AWS services in all AWS Regions. If your AWS service or AWS Region isn't available in the [Service Quotas console](https://console.aws.amazon.com/servicequotas/home "https://console.aws.amazon.com/servicequotas/home"), complete the following steps to create a support case to request the quota increase:
...
AWS Region selection isn't available if you selected **General** as the **Category**. 8. (Optional) To request multiple limit increases, choose **Add another limit** and then choose another AWS Region. 9. Enter a **Description** for this service quota increase or multiple increases. You can attach files, if necessary. 10. Choose **Next step: Solve now or contact us**. 11. For **Contact options**, choose one of the following options:
    ...
    * **Chat** – Start a live chat with a support
     agent.
     If you can't connect to a chat, see [Troubleshooting](troubleshooting-support-cases.md "troubleshooting-support-cases.md").
