...
As a managed service, AWS Support is protected by the AWS global network security
...
You use AWS published API calls to access Support through the network. Clients must
