...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ---- |
| [AWSSupportAppFullAccess](#security-iam-awsmanpol-support-app-full-access "#security-iam-awsmanpol-support-app-full-access") and [AWSSupportAppReadOnlyAccess](#security-iam-support-app-read-only "#security-iam-support-app-read-only")<br>New AWS managed policies for the AWS Support App | You can use these policies for the IAM role that you configure for<br>your Slack channel configuration.<br>For more information, see [Managing access to the AWS Support App](support-app-permissions.md "support-app-permissions.md"). | August 19, 2022 |
