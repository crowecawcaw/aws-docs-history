...
performance of Support Plans and your other AWS solutions. AWS provides the following monitoring
tools to watch Support Plans, report when something is wrong, and take automatic actions when
appropriate:
