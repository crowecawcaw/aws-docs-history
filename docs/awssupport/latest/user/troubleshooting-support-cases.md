...
If you chose the **Chat** option but you can't connect to the
chat window, first perform the following checks:

- Ensure that you've configured your browser to allow pop-up windows in
  Support Center.

###### Note

Review the settings for your browser. For more information, see the
[Chrome Help](https://support.google.com/chrome/answer/95472?hl=en&co=GENIE.Platform%3DDesktop#zippy=%2Callow-pop-ups-and-redirects-from-a-site "https://support.google.com/chrome/answer/95472?hl=en&co=GENIE.Platform%3DDesktop#zippy=%2Callow-pop-ups-and-redirects-from-a-site") and [Firefox Support](https://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting "https://support.mozilla.org/en-US/kb/pop-blocker-settings-exceptions-troubleshooting") websites.
