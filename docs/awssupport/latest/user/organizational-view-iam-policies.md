...
If you enabled AWS CloudTrail in your account, the following roles can appear in your
log entries:

- `AWSServiceRoleForTrustedAdvisorReporting` – The
  service-linked role that Trusted Advisor uses to access accounts in your
  organization.
