...
- **Security of the cloud** – AWS is
  ...
  programs that apply to AWS Support, see [AWS services in scope
...
- **Security in the cloud** – Your responsibility
  ...
  using Support. The following topics show you how to configure Support to meet your security and
  compliance objectives. You also learn how to use other Amazon Web Services that help you to monitor
  and secure your Support resources.
