...
+ [EBS Provisioned IOPS SSD (io1) Volume Aggregate IOPS](#ebs-provisioned-iops-ssd-volume-aggregate-iops)
...
+ [Lambda Code Storage Usage](#Lambda-Code-Storage-Usage)
...
**Additional Resources**  
+ [Lambda Code Storage Usage](https://docs.aws.amazon.com/lambda/latest/dg/gettingstarted-limits.html)
