...
+ **Autonomous investigation for operational issues:** For operational issues such as performance degradation, elevated error rates, or post-deployment regressions, customers can invoke [AWS DevOps Agent](https://docs.aws.amazon.com/devopsagent/latest/userguide/) to autonomously query observability services in your account, identify root cause, and generate a mitigation plan, streaming progress directly in your support interaction. On first use, the Support Center Console prompts you to get explicit consent to enable the DevOps Agent. To learn more, see [Using AWS DevOps Agent with your AWS Support plan](https://aws.amazon.com/premiumsupport/plans/).
...
+ [Managing attachments](manage-attachments.md)
