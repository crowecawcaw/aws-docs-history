...
- Global Accelerator does not support Gateway Load Balancer inspection between Global Accelerator and an endpoint when client IP
  address preservation is enabled.
