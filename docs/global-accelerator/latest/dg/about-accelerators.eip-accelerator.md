...
For more information, see [Create accelerator](about-accelerators.creating-editing.md "about-accelerators.creating-editing.md").
...
- The global static IP addresses provisioned by Global Accelerator remain assigned to you for as long as your accelerator exists,
  ...
  lose the static IP addresses that are assigned to it. For more information, see [Delete accelerator](about-accelerators.deleting.md "about-accelerators.deleting.md").
