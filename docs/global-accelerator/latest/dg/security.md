...
- **Security in the cloud** – Your responsibility is
  ...
  using Global Accelerator. The following topics show you how to configure Global Accelerator to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Global Accelerator resources.

###### Contents

- [Identity and Access Management](security-iam.md "security-iam.md")
- [Secure VPC connections](secure-vpc-connections.md "secure-vpc-connections.md")
