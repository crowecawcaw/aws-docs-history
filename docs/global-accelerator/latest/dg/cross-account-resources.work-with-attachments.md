...
- [Create cross-account attachments](cross-account-resources.create-attachment.md "cross-account-resources.create-attachment.md")
- [Edit cross-account attachments](cross-account-resources.edit-attachment.md "cross-account-resources.edit-attachment.md")
- [Delete cross-account attachments](cross-account-resources.delete-attachment.md "cross-account-resources.delete-attachment.md")
