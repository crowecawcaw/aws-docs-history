...
preservation, see [Best practices for ENIs and security groups with client IP address preservation](best-practices-aga.md "best-practices-aga.md").
...
works with elastic network interfaces, see [Best practices for ENIs and security groups with client IP address preservation](best-practices-aga.md "best-practices-aga.md").
