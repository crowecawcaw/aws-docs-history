...
information, see [How to update an accelerator to change an IP address](using-byoip.update-accelerator.md#using-byoip.update-accelerator.how-to "using-byoip.update-accelerator.md#using-byoip.update-accelerator.how-to").
