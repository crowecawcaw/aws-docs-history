...
[add an accelerator at the same time](../../../elasticloadbalancing/latest/application/create-application-load-balancer.md "../../../elasticloadbalancing/latest/application/create-application-load-balancer.md"). Elastic Load Balancing and Global Accelerator work together to transparently add the accelerator for you.
...
see [Identity-based policy examples for AWS Global Accelerator](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
accelerator. For more information, see [View your accelerators](about-accelerators.viewing.md "about-accelerators.viewing.md") and [Create accelerator](about-accelerators.creating-editing.md "about-accelerators.creating-editing.md").
...
3. Delete the accelerator. For more
   information, see [Delete accelerator](about-accelerators.deleting.md "about-accelerators.deleting.md").
