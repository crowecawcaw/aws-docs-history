...
Before you create a custom routing accelerator, make sure that you review the best practices described in [Guidelines and restrictions for custom routing accelerators](about-custom-routing-guidelines.md).
