...
As a managed service, AWS Global Accelerator is protected by AWS global network security. For
...
You use AWS published API calls to access Global Accelerator through the network. Clients must
