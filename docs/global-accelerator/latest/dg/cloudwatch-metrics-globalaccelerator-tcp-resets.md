...
- [TCP\_AGA\_Reset\_Count](#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.aga-reset-count "#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.aga-reset-count")
- [TCP\_Client\_Reset\_Count](#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.client-reset-count "#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.client-reset-count")
- [TCP\_Endpoint\_Reset\_Count](#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.endpoint-reset-count "#cloudwatch-metrics-globalaccelerator-tcp-resets-definitions.endpoint-reset-count")
...
connection is in a TIME\_WAIT state. In response to the ACK challenge, Global Accelerator sends
...
with ACK challenge instead of SYN-ACK during **TIME\_WAIT** state. This response
...
that belongs to the previous connection is still in TIME\_WAIT (< 2MSL), the endpoint
