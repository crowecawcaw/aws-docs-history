...
This section explains how to remove endpoint groups for your custom routing accelerator on
...
# To remove an endpoint group for a custom routing accelerator
