...
This section explains how to create a cross-account attachment by using
...
4. Add the AWS accounts or the ARNs for the accelerators, or both, that you want to allow to
   add your resources.
5. Select the resources that you want to allow to be used. For example, to add resources that can be added as endpoints,
