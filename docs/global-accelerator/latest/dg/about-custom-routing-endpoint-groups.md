...
- [Add endpoint group](about-custom-routing-endpoint-groups.create-endpoint-group.md "about-custom-routing-endpoint-groups.create-endpoint-group.md")
- [Edit endpoint group](about-custom-routing-endpoint-groups.edit-endpoint-group.md "about-custom-routing-endpoint-groups.edit-endpoint-group.md")
- [Remove endpoint group](about-custom-routing-endpoint-groups.remove-endpoint-group.md "about-custom-routing-endpoint-groups.remove-endpoint-group.md")
