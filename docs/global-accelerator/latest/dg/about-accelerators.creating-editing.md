...
6.  Optionally, if you brought your own IP address ranges to AWS (BYOIP), you can specify a static IP address
    ...
    [Requirements when you update an accelerator to change the IP address.](using-byoip.update-accelerator.md#AGAUpdateAccRequirements "using-byoip.update-accelerator.md#AGAUpdateAccRequirements")
