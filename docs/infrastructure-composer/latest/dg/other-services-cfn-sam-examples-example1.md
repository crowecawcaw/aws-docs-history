...
**Note**  
To learn more about the demo application, see [Load and modify the Infrastructure Composer demo project](getting-started-demo.md).
...
1. Now, the application is ready to be deployed. We will use **sam deploy --guided**. This prepares your application for deployment through a series of prompts.
