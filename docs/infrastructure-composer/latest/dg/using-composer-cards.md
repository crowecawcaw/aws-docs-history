...
An **Enhanced component card** is A collection of AWS CloudFormation resources that have been combined into a single curated card that enhances ease of use, functionality,
