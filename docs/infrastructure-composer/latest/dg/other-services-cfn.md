...
+ **[How to use AWS Serverless Application Model (AWS SAM)](https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/chapter-using-sam.html)**: This topic, which is in the *AWS Serverless Application Model Developer Guide*, provides a high-level overview of the steps you need to complete to use AWS SAM to deploy your application to the AWS Cloud. 
