...
![Standard IaC resource cards in the Resources palette.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_12.png)
...
![A standard IaC resource cluster card.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_08.png)
...
![A DemoLambdaFunction standard component card that includes two standard IaC resource cards.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_13.png)
...
![Two standard component cards. One is an AWS::Lambda::Function card and the other is an AWS::IAM::Role card.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_14.png)
...
![The Resource properties panel for the AWS::Lambda::Function standard component card.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_15.png)


After saving our template, the two standard component cards combine into a single standard component card.

![A standard component card that includes two CloudFormation resources.](https://docs.aws.amazon.com/infrastructure-composer/latest/dg/images/aac_cards_16.png)
