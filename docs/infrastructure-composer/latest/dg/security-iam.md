...
(have permissions) to use Infrastructure Composer resources. IAM is an AWS service that you can
...
- [How AWS Infrastructure Composer works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")

## Audience

Infrastructure Composer requires, at minimum, read-only access to the AWS Management Console. Any user with this authorization
can use all features of Infrastructure Composer. Granular access to specific features of Infrastructure Composer is not supported.
