...
For information on using Infrastructure Composer in CloudFormation console mode, see [Using Infrastructure Composer in CloudFormation console mode](using-composer-console-cfn-mode.md "using-composer-console-cfn-mode.md").
