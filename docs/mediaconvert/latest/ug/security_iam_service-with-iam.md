...
To view examples of MediaConvert identity-based policies, see [Identity-based policy examples for AWS Elemental MediaConvert](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
