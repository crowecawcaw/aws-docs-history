...
<a name="supported-inputs-outputs"></a>
...
**Topics**
+ [Supported input formats](reference-codecs-containers-input.md)
+ [Supported output formats](reference-codecs-containers.md)
+ [Containers and codecs reference tables](supported-containers-codecs-details.md)
