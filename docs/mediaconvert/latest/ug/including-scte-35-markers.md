...
<a name="including-scte-35-markers"></a>
...
+ The service passes markers through from your input to the output. For more information, see [Configuring SCTE-35 marker passthrough from your input](passing-through-scte-35-markers.md).
...
+ You can have the service blank out audio and video during the ad avails indicated by the SCTE-35 markers. For more information, see [Configuring ad avail blanking](ad-avail-blanking.md).
...
**Topics**
+ [Configuring SCTE-35 marker passthrough from your input](passing-through-scte-35-markers.md)
...
+ [Configuring ad avail blanking](ad-avail-blanking.md)
+ [SCTE-35 limitations](scte-35-limitations.md)