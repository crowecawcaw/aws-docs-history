...
[HLS authoring specification for Apple devices](https://developer.apple.com/documentation/http_live_streaming/hls_authoring_specification_for_apple_devices "https://developer.apple.com/documentation/http_live_streaming/hls_authoring_specification_for_apple_devices").

When you set **Accessibility subtitles**
(`accessibility`) to **Enabled**
(`ENABLED`), MediaConvert adds the following attributes to the
