...
In order to get a watermarking embedding license, contact [Kantar Media support](https://kantarmedia.atlassian.net/wiki/spaces/WS/overview "https://kantarmedia.atlassian.net/wiki/spaces/WS/overview") with following information:
...
- AuthorisationCode for each piece od hardware, or login contact for the online
  solution
