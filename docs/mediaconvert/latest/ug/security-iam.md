...
+ [How AWS Elemental MediaConvert works with IAM](security_iam_service-with-iam.md)
+ [Identity-based policy examples for AWS Elemental MediaConvert](security_iam_id-based-policy-examples.md)
+ [Cross-service confused deputy prevention](cross-service-confused-deputy-prevention.md)
+ [Troubleshooting AWS Elemental MediaConvert identity and access](security_iam_troubleshoot.md)
