...
- [Troubleshooting AWS Elemental MediaConvert identity and
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS Elemental MediaConvert identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
