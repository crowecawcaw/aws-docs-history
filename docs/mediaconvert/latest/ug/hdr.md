...
You can set up your CMAF outputs to be compatible with Apple HLS player devices. For more information, see [Creating HDR HLS outputs that comply with the Apple specification](creating-hdr-hls-outputs-that-comply-with-the-apple-specification.md).
...
You can convert your input color space to a different output color space. You do that by choosing the output color space in the output **Color corrector** settings. For detailed instructions, see [Color space conversion](converting-the-color-space.md).
...
+ [Creating HDR HLS outputs that comply with the Apple specification](creating-hdr-hls-outputs-that-comply-with-the-apple-specification.md)
+ [Replacing inaccurate or missing HDR metadata](replacing-inaccurate-or-missing-hdr-metadata.md)
+ [Requirements for creating HDR10\+ outputs](hdr10plus-limitations.md)