...
<a name="including-scte-35-information-in-your-hls-manifest"></a>
...
1. Set up your input, output groups, and outputs for video and audio, following the procedure in [Configuring SCTE-35 passthrough](passing-through-scte-35-markers.md) or [Inserting SCTE-35 with ESAM](specifying-scte-35-markers-using-esam-xml.md).
