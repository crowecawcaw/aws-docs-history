...
- **Security of the cloud** – AWS is responsible for
  ...
  learn about the compliance programs that apply to AWS Elemental MediaConvert, see [AWS Services in scope by
...
- **Security in the cloud** – Your responsibility is
  ...
  using MediaConvert. The following topics show you how to configure MediaConvert to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your MediaConvert resources.
...
- [Infrastructure security in AWS Elemental MediaConvert](infrastructure-security.md "infrastructure-security.md")
