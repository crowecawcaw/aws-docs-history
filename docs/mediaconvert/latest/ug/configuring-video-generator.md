...
1. See [Step 3: Create output groups](setting-up-a-job.md#specify-output-groups) and [Step 4: Create outputs](setting-up-a-job.md#create-outputs) to set up your outputs.
