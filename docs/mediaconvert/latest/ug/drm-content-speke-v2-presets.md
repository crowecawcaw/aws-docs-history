...
| ------------------------ | ----------- | -------------- | -------------------------------------------------------------------------------------------------------- | ------------------ | ------------------ |
| **PRESET_VIDEO_1**       | 1           | VIDEO          | No minimum or maximum resolution. MediaConvert encrypts all<br>tracks with the same key.                 |
...
| ------------------------ | ----------- | -------------- | ---------------------------------------------------------------------------------------------------------------- | -------------------------- | -------------------------- |
| **PRESET_AUDIO_1**       | 1           | AUDIO          | No minimum or maximum number of channels. MediaConvert<br>encrypts all audio and video tracks with the same key. |
