...
SPEKE v2.0 DRM support| **Output group type** | **Apple Fairplay** | **Google Widevine** | **Microsoft PlayReady** |
| **DASH** | _Not supported_ | Supported | Supported |
...
The following table lists the different DRM [system IDs](https://dashif.org/identifiers/content_protection/ "https://dashif.org/identifiers/content_protection/") that MediaConvert supports.

|                                                   |                                      |                                      |                                      |
| ------------------------------------------------- | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| **System IDs – Support<br>matrix for DRM system** | **Apple<br>FairPlay**                | **Google<br>Widevine**               | **Microsoft<br>PlayReady**           |
