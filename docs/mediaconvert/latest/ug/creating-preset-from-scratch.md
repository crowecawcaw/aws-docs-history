...
# Creating a preset
<a name="creating-preset-from-scratch"></a>
...
You can create a custom preset by individually specifying the settings, as described in this topic. Or you can create a custom preset by duplicating and modifying an existing preset, as described in [Creating a preset, based on a system preset](create-custom-preset-from-system-preset.md).
