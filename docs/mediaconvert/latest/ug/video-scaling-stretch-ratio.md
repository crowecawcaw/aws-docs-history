...
| Input width greater than output width<br>Input height less than output height    | Blue user icon centered within a rectangular frame with dimensions labeled.            | Bounding box diagram showing dimensions of 500, 400, 200, and 300 pixels around an object. |
