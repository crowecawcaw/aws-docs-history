...
1. Open the [Job templates](https://console.aws.amazon.com/mediaconvert/home#/templates/list) page in the MediaConvert console.
...
1. In the **Job settings** pane, in the **IAM role** dropdown list, choose the service role that you created to grant permissions to MediaConvert to access your resources on your behalf. For instructions on creating this role, see [Setting up IAM permissions](iam-role.md).