...
**Topics**
+ [Choosing between input and output overlays](choosing-between-input-overlay-and-output-overlay.md)
+ [Configuring input overlays](setting-up-still-graphic-overlays-in-inputs.md)
+ [Configuring output overlays](setting-up-still-graphic-overlays-in-outputs.md)
+ [Placing your image overlay](placing-your-still-graphic-overlay.md)
+ [Sizing your overlay for scaling](about-overlay-scaling.md)
+ [Understanding overlay layers](using-multiple-overlays.md)
