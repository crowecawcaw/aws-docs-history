...
**Topics**
+ [Configuring manual video rotation](manually-specified-rotation.md)
+ [Configuring automatically detected rotation](automatic-rotation.md)
+ [Input file requirements for video rotation](auto-rotate-requirements.md)