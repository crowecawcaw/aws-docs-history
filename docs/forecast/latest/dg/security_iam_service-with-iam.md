...
Before you use IAM to manage access to Forecast, learn what IAM features are
available to use with Forecast.

| IAM features you can use with Amazon Forecast                                                                                                                               | IAM feature | Forecast support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ---------------- |
...
To get a high-level view of how Forecast and other AWS services work with most IAM
...
To view examples of Forecast identity-based policies, see [Identity-based policy
examples for Amazon Forecast](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within Forecast
...
To see a list of Forecast actions, see [Actions defined by Amazon Forecast](../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions") in the
...
To see a list of Forecast resource types and their ARNs, see
[Resources defined by Amazon Forecast](../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon Forecast](../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions").
...
To see a list of Forecast condition keys, see [Condition keys for Amazon Forecast](../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-policy-keys "../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Amazon Forecast](../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonforecast.md#amazonforecast-actions-as-permissions").
...
principal permissions for Forecast
...
Changing the permissions for a service role might break Forecast functionality.
Edit service roles only when Forecast provides guidance to do so.
