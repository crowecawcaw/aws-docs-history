...
- **Security of the cloud** – AWS is
  ...
  programs that apply to Amazon Forecast, see [AWS Services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using Forecast. The following topics show you how to configure Forecast to meet
  your security and compliance objectives. You also learn how to use other AWS services that
  help you to monitor and secure your Forecast resources.

###### Topics

- [Data Protection in Amazon Forecast](data-protection.md "data-protection.md")
- [Identity and Access Management for Amazon Forecast](security-iam.md "security-iam.md")
- [Logging and Monitoring in Amazon Forecast](logging-monitoring.md "logging-monitoring.md")
