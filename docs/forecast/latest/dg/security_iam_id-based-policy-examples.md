...
+ [Example 5: Allow all Amazon Forecast Actions with Pass Role and KMS Actions](#example-managed-policy-allow-all-forecast-actions)

### Example 1: Grant Account Administrator Permissions
<a name="example-managed-policy-full-admin"></a>
...
<a name="example-managed-policy-all-actions"></a>
...
<a name="example-managed-policy-limit-passrole"></a>
...
<a name="example-managed-policy-read-only-access"></a>
