...
As a managed service, Amazon Forecast is protected by AWS global network security. For
...
You use AWS published API calls to access Forecast through the network. Clients must
