...
their item\_id and dimension values to an S3 bucket. You must also define the attributes and attribute types of the time series
in a schema.
...
4. Choose **Create forecast export**. The
   **my\_forecast** page is displayed.
