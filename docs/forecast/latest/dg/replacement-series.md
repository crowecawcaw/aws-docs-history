...
| Replacement dataset | item_id    | timestamp | price |
| ------------------- | ---------- | --------- | ----- |
...
| Replacement dataset with an unchanged column | item_id    | timestamp | price | stock_count |
| -------------------------------------------- | ---------- | --------- | ----- | ----------- |
| item_1                                       | 2022-08-02 | 90        | 50    |
| item_1                                       | 2022-08-03 | 90        | 50    |

| Replacement dataset with unchanged rows | item_id    | timestamp | price |
| --------------------------------------- | ---------- | --------- | ----- |
...
| Replacement dataset with unchanged rows and columns | item_id    | timestamp | price | stock_count |
| --------------------------------------------------- | ---------- | --------- | ----- | ----------- |
| item_1                                              | 2022-08-01 | 100       | 50    |
| item_1                                              | 2022-08-02 | 90        | 50    |
| item_1                                              | 2022-08-03 | 90        | 50    |
...
| Replacement dataset with missing values | item_id    | timestamp | price | stock_count |
| --------------------------------------- | ---------- | --------- | ----- | ----------- |
| item_1                                  | 2022-08-02 | 90        |       |
| item_1                                  | 2022-08-03 | 90        |       |
...
| Replacement dataset with extraneous values | item_id    | timestamp | price | stock_count |
| ------------------------------------------ | ---------- | --------- | ----- | ----------- |
| item_1                                     | 2022-08-01 | 100       | 50    |
| item_1                                     | 2022-08-02 | 100       | 50    |
| item_1                                     | 2022-08-03 | 100       | 50    |
...
| Replacement dataset with values outside the forecast horizon | item_id    | timestamp | price | stock_count |
| ------------------------------------------------------------ | ---------- | --------- | ----- | ----------- |
