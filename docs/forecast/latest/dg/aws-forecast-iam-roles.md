...
+ [Create an IAM Role for Amazon Forecast (AWS CLI)](#aws-forecast-create-iam-role-with-cli)
...
------
   ...
   1. Optionally, you can assign tags to this policy. Click **Next: Review**.
...
1. In the navigation pane, choose **Roles**. Then do the following to create the IAM role:
   ...
   1. In the **Add permissions** section, click **Next**.

   1. In the **Name, review, and create** section, for **Role name**, enter a name for the role (for example, `ForecastRole`). Update the description for the role in **Role description**, then choose **Create role**.

   1. You should now be back at the **Roles** page. Choose the new role to open the role's details page.
