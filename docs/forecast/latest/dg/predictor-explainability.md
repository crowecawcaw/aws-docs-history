...
![Price increases impact score by 1, Promo by 0.176, while StoreLocation decreases it by 0.5442.](https://docs.aws.amazon.com/forecast/latest/dg/images/quicksight-unfiltered.png)
...
![Table showing normalized impact scores for price, promotion, weather index, and holiday factors.](https://docs.aws.amazon.com/forecast/latest/dg/images/explainability-global.png)
