...
| [CreateExplainability](https://docs.aws.amazon.com/forecast/latest/dg/API_CreateExplainability.html) | Forecast Explainability Creation State Change | ACTIVE, CREATE\_IN\_PROGRESS, CREATE\_FAILED, CREATE\_STOPPED | 
...
| [CreateExplainabilityExport](https://docs.aws.amazon.com/forecast/latest/dg/API_CreateExplainabilityExport.html) | Forecast Explainability Export Creation State Change | ACTIVE, CREATE\_IN\_PROGRESS, CREATE\_FAILED, CREATE\_STOPPED | 
| [CreateWhatIfAnalysis](https://docs.aws.amazon.com/forecast/latest/dg/API_CreateWhatIfAnalysis.html) | Forecast What-if Analysis Creation State Change | ACTIVE, CREATE\_IN\_PROGRESS, CREATE\_FAILED, CREATE\_STOPPED | 
| [CreateWhatIfForecast](https://docs.aws.amazon.com/forecast/latest/dg/API_CreateWhatIfForecast.html) | Forecast What-if Forecast Creation State Change | ACTIVE, CREATE\_IN\_PROGRESS, CREATE\_FAILED, CREATE\_STOPPED | 
| [CreateWhatIfForecastExport](https://docs.aws.amazon.com/forecast/latest/dg/API_CreateWhatIfForecastExport.html) | Forecast What-if Forecast Export Creation State Change | ACTIVE, CREATE\_IN\_PROGRESS, CREATE\_FAILED, CREATE\_STOPPED | 
...
| [DeleteExplainability](https://docs.aws.amazon.com/forecast/latest/dg/API_DeleteExplainability.html) | Forecast Explainability Deletion State Change | DELETE\_IN\_PROGRESS, DELETE\_FAILED | 
| [DeleteExplainabilityExport](https://docs.aws.amazon.com/forecast/latest/dg/API_DeleteExplainabilityExport.html) | Forecast Explainability Export Deletion State Change | DELETE\_IN\_PROGRESS, DELETE\_FAILED | 
| [DeleteWhatIfAnalysis](https://docs.aws.amazon.com/forecast/latest/dg/API_DeleteWhatIfAnalysis.html) | Forecast What-if Analysis Deletion State Change | DELETE\_IN\_PROGRESS, DELETE\_FAILED | 
| [DeleteWhatIfForecast](https://docs.aws.amazon.com/forecast/latest/dg/API_DeleteWhatIfForecast.html) | Forecast What-if Forecast Deletion State Change | DELETE\_IN\_PROGRESS, DELETE\_FAILED | 
| [DeleteWhatIfForecastExportJob](https://docs.aws.amazon.com/forecast/latest/dg/API_DeleteWhatIfForecastExport.html) | Forecast What-if Forecast Export Deletion State Change | DELETE\_IN\_PROGRESS, DELETE\_FAILED | 
