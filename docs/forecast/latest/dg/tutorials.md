 ...
 **Tutorials** 
+ [Automating Forecast with CloudFormation](tutorial-cloudformation.md) - Use an CloudFormation stack to automatically deploy datasets to an S3 bucket and trigger a Forecast pipeline. 