...
+ [Device pools](#devices-pools)
+ [Private devices](#devices-private)
+ [Device branding](#devices-branding)
+ [Device slots](#device-slots)
+ [Preinstalled device apps](#devices-apps)
+ [Device capabilities](#devices-capabilities)
