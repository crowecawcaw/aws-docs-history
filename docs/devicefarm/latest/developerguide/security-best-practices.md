...
- Avoid logging sensitive data, such as credentials or personal information, on the device or in your test
  framework. Logs, videos, screenshots, and other artifacts generated during a run are retained by Device Farm so that
  you can review them after the run completes. For more information on best practices in custom
  test environments, see [Best practices for custom test environment execution](custom-test-environments-best-practices.md "custom-test-environments-best-practices.md").
