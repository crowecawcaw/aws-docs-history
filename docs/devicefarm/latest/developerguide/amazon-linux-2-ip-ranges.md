...
| **52.13.151.244**  |
| **52.35.189.191**  |
| **54.201.250.26**  | For more information about Android test environments in Device Farm, see [Amazon Linux 2 test environment for Android tests](amazon-linux-2.md "amazon-linux-2.md"). |
