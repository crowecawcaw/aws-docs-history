...
| Node.js 22      | amazon_linux_2<br>macos_sequoia  | `devicefarm-cli use node 22`     |
...
| Python 3.12     | amazon_linux_2<br>macos_sequoia  | `devicefarm-cli use python 3.12` |
...
| Appium 3        | amazon_linux_2<br>macos_sequoia  | `devicefarm-cli use appium 3`    |
