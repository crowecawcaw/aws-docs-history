...
+ [Built-in: fuzz (Android and iOS)](test-types-built-in-fuzz.md) – The fuzz test randomly sends user interface events to devices and then reports results.

For more information about tests and testing frameworks in Device Farm, see [Test frameworks and built-in tests in AWS Device Farm](test-types.md).
