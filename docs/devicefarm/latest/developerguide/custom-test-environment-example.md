# Example of the Device Farm test spec file

The test spec is a file that you use to define custom test environments in AWS Device Farm. For more information
about the custom environments and the test spec file, see [Custom test environments in AWS Device Farm](custom-test-environments.md "custom-test-environments.md").. For more information about the test spec file's structure
and contents, see [Test spec syntax in Device Farm](custom-test-environment-yaml-file-structure.md "custom-test-environment-yaml-file-structure.md").

The following is an example of a Device Farm YAML test spec that configures an Appium Java TestNG test
run.
