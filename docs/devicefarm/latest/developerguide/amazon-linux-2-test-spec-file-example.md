...
The following snippet is an example of a Device Farm test spec file that configures an Appium NodeJS test run
using the Amazon Linux 2 test host for Android:
