...
All of the Device Farm actions are logged and documented in the [AWS CLI reference](cli-ref.md) and the [Automating Device Farm](api-ref.md). For example, calls to create a new project or run in Device Farm generate entries in CloudTrail log files. 
