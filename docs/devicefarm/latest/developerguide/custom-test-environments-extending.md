...
AWS Device Farm enables configuring a custom environment for automated testing (custom mode), which is the recommended
approach for all Device Farm users. The Device Farm custom mode enables you to run more than just your test suite. In this
section, you learn how to extend your test suite and optimize your tests.

For more information about custom test environments in Device Farm, see [Custom test environments in AWS Device Farm](custom-test-environments.md "custom-test-environments.md").
