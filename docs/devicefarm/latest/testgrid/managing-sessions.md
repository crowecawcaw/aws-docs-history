...
+ Artifacts, which are records of the results of events. For more information, see [Artifacts in Device Farm desktop browser testing](managing-artifacts.md).
+ Actions, which are the series of events that created artifacts. For more information, see [Actions in Device Farm desktop browser testing](managing-actions.md).
