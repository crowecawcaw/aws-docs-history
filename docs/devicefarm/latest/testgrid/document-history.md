...
| --- | --- | --- | 
| Rate Limit Workarounds | We've added workarounds for common ways that test suites run into rate limits. For more information, see [Rate limit errors during session creation](troubleshooting.md#troubleshooting-limits). | September 25, 2020 | 
