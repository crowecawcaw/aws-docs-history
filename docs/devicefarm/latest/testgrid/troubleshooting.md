...
**Topics**
+ [Can't connect to a `RemoteWebDriver`](#troubleshooting-cannot-connect-webdriver)
+ [Timeouts when setting up `RemoteWebDriver`](#troubleshooting-timeout-framework)
+ [Rate limit errors during session creation](#troubleshooting-limits)
+ [I get errors during session creation](#troubleshooting-expected-browser)
+ [Browser can't connect to my app](#troubleshooting-cannot-connect-browser)
+ [Selenium 3 WebDriver testing framework is not working properly with Microsoft Edge (Chromium)](#troubleshooting-edge-dependencies)
+ [My tests using XPath are slow](#troubleshooting-xpath-slow)

## Can't connect to a `RemoteWebDriver`
<a name="troubleshooting-cannot-connect-webdriver"></a>
...
<a name="troubleshooting-timeout-framework"></a>
...
<a name="troubleshooting-limits"></a>
...
For more information, see [Quotas in Device Farm desktop browser testing](techref-limits.md). 

### Session creation rate management
<a name="troubleshooting-limits-session-creation-rate"></a>
...
<a name="troubleshooting-limits-actions-rate-management"></a>
...
<a name="troubleshooting-expected-browser"></a>
...
+ [Supported browsers](techref-support.md#techref-support-browsers)
+ [Supported platforms](techref-support.md#techref-support-platforms)

## Browser can't connect to my app
<a name="troubleshooting-cannot-connect-browser"></a>
...
<a name="troubleshooting-edge-dependencies"></a>

Selenium 3 requires the *Selenium Tools for Microsoft Edge* package to be able to support the Edge browser. For more information, see [Using Selenium 3](https://docs.microsoft.com/en-us/microsoft-edge/webdriver-chromium/?tabs=python#using-selenium-3).

Note that Selenium 4 contains built-in support for Edge.

## My tests using XPath are slow
<a name="troubleshooting-xpath-slow"></a>
