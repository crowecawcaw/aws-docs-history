...
that the application under test is behaving as expected. For more information about Selenium, see the [Selenium documentation](https://selenium.dev/documentation/ "https://selenium.dev/documentation/").
