...
WDL lenient supports type conversion for the following items in the list of WDL’s [limited exceptions](https://github.com/openwdl/wdl/blob/wdl-1.1/SPEC.md#-limited-exceptions "https://github.com/openwdl/wdl/blob/wdl-1.1/SPEC.md#-limited-exceptions"):
