...
| Workflows<br>• Workflow definition file size<br>• API (definitionZip direct upload) | The maximum size of the workflow definition file when you create the workflow using the API<br>operation or an AWS SDK with definitionZip (direct upload).                                                  | 4.4 MB                | No                |
| Workflows<br>• Workflow definition file size<br>• API (definitionUri S3 upload)     | The maximum size of the workflow definition file when you create the workflow using the API<br>operation or an AWS SDK with definitionUri (S3 upload).                                                      | 100 MB                | No                |
