...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS HealthOmics. The following topics show you how to configure AWS HealthOmics to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS HealthOmics resources.

###### Topics

- [Data protection in AWS HealthOmics](data-protection.md "data-protection.md")
