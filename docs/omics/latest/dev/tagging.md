...
**Topics**
+ [Important notice](#important-notice-tagging)
+ [Tagging HealthOmics resources](#tagging-using-Omics)
+ [Sequence store read set tags](#sequence-store-read-tags)
+ [Adding a tag to a HealthOmics resource](add-a-tag.md)
