...
**Note**  
The HealthOmics licensing server proxy for Sentieon is not available for new customers. To use Sentieon software with HealthOmics workflows, we recommend that you create a Sentieon license server inside your Amazon VPC, following the instructions in [Sentieon's AWS Deployment Guide](https://support.sentieon.com/appnotes/aws_deployment/). Once a Sentieon license server is running in your VPC, you can use VPC networking to connect to the Sentieon license server in your HealthOmics workflows.
