...
+ [Sharing a private workflow using the console](#shared-workflow-create-console)
+ [Sharing a private workflow using the CLI](#shared-workflow-create-api)
+ [Accepting a shared workflow using the console](#shared-workflow-accept-console)
+ [Running a shared workflow using the console](#shared-workflow-using-console)
+ [Running a shared workflow using the API](#shared-workflow-using-api)
...
1. Use the console or API to create a run for the shared workflow. 
...
1. You provide your own input data for the workflow. 

1. The shared workflow runs in your AWS account.
...
For details about using events, see [Using EventBridge with AWS HealthOmics](eventbridge.md).
...
1. From the **Workflows** table on the **Private workflows** page, select the workflow to share, and choose **Share**.

1. In the **Share details** panel of the **Share workflow** page, enter a descriptive name for the share and enter the AWS account of the subscriber. 

1. Choose **Share resource**. The console displays resource shares in the **All resource shares** page.
...
See [Cross-account resource sharing in AWS HealthOmics](resource-sharing.md) for other API usage examples.
...
1.  If required, open the left navigation pane (≡). Choose **All Resource shares**, then choose the **Shared with me** tab.

1. From the **Resources shared with me** table , select the workflow share and then choose **Accept**.
...
1. From the **Resources shared with me** table, choose the **Resource link** for the shared workflow.

1. In the **Workflow details** page, choose **Create run**. 

   The console opens the **Create run** page, with the workflow type (shared) and **Workflow ID** pre-populated. 

1. Configure the remaining fields in the **Create run** form. For additional information, see [Starting a run using the console](starting-a-run.md#starting-a-run-console).
