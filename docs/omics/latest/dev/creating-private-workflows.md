...
**Note**  
After you create a WDL or Nextflow DSL2 workflow, use `GetWorkflow` to check the `statusMessage` field for any lint findings. For more information, see [Workflow linters in HealthOmics](workflows-linter.md).
