...
HealthOmics supports the 32xlarge and 48xlarge instances in these regions: US West (Oregon), US East (N. Virginia), Asia Pacific (Seoul), Asia Pacific (Tokyo), and US East (Ohio).
