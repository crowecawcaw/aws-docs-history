...
**Topics**
+ [Viewing domain configurations](#iot-custom-endpoints-managing-view)
+ [Updating domain configurations](#iot-custom-endpoints-managing-update)
+ [Deleting domain configurations](#iot-custom-endpoints-managing-delete)
+ [Rotating certificates in custom domains](#iot-custom-endpoints-managing-certificates)
