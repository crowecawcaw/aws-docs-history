...
**Note**  
When the `UpdateCommandExecution` MQTT request fails, the service publishes an error response to the `/rejected` topic. For a complete list of error codes and troubleshooting guidance, see [AWS IoT Commands Troubleshooting](commands-troubleshooting.md).
