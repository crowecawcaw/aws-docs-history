...
![Image showing how a JSON message payload is displayed in the MQTT client of the AWS IoT console.](https://docs.aws.amazon.com/iot/latest/developerguide/images/mqtt-test-client-output.png)
