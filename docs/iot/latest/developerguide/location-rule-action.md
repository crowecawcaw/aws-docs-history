...
- `value`: An expression that returns a long
  epoch time value. You can use the [time\_to\_epoch(String, String)](iot-sql-functions.md#iot-sql-function-time-to-epoch "iot-sql-functions.md#iot-sql-function-time-to-epoch") function to
