...
- Have your local host computer and Raspberry Pi from [the previous tutorial](iot-dc-prepare-device.md "iot-dc-prepare-device.md") ready.
...
- You'll have saved an image of your device's microSD card that can be used in subsequent
  tutorials.

###### Required equipment:

- Your local development and testing environment from [the previous section](iot-dc-prepare-device-test.md "iot-dc-prepare-device-test.md")
- The Raspberry Pi that you used in [the
  previous section](iot-dc-prepare-device-test.md "iot-dc-prepare-device-test.md")
- The microSD memory card from the Raspberry Pi that you used in [the
  previous section](iot-dc-prepare-device-test.md "iot-dc-prepare-device-test.md")
