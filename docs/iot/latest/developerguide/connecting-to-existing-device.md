...
| --- | --- | 
| {{your-iot-endpoint}} | In the [AWS IoT console](https://console.aws.amazon.com/iot/home), choose **All devices**, and then choose **Things**.<br />On the **Settings** page in the AWS IoT menu. Your endpoint is displayed in the **Device data endpoint** section. | 
