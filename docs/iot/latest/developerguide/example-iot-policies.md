...
The example policies in this section illustrate the policy documents used to
complete common tasks in AWS IoT Core. You can use them as examples to start from when
creating the policies for your solutions.
...
- [Connect policy examples](connect-policy.md "connect-policy.md")
- [Publish/Subscribe policy examples](pub-sub-policy.md "pub-sub-policy.md")
- [Connect and publish policy examples](connect-and-pub.md "connect-and-pub.md")
- [Retained message policy examples](retained-message-policy-examples.md "retained-message-policy-examples.md")
