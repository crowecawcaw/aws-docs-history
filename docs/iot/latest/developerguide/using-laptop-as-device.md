...
+ [Run the Shared Subscription example in Python](#gs-pc-shared-subscription-example)
...
![The shared subscriptions output page.](https://docs.aws.amazon.com/iot/latest/developerguide/images/shared-subscription-output.png)