...
| `iot:DeleteThingShadow`                    | `thing`       | The thing's name, and the shadow's name, if applicable | `arn:aws:iot:us-east-1:123456789012:thing/thingOne`<br>`arn:aws:iot:us-east-1:123456789012:thing/thingOne/shadowOne` |
...
| `iot:GetThingShadow`                       | `thing`       | The thing's name, and the shadow's name, if applicable | `arn:aws:iot:us-east-1:123456789012:thing/thingOne`<br>`arn:aws:iot:us-east-1:123456789012:thing/thingOne/shadowOne` |
