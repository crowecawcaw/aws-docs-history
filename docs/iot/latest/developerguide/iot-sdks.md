...
For more information, see the following:
+ [AWS IoT Device SDK for Swift on GitHub](https://github.com/aws/aws-iot-device-sdk-swift)
...
+ [AWS IoT C\+\+ Device SDK on GitHub](https://github.com/aws/aws-iot-device-sdk-cpp/tree/master)
+ [AWS IoT C\+\+ Device SDK Readme](https://github.com/aws/aws-iot-device-sdk-cpp/tree/master#new-version-available)
