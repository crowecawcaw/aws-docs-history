...
The Elasticsearch (`elasticsearch`) action writes data from MQTT messages to
...
`OpenSearch` rule action instead. For more information, see [OpenSearch](opensearch-rule-action.md "opensearch-rule-action.md").
...
- If you use a customer managed AWS KMS key (KMS key) to encrypt
  data at rest in OpenSearch, the service must have permission to use the
  KMS key on the caller's behalf. For more information, see [Encryption of data at rest
...
information, see [Requirements](#elasticsearch-rule-action-requirements "#elasticsearch-rule-action-requirements").

Supports [substitution templates](iot-substitution-templates.md "iot-substitution-templates.md"): No

## Examples

The following JSON example defines an Elasticsearch action in an AWS IoT rule and how
you can specify the fields for the `elasticsearch` action. For more
information, see [ElasticsearchAction](../apireference/API_ElasticsearchAction.md "../apireference/API_ElasticsearchAction.md").
...
The following JSON example defines an Elasticsearch action with substitution
...
- [What is Amazon OpenSearch Service?](../../../opensearch-service/latest/developerguide.md "../../../opensearch-service/latest/developerguide.md")
