...
You can use object literals in the SELECT clause to construct JSON objects with keys that contain characters not supported by standard identifiers, such as hyphens. For example:
