...
**Topics**
+ [Viewing MQTT messages in the MQTT client](#view-mqtt-subscribe)
+ [Publishing MQTT messages from the MQTT client](#view-mqtt-publish)
+ [Testing Shared Subscriptions in the MQTT client](#view-mqtt-shared-subscriptions)
