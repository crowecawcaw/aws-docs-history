...
| --- | --- | --- | 
| $aws/device\_location/{{customer\_device\_id}}/get\_position\_estimate | Publish | A device publishes to this topic to get the scanned raw measurement data to be resolved by AWS IoT Core Device Location. | 
| $aws/device\_location/{{customer\_device\_id}}/get\_position\_estimate/accepted | Subscribe | AWS IoT Core Device Location publishes the location information to this topic when it successfully resolves the device location. | 
| $aws/device\_location/{{customer\_device\_id}}/get\_position\_estimate/rejected | Subscribe | AWS IoT Core Device Location publishes the error information to this topic when it fails to resolve the device location. | 
...
AWS IoT Core Device Location responds by publishing to either [/get\_position\_estimate/accepted](#get-position-estimate-accepted) or [/get\_position\_estimate/rejected](#get-position-estimate-rejected).
