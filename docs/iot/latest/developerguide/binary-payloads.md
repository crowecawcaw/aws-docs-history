...
**Topics**
+ [Binary payload examples](#binary-payloads-examples)
+ [Decoding protobuf message payloads](#binary-payloads-protobuf)
...
**Topics**
+ [Prerequisites](#binary-payloads-protobuf-prerequisites)
+ [Create descriptor files](#binary-payloads-protobuf-descriptor-steps)
+ [Upload descriptor files to S3 bucket](#binary-payloads-protobuf-s3-steps)
+ [Configure protobuf decoding in Rules](#binary-payloads-protobuf-steps)
