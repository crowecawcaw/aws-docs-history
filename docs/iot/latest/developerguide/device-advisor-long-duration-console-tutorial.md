...
![The Create long duration test suite section of the Device Advisor console.](https://docs.aws.amazon.com/iot/latest/developerguide/images/create-ld-ts.png)
...
![The Create test suite step of the Device Advisor console.](https://docs.aws.amazon.com/iot/latest/developerguide/images/choose-ld-ts.png)
...
![The Create test suite step of the Device Advisor console.](https://docs.aws.amazon.com/iot/latest/developerguide/images/configure-ld-ts.png)

1. (Optional) Input the maximum amount of time Device Advisor must wait for the basic tests to complete. Select **Save**.  
![The "Timeout-optional" box for "Basic tests" of the Device Advisor console.](https://docs.aws.amazon.com/iot/latest/developerguide/images/timeout-ld-ts.png)
...
![The Device Advisor interface that allows you to configure and run tests on IoT devices.](https://docs.aws.amazon.com/iot/latest/developerguide/images/additional-ld-ts.png)
...
![The device role step where you can create a new role or select an existing role for the device being tested. The role grants permissions for Device Advisor to perform MQTT actions like Connect, Publish, and Subscribe on behalf of the test device.](https://docs.aws.amazon.com/iot/latest/developerguide/images/devicerole-ld-ts.png)

1.  Review all the configurations created until this step and select **Create test suite**.   
![The "Review" page where you can review all the details of the Device Advisor configuration.](https://docs.aws.amazon.com/iot/latest/developerguide/images/finalconfigure1-ld-ts.png)  
![The configuration page where you can view all the details for Device Advisor.](https://docs.aws.amazon.com/iot/latest/developerguide/images/finalconfigure2-ld-ts.png)

1.  The created test suite is under the **Test suites** section. Select the suite to view details.   
![A new test suite named "Long Duration Demo" has been successfully created in the Device Advisor.](https://docs.aws.amazon.com/iot/latest/developerguide/images/finalts-ld-ts.png)

1.  To run the created test suite, select **Actions** then **Run test suite**.   
![The Actions dropdown menu of the new test suite named "Long Duration Demo" in the Device Advisor interface.](https://docs.aws.amazon.com/iot/latest/developerguide/images/runts-ld-ts.png)
...
![The Run configuration page in the Device Advisor interface. The page shows Select test devices, Things, Test endpoint, and Tags.](https://docs.aws.amazon.com/iot/latest/developerguide/images/runconfiguration-ld-ts.png)
...
![The "Long Duration Demo" test case on the Test runs and results page.](https://docs.aws.amazon.com/iot/latest/developerguide/images/results-ld-ts.png)
...
![The summary page of the "Long Duration Demo" test that you created.](https://docs.aws.amazon.com/iot/latest/developerguide/images/summary-ld-ts.png)
...
![The Test log summary section on the page of the "Long Duration Demo" test.](https://docs.aws.amazon.com/iot/latest/developerguide/images/log-ld-ts.png)