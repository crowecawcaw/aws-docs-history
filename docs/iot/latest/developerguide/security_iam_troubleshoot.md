# Troubleshooting AWS IoT identity
...
- [I am not authorized to
  perform an action in AWS IoT](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS IoT resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
- To learn whether AWS IoT supports these features, see [How AWS IoT works with
