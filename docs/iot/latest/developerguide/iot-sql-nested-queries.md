...
You can use nested SELECT clauses to query for attributes within arrays and inner JSON
objects. Supported by SQL version 2016-03-23 and later.
...
Using the same MQTT message, you can also query a specific value within a nested
