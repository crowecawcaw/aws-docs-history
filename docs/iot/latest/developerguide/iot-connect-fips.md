...
**Topics**
+ [AWS IoT Core - control plane endpoints](#iot-connect-fips-control)
+ [AWS IoT Core - data plane endpoints](#iot-connect-fips-data)
+ [AWS IoT Core - credential provider endpoints](#iot-connect-fips-credential)
+ [AWS IoT Device Management - jobs data endpoints](#iot-connect-fips-jobs)
+ [AWS IoT Device Management - Fleet Hub endpoints](#iot-connect-fips-fleethub)
+ [AWS IoT Device Management - secure tunneling endpoints](#iot-connect-fips-tunnel)
+ [AWS IoT Device Management - Managed Integrations endpoints](#mi-fips-endpoints)
