...
**Topics**
+ [Create and store the job document for the IoT job](#iot-dc-runjobs-prepare-define-jobdoc)
...
1. On your local host computer:
   ...
   1. Replace {{job\_document\_url}} with the job document URL from [Create and store the job document for the IoT job](#iot-dc-runjobs-prepare-define-jobdoc).
