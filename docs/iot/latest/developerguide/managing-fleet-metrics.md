...
**Topics**
+ [Managing fleet metrics (Console)](#managing-fleet-metrics-console)
+ [Managing fleet metrics (CLI)](#managing-fleet-metrics-cli)
+ [Authorize tagging of IoT resources](#managing-fleet-metrics-policy)
