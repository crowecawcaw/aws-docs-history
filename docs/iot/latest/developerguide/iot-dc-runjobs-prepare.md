...
**Topics**
+ [Create and download device certificate files to demonstrate AWS IoT jobs](#iot-dc-runjobs-prepare-cert)
+ [Create AWS IoT resources to demonstrate AWS IoT jobs](#iot-dc-runjobs-prepare-iot)
