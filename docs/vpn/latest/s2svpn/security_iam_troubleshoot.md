...
encounter when working with Site-to-Site VPN and IAM.

###### Topics

- [I am not authorized to
  perform an action in Site-to-Site VPN](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my Site-to-Site VPN resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Site-to-Site VPN
...
Site-to-Site VPN. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Site-to-Site VPN resources
...
- To learn whether Site-to-Site VPN supports these features, see [How AWS Site-to-Site VPN works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
