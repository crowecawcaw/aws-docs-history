...
- [Site-to-Site VPN connection with Direct Connect](#vpn-direct-connect "#vpn-direct-connect")
- [Private IP Site-to-Site VPN connection with Direct Connect](#private-ip-direct-connect "#private-ip-direct-connect")
...
network through AWS Direct Connect. You can configure an Direct Connect public virtual interface to
...
bound for your network routes to the virtual private gateway and the Direct Connect connection.

![Site-to-Site VPN connection with Direct Connect](images/vpn-direct-connect.png)

When both Direct Connect and the VPN connection are set up on the same virtual private gateway,
...
Direct Connect and the VPN connection to minimize interruptions and packet loss. When this is
