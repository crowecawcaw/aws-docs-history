...
+ **Direct Connect backup**: Provide backup or overlay connectivity for high-capacity Direct Connect circuits (10 Gbps\+) to on-premises data centers or colocation facilities.
...
+ You can modify the tunnel bandwidth of existing VPN connections. For more information, see [Modify tunnel bandwidth](modify-vpn-connection-options.md#modify-vpn-connection-options-tunnel-bandwidth).
