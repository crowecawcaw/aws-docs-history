...
As a managed service, AWS Site-to-Site VPN is protected by AWS global network security. For
...
You use AWS published API calls to access Site-to-Site VPN through the network. Clients must
