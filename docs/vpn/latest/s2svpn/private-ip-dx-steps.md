...
To create a private IP VPN with Direct Connect follow these steps. Before you create the private
...
customer gateway router and the Direct Connect endpoint. AWS recommends
...
attachment for the appropriate Direct Connect gateway. 19. Choose **Create VPN connection**.
