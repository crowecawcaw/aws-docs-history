...
Before you use IAM to manage access to Site-to-Site VPN, learn what IAM features are
available to use with Site-to-Site VPN.

| IAM features you can use with AWS Site-to-Site VPN                                                                                                                          | IAM feature | Site-to-Site VPN support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------ |
...
To get a high-level view of how Site-to-Site VPN and other AWS services work with most IAM
...
To see a list of Site-to-Site VPN actions, see [Actions defined by AWS Site-to-Site VPN](../../../service-authorization/latest/reference/list_amazonec2.md#your_service-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonec2.md#your_service-actions-as-permissions") in the
...
To see a list of Site-to-Site VPN resource types and their ARNs, see
[Resources defined by AWS Site-to-Site VPN](../../../service-authorization/latest/reference/list_amazonec2.md#your_service-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonec2.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of Site-to-Site VPN condition keys, see [Condition keys for AWS Site-to-Site VPN](../../../service-authorization/latest/reference/list_amazonec2.md#your_service-policy-keys "../../../service-authorization/latest/reference/list_amazonec2.md#your_service-policy-keys") in the
