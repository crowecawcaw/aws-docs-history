...
- **Security in the cloud** — Your responsibility is
  ...
  using Site-to-Site VPN. The following topics show you how to configure Site-to-Site VPN to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Site-to-Site VPN resources.

###### Contents

- [Enhanced security features using Secrets Manager](enhanced-security.md "enhanced-security.md")
