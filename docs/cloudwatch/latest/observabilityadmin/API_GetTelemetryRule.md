...
# GetTelemetryRule
<a name="API_GetTelemetryRule"></a>

 Retrieves the details of a specific telemetry rule in your account. 

## Request Syntax
<a name="API_GetTelemetryRule_RequestSyntax"></a>
...
<a name="API_GetTelemetryRule_RequestParameters"></a>

The request does not use any URI parameters.

## Request Body
<a name="API_GetTelemetryRule_RequestBody"></a>
...
## Response Syntax
<a name="API_GetTelemetryRule_ResponseSyntax"></a>
...
## Response Elements
<a name="API_GetTelemetryRule_ResponseElements"></a>
 ...
 ** [HomeRegion](#API_GetTelemetryRule_ResponseSyntax) **   <a name="cwoa-GetTelemetryRule-response-HomeRegion"></a>
 The AWS Region where the telemetry rule was originally created. For replicated rules in spoke regions, this indicates the region that manages the rule. For rules created without multi-region scope, this field is not present.   
Type: String  
Length Constraints: Minimum length of 1.

 ** [IsReplicated](#API_GetTelemetryRule_ResponseSyntax) **   <a name="cwoa-GetTelemetryRule-response-IsReplicated"></a>
 ...
 ** [RegionStatuses](#API_GetTelemetryRule_ResponseSyntax) **   <a name="cwoa-GetTelemetryRule-response-RegionStatuses"></a>
...
## Errors
<a name="API_GetTelemetryRule_Errors"></a>
...
## See Also
<a name="API_GetTelemetryRule_SeeAlso"></a>
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/observabilityadmin-2018-05-10/GetTelemetryRule) 
...
+  [AWS SDK for Python (Boto3)](https://docs.aws.amazon.com/goto/boto3/observabilityadmin-2018-05-10/GetTelemetryRule) 
