...
|             | Create/delete projects              | Create/delete project profiles      | Create/delete environment profiles  | Create/delete environments          | Add/delete members to projects | Search and discovery | Create/delete metadata forms/glossaries | Create data source runs and ingest data | Publish data | Request subscriptions | Approve/reject subscription requests | Read subscribed data from Amazon Athena and Amazon Redshift | Create asset filters |
| ----------- | ----------------------------------- | ----------------------------------- | ----------------------------------- | ----------------------------------- | ------------------------------ | -------------------- | --------------------------------------- | --------------------------------------- | ------------ | --------------------- | ------------------------------------ | ----------------------------------------------------------- | -------------------- |
| Owner       | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | Yes                            | Yes                  | Yes                                     | Yes                                     | Yes          | Yes                   | Yes                                  | Yes                                                         | Yes                  |
| Contributor | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | No                             | Yes                  | Yes                                     | Yes                                     | Yes          | Yes                   | Yes                                  | Yes                                                         | Yes                  |
| Consumer    | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | No                             | Yes                  | No                                      | No                                      | No           | Yes                   | No                                   | Yes                                                         | No                   |
| Viewer      | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | No                             | Yes                  | No                                      | No                                      | No           | No                    | No                                   | Yes                                                         | No                   |
| Steward     | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | To be managed by domain unit member | No                             | Yes                  | Yes                                     | Yes                                     | Yes          | No                    | Yes                                  | Yes                                                         | No                   |
