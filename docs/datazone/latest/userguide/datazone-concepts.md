...
|             | Create/delete projects              | Create/delete project profiles      | Create/delete environment profiles  | Create/delete environments          | Add/delete members to projects | Search and discovery | Create/delete metadata forms/glossaries | Create data source runs and ingest data | Publish data and create asset filters | Request subscriptions | Approve/reject subscription requests | Read subscribed data from Amazon Athena and Amazon Redshift |
| ----------- | ----------------------------------- | ----------------------------------- | ----------------------------------- | ----------------------------------- | ------------------------------ | -------------------- | --------------------------------------- | --------------------------------------- | ------------------------------------- | --------------------- | ------------------------------------ | ----------------------------------------------------------- |
