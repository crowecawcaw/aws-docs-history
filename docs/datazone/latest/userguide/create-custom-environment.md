...
1. Choose **View domains** and choose the domain in which your custom AWS service blueprint is enabled.

1. Choose the **Blueprints** tab, then choose the enabled **AWS service** bluepint, and then choose **Create environment**.
