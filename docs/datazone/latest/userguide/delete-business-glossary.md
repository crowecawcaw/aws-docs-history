...
terms. For more information, see [Amazon DataZone terminology and concepts](datazone-concepts.md "datazone-concepts.md"). To delete a glossary in your Amazon DataZone domain, you
must be the member of the owning project with the right permissions for that domain.
...
3. In the Amazon DataZone Data Portal, choose **Glossaries**, and locate the
   business glossary that you want to delete.
4. On the glossary details page, expand **Actions** and then choose
   **Delete** to delete the glossary.

###### Note

You must delete all existing terms in the glossary before you can delete the
glossary. 5. Confirm the deletion of the glossary by choosing **Delete**.
