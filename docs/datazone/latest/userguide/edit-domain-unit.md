...
2. Choose **View domains** and choose the domain where you want
   to edit domain units.
3. On the domain details page, navigate to the **Domain units**
   tab and choose the domain unit that you want to edit.
4. Expand **Actions** and choose **Edit domain
   unit**.
5. Make your changes to the domain unit name and description and then choose
   **Save changes**.
