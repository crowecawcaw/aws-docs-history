...
1. Choose **Browse projects**.

1. Choose the project that you want to move. If you don't readily see it in the list of projects, you can search for it by specifying the project name in the **Find project** field. 
