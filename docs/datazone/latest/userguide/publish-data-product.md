...
To publish data products, you must be the owner or the contributor of the project. [Metadata enforcement rules for publishing](metadata-rules-publishing.md) can be configured to establish clear metadata requirements for data producers, restricting when a data product can be published.
...
1. In the Amazon DataZone data portal, choose the project in which the data product that you want to publish lives.

1. Choose the **Data** tab, then choose **Inventory data**, and then choose the **Data products** filter. This displays all unpublished existing data products.
