...
<a name="republish-data-product"></a>
...
To republish a data product, you must be the owner or the contributor of the project. [Metadata enforcement rules for publishing](metadata-rules-publishing.md) can be configured to establish clear metadata requirements for data producers, restricting when a data product can be republished.
...
1. In the Amazon DataZone data portal, choose the project in which the data product that you want to republish lives.

1. Choose the **Data** tab, then choose **Published data**, and then choose the **Data products** filter.

1. Choose the data product that you want to republish, and then choose the **Assets** tab.

1. On the **Assets** tab, do one of the following:
...
1. On the data product's details page, choose **Re-publish**. Confirm this action by choosing **Republish** in the **Republish data product** pop up window. 
**Note**  
