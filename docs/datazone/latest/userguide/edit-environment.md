...
1. Choose **Browse projects** from the top navigation pane and select the project that contains the environment that you want to edit.

1. Locate and choose the environment to open its details page. Then expand **Actions** and choose **Edit environment**.

1. Make your edits to the environment's name and description, and then choose **Save changes**.