...
<a name="unpublish-data-product"></a>
...
1. In the Amazon DataZone data portal, choose the project in which the data product that you want to unpublish lives.
...
1. Choose the data product that you want to unpublish, and then expand **Actions** and choose **Unpublish**. Confirm the unpublishing of this data product by choosing **Unpublish**. 
**Note**  
