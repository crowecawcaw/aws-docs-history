...
You can monitor Amazon DataZone events in EventBridge, which delivers a stream of real-time data from
...
For more information, see [Events via Amazon EventBridge default bus](working-with-events-and-notifications.md#eventbridge-bus "working-with-events-and-notifications.md#eventbridge-bus").
