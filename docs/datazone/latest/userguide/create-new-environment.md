...
<a name="create-new-environment"></a>
...
1. Choose **Browse all projects** and select the project in which you want to create a new environment.

1. Choose **Create environment**, specify values for the following fields, and then choose **Create environment**:
