...
1. Within the data portal, choose **Browse projects** and select the project in which you want to create the environment profile.

1. Navigate to the **Environments** tab within the project, then choose **Create environment profile**.
