...
3. In the Amazon DataZone Data Portal, choose **Metadata forms** and then
   choose the metadata form where you want to edit field(s).
4. On the form's details page, choose the field that you want to edit, then expand
   **Actions**, and choose **Edit**.
5. Make your updates to the field name, description, type, and whether this is a required
   field, and then choose **Update field**.
