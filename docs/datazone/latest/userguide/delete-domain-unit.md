...
1. Choose **View domains** and choose the domain where you want to delete domain units.

1. On the domain details page, navigate to the **Domain units** tab and choose the domain unit that you want to delete.

1. Expand Actions and choose **Delete domain unit**.

1. In the **Delete domain unit** pop up window, confirm the deletion by choosing **Delete domain unit**.