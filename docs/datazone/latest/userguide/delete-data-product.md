...
1. In the Amazon DataZone data portal, choose the project in which the data product that you want to delete lives.

1. Choose the **Data** tab, then choose **Inventory data** or **Published data**, and then choose the **Data products** filter. This displays all existing data products.

1. Choose the data product that you want to delete, and then expand **Actions** and choose **Delete**. Confirm the deletion of this data product by typing `delete` in the text field and then choosing **Delete**. 
**Note**  
