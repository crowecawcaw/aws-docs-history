...
1. Choose the **Blueprints** tab and then choose the AWS service blueprint. 

1. Under **Created environments**, choose the AWS service environment where you want to configure a subscription target.

1. Choose the **Subscription targets** tab, choose **Add**, specify the following, and then choose **Add**.
