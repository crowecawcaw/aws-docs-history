...
1. Choose **Published data** or **Inventory data** from the left navigation pane, then select the asset where you want to edit a row or a column filter. 

1. On the asset detail page, go to **Asset filters** tab and then open the filter you want to edit.

1. You can edit the following field:
...
1. Once you have made the changes, choose **Edit asset filter**.
