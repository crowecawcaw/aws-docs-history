...
1. Choose the **Blueprints** tab and then choose the custom AWS service blueprint. 

1. Under **Created environments**, choose the AWS service environment where you want to configure a data source.

1. Choose the **Data sources** tab, choose **Add**, specify the following, and then choose **Add**.
