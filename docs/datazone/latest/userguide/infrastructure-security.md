...
As a managed service, Amazon DataZone is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon DataZone through the network. Clients must
