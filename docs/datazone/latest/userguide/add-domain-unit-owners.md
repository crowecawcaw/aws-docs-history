...
1. Choose **View domains** and choose the Amazon DataZone domain where you want to add domain unit owners.

1. On the domain details page, navigate to the **Domain root owners** table.

1. Choose **Add**, and then specify users that you want to make domain unit owners. Choose **Add root domain owner(s)**.
...
1. Choose **View domains** and choose the domain and the domain unit where you want to add domain unit owners.

1. On the domain unit details page, choose the **Owners** tab and then choose **Add owners**.

1. In the **Add domain unit owners** pop up window, specify the users that you want to make domain unit owners and then choose **Add owners**.