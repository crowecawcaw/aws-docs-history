...
Any Amazon DataZone user with the required permissions to access the data portal can
subscribe to an Amazon DataZone data product.
...
1. Navigate to the Amazon DataZone data portal URL and sign in using single sign-on
   ...
   portal**.
2. Choose **Browse catalog** to find the data product to which
   you want to subscribe and then choose that data product.
3. On the data product's details page, choose
   **Subscribe**.
4. Specify the project and the reason for subscribing and then choose
   **Subscribe**.
