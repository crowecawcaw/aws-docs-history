...
If you can't create a bucket, you can check the **AWS Toolkit
 ...
 and limitations](https://docs.aws.amazon.com/AmazonS3/latest/userguide/BucketRestrictions.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/BucketRestrictions.html") in the *Amazon Simple Storage Service User Guide*.
...
[To delete only a folder](https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-folders.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/delete-folders.html"), not the
