...
You can configure the IDE to your preferences.
...
(**Got it!** I'm ready to try AWS Cloud9. [How do I get started?](#how-to-get-started "#how-to-get-started"))
...
![Diagram that provides an overview of how AWS Cloud9 works](images/arch.png)

### AWS Cloud9 environments

An _AWS Cloud9 environment_ is a place where you store your project's files and where you run the tools to develop your applications.
...
- You can instruct AWS Cloud9 to connect an environment to an
...
For a more detailed list, see [What can I do with AWS Cloud9?](what-can-i-do.md "what-can-i-do.md")

## How do I get started?

To start using AWS Cloud9, follow the steps in [Setting up AWS Cloud9](setting-up.md "setting-up.md"), and then go through the [basic tutorial](tutorials-basic.md "tutorials-basic.md").

## Additional topics

- [What can I do with AWS Cloud9?](what-can-i-do.md "what-can-i-do.md")
- [Additional information about AWS Cloud9](additional-info.md "additional-info.md")
