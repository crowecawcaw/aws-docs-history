...
control [CT.EC2.PR.8](../../../controltower/latest/userguide/ec2-rules.md#ct-ec2-pr-8-description "../../../controltower/latest/userguide/ec2-rules.md#ct-ec2-pr-8-description"). If this control is enabled, you cannot create an EC2 environment in
...
your EC2 instance. 4. For **Instance type**, choose an instance type with the amount
...
[Amazon EC2 Instance Type](https://aws.amazon.com/ec2/instance-types/ "https://aws.amazon.com/ec2/instance-types/") page. 5. For **Platform**, choose the type of Amazon EC2 instance that you want:
...
page](https://aws.amazon.com/linux/amazon-linux-2023/ "https://aws.amazon.com/linux/amazon-linux-2023/"). 6. Choose a time period for **Timeout**. This option determines how long
...
AWS account. 7. On the **Network settings** panel, choose how your environment is
...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| If you're not sure what to choose, we recommend that you skip<br>ahead to the next step in this procedure.<br>If you skip past **Network settings<br>(advanced)*<br>• and leave the preselected default<br>settings, AWS Cloud9 attempts to use the default VPC with its single<br>subnet. AWS Cloud9 chooses the subnet based on the instance-type that you selected.<br>These are in the same AWS account and AWS Region as<br>the new environment. |

###### Important

If you selected **Existing compute** as your environment
type, you can launch your instance into a public or private subnet.

    * **Public subnet**: Attach an internet
     gateway to the subnet to allow the instance SSM agent to communicate with
     Systems Manager.
    * **Private subnet**: Create a NAT gateway
     to enable the instance to communicate with the internet and other
     AWS services.Currently, you can't use [AWS managed temporary credentials](security-iam.md#auth-and-access-control-temporary-managed-credentials "security-iam.md#auth-and-access-control-temporary-managed-credentials") to allow the EC2 environment to access an

AWS service on behalf of an AWS entity, such as an IAM user.

For more information about configuring subnets, see [VPC settings for AWS Cloud9 Development Environments](vpc-settings.md "vpc-settings.md").

| **Does the AWS account have access to an<br>Amazon VPC?** | **Is that VPC in the same AWS account and Region<br>as the new environment?** | **Is that VPC the default VPC for its<br>AWS account?** | **Does that VPC contain a single<br>subnet?** | **Follow these instructions**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------------------------------- | ----------------------------------------------------------------------------- | ------------------------------------------------------- | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| No                                                        | —                                                                             | —                                                       | —                                             | If no VPC exists, create one.<br>To create a VPC in the same AWS account and Region as the new<br>environment, choose **Create new VPC**, and then follow<br>the on-screen directions. For more information, see [Create a VPC plus other VPC resources](vpc-settings.md#vpc-settings-create-vpc "vpc-settings.md#vpc-settings-create-vpc").<br>To create a VPC in a different AWS account than the new environment,<br>see [Working with Shared<br>VPCs](../../../vpc/latest/userguide/vpc-sharing.md "../../../vpc/latest/userguide/vpc-sharing.md") in the<br>_Amazon VPC User Guide_.                                             |
| Yes                                                       | Yes                                                                           | Yes                                                     | Yes                                           | Skip ahead to the next step in this procedure.<br>When you skip **Network settings (advanced)**<br>and don't change the preselected default settings, AWS Cloud9 attempts<br>to use the default VPC with its single subnet in the same account<br>and Region as the new environment.                                                                                                                                                                                                                                                                                                                                                  |
| Yes                                                       | Yes                                                                           | Yes                                                     | No                                            | If the default VPC has multiple subnets, expand<br>**Network settings (advanced)**. For<br>**Subnet**, choose the subnet that you want<br>AWS Cloud9 to use in the preselected default VPC.<br>If the default VPC has no subnets, create one. To do this,<br>choose **Create new subnet**, and then follow the<br>on-screen directions. For more information, see [Create a subnet for AWS Cloud9](vpc-settings.md#vpc-settings-create-subnet "vpc-settings.md#vpc-settings-create-subnet").                                                                                                                                          |
| Yes                                                       | Yes                                                                           | No                                                      | Yes                                           | Expand **Network settings**. For<br>**Network (VPC)**, choose the VPC that you want<br>AWS Cloud9 to use.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Yes                                                       | Yes                                                                           | No                                                      | No                                            | Expand **Network settings**. For<br>**Network (VPC)**, choose the VPC that you want<br>AWS Cloud9 to use.<br>If the chosen VPC has multiple subnets, expand **Network<br>settings (advanced)**. For **Subnet**,<br>choose the subnet that you want AWS Cloud9 to use in the chosen<br>VPC.<br>If the chosen VPC has no subnets, create one. To do this, choose<br>**Create new subnet**, and then follow the<br>on-screen directions. For more information, see [Create a subnet for AWS Cloud9](vpc-settings.md#vpc-settings-create-subnet "vpc-settings.md#vpc-settings-create-subnet").                                            |
| Yes                                                       | No                                                                            | Yes                                                     | —                                             | AWS Cloud9 can't use a default VPC in an AWS account that's<br>different than the account for the new environment. Choose a different<br>option in this list.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Yes                                                       | No                                                                            | No                                                      | Yes                                           | Expand **Network settings**. For<br>**Network (VPC)**, choose the VPC that you want<br>AWS Cloud9 to use.<br>NoteThe VPC must be in the same Region as the new environment, even if<br>the VPC is in a different account.                                                                                                                                                                                                                                                                                                                                                                                                             |
| Yes                                                       | No                                                                            | No                                                      | No                                            | Expand **Network settings**. For<br>**Network (VPC)**, choose the VPC that you want<br>AWS Cloud9 to use.<br>For **Subnet**, choose the subnet you want<br>AWS Cloud9 to use in the chosen VPC.<br>If the chosen VPC has no subnets, to create a subnet for a VPC<br>in a different AWS account than the new environment, see [Working with Shared<br>VPCs](../../../vpc/latest/userguide/vpc-sharing.md "../../../vpc/latest/userguide/vpc-sharing.md") in the<br>_Amazon VPC User Guide_.<br>NoteThe VPC and subnet must be in the same Region as the new<br>environment, even if the VPC and subnet are in a different<br>account. |
...
underlying resources. For more information, see [Propagating tag updates to underlying resources](tags.md#tags-propagate "tags.md#tags-propagate") in the advanced information about [tags](tags.md "tags.md"). 10. Choose **Create** to create your environment, and then you're redirected
...
To use code to create an EC2 environment in AWS Cloud9, call the AWS Cloud9
create
EC2 environment operation, as follows.

|                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| -------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AWS CLI                          | [create-environment-ec2](../../../cli/latest/reference/cloud9/create-environment-ec2.md "../../../cli/latest/reference/cloud9/create-environment-ec2.md")                                                                                                                                                                                                                                                                                                                                                                                                                 |
| AWS SDK for C++                  | [CreateEnvironmentEC2Request](https://sdk.amazonaws.com/cpp/api/LATEST/class_aws_1_1_cloud9_1_1_model_1_1_create_environment_e_c2_request.html "https://sdk.amazonaws.com/cpp/api/LATEST/class_aws_1_1_cloud9_1_1_model_1_1_create_environment_e_c2_request.html"), [CreateEnvironmentEC2Result](https://sdk.amazonaws.com/cpp/api/LATEST/class_aws_1_1_cloud9_1_1_model_1_1_create_environment_e_c2_result.html "https://sdk.amazonaws.com/cpp/api/LATEST/class_aws_1_1_cloud9_1_1_model_1_1_create_environment_e_c2_result.html")                                       |
| AWS SDK for Go                   | [CreateEnvironmentEC2](../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2 "../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2"), [CreateEnvironmentEC2Request](../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2Request "../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2Request"), [CreateEnvironmentEC2WithContext](../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2WithContext "../../../sdk-for-go/api/service/cloud9.md#Cloud9.CreateEnvironmentEC2WithContext") |
| AWS SDK for Java                 | CreateEnvironmentEC2Request, CreateEnvironmentEC2Result                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| AWS SDK for JavaScript           | [createEnvironmentEC2](../../../AWSJavaScriptSDK/latest/AWS/Cloud9.md#createEnvironmentEC2-property "../../../AWSJavaScriptSDK/latest/AWS/Cloud9.md#createEnvironmentEC2-property")                                                                                                                                                                                                                                                                                                                                                                                       |
| AWS SDK for .NET                 | [CreateEnvironmentEC2Request](../../../sdkfornet/v3/apidocs/items/Cloud9/TCreateEnvironmentEC2Request.md "../../../sdkfornet/v3/apidocs/items/Cloud9/TCreateEnvironmentEC2Request.md"), [CreateEnvironmentEC2Response](../../../sdkfornet/v3/apidocs/items/Cloud9/TCreateEnvironmentEC2Response.md "../../../sdkfornet/v3/apidocs/items/Cloud9/TCreateEnvironmentEC2Response.md")                                                                                                                                                                                         |
| AWS SDK for PHP                  | [createEnvironmentEC2](../../../aws-sdk-php/v3/api/api-cloud9-2017-09-23.md#createenvironmentec2 "../../../aws-sdk-php/v3/api/api-cloud9-2017-09-23.md#createenvironmentec2")                                                                                                                                                                                                                                                                                                                                                                                             |
| AWS SDK for Python (Boto)        | [create\_environment\_ec2](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloud9.html#Cloud9.Client.create_environment_ec2 "https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/cloud9.html#Cloud9.Client.create_environment_ec2")                                                                                                                                                                                                                                                                                     |
| AWS SDK for Ruby                 | [create\_environment\_ec2](../../../sdk-for-ruby/v3/api/Aws/Cloud9/Client.md#create_environment_ec2-instance_method "../../../sdk-for-ruby/v3/api/Aws/Cloud9/Client.md#create_environment_ec2-instance_method")                                                                                                                                                                                                                                                                                                                                                           |
| AWS Tools for Windows PowerShell | [New-C9EnvironmentEC2](../../../powershell/latest/reference/items/New-C9EnvironmentEC2.md "../../../powershell/latest/reference/items/New-C9EnvironmentEC2.md")                                                                                                                                                                                                                                                                                                                                                                                                           |
| AWS Cloud9 API                   | [CreateEnvironmentEC2](../APIReference/API_CreateEnvironmentEC2.md "../APIReference/API_CreateEnvironmentEC2.md")                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
