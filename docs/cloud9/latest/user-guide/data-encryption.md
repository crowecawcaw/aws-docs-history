...
Data encryption refers to protecting data while in transit, as it travels between AWS Cloud9 and your AWS account and when at rest while it is stored in AWS Cloud9 configuration stores and AWS cloud-compute instances.
