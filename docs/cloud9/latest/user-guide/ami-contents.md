...
With Amazon Linux 2, you can use the Extras Library to install application and software
 ...
 (Amazon Linux 2)](https://docs.aws.amazon.com/linux/al2/ug/al2-extras.html "https://docs.aws.amazon.com/linux/al2/ug/al2-extras.html") in the *Amazon EC2 User Guide*.
