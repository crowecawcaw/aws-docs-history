...
| Fold all possibly foldable elements, except for the current selection<br>scope                                                        | `Command-Option-0`           | `foldOther`                 |
...
| Decrease the number to the left of the cursor by 1, if it is a<br>number                                                              | `Option-Shift-Down`          | `modifyNumberDown`          |
| Increase the number to the left of the cursor by 1, if it is a<br>number                                                              | `Option-Shift-Up`            | `modifyNumberUp`            |
...
| Surround the selection with block comment characters, or remove them if<br>they are there                                             | `Command-Shift-/`            | `toggleBlockComment`        |
