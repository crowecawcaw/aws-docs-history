...
| Command | Description |
| --- | --- |
| **Preferences** | Do one of the following: <br>• Open the **Preferences** tab if it isn't open. <br>• Make the **Preferences** tab active if it is open but not active. <br>• Hide the **Preferences** tab if it is active. See [Working with Project Settings](settings-project.md "settings-project.md"), [Working with User Settings](settings-user.md "settings-user.md"), [Working with Keybindings](settings-keybindings.md "settings-keybindings.md"), [Working with Themes](settings-theme.md "settings-theme.md"), and [Working with Initialization Scripts](settings-init-script.md "settings-init-script.md"). |
| **Go To Your Dashboard** | Open the AWS Cloud9 console in a separate web browser tab. See [Creating an Environment](create-environment.md "create-environment.md"), [Opening an Environment](open-environment.md "open-environment.md"), [Changing Environment Settings](change-environment.md "change-environment.md"), and [Deleting an Environment](delete-environment.md "delete-environment.md"). |
...
| **Open Your Stylesheet** | Open the `styles.css` file for the current user. See [Working with Themes](settings-theme.md "settings-theme.md"). | ## File menu
| Command | Description |
| --- | --- |
...
| **Close All Files** | Close all open files. | ## Edit menu
| Command | Description |
| --- | --- |
...
| **Keyboard Mode** | The set of keybindings to use, such as `Default`, `Vim`, `Emacs`, or `Sublime`. See [Working with Keybindings](settings-keybindings.md "settings-keybindings.md"). |
...
| **Code Formatting, Open Language & Formatting Preferences** | Open the **Project Settings** section of the **Preferences** tab to programming language settings. | ## Find menu For more information, see [Finding and Replacing Text](find-replace-text.md "find-replace-text.md").
| Command | Description |
| --- | --- |
...
| **Find in Files** | Show the find and replace bar for multiple files. | ## View menu
| Command | Description |
| --- | --- |
...
| **Wrap To Print Margin** | Wrap words to the edge of the current print margin, or stop wrapping words if they are already wrapping. | ## Go menu
| Command | Description |
| --- | --- |
...
| **Scroll to Selection** | Scroll the selection into better view. | ## Run menu
| Command | Description |
| --- | --- |
| **Run** | Run or debug the current application. |
| **Run Last** | Run or debug the last run file. |
| **Run With** | Run or debug using the chosen runner. See [Working with Builders, Runners, and Debuggers](build-run-debug.md "build-run-debug.md"). |
...
| **Save All on Build** | When building, save all related unsaved files. | ## Tools menu
| Command | Description |
| --- | --- |
...
| **Play Macro** | Play previously recorded keystrokes. | ## Window menu
| Command | Description |
| --- | --- |
...
| **Presets, Sublime Mode** | Switch to Sublime mode. | ## Support menu
| Command | Description |
| --- | --- |
| **Welcome Page** | Open the **Welcome** tab. |
| **Get Help (Community)** | Opens the AWS Cloud9 online community website in a separate web browser tab. |
| **Read Documentation** | Opens the *AWS Cloud9 User Guide* in a separate web browser tab. | ## Preview menu
| Command | Description |
| --- | --- |
...
| **Show Active Servers** | Show a list of available active server addresses in the **Process List** dialog box. | ## Other menu bar commands
| Command | Description |
| --- | --- |
| **Run** | Run or debug the current application. |
