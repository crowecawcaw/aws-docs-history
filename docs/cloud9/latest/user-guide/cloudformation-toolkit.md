...
The AWS Toolkit provides support for [AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/") stacks. Using the AWS Toolkit, you can delete an AWS CloudFormation stack.
...
* Ensure that the credentials you're using in the AWS Cloud9 environment include
 appropriate read/write access to the AWS CloudFormation service. If in the
 **AWS Explorer**, under
...
1. In the **AWS Explorer**, open the context (right-click)
 menu of the AWS CloudFormation stack you want to delete.
