...
| **Show Git Output**            | Displays a window showing the Git commands that are run when you interact with the Git panel interface.                                                                                             | ## Git commands available from the Git panel search field You can also access some supported Git command that aren't available in the Git panel menu by typing "git" in the search box: ![Interface options for initializing and cloning a Git repository](images/git-filter.png) The following table provides a description of selected Git commands that you can access this way. Selected Git commands | Menu option | Description |
| ---                            | ---                                                                                                                                                                                                 |
...
| **Git: Merge Branch**          | Integrates the changes made in one branch into another branch. For more information, see the [merge branches procedure](using-gitpanel.md#merge-branch-proc "using-gitpanel.md#merge-branch-proc"). |
