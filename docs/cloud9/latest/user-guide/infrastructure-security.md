...
As a managed service, AWS Cloud9 is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Cloud9 through the network. Clients must
...
By default, AWS Cloud9 EC2 development environments automatically install security patches for the
 instances' system packages.
