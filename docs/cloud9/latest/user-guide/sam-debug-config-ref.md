...
| `runtime` | Specifies the runtime used by the Lambda function. For more information, see [AWS Lambda runtimes](https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html "https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html"). |
...
| `template` | Customizes your SAM template by using parameters to input customer values to it. For more information, see [Parameters](../../../AWSCloudFormation/latest/UserGuide/parameters-section-structure.md "../../../AWSCloudFormation/latest/UserGuide/parameters-section-structure.md") in the *AWS CloudFormation User Guide*. | `"parameters":{}` | AWS connection (`"aws"`) properties| Property | Description | Default value |
| --- | --- | --- |
