...
call IAM APIs. For more information, see [GetFederationToken](../../../STS/latest/APIReference/API_API_GetFederationToken.md "../../../STS/latest/APIReference/API_API_GetFederationToken.md") in the
...
- If the environment is associated with an AWS cloud compute instance (for example,
  ...
  `0.0.0.0/0`). For instructions, see [Describing Your Security Groups](../../../AWSEC2/latest/UserGuide/using-network-security.md#describing-security-group "../../../AWSEC2/latest/UserGuide/using-network-security.md#describing-security-group") and [Updating Security Group Rules](../../../AWSEC2/latest/UserGuide/using-network-security.md#updating-security-group-rules "../../../AWSEC2/latest/UserGuide/using-network-security.md#updating-security-group-rules") in the
  ...
  - Restart the instance, make sure that the instance is running and passed
    ...
    Your Instance](../../../AWSEC2/latest/UserGuide/ec2-instance-reboot.md "../../../AWSEC2/latest/UserGuide/ec2-instance-reboot.md") and [Viewing Status Checks](../../../AWSEC2/latest/UserGuide/monitoring-system-instance-status-check.md#viewing_status "../../../AWSEC2/latest/UserGuide/monitoring-system-instance-status-check.md#viewing_status") in the
    _Amazon EC2 User Guide_.
...
Software](../../../AWSEC2/latest/UserGuide/install-updates.md "../../../AWSEC2/latest/UserGuide/install-updates.md") in the _Amazon EC2 User Guide_.
...
_AssociatePublicIpAddress_ parameter to be in the
