...
download and install prebuilt OpenJDK packages](https://openjdk.org/install/ "https://openjdk.org/install/") on the OpenJDK website. 4. Switch or upgrade the default Java development toolset to OpenJDK 8. To do this, run
...
`java-1.8`). 5. Confirm that the command line versions of the Java runner and compiler are using
...
project in your environment. 2. Install Maven by using the terminal to run the following commands.
