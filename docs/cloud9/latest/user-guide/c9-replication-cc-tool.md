...
AWS Cloud9 in CodeCatalyst provides a fully managed experience for interacting with AWS Cloud9. To
 ...
 on the replication process](https://docs.aws.amazon.com/cloud9/latest/user-guide/faqs-replication-tool "https://docs.aws.amazon.com/cloud9/latest/user-guide/faqs-replication-tool") outlined below.
...
```
2. *[Optional]* The replication tool uses your
...
3. After you copy and run the replication tool in your AWS Cloud9 environment,
 ...
 the access URL in a browser and clicking *Allow* within
 ...
 AWS Builder ID](https://docs.aws.amazon.com/signin/latest/userguide/sign-in-aws_builder_id.html "https://docs.aws.amazon.com/signin/latest/userguide/sign-in-aws_builder_id.html") in the *AWS Sign-In User Guide*.
...
4. Choose the Space that you want to use. If you have only one
 ...
 in CodeCatalyst](https://docs.aws.amazon.com/codecatalyst/latest/userguide/spaces.html "https://docs.aws.amazon.com/codecatalyst/latest/userguide/spaces.html") in the *Amazon CodeCatalyst User Guide*.
5. Choose if you want to replicate your code in CodeCatalyst or try it with a
 ...
 in CodeCatalyst](https://docs.aws.amazon.com/codecatalyst/latest/userguide/devenvironment.html "https://docs.aws.amazon.com/codecatalyst/latest/userguide/devenvironment.html") in the *Amazon CodeCatalyst User Guide*.
...
If you encounter any issues, or want to give feedback on your experience using the replication tool, please create and submit a support case. For information on 
 ...
 management](https://docs.aws.amazon.com/awssupport/latest/user/case-management.html "https://docs.aws.amazon.com/awssupport/latest/user/case-management.html").
