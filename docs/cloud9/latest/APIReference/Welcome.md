# Welcome
 ...
 AWS Cloud9 is a collection of tools that you can use to code, build, run, test, debug, and
 release software in the cloud.

For more information about AWS Cloud9, see the [AWS Cloud9 User Guide](https://docs.aws.amazon.com/cloud9/latest/user-guide "https://docs.aws.amazon.com/cloud9/latest/user-guide").
...
* `CreateEnvironmentEC2`: Creates an AWS Cloud9 development environment, launches
