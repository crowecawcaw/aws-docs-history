...
+ Transformed output: s3://amzn-s3-demo-bucket/OUT/TP\_ID/edi214xml-test83.txt.2023-11-21T19:26:49.774Z.xml
...
When using a trading capability, the format for the acknowledgement files is s3://amzn-s3-demo-bucket/OUT/TP\_ID/ACK/{{filename}}.{{timestamp}}.997 (.TA1 for TA1 acknowledgements).
