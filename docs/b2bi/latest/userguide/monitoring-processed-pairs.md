...
<a name="monitoring-processed-pairs"></a>
...
**Processed input-output pairs table fields**  

| Field | Description | Included in the default view | 
| --- | --- | --- | 
...
| Output File eTag | Entity tag of the output file. For details, see the eTag entry in the [Object](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Object.html#AmazonS3-Type-Object-ETag) topic in the Amazon Simple Storage Service API Reference. | No | 
