...
as profiles, partnerships, trading capabilities, and transformers), and CloudFormation provisions and configures
those resources for you.

When you use CloudFormation, you can reuse your template to set up your AWS B2B Data Interchange resources
...
To provision and configure resources for AWS B2B Data Interchange and related services, you must understand
[CloudFormation
...
AWS B2B Data Interchange supports creating profiles, partnerships, trading capabilities, and transformers in CloudFormation.
For more information, see the [AWS B2B Data Interchange resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_B2BI.md "../../../AWSCloudFormation/latest/UserGuide/AWS_B2BI.md") in the _AWS CloudFormation User Guide_.
