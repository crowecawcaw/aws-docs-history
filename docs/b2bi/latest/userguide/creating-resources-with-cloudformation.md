...
as profiles, partnerships, trading capabilities, and transformers), and AWS CloudFormation provisions and configures
those resources for you.

When you use AWS CloudFormation, you can reuse your template to set up your AWS B2B Data Interchange resources
...
AWS B2B Data Interchange supports creating profiles, partnerships, trading capabilities, and transformers in AWS CloudFormation.
