...
- **Security of the cloud** – AWS is
  ...
  programs that apply to AWS B2B Data Interchange, see [AWS Services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using AWS B2B Data Interchange. The following topics show you how to configure AWS B2B Data Interchange to meet your
  security and compliance objectives. You also learn how to use other AWS services that help
  you to monitor and secure your AWS B2B Data Interchange resources.

###### Topics

- [Data protection in AWS B2B Data Interchange](data-protection.md "data-protection.md")
