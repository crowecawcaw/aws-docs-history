...
| 865 | Purchase Order Change Acknowledgment/Request - Seller Initiated | Supply Chain | Yes | Yes | Yes | Yes | Yes | 
...
| 920 | Loss or Damage Claim - General Commodities | Transportation | Yes | Yes | Yes | Yes | Yes | 
| 924 | Loss or Damage Claim - Motor Vehicle | Transportation | Yes | Yes | Yes | Yes | Yes | 
...
| 275 X211 | Unsolicited Claim Attachments (from practice to clearinghouse to payer) | {{No}} | 
...
| 834 X318 | Benefit Enrollment and Maintenance, Electronic Remittance Advice (ERA) | {{No}} | 
