...
![An illustration showing how AZ IDs are mapped differently than Availability Zone names.](http://docs.aws.amazon.com/ram/latest/userguide/images/availability-zone-mapping.png)
