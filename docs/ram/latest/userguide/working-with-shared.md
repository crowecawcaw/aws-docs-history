...
With AWS Resource Access Manager (AWS RAM), you can view the resource shares to which you have been added, the shared
resources that you can access, and the AWS accounts that have shared resources with you.
You can also leave a resource share when you no longer require access to its shared resources.
