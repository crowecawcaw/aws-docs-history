...
| AWS Revenue Share           | The AWS fee amount that is deducted from the billed amount at settlement time. It appears in the [Disbursement report](monthly-disbursement-report.md "monthly-disbursement-report.md").                                            |
