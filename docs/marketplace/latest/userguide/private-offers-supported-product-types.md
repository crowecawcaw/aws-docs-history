...
The offer can be any custom duration for the following:
+ Container hourly or container hourly with long term private offers – Up to 12 years (4,380 days). Only container hourly with long term private offers or container contracts support flexible payment scheduling.
