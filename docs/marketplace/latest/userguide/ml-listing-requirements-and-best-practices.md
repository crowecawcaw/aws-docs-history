...
| Explain in detail what the product does for supported content types (for example,<br>“detects X in images").                                                                                                                                                                                                                            | Required                       | Required                   |
| Provide compelling and differentiating information about the product (avoid<br>adjectives like "best" or unsubstantiated claims).                                                                                                                                                                                                       | Recommended                    | Recommended                |
| List most important use case(s) for this product.                                                                                                                                                                                                                                                                                       | Required                       | Required                   |
| Describe the data (source and size) it was trained on and list any known<br>limitations.                                                                                                                                                                                                                                                | Required                       | Not applicable             |
| Describe the core framework that the model was built on.                                                                                                                                                                                                                                                                                | Recommended                    | Recommended                |
| Summarize model performance metric on validation data (for example, "XX.YY<br>percent accuracy benchmarked using the Z dataset").                                                                                                                                                                                                       | Required                       | Not applicable             |
