...
| --- | --- | 
| product\_id | The friendly identifier of the product.Can be used to join to the `product_id` fields of the `Account`, `Billing_Event`, and `Offer_Product` data feeds. | 
