...
5. When you have obtained an account from Hyperwallet, add your Hyperwallet account information to your AWS account by returning to **Settings** and selecting **Complete banking information** in the **Payment information** section.

###### Note

To update information in your Hyperwallet account, contact the Hyperwallet support team in the [Hyperwallet Portal](https://wssellers.hyperwallet.com "https://wssellers.hyperwallet.com"). Refer to the **Support** tab for hours and contact information.
...
After providing your bank account information, you can proceed to the next step in the registration process: [Step 4: Set disbursement preferences](set-disbursement-preferences.md "set-disbursement-preferences.md").
