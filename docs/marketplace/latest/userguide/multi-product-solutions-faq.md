...
<a name="multi-product-solutions-faq"></a>

This FAQ addresses common questions about multi-product solutions, including solution listings and offer sets.

**Topics**
+ [What is the difference between a product and a solution?](#product-vs-solution-difference)
+ [Do I need to be an AWS Partner to create solutions?](#aws-partner-to-create-solutions)
+ [What's the difference between AWS Marketplace Management Portal and AWS Partner Central?](#ammp-partner-central-difference)
+ [How do I use solution in the rest of AWS Partner Central co-selling?](#solution-in-partner-central-coselling)
+ [How do I track the status of my change requests?](#track-change-request-status)
+ [Why is my solution stuck in "pending review" or "preparing" status?](#solution-pending-review-status)
+ [What happens if my solution fails the Update Visibility request to go public?](#solution-fails-update-visibility)
+ [What solution details can I modify when my solution is in public status?](#solution-details-modify-public)
+ [Can I include products I don't own in my solution?](#include-products-not-owned)
+ [How do I get consent from product owners to include their products in my solution listing?](#get-consent-product-owners)
+ [Can I mix AWS Marketplace products with non-AWS Marketplace products?](#mix-aws-marketplace-non-aws-products)
+ [How does the "Deployed on AWS" badge work for my solution?](#deployed-on-aws-badge)
+ [What are the requirements for enabling Request private offer on my solution?](#request-private-offer-requirements)
+ [What is APN Customer Engagements (ACE)?](#what-is-ace)
+ [How do I choose the right use cases for my solution?](#choose-right-use-cases)
+ [What is the logo requirement?](#logo-requirement)
+ [I have multiple AWS accounts for AWS Marketplace, which account should I choose to create multi-product solution?](#multiple-aws-accounts-which-to-choose)
+ [Can I include products from multiple sellers in my solution?](#include-products-multiple-sellers)
+ [How is "Deployed on AWS" badge eligibility determined?](#deployed-on-aws-badge-eligibility)
+ [Can customers purchase individual products from my solution separately?](#customers-purchase-individual-products)
+ [How do renewals work for multi-product solutions?](#renewals-multi-product-solutions)
+ [How does ACE opportunity linking work?](#ace-opportunity-linking)
+ [What editing options are available for offer set?](#editing-options-offer-set)
+ [What notifications do sellers receive for offer sets?](#notifications-sellers-offer-sets)
+ [How does listing fee work for multi-product offer set?](#listing-fee-multi-product-offer-set)

## What is the difference between a product and a solution?
<a name="product-vs-solution-difference"></a>
...
<a name="aws-partner-to-create-solutions"></a>
...
<a name="ammp-partner-central-difference"></a>

For more information about AWS Partner Central, see the [AWS Partner Central console](https://us-east-1.console.aws.amazon.com/partnercentral/dashboard?region=us-east-1). AWS Partner Central combines two separate portals into one. You can now use AWS Partner Central to create and manage solutions. You can navigate product, offer, and agreement capabilities from AWS Marketplace Management Portal along with partner co-selling capabilities all in AWS Partner Central. AWS Partner Central is part of the AWS Console. You can easily become an AWS Partner and access both co-selling benefits and AWS Marketplace features. Existing AWS Marketplace sellers can access AWS Partner Central directly using your AWS Marketplace credentials.

## How do I use solution in the rest of AWS Partner Central co-selling?
<a name="solution-in-partner-central-coselling"></a>

Solutions can be used throughout AWS Partner Central for Foundational Technical Review (FTR) validation, program applications, opportunities, and funding. Your solutions will be required in various features throughout the partner co-selling journey. To start receiving co-sell benefits, you must get your solution FTR validated. You need FTR validation before obtaining AWS Customer Engagement (ACE) eligibility, which is required to activate the Request Private Offer feature and receive leads from multi-product solution listings that you make public. Existing partners can migrate solutions from legacy Partner Central into the AWS Marketplace catalog in AWS Partner Central. Migrated active solutions start as Limited solutions and can be used in other AWS Partner Central features. For more information about AWS Partner Central, see the [AWS Partner Central Documentation](https://docs.aws.amazon.com/partner-central/).

## How do I track the status of my change requests?
<a name="track-change-request-status"></a>
...
<a name="solution-pending-review-status"></a>
...
<a name="solution-fails-update-visibility"></a>
...
<a name="solution-details-modify-public"></a>
...
<a name="include-products-not-owned"></a>
...
<a name="get-consent-product-owners"></a>
...
<a name="mix-aws-marketplace-non-aws-products"></a>
...
<a name="deployed-on-aws-badge"></a>
...
<a name="request-private-offer-requirements"></a>
...
<a name="choose-right-use-cases"></a>
...
<a name="multiple-aws-accounts-which-to-choose"></a>
...
<a name="include-products-multiple-sellers"></a>
...
<a name="deployed-on-aws-badge-eligibility"></a>
...
<a name="customers-purchase-individual-products"></a>
...
<a name="renewals-multi-product-solutions"></a>
...
<a name="ace-opportunity-linking"></a>
...
<a name="editing-options-offer-set"></a>
...
<a name="notifications-sellers-offer-sets"></a>
