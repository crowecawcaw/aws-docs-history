...
2. [Listing your product in AWS Marketplace](ml-publishing-your-product-in-aws-marketplace.md "ml-publishing-your-product-in-aws-marketplace.md")
...
| Public     | When you're prepared to make your product visible to buyers for subscription, update the<br>product visibility in the console. Once processed, the product transitions from Limited to<br>Public status. For information about AWS guidelines, see [Requirements and best practices for creating machine learning products](ml-listing-requirements-and-best-practices.md "ml-listing-requirements-and-best-practices.md"). |
