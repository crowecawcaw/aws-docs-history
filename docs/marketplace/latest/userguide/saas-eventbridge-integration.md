...
| • Purchase Agreement Ended - Manufacturer<br>• Purchase Agreement Ended - Proposer     | An agreement has expired, is canceled, is terminated.                                                                                                                    | Purchase agreement closure is recorded and post agreement cancelation actions happen. ISV begins revoking customer entitlements.                                                                                                                                                              | Manufacturer and proposer |
| Purchase Agreement Advisory Issued<br>• Manufacturer                                   | AWS has issued an advisory that might invalidate this agreement. Conditions that can trigger this alert include buyer account closure, compromise, abuse, or fraud.      | AWS has identified an issue that affects this agreement. This issue might affect billing or service access. Contact the buyer directly and assess whether to revise their access.                                                                                                             | Manufacturer only         |
| Purchase Agreement Advisory Resolved<br>• Manufacturer                                 | AWS has resolved the issues that were impacting this agreement.                                                                                                          | AWS has resolved the issue affecting this agreement. If you made changes to the buyer's subscription or access, you can restore it at your discretion.                                                                                                                                        | Manufacturer only         |
...
| License Deprovisioned<br>• Manufacturer                                                | The buyer's entitlement to a product has ended.                                                                                                                          | For usage-based products, this event marks the start of a 1-hour final reporting window. Sellers should collect and report any unreported usage using the `BatchMeterUsage` API. After this window closes, customer entitlements are fully revoked and usage reporting is no longer accepted. | Manufacturer only         |
| Spend Threshold Reached                                                                | The buyer's accumulated spend on a SaaS pay-as-you-go product reached a spend threshold, and AWS Marketplace initiated a payment verification (vet) on the buyer's card. | Informational; no action required. AWS Marketplace is verifying the buyer's ability to pay. Await the Spend Threshold Vet Succeeded or Spend Threshold Vet Failed event.                                                                                                                      | Manufacturer and proposer |
| Spend Threshold Vet Succeeded                                                          | The payment verification on the buyer's card passed, and the spend threshold cycle reset.                                                                                | Informational; no action required. AWS Marketplace validated the buyer's payment method.                                                                                                                                                                                                      | Manufacturer and proposer |
| Spend Threshold Vet Failed                                                             | The payment verification on the buyer's card failed.                                                                                                                     | AWS Marketplace could not verify the buyer's payment method. AWS Marketplace will retry verification.                                                                                                                                                                                         | Manufacturer and proposer |

The Spend Threshold Reached, Spend Threshold Vet Succeeded, and Spend Threshold Vet Failed events apply only to SaaS products with usage-based (pay-as-you-go) pricing. AWS Marketplace does not send these events for SaaS products with contract-only or subscription pricing.
