...
| Reseller account name       | The name of the channel partner reseller.                                                                                                                                                                                           | ## Section 2: Variable length subscriptions This section lists data for all fee-based subscriptions as of the previous day at 23:59:59 UTC. |
| Column name                 | Description                                                                                                                                                                                                                         |
| ---                         | ---                                                                                                                                                                                                                                 |
| Customer AWS Account Number | The AWS account ID where charges are billed.                                                                                                                                                                                        |
| Product Title               | The title of the product.                                                                                                                                                                                                           |
