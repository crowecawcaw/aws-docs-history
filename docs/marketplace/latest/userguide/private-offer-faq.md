...
+ [How can a seller resolve errors when accessing the Private offers tab?](#resolve-offers-tab-errors)
...
The POST enables external audiences on the AWS Marketplace Private Offer experience. Sellers can us the [Support Form](https://aws.amazon.com/marketplace/management/contact-us/) in AWS Partner Central. For help with the support form, download and refer to the [Private offers support form guide](https://d1.awsstatic.com/awsmp/solutions/mk-sol-files/private-offers/Private%20Offer%20Support%20Form%20Guide.pdf) PDF. 
...
1. Create an agreement-based offer from the **Agreements** tab in the [AWS Partner Central](https://aws.amazon.com/marketplace/management/homepage).
...
+ **Disbursements are deposited** to a US bank account on the ISV or channel partner's account minus the listing fees. Funds can take 1-3 business days to land with general bank ACH SLAs.
