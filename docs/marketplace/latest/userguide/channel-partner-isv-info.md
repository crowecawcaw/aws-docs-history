...
The information you enter in **Selling authorization name** will be visible to Channel Partners in their seller reports.
   + For **Reseller**, enter the 12-digit AWS account ID in the available text box.
     + For instructions on validating the 12-digit AWS account ID, see [Validating your AWS account ID](https://awsmarketplace.storylane.io/share/5oeofjaq5s4s) on the AWS Marketplace Storylane website.
     + For instructions on locating your Channel Partner's AWS account ID from previous transactions, see [Locating a Channel Partner's AWS account ID](https://awsmarketplace.storylane.io/share/quvrsa2vqg3v) on the AWS Marketplace Storylane website.
**Note**  
