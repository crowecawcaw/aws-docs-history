...
7. On the **Review and create** page, make sure all the information is correct. Once a selling authorization is published, it cannot be modified. 8. Choose **Create selling authorizations** to publish the selling authorization to reseller.
