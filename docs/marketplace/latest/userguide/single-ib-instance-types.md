...
product from a specific instance, you can restrict the instance.
...
- [Adding an instance](#single-ib-adding-instance-types "#single-ib-adding-instance-types")
- [Restricting an instance](#single-ib-restricting-instance-types "#single-ib-restricting-instance-types")
...
To prevent new buyers from using an instance, you can restrict the instance. You can add the instance back at a later time,
if needed. Existing users of EC2 Image Builder components on the restricted instance can continue to
