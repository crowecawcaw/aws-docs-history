...
Congratulations! After successfully completing the bank account verification, you have finished the seller registration process for AWS Marketplace. You can now create and publish products on the marketplace.
...
For more information about managing your seller account after registration, see [Managing your seller account](seller-account-management.md "seller-account-management.md").
