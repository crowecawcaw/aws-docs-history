...
The following shows an example of the address data feed. In the data feed, this
information is presented in a single table. For readability, the data is shown in two tables
