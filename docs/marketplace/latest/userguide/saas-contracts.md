...
3. On the **Pricing** tab:
   ...
   2. For **Choose the contract type you want to offer**, choose how you
      ...
      - **Buyer can choose one tier from multiple tiers offered** –
        Customers choose a tier from options that include different sets of features,
        services, and usage amounts.

   3. Choose the usage unit category that describes your product’s pricing most
      accurately. The pricing category appears to customers on the AWS Marketplace website. You can
      choose from **Bandwidth** (GBps, MBps), **Data** (GB,
      MB, TB), **Hosts** (hours), **Requests**, or
