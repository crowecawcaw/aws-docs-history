...
You can't modify the payment schedule on a private offer that has been extended to and subscribed by a buyer. To make changes, you must [create a new offer](creating-private-offer.md "creating-private-offer.md").
