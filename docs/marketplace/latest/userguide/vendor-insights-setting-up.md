...
1. Choose **Build** and select **SaaS** to navigate to the **SaaS products** page.
...
**Note**  
Vendor Insights automated assessments are no longer available for new sellers. This feature relies on AWS Audit Manager, which is entering maintenance mode on April 30, 2026, and will not support new account setup. Existing automated assessments are unaffected. [Learn more](https://docs.aws.amazon.com/audit-manager/latest/userguide/audit-manager-availability-change.html)
