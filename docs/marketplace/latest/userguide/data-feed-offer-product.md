...
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| offer\_id       | The friendly identifier of this offer.Can be used to join to the<br>`offer_id` field of the `Offer` data feed.                                                                          |
| offer\_revision | Combines with `offer_id` field to form the foreign key to the offer revision.                                                                                                           |
| product\_id     | The friendly identifier of the product, this is the foreign key to the product that<br>this offer exposes. Can be used to join to the `product_id` field of<br>the `Product` data feed. |
