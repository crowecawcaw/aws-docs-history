...
**Topics**
+ [180-day GTM Academy](#gtm-academy)
+ [Announcing your product's availability](#AnnouncingYourProductsAvailability)
+ [AWS Marketplace messaging](#AWSMarketplaceMessaging)
+ [Reviews on AWS Marketplace](#syndicated-reviews)
+ [Linking to AWS Marketplace](#linking-to-aws-marketplace)
+ [Using AWS Marketplace branding](#using-the-aws-marketplace-logo)
+ [Understanding Buy with AWS as a seller](#buy-with-aws)
+ [Linking directly to your product on AWS Marketplace](#linking-directly-to-your-product-on-aws-marketplace)
+ [Press releases](#press-releases)

## 180-day GTM Academy
<a name="gtm-academy"></a>
...
You can access the 180-day GTM Academy from the **Marketplace Resources** section of [AWS Partner Central](https://us-east-1.console.aws.amazon.com/partnercentral/home).

## Announcing your product's availability
<a name="AnnouncingYourProductsAvailability"></a>
...
<a name="AWSMarketplaceMessaging"></a>
...
+ If you think that a review doesn't meet the review guidelines or contains objectionable content, you can contact the [AWS Marketplace Seller Operations](https://aws.amazon.com/marketplace/management/contact-us/) team and describe your concern.
...
<a name="linking-to-aws-marketplace"></a>
...
<a name="using-the-aws-marketplace-logo"></a>

**Note**  
You must be an AWS Partner to use the guide and assets listed here. For information about becoming an AWS Partner, see [Join the AWS Partner Network](https://aws.amazon.com/partners/).
...
1. Paste the following URL into your browser's address bar and open the page: [AWS Partner Creative and Messaging Guide 2023 ](https://partnercentral.awspartner.com/partnercentral2/s/resources?Id=0690L000004CNhCQAW).

1. Choose **Download**.

1. Repeat steps 2 and 3 for the [ Available in AWS Marketplace](https://partnercentral.awspartner.com/partnercentral2/s/article?category=AWS_Marketplace_Market&article=Available-in-AWS-Marketplace-Branding-Treatment-v2024) branding assets.

## Understanding Buy with AWS as a seller
<a name="buy-with-aws"></a>
...
+ **Procurement speed for AWS customers**: The Buy with AWS button on your website gives customers the ability to quickly subscribe to free trials or make purchases using their AWS accounts. Buy with AWS delivers a streamlined, co-branded purchasing experience to customers through AWS Marketplace.
+ **Use existing operations in AWS Marketplace**: Extend the discovery and procurement benefits of AWS Marketplace to customers through your website, while using the existing processes in AWS Marketplace to manage your listings, disbursements, support, and insights, without additional effort.
...
<a name="review-branding-changes"></a>

Complete the following steps to submit a brand review request before launching with the Buy with AWS experience:

1. Navigate to AWS Partner Central and [submit support ticket](https://aws.amazon.com/marketplace/management/contact-us/?) for **Commercial Marketplace**

   1. Select **Buy with AWS** as the category

   1. Select **Branding Review** as the sub-category.

1. Provide the following in the ticket:

   1. Your primary email address, and seller ID.

   1. In the **Provide more details about your request** section:

      1. The URL where you'll implement the Buy with AWS integration

      1. A link to your sandbox, live site, or mockups for AWS Marketplace operations team to review. If you don't include this, the operations team will request it after you submit the ticket.

1. The AWS Marketplace seller operations team will evaluate your implementation against Buy with AWS branding guidelines. They'll provide feedback to ensure compliance. You must address all feedback and obtain approval before launching.

### Buy with AWS reporting
<a name="buy-with-aws-reporting"></a>

Buy with AWS metrics offer sellers a comprehensive view of their conversion funnel. The Buy with AWS seller dashboard provides detailed insights to measure user engagement. Sellers can access Buy with AWS metrics through the [AWS Partner Central](https://aws.amazon.com/marketplace/management/homepage?pageType=awsmpmp%3Acustomer).

To view the Buy with AWS metrics dashboard:

1. Log into the [AWS Partner Central](https://aws.amazon.com/marketplace/management/homepage?pageType=awsmpmp%3Acustomer).
...
The prodview ID appears in the URL when you search for your application on [aws.amazon.com/marketplace](https://aws.amazon.com/marketplace/). For help finding your prodview ID, contact your account manager.

**Note**  
Test the links before using them to ensure that they direct your customers to the correct page.

## Press releases
<a name="press-releases"></a>
...
Have your press release reviewed by submitting it in text format to your account manager. Additionally, review the [Amazon Web Services trademark guidelines](https://aws.amazon.com/trademark-guidelines/) before using any AWS trademarks. 