...
<a name="preparing-your-solution"></a>

## What is a solution?
<a name="what-is-solution-listing"></a>
...
1. ACE (APN Customer Engagement) eligibility to enable **Request private offer** and receive leads.

1. At least two public product listings on AWS Marketplace. At least one public product must be your own.

1. For solutions that include other sellers' products:

   1. Consent from other sellers to include their products in your solution listing

   1. Selling authorization from other sellers if you plan to resell their products in transactions

## Define your solution strategy
<a name="define-your-solution-strategy"></a>
...
<a name="common-solution-types"></a>
...
<a name="creating-solution-listing"></a>
...
1. Choose **Create solution** to begin.
...
<a name="step-1-enter-solution-details"></a>
...
<a name="step-2-add-products"></a>

 Add products using one of these methods: 

#### AWS Marketplace products you own
<a name="option-1-aws-marketplace-products-you-own"></a>

1. Select the product type.

1. Select from public or limited products owned by your AWS Marketplace account.

#### AWS Marketplace products owned by others
<a name="option-2-aws-marketplace-products-owned-by-others"></a>
...
1. Select the product type and enter details manually.

1. Add a description (1-220 characters) and URL for each non-AWS Marketplace product.

### Step 3: Choose use cases
<a name="step-3-choose-use-cases"></a>
...
1. Choose up to 3 use cases that best match your solution.

1. For each chosen use case, write a description (1-500 characters) explaining how your solution addresses that specific customer need. This description appears to buyers on the public listing page.
...
1. The system validates that all required fields and relationships are set.

1. Once submitted, the solution changes from Draft to Limited status. Limited status means your solution is visible to you but not yet public to customers. You can still make edits to the solution while it's in Limited status.

1. Choose **Preview in AWS Marketplace** to see how your solution will appear to customers.

## Solution overview page
<a name="solution-overview-page"></a>
...
+ **Overview tab**: solution detail, buyer engagement options, additional resources, images and videos, tags.
  + For a detailed guide on adding images and videos, see [Enhance your AWS Marketplace product with promotional media](https://docs.aws.amazon.com/marketplace/latest/userguide/promotional-media.html).
  + AWS lets buyers with unique or enterprise use cases request a private offer for your product directly from the product detail page. If you are an AWS Partner Network (APN) partner who is eligible for [APN Customer Engagements (ACE)](https://aws.amazon.com/partners/programs/ace/) and you would like to offer this option to buyers, see [Adding private offer and demo request buttons](https://docs.aws.amazon.com/marketplace/latest/userguide/creating-private-offer.html#private-offer-requests-demos) for more information.
...
<a name="making-your-solution-public"></a>
