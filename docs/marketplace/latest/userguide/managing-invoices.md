...
2. Expand the left side navigation. Choose **Tax details** to view the Tax invoices dashboard.
...
To download more invoices, navigate to the next page and continue selecting. 2. Choose **Download**. The selected invoices are downloaded as a zip file.
...
2. Use the `InvoiceId` from the response to call the `GetInvoicePDF` API and download each invoice.
...
- [ListInvoiceSummaries](../../../aws-cost-management/latest/APIReference/API_invoicing_ListInvoiceSummaries.md "../../../aws-cost-management/latest/APIReference/API_invoicing_ListInvoiceSummaries.md")
- [GetInvoicePDF](../../../aws-cost-management/latest/APIReference/API_invoicing_GetInvoicePDF.md "../../../aws-cost-management/latest/APIReference/API_invoicing_GetInvoicePDF.md")
