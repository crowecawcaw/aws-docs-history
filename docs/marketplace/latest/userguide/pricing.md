...
+ [Update pricing visibility](update-pricing-visibility.md)
...
1. In the **Build** tab, a list of current products that you created is available. Edit your product listing or request changes here.
