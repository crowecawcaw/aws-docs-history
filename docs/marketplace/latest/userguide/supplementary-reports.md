...
| reseller\_name | The name of the channel partner reseller. | 
| reseller\_aws\_account\_id | The unique identifier for the channel partner reseller. | 
...
| is\_free\_trial\_offer | A flag that indicates if the offer or agreement is a free trial offer. | 
| is\_upgraded\_after\_free\_trial | A flag that indicates if the agreement was upgraded to a paid contract. | 
