...
<a name="single-ib-update-eula"></a>

As an AWS Marketplace seller, you can update the end user license agreement (EULA) that will govern the use of your EC2 Image Builder components. Your EULA is located on the product listing page for public software listings on AWS Marketplace. You can either apply your own EULA or use the [Standard Contract for AWS Marketplace (SCMP)](standardized-license-terms.md). The following procedure shows you how to update the EULA for your EC2 Image Builder components.
