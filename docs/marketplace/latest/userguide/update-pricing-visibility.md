...
The pricing visibility feature is in preview release for AWS Marketplace and is subject to
change.

With the pricing visibility feature, you can list products without displaying
public pricing. This feature is also known as leads-only listing. Your product remains
visible in the catalog, but buyers can't purchase it through a public offer. Instead,
interested buyers contact you through the **Request for private offer**
button replacing the common **Subscribe** button. You receive an AWS
originated opportunity in AWS Customer Engagement (ACE) tool on AWS Partner Central to
initiate the deal negotiation process that can become a private offer. Buyers who get a
private offer from you can accept and subscribe through the standard workflow.

Use this feature when you need to customize pricing for individual buyers. This feature
is also useful for complex pricing that doesn't fit a standard public offer.

## Prerequisites

Before you update pricing visibility, make sure that the following requirements are
met:
...
3. Choose **Update public offer**, then choose **Update
   pricing visibility**.
4. For **Product pricing visibility options**, choose
   **Don't display product pricing for buyers**.

To re-enable public pricing later, return to this step and choose
**Display product pricing for buyers**.
