# Updating your end-user license agreement (EULA) for container products on AWS Marketplace

As an AWS Marketplace seller, you can update the end-user license agreement (EULA) to use either the [Standard Contract for AWS Marketplace](standardized-license-terms.md#standard-contracts "standardized-license-terms.md#standard-contracts") or a custom EULA. Updates
...
3. From the **Request changes** dropdown list, select **Update
   public offer**, and then select **Update EULA**.
4. Select **Standard Contract for AWS Marketplace** or submit your
   custom EULA. For a custom EULA, you must provide the contract from an Amazon S3 bucket.
