...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| From the AWS Marketplace console   | Navigate to *_Private offers_<br>• in the AWS Marketplace console and select<br>the offer ID from the *_Available offers_<br>• tab.For more<br>information about the buyer experience for private offers, see [Private offers](../buyerguide/buyer-private-offers.md "../buyerguide/buyer-private-offers.md") in the<br>_AWS Marketplace Buyer Guide_. |
