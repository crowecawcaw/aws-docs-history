...
# Create a private offer with contract pricing for a Container product using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_CreatePrivateOfferWithContractPricingForContainerProduct_section"></a>

The following code examples show how to create a private offer with contract pricing for a Container product.
