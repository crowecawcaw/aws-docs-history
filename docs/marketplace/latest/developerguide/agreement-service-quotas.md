...
Your AWS account has the following quotas related to the AWS Marketplace Agreement
Service.

Request quotas| **API operation** | **Request rate (per AWS<br>account)** |
| --- | --- |
...
Agreement quotas| **Description** | **Quota** |
| --- | --- |
