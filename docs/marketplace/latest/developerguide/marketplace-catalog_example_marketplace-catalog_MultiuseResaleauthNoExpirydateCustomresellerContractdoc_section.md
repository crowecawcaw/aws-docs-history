...
# Publish multi-use resale authorization without an expiration date and add reseller contract documentation using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_MultiuseResaleauthNoExpirydateCustomresellerContractdoc_section"></a>

The following code examples show how to publish multi-use resale authorization without an expiration date for any product type and add reseller contract documentation between the ISV and Channel Partner.
