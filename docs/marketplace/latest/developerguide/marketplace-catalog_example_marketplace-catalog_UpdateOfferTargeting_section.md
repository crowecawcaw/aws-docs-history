...
# Update an offer to apply targeting to specific geographic regions using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateOfferTargeting_section"></a>

The following code examples show how to update an offer to apply targeting to specific geographic regions.
