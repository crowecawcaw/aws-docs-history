...
# Specify whether AMI assets are deployed in new regions using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateFutureRegionSupport_section"></a>

The following code examples show how to specify whether AMI assets are deployed in new regions built by AWS to support future regions.
