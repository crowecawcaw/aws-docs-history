...
# Update dimensions on an AMI or SaaS product using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateNameDimensionSaasProduct_section"></a>

The following code examples show how to update dimensions on an AMI or SaaS product.
