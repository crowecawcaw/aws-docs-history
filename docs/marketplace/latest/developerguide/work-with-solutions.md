...
- Enable your AWS Marketplace solutions to work with Partner Central APIs, such as [Selling APIs](../../../partner-central/latest/APIReference/working-with-your-opportunities.md "../../../partner-central/latest/APIReference/working-with-your-opportunities.md").
...
This section provides detailed information about creating and managing solutions using AWS Marketplace Catalog API [change types](../APIReference/API_Change.md "../APIReference/API_Change.md").

Before you begin, make sure you have:

- Valid AWS Marketplace seller registration and a public profile. For more information, see [Register and create your seller profile](../userguide/create-public-profile.md "../userguide/create-public-profile.md").
- Access to the API and completed seller prerequisites. For more information, see [Access control for the AWS Marketplace Catalog API](../APIReference/catalog-api-access-control.md "../APIReference/catalog-api-access-control.md").
- Learned the basics of using the AWS Marketplace Catalog API, see [Using the AWS Marketplace Catalog API](../APIReference/catalog-apis.md "../APIReference/catalog-apis.md").
...
The DescribeEntity response returns an `EntityIdentifier` that combines an `EntityId` with a `RevisionId.` For solutions, `EntityId` is the solution ID, and `RevisionId` can be used for optimistic locking. For more information, see [Identifiers](../APIReference/catalog-apis.md#identifier "../APIReference/catalog-apis.md#identifier").
...
For more information, see [Managing tags on resources](../APIReference/catalog-api-access-control.md#managing-tags-on-resources "../APIReference/catalog-api-access-control.md#managing-tags-on-resources") and [Adding tags to an entity and change set during creation](../APIReference/catalog-api-access-control.md#example-adding-tags-entity-creation "../APIReference/catalog-api-access-control.md#example-adding-tags-entity-creation").
...
- `DetailsDocument` (object) (required) – The details of the request including the information that you want to update for your solution. Each field is optional, but you must include at least one change to update.
  ...
  - `LogoUrl` (string) – The URL to an image in a publicly accessible Amazon S3 bucket or a presigned S3 URL. Must be a direct S3 URL (not behind CloudFront or API Gateway). Max length: 2048 characters. For logo specifications, see [Company and product logo requirements](../userguide/product-submission.md#seller-and-product-logos "../userguide/product-submission.md#seller-and-product-logos").
  - `PromotionalMedia` (array of objects) – The list of promotional images and videos. Max 15 items (5 videos and 10 images). For promotional media specifications, see [Enhance your AWS Marketplace product with promotional media](../userguide/promotional-media.md "../userguide/promotional-media.md").
  ...
  - `UseCases` (array of objects) – The list of use cases that this solution addresses. Max 3 items. For valid use case categories (a combination of Group, SubGroup, and Item), see [use case categories list](https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json "https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json") for active accepted values and their [introduction labels](https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/i18n/en.json "https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/i18n/en.json"). The combination of Group, SubGroup, and Item must be a valid item in the use case categories list.

    - `Group` (string) – Industry or technology category. Must be one of the Group values in [use case categories list](https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json "https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json").
    - `SubGroup` (string) – Use case group within the category. Must be one of the SubGroup values in [use case categories list](https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json "https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json").
    - `Item` (string) – Specific use case. Must be one of the Item values in [use case categories list](https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json "https://d1z4dgsxp8pfa2.cloudfront.net/awsmp-solutions/use-case-categories-list.json").
...
For presigned URL information, see [Sharing objects with presigned URLs](../../../AmazonS3/latest/userguide/ShareObjectPreSignedURL.md "../../../AmazonS3/latest/userguide/ShareObjectPreSignedURL.md").
...
To use this change type, you must have active enrollment in the [APN Customer Engagements (ACE)](https://aws.amazon.com/partners/programs/ace/ "https://aws.amazon.com/partners/programs/ace/") program. You must also link your AWS account with your AWS Partner Central account that has enrolled in ACE. For instructions, see [Linking AWS Partner Central and AWS accounts](../../../partner-central/latest/getting-started/account-linking.md "../../../partner-central/latest/getting-started/account-linking.md").
...
- The AWS Marketplace Seller Operations team reviews all requests to move a solution to `Public` visibility. For support, see [Getting support for AWS Marketplace](../buyerguide/getting-support.md "../buyerguide/getting-support.md").
...
AWS Marketplace Catalog API uses standard IAM permissions. See [Access control for the AWS Marketplace Catalog API](../APIReference/catalog-api-access-control.md "../APIReference/catalog-api-access-control.md") for more details.
