...
# Create a draft SaaS product with a draft public offer using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_CreateDraftSaasProductWithDraftPublicOffer_section"></a>

The following code examples show how to create a draft SaaS product with a draft public offer.
