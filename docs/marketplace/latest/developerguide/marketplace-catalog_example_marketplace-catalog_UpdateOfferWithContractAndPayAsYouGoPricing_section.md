...
# Update an offer to apply a contract with Pay-As-You-Go pricing using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateOfferWithContractAndPayAsYouGoPricing_section"></a>

The following code examples show how to update an offer to apply a contract with Pay-As-You-Go pricing.
