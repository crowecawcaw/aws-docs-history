...
# Update name and description of a public offer using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateOfferNameAndDescription_section"></a>

The following code examples show how to update name and description of a public offer.
