...
# Expire a private offer using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_ExpirePrivateOffer_section"></a>

The following code examples show how to set the expiration date of a private offer to a date in the past so that buyers no longer see the offer.
