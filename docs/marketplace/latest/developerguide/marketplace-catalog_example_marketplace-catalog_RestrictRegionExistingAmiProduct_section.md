...
# Restrict a region where an AMI product is deployed using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_RestrictRegionExistingAmiProduct_section"></a>

The following code examples show how to restrict a region where an AMI product is deployed.
