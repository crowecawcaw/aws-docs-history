...
# Update the refund policy of an offer using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_UpdateRefundPolicy_section"></a>

The following code examples show how to update the refund policy of an offer.
