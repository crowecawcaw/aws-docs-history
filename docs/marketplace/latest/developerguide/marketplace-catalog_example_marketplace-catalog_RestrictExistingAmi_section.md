...
# Restrict product visibility using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_RestrictExistingAmi_section"></a>

The following code examples show how to restrict product visibility.
