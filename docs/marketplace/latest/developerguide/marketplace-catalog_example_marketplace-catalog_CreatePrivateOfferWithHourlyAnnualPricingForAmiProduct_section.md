...
# Create a private offer with hourly annual pricing for an AMI product using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_CreatePrivateOfferWithHourlyAnnualPricingForAmiProduct_section"></a>

The following code examples show how to create a private offer with hourly annual pricing for an AMI product.
