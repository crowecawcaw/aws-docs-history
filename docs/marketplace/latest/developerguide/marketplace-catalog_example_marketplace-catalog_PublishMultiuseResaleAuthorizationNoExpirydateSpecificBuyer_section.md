...
# Publish multi-use resale authorization without expiration date and add a specific buyer account for the resale using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_PublishMultiuseResaleAuthorizationNoExpirydateSpecificBuyer_section"></a>

The following code examples show how to publish multi-use resale authorization without an expiration date for any product type and add a specific buyer account for the resale.
