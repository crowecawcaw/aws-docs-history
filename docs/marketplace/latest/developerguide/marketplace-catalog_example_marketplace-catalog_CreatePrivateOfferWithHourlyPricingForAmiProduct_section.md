...
# Create a private offer with hourly pricing for an AMI product using an AWS SDK
<a name="marketplace-catalog_example_marketplace-catalog_CreatePrivateOfferWithHourlyPricingForAmiProduct_section"></a>

The following code examples show how to create a private offer with hourly pricing for an AMI product.
