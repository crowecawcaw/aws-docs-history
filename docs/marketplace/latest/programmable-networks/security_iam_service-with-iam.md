# How AWS Programmable Networks works with IAM

Before you use IAM to manage access to AWS Programmable Networks, learn what IAM features are
available to use with AWS Programmable Networks.

| IAM feature                                                                                                                                              | AWS Programmable Networks support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
...
To get a high-level view of how AWS Programmable Networks and other AWS services work with most IAM
features, see [AWS services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_.

## Identity-based

policies for AWS Programmable Networks
...
Identity-based policy examples for AWS Programmable Networks

To view examples of AWS Programmable Networks identity-based policies, see [Identity-based policy
examples for AWS Programmable Networks](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within AWS Programmable Networks
...
To see a list of AWS Programmable Networks actions, see [Actions Defined by AWS Programmable Networks](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") in the
_Service Authorization Reference_.

Policy actions in AWS Programmable Networks use the following prefix before the action:
...
resources for AWS Programmable Networks
...
To see a list of AWS Programmable Networks resource types and their ARNs, see
[Resources Defined by AWS Programmable Networks](../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions Defined by AWS Programmable Networks](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") .
...
condition keys for AWS Programmable Networks
...
To see a list of AWS Programmable Networks condition keys, see [Condition Keys for AWS Programmable Networks](../../../IAM/latest/UserGuide/list_your_service.md#your_service-policy-keys "../../../IAM/latest/UserGuide/list_your_service.md#your_service-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions Defined by AWS Programmable Networks](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") .

To view examples of AWS Programmable Networks identity-based policies, see [Identity-based policy
examples for AWS Programmable Networks](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## ACLs in AWS Programmable Networks
...
## ABAC with AWS Programmable Networks
...
credentials with AWS Programmable Networks
...
principal permissions for AWS Programmable Networks
...
Changing the permissions for a service role might break AWS Programmable Networks functionality.
Edit service roles only when AWS Programmable Networks provides guidance to do so.

## Service-linked

roles for AWS Programmable Networks
