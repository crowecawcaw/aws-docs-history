# Security in AWS Programmable Networks
...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Programmable Networks. The following topics show you how to configure AWS Programmable Networks to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS Programmable Networks resources.

###### Topics

- [Data protection in AWS Programmable Networks](data-protection.md "data-protection.md")
- [Identity and access management for AWS Programmable Networks](security-iam.md "security-iam.md")
- [Compliance validation for AWS Programmable Networks](compliance-validation.md "compliance-validation.md")
- [Resilience in AWS Programmable Networks](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
