# Resilience in AWS Programmable Networks
...
In addition to the AWS global infrastructure, AWS Programmable Networks offers several features to help support your data resiliency and backup needs.
