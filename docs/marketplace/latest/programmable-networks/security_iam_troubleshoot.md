# Troubleshooting AWS Programmable Networks identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with AWS Programmable Networks and IAM.

###### Topics

- [I am not authorized to
  perform an action in AWS Programmable Networks](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS Programmable Networks resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS Programmable Networks
...
If you receive an error that you're not authorized to perform the `iam:PassRole` action, your policies must be updated to allow you to pass a role to AWS Programmable Networks.
...
AWS Programmable Networks. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AWS Programmable Networks resources
...
- To learn whether AWS Programmable Networks supports these features, see [How AWS Programmable Networks works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
