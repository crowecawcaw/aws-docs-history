# Monitoring AWS Programmable Networks with Amazon CloudWatch

You can monitor AWS Programmable Networks using CloudWatch, which collects raw data and processes it
...
For AWS Programmable Networks, you might want to watch for `XXX`, and
also watch `XXX` and `Take Automatic Action` when `This
 Happens`.

The following tables list the metrics and dimensions for AWS Programmable Networks.
