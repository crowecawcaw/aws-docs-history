...
Notifications are sent to the email address associated with the buyer AWS account ID. If you are missing AWS Marketplace emails, check your spam folder or adjust email settings. Email
