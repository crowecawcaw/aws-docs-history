...
| **Offer type**                       | All                                                                                                                                                                                                                | <br>• To change the default filter values, select the arrow on the right side of the **Controls** bar. ![Image of an arrow pointing down.](images/org-view-filter-arrow.png) For more information about using Quick Suite filters, see [Using filters on dashboard data](../../../quicksight/latest/user/filtering-dashboard-data.md "../../../quicksight/latest/user/filtering-dashboard-data.md") and [Filtering data during your session](../../../quicksight/latest/user/subscriber-dashboards-filtering-your-view-of-the-data.md "../../../quicksight/latest/user/subscriber-dashboards-filtering-your-view-of-the-data.md"), both in the _Quick Suite User Guide_. |
