...
You can search for, subscribe to, and deploy third-party Kubernetes software using the Amazon EKS console. For more information, see [Managing Amazon EKS add-ons](https://docs.aws.amazon.com/eks/latest/userguide/managing-add-ons.html) in the *Amazon EKS User Guide*.
