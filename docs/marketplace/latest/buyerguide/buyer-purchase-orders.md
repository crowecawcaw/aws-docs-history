...
You can only enter PO numbers for future charges. If a subscription auto-renews, the PO applied to your current subscription will carry
over to invoices generated by the renewal. You can update PO numbers ahead of an auto-renewal by modifying the PO on the current
subscription's charges. Updating PO numbers on charges that have already been invoiced will not apply retroactively.
