...
The following lists include all existing supported currencies for Amazon Web Services, Inc., Amazon Web Services EMEA SARL, Amazon Web Services Australia Pty Ltd, Amazon Web Services Korea LLC, and Amazon Web Services Japan G.K. 
...
**The supported currencies for Amazon Web Services, Inc. are as follows:**
...
**The supported currencies for Amazon Web Services Australia Pty Ltd are as follows:**
+ Australian dollar (AUD)
+ US dollar (USD)
...
**The supported currencies for Amazon Web Services Korea LLC are as follows:**
+ Korean won (KRW)
+ US dollar (USD)
