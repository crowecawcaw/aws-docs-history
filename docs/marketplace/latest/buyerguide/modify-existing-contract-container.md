...
<a name="modify-existing-contract-container"></a>
...
1. In the Contract options section, increase your entitlements using the arrows. You can't reduce the entitlement counts below the entitlements purchased. 
...
1. Make sure that you understand the terms and conditions with cancellation.

1. Select the check box to cancel the automatic renewal option. 