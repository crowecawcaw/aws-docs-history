...
<a name="subscribe-container-products-contract"></a>
...
**Note**  
For information about subscribing using Amazon EKS, see [Managing Amazon EKS add-ons](https://docs.aws.amazon.com/eks/latest/userguide/managing-add-ons.html).
...
1. To start the subscription, choose **Continue to Subscribe**. 
...
1. After you've made your selections, choose **Create Contract**.
