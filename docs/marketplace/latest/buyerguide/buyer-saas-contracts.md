...
# Subscribing with SaaS upfront commitments
<a name="buyer-saas-contracts"></a>
...
**Note**  
For information about the Quick Launch experience, see [Launching SaaS products with Quick Launch](quick-launch.md#saas-quick-launch).

**To subscribe with a SaaS contract**

1. On the product detail page, choose **View purchase options** to start the subscription process. You can choose the quantities or units that you want, length of subscription (if multiple options are available), and automatic renewal.

1. After you have made your selections, choose **Subscribe**. 

1. Choose **Set Up Your Account**, which takes you to the company’s website. While your account is being configured and the payment is being verified, you will see that your contract is pending on the AWS Marketplace product details page.
**Note**  
