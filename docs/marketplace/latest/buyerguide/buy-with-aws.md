...
+ **Accelerate cloud solution discovery and evaluation**: Discover software from AWS Partners available for purchase through AWS as you explore solutions on the web beyond AWS.
+ **Convenient and secure purchasing with your AWS account**: Look for the Buy with AWS button, log in with your AWS account, and use your AWS payment preferences for fast purchases.
+ **Centralized billing and benefits through AWS Marketplace**: Unlock consolidated billing on AWS and access centralized tools to help you manage subscriptions and optimize costs in AWS Marketplace.

## Products supported
<a name="products-supported"></a>

The following products support Buy with AWS:
+ SaaS subscriptions
+ SaaS contracts
...
<a name="product-discovery-and-purchase"></a>

### View and subscribe to products on seller's website
<a name="buywithaws-sellers-website"></a>
...
1. The Buy with AWS co-branded procurement page displays offer details, pricing, and terms for customer review and purchase.

1. Review the purchase offer details.

1. Choose **Subscribe**.

1. After subscribing the SaaS product, choose **Set up your account** to register on the seller's website.

## Request a private offer from seller's website
<a name="buywithaws-private-offer"></a>

1. Navigate to a seller's website that features Buy with AWS.

1. Identify the product that you wish to purchase.

1. Choose the **Request private offer** CTA button.

1. Enter your contact details (name, phone, email) and any relevant information related to your request.

1. Choose **Submit request**.

The seller will contact you regarding your request for a private offer.

## Request a demo from seller's website
...
1. Choose the **Request demo** CTA button.

1. Enter your contact details (name, phone, email) and any relevant information related to your request.

1. Choose **Submit request**.

The seller will contact you regarding your request for a demo.