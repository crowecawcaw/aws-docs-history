...
`AWS::RolesAnywhere::Crl`, `AWS::RolesAnywhere::Profile`, and `AWS::RolesAnywhere::TrustAnchor`), and CloudFormation provisions and configures those resources for
...
When you use CloudFormation, you can reuse your template to set up your IAM Roles Anywhere resources
