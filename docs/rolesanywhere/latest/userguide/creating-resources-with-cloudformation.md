# Create IAM Roles Anywhere resources with

AWS CloudFormation

AWS Identity and Access Management Roles Anywhere is integrated with AWS CloudFormation, a service that helps you to model and set up your
...
`AWS::RolesAnywhere::Crl`, `AWS::RolesAnywhere::Profile`, and `AWS::RolesAnywhere::TrustAnchor`), and AWS CloudFormation provisions and configures those resources for
you. For more information, see [resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_RolesAnywhere.md "../../../AWSCloudFormation/latest/UserGuide/AWS_RolesAnywhere.md") in the AWS CloudFormation User Guide.

When you use AWS CloudFormation, you can reuse your template to set up your IAM Roles Anywhere resources
...
To provision and configure resources for IAM Roles Anywhere and related services, you must
...
IAM Roles Anywhere supports creating certificate revocation lists, trust anchors, and profiles
in AWS CloudFormation. For more information, including examples of JSON and YAML templates for
[CRL](../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-crl.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-crl.md"),
[TrustAnchor](../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-trustanchor.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-trustanchor.md"), and
[Profile](../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-profile.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-rolesanywhere-profile.md"),
see the _AWS CloudFormation User Guide_.
