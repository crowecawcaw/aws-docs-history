...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Identity and Access Management Roles Anywhere. The following topics show you how to configure IAM Roles Anywhere to meet your
  security and compliance objectives. You can also learn how to use other AWS services that help you
  to monitor and secure your IAM Roles Anywhere resources.
