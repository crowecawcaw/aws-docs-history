...
**Topics**
+ [I am not authorized to perform an action in IAM Roles Anywhere](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to view my access keys](#security_iam_troubleshoot-access-keys)
+ [I'm an administrator and want to allow others to access IAM Roles Anywhere](#security_iam_troubleshoot-admin-delegate)
+ [I want to allow people outside of my AWS account to access my IAM Roles Anywhere resources](#security_iam_troubleshoot-cross-account-access)
+ [Invalidating a IAM Roles Anywhere session](#security_iam_troubleshoot-invalidate-session)
...
<a name="security_iam_troubleshoot-invalidate-session"></a>
