...
| -------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| [AWSRolesAnywhereFullAccess](#security-iam-awsmanpol-AWSRolesAnywhereFullAccess "#security-iam-awsmanpol-AWSRolesAnywhereFullAccess") – New policy | IAM Roles Anywhere added a new policy to allow users to grant full access IAM Roles Anywhere permissions to principals in a standardized way. | July 16, 2025     |
| [AWSRolesAnywhereReadOnly](#security-iam-awsmanpol-AWSRolesAnywhereReadOnly "#security-iam-awsmanpol-AWSRolesAnywhereReadOnly") – New policy       | IAM Roles Anywhere added a new policy to allow users to grant read only IAM Roles Anywhere permissions to principals in a standardized way.   | July 16, 2025     |
