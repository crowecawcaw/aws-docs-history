...
- [Troubleshooting AWS End User Messaging Social identity and
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS End User Messaging Social identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
