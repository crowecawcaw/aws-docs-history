...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS End User Messaging Social. The following topics show you how to configure AWS End User Messaging Social to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS End User Messaging Social resources.

###### Topics

- [Data protection in AWS End User Messaging Social](data-protection.md "data-protection.md")
- [Identity and access management for AWS End User Messaging Social](security-iam.md "security-iam.md")
