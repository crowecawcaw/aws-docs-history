...
You can use message templates to create message types that you use frequently, such as weekly newsletters or appointment reminders. Template messages are the only type of message that can be sent to customers who have yet to message you, or who have not sent you a message in the last 24 hours.
...
<a name="managing-templates_steps"></a>
...
1. On the **Message templates** tab, you can:
