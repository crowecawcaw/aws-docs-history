...
As a managed service, AWS End User Messaging Social is protected by the AWS global network security
...
You use AWS published API calls to access AWS End User Messaging Social through the network. Clients must
