...
template, or change your application's behavior. If you edit the message template and it
is reapproved, its quality rating will gradually improve as long as it doesn't receive
frequent negative feedback or low read rates.
