...
<a name="managing-templates_rejection"></a>
...
+ The message template contains content that violates either [WhatsApp Commerce Policy](https://www.whatsapp.com/legal/commerce-policy/) or [WhatsApps Business Policy](https://www.whatsapp.com/legal/business-policy/).

For more information, see [Common Rejection Reasons](https://developers.facebook.com/docs/whatsapp/message-templates/guidelines#common-rejection-reasons) in the *WhatsApp Business Platform Cloud API Reference*. 