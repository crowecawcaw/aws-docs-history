...
<a name="increase-message-limit"></a>
...
When a customer messages you, this opens a 24-hour service window. During this time, you can send all [message types](message-types.md#message-types.title).

You can increase your messaging limit to 1,000 messages on your own by following these guidelines:
+ Your business phone number must have an [Active status](managing-phone-numbers-status.md#managing-phone-numbers-status.title). 
+ If your business phone number has a [low quality rating](understanding-phone-number-quality-rating.md#understanding-phone-number-quality-rating.title), it may continue to be limited to 250 business-initiated conversations per day until its quality rating improves.
+ Apply for [Business Verification](https://www.facebook.com/business/help/1095661473946872). If your business is approved, the messaging quality will be analyzed to determine if your messaging activity warrants an increase to your messaging limit. Based on the analysis, your request for a messaging limit increase will either be approved or denied by Meta.
+ Apply for [Identity Verification](https://www.facebook.com/business/help/587323819101032). If you complete identity verification and your identity is confirmed, Meta will approve a messaging limit increase.
...
**Note**  
If you opt in to Meta's Marketing Messages (MM) API, marketing template messaging limits are managed dynamically by Meta. According to Meta, templates with high engagement automatically receive expanded reach. Static conversation-based limits continue to apply to utility, authentication, and service messages.
