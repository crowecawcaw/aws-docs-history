...
policies to limit the permissions that Social Messaging gives another service to the
...
`arn:aws:social-messaging:*:`123456789012`:*`.
...
`aws:SourceAccount` global condition context keys in Social Messaging to prevent
