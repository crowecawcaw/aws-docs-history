...
+ [Using the AWS End User Messaging Social console](#security_iam_id-based-policy-examples-console)
...
To access the AWS End User Messaging Social console, you must have a minimum set of permissions. These permissions must allow you to list and view details about the AWS End User Messaging Social resources in your AWS account. If you create an identity-based policy that is more restrictive than the minimum required permissions, the console won't function as intended for entities (users or roles) with that policy.
