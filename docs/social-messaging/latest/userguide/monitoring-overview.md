...
performance of AWS End User Messaging Social and your other AWS solutions. AWS provides the following monitoring
tools to watch AWS End User Messaging Social, report when something is wrong, and take automatic actions when
appropriate:
