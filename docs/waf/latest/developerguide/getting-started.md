...
**Topics**
+ [Getting started with AWS WAF using the new console experience](setup-iap-console.md)
+ [Getting started with AWS WAF using the standard console experience](setup-existing-console.md)