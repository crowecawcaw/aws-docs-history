...
- [I am not authorized to perform an action in AWS WAF Classic](#classic-security_iam_troubleshoot-no-permissions "#classic-security_iam_troubleshoot-no-permissions")
- [I am not authorized to perform iam:PassRole](#classic-security_iam_troubleshoot-passrole "#classic-security_iam_troubleshoot-passrole")
- [I want to allow people outside of my AWS account to access my AWS WAF Classic resources](#classic-security_iam_troubleshoot-cross-account-access "#classic-security_iam_troubleshoot-cross-account-access")
