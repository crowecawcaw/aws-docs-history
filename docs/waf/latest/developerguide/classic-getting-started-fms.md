...
- To use Firewall Manager to enable Amazon VPC security groups, follow the steps in [Setting up AWS Firewall Manager​ Amazon VPC security group policies](getting-started-fms-security-group.md "getting-started-fms-security-group.md").
...
- [Step 4: Create and apply an AWS Firewall Manager AWS WAF Classic policy](classic-get-started-fms-create-security-policy.md "classic-get-started-fms-create-security-policy.md")
