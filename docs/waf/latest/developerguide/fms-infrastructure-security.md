...
As a managed service, AWS Firewall Manager is protected by AWS global network security. For
...
You use AWS published API calls to access Firewall Manager through the network. Clients must
