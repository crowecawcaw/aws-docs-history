...
**Topics**
+ [Using managed rule groups in AWS WAF](waf-managed-rule-groups.md)
+ [Managing your own rule groups](waf-user-created-rule-groups.md)
+ [AWS Marketplace rule groups](marketplace-rule-groups.md)
+ [Recognizing rule groups provided by other services](waf-service-owned-rule-groups.md)