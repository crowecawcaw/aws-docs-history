...
interface. For information about the CloudFormation resource, see [AWS::Shield::Protection](../../../AWSCloudFormation/latest/UserGuide/aws-resource-shield-protection.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-shield-protection.md") in the _AWS CloudFormation user guide_.
...
You'll
see the following differences compared to other web ACLs that you manage through CloudFormation:

- CloudFormation won't report any drift in the stack drift status between the actual configuration of the
