...
| IP address ranges (in CIDR notation) per IP match condition | 10,000<br />You can update up to 1,000 addresses at a time. The API call `UpdateIPSet` accepts a maximum of 1,000 addresses in a single request. | 
