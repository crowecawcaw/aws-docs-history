...
Editor](../../../awsconsolehelpdocs/latest/gsg/tag-editor.md "../../../awsconsolehelpdocs/latest/gsg/tag-editor.md"). 10. Choose **Next**. 11. Review the new resource set. To make any changes, choose **Edit** in the area
that you want to change. This returns you to the corresponding step in the
creation wizard. When you are satisfied with the resource set, choose
**Create resource set**.
