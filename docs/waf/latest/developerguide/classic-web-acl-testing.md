...
Choose the rules for which you want to view data.
   ...
   + The graph doesn't refresh itself automatically. To update the display, choose the refresh (![Icon to refresh the Amazon CloudWatch graph](https://docs.aws.amazon.com/waf/latest/developerguide/images/cloudwatch-refresh-icon.png)) icon.
