...
**Topics**
+ [Joining and configuring AWS Organizations for using Firewall Manager](join-aws-orgs.md)
+ [Creating an AWS Firewall Manager default administrator account](enable-integration.md)
+ [Enabling AWS Config for using Firewall Manager](enable-config.md)
+ [Subscribing in the AWS Marketplace and configuring third-party settings for Firewall Manager third-party policies](fms-third-party-prerequisites.md)
+ [Enabling resource sharing for Network Firewall and DNS Firewall policies with AWS RAM](enable-ram.md)
