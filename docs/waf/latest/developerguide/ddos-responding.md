...
- **Contact support** – If you're a Shield Advanced customer,
  ...
  and urgent cases are routed directly to DDoS experts. For information, see [Contacting the support center during an application layer DDoS attack](ddos-responding-contact-support.md "ddos-responding-contact-support.md").
