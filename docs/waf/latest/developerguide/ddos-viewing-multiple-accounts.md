...
# Viewing Shield Advanced events across multiple AWS accounts with AWS Firewall Manager and AWS Security Hub

You can use AWS Firewall Manager and AWS Security Hub to manage and monitor AWS Shield Advanced protected
...
You can integrate Firewall Manager with AWS Security Hub to get a single dashboard that reports DDoS events
...
event inside the Security Hub console when you have an integration of this type.
