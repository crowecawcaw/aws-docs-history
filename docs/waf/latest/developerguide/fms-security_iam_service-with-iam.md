...
To see a list of Firewall Manager actions, see [Actions defined by AWS Firewall Manager](../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-actions-as-permissions "../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-actions-as-permissions") in the
...
To see a list of Firewall Manager resource types and their ARNs, see
[Resources defined by AWS Firewall Manager](../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of Firewall Manager condition keys, see [Condition keys for AWS Firewall Manager](../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-policy-keys "../../../service-authorization/latest/reference/list_awsfirewallmanager.md#awsfirewallmanager-policy-keys") in the
...
[PutNotificationChannel](https://amazonaws.com/fms/2018-01-01/APIReference/API_PutNotificationChannel.html "https://amazonaws.com/fms/2018-01-01/APIReference/API_PutNotificationChannel.html") in the _AWS Firewall Manager API Reference_.
