...
Multiple log files may be published within a 5-minute period. The log files may contain some or all of the AWS WAF log records for the traffic recorded in the previous five minutes.
