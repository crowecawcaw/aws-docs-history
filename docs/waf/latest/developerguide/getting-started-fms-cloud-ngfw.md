...
13. Choose **Next**. 14. For **Policy scope**, under **AWS accounts this policy applies to**, choose the
option as follows:
...
and the same value. 16. For **Grant cross-account access**, choose **Download CloudFormation
