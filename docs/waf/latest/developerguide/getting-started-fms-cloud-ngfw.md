...
**Topics**
+ [Step 1: Completing the general prerequisites](#complete-fms-prereq)
+ [Step 2: Completing the Palo Alto Networks Cloud NGFW policy prerequisites](#complete-prereq-cloud-ngfw)
+ [Step 3: Creating and applying a Palo Alto Networks Cloud NGFW policy](#get-started-fms-cloud-ngfw-create-policy)
