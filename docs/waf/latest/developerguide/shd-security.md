...
This section provides standard AWS security guidance for your use of the AWS Shield service and
its AWS resources, such as Shield Advanced protections.
...
- **Security of the cloud** – AWS is responsible for protecting the infrastructure that runs AWS services in
  ...
  the compliance programs that apply to Shield, see [AWS Services in Scope
...
- **Security in the cloud** – Your responsibility is
  ...
  using Shield. The following topics show you how to configure Shield to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Shield resources.

###### Topics

- [Protecting your data in Shield](shd-data-protection.md "shd-data-protection.md")
- [Using IAM with AWS Shield](shd-security-iam.md "shd-security-iam.md")
