...
For information about retrieving an AWS Managed Rules rule group's versions, see [Retrieving the available versions for a managed rule group](waf-using-managed-rule-groups-versions.md "waf-using-managed-rule-groups-versions.md").
...
- [Baseline rule groups](aws-managed-rule-groups-baseline.md "aws-managed-rule-groups-baseline.md")
...
- [Use-case specific rule groups](aws-managed-rule-groups-use-case.md "aws-managed-rule-groups-use-case.md")
...
- [IP reputation rule groups](aws-managed-rule-groups-ip-rep.md "aws-managed-rule-groups-ip-rep.md")
