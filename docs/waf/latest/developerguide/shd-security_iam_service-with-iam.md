...
To view examples of Shield identity-based policies, see [Identity-based policy examples for
AWS Shield](shd-security_iam_id-based-policy-examples.md "shd-security_iam_id-based-policy-examples.md").

## Resource-based

policies within Shield
...
For details about creating or managing Shield service-linked roles, see [Using service-linked roles for
