...
As a managed service, AWS WAF is protected by AWS global network security. For
...
You use AWS published API calls to access AWS WAF through the network. Clients must
