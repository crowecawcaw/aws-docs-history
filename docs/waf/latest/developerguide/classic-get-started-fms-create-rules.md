...
In this step, you create rules using AWS WAF Classic. If you already have AWS WAF Classic
rules that you want to use with AWS Firewall Manager, skip this step and go to [Step 3: Create a rule group](classic-get-started-fms-create-rule-group.md "classic-get-started-fms-create-rule-group.md").
...
- Create your rules, and then add your conditions to your rules. For more
  ...
  You are now ready to go to [Step 3: Create a rule group](classic-get-started-fms-create-rule-group.md "classic-get-started-fms-create-rule-group.md").
