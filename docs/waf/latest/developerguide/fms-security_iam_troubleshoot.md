...
**Topics**
+ [I am not authorized to perform an action in Firewall Manager](#fms-security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#fms-security_iam_troubleshoot-passrole)
+ [I want to allow people outside of my AWS account to access my Firewall Manager resources](#fms-security_iam_troubleshoot-cross-account-access)
