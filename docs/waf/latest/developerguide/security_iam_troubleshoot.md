...
encounter when working with AWS WAF and IAM.

###### Topics

- [I am not authorized to
  perform an action in AWS WAF](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS WAF resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS WAF
...
have the fictional `wafv2:`GetWidget`` permissions.
...
AWS WAF. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AWS WAF resources
...
- To learn whether AWS WAF supports these features, see [How AWS WAF works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
