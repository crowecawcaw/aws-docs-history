...
As a managed service, AWS WAF Classic is protected by AWS global network security. For
...
You use AWS published API calls to access AWS WAF Classic through the network. Clients must
