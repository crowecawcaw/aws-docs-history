...
By default, users and roles don't have permission to create or modify AWS WAF Classic
...
For details about actions and resource types defined by AWS WAF Classic, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for AWS WAF](../../../service-authorization/latest/reference/list_awswaf.md "../../../service-authorization/latest/reference/list_awswaf.md") and [Actions, resources, and condition keys for AWS WAF Regional](../../../service-authorization/latest/reference/list_awswafregional.md "../../../service-authorization/latest/reference/list_awswafregional.md") in the _Service Authorization Reference_.
