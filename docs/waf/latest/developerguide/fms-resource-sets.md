...
**Topics**
+ [Considerations when working with resource sets in Firewall Manager](#fms-resource-sets-considerations)
+ [Creating resource sets in Firewall Manager](fms-creating-resource-set.md)
+ [Deleting a resource set in Firewall Manager](fms-deleting-resource-set.md)
