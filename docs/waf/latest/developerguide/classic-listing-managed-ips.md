...
If you see **Switch to AWS WAF Classic** in the navigation pane, select it. 2. In the navigation pane, choose **Rules**. 3. In the **Name** column, choose a rate-based rule.
