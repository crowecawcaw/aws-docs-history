...
encounter when working with Shield and IAM.

###### Topics

- [I am not authorized to
  perform an action in Shield](#shd-security_iam_troubleshoot-no-permissions "#shd-security_iam_troubleshoot-no-permissions")
- [I am not authorized to perform
  iam:PassRole](#shd-security_iam_troubleshoot-passrole "#shd-security_iam_troubleshoot-passrole")
- [I want to allow people
  outside of my AWS account to access my Shield resources](#shd-security_iam_troubleshoot-cross-account-access "#shd-security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Shield
...
have the fictional `shield:`GetWidget`` permissions.
...
Shield. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Shield resources
...
- To learn whether Shield supports these features, see [How AWS Shield works with IAM](shd-security_iam_service-with-iam.md "shd-security_iam_service-with-iam.md").
