...
- [I am not authorized to perform an action in Shield](#shd-security_iam_troubleshoot-no-permissions "#shd-security_iam_troubleshoot-no-permissions")
- [I am not authorized to perform iam:PassRole](#shd-security_iam_troubleshoot-passrole "#shd-security_iam_troubleshoot-passrole")
- [I want to allow people outside of my AWS account to access my Shield resources](#shd-security_iam_troubleshoot-cross-account-access "#shd-security_iam_troubleshoot-cross-account-access")
