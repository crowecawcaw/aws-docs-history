...
| Protect a TCP-based application against a DDoS attack            | Shield Advanced protecting an AWS Global Accelerator standard accelerator; attached to an Elastic IP address | [AWS Global Accelerator Documentation](../../../global-accelerator.md "../../../global-accelerator.md"),<br>[Elastic Load Balancing documentation](../../../elasticloadbalancing.md "../../../elasticloadbalancing.md") |
| Protect a UDP-based game server against a DDoS attack            | Shield Advanced protecting an Amazon EC2 instance attached to an Elastic IP address                          | [Amazon Elastic Compute Cloud Documentation](../../../ec2.md "../../../ec2.md")                                                                                                                                         |
