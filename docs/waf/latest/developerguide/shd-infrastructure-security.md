...
As a managed service, AWS Shield is protected by AWS global network security. For
...
You use AWS published API calls to access Shield through the network. Clients must
