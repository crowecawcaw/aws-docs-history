...
Add approved personnel to your Transfer team and schedule a Data Transfer Terminal reservation using the AWS Data Transfer Terminal [console](https://console.aws.amazon.com/datatransferterminal).
