...
**Topics**
+ [Equipment connection issues](#physical-connection)
+ [Troubleshooting connectivity](#connection-issues)
...
+ Each Data Transfer Terminal facility will have two (2) single-mode, LC fiber cables. If one or both of these cables are missing, contact [AWS Support](https://aws.amazon.com/contact-us/) immediately.
...
If you’re still unable to use the cables to connect, contact [AWS Support](https://aws.amazon.com/contact-us/) immediately.
...
+ Confirm that your equipment configuration meets the specified network requirements. For more information, see [Technical requirements for using Data Transfer Terminal](tech-requirements.md) 
...
If you’re still unable connect, contact [AWS Support](https://aws.amazon.com/contact-us/) and provide them with the following outputs depending on what operating system (OS) is running on your device.
