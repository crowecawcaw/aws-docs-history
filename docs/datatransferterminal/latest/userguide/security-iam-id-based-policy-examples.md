...
For details about actions and resource types defined by , including the format of the ARNs for each of the resource types, see [Actions](../../../IAM/latest/UserGuide/list_your_service.md "../../../IAM/latest/UserGuide/list_your_service.md") in the _Service Authorization Reference_.
...
- [Using the Data Transfer Terminal console](#security-iam-id-based-policy-examples-console "#security-iam-id-based-policy-examples-console")
...
To ensure that users and roles can still use the Data Transfer Terminal console, also attach the Data Transfer Terminal `ConsoleAccess` or `ReadOnly`
