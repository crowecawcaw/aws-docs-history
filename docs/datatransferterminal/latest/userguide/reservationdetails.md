...
<a name="reservationdetails"></a>

The following instructions walk you through how to schedule your Data Transfer Terminal reservation in the AWS Management Console. For information about using the Data Transfer Terminal facility, see [Make a data transfer](accessing-site.md).

1. Select the **Make reservation** button in the **Upcoming reservations** tab.

1. Complete the fields on the **Specify reservation details** page.
   ...
   1.  **Process owner**: Select the personnel alias you would like to be responsible for managing the reservation.
   ...
   1.  **Data transfer specialist**: Select the personnel you want to have access to the Data Transfer Terminal facility to complete the data transfer activity. You may select more than one personnel, as needed.
      + Best practice is to limit your Transfer team to no more than four (4) Data transfer specialists.

   1.  **Data Transfer Terminal information**: Specify the Data Transfer Terminal facility, the desired date, and specific time for the data transfer session.
...
Only facility descriptions will be provided while making a reservation. Additional location information will be provided in the reservation confirmation email.
      ...
      1.  **Data Transfer Terminal date and time**: Click into the **Search a date and time for your reservation** field to view the calendar and schedule your reservation.
         ...
         + For more information, see [Scheduling considerations](scheduling.md).

1. Confirm the reservation details are correct and then select the **Create** button to continue. This will take you to the confirmation page, which provides a summary of your reservation.