...
After modifying the policy to your use case, attach it to the IAM identity that calls the Nova Act API. To learn how to attach permissions to an IAM identity, see [Adding and removing IAM identity permissions](../../../IAM/latest/UserGuide/access_policies_manage-attach-detach.md "../../../IAM/latest/UserGuide/access_policies_manage-attach-detach.md").

For information about enabling encryption on your export S3 bucket, see [Encryption at rest](data-encryption.md#encryption-rest "data-encryption.md#encryption-rest").
