...
1. Verify your AWS credentials with ** `aws sts get-caller-identity` **. If needed, configure or update your credentials.

1. Ensure your IAM Identity has a policy permitting read and write access to the Nova Act service (see [AWS Managed Policies](security-iam-awsmanpol.md)).

1. Enter your workflow name and select your AWS Region.

1. Click **Deploy your workflow**.
