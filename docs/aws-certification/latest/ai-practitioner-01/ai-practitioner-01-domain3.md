...
- [Task Statement 3.1: Describe design considerations for applications that use foundation models (FMs).](#ai-practitioner-01-task3.1 "#ai-practitioner-01-task3.1")
- [Task Statement 3.2: Choose effective prompt engineering techniques.](#ai-practitioner-01-task3.2 "#ai-practitioner-01-task3.2")
- [Task Statement 3.3: Describe the training and fine-tuning process for FMs.](#ai-practitioner-01-task3.3 "#ai-practitioner-01-task3.3")
- [Task Statement 3.4: Describe methods to evaluate FM performance.](#ai-practitioner-01-task3.4 "#ai-practitioner-01-task3.4")
