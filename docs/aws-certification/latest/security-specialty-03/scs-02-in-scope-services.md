...
- [Analytics](#scs-02-in-scope-analytics "#scs-02-in-scope-analytics")
- [Application Integration](#scs-02-in-scope-application-integration "#scs-02-in-scope-application-integration")
- [Compute](#scs-02-in-scope-compute "#scs-02-in-scope-compute")
- [Developer Tools](#scs-02-in-scope-developer-tools "#scs-02-in-scope-developer-tools")
- [Internet of Things](#scs-02-in-scope-internet-of-things "#scs-02-in-scope-internet-of-things")
- [Machine Learning](#scs-02-in-scope-machine-learning "#scs-02-in-scope-machine-learning")
- [Management and Governance](#scs-02-in-scope-management-governance "#scs-02-in-scope-management-governance")
- [Networking and Content Delivery](#scs-02-in-scope-networking-content-delivery "#scs-02-in-scope-networking-content-delivery")
