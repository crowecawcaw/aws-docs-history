...
- [Task Statement 4.1: Compare AWS pricing models.](#cloud-practitioner-02-task4.1 "#cloud-practitioner-02-task4.1")
- [Task Statement 4.2: Understand resources for billing, budget, and cost management.](#cloud-practitioner-02-task4.2 "#cloud-practitioner-02-task4.2")
- [Task Statement 4.3: Identify AWS technical resources and AWS Support options.](#cloud-practitioner-02-task4.3 "#cloud-practitioner-02-task4.3")
