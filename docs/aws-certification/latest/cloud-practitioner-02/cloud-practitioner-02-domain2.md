...
- [Task Statement 2.1: Understand the AWS shared responsibility model.](#cloud-practitioner-02-task2.1 "#cloud-practitioner-02-task2.1")
- [Task Statement 2.2: Understand AWS Cloud security, governance, and compliance concepts.](#cloud-practitioner-02-task2.2 "#cloud-practitioner-02-task2.2")
- [Task Statement 2.3: Identify AWS access management capabilities.](#cloud-practitioner-02-task2.3 "#cloud-practitioner-02-task2.3")
- [Task Statement 2.4: Identify components and resources for security.](#cloud-practitioner-02-task2.4 "#cloud-practitioner-02-task2.4")
