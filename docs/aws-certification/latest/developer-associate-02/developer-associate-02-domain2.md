...
- [Task 1: Implement authentication and/or authorization for applications and AWS services](#developer-associate-02-domain2-task1 "#developer-associate-02-domain2-task1")
- [Task 2: Implement encryption by using AWS services](#developer-associate-02-domain2-task2 "#developer-associate-02-domain2-task2")
- [Task 3: Manage sensitive data in application code](#developer-associate-02-domain2-task3 "#developer-associate-02-domain2-task3")
