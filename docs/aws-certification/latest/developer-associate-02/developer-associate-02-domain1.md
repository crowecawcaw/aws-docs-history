...
**Topics**
+ [Task 1: Develop code for applications hosted on AWS](#developer-associate-02-domain1-task1)
+ [Task 2: Develop code for AWS Lambda](#developer-associate-02-domain1-task2)
+ [Task 3: Use data stores in application development](#developer-associate-02-domain1-task3)
