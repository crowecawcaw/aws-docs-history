...
**Topics**
+ [Task 1: Assist in a root cause analysis](#developer-associate-02-domain4-task1)
+ [Task 2: Instrument code for observability](#developer-associate-02-domain4-task2)
+ [Task 3: Optimize applications by using AWS services and features](#developer-associate-02-domain4-task3)
