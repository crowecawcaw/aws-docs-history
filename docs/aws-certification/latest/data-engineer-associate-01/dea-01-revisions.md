...
## Change History
<a name="dea-01-change-history"></a>
...
<a name="dea-01-changes-knowledge-skills"></a>
...
## Skills removed
<a name="dea-01-skills-removed"></a>
...
<a name="dea-01-services-changes"></a>

### Services added to the in-scope list
<a name="dea-01-services-added-in-scope"></a>
+ Amazon Aurora
+ Amazon Q
+ Amazon Bedrock
+ Amazon Kendra
...
<a name="dea-01-services-removed-in-scope"></a>
+ AWS Cloud9
+ AWS CodeCommit
+ AWS Schema Conversion Tool (AWS SCT)

### Services added to the out-of-scope list
<a name="dea-01-services-added-out-scope"></a>
...
<a name="dea-01-services-removed-out-scope"></a>
+ Amazon Honeycode
+ Amazon WorkDocs
+ Amazon Timestream
