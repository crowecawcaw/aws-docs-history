...
- [Task 2.1: Choose a data store](#data-engineer-associate-01-domain2-task1 "#data-engineer-associate-01-domain2-task1")
- [Task 2.2: Understand data cataloging systems](#data-engineer-associate-01-domain2-task2 "#data-engineer-associate-01-domain2-task2")
- [Task 2.3: Manage the lifecycle of data](#data-engineer-associate-01-domain2-task3 "#data-engineer-associate-01-domain2-task3")
- [Task 2.4: Design data models and schema evolution](#data-engineer-associate-01-domain2-task4 "#data-engineer-associate-01-domain2-task4")
