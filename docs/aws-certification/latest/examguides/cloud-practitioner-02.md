...
- [Introduction](#cloud-practitioner-02-intro "#cloud-practitioner-02-intro")
- [Target Candidate Description](#cloud-practitioner-02-target "#cloud-practitioner-02-target")
- [Exam Content](#cloud-practitioner-02-exam-content "#cloud-practitioner-02-exam-content")
- [Content Outline](#cloud-practitioner-02-domains "#cloud-practitioner-02-domains")
- [Service References](#clf-service-references "#clf-service-references")
- [Content Domain 1: Cloud Concepts](cloud-practitioner-02-domain1.md "cloud-practitioner-02-domain1.md")
- [Content Domain 2: Security and Compliance](cloud-practitioner-02-domain2.md "cloud-practitioner-02-domain2.md")
- [Content Domain 3: Cloud Technology and Services](cloud-practitioner-02-domain3.md "cloud-practitioner-02-domain3.md")
- [Content Domain 4: Billing, Pricing, and Support](cloud-practitioner-02-domain4.md "cloud-practitioner-02-domain4.md")
- [Technologies and Concepts](clf-technologies-concepts.md "clf-technologies-concepts.md")
- [In-Scope AWS Services](clf-02-in-scope-services.md "clf-02-in-scope-services.md")
- [Out-of-Scope AWS Services](clf-02-out-of-scope-services.md "clf-02-out-of-scope-services.md")
- [Survey](#cloud-practitioner-02-survey "#cloud-practitioner-02-survey")

## Introduction

The [AWS Certified Cloud Practitioner (CLF-C02)](https://aws.amazon.com/certification/certified-cloud-practitioner/ "https://aws.amazon.com/certification/certified-cloud-practitioner/") exam is intended for individuals who can effectively demonstrate overall knowledge of the AWS Cloud, independent of a specific job role.
...
- [Content Domain 1: Cloud Concepts (24% of scored content)](cloud-practitioner-02-domain1.md "cloud-practitioner-02-domain1.md")
- [Content Domain 2: Security and Compliance (30% of scored content)](cloud-practitioner-02-domain2.md "cloud-practitioner-02-domain2.md")
- [Content Domain 3: Cloud Technology and Services (34% of scored content)](cloud-practitioner-02-domain3.md "cloud-practitioner-02-domain3.md")
- [Content Domain 4: Billing, Pricing, and Support (12% of scored content)](cloud-practitioner-02-domain4.md "cloud-practitioner-02-domain4.md")
...
How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=CloudPractitioner&course_id=CLF-C02&Q_Language=EN "https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=CloudPractitioner&course_id=CLF-C02&Q_Language=EN").
