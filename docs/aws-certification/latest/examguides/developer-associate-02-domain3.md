...
- [Task 1: Prepare application artifacts to be deployed to AWS](#developer-associate-02-domain3-task1 "#developer-associate-02-domain3-task1")
- [Task 2: Test applications in development environments](#developer-associate-02-domain3-task2 "#developer-associate-02-domain3-task2")
- [Task 3: Automate deployment testing](#developer-associate-02-domain3-task3 "#developer-associate-02-domain3-task3")
- [Task 4: Deploy code by using AWS Continuous Integration and Continuous Delivery (CI/CD) services](#developer-associate-02-domain3-task4 "#developer-associate-02-domain3-task4")
