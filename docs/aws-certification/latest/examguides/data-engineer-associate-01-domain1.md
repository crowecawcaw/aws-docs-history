...
- [Task 1.1: Perform data ingestion](#data-engineer-associate-01-domain1-task1 "#data-engineer-associate-01-domain1-task1")
- [Task 1.2: Transform and process data](#data-engineer-associate-01-domain1-task2 "#data-engineer-associate-01-domain1-task2")
- [Task 1.3: Orchestrate data pipelines](#data-engineer-associate-01-domain1-task3 "#data-engineer-associate-01-domain1-task3")
- [Task 1.4: Apply programming concepts](#data-engineer-associate-01-domain1-task4 "#data-engineer-associate-01-domain1-task4")
