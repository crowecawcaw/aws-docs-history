...
You can consult [AWS Service Names](https://aws.amazon.com/certification/policies/before-testing/#Exam_content "https://aws.amazon.com/certification/policies/before-testing/#Exam_content") on the AWS Certification website for the list of services that appear as their short names on the exam. Any services that are on the list but that are out of scope for the exam will not appear on the exam.
