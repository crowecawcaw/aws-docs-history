...
- [Introduction](#ai-practitioner-01-intro "#ai-practitioner-01-intro")
- [Target candidate description](#ai-practitioner-01-target "#ai-practitioner-01-target")
- [Exam content](#ai-practitioner-01-exam-content "#ai-practitioner-01-exam-content")
- [Content outline](#ai-practitioner-01-domains "#ai-practitioner-01-domains")
- [Service References](#aip-service-references "#aip-service-references")
- [Content Domain 1: Fundamentals of AI and ML](ai-practitioner-01-domain1.md "ai-practitioner-01-domain1.md")
- [Content Domain 2: Fundamentals of GenAI](ai-practitioner-01-domain2.md "ai-practitioner-01-domain2.md")
- [Content Domain 3: Applications of Foundation Models](ai-practitioner-01-domain3.md "ai-practitioner-01-domain3.md")
- [Content Domain 4: Guidelines for Responsible AI](ai-practitioner-01-domain4.md "ai-practitioner-01-domain4.md")
- [Content Domain 5: Security, Compliance, and Governance for AI Solutions](ai-practitioner-01-domain5.md "ai-practitioner-01-domain5.md")
- [In-scope AWS services and features](aif-01-in-scope-services.md "aif-01-in-scope-services.md")
- [Out-of-scope AWS services and features](aif-01-out-of-scope-services.md "aif-01-out-of-scope-services.md")
- [Mentions of AWS Services on the Exam](aip-service-mentions.md "aip-service-mentions.md")
- [Survey](#ai-practitioner-01-survey "#ai-practitioner-01-survey")

## Introduction

The [AWS Certified AI Practitioner (AIF-C01)](https://aws.amazon.com/certification/certified-ai-practitioner/ "https://aws.amazon.com/certification/certified-ai-practitioner/") exam is designed for individuals who want to demonstrate a foundational understanding of AI concepts and AWS AI tools. This certification focuses on practical business applications of AI.
...
- [Content Domain 1: Fundamentals of AI and ML (20% of scored content)](ai-practitioner-01-domain1.md "ai-practitioner-01-domain1.md")
- [Content Domain 2: Fundamentals of GenAI (24% of scored content)](ai-practitioner-01-domain2.md "ai-practitioner-01-domain2.md")
- [Content Domain 3: Applications of Foundation Models (28% of scored content)](ai-practitioner-01-domain3.md "ai-practitioner-01-domain3.md")
- [Content Domain 4: Guidelines for Responsible AI (14% of scored content)](ai-practitioner-01-domain4.md "ai-practitioner-01-domain4.md")
- [Content Domain 5: Security, Compliance, and Governance for AI Solutions (14% of scored content)](ai-practitioner-01-domain5.md "ai-practitioner-01-domain5.md")
...
- [Mentions of AWS Services on the Exam](aip-service-mentions.md "aip-service-mentions.md")
- [In-Scope AWS Services](aif-01-in-scope-services.md "aif-01-in-scope-services.md")
- [Out-of-Scope AWS Services](aif-01-out-of-scope-services.md "aif-01-out-of-scope-services.md")

## Survey

How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=AI-Foundational&course_id=AIF-C01&Q_Language=EN "https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=AI-Foundational&course_id=AIF-C01&Q_Language=EN").
