...
- [Introduction](#sysops-administrator-associate-03-intro "#sysops-administrator-associate-03-intro")
- [Target candidate description](#sysops-administrator-associate-03-target "#sysops-administrator-associate-03-target")
- [Exam content](#sysops-administrator-associate-03-exam-content "#sysops-administrator-associate-03-exam-content")
- [Content outline](#sysops-administrator-associate-03-domains "#sysops-administrator-associate-03-domains")
- [Content Domain 1: Monitoring, Logging, Analysis, Remediation, and Performance Optimization](sysops-administrator-associate-03-domain1.md "sysops-administrator-associate-03-domain1.md")
- [Content Domain 2: Reliability and Business Continuity](sysops-administrator-associate-03-domain2.md "sysops-administrator-associate-03-domain2.md")
...
- [In-scope AWS services and features](soa-03-in-scope-services.md "soa-03-in-scope-services.md")
- [Out-of-scope AWS services and features](soa-03-out-of-scope-services.md "soa-03-out-of-scope-services.md")
- [Survey](#sysops-administrator-associate-03-survey "#sysops-administrator-associate-03-survey")

## Introduction

The [AWS Certified CloudOps Engineer - Associate (SOA-C03)](https://aws.amazon.com/certification/certified-cloudops-engineer-associate/ "https://aws.amazon.com/certification/certified-cloudops-engineer-associate/") exam is intended for CloudOps engineers. The exam validates a candidate's ability to deploy, manage, and operate workloads on AWS.
...
How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=SysOps-Associate&course_id=SOA-C02&Q_Language=EN "https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=SysOps-Associate&course_id=SOA-C02&Q_Language=EN").
