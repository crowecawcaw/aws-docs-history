...
- [Task 3.1: Automate data processing by using AWS services](#data-engineer-associate-01-domain3-task1 "#data-engineer-associate-01-domain3-task1")
- [Task 3.2: Analyze data by using AWS services](#data-engineer-associate-01-domain3-task2 "#data-engineer-associate-01-domain3-task2")
- [Task 3.3: Maintain and monitor data pipelines](#data-engineer-associate-01-domain3-task3 "#data-engineer-associate-01-domain3-task3")
- [Task 3.4: Ensure data quality](#data-engineer-associate-01-domain3-task4 "#data-engineer-associate-01-domain3-task4")
