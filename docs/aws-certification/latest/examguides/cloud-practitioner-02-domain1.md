...
- [Task Statement 1.1: Define the benefits of the AWS Cloud.](#cloud-practitioner-02-task1.1 "#cloud-practitioner-02-task1.1")
- [Task Statement 1.2: Identify design principles of the AWS Cloud.](#cloud-practitioner-02-task1.2 "#cloud-practitioner-02-task1.2")
- [Task Statement 1.3: Understand the benefits of and strategies for migration to the AWS Cloud.](#cloud-practitioner-02-task1.3 "#cloud-practitioner-02-task1.3")
- [Task Statement 1.4: Understand concepts of cloud economics.](#cloud-practitioner-02-task1.4 "#cloud-practitioner-02-task1.4")
