...
- [Task 2.1: Implement scalability and elasticity](#sysops-administrator-associate-03-domain2-task1 "#sysops-administrator-associate-03-domain2-task1")
- [Task 2.2: Implement highly available and resilient environments](#sysops-administrator-associate-03-domain2-task2 "#sysops-administrator-associate-03-domain2-task2")
- [Task 2.3: Implement backup and restore strategies](#sysops-administrator-associate-03-domain2-task3 "#sysops-administrator-associate-03-domain2-task3")
