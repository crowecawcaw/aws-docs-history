...
- [Task 1.1: Create data repositories for ML](#machine-learning-specialty-01-domain1-task1 "#machine-learning-specialty-01-domain1-task1")
- [Task 1.2: Identify and implement a data ingestion solution](#machine-learning-specialty-01-domain1-task2 "#machine-learning-specialty-01-domain1-task2")
- [Task 1.3: Identify and implement a data transformation solution](#machine-learning-specialty-01-domain1-task3 "#machine-learning-specialty-01-domain1-task3")
