...
<a name="sysops-administrator-associate-03-domain3"></a>

**Topics**
+ [Task 3.1: Provision and maintain cloud resources.](#sysops-administrator-associate-03-domain3-task1)
+ [Task 3.2: Automate the management of existing resources.](#sysops-administrator-associate-03-domain3-task2)

## Task 3.1: Provision and maintain cloud resources.
<a name="sysops-administrator-associate-03-domain3-task1"></a>
+ Skill 3.1.1: Create and manage AMIs and container images (for example, EC2 Image Builder).
+ Skill 3.1.2: Create and manage AWS resources by using CloudFormation and the AWS CDK.
