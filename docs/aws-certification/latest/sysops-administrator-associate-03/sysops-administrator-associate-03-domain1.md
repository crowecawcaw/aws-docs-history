...
- [Task 1.1: Implement metrics, alarms, and filters by using AWS monitoring and logging services.](#sysops-administrator-associate-03-domain1-task1 "#sysops-administrator-associate-03-domain1-task1")
- [Task 1.2: Identify and remediate issues by using monitoring and availability metrics.](#sysops-administrator-associate-03-domain1-task2 "#sysops-administrator-associate-03-domain1-task2")
- [Task 1.3: Implement performance optimization strategies for compute, storage, and database resources.](#sysops-administrator-associate-03-domain1-task3 "#sysops-administrator-associate-03-domain1-task3")
