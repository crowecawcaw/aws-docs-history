...
- [Task 3.1: Frame business problems as ML problems](#machine-learning-specialty-01-domain3-task1 "#machine-learning-specialty-01-domain3-task1")
- [Task 3.2: Select the appropriate model(s) for a given ML problem](#machine-learning-specialty-01-domain3-task2 "#machine-learning-specialty-01-domain3-task2")
- [Task 3.3: Train ML models](#machine-learning-specialty-01-domain3-task3 "#machine-learning-specialty-01-domain3-task3")
- [Task 3.4: Perform hyperparameter optimization](#machine-learning-specialty-01-domain3-task4 "#machine-learning-specialty-01-domain3-task4")
- [Task 3.5: Evaluate ML models](#machine-learning-specialty-01-domain3-task5 "#machine-learning-specialty-01-domain3-task5")
