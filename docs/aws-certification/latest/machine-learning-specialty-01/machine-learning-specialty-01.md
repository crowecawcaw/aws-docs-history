...
- [Introduction](#machine-learning-specialty-01-intro "#machine-learning-specialty-01-intro")
- [Target Candidate Description](#machine-learning-specialty-01-target "#machine-learning-specialty-01-target")
- [Exam Content](#machine-learning-specialty-01-exam-content "#machine-learning-specialty-01-exam-content")
- [Content outline](#machine-learning-specialty-01-domains "#machine-learning-specialty-01-domains")
- [Service References](#mls-service-references "#mls-service-references")
- [Content Domain 1: Data Engineering](machine-learning-specialty-01-domain1.md "machine-learning-specialty-01-domain1.md")
- [Content Domain 2: Exploratory Data Analysis](machine-learning-specialty-01-domain2.md "machine-learning-specialty-01-domain2.md")
- [Content Domain 3: Modeling](machine-learning-specialty-01-domain3.md "machine-learning-specialty-01-domain3.md")
- [Content Domain 4: Machine Learning Implementation and Operations](machine-learning-specialty-01-domain4.md "machine-learning-specialty-01-domain4.md")
- [In-Scope AWS Services](mls-01-in-scope-services.md "mls-01-in-scope-services.md")
- [Out-of-Scope AWS Services](mls-01-out-of-scope-services.md "mls-01-out-of-scope-services.md")
- [Technologies and Concepts](mls-technologies-concepts.md "mls-technologies-concepts.md")
- [Survey](#machine-learning-specialty-01-survey "#machine-learning-specialty-01-survey")
...
- [Content Domain 1: Data Engineering (20% of scored content)](machine-learning-specialty-01-domain1.md "machine-learning-specialty-01-domain1.md")
- [Content Domain 2: Exploratory Data Analysis (24% of scored content)](machine-learning-specialty-01-domain2.md "machine-learning-specialty-01-domain2.md")
- [Content Domain 3: Modeling (36% of scored content)](machine-learning-specialty-01-domain3.md "machine-learning-specialty-01-domain3.md")
- [Content Domain 4: Machine Learning Implementation and Operations (20% of scored content)](machine-learning-specialty-01-domain4.md "machine-learning-specialty-01-domain4.md")
...
How useful was this exam guide? Let us know by [taking our survey](https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=MLS-Specialty&course_id=MLS-C01&Q_Language=EN "https://amazonmr.au1.qualtrics.com/jfe/form/SV_8vLR1a9uG9zu9Po?course_title=MLS-Specialty&course_id=MLS-C01&Q_Language=EN").
