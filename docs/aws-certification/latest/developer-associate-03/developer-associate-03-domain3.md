...
- [Task 3.1: Prepare application artifacts to be deployed to AWS.](#dva-03-task3.1 "#dva-03-task3.1")
- [Task 3.2: Implement and automate application testing in AWS environments.](#dva-03-task3.2 "#dva-03-task3.2")
- [Task 3.3: Deploy code by using AWS continuous integration and continuous delivery (CI/CD) services.](#dva-03-task3.3 "#dva-03-task3.3")
