...
You can consult [AWS Service Names](https://aws.amazon.com/certification/policies/general-information/ "https://aws.amazon.com/certification/policies/general-information/") on the AWS Certification website for the list of services that appear as their short names on the exam. Any services that are on the list but that are out of scope for the exam will not appear on the exam.
