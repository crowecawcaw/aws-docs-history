...
- **Identity**
  - **Control objective:** Only trusted identities can access my resources / **Using:** RCP / **Applied on:** Resources
  - **Control objective:** Only trusted identities are allowed from my network / **Using:** VPC endpoint policy / **Applied on:** Network
  - **Global condition context keys:** aws:PrincipalOrgID<br />aws:PrincipalOrgPaths<br />aws:PrincipalAccount<br />aws:PrincipalIsAwsService<br />aws:SourceOrgID<br />aws:SourceOrgPath<br />aws:SourceAccount

- **Resources**
  - **Control objective:** Your identities can access only trusted resources / **Using:** SCP / **Applied on:** Identities
  - **Control objective:** Only trusted resources can be accessed from your network / **Using:** VPC endpoint policy / **Applied on:** Network
  - **Global condition context keys:** aws:ResourceOrgID<br />aws:ResourceOrgPaths<br />aws:ResourceAccount

- **Network**
  - **Control objective:** Your identities can access resources only from expected networks  / **Using:** SCP / **Applied on:** Identities
  - **Control objective:** Your resources can only be accessed from expected networks  / **Using:** RCP / **Applied on:** Resources
  - **Global condition context keys:** aws:SourceIp<br />aws:SourceVpc<br />aws:SourceVpce<br />aws:VpceAccount<br />aws:VpceOrgPaths<br />aws:VpceOrgID<br />aws:ViaAWSService<br />aws:PrincipalIsAwsService
