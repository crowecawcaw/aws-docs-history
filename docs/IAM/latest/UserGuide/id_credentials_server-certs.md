...
**Topics**
+ [Upload a server certificate (AWS API)](#upload-server-certificate)
+ [AWS API operations for server certificates](#id_credentials_server-certs-api)
+ [Troubleshoot server certificates](#server-certificate-troubleshooting)
