...
You can use IAM tag key-value pairs to add custom attributes to an IAM role. For
example, to add location information to a role, you can add the tag key
...
2. In the navigation pane of the console, choose **Roles** and
   then choose the name of the role that you want to edit.
3. Choose the **Tags** tab and then complete one of the
   following actions:
   - Choose **Add new tag** if the role does not yet have
     tags.
   - Choose **Manage tags** to manage the existing set of
     tags.

4. Add or remove tags to complete the set of tags.
   Then,
   choose **Save changes**.
...
- AWS CLI: [aws iam
  list-role-tags](../../../cli/latest/reference/iam/list-role-tags.md "../../../cli/latest/reference/iam/list-role-tags.md")
- AWS API: [ListRoleTags](../APIReference/API_ListRoleTags.md "../APIReference/API_ListRoleTags.md")

###### To attach tags to an IAM role (AWS CLI or AWS API)

- AWS CLI: [aws iam
  tag-role](../../../cli/latest/reference/iam/tag-role.md "../../../cli/latest/reference/iam/tag-role.md")
- AWS API: [TagRole](../APIReference/API_TagRole.md "../APIReference/API_TagRole.md")

###### To remove tags from an IAM role (AWS CLI or AWS API)

- AWS CLI: [aws iam
  untag-role](../../../cli/latest/reference/iam/untag-role.md "../../../cli/latest/reference/iam/untag-role.md")
- AWS API: [UntagRole](../APIReference/API_UntagRole.md "../APIReference/API_UntagRole.md")
