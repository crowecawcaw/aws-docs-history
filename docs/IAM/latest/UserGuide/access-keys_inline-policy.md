...
However, if you're creating a proof of concept test of a service automation or other short-term use case, and you choose to run workloads using an IAM user with access keys we recommend that you [use policy conditions to further restrict access](best-practices.md#use-policy-conditions) of their IAM user credentials.
