...
1. Select *Deploy with IAM temporary delegation*. Note that the option name might vary across supported products. Refer to the documentation of the product provider for details.
**Note**  
