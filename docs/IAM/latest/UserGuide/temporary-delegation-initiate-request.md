...
2. Select _Deploy with IAM temporary delegation_. Note that the option name might vary across supported products. Refer to the documentation of the product provider for details.
