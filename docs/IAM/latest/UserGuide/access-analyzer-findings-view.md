...
**Tip**  
If you have a large number of findings to review, use the IAM Access Analyzer API or AWS CLI commands to programmatically retrieve and manage your findings.
