...
+ *AWS Identity and Access Management and Access Analyzer* helps you identify the resources in your organization and accounts, such as Amazon S3 buckets or IAM roles, that are shared with an external entity. This helps you identify unintended access to your resources and data, which is a security risk. To learn more, see [What is IAM Access Analyzer?](https://docs.aws.amazon.com/IAM/latest/UserGuide/what-is-access-analyzer.html)
...
For additional resources and security best practices for IAM, see [Security best practices and use cases in AWS Identity and Access Management](best-practices-use-cases.md).

**Topics**
+ [Logging IAM and AWS STS API calls with AWS CloudTrail](cloudtrail-integration.md)
+ [Track privileged tasks in AWS CloudTrail](cloudtrail-track-privileged-tasks.md)