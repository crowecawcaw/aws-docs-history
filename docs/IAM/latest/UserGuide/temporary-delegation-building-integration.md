...
![State diagram showing delegation request flow from Unassigned through Assigned, Pending Approval, to Accepted, Rejected, Finalized, Expired, or Deleted states.](https://docs.aws.amazon.com/IAM/latest/UserGuide/images/delegation-states.png)
