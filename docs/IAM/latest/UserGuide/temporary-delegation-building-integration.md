...
![State diagram showing delegation request flow from Unassigned through Assigned, Pending Approval, to Accepted, Rejected, Finalized, Expired, or Deleted states.](http://docs.aws.amazon.com/IAM/latest/UserGuide/images/delegation-states.png)
