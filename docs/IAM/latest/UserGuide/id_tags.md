...
+ [Tag IAM users](id_tags_users.md)
+ [Tag IAM roles](id_tags_roles.md)
+ [Tag customer managed policies](id_tags_customer-managed-policies.md)
+ [Tag OpenID Connect (OIDC) identity providers](id_tags_oidc.md)
+ [Tag IAM SAML identity providers](id_tags_saml.md)
