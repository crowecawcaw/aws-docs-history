...
using [multifactor authentication (MFA)](id_credentials_mfa.md "id_credentials_mfa.md"). Access is restricted to actions that occur between
July 1, 2017 and December 31, 2017 (UTC), inclusive. This policy grants the permissions necessary to complete this action programmatically from the AWS API or AWS CLI.
...
policy, see [Multiple values in a condition](reference_policies_elements_condition.md#Condition-multiple-conditions "reference_policies_elements_condition.md#Condition-multiple-conditions").
