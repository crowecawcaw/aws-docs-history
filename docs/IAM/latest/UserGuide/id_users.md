...
An _IAM user_ is an entity that you create in your AWS account. The
...
more information about the root user, see [AWS account root user](id_root-user.md "id_root-user.md").
...
- A "friendly name" for the IAM user, which is the name that you specified when you
  ...
  name. Refer to [IAM name requirements](reference_iam-quotas.md#reference_iam-quotas-names "reference_iam-quotas.md#reference_iam-quotas-names") for requirements and restrictions for IAM
  names.
...
For more information about these identifiers, see [IAM identifiers](reference_identifiers.md "reference_identifiers.md").
...
- [Console
  password](id_credentials_passwords.md "id_credentials_passwords.md"): A password that the IAM user can type to sign in to
...
- [Access
  ...
  more information, see [Considerations and alternatives for long-term access keys](../../../general/latest/gr/aws-sec-cred-types.md#alternatives-to-long-term-access-keys "../../../general/latest/gr/aws-sec-cred-types.md#alternatives-to-long-term-access-keys") in the
  _AWS General Reference_. If the IAM user has active access keys, they
...
- [SSH keys for use with
  CodeCommit](id_credentials_ssh-keys.md "id_credentials_ssh-keys.md"): An SSH public key in the OpenSSH format that can be used to
  authenticate with CodeCommit.
- [Server
  certificates](id_credentials_server-certs.md "id_credentials_server-certs.md"): SSL/TLS certificates that you can use to authenticate
  ...
  ACM, see [AWS Certificate Manager endpoints and quotas](../../../general/latest/gr/acm.md "../../../general/latest/gr/acm.md") in
...
- **[Manage passwords for
  your IAM users](id_credentials_passwords.md "id_credentials_passwords.md").** Create and change the passwords that permit access
...
- **[Manage access keys
  for your IAM users](id_credentials_access-keys.md "id_credentials_access-keys.md").** Create and update access keys for programmatic
  access to the resources in your account.
- **[Enable multi-factor
  authentication (MFA) for the IAM user](id_credentials_mfa.md "id_credentials_mfa.md").**
  As a [best practice](best-practices.md "best-practices.md"), we recommend that you require multi-factor authentication for all IAM users in your account.
...
- **[Find unused
  passwords and access keys](id_credentials_finding-unused.md "id_credentials_finding-unused.md").** Anyone who has a password or access keys
  for your account or an IAM user in your account has access to your AWS resources. The
  security [best
  practice](../../../general/latest/gr/aws-access-keys-best-practices.md "../../../general/latest/gr/aws-access-keys-best-practices.md") is to remove passwords and access keys when IAM users no longer need
  them.
- **[Download a
  credential report for your account](id_credentials_getting-report.md "id_credentials_getting-report.md").** You can generate and download a
...
By default, a new IAM user has no [permissions](access.md "access.md") to do
...
to create IAM users and grant them initial credentials and permissions, see [Create an IAM user in your AWS account](id_users_create.md "id_users_create.md"). For procedures on how to change
the permissions for existing users, see [Change permissions for an IAM user](id_users_change-permissions.md "id_users_change-permissions.md"). For procedures on how to change the user's
password or access keys, see [User passwords in AWS](id_credentials_passwords.md "id_credentials_passwords.md") and [Manage access keys for IAM users](id_credentials_access-keys.md "id_credentials_access-keys.md").
...
requests. This is typically referred to as a _service account_. If you
