...
- **[Identity-based
  policies](#policies_id-based "#policies_id-based")** – Attach [managed](#managedpolicy "#managedpolicy")
  and [inline](#inline "#inline") policies to IAM identities (users, groups to
  which users belong, or roles). Identity-based policies grant permissions to an
  identity.
- **[Resource-based
  policies](#policies_resource-based "#policies_resource-based")** – Attach inline policies to resources. The most
...
- **[AWS Organizations SCPs](#policies_scp "#policies_scp")**
  ...
  permissions.
- **[AWS Organizations RCPs](#policies_rcp "#policies_rcp")**
...
- **[Access control lists
  (ACLs)](#policies_acl "#policies_acl")** – Use ACLs to control which principals in other accounts
...
Because of the [limited size of policies](reference_iam-quotas.md "reference_iam-quotas.md"), it
...
statements and multiple policies, AWS [evaluates](reference_policies_evaluation-logic.md "reference_policies_evaluation-logic.md") your policies the same way.
...
To view example policies for common scenarios, see [Example IAM identity-based policies](access_policies_examples.md "access_policies_examples.md").

## Grant least privilege

When you create IAM policies, follow the standard security advice of granting
_least privilege_, or granting only the permissions required to
perform a task. Determine what users and roles need to do and then craft policies that allow
them to perform _only_ those tasks.
...
As an alternative to least privilege, you can use [AWS managed policies](access_policies_managed-vs-inline.md#aws-managed-policies "access_policies_managed-vs-inline.md#aws-managed-policies") or policies with wildcard `*` permissions to
...
- **Understand access level groupings** – You
  ...
  grants. [Policy actions](reference_policies_elements_action.md "reference_policies_elements_action.md") are
...
- **Generate a policy based on access activity**
  ...
  policy generation](access-analyzer-policy-generation.md "access-analyzer-policy-generation.md").
- **Use last accessed information** – Another
  feature that can help with least privilege is _last accessed
  information_. View this information on the **Access
...
- **Review account events in AWS CloudTrail** – To
  ...
  **Event history**. CloudTrail event logs include detailed event
  ...
  Events in the CloudTrail Console](../../../awscloudtrail/latest/userguide/view-cloudtrail-events-console.md "../../../awscloudtrail/latest/userguide/view-cloudtrail-events-console.md") in the _AWS CloudTrail User
  Guide_.
...
- [Using resource-based policies for DynamoDB](../../../amazondynamodb/latest/developerguide/access-control-resource-based.md "../../../amazondynamodb/latest/developerguide/access-control-resource-based.md") in the
  _Amazon DynamoDB Developer Guide_
- [Bucket policies for Amazon S3](../../../AmazonS3/latest/userguide/bucket-policies.md "../../../AmazonS3/latest/userguide/bucket-policies.md") in the
  _Amazon Simple Storage Service User Guide_
- [Access Control List (ACL) overview](../../../AmazonS3/latest/userguide/acl-overview.md "../../../AmazonS3/latest/userguide/acl-overview.md") in the
  _Amazon Simple Storage Service User Guide_
