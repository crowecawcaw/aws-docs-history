...
**Contents**
+ [Passkeys and security keys](#passkeys-security-keys-for-iam-users)
+ [Virtual authenticator applications](#virtual-auth-apps-for-iam-users)
+ [Hardware TOTP tokens](#hardware-totp-token-for-iam-users)
