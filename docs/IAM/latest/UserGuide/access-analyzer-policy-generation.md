...
+ [IAM Access Analyzer policy generation services](access-analyzer-policy-generation-action-last-accessed-support.md)
...
![Resource ARN placeholder in policy template.](https://docs.aws.amazon.com/IAM/latest/UserGuide/images/res_plc_lg.png)
