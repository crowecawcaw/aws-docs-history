...
**Topics**
+ [Identify AWS resources with Amazon Resource Names (ARNs)](reference-arns.md)
+ [IAM identifiers](reference_identifiers.md)
+ [IAM and AWS STS quotas](reference_iam-quotas.md)
+ [Dual-stack endpoint support](reference_dual-stack_endpoint_support.md)
+ [Interface VPC endpoints](reference_interface_vpc_endpoints.md)
