...
+ [Control access to AWS STS with VPC endpoint policies](reference_sts_vpc_endpoint_policies.md)
+ [Use VPC condition keys to control federated access](reference_sts_vpc_condition_keys_federated.md)
