...
+ [Revoke IAM role temporary security credentials](id_roles_use_revoke-sessions.md)
+ [Update a service-linked role](id_roles_update-service-linked-role.md)
+ [Update a role trust policy](id_roles_update-role-trust-policy.md)
+ [Update permissions for a role](id_roles_update-role-permissions.md)
+ [Update settings for a role](id_roles_update-role-settings.md)
+ [Delete roles or instance profiles](id_roles_manage_delete.md)
