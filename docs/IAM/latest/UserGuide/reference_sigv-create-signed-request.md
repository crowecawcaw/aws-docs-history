...
characters. This helps make sure that the signature that you calculate can match the
...
After you have derived the signing key, calculate the signature to add to your request.
