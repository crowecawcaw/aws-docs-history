...
JSON policy documents are made up of elements. The elements are listed here in the general
order you use them in a policy. The order of the elements doesn't matter—for example, the
`Resource` element can come before the `Action` element. You're not
required to specify any `Condition` elements in the policy. To learn more about the
general structure and purpose of a JSON policy document, see [Overview of JSON policies](access_policies.md#access_policies-json "access_policies.md#access_policies-json").

Some JSON policy elements are mutually exclusive. This means that you cannot create a policy
that uses both. For example, you cannot use both `Action` and `NotAction`
in the same policy statement. Other pairs that are mutually exclusive include
`Principal`/`NotPrincipal` and
...
- [Id](reference_policies_elements_id.md "reference_policies_elements_id.md")
- [Statement](reference_policies_elements_statement.md "reference_policies_elements_statement.md")
- [Sid](reference_policies_elements_sid.md "reference_policies_elements_sid.md")
- [Effect](reference_policies_elements_effect.md "reference_policies_elements_effect.md")
...
- [Action](reference_policies_elements_action.md "reference_policies_elements_action.md")
...
- [NotResource](reference_policies_elements_notresource.md "reference_policies_elements_notresource.md")
- [Condition](reference_policies_elements_condition.md "reference_policies_elements_condition.md")
- [Variables and tags](reference_policies_variables.md "reference_policies_variables.md")
- [Supported data types](reference_policies_elements_datatypes.md "reference_policies_elements_datatypes.md")
