...
For the version of components installed with Livy in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md).


**Livy version information for emr-7.13.0**  
...
For the version of components installed with Livy in this release, see [Release 6.15.0 Component Versions](emr-6150-release.md).


**Livy version information for emr-6.15.0**  
...
For the version of components installed with Livy in this release, see [Release 5.36.2 Component Versions](emr-5362-release.md).


**Livy version information for emr-5.36.2**  
...
**Topics**
+ [Enabling HTTPS with Apache Livy](enabling-https.md)
