...
For the version of components installed with Livy in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md "emr-7130-release.md").

Livy version information for emr-7.13.0| Amazon EMR Release Label | Livy Version | Components Installed With Livy |
| --- | --- | --- |
