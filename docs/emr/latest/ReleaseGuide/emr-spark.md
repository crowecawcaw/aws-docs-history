...
For the version of components installed with Spark in this release, see [Release 7.11.0 Component Versions](emr-7110-release.md "emr-7110-release.md").

| Spark version information for emr-7.11.0 | Amazon EMR Release Label | Spark Version                                                                                                                                                                                                                                                                                                                                                                                          | Components Installed With Spark |
| ---------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
| emr-7.11.0                               | Spark 3.5.6-amzn-0       | delta, emrfs, emr-goodies, emr-ddb, emr-s3-select, hadoop-client, hadoop-hdfs-datanode, hadoop-hdfs-library, hadoop-hdfs-namenode, hadoop-hdfs-zkfc, hadoop-httpfs-server, hadoop-kms-server, hadoop-yarn-nodemanager, hadoop-yarn-resourcemanager, hadoop-yarn-timeline-server, hudi, hudi-spark, iceberg, livy-server, nginx, r, spark-client, spark-history-server, spark-on-yarn, spark-yarn-slave |
