...
For the version of components installed with Spark in this release, see [Release 7.10.0 Component Versions](emr-7100-release.md "emr-7100-release.md").

| Spark version information for emr-7.10.0 | Amazon EMR Release Label | Spark Version                                                                                                                                                                                                                                                                                                                                                                        | Components Installed With Spark |
| ---------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------- |
