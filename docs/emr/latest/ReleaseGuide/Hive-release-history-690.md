...
| Backport | [HIVE-23751](https://issues.apache.org/jira/browse/HIVE-23751): QTest: Override \#mkdirs() method in ProxyFileSystem to align after HADOOP-16582. | 
...
| Backport | [HIVE-19792](https://issues.apache.org/jira/browse/HIVE-19792): Upgrade orc to 1.5.2 and enable decimal\_64 schema evolution tests.  | 
