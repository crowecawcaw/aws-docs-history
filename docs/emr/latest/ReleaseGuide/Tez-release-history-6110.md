...
| Type        | Description                                                                                       |
| ----------- | ------------------------------------------------------------------------------------------------- |
| Bug         | Fixed invalid vertex state transition during vertex level<br>cleanup of shuffle data              |
| Bug         | Fixed DAG or vertex level cleanup of shuffle data not<br>working                                  |
| Improvement | Enable tez.am.dag.cleanup.on.completion by default for<br>clearing shuffle data of completed DAGs |
