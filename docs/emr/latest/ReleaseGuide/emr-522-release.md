...
| Application version information |                 | emr-5.2.2       | emr-5.2.1       | emr-5.2.0       | emr-5.1.1 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.2.2 release. Changes
...
- Backported [SPARK-194459](https://issues.apache.org/jira/browse/SPARK-19459 "https://issues.apache.org/jira/browse/SPARK-19459"), which addresses an issue where reading from an ORC table with char/varchar columns can fail.
...
| emr-5.2.2 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
