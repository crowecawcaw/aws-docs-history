...
- The default execution engine for Hive and Pig is now Tez. To change
  ...
  `hive-site` and `pig-properties`
  configuration classifications, respectively.
...
- Java 8 is now the default JVM. All applications run using the Java 8
  runtime. There are no changes to any applicationâ€™s byte code target.
...
| emr-5.0.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
