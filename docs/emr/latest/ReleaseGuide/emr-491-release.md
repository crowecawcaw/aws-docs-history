...
| Application version information |                 | emr-4.9.1       | emr-4.8.5       | emr-4.8.4       | emr-4.8.3 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.9.1 release. Changes
are relative to the Amazon EMR 4.8.4 release.
...
| emr-4.9.1 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
