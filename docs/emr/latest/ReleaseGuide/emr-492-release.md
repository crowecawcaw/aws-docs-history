...
| Application version information |                 | emr-4.9.2       | emr-4.9.1       | emr-4.8.5       | emr-4.8.4 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.9.2 release. Changes
are relative to the Amazon EMR 4.9.1 release.
...
| emr-4.9.2 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
