...
| Application version information |                  | emr-5.11.0       | emr-5.10.1       | emr-5.10.0       | emr-5.9.1 |
| ------------------------------- | ---------------- | ---------------- | ---------------- | ---------------- | --------- |
...
The following release notes include information for the Amazon EMR release 5.11.0. Changes
are relative to 5.10.0.
...
- Hive 2.3.2 sets `hive.compute.query.using.stats=true` by default. This causes
...
| emr-5.11.0 classifications      | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
