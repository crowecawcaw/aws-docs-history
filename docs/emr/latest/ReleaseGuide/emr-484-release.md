...
| Application version information |                 | emr-4.8.4       | emr-4.8.3       | emr-4.8.2       | emr-4.8.1 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.8.4 release. Changes
are relative to the Amazon EMR 4.8.3 release.
...
| emr-4.8.4 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
