...
**Topics**
+ [Override the JVM setting with Apache Spark](#configuring-java8-override-spark)
+ [Override the JVM setting with Apache HBase](#configuring-java8-override-hbase)
+ [Override the JVM setting with Apache Hadoop and Hive](#configuring-java8-override-hadoop)
