...
| Application version information |                 | emr-5.2.0       | emr-5.1.1       | emr-5.1.0       | emr-5.0.3 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.2.0 release. Changes
are relative to the Amazon EMR 5.1.0 release.
...
- Enables you to specify an Amazon S3 location for the HBase rootdir. For more information, see
  [HBase on Amazon S3](emr-hbase-s3.md "emr-hbase-s3.md").
...
- Fixed an issue with instance-controller and logpusher logs being
  ...
  log4j-configured .log files, which rotate hourly. The .out files do not
...
| emr-5.2.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
