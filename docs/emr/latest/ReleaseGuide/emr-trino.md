...
of Amazon EMR 7.x, along with components that Amazon EMR installs with Trino. For the version of components installed with Trino in this release, see [Release 7.12.0
Component Versions](emr-7120-release.md "emr-7120-release.md").

| Trino (PrestoSQL) version information for emr-7.12.0 | Amazon EMR Release Label   | Trino (PrestoSQL) Version                                                                                                                                                                                                                                                                                                   | Components Installed With Trino (PrestoSQL) |
| ---------------------------------------------------- | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
