...
| Application version information |                 | emr-4.8.3       | emr-4.8.2       | emr-4.8.1       | emr-4.8.0 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.8.3 release. Changes
are relative to the Amazon EMR 4.8.2 release.
...
- Upgraded to Spark 1.6.3. For more information, see [Spark
  Release Notes](http://spark.apache.org/releases/spark-release-1-6-3.html "http://spark.apache.org/releases/spark-release-1-6-3.html") in the Apache Spark documentation.
...
| emr-4.8.3 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
