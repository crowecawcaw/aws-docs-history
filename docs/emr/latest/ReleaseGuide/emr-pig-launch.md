...
1. To launch a cluster with Pig installed, type the following command, replacing {{myKey}} and {{amzn-s3-demo-bucket/}} with the name of your EC2 key pair and Amazon S3 bucket.
...
1. To submit a Pig step, enter the following command, replacing {{myClusterId}} and {{amzn-s3-demo-bucket}} with your cluster ID and name of your Amazon S3 bucket.
