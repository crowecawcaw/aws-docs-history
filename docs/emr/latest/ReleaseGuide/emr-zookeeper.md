...
For the version of components installed with ZooKeeper in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md "emr-7130-release.md").

| ZooKeeper version information for emr-7.13.0 | Amazon EMR Release Label | ZooKeeper Version                                                                                                                                                                                                                                                                    | Components Installed With ZooKeeper |
| -------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------- |
