...
| Application version information |                 | emr-5.1.0       | emr-5.0.3       | emr-5.0.2       | emr-5.0.1 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.1.0 release. Changes
are relative to the Amazon EMR 5.0.3 release.
...
| emr-5.1.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
