...
| Application version information |                  | emr-5.7.0       | emr-5.6.1       | emr-5.6.0       | emr-5.5.4 |
| ------------------------------- | ---------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.7.0 release. Changes
are relative to the Amazon EMR 5.6.0 release.
...
- Added the ability to specify a customAmazon Linux AMI when you create a cluster. For more information, see [Using a Custom AMI](../ManagementGuide/emr-custom-ami.md "../ManagementGuide/emr-custom-ami.md").
...
- **Sqoop** - backported [SQOOP-2880](https://issues.apache.org/jira/browse/SQOOP-2880 "https://issues.apache.org/jira/browse/SQOOP-2880"), which introduces an argument that allows you to set the Sqoop temporary directory.
...
| emr-5.7.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
