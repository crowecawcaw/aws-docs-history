...
You specify the release number with the _release label_. Release labels are in the form `emr-`x.x.x``. For example, `emr-7.13.0`.
...
- [Amazon EMR release 7.13.0](emr-7130-release.md "emr-7130-release.md")
