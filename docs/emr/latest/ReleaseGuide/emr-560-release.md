...
| Application version information |                 | emr-5.6.0       | emr-5.5.4       | emr-5.5.3       | emr-5.5.2 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.6.0 release. Changes
...
| emr-5.6.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
