...
This release includes the following applications: [Hadoop](http://hadoop.apache.org/docs/current/ "http://hadoop.apache.org/docs/current/"), [Hive](http://hive.apache.org/ "http://hive.apache.org/"), [Mahout](http://mahout.apache.org/ "http://mahout.apache.org/"), [Pig](http://pig.apache.org/ "http://pig.apache.org/"), and [Spark](https://spark.apache.org/docs/latest/ "https://spark.apache.org/docs/latest/").
...
| emr-4.0.0 classifications | Classifications                                                    | Description |
| ------------------------- | ------------------------------------------------------------------ | ----------- |
