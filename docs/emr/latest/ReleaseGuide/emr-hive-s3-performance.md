...
- [Enabling Hive EMRFS S3 optimized committer](hive-optimized-committer.md "hive-optimized-committer.md")
- [Using S3 Select with Hive to improve performance](emr-hive-s3select.md "emr-hive-s3select.md")
