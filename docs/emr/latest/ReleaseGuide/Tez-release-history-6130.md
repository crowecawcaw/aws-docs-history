...
| Type    | Description                                                                                                                                                                                                                  |
| ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bug Fix | REVERT [TEZ-4295](https://issues.apache.org/jira/browse/TEZ-4295 "https://issues.apache.org/jira/browse/TEZ-4295"): Could not decompress data. Buffer<br>length is too small.                                                |
| Bug Fix | REVERT [TEZ-4302](https://issues.apache.org/jira/browse/TEZ-4302 "https://issues.apache.org/jira/browse/TEZ-4302"): `NullPointerException` in<br>`CodecUtils` with<br>`GzipCodec`.                                           |
| Bug Fix | REVERT [TEZ-4234](https://issues.apache.org/jira/browse/TEZ-4234 "https://issues.apache.org/jira/browse/TEZ-4234"): Compressor can cause<br>`IllegalArgumentException` in<br>`Buffer.limit` where limit exceeds<br>capacity. |
| Bug Fix | REVERT [TEZ-4135](https://issues.apache.org/jira/browse/TEZ-4135 "https://issues.apache.org/jira/browse/TEZ-4135"): Improve memory allocation when<br>executing in-memory reads.                                             |
