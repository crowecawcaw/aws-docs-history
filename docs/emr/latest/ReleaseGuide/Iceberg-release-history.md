...
The following table lists the version of Iceberg included in each release version of Amazon EMR, along with the components installed with the application.
