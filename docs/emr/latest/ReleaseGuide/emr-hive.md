...
For the version of components installed with Hive in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md "emr-7130-release.md").

Hive version information for emr-7.13.0| Amazon EMR Release Label | Hive Version | Components Installed With Hive |
| --- | --- | --- |
