...
For the version of components installed with Hive in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md).


**Hive version information for emr-7.13.0**  
