...
| Application version information |                 | emr-5.4.0       | emr-5.3.2       | emr-5.3.1       | emr-5.3.0 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.4.0 release. Changes
...
- Added support for r4 instances. See [Amazon EC2 Instance Types](https://aws.amazon.com/ec2/instance-types/ "https://aws.amazon.com/ec2/instance-types/").
...
| emr-5.4.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
