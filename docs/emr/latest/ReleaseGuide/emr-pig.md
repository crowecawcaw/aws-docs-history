...
- [Submit Pig work](emr-pig-launch.md "emr-pig-launch.md")
- [Call user-defined functions from Pig](emr-pig-udf.md "emr-pig-udf.md")
- [Pig release history](Pig-release-history.md "Pig-release-history.md")
