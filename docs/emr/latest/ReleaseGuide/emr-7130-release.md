# Amazon EMR release 7.13.0

## 7.13.0 supported lifecycle

The following table describes the supported lifecycle dates for Amazon EMR release 7.13.0.

| Support phase          | Date           |
| ---------------------- | -------------- |
| Initial release date   | April 21, 2026 |
| Standard support until | April 21, 2028 |
| End of support         | April 22, 2028 |
| End of life            | April 21, 2029 |

## 7.13.0 application versions
...
Application version information| | emr-7.13.0 | emr-7.12.0 | emr-7.11.0 | emr-7.10.0 |
| --- | --- | --- | --- | --- |
| AWS SDK for Java | 2.42.12, 1.12.797 | 2.35.5, 1.12.792 | 2.35.5, 1.12.792 | 2.31.48, 1.12.782 |
...
| Delta | 3.3.2-amzn-2 | 3.3.2-amzn-1 | 3.3.2-amzn-0 | 3.3.0-amzn-2 |
| Flink | 1.20.0-amzn-7 | 1.20.0-amzn-6 | 1.20.0-amzn-5 | 1.20.0-amzn-4 |
| Ganglia | - | - | - | - |
| HBase | 2.6.4-amzn-0 | 2.6.2-amzn-3 | 2.6.2-amzn-2 | 2.6.2-amzn-1 |
| HCatalog | 3.1.3-amzn-22 | 3.1.3-amzn-21 | 3.1.3-amzn-20 | 3.1.3-amzn-19 |
...
| Phoenix | 5.3.0 | 5.2.1 | 5.2.1 | 5.2.1 |
| Pig | 0.17.0 | 0.17.0 | 0.17.0 | 0.17.0 |
| Presto | 0.287-amzn-7 | 0.287-amzn-6 | 0.287-amzn-5 | 0.287-amzn-4 |
| Spark | 3.5.6-amzn-2 | 3.5.6-amzn-1 | 3.5.6-amzn-0 | 3.5.5-amzn-1 |
| Sqoop | - | - | - | - |
| TensorFlow | 2.19.0 | 2.19.0 | 2.19.0 | 2.18.0 |
| Tez | 0.10.2-amzn-20 | 0.10.2-amzn-19 | 0.10.2-amzn-18 | 0.10.2-amzn-17 |
| Trino (PrestoSQL) | 479-amzn-1 | 476-amzn-1 | 475-amzn-0 | 470-amzn-0 |
| Zeppelin | 0.11.1 | 0.11.1 | 0.11.1 | 0.11.1 |
| ZooKeeper | 3.9.3-amzn-5 | 3.9.3-amzn-4 | 3.9.3-amzn-3 | 3.9.3-amzn-2 |
...
Amazon EMR release 7.13 and higher ships with Amazon Corretto 17 (built on OpenJDK)
by default for applications that support Corretto 17 (JDK 17), with the exception
of Apache Livy.

The following table shows the default Java versions for applications in Amazon EMR 7.13.0.
...
| delta                       | 3.3.2-amzn-2      | Delta lake is an open table format for huge analytic datasets                                                                               |
...
| emr-ddb                     | 5.7.0-SNAPSHOT    | Amazon DynamoDB connector for Hadoop ecosystem applications.                                                                                |
| emr-goodies                 | 3.22.0            | Extra convenience libraries for the Hadoop ecosystem.                                                                                       |
| emr-kinesis                 | 3.26.0            | Amazon Kinesis connector for Hadoop ecosystem applications.                                                                                 |
| emr-notebook-env            | 1.18.0            | Conda env for emr notebook which includes jupyter enterprise gateway                                                                        |
| emr-s3-dist-cp              | 2.43.0            | Distributed copy application optimized for Amazon S3.                                                                                       |
| emr-s3-select               | 2.22.0            | EMR S3Select Connector                                                                                                                      |
| emr-wal-cli                 | 1.3.7             | Cli used for emrwal list/deletion.                                                                                                          |
| emrfs                       | 2.74.0            | Amazon S3 connector for Hadoop ecosystem applications.                                                                                      |
| flink-client                | 1.20.0-amzn-7     | Apache Flink command line client scripts and applications.                                                                                  |
| flink-jobmanager-config     | 1.20.0-amzn-7     | Managing resources on EMR nodes for Apache Flink JobManager.                                                                                |
| hadoop-client               | 3.4.2-amzn-0      | Hadoop command-line clients such as 'hdfs', 'hadoop', or 'yarn'.                                                                            |
| hadoop-hdfs-datanode        | 3.4.2-amzn-0      | HDFS node-level service for storing blocks.                                                                                                 |
| hadoop-hdfs-library         | 3.4.2-amzn-0      | HDFS command-line client and library                                                                                                        |
| hadoop-hdfs-namenode        | 3.4.2-amzn-0      | HDFS service for tracking file names and block locations.                                                                                   |
| hadoop-hdfs-zkfc            | 3.4.2-amzn-0      | ZKFC service for tracking namenodes for HA mode.                                                                                            |
| hadoop-hdfs-journalnode     | 3.4.2-amzn-0      | HDFS service for managing the Hadoop filesystem journal on HA clusters.                                                                     |
| hadoop-httpfs-server        | 3.4.2-amzn-0      | HTTP endpoint for HDFS operations.                                                                                                          |
| hadoop-kms-server           | 3.4.2-amzn-0      | Cryptographic key management server based on Hadoop's KeyProvider API.                                                                      |
| hadoop-mapred               | 3.4.2-amzn-0      | MapReduce execution engine libraries for running a MapReduce application.                                                                   |
| hadoop-yarn-nodemanager     | 3.4.2-amzn-0      | YARN service for managing containers on an individual node.                                                                                 |
| hadoop-yarn-resourcemanager | 3.4.2-amzn-0      | YARN service for allocating and managing cluster resources and distributed applications.                                                    |
| hadoop-yarn-timeline-server | 3.4.2-amzn-0      | Service for retrieving current and historical information for YARN applications.                                                            |
| hbase-hmaster               | 2.6.4-amzn-0      | Service for an HBase cluster responsible for coordination of Regions and execution of administrative commands.                              |
| hbase-region-server         | 2.6.4-amzn-0      | Service for serving one or more HBase regions.                                                                                              |
| hbase-client                | 2.6.4-amzn-0      | HBase command-line client.                                                                                                                  |
| hbase-rest-server           | 2.6.4-amzn-0      | Service providing a RESTful HTTP endpoint for HBase.                                                                                        |
| hbase-thrift-server         | 2.6.4-amzn-0      | Service providing a Thrift endpoint to HBase.                                                                                               |
| hbase-operator-tools        | 2.6.4-amzn-0      | Repair tool for Apache HBase clusters.                                                                                                      |
| hcatalog-client             | 3.1.3-amzn-22     | The 'hcat' command line client for manipulating hcatalog-server.                                                                            |
| hcatalog-server             | 3.1.3-amzn-22     | Service providing HCatalog, a table and storage management layer for distributed applications.                                              |
| hcatalog-webhcat-server     | 3.1.3-amzn-22     | HTTP endpoint providing a REST interface to HCatalog.                                                                                       |
| hive-client                 | 3.1.3-amzn-22     | Hive command line client.                                                                                                                   |
| hive-hbase                  | 3.1.3-amzn-22     | Hive-hbase client.                                                                                                                          |
| hive-metastore-server       | 3.1.3-amzn-22     | Service for accessing the Hive metastore, a semantic repository storing metadata for SQL on Hadoop operations.                              |
| hive-server2                | 3.1.3-amzn-22     | Service for accepting Hive queries as web requests.                                                                                         |
| hudi                        | 1.0.2-amzn-2      | Incremental processing framework to power data pipeline at low latency and high efficiency.                                                 |
| hudi-presto                 | 1.0.2-amzn-2      | Bundle library for running Presto with Hudi.                                                                                                |
| hudi-trino                  | 1.0.2-amzn-2      | Bundle library for running Trino with Hudi.                                                                                                 |
| hudi-spark                  | 1.0.2-amzn-2      | Bundle library for running Spark with Hudi.                                                                                                 |
| hue-server                  | 4.11.0            | Web application for analyzing data using Hadoop ecosystem applications                                                                      |
| iceberg                     | 1.10.0-amzn-1     | Apache Iceberg is an open table format for huge analytic datasets                                                                           |
...
| phoenix-library             | 5.3.0             | The phoenix libraries for server and client                                                                                                 |
...
| presto-coordinator          | 0.287-amzn-7      | Service for accepting queries and managing query execution among presto-workers.                                                            |
| presto-worker               | 0.287-amzn-7      | Service for executing pieces of a query.                                                                                                    |
| presto-client               | 0.287-amzn-7      | Presto command-line client which is installed on an HA cluster's stand-by masters where Presto server is not started.                       |
| trino-coordinator           | 479-amzn-1        | Service for accepting queries and managing query execution among trino-workers.                                                             |
| trino-worker                | 479-amzn-1        | Service for executing pieces of a query.                                                                                                    |
| trino-client                | 479-amzn-1        | Trino command-line client which is installed on an HA cluster's stand-by masters where Trino server is not started.                         |
...
| spark-client                | 3.5.6-amzn-2      | Spark command-line clients.                                                                                                                 |
| spark-history-server        | 3.5.6-amzn-2      | Web UI for viewing logged events for the lifetime of a completed Spark application.                                                         |
| spark-on-yarn               | 3.5.6-amzn-2      | In-memory execution engine for YARN.                                                                                                        |
| spark-yarn-slave            | 3.5.6-amzn-2      | Apache Spark libraries needed by YARN slaves.                                                                                               |
...
| tez-on-yarn                 | 0.10.2-amzn-20    | The tez YARN application and libraries.                                                                                                     |
| tez-on-worker               | 0.10.2-amzn-20    | The tez YARN application and libraries for worker nodes.                                                                                    |
| zeppelin-server             | 0.11.1            | Web-based notebook that enables interactive data analytics.                                                                                 |
| zookeeper-server            | 3.9.3-amzn-5      | Centralized service for maintaining configuration information, naming, providing distributed synchronization, and providing group services. |
| zookeeper-client            | 3.9.3-amzn-5      | ZooKeeper command line client.                                                                                                              |

## 7.13.0 configuration classifications
...
emr-7.13.0 classifications| Classifications | Description | Reconfiguration Actions |
| --- | --- | --- |
...
Change log for 7.13.0 release and release notes| Date | Event | Description |
| --- | --- | --- |
