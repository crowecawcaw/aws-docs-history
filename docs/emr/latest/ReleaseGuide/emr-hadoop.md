...
For the version of components installed with Hadoop in this release, see [Release 7.12.0 Component Versions](emr-7120-release.md "emr-7120-release.md").

| Hadoop version information for emr-7.12.0 | Amazon EMR Release Label | Hadoop Version                                                                                                                                                                                                                                                                                        | Components Installed With Hadoop |
| ----------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| emr-7.12.0                                | Hadoop 3.4.1-amzn-4      | emrfs, emr-ddb, emr-goodies, emr-kinesis, emr-s3-dist-cp, hadoop-client, hadoop-hdfs-datanode, hadoop-hdfs-library, hadoop-hdfs-namenode, hadoop-hdfs-zkfc, hadoop-httpfs-server, hadoop-kms-server, hadoop-mapred, hadoop-yarn-nodemanager, hadoop-yarn-resourcemanager, hadoop-yarn-timeline-server |
