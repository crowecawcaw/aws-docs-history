...
- **Known issues and limitations**
  ...
  - **Athena SQL compatibility**
    ...
    - Athena SQL cannot read Iceberg table type V3 created by Amazon EMR Spark due to the following error: GENERIC\_INTERNAL\_ERROR: Cannot read unsupported version 3.
