...
| Application version information |                 | emr-4.9.3       | emr-4.9.2       | emr-4.9.1       | emr-4.8.5 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.9.3 release. Changes
are relative to the Amazon EMR 4.9.2 release.
...
| emr-4.9.3 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
