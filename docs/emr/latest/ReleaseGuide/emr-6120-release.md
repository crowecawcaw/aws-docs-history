...
Application version information| | emr-6.12.0 | emr-6.11.1 | emr-6.11.0 | emr-6.10.1 |
| --- | --- | --- | --- | --- |
...
release timeline, see the [6.12.0 change log](#6120-changelog "#6120-changelog").
...
emr-6.12.0 classifications| Classifications | Description | Reconfiguration Actions |
| --- | --- | --- |
...
Change log for 6.12.0 release and release notes| Date | Event | Description |
| --- | --- | --- |
...
| 2023-07-21 | Deployment complete | Amazon EMR 6.12.0 fully deployed to all [supported Regions](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/ "https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/") |
| 2023-07-21 | Docs publication | Amazon EMR 6.12.0 release notes first<br>published |
| 2023-07-12 | Initial release | Amazon EMR 6.12.0 first deployed to initial commercial<br>Regions |
