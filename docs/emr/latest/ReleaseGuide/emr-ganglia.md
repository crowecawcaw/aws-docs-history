...
For the version of components installed with Ganglia in this release, see [Release 6.15.0 Component Versions](emr-6150-release.md).


**Ganglia version information for emr-6.15.0**  
...
For the version of components installed with Ganglia in this release, see [Release 5.36.2 Component Versions](emr-5362-release.md).


**Ganglia version information for emr-5.36.2**  
