...
For the version of components installed with AmazonCloudWatchAgent in this release, see [Release 7.12.0 Component Versions](emr-7120-release.md "emr-7120-release.md").

| AmazonCloudWatchAgent version information for emr-7.12.0 | Amazon EMR Release Label                | AmazonCloudWatchAgent Version                                                                                                                                                                                                                                                                                                                       | Components Installed With AmazonCloudWatchAgent |
| -------------------------------------------------------- | --------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
