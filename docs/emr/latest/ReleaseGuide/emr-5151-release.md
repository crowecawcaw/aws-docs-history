...
| Application version information |                  | emr-5.15.1       | emr-5.15.0       | emr-5.14.2       | emr-5.14.1 |
| ------------------------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------- |
...
In this release version, Amazon EMR uses AWS Signature Version 4 exclusively to authenticate requests to Amazon S3. For more information, see [Whats New](emr-whatsnew.md "emr-whatsnew.md").
...
| emr-5.15.1 classifications      | Classifications                                                      | Description |
| ------------------------------- | -------------------------------------------------------------------- | ----------- |
