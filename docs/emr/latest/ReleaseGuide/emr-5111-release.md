...
| Application version information |                  | emr-5.11.1       | emr-5.11.0       | emr-5.10.1       | emr-5.10.0 |
| ------------------------------- | ---------------- | ---------------- | ---------------- | ---------------- | ---------- |
...
The following release notes include information for the Amazon EMR 5.11.1 release. Changes
...
| emr-5.11.1 classifications      | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
