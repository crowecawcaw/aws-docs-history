...
The supported databases for Sqoop are listed at the following url, http://sqoop.apache.org/docs/{{version}}/SqoopUserGuide.html\#\_supported\_databases, where {{version}} is the version of Sqoop you are using, for example 1.4.6. If the JDBC connect string does not match those in this list, you must specify a driver. 
...
1. Use the password alias to launch the Sqoop job:
...
1. Use the file to launch the Sqoop job:
