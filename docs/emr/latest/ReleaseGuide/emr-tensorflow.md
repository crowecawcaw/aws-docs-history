...
For the version of components installed with TensorFlow in this release, see [Release 7.12.0 Component Versions](emr-7120-release.md "emr-7120-release.md").

| TensorFlow version information for emr-7.12.0 | Amazon EMR Release Label | TensorFlow Version                                                                                                                                                                                                                                           | Components Installed With TensorFlow |
| --------------------------------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ |
