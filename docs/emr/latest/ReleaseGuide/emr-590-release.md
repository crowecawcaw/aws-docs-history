...
| Application version information |                  | emr-5.9.0        | emr-5.8.3        | emr-5.8.2        | emr-5.8.1 |
| ------------------------------- | ---------------- | ---------------- | ---------------- | ---------------- | --------- |
...
The following release notes include information for the Amazon EMR version 5.9.0 release. Changes
are relative to the Amazon EMR 5.8.0 release.
...
- Added Livy support (version 0.4.0-incubating). For more information, see [Apache Livy](emr-livy.md "emr-livy.md").
...
| emr-5.9.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
