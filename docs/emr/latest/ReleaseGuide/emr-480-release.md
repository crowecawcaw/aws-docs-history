...
| Application version information |                 | emr-4.8.0        | emr-4.7.4        | emr-4.7.3        | emr-4.7.2 |
| ------------------------------- | --------------- | ---------------- | ---------------- | ---------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.8.0 release. Changes
are relative to the Amazon EMR 4.7.2 release.
...
- Added support for security configurations, which allow you to create
  and apply encryption options more easily. For more information, see [Data Encryption](emr-data-encryption.md "emr-data-encryption.md").
...
| emr-4.8.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
