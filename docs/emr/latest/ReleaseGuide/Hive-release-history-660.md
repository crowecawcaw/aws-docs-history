...
| Backport | [HIVE-25680](https://issues.apache.org/jira/browse/HIVE-25680): Authorize \#get\_table\_meta HiveMetastore Server API to use any of the HiveMetastore Authorization model. | 
...
| Backport | [HIVE-22429](https://issues.apache.org/jira/browse/HIVE-22429): Migrated clustered tables using bucketing\_version 1 on hive 3 uses bucketing\_version 2 for inserts | 
...
| Backport | [HIVE-22331](https://issues.apache.org/jira/browse/HIVE-22331): unix\_timestamp without argument returns timestamp in millisecond instead of second | 
...
| Backport | [HIVE-22221](https://issues.apache.org/jira/browse/HIVE-22221): Llap external client - Need to reduce LlapBaseInputFormat\#getSplits | 
...
| Backport | [HIVE-22170](https://issues.apache.org/jira/browse/HIVE-22170): from\_unixtime and unix\_timestamp should use user session time zone | 
...
| Backport | [HIVE-21864](https://issues.apache.org/jira/browse/HIVE-21864): LlapBaseInputFormat\#closeAll | 
...
| Backport | [HIVE-21539](https://issues.apache.org/jira/browse/HIVE-21539): GroupBy \+ where clause on same column results in incorrect query rewrite | 
...
| Backport | [HIVE-21435](https://issues.apache.org/jira/browse/HIVE-21435): LlapBaseInputFormat should get task number from TASK\_ATTEMPT\_ID conf if present, while building SubmitWorkRequestProto | 
...
| Backport | [HIVE-21126](https://issues.apache.org/jira/browse/HIVE-21126): Allow session level queries in LlapBaseInputFormat\#getSplit | 
...
| Backport | [HIVE-20989](https://issues.apache.org/jira/browse/HIVE-20989): JDBC - The GetOperationStatus \+ log can block query progress via sleep | 
...
| Backport | [HIVE-20978](https://issues.apache.org/jira/browse/HIVE-20978): "hive.jdbc.\*" should add to sqlStdAuthSafeVarNameRegexes | 
...
| Backport | [HIVE-20826](https://issues.apache.org/jira/browse/HIVE-20826): Enhance HiveSemiJoin rule to convert join \+ group by on left side to Left Semi Join | 
| Backport | [HIVE-20821](https://issues.apache.org/jira/browse/HIVE-20821): Rewrite SUM0 into SUM \+ COALESCE combination | 
| Backport | [HIVE-20815](https://issues.apache.org/jira/browse/HIVE-20815): JdbcRecordReader.next shall not eat exception | 
| Backport | [HIVE-20813](https://issues.apache.org/jira/browse/HIVE-20813): udf to\_epoch\_milli need to support timestamp without time zone as well. | 
...
| Backport | [HIVE-20762](https://issues.apache.org/jira/browse/HIVE-20762): NOTIFICATION\_LOG cleanup interval is hardcoded as 60s and is too small | 
| Backport | [HIVE-20761](https://issues.apache.org/jira/browse/HIVE-20761): Select for update on notification\_sequence table has retry interval and retries count too small | 
...
| Backport | [HIVE-20706](https://issues.apache.org/jira/browse/HIVE-20706): external\_jdbc\_table2.q failing intermittently | 
...
| Backport | [HIVE-20692](https://issues.apache.org/jira/browse/HIVE-20692): Enable folding of NOT x IS (NOT) [TRUE\|FALSE] expressions | 
...
| Backport | [HIVE-20632](https://issues.apache.org/jira/browse/HIVE-20632): Query with get\_splits UDF fails if materialized view is created on queried table | 
...
| Backport | [HIVE-20601](https://issues.apache.org/jira/browse/HIVE-20601): EnvironmentContext null in ALTER\_PARTITION event in DbNotificationListener | 
...
| Backport | [HIVE-20343](https://issues.apache.org/jira/browse/HIVE-20343): Hive 3: CTAS does not respect transactional\_properties | 
...
| Backport | [HIVE-20320](https://issues.apache.org/jira/browse/HIVE-20320): Turn on hive.optimize.remove.sq\_count\_check flag | 
...
| Backport | [HIVE-20302](https://issues.apache.org/jira/browse/HIVE-20302): LLAP: non-vectorized execution in IO ignores virtual columns, including ROW\_\_ID | 
...
| Backport | [HIVE-20226](https://issues.apache.org/jira/browse/HIVE-20226): HMS getNextNotification will throw exception when request maxEvents exceed table's max\_rows | 
...
| Backport | [HIVE-20212](https://issues.apache.org/jira/browse/HIVE-20212): Hiveserver2 in http mode emitting metric default.General.open\_connections incorrectly | 
...
| Backport | [HIVE-20197](https://issues.apache.org/jira/browse/HIVE-20197): Vectorization: Add DECIMAL\_64 testing, add Date/Interval/Timestamp arithmetic, and add more GROUP BY Aggregation | 
...
| Backport | [HIVE-20153](https://issues.apache.org/jira/browse/HIVE-20153): Count and Sum UDF consume more memory in Hive 2\+ | 
...
| Backport | [HIVE-20013](https://issues.apache.org/jira/browse/HIVE-20013): Add an Implicit cast to date type for to\_date function | 
| Backport | [HIVE-20011](https://issues.apache.org/jira/browse/HIVE-20011): Move away from append mode in proto logging hook | 
| Backport | [HIVE-20005](https://issues.apache.org/jira/browse/HIVE-20005): acid\_table\_stats, acid\_no\_buckets, etc - query result change on the branch | 
...
| Backport | [HIVE-19759](https://issues.apache.org/jira/browse/HIVE-19759): Flaky test: TestRpc\#testServerPort | 
...
| Backport | [HIVE-19552](https://issues.apache.org/jira/browse/HIVE-19552): Enable TestMiniDruidKafkaCliDriver\#druidkafkamini\_basic.q | 
...
| Backport | [HIVE-18696](https://issues.apache.org/jira/browse/HIVE-18696): The partition folders might not get cleaned up properly in the HiveMetaStore.add\_partitions\_core method if an | 
...
| Backport | [HIVE-18201](https://issues.apache.org/jira/browse/HIVE-18201): Disable XPROD\_EDGE for sq\_count\_chec | 
...
| Backport | [HIVE-15177](https://issues.apache.org/jira/browse/HIVE-15177): Authentication with hive fails when kerberos auth type is set to fromSubject and principal contains \_HOST | 
