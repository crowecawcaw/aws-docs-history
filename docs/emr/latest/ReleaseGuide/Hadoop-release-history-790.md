...
| Type        | Description                                                                                                                                                                                |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| New Feature | Automatic Configuration Mapping: EMRFS filesystem configuration are automatically applied to corresponding S3A filessystem configuration<br>enabling seamless migration from EMRFS to S3A. |
