...
| Backport | [HIVE-24710](https://issues.apache.org/jira/browse/HIVE-24710): Optimise PTF iteration for count(\*) to reduce CPU and IO cost | 
...
| Backport | [HIVE-25093](https://issues.apache.org/jira/browse/HIVE-25093): date\_format() UDF is returning output in UTC time zone only | 
| Backport | [HIVE-25268](https://issues.apache.org/jira/browse/HIVE-25268): date\_format udf returns wrong results for dates prior to 1900 if the local timezone is other than UTC | 
...
| Backport | [HIVE-22903](https://issues.apache.org/jira/browse/HIVE-22903): Vectorized row\_number() resets the row number after one batch in case of constant expression in partition clause | 
...
| Backport | [HIVE-20502](https://issues.apache.org/jira/browse/HIVE-20502): Fix NPE while running skewjoin\_mapjoin10.q when column stats is used. | 
