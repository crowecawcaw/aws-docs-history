...
This release includes the following applications: [Ganglia](http://ganglia.info "http://ganglia.info"), [HBase](http://hbase.apache.org/ "http://hbase.apache.org/"), [HCatalog](https://cwiki.apache.org/confluence/display/Hive/HCatalog "https://cwiki.apache.org/confluence/display/Hive/HCatalog"), [Hadoop](http://hadoop.apache.org/docs/current/ "http://hadoop.apache.org/docs/current/"), [Hive](http://hive.apache.org/ "http://hive.apache.org/"), [Hue](http://gethue.com/ "http://gethue.com/"), [Mahout](http://mahout.apache.org/ "http://mahout.apache.org/"), [Oozie-Sandbox](http://oozie.apache.org/ "http://oozie.apache.org/"), [Phoenix](https://phoenix.apache.org/ "https://phoenix.apache.org/"), [Pig](http://pig.apache.org/ "http://pig.apache.org/"), [Presto-Sandbox](https://prestodb.io/ "https://prestodb.io/"), [Spark](https://spark.apache.org/docs/latest/ "https://spark.apache.org/docs/latest/"), [Sqoop-Sandbox](http://sqoop.apache.org/ "http://sqoop.apache.org/"), [Tez](https://tez.apache.org/ "https://tez.apache.org/"), [Zeppelin-Sandbox](https://zeppelin.incubator.apache.org/ "https://zeppelin.incubator.apache.org/"), and [ZooKeeper-Sandbox](https://zookeeper.apache.org "https://zookeeper.apache.org").
...
| Application version information |                  | emr-4.7.0        | emr-4.6.1        | emr-4.6.0        | emr-4.5.0 |
| ------------------------------- | ---------------- | ---------------- | ---------------- | ---------------- | --------- |
...
`/usr/share/aws/redshift/jdbc/RedshiftJDBC41.jar` is
the JDBC 4.1-compatible Amazon Redshift driver and
`/usr/share/aws/redshift/jdbc/RedshiftJDBC4.jar` is
the JDBC 4.0-compatible Amazon Redshift driver. For more information, see [Configure a JDBC
...
- Fixed a kernel issue that significantly affected performance
  on Throughput Optimized HDD (st1) EBS volumes for Amazon EMR in
  emr-4.6.0.
- Fixed an issue where a cluster would fail if any HDFS
  encryption zone were specified without choosing Hadoop as an
  application.
- Changed the default HDFS write policy from
  `RoundRobin` to
  `AvailableSpaceVolumeChoosingPolicy`. Some
  volumes were not properly utilized with the RoundRobin
  configuration, which resulted in failed core nodes and an
  unreliable HDFS.
- Fixed an issue with the EMRFS CLI, which would cause an
  exception when creating the default DynamoDB metadata table for
  consistent views.
- Fixed a deadlock issue in EMRFS that potentially occurred
  during multipart rename and copy operations.
- Fixed an issue with EMRFS that caused the CopyPart size
  default to be 5 MB. The default is now properly set at 128
  MB.
- Fixed an issue with the Zeppelin upstart configuration that
  potentially prevented you from stopping the service.
- Fixed an issue with Spark and Zeppelin, which prevented you
  from using the `s3a://` URI scheme because
  `/usr/lib/hadoop/hadoop-aws.jar` was not
  properly loaded in their respective classpath.
- Backported [HUE-2484](https://issues.cloudera.org/browse/HUE-2484 "https://issues.cloudera.org/browse/HUE-2484").
- Backported a [commit](https://github.com/cloudera/hue/commit/c3c89f085e7a29c9fac7de016d881142d90af3eb "https://github.com/cloudera/hue/commit/c3c89f085e7a29c9fac7de016d881142d90af3eb") from Hue 3.9.0 (no JIRA exists) to fix an
  issue with the HBase browser sample.
...
| emr-4.7.0 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
