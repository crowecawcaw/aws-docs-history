...
| Application version information |                 | emr-5.5.1       | emr-5.5.0       | emr-5.4.1       | emr-5.4.0 |
| ------------------------------- | --------------- | --------------- | --------------- | --------------- | --------- |
...
The following release notes include information for the Amazon EMR 5.5.1 release. Changes
are relative to the Amazon EMR 5.5.0 release.
...
| emr-5.5.1 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
