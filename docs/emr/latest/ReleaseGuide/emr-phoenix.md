...
For the version of components installed with Phoenix in this release, see [Release 7.13.0 Component Versions](emr-7130-release.md "emr-7130-release.md").

Phoenix version information for emr-7.13.0| Amazon EMR Release Label | Phoenix Version | Components Installed With Phoenix |
| --- | --- | --- |
