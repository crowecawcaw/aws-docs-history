...
| Type    | Description                                                                                                                                                                                                                            |
| ------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Upgrade | Tez is upgraded to 0.10.2. For more information, see the<br>[change log for Apache Tez 0.10.2](https://github.com/apache/tez/blob/rel/release-0.10.2/CHANGES.txt "https://github.com/apache/tez/blob/rel/release-0.10.2/CHANGES.txt"). |
| Upgrade | Upgrade Hadoop to 3.3.3.                                                                                                                                                                                                               |
| Bug     | Disable<br>`tez.runtime.transfer.data-via-events.enabled`<br>by default due to [TEZ-4450](https://issues.apache.org/jira/browse/TEZ-4450 "https://issues.apache.org/jira/browse/TEZ-4450").                                            |
