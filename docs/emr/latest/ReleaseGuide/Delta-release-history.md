# Delta release history

The following table lists the version of Delta included in each release version of Amazon EMR, along with the components installed with the application.
