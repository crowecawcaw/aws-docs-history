...
| Application version information |                 | emr-4.8.2       | emr-4.8.1       | emr-4.8.0        | emr-4.7.4 |
| ------------------------------- | --------------- | --------------- | --------------- | ---------------- | --------- |
...
The following release notes include information for the Amazon EMR 4.8.2 release. Changes
are relative to the Amazon EMR 4.8.0 release.
...
- Upgraded to Presto 0.152.3, which includes support for the Presto web interface. You can access the Presto web interface on the Presto coordinator using port

8889. For more information about the Presto web interface, see [Web Interface](https://prestodb.io/docs/current/admin/web-interface.html "https://prestodb.io/docs/current/admin/web-interface.html") in the Presto documentation.
...
| emr-4.8.2 classifications       | Classifications                                                     | Description |
| ------------------------------- | ------------------------------------------------------------------- | ----------- |
