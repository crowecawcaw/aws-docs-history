...
- Kerberos authentication that has been set up using an Amazon EMR security
  configuration is not supported.
- [OAuthenticator](https://github.com/jupyterhub/oauthenticator "https://github.com/jupyterhub/oauthenticator") is not supported.
