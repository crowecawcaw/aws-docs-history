...
supports the [LDAP
authenticator plugin for JupyterHub](https://github.com/jupyterhub/ldapauthenticator/ "https://github.com/jupyterhub/ldapauthenticator/") for obtaining user identities from an
LDAP server, such as a Microsoft Active Directory server. Instructions and examples for adding users with each authentication
...
is `jovyan` and the password is `jupyter`. We strongly recommend
...
- [Using PAM authentication](emr-jupyterhub-pam-users.md "emr-jupyterhub-pam-users.md")
- [Using LDAP authentication](emr-jupyterhub-ldap-users.md "emr-jupyterhub-ldap-users.md")
- [User impersonation](emr-jupyterhub-user-impersonation.md "emr-jupyterhub-user-impersonation.md")
