...
| [**Amazon EMR managed policies**](emr-managed-iam-policies.md) | Updated to clarify use of predefined user tags.<br />Added section on using the AWS console to launch clsuters with v2 managed policies. | September 29, 2021 | 
