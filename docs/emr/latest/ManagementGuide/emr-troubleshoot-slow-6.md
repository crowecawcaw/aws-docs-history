...
| mapred.tasktracker.reduce.tasks.maximum   | The max amount of tasks that can execute in parallel per task node during reducing.                                                                                                                                                  | If your cluster tasks are memory-intensive, you can enhance performance by using fewer tasks per core node and reducing your job tracker heap size. |
