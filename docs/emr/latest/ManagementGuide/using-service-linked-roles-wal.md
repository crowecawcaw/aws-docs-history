...
section, [Service-linked role permissions for write-ahead logging (WAL)](#using-service-linked-roles-permissions-wal "#using-service-linked-roles-permissions-wal").
