...
- What region to run a cluster in, where and how to store data, and how to output results. See [Configure Amazon EMR cluster location and data storage](emr-cluster-location-data-storage.md "emr-cluster-location-data-storage.md").
...
- Whether a cluster is long-running or transient, and what software it runs. See [Configuring an Amazon EMR cluster to continue or terminate after step execution](emr-plan-longrunning-transient.md "emr-plan-longrunning-transient.md") and [Configure applications when you launch your Amazon EMR cluster](emr-plan-software.md "emr-plan-software.md").
