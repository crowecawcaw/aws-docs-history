...
| **Idle**      | The Workspace has stopped. To reactivate an idle Workspace,<br>select it from the Workspaces list. The status changes from<br>*_Idle_<br>• to *_Starting_<br>• to<br>*_Ready_<br>• when you select the Workspace.                                                                    |
