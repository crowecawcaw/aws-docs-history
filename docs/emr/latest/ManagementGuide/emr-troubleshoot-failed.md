...
failure. For more information, see [Error codes with ErrorDetail information in Amazon EMR](emr-troubleshoot-error-errordetail.md "emr-troubleshoot-error-errordetail.md").
...
- [Step 3: Look at the last state change](emr-troubleshoot-failed-3.md "emr-troubleshoot-failed-3.md")
- [Step 4: Examine the Amazon EMR log files](emr-troubleshoot-failed-4.md "emr-troubleshoot-failed-4.md")
- [Step 5: Test the Amazon EMR cluster step by step](emr-troubleshoot-failed-5-test-steps.md "emr-troubleshoot-failed-5-test-steps.md")
