...
+ Clusters are resized manually. For more information, see [Manually resize a running Amazon EMR cluster](emr-manage-resize.md).
...
+ Instance fleets in a cluster add instances to meet an increased target capacity. For more information, see [Planning and configuring instance fleets for your Amazon EMR cluster](emr-instance-fleet.md).
