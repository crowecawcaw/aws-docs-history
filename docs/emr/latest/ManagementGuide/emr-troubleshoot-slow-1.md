...
The following cluster details are useful in helping track down issues. For more information on how to gather this information, see [View Amazon EMR cluster status and details](emr-manage-view-clusters.md "emr-manage-view-clusters.md").
