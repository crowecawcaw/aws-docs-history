...
| ------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `AmazonElasticMapReduceEditorsRole<br>• Added<br>permissions` | EMR Notebooks added `ec2:describeVPCs` and<br>`elastmicmapreduce:ListSteps` permissions to<br>`AmazonElasticMapReduceEditorsRole`. | Feb 8, 2023 |
| EMR Notebooks started tracking changes                        | EMR Notebooks started tracking changes for its AWS managed<br>policies.                                                            | Feb 8, 2023 |
