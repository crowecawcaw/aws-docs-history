...
- [Adding steps to a cluster with the Amazon EMR Management Console](emr-add-steps-console.md "emr-add-steps-console.md")
- [Adding steps to an Amazon EMR cluster with the AWS CLI](add-step-cli.md "add-step-cli.md")
- [Considerations for running multiple steps in parallel when you submit work to Amazon EMR](emr-concurrent-steps.md "emr-concurrent-steps.md")
