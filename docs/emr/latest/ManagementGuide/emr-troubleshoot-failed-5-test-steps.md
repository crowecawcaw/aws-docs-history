...
1. Launch a new cluster, with both keep alive and termination protection
   ...
   the event of an error. For more information, see [Configuring an Amazon EMR cluster to continue or terminate after step execution](emr-plan-longrunning-transient.md "emr-plan-longrunning-transient.md") and [Using termination protection to protect your Amazon EMR clusters from accidental shut down](UsingEMR_TerminationProtection.md "UsingEMR_TerminationProtection.md").
...
5. When you are done debugging the cluster, and want to terminate it, you will
   ...
   launched with termination protection enabled. For more information, see [Using termination protection to protect your Amazon EMR clusters from accidental shut down](UsingEMR_TerminationProtection.md "UsingEMR_TerminationProtection.md").
