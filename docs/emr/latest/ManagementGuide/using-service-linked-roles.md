...
- [Using service-linked roles for Amazon EMR for cleanup](using-service-linked-roles-cleanup.md "using-service-linked-roles-cleanup.md")
- [Using service-linked roles with Amazon EMR for write-ahead logging](using-service-linked-roles-wal.md "using-service-linked-roles-wal.md")
