...
![AWS Management Console automatic scaling rule parameters for Amazon EMR.](https://docs.aws.amazon.com/emr/latest/ManagementGuide/images/auto-scaling-rule-params.png)
