...
### S3A File System
<a name="emr-storage-s3a"></a>

Starting with the Amazon EMR 7.10.0 release, the S3A File System is the default file system and Amazon S3 connector for Amazon EMR clusters for all Amazon S3 file schemes, including `s3://`, `s3a://`, and `s3n://`. For more information, see [Migrating to S3A on Amazon EMR](https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-s3a-migrate.html) in the *Amazon EMR Release Guide*.
