...
As a managed service, Amazon EMR is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon EMR through the network. Clients must
