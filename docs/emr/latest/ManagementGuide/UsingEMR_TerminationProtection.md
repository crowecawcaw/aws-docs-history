...
- ** `TERMINATE_CLUSTER` **
  - **Termination after step execution:** Enabled / **Termination protection:** Disabled / **Result:** Cluster terminates
  - **Termination after step execution:** Enabled / **Termination protection:** Enabled / **Result:** Cluster terminates
  - **Termination after step execution:** Disabled / **Termination protection:** Enabled / **Result:** Cluster continues
  - **Termination after step execution:** Disabled / **Termination protection:** Disabled / **Result:** Cluster terminates
...
Linux line continuation characters (\\) are included for readability. They can be removed or used in Linux commands. For Windows, remove them or replace with a caret (^).
  ...
  ```
  aws emr create-cluster --name "{{TerminationProtectedCluster}}" --release-label {{emr-7.13.0}} \
