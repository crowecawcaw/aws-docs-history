...
DNS name, see [Retrieve the public DNS name of the primary node](emr-connect-master-node-ssh.md#emr-connect-master-dns "emr-connect-master-node-ssh.md#emr-connect-master-dns"). For more information about
...
see [View web interfaces hosted on Amazon EMR clusters](emr-web-interfaces.md "emr-web-interfaces.md").
...
browser. For more information, see [Option 2, part 2: Configure proxy settings to view websites hosted on the Amazon EMR cluster primary node](emr-connect-master-node-proxy.md "emr-connect-master-node-proxy.md"). 5. When you are done working with the web interfaces on the primary
...
`.pem` file as shown in [To configure the key pair private key file permissions](emr-connect-master-node-ssh.md#emr-keypair-file-permission-config "emr-connect-master-node-ssh.md#emr-keypair-file-permission-config"). If you are using
...
1. Ensure you've allowed inbound SSH traffic. For instructions, see
   [Before you connect to Amazon EMR: Authorize inbound traffic](emr-connect-ssh-prereqs.md "emr-connect-ssh-prereqs.md").
2. Create an SSH connection with the primary node as shown in [Connect to the primary node using the AWS CLI](emr-connect-master-node-ssh.md#emr-connect-cli "emr-connect-master-node-ssh.md#emr-connect-cli").
...
browser. For more information, see [Option 2, part 2: Configure proxy settings to view websites hosted on the Amazon EMR cluster primary node](emr-connect-master-node-proxy.md "emr-connect-master-node-proxy.md"). 6. When you are done working with the web interfaces on the primary
...
browser. For more information, see [Option 2, part 2: Configure proxy settings to view websites hosted on the Amazon EMR cluster primary node](emr-connect-master-node-proxy.md "emr-connect-master-node-proxy.md"). 14. When you are done working with the web interfaces on the primary
