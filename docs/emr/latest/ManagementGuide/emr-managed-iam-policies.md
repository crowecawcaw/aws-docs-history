...
**AmazonEMRServicePolicy\_v2** and **AmazonEMRFullAccessPolicy\_v2** depend on scoped-down
...
cluster, see [Considerations for using the Amazon EMR console to launch clusters with v2 managed policies](#emr-cluster-v2policy-awsconsole-launch "#emr-cluster-v2policy-awsconsole-launch").
...
VPCs, you must tag those VPCs with the predefined user tag. See, [Considerations for using the Amazon EMR console to launch clusters with v2 managed policies](#emr-cluster-v2policy-awsconsole-launch "#emr-cluster-v2policy-awsconsole-launch").
