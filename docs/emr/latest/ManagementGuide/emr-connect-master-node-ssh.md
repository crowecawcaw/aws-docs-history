...
1. To establish a connection to the primary node, type the following command. Replace {{ec2-\#\#\#-\#\#-\#\#-\#\#\#.compute-1.amazonaws.com}} with the primary public DNS name of your cluster and replace {{\~/mykeypair.pem}} with the full path and file name of your `.pem` file. For example `C:/Users/<username>/.ssh/mykeypair.pem`.
