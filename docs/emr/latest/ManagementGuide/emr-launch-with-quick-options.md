...
<a name="emr-launch-with-quick-options"></a>
...
1. On the **Create Cluster** page, enter or select values for the provided fields. The persistent summary panel displays a real-time view of your currently selected cluster options. Select a heading in the summary panel to navigate to the corresponding section and make adjustments. Your cluster name can't contain the characters <, >, $, \|, or ` (backtick). You must complete all required configurations before you can choose **Create cluster**.
