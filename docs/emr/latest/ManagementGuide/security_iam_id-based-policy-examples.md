...
- [Policy best practices for Amazon EMR](security_iam_service-with-iam-policy-best-practices.md "security_iam_service-with-iam-policy-best-practices.md")
...
- [Amazon EMR managed policies](emr-managed-iam-policies.md "emr-managed-iam-policies.md")
- [IAM policies for tag-based access to clusters and EMR notebooks](emr-fine-grained-cluster-access.md "emr-fine-grained-cluster-access.md")
...
- [Troubleshooting Amazon EMR identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md")
