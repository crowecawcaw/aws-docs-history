...
| Metrics evaluation frequency  | Every 5 to 10 seconds<br />More frequent evaluation of metrics allows Amazon EMR to make more precise scaling decisions. | You can define the evaluation periods only in five-minute increments. | 
