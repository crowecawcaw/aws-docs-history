...
+ EMR Serverless doesn't support HDFS. The local disks on workers are temporary storage that EMR Serverless uses to shuffle and process data during job runs.