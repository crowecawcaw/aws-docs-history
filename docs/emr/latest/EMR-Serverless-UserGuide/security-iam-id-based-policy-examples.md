...
**Topics**
+ [Policy best practices](#security-iam-policy-best-practices)
+ [Allow users to access their own permissions](#security-iam-id-based-policy-examples-view-own-permissions)
