...
**Note**  
Starting with Amazon EMR 7.12, DML and DDL operations that modify table data use Lake Formation credentials. In Amazon EMR 7.11 and older versions, these operations (except DELETE, UPDATE, and MERGE) use the job runtime role credentials to modify the table data instead. Amazon EMR 7.11 and older versions do not support DELETE, UPDATE, and MERGE operations.
