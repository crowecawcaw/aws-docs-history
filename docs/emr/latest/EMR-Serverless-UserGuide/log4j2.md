...
**Topics**
+ [Log4j2 classifications for Spark](#log4j2-spark-class)
+ [Log4j2 configuration example for Spark](#log4j2-spark-example)
+ [Log4j2 in sample Spark jobs](#log4j2-spark-jobs)
+ [Log4j2 considerations for Spark](#log4j2-spark-considerations)
