...
- You can now export, import, query, and join Amazon DynamoDB tables directly from your
  EMR Serverless Spark and Hive applications. For more information, refer to [Connecting to DynamoDB with Amazon EMR Serverless](using-ddb-connector.md "using-ddb-connector.md").
  **Known issues**
