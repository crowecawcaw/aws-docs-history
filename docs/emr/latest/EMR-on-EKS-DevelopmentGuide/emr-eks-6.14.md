...
**Release notes**: `emr-6.14.0-latest` currently
points to `emr-6.14.0-20231005`.

**Regions:**
`emr-6.14.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
