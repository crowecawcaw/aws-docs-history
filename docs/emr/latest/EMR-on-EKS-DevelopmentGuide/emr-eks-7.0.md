...
**Release notes**: `emr-7.0.0-latest` currently
points to `emr-7.0.0-2024321`.

**Regions:**
`emr-7.0.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
