...
**Release notes**: `emr-7.3.0-latest` currently
points to `emr-7.3.0-20240920`.

**Regions:**
`emr-7.3.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
