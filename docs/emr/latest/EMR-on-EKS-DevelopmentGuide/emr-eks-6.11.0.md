...
- [emr-6.11.0-latest](emr-eks-6.11.0-latest.md "emr-eks-6.11.0-latest.md")
- [emr-6.11.0-20230905](emr-eks-6.11.0-20230905.md "emr-eks-6.11.0-20230905.md")
- [emr-6.11.0-20230509](emr-eks-6.11.0-20230509.md "emr-eks-6.11.0-20230509.md")
...
- **Volcano support in Spark operator and spark-submit**
  ...
  optimized capacity. For more information, see [Using Volcano as a custom scheduler for Apache Spark on Amazon EMR on EKS](tutorial-volcano.md "tutorial-volcano.md").
