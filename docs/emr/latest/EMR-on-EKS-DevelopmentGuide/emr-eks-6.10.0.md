...
The following Amazon EMR 6.10.0 releases are available for Amazon EMR on EKS. Select a specific **emr-6.10.0-XXXX** release to view more details such as the related
container image tag.

- [emr-6.10.0-latest](emr-eks-6.10.0-latest.md "emr-eks-6.10.0-latest.md")
- [emr-6.10.0-20230905](emr-eks-6.10.0-20230905.md "emr-eks-6.10.0-20230905.md")
- [emr-6.10.0-20230624](emr-eks-6.10.0-20230624.md "emr-eks-6.10.0-20230624.md")
- [emr-6.10.0-20230421](emr-eks-6.10.0-20230421.md "emr-eks-6.10.0-20230421.md")
- [emr-6.10.0-20230403](emr-eks-6.10.0-20230403.md "emr-eks-6.10.0-20230403.md")
- [emr-6.10.0-20230220](emr-eks-6.10.0-20230220.md "emr-eks-6.10.0-20230220.md")
...
- **Spark operator** - With Amazon EMR on EKS 6.10.0 and higher, you
  can use the Kubernetes operator for Apache Spark, or _the Spark operator_,
  to deploy and manage Spark applications with the Amazon EMR release runtime on your own Amazon EKS
  clusters. For more information, see [Running Spark jobs with the Spark operator](spark-operator.md "spark-operator.md").
- **Java 11** - With Amazon EMR on EKS 6.10 and higher, you can launch
  Spark with Java 11 runtime. To do this, pass `emr-6.10.0-java11-latest` as a release
  label. We recommend that you validate and run performance tests before you move your production
  workloads from the Java 8 image to the Java 11 image.
- For the Amazon Redshift integration for Apache Spark, Amazon EMR on EKS 6.10.0 removes the dependency on
  `minimal-json.jar`, and automatically adds the required `spark-redshift`
  related jars to the executor class path for Spark: `spark-redshift.jar`,
  `spark-avro.jar`, and `RedshiftJDBC.jar`.
  **Changes**
