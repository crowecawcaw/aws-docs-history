...
**Release notes**: `emr-6.6.0-latest` currently
points to `emr-6.6.0-20240321`.

**Regions:**
`emr-6.6.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
