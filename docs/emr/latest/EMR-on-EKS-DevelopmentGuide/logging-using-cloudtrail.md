...
The following example shows a CloudTrail log entry that demonstrates the [`ListJobRuns`](https://docs.aws.amazon.com/emr-on-eks/latest/APIReference/API_ListJobRuns.html) action.
