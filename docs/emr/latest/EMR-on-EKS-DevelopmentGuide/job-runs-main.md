...
**Topics**
+ [Running Spark jobs with `StartJobRun`](job-runs.md)
+ [Running Spark jobs with the Spark operator](spark-operator.md)
+ [Running Spark jobs with spark-submit](spark-submit.md)
+ [Using Apache Livy with Amazon EMR on EKS](job-runs-apache-livy.md)
+ [Managing Amazon EMR on EKS job runs](emr-eks-jobs-manage.md)
+ [Using job templates](job-templates.md)
+ [Using pod templates](pod-templates.md)
+ [Using job retry policies](jobruns-using-retry-policies.md)
