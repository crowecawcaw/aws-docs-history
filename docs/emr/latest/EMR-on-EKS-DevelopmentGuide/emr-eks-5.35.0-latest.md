...
**Release notes**: `emr-5.35.0-latest` currently
points to `emr-5.35.0-20240321`.

**Regions:**
`emr-5.35.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
