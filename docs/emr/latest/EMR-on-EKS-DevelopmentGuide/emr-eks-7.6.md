...
**Release notes**: `emr-7.6.0-latest` currently
points to `emr-7.6.0-20241213`.

**Regions:**
`emr-7.6.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
