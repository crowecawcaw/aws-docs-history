...
**Topics**
+ [Tag basics](#tag-resources-tag-basics)
+ [Tag your resources](#tag-resources-add-tags)
+ [Tag restrictions](#tag-resources-restrictions)
+ [Work with tags using the AWS CLI and the Amazon EMR on EKS API](#tag-resources-work-with-tags)
...
For tag-based access control policy examples, see [Policies for tag-based access control](security_iam_TBAC.md). 

## Tag your resources
<a name="tag-resources-add-tags"></a>

You can tag new or existing virtual clusters and job runs that are in active states. The active states for job runs include: `PENDING`, `SUBMITTED`, `RUNNING`, and `CANCEL_PENDING`. The active states for virtual clusters include: `RUNNING`, `TERMINATING` and `ARRESTED`. For more information, see [Job run states](emr-eks-jobs-states.md) and [Virtual cluster states](virtual-cluster.md#virtual-cluster-states). 
...
| --- | --- | --- | 
| Add or overwrite one or more tags | [tag-resource](https://docs.aws.amazon.com/cli/latest/reference/emr-containers/tag-resource.html) | [TagResource](https://docs.aws.amazon.com/emr-on-eks/latest/APIReference/API_TagResource.html) | 
| List tags for a resource | [list-tags-for-resource](https://docs.aws.amazon.com/cli/latest/reference/emr-containers/list-tags-for-resource.html) | [ListTagsForResource](https://docs.aws.amazon.com/emr-on-eks/latest/APIReference/API_ListTagsForResource.html) | 
| Delete one or more tags | [untag-resource](https://docs.aws.amazon.com/cli/latest/reference/emr-containers/untag-resource.html) | [UntagResource](https://docs.aws.amazon.com/emr-on-eks/latest/APIReference/API_UntagResource.html) | 
