...
+ Use an existing Amazon EKS cluster or create one by using the [eksctl](https://docs.aws.amazon.com/eks/latest/userguide/getting-started-eksctl.html) command line utility or Amazon EKS console.
