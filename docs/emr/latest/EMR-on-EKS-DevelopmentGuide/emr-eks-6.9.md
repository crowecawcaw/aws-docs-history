...
**Release notes**: `emr-6.9.0-latest` currently
points to `emr-6.9.0-20230905`.

**Regions:**
`emr-6.9.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
