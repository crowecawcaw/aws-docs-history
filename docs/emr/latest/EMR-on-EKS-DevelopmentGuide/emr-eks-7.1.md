...
Amazon EMR on EKS deployment. For details about Amazon EMR running on Amazon EC2 and about the Amazon EMR 7.1.0 release
in general, see [Amazon EMR 7.1.0](../ReleaseGuide/emr-710-release.md "../ReleaseGuide/emr-710-release.md") in the _Amazon EMR Release Guide_.

## Amazon EMR on EKS 7.1 releases

The following Amazon EMR 7.1.0 releases are available for Amazon EMR on EKS. Select a specific **emr-7.1.0-XXXX** release to view more details such as the related
container image tag.

Flink releases
The following Amazon EMR 7.1.0 releases are available for Amazon EMR on EKS when you run Flink
applications.

- [emr-7.1.0-flink-latest](emr-eks-7.1.md "emr-eks-7.1.md")
- [emr-7.1.0-flink-20240321](emr-eks-7.1.md "emr-eks-7.1.md")

Spark releases
The following Amazon EMR 7.1.0 releases are available for Amazon EMR on EKS when you run Spark
applications.

- [emr-7.1.0-latest](emr-eks-7.1.md "emr-eks-7.1.md")
- [emr-7.1.0-20240321](emr-eks-7.1.md "emr-eks-7.1.md")
...
- **Supported applications** ‐ AWS SDK for Java
  2.23.18 and 1.12.656, Apache Spark 3.5.0-amzn-1, Apache Hudi 0.14.1-amzn-0,
  Apache Iceberg 1.4.3-amzn-0, Delta 3.0.0, Apache Spark RAPIDS 23.10.0-amzn-1,
  Jupyter Enterprise Gateway 2.6.0, Apache Flink 1.18.1-amzn-0, Flink Operator 1.6.1-amzn-1
...
- [Apache Livy support for Amazon EMR on EKS](job-runs-apache-livy.md "job-runs-apache-livy.md") – With Amazon EMR on EKS releases 7.1.0 and higher, you can use Apache Livy on an Amazon EKS cluster
  to create an Apache Livy REST interface to submit Spark jobs or snippets of Spark code. Doing so lets you retrieve results synchronously and asynchronously,
  while still leveraging Amazon EMR on EKS benefits, such as Amazon EMR-optimized Spark runtime, SSL-enabled Livy endpoints, and a programmatic set-up experience.
