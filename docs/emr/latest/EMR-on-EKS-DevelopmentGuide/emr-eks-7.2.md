...
**Release notes**: `emr-7.2.0-latest` currently
points to `emr-7.2.0-20240610`.

**Regions:**
`emr-7.2.0-latest` is available in all Regions supported by Amazon EMR on EKS. For more
