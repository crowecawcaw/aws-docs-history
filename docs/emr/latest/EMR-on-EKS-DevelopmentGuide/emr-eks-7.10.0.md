...
- [emr-7.10.0-flink-latest](emr-eks-7.10.0-flink-latest.md "emr-eks-7.10.0-flink-latest.md")
- [emr-7.10.0-flink-20250801](emr-7.10.0-flink-20250801.md "emr-7.10.0-flink-20250801.md")

Spark releases
The following Amazon EMR 7.10.0 releases are available for Amazon EMR on EKS when you run Spark
applications.

- [emr-7.10.0-latest](emr-eks-7.10.0-latest.md "emr-eks-7.10.0-latest.md")
- [emr-7.10.0-20250801](emr-eks-7.10.0-20250801.md "emr-eks-7.10.0-20250801.md")
