...
The _instruction set architecture_ of a Lambda function determines the type of computer
...
- [Advantages of using arm64 architecture](#foundation-arch-adv "#foundation-arch-adv")
- [Requirements for migration to arm64 architecture](#foundation-arch-consider "#foundation-arch-consider")
- [Function code compatibility with arm64 architecture](#foundation-arch-considerations "#foundation-arch-considerations")
- [How to migrate to arm64 architecture](#foundation-arch-steps "#foundation-arch-steps")
- [Configuring the instruction set architecture](#foundation-arch-config "#foundation-arch-config")
...
- If your function uses layers, you must [check each
  layer](adding-layers.md#finding-layer-information "adding-layers.md#finding-layer-information") to ensure that it is compatible with the new architecture. If a layer is not compatible, edit
...
For example, use [alias routing configuration](configuring-alias-routing.md "configuring-alias-routing.md") to split
...
language-specific information for Java, Go, .NET, and Python, see the [Getting started with AWS Graviton](https://github.com/aws/aws-graviton-getting-started "https://github.com/aws/aws-graviton-getting-started") GitHub
repository.
