...
- [Viewing a function's execution role](#view-execution-role "#view-execution-role")
- [Updating a function's execution role](#update-execution-role "#update-execution-role")
...
new role under **Policy templates**. 6. Choose **Save**.
