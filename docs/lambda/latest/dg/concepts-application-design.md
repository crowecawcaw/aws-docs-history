...
- [Use services instead of custom code](#services-custom-code "#services-custom-code")
- [Understand Lambda abstraction levels](#level-abstraction "#level-abstraction")
...
[Availability Zones](https://aws.amazon.com/about-aws/global-infrastructure/regions_az/ "https://aws.amazon.com/about-aws/global-infrastructure/regions_az/") the
...
[AWS Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md "../../../systems-manager/latest/userguide/systems-manager-parameter-store.md") or [AWS Secrets Manager](https://aws.amazon.com/secrets-manager/ "https://aws.amazon.com/secrets-manager/") and loaded by the function. Since these resources are account-specific, you can create build pipelines across multiple accounts. The pipelines load the appropriate secrets
...
[by using scheduled
expressions](../../../eventbridge/latest/userguide/scheduled-events.md "../../../eventbridge/latest/userguide/scheduled-events.md") for rules in Amazon EventBridge, these should be used sparingly or as a last-resort. In any scheduled
...
[Time To Live (TTL)](../../../amazondynamodb/latest/developerguide/TTL.md "../../../amazondynamodb/latest/developerguide/TTL.md")
value to expire items to limit the storage space used.

## Use multiple AWS accounts for managing quotas

Many [service quotas](gettingstarted-limits.md "gettingstarted-limits.md") in AWS are set at the account level. This means
...
In addition, by using [AWS Organizations](https://aws.amazon.com/organizations/ "https://aws.amazon.com/organizations/"), you can
