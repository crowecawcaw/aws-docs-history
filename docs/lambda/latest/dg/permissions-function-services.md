...
Add a statement with the [add-permission](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/add-permission.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/lambda/add-permission.html") command. The simplest resource-based policy statement
...
This lets Amazon SNS call the [Invoke](../api/API_Invoke.md "../api/API_Invoke.md") API action on the function, but it doesn't restrict the Amazon SNS topic that
