...
available to the [handler](powershell-handler.md "powershell-handler.md"). This variable provides methods and properties
...
- `Logger` – The [logger object](powershell-logging.md "powershell-logging.md") for the
  function.
