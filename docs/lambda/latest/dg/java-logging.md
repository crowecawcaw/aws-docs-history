...
If you select JSON for your function's log format, Lambda sends logs output using the `LambdaLogger` class as structured JSON. Each JSON log object contains at least four key value pairs with the following keys:
