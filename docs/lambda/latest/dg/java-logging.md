...
To output logs from your function code, you can use methods on [java.lang.System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html "https://docs.oracle.com/javase/8/docs/api/java/lang/System.html"), or any logging
module that writes to stdout or stderr.

###### Sections

- [Creating a function that returns logs](#java-logging-output "#java-logging-output")
- [Using Lambda advanced logging controls with Java](#java-logging-advanced "#java-logging-advanced")
- [Implementing advanced logging with Log4j2 and SLF4J](#java-logging-log4j2 "#java-logging-log4j2")
- [Using other logging tools and libraries](#java-tools-libraries "#java-tools-libraries")
- [Using Powertools for AWS Lambda (Java) and AWS SAM for structured logging](#java-logging-sam "#java-logging-sam")
- [Viewing logs in the Lambda console](#java-logging-console "#java-logging-console")
- [Viewing logs in the CloudWatch console](#java-logging-cwconsole "#java-logging-cwconsole")
- [Viewing logs using the AWS Command Line Interface (AWS CLI)](#java-logging-cli "#java-logging-cli")
- [Deleting logs](#java-logging-delete "#java-logging-delete")
- [Sample logging code](#java-logging-samples "#java-logging-samples")

## Creating a function that returns logs

To output logs from your function code, you can use methods on [java.lang.System](https://docs.oracle.com/javase/8/docs/api/java/lang/System.html "https://docs.oracle.com/javase/8/docs/api/java/lang/System.html"), or any logging
module that writes to `stdout` or `stderr`. The [aws-lambda-java-core](java-package.md "java-package.md") library provides a logger class named `LambdaLogger` that you can access
...
This version updates the underlying Log4j2 utility dependencies to version 2.17.0 (or later). The updated aws-lambda-java-log4j2 binary is available at the [Maven repository](https://repo1.maven.org/maven2/com/amazonaws/aws-lambda-java-log4j2/ "https://repo1.maven.org/maven2/com/amazonaws/aws-lambda-java-log4j2/") and its source code is available in [Github](https://github.com/aws/aws-lambda-java-libs/tree/master/aws-lambda-java-log4j2 "https://github.com/aws/aws-lambda-java-libs/tree/master/aws-lambda-java-log4j2").
...
[Powertools for AWS Lambda (Java)](../../../powertools/java.md "../../../powertools/java.md") is a developer toolkit to implement Serverless best practices and increase developer velocity. The [Logging utility](../../../powertools/java/latest/core/logging.md "../../../powertools/java/latest/core/logging.md") provides a Lambda optimized logger which includes additional information about function context across all your functions with output structured as JSON. Use this utility to do the following:
...
Follow the steps below to download, build, and deploy a sample Hello World Java application with integrated [Powertools for AWS Lambda (Java)](../../../powertools/java/latest.md "../../../powertools/java/latest.md") modules using the AWS SAM. This application implements a
