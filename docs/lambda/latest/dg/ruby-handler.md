...
+ **Separate the Lambda handler from your core logic.** This makes it easier to create a more unit-testable function. For example, in Ruby, this might look like: 
  ...
  ```
+ **Control the dependencies in your function's deployment package. ** The AWS Lambda execution environment contains a number of libraries. For the Ruby runtime, these include the AWS SDK.
