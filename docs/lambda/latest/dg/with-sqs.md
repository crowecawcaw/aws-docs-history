...
- [Using provisioned mode with Amazon SQS event source mappings](#sqs-provisioned-mode "#sqs-provisioned-mode")
- [Configuring provisioned mode for Amazon SQS event source mapping](#sqs-configuring-provisioned-mode "#sqs-configuring-provisioned-mode")
...
Provisioned mode cannot be used in conjunction with the maximum concurrency setting. When using
provisioned mode, you control maximum concurrency through the maximum number of event pollers.

For more information on configuring provisioned mode, see [Creating and configuring an Amazon SQS event source mapping](services-sqs-configure.md "services-sqs-configure.md").
