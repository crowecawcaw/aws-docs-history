...
[GitHub](https://github.com/aws-samples/serverless-dotnet-demo "https://github.com/aws-samples/serverless-dotnet-demo").
...
For complete source code and instructions on how to set up and run, see the full example on
[GitHub](https://github.com/aws-samples/serverless-go-demo "https://github.com/aws-samples/serverless-go-demo").
...
For complete source code and instructions on how to set up and run, see the full example on
[GitHub](https://github.com/aws-samples/serverless-java-frameworks-samples "https://github.com/aws-samples/serverless-java-frameworks-samples").
...
For complete source code and instructions on how to set up and run, see the full example on
[GitHub](https://github.com/aws-samples/serverless-rust-demo "https://github.com/aws-samples/serverless-rust-demo").
