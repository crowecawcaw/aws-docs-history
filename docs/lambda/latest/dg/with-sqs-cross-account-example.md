...
In **Account A**, create an [execution role](lambda-intro-execution-role.md "lambda-intro-execution-role.md")
that gives your function permission to access the required AWS resources.

###### To create an execution role

1. Open the [Roles page](https://console.aws.amazon.com/iam/home#/roles "https://console.aws.amazon.com/iam/home#/roles") in the AWS Identity and Access Management (IAM)
   console.
...
`"body"` contains the actual message from the queue. 2. Run the following `invoke` AWS CLI command.
...
4. After creating the queue, record its Amazon Resource Name (ARN). You need this in the next step when you
...
1. In **Account B**, open the [Amazon SQS console](https://console.aws.amazon.com/sqs "https://console.aws.amazon.com/sqs").
