...
that do not provide static IPs. To adapt these instructions to other peering scenarios, consult the [VPC Peering Guide](../../../vpc/latest/peering/what-is-vpc-peering.md "../../../vpc/latest/peering/what-is-vpc-peering.md").
...
3. For **IPv4 CIDR block**, provide a private CIDR block. Your CIDR
   ...
   or a block already defined in the route tables in your resources VPC. For more information about defining appropriate CIDR blocks, see [VPC CIDR blocks](../../../vpc/latest/userguide/vpc-cidr-blocks.md "../../../vpc/latest/userguide/vpc-cidr-blocks.md").
...
1. Open the [https://console.aws.amazon.com/vpc/](https://console.aws.amazon.com/vpc/ "https://console.aws.amazon.com/vpc/").
...
more information about troubleshooting, see [Troubleshoot a VPC peering connection](../../../vpc/latest/peering/troubleshoot-vpc-peering-connections.md "../../../vpc/latest/peering/troubleshoot-vpc-peering-connections.md") in
the _Amazon Virtual Private Cloud VPC Peering Guide_.
