...
- [DynamoDB event](#filtering-ddb "#filtering-ddb")
- [Filtering with table attributes](#filtering-ddb-attributes "#filtering-ddb-attributes")
- [Filtering with Boolean expressions](#filtering-ddb-boolean "#filtering-ddb-boolean")
- [Using the Exists operator](#filtering-ddb-exists "#filtering-ddb-exists")
- [JSON format for DynamoDB filtering](#filtering-ddb-JSON-format "#filtering-ddb-JSON-format")
