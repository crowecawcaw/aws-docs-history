...
We don't recommend using [layers](chapter-layers.md "chapter-layers.md") to manage dependencies for Lambda functions written in Go.
...
AWS SDK for Go in your function, see [Define Lambda function handlers in Go](golang-handler.md "golang-handler.md").
