...
- [AWS X-Ray SDK for Go](../../../xray/latest/devguide/xray-sdk-go.md "../../../xray/latest/devguide/xray-sdk-go.md") – An SDK
...
- [Using ADOT to instrument your Go functions](#golang-adot "#golang-adot")
...
Support for Go](https://aws-otel.github.io/docs/getting-started/lambda/lambda-go "https://aws-otel.github.io/docs/getting-started/lambda/lambda-go") in the ADOT documentation. For instructions on converting Lambda Telemetry API events to
...
you can also use the AWS X-Ray SDK for Go. To get the SDK, download the SDK from its [GitHub repository](https://github.com/aws/aws-xray-sdk-go "https://github.com/aws/aws-xray-sdk-go") with `go get`:
...
with annotations and metadata. For more information, see the [AWS X-Ray SDK for Go](../../../xray/latest/devguide/xray-sdk-python.md "../../../xray/latest/devguide/xray-sdk-python.md") in the
