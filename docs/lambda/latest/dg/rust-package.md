...
3. Inside the package's root directory, run the [build](https://www.cargo-lambda.info/commands/build.html "https://www.cargo-lambda.info/commands/build.html") subcommand to compile the code in your function.
...
the [--iam-role flag](https://www.cargo-lambda.info/commands/deploy.html#iam-roles "https://www.cargo-lambda.info/commands/deploy.html#iam-roles").
...
1. Use the [build](https://www.cargo-lambda.info/commands/build.html "https://www.cargo-lambda.info/commands/build.html") subcommand
...
1. Create an AWS SAM template with the resource and property definition. For `Runtime`, specify `provided.al2023`. This is an [OS-only runtime](runtimes-provided.md "runtimes-provided.md"). OS-only runtimes are used to deploy compiled binaries and custom runtimes to Lambda.

For more information about deploying Lambda functions using AWS SAM, see [AWS::Serverless::Function](../../../serverless-application-model/latest/developerguide/sam-resource-function.md "../../../serverless-application-model/latest/developerguide/sam-resource-function.md") in the _AWS Serverless Application Model Developer Guide_.
...
2. Use the [build](https://www.cargo-lambda.info/commands/build.html "https://www.cargo-lambda.info/commands/build.html") subcommand
...
3. Use the [sam deploy](../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-deploy.md "../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-deploy.md") command to deploy the function to Lambda.

```
sam deploy --guided
```

For more information about building Rust functions with the AWS SAM CLI, see [Building Rust Lambda functions with Cargo Lambda](../../../serverless-application-model/latest/developerguide/building-rust.md "../../../serverless-application-model/latest/developerguide/building-rust.md") in the _AWS Serverless Application Model Developer Guide_.

## Invoking your Rust function with Cargo Lambda

Use the [invoke](https://www.cargo-lambda.info/commands/invoke.html "https://www.cargo-lambda.info/commands/invoke.html")
