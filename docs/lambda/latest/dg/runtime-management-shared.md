...
| Managed runtime, \*_Manual_<br>• mode          | Publish new runtime versions containing the latest patches.                                                 | Use this mode only for temporary runtime rollback in the rare event of a runtime<br>update compatibility issue.<br>Switch functions to **Auto\*<br>• or **Function<br>update\*<br>• mode and the latest runtime version as soon as possible.                                                                                                                                                                                     |
