...
functions](images-create.md "images-create.md"), then Lambda is responsible for publishing updated base images. In this
...
| --------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Managed runtime, *_Auto_<br>• mode            | Publish new runtime versions containing the latest patches.<br>Apply runtime patches to existing functions. | Roll back to a previous runtime version in the rare event of a runtime update<br>compatibility issue. Follow best practices for [backward compatibility](runtimes-update.md#runtime-update-compatibility "runtimes-update.md#runtime-update-compatibility").                                                                                                                                                                    |
| Managed runtime, *_Function update_<br>• mode | Publish new runtime versions containing the latest patches.                                                 | Update functions regularly to pick up the latest runtime version.<br>Switch a function to *_Auto_<br>• mode when you're not regularly<br>updating the function.<br>Roll back to a previous runtime version in the rare event of a runtime update<br>compatibility issue. Follow best practices for [backward compatibility](runtimes-update.md#runtime-update-compatibility "runtimes-update.md#runtime-update-compatibility"). |
| Managed runtime, *_Manual_<br>• mode          | Publish new runtime versions containing the latest patches.                                                 | Use this mode only for temporary runtime rollback in the rare event of a runtime<br>update compatibility issue.<br>Switch functions to *_Auto_<br>• or *_Function<br>update_<br>• mode and the latest runtime version as soon as possible.                                                                                                                                                                                      |
| Container image                               | Publish new container images containing the latest patches.                                                 | Redeploy functions regularly using the latest container base image to pick up the<br>latest patches.                                                                                                                                                                                                                                                                                                                            |
