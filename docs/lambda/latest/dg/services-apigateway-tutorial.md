...
Before you can create an [execution role](lambda-intro-execution-role.md "lambda-intro-execution-role.md") for your Lambda function, you first
...
Node.js
The `region` setting must match the AWS Region where you deploy the function and [create the DynamoDB table](#services-apigateway-tutorial-table "#services-apigateway-tutorial-table").
...
[Using AWS Lambda environment variables](configuration-envvars.md "configuration-envvars.md"). 9. In the **DEPLOY** section, choose **Deploy** to update your function's code:
...
![Lambda console Test tab.](images/test-tab.png) 2. Scroll down to the **Event JSON** section and replace the default event with the following. This event matches the structure expected by the Lambda function.
...
1. Open the [API Gateway console](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway").
2. Choose **Create API**.
...
1. In the [API Gateway console](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway"), on the
...
[The Lambda monolith](https://serverlessland.com/content/service/lambda/guides/aws-lambda-operator-guide/monolith "https://serverlessland.com/content/service/lambda/guides/aws-lambda-operator-guide/monolith")
in Serverless Land.
...
1. In the [API Gateway console](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway"), choose your API
   (`DynamoDBOperations`).
...
To confirm, check that your DynamoDB table now contains the new item. 6. Open the [Tables page](https://console.aws.amazon.com/dynamodbv2#tables "https://console.aws.amazon.com/dynamodbv2#tables") of the DynamoDB console and
...
1. In the [API Gateway console](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway"), return to your POST method's
   **Test** tab.
...
To confirm, check that the item in your DynamoDB table has been modified. 4. Open the [Tables page](https://console.aws.amazon.com/dynamodbv2#tables "https://console.aws.amazon.com/dynamodbv2#tables") of the DynamoDB console and
choose the `lambda-apigateway` table. 5. Chose **Explore table items**. In the **Items returned** pane, you
should see one item with the **id** `1234ABCD` and the **number** `10`.

![Test item changed to number 10.](images/items-returned-2.png)
...
1. Open the **APIs** page of the [API Gateway console](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway") and choose the
...
If the operation was successful, you should see a response returned with an HTTP status code of 200. 2. You can also use the DynamoDB console to verify that the new item is in your table by doing the following:

    1. Open the [Tables page](https://console.aws.amazon.com/dynamodbv2#tables "https://console.aws.amazon.com/dynamodbv2#tables") of the DynamoDB console and choose
...
1. Open the [APIs page](https://console.aws.amazon.com/apigateway/main/apis "https://console.aws.amazon.com/apigateway/main/apis") of the API Gateway console.
