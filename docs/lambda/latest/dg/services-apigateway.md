...
resource](../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md "../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md") catches all paths beneath a resource. The `ANY` method catches all HTTP
methods.

###### Sections

- [Choosing an API type](#services-apigateway-apitypes "#services-apigateway-apitypes")
- [Adding an endpoint to your Lambda function](#apigateway-add "#apigateway-add")
- [Proxy integration](#apigateway-proxy "#apigateway-proxy")
- [Event format](#apigateway-example-event "#apigateway-example-event")
- [Response format](#apigateway-types-transforms "#apigateway-types-transforms")
- [Permissions](#apigateway-permissions "#apigateway-permissions")
- [Sample application](#services-apigateway-samples "#services-apigateway-samples")
- [The event handler from Powertools for AWS Lambda](#services-apigateway-powertools "#services-apigateway-powertools")
- [Tutorial: Using Lambda with API Gateway](services-apigateway-tutorial.md "services-apigateway-tutorial.md")
- [Handling Lambda errors with an API Gateway API](services-apigateway-errors.md "services-apigateway-errors.md")
- [Select a method to invoke your Lambda function using an HTTP request](apig-http-invoke-decision.md "apig-http-invoke-decision.md")

## Choosing an API type

API Gateway supports three types of APIs that invoke Lambda functions:

- [HTTP API](../../../apigateway/latest/developerguide/http-api.md "../../../apigateway/latest/developerguide/http-api.md"): A lightweight, low-latency RESTful API.
- [REST API](../../../apigateway/latest/developerguide/apigateway-rest-api.md "../../../apigateway/latest/developerguide/apigateway-rest-api.md"): A customizable, feature-rich RESTful API.
- [WebSocket API](../../../apigateway/latest/developerguide/apigateway-websocket-api.md "../../../apigateway/latest/developerguide/apigateway-websocket-api.md"): A web API that maintains persistent connections
...
For a detailed comparison, see [Choose between HTTP APIs and REST APIs](../../../apigateway/latest/developerguide/http-api-vs-rest.md "../../../apigateway/latest/developerguide/http-api-vs-rest.md") in the _API Gateway Developer Guide_.
...
API, see [Create AWS Lambda proxy integrations for HTTP APIs in API Gateway](../../../apigateway/latest/developerguide/http-api-develop-integrations-lambda.md "../../../apigateway/latest/developerguide/http-api-develop-integrations-lambda.md").

For more information, see [Create AWS Lambda proxy integrations for HTTP APIs in API Gateway](../../../apigateway/latest/developerguide/http-api-develop-integrations-lambda.md "../../../apigateway/latest/developerguide/http-api-develop-integrations-lambda.md").
...
For more information, see [Lambda proxy integrations in API Gateway](../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md "../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md").

## Event format

Amazon API Gateway invokes your function [synchronously](invocation-sync.md "invocation-sync.md") with an event that contains
...
API, see [Input format of a Lambda function for proxy integration](../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md#api-gateway-simple-proxy-for-lambda-input-format "../../../apigateway/latest/developerguide/set-up-lambda-proxy-integrations.md#api-gateway-simple-proxy-for-lambda-input-format") in the _API Gateway Developer Guide_.
...
Amazon API Gateway gets permission to invoke your function from the function's [resource-based policy](access-control-resource-based.md "access-control-resource-based.md"). You can grant invoke permission to an
...
The [API Gateway with Node.js](https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/nodejs-apig "https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/nodejs-apig") sample app includes a function with an AWS SAM
...
in the _Powertools for AWS Lambda (Python) documentation_ and [Event Handler REST API](https://docs.powertools.aws.dev/lambda/typescript/latest/features/event-handler/rest/ "https://docs.powertools.aws.dev/lambda/typescript/latest/features/event-handler/rest/") in the _Powertools for AWS Lambda (TypeScript) documentation_.
