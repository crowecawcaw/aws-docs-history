...
- [Using the Manual runtime update mode](#runtime-management-rollback-manual "#runtime-management-rollback-manual")
- [Using published function versions](#runtime-management-rollback-published "#runtime-management-rollback-published")
  For more information, see [Introducing AWS Lambda
  runtime management controls](https://aws.amazon.com/blogs/compute/introducing-aws-lambda-runtime-management-controls/ "https://aws.amazon.com/blogs/compute/introducing-aws-lambda-runtime-management-controls/") on the AWS Compute Blog.
...
the **Manual** mode. For the [function version](configuration-versions.md "configuration-versions.md") you want to roll back, change the runtime version update mode to
**Manual** and specify the ARN of the previous runtime version. For more
information about finding the ARN of the previous runtime version, see [Identifying Lambda runtime version changes](runtime-management-identify.md "runtime-management-identify.md").
...
Published [function versions](configuration-versions.md "configuration-versions.md") are an
...
see [Understanding the shared responsibility model for Lambda runtime management](runtime-management-shared.md "runtime-management-shared.md").
