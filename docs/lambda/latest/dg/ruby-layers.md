...
- [Package your layer content](#ruby-layers-package "#ruby-layers-package")
- [Create the layer in Lambda](#publishing-layer "#publishing-layer")
- [Using gems from layers in a function](#ruby-layers-bundler-limitations "#ruby-layers-bundler-limitations")
- [Add the layer to your function](#ruby-layer-adding "#ruby-layer-adding")
- [Sample app](#ruby-layer-sample-app "#ruby-layer-sample-app")
...
You must require each gem individually in your function code. You can't use `bundler/setup` or `Bundler.require`. For more information, see [Using gems from layers in a function](#ruby-layers-bundler-limitations "#ruby-layers-bundler-limitations").
Many popular Ruby gems contain native extensions (C code) that must be compiled for the target platform. Popular gems with native extensions include [nokogiri](https://rubygems.org/gems/nokogiri/ "https://rubygems.org/gems/nokogiri/"), [pg](https://rubygems.org/gems/pg/ "https://rubygems.org/gems/pg/"), [mysql2](https://rubygems.org/gems/mysql2/ "https://rubygems.org/gems/mysql2/"), [sqlite3](https://rubygems.org/gems/sqlite3/ "https://rubygems.org/gems/sqlite3/"), and [ffi](https://rubygems.org/gems/ffi/ "https://rubygems.org/gems/ffi/"). These gems must be built in a Linux environment that is compatible with the Lambda runtime.
...
4. In your function, require and use the modules. You must require each gem individually in your function code. You can't use `bundler/setup` or `Bundler.require`. For more information, see [Using gems from layers in a function](#ruby-layers-bundler-limitations "#ruby-layers-bundler-limitations"). Example:
