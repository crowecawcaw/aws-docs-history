...
- [Subscribe](#telemetry-subscribe-api "#telemetry-subscribe-api")
...
- **Request body parameters**
  ...
  - **destination** – The configuration settings that define the
    ...
    - For more information, see [Specifying a destination protocol](telemetry-api.md#telemetry-api-destination "telemetry-api.md#telemetry-api-destination").
  ...
  - **buffering** – The configuration settings for event
    ...
    - For more information, see [Configuring memory usage and buffering](telemetry-api.md#telemetry-api-buffering "telemetry-api.md#telemetry-api-buffering").
