...
| [Amazon EventBridge (CloudWatch Events)](../../../eventbridge/latest/userguide/eb-what-is.md "../../../eventbridge/latest/userguide/eb-what-is.md")                                               | Event-driven; asynchronous invocation (event buses and schedules), synchronous or asynchronous invocation (pipes) |
