...
Amazon EFS for Lambda is available in all [commercial Regions](../../../general/latest/gr/glos-chap.md#region "../../../general/latest/gr/glos-chap.md#region") except Asia Pacific (New Zealand), Asia Pacific (Taipei), Asia Pacific (Malaysia), Mexico (Central), Asia Pacific (Thailand), and Canada West (Calgary).

###### Sections

- [Execution role and user permissions](#configuration-filesystem-permissions "#configuration-filesystem-permissions")
- [Configuring a file system and access point](#configuration-filesystem-setup "#configuration-filesystem-setup")
- [Connecting to a file system (console)](#configuration-filesystem-config "#configuration-filesystem-config")
