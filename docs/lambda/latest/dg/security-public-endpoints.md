...
[JSON Web Tokens](https://jwt.io/introduction/ "https://jwt.io/introduction/") (JWTs) to manage authentication and
...
You can
[implement JWTs with Amazon Cognito](../../../cognito/latest/developerguide/amazon-cognito-user-pools-using-tokens-with-identity-providers.md "../../../cognito/latest/developerguide/amazon-cognito-user-pools-using-tokens-with-identity-providers.md"), a user directory service that can handle registration, authentication,
account recovery, and other common account management operations.
[Amplify Framework](https://docs.amplify.aws/start/getting-started/auth/q/integration/react "https://docs.amplify.aws/start/getting-started/auth/q/integration/react")
provides libraries to simplify integrating this service into your frontend application. You can also
consider third-party partner services like [Auth0](https://auth0.com/ "https://auth0.com/").
...
[REST APIs](../../../apigateway/latest/developerguide/apigateway-rest-api.md "../../../apigateway/latest/developerguide/apigateway-rest-api.md")
and [HTTP APIs](../../../apigateway/latest/developerguide/http-api.md "../../../apigateway/latest/developerguide/http-api.md").
Both support [authorization using AWS Lambda](../../../apigateway/latest/developerguide/apigateway-use-lambda-authorizer.md "../../../apigateway/latest/developerguide/apigateway-use-lambda-authorizer.md"), IAM, or Amazon Cognito. When using IAM or Amazon Cognito, incoming requests are
...
against common risks, such as [denial-of-service](https://en.wikipedia.org/wiki/Denial-of-service_attack "https://en.wikipedia.org/wiki/Denial-of-service_attack") (DoS) attacks.
[Applying AWS WAF](../../../apigateway/latest/developerguide/apigateway-control-access-aws-waf.md "../../../apigateway/latest/developerguide/apigateway-control-access-aws-waf.md") to these APIs can help protect your application from SQL injection and cross-site
scripting (XSS) attacks. API Gateway also implements
[throttling](../../../apigateway/latest/developerguide/api-gateway-request-throttling.md "../../../apigateway/latest/developerguide/api-gateway-request-throttling.md") at the AWS account-level and per-client level when API keys are used.
...
![security ops figure 5](images/security-ops-figure-5.png)
...
2. A CloudFront distribution in front of the API endpoint with an appropriate
   [time-to-live](../../../AmazonCloudFront/latest/DeveloperGuide/Expiration.md "../../../AmazonCloudFront/latest/DeveloperGuide/Expiration.md") (TTL) configuration would absorb most of the traffic in a DoS attack, without
