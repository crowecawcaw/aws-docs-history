...
- [Benefits of event-driven architectures](#event-driven-benefits "#event-driven-benefits")
- [Trade-offs of event-driven architectures](#event-driven-tradeoffs "#event-driven-tradeoffs")
- [Anti-patterns in Lambda-based event-driven applications](#event-driven-anti-patterns "#event-driven-anti-patterns")
...
[eventually consistent](https://en.wikipedia.org/wiki/Eventual_consistency "https://en.wikipedia.org/wiki/Eventual_consistency"). This makes it more
...
- You can use Amazon RDS for features needing [ACID properties](https://en.wikipedia.org/wiki/ACID "https://en.wikipedia.org/wiki/ACID"),
  ...
  [Amazon RDS Proxy](https://aws.amazon.com/rds/proxy/ "https://aws.amazon.com/rds/proxy/") can help manage connection pooling
...
Most Lambda invocations in production systems are [asynchronous](invocation-async.md "invocation-async.md"),
...
[dead letter queues](invocation-async.md "invocation-async.md")
...
You can use [recursive loop detection](invocation-recursion.md "invocation-recursion.md") to find and avoid this anti-pattern.
...
- **Cost** – With Lambda, you pay for the duration of an invocation.
  In this example, while the _Create invoice_ functions runs, two other functions
...
- **Tight coupling** – Processing a payment typically takes longer
  ...
  slowest function.
- **Scaling** – The [concurrency](lambda-concurrency.md "lambda-concurrency.md")
