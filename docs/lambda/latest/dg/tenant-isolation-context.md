...
- [Accessing the tenant identifier](#tenant-isolation-context-access "#tenant-isolation-context-access")
- [Common usage patterns](#tenant-isolation-context-patterns "#tenant-isolation-context-patterns")
- [Monitoring and debugging](#tenant-isolation-context-monitoring "#tenant-isolation-context-monitoring")

## Accessing the tenant identifier

The tenant identifier is available through the `tenantId` property of the context object.
Note that this property is available during the [invocation phase](lambda-runtime-environment.md#runtimes-lifecycle-invoke "lambda-runtime-environment.md#runtimes-lifecycle-invoke"),
not during the [initialization phase](lambda-runtime-environment.md#runtimes-lifecycle-ib "lambda-runtime-environment.md#runtimes-lifecycle-ib").
...
[JSON logging enabled](monitoring-cloudwatchlogs-logformat.md "monitoring-cloudwatchlogs-logformat.md"),
