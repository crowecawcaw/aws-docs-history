...
To run a batch operation, you create an Amazon S3 [batch operations job](../../../AmazonS3/latest/dev/batch-ops-operations.md "../../../AmazonS3/latest/dev/batch-ops-operations.md"). When you create
the job, you provide a manifest (the list of objects) and configure the action to perform on those objects.

When the batch job starts, Amazon S3 invokes the Lambda function [synchronously](invocation-sync.md "invocation-sync.md") for each object in the manifest.
...
In the [resource-based policy](access-control-resource-based.md "access-control-resource-based.md") that you create for the Amazon S3
...
function](../../../AmazonS3/latest/userguide/batch-ops-iam-role-policies.md "../../../AmazonS3/latest/userguide/batch-ops-iam-role-policies.md").
...
the [concurrency limit](lambda-concurrency.md "lambda-concurrency.md") of the function. Amazon S3 limits the initial ramp-up of instances
...
For more information about Amazon S3 batch operations, see [Performing batch operations](../../../AmazonS3/latest/dev/batch-ops.md "../../../AmazonS3/latest/dev/batch-ops.md") in the
...
batch operations](../../../AmazonS3/latest/dev/batch-ops-invoke-lambda.md "../../../AmazonS3/latest/dev/batch-ops-invoke-lambda.md") in the _Amazon S3 Developer Guide_.
