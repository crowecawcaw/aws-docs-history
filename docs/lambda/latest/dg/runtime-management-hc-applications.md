...
updates. If your application is subject to strict patching freshness requirements, you might
...
This operation is used to choose the runtime update mode for a function.
