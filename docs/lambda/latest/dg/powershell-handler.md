...
statement in PowerShell, see [About requires](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_requires?view=powershell-6 "https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_requires?view=powershell-6"). For more information about PowerShell deployment packages, see [Deploy PowerShell Lambda functions with .zip file archives](powershell-package.md "powershell-package.md").
...
older version, you'll experience longer cold starts. For more information, see [AWS Tools for PowerShell](https://aws.amazon.com/powershell/?track=sdk "https://aws.amazon.com/powershell/?track=sdk").
