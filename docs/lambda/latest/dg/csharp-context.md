...
When Lambda runs your function, it passes a context object to the [handler](csharp-handler.md "csharp-handler.md").
...
- `Logger` The [logger object](csharp-logging.md "csharp-logging.md") for the function.
