...
For more information, see [Using Lambda with infrastructure as code (IaC)](foundation-iac.md "foundation-iac.md").
...
For more information, see [Powertools for AWS Lambda](powertools-for-lambda.md "powertools-for-lambda.md").
