...
We don't recommend using [layers](chapter-layers.md "chapter-layers.md") to manage dependencies for Lambda functions written in Rust.
...
AWS SDK for Rust in your function, see [Define Lambda function handlers in Rust](rust-handler.md "rust-handler.md").
