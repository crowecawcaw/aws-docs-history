...
Creating a layer for dependencies requires build changes to generate the layer archive before deployment. For a working example, see the [blank-ruby](https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-ruby) sample application.