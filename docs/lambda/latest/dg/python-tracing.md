...
- [AWS X-Ray SDK for Python](../../../xray/latest/devguide/xray-sdk-python.md "../../../xray/latest/devguide/xray-sdk-python.md") – An SDK
  for generating and sending trace data to X-Ray.
- [Powertools for AWS Lambda (Python)](../../../powertools/python/latest.md "../../../powertools/python/latest.md") – A developer toolkit to implement Serverless
...
- [Using Powertools for AWS Lambda (Python) and AWS SAM for tracing](#python-tracing-sam "#python-tracing-sam")
- [Using Powertools for AWS Lambda (Python) and the AWS CDK for tracing](#python-logging-cdk "#python-logging-cdk")
- [Using ADOT to instrument your Python functions](#python-adot "#python-adot")
- [Using the X-Ray SDK to instrument your Python functions](#python-xray-sdk "#python-xray-sdk")
- [Activating tracing with the Lambda console](#python-tracing-console "#python-tracing-console")
- [Activating tracing with the Lambda API](#python-tracing-api "#python-tracing-api")
- [Activating tracing with AWS CloudFormation](#python-tracing-cloudformation "#python-tracing-cloudformation")
- [Interpreting an X-Ray trace](#python-tracing-interpretation "#python-tracing-interpretation")
- [Storing runtime dependencies in a layer (X-Ray SDK)](#python-tracing-layers "#python-tracing-layers")
...
11. To get the traces for the function, run [sam traces](../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-traces.md "../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-traces.md").
...
To record details about calls that your Lambda function makes to other resources in your application, you can
also use the AWS X-Ray SDK for Python. To get the SDK, add the `aws-xray-sdk` package to your application's
dependencies.

###### Example [requirements.txt](https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-python/function/requirements.txt "https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-python/function/requirements.txt")
...
with annotations and metadata. For more information, see the [AWS X-Ray SDK for Python](../../../xray/latest/devguide/xray-sdk-python.md "../../../xray/latest/devguide/xray-sdk-python.md") in the
...
For a working example, see the [blank-python](https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-python "https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-python") sample
application.
