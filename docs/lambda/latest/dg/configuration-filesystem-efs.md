...
You can configure a function to mount an Amazon Elastic File System (Amazon EFS) file system to a local directory. Amazon EFS is a serverless
file system that scales automatically with your workloads. With Amazon EFS, your function code can access and modify shared
resources safely and at high concurrency.

###### Sections

- [Execution role and user permissions](#configuration-filesystem-efs-permissions "#configuration-filesystem-efs-permissions")
- [Configuring a file system and access point](#configuration-filesystem-efs-setup "#configuration-filesystem-efs-setup")
- [Connecting to a file system (console)](#configuration-filesystem-efs-config "#configuration-filesystem-efs-config")
- [Supported Regions](#configuration-filesystem-efs-regions "#configuration-filesystem-efs-regions")
...
performance](../../../efs/latest/ug/performance.md "../../../efs/latest/ug/performance.md") in the _Amazon Elastic File System User Guide_.
...
- [Creating resources for Amazon EFS](../../../efs/latest/ug/creating-using.md "../../../efs/latest/ug/creating-using.md")
- [Working with users, groups, and
  permissions](../../../efs/latest/ug/accessing-fs-nfs-permissions.md "../../../efs/latest/ug/accessing-fs-nfs-permissions.md")
...
Amazon EFS charges for storage and throughput, with rates that vary by storage class. For details, see [Amazon EFS pricing](https://aws.amazon.com/efs/pricing "https://aws.amazon.com/efs/pricing").
...
details, see [Lambda pricing](https://aws.amazon.com/lambda/pricing "https://aws.amazon.com/lambda/pricing").

## Supported Regions

Amazon EFS for Lambda is available in all [commercial Regions](../../../general/latest/gr/glos-chap.md#region "../../../general/latest/gr/glos-chap.md#region") except Asia Pacific (New Zealand), Asia Pacific (Taipei), Asia Pacific (Malaysia), Asia Pacific (Thailand), and Canada West (Calgary).
