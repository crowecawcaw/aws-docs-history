...
+ Permissions that other AWS users and entities need to access your Lambda functions. For more information, see [Granting other AWS entities access to your Lambda functions](permissions-granting-access.md).
