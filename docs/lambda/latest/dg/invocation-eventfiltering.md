...
- Amazon Simple Queue Service (Amazon SQS)
  ...
  [Using filters with different AWS services](#filtering-by-service "#filtering-by-service"). Lambda doesn't support event filtering for Amazon DocumentDB.
...
- [Understanding event filtering basics](#filtering-basics "#filtering-basics")
- [Handling records that don't meet filter criteria](#filtering-criteria-not-met "#filtering-criteria-not-met")
- [Filter rule syntax](#filtering-syntax "#filtering-syntax")
- [Attaching filter criteria to an event source mapping (console)](#filtering-console "#filtering-console")
- [Attaching filter criteria to an event source mapping (AWS CLI)](#filtering-cli "#filtering-cli")
- [Attaching filter criteria to an event source mapping (AWS SAM)](#filtering-sam "#filtering-sam")
- [Encryption of filter criteria](#filter-criteria-encryption "#filter-criteria-encryption")
- [Using filters with different AWS services](#filtering-by-service "#filtering-by-service")
...
- For **Kinesis** and **DynamoDB**, after
  ...
  records. If you want records to be deleted sooner, see [Changing the Data Retention Period](../../../streams/latest/dev/kinesis-extended-retention.md "../../../streams/latest/dev/kinesis-extended-retention.md").
...
information, see [Amazon EventBridge event patterns](../../../eventbridge/latest/userguide/eb-event-patterns.md "../../../eventbridge/latest/userguide/eb-event-patterns.md") in the _Amazon EventBridge User Guide_.
...
allowed amount. 7. When you have finished adding your filters, choose **Save**.
...
the console, see [Using filters with different AWS services](#filtering-by-service "#filtering-by-service").
...
This [create-event-source-mapping](../../../cli/latest/reference/lambda/create-event-source-mapping.md "../../../cli/latest/reference/lambda/create-event-source-mapping.md") command creates a new Amazon SQS event source mapping for function
...
[list-event-source-mappings](../../../cli/latest/reference/lambda/list-event-source-mappings.md "../../../cli/latest/reference/lambda/list-event-source-mappings.md") call. Lambda also returns the UUID in the
[create-event-source-mapping](../../../cli/latest/reference/lambda/create-event-source-mapping.md "../../../cli/latest/reference/lambda/create-event-source-mapping.md") CLI response.

To remove filter criteria from an event source, you can run the following
[update-event-source-mapping](../../../cli/latest/reference/lambda/update-event-source-mapping.md "../../../cli/latest/reference/lambda/update-event-source-mapping.md") command with an empty `FilterCriteria` object.
...
the [EventSource](../../../serverless-application-model/latest/developerguide/sam-property-function-eventsource.md "../../../serverless-application-model/latest/developerguide/sam-property-function-eventsource.md") section of the AWS SAM Developer Guide. Fore more examples of creating event filters
using AWS SAM templates, see [Using filters with different AWS services](#filtering-by-service "#filtering-by-service").
...
using a [GetEventSourceMapping](../api/API_GetEventSourceMapping.md "../api/API_GetEventSourceMapping.md") API call. You must have `kms:Decrypt`
...
`FilterCriteria` field in the response of [ListEventSourceMappings](../api/API_ListEventSourceMappings.md "../api/API_ListEventSourceMappings.md")
calls. Instead, this field displays as `null`. To see the true value
of `FilterCriteria`, use the [GetEventSourceMapping](../api/API_GetEventSourceMapping.md "../api/API_GetEventSourceMapping.md") API.
...
2. Choose **Add trigger**. If you already have an existing trigger,
   choose the **Configuration** tab, and then choose **Triggers**. Select the existing trigger, and choose **Edit**.
...
[key policy](../../../kms/latest/developerguide/key-policies.md "../../../kms/latest/developerguide/key-policies.md"):
...
- `kms:Decrypt` – Must be granted to the regional Lambda service
  ...
  - To prevent a
    ...
    in the [encryption context](../../../kms/latest/developerguide/concepts.md#encrypt_context "../../../kms/latest/developerguide/concepts.md#encrypt_context")
...
- `kms:Decrypt` – Must also be granted to the principal that
  ...
  [GetEventSourceMapping](../api/API_GetEventSourceMapping.md "../api/API_GetEventSourceMapping.md") or [DeleteEventSourceMapping](../api/API_DeleteEventSourceMapping.md "../api/API_DeleteEventSourceMapping.md") API calls.
...
CloudTrail events, see [Monitoring your encryption keys for Lambda](security-encryption-at-rest.md#encryption-key-monitoring "security-encryption-at-rest.md#encryption-key-monitoring").

We also recommend using the [`kms:ViaService`](../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-via-service "../../../kms/latest/developerguide/conditions-kms.md#conditions-kms-via-service") condition key to limit the use of the KMS
...
following [CreateEventSourceMapping](../api/API_CreateEventSourceMapping.md "../api/API_CreateEventSourceMapping.md") AWS CLI command. Specify the KMS key ARN
...
If you have an existing event source mapping, use the [UpdateEventSourceMapping](../api/API_UpdateEventSourceMapping.md "../api/API_UpdateEventSourceMapping.md")
...
[GetEventSourceMapping](../api/API_GetEventSourceMapping.md "../api/API_GetEventSourceMapping.md") or [DeleteEventSourceMapping](../api/API_DeleteEventSourceMapping.md "../api/API_DeleteEventSourceMapping.md") API call,
you must have `kms:Decrypt` permissions.

Starting August 6, 2024, the `FilterCriteria` field no longer shows up in
AWS CloudTrail logs from [CreateEventSourceMapping](../api/API_CreateEventSourceMapping.md "../api/API_CreateEventSourceMapping.md"), [UpdateEventSourceMapping](../api/API_UpdateEventSourceMapping.md "../api/API_UpdateEventSourceMapping.md"), and
[DeleteEventSourceMapping](../api/API_DeleteEventSourceMapping.md "../api/API_DeleteEventSourceMapping.md") API calls if your function doesn't use event filtering.
...
the response of [GetEventSourceMapping](../api/API_GetEventSourceMapping.md "../api/API_GetEventSourceMapping.md") API calls if you have
...
- [Using event filtering with a Kinesis event source](with-kinesis-filtering.md "with-kinesis-filtering.md")
- [Filter events from an Amazon MQ event source](with-mq-filtering.md "with-mq-filtering.md")
