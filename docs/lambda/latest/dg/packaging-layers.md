...
[Amazon Linux](../../../linux/al2023/ug/what-is-amazon-linux.md "../../../linux/al2023/ug/what-is-amazon-linux.md"), your layer content must be able to compile and build in a Linux environment.
...
- [Layer paths for each Lambda runtime](#packaging-layers-paths "#packaging-layers-paths")
