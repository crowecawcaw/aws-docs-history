...
- [Package your layer content](#python-layers-package "#python-layers-package")
- [Create the layer in Lambda](#publishing-layer "#publishing-layer")
- [Add the layer to your function](#python-layer-adding "#python-layer-adding")
- [Sample app](#python-layer-sample-app "#python-layer-sample-app")
...
For more information about working with Python packages that contain compiled components, see [Creating .zip deployment packages with native libraries](python-package.md#python-package-native-libraries "python-package.md#python-package-native-libraries").
...
For more information about working with Python packages that contain compiled components, see [Creating .zip deployment packages with native libraries](python-package.md#python-package-native-libraries "python-package.md#python-package-native-libraries"). 2. Zip the contents of the `python` directory.
