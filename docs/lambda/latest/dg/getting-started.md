...
your function using the Lambda _event object_. You'll also learn how to return log outputs from your function, and how to
...
[Additional resources and next steps](#getting-started-more-resources "#getting-started-more-resources") section.
...
than one Node.js function, but the _handler_ function is always the entry point to your code. When your function is
...
The function `handler` takes two arguments, `event` and `context`. An _event_ in Lambda is a JSON formatted document that contains data for your function to process.
...
The second argument that your function takes is `context`. Lambda passes the _context object_ to your
...
To learn more about the Lambda context object in Node.js, see [Using the Lambda context object to retrieve Node.js function information](nodejs-context.md "nodejs-context.md").
...
To learn more, see [Log and monitor Node.js Lambda functions](nodejs-logging.md "nodejs-logging.md"). To learn about logging in other runtimes, see the 'Building with' pages
...
than one Python function, but the _handler_ function is always the entry point to your code. When your function is
invoked, Lambda runs this method.
...
The function `lambda_handler` takes two arguments, `event` and `context`. An _event_
...
To learn more about the Lambda context object in Python, see [Using the Lambda context object to retrieve Python function information](python-context.md "python-context.md").
...
To learn more, see [Log and monitor Python Lambda functions](python-logging.md "python-logging.md"). To learn about logging in other runtimes, see the
...
- Choose one of the following tutorials for more complex examples of using Lambda with other AWS services.
  ...
  - [Using a Lambda function to
    access an Amazon RDS database](../../../AmazonRDS/latest/UserGuide/rds-lambda-tutorial.md "../../../AmazonRDS/latest/UserGuide/rds-lambda-tutorial.md"): Use a Lambda function to write data to an Amazon Relational Database Service (Amazon RDS) database through RDS Proxy.
  - [Using an Amazon S3 trigger to create thumbnail images](with-s3-tutorial.md "with-s3-tutorial.md"): Use a Lambda function to create a thumbnail every time an image file is uploaded to
    an Amazon S3 bucket.
