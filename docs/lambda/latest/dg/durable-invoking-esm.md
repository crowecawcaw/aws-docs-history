...
For complete information about event source mapping error handling, see [event source mappings](invocation-eventsourcemapping.md "invocation-eventsourcemapping.md").
...
For idempotency in the intermediary function itself, use [Powertools for AWS Lambda](../../../powertools.md "../../../powertools.md") to prevent duplicate invocations of the durable function if the event source mapping retries the intermediary function.
