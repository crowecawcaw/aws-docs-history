...
1. Open the [Metrics page](<https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#metricsV2:graph=~();namespace=~'AWS*2fLambda> "https://console.aws.amazon.com/cloudwatch/home?region=us-east-1#metricsV2:graph=~();namespace=~'AWS*2fLambda")
...
2. On the **Browse** tab, under **Metrics**, choose
   ...
   - **By Executed Version** (`ExecutedVersion`) – View metrics for a
     ...
     alias](configuration-aliases.md "configuration-aliases.md").
...
3. Choose a metric. The metric should automatically appear in the visual graph, as well as
...
For more information about CloudWatch, see the [Amazon CloudWatch User Guide](../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md "../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md").
