...
- [Creating a function that returns logs](#golang-logging-output "#golang-logging-output")
- [Viewing logs in the Lambda console](#golang-logging-console "#golang-logging-console")
- [Viewing logs in the CloudWatch console](#golang-logging-cwconsole "#golang-logging-cwconsole")
- [Viewing logs using the AWS Command Line Interface (AWS CLI)](#golang-logging-cli "#golang-logging-cli")
- [Deleting logs](#golang-logging-delete "#golang-logging-delete")

## Creating a function that returns logs

To output logs from your function code, you can use methods on [the fmt
package](https://golang.org/pkg/fmt/ "https://golang.org/pkg/fmt/"), or any logging library that writes to `stdout` or `stderr`. The following
example uses [the log package](https://golang.org/pkg/log/ "https://golang.org/pkg/log/").

###### Example [main.go](https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-go/function/main.go "https://github.com/awsdocs/aws-lambda-developer-guide/tree/main/sample-apps/blank-go/function/main.go") – Logging
...
The Go runtime logs the `START`, `END`, and `REPORT` lines for each invocation.
