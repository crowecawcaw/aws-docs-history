...
- [Creating a .zip file on macOS and Linux](#golang-package-mac-linux "#golang-package-mac-linux")
- [Creating a .zip file on Windows](#golang-package-windows "#golang-package-windows")
- [Creating and updating Go Lambda functions using .zip files](#golang-package-create-function "#golang-package-create-function")
...
Before compiling your code, make sure you have installed the [lambda](https://github.com/aws/aws-lambda-go/tree/master/lambda "https://github.com/aws/aws-lambda-go/tree/master/lambda")
...
This command creates a stable binary package for standard C library (`libc`) versions, which may be different on Lambda and other devices. 3. Create a deployment package by packaging the executable in a .zip file.
...
The `bootstrap` file must be at the root of the .zip file. 4. Create the function. Note the following:
...
The following steps show how to download the [build-lambda-zip](https://github.com/aws/aws-lambda-go/tree/main/cmd/build-lambda-zip "https://github.com/aws/aws-lambda-go/tree/main/cmd/build-lambda-zip")
tool for Windows from GitHub, compile your executable, and create a .zip deployment package.

###### Note

If you have not already done so, you must install [git](https://git-scm.com/ "https://git-scm.com/") and then add the `git` executable to your Windows `%PATH%` environment variable.
...
2. Use the [sam build](../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-build.md "../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-build.md") command to compile the executable.
