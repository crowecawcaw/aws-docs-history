...
application. For more information, see [Tracing event-driven applications](../../../xray/latest/devguide/xray-tracelinking.md "../../../xray/latest/devguide/xray-tracelinking.md")
...
For more information about Lambda execution environment phases, see [Understanding the Lambda execution environment lifecycle](lambda-runtime-environment.md "lambda-runtime-environment.md").
...
- [Instrumenting C# code in AWS Lambda](csharp-tracing.md "csharp-tracing.md")

For a full list of services that support active instrumentation, see [Supported AWS services](../../../xray/latest/devguide/xray-usage.md#xray-usage-codechanges "../../../xray/latest/devguide/xray-usage.md#xray-usage-codechanges") in the
...
Lambda needs the following permissions to send trace data to X-Ray. Add them to your function's [execution role](lambda-intro-execution-role.md "lambda-intro-execution-role.md").

- [xray:PutTraceSegments](../../../xray/latest/api/API_PutTraceSegments.md "../../../xray/latest/api/API_PutTraceSegments.md")
- [xray:PutTelemetryRecords](../../../xray/latest/api/API_PutTelemetryRecords.md "../../../xray/latest/api/API_PutTelemetryRecords.md")

These permissions are included in the [AWSXRayDaemonWriteAccess](https://console.aws.amazon.com/iam/home?#/policies/arn:aws:iam::aws:policy/AWSXRayDaemonWriteAccess "https://console.aws.amazon.com/iam/home?#/policies/arn:aws:iam::aws:policy/AWSXRayDaemonWriteAccess") managed policy.
