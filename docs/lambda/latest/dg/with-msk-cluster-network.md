...
and the [Amazon Virtual Private Cloud (VPC)](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md")
it resides in. This page describes how to configure your cluster and VPC. If your cluster and VPC are
already configured properly, see [Configuring Amazon MSK event sources for Lambda](with-msk-configure.md "with-msk-configure.md") to configure the event source mapping.
...
The [event source mapping](invocation-eventsourcemapping.md "invocation-eventsourcemapping.md") is the intermediary
...
[hyperplane ENI](configuration-vpc.md#configuration-vpc-enis "configuration-vpc.md#configuration-vpc-enis") (or reuses an existing one, if available) in
...
- In on-demand mode, your Lambda event source mapping invokes your function via a path through your
  ...
  subnet of the VPC that provide access to Lambda, [AWS Security Token Service (STS)](../../../STS/latest/APIReference/welcome.md "../../../STS/latest/APIReference/welcome.md"), and optionally,
