...
For detailed information about Lambda security features, see [Security in AWS Lambda](lambda-security.md "lambda-security.md") in the Lambda Developer Guide. The only additional security considerations for durable functions are the checkpoint permissions documented in this guide.
