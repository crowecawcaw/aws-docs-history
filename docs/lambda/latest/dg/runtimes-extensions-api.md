...
observability, security, and governance. Function authors can use extensions from AWS, [AWS Partners](extensions-api-partners.md "extensions-api-partners.md"), and
...
the [Runtime Logs API](runtimes-logs-api.md "runtimes-logs-api.md") to receive a stream of logs.
...
Lambda also supports _internal extensions_. An internal extension runs as a separate thread in
...
use language-specific [environment variables and wrapper scripts](runtimes-modify.md "runtimes-modify.md"). You can use
these to configure the runtime environment and modify the startup behavior of the runtime process.

You can add extensions to a function in two ways. For a function deployed as a [.zip file archive](configuration-function-zip.md "configuration-function-zip.md"), you deploy your extension as a [layer](chapter-layers.md "chapter-layers.md"). For a function defined as a container image, you add [the extensions](extensions-configuration.md#invocation-extensions-images "extensions-configuration.md#invocation-extensions-images") to your container image.

###### Note

For example extensions and wrapper scripts, see [AWS Lambda Extensions](https://github.com/aws-samples/aws-lambda-extensions "https://github.com/aws-samples/aws-lambda-extensions") on
...
function metrics, see [Using CloudWatch metrics with Lambda](monitoring-metrics.md "monitoring-metrics.md").
...
function's [environment variables](configuration-envvars.md "configuration-envvars.md"), except for
...
The OpenAPI specification for the extensions API version **2020-01-01** is available here: [extensions-api.zip](samples/extensions-api.zip.md "samples/extensions-api.zip.md")
...
- [Register](#extensions-registration-api-a "#extensions-registration-api-a")
- [Next](#extensions-api-next "#extensions-api-next")
- [Init error](#runtimes-extensions-init-error "#runtimes-extensions-init-error")
- [Exit error](#runtimes-extensions-exit-error "#runtimes-extensions-exit-error")
