...
For a detailed explanation of how checkpointing works and replay behavior, see [Key concepts](../../../durable-execution/getting-started/key-concepts.md "../../../durable-execution/getting-started/key-concepts.md") in the AWS Durable Execution SDK Developer Guide.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| **[Step](../../../durable-execution/sdk-reference/operations/step.md "../../../durable-execution/sdk-reference/operations/step.md")**                                           | Execute and checkpoint a unit of work with configurable retry strategies and execution semantics. |
| **[Wait](../../../durable-execution/sdk-reference/operations/wait.md "../../../durable-execution/sdk-reference/operations/wait.md")**                                           | Pause execution for a specified duration without consuming compute resources.                     |
| **[Wait for Condition](../../../durable-execution/sdk-reference/operations/wait-for-condition.md "../../../durable-execution/sdk-reference/operations/wait-for-condition.md")** | Poll for a condition with automatic checkpointing between attempts.                               |
| **[Callback](../../../durable-execution/sdk-reference/operations/callback.md "../../../durable-execution/sdk-reference/operations/callback.md")**                               | Pause execution and wait for an external system to provide input through the Lambda API.          |
| **[Invoke](../../../durable-execution/sdk-reference/operations/invoke.md "../../../durable-execution/sdk-reference/operations/invoke.md")**                                     | Call another Lambda function and wait for its result, with automatic checkpointing.               |
| **[Parallel](../../../durable-execution/sdk-reference/operations/parallel.md "../../../durable-execution/sdk-reference/operations/parallel.md")**                               | Execute multiple operations concurrently with configurable completion policies.                   |
| **[Map](../../../durable-execution/sdk-reference/operations/map.md "../../../durable-execution/sdk-reference/operations/map.md")**                                              | Process each item in a collection concurrently with optional concurrency control.                 |
| **[Child Context](../../../durable-execution/sdk-reference/operations/child-context.md "../../../durable-execution/sdk-reference/operations/child-context.md")**                | Create an isolated execution context for grouping multiple operations.                            |

Each durable operation creates checkpoints automatically, ensuring your function can resume from any point. For detailed API reference, code examples, and language-specific usage, see [SDK Reference](../../../durable-execution/sdk-reference.md "../../../durable-execution/sdk-reference.md") in the AWS Durable Execution SDK Developer Guide.

## How durable operations are metered

Each durable operation you call through `DurableContext` creates checkpoints to track execution progress and store state data. These operations incur charges based on their usage, and the checkpoints may contain data that contributes to your data write and retention costs. Stored data includes invocation event data, payloads returned from steps, and data passed when completing callbacks. Understanding how durable operations are metered helps you estimate execution costs and optimize your workflows. For details on pricing, see the [Lambda pricing page](https://aws.amazon.com/lambda/pricing/ "https://aws.amazon.com/lambda/pricing/").
