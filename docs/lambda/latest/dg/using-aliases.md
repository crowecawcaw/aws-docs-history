...
[How Lambda processes records from stream and queue-based event sources](invocation-eventsourcemapping.md "invocation-eventsourcemapping.md").
...
For more information about using resource names in policies, see [Fine-tuning the Resources and Conditions sections of policies](lambda-api-permissions-ref.md "lambda-api-permissions-ref.md").
