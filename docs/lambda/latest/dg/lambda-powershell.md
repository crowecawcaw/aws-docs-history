...
For information about the PowerShell context object, see [Using the Lambda context object to retrieve PowerShell function information](powershell-context.md).
