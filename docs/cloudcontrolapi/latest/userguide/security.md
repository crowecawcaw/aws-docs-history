 ...
 *AWS CloudFormation User Guide*. You can also learn how to use other AWS services that
...
To see a list of Cloud Control API actions, see [Actions, resources, and condition keys for
 AWS Cloud Control API](https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscloudcontrolapi.html "https://docs.aws.amazon.com/service-authorization/latest/reference/list_awscloudcontrolapi.html") in the *Service Authorization Reference*.
