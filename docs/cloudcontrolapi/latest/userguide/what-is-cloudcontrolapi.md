...
Similar to Cloud Control API, AWS CloudFormation also uses resource types to call underlying web services
 ...
 dependencies, and then provision those resources as a *stack*. A stack is a
 ...
 see the *[AWS CloudFormation User Guide](../../../AWSCloudFormation/latest/UserGuide/Welcome.md "../../../AWSCloudFormation/latest/UserGuide/Welcome.md")*.
