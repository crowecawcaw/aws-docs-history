...
* Optionally, it may include the *part or all* resource's properties, detailing the current
...
| [`AWS::Glue::Attach::SchemaVersion`](../../../AWSCloudFormation/latest/UserGuide/aws-resource-glue-schemaversion.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-glue-schemaversion.md") | <br>• `SchemaDefinition`, `Schema/RegistryName`, and `Schema/SchemaName` <br>• `SchemaDefinition` and `Schema/SchemaArn` |
...
| [`AWS::IoTSiteWise::AccessPolicy`](../../../AWSCloudFormation/latest/UserGuide/aws-resource-iotsitewise-accesspolicy.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-iotsitewise-accesspolicy.md") | <br>• /`AccessPolicyResource`/`Portal` <br>• /`AccessPolicyResource`/`Project` |
...
| [`AWS::NetworkFirewall::LoggingConfiguration`](../../../AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-loggingconfiguration.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-networkfirewall-loggingconfiguration.md") | <br>• `FirewallArn` <br>• `FirewallName` |
...
| [`AWS::SSO::Assignment`](../../../AWSCloudFormation/latest/UserGuide/aws-resource-sso-assignment.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-sso-assignment.md") | `InstanceArn`, `PermissionSetArn`, `PrincipalId`, `PrincipalType`, `TargetId`, and `TargetType` |
