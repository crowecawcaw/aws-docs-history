...
finding a resource's identifier, see [Using a resource's primary identifier](resource-identifier.md#resource-identifier-using "resource-identifier.md#resource-identifier-using").
