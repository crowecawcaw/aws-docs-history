...
Amazon has published several hundred resource types representing offerings across AWS
 ...
 CLI](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html "https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/what-is-cloudformation-cli.html") open-source tool is automatically supported by Cloud Control API.

Each resource type is defined by its *resource type schema*. This
