...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS End User Messaging Push. The following topics show you how to configure AWS End User Messaging Push to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS End User Messaging Push resources.

###### Topics

- [Data protection in AWS End User Messaging Push](data-protection.md "data-protection.md")
- [Identity and access management for AWS End User Messaging Push](security-iam.md "security-iam.md")
- [Compliance validation for AWS End User Messaging Push](compliance-validation.md "compliance-validation.md")
- [Resilience in AWS End User Messaging Push](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure Security in AWS End User Messaging Push](infrastructure-security.md "infrastructure-security.md")
- [Configuration and vulnerability analysis](vulnerability-analysis-management.md "vulnerability-analysis-management.md")
