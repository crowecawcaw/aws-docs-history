...
To view examples of AWS End User Messaging Push identity-based policies, see [Identity-based policy examples for AWS End User Messaging Push](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
