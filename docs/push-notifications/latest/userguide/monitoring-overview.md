...
performance of AWS End User Messaging Push and your other AWS solutions. AWS provides the following monitoring
tools to watch AWS End User Messaging Push, report when something is wrong, and take automatic actions when
appropriate:
