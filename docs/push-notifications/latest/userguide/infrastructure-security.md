...
As a managed service, AWS End User Messaging Push is protected by the AWS global network security
...
You use AWS published API calls to access AWS End User Messaging Push through the network. Clients must
