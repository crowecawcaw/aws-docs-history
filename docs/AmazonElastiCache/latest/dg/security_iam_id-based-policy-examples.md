...
For details about actions and resource types defined by ElastiCache, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for Amazon ElastiCache](../../../service-authorization/latest/reference/list_amazonelasticache.md "../../../service-authorization/latest/reference/list_amazonelasticache.md") in the _Service Authorization Reference_.
