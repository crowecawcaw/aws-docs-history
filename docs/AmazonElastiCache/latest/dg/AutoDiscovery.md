...
- [Benefits of Auto Discovery with Memcached](AutoDiscovery.Benefits.md "AutoDiscovery.Benefits.md")
- [How Auto Discovery Works](AutoDiscovery.HowAutoDiscoveryWorks.md "AutoDiscovery.HowAutoDiscoveryWorks.md")
- [Using Auto Discovery](AutoDiscovery.Using.md "AutoDiscovery.Using.md")
- [Connecting to Memcached Cache Nodes Manually](AutoDiscovery.Manual.md "AutoDiscovery.Manual.md")
- [Adding Auto Discovery to your Memcached client library](AutoDiscovery.AddingToYourClientLibrary.md "AutoDiscovery.AddingToYourClientLibrary.md")
