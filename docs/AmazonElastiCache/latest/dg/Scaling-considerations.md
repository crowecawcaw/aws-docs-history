...
utilization related to enhanced I/O features. For [supported node types](CacheNodes.SupportedTypes.md#CacheNodes.CurrentGen "CacheNodes.SupportedTypes.md#CacheNodes.CurrentGen"), ElastiCache offloads
