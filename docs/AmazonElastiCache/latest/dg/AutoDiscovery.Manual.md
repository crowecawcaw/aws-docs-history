...
You can obtain a list of cache node hostnames and port numbers from the [AWS Management Console](https://aws.amazon.com/console/ "https://aws.amazon.com/console/"). You can also
