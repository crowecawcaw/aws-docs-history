...
![Image: Diagram showing application and ElastiCache in same VPC](images/ElastiCache-inVPC-AccessedByEC2-SameVPC.png)
...
The default port for Valkey and Redis OSS caches is `6379`. 2. Create a VPC security group for your EC2 instances (web and application servers).
This security group can, if needed, allow access to the EC2 instance from the Internet via the VPC's routing table.
For example, you can set rules on this security group to allow TCP access to the EC2 instance over port 22. 3. Create custom rules in the security group for your cache that allow connections
...
4. From **Type** choose **Custom TCP Rule**.
   ...
   The default port for Valkey and Redis OSS caches and replication groups is `6379`. 2. In the **Source** box, start typing the ID of the security group.
...
- [In Different Amazon VPCs in the Same Region](#elasticache-vpc-accessing-different-vpc-same-region "#elasticache-vpc-accessing-different-vpc-same-region")
- [In Different Amazon VPCs in Different Regions](#elasticache-vpc-accessing-different-vpc-different-region "#elasticache-vpc-accessing-different-vpc-different-region")
...
![Image: Diagram showing application and ElastiCache in different VPCs in the same region](images/ElastiCache-inVPC-AccessedByEC2-DifferentVPC.png)
...
information, see [Enable DNS resolution for a VPC peering connection](../../../vpc/latest/peering/modify-peering-connections.md "../../../vpc/latest/peering/modify-peering-connections.md").
...
![Image: Screen shot of a VPC routing table](images/VPC-RoutingTable.png)

_VPC Routing Table_ 4. Modify the Security Group of your ElastiCache cache to allow inbound connection from the Application security
...
![Image: Diagram showing connecting across different VPCs in different regions](images/ElastiCache-inVPC-AccessedByEC2-DifferentVPC-DifferentRegion-VPN.png)
...
1. Deploy a Transit VPC Solution. For more information,
   see, [AWS Transit Gateway](https://aws.amazon.com/transit-gateway/ "https://aws.amazon.com/transit-gateway/").
...
- [Using VPN Connectivity](#elasticache-vpc-accessing-data-center-vpn "#elasticache-vpc-accessing-data-center-vpn")
- [Using Direct Connect](#elasticache-vpc-accessing-data-center-direct-connect "#elasticache-vpc-accessing-data-center-direct-connect")
...
![Image: Diagram showing connecting to ElastiCache from your data center via a VPN](images/ElastiCache-inVPC-AccessedByAppInCustDataCenter-VPN.png)
...
![Image: Diagram showing connecting to ElastiCache from your data center via Direct Connect](images/ElastiCache-inVPC-AccessedByAppInCustDataCenter-DirectConnect.png)
