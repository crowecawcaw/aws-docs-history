...
![Image: Primary endpoint for a Valkey (cluster mode disabled) cluster](http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/images/Reader-Endpoint.png)
...
![Image: Node endpoints for a Valkey (cluster mode disabled) cluster](http://docs.aws.amazon.com/AmazonElastiCache/latest/dg/images/ElastiCache-Endpoints-Redis-Node.png)
