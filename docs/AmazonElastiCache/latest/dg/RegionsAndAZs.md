...
service endpoint. For service endpoints, see [Supported Regions & endpoints](#SupportedRegions "#SupportedRegions").

![Image: Regions and Availability Zones](images/ElastiCache-RegionsAndAZs.png)
_Regions and Availability Zones_

###### Topics

- [Availability Zone considerations with Memcached](#CacheNode.Memcached.AvailabilityZones "#CacheNode.Memcached.AvailabilityZones")
- [Locating your nodes](#RegionsAndAZs.AZMode "#RegionsAndAZs.AZMode")
- [Supported Regions & endpoints](#SupportedRegions "#SupportedRegions")
- [Using local zones with ElastiCache](Local_zones.md "Local_zones.md")
- [Using Outposts with ElastiCache](ElastiCache-Outposts.md "ElastiCache-Outposts.md")
...
Before moving on to the next step, be sure the Memcached nodes are fully created and available. 2. Modify your cluster by removing the nodes you no longer want in the original
