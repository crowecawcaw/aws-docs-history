...
- No additional IAM authentication limitations apply to your application.
  For the full list of limitations, see [Authenticating with IAM](auth-iam.md "auth-iam.md").
...
Then skip to [Step 3: Verify both authentication methods](#auth-to-iam-verify-dual "#auth-to-iam-verify-dual").
...
request](../../../general/latest/gr/sigv4-signed-request-examples.md "../../../general/latest/gr/sigv4-signed-request-examples.md"). The following Python example demonstrates token generation.
...
[Authenticating with IAM](auth-iam.md "auth-iam.md"). For other languages, generate the IAM
authentication token using the
[AWS Signature Version 4
signing process](../../../general/latest/gr/signature-version-4.md "../../../general/latest/gr/signature-version-4.md") and pass it as the password in your client's
`AUTH` command.
...
[Step 3: Remove the password-based user](#auth-to-iam-remove-user "#auth-to-iam-remove-user"), add the password-based user and remove the disabled
