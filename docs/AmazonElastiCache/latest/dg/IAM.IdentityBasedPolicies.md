...
manage access to Amazon ElastiCache resources. For more information, see [Overview of managing access permissions to your ElastiCache resources](IAM.Overview.md "IAM.Overview.md").
...
to, see [ElastiCache API permissions: Actions, resources, and conditions reference](IAM.APIReference.md "IAM.APIReference.md").
