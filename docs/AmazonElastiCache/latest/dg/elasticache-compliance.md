...
multiple AWS compliance programs, such as SOC, PCI, FedRAMP, and HIPAA.
...
- When Amazon ElastiCache is listed as being within scope of a compliance program, this scope applies to all cache engines supported by ElastiCache. This includes ElastiCache for Valkey, ElastiCache for Memcached, and ElastiCache for Redis OSS.

## More information

For general information about AWS Cloud compliance, see the following:

- [FIPS Endpoints by Service](https://aws.amazon.com/compliance/fips/#FIPS_Endpoints_by_Service "https://aws.amazon.com/compliance/fips/#FIPS_Endpoints_by_Service")
- [Service updates in ElastiCache](Self-Service-Updates.md "Self-Service-Updates.md")
...
- [AWS PCI DSS Compliance Program](https://aws.amazon.com/compliance/pci-dss-level-1-faqs/ "https://aws.amazon.com/compliance/pci-dss-level-1-faqs/")
