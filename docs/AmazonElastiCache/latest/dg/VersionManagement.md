...
and specifying a new engine version. For more information, see [Modifying a replication group](Replication.Modify.md "Replication.Modify.md").
...
For more information, see [Modifying an ElastiCache cluster](Clusters.Modify.md "Clusters.Modify.md").
...
For more information, see [Memcached connection overhead](ParameterGroups.Engine.md#ParameterGroups.Memcached.Overhead "ParameterGroups.Engine.md#ParameterGroups.Memcached.Overhead").
...
- [Valkey 9.0](#valkey-version-9.0 "#valkey-version-9.0")
