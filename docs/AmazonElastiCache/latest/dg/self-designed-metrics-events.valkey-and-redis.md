...
| ElastiCache:CacheNodeProvisioningFailedDueToSubnetIPExhaustion |  ElastiCache:CacheNodeProvisioningFailedDueToSubnetIPExhaustion {{cluster-name}}-0001-005  | Amazon ElastiCache could not add a cache node because the subnet does not have enough available IP addresses. | 
