...
The following provides details on target tracking and scheduled policies and how to
apply them using the AWS Management Console AWS CLI and APIs.

###### Topics

- [Target tracking scaling
  policies](AutoScaling-Scaling-Policies-Target.md "AutoScaling-Scaling-Policies-Target.md")
- [Adding a scaling
  policy](AutoScaling-Scaling-Adding-Policy-Shards.md "AutoScaling-Scaling-Adding-Policy-Shards.md")
- [Registering a Scalable
  Target](AutoScaling-Scaling-Registering-Policy-CLI.md "AutoScaling-Scaling-Registering-Policy-CLI.md")
- [Defining a scaling
  policy](AutoScaling-Scaling-Defining-Policy-API.md "AutoScaling-Scaling-Defining-Policy-API.md")
- [Disabling scale-in
  activity](AutoScaling-Scaling-Disabling-Scale-in.md "AutoScaling-Scaling-Disabling-Scale-in.md")
- [Applying a
