...
- [Overview of managing access permissions to your ElastiCache resources](IAM.Overview.md "IAM.Overview.md")
...
- [Overview of managing access permissions to your ElastiCache resources](IAM.Overview.md "IAM.Overview.md")
- [Using identity-based policies (IAM policies) for Amazon ElastiCache](IAM.IdentityBasedPolicies.md "IAM.IdentityBasedPolicies.md")
