...
For a list of supported versions, see [Engine versions and upgrading in ElastiCache](engine-versions.md), [Supported Redis OSS engine versions](engine-versions.md#supported-engine-versions.redis), and [Supported ElastiCache for Memcached versions](engine-versions.md#supported-engine-versions-mc).