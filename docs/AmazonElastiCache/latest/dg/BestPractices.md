...
For more information, see [How synchronization and backup are implemented](Replication.Redis.md "Replication.Redis.md").
...
## Avoiding running out of memory when

executing a background write
...
see [Creating an ElastiCache parameter group](ParameterGroups.md "ParameterGroups.md") and
