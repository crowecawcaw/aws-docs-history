...
1. Download the AWS CLI on the [AWS
   command line interface](http://aws.amazon.com/cli "http://aws.amazon.com/cli") webpage.
...
- [create-global-replication-group](../../../cli/latest/reference/elasticache/create-global-replication-group.md "../../../cli/latest/reference/elasticache/create-global-replication-group.md")
