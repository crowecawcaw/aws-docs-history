...
Here are videos to help you learn basic and advanced Amazon ElastiCache concepts. For information about AWS Training, see [AWS Training & Certification](https://aws.amazon.com/training/).
...
+ [Best practices: migrating Redis OSS clusters from Amazon EC2 to ElastiCache (re:Invent 2019)](#WhatIs.Videos.Advanced.2019.DAT358)
...
+ [DAT317—How IFTTT uses ElastiCache for Redis OSS to Predict Events (re:Invent 2016)](#WhatIs.Videos.Advanced.2016.DAT317)
