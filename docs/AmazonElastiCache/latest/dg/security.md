...
- **Security in the cloud** – Your responsibility is
  ...
  using Amazon ElastiCache. The following topics show you how to configure Amazon ElastiCache to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your Amazon ElastiCache resources.
...
- [Infrastructure security in AWS ElastiCache](infrastructure-security.md "infrastructure-security.md")
- [Service updates in ElastiCache](Self-Service-Updates.md "Self-Service-Updates.md")
- [Common Vulnerabilities and Exposures (CVE): Security vulnerabilities addressed in ElastiCache](cve.md "cve.md")
