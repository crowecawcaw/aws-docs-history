...
Clusters that are already part of a global datastore don't appear in
this list. To add a new region to an existing global datastore, see
[Adding a Region to a global datastore](#Redis-Global-Datastores-Console-Create-Secondary "#Redis-Global-Datastores-Console-Create-Secondary"). 6. Keep the following options as they are. They're prepopulated to match the
primary cluster configuration, you can't change them.
    ...
    * Encryption at rest – Enables encryption of data stored on disk.
     For more information, see [Encryption at rest](at-rest-encryption.md "at-rest-encryption.md").
     ...
     **Customer Managed AWS KMS key** and choosing the
     key. For more information, see [Using Customer Managed AWS KMS keys](at-rest-encryption.md#using-customer-managed-keys-for-elasticache-security "at-rest-encryption.md#using-customer-managed-keys-for-elasticache-security").
...
5. Under **Cluster settings**
   ...
   **Global** attribute indicates whether a parameter
   ...
   replicas that you want for this cluster. 6. If you are creating a Valkey or Redis OSS (cluster mode enabled) cluster:
        ...
        The following restrictions exist for
         Valkey or Redis OSS (cluster mode enabled).
        	...
        	* The number of read replicas per shard is fixed and cannot be
        	 ...
        	 new number of replicas. For more information, see [Tutorial: Seeding a new node-based cluster with an externally created backup](backups-seeding-redis.md "backups-seeding-redis.md").

6. For **Subnet group settings**, choose the subnet that you want
...
your VPC](../../../vpc/latest/userguide/working-with-vpcs.md#AddaSubnet "../../../vpc/latest/userguide/working-with-vpcs.md#AddaSubnet"). 7. For **Availability zone placements**, you have two
options:
...
![Image: Specifying Keyspaces and Availability Zones](images/ElastiCache-ClusterOn-Slots-AZs.png)

_Specifying Keyspaces and Availability Zones_ 8. Choose **Next** 9. Under **Advanced Valkey and Redis OSS settings**
    ...
    1. For **Security**:
    	...
    	1. To encrypt your data, you have the following options:
    		...
    		* **Encryption at rest** –
    		 ...
    		 see [Encryption at Rest](at-rest-encryption.md "at-rest-encryption.md").
    		...
    		* **Encryption in-transit**
    		 ...
    		 information, see [encryption in transit](in-transit-encryption.md "in-transit-encryption.md").
...
For more information on backup and restore, see [Snapshot and restore](backups.md "backups.md"). 11. (Optional) Specify a maintenance window. The _maintenance
window_ is the time, generally an hour in length, each week when
...
or you can choose the day, time, and duration yourself (_Specify
maintenance window_). If you choose _Specify maintenance
window_ from the lists, choose the _Start day_,
_Start time_, and _Duration_ (in hours)
for your maintenance window. All times are UCT times.

For more information, see [Managing ElastiCache cluster maintenance](maintenance-window.md "maintenance-window.md"). 12. (Optional) For **Logs**:
...
For mor information, see [Tagging your ElastiCache resources](Tagging-Resources.md "Tagging-Resources.md"). 14. Review all your entries and choices, then make any needed corrections. When
you're ready, choose **Next**. 15. After you have configured the cluster in the previous steps, you now configure
your secondary cluster details.. 16. Under **Regional cluster**, choose the AWS Region where th
cluster is located. 17. Under **Cluster info**, enter a name and optional description
of the cluster. 18. The following options are prepopulated to match the primary cluster
...
3. Choose **Modify** and choose among the following
   ...
   - **Modify Automatic Failover** – Enable or disable
     ...
     replicas. For more information, see [Auto failover](AutoFailover.md "AutoFailover.md").
...
`The current primary cluster in `primary region`
 ...
 the new primary region.` 6. Choose **Confirm** if you want to continue the promotion or
**Cancel** if you don't.
...
warning: `Removing the region will remove your only available cross region
 ...
 you want to remove the selected region from the global datastore?` 6. Choose **Confirm** if you want to continue the promotion or
**Cancel** if you don't.
