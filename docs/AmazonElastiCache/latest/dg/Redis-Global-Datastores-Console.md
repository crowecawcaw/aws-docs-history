...
**Note**  
Clusters that are already part of a global datastore don't appear in this list. To add a new region to an existing global datastore, see [Adding a Region to a global datastore](#Redis-Global-Datastores-Console-Create-Secondary).
...
![Image: Specifying Keyspaces and Availability Zones](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/images/ElastiCache-ClusterOn-Slots-AZs.png)
