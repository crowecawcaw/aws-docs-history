...
**Topics**
+ [Metrics for ElastiCache Serverless for Memcached](#serverless-metrics-memcached)
+ [Events for ElastiCache Serverless for Memcached](#serverless-events.memcached)
+ [Metrics for node-based Memcached clusters](#node-based-metrics-memcached)
+ [Events for node-based Memcached clusters](#node-based-events-memcached)
