...
- `--max-items` –
  ...
  The value of `--max-items` cannot be less than 20 or greater than 100.
...
For more information, see the AWS CLI for ElastiCache
topic describe-replication-groups.
