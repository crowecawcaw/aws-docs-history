...
clusters. In this case, the name of the cluster you created at [Step 2: Create a cluster](SubnetGroups.designing-cluster-pre.md#GettingStarted.CreateCluster.valkey "SubnetGroups.designing-cluster-pre.md#GettingStarted.CreateCluster.valkey").
...
The following code deletes the cluster `my-cluster`. In this case, substitute `my-cluster` with the name of the cluster you created at [Step 2: Create a cluster](SubnetGroups.designing-cluster-pre.md#GettingStarted.CreateCluster.valkey "SubnetGroups.designing-cluster-pre.md#GettingStarted.CreateCluster.valkey").
