...
2. If the replica you want to promote is a member of a Valkey or Redis OSS (cluster mode disabled) replication
   ...
   before you proceed. For more information, see [Modifying a replication group](Replication.Modify.md "Replication.Modify.md").
...
6. If the cluster was Multi-AZ enabled before you began the promotion process,
   ...
   re-enable Multi-AZ. For more information, see [Modifying a replication group](Replication.Modify.md "Replication.Modify.md").
...
modifying a replication group, see [Modifying a replication group](Replication.Modify.md "Replication.Modify.md").
