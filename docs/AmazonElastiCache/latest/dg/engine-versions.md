...
<a name="valkey-version-9.1.main"></a>
...
For more information on the Valkey 9.1 release, see [Valkey 9.1 Release Notes](https://github.com/valkey-io/valkey/releases/tag/9.1.0).

## ElastiCache version 9.0 for Valkey
<a name="valkey-version-9.0.main"></a>
...
<table>
<thead>
  <tr><th></th><th colspan="3">Version</th></tr>
...
<table>
<thead>
  <tr><th></th><th colspan="2">Version</th></tr>
...
<table>
<thead>
  <tr><th>Feature</th><th> Non-cluster mode </th><th> Cluster mode </th></tr>
</thead>
<tbody>
...
+ **Geospatial indexing** – Redis OSS 3.2.4 introduces support for geospatial indexing via six GEO commands. For more information, see the Redis OSS GEO\* command documentation [Commands: GEO](http://valkey.io/commands#geo) on the Valkey Commands page (filtered for GEO).
