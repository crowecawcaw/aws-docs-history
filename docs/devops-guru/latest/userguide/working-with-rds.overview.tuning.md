...
see [Overview of Performance Insights](../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Overview.md "../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Overview.md") in the _Amazon Aurora User Guide_
or [Overview of Performance Insights](../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.md "../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.md") in the _Amazon RDS User Guide_.
...
- [DB load](#working-with-rds.overview.tuning.db-load "#working-with-rds.overview.tuning.db-load")
...
To learn more, see [Database load](../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Overview.ActiveSessions.md "../../../AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights.Overview.ActiveSessions.md") in the
_Amazon Aurora User Guide_ or [Database load](../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.ActiveSessions.md "../../../AmazonRDS/latest/UserGuide/USER_PerfInsights.Overview.ActiveSessions.md") in the
...
with wait events for Aurora PostgreSQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md") and [Tuning with wait events for Aurora MySQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md") in the
_Amazon Aurora User Guide_.

For more information about wait events in other Amazon RDS databases, see [Tuning
with wait events for RDS for PostgreSQL](../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md "../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md") in the
_Amazon RDS User Guide_.
