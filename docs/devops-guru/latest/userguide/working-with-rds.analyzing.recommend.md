...
DevOps Guru for RDS recommends that you do either of the following:
    ...
    * Investigate the cause of the issue.
    ...
    Typically, DevOps Guru for RDS recommends that you investigate specific SQL statements or wait
     ...
     `io/table/sql/handler`. Look up the listed wait event in [Tuning with wait events for Aurora PostgreSQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md") or [Tuning with wait
     events for Aurora MySQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md") in the *Amazon Aurora User Guide*, or in [Tuning with wait
     events for RDS for PostgreSQL](../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md "../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md") in the *Amazon RDS User Guide*. Then perform
