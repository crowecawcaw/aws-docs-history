...
| IAM features you can use with Amazon DevOps Guru                                                                                                         | IAM feature | DevOps Guru support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------- |
...
To get a high-level view of how DevOps Guru and other AWS services work with most
...
To see a list of DevOps Guru actions, see [Actions defined by Amazon DevOps Guru](../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-actions-as-permissions "../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-actions-as-permissions") in the
...
To see a list of DevOps Guru resource types and their ARNs, see
[Resources defined by Amazon DevOps Guru](../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of DevOps Guru condition keys, see [Condition keys for Amazon DevOps Guru](../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-policy-keys "../../../service-authorization/latest/reference/list_amazondevopsguru.md#amazondevopsguru-policy-keys") in the
...
Changing the permissions for a service role might break DevOps Guru
