...
**Topics**
+ [Monitoring relational databases using DevOps Guru](monitoring-relational-databases.md)
+ [Monitoring non-relational databases using DevOps Guru](monitoring-non-relational-databases.md)