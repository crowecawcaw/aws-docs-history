...
+ Configure the idle\_in\_transaction\_session\_timeout parameter to end any session that has been in the 'idle in transaction' state for longer than the specified time.