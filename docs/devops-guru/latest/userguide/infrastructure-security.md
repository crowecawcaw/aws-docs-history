...
As a managed service, Amazon DevOps Guru is protected by AWS global network security. For
...
You use AWS published API calls to access DevOps Guru through the network. Clients must
