...
**Topics**
+ [Configuring permissions for an Amazon SNS topic in another account](#sns-permissions-attach-policy)
+ [Adding an Amazon SNS topic from another account](#sns-permissions-add-sns-topic)
+ [Updating your Amazon SNS policy with a notification channel (recommended)](#sns-permissions-policy-notification-channel)
