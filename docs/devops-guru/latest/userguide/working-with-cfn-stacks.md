...
Specify the resources that you want Amazon DevOps Guru to analyze by choosing the CloudFormation stacks that create them. You can do this using the AWS Management Console or the SDK. 

**Topics**
+ [Choosing stacks for DevOps Guru to analyze (console)](#choose-stacks-console)
+ [Choosing stacks for DevOps Guru to analyze (DevOps Guru SDK)](#choose-stacks-sdk)
