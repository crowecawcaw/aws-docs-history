...
Aurora MySQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraMySQL.Managing.Tuning.md") and [Tuning with wait events for
Aurora PostgreSQL](../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md "../../../AmazonRDS/latest/AuroraUserGuide/AuroraPostgreSQL.Tuning.md") in the _Amazon Aurora User Guide_.
To learn how to tune performance using wait events in RDS for PostgreSQL, see [Tuning with wait events for
RDS for PostgreSQL](../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md "../../../AmazonRDS/latest/UserGuide/PostgreSQL.Tuning.md") in the _Amazon RDS User Guide_.
...
performance based on these events, see [cpu](../../../AmazonRDS/latest/AuroraUserGuide/ams-waits.cpu.md "../../../AmazonRDS/latest/AuroraUserGuide/ams-waits.cpu.md") and [io/table/sql/handler](../../../AmazonRDS/latest/AuroraUserGuide/ams-waits.waitio.md "../../../AmazonRDS/latest/AuroraUserGuide/ams-waits.waitio.md") in the _Amazon Aurora User Guide_.
