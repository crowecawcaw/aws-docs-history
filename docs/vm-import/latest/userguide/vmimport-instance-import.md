...
**Important**  
We strongly recommend that you import VMs as Amazon Machine Images (AMI) instead of instances. For more information, see [Import a VM to Amazon EC2 as an image using VM Import/Export](vmimport-image-import.md).
...
**Topics**
+ [Limitations of instance import](#vmimport-instance-import-limitations)
+ [Import a VM with instance import](#vmimport-instance-import-prerequisites)
...
You can use the `ImportInstance` operation to import your VM as an instance. For more information, see [ImportInstance](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ImportInstance.html) in the *Amazon Elastic Compute Cloud API Reference*.