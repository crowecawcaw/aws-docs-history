...
applies to data protection in VM Import/Export. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with VM Import/Export or other AWS services
...
VM Import/Export encrypts your data while performing import tasks. To ensure that the destination
AMI or snapshot is encrypted, specify the `--encrypted` parameter when you
call the [import-image](../../../cli/latest/reference/ec2/import-image.md "../../../cli/latest/reference/ec2/import-image.md") or
[import-snapshot](../../../cli/latest/reference/ec2/import-snapshot.md "../../../cli/latest/reference/ec2/import-snapshot.md") command.

When performing an import task, VM Import/Export stores data temporarily in an intermediate
EBS volume. Each task gets a separate EBS volume. When an import task is completed,
VM Import/Export deletes its intermediate EBS volume.
