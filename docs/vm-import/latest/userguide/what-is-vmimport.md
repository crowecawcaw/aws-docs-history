...
repository of VM images for backup and disaster recovery. For more information, see [VM Import/Export](https://aws.amazon.com/ec2/vm-import/ "https://aws.amazon.com/ec2/vm-import/").

For more information about how to use VM Import/Export, see [How to get started with VM Import/Export](vmimport-where-do-i-go.md "vmimport-where-do-i-go.md").

###### Topics

- [Benefits of VM Import/Export](#vmimport-benefits "#vmimport-benefits")
- [Features of VM Import/Export](#vmimport-features "#vmimport-features")
- [Pricing for VM Import/Export](#vmimport-pricing "#vmimport-pricing")
- [Related services](#vmimport-related-services "#vmimport-related-services")
...
When you migrate your VM-based applications and workloads to Amazon EC2, you
...
the world using AMI copy. For more information, see [Copying an AMI](../../../AWSEC2/latest/UserGuide/CopyingAMIs.md "../../../AWSEC2/latest/UserGuide/CopyingAMIs.md") in the
_Amazon EC2 User Guide_.

**Import your VM image catalog to Amazon EC2**

If you maintain a catalog of approved VM images, you can copy your image
...
You can import your local VM images into Amazon EC2 for backup and disaster
...
- The ability to import a VM from your virtualization environment to Amazon EC2 as an
...
- The ability to export a VM that was previously imported from your
  virtualization environment.
- The ability to import disks as Amazon EBS snapshots.
- VM import supports ENA drivers for Linux. ENA support will be enabled only if
  the original VM has ENA and/or NVMe drivers installed. We recommend installing
  the latest drivers.

## Pricing for VM Import/Export

With Amazon Web Services, you pay only for what you use. There is no additional fee to use
...
- AWS Application Discovery Service – You can use the Application Discovery Service
