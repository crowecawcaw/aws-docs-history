...
For details about creating or managing Reachability Analyzer service-linked roles, see [Use service-linked roles for Reachability Analyzer](using-service-linked-roles.md "using-service-linked-roles.md").
