...
| [AmazonVPCNetworkAccessAnalyzerFullAccessPolicy](#AmazonVPCNetworkAccessAnalyzerFullAccessPolicy "#AmazonVPCNetworkAccessAnalyzerFullAccessPolicy") – Update to an existing policy | Removed resource ID prefixes from the resource ARNs used to allow tagging Network Access Analyzer resources on create.                       | November 3, 2023 |
