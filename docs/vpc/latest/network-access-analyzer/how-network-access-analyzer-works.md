...
<a name="how-network-access-analyzer-works"></a>
...
Not all AWS network configurations are supported by Network Access Analyzer. The following sections describe the types of network paths that Network Access Analyzer produces as findings. For more information about resources that you can reference in Network Access Scopes, see [Network Access Scopes in Network Access Analyzer](working-with-network-access-scopes.md).
...
<a name="supported-configs-paths"></a>
...
<a name="unsupported-resources"></a>
...
<a name="unsupported-configurations"></a>
...
+ Network Access Analyzer does not support instance targets without [client IP preservation](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-target-groups.html#client-ip-preservation) enabled.
