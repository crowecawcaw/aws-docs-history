...
- AWS SDKs – Provides language-specific APIs and
  ...
  request retries and errors. For more information, see [Tools to build on AWS](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/").
- Query API – Provides low-level API actions that
  ...
  [Amazon VPC actions](../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md "../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md") in the
...
that are analyzed. For more information, see [Pricing](https://aws.amazon.com/vpc/pricing/ "https://aws.amazon.com/vpc/pricing/").
