...
- Route table propagation must be enabled for Client VPN attachments to allow traffic between your Client VPN endpoint and transit gateway. See [Enable route propagation](enable-tgw-route-propagation.md "enable-tgw-route-propagation.md").

###### Tasks

- [Create a Client VPN attachment](create-client-vpn-attachment.md "create-client-vpn-attachment.md")
- [View a Client VPN attachment](view-client-vpn-attachment.md "view-client-vpn-attachment.md")
- [Delete a Client VPN attachment](delete-client-vpn-attachment.md "delete-client-vpn-attachment.md")
- [Accept or reject a Client VPN attachment](accept-reject-client-vpn-attachment.md "accept-reject-client-vpn-attachment.md")
