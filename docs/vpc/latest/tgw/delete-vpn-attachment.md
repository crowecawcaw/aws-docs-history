...
4. Choose the resource ID of the VPN connection to navigate to the **VPN
   Connections** page.
...
Use the [delete-vpn-connection](../../../cli/latest/reference/ec2/delete-vpn-connection.md "../../../cli/latest/reference/ec2/delete-vpn-connection.md") command.
