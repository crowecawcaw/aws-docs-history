...
For more information, see the [AWS Transit Gateway](https://aws.amazon.com/transit-gateway/ "https://aws.amazon.com/transit-gateway/") website.
...
- [How transit gateways work](how-transit-gateways-work.md "how-transit-gateways-work.md")
- [Get started with transit gateways](tgw-getting-started.md "tgw-getting-started.md")
- [Design best practices](tgw-best-design-practices.md "tgw-best-design-practices.md")
...
- **AWS Command Line Interface (AWS CLI)** — Provides
  ...
  Windows, macOS, and Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/").
