...
- [Same subnet for EC2 instances and transit gateway association](#nacl-tgw-same-subnet "#nacl-tgw-same-subnet")
- [Different subnets for EC2 instances and transit gateway association](#nacl-tgw-different-subnet "#nacl-tgw-different-subnet")
...
For more information about how VPC attachments work, see [Resource attachments](how-transit-gateways-work.md#tgw-attachments-overview "how-transit-gateways-work.md#tgw-attachments-overview").
