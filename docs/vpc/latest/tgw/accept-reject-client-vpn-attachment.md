...
4. Select the attachment with a state of **Pending acceptance** and a type of **Client VPN**.
...
Use the [accept-transit-gateway-client-vpn-attachment](../../../cli/latest/reference/ec2/accept-transit-gateway-client-vpn-attachment.md "../../../cli/latest/reference/ec2/accept-transit-gateway-client-vpn-attachment.md") command.

###### To reject a Client VPN attachment using the AWS CLI

Use the [reject-transit-gateway-client-vpn-attachment](../../../cli/latest/reference/ec2/reject-transit-gateway-client-vpn-attachment.md "../../../cli/latest/reference/ec2/reject-transit-gateway-client-vpn-attachment.md") command.
