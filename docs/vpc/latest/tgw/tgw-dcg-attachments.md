...
![Direct Connect Gateway Connected to Transit Gateway](images/direct-connect-tgw.png)
...
- A transit virtual interface that is attached to the Direct Connect gateway.
  ...
  associations](../../../directconnect/latest/UserGuide/direct-connect-transit-gateways.md "../../../directconnect/latest/UserGuide/direct-connect-transit-gateways.md") in the _AWS Direct Connect User
  Guide_.
