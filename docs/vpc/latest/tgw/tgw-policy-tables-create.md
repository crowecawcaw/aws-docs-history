...
4. (Optional) For **Name tag**, enter a name for the transit
...
Use the [create-transit-gateway-policy-table](../../../cli/latest/reference/ec2/create-transit-gateway-policy-table.md "../../../cli/latest/reference/ec2/create-transit-gateway-policy-table.md") command.
