...
This step must be completed by the **Secondary Org Admin Account**. For more information about the roles involved in this process, see [Process overview](enable-integ-ipam-outside-org-process.md).
...
1. Select a resource discovery and choose **Actions** > **Delete resource discovery**.
...
+ To delete a resource discovery: [delete-ipam-resource-discovery](https://docs.aws.amazon.com/cli/latest/reference/ec2/delete-ipam-resource-discovery.html)
