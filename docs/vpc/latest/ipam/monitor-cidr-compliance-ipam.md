...
1. From the IP dropdown menu at the top of the content pane, choose the IP address protocol that you want to use: IPv4 or IPv6.

1. From the scope dropdown menu at the top of the content pane, choose the scope that you want to use. For more information about scopes, see [How IPAM works](how-it-works-ipam.md).

1. Use the resource CIDR map to view available, allocated, and overlapping IP address space in a scope:
...
1. In the table, you can view the following details about resources in the scope:
...
1. Use **Filter resources** to filter the resources table by column property, like VPC ID or compliance status.
...
1. Get the scope ID: [describe-ipam-scopes](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-ipam-scopes.html)

1. Request resource information: [get-ipam-resource-cidrs](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-ipam-resource-cidrs.html)
