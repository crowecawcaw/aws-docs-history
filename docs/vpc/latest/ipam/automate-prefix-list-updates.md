...
+ An [IPAM](https://docs.aws.amazon.com/vpc/latest/ipam/create-ipam.html) with [Advanced Tier](https://docs.aws.amazon.com/vpc/latest/ipam/mod-ipam-tier.html) enabled
+ A [customer-managed prefix list](https://docs.aws.amazon.com/vpc/latest/userguide/managed-prefix-lists.html#create-prefix-list) (or create one during setup)
+ [IAM permissions](https://docs.aws.amazon.com/vpc/latest/ipam/iam-ipam.html) for IPAM and EC2 prefix list operations
...
1. In the navigation pane, choose **Prefix list resolvers**.

1. Choose **Create prefix list resolver**.

1. In **Step 1: Configure resolver details**, choose the following:
...
1. In **Step 2: Configure rules**, choose **Add rule**. You can add up to 99 rules.
**Important**  
...
1. Choose one of the rule types:
...
+ Use the [create-ipam-prefix-list-resolver](https://docs.aws.amazon.com/cli/latest/reference/ec2/create-ipam-prefix-list-resolver.html) command and save the returned resolver ID for step 2.
...
1. Choose the resolver you created in Step 1.

1. On the resolver details page, choose the **Targets** tab.
...
1. Under **Desired version**, select one of the following:
...
+ Use the [create-ipam-prefix-list-resolver-target](https://docs.aws.amazon.com/cli/latest/reference/ec2/create-ipam-prefix-list-resolver-target.html) command with the resolver ID from step 1 and your existing prefix list ID.
...
1. Use the [get-ipam-prefix-list-resolver-version-entries](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-ipam-prefix-list-resolver-version-entries.html) command to view the latest version created by resolver.

1. Use the [describe-ipam-prefix-list-resolver-targets](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-ipam-prefix-list-resolver-targets.html) command to monitor resolver target sync status.
