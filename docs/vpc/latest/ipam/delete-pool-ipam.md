...
1. In the content pane, choose the pool whose CIDR you want to delete.

1. Choose **Actions** > **Delete pool**.
...
1. View pools and get an IPAM pool ID: [describe-ipam-pools](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-ipam-pools.html)

1. Delete a pool: [delete-ipam-pool](https://docs.aws.amazon.com/cli/latest/reference/ec2/delete-ipam-pool.html)

1. View your pools: [describe-ipam-pools](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-ipam-pools.html)
