...
![IPAM pool hierarchy example 1.](https://docs.aws.amazon.com/vpc/latest/ipam/images/ipam-example-pool-base.png)
...
![IPAM pool hierarchy example 2.](https://docs.aws.amazon.com/vpc/latest/ipam/images/ipam-example-2-914px.png)
...
![IPAM pool hierarchy example 3.](https://docs.aws.amazon.com/vpc/latest/ipam/images/ipam-example-34.png)
...
![IPAM pool hierarchy example 4.](https://docs.aws.amazon.com/vpc/latest/ipam/images/ipam-example-pool-subnet-integ.png)
