...
If you are integrating an IPAM with accounts outside of your organizations, this is a required step that must be completed by the **Primary Org IPAM Account**. For more information about the roles involved in this process, see [Process overview](enable-integ-ipam-outside-org-process.md).
...
1. Select **Associated discoveries**, and then choose **Associate resource discoveries**.
...
+ Associate a resource discovery: [associate-ipam-resource-discovery](https://docs.aws.amazon.com/cli/latest/reference/ec2/associate-ipam-resource-discovery.html)
