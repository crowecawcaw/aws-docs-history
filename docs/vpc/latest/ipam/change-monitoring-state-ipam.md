...
1. From the dropdown menu at the top of the content pane, choose the private scope you want to use.

1. In the content pane, choose the VPC and view the details of the VPC.

1. Under **VPC CIDRs**, select one of the CIDRs allocated to the VPC and choose **Actions** > **Mark as ignored** or **Unmark as ignored**.

1. Choose **Mark as ignored** or **Unmark as ignored**.
...
1. Get a scope ID: [describe-ipam-scopes](https://docs.aws.amazon.com/cli/latest/reference/ec2/describe-ipam-pools.html)

1. View the current monitoring state for the VPC CIDR: [get-ipam-resource-cidrs](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-ipam-resource-cidrs.html)

1. Change the state of the VPC CIDR: [modify-ipam-resource-cidr](https://docs.aws.amazon.com/cli/latest/reference/ec2/modify-ipam-resource-cidr.html)

1. View the new monitoring state for the VPC CIDR: [get-ipam-resource-cidrs](https://docs.aws.amazon.com/cli/latest/reference/ec2/get-ipam-resource-cidrs.html)
