...
1. Open the AWS Cost Management console at [https://console.aws.amazon.com/cost-management/home](https://console.aws.amazon.com/cost-management/home).

1. Choose **Cost Explorer**.

1. Filter for IPAM usage by choosing **Usage type** and entering **IPAddressManager**.

1. Select one or more checkboxes. Each of them represents a different AWS Region.
