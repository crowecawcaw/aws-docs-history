...
1. Verify that the TXT record is correctly published using the following command, where {{name\_server}} is one of the name servers that you found in the previous step.
