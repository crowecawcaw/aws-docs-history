...
- [Create an SNS notification](#create-sns-notification-endpoint-service "#create-sns-notification-endpoint-service")
- [Add an access policy](#add-access-policy-endpoint-service "#add-access-policy-endpoint-service")
- [Add a key policy](#add-key-policy-endpoint-service "#add-key-policy-endpoint-service")
