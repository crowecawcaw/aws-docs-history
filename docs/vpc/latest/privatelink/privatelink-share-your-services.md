...
![Service consumers connect to endpoint services hosted by service providers.](https://docs.aws.amazon.com/vpc/latest/privatelink/images/endpoint-services.png)
