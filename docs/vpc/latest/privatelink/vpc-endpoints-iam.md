...
- [How AWS PrivateLink works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
...
**Service user** – If you use the AWS PrivateLink service to do your job, then your administrator provides you
...
**Service administrator** – If you're in charge of AWS PrivateLink resources at your company, you probably have
