...
- [Providers](#concepts-service-providers "#concepts-service-providers")
- [Service or resource consumers](#concepts-service-consumers "#concepts-service-consumers")
- [AWS PrivateLink connections](#privatelink-connections "#privatelink-connections")
- [Private hosted zones](#concepts-private-hosted-zones "#concepts-private-hosted-zones")
...
![Service consumers create VPC endpoints to connect to endpoint services and resources hosted by providers.](images/privatelink-concepts.png)
...
- [Endpoint services](#concepts-endpoint-services "#concepts-endpoint-services")
- [Service names](#concepts-service-names "#concepts-service-names")
- [Service states](#concepts-service-states "#concepts-service-states")
- [Resource configuration](#concepts-resource-configuration "#concepts-resource-configuration")
- [Resource gateway](#concepts-resource-gateway "#concepts-resource-gateway")
...
can be an IP address, a domain-name target, or an [Amazon Relational Database Service](../../../AmazonRDS/latest/UserGuide/Welcome.md "../../../AmazonRDS/latest/UserGuide/Welcome.md") (Amazon RDS)
database.

When sharing with other accounts, the resource provider must share the
resource through a [AWS Resource Access Manager](../../../ram/latest/userguide/what-is.md "../../../ram/latest/userguide/what-is.md") (AWS RAM) resource
...
- `Interface` - Create an _interface
  endpoint_ to send TCP or UDP traffic to an endpoint
...
- `Resource` - Create a _resource
  endpoint_ to access a resource that was shared with you
...
- `Service network` - Create a _service-network
  endpoint_ to access a service network that you created or
...
A service provider adds [permissions](configure-endpoint-service.md#add-remove-permissions "configure-endpoint-service.md#add-remove-permissions")
...
With interface VPC endpoints, consumers can use [endpoint policies](vpc-endpoints-access.md "vpc-endpoints-access.md") to control which IAM
...
to route traffic for a domain or subdomain. With a _public hosted
zone_, the records specify how to route traffic on the internet. With
...
information, see [Routing traffic to a VPC endpoint using your domain name](../../../Route53/latest/DeveloperGuide/routing-to-vpc-interface-endpoint.md "../../../Route53/latest/DeveloperGuide/routing-to-vpc-interface-endpoint.md").
...
Deployments](https://aws.amazon.com/blogs/apn/reviewing-dns-mechanisms-for-routing-traffic-and-enabling-failover-for-aws-privatelink-deployments/ "https://aws.amazon.com/blogs/apn/reviewing-dns-mechanisms-for-routing-traffic-and-enabling-failover-for-aws-privatelink-deployments/").
