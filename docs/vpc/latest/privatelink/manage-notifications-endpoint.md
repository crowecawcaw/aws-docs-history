...
**Topics**
+ [Create an SNS notification](#create-sns-notification)
+ [Add an access policy](#add-access-policy)
+ [Add a key policy](#add-key-policy)
...
1. For **Notification ARN**, choose the [Amazon Resource Name](https://docs.aws.amazon.com/glossary/latest/reference/glos-chap.html#ARN) (ARN) for the SNS topic that you created.
