...
- [Security group rule basics](#security-group-rule-characteristics "#security-group-rule-characteristics")
- [Components of a security group rule](#security-group-rule-components "#security-group-rule-components")
- [Security group referencing](#security-group-referencing "#security-group-referencing")
- [Security group size](#security-group-size "#security-group-size")
- [Stale security group rules](#vpc-stale-security-group-rules "#vpc-stale-security-group-rules")
...
- When you add, update, or remove rules, your changes are automatically applied to all
  resources associated with the security group. For instructions, see [Configure security group rules](working-with-security-group-rules.md "working-with-security-group-rules.md").
- The effect of some rule changes can depend on how the traffic is tracked. For more
  information, see [Connection tracking](../../../AWSEC2/latest/UserGuide/security-group-connection-tracking.md "../../../AWSEC2/latest/UserGuide/security-group-connection-tracking.md") in the _Amazon EC2 User Guide_.
...
to as the 'VPC+2 IP address' (see [Amazon Route 53 Resolver](../../../Route53/latest/DeveloperGuide/resolver.md "../../../Route53/latest/DeveloperGuide/resolver.md") in the
_Amazon Route 53 Developer Guide_), or as [AmazonProvidedDNS](DHCPOptionSet.md "DHCPOptionSet.md"). To filter DNS requests through the Route 53 Resolver, use
[Route 53 Resolver DNS
Firewall](../../../Route53/latest/DeveloperGuide/resolver-dns-firewall.md "../../../Route53/latest/DeveloperGuide/resolver-dns-firewall.md").
...
- **ICMP type and code**: For ICMP, the ICMP type and code. For
  ...
  Request. For more information, see [Rules for ping/ICMP](../../../AWSEC2/latest/UserGuide/security-group-rules-reference.md#sg-rules-ping "../../../AWSEC2/latest/UserGuide/security-group-rules-reference.md#sg-rules-ping") in the _Amazon EC2 User Guide_.
- **Source or destination**: The source (inbound rules) or
  ...
  - The ID of a prefix list. For example, `pl-1234abc1234abc123`. For more
    information, see [Managed prefix lists](managed-prefix-lists.md "managed-prefix-lists.md").
  - The ID of a security group. For example, `sg-1234567890abcdef0`. For more
    information, see [Security group referencing](#security-group-referencing "#security-group-referencing").
...
For examples, see [Security group rules for different use cases](../../../AWSEC2/latest/UserGuide/security-group-rules-reference.md "../../../AWSEC2/latest/UserGuide/security-group-rules-reference.md") in the _Amazon EC2 User Guide_.
