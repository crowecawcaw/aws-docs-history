...
- [Overview](#overview-vpc-one-public-subnet "#overview-vpc-one-public-subnet")
- [1. Create the VPC](#create-vpc-one-public-subnet "#create-vpc-one-public-subnet")
- [2. Deploy your application](#deploy-dev-test "#deploy-dev-test")
- [3. Test your configuration](#test-dev-test "#test-dev-test")
- [4. Clean up](#clean-up-dev-test "#clean-up-dev-test")
...
![A VPC with a public subnet in one Availability Zone.](images/vpc-example-dev-test.png)
...
4. **Configure the VPC**
   ...
   2. For **IPv4 CIDR block**, you can keep the default suggestion, or
      ...
      network. For more information, see [VPC CIDR blocks](vpc-cidr-blocks.md "vpc-cidr-blocks.md").
...
5. **Configure the subnets**
   ...
   4. You can keep the default CIDR block for the public subnet, or alternatively you
      ...
      For more information, see [Subnet CIDR blocks](subnet-sizing.md "subnet-sizing.md").
...
- [Amazon EC2 Auto Scaling](../../../autoscaling/ec2/userguide.md "../../../autoscaling/ec2/userguide.md")
...
information, see [Create an AMI](../../../AWSEC2/latest/UserGuide/creating-an-ami-ebs.md "../../../AWSEC2/latest/UserGuide/creating-an-ami-ebs.md")
in the _Amazon EC2 User Guide_. Alternatively, you can use [EC2 Image Builder](https://aws.amazon.com/image-builder/ "https://aws.amazon.com/image-builder/") to create and manage your Amazon Machine Image
(AMI).
...
tables or security groups. For more information, see the [Reachability Analyzer Guide](../reachability.md "../reachability.md").

## 4. Clean up

When you are finished with this configuration, you can delete it. Before you can delete the VPC,
you must terminate your instance. For more information, see [Delete your VPC](delete-vpc.md "delete-vpc.md").
