...
- [Overview](#overview-vpc-public-private-subnets-multi-az "#overview-vpc-public-private-subnets-multi-az")
- [1. Create the VPC](#create-vpc-public-private-subnets-multi-az "#create-vpc-public-private-subnets-multi-az")
- [2. Deploy your application](#deploy-web-database-servers "#deploy-web-database-servers")
- [3. Test your configuration](#test-web-database-servers "#test-web-database-servers")
- [4. Clean up](#clean-up-web-database-servers "#clean-up-web-database-servers")
...
![A VPC with subnets in two Availability Zones.](images/vpc-example-web-database.png)
...
| `Public IPv4 address range of your network`      | TCP      | 22         | (Optional) Allows inbound SSH access from IPv4 IP addresses in your<br>network |
| `IPv6 address range of your network`             | TCP      | 22         | (Optional) Allows inbound SSH access from IPv6 IP addresses in your<br>network |
| `Public IPv4 address range of your network`      | TCP      | 3389       | (Optional) Allows inbound RDP access from IPv4 IP addresses in your<br>network |
| `IPv6 address range of your network`             | TCP      | 3389       | (Optional) Allows inbound RDP access from IPv6 IP addresses in your<br>network |
...
4. Configure the VPC:
   ...
   2. For **IPv4 CIDR block**, you can keep the default suggestion, or
      ...
      For more information, see [VPC CIDR blocks](vpc-cidr-blocks.md "vpc-cidr-blocks.md").
   ...
   4. Choose a **Tenancy** option. This option defines if EC2 instances
      ...
      using defined parameters](../../../AWSEC2/latest/UserGuide/ec2-launch-instance-wizard.md "../../../AWSEC2/latest/UserGuide/ec2-launch-instance-wizard.md") in the _Amazon EC2 User Guide_. If
...
5. Configure the subnets:
   ...
   4. You can keep the default CIDR blocks for the subnets, or alternatively you can
      ...
      more information, see [Subnet CIDR blocks](subnet-sizing.md "subnet-sizing.md").
...
- [Amazon EC2 launch instance wizard](../../../AWSEC2/latest/UserGuide/ec2-launch-instance-wizard.md "../../../AWSEC2/latest/UserGuide/ec2-launch-instance-wizard.md")
- [AWS CloudFormation](../../../AWSCloudFormation/latest/UserGuide.md "../../../AWSCloudFormation/latest/UserGuide.md")
- [Amazon Elastic Container Service (Amazon ECS)](../../../ecs.md "../../../ecs.md")

To improve availability, you can use [Amazon EC2 Auto Scaling](../../../autoscaling/ec2/userguide.md "../../../autoscaling/ec2/userguide.md") to deploy
...
types. For more information, see [Databases on AWS: How to choose](../../../documentation/latest/databases-on-aws-how-to-choose.md "../../../documentation/latest/databases-on-aws-how-to-choose.md").
...
issues with your route tables or security groups. For more information, see the [Reachability Analyzer Guide](../reachability.md "../reachability.md").
...
information, see [Delete your VPC](delete-vpc.md "delete-vpc.md").
