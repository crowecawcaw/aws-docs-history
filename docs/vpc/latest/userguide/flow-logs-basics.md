...
![Flow logs for an instance.](https://docs.aws.amazon.com/vpc/latest/userguide/images/flow-logs-diagram-s3.png)
...
![Flow logs for a subnet.](https://docs.aws.amazon.com/vpc/latest/userguide/images/flow-logs-diagram-cw.png)
...
If you launch an instance into your subnet after creating a flow log for your subnet or VPC, we create a log stream (for CloudWatch Logs) or log file object (for Amazon S3) for the new network interface. The log stream or file object is created as soon as network traffic occurs on the interface.
