...
| Route Server Endpoint [ENDPOINT ID] is now undergoing maintenance. BFD and BGP sessions may be impacted. | Route server endpoint maintenance | Format: 2025-02-17T15:55:00Z | ROUTE\_SERVER\_ENDPOINT\_MAINTENANCE | Affected endpoint ID | List of affected peer IDs | 
