...
- [Routes](#route-table-routes "#route-table-routes")
- [Main route table](#main-route-table "#main-route-table")
- [Custom route tables](#custom-route-tables "#custom-route-tables")
- [Subnet route table association](#route-table-assocation "#route-table-assocation")
...
local route for the IPv6 CIDR block. You can [replace or restore](replace-local-route-target.md "replace-local-route-target.md") the target of each local route as needed.
...
- You can add middlebox appliances to the routing paths for your VPC. For more
  information, see [Routing for a middlebox appliance](route-table-options.md#route-tables-appliance-routing "route-table-options.md#route-tables-appliance-routing").
...
local route. If you [Create a VPC](create-vpc.md "create-vpc.md") and choose
...
VPC. If you [Create a VPC](create-vpc.md "create-vpc.md") and choose a
...
and route table associations, see [Determine the explicit associations](WorkWithRouteTables.md#Route_Which_Associations "WorkWithRouteTables.md#Route_Which_Associations").
...
![Two subnets with implicit associations with route table A, the main route table.](images/replace-route-table-initial.png)
...
![Subnet B is now explicitly associated with route table B, a custom route table.](images/replace-route-table-step1.png)
...
![Both subnets are implicitly associated with route table B.](images/replace-route-table-step3.png)
