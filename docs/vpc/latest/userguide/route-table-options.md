...
- [Routing to an internet gateway](#route-tables-internet-gateway "#route-tables-internet-gateway")
- [Routing to a NAT device](#route-tables-nat "#route-tables-nat")
- [Routing to a virtual private gateway](#route-tables-vgw "#route-tables-vgw")
- [Routing to an AWS Outposts local gateway](#route-tables-lgw "#route-tables-lgw")
- [Routing to a VPC peering connection](#route-tables-vpc-peering "#route-tables-vpc-peering")
- [Routing to a gateway VPC endpoint](#route-tables-vpce "#route-tables-vpce")
- [Routing to an egress-only internet gateway](#route-tables-eigw "#route-tables-eigw")
- [Routing for a transit gateway](#route-tables-tgw "#route-tables-tgw")
- [Routing for a middlebox appliance](#route-tables-appliance-routing "#route-tables-appliance-routing")
- [Routing using a prefix list](#route-tables-managed-prefix-list "#route-tables-managed-prefix-list")
- [Routing to a Gateway Load Balancer endpoint](#route-tables-gwlbe "#route-tables-gwlbe")
...
For more information, see [Enable internet access for a VPC using an internet gateway](VPC_Internet_Gateway.md "VPC_Internet_Gateway.md").
...
For more information, see [NAT devices](vpc-nat.md "vpc-nat.md").
...
[What is
AWS Site-to-Site VPN?](../../../vpn/latest/s2svpn/VPC_VPN.md "../../../vpn/latest/s2svpn/VPC_VPN.md") and [Route tables and VPN route priority](../../../vpn/latest/s2svpn/VPNRoutingTypes.md#vpn-route-priority "../../../vpn/latest/s2svpn/VPNRoutingTypes.md#vpn-route-priority") in the _AWS Site-to-Site VPN User
Guide_.
...
- [Enable traffic between Outpost subnets and your on-premises network](#route-tables-lgw-on-prem "#route-tables-lgw-on-prem")
- [Enable traffic between subnets in the same VPC across Outposts](#route-tables-lgw-intra-vpc "#route-tables-lgw-intra-vpc")
...
- To use this feature, you must use [direct VPC routing](../../../outposts/latest/userguide/routing.md#direct-vpc-routing "../../../outposts/latest/userguide/routing.md#direct-vpc-routing"). You cannot use your own [customer-owned IP addresses](../../../outposts/latest/userguide/routing.md#ip-addressing "../../../outposts/latest/userguide/routing.md#ip-addressing").
...
- Existing Outposts racks may require an update to enable support for intra-VPC communication
  ...
  [contact AWS
  Support](../../../awssupport/latest/user/case-management.md "../../../awssupport/latest/user/case-management.md").
...
For more information about VPC peering connections, see the [Amazon VPC Peering Guide](../peering.md "../peering.md").
...
gateway endpoints](../privatelink/gateway-endpoints.md#gateway-endpoint-routing "../privatelink/gateway-endpoints.md#gateway-endpoint-routing").
...
For more information, see [Enable outbound IPv6 traffic using an egress-only internet gateway](egress-only-internet-gateway.md "egress-only-internet-gateway.md").
...
For more information about transit gateway route tables, see [Routing](../tgw/how-transit-gateways-work.md#tgw-routing-overview "../tgw/how-transit-gateways-work.md#tgw-routing-overview") in _Amazon VPC Transit Gateways_.
...
- Intercept traffic that enters your VPC through an internet gateway or a
  ...
  For more information, see [Middlebox routing wizard](middlebox-routing-console.md "middlebox-routing-console.md").
...
your appliance as the target for VPC traffic. For more information, see [Gateway route tables](gateway-route-tables.md "gateway-route-tables.md"). You can
also route outbound traffic from your subnet to a middlebox appliance in another
subnet.

For middlebox routing examples, see [Middlebox scenarios](middlebox-routing-examples.md "middlebox-routing-examples.md").

###### Contents

- [Appliance considerations](#appliance-considerations "#appliance-considerations")
- [Routing traffic between a gateway and an appliance](#appliance-routing-configuration "#appliance-routing-configuration")
- [Routing inter-subnet traffic to an appliance](#appliance-routing-configuration-inter-subnet "#appliance-routing-configuration-inter-subnet")

### Appliance considerations

You can choose a third-party appliance from [AWS Marketplace](https://aws.amazon.com/marketplace "https://aws.amazon.com/marketplace"), or you can configure your
...
- You must disable source/destination checking on the appliance. For more
  ...
  the Source or Destination Checking](../../../AWSEC2/latest/UserGuide/using-eni.md#change_source_dest_check "../../../AWSEC2/latest/UserGuide/using-eni.md#change_source_dest_check") in the
...
list](managed-prefix-lists.md "managed-prefix-lists.md") to group them together. You can then specify the prefix list as the
...
as firewalls. You can create a Gateway Load Balancer, configure a [Gateway Load Balancer endpoint service](../privatelink/create-gateway-load-balancer-endpoint-service.md "../privatelink/create-gateway-load-balancer-endpoint-service.md"), and then create a [Gateway Load Balancer endpoint](../privatelink/gateway-load-balancer-endpoints.md "../privatelink/gateway-load-balancer-endpoints.md") in your VPC to connect it to the service.
...
For an example of a security appliances behind a Gateway Load Balancer, see [Configure middlebox traffic routing and inspection in a VPC](gwlb-route.md "gwlb-route.md").
...
For more information, see [Gateway Load Balancers](../../../elasticloadbalancing/latest/gateway/introduction.md "../../../elasticloadbalancing/latest/gateway/introduction.md").
