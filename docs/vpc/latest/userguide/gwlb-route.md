...
![Using a Gateway Load Balancer endpoint to access an endpoint service.](https://docs.aws.amazon.com/vpc/latest/userguide/images/vpc-endpoint-service-gwlbe.png)
