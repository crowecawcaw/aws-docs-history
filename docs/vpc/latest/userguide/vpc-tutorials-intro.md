...
**Topics**
+ [Getting started with Amazon VPC using the AWS CLI](getting-started-with-amazon-vpc-using-the-aws-cli.md)
+ [Create a VPC with private subnets and NAT gateways using AWS CLI](create-a-vpc-with-private-subnets-and-nat-gateways-using-aws-cli.md)