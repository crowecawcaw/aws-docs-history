...
To view the permissions for this policy, see [AWSVPCFlowLogsServiceRolePolicy](../../../aws-managed-policy/latest/reference/AWSVPCFlowLogsServiceRolePolicy.md "../../../aws-managed-policy/latest/reference/AWSVPCFlowLogsServiceRolePolicy.md")
in the _AWS Managed Policy Reference_.

## Updates to the AWS managed policy

View details about updates to AWS managed policies for VPC Flow Logs since this service began
tracking these changes.

| Change                                                                                                                                                                                       | Description                                                                                                                                                                                                                                                                                | Date           |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- |
| [AWS managed policy: AWSVPCFlowLogsServiceRolePolicy](#flow-logs-managed-policy-AWSVPCFlowLogsServiceRolePolicy "#flow-logs-managed-policy-AWSVPCFlowLogsServiceRolePolicy") –<br>New policy | New AWSVPCFlowLogsServiceRolePolicy policy enables VPC Flow Logs to create and manage EventBridge Managed Rules and call DescribeTag APIs on your behalf to automatically track updates to EC2 Tag values associated with resources under Flow Logs subscriptions that include tag fields. | March 31, 2026 |
