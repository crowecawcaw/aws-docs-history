...
and NAT](#ip-addresses-and-nat "#ip-addresses-and-nat").

###### Pricing

There is no charge for an internet gateway, but there are data transfer charges for EC2
instances that use internet gateways. For more information, see [Amazon EC2 On-Demand Pricing](https://aws.amazon.com/ec2/pricing/on-demand/ "https://aws.amazon.com/ec2/pricing/on-demand/").

###### Contents

- [Internet gateway basics](#vpc-igw-internet-access "#vpc-igw-internet-access")
- [Add internet access to a subnet](working-with-igw.md "working-with-igw.md")
- [Delete an internet gateway](delete-igw.md "delete-igw.md")
