...
![A VPC with CIDR block 10.0.0.0/24 divided into two subnets.](images/subnet-cidrs.png)
...
- 10.0.0.2: Reserved by AWS. The IP address of the DNS server is the base
  ...
  more information, see [Amazon DNS server](AmazonDNS-concepts.md#AmazonDNS "AmazonDNS-concepts.md#AmazonDNS").
...
If you bring an IPv4 address range to AWS using [BYOIP](../../../AWSEC2/latest/UserGuide/ec2-byoip.md "../../../AWSEC2/latest/UserGuide/ec2-byoip.md"), you can use all of the IP addresses in the range, including the first address (the network address) and the last address (the broadcast address).
...
- A link-local IPv6 address in the FE80::/10 range generated using EUI-64. For more information
  ...
  address](https://en.wikipedia.org/wiki/Link-local_address "https://en.wikipedia.org/wiki/Link-local_address").
