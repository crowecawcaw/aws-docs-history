...
an existing VPC, you can access this visualization on the [Resource map](view-vpc-resource-map.md "view-vpc-resource-map.md")
...
- [VPCs and subnets](#how-it-works-subnet "#how-it-works-subnet")
- [Default and nondefault VPCs](#what-is-default-nondefault "#what-is-default-nondefault")
- [Route tables](#what-is-route-tables "#what-is-route-tables")
- [Access the internet](#what-is-connectivity "#what-is-connectivity")
- [Access a corporate or home network](#what-is-vpn "#what-is-vpn")
- [Connect VPCs and networks](#vpc-other-networks "#vpc-other-networks")
- [AWS private global network](#what-is-aws-global-network "#what-is-aws-global-network")
...
- [Configure a virtual private cloud](configure-your-vpc.md "configure-your-vpc.md")
- [Subnets for your VPC](configure-subnets.md "configure-subnets.md")
...
configured and ready for you to use. For example, it has a _default
subnet_ in each Availability Zone in the Region, an attached internet
...
IP addresses and enable DNS resolution through the Amazon-provided DNS server (see [DNS attributes for your VPC](AmazonDNS-concepts.md#vpc-dns-support "AmazonDNS-concepts.md#vpc-dns-support")). Therefore, an EC2
...
- [Configure route tables](VPC_Route_Tables.md "VPC_Route_Tables.md")
...
- [AWS Site-to-Site VPN User Guide](../../../vpn/latest/s2svpn.md "../../../vpn/latest/s2svpn.md")
- [Amazon VPC Transit Gateways](../tgw.md "../tgw.md")
...
- [Amazon VPC Peering Guide](../peering.md "../peering.md")
- [Amazon VPC Transit Gateways](../tgw.md "../tgw.md")
