...
![VPC with subnets in 2 AZs, 3 route tables, internet gateway, and gateway endpoint.](http://docs.aws.amazon.com/vpc/latest/userguide/images/vpc-resource-map-update.PNG)
