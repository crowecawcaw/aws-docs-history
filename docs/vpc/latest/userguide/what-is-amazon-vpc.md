...
![A VPC with an internet gateway and subnets in three Availability Zones.](images/how-it-works.png)
For more information, see [Amazon Virtual Private Cloud (Amazon VPC)](https://aws.amazon.com/vpc/ "https://aws.amazon.com/vpc/").
...
A [VPC](configure-your-vpc.md "configure-your-vpc.md") is a virtual
...
**Subnets**
A [subnet](configure-subnets.md "configure-subnets.md") is a range of
...
**IP addressing**
You can assign [IP addresses](vpc-ip-addressing.md "vpc-ip-addressing.md"),
...
**Routing**
Use [route tables](VPC_Route_Tables.md "VPC_Route_Tables.md") to determine
where network traffic from your subnet or gateway is directed.

**Gateways and endpoints**
A [gateway](extend-intro.md "extend-intro.md") connects your VPC to
another network. For example, use an [internet gateway](VPC_Internet_Gateway.md "VPC_Internet_Gateway.md")
to connect your VPC to the internet. Use a [VPC endpoint](../privatelink/privatelink-access-aws-services.md "../privatelink/privatelink-access-aws-services.md") to connect to AWS services privately, without
the use of an internet gateway or NAT device.

**Peering connections**
Use a [VPC peering connection](../peering.md "../peering.md")
to route traffic between the resources in two VPCs.

**Traffic Mirroring**
[Copy network traffic](../mirroring.md "../mirroring.md") from
...
Your AWS account includes a [default VPC](default-vpc.md "default-vpc.md") in each AWS Region.
Your default VPCs are configured such that you can immediately start launching and connecting
to EC2 instances. For more information, see [Plan your VPC](vpc-getting-started.md "vpc-getting-started.md").

You can choose to create additional VPCs with the subnets, IP addresses, gateways
and routing that you need. For more information, see [Create a VPC](create-vpc.md "create-vpc.md").
...
- **AWS Command Line Interface (AWS CLI)** —
  ...
  supported on Windows, Mac, and Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/").
...
- **Query API** — Provides low-level API actions
  ...
  see [Amazon VPC actions](../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md "../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md") in
...
Network Access Analyzer. For more information, see [Amazon VPC Pricing](https://aws.amazon.com/vpc/pricing/ "https://aws.amazon.com/vpc/pricing/").
...
If you are an existing or new [AWS Free Tier](https://aws.amazon.com/free/ "https://aws.amazon.com/free/")
...
addresses are charged. For specific pricing information, see the _Public IPv4 address_ tab in [Amazon VPC Pricing](https://aws.amazon.com/vpc/pricing/ "https://aws.amazon.com/vpc/pricing/").

Private IPv4 addresses ([RFC
1918](https://datatracker.ietf.org/doc/html/rfc1918 "https://datatracker.ietf.org/doc/html/rfc1918")) are not charged. For more information about how public IPv4 addresses
are charged for shared VPCs, see [Billing and
metering for the owner and participants](vpc-sharing.md#vpc-sharing-permissions "vpc-sharing.md#vpc-sharing-permissions").
