...
[Manage security group rules](vpc-policy-examples.md#vpc-security-group-rules-iam "vpc-policy-examples.md#vpc-security-group-rules-iam").
...
4. To edit the inbound rules, choose **Edit inbound rules** from
   ...
   **Protocol**, and, if applicable, the code name
   ...
   protocol and port range are configured for you. 2. To update a rule, change its protocol, description, and source as
   ...
   a prefix list, or a security group. 3. To delete a rule, choose its **Delete** button.
...
- Add – Use the
  [authorize-security-group-ingress](../../../cli/latest/reference/ec2/authorize-security-group-ingress.md "../../../cli/latest/reference/ec2/authorize-security-group-ingress.md") and [authorize-security-group-egress](../../../cli/latest/reference/ec2/authorize-security-group-egress.md "../../../cli/latest/reference/ec2/authorize-security-group-egress.md") commands.
- Remove – Use the
  [revoke-security-group-ingress](../../../cli/latest/reference/ec2/revoke-security-group-ingress.md "../../../cli/latest/reference/ec2/revoke-security-group-ingress.md") and [revoke-security-group-egress](../../../cli/latest/reference/ec2/revoke-security-group-egress.md "../../../cli/latest/reference/ec2/revoke-security-group-egress.md") commands.
- Modify – Use the [modify-security-group-rules](../../../cli/latest/reference/ec2/modify-security-group-rules.md "../../../cli/latest/reference/ec2/modify-security-group-rules.md"), [update-security-group-rule-descriptions-ingress](../../../cli/latest/reference/ec2/update-security-group-rule-descriptions-ingress.md "../../../cli/latest/reference/ec2/update-security-group-rule-descriptions-ingress.md"), and
  [update-security-group-rule-descriptions-egress](../../../cli/latest/reference/ec2/update-security-group-rule-descriptions-egress.md "../../../cli/latest/reference/ec2/update-security-group-rule-descriptions-egress.md")commands.
