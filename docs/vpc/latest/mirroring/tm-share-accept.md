...
1. To accept a shared traffic mirror target, in the navigation pane, choose **Shared with me**, **Resource shares**.
...
1. To delete a shared traffic mirror target, on the navigation pane, choose **Shared by me**, **Resource shares**.
