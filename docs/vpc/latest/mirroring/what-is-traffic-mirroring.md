...
- **AWS Command Line Interface (AWS CLI)** — Provides commands for a
  ...
  Linux. For more information, see [AWS Command Line Interface](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/").
- **AWS SDKs** — Provide language-specific APIs.
  ...
  [AWS SDKs](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/").
- **Query API**— Provides low-level API actions that
  ...
  hash to sign the request and handling errors. For more information, see [Amazon VPC actions](../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md "../../../AWSEC2/latest/APIReference/OperationList-query-vpc.md") in the
...
to be charged for Traffic Mirroring until you [delete all active traffic mirror sessions](create-traffic-mirroring-session.md "create-traffic-mirroring-session.md"). For example, you'll
...
[Data transfer charges apply](../../../cur/latest/userguide/cur-data-transfers-charges.md "../../../cur/latest/userguide/cur-data-transfers-charges.md"). If your traffic mirroring targets are behind a gateway or network load balancer, data processing for the load balancing services also applies.

For information about pricing for Traffic Mirroring, see **Network Analysis** on
the [Amazon VPC pricing](https://aws.amazon.com/vpc/pricing/ "https://aws.amazon.com/vpc/pricing/") page.
