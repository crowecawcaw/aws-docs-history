...
![Traffic from source A and source B is mirrored to mirror target D using filter A.](images/traffic-mirroring.png)
...
- [Targets](traffic-mirroring-targets.md "traffic-mirroring-targets.md")
- [Filters](traffic-mirroring-filters.md "traffic-mirroring-filters.md")
- [Sessions](traffic-mirroring-sessions.md "traffic-mirroring-sessions.md")
- [Connectivity options](traffic-mirroring-connection.md "traffic-mirroring-connection.md")
- [Packet format](traffic-mirroring-packet-formats.md "traffic-mirroring-packet-formats.md")
