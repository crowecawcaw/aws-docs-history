...
![A single target with two traffic mirror sessions, each with an appliance.](images/ex-multiple-appliances.png)
...
information on creating a filter, see [Create, modify, or delete a traffic mirror filter](create-traffic-mirroring-filter.md "create-traffic-mirroring-filter.md").
