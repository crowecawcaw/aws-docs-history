...
<a name="tm-example-open-source"></a>
...
+ **Zeek** — For more information, see the [Zeek website](https://zeek.org/).
...
<a name="tm-example-open-source-install-software"></a>
...
<a name="tm-example-open-source-step-create-target"></a>
...
<a name="tm-example-open-source-step-create-filter"></a>

Create a traffic mirror filter (Filter 1) with the following inbound rule. For more information, see [Create, modify, or delete a traffic mirror filter](create-traffic-mirroring-filter.md).
...
<a name="tm-example-open-source-step-create-session"></a>
