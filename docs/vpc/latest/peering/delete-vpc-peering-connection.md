...
For more information about how long the peering connection remains visible, see [VPC peering connection lifecycle](vpc-peering-basics.md#vpc-peering-lifecycle "vpc-peering-basics.md#vpc-peering-lifecycle").
...
- [delete-vpc-peering-connection](../../../cli/latest/reference/ec2/delete-vpc-peering-connection.md "../../../cli/latest/reference/ec2/delete-vpc-peering-connection.md") (AWS CLI)
- [Remove-EC2VpcPeeringConnection](../../../powershell/latest/reference/items/Remove-EC2VpcPeeringConnection.md "../../../powershell/latest/reference/items/Remove-EC2VpcPeeringConnection.md") (AWS Tools for Windows PowerShell)
