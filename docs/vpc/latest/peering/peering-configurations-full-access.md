...
specific VPC peering connection configuration, see [VPC peering connection networking scenarios](peering-scenarios.md "peering-scenarios.md"). For more information about creating and working with VPC
peering connections, see [VPC peering connections](working-with-vpc-peering.md "working-with-vpc-peering.md").

For more information about updating your route tables, see [Update your route tables for a VPC peering connection](vpc-peering-routing.md "vpc-peering-routing.md").

###### Configurations

- [Two VPCs peered together](#two-vpcs-full-access "#two-vpcs-full-access")
- [One VPC peered with two VPCs](#one-to-two-vpcs-full-access "#one-to-two-vpcs-full-access")
- [Three VPCs peered together](#three-vpcs-full-access "#three-vpcs-full-access")
- [Multiple VPCs peered together](#many-vpcs-full-access "#many-vpcs-full-access")
...
![Two VPCs peered together](images/two-vpcs-peered.png)
...
connection between VPC B and VPC C, as shown in [Three VPCs peered together](#three-vpcs-full-access "#three-vpcs-full-access"). For more information about unsupported peering
scenarios, see [VPC peering limitations](vpc-peering-basics.md#vpc-peering-limitations "vpc-peering-basics.md#vpc-peering-limitations").
...
![One VPC peered with two VPCs](images/one-to-many-vpcs.png)
...
![Three VPCs peered together](images/three-vpcs-peered.png)
...
![Seven VPCs in a full mesh configuration.](images/full-mesh.png)
