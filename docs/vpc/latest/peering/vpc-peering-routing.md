...
For more information about supported route table configurations for VPC peering connections, see [Common VPC peering connection configurations](peering-configurations.md).
