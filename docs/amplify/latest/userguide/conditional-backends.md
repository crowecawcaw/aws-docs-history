...
environment variable, see [Configuring diff based backend builds for a Gen 1 app](edit-build-settings.md#enable-diff-backend "edit-build-settings.md#enable-diff-backend").
...
`amplify.yml` file, see [Build specification reference](yml-specification-syntax.md "yml-specification-syntax.md").
