...
- [Access is denied for certain routes
  even with the SPA redirect rule.](#spa-redirect-access-denied "#spa-redirect-access-denied")
- [I want to set up a reverse proxy to an
  API](#reverse-proxy-api "#reverse-proxy-api")

## Access is denied for certain routes

even with the SPA redirect rule.
