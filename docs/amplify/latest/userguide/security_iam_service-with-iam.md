...
Before you use IAM to manage access to Amplify, learn what IAM features are
available to use with Amplify.

| IAM features that you can use with Amplify                                                                                                               | IAM feature | Amplify support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------- |
...
To get a high-level view of how Amplify and other AWS services work with most IAM
...
For a list of Amplify actions, see [Actions defined by AWS Amplify](../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-actions-as-permissions "../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-actions-as-permissions") in the
...
For a list of Amplify resource types and their ARNs, see [Resource types defined by AWS Amplify](../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-resources-for-iam-policies")
...
For a list of Amplify condition keys, see
[Condition keys for AWS Amplify](../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-policy-keys "../../../service-authorization/latest/reference/list_awsamplify.md#awsamplify-policy-keys") in the _Service Authorization Reference_. To learn with
...
Find a service in the table that includes a `Yes` in the
**Service-linked role** column. Choose the **Yes**
link to view the service-linked roles documentation for that service.
