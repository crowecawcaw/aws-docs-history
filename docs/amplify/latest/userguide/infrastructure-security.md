...
As a managed service, AWS Amplify is protected by AWS global network security. For
...
You use AWS published API calls to access Amplify through the network. Clients must
