...
6. Create the second CNAME record to point to the AWS Certificate Manager (ACM) validation server.
   ...
   **Name**.
   ...
   ![The DNS records in the Amplify console, including the ACM verification record.](/images/amplify/latest/userguide/images/amplify-customdomains-DNS-verification2.png) 4. Choose **Save**.###### Note
...
console. 7. This step is not required for subdomains. GoDaddy doesn’t support ANAME/ALIAS
records. For DNS providers that do not have ANAME/ALIAS support, we strongly
recommend migrating your DNS to Amazon Route 53. For more information, see [Configuring Amazon Route 53 as your DNS service](../../../Route53/latest/DeveloperGuide/dns-configuring.md "../../../Route53/latest/DeveloperGuide/dns-configuring.md").
