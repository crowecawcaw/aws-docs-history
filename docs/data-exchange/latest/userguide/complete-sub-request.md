...
1.  On the **Complete subscription request** page, review and
    choose the product offer (if more than one offer is available).
2.  Review the **Subscription terms**, included **Data
    sets**, **Support information**, and
    **Refund policy**.
...
5.  Choose **Send subscription request to provider**.
    After you submit your request, the provider has up to 45 days to approve or decline
    your request.
