# Marketing and advertising long

description template for AWS Data Exchange
...
The following is template for a long description for marketing and advertising
products.
