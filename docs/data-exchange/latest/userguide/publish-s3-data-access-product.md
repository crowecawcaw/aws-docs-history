...
- If you're using customer managed keys, you must have the following:
  ...
  For more details, see [Configuring S3 Bucket Keys](../../../AmazonS3/latest/userguide/bucket-key.md#configure-bucket-key "../../../AmazonS3/latest/userguide/bucket-key.md#configure-bucket-key") in the _Amazon Simple Storage Service User Guide_.
