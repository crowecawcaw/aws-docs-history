...
As a managed service, AWS Data Exchange is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Data Exchange through the network. Clients must
