...
**Note**  
You can use Markdown templates as a starting point for the long description of a number of popular product types. For more information, see [Product description templates in AWS Data Exchange](product-description-templates.md).
...
1. Log into the AWS console and navigate to an [Amazon S3 bucket](https://console.aws.amazon.com/s3) that your AWS Data Exchange user has access to. The contents of this bucket are publicly readable.
