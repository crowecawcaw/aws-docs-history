...
| "dataexchange:JobType":IMPORT\_ASSETS\_FROM\_LAKE\_FORMATION\_TAG\_POLICY" (Preview) | Scopes permissions to jobs that import assets from AWS Lake Formation (Preview) | String | 
