...
To express conditions, you use predefined condition keys. AWS Data Exchange has the
`JobType` condition for API operations. However, there are AWS
wide condition keys that you can use, as appropriate. For a complete list of
AWS wide keys, see the [_IAM User Guide_](../../../IAM/latest/UserGuide/introduction.md "../../../IAM/latest/UserGuide/introduction.md").
