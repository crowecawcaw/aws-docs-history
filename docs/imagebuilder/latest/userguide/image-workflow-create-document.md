...
| timeoutSeconds                                                                      | The maximum time, in seconds, that the step runs before failing and<br>retrying, if retries apply.                                                                                                                                                                                                                                                                                                                                                                                    | Integer | No       | Depends on the default defined for the step action, if applicable. | Cannot be more than the max timeout of the step action                                                                                                                                                                                                                                                                                                                                                                |
