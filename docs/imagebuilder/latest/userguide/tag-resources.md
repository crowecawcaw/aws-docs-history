...
**Topics**
+ [Tag a resource from the AWS CLI](#cli-tag-resource)
+ [Untag a resource from the AWS CLI](#cli-untag-resource)
+ [List all of the tags for a specific resource from the AWS CLI](#cli-list-tags-for-resource)
