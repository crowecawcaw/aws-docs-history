...
The output AMI that Image Builder creates includes the product codes from AWS Marketplace image products and components. You can have up to nine product codes for your final customized image.

## AWS Marketplace subscriptions in Image Builder
<a name="integ-marketplace-subs"></a>
...
<a name="integ-marketplace-find"></a>
...
<a name="integ-marketplace-base-image"></a>
