...
**Topics**
+ [List image pipelines from the AWS CLI](#cli-list-image-pipelines)
+ [Get image pipeline details from the AWS CLI](#cli-get-image-pipeline-details)

## List image pipelines from the AWS CLI
<a name="cli-list-image-pipelines"></a>
...
<a name="cli-get-image-pipeline-details"></a>
