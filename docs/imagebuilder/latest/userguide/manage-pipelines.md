...
**Topics**
+ [Configure pipeline execution settings for image pipelines](schedule-pipeline.md)
...
+ [Configure image pipeline workflows in Image Builder](pipeline-workflows.md)
+ [Use EventBridge with Image Builder pipelines](ev-rules-for-pipeline.md)