...
<a name="tutorials-first-build-wizard"></a>
...
+ [Pipeline wizard: Create AMI](start-build-image-pipeline.md)
+ [Pipeline wizard: Create container image](start-build-container-pipeline.md)

## Create a custom component with input parameters
<a name="tutorials-create-custom-component"></a>
...
[Custom component with parameters](tutorial-component-parameters.md)

## Use Systems Manager parameters with Image Builder
<a name="tutorials-use-ssm-parameters"></a>

The following tutorial shows you how to create an AWS Systems Manager Parameter Store parameter and use it in an image recipe.
