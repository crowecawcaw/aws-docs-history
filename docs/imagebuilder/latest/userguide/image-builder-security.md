...
- **Security of the cloud** – AWS is
  ...
  programs that apply to EC2 Image Builder, see [AWS services in Scope
...
- **Security in the cloud** – Your responsibility
  ...
  using Image Builder. The following topics show you how to configure Image Builder to meet your security and
  compliance objectives. You also learn how to use other AWS services that help you to monitor
  and secure your Image Builder resources.
...
- [Security best practices for Image Builder](security-best-practices.md "security-best-practices.md")
