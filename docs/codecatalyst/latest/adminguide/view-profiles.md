...
**Note**  
This topic describes how to view your user profile if you signed in to CodeCatalyst with a AWS Builder ID. If you signed in as a user who is managed as part of SSO users and groups, see [Administering spaces that support identity federation](managing-federation-space.md).
...
+ Personal access tokens (PATs). For more information, see [Grant users repository access with personal access tokens](https://docs.aws.amazon.com/codecatalyst/latest/userguide/ipa-tokens-keys.html).
+ Personal connections. For more information, see [Accessing GitHub resources with personal connections](https://docs.aws.amazon.com/codecatalyst/latest/userguide/ipa-settings-connections.html).
+ The email and Slack notifications you want to receive. For more information, see [Sending notifications from CodeCatalyst](https://docs.aws.amazon.com/codecatalyst/latest/userguide/notifications.html).
