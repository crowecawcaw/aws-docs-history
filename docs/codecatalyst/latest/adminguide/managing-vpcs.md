...
- [Setting up an Amazon VPC](managing-vpcs.set-up.md "managing-vpcs.set-up.md")
- [Adding VPC connections for a space](managing-vpcs.add.md "managing-vpcs.add.md")
- [Configuring VPC endpoints for a space](managing-vpcs.endpoint.md "managing-vpcs.endpoint.md")
- [Managing a default VPC connection for a space](managing-vpcs.default.md "managing-vpcs.default.md")
- [Editing VPC connections for a space](managing-vpcs.edit.md "managing-vpcs.edit.md")
- [Removing VPC connections for a space](managing-vpcs.remove.md "managing-vpcs.remove.md")
...
1. In the AWS Management Console, **create an Amazon Virtual Private Cloud (VPC)** or use an existing VPC. A VPC is a virtual network that provides extra
   ...
   your VPC to work with CodeCatalyst, it must have a certain configuration. For more information, see [Amazon VPC setup requirements](managing-vpcs.set-up.md#managing-vpcs.requirements "managing-vpcs.set-up.md#managing-vpcs.requirements").
2. In your CodeCatalyst space settings, **create a VPC connection**. A
   ...
   see [Adding VPC connections for a space](managing-vpcs.add.md "managing-vpcs.add.md").
...
- CodeCatalyst only supports creating VPC connections in the same region. For more information on the available regions, see [CodeCatalyst VPC endpoint service names](managing-vpcs.endpoint.md#managing-vpcs.endpoint-service-names "managing-vpcs.endpoint.md#managing-vpcs.endpoint-service-names").
