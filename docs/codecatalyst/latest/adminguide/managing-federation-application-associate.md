...
specified billing account for your space. 3. Under **Application Enabled Spaces**, choose **Connect
space**. On the **Choose or create a CodeCatalyst space**
page, choose the space that you want to associate with your application, or you can choose
