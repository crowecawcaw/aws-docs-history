...
For more information, see [Enabling or disabling project-restricted account connections](managing-accounts-restriction.md "managing-accounts-restriction.md"). 5. Choose **Manage default**, choose **Set as default** from the drop-down
