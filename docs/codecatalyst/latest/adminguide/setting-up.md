...
Before you start using a space and projects in CodeCatalyst, you must first set up your
space and resources in CodeCatalyst.

You can manage your space that supports identity federation in CodeCatalyst after you have set up the space for
identity federation.

This guide includes information about administrator tasks for managing
spaces and related accounts and federation resources in CodeCatalyst.

For information about the following tasks for managing AWS Builder ID spaces, see the
_CodeCatalyst User Guide_ :

- Add other space administrators to the space for a AWS Builder ID space
- Change member roles and permissions for a AWS Builder ID space
