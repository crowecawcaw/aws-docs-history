...
**Note**  
This topic describes how to invite users who sign in to CodeCatalyst with a AWS Builder ID. To invite users that are managed as part of SSO users and groups, see [Administering spaces that support identity federation](managing-federation-space.md).

You can invite users to your CodeCatalyst space (instead of inviting them to a project within a space). Inviting users to a space is useful when you want that user to help you manage the space. Users who will manage a space will also need the **Space administrator** or **Power user** role. Assigning one of those roles to other users can help you distribute the responsibilities of managing the space across more people without having to invite these users to projects.
...
**Important**  
Only invite users you trust. Inviting someone grants them access to your space and resources according to the permissions you assign.
