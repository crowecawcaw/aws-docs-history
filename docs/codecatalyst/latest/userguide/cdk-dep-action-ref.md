...
- [CDK CLI versions used by the 'AWS CDK deploy' action](cdk-dep-action.md#cdk-dep-action-cdk-version "cdk-dep-action.md#cdk-dep-action-cdk-version")
- [CDK CLI versions used by the "AWS CDK bootstrap" action](cdk-boot-action.md#cdk-boot-action-cdk-version "cdk-boot-action.md#cdk-boot-action-cdk-version")
...
subsequent actions. To learn how to reference workflow output variables in subsequent actions, see [Referencing a predefined variable](workflows-working-with-variables-reference-output-vars.md "workflows-working-with-variables-reference-output-vars.md").
