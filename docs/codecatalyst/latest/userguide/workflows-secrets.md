...
- [Obtaining the identifier of a secret](#workflows-using-secrets.get-identifier "#workflows-using-secrets.get-identifier")
- [Referencing a secret in a workflow](#workflows-using-secrets.using-identifier "#workflows-using-secrets.using-identifier")
