...
| `<br>Triggers:<br>`                                       | Specifies the logic that will cause a workflow run to start. For more<br>information about triggers, see [Starting a workflow run automatically using triggers](workflows-add-trigger.md "workflows-add-trigger.md").                                                      |
