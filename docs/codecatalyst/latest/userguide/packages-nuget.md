...
CodeCatalyst supports [NuGet
version 4.8](https://docs.microsoft.com/en-us/nuget/release-notes/nuget-4.8-rtm "https://docs.microsoft.com/en-us/nuget/release-notes/nuget-4.8-rtm") and higher.
