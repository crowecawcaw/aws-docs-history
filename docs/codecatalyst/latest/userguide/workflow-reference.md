...
**Topics**
+ [Example of a workflow definition file](#workflow.anatomy)
+ [Syntax guidelines and conventions](#workflow.terms.syntax.conv)
+ [Top-level properties](#workflow.top.level)
