...
<a name="health-dashboard-concepts"></a>
...
### Incident
<a name="health-dashboard-incident-definition"></a>
...
### Status
<a name="health-dashboard-status-definition"></a>

The *status* is the real-time status of the incident. It will show as **Ongoing** or **Resolved**.

### Impacted capabilities
<a name="health-dashboard-impacted-capabilities-definition"></a>
...
### Updated on
<a name="health-dashboard-updated-on-definition"></a>
