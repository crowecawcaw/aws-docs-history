...
To investigate further, Mary can also view events for all CodeCatalyst APIs in the space by using the [**list-event-logs**](https://docs.aws.amazon.com/cli/latest/reference/codecatalyst/list-event-logs.html) command in the AWS CLI.
