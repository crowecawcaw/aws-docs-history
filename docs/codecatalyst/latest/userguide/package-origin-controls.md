...
![Simple graphic showing a new external package version being blocked from a public repository.](https://docs.aws.amazon.com/codecatalyst/latest/userguide/images/packages/package-origin-controls-one.png)
...
![Simple graphic showing package publishing blocked.](https://docs.aws.amazon.com/codecatalyst/latest/userguide/images/packages/package-origin-controls-two.png)
