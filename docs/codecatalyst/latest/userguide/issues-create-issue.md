...
1. (Optional) Add an existing label or create a new label and add it by choosing **\+ Add label**.
...
1. (Optional) Add an assignee by choosing **\+ Add an assignee**. You can quickly add yourself as the assignee by choosing **\+ Add me**.
**Tip**  
