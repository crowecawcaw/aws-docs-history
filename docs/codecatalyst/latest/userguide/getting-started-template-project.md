...
1. In **Application name**, leave the default of `mysfits{{string}}`.
...
1. Choose the priority, estimate, status, and labels. Under **assignee**, choose **\+Add me** to assign the issue to yourself.
