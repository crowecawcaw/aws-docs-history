...
| Maximum length of an output variable value                               | 500 characters or more, depending on the action that emits the value. NoteValues may be truncated if they exceed the action's limit. |
