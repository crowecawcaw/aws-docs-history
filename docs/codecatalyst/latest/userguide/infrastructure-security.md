...
As a managed service, Amazon CodeCatalyst is protected by AWS global network security. For
...
You use AWS published API calls to access CodeCatalyst through the network. Clients must
