...
The test action is defined as a set of YAML properties inside your workflow definition
file. For information about these properties, see [Build and test actions YAML](build-action-ref.md "build-action-ref.md") in the [Workflow YAML definition](workflow-reference.md "workflow-reference.md").
