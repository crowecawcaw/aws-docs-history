...
| Attachment size | Maximum of 500MB per attachment.<br />Maximum total attachment storage is impacted by the overall storage limits for your space. For more information, see [Pricing](https://codecatalyst.aws/explore/pricing). | 
