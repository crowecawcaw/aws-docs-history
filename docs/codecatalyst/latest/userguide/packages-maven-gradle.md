...
1. Update your `build.gradle` file with the following snippet. Replace {{space\_name}}, {{proj\_name}}, and {{repo\_name}} with your CodeCatalyst user name, space name, project name, and package repository name.
