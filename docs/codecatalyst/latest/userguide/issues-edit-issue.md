...
1. In **Labels**, you can add an existing label, create a new label, or remove a label.
   ...
   1. To create a new label and add it, choose **\+ Add label** enter the name of the label you want to create in the search field and press enter.
...
1. To assign an issue, choose **\+ Add an assignee** in the **Assignee** section, then search and choose the assignee from the list. You can choose **\+ Add me** to quickly add yourself as the assignee.
