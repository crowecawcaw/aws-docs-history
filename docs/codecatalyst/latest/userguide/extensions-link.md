...
**Topics**
+ [Linking resources from connected third-party providers](#extensions-link-resources)
+ [Linking a third-party repository to during CodeCatalyst project creation](#extensions-link-repositories-creation)
