...
**Topics**
+ [Understanding user roles for spaces and projects](ipa-role-types.md)
+ [Viewing the permissions available for each role](ipa-permissions.md)
+ [Viewing and changing user roles](ipa-roles-manage.md)