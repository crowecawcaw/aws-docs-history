...
**Topics**
+ [Setting up your project on a local machine](set-up-workspace-local.md)
+ [Testing an action](testing-action.md)
+ [Publishing an action](actions-publishing.md)
+ [Publishing a new action version](actions-update.md)
+ [Deleting an action version](deleting-action-version.md)