...
**Contents**
+ [Adding unit tests](#test-action-locally)
+ [Testing actions in workflows](#test-action-workflows)

## Adding unit tests
<a name="test-action-locally"></a>
...
<a name="test-action-workflows"></a>
...
1. Choose **\+ Actions**, choose the **Actions** dropdown menu, and then choose **Local** to view your custom action.
...
1. Choose **\+** to add your custom action to the workflow and configure the workflow to meet your requirements using the YAML editor or the visual editor. For more information, see [Build, test, and deploy with workflows in CodeCatalyst](https://docs.aws.amazon.com/codecatalyst/latest/userguide/flows.html).
