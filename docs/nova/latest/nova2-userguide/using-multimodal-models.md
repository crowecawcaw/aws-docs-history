...
| --------------- | ----------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------- |
| Image           | PNG, JPEG, GIF, WebP<br>**Note:*<br>• If you use an animated GIF or WebP file, only the first frame will be used. | Embedding data in the request<br>If you use the Converse API, encode data as bytes.<br>If you use the Invoke API, encode data as Base64 string. | 25 MB            | 5                 |
