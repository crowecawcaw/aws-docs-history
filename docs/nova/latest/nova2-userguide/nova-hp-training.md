...
Training Amazon Nova models on SageMaker AI Hyperpod supports multiple techniques including Continued
...
- [Reinforcement Fine-Tuning (RFT) on SageMaker AI Hyperpod](nova-hp-rft.md "nova-hp-rft.md")
