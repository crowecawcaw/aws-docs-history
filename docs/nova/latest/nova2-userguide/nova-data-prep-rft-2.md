...
- [Data format](#nova-2-rft-data-overview "#nova-2-rft-data-overview")
- [Sample inputs](#nova-2-rft-data-examples "#nova-2-rft-data-examples")
- [Supported features](#nova-2-rft-supported-features "#nova-2-rft-supported-features")
- [General/Text understanding](#rft-general-constraints "#rft-general-constraints")
- [Tool calling](#rft-tool-calling "#rft-tool-calling")
- [Reasoning](#rft-reasoning "#rft-reasoning")
- [Characteristics of effective training data](#nova-rft-effective-data "#nova-rft-effective-data")
- [RFT training using LLM as a judge](#nova-rft-llm-judge "#nova-rft-llm-judge")

## Data format

RFT training data follows the OpenAI Reinforcement Fine-Tuning [format](https://developers.openai.com/api/docs/guides/reinforcement-fine-tuning#prepare-your-dataset "https://developers.openai.com/api/docs/guides/reinforcement-fine-tuning#prepare-your-dataset"). Each line in your JSONL training file is a JSON object with the following top-level fields. Expand a section to learn more:
...
Optional. An array of tool specifications available to the model during this example. Each item defines a tool's interface and metadata. For a complete example, see [Tool calling](#rft-tool-calling "#rft-tool-calling").
...
RFT feature support| Feature | RFT on Amazon Nova 2 |
| --- | --- |
| Text understanding | Supported on Nova 2.0 Lite. See [General/Text understanding](#rft-general-constraints "#rft-general-constraints"). |
| Image understanding | Not supported |
| Video understanding | Not supported |
| Document understanding | Not supported |
| Tool calling | Supported on Nova 2.0 Lite. See [Tool calling](#rft-tool-calling "#rft-tool-calling"). |
| Reasoning | Supported on Nova 2.0 Lite. See [Reasoning](#rft-reasoning "#rft-reasoning"). |
