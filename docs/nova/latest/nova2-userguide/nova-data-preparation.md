...
# Data preparation
<a name="nova-data-preparation"></a>

This section provides data preparation guides for each training technique and model version.

**Topics**
+ [Validation tools](#nova-data-validation-tools)
+ [Preparing data for SFT on Amazon Nova 2](nova-data-prep-sft-2.md)
+ [Preparing data for RFT on Amazon Nova 2](nova-data-prep-rft-2.md)
+ [Preparing data for CPT on Amazon Nova 2](nova-data-prep-cpt-2.md)

## Validation tools
<a name="nova-data-validation-tools"></a>
