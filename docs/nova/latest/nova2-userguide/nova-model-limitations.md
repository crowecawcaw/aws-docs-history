...
only supported observability tool to view metrics for SageMaker training jobs.
...
more information about using TensorBoard in SageMaker, see [TensorBoard in SageMaker](../../../sagemaker/latest/dg/tensorboard-on-sagemaker.md "../../../sagemaker/latest/dg/tensorboard-on-sagemaker.md").
