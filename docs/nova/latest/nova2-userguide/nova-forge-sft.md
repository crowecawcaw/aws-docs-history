...
To mix in Nova data, you simply need to add a data_mixing block to your recipe YAML file, under the training_config section. Text and multi-modal data mixing blocks have different content. Please refer to corresponding recipes.
