...
2. Navigate to the SageMaker AI AI console and [request access to Amazon Nova Forge](nova-forge.md "nova-forge.md").
3. Wait for the Amazon Nova team to email a confirmation after the subscription request is
   approved.
4. Tag your SageMaker AI Hyperpod execution role with the `forge-subscription` tag.
...
## Set up SageMaker AI Hyperpod infrastructure

Once your Amazon Nova Forge subscription is approved, set up the necessary SageMaker SageMaker AI Hyperpod infrastructure to use Forge-enabled features. For detailed instructions on creating a SageMaker AI Hyperpod EKS cluster with a restricted instance group (RIG), follow the [workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/dcac6f7a-3c61-4978-8344-7535526bf743/en-US "https://catalog.us-east-1.prod.workshops.aws/workshops/dcac6f7a-3c61-4978-8344-7535526bf743/en-US") instructions.
