...
If you do not have an AWS account, complete the following steps to create one. Alternatively, you can start building for free with Amazon Nova at [nova.amazon.com/dev](https://nova.amazon.com/dev).
