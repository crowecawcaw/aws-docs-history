...
For information about setting up Amazon Nova endpoints on SageMaker Inference, see [Deploy Amazon Nova models on SageMaker](../userguide/deploy-sagemaker.md "../userguide/deploy-sagemaker.md"). For information about container features and configuration, see [Container features](../userguide/container-features.md "../userguide/container-features.md").
