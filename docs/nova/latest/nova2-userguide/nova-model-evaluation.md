...
CPT evaluation takes advantage of the existing [Bring Your Own Dataset](#nova-model-evaluation-config-byo "#nova-model-evaluation-config-byo") workflow. Data must be formatted in the "query response" format in a JSONL file separated by new lines.
