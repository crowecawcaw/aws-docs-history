...
![Bi-directional streaming flow between user, client, and Amazon Bedrock with audio and text.](https://docs.aws.amazon.com/nova/latest/nova2-userguide/images/Event-Lifecycle-Diagram_1.png)
