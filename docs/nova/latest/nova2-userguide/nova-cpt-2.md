...
With CPT on Nova 2.0 Lite, you can extend these advanced capabilities with your
domain-specific data and develop deep expertise in specialized areas
while maintaining the model's superior reasoning and analytical abilities.

The following is a sample recipe for CPT. You can find this recipe and others in the [SageMaker HyperPod recipes](https://github.com/aws/sagemaker-hyperpod-recipes/tree/main/recipes_collection/recipes/training/nova "https://github.com/aws/sagemaker-hyperpod-recipes/tree/main/recipes_collection/recipes/training/nova") repository on GitHub.
...
For information about the data format, supported features, constraints, and best practices for preparing CPT training data, see
