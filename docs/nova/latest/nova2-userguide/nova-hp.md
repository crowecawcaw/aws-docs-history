...
**Topics**
+ [Compute requirements for Amazon Nova 2 models](#nova-hp-compute-2)
+ [Best Practices for Amazon Nova customization](#best-practices)
...
+ [Pre-training for Amazon Nova models](nova-hp-training.md)
+ [Fine-tuning for Amazon Nova models](nova-hp-fine-tuning.md)
