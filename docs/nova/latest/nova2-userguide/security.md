...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon Nova, see [AWS Services in Scope by Compliance Program](https://aws.amazon.com/compliance/services-in-scope/ "https://aws.amazon.com/compliance/services-in-scope/").
- **Security in the cloud** – Your responsibility is
  ...
  regulations.
  Because Amazon Nova is available through Amazon Bedrock, follow all security guidance at [Security in
  Amazon Bedrock](../../../bedrock/latest/userguide/security.md "../../../bedrock/latest/userguide/security.md").
