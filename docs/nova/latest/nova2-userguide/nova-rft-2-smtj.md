...
Use the SageMaker training job notebook template: [Use a SageMaker AI estimator to run a training job](../../../sagemaker/latest/dg/nova-fine-tuning-training-job.md#nova-model-training-jobs-notebook "../../../sagemaker/latest/dg/nova-fine-tuning-training-job.md#nova-model-training-jobs-notebook").
