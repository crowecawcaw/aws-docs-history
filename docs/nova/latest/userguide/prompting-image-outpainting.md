...
![Amazon coffee maker](https://docs.aws.amazon.com/nova/latest/userguide/images/amazon-coffee-maker-1.png)
...
![Background replacement image](https://docs.aws.amazon.com/nova/latest/userguide/images/background-replacement-mask-prompt-example-1.png)
...
![mask image](https://docs.aws.amazon.com/nova/latest/userguide/images/three_pots-remove_mask_INVERTED.png)


**Result**

![Mask item moved to a new background](https://docs.aws.amazon.com/nova/latest/userguide/images/potted.png)
