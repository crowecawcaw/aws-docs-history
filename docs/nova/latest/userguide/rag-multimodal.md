...
_Creating a vector database using multimodal
embeddings._

You can create a vector database of multimodal data by using an embeddings model
such as [Titan multimodal embeddings](../../../bedrock/latest/userguide/titan-multiemb-models.md "../../../bedrock/latest/userguide/titan-multiemb-models.md"). To do this, you first need to parse
...
_Creating a vector database using text embeddings._

To use a text embeddings model you can use Amazon Nova to convert images into text.
Then you create a vector database by using a text embeddings model such as the
[Titan Text Embeddings V2 model.](../../../bedrock/latest/userguide/titan-embedding-models.md "../../../bedrock/latest/userguide/titan-embedding-models.md")
...
descriptions. To create a text description use Amazon Nova through the [Converse API](../../../bedrock/latest/userguide/conversation-inference-call.md "../../../bedrock/latest/userguide/conversation-inference-call.md") with a prompt such as:
...
_Running inference in RAG systems for Amazon Nova_
...
Amazon Bedrock Knowledge Bases](rag-br-knowledge.md "rag-br-knowledge.md") or build a [Custom RAG system with Amazon Nova and Converse
API](rag-building.md "rag-building.md").
