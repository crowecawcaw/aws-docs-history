...
| distillation\_data                             | Enables data distillation job, do not modify this<br>field.                                                                                                                                                                                                                                          |
...
| top\_p                                         | Cumulative probability threshold for token sampling (0.9<br>is recommended).                                                                                                                                                                                                                         |
| customer\_bucket                               | Amazon S3 bucket for input/output data.                                                                                                                                                                                                                                                              |
| kms\_key                                       | AWS KMS key to encrypt output in S3, This needed by Bedrock<br>batch inference to store output returned by inference<br>job.                                                                                                                                                                         |
