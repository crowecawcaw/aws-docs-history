...
| rubric_llm_judge    | Text                | Rubric Judge is an enhanced LLM-as-a-judge evaluation model built on Nova 2.0<br>Lite. Unlike the [original judge model](https://aws.amazon.com/blogs/machine-learning/evaluating-generative-ai-models-with-amazon-nova-llm-as-a-judge-on-amazon-sagemaker-ai/ "https://aws.amazon.com/blogs/machine-learning/evaluating-generative-ai-models-with-amazon-nova-llm-as-a-judge-on-amazon-sagemaker-ai/") that only provides preference verdicts, Rubric Judge<br>dynamically generates custom evaluation criteria tailored to each prompt and assigns<br>granular scores across multiple dimensions. | all         | judge    | No                |
