...
- [Hyperparameters for Understanding models](fine-tune-hyperparameters-understanding-models.md "fine-tune-hyperparameters-understanding-models.md")
- [Hyperparameters for Creative Content Generation models](fine-tune-hyperparameters-content-generation-models.md "fine-tune-hyperparameters-content-generation-models.md")
...
- **Distillation:** Amazon Nova Lite and Amazon Nova Pro can be used to generate training data for fine-tuning Amazon Nova Micro models. This method can be very effective if the larger models are already highly capable at the target task.
