...
- [Preparing data for fine-tuning Creative Content Generation models](fine-tune-prepare-data-creative-content.md "fine-tune-prepare-data-creative-content.md")
- [Selecting hyperparameters](customize-fine-tune-hyperparameters.md "customize-fine-tune-hyperparameters.md")

## Available models

Fine-tuning is available for the following Amazon Nova models and
...
1. Create a training dataset and a
   validation dataset (if applicable) for your customization task. For more information about preparing data, see the following:
   - [Preparing data for fine-tuning Understanding models](fine-tune-prepare-data-understanding.md "fine-tune-prepare-data-understanding.md")
   - [Preparing data for fine-tuning Creative Content Generation models](fine-tune-prepare-data-creative-content.md "fine-tune-prepare-data-creative-content.md")
