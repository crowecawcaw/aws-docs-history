...
| --- |--- |--- |
| Video | MP4, MOV, MKV, WebM, FLV, MPEG, MPG, WMV, 3GP | Base64<br />*Recommended for payload size less than 25 MB* | 
|  |  | Amazon S3 URI<br />*Recommended for payloads greater than 25 MB up to 2 GB. Individual files must be 1 GB or smaller.* | 
...
Note that for 3GP file format, the "format" field passed in the API request should be of the format "three\_gp".
