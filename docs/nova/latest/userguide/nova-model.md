...
This documentation is for Amazon Nova Version 1. Amazon Nova 2 is now available with new models and enhanced capabilities. For information on how to customize Amazon Nova 2, visit [Customizing Amazon Nova 2 models](../nova2-userguide/nova-model.md "../nova2-userguide/nova-model.md").

You can customize [Amazon Nova models](what-is-nova.md "what-is-nova.md"), including the enhanced Amazon Nova 2.0 models, through [recipes](nova-model-recipes.md#nova-model-get-recipes "nova-model-recipes.md#nova-model-get-recipes") and train them on SageMaker. These recipes
...
evaluation, and deployment for inference. This model customization approach on SageMaker provides
...
- [**SageMaker training jobs**](../../../sagemaker/latest/dg/how-it-works-training.md "../../../sagemaker/latest/dg/how-it-works-training.md") provides a
