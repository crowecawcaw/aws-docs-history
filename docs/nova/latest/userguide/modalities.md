...
| Text Document<br>_(Converse API Only)_  | CSV, XLS, XLSX, HTML, TXT, MD, DOC            | Bytes<br>Amazon S3 URI  | Textual Understanding from the document only. |
| Media Document<br>_(Converse API Only)_ | PDF, DOCX                                     | Bytes<br>Amazon S3 URI  | Text with interleaved Image Understanding     |
...
Because 25 MB is the overall payload limit, ensure that you account for the base64
...
`s3Location` should alleviate many storage issues.
