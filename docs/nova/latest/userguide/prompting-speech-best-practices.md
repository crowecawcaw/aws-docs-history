...
**Topics**
+ [Voice-specific prompting techniques](prompting-speech-voice-language.md)
+ [Speech-friendly content techniques](prompting-speech-bp-speech.md)
+ [System role adaptation](prompting-speech-bp-sysrole.md)
+ [Chain-of-thought for speech](prompting-speech-bp-reasoning.md)
+ [External tool integration](prompting-speech-bp-tools.md)
+ [Prompt techniques to avoid](prompting-speech-bp-avoid.md)