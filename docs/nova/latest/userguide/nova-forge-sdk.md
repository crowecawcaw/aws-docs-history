...
The SageMaker Python SDK v3.0 introduces a modern, modular API for training,
...
- No more finding the right recipes or container URI for your training
  techniques.
- Bring your own training recipes or use the defaults
...
| ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Continued Pre-training                         | [All Nova Models](nova-model-recipes.md#nova-model-get-recipes "nova-model-recipes.md#nova-model-get-recipes") (SMHP only) |
| Supervised Fine-tuning LoRA                    | [All Nova Models](nova-model-recipes.md#nova-model-get-recipes "nova-model-recipes.md#nova-model-get-recipes")             |
| Supervised Fine-tuning Full-Rank               | [All Nova Models](nova-model-recipes.md#nova-model-get-recipes "nova-model-recipes.md#nova-model-get-recipes")             |
...
for the `nova-textgeneration-lite` model.
