...
by setting the `model_importance_score` in your [hyperparameters](nova-fine-tune-1.md#nova-model-hyperparameter "nova-fine-tune-1.md#nova-model-hyperparameter"). For example:
...
inference](deploy-custom-model.md "deploy-custom-model.md").
