...
**Topics**
+ [Example video generation prompts](#prompting-video-examples)
+ [Image-based video generation prompts](prompting-video-image-prompts.md)
+ [Camera controls](prompting-video-camera-control.md)
...
### Photorealistic video of a cheeseburger
