...
+ [Unleashing Creativity: Mastering Nova Canvas and Nova Reel for creative success](https://catalog.us-east-1.prod.workshops.aws/workshops/66a0984a-ad2b-481f-a1cf-e7896ea9595b/en-US)
+ [Amazon Nova multimodal understanding workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/012d9c20-25dc-4065-bdb6-50e935e8bd9f)
+ [Amazon Nova Sonic (speech-to-speech) Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/5238419f-1337-4e0f-8cd7-02239486c40d/)

The following GitHub resources are available for Amazon Nova:
+ [Multimodal generation examples](https://github.com/aws-samples/amazon-nova-samples/tree/main/multimodal-generation)
+ [Multimodal understanding examples](https://github.com/aws-samples/amazon-nova-samples/tree/main/multimodal-understanding)
+ [Speech to speech examples](https://github.com/aws-samples/amazon-nova-samples/tree/main/speech-to-speech)
+ [Amazon Nova samples repository](https://github.com/aws-samples/amazon-nova-samples/tree/main)

The following documentation resources will help you when using Amazon Nova.

**Amazon Bedrock links**
+ Getting Started in the [Amazon Bedrock console](http://(https//docs.aws.amazon.com/bedrock/latest/userguide/getting-started-console.html)
+ Getting Started with the [API](https://docs.aws.amazon.com/bedrock/latest/userguide/getting-started-api.htm)
...
+ Using [Amazon Bedrock Knowledge Bases](https://docs.aws.amazon.com/bedrock/latest/userguide/knowledge-base.html)
+ Using [Amazon Bedrock Agents](https://docs.aws.amazon.com/bedrock/latest/userguide/agents.html)
+ [Customization of Amazon Bedrock models](https://docs.aws.amazon.com/bedrock/latest/userguide/custom-models.html)
