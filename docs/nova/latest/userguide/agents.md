...
**Topics**
+ [Using Amazon Nova as a foundation model in an AI agent](agents-use-nova.md)
+ [Using Amazon Nova with AgentCore](#agents-agentcore)
+ [Using Amazon Nova with Strands](#agents-strands)
+ [Additional Resources](#agents-resources)
