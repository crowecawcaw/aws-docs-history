...
| Role |  | Prompt | 
| --- |--- |--- |
| User | Provide details about the best selling full-frame cameras in past three years. Answer in JSON format with keys like name, brand, price and a summary. | Provide details about the best selling full-frame cameras in past three years. You MUST answer in JSON format only. Please follow the output schema below.<br />**Output Schema:**<pre>[{<br />    "name": "name goes here",<br />    "brand": "brand goes here",<br />    "price": "price goes here",<br />    "summary": "summary goes here"<br />}]</pre> | 
