...
<a name="jira"></a>
 ...
 The connector provides both Automatic and Manual syncing. For more detail, see [Configuring the connector.](configuring-jira.md) 
...
+  **Label:** Pillar 
 ...
 After you set up Jira account syncing in the **Settings** page, you can [configure the Jira connector](configuring-jira.md) and [sync improvement items to your Jira account](syncing-workload.md). 