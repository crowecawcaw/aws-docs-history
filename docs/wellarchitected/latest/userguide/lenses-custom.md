...
**Topics**
+ [Viewing custom lenses in AWS WA Tool](lenses-viewing.md)
+ [Creating a custom lens for a workload in AWS WA Tool](lenses-create.md)
+ [Previewing a custom lens for a workload in AWS WA Tool](lenses-preview.md)
+ [Publishing a custom lens in AWS WA Tool for the first time](lenses-publish.md)
+ [Publishing an update to a custom lens in AWS WA Tool](lenses-publish-update.md)
+ [Sharing a custom lens in AWS WA Tool](lenses-sharing.md)
+ [Adding tags to a custom lens in AWS WA Tool](lenses-tagging.md)
+ [Deleting a custom lens in AWS WA Tool](lenses-deleting.md)
+ [Lens format specification in AWS WA Tool](lenses-format-specification.md)