...
<a name="wat-info-in-cloudtrail"></a>
...
All AWS WA Tool actions are logged by CloudTrail and are documented in [Actions Defined by AWS Well-Architected Tool](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_awswell-architectedtool.html#awswell-architectedtool-actions-as-permissions). For example, calls to the `CreateWorkload`, `DeleteWorkload`, and `CreateWorkloadShare` actions generate entries in the CloudTrail log files. 
...
<a name="understanding-wat-entries"></a>
