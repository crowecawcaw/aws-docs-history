...
- **Security in the cloud** – Your responsibility is
  ...
  to monitor and secure your AWS WA Tool resources.

###### Topics

- [Data protection in AWS Well-Architected Tool](data-protection.md "data-protection.md")
- [Identity and access management for AWS Well-Architected Tool](security-iam.md "security-iam.md")
- [Incident response in AWS Well-Architected Tool](incident-response.md "incident-response.md")
- [Compliance validation for AWS Well-Architected Tool](wat-compliance.md "wat-compliance.md")
