...
+  **[Lens Catalog](lens-catalog.md):** Official lenses that are created and maintained by AWS. The Lens Catalog is available to all users and does not require any additional installation to use. 
+  **[Custom lenses](lenses-custom.md):** User-defined lenses that are not AWS official content. You can [create custom lenses](lenses-create.md) with your own pillars, questions, best practices, and improvement plans, as well as [share custom lenses](lenses-sharing.md) with other AWS accounts. 
