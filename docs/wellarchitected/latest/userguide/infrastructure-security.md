...
As a managed service, AWS Well-Architected Tool is protected by AWS global network security. For
...
Protection](../security-pillar/infrastructure-protection.md "../security-pillar/infrastructure-protection.md") in _Security Pillar AWS Well‐Architected
Framework_.

You use AWS published API calls to access AWS WA Tool through the network. Clients must
