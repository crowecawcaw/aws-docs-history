...
1. Select the name of the review template you want to define a workload from.
...
1. On the **Select review template** step, select the review template card, and choose **Next**.
