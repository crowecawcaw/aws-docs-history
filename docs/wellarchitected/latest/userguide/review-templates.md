...
You can [create a review template](creating-a-review-template.md) to answer common best practice questions or create notes, which can be shared with another IAM user or account, or an organization or organizational unit in the same AWS Region. You can [define a workload from a review template](define-workload-from-template.md), which helps scale common best practices and reduce redundancy across your workloads.