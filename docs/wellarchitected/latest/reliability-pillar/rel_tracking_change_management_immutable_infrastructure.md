...
![Diagram showing blue/green deployment with AWS Elastic Beanstalk and Amazon Route 53](https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/images/blue-green-deployment.png)
