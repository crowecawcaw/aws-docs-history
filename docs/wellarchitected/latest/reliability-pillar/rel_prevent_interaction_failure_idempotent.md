...
- [REL05-BP03
  Control and limit retry calls](rel_mitigate_interaction_failure_limit_retries.md "rel_mitigate_interaction_failure_limit_retries.md")
- [REL06-BP01
  Monitor all components for the workload (Generation)](rel_monitor_aws_resources_monitor_resources.md "rel_monitor_aws_resources_monitor_resources.md")
- [REL06-BP03
...
- [REL08-BP02
  Integrate functional testing as part of your deployment](rel_tracking_change_management_functional_testing.md "rel_tracking_change_management_functional_testing.md")
