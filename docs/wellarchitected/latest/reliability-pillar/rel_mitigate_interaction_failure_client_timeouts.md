...
Client connections time out based on configured values. After encountering a timeout, clients make decisions to back off and retry or open a [circuit breaker](https://martinfowler.com/bliki/CircuitBreaker.html "https://martinfowler.com/bliki/CircuitBreaker.html"). These patterns avoid issuing requests that may exacerbate an underlying error condition.
...
Take advantage of well-established design patterns like retries and circuit breakers to handle timeouts gracefully and support fail-fast approaches. [AWS SDKs](../../../index.md#sdks "../../../index.md#sdks") and [AWS CLI](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/") allow for configuration of both connection and request timeouts and for retries with exponential backoff and jitter. [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") functions support configuration of timeouts, and with [AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/"), you can build low code circuit breakers that take advantage of pre-built integrations with AWS services and SDKs. [AWS App Mesh](https://aws.amazon.com/app-mesh/ "https://aws.amazon.com/app-mesh/") Envoy provides timeout and circuit breaker capabilities.
...
- When your workload makes calls with an AWS SDK, review the documentation for language specific timeout configuration.
  ...
  - [PHP](../../../aws-sdk-php/v3/api/class-Aws.DefaultsMode.md "../../../aws-sdk-php/v3/api/class-Aws.DefaultsMode.md")
  - [.NET](../../../sdk-for-net/v3/developer-guide/retries-timeouts.md "../../../sdk-for-net/v3/developer-guide/retries-timeouts.md")
  - [Ruby](../../../sdk-for-ruby/v3/developer-guide/timeout-duration.md "../../../sdk-for-ruby/v3/developer-guide/timeout-duration.md")
  - [Java](../../../sdk-for-java/latest/developer-guide/best-practices.md#bestpractice5 "../../../sdk-for-java/latest/developer-guide/best-practices.md#bestpractice5")
  - [Go](https://aws.github.io/aws-sdk-go-v2/docs/configuring-sdk/retries-timeouts/#timeouts "https://aws.github.io/aws-sdk-go-v2/docs/configuring-sdk/retries-timeouts/#timeouts")
  - [Node.js](../../../AWSJavaScriptSDK/latest/AWS/Config.md "../../../AWSJavaScriptSDK/latest/AWS/Config.md")
  - [C++](../../../sdk-for-cpp/v1/developer-guide/client-config.md "../../../sdk-for-cpp/v1/developer-guide/client-config.md")

- When using AWS SDKs or AWS CLI commands in your workload, configure default timeout values by setting the AWS [configuration defaults](../../../sdkref/latest/guide/feature-smart-config-defaults.md "../../../sdkref/latest/guide/feature-smart-config-defaults.md") for `connectTimeoutInMillis` and `tlsNegotiationTimeoutInMillis`.
- Apply [command line options](../../../cli/latest/userguide/cli-configure-options.md "../../../cli/latest/userguide/cli-configure-options.md") `cli-connect-timeout` and `cli-read-timeout` to control one-off AWS CLI commands to AWS services.
...
- Implement [CloudWatch Metrics](../../../AmazonCloudWatch/latest/monitoring/working_with_metrics.md "../../../AmazonCloudWatch/latest/monitoring/working_with_metrics.md") and [CloudWatch anomaly detection](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md") on call error rates, service level objectives for latency, and latency outliers to provide insight into managing overly aggressive or permissive timeouts.
- Configure timeouts on [Lambda functions](../../../lambda/latest/dg/configuration-function-common.md#configuration-timeout-console "../../../lambda/latest/dg/configuration-function-common.md#configuration-timeout-console").
- API Gateway clients must implement their own retries when handling timeouts. API Gateway supports a [50 millisecond to 29 second integration timeout](../../../apigateway/latest/developerguide/limits.md#api-gateway-execution-service-limits-table "../../../apigateway/latest/developerguide/limits.md#api-gateway-execution-service-limits-table") for downstream integrations and does not retry when integration requests timeout.
- Implement the [circuit breaker](https://martinfowler.com/bliki/CircuitBreaker.html "https://martinfowler.com/bliki/CircuitBreaker.html") pattern to avoid making remote calls when they are timing out. Open the circuit to avoid failing calls and close the circuit when calls are responding normally.
- For container based workloads, review [App Mesh Envoy](../../../app-mesh/latest/userguide/envoy.md "../../../app-mesh/latest/userguide/envoy.md") features to leverage built in timeouts and circuit breakers.
...
- [AWS SDK: Retries and Timeouts](../../../sdk-for-net/v3/developer-guide/retries-timeouts.md "../../../sdk-for-net/v3/developer-guide/retries-timeouts.md")
- [The
  Amazon Builders' Library: Timeouts, retries, and backoff with
  jitter](https://aws.amazon.com/builders-library/timeouts-retries-and-backoff-with-jitter/ "https://aws.amazon.com/builders-library/timeouts-retries-and-backoff-with-jitter/")
- [Amazon API Gateway quotas and important notes](../../../apigateway/latest/developerguide/limits.md "../../../apigateway/latest/developerguide/limits.md")
- [AWS Command Line Interface: Command line options](../../../cli/latest/userguide/cli-configure-options.md "../../../cli/latest/userguide/cli-configure-options.md")
- [AWS SDK for Java 2.x: Configure API Timeouts](../../../sdk-for-java/latest/developer-guide/best-practices.md#bestpractice5 "../../../sdk-for-java/latest/developer-guide/best-practices.md#bestpractice5")
- [AWS Botocore using the config object and Config Reference](https://boto3.amazonaws.com/v1/documentation/api/latest/guide/configuration.html#using-the-config-object "https://boto3.amazonaws.com/v1/documentation/api/latest/guide/configuration.html#using-the-config-object")
- [AWS SDK for .NET: Retries and Timeouts](../../../sdk-for-net/v3/developer-guide/retries-timeouts.md "../../../sdk-for-net/v3/developer-guide/retries-timeouts.md")
- [AWS Lambda: Configuring Lambda function options](../../../lambda/latest/dg/configuration-function-common.md "../../../lambda/latest/dg/configuration-function-common.md")

**Related examples:**

- [Using the circuit breaker pattern with AWS Step Functions and Amazon DynamoDB](https://aws.amazon.com/blogs/compute/using-the-circuit-breaker-pattern-with-aws-step-functions-and-amazon-dynamodb/ "https://aws.amazon.com/blogs/compute/using-the-circuit-breaker-pattern-with-aws-step-functions-and-amazon-dynamodb/")
- [Martin Fowler: CircuitBreaker](https://martinfowler.com/bliki/CircuitBreaker.html?ref=wellarchitected "https://martinfowler.com/bliki/CircuitBreaker.html?ref=wellarchitected")

**Related tools:**

- [AWS SDKs](../../../index.md#sdks "../../../index.md#sdks")
