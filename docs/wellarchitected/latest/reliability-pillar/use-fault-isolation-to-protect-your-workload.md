...
- [REL10-BP02 Automate recovery for components constrained to a single location](rel_fault_isolation_single_az_system.md "rel_fault_isolation_single_az_system.md")
- [REL10-BP03 Use bulkhead architectures to limit scope of impact](rel_fault_isolation_use_bulkhead.md "rel_fault_isolation_use_bulkhead.md")
