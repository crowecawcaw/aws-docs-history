...
- [REL07-BP04
  Load test your workload](rel_adapt_to_changes_load_tested_adapt.md "rel_adapt_to_changes_load_tested_adapt.md")
- [REL08-BP03
  Integrate resiliency testing as part of your deployment](rel_tracking_change_management_resiliency_testing.md "rel_tracking_change_management_resiliency_testing.md")
- [REL12-BP04
