...
- Verify that [services are idempotent](https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/ "https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/") before implementing retries. Once retries are implemented, be sure they are both tested and regularly exercise in production.
- When calling AWS service APIs, use the [AWS SDKs](../../../sdkref/latest/guide/feature-retry-behavior.md "../../../sdkref/latest/guide/feature-retry-behavior.md") and [AWS CLI](../../../cli/latest/userguide/cli-configure-retries.md "../../../cli/latest/userguide/cli-configure-retries.md") and understand the retry configuration options. Determine if the defaults work for your use case, test, and adjust as needed.
...
- [Making retries safe with idempotent APIs](https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/ "https://aws.amazon.com/builders-library/making-retries-safe-with-idempotent-APIs/")

**Related examples:**

- [Spring Retry](https://github.com/spring-projects/spring-retry "https://github.com/spring-projects/spring-retry")
- [Resilience4j Retry](https://resilience4j.readme.io/docs/retry "https://resilience4j.readme.io/docs/retry")
...
- [AWS SDKs and Tools: Retry behavior](../../../sdkref/latest/guide/feature-retry-behavior.md "../../../sdkref/latest/guide/feature-retry-behavior.md")
- [AWS Command Line Interface: AWS CLI retries](../../../cli/latest/userguide/cli-configure-retries.md "../../../cli/latest/userguide/cli-configure-retries.md")
