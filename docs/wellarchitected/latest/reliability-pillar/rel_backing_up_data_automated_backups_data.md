...
include [Amazon DynamoDB](../../../amazondynamodb/latest/developerguide/PointInTimeRecovery_Howitworks.md "../../../amazondynamodb/latest/developerguide/PointInTimeRecovery_Howitworks.md"), [Amazon RDS](../../../AmazonRDS/latest/UserGuide/USER_PIT.md "../../../AmazonRDS/latest/UserGuide/USER_PIT.md"),
and [Amazon
Keyspaces (for Apache Cassandra)](../../../keyspaces/latest/devguide/PointInTimeRecovery.md "../../../keyspaces/latest/devguide/PointInTimeRecovery.md") – these can be restored to a
...
once turned on, is automatic. [Amazon Data Lifecycle Manager](../../../AWSEC2/latest/UserGuide/snapshot-lifecycle.md "../../../AWSEC2/latest/UserGuide/snapshot-lifecycle.md") can be used to automate the creation, copy and deletion of Amazon EBS snapshots.
...
3. **Use an automated backup solution or
   ...
   cloud, and on-premises](../../../aws-backup/latest/devguide/creating-a-backup.md#creating-automatic-backups "../../../aws-backup/latest/devguide/creating-a-backup.md#creating-automatic-backups"). Using backup plans in
   ...
   [Testing Backup and Restore of Data](https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/ "https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/").
