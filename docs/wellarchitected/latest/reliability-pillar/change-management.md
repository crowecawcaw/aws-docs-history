...
**Topics**
+ [Monitor workload resources](monitor-workload-resources.md)
+ [Design your workload to adapt to changes in demand](design-your-workload-to-adapt-to-changes-in-demand.md)
+ [Implement change](implement-change.md)