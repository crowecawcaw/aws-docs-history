...
- [REL05-BP01 Implement graceful degradation to transform applicable hard dependencies into soft dependencies](../framework/rel_mitigate_interaction_failure_graceful_degradation.md "../framework/rel_mitigate_interaction_failure_graceful_degradation.md")
...
- [REL11-BP05 Use static stability to prevent bimodal behavior](rel_withstand_component_failures_static_stability.md "rel_withstand_component_failures_static_stability.md")
