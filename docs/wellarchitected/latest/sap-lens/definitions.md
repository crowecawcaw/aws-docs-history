...
| Services (AWS services) | Over 200 cloud services that are used in combinations tailored to business or organizational needs. For information about many AWS services, see the [Overview of Amazon Web Services whitepaper](https://docs.aws.amazon.com/whitepapers/latest/aws-overview/introduction.html). | Amazon EC2, Amazon S3, Amazon EFS | 
