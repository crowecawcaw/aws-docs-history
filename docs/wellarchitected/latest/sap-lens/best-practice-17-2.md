...
![Three availability zones each with subnets, application instances at 50% capacity, and database instances.](images/example-three-availability-zone-architecture.png)
