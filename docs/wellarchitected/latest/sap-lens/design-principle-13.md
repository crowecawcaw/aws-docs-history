...
| ☐ BP 13.3 | Highly Recommended | Select architectures which allow for independent scaling of systems or components | 
| ☐ BP 13.4 | Highly Recommended | Choose instance location for performance considering network performance and latency | 
