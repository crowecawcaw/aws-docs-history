...
1. Gather your SAP-specific design documentation, operational procedures, and monitoring history (where available).

1. Compare your SAP workload implementation and operations to the best practices described in this document.

1. For each best practice, record whether it has been followed and prioritize evaluating those that are required.

1. Use the provided suggestions as solutions to address the areas where your workload is not well-architected.
...
+  For areas that require further in-depth analysis or assistance with remediation: Contact AWS Professional Services or consult with AWS Partners on the [AWS SAP Certified Partner List](https://aws.amazon.com/sap/partner-solutions). 

 For more details, see the following links and information: 
+  AWS Documentation: [The Review Process - AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/framework/the-review-process.html) 