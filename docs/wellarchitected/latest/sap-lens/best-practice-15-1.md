...
| --- | --- | 
| SUSE Linux Enterprise Server |  SAP Note: [1275776 - Linux: Preparing SLES for SAP environments](https://launchpad.support.sap.com/#/notes/1275776) [Requires SAP Portal Access]  | 
| Red Hat Enterprise Linux  |  SAP Note: [2777782 - SAP HANA DB: Recommended OS Settings for RHEL 8](https://launchpad.support.sap.com/#/notes/2777782) [Requires SAP Portal Access]  | 
| Microsoft Windows |  (Consult SAP or Vendor documentation for guidance)  | 
| Oracle Enterprise Linux |  SAP Note: [2478541 - Operating System Requirements for Oracle Database](https://launchpad.support.sap.com/#/notes/2478541) [Requires SAP Portal Access]  | 
