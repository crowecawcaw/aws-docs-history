...
encrypt data at rest and in transit using at least one encryption mechanism to meet internal
or external security requirements and controls. In addition to the controls listed in the
[AWS Shared
Responsibility Model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/"), AWS provides multiple encryption solutions. Many AWS
services have features which allow you to enable encryption with minimal effort and
