...
1. Classify data by its usage. Data can belong to several
...
2. Deploy a vector data store into a secure VPC, setting
   ...
   model-XX-RAG).
3. Develop a data ingestion pipeline which obfuscates or
...
4. Create least-privilege access policies for foundation
...
5. Test access to data using curated prompts designed to
...
- [Protect
  Data at Rest Using Encryption](../../../sagemaker/latest/dg/encryption-at-rest.md "../../../sagemaker/latest/dg/encryption-at-rest.md")
- [Data Protection in Amazon SageMaker AI](../../../sagemaker/latest/dg/data-protection.md "../../../sagemaker/latest/dg/data-protection.md")
