 ...
 **Benefits of establishing this best practice:** [Automatically recover from failure](https://docs.aws.amazon.com/wellarchitected/latest/framework/rel-dp.html) - Implementing recovery logic in generative AI workflows helps to reduce potentially blocking failures, while encouraging generative AI applications to gracefully recover automatically. 
...
1. Create continuous improvement process:
 ...
 **Related documents:** 
+  [Demo - Amazon Bedrock Flows](https://www.youtube.com/watch?v=_Bmk6peAHao) 
