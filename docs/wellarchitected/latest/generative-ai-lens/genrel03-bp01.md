...
practice:**
[Automatically
recover from failure](../framework/rel-dp.md "../framework/rel-dp.md") - Implementing recovery logic in
...
* Amazon Bedrock Flows](https://www.youtube.com/watch?v=_Bmk6peAHao "https://www.youtube.com/watch?v=_Bmk6peAHao")

- [Build
  an end-to-end generative AI workflow with Amazon Bedrock
  Flows](../../../bedrock/latest/userguide/flows.md "../../../bedrock/latest/userguide/flows.md")

**Related examples:**

- [Amazon Bedrock Flows is now generally available with enhanced safety
  and traceability](https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-flows-is-now-generally-available-with-enhanced-safety-and-traceability/ "https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-flows-is-now-generally-available-with-enhanced-safety-and-traceability/")
- [Simplifying
  the Prompts Lifecycle with Prompt Management and Prompt Flows
  for Amazon Bedrock Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/c81935bc-0b43-4bd6-bd01-db45f847d6bd/en-US "https://catalog.us-east-1.prod.workshops.aws/workshops/c81935bc-0b43-4bd6-bd01-db45f847d6bd/en-US")
