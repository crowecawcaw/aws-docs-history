 ...
 **Benefits of establishing this best practice:** [Apply security at all layers](https://docs.aws.amazon.com/wellarchitected/latest/framework/sec-design.html) - Prompt catalogs implement security at the prompt management layer of the generative AI workload. 
...
1.  Define the name, description, and encryption of that prompt. 

1.  Draft the prompt, specifying variables and hyperparameters. 

1.  Test the prompt against one or more foundation models. 

1.  Save an acceptable version of the prompt. 

1.  Revisit prompt engineering and testing regularly to verify your prompts behave as expected. 
