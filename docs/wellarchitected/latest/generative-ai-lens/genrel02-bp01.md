 ...
 **Benefits of establishing this best practice:** [Scale horizontally to increase aggregate workload availability](https://docs.aws.amazon.com/wellarchitected/latest/framework/rel-dp.html) across multiple components using a reliable network backbone. 
...
1. Design redundant network topology:
...
1. Implement private networking:
...
1. Test and validate redundancy:
