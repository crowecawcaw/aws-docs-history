...
**Topics**
+ [GENOPS04-BP01 Automate generative AI application lifecycle with infrastructure as code (IaC)](genops04-bp01.md)
+ [GENOPS04-BP02 Implement GenAIOps to optimize the application lifecycle](genops04-bp02.md)