...
_golden dataset_, is data considered to be
...
- [MLPER03](../machine-learning-lens/mlper-03.md "../machine-learning-lens/mlper-03.md")
- [MLPER04](../machine-learning-lens/mlper-04.md "../machine-learning-lens/mlper-04.md")
- [MLPER16](../machine-learning-lens/mlper-16.md "../machine-learning-lens/mlper-16.md")

**Related documents:**

- [Understand
  options for evaluating large language models with SageMaker AI
  Clarify](../../../sagemaker/latest/dg/clarify-foundation-model-evaluate.md "../../../sagemaker/latest/dg/clarify-foundation-model-evaluate.md")
- [Customize
