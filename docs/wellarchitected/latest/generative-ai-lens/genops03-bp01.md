...
practice:**
[Safely
automate where possible](../framework/oe-design-principles.md "../framework/oe-design-principles.md") - Automate prompt management,
...
using the
[SDK
APIs](../../../bedrock/latest/userguide/sdk-general-information-section.md "../../../bedrock/latest/userguide/sdk-general-information-section.md").
...
- [Evaluating
  ...
  Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/evaluating-prompts-at-scale-with-prompt-management-and-prompt-flows-for-amazon-bedrock/ "https://aws.amazon.com/blogs/machine-learning/evaluating-prompts-at-scale-with-prompt-management-and-prompt-flows-for-amazon-bedrock/")
