...
- [Apply
  security at all layers](../framework/sec-design.md "../framework/sec-design.md") - Private network communications
  facilitate an additional layer of security within your application.
- [Protect
  data in transit and at rest](../framework/sec-design.md "../framework/sec-design.md") - Using private networks instead
...
- [Use
  AWS PrivateLink to Set Up Private Access to Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/use-aws-privatelink-to-set-up-private-access-to-amazon-bedrock/ "https://aws.amazon.com/blogs/machine-learning/use-aws-privatelink-to-set-up-private-access-to-amazon-bedrock/")
- [Overseeing
