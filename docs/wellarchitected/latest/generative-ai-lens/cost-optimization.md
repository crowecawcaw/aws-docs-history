...
**Topics**
+ [Model selection and cost optimization](gencost01.md)
+ [Generative AI pricing model](gencost02.md)
+ [Cost-aware prompting](gencost03.md)
+ [Cost-informed vector stores](gencost04.md)
+ [Cost-informed agents](gencost05.md)