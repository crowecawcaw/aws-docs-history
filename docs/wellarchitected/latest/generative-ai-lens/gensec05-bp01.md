...
- [Apply
  security at all layers](../framework/sec-design.md "../framework/sec-design.md") - Applying least privilege access
...
_excessive agency_, where an agent determines
...
4. Implement user confirmation for the agent, requiring users
...
- [Amazon Bedrock User Guide - User Confirmation](../../../bedrock/latest/userguide/agents-userconfirmation.md "../../../bedrock/latest/userguide/agents-userconfirmation.md")
...
- [Design
  secure generative AI application workflows with Amazon Verified Permissions and Amazon Bedrock Agents](https://aws.amazon.com/blogs/machine-learning/design-secure-generative-ai-application-workflows-with-amazon-verified-permissions-and-amazon-bedrock-agents/ "https://aws.amazon.com/blogs/machine-learning/design-secure-generative-ai-application-workflows-with-amazon-verified-permissions-and-amazon-bedrock-agents/")
