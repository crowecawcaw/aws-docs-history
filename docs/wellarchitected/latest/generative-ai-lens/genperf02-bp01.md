...
1. Reference your organization's AI policy for information
   concerning appropriate performance metrics for model
   endpoint load testing.
2. Develop a load testing harness that prompts a foundation
...
3. Collect performance information from the model from the
...
- [MLPER-01](../machine-learning-lens/mlper-01.md "../machine-learning-lens/mlper-01.md")
- [MLPER-03](../machine-learning-lens/mlper-03.md "../machine-learning-lens/mlper-03.md")
- [MLPER-05](../machine-learning-lens/mlper-05.md "../machine-learning-lens/mlper-05.md")
...
- [Supercharge
  ...
  Inference container v15](https://aws.amazon.com/blogs/machine-learning/supercharge-your-llm-performance-with-amazon-sagemaker-large-model-inference-container-v15/ "https://aws.amazon.com/blogs/machine-learning/supercharge-your-llm-performance-with-amazon-sagemaker-large-model-inference-container-v15/")
- [Model
  management for LoRA fine-tuned models using Llama2 and Amazon SageMaker AI](https://aws.amazon.com/blogs/machine-learning/model-management-for-lora-fine-tuned-models-using-llama2-and-amazon-sagemaker/ "https://aws.amazon.com/blogs/machine-learning/model-management-for-lora-fine-tuned-models-using-llama2-and-amazon-sagemaker/")
- [Efficient
...
- [Deploy
  models with DJL Serving](../../../sagemaker/latest/dg/deploy-models-frameworks-djl-serving.md "../../../sagemaker/latest/dg/deploy-models-frameworks-djl-serving.md")
- [The
  large model inference (LMI) container documentation](../../../sagemaker/latest/dg/large-model-inference-container-docs.md "../../../sagemaker/latest/dg/large-model-inference-container-docs.md")
