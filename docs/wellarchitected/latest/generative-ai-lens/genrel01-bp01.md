 ...
 **Benefits of establishing this best practice:** [Stop guessing capacity](https://docs.aws.amazon.com/wellarchitected/latest/framework/rel-dp.html) - By understanding the throughput needs of your generative AI workload, you remove the need to guess at throughput capacity. 
...
1. Configure scaling mechanisms:
...
1. Establish ongoing optimization:
