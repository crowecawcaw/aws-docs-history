...
- [Implement
  observability for actionable insights](../framework/oe-design-principles.md "../framework/oe-design-principles.md") - User feedback
...
[Amazon Q Business](https://aws.amazon.com/q/business/ "https://aws.amazon.com/q/business/") offers tools to monitor and analyze user feedback.
...
* Amazon Q Business](../../../amazonq/latest/api-reference/API_PutFeedback.md "../../../amazonq/latest/api-reference/API_PutFeedback.md")

- [Configure
  agent to request information from user to increase accuracy of
  function prediction - Amazon Bedrock](../../../bedrock/latest/userguide/agents-user-input.md "../../../bedrock/latest/userguide/agents-user-input.md")

**Related tools:**

- [Amazon Q Business](https://aws.amazon.com/q/business/ "https://aws.amazon.com/q/business/")
