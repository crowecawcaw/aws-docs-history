 ...
 **Benefits of establishing this best practice:** [Apply security at all layers](https://docs.aws.amazon.com/wellarchitected/latest/framework/sec-design.html) - Control and data plane monitoring provides a layer of security at the service configuration and data access layers. 
...
1.  Quality and accuracy monitoring: 
