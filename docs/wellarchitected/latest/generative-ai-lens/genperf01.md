...
**Topics**
+ [GENPERF01-BP01 Define a ground truth data set of prompts and responses](genperf01-bp01.md)
+ [GENPERF01-BP02 Collect performance metrics from generative AI workloads](genperf01-bp02.md)