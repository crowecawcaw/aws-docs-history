...
<a name="microsoft-workloads-definitions"></a>
...
<a name="licensing-definitions"></a>
+  **[License included (LI)](https://aws.amazon.com/windows/resources/licensing/):** Using license included instances allows you access to fully compliant Microsoft software licenses bundled with [Amazon EC2](https://aws.amazon.com/ec2/) or Amazon RDS instances and pay for them as you go with no upfront costs or long-term investments. 
+  **[Bring your own license (BYOL)](https://aws.amazon.com/windows/resources/licensing/?nc1=h_ls):** Using existing Microsoft licenses, such as Windows Server and SQL Server, when running on AWS. 
+  **[License mobility](https://aws.amazon.com/windows/resources/licensemobility/):** Allows customers to bring eligible Microsoft licenses to the AWS Cloud under Software Assurance. 
+  **[Software Assurance](https://aws.amazon.com/windows/resources/licensemobility/):** Microsoft's program that provides license mobility and other benefits when running Microsoft products on AWS. 