...
1.  Consult AWS and Microsoft experts for BYOL eligibility and options 

1.  Set up AWS License Manager for tracking and conversion capabilities 

1.  Deploy licenses correctly (for example, Windows Server on Dedicated Hosts, SQL Server on shared tenancy) 

1.  Establish regular review process for ongoing optimization and compliance 
...
+  [Bring licenses for Windows and SQL Server workloads](https://docs.aws.amazon.com/prescriptive-guidance/latest/optimize-costs-microsoft-workloads/byol-ded-hosts.html) 
