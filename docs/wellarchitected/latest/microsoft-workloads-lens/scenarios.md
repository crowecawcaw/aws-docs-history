...
**Topics**
+ [Scenario 1: Microsoft SQL Server Migration to AWS](scenario-1-microsoft-sql-server-migration-to-aws.md)
+ [Scenario 2: .NET Application Modernization on AWS](scenario-2-.net-application-modernization-on-aws.md)
+ [Scenario 3: Active Directory integration with AWS](scenario-3-active-directory-integration-with-aws.md)
