...
<a name="scenario-6-high-availability-and-disaster-recovery-for-windows-workloads-on-aws"></a>
...
1.  Database high availability with Amazon RDS for SQL Server: 
...
1.  Cross-Region data replication using AWS DataSync: 
...
1.  Multi-Region Active Directory replication: 
   +  Enables AD Multi-Region replicas to keep AuthN and AuthZ during failovers. 

1.  Automated failover and recovery using AWS Systems Manager and AWS Lambda: 
...
## Configuration notes
<a name="configuration-notes-5"></a>
