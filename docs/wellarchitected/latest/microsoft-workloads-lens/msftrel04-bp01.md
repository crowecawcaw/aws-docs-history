...
3. Set up Amazon CloudWatch Application Insights to monitor
   ...
   servers.
4. Create CloudWatch alarms and custom metrics for Microsoft
...
5. Implement application-level scaling automation for SQL
   ...
   events.
6. Configure session state management and connection pooling
...
- [Accelerate
  Amazon EC2 Auto Scaling for Microsoft Windows workloads](https://aws.amazon.com/blogs/modernizing-with-aws/accelerate-amazon-ec2-auto-scaling-for-microsoft-windows-workloads/ "https://aws.amazon.com/blogs/modernizing-with-aws/accelerate-amazon-ec2-auto-scaling-for-microsoft-windows-workloads/")
- [Automatically
  scale your Amazon ECS service](../../../AmazonECS/latest/developerguide/service-auto-scaling.md "../../../AmazonECS/latest/developerguide/service-auto-scaling.md")
...
- [Auto
  Scaling launch templates](../../../autoscaling/ec2/userguide/launch-templates.md "../../../autoscaling/ec2/userguide/launch-templates.md")
