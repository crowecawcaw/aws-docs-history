...
1.  Install and configure the chosen platform-specific tool (for example, Azure Resource Discovery Tool) 

1.  Save the output data 

1.  Contact your AWS account team to help analyzing Azure resources in preparation for potential AWS migration scenarios 

## Resources
<a name="resources"></a>

 **Related tools:** 
+  [Azure Resource Discovery Tool](https://github.com/awslabs/resource-discovery-for-azure) 