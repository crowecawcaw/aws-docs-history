...
<a name="performance-measurement"></a>
...
**Topics**
+ [MSFTPERF04-BP01 Use historical data to evaluate performance](msftperf04-bp01.md)
+ [MSFTPERF04-BP02 Define baseline performance requirements](msftperf04-bp02.md)