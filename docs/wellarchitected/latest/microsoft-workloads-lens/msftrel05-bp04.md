...
1.  Create test cases that validate Windows-specific functionality, including: 
...
1.  Establish Microsoft workload-specific validation: 
...
1.  Create comprehensive reporting and alerting: 
...
+  [PowerShell DSC and AWS Systems Manager State Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-state-manager-powershell-dsc-support.html) 
+  [SQL Server on Amazon EC2](https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/SQL_Server.html) 
