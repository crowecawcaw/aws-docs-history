...
- [OPS04-BP01
  Define workload KPIs](ops_observability_identify_kpis.md "ops_observability_identify_kpis.md")
- [OPS04-BP02
  Implement application telemetry](ops_observability_application_telemetry.md "ops_observability_application_telemetry.md")
- [OPS04-BP03
  Implement user activity telemetry](ops_observability_customer_telemetry.md "ops_observability_customer_telemetry.md")
- [OPS04-BP05
  Implement transaction traceability](ops_observability_dist_trace.md "ops_observability_dist_trace.md")
- [OP08-BP04
