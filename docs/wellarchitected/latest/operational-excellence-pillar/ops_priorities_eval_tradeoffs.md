...
[AWS Discussion Forums](https://forums.aws.amazon.com/index.jspa "https://forums.aws.amazon.com/index.jspa"), and
[Support Center](https://console.aws.amazon.com/support/home/ "https://console.aws.amazon.com/support/home/")) and
[AWS Documentation](../../../index.md "../../../index.md") to educate your teams. For further questions,
reach out to Support.

AWS also shares operational best practices and patterns in
[The
Amazon Builders' Library](https://aws.amazon.com/builders-library/ "https://aws.amazon.com/builders-library/"). A wide variety of other useful
...
1. Formalize benefits measurement practices within a holistic
   ...
   3. Incorporate external factors into your decision making
      process (like compliance requirements).

2. Establish an agreed-upon decision-making framework for
...
3. Understand and manage benefits and risks. Balance the
   ...
   3. **Assess benefits against risks
...
4. Programatically enforce key decisions that automate your
   adherence to compliance requirements.
5. Leverage known industry frameworks and capabilities, such as
...
- [OPS01-BP05
  Evaluate threat landscape](ops_priorities_eval_threat_landscape.md "ops_priorities_eval_threat_landscape.md")

**Related documents:**

- [Elements
  of Amazon's Day 1 Culture | Make high quality, high velocity
  decisions](https://aws.amazon.com/executive-insights/content/how-amazon-defines-and-operationalizes-a-day-1-culture/ "https://aws.amazon.com/executive-insights/content/how-amazon-defines-and-operationalizes-a-day-1-culture/")
- [Cloud
  Governance](https://aws.amazon.com/cloudops/cloud-governance/ "https://aws.amazon.com/cloudops/cloud-governance/")
- [Management
  & Governance Cloud Environment](../management-and-governance-guide/management-and-governance-cloud-environment-guide.md "../management-and-governance-guide/management-and-governance-cloud-environment-guide.md")
- [Governance
  in the Cloud and in the Digital Age: Parts One &
  Two](https://aws.amazon.com/blogs/enterprise-strategy/governance-in-the-cloud-and-in-the-digital-age-part-one/ "https://aws.amazon.com/blogs/enterprise-strategy/governance-in-the-cloud-and-in-the-digital-age-part-one/")
