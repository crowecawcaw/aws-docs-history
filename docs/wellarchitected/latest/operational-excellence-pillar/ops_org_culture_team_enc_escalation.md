...
2. Encourage, train, and empower workers for early and frequent
   escalation when standards are not met.
3. Organizationally acknowledge that early and frequent
   ...
   1. Build a mechanism for escalation (like an
      Andon
      cord system).
   2. Have documented procedures defining when and how
      escalation should occur.
   3. Define the series of people with increasing authority to
...
4. When escalation occurs, it should continue until the team
   ...
   2. Protect employees who escalate. Have policy that
...
5. Encourage a culture of continuous improvement feedback loops
...
6. Leadership should periodically reemphasize the policies,
...
- [OPS02-BP05 Mechanisms exist to request additions, changes, and exceptions](ops_ops_model_req_add_chg_exception.md "ops_ops_model_req_add_chg_exception.md")

**Related documents:**

- [How
  do you foster a culture of continuous improvement and learning
  from Andon and escalation systems?](https://www.linkedin.com/advice/0/how-do-you-foster-culture-continuous-improvement-7054190310033145857 "https://www.linkedin.com/advice/0/how-do-you-foster-culture-continuous-improvement-7054190310033145857")
- [The
...
- [Jeff
  ...
  velocity)](https://www.youtube.com/watch?v=VFwCGECvq4I "https://www.youtube.com/watch?v=VFwCGECvq4I")
- [Toyota
  Product System: Stopping Production, a Button, and an Andon
  Electric Board](https://youtu.be/TUKpxjAftnk?si=qohtCCX0q78GDzJu "https://youtu.be/TUKpxjAftnk?si=qohtCCX0q78GDzJu")
- [Andon
  Cord in LEAN Manufacturing](https://youtu.be/HshopyQk720?si=1XJkpCSqJSpk_zE6 "https://youtu.be/HshopyQk720?si=1XJkpCSqJSpk_zE6")

**Related examples:**

- [Working
  with escalation plans in Incident Manager](../../../incident-manager/latest/userguide/escalation.md "../../../incident-manager/latest/userguide/escalation.md")
