...
- [OPS05-BP07
  Implement practices to improve code quality](ops_dev_integ_code_quality.md "ops_dev_integ_code_quality.md")
- [OPS05-BP10
  Fully automate integration and deployment](ops_dev_integ_auto_integ_deploy.md "ops_dev_integ_auto_integ_deploy.md")
