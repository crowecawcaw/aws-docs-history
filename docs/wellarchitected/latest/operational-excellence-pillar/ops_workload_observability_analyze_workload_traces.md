...
[AWS X-Ray](https://www.docs.aws.com/xray/latest/devguide/aws-xray.html "https://www.docs.aws.com/xray/latest/devguide/aws-xray.html") offers a comprehensive suite for trace data analysis,
...
2. **Analyze X-Ray metrics**:
   ...
   [service
   map](../../../xray/latest/devguide/xray-console-servicemap.md#xray-console-servicemap-view "../../../xray/latest/devguide/xray-console-servicemap.md#xray-console-servicemap-view") to monitor application health.
3. **Use ServiceLens**: Leverage
   the
   [ServiceLens
   map](../../../AmazonCloudWatch/latest/monitoring/servicelens_service_map.md "../../../AmazonCloudWatch/latest/monitoring/servicelens_service_map.md") for enhanced observability of your services and
...
4. **Enable X-Ray Insights**:
   1. Turn on
      ...
      traces.
   2. Examine insights to pinpoint patterns and ascertain root
      causes, such as increased fault rates or latencies.
   3. Consult the insights timeline for a chronological
      analysis of detected issues.

5. **Use X-Ray Analytics**:
   [X-Ray
   Analytics](../../../xray/latest/devguide/xray-console-analytics.md "../../../xray/latest/devguide/xray-console-analytics.md") allows you to thoroughly explore trace
   data, pinpoint patterns, and extract insights.
6. **Use groups in X-Ray**:
   Create groups in X-Ray to filter traces based on criteria
   such as high latency, allowing for more targeted analysis.
7. **Incorporate Amazon DevOps Guru**: Engage
   [Amazon DevOps Guru](https://aws.amazon.com/devops-guru/ "https://aws.amazon.com/devops-guru/") to benefit from machine learning models
   pinpointing operational anomalies in traces.
8. **Use CloudWatch
   Synthetics**: Use
   [CloudWatch
   Synthetics](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_tracing.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_tracing.md") to create canaries for continually
...
9. **Use Real User Monitoring
   (RUM)**: With
   [AWS X-Ray and CloudWatch RUM](../../../xray/latest/devguide/xray-services-RUM.md "../../../xray/latest/devguide/xray-services-RUM.md"), you can analyze and debug
...
10. **Correlate with logs**:
    Correlate
    [trace
    data with related logs](../../../AmazonCloudWatch/latest/monitoring/servicelens_troubleshooting.md#servicelens_troubleshooting_Nologs "../../../AmazonCloudWatch/latest/monitoring/servicelens_troubleshooting.md#servicelens_troubleshooting_Nologs") within the X-Ray trace view
...
- [Using
  ServiceLens to Monitor Application Health](../../../AmazonCloudWatch/latest/monitoring/ServiceLens.md "../../../AmazonCloudWatch/latest/monitoring/ServiceLens.md")
- [Exploring
  Trace Data with X-Ray Analytics](../../../xray/latest/devguide/xray-console-analytics.md "../../../xray/latest/devguide/xray-console-analytics.md")
- [Detecting
  Anomalies in Traces with X-Ray Insights](../../../xray/latest/devguide/xray-insights.md "../../../xray/latest/devguide/xray-insights.md")
- [Continuous
  Monitoring with CloudWatch Synthetics](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries.md")

**Related videos:**

- [Analyze
  and Debug Applications Using Amazon CloudWatch Synthetics
  & AWS X-Ray](https://www.youtube.com/watch?v=s2WvaV2eDO4 "https://www.youtube.com/watch?v=s2WvaV2eDO4")
- [Use
  AWS X-Ray Insights](https://www.youtube.com/watch?v=tl8OWHl6jxw "https://www.youtube.com/watch?v=tl8OWHl6jxw")
...
- [Implementing
  X-Ray with AWS Lambda](../../../lambda/latest/dg/services-xray.md "../../../lambda/latest/dg/services-xray.md")
- [CloudWatch
  Synthetics Canary Templates](https://github.com/aws-samples/cloudwatch-synthetics-canary-terraform "https://github.com/aws-samples/cloudwatch-synthetics-canary-terraform")
