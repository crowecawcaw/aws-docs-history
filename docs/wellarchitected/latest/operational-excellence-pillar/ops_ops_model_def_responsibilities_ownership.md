...
2. Review and host discussions on the documented
   ...
   2. Discuss potential services offered by internal customers
...
4. Identify opportunities for improvement.
   1. Identify frequently-requested, resource-intensive
      ...
      improvement.
   2. Look for best practices, understand patterns, follow prescriptive
      guidance, and simplify and standardize improvements.
   3. Record improvement opportunities, and track them to
      completion.

5. If a team doesn't already hold responsibility for managing
...
6. Define a process for teams to request clarification of
   ...
   4. Create a feedback mechanisms to verify that teams can
...
- [OPS01-BP06
  Evaluate tradeoffs](ops_priorities_eval_tradeoffs.md "ops_priorities_eval_tradeoffs.md")
- [OPS03-BP02
  Team members are empowered to take action when outcomes are at
  risk](ops_org_culture_team_emp_take_action.md "ops_org_culture_team_emp_take_action.md")
- [OPS03-BP03
  Escalation is encouraged](ops_org_culture_team_enc_escalation.md "ops_org_culture_team_enc_escalation.md")
- [OPS03-BP07
  Resource teams appropriately](ops_org_culture_team_res_appro.md "ops_org_culture_team_res_appro.md")
- [OPS09-BP01
  Measure operations goals and KPIs with metrics](ops_operations_health_measure_ops_goals_kpis.md "ops_operations_health_measure_ops_goals_kpis.md")
- [OPS09-BP03
  Review operations metrics and prioritize improvement](ops_operations_health_review_ops_metrics_prioritize_improvement.md "ops_operations_health_review_ops_metrics_prioritize_improvement.md")
- [OPS11-BP01
  Have a process for continuous improvement](ops_evolve_ops_process_cont_imp.md "ops_evolve_ops_process_cont_imp.md")
...
- [AWS Well-Architected Framework Operational Excellence - Workload
  level Operating model topologies](operating-model-2-by-2-representations.md "operating-model-2-by-2-representations.md")
...
- [AWS Prescriptive Guidance - Create a RACI or RASCI matrix for a
  cloud operating model](../../../prescriptive-guidance/latest/patterns/create-a-raci-or-rasci-matrix-for-a-cloud-operating-model.md "../../../prescriptive-guidance/latest/patterns/create-a-raci-or-rasci-matrix-for-a-cloud-operating-model.md")
- [AWS Cloud Operations & Migrations Blog - Delivering Business
  Value with Cloud Platform Teams](https://aws.amazon.com/blogs/mt/delivering-business-value-with-cloud-platform-teams/ "https://aws.amazon.com/blogs/mt/delivering-business-value-with-cloud-platform-teams/")
- [AWS Cloud Operations & Migrations Blog - Why a Cloud Operating
  Model?](https://aws.amazon.com/blogs/mt/why-a-cloud-operating-model/ "https://aws.amazon.com/blogs/mt/why-a-cloud-operating-model/")
- [AWS DevOps Blog - How organizations are modernizing for cloud
  operations](https://aws.amazon.com/blogs/devops/how-organizations-are-modernizing-for-cloud-operations/ "https://aws.amazon.com/blogs/devops/how-organizations-are-modernizing-for-cloud-operations/")

**Related videos:**

- [AWS Summit Online - Cloud Operating Models for Accelerated
  Transformation](https://www.youtube.com/watch?v=ksJ5_UdYIag "https://www.youtube.com/watch?v=ksJ5_UdYIag")
- [AWS re:Invent 2023 - Future-proofing cloud security: A new
  operating model](https://www.youtube.com/watch?v=GFcKCz1VO2I "https://www.youtube.com/watch?v=GFcKCz1VO2I")
