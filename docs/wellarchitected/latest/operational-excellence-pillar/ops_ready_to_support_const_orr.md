...
- [SEC01-BP03 Identify and validate control objectives](../framework/sec_securely_operate_control_objectives.md "../framework/sec_securely_operate_control_objectives.md") – Security control
  objectives make excellent ORR requirements.
- [REL13-BP01 Define recovery objectives for downtime and data loss](../framework/rel_planning_for_recovery_objective_defined_recovery.md "../framework/rel_planning_for_recovery_objective_defined_recovery.md") – Disaster
  recovery plans are a good ORR requirement.
- [COST02-BP01 Develop
  policies based on your organization requirements](../framework/cost_govern_usage_policies.md "../framework/cost_govern_usage_policies.md") – Cost management policies are
