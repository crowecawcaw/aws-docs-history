...
- [OPS01-BP06
  Evaluate tradeoffs while managing benefits and risks](ops_priorities_eval_tradeoffs.md "ops_priorities_eval_tradeoffs.md")
- [OPS02-BP06
  Responsibilities between teams are predefined or
  negotiated](ops_ops_model_def_neg_team_agreements.md "ops_ops_model_def_neg_team_agreements.md")
- [OPS11-BP03
  Implement feedback loops](ops_evolve_ops_feedback_loops.md "ops_evolve_ops_feedback_loops.md")
