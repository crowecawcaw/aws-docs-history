...
| --- | --- | --- | 
|  ![Deployment process flow for Amazon EC2](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-ec2.png)  |  ![Deployment process flow for Amazon ECS](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-ecs.png)  |  ![Deployment process flow for Lambda](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-lambda.png)  | 
