...
| --- | --- | --- | 
|  ![Deployment process flow for Amazon EC2](http://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-ec2.png)  |  ![Deployment process flow for Amazon ECS](http://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-ecs.png)  |  ![Deployment process flow for Lambda](http://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/images/deployment-process-lambda.png)  | 
