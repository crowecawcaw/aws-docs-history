...
1. Enables cost-effective storage of multi-year manufacturing data at petabyte scale
2. Supports sophisticated trend analysis and pattern detection across extended
   production history
3. Provides factual basis for validating return on technology and process investments
4. Facilitates root cause analysis of intermittent or slowly developing quality issues
5. Serves as a foundation for advanced analytics and machine learning initiatives
...
- [Building a Data Lake on AWS](https://aws.amazon.com/blogs/big-data/build-a-data-lake-foundation-with-aws-glue-and-amazon-s3/ "https://aws.amazon.com/blogs/big-data/build-a-data-lake-foundation-with-aws-glue-and-amazon-s3/")
- [Best Practices for Organizing S3 Objects](../../../AmazonS3/latest/userguide/organizing-objects.md "../../../AmazonS3/latest/userguide/organizing-objects.md")
- [Implementing Data Lifecycle Management in S3](../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md "../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md")

[Manufacturing analytic in regulated industries with MachineMetrics on AWS](https://aws.amazon.com/blogs/industries/manufacturing-analytics-in-regulated-industries-with-machinemetrics-on-aws/ "https://aws.amazon.com/blogs/industries/manufacturing-analytics-in-regulated-industries-with-machinemetrics-on-aws/")
