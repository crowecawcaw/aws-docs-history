...
- [Auto Scaling for Amazon Kinesis Data Streams](../../../streams/latest/dev/service-sizes-and-limits.md "../../../streams/latest/dev/service-sizes-and-limits.md")
- [Serverless event-driven architecture for industrial data
  ingestion](../../../serverless/latest/devguide/serverless-transition.md "../../../serverless/latest/devguide/serverless-transition.md")
- [Implementing the IoT analytics pipeline for
  manufacturing](../../../iotanalytics/latest/userguide/create-pipeline.md "../../../iotanalytics/latest/userguide/create-pipeline.md")
- [Designing scalable IoT applications with
  AWS](https://aws.amazon.com/blogs/iot/how-to-build-a-scalable-multi-tenant-iot-saas-platform-on-aws-using-a-multi-account-strategy/ "https://aws.amazon.com/blogs/iot/how-to-build-a-scalable-multi-tenant-iot-saas-platform-on-aws-using-a-multi-account-strategy/")
