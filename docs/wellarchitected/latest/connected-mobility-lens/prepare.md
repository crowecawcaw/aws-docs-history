...
**[CMOPS\_BP1.1] Define end-to-end KPIs and metrics for a
...
[AWS CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/"), which helps to observe resources in AWS,
...
- Security metrics including unpatched instances, security
  ...
  mitigate risks.
- Cloud specific metrics for key services. As an example, [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") is commonly used as part of connected mobility
...
**[CMOPS\_BP2.1] Implement an observability data lake that aggregates
...
defined by the [AUTOSAR 4 DLT](https://www.autosar.org/fileadmin/standards/R22-11/CP/AUTOSAR_SWS_DiagnosticLogAndTrace.pdf "https://www.autosar.org/fileadmin/standards/R22-11/CP/AUTOSAR_SWS_DiagnosticLogAndTrace.pdf"). The end user also should be able to enable this through a
diagnostic app in the infotainment screen to assist the troubleshooting with the service
engineer.

The logs can then be transferred to the cloud using [AWS IoT Core](https://aws.amazon.com/iot-core/ "https://aws.amazon.com/iot-core/") where the AWS IoT rules engine can be used to upload
in-vehicle log records to Amazon CloudWatch. You can also upload the log records using [Amazon S3](https://aws.amazon.com/s3/ "https://aws.amazon.com/s3/") pre-signed URLs if the MQTT publish payload is
...
**[CMOPS\_BP2.2] Set up real-time monitoring and alerting
...
telemetry, or network connectivity. Use [AWS Glue](https://aws.amazon.com/glue/ "https://aws.amazon.com/glue/") to transform and analyze the log data using services like [Amazon Athena](https://aws.amazon.com/athena/ "https://aws.amazon.com/athena/") or [Amazon OpenSearch Service](https://aws.amazon.com/opensearch-service/ "https://aws.amazon.com/opensearch-service/"). Implement custom log analysis solutions or use [AWS Partner Network](https://aws.amazon.com/partners/ "https://aws.amazon.com/partners/") offerings for advanced log analytics.
When predefined thresholds or anomalies are detected, CloudWatch Alarms can cause notifications
via [Amazon Simple Notification Service](https://aws.amazon.com/sns/ "https://aws.amazon.com/sns/") (Amazon SNS) or perform automated
actions using [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") functions.
...
For the application stack in the cloud, use an ML service like [Amazon DevOps Guru](https://aws.amazon.com/devops-guru/ "https://aws.amazon.com/devops-guru/") to detect abnormal operating patterns to identify
operational issues. You can extend predictive capability by developing ML algorithms using a
service like [Amazon SageMaker AI](https://aws.amazon.com/sagemaker/ "https://aws.amazon.com/sagemaker/") and leveraging an
...
**[CMOPS\_BP2.5] Provide remote access for troubleshooting
purposes.**
...
**[CMOPS\_BP4.2] Implement API-first architecture to facilitate
