...
**[CMREL\_BP1.2] Have a strategy for critical functions**
...
| CMREL\_2: How do you ensure that you do not overflow your communication channel to the cloud?  | 
| --- | 
|   | 
...
**[CMREL\_BP2.2] Avoid connection surge to the cloud**
...
| CMREL\_3: Do you have a strategy in case connection certificates are unavailable or accidentally deleted? | 
| --- | 
|   | 
...
**[CMREL\_BP3.1] Implement just-in-time provisioning and registration**
...
**[CMREL\_BP3.2] Manual backup of the device registry**
...
| CMREL\_4: How is your connected mobility solution resilient to unintended access? | 
| --- | 
|   | 
...
| CMREL\_5: How do you mitigate the impact of impairments in the connection layer between vehicles and the AWS Cloud? | 
| --- | 
|   | 
...
**[CMREL\_BP5.1] Account for telco providers outages**
...
**[CMREL\_BP5.2] Implement in-vehicle functionalities**
