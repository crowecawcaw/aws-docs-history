...
| CMSEC\_1: How are you maintaining consumer privacy during actions such as in-vehicle purchase transactions or data collection? | 
| --- | 
|   | 
 ...
 **[CMSEC\_BP1.1] Personally identifiable information (PII) and unique identifiers (IDs) assigned to a vehicle or consumer should be anonymized.** 
 ...
 **[CMSEC\_BP1.2] Location data collected from navigation systems should be appropriately secured to protect anonymity.** 
 ...
 **[CMSEC\_BP1.3] Data collected from cameras, microphones, biometric, and other types of sensors should be appropriately secured.** 
...
| CMSEC\_2: Your risk management program should align to security standards, laws, regulations, and frameworks in the connected vehicle space. | 
| --- | 
|   | 
