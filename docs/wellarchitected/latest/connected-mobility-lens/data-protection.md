...
data](../security-pillar/data-classification.md "../security-pillar/data-classification.md") generated by the vehicle to determine the type of encryption required in
transit and at rest.

Consider the following best practices for encryption:

**[CMSEC\_BP20.1] Implement TLS 1.2+ to encrypt data in
transit**
...
On AWS, you can use mutual TLS 1.2+ with [AWS IoT Core](../../../iot/latest/developerguide/x509-client-certs.md "../../../iot/latest/developerguide/x509-client-certs.md") and [Amazon API Gateway REST APIs](../../../apigateway/latest/developerguide/rest-api-mutual-tls.md "../../../apigateway/latest/developerguide/rest-api-mutual-tls.md") to authenticate ECUs using X.509 client certificates. You can
also terminate mutual TLS on software deployed to AWS compute services (Amazon EC2, Amazon EKS, or
Amazon ECS) behind a [Network Load Balancer](../../../elasticloadbalancing/latest/network/introduction.md "../../../elasticloadbalancing/latest/network/introduction.md")
(NLB). Individual AWS service API requests are authenticated using the [_sigv4_](../../../AmazonS3/latest/API/sig-v4-authenticating-requests.md "../../../AmazonS3/latest/API/sig-v4-authenticating-requests.md") algorithm.

**[CMSEC\_BP20.2] Consider client-side encryption of highly sensitive
data at the ECU**
...
with a _data key_ and the data key is encrypted under another key that is
...
On AWS, you can use the [AWS Key Management Service](https://aws.amazon.com/kms/ "https://aws.amazon.com/kms/") (AWS KMS) to
securely manage your encryption keys for [envelope encryption](../../../kms/latest/developerguide/concepts.md#enveloping "../../../kms/latest/developerguide/concepts.md#enveloping"). You
can use the [AWS Encryption SDK](../../../encryption-sdk/latest/developer-guide/introduction.md "../../../encryption-sdk/latest/developer-guide/introduction.md")
to implement envelope encryption with [data key caching](../../../encryption-sdk/latest/developer-guide/data-key-caching.md "../../../encryption-sdk/latest/developer-guide/data-key-caching.md")
...
**[CMSEC\_BP21.1] Do not use sensitive data to name and reference
resources**
...
On AWS, you can use [Amazon Macie](https://aws.amazon.com/macie/ "https://aws.amazon.com/macie/") to discover and help protect your sensitive data.
...
[sensitive data types](../../../macie/latest/user/managed-data-identifiers.md "../../../macie/latest/user/managed-data-identifiers.md")
...
build [custom data identifiers](../../../macie/latest/user/custom-data-identifiers.md "../../../macie/latest/user/custom-data-identifiers.md")
