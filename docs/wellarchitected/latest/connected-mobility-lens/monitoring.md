...
| CMPERF\_12: Have you implemented end-to-end monitoring and logging (between edge, vehicle, and cloud) of your system along with notifications?  | 
| --- | 
|   | 

**[CMPERF\_BP12.1] Monitoring, logging, and setting up notifications are critical for maintaining the health, performance, and security of a system. **
...
** [CMPERF\_BP12.2] Implement device monitoring at the edge device (vehicle), data transmission monitoring, monitor cloud services, and log monitoring. **
...
| CMPERF\_13: Have you built the right dashboards and widgets for your prioritized actionable insights?  | 
| --- | 
|   | 
...
**[CMPERF\_BP13.1] Follow best practices when creating dashboards**
...
**[CMPERF\_BP13.2] Use tools and best practices to gain insights**
