...
While there might be _n_ data sources that the
...
can add to the overhead. Tools such as [AWS Backup](../../../aws-backup/latest/devguide/whatisbackup.md "../../../aws-backup/latest/devguide/whatisbackup.md") and [AWS Elastic Data Recovery](https://aws.amazon.com/disaster-recovery/ "https://aws.amazon.com/disaster-recovery/") can boost
...
systems running on cloud and on-premises data centers. AWS services such as [AWS Storage Gateway](../../../storagegateway/latest/vgw/WhatIsStorageGateway.md "../../../storagegateway/latest/vgw/WhatIsStorageGateway.md") or [AWS DataSync](../../../datasync/latest/userguide/what-is-datasync.md "../../../datasync/latest/userguide/what-is-datasync.md") can help in
...
that have least
[privileged
access](../framework/sec_permissions_least_privileges.md "../framework/sec_permissions_least_privileges.md"). Use AWS
[managed
policies](../../../IAM/latest/UserGuide/security-iam-awsmanpol.md "../../../IAM/latest/UserGuide/security-iam-awsmanpol.md") where applicable. As more connected vehicles
...
lakes, following
[the
best practices](../../../whitepapers/latest/building-data-lakes/securing-protecting-managing-data.md "../../../whitepapers/latest/building-data-lakes/securing-protecting-managing-data.md") in handling this data is essential.

Ensure the backups are not accidentally deleted as this
could result in vehicle regulatory compliance violations.
[Legal
hold](../../../aws-backup/latest/devguide/legalhold.md "../../../aws-backup/latest/devguide/legalhold.md") is a feature in AWS Backup service that prevents
accidental deletions. Multiple departments/ units within an
organization can have their holds on the backup.

**[CMREL\_BP12.4] Perform periodic recovery of the data to verify
backup integrity and processes**

######

"Hope for the best and be prepared for the worst" - [Maya
Angelou](https://www.womenshistory.org/education-resources/biographies/maya-angelou "https://www.womenshistory.org/education-resources/biographies/maya-angelou")
...
[Multi-AZ](../../../whitepapers/latest/aws-fault-isolation-boundaries/availability-zones.md "../../../whitepapers/latest/aws-fault-isolation-boundaries/availability-zones.md")
...
[AWS Local Zones](https://aws.amazon.com/about-aws/global-infrastructure/localzones/ "https://aws.amazon.com/about-aws/global-infrastructure/localzones/") can be used to deploy workloads closer to
...
from
[Amazon CloudFront](https://aws.amazon.com/cloudfront/ "https://aws.amazon.com/cloudfront/") with millisecond level latency. Other
...
[Amazon API Gateway](../../../apigateway/latest/developerguide/api-gateway-api-endpoint-types.md "../../../apigateway/latest/developerguide/api-gateway-api-endpoint-types.md"), and Lambda@Edge. Amazon CloudFront can
