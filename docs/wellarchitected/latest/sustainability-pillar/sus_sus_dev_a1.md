...
- **Understand the carbon accounting
  ...
  sustainability](cloud-sustainability.md "cloud-sustainability.md")).
...
- **Communicate resource usage through
  ...
  your
  [resource
  usage through proxy metrics](evaluate-specific-improvements.md "evaluate-specific-improvements.md"). In the on-demand pricing
...
- **Continuously optimize and
  evaluate:** Use an
  [improvement
  process](improvement-process.md "improvement-process.md") to continuously optimize your IT systems,
