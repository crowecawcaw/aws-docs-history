...
![Provisioned capacity waveform with two distinct peaks that require high provisioned capacity.](http://docs.aws.amazon.com/wellarchitected/latest/sustainability-pillar/images/provisioned-capacity-1.png)
...
![Waveform diagram displaying a workload with smoothed-out peaks created using buffering or throttling.](http://docs.aws.amazon.com/wellarchitected/latest/sustainability-pillar/images/provisioned-capacity-2.png)
