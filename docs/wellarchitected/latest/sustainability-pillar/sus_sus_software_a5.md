...
- **Use managed device farms:**
  To test new features and updates, use managed device farms with representative sets of hardware and iterate development to maximize the devices supported. For more details, see [SUS06-BP05 Use managed device farms for testing](sus_sus_dev_a5.md "sus_sus_dev_a5.md").
...
- [Optimizing Your IoT Devices for Environmental Sustainability](https://aws.amazon.com/blogs/architecture/optimizing-your-iot-devices-for-environmental-sustainability/ "https://aws.amazon.com/blogs/architecture/optimizing-your-iot-devices-for-environmental-sustainability/")

**Related videos:**

- [AWS re:Invent 2023 - Improve your mobile and web app quality using AWS Device Farm](https://www.youtube.com/watch?v=__93Tm0YCRg "https://www.youtube.com/watch?v=__93Tm0YCRg")
