...
- **Choose Regions:** Choose Regions near Amazon renewable energy projects and Regions where the grid has a
  ...
  - Choose region based on method you use to track carbon emissions. For more detail
    ...
    [How to select a Region for your workload based on sustainability goals](https://aws.amazon.com/blogs/architecture/how-to-select-a-region-for-your-workload-based-on-sustainability-goals/ "https://aws.amazon.com/blogs/architecture/how-to-select-a-region-for-your-workload-based-on-sustainability-goals/").

## Resources

**Related documents:**

- [Understanding your carbon emission estimations](../../../awsaccountbilling/latest/aboutv2/ccft-estimation.md "../../../awsaccountbilling/latest/aboutv2/ccft-estimation.md")
- [Amazon
  Around the Globe](https://sustainability.aboutamazon.com/about/around-the-globe?energyType=true "https://sustainability.aboutamazon.com/about/around-the-globe?energyType=true")
- [Renewable
  Energy Methodology](https://sustainability.aboutamazon.com/amazon-renewable-energy-methodology "https://sustainability.aboutamazon.com/amazon-renewable-energy-methodology")
- [What
...
- [AWS re:Invent 2023 - Sustainability innovation in AWS Global Infrastructure](https://www.youtube.com/watch?v=0EkcwLKeOQA "https://www.youtube.com/watch?v=0EkcwLKeOQA")
...
- [AWS re:Invent 2022 - Architecting sustainably and reducing your AWS carbon footprint](https://www.youtube.com/watch?v=jsbamOLpCr8 "https://www.youtube.com/watch?v=jsbamOLpCr8")
- [AWS re:Invent 2022 - Sustainability in AWS global infrastructure](https://www.youtube.com/watch?v=NgMa8R9-Ywk "https://www.youtube.com/watch?v=NgMa8R9-Ywk")
