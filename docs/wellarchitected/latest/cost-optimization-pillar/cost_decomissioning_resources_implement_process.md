...
[For more detail, see How do I delete or terminate my Amazon EC2 resources?](https://aws.amazon.com/premiumsupport/knowledge-center/delete-terminate-ec2/ "https://aws.amazon.com/premiumsupport/knowledge-center/delete-terminate-ec2/")
...
[Performance
across the Amazon S3 storage classes](https://aws.amazon.com/s3/storage-classes/?nc=sn&loc=3#Performance_across_the_S3_Storage_Classes "https://aws.amazon.com/s3/storage-classes/?nc=sn&loc=3#Performance_across_the_S3_Storage_Classes"). For detail on how early deletion fees are calculated, see [Amazon S3 pricing](https://aws.amazon.com/s3/pricing/ "https://aws.amazon.com/s3/pricing/").
...
![Flow chart depicting the steps of decommissioning a resource.](images/decommissioning-process-flowchart.png)
...
- [Delete CloudFormation stack but retain some resources](https://www.youtube.com/watch?v=bVmsS8rjuwk "https://www.youtube.com/watch?v=bVmsS8rjuwk")
- [Find out which user launched Amazon EC2 instance](https://www.youtube.com/watch?v=SlyAHc5Mv2A "https://www.youtube.com/watch?v=SlyAHc5Mv2A")

**Related examples:**

- [Delete or terminate Amazon EC2 resources](https://aws.amazon.com/premiumsupport/knowledge-center/delete-terminate-ec2/ "https://aws.amazon.com/premiumsupport/knowledge-center/delete-terminate-ec2/")
- [Find out which user launched an Amazon EC2 instance](https://aws.amazon.com/premiumsupport/knowledge-center/ec2-user-launched-instance/ "https://aws.amazon.com/premiumsupport/knowledge-center/ec2-user-launched-instance/")
