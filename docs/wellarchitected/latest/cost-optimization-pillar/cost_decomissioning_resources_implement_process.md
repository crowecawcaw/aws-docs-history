...
![Flow chart depicting the steps of decommissioning a resource.](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/images/decommissioning-process-flowchart.png)
