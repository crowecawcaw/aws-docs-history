...
**Topics**
+ [Evaluate cost when selecting services](evaluate-cost-when-selecting-services.md)
+ [Select the correct resource type, size, and number](select-the-correct-resource-type-size-and-number.md)
+ [Select the best pricing model](select-the-best-pricing-model.md)
+ [Plan for data transfer](plan-for-data-transfer.md)