...
For a deeper understanding of the specific purposes and use cases that a particular Amazon EC2 instance family can fulfill, see [AWS Instance types](../../../AWSEC2/latest/UserGuide/instance-types.md "../../../AWSEC2/latest/UserGuide/instance-types.md").
...
- [AWS Instance types](../../../AWSEC2/latest/UserGuide/instance-types.md "../../../AWSEC2/latest/UserGuide/instance-types.md")
...
- [Cost
  Optimization: EC2 Right Sizing](../../../awsaccountbilling/latest/aboutv2/ce-rightsizing.md "../../../awsaccountbilling/latest/aboutv2/ce-rightsizing.md")

**Related videos:**

- [Selecting the right Amazon EC2 instance for your workloads](https://www.youtube.com/watch?v=q5Dn9gcmpJg "https://www.youtube.com/watch?v=q5Dn9gcmpJg")
- [Right size your service](https://youtu.be/wcp1inFS78A "https://youtu.be/wcp1inFS78A")

**Related examples:**

- [It just got easier to discover and compare Amazon EC2 instance types](https://aws.amazon.com/blogs/compute/it-just-got-easier-to-discover-and-compare-ec2-instance-types/ "https://aws.amazon.com/blogs/compute/it-just-got-easier-to-discover-and-compare-ec2-instance-types/")
