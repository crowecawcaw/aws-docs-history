...
workload to make changes to that workload. You can use a managed service, such as [AWS Auto Scaling](https://aws.amazon.com/autoscaling/ "https://aws.amazon.com/autoscaling/"), which you configure to perform
the right sizing operations for you. AWS also provides [APIs, SDKs](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/"), and features that allow
...
Some AWS services have built in automatic type or size selection, such as [Amazon Simple Storage Service Intelligent-Tiering](https://aws.amazon.com/about-aws/whats-new/2018/11/s3-intelligent-tiering/ "https://aws.amazon.com/about-aws/whats-new/2018/11/s3-intelligent-tiering/"). Amazon S3
...
- **Increase your observability by configuring workload metrics:** Capture key
  ...
  as explained in [Rightsizing with AWS Compute Optimizer and Memory Utilization Enabled](https://www.wellarchitectedlabs.com/cost/200_labs/200_aws_resource_optimization/5_ec2_computer_opt/ "https://www.wellarchitectedlabs.com/cost/200_labs/200_aws_resource_optimization/5_ec2_computer_opt/")). Identify instances with a
  maximum CPU usage and memory utilization of less than 40% over a four-week period. These are the instances to
  right size to reduce costs. For storage resources such as Amazon S3, you can use [Amazon S3 Storage Lens](https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/ "https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/"), which
...
- **View rightsizing recommendations:** Use the rightsizing recommendations in
  ...
  right-sizing your resources to make adjustments on your workload. It is important to use the [right tools](../../../whitepapers/latest/cost-optimization-right-sizing/identifying-opportunities-to-right-size.md "../../../whitepapers/latest/cost-optimization-right-sizing/identifying-opportunities-to-right-size.md") when
  right-sizing different resources and follow [right-sizing guidelines](../../../whitepapers/latest/cost-optimization-right-sizing/identifying-opportunities-to-right-size.md "../../../whitepapers/latest/cost-optimization-right-sizing/identifying-opportunities-to-right-size.md") whether it is an Amazon EC2 instance,
  ...
  costs and apply data protection best practices. Using the contextual recommendations that [Amazon S3 Storage Lens](https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/ "https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/") derives
...
- **Select resource type and size automatically based on metrics:** Using the workload
  ...
  [Amazon S3 Intelligent Tiering](https://aws.amazon.com/s3/storage-classes/intelligent-tiering/ "https://aws.amazon.com/s3/storage-classes/intelligent-tiering/") and [Amazon EFS Infrequent Access](https://aws.amazon.com/efs/features/infrequent-access/ "https://aws.amazon.com/efs/features/infrequent-access/") features, which allow you to select storage classes automatically
...
- [AWS Right-Sizing](https://aws.amazon.com/aws-cost-management/aws-cost-optimization/right-sizing/ "https://aws.amazon.com/aws-cost-management/aws-cost-optimization/right-sizing/")
- [AWS Compute Optimizer](https://aws.amazon.com/compute-optimizer/ "https://aws.amazon.com/compute-optimizer/")
- [Amazon CloudWatch features](https://aws.amazon.com/cloudwatch/features/ "https://aws.amazon.com/cloudwatch/features/")
- [CloudWatch
  Getting Set Up](../../../AmazonCloudWatch/latest/monitoring/GettingSetup.md "../../../AmazonCloudWatch/latest/monitoring/GettingSetup.md")
- [CloudWatch
...
- [Getting
  Started with Amazon EC2 Auto Scaling](../../../autoscaling/ec2/userguide/GettingStartedTutorial.md "../../../autoscaling/ec2/userguide/GettingStartedTutorial.md")
- [Amazon S3 Storage Lens](https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/ "https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/")
- [Amazon S3 Intelligent-Tiering](https://aws.amazon.com/about-aws/whats-new/2018/11/s3-intelligent-tiering/ "https://aws.amazon.com/about-aws/whats-new/2018/11/s3-intelligent-tiering/")
- [Amazon EFS Infrequent Access](https://aws.amazon.com/efs/features/infrequent-access/ "https://aws.amazon.com/efs/features/infrequent-access/")
- [Launch
  an Amazon EC2 Instance Using the SDK](../../../sdk-for-net/v2/developer-guide/run-instance.md "../../../sdk-for-net/v2/developer-guide/run-instance.md")

**Related videos:**

- [Right Size Your Services](https://www.youtube.com/watch?v=wcp1inFS78A "https://www.youtube.com/watch?v=wcp1inFS78A")
