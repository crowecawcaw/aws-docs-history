...
- [AWS Audit Manager](https://aws.amazon.com/audit-manager/ "https://aws.amazon.com/audit-manager/"): Continually audit your AWS usage to
  simplify risk and compliance assessment
- [AWS Backup](https://aws.amazon.com/backup/ "https://aws.amazon.com/backup/"): Centrally manage and automate data protection.
- [AWS Config:](https://aws.amazon.com/config/ "https://aws.amazon.com/config/") Configure compute resources, asses, audit,
  evaluate configurations and resource inventory.
- [AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/"): Launch highly available resources with
  Infrastructure as Code.
- [AWS CloudTrail](https://aws.amazon.com/cloudtrail/ "https://aws.amazon.com/cloudtrail/"): IT change management,
  compliance, and control.
- [Amazon EventBridge](https://aws.amazon.com/eventbridge/ "https://aws.amazon.com/eventbridge/") Schedule events and trigger AWS Lambda to
  take action.
- [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/"): Automate repetitive processes by triggering
  them with events or by running them on a fixed schedule with
  AWS EventBridge.
- [AWS Systems Manager](https://aws.amazon.com/systems-manager/ "https://aws.amazon.com/systems-manager/"): Start and stop workloads, patch
  operating systems, automate configuration, and ongoing
  management.
- [AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/"): Schedule jobs and automate workflows.
- [AWS Service Catalog](https://aws.amazon.com/servicecatalog/ "https://aws.amazon.com/servicecatalog/"): Template consumption,
...
[AWS Managed Services (AMS)](https://aws.amazon.com/managed-services/ "https://aws.amazon.com/managed-services/"),

[AWS Professional Services](https://aws.amazon.com/professional-services/ "https://aws.amazon.com/professional-services/"), or

[AWS Partners](https://aws.amazon.com/partners/work-with-partners/?nc2=h_ql_pa_wwap_cp "https://aws.amazon.com/partners/work-with-partners/?nc2=h_ql_pa_wwap_cp") to increase adoption of automation and improve
...
- **Build once and deploy
  ...
  [AWS Launch Wizard](https://aws.amazon.com/launchwizard/ "https://aws.amazon.com/launchwizard/") to reduce the time to deploy many
  ...
  also use the
  [Service Catalog](https://aws.amazon.com/servicecatalog/ "https://aws.amazon.com/servicecatalog/"), which helps you create and manage
...
- **Automate continuous
  ...
  and [AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/"), you can efficiently manage and
...
- **Automate maintenance and
  ...
  [EC2 Image Builder](https://aws.amazon.com/image-builder/ "https://aws.amazon.com/image-builder/") for building, testing, and deployment
  ...
  [AWS Command Line Interface](../../../cli/index.md "../../../cli/index.md") (AWS CLI) or AWS SDK tools.
  ...
  see AWS SDK Code
  [examples
  repository](https://github.com/awsdocs/aws-doc-sdk-examples "https://github.com/awsdocs/aws-doc-sdk-examples").
...
- **Delete unnecessary
  ...
  [aws-nuke](../../../prescriptive-guidance/latest/patterns/automate-deletion-of-aws-resources-by-using-aws-nuke.md "../../../prescriptive-guidance/latest/patterns/automate-deletion-of-aws-resources-by-using-aws-nuke.md").
...
- [Modernizing
  operations in the AWS Cloud](../../../prescriptive-guidance/latest/migration-operations-integration.md "../../../prescriptive-guidance/latest/migration-operations-integration.md")
- [AWS Services for Automation](../../../prescriptive-guidance/latest/migration-operations-integration/aws-services-for-automation.md "../../../prescriptive-guidance/latest/migration-operations-integration/aws-services-for-automation.md")
- [Infrastructure
  and automation](https://aws.amazon.com/blogs/infrastructure-and-automation/ "https://aws.amazon.com/blogs/infrastructure-and-automation/")
...
- [Automated
  and manual monitoring](../../../AWSEC2/latest/UserGuide/monitoring_automated_manual.md "../../../AWSEC2/latest/UserGuide/monitoring_automated_manual.md")
- [AWS automations for SAP administration and operations](../../../prescriptive-guidance/latest/strategy-sap-automation/automations.md "../../../prescriptive-guidance/latest/strategy-sap-automation/automations.md")
- [AWS Managed Services](../../../managedservices/index.md "../../../managedservices/index.md")
- [AWS Professional Services](https://aws.amazon.com/professional-services/ "https://aws.amazon.com/professional-services/")

**Related videos:**

- [Automate
  Continuous Compliance at Scale in AWS](https://www.youtube.com/watch?v=5WOL8Njvx48 "https://www.youtube.com/watch?v=5WOL8Njvx48")
- [AWS Backup Demo: Cross-Account & Cross-Region Backup](https://www.youtube.com/watch?v=dCy7ixko3tE "https://www.youtube.com/watch?v=dCy7ixko3tE")
- [Patching
  for your Amazon EC2 Instances](https://www.youtube.com/watch?v=ABtwRb9BFY4 "https://www.youtube.com/watch?v=ABtwRb9BFY4")

**Related examples:**

- [Reinventing
  automated operations (Part I)](https://aws.amazon.com/blogs/mt/reinventing-automated-operations-part-i/ "https://aws.amazon.com/blogs/mt/reinventing-automated-operations-part-i/")
- [Reinventing
  automated operations (Part II)](https://aws.amazon.com/blogs/mt/reinventing-automated-operations-part-ii/ "https://aws.amazon.com/blogs/mt/reinventing-automated-operations-part-ii/")
- [Automate
  deletion of AWS resources by using aws-nuke](../../../prescriptive-guidance/latest/patterns/automate-deletion-of-aws-resources-by-using-aws-nuke.md "../../../prescriptive-guidance/latest/patterns/automate-deletion-of-aws-resources-by-using-aws-nuke.md")
- [Delete
  unused Amazon EBS volumes by using AWS Config and AWS
  SSM](../../../prescriptive-guidance/latest/patterns/delete-unused-amazon-elastic-block-store-amazon-ebs-volumes-by-using-aws-config-and-aws-systems-manager.md "../../../prescriptive-guidance/latest/patterns/delete-unused-amazon-elastic-block-store-amazon-ebs-volumes-by-using-aws-config-and-aws-systems-manager.md")
- [Automate
...
- [IT
  Automations with AWS Lambda](https://aws.amazon.com/lambda/it-automation/ "https://aws.amazon.com/lambda/it-automation/")
