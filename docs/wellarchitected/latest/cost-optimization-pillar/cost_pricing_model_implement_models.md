...
![Chart of AWS services committed using Reserved Instances and Savings Plans](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/images/ri-sp-services.png)
