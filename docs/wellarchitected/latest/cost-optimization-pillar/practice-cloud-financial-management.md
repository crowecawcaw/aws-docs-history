...
**Topics**
+ [COST01-BP01 Establish ownership of cost optimization](cost_cloud_financial_management_function.md)
+ [COST01-BP02 Establish a partnership between finance and technology](cost_cloud_financial_management_partnership.md)
+ [COST01-BP03 Establish cloud budgets and forecasts](cost_cloud_financial_management_budget_forecast.md)
+ [COST01-BP04 Implement cost awareness in your organizational processes](cost_cloud_financial_management_cost_awareness.md)
+ [COST01-BP05 Report and notify on cost optimization](cost_cloud_financial_management_usage_report.md)
+ [COST01-BP06 Monitor cost proactively](cost_cloud_financial_management_proactive_process.md)
