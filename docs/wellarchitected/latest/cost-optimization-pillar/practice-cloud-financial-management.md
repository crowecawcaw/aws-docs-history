...
lead to inaccurate planning, and result in less visibility. Ultimately, this results in a lost opportunity to eﬀectively optimize
...
![Descriptions of the four CFM pillars see, save, plan, and run.](images/cfm-pillars.png)
...
- [COST01-BP02 Establish a partnership between finance and technology](cost_cloud_financial_management_partnership.md "cost_cloud_financial_management_partnership.md")
...
- [COST01-BP04 Implement cost awareness in your organizational processes](cost_cloud_financial_management_cost_awareness.md "cost_cloud_financial_management_cost_awareness.md")
