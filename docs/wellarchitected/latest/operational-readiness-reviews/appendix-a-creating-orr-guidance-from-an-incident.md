...
<a name="appendix-a-creating-orr-guidance-from-an-incident"></a>
...
<a name="post-incident-analysis"></a>
...
<a name="orr-guidance-generation"></a>
...
+ Use [change sets](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-updating-stacks-changesets.html) to validate the intent of your stack update matches the actions that CloudFormation will take when the change set is executed. 
+ Test CloudFormation stack updates in a pre-production environment that mirrors production. 
+ Apply [stack policies](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/protect-stack-resources.html) to protect critical resources from being unintentionally updated or deleted. 
