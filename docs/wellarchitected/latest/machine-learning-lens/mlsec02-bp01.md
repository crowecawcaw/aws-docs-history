...
[AWS Key Management Service (KMS)](https://aws.amazon.com/kms/ "https://aws.amazon.com/kms/") and
[AWS CloudHSM](https://aws.amazon.com/cloudhsm/ "https://aws.amazon.com/cloudhsm/") support robust encryption strategies. You should
...
1. **Audit data for attributes requiring
   ...
   tools like
   [AWS Glue](https://aws.amazon.com/glue/ "https://aws.amazon.com/glue/") to identify PII and sensitive data patterns
   within your datasets.
2. **Establish a data classification
...
3. **Implement field-level
   ...
   [Amazon DynamoDB](https://aws.amazon.com/dynamodb/ "https://aws.amazon.com/dynamodb/") for transparent encryption of selected
   fields.
4. **Apply data obfuscation
   ...
   [AWS Glue DataBrew](https://aws.amazon.com/glue/features/databrew/ "https://aws.amazon.com/glue/features/databrew/") for data transformation and masking
   operations.
5. **Establish key rotation
   policies**. Implement regular rotation of
   encryption keys to minimize the impact of potential key
   compromises. Configure
   [AWS KMS](https://aws.amazon.com/kms/ "https://aws.amazon.com/kms/") to automate key rotation according to your
...
6. **Secure ML model
   ...
   information. Use
   [Amazon SageMaker AI's](https://aws.amazon.com/sagemaker/ "https://aws.amazon.com/sagemaker/") security features to encrypt model
...
7. **Implement access
   ...
   [AWS Identity and Access Management (IAM)](https://aws.amazon.com/iam/ "https://aws.amazon.com/iam/") policies. Apply the
...
8. **Monitor and audit access
   ...
   [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") to track and alert on suspicious
   activities.
...
10. **Establish mechanisms to stop model
...
- [Detect
  and process sensitive data](../../../glue/latest/dg/detect-PII.md "../../../glue/latest/dg/detect-PII.md")
- [Security
  Pillar - AWS Well-Architected Framework](../security-pillar/welcome.md "../security-pillar/welcome.md")
- [Data
  protection in Amazon SageMaker AI Unified Studio](../../../sagemaker-unified-studio/latest/adminguide/data-protection.md "../../../sagemaker-unified-studio/latest/adminguide/data-protection.md")
- [Data
  Privacy in Amazon SageMaker AI](../../../sagemaker/latest/dg/data-privacy.md "../../../sagemaker/latest/dg/data-privacy.md")
- [Data
  Encryption](../../../whitepapers/latest/introduction-aws-security/data-encryption.md "../../../whitepapers/latest/introduction-aws-security/data-encryption.md")
- [Introducing
  PII Data Identification and Handling Using AWS Glue
  DataBrew](https://aws.amazon.com/blogs/big-data/introducing-pii-data-identification-and-handling-using-aws-glue-databrew/ "https://aws.amazon.com/blogs/big-data/introducing-pii-data-identification-and-handling-using-aws-glue-databrew/")
- [7
...
- [Data
  Protection Best Practices in Machine Learning](https://www.youtube.com/watch?v=1iZYmtFFLnw "https://www.youtube.com/watch?v=1iZYmtFFLnw")
