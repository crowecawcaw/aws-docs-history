...
2. **Analyze metrics when events or
...
3. **Establish key performance indicators
   ...
   [SageMaker AI
   Training Plans](https://aws.amazon.com/sagemaker/pricing/ "https://aws.amazon.com/sagemaker/pricing/") for cost optimization of large-scale
   AI training workloads.
4. **Use monitoring to generate
...
8. **Use Amazon EventBridge for automated
...
9. **Use AWS Application Cost Profiler
   ...
   [SageMaker AI
   Training Plans](https://aws.amazon.com/sagemaker/pricing/ "https://aws.amazon.com/sagemaker/pricing/") for compute reservation and better
   resource planning of high-demand GPU resources. Use these
   insights to optimize resource allocation and identify
   opportunities for cost savings.
10. **Implement SageMaker AI Model Monitor
...
11. **Use AWS X-Ray for distributed
...
12. **Implement Amazon SageMaker AI Clarify
...
- [Using
  Amzon CloudWatch dashboards](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Dashboards.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Dashboards.md")
- [DevOps
