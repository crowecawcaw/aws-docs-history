...
2. **Create a software license
   ...
   [AWS License Manager](https://aws.amazon.com/license-manager/ "https://aws.amazon.com/license-manager/") to track and manage software licenses
   across your ML environments, improving adherence to
   licensing agreements and optimizing license usage.
3. **Bootstrap instances with lifecycle
   ...
   [Amazon SageMaker AI Lifecycle Configurations](../../../sagemaker/latest/dg/studio-lifecycle-configurations.md "../../../sagemaker/latest/dg/studio-lifecycle-configurations.md") to automate the
   setup of development environments with pre-approved software
   packages and configurations.
4. **Evaluate package integrations that
...
5. **Use prebuilt containers**.
   ...
   [AWS Deep Learning Containers](../../../deep-learning-containers/latest/devguide/what-is-dlc.md "../../../deep-learning-containers/latest/devguide/what-is-dlc.md") contain several deep
...
6. **Establish a privacy-preserving ML
   ...
   stakeholders.
7. **Monitor for license and privacy
...
8. **Consider synthetic data for training
   and testing**. Create synthetic datasets that
   preserve the statistical properties of real data while
   avoiding privacy concerns.
   [Amazon SageMaker AI](https://aws.amazon.com/sagemaker/ "https://aws.amazon.com/sagemaker/") provides capabilities for generating
...
- [What
  is AWS Deep Learning Containers?](../../../deep-learning-containers/latest/devguide/what-is-dlc.md "../../../deep-learning-containers/latest/devguide/what-is-dlc.md")
- [AWS License Manager](https://aws.amazon.com/license-manager/ "https://aws.amazon.com/license-manager/")
- [Lifecycle
  configurations within Amazon SageMaker AI Studio](../../../sagemaker/latest/dg/studio-lifecycle-configurations.md "../../../sagemaker/latest/dg/studio-lifecycle-configurations.md")
- [Data
  Privacy in Amazon SageMaker AI](../../../sagemaker/latest/dg/data-privacy.md "../../../sagemaker/latest/dg/data-privacy.md")
- [Best
  practices for endpoint security and health with Amazon SageMaker AI](../../../sagemaker/latest/dg/best-practice-endpoint-security.md "../../../sagemaker/latest/dg/best-practice-endpoint-security.md")
- [Private
