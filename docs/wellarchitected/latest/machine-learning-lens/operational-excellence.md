...
- [Business goal identification](ops-business-goal-identification.md "ops-business-goal-identification.md")
- [ML problem framing](ops-ml-problem-framing.md "ops-ml-problem-framing.md")
- [Data processing](ops-data-processing.md "ops-data-processing.md")
- [Model development](ops-model-development.md "ops-model-development.md")
