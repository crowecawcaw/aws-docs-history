...
- [Business goal identification](sec-business-goal-identification.md "sec-business-goal-identification.md")
- [ML problem framing](sec-ml-problem-framing.md "sec-ml-problem-framing.md")
- [Data processing](sec-data-processing.md "sec-data-processing.md")
- [Model development](sec-model-development.md "sec-model-development.md")
- [Deployment](sec-deployment.md "sec-deployment.md")
- [Monitoring](sec-monitoring.md "sec-monitoring.md")
