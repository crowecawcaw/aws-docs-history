...
| CONTAINER_BUILD_COST_07: How do you minimize cost for your<br>containerized application during startup time? |
| ------------------------------------------------------------------------------------------------------------ |
|                                                                                                              |
...
| CONTAINER_BUILD_COST_08: What systems are you using to create<br>your container build process? |
| ---------------------------------------------------------------------------------------------- |
|                                                                                                |
