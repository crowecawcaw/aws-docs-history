...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies can enable or
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"). Alarms on fallback rates
...
1. **Implement capability toggling
   through AgentCore Policy:** Use Cedar policies in
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") to control tool access at
   the gateway boundary.
2. **Define and implement fallback
   behaviors for each capability:** Document the
   reduced-capability behavior that activates when a toggle is
   flipped.
3. **Test fallback paths alongside
   primary implementations:** Validate that fallbacks
   produce acceptable results, not just that they don't error.
4. **Monitor toggle state and fallback
...
5. **Configure alarms on elevated
