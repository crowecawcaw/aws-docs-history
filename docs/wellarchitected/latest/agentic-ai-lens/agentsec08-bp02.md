...
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails-sensitive-info.md "../../../bedrock/latest/userguide/guardrails-sensitive-info.md") sensitive information filters cover the
...
1. **Configure sensitive information
   filters:** Set up
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails-sensitive-info.md "../../../bedrock/latest/userguide/guardrails-sensitive-info.md") with filters for all relevant PII
   and credential categories, choosing MASK or BLOCK per
   category based on data classification policy.
2. **Filter every output path:**
   Apply output filtering as a middleware layer for user-facing
   responses, inter-agent messages, memory writes, and audit
   logs.
3. **Filter before short-term memory
   ...
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/best-practices.md "../../../bedrock-agentcore/latest/devguide/best-practices.md") short-term storage.
4. **Extend with Amazon Comprehend custom
...
- [Amazon
  Bedrock Guardrails sensitive information filters](../../../bedrock/latest/userguide/guardrails-sensitive-info.md "../../../bedrock/latest/userguide/guardrails-sensitive-info.md")
- [Amazon
...
- [Amazon Comprehend documentation](../../../comprehend/latest/dg/what-is.md "../../../comprehend/latest/dg/what-is.md")
