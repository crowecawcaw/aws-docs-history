...
[Amazon
Bedrock AgentCore Runtime](https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/ "https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/") A2A protocol support provides a
...
[Policy
in Amazon Bedrock AgentCore](https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/ "https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/") reinforces trust boundaries at
...
2. **Segment at the network
   ...
   zone boundaries.
3. **Enforce identity at the application
   layer:** For agents on
   [Amazon
   Bedrock AgentCore Runtime](https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/ "https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/"), configure A2A agent card
...
5. **Reinforce at the tool layer with
   Policy:** Configure Cedar policies in
   [Policy
   in Amazon Bedrock AgentCore](https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/ "https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/") with conditions on
   calling principal identity and trust level.
6. **Keep cross-zone traffic
...
- [AGENTSEC06-BP01 Encrypt
  and sign inter-agent messages](agentsec06-bp01.md "agentsec06-bp01.md")
- [AGENTSEC06-BP02
  Implement workflow orchestration security controls](agentsec06-bp02.md "agentsec06-bp02.md")

**Related documents:**

- [Introducing
  agent-to-agent protocol support in Amazon Bedrock AgentCore
  Runtime](https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/ "https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/")
- [Secure
...
- [AWS VPC security best practices](../../../vpc/latest/userguide/vpc-security-best-practices.md "../../../vpc/latest/userguide/vpc-security-best-practices.md")
- [AWS Config managed rules reference](../../../config/latest/developerguide/managed-rules-by-aws-config.md "../../../config/latest/developerguide/managed-rules-by-aws-config.md")
- [AWS Config custom rules with Lambda](../../../config/latest/developerguide/evaluate-config_develop-rules_lambda-functions.md "../../../config/latest/developerguide/evaluate-config_develop-rules_lambda-functions.md")
- [Security
