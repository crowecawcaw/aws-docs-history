...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md")'s configuration capabilities
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"), alerting when instances
...
1. **Define configuration profiles per
...
3. **Implement configuration change
   detection logging:** Log version changes so
   behavioral changes can be correlated with deployments.
4. **Use encrypted parameter storage for
   sensitive values:** Apply fine-grained access
   control on secrets.
5. **Monitor for configuration
   drift:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to alert when
...
- [Make
  ...
  available](https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-agentcore-is-now-generally-available/ "https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-agentcore-is-now-generally-available/")
- [Amazon
