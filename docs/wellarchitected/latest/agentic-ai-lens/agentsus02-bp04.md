...
[AWS Sustainability](../../../sustainability/latest/userguide/what-is-sustainability.md "../../../sustainability/latest/userguide/what-is-sustainability.md") provides carbon emissions tracking with
service and Region breakdowns for the infrastructure side, and
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") adds agent-specific
...
[Amazon
Bedrock cross-region inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") extends the same principle
...
1. **Enable carbon emissions
   tracking:** Turn on
   [AWS Sustainability](../../../sustainability/latest/userguide/what-is-sustainability.md "../../../sustainability/latest/userguide/what-is-sustainability.md") and establish environmental baselines
   for agent infrastructure across a 30-day observation window.
2. **Instrument resource efficiency per
   task:** Configure
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to track tokens per
   successful completion, compute hours per workflow execution,
   and cache hit rates.
3. **Schedule deferrable workloads
...
4. **Evaluate Region placement for batch
   work:** For workloads with flexible latency, use
   [Amazon
   Bedrock cross-region inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") to route requests to
   Regions with favorable energy profiles.
5. **Build combined dashboards and review
...
- [SUS01-BP01
  ...
  sustainability goals](../sustainability-pillar/sus_sus_region_a2.md "../sustainability-pillar/sus_sus_region_a2.md")

**Related documents:**

- [AWS Sustainability User Guide](../../../sustainability/latest/userguide/what-is-sustainability.md "../../../sustainability/latest/userguide/what-is-sustainability.md")
- [Announcing
  the AWS Sustainability console](https://aws.amazon.com/blogs/aws/announcing-the-aws-sustainability-console-programmatic-access-configurable-csv-reports-and-scope-1-3-reporting-in-one-place/ "https://aws.amazon.com/blogs/aws/announcing-the-aws-sustainability-console-programmatic-access-configurable-csv-reports-and-scope-1-3-reporting-in-one-place/")
- [Sustainability
