...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") provides a three-tiered
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md"), session isolation keeps cost
...
correlate.
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") measures output quality
...
1. **Enable distributed tracing across
   agents:** Configure
   [Amazon
...
2. **Apply role-based tagging and compute
...
3. **Visualize cost by pattern and alarm
...
5. **Compare workflow efficiency in Cost Explorer:** Use AWS Cost Explorer to compare
   efficiency across different collaboration patterns over
   time.
6. **Decompose workflow cost:**
