...
1. Latency (time-to-first-token for streaming agents, end-to-end
   completion time for task-oriented agents, and per-phase
   budgets across the reasoning pipeline)
2. Throughput (concurrent sessions, sustained requests per
   second, and queue depth under load)
3. Quality (task completion rate, tool selection and parameter
   accuracy, reasoning grounding, and response faithfulness)
4. Efficiency (tokens per task, cost per completion, and cache
   hit rate).

Layered
[agent
evaluation frameworks](https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/ "https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/") decompose quality further into
...
goals for others.
[AWS Well-Architected Performance Efficiency guidance](../performance-efficiency-pillar/perf_process_culture_establish_key_performance_indicators.md "../performance-efficiency-pillar/perf_process_culture_establish_key_performance_indicators.md") reinforces
...
[Amazon CloudWatch Application Signals service level objectives](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md")
...
[Operationalizing
agentic AI on AWS](../../../prescriptive-guidance/latest/strategy-operationalizing-agentic-ai/introduction.md "../../../prescriptive-guidance/latest/strategy-operationalizing-agentic-ai/introduction.md") frames this lifecycle discipline as
...
1. **Capture business outcomes and user
   ...
   guidance](../performance-efficiency-pillar/perf_process_culture_establish_key_performance_indicators.md "../performance-efficiency-pillar/perf_process_culture_establish_key_performance_indicators.md") treats this stakeholder alignment as the
   first step in establishing credible KPIs.
2. **Classify each agent workload by
   ...
   set.
3. **Define the KPI taxonomy spanning
   ...
   [agent
   evaluation framework described by Amazon teams](https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/ "https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/").
   Include efficiency signals such as tokens per task, cost per
   completion, and cache hit rate to connect performance to
   unit economics.
4. **Set quantitative targets with
   ...
   [AWS Well-Architected Performance Efficiency pillar](../performance-efficiency-pillar/welcome.md "../performance-efficiency-pillar/welcome.md")
   cautions that averages hide the slow responses that matter
   most.
5. **Allocate per-phase latency budgets
   ...
   assumption.
6. **Formalize targets as service level
   ...
   objectives](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md"). Configure burn-rate alarms so the service
...
7. **Operationalize quality and cost KPIs
   ...
   [Amazon CloudWatch generative AI observability](../../../AmazonCloudWatch/latest/monitoring/GenAI-observability.md "../../../AmazonCloudWatch/latest/monitoring/GenAI-observability.md"), which
   ...
   [AWS Distro for OpenTelemetry](https://aws-otel.github.io/docs/introduction "https://aws-otel.github.io/docs/introduction"). Emit agent-specific quality
...
8. **Integrate targets as quality gates
   ...
   [Operationalizing
   agentic AI on AWS](../../../prescriptive-guidance/latest/strategy-operationalizing-agentic-ai/introduction.md "../../../prescriptive-guidance/latest/strategy-operationalizing-agentic-ai/introduction.md"). Gates turn written criteria into
   enforceable artifacts that help prevent regressions rather
   than detecting them in production.
9. **Revisit targets on a defined cadence
...
- [AGENTOPS05-BP04
  Define and track KPIs for agent workflows](agentops05-bp04.md "agentops05-bp04.md")
- [AGENTOPS06-BP02
  Evaluate and track ongoing agent performance](agentops06-bp02.md "agentops06-bp02.md")
- [AGENTCOST05-BP01
...
- [AWS Well-Architected Framework: Performance Efficiency
  Pillar](../performance-efficiency-pillar/welcome.md "../performance-efficiency-pillar/welcome.md")
- [Amazon CloudWatch Application Signals: Service level objectives
  (SLOs)](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-ServiceLevelObjectives.md")
...
- [Blog:
  ...
  systems at Amazon](https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/ "https://aws.amazon.com/blogs/machine-learning/evaluating-ai-agents-real-world-lessons-from-building-agentic-systems-at-amazon/")
