...
[Amazon
Bedrock prompt caching](../../../bedrock/latest/userguide/prompt-caching.md "../../../bedrock/latest/userguide/prompt-caching.md") is the highest-impact layer for
...
query
[Amazon OpenSearch Service Serverless](https://aws.amazon.com/opensearch-service/features/serverless/ "https://aws.amazon.com/opensearch-service/features/serverless/") for similar prior requests above a
...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") manages conversation state by
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"), and alarm when hit rates
fall below targets.
...
1. **Enable prompt caching for stable
   prefixes:** Turn on
   [Amazon
   Bedrock prompt caching](../../../bedrock/latest/userguide/prompt-caching.md "../../../bedrock/latest/userguide/prompt-caching.md") for agents with system prompts
   larger than 1,000 tokens, and refactor the prompt to move
   dynamic content out of the cacheable prefix.
2. **Deploy a semantic cache
...
3. **Cache plan templates:** Key
   plan templates by task type and input parameter signature,
   and perform a pre-invocation lookup before generating a new
   plan.
4. **Use managed memory for session
   state:** Configure
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") session identifiers so
   multi-turn conversation state is maintained without manual
   history concatenation.
5. **Design event-driven invalidation and
...
- [AGENTCOST03-BP01
  ...
  memory](agentcost03-bp01.md "agentcost03-bp01.md")
