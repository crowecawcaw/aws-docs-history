...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") to cap retries within a single
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") with structured metadata
...
2. **Configure retry with exponential
   backoff and full jitter:** Use
   failure-type-specific retry counts so the strategy matches
   the failure mode.
3. **Enforce retry budgets through
   AgentCore Policy:** Use
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") to help prevent retry storms
   during widespread failures.
4. **Build self-healing workflows for
   common patterns:** Implement prompt refinement,
   tool substitution, and context reconstruction as targeted
   recovery paths.
5. **Log recovery actions for
   analysis:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to capture retry
...
- [AGENTREL07-BP01 Design
  workflows in stages with incremental recovery](agentrel07-bp01.md "agentrel07-bp01.md")
- [AGENTREL07-BP03
