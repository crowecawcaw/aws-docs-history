...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") provides a persistent filesystem
...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") persists insights across sessions
...
agent type using
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") with custom dimensions, and
set Amazon CloudWatch alarms when growth exceeds expected bounds.

### Implementation steps

1. **Deploy on AgentCore Runtime with
   tuned lifecycle parameters:** Use
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") for automatic session
   lifecycle management, configuring idleRuntimeSessionTimeout
   and maxLifetime based on workload patterns.
2. **Integrate managed memory for durable
   learning:** Configure
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") short-term memory for recent
   context and long-term memory for persistent insights,
   keeping durable learning separate from ephemeral filesystem
   state.
3. **Archive compliance-required sessions
   to S3:** Export completed session histories to
   [Amazon S3 Intelligent-Tiering](https://aws.amazon.com/s3/storage-classes/intelligent-tiering/ "https://aws.amazon.com/s3/storage-classes/intelligent-tiering/") and set lifecycle rules for
   cost-effective long-term retention.
4. **Monitor storage per agent
   type:** Configure
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") with custom
