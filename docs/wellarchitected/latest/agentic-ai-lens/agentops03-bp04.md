...
governance](agentops03-bp01.md "agentops03-bp01.md")). The fields added at this layer are the ones
...
[AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md") provides the centralized catalog with
...
[AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md") provides built-in hybrid search that
...
[Amazon Quick
Suite](https://aws.amazon.com/quicksuite/ "https://aws.amazon.com/quicksuite/") alike. A lightweight CI/CD gate that checks the
...
[Amazon EventBridge](https://aws.amazon.com/eventbridge/ "https://aws.amazon.com/eventbridge/") publishes events when agents are deprecated,
modified, or decommissioned so downstream teams receive advance
notice. Agents exposed through
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") benefit from Gateway's tool
registration metadata, which automatically tracks which agents
consume which tools and reduces manual declaration burden. A
dependency graph in
[Amazon Neptune](https://aws.amazon.com/neptune/ "https://aws.amazon.com/neptune/") enables impact analysis for determining how a
...
1. Utilization (which agents are actively used and which are
   idle)
2. Cost efficiency (which agents deliver business value
   proportional to cost)
3. Redundancy (which agents overlap with others)
4. Health (which agents show elevated error rates, degraded
   performance, or stale configurations)

The catalog is the primary data source, enriched with
[Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") metrics,
[AWS Cost Explorer](https://aws.amazon.com/aws-cost-management/aws-cost-explorer/ "https://aws.amazon.com/aws-cost-management/aws-cost-explorer/") attribution, and the dependency graph.
...
1. **Extend the agent registry into an
   organizational catalog:** Use
   [AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md") to catalog agents with metadata for
   owning team, business domain, upstream and downstream
   dependencies, cost-per-month, and business value indicators.
2. **Enable semantic capability
...
3. **Gate new agent creation on registry
   search:** Add a pre-creation CI/CD check that
   requires justification when overlapping agents exist.
4. **Track cross-team
   dependencies:** Use
   [Amazon EventBridge](../../../eventbridge/latest/userguide/eb-what-is.md "../../../eventbridge/latest/userguide/eb-what-is.md") to notify downstream teams when upstream
   agents are deprecated, modified, or decommissioned.
5. **Build a dependency graph:**
   Use
   [Amazon Neptune](../../../neptune/latest/userguide/intro.md "../../../neptune/latest/userguide/intro.md") to answer impact-analysis questions before
   agent modifications.
6. **Run quarterly portfolio
...
- [AGENTOPS03-BP01 Define
  ...
  governance](agentops03-bp01.md "agentops03-bp01.md")
- [AGENTOPS03-BP02
  Implement CI/CD pipelines tailored to agentic system
  deployment (AgentOps)](agentops03-bp02.md "agentops03-bp02.md")
- [AGENTOPS04-BP01
  Implement tool registry and catalog management](agentops04-bp01.md "agentops04-bp01.md")
- [AGENTOPS05-BP04
...
- [AGENTCOST06-BP01
  ...
  cost-effective collaboration](agentcost06-bp01.md "agentcost06-bp01.md")
...
- [AWS 2025 - AgentCore Registry: Discover, Govern, and Reuse AI
  Agents at Scale](https://www.youtube.com/watch?v=rIcOJrE-fTk "https://www.youtube.com/watch?v=rIcOJrE-fTk")
...
- [AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md")
- [Amazon
