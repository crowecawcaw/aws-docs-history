...
[Amazon
Bedrock AgentCore Runtime](https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/ "https://aws.amazon.com/blogs/machine-learning/introducing-agent-to-agent-protocol-support-in-amazon-bedrock-agentcore-runtime/") with the A2A protocol handles
...
3. **Validate inputs inside state
   ...
   expected schemas.
4. **Configure circuit breakers with
...
5. **Log every execution at the ALL
...
- [AGENTREL07-BP02
  Enable automatic recovery from agent execution failures](agentrel07-bp02.md "agentrel07-bp02.md")

**Related documents:**

- [AWS Step Functions security documentation](../../../step-functions/latest/dg/security.md "../../../step-functions/latest/dg/security.md")
- [Step
...
- [Using
  ...
  DynamoDB](https://aws.amazon.com/blogs/compute/using-the-circuit-breaker-pattern-with-aws-step-functions-and-amazon-dynamodb/ "https://aws.amazon.com/blogs/compute/using-the-circuit-breaker-pattern-with-aws-step-functions-and-amazon-dynamodb/")
- [AWS Prescriptive Guidance: Circuit breaker pattern](../../../prescriptive-guidance/latest/cloud-design-patterns/circuit-breaker.md "../../../prescriptive-guidance/latest/cloud-design-patterns/circuit-breaker.md")
- [Introducing
