...
[Structured
outputs on Amazon Bedrock blog](https://aws.amazon.com/blogs/machine-learning/structured-outputs-on-amazon-bedrock-schema-compliant-ai-responses/ "https://aws.amazon.com/blogs/machine-learning/structured-outputs-on-amazon-bedrock-schema-compliant-ai-responses/") covers the parameter shapes
...
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") Automated Reasoning checks verify that
...
1. **Constrain parameters at the model
...
2. **Enforce schemas in the invocation
...
3. **Add Cedar policy checks at the
...
4. **Use Automated Reasoning for logical
   constraints:** Configure
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") Automated Reasoning policies for
   tool inputs and outputs that require logical constraint
   validation beyond schema and Cedar rules.
5. **Right-size Lambda limits per
...
- [Amazon
  Bedrock Guardrails automated reasoning checks](../../../bedrock/latest/userguide/guardrails-automated-reasoning.md "../../../bedrock/latest/userguide/guardrails-automated-reasoning.md")
- [Structured
  outputs on Amazon Bedrock: Schema-compliant AI
  responses](https://aws.amazon.com/blogs/machine-learning/structured-outputs-on-amazon-bedrock-schema-compliant-ai-responses/ "https://aws.amazon.com/blogs/machine-learning/structured-outputs-on-amazon-bedrock-schema-compliant-ai-responses/")
- [Secure
...
- [AWS Lambda best practices](../../../lambda/latest/dg/best-practices.md "../../../lambda/latest/dg/best-practices.md")
