...
1. **Choose agent-specific metrics and
...
2. **Add evaluation-based early
   warning:** Deploy
   [Amazon
   Bedrock AgentCore Evaluations](https://aws.amazon.com/blogs/aws/amazon-bedrock-agentcore-adds-quality-evaluations-and-policy-controls-for-deploying-trusted-ai-agents/ "https://aws.amazon.com/blogs/aws/amazon-bedrock-agentcore-adds-quality-evaluations-and-policy-controls-for-deploying-trusted-ai-agents/") with built-in and
...
4. **Automate containment on threshold
   ...
   event broadcast.
5. **Wire circuit breakers into dependent
...
6. **Provide a manual runbook with
...
- [Amazon Macie documentation](../../../macie/latest/user/what-is-macie.md "../../../macie/latest/user/what-is-macie.md")
- [AWS Step Functions error handling](../../../step-functions/latest/dg/concepts-error-handling.md "../../../step-functions/latest/dg/concepts-error-handling.md")
