...
- [AWS Step Functions parallel states](../../../step-functions/latest/dg/amazon-states-language-parallel-state.md "../../../step-functions/latest/dg/amazon-states-language-parallel-state.md")
- [Human
