...
1. Running independent operations concurrently rather than
   sequentially
2. Reusing warm connections and runtimes across invocations
3. Removing cold starts from the critical path
4. Deduplicating repeated lookups within a single request.
...
respect
[Amazon
Bedrock service quotas](../../../bedrock/latest/userguide/quotas.md "../../../bedrock/latest/userguide/quotas.md") (requests-per-minute and
...
[Amazon RDS Proxy](../../../AmazonRDS/latest/UserGuide/rds-proxy.md "../../../AmazonRDS/latest/UserGuide/rds-proxy.md") pools connections to Aurora and RDS so serverless
agents don't exhaust database connection limits or pay
connection-setup latency per invocation. At runtime,
[Amazon
Bedrock AgentCore Runtime sessions](../../../bedrock-agentcore/latest/devguide/runtime-sessions.md "../../../bedrock-agentcore/latest/devguide/runtime-sessions.md") reuse a dedicated
...
[Lambda
provisioned concurrency](../../../lambda/latest/dg/provisioned-concurrency.md "../../../lambda/latest/dg/provisioned-concurrency.md") pre-initializes execution
environments and
[Lambda
SnapStart](../../../lambda/latest/dg/snapstart.md "../../../lambda/latest/dg/snapstart.md") restores from a cached snapshot on supported
...
1. **Profile the critical path to
...
2. **Execute independent operations
   ...
   service's capacity,
   [Amazon
   Bedrock service quotas](../../../bedrock/latest/userguide/quotas.md "../../../bedrock/latest/userguide/quotas.md"), tool-API rate limits, and
...
3. **Reuse connections to model endpoints
   ...
   [AWS Lambda execution environments](../../../lambda/latest/dg/lambda-runtime-environment.md "../../../lambda/latest/dg/lambda-runtime-environment.md"), container-based
   ...
   calls.
4. **Pool database connections through a
   managed connection pool:** For agents that read
   from or write to relational data, front Aurora and RDS
   databases with
   [Amazon RDS Proxy](../../../AmazonRDS/latest/UserGuide/rds-proxy.md "../../../AmazonRDS/latest/UserGuide/rds-proxy.md") so serverless invocations share a bounded
...
5. **Remove cold starts from the agent
   ...
   environments and
   [Lambda
   SnapStart](../../../lambda/latest/dg/snapstart.md "../../../lambda/latest/dg/snapstart.md") restores from a cached snapshot on
...
6. **Deduplicate repeated lookups within
...
7. **Re-measure the critical path after
...
- [Amazon
  Bedrock service quotas](../../../bedrock/latest/userguide/quotas.md "../../../bedrock/latest/userguide/quotas.md")
- [Amazon
  Bedrock AgentCore Runtime sessions](../../../bedrock-agentcore/latest/devguide/runtime-sessions.md "../../../bedrock-agentcore/latest/devguide/runtime-sessions.md")
- [Amazon
...
- [Amazon RDS Proxy](../../../AmazonRDS/latest/UserGuide/rds-proxy.md "../../../AmazonRDS/latest/UserGuide/rds-proxy.md")
- [AWS Lambda execution environments](../../../lambda/latest/dg/lambda-runtime-environment.md "../../../lambda/latest/dg/lambda-runtime-environment.md")
- [AWS Lambda provisioned concurrency](../../../lambda/latest/dg/provisioned-concurrency.md "../../../lambda/latest/dg/provisioned-concurrency.md")
- [AWS Lambda SnapStart](../../../lambda/latest/dg/snapstart.md "../../../lambda/latest/dg/snapstart.md")
- [Building
  serverless architectures for agentic AI on AWS](../../../prescriptive-guidance/latest/agentic-ai-serverless/introduction.md "../../../prescriptive-guidance/latest/agentic-ai-serverless/introduction.md")
...
- [Amazon RDS Proxy](https://aws.amazon.com/rds/proxy/ "https://aws.amazon.com/rds/proxy/")
