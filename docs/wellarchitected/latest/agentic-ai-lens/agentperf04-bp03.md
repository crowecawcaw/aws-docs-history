...
Use [Amazon EventBridge](https://aws.amazon.com/eventbridge/ "https://aws.amazon.com/eventbridge/") as the primary event bus for agent workflow
...
streams,
[Amazon Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams/ "https://aws.amazon.com/kinesis/data-streams/") with Lambda event source mappings
...
[Amazon DynamoDB](https://aws.amazon.com/dynamodb/ "https://aws.amazon.com/dynamodb/"), with references in the event. EventBridge Schema
...
[Amazon DynamoDB Streams](../../../amazondynamodb/latest/developerguide/Streams.md "../../../amazondynamodb/latest/developerguide/Streams.md") triggers agents directly from data changes
...
triggering an agent,
[AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/") or
[EventBridge
Pipes](https://aws.amazon.com/eventbridge/pipes/ "https://aws.amazon.com/eventbridge/pipes/") aggregate and transform events before agent
invocation.

### Implementation steps

1. **Configure EventBridge rules with
   content-based filtering to route events to specific
   agents:** Use content-based filtering on
   [Amazon EventBridge](https://aws.amazon.com/eventbridge/ "https://aws.amazon.com/eventbridge/") so agents receive only the events whose
   attributes match their responsibilities.
2. **Design minimal event schemas with
...
3. **Implement DynamoDB Streams for
   data-change-driven agent triggers:** Use
   [Amazon DynamoDB Streams](../../../amazondynamodb/latest/developerguide/Streams.md "../../../amazondynamodb/latest/developerguide/Streams.md") to trigger agents directly from data
   changes without polling.
4. **Implement idempotency keys for event
...
- [AGENTPERF05-BP01
  Design efficient workflow orchestration patterns](agentperf05-bp01.md "agentperf05-bp01.md")
- [AGENTPERF01-BP03
