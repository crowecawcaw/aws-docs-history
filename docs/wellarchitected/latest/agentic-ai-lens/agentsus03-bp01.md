...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") with Policies and code
interceptors can invoke human-in-the-loop workflows based on
complexity thresholds, confidence scores, or stakes assessment.
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") enforces the decision boundaries so that
high-stakes cases escalate automatically rather than depending on
the agent to self-report low confidence.
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") runs agent outputs against
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") tracks escalation rates and
task distribution, showing whether experts are being kept in the
loop often enough to stay sharp.

### Implementation steps

1. **Define a competency
...
2. **Configure automated
   escalation:** Use
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") Policies and
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") to route high-stakes, ambiguous,
   or low-confidence decisions to human experts.
3. **Establish rotation
...
4. **Validate agent outputs against
   expert baselines:** Run
   [Amazon
   Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") against baselines
   produced by subject matter experts to detect drift in
   categories that have been trusted to automation.
5. **Monitor escalation and task
   distribution:** Track escalation rates and expert
   task distribution through
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to confirm that
...
- [AGENTSUS03-BP02 Build
  ...
  competencies](agentsus03-bp02.md "agentsus03-bp02.md")
- [AGENTSUS03-BP03 Maintain
  comprehensive specifications for agents and agentic
  systems](agentsus03-bp03.md "agentsus03-bp03.md")
- [MLPERF06-BP01
  Include human-in-the-loop monitoring](../machine-learning-lens/mlperf-06.md "../machine-learning-lens/mlperf-06.md")
...
- [Human-in-the-loop
  (HITL) - Amazon Nova Act](../../../nova/latest/userguide/nova-act-hitl.md "../../../nova/latest/userguide/nova-act-hitl.md")
- [Build
...
- [GitHub:
  awslabs/amazon-bedrock-agentcore-samples - Evaluations](https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/07-AgentCore-evaluations "https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/07-AgentCore-evaluations")
