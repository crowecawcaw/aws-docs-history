...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") hosts agents with built-in
...
reservations.
[Amazon
Bedrock cross-region inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") distributes requests across
...
[Amazon
Bedrock Capacity, Limits, and Cost Optimization](../../../bedrock/latest/userguide/capacity-limits-cost-optimization.md "../../../bedrock/latest/userguide/capacity-limits-cost-optimization.md") guide
...
each layer through
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") are the signals that drive
...
1. **Deploy agents on AgentCore Runtime
   ...
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") so compute allocation
   adjusts for each invocation without manual fleet sizing.
2. **Route tasks by complexity to
...
3. **Enable Amazon Bedrock cross-region
   inference:** Turn on
   [cross-region
   inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") to distribute requests and reduce the
   impact of regional capacity constraints.
4. **Monitor token throughput and latency
   through AgentCore Observability:** Watch per-tier
   throughput and latency through
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") and trigger tier
   adjustments when thresholds are exceeded.
5. **Use scheduled scaling ahead of
