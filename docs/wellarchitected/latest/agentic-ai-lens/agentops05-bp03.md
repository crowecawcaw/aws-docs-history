...
[Amazon CloudWatch Logs](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") Insights queries against named fields.
...
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") sensitive information filters detect and
...
trails. [AWS CloudTrail](https://aws.amazon.com/cloudtrail/ "https://aws.amazon.com/cloudtrail/") captures API-level agent actions as an
infrastructure complement, and
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") captures agent reasoning
...
3. **Redact PII before write:**
   Integrate
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") sensitive information filters into
   the logging pipeline.
4. **Use immutable storage for compliance
   logs:** Write audit trails to
   [Amazon S3](../../../AmazonS3/latest/userguide/Welcome.md "../../../AmazonS3/latest/userguide/Welcome.md") with Object Lock in Compliance mode.
5. **Create saved query
...
- [AGENTOPS04-BP02
  ...
  A2A)](agentops04-bp02.md "agentops04-bp02.md")
- [AGENTREL07-BP03
