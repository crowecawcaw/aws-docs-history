...
[AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md") provides a centralized catalog that captures
capabilities, availability, and metadata for agents and tools,
making intelligent routing possible instead of hardcoded.
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") then gives the workflow secure
...
1. Agent-to-agent escalation happens when a task needs
   capabilities outside the current agent's scope. This trigger
   is a routing decision.
2. Agent-to-human escalation happens when confidence drops below
...
2. **Define a structured context package
...
3. **Deploy an agent registry:**
   Catalog agent capabilities, availability status, and handoff
   acceptance criteria in
   [AWS Agent Registry](../../../bedrock-agentcore/latest/devguide/registry.md "../../../bedrock-agentcore/latest/devguide/registry.md") to enable runtime discovery and
   intelligent routing.
4. **Connect agents through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md"):** Configure
...
7. **Monitor collaboration
   health:** Track success rates, handoff latency, and
   context-transfer completeness in
   [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/"), with alerting on handoff failure rates.
...
- [Agentic
  AI frameworks, platforms, protocols, and tools on AWS](../../../prescriptive-guidance/latest/agentic-ai-frameworks/introduction.md "../../../prescriptive-guidance/latest/agentic-ai-frameworks/introduction.md")
...
- [AWS re:Invent 2024 - Anti-Money Laundering Multi-agent
  Orchestration with AWS Strands (DEV326)](https://www.youtube.com/watch?v=VtrfpAVFKdE "https://www.youtube.com/watch?v=VtrfpAVFKdE")

**Related examples:**

- [GitHub:
  Sample Multi-Agent SaaS Workshop](https://github.com/aws-samples/sample-saas-multi-agents-workshop "https://github.com/aws-samples/sample-saas-multi-agents-workshop")
- [GitHub:
...
- [GitHub:
  Sample Bedrock AgentCore Multi-Tenant](https://github.com/aws-samples/sample-bedrock-agentcore-multitenant "https://github.com/aws-samples/sample-bedrock-agentcore-multitenant")
