...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md"), the runtime's built-in session
...
1. **Use AgentCore Runtime session
...
2. **Design compact message payloads
...
3. **Implement dead letter queues for
...
4. **Add backpressure mechanisms that
...
5. **Configure long polling and batch
...
- [AGENTPERF04-BP03 Design
  performant event-driven integration patterns](agentperf04-bp03.md "agentperf04-bp03.md")
- [AGENTPERF05-BP01
