...
- Evaluate (run behavioral evaluation through
  [Amazon
  Bedrock Evaluations](../../../bedrock/latest/userguide/model-evaluation.md "../../../bedrock/latest/userguide/model-evaluation.md"))
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") for managed scaling, versioning,
and observability. agentcore deploy pushes new
versions, and endpoint-based weighted routing handles blue/green
and canary patterns.
[Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") alarms watch quality metrics post-deployment and
...
[AWS CDK](https://aws.amazon.com/cdk/ "https://aws.amazon.com/cdk/") or
[AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/") helps make every resource reproducible.
...
2. **Set behavioral evaluation as a
   gate:** Integrate
   [Amazon
   Bedrock Evaluations](../../../bedrock/latest/userguide/model-evaluation.md "../../../bedrock/latest/userguide/model-evaluation.md") with task completion accuracy and
   hallucination rate thresholds that block promotion when
   exceeded.
3. **Deploy to
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md"):** Use built-in
...
4. **Automate rollback on quality
   ...
   [Amazon CloudWatch](../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md "../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md") alarms to revert-deployment workflows so
   quality threshold violations trigger immediate revert.
5. **Version all deployment
...
- [CI/CD
  and automation for serverless AI](../../../prescriptive-guidance/latest/agentic-ai-serverless/cicd-and-automation.md "../../../prescriptive-guidance/latest/agentic-ai-serverless/cicd-and-automation.md")
- [Kiro
...
- [AWS 2025 - Deploy Production-Ready Agents in 22 Minutes with
  AgentCore Runtime](https://www.youtube.com/watch?v=Q-tYIAuv9WI "https://www.youtube.com/watch?v=Q-tYIAuv9WI")
- [AWS 2025 - Deploy ANY AI Agent to Production in Minutes -
  AgentCore Tutorial](https://www.youtube.com/watch?v=N7FGbBq1mI4 "https://www.youtube.com/watch?v=N7FGbBq1mI4")
...
- [AWS re:Invent 2024 - Building AI Agents with Serverless, Strands,
  and MCP (NTA405)](https://www.youtube.com/watch?v=LwubRSoJcIM "https://www.youtube.com/watch?v=LwubRSoJcIM")
- [AWS re:Invent 2024 - Develop AI Agents faster with SageMaker AI
  Studio & AgentCore (AIM388)](https://www.youtube.com/watch?v=UL_7a2GEu10 "https://www.youtube.com/watch?v=UL_7a2GEu10")
