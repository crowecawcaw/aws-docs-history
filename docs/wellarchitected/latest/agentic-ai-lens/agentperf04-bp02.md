...
communication.
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") exposes tools as MCP-compatible
...
[Amazon API Gateway](https://aws.amazon.com/api-gateway/ "https://aws.amazon.com/api-gateway/") keep a persistent channel open rather than
...
1. **Adopt MCP for agent-to-tool
   communications through AgentCore Gateway:** Expose
   tools as MCP-compatible endpoints through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") so agents discover and
   invoke tools through a consistent interface.
2. **Use A2A protocol through AgentCore
...
3. **Implement WebSocket connections
   ...
   [Amazon API Gateway](https://aws.amazon.com/api-gateway/ "https://aws.amazon.com/api-gateway/") for real-time streaming so the channel
   stays open rather than reestablishing on each turn.
4. **Enable connection pooling and
   ...
   few kilobytes.
5. **Budget for authentication overhead
...
- [AgentCore
  Deep Dive: Gateway](https://www.youtube.com/watch?v=atWXM5lziY8 "https://www.youtube.com/watch?v=atWXM5lziY8")
- [Building
  Scalable, Self-Orchestrating AI Workflows with A2A and MCP
  (DEV415)](https://www.youtube.com/watch?v=9O9zZ1lQWiI "https://www.youtube.com/watch?v=9O9zZ1lQWiI")
