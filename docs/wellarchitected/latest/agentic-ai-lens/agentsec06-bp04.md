...
[Amazon
Bedrock AgentCore Observability](https://aws.amazon.com/blogs/machine-learning/build-trustworthy-ai-agents-with-amazon-bedrock-agentcore-observability/ "https://aws.amazon.com/blogs/machine-learning/build-trustworthy-ai-agents-with-amazon-bedrock-agentcore-observability/") provides the foundation.
...
1. **Define and publish coordination
...
2. **Establish baselines and enable
   anomaly detection:** Collect metrics during normal
   operation and configure Amazon CloudWatch anomaly detection
   on key metrics.
3. **Build topology maps:** Use
   [Amazon
   Bedrock AgentCore Observability](https://aws.amazon.com/blogs/machine-learning/build-trustworthy-ai-agents-with-amazon-bedrock-agentcore-observability/ "https://aws.amazon.com/blogs/machine-learning/build-trustworthy-ai-agents-with-amazon-bedrock-agentcore-observability/") service maps and A2A
...
6. **Run Logs Insights queries on a
...
- [AGENTSEC06-BP03
  Establish trust boundaries between agents](agentsec06-bp03.md "agentsec06-bp03.md")
- [AGENTSEC07-BP04
