...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock/latest/userguide/agentcore-gateway.md "../../../bedrock/latest/userguide/agentcore-gateway.md") provides the consolidation point
...
[Policy
in Amazon Bedrock AgentCore](https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/ "https://aws.amazon.com/blogs/machine-learning/secure-ai-agents-with-policy-in-amazon-bedrock-agentcore/") Cedar policies with a
...
[MCP
Registry open standard](https://github.com/modelcontextprotocol/registry "https://github.com/modelcontextprotocol/registry") so the investment isn't tied to a
...
2. **Add approved tools as Gateway
   targets:** For agent-to-tool traffic, register
   approved tools as
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock/latest/userguide/agentcore-gateway.md "../../../bedrock/latest/userguide/agentcore-gateway.md") targets with defined tool
...
3. **Publish an MCP registry for
   development:** Create an MCP registry JSON file
   that follows the
   [MCP
   Registry open standard](https://github.com/modelcontextprotocol/registry "https://github.com/modelcontextprotocol/registry"), host it on an HTTPS endpoint,
   and configure it in your organization's admin settings with
   version pinning for each server entry.
4. **Define the security review
...
6. **Enforce default-deny through
   ...
   configuration.
7. **Apply heightened review to remote
...
- [AGENTSEC02-BP01
  Implement tool authorization](agentsec02-bp01.md "agentsec02-bp01.md")
...
- [Transform
  ...
  Gateway](https://aws.amazon.com/blogs/machine-learning/transform-your-mcp-architecture-unite-mcp-servers-through-agentcore-gateway/ "https://aws.amazon.com/blogs/machine-learning/transform-your-mcp-architecture-unite-mcp-servers-through-agentcore-gateway/")
- [Enterprise
  governance: control your MCP servers and models](https://kiro.dev/blog/enterprise-governance-mcp-and-models/ "https://kiro.dev/blog/enterprise-governance-mcp-and-models/")
- [MCP
  governance for Q Developer](../../../amazonq/latest/qdeveloper-ug/mcp-governance.md "../../../amazonq/latest/qdeveloper-ug/mcp-governance.md")
- [Accelerating
  AI innovation: Scale MCP servers for enterprise workloads with
  Amazon Bedrock](https://aws.amazon.com/blogs/machine-learning/accelerating-ai-innovation-scale-mcp-servers-for-enterprise-workloads-with-amazon-bedrock/ "https://aws.amazon.com/blogs/machine-learning/accelerating-ai-innovation-scale-mcp-servers-for-enterprise-workloads-with-amazon-bedrock/")
- [Secure
...
- [Parameter
  Store, a capability of AWS Systems Manager](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md "../../../systems-manager/latest/userguide/systems-manager-parameter-store.md")

**Related examples:**

- [Accelerating
  AI Innovation: Scaling Model Context Protocol Servers for
  Enterprise Workloads on AWS (GitHub)](https://github.com/aws-samples/sample-deploy-mcp-servers-at-scale-on-aws "https://github.com/aws-samples/sample-deploy-mcp-servers-at-scale-on-aws")
