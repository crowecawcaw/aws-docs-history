...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") expresses this partitioning
...
1. **Create the memory resource with
   customer-managed encryption:** Provision an
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") resource, specify
...
2. **Design a hierarchical namespace
...
3. **Configure memory strategies at the
   ...
   prompts are needed.
4. **Scope IAM roles to authorized
...
- [Amazon
  Bedrock AgentCore Memory documentation](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md")
- [Amazon
