...
predictability.
[Basic
reasoning agents](../../../prescriptive-guidance/latest/agentic-ai-patterns/basic-reasoning-agents.md "../../../prescriptive-guidance/latest/agentic-ai-patterns/basic-reasoning-agents.md") handle single-turn classification,
extraction, or summarization in one inference call and should not
be wrapped in iterative reasoning loops.
[ReAct-style
loops](../generative-ai-lens/agentic-ai.md "../generative-ai-lens/agentic-ai.md"), in which the agent interleaves reasoning, tool
...
Strands Agents](https://aws.amazon.com/blogs/machine-learning/customize-agent-workflows-with-advanced-orchestration-techniques-using-strands-agents/ "https://aws.amazon.com/blogs/machine-learning/customize-agent-workflows-with-advanced-orchestration-techniques-using-strands-agents/").
...
2. **Select a pipeline shape that matches
   each task class:** Map each class to a reasoning
   pattern documented in
   [Agentic
   AI patterns and workflows on AWS](../../../prescriptive-guidance/latest/agentic-ai-patterns/introduction.md "../../../prescriptive-guidance/latest/agentic-ai-patterns/introduction.md"), a
   [basic
   reasoning pattern](../../../prescriptive-guidance/latest/agentic-ai-patterns/basic-reasoning-agents.md "../../../prescriptive-guidance/latest/agentic-ai-patterns/basic-reasoning-agents.md") for single-step tasks, a
   [ReAct
   loop](../generative-ai-lens/agentic-ai.md "../generative-ai-lens/agentic-ai.md") for open-ended reasoning where tool use drives
   ...
   [Customize
   agent workflows with advanced orchestration techniques using
   Strands Agents](https://aws.amazon.com/blogs/machine-learning/customize-agent-workflows-with-advanced-orchestration-techniques-using-strands-agents/ "https://aws.amazon.com/blogs/machine-learning/customize-agent-workflows-with-advanced-orchestration-techniques-using-strands-agents/"). Avoid wrapping single-step tasks in
   iterative loops, which inflates cost and latency with no
   accuracy gain.
3. **Set per-task iteration caps sized to
...
4. **Define early-termination conditions
   ...
   of thought.
5. **Establish a retry budget bounded by
...
6. **Replace identical retries with
   ...
   retrieval expansion.
7. **Configure graceful degradation paths
   ...
   request.
8. **Emit reasoning iterations, retries,
...
9. **Review pipeline shape, caps, and
...
- [Agentic
  AI - Generative AI Lens (Well-Architected Framework)](../generative-ai-lens/agentic-ai.md "../generative-ai-lens/agentic-ai.md")
