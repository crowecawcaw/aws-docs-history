...
[AWS Security Agent](https://aws.amazon.com/security-agent/ "https://aws.amazon.com/security-agent/") provides on-demand penetration testing that
...
[OWASP
Top 10 for Agentic Applications (2026)](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/ "https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/") covers agent
...
the
[OWASP
Top 10 for LLM Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/ "https://owasp.org/www-project-top-10-for-large-language-model-applications/") covers model-level risks that
...
4. **Measure quality impact before and
   after:** Run
   [Amazon
   Bedrock AgentCore Evaluations](https://aws.amazon.com/blogs/aws/amazon-bedrock-agentcore-adds-quality-evaluations-and-policy-controls-for-deploying-trusted-ai-agents/ "https://aws.amazon.com/blogs/aws/amazon-bedrock-agentcore-adds-quality-evaluations-and-policy-controls-for-deploying-trusted-ai-agents/") before and after red
   team exercises to measure quality impact and refine
   evaluator configurations.
5. **Persist and map findings:**
...
- [AGENTSEC08-BP01
  ...
  defense](agentsec08-bp01.md "agentsec08-bp01.md")

**Related documents:**

- [OWASP
  Top 10 for Agentic Applications (2026)](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/ "https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/")
- [OWASP
  Top 10 for Large Language Model Applications](https://owasp.org/www-project-top-10-for-large-language-model-applications/ "https://owasp.org/www-project-top-10-for-large-language-model-applications/")
...
- [Responsible
  ...
  AI safety on AWS](https://aws.amazon.com/blogs/machine-learning/responsible-ai-in-action-how-data-reply-red-teaming-supports-generative-ai-safety-on-aws/ "https://aws.amazon.com/blogs/machine-learning/responsible-ai-in-action-how-data-reply-red-teaming-supports-generative-ai-safety-on-aws/")
- [Protect
  DeepSeek model deployments with Protect AI and Amazon
  Bedrock](https://aws.amazon.com/blogs/apn/protect-deepseek-model-deployments-with-protect-ai-and-amazon-bedrock/ "https://aws.amazon.com/blogs/apn/protect-deepseek-model-deployments-with-protect-ai-and-amazon-bedrock/")
- [Amazon
