...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") creates an immutable version on
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") provides the per-version
...
[Amazon ECR lifecycle policies](../../../AmazonECR/latest/userguide/LifecyclePolicies.md "../../../AmazonECR/latest/userguide/LifecyclePolicies.md") to delete untagged images and images
...
1. **Structure containers for layer
   sharing:** Build agent containers with common base
   layers and agent-specific layers so
   [Amazon ECR](https://aws.amazon.com/ecr/ "https://aws.amazon.com/ecr/") layer deduplication is effective.
2. **Use endpoint-based traffic
   routing:** Deploy agents to
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") and configure custom
   endpoints for production traffic with weighted routing for
   blue/green and canary deployments.
3. **Include cost in promotion
   criteria:** Monitor deployment quality using
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") metrics before
...
4. **Set version retention
   ...
   [Amazon ECR lifecycle policies](../../../AmazonECR/latest/userguide/LifecyclePolicies.md "../../../AmazonECR/latest/userguide/LifecyclePolicies.md") to delete unused images
   automatically.
5. **Monitor version inventory
...
- [Amazon ECR lifecycle policies](../../../AmazonECR/latest/userguide/LifecyclePolicies.md "../../../AmazonECR/latest/userguide/LifecyclePolicies.md")
- [Amazon
