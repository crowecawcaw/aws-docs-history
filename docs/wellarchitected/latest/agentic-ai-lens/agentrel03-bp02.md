...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") provides managed memory
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md"), the runtime's managed session
...
[AWS Step Functions](../../../step-functions/latest/dg/welcome.md "../../../step-functions/latest/dg/welcome.md") or framework-level orchestration such as
...
designed.
[AWS Fault Injection Service](../../../fis/latest/userguide/what-is.md "../../../fis/latest/userguide/what-is.md") simulates memory store failures in
...
1. **Use AgentCore Memory as the primary
   managed store:** Default to
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") for its built-in durability
   and availability.
2. **Implement fail-fast logic for memory
...
3. **Maintain in-process fallback caches
   ...
   complete.
4. **Implement read-through caching for
   long-term memory:** Serve cached copies of
   frequently accessed items during temporary unavailability.
5. **Test failover with AWS Fault
   Injection Service:** Use
   [AWS Fault Injection Service](../../../fis/latest/userguide/what-is.md "../../../fis/latest/userguide/what-is.md") to validate degraded-mode
