...
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") provides automated assessment
...
[AWS Fault Injection
Service](https://aws.amazon.com/fis/ "https://aws.amazon.com/fis/") complements agent evaluations by validating that
...
Use
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") to maintain and run
...
[Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") and configure alarms when resilience metrics
...
1. **Catalog known failure modes per
...
2. **Create tests for dependent-component
   failures:** Simulate tool unavailability, API
   timeouts, data-source errors, and model inference
   degradation using
   [Amazon
   Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") dataset evaluations and
   custom evaluators.
3. **Create tests for orchestration
...
4. **Create tests for business-process
...
5. **Integrate infrastructure fault
   injection where appropriate:** Use
   [AWS Fault Injection Service](../../../fis/latest/userguide/what-is.md "../../../fis/latest/userguide/what-is.md") for infrastructure-level
   failures (throttling, capacity exhaustion, network latency)
   that affect agent workflows.
6. **Gate deployments on failure-handling
   regression:** Make the evaluation suite a mandatory
   CI/CD stage that blocks promotion when resilience
   regressions appear.
7. **Maintain evaluation datasets as
   living regression suites:** Use
   [Amazon
   Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") to track pass rates,
...
- [AGENTOPS02-BP01
  ...
  reflect evolving business needs](agentops02-bp01.md "agentops02-bp01.md")
- [AGENTOPS04-BP03
...
- [AWS re:Invent 2024 - Best practices for generative AI
  observability (COP404)](https://www.youtube.com/watch?v=sRjm6HS6yYU "https://www.youtube.com/watch?v=sRjm6HS6yYU")
- [AWS re:Invent 2024 - Unlock the power of generative AI with AWS
  Serverless (SVS319)](https://www.youtube.com/watch?v=y0jImhzqR1U "https://www.youtube.com/watch?v=y0jImhzqR1U")

**Related examples:**

- [GitHub:
  Open Source Bedrock Agent Evaluation](https://github.com/aws-samples/open-source-bedrock-agent-evaluation "https://github.com/aws-samples/open-source-bedrock-agent-evaluation")
- [GitHub:
