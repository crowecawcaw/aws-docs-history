...
1. **Set up the ingest-classify-store
   ...
   submission time.
2. **Build the reviewer assignment
...
3. **Cap assignments per reviewer and
...
- [AGENTSEC07-BP03 Multiple
  reviewers for critical operations](agentsec07-bp03.md "agentsec07-bp03.md")
- [AGENTSEC07-BP04
  Behavioral anomaly detection and agent containment](agentsec07-bp04.md "agentsec07-bp04.md")

**Related documents:**

- [Amazon SQS documentation](../../../AWSSimpleQueueService/latest/SQSDeveloperGuide/welcome.md "../../../AWSSimpleQueueService/latest/SQSDeveloperGuide/welcome.md")
- [AWS Step Functions human approval](../../../step-functions/latest/dg/tutorial-human-approval.md "../../../step-functions/latest/dg/tutorial-human-approval.md")
- [Implement
