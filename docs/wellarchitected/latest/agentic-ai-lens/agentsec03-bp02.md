...
provider.
[Amazon
Bedrock AgentCore Identity](../../../bedrock/latest/userguide/agentcore-identity.md "../../../bedrock/latest/userguide/agentcore-identity.md") verifies the user token and
...
described in
[Empower
AI agents with user context using Amazon Cognito](https://aws.amazon.com/blogs/security/empower-ai-agents-with-user-context-using-amazon-cognito/ "https://aws.amazon.com/blogs/security/empower-ai-agents-with-user-context-using-amazon-cognito/") uses
...
[Amazon Verified Permissions](https://aws.amazon.com/verified-permissions/ "https://aws.amazon.com/verified-permissions/") using Cedar (a choice orthogonal to
...
[AgentCore
Gateway outbound auth reference](../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md "../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md") for details). User context
...
Configure
[CloudTrail
with advanced event selectors](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md "../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md") to capture agent API calls,
...
2. **Tag agent roles
   ...
   AgentName: <name> tags to every
   agent IAM role for filtering and monitoring.
3. **Move human operators to IAM Identity Center:** Configure AWS IAM Identity Center for all
   human operator access and migrate any operators still on
   account-specific IAM users.
4. **Enforce the agent-to-human boundary
...
5. **Register Workload Identities for
   on-behalf-of flows:** Register agent Workload
   Identities in
   [Amazon
   Bedrock AgentCore Identity](../../../bedrock/latest/userguide/agentcore-identity.md "../../../bedrock/latest/userguide/agentcore-identity.md") for agents that act on
...
6. **Enable CloudTrail with AgentCore
...
- [AWS CloudTrail best practices](../../../awscloudtrail/latest/userguide/best-practices-security.md "../../../awscloudtrail/latest/userguide/best-practices-security.md")
- [AWS IAM Identity Center](../../../singlesignon/latest/userguide/what-is.md "../../../singlesignon/latest/userguide/what-is.md")
- [Securing
  AI agents with Amazon Bedrock AgentCore Identity](https://aws.amazon.com/blogs/security/securing-ai-agents-with-amazon-bedrock-agentcore-identity/ "https://aws.amazon.com/blogs/security/securing-ai-agents-with-amazon-bedrock-agentcore-identity/")
- [Empower
  AI agents with user context using Amazon Cognito](https://aws.amazon.com/blogs/security/empower-ai-agents-with-user-context-using-amazon-cognito/ "https://aws.amazon.com/blogs/security/empower-ai-agents-with-user-context-using-amazon-cognito/")
- [Amazon
...
- [AgentCore
  Identity supported authentication patterns](../../../bedrock-agentcore/latest/devguide/common-use-cases.md "../../../bedrock-agentcore/latest/devguide/common-use-cases.md")
