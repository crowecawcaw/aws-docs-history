...
[Amazon
Bedrock AgentCore Identity](../../../bedrock/latest/userguide/agentcore-identity.md "../../../bedrock/latest/userguide/agentcore-identity.md") handles the OAuth side of that
...
1. **Deploy AgentCore
   Identity:** Deploy
   [Amazon
   Bedrock AgentCore Identity](../../../bedrock/latest/userguide/agentcore-identity.md "../../../bedrock/latest/userguide/agentcore-identity.md") for agent authentication,
...
3. **Issue agent certificates from AWS Private CA:** Set up AWS Private Certificate Authority for agent identity certificates, with automated
   renewal lifecycles configured.
4. **Enforce mutual TLS
...
5. **Store keys in Secrets Manager with
...
8. **Review certificate inventory
...
- [AGENTSEC06-BP01
  Encrypt and sign inter-agent messages](agentsec06-bp01.md "agentsec06-bp01.md")
...
- [AWS Private CA documentation](../../../privateca/latest/userguide/PcaWelcome.md "../../../privateca/latest/userguide/PcaWelcome.md")
