...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") exposes patterns as MCP tools
...
[Amazon
Bedrock AgentCore Identity](../../../bedrock-agentcore/latest/devguide/identity.md "../../../bedrock-agentcore/latest/devguide/identity.md") and Gateway policies so pattern
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime.md "../../../bedrock-agentcore/latest/devguide/runtime.md") so each pattern has the same
operational baseline.

[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") exposes invocation
...
1. **Identify and extract recurring
...
2. **Deploy patterns as reusable
   components:** Implement each pattern on
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime.md "../../../bedrock-agentcore/latest/devguide/runtime.md") and publish it through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") as an MCP tool so
   orchestrating agents can discover and invoke it at runtime.
3. **Maintain a design-time
...
4. **Govern pattern access and
   versions:** Apply
   [Amazon
   Bedrock AgentCore Identity](../../../bedrock-agentcore/latest/devguide/identity.md "../../../bedrock-agentcore/latest/devguide/identity.md") and Gateway policies to
   control who can invoke each pattern, and publish new
   versions alongside old ones so consumers migrate
   deliberately.
5. **Monitor usage and feed improvements
...
- [OPS11-BP03
  Iterate to improve](../operational-excellence-pillar/ops_evolve_ops_iterate_to_improve.md "../operational-excellence-pillar/ops_evolve_ops_iterate_to_improve.md")
...
- [AWS Step Functions - State machine templates](../../../step-functions/latest/dg/concepts-templates.md "../../../step-functions/latest/dg/concepts-templates.md")
- [Strands
  Agents](https://strandsagents.com/ "https://strandsagents.com/")
- [Guidance
  for Multi-Agent Orchestration on AWS](https://aws.amazon.com/solutions/guidance/multi-agent-orchestration-on-aws/ "https://aws.amazon.com/solutions/guidance/multi-agent-orchestration-on-aws/")

**Related videos:**

- [AWS 2025 - Building AI Agents with Serverless, Strands, and MCP
  (NTA405)](https://www.youtube.com/watch?v=LwubRSoJcIM "https://www.youtube.com/watch?v=LwubRSoJcIM")

**Related examples:**

- [GitHub:
  aws-samples/aws-stepfunctions-examples](https://github.com/aws-samples/aws-stepfunctions-examples "https://github.com/aws-samples/aws-stepfunctions-examples")
