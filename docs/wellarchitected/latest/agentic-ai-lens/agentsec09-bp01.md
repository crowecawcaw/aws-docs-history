...
[AWS Security Agent](https://aws.amazon.com/security-agent/ "https://aws.amazon.com/security-agent/") provides this lifecycle coverage as a single
...
1. **Codify security requirements
   ...
   [AWS Security Agent](https://aws.amazon.com/security-agent/ "https://aws.amazon.com/security-agent/") for automated enforcement across
   development teams.
2. **Run design-phase reviews:**
   Configure AWS Security Agent to analyze architecture
   documents and technical specifications before development
   begins.
3. **Enable PR-level code
...
- [Claude
  ...
  available to defenders](https://www.anthropic.com/news/claude-code-security "https://www.anthropic.com/news/claude-code-security")
- [OWASP
