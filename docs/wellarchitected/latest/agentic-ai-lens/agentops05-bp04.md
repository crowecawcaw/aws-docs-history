...
- Quality KPIs, like decision accuracy, hallucination rate, and
  ...
  [Amazon
  Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") scores for correctness,
...
[Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") Anomaly Detection so baselines adjust
...
[Amazon Quick
Suite](https://aws.amazon.com/quicksuite/ "https://aws.amazon.com/quicksuite/") share the same dashboard with technical and business
...
1. **Define a four-dimensional KPI
...
2. **Collect KPIs through
   [Amazon CloudWatch](../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md "../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md") custom metrics:** Add dimensions
   for agent, workflow, and environment so the same metric can
   be sliced multiple ways.
3. **Establish baselines and configure
   anomaly detection:** Use
   [Amazon CloudWatch](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md") Anomaly Detection with warning and
   critical alerting thresholds.
4. **Build weekly KPI
   dashboards:** Use
   [Amazon Quick](../../../quicksuite/latest/user/welcome.md "../../../quicksuite/latest/user/welcome.md") reports shared with technical and
   business stakeholders.
5. **Review KPI alignment
...
- [AGENTOPS05-BP05 Create
  workflow-specific dashboards for operational health](agentops05-bp05.md "agentops05-bp05.md")
- [AGENTOPS02-BP04
  Maintain feedback control loops for continuous
  improvement](agentops02-bp04.md "agentops02-bp04.md")
