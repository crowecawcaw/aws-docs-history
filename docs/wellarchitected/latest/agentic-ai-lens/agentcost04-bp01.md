...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md"), or from prior tool results within
...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") provides MCP-based tool discovery
...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") applies Cedar policies that halt
retries when failure rates indicate persistent degradation and cap
tool calls per reasoning cycle.
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") exposes tool selection
patterns, Amazon CloudWatch tracks invocation frequency and
deduplication hit rates, and
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") scores tool selection
accuracy so patterns of over-invocation appear as quality data,
not just cost data.

### Implementation steps

1. **Embed tool necessity evaluation in
   system prompts:** Direct the model to check context
   and
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") before invoking tools, and
   include a cost-ranked selection rubric that places cheaper
   alternatives first.
2. **Redesign tool interfaces for
   batching:** Expose tools through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") with batch inputs and
   complete result sets so one call carries the payload that
   previously required several.
3. **Cache tool results within
   ...
   next call.
4. **Apply automatic cutoffs through
   policy:** Configure
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies that cap tool
   calls per reasoning cycle and halt retries on persistent
   failures.
5. **Monitor tool selection
   patterns:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to surface tool
   selection patterns and create Amazon CloudWatch metrics for
   tool invocation frequency and deduplication hit rates.
6. **Score tool selection
   accuracy:** Use
   [Amazon
   Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") to periodically score
...
- [AGENTCOST04-BP02 Cost
  ...
  sharing](agentcost04-bp02.md "agentcost04-bp02.md")
- [AGENTCOST04-BP03
...
- [AWS re:Invent 2024 - Scale agent tools with AgentCore Gateway
  (AIM3313)](https://www.youtube.com/watch?v=DlIHB8i6uyE "https://www.youtube.com/watch?v=DlIHB8i6uyE")
- [Integrating
  MCP Tools with Strands Agents](https://www.youtube.com/watch?v=bHSbjCZZFjE "https://www.youtube.com/watch?v=bHSbjCZZFjE")
...
- [Strands
  Agents MCP Tools](https://strandsagents.com/docs/user-guide/concepts/tools/mcp-tools/ "https://strandsagents.com/docs/user-guide/concepts/tools/mcp-tools/")
