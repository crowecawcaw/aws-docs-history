...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") and catches duplicate calls
...
[Amazon OpenSearch Service Serverless](https://aws.amazon.com/opensearch-service/features/serverless/ "https://aws.amazon.com/opensearch-service/features/serverless/") for semantic caching: generate
...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies enforce automatic
...
exposed through
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") and Amazon CloudWatch: hit
...
1. **Deploy two-layer caching:**
   Implement a session-scoped in-process cache on
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") and an
   [Amazon OpenSearch Service Serverless](https://aws.amazon.com/opensearch-service/features/serverless/ "https://aws.amazon.com/opensearch-service/features/serverless/") semantic cache for
...
3. **Validate tool inputs:**
   ...
   correct.
4. **Enforce cutoffs and fallback
   tools:** Configure
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies for automatic
   cutoffs, wire automatic fallback to alternative tools when
   cutoffs activate, and set retry budgets per reasoning
   session.
5. **Monitor cache and retry
