...
Start with what
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") provides before building custom.
...
1. **Evaluate
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") as the primary
...
- [AGENTSEC02-BP03
  ...
  assessments](agentsec02-bp03.md "agentsec02-bp03.md")
...
- [AWS re:Invent 2024 - Build agentic workflows with third-party
  agents and tools (AIM3311)](https://www.youtube.com/watch?v=kfgt1uJE-E4 "https://www.youtube.com/watch?v=kfgt1uJE-E4")
- [AWS re:Invent 2024 - Modernize containers for AI agents using
  AgentCore Gateway (CNS422)](https://www.youtube.com/watch?v=6autfsn1fy8 "https://www.youtube.com/watch?v=6autfsn1fy8")
