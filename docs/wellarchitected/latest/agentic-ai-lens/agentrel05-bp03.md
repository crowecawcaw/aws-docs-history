...
[Amazon
Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") handles the mechanics of RAG,
...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md"), and treat the authoritative
...
1. **Configure Amazon Bedrock Knowledge
   Bases with automated synchronization:** Set up
   [Amazon
   Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") with domain-appropriate data
   sources and sync pipelines triggered by source changes.
2. **Implement knowledge freshness
...
4. **Implement real-time data retrieval
   ...
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") tool functions for
   information that requires current accuracy.
5. **Handle retrieval failures
...
- [AGENTREL03-BP01
  ...
  short-term and long-term memories](agentrel03-bp01.md "agentrel03-bp01.md")
...
- [AWS re:Invent 2024 - Advanced agentic RAG Systems: Deep dive with
  Bedrock (AIM425)](https://www.youtube.com/watch?v=bu2cD1pCFTs "https://www.youtube.com/watch?v=bu2cD1pCFTs")

**Related examples:**

- [GitHub:
  awslabs/amazon-bedrock-agent-samples - Knowledge Base
  integration](https://github.com/awslabs/amazon-bedrock-agent-samples/tree/main/examples/agents/agent_with_knowledge_base_integration "https://github.com/awslabs/amazon-bedrock-agent-samples/tree/main/examples/agents/agent_with_knowledge_base_integration")
