...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock/latest/userguide/agentcore-gateway.md "../../../bedrock/latest/userguide/agentcore-gateway.md") operates under a single execution
role per gateway, with outbound authentication that depends on
target type (see the
[AgentCore
Gateway outbound auth reference](../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md "../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md")). Scope the gateway
...
1. **Generate least-privilege policies
...
2. **Apply permission
   ...
   are modified.
3. **Scope the Gateway execution
   role:** Restrict the
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock/latest/userguide/agentcore-gateway.md "../../../bedrock/latest/userguide/agentcore-gateway.md") execution role to only the
...
4. **Issue temporary credentials with
...
7. **Implement just-in-time access for
...
- [AGENTSEC03-BP04 Regular
  permission audits and access reviews](agentsec03-bp04.md "agentsec03-bp04.md")
- [AGENTREL02-BP02
  Limit agent permissions to minimum required access](agentrel02-bp02.md "agentrel02-bp02.md")

**Related documents:**

- [AWS IAM best practices](../../../IAM/latest/UserGuide/best-practices.md "../../../IAM/latest/UserGuide/best-practices.md")
