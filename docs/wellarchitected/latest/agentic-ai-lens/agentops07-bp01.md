...
seconds). Emit
[Amazon CloudWatch](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/") metrics on state transitions so cutoff health
...
[AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/") or equivalent durable workflow orchestration
...
[AGENTREL07-BP02
Enable automatic recovery from agent execution failures](../../reliability-pillar/agentrel07/agentrel07-bp02.xml.md "../../reliability-pillar/agentrel07/agentrel07-bp02.xml.md").

### Implementation steps

1. **Implement automatic cutoffs for
   every external dependency:** Define thresholds for
   error rate, timeout count, and recovery probing per
   dependency.
2. **Design fallback chains per agent
   capability:** Specify alternative tools, models,
   and degraded-mode operations, and notify users when quality
   is degraded.
3. **Build durable recovery
   workflows:** Use
   [AWS Step Functions](../../../step-functions/latest/dg/welcome.md "../../../step-functions/latest/dg/welcome.md") or equivalent with error handling,
...
6. **Run quarterly chaos engineering
...
- [AGENTOPS07-BP03 Augment
  ...
  business requirements](agentops07-bp03.xml.md "agentops07-bp03.xml.md")
- [AGENTOPS04-BP03
  Develop fallback behavior and error handling for tool
  invocations](../agentops04/agentops04-bp03.xml.md "../agentops04/agentops04-bp03.xml.md")
- [AGENTOPS05-BP02
  Monitor agent behavior patterns and detect anomalies](../agentops05/agentops05-bp02.xml.md "../agentops05/agentops05-bp02.xml.md")
- [AGENTREL07-BP02
  Enable automatic recovery from agent execution failures](../../reliability-pillar/agentrel07/agentrel07-bp02.xml.md "../../reliability-pillar/agentrel07/agentrel07-bp02.xml.md")
...
- [Agentic
  AI in the Well-Architected Generative AI Lens](../generative-ai-lens/agentic-ai.md "../generative-ai-lens/agentic-ai.md")
- [From
...
- [Introducing
  ...
  agents at any scale](https://aws.amazon.com/blogs/aws/introducing-amazon-bedrock-agentcore-securely-deploy-and-operate-ai-agents-at-any-scale/ "https://aws.amazon.com/blogs/aws/introducing-amazon-bedrock-agentcore-securely-deploy-and-operate-ai-agents-at-any-scale/")
