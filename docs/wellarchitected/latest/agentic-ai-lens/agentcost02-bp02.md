...
with
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to measure token
...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") uses MCP-based Semantic Tool
Selection to present only the tools relevant to the current
intent, and
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") manages conversation state across
...
1. **Audit and compress system
   prompts:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to measure token
   footprints for every prompt, then apply compression to
   minimize prompt size while maintaining decision accuracy.
2. **Present tools dynamically through
   Gateway:** Use
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") Semantic Tool Selection to
...
4. **Use managed memory for multi-turn
   context:** Configure
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") so conversation state is
   maintained automatically instead of re-transmitted as full
   history.
5. **Reduce few-shot example
