...
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") is the primary integration layer
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") supports A2A protocol endpoints
...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") applies Cedar policies that scope
...
[AgentCore
Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md"), which produces compliance records without
...
latency through
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"), and configure alarms so
...
1. **Expose tools through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md"):** Publish MCP
   server capabilities with
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") enforcing per-agent access
   controls.
2. **Implement A2A protocol
   endpoints:** Use
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") for standardized
   inter-agent communication.
3. **Define protocol versioning
   strategies:** Use capability negotiation so older
   and newer sides interoperate at the common supported
   version.
4. **Implement standardized error
   handling:** Apply the
   transient/permanent/authorization taxonomy and fallback
   chains for critical tools across every agent.
5. **Monitor per-tool health through
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"):** Track
...
- [Open
  ...
  Communication on MCP](https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-1-inter-agent-communication-on-mcp "https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-1-inter-agent-communication-on-mcp")
- [Open
  Protocols for Agent Interoperability Part 4: Inter-Agent
  Communication on A2A](https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-4-inter-agent-communication-on-a2a/ "https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-4-inter-agent-communication-on-a2a/")
- [Introducing
...
- [Open
  ...
  MCP](https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-2-authentication-on-mcp/ "https://aws.amazon.com/blogs/opensource/open-protocols-for-agent-interoperability-part-2-authentication-on-mcp/")
- [Agentic
  AI frameworks: Protocol-based tools](../../../prescriptive-guidance/latest/agentic-ai-frameworks/protocol-based-tools-detailed.md "../../../prescriptive-guidance/latest/agentic-ai-frameworks/protocol-based-tools-detailed.md")

**Related videos:**

- [AWS re:Invent 2024 - Building Scalable, Self-Orchestrating AI
  Workflows with A2A and MCP (DEV415)](https://www.youtube.com/watch?v=9O9zZ1lQWiI "https://www.youtube.com/watch?v=9O9zZ1lQWiI")
- [AWS 2025 - AgentCore Deep Dive: Gateway](https://www.youtube.com/watch?v=atWXM5lziY8 "https://www.youtube.com/watch?v=atWXM5lziY8")
- [AWS 2025 - Integrating MCP Tools with Strands Agents](https://www.youtube.com/watch?v=bHSbjCZZFjE "https://www.youtube.com/watch?v=bHSbjCZZFjE")
