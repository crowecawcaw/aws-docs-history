...
[AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/") with stage-specific
[AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") functions,
[Amazon ECS](https://aws.amazon.com/ecs/ "https://aws.amazon.com/ecs/")
tasks, or agents hosted on
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md"), where each stage's compute
...
[Amazon Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams/ "https://aws.amazon.com/kinesis/data-streams/") acts as an inter-stage buffer that
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") or
...
1. **Map the multi-stage pipeline and
...
2. **Implement each stage as an
   independent compute unit with stage-specific resource
   configurations:** Use
   [AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") for lightweight processing,
   [Amazon ECS](https://aws.amazon.com/ecs/ "https://aws.amazon.com/ecs/") for compute-intensive stages, and AgentCore
   Runtime for stages that require LLM reasoning, and tune each
   stage's resources to its own profile.
3. **Enable streaming between stages
   ...
   generated, and
   [Amazon Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams/ "https://aws.amazon.com/kinesis/data-streams/") as an inter-stage buffer so
   downstream stages begin processing as upstream results
   arrive.
4. **Implement micro-batching for batch
...
5. **Configure AgentCore Observability or
   X-Ray tracing across all pipeline stages for end-to-end
   latency visibility:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") or
   [AWS X-Ray](https://aws.amazon.com/xray/ "https://aws.amazon.com/xray/") to trace requests across every stage.
6. **Monitor per-stage latency,
...
- [Multi-stage
  ...
  agentic AI](../../../prescriptive-guidance/latest/agentic-ai-serverless/pattern-multi-stage-ai.md "../../../prescriptive-guidance/latest/agentic-ai-serverless/pattern-multi-stage-ai.md")
- [Blog:
...
- [GitHub:
  Build GenAI agent workflows with Step Functions](https://github.com/aws-samples/build-genai-agent-workflows-with-step-functions "https://github.com/aws-samples/build-genai-agent-workflows-with-step-functions")
