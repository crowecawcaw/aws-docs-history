...
[AWS CloudTrail Lake](../../../awscloudtrail/latest/userguide/cloudtrail-lake.md "../../../awscloudtrail/latest/userguide/cloudtrail-lake.md") provides queryable long-term retention for
...
5. **Run a formal access review on a
...
6. **Aggregate findings in Security Hub CSPM:** Pull IAM findings from Access Analyzer, AWS Config, and Amazon GuardDuty into AWS Security Hub CSPM for a
...
- [AGENTSEC03-BP02 Separate
  agent and human user permission](agentsec03-bp02.md "agentsec03-bp02.md")
- [AGENTSEC05-BP01
...
- [AWS IAM Access Analyzer documentation](../../../IAM/latest/UserGuide/what-is-access-analyzer.md "../../../IAM/latest/UserGuide/what-is-access-analyzer.md")
- [AWS Config managed rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md "../../../config/latest/developerguide/managed-rules-by-aws-config.md")

**Related services:**

- [AWS IAM Access Analyzer](https://aws.amazon.com/iam/features/analyze-access/ "https://aws.amazon.com/iam/features/analyze-access/")
