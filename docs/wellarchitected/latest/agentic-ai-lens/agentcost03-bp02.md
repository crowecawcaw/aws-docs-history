...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") separates short-term and long-term
...
from
[Amazon
Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md"), chunk sizes of 256 to 512 tokens
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") exposes token usage metrics
...
1. **Adopt managed rolling
   summarization:** Integrate
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") for managed compression, or
   implement custom rolling summarization that compresses the
   oldest N turns after every N turns.
2. **Configure relevance-scored
...
3. **Prune context before each
   ...
   decision needs.
4. **Tune RAG chunk size:**
   Optimize
   [Amazon
   Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") chunk sizes to 256 to 512
...
6. **Correlate utilization with task
...
- [AGENTCOST03-BP01 Design
  cost-effective retrieval systems with tiered memory](agentcost03-bp01.md "agentcost03-bp01.md")
- [AGENTCOST03-BP03
