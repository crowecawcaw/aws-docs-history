...
record the result.
[Amazon DynamoDB](../../../amazondynamodb/latest/developerguide/Introduction.md "../../../amazondynamodb/latest/developerguide/Introduction.md") with conditional writes makes this safe under
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"), tracking cache hit rates.
Retries that return cached results are the signal the mechanism is
working as intended.

### Implementation steps

1. **Design deterministic idempotency
   keys:** Derive keys from operation inputs through
   consistent hashing so retries generate the same key as the
   original attempt.
2. **Implement idempotency checking as a
   pre-execution step:** Use
   [Amazon DynamoDB](../../../amazondynamodb/latest/developerguide/Introduction.md "../../../amazondynamodb/latest/developerguide/Introduction.md") with conditional writes and TTL-based
   expiration to store idempotency records safely.
3. **Propagate idempotency keys through
...
4. **Pass keys to external systems with
...
5. **Monitor cache hit rates:**
   Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to watch for retries
...
- [AGENTREL06-BP01 Develop
  ...
  systems](agentrel06-bp01.md "agentrel06-bp01.md")
- [AGENTREL06-BP03
  Regularly test degraded system performance](agentrel06-bp03.md "agentrel06-bp03.md")
- [AGENTREL06-BP05
  Implement dynamic capability toggling](agentrel06-bp05.md "agentrel06-bp05.md")
