...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime.md "../../../bedrock-agentcore/latest/devguide/runtime.md") right-sizes compute per
...
[VPC
interface endpoints for Amazon Bedrock AgentCore (AWS PrivateLink)](../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md "../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md") establishes private paths that reduce latency
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") exposes the utilization
data that keeps provisioning tied to actual workload demand.

### Implementation steps

1. **Run agent processes on serverless
   runtime:** Deploy to
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime.md "../../../bedrock-agentcore/latest/devguide/runtime.md") for automatic scaling and
   session isolation, so execution capacity scales with demand
   rather than peak estimates.
2. **Apply private connectivity where
   justified:** Configure
   [VPC
   interface endpoints for Amazon Bedrock AgentCore (AWS PrivateLink)](../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md "../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md") for workloads with security or latency
   requirements that warrant it. Default to public endpoints
   otherwise.
3. **Deploy in the same Region as
   ...
   [Amazon
   Bedrock cross-region inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") for availability.
4. **Enable streaming for user-facing
...
5. **Validate utilization
   continually:** Track infrastructure utilization
   through
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") and adjust
...
- [AGENTSUS02-BP04 Measure
  ...
  workloads](agentsus02-bp04.md "agentsus02-bp04.md")
- [SUS02-BP01
...
- [VPC
  interface endpoints for Amazon Bedrock AgentCore (AWS PrivateLink)](../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md "../../../bedrock-agentcore/latest/devguide/vpc-interface-endpoints.md")
- [Amazon
