...
[Amazon CloudWatch Logs data protection policies](../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md "../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md") automatically
detect and mask sensitive types (credentials, personal
identifiers, financial data) in log events.
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") sensitive information filters anonymize
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability-telemetry.md "../../../bedrock-agentcore/latest/devguide/observability-telemetry.md") captures agent reasoning
...
[Amazon
Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") complements logging by
...
2. **Mask sensitive data before it lands
   ...
   its own.
3. **Create a dedicated, append-only
   artifact bucket in a Log Archive account:** Create
   an Amazon S3 bucket in a separate Log Archive account,
   aligned with the
   [AWS Security Reference Architecture](../../../prescriptive-guidance/latest/security-reference-architecture/welcome.md "../../../prescriptive-guidance/latest/security-reference-architecture/welcome.md"), with versioning
   enabled and cross-account access controls that allow agent
   write access but deny delete and overwrite operations.
4. **Choose a retention-protection
...
5. **Capture full traces through
   AgentCore Observability:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability-telemetry.md "../../../bedrock-agentcore/latest/devguide/observability-telemetry.md") to capture full agent
   ...
   point.
6. **Record initiator attributes on every
...
7. **Apply a consistent artifact key
   schema:** Use
   `agentId`, `sessionId`, `timestamp`, and `decisionType`
   as the key schema for efficient retrieval during
   investigations.
8. **Deploy AgentCore Evaluations with
   drift alarms:** Deploy
   [Amazon
   Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") with built-in and
   custom evaluators, publish results to Amazon CloudWatch, and
   configure alarms on evaluation scores to detect behavioral
   drift.
9. **Enable CloudTrail log file
...
10. **Make artifacts queryable with Athena
    ...
    security scenarios.
11. **Implement tiered retention with
    ...
    tagging.
12. **Encrypt all log and artifact
...
- [AGENTSEC03-BP02
  Separate agent and human user permission](agentsec03-bp02.md "agentsec03-bp02.md")
- [AGENTSEC04-BP02
  Human-in-the-loop for critical decisions](agentsec04-bp02.md "agentsec04-bp02.md")
- [AGENTSEC05-BP02
  Implement distributed tracing for agent interactions](agentsec05-bp02.md "agentsec05-bp02.md")
- [AGENTREL07-BP03
...
- [AWS CloudTrail log file validation](../../../awscloudtrail/latest/userguide/cloudtrail-log-file-validation-intro.md "../../../awscloudtrail/latest/userguide/cloudtrail-log-file-validation-intro.md")
- [Amazon S3 Object Lock](../../../AmazonS3/latest/userguide/object-lock.md "../../../AmazonS3/latest/userguide/object-lock.md")
- [Amazon CloudWatch Logs data protection](../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md "../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md")
- [Amazon Athena documentation](../../../athena/latest/ug/what-is.md "../../../athena/latest/ug/what-is.md")
- [Querying
  AWS service logs with Amazon Athena](../../../athena/latest/ug/querying-aws-service-logs.md "../../../athena/latest/ug/querying-aws-service-logs.md")
- [Create
  a customizable cross-company log lake for compliance (AWS Big
  Data Blog)](https://aws.amazon.com/blogs/big-data/create-a-customizable-cross-company-log-lake-part-ii-build-and-add-amazon-bedrock/ "https://aws.amazon.com/blogs/big-data/create-a-customizable-cross-company-log-lake-part-ii-build-and-add-amazon-bedrock/")
- [AWS Well-Architected Security Pillar SEC04-BP01: Configure service
  and application logging](../framework/sec_detect_investigate_events_app_service_logging.md "../framework/sec_detect_investigate_events_app_service_logging.md")
- [Considerations
...
- [Security
  reference architecture for generative AI](../../../prescriptive-guidance/latest/security-reference-architecture-generative-ai/gen-ai-sra.md "../../../prescriptive-guidance/latest/security-reference-architecture-generative-ai/gen-ai-sra.md")
