...
the
[AWS Agentic AI Security Scoping Matrix](https://aws.amazon.com/ai/security/agentic-ai-scoping-matrix/ "https://aws.amazon.com/ai/security/agentic-ai-scoping-matrix/") and
[this
guide to building AI agents in GxP environments](https://aws.amazon.com/blogs/machine-learning/a-guide-to-building-ai-agents-in-gxp-environments/ "https://aws.amazon.com/blogs/machine-learning/a-guide-to-building-ai-agents-in-gxp-environments/").
...
[AWS Step Functions](../../../step-functions/latest/dg/connect-to-resource.md "../../../step-functions/latest/dg/connect-to-resource.md") .waitForTaskToken
...
[human
approval in Step Functions tutorial](../../../step-functions/latest/dg/tutorial-human-approval.md "../../../step-functions/latest/dg/tutorial-human-approval.md") for a worked example.

For agents built on
[Amazon
Bedrock Agents](../../../bedrock/latest/userguide/agents.md "../../../bedrock/latest/userguide/agents.md"), two built-in patterns handle
human-in-the-loop confirmation without external workflow
orchestration.
[User
confirmation](../../../bedrock/latest/userguide/agents-userconfirmation.md "../../../bedrock/latest/userguide/agents-userconfirmation.md") pauses the agent before executing a specific
...
[Return
of control (ROC)](../../../bedrock/latest/userguide/agents-returncontrol.md "../../../bedrock/latest/userguide/agents-returncontrol.md") goes further by returning the function
...
[Amazon
Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime-long-run.md "../../../bedrock-agentcore/latest/devguide/runtime-long-run.md") supports both synchronous and
...
operation). See
[Step
Functions error handling](../../../step-functions/latest/dg/concepts-error-handling.md "../../../step-functions/latest/dg/concepts-error-handling.md") for the attribute details. For
...
[Step
Functions logging](../../../step-functions/latest/dg/monitoring-logging.md "../../../step-functions/latest/dg/monitoring-logging.md")). Augment this with application-level
...
2. **Match approval mechanism to
   execution environment:** Use
   [AWS Step Functions](../../../step-functions/latest/dg/connect-to-resource.md "../../../step-functions/latest/dg/connect-to-resource.md") callbacks for step-function-driven
   agents,
   [Amazon
   Bedrock Agents](../../../bedrock/latest/userguide/agents.md "../../../bedrock/latest/userguide/agents.md") user confirmation or return-of-control
   for agents on Amazon Bedrock Agents, and
   [Amazon
   Bedrock AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/runtime-long-run.md "../../../bedrock-agentcore/latest/devguide/runtime-long-run.md") async tasks for agents that
   need long-running approval processing, and implement the
   corresponding pattern for each tier that requires human
   approval.
3. **Bound any persistent trust
...
5. **Configure timeouts with safe
...
- [AGENTSEC07-BP03
  Multiple reviewers for critical operations](agentsec07-bp03.md "agentsec07-bp03.md")

**Related documents:**

- [AWS Step Functions callback patterns](../../../step-functions/latest/dg/connect-to-resource.md "../../../step-functions/latest/dg/connect-to-resource.md")
- [Human
  approval in Step Functions](../../../step-functions/latest/dg/tutorial-human-approval.md "../../../step-functions/latest/dg/tutorial-human-approval.md")
- [Step
  Functions error handling](../../../step-functions/latest/dg/concepts-error-handling.md "../../../step-functions/latest/dg/concepts-error-handling.md")
- [Step
  Functions logging](../../../step-functions/latest/dg/monitoring-logging.md "../../../step-functions/latest/dg/monitoring-logging.md")
- [Implement
  human-in-the-loop confirmation with Amazon Bedrock
  Agents](https://aws.amazon.com/blogs/machine-learning/implement-human-in-the-loop-confirmation-with-amazon-bedrock-agents/ "https://aws.amazon.com/blogs/machine-learning/implement-human-in-the-loop-confirmation-with-amazon-bedrock-agents/")
- [Amazon
  Bedrock Agents user confirmation](../../../bedrock/latest/userguide/agents-userconfirmation.md "../../../bedrock/latest/userguide/agents-userconfirmation.md")
- [Amazon
  Bedrock Agents return of control](../../../bedrock/latest/userguide/agents-returncontrol.md "../../../bedrock/latest/userguide/agents-returncontrol.md")
- [Amazon
  Bedrock AgentCore Runtime asynchronous processing](../../../bedrock-agentcore/latest/devguide/runtime-long-run.md "../../../bedrock-agentcore/latest/devguide/runtime-long-run.md")
- [AWS Agentic AI Security Scoping Matrix](https://aws.amazon.com/ai/security/agentic-ai-scoping-matrix/ "https://aws.amazon.com/ai/security/agentic-ai-scoping-matrix/")
- [A
  guide to building AI agents in GxP environments](https://aws.amazon.com/blogs/machine-learning/a-guide-to-building-ai-agents-in-gxp-environments/ "https://aws.amazon.com/blogs/machine-learning/a-guide-to-building-ai-agents-in-gxp-environments/")
