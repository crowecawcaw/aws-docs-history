...
files.
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") registers adapters as
...
[blog
on uniting MCP servers through AgentCore Gateway](https://aws.amazon.com/blogs/machine-learning/transform-your-mcp-architecture-unite-mcp-servers-through-agentcore-gateway/ "https://aws.amazon.com/blogs/machine-learning/transform-your-mcp-architecture-unite-mcp-servers-through-agentcore-gateway/") covers the
...
Combine this with
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies that restrict which
agents can invoke legacy adapters. Monitor adapter health through
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to detect legacy
integration reliability issues before they become incidents.

### Implementation steps

1. **Implement integration adapters
   exposing MCP tool interfaces:** Translate to legacy
   protocols internally so agents see a uniform tool-call
   interface.
2. **Register adapters in AgentCore
   Gateway:** Expose adapters through
   [Amazon
   Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") with authentication and
   discovery for agent invocation.
3. **Implement canonical error
   mapping:** Translate legacy error codes into a
   consistent taxonomy agents can handle uniformly.
4. **Enforce access control and rate
   limiting:** Use
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") for access control and
   implement application-level rate limiting in the adapter to
   protect legacy systems.
5. **Monitor adapter health through
...
- [AGENTREL06-BP02
  ...
  degradation](agentrel06-bp02.md "agentrel06-bp02.md")
- [AGENTREL06-BP03
  Regularly test degraded system performance](agentrel06-bp03.md "agentrel06-bp03.md")
- [AGENTREL06-BP04
  Implement idempotent task execution patterns](agentrel06-bp04.md "agentrel06-bp04.md")
...
- [AWS re:Invent 2024 - Adding agentic AI to legacy apps with
  AgentCore (MAM345)](https://www.youtube.com/watch?v=_-X-N0J02UI "https://www.youtube.com/watch?v=_-X-N0J02UI")
