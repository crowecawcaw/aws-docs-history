...
[Amazon
Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") applies Cedar policies at the
[Amazon
Bedrock AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") boundary, helping prevent agents
from bypassing budget limits through prompt manipulation.
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") complements this by enforcing
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md"), which feeds Amazon CloudWatch dashboards for budget utilization, cutoff activations,
...
1. **Enforce budget limits through Cedar
   policies:** Configure
   [Amazon
   Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") with Cedar policies
...
2. **Deploy automatic cutoffs and topic
   guardrails:** Track iteration counts and cumulative
   costs per session with automatic cutoffs, and use
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") for topic-based restrictions on
   tangential reasoning.
3. **Add graduated throttling:**
...
4. **Visualize and alarm on governance
   metrics:** Create Amazon CloudWatch dashboards
   displaying budget utilization, cutoff activations, and
   throttling events using
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") metrics.
...
- [Amazon
  Bedrock capacity, limits, and cost optimization](../../../bedrock/latest/userguide/capacity-limits-cost-optimization.md "../../../bedrock/latest/userguide/capacity-limits-cost-optimization.md")
- [Guidance
...
- [GitHub:
  ...
  tutorials](https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/08-AgentCore-policy "https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/08-AgentCore-policy")

**Related workshops:**

- [Diving
  Deep into Bedrock AgentCore - Policy](https://catalog.workshops.aws/agentcore-deep-dive/en-US/90-agentcore-policy "https://catalog.workshops.aws/agentcore-deep-dive/en-US/90-agentcore-policy")
