...
[Amazon
Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") provides session-scoped and
...
[Amazon
Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") handles RAG over external document
...
[Amazon
Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to catch misclassified
memories. The signal is usually unexpectedly high retrieval rates
from the wrong tier.

### Implementation steps

1. **Define a memory taxonomy:**
...
2. **Configure AgentCore Memory
   ...
   [Amazon
   Bedrock AgentCore Memory](../../../bedrock-agentcore/latest/devguide/memory.md "../../../bedrock-agentcore/latest/devguide/memory.md") with session-scoped and
   persistent namespaces that map to the taxonomy.
3. **Implement classification logic at
   ingestion:** Evaluate each item against the
   taxonomy criteria and route to the appropriate tier with
   metadata tags.
4. **Use Amazon Bedrock Knowledge Bases
   for external corpora:** Supplement agent memory
   with
   [Amazon
   Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") for RAG over organizational
   knowledge.
5. **Monitor access patterns to detect
   classification errors:** Use
   [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to spot unexpectedly
...
- [AGENTSUS02-BP01
  Optimize context management and memory utilization](agentsus02-bp01.md "agentsus02-bp01.md")
...
- [Strands
  Agents Session Management](https://strandsagents.com/docs/user-guide/concepts/agents/conversation-management/ "https://strandsagents.com/docs/user-guide/concepts/agents/conversation-management/")
...
- [AWS re:Invent 2024 - Make agents remember with AgentCore Memory
  (AIM331)](https://www.youtube.com/watch?v=Sh0Ro00_rpA "https://www.youtube.com/watch?v=Sh0Ro00_rpA")
