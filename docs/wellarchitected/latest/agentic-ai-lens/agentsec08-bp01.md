...
[Amazon
Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") with prompt attack detection to all
...
1. **Map input surfaces and assign
...
2. **Validate retrieved external
   content:** Configure
   [Amazon
   Bedrock Guardrails](../../../bedrock/latest/userguide/guardrails.md "../../../bedrock/latest/userguide/guardrails.md") with prompt attack detection and
   apply it to external content (RAG results, web content, API
   responses) before it enters the agent's context.
3. **Pick assessment mode by
...
7. **Restrict content sources where
...
8. **Verify surface-specific controls
...
- [AGENTSEC01-BP02
  Validate and sanitize memory inputs](agentsec01-bp02.md "agentsec01-bp02.md")
- [AGENTSEC02-BP02
  Validate tool inputs and outputs](agentsec02-bp02.md "agentsec02-bp02.md")
- [AGENTSEC04-BP01
  Implement guardrails and alignment controls](agentsec04-bp01.md "agentsec04-bp01.md")
- [AGENTSEC08-BP02 Output
  filtering for sensitive information](agentsec08-bp02.md "agentsec08-bp02.md")

**Related documents:**

- [Amazon
  Bedrock Guardrails prompt attack detection](../../../bedrock/latest/userguide/guardrails-prompt-attack.md "../../../bedrock/latest/userguide/guardrails-prompt-attack.md")
- [Amazon
  Bedrock Guardrails denied topics](../../../bedrock/latest/userguide/guardrails-denied-topics.md "../../../bedrock/latest/userguide/guardrails-denied-topics.md")
- [Amazon
  Bedrock Guardrails ApplyGuardrail API reference](../../../bedrock/latest/APIReference/API_runtime_ApplyGuardrail.md "../../../bedrock/latest/APIReference/API_runtime_ApplyGuardrail.md")
- [Build
...
- [Best
  ...
  configuration](https://aws.amazon.com/blogs/machine-learning/build-safe-generative-ai-applications-like-a-pro-best-practices-with-amazon-bedrock-guardrails/ "https://aws.amazon.com/blogs/machine-learning/build-safe-generative-ai-applications-like-a-pro-best-practices-with-amazon-bedrock-guardrails/")
- [Amazon
...
- [Amazon
  ...
  Framework](https://github.com/aws-samples/amazon-bedrock-samples/tree/main/responsible_ai/bedrock-guardrails-optimizer "https://github.com/aws-samples/amazon-bedrock-samples/tree/main/responsible_ai/bedrock-guardrails-optimizer")
