...
AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") applies Cedar policies at the [Amazon Bedrock AgentCore
Gateway](../../../bedrock-agentcore/latest/devguide/gateway.md "../../../bedrock-agentcore/latest/devguide/gateway.md") boundary, so iteration and token limits are rejected at the traffic layer
rather than noticed after they're exceeded. [Amazon Bedrock AgentCore
Runtime](../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md "../../../bedrock-agentcore/latest/devguide/agents-tools-runtime.md") provides session-isolated execution and consumption-based pricing, so each
...
AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") supports LLM-as-a-Judge assessment of decision quality, which
...
1. **Define explicit termination conditions per agent:** Set a
   ...
   Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md") Cedar policies at the AgentCore Gateway boundary so enforcement happens
   at the traffic layer rather than in application code.
2. **Instrument per-cycle token consumption:** Enable [Amazon
   Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md") to capture per-session token counts through
   OpenTelemetry, and configure Amazon CloudWatch alarms on anomalous per-cycle patterns.
3. **Establish objective confidence thresholds:** Configure
   [Amazon Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md") to score decision quality through
   LLM-as-a-Judge, and anchor early-termination thresholds to measured quality rather than
   self-reported confidence.
4. **Gate reflection on initial output quality:** Score each
...
5. **Recalibrate thresholds on a cadence:** Review
...
- [AGENTCOST01-BP02 Optimize multi-agent collaboration cost
  through efficient handoff patterns](agentcost01-bp02.md "agentcost01-bp02.md")
- [AGENTCOST01-BP03 Implement cost-effective patterns like
  hybrid supervisor for multi-agent coordination](agentcost01-bp03.md "agentcost01-bp03.md")
- [AGENTCOST02-BP01 Architect tiered model
  selection for cost-performance optimization](agentcost02-bp01.md "agentcost02-bp01.md")
- [AGENTCOST07-BP01 Implement automated cost
  controls with intelligent cutoffs](agentcost07-bp01.md "agentcost07-bp01.md")
...
- [Amazon Bedrock AgentCore Observability](../../../bedrock-agentcore/latest/devguide/observability.md "../../../bedrock-agentcore/latest/devguide/observability.md")
- [Amazon
  Bedrock AgentCore Policy](../../../bedrock-agentcore/latest/devguide/policy.md "../../../bedrock-agentcore/latest/devguide/policy.md")
- [Amazon Bedrock AgentCore Evaluations](../../../bedrock-agentcore/latest/devguide/evaluations.md "../../../bedrock-agentcore/latest/devguide/evaluations.md")
- [Evaluate
  models in Amazon Bedrock](../../../bedrock/latest/userguide/evaluation-judge.md "../../../bedrock/latest/userguide/evaluation-judge.md")
- [Agentic AI
  patterns and workflows on AWS](../../../prescriptive-guidance/latest/agentic-ai-patterns/introduction.md "../../../prescriptive-guidance/latest/agentic-ai-patterns/introduction.md")
- [Guidance for Cost Analysis and Optimization with Amazon Bedrock Agents](https://aws.amazon.com/solutions/guidance/cost-analysis-and-optimization-with-amazon-bedrock-agents/ "https://aws.amazon.com/solutions/guidance/cost-analysis-and-optimization-with-amazon-bedrock-agents/")

**Related videos:**

- [AWS 2025 - AgentCore
  Observability: Monitor and Debug with OpenTelemetry](https://www.youtube.com/watch?v=wWQgawUPr1k "https://www.youtube.com/watch?v=wWQgawUPr1k")
- [AWS re:Invent 2024 - Balance
  cost, performance & reliability for AI at enterprise scale (AIM3304)](https://www.youtube.com/watch?v=Lwvv8Q33eeE "https://www.youtube.com/watch?v=Lwvv8Q33eeE")
- [AWS re:Invent 2024 -
  Sustainable and cost-efficient generative AI with agentic workflows (AIM333)](https://www.youtube.com/watch?v=tFiDkSG2ess "https://www.youtube.com/watch?v=tFiDkSG2ess")

**Related examples:**

- [GitHub: awslabs/amazon-bedrock-agentcore-samples - Runtime tutorials](https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/01-AgentCore-runtime "https://github.com/awslabs/amazon-bedrock-agentcore-samples/tree/main/01-tutorials/01-AgentCore-runtime")

**Related workshops:**

- [Diving Deep into Bedrock AgentCore - Evaluations](https://catalog.workshops.aws/agentcore-deep-dive/en-US/80-agentcore-evaluations "https://catalog.workshops.aws/agentcore-deep-dive/en-US/80-agentcore-evaluations")
