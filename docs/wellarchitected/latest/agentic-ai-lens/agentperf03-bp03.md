...
choice of
[vector
store](../../../prescriptive-guidance/latest/choosing-an-aws-vector-database-for-rag-use-cases/introduction.md "../../../prescriptive-guidance/latest/choosing-an-aws-vector-database-for-rag-use-cases/introduction.md"). Query-time stages can filter and reorder what ingest
...
actually shifts.
[Advanced
parsing](../../../bedrock/latest/userguide/kb-advanced-parsing.md "../../../bedrock/latest/userguide/kb-advanced-parsing.md") recovers figures and tables from PDFs before
...
1. **Inventory source corpora and query
...
2. **Choose a chunking and parsing
   ...
   enable
   [advanced
   parsing](../../../bedrock/latest/userguide/kb-advanced-parsing.md "../../../bedrock/latest/userguide/kb-advanced-parsing.md") via a foundation model or Amazon Bedrock Data
   Automation before chunking. Configure the strategy in the
   [Knowledge
   Base chunking configuration](../../../bedrock/latest/userguide/kb-chunking.md "../../../bedrock/latest/userguide/kb-chunking.md") per data source rather
   than defaulting every source to fixed-size chunks.
3. **Select an embedding model and
   ...
   [Amazon
   Titan Text Embeddings V2](../../../bedrock/latest/userguide/titan-embedding-models.md "../../../bedrock/latest/userguide/titan-embedding-models.md") exposes configurable output
   dimensions so text-corpus index size, recall, and query
   latency can be balanced against each other, and
   [Amazon
   Nova Multimodal Embeddings](../../../bedrock/latest/userguide/model-card-amazon-amazon-nova-multimodal-embeddings.md "../../../bedrock/latest/userguide/model-card-amazon-amazon-nova-multimodal-embeddings.md") produces a single
...
4. **Configure the index for the
   ...
   Serverless, set
   [overrideSearchType: HYBRID](../../../bedrock/latest/userguide/kb-test-config.md "../../../bedrock/latest/userguide/kb-test-config.md")
   on the Retrieve request to combine vector and raw-text
   scoring in a single call. For direct OpenSearch workloads,
   configure
   [neural
   and hybrid search](../../../opensearch-service/latest/developerguide/serverless-configure-neural-search.md "../../../opensearch-service/latest/developerguide/serverless-configure-neural-search.md") explicitly. Apply metadata filters
   ...
   [vector
   index parameters](../../../opensearch-service/latest/developerguide/vector-search.md "../../../opensearch-service/latest/developerguide/vector-search.md") against retrieval precision on a
   representative query set so the index favors recall or
   latency according to the workload's budget.
5. **Add re-ranking before context
   delivery:** Run first-stage retrieval at a wider
   top-K than the prompt context budget allows, then pass the
   results through
   [Amazon
   Bedrock Rerank](../../../bedrock/latest/userguide/rerank.md "../../../bedrock/latest/userguide/rerank.md") to produce a higher-precision subset.
...
6. **Enable query
   ...
   Bases supports
   [query
   reformulation and decomposition](https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-knowledge-bases-now-supports-advanced-parsing-chunking-and-query-reformulation-giving-greater-control-of-accuracy-in-rag-based-applications/ "https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-knowledge-bases-now-supports-advanced-parsing-chunking-and-query-reformulation-giving-greater-control-of-accuracy-in-rag-based-applications/") through the Retrieve
   ...
   to the feature.
7. **Instrument per-stage retrieval
...
8. **Evaluate the pipeline on a
   ...
   Bases](https://aws.amazon.com/blogs/machine-learning/evaluate-and-improve-performance-of-amazon-bedrock-knowledge-bases/ "https://aws.amazon.com/blogs/machine-learning/evaluate-and-improve-performance-of-amazon-bedrock-knowledge-bases/"). Track Recall@k, nDCG@k, and RAG triad scores
...
- [Amazon
  Bedrock Knowledge Bases, How content chunking works](../../../bedrock/latest/userguide/kb-chunking.md "../../../bedrock/latest/userguide/kb-chunking.md")
- [Amazon
  Bedrock Knowledge Bases, Parsing options for your data
  source](../../../bedrock/latest/userguide/kb-advanced-parsing.md "../../../bedrock/latest/userguide/kb-advanced-parsing.md")
- [Amazon
  Bedrock Knowledge Bases, Query configurations](../../../bedrock/latest/userguide/kb-test-config.md "../../../bedrock/latest/userguide/kb-test-config.md")
- [Amazon
  Bedrock, Improve the relevance of query responses with a
  re-ranker model](../../../bedrock/latest/userguide/rerank.md "../../../bedrock/latest/userguide/rerank.md")
- [Amazon
  Titan Text Embeddings models](../../../bedrock/latest/userguide/titan-embedding-models.md "../../../bedrock/latest/userguide/titan-embedding-models.md")
- [Amazon
  Nova Multimodal Embeddings](../../../bedrock/latest/userguide/model-card-amazon-amazon-nova-multimodal-embeddings.md "../../../bedrock/latest/userguide/model-card-amazon-amazon-nova-multimodal-embeddings.md")
- [Amazon OpenSearch Service, Vector search](../../../opensearch-service/latest/developerguide/vector-search.md "../../../opensearch-service/latest/developerguide/vector-search.md")
- [Amazon OpenSearch Service Serverless, Configure Neural Search and Hybrid
  Search](../../../opensearch-service/latest/developerguide/serverless-configure-neural-search.md "../../../opensearch-service/latest/developerguide/serverless-configure-neural-search.md")
- [Blog:
  Amazon Bedrock Knowledge Bases, advanced parsing, chunking,
  and query reformulation](https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-knowledge-bases-now-supports-advanced-parsing-chunking-and-query-reformulation-giving-greater-control-of-accuracy-in-rag-based-applications/ "https://aws.amazon.com/blogs/machine-learning/amazon-bedrock-knowledge-bases-now-supports-advanced-parsing-chunking-and-query-reformulation-giving-greater-control-of-accuracy-in-rag-based-applications/")
- [Blog:
  Evaluate and improve performance of Amazon Bedrock Knowledge
  Bases](https://aws.amazon.com/blogs/machine-learning/evaluate-and-improve-performance-of-amazon-bedrock-knowledge-bases/ "https://aws.amazon.com/blogs/machine-learning/evaluate-and-improve-performance-of-amazon-bedrock-knowledge-bases/")
- [Choosing
  an AWS vector database for RAG use cases](../../../prescriptive-guidance/latest/choosing-an-aws-vector-database-for-rag-use-cases/introduction.md "../../../prescriptive-guidance/latest/choosing-an-aws-vector-database-for-rag-use-cases/introduction.md")

**Related videos:**

- [AWS re:Invent 2025 - Advanced agentic RAG Systems: Deep dive with
  Amazon Bedrock (AIM425)](https://www.youtube.com/watch?v=bu2cD1pCFTs "https://www.youtube.com/watch?v=bu2cD1pCFTs")

**Related examples:**

- [GitHub:
  Amazon Bedrock samples, Knowledge Bases and RAG](https://github.com/aws-samples/amazon-bedrock-samples "https://github.com/aws-samples/amazon-bedrock-samples")
