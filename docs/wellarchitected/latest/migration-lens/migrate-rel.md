...
**Suggestion 8.1.1:** Follow the best practices (BPs) in the [reliability pillar](../reliability-pillar/welcome.md "../reliability-pillar/welcome.md") to complete the failure management testing for the migrated workloads.
...
do you test reliability](../framework/rel-12.md "../framework/rel-12.md").
