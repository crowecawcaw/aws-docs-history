...
+  [Testing and cutover](https://docs.aws.amazon.com/whitepapers/latest/amazon-aurora-mysql-migration-handbook/testing-and-cutover.html) 
+  [Application migration process](https://docs.aws.amazon.com/prescriptive-guidance/latest/cutover-runbook/app-migration.html) 
+  [Testing Phase](https://docs.aws.amazon.com/whitepapers/latest/best-practices-for-migrating-from-rdbms-to-dynamodb/testing-phase.html) 

## MIG-PERF-BP-8.2: Review and implement the lessons learned from previous migration waves
<a name="mig-perf-bp-8.2-review-and-implement-the-lessons-learned-from-previous-migration-waves"></a>
...
<a name="mig-perf-bp-8.3-perform-a-well-architected-framework-review-on-each-iteration-of-the-migrated-workload"></a>
...
<a name="mig-perf-bp-9.1-generate-alarm-based-notifications-for-metrics-threshold-breach"></a>
...
<a name="mig-perf-bp-9.2-determine-the-need-for-a-real-time-or-a-near-real-time-monitoring-solution"></a>
...
<a name="mig-perf-bp-9.3"></a>

This BP applies to the following best practice areas: Process and culture

### Implementation guidance
<a name="implementation-guidance-9.3"></a>
...
<a name="mig-perf-bp-9.4-set-up-automated-testing-for-your-application-metrics"></a>
...
<a name="mig-perf-bp-9.5-re-evaluate-your-compute-usage"></a>
