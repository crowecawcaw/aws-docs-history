...
detail, see
[Manage
service quotas and constraints](../reliability-pillar/manage-service-quotas-and-constraints.md "../reliability-pillar/manage-service-quotas-and-constraints.md"). Migrations can add new
...
[AWS Application Migration Service](../../../mgn/latest/ug/MGN-service-limits.md "../../../mgn/latest/ug/MGN-service-limits.md") and

[AWS DMS](../../../dms/latest/userguide/CHAP_Limits.md "../../../dms/latest/userguide/CHAP_Limits.md"), as these can affect the sizing of your migration
...
cause the soft limit network interfaces per Region (default 5000) to be reached. Request limit increases for such quotas
...
For more detail, see [Data routing and throttling](../../../mgn/latest/ug/data-routing.md "../../../mgn/latest/ug/data-routing.md") and [Improving the performance of an AWS DMS migration](../../../dms/latest/userguide/CHAP_BestPractices.md#CHAP_BestPractices.Performance "../../../dms/latest/userguide/CHAP_BestPractices.md#CHAP_BestPractices.Performance").
...
non-workload subnets](../../../prescriptive-guidance/latest/patterns/preserve-routable-ip-space-in-multi-account-vpc-designs-for-non-workload-subnets.md "../../../prescriptive-guidance/latest/patterns/preserve-routable-ip-space-in-multi-account-vpc-designs-for-non-workload-subnets.md").
...
For more detail, see designs for [single-accoun](../../../prescriptive-guidance/latest/patterns/set-up-dns-resolution-for-hybrid-networks-in-a-single-account-aws-environment.md "../../../prescriptive-guidance/latest/patterns/set-up-dns-resolution-for-hybrid-networks-in-a-single-account-aws-environment.md")t and [multi-account](../../../prescriptive-guidance/latest/patterns/set-up-dns-resolution-for-hybrid-networks-in-a-multi-account-aws-environment.md "../../../prescriptive-guidance/latest/patterns/set-up-dns-resolution-for-hybrid-networks-in-a-multi-account-aws-environment.md") hybrid DNS resolutions. During any multi-phase migration, on-premises applications need to talk to migrated applications through DNS, and migrated applications need to talk to on-premises applications. For more detail, see [Automating DNS infrastructure using Route 53 Resolver endpoints](https://aws.amazon.com/blogs/networking-and-content-delivery/automating-dns-infrastructure-using-route-53-resolver-endpoints/ "https://aws.amazon.com/blogs/networking-and-content-delivery/automating-dns-infrastructure-using-route-53-resolver-endpoints/").
...
detail, see
[Tutorial:
Simulate a connectivity event](../../../fis/latest/userguide/fis-tutorial-disrupt-connectivity.md "../../../fis/latest/userguide/fis-tutorial-disrupt-connectivity.md").
...
- [Identify and back up all data that needs to be backed up, or reproduce the data from sources](../reliability-pillar/rel_backing_up_data_identified_backups_data.md "../reliability-pillar/rel_backing_up_data_identified_backups_data.md")
- [Secure
  and encrypt backups](../reliability-pillar/rel_backing_up_data_secured_backups_data.md "../reliability-pillar/rel_backing_up_data_secured_backups_data.md")
- [Perform
...
- [Perform periodic recovery of the data to verify backup integrity and processes](../reliability-pillar/rel_backing_up_data_periodic_recovery_testing_data.md "../reliability-pillar/rel_backing_up_data_periodic_recovery_testing_data.md")
...
pillar](../framework/a-reliability.md "../framework/a-reliability.md") to distribute workload data and resources
...
- [Deploy
  the workload to multiple locations](../reliability-pillar/rel_fault_isolation_multiaz_region_system.md "../reliability-pillar/rel_fault_isolation_multiaz_region_system.md")
- [Automate recovery for components constrained to a single location](../reliability-pillar/rel_fault_isolation_single_az_system.md "../reliability-pillar/rel_fault_isolation_single_az_system.md")
