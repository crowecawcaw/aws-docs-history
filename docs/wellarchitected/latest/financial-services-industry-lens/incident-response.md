...
+  As organizations grow and evolve over time, so does the threat landscape, making it important to continually review your incident response capabilities. [Game days](https://aws.amazon.com/gameday/) simulate a failure or event to test systems, processes, and team responses. This helps you understand where improvements can be made and can help develop organizational experience in dealing with events. 
+  Conduct game days regularly so that your team builds muscle memory on how to respond. 

**Topics**
+ [FSISEC12: How are you meeting your obligations for incident reporting to regulators?](fsisec12.md)