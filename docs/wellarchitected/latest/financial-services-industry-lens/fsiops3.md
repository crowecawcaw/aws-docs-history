...
evolving changes to compliance and regulatory obligations. Use [AWS Config Conformance Packs](../../../config/latest/developerguide/conformance-packs.md "../../../config/latest/developerguide/conformance-packs.md") and AWS Audit Manager to continually evaluate
...
notified of changes. Use [AWS Artifact](https://aws.amazon.com/artifact/ "https://aws.amazon.com/artifact/")
