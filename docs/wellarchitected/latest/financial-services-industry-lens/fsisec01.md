...
[creating
a CCoE](https://aws.amazon.com/blogs/enterprise-strategy/using-a-cloud-center-of-excellence-ccoe-to-transform-the-entire-enterprise/ "https://aws.amazon.com/blogs/enterprise-strategy/using-a-cloud-center-of-excellence-ccoe-to-transform-the-entire-enterprise/"):
...
agility.
[AWS Management and Governance native services](../../../whitepapers/latest/aws-overview/management-governance.md "../../../whitepapers/latest/aws-overview/management-governance.md")
...
The whitepaper
[Cloud
Enablement Engine: A Practical Guide](https://d1.awsstatic.com/whitepapers/cloud-enablement-engine-practical-guide.pdf "https://d1.awsstatic.com/whitepapers/cloud-enablement-engine-practical-guide.pdf")
...
[Manage pre-approved services for secure adoption at scale with Service Catalog](../../../servicecatalog/latest/adminguide/introduction.md "../../../servicecatalog/latest/adminguide/introduction.md").

[AWS Control Tower](../../../controltower/latest/userguide/what-is-control-tower.md "../../../controltower/latest/userguide/what-is-control-tower.md") can offer a straightforward way
...
[AWS services](../../../controltower/latest/userguide/integrated-services.md "../../../controltower/latest/userguide/integrated-services.md"), including AWS Organizations, Service Catalog, and AWS IAM Identity Center. It allows you to
...
- [AWS Control Tower and AWS Security Hub CSPM – Powerful Enterprise Twins](https://aws.amazon.com/blogs/enterprise-strategy/aws-control-tower-and-aws-security-hub-powerful-enterprise-twins/ "https://aws.amazon.com/blogs/enterprise-strategy/aws-control-tower-and-aws-security-hub-powerful-enterprise-twins/")

**Related videos:**

- [Transform your organization's culture with a Cloud Center of Excellence](https://www.youtube.com/watch?v=VN1vj0d3Z1Y&ab_channel=AWSEvents "https://www.youtube.com/watch?v=VN1vj0d3Z1Y&ab_channel=AWSEvents")
- [How to Build Your Cloud Enablement Engine with the People You Already Have](https://pages.awscloud.com/How-to-Build-Your-Cloud-Enablement-Engine-with-the-People-You-Already-Have_2019_0617-ENT_OD.html "https://pages.awscloud.com/How-to-Build-Your-Cloud-Enablement-Engine-with-the-People-You-Already-Have_2019_0617-ENT_OD.html")
