...
<a name="financial-services-industry-lens"></a>

Publication date: **January 27, 2026** ([Document revisions](document-revisions.md))
...
All customers should begin with the best practices and questions outlined in the [AWS Well-Architected Framework whitepaper](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html). This document provides additional best practices that are focused on the technical architectures and workloads that are associated with financial services institutions. 
