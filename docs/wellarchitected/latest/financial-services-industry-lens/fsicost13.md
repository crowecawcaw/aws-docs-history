...
<a name="fsicost13-bp01-set-up-pay-as-you-go-services-when-team-expands-for-certain-duration"></a>

 Some financial services institutions hire contractors during specific months, or for a project. These contractors can work on a project for a short duration, like 6 months to a year. Procuring a new machine, and ensuring that it is meeting the compliance standards of a financial services institution can be resource intensive. Using a service like [Amazon WorkSpaces](https://aws.amazon.com/workspaces/faqs/) for end-user computing can help with cost-efficient utilization of resources. You can create workspaces per your internal standards, and provision it for a new resource. 
