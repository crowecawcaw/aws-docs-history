...
[IAM
policies](../../../IAM/latest/UserGuide/access_policies.md "../../../IAM/latest/UserGuide/access_policies.md") are powerful and complex, so it's
...
[block
users in](../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception "../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception")
[your accounts, except for IAM administrators](../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception "../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception") or
...
[IAM permissions boundaries](../../../IAM/latest/UserGuide/access_policies_boundaries.md "../../../IAM/latest/UserGuide/access_policies_boundaries.md"). IAM permissions
...
- Enable Amazon GuardDuty in each account, and use it in
  ...
  [IAM privilege escalation](../../../guardduty/latest/ug/guardduty_finding-types-iam.md#privilegeescalation-iam-anomalousbehavior "../../../guardduty/latest/ug/guardduty_finding-types-iam.md#privilegeescalation-iam-anomalousbehavior") and other IAM

[finding types](../../../guardduty/latest/ug/guardduty_finding-types-iam.md "../../../guardduty/latest/ug/guardduty_finding-types-iam.md").
...
- If you believe there has been unauthorized use of your
  ...
  [disable their permissions](../../../IAM/latest/UserGuide/id_roles_use_revoke-sessions.md "../../../IAM/latest/UserGuide/id_roles_use_revoke-sessions.md").
- [View the last accessed information for IAM](../../../IAM/latest/UserGuide/access_policies_access-advisor-view-data.md "../../../IAM/latest/UserGuide/access_policies_access-advisor-view-data.md")
...
[source
identity](../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-user-identity.md#STS-API-source-identity "../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-user-identity.md#STS-API-source-identity") in AWS CloudTrail. Administrators
...
[review
IAM policies](../../../IAM/latest/UserGuide/security-audit-guide.md#aws-security-audit-review-policy-tips "../../../IAM/latest/UserGuide/security-audit-guide.md#aws-security-audit-review-policy-tips") as well as setting restrictive
user access on a need to know basis. You can
[prevent IAM user and roles from making specified changes](../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception "../../../organizations/latest/userguide/orgs_manage_policies_scps_examples_general.md#example-scp-restricts-with-exception"), through Service Control Policies
(SCPs) and set

[Permissions boundaries for IAM entities](../../../IAM/latest/UserGuide/access_policies_boundaries.md "../../../IAM/latest/UserGuide/access_policies_boundaries.md").
...
- [Monitor and Notify on AWS Account Root User
  Activity](https://aws.amazon.com/blogs/mt/monitor-and-notify-on-aws-account-root-user-activity/ "https://aws.amazon.com/blogs/mt/monitor-and-notify-on-aws-account-root-user-activity/")

**Related videos:**

- [AWS re:Inforce 2022 - Security best practices with AWS IAM](https://www.youtube.com/watch?v=SMjvtxXOXdU "https://www.youtube.com/watch?v=SMjvtxXOXdU")
