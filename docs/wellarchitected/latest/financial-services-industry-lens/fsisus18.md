...
set of recommendations known as the _green SLA_ that offsets the
...
Performance Computing clouds](https://ieeexplore.ieee.org/document/6604503 "https://ieeexplore.ieee.org/document/6604503").
