...
<a name="fsisus18-bp01-use-a-green-sla"></a>

### Prescriptive guidance
<a name="prescriptive-guidance-25"></a>

 The Institute of Electronics and Electrical Engineers standards body has created a set of recommendations known as the *green SLA* that offsets the responsiveness of system to meet customer requirements against the need to reduce environmental impacts. For more information, see [Providing green SLAs in High Performance Computing clouds](https://ieeexplore.ieee.org/document/6604503). 
