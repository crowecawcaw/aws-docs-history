...
## Design principles
<a name="opex-design-principles"></a>
...
+  **Implement a risk management process:** Financial institutions have adopted a [Three Lines of Defense model](https://www.iansresearch.com/resources/all-blogs/post/security-blog/2022/01/13/how-to-apply-the-three-lines-of-defense) for risk management: 
...
## Definitions
<a name="opex-definitions"></a>

 Operational excellence in the financial services industry is composed of the following best practice areas: 

1.  [Organization](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/organization.html) 

1.  [Prepare](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/prepare.html) 

1.  [Operate](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/operate.html) 

1.  [Evolve](https://docs.aws.amazon.com/wellarchitected/latest/operational-excellence-pillar/evolve.html) 