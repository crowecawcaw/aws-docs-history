...
[data
protection recommendations](../security-pillar/data-protection.md "../security-pillar/data-protection.md") applicable to any
...
[_envelope
encryption_ strategy](../../../kms/latest/developerguide/concepts.md "../../../kms/latest/developerguide/concepts.md"), which
...
- Evaluate the differences between
  [different
  key types in AWS KMS](../../../kms/latest/developerguide/concepts.md#key-mgmt "../../../kms/latest/developerguide/concepts.md#key-mgmt").
...
- [Announcing
  AWS KMS External Key Store (XKS)](https://aws.amazon.com/blogs/aws/announcing-aws-kms-external-key-store-xks/ "https://aws.amazon.com/blogs/aws/announcing-aws-kms-external-key-store-xks/")

**Related videos:**

- [AWS re:Invent 2022 – Protecting secrets, keys, and data: Cryptography for the long term](https://www.youtube.com/watch?v=9vr3oMODIUE&t=2535s&ab_channel=AWSEvents "https://www.youtube.com/watch?v=9vr3oMODIUE&t=2535s&ab_channel=AWSEvents")
- [AWS re:Invent 2022 – AWS data protection: Using locks, keys, signatures, and certificates](https://www.youtube.com/watch?v=lD34wbc7KNA&ab_channel=AWSEvents "https://www.youtube.com/watch?v=lD34wbc7KNA&ab_channel=AWSEvents")
- [AWS re:Invent 2022 – Introducing AWS KMS external keys](https://www.youtube.com/watch?v=prj6xgpHFTo&t=672s&ab_channel=AWSEvents "https://www.youtube.com/watch?v=prj6xgpHFTo&t=672s&ab_channel=AWSEvents")
