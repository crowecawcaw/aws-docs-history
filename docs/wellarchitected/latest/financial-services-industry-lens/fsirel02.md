...
allow
[cross-region
inference](../../../bedrock/latest/userguide/cross-region-inference.md "../../../bedrock/latest/userguide/cross-region-inference.md") or
[provisioned
throughput](../../../bedrock/latest/userguide/prov-throughput.md "../../../bedrock/latest/userguide/prov-throughput.md") to facilitate more reliable calls to
...
[Fault
Injection Service](https://aws.amazon.com/fis/ "https://aws.amazon.com/fis/") or Cross-Region connectivity faults
...
[chaos
engineering](https://aws.amazon.com/blogs/architecture/chaos-testing-with-aws-fault-injection-simulator-and-aws-codepipeline/ "https://aws.amazon.com/blogs/architecture/chaos-testing-with-aws-fault-injection-simulator-and-aws-codepipeline/"), your teams can improve observability and
