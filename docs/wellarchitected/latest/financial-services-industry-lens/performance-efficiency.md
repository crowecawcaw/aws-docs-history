...
<a name="consider-both-internal-and-external-requirements"></a>
...
+  [Selection](https://docs.aws.amazon.com/wellarchitected/latest/framework/a-selection.html) 
+  [Review](https://docs.aws.amazon.com/wellarchitected/latest/framework/a-review.html) 
+  [Monitoring](https://docs.aws.amazon.com/wellarchitected/latest/framework/a-monitoring.html) 
+  [Trade-offs](https://docs.aws.amazon.com/wellarchitected/latest/framework/a-tradeoffs.html) 
