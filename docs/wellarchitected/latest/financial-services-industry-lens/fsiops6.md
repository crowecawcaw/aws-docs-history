...
and familiarity with the Support workflow. [Support Center](https://support.console.aws.amazon.com/support/home "https://support.console.aws.amazon.com/support/home") access
may be restricted by central governance policies, and [access to create Support
cases](../../../awssupport/latest/user/accessing-support.md "../../../awssupport/latest/user/accessing-support.md") should be confirmed prior to a service event in order to help avoid
...
Dashboard](https://health.aws.amazon.com/health/status "https://health.aws.amazon.com/health/status") to confirm whether there are any AWS service events in progress
...
Create
[specialized runbooks](https://aws.amazon.com/blogs/security/methodology-for-incident-response-on-generative-ai-workloads/ "https://aws.amazon.com/blogs/security/methodology-for-incident-response-on-generative-ai-workloads/") for generative AI-related incidents
