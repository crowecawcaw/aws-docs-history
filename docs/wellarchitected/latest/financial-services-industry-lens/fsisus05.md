...
A simple example of this is using [AWS Direct Connect](../../../directconnect.md "../../../directconnect.md") where performance is often degraded as FSI organizations insist
