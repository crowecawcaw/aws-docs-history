...
- Avoiding the backup of unnecessary data can help lower cost and reduce the
  ...
  is needed to satisfy compliance requirements. Use [AWS Backup](../../../aws-backup/latest/devguide/whatisbackup.md "../../../aws-backup/latest/devguide/whatisbackup.md") for Amazon EFS or
