...
<a name="fsisus04-bp01"></a>

 **Prescriptive guidance** 
+  Use [Amazon ECS Spot](https://aws.amazon.com/ec2/spot/) compute for non-critical workloads such as end-of-month reconciliations. 
+  Use [Amazon EC2 Dedicated Hosts](https://aws.amazon.com/ec2/dedicated-hosts/) queues for priority jobs such as order initiation. 
+  Use [Amazon ECR Lifecycle Policies](https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html) for ephemeral ETL data such as ingestion ledgers. 
...
<a name="fsisus04-bp02-fsi-workloads-serve-the-highest-common-denominator-of-application-demands"></a>
...
### Prescriptive guidance
<a name="prescriptive-guidance-12"></a>
