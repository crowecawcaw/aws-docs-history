...
see
[Ransomware Risk Management on AWS Using the NIST Cyber Security Framework (CSF)](../../../whitepapers/latest/ransomware-risk-management-on-aws-using-nist-csf/ransomware-risk-management-on-aws-using-nist-csf.md "../../../whitepapers/latest/ransomware-risk-management-on-aws-using-nist-csf/ransomware-risk-management-on-aws-using-nist-csf.md").
...
- [Protecting
  against ransomware](https://aws.amazon.com/security/protecting-against-ransomware/ "https://aws.amazon.com/security/protecting-against-ransomware/")
- [GuardDuty findings that initiate Malware Protection scans](../../../guardduty/latest/ug/gd-findings-initiate-malware-protection-scan.md "../../../guardduty/latest/ug/gd-findings-initiate-malware-protection-scan.md")
- [Ransomware Risk Management on AWS Using the NIST Cyber Security Framework (CSF)](../../../whitepapers/latest/ransomware-risk-management-on-aws-using-nist-csf/ransomware-risk-management-on-aws-using-nist-csf.md "../../../whitepapers/latest/ransomware-risk-management-on-aws-using-nist-csf/ransomware-risk-management-on-aws-using-nist-csf.md")
- [Ransomware mitigation: Top 5 protections and recovery preparation actions](https://aws.amazon.com/blogs/security/ransomware-mitigation-top-5-protections-and-recovery-preparation-actions/ "https://aws.amazon.com/blogs/security/ransomware-mitigation-top-5-protections-and-recovery-preparation-actions/")
- [Workshop: Ransomware on S3 - Simulation and Detection](https://catalog.workshops.aws/aws-cirt-ransomware-simulation-and-detection/en-US "https://catalog.workshops.aws/aws-cirt-ransomware-simulation-and-detection/en-US")

**Related videos:**

- [What is Amazon GuardDuty Malware Protection? | Amazon Web Services](https://www.youtube.com/watch?v=xKAp5lx1Sb0&ab_channel=AmazonWebServices "https://www.youtube.com/watch?v=xKAp5lx1Sb0&ab_channel=AmazonWebServices")
- [AWS re:Invent 2021 - Backup, disaster recovery, and ransomware protection with AWS](https://www.youtube.com/watch?v=Ru4jxh9qazc&ab_channel=AWSEvents "https://www.youtube.com/watch?v=Ru4jxh9qazc&ab_channel=AWSEvents")
