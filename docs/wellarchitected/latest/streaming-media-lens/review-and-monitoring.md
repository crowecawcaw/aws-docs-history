...
| **Scenario** | **Segment Size** | **Manifest Update<br>Frequency** | **Segment Cache-Control Header or<br>Cache Behavior** | **Manifest Cache-Control Header or<br>Cache Behavior** |
| ------------ | ---------------- | -------------------------------- | ----------------------------------------------------- | ------------------------------------------------------ |
...
_Recommended cache behaviors for live and
Video-on-Demand (VOD) scenarios_
...
_Zero-Impact-Rate_, measures the rate of
...
| **Metric**                        | **Description**                                                                      |
| --------------------------------- | ------------------------------------------------------------------------------------ |
| **Time-to-First-Frame**           | Time between client request for content and first frame<br>being displayed on client |
| **Playback Frames Per<br>Second** | Client displayed frame rate                                                          |
...
| **Zero-Impact-Rate**              | Percentage of total sessions that had zero Buffers or<br>Errors                      |

_Suggested metrics for measuring quality of
service_
