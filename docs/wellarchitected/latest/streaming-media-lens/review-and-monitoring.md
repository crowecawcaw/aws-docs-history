...
<a name="review-and-monitoring"></a>
...
| SM\_PBP6 – Ensure that cache-control headers for your content are optimized | 
| SM\_PBP7 – Have a cache invalidation runbook | 
| SM\_PBP8 – Minimize negative (error) caching | 
