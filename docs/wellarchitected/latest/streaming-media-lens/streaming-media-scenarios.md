...
<a name="streaming-media-scenarios"></a>
...
**Topics**
+ [Scenario: Video-on-Demand streaming](scenario-video-on-demand-streaming.md)
+ [Scenario: Live streaming](scenario-live-streaming.md)
+ [Scenario: Ad supported content monetization](scenario-ad-supported-content-monetization.md)