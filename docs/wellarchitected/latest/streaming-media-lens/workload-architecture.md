...
+  Content Delivery Network (load dependent) 
 ...
 Every business will have to trade off the cost of reliably streaming content with any failure conditions that arise. We recommend reviewing the [Well-Architected Reliability Pillar whitepaper](https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/welcome.html) to help you calculate your reliability target and the hard and soft dependencies of your workload. 
