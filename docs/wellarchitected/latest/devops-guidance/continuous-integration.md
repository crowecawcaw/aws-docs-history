...
**Topics**
+ [Indicators for continuous integration](indicators-for-ci.md)
+ [Anti-patterns for continuous integration](anti-patterns-for-continuous-integration.md)
+ [Metrics for continuous integration](metrics-for-continuous-integration.md)