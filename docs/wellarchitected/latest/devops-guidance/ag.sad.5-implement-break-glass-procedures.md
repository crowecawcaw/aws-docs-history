...
- [AWS Well-Architected Security Pillar: SEC03-BP03 Establish
  emergency access process](../security-pillar/sec_permissions_emergency_process.md "../security-pillar/sec_permissions_emergency_process.md")
- [Break
  glass access](../../../whitepapers/latest/organizing-your-aws-environment/break-glass-access.md "../../../whitepapers/latest/organizing-your-aws-environment/break-glass-access.md")
- [Amazon's
  approach to high-availability deployment: Dealing with the
  real world](https://youtu.be/bCgD2bX1LI4?t=1300 "https://youtu.be/bCgD2bX1LI4?t=1300")
