...
Use a _compliance as code_ approach to integrate compliance rules
...
- [Cloud
  Security Posture Management (CSPM) - AWS Security Hub CSPM](https://aws.amazon.com/security-hub/ "https://aws.amazon.com/security-hub/")
- [AWS Config and AWS Organizations - AWS Organizations](../../../organizations/latest/userguide/services-that-can-integrate-config.md "../../../organizations/latest/userguide/services-that-can-integrate-config.md")
- [Intelligent
  Threat Detection - Amazon GuardDuty](https://aws.amazon.com/guardduty/ "https://aws.amazon.com/guardduty/")
- [Building
