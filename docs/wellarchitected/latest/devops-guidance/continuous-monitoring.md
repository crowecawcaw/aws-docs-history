...
**Topics**
+ [Indicators for continuous-monitoring](indicators-for-continuous-monitoring.md)
+ [Anti-patterns for continuous monitoring](anti-patterns-for-continuous-monitoring.md)
+ [Metrics for continuous monitoring](metrics-for-continuous-monitoring.md)