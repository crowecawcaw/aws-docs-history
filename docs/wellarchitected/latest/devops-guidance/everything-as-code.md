...
**Topics**
+ [Indicators for everything as code](indicators-for-everything-as-code.md)
+ [Anti-patterns for everything as code](anti-patterns-for-everything-as-code.md)
+ [Metrics for everything as code](metrics-for-everything-as-code.md)