...
**Topics**
+ [Indicators for data lifecycle management](indicators-for-data-lifecycle-management.md)
+ [Anti-patterns for data lifecycle management](anti-patterns-for-data-lifecycle-management.md)
+ [Metrics for data lifecycle management](metrics-for-data-lifecycle-management.md)