...
Following the
[Well-Architected
Reliability Pillar](../reliability-pillar/plan-your-network-topology.md "../reliability-pillar/plan-your-network-topology.md"), redundant, encrypted connections
are critical to verify service continuity and, more
importantly, consistent patient care. Many best practices can
be found in the
[AWS Well-Architected Framework Hybrid Networking Lens](../hybrid-networking-lens/hybrid-networking-lens.md "../hybrid-networking-lens/hybrid-networking-lens.md").
...
There are
[two
common approaches](../../../directconnect/latest/UserGuide/disaster-recovery-resiliency.md "../../../directconnect/latest/UserGuide/disaster-recovery-resiliency.md") to establishing redundancy across
your network connection to AWS:

- Redundant Direct Connect connections: Use the
  [AWS Direct Connect resiliency toolkit](../../../directconnect/latest/UserGuide/resiliency_toolkit.md "../../../directconnect/latest/UserGuide/resiliency_toolkit.md") to enable
  resilient applications and achieve an SLA of 99.99%.
- [Failover
  to public internet connection with VPN routing.](../../../whitepapers/latest/aws-vpc-connectivity-options/aws-direct-connect-vpn.md "../../../whitepapers/latest/aws-vpc-connectivity-options/aws-direct-connect-vpn.md")
