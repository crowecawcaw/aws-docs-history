...
+  Medical imaging study data is often stored and transmitted using the [DICOM standard](https://www.dicomstandard.org/). This standard covers both a network protocol and file format definitions. 
+  Some medical imaging solutions, such PACS, may fall under regulatory control, such as [GxP regulation](https://aws.amazon.com/compliance/gxp-part-11-annex-11/) in the US. Machine learning algorithms that aid in diagnoses may also fall under regulatory control. Determine which, if any, regulatory controls are applicable to your solutions. 
