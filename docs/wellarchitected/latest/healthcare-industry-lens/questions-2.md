...
|   | 
 ...
 Once performance requirements are met, systems can be cost optimized by balancing image retrieval performance with use of cost-effective storage services (such as right sizing cache volumes and [throughput provisioning](https://docs.aws.amazon.com/fsx/latest/WindowsGuide/performance.html)). 
