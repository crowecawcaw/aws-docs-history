...
or a [pilot
light disaster recovery environment](../../../whitepapers/latest/disaster-recovery-workloads-on-aws/disaster-recovery-options-in-the-cloud.md "../../../whitepapers/latest/disaster-recovery-workloads-on-aws/disaster-recovery-options-in-the-cloud.md"). Create specific
...
Well-Architected Framework](../security-pillar/incident-response.md "../security-pillar/incident-response.md") contains further details on
