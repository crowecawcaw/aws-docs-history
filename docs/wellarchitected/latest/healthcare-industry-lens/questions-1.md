...
|   | 
 ...
 Work with your customer to understand what vocabularies they employ and how you can link to standards. Where possible, leverage modern standards that provide semantic interoperability, such as Consolidated-Clinical Document Architecture (C-CDA). AI-based services, like [Amazon Comprehend Medical](https://aws.amazon.com/comprehend/medical/), can link concepts to standard ontologies in cases that deterministic linking is not possible. 
...
|   | 
 ...
 Restrict access to integration endpoints to allow-listed IP addresses and through secure VPN tunnels when possible. Employ [AWS WAF](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-control-access-aws-waf.html) to protect RESTful APIs, and the suite of [AWS security services](https://aws.amazon.com/security/) to add additional security measures. 
