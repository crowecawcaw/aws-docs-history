...
+  Create a hierarchical structure of IP pools that align with your organizational needs and geographical presence. For example, you can use services such as [Amazon VPC IPAM](https://docs.aws.amazon.com/vpc/latest/ipam/what-it-is-ipam.html). 
