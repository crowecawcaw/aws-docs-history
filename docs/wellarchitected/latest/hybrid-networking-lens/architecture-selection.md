...
- [HNPERF01-BP01 Determine and define your performance requirements using bandwidth, latency and jitter values.](hnperf01-bp01..md "hnperf01-bp01..md")
- [HNPERF01-BP02 Identify what applications and types of data will be transmitted over the network](hnperf01-bp02.md "hnperf01-bp02.md")
- [HNPERF02-BP01 Use tradeoffs to improve network performance](hnperf02-bp01.md "hnperf02-bp01.md")
- [HNPERF02-BP02 Choose the right physical PoP location for dedicated connectivity](hnperf02-bp02.md "hnperf02-bp02.md")
- [HNPERF02-BP03 Choose the right termination endpoint in the cloud](hnperf02-bp03.md "hnperf02-bp03.md")
- [HNPERF02-BP04 Select the most appropriate region for your workloads](hnperf02-bp04.md "hnperf02-bp04.md")
