...
<a name="cloud-game-development-cicd"></a>
...
1.  Perforce manages source and version control (CI) backed by Amazon EBS storage for quickly accessed, persistent data. Perforce Helix Core is available in the AWS Marketplace. 
