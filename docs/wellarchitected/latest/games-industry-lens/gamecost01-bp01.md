...
+  [Standalone game session servers with a WebSockets-based backend](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift_quickstart_customservers_designbackend_arch_websockets.html) 
+  [Standalone game session servers with a serverless backend](https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift_quickstart_customservers_designbackend_arch_serverless.html) 
