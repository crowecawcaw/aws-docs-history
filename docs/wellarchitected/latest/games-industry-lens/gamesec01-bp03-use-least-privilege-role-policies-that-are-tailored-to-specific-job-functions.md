...
<a name="gamesec01-bp03-use-least-privilege-role-policies-that-are-tailored-to-specific-job-functions"></a>
...
<a name="implementation-guidance-14"></a>
 ...
 You might start with broad permissions, like [managed policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_job-functions.html), while you explore the permissions that are required for your workload or use case. As your use case matures, you can work to reduce the permissions that you grant to work toward least privilege. 
