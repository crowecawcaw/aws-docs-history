...
[AWS Fargate](https://aws.amazon.com/fargate/ "https://aws.amazon.com/fargate/") can speed up and simplify the load testing setup by
...
[EKS
Anywhere](https://aws.amazon.com/eks/eks-anywhere/ "https://aws.amazon.com/eks/eks-anywhere/") can manage both clusters as one from the AWS Management Console.

You can also use
[AWS Lambda](https://aws.amazon.com/lambda/ "https://aws.amazon.com/lambda/") functions depending on your requirements and goals.
...
[Distributed
Load Testing on AWS](../../../solutions/latest/distributed-load-testing-on-aws/solution-overview.md "../../../solutions/latest/distributed-load-testing-on-aws/solution-overview.md"). This solution uses the Amazon ECS on
...
- **[Apache
  JMeter](https://jmeter.apache.org/ "https://jmeter.apache.org/"):** Popular Java-based, open-source load
...
- **[Locust](https://locust.io/ "https://locust.io/"):**
  ...
  simple to read.
- **[Grafana
  K6](https://k6.io/ "https://k6.io/"):** Powerful load testing framework that
