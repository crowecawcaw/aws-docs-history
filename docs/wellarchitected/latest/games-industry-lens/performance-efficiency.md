...
+ [Architecture selection](gameperf01.md)
+ [Region selection](gameperf02.md)
+ [Iterative development](gameperf03.md)
+ [Compute and hardware](gameperf04.md)
+ [Compute selection](gameperf05.md)
+ [Data management](gameperf06.md)
+ [Networking and content delivery](gameperf07.md)
+ [Process and culture](gameperf08.md)
