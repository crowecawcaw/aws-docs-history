...
<a name="implementation-guidance-38"></a>
 ...
 When designing your game server hosting architecture for resiliency, deploy your fleets of game servers uniformly across the Availability Zones within an AWS Region to maximize your access to available compute capacity in the Region as well as reduce the impact scope of Availability Zone impairments. For example, you can configure [Amazon EC2 Auto Scaling](https://docs.aws.amazon.com/autoscaling/ec2/userguide/auto-scaling-benefits.html) to use the Availability Zones. If an EC2 instance becomes unhealthy, EC2 Auto Scaling can replace the instance, as well as launch instances into other Availability Zones if one or more of the Availability Zones becomes unavailable. 
