...
+  [Lambda - Using service integrations and asynchronous processing](https://docs.aws.amazon.com/lambda/latest/operatorguide/integrations-asynchronous.html) 