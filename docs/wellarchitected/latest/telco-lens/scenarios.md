...
**Topics**
+ [5G core deployment on AWS](g-core-deployment-on-aws.md)
+ [Modernizing IMS networks on AWS](modernizing-ims-networks-on-aws.md)
+ [Automatic lifecycle management of telco network functions](automatic-lifecycle-management-of-telco-network-functions.md)
+ [Ingest NF packages into AWS TNB function catalog](ingest-nf-packages-into-aws-tnb-function-catalog.md)
+ [Ingest network service descriptor (NSD) into AWS TNB network catalog](ingest-network-service-descriptor-nsd-into-aws-tnb-network-catalog.md)
+ [Create network instance (NI) and initiate deployment](create-network-instance-ni-and-initiate-deployment.md)
+ [Automated infrastructure provisioning](automated-infrastructure-provisioning.md)
+ [Automated NF installation and configuration](automated-nf-installation-and-configuration.md)
+ [Ongoing lifecycle management](ongoing-lifecycle-management.md)