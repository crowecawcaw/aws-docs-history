...
<a name="imp-guidance-telcosec01-bp01"></a>
...
<a name="imp-steps-telcosec01-bp01"></a>
...
For more detail, see [Enhancing telecom security with AWS](https://aws.amazon.com/blogs/security/enhancing-telecom-security-with-aws/).
