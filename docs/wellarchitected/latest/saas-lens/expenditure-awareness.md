...
| SaaS COST 1: How do you measure the resource consumption of<br>individual tenants? |
| ---------------------------------------------------------------------------------- |
|                                                                                    |
...
| SaaS COST 2: How are you correlating tenant consumption with<br>the costs of your infrastructure? |
| ------------------------------------------------------------------------------------------------- |
|                                                                                                   |
...
The high-level view of this experience is captured in Figure 28. You’ll see that we have two distinct sets of data that we
