...
| SaaS REL 1: How do you limit an individual tenant’s ability to<br>impose load that might impact availability for other tenants<br>of your system? |
| ------------------------------------------------------------------------------------------------------------------------------------------------- |
|                                                                                                                                                   |
...
the experience of _all_ of your customers.
...
can ensure that _all_ tenants are prevented
...
| SaaS REL 3: How are you testing the multi-tenant capabilities<br>of your SaaS application? |
| ------------------------------------------------------------------------------------------ |
|                                                                                            |
