...
**Note**  
The numbering of the questions in this whitepaper has been changed to match the order in the SaaS Lens of the [AWS Well-Architected Tool](https://console.aws.amazon.com/wellarchitected/). **SaaS OPS 2** is described in the following best practice, [Evolve](oe-evolve.md).
