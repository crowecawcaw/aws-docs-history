...
| SaaS OPS 1: How are you able to effectively monitor and manage<br>the operational health of a multi-tenant environment? |
| ----------------------------------------------------------------------------------------------------------------------- |
|                                                                                                                         |
...
![Tenant-aware operations views](images/image13.png)
_Figure 12: Tenant-aware operations views_
...
order in the SaaS Lens of the [AWS Well-Architected Tool](https://console.aws.amazon.com/wellarchitected/ "https://console.aws.amazon.com/wellarchitected/"). **SaaS OPS 2** is described in the
following best practice, [Evolve](oe-evolve.md "oe-evolve.md").
...
![Flowchart showing registration process with user management, tenant management, and billing integration.](images/image14.png)
_Figure 13: Frictionless tenant onboarding_
...
| SaaS OPS 4: How do you support the need for tenant-specific<br>customizations? |
| ------------------------------------------------------------------------------ |
|                                                                                |
...
makes them available to _all_ customers.
...
![Tenant configuration diagram showing feature enablement for different tenants using on/off switches.](images/image15.png)
_Figure 14: Managing tenant needs with feature flags_
