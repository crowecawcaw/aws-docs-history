...
| SaaS SEC 1: How are you associating tenant context with users<br>and applying that context within your SaaS architecture? |
| ------------------------------------------------------------------------------------------------------------------------- |
|                                                                                                                           |
...
tenant is informally referred to as a _SaaS
identity_. The key attribute of the SaaS identity is
