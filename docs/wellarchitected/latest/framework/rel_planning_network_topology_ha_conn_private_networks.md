...
- Use AWS Transit Gateway, when possible, to end your
  [VPN
  connection](../../../vpc/latest/tgw/tgw-vpn-attachments.md "../../../vpc/latest/tgw/tgw-vpn-attachments.md").
- Evaluate AWS Marketplace appliances to end VPNs or
  [extend
  your SD-WAN to AWS](../../../whitepapers/latest/aws-vpc-connectivity-options/aws-transit-gateway-sd-wan.md "../../../whitepapers/latest/aws-vpc-connectivity-options/aws-transit-gateway-sd-wan.md").
...
- [Using
  ...
  Failover](../../../vpn/latest/s2svpn/VPNConnections.md "../../../vpn/latest/s2svpn/VPNConnections.md")
- [Routing
  policies and BGP communities](../../../directconnect/latest/UserGuide/routing-and-bgp.md "../../../directconnect/latest/UserGuide/routing-and-bgp.md")
- [Active/Active
...
- [What
  is AWS Site-to-Site VPN?](../../../AmazonVPC/latest/UserGuide/VPC_VPN.md "../../../AmazonVPC/latest/UserGuide/VPC_VPN.md")
- [Working with Direct
  Connect gateways](../../../directconnect/latest/UserGuide/direct-connect-gateways.md "../../../directconnect/latest/UserGuide/direct-connect-gateways.md")

**Related videos:**

- [AWS re:Invent
  2018: Advanced VPC Design and New Capabilities for Amazon VPC](https://youtu.be/fnxXNZdf6ew "https://youtu.be/fnxXNZdf6ew")
- [AWS re:Invent
