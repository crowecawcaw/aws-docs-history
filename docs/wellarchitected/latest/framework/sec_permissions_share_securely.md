...
see [SEC03-BP07 Analyze public and cross-account access](sec_permissions_analyze_cross_account.md "sec_permissions_analyze_cross_account.md").
...
[Analyze public and cross-account access](../security-pillar/sec_permissions_analyze_cross_account.md "../security-pillar/sec_permissions_analyze_cross_account.md")
...
[AWS Network Firewall](../../../ram/latest/userguide/shareable.md#shareable-network-firewall "../../../ram/latest/userguide/shareable.md#shareable-network-firewall"),
or [Amazon SageMaker AI pipelines](../../../ram/latest/userguide/shareable.md#shareable-sagemaker "../../../ram/latest/userguide/shareable.md#shareable-sagemaker").

To restrict your account to only share resources within your organization, use
[service control policies (SCPs)](../../../ram/latest/userguide/scp.md "../../../ram/latest/userguide/scp.md")
to prevent access to external principals. When sharing resources, combine identity-based controls and
network controls to [create a data perimeter for your organization](../../../whitepapers/latest/building-a-data-perimeter-on-aws/building-a-data-perimeter-on-aws.md "../../../whitepapers/latest/building-a-data-perimeter-on-aws/building-a-data-perimeter-on-aws.md")
...
[SCPs do not apply to service-linked roles or AWS service principals](../../../organizations/latest/userguide/orgs_manage_policies_scps.md#scp-effects-on-permissions "../../../organizations/latest/userguide/orgs_manage_policies_scps.md#scp-effects-on-permissions").

When using Amazon S3,
[turn off ACLs for your Amazon S3 bucket](../../../AmazonS3/latest/userguide/about-object-ownership.md "../../../AmazonS3/latest/userguide/about-object-ownership.md")
and use IAM policies to define access control. For [restricting access to an Amazon S3 origin](../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md "../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md")
from [Amazon CloudFront](https://aws.amazon.com/cloudfront/ "https://aws.amazon.com/cloudfront/"), migrate from origin access identity (OAI) to origin access
...
see [Permissions management](../security-pillar/permissions-management.md "../security-pillar/permissions-management.md").

### Implementation steps

1. **Use AWS Organizations:** AWS Organizations is an account management service that allows you to consolidate multiple AWS accounts
...
2. **Integrate AWS Organizations with AWS services:** When you use an AWS service to perform tasks on your behalf in the member accounts of your organization,
   ...
   turning on trusted access, see [Using AWS Organizations with other AWS services](../../../organizations/latest/userguide/orgs_integrate_services.md "../../../organizations/latest/userguide/orgs_integrate_services.md")
   and [AWS services
   that you can use with Organizations](../../../organizations/latest/userguide/orgs_integrate_services_list.md "../../../organizations/latest/userguide/orgs_integrate_services_list.md").
3. **Establish a data
   ...
   [Building
   a Perimeter on AWS whitepaper](../../../whitepapers/latest/building-a-data-perimeter-on-aws/welcome.md "../../../whitepapers/latest/building-a-data-perimeter-on-aws/welcome.md") based on your specific
...
4. **Use resource sharing in AWS services and restrict accordingly:** Many AWS services allow you to share resources with another account, or target a resource in another
   account, such as [Amazon Machine Images (AMIs)](../../../AWSEC2/latest/UserGuide/AMIs.md "../../../AWSEC2/latest/UserGuide/AMIs.md")
   and [AWS Resource Access Manager (AWS RAM)](../../../ram/latest/userguide/getting-started-sharing.md "../../../ram/latest/userguide/getting-started-sharing.md").
   ...
   considerations, see [Resource sharing and external targets](../../../whitepapers/latest/building-a-data-perimeter-on-aws/perimeter-implementation.md "../../../whitepapers/latest/building-a-data-perimeter-on-aws/perimeter-implementation.md").
5. **Use AWS RAM to share securely in an account or with other AWS accounts:** [AWS RAM](https://aws.amazon.com/ram/ "https://aws.amazon.com/ram/") helps you securely share the resources that you have
...
[`PromoteResourceShareCreatedFromPolicy` API](../../../ram/latest/APIReference/API_PromoteResourceShareCreatedFromPolicy.md "../../../ram/latest/APIReference/API_PromoteResourceShareCreatedFromPolicy.md")
...
to share an encrypted snapshot, you need to [share a AWS KMS key](../../../AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.md#share-kms-key "../../../AWSEC2/latest/UserGuide/ebs-modifying-snapshot-permissions.md#share-kms-key").
...
- [Bucket owner granting cross-account permission to objects it does not
  own](../../../AmazonS3/latest/userguide/example-walkthroughs-managing-access-example4.md "../../../AmazonS3/latest/userguide/example-walkthroughs-managing-access-example4.md")
- [How to use Trust
  Policies with IAM](https://aws.amazon.com/blogs/security/how-to-use-trust-policies-with-iam-roles/ "https://aws.amazon.com/blogs/security/how-to-use-trust-policies-with-iam-roles/")
- [Building Data Perimeter on AWS](../../../whitepapers/latest/building-a-data-perimeter-on-aws/building-a-data-perimeter-on-aws.md "../../../whitepapers/latest/building-a-data-perimeter-on-aws/building-a-data-perimeter-on-aws.md")
- [How to use
  an external ID when granting a third party access to your AWS resources](../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md "../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md")
- [AWS services you can use with AWS Organizations](../../../organizations/latest/userguide/orgs_integrate_services_list.md "../../../organizations/latest/userguide/orgs_integrate_services_list.md")
- [Establishing a data perimeter on AWS: Allow only trusted identities to access company data](https://aws.amazon.com/blogs/security/establishing-a-data-perimeter-on-aws-allow-only-trusted-identities-to-access-company-data/ "https://aws.amazon.com/blogs/security/establishing-a-data-perimeter-on-aws-allow-only-trusted-identities-to-access-company-data/")

**Related videos:**

- [Granular Access with
  AWS Resource Access Manager](https://www.youtube.com/watch?v=X3HskbPqR2s "https://www.youtube.com/watch?v=X3HskbPqR2s")
- [Securing your data perimeter
  with VPC endpoints](https://www.youtube.com/watch?v=iu0-o6hiPpI "https://www.youtube.com/watch?v=iu0-o6hiPpI")
- [Establishing a data
  perimeter on AWS](https://www.youtube.com/watch?v=SMi5OBjp1fI "https://www.youtube.com/watch?v=SMi5OBjp1fI")

**Related tools:**

- [Data Perimeter Policy Examples](https://github.com/aws-samples/data-perimeter-policy-examples "https://github.com/aws-samples/data-perimeter-policy-examples")
