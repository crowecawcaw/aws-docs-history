...
![A flowchart that describes the options you should consider when determining if you need deterministic performance in your networking or not.](http://docs.aws.amazon.com/wellarchitected/latest/framework/images/deterministic-networking-flowchart.png)
