...
2. **Deploy the
   [CloudWatch
   agent](https://aws.amazon.com/cloudwatch/ "https://aws.amazon.com/cloudwatch/"):** The CloudWatch agent is
...
3. **Implement anomaly detection for logs
   and metrics:** Use
   [CloudWatch Logs anomaly detection](../../../AmazonCloudWatch/latest/logs/LogsAnomalyDetection.md "../../../AmazonCloudWatch/latest/logs/LogsAnomalyDetection.md") and
   [CloudWatch
   Metrics anomaly detection](../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.md") to automatically identify
...
4. **Secure sensitive log
   data:** Use
   [Amazon CloudWatch Logs data protection](../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md "../../../AmazonCloudWatch/latest/logs/mask-sensitive-log-data.md") to mask sensitive
...
5. **Define and monitor business
   KPIs:** Establish
   [custom
   metrics](../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md "../../../AmazonCloudWatch/latest/monitoring/publishingMetrics.md") that align with your
   [business
   outcomes](https://aws-observability.github.io/observability-best-practices/guides/operational/business/monitoring-for-business-outcomes/ "https://aws-observability.github.io/observability-best-practices/guides/operational/business/monitoring-for-business-outcomes/").
6. **Instrument your application with AWS X-Ray:** In addition to deploying the CloudWatch
   agent, it's crucial to
   [instrument
   your application](../../../xray/latest/devguide/xray-instrumenting-your-app.md "../../../xray/latest/devguide/xray-instrumenting-your-app.md") to emit trace data. This process can
   provide further insights into your workload's behavior and
   performance.
7. **Standardize data collection across
...
8. **Implement cross-account
   observability:** Enhance monitoring efficiency
   across multiple AWS accounts with
   [Amazon CloudWatch cross-account observability](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.md"). With this
...
9. **Analyze and act on the
   data:** Once data collection and normalization are
   in place, use
   [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/features/ "https://aws.amazon.com/cloudwatch/features/") for metrics and logs analysis, and
   [AWS X-Ray](https://aws.amazon.com/xray/features/ "https://aws.amazon.com/xray/features/") for trace analysis. Such analysis can yield
...
- [OPS04-BP04
  Implement dependency telemetry](../operational-excellence-pillar/ops_observability_dependency_telemetry.md "../operational-excellence-pillar/ops_observability_dependency_telemetry.md")
- [OPS04-BP05
...
- [CloudWatch
  User Guide](../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md "../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md")
- [AWS X-Ray Developer Guide](../../../xray/latest/devguide/aws-xray.md "../../../xray/latest/devguide/aws-xray.md")
- [Instrumenting
  distributed systems for operational visibility](https://aws.amazon.com/builders-library/instrumenting-distributed-systems-for-operational-visibility "https://aws.amazon.com/builders-library/instrumenting-distributed-systems-for-operational-visibility")
...
- [What's
  New with Amazon CloudWatch](https://aws.amazon.com/about-aws/whats-new/management-and-governance/?whats-new-content.sort-by=item.additionalFields.postDateTime&whats-new-content.sort-order=desc&awsf.whats-new-products=general-products%23amazon-cloudwatch "https://aws.amazon.com/about-aws/whats-new/management-and-governance/?whats-new-content.sort-by=item.additionalFields.postDateTime&whats-new-content.sort-order=desc&awsf.whats-new-products=general-products%23amazon-cloudwatch")
- [What's
  new with AWS X-Ray](https://aws.amazon.com/about-aws/whats-new/developer-tools/?whats-new-content.sort-by=item.additionalFields.postDateTime&whats-new-content.sort-order=desc&awsf.whats-new-products=general-products%23aws-x-ray "https://aws.amazon.com/about-aws/whats-new/developer-tools/?whats-new-content.sort-by=item.additionalFields.postDateTime&whats-new-content.sort-order=desc&awsf.whats-new-products=general-products%23aws-x-ray")

**Related videos:**

- [AWS re:Invent
  2022 - Observability best practices at Amazon](https://youtu.be/zZPzXEBW4P8 "https://youtu.be/zZPzXEBW4P8")
- [AWS re:Invent
  2022 - Developing an observability strategy](https://youtu.be/Ub3ATriFapQ "https://youtu.be/Ub3ATriFapQ")

**Related examples:**

- [One
  Observability Workshop](https://catalog.workshops.aws/observability "https://catalog.workshops.aws/observability")
- [AWS Solutions Library: Application Monitoring with Amazon CloudWatch](https://aws.amazon.com/solutions/implementations/application-monitoring-with-cloudwatch "https://aws.amazon.com/solutions/implementations/application-monitoring-with-cloudwatch")
