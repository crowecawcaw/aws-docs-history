...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The more efficient storage solution for a system varies based on the kind of<br>access operation (block, file, or object), patterns of access (random or<br>sequential), required throughput, frequency of access (online, offline,<br>archival), frequency of update (WORM, dynamic), and availability and durability<br>constraints. Well-architected systems use multiple storage solutions and turn on<br>different features to improve performance and use resources efficiently. |
