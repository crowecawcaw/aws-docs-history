...
- [OPS11-BP08
  Document and share lessons learned](../operational-excellence-pillar/ops_evolve_ops_share_lessons_learned.md "../operational-excellence-pillar/ops_evolve_ops_share_lessons_learned.md")
- [OPS04
  Implement Observability](../operational-excellence-pillar/ops_evolve_ops_process_cont_imp.md "../operational-excellence-pillar/ops_evolve_ops_process_cont_imp.md")

**Related documents:**

- [AWS Well-Architected Tool - Custom lenses](../userguide/lenses-custom.md "../userguide/lenses-custom.md")
- [AWS Well-Architected Whitepaper - The review process](the-review-process.md "the-review-process.md")
- [Customize
