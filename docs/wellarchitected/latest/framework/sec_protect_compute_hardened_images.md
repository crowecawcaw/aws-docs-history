...
[Center for Internet
Security](https://www.cisecurity.org/ "https://www.cisecurity.org/") (CIS) and the Defense Information Systems Agency
(DISA) [Security
Technical Implementation Guides (STIGs)](https://public.cyber.mil/stigs/ "https://public.cyber.mil/stigs/"). We recommend you
start with an
[Amazon
Machine Image](../../../AWSEC2/latest/UserGuide/AMIs.md "../../../AWSEC2/latest/UserGuide/AMIs.md") (AMI) published by AWS or an APN partner, and
use the AWS [EC2 Image Builder](https://aws.amazon.com/image-builder/ "https://aws.amazon.com/image-builder/") to automate configuration according to an
...
[public
repository](https://gallery.ecr.aws/docker "https://gallery.ecr.aws/docker"). You can use EC2 Image Builder to harden
container images alongside AMIs.

Similar to operating systems and container images, you can obtain
code packages (or _libraries_) from public
...
[AWS CodeArtifact](https://aws.amazon.com/codeartifact/ "https://aws.amazon.com/codeartifact/"), with trusted public repositories. This
...
[Lambda
layers.](../../../lambda/latest/dg/chapter-layers.md "../../../lambda/latest/dg/chapter-layers.md") Use Lambda layers to configure a set of standard
...
- Harden operating systems. Use base images from trusted sources
  ...
  [EC2 Image Builder](https://aws.amazon.com/image-builder/ "https://aws.amazon.com/image-builder/") to help customize the software installed
  on your images.
- Harden containerized resources. Configure containerized
  resources to meet security best practices. When using
  containers, implement
  [ECR
  Image Scanning](../../../AmazonECR/latest/userguide/image-scanning.md "../../../AmazonECR/latest/userguide/image-scanning.md") in your build pipeline and on a regular
  basis against your image repository to look for CVEs in your
  containers.
- When using serverless implementation with AWS Lambda, use
  [Lambda
  layers](../../../lambda/latest/dg/chapter-layers.md "../../../lambda/latest/dg/chapter-layers.md") to segregate application function code and
  shared dependent libraries. Configure
  [code
  signing](../../../lambda/latest/dg/configuration-codesigning.md "../../../lambda/latest/dg/configuration-codesigning.md") for Lambda to make sure that only trusted code
...
- [OPS05-BP05
  Perform patch management](ops_dev_integ_patch_mgmt.md "ops_dev_integ_patch_mgmt.md")

**Related videos:**

- [Deep
  dive into AWS Lambda security](https://www.youtube.com/watch?v=FTwsMYXWGB0 "https://www.youtube.com/watch?v=FTwsMYXWGB0")

**Related examples:**

- [Quickly
  build STIG-compliant AMI using EC2 Image Builder](https://aws.amazon.com/blogs/security/quickly-build-stig-compliant-amazon-machine-images-using-amazon-ec2-image-builder/ "https://aws.amazon.com/blogs/security/quickly-build-stig-compliant-amazon-machine-images-using-amazon-ec2-image-builder/")
- [Building
  better container images](https://aws.amazon.com/blogs/containers/building-better-container-images/ "https://aws.amazon.com/blogs/containers/building-better-container-images/")
- [Using
  Lambda layers to simplify your development process](https://aws.amazon.com/blogs/compute/using-lambda-layers-to-simplify-your-development-process/ "https://aws.amazon.com/blogs/compute/using-lambda-layers-to-simplify-your-development-process/")
- [Develop
  & Deploy AWS Lambda Layers using Serverless
  Framework](https://github.com/aws-samples/aws-serverless-lambda-layers "https://github.com/aws-samples/aws-serverless-lambda-layers")
- [Building
