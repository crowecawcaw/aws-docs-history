...
1. Plan your network. Determine which networks you want to
   connect, and verify that they don't share overlapping CIDR
   ranges.
2. Create an AWS Transit Gateway and attach your VPCs.
3. If needed, create VPN connections or Direct Connect
   gateways, and associate them with the Transit Gateway.
4. Define how traffic is routed between the connected VPCs and
   other connections through configuration of your Transit
   Gateway route tables.
5. Use Amazon CloudWatch to monitor and adjust configurations
...
- [REL02-BP03
  ...
  availability](../reliability-pillar/rel_planning_network_topology_ip_subnet_allocation.md "../reliability-pillar/rel_planning_network_topology_ip_subnet_allocation.md")
- [REL02-BP05
  Enforce non-overlapping private IP address ranges in all
  private address spaces where they are connected](../reliability-pillar/rel_planning_network_topology_non_overlap_ip.md "../reliability-pillar/rel_planning_network_topology_non_overlap_ip.md")
...
- [Transit
  gateway design best practices](../../../vpc/latest/tgw/tgw-best-design-practices.md "../../../vpc/latest/tgw/tgw-best-design-practices.md")
- [Building
...
- [Building
  ...
  peering](https://aws.amazon.com/blogs/networking-and-content-delivery/building-a-global-network-using-aws-transit-gateway-inter-region-peering/ "https://aws.amazon.com/blogs/networking-and-content-delivery/building-a-global-network-using-aws-transit-gateway-inter-region-peering/")
- [Amazon Virtual Private Cloud Connectivity Options](../../../whitepapers/latest/aws-vpc-connectivity-options/introduction.md "../../../whitepapers/latest/aws-vpc-connectivity-options/introduction.md")
- [APN
...
- [AWS re:Invent 2023 - Advanced VPC designs and new
  capabilities](https://www.youtube.com/watch?v=cRdDCkbE4es "https://www.youtube.com/watch?v=cRdDCkbE4es")

**Related workshops:**

- [AWS Transit Gateway Workshop](https://catalog.workshops.aws/trasitgw/en-US "https://catalog.workshops.aws/trasitgw/en-US")
