...
- [SEC07-BP04 Define data lifecycle management](sec_data_classification_lifecycle_management.md "sec_data_classification_lifecycle_management.md")
- [SEC08-BP04 Enforce access control](sec_protect_data_rest_access_control.md "sec_protect_data_rest_access_control.md")
- [OPS08-BP02
  Analyze workload logs](ops_workload_observability_analyze_workload_logs.md "ops_workload_observability_analyze_workload_logs.md")
