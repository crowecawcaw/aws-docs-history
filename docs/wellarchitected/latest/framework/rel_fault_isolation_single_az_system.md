...
provision [multiple
nodes](../../../emr/latest/ManagementGuide/emr-plan-ha-launch.md "../../../emr/latest/ManagementGuide/emr-plan-ha-launch.md").
Using [EMR
File System (EMRFS)](../../../emr/latest/ManagementGuide/emr-fs.md "../../../emr/latest/ManagementGuide/emr-fs.md"), data in EMR can be stored in Amazon S3,
...
1. Implement self-healing. Deploy your instances or containers using
   ...
   - Protect stateful workloads that are limited to a single location using [AWS Elastic Disaster Recovery](../../../drs/latest/userguide/what-is-drs.md "../../../drs/latest/userguide/what-is-drs.md").

## Resources

**Related documents:**

- [Amazon ECS events](../../../AmazonECS/latest/developerguide/ecs_cwe_events.md "../../../AmazonECS/latest/developerguide/ecs_cwe_events.md")
- [Amazon EC2 Auto Scaling lifecycle hooks](../../../autoscaling/ec2/userguide/lifecycle-hooks.md "../../../autoscaling/ec2/userguide/lifecycle-hooks.md")
- [Recover
  your instance.](../../../AWSEC2/latest/UserGuide/ec2-instance-recover.md "../../../AWSEC2/latest/UserGuide/ec2-instance-recover.md")
- [Service
  automatic scaling](../../../AmazonECS/latest/developerguide/service-auto-scaling.md "../../../AmazonECS/latest/developerguide/service-auto-scaling.md")
- [What
