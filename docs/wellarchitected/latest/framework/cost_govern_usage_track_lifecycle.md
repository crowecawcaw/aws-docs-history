...
with
[myApplications](../../../awsconsolehelpdocs/latest/gsg/aws-myApplications.md "../../../awsconsolehelpdocs/latest/gsg/aws-myApplications.md")
...
[AWS Config](https://aws.amazon.com/config/ "https://aws.amazon.com/config/") or
[AWS Systems Manager](https://aws.amazon.com/systems-manager/ "https://aws.amazon.com/systems-manager/") to provide a detailed inventory
...
Similar to
[Application
Lifecycle Management (ALM)](https://aws.amazon.com/what-is/application-lifecycle-management/ "https://aws.amazon.com/what-is/application-lifecycle-management/"), tracking project lifecycle
...
whitepaper](https://aws.amazon.com/architecture/well-architected/ "https://aws.amazon.com/architecture/well-architected/").
...
- **Establish project lifecycle
  monitoring process:**
  [The
  Cloud Center of Excellence team](../cost-optimization-pillar/cost_cloud_financial_management_function.md "../cost-optimization-pillar/cost_cloud_financial_management_function.md") must establish
...
- [What
  Is ALM (Application Lifecycle Management)?](https://aws.amazon.com/what-is/application-lifecycle-management/ "https://aws.amazon.com/what-is/application-lifecycle-management/")
...
- [AWS CloudFormation](https://aws.amazon.com/cloudformation/?c=mg&sec=srv "https://aws.amazon.com/cloudformation/?c=mg&sec=srv")
