...
- Consider other connected networks (VPC, on-premises, or other cloud providers) and
  ...
  spaces where they are connected.](../reliability-pillar/rel_planning_network_topology_non_overlap_ip.md "../reliability-pillar/rel_planning_network_topology_non_overlap_ip.md")
