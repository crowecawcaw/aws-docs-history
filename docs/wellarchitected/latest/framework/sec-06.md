...
- [SEC06-BP03 Reduce manual management and interactive access](sec_protect_compute_reduce_manual_management.md "sec_protect_compute_reduce_manual_management.md")
