...
- [Amazon CloudFront](https://aws.amazon.com/cloudfront/ "https://aws.amazon.com/cloudfront/") is a global content delivery
...
- [VPC
  Endpoints](../../../vpc/latest/userguide/vpc-endpoints.md "../../../vpc/latest/userguide/vpc-endpoints.md") allow connectivity between AWS
  services over private networking and can be used to reduce
  public data transfer and
  [NAT
  gateway](../../../vpc/latest/userguide/vpc-nat-gateway.md "../../../vpc/latest/userguide/vpc-nat-gateway.md") costs.
  [Gateway
  VPC endpoints](../../../vpc/latest/userguide/vpce-gateway.md "../../../vpc/latest/userguide/vpce-gateway.md") have no hourly charges, and
  support Amazon S3 and Amazon DynamoDB.
  [Interface
  VPC endpoints](../../../vpc/latest/userguide/vpce-interface.md "../../../vpc/latest/userguide/vpce-interface.md") are provided by
  [AWS PrivateLink](../../../vpc/latest/userguide/endpoint-service.md "../../../vpc/latest/userguide/endpoint-service.md") and have an hourly fee and per-GB usage cost.
- [NAT
  gateways](../../../vpc/latest/userguide/vpc-nat-gateway.md "../../../vpc/latest/userguide/vpc-nat-gateway.md") provide built-in scaling and management
...
- Use [AWS Snow Family](https://aws.amazon.com/snow/ "https://aws.amazon.com/snow/") devices which have computing resources to
  collect and process data at the edge. AWS Snow Family devices
  ([Snowball Edge](https://aws.amazon.com/snowcone/ "https://aws.amazon.com/snowcone/"),
  [Snowball Edge](https://aws.amazon.com/snowball/ "https://aws.amazon.com/snowball/")
  and
  [Snowmobile](https://aws.amazon.com/snowmobile/ "https://aws.amazon.com/snowmobile/"))
...
- [AWS Explore Our
  Products](https://aws.amazon.com/ "https://aws.amazon.com/")
...
- [Amazon CloudFront Security Savings Bundle](https://aws.amazon.com/about-aws/whats-new/2021/02/introducing-amazon-cloudfront-security-savings-bundle/ "https://aws.amazon.com/about-aws/whats-new/2021/02/introducing-amazon-cloudfront-security-savings-bundle/")

**Related videos:**

- [Monitoring
  and Optimizing Your Data Transfer Costs](https://www.youtube.com/watch?v=UjliYz25_qo "https://www.youtube.com/watch?v=UjliYz25_qo")
- [AWS Cost Optimization Series: CloudFront](https://www.youtube.com/watch?v=k8De2AfAN3k "https://www.youtube.com/watch?v=k8De2AfAN3k")
- [How
  can I reduce data transfer charges for my NAT gateway?](https://www.youtube.com/watch?v=hq4KtPRezus "https://www.youtube.com/watch?v=hq4KtPRezus")

**Related examples:**

- [How-to
  chargeback shared services: An AWS Transit Gateway
  example](https://aws.amazon.com/blogs/aws-cloud-financial-management/gs-chargeback-shared-services-an-aws-transit-gateway-example/ "https://aws.amazon.com/blogs/aws-cloud-financial-management/gs-chargeback-shared-services-an-aws-transit-gateway-example/")
- [Understand
  AWS data transfer details in depth from cost and usage report
  using Athena query and QuickSight](https://aws.amazon.com/blogs/networking-and-content-delivery/understand-aws-data-transfer-details-in-depth-from-cost-and-usage-report-using-athena-query-and-quicksight/ "https://aws.amazon.com/blogs/networking-and-content-delivery/understand-aws-data-transfer-details-in-depth-from-cost-and-usage-report-using-athena-query-and-quicksight/")
- [Overview
...
- [How
  can I reduce data transfer charges for my NAT gateway?](https://aws.amazon.com/premiumsupport/knowledge-center/vpc-reduce-nat-gateway-transfer-costs/ "https://aws.amazon.com/premiumsupport/knowledge-center/vpc-reduce-nat-gateway-transfer-costs/")
