...
- **Iterate and improve:** Use an
  [iterative
  improvement process](../sustainability-pillar/improvement-process.md "../sustainability-pillar/improvement-process.md") to identify, evaluate, prioritize,
...
- [AWS re:Invent 2023 - What's new with AWS observability and
  operations](https://www.youtube.com/watch?v=E8qQBMDJjso "https://www.youtube.com/watch?v=E8qQBMDJjso")
