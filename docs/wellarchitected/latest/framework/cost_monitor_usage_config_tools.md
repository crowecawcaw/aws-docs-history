...
You can use
[AWS Cost Optimization Hub](https://aws.amazon.com/aws-cost-management/cost-optimization-hub/ "https://aws.amazon.com/aws-cost-management/cost-optimization-hub/") to understand potential cost-saving
...
[AWS ProServ](https://aws.amazon.com/professional-services/ "https://aws.amazon.com/professional-services/"),
[AWS Managed Services (AMS)](https://aws.amazon.com/managed-services/ "https://aws.amazon.com/managed-services/"), or
[AWS Partners](https://aws.amazon.com/partners/ "https://aws.amazon.com/partners/"). You can also use third-party tools but
...
- **Allow team-based access to
  ...
  [AWS Identity and Access Management](https://aws.amazon.com/iam/ "https://aws.amazon.com/iam/") to
  [control
  access](../../../cost-management/latest/userguide/ce-access.md "../../../cost-management/latest/userguide/ce-access.md") to the tools such as AWS Cost Explorer. These groups must include representatives from all
...
- **Configure AWS Budgets:**
  [Configure
  AWS Budgets](../../../cost-management/latest/userguide/budgets-managing-costs.md "../../../cost-management/latest/userguide/budgets-managing-costs.md") on all accounts for your
...
- **Configure AWS Cost Anomaly
  Detection:** Use
  [AWS Cost Anomaly Detection](https://aws.amazon.com/aws-cost-management/aws-cost-anomaly-detection/ "https://aws.amazon.com/aws-cost-management/aws-cost-anomaly-detection/") for your accounts,
...
- **Use cost analysis tools:**
  Configure
  [AWS Cost Explorer](https://aws.amazon.com/aws-cost-management/aws-cost-explorer/ "https://aws.amazon.com/aws-cost-management/aws-cost-explorer/") for your workload and
...
- [What
  is AWS Billing and Cost Management and Cost Management](../../../cost-management/latest/userguide/what-is-costmanagement.md "../../../cost-management/latest/userguide/what-is-costmanagement.md")?
- [Establishing
  your best practice AWS environment](https://aws.amazon.com/organizations/getting-started/best-practices/ "https://aws.amazon.com/organizations/getting-started/best-practices/")
- [Best
...
- [Tagging
  your AWS resources](../../../general/latest/gr/aws_tagging.md "../../../general/latest/gr/aws_tagging.md")
- [AWS Cost Categories](https://aws.amazon.com/aws-cost-management/aws-cost-categories/ "https://aws.amazon.com/aws-cost-management/aws-cost-categories/")
- [Analyzing
...
- [Analyzing
  your costs with AWS Cost Explorer](../../../awsaccountbilling/latest/aboutv2/cost-explorer-what-is.md "../../../awsaccountbilling/latest/aboutv2/cost-explorer-what-is.md")
- [What
  is AWS Data Exports](../../../cur/latest/userguide/what-is-data-exports.md "../../../cur/latest/userguide/what-is-data-exports.md")?

**Related videos:**

- [Deploying
  Cloud Intelligence Dashboards](https://www.youtube.com/watch?v=FhGZwfNJTnc "https://www.youtube.com/watch?v=FhGZwfNJTnc")
- [Get
  Alerts on any FinOps or Cost Optimization Metric or
  KPI](https://www.youtube.com/watch?v=dzRKDSXCtAs "https://www.youtube.com/watch?v=dzRKDSXCtAs")
