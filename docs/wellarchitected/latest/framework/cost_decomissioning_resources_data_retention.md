...
You can also implement custom code using the [API or SDK](https://aws.amazon.com/tools/ "https://aws.amazon.com/tools/") to
...
- [How to set lifecycle configuration on Amazon S3 bucket](../../../AmazonS3/latest/userguide/how-to-set-lifecycle-configuration-intro.md "../../../AmazonS3/latest/userguide/how-to-set-lifecycle-configuration-intro.md")

**Related videos:**

- [Automate Amazon EBS Snapshots with Amazon Data Lifecycle Manager](https://www.youtube.com/watch?v=RJpEjnVSdi4 "https://www.youtube.com/watch?v=RJpEjnVSdi4")
- [Empty an Amazon S3 bucket using a lifecycle configuration rule](https://www.youtube.com/watch?v=JfK9vamen9I "https://www.youtube.com/watch?v=JfK9vamen9I")

**Related examples:**

- [Empty an Amazon S3 bucket using a lifecycle configuration rule](https://aws.amazon.com/premiumsupport/knowledge-center/s3-empty-bucket-lifecycle-rule/ "https://aws.amazon.com/premiumsupport/knowledge-center/s3-empty-bucket-lifecycle-rule/")
