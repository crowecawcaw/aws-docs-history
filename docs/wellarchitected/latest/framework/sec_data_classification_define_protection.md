...
data at rest](../security-pillar/protecting-data-at-rest.md "../security-pillar/protecting-data-at-rest.md") and
[Protecting data in
transit](../security-pillar/protecting-data-in-transit.md "../security-pillar/protecting-data-in-transit.md") to implement relevant controls like encryption,
...
- [COST04-BP05
  Enforce data retention policies](cost_decomissioning_resources_data_retention.md "cost_decomissioning_resources_data_retention.md")
