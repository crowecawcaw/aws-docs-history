...
2. Work with business and technical stakeholders to evaluate
   ...
   1. **Business objectives and customer
      ...
      loss](../reliability-pillar/rel_planning_for_recovery_objective_defined_recovery.md "../reliability-pillar/rel_planning_for_recovery_objective_defined_recovery.md").
...
- [REL02-BP03
  ...
  availability](../reliability-pillar/rel_planning_network_topology_ip_subnet_allocation.md "../reliability-pillar/rel_planning_network_topology_ip_subnet_allocation.md")
- [REL11-BP05
  Use static stability to prevent bimodal behavior](../reliability-pillar/rel_withstand_component_failures_static_stability.md "../reliability-pillar/rel_withstand_component_failures_static_stability.md")
- [REL13-BP01
  Define recovery objectives for downtime and data loss](../reliability-pillar/rel_planning_for_recovery_objective_defined_recovery.md "../reliability-pillar/rel_planning_for_recovery_objective_defined_recovery.md")
