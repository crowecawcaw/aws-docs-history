...
![Tree diagram showing how to group multiple accounts under organizational units.](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/aws-organizations-ou-grouping.png)
