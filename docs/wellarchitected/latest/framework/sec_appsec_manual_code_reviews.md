...
Consider [Amazon CodeGuru Security](../../../codeguru/latest/reviewer-ug/welcome.md "../../../codeguru/latest/reviewer-ug/welcome.md")
...
- [Automate
  code reviews with Amazon CodeGuru Security](https://aws.amazon.com/blogs/devops/automate-code-reviews-with-amazon-codeguru-reviewer/ "https://aws.amazon.com/blogs/devops/automate-code-reviews-with-amazon-codeguru-reviewer/")
- [Automating
  detection of security vulnerabilities and bugs in CI/CD pipelines
  using Amazon CodeGuru Security CLI](https://aws.amazon.com/blogs/devops/automating-detection-of-security-vulnerabilities-and-bugs-in-ci-cd-pipelines-using-amazon-codeguru-reviewer-cli/ "https://aws.amazon.com/blogs/devops/automating-detection-of-security-vulnerabilities-and-bugs-in-ci-cd-pipelines-using-amazon-codeguru-reviewer-cli/")

**Related videos:**

- [Continuous
  improvement of code quality with Amazon CodeGuru
  Security](https://www.youtube.com/watch?v=iX1i35H1OVw "https://www.youtube.com/watch?v=iX1i35H1OVw")
