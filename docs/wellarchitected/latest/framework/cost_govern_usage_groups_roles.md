...
- **Implement groups:** Using the groups of users defined
  in your organizational policies, implement the corresponding groups, if necessary. For best practices on users, groups and authentication, see the [Security Pillar](../security-pillar/welcome.md "../security-pillar/welcome.md") of the AWS Well-Architected Framework.
- **Implement roles and policies:** Using the actions
  ...
  For best practices on roles and policies, see the [Security Pillar](../security-pillar/welcome.md "../security-pillar/welcome.md") of the AWS Well-Architected Framework.
...
- [AWS Well-Architected Framework
  Security Pillar](../security-pillar/welcome.md "../security-pillar/welcome.md")
- [AWS Identity and Access Management (IAM)](https://aws.amazon.com/iam/ "https://aws.amazon.com/iam/")
- [AWS Identity and Access Management policies](../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md "../../../IAM/latest/UserGuide/access_policies_managed-vs-inline.md")

**Related videos:**

- [Why use Identity and Access Management](https://www.youtube.com/watch?v=SXSqhTn2DuE "https://www.youtube.com/watch?v=SXSqhTn2DuE")
...
- [Starting your Cloud Financial Management journey: Cloud cost operations](https://aws.amazon.com/blogs/aws-cloud-financial-management/op-starting-your-cloud-financial-management-journey/ "https://aws.amazon.com/blogs/aws-cloud-financial-management/op-starting-your-cloud-financial-management-journey/")
