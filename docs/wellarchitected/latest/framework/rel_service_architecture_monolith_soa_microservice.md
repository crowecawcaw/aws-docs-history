...
![Diagram showing a comparison between monolithic, service-oriented, and microservices architectures](http://docs.aws.amazon.com/wellarchitected/latest/framework/images/monolith-soa-microservices-comparison.png)
