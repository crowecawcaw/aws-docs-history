...
using accounts](sec_securely_operate_multi_accounts.md "sec_securely_operate_multi_accounts.md"), you will end up with multiple AWS accounts
...
- [OPS05-BP01
  Use version control](ops_dev_integ_version_control.md "ops_dev_integ_version_control.md")
- [OPS05-BP04
  Use build and deployment management systems](ops_dev_integ_build_mgmt_sys.md "ops_dev_integ_build_mgmt_sys.md")
- [REL08-BP05
  Deploy changes with automation](rel_tracking_change_management_automated_changemgmt.md "rel_tracking_change_management_automated_changemgmt.md")
- [SUS06-BP01
  Adopt methods that can rapidly introduce sustainability
  improvements](sus_sus_dev_a2.md "sus_sus_dev_a2.md")
