...
1. Work with stakeholders in your organization to develop a
...
2. Instrument your application with the necessary tests based
   ...
   2. Use
      [Amazon CodeGuru Reviewer](../../../codeguru/latest/reviewer-ug/welcome.md "../../../codeguru/latest/reviewer-ug/welcome.md") to test your application code
      for defects.
   3. You can use
      [AWS CodeBuild](../../../codebuild/latest/userguide/welcome.md "../../../codebuild/latest/userguide/welcome.md") to conduct tests on software artifacts.
   4. [AWS CodePipeline](../../../codepipeline/latest/userguide/welcome.md "../../../codepipeline/latest/userguide/welcome.md") can orchestrate your software tests
      into a pipeline.
...
- [OPS05-BP01
  Use version control](../operational-excellence-pillar/ops_dev_integ_version_control.md "../operational-excellence-pillar/ops_dev_integ_version_control.md")
- [OPS05-BP06
  Share design standards](../operational-excellence-pillar/ops_dev_integ_share_design_stds.md "../operational-excellence-pillar/ops_dev_integ_share_design_stds.md")
- [OPS05-BP07
  Implement practices to improve code quality](../operational-excellence-pillar/ops_dev_integ_code_quality.md "../operational-excellence-pillar/ops_dev_integ_code_quality.md")
- [OPS05-BP10
  Fully automate integration and deployment](../operational-excellence-pillar/ops_dev_integ_auto_integ_deploy.md "../operational-excellence-pillar/ops_dev_integ_auto_integ_deploy.md")
...
- [Automated
  ...
  CodePipeline](https://aws.amazon.com/blogs/devops/automated-cloudformation-testing-pipeline-with-taskcat-and-codepipeline/ "https://aws.amazon.com/blogs/devops/automated-cloudformation-testing-pipeline-with-taskcat-and-codepipeline/")
- [Building
  end-to-end AWS DevSecOps CI/CD pipeline with open source SCA,
  SAST, and DAST tools](https://aws.amazon.com/blogs/devops/building-end-to-end-aws-devsecops-ci-cd-pipeline-with-open-source-sca-sast-and-dast-tools/ "https://aws.amazon.com/blogs/devops/building-end-to-end-aws-devsecops-ci-cd-pipeline-with-open-source-sca-sast-and-dast-tools/")
- [Getting
...
- [Practicing
  ...
  Whitepaper](../../../whitepapers/latest/practicing-continuous-integration-continuous-delivery/welcome.md "../../../whitepapers/latest/practicing-continuous-integration-continuous-delivery/welcome.md")
...
- [AWS re:Invent 2020: Testable infrastructure: Integration testing
  on AWS](https://www.youtube.com/watch?v=KJC380Juo2w "https://www.youtube.com/watch?v=KJC380Juo2w")
...
- [Testing
  Your Infrastructure as Code with AWS CDK](https://www.youtube.com/watch?v=fWtuwGSoSOU "https://www.youtube.com/watch?v=fWtuwGSoSOU")

**Related resources:**

- [AWS Deployment Pipeline Reference Architecture -
  Application](https://pipelines.devops.aws.dev/application-pipeline/index.html "https://pipelines.devops.aws.dev/application-pipeline/index.html")
- [AWS Kubernetes DevSecOps Pipeline](https://github.com/aws-samples/devsecops-cicd-containers "https://github.com/aws-samples/devsecops-cicd-containers")
- [Run
  unit tests for a Node.js application from GitHub by using AWS CodeBuild](../../../prescriptive-guidance/latest/patterns/run-unit-tests-for-a-node-js-application-from-github-by-using-aws-codebuild.md "../../../prescriptive-guidance/latest/patterns/run-unit-tests-for-a-node-js-application-from-github-by-using-aws-codebuild.md")
- [Use
  Serverspec for test-driven development of infrastructure
  code](../../../prescriptive-guidance/latest/patterns/use-serverspec-for-test-driven-development-of-infrastructure-code.md "../../../prescriptive-guidance/latest/patterns/use-serverspec-for-test-driven-development-of-infrastructure-code.md")
...
- [AWS CodeBuild](../../../codebuild/latest/userguide/welcome.md "../../../codebuild/latest/userguide/welcome.md")
