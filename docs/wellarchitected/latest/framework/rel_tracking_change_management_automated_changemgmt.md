...
of [continuous
integration and continuous delivery/deployment](https://en.wikipedia.org/wiki/CI/CD "https://en.wikipedia.org/wiki/CI/CD") (CI/CD),
...
- **Configure a continuous integration
  ...
  [Getting
  started with AWS CodeBuild using the console](../../../codebuild/latest/userguide/getting-started.md "../../../codebuild/latest/userguide/getting-started.md").
- **Set up a deployment service that
  ...
  manual deployments:**
  [AWS CodeDeploy](https://aws.amazon.com/codedeploy/ "https://aws.amazon.com/codedeploy/") automates software deployments to a
  variety of compute services, such as Amazon EC2,
  [AWS Fargate](https://aws.amazon.com/fargate/ "https://aws.amazon.com/fargate/"),
  [AWS Lambda](https://aws.amazon.com/lambda "https://aws.amazon.com/lambda"), and your on-premise servers. To configure
  these steps, see
  [Getting
  started with CodeDeploy](../../../codedeploy/latest/userguide/getting-started-codedeploy.md "../../../codedeploy/latest/userguide/getting-started-codedeploy.md").
- **Set up a continuous delivery service
  ...
  Consider using
  [AWS CodePipeline](../../../codepipeline/latest/userguide/getting-started-codepipeline.md "../../../codepipeline/latest/userguide/getting-started-codepipeline.md") to help you automate your release
  pipelines. For more detail, see
  [CodePipeline
  tutorials](../../../codepipeline/latest/userguide/tutorials.md "../../../codepipeline/latest/userguide/tutorials.md").
...
- [OPS05-BP04
  Use build and deployment management systems](../operational-excellence-pillar/ops_dev_integ_build_mgmt_sys.md "../operational-excellence-pillar/ops_dev_integ_build_mgmt_sys.md")
- [OPS05-BP10
...
- [OPS06-BP02
  Test deployments](../operational-excellence-pillar/ops_mit_deploy_risks_test_val_chg.md "../operational-excellence-pillar/ops_mit_deploy_risks_test_val_chg.md")
- [OPS06-BP04
  Automate testing and rollback](../operational-excellence-pillar/ops_mit_deploy_risks_auto_testing_and_rollback.md "../operational-excellence-pillar/ops_mit_deploy_risks_auto_testing_and_rollback.md")

**Related documents:**

- [Continuous
  Delivery of Nested AWS CloudFormation Stacks Using AWS CodePipeline](https://aws.amazon.com/blogs/devops/continuous-delivery-of-nested-aws-cloudformation-stacks-using-aws-codepipeline "https://aws.amazon.com/blogs/devops/continuous-delivery-of-nested-aws-cloudformation-stacks-using-aws-codepipeline")
- [APN
...
- [Automate
  chat messages with webhooks.](../../../chime/latest/ug/webhooks.md "../../../chime/latest/ug/webhooks.md")
- [The
  Amazon Builders' Library: Ensuring rollback safety during
  deployments](https://aws.amazon.com/builders-library/ensuring-rollback-safety-during-deployments "https://aws.amazon.com/builders-library/ensuring-rollback-safety-during-deployments")
- [The
  Amazon Builders' Library: Going faster with continuous
  delivery](https://aws.amazon.com/builders-library/going-faster-with-continuous-delivery/ "https://aws.amazon.com/builders-library/going-faster-with-continuous-delivery/")
- [What
  Is AWS CodePipeline?](../../../codepipeline/latest/userguide/welcome.md "../../../codepipeline/latest/userguide/welcome.md")
- [What
  Is CodeDeploy?](../../../codedeploy/latest/userguide/welcome.md "../../../codedeploy/latest/userguide/welcome.md")
...
- [What
  is Amazon SES?](../../../ses/latest/DeveloperGuide/Welcome.md "../../../ses/latest/DeveloperGuide/Welcome.md")
- [What
...
- [AWS Summit
  2019: CI/CD on AWS](https://youtu.be/tQcF6SqWCoY "https://youtu.be/tQcF6SqWCoY")
