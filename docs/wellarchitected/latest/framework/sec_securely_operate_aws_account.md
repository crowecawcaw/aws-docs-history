...
[specifically
require it](../../../general/latest/gr/aws_tasks-that-require-root.md "../../../general/latest/gr/aws_tasks-that-require-root.md"). The root user login credentials must be closely
...
1. Set up accurate [contact
   ...
   1. This information is used for the lost password recovery flow, lost MFA device
      ...
      team.
   2. Use an email address hosted by your corporate domain, preferably a distribution
   ...
   3. The phone number listed on the contact information should be a dedicated,
...
3. Determine if you need to store credentials for the root user.
   1. If you are using AWS Organizations to create new member accounts, the initial password
      ...
      management account to [gain access to the member account](../../../organizations/latest/userguide/orgs_manage_accounts_access.md#orgs_manage_accounts_access-as-root "../../../organizations/latest/userguide/orgs_manage_accounts_access.md#orgs_manage_accounts_access-as-root") if needed.
   2. For standalone AWS accounts or the management AWS Organization account,
...
5. If you need credentials for the root user:
   ...
   3. Consider hardware MFA devices for resiliency and security, as single use
   ...
   5. Store the password securely, and consider circular dependencies if storing the
...
6. Optional: Consider establishing a periodic password rotation schedule for the root
   ...
   - [Changing
     the root user password](../../../IAM/latest/UserGuide/id_credentials_passwords_change-root.md "../../../IAM/latest/UserGuide/id_credentials_passwords_change-root.md") on a periodic basis reduces the risk that an
     inadvertently exposed password can be misused.

**Detective controls**

- Create alarms to detect use of the root credentials (CIS 1.7). [Amazon GuardDuty](../../../guardduty/latest/ug/guardduty_settingup.md "../../../guardduty/latest/ug/guardduty_settingup.md") can monitor and alert on root user API credential usage through the
  [RootCredentialUsage](../../../guardduty/latest/ug/guardduty_finding-types-iam.md#policy-iam-rootcredentialusage "../../../guardduty/latest/ug/guardduty_finding-types-iam.md#policy-iam-rootcredentialusage") finding.
- Evaluate and implement the detective controls included in the [AWS Well-Architected Security Pillar conformance pack for AWS Config](../../../config/latest/developerguide/operational-best-practices-for-wa-Security-Pillar.md "../../../config/latest/developerguide/operational-best-practices-for-wa-Security-Pillar.md"), or if
  using AWS Control Tower, the [strongly
  recommended controls](../../../controltower/latest/userguide/strongly-recommended-controls.md "../../../controltower/latest/userguide/strongly-recommended-controls.md") available inside Control Tower.
...
- Periodically check that the email address associated with the account and those
  ...
  Contacts](../../../accounts/latest/reference/manage-acct-update-contact-alternate.md "../../../accounts/latest/reference/manage-acct-update-contact-alternate.md") work. Monitor these email inboxes for security notifications you
...
- Prepare incident response procedures to respond to root account misuse. Refer to
  the [AWS Security Incident Response Guide](../../../whitepapers/latest/aws-security-incident-response-guide/aws-security-incident-response-guide.md "../../../whitepapers/latest/aws-security-incident-response-guide/aws-security-incident-response-guide.md") and the best practices in
  the [Incident Response section of the Security Pillar whitepaper](../security-pillar/incident-response.md "../security-pillar/incident-response.md")
...
- [Amazon GuardDuty – root credential usage alert](../../../guardduty/latest/ug/guardduty_finding-types-iam.md#policy-iam-rootcredentialusage "../../../guardduty/latest/ug/guardduty_finding-types-iam.md#policy-iam-rootcredentialusage")
- [Step-by-step
  guidance on monitoring for root credential use through
  CloudTrail](../../../securityhub/latest/userguide/iam-controls.md#iam-20 "../../../securityhub/latest/userguide/iam-controls.md#iam-20")
- [MFA
  tokens approved for use with AWS](https://aws.amazon.com/iam/features/mfa/ "https://aws.amazon.com/iam/features/mfa/")
- Implementing [break
  glass access](../../../whitepapers/latest/organizing-your-aws-environment/break-glass-access.md "../../../whitepapers/latest/organizing-your-aws-environment/break-glass-access.md") on AWS
- [Top
  10 security items to improve in your AWS account](https://aws.amazon.com/blogs/security/top-10-security-items-to-improve-in-your-aws-account/ "https://aws.amazon.com/blogs/security/top-10-security-items-to-improve-in-your-aws-account/")
- [What
  do I do if I notice unauthorized activity in my AWS account?](https://aws.amazon.com/premiumsupport/knowledge-center/potential-account-compromise/ "https://aws.amazon.com/premiumsupport/knowledge-center/potential-account-compromise/")
...
- [Limiting use of AWS root
  credentials](https://youtu.be/SMjvtxXOXdU?t=979 "https://youtu.be/SMjvtxXOXdU?t=979") from AWS re:inforce 2022 – Security best practices with AWS
  IAM
