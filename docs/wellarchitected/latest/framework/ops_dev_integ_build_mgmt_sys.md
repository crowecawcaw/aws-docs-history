...
![Diagram showing a CI/CD pipeline using AWS CodePipeline and related services](http://docs.aws.amazon.com/wellarchitected/latest/framework/images/deployment-pipeline-tooling.png)
