...
![Diagram showing a CI/CD pipeline using AWS CodePipeline and related services](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/deployment-pipeline-tooling.png)
