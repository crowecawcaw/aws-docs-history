...
cross-account access](../security-pillar/sec_permissions_analyze_cross_account.md "../security-pillar/sec_permissions_analyze_cross_account.md").
...
[external
ID condition](../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md "../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md"). When using an external ID, you or the third
...
You can also use
[IAM
Roles Anywhere](../../../rolesanywhere/latest/userguide/introduction.md "../../../rolesanywhere/latest/userguide/introduction.md") to manage IAM roles for applications outside
...
[sharing
a workload](../userguide/workloads-sharing.md "../userguide/workloads-sharing.md") with other AWS accounts, and
[AWS Resource Access Manager](../../../ram/latest/userguide/what-is.md "../../../ram/latest/userguide/what-is.md") helping you securely share an AWS
resource you own with other accounts.

### Implementation steps

1. **Use cross-account roles to provide
   access to external accounts.**
   [Cross-account
   roles](../../../IAM/latest/UserGuide/id_roles_common-scenarios_third-party.md "../../../IAM/latest/UserGuide/id_roles_common-scenarios_third-party.md") reduce the amount of sensitive information that
   ...
   [IAM
   Roles Anywhere](../../../rolesanywhere/latest/userguide/introduction.md "../../../rolesanywhere/latest/userguide/introduction.md") helps you allow third-party workloads
...
cross-account access. 2. **Perform due diligence and ensure
...
[external
IDs](../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md "../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md") and least privilege access principles. The use of
external IDs helps address the
[confused
deputy problem](https://aws.amazon.com/blogs/security/how-to-use-external-id-when-granting-access-to-your-aws-resources/ "https://aws.amazon.com/blogs/security/how-to-use-external-id-when-granting-access-to-your-aws-resources/").
...
compliance with your security requirements. 3. **Deprecate customer-provided
...
[Identity
management](../security-pillar/identity-management.md "../security-pillar/identity-management.md"). Also, work with your AWS account team and
...
[Incident
response](../security-pillar/incident-response.md "../security-pillar/incident-response.md"). 4. **Verify that setup has prescriptive
...
must follow the
[least-privilege
principle](../../../IAM/latest/UserGuide/best-practices.md#grant-least-privilege "../../../IAM/latest/UserGuide/best-practices.md#grant-least-privilege"). The third party must provide a role policy
...
[Cross-Account
Roles](https://aws.amazon.com/blogs/apn/tag/cross-account-roles/ "https://aws.amazon.com/blogs/apn/tag/cross-account-roles/").
...
detection as part of the audit practice. 5. **Account for changes.** Your
...
[Detection best
practices](../security-pillar/detection.md "../security-pillar/detection.md").
...
- [SEC03-BP05 Define permission
  guardrails for your organization](../security-pillar/sec_permissions_define_guardrails.md "../security-pillar/sec_permissions_define_guardrails.md")
- [SEC03-BP06 Manage access
  based on lifecycle](../security-pillar/sec_permissions_lifecycle.md "../security-pillar/sec_permissions_lifecycle.md")
- [SEC03-BP07 Analyze public and
  cross-account access](../security-pillar/sec_permissions_analyze_cross_account.md "../security-pillar/sec_permissions_analyze_cross_account.md")
- [SEC04 Detection](../security-pillar/detection.md "../security-pillar/detection.md")
...
- [How
  to use trust policies with IAM roles](https://aws.amazon.com/blogs/security/how-to-use-trust-policies-with-iam-roles/ "https://aws.amazon.com/blogs/security/how-to-use-trust-policies-with-iam-roles/")
- [Delegate
  access across AWS accounts using IAM roles](../../../IAM/latest/UserGuide/tutorial_cross-account-with-roles.md "../../../IAM/latest/UserGuide/tutorial_cross-account-with-roles.md")
- [How
  do I access resources in another AWS account using IAM?](https://aws.amazon.com/premiumsupport/knowledge-center/cross-account-access-iam/ "https://aws.amazon.com/premiumsupport/knowledge-center/cross-account-access-iam/")
- [Security
  best practices in IAM](../../../IAM/latest/UserGuide/best-practices.md "../../../IAM/latest/UserGuide/best-practices.md")
- [Cross-account
  policy evaluation logic](../../../IAM/latest/UserGuide/reference_policies_evaluation-logic-cross-account.md "../../../IAM/latest/UserGuide/reference_policies_evaluation-logic-cross-account.md")
- [How
  to use an external ID when granting access to your AWS
  resources to a third party](../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md "../../../IAM/latest/UserGuide/id_roles_create_for-user_externalid.md")
- [Collecting
  Information from AWS CloudFormation Resources Created in
  External Accounts with Custom Resources](https://aws.amazon.com/blogs/apn/collecting-information-from-aws-cloudformation-resources-created-in-external-accounts-with-custom-resources/ "https://aws.amazon.com/blogs/apn/collecting-information-from-aws-cloudformation-resources-created-in-external-accounts-with-custom-resources/")
- [Securely
  Using External ID for Accessing AWS Accounts Owned by
  Others](https://aws.amazon.com/blogs/apn/securely-using-external-id-for-accessing-aws-accounts-owned-by-others/ "https://aws.amazon.com/blogs/apn/securely-using-external-id-for-accessing-aws-accounts-owned-by-others/")
- [Extend
  IAM roles to workloads outside of IAM with IAM Roles
  Anywhere](https://aws.amazon.com/blogs/security/extend-aws-iam-roles-to-workloads-outside-of-aws-with-iam-roles-anywhere/ "https://aws.amazon.com/blogs/security/extend-aws-iam-roles-to-workloads-outside-of-aws-with-iam-roles-anywhere/")

**Related videos:**

- [How
  do I allow users or roles in a separate AWS account access to
  my AWS account?](https://www.youtube.com/watch?v=20tr9gUY4i0 "https://www.youtube.com/watch?v=20tr9gUY4i0")
- [AWS re:Invent 2018: Become an IAM Policy Master in 60 Minutes or
  Less](https://www.youtube.com/watch?v=YQsK4MtsELU "https://www.youtube.com/watch?v=YQsK4MtsELU")
- [AWS Knowledge Center Live: IAM Best Practices and Design
  Decisions](https://www.youtube.com/watch?v=xzDFPIQy4Ks "https://www.youtube.com/watch?v=xzDFPIQy4Ks")

**Related examples:**

- [Configure
  cross-account access to Amazon DynamoDB](../../../prescriptive-guidance/latest/patterns/configure-cross-account-access-to-amazon-dynamodb.md "../../../prescriptive-guidance/latest/patterns/configure-cross-account-access-to-amazon-dynamodb.md")
- [AWS STS Network Query Tool](https://github.com/aws-samples/aws-sts-network-query-tool "https://github.com/aws-samples/aws-sts-network-query-tool")
