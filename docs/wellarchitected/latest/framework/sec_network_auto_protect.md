...
within your network layers](sec_network_protection_layered.md "sec_network_protection_layered.md") and
[SEC05-BP03 Implement
inspection-based protection](sec_network_protection_inspection.md "sec_network_protection_inspection.md") come with managed rules systems
...
layers](sec_network_protection_create_layers.md "sec_network_protection_create_layers.md"), you may have a central management approach to
