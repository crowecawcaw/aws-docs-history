...
- [PERF02-BP01
  Select the best compute options for your workload](perf_compute_hardware_select_best_compute_options.md "perf_compute_hardware_select_best_compute_options.md")
- [PERF03-BP01
  Use a purpose-built data store that best supports your data
  access and storage requirements](perf_data_use_purpose_built_data_store.md "perf_data_use_purpose_built_data_store.md")
- [SUS05-BP03
  Use managed services](sus_sus_hardware_a4.md "sus_sus_hardware_a4.md")

**Related documents:**

- [Planned
  lifecycle events for AWS Health](../../../health/latest/ug/aws-health-planned-lifecycle-events.md "../../../health/latest/ug/aws-health-planned-lifecycle-events.md")

**Related tools:**

- [AWS Health](../../../health/latest/ug/what-is-aws-health.md "../../../health/latest/ug/what-is-aws-health.md")
...
- [How
  ...
  using AWS DMS?](https://www.youtube.com/watch?v=vqgSdD5vkS0 "https://www.youtube.com/watch?v=vqgSdD5vkS0")
- [AWS re:Invent 2023 - Manage resource lifecycle events at scale
  with AWS Health](https://www.youtube.com/watch?v=VoLLNL5j9NA "https://www.youtube.com/watch?v=VoLLNL5j9NA")
