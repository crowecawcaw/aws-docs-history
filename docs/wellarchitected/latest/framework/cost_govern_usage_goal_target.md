...
|  Tagging  |  Untagged resources  |  Cost Explorer: <br /> 1. Filter out credits, discounts, taxes, refunds, marketplace, and copy the latest monthly cost <br /> 2. Select **Show only untagged resources** in Cost Explorer <br /> 3. Divide the amount in **untagged resources** with your monthly cost.  | 
