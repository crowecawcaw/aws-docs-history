...
1. Engineer your workloads for recovery. Regularly test your recovery
   ...
   test.
2. For Amazon EC2-based workloads, use [AWS Elastic Disaster Recovery](../../../drs/latest/userguide/what-is-drs.md "../../../drs/latest/userguide/what-is-drs.md") to implement and launch drill instances for your DR strategy. AWS Elastic Disaster Recovery provides the ability to efficiently run drills, which helps you prepare for a failover event. You can also frequently launch of your instances using Elastic Disaster Recovery for test and drill purposes without redirecting the traffic.
...
- [AWS Elastic Disaster Recovery Preparing for Failover](../../../drs/latest/userguide/failback-preparing.md "../../../drs/latest/userguide/failback-preparing.md")
- [The
  Berkeley/Stanford recovery-oriented computing project](http://roc.cs.berkeley.edu/ "http://roc.cs.berkeley.edu/")
- [What
  is AWS Fault Injection Simulator?](../../../fis/latest/userguide/what-is.md "../../../fis/latest/userguide/what-is.md")
...
- [AWS re:Invent
  ...
  AWS](https://youtu.be/7gNXfo5HZN8 "https://youtu.be/7gNXfo5HZN8")
