...
The [NIST Quality Group](https://www.nist.gov/itl/ssd/software-quality-group "https://www.nist.gov/itl/ssd/software-quality-group")
provides a comparison of [Source Code Security Analyzers](https://www.nist.gov/itl/ssd/software-quality-group/source-code-security-analyzers "https://www.nist.gov/itl/ssd/software-quality-group/source-code-security-analyzers"),
which includes open source tools for [Byte Code Scanners](https://samate.nist.gov/index.php/Byte_Code_Scanners.html "https://samate.nist.gov/index.php/Byte_Code_Scanners.html") and [Binary Code Scanners](https://samate.nist.gov/index.php/Binary_Code_Scanners.html "https://samate.nist.gov/index.php/Binary_Code_Scanners.html").
...
into your code.
[Amazon Q Developers](https://aws.amazon.com/q/developer/ "https://aws.amazon.com/q/developer/") provides code recommendations, including
security scanning, in the builder's IDE.
[Amazon CodeGuru Security](https://aws.amazon.com/codeguru/ "https://aws.amazon.com/codeguru/") can identify critical issues, security
...
The
[Security
for Developers workshop](https://catalog.workshops.aws/sec4devs "https://catalog.workshops.aws/sec4devs") uses AWS developer tools, such as
[AWS CodeBuild](https://aws.amazon.com/codebuild/ "https://aws.amazon.com/codebuild/"),
[AWS CodeCommit](https://aws.amazon.com/codecommit/ "https://aws.amazon.com/codecommit/"), and
[AWS CodePipeline](https://aws.amazon.com/codepipeline/ "https://aws.amazon.com/codepipeline/"), for release pipeline automation that
...
- [Automated
  Security Helper (ASH)](https://github.com/awslabs/automated-security-helper "https://github.com/awslabs/automated-security-helper") is an example for open-source
  code security scanning tool.
- Performing testing or code analysis using automated tools,
  such as
  [Amazon Q Developer](https://aws.amazon.com/q/developer/ "https://aws.amazon.com/q/developer/") integrated with developer IDEs, and
  [Amazon CodeGuru Security](https://aws.amazon.com/codeguru/ "https://aws.amazon.com/codeguru/") for scanning code on commit, helps
  builders get feedback at the right time.
- When building using AWS Lambda, you can use
  [Amazon Inspector](../../../inspector/latest/user/scanning-lambda.md "../../../inspector/latest/user/scanning-lambda.md") to scan the application code in your
  functions.
...
- To extract SBOM as part of your CI/CD pipelines, use
  [Amazon Inspector SBOM Generator](../../../inspector/latest/user/sbom-generator.md "../../../inspector/latest/user/sbom-generator.md") to produce SBOMs for
...
- [How
  ...
  deployments](https://aws.amazon.com/builders-library/automating-safe-hands-off-deployments/ "https://aws.amazon.com/builders-library/automating-safe-hands-off-deployments/")
- [How
  Amazon CodeGuru Security helps you effectively balance
  security and velocity](https://aws.amazon.com/blogs/security/how_amazon_codeguru_security_helps_effectively_balance_security_and_velocity/ "https://aws.amazon.com/blogs/security/how_amazon_codeguru_security_helps_effectively_balance_security_and_velocity/")
...
- [Automating
  cross-account CI/CD pipelines](https://www.youtube.com/watch?v=AF-pSRSGNks "https://www.youtube.com/watch?v=AF-pSRSGNks")
- [The
  Software Development Prcess at Amazon](https://www.youtube.com/watch?t=1340&v=52SC80SFPOw&feature=youtu.be "https://www.youtube.com/watch?t=1340&v=52SC80SFPOw&feature=youtu.be")
- [Testing
  software and systems at Amazon](https://www.youtube.com/watch?v=o1sc3cK9bMU&t "https://www.youtube.com/watch?v=o1sc3cK9bMU&t")

**Related examples:**

- [Industry
  awareness for developers](https://owasp.org/www-project-top-ten/ "https://owasp.org/www-project-top-ten/")
- [Automated
  Security Helper (ASH)](https://github.com/awslabs/automated-security-helper "https://github.com/awslabs/automated-security-helper")
- [AWS CodePipeline Governance - Github](https://github.com/awslabs/aws-codepipeline-governance "https://github.com/awslabs/aws-codepipeline-governance")
