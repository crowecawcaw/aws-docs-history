...
4. **Assess your recovery
   ...
   [AWS Resilience Hub](../../../resilience-hub/latest/userguide/create-policy.md "../../../resilience-hub/latest/userguide/create-policy.md"), you can run an assessment of your
...
5. **Do a test restore** using
   ...
   new resource](../../../aws-backup/latest/devguide/restoring-a-backup.md "../../../aws-backup/latest/devguide/restoring-a-backup.md"). If you used AWS Elastic Disaster Recovery
   you can
   [launch
   a recovery drill](../../../drs/latest/userguide/failback-preparing.md "../../../drs/latest/userguide/failback-preparing.md").
6. **Validate data recovery** from
...
7. **Measure time required** for
   ...
   [AWS CloudTrail](../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md "../../../awscloudtrail/latest/userguide/cloudtrail-user-guide.md"). While this information can provide details
   ...
   like
   [Amazon DynamoDB](https://aws.amazon.com/dynamodb/ "https://aws.amazon.com/dynamodb/") can be used to store this information.
...
8. **Notify stakeholders** if data
   ...
   [such
   as in this lab](https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/ "https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/"), services like Amazon Simple Notification Service (Amazon SNS) can be used to send push
   notifications such as email or SMS to stakeholders.
   [These
   messages can also be published to messaging applications such
   as Amazon Chime, Slack, or Microsoft Teams](https://aws.amazon.com/premiumsupport/knowledge-center/sns-lambda-webhooks-chime-slack-teams/ "https://aws.amazon.com/premiumsupport/knowledge-center/sns-lambda-webhooks-chime-slack-teams/") or used to
   [create
   tasks as OpsItems using AWS Systems Manager OpsCenter](../../../systems-manager/latest/userguide/OpsCenter-creating-OpsItems.md "../../../systems-manager/latest/userguide/OpsCenter-creating-OpsItems.md").
9. **Automate this process to run
   ...
   how to
   [Automate
   data recovery validation with AWS Backup](https://aws.amazon.com/blogs/storage/automate-data-recovery-validation-with-aws-backup/ "https://aws.amazon.com/blogs/storage/automate-data-recovery-validation-with-aws-backup/"). Additionally,
   [this
   Well-Architected lab](https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/ "https://wellarchitectedlabs.com/reliability/200_labs/200_testing_backup_and_restore_of_data/") provides a hands-on experience on
   one way to do automation for several of the steps here.

![Diagram showing an automated backup and restore process](images/automated-backup-restore-process.png)
...
- [Automate
  data recovery validation with AWS Backup](https://aws.amazon.com/blogs/storage/automate-data-recovery-validation-with-aws-backup/ "https://aws.amazon.com/blogs/storage/automate-data-recovery-validation-with-aws-backup/")
- [APN
...
- [On-demand
  backup and restore for DynamoDB](../../../amazondynamodb/latest/developerguide/BackupRestore.md "../../../amazondynamodb/latest/developerguide/BackupRestore.md")
- [What
