...
![Diagram showing dependencies such as queuing systems and load balancers are loosely coupled](http://docs.aws.amazon.com/wellarchitected/latest/framework/images/dependency-diagram.png)
