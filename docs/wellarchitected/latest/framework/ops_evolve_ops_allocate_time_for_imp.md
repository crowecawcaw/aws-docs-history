...
- [OPS05-BP08
  Use multiple environments](../operational-excellence-pillar/ops_dev_integ_multi_env.md "../operational-excellence-pillar/ops_dev_integ_multi_env.md")

**Related videos:**

- [AWS re:Invent 2023 - Improve application resilience with AWS Fault
  Injection Service](https://youtu.be/N0aZZVVZiUw?si=ivYa9ScBfHcj-IAq "https://youtu.be/N0aZZVVZiUw?si=ivYa9ScBfHcj-IAq")
