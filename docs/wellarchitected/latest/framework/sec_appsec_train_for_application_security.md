...
[Threat
Modeling Workshop](https://catalog.workshops.aws/threatmodel/en-US "https://catalog.workshops.aws/threatmodel/en-US"). Threat modeling can help your team
understand potential security risks and design systems with
security in mind from the outset. Additionally, you can provide
access to
[AWS Training and Certification](https://www.aws.training/LearningLibrary?filters=Language%3A1%20Domain%3A27 "https://www.aws.training/LearningLibrary?filters=Language%3A1%20Domain%3A27"), industry, or AWS Partner
...
[AWS Cloud Development Kit (AWS CDK) (AWS CDK) Constructs](../../../cdk/v2/guide/constructs.md "../../../cdk/v2/guide/constructs.md"), and
...
2. **Plan the training**: Based
   ...
   [Threat
   Modeling Workshop](https://catalog.workshops.aws/threatmodel/en-US "https://catalog.workshops.aws/threatmodel/en-US"),
   [AWS Training and Certification](https://www.aws.training/LearningLibrary?filters=Language%3A1%20Domain%3A27 "https://www.aws.training/LearningLibrary?filters=Language%3A1%20Domain%3A27"), and industry or AWS
...
5. **Create self-service
   ...
   [AWS CDK Constructs](../../../cdk/v2/guide/constructs.md "../../../cdk/v2/guide/constructs.md"), and
   [Service
   Catalog](https://aws.amazon.com/servicecatalog/ "https://aws.amazon.com/servicecatalog/") to provide pre-approved, secure
   configurations and reduce the need for custom setups.
6. **Communicate and
...
- [Accelerating
  training – The AWS Skills Guild](../../../whitepapers/latest/public-sector-cloud-transformation/accelerating-training-the-aws-skills-guild.md "../../../whitepapers/latest/public-sector-cloud-transformation/accelerating-training-the-aws-skills-guild.md")
- [AWS DevOps Sagas](../devops-guidance/the-devops-sagas.md "../devops-guidance/the-devops-sagas.md")
...
- [Workshop
  on threat modeling](https://catalog.workshops.aws/threatmodel "https://catalog.workshops.aws/threatmodel")
- [Industry
...
- [AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/")
- [AWS Cloud Development Kit (AWS CDK) (AWS CDK) Constructs](../../../cdk/v2/guide/constructs.md "../../../cdk/v2/guide/constructs.md")
