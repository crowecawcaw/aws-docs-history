...
inspection-based protection](sec_network_protection_inspection.md "sec_network_protection_inspection.md").
...
- [REL03-BP01
  Choose how to segment your workload](rel_service_architecture_monolith_soa_microservice.md "rel_service_architecture_monolith_soa_microservice.md")
- [SEC09-BP02
  Enforce encryption in transit](sec_protect_data_transit_encrypt.md "sec_protect_data_transit_encrypt.md")
