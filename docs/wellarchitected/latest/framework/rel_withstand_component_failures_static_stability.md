...
![Diagram showing static stability of EC2 instances across Availability Zones](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/static-stability.png)
