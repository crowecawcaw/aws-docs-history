...
![Chart showing different Regions with compliance, latency, cost, and services and features.](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/region-feature-matrix.png)
