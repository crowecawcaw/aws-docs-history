...
_policies_ that are associated with a
...
In addition to groups, you can use _attributes_
...
2. Define groups:
   ...
   2. If defining within IAM Identity Center, create groups
      and associate the desired level of access using
      permission sets.
   3. If defining within an external identity provider,
...
3. Define attributes:
   1. If you use an external identity provider, both the SCIM
      ...
      custom attributes.
   2. If you define roles within IAM Identity Center, enable
...
1. Scope permissions based on groups and attributes:
   1. Consider including conditions in your permission
      ...
      same name.
   2. When defining ABAC policies, follow the guidance in the
      [ABAC
      authorization](../../../IAM/latest/UserGuide/introduction_attribute-based-access-control.md "../../../IAM/latest/UserGuide/introduction_attribute-based-access-control.md") best practices and examples.
   3. Regularly review and update your group and attribute
...
- [COST02-BP04
  Implement groups and roles](cost_govern_usage_groups_roles.md "cost_govern_usage_groups_roles.md")
...
- [What
  Is ABAC for AWS?](../../../IAM/latest/UserGuide/introduction_attribute-based-access-control.md "../../../IAM/latest/UserGuide/introduction_attribute-based-access-control.md")
- [ABAC
  In IAM Identity Center](../../../singlesignon/latest/userguide/configure-abac.md "../../../singlesignon/latest/userguide/configure-abac.md")
- [ABAC
  Policy Examples](../../../IAM/latest/UserGuide/reference_policies_examples_aws_abac.md "../../../IAM/latest/UserGuide/reference_policies_examples_aws_abac.md")
