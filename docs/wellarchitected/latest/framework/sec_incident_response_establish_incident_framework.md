...
It's important to implement a _lessons learned_
...
- [AWS Security Incident Response Guide - Establish a framework for
  learning from incidents](../../../whitepapers/latest/aws-security-incident-response-guide/establish-framework-for-learning.md "../../../whitepapers/latest/aws-security-incident-response-guide/establish-framework-for-learning.md")
- [NCSC
  CAF guidance - Lessons learned](https://www.ncsc.gov.uk/collection/caf/caf-principles-and-guidance/d-2-lessons-learned "https://www.ncsc.gov.uk/collection/caf/caf-principles-and-guidance/d-2-lessons-learned")
