...
[AWS CodePipeline](https://aws.amazon.com/codepipeline/ "https://aws.amazon.com/codepipeline/") to perform deployments. You can use these
...
[AWS Key Management Service (AWS KMS)](https://aws.amazon.com/kms/ "https://aws.amazon.com/kms/"). By signing and verifying packages, you
...
such as
[AWS Systems Manager Parameter Store](../../../systems-manager/latest/userguide/systems-manager-parameter-store.md "../../../systems-manager/latest/userguide/systems-manager-parameter-store.md"). This practice separates
...
[AWS CDK](https://aws.amazon.com/cdk/ "https://aws.amazon.com/cdk/"). You
...
[Organizing
Your AWS Environment Using Multiple Accounts](../../../whitepapers/latest/organizing-your-aws-environment/organizing-your-aws-environment.md "../../../whitepapers/latest/organizing-your-aws-environment/organizing-your-aws-environment.md") whitepaper.
...
6. **Implement canary
   ...
   - Use services like
     [AWS CodeDeploy](https://aws.amazon.com/codedeploy/ "https://aws.amazon.com/codedeploy/") or
     [AWS ECS](https://aws.amazon.com/ecs/ "https://aws.amazon.com/ecs/") to manage canary deployments and monitor the
     impact of changes.
...
7. **Monitor and audit**:
   ...
   - Use services like
     ...
     [AWS CloudTrail](https://aws.amazon.com/cloudtrail/ "https://aws.amazon.com/cloudtrail/") to collect and analyze logs and
     metrics.
...
- [Code
  Signing, a Trust and Integrity Control for AWS Lambda](https://aws.amazon.com/blogs/aws/new-code-signing-a-trust-and-integrity-control-for-aws-lambda/ "https://aws.amazon.com/blogs/aws/new-code-signing-a-trust-and-integrity-control-for-aws-lambda/")

**Related videos:**

- [Hands-off:
  Automating continuous delivery pipelines at
  Amazon](https://www.youtube.com/watch?v=ngnMj1zbMPY "https://www.youtube.com/watch?v=ngnMj1zbMPY")

**Related examples:**

- [Blue/Green
  deployments with AWS Fargate](https://catalog.us-east-1.prod.workshops.aws/workshops/954a35ee-c878-4c22-93ce-b30b25918d89/en-US "https://catalog.us-east-1.prod.workshops.aws/workshops/954a35ee-c878-4c22-93ce-b30b25918d89/en-US")
