...
Establish policies and mechanisms to verify that appropriate costs are incurred
while objectives are achieved. By employing a checks-and-balances approach, you can innovate without overspending.
...
- [COST02-BP05 Implement cost controls](cost_govern_usage_controls.md "cost_govern_usage_controls.md")
- [COST02-BP06 Track project lifecycle](cost_govern_usage_track_lifecycle.md "cost_govern_usage_track_lifecycle.md")
