...
3. **Use
   [network
   monitoring](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-Network-Monitoring-Sections.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-Network-Monitoring-Sections.md"):** Use
   [Internet
   Monitor](../../../AmazonCloudWatch/latest/monitoring/CloudWatch-InternetMonitor.md "../../../AmazonCloudWatch/latest/monitoring/CloudWatch-InternetMonitor.md") and
   [Network
   Monitor](../../../AmazonCloudWatch/latest/monitoring/what-is-network-monitor.md "../../../AmazonCloudWatch/latest/monitoring/what-is-network-monitor.md"), which provide comprehensive insights into
   ...
   dependencies.
4. **Stay informed with
   [AWS Health](https://aws.amazon.com/premiumsupport/technology/aws-health/ "https://aws.amazon.com/premiumsupport/technology/aws-health/"):** AWS Health is the authoritative source of information about the health of your AWS Cloud resources. Use AWS Health to visualize and receive notifications about any current service events and upcoming changes, such as planned lifecycle events, so you can take steps to mitigate impacts.
...
5. **Instrument your application with
   [AWS X-Ray](https://aws.amazon.com/xray/ "https://aws.amazon.com/xray/"):** AWS X-Ray provides insights into
...
6. **Use
   [Amazon DevOps Guru](https://aws.amazon.com/devops-guru/ "https://aws.amazon.com/devops-guru/"):** This machine learning-driven
...
- [OPS04-BP01
  Define workload KPIs](../operational-excellence-pillar/ops_observability_identify_kpis.md "../operational-excellence-pillar/ops_observability_identify_kpis.md")
- [OPS04-BP02
  Implement application telemetry](../operational-excellence-pillar/ops_observability_application_telemetry.md "../operational-excellence-pillar/ops_observability_application_telemetry.md")
- [OPS04-BP03
  Implement user activity telemetry](../operational-excellence-pillar/ops_observability_customer_telemetry.md "../operational-excellence-pillar/ops_observability_customer_telemetry.md")
- [OPS04-BP05
  Implement transaction traceability](../operational-excellence-pillar/ops_observability_dist_trace.md "../operational-excellence-pillar/ops_observability_dist_trace.md")
- [OP08-BP04
...
- [Visibility
  into how internet issues impact app performance](https://www.youtube.com/watch?v=Kuc_SG_aBgQ "https://www.youtube.com/watch?v=Kuc_SG_aBgQ")
- [Introduction
  to Amazon DevOps Guru](https://www.youtube.com/watch?v=2uA8q-8mTZY "https://www.youtube.com/watch?v=2uA8q-8mTZY")
- [Manage
  resource lifecycle events at scale with AWS Health](https://www.youtube.com/watch?v=VoLLNL5j9NA "https://www.youtube.com/watch?v=VoLLNL5j9NA")
...
- [Using
  ...
  Alerting at Scale](https://aws.amazon.com/blogs/mt/using-tag-based-filtering-to-manage-health-monitoring-and-alerting-at-scale/ "https://aws.amazon.com/blogs/mt/using-tag-based-filtering-to-manage-health-monitoring-and-alerting-at-scale/")
