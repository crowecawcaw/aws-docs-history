...
![Flow diagram showing a per-Region account structure for incident response, forking into a security and forensics OU.](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/region-account-structure.png)
