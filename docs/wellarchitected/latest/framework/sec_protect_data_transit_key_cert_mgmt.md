...
certificates:
[AWS Certificate Manager](../../../acm/latest/userguide/acm-overview.md "../../../acm/latest/userguide/acm-overview.md") and
[AWS Private Certificate Authority (AWS Private CA)](../../../privateca/latest/userguide/PcaWelcome.md "../../../privateca/latest/userguide/PcaWelcome.md"). ACM is the
...
[integrates](../../../acm/latest/userguide/acm-services.md "../../../acm/latest/userguide/acm-services.md")
with many other AWS managed services to provide secure TLS
certificates for workloads. ACM can also issue publicly trusted
certificates from
[Amazon
Trust Services](https://www.amazontrust.com/repository/ "https://www.amazontrust.com/repository/"). Public certificates from ACM can be used on
...
[custom
template](../../../privateca/latest/userguide/UsingTemplates.md "../../../privateca/latest/userguide/UsingTemplates.md"). You can also use
[IAM
Roles Anywhere](../../../rolesanywhere/latest/userguide/introduction.md "../../../rolesanywhere/latest/userguide/introduction.md") to provide temporary IAM credentials to
...
[AWS IoT Core](../../../iot/latest/developerguide/what-is-aws-iot.md "../../../iot/latest/developerguide/what-is-aws-iot.md") provides specialized support for provisioning,
managing and deploying PKI certificates to IoT
devices. AWS IoT Core provides specialized mechanisms for
[onboarding
IoT devices](../../../whitepapers/latest/device-manufacturing-provisioning/device-manufacturing-provisioning.md "../../../whitepapers/latest/device-manufacturing-provisioning/device-manufacturing-provisioning.md") into your public key infrastructure at scale.
...
[Planning
your AWS Private CA deployment](../../../privateca/latest/userguide/PcaPlanning.md "../../../privateca/latest/userguide/PcaPlanning.md").
...
1. Determine the relevant AWS services required for your use
   ...
   - Consider [AWS Private CA](../../../privateca/latest/userguide/PcaWelcome.md "../../../privateca/latest/userguide/PcaWelcome.md") when you need
     ...
     of end-entity certificates](../../../privateca/latest/userguide/PcaIssueCert.md "../../../privateca/latest/userguide/PcaIssueCert.md") using the AWS Private CA.
   - For use cases where certificates must be provisioned at
     scale for embedded Internet of things (IoT) devices,
     consider [AWS IoT Core](../../../iot/latest/developerguide/x509-client-certs.md "../../../iot/latest/developerguide/x509-client-certs.md").
   - Consider using native mTLS functionality in services
     like
     [Amazon API Gateway](../../../apigateway/latest/developerguide/welcome.md "../../../apigateway/latest/developerguide/welcome.md") or
...
3. Establish logging and audit trails:
   ...
   - Periodically generate and review
     [audit
     reports](../../../privateca/latest/userguide/PcaAuditReport.md "../../../privateca/latest/userguide/PcaAuditReport.md") that list the certificates that your private
   ...
   - When deploying a private CA, you will also need to establish
     ...
     [Planning
     a certificate revocation list (CRL)](../../../privateca/latest/userguide/crl-planning.md "../../../privateca/latest/userguide/crl-planning.md").
...
- [How
  ...
  infrastructure in AWS](https://aws.amazon.com/blogs/security/how-to-host-and-manage-an-entire-private-certificate-infrastructure-in-aws/ "https://aws.amazon.com/blogs/security/how-to-host-and-manage-an-entire-private-certificate-infrastructure-in-aws/")
- [How
  to secure an enterprise scale ACM Private CA hierarchy for
  automotive and manufacturing](https://aws.amazon.com/blogs/security/how-to-secure-an-enterprise-scale-acm-private-ca-hierarchy-for-automotive-and-manufacturing/ "https://aws.amazon.com/blogs/security/how-to-secure-an-enterprise-scale-acm-private-ca-hierarchy-for-automotive-and-manufacturing/")
- [Private
  CA best practices](../../../privateca/latest/userguide/ca-best-practices.md "../../../privateca/latest/userguide/ca-best-practices.md")
- [How
  to use AWS RAM to share your ACM Private CA
  cross-account](https://aws.amazon.com/blogs/security/how-to-use-aws-ram-to-share-your-acm-private-ca-cross-account/ "https://aws.amazon.com/blogs/security/how-to-use-aws-ram-to-share-your-acm-private-ca-cross-account/")

**Related videos:**

- [Activating
  AWS Certificate Manager Private CA (workshop)](https://www.youtube.com/watch?v=XrrdyplT3PE "https://www.youtube.com/watch?v=XrrdyplT3PE")

**Related examples:**

- [Private
  CA workshop](https://catalog.workshops.aws/certificatemanager/en-US/introduction "https://catalog.workshops.aws/certificatemanager/en-US/introduction")
- [IOT
  Device Management Workshop](https://iot-device-management.workshop.aws/en/ "https://iot-device-management.workshop.aws/en/") (including device
  provisioning)

**Related tools:**

- [Plugin
  to Kubernetes cert-manager to use AWS Private CA](https://github.com/cert-manager/aws-privateca-issuer "https://github.com/cert-manager/aws-privateca-issuer")
