...
![Demand curve with two distinct peaks that require high provisioned capacity](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/provisioned-capacity-1.png)
