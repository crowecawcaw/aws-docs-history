...
![Demand curve with two distinct peaks that require high provisioned capacity](http://docs.aws.amazon.com/wellarchitected/latest/framework/images/provisioned-capacity-1.png)
