...
![Flowchart detailing the relationship between cost and usage within an organization.](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/cost-usage-organization-chart.png)
