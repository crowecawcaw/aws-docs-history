...
2. Establish mechanisms for feedback and improvement.
   ...
   3. Implement issues or a ticketing queue to provide and
      track feedback.
   4. Wherever possible, provide pre-approval and risk
...
3. Make process and procedures accessible and discoverable by
   ...
   3. Use wikis or document management to make processes and
...
4. Automate when it is appropriate to do so.
   ...
   2. Verify that processes are well-understood, and develop
      ...
      processes.
   3. Measure the successful use of processes and procedures,
...
- [OPS02-BP02
  Processes and procedures have identified owners](../operational-excellence-pillar/ops_ops_model_def_resource_owners.md "../operational-excellence-pillar/ops_ops_model_def_resource_owners.md")
...
- [OPS02-BP05
  ...
  ownership](../operational-excellence-pillar/ops_ops_model_find_owner.md "../operational-excellence-pillar/ops_ops_model_find_owner.md")
- [OPS11-BP04
...
- [AWS Knowledge Center Live | Tagging AWS Resources](https://www.youtube.com/watch?v=MX9DaAQS15I "https://www.youtube.com/watch?v=MX9DaAQS15I")
