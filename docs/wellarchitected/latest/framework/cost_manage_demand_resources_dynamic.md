...
There are multiple scaling options available to scale your Amazon EC2 Auto Scaling group:
...
also use [attribute-based instance type selection (ABS) strategy](../../../autoscaling/ec2/userguide/create-asg-instance-type-requirements.md "../../../autoscaling/ec2/userguide/create-asg-instance-type-requirements.md") in Amazon EC2 Auto Scaling groups,
...
- **Configure scheduled scaling:** For predictable
  ...
  scaling to increase the number of Amazon EC2 instances in your Amazon EC2 Auto Scaling groups in advance according
  to expected or predictable load changes.
- **Configure predictive scaling:** Predictive scaling allows you
  to increase the number of Amazon EC2 instances in your Amazon EC2 Auto Scaling group in advance of daily and
...
- **Configure dynamic automatic scaling:** To configure scaling based
  on active workload metrics, use Amazon EC2 Auto Scaling. Use the analysis and configure Amazon EC2 Auto Scaling to launch on the
  ...
  Amazon EC2 Auto Scaling group. In addition to receiving discounts for using Spot Instances, you can use
...
- Scale the size of your Amazon EC2 Auto Scaling group
- [Getting
...
- [Target Tracking Scaling Policies for Amazon EC2 Auto Scaling](https://www.youtube.com/watch?v=-RumeaoPB2M "https://www.youtube.com/watch?v=-RumeaoPB2M")
