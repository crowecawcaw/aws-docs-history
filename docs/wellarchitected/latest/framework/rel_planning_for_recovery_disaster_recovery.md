...
![Diagram showing DR strategies](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/disaster-recovery-strategies.png)
...
![Graph showing choosing a DR strategy based on RTO and cost](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/choosing-a-dr-strategy.png)
...
![Diagram showing a backup and restore architecture](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/backup-restore-architecture.png)
...
![Diagram showing a ilot light architecture](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/pilot-light-architecture.png)
...
![Diagram showing a Figure 21: Warm standby architecture](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/warm-standby-architecture.png)
...
![Diagram showing a multi-site active/active architecture](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/multi-site-active-active-architecture.png)
...
![Architecture diagram describing how AWS Elastic Disaster Recovery operates.](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/drs-architecture.png)
...
![Diagram showing a Figure 24: Multi-AZ architecture](https://docs.aws.amazon.com/wellarchitected/latest/framework/images/multi-az-architecture2.png)
