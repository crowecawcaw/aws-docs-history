...
[COST05-BP01
Identify organization requirements for cost](../cost-optimization-pillar/cost_select_service_requirements.md "../cost-optimization-pillar/cost_select_service_requirements.md"), perform a
...
[AWS Cost Explorer](https://aws.amazon.com/aws-cost-management/aws-cost-explorer/ "https://aws.amazon.com/aws-cost-management/aws-cost-explorer/") and the AWS Cost and Usage Reports ([CUR](https://aws.amazon.com/aws-cost-management/aws-cost-and-usage-reporting/ "https://aws.amazon.com/aws-cost-management/aws-cost-and-usage-reporting/"))
can analyze the cost of a proof of concept (PoC) or running
environment. You can also use [AWS Pricing Calculator](https://calculator.aws/#/ "https://calculator.aws/#/") to estimate workload costs.
...
4. **AWS Cost Explorer, CloudWatch Logs,
...
5. **Use AWS Budgets to set budgets for
...
6. **Configure Amazon CloudWatch alarms to
...
- [AWS Cost Optimization Series: CloudWatch](https://www.youtube.com/watch?v=6imTJUGEzjU "https://www.youtube.com/watch?v=6imTJUGEzjU")
