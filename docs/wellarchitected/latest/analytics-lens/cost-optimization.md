...
**Topics**
+ [11 – Choose cost-effective compute and storage solutions based on workload usage patterns](design-principle-11.md)
+ [12 – Build financial accountability models for data and workload usage](design-principle-12.md)
+ [13 – Manage cost over time](design-principle-13.md)
+ [14 – Use optimal pricing models based on infrastructure usage patterns](design-principle-14.md)