...
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| Structured data      | ERP applications, CRM applications, ERP applications, CMS applications, SaaS<br>applications, SAP applications, line of business (LOB) applications, and SQL<br>databases |     |
| Semi-structured data | Web applications, NoSQL databases, EDI (electronic data interchange), CSV,<br>XML, and JSON documents                                                                     |     |
...
| Streaming data       | Sensors, social media, video streams, IoT devices, mobile devices that<br>generate semi-structured and unstructured data as continuous streams                            |     |
...
Here are few example questions to identify your data storage and data access
requirements. 
...
- How much data are you storing now, and how much do you expect to be storing in the
  future, for example, 18 months from now?
...
- What is your frequency of data transformation? (for example, real time,
  micro-batching, overnight batch)
