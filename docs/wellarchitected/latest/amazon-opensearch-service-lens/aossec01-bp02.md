...
<a name="implementation-guidance-11"></a>
 ...
 If you enable [fine-grained access control](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/fgac.html), node-to-node encryption is required. 
