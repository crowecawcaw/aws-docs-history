...
+  **Estimate instance capacity:** Estimate the total capacity required to meet your workload demands. For detail on sizing OpenSearch Service domains, see [Performance efficiency](performance-efficiency.md) and [Cost optimization](cost-optimization.md). 
