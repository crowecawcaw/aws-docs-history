...
+  Implement an [ISM policy](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ism.html) to move data between different storage tiers to meet business and regulatory requirements. Additionally, implement an [ISM policy](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/ism.html) to delete unnecessary data. For detailed implementation guidance, see [AOSOPS01-BP01](aosops01-bp01.md). 
