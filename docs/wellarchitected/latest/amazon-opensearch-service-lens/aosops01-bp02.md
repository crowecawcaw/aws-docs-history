...
<a name="implementation-guidance-1"></a>
 ...
 For samples and full details about implementing templates, see [Index templates](https://opensearch.org/docs/latest/im-plugin/index-templates/). 
