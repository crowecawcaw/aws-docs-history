...
+  Create a custom snapshot repository. For step-by-step instructions, see [AOSOPS02-BP01](aosops02-bp01.md). 
...
+  [Automating snapshots with Snapshot Management](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-snapshots.html#managedomains-snapshot-mgmt) 
+  [Unleash the power of Snapshot Management to take automated snapshots using Amazon OpenSearch Service](https://aws.amazon.com/blogs/big-data/unleash-the-power-of-snapshot-management-to-take-automated-snapshots-using-amazon-opensearch-service/) 
