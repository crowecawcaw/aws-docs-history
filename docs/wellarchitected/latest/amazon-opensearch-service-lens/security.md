...
**Topics**
+ [Design principles](#design-principles-sec)
+ [Security foundation](security-foundation.md)
+ [Detection](detection.md)
+ [Data protection](data-protection.md)
+ [Key AWS services](key-aws-services-sec.md)
+ [Resources](resources-sec.md)

## Design principles
<a name="design-principles-sec"></a>

 In addition to the [security principles](https://docs.aws.amazon.com/wellarchitected/latest/Security%20design%20principles*%0dsecurity-pillar/security.html) of the AWS Well-Architected Framework, the following design principles can enhance the security posture of OpenSearch workloads: 
