...
<a name="amazon-delivering-browser-based-applications"></a>
...
![Reference architecture for Amazon WorkSpaces Secure Browser service](http://docs.aws.amazon.com/wellarchitected/latest/end-user-computing-lens/images/image5.jpeg)
 ...
 WorkSpaces Secure Browser provides compatibility with a broad range of web sites due to the use of a standard web browser. This compatibility verifies that web sites do not need to be re-developed to support WorkSpaces Secure Browser. 
...
<a name="common-workspaces-secure-browser-deployment-scenarios"></a>
...
<a name="scenario-1-isolate-access-to-specific-browse-applications"></a>
...
<a name="scenario-2-provide-simplified-access-to-web-applications"></a>
...
<a name="scenario-3-provide-safe-access-to-external-websites"></a>
