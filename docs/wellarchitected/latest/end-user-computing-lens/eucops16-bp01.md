...
- Should an update fail, a snapshot of the two WorkSpaces storage volumes is taken every
  12 hours, which may provide a recovery position. WorkSpaces can be rebuilt or [recovered](../../../workspaces/latest/adminguide/restore-workspace.md "../../../workspaces/latest/adminguide/restore-workspace.md"). For more information, see [Rebuild a WorkSpace in
  WorkSpaces Personal](../../../workspaces/latest/adminguide/rebuild-workspace.md "../../../workspaces/latest/adminguide/rebuild-workspace.md").
