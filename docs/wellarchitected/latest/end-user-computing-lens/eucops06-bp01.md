...
<a name="implementation-guidance-7"></a>
 ...
 Unlike on-premises infrastructure, Amazon WorkSpaces and WorkSpaces Applications environments can be [deployed using automated processes](https://pages.awscloud.com/rs/112-TZM-766/images/2020_0210-EUC_Slide-Deck.pdf) and only attract costs while in use. 

 AWS CloudFormation templates can be used to deploy new AWS services such as WorkSpaces and WorkSpaces Applications to reduce the likelihood of human error and reduce configuration drift. 

 AWS Systems Manager Runbooks can be used to automate some aspects of WorkSpaces deployment. For more detail, see [SSM Runbooks for Amazon WorkSpaces](https://docs.aws.amazon.com/systems-manager-automation-runbooks/latest/userguide/automation-ref-wsp.html). 