...
project board formulation. The [Prince II methodology](https://prince2.wiki/roles/project-board/ "https://prince2.wiki/roles/project-board/") is a common example that embraces this approach.
