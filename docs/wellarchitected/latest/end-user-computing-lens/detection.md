...
**Topics**
+ [EUCSEC07-BP01 Monitor user access to EUC instances and aggregate logs in central location](eucsec07-bp01.md)
+ [EUCSEC08-BP01 Install endpoint protection software on instances to detect unexpected behavior](eucsec08-bp01.md)
+ [EUCSEC09-BP01 Verify that your instances are configured as expected](eucsec09-bp01.md)