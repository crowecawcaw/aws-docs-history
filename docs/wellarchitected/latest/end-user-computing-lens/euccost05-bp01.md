...
<a name="implementation-guidance-85"></a>

 If you use a desktop virtualization Environment, your VDI solution may include reporting tools that can provide you with the required data. Tools like [Citrix Director](https://docs.citrix.com/en-us/citrix-virtual-apps-desktops/director.html) or [VMware vRealize Operations Manager](https://docs.vmware.com/en/vRealize-Operations/index.html) can be used for this. 
