...
<a name="implementation-guidance-44"></a>
 ...
 To improve readiness for significant incidents or data loss incidents in Amazon WorkSpaces and WorkSpaces Applications deployments, organizations must prioritize the development and regular testing of disaster recovery plans. 
