...
+  Service-emitted events and logs (for example, Amazon WorkSpaces EventBridge events and WorkSpaces Applications usage reports) 
+  Data plane logs collected through agents installed onto Amazon WorkSpaces or WorkSpaces Applications instances 
