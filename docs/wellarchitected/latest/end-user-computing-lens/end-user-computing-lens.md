...
<a name="introduction"></a>
 ...
 This document only covers details from the Well-Architected Framework that are specific to End User Compute. We recommend that you also consider the best practices from the [AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html) when designing your architecture. 
