...
<a name="implementation-guidance-16"></a>
 ...
 Amazon Kinesis agents can be installed onto Amazon WorkSpaces or WorkSpaces Applications images to export log file data in real time to a centralized location for retrospective analysis. 
