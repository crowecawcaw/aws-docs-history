...
<a name="implementation-guidance-2"></a>
 ...
 For WorkSpaces Applications, the master images created in one Region can be copied to a secondary Region to enable the configuration of identical regional deployment for DR purposes. 
