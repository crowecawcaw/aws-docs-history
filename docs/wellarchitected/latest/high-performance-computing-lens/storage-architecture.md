...
An [Amazon EBS-optimized instance types](../../../AWSEC2/latest/UserGuide/ebs-optimized.md "../../../AWSEC2/latest/UserGuide/ebs-optimized.md") uses an optimized configuration stack and
...
- [Amazon FSx for OpenZFS](https://aws.amazon.com/fsx/openzfs/ "https://aws.amazon.com/fsx/openzfs/")
...
- [Amazon EC2 Instance types](https://aws.amazon.com/ec2/instance-types/ "https://aws.amazon.com/ec2/instance-types/")
- [Deep
  dive on accelerating HPC and ML with Amazon FSx](https://www.youtube.com/watch?v=6848CCaIqSY "https://www.youtube.com/watch?v=6848CCaIqSY")
- [Amazon FSx for Lustre performance](../../../fsx/latest/LustreGuide/performance.md "../../../fsx/latest/LustreGuide/performance.md")
- [Using
  Lustre to build very fast file systems with Amazon FSx for Lustre](https://www.youtube.com/watch?v=0AVdf3jKuvo&t=4s "https://www.youtube.com/watch?v=0AVdf3jKuvo&t=4s")
- [How
  Amazon File Cache works](https://www.youtube.com/watch?v=I1-Vxwgzlbk "https://www.youtube.com/watch?v=I1-Vxwgzlbk")
