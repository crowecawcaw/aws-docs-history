...
| HPCREL01: How does your architecture optimize for capacity pool<br>flexibility? |
| ------------------------------------------------------------------------------- |
|                                                                                 |
...
see
[JobQueueDetail](../../../batch/latest/APIReference/API_JobQueueDetail.md#compute_environment_compute_resources "../../../batch/latest/APIReference/API_JobQueueDetail.md#compute_environment_compute_resources").
Multiple instance types can also be configured with AWS ParallelCluster and with Amazon Parallel Computing Service.
For more information, see
[Multiple
instance type allocation with Slurm](../../../parallelcluster/latest/ug/slurm-multiple-instance-allocation-v3.md "../../../parallelcluster/latest/ug/slurm-multiple-instance-allocation-v3.md").
...
3.4](https://aws.amazon.com/blogs/hpc/multiple-availability-zones-now-supported-in-aws-parallelcluster-3-4/ "https://aws.amazon.com/blogs/hpc/multiple-availability-zones-now-supported-in-aws-parallelcluster-3-4/")), and all or nothing scheduling ( see
[Minimize
HPC compute costs with all-or-nothing instance
launching](https://aws.amazon.com/blogs/hpc/minimize-hpc-compute-costs-with-all-or-nothing-instance-launching/ "https://aws.amazon.com/blogs/hpc/minimize-hpc-compute-costs-with-all-or-nothing-instance-launching/")), to help take full advantage of any
