...
[AWS Batch](https://aws.amazon.com/batch/ "https://aws.amazon.com/batch/"), or develop job orchestration to create an
...
[Event-driven
weather forecasts](https://github.com/aws-samples/event-driven-weather-forecasts "https://github.com/aws-samples/event-driven-weather-forecasts") shows you how this case can be
...
[AWS ParallelCluster](../../../parallelcluster/latest/ug/what-is-aws-parallelcluster.md "../../../parallelcluster/latest/ug/what-is-aws-parallelcluster.md") enable you to leverage these
...
as [AWS Parallel
Computing Service](https://aws.amazon.com/pcs/ "https://aws.amazon.com/pcs/") take this one level further, and
...
[AWS Batch](https://aws.amazon.com/batch/ "https://aws.amazon.com/batch/") is a cloud native scheduler that can integrate
with services such as
[AWS Step Functions](https://aws.amazon.com/step-functions/ "https://aws.amazon.com/step-functions/") for complex workflow logic, as well as
...
| HPCOPS03: Does your use case require data movement between separated<br>environments, and how is this handled? |
| -------------------------------------------------------------------------------------------------------------- |
|                                                                                                                |
...
[Scenarios](scenarios.md "scenarios.md") for additional
considerations.
...
[AWS Research and Engineering Studio](../../../res/latest/ug/overview.md "../../../res/latest/ug/overview.md") to streamline your VDI
...
[Elastic
visualization queues with Amazon DCV in AWS ParallelCluster](https://aws.amazon.com/blogs/hpc/elastic-visualization-queues-with-nice-dcv-in-aws-parallelcluster/ "https://aws.amazon.com/blogs/hpc/elastic-visualization-queues-with-nice-dcv-in-aws-parallelcluster/"). VDI solutions offer the additional
...
pillar](performance-efficiency.md "performance-efficiency.md").

| HPCOPS04: How will you handle future environment updates with minimal user<br>impact? |
| ------------------------------------------------------------------------------------- |
|                                                                                       |
...
[FSx for Lustre](https://aws.amazon.com/fsx/lustre/ "https://aws.amazon.com/fsx/lustre/") file system for you, choose to create a file
...
example with an
[Application Load Balancer](../../../elasticloadbalancing/latest/application/introduction.md "../../../elasticloadbalancing/latest/application/introduction.md") (ALB),
[Elastic
IP addresses](../../../AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.md "../../../AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.md"), or abstracting the submission to the
scheduler with a user facing submission form that can be
connected to different schedulers, such as
[Open
OnDemand](https://openondemand.org/ "https://openondemand.org/"). This will allow you to replace the cluster
...
systems in the
[SharedStorage](../../../parallelcluster/latest/ug/SharedStorage-v3.md "../../../parallelcluster/latest/ug/SharedStorage-v3.md")
...
See
[Operational
excellence](../operational-excellence-pillar/operational-excellence.md "../operational-excellence-pillar/operational-excellence.md") pillar of the AWS Well Architected whitepaper
...
[Creating
a cluster with AWS CloudFormation](../../../parallelcluster/latest/ug/tutorials_09_cfn-custom-resource-v3.md "../../../parallelcluster/latest/ug/tutorials_09_cfn-custom-resource-v3.md"). This allows you to
...
[HPC
Recipes for AWS](https://github.com/aws-samples/aws-hpc-recipes "https://github.com/aws-samples/aws-hpc-recipes") repository.
...
- How easy will it be to diagnose and correct various error
  ...
  responses?
  While we will test the system and implement recovery strategies in the [Reliability pillar](reliability.md "reliability.md") of the lens, planning for predictable
...
example [AWS Parallel Computing Service](https://aws.amazon.com/pcs/ "https://aws.amazon.com/pcs/"), and using the persistent
file system mode in
[Amazon FSx for Lustre](https://aws.amazon.com/fsx/lustre/ "https://aws.amazon.com/fsx/lustre/"). At the scheduler level, implement job
retries on failure.

For example, if using AWS Batch you can implement
[Automated
job retries](../../../batch/latest/userguide/job_retries.md "../../../batch/latest/userguide/job_retries.md") strategies to take action based on the
reason for failure.
