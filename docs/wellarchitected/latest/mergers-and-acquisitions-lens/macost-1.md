...
progressing with AWS hosting for both companies?
...
## MACOST01-BP01 Perform

pricing model analysis for the combined entities
...
## MACOST01-BP02 Optimize

accounts through various means, such as EC2 instance types,
Savings Plans, and Amazon S3 lifecycle

Use AWS Trusted Advisor to examine current cost savings and possible additional savings.

## MACOST01-BP03 Discover

and realize additional cost savings
...
## MACOST01-BP04 Migrate to

Regions based on cost
...
managed services for lower TCO

Understand how proper use of managed services can lower TCO.

## MACOST01-BP06 Select

third-party agreements with cost efficient terms
