...
<a name="reliability"></a>
 ...
 The reliability pillar provides an overview of design principles, best practices, and questions. You can find prescriptive guidance on implementation in the [Reliability Pillar whitepaper](https://docs.aws.amazon.com/wellarchitected/latest/reliability-pillar/welcome.html). 

**Topics**
+ [MAREL 1: How do you plan to manage application robustness and availability during mergers and acquisitions?](marel-1.md)
+ [MAREL 2: How are critical external system integrations set up for high availability to maintain your platform capabilities?](marel-2.md)
