...
1.  Differing financial needs, including taxation (Europe compared to the US) 

1.  Differing operating scope (Systems Manager) 

## MAOPS03-BP04 Merge logging, security, and infrastructure organizations
<a name="maops03-bp04"></a>
