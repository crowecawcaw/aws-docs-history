...
<a name="cost-optimization"></a>
 ...
 The cost optimization pillar provides an overview of design principles, best practices, and questions. You can find prescriptive guidance on implementation in the [Cost Optimization Pillar whitepaper](https://docs.aws.amazon.com/wellarchitected/latest/cost-optimization-pillar/welcome.html). 

**Topics**
+ [MACOST 1: How is cost optimization progressing with AWS hosting for both companies?](macost-1.md)
+ [MACOST 2: How do you plan to monitor  usage and cost of combined organizations?](macost-2.md)
+ [MACOST 3: How do you plan for data transfer and storage charges in case of required data integration after mergers and acquisitions activity?](macost-3.md)
