...
<a name="edge-layer"></a>
 ...
 [Amazon CloudFront](https://aws.amazon.com/cloudfront/) provides a CDN that securely delivers web application content and data with low latency and high transfer speeds. 