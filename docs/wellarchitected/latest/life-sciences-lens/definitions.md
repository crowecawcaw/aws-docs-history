...
+  **Digital Imaging and Communications in Medicine (DICOM):** A standard for handling, storing, printing, and transmitting medical imaging information and related data. For more detail, see [Medical Imaging on AWS](https://aws.amazon.com/health/solutions/medicalimaging/). 
...
+  **General Data Protection Regulation (GDPR):** European Union regulation governing data protection and privacy. For more detail, see [General Data Protection (GDPR) Center](https://aws.amazon.com/compliance/gdpr-center/). 
...
+  **Quality management system (QMS):** System that documents processes, procedures, and responsibilities for achieving quality policies and objectives to meet regulatory requirements in life sciences organizations. For more detail, see resources in [AWS Artifact](https://aws.amazon.com/artifact/). 
...
+  **Molecular dynamics:** Computational simulation methods used to analyze the physical movements and interactions of atoms and molecules over time. For more detail, see [High Performance Computing](https://aws.amazon.com/hpc/). 
