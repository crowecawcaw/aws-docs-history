...
1.  Stream telemetry securely into AWS IoT Core for ingestion. 

1.  Store data in Amazon Timestream for time-series analysis or Amazon S3 for long-term archival. 

1.  Configure anomaly detection with Amazon CloudWatch Alarms and notify research operations teams through Amazon SNS. 

1.  Provide researchers with performance dashboards using Quick for visualization. 
