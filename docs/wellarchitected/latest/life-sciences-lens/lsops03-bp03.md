...
1. Review the
   [AWS Shared Responsibility Model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/") to identify your areas of
   responsibility.
2. Access
   [AWS Artifact](https://aws.amazon.com/artifact/ "https://aws.amazon.com/artifact/") for audit reports and documentation.
3. Deploy AWS Audit Manager framework to create assessment
