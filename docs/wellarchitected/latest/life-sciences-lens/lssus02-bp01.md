...
1.  Define and implement normalized sustainability metrics: 
...
1.  Create sustainability KPIs aligned with research outputs: 
...
1.  Integrate metrics with AWS Customer Carbon Footprint Tool: 
...
1.  Establish continuous monitoring and optimization processes: 
...
+  [LSSUS01-BP02 Leverage energy efficient hardware and services](lssus01-bp02.html) 
