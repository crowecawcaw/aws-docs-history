...
1.  Use AWS CodeDeploy or CloudFormation change-sets with pre-defined rollback behavior. 

1.  Implement standardized rollback runbooks using AWS Systems Manager Automation so operators can run approved, automated steps. 

1.  Store validated rollback artifacts and test evidence in AWS CodeCommit or Amazon S3, and include change-control metadata for traceability. 
