...
1.  Use AWS Clean Rooms to enable granular control and data sharing without moving data or exposing sensitive information. 
 ...
 **Related examples:** 
+  [Enable data collaboration among public health agencies with AWS Clean Rooms – Part 1](https://aws.amazon.com/blogs/big-data/part-1-enable-data-collaboration-among-public-health-agencies-with-aws-clean-rooms/) 
+  [Automate AWS Clean Rooms querying and dashboard publishing using AWS Step Functions and Quick – Part 2](https://aws.amazon.com/blogs/big-data/automate-aws-clean-rooms-querying-and-dashboard-publishing-using-aws-step-functions-and-amazon-quicksight-part-2/) 
