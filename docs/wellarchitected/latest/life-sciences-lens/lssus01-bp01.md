...
1.  Design compute environments aligned with workload characteristics: 
...
1.  Implement multi-queue strategy for efficient resource allocation: 
...
1.  Enable automated scaling and resource optimization: 
...
1.  Establish monitoring and optimization processes: 
 ...
 **Related documents:** 
+  [Accelerating Life Sciences Research with HPC on AWS](https://pages.awscloud.com/rs/112-TZM-766/images/2018_0517-CMP_Slide-Deck.pdf) 
 ...
 **Related videos:** 
+  [AWS re:Invent 2023 - HPC on AWS for semiconductors and healthcare life sciences (CMP214)](https://www.youtube.com/watch?v=K-2d-pqe5nU) 
+  [AWS Summit 2023 - Building sustainable research computing on AWS](https://www.youtube.com/watch?v=example) 

 **Related examples:** 
+  [HPC Workloads on AWS](https://github.com/aws-samples/aws-hpc-recipes) 
+  [AWS Batch for Life Sciences](https://github.com/aws-samples/aws-batch-genomics) 
+  [Genomics Workflows on AWS](https://github.com/aws-samples/genomics-secondary-analysis-using-aws-step-functions-and-aws-batch) 
