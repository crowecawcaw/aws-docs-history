...
1.  Execute functional tests with containerized workloads on Amazon ECS/EKS or serverless tests with AWS Lambda. 

1.  Capture logs and results in Amazon CloudWatch Logs and archive them to Amazon S3 for long-term retention. 

1.  Use AWS Audit Manager to generate audit evidence linking test execution to change approvals. 