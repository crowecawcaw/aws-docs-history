...
**Topics**
+ [LSPERF09-BP01 Evaluate data stores based on regulatory requirements and data governance capabilities](lsperf09-bp01.md)
+ [LSPERF09-BP02 Optimize query performance and meet diverse data access requirements in your environment](lsperf09-bp02.md)
+ [LSPERF10-BP01 Implement tiered caching architecture with clinical data classification and lifecycle management](lsperf10-bp01.md)
