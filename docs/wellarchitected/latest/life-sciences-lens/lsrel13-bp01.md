...
1.  Capture logs centrally in Amazon CloudWatch Logs. 

1.  Use AWS X-Ray for distributed tracing of microservices. 

1.  Monitor configuration drift with AWS Config and events with AWS Security Hub CSPM. 

1.  Store monitoring evidence in Amazon S3 for regulatory audits. 