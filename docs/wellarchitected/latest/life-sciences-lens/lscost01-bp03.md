...
<a name="implementation-guidance"></a>
 ...
 Implement a gamification system that rewards research teams for cost-effective cloud usage while maintaining research quality (for example, [AWS GameDay](https://aws.amazon.com/gameday/)). 
