...
- [SEC03-BP01
  Define access requirements](../framework/sec_permissions_define.md "../framework/sec_permissions_define.md")
- [SEC04-BP01 Configure
  service and application logging](../framework/sec_detect_investigate_events_app_service_logging.md "../framework/sec_detect_investigate_events_app_service_logging.md")
- [SEC07-BP01
  Understand your data classification scheme](../framework/sec_data_classification_identify_data.md "../framework/sec_data_classification_identify_data.md")
- [OPS01-BP03
  Evaluate governance requirements](../framework/ops_priorities_governance_reqs.md "../framework/ops_priorities_governance_reqs.md")
- [OPS01-BP04
  Evaluate compliance requirements](../framework/ops_priorities_compliance_reqs.md "../framework/ops_priorities_compliance_reqs.md")
- [PERF01-BP05
  Use policies and reference architectures](../framework/perf_architecture_use_policies_and_reference_architectures.md "../framework/perf_architecture_use_policies_and_reference_architectures.md")
- [COST02-BP01
  Develop policies based on your organization
  requirements](../framework/cost_govern_usage_policies.md "../framework/cost_govern_usage_policies.md")
