...
- Have a structured process for how penetration testing is
  ...
  [threat
  model](https://aws.amazon.com/blogs/security/how-to-approach-threat-modeling/ "https://aws.amazon.com/blogs/security/how-to-approach-threat-modeling/") is a good way of maintaining context.
...
- [AWS Penetration Testing](https://aws.amazon.com/security/penetration-testing/ "https://aws.amazon.com/security/penetration-testing/") provides detailed guidance for
...
- [Modernize
  your penetration testing architecture on AWS Fargate](https://aws.amazon.com/blogs/architecture/modernize-your-penetration-testing-architecture-on-aws-fargate/ "https://aws.amazon.com/blogs/architecture/modernize-your-penetration-testing-architecture-on-aws-fargate/")
- [AWS Fault
  injection Simulator](https://aws.amazon.com/fis/ "https://aws.amazon.com/fis/")

**Related examples:**

- [Automate API testing with AWS CodePipeline](https://github.com/aws-samples/aws-codepipeline-codebuild-with-postman "https://github.com/aws-samples/aws-codepipeline-codebuild-with-postman") (GitHub)
- [Automated security
  helper](https://github.com/aws-samples/automated-security-helper "https://github.com/aws-samples/automated-security-helper") (GitHub)
