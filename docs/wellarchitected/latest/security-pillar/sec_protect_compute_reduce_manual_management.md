...
[AWS Systems Manager](https://aws.amazon.com/systems-manager/ "https://aws.amazon.com/systems-manager/"). AWS Systems Manager Agent (SSM Agent) initiates an encrypted
channel and thus does not rely on listening for
externally-initiated requests. Consider configuring SSM Agent to
[establish
this channel over a VPC endpoint](../../../systems-manager/latest/userguide/setup-create-vpc.md "../../../systems-manager/latest/userguide/setup-create-vpc.md").
...
[AWS CloudTrail](https://aws.amazon.com/cloudtrail/ "https://aws.amazon.com/cloudtrail/") records invocations of Systems Manager APIs for inspection.

### Implementation steps

1. [Install
   AWS Systems Manager Agent](../../../systems-manager/latest/userguide/manually-install-ssm-agent-linux.md "../../../systems-manager/latest/userguide/manually-install-ssm-agent-linux.md") (SSM Agent) on your Amazon EC2 instances. Check to see if SSM Agent is included and
   started automatically as part of your base AMI
   configuration.
2. Verify that the IAM Roles associated with your EC2 instance
   profiles include the `AmazonSSMManagedInstanceCore`
   [managed
   IAM policy](../../../aws-managed-policy/latest/reference/AmazonSSMManagedInstanceCore.md "../../../aws-managed-policy/latest/reference/AmazonSSMManagedInstanceCore.md").
3. Disable SSH, RDP, and other remote access services running
   ...
   EC2 Image Builder.
4. Verify that the security group ingress rules applicable to
...
5. Define appropriate automations, runbooks, and run commands
...
6. Use
   ...
   [Amazon CloudWatch Logs](../../../AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.md "../../../AmazonCloudWatch/latest/logs/WhatIsCloudWatchLogs.md") or [Amazon S3](https://aws.amazon.com/s3/ "https://aws.amazon.com/s3/").
...
- [REL08-BP04
  Deploy using immutable infrastructure](../framework/rel_tracking_change_management_immutable_infrastructure.md "../framework/rel_tracking_change_management_immutable_infrastructure.md")

**Related examples:**

- [Replacing
  SSH access to reduce management and security overhead with AWS Systems Manager](https://aws.amazon.com/blogs/mt/vr-beneficios-session-manager/ "https://aws.amazon.com/blogs/mt/vr-beneficios-session-manager/")
...
- [Controlling
  ...
  Manager](https://www.youtube.com/watch?v=nzjTIjFLiow "https://www.youtube.com/watch?v=nzjTIjFLiow")
