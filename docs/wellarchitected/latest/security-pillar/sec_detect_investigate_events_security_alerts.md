...
who (the _principal_ or
_identity_) is doing what
*(*the _action_ taken) to
what (the _resources_ affected). For each of
...
- [SEC10-BP03 Prepare
  forensic capabilities](../framework/sec_incident_response_prepare_forensic.md "../framework/sec_incident_response_prepare_forensic.md")
- [OPS08-BP04
  Create actionable alerts](../framework/ops_workload_observability_create_alerts.md "../framework/ops_workload_observability_create_alerts.md")
- [REL06-BP03
  Send notifications (Real-time processing and alarming)](../framework/rel_monitor_aws_resources_notification_monitor.md "../framework/rel_monitor_aws_resources_notification_monitor.md")
