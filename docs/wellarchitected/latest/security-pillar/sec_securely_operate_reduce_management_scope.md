...
- [PERF02-BP01
  Select the best compute options for your workload](../framework/perf_compute_hardware_select_best_compute_options.md "../framework/perf_compute_hardware_select_best_compute_options.md")
- [PERF03-BP01
...
- [SUS05-BP03
  Use managed services](../framework/sus_sus_hardware_a4.md "../framework/sus_sus_hardware_a4.md")
