...
- [SEC06-BP03
  Reduce manual management and interactive access](../framework/sec_protect_compute_reduce_manual_management.md "../framework/sec_protect_compute_reduce_manual_management.md")
