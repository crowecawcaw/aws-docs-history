...
- You should [rely on a
  centralized identity provider](sec_identities_identity_provider.md "sec_identities_identity_provider.md") and
  [require
...
rotate these credentials periodically](sec_identities_audit.md "sec_identities_audit.md") and
[rotate
...
- [SEC03-BP08 Share
  resources securely within your organization](sec_permissions_share_securely.md "sec_permissions_share_securely.md")
