...
using accounts](../framework/sec_securely_operate_multi_accounts.md "../framework/sec_securely_operate_multi_accounts.md"), you will end up with multiple AWS accounts
...
way, such as in
[AWS CloudFormation](https://aws.amazon.com/cloudformation/ "https://aws.amazon.com/cloudformation/"), and store them in a source control system.  Use DevOps practices to automate the deploying your
controls for more predictable releases, automated testing using
tools
like [AWS CloudFormation Guard](../../../cfn-guard/latest/ug/what-is-guard.md "../../../cfn-guard/latest/ug/what-is-guard.md"), and detecting drift between your
...
[AWS CodeDeploy](https://aws.amazon.com/codedeploy/ "https://aws.amazon.com/codedeploy/") to construct a CI/CD pipeline. Consider the
guidance in
[Organizing
Your AWS Environment Using Multiple Accounts](../../../whitepapers/latest/organizing-your-aws-environment/deployments-ou.md "../../../whitepapers/latest/organizing-your-aws-environment/deployments-ou.md") to configure
...
the [Account
Factory](../../../controltower/latest/userguide/af-customization-page.md "../../../controltower/latest/userguide/af-customization-page.md") capability, allowing workload teams to create new
...
1. Determine how you will store and maintain your templates in a
   version control system.
2. Create CI/CD pipelines to test and deploy your templates.
    Define tests to check for misconfigurations and that
   templates adhere to your company standards.
3. Build a catalog of standardized templates for workload teams
   to deploy AWS accounts and services according to your
   requirements.
4. Implement secure backup and recovery strategies for your
...
- [OPS05-BP01
  Use version control](../framework/ops_dev_integ_version_control.md "../framework/ops_dev_integ_version_control.md")
- [OPS05-BP04
  Use build and deployment management systems](../framework/ops_dev_integ_build_mgmt_sys.md "../framework/ops_dev_integ_build_mgmt_sys.md")
- [REL08-BP05
  Deploy changes with automation](../framework/rel_tracking_change_management_automated_changemgmt.md "../framework/rel_tracking_change_management_automated_changemgmt.md")
- [SUS06-BP01
  Adopt methods that can rapidly introduce sustainability
  improvements](../framework/sus_sus_dev_a2.md "../framework/sus_sus_dev_a2.md")

**Related documents:**

- [Organizing
  Your AWS Environment Using Multiple Accounts](../../../whitepapers/latest/organizing-your-aws-environment/deployments-ou.md "../../../whitepapers/latest/organizing-your-aws-environment/deployments-ou.md")

**Related examples:**

- [Automate
  account creation, and resource provisioning using Service Catalog, AWS Organizations, and AWS Lambda](https://aws.amazon.com/blogs/mt/automate-account-creation-and-resource-provisioning-using-aws-service-catalog-aws-organizations-and-aws-lambda/ "https://aws.amazon.com/blogs/mt/automate-account-creation-and-resource-provisioning-using-aws-service-catalog-aws-organizations-and-aws-lambda/")
- [Strengthen
  the DevOps pipeline and protect data with AWS Secrets Manager,
  AWS KMS, and AWS Certificate Manager](https://aws.amazon.com/blogs/security/strengthen-the-devops-pipeline-and-protect-data-with-aws-secrets-manager-aws-kms-and-aws-certificate-manager/ "https://aws.amazon.com/blogs/security/strengthen-the-devops-pipeline-and-protect-data-with-aws-secrets-manager-aws-kms-and-aws-certificate-manager/")

**Related tools:**

- [AWS CloudFormation Guard](../../../cfn-guard/latest/ug/what-is-guard.md "../../../cfn-guard/latest/ug/what-is-guard.md")
- [Landing
  Zone Accelerator on AWS](https://github.com/awslabs/landing-zone-accelerator-on-aws "https://github.com/awslabs/landing-zone-accelerator-on-aws")
