...
([SEC02-BP04](sec_identities_identity_provider.md "sec_identities_identity_provider.md"))
...
- You have defined and documented the failure modes that count as
  ...
  [Reliability
  pillar](../framework/a-reliability.md "../framework/a-reliability.md") useful to identify failure modes and architect
...
- Pre-create resources needed by the emergency access process
  ([SEC10-BP05](sec_incident_response_pre_provision_access.md "sec_incident_response_pre_provision_access.md")).
...
- Include emergency access processes as part of your incident
  management plans
  ([SEC10-BP02](sec_incident_response_develop_management_plans.md "sec_incident_response_develop_management_plans.md")).
...
- Test emergency access processes periodically to verify that
  ...
  ([SEC10-BP07](sec_incident_response_run_game_days.md "sec_incident_response_run_game_days.md"))
...
As described in
[SEC02-BP04
Rely on a centralized identity provider](sec_identities_identity_provider.md "sec_identities_identity_provider.md"), we recommend
...
- [SEC02-BP04
  Rely on a centralized identity provider](../framework/sec_identities_identity_provider.md "../framework/sec_identities_identity_provider.md")
- [SEC03-BP02
  Grant least privilege access](../framework/sec_permissions_least_privileges.md "../framework/sec_permissions_least_privileges.md")
- [SEC10-BP02
  Develop incident management plans](../framework/sec_incident_response_develop_management_plans.md "../framework/sec_incident_response_develop_management_plans.md")
- [SEC10-BP07
  Run game days](../framework/sec_incident_response_run_game_days.md "../framework/sec_incident_response_run_game_days.md")
