...
cross-account access](sec_permissions_analyze_cross_account.md "sec_permissions_analyze_cross_account.md").
...
[Identity
management](identity-management.md "identity-management.md"). Also, work with your AWS account team and
...
[Incident
response](incident-response.md "incident-response.md"). 4. **Verify that setup has prescriptive
...
[Detection best
practices](detection.md "detection.md").
...
- [SEC02-BP02 Use
  temporary credentials](sec_identities_unique.md "sec_identities_unique.md")
- [SEC03-BP05 Define permission
  guardrails for your organization](sec_permissions_define_guardrails.md "sec_permissions_define_guardrails.md")
- [SEC03-BP06 Manage access
  based on lifecycle](sec_permissions_lifecycle.md "sec_permissions_lifecycle.md")
- [SEC03-BP07 Analyze public and
  cross-account access](sec_permissions_analyze_cross_account.md "sec_permissions_analyze_cross_account.md")
- [SEC04 Detection](detection.md "detection.md")
