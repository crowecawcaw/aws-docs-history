...
- [PERF01-BP01
  ...
  features](../framework/perf_architecture_understand_cloud_services_and_features.md "../framework/perf_architecture_understand_cloud_services_and_features.md")
- [COST01-BP07
  Keep up-to-date with new service releases](../framework/cost_cloud_financial_management_scheduled.md "../framework/cost_cloud_financial_management_scheduled.md")
