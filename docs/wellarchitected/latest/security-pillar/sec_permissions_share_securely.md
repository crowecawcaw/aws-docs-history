...
[Analyze public and cross-account access](sec_permissions_analyze_cross_account.md "sec_permissions_analyze_cross_account.md")
...
see [Permissions management](permissions-management.md "permissions-management.md").
