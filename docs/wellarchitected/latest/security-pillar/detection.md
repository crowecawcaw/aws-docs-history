...
+ [SEC04-BP03 Correlate and enrich security alerts](sec_detect_investigate_events_security_alerts.md)
+ [SEC04-BP04 Initiate remediation for non-compliant resources](sec_detect_investigate_events_noncompliant_resources.md)