...
(_north-south_ traffic). Afterwards, look at
...
_principle of least privilege_ design.
...
domain. When using multiple VPCs, mediate routing using an [AWS Transit Gateway](https://aws.amazon.com/transit-gateway/ "https://aws.amazon.com/transit-gateway/"). While this provides traffic control at a Layer 4
...
such as [AWS PrivateLink](https://aws.amazon.com/privatelink/ "https://aws.amazon.com/privatelink/"), [Amazon Route 53 Resolver DNS Firewall](../../../Route53/latest/DeveloperGuide/resolver-dns-firewall.md "../../../Route53/latest/DeveloperGuide/resolver-dns-firewall.md"),
[AWS Network Firewall](https://aws.amazon.com/network-firewall/ "https://aws.amazon.com/network-firewall/"), and [AWS WAF](https://aws.amazon.com/waf/ "https://aws.amazon.com/waf/").
...
[AWS PrivateLink](https://aws.amazon.com/privatelink/ "https://aws.amazon.com/privatelink/"). To do this, identify which service should act
...
inspection-based protection](../framework/sec_network_protection_inspection.md "../framework/sec_network_protection_inspection.md").

### Implementation steps

1. Identify the required data flows between the components of
   your workloads.
2. Apply multiple controls with a defense-in-depth approach for
   both inbound and outbound traffic, including the use of
   security groups, and route tables.
3. Use firewalls to define fine-grained control over network
   traffic in, out, and across your VPCs, such as the Route 53
   Resolver DNS Firewall, AWS Network Firewall, and AWS WAF.
   Consider using the
   [AWS Firewall Manager](https://aws.amazon.com/firewall-manager/ "https://aws.amazon.com/firewall-manager/") for centrally configuring and
...
- [REL03-BP01
  Choose how to segment your workload](../framework/rel_service_architecture_monolith_soa_microservice.md "../framework/rel_service_architecture_monolith_soa_microservice.md")
- [SEC09-BP02
  Enforce encryption in transit](../framework/sec_protect_data_transit_encrypt.md "../framework/sec_protect_data_transit_encrypt.md")

**Related documents:**

- [Security
  best practices for your VPC](../../../vpc/latest/userguide/vpc-security-best-practices.md "../../../vpc/latest/userguide/vpc-security-best-practices.md")
...
- [Guidance
  for Network Security on AWS](https://aws.amazon.com/solutions/guidance/network-security-on-aws/ "https://aws.amazon.com/solutions/guidance/network-security-on-aws/")
- [Secure
  your VPC's outbound network traffic in the AWS Cloud](../../../prescriptive-guidance/latest/secure-outbound-network-traffic/welcome.md "../../../prescriptive-guidance/latest/secure-outbound-network-traffic/welcome.md")
...
- [AWS Transit Gateway reference architectures for many VPCs](https://youtu.be/9Nikqn_02Oc "https://youtu.be/9Nikqn_02Oc")
- [Application
  Acceleration and Protection with Amazon CloudFront, AWS WAF,
  and AWS Shield](https://youtu.be/0xlwLEccRe0 "https://youtu.be/0xlwLEccRe0")
- [AWS re:Inforce 2023: Firewalls and where to put them](https://www.youtube.com/watch?v=lTJxWAiQrHM "https://www.youtube.com/watch?v=lTJxWAiQrHM")
