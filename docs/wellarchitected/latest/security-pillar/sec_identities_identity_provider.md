...
- [SEC02-BP06 Employ user groups
  and attributes](sec_identities_groups_attributes.md "sec_identities_groups_attributes.md")
- [SEC03-BP02 Grant
  least privilege access](sec_permissions_least_privileges.md "sec_permissions_least_privileges.md")
- [SEC03-BP06 Manage
  access based on lifecycle](sec_permissions_lifecycle.md "sec_permissions_lifecycle.md")
