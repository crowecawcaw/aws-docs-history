...
- [SEC11-BP07 Regularly assess security properties of the pipelines](sec_appsec_regularly_assess_security_properties_of_pipelines.md "sec_appsec_regularly_assess_security_properties_of_pipelines.md")
