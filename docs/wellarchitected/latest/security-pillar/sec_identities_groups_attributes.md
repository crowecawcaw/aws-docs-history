...
1. Establish where you will define groups and attributes:
   1. Following the guidance in
      ...
      centralized identity provider](sec_identities_identity_provider.md "sec_identities_identity_provider.md"), you can determine
...
- [SEC03-BP02 Grant
  least privilege access](sec_permissions_least_privileges.md "sec_permissions_least_privileges.md")
- [COST02-BP04
  Implement groups and roles](../framework/cost_govern_usage_groups_roles.md "../framework/cost_govern_usage_groups_roles.md")
