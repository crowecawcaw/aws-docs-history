...
<a name="implementation-guidance-39"></a>
 ...
 Consider benchmark evaluation for [Amazon EC2](https://aws.amazon.com/ec2/) Intel and Graviton instances for Aerospike and Databricks. 
...
+  [Running operational workloads with Aerospike at petabyte scale in the cloud on 20 nodes](https://aerospike.com/resources/white-papers/running-operational-workloads/) 
+  Introducing the Well-Architected Data Lakehouse from Databricks[6 Guiding Principles to Build an Effective Data Lakehouse](https://www.databricks.com/blog/2022/07/14/6-guiding-principles-to-build-an-effective-data-lakehouse.html) 
