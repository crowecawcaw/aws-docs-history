...
+  [AWS Compute Optimizer](https://aws.amazon.com/compute-optimizer/) (Recommends optimal compute resources) 
+  [AWS Instance Scheduler](https://aws.amazon.com/solutions/implementations/instance-scheduler/) (Schedules starting/stopping instances) 
+  [AWS Spot Instances](https://aws.amazon.com/ec2/spot/) (Discounted spare compute capacity) 
