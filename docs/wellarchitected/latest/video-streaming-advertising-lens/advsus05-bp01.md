...
- Use
  [Amazon S3 storage lifecycle](../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md "../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md") rules to automate the expiration
...
- [Amazon S3 Storage Lens](../../../AmazonS3/latest/userguide/storage-lens-optimize-storage.md "../../../AmazonS3/latest/userguide/storage-lens-optimize-storage.md") can identify incomplete multipart
...
- [AWS Config](https://aws.amazon.com/config/ "https://aws.amazon.com/config/") can also identify if you have unused
  resources, such as
  [EBS
  volumes](https://aws.amazon.com/ebs/ "https://aws.amazon.com/ebs/").
- Use
  [Amazon ECR lifecycle policies](../../../AmazonECR/latest/userguide/LifecyclePolicies.md "../../../AmazonECR/latest/userguide/LifecyclePolicies.md") to expire old images used for
