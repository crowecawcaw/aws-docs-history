...
<a name="multi-region-advertising"></a>
...
![Displays the intake traffic routing to different regions within North America](http://docs.aws.amazon.com/wellarchitected/latest/video-streaming-advertising-lens/images/america-traffic-routing.png)
   ...
   1.  DSP patterns are replicated at a Regional boundary, and the calls from the ad network to DSP are made over the internet through RTB protocol to DSP load balancers. 

## Data management considerations
<a name="data-management-considerations"></a>
