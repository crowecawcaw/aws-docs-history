...
- [Compliance validation for Macie](../../../macie/latest/user/compliance-validation.md "../../../macie/latest/user/compliance-validation.md")
- [Compliance validation for AWS Key Management Service](../../../kms/latest/developerguide/kms-compliance.md "../../../kms/latest/developerguide/kms-compliance.md")
