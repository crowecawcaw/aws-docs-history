...
<a name="implementation-guidance-3"></a>
 ...
 Monitor and set KPIs and SLOs for infrastructure services using [Amazon CloudWatch](https://aws.amazon.com/cloudwatch/) for services like [Amazon EC2](https://aws.amazon.com/ec2/) and [Amazon EBS](https://aws.amazon.com/ebs/). Set up CloudWatch Alarms for resource utilization, performance, and availability. 
