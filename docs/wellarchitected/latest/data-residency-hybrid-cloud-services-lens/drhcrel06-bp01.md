...
<a name="implementation-guidance-41"></a>
 ...
 Monitor AWS Health events through [AWS EventBridge,](https://aws.amazon.com/eventbridge/) [AWS Health API](https://docs.aws.amazon.com/health/latest/ug/health-api.html), or email. We recommend updating the correct contact information, especially the operations contact as described [in our accounts documentation so that the correct individuals receive these events.](https://docs.aws.amazon.com/accounts/latest/reference/manage-acct-update-contact.html) Provide sufficient capacity and highly available design to avoid any impact during maintenance activities. 