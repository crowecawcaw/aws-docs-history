...
<a name="implementation-guidance-49"></a>
 ...
 To properly place a workload, you must understand your workload profiles and requirements. AWS offers a range of options across the cloud continuum, including AWS Outposts, Local Zones, and [Regions](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/), each with different capabilities and [costs](https://calculator.aws/#/). By evaluating workload requirements, you can select the most cost-effective location to run your workloads while meeting your data residency and service requirements. 