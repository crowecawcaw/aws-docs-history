...
**Topics**
+ [DRHCREL05-BP01 Provision spare compute capacity following an N\+M model](drhcrel05-bp01.md)
+ [DRHCREL05-BP02 To mitigate the impact of Availability Zone or Region failures, deploy multiple Outposts anchored to different Availability Zones or Regions](drhcrel05-bp02.md)
