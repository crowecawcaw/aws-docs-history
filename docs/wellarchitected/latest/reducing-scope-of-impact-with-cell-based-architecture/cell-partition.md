...
**Topics**
+ [Full mapping](full-mapping.md)
+ [Prefix and range-based mapping](prefix-and-range-based-mapping.md)
+ [Naïve modulo mapping or fixed partition number](naive-modulo-mapping-or-fixed-partition-number.md)
+ [Consistent hashing](consistent-hashing.md)
+ [A warning for all mapping approaches](a-warning-for-all-mapping-approaches.md)