...
<a name="benefits-and-risks"></a>
 ...
 Note that the risk posed by the AI system implementation when applied to the use case is referred to as residual risk. This is computed in [Monitoring](monitoring.md), as part of the process of deciding whether the AI system is ready for release. 

**Topics**
+ [Characterize benefits](raibr01.md)
+ [Harmful events](raibr02.md)
+ [Assess risks](raibr03.md)
+ [Mitigate risks](raibr04.md)