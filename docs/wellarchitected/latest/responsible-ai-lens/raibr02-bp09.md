...
1. Choose which strategies are appropriate to use for your design
   and development process and assign owners to track the
   progress and iterations of each employed scenario.
2. Establish a standardized documentation process for recording
   identified harmful events across different contexts.
3. Implement regular review cycles to reassess potential harms as
