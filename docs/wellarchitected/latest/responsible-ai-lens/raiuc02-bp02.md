...
1. Map out the roles involved in your AI system's lifecycle from
   ...
   or constraints.
2. Identify external stakeholders who contribute to or influence
   ...
   operation.
3. Document the specific ways each stakeholder group contributes
...
4. Include oversight and governance stakeholders who may not be
...
5. Create a stakeholder contact list with clear points of contact
...
- [ISO/IEC
  42001:2023](https://www.iso.org/standard/42001 "https://www.iso.org/standard/42001") A.3.2 AI roles and responsibilities
- [NIST
  Artificial Intelligence Risk Management Framework (NIST AI
  100-1)](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf "https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf"): MAP1.1, MAP1.2, GOVERN5.1
