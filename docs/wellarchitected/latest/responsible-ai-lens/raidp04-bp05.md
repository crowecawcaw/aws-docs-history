...
1. If needed, create standardized datasheet templates that
...
3. Set up processes to keep your datasheets current as you learn
...
- [Datasheets
  for Datasets](https://arxiv.org/pdf/1803.09010 "https://arxiv.org/pdf/1803.09010")
- [ISO/IEC
