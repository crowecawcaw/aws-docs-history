...
<a name="implementation-considerations-32"></a>
...
+  [Common fairness metrics](https://fairlearn.org/main/user_guide/assessment/common_fairness_metrics.html) 
