...
1. Take each potential harm and expected benefit you identified
...
2. Check that every question can only be answered yes or no based
...
3. For each criterion, document the stakeholders who would be
