...
1. Use validation datasets exclusively for choosing between
...
2. Run head-to-head comparisons where each candidate version
...
3. Apply paired statistical tests to determine whether
