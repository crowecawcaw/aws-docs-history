...
1.  Define clear boundaries for the problem scope, including domain, geographic, and user segment limitations. 

1.  Evaluate the urgency by quantifying inaction costs and quantifying potential benefits of solving the problem. 

1.  Draft a structured problem statement using a format such as "Enable <user> to <infer, generate, do <y> given input <x> when <context> every <frequency> with <benefit>". 

1.  Validate the problem statement with key stakeholders, confirm its current relevance, and refine based on feedback. 
