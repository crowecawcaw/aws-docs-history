...
<a name="implementation-considerations-15"></a>
...
1.  Consider what types of data might unexpectedly appear in training or operations, whether the unexpected data could be confidential or personal, and what harms might result if this data was not blocked from flowing into development or operational pipelines. 
