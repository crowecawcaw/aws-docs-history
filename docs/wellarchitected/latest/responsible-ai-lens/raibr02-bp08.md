...
1. Identify decision points where users rely on AI outputs. For
...
2. Consider differing levels of expertise among stakeholder
   groups.
3. Evaluate how transparency gaps might hide or amplify other
