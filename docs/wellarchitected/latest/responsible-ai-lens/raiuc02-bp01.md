...
1. Organize workshops with potential end users, buyers, builders,
   and operators to brainstorm potential stakeholders. Include
   people with different backgrounds and expertise.
2. Categorize identified stakeholders into primary users (for
   ...
   categories.
3. Analyze each stakeholder group's relationship to the AI system
...
4. Review and validate the stakeholder list periodically
...
- [NIST
  ...
  100-1)](https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf "https://nvlpubs.nist.gov/nistpubs/ai/NIST.AI.100-1.pdf"): MAP1.1, MAP5.1, GOVERN5.1
