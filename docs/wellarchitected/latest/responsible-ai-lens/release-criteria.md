...
1.  Are we at least 99% confident that the maximum disparity between false positive rates across all product categories < 10% (yes or no)? 

 The release decision itself is also a binary decision that aggregates the results from each individual release criterion. [Evaluate and release](evaluate-and-release.md) addresses the release decision. 

**Topics**
+ [Define release criteria](rairc01.md)
+ [Measure test properties](rairc02.md)
+ [Select metrics](rairc03.md)
+ [Release criteria thresholds](rairc04.md)