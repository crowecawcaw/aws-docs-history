...
+ **Leverage existing solutions and capabilities where possible.** Support the reuse of platforms, panels, marketplaces, research, design systems, and existing solutions or components where possible. 
  + **Improvement plan** – Encourage the organization to identify and leverage reusable tools, solutions, research and methods for the service. See the [AWS Solutions Library](https://aws.amazon.com/solutions/). 
