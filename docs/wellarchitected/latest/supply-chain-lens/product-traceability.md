...
1.  Processing through Amazon SageMaker AI ML models and AI services 

1.  Real-time analysis and prediction 

1.  API-based service delivery 

1.  Continuous monitoring and optimization 

## Architecture objectives
<a name="architecture-objectives-6"></a>
