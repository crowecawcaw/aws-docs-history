...
1.  Document user access patterns, roles, and network access methods. 

1.  Create a stakeholder map that outlines the relationships and dependencies. 