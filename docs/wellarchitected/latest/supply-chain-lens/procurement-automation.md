...
<a name="procurement-automation"></a>
...
1.  AWS Lambda processes these documents through Amazon Textract. 

1.  Extracted data from the scanned documents are saved into Amazon S3. 

1.  AWS Lambda processes these documents through Amazon Bedrock for analysis, categorization, and generating additional information like summaries. 

1.  AWS Lambda posts the output to Amazon DynamoDB. 

1.  API integration is used to post the processed results 

## Architecture objectives
<a name="architecture-objectives-1"></a>
+  Process automation 
