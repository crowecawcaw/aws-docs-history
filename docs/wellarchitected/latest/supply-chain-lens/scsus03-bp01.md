...
1.  Implement comprehensive tagging strategies for AWS services to enable the tracking by SCOR model areas and Supply Chain network locations. 

1.  Establish metrics and monitoring systems to track performance and emissions across all SCOR model areas. 

1.  Create aggregated views that show the percentage of operations running in cloud versus on-premises for each supply chain area of the model. 

1.  Identify and plan migration strategies for the services corresponding to the on-premises percentage that you would move to the cloud to gain additional sustainability benefits. 

1.  Regularly review and update the map of your supply chain to reflect changes you might have applied to your operations, and to get an updated status of where you are towards your sustainability targets. 