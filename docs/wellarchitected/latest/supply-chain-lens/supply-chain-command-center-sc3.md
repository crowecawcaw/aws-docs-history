...
<a name="supply-chain-command-center-sc3"></a>
...
<a name="architecture-description-3"></a>

1.  Ingest data from internal or external systems into Amazon S3 for loading into Amazon Redshift. 

1.  AWS Glue and AWS Glue DataBrew convert the raw data from Amazon S3 into Amazon Redshift for application access, queries, and dashboards. 

1.  Amazon SageMaker AI provides AI/ML for data management, analysis, decision support, and recommendations. 

1.  Amazon Amplify provides the front-end user experience. AWS Step Functions manage automated process flows. Amazon Location Services provides map-based visualizations. AWS Lambda holds business Logic. Amazon Quicksight provides dashboards and metrics. 

## Architecture objectives
<a name="architecture-objectives-3"></a>
