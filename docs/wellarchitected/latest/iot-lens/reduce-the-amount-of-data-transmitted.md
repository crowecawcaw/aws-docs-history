...
<a name="reduce-the-amount-of-data-transmitted"></a>
 ...
 One commonly used format is protobuf (Protocol Buffers).  Protobuf is a language and platform neutral, extensible mechanism for serializing structured data. It allows efficient binary encoding of device messages with low communication overhead and low CPU usage.  Protobuf data structures can change over time with backward compatibility, reducing operational overhead.  AWS IoT Core supports the [ingestion and translation of protobuf messages](https://docs.aws.amazon.com/iot/latest/developerguide/binary-payloads.html#binary-payloads-protobuf) natively, making it straightforward for applications to use this feature. 
