...
<a name="software-and-architecture-cloud"></a>
...
|   | 
 ...
 More detailed guidance on sustainability practices in the cloud can be found in documentation relating to those services as well as in the [Sustainability Pillar](https://docs.aws.amazon.com/wellarchitected/latest/sustainability-pillar/cloud-sustainability.html) of the [AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/framework/welcome.html). 

## IOTSUS02-BP01 Use the Basic Ingest feature in AWS IoT Core
<a name="iotsus02-bp01"></a>
