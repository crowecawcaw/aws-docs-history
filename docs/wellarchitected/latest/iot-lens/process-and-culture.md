...
+  [Custom metrics](https://docs.aws.amazon.com/iot-device-defender/latest/devguide/dd-detect-custom-metrics.html) 
...
+  [Using Device Jobs for Over-the-Air Updates](https://aws.amazon.com/blogs/iot/using-device-jobs-for-over-the-air-updates/) 
+  [Introducing Secure Tunneling for AWS IoT Device Management, a new secure way to troubleshoot IoT devices](https://aws.amazon.com/blogs/iot/introducing-secure-tunneling-for-aws-iot-device-management-a-new-secure-way-to-troubleshoot-iot-devices/) 