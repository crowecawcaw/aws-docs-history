...
<a name="managing-demand-and-supplying-resources"></a>
...
+  **Immutable data:** Use the [AWS IoT device registry](https://docs.aws.amazon.com/iot/latest/developerguide/iot-thing-management.html) device attributes for immutable data such as a serial number. 
