...
<a name="hardware-and-services-optimization"></a>
...
1.  Optimize transportation routes and modes to minimize emissions from shipping products. 

1.  Use energy-efficient manufacturing processes, such as using low-temperature solder during the pick-and-place operation to reduce energy consumption for heating solder on printed circuit boards (PCBs). 

1.  Design IoT devices and packaging in smaller form factors to allow for easier and more efficient shipping in large volumes while consuming fewer raw materials and harmful chemicals. 

1.  Consider the entire supply chain and make decisions that contribute to positive environmental outcomes through thoughtful product design, material selection, and manufacturing processes. 

## IOTSUS03-BP03 Use benchmarks to help you make a processor choice
<a name="iotsus03-bp03"></a>
