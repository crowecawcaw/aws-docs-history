...
<a name="software-and-architecture-optimization"></a>
 ...
 **Prescriptive guidance** 
 ...
 Support [exponential backoff with jitter](https://aws.amazon.com/blogs/architecture/exponential-backoff-and-jitter/) when handling connection retries to cloud endpoints. 
