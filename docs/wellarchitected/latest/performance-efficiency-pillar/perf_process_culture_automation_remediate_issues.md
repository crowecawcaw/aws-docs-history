...
- **Identify remediation workflow:**
  ...
  as
  [Amazon CloudWatch](../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md "../../../AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.md") or AWS X-Ray to help you better understand
...
- **Automate the remediation:**
  ...
  [AWS Systems Manager Automation](../../../systems-manager/latest/userguide/systems-manager-automation.md "../../../systems-manager/latest/userguide/systems-manager-automation.md") provides a secure and
...
- [Using
  Alarms and Alarm Actions in CloudWatch](../../../sdk-for-go/v1/developer-guide/cw-example-using-alarm-actions.md "../../../sdk-for-go/v1/developer-guide/cw-example-using-alarm-actions.md")
- [Build a Cloud Automation Practice for Operational Excellence: Best Practices from AWS Managed Services](https://aws.amazon.com/blogs/mt/build-a-cloud-automation-practice-for-operational-excellence-best-practices-from-aws-managed-services/ "https://aws.amazon.com/blogs/mt/build-a-cloud-automation-practice-for-operational-excellence-best-practices-from-aws-managed-services/")
...
- [AWS re:Invent 2023 - Strategies for automated scaling, remediation, and smart self-healing](https://www.youtube.com/watch?v=nlGyIa3UQYU "https://www.youtube.com/watch?v=nlGyIa3UQYU")
...
- [AWS re:Invent 2021 - Intelligently
  automating cloud operations](https://www.youtube.com/watch?v=m0S8eAF0l54 "https://www.youtube.com/watch?v=m0S8eAF0l54")
...
- [AWS re:Invent 2022 - Automating
  patch management and compliance using AWS](https://www.youtube.com/watch?v=gL3baXQJvc0 "https://www.youtube.com/watch?v=gL3baXQJvc0")
...
- [AWS re:Invent 2021 -{New Launch} Automatically detect and resolve issues with Amazon DevOps Guru](https://www.youtube.com/watch?v=iwQNQHwoXfk "https://www.youtube.com/watch?v=iwQNQHwoXfk")
- [AWS re:Invent 2023 - Centralize your operations](https://www.youtube.com/watch?v=9-RBjmhDdaM "https://www.youtube.com/watch?v=9-RBjmhDdaM")

**Related examples:**

- [CloudWatch Logs Customize Alarms](https://github.com/awslabs/cloudwatch-logs-customize-alarms "https://github.com/awslabs/cloudwatch-logs-customize-alarms")
