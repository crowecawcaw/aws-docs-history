...
- [Step 1: Create a DynamoDB table with a stream enabled](#Streams.Lambda.Tutorial.CreateTable "#Streams.Lambda.Tutorial.CreateTable")
- [Step 2: Create a Lambda execution role](#Streams.Lambda.Tutorial.CreateRole "#Streams.Lambda.Tutorial.CreateRole")
- [Step 3: Create an Amazon SNS topic](#Streams.Lambda.Tutorial.SNSTopic "#Streams.Lambda.Tutorial.SNSTopic")
- [Step 4: Create and test a Lambda function](#Streams.Lambda.Tutorial.LambdaFunction "#Streams.Lambda.Tutorial.LambdaFunction")
- [Step 5: Create and test a trigger](#Streams.Lambda.Tutorial.CreateTrigger "#Streams.Lambda.Tutorial.CreateTrigger")
...
create in [Step 4: Create and test a Lambda function](#Streams.Lambda.Tutorial.LambdaFunction "#Streams.Lambda.Tutorial.LambdaFunction").
...
3. When you create the Lambda function, you specify the Amazon Resource Name
   (ARN) for `WooferLambdaRole`, which you created in [Step 2: Create a Lambda execution role](#Streams.Lambda.Tutorial.CreateRole "#Streams.Lambda.Tutorial.CreateRole"). Enter the
