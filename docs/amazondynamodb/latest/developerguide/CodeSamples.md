...
- [Java code examples](CodeSamples.md "CodeSamples.md")
- [.NET code examples](CodeSamples.md "CodeSamples.md")
  ...
  information, see [Setting up DynamoDB (web service)](SettingUp.md "SettingUp.md") .
...
see [Setting the local endpoint](DynamoDBLocal.md#DynamoDBLocal.Endpoint "DynamoDBLocal.md#DynamoDBLocal.Endpoint") .
