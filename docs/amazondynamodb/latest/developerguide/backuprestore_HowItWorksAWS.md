...
your AWS resources in one place. To use AWS Backup, you must affirmatively [opt-in](../../../aws-backup/latest/devguide/service-opt-in.md "../../../aws-backup/latest/devguide/service-opt-in.md"). Opt-in
choices apply to the specific account and AWS Region, so you might have to opt in to multiple
Regions using the same account. For more information, see the [AWS Backup Developer Guide](../../../aws-backup/latest/devguide/whatisbackup.md "../../../aws-backup/latest/devguide/whatisbackup.md").
...
- [Backing up and restoring DynamoDB tables with AWS Backup: How it
  works](GettingStartedBackupsAWS.md "GettingStartedBackupsAWS.md")
...
- [Usage note differences between on-demand backups managed by
  AWS Backup and DynamoDB](UsageNotesAWS.md "UsageNotesAWS.md")
