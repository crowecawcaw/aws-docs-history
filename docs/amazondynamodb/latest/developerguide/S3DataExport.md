...
table data. These files are all saved in the Amazon S3 bucket that you specify in your [export request](S3DataExport_Requesting.md "S3DataExport_Requesting.md"). The following sections describe
...
[JSON lines](https://jsonlines.org/ "https://jsonlines.org/"). This means that
...
[Amazon Ion](http://amzn.github.io/ion-docs/ "http://amzn.github.io/ion-docs/") is a
...
DynamoDB supports exporting table data in Ion's [text format](http://amzn.github.io/ion-docs/docs/spec.html "http://amzn.github.io/ion-docs/docs/spec.html"),
...
datatypes](http://amzn.github.io/ion-docs/docs/spec.html "http://amzn.github.io/ion-docs/docs/spec.html"). DynamoDB sets use [Ion type
annotations](http://amzn.github.io/ion-docs/docs/spec.html#annot "http://amzn.github.io/ion-docs/docs/spec.html#annot") to disambiguate the datatype used in the source
table.
...
| Update          | Keys + new image | Keys + new image + old image |
