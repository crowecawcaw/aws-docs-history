...
![4 different scenarios showing provisioned throughput intervals, requests, and good and bad results on a table.](images/ThroughputIntervals.png)
...
implementing exponential backoff, see [Error retries and exponential backoff](Programming.Errors.md#Programming.Errors.RetryAndBackoff "Programming.Errors.md#Programming.Errors.RetryAndBackoff").
