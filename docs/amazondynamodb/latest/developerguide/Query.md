...
information, see [Expression attribute names (aliases) in DynamoDB](Expressions.md "Expressions.md").
...
`:sub`) instead of actual values. For more information, see [Expression attribute names (aliases) in DynamoDB](Expressions.md "Expressions.md") and [Using expression attribute values in DynamoDB](Expressions.md "Expressions.md").
