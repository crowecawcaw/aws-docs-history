...
- [Top-level attributes](#Expressions.Attributes.TopLevelAttributes "#Expressions.Attributes.TopLevelAttributes")
...
[Referring to item attributes when using expressions in DynamoDB](Expressions.Attributes.md "Expressions.Attributes.md").)
...
For more information, see [Expression attribute names (aliases) in DynamoDB](Expressions.ExpressionAttributeNames.md "Expressions.ExpressionAttributeNames.md").
