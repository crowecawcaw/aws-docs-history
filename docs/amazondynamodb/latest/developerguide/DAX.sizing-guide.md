...
+ Cache hit rate
+ [Read capacity units](provisioned-capacity-mode.md#read-write-capacity-units) (RCUs) per second
+ [Write capacity units](provisioned-capacity-mode.md#read-write-capacity-units) (WCUs) per second
