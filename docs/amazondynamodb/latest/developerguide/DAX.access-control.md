...
When you create a DAX cluster, do not include sensitive identifying information, such as your customers' account numbers, in the cluster name. Cluster names can be visible outside your account. When you enable encryption in transit, DAX uses AWS Certificate Manager (ACM) to provision a Transport Layer Security (TLS) certificate for the cluster endpoint, and that certificate includes your cluster name.  
ACM automatically records every public certificate that it issues in public Certificate Transparency (CT) logs, and browser policy requirements prevent you from opting out. As a result, public CT logs contain the names of TLS-enabled DAX clusters after ACM issues or renews the certificate. For general guidance on resource naming, see [Data protection in DynamoDB](data-protection.md). For more information about CT logging, see [Certificate transparency logging](https://docs.aws.amazon.com/acm/latest/userguide/acm-concepts.html#concept-transparency) in the *AWS Certificate Manager User Guide*.
...
![A high-level overview of an IAM policy scenario for using DAX.](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/images/dax-access-control-scenario.png)
...
![Overview of an IAM policy that enables direct access to a table, but blocks indirect access using a DAX cluster.](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/images/dax-access-control-ddb-only.png)
...
![An IAM policy that grants access to both a DynamoDB table and a DAX cluster.](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/images/dax-access-control-ddb-and-dax.png)
...
![A scenario where a user can access a table through a DAX cluster without direct DynamoDB access.](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/images/dax-access-control-dax-only.png)
