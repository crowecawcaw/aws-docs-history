...
that is sent to an Amazon SNS topic or Amazon EC2 Auto Scaling policy. Alarms invoke actions for sustained
...
For more information, see [Set Up Amazon Simple Notification Service](../../../AmazonCloudWatch/latest/monitoring/US_SetupSNS.md "../../../AmazonCloudWatch/latest/monitoring/US_SetupSNS.md") in the
_Amazon CloudWatch User Guide_. 2. Create the alarm.
