...
[Strongly consistent read operations](../APIReference/API_GetItem.md#DDB-GetItem-request-ConsistentRead "../APIReference/API_GetItem.md#DDB-GetItem-request-ConsistentRead") return the latest version of an
...
[ReplicationLatency](metrics-dimensions.md#ReplicationLatency "metrics-dimensions.md#ReplicationLatency") metric to
...
Live](TTL.md "TTL.md") (TTL) deletion. TTL settings are automatically synchronized for all
