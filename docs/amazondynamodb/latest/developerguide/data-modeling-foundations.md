...
![Image showing a table and how the sort key is used to differentiate each item by entity type within the same UserID Item collection.](images/DataModeling/SingleTableSchema.png)
...
![Image showing a forum table containing a list of forums and some aggregate data.](images/DataModeling/MultipleTable1.png)

![Image showing a thread table containing a list of threads partitioned by the specific forum they belong to.](images/DataModeling/MultipleTable2.png)
