...
- [Tutorial: Working with Amazon DynamoDB and Apache Hive](EMRforDynamoDB.Tutorial.md "EMRforDynamoDB.Tutorial.md")
- [Creating an external table in Hive](EMRforDynamoDB.ExternalTableForDDB.md "EMRforDynamoDB.ExternalTableForDDB.md")
- [Processing HiveQL statements](EMRforDynamoDB.ProcessingHiveQL.md "EMRforDynamoDB.ProcessingHiveQL.md")
- [Querying data in DynamoDB](EMRforDynamoDB.Querying.md "EMRforDynamoDB.Querying.md")
- [Copying data to and from Amazon DynamoDB](EMRforDynamoDB.CopyingData.md "EMRforDynamoDB.CopyingData.md")
- [Performance tuning](EMRforDynamoDB.PerformanceTuning.md "EMRforDynamoDB.PerformanceTuning.md")
