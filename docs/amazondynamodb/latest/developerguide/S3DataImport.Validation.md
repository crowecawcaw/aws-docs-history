...
[Using and data keys](encryption.usagenotes.md#dynamodb-kms "encryption.usagenotes.md#dynamodb-kms").
...
The `FailureCode` is `S3NoSuchBucket`, with `FailureMessage` containing details such as
