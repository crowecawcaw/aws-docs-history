...
See [Adding sample data to a data model](workbench.Modeler.AddData.md "workbench.Modeler.AddData.md") for details on how to auto-generate sample data for your tables. Different types of access patterns will support different input parameters.
