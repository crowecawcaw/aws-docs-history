...
The _People_ table described in [Tables, items, and attributes](#HowItWorks.CoreComponents.TablesItemsAttributes "#HowItWorks.CoreComponents.TablesItemsAttributes") is an
...
The _Music_ table described in [Tables, items, and attributes](#HowItWorks.CoreComponents.TablesItemsAttributes "#HowItWorks.CoreComponents.TablesItemsAttributes") is an
...
For more information, see [Improving data access with secondary indexes in DynamoDB](SecondaryIndexes.md "SecondaryIndexes.md").
