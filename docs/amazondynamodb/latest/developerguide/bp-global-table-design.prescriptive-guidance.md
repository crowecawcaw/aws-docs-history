...
- Plan your [Routing strategies in DynamoDB](bp-global-table-design.prescriptive-guidance.md "bp-global-table-design.prescriptive-guidance.md") strategy, based on your write mode.
- Define your
  [Evacuation processes](bp-global-table-design.prescriptive-guidance.md "bp-global-table-design.prescriptive-guidance.md"), based on your
