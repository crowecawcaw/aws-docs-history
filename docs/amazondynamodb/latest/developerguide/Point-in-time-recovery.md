...
- You can enable point-in-time recovery on each local replica of a global table. When you
  ...
  global table. If you are using [Global Tables version 2019.11.21 (Current)](GlobalTables.md "GlobalTables.md") of global tables, you can create a new global table from
  the restored table. For more information, see [How DynamoDB global tables work](V2globaltables_HowItWorks.md "V2globaltables_HowItWorks.md").
