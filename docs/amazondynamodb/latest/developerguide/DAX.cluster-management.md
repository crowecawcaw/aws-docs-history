...
- IAM and creating DAX clusters: [Creating a DAX cluster](DAX.create-cluster.md "DAX.create-cluster.md").
- IAM and DAX data plane operations: [DAX access control](DAX.access-control.md "DAX.access-control.md").
...
type for your application, see [DAX cluster sizing guide](DAX.sizing-guide.md "DAX.sizing-guide.md").
...
When you add a new node, you must synchronize the cache data from a peer node. Therefore, the addition time varies based on cache size and your application workload. As a best practice, we recommend that you pre-scale your cluster to meet expected traffic peaks. For information about right-sizing guidelines and monitoring recommendations, see [DAX cluster sizing guide](DAX.sizing-guide.md "DAX.sizing-guide.md").
...
see [Nodes](DAX.concepts.cluster.md#DAX.concepts.nodes "DAX.concepts.cluster.md#DAX.concepts.nodes").
...
- **Maintenance Window**—A weekly time period
  ...
  Region. For more information, see [Maintenance window](DAX.concepts.cluster.md#DAX.concepts.maintenance-window "DAX.concepts.cluster.md#DAX.concepts.maintenance-window").
...
For more information, see [Item cache](DAX.concepts.md#DAX.concepts.item-cache "DAX.concepts.md#DAX.concepts.item-cache") and [Query cache](DAX.concepts.md#DAX.concepts.query-cache "DAX.concepts.md#DAX.concepts.query-cache").
