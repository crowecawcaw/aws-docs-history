...
table class. See [Amazon DynamoDB Pricing](https://aws.amazon.com/dynamodb/pricing/on-demand/ "https://aws.amazon.com/dynamodb/pricing/on-demand/") for pricing details.
...
class in DynamoDB](WorkingWithTables.md "WorkingWithTables.md").
