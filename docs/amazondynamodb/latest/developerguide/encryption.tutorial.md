...
- [Specifying the encryption key for a new table](#encryption.tutorial-creating "#encryption.tutorial-creating")
- [Updating an encryption key](#encryption.tutorial-update "#encryption.tutorial-update")
...
encrypted at rest with the AWS owned key at no additional cost. 5. Under **Encryption at rest**, choose an encryption
...
identifiers, see [Key
identifiers (KeyId)](../../../kms/latest/developerguide/concepts.md#key-id "../../../kms/latest/developerguide/concepts.md#key-id") in the
