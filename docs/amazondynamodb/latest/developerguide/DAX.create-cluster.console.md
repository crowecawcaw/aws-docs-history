...
To create the cluster, see [Step 2: Create a DAX cluster using the AWS Management Console](#DAX.create-cluster.console.create-cluster "#DAX.create-cluster.console.create-cluster").
...
In the meantime, proceed to [Step 3: Configure security group inbound rules using the AWS Management Console](#DAX.create-cluster.console.configure-inbound-rules "#DAX.create-cluster.console.configure-inbound-rules") and follow
