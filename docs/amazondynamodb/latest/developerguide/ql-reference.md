...
multiple items, see [Performing transactions with PartiQL for DynamoDB](ql-reference.multiplestatements.md "ql-reference.multiplestatements.md") or [Running batch operations with PartiQL for DynamoDB](ql-reference.multiplestatements.md "ql-reference.multiplestatements.md").
