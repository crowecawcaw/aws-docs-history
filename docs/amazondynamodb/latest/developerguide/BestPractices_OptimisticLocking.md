...
Common examples include e-commerce inventory updates, collaborative editing platforms, and
...
Adding version control to items and handling conditional checks adds complexity
to the application logic. The AWS SDK for Java v2 Enhanced Client provides built-in support
through the [`@DynamoDbVersionAttribute`](../../../sdk-for-java/latest/developer-guide/ddb-en-client-extensions.md#ddb-en-client-extensions-VRE "../../../sdk-for-java/latest/developer-guide/ddb-en-client-extensions.md#ddb-en-client-extensions-VRE") annotation, which automatically
manages version numbers for you.
...
- Attributes:
  ...
  - `Version` – An integer that represents the version number of
    the item.
  - `QuantityLeft` – The remaining inventory of the
    item.

When an item is first created, the `Version` attribute is set to 1. With each
update, the version number increments by 1.
...
2. Update the item using a condition expression that checks the version number.
...
3. Handle conflicts by retrying with a fresh read.
...
For Java applications, the AWS SDK for Java v2 Enhanced Client provides built-in optimistic
locking support through the [`@DynamoDbVersionAttribute`](../../../sdk-for-java/latest/developer-guide/ddb-en-client-extensions.md#ddb-en-client-extensions-VRE "../../../sdk-for-java/latest/developer-guide/ddb-en-client-extensions.md#ddb-en-client-extensions-VRE") annotation, which automatically manages version
numbers for you.
