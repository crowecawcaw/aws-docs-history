...
- [Singleton statements](#workbench.querybuilder.partiql.single "#workbench.querybuilder.partiql.single")
...
3. Enter a valid [PartiQL statement](ql-reference.statements.md "ql-reference.statements.md").
...
request with INSERT, UPDATE, and DELETE statements. See [Performing transactions with PartiQL for DynamoDB](ql-reference.multiplestatements.transactions.md "ql-reference.multiplestatements.transactions.md") for
...
query operations are not supported. See [Running batch operations with PartiQL for DynamoDB](ql-reference.multiplestatements.batching.md "ql-reference.multiplestatements.batching.md") for
more details. 4. If your statement uses parameters:
