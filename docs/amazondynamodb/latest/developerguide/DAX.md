...
- [IAM permissions for managing a DAX
  cluster](#DAX.cluster-management.iam-permissions "#DAX.cluster-management.iam-permissions")
...
You can't modify a parameter group that is being used by a running DAX
instance.
...
groups. For more information, see [Logging DynamoDB operations by using
