...
| `Key`                                            | The primary key that defines the item. For more information about primary keys, see<br>[Primary key](HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey "HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey").Type: Map of `HashKeyElement`<br>to its value and `RangeKeyElement` to its<br>value.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Yes      |
