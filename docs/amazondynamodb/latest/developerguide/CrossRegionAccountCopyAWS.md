...
To restore a backup to another Region or account, you must first copy the backup to that Region or account. 6. Select the desired vault the file will be copied into. You can also create a new backup vault if desired. 7. Choose **Copy backup**.
