...
- To learn whether DynamoDB supports these features, see [How Amazon DynamoDB works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
