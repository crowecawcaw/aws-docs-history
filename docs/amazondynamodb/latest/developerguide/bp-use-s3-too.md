...
Amazon DynamoDB limits the size of each item that you store in a table to 400 KB (see [Quotas in Amazon DynamoDB](ServiceQuotas.md "ServiceQuotas.md")). If your application needs to store
