...
- [Using Global Secondary Indexes for materialized aggregation queries in DynamoDB](bp-gsi-aggregation.md "bp-gsi-aggregation.md")
  ...
  - [Aggregation pipeline with Streams and AWS Lambda](bp-gsi-aggregation.md#bp-gsi-aggregation-pipeline "bp-gsi-aggregation.md#bp-gsi-aggregation-pipeline")
...
- [Using Global Secondary Indexes to create an eventually consistent replica in DynamoDB](bp-indexes-gsi-replica.md "bp-indexes-gsi-replica.md")
