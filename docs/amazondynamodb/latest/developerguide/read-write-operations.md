...
- [GetItem](../APIReference/API_GetItem.md "../APIReference/API_GetItem.md"): Reads a single item from a table. To determine the
...
- [BatchGetItem](../APIReference/API_BatchGetItem.md "../APIReference/API_BatchGetItem.md"): Reads up to 100 items from one or more tables.
...
- [Scan](../APIReference/API_Scan.md "../APIReference/API_Scan.md"):
  ...
  information about Scan operations, see [Scanning tables in DynamoDB](Scan.md "Scan.md").

###### Important

If you perform a read operation on an _item that doesn't
exist_, DynamoDB will still consume read throughput as outlined
...
- [PutItem](../APIReference/API_PutItem.md "../APIReference/API_PutItem.md"): Writes a single item to a table. If an item with the
...
- [UpdateItem](../APIReference/API_UpdateItem.md "../APIReference/API_UpdateItem.md"): Modifies a single item in the table. DynamoDB
  ...
  sizes).
- [DeleteItem](../APIReference/API_DeleteItem.md "../APIReference/API_DeleteItem.md"): Removes a single item from a table. The provisioned
  throughput consumption is based on the size of the deleted item.
- [BatchWriteItem](../APIReference/API_BatchWriteItem.md "../APIReference/API_BatchWriteItem.md"): Writes up to 25 items to one or more tables.
