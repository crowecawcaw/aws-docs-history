...
information, see [Distributing write activity efficiently during data upload in DynamoDB](bp-partition-key-data-upload.md "bp-partition-key-data-upload.md").

## Compress data to keep the total S3 object size below the Regional limit

In the [import from S3 process](S3DataImport.Requesting.md "S3DataImport.Requesting.md"), there is
