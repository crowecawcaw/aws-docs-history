...
- [Requesting an import using the AWS Management Console](#S3DataImport.Requesting.Console "#S3DataImport.Requesting.Console")
- [Getting details about past imports in the AWS Management Console](#S3DataImport.Requesting.Console.Details "#S3DataImport.Requesting.Console.Details")
- [Requesting an import using the AWS CLI](#S3DataImport.Requesting.CLI "#S3DataImport.Requesting.CLI")
- [Getting details about past imports in the AWS CLI](#S3DataImport.Requesting.CLI.Details "#S3DataImport.Requesting.CLI.Details")
