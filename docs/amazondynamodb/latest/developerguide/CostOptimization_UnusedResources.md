...
###### [ConsumedReadCapacityUnits](metrics-dimensions.md#ConsumedReadCapacityUnits "metrics-dimensions.md#ConsumedReadCapacityUnits")
...
###### [ConsumedWriteCapacityUnits](metrics-dimensions.md#ConsumedWriteCapacityUnits "metrics-dimensions.md#ConsumedWriteCapacityUnits")
...
![Graphed metrics tab. Statistic is set to Sum to view resource usage data in the console.](images/CostOptimization/GraphedMetricsTab.png) 7. To avoid falsely identifying a table as unused, you'll want to evaluate metrics
...
![CloudWatch console. Custom time frame of 1 month is selected to evaluate metrics.](images/CostOptimization/OneMonthTimeFrame.png) 8. Evaluate the graphed metrics for your table to determine if it is being used.
...
![Graph showing the ConsumedReadCapacityUnits for a DynamoDB table, suggesting the table is in use.](images/CostOptimization/TableWithReadTraffic.png)
...
DynamoDB has [two capacity modes](capacity-mode.md "capacity-mode.md"),
...
costs. Refer to the [Using AWS Backup with DynamoDB](backuprestore_HowItWorksAWS.md "backuprestore_HowItWorksAWS.md") documentation for information on how enable
backups through AWS Backup as well as the [Managing backup plans](../../../aws-backup/latest/devguide/about-backup-plans.md "../../../aws-backup/latest/devguide/about-backup-plans.md")
...
Refer to the documentation for [Backup and restore for DynamoDB](Backup-and-Restore.md "Backup-and-Restore.md") and [Point-in-time backups for DynamoDB](Point-in-time-recovery.md "Point-in-time-recovery.md") to determine
