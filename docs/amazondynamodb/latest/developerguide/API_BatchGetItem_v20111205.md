...
| `Table`:`Keys`            | The primary key values that define the items in the<br>specified table. For more information about primary keys, see<br>[Primary key](HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey "HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey").<br>Type: Keys | Yes      |
...
| `UnprocessedKeys`:<br>`Table`: `Keys`               | The primary key attribute values that define the items and the attributes associated with<br>the items. For more information about primary keys, see [Primary key](HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey "HowItWorks.CoreComponents.md#HowItWorks.CoreComponents.PrimaryKey")<br>.Type: Array of attribute name-value pairs.                                                                         |
