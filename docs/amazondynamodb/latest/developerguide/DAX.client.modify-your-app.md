...
This example uses AWS SDK for Java 2.x. For the legacy SDK for Java 1.x version, see [Modifying an existing SDK for Java 1.x application to use DAX](DAX.client.modify-your-app.java-sdk-v1.md "DAX.client.modify-your-app.java-sdk-v1.md").
