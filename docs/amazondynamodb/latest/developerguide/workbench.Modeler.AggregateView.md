...
1. Open NoSQL Workbench, and on the main screen, choose the name of the model that you want to open.

1. In the top bar, choose **Aggregate view**. You see the data across all tables and indexes on the same screen.
