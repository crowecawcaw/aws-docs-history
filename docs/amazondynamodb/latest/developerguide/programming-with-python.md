...
+ **tcp\_keepalive** (bool) - Enables the TCP Keep-Alive socket option used when creating new connections if set to `True` ( defaults to `False`). This is only available starting with botocore 1.27.84.
