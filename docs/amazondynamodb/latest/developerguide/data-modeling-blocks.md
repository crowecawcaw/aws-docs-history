...
**Topics**
+ [Composite sort key building block](#data-modeling-blocks-composite)
+ [Multi-tenancy building block](#data-modeling-blocks-multi-tenancy)
+ [Sparse index building block](#data-modeling-blocks-sparse-index)
+ [Time to live building block](#data-modeling-blocks-ttl)
+ [Time to live for archival building block](#data-modeling-blocks-ttl-archival)
+ [Vertical partitioning building block](#data-modeling-blocks-vertical-partitioning)
+ [Write sharding building block](#data-modeling-blocks-write-sharding)
