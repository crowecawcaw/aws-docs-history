...
4. To run DynamoDB local in AWS CloudShell you can use the
   ...
   command line options for changing DynamoDB local settings. See [DynamoDB local usage notes](DynamoDBLocal.UsageNotes.md "DynamoDBLocal.UsageNotes.md") for available
   options.
