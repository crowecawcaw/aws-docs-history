...
For detailed instructions on loading data from DynamoDB into Amazon Redshift, refer to the following sections in the [*Amazon Redshift Database Developer Guide*](https://docs.aws.amazon.com/redshift/latest/dg/):
