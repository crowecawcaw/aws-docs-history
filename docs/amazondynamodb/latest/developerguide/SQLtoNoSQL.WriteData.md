...
- [Writing data to a table in DynamoDB](#SQLtoNoSQL.WriteData.DynamoDB "#SQLtoNoSQL.WriteData.DynamoDB")
...
`ExecuteStatement`, see [PartiQL insert statements for DynamoDB](ql-reference.insert.md "ql-reference.insert.md").
