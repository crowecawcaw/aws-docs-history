...
- [Best practices for managing many-to-many
  relationships in DynamoDB tables](bp-adjacency-graphs.md "bp-adjacency-graphs.md")
...
- [Considerations when using AWS PrivateLink for
  Amazon DynamoDB](privatelink-interface-endpoints.md#privatelink-considerations "privatelink-interface-endpoints.md#privatelink-considerations")
