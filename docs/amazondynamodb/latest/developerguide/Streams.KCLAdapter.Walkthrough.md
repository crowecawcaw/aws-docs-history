...
staying in sync. For the source code, see [Complete program: DynamoDB Streams Kinesis adapter](Streams.KCLAdapter.Walkthrough.CompleteProgram.md "Streams.KCLAdapter.Walkthrough.CompleteProgram.md").
