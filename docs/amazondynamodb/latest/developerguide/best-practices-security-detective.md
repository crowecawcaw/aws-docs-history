...
If you are using an [AWS managed key](../../../kms/latest/developerguide/concepts.md#aws-managed-cmk "../../../kms/latest/developerguide/concepts.md#aws-managed-cmk") for encryption at rest, usage of this key is
...
AWS KMS API Calls with AWS CloudTrail](../../../kms/latest/developerguide/logging-using-cloudtrail.md "../../../kms/latest/developerguide/logging-using-cloudtrail.md") and the [AWS CloudTrail User
...
information, see [Logging DynamoDB Operations by Using AWS CloudTrail](logging-using-cloudtrail.md "logging-using-cloudtrail.md"). You can view,
...
for DynamoDB, create a [trail](../../../awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.md "../../../awscloudtrail/latest/userguide/cloudtrail-create-and-update-a-trail.md"). A trail enables CloudTrail to deliver log files to an Amazon Simple Storage Service
...
with Amazon DynamoDB Streams](../../../lambda/latest/dg/with-ddb-example.md "../../../lambda/latest/dg/with-ddb-example.md"). This example receives a DynamoDB event input,
...
Using [AWS Config](../../../config/latest/developerguide/WhatIsConfig.md "../../../config/latest/developerguide/WhatIsConfig.md"), you
...
the Console](../../../config/latest/developerguide/gs-console.md "../../../config/latest/developerguide/gs-console.md"), ensuring that DynamoDB resource types are
included.
...
For an example, see [Notifications that AWS Config Sends to an Amazon SNS topic](../../../config/latest/developerguide/notifications-for-AWS-Config.md "../../../config/latest/developerguide/notifications-for-AWS-Config.md") in the
...
guidelines, and regulations. AWS Config provides [AWS managed rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md "../../../config/latest/developerguide/managed-rules-by-aws-config.md"), which are predefined, customizable rules
...
For more information, see [AWS Tagging Strategies](https://aws.amazon.com/answers/account-management/aws-tagging-strategies/ "https://aws.amazon.com/answers/account-management/aws-tagging-strategies/") and [Tagging for
