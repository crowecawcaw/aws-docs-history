...
- [Tutorial #1: Using filters to process all events with Amazon DynamoDB and AWS Lambda using the AWS CLI](Streams.Lambda.md "Streams.Lambda.md")
- [Tutorial #2: Using filters to process some events with DynamoDB and Lambda](Streams.Lambda.md "Streams.Lambda.md")
- [Best practices using DynamoDB Streams with Lambda](Streams.Lambda.md "Streams.Lambda.md")
