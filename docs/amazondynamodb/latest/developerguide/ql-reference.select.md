...
- Author your `SELECT` statements to not result in full table
  scans by making sure your [WHERE clause condition](ql-reference.select.md#ql-reference.select.parameters "ql-reference.select.md#ql-reference.select.parameters") is configured accordingly.
