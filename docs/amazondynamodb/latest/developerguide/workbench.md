...
see [Setting up DynamoDB local (downloadable version)](DynamoDBLocal.md "DynamoDBLocal.md").
...
environments. For more information, see [Exploring datasets and building operations with NoSQL Workbench](workbench.querybuilder.md "workbench.querybuilder.md").

The video below details concepts of data modeling with NoSQL Workbench.

###### Topics

- [Download NoSQL Workbench for DynamoDB](workbench.settingup.md "workbench.settingup.md")
- [Building data models with NoSQL Workbench](workbench.Modeler.md "workbench.Modeler.md")
- [Exploring datasets and building operations with NoSQL Workbench](workbench.querybuilder.md "workbench.querybuilder.md")
- [Sample data models for NoSQL Workbench](workbench.SampleModels.md "workbench.SampleModels.md")
