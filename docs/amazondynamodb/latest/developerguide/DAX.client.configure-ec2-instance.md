...
the public DNS name of your instance. (See [Step 1: Launch an Amazon EC2 instance](DAX.client.launch-ec2-instance.md "DAX.client.launch-ec2-instance.md").)
...
shown following. Enter your AWS access key ID and secret key (from [Step 2: Create a user and policy](DAX.client.create-user-policy.md "DAX.client.create-user-policy.md")), and set the default Region
...
DAX using one of the available sample applications. For more information, see [Step 4: Run a sample application](DAX.client.run-application.md "DAX.client.run-application.md").
