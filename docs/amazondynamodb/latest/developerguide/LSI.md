...
- [Scenario: Using a Local Secondary Index](#LSI.Scenario "#LSI.Scenario")
- [Attribute projections](#LSI.Projections "#LSI.Projections")
...
- [Working with Local Secondary Indexes: .NET](LSILowLevelDotNet.md "LSILowLevelDotNet.md")
- [Working with Local Secondary Indexes in DynamoDB AWS CLI](LCICli.md "LCICli.md")

## Scenario: Using a Local Secondary Index

As an example, consider the `Thread` table. This table is useful for an
application such as the [AWS discussion forums](https://forums.aws.amazon.com/ "https://forums.aws.amazon.com/"). The
following diagram shows how the items in the table would be organized. (Not all of the
attributes are shown.)

![Thread table containing a list of forum names, subjects, last post time, and number of replies.](images/LSI_01.png)
...
![LastPostIndex table containing a list of forum names, subjects, and last post time.](images/LSI_02.png)
...
the indexes, that have the same partition key value. For more information, see [Item collections in Local Secondary Indexes](#LSI.ItemCollections "#LSI.ItemCollections").
...
![LastPostIndex table containing a list of forum names, last post times, subjects, and replies.](images/LSI_03.png)
...
- If your application needs to query a table infrequently, but must perform many
  ...
  _KEYS_ONLY_. The local secondary index would be of minimal size, but
...
information, see [Filter expressions for scan](Scan.md#Scan.FilterExpression "Scan.md#Scan.FilterExpression").
...
To view the current rates for provisioned throughput capacity, see [Amazon DynamoDB pricing](https://aws.amazon.com/dynamodb/pricing "https://aws.amazon.com/dynamodb/pricing").
...
more information about how DynamoDB calculates provisioned throughput usage, see [DynamoDB provisioned capacity mode](provisioned-capacity-mode.md "provisioned-capacity-mode.md").
...
![A DynamoDB item collection with table and Local Secondary Index items that have the same partition key value of S3.](images/LSI_04.png)
