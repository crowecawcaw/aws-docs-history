...
tests. 6. In the previous step, you ran the programs against the DynamoDB endpoint. Run
...
DynamoDB. 7. Run the following Node.js program to delete
`TryDaxTable`.
...
- [01-create-table.js](DAX.client.run-application-nodejs.01-create-table.md "DAX.client.run-application-nodejs.01-create-table.md")
- [02-write-data.js](DAX.client.run-application-nodejs.02-write-data.md "DAX.client.run-application-nodejs.02-write-data.md")
- [03-getitem-test.js](DAX.client.run-application-nodejs.03-getitem-test.md "DAX.client.run-application-nodejs.03-getitem-test.md")
- [04-query-test.js](DAX.client.run-application-nodejs.04-query-test.md "DAX.client.run-application-nodejs.04-query-test.md")
- [05-scan-test.js](DAX.client.run-application-nodejs.05-scan-test.md "DAX.client.run-application-nodejs.05-scan-test.md")
- [06-delete-table.js](DAX.client.run-application-nodejs.06-delete-table.md "DAX.client.run-application-nodejs.06-delete-table.md")
