...
The [on-demand capacity mode](on-demand-capacity-mode.md "on-demand-capacity-mode.md") is designed
...
The [provisioned capacity](provisioned-capacity-mode.md "provisioned-capacity-mode.md") mode is a more
...
![Graphs for unpredictable, variable workload with spikes and periods of low activity.](images/choose-on-demand-1.png)
![Graphs for unpredictable, variable workload with spikes and periods of low activity.](images/choose-on-demand-2.png)
...
![Graph depicting a predictable, cyclical workload with limited spikes in traffic.](images/choose-provisioned-1.png)
...
![DynamoDB console. Provisioned capacity and auto scaling are enabled. Target utilization is set to 70.](images/CostOptimization/TableCapacityModeAutoScaling.png)
