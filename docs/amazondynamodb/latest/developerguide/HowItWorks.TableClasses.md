...
tables. To learn more about selecting your table class, see [Considerations when choosing a table class in DynamoDB](WorkingWithTables.tableclasses.md "WorkingWithTables.tableclasses.md").
