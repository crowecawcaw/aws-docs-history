...
[Amazon DynamoDB global tables](GlobalTables.md "GlobalTables.md") is a fully managed,
serverless, multi-Region, and multi-active database. Global tables are designed for
[99.999% availability](https://aws.amazon.com/dynamodb/sla/ "https://aws.amazon.com/dynamodb/sla/"),
