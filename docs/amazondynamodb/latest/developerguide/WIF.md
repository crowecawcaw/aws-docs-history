...
_GameScores_ table that was introduced in [Using IAM policy conditions for fine-grained access control](specifying-conditions.md "specifying-conditions.md"). Here is
...
shown in [Using IAM policy conditions for fine-grained access control](specifying-conditions.md "specifying-conditions.md"):
