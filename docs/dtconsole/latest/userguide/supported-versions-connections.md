...
AWS CodeConnections does not support deprecated GitHub Enterprise Server versions. For example,
...
GitLab.com.
For more information, see [Create a connection to GitLab](connections-create-gitlab.md "connections-create-gitlab.md").
