...
1. Follow the steps in [To edit a notification rule (AWS CLI)](notification-rule-edit.md#notification-rule-edit-cli "notification-rule-edit.md#notification-rule-edit-cli") to obtain the JSON for the
   notification rule.
