...
**Note**  
For the Europe (Milan) Region, you must enable this Region before you can use it. For more information, see [ Enabling a Region](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable).
...
| Asia Pacific (Mumbai) (ap-south-1)  | 13.234.199.152, 13.235.29.220, 35.154.230.124 | 
