...
Before you begin:
+ You must have already created an account with GitLab and have GitLab Enterprise Edition or GitLab Community Edition with a self-managed installation. For more information, see [https://docs.gitlab.com/ee/subscriptions/self\_managed/](https://docs.gitlab.com/ee/subscriptions/self_managed/).
**Note**  
