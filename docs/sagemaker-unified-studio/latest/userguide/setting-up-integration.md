...
- [Authenticating directly in Local IDE](local-ide.md "local-ide.md")
- [Link to VS Code from Amazon SageMaker Unified Studio](link-to-vs-code.md "link-to-vs-code.md")
