...
5. In **Apps** choose the app that you want to use.
6. On the **Save** button, choose the menu selector and then select
   **View history**.
7. In the **History pane**, select the version of the app that you
   want to view. The center pane refreshes to contain the selected app version.
8. In the center pane, view the app version and its configuration. You can't make
   changes to app. To return to the editable draft, choose **Close App
   history**.
9. (Optional) In the **App history** pane, choose
