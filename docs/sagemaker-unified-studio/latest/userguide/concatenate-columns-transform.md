...
3. Under **Transforms**, choose **Concatenate
   Columns**.
...
6. Under **Concatenated column**, enter the name of a new column that
   will be generated.
7. Under **Columns**, select the input columns.
8. (Optional) Under **Spacer**, enter a string to place between
   concatenated fields.
9. (Optional) Under **Null value**, enter the string to use when a
