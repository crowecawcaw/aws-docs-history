...
You can see the [Security](../adminguide/security.md "../adminguide/security.md") section in the Amazon SageMaker Unified Studio Administrator Guide for
detailed information and instructions on how to apply the shared responsibility model when using
Amazon SageMaker Unified Studio. The topics in the [Security](../adminguide/security.md "../adminguide/security.md") section in the Amazon SageMaker Unified Studio Administrator Guide show you how to configure
Amazon SageMaker Unified Studio to meet your security and compliance objectives. You also learn how to use other AWS
services that help you to monitor and secure your Amazon SageMaker Unified Studio resources.
...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Amazon SageMaker Unified Studio, see [AWS Services in Scope by Compliance Program](https://aws.amazon.com/compliance/services-in-scope/ "https://aws.amazon.com/compliance/services-in-scope/").
