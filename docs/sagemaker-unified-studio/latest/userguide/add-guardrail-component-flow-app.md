...
5. open the flow app that you created in [Create a flow app with Amazon Bedrock](build-flow.md "build-flow.md").
6. In the canvas, select the knowledge base node (**Local_bands_knowledge_base**).
7. In the **flow builder** pane, choose the configure tab.
8. In the **Guardrail details** section do one of the following:
...
9. Choose **Save** to save your changes to your flow app.
