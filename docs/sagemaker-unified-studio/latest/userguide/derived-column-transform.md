...
3. Under **Transforms**, choose **Derived
   Column**.
...
6. Under **Name of derived column**, enter the name of a new column
   that will be generated.
7. Under **Column expression**, enter a SQL expression to define the
