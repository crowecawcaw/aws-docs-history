...
1. Go to your Amazon SageMaker project and choose **Assets** in the left
   navigation.
2. Find the dashboard asset under **Inventory** or
   **published** tab.
3. Open the dashboard in the Amazon SageMaker Catalog.
4. Choose **Share** under **Actions**.
5. Grant access to individual users or groups through **AWS IAM Identity Center
   (IDC)**.
