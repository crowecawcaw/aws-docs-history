...
After connecting to an Amazon EMR on EC2 cluster, you can begin using the cluster. To get
...
5. In the first cell, choose a connection type that you want to use from the dropdown
   list of connection types. Then choose the name of the compute from the dropdown list of
   compute options.
6. Choose the **Run** icon.
   Your cluster is now initialized and configured to be a compute resource in your Amazon SageMaker Unified Studio
   project.
