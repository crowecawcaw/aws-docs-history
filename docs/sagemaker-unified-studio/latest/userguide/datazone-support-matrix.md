...
Tools support matrix| **Tool** | **Compute** | **AWS Service** | **Service deployment
option** | **Support status** | **Notes** |
| --- | --- | --- | --- | --- | --- |
...
| Visual ETL | Spark | AWS Glue | fineGrained mode | Not supported | Spark DataFrames only | Lineage capture is automated from the following sources in SageMaker Unified Studio: Services support matrix| **Data source** | **Support status** | **Configuration update** | **Notes** |
...
| Amazon Redshift | Automated by default | | | | Amazon Redshift Serverless | Automated by default | | |
