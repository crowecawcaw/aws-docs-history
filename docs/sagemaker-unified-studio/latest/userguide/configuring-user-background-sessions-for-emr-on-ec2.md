...
When user background sessions is enabled for Amazon EMR on EC2, Amazon SageMaker Unified Studio will not terminate interactive sessions.
...
For more information, see [User background sessions](../../../emr/latest/ManagementGuide/user-background-sessions.md "../../../emr/latest/ManagementGuide/user-background-sessions.md")
in the Amazon EMR on EC2 management guide.
