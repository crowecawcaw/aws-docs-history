# Getting started using Amazon Quick integration

1. ###### Create a Amazon SageMaker Unified Studio project with Quick blueprint
...
**Quick** blueprint added to it.
    ...
    When your project is created, the following resources are provisioned:
    	...
    	* One restricted Quick folder per project. All new assets—like analyses,
    	...
    	* Real-time folder permission sync. Amazon SageMaker Unified Studio keeps the Amazon Quick folder's
    	 ...
    	 in the corresponding Amazon Quick folder.
    	* Preconfigured Quick data sources for Athena and Amazon Redshift:
...
Before visualizing data in Quick, your project must have access to the required data
...
visualizations in Amazon Quick. Amazon SageMaker Unified Studio provides two integrated paths for creating Quick
datasets and analyses:

    1. ###### Create a dataset manually in Quick
    ...
    When you choose this option, Amazon SageMaker Unified Studio creates a Quick dataset using the selected
     ...
     project's restricted folder in Quick. The dataset is immediately opened in a new
    ...
    From more information on building an analysis using the newly created dataset, see
     ...
     in Quick](../../../quicksight/latest/user/working-with-an-analysis.md "../../../quicksight/latest/user/working-with-an-analysis.md"). For more information on joining your dataset with other datasets
     available within the project folder, see [Joining datasets in
     Quick](../../../quicksight/latest/user/joining-data.md "../../../quicksight/latest/user/joining-data.md").

4. ###### Publish Quick dashboards
