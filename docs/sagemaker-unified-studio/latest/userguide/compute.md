...
information and add compute resources such as Amazon Redshift and Amazon EMR Serverless
clusters to your project. Amazon SageMaker Unified Studio supports different kinds of compute resources:
...
- **Data processing**: This includes connections to Amazon EMR on
  EC2 clusters, Amazon EMR on EKS virtual clusters, Amazon EMR Serverless applications, and Glue ETL
  computes. For more information, see the following links:
...
Adding a serverless or cluster compute connection adds the compute resource to the project
space, so all project members can access it.
