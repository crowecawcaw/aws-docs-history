...
information, see [Publish assets to the Amazon SageMaker Unified Studio catalog from the project inventory](publishing-data-asset.md "publishing-data-asset.md"). You can only publish the most
