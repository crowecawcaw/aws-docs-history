...
terms. For more information, see [Amazon SageMaker Unified Studio terminology and concepts](concepts.md "concepts.md"). To edit a glossary in your
...
5. On the glossary details page, expand **Actions** and then choose
   **Edit business glossary** to edit the glossary.
6. Make your updates to the name and description, and then choose
   **Update glossary**.
