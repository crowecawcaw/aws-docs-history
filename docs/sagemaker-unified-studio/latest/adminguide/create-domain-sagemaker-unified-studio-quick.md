...
(account with IAM Identity Center) or choose an existing single sign-on user to log in to
Amazon SageMaker Unified Studio. The single sign-on user that you choose here serves as the administrator in
