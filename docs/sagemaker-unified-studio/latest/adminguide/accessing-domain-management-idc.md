...
![Domain management button in the SageMaker console domain details page](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/adminguide/images/AdminPortal/DomainDetail.png)
...
![Domain management link in the Amazon SageMaker Unified Studio portal left navigation](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/adminguide/images/AdminPortal/PortalAccess.png)
...
![Update project option in the Tooling blueprint Provisioning tab](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/adminguide/images/AdminPortal/UpdateProjectConsole.png)
...
![Create administration project option in the Tooling blueprint Provisioning tab](https://docs.aws.amazon.com/sagemaker-unified-studio/latest/adminguide/images/AdminPortal/CreateProjectConsole.png)
