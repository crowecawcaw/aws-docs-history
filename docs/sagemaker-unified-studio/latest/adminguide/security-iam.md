...
+ [How Amazon SageMaker Unified Studio works with IAM](security_iam_service-with-iam.md)
+ [Identity-based policy examples for Amazon SageMaker Unified Studio](security_iam_id-based-policy-examples.md)
+ [AWS managed policies for Amazon SageMaker Unified Studio](security-iam-awsmanpol.md)
+ [IAM roles for Amazon SageMaker Unified Studio](security-iam-roles.md)
+ [Access control patterns Amazon SageMaker Unified Studio](security-accesss-control-patterns.md)
+ [Troubleshooting Amazon SageMaker Unified Studio identity and access](security_iam_troubleshoot.md)
