...
As a managed service, Amazon SageMaker Unified Studio is protected by the AWS global network security
...
You use AWS published API calls to access Amazon SageMaker Unified Studio through the network. Clients must
