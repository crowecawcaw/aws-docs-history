...
Project details include storage configuration, execution role assignments, and
member information that determine how resources within the project operate.
...
3. The project details page displays the following information:
   ...
   4. **Members tab:**
      - Member - IAM role, IAM user, SSO user, or SSO group that can login and
        access the project
