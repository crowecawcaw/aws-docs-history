...
The Settings section in domain administration provides access to domain-level
configuration options that apply across all projects in your Amazon SageMaker Unified Studio domain. Domain
administrators can view domain details and configure networking settings.

1. From the domain administration page, choose **Settings** in the
   left navigation pane.
2. The Settings page displays the **Domain details** section with the
