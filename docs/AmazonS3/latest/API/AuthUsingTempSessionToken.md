...
By default, the session duration is one hour. If you use IAM user
 ...
 Credentials](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html") in the *IAM User Guide*. For more
...
If you want to test the sample by using IAM user credentials, you must create an
 ...
 First IAM user and Administrators Group](https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/getting-started_create-admin-group.html") in the
 *IAM User Guide*.
