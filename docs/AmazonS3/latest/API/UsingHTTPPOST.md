...
Amazon S3 now supports Signature Version 4, a protocol for authenticating inbound API
 ...
 Browser-Based Uploads Using POST (AWS Signature Version 4)](sigv4-authentication-HTTPPOST.md "sigv4-authentication-HTTPPOST.md") in the
 *Amazon Simple Storage Service API Reference*. 

The following figure shows an upload using Amazon S3 POST.


![Illustration that shows an upload using Amazon S3 POST.](../../../images/AmazonS3/latest/API/images/s3_post.png)


Uploading using POST| 1 | The user opens a web browser and accesses your web page. |
| 2 | Your web page contains an HTTP form that contains all the information
 necessary for the user to upload content to Amazon S3. |
