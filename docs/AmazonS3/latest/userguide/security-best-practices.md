...
- Use [AWS Trusted Advisor](../../../awssupport/latest/user/getting-started.md#trusted-advisor "../../../awssupport/latest/user/getting-started.md#trusted-advisor") to inspect your Amazon S3
  implementation.
...
Although Amazon S3 general purpose buckets exist in a shared global namespace, you can optionally create buckets in your account regional namespace. The account regional namespace is a reserved subdivision of the global bucket namespace where only your account can create general purpose buckets. We recommend you create buckets in your account regional namespace since these buckets are unique to your account and can never be re-created by another account. For more information, see [Namespaces for general purpose buckets](gpbucketnamespaces.md "gpbucketnamespaces.md").
...
- [Common
  ...
  Services](../../../IAM/latest/UserGuide/id_roles_common-scenarios.md "../../../IAM/latest/UserGuide/id_roles_common-scenarios.md")
...
You can use HTTPS (TLS) to help prevent potential attackers from eavesdropping on or manipulating network traffic by using person-in-the-middle or similar attacks. We recommend allowing only encrypted connections over HTTPS (TLS) by using the [aws:SecureTransport](../../../IAM/latest/UserGuide/reference_policies_elements_condition_operators.md#Conditions_Boolean "../../../IAM/latest/UserGuide/reference_policies_elements_condition_operators.md#Conditions_Boolean") condition in your Amazon S3 bucket policies. For more information, see the example S3 bucket policy [Managing access based on HTTP or HTTPS requests](example-bucket-policies.md#example-bucket-policies-HTTP-HTTPS "example-bucket-policies.md#example-bucket-policies-HTTP-HTTPS"). In addition to denying HTTP requests, we recommend that you set Amazon CloudWatch alarms on `tlsDetails.tlsVersion NOT EXISTS` that alert you if HTTP access attempts are made on your content. For more information on how to configure Amazon CloudWatch alarms, see [Creating CloudWatch alarms for CloudTrail events: examples](../../../awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.md "../../../awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.md") and [CloudTrail record contents](../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.md "../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.md") in the _AWS CloudTrail User Guide_.
...
Also consider implementing ongoing detective controls by using the [s3-bucket-ssl-requests-only](../../../config/latest/developerguide/s3-bucket-ssl-requests-only.md "../../../config/latest/developerguide/s3-bucket-ssl-requests-only.md") managed AWS Config
rule.
...
Also consider implementing ongoing detective controls by using the [s3-bucket-versioning-enabled](../../../config/latest/developerguide/s3-bucket-versioning-enabled.md "../../../config/latest/developerguide/s3-bucket-versioning-enabled.md") managed AWS Config
rule.
...
Also consider implementing ongoing detective controls by using the [s3-bucket-replication-enabled](../../../config/latest/developerguide/s3-bucket-replication-enabled.md "../../../config/latest/developerguide/s3-bucket-replication-enabled.md") managed AWS Config
rule.
...
- Use Tag Editor to identify and tag security-sensitive or
  ...
  search for these resources. For more information, see [Searching for Resources to Tag](../../../ARG/latest/userguide/tag-editor.md "../../../ARG/latest/userguide/tag-editor.md") in the _Tagging AWS Resources User Guide_.
...
- Create resource groups for your Amazon S3 resources. For more
  ...
  resource groups?](../../../ARG/latest/userguide/welcome.md "../../../ARG/latest/userguide/welcome.md") in the _AWS Resource Groups User Guide_.
...
For a second example, see [Example: Amazon S3 Bucket Activity](../../../awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.md#cloudwatch-alarms-for-cloudtrail-s3-bucket-activity "../../../awscloudtrail/latest/userguide/cloudwatch-alarms-for-cloudtrail.md#cloudwatch-alarms-for-cloudtrail-s3-bucket-activity"). This example describes how to
...
Also consider implementing ongoing detective controls by using the [s3-bucket-logging-enabled](../../../config/latest/developerguide/s3-bucket-logging-enabled.md "../../../config/latest/developerguide/s3-bucket-logging-enabled.md") AWS Config managed
rule.
...
buckets. For more information, see [cloudtrail-s3-dataevents-enabled](../../../config/latest/developerguide/cloudtrail-s3-dataevents-enabled.md "../../../config/latest/developerguide/cloudtrail-s3-dataevents-enabled.md") in the
...
Console](../../../config/latest/developerguide/gs-console.md "../../../config/latest/developerguide/gs-console.md") in the _AWS Config Developer Guide_.
...
information, see [AWS Config Managed Rules](../../../config/latest/developerguide/evaluate-config_use-managed-rules.md "../../../config/latest/developerguide/evaluate-config_use-managed-rules.md") and [List of AWS Config Managed Rules](../../../config/latest/developerguide/managed-rules-by-aws-config.md "../../../config/latest/developerguide/managed-rules-by-aws-config.md") in the _AWS Config Developer Guide_.
...
Public Access](https://aws.amazon.com/blogs/security/how-to-use-aws-config-to-monitor-for-and-respond-to-amazon-s3-buckets-allowing-public-access/ "https://aws.amazon.com/blogs/security/how-to-use-aws-config-to-monitor-for-and-respond-to-amazon-s3-buckets-allowing-public-access/") on the _AWS Security Blog_.
...
using [describe-trusted-advisor-checks](../../../cli/latest/reference/support/describe-trusted-advisor-checks.md "../../../cli/latest/reference/support/describe-trusted-advisor-checks.md").
...
For more information, see [Amazon S3 Protection in Amazon GuardDuty](../../../guardduty/latest/ug/s3-protection.md "../../../guardduty/latest/ug/s3-protection.md") in the _Amazon GuardDuty User Guide_.
...
Administration Guide](../../../detective/latest/adminguide/what-is-detective.md "../../../detective/latest/adminguide/what-is-detective.md").
