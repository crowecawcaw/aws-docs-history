...
The CORS configuration is a JSON file. The text that you type in the editor must be valid JSON. For more information, see [Elements of a CORS configuration](ManageCorsUsing.md "ManageCorsUsing.md").
 ...
 **CORS configuration editor** title. For more information about ARNs,
 ...
 and AWS Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html "https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html") in the *Amazon Web Services General Reference*.
