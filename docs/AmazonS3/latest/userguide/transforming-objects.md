...
With Amazon S3 Object Lambda, you can add your own code to Amazon S3 `GET`, `LIST`,
 ...
 AWS Blog post 
 [Use Amazon S3 Object Lambda with Amazon CloudFront](https://aws.amazon.com/blogs/aws/new-use-amazon-s3-object-lambda-with-amazon-cloudfront-to-tailor-content-for-end-users/ "https://aws.amazon.com/blogs/aws/new-use-amazon-s3-object-lambda-with-amazon-cloudfront-to-tailor-content-for-end-users/").
...
After you configure a Lambda function, you attach it to an S3 Object Lambda service endpoint, known as
 an *Object Lambda Access Point*. The Object Lambda Access Point uses a standard S3 access point, known as a
 *supporting access point*, to access data.
...
![Diagram, showing how S3 Object Lambda works.](../../../images/AmazonS3/latest/userguide/images/ObjectLamdaDiagram.png)
The topics in this section describe how to work with S3 Object Lambda.

###### Topics

* [Creating Object Lambda Access Points](olap-create.md "olap-create.md")
* [Using Amazon S3 Object Lambda Access Points](olap-use.md "olap-use.md")
* [Security considerations for S3 Object Lambda Access Points](olap-security.md "olap-security.md")
* [Writing Lambda functions for S3 Object Lambda Access Points](olap-writing-lambda.md "olap-writing-lambda.md")
* [Using AWS built Lambda functions](olap-examples.md "olap-examples.md")
* [Best practices and guidelines for S3 Object Lambda](olap-best-practices.md "olap-best-practices.md")
* [S3 Object Lambda tutorials](olap-tutorials.md "olap-tutorials.md")
...
For information about working with buckets, see [General purpose buckets overview](UsingBucket.md "UsingBucket.md"). For information about working with objects, see [Amazon S3 objects overview](UsingObjects.md "UsingObjects.md").
