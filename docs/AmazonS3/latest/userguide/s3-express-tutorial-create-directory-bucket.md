...
###### Note
	...
	* If you've chosen a Region that doesn't support directory buckets, the
	 **Bucket type** option disappears, and the bucket type
	 ...
	 buckets and the Amazon S3 Express One Zone storage class, see [S3 Express One Zone Availability Zones and Regions](s3-express-Endpoints.md "s3-express-Endpoints.md").
...
6. For **Availability Zone**, choose a Availability Zone local to your
 compute services. For a list of Availability Zones that support directory buckets and
 the S3 Express One Zone storage class, see [S3 Express One Zone Availability Zones and Regions](s3-express-Endpoints.md "s3-express-Endpoints.md"). 
...
After you create the bucket, you can't change its name. For more information about
 naming buckets, see [General purpose bucket naming rules](bucketnamingrules.md "bucketnamingrules.md"). 
...
Do not include sensitive information, such as account numbers, in the bucket name.
 ...
 bucket.
8. Under **Object Ownership**, the **Bucket owner enforced**
...
9. Under **Block Public Access settings for this bucket**, all Block
...
For more information about using Amazon S3 server-side encryption to encrypt your data,
 see [Data protection and encryption](s3-express-data-protection.md "s3-express-data-protection.md").
...
If you use the SSE-KMS option for your default encryption configuration, you are
 ...
 AWS KMS quotas and how to request a quota increase, see [Quotas](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html "https://docs.aws.amazon.com/kms/latest/developerguide/limits.html") in the
...
When you enable default encryption, you might need to update your bucket policy. For
 ...
 operations](bucket-encryption.md#bucket-encryption-update-bucket-policy "bucket-encryption.md#bucket-encryption-update-bucket-policy").
...
###### Important
	...
	* Your SSE-KMS configuration can only support 1 [customer managed key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#customer-cmk") per directory bucket for the lifetime of the bucket. 
	...
	* You can use only KMS keys that are available in the same AWS Region as the
	 ...
	 key and then you must enter the KMS key ARN. For more information on cross account permissions for KMS keys, see [Creating KMS keys that other accounts can use](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html#cross-account-console "https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html#cross-account-console") in the *AWS Key Management Service Developer Guide*. For more information on SSE-KMS, see [Specifying server-side encryption with AWS KMS
