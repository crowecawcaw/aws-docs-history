...
- **AWS CloudTrail data events** – Use CloudTrail to log data events. By
  ...
  Data Events for Trails](../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md "../../../awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.md") in the _AWS CloudTrail User Guide_.
...
tags, and more, see [Code examples](../API/s3_example_s3_ListBuckets_section.md "../API/s3_example_s3_ListBuckets_section.md") in the _Amazon S3 API Reference_.
