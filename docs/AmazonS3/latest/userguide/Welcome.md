...
* [Features of Amazon S3](#S3Features "#S3Features")
* [How Amazon S3 works](#CoreConcepts "#CoreConcepts")
* [Amazon S3 data consistency model](#ConsistencyModel "#ConsistencyModel")
* [Related services](#RelatedAmazonWebServices "#RelatedAmazonWebServices")
* [Accessing Amazon S3](#API "#API")
* [Paying for Amazon S3](#PayingforStorage "#PayingforStorage")
* [PCI DSS compliance](#pci-dss-compliance "#pci-dss-compliance")
...
the option to co-locate your object storage with your compute resources, which provides the highest possible access speed.
 ...
 Amazon S3 directory bucket. For more information, see [S3 Express One Zone](directory-bucket-high-performance.md#s3-express-one-zone "directory-bucket-high-performance.md#s3-express-one-zone") and [Working with directory buckets](directory-buckets-overview.md "directory-buckets-overview.md").
...
For more information, see [Understanding and managing Amazon S3 storage classes](storage-class-intro.md "storage-class-intro.md").
...
* [S3 Lifecycle](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md") – Configure a lifecycle configuration to manage
...
* [S3 Object Lock](object-lock.md "object-lock.md") – Prevent Amazon S3 objects from being
...
* [S3 Replication](replication.md "replication.md")
...
* [S3 Batch Operations](batch-ops.md "batch-ops.md") – Manage billions of objects at scale
...
* [S3 Block Public Access](access-control-block-public-access.md "access-control-block-public-access.md") – Block public access to S3
...
* [AWS Identity and Access Management (IAM)](security-iam.md "security-iam.md") – IAM is a web service that helps
 ...
 resources.
* [Bucket
 policies](bucket-policies.md "bucket-policies.md") – Use IAM-based policy language to configure
 resource-based permissions for your S3 buckets and the objects in
 them.
* [Amazon S3 access points](access-points.md "access-points.md")
...
* [Access control
 lists (ACLs)](acls.md "acls.md") – Grant read and write permissions for
 ...
 policies or IAM user policies, see [Managing access with ACLs](acls.md "acls.md").
* [S3 Object Ownership](about-object-ownership.md "about-object-ownership.md") – Take ownership of every object
...
* [IAM Access Analyzer for S3](access-analyzer.md "access-analyzer.md")
...
* [S3 Object Lambda](transforming-objects.md "transforming-objects.md")
...
* [Event
 notifications](EventNotifications.md "EventNotifications.md") – Trigger workflows that use Amazon Simple Notification Service
...
Amazon S3 provides logging and monitoring tools that you can use to monitor and control
 ...
 tools](monitoring-automated-manual.md "monitoring-automated-manual.md").
...
* [Amazon CloudWatch
 metrics for Amazon S3](cloudwatch-monitoring.md "cloudwatch-monitoring.md")  – Track the operational health of your
...
* [Server access
 logging](ServerLogs.md "ServerLogs.md") – Get detailed records for the requests that are
...
* [AWS Trusted
 Advisor](https://docs.aws.amazon.com/awssupport/latest/user/trusted-advisor.html "https://docs.aws.amazon.com/awssupport/latest/user/trusted-advisor.html") – Evaluate your account by using AWS best
...
* [Amazon S3 Storage Lens](storage_lens.md "storage_lens.md")
 ...
 prefixes.
* [Storage
 Class Analysis](analytics-storage-class.md "analytics-storage-class.md") – Analyze storage access patterns to
 decide when it's time to move data to a more cost-effective storage class.
* [S3 Inventory with
 Inventory reports](storage-inventory.md "storage-inventory.md") – Audit and report on objects and their
 ...
 for each object in Inventory reports, see [Amazon S3 Inventory list](storage-inventory.md#storage-inventory-contents "storage-inventory.md#storage-inventory-contents").
...
Amazon S3 provides strong read-after-write consistency for PUT and DELETE requests of
 ...
 are strongly consistent. For more information, see [Amazon S3 data consistency model](#ConsistencyModel "#ConsistencyModel").
...
* [Buckets](#BasicsBucket "#BasicsBucket")
* [Objects](#BasicsObjects "#BasicsObjects")
* [Keys](#BasicsKeys "#BasicsKeys")
* [S3 Versioning](#Versions "#Versions")
* [Version ID](#BasicsVersionID "#BasicsVersionID")
* [Bucket policy](#BucketPolicies "#BucketPolicies")
* [S3 access points](#BasicsAccessPoints "#BasicsAccessPoints")
* [Access control lists (ACLs)](#S3_ACLs "#S3_ACLs")
...
By default, all general purpose buckets are private. However, you can grant public access to general purpose buckets. 
 ...
 For more information, see [Access control in Amazon S3](access-management.md "access-management.md").
...
**Directory buckets** – Recommended for low-latency use cases and data-residency use cases. By default, you can create up to 100 directory buckets in your
 ...
 of general purpose buckets. This bucket type has no prefix limits and individual directories can scale horizontally. For more information, see [Working with directory buckets](directory-buckets-overview.md "directory-buckets-overview.md").
...
* For low-latency use cases, you can create a directory bucket in a single AWS Availability Zone to store data. Directory buckets in Availability Zones support the
 ...
 is performance sensitive and benefits from single-digit millisecond `PUT` and `GET` latencies. To learn more about creating directory buckets in Availability Zones, see [High performance workloads](directory-bucket-high-performance.md "directory-bucket-high-performance.md").
* For data-residency use cases, you can create a directory bucket in a single AWS Dedicated Local Zone (DLZ) to store data. In Dedicated Local Zones, you can create S3 directory buckets to store data 
 ...
 directory buckets in Local Zones, see [Data residency workloads](directory-bucket-data-residency.md "directory-bucket-data-residency.md").
...
Directory buckets have all public access disabled by default. This behavior can't be changed. You can't grant access to objects stored in directory buckets. You can grant access only to your 
 directory buckets. For more information, see [Authenticating and authorizing requests](s3-express-authenticating-authorizing.md "s3-express-authenticating-authorizing.md").
...
**Table buckets** – Recommended for storing tabular data, such as daily purchase transactions, streaming sensor data, or ad impressions. Tabular data represents data in columns and rows, like in a database table. Table buckets provide 
 ...
 and up to 10,000 tables per table bucket. For more information, see [Working with S3 Tables and table buckets](s3-tables.md "s3-tables.md").
...
All table buckets and tables are private and can't be made public. These resources can only be accessed by users who are explicitly granted access. To grant access, you can use IAM resource-based policies 
 for table buckets and tables, and IAM identity-based policies for users and roles. For more information, see [Security for S3 Tables](s3-tables-security-overview.md "s3-tables-security-overview.md").
...
* [Directory bucket naming rules](directory-bucket-naming-rules.md "directory-bucket-naming-rules.md")
* [Table bucket naming rules](s3-tables-buckets-naming.md#table-buckets-naming-rules "s3-tables-buckets-naming.md#table-buckets-naming-rules")
...
An object is uniquely identified within a bucket by a [key (name)](#BasicsKeys "#BasicsKeys") and a [version ID](#BasicsVersionID "#BasicsVersionID") (if
 S3 Versioning is enabled on the bucket). For more information about objects, see
 [Amazon S3 objects overview](UsingObjects.md "UsingObjects.md").
...
For more information about object keys, see [Naming Amazon S3 objects](object-keys.md "object-keys.md"). 
...
When you enable S3 Versioning in a bucket, Amazon S3 generates a unique version ID for
 ...
 modify these (or any other) objects with other operations, such as [CopyObject](../API/API_CopyObject.md "../API/API_CopyObject.md") and [PutObject](../API/API_PutObject.md "../API/API_PutObject.md"), the new objects
...
Bucket policies use JSON-based access policy language that is standard across
 ...
 objects. For more information, see [Examples of Amazon S3 bucket policies](example-bucket-policies.md "example-bucket-policies.md").
...
In your bucket policy, you can use wildcard characters on Amazon Resource Names
 ...
 you can control access to groups of objects that begin with a common [prefix](https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix "https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix") or end with a given extension, such as
 `.html`.
...
Each access point has its own access point policy. You can configure [Block Public Access](access-control-block-public-access.md "access-control-block-public-access.md") settings
...
For more information about access points for general purpose buckets, see [Managing access to shared datasets with access points](access-points.md "access-points.md"). For more information about access points for directory buckets, see [Managing access to shared datasets in directory buckets with access points](access-points-directory-buckets.md "access-points-directory-buckets.md"). 
...
You can use ACLs to grant read and write permissions to authorized users for
 ...
 more information about ACLs, see [Access control list (ACL) overview](acl-overview.md "acl-overview.md").
...
You can access Amazon S3 and its features only in the AWS Regions that are
 ...
 and manage AWS resources, see [Managing AWS Regions](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html "https://docs.aws.amazon.com/general/latest/gr/rande-manage.html") in
 the *AWS General Reference*.


For a list of Amazon S3 Regions and endpoints, see [Regions and endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html "https://docs.aws.amazon.com/general/latest/gr/s3.html") in the
...
* [Amazon Elastic Compute Cloud
 (Amazon EC2)](https://aws.amazon.com/ec2/ "https://aws.amazon.com/ec2/") – Provides secure and scalable computing
...
* [Amazon EMR](https://aws.amazon.com/elasticmapreduce/ "https://aws.amazon.com/elasticmapreduce/") – Helps businesses, researchers, data
...
* [AWS Snow
 Family](https://aws.amazon.com/snow/ "https://aws.amazon.com/snow/") – Helps customers that need to run
...
* [AWS Transfer Family](https://aws.amazon.com/aws-transfer-family/ "https://aws.amazon.com/aws-transfer-family/") – Provides fully managed support for
...
The [AWS Command Line Interface (AWS CLI)](https://aws.amazon.com/cli/ "https://aws.amazon.com/cli/") provides commands
 for a broad set of AWS services. The AWS CLI is supported on Windows, macOS, and
 Linux. To get started, see the [*AWS Command Line Interface User Guide*](https://docs.aws.amazon.com/cli/latest/userguide/ "https://docs.aws.amazon.com/cli/latest/userguide/"). For more information about the commands for
 Amazon S3, see [s3api](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html") and [s3control](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/index.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/index.html") in the *AWS CLI Command Reference*.
...
If you make direct REST API calls in your application, you must write the code to
 ...
 make requests to Amazon S3, see [Making requests](../API/MakingRequests.md "../API/MakingRequests.md")  in the *Amazon S3 API Reference*.
...
When you sign up for AWS, your AWS account is automatically signed up for all
 ...
 more information, see [AWS free tier](https://aws.amazon.com/free "https://aws.amazon.com/free"). 


To see your bill, go to the Billing and Cost Management Dashboard in the [AWS Billing and Cost Management console](https://console.aws.amazon.com/billing/ "https://console.aws.amazon.com/billing/"). To learn more about AWS account billing, see the [*AWS Billing User Guide*](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-what-is.html "https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/billing-what-is.html"). If you have
