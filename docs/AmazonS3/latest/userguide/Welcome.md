...
- [S3 Object Lock](object-lock.md "object-lock.md") – Prevent Amazon S3 objects from being
  ...
  use Object Lock to help meet regulatory requirements that require _write-once-read-many_
  _(WORM)_ storage or to simply add another
...
- [AWS Trusted
  Advisor](../../../awssupport/latest/user/trusted-advisor.md "../../../awssupport/latest/user/trusted-advisor.md") – Evaluate your account by using AWS best
...
_object_ is a file and any metadata that describes
the file. A _bucket_ is a container for objects.
...
has a _key_ (or _key
name_), which is the unique identifier for the object within the
bucket.
...
An _object key_ (or _key
name_) is the unique identifier for an object within a bucket. Every
...
you can control access to groups of objects that begin with a common [prefix](../../../general/latest/gr/glos-chap.md#keyprefix "../../../general/latest/gr/glos-chap.md#keyprefix") or end with a given extension, such as
`.html`.
...
and manage AWS resources, see [Managing AWS Regions](../../../general/latest/gr/rande-manage.md "../../../general/latest/gr/rande-manage.md") in
the _AWS General Reference_.

For a list of Amazon S3 Regions and endpoints, see [Regions and endpoints](../../../general/latest/gr/s3.md "../../../general/latest/gr/s3.md") in the
...
![An example of two clients writing to the same items with different values but returning the same read results.](images/consistency1.png)
...
![An example of two clients writing to the same items with different values but returning the same or different read results.](images/consistency2.png)
...
![An example of two clients writing to the same items with different values but returning concurrent results.](images/consistency3.png)
...
make requests to Amazon S3, see [Making requests](../API/MakingRequests.md "../API/MakingRequests.md") in the _Amazon S3 API Reference_.
