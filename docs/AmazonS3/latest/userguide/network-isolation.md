...
As a managed service, Amazon S3 is protected by the AWS global network security procedures that
 are described in the security pillar of the [AWS Well-Architected Framework](https://docs.aws.amazon.com/wellarchitected/latest/security-pillar/welcome.html "https://docs.aws.amazon.com/wellarchitected/latest/security-pillar/welcome.html").
...
Access to Amazon S3 via the network is through AWS published APIs. Clients must support
 ...
 information about this recommendation, see [Faster AWS cloud connections with TLS 1.3](https://aws.amazon.com/blogs/security/faster-aws-cloud-connections-with-tls-1-3/ "https://aws.amazon.com/blogs/security/faster-aws-cloud-connections-with-tls-1-3/") on the *AWS Security Blog*.)
