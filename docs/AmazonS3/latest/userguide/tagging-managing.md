...
For more information about object tags, see [Categorizing your objects using tags](object-tagging.md "object-tagging.md"). For more information about tag restrictions, see
 [User-Defined
 Tag Restrictions](https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html "https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/allocation-tag-restrictions.html") in the *AWS Billing and Cost Management User Guide*. 
...
Upload an object to a bucket and set tags using an S3Client. For examples, see [Upload an object to a bucket](../API/s3_example_s3_PutObject_section.md "../API/s3_example_s3_PutObject_section.md") in the *Amazon S3 API Reference*.
