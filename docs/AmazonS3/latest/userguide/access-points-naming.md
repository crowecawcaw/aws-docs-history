...
* [Access point ARNs](#access-points-arns "#access-points-arns")
* [Access point aliases](#access-points-alias "#access-points-alias")
* [Virtual-hosted–style URI](#accessing-a-bucket-through-s3-access-point "#accessing-a-bucket-through-s3-access-point")
...
Access points have Amazon Resource Names (ARNs). Access point ARNs are similar to bucket
 ...
 [Identify
 AWS resources with Amazon Resource Names (ARNs)](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference-arns.html") in the *IAM User Guide*.
...
When you create an access point, Amazon S3 automatically generates an alias that you can use
 ...
 operations, see [Access point compatibility](access-points-service-api-support.md "access-points-service-api-support.md").
...
You can use this access point alias name instead of an Amazon S3 bucket name in any data plane
 operation. For a list of these operations, see [Access point compatibility](access-points-service-api-support.md "access-points-service-api-support.md").
...
* You can't use an access point alias name for Amazon S3 control plane operations. For a
 ...
 Control](../API/API_Operations_AWS_S3_Control.md "../API/API_Operations_AWS_S3_Control.md") in the *Amazon Simple Storage Service API Reference*.
...
Access points only support virtual-host-style addressing. In a virtual-hosted–style
 ...
 For more information about virtual hosting, see [Virtual hosting of general purpose buckets](VirtualHosting.md "VirtualHosting.md").
