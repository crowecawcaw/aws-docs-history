...
You can list vectors in a vector index with the [ListVectors](../API/API_S3VectorBuckets_ListVectors.md "../API/API_S3VectorBuckets_ListVectors.md") API operation.
 ...
 the response elements of `ListVectors`, see [ListVectors](https://docs.aws.amazon.com/AmazonS3/latest/API/API_S3VectorBuckets_ListVectors "https://docs.aws.amazon.com/AmazonS3/latest/API/API_S3VectorBuckets_ListVectors") in the
...
The `segment-count` and `segment-index` parameters allow you to partition your
 ...
 see [ListVectors](https://docs.aws.amazon.com/AmazonS3/latest/API/API_S3VectorBuckets_ListVectors "https://docs.aws.amazon.com/AmazonS3/latest/API/API_S3VectorBuckets_ListVectors") in the
