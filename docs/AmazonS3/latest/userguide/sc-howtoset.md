...
You can direct Amazon S3 to change the storage class of objects automatically by adding an S3 Lifecycle configuration to a bucket. For more information, see [Managing the lifecycle of objects](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md").
...
This example request uses the `[PutObject](../API/API_PutObject.md "../API/API_PutObject.md")` command to set the storage class on a new object to S3 Intelligent-Tiering:
...
This example request uses the `[PutObject](../API/API_PutObject.md "../API/API_PutObject.md")` command to set the storage class for an existing object to S3 Intelligent-Tiering:
