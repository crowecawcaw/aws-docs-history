...
| --- | --- | --- | --- | --- | --- | --- | 
| configuration\_id | The dashboard name for the S3 Storage Lens configuration reported in the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| metrics\_version | The version of the S3 Storage Lens metrics. The metrics version has a fixed value of `1.0`. | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| organization\_id | The AWS Organizations ID for the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| aws\_account\_number | The AWS account that's associated with the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| aws\_region | The AWS Region for the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| bucket\_name | The name of the S3 bucket that's reported in the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-no.png)  | 
| storage\_class | The storage class for the bucket that's reported in the metrics | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png)  | 
| record\_type | The granularity of the metrics: ORGANIZATION, ACCOUNT, BUCKET | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png) BUCKET | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png) ACCOUNT | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png) BUCKET | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png) ACCOUNT | ![](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/icon-yes.png) ORGANIZATION | 