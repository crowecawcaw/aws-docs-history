...
up the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the _Amazon S3 API Reference_.
...
- [Restrict access to buckets in a specified
  AWS account](../../../vpc/latest/privatelink/vpc-endpoints-s3.md#bucket-policies-s3 "../../../vpc/latest/privatelink/vpc-endpoints-s3.md#bucket-policies-s3") in the _AWS PrivateLink
  Guide_
- [Restrict access to buckets that Amazon ECR uses](../../../AmazonECR/latest/userguide/vpc-endpoints.md#ecr-minimum-s3-perms "../../../AmazonECR/latest/userguide/vpc-endpoints.md#ecr-minimum-s3-perms") in the
  _Amazon ECR Guide_
- [Provide required access to Systems Manager for AWS managed Amazon S3
  buckets](../../../systems-manager/latest/userguide/ssm-agent-minimum-s3-permissions.md "../../../systems-manager/latest/userguide/ssm-agent-minimum-s3-permissions.md") in the _AWS Systems Manager
  Guide_
...
condition keys for Amazon S3, see [Actions, resources, and condition keys for Amazon S3](../../../service-authorization/latest/reference/list_amazons3.md "../../../service-authorization/latest/reference/list_amazons3.md") in the _Service Authorization
Reference_.
...
`--profile` parameter. For more information about setting
up and using the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the _Amazon S3 API Reference_.
...
you can use with `s3:max-keys` and accompanying examples, see [Numeric Condition Operators](../../../IAM/latest/UserGuide/reference_policies_elements_condition_operators.md#Conditions_Numeric "../../../IAM/latest/UserGuide/reference_policies_elements_condition_operators.md#Conditions_Numeric") in the
_IAM User Guide_.
