...
This is the default method for encrypting data at rest in your S3 file system. Amazon S3-managed encryption keys are a collection of keys that Amazon S3 owns and manages. S3 Files owns and manages encryption of your data and metadata at rest in your S3 file system when you use an Amazon S3-managed encryption key. For more information about Amazon S3-managed encryption keys, see [Protecting data with Amazon S3 managed keys](https://docs.aws.amazon.com/AmazonS3/latest/userguide/UsingServerSideEncryption.html).
...
(Required) Returns a data encryption key encrypted under a customer managed key. This permission is included in the default key policy under kms:GenerateDataKey\*.
