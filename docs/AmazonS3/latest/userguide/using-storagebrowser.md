...
In Storage Browser for S3, a *location* is an S3 general purpose bucket or prefix, that you
 grant end users access to using [S3 Access Grants](access-grants.md "access-grants.md"), IAM policies, or your
 ...
 *objects* are known as files, and *prefixes* and
 *buckets* are known as folders.)
