...
You can also create EventBridge rules to match the CloudTrail events for these API calls. For
 ...
 more information about EventBridge events, see [Events from AWS services](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-service-event.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-service-event.html").
...
For multipart uploads, this information is included in your
 ...
 using CloudTrail and CloudWatch, see [Logging and monitoring in Amazon S3](monitoring-overview.md "monitoring-overview.md").
