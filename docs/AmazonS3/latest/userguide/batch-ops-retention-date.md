...
+ When you release an event hold, you cannot specify a new retain-until-date. If you want to turn off the event hold and apply a later, explicit retain-until-date in the same job, use fixed retention instead. Fixed retention turns off the event hold and applies the retain-until-date that you specify.