...
When you create a table bucket, you can choose SSE-KMS as the default
 ...
 table bucket at any time. When you modify a encryption settings on a table
...
You also have an option to encrypt an individual table with a different
 ...
 information, see [Specifying encryption for tables](s3-tables-kms-specify.md#specify-kms-table "s3-tables-kms-specify.md#specify-kms-table").
...
To audit the usage of your AWS KMS keys for your SSE-KMS encrypted data, you can use
 ...
 operations](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#cryptographic-operations"), such as `GenerateDataKey` and `Decrypt`.
 CloudTrail supports numerous [attribute
 values](https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_LookupEvents.html "https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_LookupEvents.html") for filtering your search, including event name, user name, and event
 source.
