...
After enabling trusted access, you can also deregister delegate administrator access to
 ...
 your [management account](https://docs.aws.amazon.com/managedservices/latest/userguide/management-account.html "https://docs.aws.amazon.com/managedservices/latest/userguide/management-account.html") to create organization-level dashboards. Only the management
