...
Create a directory bucket in a Local Zone for a data residency workload. For more information, see [Data residency workloads](directory-bucket-data-residency.md "directory-bucket-data-residency.md").
5. For both types of directory buckets, on the **Create bucket** page, **Tags** is an option when creating a new directory bucket.
6. Enter a name for the bucket. For more information, see [Directory bucket naming rules](directory-bucket-naming-rules.md "directory-bucket-naming-rules.md").
