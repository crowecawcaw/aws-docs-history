...
* Enabling detective controls such as [AWS CloudTrail](cloudtrail-logging.md "cloudtrail-logging.md") or [Amazon GuardDuty](https://docs.aws.amazon.com/guardduty/latest/ug/s3_detection.html "https://docs.aws.amazon.com/guardduty/latest/ug/s3_detection.html") for
 Amazon S3.
