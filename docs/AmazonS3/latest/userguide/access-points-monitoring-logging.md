...
* [CloudWatch request metrics](#request-metrics-access-points "#request-metrics-access-points")
* [AWS CloudTrail logs for requests made through access points](#logging-access-points "#logging-access-points")
...
For more information about S3 Server Access Logs, see [Logging requests with server access logging](ServerLogs.md "ServerLogs.md"). For more information about AWS CloudTrail, see [What is
 AWS CloudTrail?](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html "https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html") in the *AWS CloudTrail User Guide*.
