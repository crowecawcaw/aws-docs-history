...
| `accessgrant`              | An Access Grant is an individual grant to your Amazon S3 data. With<br>S3 Access Grants, you can create grants to your Amazon S3 data for IAM identities<br>within your account, IAM identities in other accounts<br>(cross-account), and directory identities added to AWS IAM Identity Center from<br>your corporate directory. For more information about S3 Access Grants, see<br>[Managing access with S3 Access Grants](access-grants.md "access-grants.md")                                                                                                                                                                                                         |

###### Buckets

There are two types of Amazon S3 buckets: _general purpose
buckets_ and _directory buckets_.
...
resources by using resource tags](../../../IAM/latest/UserGuide/access_tags.md "../../../IAM/latest/UserGuide/access_tags.md") in the _IAM User Guide_.
...
authenticated users. For more information about request authentication, see [Making requests](../API/MakingRequests.md "../API/MakingRequests.md") in the _Amazon S3 API Reference_.
...
permissions. For more information, see [AWS account root user credentials and IAM user credentials](../../../general/latest/gr/root-vs-iam.md "../../../general/latest/gr/root-vs-iam.md") in the
_AWS General Reference_, and see [Security best practices in IAM](../../../IAM/latest/UserGuide/best-practices.md "../../../IAM/latest/UserGuide/best-practices.md")
...
root user](../../../IAM/latest/UserGuide/id_root-user.md "../../../IAM/latest/UserGuide/id_root-user.md").
...
AWS account owner can use AWS Identity and Access Management (IAM) to create [users](../../../IAM/latest/UserGuide/id_users.md "../../../IAM/latest/UserGuide/id_users.md"),
[groups](../../../IAM/latest/UserGuide/id_groups.md "../../../IAM/latest/UserGuide/id_groups.md"), and [roles](../../../IAM/latest/UserGuide/id_roles.md "../../../IAM/latest/UserGuide/id_roles.md"). The AWS account owner can then share
...
access to an AWS service](../../../IAM/latest/UserGuide/id_roles_common-scenarios_services.md "../../../IAM/latest/UserGuide/id_roles_common-scenarios_services.md").
...
both the _Bucket owner enforced_ and _Bucket owner
preferred_ bucket settings are turned off, the AWS account that
...
The most commonly used access management tool is an _access
policy_. An access policy can be a _resource-based policy_
...
resource-based policy](../../../IAM/latest/UserGuide/access_policies.md "../../../IAM/latest/UserGuide/access_policies.md") that is attached to a particular bucket. Use
...
An identity-based or IAM user policy is a type of [AWS Identity and Access Management (IAM) policy](../../../IAM/latest/UserGuide/access_policies.md "../../../IAM/latest/UserGuide/access_policies.md"). An identity-based policy is a
...
[AWS Identity and Access Management (IAM) policy](../../../IAM/latest/UserGuide/access_policies.md "../../../IAM/latest/UserGuide/access_policies.md"). An object ACL is used to manage access to
...
Object Ownership is set to the _Bucket owner enforced
...
For a complete list of S3 permissions and condition keys, see [Actions, resources, and condition keys for Amazon S3](../../../service-authorization/latest/reference/list_amazons3.md "../../../service-authorization/latest/reference/list_amazons3.md") in the _Service Authorization Reference_.
...
- **Access Points** – You can use
  ...
  bucket that share a specific [key name prefix](../../../general/latest/gr/glos-chap.md#keyprefix "../../../general/latest/gr/glos-chap.md#keyprefix") or
...
- **ACLs** – We do not recommend
  ...
  _Bucket owner preferred_ and _ACLs
  enabled_. With this setting, new objects that are written
...
For more information, see [Getting started with a secure static website](../../../AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.md "../../../AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.md") in the
...
see the previous option, or see [Getting started with a secure static website](../../../AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.md "../../../AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.md").
...
- **S3 Access Grants** – Use S3 Access Grants, which
  ...
  is IAM Identity Center?](../../../singlesignon/latest/userguide/what-is.md "../../../singlesignon/latest/userguide/what-is.md").
