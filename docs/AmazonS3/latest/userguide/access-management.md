...
In AWS, a resource is an entity that you can work with. In Amazon Simple Storage Service (S3), *buckets* and *objects* are the
 ...
 these feature-specific resources. For more information about Amazon S3 resources, see [S3 resources](#access-management-resources "#access-management-resources").
...
* [S3 resources](#access-management-resources "#access-management-resources")
* [Identities](#access-management-owners "#access-management-owners")
...
| --- | --- | --- |
| `bucket` | Core features | A bucket is a container for objects. To store an object in S3,
 create a bucket and then upload one or more objects to the bucket.
 For more information, see [Creating, configuring, and working with Amazon S3 general purpose buckets](creating-buckets-s3.md "creating-buckets-s3.md"). |
| `object` | An object can be a file and any metadata that describes that file.
 When an object is in the bucket, you can open it, download it, and
 move it. For more information, see [Working with objects in
 Amazon S3](uploading-downloading-objects.md "uploading-downloading-objects.md").  |
| `accesspoint` | Access Points | Access Points are named network endpoints that are attached to
 ...
 permissions, network controls, and a customized *access
 point policy* that works in conjunction with the
 ...
 for each access point. For more information, see [Managing access to shared datasets with access points](access-points.md "access-points.md"). |
| `objectlambdaaccesspoint` |  | An Object Lambda Access Point is an access point for a bucket that is also associated
 ...
 application. For more information, see [Creating Object Lambda Access Points](olap-create.md "olap-create.md").  |
| `multiregionaccesspoint` |  | Multi-Region Access Points provide a global endpoint that applications can use to
 ...
 bucket. For more information, see [Managing multi-Region traffic with Multi-Region Access Points](MultiRegionAccessPoints.md "MultiRegionAccessPoints.md"). |
| `job` | S3 Batch Operations | A job is a resource of the S3 Batch Operations feature. You can use
...
| `storagelensconfiguration` | S3 Storage Lens | An S3 Storage Lens configuration collects organization-wide storage
 ...
 information, see [Assessing your storage activity and usage with
 Amazon S3 Storage Lens](storage_lens.md "storage_lens.md"). |
| `storagelensgroup` | An S3 Storage Lens group aggregates metrics by using custom filters based
 ...
 see [Working with S3 Storage Lens groups to filter and aggregate metrics](storage-lens-groups-overview.md "storage-lens-groups-overview.md"). |
| `accessgrantsinstance` | S3 Access Grants | An S3 Access Grants instance is a container for the S3 grants that you
 ...
 S3 Access Grants, see [Managing access with S3 Access Grants](access-grants.md "access-grants.md"). |
| `accessgrantslocation` | An Access Grants Location is a bucket, prefix within a bucket, or
 ...
 directory. For more information about S3 Access Grants, see [Managing access with S3 Access Grants](access-grants.md "access-grants.md") |
| `accessgrant` | An Access Grant is an individual grant to your Amazon S3 data. With
 ...
 [Managing access with S3 Access Grants](access-grants.md "access-grants.md") |


###### Buckets


There are two types of Amazon S3 buckets: *general purpose
 buckets* and *directory buckets*.
...
* **General purpose buckets** are the original S3
 ...
 except S3 Express One Zone. For more information about S3 storage classes, see [Understanding and managing Amazon S3 storage classes](storage-class-intro.md "storage-class-intro.md").
* **Directory buckets** use the S3 Express One Zone storage class,
 ...
 For more information, see [Working with directory buckets](directory-buckets-overview.md "directory-buckets-overview.md"), [S3 Express One Zone](directory-bucket-high-performance.md#s3-express-one-zone "directory-bucket-high-performance.md#s3-express-one-zone"), and
...
For more information, see [Organizing objects using prefixes](using-prefixes.md "using-prefixes.md"). S3 Console uses the concept of
 *folders*, which, in general purpose buckets, are
 essentially prefixes that are pre-pended to the object key name. For more
 information, see [Organizing objects in the Amazon S3 console by using folders](using-folders.md "using-folders.md").
...
For more information, see [Controlling access to AWS
 resources by using resource tags](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html") in the *IAM User Guide*.
...
Identities that don't own a resource can request access to that resource. Requests to
 ...
 authenticated users. For more information about request authentication, see [Making requests](../API/MakingRequests.md "../API/MakingRequests.md")  in the *Amazon S3 API Reference*. 
...
We
 ...
 full access. We refer to users with this role as *administrator users*. You can use credentials assigned to the
 ...
 permissions. For more information, see [AWS account root user credentials and IAM user credentials](https://docs.aws.amazon.com/general/latest/gr/root-vs-iam.html "https://docs.aws.amazon.com/general/latest/gr/root-vs-iam.html") in the
 *AWS General Reference*, and see [Security best practices in IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html")
...
The AWS account that created the resource. For example, the account that created
 ...
 root user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-user.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_root-user.html").
...
When setting up accounts for new team members who require S3 access, the
 AWS account owner can use AWS Identity and Access Management (IAM) to create [users](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users.html"),
 [groups](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_groups.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_groups.html"), and [roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html"). The AWS account owner can then share
...
IAM identities provide increased capabilities, including the ability to require
 ...
 practices in IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/best-practices.html"). 
...
The AWS account owner can make resources public. Making a resource public
 technically shares the resource with *the anonymous user*.
...
The resource owner can grant another AWS service access to an Amazon S3 resource. For
 ...
 access to an AWS service](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_common-scenarios_services.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_common-scenarios_services.html").
...
The resource owner can grant users or roles from your corporate directory access
 to an S3 resource by using [S3 Access Grants](access-grants-get-started.md "access-grants-get-started.md").
...
When a bucket owner permits another account to upload objects to a bucket, the
 ...
 both the *Bucket owner enforced* and *Bucket owner
 preferred* bucket settings are turned off, the AWS account that
...
* The bucket owner can archive any objects or restore archived objects,
 ...
 store the objects. For more information, see [Managing the lifecycle of objects](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md").
...
An access policy describes who has access to what things. When Amazon S3 receives a
 ...
 [How Amazon S3 authorizes a request](how-s3-evaluates-access-control.md "how-s3-evaluates-access-control.md").
...
* **Block Public Access** — Do not turn off
 the default bucket-level setting *Block Public Access*. This
...
* **S3 Versioning** — For data integrity, you
 ...
 about S3 Versioning, see [Retaining multiple versions of objects with S3 Versioning](Versioning.md "Versioning.md").
* **S3 Object Lock** — S3 Object Lock is
 ...
 immutably. For information about Object Lock, see [Locking objects with Object Lock](object-lock.md "object-lock.md").
* **Object encryption** — Amazon S3 offers several
 object encryption options that protect data in transit and at rest.
 *Server-side encryption* encrypts your object before
 ...
 buckets](bucket-encryption.md "bucket-encryption.md"). *Client-side
 encryption* is the act of encrypting data before sending it to
...
* **Signing methods** — Signature Version 4
 ...
 [Authenticating
 Requests (AWS Signature Version 4)](../API/sig-v4-authenticating-requests.md "../API/sig-v4-authenticating-requests.md") and [Signature Version 4 signing
 process](https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html "https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html").

## Actions


For a complete list of S3 permissions and condition keys, see [Actions, resources, and condition keys for Amazon S3](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html "https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html") in the *Service Authorization Reference*.
...
In most cases, you can use an access policy to manage permissions. An access policy
 ...
 another Amazon S3 resource ([S3 resources](#access-management-resources "#access-management-resources")). An access policy can also be an
...
* **Bucket policy** – If you want to
 ...
 bucket. For more information, see [Bucket policies for Amazon S3](bucket-policies.md "bucket-policies.md").
...
* **S3 Access Grants** – You can use S3 Access Grants to
 ...
 policies are limited to 20 KB in size. For more information, see [Getting started with S3 Access Grants](access-grants-get-started.md "access-grants-get-started.md").
* **Access Points** – You can use
 ...
 see [Managing access to shared datasets with access points](access-points.md "access-points.md").
To grant permission to another AWS account, you must use a bucket policy or
 ...
 buckets?](https://repost.aws/knowledge-center/cross-account-access-s3 "https://repost.aws/knowledge-center/cross-account-access-s3")
...
* **Bucket policy** – With bucket
 ...
 see [Bucket policies for Amazon S3](bucket-policies.md "bucket-policies.md").
* **S3 Access Grants** – You can use S3 Access Grants to
 ...
 more information, see [Getting started with S3 Access Grants](access-grants-get-started.md "access-grants-get-started.md").
* **Access Points** – You can use
 Access Points, which are named network endpoints that are attached to a
 bucket. A bucket can have up to 10,000 access points attached, and for each access point
 you can enforce distinct permissions and network controls to give you
...
In a bucket policy, for example, you can grant access to the objects within a
 bucket that share a specific [key name prefix](https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix "https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix") or
...
* **Access Points** – You can use
 ...
 over access to your S3 objects. For more information, see [Managing access to shared datasets with access points](access-points.md "access-points.md").
* **ACLs** – We do not recommend
 ...
 your Bucket Settings, set *Object Ownership* to
 *Bucket owner preferred* and *ACLs
 enabled*. With this setting, new objects that are written
...
* **Access Points** – Access Points are
 ...
 access to your S3 objects. For more information, see [Managing access to shared datasets with access points](access-points.md "access-points.md").
...
* **Access Points** – Access Points are
 ...
 [Managing access to shared datasets with access points](access-points.md "access-points.md").
...
For more information, see [Getting started with a secure static website](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.html "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.html") in the
...
We do not recommend this method. Instead, we recommend you use
 ...
 see the previous option, or see [Getting started with a secure static website](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.html "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/getting-started-secure-static-website-cloudformation-template.html").
...
When creating a new Amazon S3 bucket, the *Block Public Access*
...
* **Disable Block Public Access setting**
 ...
 For example, unauthenticated [PUT Object](../API/RESTObjectPUT.md "../API/RESTObjectPUT.md") requests are allowed when a bucket has a public
...
* **Access Points** – Use access
 ...
 cross-Region replication. For more information, see [Managing access to shared datasets with access points](access-points.md "access-points.md").
* **S3 Access Grants** – Use S3 Access Grants, which
 supports a very large number of grants that give access to buckets,
 prefixes, or objects. For more information, see [Getting started with S3 Access Grants](access-grants-get-started.md "access-grants-get-started.md").
Instead of managing users, groups, and roles through AWS Identity and Access Management (IAM), you
 ...
 is IAM Identity Center?](https://docs.aws.amazon.com/singlesignon/latest/userguide/what-is.html "https://docs.aws.amazon.com/singlesignon/latest/userguide/what-is.html"). 
...
* **Bucket ACL** – The only
 ...
 your log files](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html#AccessLogsBucketAndFileOwnership "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html#AccessLogsBucketAndFileOwnership") in the *Amazon CloudFront Developer Guide*. If the bucket that stores the logs uses
 the *Bucket owner enforced* setting for
...
* **Object Ownership** – Keep the
 bucket-level setting *Object Ownership* at the
 default *Bucket owner enforced* setting.
...
IAM Access Analyzer for S3 is available at no extra cost on the Amazon S3 console. IAM Access Analyzer for S3 is powered by
 ...
 [IAM Console](https://console.aws.amazon.com/iam/ "https://console.aws.amazon.com/iam/") and create an account-level analyzer in IAM Access Analyzer for each individual
 Region. 


For more information about IAM Access Analyzer for S3, see [Reviewing bucket access using IAM Access Analyzer for S3](access-analyzer.md "access-analyzer.md").
...
For more information, see [Logging and monitoring in Amazon S3](monitoring-overview.md "monitoring-overview.md").
