...
6. To configure encryption, under **Encryption type**, choose one of
   ...
   [Quotas](../../../kms/latest/developerguide/limits.md "../../../kms/latest/developerguide/limits.md") in the _AWS Key Management Service Developer Guide_.
...
keys (DSSE-KMS)**, do the following:
     ...
     following ways:
    	...
    	* To choose from a list of available KMS keys, choose **Choose from
    	...
    	Both the AWS managed key (`aws/s3`) and your customer managed keys appear
    	 in this list. For more information about customer managed keys, see [Customer keys and AWS keys](../../../kms/latest/developerguide/concepts.md#key-mgmt "../../../kms/latest/developerguide/concepts.md#key-mgmt") in the
    ...
    When you use an AWS KMS key for server-side encryption in Amazon S3, you must
     ...
     encryption KMS keys](../../../kms/latest/developerguide/concepts.md#symmetric-cmks "../../../kms/latest/developerguide/concepts.md#symmetric-cmks") in the
     *AWS Key Management Service Developer Guide*.
