...
control access to groups of objects that begin with a common [prefix](../../../general/latest/gr/glos-chap.md#keyprefix "../../../general/latest/gr/glos-chap.md#keyprefix") or end with a specific
...
condition that tests multiple key values](../../../IAM/latest/UserGuide/reference_policies_multi-value-conditions.md "../../../IAM/latest/UserGuide/reference_policies_multi-value-conditions.md") in the _IAM User Guide_.
...
prevent the Amazon S3 service from being used as a [confused deputy](../../../IAM/latest/UserGuide/confused-deputy.md "../../../IAM/latest/UserGuide/confused-deputy.md") during
...
accessing your bucket. To determine whether the request is HTTP or HTTPS, use the [aws:SecureTransport](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-securetransport "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-securetransport") global condition key in your S3 bucket
...
Identity](../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md "../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md") in the _Amazon CloudFront Developer Guide_.

The following policy uses the OAI's ID as the policy's `Principal`. For more
information about using S3 bucket policies to grant access to a CloudFront OAI, see [Migrating from origin access identity (OAI) to origin access control (OAC)](../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md#migrate-from-oai-to-oac "../../../AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.md#migrate-from-oai-to-oac") in the
...
- Replace `EH1HDMB1FH2TC` with the OAI's ID. To
  ...
  CloudFront console, or use [ListCloudFrontOriginAccessIdentities](../../../cloudfront/latest/APIReference/API_ListCloudFrontOriginAccessIdentities.md "../../../cloudfront/latest/APIReference/API_ListCloudFrontOriginAccessIdentities.md") in the CloudFront API.
...
Multi-Factor Authentication (MFA) in AWS](../../../IAM/latest/UserGuide/id_credentials_mfa.md "../../../IAM/latest/UserGuide/id_credentials_mfa.md") in the
_IAM User Guide_.
