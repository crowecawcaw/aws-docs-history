...
The following examples show how you can use the AWS SDKs to delete an object from a
 ...
 Object](../API/RESTObjectDELETE.md "../API/RESTObjectDELETE.md") in the *Amazon Simple Storage Service API Reference*
...
For more examples, and examples in other languages, see [Use `DeleteObject` with an AWS SDK or CLI](../API/s3_example_s3_DeleteObject_section.md "../API/s3_example_s3_DeleteObject_section.md")  in the *Amazon S3 API reference*.
...
For examples of how to delete a single object with the AWS SDK for Java, see [Delete an object](../API/s3_example_s3_DeleteObject_section.md "../API/s3_example_s3_DeleteObject_section.md") in the *Amazon S3 API Reference*.
