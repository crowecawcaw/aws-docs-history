...
* [list-multipart-uploads](https://docs.aws.amazon.com/cli/latest/reference/s3api/list-multipart-uploads.html "https://docs.aws.amazon.com/cli/latest/reference/s3api/list-multipart-uploads.html")‐list in-progress multipart uploads.
...
| 2 | Run the S3Client `listMultipartUploads` method. The method returns an
 instance of the `ListMultipartUploadsResponse`
 class that gives you information about the multipart
 uploads in progress. |


For examples of how to list multipart uploads with the AWS SDK for Java, see [List multipart uploads](../API/s3_example_s3_ListMultipartUploads_section.md "../API/s3_example_s3_ListMultipartUploads_section.md") in the *Amazon S3 API Reference*.


.NETTo list all of the in-progress multipart uploads on a specific bucket, use the SDK for .NET
...
PHPThis topic shows how to use the low-level API classes from version 3 of the AWS SDK for PHP to
