...
Low-level API multipart uploads listing process| 1 | Create an instance of the `ListMultipartUploadsRequest` class and<br>provide the bucket name. |
| 2 | Run the S3Client `listMultipartUploads` method. The method returns an<br>instance of the `ListMultipartUploadsResponse`<br>class that gives you information about the multipart<br>uploads in progress. |

For examples of how to list multipart uploads with the AWS SDK for Java, see [List multipart uploads](../API/s3_example_s3_ListMultipartUploads_section.md "../API/s3_example_s3_ListMultipartUploads_section.md") in the _Amazon S3 API Reference_.
