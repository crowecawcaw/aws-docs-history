...
NoteAccess points don't have ACLs associated with them. If you
...
ImportantTo use this setting effectively, we recommend that you apply
 it at the *account* level. A bucket policy
...
| `RestrictPublicBuckets` | Setting this option to `TRUE` restricts access to an
...
When evaluating a bucket policy, Amazon S3 begins by assuming that the policy is public. It
 ...
 Policy Variable](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_variables.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_variables.html")) for one or more of the following:
...
When using [multivalued context keys](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-single-vs-multi-valued-context-keys.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_condition-single-vs-multi-valued-context-keys.html"), you must use the `ForAllValues` or
