...
`ListMultipartUploads` is a Zonal endpoint API operation. However, it is logged to CloudTrail as a management event. For more information, see [ListMultipartUploads](../API/API_ListMultipartUploads.md "../API/API_ListMultipartUploads.md") in the *Amazon Simple Storage Service API Reference*. 
