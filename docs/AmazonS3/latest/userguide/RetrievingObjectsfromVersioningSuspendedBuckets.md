...
![Illustration that shows how a simple GET returns the current version of an object.](../../../images/AmazonS3/latest/userguide/images/versioning_GET_suspended.png)
