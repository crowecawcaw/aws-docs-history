...
For examples of how to delete job tags with the AWS SDK for Java, see [Delete tags from a batch job](../API/s3-control_example_s3-control_DeleteJobTagging_section.md "../API/s3-control_example_s3-control_DeleteJobTagging_section.md") in the _Amazon S3 API Reference_.
