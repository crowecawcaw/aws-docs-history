...
You can use the REST API to list your access points. For more information, see [ListObjectsV2](../API/API_ListObjectsV2.md "../API/API_ListObjectsV2.md") in the *Amazon Simple Storage Service API Reference*.
