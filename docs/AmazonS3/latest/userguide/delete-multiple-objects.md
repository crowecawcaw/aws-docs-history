...
For examples of how to delete multiple objects with the AWS SDKs, see [Delete multiple objects](../API/s3_example_s3_DeleteObjects_section.md "../API/s3_example_s3_DeleteObjects_section.md") in the *Amazon S3 API Reference*.
...
For more information, see [Delete Multiple Objects](../API/multiobjectdeleteapi.md "../API/multiobjectdeleteapi.md") in the *Amazon Simple Storage Service API Reference*.
