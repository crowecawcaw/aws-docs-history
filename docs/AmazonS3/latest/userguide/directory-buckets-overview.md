...
Quotas, also referred to as limits, are the maximum number of service resources or
 ...
 quotas](https://docs.aws.amazon.com/general/latest/gr/s3.html#limits_s3 "https://docs.aws.amazon.com/general/latest/gr/s3.html#limits_s3").
...
* [Use cases for directory buckets](directory-bucket-use-cases.md "directory-bucket-use-cases.md")
* [Differences for directory buckets](s3-express-differences.md "s3-express-differences.md")
* [Networking for directory buckets](s3-express-networking.md "s3-express-networking.md")
* [Directory bucket naming rules](directory-bucket-naming-rules.md "directory-bucket-naming-rules.md")
* [Viewing directory bucket properties](directory-bucket-view.md "directory-bucket-view.md")
* [Managing directory bucket policies](directory-bucket-bucket-policy.md "directory-bucket-bucket-policy.md")
* [Emptying a directory bucket](directory-bucket-empty.md "directory-bucket-empty.md")
