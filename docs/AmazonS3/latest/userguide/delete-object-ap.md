...
You can use the REST API to delete an object through an access point. For more information, see [DeleteObject](../API/API_DeleteObject.md "../API/API_DeleteObject.md") in the *Amazon Simple Storage Service API Reference*.
