...
To get started appending data to objects in your directory buckets, you can use the AWS
 ...
 [`PutObject`](../API/API_PutObject.md "../API/API_PutObject.md") and [`CreateSession`](../API/API_CreateSession.md "../API/API_CreateSession.md") in the *Amazon S3 API Reference*. 
