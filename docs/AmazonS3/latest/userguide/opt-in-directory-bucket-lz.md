...
For all the services in AWS Dedicated Local Zones (Dedicated Local Zones), including Amazon S3, your administrator must
 ...
 You can use the
 [DescribeAvailabilityZones](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAvailabilityZones.html "https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeAvailabilityZones.html") API operation to confirm your account ID access to a Local Zone.
