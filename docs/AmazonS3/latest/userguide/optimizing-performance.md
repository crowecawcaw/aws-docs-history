...
Your applications can easily achieve thousands of transactions per second in request
 ...
 and using prefixes, see [Organizing objects using prefixes](using-prefixes.md "using-prefixes.md").
...
Some data lake applications on Amazon S3 scan millions or billions of objects for queries that
 ...
 that maximize the network interface use for their [Amazon EC2](https://docs.aws.amazon.com/ec2/index.html "https://docs.aws.amazon.com/ec2/index.html") instance, which can be up to 100 Gb/s on a single instance. These applications
...
Other AWS services can also help accelerate performance for different application
 ...
 single-digit millisecond latencies, use [Amazon CloudFront](https://docs.aws.amazon.com/cloudfront/index.html "https://docs.aws.amazon.com/cloudfront/index.html") or [Amazon ElastiCache](https://docs.aws.amazon.com/elasticache/index.html "https://docs.aws.amazon.com/elasticache/index.html") for
...
Additionally, if you want fast data transport over long distances between a client and an S3
 ...
 transport over geographical distances. If your Amazon S3 workload uses server-side encryption with AWS KMS, see [AWS KMS Limits](https://docs.aws.amazon.com/kms/latest/developerguide/limits.html "https://docs.aws.amazon.com/kms/latest/developerguide/limits.html")
...
* [Performance guidelines for
 Amazon S3](optimizing-performance-guidelines.md "optimizing-performance-guidelines.md")
* [Performance design
