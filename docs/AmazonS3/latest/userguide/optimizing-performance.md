...
that maximize the network interface use for their [Amazon EC2](../../../ec2/index.md "../../../ec2/index.md") instance, which can be up to 100 Gb/s on a single instance. These applications
...
single-digit millisecond latencies, use [Amazon CloudFront](../../../cloudfront/index.md "../../../cloudfront/index.md") or [Amazon ElastiCache](../../../elasticache/index.md "../../../elasticache/index.md") for
