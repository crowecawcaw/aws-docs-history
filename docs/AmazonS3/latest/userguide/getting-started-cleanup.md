...
The type of each record set is listed in the **Type** column. 4. Choose **Delete Record Set**. 5. When prompted for confirmation, choose **Confirm**.
...
Now, you can delete your bucket. For more information, see [Deleting a general purpose bucket](delete-bucket.md "delete-bucket.md").
