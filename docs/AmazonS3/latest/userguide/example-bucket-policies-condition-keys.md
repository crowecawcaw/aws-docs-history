...
If you have two AWS accounts, you can test the policy using the
 ...
 information about setting up and using the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the *Amazon S3 API Reference*.
