...
For example, for the following table bucket ARN: `arn:aws:s3tables:{{us-east-1}}:111122223333:bucket/{{bucketname}}` the prefix would be: `arn%3Aaws%3As3tables%3A{{us-east-1}}%3A{{111122223333}}%3Abucket%2F{{bucketname}}` 
