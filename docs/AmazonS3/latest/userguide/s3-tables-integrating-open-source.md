...
API requests to the S3 Tables service endpoints are authenticated using AWS Signature Version 4 (SigV4). See [AWS Signature Version 4 for API requests](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_sigv.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_sigv.html") to learn more about AWS SigV4.
