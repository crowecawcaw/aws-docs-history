...
<a name="custom-metadata"></a>

Custom object metadata is metadata that you control. You can use custom object metadata to store information about your objects that is meaningful to your applications. Amazon S3 supports three types of custom object metadata: annotations, object tags, and user-defined metadata.

### Annotations
<a name="annotations-intro"></a>

Annotations are named data payloads that you can attach to any Amazon S3 object after it's uploaded. Each annotation can store up to 1 MB of UTF-8 text, such as AI-generated output, classification results, or processing records. You can create, retrieve, list, and delete annotations without modifying the object itself. For more information, see [Annotating your objects](annotations-overview.md).

### Object tags
<a name="object-tags-intro"></a>

Object tags are key-value pairs that you can use to categorize, organize, and control access to your objects. Each object can have up to 10 tags. You can use tags in IAM and bucket policies, S3 Lifecycle rules, and cost allocation reports. For more information, see [Tagging your objects](object-tagging.md).
...
By default, S3 Metadata provides [system-defined object metadata](#SysMetadata), such as an object's creation time and storage class, and custom metadata, such as tags, [user-defined metadata](#UserMetadata), and annotations. S3 Metadata also provides event metadata, such as when an object is updated or deleted, and the AWS account that made the request.
