...
For example, you can create a new AWS Identity and Access Management (IAM) user and role for this purpose. Make
 ...
 [pass the
 IAM role](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-ec2_instance-profiles.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_switch-role-ec2_instance-profiles.html") to your Amazon EC2 instance with an instance profile. 
...
1. Mount your Amazon S3 buckets.
	...
	2. Alternatively, you can configure automatic mounting of Amazon S3 buckets when an instance starts up or reboots. 
...
Mountpoint for Amazon S3 intentionally does not implement the full [POSIX](https://en.wikipedia.org/wiki/POSIX "https://en.wikipedia.org/wiki/POSIX") standard specification for
 ...
 system semantics should consider other AWS file services, such as [Amazon Elastic File System (Amazon EFS)](https://aws.amazon.com/efs/ "https://aws.amazon.com/efs/")  or [Amazon FSx](https://aws.amazon.com/fsx/ "https://aws.amazon.com/fsx/").
