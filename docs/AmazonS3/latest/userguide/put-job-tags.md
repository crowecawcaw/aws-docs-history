...
For examples of how to put job tags with the AWS SDK for Java, see [Add tags to a batch job](../API/s3-control_example_s3-control_PutJobTagging_section.md "../API/s3-control_example_s3-control_PutJobTagging_section.md") in the _Amazon S3 API Reference_.
