...
**Note**  
This page covers the space-delimited text format used for logs delivered to an Amazon S3 general purpose bucket. For the structured JSON format used in Amazon CloudWatch Logs, see [Log format in CloudWatch Logs](sal-cw-log-format.md).
