...
For examples of how to use Amazon S3 Select with the AWS SDK for Java, see [Select content from an object](../API/s3_example_s3_SelectObjectContent_section.md "../API/s3_example_s3_SelectObjectContent_section.md") in the *Amazon S3 API Reference*.
