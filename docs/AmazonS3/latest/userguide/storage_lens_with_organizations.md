...
After enabling trusted access, add delegated administrator access to accounts in your
 ...
 and AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-s3lens.html "https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-s3lens.html") in the *AWS Organizations User Guide*.
