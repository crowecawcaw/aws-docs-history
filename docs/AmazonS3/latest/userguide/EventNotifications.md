...
in the _notification_ subresource that's associated with a bucket. For
...
[Amazon S3 service quotas](../../../general/latest/gr/s3.md#limits_s3 "../../../general/latest/gr/s3.md#limits_s3") in _AWS General Reference_.
