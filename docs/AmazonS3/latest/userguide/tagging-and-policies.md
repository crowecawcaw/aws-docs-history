...
* [Bucket operations](security_iam_service-with-iam.md#using-with-s3-actions-related-to-buckets "security_iam_service-with-iam.md#using-with-s3-actions-related-to-buckets")
...
For a complete list of Amazon S3 service-specific condition keys, see [Bucket policy examples using condition keys](amazon-s3-policy-keys.md "amazon-s3-policy-keys.md"). The
