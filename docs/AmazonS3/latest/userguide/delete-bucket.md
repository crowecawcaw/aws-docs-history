...
You can delete an empty Amazon S3 general purpose bucket. For information about emptying a general purpose bucket, see [Emptying a general purpose bucket](empty-bucket.md "empty-bucket.md"). 
...
* If the bucket receives log data from Elastic Load Balancing (ELB), we recommend that you
 ...
 your Classic Load Balancer](https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/access-log-collection.html "https://docs.aws.amazon.com/elasticloadbalancing/latest/classic/access-log-collection.html") in the *User Guide for Classic Load Balancers* and [Access logs for your
 Application Load Balancer](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/load-balancer-access-logs.html "https://docs.aws.amazon.com/elasticloadbalancing/latest/application/load-balancer-access-logs.html") in the *User Guide for Application Load Balancers*.
###### Troubleshooting
...
* **Make sure that the bucket is empty** – You
 ...
 bucket is empty. For information about emptying a bucket, see [Emptying a general purpose bucket](empty-bucket.md "empty-bucket.md").
...
* **Make sure that you have the `s3:DeleteBucket`
 ...
 IAM user](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_change-permissions.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_users_change-permissions.html") in the *IAM User Guide*. For troubleshooting information,
...
* **Check for `s3:DeleteBucket Deny` statements in AWS Organizations
 ...
 policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scps.html") and [resource control
 policies](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_rcps.html "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_rcps.html") in the *AWS Organizations User Guide*.
...
Before you can delete a general purpose bucket, you must empty it. For information about emptying a
 bucket, see [Emptying a general purpose bucket](empty-bucket.md "empty-bucket.md").
...
For examples in other languages, see [Use DeleteBucket with
 an AWS SDK or CLI](../API/s3_example_s3_DeleteBucket_section.md "../API/s3_example_s3_DeleteBucket_section.md") in the *Amazon Simple Storage Service API Reference*. For information
...
For examples of how to delete a bucket with the AWS SDK for Java, see [Delete a bucket](../API/s3_example_s3_DeleteBucket_section.md "../API/s3_example_s3_DeleteBucket_section.md") in the *Amazon S3 API Reference*.
...
If versioning is enabled, using the `rb` command with the
 ...
 versions](DeletingObjectVersions.md "DeletingObjectVersions.md").
...
For more information, see [Using
 High-Level S3 Commands with the AWS Command Line Interface](https://docs.aws.amazon.com/cli/latest/userguide/using-s3-commands.html "https://docs.aws.amazon.com/cli/latest/userguide/using-s3-commands.html") in the *AWS Command Line Interface User Guide*.
