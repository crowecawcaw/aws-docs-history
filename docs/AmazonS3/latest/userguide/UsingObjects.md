...
Tags  
You can use tags to categorize your stored objects, for access control, or cost allocation. For more information, see [Tagging your objects](object-tagging.md).
