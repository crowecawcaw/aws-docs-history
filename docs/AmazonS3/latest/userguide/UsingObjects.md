...
metadata](UsingMetadata.md "UsingMetadata.md").
...
other entity such as an object or a bucket. For more information, see [Object subresources](#ObjectAndSubResource "#ObjectAndSubResource").
...
information about sharing objects, see [Sharing objects with presigned URLs](ShareObjectPreSignedURL.md "ShareObjectPreSignedURL.md").
...
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| acl         | Contains a list of grants identifying the grantees and the permissions granted.<br>When you create an object, the `acl` identifies the object owner as having<br>full control over the object. You can retrieve an object ACL or replace it with an<br>updated list of grants. Any update to an ACL requires you to replace the existing ACL.<br>For more information about ACLs, see [Access control list (ACL) overview](acl-overview.md "acl-overview.md"). |
