...
A *manifest* is an Amazon S3 object list that contains
...
For more information, see [Specifying a manifest](#specify-batchjob-manifest "#specify-batchjob-manifest").
...
For more information about IAM roles, see [IAM roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html") in the
 *IAM User Guide*.
...
Batch Operations jobs that perform actions on directory buckets require specific
 ...
 Express One Zone](s3-express-security-iam.md "s3-express-security-iam.md").
 ...
 *tags*. You can use tags to identify who is responsible for a
...
A *manifest* is an Amazon S3 object list that contains the object keys that you want Amazon S3 to act
...
To filter the list of objects to be included in an automatically generated object
 list, you can specify the following criteria. For more information, see [JobManifestGeneratorFilter](../API/API_control_JobManifestGeneratorFilter.md "../API/API_control_JobManifestGeneratorFilter.md") in the *Amazon S3 API
 Reference*.
...
The syntax for specifying manifest criteria varies depending on the method that you use
 to create your job. For examples, see [Creating a job](#to-create-batch-ops-job "#to-create-batch-ops-job").
...
* **Amazon S3 Inventory report** – Must be a
 ...
 For more information about inventory reports, see [Cataloging and analyzing your data with S3 Inventory](storage-inventory.md "storage-inventory.md"). If the inventory report includes version IDs,
...
###### Note
	...
	+ S3 Batch Operations supports CSV *inventory reports* that are
...
* **CSV file** – Each row in the file must include
 ...
 about the CSV manifest format, see [JobManifestSpec](../API/API_control_JobManifestSpec.md "../API/API_control_JobManifestSpec.md") in the
 *Amazon Simple Storage Service API Reference*.


###### Note

S3 Batch Operations doesn't support CSV *manifest files* that are
 encrypted with SSE-KMS.
...
Before you create a Batch Operations job, confirm that you have configured the relevant
 permissions. For more information, see [Granting permissions for Batch Operations](batch-ops-iam-role-policies.md "batch-ops-iam-role-policies.md").
...
###### Note
 ...
 in the manifest.
5. For **Scope**, specify the list of objects that your Batch Operations
 job will act upon.
...
The `manifest.csv` file provides a list of bucket and
 ...
 `update-job-status` command. For more information, see [create-job](https://docs.aws.amazon.com/cli/latest/reference/s3control/create-job.html "https://docs.aws.amazon.com/cli/latest/reference/s3control/create-job.html") in the *AWS CLI Command Reference*.
...
For more information, see [create-job](https://docs.aws.amazon.com/cli/latest/reference/s3control/create-job.html "https://docs.aws.amazon.com/cli/latest/reference/s3control/create-job.html") in the *AWS CLI Command Reference*.
...
For examples of how to create S3 Batch Operations jobs with the AWS SDK for Java, see [Create a batch job to copy objects](../API/s3-control_example_s3-control_CreateJob_section.md "../API/s3-control_example_s3-control_CreateJob_section.md") in the *Amazon S3 API Reference*.

You can use the REST API to create a Batch Operations job. For more information, see [CreateJob](../API/API_control_CreateJob.md "../API/API_control_CreateJob.md") in the *Amazon Simple Storage Service API Reference*. 
