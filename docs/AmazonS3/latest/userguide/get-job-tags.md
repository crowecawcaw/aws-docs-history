...
For examples of how to get job tags with the AWS SDK for Java, see [Get tags from a batch job](../API/s3-control_example_s3-control_GetJobTagging_section.md "../API/s3-control_example_s3-control_GetJobTagging_section.md") in the *Amazon S3 API Reference*.
