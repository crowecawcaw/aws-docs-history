...
- If you're using S3 Replication Time Control, Amazon CloudWatch begins reporting replication metrics 15
  ...
  thresholds. For more information, see [Meeting compliance requirements with
...
account](replication-walkthrough1.md "replication-walkthrough1.md"). You can choose to apply your replication rule
...
###### To view S3 Replication metrics through the source bucket's **Metrics**
