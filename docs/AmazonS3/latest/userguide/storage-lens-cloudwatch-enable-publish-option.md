...
data-protection best practices. For more information, see [Amazon S3 pricing](https://aws.amazon.com/s3/pricing/ "https://aws.amazon.com/s3/pricing/"). 5. Under **Select Advanced metrics and recommendations
...
4. Under **General**, define the following configuration
   ...
   dashboard name after you create your dashboard. 2. Choose the **Home Region** for your dashboard.
...
You can add up to 50 tags to your dashboard configuration. 6. Define the scope for your configuration:
...
For more information about advanced metrics and recommendations features, see [Metrics selection](storage_lens_basics_metrics_recommendations.md#storage_lens_basics_metrics_selection "storage_lens_basics_metrics_recommendations.md#storage_lens_basics_metrics_selection"). 9. If you enabled **Advanced metrics**, select the
