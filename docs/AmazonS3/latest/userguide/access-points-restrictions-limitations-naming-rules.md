...
* You can create a maximum of 10,000 access points per AWS account per AWS Region.
 ...
 and requesting an increase, see [AWS service quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html "https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html")
...
* You cannot use the `CreateAccessPoint` API when creating and
 attaching an access point to a volume on a Amazon FSx file system. You must use the [CreateAndAttachS3AccessPoint](https://docs.aws.amazon.com/fsx/latest/APIReference/API_CreateAndAttachS3AccessPoint.html "https://docs.aws.amazon.com/fsx/latest/APIReference/API_CreateAndAttachS3AccessPoint.html") API.
...
* FSx for OpenZFS deployment type and storage class support varies by AWS Region. For more information, see 
 [Availability by AWS Region](https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/available-aws-regions.html "https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/available-aws-regions.html") in the *OpenZFS User
 Guide*.
