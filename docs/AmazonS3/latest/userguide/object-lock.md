 ...
 *write-once-read-many* (WORM) model to store objects. You can use
...
S3 Object Lock has been assessed by Cohasset Associates for use in
 ...
 information about how Object Lock relates to these regulations, see the [Cohasset Associates Compliance Assessment](https://d1.awsstatic.com/r2018/b/S3-Object-Lock/Amazon-S3-Compliance-Assessment.pdf "https://d1.awsstatic.com/r2018/b/S3-Object-Lock/Amazon-S3-Compliance-Assessment.pdf").
...
* **Retention period** – A retention period
 ...
 policy. This condition key helps you establish the allowable retention period. For more information, see [Setting limits on retention periods with a bucket policy](object-lock-managing.md#object-lock-managing-retention-limits "object-lock-managing.md#object-lock-managing-retention-limits").
...
Object Lock works only in buckets that have S3 Versioning enabled. When you lock an object
 ...
 S3 Versioning, see [Retaining multiple versions of objects with S3 Versioning](Versioning.md "Versioning.md").
...
* [Retention periods](#object-lock-retention-periods "#object-lock-retention-periods")
* [Retention modes](#object-lock-retention-modes "#object-lock-retention-modes")
* [Legal holds](#object-lock-legal-holds "#object-lock-legal-holds")
* [How deletes work with S3 Object Lock](#object-lock-how-deletes-work "#object-lock-how-deletes-work")
* [Best practices for using S3 Object Lock](#object-lock-best-practices "#object-lock-best-practices")
* [Required permissions](#object-lock-permissions "#object-lock-permissions")

### Retention periods


A *retention period* protects an object version for a fixed amount
 ...
 *Retain Until Date* for the object version. Amazon S3 stores this date
...
You can also set a retention period in a bucket's properties. When you set a retention
 ...
 bucket, Amazon S3 calculates a *Retain Until Date* for the object version
...
After you've applied a retention setting to an object version, you can extend the
 ...
 with a *Retain Until Date* that is later than the one currently
...
In *compliance* mode, a protected object version can't be
...
By default, the Amazon S3 console includes the
 ...
 delete objects protected by *governance* mode and have the
...
With Object Lock, you can also place a *legal hold* on an object
...
* **Permanent `DELETE` request** – If you issued a
 ...
 information about troubleshooting Access Denied errors with Object Lock, see [S3 Object Lock settings](troubleshoot-403-errors.md#troubleshoot-403-object-lock "troubleshoot-403-errors.md#troubleshoot-403-object-lock").
* **Simple `DELETE` request** – If you issued a
 ...
 information about managing delete markers with Object Lock, see [Managing delete markers with Object Lock](object-lock-managing.md#object-lock-managing-delete-markers "object-lock-managing.md#object-lock-managing-delete-markers").
...
Consider using *Compliance mode* if you never want any user, including the root user in your
...
For a complete list of Amazon S3 permissions with descriptions, see [Actions, resources, and condition keys for Amazon S3](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html "https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazons3.html") in the *Service Authorization 
 Reference*.
...
For information about using conditions with permissions, see [Bucket policy examples using condition keys](amazon-s3-policy-keys.md "amazon-s3-policy-keys.md").
