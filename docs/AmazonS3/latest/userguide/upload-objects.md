...
If you upload an object with a key name that already exists in a versioning-enabled bucket,
 ...
 information about enabling versioning, see [Enabling versioning on buckets](manage-versioning-examples.md "manage-versioning-examples.md").
...
When you're uploading an object, if you want to use a different type of default encryption,
 ...
 key. For more information about cross-account permissions for KMS keys, see [Creating KMS keys that other accounts can use](https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html#cross-account-console "https://docs.aws.amazon.com/kms/latest/developerguide/key-policy-modifying-external-accounts.html#cross-account-console") in the
...
For example, if you upload an object named `sample1.jpg` to a folder named
 ...
 For more information about key names, see [Working with object metadata](UsingMetadata.md "UsingMetadata.md").
...
For more information about storage classes, see [Understanding and managing Amazon S3 storage classes](storage-class-intro.md "storage-class-intro.md").
...
Additional checksums enable you to specify the checksum algorithm that you would
 like to use to verify your data. For more information about additional checksums, see [Checking object integrity in Amazon S3](checking-object-integrity.md "checking-object-integrity.md").
...
Object tagging gives you a way to categorize storage. Each tag is a key-value pair. Key
 ...
 in length. For more information about object tags, see [Categorizing your objects using tags](object-tagging.md "object-tagging.md").
8. To add metadata, choose **Add metadata**.
	 ...
	 **Content-Type** and **Content-Disposition**. For a
	 ...
	 [System-defined object metadata](UsingMetadata.md#SysMetadata "UsingMetadata.md#SysMetadata"). Any metadata starting with
	 ...
	 metadata, see [Working with object metadata](UsingMetadata.md "UsingMetadata.md").
...
You can send a `PUT` request to upload an object of up to 5 GB in a single
 operation. For more information, see the [`PutObject`](https://docs.aws.amazon.com/cli/latest/reference/s3api/put-object.html#examples "https://docs.aws.amazon.com/cli/latest/reference/s3api/put-object.html#examples") example
...
For information about setting up and running the code examples, see [Getting
 Started with the AWS SDK for .NET](https://docs.aws.amazon.com/sdk-for-net/latest/developer-guide/net-dg-setup.html "https://docs.aws.amazon.com/sdk-for-net/latest/developer-guide/net-dg-setup.html") in the *AWS SDK for .NET
 Developer Guide*. 
