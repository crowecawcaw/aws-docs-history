...
delivery of popular Amazon S3 content. For information about CloudFront, see the [Amazon CloudFront Developer Guide](../../../AmazonCloudFront/latest/DeveloperGuide.md "../../../AmazonCloudFront/latest/DeveloperGuide.md").
...
503 _slowdown_ responses. If these errors occur, each AWS
...
information about back-off techniques, see [Retry behavior](../../../sdkref/latest/guide/feature-retry-behavior.md "../../../sdkref/latest/guide/feature-retry-behavior.md") in the
...
connections to GET or PUT data in parallel. For example, this is supported by [Amazon S3 Transfer Manager](../../../sdk-for-java/latest/developer-guide/transfer-manager.md "../../../sdk-for-java/latest/developer-guide/transfer-manager.md") in the AWS Java SDK, and most of the other AWS SDKs
...
through CloudFront and to provide rapid responses to DNS queries made to [Amazon Route 53](../../../route53/index.md "../../../route53/index.md").
