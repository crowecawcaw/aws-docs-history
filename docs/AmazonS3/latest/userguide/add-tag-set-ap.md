...
You can use the REST API to add a tag-set to an object through an access point. For more information, see [PutObjectTagging](../API/API_PutObjectTagging.md "../API/API_PutObjectTagging.md") in the *Amazon Simple Storage Service API Reference*.
