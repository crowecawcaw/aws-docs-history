...
| `RecordValue` |  String  | `record_value` | The value of the `RecordType` artifact.
 NoteThe `record_value` is URL-encoded. |
...
![An example S3 Storage Lens metrics export file.](../../../images/AmazonS3/latest/userguide/images/sample_storage_lens_export.png)

The following is an example of an S3 Storage Lens metrics export with Storage Lens groups data.



![An example S3 Storage Lens metrics export file with Storage Lens groups data.](../../../images/AmazonS3/latest/userguide/images/StorageLensGroups_metricsexport.png)
