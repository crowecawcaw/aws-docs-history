...
![Copying a specific version of an object into the same bucket to make it the current version.](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/versioning_COPY2.png)
...
![Deleting the current version of an object leaves the previous version as the current object.](https://docs.aws.amazon.com/AmazonS3/latest/userguide/images/versioning_COPY_delete2.png)
