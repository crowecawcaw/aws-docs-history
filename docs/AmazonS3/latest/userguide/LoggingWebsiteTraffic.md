...
You can optionally enable Amazon S3 server access logging for a bucket that is configured
 ...
 Access Logs](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html") in the *Amazon CloudFront Developer Guide*.
...
6. Choose **Properties**.
7. Under **Server access logging**, choose
 **Edit**.
8. Choose **Enable**.
9. Under the **Target bucket**, choose the bucket and folder
