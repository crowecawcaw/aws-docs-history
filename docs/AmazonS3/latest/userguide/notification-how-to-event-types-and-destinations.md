...
| `s3:ObjectAnnotation:*`<br>`s3:ObjectAnnotation:Put`<br>`s3:ObjectAnnotation:Delete`                                                                                                                         | By using the `ObjectAnnotation` event types,<br>you can enable notification when an annotation is created,<br>updated, or deleted on an object.<br>The `s3:ObjectAnnotation:Put` event type notifies<br>you when an annotation is created or updated through<br>`PutObjectAnnotation`. The<br>`s3:ObjectAnnotation:Delete` event type notifies you<br>when an annotation is deleted through<br>`DeleteObjectAnnotation`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
- `PutObjectAnnotation` and `DeleteObjectAnnotation` send only
  annotation-specific events. They do not send object-level events such as
  `s3:ObjectCreated:*`.
- `GetObjectAnnotation` and `ListObjectAnnotations` do not send
  event notifications.
- `CopyObject` sends the standard `s3:ObjectCreated:Copy` event.
  If the copied object has annotations, the event includes a `hasObjectAnnotation`
  field set to `true`.
- `DeleteObject` does not include annotation-related fields in the event
  payload.
