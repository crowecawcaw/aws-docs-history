...
After you create the bucket, you can't change its name. The AWS account that creates
 the bucket owns it. For information about naming table buckets, see [Amazon S3 table bucket, table, and namespace naming rules](s3-tables-buckets-naming.md "s3-tables-buckets-naming.md").
...
For more information about encryption options for table data,
 see [Protecting S3 table data with encryption](s3-tables-encryption.md "s3-tables-encryption.md").
