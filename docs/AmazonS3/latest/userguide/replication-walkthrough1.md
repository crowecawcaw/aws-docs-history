...
versioning on the bucket. 10. Set up an AWS Identity and Access Management (IAM) role that Amazon S3 can assume to replicate objects on your
behalf.
...
role to an AWS service](../../../IAM/latest/UserGuide/id_roles_use_passrole.md "../../../IAM/latest/UserGuide/id_roles_use_passrole.md") in the _IAM User Guide_. 11. To replicate objects in the source bucket that are encrypted with server-side encryption
...
Requests per Second: Varies](../../../kms/latest/developerguide/limits.md#requests-per-second "../../../kms/latest/developerguide/limits.md#requests-per-second") in the _AWS Key Management Service Developer Guide_.
...
If you chose to replicate objects encrypted with AWS KMS, do the following:
    ...
    When you use an AWS KMS key for server-side encryption in Amazon S3, you must choose
     ...
     asymmetric KMS keys](../../../kms/latest/developerguide/find-symm-asymm.md "../../../kms/latest/developerguide/find-symm-asymm.md") in the *AWS Key Management Service Developer
     Guide*.
...
When you use S3 RTC or S3 Replication metrics, additional fees apply. 14. To finish, choose **Save**. 15. After you save your rule, you can edit, enable, disable, or delete your rule by
...
1. Set a credentials profile for the AWS CLI. This example uses the profile
   ...
   and using named profiles, see [Configuration and credential file settings](../../../cli/latest/userguide/cli-configure-files.md "../../../cli/latest/userguide/cli-configure-files.md") in the _AWS Command Line Interface User Guide_.
...
credentials to create a named profile, you can perform all the tasks. 2. Create a source bucket and enable versioning on it by using the following
...
For examples of how to configure replication with the AWS SDK for Java, see [Set replication configuration on a bucket](../API/s3_example_s3_PutBucketReplication_section.md "../API/s3_example_s3_PutBucketReplication_section.md") in the _Amazon S3 API Reference_.
...
[Getting Started with the AWS SDK for .NET](../../../sdk-for-net/v3/developer-guide/net-dg-config.md "../../../sdk-for-net/v3/developer-guide/net-dg-config.md") in the
