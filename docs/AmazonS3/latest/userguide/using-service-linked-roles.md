...
using the AWS CLI or AWS SDK. For more information, see [Deleting a service-linked role](../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role "../../../IAM/latest/UserGuide/using-service-linked-roles.md#delete-service-linked-role") in the _IAM User Guide_.
...
service is available. For more information, see [Amazon S3 Regions and Endpoints](../../../general/latest/gr/s3.md "../../../general/latest/gr/s3.md").
