...
single operation. For more information, see the [`PutObject`](../../../cli/latest/reference/s3api/put-object.md#examples "../../../cli/latest/reference/s3api/put-object.md#examples") in the _AWS CLI Command Reference_. You can also use [`get-object`](../../../cli/latest/reference/s3api/get-object.md "../../../cli/latest/reference/s3api/get-object.md") and
[`head-object`](../../../cli/latest/reference/s3api/head-object.md "../../../cli/latest/reference/s3api/head-object.md") to retrieve the checksum of an
...
information about chunk formatting, see [Chunked transfer encoding](https://www.rfc-editor.org/rfc/rfc9112#name-chunked-transfer-coding "https://www.rfc-editor.org/rfc/rfc9112#name-chunked-transfer-coding") on the _RFC
Editor_ website.
