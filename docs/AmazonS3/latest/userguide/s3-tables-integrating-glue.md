...
information about AWS Glue, see [What is AWS Glue?](../../../glue/latest/dg/what-is-glue.md "../../../glue/latest/dg/what-is-glue.md") in the _AWS Glue
Developer Guide_.
...
S3 Tables is supported on [AWS Glue version 5.0 or higher](../../../glue/latest/dg/release-notes.md "../../../glue/latest/dg/release-notes.md").
...
create a new script. For more information on creating AWS Glue scripts, see [Tutorial: Writing an AWS Glue for Spark script](../../../glue/latest/dg/aws-glue-programming-intro-tutorial.md "../../../glue/latest/dg/aws-glue-programming-intro-tutorial.md") in the _AWS Glue
Developer Guide_.
...
in AWS Glue, see [Special parameters used in AWS Glue jobs](../../../glue/latest/dg/aws-glue-programming-etl-glue-arguments.md "../../../glue/latest/dg/aws-glue-programming-etl-glue-arguments.md") in the
...
For more information, see [Authoring jobs in AWS Glue](../../../glue/latest/dg/author-job-glue.md "../../../glue/latest/dg/author-job-glue.md") in the
