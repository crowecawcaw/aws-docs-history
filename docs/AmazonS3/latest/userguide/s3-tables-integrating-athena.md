...
standard SQL. For more information, see [What is Amazon Athena?](../../../athena/latest/ug/what-is.md "../../../athena/latest/ug/what-is.md") in the _Amazon Athena User Guide_.
...
bucket catalogs](../../../athena/latest/ug/gdc-register-s3-table-bucket-cat.md "../../../athena/latest/ug/gdc-register-s3-table-bucket-cat.md") in the _Amazon Athena User Guide_.
