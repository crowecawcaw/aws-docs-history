...
[solution overview](../../../solutions/latest/dynamic-image-transformation-for-amazon-cloudfront/solution-overview.md "../../../solutions/latest/dynamic-image-transformation-for-amazon-cloudfront/solution-overview.md") has more details on capabilities and how to get started using
...
Lambda function using an HTTP request](../../../lambda/latest/dg/apig-http-invoke-decision.md "../../../lambda/latest/dg/apig-http-invoke-decision.md") in the _AWS Lambda Developer Guide_. After you have decided which method for invoking
