...
[Encrypting objects
with Amazon S3 Batch Operations](https://aws.amazon.com/blogs/storage/encrypting-objects-with-amazon-s3-batch-operations/ "https://aws.amazon.com/blogs/storage/encrypting-objects-with-amazon-s3-batch-operations/").
...
see [Copying, moving, and renaming objects](copy-object.md "copy-object.md") in this guide and [CopyObject](../API/API_CopyObject.md "../API/API_CopyObject.md") in the _Amazon Simple Storage Service API Reference_.
