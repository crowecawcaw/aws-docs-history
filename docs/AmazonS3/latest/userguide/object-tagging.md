...
If you need to store structured data larger than 256 characters per value, associate more than 10 metadata entries with an object, or attach rich content such as machine learning inference results or AI-generated labels, see [Annotating your objects](annotations-overview.md).
