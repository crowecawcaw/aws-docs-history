...
9. Under **Filter scope**, choose **Limit the scope of this filter
 using a prefix, object tags, and an S3 Access Point, or a combination of all
 three**.
10. Under **Filter type**, choose at least one filter type:
 **Prefix**, **Object tags**, or **Access
 Point**.
11. To define a prefix filter and limit the scope of the filter to a single path, in the
 **Prefix** box, enter a prefix.
12. To define an object tags filter, under **Object tags**, choose
...
1. Install and set up the AWS CLI. For instructions, see [Installing, updating, and uninstalling
 the AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-install.html "https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-install.html") in the *AWS Command Line Interface User Guide*.
2. Open a terminal.
