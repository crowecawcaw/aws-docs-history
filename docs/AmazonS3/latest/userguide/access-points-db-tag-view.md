...
You can view or list tags applied to Amazon S3 Access Points for directory buckets. For additional information, see [Using tags with S3 directory buckets](directory-buckets-tagging.md "directory-buckets-tagging.md").
...
* Verify that you have the required [Permissions](#access-points-db-tag-view-permissions "#access-points-db-tag-view-permissions") to view or list the tags of the access point for directory buckets.
