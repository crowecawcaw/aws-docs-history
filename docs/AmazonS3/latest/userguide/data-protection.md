...
Amazon S3 Multi-Region Access Points provide a global endpoint that applications can use to fulfill
 ...
 Amazon S3. Application requests made to a Multi-Region Access Point global endpoint use [AWS Global Accelerator](https://docs.aws.amazon.com/global-accelerator/latest/dg/ "https://docs.aws.amazon.com/global-accelerator/latest/dg/") to automatically route over the AWS
...
You can use S3 Object Lock to store objects using a *write once, read
 many* (WORM) model. Using S3 Object Lock, you can prevent an
