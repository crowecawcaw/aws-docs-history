...
Amazon CloudWatch](../../../kms/latest/developerguide/monitoring-cloudwatch.md "../../../kms/latest/developerguide/monitoring-cloudwatch.md") to monitor the total AWS KMS request rate on your
AWS account.
