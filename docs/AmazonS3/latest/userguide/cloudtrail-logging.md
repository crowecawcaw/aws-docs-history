...
[AWS CloudTrail](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html "https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-user-guide.html") is
...
CloudTrail is active in your AWS account when you create the account and you automatically
 ...
 information, see [Working with CloudTrail Event history](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/view-cloudtrail-events.html "https://docs.aws.amazon.com/awscloudtrail/latest/userguide/view-cloudtrail-events.html") in the
 *AWS CloudTrail User Guide*. There are no CloudTrail charges for viewing the
 **Event history**.

For an ongoing record of events in your AWS account past 90 days, create a trail or
 a [CloudTrail Lake](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake.html "https://docs.aws.amazon.com/awscloudtrail/latest/userguide/cloudtrail-lake.html") event data store.
...
AWS CloudTrail logs provide a record of actions taken by a user, role, or an AWS
 ...
 logs work, and their properties, performance, and costs, see [Logging options for Amazon S3](logging-with-S3.md "logging-with-S3.md"). 
...
You can use AWS CloudTrail logs together with server access logs for Amazon S3. CloudTrail logs
 ...
 access logs, see [Logging requests with server access logging](ServerLogs.md "ServerLogs.md").
...
You can also use CloudTrail logs together with Amazon CloudWatch for Amazon S3. CloudTrail integration with
 ...
 see the [AWS CloudTrail User Guide](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/ "https://docs.aws.amazon.com/awscloudtrail/latest/userguide/"). For more information
 about using CloudWatch with Amazon S3, see [Monitoring metrics with Amazon CloudWatch](cloudwatch-monitoring.md "cloudwatch-monitoring.md").
...
CloudTrail tracks Amazon S3 SOAP API calls. Amazon S3 SOAP support over HTTP is deprecated, but it
 ...
 [Appendix:
 SOAP API](../API/APISoap.md "../API/APISoap.md") in the *Amazon S3 API Reference*. 
