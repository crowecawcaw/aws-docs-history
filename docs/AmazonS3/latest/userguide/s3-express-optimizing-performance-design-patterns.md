...
For more information about examples of directory bucket operations and directory interactions, see [Directory bucket operation and directory interaction examples](#s3-express-directory-bucket-examples "#s3-express-directory-bucket-examples").
...
Gateway endpoints provide a direct connection from your VPC to directory buckets, without requiring an internet gateway or a NAT device for your VPC. To reduce the amount of time your packets spend on the network, you should configure your VPC with a gateway VPC endpoint for directory buckets. 
 For more information, see [Networking for directory buckets](s3-express-networking.md "s3-express-networking.md").
...
![Diagram showing directory structure after PUT operation for documents/reports/quarterly.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-foo-bar-baz.png)
...
![Diagram showing directory structure after PUT operation for documents/logs/application.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-foo-baz-quux.png)
...
![Diagram showing directory structure after PUT operation for documents/readme.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-foo-bar.png)
...
![Diagram showing initial directory structure before DELETE operations](../../../images/AmazonS3/latest/userguide/images/directory-examples-delete-before.png)
...
![Diagram showing directory structure after DELETE operation for documents/reports/quarterly.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-delete1.png)
...
![Diagram showing directory structure after DELETE operation for documents/readme.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-delete2.png)
...
![Diagram showing directory structure after DELETE operation for documents/logs/application.txt](../../../images/AmazonS3/latest/userguide/images/directory-examples-delete3.png)
