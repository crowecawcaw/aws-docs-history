...
4. To view more detailed bucket-level metrics, choose the
   **Bucket** tab.
5. In the **Distribution by buckets for _date_** section, choose the **%
...
ACLs. 6. To view the bucket owner enforced settings in context, scroll down to the
