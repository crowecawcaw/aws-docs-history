...
- Make sure that you understand how to [optimize your queries](metadata-tables-optimizing-query-performance.md "metadata-tables-optimizing-query-performance.md").
- Replace `b_`general-purpose-bucket-name`` with the name of
  your namespace.
- For a full list of supported columns, see the [S3 Metadata journal tables schema](metadata-tables-schema.md "metadata-tables-schema.md") and [S3 Metadata live inventory tables schema](metadata-tables-inventory-schema.md "metadata-tables-inventory-schema.md").
...
catalog and the `b_`general-purpose-bucket-name`` database for
...
report](storage-inventory.md#storage-inventory-contents "storage-inventory.md#storage-inventory-contents").

This query works for general purpose buckets with [S3 Versioning](Versioning.md "Versioning.md")
...
- You must have an existing customer-managed table bucket with an existing namespace as a
  place to output the new table. For more information, see [Creating a table bucket](s3-tables-buckets-create.md "s3-tables-buckets-create.md") and [Creating a namespace](s3-tables-namespace-create.md "s3-tables-namespace-create.md").
...
output table. Make sure that the name of your output table follows the [table naming rules](s3-tables-buckets-naming.md#naming-rules-table "s3-tables-buckets-naming.md#naming-rules-table").
