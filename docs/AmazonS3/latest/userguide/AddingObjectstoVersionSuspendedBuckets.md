...
![Amazon S3 adding the version ID of null to an object graphic.](images/versioning_PUT_versionSuspended.png)
...
![Amazon S3 adding the version ID of null to an object without overwriting version 111111 graphic.](images/versioning_PUT_versionSuspended3.png)
If a null version already exists in a bucket, the null version is overwritten, as
shown in the following figure.

![Amazon S3 adding the version ID of null to an object while overwriting the original contents graphic.](images/versioning_PUT_versionSuspended4.png)
