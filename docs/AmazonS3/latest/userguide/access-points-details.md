...
You can use the REST API to view details for your access point. For more information, see [GetAccessPoint](../API/API_control_GetAccessPoint.md "../API/API_control_GetAccessPoint.md") in the *Amazon Simple Storage Service API Reference*.
