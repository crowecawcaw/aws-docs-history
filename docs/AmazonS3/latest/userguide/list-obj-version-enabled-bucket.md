...
Use the following process to retrieve additional objects that satisfy the original
 ...
 [GET
 Bucket](../API/RESTBucketGET.md "../API/RESTBucketGET.md") in the *Amazon Simple Storage Service API Reference*.
...
```
For more information about `list-object-versions` see [list-object-versions](https://docs.aws.amazon.com/cli/latest/reference/s3api/list-object-versions.html "https://docs.aws.amazon.com/cli/latest/reference/s3api/list-object-versions.html") in the
