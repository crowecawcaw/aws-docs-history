...
Before you delete a vector index, verify the vector index. For more information about how to check the index details, see [GetIndex](../API/API_GetIndex.md "../API/API_GetIndex.md") in the *Amazon S3 API Reference*. For more information about how to list vectors inside the index to see what will be deleted, see [Listing vector indexes](s3-vectors-index-list.md "s3-vectors-index-list.md").
