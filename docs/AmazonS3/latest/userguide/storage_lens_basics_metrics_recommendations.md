...
* [Dashboard configuration](#storage_lens_basics_configuration "#storage_lens_basics_configuration")
* [Default dashboard](#storage_lens_basics_default_dashboard "#storage_lens_basics_default_dashboard")
...
Suggestions alert you to trends within your storage and activity that might
 ...
 You can use the suggested topics in the *Amazon S3 User Guide* and the S3 Storage Lens dashboard to drill down for more details
...
Call-outs are recommendations that alert you to interesting anomalies within your
 ...
 monitoring.
	...
	S3 Storage Lens provides call-outs for metrics that are outliers, based on your
	 ...
	 known as a *z-score*. In this score, the current
...
S3 Storage Lens offers two metrics selections that you can choose for your dashboard and
 export: *free metrics* and *advanced metrics and recommendations*.
...
Advanced metrics and recommendations include the following features:
	...
	+ **Amazon CloudWatch publishing** – Publishes
	 ...
	 CloudWatch [dashboards](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Dashboards.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Dashboards.html"). You can also use CloudWatch API operations and features, such as
...
Using your organization's management account, you must enable *trusted access* for S3 Storage Lens to aggregate storage metrics
...
You can create dashboards and metrics for S3 Storage Lens for your organization by using
 your AWS Organizations management account, or by giving *delegated
 administrator* access to other accounts in your organization. You can
...
For more information, see [Amazon S3 Storage Lens and AWS Organizations](https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-s3lens.html "https://docs.aws.amazon.com/organizations/latest/userguide/services-that-can-integrate-s3lens.html") in the *AWS Organizations User Guide*.
