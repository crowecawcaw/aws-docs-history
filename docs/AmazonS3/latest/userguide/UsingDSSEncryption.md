...
There are additional charges for using DSSE-KMS compared to standard SSE-KMS due to the increased computational overhead of applying two layers of encryption and additional AWS KMS API calls required for the dual encryption process. For more information
 about DSSE-KMS pricing, see [AWS KMS key concepts](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#kms_keys")
 in the *AWS Key Management Service Developer Guide* and [AWS KMS pricing](https://aws.amazon.com/kms/pricing "https://aws.amazon.com/kms/pricing").
