...
- _Second layer:_ The already-encrypted data is encrypted again using a separate AES-256 encryption key managed by Amazon S3
  ...
  For more information about DSSE-KMS pricing, see [AWS KMS key concepts](../../../kms/latest/developerguide/concepts.md#kms_keys "../../../kms/latest/developerguide/concepts.md#kms_keys")
