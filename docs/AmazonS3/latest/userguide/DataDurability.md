...
Apart from S3 Versioning, you can also use Amazon S3 Object Lock and S3 Replication to protect your data. For more information, see [Data protection in Amazon S3](data-protection.md).
