...
- **s3-website dot (.) Region** ‐ `http://`bucket-name`.s3-website.`Region`.amazonaws.com`
  ...
  Endpoints](../../../general/latest/gr/s3.md#s3_website_region_endpoints "../../../general/latest/gr/s3.md#s3_website_region_endpoints").
...
- Amazon S3 website endpoints do not support HTTPS or access points. If you want
  ...
  general purpose bucket](website-hosting-amplify.md "website-hosting-amplify.md") and [Deploying a static website from S3 using the Amplify
  console](../../../amplify/latest/userguide/deploy--from-amplify-console.md "../../../amplify/latest/userguide/deploy--from-amplify-console.md") in the _AWS Amplify Console User
  Guide_.
