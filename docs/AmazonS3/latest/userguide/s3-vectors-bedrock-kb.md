...
- **Choose a vector store you have created** - Choose an
  ...
  vector index in the Amazon Bedrock Knowledge Bases console, see the S3 Vectors tab in [Prerequisites for using a vector store you created for a knowledge base](../../../bedrock/latest/userguide/knowledge-base-setup.md "../../../bedrock/latest/userguide/knowledge-base-setup.md") in
...
documents into the vector store using the [IngestKnowledgeBaseDocuments](../../../bedrock/latest/APIReference/API_agent_IngestKnowledgeBaseDocuments.md "../../../bedrock/latest/APIReference/API_agent_IngestKnowledgeBaseDocuments.md") operation. Best practice is to create a separate
...
- **Retrieve chunks** from your source data using the
  [Retrieve](../../../bedrock/latest/APIReference/API_agent-runtime_Retrieve.md "../../../bedrock/latest/APIReference/API_agent-runtime_Retrieve.md") API
  operation.
- **Generate responses** based on retrieved chunks using
  the [RetrieveAndGenerate](../../../bedrock/latest/APIReference/API_agent-runtime_RetrieveAndGenerate.md "../../../bedrock/latest/APIReference/API_agent-runtime_RetrieveAndGenerate.md") API operation.
...
generate AI responses with Amazon Bedrock Knowledge Bases](../../../bedrock/latest/userguide/knowledge-base.md "../../../bedrock/latest/userguide/knowledge-base.md") in the _Amazon Bedrock User
Guide_.
