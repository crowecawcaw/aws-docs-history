...
- Each metrics configuration enables the full set of [available request metrics](metrics-dimensions.md#s3-request-cloudwatch-metrics "metrics-dimensions.md#s3-request-cloudwatch-metrics").
...
- Request metrics are reported for object-level operations. They are also
  reported for operations that list bucket contents, like [GET Bucket (List Objects)](../API/v2-RESTBucketGET.md "../API/v2-RESTBucketGET.md"),
  [GET Bucket Object
  Versions](../API/RESTBucketGETVersion.md "../API/RESTBucketGETVersion.md"), and [List Multipart Uploads](../API/mpUploadListMPUpload.md "../API/mpUploadListMPUpload.md"), but they are not reported for other
