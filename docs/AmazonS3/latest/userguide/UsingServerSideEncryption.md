...
For more general information, see [AWS KMS
 concepts](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html "http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html") in the *AWS Key Management Service Developer Guide*.
