...
![Diagram depicting a versioning-enabled bucket that has two objects with the same key but different version IDs.](images/versioning_Enabled.png)
...
![Diagram depicting how S3 Versioning works when you PUT an object in a versioning-enabled bucket.](images/versioning_PUT_versionEnabled3.png)
