...
![A versioning-enabled bucket that has two objects with the same key but different version IDs.](images/versioning_Enabled.png)
...
![How S3 Versioning works when you PUT an object in a versioning-enabled bucket.](images/versioning_PUT_versionEnabled3.png)
...
![How S3 Versioning works when you GET a noncurrent version in a versioning-enabled bucket.](images/versioning_GET_Versioned3.png)
