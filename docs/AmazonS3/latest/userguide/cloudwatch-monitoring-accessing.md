...
For more information about the permissions required to access CloudWatch dashboards, see
 ...
 permissions](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/dashboard-permissions-update.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/dashboard-permissions-update.html") in the *Amazon CloudWatch User Guide*.
