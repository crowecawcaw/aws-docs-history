...
If you need more control over your keys, such as managing key rotation and access policy
 ...
 KMS keys, see [Editing keys](https://docs.aws.amazon.com/kms/latest/developerguide/editing-keys.html "https://docs.aws.amazon.com/kms/latest/developerguide/editing-keys.html") in *AWS Key Management Service Developer Guide*. 
...
When you configure your bucket to use default encryption with SSE-KMS, you can also enable
 ...
 more information, see [Reducing the cost of SSE-KMS with Amazon S3 Bucket Keys](bucket-key.md "bucket-key.md").
...
To identify buckets that have SSE-KMS enabled for default encryption, you can use
 ...
 visibility into object-storage usage and activity. For more information, see  [Using S3 Storage Lens to protect your data](storage-lens-data-protection.md "storage-lens-data-protection.md").
...
When you use server-side encryption, Amazon S3 encrypts an object before saving it to disk and
 ...
 server-side encryption and encryption-key management, see [Protecting data with server-side encryption](serv-side-encryption.md "serv-side-encryption.md").
...
To encrypt your existing unencrypted Amazon S3 objects, you can use Amazon S3 Batch Operations. You
 ...
 respective API to perform the specified operation. You can use the [Batch Operations Copy operation](batch-ops-copy-object.md "batch-ops-copy-object.md")
 ...
 For more information, see [Performing object operations in bulk with Batch Operations](batch-ops.md "batch-ops.md") and the
 *AWS Storage Blog* post [Encrypting objects with
...
You can also encrypt existing objects by using the `CopyObject` API operation or
 the `copy-object` AWS CLI command. For more information, see the *AWS Storage Blog* post [Encrypting existing Amazon S3
 objects with the AWS CLI](https://aws.amazon.com/blogs/storage/encrypting-existing-amazon-s3-objects-with-the-aws-cli/ "https://aws.amazon.com/blogs/storage/encrypting-existing-amazon-s3-objects-with-the-aws-cli/").
...
When you configure your bucket to use S3 Bucket Keys for SSE-KMS on new objects, AWS KMS generates
 a bucket-level key that is used to create a unique [data key](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#data-keys "https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#data-keys") for objects in the
...
For more information about using S3 Bucket Keys, see [Using Amazon S3 Bucket Keys](bucket-key.md "bucket-key.md").
