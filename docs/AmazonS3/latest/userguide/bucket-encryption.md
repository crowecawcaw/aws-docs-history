...
KMS keys, see [Editing keys](../../../kms/latest/developerguide/editing-keys.md "../../../kms/latest/developerguide/editing-keys.md") in _AWS Key Management Service Developer Guide_.
...
a bucket-level key that is used to create a unique [data key](../../../kms/latest/developerguide/concepts.md#data-keys "../../../kms/latest/developerguide/concepts.md#data-keys") for objects in the
