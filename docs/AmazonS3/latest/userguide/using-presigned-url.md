...
see [Comparing AWS STS API operations](../../../IAM/latest/UserGuide/id_credentials_temp_request.md#stsapi_comparison "../../../IAM/latest/UserGuide/id_credentials_temp_request.md#stsapi_comparison") in the _IAM User Guide_.
...
Version 4 Authentication](../API/bucket-policy-s3-sigv4-conditions.md "../API/bucket-policy-s3-sigv4-conditions.md") in the _Amazon Simple Storage Service API Reference_.
