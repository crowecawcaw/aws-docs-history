 ...
 *Nth* column of a row with the column name
 `_`N``, where
 ``N`` is the column
...
For the full list of reserved keywords, see [Reserved keywords](s3-select-sql-reference-keyword-list.md "s3-select-sql-reference-keyword-list.md").
