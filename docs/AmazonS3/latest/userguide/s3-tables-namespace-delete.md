...
For information about the permissions required to delete a namespace, see [DeleteNamespace](../API/API_s3TableBuckets_DeleteNamespace.md "../API/API_s3TableBuckets_DeleteNamespace.md") in the *Amazon Simple Storage Service API Reference*.
