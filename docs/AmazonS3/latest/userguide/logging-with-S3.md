...
| Deliver logs to more than one destination (for example, send the same<br>logs to two different buckets) | Yes                                                                                                     | No                                                       |
| Turn on logs for a subset of objects (prefix)                                                           | Yes                                                                                                     | No                                                       |
| Cross-account log delivery (target and source bucket owned by<br>different accounts)                    | Yes                                                                                                     | No                                                       |
...
| Price                                                                                                   | Management events (first delivery) are free; data events incur a fee,<br>in addition to storage of logs | No other cost in addition to storage of logs             |
