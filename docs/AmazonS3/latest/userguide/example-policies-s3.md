...
access to Amazon S3. For example _bucket policies_ (resource-based policies), see [Bucket policies for Amazon S3](bucket-policies.md "bucket-policies.md"). For information about IAM
...
see [IAM Identifiers](../../../IAM/latest/UserGuide/reference_identifiers.md "../../../IAM/latest/UserGuide/reference_identifiers.md") in the
_IAM User Guide_.
...
Federation](../../../IAM/latest/UserGuide/id_roles_providers_oidc.md "../../../IAM/latest/UserGuide/id_roles_providers_oidc.md") in the _IAM User Guide_.
...
IAM policy](../../../IAM/latest/UserGuide/access_policies_identity-vs-resource.md "../../../IAM/latest/UserGuide/access_policies_identity-vs-resource.md") uses a `Deny` effect to block access to Amazon S3 actions,
...
organization. For this example, the [OU ID](../../../organizations/latest/APIReference/API_OrganizationalUnit.md "../../../organizations/latest/APIReference/API_OrganizationalUnit.md") is
...
The [IAM policy
condition](../../../IAM/latest/UserGuide/reference_policies_elements_condition.md "../../../IAM/latest/UserGuide/reference_policies_elements_condition.md") requires `aws:ResourceOrgPaths`, a multivalued condition
...
policy (SCP)](../../../organizations/latest/userguide/orgs_manage_policies_scps.md "../../../organizations/latest/userguide/orgs_manage_policies_scps.md"). If you choose to use an SCP, make sure to thoroughly [test the SCP](../../../organizations/latest/userguide/orgs_manage_policies_scps.md#scp-warning-testing-effect "../../../organizations/latest/userguide/orgs_manage_policies_scps.md#scp-warning-testing-effect") before attaching the policy to the root of the organization.
...
The [IAM policy
condition](../../../IAM/latest/UserGuide/reference_policies_elements_condition.md "../../../IAM/latest/UserGuide/reference_policies_elements_condition.md") in this example requires `aws:ResourceOrgID` and
...
For a list of
Amazon S3
Regions, see [Regions and Endpoints](../../../general/latest/gr/s3.md "../../../general/latest/gr/s3.md") in the _AWS General Reference_.
...
setting up and using the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the _Amazon S3 API Reference_.
