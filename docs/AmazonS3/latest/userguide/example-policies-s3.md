...
This section shows several example AWS Identity and Access Management (IAM) identity-based policies for controlling 
 access to Amazon S3. For example *bucket policies* (resource-based policies), see [Bucket policies for Amazon S3](bucket-policies.md "bucket-policies.md"). For information about IAM
...
The following example policies will work if you use them programmatically. However, to use
 ...
 console. For information about using policies such as these with the Amazon S3 console, see [Controlling access to a bucket with user policies](walkthrough1.md "walkthrough1.md"). 
...
When using policy variables, you must explicitly specify version
 ...
 console uses these permissions, see [Controlling access to a bucket with user policies](walkthrough1.md "walkthrough1.md"). 
...
Instead of using
 ...
 see [IAM Identifiers](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_identifiers.html") in the
 *IAM User Guide*.
...
You can then use web identity federation in AWS Security Token Service to integrate information from
 ...
 Federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc.html") in the *IAM User Guide*.
...
If you want to ensure that your Amazon S3 principals are accessing only the resources that
 ...
 IAM policy](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_identity-vs-resource.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_identity-vs-resource.html") uses a `Deny` effect to block access to Amazon S3 actions,
...
If you have an [organizational unit
 (OU)](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_ous.html "https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_ous.html") set up in AWS Organizations, you might want to restrict Amazon S3
 ...
 organization. For this example, the [OU ID](https://docs.aws.amazon.com/organizations/latest/APIReference/API_OrganizationalUnit.html "https://docs.aws.amazon.com/organizations/latest/APIReference/API_OrganizationalUnit.html") is
...
The policy denies access to Amazon S3 actions unless the Amazon S3 object that's being accessed is
 ...
 The [IAM policy
 condition](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html") requires `aws:ResourceOrgPaths`, a multivalued condition
...
The [IAM policy
 condition](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_policies_elements_condition.html") in this example requires `aws:ResourceOrgID` and
...
For a list of
 Amazon S3
 Regions, see [Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/s3.html "https://docs.aws.amazon.com/general/latest/gr/s3.html") in the *AWS General Reference*. 
...
You can test the policy using the following `create-bucket` AWS CLI command.
 ...
 setting up and using the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the *Amazon S3 API Reference*.
