...
- [Enabling Amazon SNS, Amazon SQS, or Lambda notifications using the Amazon S3 console](#enable-event-notifications-sns-sqs-lam "#enable-event-notifications-sns-sqs-lam")
...
6. In the **General configuration** section, specify descriptive event
   ...
   for the name. 2. (Optional) To filter event notifications by prefix, enter a
   **Prefix**.
