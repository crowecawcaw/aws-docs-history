...
![Illustration that shows a bucket operation requested by bucket owner.](images/example10-policy-eval-logic.png)
...
![Illustration that shows a bucket operation requested by an AWS account that is not the bucket owner.](images/example20-policy-eval-logic.png)
...
![Illustration that shows a bucket operation requested by an IAM principal and bucket owner.](images/example30-policy-eval-logic.png)
...
![Illustration that shows a bucket operation requested by an IAM principal that is not the bucket owner.](images/example40-policy-eval-logic.png)
