...
In the example, the rule doesn't specify a value for the `Prefix` element (the
 [object key
 name prefix](https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix "https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#keyprefix")). Therefore, the rule applies to all objects in the bucket for which
...
1. Set up the AWS CLI. For instructions, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the *Amazon S3 API Reference*.
