...
more information about aborting a multipart upload, see [Aborting a multipart upload](abort-mpu.md "abort-mpu.md").
...
[object key
name prefix](../../../general/latest/gr/glos-chap.md#keyprefix "../../../general/latest/gr/glos-chap.md#keyprefix")). Therefore, the rule applies to all objects in the bucket for which
...
For more information about the bucket lifecycle configuration, see [Managing the lifecycle of objects](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md").
...
The name must be unique within the bucket. 5. Choose the scope of the lifecycle rule:
...
1. Set up the AWS CLI. For instructions, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the _Amazon S3 API Reference_.
