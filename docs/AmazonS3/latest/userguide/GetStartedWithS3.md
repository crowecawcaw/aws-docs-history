...
When you sign up for AWS and set up Amazon S3, you can optionally change the display language
 ...
 of the AWS Management Console](https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/getting-started.html#change-language "https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/getting-started.html#change-language") in the *AWS Management Console Getting Started Guide*.
...
* [AWS Identity and Access Management (IAM)
 ...
 (users, user groups, and roles)](https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html") in the *IAM User Guide*.
...
The Amazon S3 REST API is an HTTP interface to Amazon S3. With the REST API,
 ...
 as they are anonymously readable. For more information, see [Developing with Amazon S3](../API/developing-s3.md "../API/developing-s3.md") in the *Amazon S3 API Reference*.
...
For more information, see [Developing with Amazon S3 using the AWS SDKs](../API/sdk-general-information-section.md "../API/sdk-general-information-section.md")  in the *Amazon S3 API Reference*.
...
The [AWS
 ...
 Code Sample Catalog](https://docs.aws.amazon.com/code-samples/latest/catalog/welcome.html "https://docs.aws.amazon.com/code-samples/latest/catalog/welcome.html") have sample code and
 libraries written especially for Amazon S3. You can use these
 code samples to understand how to implement the Amazon S3
 API. You can also view the [*Amazon Simple Storage Service API Reference*](../API/Welcome.md "../API/Welcome.md")
