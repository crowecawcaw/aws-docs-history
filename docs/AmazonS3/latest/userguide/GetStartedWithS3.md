...
pricing, see [Amazon S3](https://aws.amazon.com/s3 "https://aws.amazon.com/s3"). If you are a new Amazon S3 customer, you
can get started with Amazon S3 for free. For more information, see [AWS Free Tier](https://aws.amazon.com/free "https://aws.amazon.com/free").
...
Before you begin, confirm that you've completed the steps in [Setting up Amazon S3](#setting-up-s3 "#setting-up-s3").
...
of the AWS Management Console](../../../awsconsolehelpdocs/latest/gsg/getting-started.md#change-language "../../../awsconsolehelpdocs/latest/gsg/getting-started.md#change-language") in the _AWS Management Console Getting Started Guide_.
...
To add an object to your bucket, see [Step 2: Upload an object to your bucket](#uploading-an-object-bucket "#uploading-an-object-bucket").
...
To view your object, see [Step 3: Download an object](#accessing-an-object "#accessing-an-object").
...
To copy and paste your object within Amazon S3, see [Step 4: Copy your object to a folder](#copying-an-object "#copying-an-object").
...
Alternatively, choose **Copy** from the options in the upper right. 6. Choose the destination folder:
    ...
    To navigate into a folder and choose a subfolder as your destination, choose the
     folder name.
    3. Choose **Choose destination**.The path to your destination folder appears in the **Destination** box.
...
To delete an object and a bucket in Amazon S3, see [Step 5: Delete your objects and bucket](#deleting-object-bucket "#deleting-object-bucket").
...
- [Deleting an object](#clean-up-delete-objects "#clean-up-delete-objects")
- [Emptying your bucket](#clean-up-empty-bucket "#clean-up-empty-bucket")
- [Deleting your bucket](#clean-up-delete-bucket "#clean-up-delete-bucket")
...
bucket action is in progress will be deleted. 3. To empty the bucket and delete all the objects in it, and choose
**Empty**.

An **Empty bucket: Status** page opens that you can use to review a
summary of failed and successful object deletions. 4. To return to your bucket list, choose **Exit**.
...
bucket name, don't delete your bucket. Instead, empty and keep the bucket. 4. To delete your bucket, choose **Delete bucket**.
...
- [Explore training and support](#explore-training-and-support "#explore-training-and-support")

### Understand common use cases

You can use Amazon S3 to support your specific use case. The [AWS Solutions
Library](https://aws.amazon.com/solutions/ "https://aws.amazon.com/solutions/") and [AWS
Blog](https://aws.amazon.com/blogs/ "https://aws.amazon.com/blogs/") provide use-case specific information and
...
- Application hosting – Deploy, install,
  ...
  more information, see [Hosting a static website using Amazon S3](WebsiteHosting.md "WebsiteHosting.md").
...
- [S3
  Block Public Access](access-control-block-public-access.md "access-control-block-public-access.md") – Block public access to S3 buckets and
  objects. By default, Block Public Access settings are turned on at the bucket
  level.
- [AWS Identity and Access Management (IAM)
  identities](security-iam.md "security-iam.md") – Use IAM or AWS IAM Identity Center to create IAM
  ...
  (users, user groups, and roles)](../../../IAM/latest/UserGuide/id.md "../../../IAM/latest/UserGuide/id.md") in the _IAM User Guide_.
- [Bucket policies](bucket-policies.md "bucket-policies.md") – Use IAM-based policy
  language to configure resource-based permissions for your S3
  buckets and the objects in them.
- [Access
  control lists (ACLs)](acls.md "acls.md") – Grant read and write permissions for
  ...
  see [Identity and Access Management for Amazon S3](security-iam.md "security-iam.md").
- [S3 Object Ownership](about-object-ownership.md "about-object-ownership.md") – Take ownership of every object in
...
- [IAM Access Analyzer for S3](access-analyzer.md "access-analyzer.md") – Evaluate and monitor your S3
...
- [Protecting your storage](data-protection.md "data-protection.md") – After
...
- [Monitoring your
  storage](monitoring-overview.md "monitoring-overview.md") – Monitoring is an important part
...
optimize your storage usage. For example, use [Amazon S3 Storage Lens](storage_lens.md "storage_lens.md") to understand, analyze, and optimize your storage.
...
Analysis](analytics-storage-class.md "analytics-storage-class.md") to analyze storage access patterns to decide when it's time
to move your data to a more cost-effective storage class. To manage your costs,
you can use [S3 Lifecycle](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md").
...
as they are anonymously readable. For more information, see [Developing with Amazon S3](../API/developing-s3.md "../API/developing-s3.md") in the _Amazon S3 API Reference_.
...
To download and configure the AWS CLI, see [Developing with Amazon S3 using the AWS CLI](../API/setup-aws-cli.md "../API/setup-aws-cli.md") in the _Amazon S3 API Reference_.

The AWS CLI provides two tiers of commands for accessing
Amazon S3: High-level ([s3](../../../cli/latest/userguide/cli-services-s3-commands.md "../../../cli/latest/userguide/cli-services-s3-commands.md")) commands and API-level ([s3api](../../../cli/latest/userguide/cli-services-s3-apicommands.md "../../../cli/latest/userguide/cli-services-s3-apicommands.md") and `s3control` commands. The high-level S3
...
For a list of Amazon S3 AWS CLI commands, see [s3](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3/index.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3/index.html"), [s3api](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3api/index.html"), and [s3control](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/index.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/s3control/index.html").
...
For more information, see [Developing with Amazon S3 using the AWS SDKs](../API/sdk-general-information-section.md "../API/sdk-general-information-section.md") in the _Amazon S3 API Reference_.

###### Sample Code and Libraries

The [AWS
Developer Center](https://aws.amazon.com/code/Amazon-S3 "https://aws.amazon.com/code/Amazon-S3") and [AWS
Code Sample Catalog](../../../code-samples/latest/catalog/welcome.md "../../../code-samples/latest/catalog/welcome.md") have sample code and
libraries written especially for Amazon S3. You can use these
code samples to understand how to implement the Amazon S3
API. You can also view the [_Amazon Simple Storage Service API Reference_](../API/Welcome.md "../API/Welcome.md")
...
- [Tutorial: Storing and retrieving a file with Amazon S3](https://aws.amazon.com/getting-started/hands-on/backup-files-to-amazon-s3/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/backup-files-to-amazon-s3/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Getting started using S3 Intelligent-Tiering](https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-intelligent-tiering/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-intelligent-tiering/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Getting started using the S3 Glacier storage classes](https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-glacier-storage-classes/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-glacier-storage-classes/?ref=docs_gateway/amazons3/tutorials.html")

#### Optimizing storage costs

- [Tutorial: Getting started using S3 Intelligent-Tiering](https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-intelligent-tiering/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-intelligent-tiering/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Getting started using the S3 Glacier; storage classes](https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-glacier-storage-classes/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/getting-started-using-amazon-s3-glacier-storage-classes/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Optimizing costs and gaining visibility into usage with S3 Storage Lens](https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/amazon-s3-storage-lens/?ref=docs_gateway/amazons3/tutorials.html")

#### Managing storage

- [Tutorial: Getting started with Amazon S3 Multi-Region Access Points](https://aws.amazon.com/getting-started/hands-on/getting-started-with-amazon-s3-multi-region-access-points/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/getting-started-with-amazon-s3-multi-region-access-points/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Replicating existing objects in your Amazon S3 buckets with S3 Batch Replication](https://aws.amazon.com/getting-started/hands-on/replicate-existing-objects-with-amazon-s3-batch-replication/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/replicate-existing-objects-with-amazon-s3-batch-replication/?ref=docs_gateway/amazons3/tutorials.html")
...
- [Tutorial: Checking the integrity of data in Amazon S3 with additional checksums](https://aws.amazon.com/getting-started/hands-on/amazon-s3-with-additional-checksums/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/amazon-s3-with-additional-checksums/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Replicating data within and between AWS Regions using S3 Replication](https://aws.amazon.com/getting-started/hands-on/replicate-data-using-amazon-s3-replication/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/replicate-data-using-amazon-s3-replication/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Protecting data on Amazon S3 against accidental deletion or application bugs
  using S3 Versioning, S3 Object Lock, and S3 Replication](https://aws.amazon.com/getting-started/hands-on/protect-data-on-amazon-s3/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/protect-data-on-amazon-s3/?ref=docs_gateway/amazons3/tutorials.html")
- [Tutorial: Replicating existing objects in your Amazon S3 buckets with S3 Batch Replication](https://aws.amazon.com/getting-started/hands-on/replicate-existing-objects-with-amazon-s3-batch-replication/?ref=docs_gateway/amazons3/tutorials.html "https://aws.amazon.com/getting-started/hands-on/replicate-existing-objects-with-amazon-s3-batch-replication/?ref=docs_gateway/amazons3/tutorials.html")
...
- Training – Training resources provide a hands-on approach to learning Amazon S3. For more
  ...
  certification](https://www.aws.training "https://www.aws.training") and [AWS online tech talks](https://aws.amazon.com/events/online-tech-talks "https://aws.amazon.com/events/online-tech-talks").
- Discussion Forums – On the forum, you can review posts to understand what you can and can't do
  ...
  [Discussion Forums](https://forums.aws.amazon.com/index.jspa "https://forums.aws.amazon.com/index.jspa").
- Technical Support – If you have further questions, you can contact [Technical Support](https://aws.amazon.com/contact-us "https://aws.amazon.com/contact-us").
