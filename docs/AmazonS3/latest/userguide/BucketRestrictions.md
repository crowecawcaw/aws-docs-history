...
For information about service quotas, see [AWS service quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html "https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html") in the
...
When you create a bucket, you choose its name and the AWS Region to create it in.
 ...
 about bucket naming, see [General purpose bucket naming rules](bucketnamingrules.md "bucketnamingrules.md").
