...
![Illustration that shows how GET returns the current version of the object.](images/versioning_GET_NoVersionID.png)
...
![Illustration that shows how a GET versionId request retrieves the specified version of the object.](images/versioning_GET_Versioned.png)
