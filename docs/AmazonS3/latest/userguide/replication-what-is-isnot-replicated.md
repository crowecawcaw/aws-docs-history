...
For more information about resource ownership, see [Amazon S3 bucket and object ownership](access-policy-language-overview.md#about-resource-owner "access-policy-language-overview.md#about-resource-owner").
...
For more information, see [Changing the replica owner](replication-change-owner.md "replication-change-owner.md"). 
...
When Amazon S3 replicates objects that have retention information applied, it applies
 ...
 applied to your object replicas. For more information, see [Locking objects with Object Lock](object-lock.md "object-lock.md").
...
* If you make a DELETE request without specifying an object version ID, Amazon S3 adds a
 delete marker. Amazon S3 deals with the delete marker as follows:
	 ...
	 *delete marker replication* to non-tag-based rules. For more
...
* Batch Replication does not support re-replicating objects that were deleted with
 ...
 copy objects](batch-ops-examples-copy.md "batch-ops-examples-copy.md").
...
To learn more about S3 Glacier Flexible Retrieval and S3 Glacier Deep Archive,
 see [Storage classes for rarely accessed objects](storage-class-intro.md#sc-glacier "storage-class-intro.md#sc-glacier").


To learn more about the S3 Intelligent-Tiering, see [Managing storage costs with Amazon S3 Intelligent-Tiering](intelligent-tiering.md "intelligent-tiering.md").
...
For example, if lifecycle configuration is enabled only on your source bucket, Amazon S3
 ...
 lifecycle configuration, see [Managing the lifecycle of objects](object-lifecycle-mgmt.md "object-lifecycle-mgmt.md").
