...
+ **Browsing and managing data** – Storage Browser for Amazon S3 is an open source component that you can add to your web applications to provide your end users with a simple interface for browsing and managing Amazon S3 data. For more information, see [Working with Storage Browser for Amazon S3](storage-browser.md).
