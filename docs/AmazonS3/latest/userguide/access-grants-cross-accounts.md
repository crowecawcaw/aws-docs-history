...
that the [IAM policy language](../../../IAM/latest/UserGuide/reference_policies.md "../../../IAM/latest/UserGuide/reference_policies.md") supports. In the same policy, you can grant access to
...
If you already use [AWS Resource Access Manager](../../../ram/latest/userguide/what-is.md "../../../ram/latest/userguide/what-is.md") (AWS RAM), you can use it to share your [`s3:AccessGrants`](../../../ram/latest/userguide/shareable.md#shareable-s3 "../../../ram/latest/userguide/shareable.md#shareable-s3") resources with other accounts or within
your organization. See [Working with shared AWS resources](../../../ram/latest/userguide/working-with.md "../../../ram/latest/userguide/working-with.md") for more information. If you don't use AWS RAM, you can also add the resource policy by using the
...
6. Follow the AWS RAM steps to create the resource share. For more information, see [Creating a resource share in AWS RAM](../../../ram/latest/userguide/working-with-sharing-create.md "../../../ram/latest/userguide/working-with-sharing-create.md").
...
Following the [AWS
cross-account access pattern](../../../IAM/latest/UserGuide/access_policies-cross-account-resource-access.md "../../../IAM/latest/UserGuide/access_policies-cross-account-resource-access.md"), the IAM users or roles in the second account
