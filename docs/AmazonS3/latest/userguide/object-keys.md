...
console](https://console.aws.amazon.com/s3/home "https://console.aws.amazon.com/s3/home"), when you select a bucket, a list of objects in your bucket appears.
...
- Object key names include any prefixes (known as _folders_ in the console). For example,
  ...
  folders, see [Choosing object key names](#object-key-choose "#object-key-choose").
- Certain characters might require special handling when they're used in object key
  names. For more information, see [Object key naming guidelines](#object-key-guidelines "#object-key-guidelines").

###### Note

Object key names with the value `"soap"` aren't supported for [virtual-hosted-style requests](VirtualHosting.md#virtual-hosted-style-access "VirtualHosting.md#virtual-hosted-style-access"). For object key name values where
`"soap"` is used, a [path-style
URL](VirtualHosting.md#path-style-access "VirtualHosting.md#path-style-access") must be used instead.
...
console, see [Editing object metadata in the Amazon S3 console](add-object-metadata.md "add-object-metadata.md").
...
replaced with their equivalent XML entity code](https://www.w3.org/TR/xml/#syntax "https://www.w3.org/TR/xml/#syntax") when they're inserted
within XML tags.
...
4. `中 文/` (starts with `0xE4 0xB8 0xAD`
   `0xE6 0x96 0x87`)
