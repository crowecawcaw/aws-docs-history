...
`example.com` bucket. For more information, see [Configuring a Static Website Using a Custom Domain Name](../dev/website-hosting-custom-domain-walkthrough.md "../dev/website-hosting-custom-domain-walkthrough.md").
...
For example, if you are redirecting to a root domain address, you would enter `example.com`. 7. For **Protocol**, choose the protocol for the redirected requests (**none**,**http**, or **https**).
...
[PutBucketWebsite](../API/API_PutBucketWebsite.md "../API/API_PutBucketWebsite.md") in the _Amazon Simple Storage Service API Reference_.
