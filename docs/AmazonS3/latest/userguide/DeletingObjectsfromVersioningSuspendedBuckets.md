...
![Illustration that shows a simple delete to remove an object with a NULL version ID.](../../../images/AmazonS3/latest/userguide/images/versioning_DELETE_versioningSuspended.png)
...
![Illustration that shows a delete marker insertion.](../../../images/AmazonS3/latest/userguide/images/versioning_DELETE_versioningSuspendedNoNull.png)
...
![Illustration that shows a permanent object deletion using a specified version ID.](../../../images/AmazonS3/latest/userguide/images/versioning_DELETE_versioningEnabled2.png)
