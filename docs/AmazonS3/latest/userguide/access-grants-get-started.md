...
| Steps | Description |
| --- | --- |
| 1 | [Create an S3 Access Grants instance](access-grants-instance.md "access-grants-instance.md")
To get started, initiate an S3 Access Grants instance that will contain your
 individual access grants.  |
| 2 | [Register a location](access-grants-location.md "access-grants-location.md")
Second, register an S3 data location (such as the default,
 ...
 to custom IAM roles.  |
| 3 | [Create grants](access-grants-grant.md "access-grants-grant.md")
Create individual permission grants. Specify in these permission
 ...
 `READWRITE`). |
| 4 | [Request
 access to S3 data](access-grants-credentials.md "access-grants-credentials.md")
When users, applications, and AWS services want to access S3 data,
 ...
 requester. |
| 5 | [Access S3 data](access-grants-get-data.md "access-grants-get-data.md")
