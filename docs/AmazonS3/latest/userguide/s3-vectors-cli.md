...
For the lower-level S3 Vectors API operations that provide more control and customization, see [Amazon S3 Vectors](../API/API_Operations_Amazon_S3_Vectors.md "../API/API_Operations_Amazon_S3_Vectors.md") in the _Amazon Simple Storage Service API Reference_.
