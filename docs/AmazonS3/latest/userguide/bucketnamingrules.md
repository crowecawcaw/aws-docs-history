...
For information about object key names, see [Creating object key
 names](https://docs.aws.amazon.com/en_us/AmazonS3/latest/userguide/object-keys.html "https://docs.aws.amazon.com/en_us/AmazonS3/latest/userguide/object-keys.html").
...
This limitation doesn't affect buckets used for static website hosting, because static
 ...
 virtual-host-style addressing, see [Virtual hosting of general purpose buckets](VirtualHosting.md "VirtualHosting.md"). For more information about static website hosting,
 see [Hosting a static website using Amazon S3](WebsiteHosting.md "WebsiteHosting.md").
...
The following example shows you how to create a with a GUID at the end
 ...
 with your own information. For information about other AWS SDKs, see [Tools to Build on AWS](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/").
