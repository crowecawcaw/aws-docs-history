...
The following topics show you how to return a list of your S3 on Outposts access points by using the
...
2. In the left navigation pane, choose **Outposts
   access points**.
3. Under **Outposts access points**, review your list of
