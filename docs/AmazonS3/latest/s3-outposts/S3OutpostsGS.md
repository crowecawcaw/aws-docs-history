...
about S3 on Outposts, see [What is Amazon S3 on Outposts?](S3onOutposts.md "S3onOutposts.md")

###### Topics

- [Getting started by using the AWS Management Console](S3OutpostsGSConsole.md "S3OutpostsGSConsole.md")
- [Getting started by using the AWS CLI and SDK for Java](S3OutpostsGSCLIJava.md "S3OutpostsGSCLIJava.md")
