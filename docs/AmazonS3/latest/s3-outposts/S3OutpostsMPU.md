...
(AWS CLI), AWS SDKs, or REST API. For more information, see [What is Amazon S3 on Outposts?](S3onOutposts.md "S3onOutposts.md")
...
information. For more information, see [Uploading an object using multipart upload](../userguide/mpu-upload-object.md "../userguide/mpu-upload-object.md") in the _Amazon Simple Storage Service User Guide_.
