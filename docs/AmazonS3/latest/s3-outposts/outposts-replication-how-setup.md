...
- **The source Outposts bucket access point** – The
  ...
  see [Using a
  bucket-style alias for your S3 on Outposts bucket access point](../userguide/s3-outposts-access-points-alias.md "../userguide/s3-outposts-access-points-alias.md").
- **The objects that you want to replicate** –
  You can replicate all of the objects in the source Outposts bucket or a subset. You
  identify a subset by providing a [key name prefix](../../../general/latest/gr/glos-chap.md#keyprefix "../../../general/latest/gr/glos-chap.md#keyprefix"), one or
