...
For more information about using the SDK for Python (Boto3) to generate a presigned URL, see [Python](https://docs.aws.amazon.com/boto3/latest/reference/services/s3.html#S3.Client.generate_presigned_url) in the *AWS SDK for Python (Boto) API Reference*.
