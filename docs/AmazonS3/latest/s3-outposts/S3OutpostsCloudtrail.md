...
For a complete list of CloudTrail data events for S3 on Outposts, see [Amazon S3 data events in CloudTrail](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudtrail-logging-s3-info.html#cloudtrail-data-events) in the *Amazon S3 User Guide*.
...
Amazon S3 on Outposts management events are available via AWS CloudTrail. In addition, you can optionally [enable logging for data events in AWS CloudTrail](https://docs.aws.amazon.com/AmazonS3/latest/user-guide/enable-cloudtrail-events.html).
