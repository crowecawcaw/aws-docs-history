...
For information on recovering logs with Windows PowerShell, see the [Response Logging in AWS Tools for Windows PowerShell](https://aws.amazon.com/blogs/developer/response-logging-in-aws-tools-for-windows-powershell/ "https://aws.amazon.com/blogs/developer/response-logging-in-aws-tools-for-windows-powershell/") in the _AWS Developer Tools Blog_.
...
For more information, see [Identifying Amazon S3 requests using CloudTrail](../userguide/cloudtrail-request-identification.md "../userguide/cloudtrail-request-identification.md") in the _Amazon Simple Storage Service User Guide_.
...
For more information, see [Querying access logs for requests by using Amazon Athena](../userguide/using-s3-access-logs-to-identify-requests.md#querying-s3-access-logs-for-requests "../userguide/using-s3-access-logs-to-identify-requests.md#querying-s3-access-logs-for-requests") in the _Amazon Simple Storage Service User Guide_.
...
For more information, see [How do I turn on logging?](https://github.com/aws/aws-sdk-cpp/wiki#how-do-i-turn-on-logging "https://github.com/aws/aws-sdk-cpp/wiki#how-do-i-turn-on-logging") in the _AWS SDK for C++ wiki on
GitHub_.

Go
You can configure logging by using SDK for Go. For more information, see [Logging](../../../sdk-for-go/v2/developer-guide/configure-logging.md "../../../sdk-for-go/v2/developer-guide/configure-logging.md") in the
...
more information, see [Verbose Wire Logging](../../../sdk-for-java/v1/developer-guide/java-dg-logging.md#sdk-net-logging-verbose "../../../sdk-for-java/v1/developer-guide/java-dg-logging.md#sdk-net-logging-verbose") in the
...
For more information, see [Logging AWS SDK for JavaScript Calls](../../../sdk-for-javascript/v2/developer-guide/logging-sdk-calls.md "../../../sdk-for-javascript/v2/developer-guide/logging-sdk-calls.md") in the
...
For more information, see [Logging](../../../sdk-for-kotlin/latest/developer-guide/logging.md "../../../sdk-for-kotlin/latest/developer-guide/logging.md") in the
...
For more information, see [How can I see what data is sent over the wire?](../../../sdk-for-php/v3/developer-guide/faq.md#how-can-i-see-what-data-is-sent-over-the-wire "../../../sdk-for-php/v3/developer-guide/faq.md#how-can-i-see-what-data-is-sent-over-the-wire") in the
...
wire trace information from an AWS SDK for Ruby client](../../../sdk-for-ruby/v3/developer-guide/debugging.md "../../../sdk-for-ruby/v3/developer-guide/debugging.md") in the
...
in the AWS SDK for Rust](../../../sdk-for-rust/latest/dg/logging.md "../../../sdk-for-rust/latest/dg/logging.md") in the _AWS SDK for Rust Developer
Guide_.
