...
- [Signature Calculation Examples Using Java (AWS Signature Version 4)](#sig-v4-examples-using-sdk-java "#sig-v4-examples-using-sdk-java")
- [Examples of Signature Calculations Using C# (AWS Signature Version 4)](#sig-v4-examples-using-sdk-dotnet "#sig-v4-examples-using-sdk-dotnet")
  ...
  calculation in AWS Signature Version 4 (see [Authenticating Requests (AWS Signature Version 4)](sig-v4-authenticating-requests.md "sig-v4-authenticating-requests.md")) can be a complex undertaking, and we
...
- **PUT object** – Separate examples illustrate both uploading the full payload at once and
  ...
  header for authentication, see [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](sigv4-auth-using-authorization-header.md "sigv4-auth-using-authorization-header.md").
- **GET object** – This example generates a presigned URL to get an object. Query
  ...
  for authentication, see [Authenticating Requests: Using Query Parameters (AWS Signature Version 4)](sigv4-query-string-auth.md "sigv4-query-string-auth.md").
...
The Java sample that shows signature calculation can be downloaded at [https://docs.aws.amazon.com/AmazonS3/latest/API/samples/AWSS3SigV4JavaSamples.zip](samples/AWSS3SigV4JavaSamples.zip.md "samples/AWSS3SigV4JavaSamples.zip.md"). Note that these samples use AWS SDK for Java v1, and we recommend using [AWS SDK for Java v2](../../../sdk-for-java/latest/developer-guide/home.md "../../../sdk-for-java/latest/developer-guide/home.md") for new applications. In
...
3. In a text editor, open the file
   ...
   For
   a list of other AWS Regions, go to [Amazon Simple Storage Service (S3)](../../../general/latest/gr/rande.md#s3_region "../../../general/latest/gr/rande.md#s3_region") in the
