...
choice you make for transferring the payload ([Overview](sigv4-auth-using-authorization-header.md#sigv4-auth-header-overview "sigv4-auth-using-authorization-header.md#sigv4-auth-header-overview")). This section explains signature calculations when you choose to transfer the
payload in a single chunk. The example section (see [Examples: Signature Calculations](#example-signature-calculations "#example-signature-calculations")) shows signature calculations
...
![AWS4-HMAC-SHA256 signature process diagram showing canonical request, StringToSign, and signature steps.](images/sigV4-using-auth-header.png)
...
String to Sign](../../../general/latest/gr/sigv4-create-string-to-sign.md "../../../general/latest/gr/sigv4-create-string-to-sign.md") in the _AWS General Reference_.
...
`region` strings, see [Regions and Endpoints](../../../general/latest/gr/rande.md#s3_region "../../../general/latest/gr/rande.md#s3_region") in the
...
 For more information about signing keys, see [Introduction to Signing Requests](sig-v4-authenticating-requests.md#signing-request-intro "sig-v4-authenticating-requests.md#signing-request-intro").
...
the signing key with your servers. For more information, see [Authenticating Requests (AWS Signature Version 4)](sig-v4-authenticating-requests.md "sig-v4-authenticating-requests.md").
...
Signature](../../../general/latest/gr/sigv4-calculate-signature.md "../../../general/latest/gr/sigv4-calculate-signature.md") in the _AWS General Reference_.
...
- The bucket is assumed to be in the US East (N. Virginia) Region. The credential
  ...
  For information about other Regions, see [Regions and Endpoints](../../../general/latest/gr/rande.md#s3_region "../../../general/latest/gr/rande.md#s3_region")
...
Buckets](../userguide/VirtualHosting.md "../userguide/VirtualHosting.md") in the
...
action, see [GetObject](../API/API_GetObject.md "../API/API_GetObject.md").
...
1. ###### StringToSign
   ...
   because there are no query parameters in the request. 2. ###### StringToSign
...
- You are requesting `REDUCED_REDUNDANCY` as the
  ...
  [Storage Classes](../userguide/UsingMetadata.md#storage-class-intro "../userguide/UsingMetadata.md#storage-class-intro") in the _Amazon Simple Storage Service User Guide_.
...
For information about the API action, see [PutObject](../API/API_PutObject.md "../API/API_PutObject.md").
...
1. ###### StringToSign
   ...
   value sent to S3 in the HTTP request. 2. ###### StringToSign
...
see [GetBucketLifecycleConfiguration](../API/API_GetBucketLifecycleConfiguration.md "../API/API_GetBucketLifecycleConfiguration.md").
...
1. ###### StringToSign
   ...
   the empty request body. 2. ###### StringToSign
...
action, see [ListObjects](../API/API_ListObjects.md "../API/API_ListObjects.md").
