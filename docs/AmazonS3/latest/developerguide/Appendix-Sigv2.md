...
that are signed using Signature Version 4. For more information, see [AWS Signature Version 2 turned off (deprecated) for Amazon S3](specify-signature-version.md#UsingAWSSDK-sig2-deprecation "specify-signature-version.md#UsingAWSSDK-sig2-deprecation")
...
(AWS Signature Version 4)](../API/sig-v4-authenticating-requests.md "../API/sig-v4-authenticating-requests.md") in the _Amazon Simple Storage Service API Reference_.
...
- [Authenticating requests using the REST API (AWS signature version 2)](S3_Authentication2.md "S3_Authentication2.md")
- [Signing and authenticating REST requests (AWS signature version 2)](RESTAuthentication.md "RESTAuthentication.md")
