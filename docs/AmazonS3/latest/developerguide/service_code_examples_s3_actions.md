...
<a name="service_code_examples_s3_actions"></a>
...
These excerpts call the Amazon S3 API and are code excerpts from larger programs that must be run in context. You can see actions in context in [Scenarios for Amazon S3 using AWS SDKs](service_code_examples_s3_scenarios.md). 
