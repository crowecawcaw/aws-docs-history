...
API that include a
[CreateBucketConfiguration](../API/API_CreateBucketConfiguration.md "../API/API_CreateBucketConfiguration.md")
...
see [AWS Regions and Endpoints](../../../general/latest/gr/rande.md "../../../general/latest/gr/rande.md")
...
![Steps that occur when a DNS server routes requests from the client to facility B.](images/DNS_virthost.png)
...
![Steps that occur when a client sends a request to B and is redirected to C.](images/DNS_virthost_redirect.png)
