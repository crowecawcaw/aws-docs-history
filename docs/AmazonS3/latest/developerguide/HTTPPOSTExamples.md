...
(Using AWS Signature Version 4)](../API/sigv4-post-example.md "../API/sigv4-post-example.md") in the
...
- [Policy and form construction](#HTTPPOSTExamplesTextAreaPolicy "#HTTPPOSTExamplesTextAreaPolicy")
