...
also have the option of including trailing headers. (For more information, see [Signature Calculations for the Authorization Header: Transferring Payload in Multiple Chunks (Chunked Upload) (AWS Signature Version 4)](sigv4-streaming.md "sigv4-streaming.md").) This section describes the steps
...
- You must set `x-amz-content-sha256` to an appropriate value that indicates
  ...
  see [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](sigv4-auth-using-authorization-header.md "sigv4-auth-using-authorization-header.md").
