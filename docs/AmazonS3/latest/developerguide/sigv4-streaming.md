...
For information about the API action, see [PutObject](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html). The general request syntax is as follows: 
