...
- [Scenarios](service_code_examples_s3_scenarios.md "service_code_examples_s3_scenarios.md")
  ...
  - [Getting started with big data processing clusters](s3_example_emr_GettingStarted_037_section.md "s3_example_emr_GettingStarted_037_section.md")
  ...
  - [Getting started with document text extraction](s3_example_s3_GettingStarted_074_section.md "s3_example_s3_GettingStarted_074_section.md")
  ...
  - [Getting started with query analytics](s3_example_athena_GettingStarted_061_section.md "s3_example_athena_GettingStarted_061_section.md")
