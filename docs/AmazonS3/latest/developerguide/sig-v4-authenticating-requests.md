...
- [Authentication Methods](#auth-methods-intro "#auth-methods-intro")
- [Introduction to Signing Requests](#signing-request-intro "#signing-request-intro")
- [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](sigv4-auth-using-authorization-header.md "sigv4-auth-using-authorization-header.md")
- [Authenticating Requests: Using Query Parameters (AWS Signature Version 4)](sigv4-query-string-auth.md "sigv4-query-string-auth.md")
- [Examples: Signature Calculations in AWS Signature Version 4](sig-v4-examples-using-sdks.md "sig-v4-examples-using-sdks.md")
- [Authenticating Requests: Browser-Based Uploads Using POST (AWS Signature Version 4)](sigv4-authentication-HTTPPOST.md "sigv4-authentication-HTTPPOST.md")
- [Amazon S3 Signature Version 4 Authentication Specific Policy Keys](bucket-policy-s3-sigv4-conditions.md "bucket-policy-s3-sigv4-conditions.md")
...
Libraries](https://aws.amazon.com/code "https://aws.amazon.com/code")) to send your requests, you don't need to read this section
...
signature version. For more information, see [Sending authenticated requests using the AWS SDKs](AuthUsingAcctOrUserCredentials.md#send-authenticated-request-SDKs "AuthUsingAcctOrUserCredentials.md#send-authenticated-request-SDKs"). You need to read this section only if you are
...
- Verification of the identity of the requester –
  ...
  Security Credentials](../../../general/latest/gr/aws-sec-cred-types.md "../../../general/latest/gr/aws-sec-cred-types.md") in the _AWS General Reference_. If
...
- Protect against reuse of the signed portions of the request
  ...
  Amazon S3, and by using the `s3:x-amz-content-sha256` condition key (see [Amazon S3 Signature Version 4 Authentication Specific Policy Keys](bucket-policy-s3-sigv4-conditions.md "bucket-policy-s3-sigv4-conditions.md")) in AWS policies to require
...
Requests](../userguide/RESTAuthentication.md "../userguide/RESTAuthentication.md") in the _Amazon Simple Storage Service User Guide_.
...
- HTTP Authorization header – Using the HTTP
  ...
  and related options, see [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](sigv4-auth-using-authorization-header.md "sigv4-auth-using-authorization-header.md").
- Query string parameters – You can use
  ...
  days, in HTML. For more information, see [Authenticating Requests: Using Query Parameters (AWS Signature Version 4)](sigv4-query-string-auth.md "sigv4-query-string-auth.md").
...
authenticating POST requests, see [Browser-Based Uploads Using POST (AWS Signature Version 4)](sigv4-UsingHTTPPOST.md "sigv4-UsingHTTPPOST.md").
...
The derived signing key is specific to the date, service, and Region. For more information about how to derive a signing key in different programming languages, see [Examples of how to derive a signing key for Signature Version 4](../../../general/latest/gr/signature-v4-examples.md "../../../general/latest/gr/signature-v4-examples.md").

The following diagram illustrates the general process of computing a signature.

![Three-step process showing StringToSign creation, signing key derivation, and signature computation using HMAC-SHA256.](images/signing-overview.png)
...
- [Authenticating Requests: Using the Authorization Header (AWS Signature Version 4)](sigv4-auth-using-authorization-header.md "sigv4-auth-using-authorization-header.md")
- [Authenticating Requests: Using Query Parameters (AWS Signature Version 4)](sigv4-query-string-auth.md "sigv4-query-string-auth.md")
- [Browser-Based Uploads Using POST (AWS Signature Version 4)](sigv4-UsingHTTPPOST.md "sigv4-UsingHTTPPOST.md")
