...
+ [Examples: Signature Calculations in AWS Signature Version 4](sig-v4-examples-using-sdks.md)
+ [Authenticating Requests: Browser-Based Uploads Using POST (AWS Signature Version 4)](sigv4-authentication-HTTPPOST.md)
