...
| ---------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| `BA-R0001` | Fatal    | Missing Redis configuration for feature through specified path. Either specify the configuration at the given path or define global Redis settings. | [Available Redis cache properties in AWS Blu Age Runtime](ba-runtime-redis-configuration.md "ba-runtime-redis-configuration.md") |
...
| `BA-R0022` | Error    | Error setting property. Check property value format and constraints.                                         | [Available Redis cache properties in AWS Blu Age Runtime](ba-runtime-redis-configuration.md "ba-runtime-redis-configuration.md") |
...
| `BA-R0024` | Error    | Unknown or unsupported Property key.                                                                         | [Available Redis cache properties in AWS Blu Age Runtime](ba-runtime-redis-configuration.md "ba-runtime-redis-configuration.md") |
