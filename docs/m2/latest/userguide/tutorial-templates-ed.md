...
This tutorial describes how to use templates and predefined projects with Rocket Enterprise Developer. It covers three use cases. All of the use cases use the sample code provided in the BankDemo sample. To download the sample, choose [`bankdemo.zip`](https://d1vi4vxke6c2hu.cloudfront.net/demo/bankdemo.zip) .
...
This use case requires you to copy the source components into the Template directory structure as part of the demo pre setup steps. In the [`bankdemo.zip`](https://d1vi4vxke6c2hu.cloudfront.net/demo/bankdemo.zip) this has been changed from the original `AWSTemplates.zip` delivery to avoid having two copies of the source.

1. Start Enterprise Developer and specify the chosen workspace.  
![The Eclipse launcher with a workspace selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc1-step1.png)
...
![The enterprise development project tree view context menu.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc1-step2.png)

1. Enter the template parameters as shown.
**Note**  
The Template Path will refer to where the ZIP was extracted.  
![The Enter template parameters box with the path and project name filled in.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc1-step3.png)
...
![The local development Eclipse project showing its structure.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc1-step4.png)
...
![The project context menu with import selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc2-step4.png)

1. From the resulting dialog, under the **General** section, choose **File System** and then choose Next.  
![The Import box with file system selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc2-step5.png)
...
![The File system box with the BankDemo directory expanded.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc2-step6.png)
...
1. Start Enterprise Developer and specify the chosen workspace.  
![The Eclipse launcher with a workspace selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc3-step1.png)

1. From the **File** menu, choose **Import**.  
![The File menu with Import selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc3-step2.png)

1. From the resulting dialog, under **General**, choose **Projects from Folder or Archive** and choose **Next**.  
![The Import box with projects from folder or archive selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc3-step3.png)
...
![The import projects from file system or archive box with the path to the import source entered.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-uc3-step4.png)
...
![The server explorer context menu with open administration page selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-admin-page.png)

1. From the resulting Enterprise Server Common Web Administration (ESCWA) screen, choose **Import** .  
![The Enterprise Server Common Web Administration screen with Import selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-import.png)

1. Choose the **JSON** import type and choose **Next**.  
![The choose import type box with JSON selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-import-type.png)

1. Upload the supplied `BANKDEMO.JSON` file.  
![The choose file to upload box with the BANKDEMO file selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-upload.png)

   Once selected, choose **Next**.  
![The select regions box with clear ports from endpoints not selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-next.png)
...
![The Region and server list with BankDemo added.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-server-list.png)
...
![The configuration section with the ESP variable shown.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-ESP.png)
...
![The project context menu with Associated with project selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/ed-json-associate.png)
