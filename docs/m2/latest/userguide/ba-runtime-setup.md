...
# Set up AWS Blu Age Runtime

This section explains the steps to set up AWS Blu Age Runtime on your AWS infrastructure. Before you set
up your AWS Blu Age Runtime for applications, understand the prerequisites, regions and buckets, and the CloudWatch
