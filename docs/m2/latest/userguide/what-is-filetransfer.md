...
![The how it works for File Transfer feature with different phases.](images/filetransfer-overview.png)

The following figure is an architectural overview of AWS Mainframe Modernization File Transfer feature.

![The architectural overview of the File Transfer feature representing data transfer between mainframe and AWS Cloud Region.](images/filetransfer-architecture.png)
