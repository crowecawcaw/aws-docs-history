...
![AWS License Manager home page.](images/mf-license-manager_1.png) 2. Choose **Start using AWS License Manager**. 3. If you see the following pop-up, view the details, then choose the check-box and press **Grant Permissions**.

![IAM permissions one-time setup](images/mf-license-manager_2.png)
