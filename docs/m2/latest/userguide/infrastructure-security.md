...
As a managed service, AWS Mainframe Modernization is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Mainframe Modernization through the network. Clients must
