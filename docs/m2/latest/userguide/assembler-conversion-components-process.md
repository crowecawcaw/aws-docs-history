...
**Topics**
+ [AWS Mainframe Modernization container](#assembler-conversion-components-container)
+ [S3 project bucket](#assembler-conversion-components-s3)
+ [Log file locations](#assembler-conversion-components-log)
+ [Process overview](#assembler-conversion-process)
