...
## Resolution
<a name="env-unhealthy-resolution"></a>
...
1. Select the unhealthy environment, and choose **Configuration**.

1. Choose **Attached Storage** to view the storage resources associated with this environment. 

1. Check the network-related configurations, such as the security group, subnet, and Amazon VPC associated with the storage. If these configurations are incorrect, try to restore them to solve this issue. 
