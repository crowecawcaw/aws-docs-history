...
applications prior to production or critical deployments.
...
| Version 4     | Yet to be released | ###### Note EOL date for major version 4 will be aligned with the availability for the next major version. To understand the support model of minor versions, refer [AWS Mainframe Modernization components lifecycle](lifecycle-m2.md "lifecycle-m2.md"). |
