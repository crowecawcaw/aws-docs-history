...
To get started, create an [AWS Support](https://support.console.aws.amazon.com/support/home "https://support.console.aws.amazon.com/support/home") case to request onboarding to access AWS Transform for mainframe Runtime. Include in your request your
AWS account ID, the AWS Region that you want to use, and a compute choice, and AWS Transform for mainframe Runtime version.
If you aren't sure which version you need, contact your AWS Transform for mainframe delivery manager. If you
