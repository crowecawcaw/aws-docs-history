...
This guide covers the end-to-end process of replatforming mainframe applications using AWS Mainframe Modernization solutions on AWS.
It describes all tasks and includes information on configuring and operating AWS Mainframe Modernization runtime on Amazon EC2 from initial setup and analysis to building,
testing, and deploying your modernized applications on AWS. It also covers advanced topics like working with legacy data structures,
using templates and predefined projects, and setting up automation for streaming sessions.
