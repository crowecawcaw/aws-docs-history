...
**Topics**
+ [Step 1: Create a zFS data set for the M2-agent](#allocate-dataset)
+ [Step 2: Format the data set as zFS](#format-dataset)
+ [Step 3: Mount the filesystem](#mount-filesystem)
+ [Step 4: Verify the mount](#verify-mount)
+ [Step 5: Enter OMVS](#enter-omvs)
+ [Step 6: Set the agent installation directory environment variable](#agent-directory)
+ [Step 7: Set the work directory environment variable](#work-directory)
+ [Step 8: Create the work directory](#create-work-directory)
+ [Step 9: Copy the agent tar file and copy the work directory](#agent-tar-package)
+ [Step 10: Finish the agent installation](#finish-agent-installation)
