...
For more information on the application definition for a AWS Transform for mainframe application, see [AWS Transform for mainframe application definition sample](applications-m2-definition.md#applications-m2-definition-ba).
