...
![Route table details.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_1.png)
...
![Route table selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_2.png)
...
![Basic details with inbound rule entered.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_3.png)
...
![Endpoint settings with AWS services selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_4.png)
...
1. Choose the matching Interface service.
   ...
   **com.amazonaws.{{region}}.ec2**:  
![Services with Amazon EC2 interface service selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_5.png)

   **com.amazonaws.{{region}}.sts:**  
![Services with AWS STS interface service selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_6.png)

   **com.amazonaws.{{region}}.license-manager:**  
![Services with License Manager interface service selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_7.png)

1. For VPC choose the VPC for the instance.  
![VPC with the VPC for the instance selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_8.png)

1. Choose the **Availability Zone** and the **Subnets** for the VPC.  
![Subnets with availability zone and subnet for the VPC selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_9.png)

1. Choose the Security Group created earlier.  
![Security groups with security group selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_10.png)

1. Under Policy choose **Full Access**.  
![Policy with Full Access selected.](https://docs.aws.amazon.com/m2/latest/userguide/images/mf-no-internet_11.png)
