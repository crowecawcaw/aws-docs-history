...
![The PlanetsDemo application screen in insert mode.](/images/m2/latest/userguide/images/ba-demo-app-screen.png) 5. Type a planet name in the corresponding field and press Enter.
