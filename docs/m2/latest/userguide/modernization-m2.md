...
Automated refactoring uses AWS Transform for mainframe tools to automatically convert code, data, and dependencies to modern language, datastore, and frameworks, while at the same time guaranteeing functional equivalence with the same business functions.

Replatforming uses Rocket Software (formerly Micro Focus) tools to transform mainframe workloads into agile services on AWS.
...
## Assess phase
<a name="assess-modernization-m2"></a>
...
## Mobilize phase
<a name="mobilize-modernization-m2"></a>
...
<a name="migrate-modernization-m2"></a>
