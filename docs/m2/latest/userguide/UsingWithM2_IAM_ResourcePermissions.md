...
AWS Mainframe Modernization API and required permissions for actions| AWS Mainframe Modernization API Operations | Required Permissions (API Actions) | Resources |
| --- | --- | --- |
