...
- [Tutorial: Set up managed runtime for Rocket Software (formerly Micro Focus)](tutorial-runtime-mf.md "tutorial-runtime-mf.md")
  ...
  AWS Mainframe Modernization applications for each workload that you migrate. When you create an AWS Mainframe Modernization application,
  you specify the engine that the application runs on when you create it. Choose AWS Transform for mainframe if you are
  using the automated refactoring pattern, and choose Rocket Software (formerly Micro Focus) if you are using the replatforming
  pattern.
...
- [Delete an AWS Mainframe Modernization application](applications-m2-delete.md "applications-m2-delete.md")
...
- [Export data sets for AWS Mainframe Modernization applications](applications-m2-dataset.export.md "applications-m2-dataset.export.md")
- [Manage transactions for AWS Mainframe Modernization applications](applications-m2-transactions.console.md "applications-m2-transactions.console.md")
- [Configure the Rocket Software (formerly Micro Focus) managed application](mf-app-config.md "mf-app-config.md")
- [Configure the AWS Transform for mainframe managed application](ba-app-config.md "ba-app-config.md")
