...
- [I want to allow people outside of my AWS account to access my AWS Mainframe Modernization resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
- To learn whether AWS Mainframe Modernization supports these features, see [How AWS Mainframe Modernization works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
