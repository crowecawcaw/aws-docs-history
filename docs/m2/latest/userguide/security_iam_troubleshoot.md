...
# Troubleshooting AWS Mainframe Modernization identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with AWS Mainframe Modernization and IAM.
...
- [I want to allow
  people outside of my AWS account to access my AWS Mainframe Modernization resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
AWS Mainframe Modernization. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
people outside of my AWS account to access my AWS Mainframe Modernization resources
...
- To learn whether AWS Mainframe Modernization supports these features, see [How AWS Mainframe Modernization works with
