...
1. After you create your Lambda function, copy the function's ARN displayed. The following is an example ARN, where {{`function-name`}} is the name of the Lambda function (in this case, `ProcessSingleItem`):
