...
- [Testing state machines with Step Functions Local (unsupported)](sfn-local.md "sfn-local.md")
...
1. [Install the AWS SAM CLI](../../../serverless-application-model/latest/developerguide/serverless-sam-cli-install.md "../../../serverless-application-model/latest/developerguide/serverless-sam-cli-install.md").

###### Note

Before installing the AWS SAM CLI, you need to install the AWS CLI and Docker. See the
[Prerequisites](../../../serverless-application-model/latest/developerguide/serverless-sam-cli-install.md "../../../serverless-application-model/latest/developerguide/serverless-sam-cli-install.md") for installing the AWS SAM CLI. 2. Go through the [AWS SAM Quick Start](../../../serverless-application-model/latest/developerguide/serverless-quick-start.md "../../../serverless-application-model/latest/developerguide/serverless-quick-start.md") documentation. Be sure to follow the steps to do the
following:

    1. [Initialize the Application](../../../serverless-application-model/latest/developerguide/serverless-quick-start.md#gs-ex1-setup-local-app "../../../serverless-application-model/latest/developerguide/serverless-quick-start.md#gs-ex1-setup-local-app")
    2. [Test the Application Locally](../../../serverless-application-model/latest/developerguide/serverless-quick-start.md#gs-ex1-test-locally "../../../serverless-application-model/latest/developerguide/serverless-quick-start.md#gs-ex1-test-locally")
...
`HelloWorldFunction`
that you initialized in [Step 1: Set Up AWS SAM](#install-sam "#install-sam").
