...
| Metric                       | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ApproximateOpenMapRunCount   | Approximate number of currently open Map Runs in progress in<br>your account.<br>With this metric, you can take action when you are approaching<br>the **OpenMapRunLimit**, to avoid<br>backlogged Map Runs.<br>For an alarm to notify if you are nearing your **OpenMapRunLimit**, we recommend using the<br>**Maximum\*<br>• statistic with a<br>threshold of 900 or higher, because the default **OpenManRunLimit\*<br>• is 1,000 map runs.                                                                  |
