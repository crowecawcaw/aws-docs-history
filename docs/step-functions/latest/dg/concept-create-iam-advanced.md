...
[Service-Level Permissions](#concept-create-iam-advanced-service "#concept-create-iam-advanced-service")
...
`ListStateMachines`,
`ListActivities`,
and `ValidateStateMachineDefinition`.
...
`DescribeExecution`, `GetExecutionHistory`, and `StopExecution`.
...
token of the instance as part of the request, such as `DeleteActivity`, `DescribeActivity`, `GetActivityTask`, and `SendTaskHeartbeat`.
