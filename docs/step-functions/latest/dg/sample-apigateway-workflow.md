...
This sample project demonstrates how to use Step Functions to make a call to API Gateway and checks whether
the call succeeded.
...
- [Create API Gateway REST APIs with Step Functions](connect-api-gateway.md "connect-api-gateway.md")
