...
An _alias_ is a pointer for up to two versions of the same state
...
You
can use an alias to
[route traffic](#alias-routing-config "#alias-routing-config") between one
...
![Diagram showing an alias sending 80 percent of requests to v1, and 20 percent to v2.](images/aliases-concept.png)
...
[AWS Management Console](../../../servicequotas/latest/userguide/request-quota-increase.md "../../../servicequotas/latest/userguide/request-quota-increase.md"). Delete unused aliases from the console or by invoking the [DeleteStateMachineAlias](../apireference/API_DeleteStateMachineAlias.md "../apireference/API_DeleteStateMachineAlias.md") API action.
...
- [CreateStateMachineAlias](../apireference/API_CreateStateMachineAlias.md "../apireference/API_CreateStateMachineAlias.md") – Creates an alias
  for a state machine.
- [DescribeStateMachineAlias](../apireference/API_DescribeStateMachineAlias.md "../apireference/API_DescribeStateMachineAlias.md") – Returns details
  about a state machine alias.
- [ListStateMachineAliases](../apireference/API_ListStateMachineAliases.md "../apireference/API_ListStateMachineAliases.md") – Lists aliases for
  the specified state machine ARN.
- [UpdateStateMachineAlias](../apireference/API_UpdateStateMachineAlias.md "../apireference/API_UpdateStateMachineAlias.md") – Updates the
  configuration of an existing state machine alias by modifying its `description` or `routingConfiguration`.
- [DeleteStateMachineAlias](../apireference/API_DeleteStateMachineAlias.md "../apireference/API_DeleteStateMachineAlias.md") – Deletes a state
  machine alias.
...
- On the **Create alias** page, under **Routing
  ...
  between two versions** check box. 3. For **Version**, choose the second version that the
  alias must point to. 4. In the **Traffic percentage** fields, specify the
...
5. If required, enter the execution input, and then choose **Start
   execution**.
