...
| [.zip](https://s3.amazonaws.com/stepfunctionslocal/StepFunctionsLocal.zip "https://s3.amazonaws.com/stepfunctionslocal/StepFunctionsLocal.zip")          | [.zip.md5](https://s3.amazonaws.com/stepfunctionslocal/StepFunctionsLocal.zip.md5 "https://s3.amazonaws.com/stepfunctionslocal/StepFunctionsLocal.zip.md5")          |
...
- [Set Up AWS SAM](../../../serverless-application-model/latest/developerguide/serverless-quick-start.md "../../../serverless-application-model/latest/developerguide/serverless-quick-start.md")
- [Start AWS SAM CLI Local](../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-local-start-lambda.md "../../../serverless-application-model/latest/developerguide/sam-cli-command-reference-sam-local-start-lambda.md")
...
For more information about running Step Functions Local with AWS Lambda, see [Tutorial: Testing workflows using Step Functions and AWS SAM CLI Local](sfn-local-lambda.md "sfn-local-lambda.md").
