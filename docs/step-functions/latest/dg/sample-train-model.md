...
then trains a machine learning model and performs a batch transform, using the [SageMaker AI service integration](connect-sagemaker.md "connect-sagemaker.md").
