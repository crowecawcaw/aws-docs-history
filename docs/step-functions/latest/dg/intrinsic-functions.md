...
- [Intrinsics for arrays](#asl-intrsc-func-arrays "#asl-intrsc-func-arrays")
- [Intrinsics for data encoding and decoding](#asl-intrsc-func-data-encode-decode "#asl-intrsc-func-data-encode-decode")
- [Intrinsic for hash calculation](#asl-intrsc-func-hash-calc "#asl-intrsc-func-hash-calc")
- [Intrinsics for JSON data manipulation](#asl-intrsc-func-json-manipulate "#asl-intrsc-func-json-manipulate")
- [Intrinsics for Math operations](#asl-intrsc-func-math-operation "#asl-intrsc-func-math-operation")
- [Intrinsic for String operation](#asl-intrsc-func-string-operation "#asl-intrsc-func-string-operation")
- [Intrinsic for unique identifier generation](#asl-intrsc-func-uuid-generate "#asl-intrsc-func-uuid-generate")
- [Intrinsic for generic operation](#asl-intrsc-func-generic "#asl-intrsc-func-generic")
...
the [JsonPath ABNF](https://www.ietf.org/archive/id/draft-ietf-jsonpath-base-21.html#jsonpath-abnf "https://www.ietf.org/archive/id/draft-ietf-jsonpath-base-21.html#jsonpath-abnf")
