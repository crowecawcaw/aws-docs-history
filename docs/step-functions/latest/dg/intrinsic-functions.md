...
**Warning**  
Intrinsic functions are only available to states that use the **JSONPath** query language. For JSONata, see [Transforming data with JSONata in Step Functions](transforming-data.md).
