...
- [Adding Amazon EventBridge events with
  PutEvents](../../../eventbridge/latest/userguide/eb-putevents.md "../../../eventbridge/latest/userguide/eb-putevents.md") in the EventBridge User Guide.
- [Wait for a Callback with Task Token](connect-to-resource.md#connect-wait-token "connect-to-resource.md#connect-wait-token") in Service
...
- [`PutEvents`](../../../eventbridge/latest/APIReference/API_PutEvents.md "../../../eventbridge/latest/APIReference/API_PutEvents.md")
