...
collection of [states](workflow-states.md "workflow-states.md"), that can do work (`Task`
...
States Language Specification](https://states-language.net/spec.html "https://states-language.net/spec.html") and [Statelint](https://github.com/awslabs/statelint "https://github.com/awslabs/statelint"), a tool that validates Amazon States Language code.

To create a state machine on the [Step Functions console](https://console.aws.amazon.com/states/home?region=us-east-1#/ "https://console.aws.amazon.com/states/home?region=us-east-1#/")
using Amazon States Language, see [Getting Started](getting-started.md "getting-started.md").
