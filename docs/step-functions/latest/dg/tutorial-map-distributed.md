...
In this step, you create the prototype for your workflow using Workflow Studio. Workflow Studio is a visual workflow designer available in the Step Functions console. You choose the required state and API action from the **Flow** and **Actions** tabs respectively. You will use the drag and drop feature of Workflow Studio to create the workflow prototype.
...
1. In the **Basic information** section, configure your Lambda function:
   ...
   1. After you create your Lambda function, copy the function's Amazon Resource Name (ARN) displayed. You will need to provide this in your workflow prototype. The following is an example ARN:
