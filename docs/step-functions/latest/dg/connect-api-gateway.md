...
- The [Amazon API Gateway
  concepts](../../../apigateway/latest/developerguide/api-gateway-basic-concept.md "../../../apigateway/latest/developerguide/api-gateway-basic-concept.md") page.
- [Choosing between HTTP APIs and
  REST APIs](../../../apigateway/latest/developerguide/http-api-vs-rest.md "../../../apigateway/latest/developerguide/http-api-vs-rest.md") in the API Gateway developer guide.
...
- **IAM role**: With this method, Step Functions assumes the role of
  the state machine, signs the request with [Signature Version 4](../../../general/latest/gr/sigv4_signing.md "../../../general/latest/gr/sigv4_signing.md") (SigV4),
  then calls the API.
...
- [Request Response](connect-to-resource.md#connect-default "connect-to-resource.md#connect-default"), which is
