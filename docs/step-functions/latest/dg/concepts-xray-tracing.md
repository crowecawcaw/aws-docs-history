...
![Illustrative screenshot of X-Ray traces for a state machine.](http://docs.aws.amazon.com/step-functions/latest/dg/images/xray-tracing-overview.png)
...
![Illustrative screenshot focused on the service map in X-Ray traces.](http://docs.aws.amazon.com/step-functions/latest/dg/images/xray-tracing-servicemap.png)
...
![Example details for an X-Ray trace node.](http://docs.aws.amazon.com/step-functions/latest/dg/images/xray-tracing-servicemap-detail.png)
...
![Example graphical representation of the state machine being traced.](http://docs.aws.amazon.com/step-functions/latest/dg/images/sample-callback-example.png)
...
![Example screenshot of segments and subsegments for a state machine.](http://docs.aws.amazon.com/step-functions/latest/dg/images/xray-tracing-segments.png)
