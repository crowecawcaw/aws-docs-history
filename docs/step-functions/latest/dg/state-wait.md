...
fields](statemachine-structure.md#amazon-states-language-common-fields "statemachine-structure.md#amazon-states-language-common-fields"), `Wait` states have one of the following fields.
...
A [path](concepts-input-output-filtering.md "concepts-input-output-filtering.md") in the states input data to an integer value that specifies the time to wait, in seconds, before proceeding to the next state.

**`TimestampPath` (Optional, JSONPath only)**

A [path](concepts-input-output-filtering.md "concepts-input-output-filtering.md") in the states input data to an absolute date and time (timestamp) to wait before proceeding to the next state.
...
You can select the value of "expirydate" from the input using a reference [path](concepts-input-output-filtering.md "concepts-input-output-filtering.md") to select it from
the input data.
