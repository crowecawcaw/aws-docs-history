...
![Illustrative screenshot showing state inputs, outputs, and the info help panel](images/wfs_input_output_01.png)
For
detailed information about how Step Functions processes input and output, see [Processing input and output in Step Functions](concepts-input-output-filtering.md "concepts-input-output-filtering.md").
...
- Enter a valid [JsonPath](https://datatracker.ietf.org/wg/jsonpath/about/ "https://datatracker.ietf.org/wg/jsonpath/about/") for the `InputPath` filter. For example, `$.data`.
...
[Parallel workflow state](state-parallel.md "state-parallel.md"), [Map workflow state](state-map.md "state-map.md"), and [Pass workflow state](state-pass.md "state-pass.md") flow states have an
...
in the **Inspector** panel. For [Task workflow state](state-task.md "state-task.md") states, any output filters you select are
processed in this order:

1. `ResultSelector`: Use this filter to
   manipulate the state’s result. You can construct a new JSON object with
   parts of the result.
2. `Specifying state output using ResultPath in Step Functions`: Use this filter to select
   a combination of the state input and the task result to pass to the output.
3. `Filtering state output using OutputPath`: Use this filter to filter
...
- [Task workflow state](state-task.md "state-task.md") states, which are all states listed in the
  **Actions** tab of the [States browser](workflow-studio.md#workflow-studio-components-states "workflow-studio.md#workflow-studio-components-states").
- [Map workflow state](state-map.md "state-map.md") states, in the **Flow** tab of the States
  browser.
- [Parallel workflow state](state-parallel.md "state-parallel.md") states, in the **Flow** tab of the
  States browser.
...
passed to the state output. For more use cases of `ResultPath`, see [Specifying state output using ResultPath in Step Functions](input-output-resultpath.md "input-output-resultpath.md").
...
- [Parallel workflow state](state-parallel.md "state-parallel.md") states, in the **Flow** tab of the
  States browser.
- [Pass workflow state](state-pass.md "state-pass.md") states, in the **Flow** tab of the States
  browser.
...
entering a reference [path](amazon-states-language-paths.md "amazon-states-language-paths.md") that
