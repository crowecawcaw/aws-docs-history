...
integration](connect-athena.md "connect-athena.md") and returns the results using an SNS topic.
...
- [Run Athena queries with Step Functions](connect-athena.md "connect-athena.md")
