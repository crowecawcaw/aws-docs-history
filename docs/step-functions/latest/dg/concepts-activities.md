...
| `workers_count`    | The number of threads for your activity worker. For most implementations, between<br>10 and 20 threads should be sufficient. The longer the activity takes to process, the<br>more threads it might need. As an estimate, multiply the number of process activities<br>per second by the 99th percentile activity processing latency, in seconds. |
| `pollers_count`    | The number of threads for your pollers. Between 10 and 20 threads should be<br>sufficient for most implementations.                                                                                                                                                                                                                               |
