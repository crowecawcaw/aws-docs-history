...
1. From **Map iteration viewer**, choose **\#2** from the dropdown list for third iteration. This is because iterations are counted from zero. Likewise, choose **\#3** from the dropdown list for the fourth iteration of the **Map** state.
