...
You can modernize your .NET code using the AWS Transform web application (described here) or the [Visual Studio IDE](dotnet-ide.md). The web application is best suited for IT professionals interested in large-scale transformation. It works at repository level, and can transform as many as 5,000 repositories in a single job.
...
<a name="web-transformation-workflow"></a>
...
1. **Start transformation**
   + [Create a .NET modernization job](dotnet-web-create-job.md)
   + [Connect to source code](dotnet-web-connect-source-code.md)

1. **Discovery and assessment**
   + [Discover and confirm repositories](dotnet-web-confirm-repos.md)
   + [Set transformation mode](dotnet-web-settings.md)
   + [Assessment](dotnet-web-assessment.md)

1. **Prepare for transformation**
   + [Resolve missing package dependencies](dotnet-web-resolve-dependencies.md)
   + [Review and customize transformation plan](dotnet-web-review-and-customize-plan.md)

1. **Transformation and checkpoint reviews**
   + [Transform your .NET code](dotnet-web-transform-code.md)

1. **End of transformation**
   + [Review transformation artifacts](dotnet-web-final-summary.md)
   + [Validate and finalize with AI code companion](dotnet-next-steps.md)

### Developer hand-off
<a name="developer-hand-off"></a>
...
1. **Post-transformation hand-off:** After repositories are transformed in the web application, hand them off to developers to review, validate, and debug the transformed application - typically assisted by an AI code companion. See [Beam a transformed repository to a developer](dotnet-web-final-summary.md#beam-transformed-repository).