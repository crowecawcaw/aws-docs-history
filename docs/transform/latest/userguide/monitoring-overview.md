...
performance of AWS Transform and your other AWS solutions. AWS provides the following monitoring
tools to watch AWS Transform, report when something is wrong, and take automatic actions when
appropriate:
