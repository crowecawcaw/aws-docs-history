...
<a name="dotnet-web-transform-code"></a>

In the *Transform* phase, the agent transforms your repositories.
...
## Checkpoint reviews
<a name="working-with-checkpoints"></a>
...
<a name="download-transformed-repositories"></a>
...
+ **Beaming:** After the agent completes the transformation batch, you can [beam transformed repositories to developers](dotnet-web-final-summary.md#beam-transformed-repository) in the *Final summary* phase.