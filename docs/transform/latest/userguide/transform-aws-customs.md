...
| AWS/dotnet-version-upgrade | .NET | Early access | Migrate .NET Framework solutions to modern .NET (net10.0 default; net8.0 or later supported) with controlled user interaction. Assesses complexity and dependencies, presents a migration plan, transforms projects with validation, and generates a summary with next steps. | 
