...
| Transformation                                | Language / stack                       | Status              | Description                                                                                                                                                                                                                  |
| --------------------------------------------- | -------------------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `AWS/spring-boot-version-upgrade`             | Java / Spring Boot                     | Generally available | Upgrade an older Spring Boot application to a target Spring Boot version, including build files and starters, properties, Jackson 3 packages, Spring Security 7 DSL, testing infrastructure, and observability dependencies. |
