...
The Visual Studio IDE experience supports authentication by IAM Identity Center only. For more information, see [Adding users in IAM Identity Center](transform-user-management.md#transform-add-idc-users "transform-user-management.md#transform-add-idc-users").
