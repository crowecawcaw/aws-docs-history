...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Transform. The following topics show you how to configure AWS Transform to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS Transform resources.
...
- [Accessing the AWS Transform web application from a VPC](vpc-webapp-access.md "vpc-webapp-access.md")
