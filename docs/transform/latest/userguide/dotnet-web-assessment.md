...
After you confirm repositories for assessment in the _Discovery_ phase, your job will enter the _Assessment_ phase. AWS Transform analyzes your repositories for modernization suitability based on the following considerations.
