...
Before you use IAM to manage access to AWS Transform, learn what IAM features are
available to use with AWS Transform.
...
To get a high-level view of how AWS Transform and other AWS services work with most IAM
...
To see a list of AWS Transform resource types and their ARNs, and with
...
For details about creating or managing AWS Transform service-linked roles, see [Using service-linked roles for AWS Transform](using-service-linked-roles.md "using-service-linked-roles.md").
