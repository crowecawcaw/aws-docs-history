...
`search.m1.large`, `search.m2.xlarge`,
`search.m2.2xlarge`, `search.m3.medium`,
`search.m3.large`, `search.m3.xlarge`, and
`search.m3.2xlarge`.
...
valid when you select `search.2xlarge` as the instance
type.
