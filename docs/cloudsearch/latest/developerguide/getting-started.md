...
Using the AWS Management Console and the sample movie data, you'll
have your own search domain up and running in about half an hour.

To begin, [Get Signed Up](getting-started-sign-up.md "getting-started-sign-up.md").
