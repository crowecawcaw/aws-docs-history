...
To specify a range of values, use a comma (,) to separate the upper and lower
...
matches for _restaurant_ are filtered so that only matches within
...
For more information, see [location-based searching and sorting](searching-locations.md "searching-locations.md").
