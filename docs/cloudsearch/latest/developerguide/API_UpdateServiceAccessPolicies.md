...
Configures the access rules that control access to the domain's document and search endpoints.
 For more information, see [Configuring Access for an Amazon CloudSearch Domain](configuring-access.md "configuring-access.md").
...
## Response Elements
 ...
 The following 
 element is 
 returned in a structure named `UpdateServiceAccessPoliciesResult`. 
