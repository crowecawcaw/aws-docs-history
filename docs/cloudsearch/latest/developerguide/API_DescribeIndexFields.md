...
see [Getting Domain Information](getting-domain-info.md "getting-domain-info.md") in the _Amazon CloudSearch Developer Guide_.
...
The following
element is
returned in a structure named `DescribeIndexFieldsResult`.
