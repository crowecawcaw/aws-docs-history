...
[Overview of AWS IAM Policies](../../../IAM/latest/UserGuide/PoliciesOverview.md "../../../IAM/latest/UserGuide/PoliciesOverview.md").
...
Amazon CloudSearch supports both _user-based policies_ and
...
- **User-based policies** are attached to a
  ...
  actions.** (The _user_ in this context isn't
...
Amazon CloudSearch. For more information, see [Managing IAM Policies](../../../IAM/latest/UserGuide/ManagingPolicies.md "../../../IAM/latest/UserGuide/ManagingPolicies.md").
...
- `Action` specifies which Amazon CloudSearch actions the statement applies to.
  ...
  information, see [Configuring MFA-Protected API Access](../../../IAM/latest/UserGuide/Using_ManagingMFA.md "../../../IAM/latest/UserGuide/Using_ManagingMFA.md").) Wildcards are also
...
service for a `movies` domain owned by the account 555555555555. The policy uses wildcards for the actions, since it grants
access to all actions that begin with _Describe_ or
_List_. Note that this will also grant access to any describe
