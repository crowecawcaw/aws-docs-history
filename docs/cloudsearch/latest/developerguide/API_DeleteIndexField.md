...
Removes an `IndexField` from the search domain. For more information, see [Configuring Index Fields](configuring-index-fields.md "configuring-index-fields.md") in the _Amazon CloudSearch Developer Guide_.
