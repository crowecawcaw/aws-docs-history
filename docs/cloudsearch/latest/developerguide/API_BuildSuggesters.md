...
Indexes the search suggestions. For more information, see [Configuring Suggesters](getting-suggestions.md#configuring-suggesters "getting-suggestions.md#configuring-suggesters") in the *Amazon CloudSearch Developer Guide*.
