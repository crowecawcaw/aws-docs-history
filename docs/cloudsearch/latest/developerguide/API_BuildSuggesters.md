...
Indexes the search suggestions. For more information, see [Configuring Suggesters](getting-suggestions.md#configuring-suggesters "getting-suggestions.md#configuring-suggesters") in the _Amazon CloudSearch Developer Guide_.
...
The following
element is
returned in a structure named `BuildSuggestersResult`.
