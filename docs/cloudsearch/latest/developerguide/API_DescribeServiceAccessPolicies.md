...
see [Configuring Access for a Search Domain](configuring-access.md "configuring-access.md") in the _Amazon CloudSearch Developer Guide_.
...
The following
element is
returned in a structure named `DescribeServiceAccessPoliciesResult`.
...
Type:
[AccessPoliciesStatus](API_AccessPoliciesStatus.md "API_AccessPoliciesStatus.md")
