...
Deletes an analysis scheme. For more information, see [Configuring Analysis Schemes](configuring-analysis-schemes.md "configuring-analysis-schemes.md") in the *Amazon CloudSearch Developer Guide*. 
