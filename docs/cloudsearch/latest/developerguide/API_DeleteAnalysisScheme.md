...
Deletes an analysis scheme. For more information, see [Configuring Analysis Schemes](configuring-analysis-schemes.md "configuring-analysis-schemes.md") in the _Amazon CloudSearch Developer Guide_.
...
The following
element is
returned in a structure named `DeleteAnalysisSchemeResult`.
