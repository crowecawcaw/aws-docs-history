...
Gets the scaling parameters configured for a domain. A domain's scaling parameters specify the desired search instance type and replication count. For more information, see [Configuring Scaling Options](configuring-scaling-options.md "configuring-scaling-options.md") in the _Amazon CloudSearch Developer Guide_.
