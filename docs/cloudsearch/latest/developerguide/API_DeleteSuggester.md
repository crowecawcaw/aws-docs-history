...
Deletes a suggester. For more information, see [Getting Search Suggestions](getting-suggestions.md "getting-suggestions.md") in the *Amazon CloudSearch Developer Guide*.
