...
| fields        | A collection of one or more *field\_name<br>• properties that define the fields the document contains.<br>Condition: Required for add operations. Must contain at least one *field\_name<br>• property.                                                                                                                                                                                                                                                                                                                                                                     | Conditional |
