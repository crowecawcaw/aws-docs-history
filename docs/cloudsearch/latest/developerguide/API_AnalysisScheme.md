...
Type: 
 [AnalysisOptions](API_AnalysisOptions.md "API_AnalysisOptions.md")
...
An [IETF RFC 4646](http://tools.ietf.org/html/rfc4646 "http://tools.ietf.org/html/rfc4646") language code or `mul` for multiple languages.
