...
| `IndexUtilization` | The percentage of the search instance's index capacity that has been used. The Maximum value indicates the percentage of the domain's index capacity that has been used.<br />Units: Percent<br />Valid statistics: Average, Maximum | 
