...
Quick authors can use _custom time zones_ to help
...
- Quick authors can choose only one time zone for an analysis.
...
- Quick readers can't change the time zone of a
  dashboard.
...
- Quick authors can choose only one week start day for an
...
- Quick readers can't change the week start day of a
  dashboard.
