...
For more information on Amazon Quick ARNs, see [ARN
formats](../../../quicksight/latest/APIReference/qs-arn-format.md "../../../quicksight/latest/APIReference/qs-arn-format.md") in the _Quick API
