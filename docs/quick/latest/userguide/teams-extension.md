...
@Amazon Quick in conversations to access company knowledge, use configured action
...
- The Amazon Quick customer integrating Microsoft Teams must
...
use the Amazon Quick console to manage extension access configurations.
...
2. Add callback URLs for each Region in which your Teams extension will be installed.
   ...
   3. Choose **Web**.
   4. Compose a callback URL using the following format, replacing `your-region` with your Amazon Quick instance Region. The Teams extension supports the following Regions: `ap-southeast-2`, `eu-west-1`, `us-west-2`, and `us-east-1`.
...
This is a one-time setup that establishes a trusted identity source for all extensions. Once completed, you won't need to do this again for other extension accesses. 7. Select **Microsoft Teams**. Then, choose **Next**. 8. Configure the following fields:
...
Amazon Quick extension within your Microsoft Teams
environment.
