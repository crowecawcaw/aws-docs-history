...
don't have an AWS account, see [Complete initial configuration tasks](../../../quicksuite/latest/userguide/setting-up.md "../../../quicksuite/latest/userguide/setting-up.md"). The person who
signs up for Quick needs to have the correct AWS Identity and Access Management (IAM) permissions.
For more information, see [IAM policy examples for Quick](../../../quicksight/latest/user/iam-policy-examples.md "../../../quicksight/latest/user/iam-policy-examples.md").
...
1. Sign in to your AWS account and open Quick from the AWS Management Console.
   You can find it under **Analytics** or by searching for
   _Quick_.

Your AWS account number is displayed for verification purposes. 2. Enter a unique account name for Quick.

    * Enter a notification email address for the Quick account
