...
Amazon Quick supports multiple authentication methods for Google Slides.
...
authentication, skip this section and see [Setting up the connector in Amazon Quick](#google-slides-quicksuite-setup "#google-slides-quicksuite-setup").
...
3. Find and choose **Google Slides**.

###### Note

If a Google Slides connector already exists, a dialog
    ...
    2. For **Custom OAuth app**,
     configure the following fields:
    	...
    	* **Base URL** (Optional) – The
    	 Google Slides API base URL. For example:
...
The actions that you can use depend on the presentations
...
- **Google Slides API not
  enabled** – Verify that the Google Slides API
