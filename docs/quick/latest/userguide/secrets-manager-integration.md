...
**Topics**
+ [Granting Amazon Quick access to Secrets Manager and selected secrets](#secrets-manager-integration-select-secrets)
+ [Creating or updating a data source with secret credentials using the Amazon Quick API](#secrets-manager-integration-api)
+ [What's in the secret](#secrets-manager-integration-whats-in-secret)
+ [Modify a secret](#secrets-manager-integration-modifying)
