...
Depending on your organization's settings, sharing may require approval review. For more information, see [Approval review](approval-review.md "approval-review.md").

## How to share a flow

1. Open your flow.
2. Choose **Share**.
3. Select how you want to share: with individuals, groups, or everyone.
4. For individuals, enter email addresses. For groups, search for and select the group.
5. Choose the permission level: **Viewer** or **Co-owner**.
6. Choose **Share**.
