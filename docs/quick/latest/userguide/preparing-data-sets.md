...
**Topics**
+ [Preparing a dataset based on file data](prepare-file-data.md)
+ [Preparing a dataset based on Salesforce data](prepare-salesforce-data.md)
+ [Preparing a dataset based on database data](prepare-database-data.md)