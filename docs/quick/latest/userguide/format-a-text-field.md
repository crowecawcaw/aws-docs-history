...
When you format a text field, you can choose how to display null values
using the **Field list** pane, an on-visual editor, or a
visual field well.
...
1. Choose one of the following options:
   ...
   - On any visual that contains an on-visual editor associated
     with the percent field that you want to format, choose that
...
The **Format data** pane opens. 3. Expand the **Null values** section and choose
