...
In Enterprise edition, Amazon Quick provides a way for you to set up detailed access
to resources in AWS services. Like every other AWS service, Quick uses
...
For information about creating IAM policies to use with Quick, see [Identity and access
management in Quick](../../../quicksight/latest/user/identity.md "../../../quicksight/latest/user/identity.md").
...
to the user or group. You can assign multiple IAM policies to one Amazon Quick
user or group. To determine permissions, Amazon Quick performs a union and an
...
steps are saved.
    ...
    Choose one of the following.
    	...
    	* For **Assign to all users and groups**,
    	 ...
    	 Amazon Quick users and groups. Choosing this option assigns the
