...
team channels, managing emails, or creating documents, Quick extensions bring
AI-powered assistance directly into your existing workflows without requiring you to switch
between applications.

The following extension types are available:

- **Browser Extension** - Enhance your web browsing
...
- **Microsoft Teams extension** -
  ...
  configured data sources to provide relevant, accurate responses based on your permissions
  and access levels.
