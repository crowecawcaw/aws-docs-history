...
![Table showing Billed Amount and minOver values grouped by Customer Region and Service Line.](https://docs.aws.amazon.com/quick/latest/userguide/images/minOver.png)
