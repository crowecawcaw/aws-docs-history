...
| Other  | Success <br />Success foreground | These colors are used for success messages, for example the check mark for a successful download. | 
...
| Other  | Dimension <br />Dimension foreground | These colors are used for the names of fields that are identified as dimensions. This option also sets the color for dimensions in the filter panel of embedded dashboards. | 
| Other  | Measure <br />Measure foreground | These colors are used for the names of fields that are identified as measures. These colors also apply to measures in the filter panel of embedded dashboards. | 
