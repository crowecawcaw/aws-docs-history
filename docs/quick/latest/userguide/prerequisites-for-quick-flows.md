...
- Set up and configure Quick for your organization.
- (Optional) Restrict access to flows for select users using custom permissions.

For information about how to set up Quick, see [Setting up and signing into Amazon Quick](setting-up.md "setting-up.md").
...
Quick Flows is available in all four regions with Quick:
