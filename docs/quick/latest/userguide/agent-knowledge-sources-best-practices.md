...
Amazon Quick provides three distinct methods for configuring chat agent behavior,
...
- **Persona instructions** – High-level
  guidance that Amazon Quick enhances using generative
  AI
...
- **Spaces** – Collections of searchable
  Amazon Quick resources and documents from which chat agents retrieve
...
direction. When you use persona instructions, Amazon Quick uses generative
...
Amazon Quick preserves precise wording and specific instructions, maintains
...
Amazon Quick extracts text from these documents and applies a 100K character
...
spaces to chat agents, Amazon Quick chat agents look for answers within the
...
Amazon Quick's permission system.
