...
recommend using the new [Amazon Quick Microsoft Outlook extension (Preview)](outlook-extension-preview.md "outlook-extension-preview.md") for new deployments.
...
Quick capabilities within Outlook to enhance their email
...
- The Amazon Quick customer integrating Microsoft Outlook
...
environment. You can use the Amazon Quick console to manage extension access
configurations.
...
- **Amazon Quick user attribute** - Email address is
  used to map Amazon Quick users to their corresponding Microsoft
...
After completing these Entra ID-specific steps, proceed to the [Complete AWS Configuration (all providers)](#complete-aws-config-outlook "#complete-aws-config-outlook") section below.
...
2. Add callback URIs for each Region in which your Outlook extension will be installed
   1. Compose a callback URI using the following format, replacing `your-region` with your Amazon Quick instance Region for each region where you wish to configure the extension. The Outlook extension supports the following Regions: `ap-southeast-2`, `eu-west-1`, `us-west-2`, and `us-east-1`.
...
After completing these Okta-specific steps, proceed to the [Complete AWS Configuration (all providers)](#complete-aws-config-outlook "#complete-aws-config-outlook") section below.
...
Now you can follow these steps to create a new extension access configuration that will allow Amazon Quick to integrate with your Microsoft Outlook environment:
...
This is a one-time setup that establishes a trusted identity source for all extensions. Once completed, you won't need to do this again for other extension accesses. 7. Select **Microsoft Outlook**. Then, choose **Next**. 8. Configure the following fields:
...
Once created, this extension access configuration enables authors and other admin in your organization to create and deploy Amazon Quick extensions within your Microsoft Outlook environment.
...
admin in your organization to create and deploy Amazon Quick extensions within
...
use Amazon Quick to enhance their email workflows with AI-powered assistance for
