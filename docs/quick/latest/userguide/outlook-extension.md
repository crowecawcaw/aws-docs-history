...
- [Prerequisites for deploying the Microsoft Outlook extension to your organization](#outlook-prerequisites "#outlook-prerequisites")
- [Microsoft Outlook extension permissions](#outlook-permissions "#outlook-permissions")
- [Deploying the Microsoft Outlook extension to your organization](#outlook-deployment "#outlook-deployment")
...
3. Grant tenant-wide admin consent for Microsoft Graph
   ...
   thread. For instructions, see [Grant tenant-wide admin consent](#outlook-grant-admin-consent "#outlook-grant-admin-consent").
...
[Grant tenant-wide admin consent](#outlook-grant-admin-consent "#outlook-grant-admin-consent")).
