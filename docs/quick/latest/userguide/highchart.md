...
![Bar chart comparing current year sales in blue to prior year sales in dark gray across ten industries.](https://docs.aws.amazon.com/quick/latest/userguide/images/highcharts-example1.png)
