...
can access Quick capabilities within Word to enhance their
...
- The Amazon Quick customer integrating Microsoft Word must
  have a paid Word organization with an
  _M365 subscription for their
  organization_.
- Amazon Quick does not use user data for service improvement or for
...
experience. You can use the Amazon Quick console to manage extension access
configurations.
...
Now you can follow these steps to create a new extension access configuration that will allow Amazon Quick to integrate with your Microsoft Word environment:
...
This is a one-time setup that establishes a trusted identity source for all extensions. Once completed, you won't need to do this again for other extension accesses. 7. Select **Microsoft Word**. Then, choose **Next**. 8. Configure the following fields:
...
Once created, this extension access configuration enables authors and other admin in your organization to create and deploy Amazon Quick extensions within your Microsoft Word environment.
...
Amazon Quick to enhance their document creation workflows with AI assistance for
