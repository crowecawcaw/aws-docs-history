...
Amazon Quick chat](../../../quicksuite/latest/userguide/using-quick-chat.md "../../../quicksuite/latest/userguide/using-quick-chat.md").
...
- **Custom chat agents** – These chat agents
  ...
  creation capabilities in Amazon Quick, and shared with anyone. Admins can choose
...
Custom chat agents can interact with Amazon Quick resources in the following
ways:
...
Agent permissions in Amazon Quick can be configured in various combinations to meet
