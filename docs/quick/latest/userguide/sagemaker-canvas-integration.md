...
- A Quick account that's integrated with IAM Identity Center. If your
...
1. Log in to Amazon Quick and navigate to the tabular table or pivot table
...
1. Open the Quick console, choose **Data** at
