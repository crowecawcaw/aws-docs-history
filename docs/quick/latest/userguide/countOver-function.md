...
![Table showing countOver results by Customer Region with APAC, EMEA, and US each having a count of 1.](https://docs.aws.amazon.com/quick/latest/userguide/images/countOver1.png)
...
![Field wells interface showing Group by fields and Value field with countOver calculation.](https://docs.aws.amazon.com/quick/latest/userguide/images/countOver2.png)
...
![Table showing countOver values of 1 for Enterprise segment across Billing and HR service lines in APAC, EMEA, and US regions.](https://docs.aws.amazon.com/quick/latest/userguide/images/countOver.png)
