...
1. Under **Troubleshooting**, choose **Download error rows file**. 
   ...
   + **ERROR\_TYPE** – The type or error code for the error that occurred when importing this row. You can look up this error in the [SPICE ingestion error codes](errors-spice-ingestion.md) section that follows this procedure.
   + **COLUMN\_NAME** – The name of the column in your data that caused the error. 
