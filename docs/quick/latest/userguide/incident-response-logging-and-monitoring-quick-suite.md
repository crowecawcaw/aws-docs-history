...
The Amazon Quick analytics system captures detailed usage metrics from chat conversations,
...
just what users are doing, but how effectively they're leveraging Quick to
...
Access to analytics in Amazon Quick is controlled by user roles and permissions to
...
You can access the analytics dashboard from the Amazon Quick console if you have the
...
2. From the left navigation menu, select **Analytics**, and then
   select **Amazon Quick Usage Metrics**.
...
choose from the following preset intervals:
    ...
    * **This week** – This interval
     ...
     relevant for the primary region of the Amazon Quick account.
