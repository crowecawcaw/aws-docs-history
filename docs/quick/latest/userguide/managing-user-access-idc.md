...
**Topics**
+ [Adding users](#add-user-accounts-enterprise)
+ [Managing user access](#view-user-accounts-enterprise)
+ [Deactivating user accounts](#deactivate-user-groups-enterprise)
+ [Changing a user's role](#updating-user-accounts-enterprise)
+ [Deleting Enterprise accounts](#delete-a-user-account-enterprise)
...
1. Choose your user name on the application bar and then choose **Manage Account**.
...
Removing a user affects billing for the current billing period. For how billing works when you remove a user, see [Understanding Amazon Quick user billing](understanding-quick-user-billing.md).