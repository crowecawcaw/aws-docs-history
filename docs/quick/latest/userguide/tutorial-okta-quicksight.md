...
federation service for Amazon Quick. Although this tutorial shows the integration of
...
5. Choose **Add** to create an instance of this
   application.
6. For **Application label**, enter `AWS Account Federation - Amazon Quick`.
7. Choose **Next**.
...
![](/images/quick/latest/userguide/images/checkbox-on.png)
...
To add a Amazon Quick user, use [register-user](../../../quicksight/latest/APIReference/API_RegisterUser.md "../../../quicksight/latest/APIReference/API_RegisterUser.md"). To add a Amazon Quick group, use [create-group](../../../quicksight/latest/APIReference/API_CreateGroup.md "../../../quicksight/latest/APIReference/API_CreateGroup.md"). To add users to the Amazon Quick group, use [create-group-membership](../../../quicksight/latest/APIReference/API_CreateGroupMembership.md "../../../quicksight/latest/APIReference/API_CreateGroupMembership.md"). 16. (Optional) For **Search**, enter
...
Do this step if you want to provision Amazon Quick users automatically, rather
than using the Amazon Quick API.
...
users. A Amazon Quick administrator can later upgrade them from the Amazon Quick
profile menu, **Manage Amazon Quick**, **Manage
...
you authorize Amazon Quick to forward authorizations requests to the IdP on behalf of
your users. Using this method, users can sign in to Amazon Quick with no need to sign in
using the IdP page first.

###### (Optional) To set up Amazon Quick to send authentication requests to Okta

1. Open Amazon Quick, and choose **Manage Amazon Quick** from
   your profile menu.
...
5. Do one of the following:
   ...
   - To test signing in with Amazon Quick first, use the custom URL
     ...
     authenticate. If `enable-sso=0`, Amazon Quick doesn't send
     the authentication request, and you sign in to Amazon Quick as
     before.

6. For **Status**, choose **ON**.
7. Choose **Save** to keep your settings.
   You can create a deep link to a Amazon Quick dashboard to allow users to use IAM
...
2. Take the value of the IAM federation URL and append
   `?RelayState=` followed by the URL of your Amazon Quick
...
3. To the new IAM federation with the relay state added, append the URL of your
   Amazon Quick dashboard. The resulting URL should resemble the following.
