...
Connector-level settings| Setting | Behavior |
| --- | --- |
...
User-level settings| Setting | Behavior |
| --- | --- |
...
Default behavior by action type| Action type | Connector-level default | User-level default | User-changeable |
| --- | --- | --- | --- |
