...
Use the search bar to find flows by name or description. For each flow, the context menu lets you open, duplicate, or delete it. Choose **Create flow** to start building a new flow. For more information, see [Creating flows](creating-flows.md "creating-flows.md").
