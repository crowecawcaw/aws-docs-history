...
![The maximum sales value for each region.](https://docs.aws.amazon.com/quick/latest/userguide/images/min-max-median-function-example.png)
...
![The maximum sales value in each country.](https://docs.aws.amazon.com/quick/latest/userguide/images/max-function-example2.png)
