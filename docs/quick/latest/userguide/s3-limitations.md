...
When using Amazon S3 integrations in Amazon Quick, be aware of the following
limitations:
...
- Document metadata file maximum size: 5 MB.
  For more information about document-level ACL limitations, see
  [Limitations](acl-best-practices-kb.md#acl-limitations "acl-best-practices-kb.md#acl-limitations").
