...
1. (Optional) For tabular pivot tables, you can also add group names to subtotals. To add a group name to row subtotals, choose the **Plus (\+)** icon next to the **Label** field to add the group name parameter that you want. You can also enter a word or short phrase to this field.
