...
| Sorting                                                                       | Yes, with exceptions | You can sort data for numeric measures in the **X<br>axis\*<br>• and **Value\*<br>• field wells.<br>Other data is automatically sorted in ascending order.                                                                                                                                                                                                                        | [Sorting visual data in Amazon Quick](sorting-visual-data.md "sorting-visual-data.md")                                                                                                     |
