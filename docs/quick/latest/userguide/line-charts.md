...
| Changing the axis range                                                       | Yes                  | You can set the range for the Y axis.                                                                                                                                                                                                                                                                                                                                             | [Range and scale on visual types in<br>Quick](changing-visual-scale-axis-range.md "changing-visual-scale-axis-range.md")                                                                      |
