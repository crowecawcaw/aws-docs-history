...
| Suported in Quick console embedding                               | No            | Yes                 |
...
Quick allows any user to ask questions on dashboards that have dashboard
Q&A enabled. However, dashboard Q&A is a feature that incurs the associated
enablement fee. Quick admins can disable this feature at the account level
at any time. Use the following procedure to disable dashboard Q&A across an entire
Quick account.

1. Open the [Quick console](https://quicksight.aws.amazon.com/ "https://quicksight.aws.amazon.com/").
2. Choose the user icon in the top right, and then choose **Manage Quick**.
...
5. Toggle **Manage Dashboard Q&A** off.
   ...
   Quick account does not have Pro users or topics, this action stops the Amazon Q
   enablement fee from billing your Quick account. This setting does not impact
   Pro users or existing topics in Quick. For more information about opting out
