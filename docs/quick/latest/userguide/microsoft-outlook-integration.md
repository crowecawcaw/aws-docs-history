...
If you are using **Default OAuth app** authentication, skip this section and proceed to [Setting up the connector in Amazon Quick](#exchange-integration-setup).
...
<a name="outlook-quick-connect"></a>
...
1. On the **Available** tab, find **Microsoft Outlook** and choose **Connect**.
...
1. Find and choose **Microsoft Outlook**.
**Note**  
...
1. If you chose **Default OAuth app** or **Custom OAuth app**, a Microsoft authorization window opens. Review the requested permissions and choose **Accept**.
   ...
   If you see an error instead of the consent dialog, your organization might restrict third-party app access. See [Admin consent for Microsoft 365](#exchange-admin-consent).
...
<a name="exchange-admin-consent"></a>
