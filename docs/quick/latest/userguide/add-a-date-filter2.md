...
the timestamp differently than you expect. Amazon Quick and [SPICE](spice.md "spice.md") both use Universal Coordinated Time (UTC)
times.
...
more information, see [Parameters in Amazon Quick](parameters-in-quicksight.md "parameters-in-quicksight.md"). 7. For **Null options** choose **Exclude
...
To use parameters in a filter, create them first. Usually, you create
a parameter, add a control for it, and then add a filter for it. For
more information, see [Parameters in Amazon Quick](parameters-in-quicksight.md "parameters-in-quicksight.md"). 9. When finished, choose **Apply**.
