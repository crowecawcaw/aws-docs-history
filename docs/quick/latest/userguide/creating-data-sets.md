...
**Topics**
+ [Creating datasets using new data sources](creating-data-sets-new.md)
+ [Creating a dataset using an existing data source](create-a-data-set-existing.md)
+ [Creating a dataset using an existing dataset in Amazon Quick](create-a-dataset-existing-dataset.md)