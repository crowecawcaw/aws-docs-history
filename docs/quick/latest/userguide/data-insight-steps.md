...
The system searches across indexed documents in your spaces, including knowledge bases from connected sources. For more information about setting up spaces and knowledge bases, see [Working with integrations](working-with-integrations.md "working-with-integrations.md").

For configuration instructions, see [Editing flows](editing-flows.md "editing-flows.md").
