...
To fit the pixel perfect report to your screen, open the **View** menu at upper right and select **Fit to window**. You can also zoom in and out using the plus (\+) and minus (-) icons on the top left corner of the report.