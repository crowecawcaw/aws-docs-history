...
With the Google Analytics connector, you can access Google Analytics directly in Amazon Quick through natural language. You can run reports, retrieve audience data, monitor key events, and access real-time metrics without leaving Amazon Quick.
...
## Before you begin
<a name="google-analytics-integration-prerequisites"></a>
...
<a name="google-analytics-source-setup"></a>

If you are using **Default OAuth app** authentication, skip this section and go to [Setting up the connector in Amazon Quick](#google-analytics-quicksuite-setup).
...
### Recommended scopes
<a name="google-analytics-oauth-scopes"></a>

The following scopes are requested when you connect to Google Analytics.


**Google Analytics recommended scopes**  
...
<a name="google-analytics-quicksuite-setup"></a>

### Connect from the Available tab
<a name="google-analytics-quick-connect"></a>
...
1. On the **Available** tab, find **Google Analytics** and choose **Connect**.
...
<a name="google-analytics-full-setup"></a>
...
1. Find and choose **Google Analytics**.
**Note**  
...
1. For **OAuth Configuration**, choose one of the following authentication methods and configure the required fields.
   ...
   1. For **Custom OAuth app**, configure the following fields:
      + **Base URL** (Optional) – The Google Analytics API base URL. Example: `https://analyticsdata.googleapis.com`
...
## Available actions
<a name="google-analytics-integration-actions"></a>

After you set up the connector, the following actions are available.


**Google Analytics available actions**  
...
<a name="google-analytics-integration-troubleshooting"></a>
...
<a name="google-analytics-troubleshooting-service"></a>
