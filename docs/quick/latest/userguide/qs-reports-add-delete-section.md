...
1. Choose the **ADD** (\+) icon in the top left corner, and choose **Add section**.

You can also add a section by choosing the plus (\+) icon at the bottom of an existing section and choosing **Add section**.
