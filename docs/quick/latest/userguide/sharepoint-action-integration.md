...
Use the Microsoft SharePoint connector to manage lists, items, files, and Excel workbooks directly in Amazon Quick through natural language.
...
If you are using **Default OAuth app** authentication, skip this section and proceed to [Setting up the connector in Amazon Quick](#sharepoint-action-integration-setup).
...
1. On the **Available** tab, find **SharePoint** and choose **Connect**.
...
1. Find and choose **Microsoft SharePoint**.
**Note**  
...
1. On the **Integration type** page, select **Perform actions in Microsoft SharePoint Online** and choose **Next**.
...
1. If you chose **Default OAuth app** or **Custom OAuth app**, a Microsoft authorization window opens. Review the requested permissions and choose **Accept**.
   ...
   If you see an error instead of the consent dialog, your organization might restrict third-party app access. See [Admin consent for Microsoft 365](#sharepoint-action-admin-consent).
