...
As a Quick author, you can choose the language formatting that best fits
your audience. Amazon Quick configures numeric data languages at the analysis level
based on the language that you have chosen to view Quick in. You can change
the format of numbers, currencies, and dates. You can change your Quick
language settings in the **Language** dropdown list of the
Quick **User** menu in the top-right corner. You can change
