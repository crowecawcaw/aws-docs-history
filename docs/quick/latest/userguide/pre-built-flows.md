...
2. Choose **Duplicate** to create your own copy.
3. Open the duplicated flow in the Flow editor.
4. Modify the steps, prompts, and configuration as needed.
5. Save your customized flow.

For more information about editing flows, see [Editing flows](editing-flows.md "editing-flows.md").
