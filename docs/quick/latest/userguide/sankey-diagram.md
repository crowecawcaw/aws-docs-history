...
| Focusing on or excluding elements | Yes | [Focusing on visual elements](focusing-on-visual-elements.md)<br />[Excluding visual elements](excluding-visual-elements.md) | 
| Sorting | No |  | 
