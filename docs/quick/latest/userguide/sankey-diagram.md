...
To create Sankey diagrams in Quick, your dataset should contain a
...
To create multilevel Sankey diagrams in Amazon Quick, your dataset should still
...
Quick. For example, if your data contains the flow A-E-A-B-A-E-A,
...
demonstrate how to prepare your data for Sankey diagrams in Quick. The
...
To create a Sankey diagram in Quick using this data, first add Source
...
custom SQL in Quick to order the rows in the Step Number column.
For more information about using custom SQL in Quick, see [Using SQL to customize data](adding-a-SQL-query.md "adding-a-SQL-query.md").
...
Quick supports up to 100 Source/Destination
nodes.
