# Cross-region inference in Amazon Quick integrations

With cross-region inference, Amazon Quick automatically selects the optimal region within your geography to process your inference requests, maximizing available compute resources and model availability, and providing the best customer experience. With cross-region inference, you get:
...
## Supported regions for Amazon Quick cross-region inference

| Supported Amazon Quick Cross-Region Inference Regions | Supported Amazon Quick geography                                                                                                                                                                                                                                                                                                               | Inference regions |
| ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
