...
# Getting started
<a name="getting-started-quick-automate"></a>
...
## Key capabilities
<a name="automate-key-capabilities"></a>
...
<a name="automate-setup-groups"></a>
...
### Setup user roles
<a name="automate-setup-user-roles"></a>
...
<a name="automate-configure-integrations"></a>
+ After setting up AWS service integrations, you can begin using them in Quick Automate. See [Connectors](action-integrations.md) for setup details.
...
#### Setup instructions
<a name="automate-vpc-setup-instructions"></a>
...
### Create project
<a name="automate-create-project"></a>
...
1. Fill in the project details in the Provide project details section:
...
1. Click **Next: Business case** to proceed to the business case section.

#### Defining the business case (Section is optional)
<a name="automate-defining-business-case"></a>
