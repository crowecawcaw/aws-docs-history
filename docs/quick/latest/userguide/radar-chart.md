...
| Sorting                           | Limited       | You can only sort data fields that are in the<br>*_Category_<br>• and **Color**<br>field wells. | [Sorting visual data in Amazon Quick](sorting-visual-data.md "sorting-visual-data.md")                                                                                                     |
