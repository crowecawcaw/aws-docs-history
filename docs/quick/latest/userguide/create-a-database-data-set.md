...
3. Make sure that you have configured the cluster or instance for Amazon Quick
...
4. On the Amazon Quick start page, choose **Data**.
...
Amazon Quick automatically secures connections to Amazon RDS instances and
...
3. Make sure that you have configured the cluster or instance for Amazon Quick
   access by following the instructions in [Network and database configuration requirements](configure-access.md "configure-access.md").
4. On the Amazon Quick start page, choose **Manage
   data**.
...
7. Enter the connection information for the data source, as
   ...
   - For **Database server**, enter one of the
     ...
     - For a non-Amazon EC2 instance of MariaDB, Microsoft SQL
       ...
       [Amazon Quick SSL and CA certificates](configure-access.md#ca-certificates "configure-access.md#ca-certificates").
...
system. Amazon Quick doesn't accept self-signed SSL certificates as valid. For
a list of accepted certificates, see [Amazon Quick SSL and CA certificates](configure-access.md#ca-certificates "configure-access.md#ca-certificates").

Amazon Quick automatically secures connections to Amazon Redshift clusters by using SSL.
