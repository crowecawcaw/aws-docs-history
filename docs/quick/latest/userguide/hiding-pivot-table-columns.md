...
pivot table without changing the pivot table values. When you have more than one
measure in the pivot table, you can also hide values.

At any time, you can choose to show any hidden fields in the pivot table. When you
...
1. In your analysis, select the pivot table visual that you want to work
   with.
2. Choose the three-dot menu in the **Rows**,
   **Columns** or **Values** field wells,
...
1. In your analysis, select the pivot table visual that you want to work
   with.
2. Choose any field in the **Fields well** and choose
