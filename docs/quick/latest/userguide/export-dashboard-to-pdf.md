...
appears on-screen at the time of download.
...
3. At upper right, choose **Export**, **Download as
   PDF**. The download is prepared in the background.

When the file is ready to download, a message appears saying **Your
PDF is ready.**. 4. Choose **Download now** to download the file. Choose
**Close** to close without downloading.

If you close this dialog box without downloading the file and want to recreate
the file, repeat the previous step. Also, the downloadable file is available
