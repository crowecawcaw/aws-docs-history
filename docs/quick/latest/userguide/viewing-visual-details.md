...
![Tooltip displaying Billing section with US currency amount 9,330,832.51 when hovering over bar chart.](https://docs.aws.amazon.com/quick/latest/userguide/images/bar-detail.png)


Hovering your cursor over a single data point on a scatter plot also displays information about that specific data point.

![Scatter plot tooltip showing Age Range 35-44 with Sales Amount Sum and Discount Amount Sum values.](https://docs.aws.amazon.com/quick/latest/userguide/images/scatter-plot-detail.png)
