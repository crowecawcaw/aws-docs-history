...
Quick VPC connection, use the following procedure.
...
Amazon Quick](../../../quicksight/latest/user/vpc-setup-for-quicksight.md "../../../quicksight/latest/user/vpc-setup-for-quicksight.md"). 4. Enter the connection information for the data source. The fields for the data
...
you choose. For more information, see [Creating a data source](../../../quicksight/latest/user/create-a-data-source.md "../../../quicksight/latest/user/create-a-data-source.md").
    ...
    * For **Connection Type**, choose the name of the VPC
     ...
     missing from the list, ask a Amazon Quick administrator to verify that
     the VPC connection is correct in Amazon Quick. If it looks correct, ask
    ...
    * For **Credentials**, enter a username and password to
     use for everyone who connects from Amazon Quick using this data source.
