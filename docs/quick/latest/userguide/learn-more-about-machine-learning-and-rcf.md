...
+ [*Random Cut Forest Based Anomaly Detection On Streams*](http://proceedings.mlr.press/v48/guha16.pdf), a scholarly paper that dives deep into the technicalities of both anomaly detection and forecasting, with examples. 
...
+ *Amazon Managed Service for Apache Flink SQL Reference: *[RANDOM\_CUT\_FOREST](https://docs.aws.amazon.com/kinesisanalytics/latest/sqlref/sqlrf-random-cut-forest.html) and [RANDOM\_CUT\_FOREST\_WITH\_EXPLANATION](https://docs.aws.amazon.com/kinesisanalytics/latest/sqlref/sqlrf-random-cut-forest-with-explanation.html)
