...
![Dataset page with Generate analysis button](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-1.png)
...
![Add additional datasets](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-2a.png)  
![Add additional datasets](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-2b.png)
...
![Prompt input screen with example](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-3.png)
...
![Streaming progress screen showing steps completing](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-4.png)
**Note**  
...
![Generations tab to check status](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-5.png)
...
![Two-pane plan view with context on left, outline details on right](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-6.png)
...
![Generation progress showing sheets being created one by one](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-7.png)

![Completed analysis with multiple sheets and visuals](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-8.gif)
...
![Publish and share dialog](https://docs.aws.amazon.com/quick/latest/userguide/images/visualize-data-figure-9.gif)
