...
Quick authors upload GeoJSON files to Amazon Quick that shape layers over a
base map and join with Quick data to visualize associated metrics and
dimensions. Shape layers can be styled by color, border, and opacity. Quick
...
2. Open the Quick analysis that you want to add a layer map
   to.
