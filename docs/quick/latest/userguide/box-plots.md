...
To understand the features supported by box plots, see [Analytics formatting per type in Quick](analytics-format-options.md "analytics-format-options.md"). For customization options, see [Formatting in Amazon Quick](formatting-a-visual.md "formatting-a-visual.md").
