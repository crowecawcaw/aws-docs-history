...
**Topics**
+ [Configuring email report settings for a Quick Sight dashboard](email-reports-from-dashboard.md)
+ [How billing works for email reports](sending-reports-billing-info.md)