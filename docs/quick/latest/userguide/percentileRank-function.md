...
![Table showing Billed Amount and Percentile by Customer Region for APAC, EMEA, and US.](https://docs.aws.amazon.com/quick/latest/userguide/images/percentileRank.png)
