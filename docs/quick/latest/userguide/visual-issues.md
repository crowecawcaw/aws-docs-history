...
**Topics**
+ [I can't see my visuals](troubleshoot-adding-visuals.md)
+ [I get a feedback bar across my printed documents](troubleshoot-printing-docs.md)
+ [My map charts don't show locations](troubleshoot-geocoding.md)
+ [My pivot table stops working](troubleshoot-pivot-tables.md)
+ [My visual can’t find missing columns](troubleshooting-dataset-changed-columns.md)
