...
1. All browser actions must be placed within a browser session scope
2. Each browser scope is a browser session. Browser automatically closes when actions inside a scope completes.
