...
In this section, you can find a list of the functions available in Amazon Quick,
sorted by category.
...
The aggregate functions for calculated fields in Amazon Quick include the
...
The conditional functions for calculated fields in Amazon Quick include the
following:
...
The date functions for calculated fields in Amazon Quick include the
following:
...
The numeric functions for calculated fields in Amazon Quick include the
following:
...
The mathematical functions for calculated fields in Amazon Quick include the
following:
...
The string (text) functions for calculated fields in Amazon Quick include the
following:
