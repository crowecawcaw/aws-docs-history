...
| ----------------------------------------------------------------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Changing the legend display                                                   | Yes, with exceptions | Scatter plots display a legend if you have the<br>\*_Group/Color_<br>• field well populated.                                                                                                                                                                                                       | [Legends on visual types in<br>Quick](customizing-visual-legend.md "customizing-visual-legend.md")                                                                                            |
...
| Changing the axis range                                                       | Yes                  | You can set the range for both the X and Y axes.                                                                                                                                                                                                                                                   | [Range and scale on visual types in<br>Quick](changing-visual-scale-axis-range.md "changing-visual-scale-axis-range.md")                                                                      |
