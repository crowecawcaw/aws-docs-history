...
Nested filters are advanced filters that can be added to a Quick analysis.
...
8. For **Nested filter type**, choose the filter type that you
   ...
   - [Custom filter](../../../quicksuite/latest/userguide/add-text-filter-custom-list-data-prep.md "../../../quicksuite/latest/userguide/add-text-filter-custom-list-data-prep.md")
