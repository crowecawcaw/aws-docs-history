...
| **UPDATE\_FAILED**                       | The security group associated with the network interface did not<br>update successfully.                                                               |
...
| **ATTACHMENT\_FAILED\_ROLLBACK\_FAILED** | The elastic interface failed to attach and Amazon Quick was unable<br>to delete the elastic network interface that was created within your<br>account. |
