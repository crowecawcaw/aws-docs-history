...
If your end users are signing in to Amazon Quick using AWS root (not recommended),
AWS Identity and Access Management (IAM), corporate Active Directory, or native Quick credentials, make
sure to allow-list the following domains within your organization's network.

| User type                                                                     | Domain or domains to allow-list          |
| ----------------------------------------------------------------------------- | ---------------------------------------- |
| Users who sign in directly through Amazon Quick and Active Directory<br>users | `signin.aws` and `awsapps.com`           |
