...
Amazon Quick sends metrics to Amazon CloudWatch that you can use to observe and respond to
the availability and performance of your Amazon Quick environment in near real time.
...
Quick. For more information, see [Graphing
...
Quick assets. When the metric reaches a threshold that you specify,
...
metrics for monitoring traffic and latency of your Amazon Quick assets.
...
The `AWS/QuickSight` namespace includes the following
aggregate metrics for monitoring traffic and latency of your Amazon Quick assets.
...
information to better understand the consumption trends of your Amazon Quick account.
...
Following is a list of Quick metric dimensions that appear in
Amazon CloudWatch.

| Dimension           | Description                                                                                                                                                                                                                                                                                                                                                                                |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| DashboardId         | The public ID of a Amazon Quick Sight dashboard.<br>You can use the `ListDashboards` API operation<br>to see a list of every dashboard in your Amazon Quick<br>account. For more information, see [ListDashboards](../../../quicksight/latest/developerguide/list-dashboards.md "../../../quicksight/latest/developerguide/list-dashboards.md") in the _Amazon Quick Sight API Reference_. |
