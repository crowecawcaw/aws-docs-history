...
**Topics**
+ [Enabling the `SharedView` feature configuration for Amazon Quick Sight embedded analytics](embedded-view-sharing-set-up.md)
+ [Creating a shared view with the Amazon Quick Sight `createSharedView` API](embedded-view-sharing-sdk-create.md)
+ [Consuming a shared Amazon Quick Sight view](embedded-view-sharing-sdk-consume.md)