...
![Image of the Format visual pane with a parameter in the chart title and a chart with the parameter value in the title circled in red.](https://docs.aws.amazon.com/quick/latest/userguide/images/parameters-in-titles-labels2.png)
