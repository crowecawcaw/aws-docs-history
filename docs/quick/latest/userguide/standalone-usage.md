...
<a name="standalone-usage-how-limits-work"></a>

Your usage is governed by two limits that work together: a monthly limit and a session limit.
+ **Monthly limit** – The total amount of work you can do with Quick in a billing month. This limit resets at the start of each billing cycle.
+ **Session limit** – A shorter, rolling window that limits activity in any single stretch. The session limit is a percentage of your monthly limit. It refreshes continuously as time passes, so you no longer need to wait until the next billing month. When you reach a session limit, Quick pauses your session briefly. It does not block you for the rest of the month.

**Note**  
Reaching a session limit is temporary. It clears on its own as the rolling window moves forward, so you can keep working after a short pause.

Quick measures your usage by the length and complexity of your work, the features you use, the model selected, and the thinking level. Heavier tasks use more; lighter tasks use less. Because usage depends on these factors, the same activity can consume different amounts on different days.
...
If you need more usage, you can enable additional usage and set a maximum monthly limit—a spend cap that you control.
+ **You control the cost** – You only pay for what you actually use, up to the cap you set. The cap is a ceiling, not a charge.
+ **What changes** – Once enabled, your monthly capacity expands up to your cap, and your session windows adjust accordingly, so you're less likely to be paused mid-task.

**To enable additional usage**

1. In Amazon Quick, from the navigation bar, choose your username, and then choose **Manage account**.

1. Enable additional usage.
...
Use the following practices to make your usage go further before you need to enable additional usage:
