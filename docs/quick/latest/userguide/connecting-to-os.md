...
1. Open the menu by clicking on your profile icon at top right, then choose
   **Manage Quick**. If you don't see the
   **Manage Quick** option on your profile
   menu, ask your Amazon Quick administrator for assistance.
...
4. For **Connection type**, choose the network you want to
   ...
   VPC IDs. These names are defined by the Quick administrator.
