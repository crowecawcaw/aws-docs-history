...
2. Go to **Add-Ins** and search for
   **Quick** and choose **Quick**.
3. You will now see the Amazon Quick logo on the top bar on the right
...
1. Locate the Quick icon under **add-ins**
   in your Microsoft ribbon and select the
   **summarize** shortcut.
2. Alternatively, open the Quick side panel and ask any
...
1. Navigate to an email thread of your choice and locate the
   Quick icon under **add-ins** in your
   Microsoft ribbon. Select the
   **reply** or **reply all**
   shortcut.
2. Quick will create a draft response and open a reply window
...
retention periods may exceed Amazon Quick's 30-day limit.

Users can review past conversations and attachments. Closing the
Quick chat panel ends the current conversation. Reopen the panel
...
- The Microsoft Outlook extension is only able to access
  ...
  Microsoft Outlook
  [actions integration](../../../quicksuite/latest/userguide/creating-action-connectors-admin-console.md "../../../quicksuite/latest/userguide/creating-action-connectors-admin-console.md").
...
- You cannot review your conversation history in Microsoft
  ...
  history, use the Amazon Quick chat instance.
- The Microsoft Outlook extension doesn't support [flows](../../../quicksuite/latest/userguide/flows.md "../../../quicksuite/latest/userguide/flows.md").
- The Microsoft Outlook extension supports up to 19
  uploaded files and your current email thread. For more information on
  file upload support, see [Upload files and chat](../../../quicksuite/latest/userguide/using-quick-chat.md#file-uploads "../../../quicksuite/latest/userguide/using-quick-chat.md#file-uploads").
