...
| Sorting                           | No                   | Default sorting is in descending order by the measure in the<br>*_Size_<br>• column.                                                                                                     | [Sorting visual data in Amazon Quick](sorting-visual-data.md "sorting-visual-data.md")                                                                                                     |
