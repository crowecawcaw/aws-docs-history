...
| ----------------------------------------------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Changing the legend display                                                   | Yes, with exceptions | Multi-measure and clustered bar charts display a legend, while<br>single-measure horizontal bar charts don't.                                                                            | [Legends on visual types in<br>Quick](customizing-visual-legend.md "customizing-visual-legend.md")                                                                                            |
...
| Showing data labels                                                           | Yes                  |                                                                                                                                                                                          | [Data labels on visual types in<br>Quick](customizing-visual-data-labels.md "customizing-visual-data-labels.md")                                                                              |
