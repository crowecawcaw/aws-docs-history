...
2. Choose **Publish as a new dashboard** or **Replace existing dashboard**.
...
The dashboard is now published. 7. On the **Share dashboard** page that opens, choose
the **X** icon to close it. You can share the dashboard
later by using the sharing option on the dashboard page.
