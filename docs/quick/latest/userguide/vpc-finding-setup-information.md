...
To gather the information to have ready when you create a VPC connection in Amazon Quick
...
Quick. For each of these, note the database's private IP, security group,
and subnets. Amazon Quick connects to your data using the private IP. However, you don't
need to enter this or the security group or subnet information for the VPC connection.
This information helps you identify the other components you need for the Amazon Quick
VPC connection.
...
the same VPC. Make sure also that you use Quick in the same AWS Region
with the VPC.

You can't use Amazon Quick in one AWS Region and expect to connect to a VPC in a
different AWS Region.

If your team is already using Amazon Quick, you can see your current AWS Region
displayed at the upper right of the Amazon Quick home screen. You can change the
AWS Region you're using in Amazon Quick by changing the Region at the upper right of
the Amazon Quick home screen. All the people who plan to use the data in the VPC must be
using the same AWS Region in Amazon Quick.

###### Note

The AWS Region that displays in the Amazon Quick console doesn't have to match
your AWS CLI configuration. Take care not to mistake your current Amazon Quick console
...
have the Amazon Quick console open in one AWS Region, the Amazon VPC console open in a
...
Amazon Quick creates its Amazon Quick elastic network interface (Amazon Quick network
interface) for the subnets that you choose. The Amazon Quick network interfaces get
