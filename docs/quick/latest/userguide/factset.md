...
2. Create a Quick integration for FactSet.
   ...
   5. For the client ID, provide the client ID you got from FactSet.
   6. For the other authentication-related fields you can use the suggestions visible below each input field.
