...
Before setting up the integration in Amazon Quick, prepare your SAP system
...
list and is available for use in Amazon Quick workflows, automations, and AI agents.
You can perform SAP-specific actions directly from Amazon Quick using the configured
