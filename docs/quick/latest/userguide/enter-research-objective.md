...
You can also reference internal data sources in your objective. For example: "Primarily build research on our internal investment analysis from Document: 'Renewable\_Portfolio\_Performance\_2024.pdf' in Knowledge base: 'Investment Research', which is added in Space: 'Financial Analysis', and Chart: 'Investment Performance Trends' in Dashboard: 'Sustainability Portfolio Dashboard'. Use web research to supplement with recent policy changes, emerging technology costs, and competitor strategies not covered in our internal data." 4. (Optional) Choose the **Research mode** button to select a research mode. The following modes are available:
