...
**Topics**
+ [Editing field names and descriptions](changing-a-field-name.md)
+ [Setting fields as a dimensions or measures](setting-dimension-or-measure.md)
+ [Changing a field data type](changing-a-field-data-type.md)
+ [Adding drill-downs to visual data in Quick Sight](adding-drill-downs.md)
+ [Selecting fields](selecting-fields.md)
+ [Organizing fields into folders in Amazon QuickSight](organizing-fields-folder.md)
+ [Mapping and joining fields](mapping-and-joining-fields.md)