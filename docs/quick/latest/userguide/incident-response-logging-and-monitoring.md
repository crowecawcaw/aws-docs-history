...
| Which API calls occurred for AI features (flows, agents,<br>automations, action connectors) | CloudTrail (management and data events)                      | [Monitoring Amazon Quick using CloudTrail](monitoring-cloudtrail.md "monitoring-cloudtrail.md");<br>[Logging Amazon Quick data events in CloudTrail](monitoring-cloudtrail.md#logging-data-events "monitoring-cloudtrail.md#logging-data-events")                                  |
