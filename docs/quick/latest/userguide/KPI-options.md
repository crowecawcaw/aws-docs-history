...
1. To change the color of the positive value, navigate to **Condition \#1**, choose the **Color** icon, and then choose the color tht you want.

1. To change the color of the negative value, navigate to **Condition \#2**, choose the **Color** icon, and then choose the color tht you want.
