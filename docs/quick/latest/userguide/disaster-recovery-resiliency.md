...
Quick is built by AWS and runs on AWS-managed infrastructure. It takes
full advantage of the high availability features provided by AWS.
...
Because Amazon Quick is an AWS-managed application, all patches and updates are applied
by AWS as needed.
