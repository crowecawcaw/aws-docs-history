...
**Topics**
+ [Managing access for IAM Identity Center users](managing-user-access-idc.md)
+ [Managing access for Amazon Quick and IAM users](managing-user-access-qs-iam.md)