...
**Topics**
+ [Adding calculated fields to an analysis](#using-the-calculated-field-editor-analysis)
+ [Adding calculated fields to a dataset](#using-the-calculated-field-editor)
+ [Handling decimal values in calculated fields](#handling-decimal-fields)
...
1. In the **Data** pane, choose **Add** at top left, and then choose **\+ CALCULATED FIELD**.
...
- **`abs`**
  ...
  - **Input type:** Int / **Output type:** Int
  - **Input type:** Decimal-float / **Output type:** Decimal-float

- **`ceil`**
  - **Input type:** Decimal-fixed / **Output type:** Int
  - **Input type:** Int / **Output type:** Int
  - **Input type:** Decimal-float / **Output type:** Int

- **`exp`**
  - **Input type:** Decimal-fixed / **Output type:** Decimal-float
  - **Input type:** Int / **Output type:** Decimal-float
  - **Input type:** Decimal-float / **Output type:** Decimal-float
...
- **`round`**
  - **Input type:** Decimal-fixed / **Output type:** Decimal-fixed
  - **Input type:** Int / **Output type:** Decimal-fixed
  - **Input type:** Decimal-float / **Output type:** Decimal-fixed
