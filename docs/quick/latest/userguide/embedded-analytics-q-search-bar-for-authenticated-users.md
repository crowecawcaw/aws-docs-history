...
**Topics**
+ [Step 1: Set up permissions](#embedded-q-bar-for-authenticated-users-step-1)
+ [Step 2: Generate the URL with the authentication code attached](#embedded-q-bar-for-authenticated-users-step-2)
+ [Step 3: Embed the Q search bar URL](#embedded-q-bar-for-authenticated-users-step-3)
+ [Optional Amazon Quick Sight Q search bar embedding functionalities](#embedded-q-bar-for-authenticated-users-step-4)
