...
- [Exploring nodes using console filters](view-aggregated-node-details-console.md "view-aggregated-node-details-console.md")
- [Exploring nodes using text prompts in Amazon Q](view-aggregated-node-details-Q.md "view-aggregated-node-details-Q.md")
- [Viewing individual node details and taking action on a node](node-detail-actions.md "node-detail-actions.md")
- [Downloading or exporting a managed node report](explore-nodes-download-report.md "explore-nodes-download-report.md")
- [Managing node report content and appearance](explore-nodes-manage-report-display.md "explore-nodes-manage-report-display.md")
