...
**Topics**
+ [Exploring nodes using console filters](view-aggregated-node-details-console.md)
+ [Exploring nodes using text prompts in Amazon Q](view-aggregated-node-details-Q.md)
