...
Windows Server, macOS, Linux, and Ubuntu Server.

###### Note

To use the Session Manager plugin, you must have AWS CLI version 1.16.12 or later
installed on your local machine. For more information, see [Installing or updating the latest version of the AWS Command Line Interface](../../../cli/latest/userguide/getting-started-install.md "../../../cli/latest/userguide/getting-started-install.md").
