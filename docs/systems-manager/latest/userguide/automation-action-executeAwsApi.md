...
to run. You can view a list of supported AWS service namespaces in [Available services](../../../boto3/latest/reference/services/index.md "../../../boto3/latest/reference/services/index.md") of the
