...
**Topics**
+ [Using the AWS Management Console to create an activation for registering managed nodes with Systems Manager](#create-managed-node-activation-console)
+ [Using the command line to create an activation for registering managed nodes with Systems Manager](#create-managed-node-activation-command-line)
