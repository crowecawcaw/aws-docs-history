...
policies. For more information, see [Sample IAM policies for Session Manager](getting-started-restrict-access-quickstart.md "getting-started-restrict-access-quickstart.md"). For information
...
- [Start a default shell session by specifying the default session document in IAM policies](getting-started-default-session-document.md "getting-started-default-session-document.md")
- [Start a session with a document by specifying the session documents in IAM policies](getting-started-specify-session-document.md "getting-started-specify-session-document.md")
- [Sample IAM policies for Session Manager](getting-started-restrict-access-quickstart.md "getting-started-restrict-access-quickstart.md")
- [Additional sample IAM policies for Session Manager](getting-started-restrict-access-examples.md "getting-started-restrict-access-examples.md")
