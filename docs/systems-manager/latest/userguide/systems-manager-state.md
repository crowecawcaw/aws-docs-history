...
+ [Understanding how State Manager works](state-manager-about.md)
+ [Working with associations in Systems Manager](state-manager-associations.md)
...
+ [Walkthrough: Automatically update SSM Agent with the AWS CLI](state-manager-update-ssm-agent-cli.md)
+ [Walkthrough: Automatically update PV drivers on EC2 instances for Windows Server](state-manager-update-pv-drivers.md)
