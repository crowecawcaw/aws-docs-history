...
Before you install SSM Agent on an Amazon Linux 2 or Amazon Linux 2023 instance, note the
following:
...
are the correct global installation files for Amazon Linux 2 and
Amazon Linux 2023.
