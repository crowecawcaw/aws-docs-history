...
As a managed service, AWS Systems Manager is protected by AWS global network security. For
...
You use AWS published API calls to access Systems Manager through the network. Clients must
