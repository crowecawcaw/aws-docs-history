...
manually. For information, see the troubleshooting topic [Session Manager plugin not automatically added to command line path (Windows)](session-manager-troubleshooting.md#windows-plugin-env-var-not-set "session-manager-troubleshooting.md#windows-plugin-env-var-not-set").
