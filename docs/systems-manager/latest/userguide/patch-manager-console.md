...
3. Do one of the following:
   ...
   - Create a maintenance window that uses the Systems Manager document (SSM
     ...
     more information, see [Tutorial: Create a maintenance window for patching using the console](maintenance-window-tutorial-patching.md "maintenance-window-tutorial-patching.md").
