...
+ [Prerequisites for creating associations that run MOF files](#systems-manager-state-manager-using-mof-file-prereqs)
+ [Creating an association that runs MOF files](#systems-manager-state-manager-using-mof-file-creating)
+ [Troubleshooting issues when creating associations that run MOF files](#systems-manager-state-manager-using-mof-file-troubleshooting)
