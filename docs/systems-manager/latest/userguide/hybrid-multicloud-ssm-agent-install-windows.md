...
You can use the [setupcli\_data\_integrity\_windows.ps1](https://github.com/aws/amazon-ssm-agent/blob/mainline/Tools/src/setupcli_data_integrity_windows.ps1) script to validate the signature of `ssm-setup-cli`.
