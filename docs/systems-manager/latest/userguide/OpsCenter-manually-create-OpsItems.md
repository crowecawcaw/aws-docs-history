...
You can create OpsItems by using the AWS Systems Manager console, the AWS Command Line Interface (AWS CLI), or
AWS Tools for Windows PowerShell.

###### Topics

- [Creating OpsItems manually (console)](OpsCenter-creating-OpsItems-console.md "OpsCenter-creating-OpsItems-console.md")
- [Creating OpsItems manually (AWS CLI)](OpsCenter-creating-OpsItems-CLI.md "OpsCenter-creating-OpsItems-CLI.md")
- [Creating OpsItems manually (PowerShell)](OpsCenter-creating-OpsItems-Powershell.md "OpsCenter-creating-OpsItems-Powershell.md")
