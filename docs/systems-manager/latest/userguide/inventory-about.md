...
Inventory only collects metadata. It doesn't collect any personal or proprietary
data.

###### Topics

- [Metadata collected by Inventory](inventory-schema.md "inventory-schema.md")
