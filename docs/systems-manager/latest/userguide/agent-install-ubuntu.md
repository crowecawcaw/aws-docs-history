...
For more information, see [Determining the correct SSM Agent version to install on 64-bit Ubuntu Server 16.04 instances](agent-install-ubuntu-about-v16.md "agent-install-ubuntu-about-v16.md").
...
- [Install SSM Agent on Ubuntu Server 16.04 LTS 64-bit (Snap), 18.04, 20.04, 22.04 LTS, 23.10, 24.04 LTS, 24.0, and 25.04](agent-install-ubuntu-64-snap.md "agent-install-ubuntu-64-snap.md")
- [Install SSM Agent on Ubuntu Server 16.04 64-bit (deb)](agent-install-ubuntu-64-deb.md "agent-install-ubuntu-64-deb.md")
- [Install SSM Agent on Ubuntu Server 16.04 32-bit](agent-install-ubuntu-32.md "agent-install-ubuntu-32.md")
- [Determining the correct SSM Agent version to install on 64-bit Ubuntu Server 16.04 instances](agent-install-ubuntu-about-v16.md "agent-install-ubuntu-about-v16.md")
