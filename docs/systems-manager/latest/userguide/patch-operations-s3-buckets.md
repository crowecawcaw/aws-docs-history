...
For information about specifying these S3 buckets in EC2 instance profiles, see [SSM Agent communications with AWS managed S3 buckets](ssm-agent-technical-details.md#ssm-agent-minimum-s3-permissions).

For information about using VPC endpoints with Systems Manager, see [Improve the security of EC2 instances by using VPC endpoints for Systems Manager](setup-create-vpc.md).

**Topics**
+ [Buckets containing SSM Command documents for patching operations (Linux and Windows Server)](#aws-patch-manager-buckets-linux-windows)
+ [Buckets containing SSM Command documents for patching operations (macOS)](#aws-patch-manager-buckets-macos)
+ [Buckets containing AWS managed patch baseline snapshots](#aws-patch-manager-buckets-baseline-snapshots)
...
| Region name  | Region code | `aws-patch-manager-{{region}}-{{suffix}}` bucket | 
| --- | --- | --- | 
...
| Asia Pacific (Taipei) | ap-east-2 | aws-patch-manager-ap-east-2-5a64b2916 | 
| Asia Pacific (Malaysia) | ap-southeast-5 | aws-patch-manager-ap-southeast-5-dcb42f3e3 | 
| Asia Pacific (New Zealand) | ap-southeast-6 | aws-patch-manager-ap-southeast-6-df0d3a7f2 | 
| Asia Pacific (Thailand) | ap-southeast-7 | aws-patch-manager-ap-southeast-7-c707c017a | 
| Mexico (Central) | mx-central-1 | aws-patch-manager-mx-central-1-396b275ad | 
...
| Region name  | Region code | `aws-patchmanager-macos-{{region}}-{{suffix}}` bucket | 
| --- | --- | --- | 
...
| Asia Pacific (Taipei) | ap-east-2 | aws-patchmanager-macos-ap-east-2-5a64b2916 | 
| Asia Pacific (Malaysia) | ap-southeast-5 | aws-patchmanager-macos-ap-southeast-5-dcb42f3e3 | 
| Asia Pacific (New Zealand) | ap-southeast-6 | aws-patchmanager-macos-ap-southeast-6-df0d3a7f2 | 
| Asia Pacific (Thailand) | ap-southeast-7 | aws-patchmanager-macos-ap-southeast-7-c707c017a | 
| Mexico (Central) | mx-central-1 | aws-patchmanager-macos-mx-central-1-396b275ad | 
...
| Asia Pacific (Taipei) | ap-east-2 | patch-baseline-snapshot-ap-east-2-8947749e | 
| Asia Pacific (Malaysia) | ap-southeast-5 | patch-baseline-snapshot-ap-southeast-5 | 
