...
- [Quick installation commands for SSM Agent on CentOS Stream](#quick-install-centos-stream "#quick-install-centos-stream")
- [Create custom agent installation commands for CentOS Stream in your Region](#custom-url-centos-stream "#custom-url-centos-stream")
...
You can also replace a global URL in the procedure [Quick installation commands for SSM Agent on CentOS Stream](#quick-install-centos-stream "#quick-install-centos-stream") earlier in this topic
