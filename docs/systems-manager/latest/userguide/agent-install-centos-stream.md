...
# Manually install SSM Agent on

CentOS Stream instances

The Amazon Machine Images (AMIs) for CentOS Stream that are provided by AWS do not
...
SSM Agent on a CentOS Stream instance.

###### Before you begin

Before you install SSM Agent on a CentOS Stream instance, note the
following:
...
- [Quick installation commands
  for SSM Agent on CentOS Stream](#quick-install-centos-stream "#quick-install-centos-stream")
- [Create custom agent installation
  commands for CentOS Stream in your Region](#custom-url-centos-stream "#custom-url-centos-stream")

## Quick installation commands

for SSM Agent on CentOS Stream
...
1. Connect to your CentOS Stream instance using your preferred method,
   such as SSH.
...
commands for CentOS Stream in your Region
...
You can also replace a global URL in the procedure [Quick installation commands
for SSM Agent on CentOS Stream](#quick-install-centos-stream "#quick-install-centos-stream") earlier in this topic
