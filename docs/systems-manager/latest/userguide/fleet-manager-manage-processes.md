...
can see the CPU utilization and memory usage of processes besides their
handles and threads. With Fleet Manager, you can start and terminate processes from the
console.

This section includes the following topics.

- [Viewing details about OS processes using Fleet Manager](fleet-manager-view-process-details.md "fleet-manager-view-process-details.md")
- [Starting an OS process on a managed node using Fleet Manager](fleet-manager-start-process.md "fleet-manager-start-process.md")
- [Terminating an OS process using Fleet Manager](fleet-manager-terminate-process.md "fleet-manager-terminate-process.md")
