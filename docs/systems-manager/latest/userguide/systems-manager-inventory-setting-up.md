...
- [Creating a resource data sync for Inventory](inventory-create-resource-data-sync.md "inventory-create-resource-data-sync.md")
- [Using EventBridge to monitor Inventory events](systems-manager-inventory-setting-up-eventbridge.md "systems-manager-inventory-setting-up-eventbridge.md")
