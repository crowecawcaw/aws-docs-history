...
1. In the **Chat** section, select **Configure new client**.

1. In the **Select client type** dropdown, choose the type of chat client you want to configure and select **Next**.

1. You're prompted to allow Amazon Q Developer in chat applications to access your chat client. Select **Allow**.

1. In the **Configure channel** section, enter the information for your chat client channel and select the types of notifications you want to receive.

1. If you're configuring Slack notifications, invite "@Amazon Q" to every Slack channel that notifications are being configured in.

1. Select **Configure channel**.
...
1. In the **Email** section, select **Edit**.

1. Select **Add emails**, choose the **IAM role** you want to manually associate email addresses with.
