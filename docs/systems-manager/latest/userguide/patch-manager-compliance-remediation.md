...
- Create a maintenance window that uses the Systems Manager document (SSM
  ...
  For information, see [Tutorial: Create a maintenance window for patching using the console](maintenance-window-tutorial-patching.md "maintenance-window-tutorial-patching.md").
...
- Install patches on demand using the **Patch now**
  option. For information, see [Patching managed nodes on demand](patch-manager-patch-now-on-demand.md "patch-manager-patch-now-on-demand.md").
