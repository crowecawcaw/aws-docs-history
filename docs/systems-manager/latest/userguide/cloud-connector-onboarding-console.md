...
<a name="cloud-connector-onboarding-console"></a>

To enable VM onboarding in the AWS Management Console:

1. Open the Systems Manager console and navigate to **Hybrid Cloud**.

1. Choose the Cloud Connector for which you want to enable VM onboarding.

1. Choose **Install and configure SSM Agent**.
...
VM tags  
Optionally add tags that will be applied to managed instances during onboarding. The `CloudConnector` tag is applied automatically (see [Tags applied to managed instances](cloud-connector-managed-instance-tags.md)). You can add additional tags to further organize your managed fleet.
