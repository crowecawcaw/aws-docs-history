...
+ [Enable VM onboarding (AWS Management Console)](cloud-connector-onboarding-console.md)
...
+ [Enable VM onboarding (AWS CLI)](cloud-connector-onboarding-cli.md)
...
+ [Set up a Cloud Connector for Microsoft Azure in Systems Manager](#systems-manager-cloud-connector)
