...
+ **Association edit** – State Manager runs the association after a user edits and saves changes to any association field. Any call to the `UpdateAssociation` API action that modifies the association triggers an immediate execution.
