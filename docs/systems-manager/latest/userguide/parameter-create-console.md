...
1. For **Parameter tier** choose either **Standard** or **Advanced**. For more information about advanced parameters, see [Choosing parameter tiers in Parameter Store](parameter-store-advanced-parameters.md).
