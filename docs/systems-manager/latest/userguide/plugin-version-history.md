...
| --------- | ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1.2.835.0 | June 17, 2026      | **Enhancement**: Add<br>SSH-style escape sequences to shell sessions (~. to<br>terminate, ~? for help).<br>**Bug fix**: Fix port<br>forwarding sessions silently dying after WebSocket<br>reconnection.         |
