...
Before you install SSM Agent on an Oracle Linux instance, note the
following:
...
Even though URL in the following command includes an
`ec2-downloads-windows` directory, these
are the correct global installation files for Oracle Linux.
