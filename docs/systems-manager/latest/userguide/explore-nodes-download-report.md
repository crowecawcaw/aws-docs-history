...
6. If the **Export to Amazon S3** dialog box is displayed, do the
   ...
   **View**. To select from a list of buckets in
   ...
   creating this role, see [Creating a custom service role to export diagnosis reports to S3](create-s3-export-role.md "create-s3-export-role.md"). 3. Choose **Submit**.
