...
| `aws:deleteImage`          | Amazon EC2                          | [Amazon Machines<br>Images](../../../AWSEC2/latest/UserGuide/AMIs.md "../../../AWSEC2/latest/UserGuide/AMIs.md")                                 |                                                                                                                                                                   |
| `aws:copyImage`            | Amazon EC2                          | [Amazon Machine Images](../../../AWSEC2/latest/UserGuide/AMIs.md "../../../AWSEC2/latest/UserGuide/AMIs.md")                                     |                                                                                                                                                                   |
| `aws:createTag`            | Amazon EC2, Systems Manager         | [EC2<br>Resource and Tags](../../../AWSEC2/latest/UserGuide/EC2_Resources.md "../../../AWSEC2/latest/UserGuide/EC2_Resources.md")                |                                                                                                                                                                   |
| `aws:invokeLambdaFunction` | AWS Lambda                          | [AWS Lambda Developer Guide](../../../lambda/latest/dg.md "../../../lambda/latest/dg.md")                                                        | [Troubleshooting Lambda](../../../lambda/latest/dg/monitoring-functions.md "../../../lambda/latest/dg/monitoring-functions.md")                                   |
...
A problem with the Automation service is preventing the specified runbook from
running correctly. To resolve this issue, contact AWS Support. Provide the
execution ID and customer ID, if available.
...
A step in the `aws:runInstances` action timed out. This
can happen if the step action takes longer to run than the value specified for `timeoutSeconds` in the step. To resolve this issue, specify
a longer value for the `timeoutSeconds` parameter in the
`aws:runInstances` action. If that doesn't solve the
problem, investigate why the step takes longer to run than expected
