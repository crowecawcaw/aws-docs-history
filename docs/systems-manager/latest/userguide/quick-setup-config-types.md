...
- [Set up the Default Host Management Configuration for an organization using Quick Setup](quick-setup-default-host-management-configuration.md "quick-setup-default-host-management-configuration.md")
...
- [Change Manager organization
  setup](change-manager-organization-setup.md "change-manager-organization-setup.md")
...
- [OpsCenter organization
  setup](OpsCenter-quick-setup-cross-account.md "OpsCenter-quick-setup-cross-account.md")
- [Configure AWS Resource Explorer using Quick Setup](Resource-explorer-quick-setup.md "Resource-explorer-quick-setup.md")
