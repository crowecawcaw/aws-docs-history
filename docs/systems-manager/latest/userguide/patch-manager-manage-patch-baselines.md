...
custom patch baselines. To learn more about patch baselines, see [Predefined and
...
- [Updating
  or deleting a custom patch baseline](patch-manager-update-or-delete-a-patch-baseline.md "patch-manager-update-or-delete-a-patch-baseline.md")
