...
+ [Upload failed.](#distributor-tshoot-6)
+ [Error: Failed to find platform: no manifest found for platform: oracle, version 8.9, architecture x86\_64](#distributor-tshoot-7)
