...
- [Updating AMIs](automation-tutorial-update-ami.md "automation-tutorial-update-ami.md")
  ...
  - [Update a golden
    ...
    - [Task 1: Create a parameter in Systems Manager
      Parameter Store](automation-tutorial-update-patch-golden-ami.md#create-parameter-ami "automation-tutorial-update-patch-golden-ami.md#create-parameter-ami")
    - [Task 2: Create an IAM role for
      AWS Lambda](automation-tutorial-update-patch-golden-ami.md#create-lambda-role "automation-tutorial-update-patch-golden-ami.md#create-lambda-role")
    - [Task 3: Create an AWS Lambda
      function](automation-tutorial-update-patch-golden-ami.md#create-lambda-function "automation-tutorial-update-patch-golden-ami.md#create-lambda-function")
...
- [Using AWS Support self-service
  runbooks](automation-tutorial-support-runbooks.md "automation-tutorial-support-runbooks.md")
  - [Run the EC2Rescue tool on unreachable
    ...
    - [Before you begin](automation-ec2rescue.md#automation-ec2rescue-begin "automation-ec2rescue.md#automation-ec2rescue-begin")
      - [Granting
        ...
        on your instances](automation-ec2rescue.md#automation-ec2rescue-access "automation-ec2rescue.md#automation-ec2rescue-access")
        - [Granting
  ...
  - [Reset passwords and SSH keys on EC2
    ...
    - [Before you begin](automation-ec2reset.md#automation-ec2reset-begin "automation-ec2reset.md#automation-ec2reset-begin")
      - [Granting
        ...
        instances](automation-ec2reset.md#automation-ec2reset-access "automation-ec2reset.md#automation-ec2reset-access")
        - [Granting
