...
# Manually install SSM Agent on Rocky Linux
...
managed AMIs on which the agent might be preinstalled, see [Find AMIs with the SSM Agent
...
- [Quick installation commands for
  SSM Agent on Rocky Linux](#quick-install-rocky "#quick-install-rocky")
- [Create custom agent installation commands
  for Rocky Linux in your Region](#custom-url-rocky "#custom-url-rocky")

## Quick installation commands for

SSM Agent on Rocky Linux
...
for Rocky Linux in your Region
