...
2. Run the following command to get information about a maintenance
...
3. Run the following command to list the tasks run as part of a
...
4. Run the following command to get the details of a task
   execution.
...
5. Run the following command to get the specific task invocations
   performed for a task execution.
