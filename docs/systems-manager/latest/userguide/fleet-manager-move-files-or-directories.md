...
pasting OS files or directories using Fleet Manager

You can use Fleet Manager to copy, cut, and paste OS files on a managed
node.
...
7. In the **Actions** menu, choose
   **Copy** or **Cut**.
8. In the **File system** view, choose the button next
   to the directory you want to paste the file in.
9. In the **Actions** menu, choose
   **Paste**.
