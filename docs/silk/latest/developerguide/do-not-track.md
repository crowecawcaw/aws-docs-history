...
1. Tap **Privacy**, and then tap **'Do Not Track'**.

1. You can turn DNT on or off.
...
Here's [a W3C example](http://www.w3.org/TR/tracking-dnt/#dnt-header-field) of an HTTP header with the DNT field set to 1: 
...
<a name="do-not-track-resources"></a>

To learn more about the Do Not Track standard, see the following resources:

 
+ [Tracking Preference Expression](http://www.w3.org/TR/tracking-dnt/)
