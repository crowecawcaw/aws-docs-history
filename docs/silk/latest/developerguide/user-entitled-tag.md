...
## Usage guidelines
<a name="user-entitled-tag-use-implementation"></a>
...
1. **Omit the Tag for Entitled Users:** If the user is entitled to view the entire content of the page, the `silk:is-user-entitled` tag can be omitted, as Silk will assume entitlement by default.
...
## Examples
<a name="user-entitled-tag-examples"></a>
