...
| ------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Assignment Group value (SYS\_ID) to use when creating ServiceNow<br>Incidents from AWS Systems Manager Incident Manager<br>synchronization | sys\_id of the assignment group that the Connector uses when<br>synching Incidents from AWS Systems Manager Incident Manager<br>Default value: <empty>                                                                                                                                                                                                                                       |
