...
When you configure ServiceNow tables
as AWS Config custom resources
you might encounter an increase
in your billing statement
for the creation
...
5. Choose an account and Region for the new resource type. You can select
   any supported Region, in addition to preconfigured Regions for the
   account.
6. Click **Submit**.
7. Repeat steps above to include additional ServiceNow tables available
   to sync as AWS Config custom resources.

The amount of time to create new AWS Config resources depends
on the number of ServiceNow tables you selected. You can see resources
in the **Schema version** field upon
successful completion. The period synchronization of resources
automatically includes the new AWS Config custom resource type.
As details in the ServiceNow table update, this information syncs to
AWS Config custom resource.
