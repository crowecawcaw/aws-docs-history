...
| **(Advanced mode)*<br>• Enable an _intermediate table_<br>(SMC Support Case table) to synchronize data to and from Support. Use caution; enabling<br>an intermediate table replaces the default Incident table. | Default: **False**                                        |
