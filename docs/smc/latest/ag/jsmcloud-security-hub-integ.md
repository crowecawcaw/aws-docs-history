...
1. Enable AWS Security Hub. For more information, refer to [Setting up AWS Security Hub](../../../securityhub/latest/userguide/securityhub-settingup.md "../../../securityhub/latest/userguide/securityhub-settingup.md") with the Console.
2. Set up an SQS queue to receive updated Findings. Name the queue,
   `AwsSmcJsmCloudForgeSecurityHubQueue`, to align with
   the default name in the Jira Service Management Connector Settings for the AWS Security Hub
...
automate the AWS Config custom resource and AWS Security Hub integration features. For more information, refer to
[Setting baseline
