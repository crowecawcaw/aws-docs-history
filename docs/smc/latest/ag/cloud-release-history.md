...
| v3.9.0  | AWS Security Hub CSPM integration enhancements including additional<br>logging to capture errors associated with the AWS Security Hub CSPM Findings<br>sync | January 4, 2023   |
