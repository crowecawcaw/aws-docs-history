...
| Compliance            | Whether a resource passes the configured compliance criteria.<br>Contains status (PASSED, WARNING, FAILED, NOT\_AVAILABLE). If the<br>resource does not pass, it will contain information about the<br>reason. |
