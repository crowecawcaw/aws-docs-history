...
After you've enabled projects for the Connector, AWS Security Hub CSPM
...
and add or remove projects at any time. 3. Under **AWS Security Hub CSPM
...
respectively. **Synchronize AWS Security Hub CSPM Findings
