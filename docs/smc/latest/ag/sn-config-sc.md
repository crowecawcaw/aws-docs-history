...
1. Follow the steps to [create a Service Catalog portfolio](../../../servicecatalog/latest/adminguide/portfoliomgmt-create.md "../../../servicecatalog/latest/adminguide/portfoliomgmt-create.md").
...
in the ServiceNow Service Catalog. 5. Add the SMEndUser user to the Service Catalog portfolio. For additional user access
