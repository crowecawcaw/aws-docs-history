...
To use an CloudFormation template to set up the AWS configurations of the Connector for
...
The CloudFormation template creates IAM users with permissions to all existing integrations, and _is intended to
