...
This section describes how to view AWS Security Hub CSPM Findings, update
...
3. Choose **Open Issues** and select
   the **AWS Security Hub CSPM Finding** from AWS
...
2. In the **Jira Service Management Jira
   ...
   AWS Security Hub CSPM Finding.
3. Choose **Open Issues** and select
   the AWS Security Hub CSPM Finding from AWS that you want to update.
4. Choose **Edit Issue**.
...
2. In the **Jira Service Management Jira
   ...
   AWS Security Hub CSPM Finding.
3. Choose **Open Issues** and select
   the AWS Security Hub CSPM Finding.
4. In the selected AWS resources section of the AWS Security Hub CSPM
...
AWS Security Hub CSPM findings follow the [AWS Security Finding Format](../../../securityhub/latest/userguide/securityhub-findings-format.md "../../../securityhub/latest/userguide/securityhub-findings-format.md") (ASFF). Here’s a mapping of
fields from AWS Security Hub CSPM findings to JSM Incident records.
...
Jira does not duplicate findings. If a Security Hub CSPM finding is sent to
