...
<a name="sp-purchase-analysis-next-steps"></a>
...
1. On the **Purchase Analyzer** page, choose **Add Savings Plan to cart**, and then review your order on the **Cart** page.

## CSV field details
<a name="sp-analysis-csv"></a>
