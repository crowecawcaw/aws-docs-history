...
Compute Savings Plans provide savings up to 66% off On-Demand, similar to Convertible
RIs. Compute Savings Plans automatically reduce your cost on EC2 instance usage, Fargate, and Lambda.
EC2 Instance Savings Plans offer savings up to 72% off of On-Demand, similar to Standard RIs. They also
