...
| **Mount Folder** | The folder on the node where the remote folder is mounted. As shown, this folder must be under `/data/mnt`. You can specify a sub-subfolder; if that folder does not already exist, AWS Elemental Server automatically creates it. |
