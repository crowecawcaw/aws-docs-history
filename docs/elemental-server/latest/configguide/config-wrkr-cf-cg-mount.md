...
your AWS Elemental Server nodes, create mount points as described in this section. When you mount a
...
| **Mount Folder** | The folder on the node where the remote folder is mounted. As shown,<br>this folder must be under `/data/mnt`. You can specify a sub-subfolder;<br>if that folder does not already exist, AWS Elemental Server automatically creates it. |
