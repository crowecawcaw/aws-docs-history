...
<a name="config-wrkr-srvr-cg-auth"></a>
...
1. For the prompt `Do you wish to enable PAM?`, type **N**. If you're using PAM authentication, type **Y**.
   ...
   For information about the different authentication options, see [User Authentication Reference](config-wrkr-srvr-cg-auth-ref.md)
