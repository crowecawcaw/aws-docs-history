...
To configure AWS Elemental Server to relay
...
1. If you haven't already, subscribe to global alert notifications as described in [Email Notifications](notification-email.md "notification-email.md").
