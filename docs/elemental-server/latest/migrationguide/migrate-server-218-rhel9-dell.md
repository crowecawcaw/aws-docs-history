...
# Install on a Dell
<a name="migrate-server-218-rhel9-dell"></a>
...
<a name="migrate-server-218-rhel9-dell-idrac"></a>

### Get Ready
<a name="migrate-server-218-rhel9-dell-idrac-step1"></a>
...
<a name="migrate-server-218-rhel9-dell-idrac-step2"></a>
...
## USB stick
<a name="migrate-server-218-rhel9-dell-stick"></a>

1. Make sure that you have created a boot USB drive. See [Create a boot USB drive](migrate-server-218-get-ready.md#migrate-server-218-boot).
