...
<a name="migrate-server-218-install-restore"></a>
...
1. After the restore has succeeded, reboot the node:
...
1. Copy the files to `/home/elemental`

1. Enter the restore command again:
