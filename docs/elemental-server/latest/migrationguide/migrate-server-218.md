...
- [Step B: Prepare the AWS Elemental Server node for migration](migrate-server-218-prepare-node.md "migrate-server-218-prepare-node.md")
...
- [Step G: Install worker software on a AWS Elemental Server node](migrate-server-218-install-software.md "migrate-server-218-install-software.md")
- [Step H: Restore the database on a AWS Elemental Server node](migrate-server-218-install-restore.md "migrate-server-218-install-restore.md")
