...
**Topics**
+ [Step A: Prepare Hardware and Download Files](install-vm-srvr-ig-prep.md)
+ [Step B: Deploy the VM](install-vm-srvr-ig-install-vm.md)
+ [Step C: Install the AWS Elemental Software](install-vm-srvr-ig-install-sw.md)
+ [Step D: Set-up Licensing](install-vm-srvr-ig-licensing.md)
+ [Step E: Complete Node Configuration](install-vm-srvr-ig-complete.md)