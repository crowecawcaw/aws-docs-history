...
<a name="install-srvr-ig"></a>

This section is for IT administrators who perform the first-time installation of AWS Elemental Server software on a hardware unit that is considered qualified hardware.
...
The procedure for installing any version of AWS Elemental Server is the same; only the version number in the file name changes. In this procedure, we show how to install version 2.18.0 of the software.
