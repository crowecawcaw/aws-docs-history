...
<tbody>
  <tr><td><b>Name</b></td><td>Type a descriptive name for the VM. This will be the hostname that you use to access AWS Elemental Server.</td></tr>
