...
![Three-bar icon with dropdown menu showing "License(s)" and "Download" options.](images/install-licorderdetail-shared-png.png) 3. On the **License Information** page, choose **Generate**.

![Generate button highlighted on a License Information page interface.](/images/elemental-server/latest/installguide/images/install-licinfo-shared-png.png) 4. On the **Generate Licenses** page, select **Choose File** to browse to and select your `.key` file. 5. This returns you to the **Generate Licenses** page,
