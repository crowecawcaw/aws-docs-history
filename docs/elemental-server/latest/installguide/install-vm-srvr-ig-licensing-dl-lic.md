...
![](https://docs.aws.amazon.com/elemental-server/latest/installguide/images/install-licorderdetail-shared-png.png)

1. On the **License Information** page, choose **Generate**.  
![](https://docs.aws.amazon.com/elemental-server/latest/installguide/images/install-licinfo-shared-png.png)
...
![](https://docs.aws.amazon.com/elemental-server/latest/installguide/images/install-genlic-shared-png.png)
...
![](https://docs.aws.amazon.com/elemental-server/latest/installguide/images/install-viewlic-shared-png.png)
