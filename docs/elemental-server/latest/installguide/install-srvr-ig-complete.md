...
<a name="install-srvr-ig-complete"></a>

You have now installed and performed basic configuration of AWS Elemental Server. To complete the node configuration, refer to the following.
