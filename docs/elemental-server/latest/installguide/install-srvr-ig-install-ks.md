...
![](https://docs.aws.amazon.com/elemental-server/latest/installguide/images/install-installer-shared-png.png)
...
<tbody>
  <tr><td><code>Set Hostname</code></td><td>Change the hostname to a useful name such as <b>server-01</b> or <b>server-chicago-01</b>.<br />Do not use localhost as the hostname!<br />Do not use periods or underscores in the hostname</td></tr>
