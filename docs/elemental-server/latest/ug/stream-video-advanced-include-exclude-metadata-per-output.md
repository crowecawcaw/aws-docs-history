...
<a name="stream-video-advanced-include-exclude-metadata-per-output"></a>

The Insert Color Metadata checkbox is located under Advanced on the Video tab of each stream. Use this checkbox to indicate whether outputs should include metadata. 
