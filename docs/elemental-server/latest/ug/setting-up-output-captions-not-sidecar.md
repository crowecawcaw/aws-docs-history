...
| **Pass Style Information** | If \*_Destination Type_<br>• is CCF-TT or TTML.<br>And if the source caption type is an Embedded combination (Embedded, Embedded+SCTE-20,<br>SCTE-20+Embedded), or Teletext, TTML, SMPTE-TT, or CCF-TT. | The choices are:<br>1. Check this box if you want the style (font, position and so on) of the input<br>captions to be copied.<br>2. Leave unchecked if you want a simplified caption style. Some client players work<br>best with a simplified caption style.<br>(For other combinations of source caption types and output caption type, the output is<br>always simplified.) |
| Font style fields          | \*_Destination Type_<br>• type is Burn-in or DVB-Sub                                                                                                                                                    | For burn-in, see [Font Styles for Burn-in](font-styles-for-burn-in.md "font-styles-for-burn-in.md"). For DVB-Sub, see [(Font Styles for DVB-Sub)](font-styles-for-dvb-sub.md "font-styles-for-dvb-sub.md").                                                                                                                                                                    |
| Language                   | All captions except not for embedded-to-embedded or Teletext-to-Teletext                                                                                                                                | Complete if desired. This information may be useful to or required by a downstream<br>system.<br>For embedded-to-embedded or Teletext-to-Teletext, leave as Undefined.                                                                                                                                                                                                         |
