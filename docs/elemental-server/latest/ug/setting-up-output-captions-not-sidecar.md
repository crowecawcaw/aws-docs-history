...
<a name="setting-up-output-captions-not-sidecar"></a>
...
1. Choose the output group tab that contains the output to which you want to add captions.
...
1. Create an additional captions tabs in the same stream and output for each additional captions track you want to include.

1. Repeat this procedure for any other outputs you want to include captions in.
**Note**  
If your output captions are embedded and your output package (that is, your output group type) is HLS, you can optionally include captions language information in the manifest. For more information, see [Setting up the HLS Manifest](set-up-the-hls-manifest.md).


|  Field  |  Applicability  |  Description  | 
| --- | --- | --- | 
| **Caption Source** | All | Select the caption selector you created when specifying the input captions (see [Creating Input Captions Selectors](create-input-caption-selectors.md)). | 
