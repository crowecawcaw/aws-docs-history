...
AWS Elemental Server does not create output captions in these formats, but you can convert them to a [supported output format](choose-a-supported-output-captions-format.md)..

**Note**  
If your content includes 608 XDS data, see [Setting Up Input Captions With 608 XDS Data](setting-up-for-608-xds-data.md)
