...
+  **Deinterlace**: Applies a deinterlace algorithm to content. If the AWS Elemental system detects that the source content is already progressive, no deinterlacing is applied. 
