...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Streams > Advanced > Telecine                                            | stream\_assembly/video\_description/`codec`/telecinewhere `codec` is one of the following:<br>• `h264_settings`<br>• `mpeg2_settings`<br>• `h265_settings`<br>• `prores_settings`                            |
| Streams > Advanced > Interlace Mode                                      | stream\_assembly/video\_description/`codec`/interlace\_modewhere `codec` is one of the following:<br>• `vc1_settings`<br>• `h264_settings`<br>• `mpeg2_settings`<br>• `h265_settings`<br>• `prores_settings` |
