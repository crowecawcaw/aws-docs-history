...
![Workflow showing input captions converted to TTML and WebVTT formats for DASH and HLS outputs.](https://docs.aws.amazon.com/elemental-server/latest/ug/images/example-one-to-different-one-each-1.png)
...
![Caption Selector interface showing two selectors with Source dropdown set to Teletext and Page Numbers 890 and 896.](https://docs.aws.amazon.com/elemental-server/latest/ug/images/example-one-to-different-one-each-2.png)
...
![Streams configuration interface showing six streams with video, audio, and caption settings.](https://docs.aws.amazon.com/elemental-server/latest/ug/images/example-one-to-different-one-each-3.png)
...
![Three output streams showing Stream 1 with av modifier, Stream 3 with CZ modifier, and Stream 4 with POL modifier.](https://docs.aws.amazon.com/elemental-server/latest/ug/images/example-one-to-different-one-each-4.png)
...
![Three output streams with name modifiers av, CZ, and POL configured in the Outputs section.](https://docs.aws.amazon.com/elemental-server/latest/ug/images/example-one-to-different-one-each-5.png)