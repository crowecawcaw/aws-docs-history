...
| **Framerate**        | If the *_Destination Type_<br>• is SCC.                                                                                                              | Complete this field to ensure that the captions and the video are synchronized in the<br>output.<br>Specify a framerate that matches the framerate of the associated video.<br>• If the video framerate is 23.97 or 24, choose the corresponding option<br>• If the video framerate is 29.97, choose 29.97 dropframe only if the video has the<br>*_Video Insertion_<br>• and *_Drop Frame<br>Timecode_<br>• both checked; otherwise, choose 29.97 non-dropframe. |
