...
**Note**  
If you are extracting embedded captions from the input and using embedded captions in the output, and if the input includes VBI data and you want to include all that data in the output, then do not follow this procedure. Instead, see [Extracting VBI Data Included in Embedded Input Captions](embedded-captions-in-vbi-data.md).
