...
**Note**  
Even if your overlays never overlap, you need to specify unique **Layer** values for each overlay in the job.
...
1. Set up your graphic overlay as described in [Still Image Inserter](setting-up-a-graphic-overlay.md).
