...
**Topics**
+ [Creating Streams for HLS Rendition Groups in the REST API](#hls-rendition-groups-create-using-rest-api-streams)
+ [Creating Output Groups for HLS Rendition Groups in the REST API](#hls-rendition-groups-create-using-rest-api-output-groups)
+ [Creating Outputs for HLS Output Groups in the REST API](#hls-rendition-groups-create-using-rest-api-outputs)
...
+ Each **audio** output element must contain:
  ...
  + apple\_live\_settings element that contains:
    ...
    + Version 2.10.0 and later: audio\_track\_type: Either “alternate\_audio\_auto\_select\_default” or “alternate\_audio\_auto\_select” or “alternate\_audio\_not\_auto\_select” or “audio\_only\_variant\_stream”. See [Step 2. Determine Defaults and Auto-Selection Behavior](hls-rendition-groups-getting-ready-to-create.md#hls-rendition-groups-getting-ready-determine-defaults)for information.
    + Other tags as you require.
