...
| **Beta features**          | Pass through with `anthropic-beta` headers (see [Feature support](feature-support.md "feature-support.md")) | Requires AWS support                                         |
...
If you need AWS-operated Claude with the Bedrock API, see [Amazon Bedrock](../../../bedrock/latest/userguide.md "../../../bedrock/latest/userguide.md").
