...
For the current list of models, model IDs, context window sizes, and capabilities, see [Models overview](https://platform.claude.com/docs/en/about-claude/models/overview "https://platform.claude.com/docs/en/about-claude/models/overview") in the Anthropic documentation.
