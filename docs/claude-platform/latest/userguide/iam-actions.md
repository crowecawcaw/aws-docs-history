...
_IAM action reference for controlling access to Claude Platform on AWS through AWS policies._
...
Agent definitions for [Claude Managed Agents](https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview "https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview").
...
A default workspace is provisioned at sign-up; see [Workspaces](workspaces.md "workspaces.md").
...
- [IAM policies](iam-policies.md "iam-policies.md") for example policies and managed policies
- [AWS IAM User Guide](../../../IAM/latest/UserGuide/introduction.md "../../../IAM/latest/UserGuide/introduction.md") for IAM policy syntax and evaluation logic
- [AWS CloudTrail User Guide](../../../awscloudtrail/latest/userguide.md "../../../awscloudtrail/latest/userguide.md") for audit logging configuration
