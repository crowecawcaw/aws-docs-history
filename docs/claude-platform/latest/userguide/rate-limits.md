...
See [Response headers](https://platform.claude.com/docs/en/api/rate-limits#response-headers "https://platform.claude.com/docs/en/api/rate-limits#response-headers") on the Anthropic documentation website for the complete set.
