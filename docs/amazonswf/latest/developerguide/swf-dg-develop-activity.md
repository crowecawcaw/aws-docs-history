...
1. Begin performing the task.

1. Periodically report a heartbeat to Amazon SWF if the task is long-lived.

1. Report that the task completed or failed and return the results to Amazon SWF.
...
1. Program the activity worker to begin processing the data and executing your logic.
