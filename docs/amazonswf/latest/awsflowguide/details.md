...
deterministic way. See the section on [Execution Context](executioncontext.md "executioncontext.md") for more details.
...
the [Spring Integration](test.md#test.spring "test.md#test.spring") section for more
details.
