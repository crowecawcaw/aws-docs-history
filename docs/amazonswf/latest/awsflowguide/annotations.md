...
This annotation is used on an interface to declare a *workflow* type. An interface decorated with this annotation should contain exactly one method that is decorated with the [@Execute](#annotations-execute) annotation to declare an entry point for your workflow.
