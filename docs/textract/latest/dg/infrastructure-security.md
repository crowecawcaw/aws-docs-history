...
As a managed service, Amazon Textract is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Textract through the network. Clients must
