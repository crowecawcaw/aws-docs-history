...
Amazon Textract operations return different types of objects depending on the operations
run. Response objects are structured JSON outputs, with various elements that can be
searched for within a response. For more information about these response objects, see
