# Actions, resources, and condition keys for AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena

AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena (service prefix: `sagemaker-unified-studio-mcp`) provides the following service-specific resources, actions, and condition context keys for use in IAM permission policies.

References:

- Learn how to [configure this service](../../../sagemaker-unified-studio-mcp/latest/userguide/what-is.md "../../../sagemaker-unified-studio-mcp/latest/userguide/what-is.md").
- View a list of the [API operations available for this service](../../../sagemaker-unified-studio-mcp/latest/APIReference.md "../../../sagemaker-unified-studio-mcp/latest/APIReference.md").
- Learn how to secure this service and its resources by [using IAM](../../../sagemaker-unified-studio-mcp/latest/userguide/security-iam.md "../../../sagemaker-unified-studio-mcp/latest/userguide/security-iam.md") permission policies.
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [CallPrivilegedTool](../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md "../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md") | Grants permission to call privileged tools in MCP service | Write        |                             |                |                   |
| [CallReadOnlyTool](../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md "../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md")   | Grants permission to call read-only tools in MCP service  | Read         |                             |                |                   |
| [InvokeMcp](../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md "../../../sagemaker-unified-studio-mcp/latest/userguide/using-iam-roles.md")          | Grants permission to use MCP service                      | Read         |                             |                |                   |

## Resource types defined by AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena

AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena does not support specifying a resource ARN in the `Resource` element of an IAM policy statement. To allow access to AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena, specify `"Resource": "*"` in your policy.

## Condition keys for AWS SageMaker Unified Studio MCP is a managed MCP solution for AWS data processing services like EMR, Glue, Athena
