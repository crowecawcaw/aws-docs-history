...
- View a list of the [API operations available for this service](../../../freertos/latest/userguide/dev-tester-prereqs.md "../../../freertos/latest/userguide/dev-tester-prereqs.md").
- Learn how to secure this service and its resources by [using IAM](../../../freertos/latest/userguide/dev-tester-prereqs.md "../../../freertos/latest/userguide/dev-tester-prereqs.md") permission policies.

###### Topics

- [Actions defined by AWS IoT Device Tester](#awsiotdevicetester-actions-as-permissions "#awsiotdevicetester-actions-as-permissions")
- [Resource types defined by AWS IoT Device Tester](#awsiotdevicetester-resources-for-iam-policies "#awsiotdevicetester-resources-for-iam-policies")
- [Condition keys for AWS IoT Device Tester](#awsiotdevicetester-policy-keys "#awsiotdevicetester-policy-keys")
