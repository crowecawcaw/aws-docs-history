...
- Learn how to [configure this service](../../../aws-mcp/latest/userguide/what-is-mcp-server.md "../../../aws-mcp/latest/userguide/what-is-mcp-server.md").
- View a list of the [API operations available for this service](../../../aws-mcp/latest/userguide/understanding-mcp-server-tools.md "../../../aws-mcp/latest/userguide/understanding-mcp-server-tools.md").
- Learn how to secure this service and its resources by [using IAM](../../../aws-mcp/latest/userguide/security-iam.md "../../../aws-mcp/latest/userguide/security-iam.md") permission policies.

###### Topics

- [Actions defined by AWS MCP Server](#awsmcpserver-actions-as-permissions "#awsmcpserver-actions-as-permissions")
- [Resource types defined by AWS MCP Server](#awsmcpserver-resources-for-iam-policies "#awsmcpserver-resources-for-iam-policies")
- [Condition keys for AWS MCP Server](#awsmcpserver-policy-keys "#awsmcpserver-policy-keys")
...
| -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [CallReadOnlyTool](../../../aws-mcp/latest/userguide/security-iam.md "../../../aws-mcp/latest/userguide/security-iam.md")  | Grants permission to call read-only tools in MCP service         | Read         |                             |                |                   |
| [CallReadWriteTool](../../../aws-mcp/latest/userguide/security-iam.md "../../../aws-mcp/latest/userguide/security-iam.md") | Grants permission to call AWS Read and Write apis in MCP Service | Write        |                             |                |                   |
| [InvokeMcp](../../../aws-mcp/latest/userguide/security-iam.md "../../../aws-mcp/latest/userguide/security-iam.md")         | Grants permission to use MCP service                             | List         |                             |                |                   |
