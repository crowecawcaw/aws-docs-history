...
- [Actions defined by AWS Tiros](#awstiros-actions-as-permissions "#awstiros-actions-as-permissions")
- [Resource types defined by AWS Tiros](#awstiros-resources-for-iam-policies "#awstiros-resources-for-iam-policies")
- [Condition keys for AWS Tiros](#awstiros-policy-keys "#awstiros-policy-keys")
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [CreateQuery](../../../vpc/latest/reachability/security_iam_required-API-permissions.md "../../../vpc/latest/reachability/security_iam_required-API-permissions.md") [permission only]               | Grants permission to create a VPC reachability query                                           | Write        |                             |                |                   |
| [ExtendQuery](../../../vpc/latest/reachability/security_iam_required-API-permissions.md "../../../vpc/latest/reachability/security_iam_required-API-permissions.md") [permission only]               | Grants permission to extend a VPC reachability query to include the calling principals account | Write        |                             |                |                   |
| [GetQueryAnswer](../../../vpc/latest/reachability/security_iam_required-API-permissions.md "../../../vpc/latest/reachability/security_iam_required-API-permissions.md") [permission only]            | Grants permission to get VPC reachability query answers                                        | Read         |                             |                |                   |
| [GetQueryExplanation](../../../vpc/latest/reachability/security_iam_required-API-permissions.md "../../../vpc/latest/reachability/security_iam_required-API-permissions.md") [permission only]       | Grants permission to get VPC reachability query explanations                                   | Read         |                             |                |                   |
| [GetQueryExtensionAccounts](../../../vpc/latest/reachability/security_iam_required-API-permissions.md "../../../vpc/latest/reachability/security_iam_required-API-permissions.md") [permission only] | Grants permission to list accounts that might be useful in a new query                         | Read         |                             |                |                   |
