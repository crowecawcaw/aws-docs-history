...
| [ListSessions](../../../singlesignon/latest/userguide/manage-app-session.md "../../../singlesignon/latest/userguide/manage-app-session.md") [permission only]       | Grants permission to retrieve a list of active sessions for the specified user   | List         |                             |                |                   |
