...
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------ | --------------------------- | -------------- | ----------------- |
| [AuthenticatePackager](../../../wam/latest/adminguide/iam.md "../../../wam/latest/adminguide/iam.md") [permission only] | Allows the Amazon WAM packaging instance to access your application package catalog. | Write        |                             |                |                   |
