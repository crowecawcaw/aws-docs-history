...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [AllowMultiRegion](../../../vpc/latest/privatelink/vpc/latest/privatelink/security_iam_service-with-iam.md "../../../vpc/latest/privatelink/vpc/latest/privatelink/security_iam_service-with-iam.md") [permission only] | Grants permission to manage multi-region VPC endpoints and VPC endpoint service configurations | Write        |                             |                |                   |

## Resource types defined by AWS PrivateLink

AWS PrivateLink does not support specifying a resource ARN in the `Resource` element of an IAM policy statement. To allow access to AWS PrivateLink, specify `"Resource": "*"` in your policy.
