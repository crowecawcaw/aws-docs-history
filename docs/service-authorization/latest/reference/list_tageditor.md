...
| [ListTags](../../../ARG/latest/userguide/gettingstarted-prereqs.md#rg-permissions-te "../../../ARG/latest/userguide/gettingstarted-prereqs.md#rg-permissions-te") [permission only]          | Grants permission to retrieve the tags attached to the specified resource identifiers | Read         |                             |                | tag:GetResources  |
