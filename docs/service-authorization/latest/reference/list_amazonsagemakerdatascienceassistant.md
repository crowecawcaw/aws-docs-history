...
| --------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [SendConversation](../../../sagemaker-dsa/APIReference.md "../../../sagemaker-dsa/APIReference.md") [permission only] | Grants permission to start a conversation with SageMaker data science assistant | Write        |                             |                |                   |
