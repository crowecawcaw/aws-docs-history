...
- View a list of the [API operations available for this service](../../../signin/latest/APIReference.md "../../../signin/latest/APIReference.md").
...
- [Actions defined by AWS Signin](#awssignin-actions-as-permissions "#awssignin-actions-as-permissions")
- [Resource types defined by AWS Signin](#awssignin-resources-for-iam-policies "#awssignin-resources-for-iam-policies")
- [Condition keys for AWS Signin](#awssignin-policy-keys "#awssignin-policy-keys")
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------ | --------------------------- | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [AuthorizeOAuth2Access](../../../signin/latest/APIReference/API_AuthorizeOAuth2Access.md "../../../signin/latest/APIReference/API_AuthorizeOAuth2Access.md")                                                                                                 | Grants permission to authenticate through a browser and obtain an OAuth 2.0 authorization code for credential exchange                                                         | Read         |                             |                |                                                                                                                                                                                                                                   |
...
| [CreateTrustedIdentityPropagationApplicationForConsole](../../../signin/latest/APIReference/API_CreateTrustedIdentityPropagationApplicationForConsole.md "../../../signin/latest/APIReference/API_CreateTrustedIdentityPropagationApplicationForConsole.md") | Grants permission to create an Identity Center application that represents the AWS Management Console on an Identity Center organization instance                              | Write        |                             |                | sso:CreateApplication<br>sso:GetSharedSsoConfiguration<br>sso:ListApplications<br>sso:PutApplicationAccessScope<br>sso:PutApplicationAssignmentConfiguration<br>sso:PutApplicationAuthenticationMethod<br>sso:PutApplicationGrant |
| [ListTrustedIdentityPropagationApplicationsForConsole](../../../signin/latest/APIReference/API_ListTrustedIdentityPropagationApplicationsForConsole.md "../../../signin/latest/APIReference/API_ListTrustedIdentityPropagationApplicationsForConsole.md")    | Grants permission to list all Identity Center applications that represent the AWS Management Console                                                                           | List         |                             |                | sso:GetSharedSsoConfiguration<br>sso:ListApplications                                                                                                                                                                             |
