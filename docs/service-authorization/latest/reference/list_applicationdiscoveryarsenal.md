...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ------------ | --------------------------- | -------------- | ----------------- |
| [RegisterOnPremisesAgent](../../../application-discovery/latest/userguide/setting-up.md "../../../application-discovery/latest/userguide/setting-up.md") [permission only] | Grants permission to register AWS provided data collectors to the Application Discovery Service | Write        |                             |                |                   |
