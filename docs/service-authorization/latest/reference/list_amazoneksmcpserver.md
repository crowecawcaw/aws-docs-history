...
- View a list of the [API operations available for this service](../../../eks/latest/userguide/eks-mcp-tool-configurations.md "../../../eks/latest/userguide/eks-mcp-tool-configurations.md").
- Learn how to secure this service and its resources by [using IAM](../../../eks/latest/userguide/eks-mcp-tool-configurations.md "../../../eks/latest/userguide/eks-mcp-tool-configurations.md") permission policies.

###### Topics

- [Actions defined by Amazon EKS MCP Server](#amazoneksmcpserver-actions-as-permissions "#amazoneksmcpserver-actions-as-permissions")
- [Resource types defined by Amazon EKS MCP Server](#amazoneksmcpserver-resources-for-iam-policies "#amazoneksmcpserver-resources-for-iam-policies")
- [Condition keys for Amazon EKS MCP Server](#amazoneksmcpserver-policy-keys "#amazoneksmcpserver-policy-keys")
