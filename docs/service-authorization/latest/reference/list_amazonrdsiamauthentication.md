...
- Learn how to secure this service and its resources by [using IAM](../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAM.md "../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAM.md") permission policies.
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------------------- | -------------- | ----------------- |
| [connect](../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.IAMPolicy.md "../../../AmazonRDS/latest/UserGuide/UsingWithRDS.IAMDBAuth.IAMPolicy.md") | Allows IAM role or user to connect to RDS database | Permissions management | [db-user\*](#amazonrdsiamauthentication-db-user "#amazonrdsiamauthentication-db-user") |                |                   |
