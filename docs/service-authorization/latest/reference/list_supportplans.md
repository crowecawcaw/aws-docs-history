...
| [ListSupportPlanModifiers](../../../awssupport/latest/user/security-support-plans.md "../../../awssupport/latest/user/security-support-plans.md")   | Grants permission to view a list of all support plan modifiers for this AWS account       |                             |                | List         |
