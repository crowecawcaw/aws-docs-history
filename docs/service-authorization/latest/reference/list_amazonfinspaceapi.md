...
- View a list of the [API operations available for this service](../../../finspace/latest/data-api.md "../../../finspace/latest/data-api.md").
- Learn how to secure this service and its resources by [using IAM](../../../finspace/latest/userguide/temporary-credentials.md "../../../finspace/latest/userguide/temporary-credentials.md") permission policies.

###### Topics

- [Actions defined by Amazon FinSpace API](#amazonfinspaceapi-actions-as-permissions "#amazonfinspaceapi-actions-as-permissions")
- [Resource types defined by Amazon FinSpace API](#amazonfinspaceapi-resources-for-iam-policies "#amazonfinspaceapi-resources-for-iam-policies")
- [Condition keys for Amazon FinSpace API](#amazonfinspaceapi-policy-keys "#amazonfinspaceapi-policy-keys")
