...
| ------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ | ------------ | --------------------------- | -------------- | ----------------- |
| [CreateDatabaseBinarySnapshot](../../../AmazonRDS/latest/UserGuide/custom-cev.md "../../../AmazonRDS/latest/UserGuide/custom-cev.md") [permission only] | Grants permission to create a database binary snapshot on the customer's aws account | Write        |                             |                |                   |
