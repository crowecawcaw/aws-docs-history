...
| GetEstimatedWaterAllocation                | [sustainability:GetEstimatedWaterAllocation](#list_sustainability-action-GetEstimatedWaterAllocation "#list_sustainability-action-GetEstimatedWaterAllocation")                                              |               |                   | Read         |
| GetEstimatedWaterAllocationDimensionValues | [sustainability:GetEstimatedWaterAllocationDimensionValues](#list_sustainability-action-GetEstimatedWaterAllocationDimensionValues "#list_sustainability-action-GetEstimatedWaterAllocationDimensionValues") |               |                   | Read         |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------- | -------------- | ------------ |
| [GetCarbonFootprintSummary](../../../cur/latest/userguide/dataexports-create-standard.md "../../../cur/latest/userguide/dataexports-create-standard.md")                                                                                    | Grants permission to access carbon footprint data from AWS Data Exports                                         |                             |                | Read         |
...
| [GetEstimatedWaterAllocation](../../../sustainability/latest/APIReference/API_GetEstimatedWaterAllocation.md "../../../sustainability/latest/APIReference/API_GetEstimatedWaterAllocation.md")                                              | Grants permission to view estimated water allocation values based on customer grouping and filtering parameters |                             |                | Read         |
| [GetEstimatedWaterAllocationDimensionValues](../../../sustainability/latest/APIReference/API_GetEstimatedWaterAllocationDimensionValues.md "../../../sustainability/latest/APIReference/API_GetEstimatedWaterAllocationDimensionValues.md") | Grants permission to view the possible dimension values available for the estimated water allocation values     |                             |                | Read         |
