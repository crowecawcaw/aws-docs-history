...
| [StartSupportPlanUpdate](../../../awssupport/latest/user/security-support-plans.md "../../../awssupport/latest/user/security-support-plans.md") [permission only]     | Grants permission to update the support plan for this AWS account                         | Write        |                             |                |                   |
