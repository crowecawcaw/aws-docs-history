...
- View a list of the [API operations available for this service](../../../tk-dotnet-refactoring/latest/userguide/what-is-tk-dotnet-refactoring.md "../../../tk-dotnet-refactoring/latest/userguide/what-is-tk-dotnet-refactoring.md").
- Learn how to secure this service and its resources by [using IAM](../../../tk-dotnet-refactoring/latest/userguide/dotnet-refactoring-security.md "../../../tk-dotnet-refactoring/latest/userguide/dotnet-refactoring-security.md") permission policies.

###### Topics

- [Actions defined by AWS App2Container](#awsapp2container-actions-as-permissions "#awsapp2container-actions-as-permissions")
- [Resource types defined by AWS App2Container](#awsapp2container-resources-for-iam-policies "#awsapp2container-resources-for-iam-policies")
- [Condition keys for AWS App2Container](#awsapp2container-policy-keys "#awsapp2container-policy-keys")
