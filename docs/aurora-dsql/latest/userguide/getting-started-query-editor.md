...
The Query Editor is available in all Regions where Aurora DSQL is supported. For more information, see [AWS Regional Services](https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/ "https://aws.amazon.com/about-aws/global-infrastructure/regional-product-services/").
...
To get the query execution plan, run `EXPLAIN ANALYZE` or `EXPLAIN ANALYZE VERBOSE` to get additional insights into query performance. For more information, see [Reading Aurora DSQL EXPLAIN plans](reading-dsql-explain-plans.md "reading-dsql-explain-plans.md").
