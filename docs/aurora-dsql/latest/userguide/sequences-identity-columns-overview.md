...
[CREATE TABLE](create-table-syntax-support.md "create-table-syntax-support.md"), for example:
...
See [CREATE TABLE](create-table-syntax-support.md "create-table-syntax-support.md") for more details.
...
(See [CREATE SEQUENCE](create-sequence-syntax-support.md "create-sequence-syntax-support.md").) The properties of the associated sequence
might be specified when creating an identity column (see
[CREATE TABLE](create-table-syntax-support.md "create-table-syntax-support.md")) or changed afterwards (see
