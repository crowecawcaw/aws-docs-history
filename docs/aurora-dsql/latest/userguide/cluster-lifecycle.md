...
1. Wait for automatic transition to **Active** state.

1. Initiate the backup after the cluster is fully operational.
...
1. Open the Aurora DSQL console at [https://console.aws.amazon.com/dsql](https://console.aws.amazon.com/dsql).

1. Choose **Clusters** in the navigation pane.

1. View the status for each cluster in the dashboard.
