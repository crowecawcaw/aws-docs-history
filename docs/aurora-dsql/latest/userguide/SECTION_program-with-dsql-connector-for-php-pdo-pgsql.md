...
The [Aurora DSQL Connector for PHP](https://github.com/awslabs/aurora-dsql-connectors/tree/main/php/pdo_pgsql "https://github.com/awslabs/aurora-dsql-connectors/tree/main/php/pdo_pgsql") is a PHP connector built on [`PDO_PGSQL`](https://www.php.net/manual/en/ref.pdo-pgsql.php "https://www.php.net/manual/en/ref.pdo-pgsql.php") that integrates IAM authentication for connecting PHP applications to Amazon Aurora DSQL clusters.
...
For a complete example, see the [example application](https://github.com/awslabs/aurora-dsql-connectors/tree/main/php/pdo_pgsql/example "https://github.com/awslabs/aurora-dsql-connectors/tree/main/php/pdo_pgsql/example") on GitHub.
