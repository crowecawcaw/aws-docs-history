...
+ [`CREATE STATISTICS`](create-statistics-syntax-support.md)
+ [`ALTER STATISTICS`](alter-statistics-syntax-support.md)
+ [`DROP STATISTICS`](drop-statistics-syntax-support.md)
