...
| IAM features you can use with Amazon Aurora DSQL                                                                                                         | IAM feature | Aurora DSQL support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------- |
...
To see a list of Aurora DSQL actions, see [Actions Defined by Amazon Aurora DSQL](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") in the
...
[Resources Defined by Amazon Aurora DSQL](../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions Defined by Amazon Aurora DSQL](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") .
...
To see a list of Aurora DSQL condition keys, see [Condition keys for Amazon Aurora DSQL](../../../service-authorization/latest/reference/list_amazonauroradsql.md#amazonauroradsql-policy-keys "../../../service-authorization/latest/reference/list_amazonauroradsql.md#amazonauroradsql-policy-keys") in the _Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Amazon Aurora DSQL](../../../service-authorization/latest/reference/list_amazonauroradsql.md#amazonauroradsql-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonauroradsql.md#amazonauroradsql-actions-as-permissions").
...
For details about creating or managing service-linked roles for Aurora DSQL, see [Using service-linked roles in Aurora DSQL](working-with-service-linked-roles.md "working-with-service-linked-roles.md").
