...
Join the [Aurora DSQL Discord server](https://discord.com/invite/nEF6ksFWru "https://discord.com/invite/nEF6ksFWru") to connect with the AWS team and community. Share feature requests, discuss migration challenges, and get real-time feedback.
...
Use [AWS re:Post](https://repost.aws/ "https://repost.aws/") to ask questions and share feedback with the community and AWS experts.
