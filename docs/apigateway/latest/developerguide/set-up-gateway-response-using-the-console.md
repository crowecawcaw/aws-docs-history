...
response. 7. Under **Response templates**, keep
...
response body. 8. Choose **Save changes**. 9. Deploy the API to a new or existing stage.
...
Store](http://petstore-demo-endpoint.execute-api.com/petstore/pets "http://petstore-demo-endpoint.execute-api.com/petstore/pets") and the API has a stage variable, `a`,
defined.
