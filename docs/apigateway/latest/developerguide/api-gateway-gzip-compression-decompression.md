...
[supported content
codings](api-gateway-enable-compression.md#api-gateway-supported-content-encodings "api-gateway-enable-compression.md#api-gateway-supported-content-encodings"). By default, API Gateway supports decompression of the method request
payload. However, you must configure your API to enable compression of the method response
payload.

To enable compression on an [`API`](../api/API_RestApi.md "../api/API_RestApi.md"), set the [`minimumCompressionsSize`](../api/API_RestApi.md#minimumCompressionSize "../api/API_RestApi.md#minimumCompressionSize") property to a non-negative integer
