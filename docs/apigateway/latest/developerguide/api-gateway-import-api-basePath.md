...
In [OpenAPI 3.0](https://swagger.io/docs/specification/api-host-and-base-path/ "https://swagger.io/docs/specification/api-host-and-base-path/"), `basePath` is no longer a
top-level property. Instead, API Gateway uses a [server variable](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.0.md#serverVariableObject "https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.0.0.md#serverVariableObject") as a convention. The Import API
...
host. This can be used, for example, when you have a custom domain name with an API mapping that doesn't include a _Base
Path_ and a _Stage_ value that refers to your production stage.
