...
settings](#override-api-gateway-stage-cache-for-method-cache "#override-api-gateway-stage-cache-for-method-cache").

###### Important

Caching is charged by the hour based on the cache size that you select. Caching is not eligible for the AWS Free Tier. For more information, see [API Gateway Pricing](https://aws.amazon.com/api-gateway/pricing/ "https://aws.amazon.com/api-gateway/pricing/").
...
performance, but also costs more. For supported cache sizes, see [cacheClusterSize](../api/API_CreateStage.md#apigw-CreateStage-request-cacheClusterSize "../api/API_CreateStage.md#apigw-CreateStage-request-cacheClusterSize") in the _API Gateway API Reference_.
...
capacity to avoid hitting a rate limit?](https://repost.aws/knowledge-center/api-gateway-cache-capacity "https://repost.aws/knowledge-center/api-gateway-cache-capacity").

AWS Management Console In the API Gateway console, you configure caching on the **Stages** page. You provision the stage
...
information about method overrides, see [Override API Gateway stage-level caching for method-level caching](#override-api-gateway-stage-cache-for-method-cache "#override-api-gateway-stage-cache-for-method-cache").
...
This provisions a cache cluster for your stage. 6. To activate caching for your stage, turn on **Default method-level caching**.
...
![Turn on provision API cache and default method-level caching.](images/api-caching-stage-flow.png) 7. Choose **Save changes**.

AWS CLI
The following [update-stage](../../../cli/latest/reference/apigateway/update-stage.md "../../../cli/latest/reference/apigateway/update-stage.md") command
...
However, you can enable caching for other methods by [overriding method settings](#override-api-gateway-stage-cache-for-method-cache "#override-api-gateway-stage-cache-for-method-cache").
...
Caching is not active until you provision a cache cluster for your stage. 7. Choose **Save**.
...
![Include method or integration parameters as cache keys to index cached response](images/api-caching-including-parameter-as-cache-key-new-console.png)
...
The following [put-integration](../../../cli/latest/reference/apigateway/put-integration.md "../../../cli/latest/reference/apigateway/put-integration.md") command
...
AWS CLI
The following [flush-stage-cache](../../../cli/latest/reference/apigateway/flush-stage-cache.md "../../../cli/latest/reference/apigateway/flush-stage-cache.md")
...
permissions for the API Gateway execution service, see [Control access to a REST API with IAM permissions](permissions.md "permissions.md").
