...
proxy integration or an HTTP proxy integration. For details, see [Amazon API Gateway important notes](api-gateway-known-issues.md "api-gateway-known-issues.md").
...
limitations](api-gateway-known-issues.md "api-gateway-known-issues.md").
