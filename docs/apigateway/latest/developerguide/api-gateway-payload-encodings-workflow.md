...
configurations of a request's `Accept` header, the `binaryMediaTypes` list of a [RestApi](../api/API_RestApi.md "../api/API_RestApi.md") resource, and the `contentHandling` property value of the [IntegrationResponse](../api/API_IntegrationResponse.md "../api/API_IntegrationResponse.md")
resource.
...
conversion, although you must enable the [passthrough behaviors](integration-passthrough-behaviors.md "integration-passthrough-behaviors.md") on the
API.
...
[passthrough behaviors](integration-passthrough-behaviors.md "integration-passthrough-behaviors.md") on
the API.
