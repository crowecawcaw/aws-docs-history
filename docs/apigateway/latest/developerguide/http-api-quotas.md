...
| Multi-level API mappings per domain                     | 200 API mappings. This limit doesn't include API mapping with single levels, such as<br>`/prod`. | No                                                                                                                                                                                       |
...
| Authorizers per API                                     | 10                                                                                               | Yes<br>To increase this quota, contact the [AWS Support Center](https://console.aws.amazon.com/support/home#/ "https://console.aws.amazon.com/support/home#/")                           |
...
see [Export HTTP APIs from API Gateway](http-api-export.md "http-api-export.md").
