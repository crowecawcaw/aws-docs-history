...
- AWS CLI commands ([create-resource](../../../cli/latest/reference/apigateway/create-resource.md "../../../cli/latest/reference/apigateway/create-resource.md") and [put-method](../../../cli/latest/reference/apigateway/put-method.md "../../../cli/latest/reference/apigateway/put-method.md"))
- AWS SDK functions (for example, in Node.js, [createResource](../../../AWSJavaScriptSDK/latest/AWS/APIGateway.md#createResource-property "../../../AWSJavaScriptSDK/latest/AWS/APIGateway.md#createResource-property") and [putMethod](../../../AWSJavaScriptSDK/latest/AWS/APIGateway.md#putMethod-property "../../../AWSJavaScriptSDK/latest/AWS/APIGateway.md#putMethod-property"))
- API Gateway REST API ([resource:create](../api/API_CreateResource.md "../api/API_CreateResource.md") and [method:put](../api/API_PutMethod.md "../api/API_PutMethod.md")).
...
In an API Gateway API, you expose addressable resources as a tree of API [Resources](../api/API_GetResources.md "../api/API_GetResources.md") entities, with the root
...
see [create a custom domain name](how-to-custom-domains.md "how-to-custom-domains.md").

For the [PetStore sample
API](api-gateway-create-api-from-example.md "api-gateway-create-api-from-example.md"), the root resource (`/`) exposes the pet store. The
...
The following [get-resources](../../../cli/latest/reference/apigateway/get-resources.md "../../../cli/latest/reference/apigateway/get-resources.md") command
...
existing API set up. To avoid this, you can use an API Gateway [proxy resource](api-gateway-set-up-simple-proxy.md "api-gateway-set-up-simple-proxy.md") to expose a
...
The following [create-resource](../../../cli/latest/reference/apigateway/create-resource.md "../../../cli/latest/reference/apigateway/create-resource.md") command
