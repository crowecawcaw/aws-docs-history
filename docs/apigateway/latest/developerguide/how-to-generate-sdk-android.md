...
Before proceeding further, you must have already completed the steps in [Generate SDKs for REST APIs in API Gateway](how-to-generate-sdk.md "how-to-generate-sdk.md").

###### Note

The generated SDK is not compatible with Android 4.4 and earlier. For more information, see
[Amazon API Gateway important notes](api-gateway-known-issues.md "api-gateway-known-issues.md").
...
2. Download and install [Apache
   Maven](https://maven.apache.org/ "https://maven.apache.org/") (preferably version 3.x).
...
Make sure no duplicated .jar files are declared. 7. Use the `ApiClientFactory` class to initialize the API Gateway-generated
SDK. For example:
