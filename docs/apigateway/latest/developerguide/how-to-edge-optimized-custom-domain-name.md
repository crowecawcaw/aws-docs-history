...
1. Call [domainname:create](../api/API_CreateDomainName.md "../api/API_CreateDomainName.md"), specifying the
...
well as the associated CloudFront distribution name in its payload. 2. Note the CloudFront distribution domain name shown in the output. You need it in the next step to set the
custom domain's A-record alias target in your DNS.

For code examples of this REST API call, see [domainname:create](../api/API_CreateDomainName.md "../api/API_CreateDomainName.md").
...
custom domain names are not supported. For more information, see [Use API mappings to connect API stages to a custom domain name for REST APIs](rest-api-mappings.md "rest-api-mappings.md").
...
(optional) for the mapping. 7. Choose **Save**.

REST API
Call [basepathmapping:create](../api/API_CreateBasePathMapping.md "../api/API_CreateBasePathMapping.md") on a
...
For code examples of the REST API call, see [basepathmapping:create](../api/API_CreateBasePathMapping.md "../api/API_CreateBasePathMapping.md").
...
Resource Record Sets](../../../Route53/latest/DeveloperGuide/resource-record-sets-choosing-alias-non-alias.md "../../../Route53/latest/DeveloperGuide/resource-record-sets-choosing-alias-non-alias.md") in the _Amazon Route 53 Developer Guide_.
...
[To create or import an SSL/TLS certificate into ACM](how-to-specify-certificate-for-custom-domain-name.md#how-to-specify-certificate-for-custom-domain-name-setup "how-to-specify-certificate-for-custom-domain-name.md#how-to-specify-certificate-for-custom-domain-name-setup").
...
AWS Management Console1. Request or import a certificate in ACM. 2. Sign in to the API Gateway console at [https://console.aws.amazon.com/apigateway](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway"). 3. Choose **Custom domain names** from the API Gateway console main navigation pane. 4. Choose an edge-optimized custom domain name. 5. For **Endpoint configuration**, choose **Edit**. 6. For **ACM certificate**, select a certificate from dropdown list. 7. Choose **Save changes** to begin rotating the certificate for the custom domain name.

REST API
Call [domainname:update](../api/API_UpdateDomainName.md "../api/API_UpdateDomainName.md") action, specifying
...
[Amazon CloudFront Custom SSL](https://aws.amazon.com/cloudfront/custom-ssl-domains/ "https://aws.amazon.com/cloudfront/custom-ssl-domains/").
