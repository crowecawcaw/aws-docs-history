...
- **Standard AWS IAM roles and policies** offer flexible and
  ...
  APIs, as well as who can invoke them. For more information, see [Control access to a REST API with IAM permissions](permissions.md "permissions.md").
...
- **Usage plans** let you provide **API
  ...
  API stages and methods for each API key. For more information, see [Usage plans and API keys for REST APIs in API Gateway](api-gateway-api-usage-plans.md "api-gateway-api-usage-plans.md").
