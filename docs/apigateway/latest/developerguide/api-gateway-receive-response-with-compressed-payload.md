...
`Accept-Encoding` header with a [supported content coding](api-gateway-enable-compression.md#api-gateway-supported-content-encodings "api-gateway-enable-compression.md#api-gateway-supported-content-encodings").
...
in [RFC
7231](https://datatracker.ietf.org/doc/html/rfc7231#section-5.3.4 "https://datatracker.ietf.org/doc/html/rfc7231#section-5.3.4"). In such a case, API Gateway does not compress the payload. Some
