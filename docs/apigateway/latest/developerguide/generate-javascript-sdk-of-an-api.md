...
7. Choose **Generate SDK**, and then follow the on-screen
   ...
   Follow the instructions in [Use a JavaScript SDK generated by API Gateway for a REST API](how-to-generate-sdk-javascript.md "how-to-generate-sdk-javascript.md") to use the generated
   SDK.
