...
[logging variable](http-api-logging-variables.md "http-api-logging-variables.md") to your log format,
...
2. Sign in to the API Gateway console at [https://console.aws.amazon.com/apigateway](https://console.aws.amazon.com/apigateway "https://console.aws.amazon.com/apigateway").
...
![CloudWatch Logs log entry showing the integration error message from Lambda.](images/troubleshoot-http-api-logs.png)
...
response in the [required format](http-api-develop-integrations-lambda.md#http-api-develop-integrations-lambda.response "http-api-develop-integrations-lambda.md#http-api-develop-integrations-lambda.response"). If your logs
...
[Confirm the function policy](../../../lambda/latest/dg/access-control-resource-based.md "../../../lambda/latest/dg/access-control-resource-based.md") in the **Permissions** tab of
the Lambda console.
