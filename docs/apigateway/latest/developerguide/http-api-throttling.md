...
You can configure route-level throttling by using the AWS CLI. The following [update-stage](../../../cli/latest/reference/apigatewayv2/update-stage.md "../../../cli/latest/reference/apigatewayv2/update-stage.md") command configures custom throttling
