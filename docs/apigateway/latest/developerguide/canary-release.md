...
[Canary release](https://martinfowler.com/bliki/CanaryRelease.html "https://martinfowler.com/bliki/CanaryRelease.html") is a
...
- [Canary release deployment in API Gateway](#api-gateway-canary-release-deployment-overview "#api-gateway-canary-release-deployment-overview")
- [Create a canary release deployment](create-canary-deployment.md "create-canary-deployment.md")
- [Update a canary release](update-canary-deployment.md "update-canary-deployment.md")
- [Promote a canary release](promote-canary-deployment.md "promote-canary-deployment.md")
- [Turn off a canary release](delete-canary-deployment.md "delete-canary-deployment.md")
...
adding [canary settings](../api/API_Stage.md#canarySettings "../api/API_Stage.md#canarySettings")
to the [stage](../api/API_Stage.md "../api/API_Stage.md") of a regular [deployment](../api/API_Deployment.md "../api/API_Deployment.md"). The canary settings
...
- A deployment ID, initially identical to the ID of the base version deployment
  set on the stage.
- A [percentage of API
  traffic](../api/API_Stage.md#percentTraffic "../api/API_Stage.md#percentTraffic"), between 0.0 and 100.0 inclusive, for the canary release.
- [Stage variables
  for the canary release](../api/API_Stage.md#stageVariableOverrides "../api/API_Stage.md#stageVariableOverrides") that can override production release stage
  variables.
- The [use of the stage
  cache](../api/API_Stage.md#useStageCache "../api/API_Stage.md#useStageCache") for canary requests, if the [useStageCache](../api/API_Stage.md#useStageCache "../api/API_Stage.md#useStageCache") is
