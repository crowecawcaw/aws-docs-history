...
information about API Gateway mapping templates, see [Mapping template transformations for REST APIs in API Gateway](models-mappings.md "models-mappings.md").

The payload can have a _data model_ according to the [JSON schema draft 4](https://datatracker.ietf.org/doc/html/draft-zyp-json-schema-04 "https://datatracker.ietf.org/doc/html/draft-zyp-json-schema-04").
...
response](apigateway-websocket-api-integration-responses.md "apigateway-websocket-api-integration-responses.md"). This expression is evaluated to determine the input or output template
...
When you [set up an
integration response](apigateway-websocket-api-integration-responses.md "apigateway-websocket-api-integration-responses.md") for a WebSocket API, you can optionally specify an
