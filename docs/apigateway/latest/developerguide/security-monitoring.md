...
information, see [Set up CloudWatch logging for REST APIs in API Gateway](set-up-logging.md "set-up-logging.md").
...
information, see [Log REST API calls to Amazon Data Firehose in API Gateway](apigateway-logging-to-kinesis.md "apigateway-logging-to-kinesis.md").
...
you can use to identify issues with your application and opportunities for optimization. For more information, see [Set up AWS X-Ray with API Gateway REST APIs](apigateway-enabling-xray.md "apigateway-enabling-xray.md").
