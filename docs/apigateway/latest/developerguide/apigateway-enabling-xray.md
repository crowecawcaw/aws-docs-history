...
In this section you can find detailed information on how to set up [AWS X-Ray](../../../xray/latest/devguide/xray-services-apigateway.md "../../../xray/latest/devguide/xray-services-apigateway.md") with API Gateway REST APIs.
...
The following [create-stage](../../../cli/latest/reference/apigateway/create-stage.md "../../../cli/latest/reference/apigateway/create-stage.md") command creates a stage without active X-Ray tracing:
...
The following [update-stage](../../../cli/latest/reference/apigateway/update-stage.md "../../../cli/latest/reference/apigateway/update-stage.md") turns on active X-Ray tracing for a deployed API:
...
The following [update-stage](../../../cli/latest/reference/apigateway/update-stage.md "../../../cli/latest/reference/apigateway/update-stage.md") turns off active X-Ray tracing for a deployed API:
...
[Using the
X-Ray API with the AWS CLI](../../../xray/latest/devguide/aws-xray-interface-api.md#xray-api-tutorial "../../../xray/latest/devguide/aws-xray-interface-api.md#xray-api-tutorial").
