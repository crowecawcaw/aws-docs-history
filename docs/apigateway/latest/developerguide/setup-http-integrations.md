...
As part of the method request setup, you set the [requestParameters](../api/API_Method.md#requestParameters "../api/API_Method.md#requestParameters")
property on a [Method](../api/API_Method.md "../api/API_Method.md") resource. This
...
[requestParameters](../api/API_Integration.md#requestParameters "../api/API_Integration.md#requestParameters") property on the corresponding [Integration](../api/API_Integration.md "../api/API_Integration.md") resource to specify the
parameter-to-parameter mappings. You also set the [requestTemplates](../api/API_Integration.md#requestTemplates "../api/API_Integration.md#requestTemplates")
...
Similarly, as part of the method response setup, you set the [responseParameters](../api/API_MethodResponse.md#responseParameters "../api/API_MethodResponse.md#responseParameters") property on the [MethodResponse](../api/API_MethodResponse.md "../api/API_MethodResponse.md") resource. This declares which method response
...
[selectionPattern](../api/API_IntegrationResponse.md#selectionPattern "../api/API_IntegrationResponse.md#selectionPattern") to choose an integration response based on the response from the
...
API Gateway uses Java pattern-style regexes for response mapping. For more information, see [Pattern](https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html "https://docs.oracle.com/javase/8/docs/api/java/util/regex/Pattern.html") in the Oracle documentation.

Then, as part of the integration response setup, you set the [responseParameters](../api/API_IntegrationResponse.md#responseParameters "../api/API_IntegrationResponse.md#responseParameters") property on the
corresponding [IntegrationResponse](../api/API_IntegrationResponse.md "../api/API_IntegrationResponse.md") resource to
specify the parameter-to-parameter mappings. You also set the [responseTemplates](../api/API_IntegrationResponse.md#responseTemplates "../api/API_IntegrationResponse.md#responseTemplates") map to specify
...
For more information about setting up mapping templates, see [Data transformations for REST APIs in API Gateway](rest-api-data-transformations.md "rest-api-data-transformations.md").
