...
conditions that you define. For more information, see [How AWS WAF Works](../../../waf/latest/developerguide/how-aws-waf-works.md "../../../waf/latest/developerguide/how-aws-waf-works.md").
...
API, AWS WAF rules are evaluated before other access control features, such as [resource policies](apigateway-resource-policies.md "apigateway-resource-policies.md"), [IAM policies](permissions.md "permissions.md"), [Lambda authorizers](apigateway-use-lambda-authorizer.md "apigateway-use-lambda-authorizer.md"), and [Amazon Cognito authorizers](apigateway-integrate-with-cognito.md "apigateway-integrate-with-cognito.md"). For example,
...
1. Use the AWS WAF console, AWS SDK, or CLI to create a web ACL that contains
   ...
   AWS WAF](../../../waf/latest/developerguide/getting-started.md "../../../waf/latest/developerguide/getting-started.md") and [Web access control lists (web ACLs)](../../../waf/latest/developerguide/web-acl.md "../../../waf/latest/developerguide/web-acl.md").
...
The following [associate-web-acl](../../../cli/latest/reference/waf-regional/associate-web-acl.md "../../../cli/latest/reference/waf-regional/associate-web-acl.md") command associates an AWS WAF Classic Regional web ACL with an existing API Gateway API
stage:
...
API Gateway API stage, use the [AssociateWebACL](../../../waf/latest/APIReference/API_wafRegional_AssociateWebACL.md "../../../waf/latest/APIReference/API_wafRegional_AssociateWebACL.md") command, as in the following
example:
