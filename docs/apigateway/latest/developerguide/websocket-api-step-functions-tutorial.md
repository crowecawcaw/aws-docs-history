...
- [Prerequisites](#websocket-api-step-functions-prerequisites "#websocket-api-step-functions-prerequisites")
- [Step 1: Create resources](#websocket-api-step-functions-create-dependencies "#websocket-api-step-functions-create-dependencies")
- [Step 2: Create a WebSocket API](#websocket-api-step-functions-create-api "#websocket-api-step-functions-create-api")
- [Step 3: Create a Lambda authorizer](#websocket-api-step-functions-create-authorizer "#websocket-api-step-functions-create-authorizer")
- [Step 4: Create a mock two-way integration](#websocket-api-step-functions-create-mock-integration "#websocket-api-step-functions-create-mock-integration")
- [Step 5: Create a non-proxy integration with Step Functions](#websocket-api-step-functions-create-step-function-integration "#websocket-api-step-functions-create-step-function-integration")
- [Step 6: Test your API](#websocket-api-step-functions-test-api "#websocket-api-step-functions-test-api")
- [Step 7: Clean up](#websocket-api-step-functions-cleanup "#websocket-api-step-functions-cleanup")
- [Next steps](#websocket-api-step-functions-next-steps "#websocket-api-step-functions-next-steps")
...
The route selection expression determines the route that API Gateway invokes when a client sends a message. 6. Choose **Next**. 7. For **Predefined routes**, choose **Add $connect**, **Add $disconnect**, **Add $default**.
...
In a mock integration, API Gateway manages the route response without an integration backend. 12. Choose **Next**. 13. Review the stage that API Gateway creates for you. By default, API Gateway creates a stage named
**production** and automatically deploys your API to that stage. Choose
**Next**. 14. Choose **Create and deploy**.
...
We recommend that you don't use this example authorizer for your production APIs. 6. For **Identity source type**, choose **Header**. For **Key**, enter `Authorization`. 7. Choose **Create authorizer**.
...
![Integration response configuration for mock integration for the $default route.](images/ws-sfn-mock-integration-response.png)
