...
AWS Management Console###### To change the IP address type of an HTTP API
...
AWS CLI
The following [update-api](../../../cli/latest/reference/apigatewayv2/update-api.md "../../../cli/latest/reference/apigatewayv2/update-api.md")
