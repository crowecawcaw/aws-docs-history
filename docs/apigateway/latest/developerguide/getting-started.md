...
to complete, and is possible within the [AWS Free Tier](https://aws.amazon.com/free/ "https://aws.amazon.com/free/").
...
[Get started with the REST API console](getting-started-rest-new-console.md "getting-started-rest-new-console.md").

For more information about the difference between HTTP APIs and REST APIs, see [Choose between REST APIs and HTTP APIs](http-api-vs-rest.md "http-api-vs-rest.md").
...
![Overview of the HTTP API that you create in this tutorial.](images/getting-started-overview.png)
...
- [Step 1: Create a Lambda function](#getting-started-create-function "#getting-started-create-function")
- [Step 2: Create an HTTP API](#getting-started-create-api "#getting-started-create-api")
- [Step 3: Test your API](#getting-started-invoke-api "#getting-started-invoke-api")
- [(Optional) Step 4: Clean up](#getting-started-cleanup "#getting-started-cleanup")
...
1. Sign in to the Lambda console at [https://console.aws.amazon.com/lambda](https://console.aws.amazon.com/lambda "https://console.aws.amazon.com/lambda").
...
You can modify your Lambda function, as long as the function's response aligns with the [format that API Gateway requires](http-api-develop-integrations-lambda.md#http-api-develop-integrations-lambda.response "http-api-develop-integrations-lambda.md#http-api-develop-integrations-lambda.response").
...
7. Choose **Next**.
8. Review the _route_ that API Gateway creates for you, and then choose
   **Next**.
9. Review the _stage_ that API Gateway creates for you, and then choose
   **Next**.
10. Choose **Create**.
...
Your browser sends a `GET` request to the API. 5. Verify your API's response. You should see the text `"Hello from Lambda!"` in your
browser.
...
1. In the Amazon CloudWatch console, open the [Log groups
   page](https://console.aws.amazon.com/cloudwatch/home#logs: "https://console.aws.amazon.com/cloudwatch/home#logs:").
...
1. In the AWS Identity and Access Management console, open the [Roles
   page](https://console.aws.amazon.com/iam/home?#/roles "https://console.aws.amazon.com/iam/home?#/roles").
...
- [Configure additional types of API integrations,](http-api-develop-integrations.md "http-api-develop-integrations.md")
  ...
  - [AWS services such as Amazon Simple Queue Service,
    AWS Step Functions, and Kinesis Data Streams](http-api-develop-integrations-aws-services.md "http-api-develop-integrations-aws-services.md")

- [Control access to your APIs](http-api-access-control.md "http-api-access-control.md")
- [Enable logging for your APIs](http-api-logging.md "http-api-logging.md")
- [Configure throttling for your APIs](http-api-throttling.md "http-api-throttling.md")
- [Configure custom domains for your APIs](http-api-custom-domain-names.md "http-api-custom-domain-names.md")

To get help with Amazon API Gateway from the community, see the
[API Gateway Discussion
Forum](https://repost.aws/tags/TAx94GNHn2R3Ot5Ab_HCvlng "https://repost.aws/tags/TAx94GNHn2R3Ot5Ab_HCvlng"). When you enter this forum, AWS might require you to sign in.

To get help with API Gateway directly from AWS, see the support options on the [AWS Support page](https://aws.amazon.com/premiumsupport/ "https://aws.amazon.com/premiumsupport/").

See also our [frequently asked questions (FAQs)](https://aws.amazon.com/api-gateway/faqs/ "https://aws.amazon.com/api-gateway/faqs/"), or
[contact us directly](https://aws.amazon.com/contact-us/ "https://aws.amazon.com/contact-us/").
