...
- [Create and attach an API Gateway
  resource policy to an API](apigateway-resource-policies-create-attach.md "apigateway-resource-policies-create-attach.md")
- [AWS condition keys
  that can be used in API Gateway resource policies](apigateway-resource-policies-aws-condition-keys.md "apigateway-resource-policies-aws-condition-keys.md")
