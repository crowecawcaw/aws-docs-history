...
of the Amazon API Gateway Control Service. To use the API Gateway Export API, you need to sign your API requests. For more information about signing requests, see [Signing AWS API requests](../../../IAM/latest/UserGuide/reference_aws-signing.md "../../../IAM/latest/UserGuide/reference_aws-signing.md") in the _IAM User Guide_. You have options to include the API Gateway
integration extensions, as well as the [Postman](https://www.postman.com "https://www.postman.com") extensions, in the exported OpenAPI definition file.
...
API, see [GetExport](../api/API_GetExport.md "../api/API_GetExport.md").
...
![Export REST API using the API Gateway console](images/export-new-console.png)
