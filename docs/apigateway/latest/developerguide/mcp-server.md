...
information, see
[API Gateway
REST API stages as targets](../../../bedrock-agentcore/latest/devguide/gateway-target-api-gateway.md "../../../bedrock-agentcore/latest/devguide/gateway-target-api-gateway.md") in the _Amazon Bedrock AgentCore
...
- Every method of your API must either have an [operation name](../api/API_PutMethod.md#apigw-PutMethod-request-operationName "../api/API_PutMethod.md#apigw-PutMethod-request-operationName")
...
- You can use `API_KEY`, `NO_AUTH`, or `GATEWAY_IAM_ROLE` credential
  ...
  [Setting up
  Outbound Auth](../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md "../../../bedrock-agentcore/latest/devguide/gateway-outbound-auth.md").
...
the endpoint. 10. The combination of the resource and the method are the operations for the tool. If your operation does not
have a name, create a name override.

You can also define an operation name for a method when you create it. 11. For **Outbound Auth configuration**, choose either **IAM Role** ,
**No authorization** or
**API key**. 12. Choose **Create target**.
...
[Add
targets to an existing AgentCore Gateway](../../../bedrock-agentcore/latest/devguide/gateway-building-adding-targets.md "../../../bedrock-agentcore/latest/devguide/gateway-building-adding-targets.md").
