...
partial responses back to the client as they become available. API Gateway requires you to use the [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") Lambda API to invoke
...
- API Gateway uses the
  [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") API to invoke the Lambda proxy integration for response
...
| ---------------------- | -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stream                 | Yes                                          | [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") | Yes. API Gateway streams your response.                                                                                                                                      |
| Stream                 | No                                           | [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") | No. API Gateway invokes your Lambda function and return a 500 error response.                                                                                                |
| Stream                 | Yes                                          | [Invoke](../../../lambda/latest/api/API_Invoke.md "../../../lambda/latest/api/API_Invoke.md")                                                       | No. API Gateway doesn't support this integration configuration.                                                                                                              |
| Stream                 | No                                           | [Invoke](../../../lambda/latest/api/API_Invoke.md "../../../lambda/latest/api/API_Invoke.md")                                                       | No. API Gateway doesn't support this integration configuration.                                                                                                              |
| Buffered               | Yes                                          | [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") | No. API Gateway doesn't support this integration configuration.                                                                                                              |
| Buffered               | No                                           | [InvokeWithResponseStream](../../../lambda/latest/api/API_InvokeWithResponseStream.md "../../../lambda/latest/api/API_InvokeWithResponseStream.md") | No. API Gateway doesn't support this integration configuration.                                                                                                              |
| Buffered               | Yes                                          | [Invoke](../../../lambda/latest/api/API_Invoke.md "../../../lambda/latest/api/API_Invoke.md")                                                       | API Gateway returns the HTTP headers and status code but not the response body.                                                                                              |
| Buffered               | No                                           | [Invoke](../../../lambda/latest/api/API_Invoke.md "../../../lambda/latest/api/API_Invoke.md")                                                       | Yes. This is a Lambda proxy integration. For more information, see<br>[Lambda proxy integration](set-up-lambda-proxy-integrations.md "set-up-lambda-proxy-integrations.md"). |
