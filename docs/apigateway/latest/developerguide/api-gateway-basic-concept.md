...
- Creating, deploying, and managing a [RESTful](https://en.wikipedia.org/wiki/Representational_state_transfer "https://en.wikipedia.org/wiki/Representational_state_transfer") application programming interface (API) to expose
  backend HTTP endpoints, AWS Lambda functions, or other AWS
  services.
- Creating, deploying, and managing a [WebSocket](https://datatracker.ietf.org/doc/html/rfc6455 "https://datatracker.ietf.org/doc/html/rfc6455") API to
...
one or more API methods that have unique HTTP verbs supported by API Gateway. For more information, see [Choose between REST APIs and HTTP APIs](http-api-vs-rest.md "http-api-vs-rest.md").
...
verbs supported by API Gateway. For more information, see [Choose between REST APIs and HTTP APIs](http-api-vs-rest.md "http-api-vs-rest.md").
...
- [Edge-optimized API endpoint](#apigateway-definition-edge-optimized-api-endpoint "#apigateway-definition-edge-optimized-api-endpoint")
- [Private API
  endpoint](#apigateway-definition-private-api-endpoint "#apigateway-definition-private-api-endpoint")
- [Regional
  API endpoint](#apigateway-definition-regional-api-endpoint "#apigateway-definition-regional-api-endpoint")
...
authorizers](apigateway-use-lambda-authorizer.md "apigateway-use-lambda-authorizer.md") or [usage
plans](api-gateway-api-usage-plans.md "api-gateway-api-usage-plans.md") to control access to your APIs.

See [API
endpoints](#apigateway-definition-api-endpoints "#apigateway-definition-api-endpoints").

**API owner**

See [API
developer](#apigateway-definition-api-developer "#apigateway-definition-api-developer").
...
customers. An app developer is typically identified by an [API key](#apigateway-definition-api-key "#apigateway-definition-api-key").
...
Template Language (VTL)](https://velocity.apache.org/engine/devel/vtl-reference.html "https://velocity.apache.org/engine/devel/vtl-reference.html") that transforms a request body from the
...
transform](https://en.wikipedia.org/wiki/Identity_transform "https://en.wikipedia.org/wiki/Identity_transform") that passes the headers or body through the integration
...
See [Private API
endpoint](#apigateway-definition-private-api "#apigateway-definition-private-api").
...
routing](../../../Route53/latest/DeveloperGuide/routing-policy.md#routing-policy-latency "../../../Route53/latest/DeveloperGuide/routing-policy.md#routing-policy-latency") on Regional endpoints to deploy an API to multiple Regions
...
A [usage plan](api-gateway-api-usage-plans.md "api-gateway-api-usage-plans.md") provides
