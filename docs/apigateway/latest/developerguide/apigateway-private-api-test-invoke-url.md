...
For more information, see [Custom domain names for private APIs in API Gateway](apigateway-private-custom-domains.md "apigateway-private-custom-domains.md").
...
AWS Management Console###### To find the DNS names
...
AWS CLI
Use the following
[describe-vpc-endpoints](../../../cli/latest/reference/ec2/describe-vpc-endpoints.md "../../../cli/latest/reference/ec2/describe-vpc-endpoints.md") command to list your DNS values.
