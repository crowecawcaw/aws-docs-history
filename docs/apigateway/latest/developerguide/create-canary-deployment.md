...
settings](../api/API_CreateDeployment.md#canarySettings "../api/API_CreateDeployment.md#canarySettings") as an additional input to the [deployment creation](../api/API_CreateDeployment.md "../api/API_CreateDeployment.md")
operation.

You can also create a canary release deployment from an existing non-canary deployment
by making a [`stage:update`](../api/API_UpdateStage.md "../api/API_UpdateStage.md") request to add the canary settings on the
stage.
...
[Use stage variables for a REST API in API Gateway](stage-variables.md "stage-variables.md"). 7. Choose the **Canary** tab, and then choose **Create
canary**. You might need to choose the right arrow button to show the **Canary** tab. 8. Under **Canary settings**, for **Canary**, enter the percentage of requests to be diverted to the
canary. 9. If desired, select **Stage cache** to
turn on caching for the canary release. The cache is not
available for the canary release until API caching is enabled. 10. To override existing stage variables, for **Canary override**, enter a new stage variable value.
...
1. Use the following [create-deployment](../../../cli/latest/reference/apigateway/create-deployment.md "../../../cli/latest/reference/apigateway/create-deployment.md") command
...
2. Use the following [create-deployment](../../../cli/latest/reference/apigateway/create-deployment.md "../../../cli/latest/reference/apigateway/create-deployment.md") command
...
for the canary release. As a result, the associated stage is canary-enabled. 3. (Optional) Use the following [get-stage](../../../cli/latest/reference/apigateway/get-stage.md "../../../cli/latest/reference/apigateway/get-stage.md") command to view the stage representation:
...
1. Use the [create-deployment](../../../cli/latest/reference/apigateway/create-deployment.md "../../../cli/latest/reference/apigateway/create-deployment.md") command to
...
2. Use the [update-stage](../../../cli/latest/reference/apigateway/update-stage.md "../../../cli/latest/reference/apigateway/update-stage.md") command to update
