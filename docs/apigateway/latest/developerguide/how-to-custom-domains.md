...
For information about custom domain names for private APIs, see [Custom domain names for private APIs in API Gateway](apigateway-private-custom-domains.md "apigateway-private-custom-domains.md").
...
- A Regional custom domain name can be associated with REST APIs and HTTP APIs. You can use the
  ...
  APIs](../../../apigatewayv2/latest/api-reference/api-reference.md "../../../apigatewayv2/latest/api-reference/api-reference.md") to create and manage Regional custom domain names for REST APIs.
...
custom domain names for private APIs, see [Custom domain names for private APIs in API Gateway](apigateway-private-custom-domains.md "apigateway-private-custom-domains.md").

### Register a domain name

You must have a registered internet domain name in order to set up custom domain names for your APIs. You
can register your internet domain name using [Amazon Route 53](../../../Route53/latest/DeveloperGuide.md "../../../Route53/latest/DeveloperGuide.md") or using a third-party
...
1035](https://tools.ietf.org/html/rfc1035#section-2.3.4 "https://tools.ietf.org/html/rfc1035#section-2.3.4") specification and can have a maximum of 63 octets per label and 255 octets in total.
...
your domain after AWS renews the certificate. For more information, see [Certificate pinning problems](../../../acm/latest/userguide/troubleshooting-pinning.md "../../../acm/latest/userguide/troubleshooting-pinning.md") in the
_AWS Certificate Manager User Guide_.

## Wildcard custom domain names

With wildcard custom domain names, you can support an almost infinite number of domain names without exceeding the [default quota](limits.md "limits.md"). For
...
determine the domain name that a client used to call your API. To learn more about context variables, see [Variables for data transformations for API Gateway](api-gateway-mapping-template-reference.md "api-gateway-mapping-template-reference.md").
...
If account A and account B share an owner, you can contact the [AWS Support Center](https://console.aws.amazon.com/support/home#/ "https://console.aws.amazon.com/support/home#/") to request an
exception.
