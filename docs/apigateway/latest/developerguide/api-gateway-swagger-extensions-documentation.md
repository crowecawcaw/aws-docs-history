...
| -------------------- | -------- | ------------------------------------------------------------------------------ |
| `documentationParts` | `Array`  | An array of the exported or imported<br>`DocumentationPart` instances.         |
| `version`            | `String` | The version identifier of the snapshot of the exported<br>documentation parts. |
