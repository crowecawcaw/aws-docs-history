...
![Overview of the private API you create in this tutorial.](images/private-api-tutorial-diagram.png)
...
- [Step 1: Create dependencies](#private-api-tutorial-create-dependencies "#private-api-tutorial-create-dependencies")
- [Step 2: Create a private API](#private-api-tutorial-create-api "#private-api-tutorial-create-api")
...
You attach a [resource policy](apigateway-resource-policies.md "apigateway-resource-policies.md") to your API that allows
clients to invoke your API only through your VPC endpoint. To further restrict access to your API, you can also
configure a [VPC endpoint policy](apigateway-vpc-endpoint-policies.md "apigateway-vpc-endpoint-policies.md") for your VPC endpoint,
...
![You use Session Manager to invoke your API from within your Amazon VPC.](images/private-api-tutorial-invoke.png)
