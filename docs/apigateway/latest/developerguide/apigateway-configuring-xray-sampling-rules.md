...
- [Configure sampling rules](../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console-sampling "../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console-sampling")
- [Using Sampling Rules with the X-Ray
  API](../../../xray/latest/devguide/aws-xray-interface-api.md#xray-api-sampling "../../../xray/latest/devguide/aws-xray-interface-api.md#xray-api-sampling")
...
- **Service name** (string) — API stage
  name, in the form
  ``{api-name}`/`{stage-name}``.
  For example, if you were to deploy the [PetStore](api-gateway-create-api-from-example.md "api-gateway-create-api-from-example.md") sample
...
more information about ARN formats, see the [Amazon Web Services General Reference](../../../general/latest/gr.md "../../../general/latest/gr.md").
