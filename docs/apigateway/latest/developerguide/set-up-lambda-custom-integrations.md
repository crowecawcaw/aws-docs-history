...
You use the API `id` (
`te6si5ach7`) and the `rootResourceId` (`krznpq9xpg`) throughout this example. 2. Use the following [create-resource](../../../cli/latest/reference/apigateway/create-resource.md "../../../cli/latest/reference/apigateway/create-resource.md")
command to create an API Gateway [Resource](../api/API_Resource.md "../api/API_Resource.md") of
`/greeting`:
...
method on the `/greeting` resource in the next step. 3. Use the following [put-method](../../../cli/latest/reference/apigateway/put-method.md "../../../cli/latest/reference/apigateway/put-method.md") command to
...
caller. 4. Use the following [put-method-response](../../../cli/latest/reference/apigateway/put-method-response.md "../../../cli/latest/reference/apigateway/put-method-response.md") command to set up the `200 OK` response to the method request of
...
action for function invocations](../../../lambda/latest/api/API_Invoke.md "../../../lambda/latest/api/API_Invoke.md"). The `uri` parameter
...
supplying an IAM role for `credentials`, you can call the [add-permission](../../../cli/latest/reference/lambda/add-permission.md "../../../cli/latest/reference/lambda/add-permission.md") command
to add resource-based permissions. This is how the API Gateway console adds these
permissions. 6. Use the following [put-integration-response](../../../cli/latest/reference/apigateway/put-integration-response.md "../../../cli/latest/reference/apigateway/put-integration-response.md") command to set up the integration response to pass the Lambda function
...
7. Use the following [create-deployment](../../../cli/latest/reference/apigateway/create-deployment.md "../../../cli/latest/reference/apigateway/create-deployment.md")
