...
+ You want to store connection IDs, domain names, or other connection details in a database (for example, Amazon DynamoDB). The connection ID is a variable-length string whose length and format might change.
