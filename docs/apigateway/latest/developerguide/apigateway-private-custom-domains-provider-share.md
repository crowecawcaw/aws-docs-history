...
- After you create the resource share, AWS RAM updates the `managementPolicy` for the
  ...
  whether a request is allowed or denied within an account](../../../IAM/latest/UserGuide/reference_policies_evaluation-logic.md#policy-eval-denyallow "../../../IAM/latest/UserGuide/reference_policies_evaluation-logic.md#policy-eval-denyallow") in the IAM User Guide.
...
[Creating a
resource share in AWS RAM](../../../ram/latest/userguide/working-with-sharing-create.md "../../../ram/latest/userguide/working-with-sharing-create.md") in the _AWS RAM User Guide_.

For **Select resource type**, choose
**API Gateway Private Custom Domains**.

AWS CLI
The following [create-resource-share](../../../cli/latest/reference/ram/create-resource-share.md "../../../cli/latest/reference/ram/create-resource-share.md")
...
the **Domain details** page of your private custom domain name. 6. Choose **Save changes**.
