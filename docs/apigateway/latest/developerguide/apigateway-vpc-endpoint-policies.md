...
to Services with VPC Endpoints](../../../vpc/latest/privatelink/vpc-endpoints-access.md "../../../vpc/latest/privatelink/vpc-endpoints-access.md").
...
| Valid [SigV4 or SigV4a](../../../IAM/latest/UserGuide/reference_sigv.md "../../../IAM/latest/UserGuide/reference_sigv.md") signature   | The invoker is evaluated as the authenticated IAM identity from the signature |
| Invalid [SigV4 or SigV4a](../../../IAM/latest/UserGuide/reference_sigv.md "../../../IAM/latest/UserGuide/reference_sigv.md") signature | API Gateway denies access                                                     |
...
- If your access control depends on using a bearer token, such as a Lambda or Amazon Cognito authorizer, you can
  control your security perimeter by using [properties of the resource](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-properties "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-properties").
- If your authorization controls use IAM
  authorization, you can control your security perimeter by using [properties of the resource](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-properties "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-properties") and
  [properties of the principal](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-principal "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-resource-principal").
...
This might depend on the contents of your authorization header. For more information, see [VPC endpoint policy considerations](#apigateway-vpc-endpoint-policies-considerations "#apigateway-vpc-endpoint-policies-considerations"). For additional example policies, see [Data perimeter policy examples](https://github.com/aws-samples/data-perimeter-policy-examples "https://github.com/aws-samples/data-perimeter-policy-examples") on the GitHub website.
...
custom domain name. For more information, see [Custom domain names for private APIs in API Gateway](apigateway-private-custom-domains.md "apigateway-private-custom-domains.md").
...
user can invoke allowed private APIs and domain resources. For more information, see [Custom domain names for private APIs in API Gateway](apigateway-private-custom-domains.md "apigateway-private-custom-domains.md").
