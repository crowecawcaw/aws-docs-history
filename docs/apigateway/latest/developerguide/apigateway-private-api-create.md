...
To follow these steps, you must have a fully configured VPC. To learn how to create a VPC, see [Create a VPC only](../../../vpc/latest/userguide/create-vpc.md#create-vpc-only "../../../vpc/latest/userguide/create-vpc.md#create-vpc-only") in
...
VPC](../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support "../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-support") and [Updating DNS Support for Your VPC](../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-updating "../../../vpc/latest/userguide/vpc-dns.md#vpc-dns-updating").
...
security group in your VPC. 11. For **Policy**, do one of the following:
...
AWS CLIThe following [create-vpc-endpoint](../../../cli/latest/reference/ec2/create-vpc-endpoint.md "../../../cli/latest/reference/ec2/create-vpc-endpoint.md") command creates a VPC endpoint:
...
AWS Management Console###### To create a private API
...
AWS CLIThe following [create-rest-api](../../../cli/latest/reference/apigateway/create-rest-api.md "../../../cli/latest/reference/apigateway/create-rest-api.md") command creates a private API:
...
AWS CLIThe following [update-rest-api](../../../cli/latest/reference/apigateway/update-rest-api.md "../../../cli/latest/reference/apigateway/update-rest-api.md") command attaches a resource policy to an existing API:
...
The following [create-rest-api](../../../cli/latest/reference/apigateway/create-rest-api.md "../../../cli/latest/reference/apigateway/create-rest-api.md")
...
AWS Management Console###### To deploy a private API
...
AWS CLIThe following [create-deployment](../../../cli/latest/reference/apigateway/create-deployment.md "../../../cli/latest/reference/apigateway/create-deployment.md") command deploys a private API:
...
method, see [Methods for REST APIs in API Gateway](how-to-method-settings.md "how-to-method-settings.md").
