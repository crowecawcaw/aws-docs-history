...
the `selectionPattern` property of the [IntegrationResponse](../api/API_IntegrationResponse.md "../api/API_IntegrationResponse.md")
...
For example, use the following [put-integration-response](../../../cli/latest/reference/apigateway/put-integration-response.md "../../../cli/latest/reference/apigateway/put-integration-response.md") to set up a
...
[method response](api-gateway-method-settings-method-response.md#setup-method-response-status-code "api-gateway-method-settings-method-response.md#setup-method-response-status-code"). Otherwise,
...
call the [update-integration-response](../../../cli/latest/reference/apigateway/update-integration-response.md "../../../cli/latest/reference/apigateway/update-integration-response.md") operation to replace the
...
properties to the `error_type`, `error_status`,
`error_trace_function`, and `error_trace` headers,
respectively.
...
`error_trace`, `error_trace_function`, and
...
complex property. It is mapped to the `error_trace` header as a JSON string.
