...
`'Event'` as the [Lambda
invocation type](../../../lambda/latest/dg/lambda-invocation.md "../../../lambda/latest/dg/lambda-invocation.md"). This is done as follows:
...
1. Add the following header on any [OpenAPI Path Item Object](https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md#pathItemObject "https://github.com/OAI/OpenAPI-Specification/blob/main/versions/3.1.0.md#pathItemObject").
