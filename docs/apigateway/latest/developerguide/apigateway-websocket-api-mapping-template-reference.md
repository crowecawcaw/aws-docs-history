...
| --- | --- | 
| $context.connectionId | A unique ID for the connection that you can use to make a callback to the client. The connection ID is a variable-length string whose length and format might change. | 
