...
- [Set up a Lambda integration](#how-to-method-settings-console-lambda "#how-to-method-settings-console-lambda")
- [Set up an HTTP integration](#how-to-method-settings-console-http "#how-to-method-settings-console-http")
- [Set up an AWS service integration](#how-to-method-settings-console-aws "#how-to-method-settings-console-aws")
- [Set up a mock integration](#how-to-method-settings-console-mock "#how-to-method-settings-console-mock")
...
4. To use an HTTP proxy integration, turn on **HTTP proxy integration**. To learn more about HTTP proxy integrations, see [Set up HTTP proxy integrations in API Gateway](setup-http-integrations.md#api-gateway-set-up-http-proxy-integration-on-proxy-resource "setup-http-integrations.md#api-gateway-set-up-http-proxy-integration-on-proxy-resource").
