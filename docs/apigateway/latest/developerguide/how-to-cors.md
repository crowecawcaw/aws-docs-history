...
- Any additional requirements that are listed in the [Mozilla CORS documentation for simple requests](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#Simple_requests "https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS#Simple_requests").
...
protocol](https://fetch.spec.whatwg.org/#http-cors-protocol "https://fetch.spec.whatwg.org/#http-cors-protocol") requires the browser to send a preflight request to the server and wait for approval (or a
...
The following
[update-integration](../../../cli/latest/reference/apigateway/update-integration.md "../../../cli/latest/reference/apigateway/update-integration.md") command changes the
...
The following [update-integration-response](../../../cli/latest/reference/apigateway/update-integration-response.md "../../../cli/latest/reference/apigateway/update-integration-response.md") command changes the
