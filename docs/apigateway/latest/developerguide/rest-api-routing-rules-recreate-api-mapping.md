...
[Strip the base path with base path conditions](rest-api-routing-rules.md#rest-api-routing-rules-condition-path-split "rest-api-routing-rules.md#rest-api-routing-rules-condition-path-split").
...
rules always take priority over API mappings. 9. Choose **Save changes**.
...
If you don't have a log group, see [Set up CloudWatch logging for REST APIs in API Gateway](set-up-logging.md "set-up-logging.md"). 5. Add `$context.customDomain.routingRuleIdMatched` to your log format.
...
1. Use the following [update-domain-name](../../../cli/latest/reference/apigatewayv2/update-domain-name.md "../../../cli/latest/reference/apigatewayv2/update-domain-name.md") command to update the domain name
...
2. Use the following
   [create-routing-rule](../../../cli/latest/reference/apigatewayv2/create-routing-rule.md "../../../cli/latest/reference/apigatewayv2/create-routing-rule.md") command to create a new routing rule to recreate the API mapping
...
3. Use the following [update-stage](../../../cli/latest/reference/apigateway/update-stage.md "../../../cli/latest/reference/apigateway/update-stage.md") command to update the access logs format to include the
   ...
   routing rule to send traffic to your API. For more information, see [I can't tell how API Gateway sent traffic to my APIs](rest-api-routing-rules-troubleshoot.md#rest-api-routing-rules-logging "rest-api-routing-rules-troubleshoot.md#rest-api-routing-rules-logging").
...
If you don't have a log group, see [Set up CloudWatch logging for REST APIs in API Gateway](set-up-logging.md "set-up-logging.md"). 4. Use the following example curl command to invoke your custom domain name with the base path
`orders/v2/items/categories/5`.
...
5. Use the following
   [filter-log-events](../../../cli/latest/reference/logs/filter-log-events.md "../../../cli/latest/reference/logs/filter-log-events.md") command to get the log events from the log group
