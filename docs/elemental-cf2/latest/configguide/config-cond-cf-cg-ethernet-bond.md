...
<a name="config-cond-cf-cg-ethernet-bond"></a>
...
**Topics**
+ [Step A: Create the Bond](#config-cond-cf-cg-ethernet-bond-create)
+ [Step B: Assign the Devices](#config-cond-cf-cg-ethernet-bond-assign)
...
<a name="config-cond-cf-cg-ethernet-bond-create"></a>
...
<a name="config-cond-cf-cg-ethernet-bond-assign"></a>
