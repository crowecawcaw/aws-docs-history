...
This screen has a warning in red. It does not apply the first time you set up network devices. 4. On the **Network Devices** tab, choose **Add Network Device**. 5. In the **Add Network Device** dialog, select **eth** as the device type and choose **Save**. 6. In the **Edit a Network Device** dialog, complete the fields as follows:
