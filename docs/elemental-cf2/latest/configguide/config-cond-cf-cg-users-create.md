...
The policies determine what actions a user can perform on the node. AWS Elemental Conductor File comes
...
1. Log in to the AWS Elemental Conductor File web interface using administrator credentials.
