...
![Network Devices list showing bond0, eth0, and eth1 with their configurations and statuses.](images/confc-device-shared-png.png) 3. If you have additional worker nodes, switch to the web interface for each node and repeat these steps.
