...
<a name="config-cond-cf-cg-users-manage"></a>
...
1. Go to the **Settings** page and choose **Authentication**. 

1. Review the current values for the fields. Make any changes and choose **Save**.