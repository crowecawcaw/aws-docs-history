...
Refer to the essential notes in the [AWS Elemental Conductor File Release Notes](../../../elemental-onprem/latest/pdf/elemental_server_conductor_file_release_notes_2.18.0.pdf.md "../../../elemental-onprem/latest/pdf/elemental_server_conductor_file_release_notes_2.18.0.pdf.md") to identify key changes to
