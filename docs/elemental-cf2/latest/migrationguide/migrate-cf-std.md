...
In this procedure, we show how to upgrade the cluster from Conductor File version 2.17.5 (worker nodes version 2.17.5) to version 2.17.5). Modify the commands you enter to match your versions.
...
**Topics**
+ [Plan maintenance windows for migrating an AWS Elemental Conductor File cluster](migrate-std-plan-maintenance.md)
+ [Step A: Get ready to migrate an AWS Elemental Conductor File cluster](migrate-std-get-ready.md)
...
+ [Step E: Upgrade nodes](migrate-server-218-install-software-cf.md)
