...
<a name="install-vm-cf-ig"></a>

This section is for IT administrators who perform the first-time installation of AWS Elemental Conductor File software on a VM (virtual machine).
...
**Phase 1 Setup**  
This section explains how to perform the phase 1 setup on each blade, including the following:
...
**Topics**
+ [Step A: Prepare the Hardware and Download Files](install-vm-cf-ig-prep.md)
+ [Step B: Deploy the VM](install-vm-cf-ig-install-vm.md)
+ [Step C: Install the AWS Elemental Software](install-vm-cf-ig-install-sw.md)
+ [Step D: Set-up Licensing](install-vm-cf-ig-licensing.md)
+ [Step E: Complete Node Configuration](install-vm-cf-ig-complete.md)