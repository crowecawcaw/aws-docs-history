...
<a name="install-cf-ig"></a>

This section is for IT administrators who perform the first-time installation of AWS Elemental Conductor File software on a hardware unit that is considered qualified hardware.
