...
![License management interface showing options to upload or update license files.](https://docs.aws.amazon.com/elemental-cf2/latest/installguide/images/install-installlic-shared-png.png)
