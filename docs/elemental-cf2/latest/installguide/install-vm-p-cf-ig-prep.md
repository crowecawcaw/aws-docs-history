...
<a name="install-vm-p-cf-ig-prep"></a>

## Determine the Primary Conductor Node
<a name="install-vm-p-cf-ig-cond"></a>
...
<a name="install-vm-p-cf-ig-prep-hw"></a>
...
<a name="install-vm-p-cf-ig-prep-act"></a>
...
## Download Files
<a name="install-vm-p-cf-ig-prep-dl"></a>
...
<a name="install-vm-p-cf-ig-prep-move"></a>
