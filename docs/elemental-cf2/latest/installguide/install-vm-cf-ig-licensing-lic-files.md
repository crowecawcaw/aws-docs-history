...
![Licenses tab showing Choose File button with no license pools currently uploaded.](images/install-installlic-shared-png.png) 4. Back on the Licenses screen, choose **Update**. The license file is installed. Be sure to install each license file: `conductor.lic` and `ui.lic`. 5. Repeat steps 1 through 4 on each VM guest.
