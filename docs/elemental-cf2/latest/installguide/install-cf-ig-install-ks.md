...
<a name="install-cf-ig-install-ks"></a>
...
![](https://docs.aws.amazon.com/elemental-cf2/latest/installguide/images/install-installer-shared-png.png)
...
<tbody>
  <tr><td><code>Set Hostname</code></td><td>Change the hostname to a useful name such as <b>conductor-file-01</b> or <b>conductor-file-chicago-01</b>.<br />Do not use localhost as the hostname!<br />Do not use periods or underscores in the hostname</td></tr>
