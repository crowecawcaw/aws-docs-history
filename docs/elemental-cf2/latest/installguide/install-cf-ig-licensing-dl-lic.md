...
![View Licenses page showing license details and download options.](/images/elemental-cf2/latest/installguide/images/install-viewlic-shared-png.png) 7. Save the `.tgz` file to a place accessible to the AWS Elemental system that will be using this license, for example, a directory on your workstation called “licenses”. Make a note of the path.
