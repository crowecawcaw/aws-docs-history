...
<a name="install-vm-cf-ig-install-sw"></a>
...
[See the AWS documentation website for more details](http://docs.aws.amazon.com/elemental-cf2/latest/installguide/install-vm-cf-ig-install-sw.html)

   The software is installed. This message confirms that both installation and configuration are complete:
