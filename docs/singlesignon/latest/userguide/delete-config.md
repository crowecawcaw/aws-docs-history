...
| What data gets deleted                                                        | Connected directory<br>• AWS Managed Microsoft AD, AD Connector, or external identity<br>provider | IAM Identity Center identity store |
| ----------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------- |
...
3. On the **Settings** page, choose the **Management**
   tab.
4. In the **Delete IAM Identity Center configuration** section, choose
   **Delete**.
5. In the **Delete IAM Identity Center configuration** dialog, select each checkbox to
   acknowledge you understand that your data will be deleted. Type your IAM Identity Center instance in the
   text box, and then choose **Confirm**.
