...
* To access AWS accounts, the AWS Management Console, and the IAM Identity Center console from your
 AWS access portal, you must allowlist additional domains. Refer to [Troubleshooting](https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/troubleshooting.html "https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/troubleshooting.html") in the *AWS Management Console Getting Started
 Guide* for a list of AWS Management Console domains.
