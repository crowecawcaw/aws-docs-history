...
| SCIM                                                                                                                                                                           | [SCIM](../developerguide/what-is-scim.md "../developerguide/what-is-scim.md")                       | The SCIM APIs support the provisioning of users, groups, and group memberships<br>through the SCIM protocol. See [Logging IAM Identity Center SCIM API calls with AWS CloudTrail](scim-logging-using-cloudtrail.md "scim-logging-using-cloudtrail.md") for more information. | `identitystore-scim.amazonaws.com`                              |
