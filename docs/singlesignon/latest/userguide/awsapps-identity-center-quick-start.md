...
- With AWS Organizations – If you choose this option, an _organization instance_ of IAM Identity Center is
  created.
- Only in your specific AWS account – If you choose this
  option, an _account instance_ of IAM Identity Center is
  created.
