...
1. **Create an [IAM
 role](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html")** in the account where the Amazon Redshift
 cluster or Serverless instance exists with the following
 permission policy. For more information, see [IAM Role
 creation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create.html").
