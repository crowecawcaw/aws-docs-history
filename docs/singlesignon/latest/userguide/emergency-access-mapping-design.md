...
![IAM Identity Center workflow: map emergency access groups to roles in emergency account.](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/emergency-access-mapping.png)
