...
**Topics**
+ [Prerequisites](#trustedidentitypropagation-prerequisites)
+ [Considerations](#trustedidentitypropagation-considerations)
+ [Considerations for customer managed applications](#trustedidentitypropagation-customer-apps)
