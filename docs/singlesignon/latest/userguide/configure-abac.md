...
To use attribute-based access control (ABAC), you must first enable it in
 ...
 value from its Identity Store as a [session tag](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_session-tags.html") on
