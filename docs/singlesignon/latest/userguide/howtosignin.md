...
vary. Check with your administrator for details. 3. Once signed in, you can access any AWS account and application that displays in the
portal.
...
- Once you sign in to the AWS access portal, you can switch to a role. Switching roles
  ...
  permissions assigned to the role.  For more information, see [Switching to a role (console)](../../../IAM/latest/UserGuide/id_roles_use_switch-role-console.md "../../../IAM/latest/UserGuide/id_roles_use_switch-role-console.md").

## Signing out of the AWS access portal

When you sign out from the portal, your credentials are completely removed from the
browser session. For more information, see [Sign out of the AWS access portal](../../../signin/latest/userguide/aws-access-portal-signing-out-iam-identity-center-user.md "../../../signin/latest/userguide/aws-access-portal-signing-out-iam-identity-center-user.md") in the _AWS Sign-In_ guide.
