...
These requirements apply only to users created in the Identity Center directory. If you
 ...
 password policies for AWS Managed Microsoft AD](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_password_policies.html "https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_password_policies.html") for more information.
