...
sync, the sync cycle picks up these changes from the next scheduled sync.
...
3. On the **Settings** page, choose the **Identity
   ...
   **Manage Sync**.
4. Under **Manage Sync**, choose **Pause
   sync**.
...
3. On the **Settings** page, choose the **Identity
   source** tab, choose **Actions**, and then choose
   **Manage Sync**.
4. Under **Manage Sync**, choose **Resume
   sync**.

###### Note

If you see **Pause sync** instead of **Resume
sync**, the sync from Active Directory to IAM Identity Center has already resumed.
