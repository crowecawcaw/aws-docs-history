...
The relay state URL must be within the AWS Management Console. 6. If the permission set is provisioned in any AWS accounts, the
...
permission set. 7. Choose **Save changes**. 8. At the top of the **AWS Organization** page, a
...
- The `create-permission-set` or
  `update-permission-set` commands in the [sso-admin](../../../cli/latest/reference/sso-admin/index.md#cli-aws-sso-admin "../../../cli/latest/reference/sso-admin/index.md#cli-aws-sso-admin") section of the
