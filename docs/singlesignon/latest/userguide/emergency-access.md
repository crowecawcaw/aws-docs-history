...
- Connect your third-party IdP to individual AWS accounts by using [SAML 2.0-based federation](../../../IAM/latest/UserGuide/id_roles_providers_saml.md "../../../IAM/latest/UserGuide/id_roles_providers_saml.md").
