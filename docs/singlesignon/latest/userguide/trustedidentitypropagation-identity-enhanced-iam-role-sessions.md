...
The [AWS Security Token Service](../../../IAM/latest/UserGuide/id_credentials_sts-comparison.md "../../../IAM/latest/UserGuide/id_credentials_sts-comparison.md") (STS) enables an application to obtain an
...
requests to the AWS STS [AssumeRole](../../../STS/latest/APIReference/API_AssumeRole.md "../../../STS/latest/APIReference/API_AssumeRole.md")
...
`sts:identity_context` field in the [AssumeRole](../../../STS/latest/APIReference/API_AssumeRole.md "../../../STS/latest/APIReference/API_AssumeRole.md") request using the
