...
3. In the **Attach SCP to prevent creation of new account instances**
 ...
 detaching service control policies](/organizations/latest/userguide/orgs_manage_policies_scps_attach.html "/organizations/latest/userguide/orgs_manage_policies_scps_attach.html") in the *AWS Organizations User
 Guide.*
...
For instructions on attaching an SCP, see [Attaching and detaching service control policies](/organizations/latest/userguide/orgs_manage_policies_scps_attach.html "/organizations/latest/userguide/orgs_manage_policies_scps_attach.html") in the *AWS Organizations
 User Guide.*
