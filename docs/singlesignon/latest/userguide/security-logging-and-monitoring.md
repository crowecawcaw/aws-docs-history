...
+ [Logging IAM Identity Center SCIM API calls with AWS CloudTrail](scim-logging-using-cloudtrail.md)
+ [Connect application components with Amazon EventBridge](eventbridge-integration.md)
