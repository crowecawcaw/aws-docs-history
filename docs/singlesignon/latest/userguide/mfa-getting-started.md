...
The instructions in this section apply to [AWS IAM Identity Center](https://aws.amazon.com/iam/identity-center/ "https://aws.amazon.com/iam/identity-center/"). They do
 ...
 deactivating MFA for IAM users, see [Deactivating MFA devices](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_mfa_disable.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_mfa_disable.html") in the *AWS Identity and Access Management User
 Guide*.
