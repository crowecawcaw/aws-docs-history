...
[Amazon SageMaker Studio](../../../sagemaker/latest/dg/studio-updated.md "../../../sagemaker/latest/dg/studio-updated.md") integrates with IAM Identity Center, and it supports [user background sessions](user-background-sessions.md "user-background-sessions.md") and
