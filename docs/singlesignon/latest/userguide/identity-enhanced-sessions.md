...
1. After you finish setting up IAM Identity Center, open the Amazon Q console and follow the steps in [Subscriptions](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/q-admin-setup-subscribe-management-account.html) in the *Amazon Q Developer User Guide*. Make sure to enable identity-enhanced console sessions.
**Note**  
