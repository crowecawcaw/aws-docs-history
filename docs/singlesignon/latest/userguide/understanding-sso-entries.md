...
A trail is a configuration that enables delivery of events to an Amazon S3 bucket that you
 ...
 appear in any specific order. Learn about the [contents of a CloudTrail record](../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.md "../../../awscloudtrail/latest/userguide/cloudtrail-event-reference-record-contents.md") in the *CloudTrail User
 Guide*.
