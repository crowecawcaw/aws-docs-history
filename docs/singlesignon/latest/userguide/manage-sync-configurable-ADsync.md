...
AWS Managed Microsoft AD directory is located before you move to the next step. 2. Choose **Settings**. 3. At the top of the page, in the notification message, choose **Start guided
setup**. 4. In **Step 1 – _optional_: Configure attribute
...
the changes, and then choose **Save changes**. 5. In **Step 2 – _optional_: Configure sync
...
**Next**. 6. In **Step 3: Review and save configuration**, confirm your
