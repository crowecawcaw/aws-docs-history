...
IAM, see [Deleting
an IAM user group](../../../IAM/latest/UserGuide/id_groups_manage_delete.md "../../../IAM/latest/UserGuide/id_groups_manage_delete.md") in the _AWS Identity and Access Management User
Guide_.
...
5. Choose **Delete group**. If you selected multiple
   groups for deletion, choose **Delete _#_
   groups**.
