...
**Topics**
+ [Trusted token issuer overview](#trusted-token-issuer-overview)
+ [Prerequisites and considerations for trusted token issuers](#trusted-token-issuer-prerequisites)
+ [JTI claim details](#trusted-token-issuer-configuration-jti-claim)
