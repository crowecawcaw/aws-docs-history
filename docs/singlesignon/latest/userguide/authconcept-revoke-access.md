...
2. Specify the `aws:userid` or `identitystore:userid`
   ...
   Policy](../../../organizations/latest/userguide/orgs_manage_policies_scps.md "../../../organizations/latest/userguide/orgs_manage_policies_scps.md") to deny the user's access across all member accounts in your
   organization.
