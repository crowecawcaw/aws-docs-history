...
Some service providers require custom SAML assertions to pass additional data about
 ...
 applications user attributes should map to corresponding attributes in IAM Identity Center.
...
3. In the list of applications, choose the application where you want to map
 attributes.
4. On the application details page, choose the **Actions** and
 then choose **Edit attribute mapping**.
5. Choose **Add new attribute mapping**.
6. In the first text box, enter the application attribute.
7. In the second text box, enter the attribute in IAM Identity Center that you want to map to
