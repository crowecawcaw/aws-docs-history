...
## KMS policy statements for read-only use of a specific IAM Identity Center instance
 ...
 This policy allows [security auditors](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/SecurityAudit.html "https://docs.aws.amazon.com/aws-managed-policy/latest/reference/SecurityAudit.html") and other personnel who need only read access to IAM Identity Center to use the KMS key.
