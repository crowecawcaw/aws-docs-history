...
To learn more about AWS IAM Identity Center resiliency, see [Resiliency design and Regional behavior](resiliency-regional-behavior.md "resiliency-regional-behavior.md").
