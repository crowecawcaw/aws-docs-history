...
If you have not yet configured a data source, you must do so now. See the
 ...
 configure a data source in PingFederate.
11. On the **Source Settings** page, confirm all values are correct
 for your installation, then click **Next**.
12. On the **Source Location** page, enter settings appropriate to
 ...
 **Source** (*data store*) and
 **Value** (*data store attribute*) for the
 **Attribute Contract**
`https://aws.amazon.com/SAML/Attributes/AccessControl:**Department**`.
...
If you have not yet configured a data source, you will need to do so now. See
 ...
 configure a data source in PingFederate.
10. Click **Next** repeatedly until you arrive on the
