...
IAM users](../../../IAM/latest/UserGuide/id_users_manage.md "../../../IAM/latest/UserGuide/id_users_manage.md") in the _AWS Identity and Access Management User
Guide_. 2. Choose **Users**. 3. Select the username of the user whose access you want to disable. 4. Below the username of the user whose access you want to disable, in the **General
information** section, choose **Disable
user access**. 5. In the **Disable user access** dialog box, choose **Disable
user access**.
