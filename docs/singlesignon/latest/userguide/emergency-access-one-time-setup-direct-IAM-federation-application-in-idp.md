...
![Two options: accountid and role in group filter or role value pattern.](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/emergency-access-group-filter-role-value-pattern.png)
