...
- Set up [Amazon EMR Cluster
  on Amazon EC2 with Apache Spark](../../../emr/latest/ManagementGuide/emr-idc-start.md "../../../emr/latest/ManagementGuide/emr-idc-start.md").
- _Recommended_: [AWS Lake Formation](tip-tutorial-lf.md "tip-tutorial-lf.md") and [Amazon S3
