...
3. In the list of applications, choose the application name to which you want to
 assign access.
4. On the application details page, in the **Assigned users**
 section, choose **Assign users**.
5. In the **Assign users** dialog box, enter a user display name
 or group name. You can specify multiple users or groups by selecting the
 applicable accounts as they appear in search results.
