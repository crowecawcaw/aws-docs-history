...
| --- | --- | --- | --- | 
| Read users or groups (reading the group itself and the group's membership) | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Add, edit, or delete users or groups | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes\* | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Enable or disable user access | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Enable, disable, or manage incoming attributes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Change or manage identity sources | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Create, edit, or delete customer managed applications | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Create, edit, or delete AWS managed applications | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Configure MFA | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Manage permission sets not provisioned in the management account | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Manage permission sets provisioned in the management account | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Enable IAM Identity Center | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Delete IAM Identity Center configuration | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
| Enable or disable user access in the management account | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-no.png) No | ![](https://docs.aws.amazon.com/singlesignon/latest/userguide/images/icon-yes.png) Yes | 
