...
For more information about AWS account types, see [AWS Organizations Terminology and Concepts](http://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html "http://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html") in the *AWS Organizations User Guide*.


You can also choose to register a member account as a *delegated
 administrator* for IAM Identity Center. Users in this account can perform most IAM Identity Center
