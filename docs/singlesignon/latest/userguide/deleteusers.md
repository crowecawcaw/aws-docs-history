...
IAM, see [Deleting
an IAM user](../../../IAM/latest/UserGuide/id_users_manage.md#id_users_deleting "../../../IAM/latest/UserGuide/id_users_manage.md#id_users_deleting") in the _AWS Identity and Access Management User
Guide_.
...
5. Choose **Delete user**. If you selected multiple
   users for deletion, choose **Delete _#_
   users**.
