...
IAM Identity Center authentication with the AWS CLI](../../../cli/latest/userguide/cli-configure-sso.md "../../../cli/latest/userguide/cli-configure-sso.md") in the
...
A _scope_ defines the access for a
