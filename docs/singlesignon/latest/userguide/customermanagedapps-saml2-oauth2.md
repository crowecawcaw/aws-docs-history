...
| codecatalyst:read\_write | Read and write to your Amazon CodeCatalyst resources, allowing access to all your existing resources. | AWS Builder ID and IAM Identity Center | 
| verified\_access:application:connect | Enable AWS Verified Access | AWS Verified Access | 
