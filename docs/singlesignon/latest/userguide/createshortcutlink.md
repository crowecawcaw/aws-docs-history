...
2. In the dialog box: 
	...
	You cannot grant new access with shortcut links. Shortcut links work only with
	 ...
	 denied access.
	3. Optionally enter the AWS access portal destination URL. If you omit entering a URL,
	 the destination is automatically determined when using the shortcut link, based on
	 the previously-mentioned shortcut link destination options.
	4. Your shortcut link generates at the bottom of the dialog box, based on your
