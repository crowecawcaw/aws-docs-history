...
For more information about setting up a two-way trust, see [When to Create a Trust Relationship](../../../directoryservice/latest/admin-guide/setup_trust.md "../../../directoryservice/latest/admin-guide/setup_trust.md") in the
