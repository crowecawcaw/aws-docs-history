...
If you are switching to an external identity provider, we recommend that you follow the
 steps in [How to connect to an external identity provider](how-to-connect-idp.md "how-to-connect-idp.md").
5. After you read the disclaimer and are ready to proceed, type
 **ACCEPT**.
6. Choose **Change identity source**. If you are changing your identity
 source to Active Directory, proceed to the next step.
7. Changing your identity source to Active Directory takes you to the
