...
Use the following procedure within the AWS access portal to register your new device for
...
If the **Register MFA device** option is grayed out, contact your
 administrator for assistance with registering your device.
4. On the **Register MFA device** page, select one of the following MFA
