...
Choose the approach that best fits your organization's identity management strategy and
existing infrastructure.

###### Topics

- [Users, groups, and provisioning in IAM Identity Center](users-groups-provisioning.md "users-groups-provisioning.md")
- [Manage your identity source](manage-your-identity-source.md "manage-your-identity-source.md")
- [Manage users in the Identity Center directory](manage-your-identity-source-sso.md "manage-your-identity-source-sso.md")
