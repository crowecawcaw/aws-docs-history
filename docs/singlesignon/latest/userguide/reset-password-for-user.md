...
changing passwords for IAM users, see [Managing passwords for IAM users](../../../IAM/latest/UserGuide/id_credentials_passwords_admin-change-user.md "../../../IAM/latest/UserGuide/id_credentials_passwords_admin-change-user.md") in the _AWS Identity and Access Management User
Guide_.
...
5. In the **Reset password** dialog box, select one of the
   ...
   gain unauthorized access to your AWS environment. 2. **Generate a one-time password and share the password with the
