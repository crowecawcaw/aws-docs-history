...
or member accounts in your organization in AWS Organizations based on [common job functions](../../../IAM/latest/UserGuide/access_policies_job-functions.md "../../../IAM/latest/UserGuide/access_policies_job-functions.md"). Or you can use custom permissions to meet your
...
- [Revoke user access](revoke-user-permissions.md "revoke-user-permissions.md")
