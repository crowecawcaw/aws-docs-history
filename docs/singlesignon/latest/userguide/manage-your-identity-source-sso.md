...
+ [Changing your identity source](#ad-external-idp)
+ [Add users to your Identity Center directory](addusers.md)
+ [Add groups to your Identity Center directory](addgroups.md)
+ [Add users to groups](adduserstogroups.md)
+ [Delete groups in IAM Identity Center](deletegroups.md)
+ [Delete users in IAM Identity Center](deleteusers.md)
+ [Remove users from groups](removeusersfromgroups.md)
+ [Edit Identity Center directory user properties](edituser.md)