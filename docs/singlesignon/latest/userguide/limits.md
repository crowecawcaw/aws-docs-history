...
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| IAM Identity Center APIs | [IAM Identity Center<br>APIs](../APIReference/API_Operations.md "../APIReference/API_Operations.md") have a collective throttle limit of 20 transactions<br>per second (TPS). You can open a support case to request a limit increase.<br>The [CreateAccountAssignment](../APIReference/API_CreateAccountAssignment.md "../APIReference/API_CreateAccountAssignment.md") API has a limit of 15<br>outstanding asynchronous calls. This limit cannot be increased. |
