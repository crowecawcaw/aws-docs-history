...
**Topics**
+ [OIDC discovery endpoint URL (issuer URL)](#oidc-discovery-endpoint-url)
+ [Attribute mapping](#trusted-token-issuer-attribute-mappings)
+ [Aud claim](#trusted-token-issuer-aud-claim)
