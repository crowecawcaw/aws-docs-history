...
per account is 1000 roles. For more information, see [IAM object quotas](../../../IAM/latest/UserGuide/reference_iam-quotas.md#reference_iam-quotas-entities "../../../IAM/latest/UserGuide/reference_iam-quotas.md#reference_iam-quotas-entities").
...
the IAM role quota. For information about how to request a quota increase, see [Requesting a quota increase](../../../servicequotas/latest/userguide/request-quota-increase.md "../../../servicequotas/latest/userguide/request-quota-increase.md") in the
