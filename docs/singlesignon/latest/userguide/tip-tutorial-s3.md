...
![Create S3 Access Grants instance page in S3 Access Grants console.](images/s3-tutorial-step-1.1.png) 2. **Register a location** - After you create an
[create an Amazon S3 Access Grants
instance](../../../AmazonS3/latest/userguide/access-grants-instance-create.md "../../../AmazonS3/latest/userguide/access-grants-instance-create.md") in an AWS Region in your account, you
[register an S3 location](../../../AmazonS3/latest/userguide/access-grants-location-register.md "../../../AmazonS3/latest/userguide/access-grants-location-register.md") in that instance. An S3
...
For more information, see [Register a location](../../../AmazonS3/latest/userguide/access-grants-location-register.md "../../../AmazonS3/latest/userguide/access-grants-location-register.md") in the _Amazon Simple Storage Service User Guide_.
...
principal to assume the IAM role.
    ...
    2. **Trust policy**
     ...
     account, see [Create a role using custom trust policies](../../../IAM/latest/UserGuide/id_roles_create_for-custom.md "../../../IAM/latest/UserGuide/id_roles_create_for-custom.md").
...
you can [create a grant](../../../AmazonS3/latest/userguide/access-grants-grant-create.md "../../../AmazonS3/latest/userguide/access-grants-grant-create.md"). In the S3 console **Create Grant** page, complete the following:
...
1. Select the location created in the previous step. You can
   ...
   more information, see [Subprefix](../../../AmazonS3/latest/userguide/access-grants-grant-create.md#subprefix "../../../AmazonS3/latest/userguide/access-grants-grant-create.md#subprefix") in the _Amazon Simple Storage Service
   User Guide_.
