...
[AWS Lake Formation](../../../lake-formation/latest/dg/what-is-lake-formation.md "../../../lake-formation/latest/dg/what-is-lake-formation.md") is a managed service that simplifies the creation and
...
[Creating objects in AWS Glue Data Catalog](../../../lake-formation/latest/dg/populating-catalog.md "../../../lake-formation/latest/dg/populating-catalog.md") for more
information. 2. **Register data lake locations**.

[Register the S3 locations](../../../lake-formation/latest/dg/register-location.md "../../../lake-formation/latest/dg/register-location.md") where the data of the
...
WorkGroup).
    ...
    To use these policies, replace the
     ...
     own information. For additional directions, see [Create a policy](../../../IAM/latest/UserGuide/access_policies_create.md "../../../IAM/latest/UserGuide/access_policies_create.md") or [Edit a policy](../../../IAM/latest/UserGuide/access_policies_manage-edit.md "../../../IAM/latest/UserGuide/access_policies_manage-edit.md"). The permission policy should
...
instance of IAM Identity Center. See [Cross-account data sharing in Lake Formation](../../../lake-formation/latest/dg/cross-data-sharing-lf.md "../../../lake-formation/latest/dg/cross-data-sharing-lf.md") for more
information.
