...
transcription, refer to the [Supported languages and language-specific features](supported-languages.md "supported-languages.md") table.

###### Topics

- [Amazon Transcribe and HIPAA eligibility](#transcribe-hippa "#transcribe-hippa")
- [Pricing](#transcribe-pricing "#transcribe-pricing")
- [Region availability and quotas](#tsc-regions "#tsc-regions")
  For a short video tour of Amazon Transcribe,
  see:

To learn more, see [How Amazon Transcribe works](how-it-works.md "how-it-works.md") and
[Getting started with Amazon Transcribe](getting-started.md "getting-started.md").

###### Tip

Information on the **Amazon Transcribe API** is located in the
[API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").

## Amazon Transcribe and HIPAA eligibility

Amazon Transcribe is covered under AWS’s HIPAA eligibility and BAA which
requires BAA customers to encrypt all PHI at rest and in transit when in use. Automatic PHI identification
is available at no additional charge and in all regions where Amazon Transcribe operates. For more
information, refer to [HIPAA eligibility
and BAA](https://aws.amazon.com/compliance/hipaa-compliance/ "https://aws.amazon.com/compliance/hipaa-compliance/").
...
For cost information for each AWS Region, refer to
