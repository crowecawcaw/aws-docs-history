...
As a managed service, Amazon Transcribe is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Transcribe through the network. Clients must
