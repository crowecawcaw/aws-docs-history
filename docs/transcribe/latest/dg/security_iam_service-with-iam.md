...
Before you use IAM to manage access to Amazon Transcribe, learn what IAM features are
available to use with Amazon Transcribe.

| IAM features you can use with Amazon Transcribe                                                                                                                                | IAM feature | Amazon Transcribe support |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- | ------------------------- |
| [Identity-based<br>policies](#security_iam_service-with-iam-id-based-policies "#security_iam_service-with-iam-id-based-policies")                                              | Yes         |
...
| [Service-linked<br>roles](#security_iam_service-with-iam-roles-service-linked "#security_iam_service-with-iam-roles-service-linked")                                           | No          |

To get a high-level view of how Amazon Transcribe and other AWS services work
with most IAM features, see [AWS
...
To see a list of Amazon Transcribe actions, see [Actions defined by Amazon Transcribe](../../../service-authorization/latest/reference/list_amazontranscribe.md#amazontranscribe-actions-as-permissions "../../../service-authorization/latest/reference/list_amazontranscribe.md#amazontranscribe-actions-as-permissions") in the
_Service Authorization Reference_.

Policy actions in Amazon Transcribe use the `transcribe` prefix before the action. To
specify multiple actions in a single statement, separate them with commas.
...
To see a list of Amazon Transcribe condition keys, see [Condition keys for Amazon Transcribe](../../../service-authorization/latest/reference/list_amazontranscribe.md#amazontranscribe-policy-keys "../../../service-authorization/latest/reference/list_amazontranscribe.md#amazontranscribe-policy-keys") in the
...
For more information about tagging Amazon Transcribe resources, see [Tagging resources](tagging.md "tagging.md"). For more detailed information on tag-based access control, see
...
For details about creating or managing service-linked roles for other services, see
[AWS
services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md"). Find a service in the table that includes a
`Yes` in the **Service-linked role** column. Choose the
**Yes** link to view the service-linked role documentation for that service.
