...
![Amazon Transcribe console screenshot: the 'real-time transcription' page.](/images/transcribe/latest/dg/images/stream-main.png) 3. Toggle on **Custom language model** and select a model from the
dropdown menu.
