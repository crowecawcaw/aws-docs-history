...
+ **Streaming transcriptions**: Transcribe media streams in real time. You can use the [AWS Management Console](getting-started-console.md), [HTTP/2](streaming-setting-up.md#streaming-http2), [WebSockets](streaming-setting-up.md#streaming-websocket), and various [AWS SDKs](getting-started-sdk.md) for streaming transcriptions.
