...
**Topics**
+ [Abkhaz character set](#char-abkhaz)
+ [Afrikaans character set](#char-afrikaans)
+ [Arabic character set](#char-arabic)
+ [Asturian character set](#char-asturian)
+ [Azerbaijani character set](#char-azerbaijani)
+ [Armenian character set](#char-armenian)
+ [Bashkir character set](#char-bashkir)
+ [Basque character set](#char-basque)
+ [Belarusian character set](#char-belarusian)
+ [Bengali character set](#char-bengali)
+ [Bosnian character set](#char-bosnian)
+ [Bulgarian character set](#char-bulgarian)
+ [Catalan character set](#char-catalan)
+ [Central Kurdish character set](#char-central-kurdish)
...
+ [Chinese, Cantonese (Hong Kong), Traditional character set](#char-cantonese-hk)
+ [Croatian character set](#char-croatian)
+ [Czech character set](#char-czech)
+ [Danish character set](#char-danish)
+ [Dutch character set](#char-dutch)
+ [English character set](#char-english)
+ [Estonian character set](#char-estonian)
+ [Farsi character set](#char-farsi)
+ [Finnish character set](#char-finnish)
+ [French character set](#char-french)
+ [Galician character set](#char-galician)
+ [Georgian character set](#char-georgian)
+ [German character set](#char-german)
+ [Greek character set](#char-greek)
+ [Gujarati character set](#char-gujarati)
+ [Hausa character set](#char-hausa)
+ [Hebrew character set](#char-hebrew)
+ [Hindi character set](#char-hindi)
+ [Hungarian character set](#char-hungarian)
+ [Icelandic character set](#char-icelandic)
+ [Indonesian character set](#char-indonesian)
+ [Italian character set](#char-italian)
+ [Japanese character set](#char-japanese)
+ [Kabyle character set](#char-kabyle)
+ [Kannada character set](#char-kannada)
+ [Kazakh character set](#char-kazakh)
+ [Kinyarwanda character set](#char-kinyarwanda)
+ [Korean character set](#char-korean)
+ [Kyrgyz character set](#char-kyrgyz)
+ [Latvian character set](#char-latvian)
+ [Lithuanian character set](#char-lithuanian)
+ [Luganda character set](#char-luganda)
+ [Macedonian character set](#char-macedonian)
+ [Malay character set](#char-malay)
+ [Malayalam character set](#char-malayalam)
+ [Maltese character set](#char-maltese)
+ [Marathi character set](#char-marathi)
+ [Meadow Mari character set](#char-meadow-mari)
+ [Mongolian character set](#char-mongolian)
+ [Norwegian Bokmål character set](#char-norwegian-bokmal)
+ [Odia/Oriya character set](#char-odia-oriya)
+ [Pashto character set](#char-pashto)
+ [Polish character set](#char-polish)
+ [Portuguese character set](#char-portuguese)
+ [Punjabi character set](#char-punjabi)
+ [Romanian character set](#char-romanian)
+ [Russian character set](#char-russian)
+ [Serbian character set](#char-serbian)
+ [Sinhala character set](#char-sinhala)
+ [Slovak character set](#char-slovak)
+ [Slovenian character set](#char-slovenian)
+ [Somali character set](#char-somali)
+ [Spanish character set](#char-spanish)
+ [Sundanese character set](#char-sundanese)
+ [Swahili character set](#char-swahili)
+ [Swedish character set](#char-swedish)
+ [Tagalog/Filipino character set](#char-tagalog-filipino)
+ [Tamil character set](#char-tamil)
+ [Tatar character set](#char-tatar)
+ [Telugu character set](#char-telugu)
+ [Thai character set](#char-thai)
+ [Turkish character set](#char-turkish)
+ [Ukrainian character set](#char-ukrainian)
+ [Uyghur character set](#char-uyghur)
+ [Uzbek character set](#char-uzbek)
+ [Vietnamese character set](#char-vietnamese)
+ [Welsh character set](#char-welsh)
+ [Wolof character set](#char-wolof)
+ [Zulu character set](#char-zulu)
...
For Korean custom vocabularies, you can use the following in the `Phrase` field:
+ a - z
+ A - Z
+ - (hyphen)
+ . (period)

The `Phrase` field can use any of the Hangul syllables listed in the following link:
+ [Hangul Syllables](https://en.wikipedia.org/wiki/Hangul_Syllables) on Wikipedia.
