...
- Urology – available in streaming transcription only
  ...
  how medical custom vocabularies work, see [Improving transcription accuracy with medical custom
...
- [Transcribing an audio file of a medical
  dictation](batch-medical-dictation.md "batch-medical-dictation.md")
- [Transcribing a medical dictation in a
  real-time stream](streaming-medical-dictation.md "streaming-medical-dictation.md")
