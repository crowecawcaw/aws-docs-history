...
PHI that could be used to identify a patient.

You can identify PHI using either a real-time stream or batch transcription job.

You can use your own post-processing to redact the PHI identified in the transcription
output.

Use Personal Health Information Identification to identify the following types of
PHI:
...
- [Identifying PHI in an audio file](phi-id-batch.md "phi-id-batch.md")
- [Identifying PHI in a real-time stream](phi-id-stream.md "phi-id-stream.md")
