...
conventions that Amazon Transcribe Medical uses for medical terms and measurements in the table on this
page. The _Spoken Term_ column refers to the term spoken in the
source audio. The _Output_ column refers to the abbreviation you see
in your transcription results.

You can see how the terms spoken in source audio correspond to the transcription
output here.
...
| cat scan                    | CT Scan                     | Patient indication of cerebral hemorrhage required use of CT<br>Scan. |
