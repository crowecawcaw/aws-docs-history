...
administrator](manage-cross-account.md#backup-delegatedadmin "manage-cross-account.md#backup-delegatedadmin") account holders can also create cross-account reports.

###### Tip

To ensure reports generated by delegated administrator accounts show all member account
data, [create frameworks](working-with-audit-frameworks.md "working-with-audit-frameworks.md") in each of
those member accounts.

###### Important

AWS Backup Audit Manager delivers reports only to Amazon S3 buckets that belong to the account
in which the report plan or on-demand report is created. Cross-account Amazon S3 bucket delivery
is not supported.
...
- [Updating report plans](update-report-plan.md "update-report-plan.md")
- [Deleting report plans](delete-report-plan.md "delete-report-plan.md")
