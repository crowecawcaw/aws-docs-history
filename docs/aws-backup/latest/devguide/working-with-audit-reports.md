...
**Important**  
AWS Backup Audit Manager delivers reports only to Amazon S3 buckets that belong to the account in which the report plan or on-demand report is created. Cross-account Amazon S3 bucket delivery is not supported.
