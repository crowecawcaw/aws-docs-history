...
| [Amazon Relational Database Service (Amazon RDS)](../../../AmazonRDS/latest/UserGuide.md "../../../AmazonRDS/latest/UserGuide.md")                                   | Amazon RDS database instances (including all database engines); Multi-Availability Zone clusters |
...
| [SAP HANA databases](backup-saphana.md "backup-saphana.md")                                                                                                          | SAP HANA databases on Amazon EC2 instances                                                       | ## Pricing With AWS Backup, you pay for backup storage, data restored, restore testing, cross-Region data transfer, and AWS Backup Audit Manager. For more information, see [AWS Backup Pricing](https://aws.amazon.com/backup/pricing/ "https://aws.amazon.com/backup/pricing/"). |
