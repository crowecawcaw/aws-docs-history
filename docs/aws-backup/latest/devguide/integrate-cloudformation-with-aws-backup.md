...
For information about using CloudFormation with AWS Backup, see [AWS Backup Resource Type Reference](../../../AWSCloudFormation/latest/UserGuide/AWS_Backup.md "../../../AWSCloudFormation/latest/UserGuide/AWS_Backup.md") in the
