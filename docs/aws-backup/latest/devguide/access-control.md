...
available operations, see AWS Backup [Operations](../APIReference/API_Operations.md "../APIReference/API_Operations.md").
...
(see [Operations](../APIReference/API_Operations.md "../APIReference/API_Operations.md")). To grant
...
| [DescribeRecoveryPoint](../APIReference/API_DescribeRecoveryPoint.md "../APIReference/API_DescribeRecoveryPoint.md") | `backup:DescribeRecoveryPoint` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*`<br>2 |
| [DescribeRestoreJob](../APIReference/API_DescribeRestoreJob.md "../APIReference/API_DescribeRestoreJob.md") | `backup:DescribeRestoreJob` | |
| [DescribeRegionSettings](../APIReference/API_DescribeRegionSettings.md "../APIReference/API_DescribeRegionSettings.md") | `backup:DescribeRegionSettings` | |
| [ExportBackupPlanTemplate](../APIReference/API_ExportBackupPlanTemplate.md "../APIReference/API_ExportBackupPlanTemplate.md") | `backup:ExportBackupPlanTemplate` | |
| [GetBackupPlan](../APIReference/API_GetBackupPlan.md "../APIReference/API_GetBackupPlan.md") | `backup:GetBackupPlan` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [GetBackupPlanFromJSON](../APIReference/API_GetBackupPlanFromJSON.md "../APIReference/API_GetBackupPlanFromJSON.md") | `backup:GetBackupPlanFromJSON` | |
| [GetBackupPlanFromTemplate](../APIReference/API_GetBackupPlanFromTemplate.md "../APIReference/API_GetBackupPlanFromTemplate.md") | `backup:GetBackupPlanFromTemplate` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [GetBackupSelection](../APIReference/API_GetBackupSelection.md "../APIReference/API_GetBackupSelection.md") | `backup:GetBackupSelection` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [GetBackupVaultAccessPolicy](../APIReference/API_GetBackupVaultAccessPolicy.md "../APIReference/API_GetBackupVaultAccessPolicy.md") | `backup:GetBackupVaultAccessPolicy` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
...
| [ListBackupPlanVersions](../APIReference/API_ListBackupPlanVersions.md "../APIReference/API_ListBackupPlanVersions.md") | `backup:ListBackupPlanVersions` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [ListBackupSelections](../APIReference/API_ListBackupSelections.md "../APIReference/API_ListBackupSelections.md") | `backup:ListBackupSelections` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [ListBackupVaults](../APIReference/API_ListBackupVaults.md "../APIReference/API_ListBackupVaults.md") | `backup:ListBackupVaults` | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [ListProtectedResources](../APIReference/API_ListProtectedResources.md "../APIReference/API_ListProtectedResources.md") | `backup:ListProtectedResources` | |
| [ListRecoveryPointsByBackupVault](../APIReference/API_ListRecoveryPointsByBackupVault.md "../APIReference/API_ListRecoveryPointsByBackupVault.md") | `backup:ListRecoveryPointsByBackupVault` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [ListRecoveryPointsByResource](../APIReference/API_ListRecoveryPointsByResource.md "../APIReference/API_ListRecoveryPointsByResource.md") | `backup:ListRecoveryPointsByResource` | |
| [ListRestoreJobs](../APIReference/API_ListRestoreJobs.md "../APIReference/API_ListRestoreJobs.md") | `backup:ListRestoreJobs` | |
| [ListTags](../APIReference/API_ListTags.md "../APIReference/API_ListTags.md") | `backup:ListTags` | |
| [PutBackupVaultAccessPolicy](../APIReference/API_PutBackupVaultAccessPolicy.md "../APIReference/API_PutBackupVaultAccessPolicy.md") | `backup:PutBackupVaultAccessPolicy` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [PutBackupVaultLockConfiguration](../APIReference/API_PutBackupVaultLockConfiguration.md "../APIReference/API_PutBackupVaultLockConfiguration.md") | `backup:PutBackupVaultLockConfiguration` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [PutBackupVaultNotifications](../APIReference/API_PutBackupVaultNotifications.md "../APIReference/API_PutBackupVaultNotifications.md") | `backup:PutBackupVaultNotifications` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [StartBackupJob](../APIReference/API_StartBackupJob.md "../APIReference/API_StartBackupJob.md") | `backup:StartBackupJob` | `arn:aws:backup:`region`:`account-id`:backup-vault:*` |
| [StartRestoreJob](../APIReference/API_StartRestoreJob.md "../APIReference/API_StartRestoreJob.md") | `backup:StartRestoreJob` | `arn:aws:backup:`region`:`account-id`:backup-vault:*`<br>`arn:aws:backup:`region`:`account-id:`recovery-point:*`<br>3 |
| [StopBackupJob](../APIReference/API_StopBackupJob.md "../APIReference/API_StopBackupJob.md") | `backup:StopBackupJob` | |
| [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md") | `backup:TagResource` | `arn:aws:backup:`region`:`account-id:`recovery-point:*` |
| [UntagResource](../APIReference/API_UntagResource.md "../APIReference/API_UntagResource.md") | `backup:UntagResource` | |
| [UpdateBackupPlan](../APIReference/API_UpdateBackupPlan.md "../APIReference/API_UpdateBackupPlan.md") | `backup:UpdateBackupPlan` | `arn:aws:backup:`region`:`account-id`:backup-plan:*` |
| [UpdateRecoveryPointLifecycle](../APIReference/API_UpdateRecoveryPointLifecycle.md "../APIReference/API_UpdateRecoveryPointLifecycle.md") | `backup:UpdateRecoveryPointLifecycle` 1 | `arn:aws:backup:`region`:`account-id`:backup-vault:*`<br>2 |
| [UpdateRegionSettings](../APIReference/API_UpdateRegionSettings.md "../APIReference/API_UpdateRegionSettings.md") | `backup:UpdateRegionSettings`<br>`backup:DescribeRegionSettings` | |
