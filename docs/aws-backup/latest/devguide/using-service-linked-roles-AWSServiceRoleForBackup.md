...
1. To delete all your recovery points and backup vaults (except for your default
   ...
   [Delete a vault](create-a-vault.md#delete-a-vault "create-a-vault.md#delete-a-vault").
...
1. To delete all your recovery points, use [delete-recovery-point](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-recovery-point.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-recovery-point.html").
2. To delete all your backup vaults, use [delete-backup-vault](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-backup-vault.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/delete-backup-vault.html").
