...
For a full list of capabilities and details, see the [Feature availability by resource](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource") table.

You can use AWS Backup to protect your virtual machines on
[VMware Cloud™ on AWS Outposts](https://aws.amazon.com/vmware/aws-services/ "https://aws.amazon.com/vmware/aws-services/").
...
actions](API_Operations_AWS_Backup_Gateway.md "API_Operations_AWS_Backup_Gateway.md"). To view a list of Backup gateway API data types, see [Backup gateway data types](API_Types_AWS_Backup_Gateway.md "API_Types_AWS_Backup_Gateway.md").

## Endpoints

Existing users who currently use a public endpoint and who wish to switch to a VPC (Virtual Private Cloud)
endpoint can [create a new gateway with a VPC endpoint](working-with-gateways.md#create-gateway "working-with-gateways.md#create-gateway") using
[AWS PrivateLink](backup-network.md#backup-privatelink "backup-network.md#backup-privatelink"),
associate the existing hypervisor to the gateway, and then
[delete the gateway](working-with-gateways.md#edit-gateway "working-with-gateways.md#edit-gateway") containing the public endpoint.
