...
using the parameter [`DeleteAfterDays`](API_Lifecycle.md "API_Lifecycle.md"). The retention period for snapshots can range
...
storage and for restore, as outlined by [AWS Backup pricing](https://aws.amazon.com/backup/pricing/ "https://aws.amazon.com/backup/pricing/"). Every backup is
...
[Feature availability by resource](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource") displays
...
1. Use [`create-backup-plan`](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/create-backup-plan.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/create-backup-plan.html") or [`update-backup-plan`](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/update-backup-plan.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/backup/update-backup-plan.html").
2.
3. Include the Boolean parameter [`OptInToArchiveForSupportedResources`](API_Lifecycle.md "API_Lifecycle.md") for EBS
   resources.
4. Include the parameter [`MoveToColdStorageAfterdays`](API_Lifecycle.md "API_Lifecycle.md").
...
| Amazon EBS (using EBS Snapshot Archive)            | Full; Incremental backups will become Full after<br>transition. |
...
for creating a backup vault, see [Backup vault creation and deletion](create-a-vault.md "create-a-vault.md").

### Copy to Regions

As part of your backup plan, you can optionally create a backup copy in the same or another
AWS Region. These copies can be made either in the same account or another account. For more information about backup copies, see [Creating backup copies across AWS Regions](cross-region-backup.md "cross-region-backup.md").
...
If the value for [`Lifecycle:DeleteAfterDays`](API_CopyAction.md#Backup-Type-CopyAction-Lifecycle "API_CopyAction.md#Backup-Type-CopyAction-Lifecycle") (shown as
...
Amazon EC2 instance types from Windows VSS backups. For more information, see [Create Windows VSS backups](windows-backups.md "windows-backups.md").
...
see [Advanced Amazon S3 backup settings](s3-backups.md#s3-advanced-backup-settings "s3-backups.md#s3-advanced-backup-settings").
