...
cold storage or archive tiers cannot be copied. See [Feature availability by resource](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource") and
...
[Feature availability by resource](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource"). If the
...
available for all resource types that support both backup types). Depending on the [resource type](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource"), the snapshots may be an incremental
...
in the AWS Backup console (or [`DeleteAfterDays`](API_CopyAction.md#Backup-Type-CopyAction-Lifecycle "API_CopyAction.md#Backup-Type-CopyAction-Lifecycle") value is set to `-1` in the API
...
job completes. For more information about concurrency limits, see [AWS Backup quotas](aws-backup-limits.md "aws-backup-limits.md").
...
set the copy retention period to at least one week. For more information, see [Metering, costs, and billing](metering-and-billing.md "metering-and-billing.md"). To determine which resource types support
incremental copies, see [Feature availability by resource](backup-feature-availability.md#features-by-resource "backup-feature-availability.md#features-by-resource").
