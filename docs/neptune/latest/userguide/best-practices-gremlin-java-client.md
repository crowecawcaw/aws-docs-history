...
For information about configuring heartbeat intervals for Neptune Serverless,
see [Heartbeat Configuration for Neptune Serverless](best-practices-gremlin-heartbeat-serverless.md "best-practices-gremlin-heartbeat-serverless.md").
