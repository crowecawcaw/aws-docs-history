...
[Neptune
Analytics](../../../neptune-analytics/latest/userguide/what-is-neptune-analytics.md "../../../neptune-analytics/latest/userguide/what-is-neptune-analytics.md") is an analytics database engine that complements Neptune database and
...
- [Getting started with Amazon Neptune](graph-get-started.md "graph-get-started.md")
- [Overview of Amazon Neptune features](feature-overview.md "feature-overview.md")
  ...
  production environment, visit our [Getting started with Neptune](graph-get-started.md "graph-get-started.md") topic to find out how to use
...
Reference Architectures for Using Graph Databases](https://github.com/aws-samples/aws-dbs-refarch-graph "https://github.com/aws-samples/aws-dbs-refarch-graph"), where you can inform your
choices about graph data models and query languages, and browse examples of reference
deployment architectures.

###### Key Service Components

- _Primary DB instance_ – Supports read and write operations, and
...
- _Neptune replica_ – Connects to the same storage volume as the
...
- _Cluster volume_ – Neptune data is stored in the cluster volume,
...
graph with both the [openCypher query language](access-graph-opencypher.md "access-graph-opencypher.md")
and/or the [Gremlin query language](access-graph-gremlin.md "access-graph-gremlin.md"). If you
use the W3C standard Resource Description Framework (RDF) model, you can access your
graph using the standard [SPARQL query language](access-graph-sparql.md "access-graph-sparql.md").

###### Highly Secure

Neptune provides multiple levels of security for your database. Security features
include network isolation using [Amazon VPC](https://aws.amazon.com/vpc/ "https://aws.amazon.com/vpc/"), and
encryption at rest using keys that you create and control through [AWS Key Management Service (AWS KMS)](https://aws.amazon.com/kms/ "https://aws.amazon.com/kms/"). On an encrypted
