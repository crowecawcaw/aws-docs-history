...
has been established, use the [Neptune-to-Neptune CloudFormation template](streams-consumer-setup.md "streams-consumer-setup.md")
...
they are set to false or the CloudFormation creation will fail.
...
Once the CloudFormation template has been deployed, Neptune will begin replicating
