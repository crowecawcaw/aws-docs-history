...
If you have enabled IAM authentication on the source (blue) cluster, be sure to update any IAM policies used in your applications to point to the green cluster (for an example of such a policy, see this [unrestricted access policy](iam-data-access-examples.md#iam-auth-data-policy-example-general)).
