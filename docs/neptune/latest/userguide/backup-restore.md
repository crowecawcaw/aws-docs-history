...
**Topics**
+ [Neptune Backups](#backup-restore-overview-backups)
+ [Fault tolerance for a Neptune DB cluster](backup-restore-overview-fault-tolerance.md)
+ [CloudWatch metrics that are useful for managing Neptune backup storage](backup-restore-overview-metrics.md)
+ [Restoring data from a Neptune backup](backup-restore-overview-restore.md)
+ [Backup window in Neptune](backup-restore-overview-backup-window.md)
+ [Creating a DB Cluster Snapshot in Neptune](backup-restore-create-snapshot.md)
+ [Restoring from a DB Cluster Snapshot](backup-restore-restore-snapshot.md)
+ [Copying a DB Cluster Snapshot](backup-restore-copy-snapshot.md)
+ [Sharing a DB Cluster Snapshot](backup-restore-share-snapshot.md)
+ [Deleting a Neptune Snapshot](backup-restore-delete-snapshot.md)
...
If you want to retain a backup beyond the backup retention period, you can also take a snapshot of the data in your cluster volume. Storing snapshots incurs the standard storage charges for Neptune. For more information about Neptune storage pricing, see [Amazon Neptune Pricing](https://aws.amazon.com/neptune/pricing/). 
