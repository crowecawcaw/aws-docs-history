...
For more information, see [Authenticating Requests: Using Query Parameters](https://docs.aws.amazon.com/AmazonS3/latest/API/sigv4-query-string-auth.html). The [Boto3 documentation](https://docs.aws.amazon.com/boto3/latest/guide/s3-presigned-urls.html) shows how to use a Python script to generate a presigned URL.
