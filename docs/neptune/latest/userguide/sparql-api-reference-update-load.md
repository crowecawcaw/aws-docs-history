...
For more information, see [Authenticating Requests: Using Query Parameters](../../../AmazonS3/latest/API/sigv4-query-string-auth.md "../../../AmazonS3/latest/API/sigv4-query-string-auth.md"). The [Boto3 documentation](../../../boto3/latest/guide/s3-presigned-urls.md "../../../boto3/latest/guide/s3-presigned-urls.md")
