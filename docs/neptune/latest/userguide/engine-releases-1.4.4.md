...
As of 2025-02-24, engine version 1.4.4.0 is being generally deployed. Please note
...
- Fixed an issue where the `WITH` clause containing an asterisk (`*`) and aliasing expressions
  caused incorrect query parsing in openCypher.

## Query-Language Versions Supported in This Release

Before upgrading a DB cluster to version 1.4.4.0, make sure that your project is compatible
