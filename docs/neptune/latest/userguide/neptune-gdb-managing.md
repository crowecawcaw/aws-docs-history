...
to individual Neptune DB clusters. To learn more, see [Performing managed planned failovers for Neptune global databases](neptune-gdb-disaster-recovery.md#neptune-gdb-managed-failover "neptune-gdb-disaster-recovery.md#neptune-gdb-managed-failover").

To recover a Neptune global database from an unplanned outage in its primary region,
see [Detach-and-promote a Neptune global database in the case of an unplanned outage](neptune-gdb-disaster-recovery.md#neptune-gdb-detach-and-promote "neptune-gdb-disaster-recovery.md#neptune-gdb-detach-and-promote").
