...
# Amazon Neptune Engine version 1.4.7.1 (2026-09-18)
<a name="engine-releases-1.4.7.1"></a>

As of 2026-09-18, engine version 1.4.7.1 is being generally deployed. Please note that it takes several days for a new release to become available in every region.

## Defects fixed in this engine release (1.4.7.1)
<a name="engine-releases-1.4.7.1-defects"></a>

**General fixes**
+  Fixed an issue where the `VolumeBytesLeftTotal` Amazon CloudWatch metric reported incorrect values in engine version 1.4.7.0. 
+ Various stability and correctness fixes for the DFE query engine.

**Gremlin fixes**
+  Fixed an issue that could cause some Gremlin queries to fail using Neptune serverless when the instance has scaled down close to the minimum NCU value. 
+  General stability and security improvements for Gremlin data loading. 

## Query-Language Versions Supported in This Release
<a name="engine-releases-1.4.7.1-query-versions"></a>

Before upgrading a DB cluster to version 1.4.7.1, make sure that your project is compatible with these query-language versions:
+ *Gremlin earliest version supported:* `3.7.1`
+ *Gremlin latest version supported:* `3.7.1`
+ *openCypher version:* `Neptune-9.0.20190305-1.0`
+ *SPARQL version:* `1.1`

## Upgrade paths to engine release 1.4.7.1
<a name="engine-releases-1.4.7.1-upgrade-paths"></a>
...
Minor version upgrades to engine version 1.4.7.1 from versions prior to 1.4.7.0 are not supported for Neptune clusters that are part of a [global database](neptune-global-database.md). Non-global database clusters and major version upgrades are not affected.  
To minor version upgrade a global database cluster running a version prior to 1.4.7.0 to 1.4.7.1, you must first remove the secondary clusters from the global database (see [Removing a cluster](neptune-gdb-detaching.md)), upgrade the primary cluster to 1.4.7.1, and then create new secondary clusters in the global database.

## Upgrading to This Release
<a name="engine-releases-1.4.7.1-upgrading"></a>
...
<a name="engine-1.4.7.1-test-before-upgrading"></a>
...
<a name="engine-1.4.7.1-snapshot-before-upgrading"></a>
