...
**Additional connectivity configuration**:
    ...
    3. Under **Database port**, enter the TCP/IP port that
     ...
     `8182` as the default.
    4. Under **Network type**, choose **IPv4**
     to allow only IPv4 addresses to communicate with the DB cluster, or choose
     **Dual-stack** to allow both IPv4 and IPv6 addresses to communicate
     with the DB cluster. For more information, see [Dual-stack mode](neptune-dualstack-db-cluster.md "neptune-dualstack-db-cluster.md").
...
your new DB cluster. 10. Under **Additional configuration**, there are more settings
