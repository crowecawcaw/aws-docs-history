...
1. In a web browser, navigate to the URL where the RDF4J Workbench web app is deployed. For example, if you are using Apache Tomcat, the URL is: [https://{{ec2\_hostname}}:8080/rdf4j-workbench/](http://localhost:8080/rdf4j-workbench/).
