...
+ **Tags**  (in the CLI: `--tags`) –  *Required:* An array of [Tag](#Tag) objects.
...
**Response**
+ **TagList**   – An array of [Tag](#Tag) objects.
...
+ **Marker**   – a String, of type: `string` (a UTF-8 encoded string).
   ...
   An optional pagination token provided by a previous `DescribePendingMaintenanceActions` request. If this parameter is specified, the response includes only records beyond the marker, up to a number of records specified by `MaxRecords`.
+ **PendingMaintenanceActions**   – An array of [ResourcePendingMaintenanceActions](#ResourcePendingMaintenanceActions) objects.
...
**Response**
+ **DBEngineVersions**   – An array of [DBEngineVersion](#DBEngineVersion) objects.
...
<a name="DBEngineVersion"></a>
 ...
 This data type is used as a response element in the action [DescribeDBEngineVersions (action)](#DescribeDBEngineVersions).
...
+ **SupportedTimezones** – This is An array of [Timezone](api-datatypes.md#Timezone) objects.
...
+ **ValidUpgradeTarget** – This is An array of [UpgradeTarget](#UpgradeTarget) objects.
...
<a name="EngineDefaults"></a>
 ...
 Contains the result of a successful invocation of the [DescribeEngineDefaultParameters (action)](api-parameters.md#DescribeEngineDefaultParameters) action.
...
+ **Parameters** – This is An array of [Parameter](api-parameters.md#Parameter) objects.
...
+ **CurrentApplyDate** – This is a TStamp, of type: `timestamp` (a point in time, generally defined as an offset from midnight 1970-01-01).
  ...
  The effective date when the pending maintenance action is applied to the resource. This date takes into account opt-in requests received from the [ApplyPendingMaintenanceAction (action)](#ApplyPendingMaintenanceAction) API, the `AutoAppliedAfterDate`, and the `ForcedApplyDate`. This value is blank if an opt-in request has not been received and nothing has been specified as `AutoAppliedAfterDate` or `ForcedApplyDate`.
...
**Fields**
+ **PendingMaintenanceActionDetails** – This is An array of [PendingMaintenanceAction](#PendingMaintenanceAction) objects.
