...
applies to data protection in Amazon Neptune. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Neptune or other AWS services
...
You use AWS published API calls to manage Neptune through the network. Clients
must support Transport Layer Security (TLS) 1.2 or later using strong cipher suites, as
described in [Encrypting connects to Neptune databases](security-ssl.md "security-ssl.md"). Most
...
- [Securing your Amazon Neptune database with Amazon VPC](security-vpc.md "security-vpc.md")
- [Encrypting connections to your Amazon Neptune database with SSL/HTTPS](security-ssl.md "security-ssl.md")
- [Encrypting data at rest in your Amazon Neptune database](encrypt.md "encrypt.md")
