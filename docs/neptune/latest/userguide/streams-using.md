...
change-log entries that record every change made to your graph data as it happens. For an
overview of this feature, see [Capturing graph changes in real time using Neptune streams](streams.md "streams.md").

###### Topics

- [Enabling Neptune Streams](streams-using-enabling.md "streams-using-enabling.md")
