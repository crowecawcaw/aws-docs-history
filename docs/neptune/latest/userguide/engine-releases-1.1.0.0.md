...
As of 2022-12-23, engine version 1.1.0.0.R3 is being generally deployed. Please note
...
Before upgrading a DB cluster to version 1.1.0.0.R3, make sure that your project is compatible
