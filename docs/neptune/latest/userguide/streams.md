...
- By default, change records are automatically purged one week after they
  ...
  1.2.0.0](engine-releases-1.2.0.0.md "engine-releases-1.2.0.0.md"), this retention period can be changed using the the [neptune\_streams\_expiry\_days](parameters.md#parameters-db-cluster-parameters-neptune_streams_expiry_days "parameters.md#parameters-db-cluster-parameters-neptune_streams_expiry_days")
