...
The corresponding state of the SPOG (Subject-Predicate-Object\_Graph) index is shown below on the left. On the right, the corresponding strings are shown, to help understand what the index data means.
