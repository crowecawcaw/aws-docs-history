...
As of 2021-03-22, engine version 1.0.4.1.R1.1 is being generally deployed. Please note
...
Before upgrading a DB cluster to version 1.0.4.1.R1.1, make sure that your project is compatible
