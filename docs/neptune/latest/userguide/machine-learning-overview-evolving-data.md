...
Inductive inference is disabled by default. You can enable it for a query by using the Gremlin [Neptune\#ml.inductiveInference](machine-learning-gremlin-inference-query-predicates.md#machine-learning-gremlin-inference-neptune-ml-inductiveInference) predicate in the query as follows:
