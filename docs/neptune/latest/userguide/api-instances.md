...
+ [OrderableDBInstanceOption (structure)](#OrderableDBInstanceOption)
+ [PendingModifiedValues (structure)](#PendingModifiedValues)
+ [ValidStorageOptions (structure)](#ValidStorageOptions)
+ [ValidDBInstanceModificationsMessage (structure)](#ValidDBInstanceModificationsMessage)
...
+ **BackupRetentionPeriod**  (in the CLI: `--backup-retention-period`) –  an IntegerOptional, of type: `integer` (a signed 32-bit integer).
  ...
  Not applicable. The retention period for automated backups is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
+ **DBClusterIdentifier**  (in the CLI: `--db-cluster-identifier`) –  *Required:* a String, of type: `string` (a UTF-8 encoded string).
  ...
  For information on creating a DB cluster, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
+ **KmsKeyId**  (in the CLI: `--kms-key-id`) –  a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not applicable. The KMS key identifier is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
+ **Port**  (in the CLI: `--port`) –  an IntegerOptional, of type: `integer` (a signed 32-bit integer).
  ...
  Not applicable. The port is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
+ **PreferredBackupWindow**  (in the CLI: `--preferred-backup-window`) –  a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not applicable. The daily time range for creating automated backups is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
+ **StorageEncrypted**  (in the CLI: `--storage-encrypted`) –  a BooleanOptional, of type: `boolean` (a Boolean (true or false) value).
  ...
  Not applicable. The encryption for DB instances is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).

  Default: false
+ **StorageType**  (in the CLI: `--storage-type`) –  a String, of type: `string` (a UTF-8 encoded string).

  Not applicable. In Neptune the storage type is managed at the DB Cluster level.
+ **Tags**  (in the CLI: `--tags`) –  An array of [Tag](api-other-apis.md#Tag) objects.
...
+ **VpcSecurityGroupIds**  (in the CLI: `--vpc-security-group-ids`) –  a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not applicable. The associated list of EC2 VPC security groups is managed by the DB cluster. For more information, see [CreateDBCluster (action)](api-clusters.md#CreateDBCluster).
...
This data type is used as a response element in the [DescribeDBInstances (action)](#DescribeDBInstances) action.
...
+ **DBName**   – a String, of type: `string` (a UTF-8 encoded string).
  ...
  The database name.
+ **DBParameterGroups**   – An array of [DBParameterGroupStatus](api-parameters.md#DBParameterGroupStatus) objects.

  Provides the list of DB parameter groups applied to this DB instance.
+ **DBSecurityGroups**   – An array of [DBSecurityGroupMembership](api-datatypes.md#DBSecurityGroupMembership) objects.

   Provides List of DB security group elements containing only `DBSecurityGroup.Name` and `DBSecurityGroup.Status` subelements.
+ **DBSubnetGroup**   – A [DBSubnetGroup](api-subnets.md#DBSubnetGroup) object.
...
+ **DomainMemberships**   – An array of [DomainMembership](api-datatypes.md#DomainMembership) objects.

  Not supported
+ **EnabledCloudwatchLogsExports**   – a String, of type: `string` (a UTF-8 encoded string).

  A list of log types that this DB instance is configured to export to CloudWatch Logs.
+ **Endpoint**   – An [Endpoint](api-datatypes.md#Endpoint) object.
...
+ **PendingModifiedValues**   – A [PendingModifiedValues](#PendingModifiedValues) object.
...
+ **Timezone**   – a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not supported.
+ **VpcSecurityGroups**   – An array of [VpcSecurityGroupMembership](api-datatypes.md#VpcSecurityGroupMembership) objects.
...
Modifies settings for a DB instance. You can change one or more database configuration parameters by specifying these parameters and the new values in the request. To learn what modifications you can make to your DB instance, call [DescribeValidDBInstanceModifications (action)](#DescribeValidDBInstanceModifications) before you call [ModifyDBInstance (action)](#ModifyDBInstance).
...
+ **ApplyImmediately**  (in the CLI: `--apply-immediately`) –  a Boolean, of type: `boolean` (a Boolean (true or false) value).
  ...
  Specifies whether the modifications in this request and any pending modifications are asynchronously applied as soon as possible, regardless of the `PreferredMaintenanceWindow` setting for the DB instance.
   ...
   If this parameter is set to `false`, changes to the DB instance are applied during the next maintenance window. Some parameter changes can cause an outage and are applied on the next call to [RebootDBInstance (action)](#RebootDBInstance), or the next failure reboot.
...
+ **BackupRetentionPeriod**  (in the CLI: `--backup-retention-period`) –  an IntegerOptional, of type: `integer` (a signed 32-bit integer).
  ...
  Not applicable. The retention period for automated backups is managed by the DB cluster. For more information, see [ModifyDBCluster (action)](api-clusters.md#ModifyDBCluster).
...
+ **CloudwatchLogsExportConfiguration**  (in the CLI: `--cloudwatch-logs-export-configuration`) –  A [CloudwatchLogsExportConfiguration](api-clusters.md#CloudwatchLogsExportConfiguration) object.
...
+ **EnableIAMDatabaseAuthentication**  (in the CLI: `--enable-iam-database-authentication`) –  a BooleanOptional, of type: `boolean` (a Boolean (true or false) value).
  ...
  Not applicable. Mapping Amazon IAM accounts to database accounts is managed by the DB cluster. For more information, see [ModifyDBCluster (action)](api-clusters.md#ModifyDBCluster).

  Default: `false`
+ **EngineVersion**  (in the CLI: `--engine-version`) –  a String, of type: `string` (a UTF-8 encoded string).

  The version number of the database engine to upgrade to. Currently, setting this parameter has no effect. To upgrade your database engine to the most recent release, use the [ApplyPendingMaintenanceAction (action)](api-other-apis.md#ApplyPendingMaintenanceAction) API.
+ **Iops**  (in the CLI: `--iops`) –  an IntegerOptional, of type: `integer` (a signed 32-bit integer).
...
+ **PreferredBackupWindow**  (in the CLI: `--preferred-backup-window`) –  a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not applicable. The daily time range for creating automated backups is managed by the DB cluster. For more information, see [ModifyDBCluster (action)](api-clusters.md#ModifyDBCluster).
...
+ **VpcSecurityGroupIds**  (in the CLI: `--vpc-security-group-ids`) –  a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not applicable. The associated list of EC2 VPC security groups is managed by the DB cluster. For more information, see [ModifyDBCluster (action)](api-clusters.md#ModifyDBCluster).
...
+ **Filters**  (in the CLI: `--filters`) –  An array of [Filter](api-datatypes.md#Filter) objects.
...
**Response**
+ **DBInstances**   – An array of [DBInstance](#DBInstance) objects.

   A list of [DBInstance (structure)](#DBInstance) instances.
...
+ **OrderableDBInstanceOptions**   – An array of [OrderableDBInstanceOption](#OrderableDBInstanceOption) objects.

  An [OrderableDBInstanceOption (structure)](#OrderableDBInstanceOption) structure containing information about orderable options for the DB instance.
...
You can call [DescribeValidDBInstanceModifications (action)](#DescribeValidDBInstanceModifications) to learn what modifications you can make to your DB instance. You can use this information when you call [ModifyDBInstance (action)](#ModifyDBInstance).
...
Information about valid modifications that you can make to your DB instance. Contains the result of a successful call to the [DescribeValidDBInstanceModifications (action)](#DescribeValidDBInstanceModifications) action. You can use this information when you call [ModifyDBInstance (action)](#ModifyDBInstance). 
+ **Storage**   – An array of [ValidStorageOptions](#ValidStorageOptions) objects.
...
+ **DBName** – This is a String, of type: `string` (a UTF-8 encoded string).
  ...
  The database name.
+ **DBParameterGroups** – This is An array of [DBParameterGroupStatus](api-parameters.md#DBParameterGroupStatus) objects.

  Provides the list of DB parameter groups applied to this DB instance.
+ **DBSecurityGroups** – This is An array of [DBSecurityGroupMembership](api-datatypes.md#DBSecurityGroupMembership) objects.

   Provides List of DB security group elements containing only `DBSecurityGroup.Name` and `DBSecurityGroup.Status` subelements.
+ **DBSubnetGroup** – This is A [DBSubnetGroup](api-subnets.md#DBSubnetGroup) object.

  Specifies information on the subnet group associated with the DB instance, including the name, description, and subnets in the subnet group.
+ **DeletionProtection** – This is a BooleanOptional, of type: `boolean` (a Boolean (true or false) value).

  Indicates whether or not the DB instance has deletion protection enabled. The instance can't be deleted when deletion protection is enabled. See [Deleting a DB Instance](https://docs.aws.amazon.com/neptune/latest/userguide/manage-console-instances-delete.html).
+ **DomainMemberships** – This is An array of [DomainMembership](api-datatypes.md#DomainMembership) objects.

  Not supported
+ **EnabledCloudwatchLogsExports** – This is a String, of type: `string` (a UTF-8 encoded string).

  A list of log types that this DB instance is configured to export to CloudWatch Logs.
+ **Endpoint** – This is An [Endpoint](api-datatypes.md#Endpoint) object.
...
+ **MultiAZ** – This is a Boolean, of type: `boolean` (a Boolean (true or false) value).
  ...
  Specifies if the DB instance is a Multi-AZ deployment.
+ **PendingModifiedValues** – This is A [PendingModifiedValues](#PendingModifiedValues) object.
...
+ **SecondaryAvailabilityZone** – This is a String, of type: `string` (a UTF-8 encoded string).
  ...
  If present, specifies the name of the secondary Availability Zone for a DB instance with multi-AZ support.
+ **StatusInfos** – This is An array of [DBInstanceStatusInfo](#DBInstanceStatusInfo) objects.
...
+ **Timezone** – This is a String, of type: `string` (a UTF-8 encoded string).
  ...
  Not supported.
+ **VpcSecurityGroups** – This is An array of [VpcSecurityGroupMembership](api-datatypes.md#VpcSecurityGroupMembership) objects.
...
Contains a list of available options for a DB instance.
 ...
 This data type is used as a response element in the [DescribeOrderableDBInstanceOptions (action)](#DescribeOrderableDBInstanceOptions) action.

**Fields**
+ **AvailabilityZones** – This is An array of [AvailabilityZone](api-datatypes.md#AvailabilityZone) objects.
...
This data type is used as a response element in the [ModifyDBInstance (action)](#ModifyDBInstance) action.
...
+ **PendingCloudwatchLogsExports** – This is A [PendingCloudwatchLogsExports](api-clusters.md#PendingCloudwatchLogsExports) object.
...
**Fields**
+ **IopsToStorageRatio** – This is An array of [DoubleRange](api-datatypes.md#DoubleRange) objects.

  Not applicable. In Neptune the storage type is managed at the DB Cluster level.
+ **ProvisionedIops** – This is An array of [Range](api-datatypes.md#Range) objects.

  Not applicable. In Neptune the storage type is managed at the DB Cluster level.
+ **StorageSize** – This is An array of [Range](api-datatypes.md#Range) objects.
...
**Fields**
+ **Storage** – This is An array of [ValidStorageOptions](#ValidStorageOptions) objects.
