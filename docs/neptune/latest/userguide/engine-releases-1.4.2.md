# Amazon Neptune Engine version 1.4.2.0 (2024-12-19)

As of 2024-12-19, engine version 1.4.2.0 is being generally deployed. Please note
...
- Fixed execution plan and performance for queries with multiple property accesses over the same variable inside
  OPTIONAL MATCH and list comprehension. For example:
...
Before upgrading a DB cluster to version 1.4.2.0, make sure that your project is compatible
...
## Upgrade paths to engine release 1.4.2.0
