...
As of 2025-09-18, engine version 1.4.6.1 is being generally deployed. Please note that it takes several days for a new release to become available in every region.

## Defects fixed in this engine release
<a name="engine-releases-1.4.6.1-defects"></a>

**General fixes**
+  Removed the network checks for clusters that are using non-RFC 1918 conforming private IP ranges that was introduced in Release [Amazon Neptune Engine version 1.4.6.0 (2025-09-02)](engine-releases-1.4.6.0.md). 
...
Before upgrading a DB cluster to version 1.4.6.1, make sure that your project is compatible with these query-language versions:
