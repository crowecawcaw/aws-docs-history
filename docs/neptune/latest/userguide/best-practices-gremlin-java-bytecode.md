...
+ **Avoid string-based performance penalty: **  Any string-based query submission, whether you're using WebSockets or HTTP, results in a detached vertex, which implies that the Vertex object consists of the ID, Label and all the properties associated with the Vertex (see [Properties of Elements](http://tinkerpop.apache.org/docs/current/reference/#_properties_of_elements)).
