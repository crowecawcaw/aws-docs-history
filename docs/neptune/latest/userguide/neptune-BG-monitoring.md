...
![Screenshot of the Blue/Green CloudFormation stack output](https://docs.aws.amazon.com/neptune/latest/userguide/images/BG-stack-output.png)
...
![Screenshot of the Neptune Blue/Green log screen](https://docs.aws.amazon.com/neptune/latest/userguide/images/BG-log-screenshot.png)


Log messages show the sync status between the blue and green clusters:

![Screenshot of Neptune Blue/Green solution log messages](https://docs.aws.amazon.com/neptune/latest/userguide/images/BG-log-messages.png)
