...
reference, see [neptunedata](../../../cli/latest/reference/neptunedata.md "../../../cli/latest/reference/neptunedata.md")
...
You can use the Neptune Data API through the AWS SDKs to run queries
programmatically. The following Python examples show how to run a basic query:
...
For AWS SDK examples in other languages, see
[AWS SDK](access-graph-gremlin-sdk.md "access-graph-gremlin-sdk.md").
...
For AWS SDK examples in other languages, see
[AWS SDK](access-graph-opencypher-sdk.md "access-graph-opencypher-sdk.md").

## Using `curl` and `awscurl`

The [curl](https://curl.haxx.se/ "https://curl.haxx.se/") command-line tool submits
HTTP requests directly to the Neptune endpoints. If IAM authentication is enabled,
use [awscurl](https://github.com/okigan/awscurl "https://github.com/okigan/awscurl") or
...
store, see [SSL Certificate Verification](https://curl.haxx.se/docs/sslcerts.html "https://curl.haxx.se/docs/sslcerts.html") in the `curl` documentation.
...
For more information about the tool, see the [curl man page](https://curl.haxx.se/docs/manpage.html "https://curl.haxx.se/docs/manpage.html"), and the book
...
Plain `curl` works only when IAM authentication is not
...
For more Gremlin HTTP examples, see
[HTTPS REST](access-graph-gremlin-rest.md "access-graph-gremlin-rest.md").
For more openCypher HTTP examples, see
[HTTPS endpoint](access-graph-opencypher-queries.md "access-graph-opencypher-queries.md").
