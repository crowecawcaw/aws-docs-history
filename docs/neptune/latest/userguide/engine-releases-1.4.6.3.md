...
As of 2025-12-18, engine version 1.4.6.3 is being generally deployed. Please note that it takes several days for a new release to become available in every region.
...
Before upgrading a DB cluster to version 1.4.6.3, make sure that your project is compatible with these query-language versions:
