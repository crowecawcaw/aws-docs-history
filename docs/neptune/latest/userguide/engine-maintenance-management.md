...
Automatic minor version upgrades don't apply to Neptune clusters that are part of a global database. You can set this option on a DB instance in a global database cluster, but it has no effect. 
