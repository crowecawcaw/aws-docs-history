...
**Warning**  
 Engine release 1.3.2.0 introduced some potential issues that you should be aware of. See the section below on [Mitigating issues in release 1.3.2.0](#1.3.2.0-mitigation) for more information. 
