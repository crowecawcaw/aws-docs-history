...
- You must have the IAM credentials needed to sign the requests. See [Using the default credential
  provider chain](../../../sdk-for-java/latest/developer-guide/credentials-chain.md "../../../sdk-for-java/latest/developer-guide/credentials-chain.md") in the AWS SDK for Java Developer Guide.
