...
+ [Release: 1.0.5.1.R2 (2021-10-26)](engine-releases-1.0.5.1.R2.md) 
+ [Release: 1.0.5.1.R3 (2022-01-13)](engine-releases-1.0.5.1.R3.md) 
+ [Maintenance release: 1.0.5.1.R4 (2022-05-16)](engine-releases-1.0.5.1.R4.md) 

## New Features in This Engine Release
<a name="engine-releases-1.0.5.1-features"></a>
+ Added a [results cache](gremlin-results-cache.md) for caching the results of specified queries.
