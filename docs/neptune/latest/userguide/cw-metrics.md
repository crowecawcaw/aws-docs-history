...
| `VolumeBytesUsed` | The total amount of storage allocated to your Neptune DB cluster, in bytes.<br>This is the amount of storage for which you are billed. It is the maximum amount of<br>storage allocated to your DB cluster at any point in its existence, not the amount<br>you are currently using (see [Neptune storage billing](feature-overview-storage.md#feature-overview-storage-billing "feature-overview-storage.md#feature-overview-storage-billing")). | 5 min | sum |
