...
+ Added support for [Gremlin query hints](gremlin-query-hints.md).
+ Improved error messages for IAM authentication. For more information, see [IAM Authentication Errors](errors-engine-codes.md#errors-iam-auth).
