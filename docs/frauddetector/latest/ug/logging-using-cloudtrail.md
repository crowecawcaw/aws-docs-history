...
Amazon Fraud Detector supports logging every action (API operation) as an event in CloudTrail log files. For more information, see [Actions]( https://docs.aws.amazon.com/frauddetector/latest/api/API_Operations.html). 
