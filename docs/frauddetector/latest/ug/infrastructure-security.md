...
As a managed service, Amazon Fraud Detector is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Fraud Detector through the network. Clients must
