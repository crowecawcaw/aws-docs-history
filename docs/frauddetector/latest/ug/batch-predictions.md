...
**Topics**
+ [How batch predictions work](#how-batch-predictions-works)
+ [Input and output files](#input-and-output-files)
+ [Getting batch predictions](#getting-batch-predictions)
+ [Guidance on IAM roles](#guidance-iam-roles)
+ [Get batch fraud predictions using the AWS SDK for Python (Boto3)](#get-a-batch-fraud-prediction-using-the-aws-python-sdk)
