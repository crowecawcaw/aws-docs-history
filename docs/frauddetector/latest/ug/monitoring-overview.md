...
**Topics**
+ [Monitoring Amazon Fraud Detector with Amazon CloudWatch](monitoring-cloudwatch.md)
+ [Logging Amazon Fraud Detector API Calls with AWS CloudTrail](logging-using-cloudtrail.md)