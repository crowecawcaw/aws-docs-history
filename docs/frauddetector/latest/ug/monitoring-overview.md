...
Amazon Fraud Detector and your other AWS solutions. AWS provides the following monitoring tools to
...
- [Monitoring Amazon Fraud Detector with Amazon CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md")
- [Logging Amazon Fraud Detector API Calls with AWS CloudTrail](logging-using-cloudtrail.md "logging-using-cloudtrail.md")
