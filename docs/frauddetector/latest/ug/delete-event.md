...
1. In the left navigation pane of the console, choose **Search past predictions**.

1. Choose the event that you want to delete.

1. Choose **Actions**, and then choose **Delete event**.

1. Enter **delete**, and then choose **Delete event**.
...
1. Choose the event type for which you want all events deleted.

1. Navigate to **Stored events** tab and choose **Delete stored events**
...
1. Choose the event type that you want to delete.
