...
| Match any number of characters except new line prior ‘mystring’ | regex\_match(".\*mystring", $variable) | 
...
| isbefore(DateTime1, DateTime2) | Returns a boolean(True/False) if the caller DateTime1 is before DateTime2 | isbefore(getcurrentdatetime(), "2019-11-30T01:01:01Z") == "False"<br />isbefore(getcurrentdatetime(), "2050-11-30T01:05:01Z") == "True" | 
| isafter(DateTime1,DateTime2) | Returns a boolean(True/False) if the caller DateTime1 is after DateTime2 | isafter(getcurrentdatetime(), "2019-11-30T01:01:01Z") == "True"<br />isafter(getcurrentdatetime(), "2050-11-30T01:05:01Z") == "False" | 
