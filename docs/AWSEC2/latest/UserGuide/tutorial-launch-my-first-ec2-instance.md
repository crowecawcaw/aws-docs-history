...
| Prerequisites |  +  You must have an AWS account, configure a user with administrator access, and use the administrator user to sign into the AWS Management Console. Not sure how to do this? Try this tutorial: [Setting Up Your AWS Environment ](https://aws.amazon.com/getting-started/guides/setup-environment/) <br />+  You must have general familiarity with the AWS console. Not sure where to start? Try this getting started guide: [Getting Started with the AWS Management Console](https://aws.amazon.com/getting-started/hands-on/getting-started-with-aws-management-console/)   | 
