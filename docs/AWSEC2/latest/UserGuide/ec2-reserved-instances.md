...
- [Exchange Convertible Reserved Instances](ri-convertible-exchange.md "ri-convertible-exchange.md")
- [Reserved Instance quotas](ri-limits.md "ri-limits.md")
...
![Purchasing Reserved Instances.](images/ri-basics.png)
...
- **Instance type**: For example,
  `m4.large`. This is composed of the instance family (for
  example, `m4`) and the instance size (for example,
  `large`).
- **Region**: The Region in which the Reserved Instance is
  purchased.
- **Tenancy**: Whether your instance runs on
  shared (default) or single-tenant (dedicated) hardware. For more
  information, see [Amazon EC2 Dedicated Instances](dedicated-instance.md "dedicated-instance.md").
- **Platform**: The operating system; for
  example, Windows or Linux/Unix. For more information, see [Choosing a platform](ri-market-concepts-buying.md#ri-choosing-platform "ri-market-concepts-buying.md#ri-choosing-platform").
...
- **One-year**: A year is defined as 31536000
  seconds (365 days).
- **Three-year**: Three years is defined as
...
be able to [modify](ri-modifying.md "ri-modifying.md"), [exchange](ri-convertible-exchange.md "ri-convertible-exchange.md"), or [sell](ri-market-general.md "ri-market-general.md") your Reserved Instance if your needs
change.
...
- **All Upfront**: Full payment is made at the
...
- **Partial Upfront**: A portion of the cost
...
- **No Upfront**: You are billed a discounted
...
shorter term lengths on the Reserved Instance Marketplace. For more information, see [Sell Reserved Instances for Amazon EC2 in the Reserved Instance Marketplace](ri-market-general.md "ri-market-general.md").
...
For more information, see [Types of Reserved Instances (offering classes)](reserved-instances-types.md "reserved-instances-types.md").

###### Important

After you purchase a Reserved Instance, you cannot cancel your purchase. However, you might be
able to [modify](ri-modifying.md "ri-modifying.md"), [exchange](ri-convertible-exchange.md "ri-convertible-exchange.md"), or [sell](ri-market-general.md "ri-market-general.md") your Reserved Instance if your needs change.

For more information, see the [Amazon EC2 Reserved Instances Pricing
page](https://aws.amazon.com/ec2/pricing/reserved-instances/pricing/ "https://aws.amazon.com/ec2/pricing/reserved-instances/pricing/").
