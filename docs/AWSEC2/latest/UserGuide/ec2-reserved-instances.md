...
+ [How Reserved Instance discounts are applied](apply_ri.md)
+ [Use your Reserved Instances](using-reserved-instances.md)
+ [How billing works with Reserved Instances](concepts-reserved-instances-application.md)
+ [Buy Reserved Instances for Amazon EC2](ri-market-concepts-buying.md)
+ [Sell Reserved Instances for Amazon EC2 in the Reserved Instance Marketplace](ri-market-general.md)
...
![Purchasing Reserved Instances.](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/images/ri-basics.png)
