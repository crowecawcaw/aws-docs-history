...
| -------- | ------------------------------- | ---------- | ------------------------------------------------------------------------------------------- |
| TCP      | `ID of instance security group` | 22         | Allows outbound SSH traffic to all instances associated with the<br>instance security group |
...
[Considerations](connect-with-ec2-instance-connect-endpoint.md#ec2-instance-connect-endpoint-prerequisites "connect-with-ec2-instance-connect-endpoint.md#ec2-instance-connect-endpoint-prerequisites").
...
| -------- | ------------------------------- | ---------- | -------------------------------------------------------------------------------------------- |
| TCP      | `ID of endpoint security group` | 22         | Allows inbound SSH traffic from the resources associated with the<br>endpoint security group |
...
| Protocol | Source                      | Port range | Comment                                                                |
| -------- | --------------------------- | ---------- | ---------------------------------------------------------------------- |
| TCP      | `Public IPv4 address range` | 22         | Allows inbound traffic from the specified client IPv4 address<br>range |
