...
- [How zonal Reserved Instances are applied](#apply-zonal-ri "#apply-zonal-ri")
- [How regional Reserved Instances are applied](#apply-regional-ri "#apply-regional-ri")
- [Instance size flexibility](#ri-instance-size-flexibility "#ri-instance-size-flexibility")
- [Examples of applying Reserved Instances](#ri-usage-examples "#ri-usage-examples")
...
- The Reserved Instance discount applies to instance usage within the instance family,
  ...
  flexibility](#ri-instance-size-flexibility "#ri-instance-size-flexibility").
...
![Applying a Regional Reserved Instance.](images/ri-instance-flex-full.png)
...
![Applying a Regional Reserved Instance.](images/ri-instance-flex-partial.png)
...
| `c5n.metal`     | 144                           |
| `c5.metal`      | <br>`c5d.metal`               | <br>`i3en.metal`    | <br>`m5.metal`   | <br>`m5d.metal`  | <br>`m5dn.metal` | <br>`m5n.metal`  | <br>`r5.metal`   | <br>`r5b.metal` | <br>`r5d.metal` | <br>`r5dn.metal` | <br>`r5n.metal` | 192 |
| `c6i.metal`     | <br>`c6id.metal`              | <br>`m6i.metal`     | <br>`m6id.metal` | <br>`r6d.metal`  | <br>`r6id.metal` | 256              |
| `u-18tb1.metal` | <br>`u-24tb1.metal`           | 448                 |
| `u-6tb1.metal`  | <br>`u-9tb1.metal`            | <br>`u-12tb1.metal` | 896              |
...
reservations](../../../cur/latest/userguide/understanding-ri.md "../../../cur/latest/userguide/understanding-ri.md") in the AWS Cost and Usage Report.
