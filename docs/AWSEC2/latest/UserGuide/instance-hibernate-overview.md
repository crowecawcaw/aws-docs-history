...
see [Differences between instance states](ec2-instance-lifecycle.md#lifecycle-differences "ec2-instance-lifecycle.md#lifecycle-differences").
...
- (Spot Instances only) If Amazon EC2 hibernates your Spot Instance, only Amazon EC2 can resume
  your instance. If you hibernate your Spot Instance ([user-initiated hibernation](hibernating-instances.md "hibernating-instances.md")), you
