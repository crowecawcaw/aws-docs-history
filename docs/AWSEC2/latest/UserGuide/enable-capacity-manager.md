...
**Topics**
+ [Enabling EC2 Capacity Manager with AWS Organizations](enable-capacity-manager-organizations.md)
+ [Enabling EC2 Capacity Manager at the account-level](enable-capacity-manager-account.md)
+ [Registering a delegated administrator](enable-capacity-manager-da.md)
+ [Using service-linked roles for EC2 Capacity Manager](using-service-linked-roles-cm.md)