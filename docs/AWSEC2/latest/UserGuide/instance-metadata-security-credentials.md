...
you get an `AccessDenied` error. For more information, see [Update a role trust policy](../../../IAM/latest/UserGuide/id_roles_update-role-trust-policy.md "../../../IAM/latest/UserGuide/id_roles_update-role-trust-policy.md") in the _IAM User Guide_.
...
[I can't access the temporary security credentials on my EC2 instance](../../../IAM/latest/UserGuide/troubleshoot_iam-ec2.md#troubleshoot_iam-ec2_no-keys "../../../IAM/latest/UserGuide/troubleshoot_iam-ec2.md#troubleshoot_iam-ec2_no-keys")
