...
- [Network interface concepts](#eni-basics "#eni-basics")
- [Network cards](#network-cards "#network-cards")
- [Maximum IP addresses per network interface](AvailableIpPerENI.md "AvailableIpPerENI.md")
- [Create a network interface for your EC2 instance](create-network-interface.md "create-network-interface.md")
- [Network interface attachments for your EC2 instance](network-interface-attachments.md "network-interface-attachments.md")
- [Manage the IP addresses for your network interface](managing-network-interface-ip-addresses.md "managing-network-interface-ip-addresses.md")
- [Modify network interface attributes](modify-network-interface-attributes.md "modify-network-interface-attributes.md")
- [Multiple network interfaces for your Amazon EC2 instances](scenarios-enis.md "scenarios-enis.md")
- [Requester-managed network interfaces](requester-managed-eni.md "requester-managed-eni.md")
- [Prefix delegation for Amazon EC2 network interfaces](ec2-prefix-eni.md "ec2-prefix-eni.md")
- [Delete a network interface](delete_eni.md "delete_eni.md")
...
Each instance has a default network interface, called the _primary
network interface_. You can't detach a primary network interface from
an instance.
...
see [Maximum IP addresses per network interface](AvailableIpPerENI.md "AvailableIpPerENI.md").
...
subnet) are assigned a public IPv4 address. For more information, see [Subnet settings](../../../vpc/latest/userguide/configure-subnets.md#subnet-settings "../../../vpc/latest/userguide/configure-subnets.md#subnet-settings")
...
information, see [Requester-managed network interfaces](requester-managed-eni.md "requester-managed-eni.md").
...
field. For more information, see [Amazon EC2 managed instances](amazon-ec2-managed-instances.md "amazon-ec2-managed-instances.md").
