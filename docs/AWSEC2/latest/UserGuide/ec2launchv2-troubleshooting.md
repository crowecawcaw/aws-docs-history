...
| --- | --- | 
| S (Stage) | 0 - Service-level message<br />1 - Boot<br />2 - Network<br />3 - PreReady<br />5 - Windows is Ready<br />6 - PostReady<br />7 - User Data | 
...
| L (Level of the event) | 0 - Success<br />1 - Informational<br />2 - Warning<br />3 - Error | 
