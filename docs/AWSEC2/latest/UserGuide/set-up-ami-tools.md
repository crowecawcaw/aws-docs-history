...
the next step. 4. Install the RPM using the following command:

```
`[ec2-user ~]$` **sudo yum** install ec2-ami-tools.noarch.rpm
```

5. Verify your AMI tools installation using the [ec2-ami-tools-version](ami-tools-commands.md#ami-tools-version "ami-tools-commands.md#ami-tools-version") command.
...
path. 6. (Optional) If you received an error in the previous step, add the location of
your AMI tools installation to your `RUBYLIB` path.
    ...
    ```
    3. Verify your AMI tools installation using the [ec2-ami-tools-version](ami-tools-commands.md#ami-tools-version "ami-tools-commands.md#ami-tools-version")
     command.
...
`ec2-ami-tools-1.5.7`). 4. Set the `EC2_AMITOOL_HOME` environment variable to the installation
...
6. You can verify your AMI tools installation using the [ec2-ami-tools-version](ami-tools-commands.md#ami-tools-version "ami-tools-commands.md#ami-tools-version")
   command.
...
To upload the certificate to AWS, use the [upload-signing-certificate](../../../cli/latest/reference/iam/upload-signing-certificate.md "../../../cli/latest/reference/iam/upload-signing-certificate.md") command.

```
aws iam upload-signing-certificate --user-name `user-name` --certificate-body file://`path/to/certificate`.pem
```

To list the certificates for a user, use the [list-signing-certificates](../../../cli/latest/reference/iam/list-signing-certificates.md "../../../cli/latest/reference/iam/list-signing-certificates.md") command:

```
aws iam list-signing-certificates --user-name `user-name`
```

To disable or re-enable a signing certificate for a user, use the [update-signing-certificate](../../../cli/latest/reference/iam/update-signing-certificate.md "../../../cli/latest/reference/iam/update-signing-certificate.md") command. The following command disables the
certificate:
...
To delete a certificate, use the [delete-signing-certificate](../../../cli/latest/reference/iam/delete-signing-certificate.md "../../../cli/latest/reference/iam/delete-signing-certificate.md") command:
