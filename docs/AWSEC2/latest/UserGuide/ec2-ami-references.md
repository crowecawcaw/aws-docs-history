...
- [Supported resources](#ec2-ami-references-supported-resources "#ec2-ami-references-supported-resources")
- [How AMI reference checks work](#how-ami-references-works "#how-ami-references-works")
- [Required IAM permissions](#ami-references-required-permissions "#ami-references-required-permissions")
- [Steps for checking AMI references](#ami-reference-procedures "#ami-reference-procedures")
...
| ---------------- | ----------------------------- | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| EC2 instances    | `state-name`                  | Filter by instance state                                                                           | `pending`, `running`,<br>`shutting-down`, `terminated`,<br>`stopping`, `stopped` (all states) |
| Launch templates | `version-depth`               | Specify the number of launch template versions to check (starting<br>from the most recent version) | `10` (most recent versions)                                                                   |
...
We strongly recommend using the AWS managed policy [`AmazonEC2ImageReferencesAccessPolicy`](../../../aws-managed-policy/latest/reference/AmazonEC2ImageReferencesAccessPolicy.md "../../../aws-managed-policy/latest/reference/AmazonEC2ImageReferencesAccessPolicy.md")
...
To view the permissions included in this policy, see [AmazonEC2ImageReferencesAccessPolicy](../../../aws-managed-policy/latest/reference/AmazonEC2ImageReferencesAccessPolicy.md "../../../aws-managed-policy/latest/reference/AmazonEC2ImageReferencesAccessPolicy.md")
...
Use the [describe-image-references](../../../cli/latest/reference/ec2/describe-image-references.md "../../../cli/latest/reference/ec2/describe-image-references.md") command with the
...
Use the [describe-image-references](../../../cli/latest/reference/ec2/describe-image-references.md "../../../cli/latest/reference/ec2/describe-image-references.md") command with both the
...
Use the [Get-EC2ImageReference](../../../powershell/latest/reference/items/Get-EC2ImageReference.md "../../../powershell/latest/reference/items/Get-EC2ImageReference.md") cmdlet with the
