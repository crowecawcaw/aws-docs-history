...
(ABAC). For more information, see [Tag your resources](Using_Tags.md#tag-resources "Using_Tags.md#tag-resources") and [Control access using attribute-based access](iam-policies-for-amazon-ec2.md#control-access-with-tags "iam-policies-for-amazon-ec2.md#control-access-with-tags").
...
launch template. For an example policy, see [Tags in a launch template](ExamplePolicies_EC2.md#iam-example-tags-launch-template "ExamplePolicies_EC2.md#iam-example-tags-launch-template").
...
For example IAM policies, see [Example policies to control access the Amazon EC2 API](ExamplePolicies_EC2.md "ExamplePolicies_EC2.md"). For more information, see [Conditions with multiple context keys or values](../../../IAM/latest/UserGuide/reference_policies_condition-logic-multiple-context-keys-or-values.md "../../../IAM/latest/UserGuide/reference_policies_condition-logic-multiple-context-keys-or-values.md") in the
_IAM User Guide_.
