...
with you by other AWS accounts to a group.
...
5. In the **Capacity Reservations** section,
   choose **Add**.
6. Select the Capacity Reservations you want to add, then choose
   **Add**.
...
2. In the navigation pane, choose **Capacity
   Reservations**.
3. Select the Capacity Reservation you want to add to a group.
4. Choose **Action**, then choose
   **Add to group**.
5. Select the group, then choose
   **Add**.
...
Use the [group-resources](../../../cli/latest/reference/resource-groups/group-resources.md "../../../cli/latest/reference/resource-groups/group-resources.md") command. Provide the ARN of each Capacity Reservation
you want to add.
...
Use the [Add-RGResource](../../../powershell/latest/reference/items/Add-RGResource.md "../../../powershell/latest/reference/items/Add-RGResource.md") cmdlet.
