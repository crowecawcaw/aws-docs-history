...
The method you use to copy an AMI depends on whether you're copying across Regions _within the same [partition](../../../glossary/latest/reference/glos-chap.md#partition "../../../glossary/latest/reference/glos-chap.md#partition")_ or _across different
partitions_:
...
- **Cross-partition copying** – Copy AMIs _from one partition to another partition_, for example,
  ...
  this copy method, see [Store and restore an AMI](ami-store-restore.md "ami-store-restore.md").
- **Cross-account copying** – Create a copy of an AMI
  that another AWS account has [shared with your
  AWS account](sharingamis-explicit.md "sharingamis-explicit.md"). This copy method is described in this topic.
  ...
  more information, see [Time-based copies](../../../ebs/latest/userguide/time-based-copies.md "../../../ebs/latest/userguide/time-based-copies.md") in the
  _Amazon EBS User Guide_.

###### Contents

- [Considerations](#copy-ami-considerations "#copy-ami-considerations")
- [Costs](#copy-ami-costs "#copy-ami-costs")
- [Grant permissions to copy Amazon EC2 AMIs](copy-ami-permissions.md "copy-ami-permissions.md")
- [Copy an AMI](#ami-copy-steps "#ami-copy-steps")
- [Stop a pending AMI copy operation](#ami-copy-stop "#ami-copy-stop")
- [How Amazon EC2 AMI copy works](how-ami-copy-works.md "how-ami-copy-works.md")
...
- **Quotas for time-based AMI copies** – After you reach
  ...
  time-based AMI copy requests fail. For more information, see [Quotas for time-based copies](../../../ebs/latest/userguide/time-based-copies.md#time-based-copies-quota "../../../ebs/latest/userguide/time-based-copies.md#time-based-copies-quota") in the
  _Amazon EBS User Guide_.
