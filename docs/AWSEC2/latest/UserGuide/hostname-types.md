...
+ [Private hostnames](#ec2-instance-private-hostnames)
...
**Topics**
+ [Public hostname types and when to use them](#public-hostname-types)
+ [View public hostnames](#view-public-hostnames)
+ [Modify public hostnames types](#modify-public-hostnames)
...
**Topics**
+ [Private hostname types](#instance-naming-types)
+ [Where to find resource names and IP names](#instance-naming-presence)
+ [Choosing between resource names and IP names](#instance-naming-choose)
+ [Change resource based naming options for Amazon EC2](#instance-naming-modify)
...
When you launch EC2 instances in IPv6-only subnets, the **Hostname type** of **Resource name** is selected by default. When you launch an instance in IPv4-only or dual-stack (IPv4\+IPv6) subnets, **Resource name** is an option that you can select. After you launch an instance, you can manage the hostname configuration. For more information, see [Change resource based naming options for Amazon EC2](#instance-naming-modify).
