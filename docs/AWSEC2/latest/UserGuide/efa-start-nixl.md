...
more information, see the [NIXL](https://github.com/ai-dynamo/nixl "https://github.com/ai-dynamo/nixl")
website.
...
4. In the **Application and OS Images** section, select an AMI for
   ...
   [DLAMI
   Release Notes Page](../../../dlami/latest/devguide/appendix-ami-release-notes.md "../../../dlami/latest/devguide/appendix-ami-release-notes.md").
...
7. (`p4d.24xlarge` and `p5.48xlarge` only) Install the Nvidia Fabric Manager.
   ...
   to install Nvidia Fabric Manager version `450`. 2. Install the Nvidia Fabric Manager. Run the following command and specify the major version
...
1. Connect to the instance you launched. For more information, see
   [Connect to your Linux instance using SSH](connect-to-linux-instance.md "connect-to-linux-instance.md").
...
[NIXL repository](https://github.com/ai-dynamo/nixl "https://github.com/ai-dynamo/nixl").
...
[nixlbench
repository](https://github.com/ai-dynamo/nixl/tree/main/benchmark/nixlbench "https://github.com/ai-dynamo/nixl/tree/main/benchmark/nixlbench").
...
[nixlbench
repository](https://github.com/ai-dynamo/nixl/tree/main/benchmark/nixlbench "https://github.com/ai-dynamo/nixl/tree/main/benchmark/nixlbench"). 3. Install Docker.
...
2. Start the vLLM server with NIXL. The following sample commands create one prefill (producer)
   ...
   [NIXLConnector
   Usage Guide](https://github.com/vllm-project/vllm/blob/2d977a7a9ead3179fde9ed55d69393ef7b6cec47/docs/features/nixl_connector_usage.md "https://github.com/vllm-project/vllm/blob/2d977a7a9ead3179fde9ed55d69393ef7b6cec47/docs/features/nixl_connector_usage.md").
