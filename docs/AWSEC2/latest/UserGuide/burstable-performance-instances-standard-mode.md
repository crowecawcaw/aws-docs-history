...
depleted. For more information, see [Key concepts for burstable performance instances](burstable-credits-baseline-concepts.md "burstable-credits-baseline-concepts.md").
