...
depleted. For more information, see [Key concepts for burstable
...
- [Standard mode examples for burstable instances](standard-mode-examples.md "standard-mode-examples.md")
  - [Example 1: Explain credit use with T3
    Standard](standard-mode-examples.md#t3_standard_example "standard-mode-examples.md#t3_standard_example")
  - [Example 2: Explain credit use with T2
    Standard](standard-mode-examples.md#t2-standard-example "standard-mode-examples.md#t2-standard-example")
    ...
    - [Period 4: 62 – 72 hours](standard-mode-examples.md#period-4 "standard-mode-examples.md#period-4")
    - [Period 5: 73 – 75 hours](standard-mode-examples.md#period-5 "standard-mode-examples.md#period-5")
    - [Period 6: 76 – 90 hours](standard-mode-examples.md#period-6 "standard-mode-examples.md#period-6")
    - [Period 7: 91 – 96 hours](standard-mode-examples.md#period-7 "standard-mode-examples.md#period-7")
