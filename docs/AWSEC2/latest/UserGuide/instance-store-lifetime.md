...
| [An Amazon S3-backed AMI is created from<br>the instance](creating-an-ami-instance-store.md "creating-an-ami-instance-store.md") (Linux instances) | The data persists in the AMI bundle uploaded to Amazon S3 \*\*\* |
