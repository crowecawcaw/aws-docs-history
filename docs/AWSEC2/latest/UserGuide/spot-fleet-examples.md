...
**Topics**
+ [Example 1: Launch Spot Instances using the lowest-priced Availability Zone in the Region](#fleet-config1)
+ [Example 2: Launch Spot Instances using the lowest-priced Availability Zone from a list](#fleet-config2)
+ [Example 3: Launch Spot Instances using the lowest-priced instance type from a list](#fleet-config3)
...
+ [Example 7: Launch a Spot Fleet using On-Demand capacity](#fleet-config7)
