...
| TCP           | 6               | 80 (HTTP)   | ::/0      | Allows inbound HTTP access from any IPv6<br>address  |
| TCP           | 6               | 443 (HTTPS) | ::/0      | Allows inbound HTTPS access from any IPv6<br>address |
...
information about Amazon RDS instances, see the [Amazon RDS User Guide](../../../AmazonRDS/latest/UserGuide.md "../../../AmazonRDS/latest/UserGuide.md").
...
| ------------- | --------------- | ------------------- | ----------------------------------------------------------------------------------------------------- |
| TCP           | 6               | 1433 (MS SQL)       | The default port to access a Microsoft SQL Server database, for<br>example, on an Amazon RDS instance |
| TCP           | 6               | 3306 (MYSQL/Aurora) | The default port to access a MySQL or Aurora database, for<br>example, on an Amazon RDS instance      |
| TCP           | 6               | 5439 (Redshift)     | The default port to access an Amazon Redshift cluster database.                                       |
| TCP           | 6               | 5432 (PostgreSQL)   | The default port to access a PostgreSQL database, for example, on<br>an Amazon RDS instance           |
| TCP           | 6               | 1521 (Oracle)       | The default port to access an Oracle database, for example, on an<br>Amazon RDS instance              |
...
| TCP           | 6               | 80 (HTTP)   | ::/0           | (IPv6-enabled VPC only) Allows outbound HTTP access to any<br>IPv6 address  |
| TCP           | 6               | 443 (HTTPS) | ::/0           | (IPv6-enabled VPC only) Allows outbound HTTPS access to any<br>IPv6 address |
...
| ------------- | --------------- | -------- | ------------------------------------------------------------------------------------------------------------- |
| -1 (All)      | -1 (All)        | -1 (All) | The ID of the security group, or the CIDR range of the subnet that contains<br>the other instance (see note). |
...
| --------------------- | ------------- | --------------------------------------------------------------------------------------------------------------- |
| Custom ICMP<br>• IPv4 | Echo request  | The public IPv4 address of your computer, a specific IPv4 address, or an IPv4 or IPv6<br>address from anywhere. |
| All ICMP<br>• IPv4    | IPv4 ICMP (1) | The public IPv4 address of your computer, a specific IPv4 address, or an IPv4 or IPv6<br>address from anywhere. |
...
| Type               | Protocol       | Source                                                                                                   |
| ------------------ | -------------- | -------------------------------------------------------------------------------------------------------- |
| All ICMP<br>• IPv6 | IPv6 ICMP (58) | The IPv6 address of your computer, a specific IPv4 address, or an IPv4 or IPv6<br>address from anywhere. |
...
| ------------- | --------------- | ---------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------ |
| TCP           | 6               | 2049 (NFS) | The ID of the security group | Allows inbound NFS access from resources (including the mount<br>target) associated with this security group |
...
- [Configure security groups for your Classic Load Balancer](../../../elasticloadbalancing/latest/classic/elb-vpc-security-groups.md "../../../elasticloadbalancing/latest/classic/elb-vpc-security-groups.md")
