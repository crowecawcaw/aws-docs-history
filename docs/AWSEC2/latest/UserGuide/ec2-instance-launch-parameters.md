...
- [Name and tags](#liw-name-and-tags "#liw-name-and-tags")
- [Application and OS Images (Amazon Machine Image)](#liw-ami "#liw-ami")
- [Instance type](#liw-instance-type "#liw-instance-type")
- [Key pair (login)](#liw-key-pair "#liw-key-pair")
- [Network settings](#liw-network-settings "#liw-network-settings")
- [Configure storage](#liw-storage "#liw-storage")
- [Advanced details](#liw-advanced-details "#liw-advanced-details")
- [Summary](#liw-summary "#liw-summary")
...
For Spot Instances, you can tag the Spot Instance request only. For information about tags, see [Tag your Amazon EC2 resources](Using_Tags.md "Using_Tags.md").
...
- To find an AMI by using a Systems Manager parameter, choose the arrow button
  ...
  Systems Manager parameter**. For more information, see [Reference AMIs using Systems Manager parameters](using-systems-manager-parameter-to-find-AMI.md "using-systems-manager-parameter-to-find-AMI.md").
...
- Check the **Root device type** listed for each
  ...
  **instance-store** (backed by instance store).
  For more information, see [Root volume type](ComponentsAMIs.md#storage-for-the-root-device "ComponentsAMIs.md#storage-for-the-root-device").
- Check the **Virtualization** type listed for each
  AMI. Notice which AMIs are the type that you need: either
  **hvm** or **paravirtual**.
  For example, some instance types require HVM. For more information
  about Linux virtualization types, see [Virtualization types](ComponentsAMIs.md#virtualization_types "ComponentsAMIs.md#virtualization_types").
- Check the **Boot mode** listed for each AMI.
  ...
  **uefi-preferred**. For more information, see
  [Instance launch behavior with Amazon EC2 boot modes](ami-boot.md "ami-boot.md").
...
instance types](../../../ec2/latest/instancetypes/instance-types.md "../../../ec2/latest/instancetypes/instance-types.md").

- **Instance type**: Ensure that the instance type is
  compatible with the AMI that you've specified. For more information, see [Amazon EC2 instance types](instance-types.md "instance-types.md").
...
a **t3.micro** instance, it defaults to [Unlimited mode](burstable-performance-instances-unlimited-mode.md "burstable-performance-instances-unlimited-mode.md"), which might incur
...
- **Get advice**: You can get guidance and suggestions for
  instance types from the EC2 instance type finder. For more information, see [Get recommendations from EC2 instance type finder](get-ec2-instance-type-recommendations.md "get-ec2-instance-type-recommendations.md").
- (Launch templates only) **Advanced**: To specify instance
  ...
  - Expand **Optional instance type attributes** and
    ...
    [InstanceRequirementsRequest](../APIReference/API_InstanceRequirementsRequest.md "../APIReference/API_InstanceRequirementsRequest.md") in the _Amazon EC2 API Reference_.
...
see [Amazon EC2 key pairs and Amazon EC2 instances](ec2-key-pairs.md "ec2-key-pairs.md").
...
The network settings define the [IP addresses](using-instance-addressing.md "using-instance-addressing.md"),
[security groups](ec2-security-groups.md "ec2-security-groups.md"), and
[network interfaces](using-eni.md "using-eni.md") for your instances. You can use the
...
- (Launch instance wizard only) **VPC**: Choose an existing VPC
  ...
  more information, see [Virtual private clouds for your EC2 instances](using-vpc.md "using-vpc.md").
- **Subnet**: Choose a subnet for your instance or choose
  **Create new subnet** to create a new subnet using the Amazon VPC
  ...
  - To launch the instance in an IPv6-only subnet, the instance must be a
    [Nitro-based instance](instance-types.md#instance-hypervisor-type "instance-types.md#instance-hypervisor-type").
...
- (Launch instance wizard only) **Auto-assign Public IP**:
  ...
  **Disable**. For more information, see [Public IPv4 addresses](using-instance-addressing.md#concepts-public-addresses "using-instance-addressing.md#concepts-public-addresses").

You can't enable this option for nondefault subnets if you add a secondary
network interface. For more information, see [Assign a public IPv4 address at launch](working-with-ip-addresses.md#public-ip-addresses "working-with-ip-addresses.md#public-ip-addresses").

- (Launch instance wizard only) **Auto-assign IPv6 IP**:
  Enable or disable auto-assignment of IPv6 addresses. For more information,
  see [IPv6 addresses](using-instance-addressing.md#ipv6-addressing "using-instance-addressing.md#ipv6-addressing").
...
add rules as needed. For more information, see [Configure security group rules](changing-security-group.md#add-remove-security-group-rules "changing-security-group.md#add-remove-security-group-rules").
...
- **Advanced network configuration** – You can configure
  ...
  a [Nitro-based instance](instance-types.md#instance-hypervisor-type "instance-types.md#instance-hypervisor-type"). When launching an IPv6-only instance, it is
  ...
  - (Launch templates only) **Auto-assign public IP**:
    ...
    **Enable** or **Disable** to
    override the subnet's default setting. For more information, see [Public IPv4 addresses](using-instance-addressing.md#concepts-public-addresses "using-instance-addressing.md#concepts-public-addresses").
  ...
  - **Interface type**: The network interface
    ...
    - **EFA-only**: A high-performance network interface designed to handle high
      ...
      Adapter](efa.md "efa.md").

  - **Elastic Fabric Adapter**: Indicates whether the network
    interface is an Elastic Fabric Adapter. For more information, see [Elastic Fabric Adapter for AI/ML and HPC workloads on Amazon EC2](efa.md "efa.md").
  - **Network card index**: The index of the network
    card. The primary network interface must be assigned to network card
    index 0. Some instance types support [multiple network cards](using-eni.md#network-cards "using-eni.md#network-cards").
...
- **Storage type**: Select Amazon EBS or instance store volumes to
  ...
  the instance type that you've chosen. For more information, see [Instance store temporary block storage for EC2 instances](InstanceStorage.md "InstanceStorage.md") and [Amazon EBS
  volumes](../../../ebs/latest/userguide/ebs-volumes.md "../../../ebs/latest/userguide/ebs-volumes.md").
...
- **Volume type**: For EBS volumes, select a volume type. For
  more information, see [Amazon EBS volume types](../../../ebs/latest/userguide/ebs-volume-types.md "../../../ebs/latest/userguide/ebs-volume-types.md")
...
- **Encrypted**: If the instance type supports EBS encryption,
  ...
  you. For more information, see [Amazon EBS encryption](../../../ebs/latest/userguide/ebs-encryption.md "../../../ebs/latest/userguide/ebs-encryption.md") in the
...
- **Volume initialization rate**: If you have selected a snapshot,
  ...
  see [Use an Amazon EBS Provisioned Rate for Volume Initialization](../../../ebs/latest/userguide/initalize-volume.md#volume-initialization-rate "../../../ebs/latest/userguide/initalize-volume.md#volume-initialization-rate"). To use the default
...
- **File systems**: Mount an Amazon EFS or Amazon FSx file system to the
  instance. For more information about mounting an Amazon EFS file system, see [Use Amazon EFS with Amazon EC2 Linux instances](AmazonEFS.md "AmazonEFS.md"). For more information about
  mounting an Amazon FSx file system, see [Use Amazon FSx with Amazon EC2 instances](storage_fsx.md "storage_fsx.md")
...
- (Launch instance wizard only) **Domain join directory**:
  ...
  directory](../../../directoryservice/latest/admin-guide/launching_instance.md "../../../directoryservice/latest/admin-guide/launching_instance.md") (Windows instances).
- **IAM instance profile**: Select an IAM instance profile
  ...
  information, see [IAM roles for Amazon EC2](iam-roles-for-amazon-ec2.md "iam-roles-for-amazon-ec2.md").
- **Hostname type**: Select whether the guest OS hostname of
  the instance will include the resource name or the IP name. For more
  information, see [EC2 instance hostnames and domains](ec2-instance-naming.md "ec2-instance-naming.md").
...
- **Detailed CloudWatch monitoring**: Choose
  **Enable** to turn on detailed monitoring of your instance
  using Amazon CloudWatch. Additional charges apply. For more information, see [Monitor your instances using CloudWatch](using-cloudwatch.md "using-cloudwatch.md").
- **Credit specification**: Choose
  **Unlimited** to enable applications to burst beyond the
  ...
  information, see [Burstable performance instances](burstable-performance-instances.md "burstable-performance-instances.md").
...
- **EBS-optimized instance**: An instance that's optimized for
  ...
  **Enable** to enable it. Additional charges apply. For more
  information, see [Amazon EBS-optimized instance types](ebs-optimized.md "ebs-optimized.md").
- **Instance bandwidth configuration**: You can boost either
  ...
  only. For more information, see [EC2 instance bandwidth weighting configuration](configure-bandwidth-weighting.md "configure-bandwidth-weighting.md").
- **Purchasing option**: Choose **Spot
  ...
  more information, see [Manage your Spot Instances](using-spot-instances-request.md "using-spot-instances-request.md").
...
- **Tenancy**: Choose whether to run your instance on shared
  ...
  [Amazon EC2 Dedicated Instances](dedicated-instance.md "dedicated-instance.md") and
  [Amazon EC2 Dedicated Hosts](dedicated-hosts-overview.md "dedicated-hosts-overview.md").
...
- **Nitro Enclave**: Allows you to create isolated execution
  ...
  **Enable** to enable the instance for AWS Nitro Enclaves.
  ...
  Enclaves?](../../../enclaves/latest/user/nitro-enclave.md "../../../enclaves/latest/user/nitro-enclave.md") in the _AWS Nitro Enclaves User
  Guide_.
- **License configurations**: You can launch instances against
  ...
  information, see [Create a license configuration](../../../license-manager/latest/userguide/create-license-configuration.md "../../../license-manager/latest/userguide/create-license-configuration.md") in the _AWS
  License Manager User Guide_.
...
- **Metadata IPv6 endpoint**: You can enable the instance to
  ...
  [Nitro-based instances](instance-types.md#instance-hypervisor-type "instance-types.md#instance-hypervisor-type") into an [IPv6-supported subnet](../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range "../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range") (dual stack or IPv6 only). For more
...
- **User data**: You can specify user data to configure an
  ...
  about user data for Linux instances, see [Run commands when you launch an EC2 instance with user data input](user-data.md "user-data.md"). For more information about user data for
  Windows instances, see [How Amazon EC2 handles user data for Windows instances](user-data.md#ec2-windows-user-data "user-data.md#ec2-windows-user-data").
