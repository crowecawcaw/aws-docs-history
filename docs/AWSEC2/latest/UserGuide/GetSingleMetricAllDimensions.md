...
statistics aggregated across instances, you must [enable detailed monitoring](manage-detailed-monitoring.md#enable-detailed-monitoring "manage-detailed-monitoring.md#enable-detailed-monitoring") (at an additional charge), which provides data in
1-minute periods.
...
Use the [get-metric-statistics](../../../cli/latest/reference/cloudwatch/get-metric-statistics.md "../../../cli/latest/reference/cloudwatch/get-metric-statistics.md") command as follows to get the average of the
