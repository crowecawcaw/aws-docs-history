...
3. To install the AMD drivers on Linux, see [AMD drivers for your EC2 instance](install-amd-driver.md "install-amd-driver.md"). If you already have the AMD GPU driver
...
5. Set up DCV by following the instructions in setting up an [interactive desktop](#amd-interactive-desktop "#amd-interactive-desktop").
...
![DCV resolution changes](images/dm-dcv-example.png)
...
5. (Optional) [Install the Amazon DCV server](../../../dcv/latest/adminguide/setting-up-installing.md "../../../dcv/latest/adminguide/setting-up-installing.md") to use Amazon DCV as a high-performance display
   protocol, and then [connect to a Amazon DCV
   session](../../../dcv/latest/userguide/using-connecting.md "../../../dcv/latest/userguide/using-connecting.md") using your preferred client.
...
5. (Optional) [Install the Amazon DCV
   server](../../../dcv/latest/adminguide/setting-up-installing.md "../../../dcv/latest/adminguide/setting-up-installing.md") to use Amazon DCV as a high-performance display
   protocol, and then [connect to a Amazon DCV
   session](../../../dcv/latest/userguide/using-connecting.md "../../../dcv/latest/userguide/using-connecting.md") using your preferred client.
