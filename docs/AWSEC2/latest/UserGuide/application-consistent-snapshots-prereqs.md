...
Ensure that your instance has the PowerShell language mode set to `FullLanguage`. For more information, see [ about\_Language\_Modes](https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_language_modes?view=powershell-7.3) in the Microsoft documentation.