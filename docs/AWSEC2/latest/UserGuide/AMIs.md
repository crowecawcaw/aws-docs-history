...
![Launch multiple instances from an AMI.](images/launch-from-ami.png)
...
- [AMI characteristics](ComponentsAMIs.md "ComponentsAMIs.md")
- [Find an AMI](finding-an-ami.md "finding-an-ami.md")
- [Paid AMIs in the AWS Marketplace](paid-amis.md "paid-amis.md")
- [AMI lifecycle](ami-lifecycle.md "ami-lifecycle.md")
- [Boot modes](ami-boot.md "ami-boot.md")
- [AMI encryption](AMIEncryption.md "AMIEncryption.md")
- [Shared AMIs](sharing-amis.md "sharing-amis.md")
- [Monitor AMI events](monitor-ami-events.md "monitor-ami-events.md")
- [Understand AMI billing](ami-billing-info.md "ami-billing-info.md")
- [AMI quotas](ami-quotas.md "ami-quotas.md")
