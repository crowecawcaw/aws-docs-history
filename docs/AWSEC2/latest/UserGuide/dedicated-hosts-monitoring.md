...
| `under-assessment`           | AWS is exploring a possible issue with the Dedicated Host. If action must<br>be taken, you are notified via the AWS Management Console or email. Instances<br>can't be launched onto a Dedicated Host in this state.                                                                                                                                                                 |
