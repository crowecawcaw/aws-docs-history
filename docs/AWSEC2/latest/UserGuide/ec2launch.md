...
[AWS Windows AMI Reference](../../../ec2/latest/windows-ami-reference/windows-amis.md "../../../ec2/latest/windows-ami-reference/windows-amis.md").
...
- Executes user data (if specified). For more information about specifying user
  data, see [Run commands when you launch an EC2 instance with user data input](user-data.md "user-data.md").
