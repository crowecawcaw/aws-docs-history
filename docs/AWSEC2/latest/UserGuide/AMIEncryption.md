...
see [Understand shared AMI usage in Amazon EC2](sharing-amis.md "sharing-amis.md").

###### Encryption with EBS-backed AMIs topics

- [Instance-launching scenarios](#AMI-encryption-launch "#AMI-encryption-launch")
- [Image-copying scenarios](#AMI-encryption-copy "#AMI-encryption-copy")
...
see [Block device mappings for volumes on Amazon EC2 instances](block-device-mapping-concepts.md "block-device-mapping-concepts.md").
For examples of controlling block device mapping from the AWS CLI,
see [Launch, List, and Terminate EC2 Instances](../../../cli/latest/userguide/cli-services-ec2-instances.md "../../../cli/latest/userguide/cli-services-ec2-instances.md").
...
For information about using the console to launch an instance from an AMI, see [Launch an Amazon EC2 instance](LaunchingAndUsingInstances.md "LaunchingAndUsingInstances.md").
...
![Launch instance and encrypt volume on the fly.](images/ami-launch-convert.png)
...
![Launch instance and re-encrypt volume on the fly.](images/ami-launch-encrypted.png)
...
![Encrypt and re-encrypt multiple volumes during launch.](images/ami-launch-mixed.png)
...
For detailed instructions using the console, see [Copy an Amazon EC2 AMI](CopyingAMIs.md "CopyingAMIs.md").
