...
For more information, see [Exchange Convertible Reserved Instances](ri-convertible-exchange.md "ri-convertible-exchange.md").
...
- The modified reservation becomes effective immediately and the pricing benefit
  ...
  effective date of the modified Reserved Instances by using the [describe-reserved-instances](../../../cli/latest/reference/ec2/describe-reserved-instances.md "../../../cli/latest/reference/ec2/describe-reserved-instances.md") command.
...
- You must select another instance size in the same [instance
  family](../../../ec2/latest/instancetypes/instance-type-names.md "../../../ec2/latest/instancetypes/instance-type-names.md") (indicated by a letter, for example, T) and [generation](../../../ec2/latest/instancetypes/instance-type-names.md "../../../ec2/latest/instancetypes/instance-type-names.md")
...
![Modifying Reserved Instances.](images/ri-modify-merge.png)
...
For example, an `i3.metal` instance has a normalization factor of 128. If you purchase an `i3.metal` default tenancy Amazon Linux/Unix
...
Before you modify your Reserved Instances, ensure that you have read the applicable [restrictions](#ri-modification-limits "#ri-modification-limits"). Before you modify the
instance size, calculate the total [instance size footprint](#ri-modification-instancemove "#ri-modification-instancemove") of the original reservations that you want to
...
modified, **Modify Reserved Instances** is disabled. 3. The first entry in the modification table displays attributes
...
Use the [modify-reserved-instances](../../../cli/latest/reference/ec2/modify-reserved-instances.md "../../../cli/latest/reference/ec2/modify-reserved-instances.md") command. You can provide the
...
Use the [describe-reserved-instances-modifications](../../../cli/latest/reference/ec2/describe-reserved-instances-modifications.md "../../../cli/latest/reference/ec2/describe-reserved-instances-modifications.md") command. The
...
Use the [Edit-EC2ReservedInstance](../../../powershell/latest/reference/items/Edit-EC2ReservedInstance.md "../../../powershell/latest/reference/items/Edit-EC2ReservedInstance.md") cmdlet. You can provide the
...
Use the [Get-EC2ReservedInstancesModification](../../../powershell/latest/reference/items/Get-EC2ReservedInstancesModification.md "../../../powershell/latest/reference/items/Get-EC2ReservedInstancesModification.md") cmdlet. The status
...
that you have read the applicable [restrictions](#ri-modification-limits "#ri-modification-limits") before submitting the request.
