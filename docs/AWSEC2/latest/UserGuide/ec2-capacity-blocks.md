...
- [Create a Capacity Reservation Resource Group for UltraServer Capacity Blocks](cb-group.md "cb-group.md")
...
- You can add both UltraServer Capacity Blocks and instance Capacity Blocks to a Capacity Reservation
  Resource Group. For more information, see [Capacity Reservation Resource Groups](cr-groups.md "cr-groups.md").
- Capacity Blocks do not support placement groups. You can't specify a
  placement group when you launch instances into a Capacity Block, whether you
  target the Capacity Block by its reservation ID or through a Capacity Reservation Resource
  Group.
