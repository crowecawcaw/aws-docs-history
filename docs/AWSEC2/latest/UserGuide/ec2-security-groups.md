...
Security is a shared responsibility between AWS and you. For more information, see [Security in Amazon EC2](ec2-security.md "ec2-security.md"). AWS provides security groups as
...
- [Overview](#security-group-basics "#security-group-basics")
- [Create a security group for your Amazon EC2 instance](creating-security-group.md "creating-security-group.md")
- [Change the security groups for your Amazon EC2 instance](changing-security-group.md "changing-security-group.md")
- [Delete an Amazon EC2 security group](deleting-security-group.md "deleting-security-group.md")
- [Amazon EC2 security group connection tracking](security-group-connection-tracking.md "security-group-connection-tracking.md")
...
associated with the instance. For more information, see [Security group rules](../../../vpc/latest/userguide/security-group-rules.md "../../../vpc/latest/userguide/security-group-rules.md") in the
...
[Connection tracking](security-group-connection-tracking.md "security-group-connection-tracking.md").
