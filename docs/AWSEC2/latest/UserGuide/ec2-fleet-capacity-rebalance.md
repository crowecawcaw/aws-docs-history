...
recommendation](rebalance-recommendations.md "rebalance-recommendations.md"). If Capacity Rebalancing is enabled, the rebalance
...
When you enable Capacity Rebalancing, it does not increase your [Spot Instance interruption rate](spot-interruptions.md "spot-interruptions.md") (the
...
notice](spot-instance-termination-notices.md "spot-instance-termination-notices.md"), you typically only have up to two minutes to
...
running. This gives you the opportunity to perform [rebalancing actions](rebalance-recommendations.md#rebalancing-actions "rebalance-recommendations.md#rebalancing-actions") on the
instance.
...
monitoring the signal, you can quickly perform [rebalancing actions](rebalance-recommendations.md#rebalancing-actions "rebalance-recommendations.md#rebalancing-actions") on the
