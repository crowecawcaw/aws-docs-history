...
- **Fleet behavior when increasing total target
  ...
  and according to the specified [allocation strategy](ec2-fleet-allocation-strategy.md "ec2-fleet-allocation-strategy.md").
...
Use the [modify-fleet](../../../cli/latest/reference/ec2/modify-fleet.md "../../../cli/latest/reference/ec2/modify-fleet.md")
command.
...
Use the [Edit-EC2Fleet](../../../powershell/latest/reference/items/Edit-EC2Fleet.md "../../../powershell/latest/reference/items/Edit-EC2Fleet.md")
cmdlet.
