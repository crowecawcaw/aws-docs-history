...
Linux example that uses the AWS CLI, see [modify-instance-attribute](../../../cli/latest/reference/ec2/modify-instance-attribute.md "../../../cli/latest/reference/ec2/modify-instance-attribute.md"). For a Windows example that uses the Tools for Windows PowerShell,
see [User data and the Tools for Windows PowerShell](user-data.md#user-data-powershell "user-data.md#user-data-powershell").
...
IMDSv2, see [Use the Instance Metadata Service to access instance metadata](configuring-instance-metadata-service.md "configuring-instance-metadata-service.md").
...
[Nitro-based instance](instance-types.md#instance-hypervisor-type "instance-types.md#instance-hypervisor-type") launched in a [subnet that supports IPv6](../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range "../../../vpc/latest/userguide/configure-subnets.md#subnet-ip-address-range").
...
information, see [Create an Amazon EC2 AMI using Windows Sysprep](ami-create-win-sysprep.md "ami-create-win-sysprep.md").
...
metadata category, see [Instance metadata categories](ec2-instance-metadata.md#instancedata-data-categories "ec2-instance-metadata.md#instancedata-data-categories").
...
and are valid only from the instance. For more information, see [Link-local addresses](using-instance-addressing.md#link-local-addresses "using-instance-addressing.md#link-local-addresses").
...
For more information about dynamic data and examples of how to retrieve it, see [Instance identity documents for Amazon EC2 instances](instance-identity-documents.md "instance-identity-documents.md").
...
must be a [Nitro-based instance](instance-types.md#instance-hypervisor-type "instance-types.md#instance-hypervisor-type") in a subnet that supports IPv6.
...
see [Retrieve security credentials from instance metadata](instance-metadata-security-credentials.md "instance-metadata-security-credentials.md").
