...
For more information about host recovery, see [Host recovery](dedicated-hosts-recovery.md "dedicated-hosts-recovery.md").
...
- Host maintenance can't be turned on or off for hosts already within a
  ...
  host maintenance setting. For more information, see [Host resource groups](../../../license-manager/latest/userguide/host-resource-groups.md "../../../license-manager/latest/userguide/host-resource-groups.md").
...
available). For more information, see the [AWS License Manager User Guide](../../../license-manager/latest/userguide/license-manager.md "../../../license-manager/latest/userguide/license-manager.md").
...
Pricing](https://aws.amazon.com/ec2/dedicated-hosts/pricing/ "https://aws.amazon.com/ec2/dedicated-hosts/pricing/").
