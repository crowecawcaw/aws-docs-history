...
- [Step 1: Launch an instance](#ec2-launch-instance "#ec2-launch-instance")
- [Step 2: Connect to your instance](#ec2-connect-to-instance "#ec2-connect-to-instance")
- [Step 3: Clean up your instance](#ec2-clean-up-your-instance "#ec2-clean-up-your-instance")
- [Next steps](#ec2-next-steps "#ec2-next-steps")
...
to your instance, see [Troubleshoot issues connecting to your Amazon EC2 Linux instance](TroubleshootingInstancesConnecting.md "TroubleshootingInstancesConnecting.md") for assistance.
...
[install OpenSSH for Windows](https://learn.microsoft.com/en-us/windows-server/administration/openssh/openssh_install_firstuse?tabs=gui#install-openssh-for-windows "https://learn.microsoft.com/en-us/windows-server/administration/openssh/openssh_install_firstuse?tabs=gui#install-openssh-for-windows").
...
you clean up, see [Next steps](#ec2-next-steps "#ec2-next-steps").
...
now and then start it again later. For more information, see [Stop and start Amazon EC2 instances](Stop_Start.md "Stop_Start.md").
...
- Configure a CloudWatch alarm to notify you if your usage exceeds the Free Tier (for accounts
  ...
  AWS Free Tier usage](../../../awsaccountbilling/latest/aboutv2/tracking-free-tier-usage.md "../../../awsaccountbilling/latest/aboutv2/tracking-free-tier-usage.md") in the
  _AWS Billing User Guide_.
- Add an EBS volume. For more information, see [Create an Amazon EBS volume](../../../ebs/latest/userguide/ebs-creating-volume.md "../../../ebs/latest/userguide/ebs-creating-volume.md") in the _Amazon EBS User Guide_.
- Learn how to remotely manage your EC2 instance using the Run command.
  For more information, see [AWS Systems Manager Run Command](../../../systems-manager/latest/userguide/run-command.md "../../../systems-manager/latest/userguide/run-command.md") in the _AWS Systems Manager User Guide_.
