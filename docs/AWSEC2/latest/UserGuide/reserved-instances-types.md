...
Standard Reserved Instance. You can exchange Convertible Reserved Instances. You can modify Standard and
...
| ----------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Modify Reserved Instances                 | Some attributes can be modified. For more information, see [Modify Reserved Instances](ri-modifying.md "ri-modifying.md"). | Some attributes can be modified. For more information, see [Modify Reserved Instances](ri-modifying.md "ri-modifying.md").                                                                                                                                                                                 |
| Exchange Reserved Instances               | Can't be exchanged.                                                                                                        | Can be exchanged during the term for another Convertible Reserved Instance with new<br>attributes, including instance family, instance type, platform,<br>scope, or tenancy. For more information, see [Exchange Convertible Reserved Instances](ri-convertible-exchange.md "ri-convertible-exchange.md"). |
