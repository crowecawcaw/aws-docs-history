...
- When using [Runtime Monitoring](../../../guardduty/latest/ug/runtime-monitoring.md "../../../guardduty/latest/ug/runtime-monitoring.md") (including EKS Runtime Monitoring), make the following changes in the AWS GovCloud (US) Regions:
  ...
  This must be the same Region as your Amazon EC2 instance (or Amazon EKS cluster) that belongs to your AWS account ID. 2. With the initial release of Runtime Monitoring, GuardDuty starts the support with the following security agent versions:
...
- [Amazon GuardDuty documentation](../../../documentation/guardduty.md "../../../documentation/guardduty.md")
