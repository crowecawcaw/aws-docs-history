...
- Addressing potential compliance requirements.
  For instructions, see [Migrating a hosted zone to a different AWS account](../../../Route53/latest/DeveloperGuide/hosted-zones-migrating.md "../../../Route53/latest/DeveloperGuide/hosted-zones-migrating.md").
