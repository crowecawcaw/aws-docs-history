...
1. Create two web application Amazon EC2 servers via the [AWS GovCloud (US) console](../../../https:/console.amazonaws-us-gov.com/ec2/v2/home.md "../../../https:/console.amazonaws-us-gov.com/ec2/v2/home.md") and confirm that they are in a running state. Configuring the web servers on the Amazon EC2 instances is outside of the scope of this section.
