...
## How Amazon Bedrock differs for
...
[Amazon Bedrock
documentation](../../../bedrock/latest/userguide/what-is-bedrock.md "../../../bedrock/latest/userguide/what-is-bedrock.md").
...
Amazon Bedrock model evaluation metadata is not permitted to contain
export-controlled data. This metadata includes all configuration data that you enter
when creating an Amazon Bedrock model evaluation job, such as the following:
