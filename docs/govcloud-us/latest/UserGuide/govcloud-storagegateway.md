...
<a name="govcloud-storagegateway"></a>
...
+  [AWS Storage Gateway Hardware Appliance](https://docs.aws.amazon.com/storagegateway/latest/userguide/HardwareAppliance.html) is not available for use with the AWS Storage Gateway service running in the AWS GovCloud (US) Region.

## Documentation
<a name="govcloud-sga-docs"></a>
+  [AWS Storage Gateway documentation](https://docs.aws.amazon.com/storagegateway/index.html) 

## Export-controlled content
<a name="govcloud-storagegateway-itar"></a>
...
<a name="govcloud-storagegateway-ami"></a>
