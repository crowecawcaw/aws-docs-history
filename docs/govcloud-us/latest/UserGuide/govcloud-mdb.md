...
MemoryDB requires the use of the SSL (HTTPS) endpoint for service API calls. For more information, see [Service Endpoints](using-govcloud-endpoints.md "using-govcloud-endpoints.md").
