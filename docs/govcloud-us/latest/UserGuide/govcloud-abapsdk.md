...
- The services used with the SDK can handle the export-controlled content differently. For more information, see [Services in AWS GovCloud (US) Regions](using-services.md "using-services.md").
