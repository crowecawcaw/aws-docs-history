...
<a name="govcloud-lambda-diffs"></a>
...
## Documentation
<a name="govcloud-lambda-docs"></a>
+  [AWS Lambda documentation](https://docs.aws.amazon.com/documentation/lambda/) 

## Export-controlled content
<a name="govcloud-lambda-itar"></a>
