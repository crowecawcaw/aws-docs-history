...
The following differences apply to Amazon Translate:

- Async batch is not available.
- Active Custom Translation is not available.
- Parallel Data Operations are not available.
