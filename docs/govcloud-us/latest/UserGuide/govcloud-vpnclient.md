...
- We suggest you use the client configuration file exported from the {cvpnlong} endpoint without modification. {cvpnlong} endpoints in AWS GovCloud (US) use the following FIPS-approved cryptographic algorithms and clients should not be configured to use other ciphers:
