...
- The **Forgot Password** option and the **Welcome Email**
  feature are not supported in the AWS GovCloud (US) Regions. Users cannot reset their own passwords
  and users with new WorkSpaces will not receive a welcome email.
...
- Amazon WorkSpaces metadata is not permitted to contain export-controlled data. This
