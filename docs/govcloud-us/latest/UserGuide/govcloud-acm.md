...
- No export-controlled data may be entered, stored, or processed by AWS
  Certificate Manager. For example, domain names specified for certificates are
  not permitted to contain export-controlled data. For example, do not enter
  export-controlled data into the **DomainName** or
