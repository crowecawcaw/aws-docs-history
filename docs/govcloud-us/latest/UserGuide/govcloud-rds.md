...
- Creation of [cross-Region read replicas](../../../AmazonRDS/latest/UserGuide/USER_ReadRepl.XRgn.md "../../../AmazonRDS/latest/UserGuide/USER_ReadRepl.XRgn.md") from other AWS Regions to the AWS GovCloud (US) Regions or from AWS GovCloud (US) Regions to other AWS Regions isn’t supported.
