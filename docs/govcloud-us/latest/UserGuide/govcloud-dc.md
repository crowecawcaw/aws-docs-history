...
+ Alternatively, you can set up an Direct Connect connection, in a different Region and connect to AWS GovCloud (US) Regions using a public virtual interface and a VPN connection. For more information, see [Setting up AWS Direct Connect with a VPN Connection](#setup-direct-connect).
...
## Documentation
<a name="govcloud-awsdc-docs"></a>

 [AWS Direct Connect documentation](https://docs.aws.amazon.com/directconnect/index.html?id=docs_gateway#).

## Export-controlled content
<a name="dc-itar-boundary"></a>
