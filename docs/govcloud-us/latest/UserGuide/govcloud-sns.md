...
- You cannot use Amazon SNS to send SMS messages while using the
...
- Export-controlled data may not be entered, stored, or processed in Amazon SNS notification
  messages when the following notification endpoints are being used:

Notification Endpoints

    + Mobile push notifications – not permitted to contain export-controlled
     data
    + Email – not permitted to contain export-controlled data
    + Amazon SQS queues outside of AWS GovCloud (US) Regions – not permitted to contain
