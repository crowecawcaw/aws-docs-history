...
prevention service for your virtual private cloud (VPC) that you created in Amazon Virtual Private Cloud
(Amazon VPC).
...
documentation](../../../network-firewall.md "../../../network-firewall.md").
