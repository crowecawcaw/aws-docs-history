...
Before you start an experiment, verify you completed the prerequisites. For more information, see [Step 1: Configuring prerequisites](appconfig-experimentation-creating-prerequisites.md "appconfig-experimentation-creating-prerequisites.md"). Before running an experiment in production, read [About running and monitoring an experiment](appconfig-experimentation-about-running-an-experiment.md "appconfig-experimentation-about-running-an-experiment.md") to familiarize yourself with recommended practices for safely starting and monitoring the experiment.
...
4. (Optional) In the **Description** field, enter information about this particular experiment run.
5. For an initial experiment run, verify that **Test first at 0% exposure on start** is selected.
6. If you plan to use treatment assignment overrides, choose **Add entity ID**. For more information, see [About treatment assignment overrides](appconfig-experimentation-about-controls-and-treatments.md#appconfig-experimentation-about-treatment-overrides "appconfig-experimentation-about-controls-and-treatments.md#appconfig-experimentation-about-treatment-overrides").
7. (Optional) Expand **Tags** to assign one or more key-value pairs to the experiment run.
