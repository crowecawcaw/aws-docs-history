...
- [Using the audience rule builder](#appconfig-experimentation-about-specifying-audience-rule-builder "#appconfig-experimentation-about-specifying-audience-rule-builder")
- [Using the editor](#appconfig-experimentation-about-specifying-audience-editor "#appconfig-experimentation-about-specifying-audience-editor")
...
![An image of the Rule builder tab in AWS AppConfig experimentation with sample audience rule specified.](images/experimentation-rule-builder-1.png)

**A rule for targeting users in a specific geographic region using a specific email domain.**

![A second image of the Rule builder tab in AWS AppConfig experimentation with sample audience rule specified.](images/experimentation-rule-builder-2.png)
...
![A third image of the Rule builder tab in AWS AppConfig experimentation with sample audience rule specified.](images/experimentation-rule-builder-3.png)
...
The editor supports the same targeting scenarios as the rule builder. For visual examples of audience rules, see [Using the audience rule builder](#appconfig-experimentation-about-specifying-audience-rule-builder "#appconfig-experimentation-about-specifying-audience-rule-builder").
