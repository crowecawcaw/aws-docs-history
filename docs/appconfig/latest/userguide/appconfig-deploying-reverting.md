...
strategies](appconfig-creating-deployment-strategy.md "appconfig-creating-deployment-strategy.md") and Amazon CloudWatch alarms. Once configured, if one or more CloudWatch alarms go into
...
To get started, see [Configure permissions for automatic rollback](setting-up-appconfig.md#getting-started-with-appconfig-cloudwatch-alarms-permissions "setting-up-appconfig.md#getting-started-with-appconfig-cloudwatch-alarms-permissions").

###### Note

You can also roll back a configuration by calling the [StopDeployment](../../2019-10-09/APIReference/API_StopDeployment.md "../../2019-10-09/APIReference/API_StopDeployment.md") API
...
data to a previous version by using the `AllowRevert` parameter with the [StopDeployment](../../2019-10-09/APIReference/API_StopDeployment.md "../../2019-10-09/APIReference/API_StopDeployment.md") API operation. For some customers, reverting to a previous
...
5. If `StopDeployment` (with `AllowRevert`) is called on a
   ...
   thrown.
   You can use the AWS CLI to call the [StopDeployment](https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/stop-deployment.html "https://awscli.amazonaws.com/v2/documentation/api/latest/reference/appconfig/stop-deployment.html") operation with the `AllowRevert` parameter. Here's an
