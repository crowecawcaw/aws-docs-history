...
**Topics**
+ [Logging AWS AppConfig API calls using AWS CloudTrail](logging-using-cloudtrail.md)
+ [Logging metrics for AWS AppConfig data plane calls](monitoring-data-plane-call-logging.md)
