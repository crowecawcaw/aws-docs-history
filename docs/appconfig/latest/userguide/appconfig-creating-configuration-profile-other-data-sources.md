...
- AWS CodePipeline
  ...
  extension](working-with-appconfig-extensions.md "working-with-appconfig-extensions.md") to retrieve your data from its source. For example, by using an AWS AppConfig
