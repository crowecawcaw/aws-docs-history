...
<a name="what-is-additional-resources"></a>

The following resources can help you learn more about AWS AppConfig.

## Blogs
<a name="w2aab5c21b5"></a>

The following blogs can help you learn more about AWS AppConfig and its capabilities:
+ [Why you should use AWS AppConfig](https://dev.to/aws-builders/why-you-should-use-appconfig-2ph4)
+ [Unleash the power of feature flags with AWS AppConfig](https://medium.com/globant/unleash-the-power-of-feature-flags-with-aws-appconfig-660906ba98c7)
