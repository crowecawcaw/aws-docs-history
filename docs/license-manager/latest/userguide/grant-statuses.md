...
| PENDING\_AVAILABLE | The license is not available to use as it is still processing.                                |
...
| PENDING\_DELETE    | The license is not available to use as it is in the process of being<br>deleted.              |
...
| Status             | Description                                                                                                                                               |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PENDING\_WORKFLOW  | The grant is in the process of being distributed.                                                                                                         |
| PENDING\_ACCEPT    | The grant has been created and the grant recipient has not yet accepted<br>it.                                                                            |
...
| FAILED\_WORKFLOW   | The grant failed to distribute.                                                                                                                           |
...
| WORKFLOW\_COMPLETE | The grant to an organization has been distributed or recalled. The grant<br>details show the status of sub-grants to each account in the<br>organization. |
