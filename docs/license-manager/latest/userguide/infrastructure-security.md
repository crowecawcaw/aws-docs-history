...
As a managed service, AWS License Manager is protected by AWS global network security. For
...
You use AWS published API calls to access License Manager through the network. Clients must
