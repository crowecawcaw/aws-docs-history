...
server, see [Step 3: Configure RDS license server](user-based-subscriptions-getting-started.md#usubs-configure-rds "user-based-subscriptions-getting-started.md#usubs-configure-rds").
...
[Step 3: Configure RDS license server](user-based-subscriptions-getting-started.md#usubs-configure-rds "user-based-subscriptions-getting-started.md#usubs-configure-rds") in the Get
