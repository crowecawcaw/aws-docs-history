...
| InstanceCount                       | Number of instances within a license asset group.<br>Units: Count<br>Dimensions:<br>• `LicenseAssetGroupArn`: The license asset group ARN.<br>• `LicensingModel`: The licensing model (LicenseIncluded or AWSMarketplace). Available only for license asset groups with AWS-managed rulesets.                                                                                                                |
| InstanceConsumedLicenseCount        | Number of consumed licenses for instances within a license asset group.<br>Units: Count<br>Dimensions:<br>• `LicenseAssetGroupArn`: The license asset group ARN.<br>• `LicenseCountingType`: The license counting type (Instance, vCPU, Socket, or Core).<br>• `LicensingModel`: The licensing model (LicenseIncluded or AWSMarketplace). Available only for license asset groups with AWS-managed rulesets. |
