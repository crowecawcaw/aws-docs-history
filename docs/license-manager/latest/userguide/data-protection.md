...
applies to data protection in AWS License Manager. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with License Manager or other AWS services
...
License Manager stores data in an Amazon S3 bucket in the management account. The bucket is configured
