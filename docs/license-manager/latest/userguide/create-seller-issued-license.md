...
1. For **Issuer**, provide the following information:
   + **Enter an AWS KMS key** – License Manager uses this key to sign and verify the issuer. For more information, see [Cryptographic signing of licenses in License Manager](license-signing.md).
