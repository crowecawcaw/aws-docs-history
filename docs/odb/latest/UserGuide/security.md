...
+ Use AWS Identity and Access Management (IAM) policies to assign permissions that determine who is allowed to manage Oracle Database@AWS resources. For example, you can use IAM to determine who is allowed to create, describe, modify, and delete Exadata infrastructure, VM clusters or tag resources.
...
+ By default, Oracle Database@AWS uses Transparent Data Encryption (TDE) with Oracle-managed encryption keys. For customer-managed keys, Oracle Database@AWS supports AWS Key Management Service, [OCI vaults](https://docs.oracle.com/en-us/iaas/Content/KeyManagement/Concepts/keyoverview.htm), or [Oracle Key Vault](https://www.oracle.com/security/database-security/key-vault/).
...
**Topics**
+ [Data protection in Oracle Database@AWS](data-protection.md)
+ [Identity and access management for Oracle Database@AWS](security-iam.md)
+ [Compliance validation for Oracle Database@AWS](compliance-validation.md)
