...
To view examples of Oracle Database@AWS identity-based policies, see [Identity-based policies for Oracle Database@AWS](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
