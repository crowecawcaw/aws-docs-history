...
- [Oracle Database@AWS authentication and authorization in
  OCI](#odb-authentication-oci "#odb-authentication-oci")
- [Troubleshooting Oracle Database@AWS identity and
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting Oracle Database@AWS identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
