...
<a name="accessing-data-insights-on-the-amazon-ml-console"></a>
...
<a name="variable-target-correlation"></a>
 ...
 You might be able to improve the predictive performance of your model by removing variables that have little impact when you train your model. You can define which variables are made available to the machine learning process in a *recipe*, which is a transformation mechanism of Amazon ML. To learn more about recipes, see [Data Transformation for Machine Learning](https://docs.aws.amazon.com/machine-learning/latest/dg/transforming_data.html). 

### Summary Statistics of Attributes by Data Type
<a name="summary-statistics-of-attributes-by-data-type"></a>
...
<a name="understanding-the-distribution-of-categorical-and-binary-attributes"></a>
