...
For information about statistics associated with each data type, see [Descriptive Statistics](data-insights.md#descriptive-statistics).
...
1.  Provide the schema by using the Amazon ML API.
