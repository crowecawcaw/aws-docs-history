...
<a name="listing-objects-through-the-console"></a>
...
## Listing Objects (API)
<a name="listing-objects-through-the-api"></a>

In the [Amazon ML API](https://docs.aws.amazon.com/machine-learning/latest/APIReference/), you can list objects, by type, by using the following operations:
+ `DescribeDataSources`
+ `DescribeMLModels`
+ `DescribeEvaluations`
