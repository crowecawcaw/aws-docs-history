...
+ **[Amazon ML product information](https://aws.amazon.com/machine-learning/)** – Captures all the pertinent product information about Amazon ML in a central location.
+ **[Amazon ML FAQs](https://aws.amazon.com/machine-learning/faqs/)** – Covers the top questions that developers have asked about this product.
+ **[Amazon ML sample code](https://github.com/awslabs/machine-learning-samples)** – Sample applications that use Amazon ML. You can use the sample code as a starting point to create your own ML applications.
+ **[Amazon ML API Reference](https://docs.aws.amazon.com/machine-learning/latest/APIReference/)** – Describes all of the API operations for Amazon ML in detail. It also provides sample requests and responses for supported web service protocols.
