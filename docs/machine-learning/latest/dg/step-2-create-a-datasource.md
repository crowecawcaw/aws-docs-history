...
![Launch button circled in red on the Get started with Amazon Machine Learning page.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/get-started-launch.png)

1. On the **Input Data** page, for **Where is your data located**?, make sure that **S3** is selected.   
![S3 radio button selected under Where is your data located question.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image5.png)
...
![Datasource name field with Banking Data 1 entered as the value.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image6.png)

1. Choose **Verify**. 

1. In the **S3 permissions** dialog box, choose **Yes**.   
![S3 permissions dialog box requesting read permission for Amazon Machine Learning with Yes and No buttons.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image7.png)
...
![Validation success message showing datasource properties including name, data location, format, schema source, number of files, and total size.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image8.png)
...
![Table showing field names, data types, and sample values for database fields.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image10.png)
...
![Navigation controls showing page 1 through 10 of 21 with Cancel, Previous, and Continue buttons.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image11.png)

1. In the **Target** column, select `y`.   
![Table showing variable y with Binary data type and selectable target option.](https://docs.aws.amazon.com/machine-learning/latest/dg/images/image12.png)
