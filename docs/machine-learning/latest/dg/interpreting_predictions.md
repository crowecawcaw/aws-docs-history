...
Use asynchronous predictions, or _batch predictions_**,** when you have a number of observations and would like to obtain
...
Use synchronous, or _real-time predictions_**,** when you want to obtain predictions at low latency. The real-time prediction API
