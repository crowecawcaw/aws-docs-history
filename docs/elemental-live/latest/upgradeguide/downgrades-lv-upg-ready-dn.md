...
<a name="downgrades-lv-upg-ready-dn"></a>
...
<a name="downgrades-lv-upg-db-bkup-dn"></a>
...
<a name="downgrades-lv-upg-ready-dn-ks"></a>

You must install the host operating system from an `.iso` file onto each physical machine that will be running Elemental Live. Doing so is referred to as “kickstarting the system”.
