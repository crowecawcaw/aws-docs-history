...
This guide describes how to upgrade or downgrade the software running on an AWS Elemental Live
node. It covers versions 2.25.x and lower. These versions run on RHEL 7 (or CentOS 7). It
also covers version 2.26.0 and higher. These versions run on RHEL 9.

It applies to the following _upgrade_ scenarios:

- You are currently running version 2.25.x or lower, and you want to upgrade to a
  version that is below 2.26.0.
- You are currently running version 2.26.0 or higher, and you want to upgrade to a
  version that is higher than your current version.
  It applies to the following _downgrade_ scenarios:

- You are currently running version 2.25.x or lower, and you want to downgrade to a
  version that is lower than your current version.
- You are currently running version 2.26.0 or higher, and you want to downgrade to a
  different 2.26.x version.
  If you want to upgrade or downgrade across the 2.25 / 2.26 divide, see the
  [AWS Elemental Live Migration Guide](../migrationguide.md "../migrationguide.md")
