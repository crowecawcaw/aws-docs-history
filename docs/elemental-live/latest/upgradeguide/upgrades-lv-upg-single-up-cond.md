...
<a name="upgrades-lv-upg-single-up-cond"></a>
...
**Topics**
+ [Upgrade without change](#upgrades-live-step-upgrade-no-change)
+ [Upgrade and change deployment](#upgrades-live-step-upgrade-change)

## Upgrade without change
<a name="upgrades-live-step-upgrade-no-change"></a>
...
1. Refresh your web browser to load the updated Elemental Live web interface.

## Upgrade and change deployment
<a name="upgrades-live-step-upgrade-change"></a>
