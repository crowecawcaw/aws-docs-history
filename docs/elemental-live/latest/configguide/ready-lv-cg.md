...
# Getting ready
<a name="ready-lv-cg"></a>

Be aware of the following topics before starting phase 2 of installation.

## Web interface access
<a name="ready-lv-cg-access"></a>

Most of the steps in the configuration procedure for AWS Elemental Live involve working in the web interface.
