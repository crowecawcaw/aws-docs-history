...
Perform these steps on each AWS Elemental Live hardware unit, either
directly at the hardware unit or from your workstation via SSH.

###### Topics

- [About Installer Options](#install-live-sw-about-options "#install-live-sw-about-options")
- [Setting up OCR Conversion in Versions 2.22.0 to 2.23.0](#install-live-sw-ocr-2220 "#install-live-sw-ocr-2220")
- [Setting up OCR Conversion in Versions 2.23.1 and later](#install-live-sw-ocr-2231 "#install-live-sw-ocr-2231")
- [Installing the Software](#install-live-sw-procedure "#install-live-sw-procedure")
...
- Downloading the OCR libraries from the internet. These
  libraries are language dictionaries that are used in the
  captions conversion.
...
Keep the file zipped. 2. Use a method such as SCP to move the zipped file to a
location on the Elemental Live node that you are setting
up. For example, move to this location:
...
1. At the Linux command line, log in with the
   _elemental_ user credentials.
2. Decide which options you want to include with the
...
3. Run the installer as follows. Use the actual file name
...
4. Follow the prompts. This table specifies the prompts
   that appear when you don't include any options for the
   installer.

| Prompt                                                                                    | Action                                                                                                                                                                                                                                                             |
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Do you agree to these<br>terms`                                                          | This prompt appears after you have paged<br>through the EULA (End User License<br>Agreement).<br>Enter `Yes` or<br>`No`. (You must<br>enter Yes to continue.)                                                                                                      |
| `Enter this server's<br>Hostname`                                                         | Type the hostname of this hardware unit.<br>For example,<br>`live-01`                                                                                                                                                                                              |
| `Would you like to configure<br>eth1`                                                     | If you type `No`, you<br>can configure eth1 in the next phase of the<br>configuration                                                                                                                                                                              |
| `The firewall for this system is<br>currently disabled. Would you like to<br>enable it?`  | If you type `No` you<br>can set up the firewall in the next phase of<br>the configuration                                                                                                                                                                          |
| `Is this machine a part of or<br>intended to be a part of a Conductor<br>Live 3 cluster?` | Type `Yes` or<br>`No`                                                                                                                                                                                                                                              |
| `Will this machine require use of<br>SNMP alerts?`                                        | Type `Yes` or<br>`No`                                                                                                                                                                                                                                              |
| `Will this machine be ingesting<br>RTMP?`                                                 | Type `Yes` or<br>`No`                                                                                                                                                                                                                                              |
...
| `Enable conversion of eligible<br>captions using OCR<br>technology?`                      | Type `Yes` or<br>`No`. For<br>information about requirements for this<br>feature, see [Setting up OCR Conversion in Versions 2.23.1 and later](#install-live-sw-ocr-2231 "#install-live-sw-ocr-2231").                                                             |
...
| `Would you like to start the<br>Elemental service now?`                                   | Type `Yes`                                                                                                                                                                                                                                                         |

When the software install is complete, this message
appears:
...
5. Start a web browser and start the Elemental Live
   web interface by typing the following:
