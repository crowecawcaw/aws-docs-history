...
| `Enable conversion of eligible captions using OCR technology?`                      | Type `Yes` or `No`. For information about requirements for this feature, see [Setting up OCR Conversion in Versions 2.23.1 and later](#install-live-sw-ocr-2231 "#install-live-sw-ocr-2231").                                                                  |
...
| `Would you like to start the Elemental service now?`                                | Type `Yes`                                                                                                                                                                                                                                                     | When the software install is complete, this message appears: `Installation and configuration complete!` 5. Start a web browser and start the Elemental Live web interface by typing the following: `https://<hostname>` Make sure the web interface displays. |
