...
The software is installed. Finally, this message
appears:
...
6. Take a snapshot of the VM, as described in the CentOS
   7 Virtual Manager online help.
7. Start a web browser and start the Elemental Live
