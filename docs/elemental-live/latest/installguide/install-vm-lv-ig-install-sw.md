...
<tbody>
  ...
  <tr><td><code>Enable conversion of eligible captions using OCR technology?</code></td><td>Type <b>Yes</b> or <b>No</b>. For information about requirements for this feature, see <a href="install-lv-ig-install-sw.md#install-live-sw-ocr-2231">Setting up OCR Conversion in Versions 2.23.1 and later</a>.</td></tr>
