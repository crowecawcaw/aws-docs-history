...
<a name="migrate-worker-boot-mode-uefi-smc"></a>
...
<a name="migrate-worker-boot-mode-uefi-smc-step1"></a>
...
1. Change the security level in the Java control panel in order for the applet to run:
   ...
   1. Choose the **Security** tab. Move the slider to the lowest setting: **Medium**.
...
<a name="migrate-worker-boot-mode-uefi-smc-step2"></a>
