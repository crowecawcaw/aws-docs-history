...
# Install on a Dell
<a name="migrate-worker-rhel9-dell"></a>
...
<a name="migrate-worker-rhel9-dell-idrac"></a>

### Get Ready
<a name="migrate-worker-rhel9-dell-idrac-step1"></a>
...
1. In the **Map CD/DVD** section, in **Image File**, choose **Choose File**. In the window that appears, navigate to the kickstart .iso file, select it, and choose **Open**. The **Image File** field in the **Virtual Media** screen now specifies the image file. 

1. Choose **Map Device**. Then at the bottom of the screen, choose **Close**.

The kickstart .ISO image file is now mapped to the virtual CD/DVD drive. 

1. On the main menu of the Virtual Console, choose **Boot**. On the **Boot Controls** list, choose **Virtual CD/DVD/ISO**. Then at the **Confirm Boot Action** prompt, choose **Yes**.

1. On the main menu of the Virtual Console, choose **Power**, then choose **Reset System (warm boot)**, and at the **Confirm** prompt, choose **Yes**.
...
<a name="migrate-worker-rhel9-dell-idrac-step2"></a>
...
### Finishing steps
<a name="migrate-worker-rhel9-dell-idrac-step3"></a>
...
<a name="migrate-worker-rhel9-dell-stick"></a>

### Install the operating system
<a name="migrate-worker-rhel9-stick-step1"></a>
...
### Finishing steps
<a name="migrate-worker-rhel9-dell-stick-finishing"></a>
