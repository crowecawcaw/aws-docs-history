...
# Install on an SMC
<a name="migrate-worker-rhel9-smc"></a>

You install RHEL 9 on an SMC chassis from the IPMI interface.

## Install the operating system
<a name="migrate-worker-rhel9-smc-step1"></a>
...
1. Reboot the system. The image should start to boot. 
   ...
   If the image does not start to boot, choose the **F11** key while the splash screen is displaying. Then when the **Please select boot device** prompt appear, choose **UEFI: Virtual CDROM**. Move this item to the top of the list by pressing the **\+ **key repeatedly.
...
## Finishing steps
<a name="migrate-worker-rhel9-smc-finish"></a>
