...
<a name="migrate-worker-boot-mode-uefi-dell"></a>

There are three ways to switch the boot mode from Legacy mode to UEFI.

**Topics**
+ [Switch using the IDRAC user interface](#migrate-worker-boot-mode-uefi-idrac)
+ [Switch using RACADM](#migrate-worker-boot-mode-uefi-racadm)
+ [Switch using the F2 boot menu](#migrate-worker-boot-mode-uefi-f2)

## Switch using the IDRAC user interface
<a name="migrate-worker-boot-mode-uefi-idrac"></a>
...
## Switch using RACADM
<a name="migrate-worker-boot-mode-uefi-racadm"></a>
...
<a name="migrate-worker-boot-mode-uefi-f2"></a>
