...
- [Switch using the IDRAC user interface](#migrate-worker-boot-mode-uefi-idrac "#migrate-worker-boot-mode-uefi-idrac")
- [Switch using RACADM](#migrate-worker-boot-mode-uefi-racadm "#migrate-worker-boot-mode-uefi-racadm")
- [Switch using the F2 boot menu](#migrate-worker-boot-mode-uefi-f2 "#migrate-worker-boot-mode-uefi-f2")
