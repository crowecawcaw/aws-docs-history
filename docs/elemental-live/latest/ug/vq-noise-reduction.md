...
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| **Streams > Advanced >Preprocessors > Noise Reducer ><br>Filter**   | stream\_assembly/video\_description/video\_preprocessors/<br>noise\_reducer/filter   |
| **Streams > Advanced >Preprocessors > Noise Reducer ><br>Strength** | stream\_assembly/video\_description/video\_preprocessors/<br>noise\_reducer/strength |
