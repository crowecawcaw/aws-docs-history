...
sidecar, as identified in [Step 4: Match formats to categories](categories-captions.md "categories-captions.md"), or if the format is
...
["Caption Stream Incompatible" message](output-embedded-and-more.md#embedded-caption-incompatible-message "output-embedded-and-more.md#embedded-caption-incompatible-message").
