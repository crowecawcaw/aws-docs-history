...
- [Use case: One input format converted to one different format in one output](#use-case-one-input-format-to-different-output-formats "#use-case-one-input-format-to-different-output-formats")
- [Use case: One input format converted to different formats, one format for each output](#use-case-one-input-format-to-several-output-formats "#use-case-one-input-format-to-several-output-formats")
- [Use case: One captions output shared by multiple video encodes](#use-case-one-captions-output-multiple-video-encodes "#use-case-one-captions-output-multiple-video-encodes")
