...
**Topics**
+ [Use case: One input format to one output and not converted](#use-case-one-input-format-to-one-output-format-not-converted)
+ [Use case: One input format converted to one different format in one output](#use-case-one-input-format-to-different-output-formats)
+ [Use case: One input format converted to different formats, one format for each output](#use-case-one-input-format-to-several-output-formats)
+ [Use case: One captions output shared by multiple video encodes](#use-case-one-captions-output-multiple-video-encodes)
