...
<a name="output-locking-requirements"></a>
...
**Topics**
+ [Supported input types](#opl-requirements-input-types)
+ [Input requirements](#output-locking-input-requirements)
+ [Supported output types](#opl-requirements-output-types)
+ [Output encode requirements](#output-locking-output-requirements)
+ [Output locking and SCTE 35](#opl-requirements-scte35)

## Supported input types
<a name="opl-requirements-input-types"></a>
...
## Input requirements
<a name="output-locking-input-requirements"></a>
...
<a name="opl-requirements-output-types"></a>
...
### Frame rate
<a name="opl-output-requirements-framerate"></a>
...
<a name="opl-requirements-scte35"></a>
