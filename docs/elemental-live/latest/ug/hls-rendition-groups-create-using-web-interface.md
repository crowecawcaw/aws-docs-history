...
![Output section showing six stream configurations with name and segment modifiers.](https://docs.aws.amazon.com/elemental-live/latest/ug/images/hls-rendition-groups-create-example-output.png)


Here is the Streams section.

![Four stream configurations showing video and audio encoding settings with codec and bitrate options.](https://docs.aws.amazon.com/elemental-live/latest/ug/images/hls-rendition-groups-create-example-streams-1.png)![Four stream configurations showing video and audio encoding settings with codec and bitrate options.](https://docs.aws.amazon.com/elemental-live/latest/ug/images/hls-rendition-groups-create-example-streams-2.png)
