...
**Topics**
+ [Static overlay](#about-static-overlay)
+ [Motion graphic overlay](#about-motion-overlay)
+ [Inserting both types of overlay](#supported-combinations-of-features)

## Static overlay
<a name="about-static-overlay"></a>
...
For more information, see [Static graphic overlay](static-graphic-overlay.md).

## Motion graphic overlay
<a name="about-motion-overlay"></a>
