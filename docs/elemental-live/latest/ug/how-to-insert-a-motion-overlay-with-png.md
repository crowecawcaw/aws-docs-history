...
Here are some examples of how motion image overlay works with a set
of PNG files:
...
- Example 2: Animated corporate logo – You want to insert
  ...
  and specify the first runtime. You start the event. After the
...
- You prepare a set of PNG files and store them at a location
  that is accessible to Elemental Live.
