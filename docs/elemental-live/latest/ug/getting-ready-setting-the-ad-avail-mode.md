...
- **Splice Insert Mode **
  - **Message type ID:** Splice Insert / **Segmentation type ID:** No segmentation descriptor present / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Provider advertisement / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Distributor advertisement / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Placement opportunity / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Other type / **Handled as an ad avail event:**   / **Not handled as an ad avail event:**   / **Handled as another type of event:** X
  - **Message type ID:** Time Signal  / **Segmentation type ID:** Provider advertisement / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Distributor advertisement / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Placement opportunity / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Other type / **Handled as an ad avail event:**   / **Not handled as an ad avail event:**   / **Handled as another type of event:** X

- **Time Signal APOS Mode **
  - **Message type ID:** Splice Insert  / **Segmentation type ID:** Any / **Handled as an ad avail event:**   / **Not handled as an ad avail event:** X / **Handled as another type of event:**  
  - **Message type ID:** Time Signal  / **Segmentation type ID:** Provider advertisement / **Handled as an ad avail event:**   / **Not handled as an ad avail event:** X / **Handled as another type of event:**  
  - **Segmentation type ID:** Distributor advertisement / **Handled as an ad avail event:**   / **Not handled as an ad avail event:** X / **Handled as another type of event:**  
  - **Segmentation type ID:** Placement opportunity / **Handled as an ad avail event:** X / **Not handled as an ad avail event:**   / **Handled as another type of event:**  
  - **Segmentation type ID:** Other type / **Handled as an ad avail event:**   / **Not handled as an ad avail event:**   / **Handled as another type of event:** X 
