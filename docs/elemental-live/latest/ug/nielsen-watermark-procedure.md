...
general steps for creating an event. It also assumes that you have already
...
1. On the **Event** page of the web
   interface, go to the **Streams** section, then go to the
   specific stream that contains the audio that you want to set up with
   watermarking.
...
5. Complete the remaining fields with the values you determined when
