...
For more information, see [Group of pictures (GOP) configuration](vq-gop.md "vq-gop.md").
...
For more information, see [Quantization controls](vq-quantization.md "vq-quantization.md").

## Slices

This parameter affects CPU usage.

The number of slices in each video frame affects the CPU usage. You must balance the
