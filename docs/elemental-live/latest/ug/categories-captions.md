...
| --- | --- | 
| Ancillary\+Embedded | The captions in ancillary format are in the ancillary data in the stream. The embedded captions are embedded in the video. To choose Ancillary\+Embedded, choose **Embedded** as the **Destination Type **(in the [procedure](output-embedded-and-more.md)). Elemental Live will automatically produce both Ancillary and embedded.  | 
| ARIB  | Object | 
| Burn-in | Burn-in | 
| DVB-Sub | Object | 
| Embedded | Embedded | 
