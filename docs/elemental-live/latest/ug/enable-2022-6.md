...
1. In the Elemental Live web interface, go to **Settings**, and select **Network Devices**.

1. Choose the **edit** icon (pencil) next to the device that you want to enable. For L800 series appliances and bare metal appliances, this can only be enabled for 25 GbE NICs. 

1. Select the **SMPTE 2110 and SMPTE 2022-6 Enabled** check box, and then choose **Save**.
