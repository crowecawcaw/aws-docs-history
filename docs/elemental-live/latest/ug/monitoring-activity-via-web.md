...
2. If the blue button specifies Control Panel, then the
   Details panel is currently displayed. Click the Control
   Panel button.
3. On the Control Panel, click Input Controls (below the
   Preview panel) to expand that section. The dynamic
   playlist appears.
