...
| image_inserter_input | Location | Required                                   | Overlay PNG or BMP file to insert.<br>For file requirement details, information about where to store this<br>file, and how to specify its location, see [Step A: Prepare the overlay asset](step-a-prepare-the-overlay-asset.md "step-a-prepare-the-overlay-asset.md").                                                                                                                                                                                                                                                                                                                                                                                                                                  |
