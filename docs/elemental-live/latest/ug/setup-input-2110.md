...
<a name="setup-input-2110"></a>

Follow this procedure if you have a SMPTE 2110 source and your organization doesn't use [NMOS IS-04 and IS-05](2110-and-nmos.md).
...
1. From the **Input** menu in the event, select **SMPTE 2110 Input**.

1. In **Video SDP Location**, enter the location of the SDP file for the video. For example:

   [http://172.18.8.19/curling\_video.sdp](rtp://239.255.100.100:5000)

   For more information about SDP files, see [About SDP files](2110-sdp-about.md).

1. In **Media Index**, enter the index of the video stream that you want Elemental Live to extract. For example, enter **0** if the video is the first stream, **1** if it's the second stream, and so on.

1. Complete the **Interface** fields:
...
1. Complete the audio fields in the same way – **Audio SDP Location**, **Media Index**, and **Interface** fields. 
