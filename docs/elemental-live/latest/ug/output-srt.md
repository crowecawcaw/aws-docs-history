...
To send to an SRT flow on MediaConnect, we recommend that you use the Reliable TS output group with the AWS Elemental MediaConnect option. See [Setting up Elemental Live as a Contribution Encoder for AWS Elemental MediaConnect](setting-up-live-as-contribution-encoder-for-mediaconnect.md).
...
**Topics**
+ [Getting ready](output-srt-get-ready.md)
+ [Creating the output](output-srt-setup.md)