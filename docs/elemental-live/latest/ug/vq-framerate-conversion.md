...
+ The scan type for the output – interlaced or progressive. The choice of frame rate might be constrained by the scan type conversion you apply. For more information, see [Converting the scan type](vq-scan-type.md).
