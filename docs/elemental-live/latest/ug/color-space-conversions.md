...
| HDR10                   | Yes                                | Yes, to any supported color space. If you want to convert to<br>Dolby Vision, see [Requirements for inputs](color-space-inputs-requirements.md "color-space-inputs-requirements.md") and<br>[Requirements for outputs](color-space-output-requirements.md "color-space-output-requirements.md"). |
