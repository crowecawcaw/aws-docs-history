...
1. On the Elemental Live web interface, display the details for the event that you want to set up.

1. In **Input**, make sure you have set the **Input type** field to one of the following. These types are all valid for TS inputs:
   + **Network Input**
   + **File Input**
   + **HLS File Input**
   + **HLS Network Input**
