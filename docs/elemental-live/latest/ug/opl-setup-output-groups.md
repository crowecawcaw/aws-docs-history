...
<a name="opl-setup-output-groups"></a>
...
**Topics**
+ [Setting up an HLS output group](opl-setup-hls.md)
+ [Setting up an MS Smooth output group](output-locking-event-setup-mss-output-fields.md)
+ [Setting up a UDP/TS output group](opl-setup-udp.md)