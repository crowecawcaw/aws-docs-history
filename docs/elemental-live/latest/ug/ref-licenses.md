...
Some features of Elemental Live require that you purchase an add-on
package from AWS Elemental. This section includes tables that list the features and
the audio and video codecs that require an add-on package.
