...
![Audio encoding settings with Dolby Digital codec, bitstream mode, coding mode, bitrate, and compression options.](https://docs.aws.amazon.com/elemental-live/latest/ug/images/dolby-metadata-setup-dolby-digital.png)
...
![Audio encoding settings interface showing Surround FX Mode field set to Disabled.](https://docs.aws.amazon.com/elemental-live/latest/ug/images/dolby-metadata-setup-dolby-digital-plus.png)
