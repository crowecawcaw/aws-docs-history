...
and output captions in an RTMP output container
...
| Ancillary Data         | Burn-in, Embedded, RTMP CaptionInfo, RTMP CuePoint |                                                    | Teletext | Burn-in, RTMP CuePoint                             |
...
| SMI                    | Burn-in, RTMP CuePoint                             |                                                    | TTML     | Burn-in, RTMP CuePoint                             |
| STL                    | Burn-in, RTMP CuePoint                             |                                                    | SCC      | Burn-in, Embedded, RTMP CaptionInfo, RTMP CuePoint |
...
| Teletext               | Burn-in, RTMP CuePoint                             |                                                    | ARIB     |                                                    |
| MPEG2-TS Container     | Embedded                                           | Burn-in, Embedded, RTMP CaptionInfo, RTMP CuePoint |
| SCTE-20                | Burn-in, Embedded, RTMP CaptionInfo, RTMP CuePoint |                                                    | Teletext | Burn-in, RTMP CuePoint                             |
