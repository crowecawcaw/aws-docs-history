...
<a name="interleave-2si-inputs"></a>
...
1. In the **Input** section of the event, set the **Select Type** field to **Interleave 4K (HD-2SI)**.

The **Interleave 4K (HD-2SI)** setting is applied to fours ports on the appliance: ports 1-4, or ports 5-8, or ports 9-12, or ports 13-16.
