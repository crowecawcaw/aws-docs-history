...
| Field               | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Image Location      | The location and filename of the PNG or BMP image file.<br>For file requirement details, information about where to store<br>this file, and how to specify its location, see [Step A: Prepare the overlay asset](step-a-prepare-the-overlay-asset.md "step-a-prepare-the-overlay-asset.md").<br>For S3, use `sse=true` to enable S3 Server Side<br>Encryption (SSE) and `rrs=true` to enable Reduced<br>Redundancy Storage (RRS). Default values for RRS and SSE are<br>`false`. |
...
| Start Time          | The start time for the overlay.<br>Specify the start time in one of the formats listed at [Start time formats](#start-time-formats "#start-time-formats").                                                                                                                                                                                                                                                                                                                       |
