...
+ [Examples of implementing use cases](examples.md)
+ [Passing through VBI data](captions-in-vbi-data.md)
+ [Reference: Languages supported with OCR captions](captions-ocr-languages.md)