...
of the **Create New Live Event** screen. For more context, see [Step 1: Identify the source captions that you want](identify-captions-in-the-input.md "identify-captions-in-the-input.md").
