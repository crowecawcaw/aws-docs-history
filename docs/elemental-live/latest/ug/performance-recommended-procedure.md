...
<a name="performance-recommended-procedure"></a>
...
1. Design the lab tests as follows:
   ...
   + Set up the events with the most complex outputs that you expect to run on the appliance. Include any high-demand features that you plan to implement. See [Features that affect performance](performance-features.md).
   + Run the events for several days.

1. Monitor the events as described in this section:
   + Frequently measure the CPU usage, RAM usage, I/O bandwidth, and system bandwidth. See [Assessing performance by measuring](performance-measures.md).
