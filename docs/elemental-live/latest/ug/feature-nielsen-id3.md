...
1. Set the fields to enable and configure the feature:
...
1. Go to the output group where you want to include the ID3 tags. The output group must be an Archive, Apple HLS, or UDP/TS group. You can set up one or more output groups to include ID3 tags.

1. If the output group doesn't have an output, choose the **Add Output** button. An **Outputs** section appears.

1. In the **Outputs** section, take the appropriate action:
...
1. Open the **PID Control** section to see more fields, including **Nielsen ID3**.

1. In **Nielsen ID3**, choose the check box to enable passthrough in this output.