...
content and distribution providers use Nielsen watermarks. If you're not
working with The Nielsen
Company
to implement watermarks, you don't need to read this section.
