...
## Troubleshoot Windows Server entitlements
<a name="troubleshoot-entitlements-pointer"></a>

For help troubleshooting Windows Server entitlements, see [Troubleshooting Windows Server entitlements](troubleshoot-entitlements.md).