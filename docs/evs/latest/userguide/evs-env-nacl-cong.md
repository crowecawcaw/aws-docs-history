...
A network access control list (ACL) allows or denies specific inbound or outbound traffic at the subnet level. You can use network ACLs to control inbound and outbound traffic for your Amazon EVS VLAN subnets. For more information, see [Create a network ACL for your VPC](https://docs.aws.amazon.com/vpc/latest/userguide/create-network-acl.html) in the *Amazon VPC User Guide*.
