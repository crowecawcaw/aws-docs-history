...
1. To suspend one or more GuardDuty member accounts, run [StopMonitoringMembers](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_StopMonitoringMembers.html) to suspend GuardDuty for a member account.
