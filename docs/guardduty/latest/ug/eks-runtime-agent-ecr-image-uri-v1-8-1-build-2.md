...
# ECR repository for EKS agent versions 1.16.0 - 1.8.1 (eks.build.2)
...
The following table shows the Amazon ECR repository URIs where the GuardDuty security agent versions `1.16.0.eks.build.2`, `1.15.0.eks.build.2`, `1.11.0.eks.build.2`, `1.10.0.eks.build.2`, `1.9.0.eks.build.2`, and `1.8.0.eks.build.2` for Amazon EKS are hosted.
