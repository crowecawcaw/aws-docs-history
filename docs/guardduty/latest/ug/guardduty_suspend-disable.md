...
<a name="guardduty_suspend-disable"></a>
...
1. In the **Suspend GuardDuty** section, choose **Suspend GuardDuty** or **Disable GuardDuty**, then **Confirm** your action.
