...
AWS Security Hub collects security data from across your AWS accounts, services, and
...
security posture, Security Hub creates a central location for findings across all of your
integrated AWS services, and AWS Partner products. Enabling Security Hub with GuardDuty will
automatically allow GuardDuty findings data to be ingested by Security Hub.

For more information about using Security Hub with GuardDuty see [Integrating with AWS Security Hub](securityhub-integration.md "securityhub-integration.md").
