...
+ [Identity and Access Management for Amazon GuardDuty](security-iam.md)
...
+ [Amazon GuardDuty and interface VPC endpoints (AWS PrivateLink)](security-vpc-endpoints.md)