...
Before you use IAM to manage access to GuardDuty, learn what IAM features are
available to use with GuardDuty.

| IAM features you can use with Amazon GuardDuty                                                                                                           | IAM feature | GuardDuty support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ----------------- |
...
To get a high-level view of how GuardDuty and other AWS services work with most IAM
...
To see a list of GuardDuty actions, see [Actions defined by Amazon GuardDuty](../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-actions-as-permissions") in the
...
To see a list of GuardDuty resource types and their ARNs, see [Resources defined by Amazon GuardDuty](../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-resources-for-iam-policies")
...
To see a list of GuardDuty condition keys, see [Condition keys for Amazon GuardDuty](../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-policy-keys "../../../service-authorization/latest/reference/list_amazonguardduty.md#amazonguardduty-policy-keys") in the
