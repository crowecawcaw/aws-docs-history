...
To view examples of GuardDuty identity-based policies, see [Identity-based policy examples for Amazon GuardDuty](security_iam_id-based-policy-examples.md).
...
To see a list of GuardDuty actions, see [Actions defined by Amazon GuardDuty](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonguardduty.html#amazonguardduty-actions-as-permissions) in the *Service Authorization Reference*.
