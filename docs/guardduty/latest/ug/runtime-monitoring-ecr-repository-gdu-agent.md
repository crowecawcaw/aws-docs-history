...
agent that gets deployed on your Amazon EKS, Amazon ECS, and Amazon ECS-Amazon EC2 Bottlerocket resources.
...
- [ECR repository for EKS agent versions 1.16.0 - 1.8.1 (eks.build.2)](eks-runtime-agent-ecr-image-uri-v1-8-1-build-2.md "eks-runtime-agent-ecr-image-uri-v1-8-1-build-2.md")
...
- [ECR repository for GuardDuty agent on ECS-EC2 Bottlerocket](ecs-ec2-bottlerocket-runtime-agent-ecr-image-uri.md "ecs-ec2-bottlerocket-runtime-agent-ecr-image-uri.md")
