...
This section applies to you only if you [Enable tagging for scanned objects](enable-malware-protection-s3-bucket.md#tag-scanned-objects-s3-malware-protection "enable-malware-protection-s3-bucket.md#tag-scanned-objects-s3-malware-protection") in your protected
bucket.
...
- The IAM role used for this protected S3 bucket is missing
  ...
  information, see [Create or update IAM role policy](malware-protection-s3-iam-policy-prerequisite.md "malware-protection-s3-iam-policy-prerequisite.md").
...
object under [Enable tagging for scanned objects](enable-malware-protection-s3-bucket.md#tag-scanned-objects-s3-malware-protection "enable-malware-protection-s3-bucket.md#tag-scanned-objects-s3-malware-protection").
