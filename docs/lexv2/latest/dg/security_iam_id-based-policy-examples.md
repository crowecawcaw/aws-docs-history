...
For details about actions and resource types defined by Amazon Lex V2, including the format of the ARNs for each of the resource types, see [Actions, resources, and condition keys for Amazon Lex V2](../../../service-authorization/latest/reference/list_amazonlexv2.md "../../../service-authorization/latest/reference/list_amazonlexv2.md") in the _Service Authorization Reference_.
...
- [Allow users to create and view bot replicas, but not to delete them](#security_iam_id-based-policy-examples-gr-permissions "#security_iam_id-based-policy-examples-gr-permissions")

## Policy best practices

Identity-based policies determine whether someone can create, access, or delete Amazon Lex V2 resources in your
...
To access the Amazon Lex V2 console, you must have a minimum set of permissions.
These permissions must allow you to list and view details about the Amazon Lex V2 resources
...
To ensure that users and roles can still use the Amazon Lex V2
console, users need to have Console access. For more information
...
before they can deploy a bot on a messaging platform.
...
action on the console or using the AWS CLI or AWS API.
...
The following IAM permission policy allows a user to start
migrating a bot from Amazon Lex to Amazon Lex V2.
...
The following IAM permission policy allows a user to draw the conversation flow with visual
conversation builder in Amazon Lex V2.

## Allow users to create and view bot replicas, but not to delete them

You can attach the following permissions to an IAM role to allow it to only create and view bot replicas. By omitting `lex:DeleteBotReplica`, you prevent the role from deleting bot replicas. For more information, see [Permissions to replicate bots and manage bot replicas in Lex V2](gr-permissions.md "gr-permissions.md").
