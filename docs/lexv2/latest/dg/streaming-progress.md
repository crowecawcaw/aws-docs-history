...
Fulfillment updates are used only when interacting with a bot using the [StartConversation](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_StartConversation.html) operation. You can use the post-fulfillment update when interacting with the bot using the [StartConversation](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_StartConversation.html), [RecognizeText](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_RecognizeText.html), and [RecognizeUtterance](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_RecognizeUtterance.html) operations 
...
If you turn off fulfillment updates by setting `active` to false in the console or using the [CreateIntent](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_CreateIntent.html) or [UpdateIntent](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_UpdateIntent.html) operation, the timeout specified for the fulfillment updates isn't used and the default timeout of 30 seconds is used instead.
...
You can use the `active` toggle in the console or the [FulfillmentUpdatesSpecification](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_FulfillmentUpdatesSpecification.html) structure to turn the start response on and off. When `active` is false, the start response isn't played.
...
You can use the `active` toggle in the console or the [FulfillmentUpdatesSpecification](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_FulfillmentUpdatesSpecification.html) structure to turn the update response on and off. When `active` is false, the update response isn't returned.
...
You can use the `active` toggle in the console or the [PostFulfillmentStatusSpecification](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_PostFulfillmentStatusSpecification.html) structure to turn the post-fulfillment response on and off. When `active` is false, the response is not played.
