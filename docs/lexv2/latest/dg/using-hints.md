...
+ Runtime hints are supported only for 8 kHz audio input. They are available with [contact center integrations](https://docs.aws.amazon.com/lexv2/latest/dg/contact-center.html) supported by Amazon Lex V2. Runtime hints aren't provided for audio input from the [test window](https://docs.aws.amazon.com/lexv2/latest/dg/test-bot.html) on the Amazon Lex V2 console because it uses 16 kHz audio input.
...
You can send runtime hints to Amazon Lex V2 using the [PutSession](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_PutSession.html), [RecognizeText](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_RecognizeText.html), [RecognizeUtterance](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_RecognizeUtterance.html), or [StartConversation](https://docs.aws.amazon.com/lexv2/latest/APIReference/API_runtime_StartConversation.html) operation. You can also add runtime hints using a Lambda function.
...
Add context for your bot by providing expected slot values as runtime hints when your application has information about the user's next likely utterance. Add a Lambda dialog code hook to your bot (see [Integrating an AWS Lambda function into your Amazon Lex V2 bot](lambda.md) for more information) and use the **proposedNextState** field in the [AWS Lambda input event format for Lex V2](lambda-input-format.md) to determine the runtime hints that you should include to improve the conversation with the user.
