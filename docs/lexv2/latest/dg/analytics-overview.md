...
![A donut chart that visualizes the performance of your conversations.](images/analytics/conversation-performance.png)
...
![A line graph that tracks the bot's conversation performance over time.](images/analytics/conversation-performance-history.png)
...
![A bar graph that shows the top five intents that customers used with your bot.](images/analytics/top-five-intents.png)
...
![A bar graph that shows the top five intents that your bot failed to fulfill.](images/analytics/top-five-failed-intents.png)
