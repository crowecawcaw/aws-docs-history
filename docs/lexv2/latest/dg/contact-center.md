...
- **Interruptions**
  ...
  information, see [Enabling your Amazon Lex V2 bot to be interrupted by the user](interrupt-bot.md "interrupt-bot.md").
- **Wait and continue** –
  ...
  see [Enabling the Amazon Lex V2 bot to wait for the user to provide more information during a pause](wait-and-continue.md "wait-and-continue.md").
- **DTMF support** –
...
- **Configurable timeouts**
  ...
  or credit card number. For more information, see [Configuring timeouts for capturing user input with a Lex V2 bot](session-attribs-speech.md "session-attribs-speech.md").
