...
| Language | Required in voice mode<br />Ignored in DTMF mode | [4.5](https://www.w3.org/TR/speech-grammar/#S4.5): xml:lang attribute on grammar element | Required in voice mode<br />Ignored in DTMF mode | SRGS | 
