...
| --- | --- | --- | 
| *repeat="n"*<br />repeat="6" | The contained expression is repeated exactly "n" times. "n" must be "0" or a positive integer. | Yes | 
| *repeat="m-n"*<br />repeat="4-6" | The contained expansion is repeated between "m" and "n" times (inclusive). "m" and "n" must both be "0" or a positive integer, and "m" must be less than or equal to "n". | Yes | 
