...
## Prerequisite
<a name="order-prereq"></a>

Confirm your quote. For details, see [Review your quote for AWS Elemental appliances and software](access-and-confirm-your-quote.md).

## Step 1: Add billing details
<a name="purchase-order-billing"></a>
...
1. Enter or verify your billing details.
...
1. Choose **Next** to add shipping information.
...
1. Based on what you enter, the service suggests a valid postal address. You can use the suggestion or your own entry.

1. If you need additional addresses, choose **Add a delivery address**, and then use the **Additional shipping requests** field under each address to specify which items on the order to ship to each delivery location.
