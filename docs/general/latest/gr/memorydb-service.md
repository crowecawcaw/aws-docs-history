...
| ------------------------- | -------------- | --------------------------------------------------------------------------- | -------------- |
| US East (Ohio)            | us-east-2      | memory-db.us-east-2.amazonaws.com<br>memory-db-fips.us-east-2.amazonaws.com | HTTPS<br>HTTPS |
| US East (N. Virginia)     | us-east-1      | memory-db.us-east-1.amazonaws.com<br>memory-db-fips.us-east-1.amazonaws.com | HTTPS<br>HTTPS |
| US West (N. California)   | us-west-1      | memory-db.us-west-1.amazonaws.com<br>memory-db-fips.us-west-1.amazonaws.com | HTTPS<br>HTTPS |
| US West (Oregon)          | us-west-2      | memory-db.us-west-2.amazonaws.com<br>memory-db-fips.us-west-2.amazonaws.com | HTTPS<br>HTTPS |
...
| AWS GovCloud (US-West)    | us-gov-west-1  | memory-db.us-gov-west-1.amazonaws.com                                       | HTTPS          |
