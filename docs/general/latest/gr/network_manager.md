...
For a list of the quotas, see [AWS Global Networks for Transit Gateways Quotas](https://docs.aws.amazon.com/network-manager/latest/tgwnm/nm-quotas.html) in the *AWS Global Networks for Transit Gateways User Guide*.