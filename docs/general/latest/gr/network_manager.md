# AWS Global Networks for Transit Gateways Quotas (Network Manager)
...
| Asia Pacific (Hong Kong)   | ap-east-1      | networkmanager.us-west-2.amazonaws.com<br>networkmanager-fips.us-west-2.api.aws<br>networkmanager-fips.us-west-2.amazonaws.com<br>networkmanager.us-west-2.api.aws | HTTPS<br>HTTPS<br>HTTPS<br>HTTPS |
...
| Mexico (Central)           | mx-central-1   | networkmanager.us-west-2.amazonaws.com<br>networkmanager-fips.us-west-2.api.aws<br>networkmanager-fips.us-west-2.amazonaws.com<br>networkmanager.us-west-2.api.aws | HTTPS<br>HTTPS<br>HTTPS<br>HTTPS |
...
| South America (São Paulo)  | sa-east-1      | networkmanager.us-west-2.amazonaws.com<br>networkmanager-fips.us-west-2.api.aws<br>networkmanager-fips.us-west-2.amazonaws.com<br>networkmanager.us-west-2.api.aws | HTTPS<br>HTTPS<br>HTTPS<br>HTTPS |
...
For a list of the quotas, see [AWS Global Networks for Transit
Gateways Quotas](../../../network-manager/latest/tgwnm/nm-quotas.md "../../../network-manager/latest/tgwnm/nm-quotas.md") in the _AWS Global Networks for Transit Gateways
User Guide_.
