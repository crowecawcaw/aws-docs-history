...
| Canada West (Calgary) | ca-west-1 |  cassandra.ca-west-1.amazonaws.com <br /> cassandra.ca-west-1.api.aws  | HTTPS and TLS<br />HTTPS and TLS | 
...
| --- | --- | --- | --- | 
| Account-level read throughput quota (Provisioned mode) | Each supported Region: 80,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-E7DB0CFF)  | The maximum number of aggregate read capacity units (RCUs) allocated for the account per region; applicable only for tables in provisioned read/write capacity mode. For more information, see https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html | 
| Account-level write throughput quota (Provisioned mode) | Each supported Region: 80,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-2C5B14BD)  | The maximum number of aggregate write capacity units (WCUs) allocated for the account per region; applicable only for tables in provisioned read/write capacity mode. For more information, see https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html | 
...
| Keyspaces per region | Each supported Region: 256 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-677FFD22)  | The maximum number of keyspaces that can be created per region. | 
...
| Max UDT name length | Each supported Region: 48 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-964C49BD)  | The maximum number of characters in the UDT name. | 
| Max amount of data restored using Point-in-time Recovery (PITR) | Each supported Region: 5 Terabytes |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-4C49F3DB)  | The maximum size of data that can be restored using PITR within 24 hours. | 
| Max amount of data restored using add Region operations | Each supported Region: 10 Terabytes |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-7F2EAE05)  | The maximum size of data that can be concurrently restored by add Region operations. | 
| Max amount of direct child UDTs per UDT | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-F90953AC)  | The maximum number of child UDTs supported for a UDT. | 
| Max amount of direct parent UDTs per UDT | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-C63C913D)  | The maximum number of parent UDTs supported for a UDT. | 
...
| Max concurrent table restores using Point-in-time Recovery (PITR) | Each supported Region: 4 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-F41E662B)  | The maximum number of concurrent table restores using PITR per subscriber is 4 | 
| Max number of UDTs per AWS Region | Each supported Region: 256 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-7A88D508)  | The maximum number of UDTs that can be created per region across all keyspaces. | 
| Max number of UDTs per table | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-96FEFC6D)  | The maximum number of UDTs that a table can reference. | 
| Max number of tables per UDT | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-089904FB)  | The Maximum number of tables that can refer to a particular UDT. | 
...
| Max subqueries per IN SELECT statement | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-2FC1B9A1)  | The maximum number of subqueries you can use for the IN keyword in a SELECT statement. | 
| Max write capacity for a table using change-data-capture (CDC) | Each supported Region: 40,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-6632AD49)  | The maximum write capacity for Amazon Keyspaces tables with CDC enabled. This default quota only applies to tables in provisioned read/write capacity mode. | 
...
| Table-level write throughput quota | Each supported Region: 40,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-3D8ED127)  | The maximum write throughput (WCUs & WRUs per second) that can be allocated to a table per region. For more information, see https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html | 
| Tables per region | Each supported Region: 256 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cassandra/quotas/L-BF48748A)  | The maximum number of tables that can be created per region across all keyspaces. | 

For more information, see [Quotas for Amazon Keyspaces (for Apache Cassandra)](https://docs.aws.amazon.com/keyspaces/latest/devguide/quotas.html) in the *Amazon Keyspaces (for Apache Cassandra) Developer Guide*.