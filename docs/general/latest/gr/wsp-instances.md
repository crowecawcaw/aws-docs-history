...
| ----------------------------------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------ | ---------- | ----------------- |
| US East (N. Virginia)                                       | us-east-1      | workspaces-instances.us-east-1.api.aws workspaces-instances-fips.us-east-1.api.aws                                       | HTTPS      |
| US East (Ohio)                                              | us-east-2      | workspaces-instances.us-east-2.api.aws workspaces-instances-fips.us-east-2.api.aws                                       | HTTPS      |
| US West (Oregon)                                            | us-west-2      | workspaces-instances.us-west-2.api.aws workspaces-instances-fips.us-west-2.api.aws                                       | HTTPS      |
...
| South America (São Paulo)                                   | sa-east-1      | workspaces-instances.sa-east-1.api.aws                                                                                   | HTTPS      | ## Service quotas |
