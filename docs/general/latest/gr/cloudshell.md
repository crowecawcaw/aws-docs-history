...
| --- | --- | --- | --- | 
| Concurrent shells | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/cloudshell/quotas/L-C2A56602)  | The maximum number of concurrent shells that you can run at the same time in this account in the current Region. | 
