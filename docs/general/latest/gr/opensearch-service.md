...
| Collections per collection group                               | 1,500         | No         | The maximum number of collections per collection group. The<br>actual number of collections can be further limited by MaxOCUs<br>based on the size of collections.                                                                                                                                                               |
