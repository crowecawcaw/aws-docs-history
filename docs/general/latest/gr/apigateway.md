...
| Domain name access associations | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-4D98A8A5)  | The maximum number of domain name access associations that you can create in this account in the current region | 
...
| Maximum resource policy size in bytes | Each supported Region: 8,192 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-8B81B02C)  | The maximum resource policy size in bytes you can have in this account in the current region. | 
| Method ARN Length | Each supported Region: 1,600 Bytes | No | ARN length of a method with authorization | 
| PortalProducts per Portal | Each supported Region: 200 | No | The maximum number of PortalProducts per Portal | 
| PortalProducts per account | Each supported Region: 500 | No | The maximum number of PortalProducts per account | 
| Portals per account | Each supported Region: 15 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-F8BD84D3)  | The maximum number of Portals per account | 
...
| Private custom domain names | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-24E7E662)  | The maximum number of private custom domain names that you can create in this account in the current region | 
| ProductPages per PortalProduct | Each supported Region: 40 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-154598D1)  | The maximum number of ProductPages per PortalProduct | 
| ProductRestEndpointPages per PortalProduct | Each supported Region: 40 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-05295E0B)  | The maximum number of ProductRestEndpointPages per PortalProduct | 
...
| Resources/Routes per REST/WebSocket API | Each supported Region: 300 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-01C8A9E0)  | The maximum number of resources/routes that you can include in a REST or WebSocket API | 
| Routes per HTTP API | Each supported Region: 300 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-65B5C802)  | The maximum number of routes that you can include in an HTTP API | 
| RoutingRules Per Domain Name | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-68B79FF0)  | The maximum number of RoutingRules per DomainName that you can create in this account in the current region | 
...
| Subnets per VPC link(V2) | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-668C9B28)  | The maximum number of subnets per V2 VPC link in this account in the current Region | 
...
| VPC links | Each supported Region: 20 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-A4C7274F)  | The maximum number of VPC links that you can create in this account in the current region | 
| VPC links(V2) | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/apigateway/quotas/L-608BDCD4)  | The maximum number of V2 VPC links that you can create in this account in the current Region | 
