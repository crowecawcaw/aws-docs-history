...
| -------------------------- | -------------- | ------------------------------------------------------------ | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| US East (Ohio)             | us-east-2      | sts.us-east-2.amazonaws.com sts-fips.us-east-2.amazonaws.com | HTTPS HTTPS |
| US East (N. Virginia)      | us-east-1      | sts.us-east-1.amazonaws.com sts-fips.us-east-1.amazonaws.com | HTTPS HTTPS |
| US West (N. California)    | us-west-1      | sts.us-west-1.amazonaws.com sts-fips.us-west-1.amazonaws.com | HTTPS HTTPS |
| US West (Oregon)           | us-west-2      | sts.us-west-2.amazonaws.com sts-fips.us-west-2.amazonaws.com | HTTPS HTTPS |
...
| AWS GovCloud (US-West)     | us-gov-west-1  | sts.us-gov-west-1.amazonaws.com                              | HTTPS       | ## Service quotas For information about AWS STS quotas, see [IAM and AWS STS quotas](../../../IAM/latest/UserGuide/reference_iam-quotas.md "../../../IAM/latest/UserGuide/reference_iam-quotas.md") in the _IAM User Guide_. |
