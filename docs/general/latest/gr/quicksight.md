...
| Amazon Quick Automate Maximum Concurrent Tests and Deployed Executions | Each supported Region: 100              | No         | Maximum number of concurrent tests and executions per account in Amazon Quick Automate                                                                                                                                                                            |
