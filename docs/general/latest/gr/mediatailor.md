...
| --- | --- | --- | --- | 
| Ad Insertion Requests | Each supported Region: 10,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-32FBC51C)  | Maximum requests per second when requesting manifests, segments, and tracking information when performing server side ad insertion. | 
...
| Channel Manifest Requests | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-C13EFDBD)  | The maximum number of manifest requests per second for any single Channel Assembly channel. This is an account-level quota. | 
| Channel outputs | Each supported Region: 5 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-3BCD6A29)  | The maximum number of outputs per channel. | 
| Channels per account | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-29DF1B92)  | The maximum number of channels per account. | 
...
| Live Sources | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-7A79D9CE)  | The maximum number of live sources sources per source location. | 
| Manifest Requests | Each supported Region: 400 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-B9D43015)  | The maximum number of manifest requests per second across all channels. This is an account-level quota. | 
...
| Package configurations | Each supported Region: 5 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-0F7265C4)  | The maximum number of package configurations per live or VOD (video on demand) source. | 
| Programs Per Channel | Each supported Region: 400 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-7946CFE6)  | The maximum number of programs per channel. | 
| Segment Delivery Configurations Per Source | Each supported Region: 5 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-680CE323)  | The maximum number of segment delivery configurations per source location. | 
...
| Source Locations | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-2290981E)  | The maximum number of source locations per account. | 
| VOD Sources | Each supported Region: 1,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mediatailor/quotas/L-A32E8357)  | The maximum number of video on demand (VOD) sources per source location. | 

For more information, see [Quotas](https://docs.aws.amazon.com/mediatailor/latest/ug/limits.html) in the *AWS Elemental MediaTailor User Guide*.