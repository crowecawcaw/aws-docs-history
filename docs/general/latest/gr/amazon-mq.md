...
| Number of brokers, per region | Each supported Region: 200 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mq/quotas/L-4D525FD5)  | The maximum number of brokers, per region. | 
...
| Wire-level connections per larger broker | Each supported Region: 2,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/mq/quotas/L-42B434B7)  | The maximum number of wire-level connections per larger broker (mq.\*.\*large instance type brokers). This does not apply to RabbitMQ brokers. | 
...
For more information, see [Quotas in Amazon MQ](https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/amazon-mq-limits.html) in the *Amazon MQ Developer Guide*.