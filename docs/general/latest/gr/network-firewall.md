...
| --- | --- | --- | --- | 
| US East (Ohio) | us-east-2 |  network-firewall.us-east-2.amazonaws.com <br /> network-firewall-fips.us-east-2.amazonaws.com  | HTTPS<br />HTTPS | 
| US East (N. Virginia) | us-east-1 |  network-firewall.us-east-1.amazonaws.com <br /> network-firewall-fips.us-east-1.amazonaws.com  | HTTPS<br />HTTPS | 
| US West (N. California) | us-west-1 |  network-firewall.us-west-1.amazonaws.com <br /> network-firewall-fips.us-west-1.amazonaws.com  | HTTPS<br />HTTPS | 
| US West (Oregon) | us-west-2 |  network-firewall.us-west-2.amazonaws.com <br /> network-firewall-fips.us-west-2.amazonaws.com  | HTTPS<br />HTTPS | 
...
| Asia Pacific (New Zealand) | ap-southeast-6 |  network-firewall.ap-southeast-6.amazonaws.com  | HTTPS | 
...
| Canada (Central) | ca-central-1 |  network-firewall.ca-central-1.amazonaws.com <br /> network-firewall-fips.ca-central-1.amazonaws.com  | HTTPS<br />HTTPS | 
...
| Container associations | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-56D4232F)  | The maximum number of container associations per account per Region. | 
| Firewall policies | Each supported Region: 20 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-0814492B)  | The maximum number of firewall policies per account per Region. | 
| Firewalls | Each supported Region: 5 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-DE163D32)  | The maximum number of firewalls per account per Region. | 
...
| Resource filters | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-DBC1A782)  | The maximum number of resource filters per account per Region. | 
...
| Stateful rulegroups | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-2D7A0EE2)  | The maximum number of stateful rule groups per account per Region. | 
| Stateful rules per policy | Each supported Region: 30,000 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-E65239AF)  | The maximum number of stateful rules per firewall policy. This is the total across all rule groups that are referenced by the policy. You can increase this up to 50,000, but higher settings might impact firewall performance. | 
...
| Stateless rulegroups | Each supported Region: 50 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-EAE8E19E)  | The maximum number of stateless rule groups per account per Region. | 
...
| TLS configurations | Each supported Region: 20 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-801F8132)  | The maximum number of TLS configurations per account per Region. | 
...
| VPC endpoint associations | Each supported Region: 300 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/network-firewall/quotas/L-3EF9089F)  | The maximum number of VPC endpoint associations per account per Region. | 
| VPC endpoint associations per Availability Zone per Firewall | Each supported Region: 50 | No | The maximum number of VPC endpoint associations for a firewall per Availability Zone. | 

For more information, see [AWS Network Firewall quotas](https://docs.aws.amazon.com/network-firewall/latest/developerguide/quotas.html) in the *Network Firewall Developer Guide*.