...
| Europe (Ireland)      | eu-west-1 | Amazon WorkMail Message Flow SDK | https://workmailmessageflow.eu-west-1.amazonaws.com |

## Email protocols endpoints
...
| Europe (Ireland)      | eu-west-1 | SMTP over SSL/TLS (SMTPS)   | smtp.mail.eu-west-1.awsapps.com:465                                                   |

## Service quotas

For more information, see [Amazon WorkMail
Quotas](../../../workmail/latest/adminguide/workmail_limits.md "../../../workmail/latest/adminguide/workmail_limits.md").
