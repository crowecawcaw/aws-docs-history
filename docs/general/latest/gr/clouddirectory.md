...
| Asia Pacific (Singapore) | ap-southeast-1 |  clouddirectory.ap-southeast-1.amazonaws.com  | HTTPS | 
| Asia Pacific (Sydney) | ap-southeast-2 |  clouddirectory.ap-southeast-2.amazonaws.com  | HTTPS | 
| Canada (Central) | ca-central-1 |  clouddirectory.ca-central-1.amazonaws.com  | HTTPS | 
...
For more information, see [Amazon Cloud Directory quotas](https://docs.aws.amazon.com/clouddirectory/latest/developerguide/limits.html).