...
| Number of active instances per object | Each supported Region: 5 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/datapipeline/quotas/L-38666D85)  | The maximum number of active instances per object. | 
| Number of fields per object | Each supported Region: 50 | No | The maximum number of fields per object. | 
| Number of objects per pipeline | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/datapipeline/quotas/L-68BE1CDF)  | The maximum number of objects that you can define per pipeline. | 
| Number of pipelines you can create | Each supported Region: 100 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/datapipeline/quotas/L-F826FAFA)  | The maximum number of pipelines that you can create. | 
