...
For more information, see [IAM Roles Anywhere quotas](https://docs.aws.amazon.com/rolesanywhere/latest/userguide/load-balancer-limits.html) in the *IAM Roles Anywhere User Guide*.