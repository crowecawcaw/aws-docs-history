...
- [AWS Cloud WAN](cloudwan.md#cloudwan_region "cloudwan.md#cloudwan_region")
- [Amazon CloudFront](cf_region.md "cf_region.md")
- [AWS Global Accelerator](global_accelerator.md#global_accelerator_region "global_accelerator.md#global_accelerator_region")
- [AWS Identity and Access Management](iam-service.md#iam_region "iam-service.md#iam_region") (IAM)
- [AWS Organizations](ao.md#ao_region "ao.md#ao_region")
- [Amazon Route 53](r53.md#r53_region "r53.md#r53_region")
- [AWS Shield Advanced](shield.md#shield_region "shield.md#shield_region")
- [AWS WAF Classic](waf-classic.md#waf-classic_region "waf-classic.md#waf-classic_region")
...
- Open [Service endpoints and quotas](aws-service-information.md "aws-service-information.md"), search for the service name, and click
...
- To programmatically view Region and service information using Systems Manager, see [Calling public parameters for AWS services, Regions, endpoints, and zones in parameter store](../../../systems-manager/latest/userguide/parameter-store-public-parameters-global-infrastructure.md "../../../systems-manager/latest/userguide/parameter-store-public-parameters-global-infrastructure.md")
  in the _AWS Systems Manager User Guide_. For information about how to use public
  parameters, see [Query for AWS Regions, Endpoints, and More Using AWS Systems Manager Parameter Store](https://aws.amazon.com/blogs/aws/new-query-for-aws-regions-endpoints-and-more-using-aws-systems-manager-parameter-store/ "https://aws.amazon.com/blogs/aws/new-query-for-aws-regions-endpoints-and-more-using-aws-systems-manager-parameter-store/").
- To see the supported AWS services in each Region (without endpoints), see the
...
(FIPS) 140 in some Regions. Unlike standard AWS endpoints, FIPS endpoints use a TLS
software library that complies with FIPS 140. These endpoints might be required by
enterprises that interact with the United States government.
...
For a list of FIPS endpoints, see [FIPS endpoints by
Service](https://aws.amazon.com/compliance/fips/#FIPS_Endpoints_by_Service "https://aws.amazon.com/compliance/fips/#FIPS_Endpoints_by_Service").
