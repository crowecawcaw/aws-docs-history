...
The quotas associated with AWS Migration Hub are the AWS Application Discovery Service quotas. For more information,
see [AWS Application Discovery Service Quotas](appdiscserv.md#limits_appdiscserve "appdiscserv.md#limits_appdiscserve").
