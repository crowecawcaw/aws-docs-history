...
| --- | --- | --- | --- | 
| Accounts in scope across all assessments | Each supported Region: 250 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/auditmanager/quotas/L-BEA222D4)  | The maximum number of accounts in scope across all assessments per region | 
| Controls per framework | Each supported Region: 1,400 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/auditmanager/quotas/L-724DD74D)  | The maximum number of controls per framework per account per region | 
