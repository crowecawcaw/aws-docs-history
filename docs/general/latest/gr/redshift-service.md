...
| Asia Pacific (Melbourne) | ap-southeast-4 |  redshift-serverless.ap-southeast-4.amazonaws.com <br /> redshift-serverless.ap-southeast-4.api.aws  | HTTPS<br />HTTPS | 
...
| Canada West (Calgary) | ca-west-1 |  redshift-serverless.ca-west-1.amazonaws.com <br /> redshift-serverless-fips.ca-west-1.api.aws <br /> redshift-serverless-fips.ca-west-1.amazonaws.com <br /> redshift-serverless.ca-west-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
...
For information, see [Quotas and limits in Amazon Redshift](https://docs.aws.amazon.com/redshift/latest/mgmt/amazon-redshift-limits.html) in the *Amazon Redshift Management Guide*.