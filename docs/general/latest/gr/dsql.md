...
| --- | --- | --- | --- | 
| Cluster size | Each supported Region: 10,000 Gigabytes |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/dsql/quotas/L-9A50E9F1)  | The maximum capacity (in GB) for an Aurora DSQL cluster. This quota applies to both single-Region and multi-Region clusters. | 
