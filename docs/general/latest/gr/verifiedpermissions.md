...
| --- | --- | --- | --- | 
| US East (Ohio) | us-east-2 |  verifiedpermissions.us-east-2.amazonaws.com <br /> verifiedpermissions-fips.us-east-2.api.aws <br /> verifiedpermissions-fips.us-east-2.amazonaws.com <br /> verifiedpermissions.us-east-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| US East (N. Virginia) | us-east-1 |  verifiedpermissions.us-east-1.amazonaws.com <br /> verifiedpermissions-fips.us-east-1.api.aws <br /> verifiedpermissions-fips.us-east-1.amazonaws.com <br /> verifiedpermissions.us-east-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| US West (N. California) | us-west-1 |  verifiedpermissions.us-west-1.amazonaws.com <br /> verifiedpermissions-fips.us-west-1.api.aws <br /> verifiedpermissions-fips.us-west-1.amazonaws.com <br /> verifiedpermissions.us-west-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| US West (Oregon) | us-west-2 |  verifiedpermissions.us-west-2.amazonaws.com <br /> verifiedpermissions-fips.us-west-2.api.aws <br /> verifiedpermissions-fips.us-west-2.amazonaws.com <br /> verifiedpermissions.us-west-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Africa (Cape Town) | af-south-1 |  verifiedpermissions.af-south-1.amazonaws.com <br /> verifiedpermissions.af-south-1.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Hong Kong) | ap-east-1 |  verifiedpermissions.ap-east-1.amazonaws.com <br /> verifiedpermissions.ap-east-1.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Hyderabad) | ap-south-2 |  verifiedpermissions.ap-south-2.amazonaws.com <br /> verifiedpermissions.ap-south-2.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Jakarta) | ap-southeast-3 |  verifiedpermissions.ap-southeast-3.amazonaws.com <br /> verifiedpermissions.ap-southeast-3.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Malaysia) | ap-southeast-5 |  verifiedpermissions.ap-southeast-5.amazonaws.com <br /> verifiedpermissions.ap-southeast-5.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Melbourne) | ap-southeast-4 |  verifiedpermissions.ap-southeast-4.amazonaws.com <br /> verifiedpermissions.ap-southeast-4.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Mumbai) | ap-south-1 |  verifiedpermissions.ap-south-1.amazonaws.com <br /> verifiedpermissions.ap-south-1.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (New Zealand) | ap-southeast-6 |  verifiedpermissions.ap-southeast-6.amazonaws.com <br /> verifiedpermissions.ap-southeast-6.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Osaka) | ap-northeast-3 |  verifiedpermissions.ap-northeast-3.amazonaws.com <br /> verifiedpermissions.ap-northeast-3.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Seoul) | ap-northeast-2 |  verifiedpermissions.ap-northeast-2.amazonaws.com <br /> verifiedpermissions.ap-northeast-2.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Singapore) | ap-southeast-1 |  verifiedpermissions.ap-southeast-1.amazonaws.com <br /> verifiedpermissions.ap-southeast-1.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Sydney) | ap-southeast-2 |  verifiedpermissions.ap-southeast-2.amazonaws.com <br /> verifiedpermissions.ap-southeast-2.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Taipei) | ap-east-2 |  verifiedpermissions.ap-east-2.amazonaws.com <br /> verifiedpermissions.ap-east-2.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Thailand) | ap-southeast-7 |  verifiedpermissions.ap-southeast-7.amazonaws.com <br /> verifiedpermissions.ap-southeast-7.api.aws  | HTTPS<br />HTTPS | 
| Asia Pacific (Tokyo) | ap-northeast-1 |  verifiedpermissions.ap-northeast-1.amazonaws.com <br /> verifiedpermissions.ap-northeast-1.api.aws  | HTTPS<br />HTTPS | 
| Canada (Central) | ca-central-1 |  verifiedpermissions.ca-central-1.amazonaws.com <br /> verifiedpermissions-fips.ca-central-1.api.aws <br /> verifiedpermissions-fips.ca-central-1.amazonaws.com <br /> verifiedpermissions.ca-central-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Canada West (Calgary) | ca-west-1 |  verifiedpermissions.ca-west-1.amazonaws.com <br /> verifiedpermissions-fips.ca-west-1.api.aws <br /> verifiedpermissions-fips.ca-west-1.amazonaws.com <br /> verifiedpermissions.ca-west-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Europe (Frankfurt) | eu-central-1 |  verifiedpermissions.eu-central-1.amazonaws.com <br /> verifiedpermissions.eu-central-1.api.aws  | HTTPS<br />HTTPS | 
| Europe (Ireland) | eu-west-1 |  verifiedpermissions.eu-west-1.amazonaws.com <br /> verifiedpermissions.eu-west-1.api.aws  | HTTPS<br />HTTPS | 
| Europe (London) | eu-west-2 |  verifiedpermissions.eu-west-2.amazonaws.com <br /> verifiedpermissions.eu-west-2.api.aws  | HTTPS<br />HTTPS | 
| Europe (Milan) | eu-south-1 |  verifiedpermissions.eu-south-1.amazonaws.com <br /> verifiedpermissions.eu-south-1.api.aws  | HTTPS<br />HTTPS | 
| Europe (Paris) | eu-west-3 |  verifiedpermissions.eu-west-3.amazonaws.com <br /> verifiedpermissions.eu-west-3.api.aws  | HTTPS<br />HTTPS | 
| Europe (Spain) | eu-south-2 |  verifiedpermissions.eu-south-2.amazonaws.com <br /> verifiedpermissions.eu-south-2.api.aws  | HTTPS<br />HTTPS | 
| Europe (Stockholm) | eu-north-1 |  verifiedpermissions.eu-north-1.amazonaws.com <br /> verifiedpermissions.eu-north-1.api.aws  | HTTPS<br />HTTPS | 
| Europe (Zurich) | eu-central-2 |  verifiedpermissions.eu-central-2.amazonaws.com <br /> verifiedpermissions.eu-central-2.api.aws  | HTTPS<br />HTTPS | 
| Israel (Tel Aviv) | il-central-1 |  verifiedpermissions.il-central-1.amazonaws.com <br /> verifiedpermissions.il-central-1.api.aws  | HTTPS<br />HTTPS | 
| Mexico (Central) | mx-central-1 |  verifiedpermissions.mx-central-1.amazonaws.com <br /> verifiedpermissions.mx-central-1.api.aws  | HTTPS<br />HTTPS | 
| Middle East (Bahrain) | me-south-1 |  verifiedpermissions.me-south-1.amazonaws.com <br /> verifiedpermissions.me-south-1.api.aws  | HTTPS<br />HTTPS | 
| Middle East (UAE) | me-central-1 |  verifiedpermissions.me-central-1.amazonaws.com <br /> verifiedpermissions.me-central-1.api.aws  | HTTPS<br />HTTPS | 
| South America (São Paulo) | sa-east-1 |  verifiedpermissions.sa-east-1.amazonaws.com <br /> verifiedpermissions.sa-east-1.api.aws  | HTTPS<br />HTTPS | 
|  AWS GovCloud (US-East) | us-gov-east-1 |  verifiedpermissions.us-gov-east-1.amazonaws.com <br /> verifiedpermissions-fips.us-gov-east-1.api.aws <br /> verifiedpermissions-fips.us-gov-east-1.amazonaws.com <br /> verifiedpermissions.us-gov-east-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
|  AWS GovCloud (US-West) | us-gov-west-1 |  verifiedpermissions.us-gov-west-1.amazonaws.com <br /> verifiedpermissions-fips.us-gov-west-1.api.aws <br /> verifiedpermissions-fips.us-gov-west-1.amazonaws.com <br /> verifiedpermissions.us-gov-west-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
...
| CreatePolicyStoreAlias requests per second per Region per policy store | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/verifiedpermissions/quotas/L-7CE71035)  | The maximum number of CreatePolicyStoreAlias requests per second per policy store. | 
...
| DeletePolicyStoreAlias requests per second per Region per policy store | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/verifiedpermissions/quotas/L-5EB73F6C)  | The maximum number of DeletePolicyStoreAlias requests per second per policy store. | 
...
| GetPolicyStoreAlias requests per second per Region per policy store | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/verifiedpermissions/quotas/L-B45950D5)  | The maximum number of GetPolicyStoreAlias requests per second per policy store. | 
...
| ListPolicyStoreAliases requests per second per Region per policy store | Each supported Region: 10 |  [Yes](https://console.aws.amazon.com/servicequotas/home/services/verifiedpermissions/quotas/L-57660735)  | The maximum number of ListPolicyStoreAliases requests per second per policy store. | 
