...
| --- | --- | --- | --- | 
| US East (Ohio) | us-east-2 |  management.deadline.us-east-2.amazonaws.com <br /> scheduling.deadline.us-east-2.amazonaws.com <br /> scheduling.deadline.us-east-2.api.aws <br /> management.deadline.us-east-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| US East (N. Virginia) | us-east-1 |  management.deadline.us-east-1.amazonaws.com <br /> scheduling.deadline.us-east-1.amazonaws.com <br /> scheduling.deadline.us-east-1.api.aws <br /> management.deadline.us-east-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| US West (Oregon) | us-west-2 |  management.deadline.us-west-2.amazonaws.com <br /> scheduling.deadline.us-west-2.amazonaws.com <br /> scheduling.deadline.us-west-2.api.aws <br /> management.deadline.us-west-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Asia Pacific (Seoul) | ap-northeast-2 |  management.deadline.ap-northeast-2.amazonaws.com <br /> scheduling.deadline.ap-northeast-2.amazonaws.com <br /> scheduling.deadline.ap-northeast-2.api.aws <br /> management.deadline.ap-northeast-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Asia Pacific (Singapore) | ap-southeast-1 |  management.deadline.ap-southeast-1.amazonaws.com <br /> scheduling.deadline.ap-southeast-1.amazonaws.com <br /> scheduling.deadline.ap-southeast-1.api.aws <br /> management.deadline.ap-southeast-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Asia Pacific (Sydney) | ap-southeast-2 |  management.deadline.ap-southeast-2.amazonaws.com <br /> scheduling.deadline.ap-southeast-2.amazonaws.com <br /> scheduling.deadline.ap-southeast-2.api.aws <br /> management.deadline.ap-southeast-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Asia Pacific (Tokyo) | ap-northeast-1 |  management.deadline.ap-northeast-1.amazonaws.com <br /> scheduling.deadline.ap-northeast-1.amazonaws.com <br /> scheduling.deadline.ap-northeast-1.api.aws <br /> management.deadline.ap-northeast-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Europe (Frankfurt) | eu-central-1 |  management.deadline.eu-central-1.amazonaws.com <br /> scheduling.deadline.eu-central-1.amazonaws.com <br /> scheduling.deadline.eu-central-1.api.aws <br /> management.deadline.eu-central-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Europe (Ireland) | eu-west-1 |  management.deadline.eu-west-1.amazonaws.com <br /> scheduling.deadline.eu-west-1.amazonaws.com <br /> scheduling.deadline.eu-west-1.api.aws <br /> management.deadline.eu-west-1.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
| Europe (London) | eu-west-2 |  management.deadline.eu-west-2.amazonaws.com <br /> scheduling.deadline.eu-west-2.amazonaws.com <br /> scheduling.deadline.eu-west-2.api.aws <br /> management.deadline.eu-west-2.api.aws  | HTTPS<br />HTTPS<br />HTTPS<br />HTTPS | 
...
For more information, see [Quotas](https://docs.aws.amazon.com/deadline-cloud/latest/userguide/deadline-cloud-quotas.html) in the Deadline Cloud user guide.