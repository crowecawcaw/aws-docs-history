...
For more information about Security Hub CSPM quotas, see [Quotas](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub_limits.html) in the *AWS Security Hub User Guide*.