...
| Asia Pacific (Thailand)  | ap-southeast-7 | aiops.ap-southeast-7.amazonaws.com | HTTPS    |
...
| Monthly investigations           | 150     | No         | The maximum number of AI-assisted investigations per month in this account in the current Region. |
