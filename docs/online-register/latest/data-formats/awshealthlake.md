...
| <a name="healthlake-DescribeFHIRBulkPatchJob"></a>[DescribeFHIRBulkPatchJob](https://docs.aws.amazon.com/healthlake/latest/devguide/reference-fhir-operations-bulk-patch.html) | Describe a FHIR Bulk Patch Job | Read | 
