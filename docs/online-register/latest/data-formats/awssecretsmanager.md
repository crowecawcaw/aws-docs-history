...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | ------------ |
| [BatchGetSecretValue](../../../secretsmanager/latest/apireference/API_BatchGetSecretValue.md "../../../secretsmanager/latest/apireference/API_BatchGetSecretValue.md")    | Retrieve and decrypt a list of secrets                           | Read         |
