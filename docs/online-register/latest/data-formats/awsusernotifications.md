...
| <a name="notifications-GetManagedNotificationConfiguration"></a>[GetManagedNotificationConfiguration](https://docs.aws.amazon.com/notifications/latest/APIReference/API_GetManagedNotificationConfiguration.html) | Get a Managed Notification Configuration | Read | 
| <a name="notifications-GetManagedNotificationEvent"></a>[GetManagedNotificationEvent](https://docs.aws.amazon.com/notifications/latest/APIReference/API_GetManagedNotificationEvent.html) | Get a Managed NotificationEvent | Read | 
| <a name="notifications-GetNotificationConfiguration"></a>[GetNotificationConfiguration](https://docs.aws.amazon.com/notifications/latest/APIReference/API_GetNotificationConfiguration.html) | Get a NotificationConfiguration | Read | 
| <a name="notifications-GetNotificationEvent"></a>[GetNotificationEvent](https://docs.aws.amazon.com/notifications/latest/APIReference/API_GetNotificationEvent.html) | Get a NotificationEvent | Read | 
| <a name="notifications-GetNotificationsAccessForOrganization"></a>[GetNotificationsAccessForOrganization](https://docs.aws.amazon.com/notifications/latest/APIReference/API_GetNotificationsAccessForOrganization.html) | Read Service Trust for AWS User Notifications | Read | 
| <a name="notifications-ListChannels"></a>[ListChannels](https://docs.aws.amazon.com/notifications/latest/APIReference/API_ListChannels.html) | List Channels by NotificationConfiguration | List | 
| <a name="notifications-ListEventRules"></a>[ListEventRules](https://docs.aws.amazon.com/notifications/latest/APIReference/API_ListEventRules.html) | List EventRules | List | 
| <a name="notifications-ListManagedNotificationChannelAssociations"></a>[ListManagedNotificationChannelAssociations](https://docs.aws.amazon.com/notifications/latest/APIReference/API_ListManagedNotificationChannelAssociations.html) | List Account contacts and Channels associated with a Managed Notification Configuration | List | 
