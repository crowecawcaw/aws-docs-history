...
| MESSAGE_SIZE_LIMIT_EXCEEDED | A message sent from the vehicle and received by AWS IoT FleetWise exceeds the maximum size of a message service limit.<br>Attributes: accountId, vehicleName                                                                                                                                                                                                                                 |
