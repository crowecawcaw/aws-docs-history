...
| IAM features you can use with AWS IoT FleetWise                                                                                                          | IAM feature | AWS IoT FleetWise support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------- |
...
To get a high-level view of how AWS IoT FleetWise and other AWS services work with most
...
To see a list of AWS IoT FleetWise actions, see [Actions Defined by AWS IoT FleetWise](../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-actions-as-permissions "../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-actions-as-permissions") in the
...
To see a list of AWS IoT FleetWise resource types and their ARNs, see
[Resources Defined by AWS IoT FleetWise](../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of AWS IoT FleetWise condition keys, see [Condition Keys for AWS IoT FleetWise](../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-policy-keys "../../../IAM/latest/UserGuide/list_awskeymanagementservice.md#awskeymanagementservice-policy-keys") in the
...
Changing the permissions for a service role might break AWS IoT FleetWise
