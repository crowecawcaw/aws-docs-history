...
1. In **Add attributes**, specify the following
   ...
   - **Data type** – The
     ...
     UINT64, BOOLEAN, FLOAT, DOUBLE, STRING, UNIX\_TIMESTAMP,
     INT8\_ARRAY, UINT8\_ARRAY, INT16\_ARRAY, UINT16\_ARRAY,
     INT32\_ARRAY, UINT32\_ARRAY, INT64\_ARRAY, UINT64\_ARRAY,
     BOOLEAN\_ARRAY, FLOAT\_ARRAY, DOUBLE\_ARRAY, STRING\_ARRAY,
     UNIX\_TIMESTAMP\_ARRAY, or UNKNOWN
   - (Optional) **Unit** – The
