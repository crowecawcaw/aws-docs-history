...
To ensure that users and roles can still use the AWS IoT FleetWise console, also attach
the AWS IoT FleetWise `ConsoleAccess` or `ReadOnly` AWS managed
...
AWS Cloud on your behalf. To register, you need:
...
For more information, including procedures and example policies, see
