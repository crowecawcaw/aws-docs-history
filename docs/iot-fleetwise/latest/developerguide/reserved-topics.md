...
| `$aws/iotfleetwise/vehicles/{{vehicleName}}/command/response` | Publish | The Edge Agent software publishes command responses from the vehicle to this topic.<br />Command responses are exchanged in protocol buffers (Protobuf) format. For more information, see the [*Edge Agent for AWS IoT FleetWise software Developer Guide*](https://github.com/aws/aws-iot-fleetwise-edge/blob/main/docs/dev-guide/edge-agent-dev-guide.md#data-models). | 
