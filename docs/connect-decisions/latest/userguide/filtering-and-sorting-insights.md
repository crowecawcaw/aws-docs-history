...
2. Begin typing your search term (Task ID, product name, site name, keywords)
3. The system provides real-time search results as you type
4. Applied filters appear as chips below the search area
...
2. The date picker displays showing the current date range
3. Select the start date and end date from the calendar
4. The filter applies automatically, showing the date range
5. The results count updates to show matching insights
...
2. The system removes that filter and updates results

**To remove all filters:**

1. Select **Clear filters**
2. The system removes all filter chips and displays the unfiltered view
...
3. Navigate to the **Assigned Scope** tab
4. Toggle **Filter views by my assigned scope** on or off
5. Select **Save**
...
2. The system sorts insights by that column in ascending order
3. An arrow appears on the column header showing the sort direction
4. Select the same column header again to toggle to descending order
