...
responsibility model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/") describes this as security _of_ the cloud
and security _in_ the cloud:
...
- **Security of the cloud** – AWS is responsible for
  ...
  Amazon Connect Decisions, see [AWS Services in Scope
...
- **Security in the cloud** – Your responsibility is
  ...
  using Amazon Connect. The following topics show you how to configure Amazon Connect Decisions to
