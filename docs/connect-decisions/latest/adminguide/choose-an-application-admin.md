...
![](https://docs.aws.amazon.com/connect-decisions/latest/adminguide/images/choose-an-application-admin-select-admin.png)
...
![](https://docs.aws.amazon.com/connect-decisions/latest/adminguide/images/choose-an-application-admin-send-invite.png)
