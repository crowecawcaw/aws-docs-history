...
1. Select the radio button that represents your most pressing challenge.

1. Optionally, review the feature comparison table below the options to understand what is included with each selection.
...
1. Select the radio button for the approach that matches your current state.
...
1. Click **Submit** to finalize the onboarding questionnaire.
...
+ Reference [user guides](https://docs.aws.amazon.com/connect-decisions/legacy/userguide/data-model-asc.html) to learn more about specific datasets
