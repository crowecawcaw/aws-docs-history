...
+ Your data is already stored in an AWS Glue-compatible relational database. Refer to [this guide](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-etl-connect-jdbc-home.html) for compatible databases and versions.
...
1. **Configure key type and usage**
...
1. **Set key identification details**
...
1. **Define key administrative permissions**
...
1. **Define key usage permissions**
...
1. **Configure the key policy for Amazon Connect Decisions services**
...
1. **Configure table refresh schedule**
