...
To ensure that users and roles can still use the Amazon SNS console, also attach the
Amazon SNS `ConsoleAccess` or
`ReadOnly` AWS managed policy to the entities.
