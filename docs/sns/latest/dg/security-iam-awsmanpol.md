...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------- |
| [AmazonSNSFullAccess](#security-iam-awsmanpol-AmazonSNSFullAccess "#security-iam-awsmanpol-AmazonSNSFullAccess") – Update to an existing policy             | Amazon SNS added new permissions to allow full access to Amazon SNS using the AWS Management Console.      | 09/24/2024 |
| [AmazonSNSReadOnlyAccess](#security-iam-awsmanpol-AmazonSNSReadOnlyAccess "#security-iam-awsmanpol-AmazonSNSReadOnlyAccess") – Update to an existing policy | Amazon SNS added new permissions to allow read-only access to Amazon SNS using the AWS Management Console. | 09/24/2024 |
