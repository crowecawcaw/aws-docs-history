...
- [Logging AWS SNS API calls using AWS CloudTrail](logging-using-cloudtrail.md "logging-using-cloudtrail.md"). This logging enables you to track the actions performed on your Amazon SNS topics,
...
- [Monitoring Amazon SNS topics using CloudWatch](sns-monitoring-using-cloudwatch.md "sns-monitoring-using-cloudwatch.md"). CloudWatch provides metrics that
