...
This topic guides you through managing your SMS sandbox and configuring IAM and
resource-based policies to grant Amazon SNS the necessary permissions for accessing and utilizing
the AWS End User Messaging SMS APIs.
...
- [AmazonSNSFullAccess](security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonSNSFullAccess "security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonSNSFullAccess")
- [AmazonSNSReadOnly](security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonSNSReadOnlyAccess "security-iam-awsmanpol.md#security-iam-awsmanpol-AmazonSNSReadOnlyAccess")
