...
with subscribers by sending messages to a _topic_, which is
...
- The [Amazon SNS console](https://console.aws.amazon.com/sns/v3/home "https://console.aws.amazon.com/sns/v3/home")
...
- The AWS Command Line Interface (AWS CLI) gives you direct access to the Amazon SNS API for advanced
  configuration and automation use cases. For more information, see [Using Amazon SNS with the
  AWS CLI](../../../cli/latest/userguide/cli-services-sns.md "../../../cli/latest/userguide/cli-services-sns.md").
- AWS provides SDKs in various languages. For more information,
  see [SDKs and
...
The _Fanout_ scenario is when a message published
...
![A fanout scenario in Amazon SNS, where a single message from a publisher is sent to an Amazon SNS topic and then replicated to multiple endpoints, such as Amazon SQS queues. Each Amazon SQS queue forwards the message to an Amazon EC2 instance—one handling order processing and another performing data analysis, demonstrating parallel, asynchronous message delivery for event-driven applications.](images/sns-fanout.png)
...
metric threshold breached in Amazon CloudWatch. For more information, see [Setting up Amazon SNS notifications](../../../AmazonCloudWatch/latest/monitoring/US_SetupSNS.md "../../../AmazonCloudWatch/latest/monitoring/US_SetupSNS.md") in
...
for free with the Amazon SNS free tier. For information, see [Worldwide SMS Pricing](https://aws.amazon.com/sns/sms-pricing/ "https://aws.amazon.com/sns/sms-pricing/").
