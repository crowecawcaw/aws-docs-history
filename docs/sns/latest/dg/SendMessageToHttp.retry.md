...
retries with a delay between failed attempts set at 20 seconds. As discussed in [Step 1](SendMessageToHttp.prepare.md "SendMessageToHttp.prepare.md"), your endpoint should have code that can
