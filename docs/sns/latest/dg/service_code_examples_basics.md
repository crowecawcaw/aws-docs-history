...
# Basic examples for Amazon SNS using AWS SDKs
<a name="service_code_examples_basics"></a>

The following code examples show how to use the basics of Amazon Simple Notification Service with AWS SDKs. 
