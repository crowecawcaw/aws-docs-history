...
For information on managing and maintaining FCM v1 device tokens, see [Amazon SNS management of Firebase Cloud Messaging endpoints](sns-fcm-endpoint-management.md "sns-fcm-endpoint-management.md").
