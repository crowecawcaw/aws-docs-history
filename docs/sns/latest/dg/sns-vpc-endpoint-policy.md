...
You can create a policy for Amazon VPC endpoints for Amazon SNS in which you specify the
following:
...
- The resources on which actions can be performed.
  ...
  Access to Services with VPC Endpoints](../../../vpc/latest/userguide/vpc-endpoints-access.md "../../../vpc/latest/userguide/vpc-endpoints-access.md") in the
...
- Other Amazon SNS API actions, such as `sns:Subscribe` and
  `sns:Unsubscribe`.
...
The IAM user can still use other Amazon SNS API actions from _outside_ the VPC.
