...
this feature, see [Amazon SNS message archiving and replay for FIFO topics](fifo-message-archiving-replay.md "fifo-message-archiving-replay.md").
...
| Message replay    | Replay for standard topics is not a built in feature. Many customers<br>build their own based on their message archive. | [Amazon SNS message replay for FIFO topic subscribers](message-archiving-and-replay-subscriber.md "message-archiving-and-replay-subscriber.md") |
