...
4.  On the **fork-event-replay-pipeline** page, do the
    following:
         ...
         **ReplayQueueRetentionPeriodInSeconds**, enter the
         ...
         used.
        4. For **TopicArn**, enter the ARN of the Amazon SNS topic to
         which this instance of the fork pipeline is to be subscribed.
        5. For **DestinationQueueName**, enter the name of the
         Amazon SQS queue to which the Lambda replay function forwards messages.
        6. (Optional) For **SubscriptionFilterPolicy**, enter
         ...
         (all events are buffered for replay).
        7. Choose **I acknowledge that this app creates custom IAM roles,
