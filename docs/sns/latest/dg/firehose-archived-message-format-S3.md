...
The following example shows three SNS messages sent through an delivery stream
to the same Amazon S3 bucket. Buffering is applied, and line breaks separate each message.
