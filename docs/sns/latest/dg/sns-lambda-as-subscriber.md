...
Amazon SNS notifications. When a message is published to an Amazon SNS topic that has a Lambda function
...
information in the message, publish the message to other Amazon SNS topics, or send the message to
other AWS services.
