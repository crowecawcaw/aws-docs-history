...
## What is API Gateway?
<a name="apigw_what-is-api-gateway"></a>
...
1. The call matches the API `GET` method and `users` resource, which is integrated with get-users Lambda function.

1. Permissions are verified before invoking the AWS resource.

1. Lambda function sends queries to retrieve items from a Users Table data store.

1. Data is wrapped in an HTTP response to be returned to the client.

### Create an API
<a name="apigw_create-an-api"></a>
...
### Invoke your API
<a name="apigw_invoke-your-api"></a>
...
**Related resource(s):**
+ [cURL home page](https://curl.se/) - Learn how to invoke APIs with cURL
+ [Postman home page](https://www.postman.com/) - Learn how to invoke APIs with the Postman application

### Protect your API
<a name="apigw_protect-your-api-"></a>
...
+ [API Security Whitepaper](https://docs.aws.amazon.com/whitepapers/latest/security-overview-amazon-api-gateway/security-design-principles.html) - Learn about AWS best practices for API Gateway security

More resources related to access control:
+ [How to set up cross-origin resource sharing (CORS)](https://docs.aws.amazon.com/apigateway/latest/developerguide/how-to-cors.html)
+ [Mutual TLS in REST API](https://docs.aws.amazon.com/apigateway/latest/developerguide/rest-api-mutual-tls.html)
+ [Control access with AWS WAF](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-control-access-aws-waf.html)

## Advanced Topics
<a name="apigw_advanced-topics-"></a>
...
<a name="apigw_choose-between-rest-and-http-apis"></a>
...
**Related resource(s):**
+ [Choosing between REST APIs and HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-vs-rest.html) - detailed comparison between REST and HTTP APIs

### Non-proxy integrations and data transformations (REST API only)
<a name="apigw_nonproxy-integrations-and-data-transformations-rest-api-only"></a>
...
**Related resource(s):**
+ [Tutorial: Build a Hello World REST API with Lambda proxy integration](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-create-api-as-simple-proxy-for-lambda.html) (proxy example)
+ [Using API Gateway as a proxy for DynamoDB](https://aws.amazon.com/blogs/compute/using-amazon-api-gateway-as-a-proxy-for-dynamodb/) (custom non-proxy integration example)
+ [Best practices for working with Apache Velocity Template Language (VTL)](https://aws.amazon.com/blogs/compute/best-practices-for-working-with-the-apache-velocity-template-language-in-amazon-api-gateway/) (custom non-proxy integration example)

### Optimize your API with caching (REST API only)
<a name="apigw_optimize-your-api-on-caching-rest-api-only"></a>
...
**Related resource(s):**
+ [Enabling API caching to enhance responsiveness](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-caching.html) - Learn how to enable caching for your REST APIs. 

### Send binary media types
<a name="apigw_send-binary-media-types"></a>
...
**Related resource(s):**
+ [Return binary media from a Lambda proxy integration](https://docs.aws.amazon.com/apigateway/latest/developerguide/lambda-proxy-binary-media.html) - Learn how to use a Lambda function to return binary media. This works for both REST and HTTP APIs.
+ [Working with binary media types for REST APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-payload-encodings.html) - Additional considerations for REST non-proxy integrations 

### Greedy path variables
<a name="apigw_greedy-path-variables"></a>
...
**Related resource(s):**
+ [Use a proxy resource to streamline API setup](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-method-settings-method-request.html#api-gateway-proxy-resource) – Set up a proxy resource and greedy path variable for REST APIs.
+ [Working with routes for HTTP APIs](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-develop-routes.html) – Set up a greedy path variable for HTTP APIs

### WebSocket APIs
<a name="apigw_websocket-apis"></a>
...
**Related resource(s):**
+ [About WebSocket APIs in API Gateway](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-overview.html) - Get started with WebSocket APIs
+ [Tutorial: Building a serverless chat app with a WebSocket API, Lambda, and DynamoDB](https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-chat-app.html) - Intermediate level WebSocket API tutorial using CloudFormation

### OpenAPI
<a name="apigw_openapi-"></a>
...
**Related resource(s):**
+ [OpenAPI FAQ](https://www.openapis.org/faq) - Introduction and FAQ for the OpenAPI Specification 
+ [Working with API Gateway extensions to OpenAPI](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-swagger-extensions.html) - Learn how to use API Gateway extensions to the OpenAPI specification 

## Additional resources
<a name="apigw_additional-resources"></a>

 Official AWS documentation:
+ [API Gateway Developer Guide](https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html) - extensive and complete documentation for Amazon API Gateway 
+ [REST API tutorial](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-create-api-as-simple-proxy-for-http.html) - REST API tutorial
+ [HTTP API tutorial](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-dynamo-db.html) - HTTP API tutorial

 Resources from the serverless community:
+ [Building Happy Little APIs \| I Didn’t Know Amazon API Gateway Did That](https://www.youtube.com/watch?v=10t2H9aT5Kc) - AWS video series introducing to API Gateway

## Next Steps
<a name="apigw_next-steps"></a>
