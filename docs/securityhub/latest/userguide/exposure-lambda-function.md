...
- [Impact traits for Lambda functions](exposure-lambda-function.md#lambda-impact "exposure-lambda-function.md#lambda-impact")
  ...
  - [Has full control privileged executor path](exposure-lambda-function.md#has-full-control-privileged-executor-path "exposure-lambda-function.md#has-full-control-privileged-executor-path")
  - [Has direct policy escalation path](exposure-lambda-function.md#has-direct-policy-escalation-path "exposure-lambda-function.md#has-direct-policy-escalation-path")
  - [Has trust policy hijack path](exposure-lambda-function.md#has-trust-policy-hijack-path "exposure-lambda-function.md#has-trust-policy-hijack-path")
  - [Has data ransomware path](exposure-lambda-function.md#has-data-ransomware-path "exposure-lambda-function.md#has-data-ransomware-path")
  - [Has remove restriction path](exposure-lambda-function.md#has-remove-restriction-path "exposure-lambda-function.md#has-remove-restriction-path")
  - [Has pass role create executor path](exposure-lambda-function.md#has-pass-role-create-executor-path "exposure-lambda-function.md#has-pass-role-create-executor-path")
  - [Has swap role existing executor path](exposure-lambda-function.md#has-swap-role-existing-executor-path "exposure-lambda-function.md#has-swap-role-existing-executor-path")
  - [Has role chain escalation path](exposure-lambda-function.md#has-role-chain-escalation-path "exposure-lambda-function.md#has-role-chain-escalation-path")
  - [Has inject code privileged executor path](exposure-lambda-function.md#has-inject-code-privileged-executor-path "exposure-lambda-function.md#has-inject-code-privileged-executor-path")
  - [Has disable audit trail path](exposure-lambda-function.md#has-disable-audit-trail-path "exposure-lambda-function.md#has-disable-audit-trail-path")
  - [Has access existing executor path](exposure-lambda-function.md#has-access-existing-executor-path "exposure-lambda-function.md#has-access-existing-executor-path")
  - [Has credential minting path](exposure-lambda-function.md#has-credential-minting-path "exposure-lambda-function.md#has-credential-minting-path")
  - [Has pass role data access path](exposure-lambda-function.md#has-pass-role-data-access-path "exposure-lambda-function.md#has-pass-role-data-access-path")
  - [Has pass role task hijack path](exposure-lambda-function.md#has-pass-role-task-hijack-path "exposure-lambda-function.md#has-pass-role-task-hijack-path")
  - [Has single hop data access path](exposure-lambda-function.md#has-single-hop-data-access-path "exposure-lambda-function.md#has-single-hop-data-access-path")
  - [Has capability advancing path](exposure-lambda-function.md#has-capability-advancing-path "exposure-lambda-function.md#has-capability-advancing-path")
