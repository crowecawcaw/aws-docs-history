...
As a managed service, AWS Security Hub CSPM is protected by AWS global network security. For
...
You use AWS published API calls to access Security Hub CSPM through the network. Clients must
