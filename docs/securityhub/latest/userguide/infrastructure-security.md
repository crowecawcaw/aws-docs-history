...
As a managed service, AWS Security Hub is protected by AWS global network security. For
...
You use AWS published API calls to access Security Hub through the network. Clients must
