...
| PCI DSS v3.2.1 | PCI.EC2.1 EBS snapshots should not be publicly restorable                                                                           | [[EC2.1] Amazon EBS snapshots should not be publicly restorable](ec2-controls.md#ec2-1 "ec2-controls.md#ec2-1")                                                                                                             |
