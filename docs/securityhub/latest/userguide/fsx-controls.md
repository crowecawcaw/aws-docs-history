...
types to include in the evaluation.
...
You can't change the deployment type for an existing Amazon FSx for NetApp ONTAP file system. However, you can back up the data, and then restore it
on a new file system that uses a Multi-AZ deployment type.
...
**AWS Config rule:**
[fsx-windows-deployment-type-check](../../../config/latest/developerguide/fsx-windows-deployment-type-check.md "../../../config/latest/developerguide/fsx-windows-deployment-type-check.md")
