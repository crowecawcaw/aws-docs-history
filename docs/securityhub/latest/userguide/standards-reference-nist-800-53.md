...
| Amazon Bedrock AgentCore                               | `AWS::BedrockAgentCore::Gateway`,<br>`AWS::BedrockAgentCore::Memory`                                                                                                                                                                                                                                        |
...
| Amazon SageMaker AI                                    | `AWS::SageMaker::FeatureGroup`,<br>`AWS::SageMaker::NotebookInstance`                                                                                                                                                                                                                                       |
...
requirements that a control supports, choose the control. Then refer to the **Related requirements** field in the details for the control.
This field specifies each NIST requirement that the control supports. If the field
doesn't specify a particular NIST requirement, the control doesn't support the
requirement.
