...
Changes to cross-Region aggregation are not implemented for an opt-in Region until you enable the Region in your AWS account. Regions that AWS introduced on or after March 20, 2019 are opt-in Regions.
...
1. Enable cross-Region aggregation. For instructions, see [Enabling cross-Region aggregation](sh-finding-aggregation-enable.md).
