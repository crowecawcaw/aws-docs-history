...
**Topics**
+ [Required AWS Config resources for control findings](controls-config-resources.md)
...
+ [Evaluating compliance status and control status](controls-overall-status.md)
+ [Calculating security scores](standards-security-score.md)