...
Any findings that existed in a Region at the time that it becomes a linked Region are not replicated to the home Region unless there is an update to the finding. After a Region is linked to a home Region, there is a difference in findings between the home Region and the linked Region until findings in the linked Region are updated or they age out.
