...
The AI inventory in AWS Security Hub provides a unified view of your artificial intelligence (AI) and machine learning (ML) resources across your AWS environment.
Use the AI inventory to identify unsanctioned AI workloads, understand where AI is running and how it was discovered, and prioritize the resources that require closer security review.
Security Hub organizes AI resources into two discovery types:
...
You can retrieve AI inventory data programmatically with the [GetResourcesV2](../../1.0/APIReference/API_GetResourcesV2.md "../../1.0/APIReference/API_GetResourcesV2.md") and [GetResourcesStatisticsV2](../../1.0/APIReference/API_GetResourcesStatisticsV2.md "../../1.0/APIReference/API_GetResourcesStatisticsV2.md") operations.
