...
about these differences, see [Impact of consolidation on ASFF fields and values](asff-changes-consolidation.md "asff-changes-consolidation.md"). For sample control findings, see [Samples of control findings](sample-control-findings.md "sample-control-findings.md").
