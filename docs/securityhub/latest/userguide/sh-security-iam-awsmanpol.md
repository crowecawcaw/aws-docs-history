...
- `config` – Manage service-linked configuration recorders and
  third-party service-linked configuration recorders for
  Security Hub resources, including support for global Config recorders. List
