...
- [Misconfiguration traits for Azure Container apps](exposure-azure-container-app.md#azure-aca-misconfiguration "exposure-azure-container-app.md#azure-aca-misconfiguration")
...
- [Reachability traits for Azure Container apps](exposure-azure-container-app.md#azure-aca-reachability "exposure-azure-container-app.md#azure-aca-reachability")
...
Following standard security principles, store sensitive values as secrets and reference them rather than embedding them in plaintext.
...
Following standard security principles, grant the identity only the permissions the workload needs, at the narrowest scope.
...
Following standard security principles, disable external ingress where it is not required, use an internal environment, or place the app behind a controlled, authenticated ingress point.
