...
object. To view descriptions of `CodeRepository` attributes, see [CodeRepositoryDetails](../../1.0/APIReference/API_CodeRepositoryDetails.md "../../1.0/APIReference/API_CodeRepositoryDetails.md") in the _AWS Security Hub CSPM API Reference_. For
