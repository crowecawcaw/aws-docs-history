...
On the Security Hub CSPM console, a control doesn't appear in the list of controls if it isn't available in the Region that you're currently signed in to. The
exception is an aggregation Region. If you set an aggregation Region and sign in to that Region, the console shows controls that are available
in the aggregation Region or one or more linked Regions.

###### AWS Regions

- [US East (N. Virginia)](#securityhub-control-support-useast1 "#securityhub-control-support-useast1")
- [US East (Ohio)](#securityhub-control-support-useast2 "#securityhub-control-support-useast2")
- [US West (N. California)](#securityhub-control-support-uswest1 "#securityhub-control-support-uswest1")
- [US West (Oregon)](#securityhub-control-support-uswest2 "#securityhub-control-support-uswest2")
- [Africa (Cape Town)](#securityhub-control-support-afsouth1 "#securityhub-control-support-afsouth1")
- [Asia Pacific (Hong Kong)](#securityhub-control-support-apeast1 "#securityhub-control-support-apeast1")
- [Asia Pacific (Hyderabad)](#securityhub-control-support-apsouth2 "#securityhub-control-support-apsouth2")
- [Asia Pacific (Jakarta)](#securityhub-control-support-apsoutheast3 "#securityhub-control-support-apsoutheast3")
- [Asia Pacific (Malaysia)](#securityhub-control-support-apsoutheast5 "#securityhub-control-support-apsoutheast5")
- [Asia Pacific (Melbourne)](#securityhub-control-support-apsoutheast4 "#securityhub-control-support-apsoutheast4")
- [Asia Pacific (Mumbai)](#securityhub-control-support-apsouth1 "#securityhub-control-support-apsouth1")
- [Asia Pacific (New Zealand)](#securityhub-control-support-apsoutheast6 "#securityhub-control-support-apsoutheast6")
- [Asia Pacific (Osaka)](#securityhub-control-support-apnortheast3 "#securityhub-control-support-apnortheast3")
- [Asia Pacific (Seoul)](#securityhub-control-support-apnortheast2 "#securityhub-control-support-apnortheast2")
- [Asia Pacific (Singapore)](#securityhub-control-support-apsoutheast1 "#securityhub-control-support-apsoutheast1")
- [Asia Pacific (Sydney)](#securityhub-control-support-apsoutheast2 "#securityhub-control-support-apsoutheast2")
- [Asia Pacific (Taipei)](#securityhub-control-support-apeast2 "#securityhub-control-support-apeast2")
- [Asia Pacific (Thailand)](#securityhub-control-support-apsoutheast7 "#securityhub-control-support-apsoutheast7")
- [Asia Pacific (Tokyo)](#securityhub-control-support-apnortheast1 "#securityhub-control-support-apnortheast1")
- [Canada (Central)](#securityhub-control-support-cacentral1 "#securityhub-control-support-cacentral1")
- [Canada West (Calgary)](#securityhub-control-support-cawest1 "#securityhub-control-support-cawest1")
- [China (Beijing)](#securityhub-control-support-cnnorth1 "#securityhub-control-support-cnnorth1")
- [China (Ningxia)](#securityhub-control-support-cnnorthwest1 "#securityhub-control-support-cnnorthwest1")
- [Europe (Frankfurt)](#securityhub-control-support-eucentral1 "#securityhub-control-support-eucentral1")
- [Europe (Ireland)](#securityhub-control-support-euwest1 "#securityhub-control-support-euwest1")
- [Europe (London)](#securityhub-control-support-euwest2 "#securityhub-control-support-euwest2")
- [Europe (Milan)](#securityhub-control-support-eusouth1 "#securityhub-control-support-eusouth1")
- [Europe (Paris)](#securityhub-control-support-euwest3 "#securityhub-control-support-euwest3")
- [Europe (Spain)](#securityhub-control-support-eusouth2 "#securityhub-control-support-eusouth2")
- [Europe (Stockholm)](#securityhub-control-support-eunorth1 "#securityhub-control-support-eunorth1")
- [Europe (Zurich)](#securityhub-control-support-eucentral2 "#securityhub-control-support-eucentral2")
- [Israel (Tel Aviv)](#securityhub-control-support-ilcentral1 "#securityhub-control-support-ilcentral1")
- [Mexico (Central)](#securityhub-control-support-mxcentral1 "#securityhub-control-support-mxcentral1")
- [Middle East (Bahrain)](#securityhub-control-support-mesouth1 "#securityhub-control-support-mesouth1")
- [Middle East (UAE)](#securityhub-control-support-mecentral1 "#securityhub-control-support-mecentral1")
- [South America (São Paulo)](#securityhub-control-support-saeast1 "#securityhub-control-support-saeast1")
- [AWS GovCloud (US-East)](#securityhub-control-support-usgoveast1 "#securityhub-control-support-usgoveast1")
- [AWS GovCloud (US-West)](#securityhub-control-support-usgovwest1 "#securityhub-control-support-usgovwest1")
...
- [[RDS.37] Aurora PostgreSQL DB clusters should publish logs to CloudWatch Logs](rds-controls.md#rds-37 "rds-controls.md#rds-37")
- [[RDS.38] RDS for PostgreSQL DB instances should be encrypted in transit](rds-controls.md#rds-38 "rds-controls.md#rds-38")
- [[RDS.39] RDS for MySQL DB instances should be encrypted in transit](rds-controls.md#rds-39 "rds-controls.md#rds-39")
...
- [[S3.10] S3 general purpose buckets with versioning enabled should have Lifecycle configurations](s3-controls.md#s3-10 "s3-controls.md#s3-10")
- [[S3.11] S3 general purpose buckets should have event notifications enabled](s3-controls.md#s3-11 "s3-controls.md#s3-11")
