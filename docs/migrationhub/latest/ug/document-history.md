...
| --- |--- |--- |
| [Migration Hub now makes it possible to automate migration tasks.](#document-history) | To learn about this new feature, see [AWS Migration Hub Automation](https://docs.aws.amazon.com/migrationhub/latest/ug/mha.html). | December 3, 2024 | 
