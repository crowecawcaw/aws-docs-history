...
- [Message that you need to install Discovery Agent](#troubleshooting-problem-need-agent "#troubleshooting-problem-need-agent")
- [Problems when adding servers or expanding diagram](#troubleshooting-problem-expand-diagram "#troubleshooting-problem-expand-diagram")
