...
- **Security in the cloud** – Your responsibility
  ...
  when using Migration Hub. The following topics show you how to configure Migration Hub to
  meet your security and compliance objectives. You'll also learn how to use other AWS
  services that can help you to monitor and secure your Migration Hub resources.

###### Topics

- [Identity and access management in AWS Migration Hub](auth-and-access-control.md "auth-and-access-control.md")
- [Logging and monitoring in AWS Migration Hub](logging-monitoring.md "logging-monitoring.md")
