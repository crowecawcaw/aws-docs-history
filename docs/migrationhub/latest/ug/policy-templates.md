...
**Topics**
+ [New user IAM setup for AWS Migration Hub](new-customer-setup.md)
+ [Custom Policies for Migration Tools when using AWS Migration Hub](customer-managed-vendor.md)