...
<a name="generating-ec2-recommendations"></a>
...
| --- | --- | 
| EC2InstanceRecommendations-{type}-{date}.csv | Details of each server’s recommended Amazon EC2 instance type and cost. For more information, see [Understanding your Amazon EC2 recommendations in AWS Migration Hub](understanding-ec2-recommendations.md). | 
