...
**Topics**
+ [Choose an AWS Migration Hub home Region](select-home-region.md)
+ [Changing your AWS Migration Hub home Region](change-home-region.md)
+ [Discovery with AWS Migration Hub requires the home Region](home-region-with-discovery.md)
+ [Migration progress is stored in the AWS Migration Hub home Region](migration-reporting.md)
+ [Working with the AWS Migration Hub home Region APIs](#using-migration-hub-apis)

## Working with the AWS Migration Hub home Region APIs
<a name="using-migration-hub-apis"></a>
