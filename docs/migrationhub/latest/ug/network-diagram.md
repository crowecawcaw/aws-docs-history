...
**Topics**
+ [Prerequisites for using the network diagram in AWS Migration Hub](network-diagram-prerequisites.md)
+ [How to use the network diagram in AWS Migration Hub](network-diagram-how-to.md)
+ [Troubleshooting the AWS Migration Hub network diagram](network-diagram-troubleshooting.md)