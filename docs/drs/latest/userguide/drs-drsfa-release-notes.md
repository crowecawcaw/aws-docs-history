...
| 3.1.0          | • Fixed issue with failback where VMWare VMs would not eject ISOs via cdrom.<br>• Fixed issue with failback when a VMWare VM had an ISO alredy mounted via cdrom. | 20 August 2022   |
