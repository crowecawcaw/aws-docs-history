...
- [Verifying TCP port 443](#comm-443-diagnose "#comm-443-diagnose")
- [Verifying TCP port 1500](#comm-1500-verify "#comm-1500-verify")
- [Resolving port 1500 issues](#comm-1500-resolve "#comm-1500-resolve")
- [Common network configuration issues](#comm-443-checklist "#comm-443-checklist")
...
endpoints](../../../general/latest/gr/drs.md#drs-region "../../../general/latest/gr/drs.md#drs-region").
...
3. Choose **Network ACLs** in the
   ...
   (1024–65535).
4. Choose **Security Groups** in the
...
3. Retrieve the security group IDs assigned to the replication
   servers:
...
4. Verify the outbound rules for the replication server security
   group:
...
2. In the navigation pane, choose **Network ACLs**.
   ...
   port 1500.
3. Verify that the outbound rules for the network ACL allow the
...
1. Check that the network ACL allows inbound TCP port 1500 and
...
ports 1024–65535. 2. Get the security group IDs for your replication servers:
...
3. Verify that the security group allows inbound TCP port
   1500:
...
4. Check the source server firewall rules. Do one of the
   following:
