...
![Source servers list showing hostname, recovery readiness, and data replication status.](images/drs-new-ss11-details.png)
...
![Source servers list with options to view details, edit settings, or initiate recovery job.](images/drs-new-ss11-details2.png)
...
![AWS Elastic Disaster Recovery server details showing recovery status and options for a specific server.](images/drs-new-ss12-details.png)
...
![Overview box showing server status: ready for recovery, no pending actions, successful last result.](images/drs-new-ss12-details-overview.png)
