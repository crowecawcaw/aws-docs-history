...
## Source servers page
<a name="drs-console-servers"></a>

The Source Servers page lists all of the source servers you added to AWS Elastic Disaster Recovery and allows you to interact with your servers and perform actions. [[Learn more about the Source servers page. ](server-list.md)](source-servers.md)
