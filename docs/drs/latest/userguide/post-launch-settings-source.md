...
These settings are created automatically based on the **Default post-launch actions**.
...
- Go to the **Post-launch settings** tab. If **Post launch action settings** has **Post launch actions** set to **Active**,
  click **Edit** for **Post launch action settings**.
...
Alternatively, you can activate and deactivate post-launch actions for multiple servers by navigating to the **Source servers** page, selecting the servers you want to update and clicking **Actions > Edit post-launch action settings**.
To activate, make sure the **Post-launch actions active** option is checked, and to deactivate, it should be unchecked.
If you made a change, click **Save**.
