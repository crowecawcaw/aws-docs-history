...
To view the policy permission details see [AWSElasticDisasterRecoveryFailbackPolicy](../../../aws-managed-policy/latest/reference/AWSElasticDisasterRecoveryFailbackPolicy.md "../../../aws-managed-policy/latest/reference/AWSElasticDisasterRecoveryFailbackPolicy.md") in the AWS Managed Policy Reference Guide.
