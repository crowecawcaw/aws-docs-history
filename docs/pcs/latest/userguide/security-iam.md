...
(have permissions) to use AWS PCS resources. IAM is an AWS service that you can
...
- [How AWS Parallel Computing Service works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
- [Identity-based policy examples for AWS Parallel Computing Service](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md")
- [AWS managed policies for AWS Parallel Computing Service](security-iam-awsmanpol.md "security-iam-awsmanpol.md")
...
- [Minimum permissions for AWS PCS](security-min-permissions.md "security-min-permissions.md")
- [IAM instance profiles for AWS Parallel Computing Service](security-instance-profiles.md "security-instance-profiles.md")
- [Troubleshooting AWS Parallel Computing Service identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS Parallel Computing Service identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
- **Service administrator** - determine user access and
  submit permission requests (see [How AWS Parallel Computing Service works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md"))
- **IAM administrator** - write policies to manage
  access (see [Identity-based policy examples for AWS Parallel Computing Service](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md"))
