...
**Notes**
+ The log paths in the sample file are for Amazon Linux 2023. If your instances will use a different base operating system, change the paths as appropriate.
