...
**Topics**
+ [Step 1 – Launch a temporary instance](working-with_ami_custom_launch-instance.md)
+ [Step 2 – Install the AWS PCS agent](working-with_ami_custom_install-agent.md)
+ [Step 3 – Install Slurm](working-with_ami_custom_install-slurm.md)
+ [Step 4 – (Optional) Install additional drivers, libraries, and application software](working-with_ami_custom_install-software.md)
