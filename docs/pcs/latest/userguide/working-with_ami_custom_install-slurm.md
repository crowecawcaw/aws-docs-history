...
`aws-pcs-slurm-25.11-installer-latest.tar.gz`). For a complete list of available versions with checksums, see [Slurm versions in AWS PCS](slurm-versions.md "slurm-versions.md").
