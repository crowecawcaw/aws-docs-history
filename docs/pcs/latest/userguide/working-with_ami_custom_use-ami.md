...
3. Choose the cluster where you will use the custom AMI, then select **Compute
   node groups**.
4. Create a new compute node group. For more information, see [Creating a compute node group in AWS PCS](working-with_cng_create.md "working-with_cng_create.md"). Under
