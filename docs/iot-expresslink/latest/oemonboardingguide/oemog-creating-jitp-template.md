...
![AWS IoT Core service console search results showing AWS IoT offerings.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss06.png)

1. In the left navigation pane, select **Connect many devices** then select **Provisioning templates** in the drop-down sub-menu.   
![AWS IoT console overview showing options to connect devices, and test device configurations.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss07.png)

1. On the provisioning templates management page, select **Create provisioning template**.   
![AWS IoT service connect many devices workflow with steps to create provisioning template.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss08.png)
...
![AWS IoT template for provisioning devices with unique certificates at initial connect.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss09.png)
...
![AWS IoT provisioning template configuration screen with options to set template status as active or inactive.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss10.png)
...
![Choose an IAM role and create new role button for provisioning AWS IoT access to resources.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss11.png)
...
![Create role dialog with role name field and instructions to enter unique role name without spaces.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss12.png)
...
![CA certificate configuration options to choose certificates to use, toggle automatic certificate registration.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss13.png)
...
![CA certificate selection interface showing a search bar and a pre-selected CA certificate ID.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss14.png)  
![CA certificate configuration page showing options to manage CA certificates.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss15.png)
...
1. Under **Set provisioning actions**, toggle on **Automatically create a thing resource when provisioning a device**. 
   ...
   Select **Next**.  
![AWS IoT console showing provisioning steps to automatically create a thing resource and additional configurations.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss16.png)
...
![Set device permissions screen with list of AWS IoT policies to authorize devices accessing resources like MQTT topics and Device Shadows.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss17.png)
...
![AWS IoT Core policy creation console with fields to enter policy details.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss18.png)
...
![Set device permissions page showing Policies section with a policy named "your_policy_name" selected.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss19.png)
...
![Set provisioning actions interface showing automatic thing creation options.](https://docs.aws.amazon.com/iot-expresslink/latest/oemonboardingguide/images/ss20.png)
