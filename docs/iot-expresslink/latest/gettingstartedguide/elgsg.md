...
Catalog](https://partners.amazonaws.com/qualified-devices "https://partners.amazonaws.com/qualified-devices").
...
[AWS IoT
ExpressLink Programmer's Guide](../programmersguide/elpg-provisioning.md "../programmersguide/elpg-provisioning.md") .

If you have questions or issues that are not answered here, please visit the
[AWS re:Post
for AWS IoT ExpressLink](https://repost.aws/tags/TADqOo0ODORl2pC69DWwUFug/aws-iot-expresslink "https://repost.aws/tags/TADqOo0ODORl2pC69DWwUFug/aws-iot-expresslink") page.

###### Topics

- [Set up your host machine](#elgsg-host-app-set-up "#elgsg-host-app-set-up")
- [AWS account set up and console login](elgsg-set-up.md "elgsg-set-up.md")
- [Register an AWS IoT ExpressLink module](elgsg-register-account.md "elgsg-register-account.md")
- [Connect and interact with AWS Cloud.](elgsg-interact-with-cloud.md "elgsg-interact-with-cloud.md")
- [Perform a firmware OTA update](elgsg-setup-ota-update.md "elgsg-setup-ota-update.md")
