...
<a name="elgsg-setup-ota-update-monitor"></a>
...
1. The ExpressLink module should now start downloading the firmware update from the cloud. You can monitor the state of the job using the 'AT\+OTA?' command.
