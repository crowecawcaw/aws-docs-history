...
- **Security in the cloud** – Your responsibility is
  ...
  to monitor and secure your CodeArtifact resources.

###### Topics

- [Data protection in AWS CodeArtifact](data-protection.md "data-protection.md")
- [Monitoring CodeArtifact](security-logging-and-monitoring.md "security-logging-and-monitoring.md")
- [Compliance validation for AWS CodeArtifact](codeartifact-compliance-validation.md "codeartifact-compliance-validation.md")
