...
| resources               | A list that contains the ARN of the package that changed. The list contains one entry. For information about package ARN format, see [Grant write access to packages](repo-policies.md#granting-write-access-to-specific-packages "repo-policies.md#granting-write-access-to-specific-packages").                                                 |
