...
AWS CodeArtifact only supports V3 of the NuGet HTTP protocol. This means that some CLI commands that rely on V2 of the protocol are not supported. See the [nuget.exe command support](#nuget-command-support) section for more information.
