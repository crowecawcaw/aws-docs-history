...
Before you use IAM to manage access to CodeArtifact, learn what IAM features are
available to use with CodeArtifact.

| IAM features you can use with AWS CodeArtifact                                                                                                                              | IAM feature | CodeArtifact support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------- |
...
To get a high-level view of how CodeArtifact and other AWS services work with most IAM
...
To see a list of CodeArtifact actions, see [Actions defined by AWS CodeArtifact](../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-actions-as-permissions "../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-actions-as-permissions") in the
...
To see a list of CodeArtifact resource types and their ARNs, see
[Resources defined by AWS CodeArtifact](../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
- [Referer](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-referer "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-referer")
- [UserAgent](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-useragent "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-useragent")

To see a list of CodeArtifact condition keys, see [Condition keys for AWS CodeArtifact](../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-policy-keys "../../../service-authorization/latest/reference/list_awscodeartifact.md#awscodeartifact-policy-keys") in the
...
1. `GetAuthorizationToken` requires `sts:GetServiceBearerToken`
   along with `codeartifact:GetAuthorizationToken`.
2. `CreateDomain`, when providing a non-default encryption key, requires both `kms:DescribeKey` and
