...
tagging CodeArtifact resources, see [Tagging resources](tag-resources.md "tag-resources.md"). This topic discusses tag-based access
control.
...
support tagging. In CodeArtifact, resources can have tags, and some actions can include
tags. When you create an IAM policy, you can use tag condition keys to
control:

- Which users can perform actions on a domain or repository resource, based on tags that
  it already has.
...
information about, repositories and packages in CodeArtifact.
...
The following policy grants users permission to create repositories
in specified domains in CodeArtifact.
