...
repositories. For more information, see [Add or remove upstream repositories (AWS CLI)](repo-upstream-add.md#repo-upstream-add-cli "repo-upstream-add.md#repo-upstream-add-cli").
...
![Simple upstream repository diagram showing my_repo with 3 upstream repositories.](images/upstream-diagram-simple.png)
...
![A more complex upstream repository diagram with 2 upstream repositories A and B and additional upstream repositories.](images/upstream-diagram-complex.png)
