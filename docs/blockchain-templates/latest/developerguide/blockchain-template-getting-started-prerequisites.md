...
![AWS IAM interface showing a role named EC2RoleforEther with associated description and trusted entity.](images/ec2-select-role.png) 11. Copy the **Instance Profile ARN** value and save it so you can copy it
again. You need this ARN when you create the Ethereum network.

![AWS IAM role summary page showing Role ARN and Instance Profile ARNs fields.](images/ec2-role-arn.png)
