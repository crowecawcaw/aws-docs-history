...
- You, as a freelancer or working for a company, must be based in an [eligible jurisdiction](../../../marketplace/latest/userguide/user-guide-for-sellers.md#eligible-jurisdictions "../../../marketplace/latest/userguide/user-guide-for-sellers.md#eligible-jurisdictions") supported by AWS Marketplace and have valid tax and U.S. banking
  information. If you don't have a U.S. bank account, you might be able to obtain one
  through Hyperwallet. For more information about Hyperwallet, see [Seller registration process](../../../marketplace/latest/userguide/seller-registration-process.md "../../../marketplace/latest/userguide/seller-registration-process.md") in the _AWS Marketplace Seller
  Guide_.
...
For an overview of working as an AWS IQ expert, see [AWS IQ for Experts](https://aws.amazon.com/iq/experts "https://aws.amazon.com/iq/experts").
...
As of May 20, 2025, AWS IQ is no longer accepting new expert registrations. For more information, see [AWS IQ end of support](aws-iq-end-of-support.md "aws-iq-end-of-support.md").
...
payment information. For more information about how to set up payments, see [Set up payments in AWS IQ](set-up-payments.md "set-up-payments.md").

![Set up payments section of Expert signup with the Go to AWS Marketplace button.](images/aws-iq-experts-set-up-payments.png) 4. After Steps 2 and 3 are complete, AWS IQ will contact you with the next steps for
