...
**Topics**
+ [Using asset sync with AWS IoT SiteWise](tm-sw-asset-sync-use.md)
+ [Differences between custom and default workspaces](tm-sw-default-ws-diffs.md)
+ [Resources synced from AWS IoT SiteWise](tm-sw-asset-sync-map.md)
