...
As a managed service, AWS IoT TwinMaker is protected by the AWS global network security
...
You use AWS published API calls to access AWS IoT TwinMaker through the network. Clients must
