...
![Example visual rules with temperature based expressions that activate error, warning, and info icons.](https://docs.aws.amazon.com/iot-twinmaker/latest/guide/images/scene-topic-temp-sample-rule.png)
...
![The "Rules" tab with the New Rule Map name entered above the "Add New Rule Group" button.](https://docs.aws.amazon.com/iot-twinmaker/latest/guide/images/scenes-new-vis-rule-create.png)
