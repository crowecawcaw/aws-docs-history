...
1. Press the **\+** button, and from the drop down options select one of the options. This could be a model, a light, a tag, or anything from the **\+** menu.
...
1. If you have no models in your scene, make sure to add one by selecting the option from the **\+** menu.
...
1. To add tags, lights, rules, or other properties to submodels, press the **\+**, while the submodel is selected in the hierarchy.
...
1. Once the element is selected, press the **\+** button, and from the drop down select one of the options:
   + **Add empty node**
   + **Add 3D model**
   + **Add light**
