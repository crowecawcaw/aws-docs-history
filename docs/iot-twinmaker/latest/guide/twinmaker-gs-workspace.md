...
![A banner with the recommended IAM policy and role names, and a button that lets you get the required JSON.](https://docs.aws.amazon.com/iot-twinmaker/latest/guide/images/DashboardPolicy.png)
