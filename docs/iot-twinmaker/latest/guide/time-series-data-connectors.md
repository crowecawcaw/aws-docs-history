...
**Topics**
+ [AWS IoT TwinMaker time-series data connector prerequisites](#time-series-data-connectors-prereqs)
+ [Time-series data connector background](#time-series-data-connectors-background)
+ [Developing a time-series data connector](#time-series-data-connectors-develop)
+ [Improving your data connector](#time-series-data-connectors-improve)
+ [Testing your connector](#time-series-data-connectors-test)
+ [Security](#time-series-data-connectors-security)
+ [Creating AWS IoT TwinMaker resources](#time-series-data-connectors-resources)
+ [What's next](#time-series-data-connectors-wn)
+ [AWS IoT TwinMaker cookie factory example time-series connector](time-series-data-connectors-example.md)
