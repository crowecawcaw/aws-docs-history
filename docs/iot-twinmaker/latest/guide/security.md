...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS IoT TwinMaker. The following topics show you how to configure AWS IoT TwinMaker to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS IoT TwinMaker resources.
