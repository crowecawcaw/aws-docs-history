...
1. Next, decide how you send location updates to your tracker resources. Use [AWS SDKs](dev-sdks.md) to integrate tracking capabilities into your mobile applications. Alternately, you can use MQTT by following step-by-step directions in [tracking using MQTT](tracking-using-mqtt.md).
...
1. You can then integrate monitoring using services such as Amazon CloudWatch and AWS CloudTrail. For more information see, [Monitor with Amazon CloudWatch](cloudwatch.md) and [Monitor and log with AWS CloudTrail](cloudtrail.md).
