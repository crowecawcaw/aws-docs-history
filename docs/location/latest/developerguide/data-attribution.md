...
+ For more information about the AWS requirements, see Section 82 of the [AWS Service Terms](https://aws.amazon.com/service-terms/).
+ For more information about the SLAs, see [Amazon Location SLA](https://aws.amazon.com/location/sla/).
...
+ [Esri's data source attributions](https://www.esri.com/en-us/legal/terms/data-attributions)
+ [GrabMaps' data source attributions](https://www.grab.com/sg/terms-policies/transport-delivery-logistics/)
+ [HERE's data source attributions](https://legal.here.com/en-gb/terms/general-content-supplier-terms-and-notices)
