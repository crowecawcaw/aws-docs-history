...
Before you use Amazon Location Service, be sure you can comply with all applicable legal
requirements, including license terms applicable to the use of the provider.
...
- HERE Technologies provides AWS customers access to base maps, geocoding,
  reverse geocoding, and street-level address data. Maps provided by HERE are
...
- GrabMaps provides AWS customers access to various styles of map tiles,
  ...
  Today, GrabMaps powers more than 800 billion searches, suggestions, trips and
...
- Esri provides AWS customers access to various styles of map tiles, geocoding
  ...
  Today, Esri’s technology is deployed in more than 350,000 organizations
...
- AWS provides customers access to global base maps built from the Daylight
  ...
  professionally designed to support different applications and use cases,
  including logistics and delivery, and data visualization in web and mobile
  environments. With a community of over a million map makers, OSM is an open data
...
their sources for attribution. In addition, by default, attribution is shown on the
bottom right corner of the map when using Amazon Location Service to render dynamic maps.
