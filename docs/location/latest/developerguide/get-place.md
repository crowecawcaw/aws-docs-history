...
**Note**  
If results are stored, they will be billed at the higher Storage pricing tier. Use the `IntendedUse` parameter to specify whether the results are for single use or storage. Refer to [Places pricing](places-pricing.md) for cost details associated with stored results.

For more information, see [GetPlace](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_GetPlace.html) in the *Amazon Location Service API Reference*.
...
<a name="get-place-request-parameters"></a>

**Note**  
 For customers in `ap-southeast-1` and `ap-southeast-5`, supported request and response fields may differ. Refer to the [GetPlace API Reference](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_GetPlace.html) for details. 
...
<a name="get-place-response-details"></a>
