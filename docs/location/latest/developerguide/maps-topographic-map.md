...
Use the `terrain` parameter in your API request to display regional topography with elevation shading. This feature highlights variations in elevation and geographic features, helping users better visualize the physical landscape. See [How to create topographic maps](how-to-create-topographic-maps.md "how-to-create-topographic-maps.md").

![](/images/location/latest/developerguide/images/map-topographic-terrain.gif)
...
![](/images/location/latest/developerguide/images/zoom-contours-low.gif)

Medium

![](/images/location/latest/developerguide/images/zoom-contours-medium.gif)

High

![](/images/location/latest/developerguide/images/zoom-contours-high.gif)
