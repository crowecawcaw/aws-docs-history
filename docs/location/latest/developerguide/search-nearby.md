...
For more information, see [SearchNearby](https://docs.aws.amazon.com/location/latest/APIReference/API_geoplaces_SearchNearby.html) in the *Amazon Location Service API Reference*.
...
<a name="search-nearby-request-parameters"></a>
...
<a name="search-nearby-response-details"></a>
