...
Use the `travel-modes` parameter in your API request to show transportation-specific routing data. See [how to show transit details on a map](how-to-show-transit-details-map.md "how-to-show-transit-details-map.md") and [how to create a logistics map](how-to-create-logistic-map.md "how-to-create-logistic-map.md").

![](/images/location/latest/developerguide/images/map-travel-modes-transit.gif)

![](/images/location/latest/developerguide/images/map-travel-modes-truck.gif)
