...
As a managed service, Amazon Location Service is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Location through the network. Clients must
