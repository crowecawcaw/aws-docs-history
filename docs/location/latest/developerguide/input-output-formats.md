...
For more information, see [How to prepare input data](preparing-input-data.md "preparing-input-data.md") and [How to retrieve results](retrieving-results.md "retrieving-results.md").
