...
**Note**  
 ...
 ![Diagram showing two QM brokers connected by a network connector, with queues and apps.](http://docs.aws.amazon.com/amazon-mq/latest/migration-guide/images/ibm-amazon-mq-architecture-fig-1.PNG) 
