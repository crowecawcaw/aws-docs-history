...
ActiveMQ](../developer-guide/amazon-mq-working-java-example.md "../developer-guide/amazon-mq-working-java-example.md") in the
_Amazon MQ Developer Guide_.

### Message persistence

To replicate _persistence mode_ or _sync point
control_ options with Amazon MQ, you can deploy your brokers as [active/standby brokers](../developer-guide/active-standby-broker-deployment.md "../developer-guide/active-standby-broker-deployment.md"). In the active/standby deployment, brokers use
shared storage across multiple Availability Zones, with an optional time to live
(TTL).

For more information about how Amazon MQ ensures message durability, see [Availability options](#high-availability "#high-availability").
...
access](../../../vpn/latest/s2svpn/VPC_VPN.md "../../../vpn/latest/s2svpn/VPC_VPN.md"), or [VPC access](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md") using
...
For network access across multiple VPCs, you can use [VPC peering](../../../vpc/latest/peering/what-is-vpc-peering.md "../../../vpc/latest/peering/what-is-vpc-peering.md").
...
To achieve high availability and message durability, you can use a [network of brokers](../developer-guide/network-of-brokers.md "../developer-guide/network-of-brokers.md"). A network of brokers is a series of simultaneously
...
Architecture](../developer-guide/amazon-mq-broker-architecture.md "../developer-guide/amazon-mq-broker-architecture.md") in the _Amazon MQ Developer Guide_.
...
the next maintenance window or reboot the broker. For more information, see [Amazon MQ Broker Configuration Lifecycle](../developer-guide/amazon-mq-broker-configuration-lifecycle.md "../developer-guide/amazon-mq-broker-configuration-lifecycle.md") in the
_Amazon MQ Developer Guide_.
...
resources remain active and online. To scale horizontally, you can deploy a [network of brokers](../developer-guide/network-of-brokers.md "../developer-guide/network-of-brokers.md") in an active/standby configuration across multiple
Availability Zones.
...
Types](../developer-guide/broker.md#broker-instance-types "../developer-guide/broker.md#broker-instance-types") in the _Amazon MQ Developer Guide_.
...
affect latency, see [Differences Between Storage Types](../developer-guide/broker-storage.md#differences-between-storage-types "../developer-guide/broker-storage.md#differences-between-storage-types") in the
_Amazon MQ Developer Guide_.
...
queues,
also known as ordered queues. You can scale FIFO queues using [Message Groups](https://activemq.apache.org/message-groups "https://activemq.apache.org/message-groups"). You can
configure your broker destinations with _at-least-once delivery_,
_at-most-once delivery_, or _exactly-once
delivery_ options.
...
Destinations](https://activemq.apache.org/virtual-destinations.html "https://activemq.apache.org/virtual-destinations.html"), where publishers broadcast messages to a pool of subscribers
...
information, see [Performance Tuning](https://activemq.apache.org/performance-tuning.html "https://activemq.apache.org/performance-tuning.html")
on
...
[Lightweight Directory Access Protocol (LDAP)](https://ldap.com/ "https://ldap.com/")
with your Amazon MQ brokers, see [Messaging Authentication and Authorization for ActiveMQ](../developer-guide/security-authentication-authorization.md "../developer-guide/security-authentication-authorization.md") in the
_Amazon MQ Developer Guide_.
...
[client-side
encryption](../../../encryption-sdk/latest/developer-guide/introduction.md "../../../encryption-sdk/latest/developer-guide/introduction.md").
...
_pooled connections_. For more information, see [Always Use Connection Pooling](../developer-guide/connecting-to-amazon-mq.md#always-use-connection-pooling "../developer-guide/connecting-to-amazon-mq.md#always-use-connection-pooling") in the
_Amazon MQ Developer Guide_.

You can request an increase for many [broker
usage quotas](../developer-guide/amazon-mq-limits.md#broker-limits "../developer-guide/amazon-mq-limits.md#broker-limits") for your AWS account. For more information, see [AWS service
...
For more information, see [Amazon MQ Broker Configuration Parameters](../developer-guide/amazon-mq-broker-configuration-parameters.md "../developer-guide/amazon-mq-broker-configuration-parameters.md") in the
_Amazon MQ Developer Guide_.
...
To estimate your broker costs for Amazon MQ, you can us the [AWS Pricing Calculator](https://calculator.aws/#/ "https://calculator.aws/#/").
