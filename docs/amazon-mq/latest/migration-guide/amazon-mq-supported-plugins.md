...
<a name="amazon-mq-supported-plugins"></a>

 A plugin in Amazon MQ is a software module that adds a specific feature to a broker. Amazon MQ for ActiveMQ managed brokers support the following plugins: 
