...
| CPU%         | 44%                 | 87%  | 89%  | ## `mq.m5.large` Configuration options: <br>• **Broker Instance -** `mq.m5.large` <br>• **Persistent -** `TRUE` <br>• **Client -** `m5.xlarge` <br>• **CSAD -** `TRUE` <br>• **Protocol -** Openwire     |     | Producers/Consumers |
| ---          | ---                 |
| Message size | Metrics             | 25   | 50   | 100                                                                                                                                                                                                      |
...
| CPU%         | 40%                 | 53%  | 86%  | ## `mq.m5.xlarge` Configuration options: <br>• **Broker Instance -** `mq.m5.xlarge` <br>• **Persistent -** `TRUE` <br>• **Client -** `m5.xlarge` <br>• **CSAD -** `TRUE` <br>• **Protocol -** Openwire   |     | Producers/Consumers |
| ---          | ---                 |
| Message size | Metrics             | 25   | 50   | 100                                                                                                                                                                                                      |
...
| CPU%         | 36%                 | 61%  | 89%  | ## `mq.m5.2xlarge` Configuration options: <br>• **Broker Instance -** `mq.m5.2xlarge` <br>• **Persistent -** `TRUE` <br>• **Client -** `m5.xlarge` <br>• **CSAD -** `TRUE` <br>• **Protocol -** Openwire |     | Producers/Consumers |
| ---          | ---                 |
| Message size | Metrics             | 25   | 50   | 100                                                                                                                                                                                                      |
...
| CPU%         | 18%                 | 36%  | 67%  | ## `mq.m5.4xlarge` Configuration options: <br>• **Broker Instance -** `mq.m5.4xlarge` <br>• **Persistent -** `TRUE` <br>• **Client -** `m5.xlarge` <br>• **CSAD -** `TRUE` <br>• **Protocol -** Openwire |     | Producers/Consumers |
| ---          | ---                 |
| Message size | Metrics             | 25   | 50   | 100                                                                                                                                                                                                      |
