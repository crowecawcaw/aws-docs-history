...
![Amazon MQ navigation panel showing Brokers and Configurations options.](images/amazon-mq-tutorials-create-configuration.png) 3. On the **Configurations** page, choose **Create
