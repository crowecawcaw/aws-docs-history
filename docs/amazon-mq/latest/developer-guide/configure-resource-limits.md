...
For more details see [RabbitMQ Broker Configurations](rabbitmq-broker-configuration-parameters.md "rabbitmq-broker-configuration-parameters.md")
...
[Default resource limits](rabbitmq-resource-limits-configuration.md "rabbitmq-resource-limits-configuration.md") and
[Amazon MQ for RabbitMQ maximum resource limit](rabbitmq-resource-hard-limit.md "rabbitmq-resource-hard-limit.md").
