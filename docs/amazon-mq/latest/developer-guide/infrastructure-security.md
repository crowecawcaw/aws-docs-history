...
As a managed service, Amazon MQ is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon MQ through the network. Clients must
