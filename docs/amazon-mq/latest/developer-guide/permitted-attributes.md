...
Amazon MQ configurations. For more information, see [XML Configuration](https://activemq.apache.org/xml-configuration.html "https://activemq.apache.org/xml-configuration.html") in the
