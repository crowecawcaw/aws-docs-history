...
[recovering XA transactions](best-practices-activemq.md#recover-xa-transactions "best-practices-activemq.md#recover-xa-transactions").
...
For more information on LDAP integration, see [How LDAP integration works](security-authentication-authorization.md#ldap-support-details "security-authentication-authorization.md#ldap-support-details").
