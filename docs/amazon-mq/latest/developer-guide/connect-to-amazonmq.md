...
| ``brokerId`.mq.`region`.on.aws`        | Dual-stack (IPv4 and IPv6) NoteAmazon MQ for ActiveMQ brokers do not support dual-stack. |
...
[AWS General Reference](../../../general/latest/gr/amazon-mq.md "../../../general/latest/gr/amazon-mq.md").
...
[Dual-stack and FIPS endpoints](../../../sdkref/latest/guide/feature-endpoints.md "../../../sdkref/latest/guide/feature-endpoints.md")
...
[Using endpoints in the AWS CLI](../../../cli/v1/userguide/cli-configure-endpoints.md "../../../cli/v1/userguide/cli-configure-endpoints.md")
