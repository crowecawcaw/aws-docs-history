...
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Number of messages             | Consume messages published to the queues,<br>purge messages from queues,<br>or delete the queues from your broker.                       | Enable lazy queues,<br>and set or reduce the [queue depth limit](rabbitmq-defaults.md "rabbitmq-defaults.md").                                                                             |
| Number of queues               | Reduce the number of queues.                                                                                                             | Set or reduce the [queue count limit](rabbitmq-defaults.md "rabbitmq-defaults.md").                                                                                                        |
| Number of connections          | [Reduce the number of connections](reducing-connections-and-channels.md "reducing-connections-and-channels.md").                         | Set or reduce the [connection count limit](rabbitmq-defaults.md "rabbitmq-defaults.md").                                                                                                   |
...
| Number of consumers            | Reduce the number of consumers connected to the broker.                                                                                  | Set a small consumer [pre-fetch limit](rabbitmq-defaults.md "rabbitmq-defaults.md").                                                                                                       |
