...
Amazon MQ supports in-place upgrades from RabbitMQ 3.13 to RabbitMQ 4.2. For more information, see [Upgrading from RabbitMQ 3 to 4](upgrading-rabbitmq-v3-to-v4.md).

**Important**  
 The default queue type on Amazon MQ for RabbitMQ 4.2 brokers will be “quorum”. If no queue type argument is specified during queue creation, a quorum queue will be created.   
