...
For more information about the metrics exposed by each endpoint, see [Prometheus metric](https://www.rabbitmq.com/docs/prometheus#metric-aggregation "https://www.rabbitmq.com/docs/prometheus#metric-aggregation") in the RabbitMQ documentation.
...
CloudWatch metrics, see [Available CloudWatch metrics for Amazon MQ for RabbitMQ brokers](rabbitmq-logging-monitoring.md "rabbitmq-logging-monitoring.md").
