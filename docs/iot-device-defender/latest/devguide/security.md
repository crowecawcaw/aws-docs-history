...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS IoT Device Defender. The following topics show you how to configure AWS IoT Device Defender to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS IoT Device Defender resources. To learn more about security in AWS IoT Core, see the [security chapter](../../../iot/latest/developerguide/iot-security.md "../../../iot/latest/developerguide/iot-security.md") in the _AWS IoT Core Developer Guide_

###### Topics

- [Data protection in AWS IoT Device Defender](data-protection.md "data-protection.md")
- [Identity and access management for AWS IoT Device Defender](security-iam.md "security-iam.md")
- [Compliance validation for AWS IoT Device Defender](compliance-validation.md "compliance-validation.md")
- [Resilience in AWS IoT Device Defender](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
