...
Use this metric to specify the maximum or minimum amount of outbound traffic that a device
...
Use this metric to specify the maximum or minimum amount of inbound traffic that a device
...
Use this metric to specify the maximum or minimum amount of total outbound traffic that a
...
Use this metric to specify the maximum or minimum amount of total inbound traffic that a
...
Use this metric to specify a set of allowed (formerly referred to as whitelisted) or
denied (formerly referred to as blacklisted) TCP ports on which each device must or must not
listen.
...
Use this metric to specify a set of allowed (formerly referred to as whitelisted) or
denied (formerly referred to as blacklisted) UDP ports on which each device must or must not
listen.
...
Use this metric to specify the maximum or minimum number of active TCP connections that
