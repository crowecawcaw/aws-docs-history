...
To get a high-level view of how AWS IoT Device Defender and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of AWS IoT Device Defender identity-based policies, see [Identity-based policy examples for AWS IoT Device Defender](security_iam_id-based-policy-examples.md).
