...
- The certificates are within their validity period (in other words, not
  expired).
- Their cryptographic key sizes meet a minimum required size (for RSA keys, they
...
This check appears as `CA_CERTIFICATE_KEY_QUALITY_CHECK` in the CLI and
API.
