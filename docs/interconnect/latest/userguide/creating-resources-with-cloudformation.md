...
AWS Interconnect supports creating Connections in AWS CloudFormation. For more information, including examples of JSON and YAML templates for Connections, see [AWS Interconnect Connection](https://docs.aws.amazon.com/AWSCloudFormation/latest/TemplateReference/aws-resource-interconnect-connection.html) in the *AWS CloudFormation User Guide*.
