...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to Guard, see [AWS Services in Scope by Compliance Program](https://aws.amazon.com/compliance/services-in-scope/ "https://aws.amazon.com/compliance/services-in-scope/").
- **Security in the cloud** – Your responsibility is
  ...
  and regulations
  The following documentation helps you understand how to apply the shared responsibility model when
  [installing Guard as an AWS Lambda function](setting-up-lambda.md "setting-up-lambda.md") (_cfn-guard-lambda_):

- [Security](../../../cli/latest/userguide/security.md "../../../cli/latest/userguide/security.md") in the _AWS Command Line Interface User Guide_
- [Security](../../../lambda/latest/dg/lambda-security.md "../../../lambda/latest/dg/lambda-security.md") in the _AWS Lambda Developer Guide_
- [Security](../../../IAM/latest/UserGuide/security.md "../../../IAM/latest/UserGuide/security.md") in the _AWS Identity and Access Management User Guide_
