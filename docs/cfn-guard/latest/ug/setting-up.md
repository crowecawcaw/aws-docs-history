...
The following topics provide information about how to install Guard using your chosen operating system or as an AWS Lambda function.

**Topics**
+ [Installing Guard for Linux and macOS](setting-up-linux.md)
+ [Installing Guard for Windows](setting-up-windows.md)
