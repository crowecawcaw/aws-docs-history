...
Turning off group lifecycle events does _**not**_ delete the service-linked role. You can [delete the service-linked role manually](using-service-linked-roles.md#delete-service-linked-role "using-service-linked-roles.md#delete-service-linked-role")
