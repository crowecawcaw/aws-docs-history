...
Resource Groups supports creating resource groups in CloudFormation. For more information, including examples of JSON and YAML templates for resource groups, see the [AWS Resource Groups resource type reference](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-resourcegroups-group.html) in the *AWS CloudFormation User Guide*.
