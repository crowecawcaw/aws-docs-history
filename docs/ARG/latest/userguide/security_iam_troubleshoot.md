...
- [I am not authorized to perform an action in Resource Groups](#security_iam_troubleshoot-permissions-arg-te "#security_iam_troubleshoot-permissions-arg-te")
- [I am not authorized to perform iam:PassRole](#security_troubleshoot-passrole "#security_troubleshoot-passrole")
- [I want to allow people outside of my AWS account to access my Resource Groups](#security_troubleshoot-cross-account "#security_troubleshoot-cross-account")
