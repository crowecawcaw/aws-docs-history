...
encounter when working with Resource Groups and IAM.

###### Topics

- [I am not authorized to
  perform an action in Resource Groups](#security_iam_troubleshoot-permissions-arg-te "#security_iam_troubleshoot-permissions-arg-te")
...
- [I want to allow people outside
  of my AWS account to access my Resource Groups](#security_troubleshoot-cross-account "#security_troubleshoot-cross-account")

## I am not authorized to

perform an action in Resource Groups
...
use the console to view details about a group but does not have
`resource-groups:ListGroups` permission.
...
access the `my-test-group` resource using the
`resource-groups:ListGroups` action.
...
Resource Groups. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
of my AWS account to access my Resource Groups
...
- To learn whether Resource Groups supports these features, see [How Resource Groups works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
