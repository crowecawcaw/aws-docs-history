...
**Topics**
+ [Data protection in AWS Resource Groups](data-protection.md)
...
+ [Compliance validation for AWS Resource Groups](compliance-validation.md)
+ [Resilience in AWS Resource Groups](disaster-recovery-resiliency.md)
+ [Infrastructure Security in AWS Resource Groups](infrastructure-security.md)
