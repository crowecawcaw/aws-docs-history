...
role**. 7. Modify any other optional settings as described in [Creating and working with AWS Glue DataBrew profile jobs](jobs.profile.md "jobs.profile.md"), if needed. 8. Choose **Create and run job**.
