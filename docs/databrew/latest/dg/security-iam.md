...
(have permissions) to use DataBrew resources. IAM is an AWS service that you can
...
- [AWS Glue DataBrew and AWS Lake Formation](#lake-formation "#lake-formation")
- [How AWS Glue DataBrew works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
- [Identity-based policy examples for AWS Glue DataBrew](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md")
- [AWS managed policies for AWS Glue DataBrew](aws-managed-policies.md "aws-managed-policies.md")
- [Troubleshooting identity and access in AWS Glue DataBrew](security_iam_troubleshoot.md "security_iam_troubleshoot.md")
...
AWS Glue DataBrew supports AWS Lake Formation permissions for AWS Glue Data Catalog tables.
When a dataset uses an AWS Glue Data Catalog table that is registered with Lake Formation,
the IAM role provided to projects or jobs must have
[DESCRIBE](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-describe "../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-describe") and
[SELECT](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-select "../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-select")
Lake Formation permissions on the table.

AWS Glue DataBrew supports writing to AWS Glue Data Catalog tables based on AWS Lake Formation. When a DataBrew job
uses a Data Catalog that is registered with Lake Formation, the IAM role provided to the jobs must have
[INSERT](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-insert "../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-insert"), [ALTER](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-alter "../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-alter"),
and [DELETE](../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-delete "../../../lake-formation/latest/dg/lf-permissions-reference.md#perm-delete")
permissions from Lake Formation for the tables involved. The IAM role must have
`glue:UpdateTable` permissions, and also permissions to the data location
associated with the Data Catalog table.
