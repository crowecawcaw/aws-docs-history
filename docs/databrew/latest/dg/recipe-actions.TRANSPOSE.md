...
![Table transformation from rows to columns, showing data reorganization for improved analysis.](images/transpose.png)
...
- `aggregateFunction` — The name of an aggregation function.
  If you don't want aggregation, use the keyword `COLLECT_LIST`.
