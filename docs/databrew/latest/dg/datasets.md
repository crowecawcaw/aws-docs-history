...
- [Using datasets in AWS Glue DataBrew](datasets.creating.md "datasets.creating.md")
- [Connecting to your data](datasets.connecting-to-data.md "datasets.connecting-to-data.md")
- [Connecting to data in a text file with DataBrew](datasets.connecting-to-data-in-text-files.md "datasets.connecting-to-data-in-text-files.md")
- [Connecting data in multiple files in Amazon S3](datasets.multiple-files.md "datasets.multiple-files.md")
- [Data types](datatypes.md "datatypes.md")
- [Advanced data types](projects.adv-data-types.md "projects.adv-data-types.md")
