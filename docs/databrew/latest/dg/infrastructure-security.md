...
As part of a managed service, AWS Glue DataBrew is protected by the AWS global network security
...
You use AWS published API calls to access DataBrew through the network. Clients must
...
- [Using AWS Glue DataBrew with your VPC](databrew-with-vpc.md "databrew-with-vpc.md")
- [Using AWS Glue DataBrew with VPC endpoints](vpc-endpoint.md "vpc-endpoint.md")
