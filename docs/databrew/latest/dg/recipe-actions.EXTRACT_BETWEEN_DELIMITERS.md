...
- `targetColumn` – The name of the new column to be
  created.
- `startPattern` – A regular expression, indicating the
  character or characters that begin the delimited values.
- `endPattern` – A regular expression, indicating the
  delimiter character or characters that end the delimited values.
