...
and begins loading data. For more information, see [Connecting to your data](datasets.connecting-to-data.md "datasets.connecting-to-data.md").
...
about how to do this, see [Step 5: Create a data profile](getting-started.05.md "getting-started.05.md").
...
- [Deleting a dataset](datasets.deleting.md "datasets.deleting.md")
