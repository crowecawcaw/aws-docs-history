...
- `secretId` – The ARN of the Secrets Manager secret
  key to use to decrypt the source columns.
...
console user must have permission to secretsmanager:GetSecretValue on the provided Secrets Manager
secret.
