...
![More menu expanded showing Import recipe, Download as YAML, and Download as JSON options.](http://docs.aws.amazon.com/databrew/latest/dg/images/project-view-download-json.png)
