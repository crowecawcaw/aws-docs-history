...
- `startDelimiter` – A character indicating where masking is to begin. Omitting
  this parameter will apply the mask starting from the start of the string.
- `endDelimiter` – A character indicating where masking is to end. Omitting
  this parameter will apply the masking from the startDelimiter to the end of the string.
