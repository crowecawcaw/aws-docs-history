...
5. (Optional) Configure the following on the **Data profile configurations**
   ...
   statistics that you can configure at the dataset level, see [Configurable statistics at the dataset level](profile.configuration.md#statistics.table01 "profile.configuration.md#statistics.table01").
   ...
   - **Column level configurations** – Using
     **Default profile configuration
     ...
     at the column level, see [Configurable statistics at the column level](profile.configuration.md#statistics.table02 "profile.configuration.md#statistics.table02"). You can configure statistics
...
8. For **Associated Schedule**, you can apply a DataBrew job schedule so that
   ...
   information, see [Automating job runs with a schedule](jobs.recipe.md#jobs.scheduling "jobs.recipe.md#jobs.scheduling").
