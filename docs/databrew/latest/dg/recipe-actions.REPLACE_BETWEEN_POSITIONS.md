...
- `startPosition` – A number indicting at what character
  position in the string the substitution is to begin.
- `endPosition` – A number indicting at what character
  position in the string the substitution is to end.
