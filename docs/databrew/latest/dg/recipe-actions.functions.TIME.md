...
Creates a new column containing the time value, from the source columns or values
provided.

###### Parameters

- `dateTimeFormat` – Optional. A format string for the date,
  as it is to appear in the new column. If this string isn't specified, the
