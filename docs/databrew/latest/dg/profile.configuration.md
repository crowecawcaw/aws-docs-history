...
- [DatasetStatisticsConfiguration section](#profile-dataset-stats-config "#profile-dataset-stats-config")
- [ColumnStatisticsConfigurations section](#profile-column-stats-config "#profile-column-stats-config")
...
that contain detected entities. See [Configurable statistics at the column level](#statistics.table02 "#statistics.table02")
