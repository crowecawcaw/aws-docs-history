...
**Example**  
   ...
   For a list of MIBs and their variables, see [Management Information Bases (MIBs) in AWS Elemental Statmux](notification-polling-mibs.md).