...
<a name="config-wrkr-sm-cg-ethernet-bond"></a>
...
**Topics**
+ [Step A: Create Bond Configuration File](#config-wrkr-sm-cg-ethernet-bond-create)
+ [Step B: Edit Ethernet Interface Configuration Files](#config-wrkr-sm-cg-ethernet-bond-assign)
+ [Step C: Restart the AWS Elemental Service Configuration Files](#config-wrkr-sm-cg-ethernet-bond-restart)
+ [Step D: Verify the Bond](#config-wrkr-sm-cg-ethernet-bond-verify)

For help creating and updating bonding files through the CLI, see [Using the CLI](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html/networking_guide/sec-network_bonding_using_the_command_line_interface) in the Red Hat *Networking Guide*.
...
+ [Added to AWS Elemental Statmux the Ethernet devices](config-wrkr-sm-cg-ethernet-add.md) that you're bonding.

## Step A: Create Bond Configuration File
<a name="config-wrkr-sm-cg-ethernet-bond-create"></a>
...
1. Insert the following settings in the file:
   ...
   + ***BONDING\_OPTS*** – Type the bonding mode you're using and other applicable options.

     For a list of additional options, see [Creating a Network Bond in CentOS7 and RHEL7 from the CLI](https://community.elemental.com/docs/DOC-3976).
...
<a name="config-wrkr-sm-cg-ethernet-bond-assign"></a>
...
<a name="config-wrkr-sm-cg-ethernet-bond-restart"></a>
...
<a name="config-wrkr-sm-cg-ethernet-bond-verify"></a>
