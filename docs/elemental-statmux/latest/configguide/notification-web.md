...
<tbody>
  ...
  <tr><td><b>Notification: Web Callback URL</b></td><td>Enter the URL of the appropriate <code>.php</code> file on your web server.This is required if you don't provide an address in the <b>Email</b> field.</td></tr>
