...
<tbody>
  ...
  <tr><td><b>Mount Folder</b></td><td>The folder on the node where the remote folder is mounted. As shown, this folder must be under <code>/data/mnt</code>. You can specify a sub-subfolder; if that folder does not already exist, Statmux automatically creates it.</td></tr>
