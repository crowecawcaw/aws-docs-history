...
![](http://docs.aws.amazon.com/elemental-statmux/latest/installguide/images/install-licorderdetail-shared-png.png)

1. On the **License Information** page, choose **Generate**.  
![](http://docs.aws.amazon.com/elemental-statmux/latest/installguide/images/install-licinfo-shared-png.png)
...
![](http://docs.aws.amazon.com/elemental-statmux/latest/installguide/images/install-genlic-shared-png.png)
...
![](http://docs.aws.amazon.com/elemental-statmux/latest/installguide/images/install-viewlic-shared-png.png)
