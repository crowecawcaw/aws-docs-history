...
You're prompted to read and accept the EULA.
...
The AWS Elemental Statmux software is configured.
...
Please open a web browser and point it to http://10.24.34.2 to get to the web interface.
Enjoy!
```
