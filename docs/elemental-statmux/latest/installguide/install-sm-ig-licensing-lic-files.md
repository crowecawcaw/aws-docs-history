...
![Standalone License tab showing Browse button with no file selected and update option.](https://docs.aws.amazon.com/elemental-statmux/latest/installguide/images/install-installlic-shared-png.png)
