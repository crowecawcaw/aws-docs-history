...
<a name="upgrades-sm-upg-single-locate-sw"></a>
...
1. Make a note of the name of the download file. For example: `elemental_production_statmux_2.20.0.123456.run`
...
For detailed downloading steps, see [Downloading AWS Elemental Statmux Software](detailed-dl-sm-upg.md).