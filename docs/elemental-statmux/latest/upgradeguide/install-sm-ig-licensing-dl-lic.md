...
<a name="install-sm-ig-licensing-dl-lic"></a>

1. Follow the instructions in [Downloading AWS Elemental Statmux Software](detailed-dl-sm-upg.md) to get to the **Order Detail** page on the [AWS Elemental Support Center Activations](https://console.aws.amazon.com/elemental-appliances-software/home?region=us-east-1#/activations).

1. Hover over the three-bar icon on the right of the screen to bring up a small menu. Choose **License(s)**.  
![](https://docs.aws.amazon.com/elemental-statmux/latest/upgradeguide/images/install-licorderdetail-shared-png.png)

1. On the **License Information** page, choose **Generate**.  
![](https://docs.aws.amazon.com/elemental-statmux/latest/upgradeguide/images/install-licinfo-shared-png.png)
...
![](https://docs.aws.amazon.com/elemental-statmux/latest/upgradeguide/images/install-genlic-shared-png.png)
...
![](https://docs.aws.amazon.com/elemental-statmux/latest/upgradeguide/images/install-viewlic-shared-png.png)
