...
1. Follow the instructions in [Downloading AWS Elemental Statmux Software](detailed-dl-sm-upg.md "detailed-dl-sm-upg.md") to get to the **Order Detail** page on the
