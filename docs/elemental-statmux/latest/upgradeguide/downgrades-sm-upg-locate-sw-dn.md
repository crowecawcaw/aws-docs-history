...
<a name="downgrades-sm-upg-locate-sw-dn"></a>
...
1. If you find the software, skip to [Step C: Downgrade the Node](downgrades-sm-upg-dg-node.md).
...
1. Make a note of the name of the download file. For example: `elemental_production_statmux_2.17.0.123456.run`
