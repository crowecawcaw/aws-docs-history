...
![Licenses tab showing Choose File button with no license pools currently uploaded.](https://docs.aws.amazon.com/elemental-statmux/latest/upgradeguide/images/install-installlic-shared-png.png)
