...
```
{
  ...
  "Statement": [
    ...
    {
      "Sid": "AIDevOpsServiceRegistrationOAuth",
      "Effect": "Allow",
      "Action": [
...
Provides permissions required by the Amazon DevOps Agent to perform analysis on customer AWS resources during investigations.
