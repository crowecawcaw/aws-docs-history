...
2. Choose the custom agent you want to edit.
3. On the agent detail page, choose **Edit**.
4. In the dialog, choose **Form**.
5. Modify the fields you want to update:
...
1. Navigate to the **Agents** page in your DevOps Agent web app.
2. Choose the custom agent you want to inspect.
...
2. Review the trajectory timeline.
