...
- **Connect** - Establish connection to Dynatrace by configuring account access credentials, with all the environments you may need
...
3. **Create OAuth client in Dynatrace, with the detailed permissions.**
   - See Dynatrace documentation [https://docs.dynatrace.com/docs/shortlink/aws-devops-agent](https://docs.dynatrace.com/docs/shortlink/aws-devops-agent "https://docs.dynatrace.com/docs/shortlink/aws-devops-agent")
