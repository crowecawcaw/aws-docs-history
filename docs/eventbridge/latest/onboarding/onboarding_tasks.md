...
# Onboarding tasks
<a name="onboarding_tasks"></a>

## 1. Partner registration
<a name="_1_partner_registration"></a>
...
Additionally, AWS requires the information listed in the topic [Partner Terms](partner_terms.md).

## 2. Creating partner event sources
<a name="_2_creating_partner_event_sources"></a>
...
### Best practices
<a name="PartnerRegistration_BestPractices"></a>
...
### Best practices
<a name="SendingEvents_BestPractices"></a>
...
<a name="_4_managing_partner_event_buses"></a>
