...
## AWS Clean Rooms events delivered via

AWS CloudTrail

AWS CloudTrail sends events originating from AWS Clean Rooms to EventBridge. AWS services deliver events to CloudTrail on a [best effort](event-delivery-level.md "event-delivery-level.md") basis. For more information,
