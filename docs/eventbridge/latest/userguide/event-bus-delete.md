...
You can delete a custom or partner event bus. You cannot delete the default event bus.
Deleting an event bus deletes the rules associated with that event bus.
...
4. Do one of the following:
   ...
   On the event bus details page, choose
   **Delete**.
