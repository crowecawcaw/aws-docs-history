...
8. For **Connection**, choose **Use an existing
   connection** and choose the `Salesforce` connection you created in step
9.
10. Choose **Create**.

## Step 3: Create rule

Next, you'll create a rule to send events to Salesforce when an Amazon S3 object is
created.
...
12. For **API destination**, choose **Use an existing API
    destination**, and then choose the `SalesforceAD` destination you created in step
13.
...
object](../../../AmazonS3/latest/userguide/upload-objects.md "../../../AmazonS3/latest/userguide/upload-objects.md") by uploading a file to an EventBridge-enabled bucket. The information about the created object will be
sent to the Salesforce platform event.
