...
**API destination invocation endpoint URL**  
For a full list of endpoints, see [Coralogix API Reference](https://coralogix.com/docs/user-guides/alerting/outbound-webhooks/aws-eventbridge-outbound-webhook/).
...
[Amazon EventBridge webhook delivery](https://shopify.dev/docs/apps/build/webhooks/get-started?framework=remix&deliveryMethod=eventBridge)  
