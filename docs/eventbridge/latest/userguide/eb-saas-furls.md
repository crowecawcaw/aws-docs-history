...
| Amazon EventBridge  | 256KB maximum entry size for PutEvents actions.<br>EventBridge enforces Region-based rate quotas. For more information, see [EventBridge event bus quotas](eb-quota.md#eb-limits "eb-quota.md#eb-limits").                                                                                                                                                                                                                                                                                                                                                 |
