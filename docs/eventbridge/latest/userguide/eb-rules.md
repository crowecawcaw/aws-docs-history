...
For more information, see [Creating rules that react to events in Amazon EventBridge](eb-create-rule.md "eb-create-rule.md").
...
For more information, see [Creating a rule that runs on a
