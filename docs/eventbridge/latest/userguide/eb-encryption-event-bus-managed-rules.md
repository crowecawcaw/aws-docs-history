...
![An event that matches a managed rule, encrypted using the key of the rule target.](https://docs.aws.amazon.com/eventbridge/latest/userguide/images/cmkms-bus-managed-rule_eventbridge_conceptual.svg)
