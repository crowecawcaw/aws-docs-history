...
- [Generating an CloudFormation template from an existing EventBridge event bus](eb-generate-event-bus-template.md "eb-generate-event-bus-template.md")
...
- [Generating an CloudFormation template from EventBridge Pipes](pipes-generate-template.md "pipes-generate-template.md")
...
CloudFormation events using EventBridge](../../../AWSCloudFormation/latest/UserGuide/stacks-event-bridge.md "../../../AWSCloudFormation/latest/UserGuide/stacks-event-bridge.md") in the _CloudFormation User
Guide_.
