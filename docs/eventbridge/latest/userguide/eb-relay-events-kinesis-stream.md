...
For more information on schemas, see [Amazon EventBridge schemas](eb-schema.md "eb-schema.md"). For more information on creating a rule using other event pattern options, see [Creating rules using the Enhanced Builder](eb-create-rule-visual.md "eb-create-rule-visual.md").
