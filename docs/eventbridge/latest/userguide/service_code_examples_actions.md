...
The following code examples demonstrate how to perform individual EventBridge
...
These excerpts call the EventBridge API and
are code excerpts from larger programs that must be run in context.
You can see actions in context in
[Scenarios for EventBridge using AWS SDKs](service_code_examples_scenarios.md "service_code_examples_scenarios.md").
