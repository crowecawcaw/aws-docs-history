...
4. Define an input transformer to transform the source event data into the CloudEvents format:
   ...
   including a list of known extension attributes, see [CloudEvents Extension Attributes](https://github.com/cloudevents/spec/tree/main/cloudevents/extensions "https://github.com/cloudevents/spec/tree/main/cloudevents/extensions")
