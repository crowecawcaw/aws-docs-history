...
| ------------------ | ------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- |
| `schemaNamePrefix` | String | False | Specifying this limits the results to only those schema names that start with the<br>specified prefix.                                                                                            |
...
| ----------- | --------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `NextToken` | string                      | False    | The token that specifies the next page of results to return. To request the first<br>page, leave NextToken empty. The token will expire in 24 hours, and cannot be shared<br>with other accounts. |
| `Schemas`   | Array of type SchemaSummary | False    | An array of schema summaries.                                                                                                                                                                     |
...
| `VersionCount` | integerFormat: int64                                                                                              | False    | The number of versions available for the schema. |
