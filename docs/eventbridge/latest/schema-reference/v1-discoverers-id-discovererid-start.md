...
| `State`        | [DiscovererState](#v1-discoverers-id-discovererid-start-model-discovererstate "#v1-discoverers-id-discovererid-start-model-discovererstate") | False    | The state of the discoverer. |
