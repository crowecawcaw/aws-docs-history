...
container](https://docs.docker.com/engine/api/v1.23/#create-a-container "https://docs.docker.com/engine/api/v1.23/#create-a-container") section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.23/ "https://docs.docker.com/engine/api/v1.23/") and
the `--memory` option to [docker run](https://docs.docker.com/engine/reference/run/ "https://docs.docker.com/engine/reference/run/"). You
...
in the [Create a container](https://docs.docker.com/engine/api/v1.23/#create-a-container "https://docs.docker.com/engine/api/v1.23/#create-a-container") section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.23/ "https://docs.docker.com/engine/api/v1.23/") and
the `--memory` option to [docker run](https://docs.docker.com/engine/reference/run/ "https://docs.docker.com/engine/reference/run/").

###### Note

If you're trying to maximize your resource utilization by providing your
jobs as much memory as possible for a particular instance type, see [Memory management](../../../batch/latest/userguide/memory-management.md "../../../batch/latest/userguide/memory-management.md") in the _AWS Batch User
Guide_.
...
container](https://docs.docker.com/engine/api/v1.23/#create-a-container "https://docs.docker.com/engine/api/v1.23/#create-a-container") section of the [Docker Remote API](https://docs.docker.com/engine/api/v1.23/ "https://docs.docker.com/engine/api/v1.23/") and
the `--cpu-shares` option to [docker run](https://docs.docker.com/engine/reference/run/ "https://docs.docker.com/engine/reference/run/"). Each
...
is 6 vCPUs. For more information about Fargate quotas, see [AWS Fargate quotas](../../../general/latest/gr/ecs-service.md#service-quotas-fargate "../../../general/latest/gr/ecs-service.md#service-quotas-fargate") in the _AWS
General Reference_.
...
- [AWS SDK for C++](../../../goto/SdkForCpp/pipes-2015-10-07/BatchResourceRequirement.md "../../../goto/SdkForCpp/pipes-2015-10-07/BatchResourceRequirement.md")
- [AWS SDK for Java V2](../../../goto/SdkForJavaV2/pipes-2015-10-07/BatchResourceRequirement.md "../../../goto/SdkForJavaV2/pipes-2015-10-07/BatchResourceRequirement.md")
- [AWS SDK for Ruby V3](../../../goto/SdkForRubyV3/pipes-2015-10-07/BatchResourceRequirement.md "../../../goto/SdkForRubyV3/pipes-2015-10-07/BatchResourceRequirement.md")
