...
<a name="nitro-enclave-concepts"></a>

The following concepts are important to your understanding and use of AWS Nitro Enclaves.

**Topics**
+ [Enclave](#term-enclave)
+ [Enclave ID](#term-enclaveid)
+ [Parent instance](#term-parent)
+ [Enclave image file](#term-eif)
+ [AWS Nitro Enclaves CLI](#term-cli)
+ [AWS Nitro Enclaves SDK](#term-sdk)
+ [Cryptographic attestation](#term-attest)
+ [Attestation document](#term-attestdoc)
+ [Platform configuration registers](#term-pcr)
+ [KMS proxy](#term-proxy)
+ [Vsock socket](#term-socket)

## Enclave
<a name="term-enclave"></a>
