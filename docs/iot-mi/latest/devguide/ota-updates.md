...
![Current architecture to ingest AWS IoT data with AWS IoT Analytics](https://docs.aws.amazon.com/iot-mi/latest/devguide/images/iot-managedintegrations-sdk-ota-arch.png)
