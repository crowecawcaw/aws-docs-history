...
To get a high-level view of how Managed Integrations and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of Managed Integrations identity-based policies, see [Identity-based policy examples for Managed Integrations](security_iam_id-based-policy-examples.md).
...
To see a list of Managed Integrations actions, see [Actions Defined by Managed Integrations ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions) in the *Service Authorization Reference*.
...
To see a list of Managed Integrations condition keys, see [Condition Keys for Managed Integrations ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-policy-keys) in the *Service Authorization Reference*. To learn with which actions and resources you can use a condition key, see [Actions Defined by Managed Integrations ](https://docs.aws.amazon.com/IAM/latest/UserGuide/list_your_service.html#your_service-actions-as-permissions).
