...
# Device control
<a name="managedintegrations-sdk-v2-control"></a>
...
With device control, you can view and modify device states, such as light bulb brightness or door position. The feature emits events for state changes, which you can use for analytics, rules, and monitoring.Key features
...
<a name="managedintegrations-sdk-v2-control-flow"></a>
...
<a name="managedintegrations-sdk-v2-control-components"></a>
...
The Hub SDK consists of the following components, and facilitates device onboarding and control on IoT hubs.Primary components:
...
**Provisioner**  
Handles device discovery and onboarding. It includes a core provisioner and protocol-specific provisioner plugins for protocol-specific onboarding tasks.Secondary components
