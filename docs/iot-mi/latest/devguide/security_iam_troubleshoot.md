# Troubleshooting managed integrations identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with managed integrations and IAM.

###### Topics

- [I am not authorized to
  perform an action in managed integrations](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my managed integrations resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in managed integrations
...
have the fictional `iot-mi:`GetWidget`` permissions.
...
managed integrations. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my managed integrations resources
...
- To learn whether managed integrations supports these features, see [How managed integrations works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
