...
**Topics**
+ [I am not authorized to perform an action in Managed Integrations](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to allow people outside of my AWS account to access my Managed Integrations resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether Managed Integrations supports these features, see [How Managed Integrations works with IAM](security_iam_service-with-iam.md).
