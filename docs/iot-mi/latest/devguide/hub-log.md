...
## Prerequisites
<a name="hub-prerequisites"></a>
+ Onboard the managed device to the cloud. See [Hub onboarding setup](managedintegrations-sdk-v2-cookbook-hubsetup.md) for details. 
+ Verify Hub agent startup and successful initialization. See [Install and validate the managed integrations Hub SDK](managedintegrations-sdk-v2-cookbook-deployment.md) for details. 

**Note**  
To create logging configurations, see [PutRuntimeLogConfiguration API](https://docs.aws.amazon.com/iot-mi/latest/APIReference/API_PutRuntimeLogConfiguration.html) for details.
...
<a name="hub-configuration-attributes"></a>
