...
1. Event emission functions

1. Attribute change notification functions

1. Cluster registration functions
...
The following section illustrates the [OnOff cluster](https://github.com/project-chip/connectedhomeip/blob/v1.3.0.0/data_model/clusters/OnOff.xml) API.
