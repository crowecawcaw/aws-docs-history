...
and real-time operating systems (RTOS). Download the latest version of the End device SDK from the [AWS IoT Management Console](https://console.aws.amazon.com/iot "https://console.aws.amazon.com/iot").
