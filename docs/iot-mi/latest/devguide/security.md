...
- **Security in the cloud** – Your responsibility is
  ...
  using managed integrations. The following topics show you how to configure managed integrations to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your managed integrations resources.

###### Topics

- [Data protection in managed integrations](data-protection.md "data-protection.md")
- [Identity and access management for managed integrations](security-iam.md "security-iam.md")
- [Use AWS Secrets Manager for data protection for C2C workflows](secrets-manager.md "secrets-manager.md")
- [Compliance validation for managed integrations](compliance-validation.md "compliance-validation.md")
- [Use managed integrations with interface VPC endpoints](interface-vpc-endpoints.md "interface-vpc-endpoints.md")
- [Connect to managed integrations for AWS IoT Device Management FIPS endpoints](FIPS-endpoints.md "FIPS-endpoints.md")
