...
![The hostkey details console screen.](https://docs.aws.amazon.com/transfer/latest/userguide/images/server-host-keys-details.png)
...
![The server hostkey Actions menu.](https://docs.aws.amazon.com/transfer/latest/userguide/images/server-host-keys-actions.png)
