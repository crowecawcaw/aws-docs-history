...
| AES192\_CBC | Yes | Yes |  | 
| AES256\_CBC | Yes | Yes |  | 
| DES\_EDE3\_CBC | Yes | Yes | Only use this algorithm if you must support a legacy client that requires it, as it is a weak encryption algorithm. | 
