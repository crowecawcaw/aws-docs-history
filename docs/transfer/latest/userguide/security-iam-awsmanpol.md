...
| [AWSTransferReadOnlyAccess](#security-iam-awsmanpol-transferreadonlyaccess "#security-iam-awsmanpol-transferreadonlyaccess") – Update to an existing policy | AWS Transfer Family added new permissions to allow the policy to read AWS Managed Microsoft AD. | September 30, 2021 |
