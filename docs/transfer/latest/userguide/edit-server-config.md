...
![The server details console page for the server, showing the Endpoint details parameter.](/images/transfer/latest/userguide/images/edit-server-details-top.png)
