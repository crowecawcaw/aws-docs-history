...
**Topics**
+ [Move or rename files or directories on the remote SFTP server](#move-remote-file)
+ [Delete files or directories on the remote SFTP server](#delete-remote-file)
