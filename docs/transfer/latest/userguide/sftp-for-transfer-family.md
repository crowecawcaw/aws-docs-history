...
Endpoint type matrix| Characteristic | Public | VPC<br>• Internet | VPC<br>• Internal | VPC\_Endpoint (deprecated) |
| --- | --- | --- | --- | --- |
...
- For details about the deprecation, see [Discontinuing the use of VPC\_ENDPOINT](create-server-in-vpc.md#deprecate-vpc-endpoint "create-server-in-vpc.md#deprecate-vpc-endpoint").
