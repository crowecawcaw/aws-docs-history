...
- We provide several AWS CloudFormation templates to help you quickly deploy a Transfer Family server
...
| Access                     | From over the internet. This endpoint type doesn't require any<br>special configuration in your VPC.                                                                                                                                                                                      | Over the internet and from within VPC and VPC-connected environments,<br>such as an on-premises data center over AWS Direct Connect or VPN.                                                                                                                                                                                                                                                 | From within VPC and VPC-connected environments, such as an<br>on-premises data center over AWS Direct Connect or VPN.                                                                                       | From within VPC and VPC-connected environments, such as an<br>on-premises data center over AWS Direct Connect or VPN.                                                     |
...
- Use a VPC endpoint with internal access, so that the server is accessible only
  ...
  data center over AWS Direct Connect or VPN.
