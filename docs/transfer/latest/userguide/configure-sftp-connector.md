...
**Topics**
+ [Choosing SFTP connector egress type](#choosing-egress-type)
+ [Choosing IP addressing mode](#choosing-ip-address-type)
+ [Store authentication credentials for SFTP connectors in Secrets Manager](sftp-connector-secret-procedure.md)
