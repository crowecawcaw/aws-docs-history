...
![The Kleopatra options for signing and encrypting files. The option for Sign as is cleared, and the option for Encrypt for me is selected.](https://docs.aws.amazon.com/transfer/latest/userguide/images/workflows-step-decrypt-kleopatra.png)
