...
- [Register SAP HANA database](#register-hana "#register-hana")
- [Register SAP ABAP application](#register-abap "#register-abap")
...
On registration completion, you can see your application on the **Applications** page. For more information about the application details page, see [Application details](manage-console.md#application-details "manage-console.md#application-details").
