...
**Topics**
+ [AWS managed policies for AWS Systems Manager for SAP](iam-policies.md)
+ [Using service linked roles for AWS Systems Manager for SAP](slr.md)
+ [AWS PrivateLink for AWS Systems Manager for SAP](privatelink.md)