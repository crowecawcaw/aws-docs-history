...
- [Application details](#application-details "#application-details")
- [Start an application](#start-application "#start-application")
- [Stop an application](#stop-application "#stop-application")

## Application details

To view the details of a registered application, open the [AWS Console for SAP applications](https://console.aws.amazon.com/awsforsap/home "https://console.aws.amazon.com/awsforsap/home"), choose **Applications**, and then choose the application. The application details page contains the following tabs.
...
View the results of previous configuration check evaluations by selecting a check, or choose **Run checks** to perform a new evaluation. For more information, see [Run Configuration Checks](configuration-checks-console.md "configuration-checks-console.md").
...
2. Choose **Applications**, then choose the application that you want to start.
3. Choose **Actions**, then choose **Start application**.
4. Choose **Start**.

You can monitor the task status using the _operation ID_ provided in the flash banner or by choosing the **Operations** tab.
