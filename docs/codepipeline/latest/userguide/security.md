...
- **Security in the cloud** – Your responsibility is
  ...
  using CodePipeline. The following topics show you how to configure CodePipeline to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your CodePipeline resources.
...
- [Compliance validation for AWS CodePipeline](compliance-validation.md "compliance-validation.md")
- [Resilience in AWS CodePipeline](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
- [Infrastructure security in AWS CodePipeline](infrastructure-security.md "infrastructure-security.md")
