...
As a managed service, AWS CodePipeline is protected by AWS global network security. For
...
You use AWS published API calls to access CodePipeline through the network. Clients must
