...
that use the CodeStarSourceConnection action in CodePipeline, such as GitHub, Bitbucket, and
GitLab.
...
Choose **Edit triggers**. Choose to add a trigger. 5. In **Trigger type**, choose **No
filter**.
