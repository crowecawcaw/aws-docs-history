...
![An example Timeline tab showing the monitor rule as successful in the previous run.](https://docs.aws.amazon.com/codepipeline/latest/userguide/images/stage-condition-timeline-tab.png)
