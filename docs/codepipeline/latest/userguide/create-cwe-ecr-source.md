...
- Use the CLI to add the action configuration for the `ECR` action
  ...
  - The change detection method defaults to starting the pipeline by
    ...
    change detection rule manually. Use one of the following methods: [Create an EventBridge rule for an Amazon ECR source (console)](create-cwe-ecr-source-console.md "create-cwe-ecr-source-console.md"), [Create an EventBridge rule for an Amazon ECR source (CLI)](create-cwe-ecr-source-cli.md "create-cwe-ecr-source-cli.md"), or [Create an EventBridge rule for an Amazon ECR source (CloudFormation template)](create-cwe-ecr-source-cfn.md "create-cwe-ecr-source-cfn.md").

###### Topics

- [Create an EventBridge rule for an Amazon ECR source (console)](create-cwe-ecr-source-console.md "create-cwe-ecr-source-console.md")
- [Create an EventBridge rule for an Amazon ECR source (CLI)](create-cwe-ecr-source-cli.md "create-cwe-ecr-source-cli.md")
- [Create an EventBridge rule for an Amazon ECR source (CloudFormation template)](create-cwe-ecr-source-cfn.md "create-cwe-ecr-source-cfn.md")
