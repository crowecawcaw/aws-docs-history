...
**Topics**
+ [Start a pipeline with a source revision override (console)](#pipelines-trigger-source-overrides-console)
+ [Start a pipeline with a source revision override (CLI)](#pipelines-trigger-source-overrides-cli)
