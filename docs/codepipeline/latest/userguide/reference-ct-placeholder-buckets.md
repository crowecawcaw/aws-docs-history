...
<a name="reference-ct-placeholder-buckets"></a>

This section is a reference only. For information about creating a pipeline with event detection resources, see [Source actions and change detection methods](change-detection-methods.md).
...
+ If you used the CLI or CloudFormation to set up the CloudWatch Events resources, you can find your CloudTrail files in the bucket that you specified when you set up your pipeline.
...
<a name="reference-ct-placeholder-buckets-list"></a>
