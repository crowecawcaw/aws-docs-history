...
| CloudFormation action support added. See [Service role permissions: CloudFormation<br>action](action-reference-CloudFormation.md#edit-role-cloudformation "action-reference-CloudFormation.md#edit-role-cloudformation").                                                                                                                                                                                           | November 3, 2016                                                                    |
