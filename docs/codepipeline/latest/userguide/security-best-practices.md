...
CodePipeline provides a number of security features to consider as you develop and implement your own security
...
You use encryption and authentication for the source repositories that connect to your pipelines. These are
the CodePipeline best practices for security:
