...
**Topics**
+ [Add filters for push and pull request event types (console)](#pipelines-filter-console)
+ [Add filters for push and pull request event types (CLI)](#pipelines-filter-cli)
+ [Add filters for push and pull request event types (CloudFormation templates)](#pipelines-filter-cfn)
