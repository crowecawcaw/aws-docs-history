...
performed in your AWS account in the AWS Region where you are signed in. The
...
- CodePipeline: `ListPipelines`
  ...
  for that service. Even if you have permissions for viewing resources, some resources
  are not returned if there is an explicit `Deny` to view those
  resources.
