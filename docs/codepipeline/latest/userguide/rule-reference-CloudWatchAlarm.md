...
+ [Configuration parameters](#rule-reference-CloudWatchAlarm-config)
+ [Example rule configuration](#rule-reference-CloudWatchAlarm-example)
+ [See also](#rule-reference-CloudWatchAlarm-links)
...
**AlarmStates**  
Required: No  
The desired CloudWatch alarm states for the rule to monitor. Valid values are ALARM, OK, and INSUFFICIENT\_DATA.
