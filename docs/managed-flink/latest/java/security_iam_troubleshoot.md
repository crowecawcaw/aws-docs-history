...
- [I am not authorized to perform an action in
  Managed Service for Apache Flink](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people outside of my AWS account
  to access my Managed Service for Apache Flink resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")
...
to access my Managed Service for Apache Flink resources
