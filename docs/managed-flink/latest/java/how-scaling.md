...
**Topics**
+ [Configure application parallelism and ParallelismPerKPU](#how-parallelism)
+ [Allocate Kinesis Processing Units](#how-scaling-kpus)
+ [Update your application's parallelism](#how-scaling-howto)
+ [Use automatic scaling in Managed Service for Apache Flink](how-scaling-auto.md)
+ [maxParallelism considerations](#how-scaling-auto-max-parallelism)
