...
This is the [key policy](https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html) and [key material](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-material). You'll need to create a key which is used to encrypt your application state in running application storage and durable application storage.
