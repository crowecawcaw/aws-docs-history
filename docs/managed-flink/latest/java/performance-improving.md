...
For more information about scaling, see [Implement application scaling](how-scaling.md).
...
You can set the ratio for the operator using [Use runtime properties](how-properties.md), so you can tune the operator's parallelism without compiling and uploading your application code.
...
For information about subtasks, task slots, and other application resources, see [Review Managed Service for Apache Flink application resources](how-resources.md).
