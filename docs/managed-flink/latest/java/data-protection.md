...
In Amazon MSF, you can use either service managed or your own customer managed keys to encrypt data. For more information, see [Key management in Amazon Managed Service for Apache Flink](key-management-flink.md).