...
- [Delete your Managed Service for Apache Flink application](#gs-python-cleanup-app "#gs-python-cleanup-app")
- [Delete your Kinesis data streams](#gs-python-cleanup-msk "#gs-python-cleanup-msk")
- [Delete your Amazon S3 objects and bucket](#gs-python-cleanup-s3 "#gs-python-cleanup-s3")
- [Delete your IAM resources](#gs-python-cleanup-iam "#gs-python-cleanup-iam")
- [Delete your CloudWatch resources](#gs-python-cleanup-cw "#gs-python-cleanup-cw")
...
3. Select the two streams that you created,
   `ExampleInputStream` and
   `ExampleOutputStream`.
