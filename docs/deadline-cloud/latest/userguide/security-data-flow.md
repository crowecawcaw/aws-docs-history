...
| AWS IAM Identity Center                                                   | Your AWS account                                                                                | Sign-in and access levels for monitor users. For more information, see<br>[Managing users](managing-users.md "managing-users.md").                                                                                                                                                                             |
...
- **Job attachments** – Amazon Simple Storage Service encrypts your
  ...
  Deadline Cloud](storage-job-attachments.md "storage-job-attachments.md").
