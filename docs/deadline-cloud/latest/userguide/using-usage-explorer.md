...
`OWNER` farm permissions. For more information, see [How permissions work in Deadline Cloud](permissions-overview.md "permissions-overview.md").
...
The chart _only_ displays the top five
...
![A pie chart showing a breakdown of the time spent running jobs is three different queues in a farm.](images/cost-explorer-graph.png)
