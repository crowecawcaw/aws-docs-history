...
* [Send
 an email when events happen using Amazon EventBridge](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-s3-object-created-tutorial.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-s3-object-created-tutorial.html").
* [Creating an
 Amazon EventBridge rule that sends notifications to Amazon Q Developer in chat applications](https://docs.aws.amazon.com/chatbot/latest/adminguide/create-eventbridge-rule.html "https://docs.aws.amazon.com/chatbot/latest/adminguide/create-eventbridge-rule.html").
* [Getting started with
 Amazon EventBridge](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-get-started.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-get-started.html").
For more information about budget events, see the [Budget Threshold Reached event](../developerguide/events-detail-reference.md#event-detail-budget-threshold-reached "../developerguide/events-detail-reference.md#event-detail-budget-threshold-reached") in the *Deadline Cloud Developer
 Guide*.
