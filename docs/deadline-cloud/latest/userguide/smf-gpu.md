...
For testing purposes you are limited to one GPU. To request more for your
 production workloads, see [Requesting a quota increase](https://docs.aws.amazon.com/servicequotas/latest/userguide/request-quota-increase.html "https://docs.aws.amazon.com/servicequotas/latest/userguide/request-quota-increase.html") in the
...
* `grid:r535` - [NVIDIA vGPU software
 16](https://docs.nvidia.com/vgpu/16.0/index.html "https://docs.nvidia.com/vgpu/16.0/index.html")
