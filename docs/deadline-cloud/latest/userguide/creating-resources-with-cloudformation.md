...
Deadline Cloud supports creating farms, queues, and fleets in CloudFormation. For more information, including examples of JSON and YAML templates for farms, queues, and fleets, see the [AWS Deadline Cloud](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/AWS_Deadline.html) in the *AWS CloudFormation User Guide*.
