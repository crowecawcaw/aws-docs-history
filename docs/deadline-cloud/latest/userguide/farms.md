...
_farm_ is a where your project resources are located.
Your farm consists of queues and fleets. A _queue_ is
where submitted jobs are located and scheduled to be rendered. A _fleet_ is a group of worker nodes that run tasks to complete jobs. After you
