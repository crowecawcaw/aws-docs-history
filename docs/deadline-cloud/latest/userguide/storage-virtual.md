...
You can view logs for your virtual file system using the Deadline Cloud monitor. For instructions, see [View session and worker logs in Deadline Cloud](view-logs.md).
