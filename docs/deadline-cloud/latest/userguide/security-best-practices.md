...
information, see [IAM Best Practices](../../../IAM/latest/UserGuide/IAMBestPractices.md "../../../IAM/latest/UserGuide/IAMBestPractices.md") in the
_IAM User Guide_.
...
- Using a _host configuration script_ can change the security and operations of a
...
- Secure any persisted credentials that provide access to AWS, including Deadline Cloud.
  For more information, see [Managing access keys for IAM users](../../../IAM/latest/UserGuide/id_credentials_access-keys.md#securing_access-keys "../../../IAM/latest/UserGuide/id_credentials_access-keys.md#securing_access-keys") in the _IAM User Guide_.
