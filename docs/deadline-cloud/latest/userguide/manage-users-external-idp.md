...
permissions to Deadline Cloud resources. See [Assign permissions to users and groups](assign-permissions-procedure.md "assign-permissions-procedure.md") for information about
