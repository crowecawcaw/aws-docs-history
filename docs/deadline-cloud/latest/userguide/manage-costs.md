...
- _Run time_ is the sum of all tasks in a job, from start
  time to end time.
- _Compute rate_ is determined by the [AWS Deadline Cloud pricing](https://aws.amazon.com/deadline-cloud/pricing/ "https://aws.amazon.com/deadline-cloud/pricing/") for
  service-managed fleets. For customer-managed fleets, the compute rate is
  estimated to be $1 per worker hour.
- _License rate_ is determined by the Deadline Cloud base license
...
- _Customer owned resources and their pricing_. You can
...
- _Changes in price_. AWS offers pay-as-you-go pricing
  ...
  changes.
- _Taxes_. The cost management tools don't include taxes
  applied to our purchase of the service.
- _Rounding_. The cost management tool perform mathematical
  rounding of pricing data.
- _Currency_. Cost estimates are made in U.S. dollars.
