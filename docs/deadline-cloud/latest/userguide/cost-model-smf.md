...
<a name="cost-model-smf-traditional"></a>
...
<a name="cost-model-smf-how-smf-differs"></a>
...
<a name="cost-model-smf-scaling"></a>
...
For information about configuring auto scaling, see [Auto scaling configuration](auto-scaling-configuration.md).

## Cost components at a glance
<a name="cost-model-smf-components"></a>
...
<a name="cost-model-smf-example"></a>
