...
Errors or slow responses typically occur when your service quotas are
exceeded or when the monitor user role is missing required permissions.

### Resolution

- Check your service quotas in your Region. See [Service quotas and throttling](assistant-service-quotas.md "assistant-service-quotas.md") for
  details on checking and increasing your quotas.
- If you receive throttling errors, request a service quota increase for
  in your Region.
