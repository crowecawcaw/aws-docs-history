...
You can change the monitor user role after you complete setup, at any
 time. For more information about user roles, see [IAM Roles](https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html#id_iam-roles "https://docs.aws.amazon.com/IAM/latest/UserGuide/id.html#id_iam-roles").
