...
Lifecycle configuration for your queue's Amazon S3 bucket. For more information, see [Managing your storage lifecycle](../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md "../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md") in the _Amazon Simple Storage Service User
Guide_.
