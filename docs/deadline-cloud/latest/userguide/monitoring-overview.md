...
- _AWS CloudTrail_ captures API calls and related events made by or on behalf
  ...
  For more information, see the following topics in the _Deadline Cloud Developer
  Guide_:

- [CloudTrail
  logs](../developerguide/logging-using-cloudtrail.md "../developerguide/logging-using-cloudtrail.md")
- [Managing events
  using EventBridge](../developerguide/eventbridge-integration.md "../developerguide/eventbridge-integration.md")
- [Monitoring with
  CloudWatch](../developerguide/monitoring-cloudwatch.md "../developerguide/monitoring-cloudwatch.md")
