...
- **AI-generated responses** – The assistant
  uses generative AI to produce responses. As with any generative AI, responses might be
  inaccurate, incomplete, or outdated. Always verify recommendations before making
  changes to your environment.
- **Content safeguards** – The assistant's
  instructions and tools are scanned for abusive or dangerous content as part of the
  deployment process. However, the assistant does not apply runtime content filtering on
