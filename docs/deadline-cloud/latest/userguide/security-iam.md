...
AWS Identity and Access Management (IAM) is an AWS service that helps an administrator securely control access
 ...
 (have permissions) to use Deadline Cloud resources. IAM is an AWS service that you can
...
* [How Deadline Cloud works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
