...
With *job attachments* you can transfer files back and forth between
...
Job attachment files are encrypted in your S3 bucket by default. This helps secure your
 ...
 new objects](https://docs.aws.amazon.com/AmazonS3/latest/userguide/default-encryption-faq.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/default-encryption-faq.html") in the *Amazon S3 User Guide*.
...
Deadline Cloud stores the job attachment files required for your job in an S3 bucket. These files
 ...
 configuration](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html "https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-configuration-examples.html") in the *Amazon S3 User Guide*.
