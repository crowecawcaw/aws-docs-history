...
<a name="cost-concurrency-comparison"></a>
...
<a name="cost-concurrency-fleet-max"></a>
...
For more information, see [Auto scaling configuration](auto-scaling-configuration.md).

## Job maximum worker count
<a name="cost-concurrency-job-max"></a>
...
## Resource limits
<a name="cost-concurrency-limits"></a>
...
For more information, see [Create resource limits for jobs](https://docs.aws.amazon.com/deadline-cloud/latest/developerguide/build-job-limits.html) in the *Deadline Cloud Developer Guide*.

## Budgets with limit actions
<a name="cost-concurrency-budgets"></a>
...
For more information, see [Control costs with a budget](using-budget-manager.md).

## Job priority
<a name="cost-concurrency-priority"></a>
