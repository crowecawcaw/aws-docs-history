...
**Topics**
+ [Set environment variables in a queue environment](set-environment-variables.md)
+ [Set the path in a queue environment](set-the-path.md)
+ [Run a background daemon process from the queue environment](run-a-background-daemon-process.md)