...
Alternatively, create activate.d scripts that the `conda activate` command
 ...
 activate.d scripts instead.
3. Some applications depend on libraries not installed by default on Deadline Cloud
 ...
 interface. You must provide those dependencies within the package you create.
4. Ensure you follow the copyright and license agreements for the applications you
