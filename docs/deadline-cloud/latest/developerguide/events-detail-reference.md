...
All events from AWS services have a common set of fields containing
 ...
 took place, and others. For definitions of these general fields, see [Event structure reference](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events-structure.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events-structure.html") in the *Amazon EventBridge User
 Guide*. 
...
For more information on events and how EventBridge processes them, see [Amazon EventBridge events](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events.html") in the *Amazon EventBridge User
 Guide*.
...
The `source` and `detail-type` fields are included below because they contain specific values for Deadline Cloud events. For
 ...
 reference](https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events-structure.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eb-events-structure.html") in the *Amazon EventBridge User Guide*.
...
* A step update completed successfully (UPDATE\_SUCEEDED).
