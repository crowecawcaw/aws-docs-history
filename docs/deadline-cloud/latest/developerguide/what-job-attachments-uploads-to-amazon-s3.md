...
Deadline Cloud treats the S3 bucket as content-addressable storage. Files are uploaded to S3
 ...
 You can use the [AWS CLI](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-welcome.html "https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-welcome.html") to see the objects that
