...
directory on the GitHub website contains a sequence of four job bundle development stages. As you
...
self-contained template and end at a Python package bundled with script
entry points and unit tests. The sample is built around Python, but the
ideas are not Python-specific.
...
[Open Job
Description CLI](https://github.com/OpenJobDescription/openjd-cli "https://github.com/OpenJobDescription/openjd-cli") on the GitHub website.
