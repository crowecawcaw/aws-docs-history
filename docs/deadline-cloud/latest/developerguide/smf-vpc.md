...
use the fully managed Deadline Cloud platform while integrating with your existing infrastructure within a VPC.
...
To learn more, see the [VPC Lattice user guide](../../../vpc-lattice/latest/ug/what-is-vpc-lattice.md "../../../vpc-lattice/latest/ug/what-is-vpc-lattice.md").
...
1. To create a resource gateway in VPC Lattice, see [Create a resource gateway](../../../vpc-lattice/latest/ug/create-resource-gateway.md "../../../vpc-lattice/latest/ug/create-resource-gateway.md")
   in the VPC Lattice user guide.
2. To create a resource configuration in VPC Lattice, see [Create a resource configuration](../../../vpc-lattice/latest/ug/create-resource-configuration.md "../../../vpc-lattice/latest/ug/create-resource-configuration.md")
   in the VPC Lattice user guide.
3. To share the resource with your Deadline Cloud fleet, create a resource share in AWS RAM.
   See [Creating a resource share](../../../ram/latest/userguide/working-with-sharing-create.md "../../../ram/latest/userguide/working-with-sharing-create.md") for instructions.

While creating a resource share, for **Principals**, select **Service
principal** from the dropdown, and then enter `fleets.deadline.amazonaws.com`. 4. To connect the resource configuration with your Deadline Cloud fleet, complete the following steps.
...
For more information about VPC Lattice quotas, see [Quotas for VPC Lattice](../../../vpc-lattice/latest/ug/quotas.md "../../../vpc-lattice/latest/ug/quotas.md").
