...
targets on a [best-effort basis](../../../eventbridge/latest/userguide/eb-service-event.md#eb-service-event-delivery-level "../../../eventbridge/latest/userguide/eb-service-event.md#eb-service-event-delivery-level"). Events might be delivered out of order.
