...
* **Security of the cloud** â AWS is responsible for
...
* **Security in the cloud** â Your responsibility is
...
This documentation helps you understand how to apply the shared responsibility model when
 using Deadline Cloud. The following topics show you how to configure Deadline Cloud to meet your
 security and compliance objectives. You also learn how to use other AWS services that help you
 to monitor and secure your Deadline Cloud resources. 
