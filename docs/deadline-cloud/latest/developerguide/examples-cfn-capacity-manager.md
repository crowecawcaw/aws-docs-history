...
capabilities. Set the Spot fleet's `minWorkerCount` to 0 so
that the capacity manager can scale it down to zero when the Wait and Save
fleet is at full capacity.
