...
[Monitor role](security-iam-service-roles.md#monitor-role "security-iam-service-roles.md#monitor-role") and [Managing users](../userguide/managing-users.md "../userguide/managing-users.md").
