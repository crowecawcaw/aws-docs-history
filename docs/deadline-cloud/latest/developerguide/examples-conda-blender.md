...
+ [blender-flipfluids](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/conda_recipes/blender-flipfluids): FLIP Fluids physics simulation add-on for Blender.
+ [blender-plugin-bundle](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/conda_recipes/blender-plugin-bundle): A bundle of Blender plugins packaged together.
