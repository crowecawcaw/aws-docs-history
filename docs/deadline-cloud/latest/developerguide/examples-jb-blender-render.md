...
parameter space that creates a task for each frame in the Frames job
parameter, and a short script that substitutes job parameters and the Frame
task parameter into a command for each task.
...
environment. The
[blender-4.5
conda recipe](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/conda_recipes/blender-4.5 "https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/conda_recipes/blender-4.5") and other Blender recipes in the samples repository
build conda packages you can publish to your queue's S3 conda channel.
