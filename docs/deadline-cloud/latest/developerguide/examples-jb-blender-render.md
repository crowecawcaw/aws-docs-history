...
To run this bundle, your queue needs Blender available through a queue environment. The samples repository on the GitHub website includes the [blender-4.5 conda recipe](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/conda_recipes/blender-4.5) and other Blender recipes that build conda packages you can publish to your queue's S3 conda channel.
