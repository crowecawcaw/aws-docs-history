...
The
[rez\_shim](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/queue_environments/rez_shim "https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/queue_environments/rez_shim")
variant on the GitHub website applies a resolved Rez context to each task by wrapping its
command instead of replaying environment variables. Choose it if your
Rez packages configure software with anything other than plain
environment variables, such as an `alias` for a launcher, a
