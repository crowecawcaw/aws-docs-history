...
program called a _worker agent_. The worker agent is responsible
for:
...
_after_ your software is deployed and working as expected. This
...
![An illustration of the relationship between agent-users and the jobRunAsUser on queues.](images/worker_users_and_groups.png)
