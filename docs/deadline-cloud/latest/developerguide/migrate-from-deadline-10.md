...
| Pulse (house cleaning, pending job scan) | The service performs scheduling and maintenance. On a CMF, you're<br>responsible for worker host health. A health check template is available in the<br>[CMF<br>farm templates](https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/cloudformation/farm_templates/cmf_templates "https://github.com/aws-deadline/deadline-cloud-samples/tree/mainline/cloudformation/farm_templates/cmf_templates") sample on the GitHub website. |
...
| `deadlinecommand` and the REST API       | The [deadline<br>CLI](https://github.com/aws-deadline/deadline-cloud "https://github.com/aws-deadline/deadline-cloud") on the GitHub website, the [Deadline Cloud API](../APIReference/Welcome.md "../APIReference/Welcome.md"), and the<br>AWS SDKs.                                                                                                                                                                                              |
...
| Application plugins and job files                                    | Open Job Description (OpenJD) job templates, packaged as job bundles.<br>Application adaptors wrap interactive applications such as Maya and Nuke.                                                        | [Open Job Description (OpenJD) templates for Deadline Cloud](build-job-bundle.md "build-job-bundle.md"), [adaptor<br>runtime](https://github.com/OpenJobDescription/openjd-adaptor-runtime-for-python "https://github.com/OpenJobDescription/openjd-adaptor-runtime-for-python") on the GitHub website |
