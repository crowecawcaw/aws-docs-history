...
To help solve this, you can use *limits* for these constrained
...
Deadline Cloud provides two AWS CloudFormation metrics to help you monitor the resources provided by a
 ...
 resources available in the limit. For more information, see [Resource limit metrics](cloudwatch-metrics.md#cloudwatch-metrics-limits "cloudwatch-metrics.md#cloudwatch-metrics-limits") in the *Deadline Cloud Developer Guide*.
