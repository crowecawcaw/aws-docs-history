...
- DDL statements in the CQL language reference: [Tables](cql.ddl.table.md "cql.ddl.table.md")
- Table resource management: [Managing serverless resources in Amazon Keyspaces (for Apache Cassandra)](serverless_resource_management.md "serverless_resource_management.md")
...
table, proceed to [Create, read, update, and delete data (CRUD) using CQL in Amazon Keyspaces](getting-started.dml.md "getting-started.dml.md").
