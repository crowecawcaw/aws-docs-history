...
You can label Amazon Keyspaces (for Apache Cassandra) resources using _tags_. Tags let you categorize
your resources in different ways—for example, by purpose, owner, environment, or other
