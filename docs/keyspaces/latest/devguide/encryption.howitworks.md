...
[ALTER TABLE](cql.ddl.keyspace.md#cql.ddl.keyspace.alter "cql.ddl.keyspace.md#cql.ddl.keyspace.alter") statement. The process of
...
- You can use AWS CloudTrail and Amazon CloudWatch Logs to track the requests that Amazon Keyspaces sends to AWS KMS on
  your behalf. For more information, see [Step 6: Configure monitoring with AWS CloudTrail](encryption.customermanaged.md#encryption-cmk-trail "encryption.customermanaged.md#encryption-cmk-trail").
