...
- [Create temporary credentials to connect to Amazon Keyspaces using an IAM role and the SigV4 plugin](temporary.credentials.IAM.md "temporary.credentials.IAM.md")
- [Create an IAM user for programmatic access to Amazon Keyspaces in your AWS account](access.credentials.IAM.md "access.credentials.IAM.md")
- [Create new access keys for an IAM user](create.keypair.md "create.keypair.md")
- [Store access keys for programmatic access](aws.credentials.manage.md "aws.credentials.manage.md")
