...
- [Cassandra Query Language (CQL) elements in Amazon Keyspaces](cql.elements.md "cql.elements.md")
- [DDL statements (data definition language) in Amazon Keyspaces](cql.ddl.md "cql.ddl.md")
- [DML statements (data manipulation language) in Amazon Keyspaces](cql.dml.md "cql.dml.md")
- [Built-in functions in Amazon Keyspaces](cql.functions.md "cql.functions.md")
