...
- [Inserting and loading data into an Amazon Keyspaces table](getting-started.dml.create.md "getting-started.dml.create.md")
- [Read data from a table using the CQL SELECT statement in Amazon Keyspaces](getting-started.dml.read.md "getting-started.dml.read.md")
- [Update data in an Amazon Keyspaces table using CQL](getting-started.dml.update.md "getting-started.dml.update.md")
- [Delete data from a table using the CQL DELETE statement](getting-started.dml.delete.md "getting-started.dml.delete.md")
