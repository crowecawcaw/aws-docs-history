...
In the [Inserting and loading data into an Amazon Keyspaces table](getting-started.dml.create.md "getting-started.dml.create.md") section, you used the
...
- [Select all the data in your table](#getting-started.dml.read.all "#getting-started.dml.read.all")
- [Select a subset of columns](#getting-started.dml.read.columns "#getting-started.dml.read.columns")
