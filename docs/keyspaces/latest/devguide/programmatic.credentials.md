...
plugin, see [Using a Cassandra client driver to access Amazon Keyspaces programmatically](programmatic.drivers.md "programmatic.drivers.md").

###### Topics

- [Create service-specific credentials](programmatic.credentials.ssc.md "programmatic.credentials.ssc.md")
- [Create IAM credentials for AWS authentication](access.credentials.md "access.credentials.md")
