...
The recommended design pattern to check when a new keyspace is ready for use is to poll the Amazon Keyspaces system schema tables (system\_schema\_mcs.\*). 
...
The recommended design pattern to check when a new table is ready for use is to poll the Amazon Keyspaces system schema tables (system\_schema\_mcs.\*). 
