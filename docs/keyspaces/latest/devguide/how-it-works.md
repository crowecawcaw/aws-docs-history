...
**Topics**
+ [High-level architecture: Apache Cassandra vs. Amazon Keyspaces](#how-it-works.cassandra-arch)
+ [Cassandra data model](#how-it-works.data-model)
+ [Accessing Amazon Keyspaces from an application](#how-it-works.keyspaces-arch.accessing)
