...
For a complete example of a Java client driver connection, see [Using a Cassandra Java client driver to access Amazon Keyspaces programmatically](using_java_driver.md "using_java_driver.md").
