...
2. In the **Capacity settings** section, choose **Edit**. You
   ...
   sections. For more information about these settings, see [Create a new table with automatic scaling](autoscaling.createTable.md "autoscaling.createTable.md").
