...
![Implementing the ZDM dual write proxy for migrating data from Apache Cassandra to Amazon Keyspaces.](https://docs.aws.amazon.com/keyspaces/latest/devguide/images/migration/online-migration-zdm.png)
...
![Implementing dual writes at the application layer when migrating from Apache Cassandra to Amazon Keyspaces.](https://docs.aws.amazon.com/keyspaces/latest/devguide/images/migration/online-migration-dual-writes.png)
