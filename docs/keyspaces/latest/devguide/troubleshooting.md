...
- Increase the _provisioned throughput_ for the table, which is the maximum
  ...
  see [Read capacity units and write capacity units](ReadWriteCapacityMode.md#ReadWriteCapacityMode.Provisioned.Units "ReadWriteCapacityMode.md#ReadWriteCapacityMode.Provisioned.Units").
