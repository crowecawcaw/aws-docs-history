...
the public DNS name of your instance. (See [Step 1: Launch an Amazon EC2 instance](vpc-endpoints-tutorial.launch-ec2-instance.md "vpc-endpoints-tutorial.launch-ec2-instance.md")).
...
7. To confirm that your VPC endpoint has been configured correctly, you have to use a `cqlsh`
   ...
   instructions in [Using cqlsh to connect to Amazon Keyspaces](programmatic.cqlsh.md "programmatic.cqlsh.md").
