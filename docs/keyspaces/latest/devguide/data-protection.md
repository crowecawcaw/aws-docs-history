...
applies to data protection in Amazon Keyspaces (for Apache Cassandra). As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with Amazon Keyspaces or other AWS services
...
- [Encryption in transit in Amazon Keyspaces](encryption-in-transit.md "encryption-in-transit.md")
- [Internetwork traffic privacy in Amazon Keyspaces](inter-network-traffic-privacy.md "inter-network-traffic-privacy.md")
