...
![Console screenshot that shows the NoSQL Workbench start page.](images/workbench/key_nosql_welcome.png)
...
![Console screenshot that shows the data modeler start page.](images/workbench/key_nosql_datamodel.png)
Each of the options opens the NoSQL Workbench data modeler. To continue creating a new
data model, see [Create a new data model with NoSQL Workbench](workbench.datamodel.new.md "workbench.datamodel.new.md"). To edit an existing data
model, see [Edit existing data models with NoSQL Workbench](workbench.datamodel.edit.md "workbench.datamodel.edit.md").
