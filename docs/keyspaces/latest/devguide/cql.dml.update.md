...
To increment a `counter`, use the following syntax. For more
information, see [Counters](cql.elements.md#cql.data-types.numeric.counters "cql.elements.md#cql.data-types.numeric.counters").
...
`UPDATE` supports the following values as
`update_parameter`:
