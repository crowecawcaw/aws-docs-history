...
To learn more about how to commit changes, see [How to commit data models to Amazon Keyspaces and Apache Cassandra](workbench.commit.md "workbench.commit.md").
