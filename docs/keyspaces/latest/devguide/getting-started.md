...
- **Step 3: Clean up resources** – To avoid incurring charges for unused resources, this section
  ...
  client drivers, see [Using a Cassandra client driver to access Amazon Keyspaces programmatically](programmatic.md "programmatic.md"). For code examples using different AWS SDKs, see [Code examples for Amazon Keyspaces using AWS SDKs](service_code_examples.md "service_code_examples.md").
...
- [Create, read, update, and delete data (CRUD) using CQL in Amazon Keyspaces](getting-started.md "getting-started.md")
