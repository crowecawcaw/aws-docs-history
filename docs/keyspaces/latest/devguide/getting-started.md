...
- [Tutorial prerequisites and considerations](getting-started.before-you-begin.md "getting-started.before-you-begin.md")
...
- [Create a table in Amazon Keyspaces](getting-started.tables.md "getting-started.tables.md")
- [Check table creation status in Amazon Keyspaces](tables-create.md "tables-create.md")
- [Create, read, update, and delete data (CRUD) using CQL in Amazon Keyspaces](getting-started.dml.md "getting-started.dml.md")
- [Delete a table in Amazon Keyspaces](getting-started.clean-up.table.md "getting-started.clean-up.table.md")
- [Delete a keyspace in Amazon Keyspaces](getting-started.clean-up.keyspace.md "getting-started.clean-up.keyspace.md")
