...
1.  You need to authorize inbound SSH traffic to your Amazon EC2 instance. To do this,
    ...
    4.  Choose the Amazon EC2 instance that you launched in [Step 1: Launch an Amazon EC2 instance](vpc-endpoints-tutorial.md "vpc-endpoints-tutorial.md").
...
the public DNS name of your instance. (See [Step 1: Launch an Amazon EC2 instance](vpc-endpoints-tutorial.md "vpc-endpoints-tutorial.md")).
...
7. To confirm that your VPC endpoint has been configured correctly, you have to use a `cqlsh`
   ...
   instructions in [Using cqlsh to connect to Amazon Keyspaces](programmatic.md "programmatic.md").
