...
| Asia Pacific (Hyderabad) | ap-south-2 |  cassandra-streams.ap-south-2.api.aws  | HTTPS | 
| Asia Pacific (Jakarta) | ap-southeast-3 |  cassandra-streams.ap-southeast-3.api.aws  | HTTPS | 
| Asia Pacific (Malaysia) | ap-southeast-5 |  cassandra-streams.ap-southeast-5.api.aws  | HTTPS | 
| Asia Pacific (Melbourne) | ap-southeast-4 |  cassandra-streams.ap-southeast-4.api.aws  | HTTPS | 
| Asia Pacific (Mumbai) | ap-south-1 |  cassandra-streams.ap-south-1.api.aws  | HTTPS | 
| Asia Pacific (New Zealand) | ap-southeast-6 |  cassandra-streams.ap-southeast-6.api.aws  | HTTPS | 
| Asia Pacific (Osaka) | ap-northeast-3 |  cassandra-streams.ap-northeast-3.api.aws  | HTTPS | 
...
| Asia Pacific (Taipei) | ap-east-2 |  cassandra-streams.ap-east-2.api.aws  | HTTPS | 
...
| Canada West (Calgary) | ca-west-1 |  cassandra-streams.ca-west-1.api.aws  | HTTPS | 
...
| Europe (Milan) | eu-south-1 |  cassandra-streams.eu-south-1.api.aws  | HTTPS | 
| Europe (Paris) | eu-west-3 |  cassandra-streams.eu-west-3.api.aws  | HTTPS | 
| Europe (Spain) | eu-south-2 |  cassandra-streams.eu-south-2.api.aws  | HTTPS | 
| Europe (Stockholm) | eu-north-1 |  cassandra-streams.eu-north-1.api.aws  | HTTPS | 
| Europe (Zurich) | eu-central-2 |  cassandra-streams.eu-central-2.api.aws  | HTTPS | 
| Israel (Tel Aviv) | il-central-1 |  cassandra-streams.il-central-1.api.aws  | HTTPS | 
| Mexico (Central) | mx-central-1 |  cassandra-streams.mx-central-1.api.aws  | HTTPS | 
