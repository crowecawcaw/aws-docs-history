...
To get started with Amazon Keyspaces automatic scaling quickly, see [Configure and update Amazon Keyspaces automatic scaling policies](autoscaling.configure.md "autoscaling.configure.md").
...
- If you use the console to create a table with provisioned throughput capacity,
  ...
  scaling settings at any time. For more information, see [Turn off Amazon Keyspaces auto scaling for a table](autoscaling.turnoff.md "autoscaling.turnoff.md").
