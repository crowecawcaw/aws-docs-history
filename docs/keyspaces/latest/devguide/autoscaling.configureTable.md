...
automatically for you. For more information, see [Using service-linked roles for Amazon Keyspaces](using-service-linked-roles.md "using-service-linked-roles.md").
...
5. Select **Scale automatically** and see step 6 in
   [Create a new table with automatic scaling](autoscaling.createTable.md "autoscaling.createTable.md") to edit read and write
   capacity.
...
example, you can download the example JSON file from [auto-scaling.zip](samples/auto-scaling.zip.md "samples/auto-scaling.zip.md") and extract
...
example, see [Create a new table with automatic scaling](autoscaling.createTable.md "autoscaling.createTable.md").
