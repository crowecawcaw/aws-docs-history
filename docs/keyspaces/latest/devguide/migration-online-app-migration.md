...
![Using the blue green strategy for migrating an application from Apache Cassandra to Amazon Keyspaces.](https://docs.aws.amazon.com/keyspaces/latest/devguide/images/migration/online-migration-switch.png)
...
![Using the canary strategy for migrating an application from Apache Cassandra to Amazon Keyspaces.](https://docs.aws.amazon.com/keyspaces/latest/devguide/images/migration/online-migration-canary.png)