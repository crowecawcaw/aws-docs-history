...
1. Change the statistic from **Average** to **Sum**. This action automatically creates another metric called **ANOMALY\_DETECTION\_BAND**. For the scope of this procedure, you can ignore this by removing the checkbox on the newly generated **ad1 metric**.
