...
counter value is incremented or decremented using the [UPDATE](cql.dml.update.md "cql.dml.update.md") statement, and it cannot be set directly.
...
functional differences with Apache Cassandra, see [FROZEN collections](functional-differences.md#functional-differences.frozen-collections "functional-differences.md#functional-differences.frozen-collections"). For more information
about CQL syntax, see [CREATE TABLE](cql.ddl.table.md#cql.ddl.table.create "cql.ddl.table.md#cql.ddl.table.create") and [ALTER TABLE](cql.ddl.table.md#cql.ddl.table.alter "cql.ddl.table.md#cql.ddl.table.alter").
...
For more information about CQL syntax, see [User-defined types (UDTs)](cql.ddl.type.md "cql.ddl.type.md"). For more information about
