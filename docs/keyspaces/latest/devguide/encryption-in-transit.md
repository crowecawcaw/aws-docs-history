...
To learn how to encrypt `cqlsh` connections to Amazon Keyspaces using TLS, see [How to manually configure cqlsh connections for TLS](programmatic.md#encrypt_using_tls "programmatic.md#encrypt_using_tls"). To learn how to use TLS encryption with client drivers,
see [Using a Cassandra client driver to access Amazon Keyspaces programmatically](programmatic.md "programmatic.md").
