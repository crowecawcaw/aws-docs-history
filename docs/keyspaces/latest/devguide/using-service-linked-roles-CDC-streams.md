...
For more information about KeyspacesCDCServiceRolePolicy, see [AWS managed policy: KeyspacesCDCServiceRolePolicy](security-iam-awsmanpol.md#security-iam-awsmanpol-KeyspacesCDCServiceRolePolicy "security-iam-awsmanpol.md#security-iam-awsmanpol-KeyspacesCDCServiceRolePolicy").
