...
![Diagram showing three different accounts in owned by the same organization in the same AWS Region without a shared VPC.](https://docs.aws.amazon.com/keyspaces/latest/devguide/images/keyspaces_cross-account_noVPC.png)
