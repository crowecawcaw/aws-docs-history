...
**Topics**
+ [Write consistency levels](#WriteConsistency)
+ [Read consistency levels](#ReadConsistency)
+ [Unsupported consistency levels](#UnsupportedConsistency)
...
| LOCAL\_ONE | 0.5 RCUs | 0.5 RRUs | 
| LOCAL\_QUORUM | 1 RCU | 1 RRU | 
