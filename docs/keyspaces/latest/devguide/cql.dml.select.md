...
For a table that maps JSON-encoded data types to Amazon Keyspaces data types, see [JSON encoding of Amazon Keyspaces data types](cql.elements.md#cql.data-types.JSON "cql.elements.md#cql.data-types.JSON").
...
statement, see [Use the IN operator with the SELECT statement in a query in Amazon Keyspaces](in.select.md "in.select.md").
