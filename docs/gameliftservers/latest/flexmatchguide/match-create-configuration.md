...
**Topics**
+ [Tutorial: Create a matchmaker for Amazon GameLift Servers hosting](match-create-configuration-withqueue.md)
+ [Tutorial: Create a matchmaker for standalone FlexMatch](match-create-configuration-standalone.md)
+ [Tutorial: Edit a matchmaking configuration](match-create-configuration-edit.md)