...
**Topics**
+ [Configure a basic matchmaker](#match-configuration-elements)
+ [Choose a location for the matchmaker](match-configuration-regions.md)
+ [Add optional elements](match-configuration-options.md)
