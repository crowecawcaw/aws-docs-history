...
**Topics**
+ [Set up EventBridge events](#match-notification-cwe)
+ [Tutorial: Set up an Amazon SNS topic](match-notification-sns.md)
+ [Set up an SNS topic with server-side encryption](queue-notification-sns-sse.md)
+ [Configure a topic subscription to invoke a Lambda function](match-notification-lambda.md)
