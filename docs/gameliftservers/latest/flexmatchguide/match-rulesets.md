...
The topics in this section describe how to design and build a matchmaking rule set. When creating a rule set, you can use either the Amazon GameLift Servers console or the AWS CLI.
