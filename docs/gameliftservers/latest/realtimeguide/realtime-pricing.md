...
With Amazon GameLift Servers Realtime you pay for the managed EC2 hosting resources and services you use to host Realtime servers.
There's no additional charge for use of the Realtime servers themselves.
