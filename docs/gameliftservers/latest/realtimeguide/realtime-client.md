...
1. Add the following functionality to your game client. See the [Amazon GameLift Servers Realtime client API (C\#) reference](realtime-sdk-csharp-ref.md) for more information. 
...
1. Set up event handlers for the client callbacks as needed. See [Amazon GameLift Servers Realtime client API (C\#) reference: Asynchronous callbacks](realtime-sdk-csharp-ref-callbacks.md).
