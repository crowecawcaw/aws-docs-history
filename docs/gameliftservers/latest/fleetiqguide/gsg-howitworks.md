...
resource management tools that you get with Amazon EC2 and Amazon EC2 Auto Scaling. In addition to offering a slate
...
manage your Amazon EC2 and Amazon EC2 Auto Scaling resources and integrate as needed with other AWS
services.
...
define configuration settings for an Amazon EC2 Auto Scaling group. However, instead of creating an Amazon EC2 Auto Scaling group
directly, you create a Amazon GameLift Servers FleetIQ game server group with your Amazon EC2 and Amazon EC2 Auto Scaling resources and
configuration. This action prompts Amazon GameLift Servers FleetIQ to create both a game server group and a
corresponding Amazon EC2 Auto Scaling group. The game server group is linked to and manages certain aspects of
the Amazon EC2 Auto Scaling group.

After the Amazon EC2 Auto Scaling group is created, you have full access to your Amazon EC2 and Amazon EC2 Auto Scaling resources.
You can change the configuration of your Amazon EC2 Auto Scaling groups, add multi-level scaling policies or
...
updates to certain Amazon EC2 Auto Scaling group properties. You can track the availability status of all
instances deployed by the Amazon EC2 Auto Scaling group.
