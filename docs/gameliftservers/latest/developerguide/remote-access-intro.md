...
You can connect to any instance in your active Amazon GameLift Servers managed EC2 or managed container fleets. For
container fleets, you can also connect to individual containers running on an instance to
troubleshoot game sessions, inspect logs, and debug runtime issues. Common reasons to
