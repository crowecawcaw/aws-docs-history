...
With a basic game hosting solution in place, use the following topics to customize and enhance it to improve
the player experience, optimize costs, and add advanced functionality. This section covers various customization
options organized by the component they primarily affect. Choose the customizations
that best fit your game's requirements and player base.
...
- [Hosting resource customizations](fleets-design.md "fleets-design.md")
  ...
  - [Optimize game server runtime configuration on managed Amazon GameLift Servers](fleets-multiprocess.md "fleets-multiprocess.md")
