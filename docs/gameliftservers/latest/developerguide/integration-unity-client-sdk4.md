...
**Topics**
+ [Prerequisites](#integration-unity-client-sdk4-prereq)
+ [Initialize a game client](#integration-unity-client-sdk4-initialize)
+ [Create game session on a specific fleet](#integration-unity-client-sdk4-game-session)
+ [Add players to game sessions](#integration-unity-client-sdk4-add-player)
+ [Remove a player from a game session](#integration-unity-client-sdk4-remove-player)
