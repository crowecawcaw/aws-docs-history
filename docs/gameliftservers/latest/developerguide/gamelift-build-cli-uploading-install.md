...
Amazon GameLift Servers runs the install script during fleet creation to establish an Amazon Machine Image (AMI) that is used on all future fleet instances. The script is not run at the start of each new instance.
