...
[C\# server SDK 5.x for Amazon GameLift Servers -- Data types](integration-server-sdk5-csharp-datatypes.md)
...
+ [ListContainersNetworkInfo()](#integration-server-sdk5-csharp-listcontainersnetworkinfo)
...
<a name="integration-server-sdk5-csharp-listcontainersnetworkinfo"></a>
...
### Syntax
<a name="integration-server-sdk5-csharp-listcontainersnetworkinfo-syntax"></a>
...
### Return value
<a name="integration-server-sdk5-csharp-listcontainersnetworkinfo-return"></a>

Returns a [ListContainersNetworkInfoOutcome](integration-server-sdk5-csharp-datatypes.md#integration-server-sdk5-csharp-datatypes-listcontainersnetworkinfooutcome) object.

### Example
<a name="integration-server-sdk5-csharp-listcontainersnetworkinfo-example"></a>
