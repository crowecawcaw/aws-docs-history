...
containing your server script, follow the instructions in [Set up an IAM service role for Amazon GameLift Servers](setting-up-role.md "setting-up-role.md"). After you
...
IAM `PassRole` permission, as described in [IAM permission examples for Amazon GameLift Servers](gamelift-iam-policy-examples.md "gamelift-iam-policy-examples.md").
