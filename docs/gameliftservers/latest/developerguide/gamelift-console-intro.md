...
- **Use the dashboard for a high-level snapshot.** You can see the
  numbers and current status of all your Amazon GameLift Servers hosting resources and follow links to
  get details on individual resources.
- **Manage individual hosting resources.** You can create, view,
  and delete all Amazon GameLift Servers resources, and update their mutable properties. You can also
  view certain types of hosting activity, such as events and performance
  metrics.
