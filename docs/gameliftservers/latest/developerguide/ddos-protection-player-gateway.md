...
<a name="ddos-protection-player-gateway"></a>
...
Player gateway is provided at no additional charge when you use Amazon GameLift Servers. It requires game servers to run on Linux-based Amazon GameLift Servers Managed EC2 fleets or Container Fleets. You must enable player gateway during fleet creation and update your game client and game backend to use this feature.

## Key benefits
<a name="ddos-protection-player-gateway-benefits"></a>

Player gateway provides the following security and operational benefits beyond the baseline DDoS protection:
...
+ **No additional cost** – Player gateway is included at no additional charge with Amazon GameLift Servers.

## Prerequisites
<a name="ddos-protection-player-gateway-prerequisites"></a>

To use player gateway, you need the following:
+ Game servers running on Linux-based Amazon GameLift Servers Managed EC2 fleets or Container Fleets.
