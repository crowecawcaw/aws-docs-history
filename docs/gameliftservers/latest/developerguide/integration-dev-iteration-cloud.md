...
+ **Package a game server build for Amazon GameLift Servers. **The workflow provides a script to build a sample C\+\+ game server, which has already been integrated with the server SDK for Amazon GameLift Servers version 5.x and is ready for hosting. Alternatively, you can work with your own game project if you've completed integration.
