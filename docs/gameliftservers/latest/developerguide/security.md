...
Cloud security at AWS is the highest priority. As an AWS
customer, you benefit from data centers and network architectures that are built to meet the
...
- **Security of the cloud** – AWS is
  ...
  programs that apply to Amazon GameLift Servers, see [AWS services in scope
...
- **Security in the cloud** – Your responsibility
  ...
  using Amazon GameLift Servers. The following topics show you how to configure Amazon GameLift Servers to meet your
  security and compliance objectives. You also learn how to use other AWS services that help
  you to monitor and secure your Amazon GameLift Servers resources.

###### Topics

- [Data protection in Amazon GameLift Servers](data-protection.md "data-protection.md")
- [Identity and access management for Amazon GameLift Servers](security-iam.md "security-iam.md")
- [Logging and monitoring with Amazon GameLift Servers](logging-and-monitoring.md "logging-and-monitoring.md")
