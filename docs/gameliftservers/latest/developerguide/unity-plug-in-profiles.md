...
1. In the Unity main toolbar, choose the Amazon GameLift Servers menu, and select **AWS Access Credentials**. This action opens the Amazon GameLift Servers plugin to
...
3. If you don't already have a user profile, you're prompted to enter profile details
   ...
   - AWS region. This is a geographic location where you want to create
     your AWS resources for hosting. During development, we recommend using
     a region close to your physical location. Choose a region from the list
     of [supported AWS regions](../../../general/latest/gr/gamelift.md "../../../general/latest/gr/gamelift.md").
