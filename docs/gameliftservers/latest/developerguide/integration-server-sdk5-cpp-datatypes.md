...
| Port                      | The port number for the game session. To connect to a Amazon GameLift Servers game<br>server, an app needs both the IP address and port number.<br>**Type:**<br>`in`<br>**Required**: No                                                                                                                                                                                                                                                                                        |
| IpAddress                 | The IP address of the game session. To connect to a Amazon GameLift Servers game<br>server, an app needs both the IP address and port number.<br>**Type:**<br>`std::string`<br>**Required**: No                                                                                                                                                                                                                                                                                 |
