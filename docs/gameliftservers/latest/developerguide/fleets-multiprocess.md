...
You can set up a managed EC2 fleet's runtime configuration to run multiple game server processes per instance. This uses your hosting resources more efficiently.
