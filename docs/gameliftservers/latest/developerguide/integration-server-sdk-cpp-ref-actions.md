...
**Note**  
This reference is for an earlier version of the server SDK for Amazon GameLift Servers. For the latest version, see [C\+\+ server SDK 5.x for Amazon GameLift Servers -- Actions](integration-server-sdk5-cpp-actions.md).

[C\+\+ server SDK for Amazon GameLift Servers 4.x -- Data types](integration-server-sdk-cpp-ref-datatypes.md)
