...
7. Skip the optional **Event notification settings**
   ...
   placement requests by polling with[DescribeGameSessionPlacement](../apireference/API_DescribeGameSessionPlacement.md "../apireference/API_DescribeGameSessionPlacement.md"). For more details, see [Set up event notification for game session placement](queue-notification.md "queue-notification.md").
