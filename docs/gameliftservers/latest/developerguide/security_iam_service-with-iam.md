...
| IAM features you can use with Amazon GameLift Servers                                                                                                                       | IAM feature | Amazon GameLift Servers support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------- |
...
To get a high-level view of how Amazon GameLift Servers and other AWS services work with most
IAM features, see [AWS
...
For a list of Amazon GameLift Servers actions, see [Actions defined by Amazon GameLift Servers](../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-actions-as-permissions "../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-actions-as-permissions") in the
...
For a list of Amazon GameLift Servers resource types and their ARNs, see
[Resources defined by Amazon GameLift Servers](../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
Some Amazon GameLift Servers resources have ARN values, which allows the resources to have
their access managed using IAM policies. The Amazon GameLift Servers fleet resource has an
ARN with the following syntax:
...
`fleet-2222bbbb-33cc-44dd-55ee-6666ffff77aa` fleet in your statement,
...
For a list of Amazon GameLift Servers condition keys, see
[Condition keys for Amazon GameLift Servers](../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-policy-keys "../../../service-authorization/latest/reference/list_amazongamelift.md#amazongamelift-policy-keys") in the _Service Authorization Reference_. To learn with
...
Changing the permissions for a service role might break Amazon GameLift Servers
functionality. Edit service roles only when Amazon GameLift Servers provides guidance to do
so.

Allow your Amazon GameLift Servers-hosted game servers to access other AWS resources, such as an
AWS Lambda function or an Amazon DynamoDB database. Because game servers are hosted on
...
services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_. Find a service in the table that includes
a `Yes` in the **Service-linked roles** column. Choose
**Yes** to view the service-linked role documentation for that
service.
