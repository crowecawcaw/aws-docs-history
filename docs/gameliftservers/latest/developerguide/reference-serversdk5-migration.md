...
5. When uploading your game build to Amazon GameLift Servers (such as with [upload-build](../../../cli/latest/reference/gamelift/upload-build.md "../../../cli/latest/reference/gamelift/upload-build.md") or [CreateBuild()](../apireference/API_CreateBuild.md "../apireference/API_CreateBuild.md")), set the `ServerSdkVersion` parameter to
