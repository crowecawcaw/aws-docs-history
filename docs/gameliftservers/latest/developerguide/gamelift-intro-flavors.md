...
**Topics**
+ [Managed EC2](#gamelift-intro-flavors-hosting-managed-ec2)
+ [Managed containers](#gamelift-intro-flavors-hosting-managed-containers)
+ [Anywhere hosting](#gamelift-intro-flavors-hosting-anywhere)
+ [Hybrid hosting](#gamelift-intro-flavors-hosting-hybrid)
