...
1. To activate a game session, call `ActivateGameSession()`. For more information about the SDK, see [C\# server SDK for Amazon GameLift Servers 4.x -- Actions](integration-server-sdk-csharp-ref-actions.md).
