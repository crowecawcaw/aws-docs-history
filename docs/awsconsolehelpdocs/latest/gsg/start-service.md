...
The [AWS Management Console](https://console.aws.amazon.com/ "https://console.aws.amazon.com/") provides multiple ways for
navigating to individual service consoles.
...
- On the navigation bar, choose **Services** to open a full
  list of services. Then choose a service under **Recently
  visited** or **All services**.
