...
The [AWS Management Console](https://console.aws.amazon.com/ "https://console.aws.amazon.com/") is a web-based application that contains and provides centralized access to all individual AWS service consoles.
...
- [Features of AWS Management Console](#console-features "#console-features")
- [Individual AWS service consoles in the AWS Management Console](individual-console.md "individual-console.md")
- [Accessing the AWS Management Console](#access-console "#access-console")
- [Accessing the AWS Management Console with mobile devices](console-device.md "console-device.md")
...
You can access the AWS Management Console at [https://console.aws.amazon.com/](https://console.aws.amazon.com/ "https://console.aws.amazon.com/").
