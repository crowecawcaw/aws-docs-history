...
AWS Management Console VPC endpoint policy. For more information, see [Implementing service control policies and VPC endpoint policies](implementing-console-private-access-policies.md "implementing-console-private-access-policies.md").
