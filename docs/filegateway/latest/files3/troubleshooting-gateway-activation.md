...
information, see [Testing your gateway's network connectivity](manage-on-premises-fgw.md#MaintenanceTestGatewayConnectivity-fgw "manage-on-premises-fgw.md#MaintenanceTestGatewayConnectivity-fgw").
