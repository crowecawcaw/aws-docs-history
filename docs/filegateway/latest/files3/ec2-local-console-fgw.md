...
<a name="ec2-local-console-fgw"></a>
...
**Topics**
+ [Logging in to your Amazon EC2 gateway local console](EC2_MaintenanceConsoleWindow-fgw.md) - Learn how to connect and log in to the gateway local console your Amazon EC2 instance by using a Secure Shell (SSH) client.
+ [Routing your gateway deployed on Amazon EC2 through an HTTP proxy](EC2_MaintenanceRoutingProxy-fgw.md) - Learn how to configure a Socket Secure version 5 (SOCKS5) proxy between AWS and a gateway deployed on an Amazon EC2 instance.
+ [Testing your gateway's network connectivity](EC2_MaintenanceTestGatewayConnectivity-fgw.md) - Learn how to use the gateway local console to test network connectivity between your gateway and various network resources.
