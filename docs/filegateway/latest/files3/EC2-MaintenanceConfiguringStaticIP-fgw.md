...
<a name="EC2-MaintenanceConfiguringStaticIP-fgw"></a>
...
1. From the **AWS Appliance Activation - Network Configuration** menu, enter the corresponding numeral for the task that you want to perform:
