...
**Topics**
+ [Deploy a default Amazon EC2 host for S3 File Gateway](ec2-quicklaunch-settings.md)
+ [Deploy a customized Amazon EC2 host for S3 File Gateway](ec2-gateway-file.md)
