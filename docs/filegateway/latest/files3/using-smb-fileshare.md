...
1. In the navigation pane, choose **This PC**. Then, on the **Computer** tab, choose **Map Network Drive**.
...
1. When you're finished, choose **Save**.
   ...
   You can turn on Access Control Lists(ACLs) on your SMB file share. For information about how to turn on ACLs, see [Using Windows ACLs to limit SMB file share access](smb-acl.md).
