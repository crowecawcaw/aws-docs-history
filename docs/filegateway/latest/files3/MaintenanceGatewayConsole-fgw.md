...
| open-support-channel | Connect to AWS Support. For instructions on how to turn on<br>AWS support access, see<br>[You want AWS Support to help troubleshoot your EC2<br>gateway](troubleshooting-EC2-gateway-issues.md#EC2-EnableAWSSupportAccess "troubleshooting-EC2-gateway-issues.md#EC2-EnableAWSSupportAccess")<br>.                                                                                          |
