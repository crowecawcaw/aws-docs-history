...
| FORCE\_DELETING | The file share is being deleted forcibly. The file share is<br>deleted immediately and data is not uploaded to AWS. The<br>FORCE\_DELETING status is transitional, and no action is<br>required.                                                                                            |
