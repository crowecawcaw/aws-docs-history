...
(have permissions) to use AWS SGW resources. IAM is an AWS service that you can
...
- [How AWS Storage Gateway works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md")
- [Identity-based policy examples for AWS Storage Gateway](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md")
- [Troubleshooting AWS Storage Gateway identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md")
- [Using tags to control access to your gateway and resources](restrict-fgw-access.md "restrict-fgw-access.md")
- [Using Windows ACLs to limit SMB file share access](smb-acl.md "smb-acl.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS Storage Gateway identity and access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
- **Service administrator** - determine user access and
  submit permission requests (see [How AWS Storage Gateway works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md"))
- **IAM administrator** - write policies to manage
  access (see [Identity-based policy examples for AWS Storage Gateway](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md"))
