...
For more information about the metrics that are used to monitor S3 File Gateway, see [Understanding gateway metrics](monitoring-file-gateway.md#understanding-file-gateway-metrics "monitoring-file-gateway.md#understanding-file-gateway-metrics") and [Understanding file share metrics](monitoring-file-gateway.md#monitoring-file-gateway-resources "monitoring-file-gateway.md#monitoring-file-gateway-resources"). For each alarm, you specify conditions
...
- Files failing upload: `FilesFailingUpload` >= 1 for 1 datapoint
  within 5 minutes
- File shares unavailable: `FileSharesUnavailable` >= 1 for 1
  datapoint within 5 minutes
...
| **None**              | No alarms are created for the gateway. To create a new alarm, see [Create a custom CloudWatch alarm for your gateway](cloudwatch-alarms-create-alarm.md "cloudwatch-alarms-create-alarm.md"). |
