...
**Topics**
+ [Accessing AWS Storage Gateway](WhatIsAPIIntro.md) - Learn how to sign up for AWS and create an AWS account.
+ [Accessing AWS Storage Gateway](WhatIsAPIIntro.md) - Learn how to create an IAM user with administrative privileges for your AWS account.
