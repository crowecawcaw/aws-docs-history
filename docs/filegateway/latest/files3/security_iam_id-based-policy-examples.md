...
By default, users and roles don't have permission to create or modify AWS SGW
...
For details about actions and resource types defined by AWS SGW, including the format of the ARNs for each of the resource types, see [Actions, Resources, and Condition Keys for AWS Storage Gateway](../../../IAM/latest/UserGuide/list_storagegateway.md "../../../IAM/latest/UserGuide/list_storagegateway.md") in the _Service Authorization Reference_.

###### Topics

- [Policy best practices](#security_iam_service-with-iam-policy-best-practices "#security_iam_service-with-iam-policy-best-practices")
- [Using the AWS SGW console](#security_iam_id-based-policy-examples-console "#security_iam_id-based-policy-examples-console")
- [Allow users to view their own permissions](#security_iam_id-based-policy-examples-view-own-permissions "#security_iam_id-based-policy-examples-view-own-permissions")

## Policy best practices

Identity-based policies determine whether someone can create, access, or delete AWS SGW resources in your
...
To access the AWS Storage Gateway console, you must have a minimum set of permissions.
These permissions must allow you to list and view details about the AWS SGW resources
...
To ensure that users and roles can still use the AWS SGW console, also attach the
AWS SGW `ConsoleAccess` or
