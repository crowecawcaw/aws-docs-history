...
and Service Message Block (SMB) clients, see [Supported NFS and SMB clients for File Gateway](Requirements.md#requirements-s3-fgw-clients "Requirements.md#requirements-s3-fgw-clients").
...
- [Mount your NFS file share on your client](GettingStartedAccessFileShare.md "GettingStartedAccessFileShare.md") - Learn how to mount your NFS
...
- [Mount your SMB file share on your client](using-smb-fileshare.md "using-smb-fileshare.md") - Learn
  ...
  client.
- [Using file shares on buckets with pre-existing objects](FileSharePrexistingObjects.md "FileSharePrexistingObjects.md") - Learn how to export a file share
