...
data recovery, and security. The on-premises gateway troubleshooting information covers
...
- [Troubleshooting: file
  share issues](troubleshooting-file-share-issues.md "troubleshooting-file-share-issues.md") - Learn about actions
  you can take if you experience unexpected issues with your file share.
