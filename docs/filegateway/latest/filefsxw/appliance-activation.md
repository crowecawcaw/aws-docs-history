...
For more information about configuring the IP address, see [Configuring network parameters](appliance-configure-network.md "appliance-configure-network.md"). 5. For **Name**, enter a name for your hardware appliance. Names can
