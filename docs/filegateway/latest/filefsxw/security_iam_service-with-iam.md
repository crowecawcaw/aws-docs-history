...
Before you use IAM to manage access to AWS SGW, learn what IAM features are
available to use with AWS SGW.

| IAM features you can use with AWS Storage Gateway                                                                                                                           | IAM feature | AWS SGW support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------- |
...
To get a high-level view of how AWS SGW and other AWS services work with most IAM
...
To see a list of AWS SGW actions, see [Actions Defined by AWS Storage Gateway](../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-actions-as-permissions "../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-actions-as-permissions") in the
...
To see a list of AWS SGW resource types and their ARNs, see [Resources Defined by AWS Storage Gateway](../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-resources-for-iam-policies")
...
To see a list of AWS SGW condition keys, see [Condition Keys for AWS Storage Gateway](../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-policy-keys "../../../IAM/latest/UserGuide/list_storagegateway.md#storagegateway-policy-keys") in the
