...
- [Create and activate an
  Amazon S3 File Gateway](../files3/create-gateway-file.md "../files3/create-gateway-file.md")
- [Create and activate
  an Amazon FSx File Gateway](create-gateway-file.md "create-gateway-file.md")
