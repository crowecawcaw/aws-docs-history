...
- Download the .ova image for your gateway type from one of the
  following:
  - File Gateway – [Create and activate an Amazon FSx File Gateway](create-gateway-file.md "create-gateway-file.md")
...
information, see [Getting FSx File Gateway health logs with CloudWatch log groups](monitoring-file-gateway.md#cw-log-groups "monitoring-file-gateway.md#cw-log-groups").
