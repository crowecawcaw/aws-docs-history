...
in the Storage Gateway console. For instructions, see [Configure your Amazon FSx File Gateway](create-gateway-file.md#configure-gateway-fsx-file "create-gateway-file.md#configure-gateway-fsx-file").
