...
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Configure an HTTP proxy for your gateway    | [Routing your gateway deployed on Amazon EC2<br>through an HTTP proxy](EC2_MaintenanceRoutingProxy-fgw.md "EC2_MaintenanceRoutingProxy-fgw.md")                   |
| Configure network settings for your gateway | [Configuring your Amazon EC2 gateway<br>network settings](EC2-MaintenanceConfiguringStaticIP-fgw.md "EC2-MaintenanceConfiguringStaticIP-fgw.md")                  |
| Test network connectivity                   | [Testing your gateway's<br>network connectivity](EC2_MaintenanceTestGatewayConnectivity-fgw.md "EC2_MaintenanceTestGatewayConnectivity-fgw.md")                   |
| View a system resource check                | [Viewing your gateway system resource<br>status](EC2_system-resource-check-fgw.md "EC2_system-resource-check-fgw.md").                                            |
| Run Storage Gateway console commands        | [Running Storage Gateway commands on the<br>local console for an Amazon EC2 gateway](EC2_MaintenanceGatewayConsole-fgw.md "EC2_MaintenanceGatewayConsole-fgw.md") |
