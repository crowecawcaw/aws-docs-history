...
1. On the **Confirm gateway** page, choose the gateway you want to join to your Active Directory domain from the drop-down menu.
   ...
   If you don't have a gateway, you must create one. Make sure your gateway can resolve the name of your Active Directory Domain Controller. For information, see [Prerequisites](Requirements.md#user-requirements).
