...
- **Security of the cloud** – AWS is responsible for
  ...
  compliance programs that apply to AWS Snowball Edge, see [AWS Services in Scope by Compliance
...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Snowball Edge. The following topics show you how to configure AWS Snowball Edge to meet your
  security and compliance objectives. You also learn how to use other AWS services
  that help you to monitor and secure your AWS Snowball Edge resources.
