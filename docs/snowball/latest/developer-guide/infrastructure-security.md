...
As a managed service, AWS Snow Family is protected by AWS global network security. For
...
You use AWS published API calls to access AWS Snow Family through the network. Clients must
