...
To view examples of AWS Snow Family identity-based policies, see [Identity-based policy examples for AWS Snowball Edge](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
