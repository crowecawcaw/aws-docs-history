...
**Action to take**  
Get your credentials from the Snowball Edge client. For more information, see [Getting credentials for a Snowball Edge](using-client-commands.md#client-credentials).