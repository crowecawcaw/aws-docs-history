...
|  [CreateCluster](https://docs.aws.amazon.com/snowball/latest/api-reference/API_CreateCluster.html) | This action requires the following permissions:+  The complete console permissions in [Permissions Required to Use the AWS Snowball Edge Console](access-control-managing-permissions.md#additional-console-required-permissions) <br />+  The additional API-only permissions in [Example 1: Role Policy That Allows a User to Create a Job to order a Snowball Edge device with the API](#access-policy-example-create-api) <br />+  `snowball:CreateCluster`  | 
|  [CreateJob](https://docs.aws.amazon.com/snowball/latest/api-reference/API_CreateJob.html) |  +  The complete console permissions in [Permissions Required to Use the AWS Snowball Edge Console](access-control-managing-permissions.md#additional-console-required-permissions) <br />+  The additional API-only permissions in [Example 1: Role Policy That Allows a User to Create a Job to order a Snowball Edge device with the API](#access-policy-example-create-api) <br />+   `snowball:CreateJob`  | 
