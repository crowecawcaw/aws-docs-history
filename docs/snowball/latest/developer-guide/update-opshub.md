...
3. Verify that **Automatic updates enabled** is selected. Automatic update is
   enabled by default.

![Updates tab showing automatic updates enabled](images/opshub-auto-update-console.png)
