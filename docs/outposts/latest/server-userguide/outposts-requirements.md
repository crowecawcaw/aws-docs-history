...
servers](local-server.md#lni-sl "local-server.md#lni-sl") in the _AWS Outposts user guide for servers_.
...
servers](../install-server/install-server.md "../install-server/install-server.md") in the _AWS Outposts user guide for servers_.
