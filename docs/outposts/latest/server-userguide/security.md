...
For more information about security and compliance for AWS Outposts, see the [AWS Outposts servers FAQ](https://aws.amazon.com/outposts/servers/faqs/#Security_and_compliance).
