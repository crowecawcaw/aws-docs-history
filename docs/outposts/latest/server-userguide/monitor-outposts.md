...
Use Amazon CloudWatch to retrieve statistics about data points for your Outposts server
...
see [CloudWatch metrics for Outposts servers](outposts-cloudwatch-metrics.md "outposts-cloudwatch-metrics.md").
...
Outposts server to out-of-band security and monitoring appliances. You can use the
