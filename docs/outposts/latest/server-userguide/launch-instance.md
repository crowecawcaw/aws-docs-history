...
**Topics**
+ [Step 1: Create a subnet](#create-subnet)
+ [Step 2: Launch an instance on the Outpost](#launch-instances)
+ [Step 3: Configure connectivity](#configure-routing)
+ [Step 4: Test the connectivity](#test-connecitivity)
