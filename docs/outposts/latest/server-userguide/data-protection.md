...
Destroying the Nitro Security Key cryptographically shreds the data on your Outpost. For more information, see [Cryptographically shred server data](outpost-maintenance.md#outpost-server-cryptographically-shred-data).