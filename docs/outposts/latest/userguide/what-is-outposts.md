...
| AWS Region              | Amazon EC2 | Amazon EBS | Amazon EBS Snapshots | Amazon S3 | Amazon RDS SQL, MySQL, PostgreSQL, and Oracle | Amazon ECS | Amazon EKS | Amazon EKS-LC | Amazon EMR | Amazon ElastiCache | CloudEndure Migrations | Elastic Disaster Recovery | Application Load Balancer | Direct Connect | Amazon VPC | Local Gateway |
| ----------------------- | ---------- | ---------- | -------------------- | --------- | --------------------------------------------- | ---------- | ---------- | ------------- | ---------- | ------------------ | ---------------------- | ------------------------- | ------------------------- | -------------- | ---------- | ------------- |
