...
2. In the navigation pane, choose **Route tables**,
   and select the route table you created in [2b: Create a custom route table](#create-custom-routetable "#create-custom-routetable").
...
For more information, see [Local gateway
BGP connectivity](local-rack.md#local-gateway-bgp-connectivity "local-rack.md#local-gateway-bgp-connectivity").
...
- For traffic going from on-premises to Outposts, ensure that you are receiving in your
  ...
  resources.
- For traffic going from Outposts to on-premises network, ensure that
...
For troubleshooting, see [AWS Outposts rack network
troubleshooting checklist](../network-userguide/network-troubleshoot.md "../network-userguide/network-troubleshoot.md").
