...
![Shows metrics on the Available EC2 capacity tab.](http://docs.aws.amazon.com/outposts/latest/userguide/images/outpost-rack-ec2-status.jpg)

      The following image shows the list of instance types.  
![Shows list of instance types.](http://docs.aws.amazon.com/outposts/latest/userguide/images/racks-instance-types.png)
