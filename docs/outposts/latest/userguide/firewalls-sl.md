...
| TCP      | 443         | AWS Outposts Region's public networks | 1025-65535       | AWS Outposts service link /26         |
...
AWS Outposts racks are also designed with redundant power and networking
equipment, including local gateway components. For more information, see [Resilience in AWS Outposts](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md").
