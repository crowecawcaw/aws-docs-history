...
For more information, see [Placement groups on Outposts](outposts-optimizations.md#placement-groups-outpost "outposts-optimizations.md#placement-groups-outpost").
