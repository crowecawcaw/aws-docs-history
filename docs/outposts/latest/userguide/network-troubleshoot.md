...
1. Ping the remote peer IP address on the Outpost network devices from the customer
   ...
   also refer to the [Network readiness checklist](outposts-requirements.md#checklist "outposts-requirements.md#checklist") provided to you at
...
1. If connectivity between the Outposts rack and the AWS Region is using the AWS Outposts
   ...
   4. Confirm that the network ACLs associated with the service link private endpoint in
      your VPC allow the relevant traffic. For more information, see [Network readiness checklist](outposts-requirements.md#checklist "outposts-requirements.md#checklist").
