...
![An image of the Atlas 2.0 and 3.0 NSKs with the RGB Status LED on each NSK and the green Power LED on the Atlas 3.0.](https://docs.aws.amazon.com/outposts/latest/install-server/images/nsk-led-status.png)
