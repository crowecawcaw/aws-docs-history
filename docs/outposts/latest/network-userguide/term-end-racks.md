...
For the list of Outpost resources that can be shared, see [Shareable
Outpost resources](sharing-outposts.md#sharing-resources "sharing-outposts.md#sharing-resources"). 2. Terminate the active instances associated with subnets on your Outpost. To terminate the
...
[Show moreShow less](# "#") 6. Delete any VPC associations and customer-owned IP address pool (CoIP) CIDRs associated
with your Outpost.
