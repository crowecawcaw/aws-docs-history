...
your Outpost using an Outpost subnet.
...
You can create and add an Outpost subnet to any VPC in the AWS
Region that the Outpost is homed to. When you do so, the VPC includes the Outpost. For more
...
7. For **Mode**, choose a mode for communication with your
   ...
   - Choose **Direct VPC routing** to use the private IP addresses
     of your instances.
   - Choose **CoIP** to use addresses from
     your customer-owned IP address pools. For more information, see [Create a CoIP
