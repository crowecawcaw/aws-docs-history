...
made to AWS APIs. You can use these CloudTrail logs to determine such information as which
call was made, the source IP address where the call came from, who made the call, and when
the call was made.
