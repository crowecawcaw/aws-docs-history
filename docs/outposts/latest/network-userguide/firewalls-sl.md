...
to the Outpost. An Direct Connect public virtual interface is the service link connection. The
following traffic goes over the service link and the Direct Connect connection:
