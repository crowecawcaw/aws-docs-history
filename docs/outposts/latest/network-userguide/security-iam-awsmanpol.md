...
| ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| Updates to the AWS Identity and Access Management service-linked role AWSServiceRoleForOutposts\_`OutpostID` | The \*_AWSServiceRoleForOutposts\_`OutpostID`_<br>• service-linked role permissions are<br>updated to refine how AWS Outposts manages networking resources for private<br>connectivity, with more precise controls over network interface and security<br>group operations needed for service link endpoint instances. | April 18, 2025    |
