# Amazon Corretto 21 Installation Instructions for Debian-Based,

RPM-Based and Alpine Linux Distributions

This topic describes how to install Amazon Corretto 21 on Debian-based, RPM-based and Alpine Linux
distributions.

If you need to install Amazon Corretto 21 on Amazon Linux, see
[Installing on Amazon Linux](amazon-linux-install.md "amazon-linux-install.md").

## Install Amazon Corretto 21 on Debian-Based

Linux

This section describes how to install and uninstall Amazon Corretto 21 on a host or container
...
After the repo has been added, you can install Corretto 21 by running this
command:
...
You can uninstall Amazon Corretto 21 by using the following command.

```
sudo dpkg --remove java-21-amazon-corretto-jdk
```

## Install Amazon Corretto 21 on RPM-Based
...
After the repository is added, you can install Corretto 21 by running this
command:
...
## Install Amazon Corretto 21 on Alpine
