...
```
sudo dpkg --install java-1.8.0-amazon-corretto-jdk_8.0.492.09-2_amd64.deb
```
...
```
sudo yum localinstall java-1.8.0-amazon-corretto-devel-1.8.0_492.b09-2.x86_64.rpm
```
