# Amazon Corretto 8 Installation Instructions for Debian-Based,

RPM-Based and Alpine Linux Distributions

This topic describes how to install Amazon Corretto 8 on Debian-based, RPM-based and Alpine Linux
distributions.

If you need to install Amazon Corretto 8 on Amazon Linux, see
[Installing on Amazon Linux](amazon-linux-install.md "amazon-linux-install.md").

## Install Amazon Corretto 8 on Debian-Based

Linux

This section describes how to install and uninstall Amazon Corretto 8 on a host or container
...
After the repo has been added, you can install Corretto 8 by running this
command:
...
```
sudo dpkg --install java-1.8.0-amazon-corretto-jdk_8.0.472.08-1_amd64.deb
```
...
## Install Amazon Corretto 8 on RPM-Based
...
After the repository is added, you can install Corretto 8 by running this
command:
...
```
sudo yum localinstall java-1.8.0-amazon-corretto-devel-1.8.0_472.b08-1.x86_64.rpm
```
...
## Install Amazon Corretto 8 on Alpine
