 ...
 **Prerequisite**: Amazon Corretto 8 requires Visual C\+\+ Redistributable Package for Visual Studio 2013 or newer. If it's not installed in your system, you can find it from [Microsoft Download Center](https://www.microsoft.com/en-us/download/details.aspx?id=40784) page. 
