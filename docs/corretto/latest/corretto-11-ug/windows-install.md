# Amazon Corretto 11 Installation Instructions for Windows 10 or
...
directory is used for 11.0.29, then set `JAVA_HOME` as
`C:\Program Files\Amazon Corretto\jdk11.0.29_7`.
