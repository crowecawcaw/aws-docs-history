...
This topic describes how to install and uninstall Amazon Corretto 11 on a host or container
...
Amazon Corretto 11 is installed at `C:\Program Files\Amazon
...
directory is used for 11.0.32, then set `JAVA_HOME` as
`C:\Program Files\Amazon Corretto\jdk11.0.32_10`.
...
You can uninstall Amazon Corretto 11 by following the standard steps to uninstall an
