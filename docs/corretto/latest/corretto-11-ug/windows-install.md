...
`C:\Program Files\Amazon Corretto\jdk11.0.32_9`.
...
OpenJDK Runtime Environment Corretto-11.0.32.9.1 (build 11.0.32+9-LTS)
OpenJDK 64-Bit Server VM Corretto-11.0.32.9.1 (build 11.0.32+9-LTS, mixed mode)
```
