...
This topic describes how to install and uninstall Amazon Corretto 27 on a host or container
...
Amazon Corretto 27 is installed at `C:\Program Files\Amazon
...
directory is used for 27.0.0, then set `JAVA_HOME` as
`C:\Program Files\Amazon Corretto\jdk27.0.0_33`.
...
You can uninstall Amazon Corretto 27 by following the standard steps to uninstall an
application from Windows.

1. Open **Programs and Features**.
2. Search for **Amazon Corretto 27** and then select it.
3. Choose **uninstall**.
