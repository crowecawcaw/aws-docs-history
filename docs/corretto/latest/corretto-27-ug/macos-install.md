...
This topic describes how to install and uninstall Amazon Corretto 27 on a host running the Mac
OS version 11 or later. You must have administrator permissions to install
and uninstall Amazon Corretto 27.
...
3. Once the wizard completes, Amazon Corretto 27 is installed in
...
4. Run the following command in the terminal to set the `JAVA_HOME`
   variable to the Amazon Corretto 27 version of the JDK. If this was set to another version
