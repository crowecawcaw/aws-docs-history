...
This topic describes how to install Amazon Corretto 27 on Debian-based, RPM-based and Alpine Linux
distributions.

If you need to install Amazon Corretto 27 on Amazon Linux, see
...
This section describes how to install and uninstall Amazon Corretto 27 on a host or container
...
After the repo has been added, you can install Corretto 27 by running this
command:
...
After the repository is added, you can install Corretto 27 by running this
command:
