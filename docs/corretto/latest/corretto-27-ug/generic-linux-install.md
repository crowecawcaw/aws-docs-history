...
# Amazon Corretto 27 Installation Instructions for Debian-Based, RPM-Based and Alpine Linux Distributions
<a name="generic-linux-install"></a>

This topic describes how to install Amazon Corretto 27 on Debian-based, RPM-based and Alpine Linux distributions. 

If you need to install Amazon Corretto 27 on Amazon Linux, see [Installing on Amazon Linux](amazon-linux-install.md). 

## Install Amazon Corretto 27 on Debian-Based Linux
<a name="debian-install-instruct"></a>

This section describes how to install and uninstall Amazon Corretto 27 on a host or container running a Debian-based operating system.
...
After the repo has been added, you can install Corretto 27 by running this command:

**Example**  

```
sudo apt-get update; sudo apt-get install -y java-27-amazon-corretto-jdk
```
...
1.  Install the `.deb` file by using `sudo dpkg --install`. For example install x86\_64 deb using the following command:   
**Example**  

   ```
   sudo dpkg --install java-27-amazon-corretto-jdk_27.0.0.35-1_amd64.deb
   ```
...
You can uninstall Amazon Corretto 27 by using the following command.

**Example**  

```
sudo dpkg --remove java-27-amazon-corretto-jdk
```

## Install Amazon Corretto 27 on RPM-Based Linux
...
After the repository is added, you can install Corretto 27 by running this command:

**Example**  

```
sudo yum install -y java-27-amazon-corretto-devel
```
...
```
sudo zypper install java-27-amazon-corretto-devel
```
...
1.  Install the downloaded `.rpm` file using `yum localinstall`. For example install x86\_64 rpm using the following command:   
**Example**  

   ```
   sudo yum localinstall java-27-amazon-corretto-devel-27.0.0.35-1.x86_64.rpm
   ```
...
```
sudo yum remove java-27-amazon-corretto-devel
```

## Install Amazon Corretto 27 on Alpine Linux
...
```
apk add amazon-corretto-27
```

### Uninstall Amazon Corretto 27
<a name="alpine-uninstall"></a>

You can uninstall Amazon Corretto 27 by using the following
