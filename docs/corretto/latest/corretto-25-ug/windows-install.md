...
This topic describes how to install and uninstall Amazon Corretto 25 on a host or container
...
Amazon Corretto 25 is installed at `C:\Program Files\Amazon
...
directory is used for 25.0.2, then set `JAVA_HOME` as
`C:\Program Files\Amazon Corretto\jdk25.0.2_10`.
...
You can uninstall Amazon Corretto 25 by following the standard steps to uninstall an
application from Windows.

1. Open **Programs and Features**.
2. Search for **Amazon Corretto 25** and then select it.
3. Choose **uninstall**.
