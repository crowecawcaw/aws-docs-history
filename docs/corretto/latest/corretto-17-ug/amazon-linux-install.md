...
2. You can install Amazon Corretto 17 as either the runtime environment (JRE) or the full development environment (JDK).
   The development environment includes the runtime environment.

Install Amazon Corretto 17 as JRE.
...
Install Amazon Corretto 17 as JDK.
