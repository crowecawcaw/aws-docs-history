...
This topic describes how to install Amazon Corretto 17 on Debian-based, RPM-based and Alpine Linux
distributions.

If you need to install Amazon Corretto 17 on Amazon Linux, see
[Installing on Amazon Linux](amazon-linux-install.md "amazon-linux-install.md").

## Install Amazon Corretto 17 on Debian-Based

Linux

This section describes how to install and uninstall Amazon Corretto 17 on a host or container
...
After the repo has been added, you can install Corretto 17 by running this
command:
...
```
sudo dpkg --install java-17-amazon-corretto-jdk_17.0.18.9-1_amd64.deb
```
...
## Install Amazon Corretto 17 on RPM-Based
...
After the repository is added, you can install Corretto 17 by running this
command:
...
```
sudo yum localinstall java-17-amazon-corretto-devel-17.0.18.9-1.x86_64.rpm
```
...
## Install Amazon Corretto 17 on Alpine
