...
![Deployment configuration of a container service in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/container-service-deployment-config.png)
...
![Public endpoint of a container service in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/container-service-deployment-public-endpoint-config.png)
...
![Container deployment with a localhost environment variable in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-container-service-environment-variable-localhost.png)
...
![Container deployment with a private domain environment variable in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-container-service-environment-variable-private-domain.png)
...
![Container deployment with a resource public endpoint URL environment variable in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-container-service-environment-variable-service.png)
...
![Container service deployment form in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/container-service-deployment-form.png)
