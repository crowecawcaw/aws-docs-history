...
**Contents**
+ [Step 1: Complete the prerequisites](#connect-wordpress-aurora-prerequisites)
+ [Step 2: Configure the security group for your Aurora database](#configure-wordpress-aurora-security-group)
+ [Step 3: Connect to your Aurora database from your Lightsail instance](#connect-to-aurora-from-wordpress-instance)
+ [Step 4: Transfer the MySQL database from your WordPress instance to your Aurora database](#transfer-wordpress-database-to-aurora)
+ [Step 5: Configure WordPress to connect to your Aurora managed database](#configure-wordpress-to-aurora)
...
1. Create a WordPress instance in Lightsail, and configure your application on it. The instance should be in a running state before you continue. For more information, see [Launch and configure a WordPress instance](amazon-lightsail-launch-and-configure-wordpress.md).
