...
- [Step 1: Complete the
  prerequisites](#connect-wordpress-aurora-prerequisites "#connect-wordpress-aurora-prerequisites")
- [Step 2: Configure the
  security group for your Aurora database](#configure-wordpress-aurora-security-group "#configure-wordpress-aurora-security-group")
- [Step 3:
  Connect to your Aurora database from your Lightsail instance](#connect-to-aurora-from-wordpress-instance "#connect-to-aurora-from-wordpress-instance")
- [Step 4: Transfer
  the MySQL database from your WordPress instance to your Aurora database](#transfer-wordpress-database-to-aurora "#transfer-wordpress-database-to-aurora")
- [Step 5: Configure WordPress to
  connect to your Aurora managed database](#configure-wordpress-to-aurora "#configure-wordpress-to-aurora")
...
1. Create a WordPress instance in Lightsail, and configure your application on it. The
   instance should be in a running state before you continue. For more information, see [Launch
...
3. Choose the browser-based SSH client icon for your WordPress instance to connect to it
   using SSH.
4. After you're connected to your instance, enter the following command to connect to
...
You should see a response that confirms your instance can access and connect to your Aurora database.
...
your Aurora database](#configure-wordpress-aurora-security-group "#configure-wordpress-aurora-security-group") section of this guide.
...
3. After the browser-based SSH client is connected to your WordPress instance, enter the
   following command. The command transfers the data from the `wordpress`
...
Your WordPress site is now configured to use your Aurora database.
