...
page. Monitoring metrics is an important part of maintaining the availability, and performance
of your bucket. Monitor and collect metric data from your bucket regularly so that you can
upsize or downsize the storage space and network transfer quota of your bucket when you need to.
...
- **Bucket size** — The amount of data stored in a bucket. This value
  ...
  noncurrent objects), including the size of all parts for all incomplete multipart uploads
  to the bucket.
- **Number of objects** — The total number of objects stored in a
  ...
  noncurrent objects) and the total number of parts for all incomplete multipart uploads to
  the bucket.
...
- [Create alarms](amazon-lightsail-adding-bucket-metric-alarms.md "amazon-lightsail-adding-bucket-metric-alarms.md")
