...
![Database endpoint and port in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-database-endpoint-and-port.png)
...
![MySQL Workbench connection configuration](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-connection-manager.png)
...
![MySQL Workbench successful connection test](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-successful-connection.png)
...
![MySQL Workbench workspace](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-workspace.png)
