...
<a name="amazon-lightsail-adding-distribution-health-metric-alarms"></a>
...
<a name="distribution-alarm-limits"></a>
...
<a name="distribution-alarms-best-practices"></a>
...
![Distribution requests example.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-distribution-requests-graph-example.png)
...
![Distribution metric example, with alarm line.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-networkout-transmit-graph-example-alarmed.png)


## Default alarm settings
<a name="default-distribution-alarm-settings"></a>
...
<a name="creating-distribution-alarms"></a>
...
<a name="testing-distribution-alarms"></a>
...
<a name="next-steps-creating-distribution-alarms"></a>
