...
Here are a few steps you should take to get started after your Redmine instance is up and
running on Amazon Lightsail:

**Contents**

- [Step 1: Read
  the Bitnami documentation](#amazon-lightsail-read-the-bitnami-documentation-redmine "#amazon-lightsail-read-the-bitnami-documentation-redmine")
- [Step 2: Get the
  default application password to access the Redmine administration
  dashboard](#amazon-lightsail-get-the-default-user-password-redmine "#amazon-lightsail-get-the-default-user-password-redmine")
- [Step 3:
  Attach a static IP address to your instance](#amazon-lightsail-attach-static-ip-redmine "#amazon-lightsail-attach-static-ip-redmine")
- [Step 4: Sign in to
  the administration dashboard of your Redmine website](#amazon-lightsail-sign-in-redmine "#amazon-lightsail-sign-in-redmine")
- [Step 5:
  Route traffic for your registered domain name to your Redmine
  website](#amazon-lightsail-map-your-domain-to-your-instance-redmine "#amazon-lightsail-map-your-domain-to-your-instance-redmine")
- [Step 6: Configure
  HTTPS for your Redmine website](#amazon-lightsail-https-redmine "#amazon-lightsail-https-redmine")
- [Step 7:
  Read the Redmine documentation and continue configuring your
  website](#amazon-lightsail-read-documentation-redmine "#amazon-lightsail-read-documentation-redmine")
- [Step 8:
...
administrative changes. For more information about what you can do in Joomla!, see the
[Step 7:
Read the Redmine documentation and continue configuring your website](#amazon-lightsail-read-documentation-redmine "#amazon-lightsail-read-documentation-redmine") section
later in this guide.
...
redirected to the home page of your Redmine website. Next, you should generate and
configure an SSL/TLS certificate to enable HTTPS connections for your Redmine website.
...
route traffic to your Redmine instance. Otherwise, the SSL/TLS certificate
...
You are now done enabling HTTPS on your Redmine instance. Next time you browse
