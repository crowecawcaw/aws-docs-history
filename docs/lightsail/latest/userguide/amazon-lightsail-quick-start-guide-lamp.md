...
![LAMP blueprint vendor on the instance management page](images/instances/headers/lamp-blueprint-vendor.png)
...
application password for your LAMP instance
...
1. On your instance management page, under the **Connect** tab, choose
   **Connect using SSH**.
2. After you're connected, enter the following command to get the application
   password:
...
## Step 3: Visit your LAMP instance welcome
...
domain name to your LAMP instance
...
choose **Create DNS zonelamp**, then follow the instructions on the page.
...
Read the Bitnami documentation to learn how to deploy your application, enable HTTPS
...
Lightsail LAMP website with Let's Encrypt SSL/TLS](amazon-lightsail-using-lets-encrypt-certificates-with-lamp.md "amazon-lightsail-using-lets-encrypt-certificates-with-lamp.md").
