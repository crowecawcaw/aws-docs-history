...
- [Keep automatic snapshots from being replaced in Lightsail](amazon-lightsail-keeping-automatic-snapshots.md "amazon-lightsail-keeping-automatic-snapshots.md")
...
1. Complete the following prerequisites if you haven't already.
   ...
   3. (Optional) Use AWS CloudShell. For more information, see [Manage Lightsail resources with AWS CloudShell](amazon-lightsail-cloudshell.md "amazon-lightsail-cloudshell.md").
