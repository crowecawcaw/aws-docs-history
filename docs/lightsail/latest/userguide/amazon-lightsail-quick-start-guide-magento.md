...
Configure the SMTP settings of your Magento website to enable email notifications for it. For more information, see [Install the Magento Magepal SMTP extension](https://docs.bitnami.com/general/apps/magento/configuration/install-extension-smtp/) in the *Bitnami documentation*.
...
Read the Bitnami documentation to learn how to perform administrative tasks on your Magento instance and website, such as install plugins and customize the theme. For more information, see [Bitnami Magento Stack for AWS Cloud](https://docs.bitnami.com/general/apps/magento/) in the *Bitnami documentation*.
