...
You can use the Microsoft Remote Desktop client to connect to your Windows instance from
your macOS computer. Microsoft Remote Desktop requires that you use the administrator user name
and password for your Lightsail Windows instance. This can be the default password assigned to
the instance when it is created, or your own password if you changed the default
password.

This topic walks you through the steps to obtain your default administrator password from
the Lightsail console, and configure Microsoft Remote Desktop to connect to your Windows
instance. You can also connect to your instance from within the Lightsail console using your
...
6. Choose **Show default password** to obtain the Windows administrator
   password for your instance.

![The Show default password option in the Lightsail Instance Connect tab.](images/connect-using-remote-desktop-mac-01.png)

The prompt displays the default administrator password for your Windows
instance.
...
1. Open the App Store on your Mac, and search for **Microsoft Remote
   Desktop**.
2. Find the **Microsoft Remote Desktop** app in the search results, and
...
instance. 6. Choose **Add**.

![The Add button.](images/connect-using-remote-desktop-mac-05.png) 7. Right-click the icon for your instance, and choose
**Connect**.

![The Connect option in the Microsoft Remote Desktop application.](images/connect-using-remote-desktop-mac-06.png) 8. Enter **Administrator** into the **Username** text
box, and enter the default administrator password that you got earlier in this guide into
the **Password** text box. 9. Choose **Continue** to connect to your instance.

![The Continue button.](images/connect-using-remote-desktop-mac-07.png)
