...
Here are a few steps you should take to get started after your Drupal instance is up and
running on Amazon Lightsail:

**Contents**

- [Step 1: Read
  the Bitnami documentation](#amazon-lightsail-read-the-bitnami-documentation-drupal "#amazon-lightsail-read-the-bitnami-documentation-drupal")
- [Step 2: Get the
  default application password to access the Drupal administration
  dashboard](#amazon-lightsail-get-the-default-user-password-drupal "#amazon-lightsail-get-the-default-user-password-drupal")
- [Step 3:
  Attach a static IP address to your instance](#amazon-lightsail-attach-static-ip-drupal "#amazon-lightsail-attach-static-ip-drupal")
- [Step 4: Sign in to
  the administration dashboard of your Drupal website](#amazon-lightsail-sign-in-drupal "#amazon-lightsail-sign-in-drupal")
- [Step 5: Route
  traffic for your registered domain name to your Drupal website](#amazon-lightsail-map-your-domain-to-your-instance-drupal "#amazon-lightsail-map-your-domain-to-your-instance-drupal")
- [Step 6: Configure
  HTTPS for your Drupal website](#amazon-lightsail-https-drupal "#amazon-lightsail-https-drupal")
- [Step 7:
  Read the Drupal documentation and continue configuring your
  website](#amazon-lightsail-read-documentation-drupal "#amazon-lightsail-read-documentation-drupal")
- [Step 8:
...
customizing your website and making administrative changes. For more information about
what you can do in Drupal, see the [Step 7: Read the Drupal
documentation and continue configuring your website](#amazon-lightsail-read-documentation-drupal "#amazon-lightsail-read-documentation-drupal") section later in this
guide.
...
redirected to the home page of your Drupal website. Next, you should generate and
configure an SSL/TLS certificate to enable HTTPS connections for your Drupal website.
...
route traffic to your Drupal instance. Otherwise, the SSL/TLS certificate validation
process will fail.
...
You are now done enabling HTTPS on your Drupal instance. Next time you browse
