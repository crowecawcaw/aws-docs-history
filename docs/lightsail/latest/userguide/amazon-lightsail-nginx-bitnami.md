...
Use the following tutorials to learn how to configure and manage your instances that use Nginx packaged by Bitnami
on Amazon Lightsail.
...
- [Enable HTTPS on instances that use Nginx packaged by Bitnami with Let's Encrypt and Certbot](amazon-lightsail-using-lets-encrypt-certificates-with-nginx-bitnami.md "amazon-lightsail-using-lets-encrypt-certificates-with-nginx-bitnami.md")
