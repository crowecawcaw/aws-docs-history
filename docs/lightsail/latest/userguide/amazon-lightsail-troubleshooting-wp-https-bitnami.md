...
+ [DNS records not found](#dns-not-found-bitnami)
+ [DNS records do not match](#dns-mismatch-error-bitnami)
+ [Unable to connect to your instance](#unable-to-connect-bitnami)
+ [Unsupported WordPress version](#unsupported-wp-version-bitnami)
+ [Instance created prior to January 1, 2023](#instance-create-date-error-bitnami)
+ [Instance firewall ports](#firewall-ports-error-bitnami)

## Setup failures
<a name="setup-failures-bitnami"></a>
...
+ [Some challenges have failed](#certbot-authorization-error-bitnami)
+ [Certbot failed to authenticate some domains](#domain-authentication-failed-bitnami)
+ [Deprecated Debian repository](#deprecated-debian-repo-bitnami)
+ [Deprecated PPA repository](#deprecated-ppa-repo-error-bitnami)
+ [Too many certificates](#too-many-certificates-bitnami)
+ [Too many failed authorizations](#too-many-failed-authorizations-bitnami)
...
<a name="dns-not-found-bitnami"></a>
...
<a name="dns-mismatch-error-bitnami"></a>
...
<a name="unable-to-connect-bitnami"></a>
...
<a name="unsupported-wp-version-bitnami"></a>
...
<a name="instance-create-date-error-bitnami"></a>
...
<a name="firewall-ports-error-bitnami"></a>
...
<a name="certbot-authorization-error-bitnami"></a>
...
<a name="domain-authentication-failed-bitnami"></a>
...
<a name="deprecated-debian-repo-bitnami"></a>
...
<a name="deprecated-ppa-repo-error-bitnami"></a>
...
<a name="too-many-certificates-bitnami"></a>
...
<a name="too-many-failed-authorizations-bitnami"></a>
