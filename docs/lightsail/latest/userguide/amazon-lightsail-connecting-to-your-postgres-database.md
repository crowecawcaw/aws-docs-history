...
![Database endpoint and port in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-postgres-database-endpoint-and-port.png)
...
1.   
![pgAdmin server configuration](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-create-server.png)
...
![pgAdmin server configuration form](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-create-server-form-connection-tab.png)
...
![pgAdmin workspace](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-connected.png)
