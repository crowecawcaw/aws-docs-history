...
When you create a Windows-based instance, you can configure it using a Windows PowerShell
script or any other batch script. This is a one-time script that runs right after your instance
...
2. Choose the AWS Region and Availability Zone where you want to create your
   instance.
3. Under **Select a platform**, choose **Microsoft
   Windows**.
4. Choose **OS Only**, and then choose **Windows Server
   2022**, **Windows Server 2019**, **Windows Server
   2016**.
...
You must always wrap your PowerShell scripts in
`<powershell></powershell>` tags. You can enter non-PowerShell
commands or batch scripts using `<script></script>` tags or
without any tags at all. 7. Enter a name for your instance.
...
ready, log in using the browser-based RDP client or configure your own RDP client. For more
information, see [Connect to your Windows-based instance](connect-to-your-windows-based-instance-using-amazon-lightsail.md "connect-to-your-windows-based-instance-using-amazon-lightsail.md").

1. Once you can connect to your Lightsail instance, open a command prompt (or open
   Windows Explorer).
...
3. Open `UserdataExecution.log` in a text editor, or type the
   following: `type UserdataExecution.log`.
