...
![Bucket access permissions in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-access-permission-all-objects-private.png)
...
![Bucket access permissions in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-access-permission-individual-objects-public.png)
...
![Bucket access permissions in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-access-permission-all-objects-public.png)
...
![Bucket resource access in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-resource-access-attached.png)
...
![Bucket access keys in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-access-keys.png)
...
![Bucket cross-account access in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-bucket-cross-account-access.png)
