...
# Block storage (Disks)
<a name="amazon-lightsail-faq-block-storage"></a>

## What can I do with Lightsail block storage?
<a name="what-can-i-do-with-block-storage"></a>
...
Lightsail block storage disks use solid-state drives (SSD). This type of block storage balances a low price and good performance and is intended to support the vast majority of workloads that run on Lightsail. 

## How are attached disks different than the storage included in my Lightsail plan?
<a name="how-are-attached-disks-different-than-included-storage"></a>
...
<a name="how-large-can-i-make-my-attached-disk"></a>
...
<a name="can-i-increase-the-size-of-attached-disk"></a>
...
<a name="does-block-storage-offer-encryption"></a>
...
<a name="what-availability-from-block-storage"></a>
