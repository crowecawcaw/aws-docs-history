...
![The JSON tab in the IAM console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-iam-policy-json.png)
...
![The JSON tab in the IAM console populated with a policy for Lightsail access.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-iam-policy-json-added.png)
...
![The Review Policy page in the IAM console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-iam-policy-review.png)
...
![Add user to a group in the IAM console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-iam-user-set-permissions.png)
...
![Confirmation that an IAM user was successfully created.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-iam-user-successfully-created.png)