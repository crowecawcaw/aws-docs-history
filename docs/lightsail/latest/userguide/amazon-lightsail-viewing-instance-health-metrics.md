...
![Sustainable and burstable zones on the CPU utilization graph.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/cpu-utilization-burstable-zone.png)
...
**Topics**
+ [Available instance metrics](#instance-metrics)
+ [CPU utilization sustainable and burstable zones](#cpu-utilization-zones)
+ [View instance metrics in the Lightsail console](#viewing-instance-metrics-console)
+ [Next steps](#next-steps-viewing-instance-metrics)
