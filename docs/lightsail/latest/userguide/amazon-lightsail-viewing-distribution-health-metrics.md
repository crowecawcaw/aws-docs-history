...
<a name="amazon-lightsail-viewing-distribution-health-metrics"></a>
...
<a name="viewing-distribution-metrics-console"></a>
...
<a name="next-steps-viewing-distribution-metrics"></a>
