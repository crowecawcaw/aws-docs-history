...
- [Step 1: Complete the prerequisites](#connect-wordpress-to-s3-prerequisites-bitnami "#connect-wordpress-to-s3-prerequisites-bitnami")
- [Step 2: Install the WP Offload Media plugin on your WordPress website](#install-wp-offload-media-on-wordpress-bitnami "#install-wp-offload-media-on-wordpress-bitnami")
- [Step 3: Create an IAM policy](#create-iam-policy-for-wordpress-bitnami "#create-iam-policy-for-wordpress-bitnami")
- [Step 4: Create an IAM user](#create-iam-user-for-wordpress-bitnami "#create-iam-user-for-wordpress-bitnami")
- [Step 5: Create an access key for your IAM user](#create-access-key-for-wordpress-bitnami "#create-access-key-for-wordpress-bitnami")
- [Step 6: Edit the WordPress configuration file](#edit-the-wp-config-file-for-s3-bucket-bitnami "#edit-the-wp-config-file-for-s3-bucket-bitnami")
- [Step 7: Create the Amazon S3 bucket using the WP Offload Media plugin](#create-the-amazon-s3-bucket-bitnami "#create-the-amazon-s3-bucket-bitnami")
- [Step 8: Next steps](#connect-wordpress-to-s3-prerequisites-next-steps-bitnami "#connect-wordpress-to-s3-prerequisites-next-steps-bitnami")
...
this tutorial. Continue to the [Step 3: Create an IAM policy](#create-iam-policy-for-wordpress-bitnami "#create-iam-policy-for-wordpress-bitnami") section of this tutorial.
...
Offload Media plugin](#create-the-amazon-s3-bucket-bitnami "#create-the-amazon-s3-bucket-bitnami").
