...
Read the Bitnami documentation to learn how to configure your Joomla\! application. For more information, see the [Joomla\! Packaged By Bitnami For AWS Cloud](https://docs.bitnami.com/general/apps/joomla/).
...
1. On your Joomla\! website home page, choose the **Manage** banner.
...
![The Joomla! administration control panel](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-joomla-dashboard.png)
...
![Apache virtual hosts configuration file](https://docs.aws.amazon.com/lightsail/latest/userguide/images/quick-start-apache-vhost-config-approach-a.png)
...
1. Complete the following steps if the result of the previous command indicated that you should use approach B.
   ...
   1. Add your domain name to the file as shown in the following example. In this example we are using the `example.com` and `www.example.com` domains.  
![Apache virtual hosts configuration file](https://docs.aws.amazon.com/lightsail/latest/userguide/images/quick-start-apache-vhost-config-approach-b.png)
...
Complete the following procedure to configure HTTPS on your Joomla\! website. These steps show you how to use the Bitnami HTTPS Configuration Tool (`bncert-tool`), which is a command line tool for requesting Let's Encrypt SSL/TLS certificates.
