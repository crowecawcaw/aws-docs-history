...
![Host key or certificate mismatch error for the Lightsail browser-based SSH or RDP client.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-browser-ssh-rdp-cant-connect-resest-record.png)
...
![Host key or certificate mismatch error for the Lightsail browser-based SSH or RDP client.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-browser-ssh-rdp-cant-connect.png)
...
![Instance unavailable when trying to connect using the Lightsail browser-based SSH or RDP client.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-browser-ssh-rdp-cant-connect-right-now.png)
