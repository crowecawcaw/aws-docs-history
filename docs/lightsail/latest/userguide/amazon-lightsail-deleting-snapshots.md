...
![Delete a snapshot in the Lightsail console.](images/amazon-lightsail-delete-snapshot-menu-option.png) 4. Choose **Yes** to confirm that you want to delete the snapshot.
...
![Use the shortcut menu to show your disk snapshots and delete multiple disk snapshots](images/delete-disk-snapshot-multiple.png) 4. Choose **Yes** to confirm that you want to delete the snapshots.
