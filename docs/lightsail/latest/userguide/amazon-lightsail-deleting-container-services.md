...
![Delete tab for the container service in the Lightsail console](images/continer-service-delete-tab.png) 5. Choose **Delete container service** to delete your service. 6. In the prompt that appears, choose **Yes, delete** to confirm that
