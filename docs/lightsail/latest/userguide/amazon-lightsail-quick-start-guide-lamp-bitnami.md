...
<a name="amazon-lightsail-quick-start-guide-lamp-bitnami"></a>
...
<a name="lamp-bitnami-get-the-default-user-password"></a>
...
<a name="lamp-bitnami-attach-static-ip"></a>
...
<a name="lamp-bitnami-map-your-domain-to-your-instance"></a>
...
<a name="lamp-bitnami-read-the-bitnami-documentation"></a>
...
For more information, see the [Bitnami LAMP for AWS Cloud](https://docs.bitnami.com/general/infrastructure/lamp/).

## Step 6: Create a snapshot of your LAMP instance
<a name="lamp-bitnami-create-a-snapshot"></a>
