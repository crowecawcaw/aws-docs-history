...
![Database snapshot in progress](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-database-snapshot-in-progress.png)
...
![Recent database snapshots in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-database-recent-snapshots.png)

## Next steps
<a name="creating-a-database-snapshot-next-steps"></a>

After your snapshot is ready, you can create a new database from the snapshot, which is a duplicate of the original database. For more information, see [Create a database from a snapshot](amazon-lightsail-creating-a-database-from-snapshot.md).

**Topics**
+ [Next steps](#creating-a-database-snapshot-next-steps)
+ [Restore database](amazon-lightsail-creating-a-database-from-point-in-time-backup.md)
+ [Create database from snapshot](amazon-lightsail-creating-a-database-from-snapshot.md)