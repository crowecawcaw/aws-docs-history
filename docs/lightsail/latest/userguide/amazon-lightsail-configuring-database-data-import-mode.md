...
![The data import mode toggle in the Lightsail console](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-database-data-import-mode-toggle.png)
