...
**Important**  
All emergency restore backups are deleted when data import mode is enabled. Create a snapshot of your database if you would like to have a backup before data import mode is enabled. For more information, see [Create a snapshot of your database](amazon-lightsail-creating-a-database-snapshot.md).
...
![The data import mode toggle in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-database-data-import-mode-toggle.png)
