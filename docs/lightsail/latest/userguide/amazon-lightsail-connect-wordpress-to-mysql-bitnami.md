...
![Password prompt to transfer WordPress database to a MySQL managed database in Lightsail.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-transfer-wordpress-database-to-mysql-managed-database.png)
...
![Successfully transferred WordPress database to a MySQL managed database in Lightsail.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-transfer-wordpress-database-to-mysql-managed-database-success.png)
...
![Wordpress configuration file before modifications.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-wordpress-wpconfig-file-original.png)
...
![Modifications to the WordPress configuration file.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-wordpress-wpconfig-file-modifications.png)
...
![Restarting server services on the WordPress instances.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-restart-wordpress-services.png)
