...
# Tags in Lightsail
<a name="amazon-lightsail-faq-tagging"></a>
...
<a name="how-can-i-use-tags-in-lightsail"></a>
...
For more information about using tags in Lightsail, see [Tags](amazon-lightsail-tags.md).

## What resources can be tagged?
<a name="what-resources-can-be-tagged"></a>
...
<a name="how-can-i-tag-my-lightsail-snapshots"></a>
