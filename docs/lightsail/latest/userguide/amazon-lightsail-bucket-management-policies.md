...
the AWS Command Line Interface (AWS CLI), AWS API, and AWS SDKs. In the policy, replace
`<BucketName>` with the name of the bucket to manage. For more
information about IAM policies, see [Creating
IAM policies](../../../IAM/latest/UserGuide/access_policies_create.md "../../../IAM/latest/UserGuide/access_policies_create.md") in the _AWS Identity and Access Management User Guide_. For more information
about creating IAM users and user groups, see [Creating your first IAM delegated user and user group](../../../IAM/latest/UserGuide/getting-started_create-delegated-user.md "../../../IAM/latest/UserGuide/getting-started_create-delegated-user.md") in the _AWS Identity and Access Management
User Guide_.

###### Important

Users who don't have this policy will experience errors when viewing the
**Objects** tab of the bucket management page in the Lightsail
console.
