...
![SSH keys page](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-02.png)
...
![Default keys download icon](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-download-default-key.png)
**Important**  
...
![Custom keys delete icon](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-06.png)
...
![Default keys delete icon](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-delete-default-key.png)
**Important**  
...
![Before you delete this key prompt](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-09.png)
...
![Download default key prompt](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-10.png)

1. The default key has been deleted. Choose **Okay**.  
![Default key deleted prompt](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-11.png)
...
![Key pair created](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-13.png)

1. Confirm the new default key on the Lightsail console SSH keys page.  
![Default keys list](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-14.png)
...
![Create custom key](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-create-custom-key.png)
...
![AWS Region list](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-17.png)

1. In the **Create a new SSH key pair** prompt that appears, give your custom key a name, and choose **Generate key pair**.  
![Create a new SSH key pair](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-18.png)
...
![Download private key prompt](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-19.png)

1. Choose **Ok, got it\!** to close the prompt.  
![You can only download private key once prompt](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-20.png)

1. Your new custom key is listed under the Custom keys section of the page.  
![Custom keys list](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-21.png)
...
![ssh-keygen](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-22.png)
...
![passphrase](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-23.png)

1. Enter the passphrase again to confirm it and press **Enter**. You will not see the passphrase as you enter it.  
![passphrase](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-24.png)

1. A prompt confirms that your private key and public key have been saved to the specified directory.  
![key pair save location](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-25.png)
...
![Upload custom key](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-27.png)
...
![AWS Region list](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-28.png)

1. Choose **Upload**.

1. Click **Choose File** in the **Upload a public key** prompt that appears.  
![Choose public key file location](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-29.png)
...
![Select public key](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-30.png)

1. Choose **Upload key**.  
![Choose upload key button](https://docs.aws.amazon.com/lightsail/latest/userguide/images/managing-key-pairs-31.png)
