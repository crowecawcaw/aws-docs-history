...
1. The browser-based SSH client terminal window opens. You are successfully connected to your instance via SSH if you see the Bitnami logo as shown in the following example.  
![Browser-based SSH client terminal window in the Lightsail console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-ssh-session-bncert.png)
...
**Important**  
The `bncert` tool can only be used on WordPress instances that are *Certified by Bitnami*. Alternately, you can use the Certbot tool to enable HTTPS on your WordPress instance. For more information, see [Tutorial: Use Let’s Encrypt SSL certificates with your WordPress instance](amazon-lightsail-using-lets-encrypt-certificates-with-wordpress.md).  
![Message confirming the bncert tool is not installed](https://docs.aws.amazon.com/lightsail/latest/userguide/images/run-bncert-tool-fail.png)
...
![Message confirming the bncert tool is installed](https://docs.aws.amazon.com/lightsail/latest/userguide/images/run-bncert-tool-success.png)
...
![Message indicating a new version of the bncert tool is available](https://docs.aws.amazon.com/lightsail/latest/userguide/images/bncert-update-required.png)
...
![Secured website confirmation](https://docs.aws.amazon.com/lightsail/latest/userguide/images/bncert-secured-website.png)
