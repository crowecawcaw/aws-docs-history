...
browser-based remote desktop (RDP) client, as well as a client such as Remote Desktop
Connection.

###### Important

We strongly encourage you to let Lightsail generate the password for your instance.
...
Lightsail does not provide utilities for manipulating .pem files. If you need to
convert the format of your private key file, free and open-source tools such as OpenSSL
for Linux, and base64 for Windows are readily available.
...
AWS Command Line Interface to work with Amazon Lightsail](lightsail-how-to-set-up-and-configure-aws-cli.md "lightsail-how-to-set-up-and-configure-aws-cli.md"). 2. Open a command prompt or a terminal. 3. Type the following command.

```
aws lightsail get-instance-access-details --instance-name `my-instance`
```

Where `my-instance` is the name of the instance you want to
...
4. You can use the ciphertext with any available application to decrypt your
   password.
