...
![Bitnami banner on the WordPress application home page](https://docs.aws.amazon.com/lightsail/latest/userguide/images/bitnami-banner.png)
...
![The Nginx application home page without a Bitnami banner](https://docs.aws.amazon.com/lightsail/latest/userguide/images/no-bitnami-banner.png)
...
![Public IP address of a Lightsail instance](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-instance-public-ip-address.png)
...
![The browser-based SSH client icon for a Lightsail instance](https://docs.aws.amazon.com/lightsail/latest/userguide/images/browser-based-ssh-client-icon.png)
