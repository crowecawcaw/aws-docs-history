...
![The Change permissions button.](/images/lightsail/latest/userguide/images/amazon-lightsail-bucket-access-permissions.png) 6. Choose **Individual objects can be made public and read
only**.
