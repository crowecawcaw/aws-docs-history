...
For step-by-step directions, see [Secure your WordPress site with HTTPS on Lightsail](amazon-lightsail-enabling-https-on-wordpress.md "amazon-lightsail-enabling-https-on-wordpress.md"). 5. Verify that the URLs that you specified in the domain assignments step open your
WordPress site.
