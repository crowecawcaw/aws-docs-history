...
![Connect using SSH in the Lightsail console](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-connect-to-your-instance.png)
...
![Default application password for Bitnami instances](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-ssh-default-application-password.png)
...
![Public or static IP address of a Lightsail instance](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-public-static-ip.png)

1. On the instance management page, under the **Connect** tab, choose **Connect using SSH**.  
![Connect to your instance using SSH](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-connect-using-ssh.png)
...
![Result of the domain configuration tool](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-configure-domain-ip.png)
...
![The PrestaShop administration dashboard sign in page](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-prestashop-sign-in-page.png)

   The PrestaShop administration dashboard appears.  
![PrestaShop administration dashboard](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-prestashop-administration-dashboard.png)
...
![Advanced parameters in the PrestaShop navigation pane](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-advanced-parameters.png)
...
![Result of the domain configuration tool](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-configure-domain.png)
...
![Running the bncert tool](https://docs.aws.amazon.com/lightsail/latest/userguide/images/run-bncert-tool-success.png)
...
![General parameters in the PrestaShop navigation pane](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-general-parameters.png)

1. Choose **Yes** next to **Enable SSL**.  
![Enable SSL in the PrestaShop administration dashboard](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-enable-ssl.png)
...
![Enable SSL for all pages in the PrestaShop administration dashboard](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-enable-ssl-all-pages.png)
...
![Email option in the navigation pane](https://docs.aws.amazon.com/lightsail/latest/userguide/images/prestashop-quick-start-advanced-parameters-email.png)


For more information, see [User Guide PrestaShop](https://docs.prestashop-project.org/1.7-documentation/user-guide) in the *PrestaShop documentation*.
...
You should read the PrestaShop documentation to learn how to administer your PrestaShop website. For more information, see the [User Guide PrestaShop](https://docs.prestashop-project.org/1.7-documentation/user-guide) in the *PrestaShop documentation*.
