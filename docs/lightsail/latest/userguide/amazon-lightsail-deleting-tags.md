...
**Note**  
For more information about tags, what resources can be tagged, and the tag restrictions, see [Tags](amazon-lightsail-tags.md).

**To delete tags from a resource**

1. Sign in to the [Lightsail console](https://lightsail.aws.amazon.com/).

1. In the left navigation pane, choose the resource type that you want to delete tags from. For example, to delete tags from a DNS zone, choose **Networking**. Or choose **Instances** to delete tags from an instance.
**Note**  
