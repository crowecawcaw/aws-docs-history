...
Create and configure a WordPress instance as described in [Launch and configure a WordPress instance](amazon-lightsail-launch-and-configure-wordpress.md "amazon-lightsail-launch-and-configure-wordpress.md").
...
7. Add the following lines of code to the file where you previously deleted the code:
