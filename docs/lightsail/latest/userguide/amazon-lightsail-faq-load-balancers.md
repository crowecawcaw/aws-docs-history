...
# Load balancers
<a name="amazon-lightsail-faq-load-balancers"></a>

## What can I do with Lightsail load balancers?
<a name="what-can-i-do-with-load-balancers"></a>
...
<a name="can-i-use-load-balancers-in-different-regions-availability-zones"></a>
...
<a name="how-does-load-balancer-deal-with-traffic-spikes"></a>
...
<a name="how-do-load-balancers-route-traffic-to-my-instance"></a>
...
<a name="how-does-lightsail-know-instance-health"></a>
...
<a name="how-many-instances-attached-to-load-balancer"></a>
...
<a name="can-i-assign-one-instance-to-multiple-load-balancers"></a>
...
<a name="what-happens-to-instance-when-load-balancer-deleted"></a>
...
<a name="what-is-session-persistence"></a>
...
<a name="do-loadbalancer-instances-need-ipv6"></a>
