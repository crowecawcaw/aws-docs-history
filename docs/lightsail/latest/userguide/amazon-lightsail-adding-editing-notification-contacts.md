...
<a name="amazon-lightsail-adding-editing-notification-contacts"></a>
...
![Verification request email.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-verification.png)
...
![Email waiting verification banner in the Lightsail console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-verification-banner.png)


## Adding notification contacts using the Lightsail console
<a name="adding-notification-contacts-console"></a>
...
![Notification contacts in the Lightsail console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-notification-contacts.png)
...
![Select an AWS Region when adding a notification contact.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-notification-contact-region-menu.png)
...
**Important**  
SMS text messaging feature has been temporarily disabled and is currently not supported in any AWS Region in which you can create Lightsail resources. For more information, see [SMS text messaging support](#sms-support).  
![Select an AWS Region when adding a notification contact.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-sms-notification-contact-region-menu.png)
...
![Email verification prompt after adding an email notification contacts in the Lightsail console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-verification-modal.png)
...
![Notification contacts added in the Lightsail console.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-added-notification-contacts.png)
...
![Verification email request.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-verification-request.png)
...
![Email verification subscription.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-email-verification-subscribe.png)

## Adding notification contacts using the AWS CLI
<a name="adding-notification-contacts-cli"></a>
...
<a name="next-steps-adding-notification-contacts"></a>
