...
- [DNS records not found](#dns-not-found-lightsail "#dns-not-found-lightsail")
- [DNS records do not match](#dns-mismatch-error-lightsail "#dns-mismatch-error-lightsail")
- [Unable to connect to your instance](#unable-to-connect-lightsail "#unable-to-connect-lightsail")
- [Unsupported WordPress version](#unsupported-wp-version-lightsail "#unsupported-wp-version-lightsail")
- [Instance created prior to January 1, 2023](#instance-create-date-error-lightsail "#instance-create-date-error-lightsail")
- [Instance firewall ports](#firewall-ports-error-lightsail "#firewall-ports-error-lightsail")
...
- [Some challenges have failed](#certbot-authorization-error-lightsail "#certbot-authorization-error-lightsail")
- [Certbot failed to authenticate some domains](#domain-authentication-failed-lightsail "#domain-authentication-failed-lightsail")
- [Deprecated Debian repository](#deprecated-debian-repo-lightsail "#deprecated-debian-repo-lightsail")
- [Deprecated PPA repository](#deprecated-ppa-repo-error-lightsail "#deprecated-ppa-repo-error-lightsail")
- [Too many certificates](#too-many-certificates-lightsail "#too-many-certificates-lightsail")
- [Too many failed authorizations](#too-many-failed-authorizations-lightsail "#too-many-failed-authorizations-lightsail")
...
2. Stop the Apache service that's running on the instance:
