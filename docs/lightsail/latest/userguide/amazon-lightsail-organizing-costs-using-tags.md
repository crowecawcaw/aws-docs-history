...
**Note**  
For more information about tags in Lightsail, what resources can be tagged, and tag restrictions, see [Tags](amazon-lightsail-tags.md).
...
Add key-value tags to the Lightsail resources that you want to organize in your billing console. For more information about key-value tags, see [Add tags to a resource](amazon-lightsail-adding-tags-to-a-resource.md).
...
![Key-value tags for cost allocation.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-key-value-tags-for-cost-allocation.png)
