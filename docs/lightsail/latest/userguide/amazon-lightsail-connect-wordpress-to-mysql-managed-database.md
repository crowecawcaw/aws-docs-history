...
become unrecoverable. To prevent this scenario, you should transfer your website data to a MySQL
managed database.
...
(`wp-config.php`) file on your instance so that your website connects to the
...
- Enable the public mode and data import mode of your MySQL managed database. You can
  disable these modes after completing the steps in this tutorial. For more information, see
...
2. In the **Instances** tab, choose the browser-based SSH client icon
...
1. In the browser-based SSH client that is connected to your WordPress instance, enter
   the following command to create a backup of the `wp-config.php` file in case
...
If for any reason you need to restore the original `wp-config.php` file,
enter the following command to restore it using the backup you created earlier in this
tutorial.
...
- Create a snapshot of the MySQL managed database. For more information, see [Create a snapshot of your
...
- Disable the public mode and data import mode of your MySQL managed database. For more
  information, see [Configure the public mode for your database](amazon-lightsail-configuring-database-public-mode.md "amazon-lightsail-configuring-database-public-mode.md") and [Configure the data
  import mode for your database](amazon-lightsail-configuring-database-data-import-mode.md "amazon-lightsail-configuring-database-data-import-mode.md").
