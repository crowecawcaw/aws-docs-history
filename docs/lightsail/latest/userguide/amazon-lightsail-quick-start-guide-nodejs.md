...
Here are a few steps you should take to get started after your Node.js instance is up and
running on Amazon Lightsail. Before you get started, identify your blueprint vendor on your instance management page:

![Node.js blueprint vendor on the instance management page](images/nodejs/nodejs-blueprint-vendor.png)
...
![Copy static IP](images/nodejs/nodejs-copy-static-ip.png) 2. Paste the static IP address into your browser address, for example
`http://192.0.0.1`.

![Node.js welcome page](images/nodejs/nodejs-welcome-page.png)
