...
default application password for your Node.js instance
...
Read the Bitnami documentation to learn how to deploy your Node.js application, enable
HTTPS support with SSL certificates, upload files to the server with SFTP, and more.
