...
information about notifications for alarms, see [Configure metric notifications for Lightsail resources](amazon-lightsail-notifications.md "amazon-lightsail-notifications.md").

###### Topics

- [Review alarm notifications for active alarms](#amazon-lightsail-alarm-notifications-review-alarms "#amazon-lightsail-alarm-notifications-review-alarms")
- [Review email contacts pending verification](#amazon-lightsail-alarm-notifications-review-contacts "#amazon-lightsail-alarm-notifications-review-contacts")
...
![Displays an example notification for an active alarm.](images/amazon-lightsail-alarm-notification-example.png)
...
![Displays an example notification for a pending email contact.](images/amazon-lightsail-alarm-pending-contact-example.png)
