...
![Browser-based SSH client icon in the Lightsail home page.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/instances/resource_cards/nginx-ssh-quick-connect.png)
...
![IPv6 not configured on the instance.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/lightsail-nginx-ssh-curl-result-not-configured.png)
...
![IPv6 configured on the instance.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/lightsail-nginx-ssh-curl-result-configured.png)
...
![Nginx configuration file on the instance.](https://docs.aws.amazon.com/lightsail/latest/userguide/images/lightsail-nginx-ssh-nginx-conf-file.png)
