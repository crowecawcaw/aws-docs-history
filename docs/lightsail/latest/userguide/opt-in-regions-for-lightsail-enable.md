...
![Displays how to start enabling an opt-in Region from your AWS profile.](images/opt-in-regions-enable-region.png) 9. Review any additional information that is displayed, then choose **Enable
...
![Displays how to start enabling an opt-in Region from your AWS profile.](images/opt-in-regions-region-is-enabled.png)
