...
<a name="amazon-lightsail-faq-export-to-ec2"></a>

## What is export to Amazon EC2?
<a name="what-is-export-to-ec2"></a>
...
<a name="why-would-i-want-to-export-to-ec2"></a>
...
<a name="how-does-exporting-to-ec2-work"></a>
...
<a name="can-i-export-managed-databases"></a>
