...
registration form. 3. In the **US short code registration** section, make sure you have the following documentation ready:
    ...
    * **Confirm your campaign does not fall into prohibited message control and use cases**, make sure your campaign is not in any prohibited category. For more information, see [Prohibited message content](best-practices.md#best-practices-sms-message-content "best-practices.md#best-practices-sms-message-content").
...
Choose **Next**. 7. In the **Customer Care Contact info** section, enter the following:
...
Choose **Next**. 8. In the **Short Code info** section, enter the following:
...
Choose **Next**. 9. In the **Messaging use case** section, enter the following:
...
Choose **Next**. 10. In **Message Samples** section, do the following:
...
Choose **Next**. 11. In the **MMS File samples** section, enter the following:
...
Choose **Next**. 12. In the **Terms & Conditions and Privacy Policy Info** section, enter the following:
...
Choose **Next**. 13. In **Opt-in Workflow/Call-to-action** section, do the following:
...
Choose **Next**. 14. In the **Compliance Keywords and Auto-Responses** section, enter the following:
...
Choose **Next**. 15. On the **Review and submit** page verify the information you are about to submit is correct. To make updates choose **Edit** next to the section. 16. Choose **Submit registration**.
