...
To update an AWS End User Messaging SMS event destination using the AWS End User Messaging SMS console, follow these steps:
...
1. From the **Destination type** dropdown choose Amazon SNS.
   ...
   1. **New Amazon SNS topic** – Choose this option, AWS End User Messaging SMS creates a topic in your account. The topic is automatically created with all of the required permissions. For more information on Amazon SNS topics see [Configuring Amazon SNS](https://docs.aws.amazon.com/sns/latest/dg/sns-getting-started.html) in the [Amazon Simple Notification Service Developer Guide](https://docs.aws.amazon.com/sns/latest/dg/).
