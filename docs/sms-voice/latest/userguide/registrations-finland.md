...
Choose **Next**. 6. In **Message samples**, do the following:
...
Choose **Next**. 7. On the **Review and submit** page verify the information you are about to submit is correct. To make updates choose **Edit** next to the section. 8. Choose **Submit registration**.
