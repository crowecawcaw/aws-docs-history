...
2. Clear language: "I agree to receive text messages from [Brokerage Name] regarding property listings, showing updates, and transaction notifications"
3. Message frequency disclosure
4. "Message and data rates may apply"
5. STOP/HELP instructions or link to full terms
6. Link to your privacy policy and SMS terms
...
For a real estate-specific opt-in form example, see the form screenshots in this section.
...
![Buyer registration form showing an unchecked SMS consent checkbox with brokerage name, message frequency, data rates, and opt-out disclosures](images/vertical-realty-optin.png)
