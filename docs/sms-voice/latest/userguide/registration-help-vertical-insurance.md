...
| Denial title reference                                   | Denial title                                                                                                                                                                                         | What it means for insurance brokers |
| -------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
...
| Denial title reference                                  | Denial title                                                                                                                                                                                                                     | What it means for insurance brokers |
| ------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| **Campaign unclear**                                    | Your description doesn't clearly explain what messages consumers will receive. "Insurance communications" is too vague – specify: "Policy renewal reminders and claims status updates for existing auto and home policyholders." |
...
| **Opt-in workflow mismatch**                                        | The brand name on your opt-in form doesn't match your registered brand. If your form says "ABC Insurance Group" but you registered as "ABC Agency LLC," this triggers a mismatch. |
...
If any part of your business involves premium financing (paying insurance premiums in installments with interest), you must select the **Direct Lending** content attribute during registration. Omitting this when your website mentions financing options triggers the "Campaign undeclared direct lending" denial.
