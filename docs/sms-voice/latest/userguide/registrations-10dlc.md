...
**Note**  
**Important:** Brand registration and external brand vetting alone does not automatically increase the default of 1 MPS limit per number associated to an approved 10DLC campaign. To get the eligible throughput from your campaign applied to the associated 10DLC numbers, you need to submit a request to increase SMS sending rates.
