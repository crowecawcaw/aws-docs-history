...
Complete the following form to register your sender ID in the United Kingdom. If your sender ID is protected by then a completed [Letter of Authorization (LOA)](registrations-uk.md "registrations-uk.md") is required as well.
...
5.  In the **Sender ID info** section, enter the following:
        ...
        * For **Letter of authorization image – optional**:
         Information provided must be that of the end company. If you are registering
         on behalf of a company they are required to authorize AWS and the LOA
         should not include or reference your company information.
        	...
        	+ Create a PDF of the LOA to upload as part of completing the **Sender
        	 ID info** section for your UK registration. The maximum file size
        	 is 400 KB.
