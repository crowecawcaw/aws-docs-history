...
Choose **Next**. 5. In **Messaging Use Case**, do the following:
...
6. Choose **Next**. 7. In **Message samples**, do the following:
...
8. Choose **Next**. 9. On the **Review and submit** page verify the information you are about to submit is correct. To make updates choose **Edit** next to the section. 10. Choose **Submit registration**.
