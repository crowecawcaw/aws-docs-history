...
**Note**  
Your business registration number is verified against official business registries. The company name on your registration must exactly match the legal name associated with your registration number. If verification fails, you can upload supporting documentation. For detailed guidance, see [Business verification for toll-free registrations](registration-help-tfn-verification.md).
...
**Keyword or QR Code Opt-in**: Where does the customer find the keyword or QR code to opt-in to these messages.
