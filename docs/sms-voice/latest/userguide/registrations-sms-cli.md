...
If your registration's status is changed to **REQUIRES\_UPDATES** then you can find and [edit the flagged fields](registrations-edit.md "registrations-edit.md") and resubmit the
