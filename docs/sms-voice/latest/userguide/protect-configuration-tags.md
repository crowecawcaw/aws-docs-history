...
<a name="protect-configuration-tags"></a>
...
1. In the navigation pane, under **Protect**, choose **Protect configurations**.

1. On the **Protect configurations** page, choose the protect configurations to add a tag to.
