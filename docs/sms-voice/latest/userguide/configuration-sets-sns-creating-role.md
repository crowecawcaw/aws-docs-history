...
**Note**  
If your Amazon SNS topic has server-side encryption enabled with AWS Key Management Service then also add the policy to the associated [symmetric encryption customer](#configuration-sets-sns-creating-role-encrypted) managed key.
