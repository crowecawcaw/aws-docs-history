...
This guide clarifies the critical distinction between first-party lead nurturing (allowed) and third-party lead generation (restricted/prohibited) for A2P 10DLC registration.
...
Businesses that collect their own leads and message those leads directly may register campaigns for:
...
The following denials are triggered when lead generation or affiliate marketing is detected:
...
Reviewers look for these signals in your registration:
...
If you are a legitimate first-party business that nurtures your own leads:

1. **Register as the end brand** – The brand name must match who the consumer believes is messaging them
2. **Own your opt-in** – Consent must be collected on your own properties (website, app, in-store)
3. **Match brand to messages** – Message samples must reference your registered brand name
4. **Clean your privacy policy** – Remove any language about sharing consent or phone numbers with third parties
5. **Describe your flow clearly** – Campaign description should state "We message people who submit inquiries on our website" not "We connect consumers with service providers"
...
If your campaign was denied for lead generation or affiliate marketing:
...
2. **Update your privacy policy** – Ensure it explicitly states you do not share opt-in consent or phone numbers with third parties
3. **Revise campaign description** – Describe only your direct relationship with the message recipients
4. **Verify brand alignment** – Confirm the registered brand is the same entity consumers see in messages
