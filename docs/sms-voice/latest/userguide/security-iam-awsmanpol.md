...
For details about this policy, see [SMSVoiceServiceRolePolicy](https://docs.aws.amazon.com/aws-managed-policy/latest/reference/SMSVoiceServiceRolePolicy.html).
...
View details about updates to AWS managed policies for AWS End User Messaging SMS since this service began tracking these changes. For automatic alerts about changes to this page, subscribe to the RSS feed on the AWS End User Messaging SMS Document history page.
