...
<a name="registrations-status"></a>

Your registration will be in one of these different statuses:
+ **AUTHENTICATION\_REQUIRED** – You need to complete two-factor authentication for your registration.
...
+  **REQUIRES\_UPDATES** – You must fix your registration and resubmit it. See [Edit a registration in AWS End User Messaging SMS](registrations-edit.md) for more information. Fields that require updates display a warning icon and a brief description of the issue.
