...
AWS is committed to improving the resilience and deliverability
of SMS messages for our customers. We maintain multiple routes and adjust SMS routing based on route trustworthiness, message deliverability, and message cost.
