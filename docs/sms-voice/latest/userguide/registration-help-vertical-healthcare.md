...
| Denial title reference                | Denial title                                                                                                                                                                              | What it means for healthcare providers |
| ------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
...
| Denial title reference                  | Denial title                                                                                                                                                                                                                                                        | What it means for healthcare providers |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- |
| **Campaign unclear**                    | Your description doesn't clearly explain what messages patients will receive. "Healthcare communications" is too vague – specify: "Appointment reminders, prescription refill notifications, and billing alerts for established patients of Smith Family Medicine." |
...
| **Opt-in workflow mismatch**                                        | The practice name on your opt-in form doesn't match your registered brand. If your form says "Downtown Medical Associates" but you registered as "DMA Health LLC," this triggers a mismatch.          |
...
| **Opt-in workflow non compliant privacy policy**                    | Your opt-in flow doesn't link to a privacy policy or doesn't state that mobile opt-in data won't be shared with third parties. Critical for healthcare – patients expect strict data handling.        |
...
2. An unchecked checkbox or signature line specifically for text messaging
3. Language stating: "I agree to receive text messages from [Practice Name] regarding appointments, prescriptions, and billing"
4. Message frequency disclosure
5. "Message and data rates may apply"
6. STOP/HELP instructions
7. Reference to privacy policy

**For registration:** Photograph or scan the relevant section of your paper form and host it at a publicly accessible URL, or upload a screenshot showing the SMS consent portion.
...
2. Host it at a public URL (the portal itself requires login, but the screenshot must be accessible to reviewers)
3. Ensure the portal consent screen includes all required disclosures

### Multi-location practices

If your practice has multiple locations under one brand, you can use a single campaign registration. If locations operate under different brand names (e.g., "Smith Cardiology" vs. "Smith Orthopedics"), register each as a separate campaign.
...
Campaigns involving GLP-1 receptor agonists and similar weight-loss or metabolic
medications are subject to additional restrictions beyond standard healthcare
messaging.

### Prohibited for GLP-1

The use of SMS for the **marketing or promotion**
of GLP-1 receptor agonists and related metabolic medications is strictly
prohibited. Messages must not include the prescription drug or brand name.

### Approved use cases for GLP-1

Campaign submissions will only be approved if the messaging intent is purely
...
- **FDA approval required** –
  Products must have formal FDA approval. Lack of approval significantly
  increases the likelihood of rejection.
- **Legal in all 50 states** –
  Products must be legal in all 50 U.S. states. If restricted in even one
  state, the campaign will be rejected.
