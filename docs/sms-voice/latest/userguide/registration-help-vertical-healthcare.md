...
![Patient intake form showing an unchecked SMS consent checkbox with message frequency, data rates, and opt-out disclosures](https://docs.aws.amazon.com/sms-voice/latest/userguide/images/vertical-healthcare-optin.png)
