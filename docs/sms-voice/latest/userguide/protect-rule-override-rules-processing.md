...
![Shows the decisions for using a phone number override rule.](https://docs.aws.amazon.com/sms-voice/latest/userguide/images/phone-number-override-rule-process.png)
