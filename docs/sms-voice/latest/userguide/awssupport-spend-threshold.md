...
<a name="awssupport-spend-threshold"></a>
...
<a name="awssupport-spend-threshold-open"></a>
...
1. Choose **AWS End User Messaging** from the list, or search for **AWS End User Messaging** in the search box.

1. Choose the applicable spending quota
...
1. For increased quota value, enter the new value. The new value must be greater than the current value.
