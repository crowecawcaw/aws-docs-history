...
This guide covers registration requirements for organizations that send employment-related messages. It distinguishes between direct employer messaging (allowed) and third-party job board aggregation (prohibited).
...
Direct employers and exclusive staffing agencies may register campaigns for:
...
If you are a staffing agency (not a job board), your registration must clearly establish:

1. **Direct candidate relationship** – Candidates applied to your agency directly
2. **Brand is the agency** – Register under your staffing agency brand, not your client's brand
3. **Campaign describes agency use case** – "We notify candidates who applied through [AgencyName] about placement opportunities and interview scheduling"
4. **Messages identify your agency** – Sample messages include your agency name, not the end client's name alone
...
- **Consent is specific** – Candidates opted in to receive SMS from _your_ organization specifically
...
### Non-compliant brand affiliation: third party job boards

**Title:** Non-compliant brand affiliation
...
**Title:** Campaign non-compliant content: third party job boards.
...
**Title:** Campaign non-compliant content: affiliate marketing.
...
**Title:** Invalid brand business connection
...
**Title:** Campaign to brand mismatch
...
**Title:** Opt-in workflow insufficient consent
...
**Title:** Opt-in workflow non compliant privacy policy
...
1. **State your model explicitly** – In your campaign description, say "direct employer," "exclusive staffing agency," or "recruitment firm." Don't leave reviewers guessing whether you're a job board.
2. **Show the candidate relationship** – Describe how candidates enter your system: "Candidates create profiles on our website" or "Applicants submit through our careers page." This proves direct consent.
3. **Don't reference multiple unrelated employers** – If your sample messages mention different company names, it signals job board behavior. Keep samples focused on your brand as the sender.
4. **Separate use cases** – If you send both shift notifications (transactional) and new opportunity alerts (marketing), consider separate campaigns with distinct consent flows.
5. **Avoid lead-gen language** – Phrases like "matched with top employers," "opportunities from our network of companies," or "jobs from 500+ employers" signal aggregation and will be rejected.
6. **Keep your website clear** – Your site should show your company as an employer or staffing agency, not a job listing marketplace. If you list roles, they should be your own openings or your agency's active placements.
7. **Don't use purchased lists** – Messaging candidates who didn't directly apply to your organization has no valid opt-in path and will fail consent review.
