...
- [Using service-linked roles for
  AWS End User Messaging SMS](using-service-linked-roles.md "using-service-linked-roles.md")
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting AWS End User Messaging SMS identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
