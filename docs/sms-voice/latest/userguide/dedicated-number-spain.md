...
New Spain short code provisioning is temporarily on hold. If you need a dedicated number for Spain, request a long code instead. For more information, see [Requesting dedicated long codes](phone-numbers-request-long-code.md "phone-numbers-request-long-code.md").
...
Choose **Next**. 4. In the **Company Address** section, enter the following:
...
Choose **Next**. 5. In the **Service Information and Use Case** section, enter the following:
...
Choose **Next**. 6. On the **Review and submit** page verify the information you are about to submit is correct. To make updates choose **Edit** next to the section. 7. Choose **Submit registration**.
