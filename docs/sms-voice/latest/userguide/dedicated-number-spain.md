...
**Important**  
New Spain short code provisioning is temporarily on hold. If you need a dedicated number for Spain, request a long code instead. For more information, see [Requesting dedicated long codes](phone-numbers-request-long-code.md).
