...
1. In the **Destination number** section, choose either **Simulator number** or **Verified number** and then select the number from the dropdown list.
   ...
   1. In the **Add phone number** window for **Destination phone number**, enter the phone number of the device to receive the test message. The phone number must start with a '\+' and can't contain any spaces, hyphens, or parentheses. For example, `+1 (206) 555-0142` is not in the correct format, but `+12065550142` is.
