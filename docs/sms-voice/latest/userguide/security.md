...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS End User Messaging SMS. The following topics show you how to configure AWS End User Messaging SMS to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS End User Messaging SMS resources.
