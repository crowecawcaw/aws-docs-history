...
When you submit a campaign registration, reviewers evaluate your application against eight
criteria. Understanding these criteria helps you prepare a complete submission that passes
...
- If your registration was denied, see [Rejection troubleshooting](registration-help-rejection-troubleshooting.md "registration-help-rejection-troubleshooting.md") to find your specific
  denial reason and resolution steps.
- For opt-in form examples, see [Compliant opt-in examples](registration-help-optin-examples.md "registration-help-optin-examples.md").
- For industry-specific guidance, see the vertical guides for your
  business type.
