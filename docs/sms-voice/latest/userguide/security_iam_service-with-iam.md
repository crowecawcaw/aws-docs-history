...
To view examples of AWS End User Messaging SMS identity-based policies, see [Identity-based policy examples for AWS End User Messaging SMS](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
