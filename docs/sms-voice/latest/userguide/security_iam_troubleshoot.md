# Troubleshooting AWS End User Messaging SMS identity and
...
- [I am not authorized to
  perform an action in AWS End User Messaging SMS](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS End User Messaging SMS resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS End User Messaging SMS
...
outside of my AWS account to access my AWS End User Messaging SMS resources
