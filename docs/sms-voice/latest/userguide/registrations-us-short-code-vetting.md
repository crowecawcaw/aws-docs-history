...
1. **Email verification** – A verification PIN is sent to the brand's point of contact email address from `verify@usshortcodes.com`. The brand contact must choose the verification link in the email and enter the PIN to complete the process.
