...
**Topics**
+ [What is a testing agent?](#rcs-testing-what-is)
+ [Adding test devices](#rcs-testing-add-devices)
+ [Tester invitation flow](#rcs-testing-tester-invitation)
+ [Viewing test devices](#rcs-testing-view-devices)
+ [Sending test messages](#rcs-testing-send-messages)
+ [Testing SMS fallback](#rcs-testing-sms-fallback)
+ [Troubleshooting RCS testing](#rcs-testing-troubleshooting)
