...
Common rejection reasons for lenders| Denial title | What it means | How to fix |
| --- | --- | --- |
...
For a lender-specific opt-in form example, see the form screenshots in this section.
...
![Lender opt-in form example](images/vertical-lender-optin.png)
