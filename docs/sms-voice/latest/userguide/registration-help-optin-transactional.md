...
![Transactional opt-in — optional phone, no checkbox](images/optin-transactional-optional.png)

![Transactional opt-in — required phone, separate checkbox](images/optin-transactional-required.png)
