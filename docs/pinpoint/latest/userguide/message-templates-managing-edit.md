...
1. Make the changes that you want. You can change any of the template's content or settings, except the name of the template. To change the name of the template, you can [create a copy of the template](message-templates-managing-copy.md), save the copy with the name that you want, and then optionally delete the original template.
