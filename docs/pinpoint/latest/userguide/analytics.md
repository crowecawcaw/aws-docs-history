...
As users interact with your project, Amazon Pinpoint collects and stores analytics data for these interactions. You can view that data to learn about areas such as [usage charts](analytics-usage.md), [revenue charts](analytics-revenue.md), and [demographics charts](analytics-demographics.md). For example, if you have a mobile app, you can view charts and metrics that show how many users open your app each day, when users open your app, and the revenue that's generated by your app. 
