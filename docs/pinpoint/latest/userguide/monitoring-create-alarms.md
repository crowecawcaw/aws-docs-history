...
1. On the **All metrics** tab, choose **Pinpoint**, and then choose the type of metric that you want to create an alarm for. The types of available metrics depend on the Amazon Pinpoint features that you use.
