...
| The redo button.                | **Redo**            | Restores an action that was previously undone by using the **Undo** button.                                                                                                                                        |
| The center view button.         | **Center**          | Moves to the top of the journey and centers the **Journey entry** activity on the journey workspace.                                                                                                               |
