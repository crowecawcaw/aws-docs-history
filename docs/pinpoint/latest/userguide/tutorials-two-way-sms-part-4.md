...
![Protocol set to REST, Create new API set to New API, API name set to RegistrationForm, and Endpoint Type set to Regional.](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step2.png)
...
![The new child resource pane with resource name set to register.](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step3.png)
...
![The create method pane with check mark selected.](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step4.png)
...
1. In the **/register - POST - Setup** pane, make the following selections:
   ...
   An example of these settings is shown in the following image.  
![The /register - POST - Setup pane with Lambda Function selected.](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step5.png)
...
![The deploy API windows with Stage name set to v1](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step6.png)
...
![The v1 Stage Editor pane showing the Invoke URL to copy](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step7.png)
...
![The drop down menu for Actions, shows Enable CORS is selected](https://docs.aws.amazon.com/pinpoint/latest/userguide/images/SMS_Reg_Tutorial_APIGW_Step8.png)
