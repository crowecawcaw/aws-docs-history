...
![The name of the segment, there are five buttons: Delete, Duplicate, Edit, Export, and Create a campaign.](http://docs.aws.amazon.com/pinpoint/latest/userguide/images/segments_export_button.png)
...
1. Amazon Pinpoint creates a new export job, and you see the **Recent exports** tab on the **Segments** page.
   ...
   Wait a few minutes, and then choose the **refresh** (![The refresh button.](http://docs.aws.amazon.com/pinpoint/latest/userguide/images/refresh-button.png)) button. If the status is still **In progress**, wait another minute, and then repeat this step. Otherwise, if the status is **Complete**, proceed to the next step.
**Note**  
