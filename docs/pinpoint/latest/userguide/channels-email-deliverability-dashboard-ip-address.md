...
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| Spamhaus                       | [Spamhaus<br>website](https://check.spamhaus.org/ "https://check.spamhaus.org/")                                                 |
...
| Invaluement                    | [Invaluement<br>website](https://www.invaluement.com/removal/ "https://www.invaluement.com/removal/")                            |
...
notifications when your dedicated IPs are added to major denylists.
    ...
    **for at least**, enter a value of
    ...
    following options:
        ...
        * **Create a new topic** – Choose this
         option if you haven't yet created an Amazon SNS topic, or if you want
