...
<a name="customerdata-endpoints"></a>
...
**Topics**
+ [Create and update individual endpoints](#customerdata-endpoints-individual)
+ [Create or update endpoints in bulk](#customerdata-endpoints-bulk)

## Create and update individual endpoints
<a name="customerdata-endpoints-individual"></a>
...
<a name="customerdata-endpoints-bulk"></a>
