...
**Topics**
+ [Is a resilient, multi-Region architecture necessary for your use case?](#overview-usecase)
+ [High availability concepts](#overview-terms)
+ [When to fail over to another AWS Region](#overview-failover)

## Is a resilient, multi-Region architecture necessary for your use case?
<a name="overview-usecase"></a>
...
For more information about AWS Regions and Availability Zones, see [Regions and Availability Zones](https://aws.amazon.com/about-aws/global-infrastructure/regions_az/) on the AWS Global Infrastructure website.

## High availability concepts
<a name="overview-terms"></a>
