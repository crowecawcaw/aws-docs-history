...
practices can help you achieve internetwork traffic privacy for Amazon Pinpoint.
...
Layer Security (TLS) 1.2 or later. Clients must also support cipher suites with perfect
...
To secure communications between Amazon Pinpoint and other AWS resources in the same
AWS Region, Amazon Pinpoint uses HTTPS and TLS 1.2 by default.
