...
Before you can retrieve recommendation data from an Amazon Personalize campaign, you must create an
...
2. Create an IAM role and attach the IAM policy to it.
   ...
   that you've already created the Amazon Personalize solution and deployed it as an Amazon Personalize campaign. For
   information about creating and deploying a campaign, see [Creating a campaign](../../../personalize/latest/dg/campaigns.md#create-campaign-cli "../../../personalize/latest/dg/campaigns.md#create-campaign-cli") in the _Amazon Personalize Developer Guide_.
...
you must first create an IAM policy for the role. This policy must allow Amazon Pinpoint to do
the following:
...
text with your information:
    ...
    * `region` – The name of the
     AWS Region that hosts the Amazon Personalize solution and campaign.
    ...
    * `campaignId` – The unique resource ID
     for the Amazon Personalize campaign from which to retrieve recommendation
     data.
...
`CreatePolicy` operation, you must attach a policy to your
user account that lets you create new IAM policies and roles for your
...
following: 5. Enter the following command to attach the policy that you created in the
previous section to the role that you created:
