...
The following topics explain how to work with endpoints in Amazon Pinpoint. For information about adding endpoints automatically using your Android, iOS, or JavaScript client, see [Register Amazon Pinpoint endpoints in your application](integrate-endpoints.md).

**Topics**
+ [Add endpoints](audience-define-endpoints.md)
+ [Associate users with endpoints](audience-define-user.md)
+ [Add a batch of endpoints](audience-define-endpoints-batch.md)
+ [Import endpoints](audience-define-import.md)
+ [Export endpoints from Amazon Pinpoint to Amazon S3 buckets](audience-define-export.md)
+ [Look up endpoints in an Amazon Pinpoint project](audience-define-lookup.md)
+ [List endpoint IDs](audience-define-list-ids.md)
+ [Manage endpoint maximum](audience-define-auto-inactive.md)
+ [Delete endpoints](audience-define-remove.md)