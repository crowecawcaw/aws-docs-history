...
**Topics**
+ [Set up Amazon Pinpoint to stream app event data through Amazon Kinesis or Amazon Data Firehose](event-streams-setup.md)
+ [App event data stream from Amazon Pinpoint](event-streams-data-app.md)
+ [Campaign event data stream from Amazon Pinpoint](event-streams-data-campaign.md)
+ [Journey event data from Amazon Pinpoint](event-streams-data-journey.md)
+ [Email event data stream from Amazon Pinpoint](event-streams-data-email.md)
+ [SMS event data stream from Amazon Pinpoint](event-streams-data-sms.md)
+ [Delete an event stream from Amazon Pinpoint](event-streams-disable.md)