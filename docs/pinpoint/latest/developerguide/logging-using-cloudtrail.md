...
<a name="pinpoint-info-in-cloudtrail"></a>
...
+ [Amazon Pinpoint API](pinpoint-cloudtrail-actions.md)
+ [Amazon Pinpoint SMS and Voice API](pinpoint-sms-voice-cloudtrail-actions.md)