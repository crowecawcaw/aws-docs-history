...
# Use `CreateConfigurationSetEventDestination` with an AWS SDK
...
- For API details, see
  [CreateConfigurationSetEventDestination](../../../sdk-for-sap-abap/v1/api/latest/index.md "../../../sdk-for-sap-abap/v1/api/latest/index.md")
