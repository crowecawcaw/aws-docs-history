...
# Scenarios for Amazon Pinpoint using AWS SDKs

The following code examples show you how to implement common scenarios in Amazon Pinpoint
with AWS SDKs. These scenarios show you how to accomplish specific tasks by calling multiple functions
within Amazon Pinpoint or combined with other AWS services.
