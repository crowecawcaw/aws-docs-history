...
For an introduction to creating Lambda functions, see [Building Lambda functions](https://docs.aws.amazon.com/lambda/latest/dg/getting-started.html) in the *AWS Lambda Developer Guide*.
