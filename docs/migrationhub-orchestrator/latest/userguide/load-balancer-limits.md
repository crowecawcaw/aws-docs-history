...
To view a list of the quotas for Migration Hub Orchestrator, see [Orchestrator service quotas](../../../general/latest/gr/migrationhuborchestrator.md#limits_migrationhuborchestrator "../../../general/latest/gr/migrationhuborchestrator.md#limits_migrationhuborchestrator").

To view the quotas for Migration Hub Orchestrator, open the [Service Quotas console](https://console.aws.amazon.com/servicequotas/home "https://console.aws.amazon.com/servicequotas/home"). In the navigation pane, choose **AWS services**
and select **Migration Hub Orchestrator**.
