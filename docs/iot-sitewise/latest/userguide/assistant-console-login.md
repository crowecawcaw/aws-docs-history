...
![Integration with AWS IoT TwinMaker popup](images/ai-enable-twinmaker-in-assistant.png) 2. Choose **Assistant** from the left navigation panel.

![The Assistant is enabled by default.](images/ai-assistant-console.png)
