...
![The "Enable AWS IAM Identity Center (SSO)" page of the "Create portal" process.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sitewise-enable-sso-console.png)
...
![The "Invite administrators" page of the "Create portal" process.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sitewise-invite-portal-administrators-console.png)
...
![The "Portal details" page with "Assign users" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sso-widget-create-user-console.png)

      1. Choose **Create user**.

   1. Select the two IAM Identity Center users that you created in the previous step.  
![The "Assign users" page with the new IAM Identity Center users highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sitewise-choose-users-to-assign-console.png)
...
![The "Portals" page with the wind farm portal's link highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sitewise-choose-portal-link-console.png)
...
![The portal sign-in page.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/portal-sign-in-console.png)
...
![The "Assets" page with the demo wind farm asset and "Add asset to project" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/portal-add-asset-project-console.png)

1. In the **Add asset to project** dialog box, choose **Create new project**, and then choose **Next**.  
![The "Add asset to project" dialog box with "Create new project" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/portal-choose-new-project-console.png)
...
![The "Create new project" dialog box.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/portal-create-new-project-console.png)
...
![The "Project details" page with "Assign users" and "Edit users" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/project-add-owners-console.png)

   1. Choose the user to add as a project owner (for example, **Mary Major**), and then choose the **>>** icon.  
![The "Project owners" dialog box with a user highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/project-choose-owner-console.png)
...
![The "Dashboard" edit page with the dashboard name highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-edit-console.png)

1. Drag **Total Average Power** from the **Demo Wind Farm Asset** to the dashboard to create a visualization.  
![The "Dashboard" edit page with the "Average Total Power" property dragging an asset property to the dashboard.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-add-total-power-console.png)
...
![The "Dashboard" edit page with a wind turbine's "Wind Speed" property highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-add-wind-speed-console.png)
...
![A "Wind Speed" visualization that contains four demo wind turbine assets' wind speeds.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-add-all-wind-speeds-console.png)
...
![A "Torque (KiloNewton Meter)" visualization with visualization type and bar chart icons.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-change-torque-visualization-type-console.png)
...
![A "Wind Direction" visualization with the visualization type and KPI chart icons highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/dashboard-change-wind-direction-visualization-type-console.png)
...
![A complete wind farm dashboard.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/wind-farm-dashboard-console.png)
...
![A complete wind turbine dashboard.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/wind-turbine-dashboard-console.png)
...
![The "Portals" page with the wind farm portal and "Delete" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sitewise-choose-delete-portal-console.png)

1. In the **Delete portal** dialog box, choose **Remove administrators and users**.  
![The "Delete portal" dialog box with "Remove administrators and users" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sitewise-delete-portal-remove-users-console.png)

1. Enter **delete** to confirm deletion, and then choose **Delete**.  
![The "Delete portal" dialog box with "Delete" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sitewise-delete-portal-confirm-delete-console.png)
...
![IAM Identity Center "Users" page with "Delete users" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sso-choose-delete-users-console.png)

1. In the **Delete users** dialog box, enter **DELETE**, and then choose **Delete users**.  
![IAM Identity Center "Delete users" dialog box.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/monitor-wind-farm/sso-delete-users-console.png)