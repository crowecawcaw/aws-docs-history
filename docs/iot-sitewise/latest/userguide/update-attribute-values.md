...
Assets inherit the attributes of their asset model, including the default value of the
attribute. In some cases, you will want to keep the asset model's default attribute, such as
for an asset manufacturer property. In other cases, you will want to update the inherited
attribute, such as for an asset's latitude and longitude.
...
asset. 4. Choose **Edit**. 5. Find the attribute to update, and then enter its new value.

![AWS IoT SiteWise "Edit asset" page screenshot with an attribute value highlighted.](images/sitewise-update-asset-attribute-console.png) 6. Choose **Save**.
