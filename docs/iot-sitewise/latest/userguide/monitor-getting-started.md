...
<a name="monitor-getting-started"></a>
...
**Topics**
+ [Create a portal in SiteWise Monitor](monitor-create-portal.md)
+ [Configure your portal in SiteWise Monitor](monitor-configure-portal.md)
+ [Invite administrators in SiteWise Monitor](monitor-invite-administrators.md)
+ [Add portal users in SiteWise Monitor](monitor-add-portal-users.md)
+ [Create AWS IoT SiteWise dashboards (AWS CLI)](create-dashboards-using-aws-cli.md)
