...
- [Basics](service_code_examples_basics.md "service_code_examples_basics.md")
  ...
  - [Actions](service_code_examples_actions.md "service_code_examples_actions.md")
    ...
    - [CreatePortal](example_iotsitewise_CreatePortal_section.md "example_iotsitewise_CreatePortal_section.md")
    ...
    - [DeletePortal](example_iotsitewise_DeletePortal_section.md "example_iotsitewise_DeletePortal_section.md")
    ...
    - [DescribePortal](example_iotsitewise_DescribePortal_section.md "example_iotsitewise_DescribePortal_section.md")
