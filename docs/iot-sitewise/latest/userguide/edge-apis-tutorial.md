...
1. Create a file called **get\_credentials.py** and the copy the following code into it.
...
1. Run **get\_credentials.py** from the terminal replacing `<gateway_username>` and `<gateway_password>` with the credentials you created.
...
1. Run the following command from the terminal replacing <gateway\_username> and <gateway\_password> with the credentials you created.
...
1. Create a file called **list\_asset\_model.py** and the copy the following code into it.
...
1. Run **list\_asset\_model.py** from the terminal.
