...
![The IoT dashboard Create dashboard page with Create highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/ai-new-project-create-dash.png)

   1.  Create a dashboard from a project in the **Projects** section, under **Dashboards**.   
![The IoT dashboard Create dashboard page with Create highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/ai-existing-project-new-dash-create.png)
...
1.  Select **Create**.   
![The IoT dashboard Create dashboard page with Create highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/ai-existing-project-new-dash-name.png)
