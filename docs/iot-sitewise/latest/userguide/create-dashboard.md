...
1.  Create a dashboard in two ways:
    1.  Create a dashboard from **Build a dashboard** in the **Home** page.
        ...
        ![The IoT dashboard Create dashboard page with Create highlighted.](images/ai-new-project-create-dash.png)

    2.  Create a dashboard from a project in the **Projects** section, under **Dashboards**.

    ![The IoT dashboard Create dashboard page with Create highlighted.](images/ai-existing-project-new-dash-create.png)

2.  Select **Create** in the upper right corner.
3.  Enter a **Dashboard name**, and give an optional **Dashboard description**.
4.  Select **Create**.

![The IoT dashboard Create dashboard page with Create highlighted.](images/ai-existing-project-new-dash-name.png) 5. Configure your newly created dashboard.
