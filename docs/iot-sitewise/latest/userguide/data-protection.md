...
applies to data protection in AWS IoT SiteWise. As described in this model, AWS is
...
- If you require FIPS 140-3 validated cryptographic modules when accessing AWS through
  ...
  customers' email addresses, into tags or free-form text fields such as a **Name** field. This includes when you work with AWS IoT SiteWise or other AWS services
...
- [Internetwork traffic privacy for AWS IoT SiteWise](internetwork-traffic-privacy.md "internetwork-traffic-privacy.md")
- [AWS IoT SiteWise Assistant Business Service improvement](assistant-bsp.md "assistant-bsp.md")
