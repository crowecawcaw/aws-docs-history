...
**Topics**
+ [Create asset models in AWS IoT SiteWise](create-asset-models.md)
+ [Create component models](create-component-models.md)
+ [Define data properties](asset-properties.md)
+ [Create custom composite models (components)](create-custom-composite-models.md)