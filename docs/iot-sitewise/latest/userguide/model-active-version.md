...
**Topics**
+ [Retrieve the active version of an asset model or component model (console)](#active-console)
+ [Retrieve the active version of an asset model or component model (AWS CLI)](#active-cli)
