...
| -------------- | ------------ | ------------------------------------------- | ------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `POWER`        | POWER (int   | double, int                                 | double)                                                       | Returns the value of first argument raised to the power of the second<br>argument. |
| `ROUND`        | • ROUND (int | double, decimal_places_int)<br>• ROUND (int | double)                                                       | Rounds to the nearest integer.                                                     |
