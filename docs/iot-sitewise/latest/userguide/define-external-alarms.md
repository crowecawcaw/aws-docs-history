...
You can use the AWS IoT SiteWise console to define an external alarm on an existing asset model. To define an external alarm on a new asset model, create the asset model, and then complete these steps. For more information, see [Create asset models in AWS IoT SiteWise](create-asset-models.md).
...
+ [Create an asset model (AWS CLI)](create-asset-models.md#create-asset-model-cli)
