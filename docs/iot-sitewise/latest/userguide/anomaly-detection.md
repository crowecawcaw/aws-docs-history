...
**Topics**
+ [Add a prediction definition (console)](#ad-add-prediction-definition-console)
+ [Train a prediction (console)](#ad-train-prediction-console)
+ [Start or stop inference on a prediction (console)](#ad-start-stop-inference-console)
+ [Add a prediction definition (CLI)](#ad-add-prediction-definition-cli)
+ [Train a prediction and starting inference (CLI)](#ad-train-inference-prediction-cli)
+ [Train a prediction (CLI)](#ad-train-prediction-cli)
+ [Start or stop inference on a prediction (CLI)](#ad-start-stop-inference-cli)
