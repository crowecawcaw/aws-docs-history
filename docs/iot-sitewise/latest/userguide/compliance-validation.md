...
Your compliance responsibility when using AWS IoT SiteWise is determined by the sensitivity
...
- [Security and Compliance Quick Start Guides](https://aws.amazon.com/solutions/security/ "https://aws.amazon.com/solutions/security/") – These deployment
...
- [AWS Security Hub CSPM](../../../securityhub/latest/userguide/what-is-securityhub.md "../../../securityhub/latest/userguide/what-is-securityhub.md")
  ...
  and best practices.
- [Ten security golden rules for Industrial IoT solutions](https://aws.amazon.com/blogs/iot/ten-security-golden-rules-for-industrial-iot-solutions/ "https://aws.amazon.com/blogs/iot/ten-security-golden-rules-for-industrial-iot-solutions/")
  – This blog post introduces ten golden rules that help secure
  your industrial control systems (ICS), industrial Internet of Things (IIoT), and cloud environments.
- [Security Best Practices for Manufacturing OT](https://d1.awsstatic.com/whitepapers/security-bp-for-manufacturing-ot.pdf "https://d1.awsstatic.com/whitepapers/security-bp-for-manufacturing-ot.pdf")
  – This whitepaper describes security best
  practices to design, deploy, and architect these on-premises hybrid manufacturing
  workloads for the AWS Cloud.
