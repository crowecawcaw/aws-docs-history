...
+ [Security and Compliance Quick Start Guides](https://aws.amazon.com/solutions/security/) – These deployment guides discuss architectural considerations and provide steps for deploying security- and compliance-focused baseline environments on AWS.
