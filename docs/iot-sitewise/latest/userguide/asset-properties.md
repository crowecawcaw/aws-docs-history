...
**Topics**
+ [Define static data (attributes)](attributes.md)
+ [Define data streams from equipment (measurements)](measurements.md)
+ [Transform data (transforms)](transforms.md)
+ [Aggregate data from properties and other assets (metrics)](metrics.md)
+ [Use formula expressions](formula-expressions.md)