...
![Left navigation pane in the AWS IoT SiteWise console with Portals highlighted.](images/ai-sitewise-choose-portals-console.png) 3. Choose a portal, and then choose **Open portal** (or choose the
