...
- **Security of the cloud** – AWS is responsible for
  ...
  apply to AWS IoT SiteWise, see [AWS services in scope by compliance
...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS IoT SiteWise. The following topics show you how to configure AWS IoT SiteWise to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS IoT SiteWise resources.

###### Topics

- [Data protection in AWS IoT SiteWise](data-protection.md "data-protection.md")
- [Data encryption in AWS IoT SiteWise](data-encryption.md "data-encryption.md")
- [Identity and access management for AWS IoT SiteWise](security-iam.md "security-iam.md")
