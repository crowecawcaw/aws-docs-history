...
| `TO_TIMESTAMP` | • TO\_TIMESTAMP (double)<br>• TO\_TIMESTAMP (string, format) | • Converts an epoch second integer into a timestamp data type.<br>• Converts a string representation of a date and time into a timestamp<br>data type.                                                                         |
