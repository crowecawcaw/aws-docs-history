...
![AWS IoT SiteWise console with Scenario Discovery in the navigation menu](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image2.png)


![Scenario Discovery benefits, features, and use cases overview](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image3.png)


You can now create a workspace.

![Scenario Discovery get started page](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image4.png)
...
![Workspaces management view showing active environments](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image5.png)


![Creating a workspace and signing up with your email](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image6.png)


![Linking an existing user account to your new workspace](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image7.png)


![Configuring workspace name and encryption settings](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image8.png)


For creating an encrypted workspace with your own KMS keys, see [Encryption at rest](sd-encryption.md) for instructions.

![Verifying your new workspace in the workspaces list](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image9.png)


![Overview of the workspace created](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/sd-image10.png)
