...
<a name="portal-change-details-ai"></a>
...
![Portal details section of the portal details page with Edit highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/userguide/images/ai-sitewise-view-portal-details-console.png)
