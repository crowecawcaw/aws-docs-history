...
**Topics**
+ [Query current asset property values in AWS IoT SiteWise](current-values.md)
+ [Query historical asset property values in AWS IoT SiteWise](historical-values.md)
+ [Query asset property aggregates in AWS IoT SiteWise](aggregates.md)
+ [AWS IoT SiteWise query language](sql.md)
+ [Query optimization](query-optimize.md)
+ [ODBC](query-ODBC.md)