...
<a name="add-assets-to-dashboards"></a>
...
![The "Dashboards" page with an existing dashboard and "Create dashboard" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/project-create-or-modify-dashboard-console.png)
...
![A dashboard with a callout highlighting an asset property that you can drag onto the dashboard.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/dashboard-add-visualization-console.png)
