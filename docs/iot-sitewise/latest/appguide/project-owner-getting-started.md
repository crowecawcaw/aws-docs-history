...
![The dashboard editor with "Total average power" highlighted.](/images/iot-sitewise/latest/appguide/images/dashboard-add-visualization-console.png) 3. To change how your data displays, choose the visualization type.
