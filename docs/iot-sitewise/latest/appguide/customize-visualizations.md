...
**Topics**
+ [Change visualization types](#changing-visualization-types)
+ [Add data to a visualization](#adding-data-to-visualization)
+ [Remove data from a visualization](#removing-data-from-visualization)
+ [Delete a visualization](#deleting-visualizations)
+ [Choose visualization types](choose-visualization-types.md)
+ [Configure thresholds](configure-thresholds.md)
+ [Configure trend lines](configure-trend-lines.md)
