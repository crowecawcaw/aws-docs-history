...
5. On the **Define threshold** page, you define when the alarm
   ...
   If you choose **Custom value**, enter a number. 4. Enter the **Severity** of the alarm. Use an integer that your
   team understands to reflect the severity of this alarm. 5. Choose an asset to preview this threshold. 6. Choose **Next**.
...
7. On the **Configure notification** page, you configure the notification recipient,
   ...
   Your IT administrator must add IAM Identity Center users in the current AWS Region before you can add recipients for this alarm. 2. For **Protocol**, choose from the following options:
   ...
   that helps your team understand how to address this alarm. 4. Choose **Create alarm definition**.
