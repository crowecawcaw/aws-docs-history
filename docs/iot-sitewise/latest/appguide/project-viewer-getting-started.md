...
<a name="project-viewer-getting-started"></a>
...
+ [Sign in to a portal](getting-started.md#portal-login)
+ [Explore shared dashboards](#project-viewer-exploring-dashboards)
+ [Explore project assets and their data](#project-viewer-exploring-assets)

## Explore shared dashboards
<a name="project-viewer-exploring-dashboards"></a>
...
1. If you're a project owner or portal administrator, you can modify the dashboard. For more information see [Add visualizations in AWS IoT SiteWise Monitor](add-visualizations.md).

## Explore project assets and their data
<a name="project-viewer-exploring-assets"></a>
...
<tbody>
  ...
  <tr><td>B</td><td>Select the time range for the data shown for the properties of the selected assets.</td></tr>
  <tr><td>C</td><td>View the values for the properties of the selected asset. View and respond to the alarms for the selected asset.</td></tr>
</tbody>
</table>
