...
| [View project details](view-project-details.md "view-project-details.md")                        | Portal administrators can view details for all projects. Project owners and project viewers can view details for projects to which they have been invited. |
...
| [Assign project viewers](assign-project-viewers.md "assign-project-viewers.md")                  | Portal administrators can invite viewers to any project in the portal. Project owners can invite viewers to projects that they administer.                 |
| [Change project details](edit-project-details.md "edit-project-details.md")                      | Only portal administrators can update the name and description for a project.                                                                              |
