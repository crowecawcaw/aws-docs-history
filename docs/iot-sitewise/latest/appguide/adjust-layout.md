...
The SiteWise Monitor application lets you to adjust the layout of your dashboards and visualizations to better suit your needs. You can resize and rearrange the various components on the dashboard to create a customized view that highlights the most important information for your use case. Additionally, you can change the layout to optimize for different screen sizes and resolutions, ensuring a consistent and user-friendly experience across devices.
