...
<a name="add-assets-to-projects-sd"></a>
...
<a name="add-assets-new-project-sd"></a><a name="add-assets-new-project"></a>
...
<a name="add-assets-existing-project-sd"></a><a name="add-assets-existing-project"></a>
...
![Add assets to project dialog.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/asset-library-add-assets-to-existing-project-console.png)
...
<a name="remove-project-assets-sd"></a>
...
![The "Projects" page with "Remove all assets from project" button highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/project-remove-all-assets-console.png)
