...
![The "Create new project" page with the "Create project" button highlighted.](images/projects-create-new-project-console.png) 4. Choose **Finish** to create the new project.
