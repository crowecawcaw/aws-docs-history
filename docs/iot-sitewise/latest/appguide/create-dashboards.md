...
![The dashboards list with "Create dashboard" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/dashboards-create-dashboard-console.png)
...
1. <a name="dashboard-add-visualizations-link"></a>Add one or more visualizations. For more information, see [Add visualizations in AWS IoT SiteWise Monitor](add-visualizations.md).
