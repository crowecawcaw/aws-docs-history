...
<a name="add-assets-to-projects-ea"></a>
...
<a name="add-assets-new-project-ea"></a><a name="add-assets-new-project"></a>
...
<a name="add-assets-existing-project-ea"></a><a name="add-assets-existing-project"></a>
...
<a name="remove-project-assets-ea"></a>
