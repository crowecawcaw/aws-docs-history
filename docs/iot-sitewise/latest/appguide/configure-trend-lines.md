...
![A line graph visualization with a linear trend line.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/dashboard-trend-line-graph-console.png)
...
![The visualization configuration panel with "Add a trend line" highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/dashboard-add-trend-console.png)
...
![A visualization trend line with the remove icon highlighted.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/dashboard-remove-trend-console.png)
