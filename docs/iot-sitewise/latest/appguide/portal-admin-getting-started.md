...
<a name="portal-admin-getting-started"></a>
...
+ [Explore asset data and adding assets to projects](#portal-admin-exploring-assets)
+ [Assign owners to the project](#portal-admin-inviting-owners)
+ [Get started as a project owner](project-owner-getting-started.md)

## Explore asset data and adding assets to projects
<a name="portal-admin-exploring-assets"></a>
...
<a name="portal-admin-inviting-owners"></a>
