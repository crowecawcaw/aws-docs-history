...
The following procedures describe how to view asset data on the **Assets** page and how to view asset data from a project page. For information about viewing asset data in dashboards, see [View dashboards in AWS IoT SiteWise](view-dashboards.md).

**To view asset data on the Assets page**

1. Log in to your AWS IoT SiteWise Monitor portal. For more information, see [Sign in to an AWS IoT SiteWise Monitor portal](getting-started.md#portal-login).
...
![The "Assets" page, with a factory asset and its properties.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/asset-library-choose-asset-console.png)
...
![The "Assets" page, with an equipment asset and its properties.](https://docs.aws.amazon.com/iot-sitewise/latest/appguide/images/asset-library-choose-child-asset-console.png)
