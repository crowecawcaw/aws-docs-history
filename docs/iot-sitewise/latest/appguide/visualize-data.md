...
| --- | --- | --- | 
| [View dashboards in AWS IoT SiteWise](view-dashboards.md) | Portal administrator, project owner, and project viewer | View the dashboards to which you have been given access. | 
| [Create dashboards in an AWS IoT SiteWise Monitor project](create-dashboards.md) | Portal administrator, project owner | Create a dashboard in a project. | 
| [Add visualizations in AWS IoT SiteWise Monitor](add-visualizations.md) | Portal administrator, project owner | Add a visualization to a dashboard. | 
