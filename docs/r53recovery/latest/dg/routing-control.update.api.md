...
- For information about using the AWS CLI to get and update routing control states, see [List and update routing controls and states with the AWS CLI](getting-started-cli-routing.control-state.md "getting-started-cli-routing.control-state.md").
