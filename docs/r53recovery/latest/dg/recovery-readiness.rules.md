...
readiness rules in the following section: [Readiness rules in ARC](recovery-readiness.rules-resources.md#recovery-readiness.list-rules "recovery-readiness.rules-resources.md#recovery-readiness.list-rules").
