...
- **ZonalShiftEnabled** – If set to `true`, Auto Scaling registers the Auto Scaling group with ARC zonal shift and you can [start, update, or cancel a zonal shift](arc-zonal-shift.start-cancel.md "arc-zonal-shift.start-cancel.md") on the
...
- **ZonalShiftEnabled** – If set to `TRUE`, Auto Scaling
  ...
  [start, update, or cancel a zonal shift](arc-zonal-shift.start-cancel.md "arc-zonal-shift.start-cancel.md") on the
...
To start a zonal shift, see [Starting, updating, or canceling a zonal shift](arc-zonal-shift.start-cancel.md "arc-zonal-shift.start-cancel.md").
