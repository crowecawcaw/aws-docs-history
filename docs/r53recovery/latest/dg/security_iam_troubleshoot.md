# Troubleshooting Amazon Application Recovery Controller (ARC) identity and
...
- [I am not authorized to
  perform an action in ARC](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my ARC resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in ARC
...
have the fictional `route53-recovery-readiness:`GetWidget``
permissions.
...
`route53-recovery-readiness:`GetWidget`` action.
...
ARC. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my ARC resources
...
- To learn whether ARC supports these features, see [How Amazon Application Recovery Controller (ARC) capabilities work with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
