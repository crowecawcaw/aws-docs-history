...
To see a list of ARC actions for readiness check, see
[Actions defined by Amazon Route 53 Recovery Readiness](../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoveryreadiness-actions-as-permissions "../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoveryreadiness-actions-as-permissions")
...
For details about creating or managing ARC service-linked roles, see [Using service-linked role for readiness check in ARC](using-service-linked-roles-readiness.md "using-service-linked-roles-readiness.md").
