...
| [Amazon EC2 Amazon EC2 Auto Scaling group execution block](ec2-auto-scaling-block.md "ec2-auto-scaling-block.md")  | Scale EC2 compute resources that are in an Amazon EC2 Auto Scaling group as part of your plan execution.                            | Specify the minimum percentage of compute capacity that should be matched in the Region that you're activating. |
