...
| [ARC routing control execution block](arc-routing-controls-block.md "arc-routing-controls-block.md")               | Add a step to change the state of one or more ARC routing controls, to redirect your application traffic to a target AWS Region. | N/A                                                                                                             |
