...
- [Responsibilities and permissions for shared clusters](#sharing-perms "#sharing-perms")
...
Use the [get-resource-policy](../../../recovery-cluster/latest/api/resourcepolicy-resourcearn.html.md "../../../recovery-cluster/latest/api/resourcepolicy-resourcearn.html.md") command.
...
routing control API operation](actions.routing-control.md "actions.routing-control.md"), using the AWS Command Line Interface or AWS SDKs.
...
For a list of routing control quotas, see [Quotas for routing control](routing-control.quotas.md "routing-control.quotas.md").
