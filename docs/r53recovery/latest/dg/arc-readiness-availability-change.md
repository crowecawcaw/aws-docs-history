...
check feature is affected by this change. There are no changes to Region switch, routing
...
ARC Region switch is a fully managed service that provides complete multi-Region
recovery orchestration. It includes a capability called plan evaluation, which regularly
monitors the state of your Region switch plan to ensure readiness for execution.

To get started with ARC Region switch, see [Region switch in ARC](region-switch.md "region-switch.md").
