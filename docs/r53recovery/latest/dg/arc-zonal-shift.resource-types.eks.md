...
For more information on starting a zonal shift, see [Starting, updating, or canceling a zonal shift](arc-zonal-shift.start-cancel.md "arc-zonal-shift.start-cancel.md").
