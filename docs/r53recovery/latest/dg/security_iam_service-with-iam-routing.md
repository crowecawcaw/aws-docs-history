...
To see a list of ARC actions for routing control, see
...
Policy actions in ARC for routing control use the following prefixes before the action, depending
on the API that you're working with:
...
To specify multiple actions in a single statement, separate them with commas. For example, you could do
the following:
...
In the _Service Authorization Reference_, you can see the following information related to ARC:

To see a list of resource types and their ARNs, and the actions that you can specify with the ARN of each resource, see the following topics
in the _Service Authorization Reference_:
...
To see a list of ARC condition keys for routing control, see the following topics
in the _Service Authorization Reference_:

- [Condition keys for Amazon Route 53 Recovery Controls](../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoverycontrols-policy-keys "../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoverycontrols-policy-keys")
- [Condition keys for Amazon Route 53 Recovery Cluster](../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoverycluster-policy-keys "../../../service-authorization/latest/reference/list_amazonroute53recoverycontrols.md#amazonroute53recoverycluster-policy-keys")
...
To see whether an action requires additional dependent actions in a policy, see the following topics
in the _Service Authorization Reference_:
...
A service-linked role is a type of service role that is linked to an AWS service. The service can assume
the role to perform an action on your behalf. Service-linked roles appear in your AWS account and are owned
