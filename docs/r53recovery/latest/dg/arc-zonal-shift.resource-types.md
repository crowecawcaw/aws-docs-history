...
- [Amazon EC2 Auto Scaling groups](arc-zonal-shift.resource-types.ec2-auto-scaling-groups.md "arc-zonal-shift.resource-types.ec2-auto-scaling-groups.md")
- [Amazon Elastic Kubernetes Service](arc-zonal-shift.resource-types.eks.md "arc-zonal-shift.resource-types.eks.md")
- [Application Load Balancers](arc-zonal-shift.resource-types.app-load-balancers.md "arc-zonal-shift.resource-types.app-load-balancers.md") with
  cross-zone load balancing enabled or disabled
- [Network Load Balancers](arc-zonal-shift.resource-types.network-load-balancers.md "arc-zonal-shift.resource-types.network-load-balancers.md") with cross-zone load balancing enabled or disabled
