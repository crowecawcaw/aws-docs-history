...
Zonal autoshift for ARC is integrated with AWS CloudTrail, a service that provides a record of actions
...
in ARC for zonal autoshift, that activity is recorded in a CloudTrail event along with other AWS service events
...
For an ongoing record of events in your AWS account, including events for zonal autoshift in ARC,
