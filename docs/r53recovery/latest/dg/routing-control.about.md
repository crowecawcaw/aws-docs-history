...
doesn't impair availability. For more information, see [Creating safety rules for routing control](routing-control.safety-rules.md "routing-control.safety-rules.md").
...
[Ensuring that traffic shifts finish quickly](route53-arc-best-practices.zonal-shifts.md#arc-zonal-shift.existing-connections "route53-arc-best-practices.zonal-shifts.md#arc-zonal-shift.existing-connections").
