...
| Amazon S3 *_delta\_lake_<br>• folder only | The *_delta\_lake_<br>• folder containing the metadata of scanned data. Backed using an Amazon S3 replication rule                                                                                                                                               |
...
the **delta\_lake** folder that contains ingestion metadata from the Amazon S3 source bucket for the EDI IQ console.
