...
+ Incident priority: How you or ECO prioritizes incidents as either Low, Medium, or High. For definitions, see [Incident priority](incident-mgmt.md#incident-mgmt-priority).
...
+ ITIL: Information Technology Infrastructure Library (ITIL) is an IT service management (ITSM) framework that's designed to standardize the lifecycle of IT services. ITIL is arranged in ﬁve stages of the IT service lifecycle: service strategy, service design, service transition, service operation, and service improvement.
