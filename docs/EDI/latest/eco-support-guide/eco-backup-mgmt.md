...
The ECO team enables backups for Amazon RDS, DynamoDB, and Amazon EC2 instances in your account as part of the default backup plan. To learn more, see [How AWS Backup works with supported AWS services](https://docs.aws.amazon.com/aws-backup/latest/devguide/working-with-supported-services.html), in the *AWS Backup User Guide*.