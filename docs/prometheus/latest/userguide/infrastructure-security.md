...
As a managed service, Amazon Managed Service for Prometheus is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon Managed Service for Prometheus through the network. Clients must
