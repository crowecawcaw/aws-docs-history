...
+ *upper\_band* - The upper boundary of expected normal values
+ *lower\_band* - The lower boundary of expected normal values
...
You can preview how anomaly detection will work with your metrics using the `PreviewAnomalyDetector` API. Use `PreviewAnomalyDetector` to test the algorithm against your historical data and evaluate its effectiveness before implementing it in production monitoring. For more information, see [PreviewAnomalyDetector API](anomaly-detection-api.md).
