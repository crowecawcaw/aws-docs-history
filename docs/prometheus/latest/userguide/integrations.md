...
**Topics**
+ [Integrating with Amazon EKS cost monitoring](integrating-kubecost.md)
+ [Set up Amazon Managed Service for Prometheus with AWS Observability Accelerator](obs_accelerator.md)
+ [Manage Amazon Managed Service for Prometheus with AWS Controllers for Kubernetes](integrating-ack.md)
+ [Integrating CloudWatch metrics with Amazon Managed Service for Prometheus](integrating-cw-firehose.md)