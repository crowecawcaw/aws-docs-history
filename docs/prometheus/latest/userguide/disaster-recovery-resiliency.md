...
In addition to the AWS global infrastructure, Amazon Managed Service for Prometheus offers several features to
help support your data resiliency and backup needs, including support for [high-availability data](AMP-ingest-dedupe.md "AMP-ingest-dedupe.md").
