...
[AWS Deep Learning Containers (DLCs)](https://aws.amazon.com/machine-learning/containers/ "https://aws.amazon.com/machine-learning/containers/") for Amazon SageMaker are now available with PyTorch 2.9 and support for CUDA 13.0 on Ubuntu 22.04. You can launch the new versions of the Deep Learning Containers on any of the SageMaker service(s). For a complete list of frameworks and versions supported by the AWS Deep Learning Containers, see below.
...
- Introduced containers for PyTorch 2.9 for Training which support SageMaker. For details about this release, check out our GitHub [release tag.](https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.9.0-tr-py312 "https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.9.0-tr-py312")
- Please refer to the official PyTorch 2.9.0 release notes [here](https://github.com/PyTorch/PyTorch/releases/tag/v2.9.0 "https://github.com/PyTorch/PyTorch/releases/tag/v2.9.0").
...
- The GPU Docker Image includes the following libraries:
  ...
  - cuDNN 9.13.0.50
  - NCCL 2.27.7-1
  - EFA installer 1.43.3 (with AWS OFI NCCL embedded)
  - Transformer Engine 2.9
  - Flash Attention 2.8.3
  - GDRCopy 2.5.1

- The Dockerfile for CPU can be found [here](https://github.com/aws/deep-learning-containers/blob/master/pytorch/training/docker/2.9/py3/Dockerfile.cpu "https://github.com/aws/deep-learning-containers/blob/master/pytorch/training/docker/2.9/py3/Dockerfile.cpu"), and the Dockerfile for GPU can be found [here](https://github.com/aws/deep-learning-containers/blob/master/pytorch/training/docker/2.9/py3/cu130/Dockerfile.gpu "https://github.com/aws/deep-learning-containers/blob/master/pytorch/training/docker/2.9/py3/cu130/Dockerfile.gpu").
