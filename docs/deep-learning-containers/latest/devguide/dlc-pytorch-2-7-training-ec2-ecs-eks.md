...
| China (Ningxia)          | cn-northwest-1 | ## Build and Test <br>• Built on: c5.18xlarge <br>• Tested on: p4d.24xlarge, p4de.24xlarge, p5.48xlarge, g4dn.4xlarge, g5.24xlarge, g5.12xlarge <br>• Tested with Resnet50, BERT along with ImageNet datasets on EC2, ECS AMI (Amazon Linux AMI 2.0.20250605), and EKS AMI (amazon-eks-gpu-node-1.32.3-20250610) |
