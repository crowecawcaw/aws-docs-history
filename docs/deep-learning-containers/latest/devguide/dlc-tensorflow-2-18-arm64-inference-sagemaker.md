# AWS Deep Learning Containers for TensorFlow 2.18 ARM64 Inference on SageMaker
...
- Support for TensorFlow Serving 2.18 on Amazon SageMaker. For details about this release, checkout our GitHub [v1.0-tf-arm64-sagemaker-2.18.0-inf-cpu-py310](https://github.com/aws/deep-learning-containers/releases/tag/v1.0-tf-arm64-sagemaker-2.18.0-inf-cpu-py310 "https://github.com/aws/deep-learning-containers/releases/tag/v1.0-tf-arm64-sagemaker-2.18.0-inf-cpu-py310")
