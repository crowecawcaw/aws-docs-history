...
- Introduced containers for PyTorch 2.5.1 for inference supporting EC2, ECS, and EKS. For details about this release, check out our GitHub[release tag](https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-ec2-2.5.1-inf-py311 "https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-ec2-2.5.1-inf-py311").
