...
- Introduced containers for PyTorch 2.5.1 for training which support SageMaker service. For details about this release, check out our GitHub [release tag](https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.5.1-tr-py311 "https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.5.1-tr-py311").
