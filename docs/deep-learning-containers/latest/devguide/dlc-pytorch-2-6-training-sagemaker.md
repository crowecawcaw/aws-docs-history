...
[AWS Deep Learning Containers](https://aws.amazon.com/machine-learning/containers/ "https://aws.amazon.com/machine-learning/containers/") (DLCs) for Amazon SageMaker (SM) are now available with PyTorch 2.6 and support for CUDA 12.6 on Ubuntu 22.04. You can launch the new versions of the Deep Learning Containers on any of the SM service. For a complete list of frameworks and versions supported by the AWS Deep Learning Containers, see below.
...
- Introduced containers for PyTorch 2.6.0 for training which support SageMaker service. For details about this release, check out our GitHub [release tag](https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.6.0-tr-py312 "https://github.com/aws/deep-learning-containers/releases/tag/v1.0-pt-sagemaker-2.6.0-tr-py312").
...
- Removed [fastai](https://github.com/fastai/fastai "https://github.com/fastai/fastai") since it hasn't release PyTorch 2.6 compatible version, refer to this [issue](https://github.com/fastai/fastai/issues/4068 "https://github.com/fastai/fastai/issues/4068").
