...
4. On the **Describe rule group** page, provide the following information:

   1. Enter a name and description for the rule group. You'll use these to
      identify the rule group when you manage it and use it.

   ###### Note

   You can't change the name after you create the rule group. 2. For **Capacity**, set the maximum capacity you want to allow for the
   ...
   setting, see [AWS Network Firewall quotas](quotas.md "quotas.md"). 3. (Optional) Under **Customer managed key**, toggle the **Customize encryption settings** option to configure your customer managed key. For more information about this option, see [Encryption at rest with AWS Key Management Service](kms-encryption-at-rest.md "kms-encryption-at-rest.md"). 4. (Optional) Under **Tags**, enter a key and optional value for any
   tag that you want added to this rule group. Tags help you organize and
...
5. Choose **Next**.
6. On the **Choose rule group type** page, for the
   **Rule group format**, choose **Stateless rule
   group**.
7. Choose **Next**.
8. On the **Configure rules** page, review the rules that you want to add to the stateless rule group.
   ...
   example, you might start with rule priorities numbered 100, 200, and so on.
...
9. Choose **Next**. 10. Review the settings for the rule group, then choose **Create stateless rule
group**.
