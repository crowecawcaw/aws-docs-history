...
- [Troubleshooting rules in AWS Network Firewall](troubleshooting-rules.md "troubleshooting-rules.md")
  ...
  - [Rules with the HOME\_NET variable are not working as expected with managed rule groups](troubleshooting-rules.md#troubleshoot-rules-home-net "troubleshooting-rules.md#troubleshoot-rules-home-net")
  - [I created a rule to allow only outbound traffic from HOME\_NET to EXTERNAL\_NET, but EXTERNAL\_NET was also able to initiate a connection back to HOME\_NET. How do I prevent this from happening?](troubleshooting-rules.md#troubleshoot-rules-allow-outbound-home-net "troubleshooting-rules.md#troubleshoot-rules-allow-outbound-home-net")
