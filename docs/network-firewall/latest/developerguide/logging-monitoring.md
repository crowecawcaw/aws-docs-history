...
**Topics**
+ [Managing AWS Network Firewall events using Amazon EventBridge](eventbridge-events.md)
+ [Logging network traffic from AWS Network Firewall](firewall-logging.md)
