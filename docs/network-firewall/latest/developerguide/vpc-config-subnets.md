...
Network Firewall supports up to 100 Gbps of network traffic per Availability Zone. The 100 Gbps bandwidth is shared across all associated VPC endpoints. If you require more traffic bandwidth,
you can split your resources into subnets and create a Network Firewall firewall in each subnet.
