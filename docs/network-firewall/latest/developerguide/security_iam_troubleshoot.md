# Troubleshooting AWS Network Firewall identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with Network Firewall and IAM.

###### Topics

- [I am not authorized to
  perform an action in Network Firewall](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my Network Firewall resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in Network Firewall
...
have the fictional `network-firewall:`GetWidget`` permissions.

```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: network-firewall:GetWidget on resource: my-example-widget
```
...
`network-firewall:`GetWidget`` action.
...
Network Firewall. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my Network Firewall resources
...
- To learn whether Network Firewall supports these features, see [How AWS Network Firewall works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
