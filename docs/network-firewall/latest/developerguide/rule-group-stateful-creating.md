...
4. On the **Describe rule group** page, provide the following information:
   ...
   You can't change the name after you create the rule group. 2. (Optional) Enter a **Description** for the rule group to help you identify it among your other resources. 3. For **Capacity**, set the maximum capacity you want to allow for the
   ...
   setting, see [AWS Network Firewall quotas](quotas.md "quotas.md"). 4. (Optional) Under **Customer managed key**, toggle the **Customize encryption settings** option to configure your customer managed key. For more information about this option, see [Encryption at rest with AWS Key Management Service](kms-encryption-at-rest.md "kms-encryption-at-rest.md"). 5. (Optional) Under **Tags**, enter a key and optional value for any
...
[Working with stateful rule groups in AWS Network Firewall](stateful-rule-groups-ips.md "stateful-rule-groups-ips.md"). 7. Choose **Next**. 8. Select the type of rule group that you want to add, from the **Stateful rule
...
9. Choose **Next**. 10. Review the settings that you've provided for the rule group, then choose **Create
stateful rule group**.
