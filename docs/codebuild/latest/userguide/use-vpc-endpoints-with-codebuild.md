...
- VPC endpoints currently do not support cross-Region requests. Make sure that
  ...
  about Region-specific endpoints for Amazon S3, see [Amazon Simple Storage Service](../../../general/latest/gr/rande.md#s3_region "../../../general/latest/gr/rande.md#s3_region") in the _Amazon Web Services General Reference_. If you use the AWS CLI to make
