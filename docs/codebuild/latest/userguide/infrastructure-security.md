...
As a managed service, AWS CodeBuild is protected by AWS global network security. For
...
You use AWS published API calls to access CodeBuild through the network. Clients must
