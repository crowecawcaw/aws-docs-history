...
1. If you want to use a curated Amazon Linux 2 image, you can pull it from the CodeBuild public Amazon ECR repository at [https://gallery.ecr.aws/codebuild/amazonlinux-x86\_64-standard](https://gallery.ecr.aws/codebuild/amazonlinux-x86_64-standard) with the following command:
