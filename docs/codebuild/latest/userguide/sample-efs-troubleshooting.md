...
- [CLIENT\_ERROR: mounting '127.0.0.1:/' failed. permission denied](#sample-efs-troubleshooting.permission-denied "#sample-efs-troubleshooting.permission-denied")
- [CLIENT\_ERROR: mounting '127.0.0.1:/' failed. connection reset by peer](#sample-efs-troubleshooting.connection-reset "#sample-efs-troubleshooting.connection-reset")
- [VPC\_CLIENT\_ERROR: Unexpected EC2 error: UnauthorizedOperation](#sample-efs-troubleshooting.unauthorized-operation "#sample-efs-troubleshooting.unauthorized-operation")
