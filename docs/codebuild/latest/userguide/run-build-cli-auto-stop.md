...
- where `<project-name>` is the name of the build
  project that contains the source code to be rebuilt.
  If this command is successful, no information and no errors appear in the
  output.
