...
![The configuration of GitLab scoped webhook.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/gitlab-group-source.png)
...
![The configuration of group webhooks.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/gitlab-group-webhook-primary-events.png)
