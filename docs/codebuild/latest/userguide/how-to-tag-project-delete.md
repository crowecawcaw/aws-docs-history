...
You can remove one or more tags associated with a project. Removing a tag does not
...
2. In **Build projects**, choose the name of the project where
   you want to remove tags.
3. In the navigation pane, choose **Settings**. Choose
   **Build project tags**.
4. Choose **Edit**.
5. Find the tag you want to remove, and then choose **Remove
   tag**.
...
If you delete a CodeBuild build project, all tag associations are removed from the
deleted build project. You do not have to remove tags before you delete a build project.
