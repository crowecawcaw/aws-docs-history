...
**Topics**
+ [Configure Squid as a transparent proxy server](#use-proxy-server-transparent-squid-configure)
+ [Create a CodeBuild project](#use-proxy-server-transparent-create-acb-project)
