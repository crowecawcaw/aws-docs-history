...
![How to add a test stage immediately after the Source stage to your pipeline.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/create-stage.png)
