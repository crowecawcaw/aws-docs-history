...
![Console screenshot showing connection option selected for GitLab.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/connections-create-gitlab.png)
...
1. If this is your first time authorizing the connection, an authorization page displays with a message requesting authorization for the connection to access your GitLab account.
   ...
   Choose **Authorize**.  
![Screenshot showing the message to authorize the connection for your GitLab account.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/gitlab-authorization.png)
