...
You can use the Jenkins plugin for AWS CodeBuild to integrate CodeBuild with your Jenkins build
jobs. Instead of sending your build jobs to Jenkins build nodes, you use the plugin to send
your build jobs to CodeBuild. This eliminates the need for you to provision, configure, and
manage Jenkins build nodes.

###### Topics

- [Set up Jenkins](#setup-jenkins "#setup-jenkins")
- [Install the plugin](#plugin-installation "#plugin-installation")
- [Use the plugin](#plugin-usage "#plugin-usage")

## Set up Jenkins

For information about setting up Jenkins with the AWS CodeBuild plugin, and to download
the plugin source code, see [https://github.com/awslabs/aws-codebuild-jenkins-plugin](https://github.com/awslabs/aws-codebuild-jenkins-plugin "https://github.com/awslabs/aws-codebuild-jenkins-plugin").

## Install the plugin

If you already have a Jenkins server set up and would like to only install the
AWS CodeBuild plugin, on your Jenkins instance, in the Plugin Manager, search for
`CodeBuild Plugin for Jenkins`.

## Use the plugin

###### To use AWS CodeBuild with sources

from outside of a VPC
...
4. For **Source Code Management**, choose how you want to
...
###### To use the AWS CodeBuild plugin with the Jenkins

pipeline plugin

- On your Jenkins pipeline project page, use the snippet generator to generate a
  pipeline script that adds CodeBuild as a step in your pipeline. It should generate a
