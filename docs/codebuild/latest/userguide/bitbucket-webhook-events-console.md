...
![A webhook filter group that triggers a build for pull requests only.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/pull-request-webhook-filter-bitbucket.png)
...
![An example of two filter groups.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/pull-request-webhook-filter-head-base-regexes-bitbucket.png)


In this example, a webhook filter group triggers a build for all requests except tag events. 

![A webhook filter group that triggers a build for all requests except tag events.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/pull-request-webhook-filter-exclude-bitbucket.png)
...
![A webhook filter group that triggers a build only when a change is made by a Bitbucket user who does not have an account ID.](https://docs.aws.amazon.com/codebuild/latest/userguide/images/pull-request-webhook-filter-actor-bitbucket.png)
