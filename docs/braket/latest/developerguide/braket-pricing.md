...
With Amazon Braket, you have access to quantum computing resources on demand without upfront commitment. You pay only for what you use. To learn more about pricing, visit our [pricing page](https://aws.amazon.com/braket/pricing/).

**Topics**
+ [Setting spending limits for Amazon Braket QPUs](#quantum-hardware-spending-limits)
+ [Near real-time cost tracking](#real-time-cost-tracking)
+ [Best practices for cost savings](#best-practices)
 ...
 **Set billing alarms** 
+ You can set a billing alarm to notify you when your bill reaches a preset limit. The recommended way to set up an alarm is through AWS Budgets. You can set custom budgets and receive alerts when your costs or usage may exceed your budgeted amount. Information is available at [AWS Budgets](https://aws.amazon.com/aws-cost-management/aws-budgets/).
