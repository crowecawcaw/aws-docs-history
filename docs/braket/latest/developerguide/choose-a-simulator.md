...
DM1 is best suited for simulating circuits with noise. Use DM1
when you need to study the effects of noise on your circuit or when your algorithm
requires density matrix operations. The runtime scales linearly with the number of
operations but exponentially with the number of qubits, limiting
