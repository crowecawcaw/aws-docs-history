...
**Topics**
+ [Create a hybrid job from local Python code](#create-hybrid-job-from-local-python-code)
+ [Install additional Python packages and source code](#install-python-packages-and-code)
+ [Save and load data into a hybrid job instance](#save-load-data-into-instance)
+ [Best practices for hybrid job decorators](#best-practices)
...
All other hybrid job options are supported. For a list of options see the [braket.jobs.quantum\_job\_creation module](https://amazon-braket-sdk-python.readthedocs.io/en/stable/_apidoc/braket.jobs.quantum_job_creation.html). 
