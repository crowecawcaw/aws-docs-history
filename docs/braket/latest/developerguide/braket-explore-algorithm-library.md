...
console. For more information, see the [Braket Github algorithm library](https://github.com/amazon-braket/amazon-braket-algorithm-library "https://github.com/amazon-braket/amazon-braket-algorithm-library").

![Amazon Braket's Algorithm library page showing a list of pre-built quantum algorithms like Berstein Vazirani, Deutsch-Jozsa, Grover's algorithm, and Quantum Approximate Optimization Algorithm with brief descriptions.](images/AlgorithmLibrary.png)
