...
**Topics**
+ [Shared responsibility for security](#braket-shared-security)
+ [Data protection](#braket-data-protection)
+ [Data retention](#braket-data-retention)
+ [Managing access to Amazon Braket](braket-manage-access.md)
+ [Amazon Braket service-linked role](braket-slr.md)
+ [Compliance validation for Amazon Braket](compliance-validation.md)
+ [Infrastructure Security in Amazon Braket](infrastructure-security.md)
+ [Security of Amazon Braket Hardware Providers](third-party-security.md)
+ [Amazon VPC endpoints for Amazon Braket](braket-privatelink.md)

## Shared responsibility for security
<a name="braket-shared-security"></a>
...
## Data protection
<a name="braket-data-protection"></a>
...
## Data retention
<a name="braket-data-retention"></a>
