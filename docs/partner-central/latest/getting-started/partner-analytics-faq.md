...
<a name="partner-analytics-faq"></a>
...
<a name="data-discrepancies"></a>

File a ticket with APN Support to resolve discrepancies. From the left navigation panel, choose [AWS Partner Central support](https://partnercentral.awspartner.com/partnercentral2/s/support) to file a ticket.

### Why doesn't the Partner Scorecard data match what is shown in Partner Analytics dashboard data?
<a name="scorecard-data-mismatch"></a>
...
<a name="opportunities-dashboard-faqs"></a>
...
<a name="opportunity-win-rate-difference"></a>
...
<a name="partner-referrals-approval-rate"></a>
...
<a name="stage-aws-stage-difference"></a>
...
<a name="aws-co-sell-recommendation-score-faqs"></a>

### How do I see AWS Co-Sell Recommendation Scores on Partner Analytics?
<a name="see-co-sell-scores"></a>
...
<a name="marketplace-influence"></a>
...
<a name="model-evaluate-capabilities"></a>
...
<a name="service-validations-affect"></a>
...
<a name="wrong-use-case-tagged"></a>
...
<a name="submit-more-opportunities"></a>
...
<a name="win-rate-deal-size-impact"></a>
...
<a name="hundreds-pos-no-score"></a>
...
<a name="software-partner-public-listing"></a>
...
<a name="services-partner-public-listing"></a>

Not currently.

## AWS Marketplace Engagement Score FAQs
<a name="aws-marketplace-engagement-score-faqs"></a>

### What is the AWS Marketplace solution engagement score?
<a name="what-is-marketplace-solution-engagement-score"></a>
...
<a name="act-on-marketplace-engagement-score"></a>
...
<a name="opportunities-show-dash"></a>
...
<a name="listed-marketplace-no-scores"></a>
...
<a name="high-medium-low-meaning"></a>
...
<a name="scores-all-partners-opportunities"></a>
...
<a name="difference-marketplace-solution-engagement"></a>
...
<a name="scores-update-frequency"></a>
...
<a name="different-scores-each-opportunity"></a>
...
<a name="higher-score-customer-using-solution"></a>
...
<a name="score-both-ao-po-opportunities"></a>
...
<a name="higher-score-edp-spend"></a>
...
<a name="marketing-campaigns-faqs"></a>
...
<a name="more-campaigns-donut-charts"></a>
...
<a name="identical-metrics-different-values"></a>
...
<a name="training-certifications-faqs"></a>
...
<a name="pii-certifications-table-mismatch"></a>
