...
The existence of an AWS Marketplace account does not mean all partners must sell on the AWS Marketplace. To list and sell your products or services on the AWS Marketplace, review the [AWS Marketplace Seller Guide](../../../marketplace/latest/userguide/user-guide-for-sellers.md "../../../marketplace/latest/userguide/user-guide-for-sellers.md").
