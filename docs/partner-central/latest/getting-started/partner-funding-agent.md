...
After submission, the request follows the standard approval workflow. Track progress on the **Funding Dashboard**. For more information, see [Creating a fund request](create-fund-request.md "create-fund-request.md").
...
- [Managing fund requests in AWS Partner Central](partner-funding.md "partner-funding.md")
- [Creating a fund request](create-fund-request.md "create-fund-request.md")
- [AWS Partner Funding Benefits](funding-benefits.md "funding-benefits.md")
