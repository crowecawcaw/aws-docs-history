...
1. **Initiate the service period** – Channel Partners create service period invitations on specific relationships, specifying either minimum notice requirements (14, 30, or 60 days) or fixed-term commitments (1-5 years).
