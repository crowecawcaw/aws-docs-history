...
1. **Customer notification** – A termination channel handshake is created and the end-customer receives an email notification with a unique link to review the termination request.

1. **Customer review and consent** – An authorized user from the customer's AWS management account must:
...
1. **Immediate effect** – When the customer accepts the termination handshake:
