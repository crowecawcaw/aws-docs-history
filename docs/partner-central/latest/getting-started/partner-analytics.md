...
+ [At a Glance:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-at-a-glance.html) Comprehensive visualization of cross-functional KPIs and critical success metrics aggregated from core operational domains.
+ [Opportunities:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-opportunity-pipeline.html) Quantitative analysis of AWS and Partner-referred opportunity flows, featuring pipeline velocity metrics, revenue forecasting models, and statistical conversion analytics.
+ [Leads:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-lead-pipeline.html) Systematic tracking of lead acquisition and progression, with granular conversion rate analysis and source attribution metrics.
+ [Investments:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-funding.html) Data-driven insights into funding utilization, including claim metrics and hierarchical analysis of funding source distribution.
+ [Channel:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-resell.html) Multi-dimensional analysis of incentive programs across Solution Provider and Distribution frameworks, incorporating CEI benefit utilization and discount mechanism performance across public sector and growth segments.
+ [Marketing Campaigns:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-marketing.html) Granular examination of AWS marketing initiative efficacy, with integrated lead-to-opportunity conversion modeling and funnel progression metrics.
+ [Training and Certifications:](https://docs.aws.amazon.com/partner-central/latest/getting-started/partner-analytics-training-certifications.html) Quantitative assessment of organizational capability development, tracking certifications, accreditation completion rates, and training program progression metrics.

## Navigating the Partner Insights dashboards
<a name="navigating-partner-insights-dashboards"></a>
...
<a name="filter-by-date-preset"></a>
...
<a name="filter-by-date-custom"></a>
