...
1. **Identify the management account of the existing customer to migrate**
...
1. **Establish a Partner Central channel relationship**
...
1. **Wait for Billing Transfer to become effective**
...
1. **Prepare the organization for transfer**
...
1. **Transfer root account ownership**
