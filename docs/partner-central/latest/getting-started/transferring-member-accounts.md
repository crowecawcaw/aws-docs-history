...
1. **Establish billing transfer**

   Before moving any member accounts, set up billing transfer to ensure continuous billing responsibility. In AWS Partner Central, create a billing transfer from the customer's new management account to your Program Management Account (PMA). The customer must accept this transfer in their AWS Billing and Cost Management console. Wait for the billing transfer to become active on the first of the next month before proceeding with account migration.

1. **Prepare member account migration**
