...
<a name="partner-analytics-opportunity-pipeline"></a>
...
1. Drill down to specific Opportunity IDs.

1. Check for operational/data recording discrepancies between the opportunity Stage and the AWS Stage noted by AWS Sellers (mismatches highlighted in red).

1. Sort table columns in ascending/descending order to focus on top priorities.
