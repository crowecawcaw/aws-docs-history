...
<a name="navigate-partner-central"></a>
...
**Important**  
If you encounter an access error, it means your assigned IAM role lacks the necessary permissions. Check the error message for specific details and resolution steps. Review the [AWS managed policies for AWS Partner Central users](https://docs.aws.amazon.com/partner-central/latest/getting-started/managed-policies.html) section for more information.
