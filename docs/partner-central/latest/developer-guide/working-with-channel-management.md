...
<a name="working-with-channel-management"></a>
...
<a name="working-with-program-management-accounts"></a>
...
<a name="working-with-channel-handshakes"></a>
...
<a name="working-with-channel-relationships"></a>
