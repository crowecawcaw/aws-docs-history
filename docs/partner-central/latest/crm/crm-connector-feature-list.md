...
To migrate from an earlier CRM with Amazon S3 integration to the AWS Partner Central API, refer to [Upgrading from Amazon S3 to API-based integration](upgrade-crm-api.md) before proceeding.
