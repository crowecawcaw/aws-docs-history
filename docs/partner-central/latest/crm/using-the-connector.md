...
The following topics explain how to use Salesforce and the CRM connector to manage customer engagements,
and how to manage AWS Marketplace activities such as private offers and resale authorizations. The
topics assume that you have configured the connector for AWS Partner Central and AWS Marketplace.
