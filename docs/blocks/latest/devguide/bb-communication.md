...
For more information, see [bb-email-client on GitHub](https://github.com/aws-devtools-labs/aws-blocks/tree/main/packages/bb-email-client "https://github.com/aws-devtools-labs/aws-blocks/tree/main/packages/bb-email-client").
