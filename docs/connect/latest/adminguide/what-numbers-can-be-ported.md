...
Regions, and want to move it to the other Region, [submit an Amazon Connect support ticket](about-porting.md#step1-porting "about-porting.md#step1-porting") for
assistance.
...
to Amazon Connect, [submit an Amazon Connect support
...
ported to Amazon Connect, we recommend waiting until the requested porting has
...
from Amazon Connect to another service, if their contact center moves. Because of
...
ported to Amazon Connect, [submit a ticket to Amazon Connect
