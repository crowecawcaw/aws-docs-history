...
To find out if a phone number that you currently own—whether local, mobile, or toll-free—can be ported to Connect Customer: 
...
If your intent to is release the remaining phone numbers not being ported to Connect Customer, we recommend waiting until the requested porting has been completed to avoid any disruptions to service. 
