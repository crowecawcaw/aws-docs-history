...
Connect Customer outbound campaign provides several types of voice communication. The following sections describe each type so that you can implement the campaign that best meets your needs.
