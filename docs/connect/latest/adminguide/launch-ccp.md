...
- https://`instance name`.my.connect.aws/ccp-v2/
  ...
  whoever set up Connect Customer for your business. The following image shows an example URL for the
  CCP.
...
As the administrator, you can also launch the CCP directly from the Connect Customer console.
...
- Add agents as users to the instance. For more information, see [Manage users that you add to Connect Customer](manage-users.md "manage-users.md").
