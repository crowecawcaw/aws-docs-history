...
+ **Check that your computer recognizes your headset**—Check the settings in Device Manager to make sure that your computer recognizes the headset and allows proper headset connectivity. For example, if you're using a Windows PC:
