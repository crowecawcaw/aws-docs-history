...
![The properties page of the Get customer input block, the Session attributes section.](https://docs.aws.amazon.com/connect/latest/adminguide/images/session_attributes_customer_number.png)
...
![The Set dynamically section.](https://docs.aws.amazon.com/connect/latest/adminguide/images/session_attributes_call_type_channel.png)
