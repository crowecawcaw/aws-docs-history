...
+ Before using this block, make sure Customer Profiles is enabled for your Connect Customer instance. For instructions, see [Use Connect Customer Customer Profiles](customer-profiles.md).
...
**Important**  
To use this action, your Connect Customer instance must have permission for the following API: `GetProfileRecommendations` in either of the following Policies: **AmazonConnectServiceLinkedRolePolicy** or **AmazonConnectServiceCustomerProfileAccess**.
