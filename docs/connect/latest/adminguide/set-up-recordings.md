...
block to your flow. You need to do this regardless of whether your Connect Customer instance is
...
![Connect Customer navigation menu, Routing, flows.](images/menu-contact-flows.png) 3. Open the flow that handles customer contacts you want to record. 4. In the flow, before the contact is connected to an agent, add a [Set recording and analytics
...
3. Scroll down the page, choose **Enable Bot Analytics and Transcripts in
   Connect Customer**, and then choose **Save**.
4. In the Connect Customer admin website, [assign
