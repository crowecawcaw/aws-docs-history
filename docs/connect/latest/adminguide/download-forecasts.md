...
computed forecast or the last published forecast. 5. We recommend choosing **choose here**. With this option, you can
...
![Forecast page, the choose here button to start downloading a forecast, open with Excel.](images/wfm-forecasting-download.png)
