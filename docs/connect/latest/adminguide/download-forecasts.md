...
![Forecast page, the choose here button to start downloading a forecast, open with Excel.](https://docs.aws.amazon.com/connect/latest/adminguide/images/wfm-forecasting-download.png)