...
# Upgrade to the latest Connect Customer Contact Control Panel (CCP).
...
+ [You use the Connect Customer Streams API](upgrade-ccp-streams-api.md). The URL associated with `initCCP()` ends with **/ccp\#**
...
+ [Upgrade your Contact Control Panel (CCP) when your CCP URL ends with /ccp\#](upgrade-browser-ccp.md)
+ [Upgrade your Contact Control Panel (CCP) when using the Connect Customer Streams API](upgrade-ccp-streams-api.md)
