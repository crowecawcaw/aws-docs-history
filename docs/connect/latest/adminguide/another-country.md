...
To claim a number that you don't already own in another country or Region, see [Request numbers or international numbers for Connect Customer](number-request.md).

1. Go to [Create case](https://console.aws.amazon.com/support/cases#/create).

1. Choose **Service quota increase**.

1. In **Limit type** select **Connect Customer**.
