...
![The Email option on the Connect Customer console.](https://docs.aws.amazon.com/connect/latest/adminguide/images/email-aws-console.png)
...
1. In the Connect Customer console, on the left navigation menu, choose **Email**, and then choose **Add Domain** as shown in the following image.  
![The Add domain option on the Connect Customer console.](https://docs.aws.amazon.com/connect/latest/adminguide/images/email-aws-console.png)
