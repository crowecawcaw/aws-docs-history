...
This topic is for administrators who have access to the Connect Customer console. It explains how to
...
Connect Customer uses Amazon SES for sending emails. If you have a new Amazon SES instance, you need to take it
...
your Connect Customer instance, skip to these topics:
...
![The Connect Customer virtual contact center instances page, the instance alias.](images/instance.png) 3. On the left navigation menu, choose **Data storage**, and then choose
...
![The Email option on the Connect Customer console.](images/email-aws-console.png) 2. In the **Add email domain** box, choose **Connect Customer email
...
![The Add domain option on the Connect Customer console.](images/email-aws-console.png) 2. Choose **Use custom email domain**. Use the dropdown box to choose
...
1. Find the name of the Amazon S3 bucket for storing attachments:
   ...
   1. Open the Connect Customer console at
      [https://console.aws.amazon.com/connect/](https://console.aws.amazon.com/connect/ "https://console.aws.amazon.com/connect/").
   2. In the Connect Customer console, choose **Data storage**, and locate the Amazon S3
      bucket name.
