# Integrate Connect Customer Contact Lens with external voice systems
...
3. A flow is started for the call. The Contact Lens connector routes the call
   to Connect Customer Contact Lens.

## Requirements

Before you start setting up Contact Lens integration, check that your Connect Customer and
...
- [Create an Connect Customer instance](amazon-connect-instances.md "amazon-connect-instances.md") if
  ...
  - You don't need to claim a phone number to Connect Customer in order to integrate
    with Contact Lens.
