...
To enable agents to consult over the phone with each other while they are on chats, your Connect Customer administrator needs to set up a direct dial number (DID) that routes to the agent. This configuration incurs additional costs. 