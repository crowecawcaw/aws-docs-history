...
![The Agent applications section of the Security profiles page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/SecurityProfile_cloudscape_agent_apps.png)


You also need to enable the **Access Contact Control Panel** permission for third-party apps to appear.

![Access Contact Control Panel (CCP) permission.](https://docs.aws.amazon.com/connect/latest/adminguide/images/assign-security-profile-3p-apps-ccp-permissions.png)
