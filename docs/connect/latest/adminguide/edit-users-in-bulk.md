...
| User phone configuration         | [UpdateUserPhoneConfig](../APIReference/API_UpdateUserPhoneConfig.md "../APIReference/API_UpdateUserPhoneConfig.md")                                                                | [update-user-phone-config](../../../cli/latest/reference/connect/update-user-phone-config.md "../../../cli/latest/reference/connect/update-user-phone-config.md")                                                                                                 | You can edit the following identity and contact information programmatically for an individual user: first name, last name, email address, mobile number, secondary email address. Use the following API or CLI: |
| Property                         | API                                                                                                                                                                                 | CLI                                                                                                                                                                                                                                                               |
| ---                              | ---                                                                                                                                                                                 | ---                                                                                                                                                                                                                                                               |
