...
| User phone configuration | [UpdateUserPhoneConfig](../APIReference/API_UpdateUserPhoneConfig.md "../APIReference/API_UpdateUserPhoneConfig.md")                                                                   | [update-user-phone-config](../../../cli/latest/reference/connect/update-user-phone-config.md "../../../cli/latest/reference/connect/update-user-phone-config.md")                                                                                                    |
