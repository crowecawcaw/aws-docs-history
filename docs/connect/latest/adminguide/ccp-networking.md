...
| `instance-id.source-region`.sign-in.connect.aws<br>This is used only if you have onboarded to [Connect Customer Global<br>Resiliency](setup-connect-global-resiliency.md "setup-connect-global-resiliency.md").                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Replace `instance-id` with your<br>instance ID, and `source-region` with the<br>AWS Region of your source instance. For more information, see<br>[Integrate your identity provider (IdP) with an Connect Customer Global Resiliency SAML sign in endpoint](integrate-idp.md "integrate-idp.md").                                                                 | 443 (HTTPS) | OUTBOUND  | SEND/RECEIVE |
