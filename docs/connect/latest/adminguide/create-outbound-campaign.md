...
communications, and multichannel fallback—for example, sending an email if an SMS bounces.

Connect Customer provides two ways to create an outbound campaign:

- **Visual Journey Builder**: Design multi-channel, multi-step
  campaigns using an intuitive drag-and-drop canvas. Ideal for complex journeys that span
