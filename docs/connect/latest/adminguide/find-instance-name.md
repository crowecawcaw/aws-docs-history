...
# Find your Connect Customer instance name
...
1. On the instances page, the instance name appears in the **Instance Alias** column. This instance name appears in the URL you use to access Connect Customer.   
