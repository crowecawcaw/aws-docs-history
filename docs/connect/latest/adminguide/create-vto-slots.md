...
1. Provide the reason for requesting voluntary time off in the **Reason** text box. Agents will be able to view the reason before accepting or declining the overtime request.
