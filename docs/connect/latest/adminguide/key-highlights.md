...
It can be time-consuming to review contact transcripts that are hundreds of lines long. To make this process faster and more efficient, conversational analytics automatically identifies and labels key parts of customer conversations, then displays highlights of the conversations. Managers can view those highlights on the **Contact details** page. Agents can view the highlights in the Contact Control Panel (CCP). 

**Tip**  
For a list of supported languages, see the *Key highlights* column in the [Connect Customer conversational analytics supported languages](supported-languages.md#supported-languages-contact-lens) topic.

After you enable conversational analytics, it identifies key parts of a customer conversation, assigns labels (such as issue, outcome, or action item) to those parts, and displays highlights of the customer conversation. You can expand the highlights to view the full transcript of the contact. 
