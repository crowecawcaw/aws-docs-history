...
| AppleBusinessChatLocale       | Defines the language and AWS Region preferences that the user<br>wants to see in their user interface. It consists of a language<br>identifier (ISO 639-1) and a Region identifier (ISO 3166). For<br>example, **en\_US**.                                                                      | User-defined | $.Attributes.AppleBusinessChatLocale       |
