...
![The Connect Customer virtual contact center instances page, the instance alias.](images/instance.png) 3. Complete the following procedures.
...
2. To enable customers to call into your contact center, choose
   **Receive inbound calls with Connect Customer**.
...
- In the navigation pane, choose **Data storage**. Choose
  ...
  - **Live media streaming**: Choose
    ...
    **Edit**. For more information, see [Set up live media streaming of customer audio in Connect Customer](customer-voice-streams.md "customer-voice-streams.md").
  ...
  more information, see [Enable screen recording for your Connect Customer instance](enable-sr.md "enable-sr.md").
...
2. (Optional) To add a signing key for use in flows, choose **Add
   key**. For more information, see [Encrypt sensitive customer input in Connect Customer](encrypt-data.md "encrypt-data.md").
3. (Optional) To integrate with Amazon Lex, select a Lex bot. For more
   information, see [Create conversational AI bots in Connect Customer](connect-conversational-ai-bots.md "connect-conversational-ai-bots.md").
4. (Optional) To integrate with AWS Lambda, select a Lambda function. For more
   information, see [Grant Connect Customer access to your AWS Lambda functions](connect-lambda-functions.md "connect-lambda-functions.md").
5. (Optional) To enable flow logs, choose **Enable flow
   logs**. For more information, see [Use flow logs to track events in Connect Customer flows](about-contact-flow-logs.md "about-contact-flow-logs.md").
...
8. (Optional) To enables logs of automated interactions using IVR and Lex bot
   ...
   Transcripts in Connect Customer**.
