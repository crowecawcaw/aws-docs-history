...
1. You must have a Customer Profiles domain enabled for your instance. For instructions,
   see [Enable Customer Profiles for your Connect Customer instance](enable-customer-profiles.md "enable-customer-profiles.md").
2. In the navigation pane, choose **Customer
   profiles**.
3. In the **Identity Resolution** section, choose **Enable
   Identity Resolution**.

![The Connect Customer Customer Profiles page, the Enable Identity Resolution button.](images/customer-profiles-enable-ir.png) 4. In the **Identity Resolution** pop-up box, choose **Enable
Identity Resolution**.

![The Connect Customer Customer Profiles page, the Enable Identity Resolution button.](images/customer-profiles-enable-ir-2.png) 5. On the **Enable Identity Resolution** page, specify the date and time
