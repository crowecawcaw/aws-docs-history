...
1. Select trigger component: The component that will trigger the applied condition

1. Apply condition when: The operation evaluated based on the value of the trigger component
