...
![The CCP, the create task page, the schedule date and time section, the create button.](images/test-create-task-ccp-2.png) 3. If you chose yourself, the task is routed to you. Choose **Accept
task**.

![The CCP, an incoming take, the accept task button.](images/test-tasks-incoming.png)
...
![The create task page, the scheduled date and time section.](images/scheduled-task.png)
