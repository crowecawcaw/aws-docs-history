...
![The CCP, the task button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/test-create-task-ccp.png)
...
![The CCP, the create task page, the schedule date and time section, the create button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/test-create-task-ccp-2.png)


------

1. If you chose yourself, the task is routed to you. Choose **Accept task**.  
![The CCP, an incoming take, the accept task button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/test-tasks-incoming.png)
...
![The create task page, the scheduled date and time section.](https://docs.aws.amazon.com/connect/latest/adminguide/images/scheduled-task.png)
