...
Connect Customer provides a set of pre-built integrations powered by Amazon AppFlow and Amazon EventBridge. After
you enable Connect Customer Customer Profiles, you can use these integrations to combine information from external
applications such as Salesforce or Zendesk, with contact history from Connect Customer. This
...
You can setup an integration using either featured applications in Connect Customer or
...
using Amazon AppFlow and build a unified Connect Customer Customer profile for contact center
...
- [Set up integration
  for featured applications in Connect Customer](integrate-customer-profiles-appflow.md "integrate-customer-profiles-appflow.md")
- [Set up
