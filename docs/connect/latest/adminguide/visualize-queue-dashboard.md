...
![The view queue graphs option in the test queue dropdown menu.](images/hmr-queue-dashboard-ui.png) 3. After you select **View queue graphs**, you are directed
...
![An example Queue dashboard, a graph of data.](images/hmr-queue-dashboard-exp.png)
