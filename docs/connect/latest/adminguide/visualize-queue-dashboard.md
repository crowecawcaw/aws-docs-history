...
![The view queue graphs option in the test queue dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/hmr-queue-dashboard-ui.png)
...
![An example Queue dashboard, a graph of data.](https://docs.aws.amazon.com/connect/latest/adminguide/images/hmr-queue-dashboard-exp.png)