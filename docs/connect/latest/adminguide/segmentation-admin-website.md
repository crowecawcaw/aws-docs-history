...
creating a customer segment, see [Build customer segments in Amazon Connect](customer-segments-building-segments.md "customer-segments-building-segments.md").
...
or API. For more information about customer profiles, see [What is a customer profile in Amazon Connect?](customer-profiles-what-data.md "customer-profiles-what-data.md").
