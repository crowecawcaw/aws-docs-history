...
Connect Customer only supports direct calls from the agent CCP to 911. It does not support call
...
- [Get and store an agent's validated physical address in your Connect Customer instance](get-and-store-agent-address-e911.md "get-and-store-agent-address-e911.md")
- [Retrieve an agent's address from Connect Customer when they call 911](retrieve-agent-address-e911.md "retrieve-agent-address-e911.md")
