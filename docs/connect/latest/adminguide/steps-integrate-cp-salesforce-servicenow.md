...
To provide periodic updates to Connect Customer Customer Profiles, you can integrate with Salesforce, ServiceNow, Marketo, or Zendesk using Amazon AppFlow. You first set up the connection in Connect Customer and the application of your choice, and then verify the integration.
...
![The Customer profiles configuration page, the Add integration button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-enable-addintegration.png)
...
![The Select data source page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-cp-salesforce-source.png)
...
![The Establish connection page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-enable-establish-connection.png)
...
![The integration options page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-integration-options.png)
...
![The Review and integrate page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-enable-review-and-integrate.png)
...
![The Customer profiles configuration page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-enable-objects.png)