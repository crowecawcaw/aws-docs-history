...
![A Google Chrome banner that says you have received a new message.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chatwidget-notification-banner.png)
...
![A notification icon.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chatwidget-browser-notification.png)
