...
| PartyType | String | The type of profile used to describe the customer.<br />Valid values: INDIVIDUAL \| BUSINESS \| OTHER | 
...
| EngagementPreferences | EngagementPreferences | The customer or account’s engagement preferences. | 
...
For example, you can use `_phone` as a key name with the [SearchProfiles API](https://docs.aws.amazon.com/customerprofiles/latest/APIReference/API_SearchProfiles.html) to find a profile whose PhoneNumber, MobilePhoneNumber, HomePhoneNumber, or BusinessPhoneNumber attribute matches with the search value.
...
| Phone | Array of ContactPreference objects | A list of phone-related contact preferences. | 
