...
![A case in the Open status, ready for edit.](images/cases-agent-application-edit.png)

![The page where an agent can edit a case.](images/cases-agent-application-edit-template.png)
