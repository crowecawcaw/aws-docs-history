...
The Amazon Connect Chat service quota limits apply to Apple Messages for Business. To learn more, see [Amazon Connect service quotas](amazon-connect-service-limits.md "amazon-connect-service-limits.md").

## Set up automatic replies

You can use Amazon Lex to set up automatic replies to chat. For a tutorial that
introduces you to setting up Amazon Lex and Amazon Connect, see [Add an Amazon Lex bot to Amazon Connect](amazon-lex.md "amazon-lex.md").
