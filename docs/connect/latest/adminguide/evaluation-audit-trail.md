...
1. Log into Connect Customer with a user account that has **Analytics and optimization ** - ** [Evaluation forms - perform evaluations](evaluation-and-coaching-permissions.md)** permission on their security profile. 
