...
![The manage phone numbers page, your phone number.](/images/connect/latest/adminguide/images/tutorial1-choose-on-phone-number.png) 3. Use the drop-down box to choose the flow you just created, and then choose
**Save**.
...
omnichannel IT Help Desk that uses Amazon Lex and offers customers both chat and
voice.
