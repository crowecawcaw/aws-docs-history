...
![The properties page of the set contact attributes block.](https://docs.aws.amazon.com/connect/latest/adminguide/images/play-prompt-properties-2-a-new.png)
...
![The properties page of the Play prompt block.](https://docs.aws.amazon.com/connect/latest/adminguide/images/play-prompt-properties2.png)
...
![A flow with the set contact attributes block connected to the play prompt.](https://docs.aws.amazon.com/connect/latest/adminguide/images/play-prompt-properties-2-b.png)