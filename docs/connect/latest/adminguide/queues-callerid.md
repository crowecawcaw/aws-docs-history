# Set up outbound caller ID in Connect Customer
...
- Connect Customer runs on a SIP-only infrastructure through our carrier
  ...
  outside of what Connect Customer controls, the caller ID name is not guaranteed
...
- To guarantee your caller ID name is delivered to customers, see
  [Optimize your reputation for outbound calling in Connect Customer](optimize-outbound-calling.md "optimize-outbound-calling.md") for information
...
If you use toll-free numbers outside of the US, refer to the [Connect Customer Telecoms Country Coverage Guide](https://d1v2gagwb6hfe1.cloudfront.net/Amazon_Connect_Telecoms_Coverage.pdf "https://d1v2gagwb6hfe1.cloudfront.net/Amazon_Connect_Telecoms_Coverage.pdf") to see which countries
...
Support Knowledge Center article: [How can I set my Connect Customer outbound caller ID dynamically based on country?](https://aws.amazon.com/premiumsupport/knowledge-center/connect-dynamic-outbound-caller-id/ "https://aws.amazon.com/premiumsupport/knowledge-center/connect-dynamic-outbound-caller-id/")

## Use E.164 format for international phone numbers

Connect Customer requires phone numbers in [E.164](https://www.itu.int/rec/T-REC-E.164/en "https://www.itu.int/rec/T-REC-E.164/en") format.
...
as +44 20 718 xxxxx. When you place calls from the CCP using Connect Customer the CCP provides
...
alternative reputation mechanisms described in [Optimize your reputation for outbound calling in Connect Customer](optimize-outbound-calling.md "optimize-outbound-calling.md"),
as of March 31, 2023, Connect Customer no longer sets CNAM configurations.
...
See the recommended steps in [Optimize your reputation for outbound calling in Connect Customer](optimize-outbound-calling.md "optimize-outbound-calling.md").
