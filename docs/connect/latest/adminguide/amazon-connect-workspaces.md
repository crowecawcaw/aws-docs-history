...
1. Choose **Add new workspace**.

1. Provide a name and description for your workspace.

1. Identify the pages included in this workspace.
...
**Note**  
Connect Customer provides a default home page, which displays to all users who do not have a workspace with an alternative.
...
1. Assign the workspace to the desired audience.
   ...
   1. Visible to assigned users – Restrict to one or more users or routing profiles.

   1. Visible to no users – Hide the workspace for testing, preparation, or retirement.

1. (Optional) Customize theme and branding elements.

   1. Update the logo, font, and color scheme to match your branding.

## How workspaces relate to other assignments
<a name="how-workspaces-relate-to-other-assignments"></a>
...
<a name="employ-best-practices"></a>
