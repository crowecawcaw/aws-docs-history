...
For a list of the languages supported by Contact Lens redaction, see [Languages supported by Connect Customer features](supported-languages.md "supported-languages.md").
...
- A redacted audio file (wav) for voice contacts. Sensitive data in
  ...
  in the Connect Customer admin website or elsewhere as non-talk time.
