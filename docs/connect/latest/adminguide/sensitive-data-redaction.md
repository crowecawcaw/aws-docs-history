...
- A redacted file. This file is generated by default when Redaction is
  ...
  example file, see [Example redacted file for a call analyzed by Contact Lens conversational analytics](contact-lens-example-output-files.md#example-redacted-file "contact-lens-example-output-files.md#example-redacted-file").
- An original (raw), analyzed file. This file is generated only when you
  ...
  file, see [Example original file for a call analyzed by Contact Lens conversational analytics](contact-lens-example-output-files.md#example-original-output-file "contact-lens-example-output-files.md#example-original-output-file").
