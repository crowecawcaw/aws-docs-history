...
For a list of the languages supported by conversational analytics redaction, see [Languages supported by Connect Customer features](supported-languages.md "supported-languages.md").
...
When redaction is enabled, conversational analytics generates the following
files:
...
- A redacted file. This file is generated by default when Redaction is
  ...
  example file, see [Example redacted file for a call analyzed by conversational analytics](contact-lens-example-output-files.md#example-redacted-file "contact-lens-example-output-files.md#example-redacted-file").
- An original (raw), analyzed file. This file is generated only when you
  ...
  file, see [Example original file for a call analyzed by conversational analytics](contact-lens-example-output-files.md#example-original-output-file "contact-lens-example-output-files.md#example-original-output-file").
