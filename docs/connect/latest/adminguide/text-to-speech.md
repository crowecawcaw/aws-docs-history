...
![A message in the text-to-speech box.](https://docs.aws.amazon.com/connect/latest/adminguide/images/play-prompt-sample-tts.png)

   Or enter SSML, as shown in the following image:  
![A message formatted with SSML in the text-to-speech box.](https://docs.aws.amazon.com/connect/latest/adminguide/images/play-prompt-sample-ssml.png)
