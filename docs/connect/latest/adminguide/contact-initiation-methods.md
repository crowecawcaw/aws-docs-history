...
To summarize, an **Outbound flow** type is the only one involved in an outbound call initiated from Connect Customer.
...
For more information, see [Default flows in Connect Customer for your contact center](contact-flow-default.md). 