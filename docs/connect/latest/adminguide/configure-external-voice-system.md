...
![The conversational analytics integrations page, an example connector named MyTestConnector.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contactlens-connector-name.png)
...
![The MyTestConnector details page, the fully qualified name of the host that will receive the SIPREC audio.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contactlens-connector-detailspage.png)
...
![The Configuration Guides on the Amazon Chime SDK resource page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/configuration-guides.png)
**Note**  
