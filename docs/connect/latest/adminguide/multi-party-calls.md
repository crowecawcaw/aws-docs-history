...
![The CCP, multiple participants on call.](images/ccp-multiparty-mute-hold-drop1.png)
...
![The CCP, the agent and contact on a call.](images/ccp-multiparty-two-people.png)
...
![The CCP, a contact on hold, another contact on call.](images/ccp-multiparty-join-second-person.png) 2. Choose **Join** to take all parties off hold.
...
![The CCP, multiple participants on a call.](images/ccp-multiparty-overview.png)
...
![The CCP, multiple participants on a call, the More button at the bottom of the CCP.](images/ccp-multiparty-more-options.png)
