...
Connect Customer also supports adding additional users to join the web, in-app, and video call. To learn how to enable multi-user web, in-app and video calling, see [Enable multi-user in-app, web, and video calling](enable-multiuser-inapp.md). 
