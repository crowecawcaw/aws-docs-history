...
Customer Profiles includes mapping templates for Connect Customer contact records, Salesforce Accounts, ServiceNow Users, and Marketo Leads. For a complete list of available mapping templates, use the [ListProfileObjectTypeTemplates](https://docs.aws.amazon.com/customerprofiles/latest/APIReference/API_ListProfileObjectTypeTemplates.html) API.  
