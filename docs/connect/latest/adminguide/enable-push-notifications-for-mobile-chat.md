...
![Invoke lambda function flow block in the Connect Customer admin website flow designer.](https://docs.aws.amazon.com/connect/latest/adminguide/images/step-4-set-up-push-notifications-for-mobile-chat-1.png)
