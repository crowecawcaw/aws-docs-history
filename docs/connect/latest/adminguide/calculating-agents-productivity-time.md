...
This topic shows two examples that illustrate how Agent Adherent and Non-Adherent Time are calculated in Connect Customer. It also includes a third example that shows adherence with thresholds.
...
+  (Total Adherent Time was 150 minutes/Total Scheduled Time 180 minutes) 
...
+ (Total Adherent Time: 105 Minutes / Total Scheduled Time: 180 Minutes)
