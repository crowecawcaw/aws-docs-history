...
![Default customer queue flow on the flows page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customize-default-contact-flow1.png)

1. To customize the message, choose the **Loop prompts** block to open the properties page.   
![Loop prompts block on the flow designer.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customize-default-contact-flow2.png)
...
![Loop prompts block configured with a text-to-speech message.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customize-default-contact-flow3.png)
...
![The publish button on the flow designer.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customize-default-contact-flow4.png)