...
![The Create new template page, the Fields section, the Add field dropdown list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-field-type.png)
...
![The Validation and permissions section for an email field.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-field-permissions.png)
**Note**  
...
![The task assignment section, the default value dropdown list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-task-assigment.png)
...
![The Self assign checkbox section, the Default state option set to True.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-task-selfassigment.png)
...
![The Task durations section of the template. list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-expiry-duration.png)
...
![The task templates page, the disable or enable toggle for each template.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-published.png)
...
![The create task button on the CCP, the two templates the agents can select.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-agent-experience.png)
...
![The CCP, no option to assign a task to others, but agent can assign the task to themselves.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-create-task-ccp.png)
...
![The CCP, create task page, the Assign to field set to John Does quick connect.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-choose-agent-quick-connect.png)
...
![The CCP, create task page, Assign to blank, No data message at the bottom of page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-templates-no-data.png)
