...
This topic explains how to create a conversational analytics connector to integrate with your external voice system. Complete the following steps.
...
1. In the Connect Customer console, in the navigation pane, choose **External voice systems**, **conversational analytics integrations**, and then choose **Create conversational analytics connector**, as shown in the following image.  
![The conversational analytics integrations page, the Create conversational analytics connector button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-create-connector.png)
...
![The conversational analytics connector page, the Connect source type dropdown list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-connector-source-types.png)
...
![The conversational analytics connector page, the voice system type dropdown list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-voice-system-types.png)
...
1. Optionally, add tags to identify, organize, search for, filter, and control who can access this connector. For more information, see [Add tags to resources in Connect Customer](tagging.md).

1. Choose **Create conversational analytics connector** to create the connector. After the connector is created, a success message is displayed.

1. On the **conversational analytics integrations** page you'll see the short host name. This is the host that your external voice system will send SIPREC voice traffic to. 
...
![The conversational analytics integrations page, the short host name of the connector.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-connector-shorthostname.png)
