# Embed a custom Connect Customer Contact Control Panel (CCP)
...
- [Using Connect Customer with third-party
  cookies](admin-3pcookies.md "admin-3pcookies.md")
- [Embed CCP into Salesforce](salesforce-integration.md "salesforce-integration.md")
- [Embed CCP into Zendesk](zendesk-integration.md "zendesk-integration.md")
