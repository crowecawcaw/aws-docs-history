...
This scenario is especially possible when using the default audio prompts that Connect Customer provides since these audio prompts can be as long as 4 minutes. 
