...
| Language                           | Language code | Amazon Connect AI Agents | Amazon Connect agentic voice | Automated performance evaluations† | Post-call analytics | Real-time call analytics | Email and Chat analytics | Post-contact summaries | Sentiment analysis | Redaction | Pattern match rules |
| ---------------------------------- | ------------- | ------------------------ | ---------------------------- | ---------------------------------- | ------------------- | ------------------------ | ------------------------ | ---------------------- | ------------------ | --------- | ------------------- |
