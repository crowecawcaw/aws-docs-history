...
| Language                           | Language code | Amazon Q in Connect | Performance Evaluations | Post-call analytics | Real-time call analytics | Chat analytics | Post-contact summaries | Sentiment analysis | Redaction | Pattern match rules |
| ---------------------------------- | ------------- | ------------------- | ----------------------- | ------------------- | ------------------------ | -------------- | ---------------------- | ------------------ | --------- | ------------------- |
