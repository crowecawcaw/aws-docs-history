...
![The Profile button on the Customer profile tab.](images/cm-cases-associated-profile1.png) 2. Choose **+ Connect Case** to create a case, as shown in
the following image.

![The connect case button on the customer profile page.](images/cm-cases-associated-profile2.png) 3. Complete the required information for the case, and then choose
**Save**. A case is created for the customer, as shown
in the following image.

![A case.](images/cm-cases-associated-profile3.png)
...
![The customer name, the more option.](images/cases-agent-application-customername.png)
