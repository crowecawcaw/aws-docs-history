...
Currently, Connect Customer Customer Profiles can be used in compliance with [GDPR](https://aws.amazon.com/compliance/gdpr-center) and is pending additional certifications held by Connect Customer.
