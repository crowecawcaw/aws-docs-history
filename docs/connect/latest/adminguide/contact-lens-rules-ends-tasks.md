...
![The new rule page, the add action dropdown menu, the a case is added option.](images/contact-lens-rules-update-case-1.png) 2. When you create your rule, choose **End tasks** for
the action.
