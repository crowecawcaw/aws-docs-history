...
![The user management page, with an arrow pointing to the View historical changes link.](images/user-management-view-historical-changes.png) 4. On the **View recent changes for agent** page, there is one
...
![The View recent changes for agent page, with an arrow pointing to the Resource name.](images/user-management-view-recent-changes.png) 5. On the **View recent changes for [resource name]** page, you
...
![The View recent change page, a list of recent changes to the user record for John Doe.](images/user-management-view-recent-changes-johndoe.png)
