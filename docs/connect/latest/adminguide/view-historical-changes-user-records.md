...
![The user management page.](images/user-management-view-historical-changes.png) 4. On the **View recent changes for agent** page, there is one
...
![The View recent changes for agent page.](images/user-management-view-recent-changes.png) 5. On the **View recent changes for [resource name]** page, you
