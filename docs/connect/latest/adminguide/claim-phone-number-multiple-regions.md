...
1. Create a traffic distribution group by using the [CreateTrafficDistributionGroup](../APIReference/API_CreateTrafficDistributionGroup.md "../APIReference/API_CreateTrafficDistributionGroup.md") API.
2. Describe your traffic distribution group by using the [DescribeTrafficDistributionGroup](../APIReference/API_DescribeTrafficDistributionGroup.md "../APIReference/API_DescribeTrafficDistributionGroup.md") API to determine whether it
   has been created successfully (`Status` must be
   `ACTIVE`).
3. After your traffic distribution group has been created successfully (`Status` is
   `ACTIVE`), you can claim phone numbers to it by using the
   [ClaimPhoneNumber](../APIReference/API_ClaimPhoneNumber.md "../APIReference/API_ClaimPhoneNumber.md") API.
