...
When auto-accept is enabled for an available agent, the agent will be automatically connected to contacts from that channel, and won't need to manually choose accept or reject.
