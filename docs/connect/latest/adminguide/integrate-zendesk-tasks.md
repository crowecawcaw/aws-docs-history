...
If you don't already have the EventBridge connector for Zendesk enabled, you need to set it up first. Otherwise, go to [Step 2: Integrate Zendesk with Connect Customer for task creation](#steps-integrate-zendesk). 
...
**Note**  
If you use custom AWS Identity and Access Management (IAM) policies, for a list of the required IAM permissions to set up Connect Customer Tasks, see [Tasks page](security-iam-amazon-connect-permissions.md#tasks-page).
...
![The tasks page, the add an application button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-add-an-application-button.png)
...
![The select application page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-choose-an-app-zendesk.png)
...
![The Establish connection page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-establish-connection-zendesk.png)
...
![The integrations page in Zendesk.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-connect-zendesk-eventbridge.png)
...
![The Amazon Web Services page in Zendesk.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-connect-zendesk-support-ticket.png)

1. Return to the **Establish connection** page in Connect Customer choose **Next**.

1. On the **Establish connection** page, you'll see the message that Connect Customer has successfully connected with Zendesk. Choose **Next**.   
![The Establish connection page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-establish-connection-final-zendesk.png)

1. On the **Review and integrate** page, check that the **Connection status** says **Connected**, and then choose **Complete integration**. 

   This creates a connection that associates the EventBridge resource for Zendesk to Connect Customer.  
![The Review and integrate page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-establish-connection-review-and-integrate-zendesk.png)

1. On the **Tasks** page, the new Zendesk connection is listed, as shown in the following image.  
![The tasks page showing the new Zendesk connection.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-establish-connection-final2-zendesk.png)

You're done\! Next, add rules that tell Connect Customer when to create a task and how to route it. For instructions, see [Create rules that generate tasks for third-party integrations in Connect Customer](add-rules-task-creation.md).
...
![The Amazon Web Services page, the support ticket option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/zendesk-support-ticket.png)
...
1. In the Connect Customer console, restart the flow.