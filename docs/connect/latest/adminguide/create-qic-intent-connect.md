...
![A sample configuration page for an unconfigured bot.](https://docs.aws.amazon.com/connect/latest/adminguide/images/enable-qic-bot.png)
...
![A Enable agent assist intent dialog box.](https://docs.aws.amazon.com/connect/latest/adminguide/images/qic-intent-dropdownbox.png)
