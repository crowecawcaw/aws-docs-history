...
workloads that are flexible and meet business and compliance requirements. Amazon Connect helps
...
Amazon Connect scheduling is not designed to ensure compliance with any particular laws. It
...
2. Double-check with your Amazon Connect admin that users have the required security
