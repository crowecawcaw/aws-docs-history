...
# Batch enrollment in Connect Customer Voice ID using audio data from prior calls
...
1. An input file containing a list of speakers. See [Input and output file schema for the Speaker Enrollment Job in Connect Customer Voice ID](speaker-enrollment-job-schema.md). 
...
**Note**  
You are charged for enrolling speakers. For more information, see [Connect Customer Voice ID Pricing](https://aws.amazon.com/connect/pricing/).