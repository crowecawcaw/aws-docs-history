...
![The Customer Profiles page and the button highlighted that opens the agent workspace.](images/customer-profiles-agent-workspace-open.png)
...
- **https://`instance name`.my.connect.aws/agent-app-v2/**
  If you access your instance using the **awsapps.com** domain,
...
To build your own widget while using raw data from Customer Profiles, see the
[Github](https://github.com/amazon-connect/amazon-connect-customer-profiles "https://github.com/amazon-connect/amazon-connect-customer-profiles") documentation about how to use the CustomerProfilesJS open
source library.
