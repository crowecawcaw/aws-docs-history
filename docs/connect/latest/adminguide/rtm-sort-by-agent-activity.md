...
![The Agents report, the sort icon for the Activity column.](https://docs.aws.amazon.com/connect/latest/adminguide/images/agent-activity-sortable.png)
...
![The Agents report, no sort icon appears in the Activity column.](https://docs.aws.amazon.com/connect/latest/adminguide/images/agent-activity-not-sortable.png)
