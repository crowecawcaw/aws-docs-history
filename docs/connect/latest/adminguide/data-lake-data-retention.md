...
The 25-month window is fixed. You cannot change the retention period. To keep data
for longer, such as to meet statutory retention requirements, copy the data to
storage that you control before it ages out of the window.

You access the data lake tables from your own account with AWS Lake Formation and
. For more information, see [Access Connect Customer data lake](access-datalake.md "access-datalake.md"). To retain data, run a scheduled query that
...
of objects](../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md "../../../AmazonS3/latest/userguide/object-lifecycle-mgmt.md") in the _Amazon S3 User Guide_.
