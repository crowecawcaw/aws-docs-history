...
![Icons for all the services you can use with Amazon Connect.](images/connect-overview2.png)

## Development

You can use AWS Lambda functions to either look up or post data to sources outside
of Amazon Connect. For example, you can look up an inbound caller on Salesforce based on the
...
When you set up Amazon Connect, it creates default buckets for these requirements, or you can
...
[Create an Amazon Connect instance](amazon-connect-instances.md "amazon-connect-instances.md").
...
long-term storage. However, it breaks the link in the contact record in Amazon Connect. To
fix this, use a Lambda function to rename the Amazon Glacier object to match the data in
the contact record.

## Database

You can use AWS databases with Amazon Connect for a variety of reasons. For example, with
...
- Blog post: [Creating dynamic, personalized experiences in Amazon Connect](https://aws.amazon.com/blogs/contact-center/creating-dynamic-personalized-experiences-in-amazon-connect/ "https://aws.amazon.com/blogs/contact-center/creating-dynamic-personalized-experiences-in-amazon-connect/")
...
combine the flow log data with other Amazon Connect data in your warehouse, or run queries to
...
- Amazon Pinpoint—Use as an outbound messaging trigger for events; for example,
  ...
  see this blog post: [Using Amazon Pinpoint to send text messages in Amazon Connect](https://aws.amazon.com/blogs/contact-center/using-amazon-pinpoint-to-send-text-messages-in-amazon-connect/ "https://aws.amazon.com/blogs/contact-center/using-amazon-pinpoint-to-send-text-messages-in-amazon-connect/").
...
For more information, see:
    ...
    + [Plan your identity management in Amazon Connect](connect-identity-management.md "connect-identity-management.md")
    + Blog post: [Enabling federation with AWS Single Sign-On and
     Amazon Connect](https://aws.amazon.com/blogs/contact-center/enabling-federation-with-aws-single-sign-on-and-amazon-connect/ "https://aws.amazon.com/blogs/contact-center/enabling-federation-with-aws-single-sign-on-and-amazon-connect/")
...
- Amazon CloudWatch—Collects logs, service metrics, performance metrics for
  Amazon Connect. For more information, see [Monitoring your Amazon Connect instance using CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md").
