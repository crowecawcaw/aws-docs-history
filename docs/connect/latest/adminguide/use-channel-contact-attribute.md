...
![The Attribute to check section set to Channel, the Conditions to check section set to chat.](https://docs.aws.amazon.com/connect/latest/adminguide/images/channel-attribute.png)
...
![A configured Check contact attributes block.](https://docs.aws.amazon.com/connect/latest/adminguide/images/channel-attribute-flow.png)