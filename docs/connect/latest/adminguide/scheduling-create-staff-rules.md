...
**Topics**
+ [Create staff rules for individuals](#individual-rules)
+ [Import time off balance for individuals](#scheduling-upload-ic-timeoff)
...
1. In the **Shift profile override** section, choose **Enabled** to define a specific shift profile or shift rotation pattern for each agent.
