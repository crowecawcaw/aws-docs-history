...
![The define condition page with Post-call, Post-chat, and Email analysis event source options.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-rules-create-case-1.png)

1. Choose **Next**

1. On the actions page, choose **Create case** for the action.  
![The new rule page, the add action dropdown menu, the create case option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-rules-create-case-2.png)

1. In the **Create case** card, select a **Case template**.  
![In the Create case card, select a Case template.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-rules-create-case-3.png)
...
![Fill out the required fields and add optional case fields to populate case data.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-rules-create-case-4.png)
