...
![The define condition page with Post-call, Post-chat, and Email analysis event source options.](images/contact-lens-rules-create-case-1.png) 2. Choose **Next** 3. On the actions page, choose **Create case** for the
action.
...
![In the Create case card, select a Case template.](images/contact-lens-rules-create-case-3.png) 5. Fill out the **required fields** and add
