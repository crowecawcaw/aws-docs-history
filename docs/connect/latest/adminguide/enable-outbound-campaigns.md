...
+ Make sure your Connect Customer instance is [enabled for outbound calling](enable-outbound-calls.md). 
...
![The Configure key page, Symmetric option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-create-kms-key-configure-key.png)
...
![The Review and edit key policy page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-create-kms-key-note-key.png)
   + Return to the tab in your browser for the Connect Customer console, **Enable outbound campaigns** page. Choose or tap in the **AWS KMS key** for the key you created to appear in a dropdown list. Choose the key you created.

1. Choose **Enable outbound campaigns**. 

1. It takes a few minutes for outbound campaigns to be enabled. When it's successfully enabled, you can create outbound campaigns in Connect Customer for voice calls. If it does not enable, verify you have the required [IAM permissions](security-iam-amazon-connect-permissions.md). 
