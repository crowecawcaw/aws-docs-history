...
![The disconnect from Salesforce page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-disconnect-connection.png)
...
![The disconnect from Salesforce option in Amazon AppFlow.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-disconnect-2.png)
