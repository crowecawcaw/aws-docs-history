...
![An agents calendar, a Work shift, the Request shift trade option.](images/shiftexchange-agentrequest.png) 2. On the **Request shift trade** dialog box, you can
...
shift details on the left side of the screen.
    ...
    * **To offer a trade**: Enter a
    ...
    ![The Request shift trade dialog box, the Comment box, the Offer trade button.](images/shiftexchange-offertrade.png)
    * **To trade your shift with another
     shift**
    	...
    	![The Request shift trade dialog box, the time range box and name or login box to search for available trades.](images/shiftexchange-search.png)
    	...
    	![The Request shift trade dialog box, trades offered by other agents.](images/shiftexchange-offertrade2.png)
