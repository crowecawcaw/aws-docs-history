...
![A green checkmark and the words Successfully Deleted selected Quick response.](https://docs.aws.amazon.com/connect/latest/adminguide/images/deletion-success-message.png)
