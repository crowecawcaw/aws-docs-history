...
- If you have a **Trailing** time range filter on your dashboard, you can only see an interval of 15min for the last 24
  hours.
- If you have a **Day** time range filter on your dashboard, you can see a trailing 8 day interval trend, or a 15min
