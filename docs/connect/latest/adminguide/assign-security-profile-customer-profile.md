...
records to profiles, editing profiles, and creating and saving new profiles. The topics
in the section help you assign permissions by updating permissions for agents, flows,
and calculated attributes. There is also information to help you troubleshoot an error
should you happen to encounter it while updating permissions.
