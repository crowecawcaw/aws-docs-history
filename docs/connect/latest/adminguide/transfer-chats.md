...
![The ccp, quick connect button.](images/transfer-customer.png) 2. Choose or search for the queue you want to transfer to, and then choose
...
![The ccp, the confirmation message.](images/transfer-confirmation.png)
