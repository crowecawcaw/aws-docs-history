...
+ To edit the forecast time zone, you must have security profile permissions for **Analytics, Forecast and schedule interval - Edit**. For more information, see [Assign permissions](required-optimization-permissions.md).
+ The default value for the forecast time zone is UTC.
+ When you change the forecast time zone, Connect Customer regenerates both the short-term and long-term forecasts.
