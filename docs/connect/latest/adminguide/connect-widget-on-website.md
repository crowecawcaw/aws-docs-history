...
**Topics**
+ [Step 1: Create a contact form for your widget](#create-web-form)
+ [Step 2: Customize your communications widget](#customize-communications-widget)
+ [Step 3: Specify the website domains where you expect to display the communications widget](#communications-widget-domains)
+ [Step 4: Confirm and copy communications widget code and security keys](#confirm-and-copy-communications-widget-script)
...
1. At the top left, choose **Views**.
