# Emergency login to the Amazon Connect admin

website

As a best practice, users assigned to the Amazon Connect **Admin** security
profile should always use their Amazon Connect instance URL to login:
...
- You forgot your Amazon Connect administrator password and no other Amazon Connect administrators
  are around to reset it.
- Someone deleted the Amazon Connect **Admin** security profile by
  mistake.
...
2. Open the Amazon Connect console at
...
![The Amazon Connect virtual contact center instances page, the instance alias.](images/instance.png) 5. In the navigation pane, choose **Overview**. 6. Choose **Log in for emergency access**.
