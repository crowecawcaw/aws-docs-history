...
# Download recordings and transcripts of past conversations in Connect Customer
...
1. Log in to the Connect Customer admin website with a user account that has [permissions to access recordings](assign-permissions-to-review-recordings.md).
