...
1. If you access the CCP through the Connect Customer console by choosing the phone icon on the top right of a page, you will be re-directed according to the automatic upgrade date sent by email. Please reach out to your Amazon Solution Architect if your request is more urgent.   
![The Connect Customer admin website, phone icon in top right corner.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-phone-icon.png)
...
![The available status in earlier CCP, available status in latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-status-available.png)
...
![Receive a call in earlier CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-receive-call-earlier-ccp.png)


![Receive a call in latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-receive-call-latest-ccp.png)


### Miss a call
<a name="ui-comparison-missed-call"></a>

![Miss a call in earlier CCP, miss a call in latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-missed-call.png)


### Make a call: When to use Quick connects
<a name="ui-comparison-make-call"></a>

![Make a call in earlier CCP, Make a call in latest CCP using quick connect.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-make-call.png)
...
![Make a call in earlier CCP, Make a call in latest CCP using number pad.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-make-call2.png)
...
![Make an outbound call in earlier CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-connected-outbound-call-earlier.png)


![Make an outbound call in latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-connected-outbound-call-latest.png)


### Agent ends a call before being connected to the other party
<a name="ui-comparison-agent-ends-call-before-connecting"></a>

![Agent ends call before being connected in earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-end-outbound-call-before-connecting.png)
...
![Make another call while connected on a call earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-another-call.png)
...
![DTMF input while connected on a call earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-dtmf.png)
...
![Leaving call earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-conference-call.png)
...
![Leaving call earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-leave-call-keep-others-joined.png)
...
![Leaving call earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-on-hold.png)
...
![Receive a queued callback earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-receive-callback.png)


### Miss a queued callback
<a name="ui-comparison-miss-queued-callback"></a>

![Miss a queued callback earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-miss-callback.png)


### Finish After contact work (ACW)
<a name="ui-comparison-acw"></a>

![Finish After contact work earlier CCP, latest CCP.](https://docs.aws.amazon.com/connect/latest/adminguide/images/upgradeccp-acw.png)
