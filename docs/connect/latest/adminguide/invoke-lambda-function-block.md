...
+ To use an AWS Lambda function in a flow, first add the function to your instance. For more information, see [Add a Lambda function to your Connect Customer instance](connect-lambda-functions.md#add-lambda-function).
