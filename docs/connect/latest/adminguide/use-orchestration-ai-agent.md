...
Without chat streaming enabled, some messages will fail to render. For more information, see [Enable message streaming for AI-powered chat](message-streaming-ai-chat.md "message-streaming-ai-chat.md").
