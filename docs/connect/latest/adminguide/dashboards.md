...
+ [Customize your Connect Customer dashboard](dashboard-customize-widgets.md)
+ [Connect Customer conversational analytics dashboard](contact-lens-conversational-analytics-dashboard.md)
...
+ [Queue and agent performance dashboard in Connect Customer](queue-performance-dashboard.md)
...
+ [Access the performance dashboard directly in the agent workspace](performance-dashboard-aw.md)
