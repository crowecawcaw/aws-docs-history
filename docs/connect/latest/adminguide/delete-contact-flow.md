...
![The Archive option in the dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/flow-archive-error.png)
...
![The Archive option in the dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-flow-archive.png)
...
![The Archive option in the dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/flow-archive-option2.png)
...
![The Amazon Connect Flows Archive page showing the restore option in the Actions menu for an archived flow.](https://docs.aws.amazon.com/connect/latest/adminguide/images/flow-restorearchive1.png)
...
![The Amazon Connect flow designer dropdown menu showing the Restore option for an archived flow.](https://docs.aws.amazon.com/connect/latest/adminguide/images/flow-restorearchive.png)
