...
![The new rule page, the Words or phrases - Exact match section, multiple conditions.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-add-category-rules-3.png)
