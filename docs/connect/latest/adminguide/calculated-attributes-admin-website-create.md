...
![The Customer profiles tab in the agent workspace, the Associate button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/calculated-attributes-admin-website-create-1.png)
...
![The Customer profiles tab in the agent workspace, the Associate button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/calculated-attributes-admin-website-create-2.png)
...
![The Customer profiles tab in the agent workspace, the Associate button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/calculated-attributes-admin-website-create-3.png)
...
![The Customer profiles tab in the agent workspace, the Associate button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/calculated-attributes-admin-website-create-4.png)
...
![A banner that the calculated attribute has been created.](https://docs.aws.amazon.com/connect/latest/adminguide/images/calculated-attributes-admin-website-create-5.png)