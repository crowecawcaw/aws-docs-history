...
By making Your Content available to improve Amazon Connect,
...
When the following Amazon Connect features are enabled, we can use Your Content to develop
...
You can always choose to opt out of having your data used to develop and improve Amazon Connect by
