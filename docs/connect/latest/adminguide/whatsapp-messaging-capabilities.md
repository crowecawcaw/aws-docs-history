...
When integrating WhatsApp Business messaging with Connect Customer, be aware of the following limitations:
...
+ Attachments with captions are not supported. Connect Customer removes any captions and delivers the attachment. 
