...
To learn more, see [Enable persistent
...
To get started, configure sort attributes when building segments in Connect Customer Customer Profiles. For more information, see [Outbound Campaigns best practices](outbound-campaigns-best-practices.md "outbound-campaigns-best-practices.md").
...
This feature is available in all AWS Regions where Connect Customer is available. For more information, see the [Connect Customer Administrator Guide](what-is-amazon-connect.md "what-is-amazon-connect.md").
...
Connect Customer conversational analytics is available in the US East (N. Virginia), US West (Oregon), Asia Pacific (Seoul), Asia Pacific (Singapore), Asia Pacific (Sydney), Asia Pacific (Tokyo), Canada (Central), Europe (Frankfurt), and Europe (London) regions. For more information, see [the help documentation](analyze-conversations.md "analyze-conversations.md").
...
For more information, see the [Connect Customer Administrator Guide](what-is-amazon-connect.md "what-is-amazon-connect.md").
...
Connect Customer email is available in the US East (N. Virginia), US West (Oregon), Africa (Cape Town), Asia Pacific (Seoul), Asia Pacific (Singapore), Asia Pacific (Sydney), Asia Pacific (Tokyo), Canada (Central), Europe (Frankfurt), and Europe (London) regions. For more information, see [the help documentation](setup-email-channel.md "setup-email-channel.md").
...
For more information, see [Set up email in Connect Customer](setup-email-channel.md "setup-email-channel.md").
...
For more information, see [Quick Responses](quick-responses.md "quick-responses.md") and [Tag-based Access Control](tag-based-access-control.md "tag-based-access-control.md") in the Connect Customer Administrator Guide.
...
For more information, see [Connect Customer Testing and Simulation](testing-simulation.md "testing-simulation.md").
...
updated through UpdateUserConfig API.

### Audio Enhancement for agents

Connect Customer now offers Audio Enhancement to improve audio quality on the agent's side by reducing
...
Connect Customer Cases now enables you to bulk configure cascading dropdown menus for case fields by uploading CSV files containing field option mappings. This capability
...
For more information about estimated wait time, see [Estimated wait time](get-queue-metrics.md "get-queue-metrics.md") in the Connect Customer Administrator Guide.
...
Connect Customer now enables you to include file attachments when creating tasks using the StartTaskContact API.
...
Connect Customer now enables you to use tag-based access controls to define who can access specific cases. You can
...
Connect Customer now makes it easier to link related contacts such as email replies, call transfers,
...
create a case through a Step-by-Step Guide, you can link that case to the main contact (for example, voice,
chat, email, or tasks) directly using flows.

### Recurring overrides and visual calendar for hours of operation

Connect Customer now makes it easier to manage contact center operating hours for recurring events
...
For more information, see [AWS::Cases](../../../AWSCloudFormation/latest/TemplateReference/AWS_Cases.md "../../../AWSCloudFormation/latest/TemplateReference/AWS_Cases.md") in the _AWS CloudFormation Template Reference_.
...
For more information, see [Flows in Connect Customer](connect-contact-flows.md "connect-contact-flows.md").

## December 2025 Updates

### Workspace and data table resources provide business users with greater control over daily operations

Connect Customer now gives business users greater control over daily contact center operations without
...
For more information, see [Set up workspaces for your business users](amazon-connect-workspaces.md "amazon-connect-workspaces.md").
...
For more information, see [Dashboards in Connect Customer for getting contact center performance data](dashboards.md "dashboards.md").
...
For more information, see [Evaluate agent and self-service interaction performance in Connect Customer](evaluations.md "evaluations.md").
...
For more information, see [Create alerts on real-time metrics in Connect Customer](rule-real-time-metrics.md "rule-real-time-metrics.md").
...
For more information, see [Create an evaluation form in Connect Customer](create-evaluation-forms.md "create-evaluation-forms.md").
...
Connect Customer Cases now supports conditional field visibility and dependent field options,
...
For more information, see [Add case field conditions to a case template in Connect Customer](case-field-conditions.md "case-field-conditions.md").

### Custom metrics

Connect Customer now supports creation of custom metrics, enabling contact center supervisors to
analyze tailored performance measurements without requiring technical skills. This feature
provides a simple, no-code interface for performing mathematical operations (for example, addition,
...
For more information, see [Create AI agents in Connect Customer](create-ai-agents.md "create-ai-agents.md").
...
For more information, see [Flow block in Connect Customer: Cases](cases-block.md "cases-block.md").
...
For more information, see [Introducing Amazon Nova 2 Sonic](https://aws.amazon.com/blogs/aws/introducing-amazon-nova-2-sonic-next-generation-speech-to-speech-model-for-conversational-ai "https://aws.amazon.com/blogs/aws/introducing-amazon-nova-2-sonic-next-generation-speech-to-speech-model-for-conversational-ai") on the AWS News Blog.
...
For more information, see [How Connect Customer email works](email-capabilities.md "email-capabilities.md").
...
For more information, see [Using MCP with Amazon Connect to monitor operational readiness](https://aws.amazon.com/blogs/contact-center/using-mcp-with-amazon-connect-to-monitor-operational-readiness/ "https://aws.amazon.com/blogs/contact-center/using-mcp-with-amazon-connect-to-monitor-operational-readiness/") on the AWS Contact Center Blog.
...
For more information, see [Intent structure](../../../lexv2/latest/dg/intent-structure.md "../../../lexv2/latest/dg/intent-structure.md") in the _Amazon Lex Developer Guide_.
...
For more information, see [Wait and continue](../../../lexv2/latest/dg/wait-and-continue.md "../../../lexv2/latest/dg/wait-and-continue.md") in the _Amazon Lex Developer Guide_.
...
transcripts in the Connect Customer admin website. You can separately configure access to recordings and transcripts,
allowing users to listen to calls while preventing unauthorized copying of transcripts. Connect Customer
...
Connect Customer provides agents with generative AI-powered email conversation overviews, suggested
...
For example, a customer emails about a refund request. Connect Customer Connect automatically provides
...
Agent time-off balance data is available in the Connect Customer data lake, making it easier
...
of absence) in the data lake. You can also view a chronological list of all
...
For more information, see [Connect Customer Client Application](amazon-connect-client-app.md "amazon-connect-client-app.md").
...
Connect Customer dashboards support selecting and comparing any time ranges. This enables you to focus
...
For more information, see [Dashboards in Connect Customer for getting contact center
...
These APIs support the functionality described in [Access the Worklist app in the agent workspace](worklist-app.md "worklist-app.md").
...
Connect Customer offers expanded disconnect reasons to help you better understand why outbound calls
...
search** page in the Connect Customer admin website. You can drill-down into your hierarchy to review contacts
...
contacts in Connect Customer](contact-search.md "contact-search.md").
...
information, see [Access the Worklist app in the agent workspace](worklist-app.md "worklist-app.md").
...
Connect Customer supports multi-user web, in-app, and video calling, allowing multiple users to join
...
Connect Customer supports recurring activities in agent schedules, allowing you to add repeating
...
For more information, see [Add the Connect Customer widget to your website to accept chat, task, email, and web calling contacts](connect-widget-on-website.md "connect-widget-on-website.md").

### Connect Customer Outbound Campaigns supports multi-profile campaigns and enhanced phone number retry sequencing

Connect Customer Outbound Campaigns supports account-based campaigns, enabling you to reach multiple
...
This feature is available in all AWS Regions where Connect Customer Outbound Campaigns is supported.
...
For more information, see [Access third-party applications in the agent workspace](3p-apps-agent-workspace.md "3p-apps-agent-workspace.md") in the Amazon Connect Administrator Guide and the
[Amazon
...
assigned a score of 0 to the entire form. For more information, see [Step 5: Assign scores and ranges to answers](create-evaluation-forms.md#step-assignscores "create-evaluation-forms.md#step-assignscores") in [Create an evaluation form in Connect Customer](create-evaluation-forms.md "create-evaluation-forms.md").
...
STIR/SHAKEN attestation headers and attestation levels provided by Connect Customer through AMCS LLC.
Previously, these calls were marked and signed with headers and attestation levels determined by
our carrier partners. For more information, see [Stir/Shaken attestation in Connect Customer](stirshaken.md "stirshaken.md").
...
[Keyboard shortcuts for the Connect Customer flow designer](keyboard-shortcuts.md "keyboard-shortcuts.md").
...
Reflow Mode makes sure that panels and interface elements automatically rearrange when zoomed
...
The Connect Customer UI builder, used to create Views that power Step-by-Step Guides, has an updated
...
entered on a view by a user more initiative and consistent with Connect Customer workflow orchestration.

In addition, the UI builder contains a consistent look and feel with the rest of Connect Customer by
using [Cloudscape Design System](https://cloudscape.design/ "https://cloudscape.design/") components.

For more information, see [Use the UI builder in Connect Customer for resources in step-by-step guides](no-code-ui-builder.md "no-code-ui-builder.md"), especially the subtopic [Configure
...
Added the following chat metrics to Connect Customer. Each metric is available in the Connect Customer admin website and by
...
resiliency instance in Asia Pacific (Osaka), you can replicate your Connect Customer configurations,
...
after switching Regions. To get started, you first need to set up an Connect Customer instance in
Asia Pacific (Tokyo) as your primary Region. You can then create a replica instance for
Amazon Connect in the Asia Pacific (Osaka) Region. For more information, see [Set up Connect Customer Global Resiliency](setup-connect-global-resiliency.md "setup-connect-global-resiliency.md").
...
You can integrate agent activities from third-party applications as Connect Customer tasks. Managers
can then evaluate these activities alongside work completed in Connect Customer. This provides managers
...
Connect Customer Customer Profiles Profile Explorer is a feature that provides a unified, customizable view of
...
For more information, see the [Set up Profile explorer in Connect Customer Customer Profiles](customer-profiles-profile-explorer.md "customer-profiles-profile-explorer.md").
...
request. For more information, see [Connect Customer service
...
For more information, see the [Create calculated attributes in Connect Customer](calculated-attributes-admin-website-create.md "calculated-attributes-admin-website-create.md").
...
interactions. For more information, see [AgentInitiatedHoldDuration](ctr-data-model.md#AgentInitiatedHoldDuration-CTR "ctr-data-model.md#AgentInitiatedHoldDuration-CTR") in the [Data model for Connect Customer contact records](ctr-data-model.md "ctr-data-model.md") topic.
...
(VDI) environments. Connect Customer automatically optimizes audio by redirecting media from your agent's
local desktop to Connect Customer, simplifying the agent experience and improving audio quality by reducing
...
information, see [Optimize Connect Customer audio for Omnissa cloud desktops](using-ccp-vdi-omnissa-step-by-step.md "using-ccp-vdi-omnissa-step-by-step.md").
...
reporting. For more information, see [Outbound campaign metrics in Connect Customer](outbound-campaign-metrics.md "outbound-campaign-metrics.md").
...
agents accordingly. For more information, see [Schedule Adherence for agent productivity in Connect Customer](schedule-adherence.md "schedule-adherence.md").
...
be able to see metrics for those agents. For more information, see [Apply hierarchy-based access control to dashboards and reports in Connect Customer](dashboard-access-control.md "dashboard-access-control.md").

### Track and meet service level agreements (SLAs) on cases

Connect Customer Cases provides capabilities to help contact centers track and meet service level
agreements (SLAs) on cases. Using the Connect Customer admin website, admins can set up SLA rules based on case
...
are not met. For more information, see [How SLAs work in Connect Customer Cases](cases-sla.md "cases-sla.md").
...
You can customize the number of seconds that Connect Customer waits between a caller's keypad button
...
For more information, see [How supervisors view published schedules using the Connect Customer admin website](scheduling-view-schedule-supervisors.md "scheduling-view-schedule-supervisors.md").

### Process to enable outbound campaigns for the purpose of event-driven mass notifications

Connect Customer outbound campaigns supports event-driven mass notifications, such as severe weather warnings,
evacuation notices, disaster response communications, or utility disruptions impacting many
thousands of customers with prior authorization and approval. Additional charges might apply based
...
conversational analytics. This helps you make sure that agents have reviewed evaluation feedback and
...
Connect Customer Analytics Data Lake provides a unified source for contact center data,
...
For more information, see [Connect Customer data lake](data-lake.md "data-lake.md").

There are updated tables for Contact records, Contact Evaluation records, Lex, and Outbound
Campaigns. For tables of the latest fields, see [Data type definitions for the Connect Customer data lake](data-type-definitions.md "data-type-definitions.md").
...
For more information, see [Create shift trade groups](scheduling-create-shift-trade-groups.md "scheduling-create-shift-trade-groups.md") and [Set up shift exchange in Connect Customer](shift-exchange.md "shift-exchange.md").
...
available to associate with for a given Connect Customer instance.
...
You can use Connect Customer Agent Workspace to redirect audio from Citrix and Amazon WorkSpaces Virtual
...
You can maintain an open communication channel between your agents and Connect Customer to help reduce
...
Connect Customer persistent agent connection makes it easier to support compliance requirements with
...
(for example, handle time) in the Connect Customer admin website.
...
week over week), summary charts, time-series chart. For example, you can create a single
...
impact both wait time and customer abandonment rates. For more information, see [Customize your Connect Customer dashboard](dashboard-customize-widgets.md "dashboard-customize-widgets.md").
...
Connect Customer allows you to target a range of agent proficiency levels, such as from levels 1 to 3
...
Connect Customer allows you to exclude certain proficiencies from consideration when using routing
...
You can use the Connect Customer admin website to permanently delete queues and routing profiles. For example, if
...
For more information, see [Scheduling data in the Connect Customer analytics data lake](data-lake-scheduling.md "data-lake-scheduling.md").
...
configure overrides by using the Connect Customer admin website or APIs. During daily contact handling, Connect Customer
...
[Hours of operation actions](../APIReference/hours-of-operation-api.md "../APIReference/hours-of-operation-api.md") in the _Connect Customer API Reference_.

#### Connect Customer supports push notifications for mobile chat on iOS and Android devices

Connect Customer supports push notifications for mobile chat on iOS and Android devices, improving
...
Connect Customer makes it easier for you to collect sensitive customer data and deliver seamless
...
another page on your website. For more information, see the [Flow block in Connect Customer: Show view](show-view-block.md "show-view-block.md") block.

#### Proactive outbound engagement in the Connect Customer admin website

You can proactively engage your customers in a personalized manner. Connect Customer includes
...
- Use the segment AI assistant in Connect Customer Customer Profiles to build audiences using natural language
...
- Use trigger-based campaigns based on real-time customer events on Connect Customer outbound campaigns to
...
conversational AI experiences, all within the Connect Customer admin website.
...
for interactive voice response (IVR) and chatbot self-service experiences by using the Connect Customer admin website
(powered by [Amazon Lex](https://aws.amazon.com/lex/ "https://aws.amazon.com/lex/")). By using the Connect Customer
drag-and-drop workflow designer, you can enhance your bots with Connect Customer Customer Profiles, making
...
options. These new bot building capabilities in Connect Customer make it easy for you create and launch
bot-powered self-service experiences by reducing the need for you to manage multiple
applications or custom integrations.

For more information, see [Create conversational AI bots in Connect Customer](connect-conversational-ai-bots.md "connect-conversational-ai-bots.md").

For a list of new metrics included in this release, see [Connect Customer bot metrics and analytics](bot-metrics.md "bot-metrics.md").
...
For more information, see [Monitor automated interactions (IVR) in Connect Customer](monitor-automated-interaction-logs.md "monitor-automated-interaction-logs.md").
...
Connect Customer Email provides built-in capabilities that make it easy for you to
...
emails sent by customers to business addresses or submitted through web forms on your website or
mobile app.
...
proactive and personalized email communications. For more information, see [Set up email in Connect Customer](setup-email-channel.md "setup-email-channel.md").
...
[Forecasting data in the Connect Customer analytics data lake](data-lake-forecasting-data.md "data-lake-forecasting-data.md").

#### Use screen sharing with web and video calls

You can use screen sharing with Connect Customer web and video calls, and pass contextual information
to Connect Customer. Screen sharing enables agents to quickly gain an understanding of issues and help
...
Connect Customer Chat provides SDKs for iOS and Android, allowing you to deliver native in-app chat
...
Connect Customer supports the ability to initiate outbound SMS contacts, enabling
businesses to help increase customer satisfaction by engaging customers on their preferred
communication channel. For more information, see the [Flow block in Connect Customer: Send message](send-message.md "send-message.md") flow block and the [StartOutboundChatContact](../APIReference/API_StartOutboundChatContact.md "../APIReference/API_StartOutboundChatContact.md") API.
...
the Connect Customer admin website.
...
across evaluators. For more information, see [View an evaluation audit trail in Connect Customer](evaluation-audit-trail.md "evaluation-audit-trail.md").
...
information, see the **Set creation flow** parameter on the [Flow block in Connect Customer: Transfer to queue](transfer-to-queue.md "transfer-to-queue.md") block.
...
contact using the Set routing criteria flow block in the Connect Customer admin website. For
...
(VDI) environments. Connect Customer automatically optimizes audio by redirecting media from your agent's
local desktop to Connect Customer, simplifying the agent experience and improving audio quality by
reducing network hops. For more information, see [Optimize Connect Customer audio for Amazon WorkSpaces cloud desktops](using-ccp-vdi-workspaces.md "using-ccp-vdi-workspaces.md").
...
flows and reduce the duration of a contact. For more information, see [Flow block in Connect Customer: Set whisper flow](set-whisper-flow.md "set-whisper-flow.md").
...
the Connect Customer admin website. This enables you to evaluate contact quality and agent performance by using offline
...
information, see [Review agent screen recordings in the Connect Customer Client Application](review-screen-recordings.md "review-screen-recordings.md").
...
Synchronization. For a description of the additional actions, see [Connect Customer updates to AWS managed policies](security_iam_awsmanpol.md#security-iam-awsmanpol-updates "security_iam_awsmanpol.md#security-iam-awsmanpol-updates").
...
Released Connect Customer Client Application v2.0.1. This version includes bug fixes and enhancements to improve the
stability and monitoring of the application. To download the latest version, see [Connect Customer Client Application](amazon-connect-client-app.md "amazon-connect-client-app.md").
...
integration with third-party agent workspace or CRM systems. For more information, see [View generative AI-powered post-contact summaries in Connect Customer](view-generative-ai-contact-summaries.md "view-generative-ai-contact-summaries.md").

#### More options for searching for resources on the Connect Customer admin website

You have more options for searching resources on the Connect Customer admin website. The search options are
...
Connect Customer automatically returned users that matched the first two characters typed - "ja".
...
to administrate schedules and make sure that agents receive a business-defined sequence of shifts.
For more information, see [Set up shift rotation patterns in Connect Customer](shift-rotations.md "shift-rotations.md").
...
The Connect Customer agent workspace features an updated user interface to improve the productivity
...
For more information, see [Access third-party applications in the agent workspace](3p-apps-agent-workspace.md "3p-apps-agent-workspace.md").
...
operates. Connect Customer automatically adjusts forecasts to account for daylight saving changes. For
...
These metrics are available in the Connect Customer admin website. You can also access them programmatically by
...
welcome flow exceeds 10% over a trailing 4 hour window. For more information, see [Create alerts on real-time metrics in Connect Customer](rule-real-time-metrics.md "rule-real-time-metrics.md").
...
the Connect Customer admin website. For a description of each metric, see [Metric definitions in Connect Customer](metrics-definitions.md "metrics-definitions.md").
...
when using Connect Customer in a multi-session VDI environment.

To use this update, download the latest version of the screen recording client
application. For the download location, see [Connect Customer Client Application](amazon-connect-client-app.md "amazon-connect-client-app.md").
...
Connect Customer allows you to create rich, interactive chat experiences for customers using
step-by-step guides, that help resolve issues faster and improve the customer experience. For
more information, see [Deploy step-by-step guides in Connect Customer chats](step-by-step-guides-chat.md "step-by-step-guides-chat.md").

#### Connect Customer agent workspace supports third-party applications in general availability

The Connect Customer agent workspace now supports third-party applications in general availability.
Agents can use the native agent applications of Connect Customer (Q in Connect, Cases, Customer Profiles, and Step-by-step
Guides) alongside internal or custom-built agent applications, all within a unified agent
workspace. For more information, see [Integrate third-party applications in the agent workspace](3p-apps.md "3p-apps.md"), [Use screen pop functionality of third-party applications in the Connect Customer agent workspace](no-code-ui-builder-app-integration.md "no-code-ui-builder-app-integration.md"), the [Agent Workspace developer
guide](../../../agentworkspace/latest/devguide/what-is-service.md "../../../agentworkspace/latest/devguide/what-is-service.md"), the [Connect Customer API reference
...
For more information, see [View generative AI-powered post-contact summaries in Connect Customer](view-generative-ai-contact-summaries.md "view-generative-ai-contact-summaries.md").

#### Hierarchy-based access control (Preview)

In addition to tags, you can enable granular access controls for users by [configuring agent](agent-hierarchy.md "agent-hierarchy.md") hierarchies within the Connect Customer admin website.
...
controls for users, see the [Apply hierarchy-based access control in Connect Customer](hierarchy-based-access-control.md "hierarchy-based-access-control.md").
...
reports using the historical metrics dashboard in the Connect Customer admin website to analyze case resolution
...
Connect Customer Cases provides audit history on cases, allowing you to see which users worked on a
...
times, do-not-call times, maximum contact attempts) while programmatically using Connect Customer
...
Connect Customer console and integrate the Amazon Q in Connect JavaScript library
...
metrics reports. For more information, see [Apply granular access control to historical metrics reports in Connect Customer](hm-tag-based-access-control.md "hm-tag-based-access-control.md").

### December 2023 Updates

#### Update to third-party applications preview

Added support for third-party applications (preview) to listen to Connect Customer contact and agent
events.
...
prompts in the Connect Customer admin website. For example, you can tag hours of operation with
...
agent, channel, queue) and keywords within a conversation. Using this API, you can build
...
more insights into your Connect Customer bill and better organize your bill by lines of
business/departments (for example, support, banking, sales, claims), types of issues, phone
numbers, environments, and more.

For more information, see [Set up granular billing for a detailed view of your Connect Customer usage](granular-billing.md "granular-billing.md"). Also see [TagContact](../APIReference/API_TagContact.md "../APIReference/API_TagContact.md") and
[UntagContact](../APIReference/API_UntagContact.md "../APIReference/API_UntagContact.md") in the _Connect Customer API Reference_.
...
personalized customer experiences more efficiently. For more information, see [Generative AI powered data mapping in Connect Customer](genai-powered-data-mapping.md "genai-powered-data-mapping.md").
...
The Connect Customer in-app, web, and video calling capabilities enable your customers to contact you
without ever leaving your web or mobile application. You can use these capabilities to pass
contextual information to Connect Customer. This enables you to personalize the customer experience based
...
In addition, see the [StartWebRTCContact](../APIReference/API_StartWebRTCContact.md "../APIReference/API_StartWebRTCContact.md") action in the _Connect Customer API
Reference_.

#### Connect Customer supports two-way SMS

Connect Customer supports two-way Short Messaging Service (SMS) capabilities, making it easy for you
...
your Connect Customer instance. Connect Customer SMS uses the same automation, routing, configuration, analytics, and
agent experience as calls and chats, making it easy to deliver seamless omnichannel customer
experiences.

For more information, see [Set up SMS messaging in Connect Customer](setup-sms-messaging.md "setup-sms-messaging.md"). In addition, see the following new actions in the
...
For more information, see [Access Connect Customer data lake](access-datalake.md "access-datalake.md"). In addition, see new actions in the [Analytics data lake
actions](../APIReference/analyticsdataset-api.md "../APIReference/analyticsdataset-api.md") topic in the _Connect Customer API Reference_.
...
information, see [Flow block in Connect Customer: Customer profiles](customer-profiles-block.md "customer-profiles-block.md").
...
by each of your Connect Customer instances. When requesting a quota increase, Service Quotas allows you to
indicate both the Connect Customer quota and desired value. For quotas that support resource level
adjustability you can also specify your Connect Customer instance. For more information, see [Connect Customer service quotas](amazon-connect-service-limits.md "amazon-connect-service-limits.md").
...
Connect Customer provides a pre-built queue performance dashboard that helps contact center managers
...
example, you might notice a discrepancy in the IVR prompt that customers hear when they call your
...
You can integrate Connect Customer with your preferred file scanning application to detect malware or
...
information, see [Set up attachment scanning in Connect Customer](setup-attachment-scanning.md "setup-attachment-scanning.md").
...
outcomes of all campaign calls by using the Connect Customer
...
additional actions, see [Connect Customer updates to AWS
...
subsequent contact handling. If that agent experiences poor network conditions, this might result
...
Connect Customer can identify, within about 2 minutes, a situation where a chat customer and an agent
...
percent**. For descriptions of these metrics, see [Metric definitions in Connect Customer](metrics-definitions.md "metrics-definitions.md").

#### Added configuration management across AWS Regions for Connect Customer Global Resiliency customers

Connect Customer Global Resiliency customers can use the [ReplicateInstance](../APIReference/API_ReplicateInstance.md "../APIReference/API_ReplicateInstance.md") API to copy configuration information for resources
such as users, routing profiles, queues, and flows across AWS Regions. The API
also automatically matches the service quotas for these resources across AWS Regions as part of the replication process. For more information, see [Create a replica of your existing Connect Customer instance](create-replica-connect-instance.md "create-replica-connect-instance.md").
...
can list which phone numbers are associated with which flows in an Connect Customer instance.

### October 2023 Updates

#### Added actions to `AmazonConnectServiceLinkedRolePolicy`

Updated `AmazonConnectServiceLinkedRolePolicy` with actions for Connect Customer Customer Profiles. For
a description of the additional actions, see [Connect Customer updates to AWS managed policies](security_iam_awsmanpol.md#security-iam-awsmanpol-updates "security_iam_awsmanpol.md#security-iam-awsmanpol-updates").

#### Third-party applications preview

You can integrate third-party applications into the agent workspace. For more information,
see [Integrate third-party applications in the agent workspace](3p-apps.md "3p-apps.md") and the [Amazon Connect agent workspace
...
This upgrade prevents the blocking of third-party cookies from impacting Connect Customer across
Chrome and all supported browsers. For more information, see [Connect Customer CTI Adapter for Salesforce](https://amazon-connect.github.io/amazon-connect-salesforce-cti/docs/lightning/release-notes/ "https://amazon-connect.github.io/amazon-connect-salesforce-cti/docs/lightning/release-notes/") release notes and [Using Connect Customer with third-party cookies](admin-3pcookies.md "admin-3pcookies.md").

#### Create and customize up to 15 communications widgets

You can create and customize up to 15 communications widgets per Connect Customer instance. For more
information, see [Add a chat user interface to your website hosted by Connect Customer](add-chat-to-website.md "add-chat-to-website.md").
...
metrics are not available in Connect Customer admin website.
...
Released Connect Customer Client Application v1.0.2.38. This version contains minor fixes and
improvements. For more information, see [Connect Customer Client Application](amazon-connect-client-app.md "amazon-connect-client-app.md").
...
This upgrade prevents the blocking of third-party cookies from impacting Connect Customer across
Chrome and all supported browsers. For more information, see [Using Connect Customer with third-party cookies](admin-3pcookies.md "admin-3pcookies.md").
...
For more information, see [Set the limit of maximum contacts in a queue using Connect Customer](set-maximum-queue-limit.md "set-maximum-queue-limit.md").

#### Manage contacts from the Contact details page

On the **Contact details** page of an in-progress contact, you can manage
a contact by transferring, rescheduling, or ending the contact. For more information, see [Manage contacts from the Contact details page in Connect Customer](manage-contacts-admin.md "manage-contacts-admin.md").
...
file types, see [Connect Customer feature specifications](feature-limits.md "feature-limits.md").
...
Connect Customer supports Universal International Freephone number (UIFN) in more than 60 countries
that are registered with the International Telecommunications Union, an organization that
supports the administration of the UIFN service. Connect Customer allows you to enable UIFNs in as many
countries as you need, with a requirement of at least 5 countries. For more information, see
[Connect Customer support of the inbound only UIFN service](uifn-service.md "uifn-service.md").

### August 2023 Updates

#### Voice dialing for outbound campaigns, no agents required

You can use Connect Customer outbound campaigns for high-volume outreach with no agents required. A
...
Connect Customer Cases supports nine additional languages. You can view the Connect Customer Cases user
interface in any language supported by Connect Customer regardless of your AWS Region. For more
information, see [Connect Customer Cases](supported-languages.md#supported-languages-cases "supported-languages.md#supported-languages-cases").

#### Granular access controls using resource tags for the agent activity audit report

You can apply granular permissions to the agent activity audit report in the Connect Customer
historical metrics UI using resource tagging and tag-based access controls. For more
information, see [Agent activity audit tag-based access control in Connect Customer](agent-activity-audit-tag-based-access-control.md "agent-activity-audit-tag-based-access-control.md") and [Apply tag-based access control in Connect Customer](tag-based-access-control.md "tag-based-access-control.md").

#### Enhanced user bulk edit

You can update up to 100 user records on the Connect Customer admin website in less than half the time it used to
take to make bulk updates. This enhancement is especially useful during contact surges when you
might need to change the routing profile for many agents. For more information, see [Edit users in bulk in Amazon Connect Customer](edit-users-in-bulk.md "edit-users-in-bulk.md").

#### Connect Customer scheduling supports agent group activities

Connect Customer scheduling allows contact center managers to more efficiently create and manage
activities for groups of agents. For more information, see [Add shift activities in draft or published schedules in Connect Customer](scheduling-shift-activities-calendar-view.md "scheduling-shift-activities-calendar-view.md").

#### GA for global sign-in and agent distribution capabilities

Released the following Connect Customer Global Resiliency capabilities for general availability:
global sign-in and agent distribution across Connect Customer Regions. This release includes:
...
For more information, see [Set up your agent's experience with Connect Customer Global Resiliency](overview-agent-distribution.md "overview-agent-distribution.md"). Also see the following new APIs:
...
real-time metrics, see [Real-time metrics reports in Connect Customer](real-time-metrics-reports.md "real-time-metrics-reports.md").

#### Sorting on column header names

You now have the ability to sort by choosing a column header, rather than choosing the
smaller arrow next to the header text. For more information about real-time metrics, see [Real-time metrics reports in Connect Customer](real-time-metrics-reports.md "real-time-metrics-reports.md").
...
their routing order impacted by outbound contacts. For more information, see [Create a routing profile in Connect Customer to link queues to agents](routing-profiles.md "routing-profiles.md").
...
You can archive, restore, and delete flows and modules by using the Connect Customer admin website.
...
information, see [Archive, delete, and restore flows in Connect Customer](delete-contact-flow.md "delete-contact-flow.md").
...
undo, Ctrl+Y to redo. For more information, see [Undo and redo actions in the flow designer in Connect Customer](undo-redo-history.md "undo-redo-history.md").
...
information, see [Add comments to a flow block in the flow designer in Connect Customer](add-notes-to-block.md "add-notes-to-block.md").
...
flow. For more information, see [Use the mini-map in Connect Customer to navigate a flow](flow-minimap.md "flow-minimap.md").
...
time off by hour, for each calendar day, for specific time off activities. Connect Customer uses the time
off balance to automatically approve or decline time off requests based on the agent's
available net balance and the group allowance for time off. For more information, see [Import an agent's time off balance to Connect Customer](upload-timeoff-balance.md "upload-timeoff-balance.md") and [Set group allowance for time off in Connect Customer](config-group-allowance-to.md "config-group-allowance-to.md").
...
- You can generate agent schedules that include flexible days, that is, days that will be
  optionally scheduled if there's a need. Connect Customer can automatically generate flexible schedules
  that are compliant to agent's contracts and regional labor laws, thereby saving time for
  schedulers.

For more information, see [Create a template for an agent's weekly shift in Connect Customer](scheduling-create-shift-profiles.md "scheduling-create-shift-profiles.md").

#### Connect Customer Customer Profiles supports rule-based matching and merging

Connect Customer Customer Profiles supports rule-based resolution to match and merge similar profiles into unified
...
personalized for customers. For more information, see [Use Identity Resolution to consolidate similar profiles in Connect Customer](use-identity-resolution.md "use-identity-resolution.md").

#### Released Connect Customer Client Application v1.0.1.33

The Connect Customer Client Application is used to [record agent
...
installing the client application. For the download location, see the [Connect Customer Client Application](amazon-connect-client-app.md "amazon-connect-client-app.md") topic.
...
agent, and Average talk time customer. For more information, see [Metric definitions in Connect Customer](metrics-definitions.md "metrics-definitions.md") and [GetMetricDataV2](../APIReference/API_GetMetricDataV2.md "../APIReference/API_GetMetricDataV2.md").
...
Region. GetMetricDataV2 is now released in all AWS Regions where Connect Customer is
...
Connect Customer provides the ability to search for existing tags within an instance, both
programmatically through API and within the UI. When tagging resources, you can search from
...
Connect Customer scheduling allows contact center agents to manage their time off requests in a
self-serve manner. For more information, see [Create a time off request in Connect Customer](create-time-off-to.md "create-time-off-to.md").

#### Real-time data export of unified customer profiles to an Amazon Kinesis Data Stream

Connect Customer Customer Profiles supports real-time data export of unified customer profiles to an Amazon Kinesis
...
prompts stored in Connect Customer and add them to your Amazon S3 bucket. AWS CloudTrail, CloudFormation, and
...
_Connect Customer API Reference Guide_. Also see [AWS::Connect::Prompt](../../../AWSCloudFormation/latest/UserGuide/aws-resource-connect-prompt.md "../../../AWSCloudFormation/latest/UserGuide/aws-resource-connect-prompt.md") in the _CloudFormation User Guide_.
...
Released Connect Customer evaluation capabilities for general availability. Use these capabilities
to:
...
_Connect Customer API Reference_. To create a shared template for evaluation forms,
...
experiences. You use it to integrate custom participants. For more information, see [Customize chat flow experiences in Connect Customer by integrating custom participants](chat-customize-flow.md "chat-customize-flow.md").

#### Customer Profiles displays case information in the agent workspace

Using Connect Customer Customer Profiles inside the agent workspace, agents can see cases from
third-party case management solutions and Connect Customer Cases inside a particular customer
profile. For more information, see [Use Connect Customer Customer Profiles](customer-profiles.md "customer-profiles.md") and [Access Connect Customer Customer Profiles in the agent workspace](customer-profile-access.md "customer-profile-access.md").
...
For more information, see [Create a routing profile in Connect Customer to link queues to agents](routing-profiles.md "routing-profiles.md"). Also see the [CrossChannelBehavior](../APIReference/API_CrossChannelBehavior.md "../APIReference/API_CrossChannelBehavior.md") API.
...
schedule calendar. For more information, see [How supervisors view published schedules using the Connect Customer admin website](scheduling-view-schedule-supervisors.md "scheduling-view-schedule-supervisors.md").
...
Inside the out-of-the-box Connect Customer agent workspace, you can create workflows
...
transactions and disposition codes. For more information, see [Step-by-step Guides to set up your Connect Customer agent workspace](step-by-step-guided-experiences.md "step-by-step-guided-experiences.md").
...
information, see [Flow block in Connect Customer: AWS Lambda function](invoke-lambda-function-block.md "invoke-lambda-function-block.md").

#### Added Show View flow block

This block is used to configure UI based workflows that you can surface to users in front
end applications. For more information, see [Flow block in Connect Customer: Show view](show-view-block.md "show-view-block.md").
...
shift profile** option described in [Create staff rules for scheduling in Connect Customer](scheduling-create-staff-rules.md "scheduling-create-staff-rules.md").
...
detection](voice-id.md#fraud-detection "voice-id.md#fraud-detection"), and see new actions in the [Connect Customer Voice ID API Reference](../../../voiceid/latest/APIReference/Welcome.md "../../../voiceid/latest/APIReference/Welcome.md").
...
associated to a single user and that user will be able to access Connect Customer from either provider. To
learn more about configuring IAM roles for SAML 2.0 in Connect Customer, see the [Configure SAML with IAM for Connect Customer](configure-saml.md "configure-saml.md") documentation.
...
_Connect Customer API Reference Guide_. This API enables you to programmatically
...
in the _Connect Customer Cases API Reference Guide_.
...
For more information, see [Linked tasks](tasks.md#linked-tasks "tasks.md#linked-tasks") and the [StartTaskContact](../APIReference/API_StartTaskContact.md "../APIReference/API_StartTaskContact.md") API in the _Connect Customer API Reference
Guide_.

#### Connect Customer Cases integrates with AWS PrivateLink

For more information, see [Creating an interface VPC endpoint for Connect Customer](vpc-interface-endpoints.md#vpc-endpoint-create "vpc-interface-endpoints.md#vpc-endpoint-create").
...
tags and access control tags within security profiles in the Connect Customer admin website. For more
...
Connect Customer](tag-based-access-control.md "tag-based-access-control.md").
...
profiles in the Connect Customer admin website. For more information, see [Permissions required to
...
You can use CloudFormation templates to manage Connect Customer instances for
...
[Connect Customer resource type reference](../../../AWSCloudFormation/latest/UserGuide/AWS_Connect.md "../../../AWSCloudFormation/latest/UserGuide/AWS_Connect.md") in the _CloudFormation User
Guide_.
...
Connect Customer makes it easier for you to deliver long lasting, persistent chat
...
changes to [StartChatContact](../APIReference/API_StartChatContact.md "../APIReference/API_StartChatContact.md") in the _Connect Customer API Reference
Guide_, and see the new `RelatedContactId` parameter in the [GetTranscript](../../../connect-participant/latest/APIReference/API_GetTranscript.md "../../../connect-participant/latest/APIReference/API_GetTranscript.md") API in the _Connect Customer Participant
...
data types in the _Connect Customer Participant Service API Reference
Guide_.
...
sent) for a certain amount of time, you might want to consider a chat participant to be idle, and
you might even want to automatically disconnect an agent from the chat. To set up chat timeout
...
Connect Customer now supports Microsoft Edge Chromium. For more information about
supported browsers, see [Browsers supported by Connect Customer.](connect-supported-browsers.md "connect-supported-browsers.md")

#### Connect Customer supports JSON as a content type for chat messages

By supporting JSON as a content type, Connect Customer provides you with a way to pass
...
[StartChatContact](../APIReference/API_StartChatContact.md "../APIReference/API_StartChatContact.md") in the _Connect Customer API Reference
Guide_, and [SendMessage](../../../connect-participant/latest/APIReference/API_SendMessage.md "../../../connect-participant/latest/APIReference/API_SendMessage.md") in the _Connect Customer Participant Service
...
profiles, and queues by configuring resource tags within the Connect Customer console. You can add
...
Connect Customer](tagging.md "tagging.md") and [Tag based access controls in
Connect Customer](tag-based-access-control.md "tag-based-access-control.md").

#### Bulk user import now includes agent hierarchy and tags

Connect Customer now allows you to configure hierarchies and resource tags for users in bulk. You can
...
Connect Customer](user-management.md "user-management.md").
...
Use it to programmatically add conditions to rules. For more information, see [Connect Customer Rules
...
For more information, see [Rules actions](../APIReference/rules-api.md "../APIReference/rules-api.md") in the _Connect Customer
API Reference_.
...
In addition to searching for profiles with a single search key (that is, a key-values(s)
...
Connect Customer console. For more information, see [Delete quick connects](quick-connects-delete.md "quick-connects-delete.md").
...
For more information, see [Add users to Connect Customer](user-management.md "user-management.md").
...
Connect Customer](setup-us-emergency-calling.md "setup-us-emergency-calling.md").

#### GA for Connect Customer Global Resiliency

Released Connect Customer Global Resiliency for General Availability. Global Resiliency enables you
...
[Set up Connect Customer Global
...
Connect Customer Cases allows your agents to quickly track and manage customer issues that require
multiple interactions, follow-up tasks, and teams in your contact center. For more information,
see [Connect Customer Cases](cases.md "cases.md") and [Connect Customer Cases API Reference](../../../cases/latest/APIReference/Welcome.md "../../../cases/latest/APIReference/Welcome.md").
...
options:
    ...
    This option is most useful for scenarios where you have stored your flows in JSON
     offline. For example, for configuration control, you might have flow configurations in an
...
You can search for Connect Customer users by first name, last name, user login, agent hierarchy,
security profile, and routing profile. For example, you can search for all Connect Customer users who have
the first name "Jane."
...
Use Voice ID to evaluate calls for voice spoofing. For more information, see [Voice spoofing detection](voice-id.md#voice-spoofing-detection "voice-id.md#voice-spoofing-detection") and the [Connect Customer Voice ID API Reference](../../../voiceid/latest/APIReference/Welcome.md "../../../voiceid/latest/APIReference/Welcome.md").
...
are following the schedule that you have created. This helps make sure you achieve your service
...
page, in your Connect Customer security profile you must have **Users - View**
...
Connect Customer Chat, see [Set up your customer's chat
...
expect from Connect Customer. Due to this change, the agent tables are sorted by [agent status](metrics-agent-status.md "metrics-agent-status.md") instead of by agent login.
...
Connect Customer Cases (Preview) allows your agents to quickly track and manage customer issues that
require multiple interactions, follow-up tasks, and teams in your contact center. For more
information, see [Connect Customer
Cases (Preview)](cases.md "cases.md") and [Connect Customer Cases API Reference
...
Released Connect Customer outbound campaigns, formerly known as High-volume outbound communications.
This release includes a set of APIs for creating and managing outbound campaigns. For more
information, see [Enable Connect Customer outbound
campaigns](outbound-campaigns.md "outbound-campaigns.md") and [Connect Customer Outbound Campaigns API
...
user data from the specified Connect Customer instance.
...
Reference](../APIReference/Welcome.md "../APIReference/Welcome.md") and the [Connect Customer Resource Type
...
Updated the workflow for onboarding to outbound campaigns using the Connect Customer and Amazon Pinpoint user interface.
For more information, see [Enable outbound campaigns](outbound-campaigns.md "outbound-campaigns.md").

#### Voice ID expires speakers

For BIPA Compliance, Connect Customer Voice ID automatically expires speakers that have not been
...
Connect Customer provides an API to programmatically change the current status of an agent. [Agent statuses](metrics-agent-status.md "metrics-agent-status.md") are used to determine when an agent is
**Available** to be routed contacts in Connect Customer, versus when they are set to
**Offline** or a custom status such as **Lunch** or
**Break** and should not be routed contacts. For more information, see [PutUserStatus](../APIReference/API_PutUserStatus.md "../APIReference/API_PutUserStatus.md") in the [Connect Customer API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").

#### New API to search for users by name, agent hierarchies, and tags

Added API to search for user records in your Connect Customer instance. This new API provides a
...
more information, see the [Connect Customer API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
number APIs come with support for AWS CloudFormation. For more information, see the [Connect Customer API
Reference](../APIReference/Welcome.md "../APIReference/Welcome.md") and the [Connect Customer Resource Type
Reference](../../../AWSCloudFormation/latest/UserGuide/AWS_Connect.md "../../../AWSCloudFormation/latest/UserGuide/AWS_Connect.md") in the _AWS CloudFormation User Guide_.

#### Telephony: Multi-party calls

You can enable Connect Customer to allow up to six parties on a call: the agent, the caller, and four
more participants. (By default, Connect Customer allows agents to have up to three parties on a call: the
agent, and caller, and another participant.)

For more information, see the following topics:

- [Comparison of enhanced contact monitoring (multi-party) and three-party functionality in Connect Customer](three-party-multi-party-comparison.md "three-party-multi-party-comparison.md")
...
Connect Customer Streams, see the [Connect Customer
...
information about the policy required for Connect Customer to access the Amazon S3 bucket, see [Set up prompts to play from an S3 bucket in Connect Customer](setup-prompts-s3.md "setup-prompts-s3.md").

#### CloudTrail support for queues and routing profiles

Connect Customer records all changes made to users, routing profiles, and queues as events in
AWS CloudTrail. For example, you can identify who took which action, what resources were acted upon,
and when an event occurred. For more information, see [Log Connect Customer API calls with AWS CloudTrail](logging-using-cloudtrail.md "logging-using-cloudtrail.md").
...
Added a user interface for creating object type mapping by using the Connect Customer admin console.
...
**SuccessfulChatsPerInterval**. For more information, see [Monitoring your Connect Customer instance using CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md").
...
Connect Customer released the unified agent application to improve the agent experience and customer
...
Connect Customer Customer Profiles offers Identity Resolution, a feature that is designed to automatically detect similar customer
...
[Connect Customer
admin console](use-identity-resolution.md "use-identity-resolution.md") or [Connect Customer Customer Profiles APIs](../../../customerprofiles/latest/APIReference/Welcome.md "../../../customerprofiles/latest/APIReference/Welcome.md").

#### Connect Customer Customer Profiles stores contact history at no charge

Connect Customer Customer Profiles now provides contact history and customer information together in unified
...
Data Storage](amazon-connect-instances.md#get-started-data-storage "amazon-connect-instances.md#get-started-data-storage") in the _Create an Connect Customer instance_ topic.
...
longer available for use. For more information, see the [Connect Customer API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
profiles help you manage who can access the Connect Customer dashboard and Contact Control Panel (CCP),
and who can perform specific tasks. For more information, see the [Connect Customer API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
Released the Connect Customer `HoursOfOperation` APIs for general availability (GA). Also
launched CloudFormation support for Users, User Hierarchies, and Hours of Operation. For more
information, see the [Connect Customer API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md") and the [AWS CloudFormation User
...
Voice ID](voice-id.md "voice-id.md") and the [Connect Customer Voice ID API Reference](../../../voiceid/latest/APIReference/Welcome.md "../../../voiceid/latest/APIReference/Welcome.md").

#### Preview release of Connect Customer outbound campaigns

Added content for the preview release of outbound campaigns. By using Amazon Pinpoint Journeys and Connect Customer, you
...
list. For more information, see [Set up your network to use the Connect Customer Contact Control Panel (CCP)](ccp-networking.md "ccp-networking.md").
...
current contacts. When all their slots are cleared, Connect Customer automatically sets agents to the next
...
When an agent sets their status to **Next status**, Connect Customer populates a
...
- If you integrate with Connect Customer Streams API and your agents interact directly with the
  native CCP user interface, your agents will start using this new feature immediately.
- If you integrate with Connect Customer Streams API but your agents don't interact directly with
...
If you are handling state change logic yourself from Connect Customer Streams, you will need to
make additional changes explained in the [Connect Customer
Streams README](https://github.com/amazon-connect/amazon-connect-streams/blob/master/README.md "https://github.com/amazon-connect/amazon-connect-streams/blob/master/README.md").
...
Released Apple Messages for Business for general availability (GA). For more information, see [Enable Apple Messages for Business with Connect Customer](apple-messages-for-business.md "apple-messages-for-business.md").

#### Quick connects management API GA

Released Connect Customer quick connects management API for general availability (GA). For more
information, see [Connect Customer Service API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md"). The quick connects API also supports AWS CloudFormation. For more
information, see [Connect Customer Resource Type
...
For more information on using the Amazon Lex V2 console with Connect Customer, see [Add an Amazon Lex bot](amazon-lex.md "amazon-lex.md").
Added these three APIs: AssociateLexBot, DisassociateLexBot, and ListLexBots. See the [Connect Customer Service API
...
your Connect Customer contact center. For more information, see [Connect Customer contact events](contact-events.md "contact-events.md").
...
- Connect Customer incorrectly reported that chat contacts that were created from disconnect flows
  were created from transfer flows.
- When these fixes, Connect Customer correctly reflects in the contact records and agent event stream
...
The current access URL continues to work for Connect Customer instances created before the release
of the **my.connect.aws** domain. Any Connect Customer instances created after the
release automatically use the new domain.

Also, if you create new Connect Customer instances after the release of the new domain, you must add
...
your widget. For more information, see [Set up your customer's chat experience in Connect Customer](enable-chat-in-app.md "enable-chat-in-app.md").

Provided an open source example. For more information, see [Customize chat with the Connect Customer open source example](download-chat-example.md "download-chat-example.md").

#### Connect Customer Endpoint Test Utility

To help you validate connectivity to Connect Customer, or troubleshoot when your agents are
experiencing problems with the Contact Control Panel (CCP), we've added the Connect Customer Endpoint Test
Utility. For more information, see [Validate connectivity to Connect Customer with the Endpoint Test Utility](check-connectivity-tool.md "check-connectivity-tool.md").
...
The Connect Customer contact records stream now includes **DisconnectReason** for
...
information, see [Connect Customer Service API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
[The task channel in Connect Customer](tasks.md "tasks.md").

#### Connect Customer APIs

Added an Connect Customer API that provides the ability to create tasks
...
Added Connect Customer Customer Profiles, enabling agents to create a customer profile for every new
...
Added Connect Customer Voice ID (Preview), which provides for real-time caller authentication. For
more information, see [Use real-time caller authentication with Voice ID in Connect Customer](voice-id.md "voice-id.md").
...
Added support for using Connect Customer with Apple Messages for Business. For more information, see [Enable Apple Messages for Business with Connect Customer](apple-messages-for-business.md "apple-messages-for-business.md").
...
- Added chat support for whisper flows. For more information, see [Flow block in Connect Customer: Set whisper flow](set-whisper-flow.md "set-whisper-flow.md").
...
- Added **ContactDetails** and **References** to the
  contact record. For more information, see [Data model for Connect Customer contact records](ctr-data-model.md "ctr-data-model.md").
...
- Added the Connect Customer Flow language, a JSON-based representation of a series of flow actions,
...
- Added the ability to select, cut, copy, and paste flows. For more information, see [Copy and paste flows in Connect Customer](copy-paste-contact-flows.md "copy-paste-contact-flows.md").
...
- The **Set voice** block supports speaking styles with neural
  text-to-speech (TTS) voices. For more information, see [Flow block in Connect Customer: Set voice](set-voice.md "set-voice.md").
...
In addition, in the historical metrics report, Connect Customer displays a hyphen (-)
...
**Queue**, however, Connect Customer doesn't provide an accurate view into
the how the agent is working. Because of this, Connect Customer doesn't show **Agent
...
- Released the following improvements:
  ...
  - Resolved an issue where the DTMF tone degraded when agents interacted with Quick
    connect or Number pad during a session.
...
- Published instructions for upgrading to the latest CCP. For more information, see [Upgrade to the latest Connect Customer Contact Control Panel (CCP).](upgrade-to-latest-ccp.md "upgrade-to-latest-ccp.md").
- Published a training video that explains how to use the CCP. For more information, see
  [Training video: How to use the Contact Center Panel (CCP) in Connect Customer](ccp-video-training.md "ccp-video-training.md").

#### Flows

- The **Set disconnect flow** block supports voice conversations. For
  more information, see [Flow block in Connect Customer: Set disconnect flow](set-disconnect-flow.md "set-disconnect-flow.md").
- The **Set Voice** block supports Amazon Polly Neural Text-to-Speech (NTTS)
  voices. For more information, see [Flow block in Connect Customer: Set voice](set-voice.md "set-voice.md").
- The **Get queue metrics** block can return metrics by channel, for
  example, by voice or chat. For more information, see [Flow block in Connect Customer: Get metrics](get-queue-metrics.md "get-queue-metrics.md").
...
- Updated softphone requirements in [Set up your network to use the Connect Customer Contact Control Panel (CCP)](ccp-networking.md "ccp-networking.md").
...
- Adjusted [Connect Customer service quotas](amazon-connect-service-limits.md "amazon-connect-service-limits.md") for new accounts.
...
- Updated [Set up your network to use the Connect Customer Contact Control Panel (CCP)](ccp-networking.md "ccp-networking.md") to include
...
the ring. In these situations, Connect Customer doesn't drop the contact. Instead, the
...
- Added that you can use AWS Identity and Access Management (IAM) with Connect Customer. For more
  information, see [Identity and access management for Connect Customer](security-iam.md "security-iam.md").

#### Live Media Streaming

- Added that you can capture customer audio for the entire interaction with your contact
  center. For more information, see [Set up live media streaming of customer audio in Connect Customer](customer-voice-streams.md "customer-voice-streams.md").

#### API

- Added [StartChatContact](../APIReference/API_StartChatContact.md "../APIReference/API_StartChatContact.md"), [ListTagsForResource](../APIReference/API_ListTagsForResource.md "../APIReference/API_ListTagsForResource.md"), [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md"), [UntagResource](../APIReference/API_UntagResource.md "../APIReference/API_UntagResource.md") to the Connect Customer Service API.
- Added the [Connect Customer Participant Service](../../../connect-participant/latest/APIReference/Welcome.md "../../../connect-participant/latest/APIReference/Welcome.md")
  API. These APIs are used chat participants, such as agents and customers.

#### Contact Control Panel (CCP)

- Updated the CCP so it supports chat. For more information, see [Agent training guide for the Contact Control Panel (CCP) and agent workspace in Connect Customer](agent-user-guide.md "agent-user-guide.md").
...
- In the agent event stream, fixed the formatting of the timestamp millisecond so you can
  better order and analyze the data. To learn more, see [Connect Customer agent event streams](agent-event-streams.md "agent-event-streams.md").

#### Contact Control Panel

- Resolved an issue where calling a destroy action (such as
  `connection.destroy`) using the [Connect Customer
  ...
  Panel instead of the Connect Customer Streams API, you weren't impacted by this issue.
...
- Improved the error messages you might encounter when running real-time metrics reports.
  ...
  reconfigure your report to contain no more than 100 queues." To learn more, see [Troubleshoot no metrics or too few rows in a queues report in Connect Customer](troubleshoot-rtm.md "troubleshoot-rtm.md")
...
- Released the [UpdateContactAttributes](../APIReference/API_UpdateContactAttributes.md "../APIReference/API_UpdateContactAttributes.md") operation for the Connect Customer API.
...
- [Add an Amazon Lex bot to Connect Customer](amazon-lex.md "amazon-lex.md")
- [User Management
...
- Added an error message when attempting to create an admin user during instance creation
  ...
  use, and cannot be used to create a user account in Connect Customer.
...
- Introduced support for using Amazon Lex bots with Connect Customer in the US West (Oregon)
  Region.
...
- Released contact attributes for system metrics, including a new **Get
  metrics** block in flows. For more information, see [Use attributes in Connect Customer to route based on number of contacts in a queue](attrib-system-metrics.md "attrib-system-metrics.md").
...
- New [Amazon Polly voices](../../../polly/latest/dg/voicelist.md "../../../polly/latest/dg/voicelist.md") are now automatically
  made available in Connect Customer as soon as they are launched. You can use new voices, such as Matthew
  and Léa, in your flows.
- Updated password enforcement for Connect Customer user accounts to match requirements for the Connect Customer
...
- Added support for keypad numeric input to an Amazon Lex bots when used in an Connect Customer contact
  flow. For more information, see [Connect Customer Now Supports Keypad Input with an Amazon Lex Chatbot](https://aws.amazon.com/about-aws/whats-new/2018/05/amazon-connect-now-supports-keypad-input-with-an-amazon-lex-chat/ "https://aws.amazon.com/about-aws/whats-new/2018/05/amazon-connect-now-supports-keypad-input-with-an-amazon-lex-chat/").
...
- Added a **Save** button to the settings menu for the CCP when an agent
  ...
  between sessions.
- Agent username is now available as part of agent configuration data in the [Connect Customer Streams](https://github.com/aws/amazon-connect-streams/blob/master/Documentation.md "https://github.com/aws/amazon-connect-streams/blob/master/Documentation.md") API.
