...
![The Analytics dashboards page, the grouping dropdown.](https://docs.aws.amazon.com/connect/latest/adminguide/images/predefined-attributes-groupings.png)
...
![The Analytics dashboards page, the Add filter dropdown.](https://docs.aws.amazon.com/connect/latest/adminguide/images/predefined-attributes-filters-1.png)

1. Once a filter has been selected, select one or more values to be filter by.  
![The Analytics dashboards page, the filter values dropdown.](https://docs.aws.amazon.com/connect/latest/adminguide/images/predefined-attributes-filters-2.png)
