...
components that enable and facilitate the use of Connect's simulation
capabilities.

###### Contents

- [Required permissions](required-permissions.md "required-permissions.md")
- [Simulation concepts](testing-simulation-concepts.md "testing-simulation-concepts.md")
- [Create test cases](testing-simulation-test-cases.md "testing-simulation-test-cases.md")
- [Execute test cases](testing-simulation-execute-test-cases.md "testing-simulation-execute-test-cases.md")
- [Test and simulate dashboard](testing-simulation-analyze-test-results.md "testing-simulation-analyze-test-results.md")
- [Simulation example](simulation-example.md "simulation-example.md")
