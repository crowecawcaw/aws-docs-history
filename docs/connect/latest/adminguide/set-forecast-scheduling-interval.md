...
+ Connect Customer supports 15- or 30-minute intervals. For example, if you select 30 minutes as the interval, your short-term forecasts are generated for 30-minute intervals (that is, 20 contacts between 9:00 AM-9:30 AM), and your schedules are computed for 30 minute intervals.
