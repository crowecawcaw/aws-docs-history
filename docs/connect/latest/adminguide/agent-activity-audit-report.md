...
+ **Missed Call Agent**: When an agent accepts a call, but they end the call before ringing the customer has finished. 
...
**Note**  
If a status appears in your report but is not listed on this page, it is a custom status created by your organization. Contact your Connect Customer admin to learn the definition.
...
![The Analytics and Optimization section of the security profiles permissions page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/permissions-create-and-share-reports.png)
...
![The agent activity audit permission on the security profile permissions page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/permissions-create-and-share-reports-3.png)
