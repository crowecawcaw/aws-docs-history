...
![The Scheduling page, the shift-activities tab, the sub-type Work.](images/overtime-slots-1.png)
...
![The Request Overtime pane, the Activity dropdown list.](images/overtime-slots-2.png)
