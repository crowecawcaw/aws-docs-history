...
contact to another agent by using [Create quick connects in Connect Customer](quick-connects.md "quick-connects.md"). The "from" agent hears a **Play
...
instructions: [Use contact attributes to route contacts to a specific agent](transfer-to-agent.md#use-attribs-agent-queue "transfer-to-agent.md#use-attribs-agent-queue").
