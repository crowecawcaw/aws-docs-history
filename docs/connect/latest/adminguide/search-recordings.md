# Search for recordings of conversations by a

customer's contact ID in Amazon Connect
...
**Contact search** page, you can find the correct recording by
referring the audio file on the contact's record.
...
4. Conversations that were recorded have icons in the
   **Recording/Transcript** column. The following image shows
...
To learn more about searching, see [Search for completed and in-progress contacts in
