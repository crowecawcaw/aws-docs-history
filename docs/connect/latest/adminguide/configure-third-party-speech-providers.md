# Configure third-party speech providers in
...
- [Configure third‑party text‑to‑speech (TTS)
  providers](configure-third-party-tts.md "configure-third-party-tts.md")
- [Endpoints and Regions for third-party STT
  providers](endpoints-regions-third-party-stt.md "endpoints-regions-third-party-stt.md")
