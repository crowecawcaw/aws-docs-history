...
- [Create and view Connect Customer agent assist Assistants](#wisdom-resources-example1 "#wisdom-resources-example1")
...
The following sample policy allows agent assist assistants to be created, listed,
fetched, and deleted.
