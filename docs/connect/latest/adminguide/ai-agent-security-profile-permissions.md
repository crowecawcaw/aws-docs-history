...
![Security profile page showing AI agent designer permissions including AI Agents, AI Prompts.](images/SecurityProfile_cloudscape_ai_permissions.png) 5. Expand **Channels and Flows** 6. Enable **Bots - All Access** 7. Enable **Flows - All Access** 8. Enable **Flow Modules - All Access** (if using flow modules as tools)

![Security profile page showing Channels and Flows permissions including Bots, Flows, and Flow Modules with All Access enabled.](images/SecurityProfile_cloudscape_channels_flows.png)
