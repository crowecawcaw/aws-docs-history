...
![The Scheduling page, the Published schedule calendar, the request drawer icon.](images/shiftexchange-supervisor-request.png) 2. Choose the **Shift trades** tab to view the details
...
![The Requests pane.](images/shiftexchange-supervisor-request2.png) 3. Approve or decline the requests. The comment you enter will be sent to
the agent.
