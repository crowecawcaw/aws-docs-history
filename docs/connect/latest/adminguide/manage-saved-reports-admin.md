...
1. Log in to the Connect Customer admin website at https://{{instance name}}.my.connect.aws/. Use an account that has **Save reports (admin) - All** in it's the security profile.
