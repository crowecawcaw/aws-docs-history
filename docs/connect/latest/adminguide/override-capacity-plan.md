...
![The Plan Outputs section of the capacity plan, the Required FTEs (without Shrinkage).](https://docs.aws.amazon.com/connect/latest/adminguide/images/wfm-capacity-planning-override-without-shrinkage.png)
...
![The apply override section, the link to download the .csv template file.](https://docs.aws.amazon.com/connect/latest/adminguide/images/wfm-capacity-planning-download-override-template2.png)
...
![A csv file, the data for the Required FTEs without shrinkage.](https://docs.aws.amazon.com/connect/latest/adminguide/images/wfm-capacity-planning-override-template.png)
...
![The Plan Outputs section showing a triangle indicator that displays the original value for the required FTEs.](https://docs.aws.amazon.com/connect/latest/adminguide/images/wfm-capacity-planning-override-without-shrinkage-blue.png)
