...
There is no additional charge for using an existing or a proprietary directory in Connect Customer. For information about the costs associated with using Directory Service, see [Directory Service Pricing Overview](https://aws.amazon.com/directoryservice/pricing/).
