...
After you set up an external application to generate tasks automatically, you need to build rules that tell Connect Customer when to create tasks, and how to route them.
...
1. In Connect Customer, on the navigation menu, choose **Rules**.
...
![The New rule page, spaces are not allowed in the name of a rule.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-lens-add-category-rules.png)
...
![The When and Type dropdown menus.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tasks-add-rule-for-zendesk.png)
...
![The Action page, the task to be generated when the rule is met.](https://docs.aws.amazon.com/connect/latest/adminguide/images/task-rule-action-to-take.png)
