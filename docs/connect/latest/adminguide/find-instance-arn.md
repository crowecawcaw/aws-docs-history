...
![The Distribution settings section, the full ARN.](https://docs.aws.amazon.com/connect/latest/adminguide/images/find-instance-arn.png)

   The information after **instance/** is the instance ID.   
![The characters after the last /.](https://docs.aws.amazon.com/connect/latest/adminguide/images/find-instance-id.png)
...
![The Region dropdown list.](https://docs.aws.amazon.com/connect/latest/adminguide/images/supported-regions.png)
