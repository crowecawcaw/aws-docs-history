...
Connect Customer sends data about your instance to CloudWatch metrics so that you can collect, view, and
analyze CloudWatch metrics for your Connect Customer virtual contact center. You can use this data to monitor key
...
minute period. You can select a refresh interval of 10 seconds, but Connect Customer does not send data
...
If your Connect Customer instance was created on or before October 2018, you need to provide Connect Customer
with permission to begin publishing chat metrics to your CloudWatch account. To do so, create an
IAM policy with the following permission and attach it to the Connect Customer service role. You can
find the Connect Customer service role on the **Account overview** page for your Connect Customer
instance.
...
| CallRecordingUploadError             | The number of call recordings that failed to upload to the Amazon S3 bucket<br>configured for your instance. This is the bucket specified in *_Data<br>Storage_<br>• > *_Call Recordings_<br>• settings for the<br>instance.<br>Unit: Count<br>Dimensions:<br>• **InstanceId**: The ID of your instance<br>• **MetricGroup**: **CallRecordings**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
The following dimensions are used in the CloudWatch dashboard for Connect Customer Voice ID metrics. When
