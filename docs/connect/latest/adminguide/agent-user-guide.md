...
With the agent workspace you can access all Connect Customer features in a single application. You can:
...
You use the Connect Customer Contact Control Panel (CCP) to interact with customer contacts. It's how you receive calls, chat with contacts, transfer them to other agents, put them on hold, and perform other key tasks.
