...
![A set whisper flow block in the sample inbound flow.](https://docs.aws.amazon.com/connect/latest/adminguide/images/set-whisper-flow-default-chat-sample.png)
...
![The properties page of the set whisper flow block, set to default agent whisper.](https://docs.aws.amazon.com/connect/latest/adminguide/images/set-whisper-flow-properties3.png)
