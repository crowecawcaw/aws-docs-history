# Manage Connect Customer Voice ID with the Voice ID APIs
...
To manage Voice ID programmatically, see [Connect Customer Voice ID APIs](../../../voiceid/latest/APIReference.md "../../../voiceid/latest/APIReference.md").

This section explains how to perform common scenarios using the Voice ID APIs.

###### Contents

- [Manage Connect Customer Voice ID domains](voiceid-domain-operations.md "voiceid-domain-operations.md")
...
- [Batch enrollment in Connect Customer Voice ID using audio data from prior calls](voiceid-batch-enrollment.md "voiceid-batch-enrollment.md")
- [File schema for Speaker
  Enrollment Job](speaker-enrollment-job-schema.md "speaker-enrollment-job-schema.md")
- [Create and edit a fraudster watchlist in Connect Customer Voice ID](voiceid-fraudster-watchlist.md "voiceid-fraudster-watchlist.md")
- [File schema for
  Fraudster Registration Job](fraudster-registration-schema.md "fraudster-registration-schema.md")
- [Connect Customer Streams APIs to integrate Voice ID](voiceid-streams-apis.md "voiceid-streams-apis.md")
