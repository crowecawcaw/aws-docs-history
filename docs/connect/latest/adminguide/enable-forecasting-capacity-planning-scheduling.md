...
You must enable forecasting, capacity planning, and scheduling at the Connect Customer instance level. After you enable forecasting, capacity planning, and scheduling,
...
![The Connect Customer virtual contact center instances page, the instance alias.](images/wfm-select-instance.png) 4. In the navigation pane, choose **Forecasting, capacity planning, and scheduling**.

![The Connect Customer navigation pane, the option for forecasting, capacity planning, and scheduling.](images/wfm-left-nav-pane.png) 5. On the **Forecasting, capacity planning, and scheduling** page, select the check box to enable
forecasting, capacity planning, and scheduling.
