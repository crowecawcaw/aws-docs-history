...
| amazon:effect name="whispered" | Indicate that the input text should be spoken in a whispered voice rather than as normal speech.                                         | If you use an unsupported tag in your input text it is automatically ignored when it is processed. To learn more about the SSML tags, see [Supported SSML Tags](../../../polly/latest/dg/supportedtags.md "../../../polly/latest/dg/supportedtags.md") in the Amazon Polly Developer Guide. ## Neural and Conversational Speaking Styles For the **Joanna** and **Matthew** neural voices, in American English (en-US), you can also specify a [Newscaster speaking style](../../../polly/latest/dg/ntts-speakingstyles.md "../../../polly/latest/dg/ntts-speakingstyles.md"). |
