...
![The Contact details page, contact transferred successfully.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-details-contact-transfer-permissions.png)
...
![The Contact search page, task filter, contact status filter.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-details-contact-transfer-filters.png)
...
![The Contact details page, contact transferred successfully.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-details-contact-transfer-action.png)
...
![The Contact details page, contact transferred successfully.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-details-contact-transferred.png)