...
![The properties page of the loop prompts block, the message You are on hold.](https://docs.aws.amazon.com/connect/latest/adminguide/images/default-agent-hold-loop-prompt.png)
...
![break time = 10s in the text-to-speech box.](https://docs.aws.amazon.com/connect/latest/adminguide/images/default-agent-hold-loop-prompt-example.png)
