...
1. Enable security in the communications widget as described in [Add a chat user interface to your website hosted by Connect Customer](add-chat-to-website.md), if you haven't already:
