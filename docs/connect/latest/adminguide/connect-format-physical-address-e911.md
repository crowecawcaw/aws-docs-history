...
| -------------- | -------------------------------------------------------------- | ------------- | -------------------------------------- | --------------- | --------------------------- |
| country        | The country is identified by the two-letter ISO 3166<br>code.  | US            | Required                               | 2               |                             |
| A1             | National subdivisions (state, region, province,<br>prefecture) | NY            | Required                               | 2               |                             |
...
It is your responsibility to validate the address against a standard
repository such as the Master Street Address Guide (MSAG).
