...
| Attributes                 | Map<String, String>            | Key-value pair of attributes of a hotel<br>preference |

The standard hotel preference objects are indexed by the keys in the
following table.
...
For example, you can use `_hotelPreferenceId` as a key name
with the [SearchProfiles API](../../../customerprofiles/latest/APIReference/API_SearchProfiles.md "../../../customerprofiles/latest/APIReference/API_SearchProfiles.md") to find a profile that has a hotel
preference whose PreferenceId matches with the search value. You can find
the standard hotelPreference objects associated with a specific profile by
using the [ListProfileObjects API](../../../customerprofiles/latest/APIReference/API_ListProfileObjects.md "../../../customerprofiles/latest/APIReference/API_ListProfileObjects.md") with the `ProfileId` and
`ObjectTypeName` set to `_hotelPreference`.
...
| ContactDetailCommunication data type | Standard hotelPreference field | Type                                      | Description |
| ------------------------------------ | ------------------------------ | ----------------------------------------- | ----------- |
...
| Language data type | Standard hotelPreference field | Type                     | Description |
| ------------------ | ------------------------------ | ------------------------ | ----------- |
| PhoneLanguage      | String                         | Preferred phone language |
| EmailLanguage      | String                         | Preferred email language |

| CarRental data type | Standard hotelPreference field | Type                            | Description |
| ------------------- | ------------------------------ | ------------------------------- | ----------- |
...
| Location data type | Standard hotelPreference field | Type                                  | Description |
| ------------------ | ------------------------------ | ------------------------------------- | ----------- |
...
| Bedding data type | Standard hotelPreference field | Type                                | Description |
| ----------------- | ------------------------------ | ----------------------------------- | ----------- |
...
| Tour data type  | Standard hotelPreference field | Type                                  | Description |
| --------------- | ------------------------------ | ------------------------------------- | ----------- |
...
| Accessibility data types | Standard airPreference field | Data type                     | Description |
| ------------------------ | ---------------------------- | ----------------------------- | ----------- |
...
| Interest data type | Standard hotelPreference field | Type                              | Description |
| ------------------ | ------------------------------ | --------------------------------- | ----------- |
| NameOfInterest     | String                         | Name of the interest              |
| PreferenceLevel    | String                         | Preference level for the interest |

| Loyalty data type | Standard hotelPreference field | Type                         | Description |
| ----------------- | ------------------------------ | ---------------------------- | ----------- |
...
| Dining data type   | Standard hotelPreference field | Type                         | Description |
| ------------------ | ------------------------------ | ---------------------------- | ----------- |
...
| MediaEntertainment data type | Standard hotelPreference field | Type                                        | Description |
| ---------------------------- | ------------------------------ | ------------------------------------------- | ----------- |
| Name                         | String                         | Name of preferred media or entertainment    |
| PreferenceLevel              | String                         | Preference level for media or entertainment |

| PaymentForm data type | Standard hotelPreference field | Type                                    | Description |
| --------------------- | ------------------------------ | --------------------------------------- | ----------- |
...
| PetInfo data type | Standard hotelPreference field | Type                     | Description |
| ----------------- | ------------------------------ | ------------------------ | ----------- |
| Type              | String                         | Type of pet              |
| PreferenceLevel   | String                         | preference level for pet |

| Special Request data type | Standard hotelPreference field | Type                            | Description |
| ------------------------- | ------------------------------ | ------------------------------- | ----------- |
...
| Medical data type | Standard hotelPreference field | Type                                  | Description |
| ----------------- | ------------------------------ | ------------------------------------- | ----------- |
...
| Baggage data type | Standard hotelPreference field | Type                               | Description |
| ----------------- | ------------------------------ | ---------------------------------- | ----------- |
