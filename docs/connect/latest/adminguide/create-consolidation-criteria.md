...
**Note**  
You must [enable Identity Resolution](#create-consolidation-criteria) in order to access the option to create consolidation criteria using the Connect Customer admin console. 
