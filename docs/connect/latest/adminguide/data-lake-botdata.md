...
| flow_type                             | String    | Connect Customer includes a set of nine flow types. For more<br>information, see [Choose a flow type](create-contact-flow.md#contact-flow-types "create-contact-flow.md#contact-flow-types").   |
...
| flow_type                             | String    | The type of flow. Connect Customer includes a set of nine flow types.<br>For more information, see [Choose a flow type](create-contact-flow.md#contact-flow-types "create-contact-flow.md#contact-flow-types"). |
| channel                               | String    | The method used to contact your contact center: VOICE, CHAT,<br>TASK.                                                                                                                                           |
