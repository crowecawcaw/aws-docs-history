...
**Note**  
Connect Customer supports standard, neural, and generative engines, so you can pass either standard, neural, or generative as values into the engine parameter.
...
Connect Customer also supports speaking styles, which can be defined as None, Conversational, or Newscaster. The Newscaster and Conversational styles are both available for the following voices in the neural engine:
+ Matthew (en-US)
+ Joanna (en-US)
+ Lupe (es-US)
+ Amy (en-GB)
...
| Language Code | Voice | Engine | Speaking style | Result \+ Reasoning | 
| --- | --- | --- | --- | --- | 
