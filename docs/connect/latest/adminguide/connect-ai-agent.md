...
AI agents dynamically navigate your organization's resources to find solutions and
...
AI agents also support human agents by automatically detecting customer intent
...
In addition to receiving automatic recommendations, agents can query an AI agent
directly using natural language or keywords to answer customer requests. AI agents
work right within the Connect Customer agent workspace.

You can customize AI agents to meet your business needs. For example, you can:

- Write [custom](customize-connect-ai-agents.md "customize-connect-ai-agents.md") AI prompts, add AI guardrails, and integrate LLM tools.
- [Integrate AI agents with step-by-step
  guides](integrate-guides-with-ai-agents.md "integrate-guides-with-ai-agents.md") to help agents arrive at solutions faster.
- Integrate AI agents with knowledge bases.
  AI agents can be configured both in the Connect Customer UI as well as via API. For more information, see the
  [AI agents API Reference Guide](../APIReference/API_Operations_Amazon_Connect_AI_Agents.md "../APIReference/API_Operations_Amazon_Connect_AI_Agents.md").

Agent assist can be used in compliance with GDPR and is HIPAA eligible.
