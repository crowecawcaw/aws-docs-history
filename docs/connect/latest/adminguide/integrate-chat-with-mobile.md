...
This topic explains how to integrate Connect Customer Chat into your mobile application. You
can use one of the following options:

- [WebView integration](#webview "#webview")
- The [Connect Customer Chat SDKs for iOS and Android](#integrate-chat-with-mobile-sdks-for-mobile "#integrate-chat-with-mobile-sdks-for-mobile")
- [React Native integration](#react-native-integration "#react-native-integration")
  Use the Connect Customer
...
- [Connect Customer chat integration workflow](#integrate-chat-with-mobile-workflow "#integrate-chat-with-mobile-workflow")
- [Get started with Connect Customer chat integration](#integrate-chat-with-mobile-getting-started "#integrate-chat-with-mobile-getting-started")
...
For more information on implementing WebView integration, see the Connect Customer chat
...
The Connect Customer Chat SDKs for iOS and Android simplify the integration of
Connect Customer chat for native mobile applications. The SDKs help handle
...
- For more information on the Swift-based iOS SDK, see the [Connect Customer Chat SDK for iOS](https://github.com/amazon-connect/amazon-connect-chat-ios "https://github.com/amazon-connect/amazon-connect-chat-ios") GitHub page.
- For more information on the
  Kotlin-based Android SDK, see the [Connect Customer Chat SDK for Android](https://github.com/amazon-connect/amazon-connect-chat-android "https://github.com/amazon-connect/amazon-connect-chat-android") GitHub page.
...
1. When a customer starts a chat in the mobile app, the app should send a request
   to Connect Customer using the [StartChatContact](../APIReference/API_StartChatContact.md "../APIReference/API_StartChatContact.md") API. This requires specific parameters, such as
...
3. The app's UI passes the `StartChatContact` response to the mobile
   SDK in order for the SDK to properly communicate with the [Connect Customer Participant Service](../APIReference/API_Operations_Amazon_Connect_Participant_Service.md "../APIReference/API_Operations_Amazon_Connect_Participant_Service.md") and set up the
...
5. Under the hood, the SDK interacts with the [Connect Customer Participant Service](../APIReference/API_Operations_Amazon_Connect_Participant_Service.md "../APIReference/API_Operations_Amazon_Connect_Participant_Service.md") using the [AWS SDK](https://aws.amazon.com/developer/tools/ "https://aws.amazon.com/developer/tools/"). The communication with the Connect Customer
...
2. For examples that show how to
   build your mobile chat UI powered by the Connect Customer Chat SDKs, check out our [UI
...
[Connect Customer Chat UI Examples Issues](https://github.com/amazon-connect/amazon-connect-chat-ui-examples/issues "https://github.com/amazon-connect/amazon-connect-chat-ui-examples/issues") page.
