...
![The historical metrics queues report, the settings icon.](https://docs.aws.amazon.com/connect/latest/adminguide/images/hmr-queues-settings.png)
...
![Tables settings page, Filters tab, show agent queues option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/hmr-queues-settings-agent-queues.png)
