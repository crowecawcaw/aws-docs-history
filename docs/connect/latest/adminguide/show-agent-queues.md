...
1. In a historical metrics report, choose the **Settings**
   icon, as shown in the following image.

![The historical metrics queues report, the settings icon.](images/hmr-queues-settings.png) 2. Choose **Filters**, **Show agent
queues**, **Agent queues**, and then use the
