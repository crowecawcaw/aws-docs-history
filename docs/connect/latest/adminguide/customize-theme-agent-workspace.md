...
By default, the agent workspace uses an Connect Customer theme, which includes the logo, favicon, font family, and color palette.
...
![The agent workspace in dark mode.](images/agent-workspace-dark-mode.png)
