...
For example, you can set an alert for when a flow block goes down an error path as a
customer interacts with the flow. Log entries are typically available in CloudWatch within a short time, giving you near real-time notification of events in
flows.
