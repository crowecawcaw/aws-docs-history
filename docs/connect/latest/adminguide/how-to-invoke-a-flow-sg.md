...
After you've created your flows, you can dynamically determine which guides to show to users. To do this: 

1. Add a [Flow block in Connect Customer: Set event flow](set-event-flow.md) block to your flow.
