...
To compose and send a notification requires API permissions. For more information about notification APIs, see [Actions by resource in the Connect Customer API Reference](../APIReference/actions-by-resource.md "../APIReference/actions-by-resource.md").
