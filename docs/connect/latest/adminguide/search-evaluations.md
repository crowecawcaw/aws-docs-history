...
![The search filters for evaluations.](images/evaluationforms-searchfilters1.png) 4. Click on the contact ID in the search results to open a contact and review
associated evaluations.

## View evaluations on the contact details page

1. Click on **Evaluations** on the top right of the
   page.
2. If the contact has received an evaluation it will show under
   **Completed**.
3. Click on the evaluation to review the completed evaluation.
