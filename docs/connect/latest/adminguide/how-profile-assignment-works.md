...
![Flowchart showing profile key check process for assigning or queuing objects.](https://docs.aws.amazon.com/connect/latest/adminguide/images/customer-profiles-template1.png)
