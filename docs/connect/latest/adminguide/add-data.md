...
explains how to use the Connect Customer admin website to import quick responses. To import quick responses
...
spreadsheet program. 5. In the .csv file, enter values in each column. Remember the following:
    ...
    * The **Name** and **Shortcut key** values must be
     unique across all the quick responses in your Connect Customer instance.
