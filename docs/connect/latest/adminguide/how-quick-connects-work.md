...
**Note**  
If you don't create and then select a custom agent whisper flow, Connect Customer plays the [default agent whisper flow](default-agent-whisper.md), which says the queue name. 
...
**Note**  
If you don't create and then select a custom customer whisper flow, Connect Customer plays the [default customer whisper flow](default-customer-whisper.md), which plays a beep. 
