...
A supervisor can cancel or edit a time off request by choosing the **Cancel Request** or **Edit Request** buttons at the bottom of the request drawer window. The following image shows the time off requests from Nikki Wolfe. 

![The Scheduling page, the Published schedule calendar tab, the time off requests.](https://docs.aws.amazon.com/connect/latest/adminguide/images/cancel-edit-time-off-to.png)
