...
![The domain section of the Connect Customer Customer Profiles console.](https://docs.aws.amazon.com/connect/latest/adminguide/images/security-profile-customer-profile-issues-403-1.png)

1.  Choose **Update Permissions** in the view domain details section.   
![Update permissions button appears here if any outstanding permissions need to be updated.](https://docs.aws.amazon.com/connect/latest/adminguide/images/security-profile-customer-profile-issues-403-2.png)
...
![Update permissions button disappears after the action has completed successfully.](https://docs.aws.amazon.com/connect/latest/adminguide/images/security-profile-customer-profile-issues-403-3.png)