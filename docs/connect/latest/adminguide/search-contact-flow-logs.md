...
![The Amazon CloudWatch console, log groups section.](https://docs.aws.amazon.com/connect/latest/adminguide/images/cloudwatch-log-group.png)

1. Choose the log group for your instance. The log group name uses the format `/aws/connect/{{instance_alias}}`, where {{instance\_alias}} is the alias of your Connect Customer instance. To find it quickly, enter `/aws/connect/` in the log group filter box.

   A list of log streams appears.

1. To search all the log streams in the instance, choose **Search log group**, as shown in the following image.  
![The search log group button on the /aws/connect/mytest88 page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-flow-logs-choose-search.png)
...
![The log events listed for mytest88.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-flow-logs-search-results.png)
...
![The event for a Play prompt block.](https://docs.aws.amazon.com/connect/latest/adminguide/images/contact-flow-logs-example-event.png)