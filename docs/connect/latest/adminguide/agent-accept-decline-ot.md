...
![Permissions in the agent application schedule calendar.](https://docs.aws.amazon.com/connect/latest/adminguide/images/SecurityProfile_cloudscape_staff_calendar.png)


## Accept and Decline overtime buttons for agents
<a name="buttons-for-agents-accept-decline-ot"></a>

The following image shows the Accept and Decline buttons.
