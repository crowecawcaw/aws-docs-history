...
In step-by-step guides, users must choose a button to proceed to a new page in guides. You configure these buttons in the UI builder by setting an Action for each button. For example, you can configure a button to submit a form. 
