...
You can have multiple instances of Connect Customer. Each instance contains all the resources
related to your contact center, such as phone numbers, agent accounts, and
queues.

In this tutorial, you open Connect Customer, create an instance of Connect Customer, and claim a phone
number that you can use for testing.

###### Contents

- [Step 1: Launch Connect Customer](#tutorial1-login-aws "#tutorial1-login-aws")
...
This step walks you through finding Connect Customer in the AWS console, and opening the
...
![The AWS Management console, the services dropdown menu.](images/tutorial1-access-services.png) 3. In the search box, type **Connect Customer**.

![The search box, Connect Customer in the dropdown list of results.](images/tutorial1-access-services2.png) 4. Choose **Connect Customer**.

If this is the first time you've been to the Connect Customer console, you'll see the
following Welcome page.

![The Connect Customer welcome page, the get started button.](images/tutorial1-amazon-connect-getting-started.png) 5. Choose **Get started**.

**Congratulations!** You found and accessed Connect Customer.
...
1. On the **Connect Customer virtual contact center instances** page,
...
administrator account for Connect Customer. Use this account to log in to your instance
...
![The add administrator page, the username and password boxes.](images/tutorial1-create-admin.png)
    ...
    1. The user name will be your Connect Customer login. It's case
     sensitive.
...
![The Connect Customer instances page, the Getting started button in the top right corner.](images/tutorial1-done-created-instance.png) 8. On the **Welcome to Connect Customer** page, choose **Skip
for now**.

![The Welcome to Connect Customer page, the Skip for now link.](images/tutorial1-skip-for-now.png) 9. You're now on the Connect Customer dashboard. Your instance name (also called an
**alias**) displays in the URL. On the left
is the navigation menu.

![The Connect Customer dashboard page.](images/tutorial1-dashboard.png)

    1. Your instance alias is located in the first part of the
     URL.
    2. The navigation menu.

Congratulations! You set up your instance and now you're on the Connect Customer dashboard.
...
1. On the Connect Customer navigation menu, choose **Channels**,
   **Phone numbers**.

![The Connect Customer navigation menu, channels icon, phone numbers option.](images/tutorial1-routing-phone-numbers.png) 2. On the right side of the **Manage Phone numbers** page,
...
Connect Customer. Go to [Test the sample voice and chat experience in Connect Customer](tutorial1-explore-voice-and-chat.md "tutorial1-explore-voice-and-chat.md").
