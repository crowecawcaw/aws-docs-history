...
![The AWS Management console, the services dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-access-services.png)

1. In the search box, type **Connect Customer**.  
![The search box, Connect Customer in the dropdown list of results.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-access-services2.png)
...
![The Connect Customer welcome page, the get started button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-amazon-connect-getting-started.png)
...
![The set identity page, the Access URL box.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-name-instance.png)
...
![The add administrator page, the username and password boxes.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-create-admin.png)
...
![The set telephony page, telephony options section.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-telephony-defaults.png)

1. On the **Data storage** page, accept the default settings and choose **Next**.   
![The default settings for storing data and flow logs, enable customer profiles option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-data-storage.png)

1. On the **Review and create** page, choose **Create instance**.  
![The review and create page, the create instance button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-review-create-instance.png)

1. After the instance is created, choose **Get started**.  
![The Connect Customer instances page, the Getting started button in the top right corner.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-done-created-instance.png)

1. On the **Welcome to Connect Customer** page, choose **Skip for now**.  
![The Welcome to Connect Customer page, the Skip for now link.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-skip-for-now.png)
...
![The Connect Customer dashboard page.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-dashboard.png)
...
![The Connect Customer navigation menu, channels icon, phone numbers option.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-routing-phone-numbers.png)

1. On the right side of the **Manage Phone numbers** page, choose **Claim a number**.  
![The Manage phone numbers page, the Claim a number button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-claim-a-number-button.png)
...
![The Description box, the flow IVR dropdown menu.](https://docs.aws.amazon.com/connect/latest/adminguide/images/tutorial1-claim-number2.png)
