...
This topic details the content in the Connect Customer data lake scheduling tables.
...
| last\_updated\_by                      | string    | Yes      | The ARN of the user who created/updated the Agent to Demand<br>Group association.                                                                                                                     |
...
| last\_updated\_by                       | string    | Yes      | The ARN of the user who created/updated the Staffing Group<br>to Demand Group association.                                                                                                            |
...
relationships between scheduling tables in the Connect Customer data lake.
