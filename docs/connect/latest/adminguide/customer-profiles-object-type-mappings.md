...
| --------- | ---------------- | ------------ | -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| ACC111    | ACCOUNT\_PROFILE | Sam Joe      | John Doe       | [{"KeyName":"CustomerId","KeyValue":"456","ContactType":"PersonalEmailAddress"},{"KeyName":"CustomerId","KeyValue":"789","ContactType":"PersonalEmailAddress"}] | [{"KeyName":"CustomerId","KeyValue":"456","ContactType":"PhoneNumber"},{"KeyName":"CustomerId","KeyValue":"789","ContactType":"PhoneNumber"}] |
| ACC112    | ACCOUNT\_PROFILE | John Doe     | Sally Doe      | [{"KeyName":"CustomerId","KeyValue":"111","ContactType":"PersonalEmailAddress"}]                                                                                | [{"KeyName":"CustomerId","KeyValue":"111","ContactType":"PhoneNumber"}]                                                                       |
