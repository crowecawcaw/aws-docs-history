...
- [Connect Customer TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md")
...
- [Connect Customer Voice ID TagResource](../../../voiceid/latest/APIReference/API_TagResource.md "../../../voiceid/latest/APIReference/API_TagResource.md"): You can add tags to the Voice ID domain.
- [Amazon AppIntegrations
  ...
  Connect Customer services support up to 50 tags per resource. For a given resource, each tag key must
...
Connect Customer retains tag metadata for resources even after the resource is deleted. The
metadata is retained as long as the Connect Customer instance is active.

This design supports
historical reporting and access control (TBAC) use cases. Specifically, Connect Customer uses
...
entire Connect Customer instance is deleted, at which point historical data access is no longer
applicable.
