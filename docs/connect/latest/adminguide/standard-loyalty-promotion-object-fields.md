...
| CampaignRef           | String                          | External reference to a broader campaign this promotion<br>belongs to.   |
| AdditionalInformation | String                          | Miscellaneous notes or marketing copy about the<br>promotion.            |
...
| --------------------- | ------------------- | -------------------------------- |
| \_loyaltyPromotionId  | PromotionId         |

| Rules data type | Standard loyaltyPromotion field | Type                                         | Description |
| --------------- | ------------------------------- | -------------------------------------------- | ----------- |
| Name            | String                          | Rule name within the promotion rules.        |
| Description     | String                          | Rule description within the promotion rules. |
...
| Interval               | String                          | Interval for trigger limit.                   |

| Usage data type      | Standard loyaltyPromotion field | Type                                        | Description |
| -------------------- | ------------------------------- | ------------------------------------------- | ----------- |
