...
**Topics**
+ [Supported widget snippet fields in Connect Customer that are customizable](supported-snippet-fields.md)
...
+ [Customize widget launch behavior and button icon for your website hosted in Connect Customer](customize-widget-launch.md)
+ [Pass the customer display name when a Connect Customer chat starts](pass-display-name-chat.md)
+ [Pass contact attributes to an agent in the Contact Control Panel (CCP) when a chat starts](pass-contact-attributes-chat.md)
+ [Additional customizations for your Connect Customer chat widget](pass-customization-object.md)
+ [Download the transcript for your chat widget in Connect Customer](chat-widget-download-transcript.md)
+ [Customize chat with the Connect Customer open source example](download-chat-example.md)
+ [Start chats in your applications by using Connect Customer APIs](integrate-with-startchatcontact-api.md)
+ [Send browser notifications to customers when chat messages arrive](browser-notifications-chat.md)
+ [Programmatically disconnect the chat session of a Connect Customer communication widget](programmatic-chat-disconnect.md)
+ [Pass custom properties to override the defaults in the communications widget in Connect Customer](pass-custom-styles.md)
+ [Target your Connect Customer widget button and frame with CSS/JavaScript](target-widget-button.md)
+ [Troubleshoot issues with your Connect Customer communications widget](ts-cw.md)
+ [Add a pre-contact or pre-chat form](add-precontact-form.md)
+ [Enable post-chat survey](enable-post-chat-survey.md)
+ [Capture website visitor activity with the web data tracker](chat-widget-data-tracker.md)
...
1. 
   + **System Message Display Name**: Type a new display name to override the default. The default is **SYSTEM\_MESSAGE**.
...
If you encounter error messages, see [Troubleshoot issues with your Connect Customer communications widget](ts-cw.md).