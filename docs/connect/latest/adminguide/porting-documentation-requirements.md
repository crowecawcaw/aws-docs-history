...
- A link to a secure Amazon S3 storage so you can upload the LOA and any
  other required documents.
  For more information, see [How to complete an LOA](about-porting.md#how-to-complete-loa "about-porting.md#how-to-complete-loa").
...
This usually means that you have an unpaid balance or the carrier
charges a port away fee. After you pay the bill or fee to your
carrier, we will resubmit the port request.

- Name or address mismatch

The information you submitted on your Letter of Authorization
(LOA) is different from what's on file with your carrier in their
Customer Service Record (CSR). To fix this, contact your existing
carrier to update your CSR information, obtain the correct CSR
information, or both. Let us know when they update your information
and we will resubmit the port request. Or, send us a new LOA with
the correct information as provided by your existing carrier.
