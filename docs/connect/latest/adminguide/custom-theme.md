...
<a name="customize-color-palette"></a>
...
<a name="theme-important-considerations"></a>

1. Test thoroughly to ensure the desired appearance, as well as accessibility (for example, sufficient contrast).

1. If a style element is inconsistent with your workspace configuration, check for component-level configurations in its view. Component styling takes precedence over workspace styling. (View styling is only considered in the absence of workspace or component styling).
