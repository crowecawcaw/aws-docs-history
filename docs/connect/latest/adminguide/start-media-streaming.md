# Flow block in Connect Customer: Start media streaming
...
**Start media streaming** block. It has two options: start the
stream from the customer or to the customer.

![The properties page of the Start media streaming block.](images/start-media-streaming.png)
...
![A configured Start media streaming block.](images/start-media-streaming-configured.png)
