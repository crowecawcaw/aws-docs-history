...
+ Agents might take contacts from the Tier 4 Support queue when:
  ...
  **Priority takes precedence**. (You might think that agents take contacts from Tier 4 Support when contacts are in Tier 1 Support, Tier 2 Support, or Tier 3 Support and waiting 80 seconds or longer, but that's not right.) 
