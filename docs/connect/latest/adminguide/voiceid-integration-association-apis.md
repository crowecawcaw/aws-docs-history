...
1. [CreateIntegrationAssociation](../APIReference/API_CreateIntegrationAssociation.md "../APIReference/API_CreateIntegrationAssociation.md"): To enable Voice ID on an Connect Customer
   ...
   only associate one Voice ID domain to an Connect Customer instance. If the instance is
...
When you enable Voice ID for an Connect Customer instance (by using either the
...
between an Connect Customer instance and a Voice ID domain, you will need to call the
