...
For outbound voice calls within Connect Customer, an [outbound whisper flow](create-contact-flow.md#contact-flow-types) usually specifies the whisper to be played to customer. However, in this case you need to configure an [outbound whisper flow](create-contact-flow.md#contact-flow-types) to do the following:
