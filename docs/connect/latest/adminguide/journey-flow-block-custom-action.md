...
at your Amazon Connect instance at AWS admin console. For more information, see [Invoke Lambda functions](lambda-invoke-functions.md "lambda-invoke-functions.md").
