...
To pass a customer display name, implement your callback function in the snippet. Connect Customer retrieves the display name automatically.

1. Complete the steps in [Add a chat user interface to your website hosted by Connect Customer](add-chat-to-website.md), if you haven't already.
