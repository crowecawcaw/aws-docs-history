...
**Set logging behavior** block. It has two options: enable
logging behavior, or disable it.

![The properties page of the Set logging behavior block.](images/set-logging-behavior-properties.png)
