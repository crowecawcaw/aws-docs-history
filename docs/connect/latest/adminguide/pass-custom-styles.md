...
widget. Connect Customer retrieves the custom styles automatically. All of the
...
| `composer.textColor`                    | Color of the text in the composer.                                                               | Any CSS legal color value. For more information about valid<br>CSS color values, see [CSS Legal Color Values](https://www.w3schools.com/cssref/css_colors_legal.php "https://www.w3schools.com/cssref/css_colors_legal.php") on the W3Schools<br>website.                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `composer.focusBorderColor`             | Border color for the composer when it has keyboard<br>focus.                                     | Any CSS legal color value. Use a color that is visually<br>distinct from `composer.borderColor` so that the<br>focus indicator remains visible.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `composer.placeholderColor`             | Color of the placeholder text displayed in the composer<br>when the field is empty.              | Any CSS legal color value.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
To override the System/Bot display name and logo configurations set in the Connect Customer admin website,
