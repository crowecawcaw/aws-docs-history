...
**Note**  
To update the **Description** field, you must use the Connect Customer console.
...
1. Perform the following steps to associate flows to phone numbers. Do them in both Regions where the traffic distribution group operates. 
   ...
   1. In your existing Connect Customer instance in the Region where the traffic distribution group was created, do the following steps:
   ...
   1. In the replicated Connect Customer instance in the other AWS Region, do the following steps:
