...
**Distribute by percentage** block. It is configured to route
50% of contacts to the test branch.

![The properties page of the Distribute by percentage block.](images/distribute-by-percentage-properties.png)

## How it works

This block creates static allocation rules based on how you configure it. Internal
logic generates a random number between 1-100. This number identifies which branch
to take. It doesn't use current or historical volume as part of it's logic.
...
configured. It shows two branches: **50% test** and
**50% default**.

![A configured distribute by percentage block.](images/distribute-by-percentage-configured.png)
