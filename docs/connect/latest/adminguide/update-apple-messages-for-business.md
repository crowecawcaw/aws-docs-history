# Update an Apple Messages for Business integration with Connect Customer
...
Body:
   ...
   Connect Customer Instance ARN (required): `enter your current instance ARN` change to `new instance ARN`
   Connect Customer Flow ID (required): `enter your current flow ID` change to `new flow ID`

```

###### Note

If you update your Connect Customer Instance ARN, you must also update your contact
...
![The contact options page.](images/abc-contact-support-options.png) 4. Choose **Submit**. 5. Support will work directly with the Connect Customer team on your request and follow up
