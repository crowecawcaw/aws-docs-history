...
also known as skills-based routing.

For example, an airline might have some agents who handle reservations for
English-speaking customers, others who handle Spanish-speaking customers, and a third
group that handles both types of customers, but only over the phone.
...
![A graphic of four routing profiles.](images/routing-profile-example2.png)
For an overview of the steps to set up queue-based routing, see [Set up queue-based
