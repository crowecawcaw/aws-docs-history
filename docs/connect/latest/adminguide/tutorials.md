# Tutorials: An introduction to Connect Customer

The tutorials in this section are provided to help you start using Connect Customer. They show you
...
![A page in the Connect Customer documentation, the PDF link under the title of the page.](images/tutorial1-print.png)
...
- [Set up your Connect Customer instance](tutorial1-set-up-your-instance.md "tutorial1-set-up-your-instance.md")
- [Test the sample voice and chat experience in Connect Customer](tutorial1-explore-voice-and-chat.md "tutorial1-explore-voice-and-chat.md")
