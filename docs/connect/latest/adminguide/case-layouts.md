...
elements for a case, such as:

- Which fields to display.
- The section, either Top panel or More information.
- The order within a section to display these fields
  Whereas it's the case template that mandates a particular schema, such as required
  case fields.
...
You can create a case template and not link it to a case layout. Any case created
with a case template that is not linked to a case layout will display system fields
in a default order.
