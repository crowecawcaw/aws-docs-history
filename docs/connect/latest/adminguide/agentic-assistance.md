...
actions and look up information automatically, all in the spirit of helping customer
service representatives deliver better customer outcomes. Connect agentic assistance
includes AI agents for all channels, with some agents specific to tasks and email
interactions. The service also provides automatic case summarization support to help
