...
The string field limits (for example, title, subtitle, etc.) are expected to be
...
| actionDetail       | No               |          |                    | Only required for action button feature. Must be<br>"PREVIOUS_OPTIONS" or "SHOW_MORE".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
carousel by using the SHOW_MORE feature.
...
|                     | **merchantCapabilities**          | Yes      |                    |                    | An array of payment capabilities supported by the merchant. The<br>array must include supports3DS, and may optionally include<br>supportsCredit, supportsDebit, and supportsEMV.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
