...
sample data is for view purposes only. It appears only in the Connect Customer UI
builder.

For example, the following image shows an example of a **Mailing address
form**.

![The DefaultValue and Sample data sections of the Customize panel.](images/no-code-ui-builder-sample-data-example.png)
...
- The value `7 W 34th St` is for display purposes only in the
  Connect Customer admin website. It does not appear to the agent.
