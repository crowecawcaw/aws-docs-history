...
| RECORDING_SAMPLE_RATE_NOT_SUPPORTED | The sample rate of the audio file is not supported.<br>Contact Lens currently supports audio files<br>with an 8kHz sample rate. That is the sample rate for<br>Connect Customer recordings. |
