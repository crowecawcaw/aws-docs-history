...
If you place the **End flow / Resume** block in an inbound
flow or disconnect flow, it functions identically to the
**Disconnect** block, and terminates the contact.
...
**End flow / Resume** block.

![The properties page of the End flow Resume block.](images/end-flow-properties.png)

## Configured block

The following image shows an example of what this block looks like when it is
configured. It does not have any The End flow / Resume termination event
branches.

![The properties page of the End flow Resume block.](images/end-flow-configured.png)
