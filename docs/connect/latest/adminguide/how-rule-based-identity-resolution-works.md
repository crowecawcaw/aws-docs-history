...
+ **By default, the default rule will be applied if no custom rule specified.**
  + Connect Customer Customer Profiles provides a default matching rule if you do not provide a custom matching rule. You can check the custom matching rule here.
