...
![The Agent queues option in the New table dropdown list.](images/rtm-agent-queues.png)
...
![The Agent queues table, the settings icon.](images/agent-settings2.png) 2. Choose the **Metrics** tab. 3. Scroll to the **Performance** section and choose
**In queue** and **Queued**,
and then **Apply**, as shown in the following
table.

![Queued and In queue options on the table settings page.](images/rtm-metrics-in-queue.png)
