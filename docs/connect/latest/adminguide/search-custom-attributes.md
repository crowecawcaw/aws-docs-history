...
**Topics**
+ [Required permissions to configure searchable contact attributes](#permissions-search-custom-attributes)
+ [Configure searchable custom contact attributes](#configure-search-custom-attributes)
+ [Edit, add, or remove contact attributes](#edit-add-remove-attribute-keys)
+ [Filter contact search results on contact attributes](#howto-search-for-custom-attributes)
+ [Filter contact search results on contact segment attributes](#filter-contact-search-segment)
...
1. On the **Searchable customer contact attributes** page, in the **Attribute key** box, enter the attribute key, and choose **\+Add key** and then choose **Save**.
