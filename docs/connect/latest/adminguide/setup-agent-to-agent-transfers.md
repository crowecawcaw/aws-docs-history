...
![The properties page for the Set working queue block.](https://docs.aws.amazon.com/connect/latest/adminguide/images/set-working-queue-properties-agent-to-agent-transfer.png)
...
![The transfer to queue block on the flow designer.](https://docs.aws.amazon.com/connect/latest/adminguide/images/agent-to-agent-transfer.png)
