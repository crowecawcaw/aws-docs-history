...
| Initiation Method                                                                        | Indicates how the contact was initiated. (Only supported for Agent Connecting Time)                                                                                                                                                                                                 | Example: INBOUND, OUTBOUND, TRANSFER, QUEUE_TRANSFER, CALLBACK, API, etc.<br>Please refer to the InitiationMethod section of [ContactTraceRecord](ctr-data-model.md#ctr-ContactTraceRecord "ctr-data-model.md#ctr-ContactTraceRecord") in the Amazon Connect Administrator Guide for more filter values.       |
...
| ROUTING_PROFILE                                      | Routing profile             | Valid input is Routing Profile ARNs. Please read below docs for<br>more details:<br>• [How Amazon Connect uses routing profiles](concepts-routing.md "concepts-routing.md")<br>• [Contact Trace Record Data Model](ctr-data-model.md#ctr-Agent "ctr-data-model.md#ctr-Agent")                                                                                                                                                                                                                                                                                             |
