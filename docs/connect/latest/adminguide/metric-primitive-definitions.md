...
| --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Contact                                                                                 | Initiation method                                                                                                                                                                                                                                                                   | Indicates how the contact was initiated.                                                                                                                                                                                                                                                                       | Example: INBOUND, OUTBOUND, TRANSFER, QUEUE\_TRANSFER, CALLBACK, API, etc.<br>Please refer to the InitiationMethod section of ContactTraceRecord in the Amazon Connect Administrator Guide for more filter values.                                                                               |
| Disconnect reason                                                                       | Indicates how the contact was terminated.                                                                                                                                                                                                                                           | A few examples of filter values are AGENT\_DISCONNECT, CUSTOMER\_DISCONNECT, TRANSFER, THIRD\_PARTY\_DISCONNECT, BARGED, CONTACT\_FLOW\_DISCONNECT, etc.<br>Please refer to ContactTraceRecord in the Amazon Connect Administrator Guide for more filter values.                                               |
...
| Initiation Method                                                                       | Indicates how the contact was initiated. (Only supported for Agent Connecting Time)                                                                                                                                                                                                 | Example: INBOUND, OUTBOUND, TRANSFER, QUEUE\_TRANSFER, CALLBACK, API, etc.<br>Please refer to the InitiationMethod section of [ContactTraceRecord](ctr-data-model.md#ctr-ContactTraceRecord "ctr-data-model.md#ctr-ContactTraceRecord") in the Amazon Connect Administrator Guide for more filter values.      |
...
| Initiation Method                                                                       | Indicates how the contact was initiated. (Only supported for Contacts active)                                                                                                                                                                                                       | Example: Inbound, Outbound, Transfer, Callback, Api, Webrtc Api, Queue Transfer, Monitor, Disconnect, External Outbound, Agent Reply, Flow, Campaign Preview.<br>Refer to [Contact object](agent-event-stream-model.md#Contact "agent-event-stream-model.md#Contact") for the allowed values.                  |
| contactStatus (Represented as Agent Contact State in the custom metric builder)         | Contact states are events that appear in the lifecycle of a contact. You can locate them in two places: the real-time metrics reports and the agent event stream. (Only supported for Agents online)                                                                                | Example: Incoming, Pending, Connected, etc.<br>Please refer to<br>[Contact states in the agent event stream](about-contact-states.md "about-contact-states.md")<br>in the Amazon Connect Administrator Guide for more filter values.                                                                           |
...
| FLOWS\_RESOURCE\_TYPE                                | Only available via API                 |
| RESOURCE\_PUBLISHED\_TIMESTAMP                       | Only available via API                 |
| FLOWS\_NEXT\_RESOURCE\_ID                            | Only available via API                 |
| FLOWS\_NEXT\_RESOURCE\_TYPE                          | Only available via API                 |
| FLOWS\_OUTCOME\_TYPE                                 | Only available via API                 |
| FLOWS\_NEXT\_RESOURCE\_QUEUE\_ID                     | Only available via API                 |
| Bot                                                  | CHANNEL                                | Channel                         |
| FLOWS\_RESOURCE\_ID                                  | Flow                                   |
| FLOWS\_MODULE\_RESOURCE\_ID                          | Flow module                            |
| BOT\_ID                                              | Bot                                    |
...
| FLOW\_ACTION\_ID                                     | Only available via API                 |
| INVOKING\_RESOURCE\_PUBLISHED\_TIMESTAMP             | Only available via API                 |
| PARENT\_FLOWS\_RESOURCE\_ID                          | Only available via API                 |
| INVOKING\_RESOURCE\_TYPE                             | Only available via API                 |
...
| AGENT\_HIERARCHY\_LEVEL\_FIVE                        | Agent hierarchy level five             | Valid input to this filter, is an Agent Hierarchy Level<br>ARN.<br>Read more about [Agent Hierarchy Level](agent-hierarchy.md#new-agent-hierarchy "agent-hierarchy.md#new-agent-hierarchy").                                                                                                                                                                                                                                                                                                                                                                              |
| AGENT\_HIERARCHY\_LEVEL\_FOUR                        | Agent hierarchy level four             |
| AGENT\_HIERARCHY\_LEVEL\_THREE                       | Agent hierarchy level three            |
| AGENT\_HIERARCHY\_LEVEL\_TWO                         | Agent hierarchy level two              |
| AGENT\_HIERARCHY\_LEVEL\_ONE                         | Agent hierarchy level one              |
...
| RoutingStepExpressions                               | Routing step expression                | Accepts a filter value up to 3,000 characters in length. Filter values are case-sensitive. JSON object key order and whitespace may be arbitrary; array order and tree structure must be preserved.<br>Please read the below references for more info:<br>• [Routing step expression guide](../APIReference/API_Expression.md "../APIReference/API_Expression.md")<br>• [Routing step expression examples](../APIReference/API_GetCurrentMetricData.md#API_GetCurrentMetricData_Examples "../APIReference/API_GetCurrentMetricData.md#API_GetCurrentMetricData_Examples") |
...
| FLOWS\_RESOURCE\_TYPE                                | Only available via API                 | Valid values: Flow, Module                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| RESOURCE\_PUBLISHED\_TIMESTAMP                       | Only available via API                 | Timestamp when the flow resource was published.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| FLOWS\_NEXT\_RESOURCE\_ID                            | Only available via API                 | ARN of the next resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| FLOWS\_NEXT\_RESOURCE\_TYPE                          | Only available via API                 | Type of resource the flow transitioned to.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| FLOWS\_OUTCOME\_TYPE                                 | Only available via API                 | Indicates the terminal outcome of the flow.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| FLOWS\_NEXT\_RESOURCE\_QUEUE\_ID                     | Only available via API                 | ARN of the next queue resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| FLOW\_ACTION\_ID                                     | Only available via API                 | Flow action identifier that invoked the bot.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| PARENT\_FLOWS\_RESOURCE\_ID                          | Only available via API                 | ARN of the parent flow resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| INVOKING\_RESOURCE\_TYPE                             | Only available via API                 | Valid values: Flow, Module                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| INVOKING\_RESOURCE\_PUBLISHED\_TIMESTAMP             | Only available via API                 | Timestamp when the invoking resource was published.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- **Component identifiers** (e.g., Metric\_1,
  Metric\_2)
