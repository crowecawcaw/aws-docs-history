...
Check  
This block is optional and is used to validate metadata such as user defined attributes, system attributes, and segment attributes. You can validate more than one attribute in the check block.   
![The Check block in the test simulation configuration.](https://docs.aws.amazon.com/connect/latest/adminguide/images/test-check-block.png)
...
![The Actions block in the test simulation configuration.](https://docs.aws.amazon.com/connect/latest/adminguide/images/test-action-block.png)