...
![The Observe block in the test simulation configuration.](http://docs.aws.amazon.com/connect/latest/adminguide/images/test-observe-block.png)
...
![The Check block in the test simulation configuration.](http://docs.aws.amazon.com/connect/latest/adminguide/images/test-check-block.png)
