...
- **Agentic self-service (recommended)** –
  ...
  tools, and maintain a continuous conversation until the issue is resolved or
  escalation is needed.
- **Legacy self-service** – Uses AI agents
  that can answer customer questions using a configured knowledge base and select
  custom tools that return control to the contact flow for additional routing.
  This approach is not receiving new feature updates. We recommend using agentic
  self-service for new implementations.

###### Contents

- [Use agentic self-service](agentic-self-service.md "agentic-self-service.md")
- [(legacy) Use generative
