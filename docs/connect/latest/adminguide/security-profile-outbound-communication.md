...
![The CCP security profile permissions page, the make outbound calls permission.](https://docs.aws.amazon.com/connect/latest/adminguide/images/SecurityProfile_cloudscape_outbound_calls.png)
