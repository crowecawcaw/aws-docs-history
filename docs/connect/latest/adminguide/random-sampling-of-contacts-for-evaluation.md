...
![Save filters and sampling criteria.](images/evaluationforms-randomsampling-save-search-banner.png) 7. After the sample is generated, you can create draft evaluations in bulk across all the contacts.
