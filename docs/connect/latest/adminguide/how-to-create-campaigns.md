...
- [Visual Journey Builder](create-a-multi-step-and-multi-channel-journey.md "create-a-multi-step-and-multi-channel-journey.md")—Design multi-channel,
  multi-step campaigns using an intuitive drag-and-drop canvas. Ideal for complex journeys
  that span multiple channels and include branching logic.
