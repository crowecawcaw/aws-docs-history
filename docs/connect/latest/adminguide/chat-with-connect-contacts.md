...
When you set your status in the CCP to **Available**, Connect Customer delivers calls or chats to you, based on the settings in your [routing profile](routing-profiles.md). An administrator can specify that up to 10 chat conversations can be routed to you at the same time. 
...
![A browser notification of incoming chat.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chat-notify.png)

1. If you're on the chat tab, the page displays the name of the contact and a button for you to connect to the chat.  
![The CCP, the incoming chat notification, the accept chat button.](https://docs.aws.amazon.com/connect/latest/adminguide/images/incoming-chat-ccp.png)

1. If you're on the phone tab, a banner displays the name of the contact and a button for you to connect to the chat.  
![The CCP, a banner displays incoming chat.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chat-incoming-banner.png)
...
![The CCP, the missed chat tab.](https://docs.aws.amazon.com/connect/latest/adminguide/images/missed-chat-tab.png)
...
![The CCP, a connect chat, the transcript between customer and bot.](https://docs.aws.amazon.com/connect/latest/adminguide/images/ccp-chat-agent.png)
...
![The CCP, the timers at top of chat tabs.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chat-timers.png)
...
![The CCP, the hour glass icon.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chat-acw.png)
...
![The CCP, a missed chat, the name of the agent who is logged in.](https://docs.aws.amazon.com/connect/latest/adminguide/images/missed-chat-name.png)
...
![The CCP, the formatting toolbar at the bottom of the chat window.](https://docs.aws.amazon.com/connect/latest/adminguide/images/chat-rich-messaging-toolbar.png)
