...
You can search cases using a keyword match. Connect Customer searches data across all system and custom fields. The results are sorted from most-recently to least-recently updated case.
