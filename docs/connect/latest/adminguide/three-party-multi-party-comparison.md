...
- All agents have exactly the same capabilities as any other agent on the call.
  This takes effect the moment an agent accepts the invitation to join the
  call.
...
when an agent performs a series of consults followed by a transfer.
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Agent can control hold, resume, and disconnect only the parties<br>they add.                                                                               | All agents have the same call control capabilities.                                                                                                                                                                                                                                       |
...
| Not applicable.                                                                                                                                            | When a party is being dialed, an agent on a multi-party call<br>cannot add another party until the prior dial operation is completed<br>(party added or call leg terminated).                                                                                                             |
