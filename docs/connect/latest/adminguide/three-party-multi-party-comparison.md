...
For information about new functionality in the existing Connection and Contact API in Connect Customer Streams, see the [Connect Customer Streams Readme](https://github.com/amazon-connect/amazon-connect-streams/blob/master/README.md). 
...
| Primary agent can only mute themselves.<br />Secondary agent can only mute themselves. | Any agent on the call can mute any other participant on the call. | 
