...
function with a collection of optional parameters. This AWS Lambda
function is also given a copy of the flow run data if there is an associated contact
with the flow.
...
attributes are available dynamically under the $.External path.
...
[AWS Lambda function](../adminguide/invoke-lambda-function-block.md "../adminguide/invoke-lambda-function-block.md")
