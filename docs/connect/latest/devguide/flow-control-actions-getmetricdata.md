...
# GetMetricData
<a name="flow-control-actions-getmetricdata"></a>
...
## Parameter object
<a name="getmetricdata-parameter"></a>
...
<a name="getmetricdata-results"></a>

None. No conditions are supported.

## Errors
<a name="getmetricdata-errors"></a>
+ NoMatchingError - if no other Error matches.

## Restrictions
<a name="getmetricdata-restrictions"></a>

This action is available in every type of flow. 

## Corresponding block in the UI
<a name="getmetricdata-ui"></a>
