...
<a name="contact-actions-transfercontacttoagent"></a>
...
## Parameter object
<a name="transfercontacttoagent-parameter"></a>

No parameters are expected.

## Results and conditions
<a name="transfercontacttoagent-results"></a>

None.

## Errors
<a name="transfercontacttoagent-errors"></a>

None.

## Restrictions
<a name="transfercontacttoagent-restrictions"></a>

This action is supported in only transfer to agent and transfer to queue flows. 

## Corresponding block in the UI
<a name="transfercontacttoagent-ui"></a>
