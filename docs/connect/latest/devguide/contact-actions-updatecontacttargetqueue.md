...
Sets the contact's TargetQueue. This is the queue is used by all other instructions
that check a queue implicitly, and for TransferContactToQueue.
...
This action is supported only in inbound contact flows and transfer flows. It is
not supported in whisper flows, hold flows, or customer queue flows.

## Corresponding block in the UI

[Set working queue](../adminguide/set-working-queue.md "../adminguide/set-working-queue.md")
