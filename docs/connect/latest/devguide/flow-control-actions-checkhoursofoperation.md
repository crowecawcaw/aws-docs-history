...
<a name="flow-control-actions-checkhoursofoperation"></a>
...
## Parameter object
<a name="checkhoursofoperation-parameter"></a>
...
<a name="checkhoursofoperation-results"></a>
...
## Errors
<a name="checkhoursofoperation-errors"></a>
+ NoMatchingError - if no other Error matches.

## Restrictions
<a name="checkhoursofoperation-restrictions"></a>
...
<a name="checkhoursofoperation-ui"></a>
