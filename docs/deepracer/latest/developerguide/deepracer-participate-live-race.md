...
![Find your race card and select go to live race.](images/deepracer-go-to-live-race.png) 3. On the **Race** page, select **Enter race**. 4. On the **Enter race** page, under **Choose model**, select the
model you want to submit from the drop down menu and choose **Enter race**.

![Find your race card and select go to LIVE race.](images/deepracer-live-enter-race.png) 5. On the **Race** page, choose **Go to LIVE race**. 6. On the **LIVE race** page, you'll see a wait message. Navigate to the conference
bridge provided to you by your race organizer.

![If you see a wait message, the race will start soon.](images/deepracer-live-race-wait-message.png) 7. Check in with your race organizer, who will review the race rules and answer racer questions. 8. Check the **COMING UP** section under **LEADERBOARD** for your
...
![The track map overlay is divided into three sectors that change color depending on a racer’s pace. Green indicates the section of the tack where a racer clocked a personal best, yellow denotes the slowest sector driven, and purple signifies a session best.](images/live-race-track-map-overlay.png) 12. The race ends when you see the checkered flag icon in the console. The Speed control is disabled
