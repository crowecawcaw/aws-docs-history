...
![Image: AWS DeepRacer reward function input parameter of all_wheels_on_track = True.](images/deepracer-reward-function-input-all_wheels_on_track-true.png)

The following illustration shows that the agent is off-track.

![Image: AWS DeepRacer reward function input parameter of all_wheels_on_track = False.](images/deepracer-reward-function-input-all_wheels_on_track-false.png)
...
![Image: AWS DeepRacer reward function input parameter of distance_from_center.](images/deepracer-reward-function-input-distance_from_center.png)
...
Heading direction, in degrees, of the agent with respect to the x-axis of the
coordinate system.

![Image: AWS DeepRacer reward function input parameter of heading.](images/deepracer-reward-function-input-heading.png)
...
A Boolean flag to indicate whether the agent has off track (True) or not (False)
...
A Boolean flag to indicate if the agent is driving on clock-wise (True) or counter
clock-wise (False).
...
A list of the distances between objects in the environment in relation to the
...
object behind the vehicle, use the "closest_objects" parameter.
...
element measures the heading of the ith object. For
stationary objects, their headings are 0. For a bot
vehicle, the corresponding element's value is the
...
List of all object locations, each location is a tuple of ([x, y](#reward-function-input-x_y "#reward-function-input-x_y")).

The size of the list equals the number of objects on the track. Note the object
could be the stationary obstacles, moving bot
vehicles.
...
List of speeds (meters per second) for the objects on the track. For stationary
...
![Image: AWS DeepRacer reward function input parameter of speed.](images/deepracer-reward-function-input-speed.png)
...
The
agent center line is not necessarily parallel with the track center line as is shown
in the following illustration.

![Image: AWS DeepRacer reward function input parameter of steering_angle.](images/deepracer-reward-function-steering.png)
...
Number of steps completed. A step corresponds to an action taken by the agent
...
![Image: AWS DeepRacer reward function input parameter of track_width.](images/deepracer-reward-function-input-track_width.png)
...
Location, in meters, of the agent center along the x and y axes, of the simulated
environment containing the track. The origin is at the lower-left corner of the
simulated environment.

![Image: AWS DeepRacer reward function input parameters of x,y.](images/deepracer-reward-function-input-x-y.png)
...
![Image: AWS DeepRacer reward function input parameter of waypoints.](images/deepracer-reward-function-input-waypoints.png)
