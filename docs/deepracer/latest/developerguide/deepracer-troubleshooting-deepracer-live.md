...
![Choose the Launch simulator button.](images/deepracer-remove-model-live-race-queue.png)
...
![Choose the Launch simulator button.](images/deepracer-live-launch-simulator.png)
