...
![Image: Enter a Classic community race from the console.](images/enter-community-race-classic.png) 3. On the **Enter race** page, under **Choose model**,
choose a trained model and then choose **Enter race**.

![Image: Submit a model to a AWS DeepRacer community race from the console.](images/choose-a-model-enter-classic-race.png) 4. If your model is evaluated successfully against the racing criteria, watch the event's
...
![Image: Submit a model to a AWS DeepRacer community race from the console.](images/deepracer-community-race-success-classic.png) 6. Choose **Race again** to enter another model. You can submit
...
![Image: Enter a LIVE community race from the console.](images/enter-community-race-live.png) 3. On the **Enter race** page, under **Choose model**,
choose a trained model and then choose **Enter race**.

![Image: Submit a model to a AWS DeepRacer community race from the console.](images/choose-a-model-enter-race.png) 4. If your model is evaluated successfully against the racing criteria, watch the event's
