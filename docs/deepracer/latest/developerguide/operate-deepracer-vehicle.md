...
After you finish training and evaluating an AWS DeepRacer model in the AWS DeepRacer simulator, you can
deploy the model to your AWS DeepRacer vehicle. You can set the vehicle to drive on a track and
evaluate the model's performance in a physical environment. This mimics a real-world
autonomous race.

Before driving your vehicle for the first time, you must set up the vehicle, install
...
- [Inspect and manage your AWS DeepRacer vehicle settings](deepracer-manage-vehicle-settings.md "deepracer-manage-vehicle-settings.md")
- [View your AWS DeepRacer vehicle logs](deepracer-drive-vehicle-logs.md "deepracer-drive-vehicle-logs.md")
