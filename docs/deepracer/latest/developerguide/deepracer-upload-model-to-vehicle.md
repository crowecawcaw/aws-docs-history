...
To upload a model, you must have [trained and evaluated the model](deepracer-console-train-evaluate-models.md "deepracer-console-train-evaluate-models.md"). You can train the model using the AWS DeepRacer console.
...
![Image: Upload models](images/deepracer-device-choose-models.png) 2. On the **Models** page, choose **Upload** above the
**Models** list. 3. From the file picker, navigate to the drive or share where you've downloaded your model artifacts
