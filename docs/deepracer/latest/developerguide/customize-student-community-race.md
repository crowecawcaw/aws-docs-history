...
![The "Leaderboard" button is circled on an image of a Student Community Race card.](images/deepracer-student-community-leaderboard.png) 4. On the **Race details** page, choose **Edit race**.

![Image showing the "Edit race" button circled on the Race details page.](images/deepracer-student-community-edit-race.png) 5. Expand **Race customizations**.

![Expand the "Race customizations" section by selecting an arrow.](images/deepracer-student-community-customizations.png) 6. Optionally, write a description for your race that summarizes the goals and rules of the event for
