...
![Image: Unplug the USB-C cable from the vehicle's compute power port.](images/deepracer-troubleshooting-unplug-cable-from-compute-power-port.png) 2. Attach the AC power cord and the USB-C cable to the computer module power adapter (A). Plug the power cord
to a power outlet (C) and plug the USB-C cable the vehicle's computer module power port (B).

![Image: Connect power cord to the vehicle and a power outlet](images/deepracer-troubleshooting-connect-power-cord-to-vehicle-and-outlet.png)
