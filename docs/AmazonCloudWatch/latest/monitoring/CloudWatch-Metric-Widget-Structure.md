...
Math](using-metric-math.md "using-metric-math.md") in the Amazon CloudWatch User Guide.
...
information about the format, see
[Options Object Format](#CloudWatch-Metric-Widget-Options-Object-Format "#CloudWatch-Metric-Widget-Options-Object-Format").
...
see [Metric Math Syntax and Functions](using-metric-math.md#metric-math-syntax "using-metric-math.md#metric-math-syntax")
