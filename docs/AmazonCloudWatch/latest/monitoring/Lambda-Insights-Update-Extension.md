# Update the Lambda Insights extension version
...
## Use the Lambda console to update the Lambda Insights extension
...
## Use the AWS CLI to update the Lambda Insights extension
...
## Use the AWS SAM CLI to update the Lambda Insights extension
...
## Use the AWS CDK to update the Lambda Insights extension
...
## Use Serverless Framework to update the Lambda Insights extension
...
To update Lambda Insights on a Lambda container image, follow the steps in [Enable Lambda Insights on a Lambda container image
deployment](Lambda-Insights-Getting-Started-docker.md "Lambda-Insights-Getting-Started-docker.md") to rebuild the image with
