...
The _Agent view_ provides a curated dashboard for your
...
about agent spans, see [Spans](../../../bedrock-agentcore/latest/devguide/observability-telemetry.md#agent_spans "../../../bedrock-agentcore/latest/devguide/observability-telemetry.md#agent_spans").
...
AgentCore Runtime](../../../bedrock-agentcore/latest/devguide/agents-runtime-create.md "../../../bedrock-agentcore/latest/devguide/agents-runtime-create.md") .
...
- Runtime errors – The number of system and user errors. For system
  and user error definitions, see [AgentCore provided runtime metrics](../../../bedrock-agentcore/latest/devguide/observability-runtime-metrics.md "../../../bedrock-agentcore/latest/devguide/observability-runtime-metrics.md")
