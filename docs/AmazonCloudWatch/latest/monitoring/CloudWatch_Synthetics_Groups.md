...
more information about these Regions, see [Enabling a Region](../../../general/latest/gr/rande-manage.md#rande-manage-enable "../../../general/latest/gr/rande-manage.md#rande-manage-enable") .
...
You can repeat this step to associate as many as 10 canaries with the group. 6. (Optional) Under **Tags**, add one or more key-value pairs as tags
for this group. Tags can help you identify and organize your AWS resources and track
your AWS costs. For more information, see [Tagging your Amazon CloudWatch resources](CloudWatch-Tagging.md "CloudWatch-Tagging.md"). 7. Choose **Create Group**.
