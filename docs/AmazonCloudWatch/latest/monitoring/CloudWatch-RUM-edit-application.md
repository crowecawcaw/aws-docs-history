...
updated code snippet into your application. 6. After the code snippet is created, choose **Copy to
clipboard** or **Download**, and then
choose **Done**.

To start monitoring with the new settings, you insert the code snippet
