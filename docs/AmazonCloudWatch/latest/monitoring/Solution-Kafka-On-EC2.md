...
1. In the **Metrics** section, for **Number of metrics**, enter **broker\_metrics\_count \+ producer\_metrics\_count \+ consumer\_metrics\_count**. Calculate these as follows:
...
1. Open the CloudWatch Console **Create Dashboard** using this link: [ https://console.aws.amazon.com/cloudwatch/home?\#dashboards?dashboardTemplate=ApacheKafkaOnEc2&referrer=os-catalog ](https://console.aws.amazon.com/cloudwatch/home?#dashboards?dashboardTemplate=ApacheKafkaOnEc2&referrer=os-catalog). 
