...
5. Under **Logs Query**:
   ...
   1. For **Log groups**, choose one or more log groups to
      query.
   2. In the query editor, enter your Logs Insights query. Choose
      **Preview results** to verify correct lines are getting
      considered.
   ...
   4. For **Schedule**, choose how often the query runs (for
