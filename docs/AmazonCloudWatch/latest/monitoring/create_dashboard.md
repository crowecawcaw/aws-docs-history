...
3. In the **Create new dashboard** dialog box, 
 ...
 For more information, 
 see [Getting started with CloudWatch automatic dashboards](GettingStarted.md "GettingStarted.md").
 ...
 of the following:
	...
	* To add a graph to the dashboard, choose **Line** or
	 ...
	 **Configure**. In the **Add metric
	 ...
	 you can add it manually. For more information, see [Graph metrics manually on a CloudWatch dashboard](add_old_metrics_to_graph.md "add_old_metrics_to_graph.md").
	...
	* To add a text block to the dashboard, choose
	 ...
	 **Configure**. In the **New text
	 ...
	 format your text using [Markdown](https://docs.aws.amazon.com/general/latest/gr/aws-markdown.html "https://docs.aws.amazon.com/general/latest/gr/aws-markdown.html"), and then choose **Create
	 widget**.
