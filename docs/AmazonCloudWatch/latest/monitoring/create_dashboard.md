...
For more information,
see [Getting started with CloudWatch automatic dashboards](GettingStarted.md "GettingStarted.md"). 4. In the **Add to this dashboard** dialog box,
do one
of the following:
    ...
    * To add a text block to the dashboard, choose
     ...
     **Configure**. In the **New text
     ...
     format your text using [Markdown](../../../general/latest/gr/aws-markdown.md "../../../general/latest/gr/aws-markdown.md"), and then choose **Create
     widget**.
