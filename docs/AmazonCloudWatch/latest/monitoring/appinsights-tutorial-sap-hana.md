...
* [Set up
 monitoring](#appinsights-tutorial-sap-hana-set-up "#appinsights-tutorial-sap-hana-set-up")
* [Manage
...
For more information, see the [installation example](#install "#install"). 
...
* **AWS Systems Manager enablement** – Install
 ...
 Agent](https://docs.aws.amazon.com/systems-manager/latest/userguide/ssm-agent.html "https://docs.aws.amazon.com/systems-manager/latest/userguide/ssm-agent.html") in the *AWS Systems Manager User Guide*.
* **Amazon EC2 instance roles** – You must
 attach the following Amazon EC2 instance roles to configure your database.
	...
	+ You must attach the `CloudWatchAgentServerPolicy` to
	 ...
	 agent](create-iam-roles-for-cloudwatch-agent.md "create-iam-roles-for-cloudwatch-agent.md").
	+ You must attach the following IAM inline policy to the Amazon EC2
	 ...
	 information about inline policies, see [Inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html "https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_managed-vs-inline.html")  in the *AWS Identity and Access Management User
	 Guide*.
...
* **IAM permissions** – For non-admin
 users:
	...
	+ The user must have permission to create a secret in AWS Secrets Manager to
	 ...
	 [Example: Permission to create secrets](https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html#auth-and-access_examples_create "https://docs.aws.amazon.com/secretsmanager/latest/userguide/auth-and-access_examples.html#auth-and-access_examples_create").
 ...
 **Resource group** dropdown. For more information about
 creating resource groups, see the [*AWS Resource Groups
 User Guide.*](https://docs.aws.amazon.com/ARG/latest/userguide/resource-groups.html "https://docs.aws.amazon.com/ARG/latest/userguide/resource-groups.html")
5. Under **Monitor CloudWatch Events**, select the check box to
...
6. Under **Integrate with AWS Systems Manager OpsCenter**, select the
...
7. You can optionally enter tags to help you identify and organize your
 ...
 information, see [Tag Editor](https://docs.aws.amazon.com/ARG/latest/userguide/tag-editor.html "https://docs.aws.amazon.com/ARG/latest/userguide/tag-editor.html") in the
...
9. On the **Review detected components** page, the monitored
 ...
 listed.
	...
	![The review components for monitoring page of the CloudWatch Application Insights console: select component to edit.](images/appinsights-multiapp-hana-review.png)
	2. To add a new workload, choose **Add new workload**.
	
	
	
	![The edit component section of the CloudWatch Application Insights console: choose lower left button to add workload.](images/appinsights-multiapp-hana-edit.png)
...
![Memory allocation exceeded.](images/appinsights-memory-allocation-1.png)
...
![Log group showing out of memory.](images/appinsights-memory-allocation-2.png)
...
![Log group showing out of memory.](images/appinsights-disk-full-1.png)
...
![Log group showing out of memory.](images/appinsights-disk-full-2.png)
...
3. To check for errors in the exporter manager service logs, run the following command replacing `WORKLOAD_SHORT_NAME` with the short name you found in [Step 2](#step-find-short-name "#step-find-short-name").
...
**Resolution** – Install Python using SUSE Linux commands as shown in the following example. The following example installs the latest version of [Python 3.8](https://www.python.org/downloads/ "https://www.python.org/downloads/").
