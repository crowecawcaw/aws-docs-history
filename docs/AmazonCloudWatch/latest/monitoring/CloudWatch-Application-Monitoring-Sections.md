...
+ [Monitor service events](CloudWatch-Application-Signals-ServiceEvents.md)
+ [Debug applications with Dynamic Instrumentation](CloudWatch-Application-Signals-DynamicInstrumentation.md)
