...
**Correlated traces** table to open the [X-Ray trace details](../../../xray/latest/devguide/xray-console-traces.md "../../../xray/latest/devguide/xray-console-traces.md") page
...
- An [auto scaling group](../../../autoscaling/ec2/userguide/auto-scaling-groups.md "../../../autoscaling/ec2/userguide/auto-scaling-groups.md")
...
in [Log Insights](../logs/AnalyzingLogData.md "../logs/AnalyzingLogData.md"). View infrastructure performance metrics by specific groups such
...
log groups and log streams](../logs/Working-with-log-groups-and-streams.md "../logs/Working-with-log-groups-and-streams.md").
