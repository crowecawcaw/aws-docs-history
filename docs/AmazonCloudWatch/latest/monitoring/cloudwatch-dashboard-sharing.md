...
<a name="share-cloudwatch-dashboard-promql"></a>

When you share a dashboard, widgets that use PromQL (Prometheus Query Language) queries are not visible by default to people with whom you share the dashboard. If you want these people to see PromQL widgets, you must add permissions to the IAM role for dashboard sharing.
...
1. Choose **Edit policy** and add the following statement.
