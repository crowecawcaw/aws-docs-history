...
| ASP.NET Applications Errors Unhandled During<br>Execution/Sec    | ASP.NET Applications            |
...
| DirectoryServices DRA Pending Replication<br>Synchronizations    | DirectoryServices               |
...
| SharePoint Disk-Based Cache Total number of cache<br>compactions | SharePoint Disk-Based Cache     |
| SharePoint Foundation Executing Time/Page Request                | SharePoint Foundation           |
| SharePoint Publishing Cache Publishing cache flushes /<br>second | SharePoint Publishing Cache     |
