...
- [Change health event thresholds](CloudWatch-IM-get-started.change-threshold.md "CloudWatch-IM-get-started.change-threshold.md")
- [Publish internet
  measurements to S3](CloudWatch-IM-get-started.Publish-to-S3.md "CloudWatch-IM-get-started.Publish-to-S3.md")
