...
After creating pipelines, you can monitor their performance and manage their
configuration through the Pipelines tab.
...
- **Delete pipeline** – Remove pipelines
  that are no longer needed

###### Note

To programmatically manage metrics pipelines, use the Observability Admin APIs
including `CreateTelemetryPipeline`,
`UpdateTelemetryPipeline`, and
