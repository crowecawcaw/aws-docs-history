...
To learn more about AWS resource policies, see [Identity-based policies and resource-based policies](../../../IAM/latest/UserGuide/access_policies_identity-vs-resource.md "../../../IAM/latest/UserGuide/access_policies_identity-vs-resource.md").
...
To learn more about IAM policy grammar, see [IAM JSON policy element reference](../../../IAM/latest/UserGuide/reference_policies_elements.md "../../../IAM/latest/UserGuide/reference_policies_elements.md").
...
more information about this condition key, see [Properties of the network](../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-network-properties "../../../IAM/latest/UserGuide/reference_policies_condition-keys.md#condition-keys-network-properties")
...
Additionally, you can also choose to only accept [PutRumEvents](../../../cloudwatchrum/latest/APIReference/API_PutRumevents.md "../../../cloudwatchrum/latest/APIReference/API_PutRumevents.md")
