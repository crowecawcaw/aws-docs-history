...
1. In the **Metrics** section, for **Number of metrics**, enter **(6 \+ total count of disk and diskio metrics per EC2 host as described above) \* number of EC2 instances configured for this solution**.
...
If you want to edit the template file to customize it for any purpose, you can use the **Upload a template file** option under **Create Stack Wizard** to upload the edited template. For more information, see [Creating a stack on CloudFormation console](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/cfn-console-create-stack.html). You can use this link to download the template: [ https://aws-observability-solutions-prod-us-east-1.s3.us-east-1.amazonaws.com/EC2\_Health/CloudWatch/CFN/v1.0.0/dashboard-template-linux-macos-1.0.0.json ](https://aws-observability-solutions-prod-us-east-1.s3.us-east-1.amazonaws.com/EC2_Health/CloudWatch/CFN/v1.0.0/dashboard-template-linux-macos-1.0.0.json) 
