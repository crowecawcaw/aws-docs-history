...
4. To add or remove tags, choose the **Tags** tab and then choose
   **Manage tags**.
5. To edit other parts of the alarm, choose **Actions**,
   **Edit**.

The **Specify metric and conditions** page appears, showing a graph
and other information about the metric and statistic that you selected. 6. To change the metric, choose **Edit**, choose the **All
...
**Copy**. 11. Choose **Next**. 12. Under **Preview and create**, confirm that the information and
