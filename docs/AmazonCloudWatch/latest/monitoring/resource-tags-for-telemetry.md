...
To begin discovering and visualizing your telemetry by tags, you must first enable the resource tags for telemetry feature for your AWS account. When you enable this feature, Resource Explorer creates an AWS index and managed view that 
 indexes and discovers resources and tags in your account. For more information, see [Index](https://docs.aws.amazon.com/resource-explorer/latest/apireference/API_Index.html "https://docs.aws.amazon.com/resource-explorer/latest/apireference/API_Index.html") in the Resource 
 Explorer API reference guide and [AWS managed views](https://docs.aws.amazon.com/resource-explorer/latest/userguide/aws-managed-views.html "https://docs.aws.amazon.com/resource-explorer/latest/userguide/aws-managed-views.html") in the Resource Explorer user guide. CloudWatch uses this information to enrich your AWS 
