...
5. On the **Specify Details** page, fill out the following
   ...
   - **KeyName**: To enable SSH access to the new instance, choose
     ...
     create one in the AWS Management Console. For more information, see [Amazon EC2 Key Pairs](../../../AWSEC2/latest/UserGuide/ec2-key-pairs.md "../../../AWSEC2/latest/UserGuide/ec2-key-pairs.md") in the
...
`CREATE_IN_PROGRESS` status. 8. When the instance is created, you can see it in the Amazon EC2 console. Optionally, you
...
8. On the **Options** page, you can choose to tag your stack
   resources. Choose **Next**.
9. On the **Review** page, review your information, acknowledge that
   the stack might create IAM resources, and then choose
   **Create**.

If you refresh the console, you see that the new stack has the
`CREATE_IN_PROGRESS` status. 10. When the instance is created, you can see it in the Amazon EC2 console. Optionally, you
can connect to the host and check the progress.
