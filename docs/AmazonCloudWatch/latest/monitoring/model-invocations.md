...
CloudWatch generative AI observability allows you to monitor Model Invocations performance.
 ...
 CloudWatch. For more information, see [Set up a CloudWatch Logs destination](https://docs.aws.amazon.com/bedrock/latest/userguide/model-invocation-logging.html#setup-cloudwatch-logs-destination "https://docs.aws.amazon.com/bedrock/latest/userguide/model-invocation-logging.html#setup-cloudwatch-logs-destination") and [Help protect
 sensitive log data with masking](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/mask-sensitive-log-data.html "https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/mask-sensitive-log-data.html") .
...
* **Invocation Throttles** – Number of
 ...
 your retry settings in the SDK. For more information, see [Retry](https://docs.aws.amazon.com/sdkref/latest/guide/feature-retry-behavior.html "https://docs.aws.amazon.com/sdkref/latest/guide/feature-retry-behavior.html") behavior in the AWS SDKs and Tools Reference Guide
