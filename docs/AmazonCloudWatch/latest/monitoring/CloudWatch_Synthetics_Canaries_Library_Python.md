...
Disables all screenshot options (get\_screenshot\_on\_step\_start, get\_screenshot\_on\_step\_success,
...
*filename* is the file name for the screenshot, and 
 *suffix* is an optional string to be used for naming the screenshot.
