...
Container Insights collects data as _performance log events_ using [embedded metric format](CloudWatch_Embedded_Metric_Format.md "CloudWatch_Embedded_Metric_Format.md"). These performance
