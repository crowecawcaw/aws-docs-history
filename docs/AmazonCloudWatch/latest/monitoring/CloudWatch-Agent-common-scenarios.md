...
configuration file](create-cloudwatch-agent-configuration-file.md "create-cloudwatch-agent-configuration-file.md") 5. Give the user the required permissions. The user must have Read (r) permissions for
...
Make other modifications to the configuration file as needed. For more information,
see [Create the CloudWatch agent
configuration file](create-cloudwatch-agent-configuration-file.md "create-cloudwatch-agent-configuration-file.md") 6. Give the user required permissions. The user must have Read (r) permissions for the
