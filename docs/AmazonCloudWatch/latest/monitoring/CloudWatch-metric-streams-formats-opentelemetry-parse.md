...
OpenTelemetry 0.7.0 messages in your preferred language.
...
- The steps depend on your preferred language.
      ...
      + To use any other language, follow these steps:
      	...
      	3. Download the OpenTelemetry 0.7.0 ProtoBuf definitions at
      	 [v0.7.0 release](https://github.com/open-telemetry/opentelemetry-proto/releases/tag/v0.7.0 "https://github.com/open-telemetry/opentelemetry-proto/releases/tag/v0.7.0").
      	4. Confirm that you are in the root folder of the downloaded
      	 OpenTelemetry 0.7.0 ProtoBuf definitions. Then create a `src`
