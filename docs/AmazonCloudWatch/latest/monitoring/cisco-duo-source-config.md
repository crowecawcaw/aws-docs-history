...
<a name="cisco-duo-source-config"></a>

## Integrating with Cisco Duo
<a name="cisco-duo-integration"></a>
...
<a name="cisco-duo-authentication"></a>
...
<a name="cisco-duo-configure-auth"></a>
...
1. Search for "Admin API" and create a new integration.

1. Note the Integration Key, Secret Key, and API Hostname provided by Duo.

1. Grant the "Grant read log" permission to the integration.

1. Store the `integration_key` and `secret_key` in AWS Secrets Manager.

## Configuring the CloudWatch Pipeline
<a name="cisco-duo-pipeline-config"></a>
...
<a name="cisco-duo-ocsf-support"></a>
