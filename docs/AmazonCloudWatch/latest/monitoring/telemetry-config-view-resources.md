...
- [Viewing data sources](#telemetry-config-view-data-sources "#telemetry-config-view-data-sources")
- [Viewing discovered resources](#telemetry-config-view-discovered "#telemetry-config-view-discovered")
- [Filtering and preferences](#telemetry-config-filter-resource-view "#telemetry-config-filter-resource-view")
...
preferences. For more information, see [Changing preferences for the Discovered resources page](#telemetry-config-resource-view-prefs "#telemetry-config-resource-view-prefs").
...
discovered resources page. For more information, see [Filtering and preferences](#telemetry-config-filter-resource-view "#telemetry-config-filter-resource-view").
