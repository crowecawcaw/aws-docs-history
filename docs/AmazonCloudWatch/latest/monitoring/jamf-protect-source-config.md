...
2. Create or edit an Action Configuration.
3. Configure the Amazon S3 destination with your bucket name, region, and IAM credentials.

**Jamf Security Cloud (Data Streams)**

1. In the Jamf Protect console, navigate to Integrations, then choose Data Streams.
2. Create a new Data Stream with Amazon S3 as the destination.
3. Provide the bucket name, region, and IAM credentials.
