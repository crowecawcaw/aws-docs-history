...
| Page                                                                                                      | Description                                                                                                                                                                                                                                                                                  |
| --------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Send metrics using OpenTelemetry](metrics-otel-send.md "metrics-otel-send.md")                           | Publish custom metrics through the OTLP endpoint using OTel<br>SDKs or collectors                                                                                                                                                                                                            |
| [AWS vended metrics in OpenTelemetry format](CloudWatch-OTelEnrichment.md "CloudWatch-OTelEnrichment.md") | Enable AWS services to publish metrics as OTel data<br>points with resource tags. Uses OTel Vended Metric Enrichment to<br>convert existing AWS service metrics (Amazon EC2, Amazon RDS, ELB, etc.)<br>into the OTel path with full label enrichment — no agent or<br>code changes required. |
