...
service is available. For more information, see [CloudWatch Application Insights Regions and Endpoints](../../../general/latest/gr/applicationinsights.md "../../../general/latest/gr/applicationinsights.md").
