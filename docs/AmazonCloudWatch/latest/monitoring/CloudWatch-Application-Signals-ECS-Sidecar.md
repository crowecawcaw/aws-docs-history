...
[Setting up a Node.js application with the ESM module format](#ECS-NodeJs-ESM "#ECS-NodeJs-ESM") before you start these steps.
...
format. For details, see [Known limitations about Node.js with ESM](CloudWatch-Application-Signals-supportmatrix.md#ESM-limitations "CloudWatch-Application-Signals-supportmatrix.md#ESM-limitations").
