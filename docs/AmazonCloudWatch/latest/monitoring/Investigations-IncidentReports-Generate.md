...
Report generation requires an investigation with at least one accepted
 hypothesis.
5. On the top of the investigation page, choose **Incident
 report**. Wait while the relevant facts of the investigation are
 collected and synced.
6. On the **Incident Report** page review the facts being used
...
8. Review the generated report in the preview pane. The report will
 include:
