...
* Only the latest 3 hours of data can be used for evaluating the alarm's conditions.
 ...
 graph
* Alarms evaluating multiple time series will limit the rate of concurrent
 transitions to 100
* Metrics Insights limits on the maximum number of time series analyzed or returned
 apply

For more information on CloudWatch service quotas and limits, see [CloudWatch service quotas](cloudwatch_limits.md "cloudwatch_limits.md").
