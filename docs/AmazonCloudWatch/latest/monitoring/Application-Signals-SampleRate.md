...
- To change X-Ray sampling, see [Configure sampling rules](../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console "../../../xray/latest/devguide/aws-xray-interface-console.md#xray-console")
- To change ADOT sampling, see [Configuring the OpenTelemetry Collector for X-Ray remote sampling](https://aws-otel.github.io/docs/getting-started/remote-sampling "https://aws-otel.github.io/docs/getting-started/remote-sampling")
