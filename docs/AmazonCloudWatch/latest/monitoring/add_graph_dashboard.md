...
to the same graph or gauge. 11. (Optional) To add or edit vertical annotations,
choose **Options**:

    1. To add a vertical annotation,
     choose **Add vertical annotation**.
    2. For ***Label***, choose the pen
...
to the same graph. 12. Choose **Create widget**. 13. Choose **Save dashboard**.
