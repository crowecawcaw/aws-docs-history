...
**Note**  
For Node.js, versions 4.1.1\+, 3.0.2\+, 2.0.7\+ are required for use with the Lambda JSON log format. Using previous versions in such Lambda environments will lead to metric loss.  
