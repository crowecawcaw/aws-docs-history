...
1. (Optional) Choose the **Graphed metrics** tab and add a metric math function that uses the metrics that you have chosen. For more information, see [Math expressions with metrics](using-metric-math.md).
