...
policies for Network Synthetic Monitor
...
To view examples of Network Synthetic Monitor identity-based policies, see [Identity-based policy examples
for Amazon CloudWatch](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within Network Synthetic Monitor
...
actions for Network Synthetic Monitor
...
To see a list of Network Synthetic Monitor actions, see [Actions defined by Network Synthetic Monitor](../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions") in the
...
resources for Network Synthetic Monitor
...
To see a list of Network Synthetic Monitor resource types and their ARNs, see [Resources defined by Network Synthetic Monitor](../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-resources-for-iam-policies "../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-resources-for-iam-policies")
in the _Service Authorization Reference_. To learn with which actions you can
specify the ARN of each resource, see [Actions defined by Network Synthetic Monitor](../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions").

## Policy

condition keys for Network Synthetic Monitor
...
To see a list of Network Synthetic Monitor condition keys, see [Condition keys for Network Synthetic Monitor](../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-policy-keys "../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by Network Synthetic Monitor](../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions "../../../service-authorization/latest/reference/list_amazoncloudwatchnetworkmonitor.md#amazoncloudwatchnetworkmonitor-actions-as-permissions").
...
credentials with Network Synthetic Monitor
...
principal permissions for Network Synthetic Monitor
...
Changing the permissions for a service role might break Network Synthetic Monitor functionality. Edit
service roles only when Network Synthetic Monitor provides guidance to do so.

## Using a service-linked

role for Network Synthetic Monitor
...
For details about creating or managing service-linked roles, see [AWS services that work
with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam-nw.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam-nw.md"). Find a service in the table that includes a `Yes` in the
