...
available through AWS Security Hub CSPM integration. Security Hub partner
providers that send findings to Security Hub are automatically available as data
sources. For the full list of supported partners, see the [Security Hub partner providers](../../../securityhub/latest/userguide/securityhub-partner-providers.md "../../../securityhub/latest/userguide/securityhub-partner-providers.md") documentation.
