...
When you create a monitor in this way, the **Create monitor** 
 ...
 can choose to create a monitor with those resources, or update the selection of local
...
6. Select the local resources (one or more) for the network flows that you want to monitor.
	...
	* To monitor network flows from all resources in your Region, choose **Everywhere 
	...
	Or, to choose specific local resources to monitor flows from, choose **Specific resources 
	 in *Region***. Then, under **Add resources**,
	 choose **VPCs and subnets** or **Availability Zones**, 
...
8. Select the remote resources (one or more) for the network flows that you want to monitor.
	...
	* To monitor network flows to all resources in your Region, choose **Everywhere 
	...
	To choose specific remote resources to monitor flows from, choose **Specific resources 
	 in *Region***. Then, under **Add resources**,
	 choose **VPCs and subnets**, **Availability Zones**, 
	 or **AWS services**, and then choose resources to add.
...
After you create a monitor, you can edit the monitor at any time, to add or remove 
 network flows. You can also delete the monitor. Select a monitor, and then choose 
 **Edit**. Note that you can’t change the name of a monitor.
