...
- Enable IPv4 internet access to allow the canary to send metrics to CloudWatch and Amazon S3. For
  more information, see the following section [Giving internet access to your canary on a VPC](#CloudWatch_Synthetics_VPC_Internet "#CloudWatch_Synthetics_VPC_Internet").
- If you want to keep your VPC private, you can configure the canary to send its data to
  ...
  and a gateway endpoint for Amazon S3. For more information, see [Using CloudWatch, CloudWatch Synthetics, and CloudWatch Network Monitoring with interface VPC endpoints](cloudwatch-and-interface-VPC.md "cloudwatch-and-interface-VPC.md")
...
1. Configure your VPC to have Dualstack subnets. You must add an Egress-Only Internet
   ...
   and allow outbound access from the associated Security Groups. For more information, see [Add IPv6 support for your VPC](../../../vpc/latest/userguide/vpc-migrate-ipv6-add.md "../../../vpc/latest/userguide/vpc-migrate-ipv6-add.md") .
2. Set the `Ipv6AllowedForDualstack` in your canary VPC configuration using
   ...
   see [VpcConfigInput](../../../AmazonSynthetics/latest/APIReference/API_VpcConfigInput.md "../../../AmazonSynthetics/latest/APIReference/API_VpcConfigInput.md")
   .
