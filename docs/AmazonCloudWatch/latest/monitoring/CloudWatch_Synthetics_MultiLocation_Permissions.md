...
You can use condition keys in IAM policies to control which Regions can be used
as replica locations. The following condition keys are available:

| Condition key                       | Description                                                        | Type          | Used with                                               |
| ----------------------------------- | ------------------------------------------------------------------ | ------------- | ------------------------------------------------------- |
| `synthetics:AddReplicaLocations`    | Filters access by the replica Regions specified in the request     | ArrayOfString | `synthetics:CreateCanary`,<br>`synthetics:UpdateCanary` |
...
The following policy allows creating and updating canaries with replicas only in
...
For more information about CloudWatch Synthetics permissions, see [Required roles and permissions for CloudWatch canaries](CloudWatch_Synthetics_Canaries_Roles.md "CloudWatch_Synthetics_Canaries_Roles.md").
