...
###### If you're using X-Ray or AWS Distro for OpenTelemetry SDKs
 ...
 For more information, see [Configuring sampling rules](https://docs.aws.amazon.com/xray/latest/devguide/xray-console-sampling.html#xray-console-config "https://docs.aws.amazon.com/xray/latest/devguide/xray-console-sampling.html#xray-console-config")
...
* [Trace summary search](https://docs.aws.amazon.com/xray/latest/devguide/xray-console-traces.html?icmpid=docs_xray_help_panel_traces#xray-console-traces-view "https://docs.aws.amazon.com/xray/latest/devguide/xray-console-traces.html?icmpid=docs_xray_help_panel_traces#xray-console-traces-view") – Search and find traces from trace summaries.
* [Trace summary analytics](https://docs.aws.amazon.com/xray/latest/devguide/xray-console-analytics.html "https://docs.aws.amazon.com/xray/latest/devguide/xray-console-analytics.html") – Interpret trace data.
* [Trace insights](https://docs.aws.amazon.com/xray/latest/devguide/xray-console-insights.html "https://docs.aws.amazon.com/xray/latest/devguide/xray-console-insights.html") – Analyze trace data to identify application issues.
