...
in the Region that have Lambda Insights enabled. Lower on the page is a table that lists the functions. 4. To filter by function name to reduce the number of functions displayed, type part of the
function name in the box near the top of the page. 5. To add this view to a dashboard as a widget, choose **Add to dashboard**.
...
the selected function. 4. If you have X-Ray enabled, you can choose a single trace ID. This opens the X-Ray Trace Map page for
...
X-Ray Trace Map](../../../xray/latest/devguide/xray-console-servicemap.md "../../../xray/latest/devguide/xray-console-servicemap.md"). 5. To open CloudWatch Logs Insights and zoom in on a specific error,
choose **View logs** by the table at the bottom of the page. 6. To add this view to a dashboard as a widget, choose **Add to dashboard**.
