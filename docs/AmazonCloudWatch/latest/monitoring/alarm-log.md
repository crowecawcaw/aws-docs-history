...
| Recently created or updated alarm                | After creation or configuration update, the alarm remains in<br>INSUFFICIENT_DATA until enough query executions complete to satisfy the M-out-of-N<br>evaluation window.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
