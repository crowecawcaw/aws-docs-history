...
1. To annotate a single workload, enter one of the following commands. Replace {{$WORKLOAD\_TYPE}} and {{$WORKLOAD\_NAME}} with the values for your workload.
   + For Java workloads:
...
1. To annotate all workloads in a namespace, enter enter one of the following commands. Replace {{$NAMESPACE}} with the name of your namespace.
