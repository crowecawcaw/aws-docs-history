...
For more information, see [Creating a CloudWatch dashboard](create_dashboard.md "create_dashboard.md") in the *Amazon CloudWatch User Guide*.
...
* For API details, see
 [PutDashboard](https://docs.aws.amazon.com/powershell/v4/reference "https://docs.aws.amazon.com/powershell/v4/reference")
...
* For API details, see
 [PutDashboard](https://docs.aws.amazon.com/powershell/v5/reference "https://docs.aws.amazon.com/powershell/v5/reference")
