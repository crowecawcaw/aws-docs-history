...
4. Add widgets to the dashboard that display metrics for a Lambda function.
...
7. For **Property that the variable changes**, choose 
 **FunctionName**.
8. For **Input type**, for this use case, we recommend
...
9. When you choose **Select menu (dropdown)**, you must then choose whether to
