...
For more information, see [Using CloudWatch anomaly detection](CloudWatch_Anomaly_Detection.md "CloudWatch_Anomaly_Detection.md").
...
8. Under _**Conditions**_, specify the following:
   ...
   **Edit** at the top-right of the screen.
   ...
   or outside the band (in either direction). 3. For **Anomaly detection threshold**, choose the number to use for
