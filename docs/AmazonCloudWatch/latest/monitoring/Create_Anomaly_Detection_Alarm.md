...
6. Choose **Graphed metric**. 
	...
	1. (Optional) For *Statistic*, choose the dropdown, and then
	...
	2. (Optional) For *Period*, choose the dropdown, and then select
...
8. Under ***Conditions***, specify the following: 
	...
	3. For **Outlier detection threshold**, choose the number to use for
	...
	To create an M out of N alarm, specify a number for the first value that is lower
	 than the number for the second value. For more information, see [Evaluating an alarm](AlarmThatSendsEmail.md#alarm-evaluation "AlarmThatSendsEmail.md#alarm-evaluation").
...
12. Choose **Next**.
13. Under ***Name and description***, enter a name
...
###### Tip
 ...
 characters
14. Under ***Preview and create***, confirm that your
