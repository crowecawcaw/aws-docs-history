...
* [Use Quick Amazon S3 setup](CloudWatch-metric-streams-setup-Quick-S3.md "CloudWatch-metric-streams-setup-Quick-S3.md")
* [Quick partner setup](CloudWatch-metric-streams-QuickPartner.md "CloudWatch-metric-streams-QuickPartner.md")
