...
- Multi-account investigation requires you to already have cross-account
  ...
  the prerequisite, set up either [cross-account observability](../../../prescriptive-guidance/latest/patterns/centralize-monitoring-by-using-amazon-cloudwatch-observability-access-manager.md "../../../prescriptive-guidance/latest/patterns/centralize-monitoring-by-using-amazon-cloudwatch-observability-access-manager.md") or the [cross-account dashboard](Cross-Account-Cross-Region.md "Cross-Account-Cross-Region.md").
