...
Amazon EventBridge event rules can notify you when canaries change status or complete runs. EventBridge
 ...
 CloudWatch Synthetics sends these events to EventBridge on a *best effort* basis. Best
...
Amazon EventBridge is an event bus service that you can use to connect your applications with data
 from a variety of sources. For more information, see [What is Amazon EventBridge?](https://docs.aws.amazon.com/eventbridge/latest/userguide/what-is-amazon-eventbridge.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/what-is-amazon-eventbridge.html")
...
This section lists example events from CloudWatch Synthetics. For more information about event
 ...
 Patterns in EventBridge](https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-and-event-patterns.html "https://docs.aws.amazon.com/eventbridge/latest/userguide/eventbridge-and-event-patterns.html"). 
