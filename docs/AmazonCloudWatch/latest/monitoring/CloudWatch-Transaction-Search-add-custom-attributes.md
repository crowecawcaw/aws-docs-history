...
###### Note
 ...
 For information about adding custom attributes or span events in a different language, see [Language APIs and SDKS](https://opentelemetry.io/docs/languages/ "https://opentelemetry.io/docs/languages/") in the *OpenTelemetry website*.
