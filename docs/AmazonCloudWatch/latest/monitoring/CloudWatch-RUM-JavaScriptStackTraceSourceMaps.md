...
**Topics**
+ [Requirements and syntax](#CloudWatch-RUM-RequirementsJavaScriptStackTraceSourceMaps)
...
Enable RUM event storage in CloudWatch Logs by turning on **Data storage**. Once enabled, you can search the new **event\_details.unminifiedStack** field. This allows you to analyze trends and relate issues across multiple sessions using CloudWatch Logs queries.
