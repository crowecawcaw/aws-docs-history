...
more information, see [AWS KMS keys](../../../kms/latest/developerguide/concepts.md "../../../kms/latest/developerguide/concepts.md").
...
You can also choose to attach the general AWS [**ReadOnlyAccess**](../../../aws-managed-policy/latest/reference/ReadOnlyAccess.md "../../../aws-managed-policy/latest/reference/ReadOnlyAccess.md") to the investigation group role, in addition
...
- **AWS owned keys**– By default, CloudWatch investigations
  ...
  keys](../../../kms/latest/developerguide/concepts.md#aws-owned-cmk "../../../kms/latest/developerguide/concepts.md#aws-owned-cmk").
...
enhance the security of the AWS KMS key. For more information, see [AWS KMS keys and encryption context](../logs/encrypt-log-data-kms.md#encrypt-log-data-kms-policy "../logs/encrypt-log-data-kms.md#encrypt-log-data-kms-policy").
