...
+  Identify and organize your AWS resources. Many AWS services support tagging. You can assign the same tag to resources from different services to indicate the resources are related. For example, you can assign the tag that you assigned to a CloudWatch rule to an EC2 instance. 
...
+ Alarms – You can tag alarms using the [tag-resource](https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/tag-resource.html) AWS CLI command and the [TagResource](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_TagResource.html) API. You can also view and manage your alarm tags using the *Alarms* details page in the CloudWatch console.
...
+ Dashboards – You can tag dashboards when you create them by using the [put-dashboard](https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/put-dashboard.html) AWS CLI command and the [PutDashboard](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_PutDashboard.html) API. You can add tags to existing dashboards by using the [tag-resource](https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/tag-resource.html) AWS CLI command and the [TagResource](https://docs.aws.amazon.com/AmazonCloudWatch/latest/APIReference/API_TagResource.html) API.
