...
- Alarms – You can tag alarms using the [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md "../../../cli/latest/reference/cloudwatch/tag-resource.md") AWS CLI command and the
...
- Contributor Insights rules – You can tag Contributor Insights rules when
  you create them by using the [put-insight-rule](../../../cli/latest/reference/cloudwatch/put-insight-rule.md "../../../cli/latest/reference/cloudwatch/put-insight-rule.md") AWS CLI command and the
...
- Metric streams – You can tag metric streams when
  ...
  You can add tags to existing metric streams by using the [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md "../../../cli/latest/reference/cloudwatch/tag-resource.md") AWS CLI command and the
  [TagResource](../APIReference/API_TagResource.md "../APIReference/API_TagResource.md") API.
...
- [tag-resource](../../../cli/latest/reference/cloudwatch/tag-resource.md "../../../cli/latest/reference/cloudwatch/tag-resource.md"), [untag-resource](../../../cli/latest/reference/cloudwatch/untag-resource.md "../../../cli/latest/reference/cloudwatch/untag-resource.md"), and [list-tags-for-resource](../../../cli/latest/reference/cloudwatch/list-tags-for-resource.md "../../../cli/latest/reference/cloudwatch/list-tags-for-resource.md") in the
  _Amazon CloudWatch CLI Reference_
- [Working with Tag Editor](../../../ARG/latest/userguide/tag-editor.md "../../../ARG/latest/userguide/tag-editor.md") in the
