...
Note: *city-networks* are pairs of client locations and the ASNs the clients use (typically internet 
...
| CityNetworksFor25PercentTraffic | The number that you should set your city-networks maximum limit to if you want to monitor 25% of your application internet traffic in Internet Monitor. | For more information, see [Metrics in Amazon CloudWatch](working_with_metrics.md "working_with_metrics.md").
