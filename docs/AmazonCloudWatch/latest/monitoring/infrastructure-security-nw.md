...
As a managed service, Network Synthetic Monitor is protected by the AWS global network security
...
You use AWS published API calls to access Network Synthetic Monitor through the network. Clients must
