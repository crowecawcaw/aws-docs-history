...
information about these endpoints, see [Amazon Elastic Compute Cloud (Amazon EC2)](../../../general/latest/gr/rande.md#ec2_region "../../../general/latest/gr/rande.md#ec2_region") in the
  ...
  - `files` – Specifies which regular log files the CloudWatch agent
    ...
    - `collect_list` – Required if `files` is
      ...
      - `file_path` – Specifies the path of the log file
        ...
        asterisk_. For example, specifying
      ...
      - `log_group_class` – Optional. Specifies which log
        ...
        group classes, see [Log classes](../logs/CloudWatch_Logs_Log_Classes.md "../logs/CloudWatch_Logs_Log_Classes.md").
...
- `traces_collected` – Required if the `traces`
  ...
  - `xray` – Optional. Specifies that you want to collect
    ...
    - `tcp_proxy` – Optional. Configures the address for a
      ...
      [Configuring
      sampling rules](../../../xray/latest/devguide/xray-console-sampling.md "../../../xray/latest/devguide/xray-console-sampling.md") in the X-Ray documentation.
...
- `endpoint_override` – Optional. Specifies a FIPS endpoint or
  ...
  endpoint. For more information, see [What is Amazon VPC](../../../vpc/latest/userguide/what-is-amazon-vpc.md "../../../vpc/latest/userguide/what-is-amazon-vpc.md")
