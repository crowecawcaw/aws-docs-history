...
For the specific metrics that CloudWatch enriches for each resource type, see [Supported metrics for resource tags for telemetry](SupportedMetricsForResourceTagsForTelemetry.md).
