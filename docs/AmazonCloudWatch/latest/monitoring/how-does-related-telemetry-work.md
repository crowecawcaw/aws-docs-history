 ...
 *entity* to which they are related. Typically, the entity will be
...
The *topology map* (map) in the **Explore 
 related** pane displays the currently selected resource, along with 
 *related resources*. For AWS resources, CloudWatch automatically 
 ...
 *service*. For example, a service might be a website application. 
...
To use tags to generate service names, you must first 
 [set up instance metadata](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/work-with-tags-in-IMDS.html#allow-access-to-tags-in-IMDS "https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/work-with-tags-in-IMDS.html#allow-access-to-tags-in-IMDS") for the Amazon EC2 instance.
