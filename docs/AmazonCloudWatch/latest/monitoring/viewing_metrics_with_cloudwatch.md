 ...
 *Monitoring* account, the *Source* account metrics
...
Use the [list-metrics](https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/list-metrics.html "https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/list-metrics.html")
