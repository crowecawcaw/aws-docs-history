...
![Mute icon with alarm symbol labeled test-alarm.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/alarm_mute_rules_icon.png)
...
![Graph showing timed expression values over time with alarm states indicated by colored bars below.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/alarm-mutes-timelineview.png)
