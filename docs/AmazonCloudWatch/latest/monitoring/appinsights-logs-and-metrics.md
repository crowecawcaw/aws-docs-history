...
- Alert logs and listener logs for Oracle on Amazon RDS and Oracle on Amazon
  EC2
- Container logs routing from Amazon ECS containers to CloudWatch using [`awslogs` log driver](../../../AmazonECS/latest/developerguide/using_awslogs.md "../../../AmazonECS/latest/developerguide/using_awslogs.md").
- Container logs routing from Amazon ECS containers to CloudWatch using [FireLens container
  log router](../../../AmazonECS/latest/developerguide/using_firelens.md "../../../AmazonECS/latest/developerguide/using_firelens.md").
...
- **Standard** – Amazon CloudWatch Application Insights requires that log
  ...
  Standard log class](../logs/CloudWatch_Logs_Log_Classes.md "../logs/CloudWatch_Logs_Log_Classes.md") to enable monitoring.
