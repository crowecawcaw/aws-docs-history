# How Amazon CloudWatch works with
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| [Identity-based policies](#security_iam_service-with-iam-id-based-policies-cw "#security_iam_service-with-iam-id-based-policies-cw")                                                                        | Yes                |
| [Resource-based policies](#security_iam_service-with-iam-resource-based-policies-cw "#security_iam_service-with-iam-resource-based-policies-cw")                                                            | No                 |
| [Policy actions](#security_iam_service-with-iam-id-based-policies-actions-cw "#security_iam_service-with-iam-id-based-policies-actions-cw")                                                                 | Yes                |
| [Policy resources](#security_iam_service-with-iam-id-based-policies-resources-cw "#security_iam_service-with-iam-id-based-policies-resources-cw")                                                           | Yes                |
| [Policy condition keys (service-specific)](#security_iam_service-with-iam-id-based-policies-conditionkeys-cw "#security_iam_service-with-iam-id-based-policies-conditionkeys-cw")                           | Yes                |
| [ACLs](#security_iam_service-with-iam-acls-cw "#security_iam_service-with-iam-acls-cw")                                                                                                                     | No                 |
| [ABAC (tags<br>in policies)](#security_iam_service-with-iam-tags-cw "#security_iam_service-with-iam-tags-cw")                                                                                               | Partial            |
| [Temporary credentials](#security_iam_service-with-iam-roles-tempcreds-cw "#security_iam_service-with-iam-roles-tempcreds-cw")                                                                              | Yes                |
| [Principal permissions](#security_iam_service-with-iam-principal-permissions-cw "#security_iam_service-with-iam-principal-permissions-cw")                                                                  | Yes                |
| [Service roles](#security_iam_service-with-iam-roles-service-cw "#security_iam_service-with-iam-roles-service-cw")                                                                                          | Yes                |
| [Service-linked roles](security_iam_service-with-iam-cwim.md#security_iam_service-with-iam-roles-service-linked "security_iam_service-with-iam-cwim.md#security_iam_service-with-iam-roles-service-linked") | No                 |
...
To view examples of CloudWatch identity-based policies, see [Identity-based policy examples
for Amazon CloudWatch](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
...
To see a list of CloudWatch actions, see [Actions defined by Amazon CloudWatch](../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions "../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions") in the
...
[Resources defined by Amazon CloudWatch](../../../service-authorization/latest/reference/list_your_service.md#your_service-resources-for-iam-policies "../../../service-authorization/latest/reference/list_your_service.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by Amazon CloudWatch](../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions "../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions").
...
To see a list of CloudWatch condition keys, see [Condition keys for Amazon CloudWatch](../../../service-authorization/latest/reference/list_your_service.md#your_service-policy-keys "../../../service-authorization/latest/reference/list_your_service.md#your_service-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources
you can use a condition key, see [Actions defined by Amazon CloudWatch](../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions "../../../service-authorization/latest/reference/list_your_service.md#your_service-actions-as-permissions").
