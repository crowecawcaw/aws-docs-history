...
When you see the role, choose the name of the role. 4. In the **Permissions** tab, choose **Add
permissions**, **Create inline policy**. 5. Choose the **JSON** tab and copy the following policy into the
...
policy**. 5. Choose the **JSON** tab and copy the following policy into the
box, replacing the default JSON in the box:
...
Gateways](../../../vpc/latest/userguide/VPC_Internet_Gateway.md "../../../vpc/latest/userguide/VPC_Internet_Gateway.md") in the Amazon VPC User Guide.
...
- If you're using the agent to collect metrics, you must add the CloudWatch endpoints for
  ...
  endpoints and quotas](../../../general/latest/gr/cw_region.md "../../../general/latest/gr/cw_region.md").
- If you're using the agent to collect logs, you must add the CloudWatch Logs endpoints
  ...
  CloudWatch Logs endpoints and quotas](../../../general/latest/gr/cwl_region.md "../../../general/latest/gr/cwl_region.md").
- If you're using Systems Manager to install the agent or Parameter Store to store
  ...
  endpoints and quotas](../../../general/latest/gr/ssm.md "../../../general/latest/gr/ssm.md").
