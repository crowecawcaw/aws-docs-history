...
![A screenshot of the AWS Cost Explorer Service interface, with CloudWatch selected for the Service field and Resource selected for the Dimension field.](images/celogs.png)
