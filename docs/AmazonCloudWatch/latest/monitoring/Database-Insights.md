...
| Analyze operating system processes happening in your databases with detailed metrics per running process<br />[Amazon RDS Enhanced Monitoring](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/USER_PerfInsights_Counters.html) is required for this feature to work. | Not supported | Supported | 
...
For information about detailed database and per-query metrics, see [Amazon CloudWatch metrics for Amazon Aurora](https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/Aurora.AuroraMonitoring.Metrics.html).
