...
<a name="github-audit-log-setup"></a>
...
**Topics**
+ [Source configuration for GitHub Audit Log](github-audit-log-source-setup.md)
+ [CloudWatch pipelines configuration for GitHub Audit Log](github-audit-log-pipeline-setup.md)