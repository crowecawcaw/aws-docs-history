...
* [Puppeteer Change log](https://playwright.dev/docs/release-notes "https://playwright.dev/docs/release-notes")
...
* Simplified packaging – Package scripts directly under root without using the Node.js/node\_modules directory structure
