...
6. Choose a percentage of your application's internet traffic to monitor. 7. Optionally, under **Advanced settings**, specify one or more of the following additional options.
    ...
    * **Amazon S3 bucket storage** — You can specify an Amazon S3 bucket name and custom prefix to
    ...
    Internet Monitor stores internet measurements for pairs of your client locations and ASNs, or *city-networks*.
     ...
     see [Publish internet measurements to Amazon S3 in Internet Monitor](CloudWatch-IM-get-started.Publish-to-S3.md "CloudWatch-IM-get-started.Publish-to-S3.md").
