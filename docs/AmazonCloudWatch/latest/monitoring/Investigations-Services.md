...
- 4For Amazon RDS, enable CloudWatch Database Insights in the
  **Advanced mode**. For more information, see [Turning on the Advanced mode of Database Insights for Amazon Aurora](../../../AmazonRDS/latest/AuroraUserGuide/USER_DatabaseInsights.TurningOnAdvanced.md "../../../AmazonRDS/latest/AuroraUserGuide/USER_DatabaseInsights.TurningOnAdvanced.md")
