...
when some data points are missing. For more information, see [Configuring how CloudWatch alarms treat missing data](alarms-and-missing-data.md "alarms-and-missing-data.md"). 9. Choose **Next**. 10. Under **Notification**, select an SNS topic to notify when the
