...
###### Note
 ...
 US East (N. Virginia). For more information, see [Enabling billing alerts](#turning_on_billing_metrics "#turning_on_billing_metrics").
5. Select the box for the **EstimatedCharges** metric, and then
 choose **Select metric**.
6. For **Statistic**, choose **Maximum**.
7. For **Period**, choose **6 hours**.
8. For **Threshold type**, choose **Static**.
9. For **Whenever EstimatedCharges is . . .**, choose
 **Greater**.
