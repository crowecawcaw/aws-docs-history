...
information, see [Setting up telemetry configuration](telemetry-config-turn-on.md "telemetry-config-turn-on.md").
...
settings for your resources. It only stops the centralized management and visibility of
these settings.
