...
For more information on search, see [Use search expressions in graphs](using-search-expressions.md "using-search-expressions.md")
...
![View the resulting metrics for a search term](images/metrics_search_results.png)
