...
For more information on search, see [Use search expressions in graphs](using-search-expressions.md "using-search-expressions.md") 4. To graph all the search results, choose **Graph search**
