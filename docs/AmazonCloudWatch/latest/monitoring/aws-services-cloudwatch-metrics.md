...
<a name="aws-services-cloudwatch-metrics"></a>
...
| AWS Application Migration Service | `AWS/MGN ` | [ Monitoring Application Migration Service with Amazon CloudWatch](https://docs.aws.amazon.com/mgn/latest/ug/monitoring-cloudwatch.html) | 
...
| WorkSpaces Applications | `AWS/AppStream` | [Monitoring Amazon AppStream 2.0 Resources](https://docs.aws.amazon.com/appstream2/latest/developerguide/monitoring.html) | 
...
| Amazon Bedrock Guardrails | `AWS/Bedrock/Guardrails` | [Monitoring Amazon Bedrock Guardrails using CloudWatch Metrics](https://docs.aws.amazon.com/bedrock/latest/userguide/monitoring-guardrails-cw-metrics.html) | 
...
| Amazon Braket | `AWS/Braket/By Device` | [ Monitoring Amazon Braket with Amazon CloudWatch](https://docs.aws.amazon.com/braket/latest/developerguide/braket-monitor-metrics.html) | 
...
| Amazon Q Developer in chat applications | `AWS/Chatbot` | [Monitoring Amazon Q Developer in chat applications with Amazon CloudWatch](https://docs.aws.amazon.com//chatbot/latest/adminguide/monitoring-cloudwatch.html) | 
| Amazon Chime | `AWS/ChimeVoiceConnector` | [ Monitoring Amazon Chime with Amazon CloudWatch](https://docs.aws.amazon.com/chime/latest/ag/monitoring-cloudwatch.html) | 
...
| CloudWatch Application Signals | `ApplicationSignals` | [Metrics collected by Application Signals](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/AppSignals-MetricsCollected.html) | 
...
| Amazon CodeGuru Reviewer | `` | [Monitoring CodeGuru Reviewer with Amazon CloudWatch ](https://docs.aws.amazon.com/codeguru/latest/reviewer-ug/monitoring.html) | 
| AWS CodePipeline | `` | [AWS CodePipeline CloudWatch metrics](https://docs.aws.amazon.com/codepipeline/latest/userguide/metrics-dimensions.html) | 
| Amazon Kendra | `` | [ Monitoring Amazon Kendra with Amazon CloudWatch](https://docs.aws.amazon.com/kendra/latest/dg/cloudwatch-metrics.html) | 
...
| Amazon Comprehend | `AWS/Comprehend` | [ Monitoring Amazon Comprehend endpoints](https://docs.aws.amazon.com/comprehend/latest/dg/manage-endpoints-monitor.html) | 
| AWS Config | `AWS/Config` | [AWS Config Usage and Success Metrics](https://docs.aws.amazon.com/config/latest/developerguide/viewing-the-aws-config-dashboard.html#aws-config-dashboard-metrics) | 
| Connect Customer | `AWS/Connect` | [Monitoring Connect Customer in Amazon CloudWatch Metrics](https://docs.aws.amazon.com/connect/latest/adminguide/monitoring-cloudwatch.html) | 
...
| Amazon DataZone | `` | [ Monitoring Amazon DataZone with Amazon CloudWatch](https://docs.aws.amazon.com/datazone/latest/userguide/monitoring-cloudwatch.html) | 
| Amazon DevOps Guru | `AWS/DevOps-Guru` | [ Monitoring Amazon DevOps Guru with Amazon CloudWatch](https://docs.aws.amazon.com/devops-guru/latest/userguide/monitoring-cloudwatch.html) | 
...
| Direct Connect | `AWS/DX` | [Monitoring with Amazon CloudWatch](https://docs.aws.amazon.com/directconnect/latest/UserGuide/monitoring-cloudwatch.html) | 
| AWS Directory Service | `AWS/DirectoryService` | [ Use Amazon CloudWatch metrics to determine when to add domain controllers](https://docs.aws.amazon.com/directoryservice/latest/admin-guide/ms_ad_deploy_additional_dcs.html#scaledcs) | 
| Amazon DocumentDB | `AWS/DocDB` | [Monitoring Amazon DocumentDB with CloudWatch](https://docs.aws.amazon.com//documentdb/latest/developerguide/cloud_watch.html) | 
...
| Amazon Elastic Container Registry | `AWS/ECR` | [ Amazon ECR repository metrics](https://docs.aws.amazon.com/AmazonECR/latest/userguide/ecr-repository-metrics.html) | 
...
| Amazon ECS through CloudWatch Container Insights | `ECS/ContainerInsights` | [ Amazon ECS Container Insights metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Container-Insights-metrics-ECS.html) | 
...
| AWS Elastic Disaster Recovery | `` | [ CloudWatch Metrics for DRS](https://docs.aws.amazon.com/drs/latest/userguide/monitoring-event-bridge-metrics.html) | 
...
| Amazon Elastic Inference | `AWS/ElasticInference` | [ Using CloudWatch Metrics to Monitor Amazon Elastic Inference](https://docs.aws.amazon.com/elastic-inference/latest/developerguide/ei-cloudwatch-metrics.html) | 
| Amazon EKS | `AWS/EKS` | [ Basic metrics in Amazon CloudWatch](https://docs.aws.amazon.com/eks/latest/userguide/cloudwatch.html#cloudwatch-basic-metrics) | 
| Amazon EKS through CloudWatch Container Insights | `ContainerInsights` | [ Amazon EKS and Kubernetes Container Insights metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Container-Insights-metrics-EKS.html) | 
...
| Amazon ElastiCache (Memcached) | `AWS/ElastiCache` | [Monitoring Use with CloudWatch Metrics](https://docs.aws.amazon.com/AmazonElastiCache/latest/mem-ug/CacheMetrics.html) | 
| Amazon ElastiCache (Redis OSS) | `AWS/ElastiCache` | [Monitoring Use with CloudWatch Metrics](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheMetrics.html) | 
...
| Amazon EMR | `AWS/EMRServerless` | [Monitoring EMR Serverless applications and jobs ](https://docs.aws.amazon.com/emr/latest/ManagementGuide/app-job-metrics.html) | 
...
| Amazon FinSpace | `` | [ Logging and monitoring](https://docs.aws.amazon.com/finspace/latest/userguide/kdb-cluster-logging-monitoring.html) | 
| Amazon Forecast | `` | [ CloudWatch Metrics for Amazon Forecast](https://docs.aws.amazon.com/forecast/latest/dg/cloudwatch-metrics.html) | 
| Amazon Fraud Detector | `` | [ Monitoring Amazon Fraud Detector with Amazon CloudWatch](https://docs.aws.amazon.com/frauddetector/latest/ug/monitoring-cloudwatch.html#YourService-metrics) | 
...
| Amazon FSx for NetApp ONTAP | `AWS/FSx` | [ Monitoring with Amazon CloudWatch](https://docs.aws.amazon.com/fsx/latest/ONTAPGuide/monitoring-cloudwatch.html) | 
| Amazon FSx for OpenZFS | `AWS/FSx` | [ Monitoring with Amazon CloudWatch](https://docs.aws.amazon.com/fsx/latest/OpenZFSGuide/monitoring-cloudwatch.html) | 
| Amazon GameLift Servers | `AWS/GameLift` | [Monitor Amazon GameLift Servers with CloudWatch](https://docs.aws.amazon.com/gamelift/latest/developerguide/monitoring-cloudwatch.html) | 
...
| AWS HealthLake | `AWS/HealthLake` | [ Monitoring HealthLake with CloudWatch](https://docs.aws.amazon.com/healthlake/latest/devguide/monitoring-cloudwatch.html) | 
...
| Amazon Kendra | `` | [ Monitoring Amazon Kendra with Amazon CloudWatch](https://docs.aws.amazon.com/kendra/latest/dg/cloudwatch-metrics.html) | 
| Amazon Managed Service for Apache Flink | `AWS/KinesisAnalytics` | *Managed Service for Apache Flink for SQL Applications*: [Monitoring with CloudWatch](https://docs.aws.amazon.com/kinesisanalytics/latest/dev/monitoring-cloudwatch.html)<br />*Managed Service for Apache Flink for Apache Flink*: [Viewing Amazon Managed Service for Apache Flink Metrics and Dimensions](https://docs.aws.amazon.com/kinesisanalytics/latest/java/metrics-dimensions.html) | 
| Amazon Data Firehose | `AWS/Firehose` | [Monitoring Firehose Using CloudWatch Metrics ](https://docs.aws.amazon.com/firehose/latest/dev/monitoring-with-cloudwatch-metrics.html) | 
...
| Amazon Managed Service for Prometheus | `AWS/Prometheus` | [ Amazon CloudWatch metrics](https://docs.aws.amazon.com/prometheus/latest/userguide/AMP-CW-usage-metrics.html) | 
...
| Amazon Managed Streaming for Apache Kafka | `AWS/KafkaConnect` |  [ Monitoring MSK Connect](https://docs.aws.amazon.com/msk/latest/developerguide/mkc-monitoring-overview.html) | 
| Amazon Managed Workflows for Apache Airflow | `AWS/MWAA` |  [ Container, queue, and database metrics for Amazon MWAA](https://docs.aws.amazon.com/mwaa/latest/userguide/accessing-metrics-cw-container-queue-db.html) | 
| Amazon MemoryDB | `AWS/MemoryDB` |  [ Monitoring CloudWatch metrics](https://docs.aws.amazon.com/memorydb/latest/devguide/cloudwatchmetrics.html) | 
...
| AWS HealthOmics | `AWS/Omics` | [ Monitoring AWS HealthOmics with Amazon CloudWatch](https://docs.aws.amazon.com/omics/latest/dev/monitoring-cloudwatch.html) | 
| AWS Outposts | `AWS/Outposts` | [ CloudWatch metrics for AWS Outposts](https://docs.aws.amazon.com/outposts/latest/userguide/outposts-cloudwatch-metrics.html) | 
| AWS Panorama | `AWS/PanoramaDeviceMetrics` | [ Monitoring appliances and applications with Amazon CloudWatch](https://docs.aws.amazon.com/panorama/latest/dev/monitoring-metrics.html) | 
| Amazon Personalize | `AWS/Personalize ` | [ CloudWatch metrics for Amazon Personalize](https://docs.aws.amazon.com/personalize/latest/dg/cloudwatch-metrics.html) | 
| Amazon Pinpoint | `AWS/Pinpoint` | [ View Amazon Pinpoint metrics in CloudWatch](https://docs.aws.amazon.com/pinpoint/latest/userguide/monitoring-view-metrics.html) | 
...
| AWS Private 5G | `AWS/Private5G` | [ Amazon CloudWatch metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/working_with_metrics.html) | 
| Amazon Q Apps | `AWS/QApps` | [Monitoring Amazon Q Business and Amazon Q Apps with Amazon CloudWatch ](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/monitoring-cloudwatch.html) | 
| Amazon Q Business | `AWS/QBusiness` | [Monitoring Amazon Q Business and Amazon Q Apps with Amazon CloudWatch ](https://docs.aws.amazon.com/amazonq/latest/qbusiness-ug/monitoring-cloudwatch.html) | 
| Amazon Q Developer | `AWS/Q` | [Monitoring Amazon Q Developer with Amazon CloudWatch ](https://docs.aws.amazon.com/amazonq/latest/qdeveloper-ug/monitoring-cloudwatch.html) | 
| Amazon Quick | `AWS/QuickSight` | [ Monitoring with Amazon CloudWatch](https://docs.aws.amazon.com/quicksight/latest/user/monitoring-quicksight.html) | 
...
| Amazon Rekognition | `AWS/Rekognition` | [ Monitoring Rekognition with Amazon CloudWatch](https://docs.aws.amazon.com/rekognition/latest/dg/rekognition-monitoring.html) | 
| AWS re:Post Private | `AWS/rePostPrivate` | [ Monitoring AWS re:Post Private with Amazon CloudWatch](https://docs.aws.amazon.com/repostprivate/latest/caguide/monitoring-cloudwatch.html) | 
...
| Amazon SageMaker AI | `AWS/SageMaker` | [Monitoring SageMaker AI with CloudWatch](https://docs.aws.amazon.com/sagemaker/latest/dg/monitoring-cloudwatch.html) | 
| Amazon SageMaker AI Model Building Pipelines | `AWS/SageMaker/ModelBuildingPipeline` | [ SageMaker AI Pipelines Metrics](https://docs.aws.amazon.com/sagemaker/latest/dg/monitoring-cloudwatch.html#cloudwatch-metrics-pipelines) | 
...
| Amazon Security Lake | `AWS/SecurityLake` | [ CloudWatch metrics for Amazon Security Lake](https://docs.aws.amazon.com/security-lake/latest/userguide/cloudwatch-metrics.html) | 
...
| Amazon S3 | `AWS/S3` | [Monitoring Metrics with Amazon CloudWatch](https://docs.aws.amazon.com/AmazonS3/latest/userguide/cloudwatch-monitoring.html) | 
...
| Amazon Transcribe | `AWS/Transcribe` | [ Monitoring Amazon Transcribe with Amazon CloudWatch](https://docs.aws.amazon.com/transcribe/latest/dg/monitoring-cloudwatch.html) | 
...
| AWS WAF | `AWS/WAFV2` for AWS WAF resources<br />`WAF` for AWS WAF classic resources | [Monitoring with CloudWatch](https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html) | 
