...
<a name="zeek-pipeline-setup"></a>

The Zeek setup on AWS reads log data from Amazon S3 buckets using Amazon SQS notifications for new object events.

Configure the Zeek source using the following parameters:
...
Identifies the data source. This can be any string value that represents your data source. Example: "zeek".
