...
- [Amazon Route 53 Resolver query logging configuration](component-configuration-examples-resolver-query-logging.md "component-configuration-examples-resolver-query-logging.md")
- [Amazon S3 bucket](component-configuration-examples-s3.md "component-configuration-examples-s3.md")
- [Amazon Simple Queue Service (SQS)](component-configuration-examples-sqs.md "component-configuration-examples-sqs.md")
