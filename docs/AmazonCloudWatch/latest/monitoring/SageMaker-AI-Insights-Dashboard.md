...
![SageMaker AI Insights dashboard header with summary bar showing Invocations, Instances, Inference Components, and Avg AZ Skew.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_New_Insights_Dashbaord.png)
...
![Endpoints list page showing the View in SageMaker AI Insights button.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Observability_Enabled_page.png)
+ **From the endpoint detail page:** Choose **View in SageMaker AI Insights** to open the dashboard filtered to that endpoint.  
![Endpoint detail page showing the View in SageMaker AI Insights button.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Endpoint_detail_page.png)
...
![Inference component detail page showing the View in SageMaker AI Insights button.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_IC_Detaild_page.png)
...
![Performance health honeycombs showing alarm state by AZ.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Performance_health_AZ_honey_comb.png)
...
![Instance performance table showing TTFT, output TPS, concurrent requests, and KV cache.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Instance_health_performance_tab.png)


Token streaming  
Time‐series chart showing TTFT and inter‐token latency (ITL) with a P50/P99 toggle, broken down by framework.  

![Token streaming chart showing TTFT and ITL P50/P99 over time.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Token_streaming.png)


Token throughput  
Input and output tokens per second by framework, with toggles for Input/Output, Percentiles, and By instance views.  

![Token throughput chart showing input and output tokens per second.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Token_throughput.png)
...
![Engine and request pressure panel showing KV cache, running requests, and waiting requests.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Engine_and_request_pressure.png)
...
![Traffic distribution table showing invocations per minute, 4XX rate, and 5XX rate by instance.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Traffic_distribution.png)


Error mix over time  
Line chart showing 4XX, 5XX, and mid‐stream error rates over time per IC.  

![Error mix over time line chart showing 4XX, 5XX, and mid-stream errors.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Error_mix_over_time.png)
...
![Latency breakdown over time stacked area chart showing model latency and overhead latency.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Latency_breakdown_over_time.png)
...
![Capacity health honeycombs showing alarm state by AZ.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Capacity_health_honey_comb.png)


Instance capacity table  
Per‐instance utilization bars for GPU, GPU memory, CPU, memory, and disk.  

![Instance capacity table showing GPU, GPU memory, CPU, memory, and disk utilization.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Instance_health_capacity_tab.png)
...
![Fleet utilization chart showing CPU, GPU, GPU memory, memory, and disk utilization per instance over time.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Fleet_Util.png)
...
![Availability Zone distribution bar chart showing instance count per AZ.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_AZ_distribution.png)
...
![Cold start anatomy showing model download, GPU load, container start, and platform overhead.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_Cold_start_anatomy.png)
...
![ICE diagnostics panel showing ICE count over time and an event table.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/smai_ICE_events.png)
