...
Security is a shared responsibility between AWS and you. The [shared responsibility
 model](https://aws.amazon.com/compliance/shared-responsibility-model/ "https://aws.amazon.com/compliance/shared-responsibility-model/") describes this as security *of* the cloud and security
 *in* the cloud:
...
This documentation helps you understand how to apply the shared responsibility model when
 ...
 monitor and secure your Network Synthetic Monitor resources. 

###### Topics

* [Data protection in Network Synthetic Monitor](data-protection-nw.md "data-protection-nw.md")
* [Infrastructure Security in Network Synthetic Monitor](infrastructure-security-nw.md "infrastructure-security-nw.md")
