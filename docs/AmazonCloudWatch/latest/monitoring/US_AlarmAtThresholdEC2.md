...
10. Under **Conditions**, specify the following:
	...
	To create an M out of N alarm, specify a lower number for the first value than
	 you specify for the second value. For more information, see [Evaluating an alarm](AlarmThatSendsEmail.md#alarm-evaluation "AlarmThatSendsEmail.md#alarm-evaluation").
	4. For **Missing data treatment**, choose how to have the alarm
	...
	5. If the alarm uses a percentile as the monitored statistic, a
...
15. Under **Preview and create**, confirm that the information and
...
2. Create an alarm using the [put-metric-alarm](https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/put-metric-alarm.html "https://docs.aws.amazon.com/cli/latest/reference/cloudwatch/put-metric-alarm.html") command
 as follows. 
