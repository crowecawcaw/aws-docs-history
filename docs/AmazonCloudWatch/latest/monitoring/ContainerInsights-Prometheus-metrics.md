...
For more information about HAProxy Ingress and its versions, see [haproxy-ingress](https://artifacthub.io/packages/helm/haproxy-ingress/haproxy-ingress "https://artifacthub.io/packages/helm/haproxy-ingress/haproxy-ingress").
...
| `haproxy_backend_http_responses_total`    | `ClusterName`, `Namespace`, Service, code,<br>backend  | All versions of HAProxy Ingress                       |
...
| `haproxy_frontend_http_responses_total`   | `ClusterName`, `Namespace`, Service, code,<br>frontend | All versions of HAProxy Ingress                       |
