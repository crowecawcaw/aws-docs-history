...
1. Integrate the SSO provider with Amazon Cognito. For more information, 
 see [Integrating Third-Party SAML Identity Providers with Amazon Cognito User Pools](https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-integrating-3rd-party-saml-providers.html "https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-integrating-3rd-party-saml-providers.html").
...
8. In the navigation pane, choose **Social and external providers**.
9. Choose **Add identity provider**.
10. Choose **SAML**.
11. Enter a name for your SSO provider in **Provider name**.
12. Choose **Select file**, and select the 
 metadata XML file that you downloaded in step 2.
13. Choose **Create provider**.
