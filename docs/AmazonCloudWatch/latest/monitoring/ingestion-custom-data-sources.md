...
`data_source_name`  
Identifies the data source. This can be any string value that represents your data source. Example: "my\_custom\_logs".  
`aws.region` (required)  
...
**Topics**
+ [Configuring Custom S3 Bucket Sources](configuring-custom-s3-bucket-sources.md)