...
reactivate them later. For more information, see [Activate or deactivate a probe](nw-monitor-probe-status.md "nw-monitor-probe-status.md"). 5. Enter `confirm` in the confirmation field, and then choose
**Delete**.
...
1. To delete a monitor, you need the monitor name. If you don't know the name, get a list of your monitors
   by running the
   [list-monitors](../../../cli/latest/reference/networkmonitor/list-monitors.md "../../../cli/latest/reference/networkmonitor/list-monitors.md") command. Note the name of the monitor that you want to delete.
2. Verify whether the monitor contains any active probes. Use [get-monitor](../../../cli/latest/reference/networkmonitor/get-monitor.md "../../../cli/latest/reference/networkmonitor/get-monitor.md") with the
...
4. After the probes are set to `INACTIVE` or deleted, you can delete the monitor
   by running the [delete-monitor](../../../cli/latest/reference/networkmonitor/create-probe.md "../../../cli/latest/reference/networkmonitor/create-probe.md") command. Inactive probes are not deleted when you delete the monitor.
