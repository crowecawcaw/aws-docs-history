...
| `init_duration`      | function\_name<br>function\_name, version | The amount of time spent in the `init` phase of the Lambda<br>execution environment lifecycle.<br>Unit: Milliseconds                                                                                 |
...
| `total_memory`       | function\_name<br>function\_name, version | The amount of memory allocated to your Lambda function. This is the same as your<br>function’s memory size.<br>Unit: Megabytes                                                                       |
| `total_network`      | function\_name<br>function\_name, version | Sum of `rx_bytes` and `tx_bytes`. Even for functions that<br>don't perform I/O tasks, this value is usually greater than zero because of network<br>calls made by the Lambda runtime.<br>Unit: Bytes |
