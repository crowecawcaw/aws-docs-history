...
| `memory_utilization` | function_name<br>function_name, version | The maximum memory measured as a percentage of the memory allocated to the function.<br>Unit: Percent                                                                                                |
