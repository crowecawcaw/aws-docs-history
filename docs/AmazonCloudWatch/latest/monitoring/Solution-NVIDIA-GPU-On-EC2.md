...
1. In the **Metrics** section, for **Number of metrics**, enter **17 \* average number of GPUs per EC2 host \* number of EC2 instances configured for this solution**.
