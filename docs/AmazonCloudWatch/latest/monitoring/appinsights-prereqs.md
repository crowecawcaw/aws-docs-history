...
* **AWS Systems Manager enablement** – Install
 ...
 [Setting up AWS Systems Manager](https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-setting-up.html "https://docs.aws.amazon.com/systems-manager/latest/userguide/systems-manager-setting-up.html") in the *AWS Systems Manager User Guide*.
...
* **AWS resource groups** – To onboard
 ...
 AWS Resource Groups](https://docs.aws.amazon.com/ARG/latest/userguide/gettingstarted.html "https://docs.aws.amazon.com/ARG/latest/userguide/gettingstarted.html").
