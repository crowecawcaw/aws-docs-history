...
![Visual Studio Code interface showing JavaScript code for a heartbeat canary function.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/DebugCanaryVS.png)
...
![Run/Debug Configurations interface for AWS Lambda with LocalSyntheticsCanary settings.](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/DebugCanaryIntellij.png)
