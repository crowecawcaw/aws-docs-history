...
Review the installed AWS Network Flow Monitor Agent add-on to make sure that it's active for your cluster. Run the following command to verify that the status is `ACTIVE`:  
