...
3.  On the **Add probe** page, do the following:
    ...
    You can only add one probe at a time and up to four probes per monitor. 2. Enter the destination **IP address** of the on-premises network.
    Both IPv4 and IPv6 addresses are supported. 3. Choose **Advanced settings**. 4. Choose the network **Protocol** for the destination. It can be either
    **ICMP** or **TCP**. 5. If the **Protocol** is **TCP**, enter the following
