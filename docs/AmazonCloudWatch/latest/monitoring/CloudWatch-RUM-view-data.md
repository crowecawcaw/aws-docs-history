...
![The RUM Overview page showing summary cards, quick filters, and the App Monitors table](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-overview-page.png)
...
![The diagnostic side panel showing the Health tab with error breakdown and metrics graphs](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-overview-diagnostic-panel.png)
...
![The diagnostic side panel showing metrics graphs, breached SLOs, and alarms in ALARM state](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-overview-diagnostic-panel-metrics.png)
...
![Performance tab showing the Page loads view with interactive web vitals graphs, Apdex score, and Top 100 page load times table](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-performance-pageloads.png)
...
![Performance tab showing the Resources and Locations views](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-performance-resources-locations.png)
...
![Diagnostic panel showing the Browsers and Devices tabs with top 5 contributing browsers and devices](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-performance-browsers-devices.png)
...
![JS errors tab showing error count, failure rate chart, diagnostic panel, and top 100 JS errors table](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-js-errors.png)
...
![HTTP requests tab showing request summary, error graph, diagnostic panel, and top 100 network routes table](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-http-requests.png)
...
![Sessions tab showing session list and waterfall visualization of telemetry events](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-sessions-waterfall.png)
...
![Sessions diagnostic panel showing traceId link and Exception tab with stack trace](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-sessions-diagnostic.png)
...
![User Journey tab showing navigation paths with Add path button](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-user-journey.png)
...
![Metrics tab showing default and extended CloudWatch metrics published by the app monitor](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-metrics.png)
...
![Filter bar with quick filter panel, Save filter option, and Select filter dropdown](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-web-filter-bar.png)
...
![Mobile Performance tab showing screen load times, app launch times, and Apdex scores with diagnostic panel](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-mobile-performance.png)
...
![Mobile Errors tab showing Network Errors, Crashes, and ANRs/App Hangs categories with diagnostic panel](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-mobile-errors.png)
...
![Mobile Sessions tab showing waterfall visualization and diagnostic panel with traceId and Exception tab](http://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/images/rum-mobile-sessions-diagnostic.png)
