...
Agent](https://aws.amazon.com/blogs/devops/new-how-to-better-monitor-your-custom-application-metrics-using-amazon-cloudwatch-agent/ "https://aws.amazon.com/blogs/devops/new-how-to-better-monitor-your-custom-application-metrics-using-amazon-cloudwatch-agent/").
...
- `tags` – (Optional) A comma-separated list of tags.
  ...
  GitHub](https://github.com/etsy/statsd/wiki#client-implementations "https://github.com/etsy/statsd/wiki#client-implementations").
