...
- CloudWatch alarms created for this canary. These alarms have a name that starts with `Synthetics-Alarm-*MyCanaryName*`. For more information about
  deleting alarms, see [Edit or delete a CloudWatch alarm](Edit-CloudWatch-Alarm.md "Edit-CloudWatch-Alarm.md").
