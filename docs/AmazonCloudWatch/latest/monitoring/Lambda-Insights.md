...
[Using AWS Lambda extensions](../../../lambda/latest/dg/using-extensions.md "../../../lambda/latest/dg/using-extensions.md"). For more information about embedded metric format,
...
Lambda extensions.
For a list of these runtimes, see [Lambda Extensions API](../../../lambda/latest/dg/runtimes-extensions-api.md "../../../lambda/latest/dg/runtimes-extensions-api.md").
