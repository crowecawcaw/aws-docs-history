...
| `regex_replace(fieldName: string, pattern:<br>string, replacement:<br>string)`                                                     | string      | Replaces all substrings matching the regular<br>expression `pattern` with<br>`replacement`. Uses RE2 regex<br>syntax.                                                                                                                                                                                                                             |
