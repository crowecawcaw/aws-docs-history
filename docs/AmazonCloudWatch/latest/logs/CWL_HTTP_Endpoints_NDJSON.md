...
The ND-JSON Logs endpoint (`/ingest/bulk`) accepts logs in
[NDJSON (Newline Delimited JSON)](https://github.com/ndjson/ndjson-spec "https://github.com/ndjson/ndjson-spec")
format. Each line contains exactly one JSON value, separated by newline characters.
