...
update this subscription so that the destination account grants access to all
accounts in an organization, follow the steps in this section.

###### Topics

- [Step 1: Update the subscription filters](Cross-Account-Log_Subscription-Update-filter.md "Cross-Account-Log_Subscription-Update-filter.md")
