...
For information on other query languages you can use, see [OpenSearch Service PPL](CWL_AnalyzeLogData_PPL.md "CWL_AnalyzeLogData_PPL.md"),
[OpenSearch Service SQL](CWL_AnalyzeLogData_SQL.md "CWL_AnalyzeLogData_SQL.md"),
and [CloudWatch Metrics Insights](../monitoring/query_with_cloudwatch-metrics-insights.md "../monitoring/query_with_cloudwatch-metrics-insights.md").
