...
1. To add another processor, choose **\+ Add processor**. Then select the processor that you want in the **Choose processors** box, and fill in the configuration parameters. 
