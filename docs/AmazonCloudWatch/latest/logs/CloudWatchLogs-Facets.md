...
If you have [resource tags for telemetry](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/resource-tags-for-telemetry.html) enabled, resource tag fields (`@aws.tag.*`) are automatically added as default facets. These facets enable you to filter and group log events by the tags of the resources that produced them.
...
1. After selecting the facets values, choose run to execute your query.
