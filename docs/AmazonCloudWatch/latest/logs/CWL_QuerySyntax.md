...
| **`limit`**                                                                                                                | Specifies a maximum number of log events that you want<br>your query to return. Useful with<br>\*_`sort`_<br>• to return<br>"top 20" or "most recent 20" results. Use<br>`limit any` to stop scanning early once<br>enough results are found.                                                                                                                                                                                        |
