...
from Amazon EC2 Instances and On-Premises Servers with the CloudWatch Agent](../monitoring/Install-CloudWatch-Agent.md "../monitoring/Install-CloudWatch-Agent.md") in the
...
the CloudWatch Agent Configuration File with the Wizard](../monitoring/create-cloudwatch-agent-configuration-file-wizard.md "../monitoring/create-cloudwatch-agent-configuration-file-wizard.md") in the
