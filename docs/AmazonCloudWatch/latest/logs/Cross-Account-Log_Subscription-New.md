...
- [Step 1: Create a destination](CreateDestination.md "CreateDestination.md")
...
- [Validate the flow of log
  events](ValidateLogEventFlow.md "ValidateLogEventFlow.md")
- [Modify destination membership
  at runtime](ModifyDestinationMembership.md "ModifyDestinationMembership.md")
