...
| Date-Time functions     | `eval newDate = ADDDATE(DATE('2020-08-26'), 1)                                                                                                | fields<br>newDate`                                                                                                                                                                                                                 | Built-in functions for handling and transforming date and<br>timestamp data in PPL queries. For example, date\_add,<br>date\_format, datediff, date-sub, timestampadd, timestampdiff,<br>current\_timezone, utc\_timestamp, and current\_date.            |
...
| JSON functions          | `eval valid_json = json('[1,2,3,{"f1":1,"f2":[5,6]},4]')<br>                                                                                  | fields valid_json`                                                                                                                                                                                                                 | Built-in functions for handling JSON including arrays,<br>extracting, and validation. For example, json\_object,<br>json\_array, to\_json\_string, json\_array\_length, json\_extract,<br>json\_keys, and json\_valid.                                    |
