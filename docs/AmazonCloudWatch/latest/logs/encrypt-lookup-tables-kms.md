...
[Encrypt log data in CloudWatch Logs using AWS Key Management Service](encrypt-log-data-kms.md "encrypt-log-data-kms.md").
...
For more information, see [AWS KMS keys and encryption context](encrypt-log-data-kms.md#encrypt-log-data-kms-policy "encrypt-log-data-kms.md#encrypt-log-data-kms-policy").
...
To create a symmetric KMS key, use the following [create-key](../../../cli/latest/reference/kms/create-key.md "../../../cli/latest/reference/kms/create-key.md") command:
