...
subset of the Standard class capabilities. For more information, see [Log classes](CloudWatch_Logs_Log_Classes.md "CloudWatch_Logs_Log_Classes.md").
...
- **Two log classes for flexibility** –
  ...
  option for logs that require real-time monitoring or other features. For more information, see [Log classes](CloudWatch_Logs_Log_Classes.md "CloudWatch_Logs_Log_Classes.md").
- **Query your log data** – You can use CloudWatch Logs
  ...
  are included for several types of AWS service logs. To get started, see [Analyzing log data with CloudWatch Logs Insights](AnalyzingLogData.md "AnalyzingLogData.md").
...
- **Detect and debug using Live Tail** – You can use
  ...
  For more information, see [Troubleshoot with CloudWatch Logs Live Tail](CloudWatchLogs_LiveTail.md "CloudWatchLogs_LiveTail.md").
- **Monitor logs from Amazon EC2 instances** – You can use
  ...
  and while it is at rest. To get started, see [Getting started with CloudWatch Logs](CWL_GettingStarted.md "CWL_GettingStarted.md").
- **Monitor AWS CloudTrail logged events** – You can create
  ...
  CloudWatch Logs](../../../awscloudtrail/latest/userguide/cw_send_ct_events.md "../../../awscloudtrail/latest/userguide/cw_send_ct_events.md") in the _AWS CloudTrail User Guide_.
...
- **Log Route 53 DNS queries** – You can use CloudWatch Logs to
  ...
  see [Logging DNS Queries](../../../Route53/latest/DeveloperGuide/query-logs.md "../../../Route53/latest/DeveloperGuide/query-logs.md") in the
...
- **AWS CloudTrail** is a web service that enables you to monitor the calls made
  ...
  AWS CloudTrail?](../../../awscloudtrail/latest/userguide/whatisawscloudtrail.md "../../../awscloudtrail/latest/userguide/whatisawscloudtrail.md") in the _AWS CloudTrail User Guide_. For an
  example of the type of data that CloudWatch writes into CloudTrail log files, see [Logging CloudWatch Logs API and console operations in AWS CloudTrail](logging_cw_api_calls_cwl.md "logging_cw_api_calls_cwl.md").
- **AWS Identity and Access Management (IAM)** is a web service that helps you securely control
  ...
  (authorization). For more information, see [What Is IAM?](../../../IAM/latest/UserGuide/introduction.md "../../../IAM/latest/UserGuide/introduction.md") in the
  _IAM User Guide_.
- **Amazon Kinesis Data Streams** is a web service you can use for rapid and
  ...
  Amazon Kinesis Data Streams?](../../../kinesis/latest/dev/introduction.md "../../../kinesis/latest/dev/introduction.md") in the _Amazon Kinesis Data Streams Developer Guide_.
- **AWS Lambda** is a web service you can use to build
  ...
  Lambda supports. For more information, see [What is AWS Lambda?](../../../lambda/latest/dg/welcome.md "../../../lambda/latest/dg/welcome.md") in the
  _AWS Lambda Developer Guide_.

## Pricing

When you sign up for AWS, you can get started with CloudWatch Logs for free using the [AWS Free Tier](http://aws.amazon.com/free/ "http://aws.amazon.com/free/").
...
costs, see
[CloudWatch billing and cost](../monitoring/cloudwatch_billing.md "../monitoring/cloudwatch_billing.md").
