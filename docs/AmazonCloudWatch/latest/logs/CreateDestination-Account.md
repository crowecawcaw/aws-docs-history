...
1. Create the IAM role that grants CloudWatch Logs the permission to put data into your stream. First, you'll need to create a trust policy in a file **\~/TrustPolicyForCWL.json**. Use a text editor to create this policy file, do not use the IAM console.
