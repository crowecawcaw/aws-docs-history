...
simple HTTP POST requests. These endpoints support both bearer token and SigV4
authentication, making it easy to ingest logs from any application or service without
requiring AWS SDK integration.
