...
Kinesis Data Streams shard, and using the **aws kinesis get-records**
command to fetch some Kinesis Data Streams records:
...
Kinesis Data Streams starts to return data.
...
Data messages use the "DATA_MESSAGE" type. Sometimes CloudWatch Logs may
emit Kinesis Data Streams records with a "CONTROL_MESSAGE" type, mainly for
