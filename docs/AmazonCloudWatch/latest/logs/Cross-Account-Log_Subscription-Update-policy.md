...
filters in all the sender accounts as explained in [Step 1: Update the subscription filters](Cross-Account-Log_Subscription-Update-filter.md "Cross-Account-Log_Subscription-Update-filter.md").
