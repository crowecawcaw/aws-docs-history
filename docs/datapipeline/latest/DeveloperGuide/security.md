...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS Data Pipeline. The following topics show you how to configure AWS Data Pipeline to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS Data Pipeline resources.

###### Topics

- [Data Protection in AWS Data Pipeline](data-protection.md "data-protection.md")
