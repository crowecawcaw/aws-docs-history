...
As a managed service, AWS Data Pipeline is protected by the AWS global network security
...
You use AWS published API calls to access AWS Data Pipeline through the network. Clients must
