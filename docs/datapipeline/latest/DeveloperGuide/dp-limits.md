...
<a name="dp-limits-web-service"></a>
...
The following limits apply to a single AWS account. This means the total usage on the account, including that by users, cannot exceed these limits.
...
<a name="dp-scaling-considerations"></a>
