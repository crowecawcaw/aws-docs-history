...
A precondition to check that the Amazon S3 objects with the given prefix (represented
as a URI) are present.

## Example

The following is an example of this object type using required, optional, and
expression fields.
