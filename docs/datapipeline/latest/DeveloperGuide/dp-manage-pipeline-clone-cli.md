...
<a name="dp-manage-pipeline-clone-cli"></a>
...
1. Use the `get-pipeline-definition` CLI to get the pipeline definition of the existing pipeline to be cloned and write it to a temporary file. Note the absolute path of the file.

1. Use the `put-pipeline-definition` CLI to copy the pipeline definition from the existing pipeline to the new pipeline.

1. Use the `get-pipeline-definition` CLI to get the definition of the new pipeline to verify the pipeline definition.
