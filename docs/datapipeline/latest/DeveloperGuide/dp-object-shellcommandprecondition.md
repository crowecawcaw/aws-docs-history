...
| stderr                | The Amazon S3 path that receives redirected system error messages from the command. If you use the<br>`runsOn` field, this must be an Amazon S3 path because of the<br>transitory nature of the resource running your activity. However, if you<br>specify the `workerGroup` field, a local file path is<br>permitted. | String                                                     |
| stdout                | The Amazon S3 path that receives redirected output from the command. If you use the<br>`runsOn` field, this must be an Amazon S3 path because of the<br>transitory nature of the resource running your activity. However, if you<br>specify the `workerGroup` field, a local file path is<br>permitted.                | String                                                     |
