...
The following table lists the Amazon EC2 instances that AWS Data Pipeline uses by default in
those Regions where AWS Data Pipeline is supported.
...
| EU (Ireland)              | eu-west-1      | m1.small      | The following table lists the Amazon EC2 instances that AWS Data Pipeline launches by default in those Regions where AWS Data Pipeline is not supported. |
| Region Name               | Region         | Instance Type |
| ---                       | ---            | ---           |
