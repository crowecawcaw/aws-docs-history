...
For a complete description of the programmatic objects in AWS Data Pipeline, see the [AWS Data Pipeline API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
For information about endpoints, see [Regions and Endpoints](../../../general/latest/gr/rande.md "../../../general/latest/gr/rande.md").
...
- `Authorization` The set of authorization parameters that AWS uses to ensure the validity and authenticity of the request. For more information about constructing this header, go to [Signature Version 4 Signing Process](../../../general/latest/gr/signature-version-4.md "../../../general/latest/gr/signature-version-4.md").
...
- **x-amz-crc32**—AWS Data Pipeline calculates a CRC32
  checksum of the HTTP payload and returns this checksum in the
  x-amz-crc32 header. We recommend that you compute your own CRC32
  checksum on the client side and compare it with the x-amz-crc32 header;
  if the checksums do not match, it might indicate that the data was
  corrupted in transit. If this happens, you should retry your request.
