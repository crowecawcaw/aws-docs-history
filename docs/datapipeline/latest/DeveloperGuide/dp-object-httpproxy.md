...
HttpProxy allows you to configure your own proxy and make Task Runner access the
AWS Data Pipeline service through it. You do not need to configure a running Task Runner with
this information.

## Example of an HttpProxy in TaskRunner

The following pipeline definition shows an `HttpProxy`
object:
