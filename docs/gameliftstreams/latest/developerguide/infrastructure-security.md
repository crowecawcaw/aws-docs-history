...
As a managed service, Amazon GameLift Streams is protected by AWS global network security. For
...
You use AWS published API calls to access Amazon GameLift Streams through the network. Clients must
