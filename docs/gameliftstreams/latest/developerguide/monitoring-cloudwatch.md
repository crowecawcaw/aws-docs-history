...
| --- | --- | --- | --- | 
| **AllocatedCapacity** | The number of compute resources that are provisioned and ready to stream. It includes resources that are currently streaming and resources that are idle and ready to respond to new stream requests. | (StreamGroupId, Location) | Count | 
| **IdleCapacity** | The numerical portion of allocated capacity that is not currently streaming. It represents the availability of compute resources to respond to new stream requests. | (StreamGroupId, Location) | Count | 
