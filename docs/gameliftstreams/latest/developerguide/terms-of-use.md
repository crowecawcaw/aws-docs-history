...
+ For more information about the AWS requirements, see Section 43 of the [AWS Service Terms](https://aws.amazon.com/service-terms/).
+ For more information about the service level agreements, see the [Amazon GameLift Streams Service Level Agreement](https://aws.amazon.com/gamelift/streams/sla/).