...
**Topics**
+ [Choosing a configuration in Amazon GameLift Streams](choosing-configuration.md)
+ [Configuration options](configuration-options.md)
+ [Starting your first stream in Amazon GameLift Streams](streaming-process.md)