...
The Dev Portal helps you learn by example how to use the Quick Sight
API in your website or application. Currently, the Dev Portal focuses on API operations
...
1. Open the Dev Portal and choose **Try it** on the use case that
   you want to view.
...
3. Choose **Download all code** to download all of the code in a
   .zip file.
4. Choose **How to customize it** to customize the dashboard, This
   screen is interactive, so you can choose any item in the navigation pane to view
   the changes live.
