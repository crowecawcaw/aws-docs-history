...
<a name="embedded-analytics-customize-assets"></a>
...
For more information about the Quick Sight SDKs, see the `amazon-Quick Sight-embedding-sdk` on [GitHub](https://github.com/awslabs/amazon-Quick Sight-embedding-sdk) or [NPM](https://www.npmjs.com/package/amazon-quicksight-embedding-sdk).
...
**Topics**
+ [Control the look and feel of embedded assets](embedded-analytics-control-look-and-feel.md)
+ [Add interactivity to your embedded content](embedded-analytics-add-interactivity.md)
+ [Personalization](personalization-embedded-analytics.md)