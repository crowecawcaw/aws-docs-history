...
<a name="iam-policy-assignment-operations"></a>
...
+ [DeleteIAMPolicyAssignment](delete-iam-policy-assignment.md)
+ [DescribeIAMPolicyAssignment](describe-iam-policy-assignment.md)
+ [ListIAMPolicyAssignments](list-iam-policy-assignments.md)
+ [ListIAMPolicyAssignmentsForUser](list-iam-policy-assignments-for-user.md)
