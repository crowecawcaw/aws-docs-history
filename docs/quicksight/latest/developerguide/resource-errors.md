...
**Topics**
+ [Common client errors](#resource-errors-client)
+ [Client errors](#resource-errors-table-client)
+ [Server errors](#qs-api-errors-table-server)

## Common client errors
<a name="resource-errors-client"></a>
...
## Client errors
<a name="resource-errors-table-client"></a>
...
<a name="resource-errors-common-causes"></a>
...
+ **Specify the AWS account ID and namespace** – Make sure that the relevant AWS account ID is provided with each request. The namespace must be set to `default`.
