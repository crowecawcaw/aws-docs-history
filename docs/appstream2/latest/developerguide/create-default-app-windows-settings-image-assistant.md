...
started with their applications quickly. When you create these settings, AppStream 2.0
...
For more information about configuring default application and Windows settings, see _Creating Default Application and Windows Settings for Your AppStream 2.0 Users_ in [Default Application and Windows Settings and Application Launch Performance in Amazon AppStream 2.0](customizing-appstream-images.md "customizing-appstream-images.md").
