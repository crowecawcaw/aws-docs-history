...
This connection method is required when your AppStream 2.0 fleet is joined to a
Microsoft Active Directory domain.

- [AppStream 2.0 user pools](user-pool.md "user-pool.md"): Use this connection method
  when:
...
- [Streaming
  ...
  access to AppStream 2.0 by using temporary URLs. We recommend this connection method when
