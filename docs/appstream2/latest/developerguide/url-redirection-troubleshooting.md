...
- Verify that the URL pattern includes the protocol
  (`https://`).
...
- Verify that exception list patterns are more specific than allowlist
  patterns.
...
- On the web client, verify that popups are allowed on the streaming
  URL.
