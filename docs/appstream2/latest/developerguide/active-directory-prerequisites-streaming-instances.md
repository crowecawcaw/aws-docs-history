...
AppStream 2.0 Streaming Instances
...
domain-joined instances by using [CreateStreamingURL](../APIReference/API_CreateStreamingURL.md "../APIReference/API_CreateStreamingURL.md") or the AppStream 2.0
user pool.
...
support joining an Active Directory domain. For more information, see [AppStream 2.0 Base Image and Managed Image Update
