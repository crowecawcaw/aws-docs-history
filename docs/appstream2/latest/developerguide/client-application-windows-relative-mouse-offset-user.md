...
- Choosing **Relative Mouse Position [Ctrl+Shift+F8]** from the
  **Settings** menu on the AppStream 2.0 toolbar in the top left area of your streaming session window. This method works when you use classic mode or **Desktop View**.
