...
started with their applications quickly, so that they won't need to create or configure the
settings themselves.
...
- [Creating Default Application and Windows Settings for Your WorkSpaces Applications Users](creating-default-app-Windows-settings.md "creating-default-app-Windows-settings.md")
- [Optimizing the Launch Performance of Your Applications in Amazon WorkSpaces Applications](optimizing-app-launch-performance.md "optimizing-app-launch-performance.md")
