...
- This feature is not supported on Chromebooks.
  ...
  start an WorkSpaces Applications streaming session. You can use the WorkSpaces Applications client or a [supported web browser](web-browser-user.md "web-browser-user.md") to start a streaming session.
