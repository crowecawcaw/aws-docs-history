...
enable Amazon S3 Home Folders for an AppStream 2.0 stack, users of the stack can access
...
more information, see [Enable and Administer Home Folders for Your AppStream 2.0
...
streaming instances to their Home Folders, AppStream 2.0 administrators can turn on the
**heavy_sync** configuration option if large file uploads to
Amazon S3 is a common user scenario while using AppStream 2.0. Turning on this option
...
This feature is available on all Red Hat Enterprise Linux images, and Linux AppStream 2.0
images that use a Linux AppStream 2.0 agent released on or after September 12, 2024.
