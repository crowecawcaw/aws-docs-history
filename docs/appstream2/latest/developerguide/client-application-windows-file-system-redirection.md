...
![Settings menu with Local Resources selected, showing submenu with Local Drives and Folders option.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-MenuOptions.png)
...
![Share your local drives and folders dialog box with Share All and Save my configuration highlighted.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-ShareAll.png)
...
![Share your local drives and folders dialog with Share button highlighted for Y_examplecorp drive.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Share-Specific.png)
...
![Add Folder button highlighted at the bottom of the dialog box.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Add-Specific-Folder.png)
...
![Share local drives and folders dialog with Share and Save my configuration buttons circled.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drive-Folders-SpecificFolderAdded.PNG)
...
![File browser showing shared drives including Desktop, Documents, Downloads, and Work Files folders.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Access-Shared-Drives-Folders.png)
...
![Dialog showing Unshare All and Save my configuration buttons highlighted in the interface.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-UnshareAll.png)
...
![Dialog showing drives and folders with Delete and Save my configuration buttons highlighted.](http://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drive-Folders-SpecificFolderAdded-Delete.png)