...
# Local File Access
<a name="client-application-windows-file-system-redirection"></a>

WorkSpaces Applications file redirection lets you access files on your local computer from your WorkSpaces Applications streaming session. To use file redirection, open the WorkSpaces Applications client, connect to a streaming session, and choose the drives and folders that you want to share. After you share a local drive or folder, you can access all files in the shared drive or folder from your streaming session. You can stop sharing local drives and folders at any time.
...
**Note**  
If your image uses an WorkSpaces Applications agent released on or after September 25, 2025, the drive for file system redirection will be available as a removable disk instead of a network drive.
...
![Settings menu with Local Resources selected, showing submenu with Local Drives and Folders option.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-MenuOptions.png)
...
![Share your local drives and folders dialog box with Share All and Save my configuration highlighted.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-ShareAll.png)
...
![Share your local drives and folders dialog with Share button highlighted for Y_examplecorp drive.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Share-Specific.png)
...
![Add Folder button highlighted at the bottom of the dialog box.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Add-Specific-Folder.png)
...
![Share local drives and folders dialog with Share and Save my configuration buttons circled.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drive-Folders-SpecificFolderAdded.PNG)
...
![File browser showing shared drives including Desktop, Documents, Downloads, and Work Files folders.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-Access-Shared-Drives-Folders.png)
...
![Dialog showing Unshare All and Save my configuration buttons highlighted in the interface.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drives-Folders-UnshareAll.png)
...
![Dialog showing drives and folders with Delete and Save my configuration buttons highlighted.](https://docs.aws.amazon.com/appstream2/latest/developerguide/images/AppStream2-Client-Local-Drive-Folders-SpecificFolderAdded-Delete.png)