...
# Use Home Folders
<a name="home-folders-end-user"></a>
...
+ Upload and download files between your local computer and your home folder. WorkSpaces Applications continuously checks for the most recently modified files and folders and backs them up to your home folder.
...
**Warning**  
Files larger than 5 GB will not be persisted between WorkSpaces Applications sessions.
**Note**  
