...
the _Home Folders and VPC Endpoints_ section in [Networking and Access for Amazon WorkSpaces Applications](managing-network.md "managing-network.md"). For more
