...
prompted, log in as Administrator. 9. If required, configure additional default regional or language settings.
...
AppStream 2.0 Console](tutorial-image-builder.md "tutorial-image-builder.md"). 12. Do one of the following:
...
sessions, as described in [Enable Your AppStream 2.0 Users to Configure Their Regional
