...
AppStream 2.0 image builder instances have instance metadata available through Windows
...
| AppStream_Resource_Name | Machine | The name of the image builder.                                                      | On Linux image builders, environment variables are exported through the script at **/etc/profile.d/appstream_system_vars.sh**. To access the environment variables, you can explicitly source this file in your application. |
