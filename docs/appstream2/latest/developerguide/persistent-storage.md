...
- Custom shared folders (Server Message Block (SMB) network drives)
  You can enable one or more options for your organization. As an WorkSpaces Applications administrator, you
  must understand how to perform the following tasks to enable and administer persistent
