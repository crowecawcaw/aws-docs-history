...
**Note**  
WorkSpaces Applications supports [FIPS 140-3](https://aws.amazon.com/compliance/fips/). For information about how to use WorkSpaces Applications FIPS endpoints for administrative use or streaming, see [Protecting Data in Transit with FIPS Endpoints](protecting-data-in-transit-FIPS-endpoints.md).  
