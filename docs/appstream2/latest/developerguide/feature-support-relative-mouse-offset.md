...
Users can enable this feature during their AppStream 2.0 streaming sessions
...
- Choosing **Relative Mouse Position [Ctrl+Shift+F8]** from the
  **Settings** menu on the AppStream 2.0 toolbar in the top left area of their streaming session window. This method works when they use classic mode or **Desktop View**.
