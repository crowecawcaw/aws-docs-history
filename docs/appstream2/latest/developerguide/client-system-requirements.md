...
+ Client requirements
  + Windows client
    ...
    + Microsoft Visual C\+\+ 2019 version 14.20.xx Redistributable or later. For more information, see the [Latest Microsoft Visual C\+\+ Redistributable Version](https://learn.microsoft.com/en-us/cpp/windows/latest-supported-vc-redist?view=msvc-170) in the Microsoft Support documentation.
    + RAM — 2 GB minimum
