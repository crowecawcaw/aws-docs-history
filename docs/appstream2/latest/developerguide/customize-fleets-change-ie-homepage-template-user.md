...
![Admin Commands dropdown menu with Switch User option highlighted.](/images/appstream2/latest/developerguide/images/admin-commands-switch-user.png) 4. This disconnects your current session and opens the login menu. Log in to
