...
4. From the list of AWS services, choose **WorkSpaces Applications**.
5. Under **Select your use case**, **WorkSpaces Applications — Allows WorkSpaces Applications instances to call AWS services on your behalf** is already selected. Choose **Next: Permissions**.
