...
- Identify and control AWS costs
  ...
  included. For more information about setting up a cost allocation report with tags, see [Monthly Cost Allocation Report](../../../awsaccountbilling/latest/aboutv2/configurecostallocreport.md "../../../awsaccountbilling/latest/aboutv2/configurecostallocreport.md") in the _AWS Billing User Guide_.

###### Contents

- [Tagging Basics](tagging-introduction.md "tagging-introduction.md")
- [Tag Restrictions](tag-restrictions.md "tag-restrictions.md")
- [Adding Tags during Resource Creation](basic-tagging-resource-creation-console.md "basic-tagging-resource-creation-console.md")
- [Adding, Editing, and Deleting Tags](basic-tagging-console.md "basic-tagging-console.md")
- [Using the API, SDK, or CLI](basic-tagging-API-SDK-CLI.md "basic-tagging-API-SDK-CLI.md")
