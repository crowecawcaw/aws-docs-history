...
AppStream 2.0 client can be used for application streaming.

**Secure applications and data**

Applications and data remain on AWS — only encrypted pixels are
streamed to users. Applications run on an AppStream 2.0 instance dedicated to each
...
AppStream 2.0 runs on AWS with access to compute capabilities not available on
...
- Always-On — Streaming instances run all the time, even when
  ...
  scaling rules. For more information, see [Fleet Auto Scaling for Amazon AppStream 2.0](autoscaling.md "autoscaling.md").
...
- On-Demand — Streaming instances run only when users are
  ...
  rules. For more information, see [Fleet Auto Scaling for Amazon AppStream 2.0](autoscaling.md "autoscaling.md").
...
- Elastic — The pool of streaming instances is managed by
  AppStream 2.0. When your users select their application or desktop to
...
For more information, see [Amazon AppStream 2.0 Pricing](https://aws.amazon.com/appstream2/pricing/ "https://aws.amazon.com/appstream2/pricing/").
