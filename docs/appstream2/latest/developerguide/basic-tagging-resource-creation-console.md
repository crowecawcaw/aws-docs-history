...
When you create a resource in the WorkSpaces Applications console, you can add one or more tags to manage the resource. For more information, see the following topics:
