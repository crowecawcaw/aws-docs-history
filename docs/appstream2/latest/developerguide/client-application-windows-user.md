...
- [Connect to WorkSpaces Applications on Windows Client](client-application-windows-start-streaming-session-user.md "client-application-windows-start-streaming-session-user.md")
...
- [Local File Access](client-application-windows-file-system-redirection.md "client-application-windows-file-system-redirection.md")
- [Printer Redirection](client-application-windows-local-printer-redirection.md "client-application-windows-local-printer-redirection.md")
- [Video and Audio Conferencing](client-application-windows-how-to-use-local-webcam-user.md "client-application-windows-how-to-use-local-webcam-user.md")
- [Drawing Tablets](client-application-windows-drawing-tablets-user.md "client-application-windows-drawing-tablets-user.md")
