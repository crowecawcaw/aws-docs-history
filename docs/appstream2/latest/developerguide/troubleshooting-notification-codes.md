...
**Message**: X session(s) encountered OneDrive mounting failures.  
**Resolution**: To troubleshoot this issue, check your network configuration and ensure the user has valid Microsoft 365 credentials. If you continue to encounter this error, contact AWS Support. For more information, see [AWS Support Center](https://console.aws.amazon.com/support/home#/).
