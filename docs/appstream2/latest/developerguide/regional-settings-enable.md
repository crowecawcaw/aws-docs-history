...
information, see [WorkSpaces Applications Agent Release Notes](agent-software-versions.md "agent-software-versions.md"). Additionally, your image must have Windows
