...
3. In the search box, type **applicationautoscaling** to narrow the list
   of roles to select, and then choose
   `AWSServiceRoleForApplicationAutoScaling_AppStreamFleet`. If this
   role is listed, select it to view the role **Summary**page.
...
6. On the **Trust relationships** tab, choose **Show
   ...
   trust relationship policy is attached and follows the correct format. If so,
