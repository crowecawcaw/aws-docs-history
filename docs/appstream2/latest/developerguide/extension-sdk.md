...
- Enhance the usability of third-party applications in remote sessions. For example,
  you can add local audio termination for VoIP applications or local video playback
  for conferencing applications.
- Provide accessibility software such as screen readers with information about the
  remote session and applications running remotely.
- Allow security software to analyze the security posture of the local endpoint to
  allow conditional access policies.
- Perform arbitrary data transfers over an established remote session.
  To get started with the Amazon DCV Extension SDK, see [What is the Amazon DCV Extension SDK?](../../../dcv/latest/extsdkguide/what-is.md "../../../dcv/latest/extsdkguide/what-is.md"). The
  SDK itself can be found in the [Amazon DCV Extension SDK Github repository](https://github.com/aws-samples/dcv-extension-sdk "https://github.com/aws-samples/dcv-extension-sdk"). In addition, integration examples of
