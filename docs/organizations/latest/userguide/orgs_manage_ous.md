...
**Topics**
+ [Best practices for OUs](orgs_manage_ous_best_practices.md)
+ [Navigating the root and tree](navigate_tree.md)
+ [Viewing details of an OU](orgs_view_ou.md)
+ [Creating an OU](create_ou.md)
+ [Renaming an OU](rename_ou.md)
+ [Tagging an OU](tag_ou.md)
+ [Moving accounts between OUs](move_account_to_ou.md)
+ [Viewing details of the root](orgs_view_root.md)
+ [Deleting an OU](delete-ou.md)