...
For more information about multi-account networking, see [Multi-account in AWS Global Networks for Transit Gateways](https://docs.aws.amazon.com/network-manager/latest/tgwnm/nm-multi-account.html).
