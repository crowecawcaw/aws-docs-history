...
1. You can enter a new **Policy name**, **Policy description**, or edit the **JSON** policy text. For information about declarative policy syntax, see [EC2 policy syntax and examples](orgs_manage_policies_ec2_syntax.md).
