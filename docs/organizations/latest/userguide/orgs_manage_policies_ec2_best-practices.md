...
Use the EC2 policy _account status report_ to assess the
current status of all attributes supported by EC2 policies for the accounts in
...
The choice to attach a EC2 policy for enforcing a baseline configuration
...
Implement processes to monitor for new EC2 attributes, evaluate policy
...
After you make a change to an EC2 policy, check the effective policies for
...
Ensure your organizations understand the purpose and impact of your EC2
