...
As a managed service, AWS Organizations is protected by AWS global network security. For
...
You use AWS published API calls to access Organizations through the network. Clients must
