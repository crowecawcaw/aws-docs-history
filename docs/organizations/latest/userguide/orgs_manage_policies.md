...
| Tag policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Chat applications policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 5 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| AI services opt-out policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 5 | 2500 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Security Hub policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Amazon Inspector policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Amazon Bedrock policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Upgrade rollout policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| S3 policy | Declarative | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](http://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 