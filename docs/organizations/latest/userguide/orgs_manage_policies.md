...
+ [Declarative policies](orgs_manage_policies_declarative_policies.md)
...
| --- | --- | --- | --- | --- | --- | 
| SCP | Authorization | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-no.png) No | 10 | 10,240 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-no.png) No | 
| RCP | Authorization | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-no.png) No | 5 | 5120 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-no.png) No | 
| Declarative policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Backup policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Tag policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Chat applications policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 5 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| AI services opt-out policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 5 | 2500 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Security Hub policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Amazon Inspector policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Amazon Bedrock policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| Upgrade rollout policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 
| S3 policy | Declarative | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 10 | 10,000 characters | ![](https://docs.aws.amazon.com/organizations/latest/userguide/images/icon-yes.png) Yes | 