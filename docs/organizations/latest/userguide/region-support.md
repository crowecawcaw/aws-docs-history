...
For a list of functionality differences in AWS GovCloud (US) Regions, see [AWS Organizations in AWS GovCloud (US)](https://docs.aws.amazon.com/govcloud-us/latest/UserGuide/govcloud-organizations.html).

For a list of functionality differences in China Regions, see [AWS Organizations in China](https://docs.amazonaws.cn/en_us/aws/latest/userguide/organizations.html).
...
Tag policies are a type of policy that can help you standardize tags across resources in your organization's accounts. Tag policies are only supported in a subset of Regions where Organizations is supported. For a list of Regions where tag policies are supported, see [Tag policies \| Support Regions](https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_tag-policies-supported-regions.html).
