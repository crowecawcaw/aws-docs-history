...
+ Confirm that the service supports delegated administrators. See the table in [AWS services that you can use with AWS Organizations](orgs_integrate_services_list.md) to learn which services support delegated administrators.
+ Enable trusted access for that service.

**Note**  
To learn how to enable a delegated administrator a service, reference the table in [AWS services that you can use with AWS Organizations](orgs_integrate_services_list.md) and select the **Learn more** link in the **Supports Delegated Administrator** column for that service. 

## Permissions granted to delegated administrator accounts
<a name="integrate_delegated_admin-permissions"></a>

Each service-specific delegated administrator account has permissions granted by that service. To learn more, reference the table in [AWS services that you can use with AWS Organizations](orgs_integrate_services_list.md) and select the **Learn more** link in the **Supports Delegated Administrator** column for that service. 
