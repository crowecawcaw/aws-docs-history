...
| Example policy                | [Deny access to AWS based on the requested<br>AWS Region](orgs_manage_policies_scps_examples_general.md#example-scp-deny-region "orgs_manage_policies_scps_examples_general.md#example-scp-deny-region") | [Restrict access to only HTTPS connections to your resources](orgs_manage_policies_rcps_examples.md#example-rcp-enforce-ssl "orgs_manage_policies_rcps_examples.md#example-rcp-enforce-ssl") | [Allowed<br>Images Settings](orgs_manage_policies_declarative_syntax.md#declarative-policy-ec2-ami-allowed-images "orgs_manage_policies_declarative_syntax.md#declarative-policy-ec2-ami-allowed-images")       |
