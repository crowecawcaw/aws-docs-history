...
<a name="digif-data-delivery-use-cases"></a>
...
<a name="multiple-dataflows-single-receiver"></a>
...
+ 6 cores (12 vCPU) to receive DigIF Dataflow 1 (200MHz lookup in [CPU core planning](agent-instance-selection.md#cpu-core-planning) table).
...
+ Receiver Instance 1
  + 1 core (2 vCPU) for running the single AWS Ground Station Agent on the instance.
  + 9 cores (18 vCPU) to receive DigIF Dataflow 1 (400MHz lookup in [CPU core planning](agent-instance-selection.md#cpu-core-planning) table).
