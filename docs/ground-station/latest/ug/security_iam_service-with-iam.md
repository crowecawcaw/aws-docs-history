...
To view examples of AWS Ground Station identity-based policies, see [Identity-based policy examples for AWS Ground Station](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").
