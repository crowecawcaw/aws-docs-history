...
Before you use IAM to manage access to AWS Ground Station, learn what IAM features are
available to use with AWS Ground Station.

| IAM features you can use with AWS Ground Station                                                                                                                            | IAM feature | AWS Ground Station support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------------- |
...
To get a high-level view of how AWS Ground Station and other AWS services work with most IAM
features, see [AWS services that work with IAM](../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md "../../../IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.md") in the
_IAM User Guide_.

## Identity-based

policies for AWS Ground Station
...
To view examples of AWS Ground Station identity-based policies, see [Identity-based policy
examples for AWS Ground Station](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within AWS Ground Station
...
To see a list of AWS Ground Station actions, see [Actions defined by AWS Ground Station](../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions "../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions") in the
...
resources for AWS Ground Station
...
To see a list of AWS Ground Station resource types and their ARNs, see
[Resources defined by AWS Ground Station](../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
which actions you can specify the ARN of each resource, see
[Actions defined by AWS Ground Station](../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions "../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions").
...
To see a list of AWS Ground Station condition keys, see [Condition keys for AWS Ground Station](../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-policy-keys "../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-policy-keys") in the
_Service Authorization Reference_. To learn with which actions and resources you
can use a condition key, see [Actions defined by AWS Ground Station](../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions "../../../service-authorization/latest/reference/list_awsgroundstation.md#awsgroundstation-actions-as-permissions").
...
credentials with AWS Ground Station
...
principal permissions for AWS Ground Station
...
Changing the permissions for a service role might break AWS Ground Station functionality.
Edit service roles only when AWS Ground Station provides guidance to do so.

## Service-linked

roles for AWS Ground Station
