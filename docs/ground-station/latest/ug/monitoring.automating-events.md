...
[Understand contact lifecycle](contacts.lifecycle.md "contacts.lifecycle.md") . Any dataflow
...
The possible values for `contactStatus` are defined in [AWS Ground Station contact statuses](contacts.lifecycle.md#contact-statuses "contacts.lifecycle.md#contact-statuses").
