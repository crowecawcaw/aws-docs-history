...
<a name="bandwidth-definitions"></a>
...
## CancelContact
<a name="cancel-contact-billing"></a>

 Use of the [ CancelContact](https://docs.aws.amazon.com/ground-station/latest/APIReference/API_CancelContact.html) API varies based on the contact state when you call it: 
...
<a name="billing-scenarios-one"></a>
...
<a name="billing-scenarios-two"></a>
...
<a name="billing-scenarios-three"></a>
...
<a name="billing-scenarios-four"></a>
...
<a name="billing-scenarios-five"></a>
...
<a name="billing-scenarios-six"></a>
...
<a name="billing-scenarios-seven"></a>
...
<a name="billing-scenarios-eight"></a>
