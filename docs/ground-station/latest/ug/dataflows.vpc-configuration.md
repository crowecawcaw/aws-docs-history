...
- For more information on the supported regions for cross-region connections, see [Use cross-region data delivery](dataflows.cross-region-data-delivery.md "dataflows.cross-region-data-delivery.md").
