# Troubleshooting AWS Ground Station identity and

access

Use the following information to help you diagnose and fix common issues that you might
encounter when working with AWS Ground Station and IAM.

###### Topics

- [I am not authorized to
  perform an action in AWS Ground Station](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS Ground Station resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS Ground Station
...
have the fictional `groundstation:`GetWidget`` permissions.
...
`groundstation:`GetWidget`` action.
...
AWS Ground Station. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AWS Ground Station resources
...
- To learn whether AWS Ground Station supports these features, see [How AWS Ground Station works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
