...
- [JPSS-1 - Public broadcast satellite (PBS) - Evaluation](#examples.pbs-definition "#examples.pbs-definition")
- [Public broadcast satellite utilizing Amazon S3 data delivery](examples.pbs-to-s3.md "examples.pbs-to-s3.md")
- [Public broadcast satellite utilizing a dataflow endpoint (narrowband)](examples.pbs-data-dataflow-endpoint.md "examples.pbs-data-dataflow-endpoint.md")
- [Public broadcast satellite utilizing a dataflow endpoint (demodulated and decoded)](examples.pbs-dataflow-endpoint-demod-decode.md "examples.pbs-dataflow-endpoint-demod-decode.md")
- [Public broadcast satellite utilizing AWS Ground Station Agent (wideband)](examples.pbs-agent.md "examples.pbs-agent.md")

## JPSS-1 - Public broadcast satellite (PBS) - Evaluation

This example section matches the [Customer onboarding process overview](getting-started.step1.md#customer-onboarding-process "getting-started.step1.md#customer-onboarding-process"). It provides a brief compatibility analysis
with AWS Ground Station and sets the stage for the specific examples that follow.

As mentioned in the
[Public broadcast satellites](getting-started.step1.md#public-broadcast-satellites "getting-started.step1.md#public-broadcast-satellites")
