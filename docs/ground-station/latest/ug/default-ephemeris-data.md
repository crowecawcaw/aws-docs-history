...
have just launched or that are intentionally omitted from the [Space-Track](https://www.space-track.org/ "https://www.space-track.org/") catalog would have no NORAD ID and would
need to have custom ephemerides uploaded. For more information on providing a custom ephemeris see:
