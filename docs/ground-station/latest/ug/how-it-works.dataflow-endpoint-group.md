...
state, see [Troubleshoot DataflowEndpointGroups not in a HEALTHY state](troubleshooting-dfeg.md "troubleshooting-dfeg.md").
...
For more information about the complete workflow, see [Understand AWS Ground Station Core components](how-it-works.core.md "how-it-works.core.md") and [Create configs](getting-started.step3.md "getting-started.step3.md").
