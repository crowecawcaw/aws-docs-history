...
<a name="troubleshooting-no-data-received"></a>
...
<a name="troubleshooting-no-data-received.incorrect-config"></a>

 Each contact that receives data from a satellite will have an associated [Antenna Downlink Config](how-it-works.config.md#how-it-works.config-antenna-downlink) or [Antenna Downlink Demod Decode Config](how-it-works.config.md#how-it-works.config-antenna-downlink-demod-decode). If the configuration specified does not agree with the signal being transmitted by a satellite, AWS Ground Station will not be able to receive the transmitted signal. This will result in no data being received by AWS Ground Station. 
...
## Satellite maneuver
<a name="troubleshooting-no-data-received.satellite-maneuver"></a>
