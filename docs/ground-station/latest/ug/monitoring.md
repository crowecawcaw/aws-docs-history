...
- [Log AWS Ground Station API calls with AWS CloudTrail](monitoring.cloudtrail.md "monitoring.cloudtrail.md")
- [View metrics with Amazon CloudWatch](monitoring.metrics.md "monitoring.metrics.md")
