...
to upload custom ephemeris data, please open an AWS Support ticket through the [AWS Support Center Console](https://console.aws.amazon.com/support "https://console.aws.amazon.com/support"). Our team will work with you to enable this capability for your specific requirements.
