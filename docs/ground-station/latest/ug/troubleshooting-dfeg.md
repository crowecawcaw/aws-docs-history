...
- `NO_REGISTERED_AGENT` - Start your EC2 instance, which will register the agent. Note that you must have a valid controller config file
  for this call to be successful. Refer to the [Use AWS Ground Station Agent](how-it-works.gs-agent.md "how-it-works.gs-agent.md") for details on configuring that file.
