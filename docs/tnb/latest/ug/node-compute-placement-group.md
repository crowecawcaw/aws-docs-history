...
+ **SPREAD\_RACK** – places a small group of instances across distinct underlying hardware to reduce correlated failures.
+ **SPREAD\_HOST** – used only with Outpost placement groups. Places a small group of instances across distinct underlying hardware to reduce correlated failures.
