...
- **Security in the cloud** – Your responsibility is
  ...
  using AWS TNB. The following topics show you how to configure AWS TNB to meet your
  security and compliance objectives. You also learn how to use other AWS services that help you
  to monitor and secure your AWS TNB resources.
...
- [IMDS version](imds-version.md "imds-version.md")
