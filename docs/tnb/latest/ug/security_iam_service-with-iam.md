...
Before you use IAM to manage access to AWS TNB, learn what IAM features are
available to use with AWS TNB.

| IAM features you can use with AWS Telco Network Builder                                                                                                  | IAM feature | AWS TNB support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------- |
...
To get a high-level view of how AWS TNB and other AWS services work with most IAM
...
To see a list of AWS TNB actions, see [Actions defined by AWS Telco Network Builder](../../../service-authorization/latest/reference/list_awstelconetworkbuilder.md#awstelconetworkbuilder-actions-as-permissions "../../../service-authorization/latest/reference/list_awstelconetworkbuilder.md#awstelconetworkbuilder-actions-as-permissions") in the
...
To see a list of AWS TNB resource types and their ARNs, see [Resources defined by AWS Telco Network Builder](../../../service-authorization/latest/reference/list_awstelconetworkbuilder.md#awstelconetworkbuilder-resources-for-iam-policies "../../../service-authorization/latest/reference/list_awstelconetworkbuilder.md#awstelconetworkbuilder-resources-for-iam-policies")
