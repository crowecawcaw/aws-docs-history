...
![Shutdown message on LCD screen.](/images/snow/latest/swsbe-pack/images/shutdown-screen.png) 2. After the device has shut down, disconnect the device power cable from the power source.
