...
manifest file and an unlock code. The manifest file contains important information about
the job and
...
1. Sign in to the
   ...
   and open the [AWS Snow Family Management Console](https://console.aws.amazon.com/snowfamily/home "https://console.aws.amazon.com/snowfamily/home").
2. On the console, search the table for the specific job to download the job
   manifest for, and then choose that job.
3. Expand that job's **Job status** pane, and choose
   **View job details**.
4. In the details pane that appears, expand **Credentials** and
   ...
   - In the dialog box, choose **Download manifest**, and
     follow the instructions to download the job manifest file to your
...
location in the workstation as the manifest for that job.
Now that you have your credentials, the next step is to download the Snowball Edge
