...
![Shutdown message on LCD screen with Restart display button near bottom center.](https://docs.aws.amazon.com/snow/latest/swsbe-pack/images/shutdown-screen-restart.png)
