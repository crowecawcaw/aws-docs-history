...
1. Select **Confluence**, then choose **Next**.

1. Install the AWS Security Agent Forge app in your Atlassian site, following the on-screen instructions. After installation, copy the installation ID. See [Find your Atlassian installation ID](find-atlassian-installation-id.md).

1. In the **Confluence site URL** field, enter your site URL, for example `https://acme.atlassian.net`.

1. In the **Installation ID** field, paste the installation ID you copied from Confluence.

1. Choose **Authorize**.

   You are redirected to Atlassian to authorize AWS Security Agent to access your Confluence site. After authorization completes, you return to the console.
