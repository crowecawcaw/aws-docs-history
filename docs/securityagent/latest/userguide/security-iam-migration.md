...
1. In the left hand panel, select **Settings** and choose the role under **Service role** 

1. In the IAM console for the associated role, select **Add permissions** and **Attach policies** 

1. Select **AWSSecurityAgentWebAppPolicy** and choose **Add permissions** 
...
1. Update your trust policy to the following format, replacing **{{accountId}}** with your AWS account ID
...
1. For each Agent Space you have with penetration testing enabled, perform the following steps
   ...
   1. Under **Service access**, choose the role under **Service role name** 
