...
2. In the left hand panel, select **Settings** and choose the role under **Service role**
3. In the IAM console for the associated role, select **Add permissions** and **Attach policies**
4. Select **AWSSecurityAgentWebAppPolicy** and choose **Add permissions**
...
2. For each Agent Space you have with penetration testing enabled, perform the following steps
   ...
   2. Under **Service access**, choose the role under **Service role name**
