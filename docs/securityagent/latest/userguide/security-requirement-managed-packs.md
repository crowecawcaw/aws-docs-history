...
The security requirements in a managed pack are read-only. You cannot change them. You can use an AWS-managed requirement as a template to create a custom requirement, and then edit the copy to fit your organization. For more information, see [Manage security requirements](security-requirements.md "security-requirements.md").
