...
connection using either the AWS Direct Connect console or using the command line or API.
...
key with the connection. For information about removing an association, see [Remove the association between a MACsec secret key and an AWS Direct Connect endpoint
