...
- **Security of the cloud** – AWS is responsible for
  ...
  learn about the compliance programs that apply to AWS Direct Connect, see [AWS Services in Scope by
...
- [Logging and monitoring](dc-incident-response.md "dc-incident-response.md")
- [Compliance validation](DirectConnect-compliance.md "DirectConnect-compliance.md")
- [Resilience in Direct Connect](disaster-recovery-resiliency.md "disaster-recovery-resiliency.md")
