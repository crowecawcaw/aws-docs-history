...
Using a Direct Connect gateway, you can associate the Direct Connect gateway with a transit
gateway with multiple VPCs, a virtual private gateway, or if you use AWS Cloud WAN, to a
...
Use a Direct Connect gateway to associate a Direct Connect gateway with an AWS Network Manager core
network.
