# Create a transit gateway and AWS Direct Connect association
...
AWS Direct Connect. You can create an association proposal using either the AWS Direct Connect console or using the command line or API.
...
- [CreateDirectConnectGatewayAssociationProposal](../APIReference/API_CreateDirectConnectGatewayAssociationProposal.md "../APIReference/API_CreateDirectConnectGatewayAssociationProposal.md") (AWS Direct Connect API)
