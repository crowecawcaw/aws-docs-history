...
+ Provides Amazon CloudWatch metrics for connections and virtual interfaces. For more information, see [Monitoring and visibility with Direct Connect](monitoring-overview.md).
