...
Convert a connection to standalone by disassociating it from a LAG using either the AWS Direct Connect console or using the command line or API. You can't disassociate a
...
- [DisassociateConnectionFromLag](../APIReference/API_DisassociateConnectionFromLag.md "../APIReference/API_DisassociateConnectionFromLag.md") (AWS Direct Connect API)
