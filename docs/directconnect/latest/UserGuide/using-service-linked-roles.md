...
1. Remove the association between all MACsec keys and connections. For more information, see [Remove the association between a MACsec secret key and a Direct Connect connection](disassociate-key-connection.md)

1. Remove the association between all MACsec keys and LAGs. For more information, see [Remove the association between a MACsec secret key and a Direct Connect endpoint LAG](disassociate-key-lag.md)
