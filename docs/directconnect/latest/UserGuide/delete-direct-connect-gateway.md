...
attached private virtual interfaces, you can delete the Direct Connect gateway using either the Direct Connect console or using the command line or API.
...
- [DeleteDirectConnectGateway](../APIReference/API_DeleteDirectConnectGateway.md "../APIReference/API_DeleteDirectConnectGateway.md") (Direct Connect API)
