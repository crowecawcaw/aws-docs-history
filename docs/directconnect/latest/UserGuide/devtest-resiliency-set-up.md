...
3.  Under **Connection ordering type**, choose
    **Connection wizard**.
4.  Under **Resiliency level**, choose **Development
...
5.  On the **Configure connections** pane, under
    **Connection settings,** do the following:
    ...
    you use. 5. (Optional) Add or remove a tag.
...
public virtual interface to connect to public AWS services that aren't in a VPC.
When you create a private virtual interface to a VPC, you need a private virtual
interface for each VPC that you're connecting to. For example, you need three
private virtual interfaces to connect to three VPCs.
...
When you create a public virtual interface, it can take up to 72 business hours for AWS
...
5.  Under **Public virtual interface settings**, do the
    ...
    4. For **BGP ASN**, enter the Border Gateway
       Protocol (BGP) Autonomous System Number (ASN) of your
       gateway.
