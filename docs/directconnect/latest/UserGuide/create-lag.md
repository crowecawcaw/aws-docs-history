...
device (terminate at the same AWS Direct Connect endpoint). They must also use the same bandwidth.
...
- [DescribeLags](../APIReference/API_DescribeLags.md "../APIReference/API_DescribeLags.md") (AWS Direct Connect API)
