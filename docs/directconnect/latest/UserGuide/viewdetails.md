...
You can view the current status of your connection using either the AWS Direct Connect console or using the command line or API. You can also view your connection
...
- [describe-connections](../../../cli/latest/reference/directconnect/describe-connections.md "../../../cli/latest/reference/directconnect/describe-connections.md") (AWS CLI)
- [DescribeConnections](../APIReference/API_DescribeConnections.md "../APIReference/API_DescribeConnections.md") (AWS Direct Connect API)
