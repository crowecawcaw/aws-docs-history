...
- **Hosted Connection**: A physical Ethernet connection that an AWS Direct Connect Partner provisions on behalf
  ...
  AWS Direct Connect Partner Program, who provisions the connection. For more information, see [Hosted connections](hosted_connection.md "hosted_connection.md").

###### Topics

- [Dedicated connections](dedicated_connection.md "dedicated_connection.md")
- [Hosted connections](hosted_connection.md "hosted_connection.md")
