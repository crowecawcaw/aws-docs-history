...
occurs. Before you start monitoring Direct Connect; however, you should create a monitoring plan
...
- Who should be notified when something goes wrong?
  ...
  As you monitor Direct Connect, store historical monitoring data. That way, you can compare it
...
To establish a baseline, you should monitor the usage, state, and health of your physical
...
AWS provides various tools that you can use to monitor an AWS Direct Connect connection. You can
...
You can use the following automated monitoring tools to watch Direct Connect and report
...
- **Amazon CloudWatch Alarms** – Watch a single metric over a
  ...
  have changed and been maintained for a specified number of periods. For
  information about available metrics and dimensions, see [Monitor with Amazon CloudWatch](monitoring-cloudwatch.md "monitoring-cloudwatch.md").
- **AWS CloudTrail Log Monitoring** – Share log files between accounts and
  ...
  have not changed after delivery by CloudTrail. For more information, see [Log API calls](logging_dc_api_calls.md "logging_dc_api_calls.md")
  and [Working
...
- The CloudWatch home page shows:
  ...
  In addition, you can use CloudWatch to do the following:
      ...
      + Create [customized dashboards](../../../AmazonCloudWatch/latest/DeveloperGuide/CloudWatch_Dashboards.md "../../../AmazonCloudWatch/latest/DeveloperGuide/CloudWatch_Dashboards.md") to monitor the services you care
       about.
