...
VIF A, set the AS\_PATH attribute of VIF B to be shorter than the VIF A AS\_PATH
attribute.

The VIFs have the following configurations:

- VIF A (in us-east-1) advertises 172.16.0.0/16 and has an AS\_PATH attribute of
  65001, 65001, 65001
- VIF B (in us-east-1) advertises 172.16.0.0/16 and has an AS\_PATH attribute of
  65001, 65001
- VIF C (in us-west-1) advertises 172.16.0.0/16 and has an AS\_PATH attribute of
  65001
...
- VIF C (in us-west-1) advertises 172.16.0.0/24 and has an AS\_PATH attribute of
  65001
