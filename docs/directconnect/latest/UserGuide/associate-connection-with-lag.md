...
You can associate an existing connection with a LAG using either the AWS Direct Connect console or using the command line or API. The connection can be standalone, or it
...
- [AssociateConnectionWithLag](../APIReference/API_AssociateConnectionWithLag.md "../APIReference/API_AssociateConnectionWithLag.md") (AWS Direct Connect API)
