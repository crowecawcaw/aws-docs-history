...
5.  On the **Configure connections** pane, under
    **Connection settings,** do the following:
    ...
    the appropriate AWS Direct Connect location. 3. If applicable, for **First Sub location**, choose
    ...
    the appropriate AWS Direct Connect location. 6. If applicable, for **Second Sub location**,
...
your resiliency requirements. For more information, see [AWS Direct Connect Failover Test](resiliency_failover.md "resiliency_failover.md").
