...
3. Under **Connection ordering type**, choose
   **Connection wizard**.
4. Under **Resiliency level**, choose **High
...
5. On the **Configure connections** pane, under
   **Connection settings,** do the following:
   ...
   the appropriate Direct Connect location. 3. If applicable, for **First Sub location**, choose
