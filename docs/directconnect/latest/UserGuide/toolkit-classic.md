...
1. On the **Create Connection** pane, under **Connection settings,** do the following:
   ...
   1. For **On-premises**, select **Connect through a Direct Connect partner** when you use this connection to connect to your data center.
