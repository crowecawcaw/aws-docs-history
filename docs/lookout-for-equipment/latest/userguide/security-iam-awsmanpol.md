...
| [AmazonLookoutEquipmentReadOnlyAccess](#security-iam-awsmanpol-AmazonLookoutEquipmentReadOnlyAccess "#security-iam-awsmanpol-AmazonLookoutEquipmentReadOnlyAccess") – New policy                   | Lookout for Equipment added a new policy to allow read only access for all Lookout for Equipment<br>resources.                                                                                                                    | May 05, 2021      |
| [AmazonLookoutEquipmentFullAccess](#security-iam-awsmanpol-AmazonLookoutEquipmentFullAccess "#security-iam-awsmanpol-AmazonLookoutEquipmentFullAccess") – Update to an existing<br>policy          | Lookout for Equipment added permissions to describe AWS KMS managed encryption keys.<br>You must use these permissions to use the Lookout for Equipment console to display<br>information about AWS KMS keys across AWS accounts. | May 05, 2021      |
