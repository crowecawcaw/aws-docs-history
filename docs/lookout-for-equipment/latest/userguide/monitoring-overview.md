...
`Amazon Lookout for Equipment` and your other AWS solutions. AWS provides the following monitoring tools to
watch `Amazon Lookout for Equipment`, report when something is wrong, and take automatic actions when
appropriate:
