...
![Table showing active inference schedules with columns for schedule name, model name, data upload frequency, and latest results status.](https://docs.aws.amazon.com/lookout-for-equipment/latest/userguide/images/inference-schedules-main.png)
...
![Inference schedule overview showing schedule name, active status, model name, ARN, and creation date.](https://docs.aws.amazon.com/lookout-for-equipment/latest/userguide/images/inference-schedule-detail.png)
...
![Bar chart showing Temperature1 at 27.5% as top contributor, followed by Vibration1 at 16.7%.](https://docs.aws.amazon.com/lookout-for-equipment/latest/userguide/images/inference-event-details.png)
