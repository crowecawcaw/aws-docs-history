...
1. Train a multi-variate time series anomaly detection model on the data.

1. Monitor your asset with the model that you've trained.
...
If you have the data available, you can highlight abnormal equipment behavior using "labels." The trained model can use the anomalous behavior in the dataset to improve its performance.
