...
**Topics**
+ [I am not authorized to perform an action in Lookout for Equipment](#security_iam_troubleshoot-no-permissions)
+ [I am not authorized to perform iam:PassRole](#security_iam_troubleshoot-passrole)
+ [I want to view my access keys](#security_iam_troubleshoot-access-keys)
+ [I'm an administrator and want to allow others to access Lookout for Equipment](#security_iam_troubleshoot-admin-delegate)
+ [I want to allow people outside of my AWS account to access my Lookout for Equipment resources](#security_iam_troubleshoot-cross-account-access)
...
+ To learn whether Amazon Lookout for Equipment supports these features, see [AWS Identity and Access Management for Amazon Lookout for Equipment](security_iam_service-with-iam.md).
