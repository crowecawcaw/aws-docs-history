...
You've made a decision about your [training and evaluation](configuring-input-data.md) settings. If you decided to use labeled data, now is the time to upload it.
...
The last step before training your model is to [review it](reviewing-settings.md).