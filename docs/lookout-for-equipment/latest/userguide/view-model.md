...
**Note**  
You can also view a model [with the SDK](SDK-examples.md#view-model-sdk).
...
![Model performance dashboard showing detected events, labeled events, and top 15 contributing sensors.](https://docs.aws.amazon.com/lookout-for-equipment/latest/userguide/images/model-performance-image-launch.png)
