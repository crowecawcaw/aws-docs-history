...
You've [set up your account](getting-started-brain.md) and created your project. Soon, you'll organize your data so as to help Lookout for Equipment determine an appropriate schema. But first, you must ensure that your data is formatted properly.
...
| Category | Limit | minimum date range | 180 days | 
| --- | --- | --- | --- | 
