...
| --- | --- | --- | 
| [AmazonLookoutEquipmentReadOnlyAccess](#security-iam-awsmanpol-AmazonLookoutEquipmentReadOnlyAccess) | Lookout for Equipment modified the policy to allow all Describe actions and all List actions. | November 4, 2022 | 
| [AmazonLookoutEquipmentReadOnlyAccess](#security-iam-awsmanpol-AmazonLookoutEquipmentReadOnlyAccess) – Update to an existing policy | Lookout for Equipment modified the policy so as to allow all list and describe APIs. | October 26, 2022 | 
