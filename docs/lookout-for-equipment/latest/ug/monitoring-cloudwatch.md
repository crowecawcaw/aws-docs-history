...
You can monitor Lookout for Equipment using CloudWatch, which collects raw data and processes it
...
The Lookout for Equipment service reports the following metrics
...
| `InferenceInvalidInput`  | If the value is `1`, you've provided an invalid value for the inference. ModelName: The name of the model. InferenceSchedulerName: Name of the inference scheduler                 | The following dimensions are supported for the Lookout for Equipment metrics. |
