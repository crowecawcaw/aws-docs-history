...
behavior from the one set of data that has been
...
data to learn about normal behavior for your equipment.
...
It's all training data. But you do provide
[labeled](understanding-labeling.md "understanding-labeling.md") data that indicates
anomalous behavior.

- Training set, evaluation set, and labels

You identify some of the ingested data as training data, and the rest of
it as evaluation data. You also provide
[labeled](understanding-labeling.md "understanding-labeling.md") data that indicates periods
...
behavioral anomaly (or as normal behavior). In order to prevent this, it's
...
Now that you've configured your input data, the next step is to decide whether or
not to use [data labels](labeling-data.md "labeling-data.md").

If you already know that you do not want to label your data, you can skip ahead to
[Starting the training process](reviewing-settings.md "reviewing-settings.md").
