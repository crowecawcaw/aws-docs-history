...
ingest into Lookout for Equipment.

![alt_text](images/L4E-project-start.png)

###### To create a project

1. Open [Lookout for Equipment
...
resources in your AWS account. To learn more, see [Tagging AWS resources](../../../general/latest/gr/aws_tagging.md "../../../general/latest/gr/aws_tagging.md").

![alt_text](images/L4E-project-start-tags.png)

Now that you've created your project, you'll need to [check the formatting of your data](formatting-data.md "formatting-data.md"). Then you'll need to organize your files before you upload them to Amazon S3.
