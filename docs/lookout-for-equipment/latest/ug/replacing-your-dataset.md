...
<a name="replacing-your-dataset"></a>

Replacing your dataset allows you to change the data without re-creating the project from the beginning.

You may want to do this after [reviewing the ingestion of your dataset](understanding-ingestion-validation.md), and addressing problems with the job, files, or sensors.
...
After the procedure above, you'll [review your dataset ingestion](understanding-ingestion-validation.md) once again.