...
<a name="formatting-data"></a>

You've [set up your account](getting-started-brain.md) and created your project. Soon, you'll organize your data to help Lookout for Equipment determine an appropriate schema. But first, you must ensure that your data is formatted properly.
...
<a name="formatting-requirements"></a>
...
| Category | Limit | minimum date range | 14 days | 
| --- | --- | --- | --- | 
...
<a name="understanding-date-range"></a>
