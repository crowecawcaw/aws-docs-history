...
+ [Publishing information about ingestion validation to Amazon CloudWatch Logs](#security_iam_id-based-policy-examples-publish-to-CW)
...
<a name="security_iam_id-based-policy-examples-publish-to-CW"></a>

To enable Amazon CloudWatch Logs, do one of the following:
+ When creating a new role, check the **Enable CloudWatch Logs** box on the console. For more information see [Logging your ingestion data](ingest-dataset.md#activate-logs).
