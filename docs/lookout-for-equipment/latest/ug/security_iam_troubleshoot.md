...
have the fictional `lookoutequipment:`GetWidget`` permissions.

```
User: arn:aws:iam::123456789012:user/mateojackson is not authorized to perform: lookoutequipment:GetWidget on resource: my-example-widget
```
...
`lookoutequipment:`GetWidget`` action.
