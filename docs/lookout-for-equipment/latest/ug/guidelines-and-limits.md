...
For a list of Amazon Web Services Regions where Lookout for Equipment is available, see [Amazon Web Services Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/lookoutequipment.html) in the *Amazon Web Services General Reference*.

## Quotas
<a name="limits-all"></a>

Service quotas, also referred to as limits, are the maximum number of service resources for your Amazon Web Services account. For more information, see [Amazon Web Services Service Quotas](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html) in the *Amazon Web Services General Reference*. 
