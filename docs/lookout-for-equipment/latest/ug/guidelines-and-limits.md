...
For a list of Amazon Web Services Regions where Lookout for Equipment is available, see
[Amazon Web Services Regions and Endpoints](../../../general/latest/gr/lookoutequipment.md "../../../general/latest/gr/lookoutequipment.md")

in the _Amazon Web Services General
Reference_.

## Quotas

Service quotas, also referred to as limits, are the maximum number of service resources for your Amazon Web Services account. For more information, see [Amazon Web Services Service
...
| Minimum timespan of training data                                                              | [14 days](formatting-data.md#understanding-date-range "formatting-data.md#understanding-date-range") |
| **Inference**                                                                                  |
