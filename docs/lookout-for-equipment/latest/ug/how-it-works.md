...
1. Train an anomaly detection model on the data.
...
Additionally, if available, you can highlight abnormal equipment behavior using [labels](understanding-labeling.md). The trained model can use the anomalous behavior in the dataset to improve its performance.
