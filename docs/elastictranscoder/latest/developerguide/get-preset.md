...
- [Description](#get-preset-description "#get-preset-description")
- [Requests](#get-preset-requests "#get-preset-requests")
- [Responses](#get-preset-responses "#get-preset-responses")
- [Errors](#get-preset-response-errors "#get-preset-response-errors")
- [Examples](#get-preset-examples "#get-preset-examples")
...
```
GET /2012-09-25/presets/presetId HTTP/1.1
...
When you get a preset, Elastic Transcoder returns the values that you specified when you created the preset. For more information, see
[Settings that You Specify When You Create an Elastic Transcoder Preset](preset-settings.md "preset-settings.md").
...
The following example request gets the preset that has the preset ID
