...
- [Description](#create-preset-description "#create-preset-description")
- [Requests](#create-preset-requests "#create-preset-requests")
- [Responses](#create-preset-responses "#create-preset-responses")
- [Errors](#create-preset-response-errors "#create-preset-response-errors")
- [Examples](#create-preset-examples "#create-preset-examples")
...
Elastic Transcoder checks the settings that you specify to ensure that they meet Elastic Transcoder requirements and to determine
whether they comply with the applicable standard. If your settings are not valid for Elastic Transcoder, Elastic Transcoder returns an HTTP 400 response
(`ValidationException`) and does not create the preset. If the settings are valid for Elastic Transcoder but aren't
strictly compliant with the standard, Elastic Transcoder creates the preset and returns a warning message in the response.
This helps you determine whether your settings comply with the standard while giving you greater flexibility
with respect to the file that Elastic Transcoder produces.

###### Note

Elastic Transcoder includes several system presets for common output formats. For more information, see
**PresetId** in the
topic [Create Job](create-job.md "create-job.md").
...
The JSON string in the request body contains the input objects for the
`CreatePreset` operation. For more information about the input objects,
see [Settings that You Specify When You Create an Elastic Transcoder Preset](preset-settings.md "preset-settings.md").
...
[Request Body](#create-preset-request-body "#create-preset-request-body").
...
Whether the preset is a default preset provided by Elastic Transcoder (`System`) or a preset that you have
defined (`Custom`).

**(Automatic) Warning**

When the settings for a preset are not compliant with the standards for the
**Codec** but the settings might produce
acceptable output, Elastic Transcoder creates the preset and includes a warning explaining how the
preset settings are not compliant.
