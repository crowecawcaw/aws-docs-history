...
- [Description](#list-pipelines-description "#list-pipelines-description")
- [Requests](#list-pipelines-requests "#list-pipelines-requests")
- [Responses](#list-pipelines-responses "#list-pipelines-responses")
- [Errors](#list-pipelines-response-errors "#list-pipelines-response-errors")
- [Examples](#list-pipelines-examples "#list-pipelines-examples")

## Description

To get a list of the pipelines associated with the current AWS account, send a GET request to the
...
To list pipelines in chronological order by the date and time that they were submitted, enter `true`.
...
created the pipelines. For more detail about the individual objects, see [Settings that You Specify When You Create an Elastic Transcoder Pipeline](pipeline-settings.md "pipeline-settings.md").
