...
- [Description](#delete-preset-description "#delete-preset-description")
- [Requests](#delete-preset-requests "#delete-preset-requests")
- [Responses](#delete-preset-responses "#delete-preset-responses")
- [Errors](#delete-preset-response-errors "#delete-preset-response-errors")
- [Examples](#delete-preset-examples "#delete-preset-examples")
...
```
DELETE /2012-09-25/presets/presetId HTTP/1.1
...
The following example request deletes the preset that has the ID
