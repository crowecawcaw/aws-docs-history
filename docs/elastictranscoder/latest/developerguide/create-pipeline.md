...
- [Description](#create-pipeline-description "#create-pipeline-description")
- [Requests](#create-pipeline-requests "#create-pipeline-requests")
- [Responses](#create-pipeline-responses "#create-pipeline-responses")
- [Errors](#create-pipeline-response-errors "#create-pipeline-response-errors")
- [Examples](#create-pipeline-examples "#create-pipeline-examples")
...
`CreatePipeline` operation. For more information about the input objects,
...
[Request Body](#create-pipeline-request-body "#create-pipeline-request-body").
