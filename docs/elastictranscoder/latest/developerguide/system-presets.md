...
The value of the `Id` object for the preset that you want to use for a job. The preset
...
If you created any presets before AAC profiles were added, Elastic Transcoder will use the AAC-LC profile
for those presets.

To use one of the system presets that are included with Elastic Transcoder, use the following IDs. (You can also get these IDs using
[List Presets](list-presets.md "list-presets.md").)

| Description                                                                | PresetId             |
| -------------------------------------------------------------------------- | -------------------- |
| Audio AAC<br>• 256 k                                                       | 1351620000001-100110 |
| Audio AAC<br>• 160 k                                                       | 1351620000001-100120 |
| Audio AAC<br>• 128 k                                                       | 1351620000001-100130 |
| Audio AAC<br>• 64 k (Uses auto for `Audio:CodecOptions:Profile`)           | 1351620000001-100141 |
| Audio MP3<br>• 320 k                                                       | 1351620000001-300010 |
| Audio MP3<br>• 192 k                                                       | 1351620000001-300020 |
| Audio MP3<br>• 160 k                                                       | 1351620000001-300030 |
| Audio MP3<br>• 128 k                                                       | 1351620000001-300040 |
...
| FLAC<br>• CD                                                               | 1351620000001-300110 |
| Full HD 1080i50                                                            | 1351620000001-100180 |
| Full HD 1080i60                                                            | 1351620000001-100190 |
| Full HD 1080i50<br>• XDCAM422                                              | 1351620000001-100230 |
| Full HD 1080i60<br>• XDCAM422                                              | 1351620000001-100220 |
...
| ----------------------------------------------------------------- | -------------------- | -------------------- |
| Audio AAC<br>• 64k (Uses AAC-LC for `Audio:CodecOptions:Profile`) | 1351620000001-100140 | 1351620000001-100141 |
