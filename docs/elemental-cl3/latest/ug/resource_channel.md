...
When you use Conductor Live, you create a channel by first selecting a profile. If you aren't familiar with profiles, first read [Creating a profile from scratch](creating-a-profile-from-scratch.md). 
...
**Topics**
+ [Creating a channel](creating-a-channel.md)
+ [Creating a channel by duplicating an existing channel](creating-a-channel-by-duplicating.md)
+ [Modifying a channel](modifying-a-channel.md)
+ [Changing the profile used by multiple channels](changing-the-profile-used-by-multiple-channels.md)
+ [Deleting channels](deleting-channels.md)