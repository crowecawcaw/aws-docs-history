...
| Visibility           | You can toggle the visibility of active alerts.<br>Suppressing an alert this way is similar to marking<br>an email as read.<br>The section below describes where you can see<br>suppressed and unsuppressed alerts on the web<br>interface.                                                               | Only messages of the type<br>*_Error_<br>• are visible in the<br>header. You can toggle the visibility of recent error<br>messages, which is similar to marking an email as<br>**read**.<br>The section below describes where you can see<br>suppressed and unsuppressed messages on the web<br>interface.                                                                                                                                                                     |
