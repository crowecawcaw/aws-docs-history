...
<a name="starting-and-stopping-channels"></a>

## Starting and stopping one channel
<a name="starting-and-stopping-one-channel"></a>

On the Conductor Live main menu, choose **Channels**. Then choose the green **Start **button to the right of the channel that you want to start.
...
<a name="starting-or-stopping-several-channels"></a>

### Step A. Create the task
<a name="ops-step-a-create-the-task"></a>
...
<a name="ops-step-b-monitor-the-status-of-the-task"></a>
