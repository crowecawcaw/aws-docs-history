...
- [Step A: Remove backup workers from redundancy groups](#upg-std-remove-w-red "#upg-std-remove-w-red")
- [Step B: Remove backup workers from the cluster](#upg-std-remove-w-cluster "#upg-std-remove-w-cluster")
