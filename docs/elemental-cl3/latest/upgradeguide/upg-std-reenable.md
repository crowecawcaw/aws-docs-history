...
You re-enable high availability when you have more than one Conductor Live node. If you have
only one Conductor node you don't need to do re-enable high availability and the upgrade
process is complete when you start the channels.

###### Important

Enabling high availability must be the last step that you take when changing
versions on your cluster.
