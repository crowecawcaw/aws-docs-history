...
This section describes the system requirements for AWS Elemental Conductor Live and worker nodes if you're using a virtual machine (VM). 

## Constraints with VMs
<a name="cl3-vm-constraint"></a>
...
<a name="cl3-vm-reqs-hardware-min"></a>

The following minimum host hardware resource levels are not for performance testing. You can use them to run Conductor Live, AWS Elemental Live, and AWS Elemental Statmux for functional testing, or for integrating with the AWS Elemental software API. 
...
<a name="cl3-vm-reqs-host-platform"></a>
