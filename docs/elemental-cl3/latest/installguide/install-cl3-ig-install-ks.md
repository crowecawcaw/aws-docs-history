...
<a name="install-cl3-ig-install-ks"></a>
...
<tbody>
  <tr><td><code>Set Hostname</code></td><td>Change the hostname to a useful name such as <b>conductor-live-3-01</b> or <b>conductor-live-3-chicago-01</b>.<br />Do not use localhost as the hostname!<br />Do not use periods or underscores in the hostname.</td></tr>
