...
| Virtual<br>machine (VM) | You're installing<br>software<br>and licenses for each VM guest that's running AWS Elemental<br>software.                                                                                                                                                                                                                                                                                     | [Installing Conductor Live on a virtual machine (VM)](install-vm-cl3-ig.md "install-vm-cl3-ig.md") in this guide |
