...
# Step A: Get ready
<a name="migrate-split-c-get-ready"></a>

## Read the essential notes
<a name="migrate-split-c-essential-notes"></a>

Refer to the essential notes in the [ current Release Notes](https://docs.aws.amazon.com/elemental-live/) to identify key changes to the behavior of the Conductor Live and worker nodes. 
...
<a name="migrate-split-c-automation-system"></a>
...
Plan the new connection for the primary Conductor. Then switch over to the new way of connecting right after you [split the cluster](migrate-split-c-split.md).
...
<a name="migrate-split-c-verify-cpu"></a>
...
<a name="migrate-split-c-prepare-boot-drive"></a>
...
<a name="migrate-split-get-info"></a>
