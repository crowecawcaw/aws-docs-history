...
Dell), read the Knowledge article [Latest AWS Elemental Qualified Remote Management and BIOS Firmware](https://us-east-1.console.aws.amazon.com/elemental-appliances-software/home?region=us-east-1#/viewknowledge/Latest-AWS-Elemental-Qualified-Remote-Management-and-BIOS-Firmware "https://us-east-1.console.aws.amazon.com/elemental-appliances-software/home?region=us-east-1#/viewknowledge/Latest-AWS-Elemental-Qualified-Remote-Management-and-BIOS-Firmware").
This article provides instructions and includes links to downloads.
...
2. From the Linux prompt, use the **elemental** user to
   start a remote terminal session to the Elemental Live node.
