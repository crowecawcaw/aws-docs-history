...
<a name="migrate-topic-uefi-dell"></a>

There are three ways to switch the boot mode from Legacy mode to UEFI.

**Topics**
+ [Switch using the IDRAC user interface](#migrate-topic-uefi-dell-idrac)
+ [Switch using RACADM](#migrate-topic-uefi-dell-racadm)
+ [Switch using the F2 boot menu](#migrate-condcutor-uefi-dell-f2)

## Switch using the IDRAC user interface
<a name="migrate-topic-uefi-dell-idrac"></a>
...
## Switch using RACADM
<a name="migrate-topic-uefi-dell-racadm"></a>
...
<a name="migrate-condcutor-uefi-dell-f2"></a>
