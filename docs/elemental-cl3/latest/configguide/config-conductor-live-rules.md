...
| Physical location of nodes in a cluster                                                               | Within a cluster, the Conductor Live and encoder nodes must be located in the same<br>physical location. |
| Within a cluster, the communications among cluster members shouldn't traverse the<br>public internet. |
