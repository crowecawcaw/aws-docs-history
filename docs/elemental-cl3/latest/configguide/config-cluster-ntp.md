...
<a name="config-cluster-ntp-server"></a>
...
1. On the Conductor Live web interface, go to the **Settings** page and choose **Network**.

1. On the **Network Time Protocol Servers** tab, enter the IP address for the server you want to use.
...
1. Choose the **Network** tab, then choose **Hostname, DNS, & Timing Server**.

1. In the **NTP Servers** section, set up one line, with the IP address of the primary Conductor Live node. Choose **Save**.

## Configuring PTP
<a name="config-cluster-ptp"></a>
