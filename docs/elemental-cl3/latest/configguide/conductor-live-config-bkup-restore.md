...
# Restoring a backup
<a name="conductor-live-config-bkup-restore"></a>
...
1. Enter the following command to identify the version of Conductor Live that is currently installed.
...
1. The file is unzipped and copied to the appropriate folder.