...
2. Find the line that defines `SMART_HOST`. It's
   generally just past halfway down the page and should look like
   this.
...
3. Save and exit the file. For nano, press Ctrl+O to save and Ctrl+X to
   exit.
