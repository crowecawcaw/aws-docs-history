...
See the information earlier on this page to determine if you can use
the web interface.
...
For a worker node, on the worker web interface, choose
**Settings** from the main menu. Choose the
**Network** tab, then choose **Hostname, DNS,
& Timing Server**. 3. Enter the IP address for the DNS server Choose
