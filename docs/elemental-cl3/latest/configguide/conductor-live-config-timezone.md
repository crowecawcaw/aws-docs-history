...
| Each worker node              | Yes                                                                                              | ###### To set the time zone on the Conductor Live Perform this procedure on the primary Conductor Live. 1. On the web interface for the primary Conductor Live, go to the **Settings** page and choose **General**. 2. In **Timezone**, choose the time zone, then choose **Update**. ###### To set the time zone on the worker nodes Perform this procedure on each worker node. 1. On the worker web interface, choose **Settings** from the main menu. Choose the **Network** tab, then choose **General**. 2. Choose the time zone, then choose **Save**. |
