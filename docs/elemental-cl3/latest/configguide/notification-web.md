...
**Subscribe to all alerts**
    ...
    | **Web Callback URL** | If you want to receive web server notifications<br>too, enter the URL of the appropriate<br>`.php` file on your web<br>server. |
...
4. Test your setup by typing the following at the command line of the Conductor Live
   node:
