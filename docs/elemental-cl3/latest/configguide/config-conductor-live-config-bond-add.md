...
| mode=1              | Active backup                         | Transmissions are received and sent out using the first available bonded<br>interface. The other interface is only used if the active interface fails.                                                                                                                                     |
