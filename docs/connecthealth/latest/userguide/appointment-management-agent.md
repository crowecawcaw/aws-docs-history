...
- [Capabilities](#am-capabilities "#am-capabilities")
- [Configuration options](#am-configuration "#am-configuration")
...
| Insurance verification | Enable or disable real-time insurance eligibility verification. When enabled, the agent invokes a customer-managed Lambda function to check eligibility and retrieve copay information. For more information, see [Insurance verification integration](insurance-verification.md "insurance-verification.md"). |
