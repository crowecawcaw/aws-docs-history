...
![The analytics dashboard showing KPI summary cards and charts](images/full-dashboard.png)
...
![The date range picker showing date range options](images/relative-date-view.png)
