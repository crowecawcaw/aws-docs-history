...
Amazon Connect Health is integrated with AWS CloudTrail for logging and monitoring API activity. For more information, see [Logging and monitoring in Amazon Connect Health](logging-using-cloudtrail.md "logging-using-cloudtrail.md").
