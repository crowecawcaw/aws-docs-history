...
After your administrator completes the steps in [IT administrators: Setting up Amazon Connect Health](setting-up.md "setting-up.md"), you can explore the AI agents, test them with your own EHR environment, and customize their behavior in the Amazon Connect Health application.

###### Topics

- [Agent demo and testing](#cta-agent-demo "#cta-agent-demo")
- [Agent customization](#cta-agent-customization "#cta-agent-customization")
- [Sample contact flow for testing](#cta-sample-contact-flow "#cta-sample-contact-flow")
- [Communication channel support](#cta-channel-support "#cta-channel-support")
- [Next steps](#cta-next-steps "#cta-next-steps")
...
3. Configure three sequential identity verification steps by selecting required patient inputs, such as phone number or MRN, date of birth, and zip code or last four SSN digits.
4. Choose **Publish** to apply the updates.

For more information about customization options, see [Agent customization](agent-customization.md "agent-customization.md").
...
For instructions on locating, using, and customizing the sample contact flow, see [Sample contact flow](contact-flow-setup.md "contact-flow-setup.md").
...
- [Patient engagement agents](patient-engagement-overview.md "patient-engagement-overview.md") — Learn about the patient verification and appointment management agents.
- [Point of care agents](point-of-care-overview.md "point-of-care-overview.md") — Learn about agents for clinical workflows.
