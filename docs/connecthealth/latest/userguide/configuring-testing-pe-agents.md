...
After your administrator completes the steps in [Setting up Amazon Connect Health](setting-up.md "setting-up.md"), you can explore the AI agents, test them with your own EHR environment, and customize their behavior in the Amazon Connect Health application.
