...
- [How patient insights works](#pi-how-it-works "#pi-how-it-works")
- [Inputs](#pi-inputs "#pi-inputs")
- [Submitting and tracking jobs](#pi-submitting-tracking-jobs "#pi-submitting-tracking-jobs")
- [Output](#pi-output "#pi-output")
- [Rendering the summary](#pi-rendering "#pi-rendering")
