...
In addition to Amazon Connect Health quotas, you are also subject to the default [service quotas of Amazon Connect](https://docs.aws.amazon.com/connect/latest/adminguide/amazon-connect-service-limits.html). If you are deploying at scale, review and request increases for Amazon Connect service quotas as needed.
