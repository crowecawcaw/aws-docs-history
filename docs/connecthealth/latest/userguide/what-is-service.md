...
- **[Setting up Amazon Connect Health](setting-up.md "setting-up.md")** – Understand the prerequisites and configure your environment.
...
- **AWS API** – Use the Amazon Connect Health API to programmatically manage resources. For more information, see the [Amazon Connect Health API Reference](../APIReference/Welcome.md "../APIReference/Welcome.md").
...
- [Amazon Connect](../../../connect/latest/adminguide/what-is-amazon-connect.md "../../../connect/latest/adminguide/what-is-amazon-connect.md") – Cloud-based contact center service that powers the voice channel for patient engagement agents.
- [AWS HealthLake](../../../healthlake/latest/devguide/what-is-amazon-healthlake.md "../../../healthlake/latest/devguide/what-is-amazon-healthlake.md") – FHIR-compliant data store that patient insights uses to retrieve clinical records.
- [AWS Lambda](../../../lambda/latest/dg/welcome.md "../../../lambda/latest/dg/welcome.md") – Serverless compute service used for insurance verification integration.
- [Amazon S3](../../../AmazonS3/latest/userguide/Welcome.md "../../../AmazonS3/latest/userguide/Welcome.md") – Object storage used for patient insights input documents and output delivery.
- [AWS KMS](../../../kms/latest/developerguide/overview.md "../../../kms/latest/developerguide/overview.md") – Key management service used for encryption of data at rest.

## Pricing

Amazon Connect Health pricing is based on usage. For current pricing information, see [Amazon Connect Health pricing](https://aws.amazon.com/connect/pricing/ "https://aws.amazon.com/connect/pricing/").
