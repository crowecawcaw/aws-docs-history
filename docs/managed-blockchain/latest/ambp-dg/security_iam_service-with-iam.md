...
Before you use IAM to manage access to AMB Access Polygon, learn what IAM features are
available to use with AMB Access Polygon.

| IAM features you can use with Amazon Managed Blockchain (AMB) Access Polygon                                                                             | IAM feature | AMB Access Polygon support |
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | -------------------------- |
...
To get a high-level view of how AMB Access Polygon and other AWS services work with most IAM
...
To see a list of AMB Access Polygon actions, see [Actions Defined by Amazon Managed Blockchain (AMB) Access Polygon](../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions "../../../IAM/latest/UserGuide/list_your_service.md#your_service-actions-as-permissions") in the
...
`InvokeRpcPolygon`, include the following
action:
...
To see a list of AMB Access Polygon resource types and their ARNs, see
[Resources Defined by Amazon Managed Blockchain (AMB) Access Polygon](../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies "../../../IAM/latest/UserGuide/list_your_service.md#your_service-resources-for-iam-policies") in the _Service Authorization Reference_. To learn with
...
To see a list of AMB Access Polygon condition keys, see [Condition Keys for Amazon Managed Blockchain (AMB) Access Polygon](../../../IAM/latest/UserGuide/list_your_service.md#your_service-policy-keys "../../../IAM/latest/UserGuide/list_your_service.md#your_service-policy-keys") in the
