...
The following are the service endpoints for AMB Access Bitcoin. To connect with the service, you
...
When making calls to the Bitcoin JSON-RPCs on Amazon Managed Blockchain, you
...
Use the `sendrawtransaction` JSON-RPC to submit transactions that update the
