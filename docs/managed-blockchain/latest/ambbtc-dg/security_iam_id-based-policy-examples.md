...
+ [Using the AMB Access Bitcoin console](#security_iam_id-based-policy-examples-console)
+ [Allow users to view their own permissions](#security_iam_id-based-policy-examples-view-own-permissions)
+ [Accessing Bitcoin networks](#security_iam_id-based-policy-examples-access-bitcoin-networks)
...
<a name="security_iam_id-based-policy-examples-access-bitcoin-networks"></a>
