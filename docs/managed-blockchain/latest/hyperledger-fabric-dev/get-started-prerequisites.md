...
+ For information about using SSH to connect to an Amazon EC2 Instance, see [Connecting to Your Linux Instance Using SSH](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AccessingInstancesLinux.html) in the *Amazon EC2 User Guide*.
...
<a name="vpc-endpoint-permissions"></a>
...
<a name="get-started-prerequisites-sgs"></a>
