...
<a name="get-started-enroll-admin"></a>
...
<a name="get-started-enroll-member-create-cert"></a>
...
<a name="get-started-enroll-member-enroll"></a>
...
**Warning**  
Always use variables in your code to pass user credentials. For more information, see [Move hard-coded credentials to AWS Secrets Manager](https://docs.aws.amazon.com/secretsmanager/latest/userguide/hardcoded.html)
...
<a name="get-started-enroll-member-copy-cert"></a>
