...
<a name="managed-blockchain-members"></a>
...
**Note**  
Each member that is created accrues charges according to the membership rate for the network. For more information, see [Amazon Managed Blockchain (AMB) Pricing](https://aws.amazon.com/managed-blockchain/pricing/hyperledger/).
...
<a name="managed-blockchain-create-removal"></a>
...
<a name="managed-blockchain-delete-account-member"></a>
