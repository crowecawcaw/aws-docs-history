...
<a name="managed-blockchain-data-protection"></a>
...
<a name="managed-blockchain-data-protection.encryption"></a>

Data encryption helps prevent unauthorized users from reading data from a blockchain network and the associated data storage systems. This includes data saved to persistent media, known as *data at rest*, andtr data that may be intercepted as it travels the network, known as *data in transit*.
