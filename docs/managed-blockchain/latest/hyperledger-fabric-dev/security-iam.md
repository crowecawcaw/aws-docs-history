...
+ [How Amazon Managed Blockchain (AMB) Hyperledger Fabric works with IAM](security_iam_service-with-iam.md)
+ [Troubleshooting Amazon Managed Blockchain (AMB) Hyperledger Fabric identity and access](security_iam_troubleshoot.md)
+ [Amazon Managed Blockchain (AMB) Hyperledger Fabric Identity-Based Policy Examples](security_iam_id-based-policy-examples.md)
