...
+ The voting policy for proposals on the network. For more information, see [Work with Proposals for a Hyperledger Fabric Network on Amazon Managed Blockchain (AMB)](managed-blockchain-proposals.md).
