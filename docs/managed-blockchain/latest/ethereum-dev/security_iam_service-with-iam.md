...
Before you use IAM to manage access to AMB Access Ethereum, learn what IAM features are
available to use with AMB Access Ethereum.

| IAM features you can use with Amazon Managed Blockchain (AMB) Access Ethereum                                                                                               | IAM feature | AMB Access Ethereum support |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | --------------------------- |
...
To get a high-level view of how AMB Access Ethereum and other AWS services work with most IAM
...
AMB Access Ethereum defines its own set of actions that describe tasks that you can
...
For example an Ethereum public network resource on AMB Access has one
...
To see a list of AMB Access Ethereum resource types and their ARNs, see
...
AMB Access Ethereum resources, see [Tagging Amazon Managed Blockchain (AMB) resources](tagging.md "tagging.md").
