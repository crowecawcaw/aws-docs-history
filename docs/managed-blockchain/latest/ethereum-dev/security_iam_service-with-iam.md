...
To get a high-level view of how AMB Access Ethereum and other AWS services work with most IAM features, see [AWS services that work with IAM](https://docs.aws.amazon.com/IAM/latest/UserGuide/reference_aws-services-that-work-with-iam.html) in the *IAM User Guide*.
...
To view examples of AMB Access Ethereum identity-based policies, see [Identity-based policy examples for Amazon Managed Blockchain (AMB) Access Ethereum](security_iam_id-based-policy-examples.md).
...
To see a list of AMB Access Ethereum actions, see [Actions defined by Amazon Managed Blockchain (AMB) Access Ethereum](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonmanagedblockchain.html#amazonmanagedblockchain-actions-as-permissions) in the *Service Authorization Reference*.
