...
Using the AMB Access console, you can add a tag to an Ethereum node when you create it or when viewing node details. You can remove a tag when viewing node details. For more information, see [Working with Ethereum nodes using AMB Access](ethereum-nodes.md).
