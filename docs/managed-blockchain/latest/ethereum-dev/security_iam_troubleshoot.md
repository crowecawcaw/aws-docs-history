...
encounter when working with AMB Access Ethereum and IAM.

###### Topics

- [I am not authorized to
  perform an action in AMB Access Ethereum](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AMB Access Ethereum resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AMB Access Ethereum
...
AMB Access Ethereum. However, the action requires the service to have permissions that are granted by a service role. Mary does not have permissions to pass the
role to the service.
...
outside of my AWS account to access my AMB Access Ethereum resources
...
- To learn whether AMB Access Ethereum supports these features, see [How Amazon Managed Blockchain (AMB) Access Ethereum works with IAM](security_iam_service-with-iam.md "security_iam_service-with-iam.md").
