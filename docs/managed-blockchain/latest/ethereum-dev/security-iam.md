...
- [Troubleshooting Amazon Managed Blockchain (AMB) Access Ethereum identity and
...
- **Service user** - request permissions from your
  administrator if you cannot access features (see [Troubleshooting Amazon Managed Blockchain (AMB) Access Ethereum identity and
  access](security_iam_troubleshoot.md "security_iam_troubleshoot.md"))
