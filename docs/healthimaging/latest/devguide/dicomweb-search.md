...
| Dotted SQ path                               | Request a specific sub-attribute within a Sequence (SQ) attribute using dot<br>notation: <parent_tag>.<child_tag>. | `includefield=00080096.00080100` |
