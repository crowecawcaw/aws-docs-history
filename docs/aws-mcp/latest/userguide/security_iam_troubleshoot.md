# Troubleshooting AWS MCP Server identity and
...
- [I am not authorized to
  perform an action in AWS MCP Server](#security_iam_troubleshoot-no-permissions "#security_iam_troubleshoot-no-permissions")
...
- [I want to allow people
  outside of my AWS account to access my AWS MCP Server resources](#security_iam_troubleshoot-cross-account-access "#security_iam_troubleshoot-cross-account-access")

## I am not authorized to

perform an action in AWS MCP Server
...
outside of my AWS account to access my AWS MCP Server resources
