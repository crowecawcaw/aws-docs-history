...
To view examples of AWS MCP Server identity-based policies, see [Identity-based policy
examples for AWS MCP Server](security_iam_id-based-policy-examples.md "security_iam_id-based-policy-examples.md").

## Resource-based

policies within AWS MCP Server
...
credentials with AWS MCP Server
...
principal permissions for AWS MCP Server
